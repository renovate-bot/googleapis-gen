...
function main() {
  // [START alertcenter_batch_undelete_alerts_sample]
  /**
  ...
  async function batchUndeleteAlerts() {
    ...
    // Run request
    const response = await alertcenterClient.batchUndeleteAlerts(request);
    console.log(response);
  }

  batchUndeleteAlerts();
  // [END alertcenter_batch_undelete_alerts_sample]
}
