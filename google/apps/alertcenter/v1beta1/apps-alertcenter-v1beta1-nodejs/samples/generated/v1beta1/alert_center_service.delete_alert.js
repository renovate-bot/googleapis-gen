...
function main() {
  // [START alertcenter_v1beta1_generated_AlertCenterService_DeleteAlert_async]
  /**
  ...
  async function callDeleteAlert() {
    // Construct request
    const request = {
    };

    // Run request
    const response = await alertcenterClient.deleteAlert(request);
    console.log(response);
  }

  callDeleteAlert();
  // [END alertcenter_v1beta1_generated_AlertCenterService_DeleteAlert_async]
}
