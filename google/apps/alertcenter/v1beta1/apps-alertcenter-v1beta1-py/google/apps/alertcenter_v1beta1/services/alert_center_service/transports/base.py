...
class AlertCenterServiceTransport(abc.ABC):
    """Abstract transport class for AlertCenterService."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/apps.alerts',
    )

    DEFAULT_HOST: str = 'alertcenter.googleapis.com'
    def __init__(
            self, *,
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_alerts: gapic_v1.method.wrap_method(
                self.list_alerts,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_alert: gapic_v1.method.wrap_method(
                self.get_alert,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_alert: gapic_v1.method.wrap_method(
                self.delete_alert,
                default_timeout=None,
                client_info=client_info,
            ),
            self.undelete_alert: gapic_v1.method.wrap_method(
                self.undelete_alert,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_alert_feedback: gapic_v1.method.wrap_method(
                self.create_alert_feedback,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_alert_feedback: gapic_v1.method.wrap_method(
                self.list_alert_feedback,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_alert_metadata: gapic_v1.method.wrap_method(
                self.get_alert_metadata,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.batch_delete_alerts: gapic_v1.method.wrap_method(
                self.batch_delete_alerts,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_undelete_alerts: gapic_v1.method.wrap_method(
                self.batch_undelete_alerts,
                default_timeout=None,
                client_info=client_info,
            ),
         }
