...
from .grpc import AlertCenterServiceGrpcTransport


class AlertCenterServiceGrpcAsyncIOTransport(AlertCenterServiceTransport):
    """gRPC AsyncIO backend transport for AlertCenterService.
    ...
    def list_alerts(self) -> Callable[
            ...
            Awaitable[alertcenter.ListAlertsResponse]]:
    ...
    def create_alert_feedback(self) -> Callable[
            ...
            Awaitable[alertcenter.AlertFeedback]]:
    ...
    def list_alert_feedback(self) -> Callable[
            ...
            Awaitable[alertcenter.ListAlertFeedbackResponse]]:
        ...
        Returns:
            Callable[[~.ListAlertFeedbackRequest],
                    Awaitable[~.ListAlertFeedbackResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_alert_metadata(self) -> Callable[
            ...
            Awaitable[alertcenter.AlertMetadata]]:
    ...
    def get_settings(self) -> Callable[
            ...
            Awaitable[alertcenter.Settings]]:
    ...
    def batch_delete_alerts(self) -> Callable[
            ...
            Awaitable[alertcenter.BatchDeleteAlertsResponse]]:
        ...
        Returns:
            Callable[[~.BatchDeleteAlertsRequest],
                    Awaitable[~.BatchDeleteAlertsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def batch_undelete_alerts(self) -> Callable[
            ...
            Awaitable[alertcenter.BatchUndeleteAlertsResponse]]:
        ...
        Returns:
            Callable[[~.BatchUndeleteAlertsRequest],
                    Awaitable[~.BatchUndeleteAlertsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
