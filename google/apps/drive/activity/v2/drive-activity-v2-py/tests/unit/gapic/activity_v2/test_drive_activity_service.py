...
def test__get_default_mtls_endpoint():
    ...
    assert DriveActivityServiceClient._get_default_mtls_endpoint(None) is None
    assert DriveActivityServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert DriveActivityServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert DriveActivityServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert DriveActivityServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert DriveActivityServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_drive_activity_service_client_get_transport_class():
    transport = DriveActivityServiceClient.get_transport_class()
    available_transports = [
        transports.DriveActivityServiceGrpcTransport,
    ]
    assert transport in available_transports

    transport = DriveActivityServiceClient.get_transport_class("grpc")
    assert transport == transports.DriveActivityServiceGrpcTransport


@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (DriveActivityServiceClient, transports.DriveActivityServiceGrpcTransport, "grpc"),
    (DriveActivityServiceAsyncClient, transports.DriveActivityServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_drive_activity_service_client_client_options(client_class, transport_class, transport_name):
...
def test_drive_activity_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_drive_activity_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_drive_activity_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
@pytest.mark.asyncio
async def test_query_drive_activity_async_from_dict():
...
def test_query_drive_activity_pager():
    ...
    with mock.patch.object(
        ...
        call.side_effect = (
            query_drive_activity_response.QueryDriveActivityResponse(
                activities=[
                    query_drive_activity_response.DriveActivity(),
                    query_drive_activity_response.DriveActivity(),
                    query_drive_activity_response.DriveActivity(),
                ],
                next_page_token='abc',
        ...
        metadata = ()
        pager = client.query_drive_activity(request={})
...
def test_query_drive_activity_pages():
    ...
    with mock.patch.object(
        ...
        pages = list(client.query_drive_activity(request={}).pages)
...
async def test_query_drive_activity_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.query_drive_activity(request={},)
...
async def test_query_drive_activity_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.query_drive_activity(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_drive_activity_service_base_transport():
...
def test_drive_activity_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.apps.drive.activity_v2.services.drive_activity_service.transports.DriveActivityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_drive_activity_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.apps.drive.activity_v2.services.drive_activity_service.transports.DriveActivityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.DriveActivityServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.DriveActivityServiceGrpcTransport, transports.DriveActivityServiceGrpcAsyncIOTransport])
...
def test_drive_activity_service_grpc_asyncio_transport_channel():
...
@pytest.mark.parametrize("transport_class", [transports.DriveActivityServiceGrpcTransport, transports.DriveActivityServiceGrpcAsyncIOTransport])
def test_drive_activity_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DriveActivityServiceGrpcTransport, transports.DriveActivityServiceGrpcAsyncIOTransport])
def test_drive_activity_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_parse_common_billing_account_path():
    ...
    actual = DriveActivityServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = DriveActivityServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = DriveActivityServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = DriveActivityServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = DriveActivityServiceClient.parse_common_location_path(path)
    assert expected == actual
