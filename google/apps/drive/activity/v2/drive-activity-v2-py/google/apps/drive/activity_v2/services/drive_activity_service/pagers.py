...
class QueryDriveActivityPager:
    ...
    @property
    def pages(self) -> Iterator[query_drive_activity_response.QueryDriveActivityResponse]:
    ...
    def __iter__(self) -> Iterator[query_drive_activity_response.DriveActivity]:
...
class QueryDriveActivityAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[query_drive_activity_response.QueryDriveActivityResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
            yield self._response
    def __aiter__(self) -> AsyncIterator[query_drive_activity_response.DriveActivity]:
