...
In general, the google-apps-drive-activity-v2 library uses
...
The google-apps-drive-activity-v2 library aims to make authentication
...
The environment variables that google-apps-drive-activity-v2
...
connect to most services with google-apps-drive-activity-v2.
