 ...
 * `src/v2/user_license_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './user_license_service_client_config.json';
 ...
 * @memberof v2
 */
export class UserLicenseServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof UserLicenseServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'ccc.hosted.marketplace.v2.UserLicenseService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.userLicenseServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('ccc.hosted.marketplace.v2.UserLicenseService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).ccc.hosted.marketplace.v2.UserLicenseService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const userLicenseServiceStubMethods =
        ['get'];
  ...
  static get servicePath() {
    return 'appsmarket.googleapis.com';
  }
  ...
  get(
      ...
      Promise<[
        ...
        protos.ccc.hosted.marketplace.v2.IUserLicenseGetRequest|undefined, {}|undefined
      ]>;
  get(
      request: protos.ccc.hosted.marketplace.v2.IUserLicenseGetRequest,
      options: CallOptions,
