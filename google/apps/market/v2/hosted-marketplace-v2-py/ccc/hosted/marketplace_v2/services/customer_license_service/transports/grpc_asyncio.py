...
class CustomerLicenseServiceGrpcAsyncIOTransport(CustomerLicenseServiceTransport):
    """gRPC AsyncIO backend transport for CustomerLicenseService.
    ...
    def get(self) -> Callable[
        ...
        Returns:
            Callable[[~.CustomerLicenseGetRequest],
                    Awaitable[~.CustomerLicense]]:
        ...
        if 'get' not in self._stubs:
            self._stubs['get'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=services.CustomerLicenseGetRequest.serialize,
                response_deserializer=resources.CustomerLicense.deserialize,
            )
...
__all__ = (
    'CustomerLicenseServiceGrpcAsyncIOTransport',
)
