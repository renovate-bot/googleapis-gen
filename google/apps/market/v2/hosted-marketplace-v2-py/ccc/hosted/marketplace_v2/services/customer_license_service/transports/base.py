...
class CustomerLicenseServiceTransport(abc.ABC):
    """Abstract transport class for CustomerLicenseService."""
    ...
    def get(self) -> typing.Callable[
            ...
            typing.Union[
                resources.CustomerLicense,
                typing.Awaitable[resources.CustomerLicense]
            ]]:
        raise NotImplementedError()


__all__ = (
    'CustomerLicenseServiceTransport',
)
