...
class UserLicenseServiceGrpcTransport(UserLicenseServiceTransport):
    """gRPC backend transport for UserLicenseService.
    ...
    def get(self) -> Callable[
        ...
        Returns:
            Callable[[~.UserLicenseGetRequest],
                    ~.UserLicense]:
        ...
        if 'get' not in self._stubs:
            self._stubs['get'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=services.UserLicenseGetRequest.serialize,
                response_deserializer=resources.UserLicense.deserialize,
            )
