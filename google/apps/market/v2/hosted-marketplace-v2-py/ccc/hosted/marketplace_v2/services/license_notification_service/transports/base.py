...
class LicenseNotificationServiceTransport(abc.ABC):
    """Abstract transport class for LicenseNotificationService."""
    ...
    @property
    def list(self) -> typing.Callable[
            [services.LicenseNotificationListRequest],
            typing.Union[
                resources.LicenseNotificationList,
                typing.Awaitable[resources.LicenseNotificationList]
            ]]:
