...
class LicenseNotificationServiceGrpcAsyncIOTransport(LicenseNotificationServiceTransport):
    """gRPC AsyncIO backend transport for LicenseNotificationService.
    ...
    def list(self) -> Callable[
        ...
        Returns:
            Callable[[~.LicenseNotificationListRequest],
                    Awaitable[~.LicenseNotificationList]]:
