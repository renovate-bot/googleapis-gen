...
def test__get_default_mtls_endpoint():
    ...
    assert CustomerLicenseServiceClient._get_default_mtls_endpoint(None) is None
    assert CustomerLicenseServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert CustomerLicenseServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert CustomerLicenseServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert CustomerLicenseServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert CustomerLicenseServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_customer_license_service_client_from_service_account_info(client_class):
...
def test_customer_license_service_client_service_account_always_use_jwt(client_class):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.CustomerLicenseServiceGrpcTransport, "grpc"),
    (transports.CustomerLicenseServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
def test_customer_license_service_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
def test_customer_license_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
def test_customer_license_service_client_get_transport_class():
    transport = CustomerLicenseServiceClient.get_transport_class()
    available_transports = [
        transports.CustomerLicenseServiceGrpcTransport,
    ]
    assert transport in available_transports

    transport = CustomerLicenseServiceClient.get_transport_class("grpc")
    assert transport == transports.CustomerLicenseServiceGrpcTransport


@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (CustomerLicenseServiceClient, transports.CustomerLicenseServiceGrpcTransport, "grpc"),
    (CustomerLicenseServiceAsyncClient, transports.CustomerLicenseServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_customer_license_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(CustomerLicenseServiceClient, 'get_transport_class') as gtc:
...
def test_customer_license_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_customer_license_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_customer_license_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_customer_license_service_client_client_options_from_dict():
    with mock.patch('ccc.hosted.marketplace_v2.services.customer_license_service.transports.CustomerLicenseServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get(transport: str = 'grpc', request_type=services.CustomerLicenseGetRequest):
    client = CustomerLicenseServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_get_async(transport: str = 'grpc_asyncio', request_type=services.CustomerLicenseGetRequest):
    client = CustomerLicenseServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_customer_license_service_base_transport():
    # Instantiate the base transport.
    with mock.patch('ccc.hosted.marketplace_v2.services.customer_license_service.transports.CustomerLicenseServiceTransport.__init__') as Transport:
...
def test_customer_license_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('ccc.hosted.marketplace_v2.services.customer_license_service.transports.CustomerLicenseServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_customer_license_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('ccc.hosted.marketplace_v2.services.customer_license_service.transports.CustomerLicenseServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CustomerLicenseServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.CustomerLicenseServiceGrpcTransport, transports.CustomerLicenseServiceGrpcAsyncIOTransport])
def test_customer_license_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_customer_license_service_host_no_port():
    client = CustomerLicenseServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_customer_license_service_host_with_port():
    client = CustomerLicenseServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("transport_class", [transports.CustomerLicenseServiceGrpcTransport, transports.CustomerLicenseServiceGrpcAsyncIOTransport])
def test_customer_license_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CustomerLicenseServiceGrpcTransport, transports.CustomerLicenseServiceGrpcAsyncIOTransport])
def test_customer_license_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_parse_common_billing_account_path():
    ...
    actual = CustomerLicenseServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = CustomerLicenseServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = CustomerLicenseServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = CustomerLicenseServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = CustomerLicenseServiceClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.CustomerLicenseServiceTransport, '_prep_wrapped_messages') as prep:
        client = CustomerLicenseServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(transports.CustomerLicenseServiceTransport, '_prep_wrapped_messages') as prep:
        transport_class = CustomerLicenseServiceClient.get_transport_class()
        transport = transport_class(
            credentials=ga_credentials.AnonymousCredentials(),
            client_info=client_info,
        )
