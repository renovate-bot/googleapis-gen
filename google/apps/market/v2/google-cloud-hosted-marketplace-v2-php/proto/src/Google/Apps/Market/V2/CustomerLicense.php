...
class CustomerLicense extends \Google\Protobuf\Internal\Message
{
     ...
     *           The ID of the application corresponding to this license query.
     *     @type \Google\Apps\Market\V2\CustomerLicense\Editions[]|\Google\Protobuf\Internal\RepeatedField $editions
     *           (Deprecated)
     *     @type string $id
     *           The ID of the customer license.
     ...
     *
     * Generated from protobuf field <code>repeated .ccc.hosted.marketplace.v2.CustomerLicense.Editions editions = 4 [deprecated = true];</code>
     * @param \Google\Apps\Market\V2\CustomerLicense\Editions[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     * @deprecated
     */
    ...
    {
        @trigger_error('editions is deprecated.', E_USER_DEPRECATED);
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Apps\Market\V2\CustomerLicense\Editions::class);
        $this->editions = $arr;
