...
class LicenseNotification extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $kind
     *           The type of API resource. This is always appsmarket#licenseNotification.
     *     @type \Ccc\Hosted\Marketplace\V2\LicenseNotification\Provisions[]|\Google\Protobuf\Internal\RepeatedField $provisions
     *           The list of provisioning notifications.
     *     @type \Ccc\Hosted\Marketplace\V2\LicenseNotification\Expiries[]|\Google\Protobuf\Internal\RepeatedField $expiries
     *           The list of expiry notifications.
     *     @type \Ccc\Hosted\Marketplace\V2\LicenseNotification\Reassignments[]|\Google\Protobuf\Internal\RepeatedField $reassignments
     *           The list of reassignment notifications.
     *     @type \Ccc\Hosted\Marketplace\V2\LicenseNotification\Deletes[]|\Google\Protobuf\Internal\RepeatedField $deletes
     *           The list of deletion notifications.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .ccc.hosted.marketplace.v2.LicenseNotification.Provisions provisions = 6;</code>
     * @param \Ccc\Hosted\Marketplace\V2\LicenseNotification\Provisions[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProvisions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Ccc\Hosted\Marketplace\V2\LicenseNotification\Provisions::class);
        $this->provisions = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .ccc.hosted.marketplace.v2.LicenseNotification.Expiries expiries = 7;</code>
     * @param \Ccc\Hosted\Marketplace\V2\LicenseNotification\Expiries[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setExpiries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Ccc\Hosted\Marketplace\V2\LicenseNotification\Expiries::class);
        $this->expiries = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .ccc.hosted.marketplace.v2.LicenseNotification.Reassignments reassignments = 8;</code>
     * @param \Ccc\Hosted\Marketplace\V2\LicenseNotification\Reassignments[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setReassignments($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Ccc\Hosted\Marketplace\V2\LicenseNotification\Reassignments::class);
     ...
     *
     * Generated from protobuf field <code>repeated .ccc.hosted.marketplace.v2.LicenseNotification.Deletes deletes = 9;</code>
     * @param \Ccc\Hosted\Marketplace\V2\LicenseNotification\Deletes[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDeletes($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Ccc\Hosted\Marketplace\V2\LicenseNotification\Deletes::class);
        $this->deletes = $arr;
