...
# Source: google/devtools/remoteworkers/v1test2/bots.proto for package 'google.devtools.remoteworkers.v1test2'
      ...
      module V1test2
        module Bots
          ...
          class Service
            ...
            self.service_name = 'google.devtools.remoteworkers.v1test2.Bots'
            ...
            rpc :CreateBotSession, ::Google::Devtools::Remoteworkers::V1test2::CreateBotSessionRequest, ::Google::Devtools::Remoteworkers::V1test2::BotSession
            ...
            rpc :UpdateBotSession, ::Google::Devtools::Remoteworkers::V1test2::UpdateBotSessionRequest, ::Google::Devtools::Remoteworkers::V1test2::BotSession
          end
