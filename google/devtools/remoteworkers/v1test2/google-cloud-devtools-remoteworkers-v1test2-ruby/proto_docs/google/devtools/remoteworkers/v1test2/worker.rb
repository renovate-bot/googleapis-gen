  ...
  module Devtools
    module Remoteworkers
      module V1test2
        ...
        #   @return [::Array<::Google::Devtools::Remoteworkers::V1test2::Device>]
        #     A list of devices; the first device is the primary device. See the `Device`
        #     message for more information.
        # @!attribute [rw] properties
        #   @return [::Array<::Google::Devtools::Remoteworkers::V1test2::Worker::Property>]
        ...
        #   @return [::Array<::Google::Devtools::Remoteworkers::V1test2::Worker::Config>]
        ...
        # @!attribute [rw] properties
        #   @return [::Array<::Google::Devtools::Remoteworkers::V1test2::Device::Property>]
