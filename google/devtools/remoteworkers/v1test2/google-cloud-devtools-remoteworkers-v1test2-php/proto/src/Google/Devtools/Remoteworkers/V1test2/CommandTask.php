...
class CommandTask extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Devtools\Remoteworkers\V1test2\CommandTask\Inputs::class);
        $this->inputs = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Devtools\Remoteworkers\V1test2\CommandTask\Outputs::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Devtools\Remoteworkers\V1test2\CommandTask\Timeouts::class);
        $this->timeouts = $var;
