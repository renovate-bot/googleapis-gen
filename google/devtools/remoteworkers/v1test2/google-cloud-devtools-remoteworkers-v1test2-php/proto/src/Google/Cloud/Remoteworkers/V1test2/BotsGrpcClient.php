 ...
 * resource."
 */
class BotsGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Cloud\Remoteworkers\V1test2\CreateBotSessionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function CreateBotSession(\Google\Cloud\Remoteworkers\V1test2\CreateBotSessionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.devtools.remoteworkers.v1test2.Bots/CreateBotSession',
        $argument,
        ['\Google\Cloud\Remoteworkers\V1test2\BotSession', 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Cloud\Remoteworkers\V1test2\UpdateBotSessionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function UpdateBotSession(\Google\Cloud\Remoteworkers\V1test2\UpdateBotSessionRequest $argument,
      $metadata = [], $options = []) {
