...
namespace Google\Cloud\Remoteworkers\V1test2\Gapic;
...
use Google\Cloud\Remoteworkers\V1test2\CreateBotSessionRequest;
use Google\Cloud\Remoteworkers\V1test2\UpdateBotSessionRequest;
...
class BotsGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__ . '/../resources/bots_grpc_config.json',
            'credentialsConfig' => [
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a bot_session
     * resource.
     *
     ...
     * ```
     *
     * @param string     $parent       Required. The farm resource.
     * @param BotSession $botSession   Required. The bot session to create. Server-assigned fields like name must be unset.
     ...
     * }
     *
     * @return \Google\Cloud\Remoteworkers\V1test2\BotSession
     *
    ...
    public function createBotSession($parent, $botSession, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateBotSession', BotSession::class, $optionalArgs, $request)->wait();
    }
     ...
     * ```
     *
     * @param string     $name         Required. The bot session name. Must match bot_session.name.
     * @param BotSession $botSession   Required. The bot session resource to update.
     * @param FieldMask  $updateMask   Required. The fields on the bot that should be updated. See the BotSession resource
    ...
    public function updateBotSession($name, $botSession, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateBotSession', BotSession::class, $optionalArgs, $request)->wait();
    }
}
