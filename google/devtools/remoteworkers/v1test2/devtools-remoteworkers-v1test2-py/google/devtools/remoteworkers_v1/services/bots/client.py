...
class BotsClientMeta(type):
    """Metaclass for the Bots client.
...
class BotsClient(metaclass=BotsClientMeta):
    ...
    DEFAULT_ENDPOINT = 'remoteworkers.googleapis.com'
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            BotsClient: The constructed client.
        """
    ...
    def bot_session_path(bot_session: str,) -> str:
        """Return a fully-qualified bot_session string."""
    ...
    def parse_bot_session_path(path: str) -> Dict[str,str]:
        """Parse a bot_session path into its component segments."""
    ...
    def __init__(self, *,
            ...
            transport: Union[str, BotsTransport, None] = None,
        ...
        if isinstance(transport, BotsTransport):
            # transport is a BotsTransport instance.
    ...
    def create_bot_session(self,
        ...
        # in a bots.CreateBotSessionRequest.
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_bot_session]
    ...
    def update_bot_session(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a bots.UpdateBotSessionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_bot_session]
