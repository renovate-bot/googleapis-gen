...
export class ErrorGroupServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.devtools.clouderrorreporting.v1beta1.ErrorGroupService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.errorGroupServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.devtools.clouderrorreporting.v1beta1.ErrorGroupService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.devtools.clouderrorreporting.v1beta1.ErrorGroupService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const errorGroupServiceStubMethods =
 ...
 */
  getGroup(
      ...
      Promise<[
        ...
        protos.google.devtools.clouderrorreporting.v1beta1.IGetGroupRequest|undefined, {}|undefined
      ]>;
  getGroup(
      request: protos.google.devtools.clouderrorreporting.v1beta1.IGetGroupRequest,
      options: CallOptions,
 ...
 */
  updateGroup(
      ...
      Promise<[
        protos.google.devtools.clouderrorreporting.v1beta1.IErrorGroup,
        protos.google.devtools.clouderrorreporting.v1beta1.IUpdateGroupRequest|undefined, {}|undefined
      ]>;
  updateGroup(
      request: protos.google.devtools.clouderrorreporting.v1beta1.IUpdateGroupRequest,
      options: CallOptions,
