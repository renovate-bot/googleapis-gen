...
public interface ErrorContextOrBuilder extends
   ...
   * <code>repeated .google.appengine.logging.v1.SourceReference source_references = 4;</code>
   */
  com.google.appengine.logging.v1.SourceReference getSourceReferences(int index);
  /**
   * <pre>
   * Source code that was used to build the executable which has
   * caused the given error message.
   ...
   * <code>repeated .google.appengine.logging.v1.SourceReference source_references = 4;</code>
   */
  com.google.appengine.logging.v1.SourceReferenceOrBuilder getSourceReferencesOrBuilder(
      int index);
}
