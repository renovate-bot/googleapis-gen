...
public final class ReportErrorsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventRequest,
      com.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventResponse> getReportErrorEventMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventRequest,
      com.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventResponse> getReportErrorEventMethod() {
    io.grpc.MethodDescriptor<com.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventRequest, com.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventResponse> getReportErrorEventMethod;
    if ((getReportErrorEventMethod = ReportErrorsServiceGrpc.getReportErrorEventMethod) == null) {
      synchronized (ReportErrorsServiceGrpc.class) {
        if ((getReportErrorEventMethod = ReportErrorsServiceGrpc.getReportErrorEventMethod) == null) {
          ReportErrorsServiceGrpc.getReportErrorEventMethod = getReportErrorEventMethod =
              io.grpc.MethodDescriptor.<com.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventRequest, com.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReportErrorEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.devtools.clouderrorreporting.v1beta1.ReportErrorEventResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ReportErrorsServiceMethodDescriptorSupplier("ReportErrorEvent"))
              .build();
        }
      }
    }
  ...
  public static ReportErrorsServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ReportErrorsServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ReportErrorsServiceStub>() {
        @java.lang.Override
        public ReportErrorsServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static ReportErrorsServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<ReportErrorsServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ReportErrorsServiceBlockingStub>() {
        @java.lang.Override
        public ReportErrorsServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static ReportErrorsServiceFutureStub newFutureStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<ReportErrorsServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ReportErrorsServiceFutureStub>() {
        @java.lang.Override
        public ReportErrorsServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static final class ReportErrorsServiceStub extends io.grpc.stub.AbstractAsyncStub<ReportErrorsServiceStub> {
   ...
   * </pre>
   */
  public static final class ReportErrorsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ReportErrorsServiceBlockingStub> {
   ...
   * </pre>
   */
  public static final class ReportErrorsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ReportErrorsServiceFutureStub> {
  ...
  private static abstract class ReportErrorsServiceBaseDescriptorSupplier
