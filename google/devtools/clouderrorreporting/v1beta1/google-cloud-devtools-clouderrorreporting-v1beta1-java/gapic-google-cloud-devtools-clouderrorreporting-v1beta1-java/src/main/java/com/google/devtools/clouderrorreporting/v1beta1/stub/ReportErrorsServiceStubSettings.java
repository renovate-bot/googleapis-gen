...
/**
 * Settings class to configure an instance of {@link ReportErrorsServiceStub}.
 *
...
public class ReportErrorsServiceStubSettings extends StubSettings<ReportErrorsServiceStubSettings> {
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(ReportErrorsServiceStubSettings.class))
        .setTransportToken(
  ...
  protected ReportErrorsServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<ReportErrorsServiceStubSettings, Builder> {
    ...
    protected Builder(ReportErrorsServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public ReportErrorsServiceStubSettings build() throws IOException {
      return new ReportErrorsServiceStubSettings(this);
    }
  }
}
