...
class MockErrorStatsServiceCredentials_v1beta1 < Google::Cloud::ErrorReporting::V1beta1::Credentials
...
describe Google::Cloud::ErrorReporting::V1beta1::ErrorStatsServiceClient do
  ...
  describe 'delete_events' do
    custom_error = CustomTestError_v1beta1.new "Custom test error for Google::Cloud::ErrorReporting::V1beta1::ErrorStatsServiceClient#delete_events."
    ...
    it 'invokes delete_events without error' do
      ...
      mock_stub = MockGrpcClientStub_v1beta1.new(:delete_events, mock_method)

      # Mock auth layer
      mock_credentials = MockErrorStatsServiceCredentials_v1beta1.new("delete_events")

      Google::Devtools::Clouderrorreporting::V1beta1::ErrorStatsService::Stub.stub(:new, mock_stub) do
        Google::Cloud::ErrorReporting::V1beta1::Credentials.stub(:default, mock_credentials) do
          ...
          client.delete_events(formatted_project_name) do |response, operation|
            # Verify the response
            assert_equal(expected_response, response)
  ...
  describe 'list_group_stats' do
    custom_error = CustomTestError_v1beta1.new "Custom test error for Google::Cloud::ErrorReporting::V1beta1::ErrorStatsServiceClient#list_group_stats."
    ...
    it 'invokes list_group_stats without error' do
      ...
      mock_stub = MockGrpcClientStub_v1beta1.new(:list_group_stats, mock_method)

      # Mock auth layer
      mock_credentials = MockErrorStatsServiceCredentials_v1beta1.new("list_group_stats")
      ...
      Google::Devtools::Clouderrorreporting::V1beta1::ErrorStatsService::Stub.stub(:new, mock_stub) do
        Google::Cloud::ErrorReporting::V1beta1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          response = client.list_group_stats(formatted_project_name)
    ...
    it 'invokes list_group_stats with error' do
      ...
      Google::Devtools::Clouderrorreporting::V1beta1::ErrorStatsService::Stub.stub(:new, mock_stub) do
        Google::Cloud::ErrorReporting::V1beta1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          err = assert_raises Google::Gax::GaxError, CustomTestError_v1beta1 do
            client.list_group_stats(formatted_project_name)
          end
  ...
  describe 'list_events' do
    custom_error = CustomTestError_v1beta1.new "Custom test error for Google::Cloud::ErrorReporting::V1beta1::ErrorStatsServiceClient#list_events."
    ...
    it 'invokes list_events without error' do
      ...
      mock_stub = MockGrpcClientStub_v1beta1.new(:list_events, mock_method)

      # Mock auth layer
      mock_credentials = MockErrorStatsServiceCredentials_v1beta1.new("list_events")
