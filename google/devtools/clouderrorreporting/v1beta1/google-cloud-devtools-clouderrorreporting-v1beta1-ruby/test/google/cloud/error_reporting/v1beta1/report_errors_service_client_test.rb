...
class MockReportErrorsServiceCredentials_v1beta1 < Google::Cloud::ErrorReporting::V1beta1::Credentials
...
describe Google::Cloud::ErrorReporting::V1beta1::ReportErrorsServiceClient do
  ...
  describe 'report_error_event' do
    custom_error = CustomTestError_v1beta1.new "Custom test error for Google::Cloud::ErrorReporting::V1beta1::ReportErrorsServiceClient#report_error_event."
    ...
    it 'invokes report_error_event without error' do
      ...
      mock_stub = MockGrpcClientStub_v1beta1.new(:report_error_event, mock_method)

      # Mock auth layer
      mock_credentials = MockReportErrorsServiceCredentials_v1beta1.new("report_error_event")
      ...
      Google::Devtools::Clouderrorreporting::V1beta1::ReportErrorsService::Stub.stub(:new, mock_stub) do
        Google::Cloud::ErrorReporting::V1beta1::Credentials.stub(:default, mock_credentials) do
          ...
          client.report_error_event(formatted_project_name, event) do |response, operation|
            # Verify the response
            assert_equal(expected_response, response)
