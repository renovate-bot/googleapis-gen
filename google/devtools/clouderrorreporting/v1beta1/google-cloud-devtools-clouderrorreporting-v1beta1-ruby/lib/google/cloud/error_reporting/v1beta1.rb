      ...
      module V1beta1
        ...
        module ErrorGroup
          ...
          def self.new \
            ...
            Google::Cloud::ErrorReporting::V1beta1::ErrorGroupServiceClient.new(**kwargs)
          end
        end
        ...
        module ErrorStats
          ...
          def self.new \
            ...
            Google::Cloud::ErrorReporting::V1beta1::ErrorStatsServiceClient.new(**kwargs)
          end
        end
        ...
        module ReportErrors
          ...
          def self.new \
            ...
            Google::Cloud::ErrorReporting::V1beta1::ReportErrorsServiceClient.new(**kwargs)
          end
        end
      end
    end
