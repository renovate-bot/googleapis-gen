...
namespace Google\Cloud\ArtifactRegistry\V1\Gapic;
...
class ArtifactRegistryGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.devtools.artifactregistry.v1.ArtifactRegistry';
     ...
     *     $pagedResponse = $artifactRegistryClient->listDockerImages($parent);
     ...
     * @throws ApiException if the remote call fails
     */
    public function listDockerImages($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListDockerImages', $optionalArgs, ListDockerImagesResponse::class, $request);
    }
