...
class Repository(proto.Message):
    ...
    Attributes:
        ...
        format_ (google.devtools.artifactregistry_v1beta2.types.Repository.Format):
            The format of packages that are stored in the
            repository.
        description (str):
            The user-provided description of the
            repository.
        labels (Sequence[google.devtools.artifactregistry_v1beta2.types.Repository.LabelsEntry]):
...
class ListRepositoriesResponse(proto.Message):
    ...
    Attributes:
        repositories (Sequence[google.devtools.artifactregistry_v1beta2.types.Repository]):
