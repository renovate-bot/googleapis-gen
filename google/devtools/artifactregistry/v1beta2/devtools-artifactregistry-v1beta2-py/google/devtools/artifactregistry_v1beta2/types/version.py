...
class Version(proto.Message):
    ...
    Attributes:
        ...
        related_tags (Sequence[google.devtools.artifactregistry_v1beta2.types.Tag]):
...
class ListVersionsRequest(proto.Message):
    ...
    Attributes:
        ...
        page_token (str):
            ...
            request, if any.
        view (google.devtools.artifactregistry_v1beta2.types.VersionView):
...
class ListVersionsResponse(proto.Message):
    ...
    Attributes:
        versions (Sequence[google.devtools.artifactregistry_v1beta2.types.Version]):
