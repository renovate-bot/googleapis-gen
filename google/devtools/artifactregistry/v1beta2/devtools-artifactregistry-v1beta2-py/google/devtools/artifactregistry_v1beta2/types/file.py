...
class Hash(proto.Message):
    ...
    Attributes:
        type_ (google.devtools.artifactregistry_v1beta2.types.Hash.HashType):
...
class File(proto.Message):
    ...
    Attributes:
        ...
        hashes (Sequence[google.devtools.artifactregistry_v1beta2.types.Hash]):
...
class ListFilesResponse(proto.Message):
    ...
    Attributes:
        files (Sequence[google.devtools.artifactregistry_v1beta2.types.File]):
            The files returned.
        next_page_token (str):
