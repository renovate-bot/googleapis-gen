...
from google.devtools.artifactregistry_v1beta2.services.artifact_registry import ArtifactRegistryAsyncClient
from google.devtools.artifactregistry_v1beta2.services.artifact_registry import ArtifactRegistryClient
from google.devtools.artifactregistry_v1beta2.services.artifact_registry import pagers
from google.devtools.artifactregistry_v1beta2.services.artifact_registry import transports
...
def test_artifact_registry_client_client_options_from_dict():
    with mock.patch('google.devtools.artifactregistry_v1beta2.services.artifact_registry.transports.ArtifactRegistryGrpcTransport.__init__') as grpc_transport:
...
def test_artifact_registry_base_transport():
    ...
    with mock.patch('google.devtools.artifactregistry_v1beta2.services.artifact_registry.transports.ArtifactRegistryTransport.__init__') as Transport:
...
def test_artifact_registry_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.devtools.artifactregistry_v1beta2.services.artifact_registry.transports.ArtifactRegistryTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_artifact_registry_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.devtools.artifactregistry_v1beta2.services.artifact_registry.transports.ArtifactRegistryTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ArtifactRegistryTransport()
        adc.assert_called_once()
...
def test_artifact_registry_transport_auth_adc():
    ...
    with mock.patch.object(auth, 'default') as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.ArtifactRegistryGrpcTransport(host="squid.clam.whelk", quota_project_id="octopus")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/cloud-platform',
            'https://www.googleapis.com/auth/cloud-platform.read-only',),
            quota_project_id="octopus",
