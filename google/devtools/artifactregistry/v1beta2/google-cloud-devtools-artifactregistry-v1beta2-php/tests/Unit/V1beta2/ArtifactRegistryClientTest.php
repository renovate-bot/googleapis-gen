...
namespace Google\Devtools\Artifactregistry\Tests\Unit\V1beta2;

use Google\Devtools\Artifactregistry\V1beta2\ArtifactRegistryClient;
...
class ArtifactRegistryClientTest extends GeneratedTest
{
    ...
    public function listRepositoriesTest()
    {
        ...
        $response = $client->listRepositories();
    ...
    public function createRepositoryTest()
    {
        ...
        $response = $client->createRepository();
    ...
    public function deleteRepositoryTest()
    {
        ...
        $response = $client->deleteRepository();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
