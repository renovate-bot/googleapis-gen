      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            if (valueCase_ == 1) {
              subBuilder = ((com.google.devtools.cloudtrace.v2.TruncatableString) value_).toBuilder();
            }
            value_ =
                input.readMessage(com.google.devtools.cloudtrace.v2.TruncatableString.parser(), extensionRegistry);
            if (subBuilder != null) {
