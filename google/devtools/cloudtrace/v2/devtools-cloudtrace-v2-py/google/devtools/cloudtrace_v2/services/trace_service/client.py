...
from google.devtools.cloudtrace_v2.types import trace
from google.devtools.cloudtrace_v2.types import tracing
...
class TraceServiceClient(metaclass=TraceServiceClientMeta):
    ...
    def span_path(project: str,trace: str,span: str,) -> str:
        ...
        return "projects/{project}/traces/{trace}/spans/{span}".format(project=project, trace=trace, span=span, )

    @staticmethod
    def parse_span_path(path: str) -> Dict[str,str]:
        """Parse a span path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/traces/(?P<trace>.+?)/spans/(?P<span>.+?)$", path)
    ...
    def batch_write_spans(self,
        ...
        Args:
            request (google.devtools.cloudtrace_v2.types.BatchWriteSpansRequest):
            ...
            name (str):
                ...
                should not be set.
            spans (Sequence[google.devtools.cloudtrace_v2.types.Span]):
    ...
    def create_span(self,
        ...
        Args:
            request (google.devtools.cloudtrace_v2.types.Span):
        ...
        Returns:
            google.devtools.cloudtrace_v2.types.Span:
