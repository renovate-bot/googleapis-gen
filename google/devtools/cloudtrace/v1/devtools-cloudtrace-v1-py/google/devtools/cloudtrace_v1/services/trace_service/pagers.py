...
from google.devtools.cloudtrace_v1.types import trace
...
class ListTracesPager:
    ...
    :class:`google.devtools.cloudtrace_v1.types.ListTracesResponse` object, and
    ...
    All the usual :class:`google.devtools.cloudtrace_v1.types.ListTracesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.devtools.cloudtrace_v1.types.ListTracesRequest):
                The initial request object.
            response (google.devtools.cloudtrace_v1.types.ListTracesResponse):
