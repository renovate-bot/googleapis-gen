...
class TraceServiceTransport(abc.ABC):
    ...
    @property
    def list_traces(self) -> typing.Callable[
            [trace.ListTracesRequest],
            typing.Union[
                trace.ListTracesResponse,
                typing.Awaitable[trace.ListTracesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_trace(self) -> typing.Callable[
            [trace.GetTraceRequest],
            typing.Union[
                trace.Trace,
                typing.Awaitable[trace.Trace]
            ]]:
        raise NotImplementedError()

    @property
    def patch_traces(self) -> typing.Callable[
