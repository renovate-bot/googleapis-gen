      ...
      module V1
        module TestExecutionService
          ...
          class Client
            ...
            # ## Example
            #
            # To modify the configuration for all TestExecutionService clients:
            #
            ...
            # ## Examples
            #
            # To create a new TestExecutionService client with the default
            # configuration:
            #
            #     client = ::Google::Devtools::Testing::V1::TestExecutionService::Client.new
            #
            # To create a new TestExecutionService client with a custom
            # configuration:
            #
            ...
            def get_test_matrix request, options = nil
              ...
              header_params = {
                "project_id" => request.project_id,
                "test_matrix_id" => request.test_matrix_id
              }
              request_params_header = header_params.map { |k, v| "#{k}=#{v}" }.join("&")
              metadata[:"x-goog-request-params"] ||= request_params_header
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for create_test_matrix
