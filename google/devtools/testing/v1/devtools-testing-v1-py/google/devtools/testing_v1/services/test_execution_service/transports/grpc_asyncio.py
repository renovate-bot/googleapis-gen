...
class TestExecutionServiceGrpcAsyncIOTransport(TestExecutionServiceTransport):
    """gRPC AsyncIO backend transport for TestExecutionService.
    ...
    def create_test_matrix(self) -> Callable[
            ...
            Awaitable[test_execution.TestMatrix]]:
    ...
    def cancel_test_matrix(self) -> Callable[
            ...
            Awaitable[test_execution.CancelTestMatrixResponse]]:
        ...
        Returns:
            Callable[[~.CancelTestMatrixRequest],
                    Awaitable[~.CancelTestMatrixResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
