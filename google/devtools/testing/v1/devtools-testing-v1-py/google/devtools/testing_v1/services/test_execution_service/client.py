...
from .transports.grpc import TestExecutionServiceGrpcTransport
from .transports.grpc_asyncio import TestExecutionServiceGrpcAsyncIOTransport


class TestExecutionServiceClientMeta(type):
    """Metaclass for the TestExecutionService client.
    ...
    def get_transport_class(cls,
            label: str = None,
        ) -> Type[TestExecutionServiceTransport]:
...
class TestExecutionServiceClient(metaclass=TestExecutionServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            TestExecutionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> TestExecutionServiceTransport:
        ...
        Returns:
            TestExecutionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, TestExecutionServiceTransport, None] = None,
        ...
        if isinstance(transport, TestExecutionServiceTransport):
            # transport is a TestExecutionServiceTransport instance.
    ...
    def create_test_matrix(self,
        ...
        # in a test_execution.CreateTestMatrixRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, test_execution.CreateTestMatrixRequest):
            request = test_execution.CreateTestMatrixRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_test_matrix]
    ...
    def get_test_matrix(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a test_execution.GetTestMatrixRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, test_execution.GetTestMatrixRequest):
            request = test_execution.GetTestMatrixRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_test_matrix]
    ...
    def cancel_test_matrix(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a test_execution.CancelTestMatrixRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, test_execution.CancelTestMatrixRequest):
            request = test_execution.CancelTestMatrixRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.cancel_test_matrix]
