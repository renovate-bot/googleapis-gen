...
class TestEnvironmentDiscoveryServiceGrpcAsyncIOTransport(TestEnvironmentDiscoveryServiceTransport):
    """gRPC AsyncIO backend transport for TestEnvironmentDiscoveryService.
    ...
    def get_test_environment_catalog(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetTestEnvironmentCatalogRequest],
                    Awaitable[~.TestEnvironmentCatalog]]:
