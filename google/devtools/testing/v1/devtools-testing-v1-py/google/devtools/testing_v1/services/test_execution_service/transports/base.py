...
class TestExecutionServiceTransport(abc.ABC):
    """Abstract transport class for TestExecutionService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_test_matrix: gapic_v1.method.wrap_method(
                self.create_test_matrix,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_test_matrix: gapic_v1.method.wrap_method(
                self.get_test_matrix,
                default_timeout=None,
                client_info=client_info,
            ),
            self.cancel_test_matrix: gapic_v1.method.wrap_method(
                self.cancel_test_matrix,
                default_timeout=None,
                client_info=client_info,
            ),
         }
