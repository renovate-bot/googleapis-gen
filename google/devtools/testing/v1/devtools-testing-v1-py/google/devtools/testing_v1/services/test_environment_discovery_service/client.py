...
class TestEnvironmentDiscoveryServiceClientMeta(type):
    """Metaclass for the TestEnvironmentDiscoveryService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[TestEnvironmentDiscoveryServiceTransport]]
    _transport_registry["grpc"] = TestEnvironmentDiscoveryServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = TestEnvironmentDiscoveryServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: str = None,
        ) -> Type[TestEnvironmentDiscoveryServiceTransport]:
...
class TestEnvironmentDiscoveryServiceClient(metaclass=TestEnvironmentDiscoveryServiceClientMeta):
    ...
    DEFAULT_ENDPOINT = "testing.googleapis.com"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            TestEnvironmentDiscoveryServiceClient: The constructed client.
        """
    ...
    def transport(self) -> TestEnvironmentDiscoveryServiceTransport:
        ...
        Returns:
            TestEnvironmentDiscoveryServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, TestEnvironmentDiscoveryServiceTransport, None] = None,
        ...
        if isinstance(transport, TestEnvironmentDiscoveryServiceTransport):
            # transport is a TestEnvironmentDiscoveryServiceTransport instance.
    ...
    def get_test_environment_catalog(self,
        ...
        # in a test_environment_discovery.GetTestEnvironmentCatalogRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, test_environment_discovery.GetTestEnvironmentCatalogRequest):
            request = test_environment_discovery.GetTestEnvironmentCatalogRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_test_environment_catalog]
