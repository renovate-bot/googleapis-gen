...
from .base import TestEnvironmentDiscoveryServiceTransport, DEFAULT_CLIENT_INFO


class TestEnvironmentDiscoveryServiceGrpcTransport(TestEnvironmentDiscoveryServiceTransport):
    """gRPC backend transport for TestEnvironmentDiscoveryService.
    ...
    @property
    def get_test_environment_catalog(self) -> Callable[
            [test_environment_discovery.GetTestEnvironmentCatalogRequest],
            test_environment_discovery.TestEnvironmentCatalog]:
        r"""Return a callable for the get test environment catalog method over gRPC.
        ...
        Returns:
            Callable[[~.GetTestEnvironmentCatalogRequest],
                    ~.TestEnvironmentCatalog]:
        ...
        if 'get_test_environment_catalog' not in self._stubs:
            self._stubs['get_test_environment_catalog'] = self.grpc_channel.unary_unary(
                '/google.devtools.testing.v1.TestEnvironmentDiscoveryService/GetTestEnvironmentCatalog',
                request_serializer=test_environment_discovery.GetTestEnvironmentCatalogRequest.serialize,
                response_deserializer=test_environment_discovery.TestEnvironmentCatalog.deserialize,
            )
