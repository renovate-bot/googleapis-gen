...
public final class GrafeasV1Beta1Grpc {
  ...
  public static GrafeasV1Beta1Stub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<GrafeasV1Beta1Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<GrafeasV1Beta1Stub>() {
        @java.lang.Override
        public GrafeasV1Beta1Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static GrafeasV1Beta1BlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<GrafeasV1Beta1BlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<GrafeasV1Beta1BlockingStub>() {
        @java.lang.Override
        public GrafeasV1Beta1BlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static GrafeasV1Beta1FutureStub newFutureStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<GrafeasV1Beta1FutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<GrafeasV1Beta1FutureStub>() {
        @java.lang.Override
        public GrafeasV1Beta1FutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static final class GrafeasV1Beta1Stub extends io.grpc.stub.AbstractAsyncStub<GrafeasV1Beta1Stub> {
    private GrafeasV1Beta1Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected GrafeasV1Beta1Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new GrafeasV1Beta1Stub(channel, callOptions);
    }
   ...
   * </pre>
   */
  public static final class GrafeasV1Beta1BlockingStub extends io.grpc.stub.AbstractBlockingStub<GrafeasV1Beta1BlockingStub> {
    private GrafeasV1Beta1BlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
   ...
   * </pre>
   */
  public static final class GrafeasV1Beta1FutureStub extends io.grpc.stub.AbstractFutureStub<GrafeasV1Beta1FutureStub> {
    private GrafeasV1Beta1FutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
