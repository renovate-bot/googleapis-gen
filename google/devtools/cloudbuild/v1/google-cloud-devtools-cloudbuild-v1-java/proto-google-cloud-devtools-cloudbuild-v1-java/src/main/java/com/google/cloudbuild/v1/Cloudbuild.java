...
public final class Cloudbuild {
  ...
  static {
    ...
    internal_static_google_devtools_cloudbuild_v1_Build_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_devtools_cloudbuild_v1_Build_descriptor,
        new java.lang.String[] { "Name", "Id", "ProjectId", "Status", "StatusDetail", "Source", "Steps", "Results", "CreateTime", "StartTime", "FinishTime", "Timeout", "Images", "QueueTtl", "Artifacts", "LogsBucket", "SourceProvenance", "BuildTriggerId", "Options", "LogUrl", "Substitutions", "Tags", "Secrets", "Timing", "ServiceAccount", });
    internal_static_google_devtools_cloudbuild_v1_Build_SubstitutionsEntry_descriptor =
