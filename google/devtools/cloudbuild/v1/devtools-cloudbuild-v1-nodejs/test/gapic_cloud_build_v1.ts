...
describe('v1.CloudBuildClient', () => {
    ...
    describe('getBuild', () => {
        it('invokes getBuild without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.Build());
            client.innerApiCalls.getBuild = stubSimpleCall(expectedResponse);
            const [response] = await client.getBuild(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getBuild as SinonStub)
    ...
    describe('cancelBuild', () => {
        it('invokes cancelBuild without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.cancelBuild as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createBuildTrigger', () => {
        it('invokes createBuildTrigger without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.BuildTrigger());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createBuildTrigger as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getBuildTrigger', () => {
        it('invokes getBuildTrigger without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getBuildTrigger as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteBuildTrigger', () => {
        it('invokes deleteBuildTrigger without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteBuildTrigger as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateBuildTrigger', () => {
        it('invokes updateBuildTrigger without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateBuildTrigger as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createWorkerPool', () => {
        it('invokes createWorkerPool without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.WorkerPool());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createWorkerPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createWorkerPool without error using callback', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.WorkerPool());
            client.innerApiCalls.createWorkerPool = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes createWorkerPool with error', async () => {
            ...
            const expectedOptions = {};
            const expectedError = new Error('expected');
            client.innerApiCalls.createWorkerPool = stubSimpleCall(undefined, expectedError);
    ...
    describe('getWorkerPool', () => {
        it('invokes getWorkerPool without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getWorkerPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteWorkerPool', () => {
        it('invokes deleteWorkerPool without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteWorkerPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteWorkerPool without error using callback', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.innerApiCalls.deleteWorkerPool = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteWorkerPool with error', async () => {
            ...
            const expectedOptions = {};
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteWorkerPool = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateWorkerPool', () => {
        it('invokes updateWorkerPool without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateWorkerPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateWorkerPool without error using callback', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.WorkerPool());
            client.innerApiCalls.updateWorkerPool = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateWorkerPool with error', async () => {
            ...
            const expectedOptions = {};
            const expectedError = new Error('expected');
            client.innerApiCalls.updateWorkerPool = stubSimpleCall(undefined, expectedError);
    ...
    describe('listWorkerPools', () => {
        it('invokes listWorkerPools without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.ListWorkerPoolsResponse());
            client.innerApiCalls.listWorkerPools = stubSimpleCall(expectedResponse);
            const [response] = await client.listWorkerPools(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listWorkerPools as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listWorkerPools without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listWorkerPools(
                    request,
                    (err?: Error|null, result?: protos.google.devtools.cloudbuild.v1.IListWorkerPoolsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createBuild', () => {
        it('invokes createBuild without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createBuild as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('retryBuild', () => {
        it('invokes retryBuild without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.retryBuild as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('runBuildTrigger', () => {
        it('invokes runBuildTrigger without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runBuildTrigger as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listBuilds', () => {
        ...
        it('uses async iteration with listBuilds with error', async () => {
            ...
            request.projectId = '';
            request.parent = '';
            const expectedHeaderRequestParams = "project_id=&parent=";const expectedError = new Error('expected');
    ...
    describe('listBuildTriggers', () => {
        it('invokes listBuildTriggers without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listBuildTriggers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('Path templates', () => {
        ...
        describe('buildTrigger', () => {
            ...
            client.initialize();
            client.pathTemplates.buildTriggerPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.buildTriggerPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('buildTriggerPath', () => {
                const result = client.buildTriggerPath("projectValue", "triggerValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.buildTriggerPathTemplate.render as SinonStub)
            ...
            it('matchProjectFromBuildTriggerName', () => {
                ...
                assert((client.pathTemplates.buildTriggerPathTemplate.match as SinonStub)
