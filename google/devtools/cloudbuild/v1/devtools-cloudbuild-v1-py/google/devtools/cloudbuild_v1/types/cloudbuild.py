...
class Build(proto.Message):
    ...
    Attributes:
        ...
        options_ (google.devtools.cloudbuild_v1.types.BuildOptions):
    ...
    options_ = proto.Field(proto.MESSAGE, number=23,
...
class BuildTrigger(proto.Message):
    ...
    pubsub_config = proto.Field(proto.MESSAGE, number=29,
