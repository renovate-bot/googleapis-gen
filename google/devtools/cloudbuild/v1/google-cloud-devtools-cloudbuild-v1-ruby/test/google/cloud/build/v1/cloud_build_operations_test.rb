...
class ::Google::Cloud::Build::V1::CloudBuild::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Build::V1::CloudBuild::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Build::V1::CloudBuild::Operations::Configuration, config
  end
end
