...
class BuildEvent extends \Google\Protobuf\Internal\Message
{
     ...
     * @return \Google\Devtools\Build\V1\BuildEvent\InvocationAttemptStarted|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Devtools\Build\V1\BuildEvent\InvocationAttemptStarted::class);
     ...
     * @return \Google\Devtools\Build\V1\BuildEvent\InvocationAttemptFinished|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Devtools\Build\V1\BuildEvent\InvocationAttemptFinished::class);
     ...
     * @return \Google\Devtools\Build\V1\BuildEvent\BuildEnqueued|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Devtools\Build\V1\BuildEvent\BuildEnqueued::class);
     ...
     * @return \Google\Devtools\Build\V1\BuildEvent\BuildFinished|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Devtools\Build\V1\BuildEvent\BuildFinished::class);
     ...
     * @return \Google\Devtools\Build\V1\BuildEvent\ConsoleOutput|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Devtools\Build\V1\BuildEvent\ConsoleOutput::class);
     ...
     * @return \Google\Devtools\Build\V1\BuildEvent\BuildComponentStreamFinished|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Devtools\Build\V1\BuildEvent\BuildComponentStreamFinished::class);
