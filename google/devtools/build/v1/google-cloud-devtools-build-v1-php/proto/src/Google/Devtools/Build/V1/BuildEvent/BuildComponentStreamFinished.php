...
class BuildComponentStreamFinished extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Devtools\Build\V1\BuildEvent\BuildComponentStreamFinished\FinishType::class);
        $this->type = $var;
...
class_alias(BuildComponentStreamFinished::class, \Google\Devtools\Build\V1\BuildEvent_BuildComponentStreamFinished::class);
