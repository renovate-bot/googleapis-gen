...
class BuildStatus extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $build_tool_exit_code = null;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Devtools\Build\V1\BuildStatus\Result::class);
        $this->result = $var;
     ...
     * @return int|null
     */
    public function getBuildToolExitCodeUnwrapped()
    {
     ...
     * @return $this
     */
    public function setBuildToolExitCodeUnwrapped($var)
    {
