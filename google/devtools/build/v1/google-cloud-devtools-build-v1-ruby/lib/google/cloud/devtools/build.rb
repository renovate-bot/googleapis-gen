...
module Google
  module Cloud
    module Devtools
      ...
      ##
      # # Ruby Client for Build Event Service Backend API ([Alpha](https://github.com/GoogleCloudPlatform/google-cloud-ruby#versioning))
      #
      # [Build Event Service Backend API][Product Documentation]:
      # Handles build events from tools such as bazel.
      ...
      # 3. [Enable the Build Event Service Backend API.](https://console.cloud.google.com/apis/library/devtools-build.googleapis.com)
      # 4. [Setup Authentication.](https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud/master/guides/authentication)
      #
      # ### Installation
      # ```
      # $ gem install google-cloud-devtools-build
      # ```
      #
      # ### Next Steps
      # - Read the [Build Event Service Backend API Product documentation][Product Documentation]
      #   to learn more about the product and see How-to Guides.
      # - View this [repository's main README](https://github.com/GoogleCloudPlatform/google-cloud-ruby/blob/master/README.md)
      #   to see the full list of Cloud APIs that we cover.
      #
      # [Product Documentation]: https://cloud.google.com/devtools-build
      #
      # ## Enabling Logging
      #
      ...
      module Build
        ...
        FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("build"))
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Devtools::Build
            .constants
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Devtools::Build.const_get(version_module).new(*args, **kwargs)
        end
      end
    end
  end
