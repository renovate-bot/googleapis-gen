# Ruby Client for the Google Cloud Build V1 API

API Client library for the Google Cloud Build V1 API

google-cloud-build-v1 is the official client library for the Google Cloud Build V1 API.

https://github.com/googleapis/google-cloud-ruby

This gem is a _versioned_ client. It provides basic client classes for a
specific version of the Google Cloud Build V1 API. Most users should consider using
the main client gem,
