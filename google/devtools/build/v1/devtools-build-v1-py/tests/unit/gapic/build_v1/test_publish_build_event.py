...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.PublishBuildEventGrpcTransport, "grpc"),
    (transports.PublishBuildEventGrpcAsyncIOTransport, "grpc_asyncio"),
])
def test_publish_build_event_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_publish_lifecycle_event(request_type, transport: str = 'grpc'):
    client = PublishBuildEventClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_publish_build_tool_event_stream(request_type, transport: str = 'grpc'):
    client = PublishBuildEventClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
