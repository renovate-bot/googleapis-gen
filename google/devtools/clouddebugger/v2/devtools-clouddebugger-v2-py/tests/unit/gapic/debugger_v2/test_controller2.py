...
from google.cloud.debugger_v2.services.controller2.transports.base import _API_CORE_VERSION
from google.cloud.debugger_v2.services.controller2.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert Controller2Client._get_default_mtls_endpoint(None) is None
    assert Controller2Client._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert Controller2Client._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert Controller2Client._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert Controller2Client._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (Controller2AsyncClient, transports.Controller2GrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_controller2_client_client_options(client_class, transport_class, transport_name):
...
def test_controller2_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_controller2_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_controller2_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
@pytest.mark.asyncio
async def test_register_debuggee_async_from_dict():
    await test_register_debuggee_async(request_type=dict)
...
async def test_register_debuggee_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.register_debuggee(
            debuggee=data.Debuggee(id='id_value'),
        )
...
async def test_register_debuggee_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.register_debuggee(
            controller.RegisterDebuggeeRequest(),
            debuggee=data.Debuggee(id='id_value'),
        )
...
@pytest.mark.asyncio
async def test_list_active_breakpoints_async_from_dict():
...
async def test_list_active_breakpoints_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_active_breakpoints(
            controller.ListActiveBreakpointsRequest(),
            debuggee_id='debuggee_id_value',
        )
...
async def test_update_active_breakpoint_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.update_active_breakpoint(
            debuggee_id='debuggee_id_value',
            breakpoint_=data.Breakpoint(id='id_value'),
        )
...
def test_controller2_base_transport():
    # Instantiate the base transport.
    with mock.patch('google.cloud.debugger_v2.services.controller2.transports.Controller2Transport.__init__') as Transport:
...
def test_controller2_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.debugger_v2.services.controller2.transports.Controller2Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_controller2_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.debugger_v2.services.controller2.transports.Controller2Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.Controller2Transport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.Controller2GrpcTransport, transports.Controller2GrpcAsyncIOTransport])
...
def test_controller2_grpc_asyncio_transport_channel():
...
@pytest.mark.parametrize("transport_class", [transports.Controller2GrpcTransport, transports.Controller2GrpcAsyncIOTransport])
def test_controller2_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.Controller2GrpcTransport, transports.Controller2GrpcAsyncIOTransport])
def test_controller2_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_parse_common_billing_account_path():
    ...
    actual = Controller2Client.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = Controller2Client.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = Controller2Client.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = Controller2Client.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = Controller2Client.parse_common_location_path(path)
    assert expected == actual
