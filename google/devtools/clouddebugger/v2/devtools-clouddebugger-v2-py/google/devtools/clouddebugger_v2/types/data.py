...
class StatusMessage(proto.Message):
    ...
    Attributes:
        is_error (bool):
            ...
            messages.
        refers_to (google.devtools.clouddebugger_v2.types.StatusMessage.Reference):
            Reference to which the message applies.
        description (google.devtools.clouddebugger_v2.types.FormatMessage):
            Status message text.
    """
...
class Variable(proto.Message):
    ...
    Attributes:
        ...
        type_ (str):
            ...
            type of an object.
        members (Sequence[google.devtools.clouddebugger_v2.types.Variable]):
        ...
        status (google.devtools.clouddebugger_v2.types.StatusMessage):
...
class StackFrame(proto.Message):
    ...
    Attributes:
        ...
        location (google.devtools.clouddebugger_v2.types.SourceLocation):
            Source location of the call site.
        arguments (Sequence[google.devtools.clouddebugger_v2.types.Variable]):
            Set of arguments passed to this function.
            Note that this might not be populated for all
            stack frames.
        locals_ (Sequence[google.devtools.clouddebugger_v2.types.Variable]):
...
class Breakpoint(proto.Message):
    ...
    Attributes:
        id (str):
            ...
            the debuggee.
        action (google.devtools.clouddebugger_v2.types.Breakpoint.Action):
        ...
        log_level (google.devtools.clouddebugger_v2.types.Breakpoint.LogLevel):
        ...
        stack_frames (Sequence[google.devtools.clouddebugger_v2.types.StackFrame]):
            The stack at breakpoint time, where stack_frames[0]
            represents the most recently entered function.
        evaluated_expressions (Sequence[google.devtools.clouddebugger_v2.types.Variable]):
        ...
        variable_table (Sequence[google.devtools.clouddebugger_v2.types.Variable]):
            ...
            referenced variable.
        labels (Sequence[google.devtools.clouddebugger_v2.types.Breakpoint.LabelsEntry]):
...
class Debuggee(proto.Message):
    ...
    Attributes:
        ...
        ext_source_contexts (Sequence[google.devtools.source.v1.source_context_pb2.ExtendedSourceContext]):
            ...
            the source code used in the deployed
            application.
        labels (Sequence[google.devtools.clouddebugger_v2.types.Debuggee.LabelsEntry]):
