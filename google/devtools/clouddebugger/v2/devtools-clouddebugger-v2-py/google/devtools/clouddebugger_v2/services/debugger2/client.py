...
class Debugger2Client(metaclass=Debugger2ClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            Debugger2Client: The constructed client.
        """
    ...
    def transport(self) -> Debugger2Transport:
        ...
        Returns:
            Debugger2Transport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, Debugger2Transport):
            # transport is a Debugger2Transport instance.
    ...
    def set_breakpoint(self,
        ...
        Returns:
            google.devtools.clouddebugger_v2.types.SetBreakpointResponse:
        ...
        # in a debugger.SetBreakpointRequest.
    ...
    def get_breakpoint(self,
        ...
        Returns:
            google.devtools.clouddebugger_v2.types.GetBreakpointResponse:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a debugger.GetBreakpointRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_breakpoint(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a debugger.DeleteBreakpointRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_breakpoints(self,
        ...
        Returns:
            google.devtools.clouddebugger_v2.types.ListBreakpointsResponse:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a debugger.ListBreakpointsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_debuggees(self,
        ...
        Returns:
            google.devtools.clouddebugger_v2.types.ListDebuggeesResponse:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a debugger.ListDebuggeesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
