...
class Controller2Transport(abc.ABC):
    ...
    @property
    def register_debuggee(self) -> typing.Callable[
            [controller.RegisterDebuggeeRequest],
            typing.Union[
                controller.RegisterDebuggeeResponse,
                typing.Awaitable[controller.RegisterDebuggeeResponse]
            ]]:
        raise NotImplementedError()

    @property
    def list_active_breakpoints(self) -> typing.Callable[
            [controller.ListActiveBreakpointsRequest],
            typing.Union[
                controller.ListActiveBreakpointsResponse,
                typing.Awaitable[controller.ListActiveBreakpointsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def update_active_breakpoint(self) -> typing.Callable[
            [controller.UpdateActiveBreakpointRequest],
            typing.Union[
                controller.UpdateActiveBreakpointResponse,
                typing.Awaitable[controller.UpdateActiveBreakpointResponse]
            ]]:
        raise NotImplementedError()
