...
class Controller2AsyncClient:
    ...
    from_service_account_info = Controller2Client.from_service_account_info
    from_service_account_file = Controller2Client.from_service_account_file
    ...
    async def register_debuggee(self,
        ...
        Returns:
            google.devtools.clouddebugger_v2.types.RegisterDebuggeeResponse:
    ...
    async def list_active_breakpoints(self,
        ...
        Returns:
            google.devtools.clouddebugger_v2.types.ListActiveBreakpointsResponse:
    ...
    async def update_active_breakpoint(self,
        ...
        Returns:
            google.devtools.clouddebugger_v2.types.UpdateActiveBreakpointResponse:
