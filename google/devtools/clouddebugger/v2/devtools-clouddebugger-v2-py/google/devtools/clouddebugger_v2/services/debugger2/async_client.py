...
class Debugger2AsyncClient:
    ...
    from_service_account_info = Debugger2Client.from_service_account_info
    from_service_account_file = Debugger2Client.from_service_account_file
    ...
    async def set_breakpoint(self,
        ...
        Args:
            ...
            debuggee_id (:class:`str`):
                ...
                should not be set.
            breakpoint_ (:class:`google.devtools.clouddebugger_v2.types.Breakpoint`):
