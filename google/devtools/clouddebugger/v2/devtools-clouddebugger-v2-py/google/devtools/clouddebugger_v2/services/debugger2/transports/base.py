...
class Debugger2Transport(abc.ABC):
    ...
    @property
    def set_breakpoint(self) -> typing.Callable[
            [debugger.SetBreakpointRequest],
            typing.Union[
                debugger.SetBreakpointResponse,
                typing.Awaitable[debugger.SetBreakpointResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_breakpoint(self) -> typing.Callable[
            [debugger.GetBreakpointRequest],
            typing.Union[
                debugger.GetBreakpointResponse,
                typing.Awaitable[debugger.GetBreakpointResponse]
            ]]:
        raise NotImplementedError()

    @property
    def delete_breakpoint(self) -> typing.Callable[
    ...
    @property
    def list_breakpoints(self) -> typing.Callable[
            [debugger.ListBreakpointsRequest],
            typing.Union[
                debugger.ListBreakpointsResponse,
                typing.Awaitable[debugger.ListBreakpointsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def list_debuggees(self) -> typing.Callable[
            [debugger.ListDebuggeesRequest],
            typing.Union[
                debugger.ListDebuggeesResponse,
                typing.Awaitable[debugger.ListDebuggeesResponse]
            ]]:
        raise NotImplementedError()
