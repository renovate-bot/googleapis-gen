...
class Controller2GrpcAsyncIOTransport(Controller2Transport):
    """gRPC AsyncIO backend transport for Controller2.
    ...
    def register_debuggee(self) -> Callable[
            ...
            Awaitable[controller.RegisterDebuggeeResponse]]:
        ...
        Returns:
            Callable[[~.RegisterDebuggeeRequest],
                    Awaitable[~.RegisterDebuggeeResponse]]:
    ...
    def list_active_breakpoints(self) -> Callable[
            ...
            Awaitable[controller.ListActiveBreakpointsResponse]]:
        ...
        Returns:
            Callable[[~.ListActiveBreakpointsRequest],
                    Awaitable[~.ListActiveBreakpointsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def update_active_breakpoint(self) -> Callable[
            ...
            Awaitable[controller.UpdateActiveBreakpointResponse]]:
        ...
        Returns:
            Callable[[~.UpdateActiveBreakpointRequest],
                    Awaitable[~.UpdateActiveBreakpointResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
