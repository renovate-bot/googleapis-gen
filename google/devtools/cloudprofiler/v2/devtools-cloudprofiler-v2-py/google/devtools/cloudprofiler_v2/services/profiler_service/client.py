...
class ProfilerServiceClientMeta(type):
    """Metaclass for the ProfilerService client.
...
class ProfilerServiceClient(metaclass=ProfilerServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ProfilerServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ProfilerServiceTransport:
        ...
        Returns:
            ProfilerServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, ProfilerServiceTransport):
            # transport is a ProfilerServiceTransport instance.
    ...
    def create_profile(self,
        ...
        if not isinstance(request, profiler.CreateProfileRequest):
    ...
    def create_offline_profile(self,
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, profiler.CreateOfflineProfileRequest):
            request = profiler.CreateOfflineProfileRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_offline_profile]
    ...
    def update_profile(self,
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, profiler.UpdateProfileRequest):
