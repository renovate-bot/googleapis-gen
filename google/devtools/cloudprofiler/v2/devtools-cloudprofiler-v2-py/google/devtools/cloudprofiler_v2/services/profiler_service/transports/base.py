...
class ProfilerServiceTransport(abc.ABC):
    """Abstract transport class for ProfilerService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.create_offline_profile: gapic_v1.method.wrap_method(
                self.create_offline_profile,
    ...
    def create_profile(self) -> typing.Callable[
            ...
            typing.Union[
                profiler.Profile,
                typing.Awaitable[profiler.Profile]
            ]]:
        raise NotImplementedError()

    @property
    def create_offline_profile(self) -> typing.Callable[
