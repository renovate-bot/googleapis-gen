...
class MetricsV1Beta3GapicClient
{
    ...
    public function getJobExecutionDetails(array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('GetJobExecutionDetails', $optionalArgs, JobExecutionDetails::class, $request);
    }
    ...
    public function getJobMetrics(array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetJobMetrics', JobMetrics::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getStageExecutionDetails(array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('GetStageExecutionDetails', $optionalArgs, StageExecutionDetails::class, $request);
    }
}
