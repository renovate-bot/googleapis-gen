...
class MessagesV1Beta3GapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/messages_v1_beta3_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/messages_v1_beta3_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/messages_v1_beta3_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/messages_v1_beta3_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function listJobMessages(array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('ListJobMessages', $optionalArgs, ListJobMessagesResponse::class, $request);
    }
}
