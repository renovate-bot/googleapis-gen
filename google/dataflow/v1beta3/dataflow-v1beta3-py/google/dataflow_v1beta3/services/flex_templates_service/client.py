...
class FlexTemplatesServiceClient(metaclass=FlexTemplatesServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, FlexTemplatesServiceTransport):
    ...
    def launch_flex_template(self,
        ...
        Args:
            request (google.dataflow_v1beta3.types.LaunchFlexTemplateRequest):
        ...
        Returns:
            google.dataflow_v1beta3.types.LaunchFlexTemplateResponse:
        ...
        # in a templates.LaunchFlexTemplateRequest.
