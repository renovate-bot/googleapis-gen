...
from .base import FlexTemplatesServiceTransport, DEFAULT_CLIENT_INFO
...
class FlexTemplatesServiceGrpcAsyncIOTransport(FlexTemplatesServiceTransport):
    ...
    @property
    def launch_flex_template(self) -> Callable[
        ...
        if 'launch_flex_template' not in self._stubs:
            self._stubs['launch_flex_template'] = self.grpc_channel.unary_unary(
