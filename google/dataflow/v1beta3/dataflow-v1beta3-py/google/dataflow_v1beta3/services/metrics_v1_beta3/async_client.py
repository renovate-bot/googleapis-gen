...
class MetricsV1Beta3AsyncClient:
    ...
    async def get_job_metrics(self,
        ...
        Args:
            request (:class:`google.dataflow_v1beta3.types.GetJobMetricsRequest`):
        ...
        Returns:
            google.dataflow_v1beta3.types.JobMetrics:
    ...
    async def get_job_execution_details(self,
        ...
        Args:
            request (:class:`google.dataflow_v1beta3.types.GetJobExecutionDetailsRequest`):
        ...
        Returns:
            google.dataflow_v1beta3.services.metrics_v1_beta3.pagers.GetJobExecutionDetailsAsyncPager:
    ...
    async def get_stage_execution_details(self,
        ...
        Args:
            request (:class:`google.dataflow_v1beta3.types.GetStageExecutionDetailsRequest`):
        ...
        Returns:
            google.dataflow_v1beta3.services.metrics_v1_beta3.pagers.GetStageExecutionDetailsAsyncPager:
