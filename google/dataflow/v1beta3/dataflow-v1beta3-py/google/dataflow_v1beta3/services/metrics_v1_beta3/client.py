...
class MetricsV1Beta3Client(metaclass=MetricsV1Beta3ClientMeta):
    ...
    def get_job_metrics(self,
        ...
        Args:
            request (google.dataflow_v1beta3.types.GetJobMetricsRequest):
    ...
    def get_job_execution_details(self,
        ...
        Returns:
            google.dataflow_v1beta3.services.metrics_v1_beta3.pagers.GetJobExecutionDetailsPager:
    ...
    def get_stage_execution_details(self,
        ...
        Returns:
            google.dataflow_v1beta3.services.metrics_v1_beta3.pagers.GetStageExecutionDetailsPager:
