...
from .base import MetricsV1Beta3Transport, DEFAULT_CLIENT_INFO
...
class MetricsV1Beta3GrpcAsyncIOTransport(MetricsV1Beta3Transport):
    ...
    @property
    def get_job_metrics(self) -> Callable[
            [metrics.GetJobMetricsRequest],
            Awaitable[metrics.JobMetrics]]:
        ...
        if 'get_job_metrics' not in self._stubs:
            self._stubs['get_job_metrics'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_job_execution_details(self) -> Callable[
            [metrics.GetJobExecutionDetailsRequest],
            Awaitable[metrics.JobExecutionDetails]]:
        ...
        if 'get_job_execution_details' not in self._stubs:
            self._stubs['get_job_execution_details'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_stage_execution_details(self) -> Callable[
        ...
        if 'get_stage_execution_details' not in self._stubs:
            self._stubs['get_stage_execution_details'] = self.grpc_channel.unary_unary(
