...
class MessagesV1Beta3AsyncClient:
    ...
    common_billing_account_path = staticmethod(MessagesV1Beta3Client.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(MessagesV1Beta3Client.parse_common_billing_account_path)
    common_folder_path = staticmethod(MessagesV1Beta3Client.common_folder_path)
    parse_common_folder_path = staticmethod(MessagesV1Beta3Client.parse_common_folder_path)
    common_organization_path = staticmethod(MessagesV1Beta3Client.common_organization_path)
    parse_common_organization_path = staticmethod(MessagesV1Beta3Client.parse_common_organization_path)
    common_project_path = staticmethod(MessagesV1Beta3Client.common_project_path)
    parse_common_project_path = staticmethod(MessagesV1Beta3Client.parse_common_project_path)
    common_location_path = staticmethod(MessagesV1Beta3Client.common_location_path)
    parse_common_location_path = staticmethod(MessagesV1Beta3Client.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(MessagesV1Beta3Client).get_transport_class, type(MessagesV1Beta3Client))
    ...
    async def list_job_messages(self,
