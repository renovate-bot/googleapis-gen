...
class SnapshotsV1Beta3Client(metaclass=SnapshotsV1Beta3ClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, SnapshotsV1Beta3Transport, None] = None,
        ...
        if isinstance(transport, SnapshotsV1Beta3Transport):
    ...
    def get_snapshot(self,
        ...
        Args:
            request (google.dataflow_v1beta3.types.GetSnapshotRequest):
        ...
        # in a snapshots.GetSnapshotRequest.
    ...
    def delete_snapshot(self,
        ...
        Args:
            request (google.dataflow_v1beta3.types.DeleteSnapshotRequest):
        ...
        Returns:
            google.dataflow_v1beta3.types.DeleteSnapshotResponse:
                Response from deleting a snapshot.
        """
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a snapshots.DeleteSnapshotRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_snapshots(self,
        ...
        Args:
            request (google.dataflow_v1beta3.types.ListSnapshotsRequest):
        ...
        Returns:
            google.dataflow_v1beta3.types.ListSnapshotsResponse:
                List of snapshots.
        """
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a snapshots.ListSnapshotsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
