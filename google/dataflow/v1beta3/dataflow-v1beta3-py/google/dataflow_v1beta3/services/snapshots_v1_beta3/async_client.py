...
class SnapshotsV1Beta3AsyncClient:
    ...
    get_transport_class = functools.partial(type(SnapshotsV1Beta3Client).get_transport_class, type(SnapshotsV1Beta3Client))
    ...
    async def get_snapshot(self,
        ...
        Args:
            request (:class:`google.dataflow_v1beta3.types.GetSnapshotRequest`):
    ...
    async def delete_snapshot(self,
        ...
        Args:
            request (:class:`google.dataflow_v1beta3.types.DeleteSnapshotRequest`):
    ...
    async def list_snapshots(self,
        ...
        Args:
            request (:class:`google.dataflow_v1beta3.types.ListSnapshotsRequest`):
