...
class ListJobsPager:
    ...
    :class:`google.dataflow_v1beta3.types.ListJobsResponse` object, and
    ...
    All the usual :class:`google.dataflow_v1beta3.types.ListJobsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.dataflow_v1beta3.types.ListJobsResponse):
