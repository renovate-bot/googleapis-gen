...
from .base import JobsV1Beta3Transport, DEFAULT_CLIENT_INFO
...
class JobsV1Beta3GrpcTransport(JobsV1Beta3Transport):
    ...
    @property
    def aggregated_list_jobs(self) -> Callable[
            [jobs.ListJobsRequest],
            jobs.ListJobsResponse]:
    ...
    @property
    def check_active_jobs(self) -> Callable[
    ...
    @property
    def snapshot_job(self) -> Callable[
