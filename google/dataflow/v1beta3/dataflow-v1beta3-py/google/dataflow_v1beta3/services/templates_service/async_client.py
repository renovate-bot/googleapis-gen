...
class TemplatesServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(TemplatesServiceClient).get_transport_class, type(TemplatesServiceClient))
    ...
    async def create_job_from_template(self,
        ...
        Args:
            request (:class:`google.dataflow_v1beta3.types.CreateJobFromTemplateRequest`):
    ...
    async def launch_template(self,
        ...
        Args:
            request (:class:`google.dataflow_v1beta3.types.LaunchTemplateRequest`):
    ...
    async def get_template(self,
        ...
        Args:
            request (:class:`google.dataflow_v1beta3.types.GetTemplateRequest`):
