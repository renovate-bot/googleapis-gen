...
from .base import TemplatesServiceTransport, DEFAULT_CLIENT_INFO
...
class TemplatesServiceGrpcAsyncIOTransport(TemplatesServiceTransport):
    ...
    def create_job_from_template(self) -> Callable[
        ...
        if 'create_job_from_template' not in self._stubs:
            self._stubs['create_job_from_template'] = self.grpc_channel.unary_unary(
    ...
    def launch_template(self) -> Callable[
        ...
        if 'launch_template' not in self._stubs:
            self._stubs['launch_template'] = self.grpc_channel.unary_unary(
    ...
    def get_template(self) -> Callable[
            ...
            Awaitable[templates.GetTemplateResponse]]:
        ...
        if 'get_template' not in self._stubs:
            self._stubs['get_template'] = self.grpc_channel.unary_unary(
