...
class TemplatesServiceClient(metaclass=TemplatesServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, TemplatesServiceTransport):
    ...
    def create_job_from_template(self,
        ...
        Args:
            request (google.dataflow_v1beta3.types.CreateJobFromTemplateRequest):
        ...
        # in a templates.CreateJobFromTemplateRequest.
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_job_from_template]
    ...
    def launch_template(self,
        ...
        Args:
            request (google.dataflow_v1beta3.types.LaunchTemplateRequest):
        ...
        Returns:
            google.dataflow_v1beta3.types.LaunchTemplateResponse:
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a templates.LaunchTemplateRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.launch_template]
    ...
    def get_template(self,
        ...
        Args:
            request (google.dataflow_v1beta3.types.GetTemplateRequest):
        ...
        Returns:
            google.dataflow_v1beta3.types.GetTemplateResponse:
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a templates.GetTemplateRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_template]
