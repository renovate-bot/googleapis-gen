...
class TopologyConfig(proto.Message):
    ...
    Attributes:
        computations (Sequence[google.dataflow_v1beta3.types.ComputationTopology]):
            The computations associated with a streaming
            Dataflow job.
        data_disk_assignments (Sequence[google.dataflow_v1beta3.types.DataDiskAssignment]):
            The disks assigned to a streaming Dataflow
            job.
        user_stage_to_computation_name_map (Sequence[google.dataflow_v1beta3.types.TopologyConfig.UserStageToComputationNameMapEntry]):
...
class StreamLocation(proto.Message):
    ...
    Attributes:
        streaming_stage_location (google.dataflow_v1beta3.types.StreamingStageLocation):
            The stream is part of another computation
            within the current streaming Dataflow job.
        pubsub_location (google.dataflow_v1beta3.types.PubsubLocation):
            The stream is a pubsub stream.
        side_input_location (google.dataflow_v1beta3.types.StreamingSideInputLocation):
            The stream is a streaming side input.
        custom_source_location (google.dataflow_v1beta3.types.CustomSourceLocation):
...
class ComputationTopology(proto.Message):
    ...
    Attributes:
        ...
        key_ranges (Sequence[google.dataflow_v1beta3.types.KeyRangeLocation]):
            The key ranges processed by the computation.
        inputs (Sequence[google.dataflow_v1beta3.types.StreamLocation]):
            The inputs to the computation.
        outputs (Sequence[google.dataflow_v1beta3.types.StreamLocation]):
            The outputs from the computation.
        state_families (Sequence[google.dataflow_v1beta3.types.StateFamilyConfig]):
...
class StreamingComputationRanges(proto.Message):
    ...
    Attributes:
        computation_id (str):
            The ID of the computation.
        range_assignments (Sequence[google.dataflow_v1beta3.types.KeyRangeDataDiskAssignment]):
