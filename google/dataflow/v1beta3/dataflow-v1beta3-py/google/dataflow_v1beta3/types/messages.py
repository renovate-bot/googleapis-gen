...
class JobMessage(proto.Message):
    ...
    Attributes:
        ...
        message_importance (google.dataflow_v1beta3.types.JobMessageImportance):
...
class StructuredMessage(proto.Message):
    ...
    Attributes:
        ...
        message_key (str):
            ...
            personalize message.
        parameters (Sequence[google.dataflow_v1beta3.types.StructuredMessage.Parameter]):
...
class AutoscalingEvent(proto.Message):
    ...
    Attributes:
        ...
        event_type (google.dataflow_v1beta3.types.AutoscalingEvent.AutoscalingEventType):
            The type of autoscaling event to report.
        description (google.dataflow_v1beta3.types.StructuredMessage):
...
class ListJobMessagesRequest(proto.Message):
    ...
    Attributes:
        ...
        minimum_importance (google.dataflow_v1beta3.types.JobMessageImportance):
...
class ListJobMessagesResponse(proto.Message):
    ...
    Attributes:
        job_messages (Sequence[google.dataflow_v1beta3.types.JobMessage]):
            Messages in ascending timestamp order.
        next_page_token (str):
            The token to obtain the next page of results
            if there are more.
        autoscaling_events (Sequence[google.dataflow_v1beta3.types.AutoscalingEvent]):
