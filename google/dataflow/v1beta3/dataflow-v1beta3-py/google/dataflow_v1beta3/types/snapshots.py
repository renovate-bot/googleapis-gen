...
class Snapshot(proto.Message):
    ...
    Attributes:
        ...
        state (google.dataflow_v1beta3.types.SnapshotState):
            State of the snapshot.
        pubsub_metadata (Sequence[google.dataflow_v1beta3.types.PubsubSnapshotMetadata]):
...
class ListSnapshotsResponse(proto.Message):
    r"""List of snapshots.
    Attributes:
        snapshots (Sequence[google.dataflow_v1beta3.types.Snapshot]):
            Returned snapshots.
    """
