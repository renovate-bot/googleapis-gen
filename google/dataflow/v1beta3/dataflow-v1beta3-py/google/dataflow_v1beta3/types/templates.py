...
from google.dataflow_v1beta3.types import environment as gd_environment
...
class LaunchFlexTemplateResponse(proto.Message):
    ...
    Attributes:
        job (google.dataflow_v1beta3.types.Job):
...
class ContainerSpec(proto.Message):
    ...
    Attributes:
        ...
        metadata (google.dataflow_v1beta3.types.TemplateMetadata):
            Metadata describing a template including
            description and validation rules.
        sdk_info (google.dataflow_v1beta3.types.SDKInfo):
            Required. SDK info of the Flex Template.
        default_environment (google.dataflow_v1beta3.types.FlexTemplateRuntimeEnvironment):
...
class LaunchFlexTemplateParameter(proto.Message):
    ...
    Attributes:
        ...
        container_spec (google.dataflow_v1beta3.types.ContainerSpec):
            Spec about the container image to launch.
        container_spec_gcs_path (str):
            Cloud Storage path to a file with json
            serialized ContainerSpec as content.
        parameters (Sequence[google.dataflow_v1beta3.types.LaunchFlexTemplateParameter.ParametersEntry]):
            The parameters for FlexTemplate. Ex. {"num_workers":"5"}
        launch_options (Sequence[google.dataflow_v1beta3.types.LaunchFlexTemplateParameter.LaunchOptionsEntry]):
            ...
            job parameters.
        environment (google.dataflow_v1beta3.types.FlexTemplateRuntimeEnvironment):
        ...
        transform_name_mappings (Sequence[google.dataflow_v1beta3.types.LaunchFlexTemplateParameter.TransformNameMappingsEntry]):
...
class FlexTemplateRuntimeEnvironment(proto.Message):
    ...
    Attributes:
        ...
        subnetwork (str):
            ...
            the complete URL.
        additional_user_labels (Sequence[google.dataflow_v1beta3.types.FlexTemplateRuntimeEnvironment.AdditionalUserLabelsEntry]):
        ...
        ip_configuration (google.dataflow_v1beta3.types.WorkerIPAddressConfiguration):
        ...
        enable_streaming_engine (bool):
            ...
            job.
        flexrs_goal (google.dataflow_v1beta3.types.FlexResourceSchedulingGoal):
...
class LaunchFlexTemplateRequest(proto.Message):
    ...
    Attributes:
        ...
        launch_parameter (google.dataflow_v1beta3.types.LaunchFlexTemplateParameter):
...
class RuntimeEnvironment(proto.Message):
    ...
    Attributes:
        ...
        subnetwork (str):
            ...
            subnetwork is located in a Shared VPC network, you must use
            the complete URL.
        additional_user_labels (Sequence[google.dataflow_v1beta3.types.RuntimeEnvironment.AdditionalUserLabelsEntry]):
            Additional user labels to be specified for the job. Keys and
...
class ParameterMetadata(proto.Message):
    ...
    Attributes:
        ...
        regexes (Sequence[str]):
            ...
            match.
        param_type (google.dataflow_v1beta3.types.ParameterType):
            Optional. The type of the parameter.
            Used for selecting input picker.
        custom_metadata (Sequence[google.dataflow_v1beta3.types.ParameterMetadata.CustomMetadataEntry]):
...
class TemplateMetadata(proto.Message):
    ...
    Attributes:
        ...
        parameters (Sequence[google.dataflow_v1beta3.types.ParameterMetadata]):
...
class SDKInfo(proto.Message):
    r"""SDK Information.
    Attributes:
        language (google.dataflow_v1beta3.types.SDKInfo.Language):
...
class CreateJobFromTemplateRequest(proto.Message):
    ...
    Attributes:
        ...
        gcs_path (str):
            ...
            with ``gs://``.
        parameters (Sequence[google.dataflow_v1beta3.types.CreateJobFromTemplateRequest.ParametersEntry]):
            The runtime parameters to pass to the job.
        environment (google.dataflow_v1beta3.types.RuntimeEnvironment):
...
class GetTemplateRequest(proto.Message):
    ...
    Attributes:
        ...
        gcs_path (str):
            ...
            'gs://'.
        view (google.dataflow_v1beta3.types.GetTemplateRequest.TemplateView):
...
class GetTemplateResponse(proto.Message):
    ...
    Attributes:
        ...
        template_type (google.dataflow_v1beta3.types.GetTemplateResponse.TemplateType):
            Template Type.
        runtime_metadata (google.dataflow_v1beta3.types.RuntimeMetadata):
...
class LaunchTemplateParameters(proto.Message):
    ...
    Attributes:
        job_name (str):
            Required. The job name to use for the created
            job.
        parameters (Sequence[google.dataflow_v1beta3.types.LaunchTemplateParameters.ParametersEntry]):
            The runtime parameters to pass to the job.
        environment (google.dataflow_v1beta3.types.RuntimeEnvironment):
            The runtime environment for the job.
        update (bool):
        ...
        transform_name_mapping (Sequence[google.dataflow_v1beta3.types.LaunchTemplateParameters.TransformNameMappingEntry]):
...
class LaunchTemplateRequest(proto.Message):
    ...
    Attributes:
        ...
        gcs_path (str):
            ...
            Must be valid Cloud Storage URL, beginning with
            'gs://'.
        dynamic_template (google.dataflow_v1beta3.types.DynamicTemplateLaunchParams):
            Params for launching a dynamic template.
        launch_parameters (google.dataflow_v1beta3.types.LaunchTemplateParameters):
...
class InvalidTemplateParameters(proto.Message):
    ...
    Attributes:
        parameter_violations (Sequence[google.dataflow_v1beta3.types.InvalidTemplateParameters.ParameterViolation]):
