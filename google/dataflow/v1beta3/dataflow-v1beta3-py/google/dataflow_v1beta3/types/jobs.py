...
class Job(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.dataflow_v1beta3.types.JobType):
            The type of Cloud Dataflow job.
        environment (google.dataflow_v1beta3.types.Environment):
            The environment for the job.
        steps (Sequence[google.dataflow_v1beta3.types.Step]):
        ...
        steps_location (str):
            ...
            are stored.
        current_state (google.dataflow_v1beta3.types.JobState):
        ...
        current_state_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            state.
        requested_state (google.dataflow_v1beta3.types.JobState):
            ...
            state.
        execution_info (google.dataflow_v1beta3.types.JobExecutionInfo):
            Deprecated.
        ...
        transform_name_mapping (Sequence[google.dataflow_v1beta3.types.Job.TransformNameMappingEntry]):
        ...
        labels (Sequence[google.dataflow_v1beta3.types.Job.LabelsEntry]):
        ...
        pipeline_description (google.dataflow_v1beta3.types.PipelineDescription):
        ...
        stage_states (Sequence[google.dataflow_v1beta3.types.ExecutionStageState]):
            This field may be mutated by the Cloud
            Dataflow service; callers cannot mutate it.
        job_metadata (google.dataflow_v1beta3.types.JobMetadata):
...
class SdkVersion(proto.Message):
    ...
    Attributes:
        ...
        version_display_name (str):
            ...
            the SDK.
        sdk_support_status (google.dataflow_v1beta3.types.SdkVersion.SdkSupportStatus):
...
class JobMetadata(proto.Message):
    ...
    Attributes:
        sdk_version (google.dataflow_v1beta3.types.SdkVersion):
            The SDK version used to run the job.
        spanner_details (Sequence[google.dataflow_v1beta3.types.SpannerIODetails]):
            Identification of a Spanner source used in
            the Dataflow job.
        bigquery_details (Sequence[google.dataflow_v1beta3.types.BigQueryIODetails]):
            Identification of a BigQuery source used in
            the Dataflow job.
        big_table_details (Sequence[google.dataflow_v1beta3.types.BigTableIODetails]):
            Identification of a Cloud BigTable source
            used in the Dataflow job.
        pubsub_details (Sequence[google.dataflow_v1beta3.types.PubSubIODetails]):
            Identification of a PubSub source used in the
            Dataflow job.
        file_details (Sequence[google.dataflow_v1beta3.types.FileIODetails]):
            Identification of a File source used in the
            Dataflow job.
        datastore_details (Sequence[google.dataflow_v1beta3.types.DatastoreIODetails]):
...
class ExecutionStageState(proto.Message):
    ...
    Attributes:
        ...
        execution_stage_state (google.dataflow_v1beta3.types.JobState):
...
class PipelineDescription(proto.Message):
    ...
    Attributes:
        original_pipeline_transform (Sequence[google.dataflow_v1beta3.types.TransformSummary]):
            Description of each transform in the pipeline
            and collections between them.
        execution_pipeline_stage (Sequence[google.dataflow_v1beta3.types.ExecutionStageSummary]):
            Description of each stage of execution of the
            pipeline.
        display_data (Sequence[google.dataflow_v1beta3.types.DisplayData]):
...
class TransformSummary(proto.Message):
    ...
    Attributes:
        kind (google.dataflow_v1beta3.types.KindType):
            Type of transform.
        id (str):
...
class ExecutionStageSummary(proto.Message):
    ...
    Attributes:
        ...
        input_source (Sequence[google.dataflow_v1beta3.types.ExecutionStageSummary.StageSource]):
            Input sources for this stage.
        output_source (Sequence[google.dataflow_v1beta3.types.ExecutionStageSummary.StageSource]):
            Output sources for this stage.
        prerequisite_stage (Sequence[str]):
            Other stages that must complete before this
            stage can run.
        component_transform (Sequence[google.dataflow_v1beta3.types.ExecutionStageSummary.ComponentTransform]):
            Transforms that comprise this execution
            stage.
        component_source (Sequence[google.dataflow_v1beta3.types.ExecutionStageSummary.ComponentSource]):
...
class JobExecutionInfo(proto.Message):
    ...
    Attributes:
        stages (Sequence[google.dataflow_v1beta3.types.JobExecutionInfo.StagesEntry]):
...
class CreateJobRequest(proto.Message):
    ...
    Attributes:
        ...
        job (google.dataflow_v1beta3.types.Job):
            The job to create.
        view (google.dataflow_v1beta3.types.JobView):
...
class ListJobsRequest(proto.Message):
    ...
    Attributes:
        filter (google.dataflow_v1beta3.types.ListJobsRequest.Filter):
...
class ListJobsResponse(proto.Message):
    ...
    Attributes:
        jobs (Sequence[google.dataflow_v1beta3.types.Job]):
            A subset of the requested job information.
        next_page_token (str):
            Set if there may be more results than fit in
            this response.
        failed_location (Sequence[google.dataflow_v1beta3.types.FailedLocation]):
