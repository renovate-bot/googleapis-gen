...
class MetricStructuredName(proto.Message):
    ...
    Attributes:
        ...
        context (Sequence[google.dataflow_v1beta3.types.MetricStructuredName.ContextEntry]):
...
class MetricUpdate(proto.Message):
    ...
    Attributes:
        name (google.dataflow_v1beta3.types.MetricStructuredName):
            Name of the metric.
        kind (str):
...
class JobMetrics(proto.Message):
    ...
    Attributes:
        metric_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            current.
        metrics (Sequence[google.dataflow_v1beta3.types.MetricUpdate]):
...
class ProgressTimeseries(proto.Message):
    ...
    Attributes:
        ...
        data_points (Sequence[google.dataflow_v1beta3.types.ProgressTimeseries.Point]):
...
class StageSummary(proto.Message):
    ...
    Attributes:
        stage_id (str):
            ID of this stage
        state (google.dataflow_v1beta3.types.ExecutionState):
            State of this stage.
        start_time (google.protobuf.timestamp_pb2.Timestamp):
        ...
        progress (google.dataflow_v1beta3.types.ProgressTimeseries):
...
class JobExecutionDetails(proto.Message):
    ...
    Attributes:
        stages (Sequence[google.dataflow_v1beta3.types.StageSummary]):
...
class WorkerDetails(proto.Message):
    ...
    Attributes:
        worker_name (str):
            Name of this worker
        work_items (Sequence[google.dataflow_v1beta3.types.WorkItemDetails]):
...
class StageExecutionDetails(proto.Message):
    ...
    Attributes:
        workers (Sequence[google.dataflow_v1beta3.types.WorkerDetails]):
