...
from google.dataflow_v1beta3.services.jobs_v1_beta3 import JobsV1Beta3AsyncClient
from google.dataflow_v1beta3.services.jobs_v1_beta3 import JobsV1Beta3Client
from google.dataflow_v1beta3.services.jobs_v1_beta3 import pagers
from google.dataflow_v1beta3.services.jobs_v1_beta3 import transports
from google.dataflow_v1beta3.services.jobs_v1_beta3.transports.base import _GOOGLE_AUTH_VERSION
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (JobsV1Beta3AsyncClient, transports.JobsV1Beta3GrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (JobsV1Beta3AsyncClient, transports.JobsV1Beta3GrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (JobsV1Beta3Client, transports.JobsV1Beta3GrpcTransport, "grpc", "false"),
    (JobsV1Beta3AsyncClient, transports.JobsV1Beta3GrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(JobsV1Beta3Client, "DEFAULT_ENDPOINT", modify_default_endpoint(JobsV1Beta3Client))
@mock.patch.object(JobsV1Beta3AsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(JobsV1Beta3AsyncClient))
...
def test_jobs_v1_beta3_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_jobs_v1_beta3_client_client_options_from_dict():
    with mock.patch('google.dataflow_v1beta3.services.jobs_v1_beta3.transports.JobsV1Beta3GrpcTransport.__init__') as grpc_transport:
...
def test_list_jobs_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, jobs.Job)
                   for i in results)
...
def test_aggregated_list_jobs(transport: str = 'grpc', request_type=jobs.ListJobsRequest):
    client = JobsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_check_active_jobs(transport: str = 'grpc', request_type=jobs.CheckActiveJobsRequest):
    client = JobsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.check_active_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_check_active_jobs_async(transport: str = 'grpc_asyncio', request_type=jobs.CheckActiveJobsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(jobs.CheckActiveJobsResponse(
            active_jobs_exist=True,
        ))
...
def test_snapshot_job(transport: str = 'grpc', request_type=jobs.SnapshotJobRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.snapshot_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_jobs_v1_beta3_base_transport():
    ...
    with mock.patch('google.dataflow_v1beta3.services.jobs_v1_beta3.transports.JobsV1Beta3Transport.__init__') as Transport:
...
def test_jobs_v1_beta3_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.dataflow_v1beta3.services.jobs_v1_beta3.transports.JobsV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_jobs_v1_beta3_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.dataflow_v1beta3.services.jobs_v1_beta3.transports.JobsV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_jobs_v1_beta3_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.dataflow_v1beta3.services.jobs_v1_beta3.transports.JobsV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.JobsV1Beta3Transport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_jobs_v1_beta3_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        JobsV1Beta3Client()
...
def test_jobs_v1_beta3_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.JobsV1Beta3GrpcTransport, transports.JobsV1Beta3GrpcAsyncIOTransport])
def test_jobs_v1_beta3_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.JobsV1Beta3GrpcTransport, transports.JobsV1Beta3GrpcAsyncIOTransport])
def test_jobs_v1_beta3_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
