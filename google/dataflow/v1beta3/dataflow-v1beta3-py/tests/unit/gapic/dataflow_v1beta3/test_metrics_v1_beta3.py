...
from google.dataflow_v1beta3.services.metrics_v1_beta3.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert MetricsV1Beta3Client._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert MetricsV1Beta3Client._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert MetricsV1Beta3Client._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert MetricsV1Beta3Client._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert MetricsV1Beta3Client._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_metrics_v1_beta3_client_service_account_always_use_jwt(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (MetricsV1Beta3AsyncClient, transports.MetricsV1Beta3GrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(MetricsV1Beta3Client, "DEFAULT_ENDPOINT", modify_default_endpoint(MetricsV1Beta3Client))
@mock.patch.object(MetricsV1Beta3AsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MetricsV1Beta3AsyncClient))
def test_metrics_v1_beta3_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (MetricsV1Beta3AsyncClient, transports.MetricsV1Beta3GrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (MetricsV1Beta3Client, transports.MetricsV1Beta3GrpcTransport, "grpc", "false"),
    (MetricsV1Beta3AsyncClient, transports.MetricsV1Beta3GrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(MetricsV1Beta3Client, "DEFAULT_ENDPOINT", modify_default_endpoint(MetricsV1Beta3Client))
@mock.patch.object(MetricsV1Beta3AsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MetricsV1Beta3AsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_metrics_v1_beta3_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_metrics_v1_beta3_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_metrics_v1_beta3_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_metrics_v1_beta3_client_client_options_from_dict():
    with mock.patch('google.dataflow_v1beta3.services.metrics_v1_beta3.transports.MetricsV1Beta3GrpcTransport.__init__') as grpc_transport:
...
def test_get_job_metrics(transport: str = 'grpc', request_type=metrics.GetJobMetricsRequest):
    client = MetricsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.get_job_metrics),
            '__call__') as call:
...
def test_get_job_metrics_from_dict():
    test_get_job_metrics(request_type=dict)
...
@pytest.mark.asyncio
async def test_get_job_metrics_async(transport: str = 'grpc_asyncio', request_type=metrics.GetJobMetricsRequest):
...
def test_get_job_execution_details(transport: str = 'grpc', request_type=metrics.GetJobExecutionDetailsRequest):
    client = MetricsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_job_execution_details_from_dict():
    test_get_job_execution_details(request_type=dict)
...
@pytest.mark.asyncio
async def test_get_job_execution_details_async(transport: str = 'grpc_asyncio', request_type=metrics.GetJobExecutionDetailsRequest):
    client = MetricsV1Beta3AsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(metrics.JobExecutionDetails(
            next_page_token='next_page_token_value',
        ))
...
def test_get_job_execution_details_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, metrics.StageSummary)
                   for i in results)

def test_get_job_execution_details_pages():
    client = MetricsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials,
    )
...
async def test_get_job_execution_details_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.get_job_execution_details(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token

def test_get_stage_execution_details(transport: str = 'grpc', request_type=metrics.GetStageExecutionDetailsRequest):
    client = MetricsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_stage_execution_details_from_dict():
    test_get_stage_execution_details(request_type=dict)
...
@pytest.mark.asyncio
async def test_get_stage_execution_details_async(transport: str = 'grpc_asyncio', request_type=metrics.GetStageExecutionDetailsRequest):
    client = MetricsV1Beta3AsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(metrics.StageExecutionDetails(
            next_page_token='next_page_token_value',
        ))
...
def test_get_stage_execution_details_pager():
    client = MetricsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials,
    )
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, metrics.WorkerDetails)
                   for i in results)

def test_get_stage_execution_details_pages():
    client = MetricsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials,
    )
...
async def test_get_stage_execution_details_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.get_stage_execution_details(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_metrics_v1_beta3_base_transport():
    ...
    with mock.patch('google.dataflow_v1beta3.services.metrics_v1_beta3.transports.MetricsV1Beta3Transport.__init__') as Transport:
...
def test_metrics_v1_beta3_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.dataflow_v1beta3.services.metrics_v1_beta3.transports.MetricsV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_metrics_v1_beta3_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.dataflow_v1beta3.services.metrics_v1_beta3.transports.MetricsV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_metrics_v1_beta3_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.dataflow_v1beta3.services.metrics_v1_beta3.transports.MetricsV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MetricsV1Beta3Transport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_metrics_v1_beta3_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        MetricsV1Beta3Client()
        adc.assert_called_once_with(
            scopes=(                'https://www.googleapis.com/auth/cloud-platform',                'https://www.googleapis.com/auth/compute',                'https://www.googleapis.com/auth/compute.readonly',                'https://www.googleapis.com/auth/userinfo.email',),
            quota_project_id=None,
        )
...
def test_metrics_v1_beta3_transport_auth_adc(transport_class):
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        ...
        adc.assert_called_once_with(
            scopes=["1", "2"],
            default_scopes=(                'https://www.googleapis.com/auth/cloud-platform',                'https://www.googleapis.com/auth/compute',                'https://www.googleapis.com/auth/compute.readonly',                'https://www.googleapis.com/auth/userinfo.email',),
            quota_project_id="octopus",
        )
...
@requires_google_auth_lt_1_25_0
def test_metrics_v1_beta3_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize("transport_class", [transports.MetricsV1Beta3GrpcTransport, transports.MetricsV1Beta3GrpcAsyncIOTransport])
def test_metrics_v1_beta3_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_metrics_v1_beta3_host_no_port():
    client = MetricsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='dataflow.googleapis.com'),
    )
    assert client.transport._host == 'dataflow.googleapis.com:443'


def test_metrics_v1_beta3_host_with_port():
    client = MetricsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='dataflow.googleapis.com:8000'),
    )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.MetricsV1Beta3GrpcTransport, transports.MetricsV1Beta3GrpcAsyncIOTransport])
def test_metrics_v1_beta3_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.MetricsV1Beta3Transport, '_prep_wrapped_messages') as prep:
        client = MetricsV1Beta3Client(
            credentials=ga_credentials.AnonymousCredentials(),
