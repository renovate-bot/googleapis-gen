...
from google.dataflow_v1beta3.services.snapshots_v1_beta3 import SnapshotsV1Beta3AsyncClient
from google.dataflow_v1beta3.services.snapshots_v1_beta3 import SnapshotsV1Beta3Client
from google.dataflow_v1beta3.services.snapshots_v1_beta3 import transports
from google.dataflow_v1beta3.services.snapshots_v1_beta3.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert SnapshotsV1Beta3Client._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert SnapshotsV1Beta3Client._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert SnapshotsV1Beta3Client._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert SnapshotsV1Beta3Client._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert SnapshotsV1Beta3Client._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_snapshots_v1_beta3_client_service_account_always_use_jwt(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (SnapshotsV1Beta3AsyncClient, transports.SnapshotsV1Beta3GrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(SnapshotsV1Beta3Client, "DEFAULT_ENDPOINT", modify_default_endpoint(SnapshotsV1Beta3Client))
@mock.patch.object(SnapshotsV1Beta3AsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SnapshotsV1Beta3AsyncClient))
def test_snapshots_v1_beta3_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (SnapshotsV1Beta3Client, transports.SnapshotsV1Beta3GrpcTransport, "grpc", "true"),
    (SnapshotsV1Beta3AsyncClient, transports.SnapshotsV1Beta3GrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (SnapshotsV1Beta3Client, transports.SnapshotsV1Beta3GrpcTransport, "grpc", "false"),
    (SnapshotsV1Beta3AsyncClient, transports.SnapshotsV1Beta3GrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(SnapshotsV1Beta3Client, "DEFAULT_ENDPOINT", modify_default_endpoint(SnapshotsV1Beta3Client))
@mock.patch.object(SnapshotsV1Beta3AsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SnapshotsV1Beta3AsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_snapshots_v1_beta3_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_snapshots_v1_beta3_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_snapshots_v1_beta3_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_snapshots_v1_beta3_client_client_options_from_dict():
    with mock.patch('google.dataflow_v1beta3.services.snapshots_v1_beta3.transports.SnapshotsV1Beta3GrpcTransport.__init__') as grpc_transport:
...
def test_get_snapshot(transport: str = 'grpc', request_type=snapshots.GetSnapshotRequest):
    client = SnapshotsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_snapshot_async(transport: str = 'grpc_asyncio', request_type=snapshots.GetSnapshotRequest):
...
def test_delete_snapshot(transport: str = 'grpc', request_type=snapshots.DeleteSnapshotRequest):
    client = SnapshotsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_snapshot_async(transport: str = 'grpc_asyncio', request_type=snapshots.DeleteSnapshotRequest):
    client = SnapshotsV1Beta3AsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(snapshots.DeleteSnapshotResponse(
        ))
...
def test_list_snapshots(transport: str = 'grpc', request_type=snapshots.ListSnapshotsRequest):
    client = SnapshotsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_snapshots_async(transport: str = 'grpc_asyncio', request_type=snapshots.ListSnapshotsRequest):
    client = SnapshotsV1Beta3AsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(snapshots.ListSnapshotsResponse(
        ))
...
def test_snapshots_v1_beta3_base_transport():
    ...
    with mock.patch('google.dataflow_v1beta3.services.snapshots_v1_beta3.transports.SnapshotsV1Beta3Transport.__init__') as Transport:
...
def test_snapshots_v1_beta3_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.dataflow_v1beta3.services.snapshots_v1_beta3.transports.SnapshotsV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_snapshots_v1_beta3_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.dataflow_v1beta3.services.snapshots_v1_beta3.transports.SnapshotsV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_snapshots_v1_beta3_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.dataflow_v1beta3.services.snapshots_v1_beta3.transports.SnapshotsV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SnapshotsV1Beta3Transport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_snapshots_v1_beta3_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        SnapshotsV1Beta3Client()
...
@requires_google_auth_lt_1_25_0
def test_snapshots_v1_beta3_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize("transport_class", [transports.SnapshotsV1Beta3GrpcTransport, transports.SnapshotsV1Beta3GrpcAsyncIOTransport])
def test_snapshots_v1_beta3_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.SnapshotsV1Beta3GrpcTransport, transports.SnapshotsV1Beta3GrpcAsyncIOTransport])
def test_snapshots_v1_beta3_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.SnapshotsV1Beta3Transport, '_prep_wrapped_messages') as prep:
        client = SnapshotsV1Beta3Client(
            credentials=ga_credentials.AnonymousCredentials(),
