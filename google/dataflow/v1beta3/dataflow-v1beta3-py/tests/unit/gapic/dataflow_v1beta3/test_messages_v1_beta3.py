...
from google.dataflow_v1beta3.services.messages_v1_beta3 import MessagesV1Beta3AsyncClient
...
from google.dataflow_v1beta3.services.messages_v1_beta3.transports.base import _GOOGLE_AUTH_VERSION
...
def test_messages_v1_beta3_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_messages_v1_beta3_client_client_options_from_dict():
    with mock.patch('google.dataflow_v1beta3.services.messages_v1_beta3.transports.MessagesV1Beta3GrpcTransport.__init__') as grpc_transport:
...
def test_list_job_messages(transport: str = 'grpc', request_type=messages.ListJobMessagesRequest):
    client = MessagesV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_messages_v1_beta3_base_transport():
    ...
    with mock.patch('google.dataflow_v1beta3.services.messages_v1_beta3.transports.MessagesV1Beta3Transport.__init__') as Transport:
...
def test_messages_v1_beta3_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.dataflow_v1beta3.services.messages_v1_beta3.transports.MessagesV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_messages_v1_beta3_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.dataflow_v1beta3.services.messages_v1_beta3.transports.MessagesV1Beta3Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MessagesV1Beta3Transport()
        adc.assert_called_once()
