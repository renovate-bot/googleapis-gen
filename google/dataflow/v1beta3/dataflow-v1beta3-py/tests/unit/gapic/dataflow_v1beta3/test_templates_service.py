...
from google.dataflow_v1beta3.services.templates_service import TemplatesServiceAsyncClient
...
from google.dataflow_v1beta3.services.templates_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_templates_service_client_service_account_always_use_jwt(client_class):
...
def test_templates_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (TemplatesServiceAsyncClient, transports.TemplatesServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (TemplatesServiceClient, transports.TemplatesServiceGrpcTransport, "grpc", "true"),
    (TemplatesServiceAsyncClient, transports.TemplatesServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (TemplatesServiceClient, transports.TemplatesServiceGrpcTransport, "grpc", "false"),
    (TemplatesServiceAsyncClient, transports.TemplatesServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(TemplatesServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TemplatesServiceClient))
@mock.patch.object(TemplatesServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TemplatesServiceAsyncClient))
...
def test_templates_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_templates_service_client_client_options_from_dict():
    with mock.patch('google.dataflow_v1beta3.services.templates_service.transports.TemplatesServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_job_from_template(transport: str = 'grpc', request_type=templates.CreateJobFromTemplateRequest):
    client = TemplatesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.create_job_from_template),
            '__call__') as call:
...
def test_launch_template(transport: str = 'grpc', request_type=templates.LaunchTemplateRequest):
    client = TemplatesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.launch_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_template(transport: str = 'grpc', request_type=templates.GetTemplateRequest):
    client = TemplatesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_templates_service_base_transport():
    ...
    with mock.patch('google.dataflow_v1beta3.services.templates_service.transports.TemplatesServiceTransport.__init__') as Transport:
...
def test_templates_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.dataflow_v1beta3.services.templates_service.transports.TemplatesServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_templates_service_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.dataflow_v1beta3.services.templates_service.transports.TemplatesServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_templates_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.dataflow_v1beta3.services.templates_service.transports.TemplatesServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.TemplatesServiceTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_templates_service_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        TemplatesServiceClient()
...
@requires_google_auth_lt_1_25_0
def test_templates_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_templates_service_host_no_port():
    client = TemplatesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_templates_service_host_with_port():
    client = TemplatesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.TemplatesServiceGrpcTransport, transports.TemplatesServiceGrpcAsyncIOTransport])
def test_templates_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
