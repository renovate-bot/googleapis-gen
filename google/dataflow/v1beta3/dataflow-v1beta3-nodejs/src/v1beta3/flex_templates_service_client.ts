 ...
 * `src/v1beta3/flex_templates_service_client_config.json`.
...
export class FlexTemplatesServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.dataflow.v1beta3.FlexTemplatesService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.flexTemplatesServiceStub) {
      return this.flexTemplatesServiceStub;
    }

    // Put together the "service stub" for
    // google.dataflow.v1beta3.FlexTemplatesService.
    this.flexTemplatesServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.dataflow.v1beta3.FlexTemplatesService') :
    ...
    const flexTemplatesServiceStubMethods =
        ['launchFlexTemplate'];
