...
class DlpServiceAsyncClient:
    ...
    parse_deidentify_template_path = staticmethod(DlpServiceClient.parse_deidentify_template_path)
    ...
    parse_inspect_template_path = staticmethod(DlpServiceClient.parse_inspect_template_path)
    ...
    parse_stored_info_type_path = staticmethod(DlpServiceClient.parse_stored_info_type_path)

    common_billing_account_path = staticmethod(DlpServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(DlpServiceClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(DlpServiceClient.parse_common_organization_path)
    ...
    parse_common_location_path = staticmethod(DlpServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(DlpServiceClient).get_transport_class, type(DlpServiceClient))
    ...
    async def inspect_content(self,
    ...
    async def deidentify_content(self,
    ...
    async def reidentify_content(self,
    ...
    async def list_info_types(self,
    ...
    async def create_inspect_template(self,
    ...
    async def update_inspect_template(self,
    ...
    async def get_inspect_template(self,
    ...
    async def list_inspect_templates(self,
    ...
    async def delete_inspect_template(self,
    ...
    async def create_deidentify_template(self,
    ...
    async def update_deidentify_template(self,
    ...
    async def get_deidentify_template(self,
    ...
    async def list_deidentify_templates(self,
    ...
    async def delete_deidentify_template(self,
    ...
    async def create_job_trigger(self,
    ...
    async def update_job_trigger(self,
    ...
    async def hybrid_inspect_job_trigger(self,
    ...
    async def get_job_trigger(self,
    ...
    async def list_job_triggers(self,
    ...
    async def delete_job_trigger(self,
    ...
    async def activate_job_trigger(self,
    ...
    async def create_stored_info_type(self,
    ...
    async def update_stored_info_type(self,
    ...
    async def get_stored_info_type(self,
    ...
    async def list_stored_info_types(self,
    ...
    async def delete_stored_info_type(self,
    ...
    async def hybrid_inspect_dlp_job(self,
