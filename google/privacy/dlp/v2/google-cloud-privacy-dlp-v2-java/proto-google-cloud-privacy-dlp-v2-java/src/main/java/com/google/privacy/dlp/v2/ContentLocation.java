...
private static final long serialVersionUID = 0L;
    ...
    switch (locationCase_) {
      case 2:
        if (!getRecordLocation()
            .equals(other.getRecordLocation())) return false;
        break;
      case 3:
        if (!getImageLocation()
      ...
      case 5:
        if (!getDocumentLocation()
            .equals(other.getDocumentLocation())) return false;
        break;
      case 8:
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeMetadataLocation(com.google.privacy.dlp.v2.MetadataLocation value) {
      if (metadataLocationBuilder_ == null) {
        if (locationCase_ == 8 &&
          ...
          location_ = com.google.privacy.dlp.v2.MetadataLocation.newBuilder((com.google.privacy.dlp.v2.MetadataLocation) location_)
              .mergeFrom(value).buildPartial();
        } else {
          location_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.privacy.dlp.v2.MetadataLocation, com.google.privacy.dlp.v2.MetadataLocation.Builder, com.google.privacy.dlp.v2.MetadataLocationOrBuilder> 
        getMetadataLocationFieldBuilder() {
      if (metadataLocationBuilder_ == null) {
        if (!(locationCase_ == 8)) {
          location_ = com.google.privacy.dlp.v2.MetadataLocation.getDefaultInstance();
        }
        metadataLocationBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.privacy.dlp.v2.MetadataLocation, com.google.privacy.dlp.v2.MetadataLocation.Builder, com.google.privacy.dlp.v2.MetadataLocationOrBuilder>(
