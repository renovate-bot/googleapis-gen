...
class HomeGraphApiServiceAsyncClient:
    ...
    from_service_account_info = HomeGraphApiServiceClient.from_service_account_info
    from_service_account_file = HomeGraphApiServiceClient.from_service_account_file
