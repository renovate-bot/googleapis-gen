...
require "google/cloud/home/graph/v1/credentials"
        ...
        module V1
          ...
          class HomeGraphApiServiceClient
            ...
            def initialize \
              ...
              credentials ||= Google::Cloud::Home::Graph::V1::Credentials.default

              if credentials.is_a?(String) || credentials.is_a?(Hash)
                updater_proc = Google::Cloud::Home::Graph::V1::Credentials.new(credentials).updater_proc
              end
              ...
              package_version = Gem.loaded_specs['google-cloud-home-graph'].version.version
            ...
            #
            #   home_graph_api_client = Google::Cloud::Home::Graph.new(version: :v1)
            #
