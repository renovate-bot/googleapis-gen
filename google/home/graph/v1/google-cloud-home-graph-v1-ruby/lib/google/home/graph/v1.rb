...
module Google
  module Home
    module Graph
      ...
      ##
      # # Ruby Client for HomeGraph API ([Alpha](https://github.com/GoogleCloudPlatform/google-cloud-ruby#versioning))
      #
      # [HomeGraph API][Product Documentation]:
      #
      ...
      # 3. [Enable the HomeGraph API.](https://console.cloud.google.com/apis/library/home-graph.googleapis.com)
      ...
      #
      # ### Next Steps
      # - Read the [HomeGraph API Product documentation][Product Documentation]
      ...
      module V1
        ...
        def self.new \
          ...
          Google::Home::Graph::V1::HomeGraphApiServiceClient.new(**kwargs)
        end
      end
    end
  end
