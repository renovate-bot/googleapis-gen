    ...
    module Enterprise
      module Sdm
        module V1
          ...
          class ExecuteDeviceCommandRequest; end

          # Response message for SmartDeviceManagementService.ExecuteDeviceCommand
          # @!attribute [rw] results
          #   @return [Google::Protobuf::Struct]
          #     The results of executing the command.
          class ExecuteDeviceCommandResponse; end
          ...
          class ListStructuresRequest; end
          ...
          class ListStructuresResponse; end
