...
from google.home.enterprise.sdm_v1.services.smart_device_management_service import SmartDeviceManagementServiceAsyncClient
...
def test__get_default_mtls_endpoint():
    ...
    assert SmartDeviceManagementServiceClient._get_default_mtls_endpoint(None) is None
    assert SmartDeviceManagementServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert SmartDeviceManagementServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert SmartDeviceManagementServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert SmartDeviceManagementServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert SmartDeviceManagementServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_smart_device_management_service_client_from_service_account_info(client_class):
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        assert client.transport._host == 'smartdevicemanagement.googleapis.com:443'
...
def test_smart_device_management_service_client_service_account_always_use_jwt(client_class):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.SmartDeviceManagementServiceGrpcTransport, "grpc"),
    (transports.SmartDeviceManagementServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
def test_smart_device_management_service_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
def test_smart_device_management_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
def test_smart_device_management_service_client_get_transport_class():
    transport = SmartDeviceManagementServiceClient.get_transport_class()
    available_transports = [
        transports.SmartDeviceManagementServiceGrpcTransport,
    ]
    assert transport in available_transports

    transport = SmartDeviceManagementServiceClient.get_transport_class("grpc")
    assert transport == transports.SmartDeviceManagementServiceGrpcTransport


@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (SmartDeviceManagementServiceClient, transports.SmartDeviceManagementServiceGrpcTransport, "grpc"),
    (SmartDeviceManagementServiceAsyncClient, transports.SmartDeviceManagementServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_smart_device_management_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(SmartDeviceManagementServiceClient, 'get_transport_class') as gtc:
...
def test_smart_device_management_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_smart_device_management_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_smart_device_management_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
async def test_get_device_async(transport: str = 'grpc_asyncio', request_type=smart_device_management_service.GetDeviceRequest):
    client = SmartDeviceManagementServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_execute_device_command_async_from_dict():
    await test_execute_device_command_async(request_type=dict)


def test_execute_device_command_field_headers():
    client = SmartDeviceManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_execute_device_command_field_headers_async():
    client = SmartDeviceManagementServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_structure_async_from_dict():
    await test_get_structure_async(request_type=dict)


def test_get_structure_field_headers():
    client = SmartDeviceManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_structure_field_headers_async():
    client = SmartDeviceManagementServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_structures_async_from_dict():
    await test_list_structures_async(request_type=dict)


def test_list_structures_field_headers():
    client = SmartDeviceManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_structures_field_headers_async():
    client = SmartDeviceManagementServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_structures_pager():
    ...
    with mock.patch.object(
        ...
        pager = client.list_structures(request={})
...
def test_list_structures_pages():
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_structures(request={}).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token

@pytest.mark.asyncio
async def test_list_structures_async_pager():
    client = SmartDeviceManagementServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials,
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_structures(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager:
            responses.append(response)
...
async def test_list_structures_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_structures(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_list_rooms_field_headers():
    client = SmartDeviceManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_rooms_field_headers_async():
    client = SmartDeviceManagementServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_rooms_pager():
    ...
    with mock.patch.object(
        ...
        pager = client.list_rooms(request={})
...
async def test_list_rooms_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_rooms(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_transport_get_channel():
    ...
    transport = transports.SmartDeviceManagementServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_smart_device_management_service_base_transport():
    # Instantiate the base transport.
    with mock.patch('google.home.enterprise.sdm_v1.services.smart_device_management_service.transports.SmartDeviceManagementServiceTransport.__init__') as Transport:
...
def test_smart_device_management_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.home.enterprise.sdm_v1.services.smart_device_management_service.transports.SmartDeviceManagementServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_smart_device_management_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.home.enterprise.sdm_v1.services.smart_device_management_service.transports.SmartDeviceManagementServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SmartDeviceManagementServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.SmartDeviceManagementServiceGrpcTransport, transports.SmartDeviceManagementServiceGrpcAsyncIOTransport])
def test_smart_device_management_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_smart_device_management_service_host_no_port():
    client = SmartDeviceManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='smartdevicemanagement.googleapis.com'),
    )
    assert client.transport._host == 'smartdevicemanagement.googleapis.com:443'


def test_smart_device_management_service_host_with_port():
    client = SmartDeviceManagementServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_smart_device_management_service_grpc_asyncio_transport_channel():
...
@pytest.mark.parametrize("transport_class", [transports.SmartDeviceManagementServiceGrpcTransport, transports.SmartDeviceManagementServiceGrpcAsyncIOTransport])
def test_smart_device_management_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.SmartDeviceManagementServiceGrpcTransport, transports.SmartDeviceManagementServiceGrpcAsyncIOTransport])
def test_smart_device_management_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_parse_device_path():
    ...
    actual = SmartDeviceManagementServiceClient.parse_device_path(path)
    assert expected == actual
...
def test_parse_room_path():
    ...
    # Check that the path construction is reversible.
    actual = SmartDeviceManagementServiceClient.parse_room_path(path)
    assert expected == actual
...
def test_parse_structure_path():
    ...
    # Check that the path construction is reversible.
    actual = SmartDeviceManagementServiceClient.parse_structure_path(path)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    # Check that the path construction is reversible.
    actual = SmartDeviceManagementServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = SmartDeviceManagementServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = SmartDeviceManagementServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = SmartDeviceManagementServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = SmartDeviceManagementServiceClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.SmartDeviceManagementServiceTransport, '_prep_wrapped_messages') as prep:
        transport_class = SmartDeviceManagementServiceClient.get_transport_class()
        transport = transport_class(
            credentials=ga_credentials.AnonymousCredentials(),
            client_info=client_info,
        )
