...
class SmartDeviceManagementServiceAsyncClient:
    ...
    from_service_account_info = SmartDeviceManagementServiceClient.from_service_account_info
    from_service_account_file = SmartDeviceManagementServiceClient.from_service_account_file
