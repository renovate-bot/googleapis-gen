...
class SmartDeviceManagementServiceClient(metaclass=SmartDeviceManagementServiceClientMeta):
    ...
    def transport(self) -> SmartDeviceManagementServiceTransport:
        ...
        Returns:
            SmartDeviceManagementServiceTransport: The transport used by the client
                instance.
        """
    ...
    def structure_path(enterprise: str,structure: str,) -> str:
        """Returns a fully-qualified structure string."""
    ...
    def parse_structure_path(path: str) -> Dict[str,str]:
        """Parses a structure path into its component segments."""
    ...
    def __init__(self, *,
        ...
        """Instantiates the smart device management service client.
