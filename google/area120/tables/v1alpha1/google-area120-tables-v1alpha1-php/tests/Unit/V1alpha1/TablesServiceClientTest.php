...
namespace Google\Cloud\Area120\Tables\Tests\Unit\V1alpha1;

use Google\Cloud\Area120\Tables\V1alpha1\TablesServiceClient;
...
class TablesServiceClientTest extends GeneratedTest
{
    ...
    public function getTableTest()
    {
        ...
        // Mock request
        $formattedName = $client->tableName('[TABLE]');
        ...
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/GetTable', $actualFuncCall);
    ...
    public function listTablesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/ListTables', $actualFuncCall);
    ...
    public function getWorkspaceTest()
    {
        ...
        // Mock request
        $formattedName = $client->workspaceName('[WORKSPACE]');

        $response = $client->getWorkspace($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/GetWorkspace', $actualFuncCall);
    ...
    public function getWorkspaceExceptionTest()
    {
        ...
        try {
            $client->getWorkspace($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listWorkspacesTest()
    {
        ...
        $response = $client->listWorkspaces();
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/ListWorkspaces', $actualFuncCall);
    ...
    public function getRowTest()
    {
        ...
        // Mock response
        $name2 = 'name2-1052831874';
        $expectedResponse = new Row();
        $expectedResponse->setName($name2);
        $transport->addResponse($expectedResponse);

        // Mock request
        $formattedName = $client->rowName('[TABLE]', '[ROW]');

        $response = $client->getRow($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/GetRow', $actualFuncCall);
    ...
    public function listRowsTest()
    {
        ...
        $rowsElement = new Row();
        $rows = [$rowsElement];
        $expectedResponse = new ListRowsResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        ...
        $response = $client->listRows($parent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/ListRows', $actualFuncCall);
    ...
    public function createRowTest()
    {
        ...
        $response = $client->createRow($parent, $row);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/CreateRow', $actualFuncCall);

        $actualValue = $actualRequestObject->getParent();

        $this->assertProtobufEquals($parent, $actualValue);
        $actualValue = $actualRequestObject->getRow();

        $this->assertProtobufEquals($row, $actualValue);
    ...
    public function batchCreateRowsTest()
    {
        ...
        // Mock response
        $expectedResponse = new BatchCreateRowsResponse();
        $transport->addResponse($expectedResponse);
        ...
        $response = $client->batchCreateRows($parent, $requests);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/BatchCreateRows', $actualFuncCall);
    ...
    public function batchCreateRowsExceptionTest()
    {
        ...
        try {
            $client->batchCreateRows($parent, $requests);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateRowTest()
    {
        ...
        $response = $client->updateRow($row);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/UpdateRow', $actualFuncCall);
    ...
    public function batchUpdateRowsTest()
    {
        ...
        // Mock response
        $expectedResponse = new BatchUpdateRowsResponse();
        $transport->addResponse($expectedResponse);
        ...
        $response = $client->batchUpdateRows($parent, $requests);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/BatchUpdateRows', $actualFuncCall);
    ...
    public function batchUpdateRowsExceptionTest()
    {
        ...
        try {
            $client->batchUpdateRows($parent, $requests);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function deleteRowTest()
    {
        ...
        $client->deleteRow($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/DeleteRow', $actualFuncCall);
    ...
    public function batchDeleteRowsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.area120.tables.v1alpha1.TablesService/BatchDeleteRows', $actualFuncCall);
