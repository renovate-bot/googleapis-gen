...
class TablesServiceTransport(abc.ABC):
    ...
    @property
    def get_row(self) -> typing.Callable[
            [tables.GetRowRequest],
            typing.Union[
                tables.Row,
                typing.Awaitable[tables.Row]
            ]]:
        raise NotImplementedError()

    @property
    def list_rows(self) -> typing.Callable[
            [tables.ListRowsRequest],
            typing.Union[
                tables.ListRowsResponse,
                typing.Awaitable[tables.ListRowsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def create_row(self) -> typing.Callable[
    ...
    @property
    def batch_create_rows(self) -> typing.Callable[
    ...
    @property
    def update_row(self) -> typing.Callable[
    ...
    @property
    def batch_update_rows(self) -> typing.Callable[
