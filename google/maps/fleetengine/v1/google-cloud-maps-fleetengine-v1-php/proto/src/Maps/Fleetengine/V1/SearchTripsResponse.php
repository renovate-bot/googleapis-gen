...
class SearchTripsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Maps\Fleetengine\V1\Trip[]|\Google\Protobuf\Internal\RepeatedField $trips
     *           The list of trips for the requested vehicle.
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.v1.Trip trips = 1;</code>
     * @param \Maps\Fleetengine\V1\Trip[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTrips($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Maps\Fleetengine\V1\Trip::class);
        $this->trips = $arr;
