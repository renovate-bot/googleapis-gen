...
namespace Maps.Fleetengine.V1.Snippets
{
    ...
    public sealed class GeneratedVehicleServiceClientSnippets
    {
        ...
        {
            // Snippet: UpdateVehicleLocation(UpdateVehicleLocationRequest, CallSettings)
            // Create client
            VehicleServiceClient vehicleServiceClient = VehicleServiceClient.Create();
            // Initialize request argument(s)
...
#pragma warning restore CS0612
        ...
        {
            // Snippet: UpdateVehicleLocationAsync(UpdateVehicleLocationRequest, CallSettings)
            // Additional: UpdateVehicleLocationAsync(UpdateVehicleLocationRequest, CancellationToken)
            // Create client
            VehicleServiceClient vehicleServiceClient = await VehicleServiceClient.CreateAsync();
            // Initialize request argument(s)
#pragma warning disable CS0612
...
#pragma warning restore CS0612
        ...
        {
            // Snippet: SearchFuzzedVehicles(SearchVehiclesRequest, CallSettings)
            // Create client
            VehicleServiceClient vehicleServiceClient = VehicleServiceClient.Create();
            // Initialize request argument(s)
            SearchVehiclesRequest request = new SearchVehiclesRequest
        ...
        {
            // Snippet: SearchFuzzedVehiclesAsync(SearchVehiclesRequest, CallSettings)
            // Additional: SearchFuzzedVehiclesAsync(SearchVehiclesRequest, CancellationToken)
            // Create client
            VehicleServiceClient vehicleServiceClient = await VehicleServiceClient.CreateAsync();
            // Initialize request argument(s)
            SearchVehiclesRequest request = new SearchVehiclesRequest
