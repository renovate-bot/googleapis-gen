...
from maps.fleetengine_v1.services.trip_service import TripServiceAsyncClient
from maps.fleetengine_v1.services.trip_service import TripServiceClient
...
from maps.fleetengine_v1.services.trip_service.transports.base import _API_CORE_VERSION
from maps.fleetengine_v1.services.trip_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_trip_service_client_from_service_account_info(client_class):
...
def test_trip_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
def test_trip_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_create_trip(transport: str = 'grpc', request_type=trip_api.CreateTripRequest):
    ...
    with mock.patch.object(
            type(client.transport.create_trip),
            '__call__') as call:
...
async def test_create_trip_async(transport: str = 'grpc_asyncio', request_type=trip_api.CreateTripRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(trips.Trip(
            name='name_value',
            vehicle_id='vehicle_id_value',
            trip_status=trips.TripStatus.NEW,
            trip_type=fleetengine.TripType.SHARED,
...
@pytest.mark.asyncio
async def test_create_trip_field_headers_async():
    client = TripServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_trip(transport: str = 'grpc', request_type=trip_api.GetTripRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_trip),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = trips.Trip(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_trip_field_headers_async():
    client = TripServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_report_billable_trip(transport: str = 'grpc', request_type=trip_api.ReportBillableTripRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.report_billable_trip),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_report_billable_trip_field_headers():
    client = TripServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_report_billable_trip_field_headers_async():
    client = TripServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_search_trips(transport: str = 'grpc', request_type=trip_api.SearchTripsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_trips),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_search_trips_async(transport: str = 'grpc_asyncio', request_type=trip_api.SearchTripsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(trip_api.SearchTripsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_search_trips_field_headers():
    client = TripServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_search_trips_field_headers_async():
    client = TripServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_trip(transport: str = 'grpc', request_type=trip_api.UpdateTripRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_trip),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = trips.Trip(
            name='name_value',
...
def test_update_trip_field_headers():
    client = TripServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_trip_field_headers_async():
    client = TripServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_trip_service_base_transport():
    ...
    with mock.patch('maps.fleetengine_v1.services.trip_service.transports.TripServiceTransport.__init__') as Transport:
...
def test_trip_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('maps.fleetengine_v1.services.trip_service.transports.TripServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_trip_service_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('maps.fleetengine_v1.services.trip_service.transports.TripServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_trip_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('maps.fleetengine_v1.services.trip_service.transports.TripServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.TripServiceTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_trip_service_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        TripServiceClient()
...
@requires_google_auth_lt_1_25_0
def test_trip_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_trip_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_trip_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
def test_trip_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_trip_service_host_no_port():
    client = TripServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_trip_service_host_with_port():
    client = TripServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("transport_class", [transports.TripServiceGrpcTransport, transports.TripServiceGrpcAsyncIOTransport])
def test_trip_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.TripServiceGrpcTransport, transports.TripServiceGrpcAsyncIOTransport])
def test_trip_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
