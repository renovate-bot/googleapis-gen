...
class RequestHeader(proto.Message):
    ...
    Attributes:
        ...
        sdk_type (maps.fleetengine_v1.types.RequestHeader.SdkType):
        ...
        nav_sdk_version (str):
            ...
            applicable. The version format is "major.minor.patch",
            example: ``2.1.0``.
        platform (maps.fleetengine_v1.types.RequestHeader.Platform):
    ...
    sdk_type = proto.Field(
        proto.ENUM,
        number=6,
        enum=SdkType,
    )
    maps_sdk_version = proto.Field(
        proto.STRING,
        number=7,
    )
    nav_sdk_version = proto.Field(
        proto.STRING,
        number=8,
    )
