...
class SpeedReadingInterval(proto.Message):
    ...
    Attributes:
        ...
        end_polyline_point_index (int):
            ...
            path. In JSON, when the index is 0, the field
            will appear to be unpopulated.
        speed (maps.fleetengine_v1.types.SpeedReadingInterval.Speed):
...
class ConsumableTrafficPolyline(proto.Message):
    ...
    Attributes:
        speed_reading_interval (Sequence[maps.fleetengine_v1.types.SpeedReadingInterval]):
    ...
    speed_reading_interval = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
