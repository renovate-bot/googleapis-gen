...
from .transports.grpc import TripServiceGrpcTransport
from .transports.grpc_asyncio import TripServiceGrpcAsyncIOTransport


class TripServiceClientMeta(type):
    """Metaclass for the TripService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[TripServiceTransport]]
    _transport_registry["grpc"] = TripServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = TripServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: str = None,
        ) -> Type[TripServiceTransport]:
...
class TripServiceClient(metaclass=TripServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            TripServiceClient: The constructed client.
        """
    ...
    def transport(self) -> TripServiceTransport:
        ...
        Returns:
            TripServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def trip_path(provider: str,trip: str,) -> str:
        """Returns a fully-qualified trip string."""
        return "providers/{provider}/trips/{trip}".format(provider=provider, trip=trip, )

    @staticmethod
    def parse_trip_path(path: str) -> Dict[str,str]:
        """Parses a trip path into its component segments."""
        m = re.match(r"^providers/(?P<provider>.+?)/trips/(?P<trip>.+?)$", path)
    ...
    def __init__(self, *,
            ...
            transport: Union[str, TripServiceTransport, None] = None,
        ...
        if isinstance(transport, TripServiceTransport):
            # transport is a TripServiceTransport instance.
    ...
    def search_trips(self,
        ...
        Returns:
            maps.fleetengine_v1.services.trip_service.pagers.SearchTripsPager:
        ...
        response = pagers.SearchTripsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
