...
class ListVehiclesPager:
    ...
    @property
    def pages(self) -> Iterable[vehicle_api.ListVehiclesResponse]:
    ...
    def __iter__(self) -> Iterable[vehicles.Vehicle]:
...
class ListVehiclesAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterable[vehicle_api.ListVehiclesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
    ...
    def __aiter__(self) -> AsyncIterable[vehicles.Vehicle]:
