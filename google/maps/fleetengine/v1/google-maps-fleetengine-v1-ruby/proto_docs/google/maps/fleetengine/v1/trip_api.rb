...
module Maps
  module Fleetengine
    module V1
      ...
      #   @return [::Maps::Fleetengine::V1::PolylineFormatType]
      ...
      #   @return [::Maps::Fleetengine::V1::BillingPlatformIdentifier]
      ...
      #   @return [::Maps::Fleetengine::V1::ReportBillableTripRequest::SolutionType]
      ...
      # @!attribute [rw] trips
      #   @return [::Array<::Maps::Fleetengine::V1::Trip>]
