...
class ::Maps::Fleetengine::V1::VehicleService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_vehicle
    # Create GRPC objects.
    grpc_response = ::Maps::Fleetengine::V1::Vehicle.new
    ...
    create_vehicle_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Maps::Fleetengine::V1::CreateVehicleRequest, request
      ...
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::Vehicle), request["vehicle"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_vehicle_client_stub do
      ...
      # Use protobuf object
      client.create_vehicle ::Maps::Fleetengine::V1::CreateVehicleRequest.new(header: header, parent: parent, vehicle_id: vehicle_id, vehicle: vehicle) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.create_vehicle(::Maps::Fleetengine::V1::CreateVehicleRequest.new(header: header, parent: parent, vehicle_id: vehicle_id, vehicle: vehicle), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_vehicle
    ...
    get_vehicle_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Maps::Fleetengine::V1::GetVehicleRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::RequestHeader), request["header"]
    ...
    Gapic::ServiceStub.stub :new, get_vehicle_client_stub do
      ...
      # Use protobuf object
      client.get_vehicle ::Maps::Fleetengine::V1::GetVehicleRequest.new(header: header, name: name, current_route_segment_version: current_route_segment_version, waypoints_version: waypoints_version) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_vehicle(::Maps::Fleetengine::V1::GetVehicleRequest.new(header: header, name: name, current_route_segment_version: current_route_segment_version, waypoints_version: waypoints_version), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_vehicle
    ...
    update_vehicle_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Maps::Fleetengine::V1::UpdateVehicleRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::RequestHeader), request["header"]
      assert_equal "hello world", request["name"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::Vehicle), request["vehicle"]
    ...
    Gapic::ServiceStub.stub :new, update_vehicle_client_stub do
      ...
      # Use protobuf object
      client.update_vehicle ::Maps::Fleetengine::V1::UpdateVehicleRequest.new(header: header, name: name, vehicle: vehicle, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_vehicle(::Maps::Fleetengine::V1::UpdateVehicleRequest.new(header: header, name: name, vehicle: vehicle, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_vehicle_location
    # Create GRPC objects.
    grpc_response = ::Maps::Fleetengine::V1::VehicleLocation.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    update_vehicle_location_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Maps::Fleetengine::V1::UpdateVehicleLocationRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::RequestHeader), request["header"]
      assert_equal "hello world", request["name"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::VehicleLocation), request["current_location"]
    ...
    Gapic::ServiceStub.stub :new, update_vehicle_location_client_stub do
      ...
      # Use protobuf object
      client.update_vehicle_location ::Maps::Fleetengine::V1::UpdateVehicleLocationRequest.new(header: header, name: name, current_location: current_location, current_state: current_state) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_vehicle_location(::Maps::Fleetengine::V1::UpdateVehicleLocationRequest.new(header: header, name: name, current_location: current_location, current_state: current_state), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_vehicle_attributes
    # Create GRPC objects.
    grpc_response = ::Maps::Fleetengine::V1::UpdateVehicleAttributesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    update_vehicle_attributes_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Maps::Fleetengine::V1::UpdateVehicleAttributesRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::RequestHeader), request["header"]
      assert_equal "hello world", request["name"]
      assert_kind_of ::Maps::Fleetengine::V1::VehicleAttribute, request["attributes"].first
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, update_vehicle_attributes_client_stub do
      ...
      # Use protobuf object
      client.update_vehicle_attributes ::Maps::Fleetengine::V1::UpdateVehicleAttributesRequest.new(header: header, name: name, attributes: attributes) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_vehicle_attributes(::Maps::Fleetengine::V1::UpdateVehicleAttributesRequest.new(header: header, name: name, attributes: attributes), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_vehicles
    # Create GRPC objects.
    grpc_response = ::Maps::Fleetengine::V1::ListVehiclesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_vehicles_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Maps::Fleetengine::V1::ListVehiclesRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::RequestHeader), request["header"]
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_vehicles_client_stub do
      ...
      # Use protobuf object
      client.list_vehicles ::Maps::Fleetengine::V1::ListVehiclesRequest.new(header: header, parent: parent, page_size: page_size, page_token: page_token, minimum_capacity: minimum_capacity, trip_types: trip_types, maximum_staleness: maximum_staleness, vehicle_type_categories: vehicle_type_categories, required_attributes: required_attributes, required_one_of_attributes: required_one_of_attributes, required_one_of_attribute_sets: required_one_of_attribute_sets, vehicle_state: vehicle_state, on_trip_only: on_trip_only) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.list_vehicles({ header: header, parent: parent, page_size: page_size, page_token: page_token, minimum_capacity: minimum_capacity, trip_types: trip_types, maximum_staleness: maximum_staleness, vehicle_type_categories: vehicle_type_categories, required_attributes: required_attributes, required_one_of_attributes: required_one_of_attributes, required_one_of_attribute_sets: required_one_of_attribute_sets, vehicle_state: vehicle_state, on_trip_only: on_trip_only }, grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_search_vehicles
    # Create GRPC objects.
    grpc_response = ::Maps::Fleetengine::V1::SearchVehiclesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    search_vehicles_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Maps::Fleetengine::V1::SearchVehiclesRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::RequestHeader), request["header"]
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::TerminalLocation), request["pickup_point"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Maps::Fleetengine::V1::TerminalLocation), request["dropoff_point"]
      assert_equal 42, request["pickup_radius_meters"]
      assert_equal 42, request["count"]
      assert_equal 42, request["minimum_capacity"]
      assert_equal [:UNKNOWN_TRIP_TYPE], request["trip_types"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::Duration), request["maximum_staleness"]
      assert_kind_of ::Maps::Fleetengine::V1::Vehicle::VehicleType, request["vehicle_types"].first
      assert_kind_of ::Maps::Fleetengine::V1::VehicleAttribute, request["required_attributes"].first
      assert_kind_of ::Maps::Fleetengine::V1::VehicleAttributeList, request["required_one_of_attributes"].first
      assert_kind_of ::Maps::Fleetengine::V1::VehicleAttributeList, request["required_one_of_attribute_sets"].first
    ...
    Gapic::ServiceStub.stub :new, search_vehicles_client_stub do
      ...
      # Use protobuf object
      client.search_vehicles ::Maps::Fleetengine::V1::SearchVehiclesRequest.new(header: header, parent: parent, pickup_point: pickup_point, dropoff_point: dropoff_point, pickup_radius_meters: pickup_radius_meters, count: count, minimum_capacity: minimum_capacity, trip_types: trip_types, maximum_staleness: maximum_staleness, vehicle_types: vehicle_types, required_attributes: required_attributes, required_one_of_attributes: required_one_of_attributes, required_one_of_attribute_sets: required_one_of_attribute_sets, order_by: order_by, include_back_to_back: include_back_to_back, trip_id: trip_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.search_vehicles({ header: header, parent: parent, pickup_point: pickup_point, dropoff_point: dropoff_point, pickup_radius_meters: pickup_radius_meters, count: count, minimum_capacity: minimum_capacity, trip_types: trip_types, maximum_staleness: maximum_staleness, vehicle_types: vehicle_types, required_attributes: required_attributes, required_one_of_attributes: required_one_of_attributes, required_one_of_attribute_sets: required_one_of_attribute_sets, order_by: order_by, include_back_to_back: include_back_to_back, trip_id: trip_id }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_search_fuzzed_vehicles
    ...
    Gapic::ServiceStub.stub :new, search_fuzzed_vehicles_client_stub do
      ...
      # Use protobuf object
      client.search_fuzzed_vehicles ::Maps::Fleetengine::V1::SearchVehiclesRequest.new(header: header, parent: parent, pickup_point: pickup_point, dropoff_point: dropoff_point, pickup_radius_meters: pickup_radius_meters, count: count, minimum_capacity: minimum_capacity, trip_types: trip_types, maximum_staleness: maximum_staleness, vehicle_types: vehicle_types, required_attributes: required_attributes, required_one_of_attributes: required_one_of_attributes, required_one_of_attribute_sets: required_one_of_attribute_sets, order_by: order_by, include_back_to_back: include_back_to_back, trip_id: trip_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Maps::Fleetengine::V1::VehicleService::Client::Configuration, config
  end
end
