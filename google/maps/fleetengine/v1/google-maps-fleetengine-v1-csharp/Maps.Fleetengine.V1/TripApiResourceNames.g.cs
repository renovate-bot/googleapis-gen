...
namespace Maps.Fleetengine.V1
{
    ...
    {
        /// <summary>
        /// <see cref="mfv::TripName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public mfv::TripName TripName
        {
            get => string.IsNullOrEmpty(Name) ? null : mfv::TripName.Parse(Name, allowUnparsed: true);
