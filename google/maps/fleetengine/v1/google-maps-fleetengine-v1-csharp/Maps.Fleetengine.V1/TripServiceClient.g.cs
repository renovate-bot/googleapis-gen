...
namespace Maps.Fleetengine.V1
{
    ...
    public sealed partial class TripServiceClientBuilder : gaxgrpc::ClientBuilderBase<TripServiceClient>
    {
        ...
        private TripServiceClient BuildImpl()
        {
            ...
            return TripServiceClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => TripServiceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => TripServiceClient.DefaultScopes;
    ...
    public abstract partial class TripServiceClient
    {
        ...
        /// <returns>The created <see cref="TripServiceClient"/>.</returns>
        internal static TripServiceClient Create(grpccore::CallInvoker callInvoker, TripServiceSettings settings = null)
        {
            ...
            return new TripServiceClientImpl(grpcClient, settings);
        }
    ...
    public sealed partial class TripServiceClientImpl : TripServiceClient
    {
        ...
        public TripServiceClientImpl(TripService.TripServiceClient grpcClient, TripServiceSettings settings)
        {
            GrpcClient = grpcClient;
            TripServiceSettings effectiveSettings = settings ?? TripServiceSettings.GetDefault();
            gaxgrpc::ClientHelper clientHelper = new gaxgrpc::ClientHelper(effectiveSettings);
            _callCreateTrip = clientHelper.BuildApiCall<CreateTripRequest, Trip>(grpcClient.CreateTripAsync, grpcClient.CreateTrip, effectiveSettings.CreateTripSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callCreateTrip);
            Modify_CreateTripApiCall(ref _callCreateTrip);
            _callGetTrip = clientHelper.BuildApiCall<GetTripRequest, Trip>(grpcClient.GetTripAsync, grpcClient.GetTrip, effectiveSettings.GetTripSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callGetTrip);
            Modify_GetTripApiCall(ref _callGetTrip);
            _callReportBillableTrip = clientHelper.BuildApiCall<ReportBillableTripRequest, wkt::Empty>(grpcClient.ReportBillableTripAsync, grpcClient.ReportBillableTrip, effectiveSettings.ReportBillableTripSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callReportBillableTrip);
            Modify_ReportBillableTripApiCall(ref _callReportBillableTrip);
            _callSearchTrips = clientHelper.BuildApiCall<SearchTripsRequest, SearchTripsResponse>(grpcClient.SearchTripsAsync, grpcClient.SearchTrips, effectiveSettings.SearchTripsSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callSearchTrips);
            Modify_SearchTripsApiCall(ref _callSearchTrips);
            _callUpdateTrip = clientHelper.BuildApiCall<UpdateTripRequest, Trip>(grpcClient.UpdateTripAsync, grpcClient.UpdateTrip, effectiveSettings.UpdateTripSettings).WithGoogleRequestParam("name", request => request.Name);
