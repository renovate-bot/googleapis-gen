...
use Maps\Fleetengine\V1\TerminalPointId;
...
class VehicleServiceClientTest extends GeneratedTest
{
    ...
    public function createVehicleTest()
    {
        ...
        $vehicle = new Vehicle();
        $response = $client->createVehicle($parent, $vehicleId, $vehicle);
    ...
    public function createVehicleExceptionTest()
    {
        ...
        $vehicle = new Vehicle();
        try {
            $client->createVehicle($parent, $vehicleId, $vehicle);
    ...
    public function getVehicleTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->vehicleName('[PROVIDER]', '[VEHICLE]');
        $response = $client->getVehicle($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getVehicleExceptionTest()
    {
        ...
        $formattedName = $client->vehicleName('[PROVIDER]', '[VEHICLE]');
        try {
            $client->getVehicle($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listVehiclesTest()
    {
        ...
        $response = $client->listVehicles($parent, $vehicleTypeCategories);
    ...
    public function listVehiclesExceptionTest()
    {
        ...
        $vehicleTypeCategories = [];
        try {
            $client->listVehicles($parent, $vehicleTypeCategories);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function searchFuzzedVehiclesTest()
    {
        ...
        $pickupPointTerminalPointId = new TerminalPointId();
        $pickupPoint->setTerminalPointId($pickupPointTerminalPointId);
        ...
        $response = $client->searchFuzzedVehicles($parent, $pickupPoint, $pickupRadiusMeters, $count, $minimumCapacity, $tripTypes, $vehicleTypes, $orderBy);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function searchFuzzedVehiclesExceptionTest()
    {
        ...
        $orderBy = VehicleMatchOrder::UNKNOWN_VEHICLE_MATCH_ORDER;
        try {
            $client->searchFuzzedVehicles($parent, $pickupPoint, $pickupRadiusMeters, $count, $minimumCapacity, $tripTypes, $vehicleTypes, $orderBy);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function searchVehiclesTest()
    {
        ...
        $vehicleTypes = [];
        $orderBy = VehicleMatchOrder::UNKNOWN_VEHICLE_MATCH_ORDER;
        $response = $client->searchVehicles($parent, $pickupPoint, $pickupRadiusMeters, $count, $minimumCapacity, $tripTypes, $vehicleTypes, $orderBy);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function searchVehiclesExceptionTest()
    {
        ...
        $orderBy = VehicleMatchOrder::UNKNOWN_VEHICLE_MATCH_ORDER;
        try {
            $client->searchVehicles($parent, $pickupPoint, $pickupRadiusMeters, $count, $minimumCapacity, $tripTypes, $vehicleTypes, $orderBy);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateVehicleTest()
    {
        ...
        $response = $client->updateVehicle($name, $vehicle, $updateMask);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateVehicleExceptionTest()
    {
        ...
        $updateMask = new FieldMask();
        try {
            $client->updateVehicle($name, $vehicle, $updateMask);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateVehicleAttributesTest()
    {
        ...
        $name = 'name3373707';
        $attributes = [];
        $response = $client->updateVehicleAttributes($name, $attributes);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateVehicleAttributesExceptionTest()
    {
        ...
        $attributes = [];
        try {
            $client->updateVehicleAttributes($name, $attributes);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateVehicleLocationTest()
    {
        ...
        $response = $client->updateVehicleLocation($name, $currentLocation);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateVehicleLocationExceptionTest()
    {
        ...
        $currentLocation = new VehicleLocation();
        try {
            $client->updateVehicleLocation($name, $currentLocation);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
