...
class VehicleLocation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp raw_location_time = 17 [(.google.api.field_behavior) = INPUT_ONLY];</code>
     */
    protected $raw_location_time = null;
    /**
     * Input only. Source of the raw location.
     *
     * Generated from protobuf field <code>.maps.fleetengine.v1.LocationSensor raw_location_sensor = 28 [(.google.api.field_behavior) = INPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.type.LatLng supplemental_location = 18 [(.google.api.field_behavior) = INPUT_ONLY];</code>
     */
    protected $supplemental_location = null;
    /**
     * Input only. Timestamp associated with the supplemental location.
     *
     * Generated from protobuf field <code>.google.protobuf.Timestamp supplemental_location_time = 19 [(.google.api.field_behavior) = INPUT_ONLY];</code>
     */
    protected $supplemental_location_time = null;
    /**
     * Input only. Source of the supplemental location.
     *
     * Generated from protobuf field <code>.maps.fleetengine.v1.LocationSensor supplemental_location_sensor = 20 [(.google.api.field_behavior) = INPUT_ONLY];</code>
     */
