...
class ListVehiclesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.v1.Vehicle vehicles = 1;</code>
     * @param \Maps\Fleetengine\V1\Vehicle[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setVehicles($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Maps\Fleetengine\V1\Vehicle::class);
        $this->vehicles = $arr;
