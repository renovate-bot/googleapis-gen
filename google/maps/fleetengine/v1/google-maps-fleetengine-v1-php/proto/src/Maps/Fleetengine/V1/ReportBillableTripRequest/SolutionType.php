...
namespace Maps\Fleetengine\V1\ReportBillableTripRequest;
...
class_alias(SolutionType::class, \Maps\Fleetengine\V1\ReportBillableTripRequest_SolutionType::class);
