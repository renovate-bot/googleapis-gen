...
class ReportBillableTripRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\V1\BillingPlatformIdentifier::class);
        $this->platform = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\V1\ReportBillableTripRequest\SolutionType::class);
