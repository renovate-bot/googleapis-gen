...
namespace Maps\Fleetengine\V1\VisualTrafficReportPolylineRendering;
...
class RoadStretch extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\V1\VisualTrafficReportPolylineRendering\RoadStretch\Style::class);
        $this->style = $var;
...
class_alias(RoadStretch::class, \Maps\Fleetengine\V1\VisualTrafficReportPolylineRendering_RoadStretch::class);
