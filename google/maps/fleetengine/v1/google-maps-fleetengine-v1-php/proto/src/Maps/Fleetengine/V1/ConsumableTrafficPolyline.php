...
class ConsumableTrafficPolyline extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Maps\Fleetengine\V1\SpeedReadingInterval[]|\Google\Protobuf\Internal\RepeatedField $speed_reading_interval
     *           Traffic speed along the path from the previous waypoint to the current
     *           waypoint.
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.v1.SpeedReadingInterval speed_reading_interval = 1;</code>
     * @param \Maps\Fleetengine\V1\SpeedReadingInterval[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSpeedReadingInterval($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Maps\Fleetengine\V1\SpeedReadingInterval::class);
