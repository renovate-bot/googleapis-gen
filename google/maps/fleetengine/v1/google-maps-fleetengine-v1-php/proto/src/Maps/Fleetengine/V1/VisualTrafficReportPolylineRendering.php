...
class VisualTrafficReportPolylineRendering extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Maps\Fleetengine\V1\VisualTrafficReportPolylineRendering\RoadStretch[]|\Google\Protobuf\Internal\RepeatedField $road_stretch
     *           Optional. Road stretches that should be rendered along the polyline. Note that
     *           the stretches are guaranteed to not overlap, and that they do not
     *           necessarily span the full route. In the absence of a road stretch to style,
     *           the client should apply the default for the route.
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.v1.VisualTrafficReportPolylineRendering.RoadStretch road_stretch = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Maps\Fleetengine\V1\VisualTrafficReportPolylineRendering\RoadStretch[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRoadStretch($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Maps\Fleetengine\V1\VisualTrafficReportPolylineRendering\RoadStretch::class);
