    ...
    module V1
      module TripService
        ...
        class Client
          ...
          #   {::Maps::Fleetengine::V1::CreateTripRequest} or an equivalent Hash.
          #
          #   @param request [::Maps::Fleetengine::V1::CreateTripRequest, ::Hash]
          ...
          def create_trip request, options = nil
            ...
            request = ::Gapic::Protobuf.coerce request, to: ::Maps::Fleetengine::V1::CreateTripRequest
            ...
            metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
              ...
              gapic_version: ::Google::Cloud::Maps::Fleetengine::V1::VERSION
          ...
          #   {::Maps::Fleetengine::V1::GetTripRequest} or an equivalent Hash.
          #
          #   @param request [::Maps::Fleetengine::V1::GetTripRequest, ::Hash]
          #     A request object representing the call parameters. Required. To specify no
          #     parameters, or to keep all the default parameter values, pass an empty Hash.
          #   @param options [::Gapic::CallOptions, ::Hash]
          #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
          ...
          def get_trip request, options = nil
            ...
            request = ::Gapic::Protobuf.coerce request, to: ::Maps::Fleetengine::V1::GetTripRequest
          ...
          #   {::Maps::Fleetengine::V1::ReportBillableTripRequest} or an equivalent Hash.
          #
          #   @param request [::Maps::Fleetengine::V1::ReportBillableTripRequest, ::Hash]
          #     A request object representing the call parameters. Required. To specify no
          #     parameters, or to keep all the default parameter values, pass an empty Hash.
          #   @param options [::Gapic::CallOptions, ::Hash]
          #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
          ...
          #   @param platform [::Maps::Fleetengine::V1::BillingPlatformIdentifier]
          ...
          def report_billable_trip request, options = nil
            ...
            request = ::Gapic::Protobuf.coerce request, to: ::Maps::Fleetengine::V1::ReportBillableTripRequest
          ...
          #   {::Maps::Fleetengine::V1::SearchTripsRequest} or an equivalent Hash.
          #
          #   @param request [::Maps::Fleetengine::V1::SearchTripsRequest, ::Hash]
          #     A request object representing the call parameters. Required. To specify no
          #     parameters, or to keep all the default parameter values, pass an empty Hash.
          #   @param options [::Gapic::CallOptions, ::Hash]
          #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
          ...
          def search_trips request, options = nil
            ...
            request = ::Gapic::Protobuf.coerce request, to: ::Maps::Fleetengine::V1::SearchTripsRequest
          ...
          #   {::Maps::Fleetengine::V1::UpdateTripRequest} or an equivalent Hash.
          #
          #   @param request [::Maps::Fleetengine::V1::UpdateTripRequest, ::Hash]
          #     A request object representing the call parameters. Required. To specify no
          #     parameters, or to keep all the default parameter values, pass an empty Hash.
          #   @param options [::Gapic::CallOptions, ::Hash]
          #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
          ...
          def update_trip request, options = nil
            ...
            request = ::Gapic::Protobuf.coerce request, to: ::Maps::Fleetengine::V1::UpdateTripRequest
          ...
          # {::Maps::Fleetengine::V1::TripService::Client::Configuration::Rpcs}
          ...
          #   Defaults to `"fleetengine.googleapis.com"`.
          #   @return [::String]
          ...
          class Configuration
            ...
            config_attr :endpoint,      "fleetengine.googleapis.com", ::String
