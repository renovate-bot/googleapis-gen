...
describe('v1.VehicleServiceClient', () => {
    ...
    describe('createVehicle', () => {
        it('invokes createVehicle without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.maps.fleetengine.v1.Vehicle());
            ...
            assert((client.innerApiCalls.createVehicle as SinonStub)
    ...
    describe('getVehicle', () => {
        it('invokes getVehicle without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getVehicle as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateVehicle', () => {
        it('invokes updateVehicle without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateVehicle as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateVehicleAttributes', () => {
        it('invokes updateVehicleAttributes without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.maps.fleetengine.v1.UpdateVehicleAttributesResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateVehicleAttributes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('searchVehicles', () => {
        it('invokes searchVehicles without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.maps.fleetengine.v1.SearchVehiclesResponse());
            client.innerApiCalls.searchVehicles = stubSimpleCall(expectedResponse);
            const [response] = await client.searchVehicles(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchVehicles as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('searchFuzzedVehicles', () => {
        it('invokes searchFuzzedVehicles without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchFuzzedVehicles as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listVehicles', () => {
        it('invokes listVehicles without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listVehicles as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
