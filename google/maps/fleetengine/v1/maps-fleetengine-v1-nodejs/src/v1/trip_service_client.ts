 ...
 *   The first element of the array is an object representing [Trip]{@link maps.fleetengine.v1.Trip}.
 *   Please see the
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Trip]{@link maps.fleetengine.v1.Trip}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Trip]{@link maps.fleetengine.v1.Trip} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  searchTripsStream(
    ...
    return this.descriptors.page.searchTrips.createStream(
      this.innerApiCalls.searchTrips as gax.GaxCall,
      request,
      callSettings
    );
  }
 ...
 *   [Trip]{@link maps.fleetengine.v1.Trip}. The API will be called under the hood as needed, once per the page,
