 ...
 *   AND
 *   (required_one_of_attributes{@link 0|0} OR required_one_of_attributes{@link 1|0} OR
 *   ...)
 *   AND
 *   (required_one_of_attributes{@link 0|1} OR required_one_of_attributes{@link 1|1} OR
 *   ...)
 *   ```
 *
 ...
 *   (required_attributes[0] AND required_attributes[1] AND ...)
 *   AND
 *   (required_one_of_attributes{@link 0|0} AND required_one_of_attributes{@link 1|0} AND
 *   ...)
 *   OR
 *   (required_one_of_attributes{@link 0|1} AND required_one_of_attributes{@link 1|1} AND
 *   ...)
 *   ```
 *
