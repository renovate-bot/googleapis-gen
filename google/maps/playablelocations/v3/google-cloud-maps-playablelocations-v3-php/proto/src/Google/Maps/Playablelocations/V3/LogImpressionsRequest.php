 ...
 *
 * Generated from protobuf message <code>google.maps.playablelocations.v3.LogImpressionsRequest</code>
 */
class LogImpressionsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * Required. Impression event details. The maximum number of impression reports that you
     * can log at once is 50.
     *
     * Generated from protobuf field <code>repeated .google.maps.playablelocations.v3.Impression impressions = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $impressions;
    /**
     ...
     *
     *     @type \Google\Maps\Playablelocations\V3\Impression[]|\Google\Protobuf\Internal\RepeatedField $impressions
     *           Required. Impression event details. The maximum number of impression reports that you
     *           can log at once is 50.
     ...
     *
     * Generated from protobuf field <code>repeated .google.maps.playablelocations.v3.Impression impressions = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Maps\Playablelocations\V3\Impression[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setImpressions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Maps\Playablelocations\V3\Impression::class);
        $this->impressions = $arr;
