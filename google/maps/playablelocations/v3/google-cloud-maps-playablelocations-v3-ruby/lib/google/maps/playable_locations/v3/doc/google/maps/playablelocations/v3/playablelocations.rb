  ...
  module Maps
    module Playablelocations
      module V3
        ...
        class SamplePlayableLocationsRequest; end

        # Response for the
        # {Google::Maps::Playablelocations::V3::PlayableLocations::SamplePlayableLocations SamplePlayableLocations}
        # method.
        # @!attribute [rw] locations_per_game_object_type
        #   @return [Hash{Integer => Google::Maps::Playablelocations::V3::Sample::PlayableLocationList}]
        ...
        class SamplePlayableLocationsResponse; end
        ...
        #     operating system).
        class LogPlayerReportsRequest; end

        # A response for the {Google::Maps::Playablelocations::V3::PlayableLocations::LogPlayerReports LogPlayerReports}
        # method.
        #
        # This method returns no data upon success.
        class LogPlayerReportsResponse; end
        ...
        #     Required. Information about the client device. For example, device model and
        #     operating system.
        class LogImpressionsRequest; end

        # A response for the {Google::Maps::Playablelocations::V3::PlayableLocations::LogImpressions LogImpressions} method.
        # This method returns no data upon success.
        class LogImpressionsResponse; end
      end
    end
  end
end