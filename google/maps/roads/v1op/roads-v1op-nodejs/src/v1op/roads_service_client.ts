 ...
 * `src/v1op/roads_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './roads_service_client_config.json';
 ...
 * @memberof v1op
 */
export class RoadsServiceClient {
  ...
  roadsServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of RoadsServiceClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof RoadsServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.maps.roads.v1op.RoadsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.roadsServiceStub) {
      return this.roadsServiceStub;
    }

    // Put together the "service stub" for
    // google.maps.roads.v1op.RoadsService.
    this.roadsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.maps.roads.v1op.RoadsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.maps.roads.v1op.RoadsService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const roadsServiceStubMethods =
        ['snapToRoads', 'listNearestRoads'];
    for (const methodName of roadsServiceStubMethods) {
      const callPromise = this.roadsServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {boolean} request.interpolate
 ...
 *   The first element of the array is an object representing [SnapToRoadsResponse]{@link google.maps.roads.v1op.SnapToRoadsResponse}.
 *   Please see the
 ...
 */
  ...
  listNearestRoads(
      ...
      Promise<[
        ...
        protos.google.maps.roads.v1op.IListNearestRoadsRequest|undefined, {}|undefined
      ]>;
  listNearestRoads(
      request: protos.google.maps.roads.v1op.IListNearestRoadsRequest,
      options: CallOptions,
 ...
 */
  ...
  close(): Promise<void> {
    this.initialize();
    if (!this._terminated) {
      return this.roadsServiceStub!.then(stub => {
