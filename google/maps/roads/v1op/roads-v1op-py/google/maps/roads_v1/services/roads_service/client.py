...
class RoadsServiceClientMeta(type):
    """Metaclass for the RoadsService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[RoadsServiceTransport]]
    _transport_registry["grpc"] = RoadsServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = RoadsServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: str = None,
        ) -> Type[RoadsServiceTransport]:
...
class RoadsServiceClient(metaclass=RoadsServiceClientMeta):
    """"""
    ...
    DEFAULT_ENDPOINT = "roads.googleapis.com"
    ...
    def transport(self) -> RoadsServiceTransport:
        ...
        Returns:
            RoadsServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, RoadsServiceTransport, None] = None,
        ...
        if isinstance(transport, RoadsServiceTransport):
            # transport is a RoadsServiceTransport instance.
    ...
    def snap_to_roads(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.snap_to_roads]
    ...
    def list_nearest_roads(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a roads.ListNearestRoadsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_nearest_roads]
