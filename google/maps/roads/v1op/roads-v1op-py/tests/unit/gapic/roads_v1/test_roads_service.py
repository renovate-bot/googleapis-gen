...
def test__get_default_mtls_endpoint():
    ...
    assert RoadsServiceClient._get_default_mtls_endpoint(None) is None
    assert RoadsServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert RoadsServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert RoadsServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert RoadsServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test_roads_service_client_service_account_always_use_jwt(client_class):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.RoadsServiceGrpcTransport, "grpc"),
    (transports.RoadsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
def test_roads_service_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
def test_roads_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
def test_roads_service_client_get_transport_class():
    transport = RoadsServiceClient.get_transport_class()
    available_transports = [
        transports.RoadsServiceGrpcTransport,
    ]
    assert transport in available_transports

    transport = RoadsServiceClient.get_transport_class("grpc")
    assert transport == transports.RoadsServiceGrpcTransport


@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (RoadsServiceClient, transports.RoadsServiceGrpcTransport, "grpc"),
    (RoadsServiceAsyncClient, transports.RoadsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_roads_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(RoadsServiceClient, 'get_transport_class') as gtc:
...
def test_roads_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_roads_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_roads_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_roads_service_client_client_options_from_dict():
    with mock.patch('google.maps.roads_v1.services.roads_service.transports.RoadsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_snap_to_roads(transport: str = 'grpc', request_type=roads.SnapToRoadsRequest):
    client = RoadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_snap_to_roads_from_dict():
...
@pytest.mark.asyncio
async def test_snap_to_roads_async_from_dict():
    await test_snap_to_roads_async(request_type=dict)


def test_snap_to_roads_flattened():
    client = RoadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_snap_to_roads_flattened_async():
    client = RoadsServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.snap_to_roads(
            path='path_value',
        )
...
@pytest.mark.asyncio
async def test_snap_to_roads_flattened_error_async():
    client = RoadsServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.snap_to_roads(
            roads.SnapToRoadsRequest(),
            path='path_value',
        )


def test_list_nearest_roads(transport: str = 'grpc', request_type=roads.ListNearestRoadsRequest):
    client = RoadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_nearest_roads_async_from_dict():
    await test_list_nearest_roads_async(request_type=dict)


def test_list_nearest_roads_flattened():
    client = RoadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_nearest_roads_flattened_async():
    client = RoadsServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_nearest_roads(
            points='points_value',
        )
...
@pytest.mark.asyncio
async def test_list_nearest_roads_flattened_error_async():
    client = RoadsServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_nearest_roads(
            roads.ListNearestRoadsRequest(),
            points='points_value',
        )
...
def test_transport_get_channel():
    ...
    transport = transports.RoadsServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_roads_service_base_transport():
    # Instantiate the base transport.
    with mock.patch('google.maps.roads_v1.services.roads_service.transports.RoadsServiceTransport.__init__') as Transport:
...
def test_roads_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.maps.roads_v1.services.roads_service.transports.RoadsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_roads_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.maps.roads_v1.services.roads_service.transports.RoadsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RoadsServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.RoadsServiceGrpcTransport, transports.RoadsServiceGrpcAsyncIOTransport])
def test_roads_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_roads_service_host_no_port():
    client = RoadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='roads.googleapis.com'),
    )
    assert client.transport._host == 'roads.googleapis.com:443'


def test_roads_service_host_with_port():
    client = RoadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_roads_service_grpc_asyncio_transport_channel():
...
@pytest.mark.parametrize("transport_class", [transports.RoadsServiceGrpcTransport, transports.RoadsServiceGrpcAsyncIOTransport])
def test_roads_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.RoadsServiceGrpcTransport, transports.RoadsServiceGrpcAsyncIOTransport])
def test_roads_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_parse_common_billing_account_path():
    ...
    actual = RoadsServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = RoadsServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = RoadsServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = RoadsServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = RoadsServiceClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.RoadsServiceTransport, '_prep_wrapped_messages') as prep:
        client = RoadsServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(transports.RoadsServiceTransport, '_prep_wrapped_messages') as prep:
        transport_class = RoadsServiceClient.get_transport_class()
        transport = transport_class(
            credentials=ga_credentials.AnonymousCredentials(),
            client_info=client_info,
        )
