...
namespace Google\Cloud\Iam\Tests\Unit\V1Beta;

use Google\Cloud\Iam\V1Beta\WorkloadIdentityPoolsClient;
...
class WorkloadIdentityPoolsClientTest extends GeneratedTest
{
    ...
    public function listWorkloadIdentityPoolsTest()
    {
        ...
        $workloadIdentityPools = [$workloadIdentityPoolsElement];
    ...
    public function listWorkloadIdentityPoolProvidersTest()
    {
        ...
        $workloadIdentityPoolProviders = [$workloadIdentityPoolProvidersElement];
