    ...
    module V1beta
      ...
      class WorkloadIdentityPool
        ...
        module State
          ...
          # {Google::Iam::V1beta::WorkloadIdentityPools::UndeleteWorkloadIdentityPool UndeleteWorkloadIdentityPool}.
          #
      ...
      class WorkloadIdentityPoolProvider
        ...
        module State
          ...
          # provider using
          # {Google::Iam::V1beta::WorkloadIdentityPools::UndeleteWorkloadIdentityPoolProvider UndeleteWorkloadIdentityPoolProvider}.
          #
      ...
      class ListWorkloadIdentityPoolsRequest; end
      ...
      class ListWorkloadIdentityPoolsResponse; end

      # Request message for GetWorkloadIdentityPool.
      # @!attribute [rw] name
      #   @return [String]
      #     Required. The name of the pool to retrieve.
      class GetWorkloadIdentityPoolRequest; end
      ...
      class CreateWorkloadIdentityPoolRequest; end
      ...
      class UpdateWorkloadIdentityPoolRequest; end

      # Request message for DeleteWorkloadIdentityPool.
      # @!attribute [rw] name
      #   @return [String]
      #     Required. The name of the pool to delete.
      class DeleteWorkloadIdentityPoolRequest; end

      # Request message for UndeleteWorkloadIdentityPool.
      # @!attribute [rw] name
      #   @return [String]
      #     Required. The name of the pool to undelete.
      class UndeleteWorkloadIdentityPoolRequest; end
      ...
      class ListWorkloadIdentityPoolProvidersRequest; end
      ...
      #     A token, which can be sent as `page_token` to retrieve the next page.
      #     If this field is omitted, there are no subsequent pages.
      class ListWorkloadIdentityPoolProvidersResponse; end

      # Request message for GetWorkloadIdentityPoolProvider.
      # @!attribute [rw] name
      #   @return [String]
      #     Required. The name of the provider to retrieve.
      class GetWorkloadIdentityPoolProviderRequest; end
      ...
      #     and may contain the characters [a-z0-9-]. The prefix `gcp-` is
      #     reserved for use by Google, and may not be specified.
      class CreateWorkloadIdentityPoolProviderRequest; end
      ...
      class UpdateWorkloadIdentityPoolProviderRequest; end

      # Request message for DeleteWorkloadIdentityPoolProvider.
      # @!attribute [rw] name
      #   @return [String]
      #     Required. The name of the provider to delete.
      class DeleteWorkloadIdentityPoolProviderRequest; end

      # Request message for UndeleteWorkloadIdentityPoolProvider.
      # @!attribute [rw] name
      #   @return [String]
      #     Required. The name of the provider to undelete.
      class UndeleteWorkloadIdentityPoolProviderRequest; end

      # Metadata for long-running WorkloadIdentityPool operations.
      class WorkloadIdentityPoolOperationMetadata; end

      # Metadata for long-running WorkloadIdentityPoolProvider operations.
      class WorkloadIdentityPoolProviderOperationMetadata; end
    end
  end
end