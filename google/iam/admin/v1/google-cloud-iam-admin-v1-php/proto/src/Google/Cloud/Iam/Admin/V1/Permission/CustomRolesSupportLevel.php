...
namespace Google\Cloud\Iam\Admin\V1\Permission;
...
class_alias(CustomRolesSupportLevel::class, \Google\Cloud\Iam\Admin\V1\Permission_CustomRolesSupportLevel::class);
