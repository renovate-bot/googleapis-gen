...
class ListServiceAccountsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Iam\Admin\V1\ServiceAccount[]|\Google\Protobuf\Internal\RepeatedField $accounts
     *           The list of matching service accounts.
     ...
     *
     * Generated from protobuf field <code>repeated .google.iam.admin.v1.ServiceAccount accounts = 1;</code>
     * @param \Google\Cloud\Iam\Admin\V1\ServiceAccount[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAccounts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Iam\Admin\V1\ServiceAccount::class);
        $this->accounts = $arr;
