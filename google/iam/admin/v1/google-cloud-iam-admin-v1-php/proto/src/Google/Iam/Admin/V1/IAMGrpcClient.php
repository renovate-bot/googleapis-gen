...
class IAMGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Iam\Admin\V1\PatchServiceAccountRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function PatchServiceAccount(\Google\Iam\Admin\V1\PatchServiceAccountRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Iam\Admin\V1\UndeleteServiceAccountRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function UndeleteServiceAccount(\Google\Iam\Admin\V1\UndeleteServiceAccountRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.iam.admin.v1.IAM/UndeleteServiceAccount',
        $argument,
        ['\Google\Iam\Admin\V1\UndeleteServiceAccountResponse', 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Iam\Admin\V1\EnableServiceAccountRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function EnableServiceAccount(\Google\Iam\Admin\V1\EnableServiceAccountRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Iam\Admin\V1\DisableServiceAccountRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function DisableServiceAccount(\Google\Iam\Admin\V1\DisableServiceAccountRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Iam\Admin\V1\UploadServiceAccountKeyRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function UploadServiceAccountKey(\Google\Iam\Admin\V1\UploadServiceAccountKeyRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Iam\Admin\V1\QueryAuditableServicesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function QueryAuditableServices(\Google\Iam\Admin\V1\QueryAuditableServicesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.iam.admin.v1.IAM/QueryAuditableServices',
        $argument,
        ['\Google\Iam\Admin\V1\QueryAuditableServicesResponse', 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Iam\Admin\V1\LintPolicyRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function LintPolicy(\Google\Iam\Admin\V1\LintPolicyRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.iam.admin.v1.IAM/LintPolicy',
        $argument,
        ['\Google\Iam\Admin\V1\LintPolicyResponse', 'decode'],
        $metadata, $options);
    }
