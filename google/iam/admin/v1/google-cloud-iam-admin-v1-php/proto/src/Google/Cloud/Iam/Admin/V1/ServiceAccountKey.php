...
class ServiceAccountKey extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Iam\Admin\V1\ServiceAccountPrivateKeyType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Iam\Admin\V1\ServiceAccountKeyAlgorithm::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Iam\Admin\V1\ServiceAccountKeyOrigin::class);
        $this->key_origin = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Iam\Admin\V1\ListServiceAccountKeysRequest\KeyType::class);
        $this->key_type = $var;
