...
class Permission extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Iam\Admin\V1\Permission\PermissionLaunchStage::class);
        $this->stage = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Iam\Admin\V1\Permission\CustomRolesSupportLevel::class);
