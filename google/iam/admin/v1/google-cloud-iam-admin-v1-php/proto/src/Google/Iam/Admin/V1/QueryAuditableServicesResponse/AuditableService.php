...
namespace Google\Iam\Admin\V1\QueryAuditableServicesResponse;
...
class_alias(AuditableService::class, \Google\Iam\Admin\V1\QueryAuditableServicesResponse_AuditableService::class);
