...
namespace Google\Cloud\Iam\Admin\V1\ListServiceAccountKeysRequest;
...
class_alias(KeyType::class, \Google\Cloud\Iam\Admin\V1\ListServiceAccountKeysRequest_KeyType::class);
