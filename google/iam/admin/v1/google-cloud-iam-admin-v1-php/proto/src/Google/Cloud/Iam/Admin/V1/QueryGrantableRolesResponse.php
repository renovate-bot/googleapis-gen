...
class QueryGrantableRolesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Iam\Admin\V1\Role[]|\Google\Protobuf\Internal\RepeatedField $roles
     *           The list of matching roles.
     ...
     *
     * Generated from protobuf field <code>repeated .google.iam.admin.v1.Role roles = 1;</code>
     * @param \Google\Cloud\Iam\Admin\V1\Role[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRoles($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Iam\Admin\V1\Role::class);
        $this->roles = $arr;
