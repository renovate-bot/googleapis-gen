...
// internalIamClient is an interface that defines the methods availaible from Identity and Access Management (IAM) API.
...
func (c *IamClient) setGoogleClientInfo(...string) {
