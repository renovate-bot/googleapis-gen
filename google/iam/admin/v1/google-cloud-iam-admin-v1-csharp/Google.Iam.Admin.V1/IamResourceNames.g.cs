...
using giav = Google.Iam.Admin.V1;
using sys = System;
...
namespace Google.Iam.Admin.V1
{
    ...
    {
        /// <summary>
        /// <see cref="giav::ServiceAccountName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public giav::ServiceAccountName ServiceAccountName
        {
            get => string.IsNullOrEmpty(Name) ? null : giav::ServiceAccountName.Parse(Name, allowUnparsed: true);
    ...
    {
        /// <summary>
        /// <see cref="giav::KeyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public giav::KeyName KeyName
        {
            get => string.IsNullOrEmpty(Name) ? null : giav::KeyName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }
