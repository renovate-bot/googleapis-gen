...
class ::Google::Iam::Admin::V1::IAM::ClientPathsTest < Minitest::Test
  def test_key_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.key_path project: "value0", service_account: "value1", key: "value2"
      assert_equal "projects/value0/serviceAccounts/value1/keys/value2", path
    end
  end
