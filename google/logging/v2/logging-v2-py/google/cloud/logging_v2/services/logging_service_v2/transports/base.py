...
class LoggingServiceV2Transport(abc.ABC):
    ...
    @property
    def delete_log(self) -> typing.Callable[
    ...
    @property
    def write_log_entries(self) -> typing.Callable[
    ...
    @property
    def list_log_entries(self) -> typing.Callable[
    ...
    @property
    def list_logs(self) -> typing.Callable[
            [logging.ListLogsRequest],
            typing.Union[
                logging.ListLogsResponse,
                typing.Awaitable[logging.ListLogsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def tail_log_entries(self) -> typing.Callable[
