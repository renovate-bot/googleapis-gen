...
public final class LoggingServiceV2Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.logging.v2.TailLogEntriesRequest,
      com.google.logging.v2.TailLogEntriesResponse> getTailLogEntriesMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.logging.v2.TailLogEntriesRequest,
      com.google.logging.v2.TailLogEntriesResponse> getTailLogEntriesMethod() {
    io.grpc.MethodDescriptor<com.google.logging.v2.TailLogEntriesRequest, com.google.logging.v2.TailLogEntriesResponse> getTailLogEntriesMethod;
    if ((getTailLogEntriesMethod = LoggingServiceV2Grpc.getTailLogEntriesMethod) == null) {
      synchronized (LoggingServiceV2Grpc.class) {
        if ((getTailLogEntriesMethod = LoggingServiceV2Grpc.getTailLogEntriesMethod) == null) {
          LoggingServiceV2Grpc.getTailLogEntriesMethod = getTailLogEntriesMethod =
              io.grpc.MethodDescriptor.<com.google.logging.v2.TailLogEntriesRequest, com.google.logging.v2.TailLogEntriesResponse>newBuilder()
              ...
              .setSchemaDescriptor(new LoggingServiceV2MethodDescriptorSupplier("TailLogEntries"))
              .build();
        }
      }
    }
  ...
  public static LoggingServiceV2Stub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<LoggingServiceV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<LoggingServiceV2Stub>() {
        @java.lang.Override
        public LoggingServiceV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static LoggingServiceV2BlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<LoggingServiceV2BlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<LoggingServiceV2BlockingStub>() {
        @java.lang.Override
        public LoggingServiceV2BlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static LoggingServiceV2FutureStub newFutureStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<LoggingServiceV2FutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<LoggingServiceV2FutureStub>() {
        @java.lang.Override
        public LoggingServiceV2FutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static abstract class LoggingServiceV2ImplBase implements io.grpc.BindableService {
    ...
    public io.grpc.stub.StreamObserver<com.google.logging.v2.TailLogEntriesRequest> tailLogEntries(
        io.grpc.stub.StreamObserver<com.google.logging.v2.TailLogEntriesResponse> responseObserver) {
   ...
   * </pre>
   */
  public static final class LoggingServiceV2Stub extends io.grpc.stub.AbstractAsyncStub<LoggingServiceV2Stub> {
    ...
    @java.lang.Override
    protected LoggingServiceV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new LoggingServiceV2Stub(channel, callOptions);
    }
   ...
   * </pre>
   */
  public static final class LoggingServiceV2BlockingStub extends io.grpc.stub.AbstractBlockingStub<LoggingServiceV2BlockingStub> {
    private LoggingServiceV2BlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
   ...
   * </pre>
   */
  public static final class LoggingServiceV2FutureStub extends io.grpc.stub.AbstractFutureStub<LoggingServiceV2FutureStub> {
    private LoggingServiceV2FutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_TAIL_LOG_ENTRIES:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.tailLogEntries(
              (io.grpc.stub.StreamObserver<com.google.logging.v2.TailLogEntriesResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
