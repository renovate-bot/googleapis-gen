...
public final class MetricsServiceV2Grpc {
  ...
  public static MetricsServiceV2Stub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<MetricsServiceV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<MetricsServiceV2Stub>() {
        @java.lang.Override
        public MetricsServiceV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static MetricsServiceV2BlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<MetricsServiceV2BlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<MetricsServiceV2BlockingStub>() {
        @java.lang.Override
        public MetricsServiceV2BlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static MetricsServiceV2FutureStub newFutureStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<MetricsServiceV2FutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<MetricsServiceV2FutureStub>() {
        @java.lang.Override
        public MetricsServiceV2FutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static final class MetricsServiceV2Stub extends io.grpc.stub.AbstractAsyncStub<MetricsServiceV2Stub> {
    ...
    @java.lang.Override
    protected MetricsServiceV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new MetricsServiceV2Stub(channel, callOptions);
    }
    ...
    public void listLogMetrics(com.google.logging.v2.ListLogMetricsRequest request,
        io.grpc.stub.StreamObserver<com.google.logging.v2.ListLogMetricsResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getListLogMetricsMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void getLogMetric(com.google.logging.v2.GetLogMetricRequest request,
        io.grpc.stub.StreamObserver<com.google.logging.v2.LogMetric> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetLogMetricMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void createLogMetric(com.google.logging.v2.CreateLogMetricRequest request,
        io.grpc.stub.StreamObserver<com.google.logging.v2.LogMetric> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getCreateLogMetricMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void updateLogMetric(com.google.logging.v2.UpdateLogMetricRequest request,
        io.grpc.stub.StreamObserver<com.google.logging.v2.LogMetric> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getUpdateLogMetricMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void deleteLogMetric(com.google.logging.v2.DeleteLogMetricRequest request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getDeleteLogMetricMethod(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class MetricsServiceV2BlockingStub extends io.grpc.stub.AbstractBlockingStub<MetricsServiceV2BlockingStub> {
   ...
   * </pre>
   */
  public static final class MetricsServiceV2FutureStub extends io.grpc.stub.AbstractFutureStub<MetricsServiceV2FutureStub> {
    private MetricsServiceV2FutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
