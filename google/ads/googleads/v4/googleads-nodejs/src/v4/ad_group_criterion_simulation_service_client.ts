 ...
 * `src/v4/ad_group_criterion_simulation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_criterion_simulation_service_client_config.json';
...
export class AdGroupCriterionSimulationServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.AdGroupCriterionSimulationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupCriterionSimulationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.AdGroupCriterionSimulationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.AdGroupCriterionSimulationService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupCriterionSimulationServiceStubMethods =
        ['getAdGroupCriterionSimulation'];
    for (const methodName of adGroupCriterionSimulationServiceStubMethods) {
      const callPromise = this.adGroupCriterionSimulationServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getAdGroupCriterionSimulation(
      request?: protos.google.ads.googleads.v4.services.IGetAdGroupCriterionSimulationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.IAdGroupCriterionSimulation,
        protos.google.ads.googleads.v4.services.IGetAdGroupCriterionSimulationRequest|undefined, {}|undefined
      ]>;
  getAdGroupCriterionSimulation(
      request: protos.google.ads.googleads.v4.services.IGetAdGroupCriterionSimulationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.IAdGroupCriterionSimulation,
          protos.google.ads.googleads.v4.services.IGetAdGroupCriterionSimulationRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroupCriterionSimulation(
      request: protos.google.ads.googleads.v4.services.IGetAdGroupCriterionSimulationRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AdGroupCriterionSimulation]{@link google.ads.googleads.v4.resources.AdGroupCriterionSimulation}.
 *   Please see the
