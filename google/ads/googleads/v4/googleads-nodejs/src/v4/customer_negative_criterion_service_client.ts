 ...
 * `src/v4/customer_negative_criterion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_negative_criterion_service_client_config.json';
...
export class CustomerNegativeCriterionServiceClient {
  ...
  customerNegativeCriterionServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CustomerNegativeCriterionServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.CustomerNegativeCriterionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerNegativeCriterionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.CustomerNegativeCriterionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.CustomerNegativeCriterionService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerNegativeCriterionServiceStubMethods =
        ['getCustomerNegativeCriterion', 'mutateCustomerNegativeCriteria'];
    for (const methodName of customerNegativeCriterionServiceStubMethods) {
      const callPromise = this.customerNegativeCriterionServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getCustomerNegativeCriterion(
      request: protos.google.ads.googleads.v4.services.IGetCustomerNegativeCriterionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.ICustomerNegativeCriterion,
        protos.google.ads.googleads.v4.services.IGetCustomerNegativeCriterionRequest|undefined, {}|undefined
      ]>;
  getCustomerNegativeCriterion(
      request: protos.google.ads.googleads.v4.services.IGetCustomerNegativeCriterionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.ICustomerNegativeCriterion,
          protos.google.ads.googleads.v4.services.IGetCustomerNegativeCriterionRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomerNegativeCriterion(
      request: protos.google.ads.googleads.v4.services.IGetCustomerNegativeCriterionRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CustomerNegativeCriterion]{@link google.ads.googleads.v4.resources.CustomerNegativeCriterion}.
 *   Please see the
 ...
 */
  ...
  mutateCustomerNegativeCriteria(
      request: protos.google.ads.googleads.v4.services.IMutateCustomerNegativeCriteriaRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IMutateCustomerNegativeCriteriaResponse,
        protos.google.ads.googleads.v4.services.IMutateCustomerNegativeCriteriaRequest|undefined, {}|undefined
      ]>;
  mutateCustomerNegativeCriteria(
      request: protos.google.ads.googleads.v4.services.IMutateCustomerNegativeCriteriaRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IMutateCustomerNegativeCriteriaResponse,
          protos.google.ads.googleads.v4.services.IMutateCustomerNegativeCriteriaRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerNegativeCriteria(
      request: protos.google.ads.googleads.v4.services.IMutateCustomerNegativeCriteriaRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomerNegativeCriteriaResponse]{@link google.ads.googleads.v4.services.MutateCustomerNegativeCriteriaResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
