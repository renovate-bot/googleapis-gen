 ...
 * `src/v4/shopping_performance_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './shopping_performance_view_service_client_config.json';
...
export class ShoppingPerformanceViewServiceClient {
  ...
  shoppingPerformanceViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ShoppingPerformanceViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.ShoppingPerformanceViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.shoppingPerformanceViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.ShoppingPerformanceViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.ShoppingPerformanceViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const shoppingPerformanceViewServiceStubMethods =
        ['getShoppingPerformanceView'];
    for (const methodName of shoppingPerformanceViewServiceStubMethods) {
      const callPromise = this.shoppingPerformanceViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getShoppingPerformanceView(
      request: protos.google.ads.googleads.v4.services.IGetShoppingPerformanceViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.IShoppingPerformanceView,
        protos.google.ads.googleads.v4.services.IGetShoppingPerformanceViewRequest|undefined, {}|undefined
      ]>;
  getShoppingPerformanceView(
      request: protos.google.ads.googleads.v4.services.IGetShoppingPerformanceViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.IShoppingPerformanceView,
          protos.google.ads.googleads.v4.services.IGetShoppingPerformanceViewRequest|null|undefined,
          {}|null|undefined>): void;
  getShoppingPerformanceView(
      request: protos.google.ads.googleads.v4.services.IGetShoppingPerformanceViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [ShoppingPerformanceView]{@link google.ads.googleads.v4.resources.ShoppingPerformanceView}.
 *   Please see the
