 ...
 * `src/v4/currency_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './currency_constant_service_client_config.json';
 ...
 * @memberof v4
 */
export class CurrencyConstantServiceClient {
  ...
  currencyConstantServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CurrencyConstantServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.CurrencyConstantService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.currencyConstantServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.CurrencyConstantService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.CurrencyConstantService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const currencyConstantServiceStubMethods =
        ['getCurrencyConstant'];
    for (const methodName of currencyConstantServiceStubMethods) {
      const callPromise = this.currencyConstantServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getCurrencyConstant(
      request?: protos.google.ads.googleads.v4.services.IGetCurrencyConstantRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.ICurrencyConstant,
        protos.google.ads.googleads.v4.services.IGetCurrencyConstantRequest|undefined, {}|undefined
      ]>;
  getCurrencyConstant(
      request: protos.google.ads.googleads.v4.services.IGetCurrencyConstantRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.ICurrencyConstant,
          protos.google.ads.googleads.v4.services.IGetCurrencyConstantRequest|null|undefined,
          {}|null|undefined>): void;
  getCurrencyConstant(
      request: protos.google.ads.googleads.v4.services.IGetCurrencyConstantRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CurrencyConstant]{@link google.ads.googleads.v4.resources.CurrencyConstant}.
 *   Please see the
