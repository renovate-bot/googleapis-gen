 ...
 * `src/v4/customer_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_service_client_config.json';
...
export class CustomerServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.CustomerService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.CustomerService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.CustomerService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerServiceStubMethods =
        ['getCustomer', 'mutateCustomer', 'listAccessibleCustomers', 'createCustomerClient'];
    for (const methodName of customerServiceStubMethods) {
      const callPromise = this.customerServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getCustomer(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v4.services.IGetCustomerRequest|undefined, {}|undefined
      ]>;
  getCustomer(
      request: protos.google.ads.googleads.v4.services.IGetCustomerRequest,
      options: CallOptions,
 ...
 *   The first element of the array is an object representing [Customer]{@link google.ads.googleads.v4.resources.Customer}.
 *   Please see the
 ...
 */
  ...
  mutateCustomer(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v4.services.IMutateCustomerRequest|undefined, {}|undefined
      ]>;
  mutateCustomer(
      request: protos.google.ads.googleads.v4.services.IMutateCustomerRequest,
      options: CallOptions,
 ...
 * @param {google.ads.googleads.v4.services.CustomerOperation} request.operation
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomerResponse]{@link google.ads.googleads.v4.services.MutateCustomerResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  listAccessibleCustomers(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v4.services.IListAccessibleCustomersRequest|undefined, {}|undefined
      ]>;
  listAccessibleCustomers(
      request: protos.google.ads.googleads.v4.services.IListAccessibleCustomersRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [ListAccessibleCustomersResponse]{@link google.ads.googleads.v4.services.ListAccessibleCustomersResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  createCustomerClient(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v4.services.ICreateCustomerClientRequest|undefined, {}|undefined
      ]>;
  createCustomerClient(
      request: protos.google.ads.googleads.v4.services.ICreateCustomerClientRequest,
      options: CallOptions,
 ...
 * @param {google.ads.googleads.v4.resources.Customer} request.customerClient
 *   Required. The new client customer to create. The resource name on this customer
 *   will be ignored.
 * @param {google.protobuf.StringValue} request.emailAddress
 ...
 * @param {google.ads.googleads.v4.enums.AccessRoleEnum.AccessRole} request.accessRole
 *   The proposed role of user on the created client customer.
 *   Accessible only to customers on the allow-list.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [CreateCustomerClientResponse]{@link google.ads.googleads.v4.services.CreateCustomerClientResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
