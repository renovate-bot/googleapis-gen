 ...
 * `src/v4/expanded_landing_page_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './expanded_landing_page_view_service_client_config.json';
...
export class ExpandedLandingPageViewServiceClient {
  ...
  expandedLandingPageViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ExpandedLandingPageViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.ExpandedLandingPageViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.expandedLandingPageViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.ExpandedLandingPageViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.ExpandedLandingPageViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const expandedLandingPageViewServiceStubMethods =
        ['getExpandedLandingPageView'];
    for (const methodName of expandedLandingPageViewServiceStubMethods) {
      const callPromise = this.expandedLandingPageViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getExpandedLandingPageView(
      request: protos.google.ads.googleads.v4.services.IGetExpandedLandingPageViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.IExpandedLandingPageView,
        protos.google.ads.googleads.v4.services.IGetExpandedLandingPageViewRequest|undefined, {}|undefined
      ]>;
  getExpandedLandingPageView(
      request: protos.google.ads.googleads.v4.services.IGetExpandedLandingPageViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.IExpandedLandingPageView,
          protos.google.ads.googleads.v4.services.IGetExpandedLandingPageViewRequest|null|undefined,
          {}|null|undefined>): void;
  getExpandedLandingPageView(
      request: protos.google.ads.googleads.v4.services.IGetExpandedLandingPageViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [ExpandedLandingPageView]{@link google.ads.googleads.v4.resources.ExpandedLandingPageView}.
 *   Please see the
