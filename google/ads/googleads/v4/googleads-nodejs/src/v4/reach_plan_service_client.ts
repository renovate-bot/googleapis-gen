 ...
 * `src/v4/reach_plan_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './reach_plan_service_client_config.json';
...
export class ReachPlanServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.ReachPlanService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.reachPlanServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.ReachPlanService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.ReachPlanService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const reachPlanServiceStubMethods =
        ['listPlannableLocations', 'listPlannableProducts', 'generateProductMixIdeas', 'generateReachForecast'];
  ...
  listPlannableLocations(
      request: protos.google.ads.googleads.v4.services.IListPlannableLocationsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IListPlannableLocationsResponse,
        protos.google.ads.googleads.v4.services.IListPlannableLocationsRequest|undefined, {}|undefined
      ]>;
  listPlannableLocations(
      request: protos.google.ads.googleads.v4.services.IListPlannableLocationsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IListPlannableLocationsResponse,
          protos.google.ads.googleads.v4.services.IListPlannableLocationsRequest|null|undefined,
          {}|null|undefined>): void;
  listPlannableLocations(
      request: protos.google.ads.googleads.v4.services.IListPlannableLocationsRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [ListPlannableLocationsResponse]{@link google.ads.googleads.v4.services.ListPlannableLocationsResponse}.
 *   Please see the
 ...
 */
  ...
  listPlannableProducts(
      request: protos.google.ads.googleads.v4.services.IListPlannableProductsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IListPlannableProductsResponse,
        protos.google.ads.googleads.v4.services.IListPlannableProductsRequest|undefined, {}|undefined
      ]>;
  listPlannableProducts(
      request: protos.google.ads.googleads.v4.services.IListPlannableProductsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IListPlannableProductsResponse,
          protos.google.ads.googleads.v4.services.IListPlannableProductsRequest|null|undefined,
          {}|null|undefined>): void;
  listPlannableProducts(
      request: protos.google.ads.googleads.v4.services.IListPlannableProductsRequest,
      callback: Callback<
 ...
 * @param {Object} request
 *   The request object that will be sent.
 * @param {google.protobuf.StringValue} request.plannableLocationId
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [ListPlannableProductsResponse]{@link google.ads.googleads.v4.services.ListPlannableProductsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  generateProductMixIdeas(
      request: protos.google.ads.googleads.v4.services.IGenerateProductMixIdeasRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IGenerateProductMixIdeasResponse,
        protos.google.ads.googleads.v4.services.IGenerateProductMixIdeasRequest|undefined, {}|undefined
      ]>;
  generateProductMixIdeas(
      request: protos.google.ads.googleads.v4.services.IGenerateProductMixIdeasRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IGenerateProductMixIdeasResponse,
          protos.google.ads.googleads.v4.services.IGenerateProductMixIdeasRequest|null|undefined,
          {}|null|undefined>): void;
  generateProductMixIdeas(
      request: protos.google.ads.googleads.v4.services.IGenerateProductMixIdeasRequest,
      callback: Callback<
 ...
 *   ListPlannableLocations.
 * @param {google.protobuf.StringValue} request.currencyCode
 *   Required. Currency code.
 *   Three-character ISO 4217 currency code.
 * @param {google.protobuf.Int64Value} request.budgetMicros
 *   Required. Total budget.
 *   Amount in micros. One million is equivalent to one unit.
 * @param {google.ads.googleads.v4.services.Preferences} request.preferences
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [GenerateProductMixIdeasResponse]{@link google.ads.googleads.v4.services.GenerateProductMixIdeasResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  generateReachForecast(
      request: protos.google.ads.googleads.v4.services.IGenerateReachForecastRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IGenerateReachForecastResponse,
        protos.google.ads.googleads.v4.services.IGenerateReachForecastRequest|undefined, {}|undefined
      ]>;
  generateReachForecast(
      request: protos.google.ads.googleads.v4.services.IGenerateReachForecastRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IGenerateReachForecastResponse,
          protos.google.ads.googleads.v4.services.IGenerateReachForecastRequest|null|undefined,
          {}|null|undefined>): void;
  generateReachForecast(
      request: protos.google.ads.googleads.v4.services.IGenerateReachForecastRequest,
      callback: Callback<
 ...
 *   The currency code.
 *   Three-character ISO 4217 currency code.
 * @param {google.ads.googleads.v4.services.CampaignDuration} request.campaignDuration
 *   Required. Campaign duration.
 * @param {google.protobuf.Int32Value} request.cookieFrequencyCap
 ...
 * @param {google.ads.googleads.v4.services.FrequencyCap} request.cookieFrequencyCapSetting
 *   Desired cookie frequency cap that will be applied to each planned product.
 *   This is equivalent to the frequency cap exposed in Google Ads when creating
 *   a campaign, it represents the maximum number of times an ad can be shown to
 ...
 * @param {google.protobuf.Int32Value} request.minEffectiveFrequency
 *   Desired minimum effective frequency (the number of times a person was
 *   exposed to the ad) for the reported reach metrics [1-10].
 *   This won't affect the targeting, but just the reporting.
 *   If not specified, a default of 1 is applied.
 * @param {google.ads.googleads.v4.services.Targeting} request.targeting
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [GenerateReachForecastResponse]{@link google.ads.googleads.v4.services.GenerateReachForecastResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
