 ...
 * `src/v4/parental_status_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './parental_status_view_service_client_config.json';
...
export class ParentalStatusViewServiceClient {
  ...
  parentalStatusViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ParentalStatusViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.ParentalStatusViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.parentalStatusViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.ParentalStatusViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.ParentalStatusViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const parentalStatusViewServiceStubMethods =
        ['getParentalStatusView'];
    for (const methodName of parentalStatusViewServiceStubMethods) {
      const callPromise = this.parentalStatusViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getParentalStatusView(
      request: protos.google.ads.googleads.v4.services.IGetParentalStatusViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.IParentalStatusView,
        protos.google.ads.googleads.v4.services.IGetParentalStatusViewRequest|undefined, {}|undefined
      ]>;
  getParentalStatusView(
      request: protos.google.ads.googleads.v4.services.IGetParentalStatusViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.IParentalStatusView,
          protos.google.ads.googleads.v4.services.IGetParentalStatusViewRequest|null|undefined,
          {}|null|undefined>): void;
  getParentalStatusView(
      request: protos.google.ads.googleads.v4.services.IGetParentalStatusViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [ParentalStatusView]{@link google.ads.googleads.v4.resources.ParentalStatusView}.
 *   Please see the
