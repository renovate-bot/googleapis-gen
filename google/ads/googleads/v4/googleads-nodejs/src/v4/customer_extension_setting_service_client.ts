 ...
 * `src/v4/customer_extension_setting_service_client_config.json`.
...
export class CustomerExtensionSettingServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.CustomerExtensionSettingService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerExtensionSettingServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.CustomerExtensionSettingService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.CustomerExtensionSettingService,
  ...
  getCustomerExtensionSetting(
      request: protos.google.ads.googleads.v4.services.IGetCustomerExtensionSettingRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.ICustomerExtensionSetting,
        protos.google.ads.googleads.v4.services.IGetCustomerExtensionSettingRequest|undefined, {}|undefined
      ]>;
  getCustomerExtensionSetting(
      request: protos.google.ads.googleads.v4.services.IGetCustomerExtensionSettingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.ICustomerExtensionSetting,
          protos.google.ads.googleads.v4.services.IGetCustomerExtensionSettingRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomerExtensionSetting(
      request: protos.google.ads.googleads.v4.services.IGetCustomerExtensionSettingRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CustomerExtensionSetting]{@link google.ads.googleads.v4.resources.CustomerExtensionSetting}.
 *   Please see the
 ...
 */
  ...
  mutateCustomerExtensionSettings(
      request: protos.google.ads.googleads.v4.services.IMutateCustomerExtensionSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IMutateCustomerExtensionSettingsResponse,
        protos.google.ads.googleads.v4.services.IMutateCustomerExtensionSettingsRequest|undefined, {}|undefined
      ]>;
  mutateCustomerExtensionSettings(
      request: protos.google.ads.googleads.v4.services.IMutateCustomerExtensionSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IMutateCustomerExtensionSettingsResponse,
          protos.google.ads.googleads.v4.services.IMutateCustomerExtensionSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerExtensionSettings(
      request: protos.google.ads.googleads.v4.services.IMutateCustomerExtensionSettingsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomerExtensionSettingsResponse]{@link google.ads.googleads.v4.services.MutateCustomerExtensionSettingsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
