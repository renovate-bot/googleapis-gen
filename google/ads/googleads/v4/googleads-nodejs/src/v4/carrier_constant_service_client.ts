 ...
 * `src/v4/carrier_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './carrier_constant_service_client_config.json';
...
export class CarrierConstantServiceClient {
  ...
  carrierConstantServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CarrierConstantServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.CarrierConstantService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.carrierConstantServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.CarrierConstantService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.CarrierConstantService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const carrierConstantServiceStubMethods =
        ['getCarrierConstant'];
    for (const methodName of carrierConstantServiceStubMethods) {
      const callPromise = this.carrierConstantServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getCarrierConstant(
      request: protos.google.ads.googleads.v4.services.IGetCarrierConstantRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.ICarrierConstant,
        protos.google.ads.googleads.v4.services.IGetCarrierConstantRequest|undefined, {}|undefined
      ]>;
  getCarrierConstant(
      request: protos.google.ads.googleads.v4.services.IGetCarrierConstantRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.ICarrierConstant,
          protos.google.ads.googleads.v4.services.IGetCarrierConstantRequest|null|undefined,
          {}|null|undefined>): void;
  getCarrierConstant(
      request: protos.google.ads.googleads.v4.services.IGetCarrierConstantRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CarrierConstant]{@link google.ads.googleads.v4.resources.CarrierConstant}.
 *   Please see the
