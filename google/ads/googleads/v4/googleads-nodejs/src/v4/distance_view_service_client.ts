 ...
 * `src/v4/distance_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './distance_view_service_client_config.json';
...
export class DistanceViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.DistanceViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.distanceViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.DistanceViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.DistanceViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const distanceViewServiceStubMethods =
        ['getDistanceView'];
    for (const methodName of distanceViewServiceStubMethods) {
      const callPromise = this.distanceViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getDistanceView(
      request: protos.google.ads.googleads.v4.services.IGetDistanceViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.IDistanceView,
        protos.google.ads.googleads.v4.services.IGetDistanceViewRequest|undefined, {}|undefined
      ]>;
  getDistanceView(
      request: protos.google.ads.googleads.v4.services.IGetDistanceViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.IDistanceView,
          protos.google.ads.googleads.v4.services.IGetDistanceViewRequest|null|undefined,
          {}|null|undefined>): void;
  getDistanceView(
      request: protos.google.ads.googleads.v4.services.IGetDistanceViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [DistanceView]{@link google.ads.googleads.v4.resources.DistanceView}.
 *   Please see the
