 ...
 * `src/v4/keyword_plan_idea_service_client_config.json`.
...
export class KeywordPlanIdeaServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.KeywordPlanIdeaService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordPlanIdeaServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.KeywordPlanIdeaService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.KeywordPlanIdeaService,
  ...
  generateKeywordIdeas(
      request: protos.google.ads.googleads.v4.services.IGenerateKeywordIdeasRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IGenerateKeywordIdeaResult[],
        protos.google.ads.googleads.v4.services.IGenerateKeywordIdeasRequest|null,
        protos.google.ads.googleads.v4.services.IGenerateKeywordIdeaResponse
      ]>;
  generateKeywordIdeas(
      request: protos.google.ads.googleads.v4.services.IGenerateKeywordIdeasRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.googleads.v4.services.IGenerateKeywordIdeasRequest,
          protos.google.ads.googleads.v4.services.IGenerateKeywordIdeaResponse|null|undefined,
          protos.google.ads.googleads.v4.services.IGenerateKeywordIdeaResult>): void;
  generateKeywordIdeas(
      request: protos.google.ads.googleads.v4.services.IGenerateKeywordIdeasRequest,
      callback: PaginationCallback<
          protos.google.ads.googleads.v4.services.IGenerateKeywordIdeasRequest,
 ...
 * @param {google.ads.googleads.v4.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork} request.keywordPlanNetwork
 *   Targeting network.
 * @param {google.ads.googleads.v4.services.KeywordAndUrlSeed} request.keywordAndUrlSeed
 *   A Keyword and a specific Url to generate ideas from
 *   e.g. cars, www.example.com/cars.
 * @param {google.ads.googleads.v4.services.KeywordSeed} request.keywordSeed
 *   A Keyword or phrase to generate ideas from, e.g. cars.
 * @param {google.ads.googleads.v4.services.UrlSeed} request.urlSeed
 *   A specific url to generate ideas from, e.g. www.example.com/cars.
 * @param {google.ads.googleads.v4.services.SiteSeed} request.siteSeed
 *   The site to generate ideas from, e.g. www.example.com.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [GenerateKeywordIdeaResult]{@link google.ads.googleads.v4.services.GenerateKeywordIdeaResult}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [GenerateKeywordIdeaResult]{@link google.ads.googleads.v4.services.GenerateKeywordIdeaResult} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [GenerateKeywordIdeaResult]{@link google.ads.googleads.v4.services.GenerateKeywordIdeaResult}. The API will be called under the hood as needed, once per the page,
 ...
 */
  generateKeywordIdeasAsync(
      request?: protos.google.ads.googleads.v4.services.IGenerateKeywordIdeasRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.googleads.v4.services.IGenerateKeywordIdeaResult>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.generateKeywordIdeas.asyncIterate(
      ...
      callSettings
    ) as AsyncIterable<protos.google.ads.googleads.v4.services.IGenerateKeywordIdeaResult>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
