 ...
 * `src/v4/customer_manager_link_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_manager_link_service_client_config.json';
...
export class CustomerManagerLinkServiceClient {
  ...
  customerManagerLinkServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CustomerManagerLinkServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.CustomerManagerLinkService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerManagerLinkServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.CustomerManagerLinkService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.CustomerManagerLinkService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerManagerLinkServiceStubMethods =
        ['getCustomerManagerLink', 'mutateCustomerManagerLink', 'moveManagerLink'];
    for (const methodName of customerManagerLinkServiceStubMethods) {
      const callPromise = this.customerManagerLinkServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getCustomerManagerLink(
      request: protos.google.ads.googleads.v4.services.IGetCustomerManagerLinkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.ICustomerManagerLink,
        protos.google.ads.googleads.v4.services.IGetCustomerManagerLinkRequest|undefined, {}|undefined
      ]>;
  getCustomerManagerLink(
      request: protos.google.ads.googleads.v4.services.IGetCustomerManagerLinkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.ICustomerManagerLink,
          protos.google.ads.googleads.v4.services.IGetCustomerManagerLinkRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomerManagerLink(
      request: protos.google.ads.googleads.v4.services.IGetCustomerManagerLinkRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CustomerManagerLink]{@link google.ads.googleads.v4.resources.CustomerManagerLink}.
 *   Please see the
 ...
 */
  ...
  mutateCustomerManagerLink(
      request: protos.google.ads.googleads.v4.services.IMutateCustomerManagerLinkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IMutateCustomerManagerLinkResponse,
        protos.google.ads.googleads.v4.services.IMutateCustomerManagerLinkRequest|undefined, {}|undefined
      ]>;
  mutateCustomerManagerLink(
      request: protos.google.ads.googleads.v4.services.IMutateCustomerManagerLinkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IMutateCustomerManagerLinkResponse,
          protos.google.ads.googleads.v4.services.IMutateCustomerManagerLinkRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerManagerLink(
      request: protos.google.ads.googleads.v4.services.IMutateCustomerManagerLinkRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomerManagerLinkResponse]{@link google.ads.googleads.v4.services.MutateCustomerManagerLinkResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  moveManagerLink(
      request: protos.google.ads.googleads.v4.services.IMoveManagerLinkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IMoveManagerLinkResponse,
        protos.google.ads.googleads.v4.services.IMoveManagerLinkRequest|undefined, {}|undefined
      ]>;
  moveManagerLink(
      request: protos.google.ads.googleads.v4.services.IMoveManagerLinkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IMoveManagerLinkResponse,
          protos.google.ads.googleads.v4.services.IMoveManagerLinkRequest|null|undefined,
          {}|null|undefined>): void;
  moveManagerLink(
      request: protos.google.ads.googleads.v4.services.IMoveManagerLinkRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MoveManagerLinkResponse]{@link google.ads.googleads.v4.services.MoveManagerLinkResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
