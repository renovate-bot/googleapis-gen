 ...
 * `src/v4/batch_job_service_client_config.json`.
...
export class BatchJobServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    const runBatchJobMetadata = protoFilesRoot.lookup(
      '.google.ads.googleads.v4.resources.BatchJob.BatchJobMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.BatchJobService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.batchJobServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.BatchJobService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.BatchJobService,
  ...
  mutateBatchJob(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v4.services.IMutateBatchJobRequest|undefined, {}|undefined
      ]>;
  mutateBatchJob(
      request: protos.google.ads.googleads.v4.services.IMutateBatchJobRequest,
      options: CallOptions,
 ...
 * @param {google.ads.googleads.v4.services.BatchJobOperation} request.operation
 *   Required. The operation to perform on an individual batch job.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateBatchJobResponse]{@link google.ads.googleads.v4.services.MutateBatchJobResponse}.
 *   Please see the
 ...
 */
  ...
  getBatchJob(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v4.services.IGetBatchJobRequest|undefined, {}|undefined
      ]>;
  getBatchJob(
      request: protos.google.ads.googleads.v4.services.IGetBatchJobRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [BatchJob]{@link google.ads.googleads.v4.resources.BatchJob}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  addBatchJobOperations(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v4.services.IAddBatchJobOperationsRequest|undefined, {}|undefined
      ]>;
  addBatchJobOperations(
      request: protos.google.ads.googleads.v4.services.IAddBatchJobOperationsRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [AddBatchJobOperationsResponse]{@link google.ads.googleads.v4.services.AddBatchJobOperationsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  async checkRunBatchJobProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.ads.googleads.v4.resources.BatchJob.BatchJobMetadata>>{
  ...
  listBatchJobResults(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v4.services.IListBatchJobResultsRequest|null,
        protos.google.ads.googleads.v4.services.IListBatchJobResultsResponse
      ]>;
  listBatchJobResults(
      request: protos.google.ads.googleads.v4.services.IListBatchJobResultsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          ...
          protos.google.ads.googleads.v4.services.IBatchJobResult>): void;
  listBatchJobResults(
      request: protos.google.ads.googleads.v4.services.IListBatchJobResultsRequest,
      callback: PaginationCallback<
          protos.google.ads.googleads.v4.services.IListBatchJobResultsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [BatchJobResult]{@link google.ads.googleads.v4.services.BatchJobResult}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [BatchJobResult]{@link google.ads.googleads.v4.services.BatchJobResult} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [BatchJobResult]{@link google.ads.googleads.v4.services.BatchJobResult}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listBatchJobResultsAsync(
      request?: protos.google.ads.googleads.v4.services.IListBatchJobResultsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.googleads.v4.services.IBatchJobResult>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listBatchJobResults.asyncIterate(
      ...
      callSettings
    ) as AsyncIterable<protos.google.ads.googleads.v4.services.IBatchJobResult>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
