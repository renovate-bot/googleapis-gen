 ...
 * `src/v4/mobile_device_constant_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './mobile_device_constant_service_client_config.json';
...
export class MobileDeviceConstantServiceClient {
  ...
  mobileDeviceConstantServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof MobileDeviceConstantServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.MobileDeviceConstantService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.mobileDeviceConstantServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.MobileDeviceConstantService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.MobileDeviceConstantService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const mobileDeviceConstantServiceStubMethods =
        ['getMobileDeviceConstant'];
    for (const methodName of mobileDeviceConstantServiceStubMethods) {
      const callPromise = this.mobileDeviceConstantServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getMobileDeviceConstant(
      request: protos.google.ads.googleads.v4.services.IGetMobileDeviceConstantRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.IMobileDeviceConstant,
        protos.google.ads.googleads.v4.services.IGetMobileDeviceConstantRequest|undefined, {}|undefined
      ]>;
  getMobileDeviceConstant(
      request: protos.google.ads.googleads.v4.services.IGetMobileDeviceConstantRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.IMobileDeviceConstant,
          protos.google.ads.googleads.v4.services.IGetMobileDeviceConstantRequest|null|undefined,
          {}|null|undefined>): void;
  getMobileDeviceConstant(
      request: protos.google.ads.googleads.v4.services.IGetMobileDeviceConstantRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [MobileDeviceConstant]{@link google.ads.googleads.v4.resources.MobileDeviceConstant}.
 *   Please see the
