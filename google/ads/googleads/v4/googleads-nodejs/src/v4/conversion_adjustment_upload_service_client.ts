 ...
 * `src/v4/conversion_adjustment_upload_service_client_config.json`.
...
export class ConversionAdjustmentUploadServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.ConversionAdjustmentUploadService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversionAdjustmentUploadServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.ConversionAdjustmentUploadService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.ConversionAdjustmentUploadService,
  ...
  // -------------------
  uploadConversionAdjustments(
      request: protos.google.ads.googleads.v4.services.IUploadConversionAdjustmentsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IUploadConversionAdjustmentsResponse,
        protos.google.ads.googleads.v4.services.IUploadConversionAdjustmentsRequest|undefined, {}|undefined
      ]>;
  uploadConversionAdjustments(
      request: protos.google.ads.googleads.v4.services.IUploadConversionAdjustmentsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IUploadConversionAdjustmentsResponse,
          protos.google.ads.googleads.v4.services.IUploadConversionAdjustmentsRequest|null|undefined,
          {}|null|undefined>): void;
  uploadConversionAdjustments(
      request: protos.google.ads.googleads.v4.services.IUploadConversionAdjustmentsRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [UploadConversionAdjustmentsResponse]{@link google.ads.googleads.v4.services.UploadConversionAdjustmentsResponse}.
 *   Please see the
