 ...
 * `src/v4/custom_interest_service_client_config.json`.
...
export class CustomInterestServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.CustomInterestService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customInterestServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.CustomInterestService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.CustomInterestService,
  ...
  // -------------------
  getCustomInterest(
      request: protos.google.ads.googleads.v4.services.IGetCustomInterestRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.ICustomInterest,
        protos.google.ads.googleads.v4.services.IGetCustomInterestRequest|undefined, {}|undefined
      ]>;
  getCustomInterest(
      request: protos.google.ads.googleads.v4.services.IGetCustomInterestRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.ICustomInterest,
          protos.google.ads.googleads.v4.services.IGetCustomInterestRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomInterest(
      request: protos.google.ads.googleads.v4.services.IGetCustomInterestRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CustomInterest]{@link google.ads.googleads.v4.resources.CustomInterest}.
 *   Please see the
 ...
 */
  ...
  mutateCustomInterests(
      request: protos.google.ads.googleads.v4.services.IMutateCustomInterestsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IMutateCustomInterestsResponse,
        protos.google.ads.googleads.v4.services.IMutateCustomInterestsRequest|undefined, {}|undefined
      ]>;
  mutateCustomInterests(
      request: protos.google.ads.googleads.v4.services.IMutateCustomInterestsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IMutateCustomInterestsResponse,
          protos.google.ads.googleads.v4.services.IMutateCustomInterestsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomInterests(
      request: protos.google.ads.googleads.v4.services.IMutateCustomInterestsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomInterestsResponse]{@link google.ads.googleads.v4.services.MutateCustomInterestsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
