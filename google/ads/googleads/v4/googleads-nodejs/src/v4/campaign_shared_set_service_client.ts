 ...
 * `src/v4/campaign_shared_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './campaign_shared_set_service_client_config.json';
...
export class CampaignSharedSetServiceClient {
  ...
  campaignSharedSetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignSharedSetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.CampaignSharedSetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignSharedSetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.CampaignSharedSetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.CampaignSharedSetService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignSharedSetServiceStubMethods =
        ['getCampaignSharedSet', 'mutateCampaignSharedSets'];
    for (const methodName of campaignSharedSetServiceStubMethods) {
      const callPromise = this.campaignSharedSetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getCampaignSharedSet(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v4.services.IGetCampaignSharedSetRequest|undefined, {}|undefined
      ]>;
  getCampaignSharedSet(
      request: protos.google.ads.googleads.v4.services.IGetCampaignSharedSetRequest,
      options: CallOptions,
 ...
 *   The first element of the array is an object representing [CampaignSharedSet]{@link google.ads.googleads.v4.resources.CampaignSharedSet}.
 *   Please see the
 ...
 */
  ...
  mutateCampaignSharedSets(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v4.services.IMutateCampaignSharedSetsRequest|undefined, {}|undefined
      ]>;
  mutateCampaignSharedSets(
      request: protos.google.ads.googleads.v4.services.IMutateCampaignSharedSetsRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCampaignSharedSetsResponse]{@link google.ads.googleads.v4.services.MutateCampaignSharedSetsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
