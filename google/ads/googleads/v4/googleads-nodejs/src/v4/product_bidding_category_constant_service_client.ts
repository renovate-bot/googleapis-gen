 ...
 * `src/v4/product_bidding_category_constant_service_client_config.json`.
...
export class ProductBiddingCategoryConstantServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.ProductBiddingCategoryConstantService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.productBiddingCategoryConstantServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.ProductBiddingCategoryConstantService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.ProductBiddingCategoryConstantService,
  ...
  // -------------------
  getProductBiddingCategoryConstant(
      request: protos.google.ads.googleads.v4.services.IGetProductBiddingCategoryConstantRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.IProductBiddingCategoryConstant,
        protos.google.ads.googleads.v4.services.IGetProductBiddingCategoryConstantRequest|undefined, {}|undefined
      ]>;
  getProductBiddingCategoryConstant(
      request: protos.google.ads.googleads.v4.services.IGetProductBiddingCategoryConstantRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.IProductBiddingCategoryConstant,
          protos.google.ads.googleads.v4.services.IGetProductBiddingCategoryConstantRequest|null|undefined,
          {}|null|undefined>): void;
  getProductBiddingCategoryConstant(
      request: protos.google.ads.googleads.v4.services.IGetProductBiddingCategoryConstantRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [ProductBiddingCategoryConstant]{@link google.ads.googleads.v4.resources.ProductBiddingCategoryConstant}.
 *   Please see the
