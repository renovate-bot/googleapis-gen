 ...
 * `src/v4/user_list_service_client_config.json`.
...
export class UserListServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.UserListService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.userListServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.UserListService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.UserListService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const userListServiceStubMethods =
        ['getUserList', 'mutateUserLists'];
  ...
  // -------------------
  getUserList(
      request: protos.google.ads.googleads.v4.services.IGetUserListRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.IUserList,
        protos.google.ads.googleads.v4.services.IGetUserListRequest|undefined, {}|undefined
      ]>;
  getUserList(
      request: protos.google.ads.googleads.v4.services.IGetUserListRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.IUserList,
          protos.google.ads.googleads.v4.services.IGetUserListRequest|null|undefined,
          {}|null|undefined>): void;
  getUserList(
      request: protos.google.ads.googleads.v4.services.IGetUserListRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [UserList]{@link google.ads.googleads.v4.resources.UserList}.
 *   Please see the
 ...
 */
  ...
  mutateUserLists(
      request: protos.google.ads.googleads.v4.services.IMutateUserListsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IMutateUserListsResponse,
        protos.google.ads.googleads.v4.services.IMutateUserListsRequest|undefined, {}|undefined
      ]>;
  mutateUserLists(
      request: protos.google.ads.googleads.v4.services.IMutateUserListsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IMutateUserListsResponse,
          protos.google.ads.googleads.v4.services.IMutateUserListsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateUserLists(
      request: protos.google.ads.googleads.v4.services.IMutateUserListsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateUserListsResponse]{@link google.ads.googleads.v4.services.MutateUserListsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
