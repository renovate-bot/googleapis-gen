 ...
 * `src/v4/payments_account_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './payments_account_service_client_config.json';
...
export class PaymentsAccountServiceClient {
  ...
  paymentsAccountServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof PaymentsAccountServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.PaymentsAccountService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.paymentsAccountServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.PaymentsAccountService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.PaymentsAccountService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const paymentsAccountServiceStubMethods =
        ['listPaymentsAccounts'];
    for (const methodName of paymentsAccountServiceStubMethods) {
      const callPromise = this.paymentsAccountServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  listPaymentsAccounts(
      request?: protos.google.ads.googleads.v4.services.IListPaymentsAccountsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IListPaymentsAccountsResponse,
        protos.google.ads.googleads.v4.services.IListPaymentsAccountsRequest|undefined, {}|undefined
      ]>;
  listPaymentsAccounts(
      request: protos.google.ads.googleads.v4.services.IListPaymentsAccountsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IListPaymentsAccountsResponse,
          protos.google.ads.googleads.v4.services.IListPaymentsAccountsRequest|null|undefined,
          {}|null|undefined>): void;
  listPaymentsAccounts(
      request: protos.google.ads.googleads.v4.services.IListPaymentsAccountsRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [ListPaymentsAccountsResponse]{@link google.ads.googleads.v4.services.ListPaymentsAccountsResponse}.
 *   Please see the
