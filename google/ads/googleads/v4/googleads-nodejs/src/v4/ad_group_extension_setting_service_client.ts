 ...
 * `src/v4/ad_group_extension_setting_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_extension_setting_service_client_config.json';
...
export class AdGroupExtensionSettingServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.AdGroupExtensionSettingService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupExtensionSettingServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.AdGroupExtensionSettingService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.AdGroupExtensionSettingService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupExtensionSettingServiceStubMethods =
        ['getAdGroupExtensionSetting', 'mutateAdGroupExtensionSettings'];
    for (const methodName of adGroupExtensionSettingServiceStubMethods) {
      const callPromise = this.adGroupExtensionSettingServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getAdGroupExtensionSetting(
      request: protos.google.ads.googleads.v4.services.IGetAdGroupExtensionSettingRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.IAdGroupExtensionSetting,
        protos.google.ads.googleads.v4.services.IGetAdGroupExtensionSettingRequest|undefined, {}|undefined
      ]>;
  getAdGroupExtensionSetting(
      request: protos.google.ads.googleads.v4.services.IGetAdGroupExtensionSettingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.IAdGroupExtensionSetting,
          protos.google.ads.googleads.v4.services.IGetAdGroupExtensionSettingRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroupExtensionSetting(
      request: protos.google.ads.googleads.v4.services.IGetAdGroupExtensionSettingRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AdGroupExtensionSetting]{@link google.ads.googleads.v4.resources.AdGroupExtensionSetting}.
 *   Please see the
 ...
 */
  ...
  mutateAdGroupExtensionSettings(
      request: protos.google.ads.googleads.v4.services.IMutateAdGroupExtensionSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IMutateAdGroupExtensionSettingsResponse,
        protos.google.ads.googleads.v4.services.IMutateAdGroupExtensionSettingsRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupExtensionSettings(
      request: protos.google.ads.googleads.v4.services.IMutateAdGroupExtensionSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IMutateAdGroupExtensionSettingsResponse,
          protos.google.ads.googleads.v4.services.IMutateAdGroupExtensionSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroupExtensionSettings(
      request: protos.google.ads.googleads.v4.services.IMutateAdGroupExtensionSettingsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateAdGroupExtensionSettingsResponse]{@link google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
