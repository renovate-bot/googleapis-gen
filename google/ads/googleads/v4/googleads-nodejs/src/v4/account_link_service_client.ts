 ...
 * `src/v4/account_link_service_client_config.json`.
...
export class AccountLinkServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.AccountLinkService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.accountLinkServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.AccountLinkService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.AccountLinkService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const accountLinkServiceStubMethods =
        ['getAccountLink', 'mutateAccountLink'];
  ...
  // -------------------
  getAccountLink(
      request: protos.google.ads.googleads.v4.services.IGetAccountLinkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.IAccountLink,
        protos.google.ads.googleads.v4.services.IGetAccountLinkRequest|undefined, {}|undefined
      ]>;
  getAccountLink(
      request: protos.google.ads.googleads.v4.services.IGetAccountLinkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.IAccountLink,
          protos.google.ads.googleads.v4.services.IGetAccountLinkRequest|null|undefined,
          {}|null|undefined>): void;
  getAccountLink(
      request: protos.google.ads.googleads.v4.services.IGetAccountLinkRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AccountLink]{@link google.ads.googleads.v4.resources.AccountLink}.
 *   Please see the
 ...
 */
  ...
  mutateAccountLink(
      request: protos.google.ads.googleads.v4.services.IMutateAccountLinkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IMutateAccountLinkResponse,
        protos.google.ads.googleads.v4.services.IMutateAccountLinkRequest|undefined, {}|undefined
      ]>;
  mutateAccountLink(
      request: protos.google.ads.googleads.v4.services.IMutateAccountLinkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IMutateAccountLinkResponse,
          protos.google.ads.googleads.v4.services.IMutateAccountLinkRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAccountLink(
      request: protos.google.ads.googleads.v4.services.IMutateAccountLinkRequest,
      callback: Callback<
 ...
 * @param {google.ads.googleads.v4.services.AccountLinkOperation} request.operation
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateAccountLinkResponse]{@link google.ads.googleads.v4.services.MutateAccountLinkResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
