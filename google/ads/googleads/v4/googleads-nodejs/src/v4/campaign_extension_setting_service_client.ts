 ...
 * `src/v4/campaign_extension_setting_service_client_config.json`.
...
export class CampaignExtensionSettingServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v4.services.CampaignExtensionSettingService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignExtensionSettingServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v4.services.CampaignExtensionSettingService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v4.services.CampaignExtensionSettingService,
  ...
  getCampaignExtensionSetting(
      request: protos.google.ads.googleads.v4.services.IGetCampaignExtensionSettingRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.resources.ICampaignExtensionSetting,
        protos.google.ads.googleads.v4.services.IGetCampaignExtensionSettingRequest|undefined, {}|undefined
      ]>;
  getCampaignExtensionSetting(
      request: protos.google.ads.googleads.v4.services.IGetCampaignExtensionSettingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.resources.ICampaignExtensionSetting,
          protos.google.ads.googleads.v4.services.IGetCampaignExtensionSettingRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignExtensionSetting(
      request: protos.google.ads.googleads.v4.services.IGetCampaignExtensionSettingRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CampaignExtensionSetting]{@link google.ads.googleads.v4.resources.CampaignExtensionSetting}.
 *   Please see the
 ...
 */
  ...
  mutateCampaignExtensionSettings(
      request: protos.google.ads.googleads.v4.services.IMutateCampaignExtensionSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v4.services.IMutateCampaignExtensionSettingsResponse,
        protos.google.ads.googleads.v4.services.IMutateCampaignExtensionSettingsRequest|undefined, {}|undefined
      ]>;
  mutateCampaignExtensionSettings(
      request: protos.google.ads.googleads.v4.services.IMutateCampaignExtensionSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v4.services.IMutateCampaignExtensionSettingsResponse,
          protos.google.ads.googleads.v4.services.IMutateCampaignExtensionSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCampaignExtensionSettings(
      request: protos.google.ads.googleads.v4.services.IMutateCampaignExtensionSettingsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCampaignExtensionSettingsResponse]{@link google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
