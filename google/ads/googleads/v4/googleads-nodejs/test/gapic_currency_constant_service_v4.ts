...
import * as currencyconstantserviceModule from '../src';
...
describe('v4.CurrencyConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = currencyconstantserviceModule.v4.CurrencyConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = currencyconstantserviceModule.v4.CurrencyConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = currencyconstantserviceModule.v4.CurrencyConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new currencyconstantserviceModule.v4.CurrencyConstantServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.currencyConstantServiceStub, undefined);
        await client.initialize();
        assert(client.currencyConstantServiceStub);
    });
    ...
    describe('getCurrencyConstant', () => {
        it('invokes getCurrencyConstant without error', async () => {
            const client = new currencyconstantserviceModule.v4.CurrencyConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetCurrencyConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.CurrencyConstant());
            client.innerApiCalls.getCurrencyConstant = stubSimpleCall(expectedResponse);
            const [response] = await client.getCurrencyConstant(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCurrencyConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCurrencyConstant without error using callback', async () => {
            const client = new currencyconstantserviceModule.v4.CurrencyConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.CurrencyConstant());
            client.innerApiCalls.getCurrencyConstant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCurrencyConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ICurrencyConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCurrencyConstant with error', async () => {
            const client = new currencyconstantserviceModule.v4.CurrencyConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCurrencyConstant = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCurrencyConstant(request), expectedError);
            assert((client.innerApiCalls.getCurrencyConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
