...
import * as feeditemtargetserviceModule from '../src';
...
describe('v4.FeedItemTargetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feeditemtargetserviceModule.v4.FeedItemTargetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feeditemtargetserviceModule.v4.FeedItemTargetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feeditemtargetserviceModule.v4.FeedItemTargetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feeditemtargetserviceModule.v4.FeedItemTargetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.feedItemTargetServiceStub, undefined);
        await client.initialize();
        assert(client.feedItemTargetServiceStub);
    });
    ...
    describe('getFeedItemTarget', () => {
        it('invokes getFeedItemTarget without error', async () => {
            const client = new feeditemtargetserviceModule.v4.FeedItemTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetFeedItemTargetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.FeedItemTarget());
            client.innerApiCalls.getFeedItemTarget = stubSimpleCall(expectedResponse);
            const [response] = await client.getFeedItemTarget(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getFeedItemTarget as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getFeedItemTarget without error using callback', async () => {
            const client = new feeditemtargetserviceModule.v4.FeedItemTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.FeedItemTarget());
            client.innerApiCalls.getFeedItemTarget = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFeedItemTarget(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IFeedItemTarget|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFeedItemTarget with error', async () => {
            const client = new feeditemtargetserviceModule.v4.FeedItemTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getFeedItemTarget = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getFeedItemTarget(request), expectedError);
            assert((client.innerApiCalls.getFeedItemTarget as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateFeedItemTargets', () => {
        it('invokes mutateFeedItemTargets without error', async () => {
            const client = new feeditemtargetserviceModule.v4.FeedItemTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateFeedItemTargetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateFeedItemTargetsResponse());
            client.innerApiCalls.mutateFeedItemTargets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateFeedItemTargets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateFeedItemTargets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateFeedItemTargets without error using callback', async () => {
            const client = new feeditemtargetserviceModule.v4.FeedItemTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateFeedItemTargetsResponse());
            client.innerApiCalls.mutateFeedItemTargets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedItemTargets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateFeedItemTargetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateFeedItemTargets with error', async () => {
            const client = new feeditemtargetserviceModule.v4.FeedItemTargetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateFeedItemTargets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateFeedItemTargets(request), expectedError);
            assert((client.innerApiCalls.mutateFeedItemTargets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
