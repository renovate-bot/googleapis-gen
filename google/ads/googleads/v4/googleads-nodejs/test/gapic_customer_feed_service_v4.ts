...
import * as customerfeedserviceModule from '../src';
...
describe('v4.CustomerFeedServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerfeedserviceModule.v4.CustomerFeedServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerfeedserviceModule.v4.CustomerFeedServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerfeedserviceModule.v4.CustomerFeedServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerfeedserviceModule.v4.CustomerFeedServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customerFeedServiceStub, undefined);
        await client.initialize();
        assert(client.customerFeedServiceStub);
    });
    ...
    describe('getCustomerFeed', () => {
        it('invokes getCustomerFeed without error', async () => {
            const client = new customerfeedserviceModule.v4.CustomerFeedServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetCustomerFeedRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.CustomerFeed());
            client.innerApiCalls.getCustomerFeed = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomerFeed(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomerFeed as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCustomerFeed without error using callback', async () => {
            const client = new customerfeedserviceModule.v4.CustomerFeedServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.CustomerFeed());
            client.innerApiCalls.getCustomerFeed = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerFeed(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ICustomerFeed|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomerFeed with error', async () => {
            const client = new customerfeedserviceModule.v4.CustomerFeedServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCustomerFeed = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomerFeed(request), expectedError);
            assert((client.innerApiCalls.getCustomerFeed as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCustomerFeeds', () => {
        it('invokes mutateCustomerFeeds without error', async () => {
            const client = new customerfeedserviceModule.v4.CustomerFeedServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCustomerFeedsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCustomerFeedsResponse());
            client.innerApiCalls.mutateCustomerFeeds = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomerFeeds(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomerFeeds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomerFeeds without error using callback', async () => {
            const client = new customerfeedserviceModule.v4.CustomerFeedServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCustomerFeedsResponse());
            client.innerApiCalls.mutateCustomerFeeds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerFeeds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateCustomerFeedsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomerFeeds with error', async () => {
            const client = new customerfeedserviceModule.v4.CustomerFeedServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCustomerFeeds = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomerFeeds(request), expectedError);
            assert((client.innerApiCalls.mutateCustomerFeeds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
