...
describe('v4.ThirdPartyAppAnalyticsLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = thirdpartyappanalyticslinkserviceModule.v4.ThirdPartyAppAnalyticsLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = thirdpartyappanalyticslinkserviceModule.v4.ThirdPartyAppAnalyticsLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = thirdpartyappanalyticslinkserviceModule.v4.ThirdPartyAppAnalyticsLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new thirdpartyappanalyticslinkserviceModule.v4.ThirdPartyAppAnalyticsLinkServiceClient();
        assert(client);
    });
    ...
    describe('getThirdPartyAppAnalyticsLink', () => {
        it('invokes getThirdPartyAppAnalyticsLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetThirdPartyAppAnalyticsLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.ThirdPartyAppAnalyticsLink());
        ...
        it('invokes getThirdPartyAppAnalyticsLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getThirdPartyAppAnalyticsLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IThirdPartyAppAnalyticsLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
