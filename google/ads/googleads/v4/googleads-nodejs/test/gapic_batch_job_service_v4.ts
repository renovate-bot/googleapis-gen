...
import * as batchjobserviceModule from '../src';
...
describe('v4.BatchJobServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = batchjobserviceModule.v4.BatchJobServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = batchjobserviceModule.v4.BatchJobServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = batchjobserviceModule.v4.BatchJobServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new batchjobserviceModule.v4.BatchJobServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.batchJobServiceStub);
    });
    ...
    describe('mutateBatchJob', () => {
        it('invokes mutateBatchJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateBatchJobRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateBatchJobResponse());
            client.innerApiCalls.mutateBatchJob = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateBatchJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateBatchJob as SinonStub)
        ...
        it('invokes mutateBatchJob without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateBatchJobResponse());
            client.innerApiCalls.mutateBatchJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateBatchJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateBatchJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateBatchJob with error', async () => {
            ...
            client.innerApiCalls.mutateBatchJob = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateBatchJob(request), expectedError);
            assert((client.innerApiCalls.mutateBatchJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getBatchJob', () => {
        it('invokes getBatchJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetBatchJobRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.BatchJob());
            client.innerApiCalls.getBatchJob = stubSimpleCall(expectedResponse);
            const [response] = await client.getBatchJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getBatchJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getBatchJob without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.BatchJob());
            client.innerApiCalls.getBatchJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBatchJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IBatchJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBatchJob with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.getBatchJob = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getBatchJob(request), expectedError);
            assert((client.innerApiCalls.getBatchJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('addBatchJobOperations', () => {
        it('invokes addBatchJobOperations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.AddBatchJobOperationsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.AddBatchJobOperationsResponse());
            client.innerApiCalls.addBatchJobOperations = stubSimpleCall(expectedResponse);
            const [response] = await client.addBatchJobOperations(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.addBatchJobOperations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes addBatchJobOperations without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.AddBatchJobOperationsResponse());
            client.innerApiCalls.addBatchJobOperations = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.addBatchJobOperations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IAddBatchJobOperationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes addBatchJobOperations with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.addBatchJobOperations = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.addBatchJobOperations(request), expectedError);
            assert((client.innerApiCalls.addBatchJobOperations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('runBatchJob', () => {
        it('invokes runBatchJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.RunBatchJobRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            client.innerApiCalls.runBatchJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.runBatchJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runBatchJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes runBatchJob without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.runBatchJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.runBatchJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v4.resources.BatchJob.IBatchJobMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v4.resources.BatchJob.IBatchJobMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runBatchJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes runBatchJob with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.runBatchJob = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.runBatchJob(request), expectedError);
            assert((client.innerApiCalls.runBatchJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes runBatchJob with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.runBatchJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.runBatchJob(request);
        ...
        it('invokes checkRunBatchJobProgress without error', async () => {
            ...
            const decodedOperation = await client.checkRunBatchJobProgress(expectedResponse.name);
        ...
        it('invokes checkRunBatchJobProgress with error', async () => {
            ...
            await assert.rejects(client.checkRunBatchJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listBatchJobResults', () => {
        it('invokes listBatchJobResults without error', async () => {
            const client = new batchjobserviceModule.v4.BatchJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.ListBatchJobResultsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v4.services.BatchJobResult()),
              generateSampleMessage(new protos.google.ads.googleads.v4.services.BatchJobResult()),
              generateSampleMessage(new protos.google.ads.googleads.v4.services.BatchJobResult()),
            ];
            client.innerApiCalls.listBatchJobResults = stubSimpleCall(expectedResponse);
            const [response] = await client.listBatchJobResults(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listBatchJobResults as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listBatchJobResults without error using callback', async () => {
            const client = new batchjobserviceModule.v4.BatchJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listBatchJobResults = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listBatchJobResults(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IBatchJobResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listBatchJobResults with error', async () => {
            const client = new batchjobserviceModule.v4.BatchJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listBatchJobResults = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listBatchJobResults(request), expectedError);
            assert((client.innerApiCalls.listBatchJobResults as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listBatchJobResultsStream without error', async () => {
            const client = new batchjobserviceModule.v4.BatchJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listBatchJobResults.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listBatchJobResultsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v4.services.BatchJobResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v4.services.BatchJobResult) => {
            ...
            assert((client.descriptors.page.listBatchJobResults.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listBatchJobResults, request));
            assert.strictEqual(
                (client.descriptors.page.listBatchJobResults.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });

        it('invokes listBatchJobResultsStream with error', async () => {
            const client = new batchjobserviceModule.v4.BatchJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = "resource_name=";
            const expectedError = new Error('expected');
            client.descriptors.page.listBatchJobResults.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listBatchJobResultsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v4.services.BatchJobResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v4.services.BatchJobResult) => {
        ...
        it('uses async iteration with listBatchJobResults without error', async () => {
            ...
            client.descriptors.page.listBatchJobResults.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.googleads.v4.services.IBatchJobResult[] = [];
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listBatchJobResults.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listBatchJobResults with error', async () => {
            const client = new batchjobserviceModule.v4.BatchJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.ListBatchJobResultsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";const expectedError = new Error('expected');
            client.descriptors.page.listBatchJobResults.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listBatchJobResultsAsync(request);
    ...
    describe('Path templates', () => {
        ...
        describe('accountLink', () => {
            ...
            it('accountLinkPath', () => {
                const result = client.accountLinkPath("customerValue", "accountLinkValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.accountLinkPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerFromAccountLinkName', () => {
                const result = client.matchCustomerFromAccountLinkName(fakePath);
                assert.strictEqual(result, "customerValue");
                assert((client.pathTemplates.accountLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchAccountLinkFromAccountLinkName', () => {
                const result = client.matchAccountLinkFromAccountLinkName(fakePath);
                assert.strictEqual(result, "accountLinkValue");
                assert((client.pathTemplates.accountLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('batchJob', () => {
            ...
            it('batchJobPath', () => {
                const result = client.batchJobPath("customerValue", "batchJobValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.batchJobPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerFromBatchJobName', () => {
                const result = client.matchCustomerFromBatchJobName(fakePath);
                assert.strictEqual(result, "customerValue");
                assert((client.pathTemplates.batchJobPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchBatchJobFromBatchJobName', () => {
                const result = client.matchBatchJobFromBatchJobName(fakePath);
                assert.strictEqual(result, "batchJobValue");
                assert((client.pathTemplates.batchJobPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('incomeRangeView', () => {
            ...
            const expectedParameters = {
                customer: "customerValue",
                income_range_view: "incomeRangeViewValue",
            };
            const client = new batchjobserviceModule.v4.BatchJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            it('incomeRangeViewPath', () => {
                const result = client.incomeRangeViewPath("customerValue", "incomeRangeViewValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.incomeRangeViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerFromIncomeRangeViewName', () => {
                const result = client.matchCustomerFromIncomeRangeViewName(fakePath);
                assert.strictEqual(result, "customerValue");
                assert((client.pathTemplates.incomeRangeViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchIncomeRangeViewFromIncomeRangeViewName', () => {
                const result = client.matchIncomeRangeViewFromIncomeRangeViewName(fakePath);
                assert.strictEqual(result, "incomeRangeViewValue");
                assert((client.pathTemplates.incomeRangeViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('keywordPlanAdGroupKeyword', () => {
            ...
            const expectedParameters = {
                customer: "customerValue",
                keyword_plan_ad_group_keyword: "keywordPlanAdGroupKeywordValue",
            };
            const client = new batchjobserviceModule.v4.BatchJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            it('keywordPlanAdGroupKeywordPath', () => {
                const result = client.keywordPlanAdGroupKeywordPath("customerValue", "keywordPlanAdGroupKeywordValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.keywordPlanAdGroupKeywordPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerFromKeywordPlanAdGroupKeywordName', () => {
                const result = client.matchCustomerFromKeywordPlanAdGroupKeywordName(fakePath);
                assert.strictEqual(result, "customerValue");
                assert((client.pathTemplates.keywordPlanAdGroupKeywordPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchKeywordPlanAdGroupKeywordFromKeywordPlanAdGroupKeywordName', () => {
                const result = client.matchKeywordPlanAdGroupKeywordFromKeywordPlanAdGroupKeywordName(fakePath);
                assert.strictEqual(result, "keywordPlanAdGroupKeywordValue");
                assert((client.pathTemplates.keywordPlanAdGroupKeywordPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('keywordPlanCampaignKeyword', () => {
            ...
            const expectedParameters = {
                customer: "customerValue",
                keyword_plan_campaign_keyword: "keywordPlanCampaignKeywordValue",
            };
            const client = new batchjobserviceModule.v4.BatchJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            it('keywordPlanCampaignKeywordPath', () => {
                const result = client.keywordPlanCampaignKeywordPath("customerValue", "keywordPlanCampaignKeywordValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.keywordPlanCampaignKeywordPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerFromKeywordPlanCampaignKeywordName', () => {
                const result = client.matchCustomerFromKeywordPlanCampaignKeywordName(fakePath);
                assert.strictEqual(result, "customerValue");
                assert((client.pathTemplates.keywordPlanCampaignKeywordPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchKeywordPlanCampaignKeywordFromKeywordPlanCampaignKeywordName', () => {
                const result = client.matchKeywordPlanCampaignKeywordFromKeywordPlanCampaignKeywordName(fakePath);
                assert.strictEqual(result, "keywordPlanCampaignKeywordValue");
                assert((client.pathTemplates.keywordPlanCampaignKeywordPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('thirdPartyAppAnalyticsLink', () => {
            ...
            const expectedParameters = {
                customer: "customerValue",
                third_party_app_analytics_link: "thirdPartyAppAnalyticsLinkValue",
            };
            const client = new batchjobserviceModule.v4.BatchJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            it('thirdPartyAppAnalyticsLinkPath', () => {
                const result = client.thirdPartyAppAnalyticsLinkPath("customerValue", "thirdPartyAppAnalyticsLinkValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.thirdPartyAppAnalyticsLinkPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerFromThirdPartyAppAnalyticsLinkName', () => {
                const result = client.matchCustomerFromThirdPartyAppAnalyticsLinkName(fakePath);
                assert.strictEqual(result, "customerValue");
                assert((client.pathTemplates.thirdPartyAppAnalyticsLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchThirdPartyAppAnalyticsLinkFromThirdPartyAppAnalyticsLinkName', () => {
                const result = client.matchThirdPartyAppAnalyticsLinkFromThirdPartyAppAnalyticsLinkName(fakePath);
                assert.strictEqual(result, "thirdPartyAppAnalyticsLinkValue");
                assert((client.pathTemplates.thirdPartyAppAnalyticsLinkPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
