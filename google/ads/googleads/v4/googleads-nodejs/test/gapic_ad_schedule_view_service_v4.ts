...
import * as adscheduleviewserviceModule from '../src';
...
describe('v4.AdScheduleViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adscheduleviewserviceModule.v4.AdScheduleViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adscheduleviewserviceModule.v4.AdScheduleViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adscheduleviewserviceModule.v4.AdScheduleViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adscheduleviewserviceModule.v4.AdScheduleViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adScheduleViewServiceStub, undefined);
        await client.initialize();
        assert(client.adScheduleViewServiceStub);
    });
    ...
    describe('getAdScheduleView', () => {
        it('invokes getAdScheduleView without error', async () => {
            const client = new adscheduleviewserviceModule.v4.AdScheduleViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetAdScheduleViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdScheduleView());
            client.innerApiCalls.getAdScheduleView = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdScheduleView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdScheduleView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdScheduleView without error using callback', async () => {
            const client = new adscheduleviewserviceModule.v4.AdScheduleViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdScheduleView());
            client.innerApiCalls.getAdScheduleView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdScheduleView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IAdScheduleView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdScheduleView with error', async () => {
            const client = new adscheduleviewserviceModule.v4.AdScheduleViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdScheduleView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdScheduleView(request), expectedError);
            assert((client.innerApiCalls.getAdScheduleView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
