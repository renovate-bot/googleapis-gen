...
import * as hotelgroupviewserviceModule from '../src';
...
describe('v4.HotelGroupViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = hotelgroupviewserviceModule.v4.HotelGroupViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = hotelgroupviewserviceModule.v4.HotelGroupViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = hotelgroupviewserviceModule.v4.HotelGroupViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new hotelgroupviewserviceModule.v4.HotelGroupViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.hotelGroupViewServiceStub);
    });
    ...
    describe('getHotelGroupView', () => {
        it('invokes getHotelGroupView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetHotelGroupViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.HotelGroupView());
            client.innerApiCalls.getHotelGroupView = stubSimpleCall(expectedResponse);
            const [response] = await client.getHotelGroupView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getHotelGroupView as SinonStub)
        ...
        it('invokes getHotelGroupView without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.HotelGroupView());
            client.innerApiCalls.getHotelGroupView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getHotelGroupView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IHotelGroupView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getHotelGroupView with error', async () => {
            ...
            client.innerApiCalls.getHotelGroupView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getHotelGroupView(request), expectedError);
            assert((client.innerApiCalls.getHotelGroupView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
