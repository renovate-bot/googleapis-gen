...
describe('v4.DomainCategoryServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = domaincategoryserviceModule.v4.DomainCategoryServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = domaincategoryserviceModule.v4.DomainCategoryServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = domaincategoryserviceModule.v4.DomainCategoryServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new domaincategoryserviceModule.v4.DomainCategoryServiceClient();
        assert(client);
    });
    ...
    describe('getDomainCategory', () => {
        it('invokes getDomainCategory without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetDomainCategoryRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.DomainCategory());
        ...
        it('invokes getDomainCategory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDomainCategory(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IDomainCategory|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
