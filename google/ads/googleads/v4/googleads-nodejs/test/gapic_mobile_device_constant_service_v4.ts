...
import * as mobiledeviceconstantserviceModule from '../src';
...
describe('v4.MobileDeviceConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = mobiledeviceconstantserviceModule.v4.MobileDeviceConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = mobiledeviceconstantserviceModule.v4.MobileDeviceConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = mobiledeviceconstantserviceModule.v4.MobileDeviceConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new mobiledeviceconstantserviceModule.v4.MobileDeviceConstantServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.mobileDeviceConstantServiceStub, undefined);
        await client.initialize();
        assert(client.mobileDeviceConstantServiceStub);
    });
    ...
    describe('getMobileDeviceConstant', () => {
        it('invokes getMobileDeviceConstant without error', async () => {
            const client = new mobiledeviceconstantserviceModule.v4.MobileDeviceConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetMobileDeviceConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.MobileDeviceConstant());
            client.innerApiCalls.getMobileDeviceConstant = stubSimpleCall(expectedResponse);
            const [response] = await client.getMobileDeviceConstant(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getMobileDeviceConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getMobileDeviceConstant without error using callback', async () => {
            const client = new mobiledeviceconstantserviceModule.v4.MobileDeviceConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.MobileDeviceConstant());
            client.innerApiCalls.getMobileDeviceConstant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMobileDeviceConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IMobileDeviceConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMobileDeviceConstant with error', async () => {
            const client = new mobiledeviceconstantserviceModule.v4.MobileDeviceConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getMobileDeviceConstant = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getMobileDeviceConstant(request), expectedError);
            assert((client.innerApiCalls.getMobileDeviceConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
