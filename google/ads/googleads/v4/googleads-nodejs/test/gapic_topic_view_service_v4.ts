...
describe('v4.TopicViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = topicviewserviceModule.v4.TopicViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = topicviewserviceModule.v4.TopicViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = topicviewserviceModule.v4.TopicViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new topicviewserviceModule.v4.TopicViewServiceClient();
        assert(client);
    });
    ...
    describe('getTopicView', () => {
        it('invokes getTopicView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetTopicViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.TopicView());
        ...
        it('invokes getTopicView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTopicView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ITopicView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
