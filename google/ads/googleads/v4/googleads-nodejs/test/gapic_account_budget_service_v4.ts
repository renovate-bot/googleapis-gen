...
describe('v4.AccountBudgetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = accountbudgetserviceModule.v4.AccountBudgetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = accountbudgetserviceModule.v4.AccountBudgetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = accountbudgetserviceModule.v4.AccountBudgetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new accountbudgetserviceModule.v4.AccountBudgetServiceClient();
        assert(client);
    });
    ...
    describe('getAccountBudget', () => {
        it('invokes getAccountBudget without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetAccountBudgetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AccountBudget());
        ...
        it('invokes getAccountBudget without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAccountBudget(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IAccountBudget|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
