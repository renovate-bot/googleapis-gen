...
describe('v4.CustomInterestServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = custominterestserviceModule.v4.CustomInterestServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = custominterestserviceModule.v4.CustomInterestServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = custominterestserviceModule.v4.CustomInterestServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new custominterestserviceModule.v4.CustomInterestServiceClient();
        assert(client);
    });
    ...
    describe('getCustomInterest', () => {
        it('invokes getCustomInterest without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetCustomInterestRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.CustomInterest());
        ...
        it('invokes getCustomInterest without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomInterest(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ICustomInterest|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomInterests', () => {
        it('invokes mutateCustomInterests without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCustomInterestsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCustomInterestsResponse());
        ...
        it('invokes mutateCustomInterests without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomInterests(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateCustomInterestsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
