...
describe('v4.ShoppingPerformanceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = shoppingperformanceviewserviceModule.v4.ShoppingPerformanceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = shoppingperformanceviewserviceModule.v4.ShoppingPerformanceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = shoppingperformanceviewserviceModule.v4.ShoppingPerformanceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new shoppingperformanceviewserviceModule.v4.ShoppingPerformanceViewServiceClient();
        assert(client);
    });
    ...
    describe('getShoppingPerformanceView', () => {
        it('invokes getShoppingPerformanceView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.ShoppingPerformanceView());
        ...
        it('invokes getShoppingPerformanceView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getShoppingPerformanceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IShoppingPerformanceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
