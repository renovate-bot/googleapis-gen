...
import * as conversionuploadserviceModule from '../src';
...
describe('v4.ConversionUploadServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionuploadserviceModule.v4.ConversionUploadServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionuploadserviceModule.v4.ConversionUploadServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionuploadserviceModule.v4.ConversionUploadServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionuploadserviceModule.v4.ConversionUploadServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.conversionUploadServiceStub, undefined);
        await client.initialize();
        assert(client.conversionUploadServiceStub);
    });
    ...
    describe('uploadClickConversions', () => {
        it('invokes uploadClickConversions without error', async () => {
            const client = new conversionuploadserviceModule.v4.ConversionUploadServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.UploadClickConversionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.UploadClickConversionsResponse());
            client.innerApiCalls.uploadClickConversions = stubSimpleCall(expectedResponse);
            const [response] = await client.uploadClickConversions(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.uploadClickConversions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes uploadClickConversions without error using callback', async () => {
            const client = new conversionuploadserviceModule.v4.ConversionUploadServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.UploadClickConversionsResponse());
            client.innerApiCalls.uploadClickConversions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.uploadClickConversions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IUploadClickConversionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes uploadClickConversions with error', async () => {
            const client = new conversionuploadserviceModule.v4.ConversionUploadServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.uploadClickConversions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.uploadClickConversions(request), expectedError);
            assert((client.innerApiCalls.uploadClickConversions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('uploadCallConversions', () => {
        it('invokes uploadCallConversions without error', async () => {
            const client = new conversionuploadserviceModule.v4.ConversionUploadServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.UploadCallConversionsRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.UploadCallConversionsResponse());
            client.innerApiCalls.uploadCallConversions = stubSimpleCall(expectedResponse);
            const [response] = await client.uploadCallConversions(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.uploadCallConversions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes uploadCallConversions without error using callback', async () => {
            const client = new conversionuploadserviceModule.v4.ConversionUploadServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.UploadCallConversionsResponse());
            client.innerApiCalls.uploadCallConversions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.uploadCallConversions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IUploadCallConversionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes uploadCallConversions with error', async () => {
            const client = new conversionuploadserviceModule.v4.ConversionUploadServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.uploadCallConversions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.uploadCallConversions(request), expectedError);
            assert((client.innerApiCalls.uploadCallConversions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
