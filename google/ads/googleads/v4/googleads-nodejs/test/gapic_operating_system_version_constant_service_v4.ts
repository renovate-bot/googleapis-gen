...
describe('v4.OperatingSystemVersionConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = operatingsystemversionconstantserviceModule.v4.OperatingSystemVersionConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = operatingsystemversionconstantserviceModule.v4.OperatingSystemVersionConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = operatingsystemversionconstantserviceModule.v4.OperatingSystemVersionConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new operatingsystemversionconstantserviceModule.v4.OperatingSystemVersionConstantServiceClient();
        assert(client);
    });
    ...
    describe('getOperatingSystemVersionConstant', () => {
        it('invokes getOperatingSystemVersionConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetOperatingSystemVersionConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.OperatingSystemVersionConstant());
        ...
        it('invokes getOperatingSystemVersionConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getOperatingSystemVersionConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IOperatingSystemVersionConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
