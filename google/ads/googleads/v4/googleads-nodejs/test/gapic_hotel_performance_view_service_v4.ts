...
import * as hotelperformanceviewserviceModule from '../src';
...
describe('v4.HotelPerformanceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = hotelperformanceviewserviceModule.v4.HotelPerformanceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = hotelperformanceviewserviceModule.v4.HotelPerformanceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = hotelperformanceviewserviceModule.v4.HotelPerformanceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new hotelperformanceviewserviceModule.v4.HotelPerformanceViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.hotelPerformanceViewServiceStub, undefined);
        await client.initialize();
        assert(client.hotelPerformanceViewServiceStub);
    });
    ...
    describe('getHotelPerformanceView', () => {
        it('invokes getHotelPerformanceView without error', async () => {
            const client = new hotelperformanceviewserviceModule.v4.HotelPerformanceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetHotelPerformanceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.HotelPerformanceView());
            client.innerApiCalls.getHotelPerformanceView = stubSimpleCall(expectedResponse);
            const [response] = await client.getHotelPerformanceView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getHotelPerformanceView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getHotelPerformanceView without error using callback', async () => {
            const client = new hotelperformanceviewserviceModule.v4.HotelPerformanceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.HotelPerformanceView());
            client.innerApiCalls.getHotelPerformanceView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getHotelPerformanceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IHotelPerformanceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getHotelPerformanceView with error', async () => {
            const client = new hotelperformanceviewserviceModule.v4.HotelPerformanceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getHotelPerformanceView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getHotelPerformanceView(request), expectedError);
            assert((client.innerApiCalls.getHotelPerformanceView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
