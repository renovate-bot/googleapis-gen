...
import * as campaignaudienceviewserviceModule from '../src';
...
describe('v4.CampaignAudienceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignaudienceviewserviceModule.v4.CampaignAudienceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignaudienceviewserviceModule.v4.CampaignAudienceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignaudienceviewserviceModule.v4.CampaignAudienceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignaudienceviewserviceModule.v4.CampaignAudienceViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.campaignAudienceViewServiceStub, undefined);
        await client.initialize();
        assert(client.campaignAudienceViewServiceStub);
    });
    ...
    describe('getCampaignAudienceView', () => {
        it('invokes getCampaignAudienceView without error', async () => {
            const client = new campaignaudienceviewserviceModule.v4.CampaignAudienceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetCampaignAudienceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.CampaignAudienceView());
            client.innerApiCalls.getCampaignAudienceView = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignAudienceView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignAudienceView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCampaignAudienceView without error using callback', async () => {
            const client = new campaignaudienceviewserviceModule.v4.CampaignAudienceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.CampaignAudienceView());
            client.innerApiCalls.getCampaignAudienceView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignAudienceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ICampaignAudienceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignAudienceView with error', async () => {
            const client = new campaignaudienceviewserviceModule.v4.CampaignAudienceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCampaignAudienceView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignAudienceView(request), expectedError);
            assert((client.innerApiCalls.getCampaignAudienceView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
