...
import * as adgroupadassetviewserviceModule from '../src';
...
describe('v4.AdGroupAdAssetViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupadassetviewserviceModule.v4.AdGroupAdAssetViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupadassetviewserviceModule.v4.AdGroupAdAssetViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupadassetviewserviceModule.v4.AdGroupAdAssetViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupadassetviewserviceModule.v4.AdGroupAdAssetViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupAdAssetViewServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupAdAssetViewServiceStub);
    });
    ...
    describe('getAdGroupAdAssetView', () => {
        it('invokes getAdGroupAdAssetView without error', async () => {
            const client = new adgroupadassetviewserviceModule.v4.AdGroupAdAssetViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetAdGroupAdAssetViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdGroupAdAssetView());
            client.innerApiCalls.getAdGroupAdAssetView = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupAdAssetView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupAdAssetView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupAdAssetView without error using callback', async () => {
            const client = new adgroupadassetviewserviceModule.v4.AdGroupAdAssetViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdGroupAdAssetView());
            client.innerApiCalls.getAdGroupAdAssetView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAdAssetView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IAdGroupAdAssetView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupAdAssetView with error', async () => {
            const client = new adgroupadassetviewserviceModule.v4.AdGroupAdAssetViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdGroupAdAssetView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupAdAssetView(request), expectedError);
            assert((client.innerApiCalls.getAdGroupAdAssetView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
