...
describe('v4.UserLocationViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = userlocationviewserviceModule.v4.UserLocationViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = userlocationviewserviceModule.v4.UserLocationViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = userlocationviewserviceModule.v4.UserLocationViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new userlocationviewserviceModule.v4.UserLocationViewServiceClient();
        assert(client);
    });
    ...
    describe('getUserLocationView', () => {
        it('invokes getUserLocationView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetUserLocationViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.UserLocationView());
        ...
        it('invokes getUserLocationView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getUserLocationView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IUserLocationView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
