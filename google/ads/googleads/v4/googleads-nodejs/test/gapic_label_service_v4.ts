...
describe('v4.LabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = labelserviceModule.v4.LabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = labelserviceModule.v4.LabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = labelserviceModule.v4.LabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new labelserviceModule.v4.LabelServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.labelServiceStub, undefined);
    ...
    describe('getLabel', () => {
        it('invokes getLabel without error', async () => {
            const client = new labelserviceModule.v4.LabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.Label());
            client.innerApiCalls.getLabel = stubSimpleCall(expectedResponse);
            const [response] = await client.getLabel(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getLabel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getLabel without error using callback', async () => {
            const client = new labelserviceModule.v4.LabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.Label());
            client.innerApiCalls.getLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ILabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getLabel with error', async () => {
            const client = new labelserviceModule.v4.LabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getLabel = stubSimpleCall(undefined, expectedError);
    ...
    describe('mutateLabels', () => {
        it('invokes mutateLabels without error', async () => {
            const client = new labelserviceModule.v4.LabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateLabelsResponse());
            client.innerApiCalls.mutateLabels = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateLabels(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateLabels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateLabels without error using callback', async () => {
            const client = new labelserviceModule.v4.LabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateLabelsResponse());
            client.innerApiCalls.mutateLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateLabels with error', async () => {
            const client = new labelserviceModule.v4.LabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateLabels = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateLabels(request), expectedError);
            assert((client.innerApiCalls.mutateLabels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
