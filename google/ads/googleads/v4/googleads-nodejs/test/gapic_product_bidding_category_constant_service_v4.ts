...
describe('v4.ProductBiddingCategoryConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = productbiddingcategoryconstantserviceModule.v4.ProductBiddingCategoryConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = productbiddingcategoryconstantserviceModule.v4.ProductBiddingCategoryConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = productbiddingcategoryconstantserviceModule.v4.ProductBiddingCategoryConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new productbiddingcategoryconstantserviceModule.v4.ProductBiddingCategoryConstantServiceClient();
        assert(client);
    });
    ...
    describe('getProductBiddingCategoryConstant', () => {
        it('invokes getProductBiddingCategoryConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetProductBiddingCategoryConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.ProductBiddingCategoryConstant());
        ...
        it('invokes getProductBiddingCategoryConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getProductBiddingCategoryConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IProductBiddingCategoryConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
