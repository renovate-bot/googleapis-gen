...
import * as distanceviewserviceModule from '../src';
...
describe('v4.DistanceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = distanceviewserviceModule.v4.DistanceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = distanceviewserviceModule.v4.DistanceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = distanceviewserviceModule.v4.DistanceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new distanceviewserviceModule.v4.DistanceViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.distanceViewServiceStub, undefined);
        await client.initialize();
        assert(client.distanceViewServiceStub);
    });
    ...
    describe('getDistanceView', () => {
        it('invokes getDistanceView without error', async () => {
            const client = new distanceviewserviceModule.v4.DistanceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetDistanceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.DistanceView());
            client.innerApiCalls.getDistanceView = stubSimpleCall(expectedResponse);
            const [response] = await client.getDistanceView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getDistanceView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getDistanceView without error using callback', async () => {
            const client = new distanceviewserviceModule.v4.DistanceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.DistanceView());
            client.innerApiCalls.getDistanceView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDistanceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IDistanceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDistanceView with error', async () => {
            const client = new distanceviewserviceModule.v4.DistanceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDistanceView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDistanceView(request), expectedError);
            assert((client.innerApiCalls.getDistanceView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
