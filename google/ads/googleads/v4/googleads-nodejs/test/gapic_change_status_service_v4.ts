...
import * as changestatusserviceModule from '../src';
...
describe('v4.ChangeStatusServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = changestatusserviceModule.v4.ChangeStatusServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = changestatusserviceModule.v4.ChangeStatusServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = changestatusserviceModule.v4.ChangeStatusServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new changestatusserviceModule.v4.ChangeStatusServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.changeStatusServiceStub, undefined);
        await client.initialize();
        assert(client.changeStatusServiceStub);
    });
    ...
    describe('getChangeStatus', () => {
        it('invokes getChangeStatus without error', async () => {
            const client = new changestatusserviceModule.v4.ChangeStatusServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetChangeStatusRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.ChangeStatus());
            client.innerApiCalls.getChangeStatus = stubSimpleCall(expectedResponse);
            const [response] = await client.getChangeStatus(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getChangeStatus as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getChangeStatus without error using callback', async () => {
            const client = new changestatusserviceModule.v4.ChangeStatusServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.ChangeStatus());
            client.innerApiCalls.getChangeStatus = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getChangeStatus(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IChangeStatus|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getChangeStatus with error', async () => {
            const client = new changestatusserviceModule.v4.ChangeStatusServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getChangeStatus = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getChangeStatus(request), expectedError);
            assert((client.innerApiCalls.getChangeStatus as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
