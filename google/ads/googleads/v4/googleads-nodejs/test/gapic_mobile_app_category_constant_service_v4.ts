...
describe('v4.MobileAppCategoryConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = mobileappcategoryconstantserviceModule.v4.MobileAppCategoryConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = mobileappcategoryconstantserviceModule.v4.MobileAppCategoryConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = mobileappcategoryconstantserviceModule.v4.MobileAppCategoryConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new mobileappcategoryconstantserviceModule.v4.MobileAppCategoryConstantServiceClient();
        assert(client);
    });
    ...
    describe('getMobileAppCategoryConstant', () => {
        it('invokes getMobileAppCategoryConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetMobileAppCategoryConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.MobileAppCategoryConstant());
        ...
        it('invokes getMobileAppCategoryConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMobileAppCategoryConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IMobileAppCategoryConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
