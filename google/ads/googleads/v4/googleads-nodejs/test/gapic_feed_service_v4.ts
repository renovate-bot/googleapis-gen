...
describe('v4.FeedServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feedserviceModule.v4.FeedServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feedserviceModule.v4.FeedServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feedserviceModule.v4.FeedServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feedserviceModule.v4.FeedServiceClient();
        assert(client);
    });
    ...
    describe('getFeed', () => {
        it('invokes getFeed without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetFeedRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.Feed());
        ...
        it('invokes getFeed without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeed(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IFeed|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateFeeds', () => {
        it('invokes mutateFeeds without error', async () => {
            const client = new feedserviceModule.v4.FeedServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateFeedsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateFeedsResponse());
            client.innerApiCalls.mutateFeeds = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateFeeds(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateFeeds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateFeeds without error using callback', async () => {
            const client = new feedserviceModule.v4.FeedServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateFeedsResponse());
            client.innerApiCalls.mutateFeeds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeeds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateFeedsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateFeeds with error', async () => {
            const client = new feedserviceModule.v4.FeedServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateFeeds = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateFeeds(request), expectedError);
            assert((client.innerApiCalls.mutateFeeds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
