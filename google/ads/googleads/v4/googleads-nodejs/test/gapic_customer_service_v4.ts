...
describe('v4.CustomerServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerserviceModule.v4.CustomerServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerserviceModule.v4.CustomerServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerserviceModule.v4.CustomerServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerserviceModule.v4.CustomerServiceClient();
        assert(client);
    });
    ...
    describe('getCustomer', () => {
        it('invokes getCustomer without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetCustomerRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.Customer());
        ...
        it('invokes getCustomer without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomer(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ICustomer|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomer', () => {
        it('invokes mutateCustomer without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCustomerRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCustomerResponse());
        ...
        it('invokes mutateCustomer without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomer(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateCustomerResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listAccessibleCustomers', () => {
        it('invokes listAccessibleCustomers without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.ListAccessibleCustomersRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.ListAccessibleCustomersResponse());
        ...
        it('invokes listAccessibleCustomers without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listAccessibleCustomers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IListAccessibleCustomersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCustomerClient', () => {
        it('invokes createCustomerClient without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.CreateCustomerClientRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.CreateCustomerClientResponse());
        ...
        it('invokes createCustomerClient without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCustomerClient(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.ICreateCustomerClientResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
