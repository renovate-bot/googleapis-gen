...
import * as videoserviceModule from '../src';
...
describe('v4.VideoServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = videoserviceModule.v4.VideoServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = videoserviceModule.v4.VideoServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = videoserviceModule.v4.VideoServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new videoserviceModule.v4.VideoServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.videoServiceStub, undefined);
        await client.initialize();
        assert(client.videoServiceStub);
    });
    ...
    describe('getVideo', () => {
        it('invokes getVideo without error', async () => {
            const client = new videoserviceModule.v4.VideoServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetVideoRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.Video());
            client.innerApiCalls.getVideo = stubSimpleCall(expectedResponse);
            const [response] = await client.getVideo(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getVideo as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getVideo without error using callback', async () => {
            const client = new videoserviceModule.v4.VideoServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.Video());
            client.innerApiCalls.getVideo = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getVideo(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IVideo|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getVideo with error', async () => {
            const client = new videoserviceModule.v4.VideoServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getVideo = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getVideo(request), expectedError);
            assert((client.innerApiCalls.getVideo as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
