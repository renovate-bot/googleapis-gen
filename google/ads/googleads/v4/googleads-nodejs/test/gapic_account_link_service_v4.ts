...
import * as accountlinkserviceModule from '../src';
...
describe('v4.AccountLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = accountlinkserviceModule.v4.AccountLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = accountlinkserviceModule.v4.AccountLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = accountlinkserviceModule.v4.AccountLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new accountlinkserviceModule.v4.AccountLinkServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.accountLinkServiceStub, undefined);
        await client.initialize();
        assert(client.accountLinkServiceStub);
    });
    ...
    describe('getAccountLink', () => {
        it('invokes getAccountLink without error', async () => {
            const client = new accountlinkserviceModule.v4.AccountLinkServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetAccountLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AccountLink());
            client.innerApiCalls.getAccountLink = stubSimpleCall(expectedResponse);
            const [response] = await client.getAccountLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAccountLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAccountLink without error using callback', async () => {
            const client = new accountlinkserviceModule.v4.AccountLinkServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AccountLink());
            client.innerApiCalls.getAccountLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAccountLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IAccountLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAccountLink with error', async () => {
            const client = new accountlinkserviceModule.v4.AccountLinkServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAccountLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAccountLink(request), expectedError);
            assert((client.innerApiCalls.getAccountLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAccountLink', () => {
        it('invokes mutateAccountLink without error', async () => {
            const client = new accountlinkserviceModule.v4.AccountLinkServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAccountLinkRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAccountLinkResponse());
            client.innerApiCalls.mutateAccountLink = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAccountLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAccountLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAccountLink without error using callback', async () => {
            const client = new accountlinkserviceModule.v4.AccountLinkServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAccountLinkResponse());
            client.innerApiCalls.mutateAccountLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAccountLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateAccountLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAccountLink with error', async () => {
            const client = new accountlinkserviceModule.v4.AccountLinkServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAccountLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAccountLink(request), expectedError);
            assert((client.innerApiCalls.mutateAccountLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
