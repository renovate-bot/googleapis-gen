...
import * as googleadsfieldserviceModule from '../src';
...
describe('v4.GoogleAdsFieldServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = googleadsfieldserviceModule.v4.GoogleAdsFieldServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = googleadsfieldserviceModule.v4.GoogleAdsFieldServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = googleadsfieldserviceModule.v4.GoogleAdsFieldServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new googleadsfieldserviceModule.v4.GoogleAdsFieldServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.googleAdsFieldServiceStub);
    });
    ...
    describe('getGoogleAdsField', () => {
        it('invokes getGoogleAdsField without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetGoogleAdsFieldRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.GoogleAdsField());
            client.innerApiCalls.getGoogleAdsField = stubSimpleCall(expectedResponse);
            const [response] = await client.getGoogleAdsField(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getGoogleAdsField as SinonStub)
        ...
        it('invokes getGoogleAdsField without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.GoogleAdsField());
            client.innerApiCalls.getGoogleAdsField = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGoogleAdsField(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IGoogleAdsField|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGoogleAdsField with error', async () => {
            ...
            client.innerApiCalls.getGoogleAdsField = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getGoogleAdsField(request), expectedError);
            assert((client.innerApiCalls.getGoogleAdsField as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('searchGoogleAdsFields', () => {
        it('invokes searchGoogleAdsFields without error', async () => {
            const client = new googleadsfieldserviceModule.v4.GoogleAdsFieldServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.SearchGoogleAdsFieldsRequest());
            const expectedOptions = {};
            const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v4.resources.GoogleAdsField()),
              generateSampleMessage(new protos.google.ads.googleads.v4.resources.GoogleAdsField()),
              generateSampleMessage(new protos.google.ads.googleads.v4.resources.GoogleAdsField()),
            ];
            client.innerApiCalls.searchGoogleAdsFields = stubSimpleCall(expectedResponse);
            const [response] = await client.searchGoogleAdsFields(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchGoogleAdsFields as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes searchGoogleAdsFields without error using callback', async () => {
            const client = new googleadsfieldserviceModule.v4.GoogleAdsFieldServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.searchGoogleAdsFields = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchGoogleAdsFields(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IGoogleAdsField[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes searchGoogleAdsFields with error', async () => {
            const client = new googleadsfieldserviceModule.v4.GoogleAdsFieldServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
        ...
        it('invokes searchGoogleAdsFieldsStream without error', async () => {
            const client = new googleadsfieldserviceModule.v4.GoogleAdsFieldServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.searchGoogleAdsFields.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.searchGoogleAdsFieldsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v4.resources.GoogleAdsField[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v4.resources.GoogleAdsField) => {
            ...
            assert((client.descriptors.page.searchGoogleAdsFields.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchGoogleAdsFields, request));
        });

        it('invokes searchGoogleAdsFieldsStream with error', async () => {
            const client = new googleadsfieldserviceModule.v4.GoogleAdsFieldServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.SearchGoogleAdsFieldsRequest());
            const expectedError = new Error('expected');
            client.descriptors.page.searchGoogleAdsFields.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchGoogleAdsFieldsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v4.resources.GoogleAdsField[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v4.resources.GoogleAdsField) => {
        ...
        it('uses async iteration with searchGoogleAdsFields without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.SearchGoogleAdsFieldsRequest());const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v4.resources.GoogleAdsField()),
              generateSampleMessage(new protos.google.ads.googleads.v4.resources.GoogleAdsField()),
              generateSampleMessage(new protos.google.ads.googleads.v4.resources.GoogleAdsField()),
            ];
            client.descriptors.page.searchGoogleAdsFields.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.googleads.v4.resources.IGoogleAdsField[] = [];
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.searchGoogleAdsFields.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
        });

        it('uses async iteration with searchGoogleAdsFields with error', async () => {
            const client = new googleadsfieldserviceModule.v4.GoogleAdsFieldServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.SearchGoogleAdsFieldsRequest());const expectedError = new Error('expected');
            client.descriptors.page.searchGoogleAdsFields.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchGoogleAdsFieldsAsync(request);
