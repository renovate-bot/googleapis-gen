...
describe('v4.LanguageConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = languageconstantserviceModule.v4.LanguageConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = languageconstantserviceModule.v4.LanguageConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = languageconstantserviceModule.v4.LanguageConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new languageconstantserviceModule.v4.LanguageConstantServiceClient();
        assert(client);
    });
    ...
    describe('getLanguageConstant', () => {
        it('invokes getLanguageConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetLanguageConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.LanguageConstant());
        ...
        it('invokes getLanguageConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLanguageConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ILanguageConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
