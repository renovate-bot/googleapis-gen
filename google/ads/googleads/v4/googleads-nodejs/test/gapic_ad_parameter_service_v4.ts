...
import * as adparameterserviceModule from '../src';
...
describe('v4.AdParameterServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adparameterserviceModule.v4.AdParameterServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adparameterserviceModule.v4.AdParameterServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adparameterserviceModule.v4.AdParameterServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adparameterserviceModule.v4.AdParameterServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adParameterServiceStub, undefined);
        await client.initialize();
        assert(client.adParameterServiceStub);
    });
    ...
    describe('getAdParameter', () => {
        it('invokes getAdParameter without error', async () => {
            const client = new adparameterserviceModule.v4.AdParameterServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetAdParameterRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdParameter());
            client.innerApiCalls.getAdParameter = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdParameter(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdParameter as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdParameter without error using callback', async () => {
            const client = new adparameterserviceModule.v4.AdParameterServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdParameter());
            client.innerApiCalls.getAdParameter = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdParameter(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IAdParameter|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdParameter with error', async () => {
            const client = new adparameterserviceModule.v4.AdParameterServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdParameter = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdParameter(request), expectedError);
            assert((client.innerApiCalls.getAdParameter as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAdParameters', () => {
        it('invokes mutateAdParameters without error', async () => {
            const client = new adparameterserviceModule.v4.AdParameterServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdParametersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdParametersResponse());
            client.innerApiCalls.mutateAdParameters = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdParameters(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdParameters as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdParameters without error using callback', async () => {
            const client = new adparameterserviceModule.v4.AdParameterServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdParametersResponse());
            client.innerApiCalls.mutateAdParameters = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdParameters(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateAdParametersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdParameters with error', async () => {
            const client = new adparameterserviceModule.v4.AdParameterServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdParameters = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdParameters(request), expectedError);
            assert((client.innerApiCalls.mutateAdParameters as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
