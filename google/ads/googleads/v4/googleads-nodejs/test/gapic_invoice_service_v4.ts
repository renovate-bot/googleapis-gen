...
import * as invoiceserviceModule from '../src';
...
describe('v4.InvoiceServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = invoiceserviceModule.v4.InvoiceServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = invoiceserviceModule.v4.InvoiceServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = invoiceserviceModule.v4.InvoiceServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new invoiceserviceModule.v4.InvoiceServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.invoiceServiceStub, undefined);
        await client.initialize();
        assert(client.invoiceServiceStub);
    });
    ...
    describe('listInvoices', () => {
        it('invokes listInvoices without error', async () => {
            const client = new invoiceserviceModule.v4.InvoiceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.ListInvoicesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.ListInvoicesResponse());
            client.innerApiCalls.listInvoices = stubSimpleCall(expectedResponse);
            const [response] = await client.listInvoices(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listInvoices as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listInvoices without error using callback', async () => {
            const client = new invoiceserviceModule.v4.InvoiceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.ListInvoicesResponse());
            client.innerApiCalls.listInvoices = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listInvoices(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IListInvoicesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listInvoices with error', async () => {
            const client = new invoiceserviceModule.v4.InvoiceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listInvoices = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listInvoices(request), expectedError);
            assert((client.innerApiCalls.listInvoices as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
