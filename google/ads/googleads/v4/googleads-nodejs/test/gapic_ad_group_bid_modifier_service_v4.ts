...
import * as adgroupbidmodifierserviceModule from '../src';
...
describe('v4.AdGroupBidModifierServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupbidmodifierserviceModule.v4.AdGroupBidModifierServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupbidmodifierserviceModule.v4.AdGroupBidModifierServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupbidmodifierserviceModule.v4.AdGroupBidModifierServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupbidmodifierserviceModule.v4.AdGroupBidModifierServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupBidModifierServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupBidModifierServiceStub);
    });
    ...
    describe('getAdGroupBidModifier', () => {
        it('invokes getAdGroupBidModifier without error', async () => {
            const client = new adgroupbidmodifierserviceModule.v4.AdGroupBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetAdGroupBidModifierRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdGroupBidModifier());
            client.innerApiCalls.getAdGroupBidModifier = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupBidModifier(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupBidModifier as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupBidModifier without error using callback', async () => {
            const client = new adgroupbidmodifierserviceModule.v4.AdGroupBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdGroupBidModifier());
            client.innerApiCalls.getAdGroupBidModifier = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupBidModifier(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IAdGroupBidModifier|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupBidModifier with error', async () => {
            const client = new adgroupbidmodifierserviceModule.v4.AdGroupBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdGroupBidModifier = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupBidModifier(request), expectedError);
            assert((client.innerApiCalls.getAdGroupBidModifier as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAdGroupBidModifiers', () => {
        it('invokes mutateAdGroupBidModifiers without error', async () => {
            const client = new adgroupbidmodifierserviceModule.v4.AdGroupBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdGroupBidModifiersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdGroupBidModifiersResponse());
            client.innerApiCalls.mutateAdGroupBidModifiers = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupBidModifiers(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupBidModifiers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroupBidModifiers without error using callback', async () => {
            const client = new adgroupbidmodifierserviceModule.v4.AdGroupBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdGroupBidModifiersResponse());
            client.innerApiCalls.mutateAdGroupBidModifiers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupBidModifiers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateAdGroupBidModifiersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupBidModifiers with error', async () => {
            const client = new adgroupbidmodifierserviceModule.v4.AdGroupBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdGroupBidModifiers = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupBidModifiers(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupBidModifiers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
