...
import * as keywordplanserviceModule from '../src';
...
describe('v4.KeywordPlanServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanserviceModule.v4.KeywordPlanServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanserviceModule.v4.KeywordPlanServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanserviceModule.v4.KeywordPlanServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplanserviceModule.v4.KeywordPlanServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.keywordPlanServiceStub);
    });
    ...
    describe('getKeywordPlan', () => {
        it('invokes getKeywordPlan without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetKeywordPlanRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.KeywordPlan());
            client.innerApiCalls.getKeywordPlan = stubSimpleCall(expectedResponse);
            const [response] = await client.getKeywordPlan(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getKeywordPlan as SinonStub)
        ...
        it('invokes getKeywordPlan without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.KeywordPlan());
            client.innerApiCalls.getKeywordPlan = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlan(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IKeywordPlan|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getKeywordPlan with error', async () => {
            ...
            client.innerApiCalls.getKeywordPlan = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getKeywordPlan(request), expectedError);
            assert((client.innerApiCalls.getKeywordPlan as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateKeywordPlans', () => {
        it('invokes mutateKeywordPlans without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateKeywordPlansRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateKeywordPlansResponse());
            client.innerApiCalls.mutateKeywordPlans = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateKeywordPlans(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateKeywordPlans as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateKeywordPlans without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateKeywordPlansResponse());
            client.innerApiCalls.mutateKeywordPlans = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlans(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateKeywordPlansResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateKeywordPlans with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateKeywordPlans = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateKeywordPlans(request), expectedError);
            assert((client.innerApiCalls.mutateKeywordPlans as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('generateForecastCurve', () => {
        it('invokes generateForecastCurve without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GenerateForecastCurveRequest());
            request.keywordPlan = '';
            const expectedHeaderRequestParams = "keyword_plan=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.GenerateForecastCurveResponse());
            client.innerApiCalls.generateForecastCurve = stubSimpleCall(expectedResponse);
            const [response] = await client.generateForecastCurve(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.generateForecastCurve as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes generateForecastCurve without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.GenerateForecastCurveResponse());
            client.innerApiCalls.generateForecastCurve = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateForecastCurve(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IGenerateForecastCurveResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateForecastCurve with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.generateForecastCurve = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateForecastCurve(request), expectedError);
            assert((client.innerApiCalls.generateForecastCurve as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('generateForecastMetrics', () => {
        it('invokes generateForecastMetrics without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GenerateForecastMetricsRequest());
            request.keywordPlan = '';
            const expectedHeaderRequestParams = "keyword_plan=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.GenerateForecastMetricsResponse());
            client.innerApiCalls.generateForecastMetrics = stubSimpleCall(expectedResponse);
            const [response] = await client.generateForecastMetrics(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.generateForecastMetrics as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes generateForecastMetrics without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.GenerateForecastMetricsResponse());
            client.innerApiCalls.generateForecastMetrics = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateForecastMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IGenerateForecastMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateForecastMetrics with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.generateForecastMetrics = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateForecastMetrics(request), expectedError);
            assert((client.innerApiCalls.generateForecastMetrics as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('generateHistoricalMetrics', () => {
        it('invokes generateHistoricalMetrics without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GenerateHistoricalMetricsRequest());
            request.keywordPlan = '';
            const expectedHeaderRequestParams = "keyword_plan=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.GenerateHistoricalMetricsResponse());
            client.innerApiCalls.generateHistoricalMetrics = stubSimpleCall(expectedResponse);
            const [response] = await client.generateHistoricalMetrics(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.generateHistoricalMetrics as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes generateHistoricalMetrics without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.GenerateHistoricalMetricsResponse());
            client.innerApiCalls.generateHistoricalMetrics = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateHistoricalMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IGenerateHistoricalMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateHistoricalMetrics with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.generateHistoricalMetrics = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateHistoricalMetrics(request), expectedError);
            assert((client.innerApiCalls.generateHistoricalMetrics as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
