...
describe('v4.CampaignServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignserviceModule.v4.CampaignServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignserviceModule.v4.CampaignServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignserviceModule.v4.CampaignServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignserviceModule.v4.CampaignServiceClient();
        assert(client);
    });
    ...
    describe('getCampaign', () => {
        it('invokes getCampaign without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetCampaignRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.Campaign());
        ...
        it('invokes getCampaign without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaign(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ICampaign|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaigns', () => {
        it('invokes mutateCampaigns without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCampaignsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCampaignsResponse());
        ...
        it('invokes mutateCampaigns without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaigns(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateCampaignsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
