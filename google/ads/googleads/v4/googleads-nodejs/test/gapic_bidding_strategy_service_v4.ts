...
describe('v4.BiddingStrategyServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = biddingstrategyserviceModule.v4.BiddingStrategyServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = biddingstrategyserviceModule.v4.BiddingStrategyServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = biddingstrategyserviceModule.v4.BiddingStrategyServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new biddingstrategyserviceModule.v4.BiddingStrategyServiceClient();
        assert(client);
    });
    ...
    describe('getBiddingStrategy', () => {
        it('invokes getBiddingStrategy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetBiddingStrategyRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.BiddingStrategy());
        ...
        it('invokes getBiddingStrategy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBiddingStrategy(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IBiddingStrategy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateBiddingStrategies', () => {
        it('invokes mutateBiddingStrategies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateBiddingStrategiesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateBiddingStrategiesResponse());
        ...
        it('invokes mutateBiddingStrategies without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBiddingStrategies(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateBiddingStrategiesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
