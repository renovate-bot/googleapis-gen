...
import * as merchantcenterlinkserviceModule from '../src';
...
describe('v4.MerchantCenterLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = merchantcenterlinkserviceModule.v4.MerchantCenterLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = merchantcenterlinkserviceModule.v4.MerchantCenterLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = merchantcenterlinkserviceModule.v4.MerchantCenterLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new merchantcenterlinkserviceModule.v4.MerchantCenterLinkServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.merchantCenterLinkServiceStub);
    });
    ...
    describe('listMerchantCenterLinks', () => {
        it('invokes listMerchantCenterLinks without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.ListMerchantCenterLinksRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.ListMerchantCenterLinksResponse());
            client.innerApiCalls.listMerchantCenterLinks = stubSimpleCall(expectedResponse);
            const [response] = await client.listMerchantCenterLinks(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listMerchantCenterLinks as SinonStub)
        ...
        it('invokes listMerchantCenterLinks without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.ListMerchantCenterLinksResponse());
            client.innerApiCalls.listMerchantCenterLinks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listMerchantCenterLinks(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IListMerchantCenterLinksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listMerchantCenterLinks with error', async () => {
            ...
            client.innerApiCalls.listMerchantCenterLinks = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listMerchantCenterLinks(request), expectedError);
            assert((client.innerApiCalls.listMerchantCenterLinks as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getMerchantCenterLink', () => {
        it('invokes getMerchantCenterLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetMerchantCenterLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.MerchantCenterLink());
            client.innerApiCalls.getMerchantCenterLink = stubSimpleCall(expectedResponse);
            const [response] = await client.getMerchantCenterLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getMerchantCenterLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getMerchantCenterLink without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.MerchantCenterLink());
            client.innerApiCalls.getMerchantCenterLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMerchantCenterLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IMerchantCenterLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMerchantCenterLink with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.getMerchantCenterLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getMerchantCenterLink(request), expectedError);
            assert((client.innerApiCalls.getMerchantCenterLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateMerchantCenterLink', () => {
        it('invokes mutateMerchantCenterLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateMerchantCenterLinkRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateMerchantCenterLinkResponse());
            client.innerApiCalls.mutateMerchantCenterLink = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateMerchantCenterLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateMerchantCenterLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateMerchantCenterLink without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateMerchantCenterLinkResponse());
            client.innerApiCalls.mutateMerchantCenterLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateMerchantCenterLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateMerchantCenterLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateMerchantCenterLink with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateMerchantCenterLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateMerchantCenterLink(request), expectedError);
            assert((client.innerApiCalls.mutateMerchantCenterLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
