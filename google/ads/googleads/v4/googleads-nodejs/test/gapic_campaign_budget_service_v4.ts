...
describe('v4.CampaignBudgetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignbudgetserviceModule.v4.CampaignBudgetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignbudgetserviceModule.v4.CampaignBudgetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignbudgetserviceModule.v4.CampaignBudgetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignbudgetserviceModule.v4.CampaignBudgetServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignBudget', () => {
        it('invokes getCampaignBudget without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetCampaignBudgetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.CampaignBudget());
        ...
        it('invokes getCampaignBudget without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignBudget(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ICampaignBudget|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignBudgets', () => {
        it('invokes mutateCampaignBudgets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse());
        ...
        it('invokes mutateCampaignBudgets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignBudgets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateCampaignBudgetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
