...
describe('v4.AdGroupAdLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupadlabelserviceModule.v4.AdGroupAdLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupadlabelserviceModule.v4.AdGroupAdLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupadlabelserviceModule.v4.AdGroupAdLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupadlabelserviceModule.v4.AdGroupAdLabelServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupAdLabel', () => {
        it('invokes getAdGroupAdLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetAdGroupAdLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdGroupAdLabel());
        ...
        it('invokes getAdGroupAdLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAdLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IAdGroupAdLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupAdLabels', () => {
        it('invokes mutateAdGroupAdLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdGroupAdLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdGroupAdLabelsResponse());
        ...
        it('invokes mutateAdGroupAdLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupAdLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateAdGroupAdLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
