...
import * as adserviceModule from '../src';
...
describe('v4.AdServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adserviceModule.v4.AdServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adserviceModule.v4.AdServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adserviceModule.v4.AdServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adserviceModule.v4.AdServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adServiceStub, undefined);
        await client.initialize();
        assert(client.adServiceStub);
    });
    ...
    describe('getAd', () => {
        it('invokes getAd without error', async () => {
            const client = new adserviceModule.v4.AdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetAdRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.Ad());
            client.innerApiCalls.getAd = stubSimpleCall(expectedResponse);
            const [response] = await client.getAd(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAd as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAd without error using callback', async () => {
            const client = new adserviceModule.v4.AdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.Ad());
            client.innerApiCalls.getAd = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAd(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IAd|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAd with error', async () => {
            const client = new adserviceModule.v4.AdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAd = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAd(request), expectedError);
            assert((client.innerApiCalls.getAd as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateAds', () => {
        it('invokes mutateAds without error', async () => {
            const client = new adserviceModule.v4.AdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdsResponse());
            client.innerApiCalls.mutateAds = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAds(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAds without error using callback', async () => {
            const client = new adserviceModule.v4.AdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdsResponse());
            client.innerApiCalls.mutateAds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateAdsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAds with error', async () => {
            const client = new adserviceModule.v4.AdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAds = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAds(request), expectedError);
            assert((client.innerApiCalls.mutateAds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
