...
import * as locationviewserviceModule from '../src';
...
describe('v4.LocationViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = locationviewserviceModule.v4.LocationViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = locationviewserviceModule.v4.LocationViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = locationviewserviceModule.v4.LocationViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new locationviewserviceModule.v4.LocationViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.locationViewServiceStub, undefined);
        await client.initialize();
        assert(client.locationViewServiceStub);
    });
    ...
    describe('getLocationView', () => {
        it('invokes getLocationView without error', async () => {
            const client = new locationviewserviceModule.v4.LocationViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetLocationViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.LocationView());
            client.innerApiCalls.getLocationView = stubSimpleCall(expectedResponse);
            const [response] = await client.getLocationView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getLocationView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getLocationView without error using callback', async () => {
            const client = new locationviewserviceModule.v4.LocationViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.LocationView());
            client.innerApiCalls.getLocationView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getLocationView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ILocationView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getLocationView with error', async () => {
            const client = new locationviewserviceModule.v4.LocationViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getLocationView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getLocationView(request), expectedError);
            assert((client.innerApiCalls.getLocationView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
