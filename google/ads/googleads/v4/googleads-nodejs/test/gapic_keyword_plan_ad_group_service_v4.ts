...
describe('v4.KeywordPlanAdGroupServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanadgroupserviceModule.v4.KeywordPlanAdGroupServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanadgroupserviceModule.v4.KeywordPlanAdGroupServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanadgroupserviceModule.v4.KeywordPlanAdGroupServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplanadgroupserviceModule.v4.KeywordPlanAdGroupServiceClient();
        assert(client);
    });
    ...
    describe('getKeywordPlanAdGroup', () => {
        it('invokes getKeywordPlanAdGroup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetKeywordPlanAdGroupRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.KeywordPlanAdGroup());
        ...
        it('invokes getKeywordPlanAdGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanAdGroup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IKeywordPlanAdGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateKeywordPlanAdGroups', () => {
        it('invokes mutateKeywordPlanAdGroups without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateKeywordPlanAdGroupsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateKeywordPlanAdGroupsResponse());
        ...
        it('invokes mutateKeywordPlanAdGroups without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanAdGroups(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateKeywordPlanAdGroupsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
