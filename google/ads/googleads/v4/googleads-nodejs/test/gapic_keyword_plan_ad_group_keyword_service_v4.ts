...
describe('v4.KeywordPlanAdGroupKeywordServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanadgroupkeywordserviceModule.v4.KeywordPlanAdGroupKeywordServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanadgroupkeywordserviceModule.v4.KeywordPlanAdGroupKeywordServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanadgroupkeywordserviceModule.v4.KeywordPlanAdGroupKeywordServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplanadgroupkeywordserviceModule.v4.KeywordPlanAdGroupKeywordServiceClient();
        assert(client);
    });
    ...
    describe('getKeywordPlanAdGroupKeyword', () => {
        it('invokes getKeywordPlanAdGroupKeyword without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetKeywordPlanAdGroupKeywordRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.KeywordPlanAdGroupKeyword());
        ...
        it('invokes getKeywordPlanAdGroupKeyword without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanAdGroupKeyword(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IKeywordPlanAdGroupKeyword|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateKeywordPlanAdGroupKeywords', () => {
        it('invokes mutateKeywordPlanAdGroupKeywords without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateKeywordPlanAdGroupKeywordsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateKeywordPlanAdGroupKeywordsResponse());
        ...
        it('invokes mutateKeywordPlanAdGroupKeywords without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanAdGroupKeywords(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateKeywordPlanAdGroupKeywordsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
