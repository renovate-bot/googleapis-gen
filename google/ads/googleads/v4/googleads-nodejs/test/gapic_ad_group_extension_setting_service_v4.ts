...
import * as adgroupextensionsettingserviceModule from '../src';
...
describe('v4.AdGroupExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupextensionsettingserviceModule.v4.AdGroupExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupextensionsettingserviceModule.v4.AdGroupExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupextensionsettingserviceModule.v4.AdGroupExtensionSettingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupextensionsettingserviceModule.v4.AdGroupExtensionSettingServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupExtensionSettingServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupExtensionSettingServiceStub);
    });
    ...
    describe('getAdGroupExtensionSetting', () => {
        it('invokes getAdGroupExtensionSetting without error', async () => {
            const client = new adgroupextensionsettingserviceModule.v4.AdGroupExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetAdGroupExtensionSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdGroupExtensionSetting());
            client.innerApiCalls.getAdGroupExtensionSetting = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupExtensionSetting(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupExtensionSetting as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupExtensionSetting without error using callback', async () => {
            const client = new adgroupextensionsettingserviceModule.v4.AdGroupExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.AdGroupExtensionSetting());
            client.innerApiCalls.getAdGroupExtensionSetting = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.IAdGroupExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupExtensionSetting with error', async () => {
            const client = new adgroupextensionsettingserviceModule.v4.AdGroupExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdGroupExtensionSetting = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupExtensionSetting(request), expectedError);
            assert((client.innerApiCalls.getAdGroupExtensionSetting as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAdGroupExtensionSettings', () => {
        it('invokes mutateAdGroupExtensionSettings without error', async () => {
            const client = new adgroupextensionsettingserviceModule.v4.AdGroupExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsResponse());
            client.innerApiCalls.mutateAdGroupExtensionSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupExtensionSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupExtensionSettings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroupExtensionSettings without error using callback', async () => {
            const client = new adgroupextensionsettingserviceModule.v4.AdGroupExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateAdGroupExtensionSettingsResponse());
            client.innerApiCalls.mutateAdGroupExtensionSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateAdGroupExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupExtensionSettings with error', async () => {
            const client = new adgroupextensionsettingserviceModule.v4.AdGroupExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdGroupExtensionSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupExtensionSettings(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupExtensionSettings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
