...
describe('v4.CampaignExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignextensionsettingserviceModule.v4.CampaignExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignextensionsettingserviceModule.v4.CampaignExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignextensionsettingserviceModule.v4.CampaignExtensionSettingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignextensionsettingserviceModule.v4.CampaignExtensionSettingServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignExtensionSetting', () => {
        it('invokes getCampaignExtensionSetting without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.resources.CampaignExtensionSetting());
        ...
        it('invokes getCampaignExtensionSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.resources.ICampaignExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignExtensionSettings', () => {
        it('invokes mutateCampaignExtensionSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse());
        ...
        it('invokes mutateCampaignExtensionSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v4.services.IMutateCampaignExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
