...
class googleadsCallTransformer(cst.CSTTransformer):
    ...
    'mutate': ('customer_id', 'mutate_operations', 'partial_failure', 'validate_only', ),
    ...
    'mutate_ad_group_ads': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_ad_group_bid_modifiers': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_ad_group_criteria': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    ...
    'mutate_ad_group_feeds': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_ad_group_labels': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_ad_groups': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_ad_parameters': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_ads': ('customer_id', 'operations', ),
    'mutate_assets': ('customer_id', 'operations', ),
    ...
    'mutate_campaign_budgets': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_campaign_criteria': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_campaign_drafts': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_campaign_experiments': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_campaign_extension_settings': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_campaign_feeds': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_campaign_labels': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_campaigns': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    ...
    'mutate_customer': ('customer_id', 'operation', 'validate_only', ),
    ...
    'mutate_customer_feeds': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    ...
    'mutate_extension_feed_items': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_feed_items': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_feed_item_targets': ('customer_id', 'operations', ),
    'mutate_feed_mappings': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_feeds': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    ...
    'mutate_labels': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    'mutate_media_files': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    ...
    'mutate_shared_sets': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
