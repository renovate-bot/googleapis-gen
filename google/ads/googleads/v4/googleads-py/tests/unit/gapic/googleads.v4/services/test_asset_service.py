...
from google.ads.googleads.v4.services.services.asset_service import AssetServiceClient
from google.ads.googleads.v4.services.services.asset_service import transports
...
def test_asset_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.asset_service.AssetServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v4.services.services.asset_service.transports.AssetServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_asset(transport: str = 'grpc', request_type=asset_service.GetAssetRequest):
    ...
    with mock.patch.object(
        ...
        call.return_value = asset.Asset(
            ...
            youtube_video_asset=asset_types.YoutubeVideoAsset(youtube_video_id=wrappers_pb2.StringValue(value='value_value')),
        )
...
def test_mutate_assets_flattened():
    ...
    with mock.patch.object(
        ...
        client.mutate_assets(
            ...
            operations=[asset_service.AssetOperation(create=asset.Asset(resource_name='resource_name_value'))],
        )
        ...
        assert args[0].operations == [asset_service.AssetOperation(create=asset.Asset(resource_name='resource_name_value'))]
...
def test_asset_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.asset_service.transports.AssetServiceTransport.__init__') as Transport:
...
def test_asset_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v4.services.services.asset_service.transports.AssetServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AssetServiceTransport()
        adc.assert_called_once()
...
def test_asset_path():
    ...
    actual = AssetServiceClient.asset_path(customer, asset)
