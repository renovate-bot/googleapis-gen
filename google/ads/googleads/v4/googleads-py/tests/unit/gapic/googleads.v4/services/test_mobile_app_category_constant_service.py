...
from google.ads.googleads.v4.services.services.mobile_app_category_constant_service import MobileAppCategoryConstantServiceClient
from google.ads.googleads.v4.services.services.mobile_app_category_constant_service import transports
...
def test_mobile_app_category_constant_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.mobile_app_category_constant_service.MobileAppCategoryConstantServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v4.services.services.mobile_app_category_constant_service.transports.MobileAppCategoryConstantServiceGrpcTransport.__init__') as grpc_transport:
...
def test_mobile_app_category_constant_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.mobile_app_category_constant_service.transports.MobileAppCategoryConstantServiceTransport.__init__') as Transport:
...
def test_mobile_app_category_constant_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v4.services.services.mobile_app_category_constant_service.transports.MobileAppCategoryConstantServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MobileAppCategoryConstantServiceTransport()
        adc.assert_called_once()
