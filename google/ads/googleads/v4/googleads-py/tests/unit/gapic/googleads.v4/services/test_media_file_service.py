...
from google.ads.googleads.v4.services.services.media_file_service import MediaFileServiceClient
from google.ads.googleads.v4.services.services.media_file_service import transports
...
def test_media_file_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.media_file_service.MediaFileServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v4.services.services.media_file_service.transports.MediaFileServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_media_file(transport: str = 'grpc', request_type=media_file_service.GetMediaFileRequest):
    ...
    with mock.patch.object(
        ...
        call.return_value = media_file.MediaFile(
            ...
            image=media_file.MediaImage(data=wrappers.BytesValue(value=b'value_blob')),
        )
...
def test_media_file_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.media_file_service.transports.MediaFileServiceTransport.__init__') as Transport:
...
def test_media_file_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.ads.googleads.v4.services.services.media_file_service.transports.MediaFileServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.MediaFileServiceTransport()
        adc.assert_called_once()
