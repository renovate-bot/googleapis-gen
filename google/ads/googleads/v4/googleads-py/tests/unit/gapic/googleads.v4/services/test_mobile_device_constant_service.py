...
from google.ads.googleads.v4.services.services.mobile_device_constant_service import transports
...
def test_mobile_device_constant_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.mobile_device_constant_service.transports.MobileDeviceConstantServiceGrpcTransport.__init__') as grpc_transport:
