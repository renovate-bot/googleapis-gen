...
def test_conversion_upload_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.conversion_upload_service.transports.ConversionUploadServiceGrpcTransport.__init__') as grpc_transport:
