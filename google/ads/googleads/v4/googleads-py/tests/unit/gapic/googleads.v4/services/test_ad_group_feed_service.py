...
from google.ads.googleads.v4.services.services.ad_group_feed_service import AdGroupFeedServiceClient
from google.ads.googleads.v4.services.services.ad_group_feed_service import transports
...
def test_ad_group_feed_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.ad_group_feed_service.AdGroupFeedServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v4.services.services.ad_group_feed_service.transports.AdGroupFeedServiceGrpcTransport.__init__') as grpc_transport:
...
def test_ad_group_feed_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.ad_group_feed_service.transports.AdGroupFeedServiceTransport.__init__') as Transport:
...
def test_ad_group_feed_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v4.services.services.ad_group_feed_service.transports.AdGroupFeedServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AdGroupFeedServiceTransport()
        adc.assert_called_once()
