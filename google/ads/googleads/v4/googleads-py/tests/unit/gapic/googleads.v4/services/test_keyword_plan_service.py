...
from google.ads.googleads.v4.services.services.keyword_plan_service import KeywordPlanServiceClient
from google.ads.googleads.v4.services.services.keyword_plan_service import transports
...
def test_keyword_plan_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.keyword_plan_service.KeywordPlanServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v4.services.services.keyword_plan_service.transports.KeywordPlanServiceGrpcTransport.__init__') as grpc_transport:
...
def test_keyword_plan_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.keyword_plan_service.transports.KeywordPlanServiceTransport.__init__') as Transport:
...
def test_keyword_plan_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v4.services.services.keyword_plan_service.transports.KeywordPlanServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.KeywordPlanServiceTransport()
        adc.assert_called_once()
