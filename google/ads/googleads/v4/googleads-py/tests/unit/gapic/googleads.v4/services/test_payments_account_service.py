...
from google.ads.googleads.v4.resources.types import payments_account
from google.ads.googleads.v4.services.services.payments_account_service import PaymentsAccountServiceClient
from google.ads.googleads.v4.services.services.payments_account_service import transports
from google.ads.googleads.v4.services.types import payments_account_service
...
def test_payments_account_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.payments_account_service.PaymentsAccountServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v4.services.services.payments_account_service.transports.PaymentsAccountServiceGrpcTransport.__init__') as grpc_transport:
...
def test_payments_account_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.payments_account_service.transports.PaymentsAccountServiceTransport.__init__') as Transport:
...
def test_payments_account_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v4.services.services.payments_account_service.transports.PaymentsAccountServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PaymentsAccountServiceTransport()
        adc.assert_called_once()
