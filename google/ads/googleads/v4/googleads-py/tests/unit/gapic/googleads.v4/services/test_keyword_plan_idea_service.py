...
from google.ads.googleads.v4.services.services.keyword_plan_idea_service import transports
...
def test_keyword_plan_idea_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.keyword_plan_idea_service.transports.KeywordPlanIdeaServiceGrpcTransport.__init__') as grpc_transport:
