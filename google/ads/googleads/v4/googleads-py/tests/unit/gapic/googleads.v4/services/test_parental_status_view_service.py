...
def test_parental_status_view_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.parental_status_view_service.transports.ParentalStatusViewServiceGrpcTransport.__init__') as grpc_transport:
