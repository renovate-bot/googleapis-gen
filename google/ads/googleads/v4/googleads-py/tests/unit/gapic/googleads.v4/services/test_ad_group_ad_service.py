...
from google.ads.googleads.v4.services.services.ad_group_ad_service import AdGroupAdServiceClient
from google.ads.googleads.v4.services.services.ad_group_ad_service import transports
...
def test_ad_group_ad_service_client_from_service_account_info():
    creds = credentials.AnonymousCredentials()
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        factory.return_value = creds
        info = {"valid": True}
        client = AdGroupAdServiceClient.from_service_account_info(info)
        assert client.transport._credentials == creds

        assert client.transport._host == 'googleads.googleapis.com:443'


def test_ad_group_ad_service_client_from_service_account_file():
    creds = credentials.AnonymousCredentials()
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        factory.return_value = creds
        client = AdGroupAdServiceClient.from_service_account_file("dummy/file/path.json")
        assert client.transport._credentials == creds

        client = AdGroupAdServiceClient.from_service_account_json("dummy/file/path.json")
        assert client.transport._credentials == creds
...
def test_ad_group_ad_service_client_client_options():
    # Check that if channel is provided we won't create a new one.
    with mock.patch('google.ads.googleads.v4.services.services.ad_group_ad_service.AdGroupAdServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v4.services.services.ad_group_ad_service.AdGroupAdServiceClient.get_transport_class') as gtc:
        client = AdGroupAdServiceClient(transport="grpc")
        gtc.assert_called()

    # Check the case api_endpoint is provided.
    options = client_options.ClientOptions(api_endpoint="squid.clam.whelk")
    with mock.patch('google.ads.googleads.v4.services.services.ad_group_ad_service.transports.AdGroupAdServiceGrpcTransport.__init__') as grpc_transport:
        grpc_transport.return_value = None
        client = AdGroupAdServiceClient(client_options=options)
...
def test_ad_group_ad_service_client_mtls_env_auto(use_client_cert_env):
...
def test_get_ad_group_ad(transport: str = 'grpc', request_type=ad_group_ad_service.GetAdGroupAdRequest):
    client = AdGroupAdServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_ad_group_ad_from_dict():
    test_get_ad_group_ad(request_type=dict)
...
def test_mutate_ad_group_ads(transport: str = 'grpc', request_type=ad_group_ad_service.MutateAdGroupAdsRequest):
    client = AdGroupAdServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_ad_group_ads_from_dict():
    test_mutate_ad_group_ads(request_type=dict)
...
def test_mutate_ad_group_ads_flattened():
    ...
    with mock.patch.object(
        ...
        client.mutate_ad_group_ads(
            ...
            operations=[ad_group_ad_service.AdGroupAdOperation(update_mask=field_mask.FieldMask(paths=['paths_value']))],
        )
        ...
        assert args[0].operations == [ad_group_ad_service.AdGroupAdOperation(update_mask=field_mask.FieldMask(paths=['paths_value']))]
...
def test_ad_group_ad_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v4.services.services.ad_group_ad_service.transports.AdGroupAdServiceTransport.__init__') as Transport:
...
def test_ad_group_ad_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.ads.googleads.v4.services.services.ad_group_ad_service.transports.AdGroupAdServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.AdGroupAdServiceTransport()
        adc.assert_called_once()
...
def test_ad_group_ad_service_transport_auth_adc():
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, 'default') as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.AdGroupAdServiceGrpcTransport(host="squid.clam.whelk")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/adwords',
        ))
...
@pytest.mark.parametrize("transport_class", [transports.AdGroupAdServiceGrpcTransport])
...
def test_ad_path():
    ...
    actual = AdGroupAdServiceClient.ad_path(customer, ad)
