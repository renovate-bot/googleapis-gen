...
from google.ads.googleads.v4.resources.types import dynamic_search_ads_search_term_view
from google.ads.googleads.v4.services.types import dynamic_search_ads_search_term_view_service
...
class DynamicSearchAdsSearchTermViewServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[DynamicSearchAdsSearchTermViewServiceTransport]]
    _transport_registry['grpc'] = DynamicSearchAdsSearchTermViewServiceGrpcTransport
...
class DynamicSearchAdsSearchTermViewServiceClient(metaclass=DynamicSearchAdsSearchTermViewServiceClientMeta):
    ...
    @staticmethod
    def dynamic_search_ads_search_term_view_path(customer: str,dynamic_search_ads_search_term_view: str,) -> str:
        """Return a fully-qualified dynamic_search_ads_search_term_view string."""
        return "customers/{customer}/dynamicSearchAdsSearchTermViews/{dynamic_search_ads_search_term_view}".format(customer=customer, dynamic_search_ads_search_term_view=dynamic_search_ads_search_term_view, )
    ...
    def __init__(self, *,
            ...
            transport: Union[str, DynamicSearchAdsSearchTermViewServiceTransport, None] = None,
        ...
        if isinstance(transport, DynamicSearchAdsSearchTermViewServiceTransport):
    ...
    def get_dynamic_search_ads_search_term_view(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetDynamicSearchAdsSearchTermViewRequest`):
                The request object. Request message for
                [DynamicSearchAdsSearchTermViewService.GetDynamicSearchAdsSearchTermView][google.ads.googleads.v4.services.DynamicSearchAdsSearchTermViewService.GetDynamicSearchAdsSearchTermView].
        ...
        Returns:
            google.ads.googleads.v4.resources.types.DynamicSearchAdsSearchTermView:
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_dynamic_search_ads_search_term_view]
