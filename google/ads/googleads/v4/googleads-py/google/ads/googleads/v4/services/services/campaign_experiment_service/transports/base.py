...
class CampaignExperimentServiceTransport(metaclass=abc.ABCMeta):
    ...
    @property
    def graduate_campaign_experiment(self) -> typing.Callable[
    ...
    @property
    def promote_campaign_experiment(self) -> typing.Callable[
            [campaign_experiment_service.PromoteCampaignExperimentRequest],
            operations_pb2.Operation]:
        raise NotImplementedError

    @property
    def end_campaign_experiment(self) -> typing.Callable[
            [campaign_experiment_service.EndCampaignExperimentRequest],
            empty_pb2.Empty]:
        raise NotImplementedError

    @property
    def list_campaign_experiment_async_errors(self) -> typing.Callable[
