...
from google.ads.googleads.v4.services.services.google_ads_field_service import pagers
...
class GoogleAdsFieldServiceClient(metaclass=GoogleAdsFieldServiceClientMeta):
    ...
    def get_google_ads_field(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetGoogleAdsFieldRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.GoogleAdsField:
    ...
    def search_google_ads_fields(self,
        ...
        Returns:
            google.ads.googleads.v4.services.services.google_ads_field_service.pagers.SearchGoogleAdsFieldsPager:
