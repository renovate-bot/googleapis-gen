...
class MutateLabelsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            being modified.
        operations (Sequence[google.ads.googleads.v4.services.types.LabelOperation]):
...
class LabelOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v4.resources.types.Label):
            Create operation: No resource name is
            expected for the new label.
        update (google.ads.googleads.v4.resources.types.Label):
...
class MutateLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v4.services.types.MutateLabelResult]):
