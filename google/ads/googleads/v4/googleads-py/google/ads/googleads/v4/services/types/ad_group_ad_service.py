...
class GetAdGroupAdRequest(proto.Message):
    ...
    [AdGroupAdService.GetAdGroupAd][google.ads.googleads.v4.services.AdGroupAdService.GetAdGroupAd].
...
class MutateAdGroupAdsRequest(proto.Message):
    r"""Request message for
    [AdGroupAdService.MutateAdGroupAds][google.ads.googleads.v4.services.AdGroupAdService.MutateAdGroupAds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ads
            are being modified.
        operations (Sequence[google.ads.googleads.v4.services.types.AdGroupAdOperation]):
...
class AdGroupAdOperation(proto.Message):
    ...
    Attributes:
        ...
        policy_validation_parameter (google.ads.googleads.v4.common.types.PolicyValidationParameter):
            Configuration for how policies are validated.
        create (google.ads.googleads.v4.resources.types.AdGroupAd):
            Create operation: No resource name is
            expected for the new ad.
        update (google.ads.googleads.v4.resources.types.AdGroupAd):
...
class MutateAdGroupAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v4.services.types.MutateAdGroupAdResult]):
