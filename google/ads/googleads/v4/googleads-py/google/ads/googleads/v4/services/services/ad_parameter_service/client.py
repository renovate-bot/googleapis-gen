...
class AdParameterServiceClient(metaclass=AdParameterServiceClientMeta):
    ...
    def get_ad_parameter(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAdParameterRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AdParameter:
    ...
    def mutate_ad_parameters(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateAdParametersRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.AdParameterOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateAdParametersResponse:
