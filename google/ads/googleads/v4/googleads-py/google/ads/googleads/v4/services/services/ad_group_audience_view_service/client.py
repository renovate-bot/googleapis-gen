...
from google.ads.googleads.v4.resources.types import ad_group_audience_view
from google.ads.googleads.v4.services.types import ad_group_audience_view_service
...
class AdGroupAudienceViewServiceClient(metaclass=AdGroupAudienceViewServiceClientMeta):
    ...
    def get_ad_group_audience_view(self,
        ...
        r"""Returns the requested ad group audience view in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAdGroupAudienceViewRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AdGroupAudienceView:
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_ad_group_audience_view]
