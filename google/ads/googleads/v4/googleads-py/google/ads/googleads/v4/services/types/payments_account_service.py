...
class ListPaymentsAccountsResponse(proto.Message):
    ...
    [PaymentsAccountService.ListPaymentsAccounts][google.ads.googleads.v4.services.PaymentsAccountService.ListPaymentsAccounts].

    Attributes:
        payments_accounts (Sequence[google.ads.googleads.v4.resources.types.PaymentsAccount]):
