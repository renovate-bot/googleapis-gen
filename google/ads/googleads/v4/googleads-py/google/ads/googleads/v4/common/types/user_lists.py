...
class SimilarUserListInfo(proto.Message):
    ...
    Attributes:
        seed_user_list (google.protobuf.wrappers_pb2.StringValue):
...
class CrmBasedUserListInfo(proto.Message):
    ...
    Attributes:
        ...
        upload_key_type (google.ads.googleads.v4.enums.types.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType):
            Matching key type of the list.
            Mixed data types are not allowed on the same
            list. This field is required for an ADD
            operation.
        data_source_type (google.ads.googleads.v4.enums.types.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType):
...
class UserListRuleInfo(proto.Message):
    ...
    Attributes:
        rule_type (google.ads.googleads.v4.enums.types.UserListRuleTypeEnum.UserListRuleType):
        ...
        rule_item_groups (Sequence[google.ads.googleads.v4.common.types.UserListRuleItemGroupInfo]):
...
class UserListRuleItemInfo(proto.Message):
    ...
    Attributes:
        ...
        number_rule_item (google.ads.googleads.v4.common.types.UserListNumberRuleItemInfo):
            An atomic rule item composed of a number
            operation.
        string_rule_item (google.ads.googleads.v4.common.types.UserListStringRuleItemInfo):
            An atomic rule item composed of a string
            operation.
        date_rule_item (google.ads.googleads.v4.common.types.UserListDateRuleItemInfo):
...
class UserListDateRuleItemInfo(proto.Message):
    ...
    Attributes:
        ...
        value (google.protobuf.wrappers_pb2.StringValue):
            ...
            time zone.
        offset_in_days (google.protobuf.wrappers_pb2.Int64Value):
...
class CombinedRuleUserListInfo(proto.Message):
    ...
    Attributes:
        left_operand (google.ads.googleads.v4.common.types.UserListRuleInfo):
            Left operand of the combined rule.
            This field is required and must be populated
            when creating new combined rule based user list.
        right_operand (google.ads.googleads.v4.common.types.UserListRuleInfo):
            Right operand of the combined rule.
            This field is required and must be populated
            when creating new combined rule based user list.
        rule_operator (google.ads.googleads.v4.enums.types.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator):
...
class DateSpecificRuleUserListInfo(proto.Message):
    ...
    Attributes:
        ...
        end_date (google.protobuf.wrappers_pb2.StringValue):
            ...
            includes all users after start_date. The date's format
            should be YYYY-MM-DD.
...
class RuleBasedUserListInfo(proto.Message):
    ...
    Attributes:
        prepopulation_status (google.ads.googleads.v4.enums.types.UserListPrepopulationStatusEnum.UserListPrepopulationStatus):
            ...
            request fails.
        combined_rule_user_list (google.ads.googleads.v4.common.types.CombinedRuleUserListInfo):
            ...
            is false.
        date_specific_rule_user_list (google.ads.googleads.v4.common.types.DateSpecificRuleUserListInfo):
        ...
        expression_rule_user_list (google.ads.googleads.v4.common.types.ExpressionRuleUserListInfo):
...
class LogicalUserListInfo(proto.Message):
    ...
    Attributes:
        rules (Sequence[google.ads.googleads.v4.common.types.UserListLogicalRuleInfo]):
...
class UserListLogicalRuleInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v4.enums.types.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator):
            The logical operator of the rule.
        rule_operands (Sequence[google.ads.googleads.v4.common.types.LogicalUserListOperandInfo]):
...
class BasicUserListInfo(proto.Message):
    ...
    Attributes:
        actions (Sequence[google.ads.googleads.v4.common.types.UserListActionInfo]):
...
class UserListActionInfo(proto.Message):
    ...
    Attributes:
        conversion_action (google.protobuf.wrappers_pb2.StringValue):
            ...
            remarketing.
        remarketing_action (google.protobuf.wrappers_pb2.StringValue):
