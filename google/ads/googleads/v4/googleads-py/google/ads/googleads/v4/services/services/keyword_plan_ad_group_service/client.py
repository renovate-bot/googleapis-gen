...
class KeywordPlanAdGroupServiceClient(metaclass=KeywordPlanAdGroupServiceClientMeta):
    ...
    def get_keyword_plan_ad_group(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetKeywordPlanAdGroupRequest`):
                The request object. Request message for
                [KeywordPlanAdGroupService.GetKeywordPlanAdGroup][google.ads.googleads.v4.services.KeywordPlanAdGroupService.GetKeywordPlanAdGroup].
        ...
        Returns:
            google.ads.googleads.v4.resources.types.KeywordPlanAdGroup:
    ...
    def mutate_keyword_plan_ad_groups(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateKeywordPlanAdGroupsRequest`):
                The request object. Request message for
                [KeywordPlanAdGroupService.MutateKeywordPlanAdGroups][google.ads.googleads.v4.services.KeywordPlanAdGroupService.MutateKeywordPlanAdGroups].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.KeywordPlanAdGroupOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateKeywordPlanAdGroupsResponse:
