...
class GetUserListRequest(proto.Message):
    ...
    [UserListService.GetUserList][google.ads.googleads.v4.services.UserListService.GetUserList].
...
class MutateUserListsRequest(proto.Message):
    r"""Request message for
    [UserListService.MutateUserLists][google.ads.googleads.v4.services.UserListService.MutateUserLists].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose user
            lists are being modified.
        operations (Sequence[google.ads.googleads.v4.services.types.UserListOperation]):
...
class UserListOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v4.resources.types.UserList):
            Create operation: No resource name is
            expected for the new user list.
        update (google.ads.googleads.v4.resources.types.UserList):
...
class MutateUserListsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v4.services.types.MutateUserListResult]):
