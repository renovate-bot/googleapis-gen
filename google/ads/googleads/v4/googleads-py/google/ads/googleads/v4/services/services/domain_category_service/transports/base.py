...
from google.ads.googleads.v4.resources.types import domain_category
from google.ads.googleads.v4.services.types import domain_category_service
...
class DomainCategoryServiceTransport(metaclass=abc.ABCMeta):
    ...
    @property
    def get_domain_category(self) -> typing.Callable[
