...
from .transports.base import ExtensionFeedItemServiceTransport, DEFAULT_CLIENT_INFO
...
class ExtensionFeedItemServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ExtensionFeedItemServiceTransport]]
...
class ExtensionFeedItemServiceClient(metaclass=ExtensionFeedItemServiceClientMeta):
    ...
    def get_extension_feed_item(self,
        ...
        r"""Returns the requested extension feed item in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetExtensionFeedItemRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v4.resources.types.ExtensionFeedItem:
        ...
        if not isinstance(request, extension_feed_item_service.GetExtensionFeedItemRequest):
            request = extension_feed_item_service.GetExtensionFeedItemRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_extension_feed_item]
    ...
    def mutate_extension_feed_items(self,
        ...
        r"""Creates, updates, or removes extension feed items.
        Operation statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateExtensionFeedItemsRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.ExtensionFeedItemOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateExtensionFeedItemsResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, extension_feed_item_service.MutateExtensionFeedItemsRequest):
            request = extension_feed_item_service.MutateExtensionFeedItemsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_extension_feed_items]
