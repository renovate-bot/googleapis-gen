...
class CustomerNegativeCriterionServiceGrpcTransport(CustomerNegativeCriterionServiceTransport):
    ...
    def get_customer_negative_criterion(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetCustomerNegativeCriterionRequest],
        ...
        if 'get_customer_negative_criterion' not in self._stubs:
            self._stubs['get_customer_negative_criterion'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v4.services.CustomerNegativeCriterionService/GetCustomerNegativeCriterion',
                request_serializer=customer_negative_criterion_service.GetCustomerNegativeCriterionRequest.serialize,
                response_deserializer=customer_negative_criterion.CustomerNegativeCriterion.deserialize,
            )
        return self._stubs['get_customer_negative_criterion']
    ...
    def mutate_customer_negative_criteria(self) -> Callable[
        ...
        if 'mutate_customer_negative_criteria' not in self._stubs:
            self._stubs['mutate_customer_negative_criteria'] = self.grpc_channel.unary_unary(
