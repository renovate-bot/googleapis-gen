...
class MutateCustomInterestsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v4.services.types.CustomInterestOperation]):
...
class CustomInterestOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v4.resources.types.CustomInterest):
            Create operation: No resource name is
            expected for the new custom interest.
        update (google.ads.googleads.v4.resources.types.CustomInterest):
...
class MutateCustomInterestsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v4.services.types.MutateCustomInterestResult]):
