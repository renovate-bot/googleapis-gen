...
from google.ads.googleads.v4.resources.types import customer_client
from google.ads.googleads.v4.services.types import customer_client_service
...
class CustomerClientServiceClientMeta(type):
    """Metaclass for the CustomerClientService client.
...
class CustomerClientServiceClient(metaclass=CustomerClientServiceClientMeta):
    ...
    def transport(self) -> CustomerClientServiceTransport:
        ...
        Returns:
            CustomerClientServiceTransport: The transport used by the client instance.
        """
    ...
    def customer_client_path(customer: str,customer_client: str,) -> str:
        ...
        return "customers/{customer}/customerClients/{customer_client}".format(customer=customer, customer_client=customer_client, )

    @staticmethod
    def parse_customer_client_path(path: str) -> Dict[str,str]:
        """Parse a customer_client path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/customerClients/(?P<customer_client>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def __init__(self, *,
        ...
        """Instantiate the customer client service client.
        ...
        Args:
            ...
            transport (Union[str, ~.CustomerClientServiceTransport]): The
        ...
        if isinstance(transport, CustomerClientServiceTransport):
            # transport is a CustomerClientServiceTransport instance.
            if credentials:
    ...
    def get_customer_client(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetCustomerClientRequest`):
                The request object.
                Request message for
                [CustomerClientService.GetCustomerClient][google.ads.googleads.v4.services.CustomerClientService.GetCustomerClient].
        ...
        Returns:
            google.ads.googleads.v4.resources.types.CustomerClient:
        ...
        if not isinstance(request, customer_client_service.GetCustomerClientRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_customer_client]
