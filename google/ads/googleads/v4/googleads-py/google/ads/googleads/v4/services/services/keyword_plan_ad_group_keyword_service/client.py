...
class KeywordPlanAdGroupKeywordServiceClient(metaclass=KeywordPlanAdGroupKeywordServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, KeywordPlanAdGroupKeywordServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the keyword plan ad group keyword service client.
        ...
        if isinstance(transport, KeywordPlanAdGroupKeywordServiceTransport):
            ...
            self._transport = KeywordPlanAdGroupKeywordServiceGrpcTransport(
    ...
    def get_keyword_plan_ad_group_keyword(self,
            request: keyword_plan_ad_group_keyword_service.GetKeywordPlanAdGroupKeywordRequest = None,
            *,
        ...
        r"""Returns the requested Keyword Plan ad group keyword
        in full detail.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetKeywordPlanAdGroupKeywordRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.KeywordPlanAdGroupKeyword:
                A Keyword Plan ad group keyword.
                Max number of keyword plan keywords per
                plan: 10000.
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_keyword_plan_ad_group_keyword]
    ...
    def mutate_keyword_plan_ad_group_keywords(self,
            request: keyword_plan_ad_group_keyword_service.MutateKeywordPlanAdGroupKeywordsRequest = None,
            *,
            customer_id: str = None,
            operations: Sequence[keyword_plan_ad_group_keyword_service.KeywordPlanAdGroupKeywordOperation] = None,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> keyword_plan_ad_group_keyword_service.MutateKeywordPlanAdGroupKeywordsResponse:
        r"""Creates, updates, or removes Keyword Plan ad group
        keywords. Operation statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateKeywordPlanAdGroupKeywordsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.KeywordPlanAdGroupKeywordOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateKeywordPlanAdGroupKeywordsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_keyword_plan_ad_group_keywords]
