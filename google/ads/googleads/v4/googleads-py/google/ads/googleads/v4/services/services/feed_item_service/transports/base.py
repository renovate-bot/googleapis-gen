...
class FeedItemServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for FeedItemService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_feed_item: gapic_v1.method.wrap_method(
                self.get_feed_item,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_feed_items: gapic_v1.method.wrap_method(
                self.mutate_feed_items,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    @property
    def get_feed_item(self) -> typing.Callable[
            [feed_item_service.GetFeedItemRequest],
            feed_item.FeedItem]:
        raise NotImplementedError

    @property
    def mutate_feed_items(self) -> typing.Callable[
