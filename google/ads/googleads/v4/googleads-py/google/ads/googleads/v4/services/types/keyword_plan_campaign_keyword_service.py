...
class MutateKeywordPlanCampaignKeywordsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v4.services.types.KeywordPlanCampaignKeywordOperation]):
...
class KeywordPlanCampaignKeywordOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v4.resources.types.KeywordPlanCampaignKeyword):
            Create operation: No resource name is
            expected for the new Keyword Plan campaign
            keyword.
        update (google.ads.googleads.v4.resources.types.KeywordPlanCampaignKeyword):
...
class MutateKeywordPlanCampaignKeywordsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v4.services.types.MutateKeywordPlanCampaignKeywordResult]):
