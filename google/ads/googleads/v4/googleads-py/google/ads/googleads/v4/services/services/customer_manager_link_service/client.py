...
class CustomerManagerLinkServiceClient(metaclass=CustomerManagerLinkServiceClientMeta):
    ...
    @staticmethod
    def customer_manager_link_path(customer: str,customer_manager_link: str,) -> str:
        """Return a fully-qualified customer_manager_link string."""
        return "customers/{customer}/customerManagerLinks/{customer_manager_link}".format(customer=customer, customer_manager_link=customer_manager_link, )
    ...
    def get_customer_manager_link(self,
        ...
        Returns:
            google.ads.googleads.v4.resources.types.CustomerManagerLink:
    ...
    def mutate_customer_manager_link(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.CustomerManagerLinkOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateCustomerManagerLinkResponse:
    ...
    def move_manager_link(self,
        ...
        Returns:
            google.ads.googleads.v4.services.types.MoveManagerLinkResponse:
                Response message for a
