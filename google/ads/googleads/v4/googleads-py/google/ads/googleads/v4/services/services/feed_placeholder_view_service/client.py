...
from google.ads.googleads.v4.resources.types import feed_placeholder_view
from google.ads.googleads.v4.services.types import feed_placeholder_view_service
from .transports.base import FeedPlaceholderViewServiceTransport, DEFAULT_CLIENT_INFO
...
class FeedPlaceholderViewServiceClient(metaclass=FeedPlaceholderViewServiceClientMeta):
    ...
    @staticmethod
    def feed_placeholder_view_path(customer: str,feed_placeholder_view: str,) -> str:
        """Return a fully-qualified feed_placeholder_view string."""
        return "customers/{customer}/feedPlaceholderViews/{feed_placeholder_view}".format(customer=customer, feed_placeholder_view=feed_placeholder_view, )

    @staticmethod
    def parse_feed_placeholder_view_path(path: str) -> Dict[str,str]:
        """Parse a feed_placeholder_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/feedPlaceholderViews/(?P<feed_placeholder_view>.+?)$", path)
    ...
    def get_feed_placeholder_view(self,
        ...
        r"""Returns the requested feed placeholder view in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetFeedPlaceholderViewRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v4.resources.types.FeedPlaceholderView:
        ...
        if not isinstance(request, feed_placeholder_view_service.GetFeedPlaceholderViewRequest):
            request = feed_placeholder_view_service.GetFeedPlaceholderViewRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_feed_placeholder_view]
