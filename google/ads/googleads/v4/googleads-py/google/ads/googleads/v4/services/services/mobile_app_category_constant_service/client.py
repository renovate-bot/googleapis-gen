...
class MobileAppCategoryConstantServiceClient(metaclass=MobileAppCategoryConstantServiceClientMeta):
    ...
    def get_mobile_app_category_constant(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetMobileAppCategoryConstantRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v4.resources.types.MobileAppCategoryConstant:
