...
from google.ads.googleads.v4.enums.types import target_cpa_opt_in_recommendation_goal
...
class Recommendation(proto.Message):
    ...
    class TargetCpaOptInRecommendation(proto.Message):
        ...
        Attributes:
            options_ (Sequence[google.ads.googleads.v4.resources.types.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption]):
