...
from .transports.base import KeywordPlanCampaignKeywordServiceTransport, DEFAULT_CLIENT_INFO
...
class KeywordPlanCampaignKeywordServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[KeywordPlanCampaignKeywordServiceTransport]]
...
class KeywordPlanCampaignKeywordServiceClient(metaclass=KeywordPlanCampaignKeywordServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, KeywordPlanCampaignKeywordServiceTransport, None] = None,
    ...
    def get_keyword_plan_campaign_keyword(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetKeywordPlanCampaignKeywordRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.KeywordPlanCampaignKeyword:
        ...
        if not isinstance(request, keyword_plan_campaign_keyword_service.GetKeywordPlanCampaignKeywordRequest):
            request = keyword_plan_campaign_keyword_service.GetKeywordPlanCampaignKeywordRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_keyword_plan_campaign_keyword]
    ...
    def mutate_keyword_plan_campaign_keywords(self,
        ...
        r"""Creates, updates, or removes Keyword Plan campaign
        keywords. Operation statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateKeywordPlanCampaignKeywordsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.KeywordPlanCampaignKeywordOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateKeywordPlanCampaignKeywordsResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, keyword_plan_campaign_keyword_service.MutateKeywordPlanCampaignKeywordsRequest):
            request = keyword_plan_campaign_keyword_service.MutateKeywordPlanCampaignKeywordsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_keyword_plan_campaign_keywords]
