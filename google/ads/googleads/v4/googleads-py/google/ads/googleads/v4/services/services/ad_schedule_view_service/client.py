...
class AdScheduleViewServiceClient(metaclass=AdScheduleViewServiceClientMeta):
    ...
    def ad_schedule_view_path(customer: str,ad_schedule_view: str,) -> str:
        ...
        return "customers/{customer}/adScheduleViews/{ad_schedule_view}".format(customer=customer, ad_schedule_view=ad_schedule_view, )

    @staticmethod
    def parse_ad_schedule_view_path(path: str) -> Dict[str,str]:
        """Parse a ad_schedule_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/adScheduleViews/(?P<ad_schedule_view>.+?)$", path)
    ...
    def get_ad_schedule_view(self,
        ...
        r"""Returns the requested ad schedule view in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAdScheduleViewRequest`):
                The request object. Request message for
                [AdScheduleViewService.GetAdScheduleView][google.ads.googleads.v4.services.AdScheduleViewService.GetAdScheduleView].
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AdScheduleView:
