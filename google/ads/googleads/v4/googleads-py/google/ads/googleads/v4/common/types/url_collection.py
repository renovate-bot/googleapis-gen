...
class UrlCollection(proto.Message):
    ...
    url_collection_id = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.StringValue,
    )
    final_urls = proto.RepeatedField(proto.MESSAGE, number=2,
        message=wrappers.StringValue,
    )
    final_mobile_urls = proto.RepeatedField(proto.MESSAGE, number=3,
        message=wrappers.StringValue,
    )
    tracking_url_template = proto.Field(proto.MESSAGE, number=4,
        message=wrappers.StringValue,
    )
