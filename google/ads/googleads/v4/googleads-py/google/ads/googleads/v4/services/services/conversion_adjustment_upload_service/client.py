...
from google.ads.googleads.v4.services.types import conversion_adjustment_upload_service
...
class ConversionAdjustmentUploadServiceClient(metaclass=ConversionAdjustmentUploadServiceClientMeta):
    ...
    def upload_conversion_adjustments(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.UploadConversionAdjustmentsRequest`):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            conversion_adjustments (:class:`Sequence[google.ads.googleads.v4.services.types.ConversionAdjustment]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.UploadConversionAdjustmentsResponse:
