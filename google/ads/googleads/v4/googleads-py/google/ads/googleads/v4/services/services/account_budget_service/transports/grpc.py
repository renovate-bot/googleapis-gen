...
from google.ads.googleads.v4.resources.types import account_budget
from google.ads.googleads.v4.services.types import account_budget_service
...
class AccountBudgetServiceGrpcTransport(AccountBudgetServiceTransport):
    """gRPC backend transport for AccountBudgetService.
    ...
    def get_account_budget(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetAccountBudgetRequest],
                    ~.AccountBudget]:
        ...
        if 'get_account_budget' not in self._stubs:
            self._stubs['get_account_budget'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v4.services.AccountBudgetService/GetAccountBudget',
                request_serializer=account_budget_service.GetAccountBudgetRequest.serialize,
                response_deserializer=account_budget.AccountBudget.deserialize,
            )
        return self._stubs['get_account_budget']
