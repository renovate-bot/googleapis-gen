...
class DynamicSearchAdsSearchTermViewServiceGrpcTransport(DynamicSearchAdsSearchTermViewServiceTransport):
    ...
    def get_dynamic_search_ads_search_term_view(self) -> Callable[
        ...
        if 'get_dynamic_search_ads_search_term_view' not in self._stubs:
            self._stubs['get_dynamic_search_ads_search_term_view'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v4.services.DynamicSearchAdsSearchTermViewService/GetDynamicSearchAdsSearchTermView',
