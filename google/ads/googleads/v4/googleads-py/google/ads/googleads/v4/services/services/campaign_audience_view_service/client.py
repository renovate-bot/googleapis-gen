...
from google.ads.googleads.v4.resources.types import campaign_audience_view
from google.ads.googleads.v4.services.types import campaign_audience_view_service
from .transports.base import CampaignAudienceViewServiceTransport, DEFAULT_CLIENT_INFO
...
class CampaignAudienceViewServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CampaignAudienceViewServiceTransport]]
...
class CampaignAudienceViewServiceClient(metaclass=CampaignAudienceViewServiceClientMeta):
    ...
    @staticmethod
    def campaign_audience_view_path(customer: str,campaign_audience_view: str,) -> str:
        """Return a fully-qualified campaign_audience_view string."""
        return "customers/{customer}/campaignAudienceViews/{campaign_audience_view}".format(customer=customer, campaign_audience_view=campaign_audience_view, )
    ...
    def parse_campaign_audience_view_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer>.+?)/campaignAudienceViews/(?P<campaign_audience_view>.+?)$", path)
    ...
    def __init__(self, *,
            ...
            transport: Union[str, CampaignAudienceViewServiceTransport, None] = None,
    ...
    def get_campaign_audience_view(self,
        ...
        r"""Returns the requested campaign audience view in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetCampaignAudienceViewRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v4.resources.types.CampaignAudienceView:
        ...
        if not isinstance(request, campaign_audience_view_service.GetCampaignAudienceViewRequest):
            request = campaign_audience_view_service.GetCampaignAudienceViewRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_campaign_audience_view]
