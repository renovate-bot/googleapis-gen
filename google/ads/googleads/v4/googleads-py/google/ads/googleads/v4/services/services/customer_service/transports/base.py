...
class CustomerServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for CustomerService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.mutate_customer: gapic_v1.method.wrap_method(
                self.mutate_customer,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_accessible_customers: gapic_v1.method.wrap_method(
                self.list_accessible_customers,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_customer_client: gapic_v1.method.wrap_method(
                self.create_customer_client,
                default_timeout=None,
                client_info=client_info,
            ),
         }
