...
class AdServiceClient(metaclass=AdServiceClientMeta):
    ...
    def get_ad(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAdRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v4.resources.types.Ad:
                An ad.
        """
    ...
    def mutate_ads(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateAdsRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.AdOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateAdsResponse:
