...
class ChangeStatus(proto.Message):
    ...
    Attributes:
        ...
        resource_type (google.ads.googleads.v4.enums.types.ChangeStatusResourceTypeEnum.ChangeStatusResourceType):
        ...
        ad_group (google.protobuf.wrappers_pb2.StringValue):
            ...
            change.
        resource_status (google.ads.googleads.v4.enums.types.ChangeStatusOperationEnum.ChangeStatusOperation):
