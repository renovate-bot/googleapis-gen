...
class GenerateKeywordIdeasRequest(proto.Message):
    ...
    Attributes:
        ...
        keyword_plan_network (google.ads.googleads.v4.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            Targeting network.
        keyword_and_url_seed (google.ads.googleads.v4.services.types.KeywordAndUrlSeed):
            A Keyword and a specific Url to generate
            ideas from e.g. cars, www.example.com/cars.
        keyword_seed (google.ads.googleads.v4.services.types.KeywordSeed):
            A Keyword or phrase to generate ideas from,
            e.g. cars.
        url_seed (google.ads.googleads.v4.services.types.UrlSeed):
            A specific url to generate ideas from, e.g.
            www.example.com/cars.
        site_seed (google.ads.googleads.v4.services.types.SiteSeed):
            The site to generate ideas from, e.g.
            www.example.com.
    """

    customer_id = proto.Field(proto.STRING, number=1)
    language = proto.Field(proto.MESSAGE, number=7,
        message=wrappers.StringValue,
    )
    geo_target_constants = proto.RepeatedField(proto.MESSAGE, number=8,
        message=wrappers.StringValue,
    )
...
class KeywordAndUrlSeed(proto.Message):
    ...
    keywords = proto.RepeatedField(proto.MESSAGE, number=2,
        message=wrappers.StringValue,
    )
...
class KeywordSeed(proto.Message):
    ...
    keywords = proto.RepeatedField(proto.MESSAGE, number=1,
        message=wrappers.StringValue,
    )
...
class SiteSeed(proto.Message):
    ...
    site = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.StringValue,
    )
...
class GenerateKeywordIdeaResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v4.services.types.GenerateKeywordIdeaResult]):
...
class GenerateKeywordIdeaResult(proto.Message):
    ...
    Attributes:
        text (google.protobuf.wrappers_pb2.StringValue):
            ...
            KeywordPlanService.
        keyword_idea_metrics (google.ads.googleads.v4.common.types.KeywordPlanHistoricalMetrics):
            The historical metrics for the keyword
    """

    text = proto.Field(proto.MESSAGE, number=2,
        message=wrappers.StringValue,
    )
