...
class AdGroupBidModifierServiceClient(metaclass=AdGroupBidModifierServiceClientMeta):
    ...
    def get_ad_group_bid_modifier(self,
        ...
        r"""Returns the requested ad group bid modifier in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAdGroupBidModifierRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AdGroupBidModifier:
    ...
    def mutate_ad_group_bid_modifiers(self,
        ...
        r"""Creates, updates, or removes ad group bid modifiers.
        Operation statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateAdGroupBidModifiersRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.AdGroupBidModifierOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateAdGroupBidModifiersResponse:
