...
from google.ads.googleads.v4.services.types import reach_plan_service
...
class ReachPlanServiceGrpcTransport(ReachPlanServiceTransport):
    ...
    def list_plannable_locations(self) -> Callable[
        ...
        if 'list_plannable_locations' not in self._stubs:
            self._stubs['list_plannable_locations'] = self.grpc_channel.unary_unary(
    ...
    def list_plannable_products(self) -> Callable[
        ...
        if 'list_plannable_products' not in self._stubs:
            self._stubs['list_plannable_products'] = self.grpc_channel.unary_unary(
    ...
    def generate_product_mix_ideas(self) -> Callable[
        ...
        if 'generate_product_mix_ideas' not in self._stubs:
            self._stubs['generate_product_mix_ideas'] = self.grpc_channel.unary_unary(
    ...
    def generate_reach_forecast(self) -> Callable[
        ...
        if 'generate_reach_forecast' not in self._stubs:
            self._stubs['generate_reach_forecast'] = self.grpc_channel.unary_unary(
