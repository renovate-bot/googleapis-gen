...
from google.ads.googleads.v4.services.types import mobile_device_constant_service
...
class MobileDeviceConstantServiceClient(metaclass=MobileDeviceConstantServiceClientMeta):
    ...
    def get_mobile_device_constant(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetMobileDeviceConstantRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.MobileDeviceConstant:
