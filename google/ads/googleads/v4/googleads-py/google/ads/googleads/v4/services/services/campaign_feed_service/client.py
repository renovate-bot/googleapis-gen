...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def get_campaign_feed(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetCampaignFeedRequest`):
                The request object. Request message for
                [CampaignFeedService.GetCampaignFeed][google.ads.googleads.v4.services.CampaignFeedService.GetCampaignFeed].
        ...
        Returns:
            google.ads.googleads.v4.resources.types.CampaignFeed:
                A campaign feed.
        """
    ...
    def mutate_campaign_feeds(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateCampaignFeedsRequest`):
                The request object. Request message for
                [CampaignFeedService.MutateCampaignFeeds][google.ads.googleads.v4.services.CampaignFeedService.MutateCampaignFeeds].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.CampaignFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateCampaignFeedsResponse:
