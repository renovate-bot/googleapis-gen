...
class CampaignLabelServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for CampaignLabelService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_campaign_label: gapic_v1.method.wrap_method(
                self.get_campaign_label,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_campaign_labels: gapic_v1.method.wrap_method(
                self.mutate_campaign_labels,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def get_campaign_label(self) -> typing.Callable[
            [campaign_label_service.GetCampaignLabelRequest],
            campaign_label.CampaignLabel]:
        raise NotImplementedError

    @property
    def mutate_campaign_labels(self) -> typing.Callable[
