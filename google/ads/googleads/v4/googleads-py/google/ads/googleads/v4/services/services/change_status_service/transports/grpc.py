...
class ChangeStatusServiceGrpcTransport(ChangeStatusServiceTransport):
    """gRPC backend transport for ChangeStatusService.
    ...
    def get_change_status(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetChangeStatusRequest],
                    ~.ChangeStatus]:
        ...
        if 'get_change_status' not in self._stubs:
            self._stubs['get_change_status'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v4.services.ChangeStatusService/GetChangeStatus',
                request_serializer=change_status_service.GetChangeStatusRequest.serialize,
                response_deserializer=change_status.ChangeStatus.deserialize,
            )
