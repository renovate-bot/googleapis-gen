...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
    ...
    def get_feed_item(self,
        ...
        Returns:
            google.ads.googleads.v4.resources.types.FeedItem:
                A feed item.
        """
    ...
    def mutate_feed_items(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.FeedItemOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateFeedItemsResponse:
