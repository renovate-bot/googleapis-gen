...
class AgeRangeViewServiceClient(metaclass=AgeRangeViewServiceClientMeta):
    ...
    def get_age_range_view(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAgeRangeViewRequest`):
                The request object. Request message for
                [AgeRangeViewService.GetAgeRangeView][google.ads.googleads.v4.services.AgeRangeViewService.GetAgeRangeView].
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AgeRangeView:
                An age range view.
        """
