...
class GeoTargetConstantServiceClientMeta(type):
    """Metaclass for the GeoTargetConstantService client.
...
class GeoTargetConstantServiceClient(metaclass=GeoTargetConstantServiceClientMeta):
    ...
    def transport(self) -> GeoTargetConstantServiceTransport:
        ...
        Returns:
            GeoTargetConstantServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, GeoTargetConstantServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the geo target constant service client.
        ...
        Args:
            ...
            transport (Union[str, ~.GeoTargetConstantServiceTransport]): The
        ...
        if isinstance(transport, GeoTargetConstantServiceTransport):
            # transport is a GeoTargetConstantServiceTransport instance.
            if credentials:
            ...
            self._transport = GeoTargetConstantServiceGrpcTransport(
    ...
    def get_geo_target_constant(self,
        ...
        r"""Returns the requested geo target constant in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetGeoTargetConstantRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.GeoTargetConstant:
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_geo_target_constant]
    ...
    def suggest_geo_target_constants(self,
        ...
        r"""Returns GeoTargetConstant suggestions by location
        name or by resource name.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.SuggestGeoTargetConstantsRequest`):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v4.services.types.SuggestGeoTargetConstantsResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, geo_target_constant_service.SuggestGeoTargetConstantsRequest):
            request = geo_target_constant_service.SuggestGeoTargetConstantsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.suggest_geo_target_constants]
