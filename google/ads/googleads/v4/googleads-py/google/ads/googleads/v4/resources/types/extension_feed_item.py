...
from google.ads.googleads.v4.enums.types import extension_type as gage_extension_type
...
class ExtensionFeedItem(proto.Message):
    ...
    Attributes:
        ...
        end_date_time (google.protobuf.wrappers_pb2.StringValue):
            ...
            Examples: "2018-03-05 09:15:00" or "2018-02-01
            14:34:30".
        ad_schedules (Sequence[google.ads.googleads.v4.common.types.AdScheduleInfo]):
        ...
        targeted_keyword (google.ads.googleads.v4.common.types.KeywordInfo):
            The targeted keyword.
        status (google.ads.googleads.v4.enums.types.FeedItemStatusEnum.FeedItemStatus):
            Output only. Status of the feed item.
            This field is read-only.
        sitelink_feed_item (google.ads.googleads.v4.common.types.SitelinkFeedItem):
            Sitelink extension.
        structured_snippet_feed_item (google.ads.googleads.v4.common.types.StructuredSnippetFeedItem):
            Structured snippet extension.
        app_feed_item (google.ads.googleads.v4.common.types.AppFeedItem):
            App extension.
        call_feed_item (google.ads.googleads.v4.common.types.CallFeedItem):
            Call extension.
        callout_feed_item (google.ads.googleads.v4.common.types.CalloutFeedItem):
            Callout extension.
        text_message_feed_item (google.ads.googleads.v4.common.types.TextMessageFeedItem):
            Text message extension.
        price_feed_item (google.ads.googleads.v4.common.types.PriceFeedItem):
            Price extension.
        promotion_feed_item (google.ads.googleads.v4.common.types.PromotionFeedItem):
            Promotion extension.
        location_feed_item (google.ads.googleads.v4.common.types.LocationFeedItem):
            Output only. Location extension. Locations
            are synced from a GMB account into a feed. This
            field is read-only.
        affiliate_location_feed_item (google.ads.googleads.v4.common.types.AffiliateLocationFeedItem):
        ...
        hotel_callout_feed_item (google.ads.googleads.v4.common.types.HotelCalloutFeedItem):
