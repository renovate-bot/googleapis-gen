...
class OfflineUserDataJob(proto.Message):
    ...
    Attributes:
        ...
        id (google.protobuf.wrappers_pb2.Int64Value):
            ...
            job.
        external_id (google.protobuf.wrappers_pb2.Int64Value):
            Immutable. User specified job ID.
        type_ (google.ads.googleads.v4.enums.types.OfflineUserDataJobTypeEnum.OfflineUserDataJobType):
            Immutable. Type of the job.
        status (google.ads.googleads.v4.enums.types.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus):
            Output only. Status of the job.
        failure_reason (google.ads.googleads.v4.enums.types.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason):
        ...
        customer_match_user_list_metadata (google.ads.googleads.v4.common.types.CustomerMatchUserListMetadata):
            ...
            CRM-based user list.
        store_sales_metadata (google.ads.googleads.v4.common.types.StoreSalesMetadata):
