...
class MutateCampaignFeedsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v4.services.types.CampaignFeedOperation]):
...
class CampaignFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v4.resources.types.CampaignFeed):
            Create operation: No resource name is
            expected for the new campaign feed.
        update (google.ads.googleads.v4.resources.types.CampaignFeed):
    ...
    create = proto.Field(
        ...
        number=1,
        oneof='operation',
        message=campaign_feed.CampaignFeed,
    )
    update = proto.Field(
        proto.MESSAGE,
        number=2,
...
class MutateCampaignFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v4.services.types.MutateCampaignFeedResult]):
