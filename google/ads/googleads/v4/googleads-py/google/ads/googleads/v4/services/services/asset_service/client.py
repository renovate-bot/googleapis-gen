...
class AssetServiceClient(metaclass=AssetServiceClientMeta):
    ...
    def get_asset(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAssetRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.Asset:
    ...
    def mutate_assets(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateAssetsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.AssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateAssetsResponse:
