...
class BatchJobServiceClient(metaclass=BatchJobServiceClientMeta):
    ...
    def ad_group_path(customer: str,ad_group: str,) -> str:
        ...
        return "customers/{customer}/adGroups/{ad_group}".format(customer=customer, ad_group=ad_group, )

    @staticmethod
    def parse_ad_group_path(path: str) -> Dict[str,str]:
        """Parse a ad_group path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/adGroups/(?P<ad_group>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_ad_path(customer: str,ad_group_ad: str,) -> str:
        """Return a fully-qualified ad_group_ad string."""
        return "customers/{customer}/adGroupAds/{ad_group_ad}".format(customer=customer, ad_group_ad=ad_group_ad, )

    @staticmethod
    def parse_ad_group_ad_path(path: str) -> Dict[str,str]:
        """Parse a ad_group_ad path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/adGroupAds/(?P<ad_group_ad>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_ad_label_path(customer: str,ad_group_ad_label: str,) -> str:
        """Return a fully-qualified ad_group_ad_label string."""
        return "customers/{customer}/adGroupAdLabels/{ad_group_ad_label}".format(customer=customer, ad_group_ad_label=ad_group_ad_label, )

    @staticmethod
    def parse_ad_group_ad_label_path(path: str) -> Dict[str,str]:
        """Parse a ad_group_ad_label path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/adGroupAdLabels/(?P<ad_group_ad_label>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_bid_modifier_path(customer: str,ad_group_bid_modifier: str,) -> str:
        """Return a fully-qualified ad_group_bid_modifier string."""
        return "customers/{customer}/adGroupBidModifiers/{ad_group_bid_modifier}".format(customer=customer, ad_group_bid_modifier=ad_group_bid_modifier, )

    @staticmethod
    def parse_ad_group_bid_modifier_path(path: str) -> Dict[str,str]:
        """Parse a ad_group_bid_modifier path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/adGroupBidModifiers/(?P<ad_group_bid_modifier>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_criterion_path(customer: str,ad_group_criterion: str,) -> str:
        """Return a fully-qualified ad_group_criterion string."""
        return "customers/{customer}/adGroupCriteria/{ad_group_criterion}".format(customer=customer, ad_group_criterion=ad_group_criterion, )

    @staticmethod
    def parse_ad_group_criterion_path(path: str) -> Dict[str,str]:
        """Parse a ad_group_criterion path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/adGroupCriteria/(?P<ad_group_criterion>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_criterion_label_path(customer: str,ad_group_criterion_label: str,) -> str:
        """Return a fully-qualified ad_group_criterion_label string."""
        return "customers/{customer}/adGroupCriterionLabels/{ad_group_criterion_label}".format(customer=customer, ad_group_criterion_label=ad_group_criterion_label, )
    ...
    def parse_ad_group_criterion_label_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer>.+?)/adGroupCriterionLabels/(?P<ad_group_criterion_label>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_extension_setting_path(customer: str,ad_group_extension_setting: str,) -> str:
        """Return a fully-qualified ad_group_extension_setting string."""
        return "customers/{customer}/adGroupExtensionSettings/{ad_group_extension_setting}".format(customer=customer, ad_group_extension_setting=ad_group_extension_setting, )
    ...
    def parse_ad_group_extension_setting_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer>.+?)/adGroupExtensionSettings/(?P<ad_group_extension_setting>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_feed_path(customer: str,ad_group_feed: str,) -> str:
        """Return a fully-qualified ad_group_feed string."""
        return "customers/{customer}/adGroupFeeds/{ad_group_feed}".format(customer=customer, ad_group_feed=ad_group_feed, )

    @staticmethod
    def parse_ad_group_feed_path(path: str) -> Dict[str,str]:
        """Parse a ad_group_feed path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/adGroupFeeds/(?P<ad_group_feed>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_label_path(customer: str,ad_group_label: str,) -> str:
        """Return a fully-qualified ad_group_label string."""
        return "customers/{customer}/adGroupLabels/{ad_group_label}".format(customer=customer, ad_group_label=ad_group_label, )

    @staticmethod
    def parse_ad_group_label_path(path: str) -> Dict[str,str]:
        """Parse a ad_group_label path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/adGroupLabels/(?P<ad_group_label>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def ad_parameter_path(customer: str,ad_parameter: str,) -> str:
        """Return a fully-qualified ad_parameter string."""
        return "customers/{customer}/adParameters/{ad_parameter}".format(customer=customer, ad_parameter=ad_parameter, )

    @staticmethod
    def parse_ad_parameter_path(path: str) -> Dict[str,str]:
        """Parse a ad_parameter path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/adParameters/(?P<ad_parameter>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def asset_path(customer: str,asset: str,) -> str:
        """Return a fully-qualified asset string."""
        return "customers/{customer}/assets/{asset}".format(customer=customer, asset=asset, )

    @staticmethod
    def parse_asset_path(path: str) -> Dict[str,str]:
        """Parse a asset path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/assets/(?P<asset>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def batch_job_path(customer: str,batch_job: str,) -> str:
        """Return a fully-qualified batch_job string."""
        return "customers/{customer}/batchJobs/{batch_job}".format(customer=customer, batch_job=batch_job, )

    @staticmethod
    def parse_batch_job_path(path: str) -> Dict[str,str]:
        """Parse a batch_job path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/batchJobs/(?P<batch_job>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def bidding_strategy_path(customer: str,bidding_strategy: str,) -> str:
        """Return a fully-qualified bidding_strategy string."""
        return "customers/{customer}/biddingStrategies/{bidding_strategy}".format(customer=customer, bidding_strategy=bidding_strategy, )

    @staticmethod
    def parse_bidding_strategy_path(path: str) -> Dict[str,str]:
        """Parse a bidding_strategy path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/biddingStrategies/(?P<bidding_strategy>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_path(customer: str,campaign: str,) -> str:
        """Return a fully-qualified campaign string."""
        return "customers/{customer}/campaigns/{campaign}".format(customer=customer, campaign=campaign, )

    @staticmethod
    def parse_campaign_path(path: str) -> Dict[str,str]:
        """Parse a campaign path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/campaigns/(?P<campaign>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_bid_modifier_path(customer: str,campaign_bid_modifier: str,) -> str:
        """Return a fully-qualified campaign_bid_modifier string."""
        return "customers/{customer}/campaignBidModifiers/{campaign_bid_modifier}".format(customer=customer, campaign_bid_modifier=campaign_bid_modifier, )

    @staticmethod
    def parse_campaign_bid_modifier_path(path: str) -> Dict[str,str]:
        """Parse a campaign_bid_modifier path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/campaignBidModifiers/(?P<campaign_bid_modifier>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_budget_path(customer: str,campaign_budget: str,) -> str:
        """Return a fully-qualified campaign_budget string."""
        return "customers/{customer}/campaignBudgets/{campaign_budget}".format(customer=customer, campaign_budget=campaign_budget, )

    @staticmethod
    def parse_campaign_budget_path(path: str) -> Dict[str,str]:
        """Parse a campaign_budget path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/campaignBudgets/(?P<campaign_budget>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_criterion_path(customer: str,campaign_criterion: str,) -> str:
        """Return a fully-qualified campaign_criterion string."""
        return "customers/{customer}/campaignCriteria/{campaign_criterion}".format(customer=customer, campaign_criterion=campaign_criterion, )

    @staticmethod
    def parse_campaign_criterion_path(path: str) -> Dict[str,str]:
        """Parse a campaign_criterion path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/campaignCriteria/(?P<campaign_criterion>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_draft_path(customer: str,campaign_draft: str,) -> str:
        """Return a fully-qualified campaign_draft string."""
        return "customers/{customer}/campaignDrafts/{campaign_draft}".format(customer=customer, campaign_draft=campaign_draft, )

    @staticmethod
    def parse_campaign_draft_path(path: str) -> Dict[str,str]:
        """Parse a campaign_draft path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/campaignDrafts/(?P<campaign_draft>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_experiment_path(customer: str,campaign_experiment: str,) -> str:
        """Return a fully-qualified campaign_experiment string."""
        return "customers/{customer}/campaignExperiments/{campaign_experiment}".format(customer=customer, campaign_experiment=campaign_experiment, )
    ...
    def parse_campaign_experiment_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_extension_setting_path(customer: str,campaign_extension_setting: str,) -> str:
        """Return a fully-qualified campaign_extension_setting string."""
        return "customers/{customer}/campaignExtensionSettings/{campaign_extension_setting}".format(customer=customer, campaign_extension_setting=campaign_extension_setting, )
    ...
    def parse_campaign_extension_setting_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer>.+?)/campaignExtensionSettings/(?P<campaign_extension_setting>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_feed_path(customer: str,campaign_feed: str,) -> str:
        """Return a fully-qualified campaign_feed string."""
        return "customers/{customer}/campaignFeeds/{campaign_feed}".format(customer=customer, campaign_feed=campaign_feed, )

    @staticmethod
    def parse_campaign_feed_path(path: str) -> Dict[str,str]:
        """Parse a campaign_feed path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/campaignFeeds/(?P<campaign_feed>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_label_path(customer: str,campaign_label: str,) -> str:
        """Return a fully-qualified campaign_label string."""
        return "customers/{customer}/campaignLabels/{campaign_label}".format(customer=customer, campaign_label=campaign_label, )

    @staticmethod
    def parse_campaign_label_path(path: str) -> Dict[str,str]:
        """Parse a campaign_label path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/campaignLabels/(?P<campaign_label>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_shared_set_path(customer: str,campaign_shared_set: str,) -> str:
        """Return a fully-qualified campaign_shared_set string."""
        return "customers/{customer}/campaignSharedSets/{campaign_shared_set}".format(customer=customer, campaign_shared_set=campaign_shared_set, )

    @staticmethod
    def parse_campaign_shared_set_path(path: str) -> Dict[str,str]:
        """Parse a campaign_shared_set path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/campaignSharedSets/(?P<campaign_shared_set>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def conversion_action_path(customer: str,conversion_action: str,) -> str:
        """Return a fully-qualified conversion_action string."""
        return "customers/{customer}/conversionActions/{conversion_action}".format(customer=customer, conversion_action=conversion_action, )

    @staticmethod
    def parse_conversion_action_path(path: str) -> Dict[str,str]:
        """Parse a conversion_action path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/conversionActions/(?P<conversion_action>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_customer_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def customer_extension_setting_path(customer: str,customer_extension_setting: str,) -> str:
        """Return a fully-qualified customer_extension_setting string."""
        return "customers/{customer}/customerExtensionSettings/{customer_extension_setting}".format(customer=customer, customer_extension_setting=customer_extension_setting, )
    ...
    def parse_customer_extension_setting_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer>.+?)/customerExtensionSettings/(?P<customer_extension_setting>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def customer_feed_path(customer: str,customer_feed: str,) -> str:
        """Return a fully-qualified customer_feed string."""
        return "customers/{customer}/customerFeeds/{customer_feed}".format(customer=customer, customer_feed=customer_feed, )

    @staticmethod
    def parse_customer_feed_path(path: str) -> Dict[str,str]:
        """Parse a customer_feed path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/customerFeeds/(?P<customer_feed>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def customer_label_path(customer: str,customer_label: str,) -> str:
        """Return a fully-qualified customer_label string."""
        return "customers/{customer}/customerLabels/{customer_label}".format(customer=customer, customer_label=customer_label, )

    @staticmethod
    def parse_customer_label_path(path: str) -> Dict[str,str]:
        """Parse a customer_label path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/customerLabels/(?P<customer_label>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def customer_negative_criterion_path(customer: str,customer_negative_criterion: str,) -> str:
        """Return a fully-qualified customer_negative_criterion string."""
        return "customers/{customer}/customerNegativeCriteria/{customer_negative_criterion}".format(customer=customer, customer_negative_criterion=customer_negative_criterion, )
    ...
    def parse_customer_negative_criterion_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def extension_feed_item_path(customer: str,extension_feed_item: str,) -> str:
        """Return a fully-qualified extension_feed_item string."""
        return "customers/{customer}/extensionFeedItems/{extension_feed_item}".format(customer=customer, extension_feed_item=extension_feed_item, )
    ...
    def feed_path(customer: str,feed: str,) -> str:
        ...
        return "customers/{customer}/feeds/{feed}".format(customer=customer, feed=feed, )
    ...
    def feed_item_path(customer: str,feed_item: str,) -> str:
        ...
        return "customers/{customer}/feedItems/{feed_item}".format(customer=customer, feed_item=feed_item, )
    ...
    def feed_item_target_path(customer: str,feed_item_target: str,) -> str:
        ...
        return "customers/{customer}/feedItemTargets/{feed_item_target}".format(customer=customer, feed_item_target=feed_item_target, )

    @staticmethod
    def parse_feed_item_target_path(path: str) -> Dict[str,str]:
        """Parse a feed_item_target path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/feedItemTargets/(?P<feed_item_target>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def feed_mapping_path(customer: str,feed_mapping: str,) -> str:
        """Return a fully-qualified feed_mapping string."""
        return "customers/{customer}/feedMappings/{feed_mapping}".format(customer=customer, feed_mapping=feed_mapping, )

    @staticmethod
    def parse_feed_mapping_path(path: str) -> Dict[str,str]:
        """Parse a feed_mapping path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/feedMappings/(?P<feed_mapping>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def geo_target_constant_path(geo_target_constant: str,) -> str:
        """Return a fully-qualified geo_target_constant string."""
        return "geoTargetConstants/{geo_target_constant}".format(geo_target_constant=geo_target_constant, )
    ...
    def keyword_plan_path(customer: str,keyword_plan: str,) -> str:
        ...
        return "customers/{customer}/keywordPlans/{keyword_plan}".format(customer=customer, keyword_plan=keyword_plan, )
    ...
    def parse_keyword_plan_ad_group_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def keyword_plan_ad_group_keyword_path(customer: str,keyword_plan_ad_group_keyword: str,) -> str:
        """Return a fully-qualified keyword_plan_ad_group_keyword string."""
        return "customers/{customer}/keywordPlanAdGroupKeywords/{keyword_plan_ad_group_keyword}".format(customer=customer, keyword_plan_ad_group_keyword=keyword_plan_ad_group_keyword, )
    ...
    def parse_keyword_plan_campaign_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def keyword_plan_campaign_keyword_path(customer: str,keyword_plan_campaign_keyword: str,) -> str:
        """Return a fully-qualified keyword_plan_campaign_keyword string."""
        return "customers/{customer}/keywordPlanCampaignKeywords/{keyword_plan_campaign_keyword}".format(customer=customer, keyword_plan_campaign_keyword=keyword_plan_campaign_keyword, )
    ...
    def parse_keyword_plan_campaign_keyword_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer>.+?)/keywordPlanCampaignKeywords/(?P<keyword_plan_campaign_keyword>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def label_path(customer: str,label: str,) -> str:
        """Return a fully-qualified label string."""
        return "customers/{customer}/labels/{label}".format(customer=customer, label=label, )

    @staticmethod
    def parse_label_path(path: str) -> Dict[str,str]:
        """Parse a label path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/labels/(?P<label>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def language_constant_path(language_constant: str,) -> str:
        """Return a fully-qualified language_constant string."""
        return "languageConstants/{language_constant}".format(language_constant=language_constant, )
    ...
    def list_batch_job_results(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_batch_job_results]
    ...
    def add_batch_job_operations(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.add_batch_job_operations]
