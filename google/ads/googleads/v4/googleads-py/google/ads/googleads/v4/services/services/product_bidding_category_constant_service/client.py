...
from google.ads.googleads.v4.resources.types import product_bidding_category_constant
from google.ads.googleads.v4.services.types import product_bidding_category_constant_service
from google.protobuf import wrappers_pb2 as wrappers  # type: ignore

from .transports.base import ProductBiddingCategoryConstantServiceTransport, DEFAULT_CLIENT_INFO
...
class ProductBiddingCategoryConstantServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ProductBiddingCategoryConstantServiceTransport]]
...
class ProductBiddingCategoryConstantServiceClient(metaclass=ProductBiddingCategoryConstantServiceClientMeta):
    ...
    @staticmethod
    def product_bidding_category_constant_path(product_bidding_category_constant: str,) -> str:
        """Return a fully-qualified product_bidding_category_constant string."""
        return "productBiddingCategoryConstants/{product_bidding_category_constant}".format(product_bidding_category_constant=product_bidding_category_constant, )
    ...
    def parse_product_bidding_category_constant_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^productBiddingCategoryConstants/(?P<product_bidding_category_constant>.+?)$", path)
    ...
    def __init__(self, *,
            ...
            transport: Union[str, ProductBiddingCategoryConstantServiceTransport, None] = None,
        ...
        if isinstance(transport, ProductBiddingCategoryConstantServiceTransport):
    ...
    def get_product_bidding_category_constant(self,
        ...
        r"""Returns the requested Product Bidding Category in
        full detail.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetProductBiddingCategoryConstantRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.ProductBiddingCategoryConstant:
        ...
        if not isinstance(request, product_bidding_category_constant_service.GetProductBiddingCategoryConstantRequest):
            request = product_bidding_category_constant_service.GetProductBiddingCategoryConstantRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_product_bidding_category_constant]
