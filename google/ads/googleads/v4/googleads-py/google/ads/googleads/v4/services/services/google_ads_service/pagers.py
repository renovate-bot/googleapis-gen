...
class SearchPager:
    ...
    :class:`google.ads.googleads.v4.services.types.SearchGoogleAdsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v4.services.types.SearchGoogleAdsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (:class:`google.ads.googleads.v4.services.types.SearchGoogleAdsRequest`):
                The initial request object.
            response (:class:`google.ads.googleads.v4.services.types.SearchGoogleAdsResponse`):
