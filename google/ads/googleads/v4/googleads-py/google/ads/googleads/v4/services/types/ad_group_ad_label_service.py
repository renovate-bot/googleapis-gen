...
class MutateAdGroupAdLabelsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v4.services.types.AdGroupAdLabelOperation]):
...
class AdGroupAdLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v4.resources.types.AdGroupAdLabel):
...
class MutateAdGroupAdLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v4.services.types.MutateAdGroupAdLabelResult]):
