...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def get_account_link(self,
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AccountLink:
    ...
    def mutate_account_link(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v4.services.types.AccountLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateAccountLinkResponse:
