...
class KeywordPlanCampaign(proto.Message):
    ...
    Attributes:
        ...
        keyword_plan_network (google.ads.googleads.v4.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            Targeting network.
            This field is required and should not be empty
            when creating Keyword Plan campaigns.
        cpc_bid_micros (google.protobuf.wrappers_pb2.Int64Value):
            ...
            This field is required and should not be empty
            when creating Keyword Plan campaigns.
        geo_targets (Sequence[google.ads.googleads.v4.resources.types.KeywordPlanGeoTarget]):
            The geo targets.
