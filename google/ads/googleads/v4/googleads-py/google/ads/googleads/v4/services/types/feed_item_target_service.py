...
class MutateFeedItemTargetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v4.services.types.FeedItemTargetOperation]):
...
class FeedItemTargetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v4.resources.types.FeedItemTarget):
...
class MutateFeedItemTargetsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v4.services.types.MutateFeedItemTargetResult]):
