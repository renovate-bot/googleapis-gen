...
class MutateAdGroupCriterionLabelsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v4.services.types.AdGroupCriterionLabelOperation]):
...
class AdGroupCriterionLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v4.resources.types.AdGroupCriterionLabel):
...
class MutateAdGroupCriterionLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v4.services.types.MutateAdGroupCriterionLabelResult]):
