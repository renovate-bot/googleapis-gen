...
class ReachPlanServiceClient(metaclass=ReachPlanServiceClientMeta):
    ...
    def list_plannable_locations(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.ListPlannableLocationsRequest`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.ListPlannableLocationsResponse:
    ...
    def list_plannable_products(self,
            ...
            *,
            plannable_location_id: wrappers_pb2.StringValue = None,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> reach_plan_service.ListPlannableProductsResponse:
        r"""Returns the list of per-location plannable YouTube ad
        formats with allowed targeting.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.ListPlannableProductsRequest`):
                The request object. Request to list available products
                in a given location.
            plannable_location_id (:class:`google.protobuf.wrappers_pb2.StringValue`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.ListPlannableProductsResponse:
    ...
    def generate_product_mix_ideas(self,
            ...
            *,
            ...
            plannable_location_id: wrappers_pb2.StringValue = None,
            currency_code: wrappers_pb2.StringValue = None,
            budget_micros: wrappers_pb2.Int64Value = None,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> reach_plan_service.GenerateProductMixIdeasResponse:
        r"""Generates a product mix ideas given a set of
        preferences. This method helps the advertiser to obtain
        a good mix of ad formats and budget allocations based on
        its preferences.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GenerateProductMixIdeasRequest`):
                The request object. Request message for
            ...
            plannable_location_id (:class:`google.protobuf.wrappers_pb2.StringValue`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            currency_code (:class:`google.protobuf.wrappers_pb2.StringValue`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            budget_micros (:class:`google.protobuf.wrappers_pb2.Int64Value`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.GenerateProductMixIdeasResponse:
    ...
    def generate_reach_forecast(self,
        ...
        r"""Generates a reach forecast for a given targeting /
        product mix.

        Args:
            request (:class:`google.ads.googleads.v4.services.types.GenerateReachForecastRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            campaign_duration (:class:`google.ads.googleads.v4.services.types.CampaignDuration`):
                Required. Campaign duration.
                This corresponds to the ``campaign_duration`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            planned_products (:class:`Sequence[google.ads.googleads.v4.services.types.PlannedProduct]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.GenerateReachForecastResponse:
