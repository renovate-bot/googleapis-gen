...
class GetCampaignBudgetRequest(proto.Message):
    ...
    [CampaignBudgetService.GetCampaignBudget][google.ads.googleads.v4.services.CampaignBudgetService.GetCampaignBudget].
...
class MutateCampaignBudgetsRequest(proto.Message):
    r"""Request message for
    [CampaignBudgetService.MutateCampaignBudgets][google.ads.googleads.v4.services.CampaignBudgetService.MutateCampaignBudgets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign budgets are being modified.
        operations (Sequence[google.ads.googleads.v4.services.types.CampaignBudgetOperation]):
...
class CampaignBudgetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v4.resources.types.CampaignBudget):
            Create operation: No resource name is
            expected for the new budget.
        update (google.ads.googleads.v4.resources.types.CampaignBudget):
    ...
    create = proto.Field(
        ...
        number=1,
        oneof='operation',
        message=campaign_budget.CampaignBudget,
    )
    update = proto.Field(
        proto.MESSAGE,
        number=2,
...
class MutateCampaignBudgetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v4.services.types.MutateCampaignBudgetResult]):
