...
class GenerateKeywordIdeasPager:
    ...
    :class:`google.ads.googleads.v4.services.types.GenerateKeywordIdeaResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v4.services.types.GenerateKeywordIdeaResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v4.services.types.GenerateKeywordIdeaResponse`):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
        self._method = method
        self._request = keyword_plan_idea_service.GenerateKeywordIdeasRequest(request)
    ...
    @property
    def pages(self) -> Iterable[keyword_plan_idea_service.GenerateKeywordIdeaResponse]:
