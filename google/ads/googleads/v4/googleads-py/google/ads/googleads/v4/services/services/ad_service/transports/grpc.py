...
class AdServiceGrpcTransport(AdServiceTransport):
    """gRPC backend transport for AdService.
    ...
    def get_ad(self) -> Callable[
        ...
        if 'get_ad' not in self._stubs:
            self._stubs['get_ad'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v4.services.AdService/GetAd',
                request_serializer=ad_service.GetAdRequest.serialize,
                response_deserializer=ad.Ad.deserialize,
            )
        return self._stubs['get_ad']
    ...
    def mutate_ads(self) -> Callable[
        ...
        if 'mutate_ads' not in self._stubs:
            self._stubs['mutate_ads'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v4.services.AdService/MutateAds',
