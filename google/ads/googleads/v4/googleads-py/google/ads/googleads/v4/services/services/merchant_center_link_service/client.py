...
class MerchantCenterLinkServiceClient(metaclass=MerchantCenterLinkServiceClientMeta):
    ...
    @staticmethod
    def merchant_center_link_path(customer: str,merchant_center_link: str,) -> str:
        """Return a fully-qualified merchant_center_link string."""
        return "customers/{customer}/merchantCenterLinks/{merchant_center_link}".format(customer=customer, merchant_center_link=merchant_center_link, )

    @staticmethod
    def parse_merchant_center_link_path(path: str) -> Dict[str,str]:
        """Parse a merchant_center_link path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/merchantCenterLinks/(?P<merchant_center_link>.+?)$", path)
    ...
    def list_merchant_center_links(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.ListMerchantCenterLinksRequest`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.ListMerchantCenterLinksResponse:
    ...
    def get_merchant_center_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetMerchantCenterLinkRequest`):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v4.resources.types.MerchantCenterLink:
    ...
    def mutate_merchant_center_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateMerchantCenterLinkRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v4.services.types.MerchantCenterLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateMerchantCenterLinkResponse:
