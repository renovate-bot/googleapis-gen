...
class MutateAdGroupsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v4.services.types.AdGroupOperation]):
...
class AdGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v4.resources.types.AdGroup):
            Create operation: No resource name is
            expected for the new ad group.
        update (google.ads.googleads.v4.resources.types.AdGroup):
...
class MutateAdGroupsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v4.services.types.MutateAdGroupResult]):
