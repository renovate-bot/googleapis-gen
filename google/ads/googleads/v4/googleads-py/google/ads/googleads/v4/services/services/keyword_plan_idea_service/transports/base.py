...
class KeywordPlanIdeaServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for KeywordPlanIdeaService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.generate_keyword_ideas: gapic_v1.method.wrap_method(
                self.generate_keyword_ideas,
    ...
    @property
    def generate_keyword_ideas(self) -> typing.Callable[
