...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class BatchJobName : gax::IResourceName, sys::IEquatable<BatchJobName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/batchJobs/{batch_job}</c>.</summary>
            CustomerBatchJob = 1,
        }

        private static gax::PathTemplate s_customerBatchJob = new gax::PathTemplate("customers/{customer}/batchJobs/{batch_job}");
        ...
        /// <summary>
        /// Creates a <see cref="BatchJobName"/> with the pattern <c>customers/{customer}/batchJobs/{batch_job}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer}/batchJobs/{batch_job}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="batchJobId">The <c>BatchJob</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/batchJobs/{batch_job}</c></description></item>
        /// </list>
        /// </remarks>
    ...
    public partial class BatchJob
    {
        ...
        /// </summary>
        public BatchJobName ResourceNameAsBatchJobName
        {
