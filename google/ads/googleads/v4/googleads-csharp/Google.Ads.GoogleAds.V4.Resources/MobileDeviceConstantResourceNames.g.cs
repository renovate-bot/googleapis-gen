...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class MobileDeviceConstantName : gax::IResourceName, sys::IEquatable<MobileDeviceConstantName>
    {
        ...
        /// <summary>
        /// Creates a <see cref="MobileDeviceConstantName"/> with the pattern
        /// <c>mobileDeviceConstants/{mobile_device_constant}</c>.
        /// </summary>
        /// <param name="mobileDeviceConstantId">
        /// The <c>MobileDeviceConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="MobileDeviceConstantName"/> constructed from the provided ids.
        /// </returns>
        public static MobileDeviceConstantName FromMobileDeviceConstant(string mobileDeviceConstantId) =>
            new MobileDeviceConstantName(ResourceNameType.MobileDeviceConstant, mobileDeviceConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(mobileDeviceConstantId, nameof(mobileDeviceConstantId)));
        ...
        /// <c>mobileDeviceConstants/{mobile_device_constant}</c>.
        /// </returns>
        public static string Format(string mobileDeviceConstantId) => FormatMobileDeviceConstant(mobileDeviceConstantId);
        ...
        /// <c>mobileDeviceConstants/{mobile_device_constant}</c>.
        /// </returns>
        public static string FormatMobileDeviceConstant(string mobileDeviceConstantId) =>
            s_mobileDeviceConstant.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(mobileDeviceConstantId, nameof(mobileDeviceConstantId)));
        ...
        /// <list type="bullet">
        /// <item><description><c>mobileDeviceConstants/{mobile_device_constant}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string mobileDeviceConstantName, bool allowUnparsed, out MobileDeviceConstantName result)
        {
            ...
            if (s_mobileDeviceConstant.TryParseName(mobileDeviceConstantName, out resourceName))
            {
                result = FromMobileDeviceConstant(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private MobileDeviceConstantName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string mobileDeviceConstantId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            MobileDeviceConstantId = mobileDeviceConstantId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="MobileDeviceConstantName"/> class from the component parts of
        /// pattern <c>mobileDeviceConstants/{mobile_device_constant}</c>
        /// </summary>
        /// <param name="mobileDeviceConstantId">
        /// The <c>MobileDeviceConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public MobileDeviceConstantName(string mobileDeviceConstantId) : this(ResourceNameType.MobileDeviceConstant, mobileDeviceConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(mobileDeviceConstantId, nameof(mobileDeviceConstantId)))
        {
        }
        ...
        /// <summary>
        /// The <c>MobileDeviceConstant</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.MobileDeviceConstant: return s_mobileDeviceConstant.Expand(MobileDeviceConstantId);
