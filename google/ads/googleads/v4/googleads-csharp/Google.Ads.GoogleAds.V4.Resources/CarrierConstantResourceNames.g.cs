...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class CarrierConstantName : gax::IResourceName, sys::IEquatable<CarrierConstantName>
    {
        ...
        /// <summary>
        /// Creates a <see cref="CarrierConstantName"/> with the pattern <c>carrierConstants/{carrier_constant}</c>.
        /// </summary>
        /// <param name="carrierConstantId">The <c>CarrierConstant</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="CarrierConstantName"/> constructed from the provided ids.</returns>
        public static CarrierConstantName FromCarrierConstant(string carrierConstantId) =>
            new CarrierConstantName(ResourceNameType.CarrierConstant, carrierConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(carrierConstantId, nameof(carrierConstantId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="CarrierConstantName"/> with pattern
        /// <c>carrierConstants/{carrier_constant}</c>.
        /// </summary>
        /// <param name="carrierConstantId">The <c>CarrierConstant</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <c>carrierConstants/{carrier_constant}</c>.
        /// </returns>
        public static string Format(string carrierConstantId) => FormatCarrierConstant(carrierConstantId);
        ...
        /// <c>carrierConstants/{carrier_constant}</c>.
        /// </returns>
        public static string FormatCarrierConstant(string carrierConstantId) =>
            s_carrierConstant.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(carrierConstantId, nameof(carrierConstantId)));
        ...
        /// <list type="bullet">
        /// <item><description><c>carrierConstants/{carrier_constant}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string carrierConstantName, bool allowUnparsed, out CarrierConstantName result)
        {
            ...
            if (s_carrierConstant.TryParseName(carrierConstantName, out resourceName))
            {
                result = FromCarrierConstant(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private CarrierConstantName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string carrierConstantId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            CarrierConstantId = carrierConstantId;
        }
        ...
        /// </summary>
        /// <param name="carrierConstantId">The <c>CarrierConstant</c> ID. Must not be <c>null</c> or empty.</param>
        public CarrierConstantName(string carrierConstantId) : this(ResourceNameType.CarrierConstant, carrierConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(carrierConstantId, nameof(carrierConstantId)))
        {
        }
        ...
        /// <summary>
        /// The <c>CarrierConstant</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.CarrierConstant: return s_carrierConstant.Expand(CarrierConstantId);
