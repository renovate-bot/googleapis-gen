...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class GenderViewName : gax::IResourceName, sys::IEquatable<GenderViewName>
    {
        ...
        /// <summary>
        /// Creates a <see cref="GenderViewName"/> with the pattern <c>customers/{customer}/genderViews/{gender_view}</c>
        /// .
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="genderViewId">The <c>GenderView</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="GenderViewName"/> constructed from the provided ids.</returns>
        public static GenderViewName FromCustomerGenderView(string customerId, string genderViewId) =>
            new GenderViewName(ResourceNameType.CustomerGenderView, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), genderViewId: gax::GaxPreconditions.CheckNotNullOrEmpty(genderViewId, nameof(genderViewId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="GenderViewName"/> with pattern
        /// <c>customers/{customer}/genderViews/{gender_view}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="genderViewId">The <c>GenderView</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        public static string Format(string customerId, string genderViewId) =>
            FormatCustomerGenderView(customerId, genderViewId);
        ...
        /// <c>customers/{customer}/genderViews/{gender_view}</c>.
        /// </returns>
        public static string FormatCustomerGenderView(string customerId, string genderViewId) =>
            s_customerGenderView.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(genderViewId, nameof(genderViewId)));

        /// <summary>Parses the given resource name string into a new <see cref="GenderViewName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/genderViews/{gender_view}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string genderViewName, bool allowUnparsed, out GenderViewName result)
        {
            ...
            if (s_customerGenderView.TryParseName(genderViewName, out resourceName))
            {
                result = FromCustomerGenderView(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private GenderViewName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string customerId = null, string genderViewId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            CustomerId = customerId;
            GenderViewId = genderViewId;
        }
        ...
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="genderViewId">The <c>GenderView</c> ID. Must not be <c>null</c> or empty.</param>
        public GenderViewName(string customerId, string genderViewId) : this(ResourceNameType.CustomerGenderView, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), genderViewId: gax::GaxPreconditions.CheckNotNullOrEmpty(genderViewId, nameof(genderViewId)))
        {
        }
        ...
        /// <summary>
        /// The <c>GenderView</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.CustomerGenderView: return s_customerGenderView.Expand(CustomerId, GenderViewId);
