...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class CampaignExperimentName : gax::IResourceName, sys::IEquatable<CampaignExperimentName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer}/campaignExperiments/{campaign_experiment}</c>.
            /// </summary>
            CustomerCampaignExperiment = 1,
        }

        private static gax::PathTemplate s_customerCampaignExperiment = new gax::PathTemplate("customers/{customer}/campaignExperiments/{campaign_experiment}");
        ...
        /// <c>customers/{customer}/campaignExperiments/{campaign_experiment}</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>customers/{customer}/campaignExperiments/{campaign_experiment}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        /// pattern <c>customers/{customer}/campaignExperiments/{campaign_experiment}</c>
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="campaignExperimentId">
        /// The <c>CampaignExperiment</c> ID. Must not be <c>null</c> or empty.
    ...
    public partial class CampaignExperiment
    {
        ...
        /// </summary>
        public CampaignDraftName CampaignDraftAsCampaignDraftName
        {
        ...
        /// </summary>
        public CampaignName ExperimentCampaignAsCampaignName
        {
