...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class BiddingStrategyName : gax::IResourceName, sys::IEquatable<BiddingStrategyName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer}/biddingStrategies/{bidding_strategy}</c>.
            /// </summary>
            CustomerBiddingStrategy = 1,
        }

        private static gax::PathTemplate s_customerBiddingStrategy = new gax::PathTemplate("customers/{customer}/biddingStrategies/{bidding_strategy}");
        ...
        /// <c>customers/{customer}/biddingStrategies/{bidding_strategy}</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/biddingStrategies/{bidding_strategy}</c></description></item>
        /// </list>
        /// </remarks>
    ...
    public partial class BiddingStrategy
    {
        ...
        /// property.
        /// </summary>
        public gagvr::BiddingStrategyName ResourceNameAsBiddingStrategyName
        {
        ...
        /// </summary>
        public gagvr::BiddingStrategyName BiddingStrategyName
        {
