...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class LabelName : gax::IResourceName, sys::IEquatable<LabelName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/labels/{label}</c>.</summary>
            CustomerLabel = 1,
        }

        private static gax::PathTemplate s_customerLabel = new gax::PathTemplate("customers/{customer}/labels/{label}");
        ...
        /// <summary>
        /// Creates a <see cref="LabelName"/> with the pattern <c>customers/{customer}/labels/{label}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer}/labels/{label}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="labelId">The <c>Label</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/labels/{label}</c></description></item>
        /// </list>
        /// </remarks>
