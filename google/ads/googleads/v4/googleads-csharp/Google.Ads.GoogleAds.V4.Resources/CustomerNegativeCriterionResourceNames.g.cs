...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class CustomerNegativeCriterionName : gax::IResourceName, sys::IEquatable<CustomerNegativeCriterionName>
    {
        ...
        /// <param name="customerNegativeCriterionId">
        /// The <c>CustomerNegativeCriterion</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="CustomerNegativeCriterionName"/> constructed from the provided ids.
        /// </returns>
        public static CustomerNegativeCriterionName FromCustomerCustomerNegativeCriterion(string customerId, string customerNegativeCriterionId) =>
            new CustomerNegativeCriterionName(ResourceNameType.CustomerCustomerNegativeCriterion, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), customerNegativeCriterionId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerNegativeCriterionId, nameof(customerNegativeCriterionId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="CustomerNegativeCriterionName"/> with
        /// pattern <c>customers/{customer}/customerNegativeCriteria/{customer_negative_criterion}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="customerNegativeCriterionId">
        /// The <c>CustomerNegativeCriterion</c> ID. Must not be <c>null</c> or empty.
        ...
        /// <c>customers/{customer}/customerNegativeCriteria/{customer_negative_criterion}</c>.
        /// </returns>
        public static string Format(string customerId, string customerNegativeCriterionId) =>
            FormatCustomerCustomerNegativeCriterion(customerId, customerNegativeCriterionId);
        ...
        /// <c>customers/{customer}/customerNegativeCriteria/{customer_negative_criterion}</c>.
        /// </returns>
        public static string FormatCustomerCustomerNegativeCriterion(string customerId, string customerNegativeCriterionId) =>
            s_customerCustomerNegativeCriterion.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(customerNegativeCriterionId, nameof(customerNegativeCriterionId)));
        ...
        public static bool TryParse(string customerNegativeCriterionName, bool allowUnparsed, out CustomerNegativeCriterionName result)
        {
            ...
            if (s_customerCustomerNegativeCriterion.TryParseName(customerNegativeCriterionName, out resourceName))
            {
                result = FromCustomerCustomerNegativeCriterion(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private CustomerNegativeCriterionName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string customerId = null, string customerNegativeCriterionId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            CustomerId = customerId;
            CustomerNegativeCriterionId = customerNegativeCriterionId;
        }
        ...
        /// The <c>CustomerNegativeCriterion</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public CustomerNegativeCriterionName(string customerId, string customerNegativeCriterionId) : this(ResourceNameType.CustomerCustomerNegativeCriterion, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), customerNegativeCriterionId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerNegativeCriterionId, nameof(customerNegativeCriterionId)))
        {
        }
        ...
        /// <summary>
        /// The <c>CustomerNegativeCriterion</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
        public string CustomerNegativeCriterionId { get; }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.CustomerCustomerNegativeCriterion: return s_customerCustomerNegativeCriterion.Expand(CustomerId, CustomerNegativeCriterionId);
    ...
    public partial class CustomerNegativeCriterion
    {
        ...
        /// property.
        /// </summary>
        public CustomerNegativeCriterionName ResourceNameAsCustomerNegativeCriterionName
        {
