...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class CustomerName : gax::IResourceName, sys::IEquatable<CustomerName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}</c>.</summary>
            Customer = 1,
        }

        private static gax::PathTemplate s_customer = new gax::PathTemplate("customers/{customer}");
        ...
        /// <summary>Creates a <see cref="CustomerName"/> with the pattern <c>customers/{customer}</c>.</summary>
        ...
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="CustomerName"/> with pattern <c>customers/{customer}</c>.
        /// </returns>
        ...
        /// <list type="bullet"><item><description><c>customers/{customer}</c></description></item></list>
        /// </remarks>
    ...
    public partial class Customer
    {
        ...
        /// </summary>
        public CustomerName ResourceNameAsCustomerName
        {
    ...
    public partial class CallReportingSetting
    {
        ...
        /// property.
        /// </summary>
        public ConversionActionName CallConversionActionAsConversionActionName
        {
