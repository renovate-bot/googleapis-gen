...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class MediaFileName : gax::IResourceName, sys::IEquatable<MediaFileName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/mediaFiles/{media_file}</c>.</summary>
            CustomerMediaFile = 1,
        }

        private static gax::PathTemplate s_customerMediaFile = new gax::PathTemplate("customers/{customer}/mediaFiles/{media_file}");
        ...
        /// <summary>
        /// Creates a <see cref="MediaFileName"/> with the pattern <c>customers/{customer}/mediaFiles/{media_file}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer}/mediaFiles/{media_file}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="mediaFileId">The <c>MediaFile</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/mediaFiles/{media_file}</c></description></item>
        /// </list>
        /// </remarks>
