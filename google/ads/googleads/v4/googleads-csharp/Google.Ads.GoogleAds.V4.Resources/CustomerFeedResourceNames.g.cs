...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class CustomerFeedName : gax::IResourceName, sys::IEquatable<CustomerFeedName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer}/customerFeeds/{customer_feed}</c>.
            /// </summary>
            CustomerCustomerFeed = 1,
        }

        private static gax::PathTemplate s_customerCustomerFeed = new gax::PathTemplate("customers/{customer}/customerFeeds/{customer_feed}");
        ...
        /// <summary>
        /// Creates a <see cref="CustomerFeedName"/> with the pattern
        /// <c>customers/{customer}/customerFeeds/{customer_feed}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="customerFeedId">The <c>CustomerFeed</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="CustomerFeedName"/> constructed from the provided ids.</returns>
        public static CustomerFeedName FromCustomerCustomerFeed(string customerId, string customerFeedId) =>
            new CustomerFeedName(ResourceNameType.CustomerCustomerFeed, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), customerFeedId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerFeedId, nameof(customerFeedId)));
        ...
        public static string Format(string customerId, string customerFeedId) =>
            FormatCustomerCustomerFeed(customerId, customerFeedId);
        ...
        /// <c>customers/{customer}/customerFeeds/{customer_feed}</c>.
        /// </returns>
        public static string FormatCustomerCustomerFeed(string customerId, string customerFeedId) =>
            s_customerCustomerFeed.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(customerFeedId, nameof(customerFeedId)));

        /// <summary>Parses the given resource name string into a new <see cref="CustomerFeedName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/customerFeeds/{customer_feed}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string customerFeedName, bool allowUnparsed, out CustomerFeedName result)
        {
            ...
            if (s_customerCustomerFeed.TryParseName(customerFeedName, out resourceName))
            {
                result = FromCustomerCustomerFeed(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private CustomerFeedName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string customerId = null, string customerFeedId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            CustomerId = customerId;
            CustomerFeedId = customerFeedId;
        }
        ...
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="customerFeedId">The <c>CustomerFeed</c> ID. Must not be <c>null</c> or empty.</param>
        public CustomerFeedName(string customerId, string customerFeedId) : this(ResourceNameType.CustomerCustomerFeed, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), customerFeedId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerFeedId, nameof(customerFeedId)))
        {
        }
        ...
        /// <summary>
        /// The <c>CustomerFeed</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.CustomerCustomerFeed: return s_customerCustomerFeed.Expand(CustomerId, CustomerFeedId);
