...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class ExpandedLandingPageViewName : gax::IResourceName, sys::IEquatable<ExpandedLandingPageViewName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>customers/{customer}/expandedLandingPageViews/{expanded_landing_page_view}</c>.
            /// </summary>
            CustomerExpandedLandingPageView = 1,
        }

        private static gax::PathTemplate s_customerExpandedLandingPageView = new gax::PathTemplate("customers/{customer}/expandedLandingPageViews/{expanded_landing_page_view}");
        ...
        /// <param name="expandedLandingPageViewId">
        /// The <c>ExpandedLandingPageView</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="ExpandedLandingPageViewName"/> constructed from the provided ids.
        /// </returns>
        public static ExpandedLandingPageViewName FromCustomerExpandedLandingPageView(string customerId, string expandedLandingPageViewId) =>
            new ExpandedLandingPageViewName(ResourceNameType.CustomerExpandedLandingPageView, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), expandedLandingPageViewId: gax::GaxPreconditions.CheckNotNullOrEmpty(expandedLandingPageViewId, nameof(expandedLandingPageViewId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ExpandedLandingPageViewName"/> with
        /// pattern <c>customers/{customer}/expandedLandingPageViews/{expanded_landing_page_view}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="expandedLandingPageViewId">
        /// The <c>ExpandedLandingPageView</c> ID. Must not be <c>null</c> or empty.
        ...
        public static string Format(string customerId, string expandedLandingPageViewId) =>
            FormatCustomerExpandedLandingPageView(customerId, expandedLandingPageViewId);
        ...
        /// <c>customers/{customer}/expandedLandingPageViews/{expanded_landing_page_view}</c>.
        /// </returns>
        public static string FormatCustomerExpandedLandingPageView(string customerId, string expandedLandingPageViewId) =>
            s_customerExpandedLandingPageView.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(expandedLandingPageViewId, nameof(expandedLandingPageViewId)));
        ...
        public static bool TryParse(string expandedLandingPageViewName, bool allowUnparsed, out ExpandedLandingPageViewName result)
        {
            ...
            if (s_customerExpandedLandingPageView.TryParseName(expandedLandingPageViewName, out resourceName))
            {
                result = FromCustomerExpandedLandingPageView(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ExpandedLandingPageViewName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string customerId = null, string expandedLandingPageViewId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            CustomerId = customerId;
            ExpandedLandingPageViewId = expandedLandingPageViewId;
        }
        ...
        /// The <c>ExpandedLandingPageView</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public ExpandedLandingPageViewName(string customerId, string expandedLandingPageViewId) : this(ResourceNameType.CustomerExpandedLandingPageView, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), expandedLandingPageViewId: gax::GaxPreconditions.CheckNotNullOrEmpty(expandedLandingPageViewId, nameof(expandedLandingPageViewId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ExpandedLandingPageView</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
    ...
    public partial class ExpandedLandingPageView
    {
        ...
        /// property.
        /// </summary>
        public ExpandedLandingPageViewName ResourceNameAsExpandedLandingPageViewName
        {
