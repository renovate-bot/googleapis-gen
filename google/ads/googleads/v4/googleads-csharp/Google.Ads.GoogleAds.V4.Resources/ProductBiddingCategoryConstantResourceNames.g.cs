...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class ProductBiddingCategoryConstantName : gax::IResourceName, sys::IEquatable<ProductBiddingCategoryConstantName>
    {
        ...
        /// <c>productBiddingCategoryConstants/{product_bidding_category_constant}</c>.
        /// </summary>
        /// <param name="productBiddingCategoryConstantId">
        /// The <c>ProductBiddingCategoryConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="ProductBiddingCategoryConstantName"/> constructed from the provided ids.
        /// </returns>
        public static ProductBiddingCategoryConstantName FromProductBiddingCategoryConstant(string productBiddingCategoryConstantId) =>
            new ProductBiddingCategoryConstantName(ResourceNameType.ProductBiddingCategoryConstant, productBiddingCategoryConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(productBiddingCategoryConstantId, nameof(productBiddingCategoryConstantId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ProductBiddingCategoryConstantName"/> with
        /// pattern <c>productBiddingCategoryConstants/{product_bidding_category_constant}</c>.
        /// </summary>
        /// <param name="productBiddingCategoryConstantId">
        /// The <c>ProductBiddingCategoryConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        ...
        public static string Format(string productBiddingCategoryConstantId) =>
            FormatProductBiddingCategoryConstant(productBiddingCategoryConstantId);
        ...
        /// <c>productBiddingCategoryConstants/{product_bidding_category_constant}</c>.
        /// </returns>
        public static string FormatProductBiddingCategoryConstant(string productBiddingCategoryConstantId) =>
            s_productBiddingCategoryConstant.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(productBiddingCategoryConstantId, nameof(productBiddingCategoryConstantId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>productBiddingCategoryConstants/{product_bidding_category_constant}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string productBiddingCategoryConstantName, bool allowUnparsed, out ProductBiddingCategoryConstantName result)
        {
            ...
            if (s_productBiddingCategoryConstant.TryParseName(productBiddingCategoryConstantName, out resourceName))
            {
                result = FromProductBiddingCategoryConstant(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ProductBiddingCategoryConstantName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string productBiddingCategoryConstantId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            ProductBiddingCategoryConstantId = productBiddingCategoryConstantId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="ProductBiddingCategoryConstantName"/> class from the component
        /// parts of pattern <c>productBiddingCategoryConstants/{product_bidding_category_constant}</c>
        /// </summary>
        /// <param name="productBiddingCategoryConstantId">
        /// The <c>ProductBiddingCategoryConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public ProductBiddingCategoryConstantName(string productBiddingCategoryConstantId) : this(ResourceNameType.ProductBiddingCategoryConstant, productBiddingCategoryConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(productBiddingCategoryConstantId, nameof(productBiddingCategoryConstantId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ProductBiddingCategoryConstant</c> ID. Will not be <c>null</c>, unless this instance contains an
        /// unparsed resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProductBiddingCategoryConstant: return s_productBiddingCategoryConstant.Expand(ProductBiddingCategoryConstantId);
    ...
    public partial class ProductBiddingCategoryConstant
    {
        ...
        /// name property.
        /// </summary>
        public ProductBiddingCategoryConstantName ResourceNameAsProductBiddingCategoryConstantName
        {
        ...
        /// </summary>
        public ProductBiddingCategoryConstantName ProductBiddingCategoryConstantParentAsProductBiddingCategoryConstantName
        {
