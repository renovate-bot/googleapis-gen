...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class InvoiceName : gax::IResourceName, sys::IEquatable<InvoiceName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/invoices/{invoice}</c>.</summary>
            CustomerInvoice = 1,
        }

        private static gax::PathTemplate s_customerInvoice = new gax::PathTemplate("customers/{customer}/invoices/{invoice}");
        ...
        /// <summary>
        /// Creates a <see cref="InvoiceName"/> with the pattern <c>customers/{customer}/invoices/{invoice}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer}/invoices/{invoice}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="invoiceId">The <c>Invoice</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/invoices/{invoice}</c></description></item>
        /// </list>
        /// </remarks>
    ...
    public partial class Invoice
    {
        ...
        /// </summary>
        public InvoiceName ResourceNameAsInvoiceName
        {
