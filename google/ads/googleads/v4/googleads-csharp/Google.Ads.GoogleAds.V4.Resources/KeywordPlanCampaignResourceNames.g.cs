...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class KeywordPlanCampaignName : gax::IResourceName, sys::IEquatable<KeywordPlanCampaignName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer}/keywordPlanCampaigns/{keyword_plan_campaign}</c>.
            /// </summary>
            CustomerKeywordPlanCampaign = 1,
        }

        private static gax::PathTemplate s_customerKeywordPlanCampaign = new gax::PathTemplate("customers/{customer}/keywordPlanCampaigns/{keyword_plan_campaign}");
        ...
        /// <c>customers/{customer}/keywordPlanCampaigns/{keyword_plan_campaign}</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>customers/{customer}/keywordPlanCampaigns/{keyword_plan_campaign}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        /// pattern <c>customers/{customer}/keywordPlanCampaigns/{keyword_plan_campaign}</c>
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="keywordPlanCampaignId">
        /// The <c>KeywordPlanCampaign</c> ID. Must not be <c>null</c> or empty.
    ...
    public partial class KeywordPlanCampaign
    {
        ...
        /// </summary>
        public KeywordPlanName KeywordPlanAsKeywordPlanName
        {
    ...
    public partial class KeywordPlanGeoTarget
    {
        ...
        /// property.
        /// </summary>
        public GeoTargetConstantName GeoTargetConstantAsGeoTargetConstantName
        {
