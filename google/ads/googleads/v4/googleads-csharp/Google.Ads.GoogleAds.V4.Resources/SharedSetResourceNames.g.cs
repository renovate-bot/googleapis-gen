...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class SharedSetName : gax::IResourceName, sys::IEquatable<SharedSetName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/sharedSets/{shared_set}</c>.</summary>
            CustomerSharedSet = 1,
        }

        private static gax::PathTemplate s_customerSharedSet = new gax::PathTemplate("customers/{customer}/sharedSets/{shared_set}");
        ...
        /// <summary>
        /// Creates a <see cref="SharedSetName"/> with the pattern <c>customers/{customer}/sharedSets/{shared_set}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer}/sharedSets/{shared_set}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="sharedSetId">The <c>SharedSet</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/sharedSets/{shared_set}</c></description></item>
        /// </list>
        /// </remarks>
    ...
    public partial class SharedSet
    {
        ...
        /// </summary>
        public gagvr::SharedSetName ResourceNameAsSharedSetName
        {
        ...
        /// </summary>
        public gagvr::SharedSetName SharedSetName
        {
