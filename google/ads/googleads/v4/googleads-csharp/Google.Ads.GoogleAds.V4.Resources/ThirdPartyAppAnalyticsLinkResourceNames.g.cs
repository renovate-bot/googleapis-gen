...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class ThirdPartyAppAnalyticsLinkName : gax::IResourceName, sys::IEquatable<ThirdPartyAppAnalyticsLinkName>
    {
        ...
        /// <param name="thirdPartyAppAnalyticsLinkId">
        /// The <c>ThirdPartyAppAnalyticsLink</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="ThirdPartyAppAnalyticsLinkName"/> constructed from the provided ids.
        /// </returns>
        public static ThirdPartyAppAnalyticsLinkName FromCustomerThirdPartyAppAnalyticsLink(string customerId, string thirdPartyAppAnalyticsLinkId) =>
            new ThirdPartyAppAnalyticsLinkName(ResourceNameType.CustomerThirdPartyAppAnalyticsLink, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), thirdPartyAppAnalyticsLinkId: gax::GaxPreconditions.CheckNotNullOrEmpty(thirdPartyAppAnalyticsLinkId, nameof(thirdPartyAppAnalyticsLinkId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="ThirdPartyAppAnalyticsLinkName"/> with
        /// pattern <c>customers/{customer}/thirdPartyAppAnalyticsLinks/{third_party_app_analytics_link}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="thirdPartyAppAnalyticsLinkId">
        /// The <c>ThirdPartyAppAnalyticsLink</c> ID. Must not be <c>null</c> or empty.
        ...
        /// <c>customers/{customer}/thirdPartyAppAnalyticsLinks/{third_party_app_analytics_link}</c>.
        /// </returns>
        public static string Format(string customerId, string thirdPartyAppAnalyticsLinkId) =>
            FormatCustomerThirdPartyAppAnalyticsLink(customerId, thirdPartyAppAnalyticsLinkId);
        ...
        /// <c>customers/{customer}/thirdPartyAppAnalyticsLinks/{third_party_app_analytics_link}</c>.
        /// </returns>
        public static string FormatCustomerThirdPartyAppAnalyticsLink(string customerId, string thirdPartyAppAnalyticsLinkId) =>
            s_customerThirdPartyAppAnalyticsLink.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(thirdPartyAppAnalyticsLinkId, nameof(thirdPartyAppAnalyticsLinkId)));
        ...
        public static bool TryParse(string thirdPartyAppAnalyticsLinkName, bool allowUnparsed, out ThirdPartyAppAnalyticsLinkName result)
        {
            ...
            if (s_customerThirdPartyAppAnalyticsLink.TryParseName(thirdPartyAppAnalyticsLinkName, out resourceName))
            {
                result = FromCustomerThirdPartyAppAnalyticsLink(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private ThirdPartyAppAnalyticsLinkName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string customerId = null, string thirdPartyAppAnalyticsLinkId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            CustomerId = customerId;
            ThirdPartyAppAnalyticsLinkId = thirdPartyAppAnalyticsLinkId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="ThirdPartyAppAnalyticsLinkName"/> class from the component parts
        /// of pattern <c>customers/{customer}/thirdPartyAppAnalyticsLinks/{third_party_app_analytics_link}</c>
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="thirdPartyAppAnalyticsLinkId">
        /// The <c>ThirdPartyAppAnalyticsLink</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public ThirdPartyAppAnalyticsLinkName(string customerId, string thirdPartyAppAnalyticsLinkId) : this(ResourceNameType.CustomerThirdPartyAppAnalyticsLink, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), thirdPartyAppAnalyticsLinkId: gax::GaxPreconditions.CheckNotNullOrEmpty(thirdPartyAppAnalyticsLinkId, nameof(thirdPartyAppAnalyticsLinkId)))
        {
        }
        ...
        /// <summary>
        /// The <c>ThirdPartyAppAnalyticsLink</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
        public string ThirdPartyAppAnalyticsLinkId { get; }
