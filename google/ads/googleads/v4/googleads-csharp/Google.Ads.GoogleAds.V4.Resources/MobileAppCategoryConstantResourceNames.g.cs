...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class MobileAppCategoryConstantName : gax::IResourceName, sys::IEquatable<MobileAppCategoryConstantName>
    {
        ...
        /// <c>mobileAppCategoryConstants/{mobile_app_category_constant}</c>.
        /// </summary>
        /// <param name="mobileAppCategoryConstantId">
        /// The <c>MobileAppCategoryConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>
        /// A new instance of <see cref="MobileAppCategoryConstantName"/> constructed from the provided ids.
        /// </returns>
        public static MobileAppCategoryConstantName FromMobileAppCategoryConstant(string mobileAppCategoryConstantId) =>
            new MobileAppCategoryConstantName(ResourceNameType.MobileAppCategoryConstant, mobileAppCategoryConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(mobileAppCategoryConstantId, nameof(mobileAppCategoryConstantId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="MobileAppCategoryConstantName"/> with
        /// pattern <c>mobileAppCategoryConstants/{mobile_app_category_constant}</c>.
        /// </summary>
        /// <param name="mobileAppCategoryConstantId">
        /// The <c>MobileAppCategoryConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        ...
        public static string Format(string mobileAppCategoryConstantId) =>
            FormatMobileAppCategoryConstant(mobileAppCategoryConstantId);
        ...
        /// <c>mobileAppCategoryConstants/{mobile_app_category_constant}</c>.
        /// </returns>
        public static string FormatMobileAppCategoryConstant(string mobileAppCategoryConstantId) =>
            s_mobileAppCategoryConstant.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(mobileAppCategoryConstantId, nameof(mobileAppCategoryConstantId)));
        ...
        /// <list type="bullet">
        /// <item><description><c>mobileAppCategoryConstants/{mobile_app_category_constant}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string mobileAppCategoryConstantName, bool allowUnparsed, out MobileAppCategoryConstantName result)
        {
            ...
            if (s_mobileAppCategoryConstant.TryParseName(mobileAppCategoryConstantName, out resourceName))
            {
                result = FromMobileAppCategoryConstant(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private MobileAppCategoryConstantName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string mobileAppCategoryConstantId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            MobileAppCategoryConstantId = mobileAppCategoryConstantId;
        }
        ...
        /// The <c>MobileAppCategoryConstant</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public MobileAppCategoryConstantName(string mobileAppCategoryConstantId) : this(ResourceNameType.MobileAppCategoryConstant, mobileAppCategoryConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(mobileAppCategoryConstantId, nameof(mobileAppCategoryConstantId)))
        {
        }
        ...
        /// <summary>
        /// The <c>MobileAppCategoryConstant</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.MobileAppCategoryConstant: return s_mobileAppCategoryConstant.Expand(MobileAppCategoryConstantId);
