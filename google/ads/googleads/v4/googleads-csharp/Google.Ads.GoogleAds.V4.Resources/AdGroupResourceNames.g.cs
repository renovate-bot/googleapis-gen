...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class AdGroupName : gax::IResourceName, sys::IEquatable<AdGroupName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/adGroups/{ad_group}</c>.</summary>
            CustomerAdGroup = 1,
        }

        private static gax::PathTemplate s_customerAdGroup = new gax::PathTemplate("customers/{customer}/adGroups/{ad_group}");
        ...
        /// <summary>
        /// Creates a <see cref="AdGroupName"/> with the pattern <c>customers/{customer}/adGroups/{ad_group}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer}/adGroups/{ad_group}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="adGroupId">The <c>AdGroup</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/adGroups/{ad_group}</c></description></item>
        /// </list>
        /// </remarks>
