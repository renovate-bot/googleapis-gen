...
namespace Google.Ads.GoogleAds.V4.Resources
{
    ...
    public sealed partial class CampaignName : gax::IResourceName, sys::IEquatable<CampaignName>
    {
        ...
        /// <summary>
        /// Creates a <see cref="CampaignName"/> with the pattern <c>customers/{customer}/campaigns/{campaign}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer}/campaigns/{campaign}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="campaignId">The <c>Campaign</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/campaigns/{campaign}</c></description></item>
        /// </list>
        /// </remarks>
