 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.errors.CampaignDraftErrorEnum</code>
 */
class CampaignDraftErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Errors\CampaignDraftError::initOnce();
