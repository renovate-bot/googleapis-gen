...
/**
 * Request message for [CarrierConstantService.GetCarrierConstant][google.ads.googleads.v4.services.CarrierConstantService.GetCarrierConstant].
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.GetCarrierConstantRequest</code>
 */
class GetCarrierConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Services\CarrierConstantService::initOnce();
