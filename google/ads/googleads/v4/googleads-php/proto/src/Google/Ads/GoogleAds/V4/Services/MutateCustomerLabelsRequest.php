 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.MutateCustomerLabelsRequest</code>
 */
class MutateCustomerLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.services.CustomerLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose customer-label relationships are being modified.
     *     @type \Google\Ads\GoogleAds\V4\Services\CustomerLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on customer-label relationships.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.services.CustomerLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V4\Services\CustomerLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V4\Services\CustomerLabelOperation::class);
        $this->operations = $arr;
