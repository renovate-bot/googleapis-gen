 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.UploadConversionAdjustmentsResponse</code>
 */
class UploadConversionAdjustmentsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.services.ConversionAdjustmentResult results = 2;</code>
     */
    private $results;
     ...
     *           https://developers.google.com/google-ads/api/docs/best-practices/partial-failures
     *           for more information about partial failure.
     *     @type \Google\Ads\GoogleAds\V4\Services\ConversionAdjustmentResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           Returned for successfully processed conversion adjustments. Proto will be
     *           empty for rows that received an error. Results are not returned when
     *           validate_only is true.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.services.ConversionAdjustmentResult results = 2;</code>
     * @param \Google\Ads\GoogleAds\V4\Services\ConversionAdjustmentResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V4\Services\ConversionAdjustmentResult::class);
        $this->results = $arr;
