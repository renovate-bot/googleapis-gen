 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.AccountBudgetProposalOperation</code>
 */
class AccountBudgetProposalOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           Proposals that modify budgets have the 'update' proposal type.  Specifying
     *           a mask for any other proposal type is considered an error.
     *     @type \Google\Ads\GoogleAds\V4\Resources\AccountBudgetProposal $create
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Services\AccountBudgetProposalService::initOnce();
     ...
     * No resource name is expected for the new proposal.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.AccountBudgetProposal create = 2;</code>
