...
class ApplyRecommendationOperation extends \Google\Protobuf\Internal\Message
{
     ...
     * @return \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\CampaignBudgetParameters|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\CampaignBudgetParameters::class);
     ...
     * @return \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\TextAdParameters|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\TextAdParameters::class);
     ...
     * @return \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\KeywordParameters|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\KeywordParameters::class);
     ...
     * @return \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\TargetCpaOptInParameters|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\TargetCpaOptInParameters::class);
     ...
     * @return \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\CalloutExtensionParameters|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\CalloutExtensionParameters::class);
     ...
     * @return \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\CallExtensionParameters|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\CallExtensionParameters::class);
     ...
     * @return \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\SitelinkExtensionParameters|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\SitelinkExtensionParameters::class);
     ...
     * @return \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\MoveUnusedBudgetParameters|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\ApplyRecommendationOperation\MoveUnusedBudgetParameters::class);
