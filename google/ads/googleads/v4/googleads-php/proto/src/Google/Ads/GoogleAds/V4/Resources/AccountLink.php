...
class AccountLink extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AccountLinkStatusEnum\AccountLinkStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\LinkedAccountTypeEnum\LinkedAccountType::class);
        $this->type = $var;
