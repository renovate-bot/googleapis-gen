 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.errors.MediaBundleErrorEnum</code>
 */
class MediaBundleErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Errors\MediaBundleError::initOnce();
