 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.Campaign.NetworkSettings</code>
 */
class NetworkSettings extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->target_google_search) ? $this->target_google_search : null;
    }
    ...
    {
        return isset($this->target_search_network) ? $this->target_search_network : null;
    }
    ...
    {
        return isset($this->target_content_network) ? $this->target_content_network : null;
    }
    ...
    {
        return isset($this->target_partner_search_network) ? $this->target_partner_search_network : null;
    }
...
class_alias(NetworkSettings::class, \Google\Ads\GoogleAds\V4\Resources\Campaign_NetworkSettings::class);
