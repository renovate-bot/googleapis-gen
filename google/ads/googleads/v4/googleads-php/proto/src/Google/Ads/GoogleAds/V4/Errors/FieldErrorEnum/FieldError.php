...
namespace Google\Ads\GoogleAds\V4\Errors\FieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.FieldErrorEnum.FieldError</code>
 */
class FieldError
{
    /**
...
class_alias(FieldError::class, \Google\Ads\GoogleAds\V4\Errors\FieldErrorEnum_FieldError::class);
