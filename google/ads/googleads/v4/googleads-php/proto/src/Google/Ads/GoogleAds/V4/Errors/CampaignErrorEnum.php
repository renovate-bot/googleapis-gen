 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.errors.CampaignErrorEnum</code>
 */
class CampaignErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Errors\CampaignError::initOnce();
