...
class BiddingStrategy extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\BiddingStrategyStatusEnum\BiddingStrategyStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\BiddingStrategyTypeEnum\BiddingStrategyType::class);
        $this->type = $var;
    ...
    {
        return isset($this->campaign_count) ? $this->campaign_count : null;
    }
    ...
    {
        return isset($this->non_removed_campaign_count) ? $this->non_removed_campaign_count : null;
    }
