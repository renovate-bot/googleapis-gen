...
namespace Google\Ads\GoogleAds\V4\Enums\AccessRoleEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.enums.AccessRoleEnum.AccessRole</code>
 */
class AccessRole
{
    /**
...
class_alias(AccessRole::class, \Google\Ads\GoogleAds\V4\Enums\AccessRoleEnum_AccessRole::class);
