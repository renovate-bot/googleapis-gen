 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.common.Operand.ConstantOperand</code>
 */
...
class_alias(ConstantOperand::class, \Google\Ads\GoogleAds\V4\Common\Operand_ConstantOperand::class);
