 ...
 * call.
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.common.DisplayCallToAction</code>
 */
class DisplayCallToAction extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->text_color) ? $this->text_color : null;
    }
    ...
    {
        return isset($this->url_collection_id) ? $this->url_collection_id : null;
    }
