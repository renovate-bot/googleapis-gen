 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest</code>
 */
class MutateCampaignExtensionSettingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * settings.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.services.CampaignExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose campaign extension settings are being
     *           modified.
     *     @type \Google\Ads\GoogleAds\V4\Services\CampaignExtensionSettingOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign extension
     *           settings.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.services.CampaignExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V4\Services\CampaignExtensionSettingOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V4\Services\CampaignExtensionSettingOperation::class);
        $this->operations = $arr;
