...
class AdGroupAdAssetView extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AssetFieldTypeEnum\AssetFieldType::class);
        $this->field_type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.AdGroupAdAssetPolicySummary policy_summary = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V4\Resources\AdGroupAdAssetPolicySummary|null
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AssetPerformanceLabelEnum\AssetPerformanceLabel::class);
