...
class CrmBasedUserListInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\CustomerMatchUploadKeyTypeEnum\CustomerMatchUploadKeyType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\UserListCrmDataSourceTypeEnum\UserListCrmDataSourceType::class);
