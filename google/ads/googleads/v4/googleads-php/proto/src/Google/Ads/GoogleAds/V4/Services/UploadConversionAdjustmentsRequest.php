 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.UploadConversionAdjustmentsRequest</code>
 */
class UploadConversionAdjustmentsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.services.ConversionAdjustment conversion_adjustments = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The ID of the customer performing the upload.
     *     @type \Google\Ads\GoogleAds\V4\Services\ConversionAdjustment[]|\Google\Protobuf\Internal\RepeatedField $conversion_adjustments
     *           Required. The conversion adjustments that are being uploaded.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.services.ConversionAdjustment conversion_adjustments = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V4\Services\ConversionAdjustment[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setConversionAdjustments($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V4\Services\ConversionAdjustment::class);
