 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.ProductMetadata</code>
 */
class ProductMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *           The code associated with the ad product. E.g. BUMPER, TRUEVIEW_IN_STREAM
     *           To list the available plannable product codes use ListPlannableProducts.
     *     @type \Google\Ads\GoogleAds\V4\Services\PlannableTargeting $plannable_targeting
     *           The allowed plannable targeting for this product.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.services.PlannableTargeting plannable_targeting = 2;</code>
     * @param \Google\Ads\GoogleAds\V4\Services\PlannableTargeting $var
     * @return $this
     */
    public function setPlannableTargeting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\PlannableTargeting::class);
