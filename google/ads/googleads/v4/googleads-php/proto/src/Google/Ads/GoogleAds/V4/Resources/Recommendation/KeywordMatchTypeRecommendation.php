 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.Recommendation.KeywordMatchTypeRecommendation</code>
 */
class KeywordMatchTypeRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.KeywordMatchTypeEnum.KeywordMatchType recommended_match_type = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\KeywordMatchTypeEnum\KeywordMatchType::class);
...
class_alias(KeywordMatchTypeRecommendation::class, \Google\Ads\GoogleAds\V4\Resources\Recommendation_KeywordMatchTypeRecommendation::class);
