...
class SuggestGeoTargetConstantsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\SuggestGeoTargetConstantsRequest\LocationNames::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Services\SuggestGeoTargetConstantsRequest\GeoTargets::class);
