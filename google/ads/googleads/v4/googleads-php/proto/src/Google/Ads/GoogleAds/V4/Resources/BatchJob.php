...
class BatchJob extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\BatchJob\BatchJobMetadata::class);
        $this->metadata = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\BatchJobStatusEnum\BatchJobStatus::class);
        $this->status = $var;
