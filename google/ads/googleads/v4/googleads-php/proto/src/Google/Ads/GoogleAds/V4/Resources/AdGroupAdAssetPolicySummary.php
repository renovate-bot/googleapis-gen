...
# source: google/ads/googleads/v4/resources/ad_group_ad_asset_view.proto
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.AdGroupAdAssetPolicySummary</code>
 */
class AdGroupAdAssetPolicySummary extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.common.PolicyTopicEntry policy_topic_entries = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $policy_topic_entries;
    /**
     * Output only. Where in the review process this ad group ad asset is.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.PolicyReviewStatusEnum.PolicyReviewStatus review_status = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus approval_status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Resources\AdGroupAdAssetView::initOnce();
