...
namespace Google\Ads\GoogleAds\V4\Resources\Recommendation\CampaignBudgetRecommendation;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption</code>
 */
class CampaignBudgetRecommendationOption extends \Google\Protobuf\Internal\Message
{
     ...
     * option.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.Recommendation.RecommendationImpact impact = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        return isset($this->budget_amount_micros) ? $this->budget_amount_micros : null;
    }
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.Recommendation.RecommendationImpact impact = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V4\Resources\Recommendation\RecommendationImpact|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\Recommendation\RecommendationImpact::class);
        $this->impact = $var;
...
class_alias(CampaignBudgetRecommendationOption::class, \Google\Ads\GoogleAds\V4\Resources\Recommendation_CampaignBudgetRecommendation_CampaignBudgetRecommendationOption::class);
