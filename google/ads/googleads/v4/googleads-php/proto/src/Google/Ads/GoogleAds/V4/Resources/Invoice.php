...
class Invoice extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\InvoiceTypeEnum\InvoiceType::class);
        $this->type = $var;
    ...
    {
        return isset($this->issue_date) ? $this->issue_date : null;
    }
    ...
    {
        return isset($this->invoice_level_adjustments_micros) ? $this->invoice_level_adjustments_micros : null;
    }

    public function hasInvoiceLevelAdjustmentsMicros()
    {
        return isset($this->invoice_level_adjustments_micros);
    }

    public function clearInvoiceLevelAdjustmentsMicros()
    {
        unset($this->invoice_level_adjustments_micros);
    }
    ...
    {
        return isset($this->corrected_invoice) ? $this->corrected_invoice : null;
    }
