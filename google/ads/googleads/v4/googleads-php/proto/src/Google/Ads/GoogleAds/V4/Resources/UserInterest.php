 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.UserInterest</code>
 */
class UserInterest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType taxonomy_type = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. True if the user interest is launched to all channels and locales.
     *     @type \Google\Ads\GoogleAds\V4\Common\CriterionCategoryAvailability[]|\Google\Protobuf\Internal\RepeatedField $availabilities
     *           Output only. Availability information of the user interest.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Resources\UserInterest::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\UserInterestTaxonomyTypeEnum\UserInterestTaxonomyType::class);
    ...
    {
        return isset($this->user_interest_id) ? $this->user_interest_id : null;
    }
    ...
    {
        return isset($this->user_interest_parent) ? $this->user_interest_parent : null;
    }
    ...
    {
        return isset($this->launched_to_all) ? $this->launched_to_all : null;
    }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v4.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V4\Common\CriterionCategoryAvailability[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAvailabilities($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V4\Common\CriterionCategoryAvailability::class);
