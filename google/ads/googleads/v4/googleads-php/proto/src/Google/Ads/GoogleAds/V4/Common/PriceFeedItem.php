...
class PriceFeedItem extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\PriceExtensionTypeEnum\PriceExtensionType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\PriceExtensionPriceQualifierEnum\PriceExtensionPriceQualifier::class);
