 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.MobileDeviceConstant</code>
 */
class MobileDeviceConstant extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.MobileDeviceTypeEnum.MobileDeviceType type = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $type = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Resources\MobileDeviceConstant::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\MobileDeviceTypeEnum\MobileDeviceType::class);
        $this->type = $var;
