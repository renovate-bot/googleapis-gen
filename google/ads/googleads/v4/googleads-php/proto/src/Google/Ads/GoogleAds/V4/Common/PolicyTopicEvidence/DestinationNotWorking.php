 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.common.PolicyTopicEvidence.DestinationNotWorking</code>
 */
class DestinationNotWorking extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDevice device = 4;</code>
     */
    protected $device = 0;
    /**
    ...
    {
        return isset($this->expanded_url) ? $this->expanded_url : null;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\PolicyTopicEvidenceDestinationNotWorkingDeviceEnum\PolicyTopicEvidenceDestinationNotWorkingDevice::class);
        $this->device = $var;
    ...
    {
        return isset($this->last_checked_date_time) ? $this->last_checked_date_time : null;
    }
     ...
     * The type of DNS error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorType dns_error_type = 1;</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum\PolicyTopicEvidenceDestinationNotWorkingDnsErrorType::class);
...
class_alias(DestinationNotWorking::class, \Google\Ads\GoogleAds\V4\Common\PolicyTopicEvidence_DestinationNotWorking::class);
