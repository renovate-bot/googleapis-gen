 ...
 * be validated.
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.common.ProximityInfo</code>
 */
class ProximityInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.GeoPointInfo geo_point = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.ProximityRadiusUnitsEnum.ProximityRadiusUnits radius_units = 3;</code>
     */
    protected $radius_units = 0;
    /**
     * Full address.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.AddressInfo address = 4;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V4\Common\GeoPointInfo $geo_point
     *           Latitude and longitude.
     *     @type \Google\Protobuf\DoubleValue $radius
     *           The radius of the proximity.
     *     @type int $radius_units
     *           The unit of measurement of the radius. Default is KILOMETERS.
     *     @type \Google\Ads\GoogleAds\V4\Common\AddressInfo $address
     *           Full address.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.GeoPointInfo geo_point = 1;</code>
     * @return \Google\Ads\GoogleAds\V4\Common\GeoPointInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.GeoPointInfo geo_point = 1;</code>
     * @param \Google\Ads\GoogleAds\V4\Common\GeoPointInfo $var
     * @return $this
     */
    public function setGeoPoint($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Common\GeoPointInfo::class);
        $this->geo_point = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\ProximityRadiusUnitsEnum\ProximityRadiusUnits::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.AddressInfo address = 4;</code>
     * @return \Google\Ads\GoogleAds\V4\Common\AddressInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.AddressInfo address = 4;</code>
     * @param \Google\Ads\GoogleAds\V4\Common\AddressInfo $var
     * @return $this
     */
    public function setAddress($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Common\AddressInfo::class);
        $this->address = $var;
