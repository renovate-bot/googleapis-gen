...
class TargetRestrictionOperation extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Common\TargetRestrictionOperation\Operator::class);
        $this->operator = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.TargetRestriction value = 2;</code>
     * @return \Google\Ads\GoogleAds\V4\Common\TargetRestriction|null
     */
