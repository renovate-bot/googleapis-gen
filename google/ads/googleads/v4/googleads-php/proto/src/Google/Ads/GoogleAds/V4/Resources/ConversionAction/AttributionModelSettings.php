...
class AttributionModelSettings extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AttributionModelEnum\AttributionModel::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\DataDrivenModelStatusEnum\DataDrivenModelStatus::class);
