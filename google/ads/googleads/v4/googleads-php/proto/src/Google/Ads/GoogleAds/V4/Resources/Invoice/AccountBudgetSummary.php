...
namespace Google\Ads\GoogleAds\V4\Resources\Invoice;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary</code>
 */
class AccountBudgetSummary extends \Google\Protobuf\Internal\Message
{
     ...
     *           in micros. This equals the sum of the account budget subtotal amount and
     *           the account budget tax amount.
     *     @type \Google\Ads\GoogleAds\V4\Common\DateRange $billable_activity_date_range
     *           Output only. The billable activity date range of the account budget, within the
     *           service date range of this invoice. The end date is inclusive. This can
     *           be different from the account budget's start and end time.
     * }
    ...
    {
        return isset($this->customer_descriptive_name) ? $this->customer_descriptive_name : null;
    }
    ...
    {
        return isset($this->account_budget_name) ? $this->account_budget_name : null;
    }
    ...
    {
        return isset($this->subtotal_amount_micros) ? $this->subtotal_amount_micros : null;
    }
    ...
    {
        return isset($this->tax_amount_micros) ? $this->tax_amount_micros : null;
    }
...
class_alias(AccountBudgetSummary::class, \Google\Ads\GoogleAds\V4\Resources\Invoice_AccountBudgetSummary::class);
