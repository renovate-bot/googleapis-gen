...
class Feed extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\FeedOriginEnum\FeedOrigin::class);
        $this->origin = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\FeedStatusEnum\FeedStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\Feed\PlacesLocationFeedData::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\Feed\AffiliateLocationFeedData::class);
