 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.enums.GeoTargetingTypeEnum</code>
 */
class GeoTargetingTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Enums\GeoTargetingType::initOnce();
