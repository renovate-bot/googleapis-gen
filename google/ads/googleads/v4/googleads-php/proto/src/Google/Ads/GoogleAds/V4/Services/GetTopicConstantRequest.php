 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.GetTopicConstantRequest</code>
 */
class GetTopicConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Services\TopicConstantService::initOnce();
