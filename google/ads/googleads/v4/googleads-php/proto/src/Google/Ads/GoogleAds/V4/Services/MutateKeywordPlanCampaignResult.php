 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.MutateKeywordPlanCampaignResult</code>
 */
class MutateKeywordPlanCampaignResult extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Services\KeywordPlanCampaignService::initOnce();
