...
class FrequencyCapKey extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\FrequencyCapLevelEnum\FrequencyCapLevel::class);
        $this->level = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\FrequencyCapEventTypeEnum\FrequencyCapEventType::class);
        $this->event_type = $var;
    ...
    {
        return isset($this->time_length) ? $this->time_length : null;
    }
