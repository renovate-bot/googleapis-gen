...
class GoogleAdsField extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\GoogleAdsFieldCategoryEnum\GoogleAdsFieldCategory::class);
        $this->category = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\GoogleAdsFieldDataTypeEnum\GoogleAdsFieldDataType::class);
        $this->data_type = $var;
