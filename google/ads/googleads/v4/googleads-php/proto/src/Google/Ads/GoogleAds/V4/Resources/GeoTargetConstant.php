...
class GeoTargetConstant extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->target_type) ? $this->target_type : null;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\GeoTargetConstantStatusEnum\GeoTargetConstantStatus::class);
        $this->status = $var;
    ...
    {
        return isset($this->canonical_name) ? $this->canonical_name : null;
    }
