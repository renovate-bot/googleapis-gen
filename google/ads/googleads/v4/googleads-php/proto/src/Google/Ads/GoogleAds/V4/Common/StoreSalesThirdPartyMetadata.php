 ...
 * configuration.
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.common.StoreSalesThirdPartyMetadata</code>
 */
class StoreSalesThirdPartyMetadata extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->advertiser_upload_date_time) ? $this->advertiser_upload_date_time : null;
    }
    ...
    {
        return isset($this->valid_transaction_fraction) ? $this->valid_transaction_fraction : null;
    }
    ...
    {
        return isset($this->partner_match_fraction) ? $this->partner_match_fraction : null;
    }
    ...
    {
        return isset($this->partner_upload_fraction) ? $this->partner_upload_fraction : null;
    }
    ...
    {
        return isset($this->bridge_map_version_id) ? $this->bridge_map_version_id : null;
    }
    ...
    {
        return isset($this->partner_id) ? $this->partner_id : null;
    }
