 ...
 * request.
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.resources.ClickView</code>
 */
class ClickView extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. The Google Click ID.
     *     @type \Google\Ads\GoogleAds\V4\Common\ClickLocation $area_of_interest
     *           Output only. The location criteria matching the area of interest associated with the
     *           impression.
     *     @type \Google\Ads\GoogleAds\V4\Common\ClickLocation $location_of_presence
     *           Output only. The location criteria matching the location of presence associated with the
     *           impression.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Resources\ClickView::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.ClickLocation area_of_interest = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V4\Common\ClickLocation $var
     * @return $this
     */
    public function setAreaOfInterest($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Common\ClickLocation::class);
    ...
    {
        return isset($this->page_number) ? $this->page_number : null;
    }
