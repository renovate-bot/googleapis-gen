 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.CreateCustomerClientRequest</code>
 */
class CreateCustomerClientRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.enums.AccessRoleEnum.AccessRole access_role = 4;</code>
     */
     ...
     *           Required. The ID of the Manager under whom client customer is being created.
     *     @type \Google\Ads\GoogleAds\V4\Resources\Customer $customer_client
     *           Required. The new client customer to create. The resource name on this customer
     *           will be ignored.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AccessRoleEnum\AccessRole::class);
