...
class DisplayUploadAdInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\DisplayUploadProductTypeEnum\DisplayUploadProductType::class);
     ...
     * @return \Google\Ads\GoogleAds\V4\Common\AdMediaBundleAsset|null
     */
