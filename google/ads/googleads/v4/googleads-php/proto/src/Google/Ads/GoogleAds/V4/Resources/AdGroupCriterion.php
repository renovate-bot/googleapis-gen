...
class AdGroupCriterion extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AdGroupCriterionStatusEnum\AdGroupCriterionStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.AdGroupCriterion.QualityInfo quality_info = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V4\Resources\AdGroupCriterion\QualityInfo|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\AdGroupCriterion\QualityInfo::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\CriterionSystemServingStatusEnum\CriterionSystemServingStatus::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AdGroupCriterionApprovalStatusEnum\AdGroupCriterionApprovalStatus::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\BiddingSourceEnum\BiddingSource::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.resources.AdGroupCriterion.PositionEstimates position_estimates = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V4\Resources\AdGroupCriterion\PositionEstimates|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Resources\AdGroupCriterion\PositionEstimates::class);
     ...
     * @return \Google\Ads\GoogleAds\V4\Common\ListingGroupInfo|null
     */
     ...
     * @return \Google\Ads\GoogleAds\V4\Common\AppPaymentModelInfo|null
     */
     ...
     * @return \Google\Ads\GoogleAds\V4\Common\CustomIntentInfo|null
     */
