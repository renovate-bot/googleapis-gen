...
namespace Google\Ads\GoogleAds\V4\Errors\BiddingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.BiddingErrorEnum.BiddingError</code>
 */
class BiddingError
{
    /**
...
class_alias(BiddingError::class, \Google\Ads\GoogleAds\V4\Errors\BiddingErrorEnum_BiddingError::class);
