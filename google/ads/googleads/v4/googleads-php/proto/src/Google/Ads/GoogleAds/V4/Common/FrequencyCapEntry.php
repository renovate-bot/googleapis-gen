 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.common.FrequencyCapEntry</code>
 */
class FrequencyCapEntry extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Ads\GoogleAds\V4\Common\FrequencyCapKey $key
     *           The key of a particular frequency cap. There can be no more
     *           than one frequency cap with the same key.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.FrequencyCapKey key = 1;</code>
     * @param \Google\Ads\GoogleAds\V4\Common\FrequencyCapKey $var
     * @return $this
     */
    public function setKey($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Common\FrequencyCapKey::class);
        $this->key = $var;
