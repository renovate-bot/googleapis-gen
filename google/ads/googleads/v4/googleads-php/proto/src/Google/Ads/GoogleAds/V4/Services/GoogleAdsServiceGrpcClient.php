...
class GoogleAdsServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V4\Services\SearchGoogleAdsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function Search(\Google\Ads\GoogleAds\V4\Services\SearchGoogleAdsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v4.services.GoogleAdsService/Search',
        $argument,
        ['\Google\Ads\GoogleAds\V4\Services\SearchGoogleAdsResponse', 'decode'],
        $metadata, $options);
    }

    /**
     * Returns all rows that match the search stream query.
     * @param \Google\Ads\GoogleAds\V4\Services\SearchGoogleAdsStreamRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\ServerStreamingCall
     */
    public function SearchStream(\Google\Ads\GoogleAds\V4\Services\SearchGoogleAdsStreamRequest $argument,
      $metadata = [], $options = []) {
        return $this->_serverStreamRequest('/google.ads.googleads.v4.services.GoogleAdsService/SearchStream',
        $argument,
        ['\Google\Ads\GoogleAds\V4\Services\SearchGoogleAdsStreamResponse', 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Ads\GoogleAds\V4\Services\MutateGoogleAdsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function Mutate(\Google\Ads\GoogleAds\V4\Services\MutateGoogleAdsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v4.services.GoogleAdsService/Mutate',
        $argument,
        ['\Google\Ads\GoogleAds\V4\Services\MutateGoogleAdsResponse', 'decode'],
        $metadata, $options);
    }
