...
class CustomerManagerLink extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->manager_customer) ? $this->manager_customer : null;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\ManagerLinkStatusEnum\ManagerLinkStatus::class);
        $this->status = $var;
