...
class AdGroup extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AdGroupStatusEnum\AdGroupStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AdGroupTypeEnum\AdGroupType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\AdGroupAdRotationModeEnum\AdGroupAdRotationMode::class);
    ...
    {
        return isset($this->target_cpm_micros) ? $this->target_cpm_micros : null;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\TargetingDimensionEnum\TargetingDimension::class);
    ...
    {
        return isset($this->effective_target_cpa_micros) ? $this->effective_target_cpa_micros : null;
    }
    ...
    {
        return isset($this->effective_target_roas) ? $this->effective_target_roas : null;
    }
