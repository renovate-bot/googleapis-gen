...
namespace Google\Ads\GoogleAds\V4\Errors\AdGroupErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v4.errors.AdGroupErrorEnum.AdGroupError</code>
 */
class AdGroupError
{
    /**
...
class_alias(AdGroupError::class, \Google\Ads\GoogleAds\V4\Errors\AdGroupErrorEnum_AdGroupError::class);
