...
class MerchantCenterLink extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->merchant_center_account_name) ? $this->merchant_center_account_name : null;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\MerchantCenterLinkStatusEnum\MerchantCenterLinkStatus::class);
        $this->status = $var;
