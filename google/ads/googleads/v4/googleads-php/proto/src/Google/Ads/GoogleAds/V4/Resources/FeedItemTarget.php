...
class FeedItemTarget extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\FeedItemTargetTypeEnum\FeedItemTargetType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V4\Enums\FeedItemTargetStatusEnum\FeedItemTargetStatus::class);
        $this->status = $var;
