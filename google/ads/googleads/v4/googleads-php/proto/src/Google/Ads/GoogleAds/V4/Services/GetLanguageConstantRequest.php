 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.GetLanguageConstantRequest</code>
 */
class GetLanguageConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Services\LanguageConstantService::initOnce();
