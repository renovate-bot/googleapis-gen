 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.KeywordPlanKeywordHistoricalMetrics</code>
 */
class KeywordPlanKeywordHistoricalMetrics extends \Google\Protobuf\Internal\Message
{
     ...
     *           Starting V5, the list of de-duped queries will be included in
     *           close_variants field.
     *     @type \Google\Ads\GoogleAds\V4\Common\KeywordPlanHistoricalMetrics $keyword_metrics
     *           The historical metrics for the query associated with one or more
     *           ad_group_keywords in the plan.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.KeywordPlanHistoricalMetrics keyword_metrics = 2;</code>
     * @param \Google\Ads\GoogleAds\V4\Common\KeywordPlanHistoricalMetrics $var
     * @return $this
     */
    public function setKeywordMetrics($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Common\KeywordPlanHistoricalMetrics::class);
