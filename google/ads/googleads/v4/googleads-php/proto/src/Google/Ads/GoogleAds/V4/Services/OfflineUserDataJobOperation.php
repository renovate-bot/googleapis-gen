 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.services.OfflineUserDataJobOperation</code>
 */
class OfflineUserDataJobOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Ads\GoogleAds\V4\Common\UserData $create
     *           Add the provided data to the transaction. Data cannot be retrieved after
     *           being uploaded.
     *     @type \Google\Ads\GoogleAds\V4\Common\UserData $remove
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Services\OfflineUserDataJobService::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v4.common.UserData create = 1;</code>
     * @param \Google\Ads\GoogleAds\V4\Common\UserData $var
     * @return $this
     */
    public function setCreate($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V4\Common\UserData::class);
