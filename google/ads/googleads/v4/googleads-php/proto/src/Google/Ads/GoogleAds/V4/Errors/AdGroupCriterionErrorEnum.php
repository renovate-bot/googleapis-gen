 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v4.errors.AdGroupCriterionErrorEnum</code>
 */
class AdGroupCriterionErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V4\Errors\AdGroupCriterionError::initOnce();
