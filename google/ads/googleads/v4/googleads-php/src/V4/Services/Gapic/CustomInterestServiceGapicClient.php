 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/custom_interest_service.proto
...
use Google\Ads\GoogleAds\V4\Resources\CustomInterest;
use Google\Ads\GoogleAds\V4\Services\CustomInterestOperation;
use Google\Ads\GoogleAds\V4\Services\GetCustomInterestRequest;
use Google\Ads\GoogleAds\V4\Services\MutateCustomInterestsRequest;
use Google\Ads\GoogleAds\V4\Services\MutateCustomInterestsResponse;
 ...
 * try {
 *     $formattedResourceName = $customInterestServiceClient->customInterestName('[CUSTOMER]', '[CUSTOM_INTEREST]');
...
class CustomInterestServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.CustomInterestService';
    ...
    {
        if (null == self::$customInterestNameTemplate) {
            self::$customInterestNameTemplate = new PathTemplate('customers/{customer}/customInterests/{custom_interest}');
        }
     ...
     * a custom_interest resource.
     *
     * @param string $customer
     * @param string $customInterest
     *
     * @return string The formatted custom_interest resource.
     * @experimental
     */
    public static function customInterestName($customer, $customInterest)
    {
     ...
     * Template: Pattern
     * - customInterest: customers/{customer}/customInterests/{custom_interest}.
     *
    ...
    public function mutateCustomInterests($customerId, $operations, array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            ...
            MutateCustomInterestsResponse::class,
            $optionalArgs,
            $request
        )->wait();
    }
