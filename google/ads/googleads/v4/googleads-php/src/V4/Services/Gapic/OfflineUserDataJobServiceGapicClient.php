 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/offline_user_data_job_service.proto
...
use Google\Ads\GoogleAds\V4\Services\AddOfflineUserDataJobOperationsRequest;
use Google\Ads\GoogleAds\V4\Services\AddOfflineUserDataJobOperationsResponse;
use Google\Ads\GoogleAds\V4\Services\CreateOfflineUserDataJobRequest;
use Google\Ads\GoogleAds\V4\Services\CreateOfflineUserDataJobResponse;
use Google\Ads\GoogleAds\V4\Services\GetOfflineUserDataJobRequest;
use Google\Ads\GoogleAds\V4\Services\OfflineUserDataJobOperation;
use Google\Ads\GoogleAds\V4\Services\RunOfflineUserDataJobRequest;
...
class OfflineUserDataJobServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.OfflineUserDataJobService';
