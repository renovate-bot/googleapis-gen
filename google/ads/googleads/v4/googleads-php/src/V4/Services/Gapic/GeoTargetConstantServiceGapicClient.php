 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/geo_target_constant_service.proto
 * and updates to that file get reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V4\Services\Gapic;

use Google\Ads\GoogleAds\V4\Resources\GeoTargetConstant;
use Google\Ads\GoogleAds\V4\Services\GetGeoTargetConstantRequest;
use Google\Ads\GoogleAds\V4\Services\SuggestGeoTargetConstantsRequest;

use Google\Ads\GoogleAds\V4\Services\SuggestGeoTargetConstantsRequest\GeoTargets;
use Google\Ads\GoogleAds\V4\Services\SuggestGeoTargetConstantsRequest\LocationNames;
use Google\Ads\GoogleAds\V4\Services\SuggestGeoTargetConstantsResponse;
...
class GeoTargetConstantServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.GeoTargetConstantService';
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V4\Services\SuggestGeoTargetConstantsResponse
     *
     * @throws ApiException if the remote call fails
     */
