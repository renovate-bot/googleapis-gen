 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/ad_group_service.proto
...
use Google\Ads\GoogleAds\V4\Services\GetAdGroupRequest;
use Google\Ads\GoogleAds\V4\Services\MutateAdGroupsRequest;
 ...
 * try {
 *     $formattedResourceName = $adGroupServiceClient->adGroupName('[CUSTOMER]', '[AD_GROUP]');
...
class AdGroupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.AdGroupService';
    ...
    {
        if (null == self::$adGroupNameTemplate) {
            self::$adGroupNameTemplate = new PathTemplate('customers/{customer}/adGroups/{ad_group}');
        }
     ...
     * @experimental
     */
    public static function adGroupName($customer, $adGroup)
    {
