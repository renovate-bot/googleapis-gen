 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/parental_status_view_service.proto
 * and updates to that file get reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V4\Services\Gapic;

use Google\Ads\GoogleAds\V4\Resources\ParentalStatusView;
use Google\Ads\GoogleAds\V4\Services\GetParentalStatusViewRequest;
...
class ParentalStatusViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.ParentalStatusViewService';
    ...
    public function getParentalStatusView($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetParentalStatusView', ParentalStatusView::class, $optionalArgs, $request)->wait();
    }
}
