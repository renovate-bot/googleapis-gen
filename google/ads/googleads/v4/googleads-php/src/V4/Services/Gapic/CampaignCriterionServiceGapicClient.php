 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/campaign_criterion_service.proto
...
use Google\Ads\GoogleAds\V4\Services\GetCampaignCriterionRequest;

use Google\Ads\GoogleAds\V4\Services\MutateCampaignCriteriaRequest;
use Google\Ads\GoogleAds\V4\Services\MutateCampaignCriteriaResponse;
...
class CampaignCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.CampaignCriterionService';
    ...
    public function getCampaignCriterion($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetCampaignCriterion', CampaignCriterion::class, $optionalArgs, $request)->wait();
    }
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V4\Services\MutateCampaignCriteriaResponse
     *
     * @throws ApiException if the remote call fails
     */
