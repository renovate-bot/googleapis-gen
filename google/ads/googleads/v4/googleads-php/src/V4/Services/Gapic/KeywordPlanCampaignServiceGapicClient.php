 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/keyword_plan_campaign_service.proto
...
use Google\Ads\GoogleAds\V4\Services\GetKeywordPlanCampaignRequest;
use Google\Ads\GoogleAds\V4\Services\KeywordPlanCampaignOperation;

use Google\Ads\GoogleAds\V4\Services\MutateKeywordPlanCampaignsRequest;
use Google\Ads\GoogleAds\V4\Services\MutateKeywordPlanCampaignsResponse;
...
class KeywordPlanCampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.KeywordPlanCampaignService';
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V4\Services\MutateKeywordPlanCampaignsResponse
     *
     * @throws ApiException if the remote call fails
     */
