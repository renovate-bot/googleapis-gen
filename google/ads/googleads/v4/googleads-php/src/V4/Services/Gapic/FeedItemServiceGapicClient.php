...
use Google\Ads\GoogleAds\V4\Services\GetFeedItemRequest;
use Google\Ads\GoogleAds\V4\Services\MutateFeedItemsRequest;
...
class FeedItemServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.FeedItemService';
