...
use Google\Ads\GoogleAds\V4\Services\GetCampaignBudgetRequest;
use Google\Ads\GoogleAds\V4\Services\MutateCampaignBudgetsRequest;
...
class CampaignBudgetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.CampaignBudgetService';
