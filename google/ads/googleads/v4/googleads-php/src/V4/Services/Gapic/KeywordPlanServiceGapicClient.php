 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/keyword_plan_service.proto
...
use Google\Ads\GoogleAds\V4\Services\GenerateForecastCurveRequest;
use Google\Ads\GoogleAds\V4\Services\GenerateForecastCurveResponse;
use Google\Ads\GoogleAds\V4\Services\GenerateForecastMetricsRequest;
use Google\Ads\GoogleAds\V4\Services\GenerateForecastMetricsResponse;
use Google\Ads\GoogleAds\V4\Services\GenerateHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V4\Services\GenerateHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V4\Services\GetKeywordPlanRequest;
use Google\Ads\GoogleAds\V4\Services\KeywordPlanOperation;
use Google\Ads\GoogleAds\V4\Services\MutateKeywordPlansRequest;
...
class KeywordPlanServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.KeywordPlanService';
