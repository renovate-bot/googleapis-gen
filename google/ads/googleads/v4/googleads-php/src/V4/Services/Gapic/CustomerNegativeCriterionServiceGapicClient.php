...
use Google\Ads\GoogleAds\V4\Services\GetCustomerNegativeCriterionRequest;

use Google\Ads\GoogleAds\V4\Services\MutateCustomerNegativeCriteriaRequest;
...
class CustomerNegativeCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.CustomerNegativeCriterionService';
