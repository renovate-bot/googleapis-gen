 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/campaign_experiment_service.proto
...
use Google\Ads\GoogleAds\V4\Services\CampaignExperimentOperation;
use Google\Ads\GoogleAds\V4\Services\CreateCampaignExperimentRequest;
use Google\Ads\GoogleAds\V4\Services\EndCampaignExperimentRequest;
use Google\Ads\GoogleAds\V4\Services\GetCampaignExperimentRequest;
use Google\Ads\GoogleAds\V4\Services\GraduateCampaignExperimentRequest;
use Google\Ads\GoogleAds\V4\Services\GraduateCampaignExperimentResponse;
use Google\Ads\GoogleAds\V4\Services\ListCampaignExperimentAsyncErrorsRequest;
use Google\Ads\GoogleAds\V4\Services\ListCampaignExperimentAsyncErrorsResponse;
use Google\Ads\GoogleAds\V4\Services\MutateCampaignExperimentsRequest;
use Google\Ads\GoogleAds\V4\Services\MutateCampaignExperimentsResponse;
use Google\Ads\GoogleAds\V4\Services\PromoteCampaignExperimentRequest;
...
class CampaignExperimentServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.CampaignExperimentService';
