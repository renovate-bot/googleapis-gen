 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/keyword_view_service.proto
...
use Google\Ads\GoogleAds\V4\Resources\KeywordView;
use Google\Ads\GoogleAds\V4\Services\GetKeywordViewRequest;
 ...
 * try {
 *     $formattedResourceName = $keywordViewServiceClient->keywordViewName('[CUSTOMER]', '[KEYWORD_VIEW]');
...
class KeywordViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.KeywordViewService';
     ...
     * a keyword_view resource.
     *
     * @param string $customer
     * @param string $keywordView
     *
     * @return string The formatted keyword_view resource.
     * @experimental
     */
    public static function keywordViewName($customer, $keywordView)
    {
     ...
     * Template: Pattern
     * - keywordView: customers/{customer}/keywordViews/{keyword_view}.
     *
