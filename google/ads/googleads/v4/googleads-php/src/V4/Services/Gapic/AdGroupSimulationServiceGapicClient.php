 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/ad_group_simulation_service.proto
...
use Google\Ads\GoogleAds\V4\Resources\AdGroupSimulation;
use Google\Ads\GoogleAds\V4\Services\GetAdGroupSimulationRequest;
 ...
 * try {
 *     $formattedResourceName = $adGroupSimulationServiceClient->adGroupSimulationName('[CUSTOMER]', '[AD_GROUP_SIMULATION]');
...
class AdGroupSimulationServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.AdGroupSimulationService';
    ...
    {
        if (null == self::$adGroupSimulationNameTemplate) {
            self::$adGroupSimulationNameTemplate = new PathTemplate('customers/{customer}/adGroupSimulations/{ad_group_simulation}');
        }
     ...
     * a ad_group_simulation resource.
     *
     * @param string $customer
     * @param string $adGroupSimulation
     *
     * @return string The formatted ad_group_simulation resource.
     * @experimental
     */
    public static function adGroupSimulationName($customer, $adGroupSimulation)
    {
     ...
     * Template: Pattern
     * - adGroupSimulation: customers/{customer}/adGroupSimulations/{ad_group_simulation}.
     *
