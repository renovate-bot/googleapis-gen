 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/keyword_plan_ad_group_service.proto
...
use Google\Ads\GoogleAds\V4\Services\GetKeywordPlanAdGroupRequest;
use Google\Ads\GoogleAds\V4\Services\KeywordPlanAdGroupOperation;
use Google\Ads\GoogleAds\V4\Services\MutateKeywordPlanAdGroupsRequest;
use Google\Ads\GoogleAds\V4\Services\MutateKeywordPlanAdGroupsResponse;
...
class KeywordPlanAdGroupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.KeywordPlanAdGroupService';
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V4\Services\MutateKeywordPlanAdGroupsResponse
     *
     * @throws ApiException if the remote call fails
     * @experimental
     */
