 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/customer_client_link_service.proto
...
use Google\Ads\GoogleAds\V4\Services\GetCustomerClientLinkRequest;

use Google\Ads\GoogleAds\V4\Services\MutateCustomerClientLinkRequest;
use Google\Ads\GoogleAds\V4\Services\MutateCustomerClientLinkResponse;
...
class CustomerClientLinkServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.CustomerClientLinkService';
    ...
    public function getCustomerClientLink($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetCustomerClientLink', CustomerClientLink::class, $optionalArgs, $request)->wait();
    }
