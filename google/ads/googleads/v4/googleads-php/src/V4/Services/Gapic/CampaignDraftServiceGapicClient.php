 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/campaign_draft_service.proto
...
use Google\Ads\GoogleAds\V4\Services\CampaignDraftOperation;
use Google\Ads\GoogleAds\V4\Services\GetCampaignDraftRequest;
use Google\Ads\GoogleAds\V4\Services\ListCampaignDraftAsyncErrorsRequest;
use Google\Ads\GoogleAds\V4\Services\ListCampaignDraftAsyncErrorsResponse;
use Google\Ads\GoogleAds\V4\Services\MutateCampaignDraftsRequest;
use Google\Ads\GoogleAds\V4\Services\MutateCampaignDraftsResponse;
use Google\Ads\GoogleAds\V4\Services\PromoteCampaignDraftRequest;
...
class CampaignDraftServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.CampaignDraftService';
