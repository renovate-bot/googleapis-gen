 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/bidding_strategy_service.proto
...
use Google\Ads\GoogleAds\V4\Services\GetBiddingStrategyRequest;

use Google\Ads\GoogleAds\V4\Services\MutateBiddingStrategiesRequest;
use Google\Ads\GoogleAds\V4\Services\MutateBiddingStrategiesResponse;
 ...
 *
 * ```
 * $biddingStrategyServiceClient = new BiddingStrategyServiceClient();
 * try {
 *     $formattedResourceName = $biddingStrategyServiceClient->biddingStrategyName('[CUSTOMER]', '[BIDDING_STRATEGY]');
 *     $response = $biddingStrategyServiceClient->getBiddingStrategy($formattedResourceName);
 * } finally {
 *     $biddingStrategyServiceClient->close();
 * }
 * ```
 *
 ...
 */
class BiddingStrategyServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.BiddingStrategyService';
     ...
     */
    public static function biddingStrategyName($customer, $biddingStrategy)
    {
     ...
     * Template: Pattern
     * - biddingStrategy: customers/{customer}/biddingStrategies/{bidding_strategy}
     *
     ...
     */
    public function getBiddingStrategy($resourceName, array $optionalArgs = [])
    {
        $request = new GetBiddingStrategyRequest();
        $requestParamHeaders = [];
        $request->setResourceName($resourceName);
        $requestParamHeaders['resource_name'] = $resourceName;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetBiddingStrategy', BiddingStrategy::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $operations = [];
     *     $response = $biddingStrategyServiceClient->mutateBiddingStrategies($customerId, $operations);
     * } finally {
     *     $biddingStrategyServiceClient->close();
     * }
     * ```
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V4\Services\MutateBiddingStrategiesResponse
     *
     * @throws ApiException if the remote call fails
     */
    public function mutateBiddingStrategies($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateBiddingStrategies', MutateBiddingStrategiesResponse::class, $optionalArgs, $request)->wait();
    }
}
