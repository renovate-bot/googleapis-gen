 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v4/services/shared_criterion_service.proto
...
use Google\Ads\GoogleAds\V4\Services\GetSharedCriterionRequest;
use Google\Ads\GoogleAds\V4\Services\MutateSharedCriteriaRequest;

use Google\Ads\GoogleAds\V4\Services\MutateSharedCriteriaResponse;
 ...
 */
class SharedCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v4.services.SharedCriterionService';
     ...
     */
    public function getSharedCriterion($resourceName, array $optionalArgs = [])
    {
        $request = new GetSharedCriterionRequest();
        $requestParamHeaders = [];
        $request->setResourceName($resourceName);
        $requestParamHeaders['resource_name'] = $resourceName;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetSharedCriterion', SharedCriterion::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $operations = [];
     *     $response = $sharedCriterionServiceClient->mutateSharedCriteria($customerId, $operations);
     * } finally {
     *     $sharedCriterionServiceClient->close();
     * }
     * ```
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V4\Services\MutateSharedCriteriaResponse
     *
     * @throws ApiException if the remote call fails
     */
    public function mutateSharedCriteria($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateSharedCriteria', MutateSharedCriteriaResponse::class, $optionalArgs, $request)->wait();
    }
}
