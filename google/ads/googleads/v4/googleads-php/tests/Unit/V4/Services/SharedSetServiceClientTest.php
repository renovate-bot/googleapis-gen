...
use Google\Ads\GoogleAds\V4\Services\MutateSharedSetsResponse;
...
class SharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function getSharedSetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.SharedSetService/GetSharedSet', $actualFuncCall);
    ...
    public function mutateSharedSetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.SharedSetService/MutateSharedSets', $actualFuncCall);
