...
use Google\Ads\GoogleAds\V4\Enums\MonthOfYearEnum\MonthOfYear;
use Google\Ads\GoogleAds\V4\Services\ListInvoicesResponse;
...
class InvoiceServiceClientTest extends GeneratedTest
{
    ...
    public function listInvoicesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.InvoiceService/ListInvoices', $actualFuncCall);
