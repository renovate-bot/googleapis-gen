...
use Google\Ads\GoogleAds\V4\Services\CreateCustomerClientResponse;
use Google\Ads\GoogleAds\V4\Services\CustomerOperation;
use Google\Ads\GoogleAds\V4\Services\ListAccessibleCustomersResponse;
use Google\Ads\GoogleAds\V4\Services\MutateCustomerResponse;
...
class CustomerServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.CustomerService/GetCustomer', $actualFuncCall);
    ...
    public function mutateCustomerTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.CustomerService/MutateCustomer', $actualFuncCall);
    ...
    public function listAccessibleCustomersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.CustomerService/ListAccessibleCustomers', $actualFuncCall);
    ...
    public function createCustomerClientTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.CustomerService/CreateCustomerClient', $actualFuncCall);
