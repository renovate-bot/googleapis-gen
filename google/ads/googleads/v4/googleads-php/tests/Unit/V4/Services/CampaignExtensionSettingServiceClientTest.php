...
use Google\Ads\GoogleAds\V4\Services\MutateCampaignExtensionSettingsResponse;
...
class CampaignExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignExtensionSettingTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.CampaignExtensionSettingService/GetCampaignExtensionSetting', $actualFuncCall);
    ...
    public function mutateCampaignExtensionSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.CampaignExtensionSettingService/MutateCampaignExtensionSettings', $actualFuncCall);
