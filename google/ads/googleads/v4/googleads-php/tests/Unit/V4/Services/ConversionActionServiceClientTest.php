...
use Google\Ads\GoogleAds\V4\Services\MutateConversionActionsResponse;
...
class ConversionActionServiceClientTest extends GeneratedTest
{
    ...
    public function getConversionActionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.ConversionActionService/GetConversionAction', $actualFuncCall);
    ...
    public function mutateConversionActionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.ConversionActionService/MutateConversionActions', $actualFuncCall);
