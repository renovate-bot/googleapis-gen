...
use Google\Ads\GoogleAds\V4\Services\GenerateForecastCurveResponse;
use Google\Ads\GoogleAds\V4\Services\GenerateForecastMetricsResponse;

use Google\Ads\GoogleAds\V4\Services\GenerateHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V4\Services\KeywordPlanServiceClient;
use Google\Ads\GoogleAds\V4\Services\MutateKeywordPlansResponse;
...
class KeywordPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateForecastCurveTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.KeywordPlanService/GenerateForecastCurve', $actualFuncCall);
    ...
    public function generateForecastMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.KeywordPlanService/GenerateForecastMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getKeywordPlan();
        $this->assertProtobufEquals($formattedKeywordPlan, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.KeywordPlanService/GenerateHistoricalMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getKeywordPlan();
        $this->assertProtobufEquals($formattedKeywordPlan, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getKeywordPlanTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.KeywordPlanService/GetKeywordPlan', $actualFuncCall);
    ...
    public function mutateKeywordPlansTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.KeywordPlanService/MutateKeywordPlans', $actualFuncCall);
