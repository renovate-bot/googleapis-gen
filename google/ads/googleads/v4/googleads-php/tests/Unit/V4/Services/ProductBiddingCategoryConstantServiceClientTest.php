...
use Google\Ads\GoogleAds\V4\Resources\ProductBiddingCategoryConstant;
...
class ProductBiddingCategoryConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getProductBiddingCategoryConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.ProductBiddingCategoryConstantService/GetProductBiddingCategoryConstant', $actualFuncCall);
