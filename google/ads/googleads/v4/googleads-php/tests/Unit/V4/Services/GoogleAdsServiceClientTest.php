...
class GoogleAdsServiceClientTest extends GeneratedTest
{
    ...
    public function searchTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.GoogleAdsService/Search', $actualFuncCall);
    ...
    public function searchStreamTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.GoogleAdsService/SearchStream', $actualFuncCall);
    ...
    public function mutateTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.GoogleAdsService/Mutate', $actualFuncCall);
