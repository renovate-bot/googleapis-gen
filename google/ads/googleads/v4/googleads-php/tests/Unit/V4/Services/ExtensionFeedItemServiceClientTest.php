...
class ExtensionFeedItemServiceClientTest extends GeneratedTest
{
    ...
    public function getExtensionFeedItemTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.ExtensionFeedItemService/GetExtensionFeedItem', $actualFuncCall);
    ...
    public function mutateExtensionFeedItemsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.ExtensionFeedItemService/MutateExtensionFeedItems', $actualFuncCall);
