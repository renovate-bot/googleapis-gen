...
use Google\Ads\GoogleAds\V4\Services\UserLocationViewServiceClient;
use Google\Ads\GoogleAds\V4\Resources\UserLocationView;
...
class UserLocationViewServiceClientTest extends GeneratedTest
{
    ...
    public function getUserLocationViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.UserLocationViewService/GetUserLocationView', $actualFuncCall);
