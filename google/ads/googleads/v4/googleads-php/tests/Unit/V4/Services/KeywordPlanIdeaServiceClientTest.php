...
use Google\Ads\GoogleAds\V4\Services\GenerateKeywordIdeaResponse;
...
class KeywordPlanIdeaServiceClientTest extends GeneratedTest
{
    ...
    public function generateKeywordIdeasTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.KeywordPlanIdeaService/GenerateKeywordIdeas', $actualFuncCall);
