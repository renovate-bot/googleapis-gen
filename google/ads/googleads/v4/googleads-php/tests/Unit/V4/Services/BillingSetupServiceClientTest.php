...
use Google\Ads\GoogleAds\V4\Services\BillingSetupOperation;
use Google\Ads\GoogleAds\V4\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceClientTest extends GeneratedTest
{
    ...
    public function getBillingSetupTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.BillingSetupService/GetBillingSetup', $actualFuncCall);
    ...
    public function mutateBillingSetupTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.BillingSetupService/MutateBillingSetup', $actualFuncCall);
