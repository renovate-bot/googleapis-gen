...
use Google\Ads\GoogleAds\V4\Resources\HotelPerformanceView;
...
class HotelPerformanceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getHotelPerformanceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.HotelPerformanceViewService/GetHotelPerformanceView', $actualFuncCall);
