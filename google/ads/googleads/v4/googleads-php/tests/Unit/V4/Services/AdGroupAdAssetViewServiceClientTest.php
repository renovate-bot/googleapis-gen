...
use Google\Ads\GoogleAds\V4\Services\AdGroupAdAssetViewServiceClient;
...
class AdGroupAdAssetViewServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupAdAssetViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.AdGroupAdAssetViewService/GetAdGroupAdAssetView', $actualFuncCall);
