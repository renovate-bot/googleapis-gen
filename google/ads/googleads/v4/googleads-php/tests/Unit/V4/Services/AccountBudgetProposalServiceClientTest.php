...
use Google\Ads\GoogleAds\V4\Services\AccountBudgetProposalOperation;

use Google\Ads\GoogleAds\V4\Services\MutateAccountBudgetProposalResponse;
...
class AccountBudgetProposalServiceClientTest extends GeneratedTest
{
    ...
    public function getAccountBudgetProposalTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.AccountBudgetProposalService/GetAccountBudgetProposal', $actualFuncCall);
    ...
    public function mutateAccountBudgetProposalTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.AccountBudgetProposalService/MutateAccountBudgetProposal', $actualFuncCall);
