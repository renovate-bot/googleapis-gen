...
use Google\Ads\GoogleAds\V4\Services\MutateFeedItemTargetsResponse;
...
class FeedItemTargetServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedItemTargetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.FeedItemTargetService/GetFeedItemTarget', $actualFuncCall);
    ...
    public function mutateFeedItemTargetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.FeedItemTargetService/MutateFeedItemTargets', $actualFuncCall);
