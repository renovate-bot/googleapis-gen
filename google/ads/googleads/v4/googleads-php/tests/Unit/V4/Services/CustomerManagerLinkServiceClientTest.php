...
class CustomerManagerLinkServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerManagerLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.CustomerManagerLinkService/GetCustomerManagerLink', $actualFuncCall);
    ...
    public function moveManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.CustomerManagerLinkService/MoveManagerLink', $actualFuncCall);
    ...
    public function mutateCustomerManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.CustomerManagerLinkService/MutateCustomerManagerLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
