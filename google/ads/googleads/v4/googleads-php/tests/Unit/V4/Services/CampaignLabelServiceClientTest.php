...
use Google\Ads\GoogleAds\V4\Services\MutateCampaignLabelsResponse;
...
class CampaignLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.CampaignLabelService/GetCampaignLabel', $actualFuncCall);
    ...
    public function mutateCampaignLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.CampaignLabelService/MutateCampaignLabels', $actualFuncCall);
