...
use Google\Ads\GoogleAds\V4\Services\MutateFeedItemsResponse;
...
class FeedItemServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedItemTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.FeedItemService/GetFeedItem', $actualFuncCall);
    ...
    public function mutateFeedItemsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.FeedItemService/MutateFeedItems', $actualFuncCall);
