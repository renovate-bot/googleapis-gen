...
use Google\Ads\GoogleAds\V4\Resources\AdGroupLabel;
use Google\Ads\GoogleAds\V4\Services\MutateAdGroupLabelsResponse;
...
class AdGroupLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.AdGroupLabelService/GetAdGroupLabel', $actualFuncCall);
    ...
    public function mutateAdGroupLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.AdGroupLabelService/MutateAdGroupLabels', $actualFuncCall);
