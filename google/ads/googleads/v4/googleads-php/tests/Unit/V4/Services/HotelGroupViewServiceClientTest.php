...
use Google\Ads\GoogleAds\V4\Resources\HotelGroupView;
...
class HotelGroupViewServiceClientTest extends GeneratedTest
{
    ...
    public function getHotelGroupViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.HotelGroupViewService/GetHotelGroupView', $actualFuncCall);
