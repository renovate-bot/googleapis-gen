...
class CampaignBudgetServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignBudgetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.CampaignBudgetService/GetCampaignBudget', $actualFuncCall);
    ...
    public function mutateCampaignBudgetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.CampaignBudgetService/MutateCampaignBudgets', $actualFuncCall);
