...
class AdGroupCriterionLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupCriterionLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.AdGroupCriterionLabelService/GetAdGroupCriterionLabel', $actualFuncCall);
    ...
    public function mutateAdGroupCriterionLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels', $actualFuncCall);
