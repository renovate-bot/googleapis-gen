...
use Google\Ads\GoogleAds\V4\Resources\AdGroupFeed;
use Google\Ads\GoogleAds\V4\Services\MutateAdGroupFeedsResponse;
...
class AdGroupFeedServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupFeedTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.AdGroupFeedService/GetAdGroupFeed', $actualFuncCall);
    ...
    public function mutateAdGroupFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v4.services.AdGroupFeedService/MutateAdGroupFeeds', $actualFuncCall);
