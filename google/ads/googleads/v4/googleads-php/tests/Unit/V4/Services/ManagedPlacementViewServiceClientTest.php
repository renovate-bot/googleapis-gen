...
use Google\Ads\GoogleAds\V4\Resources\ManagedPlacementView;
...
class ManagedPlacementViewServiceClientTest extends GeneratedTest
{
    ...
    public function getManagedPlacementViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v4.services.ManagedPlacementViewService/GetManagedPlacementView', $actualFuncCall);
