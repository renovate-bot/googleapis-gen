        ...
        module Services
          module CustomerService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::CustomerService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::CustomerService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # ## Examples
              #
              # To create a new CustomerService client with the default
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::CustomerService::Client.new
              #
              # To create a new CustomerService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::CustomerService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v4/services/customer_service_services_pb"
                ...
                @customer_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::CustomerService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GetCustomerRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetCustomerRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::Customer]
              ...
              def get_customer request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::GetCustomerRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::MutateCustomerRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateCustomerRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload mutate_customer(customer_id: nil, operation: nil, validate_only: nil)
              ...
              #   @param operation [::Google::Ads::GoogleAds::V4::Services::CustomerOperation, ::Hash]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateCustomerResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_customer request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::MutateCustomerRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::ListAccessibleCustomersRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::ListAccessibleCustomersRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::ListAccessibleCustomersResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def list_accessible_customers request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::ListAccessibleCustomersRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::CreateCustomerClientRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::CreateCustomerClientRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload create_customer_client(customer_id: nil, customer_client: nil, email_address: nil, access_role: nil)
              ...
              #   @param customer_client [::Google::Ads::GoogleAds::V4::Resources::Customer, ::Hash]
              #     Required. The new client customer to create. The resource name on this customer
              #     will be ignored.
              #   @param email_address [::Google::Protobuf::StringValue, ::Hash]
              ...
              #   @param access_role [::Google::Ads::GoogleAds::V4::Enums::AccessRoleEnum::AccessRole]
              #     The proposed role of user on the created client customer.
              #     Accessible only to customers on the allow-list.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::CreateCustomerClientResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def create_customer_client request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::CreateCustomerClientRequest
              ...
              # {::Google::Ads::GoogleAds::V4::Services::CustomerService::Client::Configuration::Rpcs}
              ...
              # # Examples
              #
              # To modify the global config, setting the timeout for get_customer
