...
require 'google/ads/googleads/v4/common/ad_type_infos_pb'
require 'google/ads/googleads/v4/common/custom_parameter_pb'
require 'google/ads/googleads/v4/common/final_app_url_pb'
require 'google/ads/googleads/v4/common/url_collection_pb'
require 'google/ads/googleads/v4/enums/ad_type_pb'
require 'google/ads/googleads/v4/enums/device_pb'
require 'google/ads/googleads/v4/enums/system_managed_entity_source_pb'
require 'google/api/field_behavior_pb'
require 'google/api/resource_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v4/resources/ad.proto", :syntax => :proto3) do
