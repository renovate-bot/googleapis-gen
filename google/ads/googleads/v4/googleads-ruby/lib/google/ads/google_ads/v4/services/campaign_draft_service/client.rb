        ...
        module Services
          module CampaignDraftService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::CampaignDraftService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::CampaignDraftService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::CampaignDraftService::Client.new
              #
              # To create a new CampaignDraftService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::CampaignDraftService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v4/services/campaign_draft_service_services_pb"
                ...
                @campaign_draft_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::CampaignDraftService::Stub,
              ...
              #
              # @return [::Google::Ads::GoogleAds::V4::Services::CampaignDraftService::Operations]
              #
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GetCampaignDraftRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetCampaignDraftRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::CampaignDraft]
              ...
              def get_campaign_draft request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::GetCampaignDraftRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::MutateCampaignDraftsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateCampaignDraftsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V4::Services::CampaignDraftOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateCampaignDraftsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V4::Services::MutateCampaignDraftsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def mutate_campaign_drafts request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::MutateCampaignDraftsRequest
              ...
              # {::Google::Ads::GoogleAds::V4::Services::CampaignDraftService::Client#list_campaign_draft_async_errors CampaignDraftService.ListCampaignDraftAsyncErrors} to view the list of
              # error reasons.
              #
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::PromoteCampaignDraftRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::PromoteCampaignDraftRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def promote_campaign_draft request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::PromoteCampaignDraftRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::ListCampaignDraftAsyncErrorsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::ListCampaignDraftAsyncErrorsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def list_campaign_draft_async_errors request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::ListCampaignDraftAsyncErrorsRequest
              ...
              # {::Google::Ads::GoogleAds::V4::Services::CampaignDraftService::Client::Configuration::Rpcs}
