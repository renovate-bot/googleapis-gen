        ...
        module Services
          module AdParameterService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::AdParameterService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::AdParameterService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::AdParameterService::Client.new
              #
              # To create a new AdParameterService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::AdParameterService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v4/services/ad_parameter_service_services_pb"
                ...
                @ad_parameter_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::AdParameterService::Stub,
              ...
              #   Pass arguments to `get_ad_parameter` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V4::Services::GetAdParameterRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetAdParameterRequest, ::Hash]
              ...
              #   Pass arguments to `get_ad_parameter` via keyword arguments. Note that at
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::AdParameter]
              ...
              def get_ad_parameter request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V4::Services::GetAdParameterRequest
                ...
                @ad_parameter_service_stub.call_rpc :get_ad_parameter, request,
              ...
              #   Pass arguments to `mutate_ad_parameters` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V4::Services::MutateAdParametersRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateAdParametersRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   Pass arguments to `mutate_ad_parameters` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param customer_id [::String]
              #     Required. The ID of the customer whose ad parameters are being modified.
              #   @param operations [::Array<::Google::Ads::GoogleAds::V4::Services::AdParameterOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateAdParametersResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_ad_parameters request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V4::Services::MutateAdParametersRequest
                ...
                @ad_parameter_service_stub.call_rpc :mutate_ad_parameters, request,
                                                    options: options do |response, operation|
                  yield response, operation if block_given?
                  return response
                end
              ...
              # {::Google::Ads::GoogleAds::V4::Services::AdParameterService::Client::Configuration::Rpcs}
              ...
              #     ::Google::Ads::GoogleAds::V4::Services::AdParameterService::Client.configure do |config|
              #       config.timeout = 10.0
              #       config.rpcs.get_ad_parameter.timeout = 20.0
              #     end
              #
