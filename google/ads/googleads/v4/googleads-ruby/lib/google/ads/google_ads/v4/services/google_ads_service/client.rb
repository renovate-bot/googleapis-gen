...
require "google/ads/googleads/v4/services/google_ads_service_pb"
        ...
        module Services
          module GoogleAdsService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client.new
              #
              # To create a new GoogleAdsService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v4/services/google_ads_service_services_pb"
                ...
                @google_ads_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::SearchGoogleAdsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::SearchGoogleAdsRequest, ::Hash]
              ...
              #     Default is false.
              #   @param summary_row_setting [::Google::Ads::GoogleAds::V4::Enums::SummaryRowSettingEnum::SummaryRowSetting]
              ...
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V4::Services::GoogleAdsRow>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V4::Services::GoogleAdsRow>]
              #
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::SearchGoogleAdsStreamRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::SearchGoogleAdsStreamRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Enumerable<::Google::Ads::GoogleAds::V4::Services::SearchGoogleAdsStreamResponse>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Enumerable<::Google::Ads::GoogleAds::V4::Services::SearchGoogleAdsStreamResponse>]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::MutateGoogleAdsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateGoogleAdsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param mutate_operations [::Array<::Google::Ads::GoogleAds::V4::Services::MutateOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateGoogleAdsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              # {::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client::Configuration::Rpcs}
