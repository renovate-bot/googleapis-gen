...
require 'google/ads/googleads/v4/enums/billing_setup_status_pb'
require 'google/ads/googleads/v4/enums/time_type_pb'
require 'google/api/field_behavior_pb'
require 'google/api/resource_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v4/resources/billing_setup.proto", :syntax => :proto3) do
