...
require 'google/ads/googleads/v4/enums/change_status_operation_pb'
require 'google/ads/googleads/v4/enums/change_status_resource_type_pb'
require 'google/api/field_behavior_pb'
require 'google/api/resource_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v4/resources/change_status.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v4.resources.ChangeStatus" do
      optional :resource_name, :string, 1
      optional :last_change_date_time, :message, 3, "google.protobuf.StringValue"
      optional :resource_type, :enum, 4, "google.ads.googleads.v4.enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType"
      optional :campaign, :message, 5, "google.protobuf.StringValue"
      optional :ad_group, :message, 6, "google.protobuf.StringValue"
      optional :resource_status, :enum, 8, "google.ads.googleads.v4.enums.ChangeStatusOperationEnum.ChangeStatusOperation"
...
module Google
  module Ads
    module GoogleAds
      module V4
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v4.resources.ChangeStatus").msgclass
        end
      end
    end
  end
