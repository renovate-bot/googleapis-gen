...
require "google/ads/googleads/v4/services/merchant_center_link_service_pb"
        ...
        module Services
          module MerchantCenterLinkService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Client.new
              #
              # To create a new MerchantCenterLinkService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v4/services/merchant_center_link_service_services_pb"
                ...
                @merchant_center_link_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::ListMerchantCenterLinksRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::ListMerchantCenterLinksRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::ListMerchantCenterLinksResponse]
              ...
              def list_merchant_center_links request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::ListMerchantCenterLinksRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GetMerchantCenterLinkRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetMerchantCenterLinkRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::MerchantCenterLink]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def get_merchant_center_link request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::GetMerchantCenterLinkRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::MutateMerchantCenterLinkRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateMerchantCenterLinkRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operation [::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkOperation, ::Hash]
              #     Required. The operation to perform on the link
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateMerchantCenterLinkResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_merchant_center_link request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::MutateMerchantCenterLinkRequest
              ...
              # {::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Client::Configuration::Rpcs}
