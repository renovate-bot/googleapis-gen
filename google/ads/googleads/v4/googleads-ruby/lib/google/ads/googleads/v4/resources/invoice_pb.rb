...
require 'google/ads/googleads/v4/common/dates_pb'
require 'google/ads/googleads/v4/enums/invoice_type_pb'
require 'google/api/field_behavior_pb'
require 'google/api/resource_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v4/resources/invoice.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v4.resources.Invoice" do
      optional :resource_name, :string, 1
      optional :id, :message, 2, "google.protobuf.StringValue"
      optional :type, :enum, 3, "google.ads.googleads.v4.enums.InvoiceTypeEnum.InvoiceType"
      ...
      optional :service_date_range, :message, 9, "google.ads.googleads.v4.common.DateRange"
      ...
      repeated :account_budget_summaries, :message, 18, "google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary"
    end
    add_message "google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary" do
      ...
      optional :billable_activity_date_range, :message, 9, "google.ads.googleads.v4.common.DateRange"
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V4
        module Resources
          Invoice = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v4.resources.Invoice").msgclass
          Invoice::AccountBudgetSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v4.resources.Invoice.AccountBudgetSummary").msgclass
        end
      end
    end
  end
