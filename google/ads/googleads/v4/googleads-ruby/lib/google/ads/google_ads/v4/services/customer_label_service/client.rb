        ...
        module Services
          module CustomerLabelService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::CustomerLabelService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::CustomerLabelService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::CustomerLabelService::Client.new
              #
              # To create a new CustomerLabelService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::CustomerLabelService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v4/services/customer_label_service_services_pb"
                ...
                @customer_label_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::CustomerLabelService::Stub,
              ...
              #   Pass arguments to `get_customer_label` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V4::Services::GetCustomerLabelRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetCustomerLabelRequest, ::Hash]
              ...
              #   Pass arguments to `get_customer_label` via keyword arguments. Note that at
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::CustomerLabel]
              ...
              def get_customer_label request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V4::Services::GetCustomerLabelRequest
                ...
                @customer_label_service_stub.call_rpc :get_customer_label, request,
              ...
              #   Pass arguments to `mutate_customer_labels` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V4::Services::MutateCustomerLabelsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateCustomerLabelsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   Pass arguments to `mutate_customer_labels` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param customer_id [::String]
              #     Required. ID of the customer whose customer-label relationships are being modified.
              #   @param operations [::Array<::Google::Ads::GoogleAds::V4::Services::CustomerLabelOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateCustomerLabelsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V4::Services::MutateCustomerLabelsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def mutate_customer_labels request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V4::Services::MutateCustomerLabelsRequest
                ...
                @customer_label_service_stub.call_rpc :mutate_customer_labels, request,
                                                      options: options do |response, operation|
                  yield response, operation if block_given?
                  return response
                end
              ...
              # {::Google::Ads::GoogleAds::V4::Services::CustomerLabelService::Client::Configuration::Rpcs}
              ...
              #     ::Google::Ads::GoogleAds::V4::Services::CustomerLabelService::Client.configure do |config|
              #       config.timeout = 10.0
              #       config.rpcs.get_customer_label.timeout = 20.0
              #     end
              #
