    ...
    module GoogleAds
      module V4
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V4::Enums::CampaignStatusEnum::CampaignStatus]
          #     The status of the campaign.
          #
          #     When a new campaign is added, the status defaults to ENABLED.
          # @!attribute [r] serving_status
          #   @return [::Google::Ads::GoogleAds::V4::Enums::CampaignServingStatusEnum::CampaignServingStatus]
          #     Output only. The ad serving status of the campaign.
          # @!attribute [rw] ad_serving_optimization_status
          #   @return [::Google::Ads::GoogleAds::V4::Enums::AdServingOptimizationStatusEnum::AdServingOptimizationStatus]
          #     The ad serving optimization status of the campaign.
          # @!attribute [rw] advertising_channel_type
          #   @return [::Google::Ads::GoogleAds::V4::Enums::AdvertisingChannelTypeEnum::AdvertisingChannelType]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::CampaignExperimentTypeEnum::CampaignExperimentType]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::BiddingStrategyTypeEnum::BiddingStrategyType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::FrequencyCapEntry>]
          #     A list that limits how often each user will see this campaign's ads.
          # @!attribute [r] video_brand_safety_suitability
          #   @return [::Google::Ads::GoogleAds::V4::Enums::BrandSafetySuitabilityEnum::BrandSafetySuitability]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::PaymentModeEnum::PaymentMode]
          ...
          class Campaign
            ...
            #   @return [::Google::Ads::GoogleAds::V4::Enums::PositiveGeoTargetTypeEnum::PositiveGeoTargetType]
            #     The setting used for positive geotargeting in this particular campaign.
            # @!attribute [rw] negative_geo_target_type
            #   @return [::Google::Ads::GoogleAds::V4::Enums::NegativeGeoTargetTypeEnum::NegativeGeoTargetType]
            ...
            #   @return [::Google::Ads::GoogleAds::V4::Enums::AppCampaignAppStoreEnum::AppCampaignAppStore]
            ...
            #   @return [::Google::Ads::GoogleAds::V4::Enums::VanityPharmaTextEnum::VanityPharmaText]
