    ...
    module GoogleAds
      module V4
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::AssetFieldTypeEnum::AssetFieldType]
          #     Output only. Role that the asset takes in the ad.
          # @!attribute [r] policy_summary
          #   @return [::Google::Ads::GoogleAds::V4::Resources::AdGroupAdAssetPolicySummary]
          #     Output only. Policy information for the ad group ad asset.
          # @!attribute [r] performance_label
          #   @return [::Google::Ads::GoogleAds::V4::Enums::AssetPerformanceLabelEnum::AssetPerformanceLabel]
