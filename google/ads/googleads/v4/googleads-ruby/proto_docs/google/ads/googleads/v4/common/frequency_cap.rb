    ...
    module GoogleAds
      module V4
        module Common
          ...
          # @!attribute [rw] level
          #   @return [::Google::Ads::GoogleAds::V4::Enums::FrequencyCapLevelEnum::FrequencyCapLevel]
          #     The level on which the cap is to be applied (e.g. ad group ad, ad group).
          #     The cap is applied to all the entities of this level.
          # @!attribute [rw] event_type
          #   @return [::Google::Ads::GoogleAds::V4::Enums::FrequencyCapEventTypeEnum::FrequencyCapEventType]
