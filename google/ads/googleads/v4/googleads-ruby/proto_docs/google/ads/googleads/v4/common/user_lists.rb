    ...
    module GoogleAds
      module V4
        module Common
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::CustomerMatchUploadKeyTypeEnum::CustomerMatchUploadKeyType]
          #     Matching key type of the list.
          #     Mixed data types are not allowed on the same list.
          #     This field is required for an ADD operation.
          # @!attribute [rw] data_source_type
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListCrmDataSourceTypeEnum::UserListCrmDataSourceType]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListRuleTypeEnum::UserListRuleType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::UserListRuleItemGroupInfo>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::UserListRuleItemInfo>]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Common::UserListNumberRuleItemInfo]
          #     An atomic rule item composed of a number operation.
          # @!attribute [rw] string_rule_item
          #   @return [::Google::Ads::GoogleAds::V4::Common::UserListStringRuleItemInfo]
          #     An atomic rule item composed of a string operation.
          # @!attribute [rw] date_rule_item
          #   @return [::Google::Ads::GoogleAds::V4::Common::UserListDateRuleItemInfo]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListDateRuleItemOperatorEnum::UserListDateRuleItemOperator]
          ...
          # @!attribute [rw] operator
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListNumberRuleItemOperatorEnum::UserListNumberRuleItemOperator]
          ...
          # @!attribute [rw] operator
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListStringRuleItemOperatorEnum::UserListStringRuleItemOperator]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListCombinedRuleOperatorEnum::UserListCombinedRuleOperator]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListPrepopulationStatusEnum::UserListPrepopulationStatus]
          ...
          # @!attribute [rw] rules
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::UserListLogicalRuleInfo>]
          ...
          # @!attribute [rw] operator
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListLogicalRuleOperatorEnum::UserListLogicalRuleOperator]
          #     The logical operator of the rule.
          # @!attribute [rw] rule_operands
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::LogicalUserListOperandInfo>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::UserListActionInfo>]
