    ...
    module GoogleAds
      module V4
        module Services
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::InvoiceService::Client#list_invoices InvoiceService.ListInvoices}.
          # @!attribute [rw] invoices
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Resources::Invoice>]
