...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::AdService::Client#get_ad AdService.GetAd}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::AdService::Client#mutate_ads AdService.MutateAds}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose ads are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::AdOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateAdResult>]
