    ...
    module GoogleAds
      module V4
        module Common
          ...
          #     at any time.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V4::Enums::PolicyTopicEntryTypeEnum::PolicyTopicEntryType]
          #     Describes the negative or positive effect this policy will have on serving.
          # @!attribute [rw] evidences
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::PolicyTopicEvidence>]
          #     Additional information that explains policy finding
          #     (e.g. the brand name for a trademark finding).
          # @!attribute [rw] constraints
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::PolicyTopicConstraint>]
          ...
          class PolicyTopicEvidence
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V4::Enums::PolicyTopicEvidenceDestinationMismatchUrlTypeEnum::PolicyTopicEvidenceDestinationMismatchUrlType>]
            ...
            # @!attribute [rw] device
            #   @return [::Google::Ads::GoogleAds::V4::Enums::PolicyTopicEvidenceDestinationNotWorkingDeviceEnum::PolicyTopicEvidenceDestinationNotWorkingDevice]
            ...
            #   @return [::Google::Ads::GoogleAds::V4::Enums::PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum::PolicyTopicEvidenceDestinationNotWorkingDnsErrorType]
          ...
          class PolicyTopicConstraint
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::PolicyTopicConstraint::CountryConstraint>]
