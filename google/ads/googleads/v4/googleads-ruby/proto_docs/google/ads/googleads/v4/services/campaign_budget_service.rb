...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::CampaignBudgetService::Client#get_campaign_budget CampaignBudgetService.GetCampaignBudget}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::CampaignBudgetService::Client#mutate_campaign_budgets CampaignBudgetService.MutateCampaignBudgets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaign budgets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::CampaignBudgetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateCampaignBudgetResult>]
