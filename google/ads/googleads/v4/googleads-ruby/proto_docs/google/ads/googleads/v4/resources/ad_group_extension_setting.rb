    ...
    module GoogleAds
      module V4
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::ExtensionTypeEnum::ExtensionType]
          ...
          # @!attribute [rw] device
          #   @return [::Google::Ads::GoogleAds::V4::Enums::ExtensionSettingDeviceEnum::ExtensionSettingDevice]
