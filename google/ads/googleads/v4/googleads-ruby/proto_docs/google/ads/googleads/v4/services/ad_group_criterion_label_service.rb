  ...
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V4::Services::AdGroupCriterionLabelService::Client#get_ad_group_criterion_label AdGroupCriterionLabelService.GetAdGroupCriterionLabel}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V4::Services::AdGroupCriterionLabelService::Client#mutate_ad_group_criterion_labels AdGroupCriterionLabelService.MutateAdGroupCriterionLabels}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose ad group criterion labels are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::AdGroupCriterionLabelOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateAdGroupCriterionLabelResult>]
