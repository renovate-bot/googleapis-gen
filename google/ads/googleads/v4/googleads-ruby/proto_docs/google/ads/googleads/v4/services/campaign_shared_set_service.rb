...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::CampaignSharedSetService::Client#get_campaign_shared_set CampaignSharedSetService.GetCampaignSharedSet}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::CampaignSharedSetService::Client#mutate_campaign_shared_sets CampaignSharedSetService.MutateCampaignSharedSets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaign shared sets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::CampaignSharedSetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateCampaignSharedSetResult>]
