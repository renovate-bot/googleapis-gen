    ...
    module GoogleAds
      module V4
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V4::Enums::AccountLinkStatusEnum::AccountLinkStatus]
          #     The status of the link.
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V4::Enums::LinkedAccountTypeEnum::LinkedAccountType]
