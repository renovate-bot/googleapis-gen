...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::CampaignService::Client#get_campaign CampaignService.GetCampaign}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::CampaignService::Client#mutate_campaigns CampaignService.MutateCampaigns}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaigns are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::CampaignOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateCampaignResult>]
