...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::AdGroupBidModifierService::Client#get_ad_group_bid_modifier AdGroupBidModifierService.GetAdGroupBidModifier}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::AdGroupBidModifierService::Client#mutate_ad_group_bid_modifiers AdGroupBidModifierService.MutateAdGroupBidModifiers}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose ad group bid modifiers are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::AdGroupBidModifierOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateAdGroupBidModifierResult>]
