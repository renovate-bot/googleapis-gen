    ...
    module GoogleAds
      module V4
        module Common
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::TargetRestriction>]
          #     The per-targeting-dimension setting to restrict the reach of your campaign
          #     or ad group.
          # @!attribute [rw] target_restriction_operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::TargetRestrictionOperation>]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::TargetingDimensionEnum::TargetingDimension]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Common::TargetRestrictionOperation::Operator]
