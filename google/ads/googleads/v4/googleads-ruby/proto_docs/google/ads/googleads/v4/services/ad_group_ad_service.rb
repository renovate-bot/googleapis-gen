...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::AdGroupAdService::Client#get_ad_group_ad AdGroupAdService.GetAdGroupAd}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::AdGroupAdService::Client#mutate_ad_group_ads AdGroupAdService.MutateAdGroupAds}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose ads are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::AdGroupAdOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateAdGroupAdResult>]
