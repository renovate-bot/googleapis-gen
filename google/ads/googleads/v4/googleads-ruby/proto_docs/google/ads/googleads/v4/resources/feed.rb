    ...
    module GoogleAds
      module V4
        module Resources
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Resources::FeedAttribute>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Resources::FeedAttributeOperation>]
          #     The list of operations changing the feed attributes. Attributes can only
          #     be added, not removed.
          # @!attribute [rw] origin
          #   @return [::Google::Ads::GoogleAds::V4::Enums::FeedOriginEnum::FeedOrigin]
          #     Immutable. Specifies who manages the FeedAttributes for the Feed.
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V4::Enums::FeedStatusEnum::FeedStatus]
          ...
          class Feed
            ...
            #   @return [::Google::Ads::GoogleAds::V4::Enums::AffiliateLocationFeedRelationshipTypeEnum::AffiliateLocationFeedRelationshipType]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V4::Enums::FeedAttributeTypeEnum::FeedAttributeType]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Resources::FeedAttributeOperation::Operator]
