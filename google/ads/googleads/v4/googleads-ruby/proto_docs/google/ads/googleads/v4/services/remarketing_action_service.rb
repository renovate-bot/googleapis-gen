...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::RemarketingActionService::Client#get_remarketing_action RemarketingActionService.GetRemarketingAction}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::RemarketingActionService::Client#mutate_remarketing_actions RemarketingActionService.MutateRemarketingActions}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose remarketing actions are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::RemarketingActionOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateRemarketingActionResult>]
