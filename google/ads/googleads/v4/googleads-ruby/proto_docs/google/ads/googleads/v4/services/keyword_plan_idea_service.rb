...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanIdeaService::Client#generate_keyword_ideas KeywordPlanIdeaService.GenerateKeywordIdeas}.
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanIdeaService::Client#generate_keyword_ideas KeywordPlanIdeaService.GenerateKeywordIdeas}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::GenerateKeywordIdeaResult>]
