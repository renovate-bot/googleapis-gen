    ...
    module GoogleAds
      module V4
        module Common
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::MonthlySearchVolume>]
          #     Approximate number of searches on this query for the past twelve months.
          # @!attribute [rw] competition
          #   @return [::Google::Ads::GoogleAds::V4::Enums::KeywordPlanCompetitionLevelEnum::KeywordPlanCompetitionLevel]
