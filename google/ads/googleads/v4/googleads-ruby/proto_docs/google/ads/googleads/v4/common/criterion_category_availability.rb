    ...
    module GoogleAds
      module V4
        module Common
          ...
          # @!attribute [rw] locale
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::CriterionCategoryLocaleAvailability>]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::CriterionCategoryChannelAvailabilityModeEnum::CriterionCategoryChannelAvailabilityMode]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType>]
          ...
          # @!attribute [rw] availability_mode
          #   @return [::Google::Ads::GoogleAds::V4::Enums::CriterionCategoryLocaleAvailabilityModeEnum::CriterionCategoryLocaleAvailabilityMode]
