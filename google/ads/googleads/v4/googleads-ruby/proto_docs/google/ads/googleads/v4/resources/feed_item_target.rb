    ...
    module GoogleAds
      module V4
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::FeedItemTargetTypeEnum::FeedItemTargetType]
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V4::Enums::FeedItemTargetStatusEnum::FeedItemTargetStatus]
