    ...
    module GoogleAds
      module V4
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserInterestTaxonomyTypeEnum::UserInterestTaxonomyType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::CriterionCategoryAvailability>]
