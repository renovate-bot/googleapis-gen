    ...
    module GoogleAds
      module V4
        module Resources
          ...
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V4::Enums::SimulationTypeEnum::SimulationType]
          #     Output only. The field that the simulation modifies.
          # @!attribute [r] modification_method
          #   @return [::Google::Ads::GoogleAds::V4::Enums::SimulationModificationMethodEnum::SimulationModificationMethod]
