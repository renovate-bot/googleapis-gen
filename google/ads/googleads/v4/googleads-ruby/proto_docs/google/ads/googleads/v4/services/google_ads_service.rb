...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client#search GoogleAdsService.Search}.
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::SummaryRowSettingEnum::SummaryRowSetting]
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client#search GoogleAdsService.Search}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::GoogleAdsRow>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client#search_stream GoogleAdsService.SearchStream}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer being queried.
          # @!attribute [rw] query
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client#search_stream GoogleAdsService.SearchStream}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::GoogleAdsRow>]
          #     The list of rows that matched the query.
          # @!attribute [rw] field_mask
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client#mutate GoogleAdsService.Mutate}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::GoogleAdsService::Client#mutate GoogleAdsService.Mutate}.
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateOperationResponse>]
