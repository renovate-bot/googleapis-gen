    ...
    module GoogleAds
      module V4
        module Resources
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Resources::FeedItemAttributeValue>]
          #     The feed item's attribute values.
          # @!attribute [rw] geo_targeting_restriction
          #   @return [::Google::Ads::GoogleAds::V4::Enums::GeoTargetingRestrictionEnum::GeoTargetingRestriction]
          #     Geo targeting restriction specifies the type of location that can be used
          #     for targeting.
          # @!attribute [rw] url_custom_parameters
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::CustomParameter>]
          #     The list of mappings used to substitute custom parameter tags in a
          #     `tracking_url_template`, `final_urls`, or `mobile_final_urls`.
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V4::Enums::FeedItemStatusEnum::FeedItemStatus]
          #     Output only. Status of the feed item.
          #     This field is read-only.
          # @!attribute [r] policy_infos
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Resources::FeedItemPlaceholderPolicyInfo>]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::PolicyReviewStatusEnum::PolicyReviewStatus]
          #     Output only. Where the placeholder type is in the review process.
          # @!attribute [r] approval_status
          #   @return [::Google::Ads::GoogleAds::V4::Enums::PolicyApprovalStatusEnum::PolicyApprovalStatus]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Common::PolicyTopicEntry>]
          #     Output only. The list of policy findings for the placeholder type.
          # @!attribute [r] validation_status
          #   @return [::Google::Ads::GoogleAds::V4::Enums::FeedItemValidationStatusEnum::FeedItemValidationStatus]
          #     Output only. The validation status of the palceholder type.
          # @!attribute [r] validation_errors
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Resources::FeedItemValidationError>]
          #     Output only. List of placeholder type validation errors.
          # @!attribute [r] quality_approval_status
          #   @return [::Google::Ads::GoogleAds::V4::Enums::FeedItemQualityApprovalStatusEnum::FeedItemQualityApprovalStatus]
          #     Output only. Placeholder type quality evaluation approval status.
          # @!attribute [r] quality_disapproval_reasons
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Enums::FeedItemQualityDisapprovalReasonEnum::FeedItemQualityDisapprovalReason>]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Errors::FeedItemValidationErrorEnum::FeedItemValidationError]
