    ...
    module GoogleAds
      module V4
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListMembershipStatusEnum::UserListMembershipStatus]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListSizeRangeEnum::UserListSizeRange]
          ...
          #     This field is read-only.
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListTypeEnum::UserListType]
          #     Output only. Type of this list.
          #
          #     This field is read-only.
          # @!attribute [rw] closing_reason
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListClosingReasonEnum::UserListClosingReason]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::AccessReasonEnum::AccessReason]
          ...
          #   @return [::Google::Ads::GoogleAds::V4::Enums::UserListAccessStatusEnum::UserListAccessStatus]
