...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanService::Client#get_keyword_plan KeywordPlanService.GetKeywordPlan}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanService::Client#mutate_keyword_plans KeywordPlanService.MutateKeywordPlans}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose keyword plans are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::KeywordPlanOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateKeywordPlansResult>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanService::Client#generate_forecast_curve KeywordPlanService.GenerateForecastCurve}.
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanService::Client#generate_forecast_curve KeywordPlanService.GenerateForecastCurve}.
          # @!attribute [rw] campaign_forecast_curves
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::KeywordPlanCampaignForecastCurve>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanService::Client#generate_forecast_metrics KeywordPlanService.GenerateForecastMetrics}.
          # @!attribute [rw] keyword_plan
          #   @return [::String]
          #     Required. The resource name of the keyword plan to be forecasted.
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanService::Client#generate_forecast_metrics KeywordPlanService.GenerateForecastMetrics}.
          # @!attribute [rw] campaign_forecasts
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::KeywordPlanCampaignForecast>]
          #     List of campaign forecasts.
          #     One maximum.
          # @!attribute [rw] ad_group_forecasts
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::KeywordPlanAdGroupForecast>]
          #     List of ad group forecasts.
          # @!attribute [rw] keyword_forecasts
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::KeywordPlanKeywordForecast>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::KeywordPlanMaxCpcBidForecast>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanService::Client#generate_historical_metrics KeywordPlanService.GenerateHistoricalMetrics}.
          # @!attribute [rw] keyword_plan
          #   @return [::String]
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanService::Client#generate_historical_metrics KeywordPlanService.GenerateHistoricalMetrics}.
          # @!attribute [rw] metrics
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::KeywordPlanKeywordHistoricalMetrics>]
