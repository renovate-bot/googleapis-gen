...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::RecommendationService::Client#get_recommendation RecommendationService.GetRecommendation}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::RecommendationService::Client#apply_recommendation RecommendationService.ApplyRecommendation}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer with the recommendation.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::ApplyRecommendationOperation>]
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::RecommendationService::Client#apply_recommendation RecommendationService.ApplyRecommendation}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::ApplyRecommendationResult>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::RecommendationService::Client#dismiss_recommendation RecommendationService.DismissRecommendation}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer with the recommendation.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::DismissRecommendationRequest::DismissRecommendationOperation>]
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::RecommendationService::Client#dismiss_recommendation RecommendationService.DismissRecommendation}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::DismissRecommendationResponse::DismissRecommendationResult>]
