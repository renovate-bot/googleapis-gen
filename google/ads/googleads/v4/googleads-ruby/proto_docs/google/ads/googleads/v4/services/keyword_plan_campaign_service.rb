...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::KeywordPlanCampaignService::Client#get_keyword_plan_campaign KeywordPlanCampaignService.GetKeywordPlanCampaign}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V4::Services::KeywordPlanCampaignService::Client#mutate_keyword_plan_campaigns KeywordPlanCampaignService.MutateKeywordPlanCampaigns}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose Keyword Plan campaigns are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::KeywordPlanCampaignOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Services::MutateKeywordPlanCampaignResult>]
