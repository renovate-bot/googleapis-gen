...
module Google
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for {::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Client#list_merchant_center_links MerchantCenterLinkService.ListMerchantCenterLinks}.
          ...
          # Response message for {::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Client#list_merchant_center_links MerchantCenterLinkService.ListMerchantCenterLinks}.
          # @!attribute [rw] merchant_center_links
          #   @return [::Array<::Google::Ads::GoogleAds::V4::Resources::MerchantCenterLink>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Client#get_merchant_center_link MerchantCenterLinkService.GetMerchantCenterLink}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Client#mutate_merchant_center_link MerchantCenterLinkService.MutateMerchantCenterLink}.
          # @!attribute [rw] customer_id
          #   @return [::String]
