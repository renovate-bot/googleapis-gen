  ...
  module Ads
    module GoogleAds
      module V4
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V4::Services::BillingSetupService::Client#get_billing_setup BillingSetupService.GetBillingSetup}.
          ...
          # @!attribute [rw] result
          #   @return [::Google::Ads::GoogleAds::V4::Services::MutateBillingSetupResult]
