...
import com.google.ads.googleads.v4.resources.CustomInterestName;
import com.google.ads.googleads.v4.services.stub.CustomInterestServiceStub;
import com.google.ads.googleads.v4.services.stub.CustomInterestServiceStubSettings;
...
public class CustomInterestServiceClient implements BackgroundResource {
   ...
   * try (CustomInterestServiceClient customInterestServiceClient =
   *     CustomInterestServiceClient.create()) {
   *   String resourceName = CustomInterestName.of("[CUSTOMER]", "[CUSTOM_INTEREST]").toString();
   *   CustomInterest response = customInterestServiceClient.getCustomInterest(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetCustomInterestRequest request =
   *       GetCustomInterestRequest.newBuilder()
   *           .setResourceName(CustomInterestName.of("[CUSTOMER]", "[CUSTOM_INTEREST]").toString())
   *           .build();
