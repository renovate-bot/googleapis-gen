...
import com.google.ads.googleads.v4.services.stub.AssetServiceStubSettings;
...
public class AssetServiceSettings extends ClientSettings<AssetServiceSettings> {
  ...
  public UnaryCallSettings<GetAssetRequest, Asset> getAssetSettings() {
    return ((AssetServiceStubSettings) getStubSettings()).getAssetSettings();
  }
  ...
  public UnaryCallSettings<MutateAssetsRequest, MutateAssetsResponse> mutateAssetsSettings() {
    return ((AssetServiceStubSettings) getStubSettings()).mutateAssetsSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<AssetServiceSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<MutateAssetsRequest, MutateAssetsResponse>
      ...
      return getStubSettingsBuilder().mutateAssetsSettings();
    }
