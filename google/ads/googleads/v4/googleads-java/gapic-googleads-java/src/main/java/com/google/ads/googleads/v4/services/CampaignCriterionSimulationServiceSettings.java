 ...
 *
 * <p>For example, to set the total timeout of getCampaignCriterionSimulation to 30 seconds:
 *
 * <pre>{@code
 * CampaignCriterionSimulationServiceSettings.Builder
 *     campaignCriterionSimulationServiceSettingsBuilder =
