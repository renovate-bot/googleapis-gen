...
import com.google.ads.googleads.v4.resources.FeedPlaceholderViewName;
import com.google.ads.googleads.v4.services.stub.FeedPlaceholderViewServiceStub;
import com.google.ads.googleads.v4.services.stub.FeedPlaceholderViewServiceStubSettings;
...
public class FeedPlaceholderViewServiceClient implements BackgroundResource {
   ...
   * calls. This is for advanced usage - prefer using create(FeedPlaceholderViewServiceSettings).
   */
   ...
   *     FeedPlaceholderViewServiceClient.create()) {
   *   String resourceName =
   *       FeedPlaceholderViewName.of("[CUSTOMER]", "[FEED_PLACEHOLDER_VIEW]").toString();
   *   FeedPlaceholderView response =
   *       feedPlaceholderViewServiceClient.getFeedPlaceholderView(resourceName);
   * }
   * }</pre>
