...
import com.google.ads.googleads.v4.services.GetAssetRequest;
import com.google.ads.googleads.v4.services.MutateAssetsRequest;
...
public class AssetServiceStubSettings extends StubSettings<AssetServiceStubSettings> {
  ...
  private final UnaryCallSettings<MutateAssetsRequest, MutateAssetsResponse> mutateAssetsSettings;
  ...
  /** Returns the object with the settings used for calls to mutateAssets. */
  public UnaryCallSettings<MutateAssetsRequest, MutateAssetsResponse> mutateAssetsSettings() {
    return mutateAssetsSettings;
  }
  ...
  protected AssetServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    mutateAssetsSettings = settingsBuilder.mutateAssetsSettings().build();
  }
  ...
  public static class Builder extends StubSettings.Builder<AssetServiceStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<MutateAssetsRequest, MutateAssetsResponse>
        mutateAssetsSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      mutateAssetsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(getAssetSettings, mutateAssetsSettings);
      initDefaults(this);
    }
    ...
    protected Builder(AssetServiceStubSettings settings) {
      ...
      mutateAssetsSettings = settings.mutateAssetsSettings.toBuilder();
    ...
    /** Returns the builder for the settings used for calls to mutateAssets. */
    public UnaryCallSettings.Builder<MutateAssetsRequest, MutateAssetsResponse>
        mutateAssetsSettings() {
      return mutateAssetsSettings;
    }
