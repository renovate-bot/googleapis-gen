...
import com.google.ads.googleads.v4.resources.CampaignCriterionSimulationName;
import com.google.ads.googleads.v4.services.stub.CampaignCriterionSimulationServiceStub;
import com.google.ads.googleads.v4.services.stub.CampaignCriterionSimulationServiceStubSettings;
...
public class CampaignCriterionSimulationServiceClient implements BackgroundResource {
   ...
   *                       "[CUSTOMER]", "[CAMPAIGN_CRITERION_SIMULATION]")
   *                   .toString())
   *           .build();
   *   CampaignCriterionSimulation response =
