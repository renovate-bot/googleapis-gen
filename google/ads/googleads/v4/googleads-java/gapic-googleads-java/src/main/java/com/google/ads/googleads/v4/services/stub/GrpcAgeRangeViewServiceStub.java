...
import com.google.ads.googleads.v4.services.GetAgeRangeViewRequest;
  ...
  protected GrpcAgeRangeViewServiceStub(
    ...
    GrpcCallSettings<GetAgeRangeViewRequest, AgeRangeView> getAgeRangeViewTransportSettings =
        GrpcCallSettings.<GetAgeRangeViewRequest, AgeRangeView>newBuilder()
            ...
            .setParamsExtractor(
                new RequestParamsExtractor<GetAgeRangeViewRequest>() {
                  @Override
                  public Map<String, String> extract(GetAgeRangeViewRequest request) {
