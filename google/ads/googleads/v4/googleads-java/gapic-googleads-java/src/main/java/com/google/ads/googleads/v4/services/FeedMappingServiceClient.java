...
import com.google.ads.googleads.v4.resources.FeedMappingName;
import com.google.ads.googleads.v4.services.stub.FeedMappingServiceStub;
import com.google.ads.googleads.v4.services.stub.FeedMappingServiceStubSettings;
...
public class FeedMappingServiceClient implements BackgroundResource {
   ...
   * <pre>{@code
   * try (FeedMappingServiceClient feedMappingServiceClient = FeedMappingServiceClient.create()) {
   *   String resourceName = FeedMappingName.of("[CUSTOMER]", "[FEED_MAPPING]").toString();
   *   FeedMapping response = feedMappingServiceClient.getFeedMapping(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetFeedMappingRequest request =
   *       GetFeedMappingRequest.newBuilder()
   *           .setResourceName(FeedMappingName.of("[CUSTOMER]", "[FEED_MAPPING]").toString())
   *           .build();
