...
import com.google.ads.googleads.v4.services.GetAdGroupFeedRequest;
import com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest;
import com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse;
  ...
  private static final MethodDescriptor<GetAdGroupFeedRequest, AdGroupFeed>
      getAdGroupFeedMethodDescriptor =
          MethodDescriptor.<GetAdGroupFeedRequest, AdGroupFeed>newBuilder()
              ...
              .setFullMethodName(
                  "google.ads.googleads.v4.services.AdGroupFeedService/GetAdGroupFeed")
  ...
  private static final MethodDescriptor<MutateAdGroupFeedsRequest, MutateAdGroupFeedsResponse>
      mutateAdGroupFeedsMethodDescriptor =
          MethodDescriptor.<MutateAdGroupFeedsRequest, MutateAdGroupFeedsResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.ads.googleads.v4.services.AdGroupFeedService/MutateAdGroupFeeds")
              .setRequestMarshaller(
