...
import com.google.ads.googleads.v4.resources.CampaignCriterionName;
import com.google.ads.googleads.v4.services.stub.CampaignCriterionServiceStub;
import com.google.ads.googleads.v4.services.stub.CampaignCriterionServiceStubSettings;
...
public class CampaignCriterionServiceClient implements BackgroundResource {
   ...
   *     CampaignCriterionServiceClient.create()) {
   *   String resourceName =
   *       CampaignCriterionName.of("[CUSTOMER]", "[CAMPAIGN_CRITERION]").toString();
   *   CampaignCriterion response =
   *       campaignCriterionServiceClient.getCampaignCriterion(resourceName);
   * }
   * }</pre>
