...
import com.google.ads.googleads.v4.services.stub.ReachPlanServiceStub;
import com.google.ads.googleads.v4.services.stub.ReachPlanServiceStubSettings;
...
public class ReachPlanServiceClient implements BackgroundResource {
   ...
   *   ListPlannableProductsRequest request =
   *       ListPlannableProductsRequest.newBuilder()
   *           .setPlannableLocationId(StringValue.newBuilder().build())
   *           .build();
   *   ListPlannableProductsResponse response =
   ...
   *           .setBudgetMicros(Int64Value.newBuilder().build())
   ...
   *           .setCookieFrequencyCap(Int32Value.newBuilder().build())
   *           .setCookieFrequencyCapSetting(FrequencyCap.newBuilder().build())
   *           .setMinEffectiveFrequency(Int32Value.newBuilder().build())
