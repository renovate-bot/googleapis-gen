...
import com.google.ads.googleads.v4.resources.PaidOrganicSearchTermViewName;
import com.google.ads.googleads.v4.services.stub.PaidOrganicSearchTermViewServiceStub;
import com.google.ads.googleads.v4.services.stub.PaidOrganicSearchTermViewServiceStubSettings;
...
public class PaidOrganicSearchTermViewServiceClient implements BackgroundResource {
   ...
   *           .build();
   *   PaidOrganicSearchTermView response =
   *       paidOrganicSearchTermViewServiceClient.getPaidOrganicSearchTermView(request);
   * }
   * }</pre>
   *
   ...
   *                   .toString())
   *           .build();
   *   ApiFuture<PaidOrganicSearchTermView> future =
