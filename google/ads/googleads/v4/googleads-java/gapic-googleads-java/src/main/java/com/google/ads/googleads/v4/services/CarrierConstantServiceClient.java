...
import com.google.ads.googleads.v4.resources.CarrierConstantName;
import com.google.ads.googleads.v4.services.stub.CarrierConstantServiceStub;
import com.google.ads.googleads.v4.services.stub.CarrierConstantServiceStubSettings;
...
public class CarrierConstantServiceClient implements BackgroundResource {
   ...
   * try (CarrierConstantServiceClient carrierConstantServiceClient =
   *     CarrierConstantServiceClient.create()) {
   *   String resourceName = CarrierConstantName.of("[CARRIER_CONSTANT]").toString();
   *   CarrierConstant response = carrierConstantServiceClient.getCarrierConstant(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetCarrierConstantRequest request =
   *       GetCarrierConstantRequest.newBuilder()
   *           .setResourceName(CarrierConstantName.of("[CARRIER_CONSTANT]").toString())
   *           .build();
