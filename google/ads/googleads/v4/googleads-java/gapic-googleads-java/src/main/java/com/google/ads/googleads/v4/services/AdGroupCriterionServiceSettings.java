...
import com.google.ads.googleads.v4.services.stub.AdGroupCriterionServiceStubSettings;
...
/**
 * Settings class to configure an instance of {@link AdGroupCriterionServiceClient}.
 *
 ...
 *
 * <pre>{@code
 * AdGroupCriterionServiceSettings.Builder adGroupCriterionServiceSettingsBuilder =
 ...
 *     adGroupCriterionServiceSettingsBuilder.build();
 * }</pre>
 */
@Generated("by gapic-generator-java")
public class AdGroupCriterionServiceSettings
    extends ClientSettings<AdGroupCriterionServiceSettings> {
  ...
  public UnaryCallSettings<MutateAdGroupCriteriaRequest, MutateAdGroupCriteriaResponse>
    ...
    return ((AdGroupCriterionServiceStubSettings) getStubSettings())
        .mutateAdGroupCriteriaSettings();
  }

  public static final AdGroupCriterionServiceSettings create(
      AdGroupCriterionServiceStubSettings stub) throws IOException {
    return new AdGroupCriterionServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  protected AdGroupCriterionServiceSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for AdGroupCriterionServiceSettings. */
  public static class Builder
      extends ClientSettings.Builder<AdGroupCriterionServiceSettings, Builder> {
    ...
    protected Builder(AdGroupCriterionServiceSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(AdGroupCriterionServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    @Override
    public AdGroupCriterionServiceSettings build() throws IOException {
