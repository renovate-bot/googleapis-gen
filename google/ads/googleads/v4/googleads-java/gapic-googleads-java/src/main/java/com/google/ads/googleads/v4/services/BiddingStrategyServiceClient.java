...
import com.google.ads.googleads.v4.resources.BiddingStrategyName;
import com.google.ads.googleads.v4.services.stub.BiddingStrategyServiceStub;
import com.google.ads.googleads.v4.services.stub.BiddingStrategyServiceStubSettings;
...
public class BiddingStrategyServiceClient implements BackgroundResource {
   ...
   * try (BiddingStrategyServiceClient biddingStrategyServiceClient =
   *     BiddingStrategyServiceClient.create()) {
   *   String resourceName = BiddingStrategyName.of("[CUSTOMER]", "[BIDDING_STRATEGY]").toString();
   *   BiddingStrategy response = biddingStrategyServiceClient.getBiddingStrategy(resourceName);
   * }
   * }</pre>
   *
   ...
   *       GetBiddingStrategyRequest.newBuilder()
   *           .setResourceName(
   *               BiddingStrategyName.of("[CUSTOMER]", "[BIDDING_STRATEGY]").toString())
   *           .build();
