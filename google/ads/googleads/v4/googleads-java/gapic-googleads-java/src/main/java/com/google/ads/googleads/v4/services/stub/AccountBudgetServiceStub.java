...
/**
 * Base stub class for the AccountBudgetService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@Generated("by gapic-generator-java")
public abstract class AccountBudgetServiceStub implements BackgroundResource {

  public UnaryCallable<GetAccountBudgetRequest, AccountBudget> getAccountBudgetCallable() {
    throw new UnsupportedOperationException("Not implemented: getAccountBudgetCallable()");
  }
