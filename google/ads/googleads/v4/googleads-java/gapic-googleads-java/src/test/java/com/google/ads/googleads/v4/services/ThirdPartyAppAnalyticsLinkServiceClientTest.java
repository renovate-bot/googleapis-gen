...
import com.google.ads.googleads.v4.resources.ThirdPartyAppAnalyticsLinkName;
  ...
  public void getThirdPartyAppAnalyticsLinkTest() throws Exception {
    ThirdPartyAppAnalyticsLink expectedResponse =
        ThirdPartyAppAnalyticsLink.newBuilder()
            .setResourceName(
                ThirdPartyAppAnalyticsLinkName.of("[CUSTOMER]", "[THIRD_PARTY_APP_ANALYTICS_LINK]")
                    .toString())
            .setShareableLinkId(StringValue.newBuilder().build())
            .build();
