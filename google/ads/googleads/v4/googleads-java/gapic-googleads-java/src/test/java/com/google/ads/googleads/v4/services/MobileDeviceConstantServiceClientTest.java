...
import com.google.ads.googleads.v4.resources.MobileDeviceConstantName;
  ...
  public void getMobileDeviceConstantTest() throws Exception {
    MobileDeviceConstant expectedResponse =
        MobileDeviceConstant.newBuilder()
            ...
            .setManufacturerName(StringValue.newBuilder().build())
            .setOperatingSystemName(StringValue.newBuilder().build())
            .build();
