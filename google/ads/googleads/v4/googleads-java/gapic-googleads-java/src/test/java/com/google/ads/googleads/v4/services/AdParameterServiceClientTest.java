...
import com.google.ads.googleads.v4.resources.AdParameterName;
  ...
  public void getAdParameterTest() throws Exception {
    AdParameter expectedResponse =
        AdParameter.newBuilder()
            ...
            .setParameterIndex(Int64Value.newBuilder().build())
            .setInsertionText(StringValue.newBuilder().build())
            .build();
