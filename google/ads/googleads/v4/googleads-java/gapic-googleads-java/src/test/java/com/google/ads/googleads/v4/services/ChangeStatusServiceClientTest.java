...
import com.google.ads.googleads.v4.resources.ChangeStatusName;
  ...
  public void getChangeStatusTest() throws Exception {
    ChangeStatus expectedResponse =
        ChangeStatus.newBuilder()
            ...
            .setFeedItem(StringValue.newBuilder().build())
            .setAdGroupFeed(StringValue.newBuilder().build())
            .setCampaignFeed(StringValue.newBuilder().build())
            .setAdGroupBidModifier(StringValue.newBuilder().build())
            .build();
