...
import com.google.ads.googleads.v4.resources.OperatingSystemVersionConstantName;
  ...
  public void getOperatingSystemVersionConstantTest() throws Exception {
    OperatingSystemVersionConstant expectedResponse =
        OperatingSystemVersionConstant.newBuilder()
            ...
            .setOsMajorVersion(Int32Value.newBuilder().build())
            .setOsMinorVersion(Int32Value.newBuilder().build())
            .build();
