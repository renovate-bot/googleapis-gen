...
import com.google.ads.googleads.v4.common.ExplorerAutoOptimizerSetting;
  ...
  public void getAdGroupTest() throws Exception {
    AdGroup expectedResponse =
        AdGroup.newBuilder()
            ...
            .setTargetCpaMicros(Int64Value.newBuilder().build())
            .setCpvBidMicros(Int64Value.newBuilder().build())
            .setTargetCpmMicros(Int64Value.newBuilder().build())
            .setTargetRoas(DoubleValue.newBuilder().build())
            ...
            .setEffectiveTargetCpaMicros(Int64Value.newBuilder().build())
            .setEffectiveTargetRoas(DoubleValue.newBuilder().build())
