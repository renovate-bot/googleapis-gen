...
import com.google.ads.googleads.v4.common.FinalAppUrl;
import com.google.ads.googleads.v4.common.UrlCollection;
import com.google.ads.googleads.v4.resources.Ad;
import com.google.ads.googleads.v4.resources.AdName;
...
public class AdServiceClientTest {
  ...
  public void getAdTest() throws Exception {
    Ad expectedResponse =
        Ad.newBuilder()
            ...
            .setDisplayUrl(StringValue.newBuilder().build())
            .setAddedByGoogleAds(BoolValue.newBuilder().build())
  ...
  public void mutateAdsTest() throws Exception {
    MutateAdsResponse expectedResponse =
        MutateAdsResponse.newBuilder().addAllResults(new ArrayList<MutateAdResult>()).build();
    mockAdService.addResponse(expectedResponse);
