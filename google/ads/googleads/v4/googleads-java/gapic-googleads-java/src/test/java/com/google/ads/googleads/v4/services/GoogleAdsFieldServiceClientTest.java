...
import com.google.ads.googleads.v4.resources.GoogleAdsFieldName;
  ...
  public void getGoogleAdsFieldTest() throws Exception {
    GoogleAdsField expectedResponse =
        GoogleAdsField.newBuilder()
            ...
            .setSelectable(BoolValue.newBuilder().build())
            .setFilterable(BoolValue.newBuilder().build())
            .setSortable(BoolValue.newBuilder().build())
            .addAllSelectableWith(new ArrayList<StringValue>())
            .addAllAttributeResources(new ArrayList<StringValue>())
            .addAllMetrics(new ArrayList<StringValue>())
            .addAllSegments(new ArrayList<StringValue>())
            .addAllEnumValues(new ArrayList<StringValue>())
            .setTypeUrl(StringValue.newBuilder().build())
            .setIsRepeated(BoolValue.newBuilder().build())
            .build();
