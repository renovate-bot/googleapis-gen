...
import com.google.ads.googleads.v4.resources.AccountBudgetProposalName;
  ...
  public void getAccountBudgetProposalTest() throws Exception {
    AccountBudgetProposal expectedResponse =
        AccountBudgetProposal.newBuilder()
            .setResourceName(
                AccountBudgetProposalName.of("[CUSTOMER]", "[ACCOUNT_BUDGET_PROPOSAL]").toString())
            .setId(Int64Value.newBuilder().build())
            .setBillingSetup(StringValue.newBuilder().build())
            .setAccountBudget(StringValue.newBuilder().build())
            .setProposedName(StringValue.newBuilder().build())
            .setApprovedStartDateTime(StringValue.newBuilder().build())
            .setProposedPurchaseOrderNumber(StringValue.newBuilder().build())
            .setProposedNotes(StringValue.newBuilder().build())
            .setCreationDateTime(StringValue.newBuilder().build())
            .setApprovalDateTime(StringValue.newBuilder().build())
            .build();
