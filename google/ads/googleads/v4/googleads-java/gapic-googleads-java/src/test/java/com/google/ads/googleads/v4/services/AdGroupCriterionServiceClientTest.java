...
import com.google.ads.googleads.v4.resources.AdGroupCriterionName;
  ...
  public void getAdGroupCriterionTest() throws Exception {
    AdGroupCriterion expectedResponse =
        AdGroupCriterion.newBuilder()
            ...
            .setCriterionId(Int64Value.newBuilder().build())
            .setQualityInfo(AdGroupCriterion.QualityInfo.newBuilder().build())
            .setAdGroup(StringValue.newBuilder().build())
            .setNegative(BoolValue.newBuilder().build())
            .addAllDisapprovalReasons(new ArrayList<StringValue>())
            .setBidModifier(DoubleValue.newBuilder().build())
            .setCpcBidMicros(Int64Value.newBuilder().build())
            .setCpmBidMicros(Int64Value.newBuilder().build())
            .setCpvBidMicros(Int64Value.newBuilder().build())
            .setPercentCpcBidMicros(Int64Value.newBuilder().build())
            .setEffectiveCpcBidMicros(Int64Value.newBuilder().build())
            .setEffectiveCpmBidMicros(Int64Value.newBuilder().build())
            .setEffectiveCpvBidMicros(Int64Value.newBuilder().build())
            .setEffectivePercentCpcBidMicros(Int64Value.newBuilder().build())
            .setPositionEstimates(AdGroupCriterion.PositionEstimates.newBuilder().build())
            .addAllFinalUrls(new ArrayList<StringValue>())
            .addAllFinalMobileUrls(new ArrayList<StringValue>())
            .setFinalUrlSuffix(StringValue.newBuilder().build())
            .setTrackingUrlTemplate(StringValue.newBuilder().build())
