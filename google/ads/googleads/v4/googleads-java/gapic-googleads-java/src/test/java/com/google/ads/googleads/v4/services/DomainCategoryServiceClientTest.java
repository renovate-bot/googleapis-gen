  ...
  public void getDomainCategoryTest() throws Exception {
    DomainCategory expectedResponse =
        DomainCategory.newBuilder()
            ...
            .setCategory(StringValue.newBuilder().build())
            .setLanguageCode(StringValue.newBuilder().build())
            .setDomain(StringValue.newBuilder().build())
            .setCoverageFraction(DoubleValue.newBuilder().build())
            .setCategoryRank(Int64Value.newBuilder().build())
            .setHasChildren(BoolValue.newBuilder().build())
            .setRecommendedCpcBidMicros(Int64Value.newBuilder().build())
            .build();
