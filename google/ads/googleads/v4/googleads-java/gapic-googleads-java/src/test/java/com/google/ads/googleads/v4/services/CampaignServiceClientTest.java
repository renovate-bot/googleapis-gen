  ...
  public void getCampaignTest() throws Exception {
    Campaign expectedResponse =
        Campaign.newBuilder()
            ...
            .addAllLabels(new ArrayList<StringValue>())
            .setBaseCampaign(StringValue.newBuilder().build())
            .setCampaignBudget(StringValue.newBuilder().build())
            ...
            .setOptimizationScore(DoubleValue.newBuilder().build())
            .build();
