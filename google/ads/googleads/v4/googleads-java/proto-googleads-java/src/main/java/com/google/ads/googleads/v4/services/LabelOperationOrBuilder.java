...
public interface LabelOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.services.LabelOperation)
   ...
   * @return The create.
   */
  com.google.ads.googleads.v4.resources.Label getCreate();
  /**
   * <pre>
   * Create operation: No resource name is expected for the new label.
   * </pre>
   ...
   * <code>.google.ads.googleads.v4.resources.Label create = 1;</code>
   */
  com.google.ads.googleads.v4.resources.LabelOrBuilder getCreateOrBuilder();
   ...
   * @return The update.
   */
  com.google.ads.googleads.v4.resources.Label getUpdate();
  /**
   * <pre>
   * Update operation: The label is expected to have a valid resource name.
   * </pre>
   ...
   * <code>.google.ads.googleads.v4.resources.Label update = 2;</code>
   */
  com.google.ads.googleads.v4.resources.LabelOrBuilder getUpdateOrBuilder();
  ...
  public com.google.ads.googleads.v4.services.LabelOperation.OperationCase getOperationCase();
}
