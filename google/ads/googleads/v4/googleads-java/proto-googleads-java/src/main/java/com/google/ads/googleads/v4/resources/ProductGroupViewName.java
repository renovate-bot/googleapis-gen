...
public class ProductGroupViewName implements ResourceName {
  private static final PathTemplate CUSTOMER_PRODUCT_GROUP_VIEW =
  ...
  public static ProductGroupViewName of(String customer, String productGroupView) {
    return newBuilder().setCustomer(customer).setProductGroupView(productGroupView).build();
  }
  ...
  public static ProductGroupViewName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_PRODUCT_GROUP_VIEW.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return CUSTOMER_PRODUCT_GROUP_VIEW.matches(formattedString);
  }
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (productGroupView != null) {
            fieldMapBuilder.put("product_group_view", productGroupView);
          }
  ...
  public String toString() {
    return CUSTOMER_PRODUCT_GROUP_VIEW.instantiate(
        "customer", customer, "product_group_view", productGroupView);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.customer, that.customer)
          && Objects.equals(this.productGroupView, that.productGroupView);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(productGroupView);
    return h;
  }

  /** Builder for customers/{customer}/productGroupViews/{product_group_view}. */
