...
public interface AccountBudgetProposalOperationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v4.services.AccountBudgetProposalOperation)
   ...
   * @return The create.
   */
  com.google.ads.googleads.v4.resources.AccountBudgetProposal getCreate();
  /**
   * <pre>
   * Create operation: A new proposal to create a new budget, edit an
   * existing budget, end an actively running budget, or remove an approved
   ...
   * <code>.google.ads.googleads.v4.resources.AccountBudgetProposal create = 2;</code>
   */
  com.google.ads.googleads.v4.resources.AccountBudgetProposalOrBuilder getCreateOrBuilder();
  ...
  public com.google.ads.googleads.v4.services.AccountBudgetProposalOperation.OperationCase getOperationCase();
}
