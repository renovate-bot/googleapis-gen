...
public class ExtensionFeedItemName implements ResourceName {
  private static final PathTemplate CUSTOMER_EXTENSION_FEED_ITEM =
  ...
  public static ExtensionFeedItemName of(String customer, String extensionFeedItem) {
    return newBuilder().setCustomer(customer).setExtensionFeedItem(extensionFeedItem).build();
  }
  ...
  public static ExtensionFeedItemName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_EXTENSION_FEED_ITEM.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return CUSTOMER_EXTENSION_FEED_ITEM.matches(formattedString);
  }
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (extensionFeedItem != null) {
            fieldMapBuilder.put("extension_feed_item", extensionFeedItem);
          }
  ...
  public String toString() {
    return CUSTOMER_EXTENSION_FEED_ITEM.instantiate(
        "customer", customer, "extension_feed_item", extensionFeedItem);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.customer, that.customer)
          && Objects.equals(this.extensionFeedItem, that.extensionFeedItem);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(extensionFeedItem);
    return h;
  }

  /** Builder for customers/{customer}/extensionFeedItems/{extension_feed_item}. */
