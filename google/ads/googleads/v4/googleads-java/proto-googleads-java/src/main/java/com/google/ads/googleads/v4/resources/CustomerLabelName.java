...
public class CustomerLabelName implements ResourceName {
  private static final PathTemplate CUSTOMER_CUSTOMER_LABEL =
  ...
  public static CustomerLabelName of(String customer, String customerLabel) {
    return newBuilder().setCustomer(customer).setCustomerLabel(customerLabel).build();
  }

  public static String format(String customer, String customerLabel) {
    return newBuilder().setCustomer(customer).setCustomerLabel(customerLabel).build().toString();
  }
  ...
  public static CustomerLabelName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_CUSTOMER_LABEL.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return CUSTOMER_CUSTOMER_LABEL.matches(formattedString);
  }
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (customerLabel != null) {
            fieldMapBuilder.put("customer_label", customerLabel);
          }
  ...
  public String toString() {
    return CUSTOMER_CUSTOMER_LABEL.instantiate(
        "customer", customer, "customer_label", customerLabel);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.customer, that.customer)
          && Objects.equals(this.customerLabel, that.customerLabel);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(customerLabel);
    return h;
  }

  /** Builder for customers/{customer}/customerLabels/{customer_label}. */
