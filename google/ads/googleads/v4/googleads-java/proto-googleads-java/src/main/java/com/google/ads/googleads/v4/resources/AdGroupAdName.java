...
public class AdGroupAdName implements ResourceName {
  private static final PathTemplate CUSTOMER_AD_GROUP_AD =
  ...
  public static AdGroupAdName of(String customer, String adGroupAd) {
    return newBuilder().setCustomer(customer).setAdGroupAd(adGroupAd).build();
  }

  public static String format(String customer, String adGroupAd) {
    return newBuilder().setCustomer(customer).setAdGroupAd(adGroupAd).build().toString();
  }
  ...
  public static AdGroupAdName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_AD_GROUP_AD.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return CUSTOMER_AD_GROUP_AD.matches(formattedString);
  }
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (adGroupAd != null) {
            fieldMapBuilder.put("ad_group_ad", adGroupAd);
          }
  ...
  public String toString() {
    return CUSTOMER_AD_GROUP_AD.instantiate("customer", customer, "ad_group_ad", adGroupAd);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.customer, that.customer)
          && Objects.equals(this.adGroupAd, that.adGroupAd);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(adGroupAd);
    return h;
  }

  /** Builder for customers/{customer}/adGroupAds/{ad_group_ad}. */
