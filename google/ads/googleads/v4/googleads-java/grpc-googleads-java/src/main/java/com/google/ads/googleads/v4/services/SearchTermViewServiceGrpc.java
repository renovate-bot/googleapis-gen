...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/search_term_view_service.proto")
public final class SearchTermViewServiceGrpc {

  private SearchTermViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.SearchTermViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetSearchTermViewRequest,
      com.google.ads.googleads.v4.resources.SearchTermView> getGetSearchTermViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetSearchTermView",
      requestType = com.google.ads.googleads.v4.services.GetSearchTermViewRequest.class,
      responseType = com.google.ads.googleads.v4.resources.SearchTermView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetSearchTermViewRequest,
      com.google.ads.googleads.v4.resources.SearchTermView> getGetSearchTermViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetSearchTermViewRequest, com.google.ads.googleads.v4.resources.SearchTermView> getGetSearchTermViewMethod;
      ...
      synchronized (SearchTermViewServiceGrpc.class) {
        if ((getGetSearchTermViewMethod = SearchTermViewServiceGrpc.getGetSearchTermViewMethod) == null) {
          SearchTermViewServiceGrpc.getGetSearchTermViewMethod = getGetSearchTermViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetSearchTermViewRequest, com.google.ads.googleads.v4.resources.SearchTermView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetSearchTermView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetSearchTermViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.SearchTermView.getDefaultInstance()))
  ...
  public static abstract class SearchTermViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getSearchTermView(com.google.ads.googleads.v4.services.GetSearchTermViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.SearchTermView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetSearchTermViewRequest,
                com.google.ads.googleads.v4.resources.SearchTermView>(
  ...
  public static final class SearchTermViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SearchTermViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.SearchTermView getSearchTermView(com.google.ads.googleads.v4.services.GetSearchTermViewRequest request) {
  ...
  public static final class SearchTermViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SearchTermViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.SearchTermView> getSearchTermView(
        com.google.ads.googleads.v4.services.GetSearchTermViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SEARCH_TERM_VIEW:
          serviceImpl.getSearchTermView((com.google.ads.googleads.v4.services.GetSearchTermViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.SearchTermView>) responseObserver);
          break;
        default:
  ...
  private static abstract class SearchTermViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.SearchTermViewServiceProto.getDescriptor();
    }
