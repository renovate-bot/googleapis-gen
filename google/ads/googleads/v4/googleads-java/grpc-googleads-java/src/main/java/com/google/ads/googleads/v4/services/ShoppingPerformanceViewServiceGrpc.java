...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/shopping_performance_view_service.proto")
public final class ShoppingPerformanceViewServiceGrpc {

  private ShoppingPerformanceViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.ShoppingPerformanceViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest,
      com.google.ads.googleads.v4.resources.ShoppingPerformanceView> getGetShoppingPerformanceViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetShoppingPerformanceView",
      requestType = com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest.class,
      responseType = com.google.ads.googleads.v4.resources.ShoppingPerformanceView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest,
      com.google.ads.googleads.v4.resources.ShoppingPerformanceView> getGetShoppingPerformanceViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest, com.google.ads.googleads.v4.resources.ShoppingPerformanceView> getGetShoppingPerformanceViewMethod;
      ...
      synchronized (ShoppingPerformanceViewServiceGrpc.class) {
        if ((getGetShoppingPerformanceViewMethod = ShoppingPerformanceViewServiceGrpc.getGetShoppingPerformanceViewMethod) == null) {
          ShoppingPerformanceViewServiceGrpc.getGetShoppingPerformanceViewMethod = getGetShoppingPerformanceViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest, com.google.ads.googleads.v4.resources.ShoppingPerformanceView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetShoppingPerformanceView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.ShoppingPerformanceView.getDefaultInstance()))
  ...
  public static abstract class ShoppingPerformanceViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getShoppingPerformanceView(com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.ShoppingPerformanceView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest,
                com.google.ads.googleads.v4.resources.ShoppingPerformanceView>(
  ...
  public static final class ShoppingPerformanceViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ShoppingPerformanceViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.ShoppingPerformanceView getShoppingPerformanceView(com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest request) {
  ...
  public static final class ShoppingPerformanceViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ShoppingPerformanceViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.ShoppingPerformanceView> getShoppingPerformanceView(
        com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SHOPPING_PERFORMANCE_VIEW:
          serviceImpl.getShoppingPerformanceView((com.google.ads.googleads.v4.services.GetShoppingPerformanceViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.ShoppingPerformanceView>) responseObserver);
          break;
        default:
  ...
  private static abstract class ShoppingPerformanceViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.ShoppingPerformanceViewServiceProto.getDescriptor();
    }
