...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/feed_mapping_service.proto")
public final class FeedMappingServiceGrpc {

  private FeedMappingServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.FeedMappingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetFeedMappingRequest,
      com.google.ads.googleads.v4.resources.FeedMapping> getGetFeedMappingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeedMapping",
      requestType = com.google.ads.googleads.v4.services.GetFeedMappingRequest.class,
      responseType = com.google.ads.googleads.v4.resources.FeedMapping.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetFeedMappingRequest,
      com.google.ads.googleads.v4.resources.FeedMapping> getGetFeedMappingMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetFeedMappingRequest, com.google.ads.googleads.v4.resources.FeedMapping> getGetFeedMappingMethod;
      ...
      synchronized (FeedMappingServiceGrpc.class) {
        if ((getGetFeedMappingMethod = FeedMappingServiceGrpc.getGetFeedMappingMethod) == null) {
          FeedMappingServiceGrpc.getGetFeedMappingMethod = getGetFeedMappingMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetFeedMappingRequest, com.google.ads.googleads.v4.resources.FeedMapping>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeedMapping"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetFeedMappingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.FeedMapping.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateFeedMappingsRequest,
      com.google.ads.googleads.v4.services.MutateFeedMappingsResponse> getMutateFeedMappingsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateFeedMappings",
      requestType = com.google.ads.googleads.v4.services.MutateFeedMappingsRequest.class,
      responseType = com.google.ads.googleads.v4.services.MutateFeedMappingsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateFeedMappingsRequest,
      com.google.ads.googleads.v4.services.MutateFeedMappingsResponse> getMutateFeedMappingsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateFeedMappingsRequest, com.google.ads.googleads.v4.services.MutateFeedMappingsResponse> getMutateFeedMappingsMethod;
      ...
      synchronized (FeedMappingServiceGrpc.class) {
        if ((getMutateFeedMappingsMethod = FeedMappingServiceGrpc.getMutateFeedMappingsMethod) == null) {
          FeedMappingServiceGrpc.getMutateFeedMappingsMethod = getMutateFeedMappingsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.MutateFeedMappingsRequest, com.google.ads.googleads.v4.services.MutateFeedMappingsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateFeedMappings"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateFeedMappingsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateFeedMappingsResponse.getDefaultInstance()))
  ...
  public static abstract class FeedMappingServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeedMapping(com.google.ads.googleads.v4.services.GetFeedMappingRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.FeedMapping> responseObserver) {
     ...
     * </pre>
     */
    public void mutateFeedMappings(com.google.ads.googleads.v4.services.MutateFeedMappingsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateFeedMappingsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetFeedMappingRequest,
                com.google.ads.googleads.v4.resources.FeedMapping>(
                  this, METHODID_GET_FEED_MAPPING)))
          .addMethod(
            getMutateFeedMappingsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.MutateFeedMappingsRequest,
                com.google.ads.googleads.v4.services.MutateFeedMappingsResponse>(
  ...
  public static final class FeedMappingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FeedMappingServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.FeedMapping getFeedMapping(com.google.ads.googleads.v4.services.GetFeedMappingRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.services.MutateFeedMappingsResponse mutateFeedMappings(com.google.ads.googleads.v4.services.MutateFeedMappingsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class FeedMappingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FeedMappingServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.FeedMapping> getFeedMapping(
        com.google.ads.googleads.v4.services.GetFeedMappingRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.services.MutateFeedMappingsResponse> mutateFeedMappings(
        com.google.ads.googleads.v4.services.MutateFeedMappingsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEED_MAPPING:
          serviceImpl.getFeedMapping((com.google.ads.googleads.v4.services.GetFeedMappingRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.FeedMapping>) responseObserver);
          break;
        case METHODID_MUTATE_FEED_MAPPINGS:
          serviceImpl.mutateFeedMappings((com.google.ads.googleads.v4.services.MutateFeedMappingsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateFeedMappingsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class FeedMappingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.FeedMappingServiceProto.getDescriptor();
    }
