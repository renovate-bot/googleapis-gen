...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/ad_group_label_service.proto")
public final class AdGroupLabelServiceGrpc {

  private AdGroupLabelServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.AdGroupLabelService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupLabelRequest,
      com.google.ads.googleads.v4.resources.AdGroupLabel> getGetAdGroupLabelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupLabel",
      requestType = com.google.ads.googleads.v4.services.GetAdGroupLabelRequest.class,
      responseType = com.google.ads.googleads.v4.resources.AdGroupLabel.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupLabelRequest,
      com.google.ads.googleads.v4.resources.AdGroupLabel> getGetAdGroupLabelMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupLabelRequest, com.google.ads.googleads.v4.resources.AdGroupLabel> getGetAdGroupLabelMethod;
      ...
      synchronized (AdGroupLabelServiceGrpc.class) {
        if ((getGetAdGroupLabelMethod = AdGroupLabelServiceGrpc.getGetAdGroupLabelMethod) == null) {
          AdGroupLabelServiceGrpc.getGetAdGroupLabelMethod = getGetAdGroupLabelMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetAdGroupLabelRequest, com.google.ads.googleads.v4.resources.AdGroupLabel>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupLabel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetAdGroupLabelRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.AdGroupLabel.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest,
      com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse> getMutateAdGroupLabelsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdGroupLabels",
      requestType = com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest.class,
      responseType = com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest,
      com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse> getMutateAdGroupLabelsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest, com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse> getMutateAdGroupLabelsMethod;
      ...
      synchronized (AdGroupLabelServiceGrpc.class) {
        if ((getMutateAdGroupLabelsMethod = AdGroupLabelServiceGrpc.getMutateAdGroupLabelsMethod) == null) {
          AdGroupLabelServiceGrpc.getMutateAdGroupLabelsMethod = getMutateAdGroupLabelsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest, com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdGroupLabels"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse.getDefaultInstance()))
  ...
  public static abstract class AdGroupLabelServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroupLabel(com.google.ads.googleads.v4.services.GetAdGroupLabelRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AdGroupLabel> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAdGroupLabels(com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetAdGroupLabelRequest,
                com.google.ads.googleads.v4.resources.AdGroupLabel>(
                  this, METHODID_GET_AD_GROUP_LABEL)))
          .addMethod(
            getMutateAdGroupLabelsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest,
                com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse>(
  ...
  public static final class AdGroupLabelServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupLabelServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.AdGroupLabel getAdGroupLabel(com.google.ads.googleads.v4.services.GetAdGroupLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse mutateAdGroupLabels(com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AdGroupLabelServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupLabelServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.AdGroupLabel> getAdGroupLabel(
        com.google.ads.googleads.v4.services.GetAdGroupLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse> mutateAdGroupLabels(
        com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_LABEL:
          serviceImpl.getAdGroupLabel((com.google.ads.googleads.v4.services.GetAdGroupLabelRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AdGroupLabel>) responseObserver);
          break;
        case METHODID_MUTATE_AD_GROUP_LABELS:
          serviceImpl.mutateAdGroupLabels((com.google.ads.googleads.v4.services.MutateAdGroupLabelsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdGroupLabelsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupLabelServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.AdGroupLabelServiceProto.getDescriptor();
    }
