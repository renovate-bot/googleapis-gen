...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/feed_placeholder_view_service.proto")
public final class FeedPlaceholderViewServiceGrpc {

  private FeedPlaceholderViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.FeedPlaceholderViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest,
      com.google.ads.googleads.v4.resources.FeedPlaceholderView> getGetFeedPlaceholderViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeedPlaceholderView",
      requestType = com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest.class,
      responseType = com.google.ads.googleads.v4.resources.FeedPlaceholderView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest,
      com.google.ads.googleads.v4.resources.FeedPlaceholderView> getGetFeedPlaceholderViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest, com.google.ads.googleads.v4.resources.FeedPlaceholderView> getGetFeedPlaceholderViewMethod;
      ...
      synchronized (FeedPlaceholderViewServiceGrpc.class) {
        if ((getGetFeedPlaceholderViewMethod = FeedPlaceholderViewServiceGrpc.getGetFeedPlaceholderViewMethod) == null) {
          FeedPlaceholderViewServiceGrpc.getGetFeedPlaceholderViewMethod = getGetFeedPlaceholderViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest, com.google.ads.googleads.v4.resources.FeedPlaceholderView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeedPlaceholderView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.FeedPlaceholderView.getDefaultInstance()))
  ...
  public static abstract class FeedPlaceholderViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeedPlaceholderView(com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.FeedPlaceholderView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest,
                com.google.ads.googleads.v4.resources.FeedPlaceholderView>(
  ...
  public static final class FeedPlaceholderViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FeedPlaceholderViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.FeedPlaceholderView getFeedPlaceholderView(com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest request) {
  ...
  public static final class FeedPlaceholderViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FeedPlaceholderViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.FeedPlaceholderView> getFeedPlaceholderView(
        com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEED_PLACEHOLDER_VIEW:
          serviceImpl.getFeedPlaceholderView((com.google.ads.googleads.v4.services.GetFeedPlaceholderViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.FeedPlaceholderView>) responseObserver);
          break;
        default:
  ...
  private static abstract class FeedPlaceholderViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.FeedPlaceholderViewServiceProto.getDescriptor();
    }
