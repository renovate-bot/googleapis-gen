...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/gender_view_service.proto")
public final class GenderViewServiceGrpc {

  private GenderViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.GenderViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetGenderViewRequest,
      com.google.ads.googleads.v4.resources.GenderView> getGetGenderViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetGenderView",
      requestType = com.google.ads.googleads.v4.services.GetGenderViewRequest.class,
      responseType = com.google.ads.googleads.v4.resources.GenderView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetGenderViewRequest,
      com.google.ads.googleads.v4.resources.GenderView> getGetGenderViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetGenderViewRequest, com.google.ads.googleads.v4.resources.GenderView> getGetGenderViewMethod;
      ...
      synchronized (GenderViewServiceGrpc.class) {
        if ((getGetGenderViewMethod = GenderViewServiceGrpc.getGetGenderViewMethod) == null) {
          GenderViewServiceGrpc.getGetGenderViewMethod = getGetGenderViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetGenderViewRequest, com.google.ads.googleads.v4.resources.GenderView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetGenderView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetGenderViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.GenderView.getDefaultInstance()))
  ...
  public static abstract class GenderViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getGenderView(com.google.ads.googleads.v4.services.GetGenderViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.GenderView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetGenderViewRequest,
                com.google.ads.googleads.v4.resources.GenderView>(
  ...
  public static final class GenderViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GenderViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.GenderView getGenderView(com.google.ads.googleads.v4.services.GetGenderViewRequest request) {
  ...
  public static final class GenderViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GenderViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.GenderView> getGenderView(
        com.google.ads.googleads.v4.services.GetGenderViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_GENDER_VIEW:
          serviceImpl.getGenderView((com.google.ads.googleads.v4.services.GetGenderViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.GenderView>) responseObserver);
          break;
        default:
  ...
  private static abstract class GenderViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.GenderViewServiceProto.getDescriptor();
    }
