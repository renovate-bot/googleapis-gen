...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/ad_service.proto")
public final class AdServiceGrpc {

  private AdServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.AdService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdRequest,
      com.google.ads.googleads.v4.resources.Ad> getGetAdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAd",
      requestType = com.google.ads.googleads.v4.services.GetAdRequest.class,
      responseType = com.google.ads.googleads.v4.resources.Ad.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdRequest,
      com.google.ads.googleads.v4.resources.Ad> getGetAdMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdRequest, com.google.ads.googleads.v4.resources.Ad> getGetAdMethod;
      ...
      synchronized (AdServiceGrpc.class) {
        if ((getGetAdMethod = AdServiceGrpc.getGetAdMethod) == null) {
          AdServiceGrpc.getGetAdMethod = getGetAdMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetAdRequest, com.google.ads.googleads.v4.resources.Ad>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAd"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetAdRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.Ad.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdsRequest,
      com.google.ads.googleads.v4.services.MutateAdsResponse> getMutateAdsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAds",
      requestType = com.google.ads.googleads.v4.services.MutateAdsRequest.class,
      responseType = com.google.ads.googleads.v4.services.MutateAdsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdsRequest,
      com.google.ads.googleads.v4.services.MutateAdsResponse> getMutateAdsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdsRequest, com.google.ads.googleads.v4.services.MutateAdsResponse> getMutateAdsMethod;
    if ((getMutateAdsMethod = AdServiceGrpc.getMutateAdsMethod) == null) {
      synchronized (AdServiceGrpc.class) {
        if ((getMutateAdsMethod = AdServiceGrpc.getMutateAdsMethod) == null) {
          AdServiceGrpc.getMutateAdsMethod = getMutateAdsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.MutateAdsRequest, com.google.ads.googleads.v4.services.MutateAdsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAds"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdsResponse.getDefaultInstance()))
  ...
  public static abstract class AdServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAd(com.google.ads.googleads.v4.services.GetAdRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.Ad> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAds(com.google.ads.googleads.v4.services.MutateAdsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetAdRequest,
                com.google.ads.googleads.v4.resources.Ad>(
                  this, METHODID_GET_AD)))
          .addMethod(
            getMutateAdsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.MutateAdsRequest,
                com.google.ads.googleads.v4.services.MutateAdsResponse>(
  ...
  public static final class AdServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.Ad getAd(com.google.ads.googleads.v4.services.GetAdRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.services.MutateAdsResponse mutateAds(com.google.ads.googleads.v4.services.MutateAdsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AdServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.Ad> getAd(
        com.google.ads.googleads.v4.services.GetAdRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.services.MutateAdsResponse> mutateAds(
        com.google.ads.googleads.v4.services.MutateAdsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD:
          serviceImpl.getAd((com.google.ads.googleads.v4.services.GetAdRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.Ad>) responseObserver);
          break;
        case METHODID_MUTATE_ADS:
          serviceImpl.mutateAds((com.google.ads.googleads.v4.services.MutateAdsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.AdServiceProto.getDescriptor();
    }
