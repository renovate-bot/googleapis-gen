...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/ad_group_feed_service.proto")
public final class AdGroupFeedServiceGrpc {

  private AdGroupFeedServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.AdGroupFeedService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupFeedRequest,
      com.google.ads.googleads.v4.resources.AdGroupFeed> getGetAdGroupFeedMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupFeed",
      requestType = com.google.ads.googleads.v4.services.GetAdGroupFeedRequest.class,
      responseType = com.google.ads.googleads.v4.resources.AdGroupFeed.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupFeedRequest,
      com.google.ads.googleads.v4.resources.AdGroupFeed> getGetAdGroupFeedMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupFeedRequest, com.google.ads.googleads.v4.resources.AdGroupFeed> getGetAdGroupFeedMethod;
      ...
      synchronized (AdGroupFeedServiceGrpc.class) {
        if ((getGetAdGroupFeedMethod = AdGroupFeedServiceGrpc.getGetAdGroupFeedMethod) == null) {
          AdGroupFeedServiceGrpc.getGetAdGroupFeedMethod = getGetAdGroupFeedMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetAdGroupFeedRequest, com.google.ads.googleads.v4.resources.AdGroupFeed>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupFeed"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetAdGroupFeedRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.AdGroupFeed.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest,
      com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse> getMutateAdGroupFeedsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdGroupFeeds",
      requestType = com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest.class,
      responseType = com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest,
      com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse> getMutateAdGroupFeedsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest, com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse> getMutateAdGroupFeedsMethod;
      ...
      synchronized (AdGroupFeedServiceGrpc.class) {
        if ((getMutateAdGroupFeedsMethod = AdGroupFeedServiceGrpc.getMutateAdGroupFeedsMethod) == null) {
          AdGroupFeedServiceGrpc.getMutateAdGroupFeedsMethod = getMutateAdGroupFeedsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest, com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdGroupFeeds"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse.getDefaultInstance()))
  ...
  public static abstract class AdGroupFeedServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroupFeed(com.google.ads.googleads.v4.services.GetAdGroupFeedRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AdGroupFeed> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAdGroupFeeds(com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetAdGroupFeedRequest,
                com.google.ads.googleads.v4.resources.AdGroupFeed>(
                  this, METHODID_GET_AD_GROUP_FEED)))
          .addMethod(
            getMutateAdGroupFeedsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest,
                com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse>(
  ...
  public static final class AdGroupFeedServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupFeedServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.AdGroupFeed getAdGroupFeed(com.google.ads.googleads.v4.services.GetAdGroupFeedRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse mutateAdGroupFeeds(com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AdGroupFeedServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupFeedServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.AdGroupFeed> getAdGroupFeed(
        com.google.ads.googleads.v4.services.GetAdGroupFeedRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse> mutateAdGroupFeeds(
        com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_FEED:
          serviceImpl.getAdGroupFeed((com.google.ads.googleads.v4.services.GetAdGroupFeedRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AdGroupFeed>) responseObserver);
          break;
        case METHODID_MUTATE_AD_GROUP_FEEDS:
          serviceImpl.mutateAdGroupFeeds((com.google.ads.googleads.v4.services.MutateAdGroupFeedsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdGroupFeedsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupFeedServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.AdGroupFeedServiceProto.getDescriptor();
    }
