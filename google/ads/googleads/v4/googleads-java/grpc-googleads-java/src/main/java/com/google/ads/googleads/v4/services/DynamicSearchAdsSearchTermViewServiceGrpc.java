...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/dynamic_search_ads_search_term_view_service.proto")
public final class DynamicSearchAdsSearchTermViewServiceGrpc {

  private DynamicSearchAdsSearchTermViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.DynamicSearchAdsSearchTermViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest,
      com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView> getGetDynamicSearchAdsSearchTermViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDynamicSearchAdsSearchTermView",
      requestType = com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest.class,
      responseType = com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest,
      com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView> getGetDynamicSearchAdsSearchTermViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest, com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView> getGetDynamicSearchAdsSearchTermViewMethod;
      ...
      synchronized (DynamicSearchAdsSearchTermViewServiceGrpc.class) {
        if ((getGetDynamicSearchAdsSearchTermViewMethod = DynamicSearchAdsSearchTermViewServiceGrpc.getGetDynamicSearchAdsSearchTermViewMethod) == null) {
          DynamicSearchAdsSearchTermViewServiceGrpc.getGetDynamicSearchAdsSearchTermViewMethod = getGetDynamicSearchAdsSearchTermViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest, com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDynamicSearchAdsSearchTermView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView.getDefaultInstance()))
  ...
  public static abstract class DynamicSearchAdsSearchTermViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getDynamicSearchAdsSearchTermView(com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest,
                com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView>(
  ...
  public static final class DynamicSearchAdsSearchTermViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DynamicSearchAdsSearchTermViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView getDynamicSearchAdsSearchTermView(com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest request) {
  ...
  public static final class DynamicSearchAdsSearchTermViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DynamicSearchAdsSearchTermViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView> getDynamicSearchAdsSearchTermView(
        com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DYNAMIC_SEARCH_ADS_SEARCH_TERM_VIEW:
          serviceImpl.getDynamicSearchAdsSearchTermView((com.google.ads.googleads.v4.services.GetDynamicSearchAdsSearchTermViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.DynamicSearchAdsSearchTermView>) responseObserver);
          break;
        default:
  ...
  private static abstract class DynamicSearchAdsSearchTermViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.DynamicSearchAdsSearchTermViewServiceProto.getDescriptor();
    }
