...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/topic_view_service.proto")
public final class TopicViewServiceGrpc {

  private TopicViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.TopicViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetTopicViewRequest,
      com.google.ads.googleads.v4.resources.TopicView> getGetTopicViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetTopicView",
      requestType = com.google.ads.googleads.v4.services.GetTopicViewRequest.class,
      responseType = com.google.ads.googleads.v4.resources.TopicView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetTopicViewRequest,
      com.google.ads.googleads.v4.resources.TopicView> getGetTopicViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetTopicViewRequest, com.google.ads.googleads.v4.resources.TopicView> getGetTopicViewMethod;
      ...
      synchronized (TopicViewServiceGrpc.class) {
        if ((getGetTopicViewMethod = TopicViewServiceGrpc.getGetTopicViewMethod) == null) {
          TopicViewServiceGrpc.getGetTopicViewMethod = getGetTopicViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetTopicViewRequest, com.google.ads.googleads.v4.resources.TopicView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetTopicView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetTopicViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.TopicView.getDefaultInstance()))
  ...
  public static abstract class TopicViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getTopicView(com.google.ads.googleads.v4.services.GetTopicViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.TopicView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetTopicViewRequest,
                com.google.ads.googleads.v4.resources.TopicView>(
  ...
  public static final class TopicViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TopicViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.TopicView getTopicView(com.google.ads.googleads.v4.services.GetTopicViewRequest request) {
  ...
  public static final class TopicViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TopicViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.TopicView> getTopicView(
        com.google.ads.googleads.v4.services.GetTopicViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_TOPIC_VIEW:
          serviceImpl.getTopicView((com.google.ads.googleads.v4.services.GetTopicViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.TopicView>) responseObserver);
          break;
        default:
  ...
  private static abstract class TopicViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.TopicViewServiceProto.getDescriptor();
    }
