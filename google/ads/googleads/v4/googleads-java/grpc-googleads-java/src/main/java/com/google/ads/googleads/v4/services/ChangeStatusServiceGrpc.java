...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/change_status_service.proto")
public final class ChangeStatusServiceGrpc {

  private ChangeStatusServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.ChangeStatusService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetChangeStatusRequest,
      com.google.ads.googleads.v4.resources.ChangeStatus> getGetChangeStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetChangeStatus",
      requestType = com.google.ads.googleads.v4.services.GetChangeStatusRequest.class,
      responseType = com.google.ads.googleads.v4.resources.ChangeStatus.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetChangeStatusRequest,
      com.google.ads.googleads.v4.resources.ChangeStatus> getGetChangeStatusMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetChangeStatusRequest, com.google.ads.googleads.v4.resources.ChangeStatus> getGetChangeStatusMethod;
      ...
      synchronized (ChangeStatusServiceGrpc.class) {
        if ((getGetChangeStatusMethod = ChangeStatusServiceGrpc.getGetChangeStatusMethod) == null) {
          ChangeStatusServiceGrpc.getGetChangeStatusMethod = getGetChangeStatusMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetChangeStatusRequest, com.google.ads.googleads.v4.resources.ChangeStatus>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetChangeStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetChangeStatusRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.ChangeStatus.getDefaultInstance()))
  ...
  public static abstract class ChangeStatusServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getChangeStatus(com.google.ads.googleads.v4.services.GetChangeStatusRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.ChangeStatus> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetChangeStatusRequest,
                com.google.ads.googleads.v4.resources.ChangeStatus>(
  ...
  public static final class ChangeStatusServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ChangeStatusServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.ChangeStatus getChangeStatus(com.google.ads.googleads.v4.services.GetChangeStatusRequest request) {
  ...
  public static final class ChangeStatusServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ChangeStatusServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.ChangeStatus> getChangeStatus(
        com.google.ads.googleads.v4.services.GetChangeStatusRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CHANGE_STATUS:
          serviceImpl.getChangeStatus((com.google.ads.googleads.v4.services.GetChangeStatusRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.ChangeStatus>) responseObserver);
          break;
        default:
  ...
  private static abstract class ChangeStatusServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.ChangeStatusServiceProto.getDescriptor();
    }
