...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/campaign_budget_service.proto")
public final class CampaignBudgetServiceGrpc {

  private CampaignBudgetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.CampaignBudgetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetCampaignBudgetRequest,
      com.google.ads.googleads.v4.resources.CampaignBudget> getGetCampaignBudgetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignBudget",
      requestType = com.google.ads.googleads.v4.services.GetCampaignBudgetRequest.class,
      responseType = com.google.ads.googleads.v4.resources.CampaignBudget.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetCampaignBudgetRequest,
      com.google.ads.googleads.v4.resources.CampaignBudget> getGetCampaignBudgetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetCampaignBudgetRequest, com.google.ads.googleads.v4.resources.CampaignBudget> getGetCampaignBudgetMethod;
      ...
      synchronized (CampaignBudgetServiceGrpc.class) {
        if ((getGetCampaignBudgetMethod = CampaignBudgetServiceGrpc.getGetCampaignBudgetMethod) == null) {
          CampaignBudgetServiceGrpc.getGetCampaignBudgetMethod = getGetCampaignBudgetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetCampaignBudgetRequest, com.google.ads.googleads.v4.resources.CampaignBudget>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignBudget"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetCampaignBudgetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.CampaignBudget.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest,
      com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse> getMutateCampaignBudgetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCampaignBudgets",
      requestType = com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest.class,
      responseType = com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest,
      com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse> getMutateCampaignBudgetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest, com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse> getMutateCampaignBudgetsMethod;
      ...
      synchronized (CampaignBudgetServiceGrpc.class) {
        if ((getMutateCampaignBudgetsMethod = CampaignBudgetServiceGrpc.getMutateCampaignBudgetsMethod) == null) {
          CampaignBudgetServiceGrpc.getMutateCampaignBudgetsMethod = getMutateCampaignBudgetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest, com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCampaignBudgets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse.getDefaultInstance()))
  ...
  public static abstract class CampaignBudgetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignBudget(com.google.ads.googleads.v4.services.GetCampaignBudgetRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.CampaignBudget> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCampaignBudgets(com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetCampaignBudgetRequest,
                com.google.ads.googleads.v4.resources.CampaignBudget>(
                  this, METHODID_GET_CAMPAIGN_BUDGET)))
          .addMethod(
            getMutateCampaignBudgetsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest,
                com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse>(
  ...
  public static final class CampaignBudgetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignBudgetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.CampaignBudget getCampaignBudget(com.google.ads.googleads.v4.services.GetCampaignBudgetRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse mutateCampaignBudgets(com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CampaignBudgetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignBudgetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.CampaignBudget> getCampaignBudget(
        com.google.ads.googleads.v4.services.GetCampaignBudgetRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse> mutateCampaignBudgets(
        com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_BUDGET:
          serviceImpl.getCampaignBudget((com.google.ads.googleads.v4.services.GetCampaignBudgetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.CampaignBudget>) responseObserver);
          break;
        case METHODID_MUTATE_CAMPAIGN_BUDGETS:
          serviceImpl.mutateCampaignBudgets((com.google.ads.googleads.v4.services.MutateCampaignBudgetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateCampaignBudgetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignBudgetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.CampaignBudgetServiceProto.getDescriptor();
    }
