...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/campaign_extension_setting_service.proto")
public final class CampaignExtensionSettingServiceGrpc {

  private CampaignExtensionSettingServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.CampaignExtensionSettingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest,
      com.google.ads.googleads.v4.resources.CampaignExtensionSetting> getGetCampaignExtensionSettingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignExtensionSetting",
      requestType = com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest.class,
      responseType = com.google.ads.googleads.v4.resources.CampaignExtensionSetting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest,
      com.google.ads.googleads.v4.resources.CampaignExtensionSetting> getGetCampaignExtensionSettingMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest, com.google.ads.googleads.v4.resources.CampaignExtensionSetting> getGetCampaignExtensionSettingMethod;
      ...
      synchronized (CampaignExtensionSettingServiceGrpc.class) {
        if ((getGetCampaignExtensionSettingMethod = CampaignExtensionSettingServiceGrpc.getGetCampaignExtensionSettingMethod) == null) {
          CampaignExtensionSettingServiceGrpc.getGetCampaignExtensionSettingMethod = getGetCampaignExtensionSettingMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest, com.google.ads.googleads.v4.resources.CampaignExtensionSetting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignExtensionSetting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.CampaignExtensionSetting.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest,
      com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse> getMutateCampaignExtensionSettingsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCampaignExtensionSettings",
      requestType = com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest.class,
      responseType = com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest,
      com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse> getMutateCampaignExtensionSettingsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest, com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse> getMutateCampaignExtensionSettingsMethod;
      ...
      synchronized (CampaignExtensionSettingServiceGrpc.class) {
        if ((getMutateCampaignExtensionSettingsMethod = CampaignExtensionSettingServiceGrpc.getMutateCampaignExtensionSettingsMethod) == null) {
          CampaignExtensionSettingServiceGrpc.getMutateCampaignExtensionSettingsMethod = getMutateCampaignExtensionSettingsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest, com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCampaignExtensionSettings"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse.getDefaultInstance()))
  ...
  public static abstract class CampaignExtensionSettingServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignExtensionSetting(com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.CampaignExtensionSetting> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCampaignExtensionSettings(com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest,
                com.google.ads.googleads.v4.resources.CampaignExtensionSetting>(
                  this, METHODID_GET_CAMPAIGN_EXTENSION_SETTING)))
          .addMethod(
            getMutateCampaignExtensionSettingsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest,
                com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse>(
  ...
  public static final class CampaignExtensionSettingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignExtensionSettingServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.CampaignExtensionSetting getCampaignExtensionSetting(com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse mutateCampaignExtensionSettings(com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CampaignExtensionSettingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignExtensionSettingServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.CampaignExtensionSetting> getCampaignExtensionSetting(
        com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse> mutateCampaignExtensionSettings(
        com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_EXTENSION_SETTING:
          serviceImpl.getCampaignExtensionSetting((com.google.ads.googleads.v4.services.GetCampaignExtensionSettingRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.CampaignExtensionSetting>) responseObserver);
          break;
        case METHODID_MUTATE_CAMPAIGN_EXTENSION_SETTINGS:
          serviceImpl.mutateCampaignExtensionSettings((com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateCampaignExtensionSettingsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignExtensionSettingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.CampaignExtensionSettingServiceProto.getDescriptor();
    }
