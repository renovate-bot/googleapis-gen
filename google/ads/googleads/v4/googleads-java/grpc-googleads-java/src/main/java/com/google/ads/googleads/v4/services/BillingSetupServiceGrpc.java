...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/billing_setup_service.proto")
public final class BillingSetupServiceGrpc {

  private BillingSetupServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.BillingSetupService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetBillingSetupRequest,
      com.google.ads.googleads.v4.resources.BillingSetup> getGetBillingSetupMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetBillingSetup",
      requestType = com.google.ads.googleads.v4.services.GetBillingSetupRequest.class,
      responseType = com.google.ads.googleads.v4.resources.BillingSetup.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetBillingSetupRequest,
      com.google.ads.googleads.v4.resources.BillingSetup> getGetBillingSetupMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetBillingSetupRequest, com.google.ads.googleads.v4.resources.BillingSetup> getGetBillingSetupMethod;
      ...
      synchronized (BillingSetupServiceGrpc.class) {
        if ((getGetBillingSetupMethod = BillingSetupServiceGrpc.getGetBillingSetupMethod) == null) {
          BillingSetupServiceGrpc.getGetBillingSetupMethod = getGetBillingSetupMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetBillingSetupRequest, com.google.ads.googleads.v4.resources.BillingSetup>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetBillingSetup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetBillingSetupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.BillingSetup.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateBillingSetupRequest,
      com.google.ads.googleads.v4.services.MutateBillingSetupResponse> getMutateBillingSetupMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateBillingSetup",
      requestType = com.google.ads.googleads.v4.services.MutateBillingSetupRequest.class,
      responseType = com.google.ads.googleads.v4.services.MutateBillingSetupResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateBillingSetupRequest,
      com.google.ads.googleads.v4.services.MutateBillingSetupResponse> getMutateBillingSetupMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateBillingSetupRequest, com.google.ads.googleads.v4.services.MutateBillingSetupResponse> getMutateBillingSetupMethod;
      ...
      synchronized (BillingSetupServiceGrpc.class) {
        if ((getMutateBillingSetupMethod = BillingSetupServiceGrpc.getMutateBillingSetupMethod) == null) {
          BillingSetupServiceGrpc.getMutateBillingSetupMethod = getMutateBillingSetupMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.MutateBillingSetupRequest, com.google.ads.googleads.v4.services.MutateBillingSetupResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateBillingSetup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateBillingSetupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateBillingSetupResponse.getDefaultInstance()))
  ...
  public static abstract class BillingSetupServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getBillingSetup(com.google.ads.googleads.v4.services.GetBillingSetupRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.BillingSetup> responseObserver) {
     ...
     * </pre>
     */
    public void mutateBillingSetup(com.google.ads.googleads.v4.services.MutateBillingSetupRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateBillingSetupResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetBillingSetupRequest,
                com.google.ads.googleads.v4.resources.BillingSetup>(
                  this, METHODID_GET_BILLING_SETUP)))
          .addMethod(
            getMutateBillingSetupMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.MutateBillingSetupRequest,
                com.google.ads.googleads.v4.services.MutateBillingSetupResponse>(
  ...
  public static final class BillingSetupServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BillingSetupServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.BillingSetup getBillingSetup(com.google.ads.googleads.v4.services.GetBillingSetupRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.services.MutateBillingSetupResponse mutateBillingSetup(com.google.ads.googleads.v4.services.MutateBillingSetupRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class BillingSetupServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BillingSetupServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.BillingSetup> getBillingSetup(
        com.google.ads.googleads.v4.services.GetBillingSetupRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.services.MutateBillingSetupResponse> mutateBillingSetup(
        com.google.ads.googleads.v4.services.MutateBillingSetupRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BILLING_SETUP:
          serviceImpl.getBillingSetup((com.google.ads.googleads.v4.services.GetBillingSetupRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.BillingSetup>) responseObserver);
          break;
        case METHODID_MUTATE_BILLING_SETUP:
          serviceImpl.mutateBillingSetup((com.google.ads.googleads.v4.services.MutateBillingSetupRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateBillingSetupResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BillingSetupServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.BillingSetupServiceProto.getDescriptor();
    }
