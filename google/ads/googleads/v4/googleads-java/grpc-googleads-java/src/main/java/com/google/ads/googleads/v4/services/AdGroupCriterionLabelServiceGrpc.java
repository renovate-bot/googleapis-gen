...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/ad_group_criterion_label_service.proto")
public final class AdGroupCriterionLabelServiceGrpc {

  private AdGroupCriterionLabelServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.AdGroupCriterionLabelService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest,
      com.google.ads.googleads.v4.resources.AdGroupCriterionLabel> getGetAdGroupCriterionLabelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupCriterionLabel",
      requestType = com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest.class,
      responseType = com.google.ads.googleads.v4.resources.AdGroupCriterionLabel.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest,
      com.google.ads.googleads.v4.resources.AdGroupCriterionLabel> getGetAdGroupCriterionLabelMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest, com.google.ads.googleads.v4.resources.AdGroupCriterionLabel> getGetAdGroupCriterionLabelMethod;
      ...
      synchronized (AdGroupCriterionLabelServiceGrpc.class) {
        if ((getGetAdGroupCriterionLabelMethod = AdGroupCriterionLabelServiceGrpc.getGetAdGroupCriterionLabelMethod) == null) {
          AdGroupCriterionLabelServiceGrpc.getGetAdGroupCriterionLabelMethod = getGetAdGroupCriterionLabelMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest, com.google.ads.googleads.v4.resources.AdGroupCriterionLabel>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupCriterionLabel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.AdGroupCriterionLabel.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest,
      com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse> getMutateAdGroupCriterionLabelsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdGroupCriterionLabels",
      requestType = com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest.class,
      responseType = com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest,
      com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse> getMutateAdGroupCriterionLabelsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest, com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse> getMutateAdGroupCriterionLabelsMethod;
      ...
      synchronized (AdGroupCriterionLabelServiceGrpc.class) {
        if ((getMutateAdGroupCriterionLabelsMethod = AdGroupCriterionLabelServiceGrpc.getMutateAdGroupCriterionLabelsMethod) == null) {
          AdGroupCriterionLabelServiceGrpc.getMutateAdGroupCriterionLabelsMethod = getMutateAdGroupCriterionLabelsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest, com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdGroupCriterionLabels"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse.getDefaultInstance()))
  ...
  public static abstract class AdGroupCriterionLabelServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroupCriterionLabel(com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AdGroupCriterionLabel> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAdGroupCriterionLabels(com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest,
                com.google.ads.googleads.v4.resources.AdGroupCriterionLabel>(
                  this, METHODID_GET_AD_GROUP_CRITERION_LABEL)))
          .addMethod(
            getMutateAdGroupCriterionLabelsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest,
                com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse>(
  ...
  public static final class AdGroupCriterionLabelServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupCriterionLabelServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.AdGroupCriterionLabel getAdGroupCriterionLabel(com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse mutateAdGroupCriterionLabels(com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AdGroupCriterionLabelServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupCriterionLabelServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.AdGroupCriterionLabel> getAdGroupCriterionLabel(
        com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse> mutateAdGroupCriterionLabels(
        com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_CRITERION_LABEL:
          serviceImpl.getAdGroupCriterionLabel((com.google.ads.googleads.v4.services.GetAdGroupCriterionLabelRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AdGroupCriterionLabel>) responseObserver);
          break;
        case METHODID_MUTATE_AD_GROUP_CRITERION_LABELS:
          serviceImpl.mutateAdGroupCriterionLabels((com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdGroupCriterionLabelsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupCriterionLabelServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.AdGroupCriterionLabelServiceProto.getDescriptor();
    }
