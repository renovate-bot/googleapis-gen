...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/ad_parameter_service.proto")
public final class AdParameterServiceGrpc {

  private AdParameterServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.AdParameterService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdParameterRequest,
      com.google.ads.googleads.v4.resources.AdParameter> getGetAdParameterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdParameter",
      requestType = com.google.ads.googleads.v4.services.GetAdParameterRequest.class,
      responseType = com.google.ads.googleads.v4.resources.AdParameter.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdParameterRequest,
      com.google.ads.googleads.v4.resources.AdParameter> getGetAdParameterMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdParameterRequest, com.google.ads.googleads.v4.resources.AdParameter> getGetAdParameterMethod;
      ...
      synchronized (AdParameterServiceGrpc.class) {
        if ((getGetAdParameterMethod = AdParameterServiceGrpc.getGetAdParameterMethod) == null) {
          AdParameterServiceGrpc.getGetAdParameterMethod = getGetAdParameterMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetAdParameterRequest, com.google.ads.googleads.v4.resources.AdParameter>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdParameter"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetAdParameterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.AdParameter.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdParametersRequest,
      com.google.ads.googleads.v4.services.MutateAdParametersResponse> getMutateAdParametersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdParameters",
      requestType = com.google.ads.googleads.v4.services.MutateAdParametersRequest.class,
      responseType = com.google.ads.googleads.v4.services.MutateAdParametersResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdParametersRequest,
      com.google.ads.googleads.v4.services.MutateAdParametersResponse> getMutateAdParametersMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdParametersRequest, com.google.ads.googleads.v4.services.MutateAdParametersResponse> getMutateAdParametersMethod;
      ...
      synchronized (AdParameterServiceGrpc.class) {
        if ((getMutateAdParametersMethod = AdParameterServiceGrpc.getMutateAdParametersMethod) == null) {
          AdParameterServiceGrpc.getMutateAdParametersMethod = getMutateAdParametersMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.MutateAdParametersRequest, com.google.ads.googleads.v4.services.MutateAdParametersResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdParameters"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdParametersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdParametersResponse.getDefaultInstance()))
  ...
  public static abstract class AdParameterServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdParameter(com.google.ads.googleads.v4.services.GetAdParameterRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AdParameter> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAdParameters(com.google.ads.googleads.v4.services.MutateAdParametersRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdParametersResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.GetAdParameterRequest,
                com.google.ads.googleads.v4.resources.AdParameter>(
                  this, METHODID_GET_AD_PARAMETER)))
          .addMethod(
            getMutateAdParametersMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v4.services.MutateAdParametersRequest,
                com.google.ads.googleads.v4.services.MutateAdParametersResponse>(
  ...
  public static final class AdParameterServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdParameterServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.resources.AdParameter getAdParameter(com.google.ads.googleads.v4.services.GetAdParameterRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v4.services.MutateAdParametersResponse mutateAdParameters(com.google.ads.googleads.v4.services.MutateAdParametersRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AdParameterServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdParameterServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.resources.AdParameter> getAdParameter(
        com.google.ads.googleads.v4.services.GetAdParameterRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v4.services.MutateAdParametersResponse> mutateAdParameters(
        com.google.ads.googleads.v4.services.MutateAdParametersRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_PARAMETER:
          serviceImpl.getAdParameter((com.google.ads.googleads.v4.services.GetAdParameterRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AdParameter>) responseObserver);
          break;
        case METHODID_MUTATE_AD_PARAMETERS:
          serviceImpl.mutateAdParameters((com.google.ads.googleads.v4.services.MutateAdParametersRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdParametersResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdParameterServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.AdParameterServiceProto.getDescriptor();
    }
