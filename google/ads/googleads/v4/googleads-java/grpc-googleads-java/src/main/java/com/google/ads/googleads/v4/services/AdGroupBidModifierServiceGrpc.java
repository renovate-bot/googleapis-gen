...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v4/services/ad_group_bid_modifier_service.proto")
public final class AdGroupBidModifierServiceGrpc {

  private AdGroupBidModifierServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v4.services.AdGroupBidModifierService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupBidModifierRequest,
      com.google.ads.googleads.v4.resources.AdGroupBidModifier> getGetAdGroupBidModifierMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupBidModifier",
      requestType = com.google.ads.googleads.v4.services.GetAdGroupBidModifierRequest.class,
      responseType = com.google.ads.googleads.v4.resources.AdGroupBidModifier.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupBidModifierRequest,
      com.google.ads.googleads.v4.resources.AdGroupBidModifier> getGetAdGroupBidModifierMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.GetAdGroupBidModifierRequest, com.google.ads.googleads.v4.resources.AdGroupBidModifier> getGetAdGroupBidModifierMethod;
      ...
      synchronized (AdGroupBidModifierServiceGrpc.class) {
        if ((getGetAdGroupBidModifierMethod = AdGroupBidModifierServiceGrpc.getGetAdGroupBidModifierMethod) == null) {
          AdGroupBidModifierServiceGrpc.getGetAdGroupBidModifierMethod = getGetAdGroupBidModifierMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.GetAdGroupBidModifierRequest, com.google.ads.googleads.v4.resources.AdGroupBidModifier>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupBidModifier"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.GetAdGroupBidModifierRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.resources.AdGroupBidModifier.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersRequest,
      com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersResponse> getMutateAdGroupBidModifiersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdGroupBidModifiers",
      requestType = com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersRequest.class,
      responseType = com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersRequest,
      com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersResponse> getMutateAdGroupBidModifiersMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersRequest, com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersResponse> getMutateAdGroupBidModifiersMethod;
      ...
      synchronized (AdGroupBidModifierServiceGrpc.class) {
        if ((getMutateAdGroupBidModifiersMethod = AdGroupBidModifierServiceGrpc.getMutateAdGroupBidModifiersMethod) == null) {
          AdGroupBidModifierServiceGrpc.getMutateAdGroupBidModifiersMethod = getMutateAdGroupBidModifiersMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersRequest, com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdGroupBidModifiers"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersResponse.getDefaultInstance()))
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_BID_MODIFIER:
          serviceImpl.getAdGroupBidModifier((com.google.ads.googleads.v4.services.GetAdGroupBidModifierRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.resources.AdGroupBidModifier>) responseObserver);
          break;
        case METHODID_MUTATE_AD_GROUP_BID_MODIFIERS:
          serviceImpl.mutateAdGroupBidModifiers((com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v4.services.MutateAdGroupBidModifiersResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupBidModifierServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v4.services.AdGroupBidModifierServiceProto.getDescriptor();
    }
