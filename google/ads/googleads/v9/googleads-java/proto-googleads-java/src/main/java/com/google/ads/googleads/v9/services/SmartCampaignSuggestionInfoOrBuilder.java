...
public interface SmartCampaignSuggestionInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v9.services.SmartCampaignSuggestionInfo)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v9.common.AdScheduleInfo ad_schedules = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
   ...
   * <code>repeated .google.ads.googleads.v9.common.AdScheduleInfo ad_schedules = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ads.googleads.v9.common.AdScheduleInfo getAdSchedules(int index);
  /**
   * <pre>
   * Optional. The business ad schedule.
   * </pre>
   ...
   * <code>repeated .google.ads.googleads.v9.common.AdScheduleInfo ad_schedules = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ads.googleads.v9.common.AdScheduleInfoOrBuilder getAdSchedulesOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v9.common.KeywordThemeInfo keyword_themes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<com.google.ads.googleads.v9.common.KeywordThemeInfo> 
   ...
   * <code>repeated .google.ads.googleads.v9.common.KeywordThemeInfo keyword_themes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ads.googleads.v9.common.KeywordThemeInfo getKeywordThemes(int index);
  /**
   * <pre>
   * Optional. Smart campaign keyword themes. This field may greatly improve suggestion
   * accuracy and we recommend always setting it if possible.
   ...
   * <code>repeated .google.ads.googleads.v9.common.KeywordThemeInfo keyword_themes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v9.common.KeywordThemeInfoOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v9.common.KeywordThemeInfo keyword_themes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ads.googleads.v9.common.KeywordThemeInfoOrBuilder getKeywordThemesOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.BusinessContext business_context = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   */
  com.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.BusinessContext getBusinessContext();
  /**
   * <pre>
   * Optional. Context describing the business to advertise.
   * </pre>
   ...
   * <code>.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.BusinessContext business_context = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.BusinessContextOrBuilder getBusinessContextOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.LocationList location_list = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   */
  com.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.LocationList getLocationList();
  /**
   * <pre>
   * Optional. The targeting geo location by locations.
   * </pre>
   ...
   * <code>.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.LocationList location_list = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.LocationListOrBuilder getLocationListOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v9.common.ProximityInfo proximity = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
  ...
  public com.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.BusinessSettingCase getBusinessSettingCase();

  public com.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.GeoTargetCase getGeoTargetCase();
}
