  ...
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::CustomerCustomizerService::Client#mutate_customer_customizers CustomerCustomizerService.MutateCustomerCustomizers}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose customer customizers are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::CustomerCustomizerOperation>]
          ...
          class MutateCustomerCustomizersRequest
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateCustomerCustomizerResult>]
          ...
          class MutateCustomerCustomizersResponse
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #     "MUTABLE_RESOURCE".
          class MutateCustomerCustomizerResult
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
        end
