...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanService::Client#get_keyword_plan KeywordPlanService.GetKeywordPlan}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanService::Client#mutate_keyword_plans KeywordPlanService.MutateKeywordPlans}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose keyword plans are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::KeywordPlanOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateKeywordPlansResult>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanService::Client#generate_forecast_curve KeywordPlanService.GenerateForecastCurve}.
          ...
          # Response message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanService::Client#generate_forecast_curve KeywordPlanService.GenerateForecastCurve}.
          # @!attribute [rw] campaign_forecast_curves
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::KeywordPlanCampaignForecastCurve>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanService::Client#generate_forecast_time_series KeywordPlanService.GenerateForecastTimeSeries}.
          # @!attribute [rw] keyword_plan
          #   @return [::String]
          #     Required. The resource name of the keyword plan to be forecasted.
          ...
          # Response message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanService::Client#generate_forecast_time_series KeywordPlanService.GenerateForecastTimeSeries}.
          # @!attribute [rw] weekly_time_series_forecasts
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::KeywordPlanWeeklyTimeSeriesForecast>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanService::Client#generate_forecast_metrics KeywordPlanService.GenerateForecastMetrics}.
          # @!attribute [rw] keyword_plan
          #   @return [::String]
          #     Required. The resource name of the keyword plan to be forecasted.
          ...
          # Response message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanService::Client#generate_forecast_metrics KeywordPlanService.GenerateForecastMetrics}.
          # @!attribute [rw] campaign_forecasts
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::KeywordPlanCampaignForecast>]
          #     List of campaign forecasts.
          #     One maximum.
          # @!attribute [rw] ad_group_forecasts
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::KeywordPlanAdGroupForecast>]
          #     List of ad group forecasts.
          # @!attribute [rw] keyword_forecasts
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::KeywordPlanKeywordForecast>]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Services::ForecastMetrics]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Services::KeywordPlanMaxCpcBidForecastCurve]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::KeywordPlanMaxCpcBidForecast>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::KeywordPlanWeeklyForecast>]
          #     The forecasts for the Keyword Plan campaign at different max CPC bids.
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanService::Client#generate_historical_metrics KeywordPlanService.GenerateHistoricalMetrics}.
          # @!attribute [rw] keyword_plan
          #   @return [::String]
          #     Required. The resource name of the keyword plan of which historical metrics are
          #     requested.
          # @!attribute [rw] aggregate_metrics
          #   @return [::Google::Ads::GoogleAds::V9::Common::KeywordPlanAggregateMetrics]
          #     The aggregate fields to include in response.
          # @!attribute [rw] historical_metrics_options
          #   @return [::Google::Ads::GoogleAds::V9::Common::HistoricalMetricsOptions]
          ...
          # Response message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanService::Client#generate_historical_metrics KeywordPlanService.GenerateHistoricalMetrics}.
          # @!attribute [rw] metrics
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::KeywordPlanKeywordHistoricalMetrics>]
          #     List of keyword historical metrics.
          # @!attribute [rw] aggregate_metric_results
          #   @return [::Google::Ads::GoogleAds::V9::Common::KeywordPlanAggregateMetricResults]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Common::KeywordPlanHistoricalMetrics]
