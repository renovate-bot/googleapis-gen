    ...
    module GoogleAds
      module V9
        module Services
          ...
          # Response message for {::Google::Ads::GoogleAds::V9::Services::InvoiceService::Client#list_invoices InvoiceService.ListInvoices}.
          # @!attribute [rw] invoices
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Resources::Invoice>]
