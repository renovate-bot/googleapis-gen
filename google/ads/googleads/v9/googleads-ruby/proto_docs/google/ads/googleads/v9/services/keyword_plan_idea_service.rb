...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanIdeaService::Client#generate_keyword_ideas KeywordPlanIdeaService.GenerateKeywordIdeas}.
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Enums::KeywordPlanKeywordAnnotationEnum::KeywordPlanKeywordAnnotation>]
          ...
          # Response message for {::Google::Ads::GoogleAds::V9::Services::KeywordPlanIdeaService::Client#generate_keyword_ideas KeywordPlanIdeaService.GenerateKeywordIdeas}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::GenerateKeywordIdeaResult>]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Common::KeywordAnnotations]
