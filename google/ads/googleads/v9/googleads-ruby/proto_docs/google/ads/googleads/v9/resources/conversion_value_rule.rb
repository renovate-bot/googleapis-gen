    ...
    module GoogleAds
      module V9
        module Resources
          ...
          # @!attribute [rw] action
          #   @return [::Google::Ads::GoogleAds::V9::Resources::ConversionValueRule::ValueRuleAction]
          #     Action applied when the rule is triggered.
          # @!attribute [rw] geo_location_condition
          #   @return [::Google::Ads::GoogleAds::V9::Resources::ConversionValueRule::ValueRuleGeoLocationCondition]
          #     Condition for Geo location that must be satisfied for the value rule to
          #     apply.
          # @!attribute [rw] device_condition
          #   @return [::Google::Ads::GoogleAds::V9::Resources::ConversionValueRule::ValueRuleDeviceCondition]
          #     Condition for device type that must be satisfied for the value rule to
          #     apply.
          # @!attribute [rw] audience_condition
          #   @return [::Google::Ads::GoogleAds::V9::Resources::ConversionValueRule::ValueRuleAudienceCondition]
          ...
          #     ** Read-only **
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ConversionValueRuleStatusEnum::ConversionValueRuleStatus]
          ...
          class ConversionValueRule
            ...
            #   @return [::Google::Ads::GoogleAds::V9::Enums::ValueRuleOperationEnum::ValueRuleOperation]
            ...
            #   @return [::Google::Ads::GoogleAds::V9::Enums::ValueRuleGeoLocationMatchTypeEnum::ValueRuleGeoLocationMatchType]
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V9::Enums::ValueRuleDeviceTypeEnum::ValueRuleDeviceType>]
