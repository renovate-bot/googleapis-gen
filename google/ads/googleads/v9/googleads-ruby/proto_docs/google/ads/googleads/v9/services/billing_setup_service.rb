  ...
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::BillingSetupService::Client#get_billing_setup BillingSetupService.GetBillingSetup}.
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Services::BillingSetupOperation]
          ...
          # @!attribute [rw] result
          #   @return [::Google::Ads::GoogleAds::V9::Services::MutateBillingSetupResult]
