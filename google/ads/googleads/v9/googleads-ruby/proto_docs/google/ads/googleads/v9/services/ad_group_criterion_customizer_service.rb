  ...
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::AdGroupCriterionCustomizerService::Client#mutate_ad_group_criterion_customizers AdGroupCriterionCustomizerService.MutateAdGroupCriterionCustomizers}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose ad group criterion customizers are being
          #     modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::AdGroupCriterionCustomizerOperation>]
          ...
          class MutateAdGroupCriterionCustomizersRequest
          ...
          class AdGroupCriterionCustomizerOperation
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateAdGroupCriterionCustomizerResult>]
          ...
          class MutateAdGroupCriterionCustomizersResponse
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #     to "MUTABLE_RESOURCE".
          class MutateAdGroupCriterionCustomizerResult
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
        end
