    ...
    module GoogleAds
      module V9
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Resources::KeywordPlanForecastPeriod]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::KeywordPlanForecastIntervalEnum::KeywordPlanForecastInterval]
