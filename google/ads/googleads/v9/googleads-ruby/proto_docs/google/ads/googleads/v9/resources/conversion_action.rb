    ...
    module GoogleAds
      module V9
        module Resources
          ...
          #     conversion actions.
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ConversionActionStatusEnum::ConversionActionStatus]
          #     The status of this conversion action for conversion event accrual.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ConversionActionTypeEnum::ConversionActionType]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Resources::ConversionAction::ValueSettings]
          #     Settings related to the value for conversion events associated with this
          #     conversion action.
          # @!attribute [rw] counting_type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ConversionActionCountingTypeEnum::ConversionActionCountingType]
          #     How to count conversion events for the conversion action.
          # @!attribute [rw] attribution_model_settings
          #   @return [::Google::Ads::GoogleAds::V9::Resources::ConversionAction::AttributionModelSettings]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Resources::ConversionAction::FirebaseSettings]
          #     Output only. Firebase settings for Firebase conversion types.
          # @!attribute [r] third_party_app_analytics_settings
          #   @return [::Google::Ads::GoogleAds::V9::Resources::ConversionAction::ThirdPartyAppAnalyticsSettings]
          ...
          class ConversionAction
            ...
            #   @return [::Google::Ads::GoogleAds::V9::Enums::AttributionModelEnum::AttributionModel]
            #     The attribution model type of this conversion action.
            # @!attribute [r] data_driven_model_status
            #   @return [::Google::Ads::GoogleAds::V9::Enums::DataDrivenModelStatusEnum::DataDrivenModelStatus]
