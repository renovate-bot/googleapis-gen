...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::CampaignAssetService::Client#get_campaign_asset CampaignAssetService.GetCampaignAsset}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::CampaignAssetService::Client#mutate_campaign_assets CampaignAssetService.MutateCampaignAssets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaign assets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::CampaignAssetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateCampaignAssetResult>]
