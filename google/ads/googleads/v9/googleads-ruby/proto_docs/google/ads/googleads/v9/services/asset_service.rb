...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::AssetService::Client#get_asset AssetService.GetAsset}
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::AssetService::Client#mutate_assets AssetService.MutateAssets}
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose assets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::AssetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateAssetResult>]
