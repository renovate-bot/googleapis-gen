    ...
    module GoogleAds
      module V9
        module Resources
          ...
          # @!attribute [r] caller_country_code
          #   @return [::String]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::CallTrackingDisplayLocationEnum::CallTrackingDisplayLocation]
          #     Output only. The call tracking display location.
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::CallTypeEnum::CallType]
          #     Output only. The type of the call.
          # @!attribute [r] call_status
          #   @return [::Google::Ads::GoogleAds::V9::Enums::GoogleVoiceCallStatusEnum::GoogleVoiceCallStatus]
