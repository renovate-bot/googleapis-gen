    ...
    module GoogleAds
      module V9
        module Resources
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Common::FinalAppUrl>]
          ...
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::AdTypeEnum::AdType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Common::UrlCollection>]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::SystemManagedResourceSourceEnum::SystemManagedResourceSource]
          #     Output only. If this ad is system managed, then this field will indicate the source.
          #     This field is read-only.
          # @!attribute [rw] text_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::TextAdInfo]
          #     Immutable. Details pertaining to a text ad.
          # @!attribute [rw] expanded_text_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::ExpandedTextAdInfo]
          #     Details pertaining to an expanded text ad.
          # @!attribute [rw] call_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::CallAdInfo]
          #     Details pertaining to a call ad.
          # @!attribute [rw] expanded_dynamic_search_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::ExpandedDynamicSearchAdInfo]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Common::HotelAdInfo]
          #     Details pertaining to a hotel ad.
          # @!attribute [rw] shopping_smart_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::ShoppingSmartAdInfo]
          #     Details pertaining to a Smart Shopping ad.
          # @!attribute [rw] shopping_product_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::ShoppingProductAdInfo]
          #     Details pertaining to a Shopping product ad.
          # @!attribute [rw] gmail_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::GmailAdInfo]
          #     Immutable. Details pertaining to a Gmail ad.
          # @!attribute [rw] image_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::ImageAdInfo]
          #     Immutable. Details pertaining to an Image ad.
          # @!attribute [rw] video_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::VideoAdInfo]
          #     Details pertaining to a Video ad.
          # @!attribute [rw] video_responsive_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::VideoResponsiveAdInfo]
          #     Details pertaining to a Video responsive ad.
          # @!attribute [rw] responsive_search_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::ResponsiveSearchAdInfo]
          #     Details pertaining to a responsive search ad.
          # @!attribute [rw] legacy_responsive_display_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::LegacyResponsiveDisplayAdInfo]
          #     Details pertaining to a legacy responsive display ad.
          # @!attribute [rw] app_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::AppAdInfo]
          #     Details pertaining to an app ad.
          # @!attribute [rw] legacy_app_install_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::LegacyAppInstallAdInfo]
          #     Immutable. Details pertaining to a legacy app install ad.
          # @!attribute [rw] responsive_display_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::ResponsiveDisplayAdInfo]
          #     Details pertaining to a responsive display ad.
          # @!attribute [rw] local_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::LocalAdInfo]
          #     Details pertaining to a local ad.
          # @!attribute [rw] display_upload_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::DisplayUploadAdInfo]
          #     Details pertaining to a display upload ad.
          # @!attribute [rw] app_engagement_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::AppEngagementAdInfo]
          #     Details pertaining to an app engagement ad.
          # @!attribute [rw] shopping_comparison_listing_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::ShoppingComparisonListingAdInfo]
          ...
          # @!attribute [rw] app_pre_registration_ad
          #   @return [::Google::Ads::GoogleAds::V9::Common::AppPreRegistrationAdInfo]
