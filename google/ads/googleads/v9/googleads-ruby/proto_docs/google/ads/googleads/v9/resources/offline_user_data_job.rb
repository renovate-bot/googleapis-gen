    ...
    module GoogleAds
      module V9
        module Resources
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::OfflineUserDataJobTypeEnum::OfflineUserDataJobType]
          #     Immutable. Type of the job.
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V9::Enums::OfflineUserDataJobStatusEnum::OfflineUserDataJobStatus]
          #     Output only. Status of the job.
          # @!attribute [r] failure_reason
          #   @return [::Google::Ads::GoogleAds::V9::Enums::OfflineUserDataJobFailureReasonEnum::OfflineUserDataJobFailureReason]
          #     Output only. Reason for the processing failure, if status is FAILED.
          # @!attribute [r] operation_metadata
          #   @return [::Google::Ads::GoogleAds::V9::Resources::OfflineUserDataJobMetadata]
          #     Output only. Metadata of offline user data job depicting match rate range.
          # @!attribute [rw] customer_match_user_list_metadata
          #   @return [::Google::Ads::GoogleAds::V9::Common::CustomerMatchUserListMetadata]
          #     Immutable. Metadata for data updates to a CRM-based user list.
          # @!attribute [rw] store_sales_metadata
          #   @return [::Google::Ads::GoogleAds::V9::Common::StoreSalesMetadata]
          ...
          # @!attribute [r] match_rate_range
          #   @return [::Google::Ads::GoogleAds::V9::Enums::OfflineUserDataJobMatchRateRangeEnum::OfflineUserDataJobMatchRateRange]
          ...
          #     “SUCCESS/FAILED”.
          class OfflineUserDataJobMetadata
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
        end
