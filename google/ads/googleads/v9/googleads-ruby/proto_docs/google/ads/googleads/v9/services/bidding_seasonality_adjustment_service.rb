  ...
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::BiddingSeasonalityAdjustmentService::Client#get_bidding_seasonality_adjustment BiddingSeasonalityAdjustmentService.GetBiddingSeasonalityAdjustment}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          #     Required. The resource name of the seasonality adjustment to fetch.
          class GetBiddingSeasonalityAdjustmentRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end

          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::BiddingSeasonalityAdjustmentService::Client#mutate_bidding_seasonality_adjustments BiddingSeasonalityAdjustmentService.MutateBiddingSeasonalityAdjustments}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose seasonality adjustments are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::BiddingSeasonalityAdjustmentOperation>]
          ...
          class MutateBiddingSeasonalityAdjustmentsRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          class BiddingSeasonalityAdjustmentOperation
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateBiddingSeasonalityAdjustmentsResult>]
          #     All results for the mutate.
          class MutateBiddingSeasonalityAdjustmentsResponse
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #     to "MUTABLE_RESOURCE".
          class MutateBiddingSeasonalityAdjustmentsResult
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
        end
