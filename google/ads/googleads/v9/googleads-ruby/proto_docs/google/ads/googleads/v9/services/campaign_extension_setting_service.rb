  ...
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::CampaignExtensionSettingService::Client#get_campaign_extension_setting CampaignExtensionSettingService.GetCampaignExtensionSetting}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::CampaignExtensionSettingService::Client#mutate_campaign_extension_settings CampaignExtensionSettingService.MutateCampaignExtensionSettings}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaign extension settings are being
          #     modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::CampaignExtensionSettingOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateCampaignExtensionSettingResult>]
