...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::UserDataService::Client#upload_user_data UserDataService.UploadUserData}
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer for which to update the user data.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::UserDataOperation>]
          ...
          # @!attribute [rw] create
          #   @return [::Google::Ads::GoogleAds::V9::Common::UserData]
          ...
          # Response message for {::Google::Ads::GoogleAds::V9::Services::UserDataService::Client#upload_user_data UserDataService.UploadUserData}
