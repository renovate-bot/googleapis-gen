  ...
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::CustomizerAttributeService::Client#mutate_customizer_attributes CustomizerAttributeService.MutateCustomizerAttributes}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose customizer attributes are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::CustomizerAttributeOperation>]
          ...
          class MutateCustomizerAttributesRequest
          ...
          class CustomizerAttributeOperation
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateCustomizerAttributeResult>]
          ...
          #     "MUTABLE_RESOURCE".
          class MutateCustomizerAttributeResult
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
        end
