    ...
    module GoogleAds
      module V9
        module Resources
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Resources::AttributeFieldMapping>]
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V9::Enums::FeedMappingStatusEnum::FeedMappingStatus]
          #     Output only. Status of the feed mapping.
          #     This field is read-only.
          # @!attribute [rw] placeholder_type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::PlaceholderTypeEnum::PlaceholderType]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::FeedMappingCriterionTypeEnum::FeedMappingCriterionType]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::SitelinkPlaceholderFieldEnum::SitelinkPlaceholderField]
          #     Immutable. Sitelink Placeholder Fields.
          # @!attribute [rw] call_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::CallPlaceholderFieldEnum::CallPlaceholderField]
          #     Immutable. Call Placeholder Fields.
          # @!attribute [rw] app_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::AppPlaceholderFieldEnum::AppPlaceholderField]
          #     Immutable. App Placeholder Fields.
          # @!attribute [r] location_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::LocationPlaceholderFieldEnum::LocationPlaceholderField]
          #     Output only. Location Placeholder Fields. This field is read-only.
          # @!attribute [r] affiliate_location_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::AffiliateLocationPlaceholderFieldEnum::AffiliateLocationPlaceholderField]
          #     Output only. Affiliate Location Placeholder Fields. This field is read-only.
          # @!attribute [rw] callout_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::CalloutPlaceholderFieldEnum::CalloutPlaceholderField]
          #     Immutable. Callout Placeholder Fields.
          # @!attribute [rw] structured_snippet_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::StructuredSnippetPlaceholderFieldEnum::StructuredSnippetPlaceholderField]
          #     Immutable. Structured Snippet Placeholder Fields.
          # @!attribute [rw] message_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::MessagePlaceholderFieldEnum::MessagePlaceholderField]
          #     Immutable. Message Placeholder Fields.
          # @!attribute [rw] price_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::PricePlaceholderFieldEnum::PricePlaceholderField]
          #     Immutable. Price Placeholder Fields.
          # @!attribute [rw] promotion_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::PromotionPlaceholderFieldEnum::PromotionPlaceholderField]
          #     Immutable. Promotion Placeholder Fields.
          # @!attribute [rw] ad_customizer_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::AdCustomizerPlaceholderFieldEnum::AdCustomizerPlaceholderField]
          #     Immutable. Ad Customizer Placeholder Fields
          # @!attribute [rw] dsa_page_feed_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::DsaPageFeedCriterionFieldEnum::DsaPageFeedCriterionField]
          #     Immutable. Dynamic Search Ad Page Feed Fields.
          # @!attribute [rw] location_extension_targeting_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::LocationExtensionTargetingCriterionFieldEnum::LocationExtensionTargetingCriterionField]
          #     Immutable. Location Target Fields.
          # @!attribute [rw] education_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::EducationPlaceholderFieldEnum::EducationPlaceholderField]
          #     Immutable. Education Placeholder Fields
          # @!attribute [rw] flight_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::FlightPlaceholderFieldEnum::FlightPlaceholderField]
          #     Immutable. Flight Placeholder Fields
          # @!attribute [rw] custom_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::CustomPlaceholderFieldEnum::CustomPlaceholderField]
          #     Immutable. Custom Placeholder Fields
          # @!attribute [rw] hotel_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::HotelPlaceholderFieldEnum::HotelPlaceholderField]
          #     Immutable. Hotel Placeholder Fields
          # @!attribute [rw] real_estate_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::RealEstatePlaceholderFieldEnum::RealEstatePlaceholderField]
          #     Immutable. Real Estate Placeholder Fields
          # @!attribute [rw] travel_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::TravelPlaceholderFieldEnum::TravelPlaceholderField]
          #     Immutable. Travel Placeholder Fields
          # @!attribute [rw] local_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::LocalPlaceholderFieldEnum::LocalPlaceholderField]
          #     Immutable. Local Placeholder Fields
          # @!attribute [rw] job_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::JobPlaceholderFieldEnum::JobPlaceholderField]
          #     Immutable. Job Placeholder Fields
          # @!attribute [rw] image_field
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ImagePlaceholderFieldEnum::ImagePlaceholderField]
