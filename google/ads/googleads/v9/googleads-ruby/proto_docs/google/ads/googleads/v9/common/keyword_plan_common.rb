    ...
    module GoogleAds
      module V9
        module Common
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Common::MonthlySearchVolume>]
          #     Approximate number of searches on this query for the past twelve months.
          # @!attribute [rw] competition
          #   @return [::Google::Ads::GoogleAds::V9::Enums::KeywordPlanCompetitionLevelEnum::KeywordPlanCompetitionLevel]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Common::YearMonthRange]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Enums::KeywordPlanAggregateMetricTypeEnum::KeywordPlanAggregateMetricType>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Common::KeywordPlanDeviceSearches>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Common::KeywordConcept>]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Common::ConceptGroup]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::KeywordPlanConceptGroupTypeEnum::KeywordPlanConceptGroupType]
