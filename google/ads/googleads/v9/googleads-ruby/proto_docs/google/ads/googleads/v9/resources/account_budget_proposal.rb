    ...
    module GoogleAds
      module V9
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::AccountBudgetProposalTypeEnum::AccountBudgetProposalType]
          #     Immutable. The type of this proposal, e.g. END to end the budget associated with this
          #     proposal.
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V9::Enums::AccountBudgetProposalStatusEnum::AccountBudgetProposalStatus]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::TimeTypeEnum::TimeType]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::SpendingLimitTypeEnum::SpendingLimitType]
