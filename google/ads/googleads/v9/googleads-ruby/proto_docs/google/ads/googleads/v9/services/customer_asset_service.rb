...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::CustomerAssetService::Client#get_customer_asset CustomerAssetService.GetCustomerAsset}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::CustomerAssetService::Client#mutate_customer_assets CustomerAssetService.MutateCustomerAssets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose customer assets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::CustomerAssetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateCustomerAssetResult>]
