...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::FeedItemSetService::Client#get_feed_item_set FeedItemSetService.GetFeedItemSet}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::FeedItemSetService::Client#mutate_feed_item_sets FeedItemSetService.MutateFeedItemSets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose feed item sets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::FeedItemSetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateFeedItemSetResult>]
