...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::ExtensionFeedItemService::Client#get_extension_feed_item ExtensionFeedItemService.GetExtensionFeedItem}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::ExtensionFeedItemService::Client#mutate_extension_feed_items ExtensionFeedItemService.MutateExtensionFeedItems}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose extension feed items are being
          #     modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::ExtensionFeedItemOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateExtensionFeedItemResult>]
