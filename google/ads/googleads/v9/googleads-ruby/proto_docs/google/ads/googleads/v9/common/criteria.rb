    ...
    module GoogleAds
      module V9
        module Common
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::PreferredContentTypeEnum::PreferredContentType]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ListingGroupTypeEnum::ListingGroupType]
          #     Type of the listing group.
          # @!attribute [rw] case_value
          #   @return [::Google::Ads::GoogleAds::V9::Common::ListingDimensionInfo]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Common::ListingDimensionInfo>]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Common::HotelIdInfo]
          #     Advertiser-specific hotel ID.
          # @!attribute [rw] hotel_class
          #   @return [::Google::Ads::GoogleAds::V9::Common::HotelClassInfo]
          #     Class of the hotel as a number of stars 1 to 5.
          # @!attribute [rw] hotel_country_region
          #   @return [::Google::Ads::GoogleAds::V9::Common::HotelCountryRegionInfo]
          #     Country or Region the hotel is located in.
          # @!attribute [rw] hotel_state
          #   @return [::Google::Ads::GoogleAds::V9::Common::HotelStateInfo]
          #     State the hotel is located in.
          # @!attribute [rw] hotel_city
          #   @return [::Google::Ads::GoogleAds::V9::Common::HotelCityInfo]
          #     City the hotel is located in.
          # @!attribute [rw] product_bidding_category
          #   @return [::Google::Ads::GoogleAds::V9::Common::ProductBiddingCategoryInfo]
          #     Bidding category of a product offer.
          # @!attribute [rw] product_brand
          #   @return [::Google::Ads::GoogleAds::V9::Common::ProductBrandInfo]
          #     Brand of a product offer.
          # @!attribute [rw] product_channel
          #   @return [::Google::Ads::GoogleAds::V9::Common::ProductChannelInfo]
          #     Locality of a product offer.
          # @!attribute [rw] product_channel_exclusivity
          #   @return [::Google::Ads::GoogleAds::V9::Common::ProductChannelExclusivityInfo]
          #     Availability of a product offer.
          # @!attribute [rw] product_condition
          #   @return [::Google::Ads::GoogleAds::V9::Common::ProductConditionInfo]
          #     Condition of a product offer.
          # @!attribute [rw] product_custom_attribute
          #   @return [::Google::Ads::GoogleAds::V9::Common::ProductCustomAttributeInfo]
          #     Custom attribute of a product offer.
          # @!attribute [rw] product_item_id
          #   @return [::Google::Ads::GoogleAds::V9::Common::ProductItemIdInfo]
          #     Item id of a product offer.
          # @!attribute [rw] product_type
          #   @return [::Google::Ads::GoogleAds::V9::Common::ProductTypeInfo]
          #     Type of a product offer.
          # @!attribute [rw] unknown_listing_dimension
          #   @return [::Google::Ads::GoogleAds::V9::Common::UnknownListingDimensionInfo]
          ...
          # @!attribute [rw] index
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ProductCustomAttributeIndexEnum::ProductCustomAttributeIndex]
          ...
          #     Value of the type.
          # @!attribute [rw] level
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ProductTypeLevelEnum::ProductTypeLevel]
          #     Level of the type.
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::InteractionTypeEnum::InteractionType]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::MinuteOfHourEnum::MinuteOfHour]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::AgeRangeTypeEnum::AgeRangeType]
          ...
          # A gender criterion.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::GenderTypeEnum::GenderType]
          #     Type of the gender.
          class GenderInfo
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::IncomeRangeTypeEnum::IncomeRangeType]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ParentalStatusTypeEnum::ParentalStatusType]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Common::GeoPointInfo]
          #     Latitude and longitude.
          # @!attribute [rw] radius
          #   @return [::Float]
          #     The radius of the proximity.
          # @!attribute [rw] radius_units
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ProximityRadiusUnitsEnum::ProximityRadiusUnits]
          #     The unit of measurement of the radius. Default is KILOMETERS.
          # @!attribute [rw] address
          #   @return [::Google::Ads::GoogleAds::V9::Common::AddressInfo]
          #     Full address.
          class ProximityInfo
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ContentLabelTypeEnum::ContentLabelType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Common::WebpageConditionInfo>]
          ...
          #     read-only.
          # @!attribute [rw] sample
          #   @return [::Google::Ads::GoogleAds::V9::Common::WebpageSampleInfo]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::WebpageConditionOperandEnum::WebpageConditionOperand]
          #     Operand of webpage targeting condition.
          # @!attribute [rw] operator
          #   @return [::Google::Ads::GoogleAds::V9::Enums::WebpageConditionOperatorEnum::WebpageConditionOperator]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V9::Enums::AppPaymentModelTypeEnum::AppPaymentModelType]
          ...
          #     This is required and must be set in CREATE operations.
          # @!attribute [rw] radius_units
          #   @return [::Google::Ads::GoogleAds::V9::Enums::LocationGroupRadiusUnitsEnum::LocationGroupRadiusUnits]
