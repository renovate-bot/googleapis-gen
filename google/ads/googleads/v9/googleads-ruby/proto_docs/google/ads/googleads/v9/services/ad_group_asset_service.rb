...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::AdGroupAssetService::Client#get_ad_group_asset AdGroupAssetService.GetAdGroupAsset}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::AdGroupAssetService::Client#mutate_ad_group_assets AdGroupAssetService.MutateAdGroupAssets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose ad group assets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::AdGroupAssetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateAdGroupAssetResult>]
