    ...
    module GoogleAds
      module V9
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Common::PreferredContentInfo]
          #     Immutable. A preferred content criterion.
          # @!attribute [rw] hotel_check_in_date_range
          #   @return [::Google::Ads::GoogleAds::V9::Common::HotelCheckInDateRangeInfo]
