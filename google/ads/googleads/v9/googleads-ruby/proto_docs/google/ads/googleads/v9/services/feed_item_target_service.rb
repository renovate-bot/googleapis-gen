...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::FeedItemTargetService::Client#get_feed_item_target FeedItemTargetService.GetFeedItemTarget}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::FeedItemTargetService::Client#mutate_feed_item_targets FeedItemTargetService.MutateFeedItemTargets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose feed item targets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::FeedItemTargetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateFeedItemTargetResult>]
