    ...
    module GoogleAds
      module V9
        module Resources
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Resources::FeedItemAttributeValue>]
          #     The feed item's attribute values.
          # @!attribute [rw] geo_targeting_restriction
          #   @return [::Google::Ads::GoogleAds::V9::Enums::GeoTargetingRestrictionEnum::GeoTargetingRestriction]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Resources::FeedItemPlaceholderPolicyInfo>]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::FeedItemValidationStatusEnum::FeedItemValidationStatus]
          #     Output only. The validation status of the palceholder type.
          # @!attribute [r] validation_errors
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Resources::FeedItemValidationError>]
          #     Output only. List of placeholder type validation errors.
          # @!attribute [r] quality_approval_status
          #   @return [::Google::Ads::GoogleAds::V9::Enums::FeedItemQualityApprovalStatusEnum::FeedItemQualityApprovalStatus]
          #     Output only. Placeholder type quality evaluation approval status.
          # @!attribute [r] quality_disapproval_reasons
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Enums::FeedItemQualityDisapprovalReasonEnum::FeedItemQualityDisapprovalReason>]
