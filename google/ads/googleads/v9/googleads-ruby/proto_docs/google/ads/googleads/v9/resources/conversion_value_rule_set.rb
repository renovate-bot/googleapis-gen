    ...
    module GoogleAds
      module V9
        module Resources
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Enums::ValueRuleSetDimensionEnum::ValueRuleSetDimension>]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ValueRuleSetAttachmentTypeEnum::ValueRuleSetAttachmentType]
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V9::Enums::ConversionValueRuleSetStatusEnum::ConversionValueRuleSetStatus]
