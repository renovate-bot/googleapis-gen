  ...
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::ConversionValueRuleSetService::Client#get_conversion_value_rule_set ConversionValueRuleSetService.GetConversionValueRuleSet}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::ConversionValueRuleSetService::Client#mutate_conversion_value_rule_sets ConversionValueRuleSetService.MutateConversionValueRuleSets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose conversion value rule sets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::ConversionValueRuleSetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateConversionValueRuleSetResult>]
