    ...
    module GoogleAds
      module V9
        module Common
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Common::CriterionCategoryChannelAvailability]
          #     Channel types and subtypes that are available to the category.
          # @!attribute [rw] locale
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Common::CriterionCategoryLocaleAvailability>]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::CriterionCategoryChannelAvailabilityModeEnum::CriterionCategoryChannelAvailabilityMode]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType>]
          ...
          # @!attribute [rw] availability_mode
          #   @return [::Google::Ads::GoogleAds::V9::Enums::CriterionCategoryLocaleAvailabilityModeEnum::CriterionCategoryLocaleAvailabilityMode]
