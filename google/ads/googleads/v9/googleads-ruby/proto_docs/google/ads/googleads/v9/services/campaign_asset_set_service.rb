...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::CampaignAssetSetService::Client#mutate_campaign_asset_sets CampaignAssetSetService.MutateCampaignAssetSets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaign asset sets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::CampaignAssetSetOperation>]
          ...
          class MutateCampaignAssetSetsRequest
          ...
          class CampaignAssetSetOperation
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateCampaignAssetSetResult>]
          ...
          class MutateCampaignAssetSetsResponse
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #     "MUTABLE_RESOURCE".
          class MutateCampaignAssetSetResult
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
        end
