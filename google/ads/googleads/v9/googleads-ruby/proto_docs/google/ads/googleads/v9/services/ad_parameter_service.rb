...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::AdParameterService::Client#get_ad_parameter AdParameterService.GetAdParameter}
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::AdParameterService::Client#mutate_ad_parameters AdParameterService.MutateAdParameters}
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose ad parameters are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::AdParameterOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateAdParameterResult>]
