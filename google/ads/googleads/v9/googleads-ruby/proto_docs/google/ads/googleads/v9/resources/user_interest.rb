    ...
    module GoogleAds
      module V9
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Enums::UserInterestTaxonomyTypeEnum::UserInterestTaxonomyType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Common::CriterionCategoryAvailability>]
