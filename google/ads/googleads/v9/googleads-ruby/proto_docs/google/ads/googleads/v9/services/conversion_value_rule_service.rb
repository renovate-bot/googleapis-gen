  ...
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::ConversionValueRuleService::Client#get_conversion_value_rule ConversionValueRuleService.GetConversionValueRule}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::ConversionValueRuleService::Client#mutate_conversion_value_rules ConversionValueRuleService.MutateConversionValueRules}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose conversion value rules are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::ConversionValueRuleOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateConversionValueRuleResult>]
