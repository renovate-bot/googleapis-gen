...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::SmartCampaignSettingService::Client#get_smart_campaign_setting SmartCampaignSettingService.GetSmartCampaignSetting}.
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::SmartCampaignSettingOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateSmartCampaignSettingResult>]
