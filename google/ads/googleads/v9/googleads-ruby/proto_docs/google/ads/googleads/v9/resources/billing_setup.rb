    ...
    module GoogleAds
      module V9
        module Resources
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V9::Enums::BillingSetupStatusEnum::BillingSetupStatus]
          ...
          #   @return [::Google::Ads::GoogleAds::V9::Resources::BillingSetup::PaymentsAccountInfo]
