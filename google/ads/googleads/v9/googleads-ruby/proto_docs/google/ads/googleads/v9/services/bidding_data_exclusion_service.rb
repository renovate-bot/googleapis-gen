  ...
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::BiddingDataExclusionService::Client#get_bidding_data_exclusion BiddingDataExclusionService.GetBiddingDataExclusion}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V9::Services::BiddingDataExclusionService::Client#mutate_bidding_data_exclusions BiddingDataExclusionService.MutateBiddingDataExclusions}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose data exclusions are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::BiddingDataExclusionOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateBiddingDataExclusionsResult>]
