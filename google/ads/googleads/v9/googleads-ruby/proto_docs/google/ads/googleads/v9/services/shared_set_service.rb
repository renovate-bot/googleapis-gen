...
module Google
  module Ads
    module GoogleAds
      module V9
        module Services
          # Request message for {::Google::Ads::GoogleAds::V9::Services::SharedSetService::Client#get_shared_set SharedSetService.GetSharedSet}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V9::Services::SharedSetService::Client#mutate_shared_sets SharedSetService.MutateSharedSets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose shared sets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::SharedSetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V9::Services::MutateSharedSetResult>]
