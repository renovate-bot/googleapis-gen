...
require "google/ads/googleads/v9/services/google_ads_service_pb"
        ...
        module Services
          module GoogleAdsService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V9::Services::GoogleAdsService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all GoogleAdsService clients
              #   ::Google::Ads::GoogleAds::V9::Services::GoogleAdsService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V9::Services::GoogleAdsService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V9::Services::GoogleAdsService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v9/services/google_ads_service_services_pb"
                ...
                @google_ads_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V9::Services::GoogleAdsService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsRequest, ::Hash]
              ...
              #     Default is false.
              #   @param summary_row_setting [::Google::Ads::GoogleAds::V9::Enums::SummaryRowSettingEnum::SummaryRowSetting]
              ...
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V9::Services::GoogleAdsRow>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V9::Services::GoogleAdsRow>]
              #
              ...
              #   request = Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsRequest.new
              #
              ...
              #     # Each element is of type ::Google::Ads::GoogleAds::V9::Services::GoogleAdsRow.
              #     p response
              #   end
              #
              def search request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsRequest
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsStreamRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsStreamRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Enumerable<::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsStreamResponse>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Enumerable<::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsStreamResponse>]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsStreamRequest.new
              #
              #   # Call the search_stream method.
              #   result = client.search_stream request
              #
              #   # The returned object is a streamed enumerable yielding elements of
              #   # type ::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsStreamResponse.
              #   result.each do |response|
              #     p response
              #   end
              #
              def search_stream request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsStreamRequest
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::MutateGoogleAdsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::MutateGoogleAdsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Services::MutateGoogleAdsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V9::Services::MutateGoogleAdsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V9::Services::MutateGoogleAdsRequest.new
              #
              #   # Call the mutate method.
              #   result = client.mutate request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V9::Services::MutateGoogleAdsResponse.
              #   p result
              #
              def mutate request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::MutateGoogleAdsRequest
              ...
              # {::Google::Ads::GoogleAds::V9::Services::GoogleAdsService::Client::Configuration::Rpcs}
