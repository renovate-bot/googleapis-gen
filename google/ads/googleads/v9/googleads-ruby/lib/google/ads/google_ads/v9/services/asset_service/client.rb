...
require "google/ads/googleads/v9/services/asset_service_pb"
        ...
        module Services
          module AssetService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V9::Services::AssetService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all AssetService clients
              #   ::Google::Ads::GoogleAds::V9::Services::AssetService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V9::Services::AssetService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V9::Services::AssetService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v9/services/asset_service_services_pb"
                ...
                @asset_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V9::Services::AssetService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::GetAssetRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::GetAssetRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Resources::Asset]
              ...
              #   request = Google::Ads::GoogleAds::V9::Services::GetAssetRequest.new
              #
              #   # Call the get_asset method.
              #   result = client.get_asset request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V9::Resources::Asset.
              #   p result
              #
              def get_asset request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V9::Services::GetAssetRequest
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::MutateAssetsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::MutateAssetsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V9::Services::AssetOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Services::MutateAssetsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V9::Services::MutateAssetsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V9::Services::MutateAssetsRequest.new
              #
              #   # Call the mutate_assets method.
              #   result = client.mutate_assets request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V9::Services::MutateAssetsResponse.
              #   p result
              #
              def mutate_assets request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::MutateAssetsRequest
              ...
              # {::Google::Ads::GoogleAds::V9::Services::AssetService::Client::Configuration::Rpcs}
