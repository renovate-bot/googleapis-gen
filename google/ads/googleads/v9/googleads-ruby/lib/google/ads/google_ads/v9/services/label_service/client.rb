...
require "google/ads/googleads/v9/services/label_service_pb"
        ...
        module Services
          module LabelService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V9::Services::LabelService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all LabelService clients
              #   ::Google::Ads::GoogleAds::V9::Services::LabelService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V9::Services::LabelService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V9::Services::LabelService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v9/services/label_service_services_pb"
                ...
                @label_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V9::Services::LabelService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::GetLabelRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::GetLabelRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Resources::Label]
              ...
              #   request = Google::Ads::GoogleAds::V9::Services::GetLabelRequest.new
              #
              #   # Call the get_label method.
              #   result = client.get_label request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V9::Resources::Label.
              #   p result
              #
              def get_label request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V9::Services::GetLabelRequest
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::MutateLabelsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::MutateLabelsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V9::Services::LabelOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Services::MutateLabelsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V9::Services::MutateLabelsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V9::Services::MutateLabelsRequest.new
              #
              #   # Call the mutate_labels method.
              #   result = client.mutate_labels request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V9::Services::MutateLabelsResponse.
              #   p result
              #
              def mutate_labels request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::MutateLabelsRequest
              ...
              # {::Google::Ads::GoogleAds::V9::Services::LabelService::Client::Configuration::Rpcs}
