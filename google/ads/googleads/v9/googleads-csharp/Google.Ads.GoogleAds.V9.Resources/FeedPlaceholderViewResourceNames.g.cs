...
namespace Google.Ads.GoogleAds.V9.Resources
{
    ...
    public sealed partial class FeedPlaceholderViewName : gax::IResourceName, sys::IEquatable<FeedPlaceholderViewName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer_id}/feedPlaceholderViews/{placeholder_type}</c>.
            /// </summary>
            CustomerPlaceholderType = 1,
        }

        private static gax::PathTemplate s_customerPlaceholderType = new gax::PathTemplate("customers/{customer_id}/feedPlaceholderViews/{placeholder_type}");
        ...
        /// <c>customers/{customer_id}/feedPlaceholderViews/{placeholder_type}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="placeholderTypeId">The <c>PlaceholderType</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// A new instance of <see cref="FeedPlaceholderViewName"/> constructed from the provided ids.
        /// </returns>
        public static FeedPlaceholderViewName FromCustomerPlaceholderType(string customerId, string placeholderTypeId) =>
            new FeedPlaceholderViewName(ResourceNameType.CustomerPlaceholderType, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), placeholderTypeId: gax::GaxPreconditions.CheckNotNullOrEmpty(placeholderTypeId, nameof(placeholderTypeId)));
        ...
        /// <c>customers/{customer_id}/feedPlaceholderViews/{placeholder_type}</c>.
        /// </returns>
        public static string Format(string customerId, string placeholderTypeId) =>
            FormatCustomerPlaceholderType(customerId, placeholderTypeId);
        ...
        /// <c>customers/{customer_id}/feedPlaceholderViews/{placeholder_type}</c>.
        /// </returns>
        public static string FormatCustomerPlaceholderType(string customerId, string placeholderTypeId) =>
            s_customerPlaceholderType.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(placeholderTypeId, nameof(placeholderTypeId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>customers/{customer_id}/feedPlaceholderViews/{placeholder_type}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string feedPlaceholderViewName, bool allowUnparsed, out FeedPlaceholderViewName result)
        {
            ...
            if (s_customerPlaceholderType.TryParseName(feedPlaceholderViewName, out resourceName))
            {
                result = FromCustomerPlaceholderType(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private FeedPlaceholderViewName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string customerId = null, string placeholderTypeId = null)
        {
            Type = type;
        ...
        /// <summary>
        /// The <c>PlaceholderType</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        public string PlaceholderTypeId { get; }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.CustomerPlaceholderType: return s_customerPlaceholderType.Expand(CustomerId, PlaceholderTypeId);
    ...
    public partial class FeedPlaceholderView
    {
        ...
        /// </summary>
        public FeedPlaceholderViewName ResourceNameAsFeedPlaceholderViewName
        {
