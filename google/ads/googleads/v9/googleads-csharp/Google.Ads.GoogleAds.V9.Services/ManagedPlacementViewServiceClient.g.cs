...
namespace Google.Ads.GoogleAds.V9.Services
{
    ...
    /// </summary>
    public sealed partial class ManagedPlacementViewServiceClientBuilder : gaxgrpc::ClientBuilderBase<ManagedPlacementViewServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public ManagedPlacementViewServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public ManagedPlacementViewServiceClientBuilder()
        {
            UseJwtAccessWithScopes = ManagedPlacementViewServiceClient.UseJwtAccessWithScopes;
        }
