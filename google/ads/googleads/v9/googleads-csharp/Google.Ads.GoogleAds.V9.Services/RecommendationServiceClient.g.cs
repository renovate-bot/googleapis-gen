...
namespace Google.Ads.GoogleAds.V9.Services
{
    ...
    public sealed partial class RecommendationServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <c>RecommendationServiceClient.GetRecommendation</c> and
        /// <c>RecommendationServiceClient.GetRecommendationAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
    ...
    public abstract partial class RecommendationServiceClient
    {
        ...
        public virtual gagvr::Recommendation GetRecommendation(GetRecommendationRequest request, gaxgrpc::CallSettings callSettings = null) =>
        ...
        public virtual stt::Task<gagvr::Recommendation> GetRecommendationAsync(GetRecommendationRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::Recommendation> GetRecommendationAsync(GetRecommendationRequest request, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::Recommendation GetRecommendation(string resourceName, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::Recommendation> GetRecommendationAsync(string resourceName, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::Recommendation> GetRecommendationAsync(string resourceName, st::CancellationToken cancellationToken) =>
            GetRecommendationAsync(resourceName, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::Recommendation GetRecommendation(gagvr::RecommendationName resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetRecommendation(new GetRecommendationRequest
            {
                ResourceNameAsRecommendationName = gax::GaxPreconditions.CheckNotNull(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::Recommendation> GetRecommendationAsync(gagvr::RecommendationName resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetRecommendationAsync(new GetRecommendationRequest
            {
                ResourceNameAsRecommendationName = gax::GaxPreconditions.CheckNotNull(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::Recommendation> GetRecommendationAsync(gagvr::RecommendationName resourceName, st::CancellationToken cancellationToken) =>
            GetRecommendationAsync(resourceName, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    ...
    public sealed partial class RecommendationServiceClientImpl : RecommendationServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override gagvr::Recommendation GetRecommendation(GetRecommendationRequest request, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<gagvr::Recommendation> GetRecommendationAsync(GetRecommendationRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetRecommendationRequest(ref request, ref callSettings);
