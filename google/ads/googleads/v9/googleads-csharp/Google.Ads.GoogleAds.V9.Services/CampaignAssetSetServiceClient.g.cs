...
namespace Google.Ads.GoogleAds.V9.Services
{
    ...
    /// endpoint etc.
    /// </summary>
    public sealed partial class CampaignAssetSetServiceClientBuilder : gaxgrpc::ClientBuilderBase<CampaignAssetSetServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public CampaignAssetSetServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public CampaignAssetSetServiceClientBuilder()
        {
            UseJwtAccessWithScopes = CampaignAssetSetServiceClient.UseJwtAccessWithScopes;
        }
        ...
        private CampaignAssetSetServiceClient BuildImpl()
        {
            ...
            return CampaignAssetSetServiceClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => CampaignAssetSetServiceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => CampaignAssetSetServiceClient.DefaultScopes;
