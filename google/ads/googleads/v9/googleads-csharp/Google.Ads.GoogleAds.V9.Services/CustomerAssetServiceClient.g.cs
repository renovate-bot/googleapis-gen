...
namespace Google.Ads.GoogleAds.V9.Services
{
    ...
    public sealed partial class CustomerAssetServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private CustomerAssetServiceSettings(CustomerAssetServiceSettings existing) : base(existing)
        {
            ...
            GetCustomerAssetSettings = existing.GetCustomerAssetSettings;
        ...
        /// <c>CustomerAssetServiceClient.GetCustomerAsset</c> and <c>CustomerAssetServiceClient.GetCustomerAssetAsync</c>
        /// .
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetCustomerAssetSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(3600000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(5000), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable, grpccore::StatusCode.DeadlineExceeded)));
    ...
    /// endpoint etc.
    /// </summary>
    public sealed partial class CustomerAssetServiceClientBuilder : gaxgrpc::ClientBuilderBase<CustomerAssetServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public CustomerAssetServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public CustomerAssetServiceClientBuilder()
        {
            UseJwtAccessWithScopes = CustomerAssetServiceClient.UseJwtAccessWithScopes;
        }
        ...
        private CustomerAssetServiceClient BuildImpl()
        {
            ...
            return CustomerAssetServiceClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => CustomerAssetServiceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => CustomerAssetServiceClient.DefaultScopes;
    ...
    public abstract partial class CustomerAssetServiceClient
    {
        ...
        public virtual gagvr::CustomerAsset GetCustomerAsset(GetCustomerAssetRequest request, gaxgrpc::CallSettings callSettings = null) =>
        ...
        public virtual stt::Task<gagvr::CustomerAsset> GetCustomerAssetAsync(GetCustomerAssetRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::CustomerAsset> GetCustomerAssetAsync(GetCustomerAssetRequest request, st::CancellationToken cancellationToken) =>
            GetCustomerAssetAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::CustomerAsset GetCustomerAsset(string resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetCustomerAsset(new GetCustomerAssetRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::CustomerAsset> GetCustomerAssetAsync(string resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetCustomerAssetAsync(new GetCustomerAssetRequest
            {
                ResourceName = gax::GaxPreconditions.CheckNotNullOrEmpty(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::CustomerAsset> GetCustomerAssetAsync(string resourceName, st::CancellationToken cancellationToken) =>
            GetCustomerAssetAsync(resourceName, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::CustomerAsset GetCustomerAsset(gagvr::CustomerAssetName resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetCustomerAsset(new GetCustomerAssetRequest
            {
                ResourceNameAsCustomerAssetName = gax::GaxPreconditions.CheckNotNull(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::CustomerAsset> GetCustomerAssetAsync(gagvr::CustomerAssetName resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetCustomerAssetAsync(new GetCustomerAssetRequest
            {
                ResourceNameAsCustomerAssetName = gax::GaxPreconditions.CheckNotNull(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::CustomerAsset> GetCustomerAssetAsync(gagvr::CustomerAssetName resourceName, st::CancellationToken cancellationToken) =>
            GetCustomerAssetAsync(resourceName, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    ...
    {
        private readonly gaxgrpc::ApiCall<GetCustomerAssetRequest, gagvr::CustomerAsset> _callGetCustomerAsset;
        ...
        public CustomerAssetServiceClientImpl(CustomerAssetService.CustomerAssetServiceClient grpcClient, CustomerAssetServiceSettings settings)
        {
            ...
            _callGetCustomerAsset = clientHelper.BuildApiCall<GetCustomerAssetRequest, gagvr::CustomerAsset>(grpcClient.GetCustomerAssetAsync, grpcClient.GetCustomerAsset, effectiveSettings.GetCustomerAssetSettings).WithGoogleRequestParam("resource_name", request => request.ResourceName);
            Modify_ApiCall(ref _callGetCustomerAsset);
            Modify_GetCustomerAssetApiCall(ref _callGetCustomerAsset);
        ...
        partial void Modify_GetCustomerAssetApiCall(ref gaxgrpc::ApiCall<GetCustomerAssetRequest, gagvr::CustomerAsset> call);
        ...
        partial void Modify_GetCustomerAssetRequest(ref GetCustomerAssetRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override gagvr::CustomerAsset GetCustomerAsset(GetCustomerAssetRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetCustomerAssetRequest(ref request, ref callSettings);
            return _callGetCustomerAsset.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<gagvr::CustomerAsset> GetCustomerAssetAsync(GetCustomerAssetRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetCustomerAssetRequest(ref request, ref callSettings);
            return _callGetCustomerAsset.Async(request, callSettings);
        }
