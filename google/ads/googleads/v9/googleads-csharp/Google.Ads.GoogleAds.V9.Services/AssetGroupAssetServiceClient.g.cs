...
namespace Google.Ads.GoogleAds.V9.Services
{
    ...
    public sealed partial class AssetGroupAssetServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <c>AssetGroupAssetServiceClient.GetAssetGroupAsset</c> and
        /// <c>AssetGroupAssetServiceClient.GetAssetGroupAssetAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetAssetGroupAssetSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(3600000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(5000), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable, grpccore::StatusCode.DeadlineExceeded)));
    ...
    /// endpoint etc.
    /// </summary>
    public sealed partial class AssetGroupAssetServiceClientBuilder : gaxgrpc::ClientBuilderBase<AssetGroupAssetServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public AssetGroupAssetServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public AssetGroupAssetServiceClientBuilder()
        {
            UseJwtAccessWithScopes = AssetGroupAssetServiceClient.UseJwtAccessWithScopes;
        }
        ...
        private AssetGroupAssetServiceClient BuildImpl()
        {
            ...
            return AssetGroupAssetServiceClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => AssetGroupAssetServiceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => AssetGroupAssetServiceClient.DefaultScopes;
    ...
    public abstract partial class AssetGroupAssetServiceClient
    {
        ...
        public virtual gagvr::AssetGroupAsset GetAssetGroupAsset(GetAssetGroupAssetRequest request, gaxgrpc::CallSettings callSettings = null) =>
        ...
        public virtual stt::Task<gagvr::AssetGroupAsset> GetAssetGroupAssetAsync(GetAssetGroupAssetRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::AssetGroupAsset> GetAssetGroupAssetAsync(GetAssetGroupAssetRequest request, st::CancellationToken cancellationToken) =>
            GetAssetGroupAssetAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::AssetGroupAsset GetAssetGroupAsset(string resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetAssetGroupAsset(new GetAssetGroupAssetRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::AssetGroupAsset> GetAssetGroupAssetAsync(string resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetAssetGroupAssetAsync(new GetAssetGroupAssetRequest
            {
                ResourceName = gax::GaxPreconditions.CheckNotNullOrEmpty(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::AssetGroupAsset> GetAssetGroupAssetAsync(string resourceName, st::CancellationToken cancellationToken) =>
            GetAssetGroupAssetAsync(resourceName, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::AssetGroupAsset GetAssetGroupAsset(gagvr::AssetGroupAssetName resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetAssetGroupAsset(new GetAssetGroupAssetRequest
            {
                ResourceNameAsAssetGroupAssetName = gax::GaxPreconditions.CheckNotNull(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::AssetGroupAsset> GetAssetGroupAssetAsync(gagvr::AssetGroupAssetName resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetAssetGroupAssetAsync(new GetAssetGroupAssetRequest
            {
                ResourceNameAsAssetGroupAssetName = gax::GaxPreconditions.CheckNotNull(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::AssetGroupAsset> GetAssetGroupAssetAsync(gagvr::AssetGroupAssetName resourceName, st::CancellationToken cancellationToken) =>
            GetAssetGroupAssetAsync(resourceName, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    ...
    {
        private readonly gaxgrpc::ApiCall<GetAssetGroupAssetRequest, gagvr::AssetGroupAsset> _callGetAssetGroupAsset;
        ...
        partial void Modify_GetAssetGroupAssetApiCall(ref gaxgrpc::ApiCall<GetAssetGroupAssetRequest, gagvr::AssetGroupAsset> call);
        ...
        partial void Modify_GetAssetGroupAssetRequest(ref GetAssetGroupAssetRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override gagvr::AssetGroupAsset GetAssetGroupAsset(GetAssetGroupAssetRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetAssetGroupAssetRequest(ref request, ref callSettings);
            return _callGetAssetGroupAsset.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<gagvr::AssetGroupAsset> GetAssetGroupAssetAsync(GetAssetGroupAssetRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetAssetGroupAssetRequest(ref request, ref callSettings);
            return _callGetAssetGroupAsset.Async(request, callSettings);
        }
