...
namespace Google.Ads.GoogleAds.V9.Services
{
    ...
    /// </summary>
    public sealed partial class CustomConversionGoalServiceClientBuilder : gaxgrpc::ClientBuilderBase<CustomConversionGoalServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public CustomConversionGoalServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public CustomConversionGoalServiceClientBuilder()
        {
            UseJwtAccessWithScopes = CustomConversionGoalServiceClient.UseJwtAccessWithScopes;
        }
        ...
        private CustomConversionGoalServiceClient BuildImpl()
        {
            ...
            return CustomConversionGoalServiceClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => CustomConversionGoalServiceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => CustomConversionGoalServiceClient.DefaultScopes;
    ...
    public abstract partial class CustomConversionGoalServiceClient
    {
        ...
        /// <returns>The created <see cref="CustomConversionGoalServiceClient"/>.</returns>
        internal static CustomConversionGoalServiceClient Create(grpccore::CallInvoker callInvoker, CustomConversionGoalServiceSettings settings = null)
        {
            ...
            return new CustomConversionGoalServiceClientImpl(grpcClient, settings);
        }
    ...
    public sealed partial class CustomConversionGoalServiceClientImpl : CustomConversionGoalServiceClient
    {
        ...
        /// </param>
        public CustomConversionGoalServiceClientImpl(CustomConversionGoalService.CustomConversionGoalServiceClient grpcClient, CustomConversionGoalServiceSettings settings)
        {
            ...
            _callMutateCustomConversionGoals = clientHelper.BuildApiCall<MutateCustomConversionGoalsRequest, MutateCustomConversionGoalsResponse>(grpcClient.MutateCustomConversionGoalsAsync, grpcClient.MutateCustomConversionGoals, effectiveSettings.MutateCustomConversionGoalsSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
