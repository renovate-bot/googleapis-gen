...
namespace Google.Ads.GoogleAds.V9.Services
{
    ...
    public sealed partial class BiddingDataExclusionServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private BiddingDataExclusionServiceSettings(BiddingDataExclusionServiceSettings existing) : base(existing)
        {
            ...
            GetBiddingDataExclusionSettings = existing.GetBiddingDataExclusionSettings;
        ...
        /// <c>BiddingDataExclusionServiceClient.GetBiddingDataExclusion</c> and
        /// <c>BiddingDataExclusionServiceClient.GetBiddingDataExclusionAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetBiddingDataExclusionSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(3600000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(5000), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable, grpccore::StatusCode.DeadlineExceeded)));
    ...
    /// </summary>
    public sealed partial class BiddingDataExclusionServiceClientBuilder : gaxgrpc::ClientBuilderBase<BiddingDataExclusionServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public BiddingDataExclusionServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public BiddingDataExclusionServiceClientBuilder()
        {
            UseJwtAccessWithScopes = BiddingDataExclusionServiceClient.UseJwtAccessWithScopes;
        }
        ...
        private BiddingDataExclusionServiceClient BuildImpl()
        {
            ...
            return BiddingDataExclusionServiceClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => BiddingDataExclusionServiceClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => BiddingDataExclusionServiceClient.DefaultScopes;
    ...
    public abstract partial class BiddingDataExclusionServiceClient
    {
        ...
        /// <returns>The created <see cref="BiddingDataExclusionServiceClient"/>.</returns>
        internal static BiddingDataExclusionServiceClient Create(grpccore::CallInvoker callInvoker, BiddingDataExclusionServiceSettings settings = null)
        {
            ...
            return new BiddingDataExclusionServiceClientImpl(grpcClient, settings);
        }
        ...
        public virtual gagvr::BiddingDataExclusion GetBiddingDataExclusion(GetBiddingDataExclusionRequest request, gaxgrpc::CallSettings callSettings = null) =>
        ...
        public virtual stt::Task<gagvr::BiddingDataExclusion> GetBiddingDataExclusionAsync(GetBiddingDataExclusionRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BiddingDataExclusion> GetBiddingDataExclusionAsync(GetBiddingDataExclusionRequest request, st::CancellationToken cancellationToken) =>
            GetBiddingDataExclusionAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::BiddingDataExclusion GetBiddingDataExclusion(string resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetBiddingDataExclusion(new GetBiddingDataExclusionRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BiddingDataExclusion> GetBiddingDataExclusionAsync(string resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetBiddingDataExclusionAsync(new GetBiddingDataExclusionRequest
            {
                ResourceName = gax::GaxPreconditions.CheckNotNullOrEmpty(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BiddingDataExclusion> GetBiddingDataExclusionAsync(string resourceName, st::CancellationToken cancellationToken) =>
            GetBiddingDataExclusionAsync(resourceName, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::BiddingDataExclusion GetBiddingDataExclusion(gagvr::BiddingDataExclusionName resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetBiddingDataExclusion(new GetBiddingDataExclusionRequest
            {
                ResourceNameAsBiddingDataExclusionName = gax::GaxPreconditions.CheckNotNull(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BiddingDataExclusion> GetBiddingDataExclusionAsync(gagvr::BiddingDataExclusionName resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetBiddingDataExclusionAsync(new GetBiddingDataExclusionRequest
            {
                ResourceNameAsBiddingDataExclusionName = gax::GaxPreconditions.CheckNotNull(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BiddingDataExclusion> GetBiddingDataExclusionAsync(gagvr::BiddingDataExclusionName resourceName, st::CancellationToken cancellationToken) =>
            GetBiddingDataExclusionAsync(resourceName, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    ...
    {
        private readonly gaxgrpc::ApiCall<GetBiddingDataExclusionRequest, gagvr::BiddingDataExclusion> _callGetBiddingDataExclusion;
        ...
        /// </param>
        public BiddingDataExclusionServiceClientImpl(BiddingDataExclusionService.BiddingDataExclusionServiceClient grpcClient, BiddingDataExclusionServiceSettings settings)
        {
            ...
            _callGetBiddingDataExclusion = clientHelper.BuildApiCall<GetBiddingDataExclusionRequest, gagvr::BiddingDataExclusion>(grpcClient.GetBiddingDataExclusionAsync, grpcClient.GetBiddingDataExclusion, effectiveSettings.GetBiddingDataExclusionSettings).WithGoogleRequestParam("resource_name", request => request.ResourceName);
            Modify_ApiCall(ref _callGetBiddingDataExclusion);
            Modify_GetBiddingDataExclusionApiCall(ref _callGetBiddingDataExclusion);
            _callMutateBiddingDataExclusions = clientHelper.BuildApiCall<MutateBiddingDataExclusionsRequest, MutateBiddingDataExclusionsResponse>(grpcClient.MutateBiddingDataExclusionsAsync, grpcClient.MutateBiddingDataExclusions, effectiveSettings.MutateBiddingDataExclusionsSettings).WithGoogleRequestParam("customer_id", request => request.CustomerId);
        ...
        partial void Modify_GetBiddingDataExclusionApiCall(ref gaxgrpc::ApiCall<GetBiddingDataExclusionRequest, gagvr::BiddingDataExclusion> call);
        ...
        partial void Modify_GetBiddingDataExclusionRequest(ref GetBiddingDataExclusionRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override gagvr::BiddingDataExclusion GetBiddingDataExclusion(GetBiddingDataExclusionRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetBiddingDataExclusionRequest(ref request, ref callSettings);
            return _callGetBiddingDataExclusion.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<gagvr::BiddingDataExclusion> GetBiddingDataExclusionAsync(GetBiddingDataExclusionRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetBiddingDataExclusionRequest(ref request, ref callSettings);
            return _callGetBiddingDataExclusion.Async(request, callSettings);
        }
