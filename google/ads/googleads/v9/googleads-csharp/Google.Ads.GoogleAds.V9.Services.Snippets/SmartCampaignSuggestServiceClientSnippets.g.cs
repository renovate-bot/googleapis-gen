...
namespace Google.Ads.GoogleAds.V9.Services.Snippets
{
    ...
    public sealed class GeneratedSmartCampaignSuggestServiceClientSnippets
    {
        ...
        {
            // Snippet: SuggestKeywordThemes(SuggestKeywordThemesRequest, CallSettings)
            // Create client
            SmartCampaignSuggestServiceClient smartCampaignSuggestServiceClient = SmartCampaignSuggestServiceClient.Create();
            // Initialize request argument(s)
        ...
        /// <summary>Snippet for SuggestKeywordThemesAsync</summary>
        public async Task SuggestKeywordThemesRequestObjectAsync()
        {
            // Snippet: SuggestKeywordThemesAsync(SuggestKeywordThemesRequest, CallSettings)
            // Additional: SuggestKeywordThemesAsync(SuggestKeywordThemesRequest, CancellationToken)
            // Create client
            SmartCampaignSuggestServiceClient smartCampaignSuggestServiceClient = await SmartCampaignSuggestServiceClient.CreateAsync();
            // Initialize request argument(s)
            SuggestKeywordThemesRequest request = new SuggestKeywordThemesRequest
            ...
            // Make the request
            SuggestKeywordThemesResponse response = await smartCampaignSuggestServiceClient.SuggestKeywordThemesAsync(request);
            // End snippet
        }
    }
}
