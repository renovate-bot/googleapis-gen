...
namespace Google.Ads.GoogleAds.V9.Services.Snippets
{
    ...
    public sealed partial class GeneratedKeywordPlanIdeaServiceClientStandaloneSnippets
    {
        ...
        public void GenerateKeywordIdeasRequestObject()
        {
            ...
            foreach (GenerateKeywordIdeaResult item in response)
            {
            ...
            foreach (GenerateKeywordIdeaResponse page in response.AsRawResponses())
            {
            ...
            int pageSize = 10;
            Page<GenerateKeywordIdeaResult> singlePage = response.ReadPage(pageSize);
