...
namespace Google.Ads.GoogleAds.V9.Services.Snippets
{
    ...
    public sealed partial class GeneratedOfflineUserDataJobServiceClientStandaloneSnippets
    {
        ...
        public void RunOfflineUserDataJobResourceNames()
        {
            ...
            // Make the request
            Operation<Empty, OfflineUserDataJobMetadata> response = offlineUserDataJobServiceClient.RunOfflineUserDataJob(resourceName);

            // Poll until the returned long-running operation is complete
            Operation<Empty, OfflineUserDataJobMetadata> completedResponse = response.PollUntilCompleted();
            ...
            Operation<Empty, OfflineUserDataJobMetadata> retrievedResponse = offlineUserDataJobServiceClient.PollOnceRunOfflineUserDataJob(operationName);
