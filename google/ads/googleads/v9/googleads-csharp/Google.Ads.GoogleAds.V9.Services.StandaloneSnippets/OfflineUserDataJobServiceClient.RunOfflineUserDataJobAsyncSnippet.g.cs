...
namespace Google.Ads.GoogleAds.V9.Services.Snippets
{
    ...
    public sealed partial class GeneratedOfflineUserDataJobServiceClientStandaloneSnippets
    {
        ...
        public async Task RunOfflineUserDataJobAsync()
        {
            ...
            // Make the request
            Operation<Empty, OfflineUserDataJobMetadata> response = await offlineUserDataJobServiceClient.RunOfflineUserDataJobAsync(resourceName);

            // Poll until the returned long-running operation is complete
            Operation<Empty, OfflineUserDataJobMetadata> completedResponse = await response.PollUntilCompletedAsync();
            ...
            Operation<Empty, OfflineUserDataJobMetadata> retrievedResponse = await offlineUserDataJobServiceClient.PollOnceRunOfflineUserDataJobAsync(operationName);
