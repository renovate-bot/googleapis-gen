...
namespace Google.Ads.GoogleAds.V9.Services.Tests
{
    ...
    public sealed class GeneratedBillingSetupServiceClientTest
    {
        ...
        public void GetBillingSetupRequestObject()
        {
            ...
            {
                ResourceNameAsBillingSetupName = gagvr::BillingSetupName.FromCustomerBillingSetup("[CUSTOMER_ID]", "[BILLING_SETUP_ID]"),
            };
            gagvr::BillingSetup expectedResponse = new gagvr::BillingSetup
            {
                ...
                PaymentsAccountAsPaymentsAccountName = gagvr::PaymentsAccountName.FromCustomerPaymentsAccount("[CUSTOMER_ID]", "[PAYMENTS_ACCOUNT_ID]"),
            };
