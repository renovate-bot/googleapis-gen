...
namespace Google.Ads.GoogleAds.V9.Services.Tests
{
    ...
    public sealed class GeneratedKeywordPlanAdGroupKeywordServiceClientTest
    {
        ...
        public void GetKeywordPlanAdGroupKeywordRequestObject()
        {
            ...
            {
                ResourceNameAsKeywordPlanAdGroupKeywordName = gagvr::KeywordPlanAdGroupKeywordName.FromCustomerKeywordPlanAdGroupKeyword("[CUSTOMER_ID]", "[KEYWORD_PLAN_AD_GROUP_KEYWORD_ID]"),
            };
            gagvr::KeywordPlanAdGroupKeyword expectedResponse = new gagvr::KeywordPlanAdGroupKeyword
            {
                ...
                KeywordPlanAdGroupAsKeywordPlanAdGroupName = gagvr::KeywordPlanAdGroupName.FromCustomerKeywordPlanAdGroup("[CUSTOMER_ID]", "[KEYWORD_PLAN_AD_GROUP_ID]"),
