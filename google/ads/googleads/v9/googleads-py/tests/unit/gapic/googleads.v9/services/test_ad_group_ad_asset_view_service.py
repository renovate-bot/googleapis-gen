...
def test_ad_group_ad_asset_view_service_client_from_service_account_info():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        info = {"valid": True}
        client = AdGroupAdAssetViewServiceClient.from_service_account_info(info)
...
def test_ad_group_ad_asset_view_service_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        ...
        client = AdGroupAdAssetViewServiceClient.from_service_account_json("dummy/file/path.json")
        assert client.transport._credentials == creds
...
def test_ad_group_ad_asset_view_service_client_client_options():
    # Check that if channel is provided we won't create a new one.
    with mock.patch('google.ads.googleads.v9.services.services.ad_group_ad_asset_view_service.AdGroupAdAssetViewServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v9.services.services.ad_group_ad_asset_view_service.AdGroupAdAssetViewServiceClient.get_transport_class') as gtc:
        client = AdGroupAdAssetViewServiceClient(transport="grpc")
        gtc.assert_called()
    ...
    with mock.patch('google.ads.googleads.v9.services.services.ad_group_ad_asset_view_service.transports.AdGroupAdAssetViewServiceGrpcTransport.__init__') as grpc_transport:
        ...
        client = AdGroupAdAssetViewServiceClient(client_options=options)
...
def test_ad_group_ad_asset_view_service_client_mtls_env_auto(use_client_cert_env):
...
def test_get_ad_group_ad_asset_view_from_dict():
    test_get_ad_group_ad_asset_view(request_type=dict)
...
def test_ad_group_ad_asset_view_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v9.services.services.ad_group_ad_asset_view_service.transports.AdGroupAdAssetViewServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AdGroupAdAssetViewServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.AdGroupAdAssetViewServiceGrpcTransport])
