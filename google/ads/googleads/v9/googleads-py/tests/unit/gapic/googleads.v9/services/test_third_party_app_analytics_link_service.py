...
def test_third_party_app_analytics_link_service_client_from_service_account_info():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        info = {"valid": True}
        client = ThirdPartyAppAnalyticsLinkServiceClient.from_service_account_info(info)
...
def test_third_party_app_analytics_link_service_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        ...
        client = ThirdPartyAppAnalyticsLinkServiceClient.from_service_account_json("dummy/file/path.json")
        assert client.transport._credentials == creds
...
def test_third_party_app_analytics_link_service_client_client_options():
    # Check that if channel is provided we won't create a new one.
    with mock.patch('google.ads.googleads.v9.services.services.third_party_app_analytics_link_service.ThirdPartyAppAnalyticsLinkServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v9.services.services.third_party_app_analytics_link_service.ThirdPartyAppAnalyticsLinkServiceClient.get_transport_class') as gtc:
        client = ThirdPartyAppAnalyticsLinkServiceClient(transport="grpc")
        gtc.assert_called()
    ...
    with mock.patch('google.ads.googleads.v9.services.services.third_party_app_analytics_link_service.transports.ThirdPartyAppAnalyticsLinkServiceGrpcTransport.__init__') as grpc_transport:
        ...
        client = ThirdPartyAppAnalyticsLinkServiceClient(client_options=options)
...
def test_third_party_app_analytics_link_service_client_mtls_env_auto(use_client_cert_env):
...
def test_get_third_party_app_analytics_link_from_dict():
    test_get_third_party_app_analytics_link(request_type=dict)
...
def test_regenerate_shareable_link_id_from_dict():
    test_regenerate_shareable_link_id(request_type=dict)
...
def test_third_party_app_analytics_link_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v9.services.services.third_party_app_analytics_link_service.transports.ThirdPartyAppAnalyticsLinkServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ThirdPartyAppAnalyticsLinkServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.ThirdPartyAppAnalyticsLinkServiceGrpcTransport])
