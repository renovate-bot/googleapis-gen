...
from google.ads.googleads.v9.services.services.ad_group_feed_service import AdGroupFeedServiceClient
from google.ads.googleads.v9.services.services.ad_group_feed_service import transports
...
def test_ad_group_feed_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v9.services.services.ad_group_feed_service.transports.AdGroupFeedServiceGrpcTransport.__init__') as grpc_transport:
...
def test_ad_group_feed_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v9.services.services.ad_group_feed_service.transports.AdGroupFeedServiceTransport.__init__') as Transport:
...
def test_ad_group_feed_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.googleads.v9.services.services.ad_group_feed_service.transports.AdGroupFeedServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_ad_group_feed_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.googleads.v9.services.services.ad_group_feed_service.transports.AdGroupFeedServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AdGroupFeedServiceTransport()
        adc.assert_called_once()
