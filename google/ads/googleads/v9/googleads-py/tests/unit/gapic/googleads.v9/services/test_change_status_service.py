...
from google.ads.googleads.v9.services.services.change_status_service import ChangeStatusServiceClient
from google.ads.googleads.v9.services.services.change_status_service import transports
...
def test_change_status_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v9.services.services.change_status_service.transports.ChangeStatusServiceGrpcTransport.__init__') as grpc_transport:
...
def test_change_status_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v9.services.services.change_status_service.transports.ChangeStatusServiceTransport.__init__') as Transport:
...
def test_change_status_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.googleads.v9.services.services.change_status_service.transports.ChangeStatusServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_change_status_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.googleads.v9.services.services.change_status_service.transports.ChangeStatusServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ChangeStatusServiceTransport()
        adc.assert_called_once()
