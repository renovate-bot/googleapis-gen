...
from google.ads.googleads.v9.services.services.campaign_draft_service import CampaignDraftServiceClient
from google.ads.googleads.v9.services.services.campaign_draft_service import pagers
from google.ads.googleads.v9.services.services.campaign_draft_service import transports
...
def test_campaign_draft_service_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.CampaignDraftServiceGrpcTransport, "grpc"),
])
def test_campaign_draft_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_campaign_draft_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (CampaignDraftServiceClient, transports.CampaignDraftServiceGrpcTransport, "grpc"),
])
@mock.patch.object(CampaignDraftServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CampaignDraftServiceClient))
def test_campaign_draft_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(CampaignDraftServiceClient, 'get_transport_class') as gtc:
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (CampaignDraftServiceClient, transports.CampaignDraftServiceGrpcTransport, "grpc", "true"),
    (CampaignDraftServiceClient, transports.CampaignDraftServiceGrpcTransport, "grpc", "false"),
])
@mock.patch.object(CampaignDraftServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CampaignDraftServiceClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_campaign_draft_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_campaign_draft_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_campaign_draft_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_campaign_draft_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v9.services.services.campaign_draft_service.transports.CampaignDraftServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_campaign_draft(request_type, transport: str = 'grpc'):
    client = CampaignDraftServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_campaign_drafts(request_type, transport: str = 'grpc'):
    client = CampaignDraftServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_campaign_drafts_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CampaignDraftServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_mutate_campaign_drafts_flattened():
    ...
    with mock.patch.object(
        ...
        client.mutate_campaign_drafts(
            ...
            operations=[campaign_draft_service.CampaignDraftOperation(update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))],
        )
        ...
        mock_val = [campaign_draft_service.CampaignDraftOperation(update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))]
        assert arg == mock_val
...
def test_promote_campaign_draft(request_type, transport: str = 'grpc'):
    client = CampaignDraftServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_promote_campaign_draft_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CampaignDraftServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_promote_campaign_draft_flattened():
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        arg = args[0].campaign_draft
        mock_val = 'campaign_draft_value'
        assert arg == mock_val
...
def test_list_campaign_draft_async_errors(request_type, transport: str = 'grpc'):
    client = CampaignDraftServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_campaign_draft_async_errors_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CampaignDraftServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_campaign_draft_async_errors_pager(transport_name: str = "grpc"):
    client = CampaignDraftServiceClient(
        credentials=ga_credentials.AnonymousCredentials,
...
def test_list_campaign_draft_async_errors_pages(transport_name: str = "grpc"):
    client = CampaignDraftServiceClient(
        credentials=ga_credentials.AnonymousCredentials,
        transport=transport_name,
    )
...
def test_campaign_draft_service_base_transport_error():
...
def test_campaign_draft_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v9.services.services.campaign_draft_service.transports.CampaignDraftServiceTransport.__init__') as Transport:
...
def test_campaign_draft_service_base_transport_with_credentials_file():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.googleads.v9.services.services.campaign_draft_service.transports.CampaignDraftServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_campaign_draft_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.googleads.v9.services.services.campaign_draft_service.transports.CampaignDraftServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CampaignDraftServiceTransport()
        adc.assert_called_once()
...
def test_campaign_draft_service_transport_auth_adc(transport_class):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.CampaignDraftServiceGrpcTransport, grpc_helpers),
    ],
)
def test_campaign_draft_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_campaign_draft_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_campaign_path():
    ...
    actual = CampaignDraftServiceClient.campaign_path(customer_id, campaign_id)
...
def test_campaign_draft_path():
    ...
    actual = CampaignDraftServiceClient.campaign_draft_path(customer_id, base_campaign_id, draft_id)
    assert expected == actual
