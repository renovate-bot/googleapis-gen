...
from google.ads.googleads.v9.enums.types import offline_user_data_job_failure_reason
from google.ads.googleads.v9.enums.types import offline_user_data_job_match_rate_range
from google.ads.googleads.v9.enums.types import offline_user_data_job_status
from google.ads.googleads.v9.enums.types import offline_user_data_job_type
...
from google.ads.googleads.v9.services.services.offline_user_data_job_service import OfflineUserDataJobServiceClient
from google.ads.googleads.v9.services.services.offline_user_data_job_service import transports
...
def test_offline_user_data_job_service_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.OfflineUserDataJobServiceGrpcTransport, "grpc"),
])
def test_offline_user_data_job_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_offline_user_data_job_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (OfflineUserDataJobServiceClient, transports.OfflineUserDataJobServiceGrpcTransport, "grpc"),
])
...
def test_offline_user_data_job_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(OfflineUserDataJobServiceClient, 'get_transport_class') as gtc:
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (OfflineUserDataJobServiceClient, transports.OfflineUserDataJobServiceGrpcTransport, "grpc", "true"),
    (OfflineUserDataJobServiceClient, transports.OfflineUserDataJobServiceGrpcTransport, "grpc", "false"),
])
@mock.patch.object(OfflineUserDataJobServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OfflineUserDataJobServiceClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_offline_user_data_job_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_offline_user_data_job_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_offline_user_data_job_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_offline_user_data_job_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v9.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_offline_user_data_job(request_type, transport: str = 'grpc'):
    client = OfflineUserDataJobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_offline_user_data_job_empty_call():
...
def test_create_offline_user_data_job_flattened():
    ...
    with mock.patch.object(
        ...
        assert arg == mock_val
        arg = args[0].job
        mock_val = offline_user_data_job.OfflineUserDataJob(resource_name='resource_name_value')
        assert arg == mock_val
...
def test_get_offline_user_data_job(request_type, transport: str = 'grpc'):
    client = OfflineUserDataJobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_offline_user_data_job_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = OfflineUserDataJobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_add_offline_user_data_job_operations(request_type, transport: str = 'grpc'):
    client = OfflineUserDataJobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_offline_user_data_job_operations_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = OfflineUserDataJobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_add_offline_user_data_job_operations_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = [offline_user_data_job_service.OfflineUserDataJobOperation(create=offline_user_data.UserData(user_identifiers=[offline_user_data.UserIdentifier(user_identifier_source=user_identifier_source.UserIdentifierSourceEnum.UserIdentifierSource.UNKNOWN)]))]
        assert arg == mock_val
...
def test_run_offline_user_data_job(request_type, transport: str = 'grpc'):
    client = OfflineUserDataJobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_run_offline_user_data_job_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = OfflineUserDataJobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_offline_user_data_job_service_base_transport_error():
...
def test_offline_user_data_job_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v9.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceTransport.__init__') as Transport:
...
def test_offline_user_data_job_service_base_transport_with_credentials_file():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.googleads.v9.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_offline_user_data_job_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.googleads.v9.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OfflineUserDataJobServiceTransport()
        adc.assert_called_once()
...
def test_offline_user_data_job_service_transport_auth_adc(transport_class):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.OfflineUserDataJobServiceGrpcTransport, grpc_helpers),
    ],
)
def test_offline_user_data_job_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_offline_user_data_job_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
