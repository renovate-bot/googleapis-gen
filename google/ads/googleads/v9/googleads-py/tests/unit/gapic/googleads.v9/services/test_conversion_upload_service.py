...
def test_conversion_upload_service_client_from_service_account_info():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        info = {"valid": True}
        client = ConversionUploadServiceClient.from_service_account_info(info)
...
def test_conversion_upload_service_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        ...
        client = ConversionUploadServiceClient.from_service_account_json("dummy/file/path.json")
        assert client.transport._credentials == creds
...
def test_conversion_upload_service_client_client_options():
    # Check that if channel is provided we won't create a new one.
    with mock.patch('google.ads.googleads.v9.services.services.conversion_upload_service.ConversionUploadServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v9.services.services.conversion_upload_service.ConversionUploadServiceClient.get_transport_class') as gtc:
        client = ConversionUploadServiceClient(transport="grpc")
        gtc.assert_called()
    ...
    with mock.patch('google.ads.googleads.v9.services.services.conversion_upload_service.transports.ConversionUploadServiceGrpcTransport.__init__') as grpc_transport:
        ...
        client = ConversionUploadServiceClient(client_options=options)
...
def test_conversion_upload_service_client_mtls_env_auto(use_client_cert_env):
...
def test_upload_click_conversions_from_dict():
    test_upload_click_conversions(request_type=dict)
...
def test_upload_call_conversions_from_dict():
    test_upload_call_conversions(request_type=dict)
...
def test_conversion_upload_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v9.services.services.conversion_upload_service.transports.ConversionUploadServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConversionUploadServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.ConversionUploadServiceGrpcTransport])
