...
def test_campaign_label_service_client_from_service_account_info():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        info = {"valid": True}
        client = CampaignLabelServiceClient.from_service_account_info(info)
...
def test_campaign_label_service_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        ...
        client = CampaignLabelServiceClient.from_service_account_json("dummy/file/path.json")
        assert client.transport._credentials == creds
...
def test_campaign_label_service_client_client_options():
    # Check that if channel is provided we won't create a new one.
    with mock.patch('google.ads.googleads.v9.services.services.campaign_label_service.CampaignLabelServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v9.services.services.campaign_label_service.CampaignLabelServiceClient.get_transport_class') as gtc:
        client = CampaignLabelServiceClient(transport="grpc")
        gtc.assert_called()
    ...
    with mock.patch('google.ads.googleads.v9.services.services.campaign_label_service.transports.CampaignLabelServiceGrpcTransport.__init__') as grpc_transport:
        ...
        client = CampaignLabelServiceClient(client_options=options)
...
def test_campaign_label_service_client_mtls_env_auto(use_client_cert_env):
...
def test_get_campaign_label_from_dict():
    test_get_campaign_label(request_type=dict)
...
def test_mutate_campaign_labels_from_dict():
    test_mutate_campaign_labels(request_type=dict)
...
def test_campaign_label_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v9.services.services.campaign_label_service.transports.CampaignLabelServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CampaignLabelServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.CampaignLabelServiceGrpcTransport])
