...
def test_smart_campaign_search_term_view_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v9.services.services.smart_campaign_search_term_view_service.SmartCampaignSearchTermViewServiceClient.get_transport_class') as gtc:
...
def test_smart_campaign_search_term_view_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v9.services.services.smart_campaign_search_term_view_service.transports.SmartCampaignSearchTermViewServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SmartCampaignSearchTermViewServiceTransport()
        adc.assert_called_once()
