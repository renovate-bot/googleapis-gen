...
def test_asset_group_listing_group_filter_service_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.AssetGroupListingGroupFilterServiceGrpcTransport, "grpc"),
])
def test_asset_group_listing_group_filter_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_asset_group_listing_group_filter_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (AssetGroupListingGroupFilterServiceClient, transports.AssetGroupListingGroupFilterServiceGrpcTransport, "grpc"),
])
...
def test_asset_group_listing_group_filter_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(AssetGroupListingGroupFilterServiceClient, 'get_transport_class') as gtc:
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (AssetGroupListingGroupFilterServiceClient, transports.AssetGroupListingGroupFilterServiceGrpcTransport, "grpc", "true"),
    (AssetGroupListingGroupFilterServiceClient, transports.AssetGroupListingGroupFilterServiceGrpcTransport, "grpc", "false"),
])
@mock.patch.object(AssetGroupListingGroupFilterServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AssetGroupListingGroupFilterServiceClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_asset_group_listing_group_filter_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_asset_group_listing_group_filter_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_asset_group_listing_group_filter_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_mutate_asset_group_listing_group_filters(request_type, transport: str = 'grpc'):
    client = AssetGroupListingGroupFilterServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_asset_group_listing_group_filters_empty_call():
...
def test_mutate_asset_group_listing_group_filters_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = [asset_group_listing_group_filter_service.AssetGroupListingGroupFilterOperation(update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))]
        assert arg == mock_val
...
def test_asset_group_listing_group_filter_service_base_transport_error():
...
def test_asset_group_listing_group_filter_service_base_transport_with_credentials_file():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.googleads.v9.services.services.asset_group_listing_group_filter_service.transports.AssetGroupListingGroupFilterServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_asset_group_listing_group_filter_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.googleads.v9.services.services.asset_group_listing_group_filter_service.transports.AssetGroupListingGroupFilterServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AssetGroupListingGroupFilterServiceTransport()
        adc.assert_called_once()
...
def test_asset_group_listing_group_filter_service_transport_auth_adc(transport_class):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.AssetGroupListingGroupFilterServiceGrpcTransport, grpc_helpers),
    ],
)
def test_asset_group_listing_group_filter_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_asset_group_listing_group_filter_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
