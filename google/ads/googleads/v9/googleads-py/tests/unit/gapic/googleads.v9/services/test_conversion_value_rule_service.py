...
def test_conversion_value_rule_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v9.services.services.conversion_value_rule_service.ConversionValueRuleServiceClient.get_transport_class') as gtc:
...
def test_conversion_value_rule_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v9.services.services.conversion_value_rule_service.transports.ConversionValueRuleServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConversionValueRuleServiceTransport()
        adc.assert_called_once()
