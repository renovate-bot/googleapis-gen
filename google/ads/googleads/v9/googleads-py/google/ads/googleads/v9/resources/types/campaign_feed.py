...
from google.ads.googleads.v9.common.types import matching_function as gagc_matching_function
...
class CampaignFeed(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v9.enums.types.FeedLinkStatusEnum.FeedLinkStatus):
