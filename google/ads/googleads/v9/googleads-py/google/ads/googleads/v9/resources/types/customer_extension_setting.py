...
from google.ads.googleads.v9.enums.types import extension_type as gage_extension_type
...
class CustomerExtensionSetting(proto.Message):
    ...
    Attributes:
        ...
        device (google.ads.googleads.v9.enums.types.ExtensionSettingDeviceEnum.ExtensionSettingDevice):
