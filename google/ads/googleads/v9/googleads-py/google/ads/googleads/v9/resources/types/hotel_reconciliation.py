...
from google.ads.googleads.v9.enums.types import hotel_reconciliation_status
...
class HotelReconciliation(proto.Message):
    ...
    Attributes:
        ...
        reconciled_value_micros (int):
            ...
            the value of any cancellation fees or non-
            refundable nights charged. Value is in
        ...
        billed (bool):
            ...
            modified.
        status (google.ads.googleads.v9.enums.types.HotelReconciliationStatusEnum.HotelReconciliationStatus):
