...
class MutateConversionValueRuleSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.ConversionValueRuleSetOperation]):
...
class ConversionValueRuleSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.ConversionValueRuleSet):
            Create operation: No resource name is
            expected for the new conversion value rule set.
            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.ConversionValueRuleSet):
...
class MutateConversionValueRuleSetsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateConversionValueRuleSetResult]):
