...
class MatchingFunction(proto.Message):
    ...
    Attributes:
        ...
        left_operands (Sequence[google.ads.googleads.v9.common.types.Operand]):
        ...
        right_operands (Sequence[google.ads.googleads.v9.common.types.Operand]):
...
class Operand(proto.Message):
    ...
    class FunctionOperand(proto.Message):
        ...
        Attributes:
            matching_function (google.ads.googleads.v9.common.types.MatchingFunction):
    ...
    class RequestContextOperand(proto.Message):
        ...
        Attributes:
            context_type (google.ads.googleads.v9.enums.types.MatchingFunctionContextTypeEnum.MatchingFunctionContextType):
