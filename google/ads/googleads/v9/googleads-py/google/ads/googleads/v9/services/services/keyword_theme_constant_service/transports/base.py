...
class KeywordThemeConstantServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_keyword_theme_constant: gapic_v1.method.wrap_method(
                self.get_keyword_theme_constant,
    ...
    def get_keyword_theme_constant(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[keyword_theme_constant.KeywordThemeConstant]
            ]]:
        raise NotImplementedError()
    ...
    def suggest_keyword_theme_constants(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[keyword_theme_constant_service.SuggestKeywordThemeConstantsResponse]
            ]]:
        raise NotImplementedError()
