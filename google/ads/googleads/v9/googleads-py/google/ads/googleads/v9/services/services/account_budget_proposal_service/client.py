...
from google.ads.googleads.v9.enums.types import account_budget_proposal_status
from google.ads.googleads.v9.enums.types import account_budget_proposal_type
    ...
    def mutate_account_budget_proposal(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (google.ads.googleads.v9.services.types.AccountBudgetProposalOperation):
