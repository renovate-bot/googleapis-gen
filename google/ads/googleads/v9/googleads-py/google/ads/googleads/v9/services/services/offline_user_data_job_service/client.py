...
class OfflineUserDataJobServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[OfflineUserDataJobServiceTransport]]
...
class OfflineUserDataJobServiceClient(metaclass=OfflineUserDataJobServiceClientMeta):
    ...
    def create_offline_user_data_job(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.CreateOfflineUserDataJobRequest, dict]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            job (:class:`google.ads.googleads.v9.resources.types.OfflineUserDataJob`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.CreateOfflineUserDataJobResponse:
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_offline_user_data_job]
    ...
    def get_offline_user_data_job(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetOfflineUserDataJobRequest, dict]):
                The request object. Request message for
                [OfflineUserDataJobService.GetOfflineUserDataJob][google.ads.googleads.v9.services.OfflineUserDataJobService.GetOfflineUserDataJob].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.OfflineUserDataJob:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_offline_user_data_job]
    ...
    def add_offline_user_data_job_operations(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.AddOfflineUserDataJobOperationsRequest, dict]):
                The request object. Request message for
            ...
            resource_name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.OfflineUserDataJobOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.AddOfflineUserDataJobOperationsResponse:
                Response message for
                   [OfflineUserDataJobService.AddOfflineUserDataJobOperations][google.ads.googleads.v9.services.OfflineUserDataJobService.AddOfflineUserDataJobOperations].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.add_offline_user_data_job_operations]
    ...
    def run_offline_user_data_job(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.RunOfflineUserDataJobRequest, dict]):
                The request object. Request message for
                [OfflineUserDataJobService.RunOfflineUserDataJob][google.ads.googleads.v9.services.OfflineUserDataJobService.RunOfflineUserDataJob].
            resource_name (:class:`str`):
                Required. The resource name of the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.run_offline_user_data_job]
