...
class MutateAdGroupCriterionCustomizersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.AdGroupCriterionCustomizerOperation]):
...
class AdGroupCriterionCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v9.resources.types.AdGroupCriterionCustomizer):
...
class MutateAdGroupCriterionCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateAdGroupCriterionCustomizerResult]):
