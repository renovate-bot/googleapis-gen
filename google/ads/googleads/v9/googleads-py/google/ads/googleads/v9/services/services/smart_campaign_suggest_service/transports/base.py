...
class SmartCampaignSuggestServiceTransport(abc.ABC):
    """Abstract transport class for SmartCampaignSuggestService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.suggest_smart_campaign_budget_options: gapic_v1.method.wrap_method(
                self.suggest_smart_campaign_budget_options,
            ...
            self.suggest_keyword_themes: gapic_v1.method.wrap_method(
                self.suggest_keyword_themes,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def suggest_smart_campaign_budget_options(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[smart_campaign_suggest_service.SuggestSmartCampaignBudgetOptionsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def suggest_smart_campaign_ad(self) -> Callable[
    ...
    @property
    def suggest_keyword_themes(self) -> Callable[
