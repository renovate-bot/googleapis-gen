...
from .transports.base import CustomizerAttributeServiceTransport, DEFAULT_CLIENT_INFO
...
class CustomizerAttributeServiceClient(metaclass=CustomizerAttributeServiceClientMeta):
    ...
    def mutate_customizer_attributes(self,
            request: Union[customizer_attribute_service.MutateCustomizerAttributesRequest, dict] = None,
            *,
            customer_id: str = None,
            operations: Sequence[customizer_attribute_service.CustomizerAttributeOperation] = None,
        ...
        if not isinstance(request, customizer_attribute_service.MutateCustomizerAttributesRequest):
            request = customizer_attribute_service.MutateCustomizerAttributesRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.mutate_customizer_attributes]
