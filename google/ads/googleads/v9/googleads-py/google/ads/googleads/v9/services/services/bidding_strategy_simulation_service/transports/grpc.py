...
class BiddingStrategySimulationServiceGrpcTransport(BiddingStrategySimulationServiceTransport):
    ...
    def get_bidding_strategy_simulation(self) -> Callable[
        ...
        if 'get_bidding_strategy_simulation' not in self._stubs:
            self._stubs['get_bidding_strategy_simulation'] = self.grpc_channel.unary_unary(
...
__all__ = (
    'BiddingStrategySimulationServiceGrpcTransport',
)
