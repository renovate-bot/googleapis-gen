...
class AssetSet(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            length of 128.
        type_ (google.ads.googleads.v9.enums.types.AssetSetTypeEnum.AssetSetType):
            Required. Immutable. The type of the asset
            set. Required.
        status (google.ads.googleads.v9.enums.types.AssetSetStatusEnum.AssetSetStatus):
            Output only. The status of the asset set.
            Read-only.
        merchant_center_feed (google.ads.googleads.v9.resources.types.AssetSet.MerchantCenterFeed):
