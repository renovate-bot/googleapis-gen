...
from google.ads.googleads.v9.enums.types import geo_targeting_restriction as gage_geo_targeting_restriction
...
class FeedItem(proto.Message):
    ...
    Attributes:
        ...
        geo_targeting_restriction (google.ads.googleads.v9.enums.types.GeoTargetingRestrictionEnum.GeoTargetingRestriction):
        ...
        policy_infos (Sequence[google.ads.googleads.v9.resources.types.FeedItemPlaceholderPolicyInfo]):
...
class FeedItemPlaceholderPolicyInfo(proto.Message):
    ...
    Attributes:
        placeholder_type_enum (google.ads.googleads.v9.enums.types.PlaceholderTypeEnum.PlaceholderType):
        ...
        policy_topic_entries (Sequence[google.ads.googleads.v9.common.types.PolicyTopicEntry]):
            ...
            the placeholder type.
        validation_status (google.ads.googleads.v9.enums.types.FeedItemValidationStatusEnum.FeedItemValidationStatus):
            Output only. The validation status of the
            palceholder type.
        validation_errors (Sequence[google.ads.googleads.v9.resources.types.FeedItemValidationError]):
            Output only. List of placeholder type
            validation errors.
        quality_approval_status (google.ads.googleads.v9.enums.types.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus):
            Output only. Placeholder type quality
            evaluation approval status.
        quality_disapproval_reasons (Sequence[google.ads.googleads.v9.enums.types.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason]):
...
class FeedItemValidationError(proto.Message):
    ...
    Attributes:
        validation_error (google.ads.googleads.v9.errors.types.FeedItemValidationErrorEnum.FeedItemValidationError):
