...
from google.ads.googleads.v9.enums.types import google_ads_field_category
from google.ads.googleads.v9.enums.types import google_ads_field_data_type
from google.ads.googleads.v9.resources.types import google_ads_field
from google.ads.googleads.v9.services.services.google_ads_field_service import pagers
...
class GoogleAdsFieldServiceClient(metaclass=GoogleAdsFieldServiceClientMeta):
    ...
    def google_ads_field_path(google_ads_field: str,) -> str:
        ...
        return "googleAdsFields/{google_ads_field}".format(google_ads_field=google_ads_field, )
    ...
    def get_google_ads_field(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetGoogleAdsFieldRequest, dict]):
                The request object. Request message for
                [GoogleAdsFieldService.GetGoogleAdsField][google.ads.googleads.v9.services.GoogleAdsFieldService.GetGoogleAdsField].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.GoogleAdsField:
        ...
        if not isinstance(request, google_ads_field_service.GetGoogleAdsFieldRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_google_ads_field]
    ...
    def search_google_ads_fields(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.SearchGoogleAdsFieldsRequest, dict]):
                The request object. Request message for
                [GoogleAdsFieldService.SearchGoogleAdsFields][google.ads.googleads.v9.services.GoogleAdsFieldService.SearchGoogleAdsFields].
            query (:class:`str`):
        ...
        Returns:
            google.ads.googleads.v9.services.services.google_ads_field_service.pagers.SearchGoogleAdsFieldsPager:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, google_ads_field_service.SearchGoogleAdsFieldsRequest):
            request = google_ads_field_service.SearchGoogleAdsFieldsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_google_ads_fields]
