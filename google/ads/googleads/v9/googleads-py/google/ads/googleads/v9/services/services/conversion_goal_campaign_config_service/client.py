...
from .transports.base import ConversionGoalCampaignConfigServiceTransport, DEFAULT_CLIENT_INFO
...
class ConversionGoalCampaignConfigServiceClient(metaclass=ConversionGoalCampaignConfigServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, ConversionGoalCampaignConfigServiceTransport, None] = None,
    ...
    def mutate_conversion_goal_campaign_configs(self,
            request: Union[conversion_goal_campaign_config_service.MutateConversionGoalCampaignConfigsRequest, dict] = None,
            *,
            customer_id: str = None,
            operations: Sequence[conversion_goal_campaign_config_service.ConversionGoalCampaignConfigOperation] = None,
        ...
        if not isinstance(request, conversion_goal_campaign_config_service.MutateConversionGoalCampaignConfigsRequest):
            request = conversion_goal_campaign_config_service.MutateConversionGoalCampaignConfigsRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.mutate_conversion_goal_campaign_configs]
