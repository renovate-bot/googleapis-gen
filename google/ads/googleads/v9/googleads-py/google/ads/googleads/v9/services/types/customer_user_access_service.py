...
class GetCustomerUserAccessRequest(proto.Message):
    ...
    Attributes:
        resource_name (str):
            Required. Resource name of the customer user
            access.
    """
...
class MutateCustomerUserAccessRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            modified.
        operation (google.ads.googleads.v9.services.types.CustomerUserAccessOperation):
...
class CustomerUserAccessOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v9.resources.types.CustomerUserAccess):
...
class MutateCustomerUserAccessResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v9.services.types.MutateCustomerUserAccessResult):
