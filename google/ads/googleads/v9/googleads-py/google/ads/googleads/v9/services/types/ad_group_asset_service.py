...
class GetAdGroupAssetRequest(proto.Message):
    ...
    [AdGroupAssetService.GetAdGroupAsset][google.ads.googleads.v9.services.AdGroupAssetService.GetAdGroupAsset].
...
class MutateAdGroupAssetsRequest(proto.Message):
    r"""Request message for
    [AdGroupAssetService.MutateAdGroupAssets][google.ads.googleads.v9.services.AdGroupAssetService.MutateAdGroupAssets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ad
            group assets are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.AdGroupAssetOperation]):
...
class AdGroupAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.AdGroupAsset):
            Create operation: No resource name is
            expected for the new ad group asset.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.AdGroupAsset):
...
class MutateAdGroupAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateAdGroupAssetResult]):
