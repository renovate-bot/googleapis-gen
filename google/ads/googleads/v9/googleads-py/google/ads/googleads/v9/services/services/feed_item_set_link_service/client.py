...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
    ...
    def get_feed_item_set_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetFeedItemSetLinkRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.FeedItemSetLink:
    ...
    def mutate_feed_item_set_links(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateFeedItemSetLinksRequest, dict]):
                The request object. Request message for
                [FeedItemSetLinkService.MutateFeedItemSetLinks][google.ads.googleads.v9.services.FeedItemSetLinkService.MutateFeedItemSetLinks].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.FeedItemSetLinkOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateFeedItemSetLinksResponse:
