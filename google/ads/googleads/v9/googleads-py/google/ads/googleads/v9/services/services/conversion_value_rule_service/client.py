...
from .transports.base import ConversionValueRuleServiceTransport, DEFAULT_CLIENT_INFO
...
class ConversionValueRuleServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ConversionValueRuleServiceTransport]]
...
class ConversionValueRuleServiceClient(metaclass=ConversionValueRuleServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        """Instantiate the conversion value rule service client.
        ...
        if isinstance(transport, ConversionValueRuleServiceTransport):
            ...
            self._transport = ConversionValueRuleServiceGrpcTransport(
    ...
    def get_conversion_value_rule(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetConversionValueRuleRequest, dict]):
            ...
            resource_name (:class:`str`):
                ...
                conversion value rule to fetch.
        ...
        Returns:
            google.ads.googleads.v9.resources.types.ConversionValueRule:
        ...
        # in a conversion_value_rule_service.GetConversionValueRuleRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, conversion_value_rule_service.GetConversionValueRuleRequest):
            request = conversion_value_rule_service.GetConversionValueRuleRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_conversion_value_rule]
    ...
    def mutate_conversion_value_rules(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateConversionValueRulesRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.ConversionValueRuleOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateConversionValueRulesResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, conversion_value_rule_service.MutateConversionValueRulesRequest):
            request = conversion_value_rule_service.MutateConversionValueRulesRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_conversion_value_rules]
