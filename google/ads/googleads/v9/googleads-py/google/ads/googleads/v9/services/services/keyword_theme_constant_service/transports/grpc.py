...
class KeywordThemeConstantServiceGrpcTransport(KeywordThemeConstantServiceTransport):
    ...
    @property
    def get_keyword_theme_constant(self) -> Callable[
            [keyword_theme_constant_service.GetKeywordThemeConstantRequest],
            keyword_theme_constant.KeywordThemeConstant]:
        r"""Return a callable for the get keyword theme constant method over gRPC.

        Returns the requested keyword theme constant in full
        detail.

        Returns:
            Callable[[~.GetKeywordThemeConstantRequest],
        ...
        if 'get_keyword_theme_constant' not in self._stubs:
            self._stubs['get_keyword_theme_constant'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v9.services.KeywordThemeConstantService/GetKeywordThemeConstant',
                request_serializer=keyword_theme_constant_service.GetKeywordThemeConstantRequest.serialize,
                response_deserializer=keyword_theme_constant.KeywordThemeConstant.deserialize,
            )
        return self._stubs['get_keyword_theme_constant']

    @property
    def suggest_keyword_theme_constants(self) -> Callable[
        ...
        if 'suggest_keyword_theme_constants' not in self._stubs:
            self._stubs['suggest_keyword_theme_constants'] = self.grpc_channel.unary_unary(
