...
class MutateBatchJobRequest(proto.Message):
    ...
    [BatchJobService.MutateBatchJob][google.ads.googleads.v9.services.BatchJobService.MutateBatchJob].

    Attributes:
        customer_id (str):
            Required. The ID of the customer for which to
            create a batch job.
        operation (google.ads.googleads.v9.services.types.BatchJobOperation):
...
class BatchJobOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v9.resources.types.BatchJob):
...
class MutateBatchJobResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v9.services.types.MutateBatchJobResult):
...
class GetBatchJobRequest(proto.Message):
    r"""Request message for
    [BatchJobService.GetBatchJob][google.ads.googleads.v9.services.BatchJobService.GetBatchJob].
...
class RunBatchJobRequest(proto.Message):
    r"""Request message for
    [BatchJobService.RunBatchJob][google.ads.googleads.v9.services.BatchJobService.RunBatchJob].
...
class AddBatchJobOperationsRequest(proto.Message):
    r"""Request message for
    [BatchJobService.AddBatchJobOperations][google.ads.googleads.v9.services.BatchJobService.AddBatchJobOperations].
...
class ListBatchJobResultsRequest(proto.Message):
    r"""Request message for
    [BatchJobService.ListBatchJobResults][google.ads.googleads.v9.services.BatchJobService.ListBatchJobResults].
...
class ListBatchJobResultsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.BatchJobResult]):
...
class BatchJobResult(proto.Message):
    ...
    Attributes:
        ...
        mutate_operation_response (google.ads.googleads.v9.services.types.MutateOperationResponse):
