...
from google.ads.googleads.v9.enums.types import product_bidding_category_status
...
class ProductBiddingCategoryConstant(proto.Message):
    ...
    Attributes:
        ...
        level (google.ads.googleads.v9.enums.types.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevel):
            Output only. Level of the product bidding
            category.
        status (google.ads.googleads.v9.enums.types.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus):
