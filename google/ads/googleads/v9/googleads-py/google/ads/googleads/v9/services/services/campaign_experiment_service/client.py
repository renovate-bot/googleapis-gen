...
from google.ads.googleads.v9.services.services.campaign_experiment_service import pagers
...
class CampaignExperimentServiceClient(metaclass=CampaignExperimentServiceClientMeta):
    ...
    def get_campaign_experiment(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCampaignExperimentRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CampaignExperiment:
    ...
    def create_campaign_experiment(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.CreateCampaignExperimentRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            campaign_experiment (:class:`google.ads.googleads.v9.resources.types.CampaignExperiment`):
    ...
    def mutate_campaign_experiments(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCampaignExperimentsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CampaignExperimentOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCampaignExperimentsResponse:
    ...
    def graduate_campaign_experiment(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GraduateCampaignExperimentRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.types.GraduateCampaignExperimentResponse:
                Response message for campaign
                experiment graduate.
    ...
    def promote_campaign_experiment(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.PromoteCampaignExperimentRequest, dict]):
                The request object. Request message for
    ...
    def end_campaign_experiment(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.EndCampaignExperimentRequest, dict]):
                The request object. Request message for
    ...
    def list_campaign_experiment_async_errors(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.ListCampaignExperimentAsyncErrorsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.services.campaign_experiment_service.pagers.ListCampaignExperimentAsyncErrorsPager:
