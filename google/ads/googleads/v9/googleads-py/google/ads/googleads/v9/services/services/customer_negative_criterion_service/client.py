...
class CustomerNegativeCriterionServiceClient(metaclass=CustomerNegativeCriterionServiceClientMeta):
    ...
    def transport(self) -> CustomerNegativeCriterionServiceTransport:
        ...
        Returns:
            CustomerNegativeCriterionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the customer negative criterion service client.
    ...
    def mutate_customer_negative_criteria(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v9.services.types.CustomerNegativeCriterionOperation]):
