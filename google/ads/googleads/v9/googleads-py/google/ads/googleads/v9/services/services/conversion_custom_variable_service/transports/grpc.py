...
class ConversionCustomVariableServiceGrpcTransport(ConversionCustomVariableServiceTransport):
    ...
    def get_conversion_custom_variable(self) -> Callable[
        ...
        if 'get_conversion_custom_variable' not in self._stubs:
            self._stubs['get_conversion_custom_variable'] = self.grpc_channel.unary_unary(
    ...
    def mutate_conversion_custom_variables(self) -> Callable[
        ...
        if 'mutate_conversion_custom_variables' not in self._stubs:
            self._stubs['mutate_conversion_custom_variables'] = self.grpc_channel.unary_unary(
