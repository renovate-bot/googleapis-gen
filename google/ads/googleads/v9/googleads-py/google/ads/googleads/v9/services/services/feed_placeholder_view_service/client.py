...
class FeedPlaceholderViewServiceClient(metaclass=FeedPlaceholderViewServiceClientMeta):
    ...
    def transport(self) -> FeedPlaceholderViewServiceTransport:
        ...
        Returns:
            FeedPlaceholderViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the feed placeholder view service client.
    ...
    def get_feed_placeholder_view(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetFeedPlaceholderViewRequest, dict]):
                The request object. Request message for
                [FeedPlaceholderViewService.GetFeedPlaceholderView][google.ads.googleads.v9.services.FeedPlaceholderViewService.GetFeedPlaceholderView].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.FeedPlaceholderView:
