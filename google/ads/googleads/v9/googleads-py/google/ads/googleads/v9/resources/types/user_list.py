...
from google.ads.googleads.v9.enums.types import access_reason as gage_access_reason
...
class UserList(proto.Message):
    ...
    Attributes:
        ...
        membership_status (google.ads.googleads.v9.enums.types.UserListMembershipStatusEnum.UserListMembershipStatus):
        ...
        size_range_for_display (google.ads.googleads.v9.enums.types.UserListSizeRangeEnum.UserListSizeRange):
        ...
        size_range_for_search (google.ads.googleads.v9.enums.types.UserListSizeRangeEnum.UserListSizeRange):
            Output only. Size range in terms of number of
            users of the UserList, for Search ads.
            This field is read-only.
        type_ (google.ads.googleads.v9.enums.types.UserListTypeEnum.UserListType):
            Output only. Type of this list.
            This field is read-only.
        closing_reason (google.ads.googleads.v9.enums.types.UserListClosingReasonEnum.UserListClosingReason):
        ...
        access_reason (google.ads.googleads.v9.enums.types.AccessReasonEnum.AccessReason):
            ...
            SUBSCRIBED.
            This field is read-only.
        account_user_list_status (google.ads.googleads.v9.enums.types.UserListAccessStatusEnum.UserListAccessStatus):
        ...
        crm_based_user_list (google.ads.googleads.v9.common.types.CrmBasedUserListInfo):
            User list of CRM users provided by the
            advertiser.

            This field is a member of `oneof`_ ``user_list``.
        similar_user_list (google.ads.googleads.v9.common.types.SimilarUserListInfo):
            ...
            This field is a member of `oneof`_ ``user_list``.
        rule_based_user_list (google.ads.googleads.v9.common.types.RuleBasedUserListInfo):
            User list generated by a rule.

            This field is a member of `oneof`_ ``user_list``.
        logical_user_list (google.ads.googleads.v9.common.types.LogicalUserListInfo):
            User list that is a custom combination of
            user lists and user interests.

            This field is a member of `oneof`_ ``user_list``.
        basic_user_list (google.ads.googleads.v9.common.types.BasicUserListInfo):
