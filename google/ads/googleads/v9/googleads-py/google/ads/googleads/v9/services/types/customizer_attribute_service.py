...
class MutateCustomizerAttributesRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.CustomizerAttributeOperation]):
...
class MutateCustomizerAttributesResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateCustomizerAttributeResult]):
