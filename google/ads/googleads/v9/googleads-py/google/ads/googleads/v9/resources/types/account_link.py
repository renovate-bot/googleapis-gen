...
from google.ads.googleads.v9.enums.types import account_link_status
from google.ads.googleads.v9.enums.types import linked_account_type
...
class AccountLink(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v9.enums.types.AccountLinkStatusEnum.AccountLinkStatus):
            The status of the link.
        type_ (google.ads.googleads.v9.enums.types.LinkedAccountTypeEnum.LinkedAccountType):
            Output only. The type of the linked account.
        third_party_app_analytics (google.ads.googleads.v9.resources.types.ThirdPartyAppAnalyticsLinkIdentifier):
            Immutable. A third party app analytics link.

            This field is a member of `oneof`_ ``linked_account``.
        data_partner (google.ads.googleads.v9.resources.types.DataPartnerLinkIdentifier):
            Output only. Data partner link.

            This field is a member of `oneof`_ ``linked_account``.
        google_ads (google.ads.googleads.v9.resources.types.GoogleAdsLinkIdentifier):
...
class ThirdPartyAppAnalyticsLinkIdentifier(proto.Message):
    ...
    Attributes:
        ...
        app_vendor (google.ads.googleads.v9.enums.types.MobileAppVendorEnum.MobileAppVendor):
