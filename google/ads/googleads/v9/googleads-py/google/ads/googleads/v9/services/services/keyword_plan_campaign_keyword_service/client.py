...
class KeywordPlanCampaignKeywordServiceClient(metaclass=KeywordPlanCampaignKeywordServiceClientMeta):
    ...
    def get_keyword_plan_campaign_keyword(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetKeywordPlanCampaignKeywordRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.KeywordPlanCampaignKeyword:
    ...
    def mutate_keyword_plan_campaign_keywords(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateKeywordPlanCampaignKeywordsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.KeywordPlanCampaignKeywordOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateKeywordPlanCampaignKeywordsResponse:
