...
from google.ads.googleads.v9.resources.types import ad_group_simulation
from google.ads.googleads.v9.services.types import ad_group_simulation_service
...
class AdGroupSimulationServiceGrpcTransport(AdGroupSimulationServiceTransport):
    ...
    @property
    def get_ad_group_simulation(self) -> Callable[
            [ad_group_simulation_service.GetAdGroupSimulationRequest],
            ad_group_simulation.AdGroupSimulation]:
        r"""Return a callable for the get ad group simulation method over gRPC.
        ...
        if 'get_ad_group_simulation' not in self._stubs:
            self._stubs['get_ad_group_simulation'] = self.grpc_channel.unary_unary(
