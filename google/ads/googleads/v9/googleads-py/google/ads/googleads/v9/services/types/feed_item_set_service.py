...
class GetFeedItemSetRequest(proto.Message):
    ...
    [FeedItemSetService.GetFeedItemSet][google.ads.googleads.v9.services.FeedItemSetService.GetFeedItemSet].
...
class MutateFeedItemSetsRequest(proto.Message):
    r"""Request message for
    [FeedItemSetService.MutateFeedItemSets][google.ads.googleads.v9.services.FeedItemSetService.MutateFeedItemSets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose feed
            item sets are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.FeedItemSetOperation]):
...
class FeedItemSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.FeedItemSet):
            Create operation: No resource name is
            expected for the new feed item set
            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.FeedItemSet):
...
class MutateFeedItemSetsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateFeedItemSetResult]):
