...
class CampaignBudgetServiceClient(metaclass=CampaignBudgetServiceClientMeta):
    ...
    def get_campaign_budget(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCampaignBudgetRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CampaignBudget:
                A campaign budget.
        """
    ...
    def mutate_campaign_budgets(self,
        ...
        r"""Creates, updates, or removes campaign budgets. Operation
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCampaignBudgetsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CampaignBudgetOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCampaignBudgetsResponse:
