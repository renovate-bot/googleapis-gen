...
class ConversionActionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.ConversionAction):
            Create operation: No resource name is
            expected for the new conversion action.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.ConversionAction):
...
class MutateConversionActionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateConversionActionResult]):
