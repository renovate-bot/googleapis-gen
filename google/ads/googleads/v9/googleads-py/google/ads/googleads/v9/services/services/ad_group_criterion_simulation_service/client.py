...
from google.ads.googleads.v9.resources.types import ad_group_criterion_simulation
from google.ads.googleads.v9.services.types import ad_group_criterion_simulation_service
from .transports.base import AdGroupCriterionSimulationServiceTransport, DEFAULT_CLIENT_INFO
...
class AdGroupCriterionSimulationServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AdGroupCriterionSimulationServiceTransport]]
...
class AdGroupCriterionSimulationServiceClient(metaclass=AdGroupCriterionSimulationServiceClientMeta):
    ...
    def transport(self) -> AdGroupCriterionSimulationServiceTransport:
        ...
        Returns:
            AdGroupCriterionSimulationServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, AdGroupCriterionSimulationServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the ad group criterion simulation service client.
    ...
    def get_ad_group_criterion_simulation(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetAdGroupCriterionSimulationRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.AdGroupCriterionSimulation:
        ...
        if not isinstance(request, ad_group_criterion_simulation_service.GetAdGroupCriterionSimulationRequest):
            request = ad_group_criterion_simulation_service.GetAdGroupCriterionSimulationRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_ad_group_criterion_simulation]
