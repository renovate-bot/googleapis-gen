...
from .transports.base import ConversionAdjustmentUploadServiceTransport, DEFAULT_CLIENT_INFO
...
class ConversionAdjustmentUploadServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ConversionAdjustmentUploadServiceTransport]]
...
class ConversionAdjustmentUploadServiceClient(metaclass=ConversionAdjustmentUploadServiceClientMeta):
    ...
    def transport(self) -> ConversionAdjustmentUploadServiceTransport:
        ...
        Returns:
            ConversionAdjustmentUploadServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, ConversionAdjustmentUploadServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the conversion adjustment upload service client.
    ...
    def upload_conversion_adjustments(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.UploadConversionAdjustmentsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            conversion_adjustments (Sequence[google.ads.googleads.v9.services.types.ConversionAdjustment]):
        ...
        Returns:
            google.ads.googleads.v9.services.types.UploadConversionAdjustmentsResponse:
        ...
        has_flattened_params = any([customer_id, conversion_adjustments, partial_failure])
        ...
        if not isinstance(request, conversion_adjustment_upload_service.UploadConversionAdjustmentsRequest):
            request = conversion_adjustment_upload_service.UploadConversionAdjustmentsRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.upload_conversion_adjustments]
