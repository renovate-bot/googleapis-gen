...
class KeywordPlan(proto.Message):
    ...
    Attributes:
        ...
        forecast_period (google.ads.googleads.v9.resources.types.KeywordPlanForecastPeriod):
...
class KeywordPlanForecastPeriod(proto.Message):
    ...
    Attributes:
        date_interval (google.ads.googleads.v9.enums.types.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval):
