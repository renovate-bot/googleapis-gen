...
class CampaignExperiment(proto.Message):
    ...
    Attributes:
        ...
        traffic_split_type (google.ads.googleads.v9.enums.types.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType):
        ...
        status (google.ads.googleads.v9.enums.types.CampaignExperimentStatusEnum.CampaignExperimentStatus):
