...
class OfflineUserDataJob(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v9.enums.types.OfflineUserDataJobTypeEnum.OfflineUserDataJobType):
            Immutable. Type of the job.
        status (google.ads.googleads.v9.enums.types.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus):
            Output only. Status of the job.
        failure_reason (google.ads.googleads.v9.enums.types.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason):
            Output only. Reason for the processing
            failure, if status is FAILED.
        operation_metadata (google.ads.googleads.v9.resources.types.OfflineUserDataJobMetadata):
        ...
        store_sales_metadata (google.ads.googleads.v9.common.types.StoreSalesMetadata):
...
class OfflineUserDataJobMetadata(proto.Message):
    ...
    Attributes:
        match_rate_range (google.ads.googleads.v9.enums.types.OfflineUserDataJobMatchRateRangeEnum.OfflineUserDataJobMatchRateRange):
