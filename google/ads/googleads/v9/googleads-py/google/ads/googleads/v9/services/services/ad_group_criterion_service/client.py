...
class AdGroupCriterionServiceClient(metaclass=AdGroupCriterionServiceClientMeta):
    ...
    def get_ad_group_criterion(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetAdGroupCriterionRequest, dict]):
                The request object. Request message for
                [AdGroupCriterionService.GetAdGroupCriterion][google.ads.googleads.v9.services.AdGroupCriterionService.GetAdGroupCriterion].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.AdGroupCriterion:
    ...
    def mutate_ad_group_criteria(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateAdGroupCriteriaRequest, dict]):
                The request object. Request message for
                [AdGroupCriterionService.MutateAdGroupCriteria][google.ads.googleads.v9.services.AdGroupCriterionService.MutateAdGroupCriteria].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.AdGroupCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateAdGroupCriteriaResponse:
