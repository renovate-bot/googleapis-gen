...
class ClickView(proto.Message):
    ...
    Attributes:
        ...
        area_of_interest (google.ads.googleads.v9.common.types.ClickLocation):
            Output only. The location criteria matching
            the area of interest associated with the
            impression.
        location_of_presence (google.ads.googleads.v9.common.types.ClickLocation):
            Output only. The location criteria matching
        ...
        keyword (str):
            ...
            channel.
        keyword_info (google.ads.googleads.v9.common.types.KeywordInfo):
