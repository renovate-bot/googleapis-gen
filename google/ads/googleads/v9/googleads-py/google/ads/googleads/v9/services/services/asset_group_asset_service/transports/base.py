...
class AssetGroupAssetServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_asset_group_asset: gapic_v1.method.wrap_method(
                self.get_asset_group_asset,
    ...
    @property
    def get_asset_group_asset(self) -> Callable[
            [asset_group_asset_service.GetAssetGroupAssetRequest],
            Union[
                asset_group_asset.AssetGroupAsset,
                Awaitable[asset_group_asset.AssetGroupAsset]
            ]]:
        raise NotImplementedError()

    @property
    def mutate_asset_group_assets(self) -> Callable[
