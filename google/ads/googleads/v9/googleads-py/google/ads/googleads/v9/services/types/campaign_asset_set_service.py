...
class MutateCampaignAssetSetsRequest(proto.Message):
    ...
    [CampaignAssetSetService.MutateCampaignAssetSets][google.ads.googleads.v9.services.CampaignAssetSetService.MutateCampaignAssetSets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign asset sets are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.CampaignAssetSetOperation]):
...
class CampaignAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v9.resources.types.CampaignAssetSet):
...
class MutateCampaignAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateCampaignAssetSetResult]):
