...
from google.ads.googleads.v9.services.types import user_data_service
...
class UserDataServiceGrpcTransport(UserDataServiceTransport):
    ...
    @property
    def upload_user_data(self) -> Callable[
        ...
        if 'upload_user_data' not in self._stubs:
            self._stubs['upload_user_data'] = self.grpc_channel.unary_unary(
