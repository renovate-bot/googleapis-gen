...
class CustomerClientServiceClient(metaclass=CustomerClientServiceClientMeta):
    ...
    def get_customer_client(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCustomerClientRequest, dict]):
                The request object. Request message for
                [CustomerClientService.GetCustomerClient][google.ads.googleads.v9.services.CustomerClientService.GetCustomerClient].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CustomerClient:
