...
class MutateCustomerCustomizersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.CustomerCustomizerOperation]):
...
class MutateCustomerCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateCustomerCustomizerResult]):
