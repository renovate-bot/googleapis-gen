...
from .transports.base import BiddingStrategyServiceTransport, DEFAULT_CLIENT_INFO
...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def get_bidding_strategy(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetBiddingStrategyRequest, dict]):
                The request object. Request message for
                [BiddingStrategyService.GetBiddingStrategy][google.ads.googleads.v9.services.BiddingStrategyService.GetBiddingStrategy].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.BiddingStrategy:
                A bidding strategy.
        """
        ...
        if not isinstance(request, bidding_strategy_service.GetBiddingStrategyRequest):
            request = bidding_strategy_service.GetBiddingStrategyRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_bidding_strategy]
    ...
    def mutate_bidding_strategies(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateBiddingStrategiesRequest, dict]):
                The request object. Request message for
                [BiddingStrategyService.MutateBiddingStrategies][google.ads.googleads.v9.services.BiddingStrategyService.MutateBiddingStrategies].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.BiddingStrategyOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateBiddingStrategiesResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, bidding_strategy_service.MutateBiddingStrategiesRequest):
            request = bidding_strategy_service.MutateBiddingStrategiesRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_bidding_strategies]
