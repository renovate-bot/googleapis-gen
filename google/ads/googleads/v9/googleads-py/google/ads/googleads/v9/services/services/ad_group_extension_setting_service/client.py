...
class AdGroupExtensionSettingServiceClient(metaclass=AdGroupExtensionSettingServiceClientMeta):
    ...
    def transport(self) -> AdGroupExtensionSettingServiceTransport:
        ...
        Returns:
            AdGroupExtensionSettingServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the ad group extension setting service client.
    ...
    def get_ad_group_extension_setting(self,
        ...
        r"""Returns the requested ad group extension setting in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetAdGroupExtensionSettingRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.AdGroupExtensionSetting:
    ...
    def mutate_ad_group_extension_settings(self,
        ...
        r"""Creates, updates, or removes ad group extension settings.
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateAdGroupExtensionSettingsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v9.services.types.AdGroupExtensionSettingOperation]):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateAdGroupExtensionSettingsResponse:
