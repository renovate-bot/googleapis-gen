...
class BillingSetupServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[BillingSetupServiceTransport]]
...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    def get_billing_setup(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetBillingSetupRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.BillingSetup:
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_billing_setup]
    ...
    def mutate_billing_setup(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateBillingSetupRequest, dict]):
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v9.services.types.BillingSetupOperation`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateBillingSetupResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_billing_setup]
