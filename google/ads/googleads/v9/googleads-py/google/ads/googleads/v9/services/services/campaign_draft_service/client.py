...
class CampaignDraftServiceClient(metaclass=CampaignDraftServiceClientMeta):
    ...
    def get_campaign_draft(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCampaignDraftRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CampaignDraft:
                A campaign draft.
        """
    ...
    def mutate_campaign_drafts(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCampaignDraftsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CampaignDraftOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCampaignDraftsResponse:
    ...
    def promote_campaign_draft(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.PromoteCampaignDraftRequest, dict]):
                The request object. Request message for
    ...
    def list_campaign_draft_async_errors(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.ListCampaignDraftAsyncErrorsRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v9.services.CampaignDraftService.ListCampaignDraftAsyncErrors].
            resource_name (:class:`str`):
        ...
        Returns:
            google.ads.googleads.v9.services.services.campaign_draft_service.pagers.ListCampaignDraftAsyncErrorsPager:
