...
class SharedSet(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v9.enums.types.SharedSetTypeEnum.SharedSetType):
        ...
        status (google.ads.googleads.v9.enums.types.SharedSetStatusEnum.SharedSetStatus):
