...
class LocationViewServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[LocationViewServiceTransport]]
...
class LocationViewServiceClient(metaclass=LocationViewServiceClientMeta):
    ...
    def transport(self) -> LocationViewServiceTransport:
        ...
        Returns:
            LocationViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the location view service client.
    ...
    def get_location_view(self,
            request: Union[location_view_service.GetLocationViewRequest, dict] = None,
            *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetLocationViewRequest, dict]):
                The request object. Request message for
                [LocationViewService.GetLocationView][google.ads.googleads.v9.services.LocationViewService.GetLocationView].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.LocationView:
        ...
        if not isinstance(request, location_view_service.GetLocationViewRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_location_view]
