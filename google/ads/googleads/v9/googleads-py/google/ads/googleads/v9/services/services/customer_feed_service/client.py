...
class CustomerFeedServiceClient(metaclass=CustomerFeedServiceClientMeta):
    ...
    def get_customer_feed(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCustomerFeedRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CustomerFeed:
                A customer feed.
        """
    ...
    def mutate_customer_feeds(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomerFeedsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CustomerFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomerFeedsResponse:
