...
class GetAdGroupBidModifierRequest(proto.Message):
    ...
    [AdGroupBidModifierService.GetAdGroupBidModifier][google.ads.googleads.v9.services.AdGroupBidModifierService.GetAdGroupBidModifier].
...
class MutateAdGroupBidModifiersRequest(proto.Message):
    r"""Request message for
    [AdGroupBidModifierService.MutateAdGroupBidModifiers][google.ads.googleads.v9.services.AdGroupBidModifierService.MutateAdGroupBidModifiers].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose ad group
            bid modifiers are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.AdGroupBidModifierOperation]):
...
class MutateAdGroupBidModifiersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateAdGroupBidModifierResult]):
