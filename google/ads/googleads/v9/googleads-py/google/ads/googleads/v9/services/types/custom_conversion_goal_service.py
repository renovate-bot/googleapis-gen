...
class MutateCustomConversionGoalsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.CustomConversionGoalOperation]):
...
class CustomConversionGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.CustomConversionGoal):
            Create operation: No resource name is
            expected for the new custom conversion goal
            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.CustomConversionGoal):
...
class MutateCustomConversionGoalsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateCustomConversionGoalResult]):
