...
class AdGroupFeedServiceClient(metaclass=AdGroupFeedServiceClientMeta):
    ...
    def transport(self) -> AdGroupFeedServiceTransport:
        ...
        Returns:
            AdGroupFeedServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the ad group feed service client.
    ...
    def get_ad_group_feed(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetAdGroupFeedRequest, dict]):
                The request object. Request message for
                [AdGroupFeedService.GetAdGroupFeed][google.ads.googleads.v9.services.AdGroupFeedService.GetAdGroupFeed].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.AdGroupFeed:
                An ad group feed.
        """
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_ad_group_feed]
    ...
    def mutate_ad_group_feeds(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateAdGroupFeedsRequest, dict]):
                The request object. Request message for
                [AdGroupFeedService.MutateAdGroupFeeds][google.ads.googleads.v9.services.AdGroupFeedService.MutateAdGroupFeeds].
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v9.services.types.AdGroupFeedOperation]):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateAdGroupFeedsResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, ad_group_feed_service.MutateAdGroupFeedsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_ad_group_feeds]
