...
from google.ads.googleads.v9.resources.types import payments_account
from google.ads.googleads.v9.services.types import payments_account_service
...
class PaymentsAccountServiceClient(metaclass=PaymentsAccountServiceClientMeta):
    ...
    def transport(self) -> PaymentsAccountServiceTransport:
        ...
        Returns:
            PaymentsAccountServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the payments account service client.
    ...
    def list_payments_accounts(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.ListPaymentsAccountsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.services.types.ListPaymentsAccountsResponse:
                Response message for
                [PaymentsAccountService.ListPaymentsAccounts][google.ads.googleads.v9.services.PaymentsAccountService.ListPaymentsAccounts].

        """
        # Create or coerce a protobuf request object.
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([customer_id])
