...
class ConversionValueRuleSet(proto.Message):
    ...
    Attributes:
        ...
        dimensions (Sequence[google.ads.googleads.v9.enums.types.ValueRuleSetDimensionEnum.ValueRuleSetDimension]):
        ...
        owner_customer (str):
            ...
            \*\* Read-only \*\*
        attachment_type (google.ads.googleads.v9.enums.types.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType):
        ...
        campaign (str):
            ...
            campaign.
        status (google.ads.googleads.v9.enums.types.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus):
