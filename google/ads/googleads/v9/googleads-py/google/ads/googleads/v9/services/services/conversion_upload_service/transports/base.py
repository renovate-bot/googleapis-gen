...
class ConversionUploadServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for ConversionUploadService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.upload_click_conversions: gapic_v1.method.wrap_method(
                self.upload_click_conversions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.upload_call_conversions: gapic_v1.method.wrap_method(
    ...
    @property
    def upload_call_conversions(self) -> typing.Callable[
