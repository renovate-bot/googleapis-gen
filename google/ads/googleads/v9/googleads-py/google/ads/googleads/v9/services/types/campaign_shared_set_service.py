...
class GetCampaignSharedSetRequest(proto.Message):
    ...
    [CampaignSharedSetService.GetCampaignSharedSet][google.ads.googleads.v9.services.CampaignSharedSetService.GetCampaignSharedSet].
...
class MutateCampaignSharedSetsRequest(proto.Message):
    r"""Request message for
    [CampaignSharedSetService.MutateCampaignSharedSets][google.ads.googleads.v9.services.CampaignSharedSetService.MutateCampaignSharedSets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign shared sets are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.CampaignSharedSetOperation]):
...
class CampaignSharedSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v9.resources.types.CampaignSharedSet):
...
class MutateCampaignSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateCampaignSharedSetResult]):
