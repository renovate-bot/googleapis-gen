...
class BidModifierSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v9.common.types.BidModifierSimulationPoint]):
...
class CpcBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v9.common.types.CpcBidSimulationPoint]):
...
class CpvBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v9.common.types.CpvBidSimulationPoint]):
...
class TargetCpaSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v9.common.types.TargetCpaSimulationPoint]):
...
class TargetRoasSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v9.common.types.TargetRoasSimulationPoint]):
...
class PercentCpcBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v9.common.types.PercentCpcBidSimulationPoint]):
...
class BudgetSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v9.common.types.BudgetSimulationPoint]):
...
class TargetImpressionShareSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v9.common.types.TargetImpressionShareSimulationPoint]):
