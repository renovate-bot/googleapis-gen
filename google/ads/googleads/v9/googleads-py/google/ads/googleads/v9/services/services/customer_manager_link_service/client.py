...
from google.ads.googleads.v9.resources.types import customer_manager_link
from google.ads.googleads.v9.services.types import customer_manager_link_service
...
class CustomerManagerLinkServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CustomerManagerLinkServiceTransport]]
...
class CustomerManagerLinkServiceClient(metaclass=CustomerManagerLinkServiceClientMeta):
    ...
    def get_customer_manager_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCustomerManagerLinkRequest, dict]):
                The request object. Request message for
                [CustomerManagerLinkService.GetCustomerManagerLink][google.ads.googleads.v9.services.CustomerManagerLinkService.GetCustomerManagerLink].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CustomerManagerLink:
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_customer_manager_link]
    ...
    def mutate_customer_manager_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomerManagerLinkRequest, dict]):
                The request object. Request message for
                [CustomerManagerLinkService.MutateCustomerManagerLink][google.ads.googleads.v9.services.CustomerManagerLinkService.MutateCustomerManagerLink].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CustomerManagerLinkOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomerManagerLinkResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_customer_manager_link]
    ...
    def move_manager_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MoveManagerLinkRequest, dict]):
                The request object. Request message for
                [CustomerManagerLinkService.MoveManagerLink][google.ads.googleads.v9.services.CustomerManagerLinkService.MoveManagerLink].
            customer_id (:class:`str`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MoveManagerLinkResponse:
                Response message for a
        ...
        if not isinstance(request, customer_manager_link_service.MoveManagerLinkRequest):
            ...
            if previous_customer_manager_link is not None:
                request.previous_customer_manager_link = previous_customer_manager_link
            if new_manager is not None:
                request.new_manager = new_manager

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.move_manager_link]
