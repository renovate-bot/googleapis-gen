...
class ExtensionFeedItemServiceTransport(abc.ABC):
    """Abstract transport class for ExtensionFeedItemService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_extension_feed_item: gapic_v1.method.wrap_method(
                self.get_extension_feed_item,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_extension_feed_items: gapic_v1.method.wrap_method(
                self.mutate_extension_feed_items,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    def get_extension_feed_item(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[extension_feed_item.ExtensionFeedItem]
            ]]:
        raise NotImplementedError()
