...
class MutateCustomerLabelsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.CustomerLabelOperation]):
...
class CustomerLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v9.resources.types.CustomerLabel):
...
class MutateCustomerLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateCustomerLabelResult]):
