...
class GetAdParameterRequest(proto.Message):
    ...
    [AdParameterService.GetAdParameter][google.ads.googleads.v9.services.AdParameterService.GetAdParameter]
...
class MutateAdParametersRequest(proto.Message):
    r"""Request message for
    [AdParameterService.MutateAdParameters][google.ads.googleads.v9.services.AdParameterService.MutateAdParameters]

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ad
            parameters are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.AdParameterOperation]):
...
class AdParameterOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.AdParameter):
            Create operation: No resource name is
            expected for the new ad parameter.
            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.AdParameter):
...
class MutateAdParametersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateAdParameterResult]):
