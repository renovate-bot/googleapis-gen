...
class AssetSetAssetServiceClient(metaclass=AssetSetAssetServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, AssetSetAssetServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the asset set asset service client.
        ...
        if isinstance(transport, AssetSetAssetServiceTransport):
            ...
            self._transport = AssetSetAssetServiceGrpcTransport(
    ...
    def mutate_asset_set_assets(self,
            request: Union[asset_set_asset_service.MutateAssetSetAssetsRequest, dict] = None,
            *,
            customer_id: str = None,
            operations: Sequence[asset_set_asset_service.AssetSetAssetOperation] = None,
        ...
        # in a asset_set_asset_service.MutateAssetSetAssetsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, asset_set_asset_service.MutateAssetSetAssetsRequest):
            request = asset_set_asset_service.MutateAssetSetAssetsRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.mutate_asset_set_assets]
