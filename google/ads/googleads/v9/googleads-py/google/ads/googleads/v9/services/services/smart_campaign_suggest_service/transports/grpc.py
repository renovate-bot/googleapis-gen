...
class SmartCampaignSuggestServiceGrpcTransport(SmartCampaignSuggestServiceTransport):
    ...
    def suggest_smart_campaign_budget_options(self) -> Callable[
        ...
        if 'suggest_smart_campaign_budget_options' not in self._stubs:
            self._stubs['suggest_smart_campaign_budget_options'] = self.grpc_channel.unary_unary(
    ...
    def suggest_smart_campaign_ad(self) -> Callable[
        ...
        if 'suggest_smart_campaign_ad' not in self._stubs:
            self._stubs['suggest_smart_campaign_ad'] = self.grpc_channel.unary_unary(
    ...
    def suggest_keyword_themes(self) -> Callable[
        ...
        if 'suggest_keyword_themes' not in self._stubs:
            self._stubs['suggest_keyword_themes'] = self.grpc_channel.unary_unary(
