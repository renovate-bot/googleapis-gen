...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def get_feed_item_target(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetFeedItemTargetRequest, dict]):
                The request object. Request message for
                [FeedItemTargetService.GetFeedItemTarget][google.ads.googleads.v9.services.FeedItemTargetService.GetFeedItemTarget].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.FeedItemTarget:
                A feed item target.
        """
    ...
    def mutate_feed_item_targets(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateFeedItemTargetsRequest, dict]):
                The request object. Request message for
                [FeedItemTargetService.MutateFeedItemTargets][google.ads.googleads.v9.services.FeedItemTargetService.MutateFeedItemTargets].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.FeedItemTargetOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateFeedItemTargetsResponse:
