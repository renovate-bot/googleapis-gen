...
class GenerateKeywordIdeasPager:
    ...
    :class:`google.ads.googleads.v9.services.types.GenerateKeywordIdeaResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v9.services.types.GenerateKeywordIdeaResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (:class:`google.ads.googleads.v9.services.types.GenerateKeywordIdeasRequest`):
                The initial request object.
            response (:class:`google.ads.googleads.v9.services.types.GenerateKeywordIdeaResponse`):
