...
class AssetGroupListingGroupFilterOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.AssetGroupListingGroupFilter):
...
class MutateAssetGroupListingGroupFiltersResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateAssetGroupListingGroupFilterResult]):
