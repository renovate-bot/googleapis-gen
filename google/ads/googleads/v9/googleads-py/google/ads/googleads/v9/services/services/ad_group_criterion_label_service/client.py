...
class AdGroupCriterionLabelServiceClient(metaclass=AdGroupCriterionLabelServiceClientMeta):
    ...
    def get_ad_group_criterion_label(self,
        ...
        r"""Returns the requested ad group criterion label in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetAdGroupCriterionLabelRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.AdGroupCriterionLabel:
    ...
    def mutate_ad_group_criterion_labels(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateAdGroupCriterionLabelsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.AdGroupCriterionLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateAdGroupCriterionLabelsResponse:
