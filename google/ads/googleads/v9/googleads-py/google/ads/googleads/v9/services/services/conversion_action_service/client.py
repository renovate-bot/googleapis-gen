...
from .transports.base import ConversionActionServiceTransport, DEFAULT_CLIENT_INFO
...
class ConversionActionServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ConversionActionServiceTransport]]
...
class ConversionActionServiceClient(metaclass=ConversionActionServiceClientMeta):
    ...
    def get_conversion_action(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetConversionActionRequest, dict]):
                The request object. Request message for
                [ConversionActionService.GetConversionAction][google.ads.googleads.v9.services.ConversionActionService.GetConversionAction].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.ConversionAction:
                A conversion action.
        """
        ...
        if not isinstance(request, conversion_action_service.GetConversionActionRequest):
            request = conversion_action_service.GetConversionActionRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_conversion_action]
    ...
    def mutate_conversion_actions(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateConversionActionsRequest, dict]):
                The request object. Request message for
                [ConversionActionService.MutateConversionActions][google.ads.googleads.v9.services.ConversionActionService.MutateConversionActions].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.ConversionActionOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateConversionActionsResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, conversion_action_service.MutateConversionActionsRequest):
            request = conversion_action_service.MutateConversionActionsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_conversion_actions]
