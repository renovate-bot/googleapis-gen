...
class CustomConversionGoalServiceGrpcTransport(CustomConversionGoalServiceTransport):
    """gRPC backend transport for CustomConversionGoalService.
    ...
    @property
    def mutate_custom_conversion_goals(self) -> Callable[
        ...
        if 'mutate_custom_conversion_goals' not in self._stubs:
            self._stubs['mutate_custom_conversion_goals'] = self.grpc_channel.unary_unary(
