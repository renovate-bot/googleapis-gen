...
class CampaignExperimentServiceGrpcTransport(CampaignExperimentServiceTransport):
    ...
    def get_campaign_experiment(self) -> Callable[
        ...
        if 'get_campaign_experiment' not in self._stubs:
            self._stubs['get_campaign_experiment'] = self.grpc_channel.unary_unary(
    ...
    def mutate_campaign_experiments(self) -> Callable[
        ...
        if 'mutate_campaign_experiments' not in self._stubs:
            self._stubs['mutate_campaign_experiments'] = self.grpc_channel.unary_unary(
    ...
    def graduate_campaign_experiment(self) -> Callable[
        ...
        if 'graduate_campaign_experiment' not in self._stubs:
            self._stubs['graduate_campaign_experiment'] = self.grpc_channel.unary_unary(
    ...
    def list_campaign_experiment_async_errors(self) -> Callable[
        ...
        if 'list_campaign_experiment_async_errors' not in self._stubs:
            self._stubs['list_campaign_experiment_async_errors'] = self.grpc_channel.unary_unary(
