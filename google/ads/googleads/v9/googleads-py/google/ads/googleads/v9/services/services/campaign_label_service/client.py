...
class CampaignLabelServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CampaignLabelServiceTransport]]
...
class CampaignLabelServiceClient(metaclass=CampaignLabelServiceClientMeta):
    ...
    def transport(self) -> CampaignLabelServiceTransport:
        ...
        Returns:
            CampaignLabelServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, CampaignLabelServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the campaign label service client.
        ...
        Args:
            ...
            transport (Union[str, ~.CampaignLabelServiceTransport]): The
        ...
        if isinstance(transport, CampaignLabelServiceTransport):
            ...
            self._transport = CampaignLabelServiceGrpcTransport(
    ...
    def get_campaign_label(self,
        ...
        r"""Returns the requested campaign-label relationship in full
        detail.
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCampaignLabelRequest, dict]):
                The request object. Request message for
                [CampaignLabelService.GetCampaignLabel][google.ads.googleads.v9.services.CampaignLabelService.GetCampaignLabel].
            resource_name (:class:`str`):
                Required. The resource name of the
                campaign-label relationship to fetch.
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CampaignLabel:
                Represents a relationship between a
                campaign and a label.
        ...
        # in a campaign_label_service.GetCampaignLabelRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, campaign_label_service.GetCampaignLabelRequest):
            request = campaign_label_service.GetCampaignLabelRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_campaign_label]
    ...
    def mutate_campaign_labels(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCampaignLabelsRequest, dict]):
                The request object. Request message for
                [CampaignLabelService.MutateCampaignLabels][google.ads.googleads.v9.services.CampaignLabelService.MutateCampaignLabels].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CampaignLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCampaignLabelsResponse:
        ...
        if request is not None and any([customer_id, operations]):
           ...
           # Minor optimization to avoid making a copy if the user passes
        # in a campaign_label_service.MutateCampaignLabelsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, campaign_label_service.MutateCampaignLabelsRequest):
            request = campaign_label_service.MutateCampaignLabelsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_campaign_labels]
