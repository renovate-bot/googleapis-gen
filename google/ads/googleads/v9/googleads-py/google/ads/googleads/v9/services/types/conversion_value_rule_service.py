...
class ConversionValueRuleOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.ConversionValueRule):
            Create operation: No resource name is
            expected for the new conversion value rule.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.ConversionValueRule):
...
class MutateConversionValueRulesResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateConversionValueRuleResult]):
