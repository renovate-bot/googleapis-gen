...
class KeywordPlanAdGroupServiceClient(metaclass=KeywordPlanAdGroupServiceClientMeta):
    ...
    def transport(self) -> KeywordPlanAdGroupServiceTransport:
        ...
        Returns:
            KeywordPlanAdGroupServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the keyword plan ad group service client.
    ...
    def get_keyword_plan_ad_group(self,
        ...
        r"""Returns the requested Keyword Plan ad group in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetKeywordPlanAdGroupRequest, dict]):
                The request object. Request message for
                [KeywordPlanAdGroupService.GetKeywordPlanAdGroup][google.ads.googleads.v9.services.KeywordPlanAdGroupService.GetKeywordPlanAdGroup].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.KeywordPlanAdGroup:
    ...
    def mutate_keyword_plan_ad_groups(self,
        ...
        r"""Creates, updates, or removes Keyword Plan ad groups. Operation
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateKeywordPlanAdGroupsRequest, dict]):
                The request object. Request message for
                [KeywordPlanAdGroupService.MutateKeywordPlanAdGroups][google.ads.googleads.v9.services.KeywordPlanAdGroupService.MutateKeywordPlanAdGroups].
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v9.services.types.KeywordPlanAdGroupOperation]):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateKeywordPlanAdGroupsResponse:
