...
class CustomerUserAccessServiceTransport(metaclass=abc.ABCMeta):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_customer_user_access: gapic_v1.method.wrap_method(
                self.get_customer_user_access,
    ...
    @property
    def get_customer_user_access(self) -> typing.Callable[
            [customer_user_access_service.GetCustomerUserAccessRequest],
            customer_user_access.CustomerUserAccess]:
        raise NotImplementedError

    @property
    def mutate_customer_user_access(self) -> typing.Callable[
