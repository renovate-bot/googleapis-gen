...
class CampaignConversionGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v9.resources.types.CampaignConversionGoal):
...
class MutateCampaignConversionGoalsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateCampaignConversionGoalResult]):
