...
class AssetGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.AssetGroup):
            Create operation: No resource name is
            expected for the new asset group

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.AssetGroup):
...
class MutateAssetGroupsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateAssetGroupResult]):
