...
from google.ads.googleads.v9.common.types import text_label as gagc_text_label
...
class Label(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v9.enums.types.LabelStatusEnum.LabelStatus):
            Output only. Status of the label. Read only.
        text_label (google.ads.googleads.v9.common.types.TextLabel):
