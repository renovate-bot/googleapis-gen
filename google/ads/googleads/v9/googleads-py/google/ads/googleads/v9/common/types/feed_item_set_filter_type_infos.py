...
class DynamicLocationSetFilter(proto.Message):
    ...
    Attributes:
        ...
        business_name_filter (google.ads.googleads.v9.common.types.BusinessNameFilter):
...
class BusinessNameFilter(proto.Message):
    ...
    Attributes:
        ...
        filter_type (google.ads.googleads.v9.enums.types.FeedItemSetStringFilterTypeEnum.FeedItemSetStringFilterType):
