...
from google.ads.googleads.v9.common.types import click_location
...
class ClickViewServiceClient(metaclass=ClickViewServiceClientMeta):
    ...
    def transport(self) -> ClickViewServiceTransport:
        ...
        Returns:
            ClickViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the click view service client.
    ...
    def get_click_view(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetClickViewRequest, dict]):
                The request object. Request message for
                [ClickViewService.GetClickView][google.ads.googleads.v9.services.ClickViewService.GetClickView].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.ClickView:
