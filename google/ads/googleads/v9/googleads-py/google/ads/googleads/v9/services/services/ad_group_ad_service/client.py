...
class AdGroupAdServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AdGroupAdServiceTransport]]
...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
    ...
    def transport(self) -> AdGroupAdServiceTransport:
        ...
        Returns:
            AdGroupAdServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the ad group ad service client.
    ...
    def get_ad_group_ad(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetAdGroupAdRequest, dict]):
                The request object. Request message for
                [AdGroupAdService.GetAdGroupAd][google.ads.googleads.v9.services.AdGroupAdService.GetAdGroupAd].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.AdGroupAd:
                An ad group ad.
        """
    ...
    def mutate_ad_group_ads(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateAdGroupAdsRequest, dict]):
                The request object. Request message for
                [AdGroupAdService.MutateAdGroupAds][google.ads.googleads.v9.services.AdGroupAdService.MutateAdGroupAds].
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v9.services.types.AdGroupAdOperation]):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateAdGroupAdsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_ad_group_ads]
