...
class GetCampaignFeedRequest(proto.Message):
    ...
    [CampaignFeedService.GetCampaignFeed][google.ads.googleads.v9.services.CampaignFeedService.GetCampaignFeed].
...
class MutateCampaignFeedsRequest(proto.Message):
    r"""Request message for
    [CampaignFeedService.MutateCampaignFeeds][google.ads.googleads.v9.services.CampaignFeedService.MutateCampaignFeeds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign feeds are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.CampaignFeedOperation]):
...
class CampaignFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.CampaignFeed):
            Create operation: No resource name is
            expected for the new campaign feed.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.CampaignFeed):
...
class MutateCampaignFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateCampaignFeedResult]):
