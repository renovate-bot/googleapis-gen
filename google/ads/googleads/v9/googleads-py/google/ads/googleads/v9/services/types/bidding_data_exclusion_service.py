...
class MutateBiddingDataExclusionsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.BiddingDataExclusionOperation]):
...
class BiddingDataExclusionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.BiddingDataExclusion):
            Create operation: No resource name is
            expected for the new data exclusion.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.BiddingDataExclusion):
...
class MutateBiddingDataExclusionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateBiddingDataExclusionsResult]):
