...
from google.ads.googleads.v9.enums.types import merchant_center_link_status
...
class MerchantCenterLinkServiceClient(metaclass=MerchantCenterLinkServiceClientMeta):
    ...
    def transport(self) -> MerchantCenterLinkServiceTransport:
        ...
        Returns:
            MerchantCenterLinkServiceTransport: The transport used by the client
                instance.
        """
    ...
    def merchant_center_link_path(customer_id: str,merchant_center_id: str,) -> str:
        """Returns a fully-qualified merchant_center_link string."""
    ...
    def parse_merchant_center_link_path(path: str) -> Dict[str,str]:
        """Parses a merchant_center_link path into its component segments."""
    ...
    def __init__(self, *,
        ...
        """Instantiates the merchant center link service client.
    ...
    def list_merchant_center_links(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.ListMerchantCenterLinksRequest, dict]):
                The request object. Request message for
                [MerchantCenterLinkService.ListMerchantCenterLinks][google.ads.googleads.v9.services.MerchantCenterLinkService.ListMerchantCenterLinks].
            customer_id (str):
        ...
        Returns:
            google.ads.googleads.v9.services.types.ListMerchantCenterLinksResponse:
    ...
    def get_merchant_center_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetMerchantCenterLinkRequest, dict]):
                The request object. Request message for
                [MerchantCenterLinkService.GetMerchantCenterLink][google.ads.googleads.v9.services.MerchantCenterLinkService.GetMerchantCenterLink].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.MerchantCenterLink:
    ...
    def mutate_merchant_center_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateMerchantCenterLinkRequest, dict]):
                The request object. Request message for
                [MerchantCenterLinkService.MutateMerchantCenterLink][google.ads.googleads.v9.services.MerchantCenterLinkService.MutateMerchantCenterLink].
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (google.ads.googleads.v9.services.types.MerchantCenterLinkOperation):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateMerchantCenterLinkResponse:
