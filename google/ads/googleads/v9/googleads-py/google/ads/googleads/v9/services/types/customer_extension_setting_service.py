...
class MutateCustomerExtensionSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.CustomerExtensionSettingOperation]):
...
class MutateCustomerExtensionSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateCustomerExtensionSettingResult]):
