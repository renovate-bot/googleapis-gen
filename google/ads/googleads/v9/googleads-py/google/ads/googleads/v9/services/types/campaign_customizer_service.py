...
class CampaignCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v9.resources.types.CampaignCustomizer):
...
class MutateCampaignCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateCampaignCustomizerResult]):
