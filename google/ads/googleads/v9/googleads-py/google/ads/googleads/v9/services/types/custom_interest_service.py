...
class CustomInterestOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.CustomInterest):
            Create operation: No resource name is
            expected for the new custom interest.
            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.CustomInterest):
...
class MutateCustomInterestsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateCustomInterestResult]):
