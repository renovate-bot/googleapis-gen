...
class LabelOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.Label):
            Create operation: No resource name is
            expected for the new label.
            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.Label):
...
class MutateLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateLabelResult]):
