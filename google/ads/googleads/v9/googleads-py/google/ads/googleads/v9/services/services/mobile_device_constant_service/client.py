...
from google.ads.googleads.v9.enums.types import mobile_device_type
...
class MobileDeviceConstantServiceClient(metaclass=MobileDeviceConstantServiceClientMeta):
    ...
    def transport(self) -> MobileDeviceConstantServiceTransport:
        ...
        Returns:
            MobileDeviceConstantServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the mobile device constant service client.
    ...
    def get_mobile_device_constant(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetMobileDeviceConstantRequest, dict]):
                The request object. Request message for
                [MobileDeviceConstantService.GetMobileDeviceConstant][google.ads.googleads.v9.services.MobileDeviceConstantService.GetMobileDeviceConstant].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.MobileDeviceConstant:
