...
from google.ads.googleads.v9.enums.types import call_conversion_reporting_state as gage_call_conversion_reporting_state
from google.ads.googleads.v9.enums.types import call_to_action_type as gage_call_to_action_type
...
class ImageAsset(proto.Message):
    ...
    Attributes:
        ...
        full_size (google.ads.googleads.v9.common.types.ImageDimension):
...
class LeadFormAsset(proto.Message):
    ...
    Attributes:
        business_name (str):
            ...
            advertised.
        call_to_action_type (google.ads.googleads.v9.enums.types.LeadFormCallToActionTypeEnum.LeadFormCallToActionType):
        ...
        fields (Sequence[google.ads.googleads.v9.common.types.LeadFormField]):
            Ordered list of input fields.
        delivery_methods (Sequence[google.ads.googleads.v9.common.types.LeadFormDeliveryMethod]):
        ...
        post_submit_call_to_action_type (google.ads.googleads.v9.enums.types.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType):
        ...
        desired_intent (google.ads.googleads.v9.enums.types.LeadFormDesiredIntentEnum.LeadFormDesiredIntent):
...
class LeadFormField(proto.Message):
    ...
    Attributes:
        input_type (google.ads.googleads.v9.enums.types.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType):
            Describes the input type, which may be a
            predefined type such as "full name" or a pre-
            vetted question like "Do you own a car?".
        single_choice_answers (google.ads.googleads.v9.common.types.LeadFormSingleChoiceAnswers):
...
class LeadFormDeliveryMethod(proto.Message):
    ...
    Attributes:
        webhook (google.ads.googleads.v9.common.types.WebhookDelivery):
...
class PromotionAsset(proto.Message):
    ...
    Attributes:
        ...
        discount_modifier (google.ads.googleads.v9.enums.types.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier):
        ...
        redemption_end_date (str):
            ...
            to be redeemed, in yyyy-MM-dd format.
        occasion (google.ads.googleads.v9.enums.types.PromotionExtensionOccasionEnum.PromotionExtensionOccasion):
        ...
        ad_schedule_targets (Sequence[google.ads.googleads.v9.common.types.AdScheduleInfo]):
        ...
        money_amount_off (google.ads.googleads.v9.common.types.Money):
        ...
        orders_over_amount (google.ads.googleads.v9.common.types.Money):
...
class MobileAppAsset(proto.Message):
    ...
    Attributes:
        ...
        app_store (google.ads.googleads.v9.enums.types.MobileAppVendorEnum.MobileAppVendor):
...
class CallAsset(proto.Message):
    ...
    Attributes:
        ...
        call_conversion_reporting_state (google.ads.googleads.v9.enums.types.CallConversionReportingStateEnum.CallConversionReportingState):
...
class PriceAsset(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v9.enums.types.PriceExtensionTypeEnum.PriceExtensionType):
            Required. The type of the price asset.
        price_qualifier (google.ads.googleads.v9.enums.types.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier):
            The price qualifier of the price asset.
        language_code (str):
            Required. The language of the price asset.
            Represented as BCP 47 language tag.
        price_offerings (Sequence[google.ads.googleads.v9.common.types.PriceOffering]):
...
class PriceOffering(proto.Message):
    ...
    Attributes:
        ...
        description (str):
            ...
            between 1 and 25, inclusive.
        price (google.ads.googleads.v9.common.types.Money):
            Required. The price value of the price
            offering.
        unit (google.ads.googleads.v9.enums.types.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit):
...
class CallToActionAsset(proto.Message):
    ...
    Attributes:
        call_to_action (google.ads.googleads.v9.enums.types.CallToActionTypeEnum.CallToActionType):
            Call to action.
    """
