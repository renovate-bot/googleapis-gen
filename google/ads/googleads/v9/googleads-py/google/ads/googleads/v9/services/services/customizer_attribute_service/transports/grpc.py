...
class CustomizerAttributeServiceGrpcTransport(CustomizerAttributeServiceTransport):
    ...
    @property
    def mutate_customizer_attributes(self) -> Callable[
        ...
        if 'mutate_customizer_attributes' not in self._stubs:
            self._stubs['mutate_customizer_attributes'] = self.grpc_channel.unary_unary(
