...
class ConversionValueRuleServiceGrpcTransport(ConversionValueRuleServiceTransport):
    ...
    @property
    def get_conversion_value_rule(self) -> Callable[
            [conversion_value_rule_service.GetConversionValueRuleRequest],
            conversion_value_rule.ConversionValueRule]:
        r"""Return a callable for the get conversion value rule method over gRPC.

        Returns the requested conversion value rule.

        Returns:
            Callable[[~.GetConversionValueRuleRequest],
                    ~.ConversionValueRule]:
        ...
        if 'get_conversion_value_rule' not in self._stubs:
            self._stubs['get_conversion_value_rule'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v9.services.ConversionValueRuleService/GetConversionValueRule',
                request_serializer=conversion_value_rule_service.GetConversionValueRuleRequest.serialize,
                response_deserializer=conversion_value_rule.ConversionValueRule.deserialize,
            )
        return self._stubs['get_conversion_value_rule']

    @property
    def mutate_conversion_value_rules(self) -> Callable[
        ...
        if 'mutate_conversion_value_rules' not in self._stubs:
            self._stubs['mutate_conversion_value_rules'] = self.grpc_channel.unary_unary(
