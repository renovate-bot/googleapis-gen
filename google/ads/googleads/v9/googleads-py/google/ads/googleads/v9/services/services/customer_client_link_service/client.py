...
class CustomerClientLinkServiceClient(metaclass=CustomerClientLinkServiceClientMeta):
    ...
    def get_customer_client_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCustomerClientLinkRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CustomerClientLink:
    ...
    def mutate_customer_client_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomerClientLinkRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v9.services.types.CustomerClientLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomerClientLinkResponse:
