...
class HotelGroupViewServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[HotelGroupViewServiceTransport]]
...
class HotelGroupViewServiceClient(metaclass=HotelGroupViewServiceClientMeta):
    ...
    def transport(self) -> HotelGroupViewServiceTransport:
        ...
        Returns:
            HotelGroupViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the hotel group view service client.
    ...
    def get_hotel_group_view(self,
            request: Union[hotel_group_view_service.GetHotelGroupViewRequest, dict] = None,
            *,
        ...
        if not isinstance(request, hotel_group_view_service.GetHotelGroupViewRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_hotel_group_view]
