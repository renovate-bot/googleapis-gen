...
from google.ads.googleads.v9.enums.types import keyword_plan_competition_level
from google.ads.googleads.v9.enums.types import keyword_plan_concept_group_type
...
class KeywordPlanHistoricalMetrics(proto.Message):
    ...
    Attributes:
        ...
        competition (google.ads.googleads.v9.enums.types.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel):
...
class HistoricalMetricsOptions(proto.Message):
    ...
    Attributes:
        year_month_range (google.ads.googleads.v9.common.types.YearMonthRange):
...
class KeywordPlanAggregateMetrics(proto.Message):
    ...
    Attributes:
        aggregate_metric_types (Sequence[google.ads.googleads.v9.enums.types.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType]):
...
class KeywordPlanAggregateMetricResults(proto.Message):
    ...
    Attributes:
        device_searches (Sequence[google.ads.googleads.v9.common.types.KeywordPlanDeviceSearches]):
...
class KeywordAnnotations(proto.Message):
    ...
    Attributes:
        concepts (Sequence[google.ads.googleads.v9.common.types.KeywordConcept]):
...
class KeywordConcept(proto.Message):
    ...
    Attributes:
        ...
        concept_group (google.ads.googleads.v9.common.types.ConceptGroup):
...
class ConceptGroup(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v9.enums.types.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType):
