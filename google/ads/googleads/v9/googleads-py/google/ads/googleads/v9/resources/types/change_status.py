...
class ChangeStatus(proto.Message):
    ...
    Attributes:
        ...
        resource_type (google.ads.googleads.v9.enums.types.ChangeStatusResourceTypeEnum.ChangeStatusResourceType):
        ...
        resource_status (google.ads.googleads.v9.enums.types.ChangeStatusOperationEnum.ChangeStatusOperation):
