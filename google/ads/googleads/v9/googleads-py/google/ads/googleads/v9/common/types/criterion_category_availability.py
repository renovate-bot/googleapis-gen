...
from google.ads.googleads.v9.enums.types import advertising_channel_sub_type as gage_advertising_channel_sub_type
from google.ads.googleads.v9.enums.types import advertising_channel_type as gage_advertising_channel_type
from google.ads.googleads.v9.enums.types import criterion_category_channel_availability_mode
from google.ads.googleads.v9.enums.types import criterion_category_locale_availability_mode
...
class CriterionCategoryAvailability(proto.Message):
    ...
    Attributes:
        channel (google.ads.googleads.v9.common.types.CriterionCategoryChannelAvailability):
            Channel types and subtypes that are available
            to the category.
        locale (Sequence[google.ads.googleads.v9.common.types.CriterionCategoryLocaleAvailability]):
...
class CriterionCategoryChannelAvailability(proto.Message):
    ...
    Attributes:
        availability_mode (google.ads.googleads.v9.enums.types.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode):
        ...
        advertising_channel_type (google.ads.googleads.v9.enums.types.AdvertisingChannelTypeEnum.AdvertisingChannelType):
            Channel type the category is available to.
        advertising_channel_sub_type (Sequence[google.ads.googleads.v9.enums.types.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType]):
...
class CriterionCategoryLocaleAvailability(proto.Message):
    ...
    Attributes:
        availability_mode (google.ads.googleads.v9.enums.types.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode):
