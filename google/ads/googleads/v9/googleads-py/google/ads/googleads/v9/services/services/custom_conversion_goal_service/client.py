...
from .transports.base import CustomConversionGoalServiceTransport, DEFAULT_CLIENT_INFO
...
class CustomConversionGoalServiceClient(metaclass=CustomConversionGoalServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, CustomConversionGoalServiceTransport, None] = None,
    ...
    def mutate_custom_conversion_goals(self,
            request: Union[custom_conversion_goal_service.MutateCustomConversionGoalsRequest, dict] = None,
            *,
            customer_id: str = None,
            operations: Sequence[custom_conversion_goal_service.CustomConversionGoalOperation] = None,
        ...
        if not isinstance(request, custom_conversion_goal_service.MutateCustomConversionGoalsRequest):
            request = custom_conversion_goal_service.MutateCustomConversionGoalsRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.mutate_custom_conversion_goals]
