...
class InvoiceServiceClient(metaclass=InvoiceServiceClientMeta):
    ...
    def list_invoices(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.ListInvoicesRequest, dict]):
            ...
            issue_year (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            issue_month (:class:`google.ads.googleads.v9.enums.types.MonthOfYearEnum.MonthOfYear`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.ListInvoicesResponse:
