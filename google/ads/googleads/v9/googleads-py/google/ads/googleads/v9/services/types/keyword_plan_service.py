...
class GetKeywordPlanRequest(proto.Message):
    ...
    [KeywordPlanService.GetKeywordPlan][google.ads.googleads.v9.services.KeywordPlanService.GetKeywordPlan].
...
class MutateKeywordPlansRequest(proto.Message):
    r"""Request message for
    [KeywordPlanService.MutateKeywordPlans][google.ads.googleads.v9.services.KeywordPlanService.MutateKeywordPlans].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            keyword plans are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.KeywordPlanOperation]):
...
class KeywordPlanOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.KeywordPlan):
            Create operation: No resource name is
            expected for the new keyword plan.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.KeywordPlan):
...
class MutateKeywordPlansResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateKeywordPlansResult]):
...
class GenerateForecastCurveRequest(proto.Message):
    r"""Request message for
    [KeywordPlanService.GenerateForecastCurve][google.ads.googleads.v9.services.KeywordPlanService.GenerateForecastCurve].
...
class GenerateForecastCurveResponse(proto.Message):
    ...
    Attributes:
        campaign_forecast_curves (Sequence[google.ads.googleads.v9.services.types.KeywordPlanCampaignForecastCurve]):
...
class GenerateForecastTimeSeriesRequest(proto.Message):
    r"""Request message for
    [KeywordPlanService.GenerateForecastTimeSeries][google.ads.googleads.v9.services.KeywordPlanService.GenerateForecastTimeSeries].
...
class GenerateForecastTimeSeriesResponse(proto.Message):
    ...
    Attributes:
        weekly_time_series_forecasts (Sequence[google.ads.googleads.v9.services.types.KeywordPlanWeeklyTimeSeriesForecast]):
...
class GenerateForecastMetricsRequest(proto.Message):
    r"""Request message for
    [KeywordPlanService.GenerateForecastMetrics][google.ads.googleads.v9.services.KeywordPlanService.GenerateForecastMetrics].
...
class GenerateForecastMetricsResponse(proto.Message):
    ...
    Attributes:
        campaign_forecasts (Sequence[google.ads.googleads.v9.services.types.KeywordPlanCampaignForecast]):
            List of campaign forecasts.
            One maximum.
        ad_group_forecasts (Sequence[google.ads.googleads.v9.services.types.KeywordPlanAdGroupForecast]):
            List of ad group forecasts.
        keyword_forecasts (Sequence[google.ads.googleads.v9.services.types.KeywordPlanKeywordForecast]):
...
class KeywordPlanCampaignForecast(proto.Message):
    ...
    Attributes:
        ...
        campaign_forecast (google.ads.googleads.v9.services.types.ForecastMetrics):
...
class KeywordPlanAdGroupForecast(proto.Message):
    ...
    Attributes:
        ...
        ad_group_forecast (google.ads.googleads.v9.services.types.ForecastMetrics):
...
class KeywordPlanKeywordForecast(proto.Message):
    ...
    Attributes:
        ...
        keyword_forecast (google.ads.googleads.v9.services.types.ForecastMetrics):
...
class KeywordPlanCampaignForecastCurve(proto.Message):
    ...
    Attributes:
        keyword_plan_campaign (str):
            ...
            This field is a member of `oneof`_ ``_keyword_plan_campaign``.
        max_cpc_bid_forecast_curve (google.ads.googleads.v9.services.types.KeywordPlanMaxCpcBidForecastCurve):
...
class KeywordPlanMaxCpcBidForecastCurve(proto.Message):
    ...
    Attributes:
        max_cpc_bid_forecasts (Sequence[google.ads.googleads.v9.services.types.KeywordPlanMaxCpcBidForecast]):
...
class KeywordPlanMaxCpcBidForecast(proto.Message):
    ...
    Attributes:
        ...
        max_cpc_bid_forecast (google.ads.googleads.v9.services.types.ForecastMetrics):
...
class KeywordPlanWeeklyTimeSeriesForecast(proto.Message):
    ...
    Attributes:
        keyword_plan_campaign (str):
            ...
            This field is a member of `oneof`_ ``_keyword_plan_campaign``.
        weekly_forecasts (Sequence[google.ads.googleads.v9.services.types.KeywordPlanWeeklyForecast]):
            The forecasts for the Keyword Plan campaign
            at different max CPC bids.
    """
...
class KeywordPlanWeeklyForecast(proto.Message):
    ...
    Attributes:
        ...
        forecast (google.ads.googleads.v9.services.types.ForecastMetrics):
            The forecast for the Keyword Plan campaign
            for the week.
    """
...
class GenerateHistoricalMetricsRequest(proto.Message):
    r"""Request message for
    [KeywordPlanService.GenerateHistoricalMetrics][google.ads.googleads.v9.services.KeywordPlanService.GenerateHistoricalMetrics].
...
class GenerateHistoricalMetricsResponse(proto.Message):
    ...
    Attributes:
        metrics (Sequence[google.ads.googleads.v9.services.types.KeywordPlanKeywordHistoricalMetrics]):
...
class KeywordPlanKeywordHistoricalMetrics(proto.Message):
    ...
    Attributes:
        ...
        keyword_metrics (google.ads.googleads.v9.common.types.KeywordPlanHistoricalMetrics):
