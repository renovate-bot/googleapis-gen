...
from google.ads.googleads.v9.services.types import mobile_app_category_constant_service
...
class MobileAppCategoryConstantServiceClient(metaclass=MobileAppCategoryConstantServiceClientMeta):
    ...
    def transport(self) -> MobileAppCategoryConstantServiceTransport:
        ...
        Returns:
            MobileAppCategoryConstantServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the mobile app category constant service client.
