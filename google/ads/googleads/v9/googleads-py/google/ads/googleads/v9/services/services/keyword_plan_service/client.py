...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
    ...
    def get_keyword_plan(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetKeywordPlanRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.KeywordPlan:
    ...
    def mutate_keyword_plans(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateKeywordPlansRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.KeywordPlanOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateKeywordPlansResponse:
    ...
    def generate_forecast_curve(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GenerateForecastCurveRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.types.GenerateForecastCurveResponse:
    ...
    def generate_forecast_time_series(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GenerateForecastTimeSeriesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.types.GenerateForecastTimeSeriesResponse:
                Response message for
                [KeywordPlanService.GenerateForecastTimeSeries][google.ads.googleads.v9.services.KeywordPlanService.GenerateForecastTimeSeries].
    ...
    def generate_forecast_metrics(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GenerateForecastMetricsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.types.GenerateForecastMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateForecastMetrics][google.ads.googleads.v9.services.KeywordPlanService.GenerateForecastMetrics].
    ...
    def generate_historical_metrics(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GenerateHistoricalMetricsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.types.GenerateHistoricalMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateHistoricalMetrics][google.ads.googleads.v9.services.KeywordPlanService.GenerateHistoricalMetrics].
