...
class GetAssetGroupAssetRequest(proto.Message):
    ...
    [AssetGroupAssetService.GetAssetGroupAsset][google.ads.googleads.v9.services.AssetGroupAssetService.GetAssetGroupAsset].
...
class MutateAssetGroupAssetsRequest(proto.Message):
    r"""Request message for
    [AssetGroupAssetService.MutateAssetGroupAssets][google.ads.googleads.v9.services.AssetGroupAssetService.MutateAssetGroupAssets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose asset
            group assets are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.AssetGroupAssetOperation]):
...
class AssetGroupAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.AssetGroupAsset):
            Create operation: No resource name is
            expected for the new asset group asset
            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.AssetGroupAsset):
            Update operation: The asset group asset sis
...
class MutateAssetGroupAssetsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateAssetGroupAssetResult]):
