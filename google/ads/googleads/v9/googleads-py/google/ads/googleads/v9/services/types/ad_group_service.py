...
class MutateAdGroupsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.AdGroupOperation]):
...
class AdGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.AdGroup):
            Create operation: No resource name is
            expected for the new ad group.
            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.AdGroup):
...
class MutateAdGroupsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateAdGroupResult]):
