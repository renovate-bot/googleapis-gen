...
class ConversionUploadServiceClient(metaclass=ConversionUploadServiceClientMeta):
    ...
    def upload_click_conversions(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.UploadClickConversionsRequest, dict]):
                The request object. Request message for
                [ConversionUploadService.UploadClickConversions][google.ads.googleads.v9.services.ConversionUploadService.UploadClickConversions].
            customer_id (:class:`str`):
                ...
                should not be set.
            conversions (:class:`Sequence[google.ads.googleads.v9.services.types.ClickConversion]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.UploadClickConversionsResponse:
        ...
        if request is not None and any([customer_id, conversions, partial_failure]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.upload_click_conversions]
    ...
    def upload_call_conversions(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.UploadCallConversionsRequest, dict]):
                The request object. Request message for
                [ConversionUploadService.UploadCallConversions][google.ads.googleads.v9.services.ConversionUploadService.UploadCallConversions].
            customer_id (:class:`str`):
                Required. The ID of the customer
                performing the upload.
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            conversions (:class:`Sequence[google.ads.googleads.v9.services.types.CallConversion]`):
                Required. The conversions that are
                being uploaded.
        ...
        Returns:
            google.ads.googleads.v9.services.types.UploadCallConversionsResponse:
                Response message for
                [ConversionUploadService.UploadCallConversions][google.ads.googleads.v9.services.ConversionUploadService.UploadCallConversions].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.upload_call_conversions]
