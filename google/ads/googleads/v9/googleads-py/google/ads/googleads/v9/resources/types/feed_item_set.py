...
class FeedItemSet(proto.Message):
    ...
    Attributes:
        ...
        display_name (str):
            ...
            account.
        status (google.ads.googleads.v9.enums.types.FeedItemSetStatusEnum.FeedItemSetStatus):
            Output only. Status of the feed item set.
            This field is read-only.
        dynamic_location_set_filter (google.ads.googleads.v9.common.types.DynamicLocationSetFilter):
            Filter for dynamic location set.
            It is only used for sets of locations.

            This field is a member of `oneof`_ ``dynamic_set_filter``.
        dynamic_affiliate_location_set_filter (google.ads.googleads.v9.common.types.DynamicAffiliateLocationSetFilter):
