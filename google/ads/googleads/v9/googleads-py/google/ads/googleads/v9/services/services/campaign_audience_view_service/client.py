...
class CampaignAudienceViewServiceClient(metaclass=CampaignAudienceViewServiceClientMeta):
    ...
    def transport(self) -> CampaignAudienceViewServiceTransport:
        ...
        Returns:
            CampaignAudienceViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the campaign audience view service client.
    ...
    def get_campaign_audience_view(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCampaignAudienceViewRequest, dict]):
                The request object. Request message for
                [CampaignAudienceViewService.GetCampaignAudienceView][google.ads.googleads.v9.services.CampaignAudienceViewService.GetCampaignAudienceView].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CampaignAudienceView:
