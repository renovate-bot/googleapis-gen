...
class CombinedAudienceServiceClientMeta(type):
    """Metaclass for the CombinedAudienceService client.
...
class CombinedAudienceServiceClient(metaclass=CombinedAudienceServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CombinedAudienceServiceClient: The constructed client.
        """
    ...
    def get_combined_audience(self,
        ...
        r"""Returns the requested combined audience in full detail.
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CombinedAudience:
                Describe a resource for combined
                audiences which includes different
                audiences.
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_combined_audience]
