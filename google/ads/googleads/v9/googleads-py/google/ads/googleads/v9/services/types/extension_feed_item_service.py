...
class MutateExtensionFeedItemsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.ExtensionFeedItemOperation]):
...
class ExtensionFeedItemOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.ExtensionFeedItem):
            Create operation: No resource name is
            expected for the new extension feed item.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.ExtensionFeedItem):
...
class MutateExtensionFeedItemsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateExtensionFeedItemResult]):
