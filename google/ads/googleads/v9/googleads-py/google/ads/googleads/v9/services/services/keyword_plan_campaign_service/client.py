...
class KeywordPlanCampaignServiceClient(metaclass=KeywordPlanCampaignServiceClientMeta):
    ...
    def get_keyword_plan_campaign(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetKeywordPlanCampaignRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.KeywordPlanCampaign:
    ...
    def mutate_keyword_plan_campaigns(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateKeywordPlanCampaignsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.KeywordPlanCampaignOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateKeywordPlanCampaignsResponse:
