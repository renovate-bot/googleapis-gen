...
class AdScheduleViewServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AdScheduleViewServiceTransport]]
...
class AdScheduleViewServiceClient(metaclass=AdScheduleViewServiceClientMeta):
    ...
    def transport(self) -> AdScheduleViewServiceTransport:
        ...
        Returns:
            AdScheduleViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the ad schedule view service client.
    ...
    def get_ad_schedule_view(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetAdScheduleViewRequest, dict]):
                The request object. Request message for
                [AdScheduleViewService.GetAdScheduleView][google.ads.googleads.v9.services.AdScheduleViewService.GetAdScheduleView].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.AdScheduleView:
        ...
        if not isinstance(request, ad_schedule_view_service.GetAdScheduleViewRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_ad_schedule_view]
