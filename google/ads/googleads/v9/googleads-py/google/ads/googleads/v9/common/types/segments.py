...
from google.ads.googleads.v9.enums.types import ad_destination_type as gage_ad_destination_type
from google.ads.googleads.v9.enums.types import ad_network_type as gage_ad_network_type
from google.ads.googleads.v9.enums.types import budget_campaign_association_status as gage_budget_campaign_association_status
from google.ads.googleads.v9.enums.types import click_type as gage_click_type
from google.ads.googleads.v9.enums.types import conversion_action_category as gage_conversion_action_category
from google.ads.googleads.v9.enums.types import conversion_attribution_event_type as gage_conversion_attribution_event_type
from google.ads.googleads.v9.enums.types import conversion_lag_bucket as gage_conversion_lag_bucket
from google.ads.googleads.v9.enums.types import conversion_or_adjustment_lag_bucket as gage_conversion_or_adjustment_lag_bucket
from google.ads.googleads.v9.enums.types import conversion_value_rule_primary_dimension as gage_conversion_value_rule_primary_dimension
from google.ads.googleads.v9.enums.types import day_of_week as gage_day_of_week
from google.ads.googleads.v9.enums.types import device as gage_device
from google.ads.googleads.v9.enums.types import external_conversion_source as gage_external_conversion_source
from google.ads.googleads.v9.enums.types import hotel_date_selection_type as gage_hotel_date_selection_type
from google.ads.googleads.v9.enums.types import hotel_price_bucket as gage_hotel_price_bucket
from google.ads.googleads.v9.enums.types import hotel_rate_type as gage_hotel_rate_type
from google.ads.googleads.v9.enums.types import month_of_year as gage_month_of_year
from google.ads.googleads.v9.enums.types import placeholder_type as gage_placeholder_type
from google.ads.googleads.v9.enums.types import product_channel as gage_product_channel
from google.ads.googleads.v9.enums.types import product_channel_exclusivity as gage_product_channel_exclusivity
from google.ads.googleads.v9.enums.types import product_condition as gage_product_condition
from google.ads.googleads.v9.enums.types import recommendation_type as gage_recommendation_type
from google.ads.googleads.v9.enums.types import search_engine_results_page_type as gage_search_engine_results_page_type
from google.ads.googleads.v9.enums.types import search_term_match_type as gage_search_term_match_type
from google.ads.googleads.v9.enums.types import slot as gage_slot
...
class Segments(proto.Message):
    ...
    Attributes:
        ad_destination_type (google.ads.googleads.v9.enums.types.AdDestinationTypeEnum.AdDestinationType):
            Ad Destination type.
        ad_network_type (google.ads.googleads.v9.enums.types.AdNetworkTypeEnum.AdNetworkType):
            Ad network type.
        budget_campaign_association_status (google.ads.googleads.v9.common.types.BudgetCampaignAssociationStatus):
            Budget campaign association status.
        click_type (google.ads.googleads.v9.enums.types.ClickTypeEnum.ClickType):
            Click type.
        conversion_action (str):
            Resource name of the conversion action.

            This field is a member of `oneof`_ ``_conversion_action``.
        conversion_action_category (google.ads.googleads.v9.enums.types.ConversionActionCategoryEnum.ConversionActionCategory):
        ...
        conversion_attribution_event_type (google.ads.googleads.v9.enums.types.ConversionAttributionEventTypeEnum.ConversionAttributionEventType):
            Conversion attribution event type.
        conversion_lag_bucket (google.ads.googleads.v9.enums.types.ConversionLagBucketEnum.ConversionLagBucket):
            An enum value representing the number of days
            between the impression and the conversion.
        conversion_or_adjustment_lag_bucket (google.ads.googleads.v9.enums.types.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket):
            An enum value representing the number of days
        ...
        day_of_week (google.ads.googleads.v9.enums.types.DayOfWeekEnum.DayOfWeek):
            Day of the week, e.g., MONDAY.
        device (google.ads.googleads.v9.enums.types.DeviceEnum.Device):
            Device to which metrics apply.
        external_conversion_source (google.ads.googleads.v9.enums.types.ExternalConversionSourceEnum.ExternalConversionSource):
        ...
        hotel_check_in_day_of_week (google.ads.googleads.v9.enums.types.DayOfWeekEnum.DayOfWeek):
        ...
        hotel_date_selection_type (google.ads.googleads.v9.enums.types.HotelDateSelectionTypeEnum.HotelDateSelectionType):
        ...
        hotel_rate_type (google.ads.googleads.v9.enums.types.HotelRateTypeEnum.HotelRateType):
            Hotel rate type.
        hotel_price_bucket (google.ads.googleads.v9.enums.types.HotelPriceBucketEnum.HotelPriceBucket):
            Hotel price bucket.
        hotel_state (str):
            Hotel state.
        ...
        keyword (google.ads.googleads.v9.common.types.Keyword):
            Keyword criterion.
        month (str):
        ...
        month_of_year (google.ads.googleads.v9.enums.types.MonthOfYearEnum.MonthOfYear):
            Month of the year, e.g., January.
        partner_hotel_id (str):
            Partner hotel ID.

            This field is a member of `oneof`_ ``_partner_hotel_id``.
        placeholder_type (google.ads.googleads.v9.enums.types.PlaceholderTypeEnum.PlaceholderType):
        ...
        product_channel (google.ads.googleads.v9.enums.types.ProductChannelEnum.ProductChannel):
            Channel of the product.
        product_channel_exclusivity (google.ads.googleads.v9.enums.types.ProductChannelExclusivityEnum.ProductChannelExclusivity):
            Channel exclusivity of the product.
        product_condition (google.ads.googleads.v9.enums.types.ProductConditionEnum.ProductCondition):
        ...
        recommendation_type (google.ads.googleads.v9.enums.types.RecommendationTypeEnum.RecommendationType):
            Recommendation type.
        search_engine_results_page_type (google.ads.googleads.v9.enums.types.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType):
            Type of the search engine results page.
        search_term_match_type (google.ads.googleads.v9.enums.types.SearchTermMatchTypeEnum.SearchTermMatchType):
            Match type of the keyword that triggered the
            ad, including variants.
        slot (google.ads.googleads.v9.enums.types.SlotEnum.Slot):
            Position of the ad.
        conversion_value_rule_primary_dimension (google.ads.googleads.v9.enums.types.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension):
        ...
        asset_interaction_target (google.ads.googleads.v9.common.types.AssetInteractionTarget):
...
class Keyword(proto.Message):
    ...
    Attributes:
        ...
        info (google.ads.googleads.v9.common.types.KeywordInfo):
            Keyword info.
    """
...
class BudgetCampaignAssociationStatus(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v9.enums.types.BudgetCampaignAssociationStatusEnum.BudgetCampaignAssociationStatus):
            Budget campaign association status.
    """
