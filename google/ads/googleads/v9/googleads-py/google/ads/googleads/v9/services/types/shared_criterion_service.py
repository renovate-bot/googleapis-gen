...
class GetSharedCriterionRequest(proto.Message):
    ...
    [SharedCriterionService.GetSharedCriterion][google.ads.googleads.v9.services.SharedCriterionService.GetSharedCriterion].
...
class MutateSharedCriteriaRequest(proto.Message):
    r"""Request message for
    [SharedCriterionService.MutateSharedCriteria][google.ads.googleads.v9.services.SharedCriterionService.MutateSharedCriteria].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose shared
            criteria are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.SharedCriterionOperation]):
...
class MutateSharedCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateSharedCriterionResult]):
