...
class FeedItemServiceClientMeta(type):
    """Metaclass for the FeedItemService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[FeedItemServiceTransport]]
    _transport_registry['grpc'] = FeedItemServiceGrpcTransport
...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            FeedItemServiceClient: The constructed client.
        """
    ...
    def transport(self) -> FeedItemServiceTransport:
        ...
        Returns:
            FeedItemServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, FeedItemServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the feed item service client.
        ...
        Args:
            ...
            transport (Union[str, ~.FeedItemServiceTransport]): The
        ...
        if isinstance(transport, FeedItemServiceTransport):
            # transport is a FeedItemServiceTransport instance.
            if credentials:
            ...
            self._transport = FeedItemServiceGrpcTransport(
    ...
    def get_feed_item(self,
        ...
        r"""Returns the requested feed item in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetFeedItemRequest, dict]):
                The request object. Request message for
                [FeedItemService.GetFeedItem][google.ads.googleads.v9.services.FeedItemService.GetFeedItem].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.FeedItem:
                A feed item.
        """
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_feed_item]
    ...
    def mutate_feed_items(self,
        ...
        r"""Creates, updates, or removes feed items. Operation statuses are
        returned.

        List of thrown errors: `AuthenticationError <>`__
        `AuthorizationError <>`__ `CollectionSizeError <>`__
        `CriterionError <>`__ `DatabaseError <>`__ `DateError <>`__
        `DistinctError <>`__ `FeedItemError <>`__ `FieldError <>`__
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateFeedItemsRequest, dict]):
                The request object. Request message for
                [FeedItemService.MutateFeedItems][google.ads.googleads.v9.services.FeedItemService.MutateFeedItems].
            customer_id (:class:`str`):
                Required. The ID of the customer
                whose feed items are being modified.

                This corresponds to the ``customer_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.FeedItemOperation]`):
                Required. The list of operations to
                perform on individual feed items.
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateFeedItemsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_feed_items]
