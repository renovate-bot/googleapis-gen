...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
    ...
    def transport(self) -> FeedItemServiceTransport:
        ...
        Returns:
            FeedItemServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the feed item service client.
    ...
    def mutate_feed_items(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v9.services.types.FeedItemOperation]):
