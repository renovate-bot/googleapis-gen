...
class CustomerAssetServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CustomerAssetServiceTransport]]
...
class CustomerAssetServiceClient(metaclass=CustomerAssetServiceClientMeta):
    ...
    def get_customer_asset(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCustomerAssetRequest, dict]):
                The request object. Request message for
                [CustomerAssetService.GetCustomerAsset][google.ads.googleads.v9.services.CustomerAssetService.GetCustomerAsset].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CustomerAsset:
        ...
        if not isinstance(request, customer_asset_service.GetCustomerAssetRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_customer_asset]
    ...
    def mutate_customer_assets(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomerAssetsRequest, dict]):
                The request object. Request message for
                [CustomerAssetService.MutateCustomerAssets][google.ads.googleads.v9.services.CustomerAssetService.MutateCustomerAssets].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CustomerAssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomerAssetsResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, customer_asset_service.MutateCustomerAssetsRequest):
            request = customer_asset_service.MutateCustomerAssetsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_customer_assets]
