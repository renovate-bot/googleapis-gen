...
class CustomerServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CustomerServiceTransport]]
...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def get_customer(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCustomerRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.Customer:
                A customer.
        """
    ...
    def mutate_customer(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomerRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v9.services.types.CustomerOperation`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomerResponse:
    ...
    def list_accessible_customers(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.ListAccessibleCustomersRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.types.ListAccessibleCustomersResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, customer_service.ListAccessibleCustomersRequest):
            request = customer_service.ListAccessibleCustomersRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_accessible_customers]
    ...
    def create_customer_client(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.CreateCustomerClientRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            customer_client (:class:`google.ads.googleads.v9.resources.types.Customer`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.CreateCustomerClientResponse:
                Response message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_customer_client]
