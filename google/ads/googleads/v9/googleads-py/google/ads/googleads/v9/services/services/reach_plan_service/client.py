...
class ReachPlanServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ReachPlanServiceTransport]]
...
class ReachPlanServiceClient(metaclass=ReachPlanServiceClientMeta):
    ...
    def list_plannable_locations(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.ListPlannableLocationsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.services.types.ListPlannableLocationsResponse:
        ...
        if not isinstance(request, reach_plan_service.ListPlannableLocationsRequest):
            request = reach_plan_service.ListPlannableLocationsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_plannable_locations]
    ...
    def list_plannable_products(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.ListPlannableProductsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.services.types.ListPlannableProductsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_plannable_products]
    ...
    def generate_product_mix_ideas(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GenerateProductMixIdeasRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.types.GenerateProductMixIdeasResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_product_mix_ideas]
    ...
    def generate_reach_forecast(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GenerateReachForecastRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            campaign_duration (:class:`google.ads.googleads.v9.services.types.CampaignDuration`):
                Required. Campaign duration.
                This corresponds to the ``campaign_duration`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            planned_products (:class:`Sequence[google.ads.googleads.v9.services.types.PlannedProduct]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.GenerateReachForecastResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_reach_forecast]
