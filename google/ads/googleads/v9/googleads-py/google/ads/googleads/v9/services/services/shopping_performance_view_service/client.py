...
class ShoppingPerformanceViewServiceClient(metaclass=ShoppingPerformanceViewServiceClientMeta):
    ...
    def get_shopping_performance_view(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetShoppingPerformanceViewRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.ShoppingPerformanceView:
