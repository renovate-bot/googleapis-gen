...
from .base import ExtensionFeedItemServiceTransport, DEFAULT_CLIENT_INFO
...
class ExtensionFeedItemServiceGrpcTransport(ExtensionFeedItemServiceTransport):
    ...
    @property
    def get_extension_feed_item(self) -> Callable[
            [extension_feed_item_service.GetExtensionFeedItemRequest],
            extension_feed_item.ExtensionFeedItem]:
        r"""Return a callable for the get extension feed item method over gRPC.
        ...
        Returns:
            Callable[[~.GetExtensionFeedItemRequest],
                    ~.ExtensionFeedItem]:
        ...
        if 'get_extension_feed_item' not in self._stubs:
            self._stubs['get_extension_feed_item'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v9.services.ExtensionFeedItemService/GetExtensionFeedItem',
                request_serializer=extension_feed_item_service.GetExtensionFeedItemRequest.serialize,
                response_deserializer=extension_feed_item.ExtensionFeedItem.deserialize,
            )
        return self._stubs['get_extension_feed_item']

    @property
    def mutate_extension_feed_items(self) -> Callable[
            [extension_feed_item_service.MutateExtensionFeedItemsRequest],
            extension_feed_item_service.MutateExtensionFeedItemsResponse]:
        r"""Return a callable for the mutate extension feed items method over gRPC.
        ...
        Returns:
            Callable[[~.MutateExtensionFeedItemsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'mutate_extension_feed_items' not in self._stubs:
            self._stubs['mutate_extension_feed_items'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v9.services.ExtensionFeedItemService/MutateExtensionFeedItems',
                request_serializer=extension_feed_item_service.MutateExtensionFeedItemsRequest.serialize,
                response_deserializer=extension_feed_item_service.MutateExtensionFeedItemsResponse.deserialize,
            )
        return self._stubs['mutate_extension_feed_items']
