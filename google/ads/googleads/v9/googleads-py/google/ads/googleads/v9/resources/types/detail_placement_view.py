...
from google.ads.googleads.v9.enums.types import placement_type as gage_placement_type
...
class DetailPlacementView(proto.Message):
    ...
    Attributes:
        ...
        placement_type (google.ads.googleads.v9.enums.types.PlacementTypeEnum.PlacementType):
