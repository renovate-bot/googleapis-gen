...
class AssetGroupListingGroupFilter(proto.Message):
    ...
    Attributes:
        ...
        id (int):
            ...
            ListingGroupFilter.
        type_ (google.ads.googleads.v9.enums.types.ListingGroupFilterTypeEnum.ListingGroupFilterType):
            Immutable. Type of a listing group filter
            node.
        vertical (google.ads.googleads.v9.enums.types.ListingGroupFilterVerticalEnum.ListingGroupFilterVertical):
            Immutable. The vertical the current node tree
            represents. All nodes in the same tree must
            belong to the same vertical.
        case_value (google.ads.googleads.v9.resources.types.ListingGroupFilterDimension):
    ...
    parent_listing_group_filter = proto.Field(
        proto.STRING,
        number=7,
    )
...
class ListingGroupFilterDimension(proto.Message):
    ...
    class ProductBiddingCategory(proto.Message):
        r"""One element of a bidding category at a certain level. Top-
        evel categories are at level 1, their children at level 2, and
        so on. We currently support up to 5 levels. The user must
    ...
    class ProductChannel(proto.Message):
        ...
        Attributes:
            channel (google.ads.googleads.v9.enums.types.ListingGroupFilterProductChannelEnum.ListingGroupFilterProductChannel):
