...
class MutateCustomerConversionGoalsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.CustomerConversionGoalOperation]):
...
class CustomerConversionGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v9.resources.types.CustomerConversionGoal):
...
class MutateCustomerConversionGoalsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateCustomerConversionGoalResult]):
