...
class GoogleAdsServiceClient(metaclass=GoogleAdsServiceClientMeta):
    ...
    def parse_ad_group_criterion_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_criterion_customizer_path(customer_id: str,ad_group_id: str,criterion_id: str,customizer_attribute_id: str,) -> str:
        """Return a fully-qualified ad_group_criterion_customizer string."""
        return "customers/{customer_id}/adGroupCriterionCustomizers/{ad_group_id}~{criterion_id}~{customizer_attribute_id}".format(customer_id=customer_id, ad_group_id=ad_group_id, criterion_id=criterion_id, customizer_attribute_id=customizer_attribute_id, )

    @staticmethod
    def parse_ad_group_criterion_customizer_path(path: str) -> Dict[str,str]:
        """Parse a ad_group_criterion_customizer path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/adGroupCriterionCustomizers/(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)~(?P<customizer_attribute_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_ad_group_criterion_simulation_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_customizer_path(customer_id: str,ad_group_id: str,customizer_attribute_id: str,) -> str:
        """Return a fully-qualified ad_group_customizer string."""
        return "customers/{customer_id}/adGroupCustomizers/{ad_group_id}~{customizer_attribute_id}".format(customer_id=customer_id, ad_group_id=ad_group_id, customizer_attribute_id=customizer_attribute_id, )

    @staticmethod
    def parse_ad_group_customizer_path(path: str) -> Dict[str,str]:
        """Parse a ad_group_customizer path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/adGroupCustomizers/(?P<ad_group_id>.+?)~(?P<customizer_attribute_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def asset_group_asset_path(customer_id: str,asset_group_id: str,asset_id: str,field_type: str,) -> str:
        """Return a fully-qualified asset_group_asset string."""
    ...
    def parse_asset_group_asset_path(path: str) -> Dict[str,str]:
        """Parse a asset_group_asset path into its component segments."""
    ...
    def parse_asset_group_listing_group_filter_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def asset_group_product_group_view_path(customer_id: str,asset_group_id: str,listing_group_filter_id: str,) -> str:
        """Return a fully-qualified asset_group_product_group_view string."""
        return "customers/{customer_id}/assetGroupProductGroupViews/{asset_group_id}~{listing_group_filter_id}".format(customer_id=customer_id, asset_group_id=asset_group_id, listing_group_filter_id=listing_group_filter_id, )

    @staticmethod
    def parse_asset_group_product_group_view_path(path: str) -> Dict[str,str]:
        """Parse a asset_group_product_group_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/assetGroupProductGroupViews/(?P<asset_group_id>.+?)~(?P<listing_group_filter_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def asset_set_asset_path(customer_id: str,asset_set_id: str,asset_id: str,) -> str:
        """Return a fully-qualified asset_set_asset string."""
    ...
    def parse_asset_set_asset_path(path: str) -> Dict[str,str]:
        """Parse a asset_set_asset path into its component segments."""
    ...
    def campaign_asset_set_path(customer_id: str,campaign_id: str,asset_set_id: str,) -> str:
        """Return a fully-qualified campaign_asset_set string."""
    ...
    def parse_campaign_asset_set_path(path: str) -> Dict[str,str]:
        """Parse a campaign_asset_set path into its component segments."""
    ...
    def parse_campaign_budget_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_conversion_goal_path(customer_id: str,campaign_id: str,category: str,source: str,) -> str:
        """Return a fully-qualified campaign_conversion_goal string."""
        return "customers/{customer_id}/campaignConversionGoals/{campaign_id}~{category}~{source}".format(customer_id=customer_id, campaign_id=campaign_id, category=category, source=source, )

    @staticmethod
    def parse_campaign_conversion_goal_path(path: str) -> Dict[str,str]:
        """Parse a campaign_conversion_goal path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/campaignConversionGoals/(?P<campaign_id>.+?)~(?P<category>.+?)~(?P<source>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_customer_client_link_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def customer_conversion_goal_path(customer_id: str,category: str,source: str,) -> str:
        """Return a fully-qualified customer_conversion_goal string."""
        return "customers/{customer_id}/customerConversionGoals/{category}~{source}".format(customer_id=customer_id, category=category, source=source, )

    @staticmethod
    def parse_customer_conversion_goal_path(path: str) -> Dict[str,str]:
        """Parse a customer_conversion_goal path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/customerConversionGoals/(?P<category>.+?)~(?P<source>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def customer_customizer_path(customer_id: str,customizer_attribute_id: str,) -> str:
        """Return a fully-qualified customer_customizer string."""
        return "customers/{customer_id}/customerCustomizers/{customizer_attribute_id}".format(customer_id=customer_id, customizer_attribute_id=customizer_attribute_id, )

    @staticmethod
    def parse_customer_customizer_path(path: str) -> Dict[str,str]:
        """Parse a customer_customizer path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/customerCustomizers/(?P<customizer_attribute_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def hotel_reconciliation_path(customer_id: str,commission_id: str,) -> str:
        """Return a fully-qualified hotel_reconciliation string."""
        return "customers/{customer_id}/hotelReconciliations/{commission_id}".format(customer_id=customer_id, commission_id=commission_id, )

    @staticmethod
    def parse_hotel_reconciliation_path(path: str) -> Dict[str,str]:
        """Parse a hotel_reconciliation path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/hotelReconciliations/(?P<commission_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def search(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.SearchGoogleAdsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.services.services.google_ads_service.pagers.SearchPager:
    ...
    def search_stream(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.SearchGoogleAdsStreamRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            Iterable[google.ads.googleads.v9.services.types.SearchGoogleAdsStreamResponse]:
                Response message for
                [GoogleAdsService.SearchStream][google.ads.googleads.v9.services.GoogleAdsService.SearchStream].
    ...
    def mutate(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateGoogleAdsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mutate_operations (:class:`Sequence[google.ads.googleads.v9.services.types.MutateOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateGoogleAdsResponse:
                Response message for
                [GoogleAdsService.Mutate][google.ads.googleads.v9.services.GoogleAdsService.Mutate].
