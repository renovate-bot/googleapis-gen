...
from .transports.base import DetailPlacementViewServiceTransport, DEFAULT_CLIENT_INFO
...
class DetailPlacementViewServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[DetailPlacementViewServiceTransport]]
...
class DetailPlacementViewServiceClient(metaclass=DetailPlacementViewServiceClientMeta):
    ...
    def transport(self) -> DetailPlacementViewServiceTransport:
        ...
        Returns:
            DetailPlacementViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the detail placement view service client.
    ...
    def get_detail_placement_view(self,
            request: Union[detail_placement_view_service.GetDetailPlacementViewRequest, dict] = None,
            *,
        ...
        if not isinstance(request, detail_placement_view_service.GetDetailPlacementViewRequest):
            request = detail_placement_view_service.GetDetailPlacementViewRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_detail_placement_view]
