...
class MobileDeviceConstantServiceTransport(abc.ABC):
    """Abstract transport class for MobileDeviceConstantService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_mobile_device_constant: gapic_v1.method.wrap_method(
                self.get_mobile_device_constant,
    ...
    def get_mobile_device_constant(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[mobile_device_constant.MobileDeviceConstant]
            ]]:
        raise NotImplementedError()
