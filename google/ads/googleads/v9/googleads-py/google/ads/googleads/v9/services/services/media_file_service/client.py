...
class MediaFileServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[MediaFileServiceTransport]]
...
class MediaFileServiceClient(metaclass=MediaFileServiceClientMeta):
    ...
    def transport(self) -> MediaFileServiceTransport:
        ...
        Returns:
            MediaFileServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the media file service client.
    ...
    def get_media_file(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetMediaFileRequest, dict]):
                The request object. Request message for
                [MediaFileService.GetMediaFile][google.ads.googleads.v9.services.MediaFileService.GetMediaFile]
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.MediaFile:
                A media file.
        """
    ...
    def mutate_media_files(self,
        ...
        `IdError <>`__ `ImageError <>`__ `InternalError <>`__
        `MediaBundleError <>`__ `MediaFileError <>`__
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateMediaFilesRequest, dict]):
                The request object. Request message for
                [MediaFileService.MutateMediaFiles][google.ads.googleads.v9.services.MediaFileService.MutateMediaFiles]
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v9.services.types.MediaFileOperation]):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateMediaFilesResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_media_files]
