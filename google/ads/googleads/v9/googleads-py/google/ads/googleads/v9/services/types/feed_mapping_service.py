...
class GetFeedMappingRequest(proto.Message):
    ...
    [FeedMappingService.GetFeedMapping][google.ads.googleads.v9.services.FeedMappingService.GetFeedMapping].
...
class MutateFeedMappingsRequest(proto.Message):
    r"""Request message for
    [FeedMappingService.MutateFeedMappings][google.ads.googleads.v9.services.FeedMappingService.MutateFeedMappings].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose feed
            mappings are being modified.
        operations (Sequence[google.ads.googleads.v9.services.types.FeedMappingOperation]):
...
class FeedMappingOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v9.resources.types.FeedMapping):
...
class MutateFeedMappingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v9.services.types.MutateFeedMappingResult]):
