...
class CampaignBidModifierServiceClient(metaclass=CampaignBidModifierServiceClientMeta):
    ...
    def transport(self) -> CampaignBidModifierServiceTransport:
        ...
        Returns:
            CampaignBidModifierServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the campaign bid modifier service client.
    ...
    def get_campaign_bid_modifier(self,
            request: Union[campaign_bid_modifier_service.GetCampaignBidModifierRequest, dict] = None,
            *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCampaignBidModifierRequest, dict]):
                The request object. Request message for
                [CampaignBidModifierService.GetCampaignBidModifier][google.ads.googleads.v9.services.CampaignBidModifierService.GetCampaignBidModifier].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CampaignBidModifier:
    ...
    def mutate_campaign_bid_modifiers(self,
            request: Union[campaign_bid_modifier_service.MutateCampaignBidModifiersRequest, dict] = None,
            *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCampaignBidModifiersRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v9.services.types.CampaignBidModifierOperation]):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCampaignBidModifiersResponse:
