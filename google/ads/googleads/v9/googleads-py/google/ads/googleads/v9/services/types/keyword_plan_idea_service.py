...
from google.ads.googleads.v9.enums.types import keyword_plan_keyword_annotation
from google.ads.googleads.v9.enums.types import keyword_plan_network as gage_keyword_plan_network
...
class GenerateKeywordIdeasRequest(proto.Message):
    ...
    [KeywordPlanIdeaService.GenerateKeywordIdeas][google.ads.googleads.v9.services.KeywordPlanIdeaService.GenerateKeywordIdeas].
    ...
    Attributes:
        ...
        page_size (int):
            ...
            results.
        keyword_plan_network (google.ads.googleads.v9.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            Targeting network.
        keyword_annotation (Sequence[google.ads.googleads.v9.enums.types.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation]):
            The keyword annotations to include in
            response.
        aggregate_metrics (google.ads.googleads.v9.common.types.KeywordPlanAggregateMetrics):
            The aggregate fields to include in response.
        historical_metrics_options (google.ads.googleads.v9.common.types.HistoricalMetricsOptions):
...
class GenerateKeywordIdeaResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.GenerateKeywordIdeaResult]):
            Results of generating keyword ideas.
        aggregate_metric_results (google.ads.googleads.v9.common.types.KeywordPlanAggregateMetricResults):
...
class GenerateKeywordIdeaResult(proto.Message):
    ...
    Attributes:
        ...
        keyword_annotations (google.ads.googleads.v9.common.types.KeywordAnnotations):
