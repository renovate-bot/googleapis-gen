...
class GetCustomerClientLinkRequest(proto.Message):
    ...
    [CustomerClientLinkService.GetCustomerClientLink][google.ads.googleads.v9.services.CustomerClientLinkService.GetCustomerClientLink].
...
class MutateCustomerClientLinkRequest(proto.Message):
    r"""Request message for
    [CustomerClientLinkService.MutateCustomerClientLink][google.ads.googleads.v9.services.CustomerClientLinkService.MutateCustomerClientLink].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            customer link are being modified.
        operation (google.ads.googleads.v9.services.types.CustomerClientLinkOperation):
...
class CustomerClientLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v9.resources.types.CustomerClientLink):
            Create operation: No resource name is
            expected for the new link.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v9.resources.types.CustomerClientLink):
...
class MutateCustomerClientLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v9.services.types.MutateCustomerClientLinkResult):
