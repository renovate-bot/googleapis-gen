...
from google.ads.googleads.v9.resources.types import ad as gagr_ad
...
class ApplyRecommendationRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            recommendation.
        operations (Sequence[google.ads.googleads.v9.services.types.ApplyRecommendationOperation]):
...
class ApplyRecommendationOperation(proto.Message):
    ...
    Attributes:
        resource_name (str):
            ...
            apply.
        campaign_budget (google.ads.googleads.v9.services.types.ApplyRecommendationOperation.CampaignBudgetParameters):
        ...
        text_ad (google.ads.googleads.v9.services.types.ApplyRecommendationOperation.TextAdParameters):
            Optional parameters to use when applying a
            text ad recommendation.
            This field is a member of `oneof`_ ``apply_parameters``.
        keyword (google.ads.googleads.v9.services.types.ApplyRecommendationOperation.KeywordParameters):
            Optional parameters to use when applying
            keyword recommendation.
            This field is a member of `oneof`_ ``apply_parameters``.
        target_cpa_opt_in (google.ads.googleads.v9.services.types.ApplyRecommendationOperation.TargetCpaOptInParameters):
            Optional parameters to use when applying
            target CPA opt-in recommendation.
            This field is a member of `oneof`_ ``apply_parameters``.
        target_roas_opt_in (google.ads.googleads.v9.services.types.ApplyRecommendationOperation.TargetRoasOptInParameters):
            Optional parameters to use when applying
            target ROAS opt-in recommendation.
            This field is a member of `oneof`_ ``apply_parameters``.
        callout_extension (google.ads.googleads.v9.services.types.ApplyRecommendationOperation.CalloutExtensionParameters):
            Parameters to use when applying callout
            extension recommendation.
            This field is a member of `oneof`_ ``apply_parameters``.
        call_extension (google.ads.googleads.v9.services.types.ApplyRecommendationOperation.CallExtensionParameters):
            Parameters to use when applying call
            extension recommendation.
            This field is a member of `oneof`_ ``apply_parameters``.
        sitelink_extension (google.ads.googleads.v9.services.types.ApplyRecommendationOperation.SitelinkExtensionParameters):
            Parameters to use when applying sitelink
            extension recommendation.
            This field is a member of `oneof`_ ``apply_parameters``.
        move_unused_budget (google.ads.googleads.v9.services.types.ApplyRecommendationOperation.MoveUnusedBudgetParameters):
            Parameters to use when applying move unused
            budget recommendation.
            This field is a member of `oneof`_ ``apply_parameters``.
        responsive_search_ad (google.ads.googleads.v9.services.types.ApplyRecommendationOperation.ResponsiveSearchAdParameters):
    ...
    class CalloutExtensionParameters(proto.Message):
        ...
        Attributes:
            callout_extensions (Sequence[google.ads.googleads.v9.common.types.CalloutFeedItem]):
    ...
    class CallExtensionParameters(proto.Message):
        ...
        Attributes:
            call_extensions (Sequence[google.ads.googleads.v9.common.types.CallFeedItem]):
    ...
    class SitelinkExtensionParameters(proto.Message):
        ...
        Attributes:
            sitelink_extensions (Sequence[google.ads.googleads.v9.common.types.SitelinkFeedItem]):
...
class ApplyRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.ApplyRecommendationResult]):
...
class DismissRecommendationRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer with the
            recommendation.
        operations (Sequence[google.ads.googleads.v9.services.types.DismissRecommendationRequest.DismissRecommendationOperation]):
...
class DismissRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.DismissRecommendationResponse.DismissRecommendationResult]):
