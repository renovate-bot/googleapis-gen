...
class ConversionValueRuleSetServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_conversion_value_rule_set: gapic_v1.method.wrap_method(
    ...
    @property
    def get_conversion_value_rule_set(self) -> Callable[
            [conversion_value_rule_set_service.GetConversionValueRuleSetRequest],
            Union[
                conversion_value_rule_set.ConversionValueRuleSet,
                Awaitable[conversion_value_rule_set.ConversionValueRuleSet]
            ]]:
        raise NotImplementedError()

    @property
    def mutate_conversion_value_rule_sets(self) -> Callable[
