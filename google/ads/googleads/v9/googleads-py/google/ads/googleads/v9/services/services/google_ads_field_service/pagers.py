...
class SearchGoogleAdsFieldsPager:
    ...
    :class:`google.ads.googleads.v9.services.types.SearchGoogleAdsFieldsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v9.services.types.SearchGoogleAdsFieldsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (:class:`google.ads.googleads.v9.services.types.SearchGoogleAdsFieldsRequest`):
                The initial request object.
            response (:class:`google.ads.googleads.v9.services.types.SearchGoogleAdsFieldsResponse`):
