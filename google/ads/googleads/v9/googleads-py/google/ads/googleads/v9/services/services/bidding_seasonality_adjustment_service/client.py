...
from .transports.base import BiddingSeasonalityAdjustmentServiceTransport, DEFAULT_CLIENT_INFO
...
class BiddingSeasonalityAdjustmentServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[BiddingSeasonalityAdjustmentServiceTransport]]
...
class BiddingSeasonalityAdjustmentServiceClient(metaclass=BiddingSeasonalityAdjustmentServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, BiddingSeasonalityAdjustmentServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the bidding seasonality adjustment service client.
        ...
        Args:
            ...
            transport (Union[str, ~.BiddingSeasonalityAdjustmentServiceTransport]): The
        ...
        if isinstance(transport, BiddingSeasonalityAdjustmentServiceTransport):
            ...
            self._transport = BiddingSeasonalityAdjustmentServiceGrpcTransport(
    ...
    def get_bidding_seasonality_adjustment(self,
        ...
        r"""Returns the requested seasonality adjustment in full
        detail.

        Args:
            request (Union[google.ads.googleads.v9.services.types.GetBiddingSeasonalityAdjustmentRequest, dict]):
            ...
            resource_name (:class:`str`):
                ...
                seasonality adjustment to fetch.
        ...
        Returns:
            google.ads.googleads.v9.resources.types.BiddingSeasonalityAdjustment:
                Represents a bidding seasonality
                adjustment.
        ...
        # in a bidding_seasonality_adjustment_service.GetBiddingSeasonalityAdjustmentRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, bidding_seasonality_adjustment_service.GetBiddingSeasonalityAdjustmentRequest):
            request = bidding_seasonality_adjustment_service.GetBiddingSeasonalityAdjustmentRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_bidding_seasonality_adjustment]
    ...
    def mutate_bidding_seasonality_adjustments(self,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateBiddingSeasonalityAdjustmentsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.BiddingSeasonalityAdjustmentOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateBiddingSeasonalityAdjustmentsResponse:
        ...
        if request is not None and any([customer_id, operations]):
           ...
           # Minor optimization to avoid making a copy if the user passes
        # in a bidding_seasonality_adjustment_service.MutateBiddingSeasonalityAdjustmentsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, bidding_seasonality_adjustment_service.MutateBiddingSeasonalityAdjustmentsRequest):
            request = bidding_seasonality_adjustment_service.MutateBiddingSeasonalityAdjustmentsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_bidding_seasonality_adjustments]
