...
class googleadsCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'add_offline_user_data_job_operations': ('resource_name', 'operations', 'enable_partial_failure', 'enable_warnings', 'validate_only', ),
        ...
        'create_customer_client': ('customer_id', 'customer_client', 'email_address', 'access_role', 'validate_only', ),
        'create_offline_user_data_job': ('customer_id', 'job', 'validate_only', 'enable_match_rate_range_preview', ),
        'dismiss_recommendation': ('customer_id', 'operations', 'partial_failure', ),
        'end_campaign_experiment': ('campaign_experiment', 'validate_only', ),
        'generate_forecast_curve': ('keyword_plan', ),
        'generate_forecast_metrics': ('keyword_plan', ),
        'generate_forecast_time_series': ('keyword_plan', ),
        'generate_historical_metrics': ('keyword_plan', 'aggregate_metrics', 'historical_metrics_options', ),
        'generate_keyword_ideas': ('customer_id', 'language', 'geo_target_constants', 'include_adult_keywords', 'page_token', 'page_size', 'keyword_plan_network', 'keyword_annotation', 'aggregate_metrics', 'historical_metrics_options', 'keyword_and_url_seed', 'keyword_seed', 'url_seed', 'site_seed', ),
        'generate_product_mix_ideas': ('customer_id', 'plannable_location_id', 'currency_code', 'budget_micros', 'preferences', ),
        'generate_reach_forecast': ('customer_id', 'campaign_duration', 'planned_products', 'currency_code', 'cookie_frequency_cap', 'cookie_frequency_cap_setting', 'min_effective_frequency', 'effective_frequency_limit', 'targeting', ),
        'get_accessible_bidding_strategy': ('resource_name', ),
        ...
        'get_ad_group_asset': ('resource_name', ),
        ...
        'get_asset_field_type_view': ('resource_name', ),
        'get_asset_group': ('resource_name', ),
        'get_asset_group_asset': ('resource_name', ),
        'get_batch_job': ('resource_name', ),
        'get_bidding_data_exclusion': ('resource_name', ),
        'get_bidding_seasonality_adjustment': ('resource_name', ),
        'get_bidding_strategy': ('resource_name', ),
        'get_bidding_strategy_simulation': ('resource_name', ),
        ...
        'get_campaign_simulation': ('resource_name', ),
        'get_carrier_constant': ('resource_name', ),
        'get_change_status': ('resource_name', ),
        'get_click_view': ('resource_name', ),
        'get_combined_audience': ('resource_name', ),
        'get_conversion_action': ('resource_name', ),
        'get_conversion_custom_variable': ('resource_name', ),
        'get_conversion_value_rule': ('resource_name', ),
        'get_conversion_value_rule_set': ('resource_name', ),
        'get_currency_constant': ('resource_name', ),
        'get_custom_audience': ('resource_name', ),
        'get_customer': ('resource_name', ),
        'get_customer_asset': ('resource_name', ),
        ...
        'get_customer_user_access': ('resource_name', ),
        'get_customer_user_access_invitation': ('resource_name', ),
        'get_custom_interest': ('resource_name', ),
        'get_detailed_demographic': ('resource_name', ),
        ...
        'get_feed_item_set': ('resource_name', ),
        'get_feed_item_set_link': ('resource_name', ),
        ...
        'get_keyword_theme_constant': ('resource_name', ),
        ...
        'get_smart_campaign_search_term_view': ('resource_name', ),
        'get_smart_campaign_setting': ('resource_name', ),
        ...
        'get_webpage_view': ('resource_name', ),
        'graduate_campaign_experiment': ('campaign_experiment', 'campaign_budget', 'validate_only', ),
        'list_accessible_customers': (),
        'list_batch_job_results': ('resource_name', 'page_token', 'page_size', 'response_content_type', ),
        ...
        'move_manager_link': ('customer_id', 'previous_customer_manager_link', 'new_manager', 'validate_only', ),
        ...
        'mutate_ad_group_assets': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        ...
        'mutate_ad_group_criterion_customizers': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_ad_group_criterion_labels': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
        'mutate_ad_group_customizers': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        ...
        'mutate_ad_parameters': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_ads': ('customer_id', 'operations', 'partial_failure', 'response_content_type', 'validate_only', ),
        'mutate_asset_group_assets': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
        'mutate_asset_group_listing_group_filters': ('customer_id', 'operations', 'validate_only', 'response_content_type', ),
        'mutate_asset_groups': ('customer_id', 'operations', 'validate_only', ),
        'mutate_assets': ('customer_id', 'operations', 'partial_failure', 'response_content_type', 'validate_only', ),
        'mutate_asset_set_assets': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_asset_sets': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_batch_job': ('customer_id', 'operation', ),
        'mutate_bidding_data_exclusions': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_bidding_seasonality_adjustments': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_bidding_strategies': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_billing_setup': ('customer_id', 'operation', ),
        'mutate_campaign_assets': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_campaign_asset_sets': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_campaign_bid_modifiers': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_campaign_budgets': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_campaign_conversion_goals': ('customer_id', 'operations', 'validate_only', ),
        'mutate_campaign_criteria': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_campaign_customizers': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        ...
        'mutate_campaign_extension_settings': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        ...
        'mutate_campaign_shared_sets': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_conversion_actions': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_conversion_custom_variables': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_conversion_goal_campaign_configs': ('customer_id', 'operations', 'validate_only', 'response_content_type', ),
        'mutate_conversion_value_rules': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_conversion_value_rule_sets': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_custom_audiences': ('customer_id', 'operations', 'validate_only', ),
        'mutate_custom_conversion_goals': ('customer_id', 'operations', 'validate_only', 'response_content_type', ),
        'mutate_customer': ('customer_id', 'operation', 'validate_only', 'response_content_type', ),
        'mutate_customer_assets': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_customer_client_link': ('customer_id', 'operation', 'validate_only', ),
        'mutate_customer_conversion_goals': ('customer_id', 'operations', 'validate_only', ),
        'mutate_customer_customizers': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_customer_extension_settings': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        ...
        'mutate_customer_manager_link': ('customer_id', 'operations', 'validate_only', ),
        'mutate_customer_negative_criteria': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_customer_user_access': ('customer_id', 'operation', ),
        'mutate_customer_user_access_invitation': ('customer_id', 'operation', ),
        'mutate_custom_interests': ('customer_id', 'operations', 'validate_only', ),
        'mutate_customizer_attributes': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        ...
        'mutate_feed_item_set_links': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
        'mutate_feed_item_sets': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
        'mutate_feed_item_targets': ('customer_id', 'operations', 'partial_failure', 'response_content_type', 'validate_only', ),
        'mutate_feed_mappings': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        ...
        'mutate_merchant_center_link': ('customer_id', 'operation', 'validate_only', ),
        'mutate_remarketing_actions': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
        'mutate_shared_criteria': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_shared_sets': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_smart_campaign_settings': ('customer_id', 'operations', 'partial_failure', 'validate_only', 'response_content_type', ),
        'mutate_user_lists': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
        'promote_campaign_draft': ('campaign_draft', 'validate_only', ),
        'promote_campaign_experiment': ('campaign_experiment', 'validate_only', ),
        'regenerate_shareable_link_id': ('resource_name', ),
        'run_batch_job': ('resource_name', ),
        'run_offline_user_data_job': ('resource_name', 'validate_only', ),
        ...
        'suggest_keyword_theme_constants': ('query_text', 'country_code', 'language_code', ),
        'suggest_keyword_themes': ('customer_id', 'suggestion_info', ),
        'suggest_smart_campaign_ad': ('customer_id', 'suggestion_info', ),
        'suggest_smart_campaign_budget_options': ('customer_id', 'campaign', 'suggestion_info', ),
