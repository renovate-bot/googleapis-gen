 ...
 */
import * as gapicConfig from './customer_asset_service_client_config.json';
...
export class CustomerAssetServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CustomerAssetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerAssetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CustomerAssetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CustomerAssetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerAssetServiceStubMethods =
        ['getCustomerAsset', 'mutateCustomerAssets'];
    for (const methodName of customerAssetServiceStubMethods) {
      const callPromise = this.customerAssetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
