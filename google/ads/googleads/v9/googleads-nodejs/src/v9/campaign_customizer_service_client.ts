 ...
 */
import * as gapicConfig from './campaign_customizer_service_client_config.json';
 ...
 * @memberof v9
 */
export class CampaignCustomizerServiceClient {
  ...
  campaignCustomizerServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignCustomizerServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CampaignCustomizerService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignCustomizerServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CampaignCustomizerService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CampaignCustomizerService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignCustomizerServiceStubMethods =
        ['mutateCampaignCustomizers'];
    for (const methodName of campaignCustomizerServiceStubMethods) {
      const callPromise = this.campaignCustomizerServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
