 ...
 */
import * as gapicConfig from './ad_schedule_view_service_client_config.json';
 ...
 * @memberof v9
 */
export class AdScheduleViewServiceClient {
  ...
  adScheduleViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdScheduleViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.AdScheduleViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adScheduleViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.AdScheduleViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.AdScheduleViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adScheduleViewServiceStubMethods =
        ['getAdScheduleView'];
    for (const methodName of adScheduleViewServiceStubMethods) {
      const callPromise = this.adScheduleViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getAdScheduleView(
      request?: protos.google.ads.googleads.v9.services.IGetAdScheduleViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IAdScheduleView,
        protos.google.ads.googleads.v9.services.IGetAdScheduleViewRequest|undefined, {}|undefined
      ]>;
  getAdScheduleView(
      request: protos.google.ads.googleads.v9.services.IGetAdScheduleViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IAdScheduleView,
          protos.google.ads.googleads.v9.services.IGetAdScheduleViewRequest|null|undefined,
          {}|null|undefined>): void;
  getAdScheduleView(
      request: protos.google.ads.googleads.v9.services.IGetAdScheduleViewRequest,
      callback: Callback<
