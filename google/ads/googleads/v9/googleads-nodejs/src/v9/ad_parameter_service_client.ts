 ...
 */
import * as gapicConfig from './ad_parameter_service_client_config.json';
...
export class AdParameterServiceClient {
  ...
  adParameterServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdParameterServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.AdParameterService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adParameterServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.AdParameterService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.AdParameterService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adParameterServiceStubMethods =
        ['getAdParameter', 'mutateAdParameters'];
    for (const methodName of adParameterServiceStubMethods) {
      const callPromise = this.adParameterServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
