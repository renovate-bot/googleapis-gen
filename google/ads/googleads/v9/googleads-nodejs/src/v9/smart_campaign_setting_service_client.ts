 ...
 */
import * as gapicConfig from './smart_campaign_setting_service_client_config.json';
...
export class SmartCampaignSettingServiceClient {
  ...
  smartCampaignSettingServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof SmartCampaignSettingServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.SmartCampaignSettingService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.smartCampaignSettingServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.SmartCampaignSettingService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.SmartCampaignSettingService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const smartCampaignSettingServiceStubMethods =
        ['getSmartCampaignSetting', 'mutateSmartCampaignSettings'];
    for (const methodName of smartCampaignSettingServiceStubMethods) {
      const callPromise = this.smartCampaignSettingServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getSmartCampaignSetting(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v9.services.IGetSmartCampaignSettingRequest|undefined, {}|undefined
      ]>;
  getSmartCampaignSetting(
      request: protos.google.ads.googleads.v9.services.IGetSmartCampaignSettingRequest,
      options: CallOptions,
