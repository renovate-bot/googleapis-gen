 ...
 */
import * as gapicConfig from './bidding_strategy_simulation_service_client_config.json';
 ...
 * @memberof v9
 */
export class BiddingStrategySimulationServiceClient {
  ...
  biddingStrategySimulationServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof BiddingStrategySimulationServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.BiddingStrategySimulationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.biddingStrategySimulationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.BiddingStrategySimulationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.BiddingStrategySimulationService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const biddingStrategySimulationServiceStubMethods =
        ['getBiddingStrategySimulation'];
    for (const methodName of biddingStrategySimulationServiceStubMethods) {
      const callPromise = this.biddingStrategySimulationServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getBiddingStrategySimulation(
      request?: protos.google.ads.googleads.v9.services.IGetBiddingStrategySimulationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IBiddingStrategySimulation,
        protos.google.ads.googleads.v9.services.IGetBiddingStrategySimulationRequest|undefined, {}|undefined
      ]>;
  getBiddingStrategySimulation(
      request: protos.google.ads.googleads.v9.services.IGetBiddingStrategySimulationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IBiddingStrategySimulation,
          protos.google.ads.googleads.v9.services.IGetBiddingStrategySimulationRequest|null|undefined,
          {}|null|undefined>): void;
  getBiddingStrategySimulation(
      request: protos.google.ads.googleads.v9.services.IGetBiddingStrategySimulationRequest,
      callback: Callback<
