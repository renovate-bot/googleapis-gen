 ...
 */
import * as gapicConfig from './keyword_plan_campaign_keyword_service_client_config.json';
...
export class KeywordPlanCampaignKeywordServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.KeywordPlanCampaignKeywordService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordPlanCampaignKeywordServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.KeywordPlanCampaignKeywordService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.KeywordPlanCampaignKeywordService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const keywordPlanCampaignKeywordServiceStubMethods =
        ['getKeywordPlanCampaignKeyword', 'mutateKeywordPlanCampaignKeywords'];
    for (const methodName of keywordPlanCampaignKeywordServiceStubMethods) {
      const callPromise = this.keywordPlanCampaignKeywordServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getKeywordPlanCampaignKeyword(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v9.services.IGetKeywordPlanCampaignKeywordRequest|undefined, {}|undefined
      ]>;
  getKeywordPlanCampaignKeyword(
      request: protos.google.ads.googleads.v9.services.IGetKeywordPlanCampaignKeywordRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IKeywordPlanCampaignKeyword,
          protos.google.ads.googleads.v9.services.IGetKeywordPlanCampaignKeywordRequest|null|undefined,
          {}|null|undefined>): void;
  getKeywordPlanCampaignKeyword(
      request: protos.google.ads.googleads.v9.services.IGetKeywordPlanCampaignKeywordRequest,
      callback: Callback<
 ...
 */
  mutateKeywordPlanCampaignKeywords(
      request?: protos.google.ads.googleads.v9.services.IMutateKeywordPlanCampaignKeywordsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateKeywordPlanCampaignKeywordsResponse,
        protos.google.ads.googleads.v9.services.IMutateKeywordPlanCampaignKeywordsRequest|undefined, {}|undefined
      ]>;
  mutateKeywordPlanCampaignKeywords(
      request: protos.google.ads.googleads.v9.services.IMutateKeywordPlanCampaignKeywordsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateKeywordPlanCampaignKeywordsResponse,
          protos.google.ads.googleads.v9.services.IMutateKeywordPlanCampaignKeywordsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateKeywordPlanCampaignKeywords(
      request: protos.google.ads.googleads.v9.services.IMutateKeywordPlanCampaignKeywordsRequest,
      callback: Callback<
