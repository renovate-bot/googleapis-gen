 ...
 */
import * as gapicConfig from './conversion_upload_service_client_config.json';
...
export class ConversionUploadServiceClient {
  ...
  conversionUploadServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ConversionUploadServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.ConversionUploadService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversionUploadServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.ConversionUploadService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.ConversionUploadService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const conversionUploadServiceStubMethods =
        ['uploadClickConversions', 'uploadCallConversions'];
    for (const methodName of conversionUploadServiceStubMethods) {
      const callPromise = this.conversionUploadServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  uploadClickConversions(
      request?: protos.google.ads.googleads.v9.services.IUploadClickConversionsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IUploadClickConversionsResponse,
        protos.google.ads.googleads.v9.services.IUploadClickConversionsRequest|undefined, {}|undefined
      ]>;
  uploadClickConversions(
      request: protos.google.ads.googleads.v9.services.IUploadClickConversionsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IUploadClickConversionsResponse,
          protos.google.ads.googleads.v9.services.IUploadClickConversionsRequest|null|undefined,
          {}|null|undefined>): void;
  uploadClickConversions(
      request: protos.google.ads.googleads.v9.services.IUploadClickConversionsRequest,
      callback: Callback<
 ...
 */
  uploadCallConversions(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v9.services.IUploadCallConversionsRequest|undefined, {}|undefined
      ]>;
  uploadCallConversions(
      request: protos.google.ads.googleads.v9.services.IUploadCallConversionsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IUploadCallConversionsResponse,
          protos.google.ads.googleads.v9.services.IUploadCallConversionsRequest|null|undefined,
          {}|null|undefined>): void;
  uploadCallConversions(
      request: protos.google.ads.googleads.v9.services.IUploadCallConversionsRequest,
      callback: Callback<
