 ...
 */
import * as gapicConfig from './display_keyword_view_service_client_config.json';
...
export class DisplayKeywordViewServiceClient {
  ...
  displayKeywordViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof DisplayKeywordViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.DisplayKeywordViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.displayKeywordViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.DisplayKeywordViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.DisplayKeywordViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const displayKeywordViewServiceStubMethods =
        ['getDisplayKeywordView'];
    for (const methodName of displayKeywordViewServiceStubMethods) {
      const callPromise = this.displayKeywordViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getDisplayKeywordView(
      request?: protos.google.ads.googleads.v9.services.IGetDisplayKeywordViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IDisplayKeywordView,
        protos.google.ads.googleads.v9.services.IGetDisplayKeywordViewRequest|undefined, {}|undefined
      ]>;
  getDisplayKeywordView(
      request: protos.google.ads.googleads.v9.services.IGetDisplayKeywordViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IDisplayKeywordView,
          protos.google.ads.googleads.v9.services.IGetDisplayKeywordViewRequest|null|undefined,
          {}|null|undefined>): void;
  getDisplayKeywordView(
      request: protos.google.ads.googleads.v9.services.IGetDisplayKeywordViewRequest,
      callback: Callback<
