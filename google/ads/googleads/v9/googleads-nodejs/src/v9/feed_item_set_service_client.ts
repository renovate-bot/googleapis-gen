 ...
 */
import * as gapicConfig from './feed_item_set_service_client_config.json';
 ...
 * @memberof v9
 */
export class FeedItemSetServiceClient {
  ...
  feedItemSetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof FeedItemSetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.FeedItemSetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.feedItemSetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.FeedItemSetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.FeedItemSetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const feedItemSetServiceStubMethods =
        ['getFeedItemSet', 'mutateFeedItemSets'];
    for (const methodName of feedItemSetServiceStubMethods) {
      const callPromise = this.feedItemSetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
