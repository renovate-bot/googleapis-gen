 ...
 */
import * as gapicConfig from './combined_audience_service_client_config.json';
 ...
 * @memberof v9
 */
export class CombinedAudienceServiceClient {
  ...
  combinedAudienceServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CombinedAudienceServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CombinedAudienceService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.combinedAudienceServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CombinedAudienceService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CombinedAudienceService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const combinedAudienceServiceStubMethods =
        ['getCombinedAudience'];
    for (const methodName of combinedAudienceServiceStubMethods) {
      const callPromise = this.combinedAudienceServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
