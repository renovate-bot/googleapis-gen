 ...
 */
import * as gapicConfig from './user_location_view_service_client_config.json';
 ...
 * @memberof v9
 */
export class UserLocationViewServiceClient {
  ...
  userLocationViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof UserLocationViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.UserLocationViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.userLocationViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.UserLocationViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.UserLocationViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const userLocationViewServiceStubMethods =
        ['getUserLocationView'];
    for (const methodName of userLocationViewServiceStubMethods) {
      const callPromise = this.userLocationViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
