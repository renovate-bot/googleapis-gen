...
export class AccountBudgetProposalServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.AccountBudgetProposalService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.accountBudgetProposalServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.AccountBudgetProposalService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.AccountBudgetProposalService,
