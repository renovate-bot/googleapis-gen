 ...
 */
import * as gapicConfig from './campaign_asset_set_service_client_config.json';
 ...
 * @memberof v9
 */
export class CampaignAssetSetServiceClient {
  ...
  campaignAssetSetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignAssetSetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CampaignAssetSetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignAssetSetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CampaignAssetSetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CampaignAssetSetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignAssetSetServiceStubMethods =
        ['mutateCampaignAssetSets'];
    for (const methodName of campaignAssetSetServiceStubMethods) {
      const callPromise = this.campaignAssetSetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
