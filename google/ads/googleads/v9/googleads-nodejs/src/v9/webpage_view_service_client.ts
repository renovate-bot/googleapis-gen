 ...
 */
import * as gapicConfig from './webpage_view_service_client_config.json';
 ...
 * @memberof v9
 */
export class WebpageViewServiceClient {
  ...
  webpageViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof WebpageViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.WebpageViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.webpageViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.WebpageViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.WebpageViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const webpageViewServiceStubMethods =
        ['getWebpageView'];
    for (const methodName of webpageViewServiceStubMethods) {
      const callPromise = this.webpageViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getWebpageView(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v9.services.IGetWebpageViewRequest|undefined, {}|undefined
      ]>;
  getWebpageView(
      request: protos.google.ads.googleads.v9.services.IGetWebpageViewRequest,
      options: CallOptions,
