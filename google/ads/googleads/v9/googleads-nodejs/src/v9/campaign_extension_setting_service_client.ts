 ...
 */
import * as gapicConfig from './campaign_extension_setting_service_client_config.json';
...
export class CampaignExtensionSettingServiceClient {
  ...
  campaignExtensionSettingServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignExtensionSettingServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CampaignExtensionSettingService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignExtensionSettingServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CampaignExtensionSettingService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CampaignExtensionSettingService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignExtensionSettingServiceStubMethods =
        ['getCampaignExtensionSetting', 'mutateCampaignExtensionSettings'];
    for (const methodName of campaignExtensionSettingServiceStubMethods) {
      const callPromise = this.campaignExtensionSettingServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getCampaignExtensionSetting(
      request?: protos.google.ads.googleads.v9.services.IGetCampaignExtensionSettingRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.ICampaignExtensionSetting,
        protos.google.ads.googleads.v9.services.IGetCampaignExtensionSettingRequest|undefined, {}|undefined
      ]>;
  getCampaignExtensionSetting(
      request: protos.google.ads.googleads.v9.services.IGetCampaignExtensionSettingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.ICampaignExtensionSetting,
          protos.google.ads.googleads.v9.services.IGetCampaignExtensionSettingRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignExtensionSetting(
      request: protos.google.ads.googleads.v9.services.IGetCampaignExtensionSettingRequest,
      callback: Callback<
 ...
 */
  ...
  mutateCampaignExtensionSettings(
      request?: protos.google.ads.googleads.v9.services.IMutateCampaignExtensionSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateCampaignExtensionSettingsResponse,
        protos.google.ads.googleads.v9.services.IMutateCampaignExtensionSettingsRequest|undefined, {}|undefined
      ]>;
  mutateCampaignExtensionSettings(
      request: protos.google.ads.googleads.v9.services.IMutateCampaignExtensionSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateCampaignExtensionSettingsResponse,
          protos.google.ads.googleads.v9.services.IMutateCampaignExtensionSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCampaignExtensionSettings(
      request: protos.google.ads.googleads.v9.services.IMutateCampaignExtensionSettingsRequest,
      callback: Callback<
