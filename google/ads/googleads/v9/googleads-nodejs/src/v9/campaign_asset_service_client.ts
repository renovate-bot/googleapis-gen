 ...
 */
import * as gapicConfig from './campaign_asset_service_client_config.json';
 ...
 * @memberof v9
 */
export class CampaignAssetServiceClient {
  ...
  campaignAssetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignAssetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CampaignAssetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignAssetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CampaignAssetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CampaignAssetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignAssetServiceStubMethods =
        ['getCampaignAsset', 'mutateCampaignAssets'];
    for (const methodName of campaignAssetServiceStubMethods) {
      const callPromise = this.campaignAssetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getCampaignAsset(
      request?: protos.google.ads.googleads.v9.services.IGetCampaignAssetRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.ICampaignAsset,
        protos.google.ads.googleads.v9.services.IGetCampaignAssetRequest|undefined, {}|undefined
      ]>;
  getCampaignAsset(
      request: protos.google.ads.googleads.v9.services.IGetCampaignAssetRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.ICampaignAsset,
          protos.google.ads.googleads.v9.services.IGetCampaignAssetRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignAsset(
      request: protos.google.ads.googleads.v9.services.IGetCampaignAssetRequest,
      callback: Callback<
 ...
 */
  ...
  mutateCampaignAssets(
      request?: protos.google.ads.googleads.v9.services.IMutateCampaignAssetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateCampaignAssetsResponse,
        protos.google.ads.googleads.v9.services.IMutateCampaignAssetsRequest|undefined, {}|undefined
      ]>;
  mutateCampaignAssets(
      request: protos.google.ads.googleads.v9.services.IMutateCampaignAssetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateCampaignAssetsResponse,
          protos.google.ads.googleads.v9.services.IMutateCampaignAssetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCampaignAssets(
      request: protos.google.ads.googleads.v9.services.IMutateCampaignAssetsRequest,
      callback: Callback<
