 ...
 */
import * as gapicConfig from './customer_user_access_invitation_service_client_config.json';
 ...
 * @memberof v9
 */
export class CustomerUserAccessInvitationServiceClient {
  ...
  customerUserAccessInvitationServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CustomerUserAccessInvitationServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CustomerUserAccessInvitationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerUserAccessInvitationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CustomerUserAccessInvitationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CustomerUserAccessInvitationService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerUserAccessInvitationServiceStubMethods =
        ['getCustomerUserAccessInvitation', 'mutateCustomerUserAccessInvitation'];
    for (const methodName of customerUserAccessInvitationServiceStubMethods) {
      const callPromise = this.customerUserAccessInvitationServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getCustomerUserAccessInvitation(
      request?: protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.ICustomerUserAccessInvitation,
        protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest|undefined, {}|undefined
      ]>;
  getCustomerUserAccessInvitation(
      request: protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.ICustomerUserAccessInvitation,
          protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomerUserAccessInvitation(
      request: protos.google.ads.googleads.v9.services.IGetCustomerUserAccessInvitationRequest,
      callback: Callback<
 ...
 */
  mutateCustomerUserAccessInvitation(
      request?: protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationResponse,
        protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest|undefined, {}|undefined
      ]>;
  mutateCustomerUserAccessInvitation(
      request: protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationResponse,
          protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerUserAccessInvitation(
      request: protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationRequest,
      callback: Callback<
