 ...
 */
import * as gapicConfig from './asset_field_type_view_service_client_config.json';
 ...
 * @memberof v9
 */
export class AssetFieldTypeViewServiceClient {
  ...
  assetFieldTypeViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AssetFieldTypeViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.AssetFieldTypeViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.assetFieldTypeViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.AssetFieldTypeViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.AssetFieldTypeViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const assetFieldTypeViewServiceStubMethods =
        ['getAssetFieldTypeView'];
    for (const methodName of assetFieldTypeViewServiceStubMethods) {
      const callPromise = this.assetFieldTypeViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getAssetFieldTypeView(
      request?: protos.google.ads.googleads.v9.services.IGetAssetFieldTypeViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IAssetFieldTypeView,
        protos.google.ads.googleads.v9.services.IGetAssetFieldTypeViewRequest|undefined, {}|undefined
      ]>;
  getAssetFieldTypeView(
      request: protos.google.ads.googleads.v9.services.IGetAssetFieldTypeViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IAssetFieldTypeView,
          protos.google.ads.googleads.v9.services.IGetAssetFieldTypeViewRequest|null|undefined,
          {}|null|undefined>): void;
  getAssetFieldTypeView(
      request: protos.google.ads.googleads.v9.services.IGetAssetFieldTypeViewRequest,
      callback: Callback<
