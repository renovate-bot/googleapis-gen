 ...
 */
import * as gapicConfig from './user_data_service_client_config.json';
...
export class UserDataServiceClient {
  ...
  userDataServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof UserDataServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.UserDataService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.userDataServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.UserDataService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.UserDataService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const userDataServiceStubMethods =
        ['uploadUserData'];
    for (const methodName of userDataServiceStubMethods) {
      const callPromise = this.userDataServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  uploadUserData(
      request?: protos.google.ads.googleads.v9.services.IUploadUserDataRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IUploadUserDataResponse,
        protos.google.ads.googleads.v9.services.IUploadUserDataRequest|undefined, {}|undefined
      ]>;
  uploadUserData(
      request: protos.google.ads.googleads.v9.services.IUploadUserDataRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IUploadUserDataResponse,
          protos.google.ads.googleads.v9.services.IUploadUserDataRequest|null|undefined,
          {}|null|undefined>): void;
  uploadUserData(
      request: protos.google.ads.googleads.v9.services.IUploadUserDataRequest,
      callback: Callback<
