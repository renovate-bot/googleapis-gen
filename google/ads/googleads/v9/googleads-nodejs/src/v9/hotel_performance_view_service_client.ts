 ...
 */
import * as gapicConfig from './hotel_performance_view_service_client_config.json';
...
export class HotelPerformanceViewServiceClient {
  ...
  hotelPerformanceViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof HotelPerformanceViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.HotelPerformanceViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.hotelPerformanceViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.HotelPerformanceViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.HotelPerformanceViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const hotelPerformanceViewServiceStubMethods =
        ['getHotelPerformanceView'];
    for (const methodName of hotelPerformanceViewServiceStubMethods) {
      const callPromise = this.hotelPerformanceViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
