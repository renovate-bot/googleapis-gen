 ...
 */
import * as gapicConfig from './smart_campaign_suggest_service_client_config.json';
 ...
 * @memberof v9
 */
export class SmartCampaignSuggestServiceClient {
  ...
  smartCampaignSuggestServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof SmartCampaignSuggestServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.SmartCampaignSuggestService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.smartCampaignSuggestServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.SmartCampaignSuggestService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.SmartCampaignSuggestService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const smartCampaignSuggestServiceStubMethods =
        ['suggestSmartCampaignBudgetOptions', 'suggestSmartCampaignAd', 'suggestKeywordThemes'];
  ...
  suggestSmartCampaignBudgetOptions(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v9.services.ISuggestSmartCampaignBudgetOptionsRequest|undefined, {}|undefined
      ]>;
  suggestSmartCampaignBudgetOptions(
      request: protos.google.ads.googleads.v9.services.ISuggestSmartCampaignBudgetOptionsRequest,
      options: CallOptions,
