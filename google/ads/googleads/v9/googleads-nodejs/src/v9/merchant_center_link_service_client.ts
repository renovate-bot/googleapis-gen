 ...
 */
import * as gapicConfig from './merchant_center_link_service_client_config.json';
...
export class MerchantCenterLinkServiceClient {
  ...
  merchantCenterLinkServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof MerchantCenterLinkServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.MerchantCenterLinkService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.merchantCenterLinkServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.MerchantCenterLinkService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.MerchantCenterLinkService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const merchantCenterLinkServiceStubMethods =
        ['listMerchantCenterLinks', 'getMerchantCenterLink', 'mutateMerchantCenterLink'];
    for (const methodName of merchantCenterLinkServiceStubMethods) {
      const callPromise = this.merchantCenterLinkServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  listMerchantCenterLinks(
      request?: protos.google.ads.googleads.v9.services.IListMerchantCenterLinksRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IListMerchantCenterLinksResponse,
        protos.google.ads.googleads.v9.services.IListMerchantCenterLinksRequest|undefined, {}|undefined
      ]>;
  listMerchantCenterLinks(
      request: protos.google.ads.googleads.v9.services.IListMerchantCenterLinksRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IListMerchantCenterLinksResponse,
          protos.google.ads.googleads.v9.services.IListMerchantCenterLinksRequest|null|undefined,
          {}|null|undefined>): void;
  listMerchantCenterLinks(
      request: protos.google.ads.googleads.v9.services.IListMerchantCenterLinksRequest,
      callback: Callback<
 ...
 */
  ...
  getMerchantCenterLink(
      request?: protos.google.ads.googleads.v9.services.IGetMerchantCenterLinkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IMerchantCenterLink,
        protos.google.ads.googleads.v9.services.IGetMerchantCenterLinkRequest|undefined, {}|undefined
      ]>;
  getMerchantCenterLink(
      request: protos.google.ads.googleads.v9.services.IGetMerchantCenterLinkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IMerchantCenterLink,
          protos.google.ads.googleads.v9.services.IGetMerchantCenterLinkRequest|null|undefined,
          {}|null|undefined>): void;
  getMerchantCenterLink(
      request: protos.google.ads.googleads.v9.services.IGetMerchantCenterLinkRequest,
      callback: Callback<
 ...
 */
  ...
  mutateMerchantCenterLink(
      request?: protos.google.ads.googleads.v9.services.IMutateMerchantCenterLinkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateMerchantCenterLinkResponse,
        protos.google.ads.googleads.v9.services.IMutateMerchantCenterLinkRequest|undefined, {}|undefined
      ]>;
  mutateMerchantCenterLink(
      request: protos.google.ads.googleads.v9.services.IMutateMerchantCenterLinkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateMerchantCenterLinkResponse,
          protos.google.ads.googleads.v9.services.IMutateMerchantCenterLinkRequest|null|undefined,
          {}|null|undefined>): void;
  mutateMerchantCenterLink(
      request: protos.google.ads.googleads.v9.services.IMutateMerchantCenterLinkRequest,
      callback: Callback<
