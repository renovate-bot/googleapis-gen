 ...
 */
import * as gapicConfig from './product_bidding_category_constant_service_client_config.json';
...
export class ProductBiddingCategoryConstantServiceClient {
  ...
  productBiddingCategoryConstantServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ProductBiddingCategoryConstantServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.ProductBiddingCategoryConstantService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.productBiddingCategoryConstantServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.ProductBiddingCategoryConstantService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.ProductBiddingCategoryConstantService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const productBiddingCategoryConstantServiceStubMethods =
        ['getProductBiddingCategoryConstant'];
    for (const methodName of productBiddingCategoryConstantServiceStubMethods) {
      const callPromise = this.productBiddingCategoryConstantServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getProductBiddingCategoryConstant(
      request?: protos.google.ads.googleads.v9.services.IGetProductBiddingCategoryConstantRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IProductBiddingCategoryConstant,
        protos.google.ads.googleads.v9.services.IGetProductBiddingCategoryConstantRequest|undefined, {}|undefined
      ]>;
  getProductBiddingCategoryConstant(
      request: protos.google.ads.googleads.v9.services.IGetProductBiddingCategoryConstantRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IProductBiddingCategoryConstant,
          protos.google.ads.googleads.v9.services.IGetProductBiddingCategoryConstantRequest|null|undefined,
          {}|null|undefined>): void;
  getProductBiddingCategoryConstant(
      request: protos.google.ads.googleads.v9.services.IGetProductBiddingCategoryConstantRequest,
      callback: Callback<
