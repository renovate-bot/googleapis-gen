 ...
 */
import * as gapicConfig from './custom_conversion_goal_service_client_config.json';
 ...
 * @memberof v9
 */
export class CustomConversionGoalServiceClient {
  ...
  customConversionGoalServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CustomConversionGoalServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CustomConversionGoalService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customConversionGoalServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CustomConversionGoalService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CustomConversionGoalService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customConversionGoalServiceStubMethods =
        ['mutateCustomConversionGoals'];
    for (const methodName of customConversionGoalServiceStubMethods) {
      const callPromise = this.customConversionGoalServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
