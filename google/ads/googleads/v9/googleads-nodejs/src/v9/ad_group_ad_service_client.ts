 ...
 */
import * as gapicConfig from './ad_group_ad_service_client_config.json';
...
export class AdGroupAdServiceClient {
  ...
  adGroupAdServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdGroupAdServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.AdGroupAdService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupAdServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.AdGroupAdService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.AdGroupAdService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupAdServiceStubMethods =
        ['getAdGroupAd', 'mutateAdGroupAds'];
    for (const methodName of adGroupAdServiceStubMethods) {
      const callPromise = this.adGroupAdServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getAdGroupAd(
      request?: protos.google.ads.googleads.v9.services.IGetAdGroupAdRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IAdGroupAd,
        protos.google.ads.googleads.v9.services.IGetAdGroupAdRequest|undefined, {}|undefined
      ]>;
  getAdGroupAd(
      request: protos.google.ads.googleads.v9.services.IGetAdGroupAdRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IAdGroupAd,
          protos.google.ads.googleads.v9.services.IGetAdGroupAdRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroupAd(
      request: protos.google.ads.googleads.v9.services.IGetAdGroupAdRequest,
      callback: Callback<
 ...
 */
  mutateAdGroupAds(
      request?: protos.google.ads.googleads.v9.services.IMutateAdGroupAdsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateAdGroupAdsResponse,
        protos.google.ads.googleads.v9.services.IMutateAdGroupAdsRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupAds(
      request: protos.google.ads.googleads.v9.services.IMutateAdGroupAdsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateAdGroupAdsResponse,
          protos.google.ads.googleads.v9.services.IMutateAdGroupAdsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroupAds(
      request: protos.google.ads.googleads.v9.services.IMutateAdGroupAdsRequest,
      callback: Callback<
