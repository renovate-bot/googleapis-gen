 ...
 */
import * as gapicConfig from './campaign_criterion_simulation_service_client_config.json';
...
export class CampaignCriterionSimulationServiceClient {
  ...
  campaignCriterionSimulationServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignCriterionSimulationServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CampaignCriterionSimulationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignCriterionSimulationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CampaignCriterionSimulationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CampaignCriterionSimulationService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignCriterionSimulationServiceStubMethods =
        ['getCampaignCriterionSimulation'];
    for (const methodName of campaignCriterionSimulationServiceStubMethods) {
      const callPromise = this.campaignCriterionSimulationServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
