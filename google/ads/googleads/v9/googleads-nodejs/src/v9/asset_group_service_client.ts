 ...
 */
import * as gapicConfig from './asset_group_service_client_config.json';
 ...
 * @memberof v9
 */
export class AssetGroupServiceClient {
  ...
  assetGroupServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AssetGroupServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.AssetGroupService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.assetGroupServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.AssetGroupService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.AssetGroupService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const assetGroupServiceStubMethods =
        ['getAssetGroup', 'mutateAssetGroups'];
    for (const methodName of assetGroupServiceStubMethods) {
      const callPromise = this.assetGroupServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getAssetGroup(
      request?: protos.google.ads.googleads.v9.services.IGetAssetGroupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IAssetGroup,
        protos.google.ads.googleads.v9.services.IGetAssetGroupRequest|undefined, {}|undefined
      ]>;
  getAssetGroup(
      request: protos.google.ads.googleads.v9.services.IGetAssetGroupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IAssetGroup,
          protos.google.ads.googleads.v9.services.IGetAssetGroupRequest|null|undefined,
          {}|null|undefined>): void;
  getAssetGroup(
      request: protos.google.ads.googleads.v9.services.IGetAssetGroupRequest,
      callback: Callback<
 ...
 * @example
 * const [response] = await client.getAssetGroup(request);
 */
  getAssetGroup(
      request?: protos.google.ads.googleads.v9.services.IGetAssetGroupRequest,
  ...
  mutateAssetGroups(
      request?: protos.google.ads.googleads.v9.services.IMutateAssetGroupsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateAssetGroupsResponse,
        protos.google.ads.googleads.v9.services.IMutateAssetGroupsRequest|undefined, {}|undefined
      ]>;
  mutateAssetGroups(
      request: protos.google.ads.googleads.v9.services.IMutateAssetGroupsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateAssetGroupsResponse,
          protos.google.ads.googleads.v9.services.IMutateAssetGroupsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAssetGroups(
      request: protos.google.ads.googleads.v9.services.IMutateAssetGroupsRequest,
      callback: Callback<
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.mutateAssetGroups(request);
 */
  mutateAssetGroups(
      request?: protos.google.ads.googleads.v9.services.IMutateAssetGroupsRequest,
      optionsOrCallback?: CallOptions|Callback<
