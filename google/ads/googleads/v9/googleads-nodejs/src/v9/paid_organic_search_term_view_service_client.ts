 ...
 */
import * as gapicConfig from './paid_organic_search_term_view_service_client_config.json';
...
export class PaidOrganicSearchTermViewServiceClient {
  ...
  paidOrganicSearchTermViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof PaidOrganicSearchTermViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.PaidOrganicSearchTermViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.paidOrganicSearchTermViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.PaidOrganicSearchTermViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.PaidOrganicSearchTermViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const paidOrganicSearchTermViewServiceStubMethods =
        ['getPaidOrganicSearchTermView'];
    for (const methodName of paidOrganicSearchTermViewServiceStubMethods) {
      const callPromise = this.paidOrganicSearchTermViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
