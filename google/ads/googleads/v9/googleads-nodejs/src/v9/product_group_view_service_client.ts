 ...
 */
import * as gapicConfig from './product_group_view_service_client_config.json';
...
export class ProductGroupViewServiceClient {
  ...
  productGroupViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ProductGroupViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.ProductGroupViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.productGroupViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.ProductGroupViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.ProductGroupViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const productGroupViewServiceStubMethods =
        ['getProductGroupView'];
    for (const methodName of productGroupViewServiceStubMethods) {
      const callPromise = this.productGroupViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getProductGroupView(
      request?: protos.google.ads.googleads.v9.services.IGetProductGroupViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IProductGroupView,
        protos.google.ads.googleads.v9.services.IGetProductGroupViewRequest|undefined, {}|undefined
      ]>;
  getProductGroupView(
      request: protos.google.ads.googleads.v9.services.IGetProductGroupViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IProductGroupView,
          protos.google.ads.googleads.v9.services.IGetProductGroupViewRequest|null|undefined,
          {}|null|undefined>): void;
  getProductGroupView(
      request: protos.google.ads.googleads.v9.services.IGetProductGroupViewRequest,
      callback: Callback<
