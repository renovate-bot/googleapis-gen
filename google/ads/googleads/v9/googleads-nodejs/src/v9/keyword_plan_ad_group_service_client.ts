 ...
 */
import * as gapicConfig from './keyword_plan_ad_group_service_client_config.json';
...
export class KeywordPlanAdGroupServiceClient {
  ...
  keywordPlanAdGroupServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof KeywordPlanAdGroupServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.KeywordPlanAdGroupService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordPlanAdGroupServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.KeywordPlanAdGroupService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.KeywordPlanAdGroupService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const keywordPlanAdGroupServiceStubMethods =
        ['getKeywordPlanAdGroup', 'mutateKeywordPlanAdGroups'];
    for (const methodName of keywordPlanAdGroupServiceStubMethods) {
      const callPromise = this.keywordPlanAdGroupServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getKeywordPlanAdGroup(
      request?: protos.google.ads.googleads.v9.services.IGetKeywordPlanAdGroupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IKeywordPlanAdGroup,
        protos.google.ads.googleads.v9.services.IGetKeywordPlanAdGroupRequest|undefined, {}|undefined
      ]>;
  getKeywordPlanAdGroup(
      request: protos.google.ads.googleads.v9.services.IGetKeywordPlanAdGroupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IKeywordPlanAdGroup,
          protos.google.ads.googleads.v9.services.IGetKeywordPlanAdGroupRequest|null|undefined,
          {}|null|undefined>): void;
  getKeywordPlanAdGroup(
      request: protos.google.ads.googleads.v9.services.IGetKeywordPlanAdGroupRequest,
      callback: Callback<
 ...
 */
  mutateKeywordPlanAdGroups(
      request?: protos.google.ads.googleads.v9.services.IMutateKeywordPlanAdGroupsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateKeywordPlanAdGroupsResponse,
        protos.google.ads.googleads.v9.services.IMutateKeywordPlanAdGroupsRequest|undefined, {}|undefined
      ]>;
  mutateKeywordPlanAdGroups(
      request: protos.google.ads.googleads.v9.services.IMutateKeywordPlanAdGroupsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateKeywordPlanAdGroupsResponse,
          protos.google.ads.googleads.v9.services.IMutateKeywordPlanAdGroupsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateKeywordPlanAdGroups(
      request: protos.google.ads.googleads.v9.services.IMutateKeywordPlanAdGroupsRequest,
      callback: Callback<
