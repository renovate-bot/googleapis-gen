 ...
 */
import * as gapicConfig from './ad_group_ad_asset_view_service_client_config.json';
 ...
 * @memberof v9
 */
export class AdGroupAdAssetViewServiceClient {
  ...
  adGroupAdAssetViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdGroupAdAssetViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.AdGroupAdAssetViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupAdAssetViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.AdGroupAdAssetViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.AdGroupAdAssetViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupAdAssetViewServiceStubMethods =
        ['getAdGroupAdAssetView'];
    for (const methodName of adGroupAdAssetViewServiceStubMethods) {
      const callPromise = this.adGroupAdAssetViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
