 ...
 */
import * as gapicConfig from './customer_extension_setting_service_client_config.json';
...
export class CustomerExtensionSettingServiceClient {
  ...
  customerExtensionSettingServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CustomerExtensionSettingServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CustomerExtensionSettingService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerExtensionSettingServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CustomerExtensionSettingService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CustomerExtensionSettingService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerExtensionSettingServiceStubMethods =
        ['getCustomerExtensionSetting', 'mutateCustomerExtensionSettings'];
    for (const methodName of customerExtensionSettingServiceStubMethods) {
      const callPromise = this.customerExtensionSettingServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getCustomerExtensionSetting(
      request?: protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.ICustomerExtensionSetting,
        protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest|undefined, {}|undefined
      ]>;
  getCustomerExtensionSetting(
      request: protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.ICustomerExtensionSetting,
          protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomerExtensionSetting(
      request: protos.google.ads.googleads.v9.services.IGetCustomerExtensionSettingRequest,
      callback: Callback<
 ...
 */
  mutateCustomerExtensionSettings(
      request?: protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsResponse,
        protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest|undefined, {}|undefined
      ]>;
  mutateCustomerExtensionSettings(
      request: protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsResponse,
          protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerExtensionSettings(
      request: protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsRequest,
      callback: Callback<
