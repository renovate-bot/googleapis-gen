 ...
 */
import * as gapicConfig from './managed_placement_view_service_client_config.json';
...
export class ManagedPlacementViewServiceClient {
  ...
  managedPlacementViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ManagedPlacementViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.ManagedPlacementViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.managedPlacementViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.ManagedPlacementViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.ManagedPlacementViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const managedPlacementViewServiceStubMethods =
        ['getManagedPlacementView'];
    for (const methodName of managedPlacementViewServiceStubMethods) {
      const callPromise = this.managedPlacementViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getManagedPlacementView(
      request?: protos.google.ads.googleads.v9.services.IGetManagedPlacementViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IManagedPlacementView,
        protos.google.ads.googleads.v9.services.IGetManagedPlacementViewRequest|undefined, {}|undefined
      ]>;
  getManagedPlacementView(
      request: protos.google.ads.googleads.v9.services.IGetManagedPlacementViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IManagedPlacementView,
          protos.google.ads.googleads.v9.services.IGetManagedPlacementViewRequest|null|undefined,
          {}|null|undefined>): void;
  getManagedPlacementView(
      request: protos.google.ads.googleads.v9.services.IGetManagedPlacementViewRequest,
      callback: Callback<
