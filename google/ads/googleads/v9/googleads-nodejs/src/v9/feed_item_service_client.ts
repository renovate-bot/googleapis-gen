 ...
 */
import * as gapicConfig from './feed_item_service_client_config.json';
...
export class FeedItemServiceClient {
  ...
  feedItemServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof FeedItemServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.FeedItemService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.feedItemServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.FeedItemService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.FeedItemService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const feedItemServiceStubMethods =
        ['getFeedItem', 'mutateFeedItems'];
    for (const methodName of feedItemServiceStubMethods) {
      const callPromise = this.feedItemServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getFeedItem(
      request?: protos.google.ads.googleads.v9.services.IGetFeedItemRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IFeedItem,
        protos.google.ads.googleads.v9.services.IGetFeedItemRequest|undefined, {}|undefined
      ]>;
  getFeedItem(
      request: protos.google.ads.googleads.v9.services.IGetFeedItemRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IFeedItem,
          protos.google.ads.googleads.v9.services.IGetFeedItemRequest|null|undefined,
          {}|null|undefined>): void;
  getFeedItem(
      request: protos.google.ads.googleads.v9.services.IGetFeedItemRequest,
      callback: Callback<
 ...
 * @example
 * const [response] = await client.getFeedItem(request);
 */
  getFeedItem(
      request?: protos.google.ads.googleads.v9.services.IGetFeedItemRequest,
  ...
  mutateFeedItems(
      request?: protos.google.ads.googleads.v9.services.IMutateFeedItemsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.services.IMutateFeedItemsResponse,
        protos.google.ads.googleads.v9.services.IMutateFeedItemsRequest|undefined, {}|undefined
      ]>;
  mutateFeedItems(
      request: protos.google.ads.googleads.v9.services.IMutateFeedItemsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.services.IMutateFeedItemsResponse,
          protos.google.ads.googleads.v9.services.IMutateFeedItemsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateFeedItems(
      request: protos.google.ads.googleads.v9.services.IMutateFeedItemsRequest,
      callback: Callback<
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.mutateFeedItems(request);
 */
  mutateFeedItems(
      request?: protos.google.ads.googleads.v9.services.IMutateFeedItemsRequest,
      optionsOrCallback?: CallOptions|Callback<
