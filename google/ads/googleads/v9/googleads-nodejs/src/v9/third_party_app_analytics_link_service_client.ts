 ...
 */
import * as gapicConfig from './third_party_app_analytics_link_service_client_config.json';
...
export class ThirdPartyAppAnalyticsLinkServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.ThirdPartyAppAnalyticsLinkService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.thirdPartyAppAnalyticsLinkServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.ThirdPartyAppAnalyticsLinkService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.ThirdPartyAppAnalyticsLinkService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const thirdPartyAppAnalyticsLinkServiceStubMethods =
        ['getThirdPartyAppAnalyticsLink', 'regenerateShareableLinkId'];
    for (const methodName of thirdPartyAppAnalyticsLinkServiceStubMethods) {
      const callPromise = this.thirdPartyAppAnalyticsLinkServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
