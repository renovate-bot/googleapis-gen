 ...
 */
import * as gapicConfig from './ad_group_feed_service_client_config.json';
...
export class AdGroupFeedServiceClient {
  ...
  adGroupFeedServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdGroupFeedServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.AdGroupFeedService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupFeedServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.AdGroupFeedService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.AdGroupFeedService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupFeedServiceStubMethods =
        ['getAdGroupFeed', 'mutateAdGroupFeeds'];
    for (const methodName of adGroupFeedServiceStubMethods) {
      const callPromise = this.adGroupFeedServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
