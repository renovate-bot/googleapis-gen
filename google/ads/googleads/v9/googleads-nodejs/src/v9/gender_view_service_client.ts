 ...
 */
import * as gapicConfig from './gender_view_service_client_config.json';
...
export class GenderViewServiceClient {
  ...
  genderViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof GenderViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.GenderViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.genderViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.GenderViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.GenderViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const genderViewServiceStubMethods =
        ['getGenderView'];
    for (const methodName of genderViewServiceStubMethods) {
      const callPromise = this.genderViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getGenderView(
      request?: protos.google.ads.googleads.v9.services.IGetGenderViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IGenderView,
        protos.google.ads.googleads.v9.services.IGetGenderViewRequest|undefined, {}|undefined
      ]>;
  getGenderView(
      request: protos.google.ads.googleads.v9.services.IGetGenderViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IGenderView,
          protos.google.ads.googleads.v9.services.IGetGenderViewRequest|null|undefined,
          {}|null|undefined>): void;
  getGenderView(
      request: protos.google.ads.googleads.v9.services.IGetGenderViewRequest,
      callback: Callback<
