 ...
 */
import * as gapicConfig from './detail_placement_view_service_client_config.json';
...
export class DetailPlacementViewServiceClient {
  ...
  detailPlacementViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof DetailPlacementViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.DetailPlacementViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.detailPlacementViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.DetailPlacementViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.DetailPlacementViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const detailPlacementViewServiceStubMethods =
        ['getDetailPlacementView'];
    for (const methodName of detailPlacementViewServiceStubMethods) {
      const callPromise = this.detailPlacementViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getDetailPlacementView(
      request?: protos.google.ads.googleads.v9.services.IGetDetailPlacementViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v9.resources.IDetailPlacementView,
        protos.google.ads.googleads.v9.services.IGetDetailPlacementViewRequest|undefined, {}|undefined
      ]>;
  getDetailPlacementView(
      request: protos.google.ads.googleads.v9.services.IGetDetailPlacementViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v9.resources.IDetailPlacementView,
          protos.google.ads.googleads.v9.services.IGetDetailPlacementViewRequest|null|undefined,
          {}|null|undefined>): void;
  getDetailPlacementView(
      request: protos.google.ads.googleads.v9.services.IGetDetailPlacementViewRequest,
      callback: Callback<
