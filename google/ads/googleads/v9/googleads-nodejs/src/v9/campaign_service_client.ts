 ...
 */
import * as gapicConfig from './campaign_service_client_config.json';
...
export class CampaignServiceClient {
  ...
  campaignServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v9.services.CampaignService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v9.services.CampaignService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v9.services.CampaignService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignServiceStubMethods =
        ['getCampaign', 'mutateCampaigns'];
    for (const methodName of campaignServiceStubMethods) {
      const callPromise = this.campaignServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
