...
function main(resourceName) {
  // [START googleads_v9_generated_CampaignCriterionSimulationService_GetCampaignCriterionSimulation_async]
  /**
  ...
  const {CampaignCriterionSimulationServiceClient} = require('google-ads').v9;
  ...
  async function getCampaignCriterionSimulation() {
    ...
    // Run request
    const response = await googleadsClient.getCampaignCriterionSimulation(request);
