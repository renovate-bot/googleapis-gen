...
function main(customerId, operations) {
  // [START googleads_v9_generated_AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_async]
  /**
  ...
  async function mutateAssetGroupListingGroupFilters() {
    ...
    // Run request
    const response = await googleadsClient.mutateAssetGroupListingGroupFilters(request);
