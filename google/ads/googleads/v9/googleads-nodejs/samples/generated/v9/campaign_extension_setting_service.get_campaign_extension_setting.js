...
function main(resourceName) {
  // [START googleads_v9_generated_CampaignExtensionSettingService_GetCampaignExtensionSetting_async]
  /**
  ...
  const {CampaignExtensionSettingServiceClient} = require('google-ads').v9;
  ...
  async function getCampaignExtensionSetting() {
    ...
    // Run request
    const response = await googleadsClient.getCampaignExtensionSetting(request);
