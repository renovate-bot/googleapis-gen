...
function main(resourceName) {
  // [START googleads_v9_generated_MobileDeviceConstantService_GetMobileDeviceConstant_async]
  /**
  ...
  const {MobileDeviceConstantServiceClient} = require('google-ads').v9;
  ...
  async function getMobileDeviceConstant() {
    ...
    // Run request
    const response = await googleadsClient.getMobileDeviceConstant(request);
