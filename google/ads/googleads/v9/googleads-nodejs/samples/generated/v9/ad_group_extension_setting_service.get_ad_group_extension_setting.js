...
function main(resourceName) {
  // [START googleads_v9_generated_AdGroupExtensionSettingService_GetAdGroupExtensionSetting_async]
  /**
  ...
  const {AdGroupExtensionSettingServiceClient} = require('google-ads').v9;
  ...
  async function getAdGroupExtensionSetting() {
    ...
    // Run request
    const response = await googleadsClient.getAdGroupExtensionSetting(request);
