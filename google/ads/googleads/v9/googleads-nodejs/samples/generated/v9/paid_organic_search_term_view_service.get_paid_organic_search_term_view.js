...
function main(resourceName) {
  // [START googleads_v9_generated_PaidOrganicSearchTermViewService_GetPaidOrganicSearchTermView_async]
  /**
  ...
  const {PaidOrganicSearchTermViewServiceClient} = require('google-ads').v9;
