...
function main(customerId, mutateOperations) {
  // [START googleads_v9_generated_GoogleAdsService_Mutate_async]
  /**
  ...
  async function mutate() {
    ...
    // Run request
    const response = await googleadsClient.mutate(request);
