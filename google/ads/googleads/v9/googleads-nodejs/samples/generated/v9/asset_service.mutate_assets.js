...
function main(customerId, operations) {
  // [START googleads_v9_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v9;
  ...
  async function mutateAssets() {
    ...
    // Run request
    const response = await googleadsClient.mutateAssets(request);
    console.log(response);
  }

  mutateAssets();
  // [END googleads_v9_generated_AssetService_MutateAssets_async]
}
