...
function main(customerId, operations) {
  // [START googleads_v9_generated_AdGroupFeedService_MutateAdGroupFeeds_async]
  /**
  ...
  const {AdGroupFeedServiceClient} = require('google-ads').v9;
  ...
  async function mutateAdGroupFeeds() {
    ...
    // Run request
    const response = await googleadsClient.mutateAdGroupFeeds(request);
    console.log(response);
  }

  mutateAdGroupFeeds();
  // [END googleads_v9_generated_AdGroupFeedService_MutateAdGroupFeeds_async]
}
