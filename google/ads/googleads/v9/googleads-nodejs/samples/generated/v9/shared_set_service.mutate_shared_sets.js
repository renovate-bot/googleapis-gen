...
function main(customerId, operations) {
  // [START googleads_v9_generated_SharedSetService_MutateSharedSets_async]
  /**
  ...
  const {SharedSetServiceClient} = require('google-ads').v9;
  ...
  mutateSharedSets();
  // [END googleads_v9_generated_SharedSetService_MutateSharedSets_async]
}
