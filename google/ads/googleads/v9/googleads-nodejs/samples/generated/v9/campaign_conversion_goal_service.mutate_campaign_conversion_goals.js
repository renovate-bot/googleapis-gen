...
function main(customerId, operations) {
  // [START googleads_v9_generated_CampaignConversionGoalService_MutateCampaignConversionGoals_async]
  /**
  ...
  const {CampaignConversionGoalServiceClient} = require('google-ads').v9;
  ...
  async function mutateCampaignConversionGoals() {
    ...
    // Run request
    const response = await googleadsClient.mutateCampaignConversionGoals(request);
