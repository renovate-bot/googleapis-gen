...
describe('v9.PaidOrganicSearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = paidorganicsearchtermviewserviceModule.v9.PaidOrganicSearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = paidorganicsearchtermviewserviceModule.v9.PaidOrganicSearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = paidorganicsearchtermviewserviceModule.v9.PaidOrganicSearchTermViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new paidorganicsearchtermviewserviceModule.v9.PaidOrganicSearchTermViewServiceClient();
        assert(client);
    });
    ...
    describe('getPaidOrganicSearchTermView', () => {
        it('invokes getPaidOrganicSearchTermView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetPaidOrganicSearchTermViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.PaidOrganicSearchTermView());
        ...
        it('invokes getPaidOrganicSearchTermView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPaidOrganicSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IPaidOrganicSearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
