...
import * as smartcampaignsearchtermviewserviceModule from '../src';
...
describe('v9.SmartCampaignSearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = smartcampaignsearchtermviewserviceModule.v9.SmartCampaignSearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = smartcampaignsearchtermviewserviceModule.v9.SmartCampaignSearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = smartcampaignsearchtermviewserviceModule.v9.SmartCampaignSearchTermViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new smartcampaignsearchtermviewserviceModule.v9.SmartCampaignSearchTermViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.smartCampaignSearchTermViewServiceStub, undefined);
        await client.initialize();
        assert(client.smartCampaignSearchTermViewServiceStub);
    });
    ...
    describe('getSmartCampaignSearchTermView', () => {
        it('invokes getSmartCampaignSearchTermView without error', async () => {
            const client = new smartcampaignsearchtermviewserviceModule.v9.SmartCampaignSearchTermViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetSmartCampaignSearchTermViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.SmartCampaignSearchTermView());
            client.innerApiCalls.getSmartCampaignSearchTermView = stubSimpleCall(expectedResponse);
            const [response] = await client.getSmartCampaignSearchTermView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSmartCampaignSearchTermView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getSmartCampaignSearchTermView without error using callback', async () => {
            const client = new smartcampaignsearchtermviewserviceModule.v9.SmartCampaignSearchTermViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.SmartCampaignSearchTermView());
            client.innerApiCalls.getSmartCampaignSearchTermView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSmartCampaignSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ISmartCampaignSearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSmartCampaignSearchTermView with error', async () => {
            const client = new smartcampaignsearchtermviewserviceModule.v9.SmartCampaignSearchTermViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getSmartCampaignSearchTermView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getSmartCampaignSearchTermView(request), expectedError);
            assert((client.innerApiCalls.getSmartCampaignSearchTermView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
