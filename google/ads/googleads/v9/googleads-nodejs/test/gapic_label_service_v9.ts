...
describe('v9.LabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = labelserviceModule.v9.LabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = labelserviceModule.v9.LabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = labelserviceModule.v9.LabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new labelserviceModule.v9.LabelServiceClient();
        assert(client);
    });
    ...
    describe('getLabel', () => {
        it('invokes getLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.Label());
        ...
        it('invokes getLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ILabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateLabels', () => {
        it('invokes mutateLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateLabelsResponse());
        ...
        it('invokes mutateLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
