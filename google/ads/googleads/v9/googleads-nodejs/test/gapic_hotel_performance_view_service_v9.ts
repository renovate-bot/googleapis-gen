...
describe('v9.HotelPerformanceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = hotelperformanceviewserviceModule.v9.HotelPerformanceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = hotelperformanceviewserviceModule.v9.HotelPerformanceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = hotelperformanceviewserviceModule.v9.HotelPerformanceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new hotelperformanceviewserviceModule.v9.HotelPerformanceViewServiceClient();
        assert(client);
    });
    ...
    describe('getHotelPerformanceView', () => {
        it('invokes getHotelPerformanceView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetHotelPerformanceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.HotelPerformanceView());
        ...
        it('invokes getHotelPerformanceView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getHotelPerformanceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IHotelPerformanceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
