...
import * as biddingstrategysimulationserviceModule from '../src';
...
describe('v9.BiddingStrategySimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = biddingstrategysimulationserviceModule.v9.BiddingStrategySimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = biddingstrategysimulationserviceModule.v9.BiddingStrategySimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = biddingstrategysimulationserviceModule.v9.BiddingStrategySimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new biddingstrategysimulationserviceModule.v9.BiddingStrategySimulationServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.biddingStrategySimulationServiceStub, undefined);
        await client.initialize();
        assert(client.biddingStrategySimulationServiceStub);
    });
    ...
    describe('getBiddingStrategySimulation', () => {
        it('invokes getBiddingStrategySimulation without error', async () => {
            const client = new biddingstrategysimulationserviceModule.v9.BiddingStrategySimulationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetBiddingStrategySimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.BiddingStrategySimulation());
            client.innerApiCalls.getBiddingStrategySimulation = stubSimpleCall(expectedResponse);
            const [response] = await client.getBiddingStrategySimulation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getBiddingStrategySimulation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getBiddingStrategySimulation without error using callback', async () => {
            const client = new biddingstrategysimulationserviceModule.v9.BiddingStrategySimulationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.BiddingStrategySimulation());
            client.innerApiCalls.getBiddingStrategySimulation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBiddingStrategySimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IBiddingStrategySimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBiddingStrategySimulation with error', async () => {
            const client = new biddingstrategysimulationserviceModule.v9.BiddingStrategySimulationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getBiddingStrategySimulation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getBiddingStrategySimulation(request), expectedError);
            assert((client.innerApiCalls.getBiddingStrategySimulation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
