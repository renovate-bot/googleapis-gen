...
describe('v9.PaymentsAccountServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = paymentsaccountserviceModule.v9.PaymentsAccountServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = paymentsaccountserviceModule.v9.PaymentsAccountServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = paymentsaccountserviceModule.v9.PaymentsAccountServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new paymentsaccountserviceModule.v9.PaymentsAccountServiceClient();
        assert(client);
    });
    ...
    describe('listPaymentsAccounts', () => {
        it('invokes listPaymentsAccounts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.ListPaymentsAccountsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.ListPaymentsAccountsResponse());
        ...
        it('invokes listPaymentsAccounts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPaymentsAccounts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IListPaymentsAccountsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
