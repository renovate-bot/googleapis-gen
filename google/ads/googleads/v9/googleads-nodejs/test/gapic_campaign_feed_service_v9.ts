...
describe('v9.CampaignFeedServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignfeedserviceModule.v9.CampaignFeedServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignfeedserviceModule.v9.CampaignFeedServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignfeedserviceModule.v9.CampaignFeedServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignfeedserviceModule.v9.CampaignFeedServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignFeed', () => {
        it('invokes getCampaignFeed without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCampaignFeedRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CampaignFeed());
        ...
        it('invokes getCampaignFeed without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignFeed(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICampaignFeed|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignFeeds', () => {
        it('invokes mutateCampaignFeeds without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignFeedsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignFeedsResponse());
        ...
        it('invokes mutateCampaignFeeds without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignFeeds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCampaignFeedsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
