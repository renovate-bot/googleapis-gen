...
describe('v9.CustomerNegativeCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customernegativecriterionserviceModule.v9.CustomerNegativeCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customernegativecriterionserviceModule.v9.CustomerNegativeCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customernegativecriterionserviceModule.v9.CustomerNegativeCriterionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customernegativecriterionserviceModule.v9.CustomerNegativeCriterionServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerNegativeCriterion', () => {
        it('invokes getCustomerNegativeCriterion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCustomerNegativeCriterionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CustomerNegativeCriterion());
        ...
        it('invokes getCustomerNegativeCriterion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerNegativeCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICustomerNegativeCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerNegativeCriteria', () => {
        it('invokes mutateCustomerNegativeCriteria without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaResponse());
        ...
        it('invokes mutateCustomerNegativeCriteria without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerNegativeCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomerNegativeCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
