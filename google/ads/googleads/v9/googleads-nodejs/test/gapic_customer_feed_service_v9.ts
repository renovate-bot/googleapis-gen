...
describe('v9.CustomerFeedServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerfeedserviceModule.v9.CustomerFeedServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerfeedserviceModule.v9.CustomerFeedServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerfeedserviceModule.v9.CustomerFeedServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerfeedserviceModule.v9.CustomerFeedServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerFeed', () => {
        it('invokes getCustomerFeed without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCustomerFeedRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CustomerFeed());
        ...
        it('invokes getCustomerFeed without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerFeed(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICustomerFeed|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerFeeds', () => {
        it('invokes mutateCustomerFeeds without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerFeedsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerFeedsResponse());
        ...
        it('invokes mutateCustomerFeeds without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerFeeds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomerFeedsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
