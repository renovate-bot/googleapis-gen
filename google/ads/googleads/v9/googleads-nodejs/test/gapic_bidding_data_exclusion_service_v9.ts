...
describe('v9.BiddingDataExclusionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = biddingdataexclusionserviceModule.v9.BiddingDataExclusionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = biddingdataexclusionserviceModule.v9.BiddingDataExclusionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = biddingdataexclusionserviceModule.v9.BiddingDataExclusionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new biddingdataexclusionserviceModule.v9.BiddingDataExclusionServiceClient();
        assert(client);
    });
    ...
    describe('getBiddingDataExclusion', () => {
        it('invokes getBiddingDataExclusion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetBiddingDataExclusionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.BiddingDataExclusion());
        ...
        it('invokes getBiddingDataExclusion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBiddingDataExclusion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IBiddingDataExclusion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateBiddingDataExclusions', () => {
        it('invokes mutateBiddingDataExclusions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateBiddingDataExclusionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateBiddingDataExclusionsResponse());
        ...
        it('invokes mutateBiddingDataExclusions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBiddingDataExclusions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateBiddingDataExclusionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
