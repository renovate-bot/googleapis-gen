...
describe('v9.AdScheduleViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adscheduleviewserviceModule.v9.AdScheduleViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adscheduleviewserviceModule.v9.AdScheduleViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adscheduleviewserviceModule.v9.AdScheduleViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adscheduleviewserviceModule.v9.AdScheduleViewServiceClient();
        assert(client);
    });
    ...
    describe('getAdScheduleView', () => {
        it('invokes getAdScheduleView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAdScheduleViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdScheduleView());
        ...
        it('invokes getAdScheduleView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdScheduleView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAdScheduleView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
