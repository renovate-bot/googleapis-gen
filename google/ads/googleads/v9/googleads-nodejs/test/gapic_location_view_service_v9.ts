...
describe('v9.LocationViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = locationviewserviceModule.v9.LocationViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = locationviewserviceModule.v9.LocationViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = locationviewserviceModule.v9.LocationViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new locationviewserviceModule.v9.LocationViewServiceClient();
        assert(client);
    });
    ...
    describe('getLocationView', () => {
        it('invokes getLocationView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetLocationViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.LocationView());
        ...
        it('invokes getLocationView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLocationView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ILocationView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
