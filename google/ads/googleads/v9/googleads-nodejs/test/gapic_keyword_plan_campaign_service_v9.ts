...
describe('v9.KeywordPlanCampaignServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplancampaignserviceModule.v9.KeywordPlanCampaignServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplancampaignserviceModule.v9.KeywordPlanCampaignServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplancampaignserviceModule.v9.KeywordPlanCampaignServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplancampaignserviceModule.v9.KeywordPlanCampaignServiceClient();
        assert(client);
    });
    ...
    describe('getKeywordPlanCampaign', () => {
        it('invokes getKeywordPlanCampaign without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetKeywordPlanCampaignRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.KeywordPlanCampaign());
        ...
        it('invokes getKeywordPlanCampaign without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanCampaign(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IKeywordPlanCampaign|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateKeywordPlanCampaigns', () => {
        it('invokes mutateKeywordPlanCampaigns without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateKeywordPlanCampaignsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateKeywordPlanCampaignsResponse());
        ...
        it('invokes mutateKeywordPlanCampaigns without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanCampaigns(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateKeywordPlanCampaignsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
