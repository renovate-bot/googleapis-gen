...
describe('v9.TopicConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = topicconstantserviceModule.v9.TopicConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = topicconstantserviceModule.v9.TopicConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = topicconstantserviceModule.v9.TopicConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new topicconstantserviceModule.v9.TopicConstantServiceClient();
        assert(client);
    });
    ...
    describe('getTopicConstant', () => {
        it('invokes getTopicConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetTopicConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.TopicConstant());
        ...
        it('invokes getTopicConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTopicConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ITopicConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
