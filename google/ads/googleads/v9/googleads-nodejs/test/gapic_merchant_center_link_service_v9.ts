...
describe('v9.MerchantCenterLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = merchantcenterlinkserviceModule.v9.MerchantCenterLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = merchantcenterlinkserviceModule.v9.MerchantCenterLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = merchantcenterlinkserviceModule.v9.MerchantCenterLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new merchantcenterlinkserviceModule.v9.MerchantCenterLinkServiceClient();
        assert(client);
    });
    ...
    describe('listMerchantCenterLinks', () => {
        it('invokes listMerchantCenterLinks without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.ListMerchantCenterLinksRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.ListMerchantCenterLinksResponse());
        ...
        it('invokes listMerchantCenterLinks without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listMerchantCenterLinks(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IListMerchantCenterLinksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMerchantCenterLink', () => {
        it('invokes getMerchantCenterLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetMerchantCenterLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.MerchantCenterLink());
        ...
        it('invokes getMerchantCenterLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMerchantCenterLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IMerchantCenterLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateMerchantCenterLink', () => {
        it('invokes mutateMerchantCenterLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateMerchantCenterLinkRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateMerchantCenterLinkResponse());
        ...
        it('invokes mutateMerchantCenterLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateMerchantCenterLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateMerchantCenterLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
