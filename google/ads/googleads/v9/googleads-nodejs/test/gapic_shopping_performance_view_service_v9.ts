...
import * as shoppingperformanceviewserviceModule from '../src';
...
describe('v9.ShoppingPerformanceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = shoppingperformanceviewserviceModule.v9.ShoppingPerformanceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = shoppingperformanceviewserviceModule.v9.ShoppingPerformanceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = shoppingperformanceviewserviceModule.v9.ShoppingPerformanceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new shoppingperformanceviewserviceModule.v9.ShoppingPerformanceViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.shoppingPerformanceViewServiceStub, undefined);
        await client.initialize();
        assert(client.shoppingPerformanceViewServiceStub);
    });
    ...
    describe('getShoppingPerformanceView', () => {
        it('invokes getShoppingPerformanceView without error', async () => {
            const client = new shoppingperformanceviewserviceModule.v9.ShoppingPerformanceViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetShoppingPerformanceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ShoppingPerformanceView());
            client.innerApiCalls.getShoppingPerformanceView = stubSimpleCall(expectedResponse);
            const [response] = await client.getShoppingPerformanceView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getShoppingPerformanceView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getShoppingPerformanceView without error using callback', async () => {
            const client = new shoppingperformanceviewserviceModule.v9.ShoppingPerformanceViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ShoppingPerformanceView());
            client.innerApiCalls.getShoppingPerformanceView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getShoppingPerformanceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IShoppingPerformanceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getShoppingPerformanceView with error', async () => {
            const client = new shoppingperformanceviewserviceModule.v9.ShoppingPerformanceViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getShoppingPerformanceView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getShoppingPerformanceView(request), expectedError);
            assert((client.innerApiCalls.getShoppingPerformanceView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
