...
describe('v9.CarrierConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = carrierconstantserviceModule.v9.CarrierConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = carrierconstantserviceModule.v9.CarrierConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = carrierconstantserviceModule.v9.CarrierConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new carrierconstantserviceModule.v9.CarrierConstantServiceClient();
        assert(client);
    });
    ...
    describe('getCarrierConstant', () => {
        it('invokes getCarrierConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCarrierConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CarrierConstant());
        ...
        it('invokes getCarrierConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCarrierConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICarrierConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
