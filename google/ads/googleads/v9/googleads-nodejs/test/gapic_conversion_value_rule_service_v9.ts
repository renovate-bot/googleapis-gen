...
import * as conversionvalueruleserviceModule from '../src';
...
describe('v9.ConversionValueRuleServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionvalueruleserviceModule.v9.ConversionValueRuleServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionvalueruleserviceModule.v9.ConversionValueRuleServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionvalueruleserviceModule.v9.ConversionValueRuleServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionvalueruleserviceModule.v9.ConversionValueRuleServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.conversionValueRuleServiceStub, undefined);
        await client.initialize();
        assert(client.conversionValueRuleServiceStub);
    });
    ...
    describe('getConversionValueRule', () => {
        it('invokes getConversionValueRule without error', async () => {
            const client = new conversionvalueruleserviceModule.v9.ConversionValueRuleServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetConversionValueRuleRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ConversionValueRule());
            client.innerApiCalls.getConversionValueRule = stubSimpleCall(expectedResponse);
            const [response] = await client.getConversionValueRule(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getConversionValueRule as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getConversionValueRule without error using callback', async () => {
            const client = new conversionvalueruleserviceModule.v9.ConversionValueRuleServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ConversionValueRule());
            client.innerApiCalls.getConversionValueRule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConversionValueRule(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IConversionValueRule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConversionValueRule with error', async () => {
            const client = new conversionvalueruleserviceModule.v9.ConversionValueRuleServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getConversionValueRule = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getConversionValueRule(request), expectedError);
            assert((client.innerApiCalls.getConversionValueRule as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateConversionValueRules', () => {
        it('invokes mutateConversionValueRules without error', async () => {
            const client = new conversionvalueruleserviceModule.v9.ConversionValueRuleServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateConversionValueRulesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateConversionValueRulesResponse());
            client.innerApiCalls.mutateConversionValueRules = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateConversionValueRules(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateConversionValueRules as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateConversionValueRules without error using callback', async () => {
            const client = new conversionvalueruleserviceModule.v9.ConversionValueRuleServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateConversionValueRulesResponse());
            client.innerApiCalls.mutateConversionValueRules = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionValueRules(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateConversionValueRulesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateConversionValueRules with error', async () => {
            const client = new conversionvalueruleserviceModule.v9.ConversionValueRuleServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateConversionValueRules = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateConversionValueRules(request), expectedError);
            assert((client.innerApiCalls.mutateConversionValueRules as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
