...
describe('v9.CampaignExperimentServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignexperimentserviceModule.v9.CampaignExperimentServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignexperimentserviceModule.v9.CampaignExperimentServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignexperimentserviceModule.v9.CampaignExperimentServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignexperimentserviceModule.v9.CampaignExperimentServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignExperiment', () => {
        it('invokes getCampaignExperiment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCampaignExperimentRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CampaignExperiment());
        ...
        it('invokes getCampaignExperiment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignExperiment(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICampaignExperiment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignExperiments', () => {
        it('invokes mutateCampaignExperiments without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignExperimentsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignExperimentsResponse());
        ...
        it('invokes mutateCampaignExperiments without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignExperiments(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCampaignExperimentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('graduateCampaignExperiment', () => {
        it('invokes graduateCampaignExperiment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GraduateCampaignExperimentRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.GraduateCampaignExperimentResponse());
        ...
        it('invokes graduateCampaignExperiment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.graduateCampaignExperiment(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IGraduateCampaignExperimentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('endCampaignExperiment', () => {
        it('invokes endCampaignExperiment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.EndCampaignExperimentRequest());
            request.campaignExperiment = '';
            const expectedHeaderRequestParams = "campaign_experiment=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createCampaignExperiment', () => {
        it('invokes createCampaignExperiment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.CreateCampaignExperimentRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes createCampaignExperiment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCampaignExperiment(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v9.services.ICreateCampaignExperimentMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v9.services.ICreateCampaignExperimentMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('promoteCampaignExperiment', () => {
        it('invokes promoteCampaignExperiment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.PromoteCampaignExperimentRequest());
            request.campaignExperiment = '';
            const expectedHeaderRequestParams = "campaign_experiment=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listCampaignExperimentAsyncErrors', () => {
        it('invokes listCampaignExperimentAsyncErrors without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.ListCampaignExperimentAsyncErrorsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
