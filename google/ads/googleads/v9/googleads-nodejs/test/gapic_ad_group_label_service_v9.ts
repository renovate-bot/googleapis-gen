...
describe('v9.AdGroupLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgrouplabelserviceModule.v9.AdGroupLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgrouplabelserviceModule.v9.AdGroupLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgrouplabelserviceModule.v9.AdGroupLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgrouplabelserviceModule.v9.AdGroupLabelServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupLabel', () => {
        it('invokes getAdGroupLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAdGroupLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdGroupLabel());
        ...
        it('invokes getAdGroupLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAdGroupLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupLabels', () => {
        it('invokes mutateAdGroupLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupLabelsResponse());
        ...
        it('invokes mutateAdGroupLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAdGroupLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
