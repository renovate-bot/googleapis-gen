...
import * as campaignassetsetserviceModule from '../src';
...
describe('v9.CampaignAssetSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignassetsetserviceModule.v9.CampaignAssetSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignassetsetserviceModule.v9.CampaignAssetSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignassetsetserviceModule.v9.CampaignAssetSetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignassetsetserviceModule.v9.CampaignAssetSetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.campaignAssetSetServiceStub, undefined);
        await client.initialize();
        assert(client.campaignAssetSetServiceStub);
    });
    ...
    describe('mutateCampaignAssetSets', () => {
        it('invokes mutateCampaignAssetSets without error', async () => {
            const client = new campaignassetsetserviceModule.v9.CampaignAssetSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignAssetSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse());
            client.innerApiCalls.mutateCampaignAssetSets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignAssetSets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaignAssetSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCampaignAssetSets without error using callback', async () => {
            const client = new campaignassetsetserviceModule.v9.CampaignAssetSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignAssetSetsResponse());
            client.innerApiCalls.mutateCampaignAssetSets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignAssetSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCampaignAssetSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignAssetSets with error', async () => {
            const client = new campaignassetsetserviceModule.v9.CampaignAssetSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateCampaignAssetSets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignAssetSets(request), expectedError);
            assert((client.innerApiCalls.mutateCampaignAssetSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
