...
describe('v9.CustomerAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerassetserviceModule.v9.CustomerAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerassetserviceModule.v9.CustomerAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerassetserviceModule.v9.CustomerAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerassetserviceModule.v9.CustomerAssetServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerAsset', () => {
        it('invokes getCustomerAsset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCustomerAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CustomerAsset());
        ...
        it('invokes getCustomerAsset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICustomerAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerAssets', () => {
        it('invokes mutateCustomerAssets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerAssetsResponse());
        ...
        it('invokes mutateCustomerAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomerAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
