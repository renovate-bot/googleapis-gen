...
describe('v9.AgeRangeViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = agerangeviewserviceModule.v9.AgeRangeViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = agerangeviewserviceModule.v9.AgeRangeViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = agerangeviewserviceModule.v9.AgeRangeViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new agerangeviewserviceModule.v9.AgeRangeViewServiceClient();
        assert(client);
    });
    ...
    describe('getAgeRangeView', () => {
        it('invokes getAgeRangeView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAgeRangeViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AgeRangeView());
        ...
        it('invokes getAgeRangeView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAgeRangeView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAgeRangeView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
