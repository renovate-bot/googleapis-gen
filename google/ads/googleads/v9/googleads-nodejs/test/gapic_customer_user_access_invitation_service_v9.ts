...
describe('v9.CustomerUserAccessInvitationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customeruseraccessinvitationserviceModule.v9.CustomerUserAccessInvitationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customeruseraccessinvitationserviceModule.v9.CustomerUserAccessInvitationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customeruseraccessinvitationserviceModule.v9.CustomerUserAccessInvitationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customeruseraccessinvitationserviceModule.v9.CustomerUserAccessInvitationServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerUserAccessInvitation', () => {
        it('invokes getCustomerUserAccessInvitation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCustomerUserAccessInvitationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CustomerUserAccessInvitation());
        ...
        it('invokes getCustomerUserAccessInvitation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerUserAccessInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICustomerUserAccessInvitation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerUserAccessInvitation', () => {
        it('invokes mutateCustomerUserAccessInvitation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerUserAccessInvitationRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerUserAccessInvitationResponse());
        ...
        it('invokes mutateCustomerUserAccessInvitation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerUserAccessInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
