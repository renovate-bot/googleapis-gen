...
import * as webpageviewserviceModule from '../src';
...
describe('v9.WebpageViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = webpageviewserviceModule.v9.WebpageViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = webpageviewserviceModule.v9.WebpageViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = webpageviewserviceModule.v9.WebpageViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new webpageviewserviceModule.v9.WebpageViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.webpageViewServiceStub, undefined);
        await client.initialize();
        assert(client.webpageViewServiceStub);
    });
    ...
    describe('getWebpageView', () => {
        it('invokes getWebpageView without error', async () => {
            const client = new webpageviewserviceModule.v9.WebpageViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetWebpageViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.WebpageView());
            client.innerApiCalls.getWebpageView = stubSimpleCall(expectedResponse);
            const [response] = await client.getWebpageView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getWebpageView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getWebpageView without error using callback', async () => {
            const client = new webpageviewserviceModule.v9.WebpageViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.WebpageView());
            client.innerApiCalls.getWebpageView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getWebpageView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IWebpageView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getWebpageView with error', async () => {
            const client = new webpageviewserviceModule.v9.WebpageViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getWebpageView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getWebpageView(request), expectedError);
            assert((client.innerApiCalls.getWebpageView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
