...
describe('v9.CustomerClientLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerclientlinkserviceModule.v9.CustomerClientLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerclientlinkserviceModule.v9.CustomerClientLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerclientlinkserviceModule.v9.CustomerClientLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerclientlinkserviceModule.v9.CustomerClientLinkServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerClientLink', () => {
        it('invokes getCustomerClientLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCustomerClientLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CustomerClientLink());
        ...
        it('invokes getCustomerClientLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerClientLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICustomerClientLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerClientLink', () => {
        it('invokes mutateCustomerClientLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerClientLinkRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerClientLinkResponse());
        ...
        it('invokes mutateCustomerClientLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerClientLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomerClientLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
