...
import * as assetsetserviceModule from '../src';
...
describe('v9.AssetSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = assetsetserviceModule.v9.AssetSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = assetsetserviceModule.v9.AssetSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = assetsetserviceModule.v9.AssetSetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new assetsetserviceModule.v9.AssetSetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.assetSetServiceStub, undefined);
        await client.initialize();
        assert(client.assetSetServiceStub);
    });
    ...
    describe('mutateAssetSets', () => {
        it('invokes mutateAssetSets without error', async () => {
            const client = new assetsetserviceModule.v9.AssetSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetSetsResponse());
            client.innerApiCalls.mutateAssetSets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAssetSets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAssetSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAssetSets without error using callback', async () => {
            const client = new assetsetserviceModule.v9.AssetSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetSetsResponse());
            client.innerApiCalls.mutateAssetSets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAssetSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAssetSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAssetSets with error', async () => {
            const client = new assetsetserviceModule.v9.AssetSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateAssetSets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAssetSets(request), expectedError);
            assert((client.innerApiCalls.mutateAssetSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
