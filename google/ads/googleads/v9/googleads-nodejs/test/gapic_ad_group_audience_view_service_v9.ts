...
describe('v9.AdGroupAudienceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupaudienceviewserviceModule.v9.AdGroupAudienceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupaudienceviewserviceModule.v9.AdGroupAudienceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupaudienceviewserviceModule.v9.AdGroupAudienceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupaudienceviewserviceModule.v9.AdGroupAudienceViewServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupAudienceView', () => {
        it('invokes getAdGroupAudienceView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAdGroupAudienceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdGroupAudienceView());
        ...
        it('invokes getAdGroupAudienceView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAudienceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAdGroupAudienceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
