...
describe('v9.BiddingSeasonalityAdjustmentServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = biddingseasonalityadjustmentserviceModule.v9.BiddingSeasonalityAdjustmentServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = biddingseasonalityadjustmentserviceModule.v9.BiddingSeasonalityAdjustmentServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = biddingseasonalityadjustmentserviceModule.v9.BiddingSeasonalityAdjustmentServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new biddingseasonalityadjustmentserviceModule.v9.BiddingSeasonalityAdjustmentServiceClient();
        assert(client);
    });
    ...
    describe('getBiddingSeasonalityAdjustment', () => {
        it('invokes getBiddingSeasonalityAdjustment without error', async () => {
            const client = new biddingseasonalityadjustmentserviceModule.v9.BiddingSeasonalityAdjustmentServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetBiddingSeasonalityAdjustmentRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.BiddingSeasonalityAdjustment());
            client.innerApiCalls.getBiddingSeasonalityAdjustment = stubSimpleCall(expectedResponse);
            const [response] = await client.getBiddingSeasonalityAdjustment(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getBiddingSeasonalityAdjustment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getBiddingSeasonalityAdjustment without error using callback', async () => {
            const client = new biddingseasonalityadjustmentserviceModule.v9.BiddingSeasonalityAdjustmentServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.BiddingSeasonalityAdjustment());
            client.innerApiCalls.getBiddingSeasonalityAdjustment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBiddingSeasonalityAdjustment(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IBiddingSeasonalityAdjustment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBiddingSeasonalityAdjustment with error', async () => {
            const client = new biddingseasonalityadjustmentserviceModule.v9.BiddingSeasonalityAdjustmentServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getBiddingSeasonalityAdjustment = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getBiddingSeasonalityAdjustment(request), expectedError);
            assert((client.innerApiCalls.getBiddingSeasonalityAdjustment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateBiddingSeasonalityAdjustments', () => {
        it('invokes mutateBiddingSeasonalityAdjustments without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateBiddingSeasonalityAdjustmentsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateBiddingSeasonalityAdjustmentsResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateBiddingSeasonalityAdjustments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateBiddingSeasonalityAdjustments without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBiddingSeasonalityAdjustments(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateBiddingSeasonalityAdjustmentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
