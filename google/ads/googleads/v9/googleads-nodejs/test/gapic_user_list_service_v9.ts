...
describe('v9.UserListServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = userlistserviceModule.v9.UserListServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = userlistserviceModule.v9.UserListServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = userlistserviceModule.v9.UserListServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new userlistserviceModule.v9.UserListServiceClient();
        assert(client);
    });
    ...
    describe('getUserList', () => {
        it('invokes getUserList without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetUserListRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.UserList());
        ...
        it('invokes getUserList without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getUserList(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IUserList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateUserLists', () => {
        it('invokes mutateUserLists without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateUserListsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateUserListsResponse());
        ...
        it('invokes mutateUserLists without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateUserLists(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateUserListsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
