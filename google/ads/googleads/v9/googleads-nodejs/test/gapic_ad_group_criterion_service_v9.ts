...
describe('v9.AdGroupCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupcriterionserviceModule.v9.AdGroupCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupcriterionserviceModule.v9.AdGroupCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupcriterionserviceModule.v9.AdGroupCriterionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupcriterionserviceModule.v9.AdGroupCriterionServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupCriterion', () => {
        it('invokes getAdGroupCriterion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAdGroupCriterionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdGroupCriterion());
        ...
        it('invokes getAdGroupCriterion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAdGroupCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupCriteria', () => {
        it('invokes mutateAdGroupCriteria without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupCriteriaRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupCriteriaResponse());
        ...
        it('invokes mutateAdGroupCriteria without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAdGroupCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
