...
import * as assetgroupserviceModule from '../src';
...
describe('v9.AssetGroupServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = assetgroupserviceModule.v9.AssetGroupServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = assetgroupserviceModule.v9.AssetGroupServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = assetgroupserviceModule.v9.AssetGroupServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new assetgroupserviceModule.v9.AssetGroupServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.assetGroupServiceStub, undefined);
        await client.initialize();
        assert(client.assetGroupServiceStub);
    });
    ...
    describe('getAssetGroup', () => {
        it('invokes getAssetGroup without error', async () => {
            const client = new assetgroupserviceModule.v9.AssetGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAssetGroupRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AssetGroup());
            client.innerApiCalls.getAssetGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.getAssetGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAssetGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAssetGroup without error using callback', async () => {
            const client = new assetgroupserviceModule.v9.AssetGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AssetGroup());
            client.innerApiCalls.getAssetGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAssetGroup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAssetGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAssetGroup with error', async () => {
            const client = new assetgroupserviceModule.v9.AssetGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getAssetGroup = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAssetGroup(request), expectedError);
            assert((client.innerApiCalls.getAssetGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAssetGroups', () => {
        it('invokes mutateAssetGroups without error', async () => {
            const client = new assetgroupserviceModule.v9.AssetGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetGroupsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetGroupsResponse());
            client.innerApiCalls.mutateAssetGroups = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAssetGroups(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAssetGroups as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAssetGroups without error using callback', async () => {
            const client = new assetgroupserviceModule.v9.AssetGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetGroupsResponse());
            client.innerApiCalls.mutateAssetGroups = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAssetGroups(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAssetGroupsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAssetGroups with error', async () => {
            const client = new assetgroupserviceModule.v9.AssetGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAssetGroups = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAssetGroups(request), expectedError);
            assert((client.innerApiCalls.mutateAssetGroups as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
