...
describe('v9.AdGroupCriterionLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupcriterionlabelserviceModule.v9.AdGroupCriterionLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupcriterionlabelserviceModule.v9.AdGroupCriterionLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupcriterionlabelserviceModule.v9.AdGroupCriterionLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupcriterionlabelserviceModule.v9.AdGroupCriterionLabelServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupCriterionLabel', () => {
        it('invokes getAdGroupCriterionLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAdGroupCriterionLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdGroupCriterionLabel());
        ...
        it('invokes getAdGroupCriterionLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupCriterionLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAdGroupCriterionLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupCriterionLabels', () => {
        it('invokes mutateAdGroupCriterionLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupCriterionLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupCriterionLabelsResponse());
        ...
        it('invokes mutateAdGroupCriterionLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupCriterionLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAdGroupCriterionLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
