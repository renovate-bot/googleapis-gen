...
describe('v9.CustomerClientServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerclientserviceModule.v9.CustomerClientServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerclientserviceModule.v9.CustomerClientServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerclientserviceModule.v9.CustomerClientServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerclientserviceModule.v9.CustomerClientServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerClient', () => {
        it('invokes getCustomerClient without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCustomerClientRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CustomerClient());
        ...
        it('invokes getCustomerClient without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerClient(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICustomerClient|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
