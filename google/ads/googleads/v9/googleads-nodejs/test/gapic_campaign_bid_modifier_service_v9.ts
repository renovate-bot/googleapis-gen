...
describe('v9.CampaignBidModifierServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignbidmodifierserviceModule.v9.CampaignBidModifierServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignbidmodifierserviceModule.v9.CampaignBidModifierServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignbidmodifierserviceModule.v9.CampaignBidModifierServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignbidmodifierserviceModule.v9.CampaignBidModifierServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignBidModifier', () => {
        it('invokes getCampaignBidModifier without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCampaignBidModifierRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CampaignBidModifier());
        ...
        it('invokes getCampaignBidModifier without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignBidModifier(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICampaignBidModifier|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignBidModifiers', () => {
        it('invokes mutateCampaignBidModifiers without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse());
        ...
        it('invokes mutateCampaignBidModifiers without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignBidModifiers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCampaignBidModifiersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
