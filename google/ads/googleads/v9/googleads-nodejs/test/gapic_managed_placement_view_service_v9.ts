...
describe('v9.ManagedPlacementViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = managedplacementviewserviceModule.v9.ManagedPlacementViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = managedplacementviewserviceModule.v9.ManagedPlacementViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = managedplacementviewserviceModule.v9.ManagedPlacementViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new managedplacementviewserviceModule.v9.ManagedPlacementViewServiceClient();
        assert(client);
    });
    ...
    describe('getManagedPlacementView', () => {
        it('invokes getManagedPlacementView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetManagedPlacementViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ManagedPlacementView());
        ...
        it('invokes getManagedPlacementView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getManagedPlacementView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IManagedPlacementView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
