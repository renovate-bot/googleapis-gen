...
describe('v9.FeedServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feedserviceModule.v9.FeedServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feedserviceModule.v9.FeedServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feedserviceModule.v9.FeedServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feedserviceModule.v9.FeedServiceClient();
        assert(client);
    });
    ...
    describe('getFeed', () => {
        it('invokes getFeed without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetFeedRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.Feed());
        ...
        it('invokes getFeed without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeed(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IFeed|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateFeeds', () => {
        it('invokes mutateFeeds without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateFeedsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateFeedsResponse());
        ...
        it('invokes mutateFeeds without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeeds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateFeedsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
