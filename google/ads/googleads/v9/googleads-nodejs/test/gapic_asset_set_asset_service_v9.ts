...
import * as assetsetassetserviceModule from '../src';
...
describe('v9.AssetSetAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = assetsetassetserviceModule.v9.AssetSetAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = assetsetassetserviceModule.v9.AssetSetAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = assetsetassetserviceModule.v9.AssetSetAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new assetsetassetserviceModule.v9.AssetSetAssetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.assetSetAssetServiceStub, undefined);
        await client.initialize();
        assert(client.assetSetAssetServiceStub);
    });
    ...
    describe('mutateAssetSetAssets', () => {
        it('invokes mutateAssetSetAssets without error', async () => {
            const client = new assetsetassetserviceModule.v9.AssetSetAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetSetAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse());
            client.innerApiCalls.mutateAssetSetAssets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAssetSetAssets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAssetSetAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAssetSetAssets without error using callback', async () => {
            const client = new assetsetassetserviceModule.v9.AssetSetAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetSetAssetsResponse());
            client.innerApiCalls.mutateAssetSetAssets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAssetSetAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAssetSetAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAssetSetAssets with error', async () => {
            const client = new assetsetassetserviceModule.v9.AssetSetAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateAssetSetAssets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAssetSetAssets(request), expectedError);
            assert((client.innerApiCalls.mutateAssetSetAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
