...
describe('v9.DistanceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = distanceviewserviceModule.v9.DistanceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = distanceviewserviceModule.v9.DistanceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = distanceviewserviceModule.v9.DistanceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new distanceviewserviceModule.v9.DistanceViewServiceClient();
        assert(client);
    });
    ...
    describe('getDistanceView', () => {
        it('invokes getDistanceView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetDistanceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.DistanceView());
        ...
        it('invokes getDistanceView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDistanceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IDistanceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
