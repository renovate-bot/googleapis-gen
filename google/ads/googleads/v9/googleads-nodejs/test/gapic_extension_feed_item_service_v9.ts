...
import * as extensionfeeditemserviceModule from '../src';
...
describe('v9.ExtensionFeedItemServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = extensionfeeditemserviceModule.v9.ExtensionFeedItemServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = extensionfeeditemserviceModule.v9.ExtensionFeedItemServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = extensionfeeditemserviceModule.v9.ExtensionFeedItemServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new extensionfeeditemserviceModule.v9.ExtensionFeedItemServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.extensionFeedItemServiceStub, undefined);
        await client.initialize();
        assert(client.extensionFeedItemServiceStub);
    });
    ...
    describe('getExtensionFeedItem', () => {
        it('invokes getExtensionFeedItem without error', async () => {
            const client = new extensionfeeditemserviceModule.v9.ExtensionFeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetExtensionFeedItemRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ExtensionFeedItem());
            client.innerApiCalls.getExtensionFeedItem = stubSimpleCall(expectedResponse);
            const [response] = await client.getExtensionFeedItem(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getExtensionFeedItem as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getExtensionFeedItem without error using callback', async () => {
            const client = new extensionfeeditemserviceModule.v9.ExtensionFeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ExtensionFeedItem());
            client.innerApiCalls.getExtensionFeedItem = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getExtensionFeedItem(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IExtensionFeedItem|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getExtensionFeedItem with error', async () => {
            const client = new extensionfeeditemserviceModule.v9.ExtensionFeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getExtensionFeedItem = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getExtensionFeedItem(request), expectedError);
            assert((client.innerApiCalls.getExtensionFeedItem as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateExtensionFeedItems', () => {
        it('invokes mutateExtensionFeedItems without error', async () => {
            const client = new extensionfeeditemserviceModule.v9.ExtensionFeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateExtensionFeedItemsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateExtensionFeedItemsResponse());
            client.innerApiCalls.mutateExtensionFeedItems = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateExtensionFeedItems(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateExtensionFeedItems as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateExtensionFeedItems without error using callback', async () => {
            const client = new extensionfeeditemserviceModule.v9.ExtensionFeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateExtensionFeedItemsResponse());
            client.innerApiCalls.mutateExtensionFeedItems = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateExtensionFeedItems(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateExtensionFeedItemsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateExtensionFeedItems with error', async () => {
            const client = new extensionfeeditemserviceModule.v9.ExtensionFeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateExtensionFeedItems = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateExtensionFeedItems(request), expectedError);
            assert((client.innerApiCalls.mutateExtensionFeedItems as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
