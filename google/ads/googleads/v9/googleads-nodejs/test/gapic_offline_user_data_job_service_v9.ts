...
describe('v9.OfflineUserDataJobServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = offlineuserdatajobserviceModule.v9.OfflineUserDataJobServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = offlineuserdatajobserviceModule.v9.OfflineUserDataJobServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = offlineuserdatajobserviceModule.v9.OfflineUserDataJobServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new offlineuserdatajobserviceModule.v9.OfflineUserDataJobServiceClient();
        assert(client);
    });
    ...
    describe('createOfflineUserDataJob', () => {
        it('invokes createOfflineUserDataJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.CreateOfflineUserDataJobRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.CreateOfflineUserDataJobResponse());
        ...
        it('invokes createOfflineUserDataJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createOfflineUserDataJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.ICreateOfflineUserDataJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getOfflineUserDataJob', () => {
        it('invokes getOfflineUserDataJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetOfflineUserDataJobRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.OfflineUserDataJob());
        ...
        it('invokes getOfflineUserDataJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getOfflineUserDataJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IOfflineUserDataJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('addOfflineUserDataJobOperations', () => {
        it('invokes addOfflineUserDataJobOperations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.AddOfflineUserDataJobOperationsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.AddOfflineUserDataJobOperationsResponse());
        ...
        it('invokes addOfflineUserDataJobOperations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addOfflineUserDataJobOperations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IAddOfflineUserDataJobOperationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('runOfflineUserDataJob', () => {
        it('invokes runOfflineUserDataJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.RunOfflineUserDataJobRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes runOfflineUserDataJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runOfflineUserDataJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v9.resources.IOfflineUserDataJobMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v9.resources.IOfflineUserDataJobMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runOfflineUserDataJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
