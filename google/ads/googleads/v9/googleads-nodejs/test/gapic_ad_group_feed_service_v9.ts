...
import * as adgroupfeedserviceModule from '../src';
...
describe('v9.AdGroupFeedServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupfeedserviceModule.v9.AdGroupFeedServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupfeedserviceModule.v9.AdGroupFeedServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupfeedserviceModule.v9.AdGroupFeedServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupfeedserviceModule.v9.AdGroupFeedServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupFeedServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupFeedServiceStub);
    });
    ...
    describe('getAdGroupFeed', () => {
        it('invokes getAdGroupFeed without error', async () => {
            const client = new adgroupfeedserviceModule.v9.AdGroupFeedServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAdGroupFeedRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdGroupFeed());
            client.innerApiCalls.getAdGroupFeed = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupFeed(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupFeed as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupFeed without error using callback', async () => {
            const client = new adgroupfeedserviceModule.v9.AdGroupFeedServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdGroupFeed());
            client.innerApiCalls.getAdGroupFeed = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupFeed(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAdGroupFeed|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupFeed with error', async () => {
            const client = new adgroupfeedserviceModule.v9.AdGroupFeedServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getAdGroupFeed = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupFeed(request), expectedError);
            assert((client.innerApiCalls.getAdGroupFeed as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAdGroupFeeds', () => {
        it('invokes mutateAdGroupFeeds without error', async () => {
            const client = new adgroupfeedserviceModule.v9.AdGroupFeedServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupFeedsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupFeedsResponse());
            client.innerApiCalls.mutateAdGroupFeeds = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupFeeds(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupFeeds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroupFeeds without error using callback', async () => {
            const client = new adgroupfeedserviceModule.v9.AdGroupFeedServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupFeedsResponse());
            client.innerApiCalls.mutateAdGroupFeeds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupFeeds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAdGroupFeedsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupFeeds with error', async () => {
            const client = new adgroupfeedserviceModule.v9.AdGroupFeedServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdGroupFeeds = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupFeeds(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupFeeds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
