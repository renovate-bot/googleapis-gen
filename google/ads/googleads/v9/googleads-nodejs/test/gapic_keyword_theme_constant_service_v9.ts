...
describe('v9.KeywordThemeConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordthemeconstantserviceModule.v9.KeywordThemeConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordthemeconstantserviceModule.v9.KeywordThemeConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordthemeconstantserviceModule.v9.KeywordThemeConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordthemeconstantserviceModule.v9.KeywordThemeConstantServiceClient();
        assert(client);
    });
    ...
    describe('getKeywordThemeConstant', () => {
        it('invokes getKeywordThemeConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetKeywordThemeConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.KeywordThemeConstant());
        ...
        it('invokes getKeywordThemeConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordThemeConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IKeywordThemeConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestKeywordThemeConstants', () => {
        it('invokes suggestKeywordThemeConstants without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest());
            const expectedOptions = {otherArgs: {headers: {}}};;
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse());
        ...
        it('invokes suggestKeywordThemeConstants without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestKeywordThemeConstants(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.ISuggestKeywordThemeConstantsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
