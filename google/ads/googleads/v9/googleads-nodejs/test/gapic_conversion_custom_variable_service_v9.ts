...
describe('v9.ConversionCustomVariableServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversioncustomvariableserviceModule.v9.ConversionCustomVariableServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversioncustomvariableserviceModule.v9.ConversionCustomVariableServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversioncustomvariableserviceModule.v9.ConversionCustomVariableServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversioncustomvariableserviceModule.v9.ConversionCustomVariableServiceClient();
        assert(client);
    });
    ...
    describe('getConversionCustomVariable', () => {
        it('invokes getConversionCustomVariable without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetConversionCustomVariableRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ConversionCustomVariable());
        ...
        it('invokes getConversionCustomVariable without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConversionCustomVariable(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IConversionCustomVariable|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateConversionCustomVariables', () => {
        it('invokes mutateConversionCustomVariables without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateConversionCustomVariablesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateConversionCustomVariablesResponse());
        ...
        it('invokes mutateConversionCustomVariables without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionCustomVariables(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateConversionCustomVariablesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
