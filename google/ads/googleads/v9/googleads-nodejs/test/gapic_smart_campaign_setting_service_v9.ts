...
describe('v9.SmartCampaignSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = smartcampaignsettingserviceModule.v9.SmartCampaignSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = smartcampaignsettingserviceModule.v9.SmartCampaignSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = smartcampaignsettingserviceModule.v9.SmartCampaignSettingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new smartcampaignsettingserviceModule.v9.SmartCampaignSettingServiceClient();
        assert(client);
    });
    ...
    describe('getSmartCampaignSetting', () => {
        it('invokes getSmartCampaignSetting without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetSmartCampaignSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.SmartCampaignSetting());
        ...
        it('invokes getSmartCampaignSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSmartCampaignSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ISmartCampaignSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateSmartCampaignSettings', () => {
        it('invokes mutateSmartCampaignSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateSmartCampaignSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateSmartCampaignSettingsResponse());
        ...
        it('invokes mutateSmartCampaignSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateSmartCampaignSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateSmartCampaignSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
