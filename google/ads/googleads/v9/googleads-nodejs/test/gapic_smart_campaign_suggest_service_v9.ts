...
import * as smartcampaignsuggestserviceModule from '../src';
...
describe('v9.SmartCampaignSuggestServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = smartcampaignsuggestserviceModule.v9.SmartCampaignSuggestServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = smartcampaignsuggestserviceModule.v9.SmartCampaignSuggestServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = smartcampaignsuggestserviceModule.v9.SmartCampaignSuggestServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new smartcampaignsuggestserviceModule.v9.SmartCampaignSuggestServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.smartCampaignSuggestServiceStub, undefined);
        await client.initialize();
        assert(client.smartCampaignSuggestServiceStub);
    });
    ...
    describe('suggestSmartCampaignBudgetOptions', () => {
        it('invokes suggestSmartCampaignBudgetOptions without error', async () => {
            const client = new smartcampaignsuggestserviceModule.v9.SmartCampaignSuggestServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.SuggestSmartCampaignBudgetOptionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.SuggestSmartCampaignBudgetOptionsResponse());
            client.innerApiCalls.suggestSmartCampaignBudgetOptions = stubSimpleCall(expectedResponse);
            const [response] = await client.suggestSmartCampaignBudgetOptions(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.suggestSmartCampaignBudgetOptions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes suggestSmartCampaignBudgetOptions without error using callback', async () => {
            const client = new smartcampaignsuggestserviceModule.v9.SmartCampaignSuggestServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.SuggestSmartCampaignBudgetOptionsResponse());
            client.innerApiCalls.suggestSmartCampaignBudgetOptions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.suggestSmartCampaignBudgetOptions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.ISuggestSmartCampaignBudgetOptionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestSmartCampaignBudgetOptions with error', async () => {
            const client = new smartcampaignsuggestserviceModule.v9.SmartCampaignSuggestServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.suggestSmartCampaignBudgetOptions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.suggestSmartCampaignBudgetOptions(request), expectedError);
            assert((client.innerApiCalls.suggestSmartCampaignBudgetOptions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('suggestSmartCampaignAd', () => {
        it('invokes suggestSmartCampaignAd without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.SuggestSmartCampaignAdRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.SuggestSmartCampaignAdResponse());
        ...
        it('invokes suggestSmartCampaignAd without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestSmartCampaignAd(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.ISuggestSmartCampaignAdResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestKeywordThemes', () => {
        it('invokes suggestKeywordThemes without error', async () => {
            const client = new smartcampaignsuggestserviceModule.v9.SmartCampaignSuggestServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.SuggestKeywordThemesRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.SuggestKeywordThemesResponse());
            client.innerApiCalls.suggestKeywordThemes = stubSimpleCall(expectedResponse);
            const [response] = await client.suggestKeywordThemes(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.suggestKeywordThemes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes suggestKeywordThemes without error using callback', async () => {
            const client = new smartcampaignsuggestserviceModule.v9.SmartCampaignSuggestServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.SuggestKeywordThemesResponse());
            client.innerApiCalls.suggestKeywordThemes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.suggestKeywordThemes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.ISuggestKeywordThemesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestKeywordThemes with error', async () => {
            const client = new smartcampaignsuggestserviceModule.v9.SmartCampaignSuggestServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.suggestKeywordThemes = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.suggestKeywordThemes(request), expectedError);
            assert((client.innerApiCalls.suggestKeywordThemes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
