...
describe('v9.AdGroupSimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupsimulationserviceModule.v9.AdGroupSimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupsimulationserviceModule.v9.AdGroupSimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupsimulationserviceModule.v9.AdGroupSimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupsimulationserviceModule.v9.AdGroupSimulationServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupSimulation', () => {
        it('invokes getAdGroupSimulation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAdGroupSimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdGroupSimulation());
        ...
        it('invokes getAdGroupSimulation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAdGroupSimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
