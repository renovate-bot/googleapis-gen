...
describe('v9.AdGroupExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupextensionsettingserviceModule.v9.AdGroupExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupextensionsettingserviceModule.v9.AdGroupExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupextensionsettingserviceModule.v9.AdGroupExtensionSettingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupextensionsettingserviceModule.v9.AdGroupExtensionSettingServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupExtensionSetting', () => {
        it('invokes getAdGroupExtensionSetting without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAdGroupExtensionSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdGroupExtensionSetting());
        ...
        it('invokes getAdGroupExtensionSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAdGroupExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupExtensionSettings', () => {
        it('invokes mutateAdGroupExtensionSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupExtensionSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupExtensionSettingsResponse());
        ...
        it('invokes mutateAdGroupExtensionSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAdGroupExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
