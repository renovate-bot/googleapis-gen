...
import * as assetgrouplistinggroupfilterserviceModule from '../src';
...
describe('v9.AssetGroupListingGroupFilterServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = assetgrouplistinggroupfilterserviceModule.v9.AssetGroupListingGroupFilterServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = assetgrouplistinggroupfilterserviceModule.v9.AssetGroupListingGroupFilterServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = assetgrouplistinggroupfilterserviceModule.v9.AssetGroupListingGroupFilterServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new assetgrouplistinggroupfilterserviceModule.v9.AssetGroupListingGroupFilterServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.assetGroupListingGroupFilterServiceStub, undefined);
        await client.initialize();
        assert(client.assetGroupListingGroupFilterServiceStub);
    });
    ...
    describe('mutateAssetGroupListingGroupFilters', () => {
        it('invokes mutateAssetGroupListingGroupFilters without error', async () => {
            const client = new assetgrouplistinggroupfilterserviceModule.v9.AssetGroupListingGroupFilterServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse());
            client.innerApiCalls.mutateAssetGroupListingGroupFilters = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAssetGroupListingGroupFilters(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAssetGroupListingGroupFilters as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAssetGroupListingGroupFilters without error using callback', async () => {
            const client = new assetgrouplistinggroupfilterserviceModule.v9.AssetGroupListingGroupFilterServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersResponse());
            client.innerApiCalls.mutateAssetGroupListingGroupFilters = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAssetGroupListingGroupFilters(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAssetGroupListingGroupFiltersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAssetGroupListingGroupFilters with error', async () => {
            const client = new assetgrouplistinggroupfilterserviceModule.v9.AssetGroupListingGroupFilterServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateAssetGroupListingGroupFilters = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAssetGroupListingGroupFilters(request), expectedError);
            assert((client.innerApiCalls.mutateAssetGroupListingGroupFilters as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
