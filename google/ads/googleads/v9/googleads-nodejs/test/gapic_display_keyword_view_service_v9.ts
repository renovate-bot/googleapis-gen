...
describe('v9.DisplayKeywordViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = displaykeywordviewserviceModule.v9.DisplayKeywordViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = displaykeywordviewserviceModule.v9.DisplayKeywordViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = displaykeywordviewserviceModule.v9.DisplayKeywordViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new displaykeywordviewserviceModule.v9.DisplayKeywordViewServiceClient();
        assert(client);
    });
    ...
    describe('getDisplayKeywordView', () => {
        it('invokes getDisplayKeywordView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetDisplayKeywordViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.DisplayKeywordView());
        ...
        it('invokes getDisplayKeywordView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDisplayKeywordView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IDisplayKeywordView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
