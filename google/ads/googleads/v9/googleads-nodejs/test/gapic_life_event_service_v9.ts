...
import * as lifeeventserviceModule from '../src';
...
describe('v9.LifeEventServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = lifeeventserviceModule.v9.LifeEventServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = lifeeventserviceModule.v9.LifeEventServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = lifeeventserviceModule.v9.LifeEventServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new lifeeventserviceModule.v9.LifeEventServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.lifeEventServiceStub, undefined);
        await client.initialize();
        assert(client.lifeEventServiceStub);
    });
    ...
    describe('getLifeEvent', () => {
        it('invokes getLifeEvent without error', async () => {
            const client = new lifeeventserviceModule.v9.LifeEventServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetLifeEventRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.LifeEvent());
            client.innerApiCalls.getLifeEvent = stubSimpleCall(expectedResponse);
            const [response] = await client.getLifeEvent(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getLifeEvent as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getLifeEvent without error using callback', async () => {
            const client = new lifeeventserviceModule.v9.LifeEventServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.LifeEvent());
            client.innerApiCalls.getLifeEvent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getLifeEvent(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ILifeEvent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getLifeEvent with error', async () => {
            const client = new lifeeventserviceModule.v9.LifeEventServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getLifeEvent = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getLifeEvent(request), expectedError);
            assert((client.innerApiCalls.getLifeEvent as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
