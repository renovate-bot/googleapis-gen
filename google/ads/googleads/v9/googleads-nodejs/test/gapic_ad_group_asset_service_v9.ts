...
describe('v9.AdGroupAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupassetserviceModule.v9.AdGroupAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupassetserviceModule.v9.AdGroupAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupassetserviceModule.v9.AdGroupAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupassetserviceModule.v9.AdGroupAssetServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupAsset', () => {
        it('invokes getAdGroupAsset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAdGroupAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdGroupAsset());
        ...
        it('invokes getAdGroupAsset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAdGroupAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupAssets', () => {
        it('invokes mutateAdGroupAssets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupAssetsResponse());
        ...
        it('invokes mutateAdGroupAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAdGroupAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
