...
describe('v9.UserLocationViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = userlocationviewserviceModule.v9.UserLocationViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = userlocationviewserviceModule.v9.UserLocationViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = userlocationviewserviceModule.v9.UserLocationViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new userlocationviewserviceModule.v9.UserLocationViewServiceClient();
        assert(client);
    });
    ...
    describe('getUserLocationView', () => {
        it('invokes getUserLocationView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetUserLocationViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.UserLocationView());
        ...
        it('invokes getUserLocationView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getUserLocationView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IUserLocationView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
