...
import * as accessiblebiddingstrategyserviceModule from '../src';
...
describe('v9.AccessibleBiddingStrategyServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = accessiblebiddingstrategyserviceModule.v9.AccessibleBiddingStrategyServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = accessiblebiddingstrategyserviceModule.v9.AccessibleBiddingStrategyServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = accessiblebiddingstrategyserviceModule.v9.AccessibleBiddingStrategyServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new accessiblebiddingstrategyserviceModule.v9.AccessibleBiddingStrategyServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.accessibleBiddingStrategyServiceStub, undefined);
        await client.initialize();
        assert(client.accessibleBiddingStrategyServiceStub);
    });
    ...
    describe('getAccessibleBiddingStrategy', () => {
        it('invokes getAccessibleBiddingStrategy without error', async () => {
            const client = new accessiblebiddingstrategyserviceModule.v9.AccessibleBiddingStrategyServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AccessibleBiddingStrategy());
            client.innerApiCalls.getAccessibleBiddingStrategy = stubSimpleCall(expectedResponse);
            const [response] = await client.getAccessibleBiddingStrategy(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAccessibleBiddingStrategy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAccessibleBiddingStrategy without error using callback', async () => {
            const client = new accessiblebiddingstrategyserviceModule.v9.AccessibleBiddingStrategyServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AccessibleBiddingStrategy());
            client.innerApiCalls.getAccessibleBiddingStrategy = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAccessibleBiddingStrategy(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAccessibleBiddingStrategy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAccessibleBiddingStrategy with error', async () => {
            const client = new accessiblebiddingstrategyserviceModule.v9.AccessibleBiddingStrategyServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getAccessibleBiddingStrategy = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAccessibleBiddingStrategy(request), expectedError);
            assert((client.innerApiCalls.getAccessibleBiddingStrategy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
