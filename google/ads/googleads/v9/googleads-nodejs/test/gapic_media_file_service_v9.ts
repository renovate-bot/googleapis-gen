...
describe('v9.MediaFileServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = mediafileserviceModule.v9.MediaFileServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = mediafileserviceModule.v9.MediaFileServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = mediafileserviceModule.v9.MediaFileServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new mediafileserviceModule.v9.MediaFileServiceClient();
        assert(client);
    });
    ...
    describe('getMediaFile', () => {
        it('invokes getMediaFile without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetMediaFileRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.MediaFile());
        ...
        it('invokes getMediaFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMediaFile(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IMediaFile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateMediaFiles', () => {
        it('invokes mutateMediaFiles without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateMediaFilesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateMediaFilesResponse());
        ...
        it('invokes mutateMediaFiles without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateMediaFiles(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateMediaFilesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
