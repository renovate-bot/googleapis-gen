...
import * as campaignassetserviceModule from '../src';
...
describe('v9.CampaignAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignassetserviceModule.v9.CampaignAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignassetserviceModule.v9.CampaignAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignassetserviceModule.v9.CampaignAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignassetserviceModule.v9.CampaignAssetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.campaignAssetServiceStub, undefined);
        await client.initialize();
        assert(client.campaignAssetServiceStub);
    });
    ...
    describe('getCampaignAsset', () => {
        it('invokes getCampaignAsset without error', async () => {
            const client = new campaignassetserviceModule.v9.CampaignAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCampaignAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CampaignAsset());
            client.innerApiCalls.getCampaignAsset = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignAsset(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignAsset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCampaignAsset without error using callback', async () => {
            const client = new campaignassetserviceModule.v9.CampaignAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CampaignAsset());
            client.innerApiCalls.getCampaignAsset = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICampaignAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignAsset with error', async () => {
            const client = new campaignassetserviceModule.v9.CampaignAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getCampaignAsset = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignAsset(request), expectedError);
            assert((client.innerApiCalls.getCampaignAsset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCampaignAssets', () => {
        it('invokes mutateCampaignAssets without error', async () => {
            const client = new campaignassetserviceModule.v9.CampaignAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignAssetsResponse());
            client.innerApiCalls.mutateCampaignAssets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignAssets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaignAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCampaignAssets without error using callback', async () => {
            const client = new campaignassetserviceModule.v9.CampaignAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignAssetsResponse());
            client.innerApiCalls.mutateCampaignAssets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCampaignAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignAssets with error', async () => {
            const client = new campaignassetserviceModule.v9.CampaignAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCampaignAssets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignAssets(request), expectedError);
            assert((client.innerApiCalls.mutateCampaignAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
