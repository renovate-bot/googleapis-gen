...
describe('v9.LanguageConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = languageconstantserviceModule.v9.LanguageConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = languageconstantserviceModule.v9.LanguageConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = languageconstantserviceModule.v9.LanguageConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new languageconstantserviceModule.v9.LanguageConstantServiceClient();
        assert(client);
    });
    ...
    describe('getLanguageConstant', () => {
        it('invokes getLanguageConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetLanguageConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.LanguageConstant());
        ...
        it('invokes getLanguageConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLanguageConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ILanguageConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
