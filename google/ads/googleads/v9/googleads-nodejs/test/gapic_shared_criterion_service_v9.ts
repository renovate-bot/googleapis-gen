...
describe('v9.SharedCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = sharedcriterionserviceModule.v9.SharedCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = sharedcriterionserviceModule.v9.SharedCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = sharedcriterionserviceModule.v9.SharedCriterionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new sharedcriterionserviceModule.v9.SharedCriterionServiceClient();
        assert(client);
    });
    ...
    describe('getSharedCriterion', () => {
        it('invokes getSharedCriterion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetSharedCriterionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.SharedCriterion());
        ...
        it('invokes getSharedCriterion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSharedCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ISharedCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateSharedCriteria', () => {
        it('invokes mutateSharedCriteria without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateSharedCriteriaRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateSharedCriteriaResponse());
        ...
        it('invokes mutateSharedCriteria without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateSharedCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateSharedCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
