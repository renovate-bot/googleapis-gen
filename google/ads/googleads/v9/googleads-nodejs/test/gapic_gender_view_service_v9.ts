...
describe('v9.GenderViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = genderviewserviceModule.v9.GenderViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = genderviewserviceModule.v9.GenderViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = genderviewserviceModule.v9.GenderViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new genderviewserviceModule.v9.GenderViewServiceClient();
        assert(client);
    });
    ...
    describe('getGenderView', () => {
        it('invokes getGenderView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetGenderViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.GenderView());
        ...
        it('invokes getGenderView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGenderView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IGenderView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
