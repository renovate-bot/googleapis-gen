...
describe('v9.ThirdPartyAppAnalyticsLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = thirdpartyappanalyticslinkserviceModule.v9.ThirdPartyAppAnalyticsLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = thirdpartyappanalyticslinkserviceModule.v9.ThirdPartyAppAnalyticsLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = thirdpartyappanalyticslinkserviceModule.v9.ThirdPartyAppAnalyticsLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new thirdpartyappanalyticslinkserviceModule.v9.ThirdPartyAppAnalyticsLinkServiceClient();
        assert(client);
    });
    ...
    describe('getThirdPartyAppAnalyticsLink', () => {
        it('invokes getThirdPartyAppAnalyticsLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetThirdPartyAppAnalyticsLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLink());
        ...
        it('invokes getThirdPartyAppAnalyticsLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getThirdPartyAppAnalyticsLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IThirdPartyAppAnalyticsLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('regenerateShareableLinkId', () => {
        it('invokes regenerateShareableLinkId without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.RegenerateShareableLinkIdRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.RegenerateShareableLinkIdResponse());
        ...
        it('invokes regenerateShareableLinkId without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.regenerateShareableLinkId(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IRegenerateShareableLinkIdResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
