...
describe('v9.AdGroupAdAssetViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupadassetviewserviceModule.v9.AdGroupAdAssetViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupadassetviewserviceModule.v9.AdGroupAdAssetViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupadassetviewserviceModule.v9.AdGroupAdAssetViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupadassetviewserviceModule.v9.AdGroupAdAssetViewServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupAdAssetView', () => {
        it('invokes getAdGroupAdAssetView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAdGroupAdAssetViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AdGroupAdAssetView());
        ...
        it('invokes getAdGroupAdAssetView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAdAssetView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAdGroupAdAssetView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
