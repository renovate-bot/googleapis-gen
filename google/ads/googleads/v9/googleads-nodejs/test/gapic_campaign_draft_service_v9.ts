...
describe('v9.CampaignDraftServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaigndraftserviceModule.v9.CampaignDraftServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaigndraftserviceModule.v9.CampaignDraftServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaigndraftserviceModule.v9.CampaignDraftServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaigndraftserviceModule.v9.CampaignDraftServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignDraft', () => {
        it('invokes getCampaignDraft without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCampaignDraftRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CampaignDraft());
        ...
        it('invokes getCampaignDraft without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignDraft(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICampaignDraft|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignDrafts', () => {
        it('invokes mutateCampaignDrafts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignDraftsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignDraftsResponse());
        ...
        it('invokes mutateCampaignDrafts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignDrafts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCampaignDraftsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('promoteCampaignDraft', () => {
        it('invokes promoteCampaignDraft without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.PromoteCampaignDraftRequest());
    ...
    describe('listCampaignDraftAsyncErrors', () => {
        it('invokes listCampaignDraftAsyncErrors without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.ListCampaignDraftAsyncErrorsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
