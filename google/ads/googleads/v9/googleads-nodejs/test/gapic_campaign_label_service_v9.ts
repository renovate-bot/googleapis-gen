...
import * as campaignlabelserviceModule from '../src';
...
describe('v9.CampaignLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignlabelserviceModule.v9.CampaignLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignlabelserviceModule.v9.CampaignLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignlabelserviceModule.v9.CampaignLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignlabelserviceModule.v9.CampaignLabelServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.campaignLabelServiceStub, undefined);
        await client.initialize();
        assert(client.campaignLabelServiceStub);
    });
    ...
    describe('getCampaignLabel', () => {
        it('invokes getCampaignLabel without error', async () => {
            const client = new campaignlabelserviceModule.v9.CampaignLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCampaignLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CampaignLabel());
            client.innerApiCalls.getCampaignLabel = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignLabel(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignLabel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCampaignLabel without error using callback', async () => {
            const client = new campaignlabelserviceModule.v9.CampaignLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CampaignLabel());
            client.innerApiCalls.getCampaignLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICampaignLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignLabel with error', async () => {
            const client = new campaignlabelserviceModule.v9.CampaignLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getCampaignLabel = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignLabel(request), expectedError);
            assert((client.innerApiCalls.getCampaignLabel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCampaignLabels', () => {
        it('invokes mutateCampaignLabels without error', async () => {
            const client = new campaignlabelserviceModule.v9.CampaignLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignLabelsResponse());
            client.innerApiCalls.mutateCampaignLabels = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignLabels(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaignLabels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCampaignLabels without error using callback', async () => {
            const client = new campaignlabelserviceModule.v9.CampaignLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignLabelsResponse());
            client.innerApiCalls.mutateCampaignLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCampaignLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignLabels with error', async () => {
            const client = new campaignlabelserviceModule.v9.CampaignLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCampaignLabels = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignLabels(request), expectedError);
            assert((client.innerApiCalls.mutateCampaignLabels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
