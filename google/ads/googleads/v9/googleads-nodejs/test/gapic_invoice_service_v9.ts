...
describe('v9.InvoiceServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = invoiceserviceModule.v9.InvoiceServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = invoiceserviceModule.v9.InvoiceServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = invoiceserviceModule.v9.InvoiceServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new invoiceserviceModule.v9.InvoiceServiceClient();
        assert(client);
    });
    ...
    describe('listInvoices', () => {
        it('invokes listInvoices without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.ListInvoicesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.ListInvoicesResponse());
        ...
        it('invokes listInvoices without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listInvoices(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IListInvoicesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
