...
describe('v9.AssetFieldTypeViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = assetfieldtypeviewserviceModule.v9.AssetFieldTypeViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = assetfieldtypeviewserviceModule.v9.AssetFieldTypeViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = assetfieldtypeviewserviceModule.v9.AssetFieldTypeViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new assetfieldtypeviewserviceModule.v9.AssetFieldTypeViewServiceClient();
        assert(client);
    });
    ...
    describe('getAssetFieldTypeView', () => {
        it('invokes getAssetFieldTypeView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAssetFieldTypeViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AssetFieldTypeView());
        ...
        it('invokes getAssetFieldTypeView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAssetFieldTypeView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAssetFieldTypeView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
