...
describe('v9.DetailedDemographicServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = detaileddemographicserviceModule.v9.DetailedDemographicServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = detaileddemographicserviceModule.v9.DetailedDemographicServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = detaileddemographicserviceModule.v9.DetailedDemographicServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new detaileddemographicserviceModule.v9.DetailedDemographicServiceClient();
        assert(client);
    });
    ...
    describe('getDetailedDemographic', () => {
        it('invokes getDetailedDemographic without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetDetailedDemographicRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.DetailedDemographic());
        ...
        it('invokes getDetailedDemographic without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDetailedDemographic(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IDetailedDemographic|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
