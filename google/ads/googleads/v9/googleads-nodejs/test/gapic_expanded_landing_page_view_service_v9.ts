...
describe('v9.ExpandedLandingPageViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = expandedlandingpageviewserviceModule.v9.ExpandedLandingPageViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = expandedlandingpageviewserviceModule.v9.ExpandedLandingPageViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = expandedlandingpageviewserviceModule.v9.ExpandedLandingPageViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new expandedlandingpageviewserviceModule.v9.ExpandedLandingPageViewServiceClient();
        assert(client);
    });
    ...
    describe('getExpandedLandingPageView', () => {
        it('invokes getExpandedLandingPageView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetExpandedLandingPageViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ExpandedLandingPageView());
        ...
        it('invokes getExpandedLandingPageView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getExpandedLandingPageView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IExpandedLandingPageView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
