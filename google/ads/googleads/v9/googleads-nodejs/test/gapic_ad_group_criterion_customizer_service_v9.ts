...
import * as adgroupcriterioncustomizerserviceModule from '../src';
...
describe('v9.AdGroupCriterionCustomizerServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupcriterioncustomizerserviceModule.v9.AdGroupCriterionCustomizerServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupcriterioncustomizerserviceModule.v9.AdGroupCriterionCustomizerServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupcriterioncustomizerserviceModule.v9.AdGroupCriterionCustomizerServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupcriterioncustomizerserviceModule.v9.AdGroupCriterionCustomizerServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupCriterionCustomizerServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupCriterionCustomizerServiceStub);
    });
    ...
    describe('mutateAdGroupCriterionCustomizers', () => {
        it('invokes mutateAdGroupCriterionCustomizers without error', async () => {
            const client = new adgroupcriterioncustomizerserviceModule.v9.AdGroupCriterionCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupCriterionCustomizersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupCriterionCustomizersResponse());
            client.innerApiCalls.mutateAdGroupCriterionCustomizers = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupCriterionCustomizers(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupCriterionCustomizers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroupCriterionCustomizers without error using callback', async () => {
            const client = new adgroupcriterioncustomizerserviceModule.v9.AdGroupCriterionCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupCriterionCustomizersResponse());
            client.innerApiCalls.mutateAdGroupCriterionCustomizers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupCriterionCustomizers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAdGroupCriterionCustomizersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupCriterionCustomizers with error', async () => {
            const client = new adgroupcriterioncustomizerserviceModule.v9.AdGroupCriterionCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateAdGroupCriterionCustomizers = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupCriterionCustomizers(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupCriterionCustomizers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
