...
import * as customconversiongoalserviceModule from '../src';
...
describe('v9.CustomConversionGoalServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customconversiongoalserviceModule.v9.CustomConversionGoalServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customconversiongoalserviceModule.v9.CustomConversionGoalServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customconversiongoalserviceModule.v9.CustomConversionGoalServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customconversiongoalserviceModule.v9.CustomConversionGoalServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customConversionGoalServiceStub, undefined);
        await client.initialize();
        assert(client.customConversionGoalServiceStub);
    });
    ...
    describe('mutateCustomConversionGoals', () => {
        it('invokes mutateCustomConversionGoals without error', async () => {
            const client = new customconversiongoalserviceModule.v9.CustomConversionGoalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomConversionGoalsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomConversionGoalsResponse());
            client.innerApiCalls.mutateCustomConversionGoals = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomConversionGoals(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomConversionGoals as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomConversionGoals without error using callback', async () => {
            const client = new customconversiongoalserviceModule.v9.CustomConversionGoalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomConversionGoalsResponse());
            client.innerApiCalls.mutateCustomConversionGoals = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomConversionGoals(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomConversionGoalsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomConversionGoals with error', async () => {
            const client = new customconversiongoalserviceModule.v9.CustomConversionGoalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateCustomConversionGoals = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomConversionGoals(request), expectedError);
            assert((client.innerApiCalls.mutateCustomConversionGoals as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
