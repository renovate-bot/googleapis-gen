...
import * as customerconversiongoalserviceModule from '../src';
...
describe('v9.CustomerConversionGoalServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerconversiongoalserviceModule.v9.CustomerConversionGoalServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerconversiongoalserviceModule.v9.CustomerConversionGoalServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerconversiongoalserviceModule.v9.CustomerConversionGoalServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerconversiongoalserviceModule.v9.CustomerConversionGoalServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customerConversionGoalServiceStub, undefined);
        await client.initialize();
        assert(client.customerConversionGoalServiceStub);
    });
    ...
    describe('mutateCustomerConversionGoals', () => {
        it('invokes mutateCustomerConversionGoals without error', async () => {
            const client = new customerconversiongoalserviceModule.v9.CustomerConversionGoalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerConversionGoalsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerConversionGoalsResponse());
            client.innerApiCalls.mutateCustomerConversionGoals = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomerConversionGoals(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomerConversionGoals as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomerConversionGoals without error using callback', async () => {
            const client = new customerconversiongoalserviceModule.v9.CustomerConversionGoalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerConversionGoalsResponse());
            client.innerApiCalls.mutateCustomerConversionGoals = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerConversionGoals(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomerConversionGoalsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomerConversionGoals with error', async () => {
            const client = new customerconversiongoalserviceModule.v9.CustomerConversionGoalServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateCustomerConversionGoals = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomerConversionGoals(request), expectedError);
            assert((client.innerApiCalls.mutateCustomerConversionGoals as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
