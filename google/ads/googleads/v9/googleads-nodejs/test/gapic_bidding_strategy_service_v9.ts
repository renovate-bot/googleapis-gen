...
describe('v9.BiddingStrategyServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = biddingstrategyserviceModule.v9.BiddingStrategyServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = biddingstrategyserviceModule.v9.BiddingStrategyServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = biddingstrategyserviceModule.v9.BiddingStrategyServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new biddingstrategyserviceModule.v9.BiddingStrategyServiceClient();
        assert(client);
    });
    ...
    describe('getBiddingStrategy', () => {
        it('invokes getBiddingStrategy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetBiddingStrategyRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.BiddingStrategy());
        ...
        it('invokes getBiddingStrategy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBiddingStrategy(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IBiddingStrategy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateBiddingStrategies', () => {
        it('invokes mutateBiddingStrategies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateBiddingStrategiesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateBiddingStrategiesResponse());
        ...
        it('invokes mutateBiddingStrategies without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBiddingStrategies(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateBiddingStrategiesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
