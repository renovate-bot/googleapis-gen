...
describe('v9.ConversionUploadServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionuploadserviceModule.v9.ConversionUploadServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionuploadserviceModule.v9.ConversionUploadServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionuploadserviceModule.v9.ConversionUploadServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionuploadserviceModule.v9.ConversionUploadServiceClient();
        assert(client);
    });
    ...
    describe('uploadClickConversions', () => {
        it('invokes uploadClickConversions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.UploadClickConversionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.UploadClickConversionsResponse());
        ...
        it('invokes uploadClickConversions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.uploadClickConversions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IUploadClickConversionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('uploadCallConversions', () => {
        it('invokes uploadCallConversions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.UploadCallConversionsRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.UploadCallConversionsResponse());
        ...
        it('invokes uploadCallConversions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.uploadCallConversions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IUploadCallConversionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
