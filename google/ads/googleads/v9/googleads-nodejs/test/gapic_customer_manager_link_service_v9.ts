...
describe('v9.CustomerManagerLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customermanagerlinkserviceModule.v9.CustomerManagerLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customermanagerlinkserviceModule.v9.CustomerManagerLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customermanagerlinkserviceModule.v9.CustomerManagerLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customermanagerlinkserviceModule.v9.CustomerManagerLinkServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerManagerLink', () => {
        it('invokes getCustomerManagerLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCustomerManagerLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CustomerManagerLink());
        ...
        it('invokes getCustomerManagerLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICustomerManagerLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerManagerLink', () => {
        it('invokes mutateCustomerManagerLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerManagerLinkRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerManagerLinkResponse());
        ...
        it('invokes mutateCustomerManagerLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomerManagerLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('moveManagerLink', () => {
        it('invokes moveManagerLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MoveManagerLinkRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MoveManagerLinkResponse());
        ...
        it('invokes moveManagerLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMoveManagerLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
