...
import * as assetgroupassetserviceModule from '../src';
...
describe('v9.AssetGroupAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = assetgroupassetserviceModule.v9.AssetGroupAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = assetgroupassetserviceModule.v9.AssetGroupAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = assetgroupassetserviceModule.v9.AssetGroupAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new assetgroupassetserviceModule.v9.AssetGroupAssetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.assetGroupAssetServiceStub, undefined);
        await client.initialize();
        assert(client.assetGroupAssetServiceStub);
    });
    ...
    describe('getAssetGroupAsset', () => {
        it('invokes getAssetGroupAsset without error', async () => {
            const client = new assetgroupassetserviceModule.v9.AssetGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetAssetGroupAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AssetGroupAsset());
            client.innerApiCalls.getAssetGroupAsset = stubSimpleCall(expectedResponse);
            const [response] = await client.getAssetGroupAsset(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAssetGroupAsset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAssetGroupAsset without error using callback', async () => {
            const client = new assetgroupassetserviceModule.v9.AssetGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.AssetGroupAsset());
            client.innerApiCalls.getAssetGroupAsset = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAssetGroupAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IAssetGroupAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAssetGroupAsset with error', async () => {
            const client = new assetgroupassetserviceModule.v9.AssetGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getAssetGroupAsset = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAssetGroupAsset(request), expectedError);
            assert((client.innerApiCalls.getAssetGroupAsset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAssetGroupAssets', () => {
        it('invokes mutateAssetGroupAssets without error', async () => {
            const client = new assetgroupassetserviceModule.v9.AssetGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetGroupAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetGroupAssetsResponse());
            client.innerApiCalls.mutateAssetGroupAssets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAssetGroupAssets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAssetGroupAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAssetGroupAssets without error using callback', async () => {
            const client = new assetgroupassetserviceModule.v9.AssetGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAssetGroupAssetsResponse());
            client.innerApiCalls.mutateAssetGroupAssets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAssetGroupAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAssetGroupAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAssetGroupAssets with error', async () => {
            const client = new assetgroupassetserviceModule.v9.AssetGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAssetGroupAssets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAssetGroupAssets(request), expectedError);
            assert((client.innerApiCalls.mutateAssetGroupAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
