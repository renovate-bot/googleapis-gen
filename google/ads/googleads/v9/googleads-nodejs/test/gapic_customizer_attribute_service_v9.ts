...
describe('v9.CustomizerAttributeServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customizerattributeserviceModule.v9.CustomizerAttributeServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customizerattributeserviceModule.v9.CustomizerAttributeServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customizerattributeserviceModule.v9.CustomizerAttributeServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customizerattributeserviceModule.v9.CustomizerAttributeServiceClient();
        assert(client);
    });
    ...
    describe('mutateCustomizerAttributes', () => {
        it('invokes mutateCustomizerAttributes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomizerAttributesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomizerAttributesResponse());
            ...
            assert((client.innerApiCalls.mutateCustomizerAttributes as SinonStub)
        ...
        it('invokes mutateCustomizerAttributes without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomizerAttributes(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomizerAttributesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
