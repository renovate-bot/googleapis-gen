...
import * as billingsetupserviceModule from '../src';
...
describe('v9.BillingSetupServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = billingsetupserviceModule.v9.BillingSetupServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = billingsetupserviceModule.v9.BillingSetupServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = billingsetupserviceModule.v9.BillingSetupServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new billingsetupserviceModule.v9.BillingSetupServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.billingSetupServiceStub, undefined);
        await client.initialize();
        assert(client.billingSetupServiceStub);
    });
    ...
    describe('getBillingSetup', () => {
        it('invokes getBillingSetup without error', async () => {
            const client = new billingsetupserviceModule.v9.BillingSetupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetBillingSetupRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.BillingSetup());
            client.innerApiCalls.getBillingSetup = stubSimpleCall(expectedResponse);
            const [response] = await client.getBillingSetup(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getBillingSetup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getBillingSetup without error using callback', async () => {
            const client = new billingsetupserviceModule.v9.BillingSetupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.BillingSetup());
            client.innerApiCalls.getBillingSetup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBillingSetup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IBillingSetup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBillingSetup with error', async () => {
            const client = new billingsetupserviceModule.v9.BillingSetupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getBillingSetup = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getBillingSetup(request), expectedError);
            assert((client.innerApiCalls.getBillingSetup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateBillingSetup', () => {
        it('invokes mutateBillingSetup without error', async () => {
            const client = new billingsetupserviceModule.v9.BillingSetupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateBillingSetupRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateBillingSetupResponse());
            client.innerApiCalls.mutateBillingSetup = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateBillingSetup(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateBillingSetup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateBillingSetup without error using callback', async () => {
            const client = new billingsetupserviceModule.v9.BillingSetupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateBillingSetupResponse());
            client.innerApiCalls.mutateBillingSetup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateBillingSetup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateBillingSetupResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateBillingSetup with error', async () => {
            const client = new billingsetupserviceModule.v9.BillingSetupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateBillingSetup = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateBillingSetup(request), expectedError);
            assert((client.innerApiCalls.mutateBillingSetup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
