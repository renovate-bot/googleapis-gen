...
describe('v9.CampaignConversionGoalServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignconversiongoalserviceModule.v9.CampaignConversionGoalServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignconversiongoalserviceModule.v9.CampaignConversionGoalServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignconversiongoalserviceModule.v9.CampaignConversionGoalServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignconversiongoalserviceModule.v9.CampaignConversionGoalServiceClient();
        assert(client);
    });
    ...
    describe('mutateCampaignConversionGoals', () => {
        it('invokes mutateCampaignConversionGoals without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignConversionGoalsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignConversionGoalsResponse());
            ...
            assert((client.innerApiCalls.mutateCampaignConversionGoals as SinonStub)
        ...
        it('invokes mutateCampaignConversionGoals without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignConversionGoals(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCampaignConversionGoalsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
