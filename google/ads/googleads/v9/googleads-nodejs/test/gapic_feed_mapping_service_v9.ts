...
describe('v9.FeedMappingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feedmappingserviceModule.v9.FeedMappingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feedmappingserviceModule.v9.FeedMappingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feedmappingserviceModule.v9.FeedMappingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feedmappingserviceModule.v9.FeedMappingServiceClient();
        assert(client);
    });
    ...
    describe('getFeedMapping', () => {
        it('invokes getFeedMapping without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetFeedMappingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.FeedMapping());
        ...
        it('invokes getFeedMapping without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeedMapping(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IFeedMapping|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateFeedMappings', () => {
        it('invokes mutateFeedMappings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateFeedMappingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateFeedMappingsResponse());
        ...
        it('invokes mutateFeedMappings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedMappings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateFeedMappingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
