...
import * as adgroupcustomizerserviceModule from '../src';
...
describe('v9.AdGroupCustomizerServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupcustomizerserviceModule.v9.AdGroupCustomizerServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupcustomizerserviceModule.v9.AdGroupCustomizerServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupcustomizerserviceModule.v9.AdGroupCustomizerServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupcustomizerserviceModule.v9.AdGroupCustomizerServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupCustomizerServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupCustomizerServiceStub);
    });
    ...
    describe('mutateAdGroupCustomizers', () => {
        it('invokes mutateAdGroupCustomizers without error', async () => {
            const client = new adgroupcustomizerserviceModule.v9.AdGroupCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupCustomizersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupCustomizersResponse());
            client.innerApiCalls.mutateAdGroupCustomizers = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupCustomizers(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupCustomizers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroupCustomizers without error using callback', async () => {
            const client = new adgroupcustomizerserviceModule.v9.AdGroupCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateAdGroupCustomizersResponse());
            client.innerApiCalls.mutateAdGroupCustomizers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupCustomizers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateAdGroupCustomizersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupCustomizers with error', async () => {
            const client = new adgroupcustomizerserviceModule.v9.AdGroupCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateAdGroupCustomizers = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupCustomizers(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupCustomizers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
