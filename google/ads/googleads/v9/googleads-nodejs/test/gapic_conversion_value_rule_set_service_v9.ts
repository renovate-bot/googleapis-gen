...
describe('v9.ConversionValueRuleSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionvaluerulesetserviceModule.v9.ConversionValueRuleSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionvaluerulesetserviceModule.v9.ConversionValueRuleSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionvaluerulesetserviceModule.v9.ConversionValueRuleSetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionvaluerulesetserviceModule.v9.ConversionValueRuleSetServiceClient();
        assert(client);
    });
    ...
    describe('getConversionValueRuleSet', () => {
        it('invokes getConversionValueRuleSet without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetConversionValueRuleSetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.ConversionValueRuleSet());
        ...
        it('invokes getConversionValueRuleSet without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConversionValueRuleSet(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IConversionValueRuleSet|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateConversionValueRuleSets', () => {
        it('invokes mutateConversionValueRuleSets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateConversionValueRuleSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateConversionValueRuleSetsResponse());
        ...
        it('invokes mutateConversionValueRuleSets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionValueRuleSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateConversionValueRuleSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
