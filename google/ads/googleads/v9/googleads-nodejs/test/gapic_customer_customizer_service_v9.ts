...
import * as customercustomizerserviceModule from '../src';
...
describe('v9.CustomerCustomizerServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customercustomizerserviceModule.v9.CustomerCustomizerServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customercustomizerserviceModule.v9.CustomerCustomizerServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customercustomizerserviceModule.v9.CustomerCustomizerServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customercustomizerserviceModule.v9.CustomerCustomizerServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customerCustomizerServiceStub, undefined);
        await client.initialize();
        assert(client.customerCustomizerServiceStub);
    });
    ...
    describe('mutateCustomerCustomizers', () => {
        it('invokes mutateCustomerCustomizers without error', async () => {
            const client = new customercustomizerserviceModule.v9.CustomerCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerCustomizersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerCustomizersResponse());
            client.innerApiCalls.mutateCustomerCustomizers = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomerCustomizers(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomerCustomizers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomerCustomizers without error using callback', async () => {
            const client = new customercustomizerserviceModule.v9.CustomerCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerCustomizersResponse());
            client.innerApiCalls.mutateCustomerCustomizers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerCustomizers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomerCustomizersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomerCustomizers with error', async () => {
            const client = new customercustomizerserviceModule.v9.CustomerCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateCustomerCustomizers = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomerCustomizers(request), expectedError);
            assert((client.innerApiCalls.mutateCustomerCustomizers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
