...
describe('v9.GeoTargetConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = geotargetconstantserviceModule.v9.GeoTargetConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = geotargetconstantserviceModule.v9.GeoTargetConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = geotargetconstantserviceModule.v9.GeoTargetConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new geotargetconstantserviceModule.v9.GeoTargetConstantServiceClient();
        assert(client);
    });
    ...
    describe('getGeoTargetConstant', () => {
        it('invokes getGeoTargetConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetGeoTargetConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.GeoTargetConstant());
        ...
        it('invokes getGeoTargetConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGeoTargetConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.IGeoTargetConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestGeoTargetConstants without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestGeoTargetConstants(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.ISuggestGeoTargetConstantsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
