...
import * as campaigncustomizerserviceModule from '../src';
...
describe('v9.CampaignCustomizerServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaigncustomizerserviceModule.v9.CampaignCustomizerServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaigncustomizerserviceModule.v9.CampaignCustomizerServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaigncustomizerserviceModule.v9.CampaignCustomizerServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaigncustomizerserviceModule.v9.CampaignCustomizerServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.campaignCustomizerServiceStub, undefined);
        await client.initialize();
        assert(client.campaignCustomizerServiceStub);
    });
    ...
    describe('mutateCampaignCustomizers', () => {
        it('invokes mutateCampaignCustomizers without error', async () => {
            const client = new campaigncustomizerserviceModule.v9.CampaignCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignCustomizersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignCustomizersResponse());
            client.innerApiCalls.mutateCampaignCustomizers = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignCustomizers(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaignCustomizers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCampaignCustomizers without error using callback', async () => {
            const client = new campaigncustomizerserviceModule.v9.CampaignCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCampaignCustomizersResponse());
            client.innerApiCalls.mutateCampaignCustomizers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignCustomizers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCampaignCustomizersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignCustomizers with error', async () => {
            const client = new campaigncustomizerserviceModule.v9.CampaignCustomizerServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateCampaignCustomizers = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignCustomizers(request), expectedError);
            assert((client.innerApiCalls.mutateCampaignCustomizers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
