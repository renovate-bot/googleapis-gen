...
describe('v9.CustomerExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerextensionsettingserviceModule.v9.CustomerExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerextensionsettingserviceModule.v9.CustomerExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerextensionsettingserviceModule.v9.CustomerExtensionSettingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerextensionsettingserviceModule.v9.CustomerExtensionSettingServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerExtensionSetting', () => {
        it('invokes getCustomerExtensionSetting without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCustomerExtensionSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CustomerExtensionSetting());
        ...
        it('invokes getCustomerExtensionSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICustomerExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerExtensionSettings', () => {
        it('invokes mutateCustomerExtensionSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerExtensionSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerExtensionSettingsResponse());
        ...
        it('invokes mutateCustomerExtensionSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomerExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
