...
import * as conversiongoalcampaignconfigserviceModule from '../src';
...
describe('v9.ConversionGoalCampaignConfigServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversiongoalcampaignconfigserviceModule.v9.ConversionGoalCampaignConfigServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversiongoalcampaignconfigserviceModule.v9.ConversionGoalCampaignConfigServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversiongoalcampaignconfigserviceModule.v9.ConversionGoalCampaignConfigServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversiongoalcampaignconfigserviceModule.v9.ConversionGoalCampaignConfigServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.conversionGoalCampaignConfigServiceStub, undefined);
        await client.initialize();
        assert(client.conversionGoalCampaignConfigServiceStub);
    });
    ...
    describe('mutateConversionGoalCampaignConfigs', () => {
        it('invokes mutateConversionGoalCampaignConfigs without error', async () => {
            const client = new conversiongoalcampaignconfigserviceModule.v9.ConversionGoalCampaignConfigServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateConversionGoalCampaignConfigsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateConversionGoalCampaignConfigsResponse());
            client.innerApiCalls.mutateConversionGoalCampaignConfigs = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateConversionGoalCampaignConfigs(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateConversionGoalCampaignConfigs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateConversionGoalCampaignConfigs without error using callback', async () => {
            const client = new conversiongoalcampaignconfigserviceModule.v9.ConversionGoalCampaignConfigServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateConversionGoalCampaignConfigsResponse());
            client.innerApiCalls.mutateConversionGoalCampaignConfigs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionGoalCampaignConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateConversionGoalCampaignConfigsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateConversionGoalCampaignConfigs with error', async () => {
            const client = new conversiongoalcampaignconfigserviceModule.v9.ConversionGoalCampaignConfigServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.mutateConversionGoalCampaignConfigs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateConversionGoalCampaignConfigs(request), expectedError);
            assert((client.innerApiCalls.mutateConversionGoalCampaignConfigs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
