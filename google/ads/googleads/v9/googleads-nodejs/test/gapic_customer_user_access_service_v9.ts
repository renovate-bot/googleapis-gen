...
describe('v9.CustomerUserAccessServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customeruseraccessserviceModule.v9.CustomerUserAccessServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customeruseraccessserviceModule.v9.CustomerUserAccessServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customeruseraccessserviceModule.v9.CustomerUserAccessServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customeruseraccessserviceModule.v9.CustomerUserAccessServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerUserAccess', () => {
        it('invokes getCustomerUserAccess without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.GetCustomerUserAccessRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.resources.CustomerUserAccess());
        ...
        it('invokes getCustomerUserAccess without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerUserAccess(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.resources.ICustomerUserAccess|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerUserAccess', () => {
        it('invokes mutateCustomerUserAccess without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerUserAccessRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v9.services.MutateCustomerUserAccessResponse());
        ...
        it('invokes mutateCustomerUserAccess without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerUserAccess(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v9.services.IMutateCustomerUserAccessResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
