...
use Google\Ads\GoogleAds\V9\Services\BatchJobResult;
...
class BatchJobServiceClientTest extends GeneratedTest
{
    ...
    public function addBatchJobOperationsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.BatchJobService/AddBatchJobOperations', $actualFuncCall);
    ...
    public function getBatchJobTest()
    {
        ...
        $id = 3355;
        $nextAddSequenceToken = 'nextAddSequenceToken1654552613';
        $longRunningOperation = 'longRunningOperation827165668';
        $expectedResponse = new BatchJob();
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.BatchJobService/GetBatchJob', $actualFuncCall);
        $actualValue = $actualRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBatchJobResultsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.BatchJobService/ListBatchJobResults', $actualFuncCall);
        $actualValue = $actualRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateBatchJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.BatchJobService/MutateBatchJob', $actualFuncCall);
    ...
    public function runBatchJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.BatchJobService/RunBatchJob', $actualApiFuncCall);
