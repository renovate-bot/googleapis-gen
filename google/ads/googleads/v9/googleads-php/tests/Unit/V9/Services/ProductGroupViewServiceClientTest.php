...
use Google\Ads\GoogleAds\V9\Resources\ProductGroupView;
...
class ProductGroupViewServiceClientTest extends GeneratedTest
{
    ...
    public function getProductGroupViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.ProductGroupViewService/GetProductGroupView', $actualFuncCall);
