...
use Google\Ads\GoogleAds\V9\Resources\SearchTermView;
...
class SearchTermViewServiceClientTest extends GeneratedTest
{
    ...
    public function getSearchTermViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.SearchTermViewService/GetSearchTermView', $actualFuncCall);
