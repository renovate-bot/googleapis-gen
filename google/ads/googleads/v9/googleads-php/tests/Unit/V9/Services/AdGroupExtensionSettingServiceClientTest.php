...
use Google\Ads\GoogleAds\V9\Resources\AdGroupExtensionSetting;
use Google\Ads\GoogleAds\V9\Services\MutateAdGroupExtensionSettingsResponse;
...
class AdGroupExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupExtensionSettingTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->adGroupExtensionSettingName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[EXTENSION_TYPE]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.AdGroupExtensionSettingService/GetAdGroupExtensionSetting', $actualFuncCall);
    ...
    public function mutateAdGroupExtensionSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.AdGroupExtensionSettingService/MutateAdGroupExtensionSettings', $actualFuncCall);
