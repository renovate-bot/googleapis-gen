...
use Google\Ads\GoogleAds\V9\Services\MutateCampaignSharedSetsResponse;
...
class CampaignSharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignSharedSetTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->campaignSharedSetName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[SHARED_SET_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.CampaignSharedSetService/GetCampaignSharedSet', $actualFuncCall);
    ...
    public function mutateCampaignSharedSetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.CampaignSharedSetService/MutateCampaignSharedSets', $actualFuncCall);
