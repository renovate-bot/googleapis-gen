...
class MerchantCenterLinkServiceClientTest extends GeneratedTest
{
    ...
    public function getMerchantCenterLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.MerchantCenterLinkService/GetMerchantCenterLink', $actualFuncCall);
    ...
    public function listMerchantCenterLinksTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.MerchantCenterLinkService/ListMerchantCenterLinks', $actualFuncCall);
    ...
    public function mutateMerchantCenterLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.MerchantCenterLinkService/MutateMerchantCenterLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
