...
use Google\Ads\GoogleAds\V9\Resources\GoogleAdsField;
use Google\Ads\GoogleAds\V9\Services\SearchGoogleAdsFieldsResponse;
...
class GoogleAdsFieldServiceClientTest extends GeneratedTest
{
    ...
    public function getGoogleAdsFieldTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.GoogleAdsFieldService/GetGoogleAdsField', $actualFuncCall);
    ...
    public function searchGoogleAdsFieldsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.GoogleAdsFieldService/SearchGoogleAdsFields', $actualFuncCall);
