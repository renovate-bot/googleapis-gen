 ...
 * @group gapic
 */
class ProductBiddingCategoryConstantServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getProductBiddingCategoryConstantTest()
    {
        ...
        $productBiddingCategoryConstantParent = 'productBiddingCategoryConstantParent745572856';
        $languageCode = 'languageCode-412800396';
        $localizedName = 'localizedName134243535';
        ...
        $expectedResponse->setProductBiddingCategoryConstantParent($productBiddingCategoryConstantParent);
        $expectedResponse->setLanguageCode($languageCode);
        $expectedResponse->setLocalizedName($localizedName);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->productBiddingCategoryConstantName('[COUNTRY_CODE]', '[LEVEL]', '[ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.ProductBiddingCategoryConstantService/GetProductBiddingCategoryConstant', $actualFuncCall);
