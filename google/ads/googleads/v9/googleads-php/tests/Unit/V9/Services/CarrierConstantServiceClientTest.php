...
class CarrierConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getCarrierConstantTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->carrierConstantName('[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.CarrierConstantService/GetCarrierConstant', $actualFuncCall);
