...
class MediaFileServiceClientTest extends GeneratedTest
{
    ...
    public function getMediaFileTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.MediaFileService/GetMediaFile', $actualFuncCall);
    ...
    public function mutateMediaFilesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.MediaFileService/MutateMediaFiles', $actualFuncCall);
