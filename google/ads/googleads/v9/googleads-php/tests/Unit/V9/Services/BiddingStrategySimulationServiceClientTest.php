...
use Google\Ads\GoogleAds\V9\Resources\BiddingStrategySimulation;
...
class BiddingStrategySimulationServiceClientTest extends GeneratedTest
{
    ...
    public function getBiddingStrategySimulationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.BiddingStrategySimulationService/GetBiddingStrategySimulation', $actualFuncCall);
