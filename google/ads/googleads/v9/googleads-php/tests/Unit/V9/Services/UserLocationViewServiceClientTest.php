...
use Google\Ads\GoogleAds\V9\Resources\UserLocationView;
 ...
 * @group gapic
 */
class UserLocationViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getUserLocationViewTest()
    {
        ...
        $countryCriterionId = 1427674750;
        $targetingLocation = false;
        $expectedResponse = new UserLocationView();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setCountryCriterionId($countryCriterionId);
        $expectedResponse->setTargetingLocation($targetingLocation);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->userLocationViewName('[CUSTOMER_ID]', '[COUNTRY_CRITERION_ID]', '[IS_TARGETING_LOCATION]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.UserLocationViewService/GetUserLocationView', $actualFuncCall);
