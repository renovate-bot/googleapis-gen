...
use Google\Ads\GoogleAds\V9\Resources\OperatingSystemVersionConstant;
...
class OperatingSystemVersionConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getOperatingSystemVersionConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.OperatingSystemVersionConstantService/GetOperatingSystemVersionConstant', $actualFuncCall);
