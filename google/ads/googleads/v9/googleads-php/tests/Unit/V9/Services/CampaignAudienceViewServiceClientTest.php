...
use Google\Ads\GoogleAds\V9\Resources\CampaignAudienceView;
...
class CampaignAudienceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignAudienceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.CampaignAudienceViewService/GetCampaignAudienceView', $actualFuncCall);
