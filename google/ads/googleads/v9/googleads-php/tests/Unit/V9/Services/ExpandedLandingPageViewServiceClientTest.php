...
use Google\Ads\GoogleAds\V9\Resources\ExpandedLandingPageView;
 ...
 * @group gapic
 */
class ExpandedLandingPageViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getExpandedLandingPageViewTest()
    {
        ...
        $expandedFinalUrl = 'expandedFinalUrl1081925408';
        $expectedResponse = new ExpandedLandingPageView();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setExpandedFinalUrl($expandedFinalUrl);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->expandedLandingPageViewName('[CUSTOMER_ID]', '[EXPANDED_FINAL_URL_FINGERPRINT]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.ExpandedLandingPageViewService/GetExpandedLandingPageView', $actualFuncCall);
