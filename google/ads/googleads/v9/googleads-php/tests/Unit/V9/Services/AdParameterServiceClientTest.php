...
class AdParameterServiceClientTest extends GeneratedTest
{
    ...
    public function getAdParameterTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.AdParameterService/GetAdParameter', $actualFuncCall);
    ...
    public function mutateAdParametersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.AdParameterService/MutateAdParameters', $actualFuncCall);
