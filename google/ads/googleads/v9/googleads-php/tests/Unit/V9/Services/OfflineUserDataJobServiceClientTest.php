...
class OfflineUserDataJobServiceClientTest extends GeneratedTest
{
    ...
    public function addOfflineUserDataJobOperationsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.OfflineUserDataJobService/AddOfflineUserDataJobOperations', $actualFuncCall);
    ...
    public function createOfflineUserDataJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.OfflineUserDataJobService/CreateOfflineUserDataJob', $actualFuncCall);
    ...
    public function getOfflineUserDataJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.OfflineUserDataJobService/GetOfflineUserDataJob', $actualFuncCall);
        $actualValue = $actualRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function runOfflineUserDataJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.OfflineUserDataJobService/RunOfflineUserDataJob', $actualApiFuncCall);
