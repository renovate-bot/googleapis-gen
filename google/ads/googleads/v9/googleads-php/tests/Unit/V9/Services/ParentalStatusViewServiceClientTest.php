...
use Google\Ads\GoogleAds\V9\Resources\ParentalStatusView;
 ...
 * @group gapic
 */
class ParentalStatusViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getParentalStatusViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->parentalStatusViewName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.ParentalStatusViewService/GetParentalStatusView', $actualFuncCall);
