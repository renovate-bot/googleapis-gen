...
use Google\Ads\GoogleAds\V9\Services\MutateFeedItemTargetsResponse;
...
class FeedItemTargetServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedItemTargetTest()
    {
        ...
        $expectedResponse->setFeedItemTargetId($feedItemTargetId);
        $expectedResponse->setCampaign($campaign);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->feedItemTargetName('[CUSTOMER_ID]', '[FEED_ID]', '[FEED_ITEM_ID]', '[FEED_ITEM_TARGET_TYPE]', '[FEED_ITEM_TARGET_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.FeedItemTargetService/GetFeedItemTarget', $actualFuncCall);
    ...
    public function mutateFeedItemTargetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.FeedItemTargetService/MutateFeedItemTargets', $actualFuncCall);
