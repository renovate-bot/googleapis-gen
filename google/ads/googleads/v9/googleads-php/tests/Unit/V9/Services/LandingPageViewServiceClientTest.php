...
use Google\Ads\GoogleAds\V9\Resources\LandingPageView;
...
class LandingPageViewServiceClientTest extends GeneratedTest
{
    ...
    public function getLandingPageViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.LandingPageViewService/GetLandingPageView', $actualFuncCall);
