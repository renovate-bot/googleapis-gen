...
use Google\Ads\GoogleAds\V9\Resources\HotelGroupView;
...
class HotelGroupViewServiceClientTest extends GeneratedTest
{
    ...
    public function getHotelGroupViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.HotelGroupViewService/GetHotelGroupView', $actualFuncCall);
