...
class ConversionActionServiceClientTest extends GeneratedTest
{
    ...
    public function getConversionActionTest()
    {
        ...
        $expectedResponse->setPrimaryForGoal($primaryForGoal);
        ...
        $this->assertSame('/google.ads.googleads.v9.services.ConversionActionService/GetConversionAction', $actualFuncCall);
    ...
    public function mutateConversionActionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.ConversionActionService/MutateConversionActions', $actualFuncCall);
