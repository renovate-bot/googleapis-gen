...
use Google\Ads\GoogleAds\V9\Services\ListPaymentsAccountsResponse;
...
class PaymentsAccountServiceClientTest extends GeneratedTest
{
    ...
    public function listPaymentsAccountsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.PaymentsAccountService/ListPaymentsAccounts', $actualFuncCall);
