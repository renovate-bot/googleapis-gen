...
use Google\Ads\GoogleAds\V9\Resources\MobileAppCategoryConstant;
 ...
 * @group gapic
 */
class MobileAppCategoryConstantServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getMobileAppCategoryConstantTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->mobileAppCategoryConstantName('[MOBILE_APP_CATEGORY_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.MobileAppCategoryConstantService/GetMobileAppCategoryConstant', $actualFuncCall);
