...
use Google\Ads\GoogleAds\V9\Services\MutateCampaignsResponse;
...
class CampaignServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignTest()
    {
        ...
        $baseCampaign = 'baseCampaign2033993406';
        $campaignBudget = 'campaignBudget1992382804';
        $accessibleBiddingStrategy = 'accessibleBiddingStrategy1239135520';
        ...
        $biddingStrategy = 'biddingStrategy1984547767';
        ...
        $expectedResponse->setBaseCampaign($baseCampaign);
        $expectedResponse->setCampaignBudget($campaignBudget);
        $expectedResponse->setAccessibleBiddingStrategy($accessibleBiddingStrategy);
        ...
        $expectedResponse->setUrlExpansionOptOut($urlExpansionOptOut);
        $expectedResponse->setBiddingStrategy($biddingStrategy);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->campaignName('[CUSTOMER_ID]', '[CAMPAIGN_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.CampaignService/GetCampaign', $actualFuncCall);
    ...
    public function mutateCampaignsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.CampaignService/MutateCampaigns', $actualFuncCall);
