...
use Google\Ads\GoogleAds\V9\Resources\DomainCategory;
...
class DomainCategoryServiceClientTest extends GeneratedTest
{
    ...
    public function getDomainCategoryTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.DomainCategoryService/GetDomainCategory', $actualFuncCall);
