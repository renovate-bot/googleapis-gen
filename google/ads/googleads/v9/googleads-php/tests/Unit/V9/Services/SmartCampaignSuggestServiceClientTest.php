...
class SmartCampaignSuggestServiceClientTest extends GeneratedTest
{
    ...
    public function suggestKeywordThemesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.SmartCampaignSuggestService/SuggestKeywordThemes', $actualFuncCall);
    ...
    public function suggestSmartCampaignAdTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.SmartCampaignSuggestService/SuggestSmartCampaignAd', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getSuggestionInfo();
        $this->assertProtobufEquals($suggestionInfo, $actualValue);
    ...
    public function suggestSmartCampaignBudgetOptionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.SmartCampaignSuggestService/SuggestSmartCampaignBudgetOptions', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
