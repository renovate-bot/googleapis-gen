...
use Google\Ads\GoogleAds\V9\Services\CreateCustomerClientResponse;
use Google\Ads\GoogleAds\V9\Services\CustomerOperation;
...
use Google\Ads\GoogleAds\V9\Services\MutateCustomerResponse;
...
class CustomerServiceClientTest extends GeneratedTest
{
    ...
    public function createCustomerClientTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.CustomerService/CreateCustomerClient', $actualFuncCall);
    ...
    public function getCustomerTest()
    {
        ...
        $manager = false;
        $testAccount = true;
        $optimizationScore = -1.69982841E8;
        $optimizationScoreWeight = 9.9727215E7;
        ...
        $expectedResponse->setAutoTaggingEnabled($autoTaggingEnabled);
        $expectedResponse->setHasPartnersBadge($hasPartnersBadge);
        $expectedResponse->setManager($manager);
        $expectedResponse->setTestAccount($testAccount);
        $expectedResponse->setOptimizationScore($optimizationScore);
        $expectedResponse->setOptimizationScoreWeight($optimizationScoreWeight);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->customerName('[CUSTOMER_ID]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.CustomerService/GetCustomer', $actualFuncCall);
    ...
    public function listAccessibleCustomersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.CustomerService/ListAccessibleCustomers', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateCustomerTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.CustomerService/MutateCustomer', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
