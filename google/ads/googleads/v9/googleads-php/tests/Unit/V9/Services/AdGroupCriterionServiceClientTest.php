...
class AdGroupCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupCriterionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.AdGroupCriterionService/GetAdGroupCriterion', $actualFuncCall);
    ...
    public function mutateAdGroupCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.AdGroupCriterionService/MutateAdGroupCriteria', $actualFuncCall);
