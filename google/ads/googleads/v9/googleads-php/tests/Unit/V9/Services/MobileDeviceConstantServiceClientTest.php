...
use Google\Ads\GoogleAds\V9\Resources\MobileDeviceConstant;
 ...
 * @group gapic
 */
class MobileDeviceConstantServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getMobileDeviceConstantTest()
    {
        ...
        $id = 3355;
        $name = 'name3373707';
        $manufacturerName = 'manufacturerName-1949119943';
        $operatingSystemName = 'operatingSystemName-1624170339';
        $expectedResponse = new MobileDeviceConstant();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setId($id);
        $expectedResponse->setName($name);
        $expectedResponse->setManufacturerName($manufacturerName);
        $expectedResponse->setOperatingSystemName($operatingSystemName);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->mobileDeviceConstantName('[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.MobileDeviceConstantService/GetMobileDeviceConstant', $actualFuncCall);
