...
use Google\Ads\GoogleAds\V9\Resources\AccountLink;
use Google\Ads\GoogleAds\V9\Services\AccountLinkOperation;

use Google\Ads\GoogleAds\V9\Services\CreateAccountLinkResponse;
use Google\Ads\GoogleAds\V9\Services\MutateAccountLinkResponse;
...
class AccountLinkServiceClientTest extends GeneratedTest
{
    ...
    public function createAccountLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.AccountLinkService/CreateAccountLink', $actualFuncCall);
     ...
     * @test
     */
    public function getAccountLinkTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        $accountLinkId = 1043416210;
        $expectedResponse = new AccountLink();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setAccountLinkId($accountLinkId);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->accountLinkName('[CUSTOMER_ID]', '[ACCOUNT_LINK_ID]');
        $response = $client->getAccountLink($formattedResourceName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.AccountLinkService/GetAccountLink', $actualFuncCall);
     ...
     * @test
     */
    public function getAccountLinkExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        $formattedResourceName = $client->accountLinkName('[CUSTOMER_ID]', '[ACCOUNT_LINK_ID]');
        try {
            $client->getAccountLink($formattedResourceName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function mutateAccountLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.AccountLinkService/MutateAccountLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
