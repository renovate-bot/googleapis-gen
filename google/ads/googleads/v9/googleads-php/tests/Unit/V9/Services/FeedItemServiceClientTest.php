...
use Google\Ads\GoogleAds\V9\Services\MutateFeedItemsResponse;
...
class FeedItemServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedItemTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->feedItemName('[CUSTOMER_ID]', '[FEED_ID]', '[FEED_ITEM_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.FeedItemService/GetFeedItem', $actualFuncCall);
    ...
    public function mutateFeedItemsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.FeedItemService/MutateFeedItems', $actualFuncCall);
