...
use Google\Ads\GoogleAds\V9\Resources\DetailPlacementView;
 ...
 * @group gapic
 */
class DetailPlacementViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getDetailPlacementViewTest()
    {
        ...
        $groupPlacementTargetUrl = 'groupPlacementTargetUrl-866148069';
        $targetUrl = 'targetUrl486946241';
        $expectedResponse = new DetailPlacementView();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setPlacement($placement);
        $expectedResponse->setDisplayName($displayName);
        $expectedResponse->setGroupPlacementTargetUrl($groupPlacementTargetUrl);
        $expectedResponse->setTargetUrl($targetUrl);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->detailPlacementViewName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[BASE64_PLACEMENT]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.DetailPlacementViewService/GetDetailPlacementView', $actualFuncCall);
