...
use Google\Ads\GoogleAds\V9\Services\MutateExtensionFeedItemsResponse;
...
class ExtensionFeedItemServiceClientTest extends GeneratedTest
{
    ...
    public function getExtensionFeedItemTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.ExtensionFeedItemService/GetExtensionFeedItem', $actualFuncCall);
    ...
    public function mutateExtensionFeedItemsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.ExtensionFeedItemService/MutateExtensionFeedItems', $actualFuncCall);
