...
use Google\Ads\GoogleAds\V9\Services\MutateBiddingSeasonalityAdjustmentsResponse;
...
class BiddingSeasonalityAdjustmentServiceClientTest extends GeneratedTest
{
    ...
    public function getBiddingSeasonalityAdjustmentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.BiddingSeasonalityAdjustmentService/GetBiddingSeasonalityAdjustment', $actualFuncCall);
    ...
    public function mutateBiddingSeasonalityAdjustmentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.BiddingSeasonalityAdjustmentService/MutateBiddingSeasonalityAdjustments', $actualFuncCall);
