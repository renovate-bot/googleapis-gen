...
use Google\Ads\GoogleAds\V9\Resources\CustomerExtensionSetting;
use Google\Ads\GoogleAds\V9\Services\MutateCustomerExtensionSettingsResponse;
...
class CustomerExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerExtensionSettingTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.CustomerExtensionSettingService/GetCustomerExtensionSetting', $actualFuncCall);
    ...
    public function mutateCustomerExtensionSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.CustomerExtensionSettingService/MutateCustomerExtensionSettings', $actualFuncCall);
