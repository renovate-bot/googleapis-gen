...
use Google\Ads\GoogleAds\V9\Services\MutateSharedCriteriaResponse;
...
class SharedCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getSharedCriterionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.SharedCriterionService/GetSharedCriterion', $actualFuncCall);
    ...
    public function mutateSharedCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.SharedCriterionService/MutateSharedCriteria', $actualFuncCall);
