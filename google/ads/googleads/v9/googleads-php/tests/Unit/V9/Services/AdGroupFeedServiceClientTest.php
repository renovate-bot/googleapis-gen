...
use Google\Ads\GoogleAds\V9\Resources\AdGroupFeed;
use Google\Ads\GoogleAds\V9\Services\MutateAdGroupFeedsResponse;
...
class AdGroupFeedServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupFeedTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->adGroupFeedName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[FEED_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.AdGroupFeedService/GetAdGroupFeed', $actualFuncCall);
    ...
    public function mutateAdGroupFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.AdGroupFeedService/MutateAdGroupFeeds', $actualFuncCall);
