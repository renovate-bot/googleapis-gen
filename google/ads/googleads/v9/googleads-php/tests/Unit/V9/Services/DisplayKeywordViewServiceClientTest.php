...
use Google\Ads\GoogleAds\V9\Resources\DisplayKeywordView;
 ...
 * @group gapic
 */
class DisplayKeywordViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getDisplayKeywordViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->displayKeywordViewName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.DisplayKeywordViewService/GetDisplayKeywordView', $actualFuncCall);
