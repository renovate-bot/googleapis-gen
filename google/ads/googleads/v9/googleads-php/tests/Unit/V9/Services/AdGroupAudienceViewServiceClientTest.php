...
use Google\Ads\GoogleAds\V9\Resources\AdGroupAudienceView;
 ...
 * @group gapic
 */
class AdGroupAudienceViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getAdGroupAudienceViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->adGroupAudienceViewName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.AdGroupAudienceViewService/GetAdGroupAudienceView', $actualFuncCall);
