...
class KeywordPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateForecastCurveTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.KeywordPlanService/GenerateForecastCurve', $actualFuncCall);
    ...
    public function generateForecastMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.KeywordPlanService/GenerateForecastMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getKeywordPlan();
        $this->assertProtobufEquals($formattedKeywordPlan, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateForecastTimeSeriesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.KeywordPlanService/GenerateForecastTimeSeries', $actualFuncCall);
        $actualValue = $actualRequestObject->getKeywordPlan();
        $this->assertProtobufEquals($formattedKeywordPlan, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.KeywordPlanService/GenerateHistoricalMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getKeywordPlan();
        $this->assertProtobufEquals($formattedKeywordPlan, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getKeywordPlanTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.KeywordPlanService/GetKeywordPlan', $actualFuncCall);
    ...
    public function mutateKeywordPlansTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v9.services.KeywordPlanService/MutateKeywordPlans', $actualFuncCall);
