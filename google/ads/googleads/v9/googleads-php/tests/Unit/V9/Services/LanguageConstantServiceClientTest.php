...
use Google\Ads\GoogleAds\V9\Resources\LanguageConstant;
...
class LanguageConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getLanguageConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.LanguageConstantService/GetLanguageConstant', $actualFuncCall);
