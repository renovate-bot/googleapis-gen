...
use Google\Ads\GoogleAds\V9\Services\UploadConversionAdjustmentsResponse;
...
class ConversionAdjustmentUploadServiceClientTest extends GeneratedTest
{
    ...
    public function uploadConversionAdjustmentsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.ConversionAdjustmentUploadService/UploadConversionAdjustments', $actualFuncCall);
