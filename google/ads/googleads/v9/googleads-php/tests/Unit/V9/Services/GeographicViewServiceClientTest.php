...
use Google\Ads\GoogleAds\V9\Resources\GeographicView;
...
class GeographicViewServiceClientTest extends GeneratedTest
{
    ...
    public function getGeographicViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v9.services.GeographicViewService/GetGeographicView', $actualFuncCall);
