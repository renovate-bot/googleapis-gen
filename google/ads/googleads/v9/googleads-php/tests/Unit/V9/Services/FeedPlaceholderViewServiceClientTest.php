...
use Google\Ads\GoogleAds\V9\Resources\FeedPlaceholderView;
 ...
 * @group gapic
 */
class FeedPlaceholderViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getFeedPlaceholderViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->feedPlaceholderViewName('[CUSTOMER_ID]', '[PLACEHOLDER_TYPE]');
        ...
        $this->assertSame('/google.ads.googleads.v9.services.FeedPlaceholderViewService/GetFeedPlaceholderView', $actualFuncCall);
