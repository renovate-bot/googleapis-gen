 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.enums.CallPlaceholderFieldEnum</code>
 */
class CallPlaceholderFieldEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Enums\CallPlaceholderField::initOnce();
