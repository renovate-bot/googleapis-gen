 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.AdGroupCriterionCustomizer</code>
 */
class AdGroupCriterionCustomizer extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.CustomizerValueStatusEnum.CustomizerValueStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.CustomizerValue value = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *     @type int $status
     *           Output only. The status of the ad group criterion customizer.
     *     @type \Google\Ads\GoogleAds\V9\Common\CustomizerValue $value
     *           Required. The value to associate with the customizer attribute at this level. The
     *           value must be of the type specified for the CustomizerAttribute.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\AdGroupCriterionCustomizer::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\CustomizerValueStatusEnum\CustomizerValueStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.CustomizerValue value = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V9\Common\CustomizerValue|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.CustomizerValue value = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Common\CustomizerValue $var
     * @return $this
     */
    public function setValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Common\CustomizerValue::class);
        $this->value = $var;
