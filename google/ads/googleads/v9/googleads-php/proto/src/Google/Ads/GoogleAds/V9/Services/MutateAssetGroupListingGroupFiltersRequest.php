 ...
 * together.
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateAssetGroupListingGroupFiltersRequest</code>
 */
class MutateAssetGroupListingGroupFiltersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * filters.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.AssetGroupListingGroupFilterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose asset group listing group filters are being
     *           modified.
     *     @type \Google\Ads\GoogleAds\V9\Services\AssetGroupListingGroupFilterOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual asset group listing group
     *           filters.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.AssetGroupListingGroupFilterOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\AssetGroupListingGroupFilterOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\AssetGroupListingGroupFilterOperation::class);
        $this->operations = $arr;
