 ...
 * A feed mapping.
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.FeedMapping</code>
 */
class FeedMapping extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.FeedMappingStatusEnum.FeedMappingStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    protected $target;
     ...
     *     @type string $feed
     *           Immutable. The feed of this feed mapping.
     *     @type \Google\Ads\GoogleAds\V9\Resources\AttributeFieldMapping[]|\Google\Protobuf\Internal\RepeatedField $attribute_field_mappings
     *           Immutable. Feed attributes to field mappings. These mappings are a one-to-many
     *           relationship meaning that 1 feed attribute can be used to populate
     *           multiple placeholder fields, but 1 placeholder field can only draw
     *           data from 1 feed attribute. Ad Customizer is an exception, 1 placeholder
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V9\Resources\AttributeFieldMapping[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAttributeFieldMappings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Resources\AttributeFieldMapping::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\FeedMappingStatusEnum\FeedMappingStatus::class);
        $this->status = $var;
     ...
     * attributes to placeholder fields).
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.PlaceholderTypeEnum.PlaceholderType placeholder_type = 3 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return int
     */
     ...
     * attributes to criterion fields).
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.FeedMappingCriterionTypeEnum.FeedMappingCriterionType criterion_type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\FeedMappingCriterionTypeEnum\FeedMappingCriterionType::class);
