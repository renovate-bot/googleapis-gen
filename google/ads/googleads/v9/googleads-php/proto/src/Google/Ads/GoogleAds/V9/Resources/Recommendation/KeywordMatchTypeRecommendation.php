 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.Recommendation.KeywordMatchTypeRecommendation</code>
 */
class KeywordMatchTypeRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.KeywordMatchTypeEnum.KeywordMatchType recommended_match_type = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
...
class_alias(KeywordMatchTypeRecommendation::class, \Google\Ads\GoogleAds\V9\Resources\Recommendation_KeywordMatchTypeRecommendation::class);
