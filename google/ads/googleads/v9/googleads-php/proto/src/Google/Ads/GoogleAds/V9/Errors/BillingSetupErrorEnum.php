 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.errors.BillingSetupErrorEnum</code>
 */
class BillingSetupErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Errors\BillingSetupError::initOnce();
