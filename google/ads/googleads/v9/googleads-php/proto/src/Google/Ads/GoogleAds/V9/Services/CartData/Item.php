...
namespace Google\Ads\GoogleAds\V9\Services\CartData;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.CartData.Item</code>
 */
...
class_alias(Item::class, \Google\Ads\GoogleAds\V9\Services\CartData_Item::class);
