 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateConversionCustomVariablesRequest</code>
 */
class MutateConversionCustomVariablesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * variables.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.ConversionCustomVariableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose conversion custom variables are being
     *           modified.
     *     @type \Google\Ads\GoogleAds\V9\Services\ConversionCustomVariableOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual conversion custom
     *           variables.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.ConversionCustomVariableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\ConversionCustomVariableOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\ConversionCustomVariableOperation::class);
        $this->operations = $arr;
