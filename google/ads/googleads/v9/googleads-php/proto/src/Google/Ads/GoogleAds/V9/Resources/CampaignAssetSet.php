 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.CampaignAssetSet</code>
 */
class CampaignAssetSet extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.AssetSetLinkStatusEnum.AssetSetLinkStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\CampaignAssetSet::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\AssetSetLinkStatusEnum\AssetSetLinkStatus::class);
        $this->status = $var;
