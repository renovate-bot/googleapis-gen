 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.Operand.FeedAttributeOperand</code>
 */
...
class_alias(FeedAttributeOperand::class, \Google\Ads\GoogleAds\V9\Common\Operand_FeedAttributeOperand::class);
