 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.FeedItemPlaceholderPolicyInfo</code>
 */
class FeedItemPlaceholderPolicyInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.PlaceholderTypeEnum.PlaceholderType placeholder_type_enum = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.PolicyReviewStatusEnum.PolicyReviewStatus review_status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus approval_status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $approval_status = 0;
    /**
     * Output only. The list of policy findings for the placeholder type.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.PolicyTopicEntry policy_topic_entries = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $policy_topic_entries;
    /**
     * Output only. The validation status of the palceholder type.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.FeedItemValidationStatusEnum.FeedItemValidationStatus validation_status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $validation_status = 0;
    /**
     * Output only. List of placeholder type validation errors.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.resources.FeedItemValidationError validation_errors = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $validation_errors;
    /**
     * Output only. Placeholder type quality evaluation approval status.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus quality_approval_status = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $quality_approval_status = 0;
    /**
     * Output only. List of placeholder type quality evaluation disapproval reasons.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason quality_disapproval_reasons = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The validation status of the palceholder type.
     *     @type \Google\Ads\GoogleAds\V9\Resources\FeedItemValidationError[]|\Google\Protobuf\Internal\RepeatedField $validation_errors
     *           Output only. List of placeholder type validation errors.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\FeedItem::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\PlaceholderTypeEnum\PlaceholderType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\FeedItemValidationStatusEnum\FeedItemValidationStatus::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.resources.FeedItemValidationError validation_errors = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V9\Resources\FeedItemValidationError[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setValidationErrors($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Resources\FeedItemValidationError::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\FeedItemQualityApprovalStatusEnum\FeedItemQualityApprovalStatus::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V9\Enums\FeedItemQualityDisapprovalReasonEnum\FeedItemQualityDisapprovalReason::class);
