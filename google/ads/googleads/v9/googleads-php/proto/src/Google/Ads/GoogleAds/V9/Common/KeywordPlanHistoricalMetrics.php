 ...
 * details.
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.KeywordPlanHistoricalMetrics</code>
 */
class KeywordPlanHistoricalMetrics extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.MonthlySearchVolume monthly_search_volumes = 6;</code>
     */
    private $monthly_search_volumes;
    /**
     * The competition level for the query.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel competition = 2;</code>
     */
     ...
     *           Approximate number of monthly searches on this query averaged
     *           for the past 12 months.
     *     @type \Google\Ads\GoogleAds\V9\Common\MonthlySearchVolume[]|\Google\Protobuf\Internal\RepeatedField $monthly_search_volumes
     *           Approximate number of searches on this query for the past twelve months.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.MonthlySearchVolume monthly_search_volumes = 6;</code>
     * @param \Google\Ads\GoogleAds\V9\Common\MonthlySearchVolume[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMonthlySearchVolumes($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Common\MonthlySearchVolume::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\KeywordPlanCompetitionLevelEnum\KeywordPlanCompetitionLevel::class);
