 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.GetWebpageViewRequest</code>
 */
class GetWebpageViewRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Services\WebpageViewService::initOnce();
