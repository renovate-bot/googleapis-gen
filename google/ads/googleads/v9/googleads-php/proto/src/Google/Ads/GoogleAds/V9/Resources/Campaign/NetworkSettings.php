 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.Campaign.NetworkSettings</code>
 */
...
class_alias(NetworkSettings::class, \Google\Ads\GoogleAds\V9\Resources\Campaign_NetworkSettings::class);
