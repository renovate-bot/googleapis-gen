 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.enums.FrequencyCapTimeUnitEnum</code>
 */
class FrequencyCapTimeUnitEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Enums\FrequencyCapTimeUnit::initOnce();
