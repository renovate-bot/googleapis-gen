 ...
 * an asset group.
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.AssetGroupListingGroupFilter</code>
 */
class AssetGroupListingGroupFilter extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.ListingGroupFilterTypeEnum.ListingGroupFilterType type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $type = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.ListingGroupFilterVerticalEnum.ListingGroupFilterVertical vertical = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.resources.ListingGroupFilterDimension case_value = 6;</code>
     */
     ...
     *           Immutable. The vertical the current node tree represents. All nodes in the same tree
     *           must belong to the same vertical.
     *     @type \Google\Ads\GoogleAds\V9\Resources\ListingGroupFilterDimension $case_value
     *           Dimension value with which this listing group is refining its parent.
     *           Undefined for the root group.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\ListingGroupFilterTypeEnum\ListingGroupFilterType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\ListingGroupFilterVerticalEnum\ListingGroupFilterVertical::class);
        $this->vertical = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.resources.ListingGroupFilterDimension case_value = 6;</code>
     * @return \Google\Ads\GoogleAds\V9\Resources\ListingGroupFilterDimension|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.resources.ListingGroupFilterDimension case_value = 6;</code>
     * @param \Google\Ads\GoogleAds\V9\Resources\ListingGroupFilterDimension $var
     * @return $this
     */
    public function setCaseValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Resources\ListingGroupFilterDimension::class);
        $this->case_value = $var;
