...
namespace Google\Ads\GoogleAds\V9\Resources\AccountBudget;
 ...
 * if applicable.
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.AccountBudget.PendingAccountBudgetProposal</code>
 */
class PendingAccountBudgetProposal extends \Google\Protobuf\Internal\Message
{
     ...
     * with this proposal.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType proposal_type = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\AccountBudgetProposalTypeEnum\AccountBudgetProposalType::class);
     ...
     * Output only. The end time as a well-defined type, e.g. FOREVER.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.TimeTypeEnum.TimeType end_time_type = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * Output only. The spending limit as a well-defined type, e.g. INFINITE.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.SpendingLimitTypeEnum.SpendingLimitType spending_limit_type = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
...
class_alias(PendingAccountBudgetProposal::class, \Google\Ads\GoogleAds\V9\Resources\AccountBudget_PendingAccountBudgetProposal::class);
