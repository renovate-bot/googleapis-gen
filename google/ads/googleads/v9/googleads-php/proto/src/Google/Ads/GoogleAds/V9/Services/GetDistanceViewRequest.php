 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.GetDistanceViewRequest</code>
 */
class GetDistanceViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Services\DistanceViewService::initOnce();
