 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.HotelReconciliation</code>
 */
class HotelReconciliation extends \Google\Protobuf\Internal\Message
{
     ...
     * value.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.HotelReconciliationStatusEnum.HotelReconciliationStatus status = 10 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\HotelReconciliation::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\HotelReconciliationStatusEnum\HotelReconciliationStatus::class);
        $this->status = $var;
