 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateBatchJobRequest</code>
 */
class MutateBatchJobRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.BatchJobOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The ID of the customer for which to create a batch job.
     *     @type \Google\Ads\GoogleAds\V9\Services\BatchJobOperation $operation
     *           Required. The operation to perform on an individual batch job.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.BatchJobOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V9\Services\BatchJobOperation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.BatchJobOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\BatchJobOperation $var
     * @return $this
     */
    public function setOperation($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Services\BatchJobOperation::class);
        $this->operation = $var;
