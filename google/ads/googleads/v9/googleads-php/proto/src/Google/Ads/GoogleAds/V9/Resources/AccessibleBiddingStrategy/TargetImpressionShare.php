...
namespace Google\Ads\GoogleAds\V9\Resources\AccessibleBiddingStrategy;
 ...
 * location).
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.AccessibleBiddingStrategy.TargetImpressionShare</code>
 */
class TargetImpressionShare extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.TargetImpressionShareLocationEnum.TargetImpressionShareLocation location = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\AccessibleBiddingStrategy::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\TargetImpressionShareLocationEnum\TargetImpressionShareLocation::class);
        $this->location = $var;
...
class_alias(TargetImpressionShare::class, \Google\Ads\GoogleAds\V9\Resources\AccessibleBiddingStrategy_TargetImpressionShare::class);
