 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.TagSnippet</code>
 */
class TagSnippet extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.TrackingCodeTypeEnum.TrackingCodeType type = 1;</code>
     */
    protected $type = 0;
    /**
     ...
     * installed, e.g. HTML.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat page_format = 2;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Common\TagSnippet::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\TrackingCodeTypeEnum\TrackingCodeType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\TrackingCodePageFormatEnum\TrackingCodePageFormat::class);
