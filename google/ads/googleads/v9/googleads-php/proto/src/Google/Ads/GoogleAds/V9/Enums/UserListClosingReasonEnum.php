 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.enums.UserListClosingReasonEnum</code>
 */
class UserListClosingReasonEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Enums\UserListClosingReason::initOnce();
