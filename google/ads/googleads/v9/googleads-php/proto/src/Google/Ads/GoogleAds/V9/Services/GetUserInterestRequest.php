 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.GetUserInterestRequest</code>
 */
class GetUserInterestRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Services\UserInterestService::initOnce();
