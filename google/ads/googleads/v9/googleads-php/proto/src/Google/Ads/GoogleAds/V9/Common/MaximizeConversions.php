 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.MaximizeConversions</code>
 */
class MaximizeConversions extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Common\Bidding::initOnce();
