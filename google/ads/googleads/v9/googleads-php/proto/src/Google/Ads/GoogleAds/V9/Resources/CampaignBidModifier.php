 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.CampaignBidModifier</code>
 */
class CampaignBidModifier extends \Google\Protobuf\Internal\Message
{
     ...
     *           The modifier for the bid when the criterion matches.
     *     @type \Google\Ads\GoogleAds\V9\Common\InteractionTypeInfo $interaction_type
     *           Immutable. Criterion for interaction type. Only supported for search campaigns.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\CampaignBidModifier::initOnce();
     ...
     * Immutable. Criterion for interaction type. Only supported for search campaigns.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.InteractionTypeInfo interaction_type = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V9\Common\InteractionTypeInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.InteractionTypeInfo interaction_type = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V9\Common\InteractionTypeInfo $var
     * @return $this
     */
    public function setInteractionType($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Common\InteractionTypeInfo::class);
