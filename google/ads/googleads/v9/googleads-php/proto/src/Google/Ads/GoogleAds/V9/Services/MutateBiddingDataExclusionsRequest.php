 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateBiddingDataExclusionsRequest</code>
 */
class MutateBiddingDataExclusionsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.BiddingDataExclusionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose data exclusions are being modified.
     *     @type \Google\Ads\GoogleAds\V9\Services\BiddingDataExclusionOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual data exclusions.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.BiddingDataExclusionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\BiddingDataExclusionOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\BiddingDataExclusionOperation::class);
        $this->operations = $arr;
