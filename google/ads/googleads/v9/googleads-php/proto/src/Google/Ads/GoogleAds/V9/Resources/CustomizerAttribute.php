 ...
 * level, respectively.
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.CustomizerAttribute</code>
 */
class CustomizerAttribute extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.CustomizerAttributeTypeEnum.CustomizerAttributeType type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $type = 0;
    /**
     * Output only. The status of the customizer attribute.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.CustomizerAttributeStatusEnum.CustomizerAttributeStatus status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\CustomizerAttribute::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\CustomizerAttributeTypeEnum\CustomizerAttributeType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\CustomizerAttributeStatusEnum\CustomizerAttributeStatus::class);
        $this->status = $var;
