 ...
 * request.
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.ClickView</code>
 */
class ClickView extends \Google\Protobuf\Internal\Message
{
     ...
     * impression.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.ClickLocation area_of_interest = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * impression.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.ClickLocation location_of_presence = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.KeywordInfo keyword_info = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *     @type string $gclid
     *           Output only. The Google Click ID.
     *     @type \Google\Ads\GoogleAds\V9\Common\ClickLocation $area_of_interest
     *           Output only. The location criteria matching the area of interest associated with the
     *           impression.
     *     @type \Google\Ads\GoogleAds\V9\Common\ClickLocation $location_of_presence
     *           Output only. The location criteria matching the location of presence associated with the
     *           impression.
     ...
     *           Output only. The associated keyword, if one exists and the click corresponds to the
     *           SEARCH channel.
     *     @type \Google\Ads\GoogleAds\V9\Common\KeywordInfo $keyword_info
     *           Output only. Basic information about the associated keyword, if it exists.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\ClickView::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.ClickLocation area_of_interest = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V9\Common\ClickLocation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.ClickLocation area_of_interest = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V9\Common\ClickLocation $var
     * @return $this
     */
    public function setAreaOfInterest($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Common\ClickLocation::class);
