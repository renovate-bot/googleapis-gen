 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.AccessibleBiddingStrategy.TargetSpend</code>
 */
...
class_alias(TargetSpend::class, \Google\Ads\GoogleAds\V9\Resources\AccessibleBiddingStrategy_TargetSpend::class);
