 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateCampaignCustomizersRequest</code>
 */
class MutateCampaignCustomizersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.CampaignCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose campaign customizers are being modified.
     *     @type \Google\Ads\GoogleAds\V9\Services\CampaignCustomizerOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign customizers.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.CampaignCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\CampaignCustomizerOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\CampaignCustomizerOperation::class);
        $this->operations = $arr;
