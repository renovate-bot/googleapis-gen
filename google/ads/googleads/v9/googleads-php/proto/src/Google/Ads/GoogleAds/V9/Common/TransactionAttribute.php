 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.TransactionAttribute</code>
 */
class TransactionAttribute extends \Google\Protobuf\Internal\Message
{
     ...
     * Accessible only to customers on the allow-list.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.StoreAttribute store_attribute = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.ItemAttribute item_attribute = 14;</code>
     */
     ...
     *           Transaction order id.
     *           Accessible only to customers on the allow-list.
     *     @type \Google\Ads\GoogleAds\V9\Common\StoreAttribute $store_attribute
     *           Store attributes of the transaction.
     *           Accessible only to customers on the allow-list.
     *     @type string $custom_value
     *           Value of the custom variable for each transaction.
     *           Accessible only to customers on the allow-list.
     *     @type \Google\Ads\GoogleAds\V9\Common\ItemAttribute $item_attribute
     *           Item attributes of the transaction.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.StoreAttribute store_attribute = 6;</code>
     * @return \Google\Ads\GoogleAds\V9\Common\StoreAttribute|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.StoreAttribute store_attribute = 6;</code>
     * @param \Google\Ads\GoogleAds\V9\Common\StoreAttribute $var
     * @return $this
     */
    public function setStoreAttribute($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Common\StoreAttribute::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.ItemAttribute item_attribute = 14;</code>
     * @return \Google\Ads\GoogleAds\V9\Common\ItemAttribute|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.ItemAttribute item_attribute = 14;</code>
     * @param \Google\Ads\GoogleAds\V9\Common\ItemAttribute $var
     * @return $this
     */
    public function setItemAttribute($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Common\ItemAttribute::class);
