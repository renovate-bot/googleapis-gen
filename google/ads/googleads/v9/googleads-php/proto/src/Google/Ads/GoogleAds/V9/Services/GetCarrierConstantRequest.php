 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.GetCarrierConstantRequest</code>
 */
class GetCarrierConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Services\CarrierConstantService::initOnce();
