 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateCustomerRequest</code>
 */
class MutateCustomerRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.CustomerOperation operation = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.ResponseContentTypeEnum.ResponseContentType response_content_type = 6;</code>
     */
     ...
     *           Required. The ID of the customer being modified.
     *     @type \Google\Ads\GoogleAds\V9\Services\CustomerOperation $operation
     *           Required. The operation to perform on the customer
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.CustomerOperation operation = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V9\Services\CustomerOperation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.CustomerOperation operation = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\CustomerOperation $var
     * @return $this
     */
    public function setOperation($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Services\CustomerOperation::class);
        $this->operation = $var;
