 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.enums.ReachPlanAdLengthEnum</code>
 */
class ReachPlanAdLengthEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Enums\ReachPlanAdLength::initOnce();
