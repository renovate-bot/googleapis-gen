 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.AssetSetAsset</code>
 */
class AssetSetAsset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.AssetSetAssetStatusEnum.AssetSetAssetStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\AssetSetAsset::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\AssetSetAssetStatusEnum\AssetSetAssetStatus::class);
        $this->status = $var;
