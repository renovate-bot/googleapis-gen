 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateAssetsResponse</code>
 */
class MutateAssetsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.MutateAssetResult results = 2;</code>
     */
    private $results;
     ...
     *           operations. If any errors occur outside the operations (e.g. auth errors),
     *           we return an RPC level error.
     *     @type \Google\Ads\GoogleAds\V9\Services\MutateAssetResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           All results for the mutate.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.MutateAssetResult results = 2;</code>
     * @param \Google\Ads\GoogleAds\V9\Services\MutateAssetResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\MutateAssetResult::class);
        $this->results = $arr;
