...
namespace Google\Ads\GoogleAds\V9\Errors\FeedErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v9.errors.FeedErrorEnum.FeedError</code>
 */
class FeedError
{
    /**
...
class_alias(FeedError::class, \Google\Ads\GoogleAds\V9\Errors\FeedErrorEnum_FeedError::class);
