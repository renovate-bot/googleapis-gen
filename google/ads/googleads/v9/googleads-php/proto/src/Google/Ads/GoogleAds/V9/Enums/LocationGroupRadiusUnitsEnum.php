 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.enums.LocationGroupRadiusUnitsEnum</code>
 */
class LocationGroupRadiusUnitsEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Enums\LocationGroupRadiusUnits::initOnce();
