 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.VideoResponsiveAdInfo</code>
 */
class VideoResponsiveAdInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.AdTextAsset long_headlines = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.AdTextAsset descriptions = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.AdTextAsset call_to_actions = 4;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.AdVideoAsset videos = 5;</code>
     */
    private $videos;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.AdImageAsset companion_banners = 6;</code>
     */
     ...
     *           List of text assets used for the short headline, e.g. the "Call To Action"
     *           banner. Currently, only a single value for the short headline is supported.
     *     @type \Google\Ads\GoogleAds\V9\Common\AdTextAsset[]|\Google\Protobuf\Internal\RepeatedField $long_headlines
     *           List of text assets used for the long headline.
     *           Currently, only a single value for the long headline is supported.
     *     @type \Google\Ads\GoogleAds\V9\Common\AdTextAsset[]|\Google\Protobuf\Internal\RepeatedField $descriptions
     *           List of text assets used for the description.
     *           Currently, only a single value for the description is supported.
     *     @type \Google\Ads\GoogleAds\V9\Common\AdTextAsset[]|\Google\Protobuf\Internal\RepeatedField $call_to_actions
     *           List of text assets used for the button, e.g. the "Call To Action" button.
     *           Currently, only a single value for the button is supported.
     *     @type \Google\Ads\GoogleAds\V9\Common\AdVideoAsset[]|\Google\Protobuf\Internal\RepeatedField $videos
     *           List of YouTube video assets used for the ad.
     *           Currently, only a single value for the YouTube video asset is supported.
     *     @type \Google\Ads\GoogleAds\V9\Common\AdImageAsset[]|\Google\Protobuf\Internal\RepeatedField $companion_banners
     *           List of image assets used for the companion banner.
     *           Currently, only a single value for the companion banner asset is supported.
     * }
     */
