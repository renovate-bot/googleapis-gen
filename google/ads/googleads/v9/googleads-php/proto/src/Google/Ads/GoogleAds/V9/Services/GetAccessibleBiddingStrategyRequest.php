 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.GetAccessibleBiddingStrategyRequest</code>
 */
class GetAccessibleBiddingStrategyRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Services\AccessibleBiddingStrategyService::initOnce();
