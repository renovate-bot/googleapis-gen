 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.RemarketingAction</code>
 */
class RemarketingAction extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.TagSnippet tag_snippets = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           This field is required and should not be empty when creating new
     *           remarketing actions.
     *     @type \Google\Ads\GoogleAds\V9\Common\TagSnippet[]|\Google\Protobuf\Internal\RepeatedField $tag_snippets
     *           Output only. The snippets used for tracking remarketing actions.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\RemarketingAction::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.TagSnippet tag_snippets = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V9\Common\TagSnippet[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTagSnippets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Common\TagSnippet::class);
