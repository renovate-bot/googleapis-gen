 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.Campaign.ShoppingSetting</code>
 */
...
class_alias(ShoppingSetting::class, \Google\Ads\GoogleAds\V9\Resources\Campaign_ShoppingSetting::class);
