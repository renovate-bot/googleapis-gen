 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.errors.GeoTargetConstantSuggestionErrorEnum</code>
 */
class GeoTargetConstantSuggestionErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Errors\GeoTargetConstantSuggestionError::initOnce();
