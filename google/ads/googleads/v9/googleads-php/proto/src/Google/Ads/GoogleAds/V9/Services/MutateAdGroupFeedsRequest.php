 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateAdGroupFeedsRequest</code>
 */
class MutateAdGroupFeedsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.AdGroupFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose ad group feeds are being modified.
     *     @type \Google\Ads\GoogleAds\V9\Services\AdGroupFeedOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual ad group feeds.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Services\AdGroupFeedService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.AdGroupFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\AdGroupFeedOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\AdGroupFeedOperation::class);
        $this->operations = $arr;
