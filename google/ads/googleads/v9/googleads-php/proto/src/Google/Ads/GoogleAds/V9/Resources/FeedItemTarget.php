 ...
 * A feed item target.
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.FeedItemTarget</code>
 */
class FeedItemTarget extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.FeedItemTargetTypeEnum.FeedItemTargetType feed_item_target_type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.FeedItemTargetStatusEnum.FeedItemTargetStatus status = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    protected $target;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Resources\FeedItemTarget::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\FeedItemTargetTypeEnum\FeedItemTargetType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\FeedItemTargetStatusEnum\FeedItemTargetStatus::class);
        $this->status = $var;
     ...
     * Immutable. The targeted keyword.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.KeywordInfo keyword = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
     ...
     * Immutable. The targeted device.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice device = 9 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return int
     */
     ...
     * Immutable. The targeted schedule.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.AdScheduleInfo ad_schedule = 10 [(.google.api.field_behavior) = IMMUTABLE];</code>
