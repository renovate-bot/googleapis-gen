 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.Operand.ConstantOperand</code>
 */
...
class_alias(ConstantOperand::class, \Google\Ads\GoogleAds\V9\Common\Operand_ConstantOperand::class);
