 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.UrlCollection</code>
 */
class UrlCollection extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Common\UrlCollection::initOnce();
