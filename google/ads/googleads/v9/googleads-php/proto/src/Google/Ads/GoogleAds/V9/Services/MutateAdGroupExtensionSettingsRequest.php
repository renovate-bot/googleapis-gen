 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateAdGroupExtensionSettingsRequest</code>
 */
class MutateAdGroupExtensionSettingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * settings.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.AdGroupExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose ad group extension settings are being
     *           modified.
     *     @type \Google\Ads\GoogleAds\V9\Services\AdGroupExtensionSettingOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual ad group extension
     *           settings.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.AdGroupExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\AdGroupExtensionSettingOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\AdGroupExtensionSettingOperation::class);
        $this->operations = $arr;
