 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.SuggestSmartCampaignBudgetOptionsRequest</code>
 */
class SuggestSmartCampaignBudgetOptionsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo $suggestion_info
     ...
     * Required. Information needed to get budget options
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo suggestion_info = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo suggestion_info = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo $var
     * @return $this
     */
    public function setSuggestionInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo::class);
