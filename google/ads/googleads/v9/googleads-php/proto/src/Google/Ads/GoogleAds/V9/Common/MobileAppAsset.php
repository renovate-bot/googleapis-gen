 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.MobileAppAsset</code>
 */
class MobileAppAsset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.MobileAppVendorEnum.MobileAppVendor app_store = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\MobileAppVendorEnum\MobileAppVendor::class);
        $this->app_store = $var;
