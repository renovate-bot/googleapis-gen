 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.GetOperatingSystemVersionConstantRequest</code>
 */
class GetOperatingSystemVersionConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Services\OperatingSystemVersionConstantService::initOnce();
