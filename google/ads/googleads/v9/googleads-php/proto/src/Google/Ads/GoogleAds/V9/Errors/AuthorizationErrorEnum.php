 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.errors.AuthorizationErrorEnum</code>
 */
class AuthorizationErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Errors\AuthorizationError::initOnce();
