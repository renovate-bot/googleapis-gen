 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.Forecast</code>
 */
class Forecast extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.EffectiveFrequencyBreakdown effective_frequency_breakdowns = 10;</code>
     */
     ...
     *           more information about what makes an ad viewable and how
     *           viewability is measured.
     *     @type \Google\Ads\GoogleAds\V9\Services\EffectiveFrequencyBreakdown[]|\Google\Protobuf\Internal\RepeatedField $effective_frequency_breakdowns
     *           A list of effective frequency forecasts. The list is ordered starting with
     *           1+ and ending with the value set in
     *           GenerateReachForecastRequest.effective_frequency_limit. If no
     *           effective_frequency_limit was set, this list will be empty.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.EffectiveFrequencyBreakdown effective_frequency_breakdowns = 10;</code>
     * @param \Google\Ads\GoogleAds\V9\Services\EffectiveFrequencyBreakdown[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEffectiveFrequencyBreakdowns($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\EffectiveFrequencyBreakdown::class);
