 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.enums.AssetPerformanceLabelEnum</code>
 */
class AssetPerformanceLabelEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Enums\AssetPerformanceLabel::initOnce();
