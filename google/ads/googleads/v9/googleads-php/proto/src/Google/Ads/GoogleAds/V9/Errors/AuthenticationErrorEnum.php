 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.errors.AuthenticationErrorEnum</code>
 */
class AuthenticationErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Errors\AuthenticationError::initOnce();
