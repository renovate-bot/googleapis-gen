 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.SmartCampaignSuggestionInfo</code>
 */
class SmartCampaignSuggestionInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.AdScheduleInfo ad_schedules = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.KeywordThemeInfo keyword_themes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Optional. The business ad schedule.
     *     @type \Google\Ads\GoogleAds\V9\Common\KeywordThemeInfo[]|\Google\Protobuf\Internal\RepeatedField $keyword_themes
     *           Optional. Smart campaign keyword themes. This field may greatly improve suggestion
     *           accuracy and we recommend always setting it if possible.
     *     @type \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo\BusinessContext $business_context
     ...
     *     @type \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo\LocationList $location_list
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.common.KeywordThemeInfo keyword_themes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Ads\GoogleAds\V9\Common\KeywordThemeInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setKeywordThemes($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Common\KeywordThemeInfo::class);
     ...
     * Optional. Context describing the business to advertise.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.BusinessContext business_context = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo\BusinessContext|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.BusinessContext business_context = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo\BusinessContext $var
     * @return $this
     */
    public function setBusinessContext($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo\BusinessContext::class);
     ...
     * Optional. The targeting geo location by locations.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.LocationList location_list = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo\LocationList|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.services.SmartCampaignSuggestionInfo.LocationList location_list = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo\LocationList $var
     * @return $this
     */
    public function setLocationList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V9\Services\SmartCampaignSuggestionInfo\LocationList::class);
     ...
     * Optional. The targeting geo location by proximity.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.ProximityInfo proximity = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
