 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.errors.CampaignCriterionErrorEnum</code>
 */
class CampaignCriterionErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Errors\CampaignCriterionError::initOnce();
