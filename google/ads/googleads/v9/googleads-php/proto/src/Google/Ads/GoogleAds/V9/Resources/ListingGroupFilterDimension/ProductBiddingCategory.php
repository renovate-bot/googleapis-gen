 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.resources.ListingGroupFilterDimension.ProductBiddingCategory</code>
 */
class ProductBiddingCategory extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.ListingGroupFilterBiddingCategoryLevelEnum.ListingGroupFilterBiddingCategoryLevel level = 2;</code>
     */
    protected $level = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\ListingGroupFilterBiddingCategoryLevelEnum\ListingGroupFilterBiddingCategoryLevel::class);
        $this->level = $var;
...
class_alias(ProductBiddingCategory::class, \Google\Ads\GoogleAds\V9\Resources\ListingGroupFilterDimension_ProductBiddingCategory::class);
