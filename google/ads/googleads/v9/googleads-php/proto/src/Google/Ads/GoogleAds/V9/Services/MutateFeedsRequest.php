 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.services.MutateFeedsRequest</code>
 */
class MutateFeedsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.FeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose feeds are being modified.
     *     @type \Google\Ads\GoogleAds\V9\Services\FeedOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual feeds.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Services\FeedService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v9.services.FeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V9\Services\FeedOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V9\Services\FeedOperation::class);
        $this->operations = $arr;
