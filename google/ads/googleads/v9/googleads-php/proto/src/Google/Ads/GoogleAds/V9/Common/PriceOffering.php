 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.common.PriceOffering</code>
 */
class PriceOffering extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.common.Money price = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $price = null;
    /**
     * The price unit of the price offering.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v9.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit unit = 4;</code>
     */
    protected $unit = 0;
    /**
     ...
     *           Required. The description of the price offering.
     *           The length of this string should be between 1 and 25, inclusive.
     *     @type \Google\Ads\GoogleAds\V9\Common\Money $price
     *           Required. The price value of the price offering.
     *     @type int $unit
     *           The price unit of the price offering.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V9\Enums\PriceExtensionPriceUnitEnum\PriceExtensionPriceUnit::class);
        $this->unit = $var;
