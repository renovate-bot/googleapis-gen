 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v9.errors.StringFormatErrorEnum</code>
 */
class StringFormatErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V9\Errors\StringFormatError::initOnce();
