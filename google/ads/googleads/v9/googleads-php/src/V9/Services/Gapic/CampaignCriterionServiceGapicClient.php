 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v9/services/campaign_criterion_service.proto
...
use Google\Ads\GoogleAds\V9\Services\GetCampaignCriterionRequest;

use Google\Ads\GoogleAds\V9\Services\MutateCampaignCriteriaRequest;
use Google\Ads\GoogleAds\V9\Services\MutateCampaignCriteriaResponse;
 ...
 * try {
 *     $formattedResourceName = $campaignCriterionServiceClient->campaignCriterionName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[CRITERION_ID]');
...
class CampaignCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.CampaignCriterionService';
