...
use Google\Ads\GoogleAds\V9\Services\CampaignFeedOperation;
use Google\Ads\GoogleAds\V9\Services\GetCampaignFeedRequest;

use Google\Ads\GoogleAds\V9\Services\MutateCampaignFeedsRequest;
...
class CampaignFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.CampaignFeedService';
