...
use Google\Ads\GoogleAds\V9\Services\BiddingStrategyOperation;
use Google\Ads\GoogleAds\V9\Services\GetBiddingStrategyRequest;

use Google\Ads\GoogleAds\V9\Services\MutateBiddingStrategiesRequest;
...
class BiddingStrategyServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.BiddingStrategyService';
