 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v9/services/google_ads_service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V9\Services\Gapic;

use Google\Ads\GoogleAds\V9\Services\MutateGoogleAdsRequest;
use Google\Ads\GoogleAds\V9\Services\MutateGoogleAdsResponse;

use Google\Ads\GoogleAds\V9\Services\MutateOperation;
use Google\Ads\GoogleAds\V9\Services\SearchGoogleAdsRequest;
...
class GoogleAdsServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.GoogleAdsService';
     ...
     *           For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V9\Enums\SummaryRowSettingEnum\SummaryRowSetting}
     *     @type RetrySettings|array $retrySettings
     *           Retry settings to use for this call. Can be a
     *           {@see Google\ApiCore\RetrySettings} object, or an associative array of retry
     *           settings parameters. See the documentation on
