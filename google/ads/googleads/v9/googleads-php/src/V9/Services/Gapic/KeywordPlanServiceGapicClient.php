 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v9/services/keyword_plan_service.proto
...
use Google\Ads\GoogleAds\V9\Services\GenerateForecastCurveRequest;
use Google\Ads\GoogleAds\V9\Services\GenerateForecastCurveResponse;
use Google\Ads\GoogleAds\V9\Services\GenerateForecastMetricsRequest;
use Google\Ads\GoogleAds\V9\Services\GenerateForecastMetricsResponse;
use Google\Ads\GoogleAds\V9\Services\GenerateForecastTimeSeriesRequest;
use Google\Ads\GoogleAds\V9\Services\GenerateForecastTimeSeriesResponse;
use Google\Ads\GoogleAds\V9\Services\GenerateHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V9\Services\GenerateHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V9\Services\GetKeywordPlanRequest;
use Google\Ads\GoogleAds\V9\Services\KeywordPlanOperation;
use Google\Ads\GoogleAds\V9\Services\MutateKeywordPlansRequest;
use Google\Ads\GoogleAds\V9\Services\MutateKeywordPlansResponse;
...
class KeywordPlanServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.KeywordPlanService';
