 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v9/services/asset_service.proto
...
use Google\Ads\GoogleAds\V9\Services\GetAssetRequest;

use Google\Ads\GoogleAds\V9\Services\MutateAssetsRequest;
use Google\Ads\GoogleAds\V9\Services\MutateAssetsResponse;
 ...
 * try {
 *     $formattedResourceName = $assetServiceClient->assetName('[CUSTOMER_ID]', '[ASSET_ID]');
 *     $response = $assetServiceClient->getAsset($formattedResourceName);
 * } finally {
...
class AssetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.AssetService';
     ...
     */
    public function getAsset($resourceName, array $optionalArgs = [])
    {
     ...
     *     $operations = [];
     *     $response = $assetServiceClient->mutateAssets($customerId, $operations);
     * } finally {
     *     $assetServiceClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function mutateAssets($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateAssets', MutateAssetsResponse::class, $optionalArgs, $request)->wait();
    }
}
