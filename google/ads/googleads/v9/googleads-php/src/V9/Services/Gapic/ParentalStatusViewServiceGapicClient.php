 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v9/services/parental_status_view_service.proto
...
use Google\Ads\GoogleAds\V9\Services\GetParentalStatusViewRequest;
 ...
 * try {
 *     $formattedResourceName = $parentalStatusViewServiceClient->parentalStatusViewName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]');
...
class ParentalStatusViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.ParentalStatusViewService';
    ...
    private static function getParentalStatusViewNameTemplate()
    {
        if (self::$parentalStatusViewNameTemplate == null) {
            self::$parentalStatusViewNameTemplate = new PathTemplate('customers/{customer_id}/parentalStatusViews/{ad_group_id}~{criterion_id}');
        }
     ...
     */
    public static function parentalStatusViewName($customerId, $adGroupId, $criterionId)
    {
     ...
     * Template: Pattern
     * - parentalStatusView: customers/{customer_id}/parentalStatusViews/{ad_group_id}~{criterion_id}
     *
