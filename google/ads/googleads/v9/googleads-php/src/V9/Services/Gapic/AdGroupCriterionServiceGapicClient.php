 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v9/services/ad_group_criterion_service.proto
...
use Google\Ads\GoogleAds\V9\Services\GetAdGroupCriterionRequest;

use Google\Ads\GoogleAds\V9\Services\MutateAdGroupCriteriaRequest;
use Google\Ads\GoogleAds\V9\Services\MutateAdGroupCriteriaResponse;
 ...
 * try {
 *     $formattedResourceName = $adGroupCriterionServiceClient->adGroupCriterionName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]');
 ...
 */
class AdGroupCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.AdGroupCriterionService';
    ...
    public function getAdGroupCriterion($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetAdGroupCriterion', AdGroupCriterion::class, $optionalArgs, $request)->wait();
    }
     ...
     * @param AdGroupCriterionOperation[] $operations   Required. The list of operations to perform on individual criteria.
     * @param array                       $optionalArgs {
     *     Optional.
     *
    ...
    public function mutateAdGroupCriteria($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateAdGroupCriteria', MutateAdGroupCriteriaResponse::class, $optionalArgs, $request)->wait();
    }
}
