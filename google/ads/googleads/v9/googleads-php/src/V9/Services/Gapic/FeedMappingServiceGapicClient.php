...
use Google\Ads\GoogleAds\V9\Services\GetFeedMappingRequest;

use Google\Ads\GoogleAds\V9\Services\MutateFeedMappingsRequest;
use Google\Ads\GoogleAds\V9\Services\MutateFeedMappingsResponse;
...
class FeedMappingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.FeedMappingService';
