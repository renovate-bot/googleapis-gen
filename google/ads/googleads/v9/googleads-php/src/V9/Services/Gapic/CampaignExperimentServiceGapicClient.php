 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v9/services/campaign_experiment_service.proto
...
use Google\Ads\GoogleAds\V9\Services\CampaignExperimentOperation;
use Google\Ads\GoogleAds\V9\Services\CreateCampaignExperimentRequest;

use Google\Ads\GoogleAds\V9\Services\EndCampaignExperimentRequest;
use Google\Ads\GoogleAds\V9\Services\GetCampaignExperimentRequest;

use Google\Ads\GoogleAds\V9\Services\GraduateCampaignExperimentRequest;
use Google\Ads\GoogleAds\V9\Services\GraduateCampaignExperimentResponse;
use Google\Ads\GoogleAds\V9\Services\ListCampaignExperimentAsyncErrorsRequest;
use Google\Ads\GoogleAds\V9\Services\ListCampaignExperimentAsyncErrorsResponse;
use Google\Ads\GoogleAds\V9\Services\MutateCampaignExperimentsRequest;
use Google\Ads\GoogleAds\V9\Services\MutateCampaignExperimentsResponse;
use Google\Ads\GoogleAds\V9\Services\PromoteCampaignExperimentRequest;
...
class CampaignExperimentServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.CampaignExperimentService';
    ...
    public function endCampaignExperiment($campaignExperiment, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        $request->setCampaignExperiment($campaignExperiment);
        $requestParamHeaders['campaign_experiment'] = $campaignExperiment;
        if (isset($optionalArgs['validateOnly'])) {
            $request->setValidateOnly($optionalArgs['validateOnly']);
        }
