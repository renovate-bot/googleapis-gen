 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v9/services/billing_setup_service.proto
...
use Google\Ads\GoogleAds\V9\Services\BillingSetupOperation;
use Google\Ads\GoogleAds\V9\Services\GetBillingSetupRequest;

use Google\Ads\GoogleAds\V9\Services\MutateBillingSetupRequest;
use Google\Ads\GoogleAds\V9\Services\MutateBillingSetupResponse;
 ...
 * try {
 *     $formattedResourceName = $billingSetupServiceClient->billingSetupName('[CUSTOMER_ID]', '[BILLING_SETUP_ID]');
...
class BillingSetupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.BillingSetupService';
