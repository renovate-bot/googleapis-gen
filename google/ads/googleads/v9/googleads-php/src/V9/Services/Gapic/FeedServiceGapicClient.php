 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v9/services/feed_service.proto
...
use Google\Ads\GoogleAds\V9\Services\GetFeedRequest;

use Google\Ads\GoogleAds\V9\Services\MutateFeedsRequest;
use Google\Ads\GoogleAds\V9\Services\MutateFeedsResponse;
 ...
 * try {
 *     $formattedResourceName = $feedServiceClient->feedName('[CUSTOMER_ID]', '[FEED_ID]');
...
class FeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v9.services.FeedService';
