...
class UploadUserDataRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v5.services.types.UserDataOperation]):
            Required. The list of operations to be done.
        customer_match_user_list_metadata (google.ads.googleads.v5.common.types.CustomerMatchUserListMetadata):
...
class UserDataOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v5.common.types.UserData):
            The list of user data to be appended to the
            user list.
        remove (google.ads.googleads.v5.common.types.UserData):
...
class UploadUserDataResponse(proto.Message):
    ...
    upload_date_time = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.StringValue,
    )
    received_operations_count = proto.Field(proto.MESSAGE, number=2,
