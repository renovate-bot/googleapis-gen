...
class GeoTargetConstantServiceGrpcTransport(GeoTargetConstantServiceTransport):
    ...
    def get_geo_target_constant(self) -> Callable[
        ...
        Returns the requested geo target constant in full
        detail.
    ...
    def suggest_geo_target_constants(self) -> Callable[
        ...
        Returns GeoTargetConstant suggestions by location
        ...
        if 'suggest_geo_target_constants' not in self._stubs:
            self._stubs['suggest_geo_target_constants'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v5.services.GeoTargetConstantService/SuggestGeoTargetConstants',
