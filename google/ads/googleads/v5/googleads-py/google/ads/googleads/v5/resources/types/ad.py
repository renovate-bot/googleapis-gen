...
class Ad(proto.Message):
    ...
    Attributes:
        ...
        final_app_urls (Sequence[google.ads.googleads.v5.common.types.FinalAppUrl]):
        ...
        display_url (str):
            ...
            for some ad formats.
        type_ (google.ads.googleads.v5.enums.types.AdTypeEnum.AdType):
        ...
        added_by_google_ads (bool):
            ...
            performing.
        device_preference (google.ads.googleads.v5.enums.types.DeviceEnum.Device):
        ...
        url_collections (Sequence[google.ads.googleads.v5.common.types.UrlCollection]):
        ...
        system_managed_resource_source (google.ads.googleads.v5.enums.types.SystemManagedResourceSourceEnum.SystemManagedResourceSource):
            Output only. If this ad is system managed,
            then this field will indicate the source. This
            field is read-only.
        text_ad (google.ads.googleads.v5.common.types.TextAdInfo):
            Immutable. Details pertaining to a text ad.
        expanded_text_ad (google.ads.googleads.v5.common.types.ExpandedTextAdInfo):
            Details pertaining to an expanded text ad.
        call_only_ad (google.ads.googleads.v5.common.types.CallOnlyAdInfo):
            Details pertaining to a call-only ad.
        expanded_dynamic_search_ad (google.ads.googleads.v5.common.types.ExpandedDynamicSearchAdInfo):
        ...
        hotel_ad (google.ads.googleads.v5.common.types.HotelAdInfo):
            Details pertaining to a hotel ad.
        shopping_smart_ad (google.ads.googleads.v5.common.types.ShoppingSmartAdInfo):
            Details pertaining to a Smart Shopping ad.
        shopping_product_ad (google.ads.googleads.v5.common.types.ShoppingProductAdInfo):
            Details pertaining to a Shopping product ad.
        gmail_ad (google.ads.googleads.v5.common.types.GmailAdInfo):
            Immutable. Details pertaining to a Gmail ad.
        image_ad (google.ads.googleads.v5.common.types.ImageAdInfo):
            Immutable. Details pertaining to an Image ad.
        video_ad (google.ads.googleads.v5.common.types.VideoAdInfo):
            Details pertaining to a Video ad.
        video_responsive_ad (google.ads.googleads.v5.common.types.VideoResponsiveAdInfo):
            Details pertaining to a Video responsive ad.
        responsive_search_ad (google.ads.googleads.v5.common.types.ResponsiveSearchAdInfo):
            Details pertaining to a responsive search ad.
        legacy_responsive_display_ad (google.ads.googleads.v5.common.types.LegacyResponsiveDisplayAdInfo):
            Details pertaining to a legacy responsive
            display ad.
        app_ad (google.ads.googleads.v5.common.types.AppAdInfo):
            Details pertaining to an app ad.
        legacy_app_install_ad (google.ads.googleads.v5.common.types.LegacyAppInstallAdInfo):
            Immutable. Details pertaining to a legacy app
            install ad.
        responsive_display_ad (google.ads.googleads.v5.common.types.ResponsiveDisplayAdInfo):
            Details pertaining to a responsive display
            ad.
        local_ad (google.ads.googleads.v5.common.types.LocalAdInfo):
            Details pertaining to a local ad.
        display_upload_ad (google.ads.googleads.v5.common.types.DisplayUploadAdInfo):
            Details pertaining to a display upload ad.
        app_engagement_ad (google.ads.googleads.v5.common.types.AppEngagementAdInfo):
            Details pertaining to an app engagement ad.
        shopping_comparison_listing_ad (google.ads.googleads.v5.common.types.ShoppingComparisonListingAdInfo):
    ...
    video_responsive_ad = proto.Field(proto.MESSAGE, number=39, oneof='ad_data',
