...
from google.ads.googleads.v5.enums.types import keyword_plan_competition_level
...
class KeywordPlanHistoricalMetrics(proto.Message):
    ...
    Attributes:
        ...
        monthly_search_volumes (Sequence[google.ads.googleads.v5.common.types.MonthlySearchVolume]):
            Approximate number of searches on this query
            for the past twelve months.
        competition (google.ads.googleads.v5.enums.types.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel):
...
class MonthlySearchVolume(proto.Message):
    ...
    Attributes:
        ...
        month (google.ads.googleads.v5.enums.types.MonthOfYearEnum.MonthOfYear):
