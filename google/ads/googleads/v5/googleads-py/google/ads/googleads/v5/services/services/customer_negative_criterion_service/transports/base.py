...
class CustomerNegativeCriterionServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for CustomerNegativeCriterionService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_customer_negative_criterion: gapic_v1.method.wrap_method(
                self.get_customer_negative_criterion,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_customer_negative_criteria: gapic_v1.method.wrap_method(
                self.mutate_customer_negative_criteria,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def get_customer_negative_criterion(self) -> typing.Callable[
    ...
    @property
    def mutate_customer_negative_criteria(self) -> typing.Callable[
