...
class IncomeRangeViewServiceClient(metaclass=IncomeRangeViewServiceClientMeta):
    ...
    def get_income_range_view(self,
            request: income_range_view_service.GetIncomeRangeViewRequest = None,
            *,
        ...
        r"""Returns the requested income range view in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetIncomeRangeViewRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v5.resources.types.IncomeRangeView:
        ...
        if not isinstance(request, income_range_view_service.GetIncomeRangeViewRequest):
            request = income_range_view_service.GetIncomeRangeViewRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_income_range_view]
