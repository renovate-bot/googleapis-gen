...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
    ...
    def get_feed_item(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetFeedItemRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.FeedItem:
                A feed item.
        """
    ...
    def mutate_feed_items(self,
        ...
        r"""Creates, updates, or removes feed items. Operation
        statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateFeedItemsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.FeedItemOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateFeedItemsResponse:
