...
class GetFeedRequest(proto.Message):
    ...
    [FeedService.GetFeed][google.ads.googleads.v5.services.FeedService.GetFeed].
...
class MutateFeedsRequest(proto.Message):
    r"""Request message for
    [FeedService.MutateFeeds][google.ads.googleads.v5.services.FeedService.MutateFeeds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose feeds
            are being modified.
        operations (Sequence[google.ads.googleads.v5.services.types.FeedOperation]):
...
class FeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.Feed):
            Create operation: No resource name is
            expected for the new feed.
        update (google.ads.googleads.v5.resources.types.Feed):
...
class MutateFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateFeedResult]):
