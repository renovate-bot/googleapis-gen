...
class KeywordPlanServiceGrpcTransport(KeywordPlanServiceTransport):
    ...
    def mutate_keyword_plans(self) -> Callable[
        ...
        Creates, updates, or removes keyword plans. Operation
    ...
    def generate_forecast_curve(self) -> Callable[
        ...
        if 'generate_forecast_curve' not in self._stubs:
            self._stubs['generate_forecast_curve'] = self.grpc_channel.unary_unary(
    ...
    def generate_forecast_time_series(self) -> Callable[
        ...
        Returns a forecast in the form of a time series for
        ...
        if 'generate_forecast_time_series' not in self._stubs:
            self._stubs['generate_forecast_time_series'] = self.grpc_channel.unary_unary(
    ...
    def generate_forecast_metrics(self) -> Callable[
        ...
        if 'generate_forecast_metrics' not in self._stubs:
            self._stubs['generate_forecast_metrics'] = self.grpc_channel.unary_unary(
    ...
    def generate_historical_metrics(self) -> Callable[
        ...
        Returns the requested Keyword Plan historical
        metrics.
        ...
        if 'generate_historical_metrics' not in self._stubs:
            self._stubs['generate_historical_metrics'] = self.grpc_channel.unary_unary(
