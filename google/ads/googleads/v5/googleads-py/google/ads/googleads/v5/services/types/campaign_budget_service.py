...
class MutateCampaignBudgetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v5.services.types.CampaignBudgetOperation]):
...
class CampaignBudgetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.CampaignBudget):
            Create operation: No resource name is
            expected for the new budget.
        update (google.ads.googleads.v5.resources.types.CampaignBudget):
...
class MutateCampaignBudgetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateCampaignBudgetResult]):
