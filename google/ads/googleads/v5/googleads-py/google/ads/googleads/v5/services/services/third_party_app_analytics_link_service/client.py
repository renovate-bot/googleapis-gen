...
class ThirdPartyAppAnalyticsLinkServiceClient(metaclass=ThirdPartyAppAnalyticsLinkServiceClientMeta):
    ...
    def get_third_party_app_analytics_link(self,
        ...
        r"""Returns the third party app analytics link in full
        detail.
        ...
        Returns:
            google.ads.googleads.v5.resources.types.ThirdPartyAppAnalyticsLink:
    ...
    def regenerate_shareable_link_id(self,
        ...
        Returns:
            google.ads.googleads.v5.services.types.RegenerateShareableLinkIdResponse:
