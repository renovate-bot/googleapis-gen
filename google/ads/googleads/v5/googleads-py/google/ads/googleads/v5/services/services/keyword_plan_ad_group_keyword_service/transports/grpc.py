...
class KeywordPlanAdGroupKeywordServiceGrpcTransport(KeywordPlanAdGroupKeywordServiceTransport):
    ...
    def get_keyword_plan_ad_group_keyword(self) -> Callable[
        ...
        if 'get_keyword_plan_ad_group_keyword' not in self._stubs:
            self._stubs['get_keyword_plan_ad_group_keyword'] = self.grpc_channel.unary_unary(
    ...
    def mutate_keyword_plan_ad_group_keywords(self) -> Callable[
        ...
        if 'mutate_keyword_plan_ad_group_keywords' not in self._stubs:
            self._stubs['mutate_keyword_plan_ad_group_keywords'] = self.grpc_channel.unary_unary(
