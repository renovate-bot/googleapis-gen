...
class AdGroupExtensionSettingServiceClient(metaclass=AdGroupExtensionSettingServiceClientMeta):
    ...
    def get_ad_group_extension_setting(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetAdGroupExtensionSettingRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.AdGroupExtensionSetting:
    ...
    def mutate_ad_group_extension_settings(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateAdGroupExtensionSettingsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.AdGroupExtensionSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateAdGroupExtensionSettingsResponse:
