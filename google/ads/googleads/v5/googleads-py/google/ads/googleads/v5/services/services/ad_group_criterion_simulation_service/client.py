...
from google.ads.googleads.v5.resources.types import ad_group_criterion_simulation
from google.ads.googleads.v5.services.types import ad_group_criterion_simulation_service
...
class AdGroupCriterionSimulationServiceClient(metaclass=AdGroupCriterionSimulationServiceClientMeta):
    ...
    @staticmethod
    def ad_group_criterion_simulation_path(customer: str,ad_group_criterion_simulation: str,) -> str:
        """Return a fully-qualified ad_group_criterion_simulation string."""
        return "customers/{customer}/adGroupCriterionSimulations/{ad_group_criterion_simulation}".format(customer=customer, ad_group_criterion_simulation=ad_group_criterion_simulation, )
    ...
    def parse_ad_group_criterion_simulation_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer>.+?)/adGroupCriterionSimulations/(?P<ad_group_criterion_simulation>.+?)$", path)
    ...
    def get_ad_group_criterion_simulation(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetAdGroupCriterionSimulationRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.AdGroupCriterionSimulation:
