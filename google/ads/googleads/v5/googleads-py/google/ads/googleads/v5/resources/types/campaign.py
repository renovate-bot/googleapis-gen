...
from google.ads.googleads.v5.common.types import real_time_bidding_setting as gagc_real_time_bidding_setting
from google.ads.googleads.v5.common.types import targeting_setting as gagc_targeting_setting
from google.ads.googleads.v5.enums.types import ad_serving_optimization_status as gage_ad_serving_optimization_status
...
from google.ads.googleads.v5.enums.types import bidding_strategy_type as gage_bidding_strategy_type
...
from google.ads.googleads.v5.enums.types import location_source_type as gage_location_source_type
from google.ads.googleads.v5.enums.types import negative_geo_target_type as gage_negative_geo_target_type
from google.ads.googleads.v5.enums.types import optimization_goal_type
from google.ads.googleads.v5.enums.types import payment_mode as gage_payment_mode
from google.ads.googleads.v5.enums.types import positive_geo_target_type as gage_positive_geo_target_type
from google.ads.googleads.v5.enums.types import vanity_pharma_display_url_mode as gage_vanity_pharma_display_url_mode
from google.ads.googleads.v5.enums.types import vanity_pharma_text as gage_vanity_pharma_text
...
class Campaign(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v5.enums.types.CampaignStatusEnum.CampaignStatus):
            The status of the campaign.
            When a new campaign is added, the status
            defaults to ENABLED.
        serving_status (google.ads.googleads.v5.enums.types.CampaignServingStatusEnum.CampaignServingStatus):
            Output only. The ad serving status of the
            campaign.
        ad_serving_optimization_status (google.ads.googleads.v5.enums.types.AdServingOptimizationStatusEnum.AdServingOptimizationStatus):
        ...
        advertising_channel_sub_type (google.ads.googleads.v5.enums.types.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType):
        ...
        url_custom_parameters (Sequence[google.ads.googleads.v5.common.types.CustomParameter]):
            ...
            ``mobile_final_urls``.
        real_time_bidding_setting (google.ads.googleads.v5.common.types.RealTimeBiddingSetting):
            Settings for Real-Time Bidding, a feature
            only available for campaigns targeting the Ad
            Exchange network.
        network_settings (google.ads.googleads.v5.resources.types.Campaign.NetworkSettings):
            The network settings for the campaign.
        hotel_setting (google.ads.googleads.v5.resources.types.Campaign.HotelSettingInfo):
            Immutable. The hotel setting for the
            campaign.
        dynamic_search_ads_setting (google.ads.googleads.v5.resources.types.Campaign.DynamicSearchAdsSetting):
            The setting for controlling Dynamic Search
            Ads (DSA).
        shopping_setting (google.ads.googleads.v5.resources.types.Campaign.ShoppingSetting):
            The setting for controlling Shopping
            campaigns.
        targeting_setting (google.ads.googleads.v5.common.types.TargetingSetting):
            Setting for targeting related features.
        geo_target_type_setting (google.ads.googleads.v5.resources.types.Campaign.GeoTargetTypeSetting):
            The setting for ads geotargeting.
        local_campaign_setting (google.ads.googleads.v5.resources.types.Campaign.LocalCampaignSetting):
            The setting for local campaign.
        app_campaign_setting (google.ads.googleads.v5.resources.types.Campaign.AppCampaignSetting):
            The setting related to App Campaign.
        labels (Sequence[str]):
            Output only. The resource names of labels
            attached to this campaign.
        experiment_type (google.ads.googleads.v5.enums.types.CampaignExperimentTypeEnum.CampaignExperimentType):
        ...
        bidding_strategy_type (google.ads.googleads.v5.enums.types.BiddingStrategyTypeEnum.BiddingStrategyType):
        ...
        final_url_suffix (str):
            ...
            tracking.
        frequency_caps (Sequence[google.ads.googleads.v5.common.types.FrequencyCapEntry]):
            A list that limits how often each user will
            see this campaign's ads.
        video_brand_safety_suitability (google.ads.googleads.v5.enums.types.BrandSafetySuitabilityEnum.BrandSafetySuitability):
            Output only. 3-Tier Brand Safety setting for
            the campaign.
        vanity_pharma (google.ads.googleads.v5.resources.types.Campaign.VanityPharma):
            Describes how unbranded pharma ads will be
            displayed.
        selective_optimization (google.ads.googleads.v5.resources.types.Campaign.SelectiveOptimization):
        ...
        optimization_goal_setting (google.ads.googleads.v5.resources.types.Campaign.OptimizationGoalSetting):
            Optimization goal setting for this campaign,
            which includes a set of optimization goal types.
        tracking_setting (google.ads.googleads.v5.resources.types.Campaign.TrackingSetting):
            Output only. Campaign-level settings for
            tracking information.
        payment_mode (google.ads.googleads.v5.enums.types.PaymentModeEnum.PaymentMode):
        ...
        commission (google.ads.googleads.v5.common.types.Commission):
            Commission is an automatic bidding strategy
            in which the advertiser pays a certain portion
            of the conversion value.
        manual_cpc (google.ads.googleads.v5.common.types.ManualCpc):
            Standard Manual CPC bidding strategy.
            Manual click-based bidding where user pays per
            click.
        manual_cpm (google.ads.googleads.v5.common.types.ManualCpm):
            Standard Manual CPM bidding strategy.
            Manual impression-based bidding where user pays
            per thousand impressions.
        manual_cpv (google.ads.googleads.v5.common.types.ManualCpv):
            Output only. A bidding strategy that pays a
            configurable amount per video view.
        maximize_conversions (google.ads.googleads.v5.common.types.MaximizeConversions):
        ...
        maximize_conversion_value (google.ads.googleads.v5.common.types.MaximizeConversionValue):
        ...
        percent_cpc (google.ads.googleads.v5.common.types.PercentCpc):
            Standard Percent Cpc bidding strategy where
            bids are a fraction of the advertised price for
            some good or service.
        target_cpm (google.ads.googleads.v5.common.types.TargetCpm):
    ...
    class LocalCampaignSetting(proto.Message):
        ...
        Attributes:
            location_source_type (google.ads.googleads.v5.enums.types.LocationSourceTypeEnum.LocationSourceType):
    ...
    class GeoTargetTypeSetting(proto.Message):
        ...
        Attributes:
            positive_geo_target_type (google.ads.googleads.v5.enums.types.PositiveGeoTargetTypeEnum.PositiveGeoTargetType):
                The setting used for positive geotargeting in
                this particular campaign.
            negative_geo_target_type (google.ads.googleads.v5.enums.types.NegativeGeoTargetTypeEnum.NegativeGeoTargetType):
    ...
    class OptimizationGoalSetting(proto.Message):
        ...
        Attributes:
            optimization_goal_types (Sequence[google.ads.googleads.v5.enums.types.OptimizationGoalTypeEnum.OptimizationGoalType]):
    ...
    class AppCampaignSetting(proto.Message):
        ...
        Attributes:
            bidding_strategy_goal_type (google.ads.googleads.v5.enums.types.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType):
            ...
            app_store (google.ads.googleads.v5.enums.types.AppCampaignAppStoreEnum.AppCampaignAppStore):
    ...
    class VanityPharma(proto.Message):
        ...
        Attributes:
            vanity_pharma_display_url_mode (google.ads.googleads.v5.enums.types.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode):
                The display mode for vanity pharma URLs.
            vanity_pharma_text (google.ads.googleads.v5.enums.types.VanityPharmaTextEnum.VanityPharmaText):
