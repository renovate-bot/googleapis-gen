...
class FeedPlaceholderViewServiceClient(metaclass=FeedPlaceholderViewServiceClientMeta):
    ...
    def get_feed_placeholder_view(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetFeedPlaceholderViewRequest`):
                The request object. Request message for
                [FeedPlaceholderViewService.GetFeedPlaceholderView][google.ads.googleads.v5.services.FeedPlaceholderViewService.GetFeedPlaceholderView].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.FeedPlaceholderView:
