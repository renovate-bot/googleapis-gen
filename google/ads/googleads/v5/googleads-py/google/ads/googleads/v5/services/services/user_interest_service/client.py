...
class UserInterestServiceClient(metaclass=UserInterestServiceClientMeta):
    ...
    def get_user_interest(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetUserInterestRequest`):
                The request object. Request message for
                [UserInterestService.GetUserInterest][google.ads.googleads.v5.services.UserInterestService.GetUserInterest].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.UserInterest:
