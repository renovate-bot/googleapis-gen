...
class SearchPager:
    ...
    :class:`google.ads.googleads.v5.services.types.SearchGoogleAdsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v5.services.types.SearchGoogleAdsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v5.services.types.SearchGoogleAdsResponse`):
