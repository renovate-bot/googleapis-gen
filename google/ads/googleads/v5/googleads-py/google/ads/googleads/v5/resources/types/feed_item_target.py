...
class FeedItemTarget(proto.Message):
    ...
    Attributes:
        ...
        feed_item (google.protobuf.wrappers_pb2.StringValue):
            ...
            item target belongs.
        feed_item_target_type (google.ads.googleads.v5.enums.types.FeedItemTargetTypeEnum.FeedItemTargetType):
        ...
        status (google.ads.googleads.v5.enums.types.FeedItemTargetStatusEnum.FeedItemTargetStatus):
