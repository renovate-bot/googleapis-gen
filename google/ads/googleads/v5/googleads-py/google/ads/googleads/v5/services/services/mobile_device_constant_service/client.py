...
class MobileDeviceConstantServiceClient(metaclass=MobileDeviceConstantServiceClientMeta):
    ...
    def mobile_device_constant_path(mobile_device_constant: str,) -> str:
        ...
        return "mobileDeviceConstants/{mobile_device_constant}".format(mobile_device_constant=mobile_device_constant, )
    ...
    def parse_mobile_device_constant_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^mobileDeviceConstants/(?P<mobile_device_constant>.+?)$", path)
    ...
    def get_mobile_device_constant(self,
        ...
        r"""Returns the requested mobile device constant in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetMobileDeviceConstantRequest`):
                The request object.
                Request message for
                [MobileDeviceConstantService.GetMobileDeviceConstant][google.ads.googleads.v5.services.MobileDeviceConstantService.GetMobileDeviceConstant].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.MobileDeviceConstant:
