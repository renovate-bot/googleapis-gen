...
class FrequencyCapEntry(proto.Message):
    ...
    Attributes:
        key (google.ads.googleads.v5.common.types.FrequencyCapKey):
...
class FrequencyCapKey(proto.Message):
    ...
    Attributes:
        level (google.ads.googleads.v5.enums.types.FrequencyCapLevelEnum.FrequencyCapLevel):
            The level on which the cap is to be applied
            (e.g. ad group ad, ad group). The cap is applied
            to all the entities of this level.
        event_type (google.ads.googleads.v5.enums.types.FrequencyCapEventTypeEnum.FrequencyCapEventType):
