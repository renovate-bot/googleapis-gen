...
class CampaignBidModifierServiceClient(metaclass=CampaignBidModifierServiceClientMeta):
    ...
    def get_campaign_bid_modifier(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetCampaignBidModifierRequest`):
                The request object.
                Request message for
                [CampaignBidModifierService.GetCampaignBidModifier][google.ads.googleads.v5.services.CampaignBidModifierService.GetCampaignBidModifier].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.CampaignBidModifier:
    ...
    def mutate_campaign_bid_modifiers(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateCampaignBidModifiersRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.CampaignBidModifierOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateCampaignBidModifiersResponse:
