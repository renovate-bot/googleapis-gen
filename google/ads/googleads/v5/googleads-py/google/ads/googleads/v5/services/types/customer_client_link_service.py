...
class MutateCustomerClientLinkRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.ads.googleads.v5.services.types.CustomerClientLinkOperation):
...
class CustomerClientLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.CustomerClientLink):
            Create operation: No resource name is
            expected for the new link.
        update (google.ads.googleads.v5.resources.types.CustomerClientLink):
