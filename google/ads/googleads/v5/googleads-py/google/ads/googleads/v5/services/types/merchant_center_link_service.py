...
from google.ads.googleads.v5.resources.types import merchant_center_link
...
class ListMerchantCenterLinksRequest(proto.Message):
    ...
    [MerchantCenterLinkService.ListMerchantCenterLinks][google.ads.googleads.v5.services.MerchantCenterLinkService.ListMerchantCenterLinks].
...
class ListMerchantCenterLinksResponse(proto.Message):
    ...
    Attributes:
        merchant_center_links (Sequence[google.ads.googleads.v5.resources.types.MerchantCenterLink]):
...
class GetMerchantCenterLinkRequest(proto.Message):
    r"""Request message for
    [MerchantCenterLinkService.GetMerchantCenterLink][google.ads.googleads.v5.services.MerchantCenterLinkService.GetMerchantCenterLink].
...
class MutateMerchantCenterLinkRequest(proto.Message):
    r"""Request message for
    [MerchantCenterLinkService.MutateMerchantCenterLink][google.ads.googleads.v5.services.MerchantCenterLinkService.MutateMerchantCenterLink].

    Attributes:
        customer_id (str):
            Required. The ID of the customer being
            modified.
        operation (google.ads.googleads.v5.services.types.MerchantCenterLinkOperation):
...
class MerchantCenterLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v5.resources.types.MerchantCenterLink):
...
class MutateMerchantCenterLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v5.services.types.MutateMerchantCenterLinkResult):
