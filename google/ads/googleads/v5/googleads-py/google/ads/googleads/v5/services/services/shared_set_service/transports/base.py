...
class SharedSetServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for SharedSetService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_shared_set: gapic_v1.method.wrap_method(
                self.get_shared_set,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_shared_sets: gapic_v1.method.wrap_method(
                self.mutate_shared_sets,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def get_shared_set(self) -> typing.Callable[
            [shared_set_service.GetSharedSetRequest],
            shared_set.SharedSet]:
        raise NotImplementedError

    @property
    def mutate_shared_sets(self) -> typing.Callable[
