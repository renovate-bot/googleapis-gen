...
from google.ads.googleads.v5.resources.types import ad_group_criterion as gagr_ad_group_criterion
...
class GetAdGroupCriterionRequest(proto.Message):
    ...
    [AdGroupCriterionService.GetAdGroupCriterion][google.ads.googleads.v5.services.AdGroupCriterionService.GetAdGroupCriterion].
...
class MutateAdGroupCriteriaRequest(proto.Message):
    r"""Request message for
    [AdGroupCriterionService.MutateAdGroupCriteria][google.ads.googleads.v5.services.AdGroupCriterionService.MutateAdGroupCriteria].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose criteria
            are being modified.
        operations (Sequence[google.ads.googleads.v5.services.types.AdGroupCriterionOperation]):
...
class AdGroupCriterionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.AdGroupCriterion):
            Create operation: No resource name is
            expected for the new criterion.
        update (google.ads.googleads.v5.resources.types.AdGroupCriterion):
...
class MutateAdGroupCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateAdGroupCriterionResult]):
...
class MutateAdGroupCriterionResult(proto.Message):
    ...
    Attributes:
        ...
        ad_group_criterion (google.ads.googleads.v5.resources.types.AdGroupCriterion):
