...
class CampaignCriterion(proto.Message):
    ...
    Attributes:
        ...
        negative (bool):
            ...
            (``true``) the criterion.
        type_ (google.ads.googleads.v5.enums.types.CriterionTypeEnum.CriterionType):
            Output only. The type of the criterion.
        status (google.ads.googleads.v5.enums.types.CampaignCriterionStatusEnum.CampaignCriterionStatus):
            The status of the criterion.
        keyword (google.ads.googleads.v5.common.types.KeywordInfo):
            Immutable. Keyword.
        placement (google.ads.googleads.v5.common.types.PlacementInfo):
            Immutable. Placement.
        mobile_app_category (google.ads.googleads.v5.common.types.MobileAppCategoryInfo):
            Immutable. Mobile app category.
        mobile_application (google.ads.googleads.v5.common.types.MobileApplicationInfo):
            Immutable. Mobile application.
        location (google.ads.googleads.v5.common.types.LocationInfo):
            Immutable. Location.
        device (google.ads.googleads.v5.common.types.DeviceInfo):
            Immutable. Device.
        ad_schedule (google.ads.googleads.v5.common.types.AdScheduleInfo):
            Immutable. Ad Schedule.
        age_range (google.ads.googleads.v5.common.types.AgeRangeInfo):
            Immutable. Age range.
        gender (google.ads.googleads.v5.common.types.GenderInfo):
            Immutable. Gender.
        income_range (google.ads.googleads.v5.common.types.IncomeRangeInfo):
            Immutable. Income range.
        parental_status (google.ads.googleads.v5.common.types.ParentalStatusInfo):
            Immutable. Parental status.
        user_list (google.ads.googleads.v5.common.types.UserListInfo):
            Immutable. User List.
        youtube_video (google.ads.googleads.v5.common.types.YouTubeVideoInfo):
            Immutable. YouTube Video.
        youtube_channel (google.ads.googleads.v5.common.types.YouTubeChannelInfo):
            Immutable. YouTube Channel.
        proximity (google.ads.googleads.v5.common.types.ProximityInfo):
            Immutable. Proximity.
        topic (google.ads.googleads.v5.common.types.TopicInfo):
            Immutable. Topic.
        listing_scope (google.ads.googleads.v5.common.types.ListingScopeInfo):
            Immutable. Listing scope.
        language (google.ads.googleads.v5.common.types.LanguageInfo):
            Immutable. Language.
        ip_block (google.ads.googleads.v5.common.types.IpBlockInfo):
            Immutable. IpBlock.
        content_label (google.ads.googleads.v5.common.types.ContentLabelInfo):
            Immutable. ContentLabel.
        carrier (google.ads.googleads.v5.common.types.CarrierInfo):
            Immutable. Carrier.
        user_interest (google.ads.googleads.v5.common.types.UserInterestInfo):
            Immutable. User Interest.
        webpage (google.ads.googleads.v5.common.types.WebpageInfo):
            Immutable. Webpage.
        operating_system_version (google.ads.googleads.v5.common.types.OperatingSystemVersionInfo):
            Immutable. Operating system version.
        mobile_device (google.ads.googleads.v5.common.types.MobileDeviceInfo):
            Immutable. Mobile Device.
        location_group (google.ads.googleads.v5.common.types.LocationGroupInfo):
            Immutable. Location Group
        custom_affinity (google.ads.googleads.v5.common.types.CustomAffinityInfo):
