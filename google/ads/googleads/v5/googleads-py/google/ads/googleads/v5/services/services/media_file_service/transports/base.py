...
class MediaFileServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for MediaFileService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_media_file: gapic_v1.method.wrap_method(
                self.get_media_file,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_media_files: gapic_v1.method.wrap_method(
                self.mutate_media_files,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def mutate_media_files(self) -> typing.Callable[
