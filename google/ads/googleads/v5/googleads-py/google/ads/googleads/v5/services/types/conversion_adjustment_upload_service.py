...
class UploadConversionAdjustmentsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            the upload.
        conversion_adjustments (Sequence[google.ads.googleads.v5.services.types.ConversionAdjustment]):
...
class UploadConversionAdjustmentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            ads/api/docs/best-practices/partial-failures for
            more information about partial failure.
        results (Sequence[google.ads.googleads.v5.services.types.ConversionAdjustmentResult]):
...
class ConversionAdjustment(proto.Message):
    ...
    Attributes:
        ...
        adjustment_type (google.ads.googleads.v5.enums.types.ConversionAdjustmentTypeEnum.ConversionAdjustmentType):
            The adjustment type.
        restatement_value (google.ads.googleads.v5.services.types.RestatementValue):
        ...
        gclid_date_time_pair (google.ads.googleads.v5.services.types.GclidDateTimePair):
