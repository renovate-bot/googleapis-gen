...
class MutateBillingSetupRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.ads.googleads.v5.services.types.BillingSetupOperation):
...
class BillingSetupOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v5.resources.types.BillingSetup):
...
class MutateBillingSetupResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v5.services.types.MutateBillingSetupResult):
