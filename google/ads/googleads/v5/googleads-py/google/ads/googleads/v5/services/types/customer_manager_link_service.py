...
class MutateCustomerManagerLinkRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v5.services.types.CustomerManagerLinkOperation]):
...
class CustomerManagerLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v5.resources.types.CustomerManagerLink):
...
class MutateCustomerManagerLinkResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v5.services.types.MutateCustomerManagerLinkResult]):
