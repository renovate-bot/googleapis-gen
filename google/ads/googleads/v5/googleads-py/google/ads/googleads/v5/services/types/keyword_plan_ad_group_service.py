...
class MutateKeywordPlanAdGroupsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v5.services.types.KeywordPlanAdGroupOperation]):
...
class KeywordPlanAdGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.KeywordPlanAdGroup):
            Create operation: No resource name is
            expected for the new Keyword Plan ad group.
        update (google.ads.googleads.v5.resources.types.KeywordPlanAdGroup):
...
class MutateKeywordPlanAdGroupsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateKeywordPlanAdGroupResult]):
