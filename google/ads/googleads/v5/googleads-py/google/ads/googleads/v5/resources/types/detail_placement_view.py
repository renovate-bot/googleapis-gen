...
from google.ads.googleads.v5.enums.types import placement_type as gage_placement_type
...
class DetailPlacementView(proto.Message):
    ...
    group_placement_target_url = proto.Field(proto.MESSAGE, number=4,
        message=wrappers.StringValue,
    )
    target_url = proto.Field(proto.MESSAGE, number=5,
        message=wrappers.StringValue,
    )
