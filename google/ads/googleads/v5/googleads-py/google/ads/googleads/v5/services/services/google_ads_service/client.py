...
class GoogleAdsServiceClient(metaclass=GoogleAdsServiceClientMeta):
    ...
    def account_link_path(customer: str,account_link: str,) -> str:
        ...
        return "customers/{customer}/accountLinks/{account_link}".format(customer=customer, account_link=account_link, )
    ...
    def parse_ad_group_ad_label_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_audience_view_path(customer: str,ad_group_audience_view: str,) -> str:
        """Return a fully-qualified ad_group_audience_view string."""
        return "customers/{customer}/adGroupAudienceViews/{ad_group_audience_view}".format(customer=customer, ad_group_audience_view=ad_group_audience_view, )
    ...
    def campaign_asset_path(customer: str,campaign_asset: str,) -> str:
        ...
        return "customers/{customer}/campaignAssets/{campaign_asset}".format(customer=customer, campaign_asset=campaign_asset, )

    @staticmethod
    def parse_campaign_asset_path(path: str) -> Dict[str,str]:
        """Parse a campaign_asset path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/campaignAssets/(?P<campaign_asset>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_campaign_criterion_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def campaign_criterion_simulation_path(customer: str,campaign_criterion_simulation: str,) -> str:
        """Return a fully-qualified campaign_criterion_simulation string."""
        return "customers/{customer}/campaignCriterionSimulations/{campaign_criterion_simulation}".format(customer=customer, campaign_criterion_simulation=campaign_criterion_simulation, )
    ...
    def parse_campaign_criterion_simulation_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer>.+?)/campaignCriterionSimulations/(?P<campaign_criterion_simulation>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def change_status_path(customer: str,change_status: str,) -> str:
        ...
        return "customers/{customer}/changeStatus/{change_status}".format(customer=customer, change_status=change_status, )

    @staticmethod
    def parse_change_status_path(path: str) -> Dict[str,str]:
        """Parse a change_status path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/changeStatus/(?P<change_status>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def currency_constant_path(currency_constant: str,) -> str:
        ...
        return "currencyConstants/{currency_constant}".format(currency_constant=currency_constant, )
    ...
    def parse_customer_client_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def customer_client_link_path(customer: str,customer_client_link: str,) -> str:
        """Return a fully-qualified customer_client_link string."""
        return "customers/{customer}/customerClientLinks/{customer_client_link}".format(customer=customer, customer_client_link=customer_client_link, )

    @staticmethod
    def parse_customer_client_link_path(path: str) -> Dict[str,str]:
        """Parse a customer_client_link path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/customerClientLinks/(?P<customer_client_link>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_custom_interest_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def detail_placement_view_path(customer: str,detail_placement_view: str,) -> str:
        """Return a fully-qualified detail_placement_view string."""
        return "customers/{customer}/detailPlacementViews/{detail_placement_view}".format(customer=customer, detail_placement_view=detail_placement_view, )

    @staticmethod
    def parse_detail_placement_view_path(path: str) -> Dict[str,str]:
        """Parse a detail_placement_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/detailPlacementViews/(?P<detail_placement_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def display_keyword_view_path(customer: str,display_keyword_view: str,) -> str:
        """Return a fully-qualified display_keyword_view string."""
        return "customers/{customer}/displayKeywordViews/{display_keyword_view}".format(customer=customer, display_keyword_view=display_keyword_view, )

    @staticmethod
    def parse_display_keyword_view_path(path: str) -> Dict[str,str]:
        """Parse a display_keyword_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/displayKeywordViews/(?P<display_keyword_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_dynamic_search_ads_search_term_view_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def expanded_landing_page_view_path(customer: str,expanded_landing_page_view: str,) -> str:
        """Return a fully-qualified expanded_landing_page_view string."""
        return "customers/{customer}/expandedLandingPageViews/{expanded_landing_page_view}".format(customer=customer, expanded_landing_page_view=expanded_landing_page_view, )
    ...
    def parse_expanded_landing_page_view_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer>.+?)/expandedLandingPageViews/(?P<expanded_landing_page_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def gender_view_path(customer: str,gender_view: str,) -> str:
        ...
        return "customers/{customer}/genderViews/{gender_view}".format(customer=customer, gender_view=gender_view, )

    @staticmethod
    def parse_gender_view_path(path: str) -> Dict[str,str]:
        """Parse a gender_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/genderViews/(?P<gender_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def hotel_group_view_path(customer: str,hotel_group_view: str,) -> str:
        ...
        return "customers/{customer}/hotelGroupViews/{hotel_group_view}".format(customer=customer, hotel_group_view=hotel_group_view, )

    @staticmethod
    def parse_hotel_group_view_path(path: str) -> Dict[str,str]:
        """Parse a hotel_group_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/hotelGroupViews/(?P<hotel_group_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def income_range_view_path(customer: str,income_range_view: str,) -> str:
        ...
        return "customers/{customer}/incomeRangeViews/{income_range_view}".format(customer=customer, income_range_view=income_range_view, )

    @staticmethod
    def parse_income_range_view_path(path: str) -> Dict[str,str]:
        """Parse a income_range_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/incomeRangeViews/(?P<income_range_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def landing_page_view_path(customer: str,landing_page_view: str,) -> str:
        ...
        return "customers/{customer}/landingPageViews/{landing_page_view}".format(customer=customer, landing_page_view=landing_page_view, )

    @staticmethod
    def parse_landing_page_view_path(path: str) -> Dict[str,str]:
        """Parse a landing_page_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/landingPageViews/(?P<landing_page_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def location_view_path(customer: str,location_view: str,) -> str:
        ...
        return "customers/{customer}/locationViews/{location_view}".format(customer=customer, location_view=location_view, )

    @staticmethod
    def parse_location_view_path(path: str) -> Dict[str,str]:
        """Parse a location_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/locationViews/(?P<location_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_mobile_device_constant_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def offline_user_data_job_path(customer: str,offline_user_data_job: str,) -> str:
        """Return a fully-qualified offline_user_data_job string."""
        return "customers/{customer}/offlineUserDataJobs/{offline_user_data_job}".format(customer=customer, offline_user_data_job=offline_user_data_job, )

    @staticmethod
    def parse_offline_user_data_job_path(path: str) -> Dict[str,str]:
        """Parse a offline_user_data_job path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/offlineUserDataJobs/(?P<offline_user_data_job>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def payments_account_path(customer: str,payments_account: str,) -> str:
        ...
        return "customers/{customer}/paymentsAccounts/{payments_account}".format(customer=customer, payments_account=payments_account, )

    @staticmethod
    def parse_payments_account_path(path: str) -> Dict[str,str]:
        """Parse a payments_account path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/paymentsAccounts/(?P<payments_account>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_shopping_performance_view_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def third_party_app_analytics_link_path(customer: str,third_party_app_analytics_link: str,) -> str:
        """Return a fully-qualified third_party_app_analytics_link string."""
        return "customers/{customer}/thirdPartyAppAnalyticsLinks/{third_party_app_analytics_link}".format(customer=customer, third_party_app_analytics_link=third_party_app_analytics_link, )
    ...
    def topic_constant_path(topic_constant: str,) -> str:
        ...
        return "topicConstants/{topic_constant}".format(topic_constant=topic_constant, )
    ...
    def topic_view_path(customer: str,topic_view: str,) -> str:
        ...
        return "customers/{customer}/topicViews/{topic_view}".format(customer=customer, topic_view=topic_view, )

    @staticmethod
    def parse_topic_view_path(path: str) -> Dict[str,str]:
        """Parse a topic_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/topicViews/(?P<topic_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def user_interest_path(customer: str,user_interest: str,) -> str:
        """Return a fully-qualified user_interest string."""
        return "customers/{customer}/userInterests/{user_interest}".format(customer=customer, user_interest=user_interest, )

    @staticmethod
    def parse_user_interest_path(path: str) -> Dict[str,str]:
        """Parse a user_interest path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/userInterests/(?P<user_interest>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def user_location_view_path(customer: str,user_location_view: str,) -> str:
        ...
        return "customers/{customer}/userLocationViews/{user_location_view}".format(customer=customer, user_location_view=user_location_view, )

    @staticmethod
    def parse_user_location_view_path(path: str) -> Dict[str,str]:
        """Parse a user_location_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/userLocationViews/(?P<user_location_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def video_path(customer: str,video: str,) -> str:
        """Return a fully-qualified video string."""
        return "customers/{customer}/videos/{video}".format(customer=customer, video=video, )

    @staticmethod
    def parse_video_path(path: str) -> Dict[str,str]:
        """Parse a video path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/videos/(?P<video>.+?)$", path)
        return m.groupdict() if m else {}
