...
class AdGroupFeedServiceGrpcTransport(AdGroupFeedServiceTransport):
    """gRPC backend transport for AdGroupFeedService.
    ...
    def get_ad_group_feed(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetAdGroupFeedRequest],
                    ~.AdGroupFeed]:
        ...
        if 'get_ad_group_feed' not in self._stubs:
            self._stubs['get_ad_group_feed'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v5.services.AdGroupFeedService/GetAdGroupFeed',
                request_serializer=ad_group_feed_service.GetAdGroupFeedRequest.serialize,
                response_deserializer=ad_group_feed.AdGroupFeed.deserialize,
            )
        return self._stubs['get_ad_group_feed']
    ...
    def mutate_ad_group_feeds(self) -> Callable[
        ...
        Returns:
            Callable[[~.MutateAdGroupFeedsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'mutate_ad_group_feeds' not in self._stubs:
            self._stubs['mutate_ad_group_feeds'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v5.services.AdGroupFeedService/MutateAdGroupFeeds',
                request_serializer=ad_group_feed_service.MutateAdGroupFeedsRequest.serialize,
                response_deserializer=ad_group_feed_service.MutateAdGroupFeedsResponse.deserialize,
            )
        return self._stubs['mutate_ad_group_feeds']
