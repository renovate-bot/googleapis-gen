...
class SuggestGeoTargetConstantsRequest(proto.Message):
    ...
    Attributes:
        ...
        country_code (str):
            ...
            country code.
        location_names (google.ads.googleads.v5.services.types.SuggestGeoTargetConstantsRequest.LocationNames):
            The location names to search by. At most 25
            names can be set.
        geo_targets (google.ads.googleads.v5.services.types.SuggestGeoTargetConstantsRequest.GeoTargets):
...
class SuggestGeoTargetConstantsResponse(proto.Message):
    ...
    Attributes:
        geo_target_constant_suggestions (Sequence[google.ads.googleads.v5.services.types.GeoTargetConstantSuggestion]):
...
class GeoTargetConstantSuggestion(proto.Message):
    ...
    Attributes:
        ...
        search_term (str):
            ...
            target.
        geo_target_constant (google.ads.googleads.v5.resources.types.GeoTargetConstant):
            The GeoTargetConstant result.
        geo_target_constant_parents (Sequence[google.ads.googleads.v5.resources.types.GeoTargetConstant]):
