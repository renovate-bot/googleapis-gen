...
class KeywordPlanCampaignKeywordServiceClient(metaclass=KeywordPlanCampaignKeywordServiceClientMeta):
    ...
    def get_keyword_plan_campaign_keyword(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetKeywordPlanCampaignKeywordRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.KeywordPlanCampaignKeyword:
    ...
    def mutate_keyword_plan_campaign_keywords(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateKeywordPlanCampaignKeywordsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.KeywordPlanCampaignKeywordOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateKeywordPlanCampaignKeywordsResponse:
