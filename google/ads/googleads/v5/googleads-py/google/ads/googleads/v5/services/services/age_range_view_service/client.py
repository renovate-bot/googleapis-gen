...
from google.ads.googleads.v5.resources.types import age_range_view
from google.ads.googleads.v5.services.types import age_range_view_service
...
class AgeRangeViewServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AgeRangeViewServiceTransport]]
...
class AgeRangeViewServiceClient(metaclass=AgeRangeViewServiceClientMeta):
    ...
    def age_range_view_path(customer: str,age_range_view: str,) -> str:
        ...
        return "customers/{customer}/ageRangeViews/{age_range_view}".format(customer=customer, age_range_view=age_range_view, )

    @staticmethod
    def parse_age_range_view_path(path: str) -> Dict[str,str]:
        """Parse a age_range_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/ageRangeViews/(?P<age_range_view>.+?)$", path)
    ...
    def get_age_range_view(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetAgeRangeViewRequest`):
                The request object. Request message for
                [AgeRangeViewService.GetAgeRangeView][google.ads.googleads.v5.services.AgeRangeViewService.GetAgeRangeView].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.AgeRangeView:
                An age range view.
        """
        ...
        if not isinstance(request, age_range_view_service.GetAgeRangeViewRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_age_range_view]
