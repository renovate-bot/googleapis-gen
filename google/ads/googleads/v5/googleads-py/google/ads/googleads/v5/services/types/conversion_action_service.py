...
class GetConversionActionRequest(proto.Message):
    ...
    [ConversionActionService.GetConversionAction][google.ads.googleads.v5.services.ConversionActionService.GetConversionAction].
...
class MutateConversionActionsRequest(proto.Message):
    r"""Request message for
    [ConversionActionService.MutateConversionActions][google.ads.googleads.v5.services.ConversionActionService.MutateConversionActions].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            conversion actions are being modified.
        operations (Sequence[google.ads.googleads.v5.services.types.ConversionActionOperation]):
...
class ConversionActionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.ConversionAction):
            Create operation: No resource name is
            expected for the new conversion action.
        update (google.ads.googleads.v5.resources.types.ConversionAction):
...
class MutateConversionActionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateConversionActionResult]):
