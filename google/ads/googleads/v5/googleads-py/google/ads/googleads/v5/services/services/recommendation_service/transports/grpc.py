...
class RecommendationServiceGrpcTransport(RecommendationServiceTransport):
    ...
    def get_recommendation(self) -> Callable[
        ...
        if 'get_recommendation' not in self._stubs:
            self._stubs['get_recommendation'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v5.services.RecommendationService/GetRecommendation',
                request_serializer=recommendation_service.GetRecommendationRequest.serialize,
    ...
    def apply_recommendation(self) -> Callable[
        ...
        if 'apply_recommendation' not in self._stubs:
            self._stubs['apply_recommendation'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v5.services.RecommendationService/ApplyRecommendation',
    ...
    def dismiss_recommendation(self) -> Callable[
        ...
        if 'dismiss_recommendation' not in self._stubs:
            self._stubs['dismiss_recommendation'] = self.grpc_channel.unary_unary(
