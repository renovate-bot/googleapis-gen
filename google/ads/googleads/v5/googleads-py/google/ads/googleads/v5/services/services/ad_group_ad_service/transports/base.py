...
class AdGroupAdServiceTransport(metaclass=abc.ABCMeta):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_ad_group_ad: gapic_v1.method.wrap_method(
                self.get_ad_group_ad,
    ...
    @property
    def get_ad_group_ad(self) -> typing.Callable[
            [ad_group_ad_service.GetAdGroupAdRequest],
            ad_group_ad.AdGroupAd]:
        raise NotImplementedError

    @property
    def mutate_ad_group_ads(self) -> typing.Callable[
