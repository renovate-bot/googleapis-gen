...
class DomainCategoryServiceClient(metaclass=DomainCategoryServiceClientMeta):
    ...
    def domain_category_path(customer: str,domain_category: str,) -> str:
        ...
        return "customers/{customer}/domainCategories/{domain_category}".format(customer=customer, domain_category=domain_category, )
    ...
    def get_domain_category(self,
        ...
        Returns:
            google.ads.googleads.v5.resources.types.DomainCategory:
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_domain_category]
