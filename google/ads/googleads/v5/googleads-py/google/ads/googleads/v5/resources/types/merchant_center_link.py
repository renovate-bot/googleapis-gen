...
from google.ads.googleads.v5.enums.types import merchant_center_link_status
...
class MerchantCenterLink(proto.Message):
    ...
    Attributes:
        ...
        merchant_center_account_name (str):
            ...
            account. This field is readonly.
        status (google.ads.googleads.v5.enums.types.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatus):
