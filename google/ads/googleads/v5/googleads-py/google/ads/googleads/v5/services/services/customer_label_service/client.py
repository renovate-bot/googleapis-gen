...
class CustomerLabelServiceClient(metaclass=CustomerLabelServiceClientMeta):
    ...
    def get_customer_label(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetCustomerLabelRequest`):
                The request object. Request message for
                [CustomerLabelService.GetCustomerLabel][google.ads.googleads.v5.services.CustomerLabelService.GetCustomerLabel].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.CustomerLabel:
    ...
    def mutate_customer_labels(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateCustomerLabelsRequest`):
                The request object. Request message for
                [CustomerLabelService.MutateCustomerLabels][google.ads.googleads.v5.services.CustomerLabelService.MutateCustomerLabels].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.CustomerLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateCustomerLabelsResponse:
