...
class ProductBiddingCategoryConstant(proto.Message):
    ...
    Attributes:
        ...
        level (google.ads.googleads.v5.enums.types.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevel):
            Output only. Level of the product bidding
            category.
        status (google.ads.googleads.v5.enums.types.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus):
