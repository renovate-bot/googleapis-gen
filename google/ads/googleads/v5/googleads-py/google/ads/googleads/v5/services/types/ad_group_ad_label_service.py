...
class GetAdGroupAdLabelRequest(proto.Message):
    ...
    [AdGroupAdLabelService.GetAdGroupAdLabel][google.ads.googleads.v5.services.AdGroupAdLabelService.GetAdGroupAdLabel].
...
class MutateAdGroupAdLabelsRequest(proto.Message):
    r"""Request message for
    [AdGroupAdLabelService.MutateAdGroupAdLabels][google.ads.googleads.v5.services.AdGroupAdLabelService.MutateAdGroupAdLabels].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose ad group
            ad labels are being modified.
        operations (Sequence[google.ads.googleads.v5.services.types.AdGroupAdLabelOperation]):
...
class AdGroupAdLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v5.resources.types.AdGroupAdLabel):
...
class MutateAdGroupAdLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateAdGroupAdLabelResult]):
