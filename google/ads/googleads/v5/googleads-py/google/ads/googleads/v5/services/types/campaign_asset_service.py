...
class MutateCampaignAssetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v5.services.types.CampaignAssetOperation]):
...
class CampaignAssetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v5.resources.types.CampaignAsset):
...
class MutateCampaignAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateCampaignAssetResult]):
