...
class BiddingStrategy(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v5.enums.types.BiddingStrategyStatusEnum.BiddingStrategyStatus):
            Output only. The status of the bidding
            strategy.
            This field is read-only.
        type_ (google.ads.googleads.v5.enums.types.BiddingStrategyTypeEnum.BiddingStrategyType):
        ...
        non_removed_campaign_count (int):
            ...
            This field is read-only.
        enhanced_cpc (google.ads.googleads.v5.common.types.EnhancedCpc):
