...
from google.ads.googleads.v5.resources.types import detail_placement_view
from google.ads.googleads.v5.services.types import detail_placement_view_service
...
class DetailPlacementViewServiceGrpcTransport(DetailPlacementViewServiceTransport):
    ...
    @property
    def get_detail_placement_view(self) -> Callable[
            [detail_placement_view_service.GetDetailPlacementViewRequest],
            detail_placement_view.DetailPlacementView]:
        r"""Return a callable for the get detail placement view method over gRPC.

        Returns the requested Detail Placement view in full
        detail.
        ...
        if 'get_detail_placement_view' not in self._stubs:
            self._stubs['get_detail_placement_view'] = self.grpc_channel.unary_unary(
