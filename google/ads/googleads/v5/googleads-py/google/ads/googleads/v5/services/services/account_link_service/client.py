...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def get_account_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetAccountLinkRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.AccountLink:
    ...
    def create_account_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.CreateAccountLinkRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            account_link (:class:`google.ads.googleads.v5.resources.types.AccountLink`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.CreateAccountLinkResponse:
    ...
    def mutate_account_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateAccountLinkRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v5.services.types.AccountLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateAccountLinkResponse:
