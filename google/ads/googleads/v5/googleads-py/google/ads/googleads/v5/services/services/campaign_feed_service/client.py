...
from .transports.base import CampaignFeedServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import CampaignFeedServiceGrpcTransport


class CampaignFeedServiceClientMeta(type):
    """Metaclass for the CampaignFeedService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CampaignFeedServiceTransport]]
...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CampaignFeedServiceClient: The constructed client.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, CampaignFeedServiceTransport, None] = None,
    ...
    def get_campaign_feed(self,
        ...
        r"""Returns the requested campaign feed in full detail.

        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetCampaignFeedRequest`):
                The request object.
                Request message for
                [CampaignFeedService.GetCampaignFeed][google.ads.googleads.v5.services.CampaignFeedService.GetCampaignFeed].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.CampaignFeed:
                A campaign feed.
        """
        ...
        if not isinstance(request, campaign_feed_service.GetCampaignFeedRequest):
            request = campaign_feed_service.GetCampaignFeedRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_campaign_feed]
    ...
    def mutate_campaign_feeds(self,
        ...
        r"""Creates, updates, or removes campaign feeds.
        Operation statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateCampaignFeedsRequest`):
                The request object.
                Request message for
                [CampaignFeedService.MutateCampaignFeeds][google.ads.googleads.v5.services.CampaignFeedService.MutateCampaignFeeds].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.CampaignFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateCampaignFeedsResponse:
                Response message for a campaign feed
                mutate.
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, campaign_feed_service.MutateCampaignFeedsRequest):
            request = campaign_feed_service.MutateCampaignFeedsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_campaign_feeds]
