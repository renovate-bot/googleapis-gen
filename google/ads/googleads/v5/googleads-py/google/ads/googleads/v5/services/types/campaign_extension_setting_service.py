...
class MutateCampaignExtensionSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v5.services.types.CampaignExtensionSettingOperation]):
...
class CampaignExtensionSettingOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.CampaignExtensionSetting):
            Create operation: No resource name is
            expected for the new campaign extension setting.
        update (google.ads.googleads.v5.resources.types.CampaignExtensionSetting):
...
class MutateCampaignExtensionSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateCampaignExtensionSettingResult]):
