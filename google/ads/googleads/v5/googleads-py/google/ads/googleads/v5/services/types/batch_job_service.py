...
class MutateBatchJobRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            create a batch job.
        operation (google.ads.googleads.v5.services.types.BatchJobOperation):
...
class BatchJobOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v5.resources.types.BatchJob):
...
class MutateBatchJobResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v5.services.types.MutateBatchJobResult):
...
class AddBatchJobOperationsRequest(proto.Message):
    ...
    Attributes:
        ...
        mutate_operations (Sequence[google.ads.googleads.v5.services.types.MutateOperation]):
    ...
    mutate_operations = proto.RepeatedField(proto.MESSAGE, number=3,
...
class ListBatchJobResultsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v5.services.types.BatchJobResult]):
...
class BatchJobResult(proto.Message):
    ...
    Attributes:
        ...
        mutate_operation_response (google.ads.googleads.v5.services.types.MutateOperationResponse):
    ...
    mutate_operation_response = proto.Field(proto.MESSAGE, number=2,
