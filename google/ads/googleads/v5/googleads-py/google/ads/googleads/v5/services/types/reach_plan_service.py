...
from google.ads.googleads.v5.enums.types import reach_plan_ad_length
from google.ads.googleads.v5.enums.types import reach_plan_age_range
from google.ads.googleads.v5.enums.types import reach_plan_network
...
class ListPlannableLocationsRequest(proto.Message):
    ...
    [ReachPlanService.ListPlannableLocations][google.ads.googleads.v5.services.ReachPlanService.ListPlannableLocations].
    """
...
class ListPlannableLocationsResponse(proto.Message):
    ...
    Attributes:
        plannable_locations (Sequence[google.ads.googleads.v5.services.types.PlannableLocation]):
...
class PlannableLocation(proto.Message):
    ...
    parent_country_id = proto.Field(proto.MESSAGE, number=3,
...
class ListPlannableProductsRequest(proto.Message):
    ...
    plannable_location_id = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.StringValue,
    )
...
class ListPlannableProductsResponse(proto.Message):
    ...
    Attributes:
        product_metadata (Sequence[google.ads.googleads.v5.services.types.ProductMetadata]):
...
class ProductMetadata(proto.Message):
    ...
    Attributes:
        ...
        plannable_targeting (google.ads.googleads.v5.services.types.PlannableTargeting):
            The allowed plannable targeting for this
            product.
    """

    plannable_product_code = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.StringValue,
    )
...
class PlannableTargeting(proto.Message):
    ...
    Attributes:
        age_ranges (Sequence[google.ads.googleads.v5.enums.types.ReachPlanAgeRangeEnum.ReachPlanAgeRange]):
        ...
        genders (Sequence[google.ads.googleads.v5.common.types.GenderInfo]):
            Targetable genders for the ad product.
        devices (Sequence[google.ads.googleads.v5.common.types.DeviceInfo]):
            Targetable devices for the ad product.
        networks (Sequence[google.ads.googleads.v5.enums.types.ReachPlanNetworkEnum.ReachPlanNetwork]):
...
class GenerateProductMixIdeasRequest(proto.Message):
    r"""Request message for
    [ReachPlanService.GenerateProductMixIdeas][google.ads.googleads.v5.services.ReachPlanService.GenerateProductMixIdeas].
    ...
    Attributes:
        ...
        budget_micros (google.protobuf.wrappers_pb2.Int64Value):
            ...
            one unit.
        preferences (google.ads.googleads.v5.services.types.Preferences):
    ...
    plannable_location_id = proto.Field(proto.MESSAGE, number=2,
        message=wrappers.StringValue,
    )
    currency_code = proto.Field(proto.MESSAGE, number=3,
        message=wrappers.StringValue,
    )
    budget_micros = proto.Field(proto.MESSAGE, number=4,
        message=wrappers.Int64Value,
    )
...
class Preferences(proto.Message):
    ...
    Attributes:
        ...
        starts_with_sound (google.protobuf.wrappers_pb2.BoolValue):
            ...
            If not set, default is any value.
        ad_length (google.ads.googleads.v5.enums.types.ReachPlanAdLengthEnum.ReachPlanAdLength):
    ...
    is_skippable = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.BoolValue,
    )
    starts_with_sound = proto.Field(proto.MESSAGE, number=2,
        message=wrappers.BoolValue,
    )
    ad_length = proto.Field(proto.ENUM, number=3,
        enum=reach_plan_ad_length.ReachPlanAdLengthEnum.ReachPlanAdLength,
    )
    top_content_only = proto.Field(proto.MESSAGE, number=4,
        message=wrappers.BoolValue,
    )
    has_guaranteed_price = proto.Field(proto.MESSAGE, number=5,
        message=wrappers.BoolValue,
    )
...
class GenerateProductMixIdeasResponse(proto.Message):
    ...
    Attributes:
        product_allocation (Sequence[google.ads.googleads.v5.services.types.ProductAllocation]):
...
class ProductAllocation(proto.Message):
    ...
    budget_micros = proto.Field(proto.MESSAGE, number=2,
        message=wrappers.Int64Value,
    )
...
class GenerateReachForecastRequest(proto.Message):
    r"""Request message for
    [ReachPlanService.GenerateReachForecast][google.ads.googleads.v5.services.ReachPlanService.GenerateReachForecast].
    ...
    Attributes:
        ...
        currency_code (google.protobuf.wrappers_pb2.StringValue):
            The currency code.
            Three-character ISO 4217 currency code.
        campaign_duration (google.ads.googleads.v5.services.types.CampaignDuration):
        ...
        cookie_frequency_cap_setting (google.ads.googleads.v5.services.types.FrequencyCap):
            Desired cookie frequency cap that will be applied to each
            planned product. This is equivalent to the frequency cap
            exposed in Google Ads when creating a campaign, it
            represents the maximum number of times an ad can be shown to
        ...
        targeting (google.ads.googleads.v5.services.types.Targeting):
        ...
        planned_products (Sequence[google.ads.googleads.v5.services.types.PlannedProduct]):
...
class FrequencyCap(proto.Message):
    ...
    Attributes:
        impressions (google.protobuf.wrappers_pb2.Int32Value):
            ...
            inclusive.
        time_unit (google.ads.googleads.v5.enums.types.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit):
...
class Targeting(proto.Message):
    ...
    Attributes:
        ...
        age_range (google.ads.googleads.v5.enums.types.ReachPlanAgeRangeEnum.ReachPlanAgeRange):
            Targeted age range.
        ...
        network (google.ads.googleads.v5.enums.types.ReachPlanNetworkEnum.ReachPlanNetwork):
...
class CampaignDuration(proto.Message):
    ...
    duration_in_days = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.Int32Value,
    )
...
class GenerateReachForecastResponse(proto.Message):
    ...
    Attributes:
        on_target_audience_metrics (google.ads.googleads.v5.services.types.OnTargetAudienceMetrics):
            Reference on target audiences for this curve.
        reach_curve (google.ads.googleads.v5.services.types.ReachCurve):
...
class ReachCurve(proto.Message):
    ...
    Attributes:
        reach_forecasts (Sequence[google.ads.googleads.v5.services.types.ReachForecast]):
...
class ReachForecast(proto.Message):
    ...
    Attributes:
        cost_micros (google.protobuf.wrappers_pb2.Int64Value):
            The cost in micros.
        forecast (google.ads.googleads.v5.services.types.Forecast):
            Forecasted traffic metrics for this point.
        forecasted_product_allocations (Sequence[google.ads.googleads.v5.services.types.ProductAllocation]):
    ...
    cost_micros = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.Int64Value,
    )
    forecast = proto.Field(proto.MESSAGE, number=2,
        message='Forecast',
    )
    forecasted_product_allocations = proto.RepeatedField(proto.MESSAGE, number=3,
        message='ProductAllocation',
    )
...
class Forecast(proto.Message):
    ...
    on_target_reach = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.Int64Value,
    )
    total_reach = proto.Field(proto.MESSAGE, number=2,
        message=wrappers.Int64Value,
    )
    on_target_impressions = proto.Field(proto.MESSAGE, number=3,
        message=wrappers.Int64Value,
    )
    total_impressions = proto.Field(proto.MESSAGE, number=4,
        message=wrappers.Int64Value,
    )
...
class OnTargetAudienceMetrics(proto.Message):
    ...
    youtube_audience_size = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.Int64Value,
    )
    census_audience_size = proto.Field(proto.MESSAGE, number=2,
        message=wrappers.Int64Value,
    )
