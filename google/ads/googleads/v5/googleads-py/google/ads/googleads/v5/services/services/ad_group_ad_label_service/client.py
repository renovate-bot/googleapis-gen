...
class AdGroupAdLabelServiceClient(metaclass=AdGroupAdLabelServiceClientMeta):
    ...
    def get_ad_group_ad_label(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetAdGroupAdLabelRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v5.resources.types.AdGroupAdLabel:
    ...
    def mutate_ad_group_ad_labels(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateAdGroupAdLabelsRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.AdGroupAdLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateAdGroupAdLabelsResponse:
