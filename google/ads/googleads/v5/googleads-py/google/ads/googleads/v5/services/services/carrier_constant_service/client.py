...
from google.ads.googleads.v5.resources.types import carrier_constant
from google.ads.googleads.v5.services.types import carrier_constant_service
...
class CarrierConstantServiceClient(metaclass=CarrierConstantServiceClientMeta):
    ...
    def carrier_constant_path(carrier_constant: str,) -> str:
        ...
        return "carrierConstants/{carrier_constant}".format(carrier_constant=carrier_constant, )
    ...
    def get_carrier_constant(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetCarrierConstantRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.CarrierConstant:
