...
from google.ads.googleads.v5.common.types import matching_function as gagc_matching_function
...
class CampaignFeed(proto.Message):
    ...
    Attributes:
        ...
        placeholder_types (Sequence[google.ads.googleads.v5.enums.types.PlaceholderTypeEnum.PlaceholderType]):
        ...
        status (google.ads.googleads.v5.enums.types.FeedLinkStatusEnum.FeedLinkStatus):
