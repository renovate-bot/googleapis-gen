...
class AdGroupLabelServiceClientMeta(type):
    """Metaclass for the AdGroupLabelService client.
...
class AdGroupLabelServiceClient(metaclass=AdGroupLabelServiceClientMeta):
    ...
    def transport(self) -> AdGroupLabelServiceTransport:
        ...
        Returns:
            AdGroupLabelServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, AdGroupLabelServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the ad group label service client.
        ...
        Args:
            ...
            transport (Union[str, ~.AdGroupLabelServiceTransport]): The
        ...
        if isinstance(transport, AdGroupLabelServiceTransport):
            # transport is a AdGroupLabelServiceTransport instance.
            if credentials:
            ...
            self._transport = AdGroupLabelServiceGrpcTransport(
    ...
    def get_ad_group_label(self,
        ...
        r"""Returns the requested ad group label in full detail.

        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetAdGroupLabelRequest`):
                The request object. Request message for
                [AdGroupLabelService.GetAdGroupLabel][google.ads.googleads.v5.services.AdGroupLabelService.GetAdGroupLabel].
            resource_name (:class:`str`):
                Required. The resource name of the ad
                group label to fetch.
        ...
        Returns:
            google.ads.googleads.v5.resources.types.AdGroupLabel:
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_ad_group_label]
    ...
    def mutate_ad_group_labels(self,
        ...
        r"""Creates and removes ad group labels.
        Operation statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateAdGroupLabelsRequest`):
                The request object. Request message for
                [AdGroupLabelService.MutateAdGroupLabels][google.ads.googleads.v5.services.AdGroupLabelService.MutateAdGroupLabels].
            customer_id (:class:`str`):
                Required. ID of the customer whose ad
                group labels are being modified.

                This corresponds to the ``customer_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.AdGroupLabelOperation]`):
                Required. The list of operations to
                perform on ad group labels.
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateAdGroupLabelsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_ad_group_labels]
