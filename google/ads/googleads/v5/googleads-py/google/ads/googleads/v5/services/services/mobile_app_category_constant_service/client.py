...
from google.ads.googleads.v5.resources.types import mobile_app_category_constant
from google.ads.googleads.v5.services.types import mobile_app_category_constant_service
from .transports.base import MobileAppCategoryConstantServiceTransport, DEFAULT_CLIENT_INFO
...
class MobileAppCategoryConstantServiceClient(metaclass=MobileAppCategoryConstantServiceClientMeta):
    ...
    @staticmethod
    def mobile_app_category_constant_path(mobile_app_category_constant: str,) -> str:
        """Return a fully-qualified mobile_app_category_constant string."""
        return "mobileAppCategoryConstants/{mobile_app_category_constant}".format(mobile_app_category_constant=mobile_app_category_constant, )
    ...
    def parse_mobile_app_category_constant_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^mobileAppCategoryConstants/(?P<mobile_app_category_constant>.+?)$", path)
    ...
    def __init__(self, *,
            ...
            transport: Union[str, MobileAppCategoryConstantServiceTransport, None] = None,
    ...
    def get_mobile_app_category_constant(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetMobileAppCategoryConstantRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.MobileAppCategoryConstant:
        ...
        if not isinstance(request, mobile_app_category_constant_service.GetMobileAppCategoryConstantRequest):
            request = mobile_app_category_constant_service.GetMobileAppCategoryConstantRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_mobile_app_category_constant]
