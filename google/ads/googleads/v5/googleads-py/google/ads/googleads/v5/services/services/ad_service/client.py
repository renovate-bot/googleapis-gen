...
class AdServiceClient(metaclass=AdServiceClientMeta):
    ...
    def get_ad(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetAdRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.Ad:
                An ad.
        """
    ...
    def mutate_ads(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateAdsRequest`):
                The request object. Request message for
                [AdService.MutateAds][google.ads.googleads.v5.services.AdService.MutateAds].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.AdOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateAdsResponse:
