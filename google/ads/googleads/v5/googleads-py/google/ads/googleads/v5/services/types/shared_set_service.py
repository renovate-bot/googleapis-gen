...
class MutateSharedSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v5.services.types.SharedSetOperation]):
...
class SharedSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.SharedSet):
            Create operation: No resource name is
            expected for the new shared set.
        update (google.ads.googleads.v5.resources.types.SharedSet):
...
class MutateSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateSharedSetResult]):
