...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
    ...
    def get_keyword_plan(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetKeywordPlanRequest`):
                The request object. Request message for
                [KeywordPlanService.GetKeywordPlan][google.ads.googleads.v5.services.KeywordPlanService.GetKeywordPlan].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.KeywordPlan:
    ...
    def mutate_keyword_plans(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateKeywordPlansRequest`):
                The request object. Request message for
                [KeywordPlanService.MutateKeywordPlans][google.ads.googleads.v5.services.KeywordPlanService.MutateKeywordPlans].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.KeywordPlanOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateKeywordPlansResponse:
    ...
    def generate_forecast_curve(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GenerateForecastCurveRequest`):
                The request object. Request message for
                [KeywordPlanService.GenerateForecastCurve][google.ads.googleads.v5.services.KeywordPlanService.GenerateForecastCurve].
        ...
        Returns:
            google.ads.googleads.v5.services.types.GenerateForecastCurveResponse:
    ...
    def generate_forecast_time_series(self,
        ...
        r"""Returns a forecast in the form of a time series for
        the Keyword Plan over the next 52 weeks.
        (1) Forecasts closer to the current date are generally
        more accurate than further out.

        (2) The forecast reflects seasonal trends using current
        and prior traffic patterns. The forecast period of the
        plan is ignored.

        Args:
            request (:class:`google.ads.googleads.v5.services.types.GenerateForecastTimeSeriesRequest`):
                The request object. Request message for
                [KeywordPlanService.GenerateForecastTimeSeries][google.ads.googleads.v5.services.KeywordPlanService.GenerateForecastTimeSeries].
            keyword_plan (:class:`str`):
                Required. The resource name of the
                keyword plan to be forecasted.
        ...
        Returns:
            google.ads.googleads.v5.services.types.GenerateForecastTimeSeriesResponse:
                Response message for
                [KeywordPlanService.GenerateForecastTimeSeries][google.ads.googleads.v5.services.KeywordPlanService.GenerateForecastTimeSeries].
    ...
    def generate_forecast_metrics(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GenerateForecastMetricsRequest`):
                The request object. Request message for
                [KeywordPlanService.GenerateForecastMetrics][google.ads.googleads.v5.services.KeywordPlanService.GenerateForecastMetrics].
            keyword_plan (:class:`str`):
                Required. The resource name of the
                keyword plan to be forecasted.
        ...
        Returns:
            google.ads.googleads.v5.services.types.GenerateForecastMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateForecastMetrics][google.ads.googleads.v5.services.KeywordPlanService.GenerateForecastMetrics].
    ...
    def generate_historical_metrics(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GenerateHistoricalMetricsRequest`):
                The request object. Request message for
                [KeywordPlanService.GenerateHistoricalMetrics][google.ads.googleads.v5.services.KeywordPlanService.GenerateHistoricalMetrics].
            keyword_plan (:class:`str`):
                Required. The resource name of the
        ...
        Returns:
            google.ads.googleads.v5.services.types.GenerateHistoricalMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateHistoricalMetrics][google.ads.googleads.v5.services.KeywordPlanService.GenerateHistoricalMetrics].
