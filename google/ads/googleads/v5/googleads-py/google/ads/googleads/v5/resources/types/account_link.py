...
class AccountLink(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v5.enums.types.AccountLinkStatusEnum.AccountLinkStatus):
            The status of the link.
        type_ (google.ads.googleads.v5.enums.types.LinkedAccountTypeEnum.LinkedAccountType):
            Output only. The type of the linked account.
        third_party_app_analytics (google.ads.googleads.v5.resources.types.ThirdPartyAppAnalyticsLinkIdentifier):
            Immutable. A third party app analytics link.
        data_partner (google.ads.googleads.v5.resources.types.DataPartnerLinkIdentifier):
            Output only. Data partner link.
        google_ads (google.ads.googleads.v5.resources.types.GoogleAdsLinkIdentifier):
...
class ThirdPartyAppAnalyticsLinkIdentifier(proto.Message):
    ...
    Attributes:
        ...
        app_vendor (google.ads.googleads.v5.enums.types.MobileAppVendorEnum.MobileAppVendor):
