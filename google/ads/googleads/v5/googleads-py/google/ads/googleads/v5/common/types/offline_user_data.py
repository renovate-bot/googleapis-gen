...
class UserIdentifier(proto.Message):
    ...
    Attributes:
        ...
        third_party_user_id (google.protobuf.wrappers_pb2.StringValue):
            ...
            for SSD.
        address_info (google.ads.googleads.v5.common.types.OfflineUserAddressInfo):
            Address information.
    """
...
class TransactionAttribute(proto.Message):
    ...
    Attributes:
        ...
        store_attribute (google.ads.googleads.v5.common.types.StoreAttribute):
...
class UserData(proto.Message):
    ...
    Attributes:
        user_identifiers (Sequence[google.ads.googleads.v5.common.types.UserIdentifier]):
            User identification info. Required.
        transaction_attribute (google.ads.googleads.v5.common.types.TransactionAttribute):
...
class StoreSalesMetadata(proto.Message):
    ...
    Attributes:
        ...
        custom_key (google.protobuf.wrappers_pb2.StringValue):
            ...
            Accessible only to customers on the allow-list.
        third_party_metadata (google.ads.googleads.v5.common.types.StoreSalesThirdPartyMetadata):
