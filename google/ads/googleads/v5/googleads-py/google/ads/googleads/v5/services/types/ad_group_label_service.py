...
class MutateAdGroupLabelsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v5.services.types.AdGroupLabelOperation]):
...
class AdGroupLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v5.resources.types.AdGroupLabel):
...
class MutateAdGroupLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateAdGroupLabelResult]):
