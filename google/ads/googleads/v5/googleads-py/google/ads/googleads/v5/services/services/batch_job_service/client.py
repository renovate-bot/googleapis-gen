...
from google.ads.googleads.v5.services.services.batch_job_service import pagers
...
class BatchJobServiceClient(metaclass=BatchJobServiceClientMeta):
    ...
    def mutate_batch_job(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v5.services.types.BatchJobOperation`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateBatchJobResponse:
    ...
    def get_batch_job(self,
        ...
        Returns:
            google.ads.googleads.v5.resources.types.BatchJob:
    ...
    def list_batch_job_results(self,
        ...
        Returns:
            google.ads.googleads.v5.services.services.batch_job_service.pagers.ListBatchJobResultsPager:
                Response message for
                [BatchJobService.ListBatchJobResults][google.ads.googleads.v5.services.BatchJobService.ListBatchJobResults].
    ...
    def add_batch_job_operations(self,
        ...
        Returns:
            google.ads.googleads.v5.services.types.AddBatchJobOperationsResponse:
                Response message for
                [BatchJobService.AddBatchJobOperations][google.ads.googleads.v5.services.BatchJobService.AddBatchJobOperations].
