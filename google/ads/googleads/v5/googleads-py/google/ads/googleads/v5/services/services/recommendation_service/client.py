...
class RecommendationServiceClient(metaclass=RecommendationServiceClientMeta):
    ...
    def recommendation_path(customer: str,recommendation: str,) -> str:
        ...
        return "customers/{customer}/recommendations/{recommendation}".format(customer=customer, recommendation=recommendation, )
    ...
    def get_recommendation(self,
        ...
        Returns:
            google.ads.googleads.v5.resources.types.Recommendation:
                A recommendation.
        """
    ...
    def apply_recommendation(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.ApplyRecommendationOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.ApplyRecommendationResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.apply_recommendation]
    ...
    def dismiss_recommendation(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.DismissRecommendationRequest.DismissRecommendationOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.DismissRecommendationResponse:
                Response message for
                [RecommendationService.DismissRecommendation][google.ads.googleads.v5.services.RecommendationService.DismissRecommendation].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.dismiss_recommendation]
