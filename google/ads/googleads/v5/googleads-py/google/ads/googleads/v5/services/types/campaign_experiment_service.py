...
from google.ads.googleads.v5.resources.types import campaign_experiment as gagr_campaign_experiment
...
class GetCampaignExperimentRequest(proto.Message):
    ...
    [CampaignExperimentService.GetCampaignExperiment][google.ads.googleads.v5.services.CampaignExperimentService.GetCampaignExperiment].
...
class MutateCampaignExperimentsRequest(proto.Message):
    r"""Request message for
    [CampaignExperimentService.MutateCampaignExperiments][google.ads.googleads.v5.services.CampaignExperimentService.MutateCampaignExperiments].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign experiments are being modified.
        operations (Sequence[google.ads.googleads.v5.services.types.CampaignExperimentOperation]):
...
class CampaignExperimentOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v5.resources.types.CampaignExperiment):
...
class MutateCampaignExperimentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateCampaignExperimentResult]):
...
class MutateCampaignExperimentResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_experiment (google.ads.googleads.v5.resources.types.CampaignExperiment):
...
class CreateCampaignExperimentRequest(proto.Message):
    r"""Request message for
    [CampaignExperimentService.CreateCampaignExperiment][google.ads.googleads.v5.services.CampaignExperimentService.CreateCampaignExperiment].
...
class GraduateCampaignExperimentRequest(proto.Message):
    r"""Request message for
    [CampaignExperimentService.GraduateCampaignExperiment][google.ads.googleads.v5.services.CampaignExperimentService.GraduateCampaignExperiment].
...
class PromoteCampaignExperimentRequest(proto.Message):
    r"""Request message for
    [CampaignExperimentService.PromoteCampaignExperiment][google.ads.googleads.v5.services.CampaignExperimentService.PromoteCampaignExperiment].
...
class EndCampaignExperimentRequest(proto.Message):
    r"""Request message for
    [CampaignExperimentService.EndCampaignExperiment][google.ads.googleads.v5.services.CampaignExperimentService.EndCampaignExperiment].
...
class ListCampaignExperimentAsyncErrorsRequest(proto.Message):
    r"""Request message for
    [CampaignExperimentService.ListCampaignExperimentAsyncErrors][google.ads.googleads.v5.services.CampaignExperimentService.ListCampaignExperimentAsyncErrors].
