...
class ConversionAdjustmentUploadServiceClient(metaclass=ConversionAdjustmentUploadServiceClientMeta):
    ...
    def upload_conversion_adjustments(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.UploadConversionAdjustmentsRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            conversion_adjustments (:class:`Sequence[google.ads.googleads.v5.services.types.ConversionAdjustment]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.UploadConversionAdjustmentsResponse:
