...
class AdGroupCriterionSimulation(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v5.enums.types.SimulationTypeEnum.SimulationType):
            Output only. The field that the simulation
            modifies.
        modification_method (google.ads.googleads.v5.enums.types.SimulationModificationMethodEnum.SimulationModificationMethod):
        ...
        cpc_bid_point_list (google.ads.googleads.v5.common.types.CpcBidSimulationPointList):
            Output only. Simulation points if the simulation type is
            CPC_BID.
        percent_cpc_bid_point_list (google.ads.googleads.v5.common.types.PercentCpcBidSimulationPointList):
            Output only. Simulation points if the simulation type is
            PERCENT_CPC_BID.
    """
    ...
    percent_cpc_bid_point_list = proto.Field(proto.MESSAGE, number=13, oneof='point_list',
