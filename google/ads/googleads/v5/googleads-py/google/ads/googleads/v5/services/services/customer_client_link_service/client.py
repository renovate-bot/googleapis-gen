...
from google.ads.googleads.v5.services.types import customer_client_link_service
...
class CustomerClientLinkServiceClient(metaclass=CustomerClientLinkServiceClientMeta):
    ...
    def get_customer_client_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetCustomerClientLinkRequest`):
                The request object. Request message for
                [CustomerClientLinkService.GetCustomerClientLink][google.ads.googleads.v5.services.CustomerClientLinkService.GetCustomerClientLink].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.CustomerClientLink:
    ...
    def mutate_customer_client_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateCustomerClientLinkRequest`):
                The request object. Request message for
                [CustomerClientLinkService.MutateCustomerClientLink][google.ads.googleads.v5.services.CustomerClientLinkService.MutateCustomerClientLink].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v5.services.types.CustomerClientLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateCustomerClientLinkResponse:
