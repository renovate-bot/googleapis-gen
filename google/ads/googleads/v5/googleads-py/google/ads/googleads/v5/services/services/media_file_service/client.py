...
class MediaFileServiceClient(metaclass=MediaFileServiceClientMeta):
    ...
    def get_media_file(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetMediaFileRequest`):
                The request object. Request message for
                [MediaFileService.GetMediaFile][google.ads.googleads.v5.services.MediaFileService.GetMediaFile]
        ...
        Returns:
            google.ads.googleads.v5.resources.types.MediaFile:
                A media file.
        """
    ...
    def mutate_media_files(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateMediaFilesRequest`):
                The request object. Request message for
                [MediaFileService.MutateMediaFiles][google.ads.googleads.v5.services.MediaFileService.MutateMediaFiles]
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.MediaFileOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateMediaFilesResponse:
