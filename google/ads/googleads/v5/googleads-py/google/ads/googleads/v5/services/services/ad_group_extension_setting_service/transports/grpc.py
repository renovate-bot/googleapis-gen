...
class AdGroupExtensionSettingServiceGrpcTransport(AdGroupExtensionSettingServiceTransport):
    ...
    def get_ad_group_extension_setting(self) -> Callable[
        ...
        if 'get_ad_group_extension_setting' not in self._stubs:
            self._stubs['get_ad_group_extension_setting'] = self.grpc_channel.unary_unary(
    ...
    def mutate_ad_group_extension_settings(self) -> Callable[
        ...
        r"""Return a callable for the
        mutate ad group extension
        settings
          method over gRPC.

        Creates, updates, or removes ad group extension
        ...
        if 'mutate_ad_group_extension_settings' not in self._stubs:
            self._stubs['mutate_ad_group_extension_settings'] = self.grpc_channel.unary_unary(
