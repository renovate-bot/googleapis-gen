...
from google.ads.googleads.v5.resources.types import account_link as gagr_account_link
...
class GetAccountLinkRequest(proto.Message):
    ...
    [AccountLinkService.GetAccountLink][google.ads.googleads.v5.services.AccountLinkService.GetAccountLink].
...
class CreateAccountLinkRequest(proto.Message):
    ...
    Attributes:
        ...
        account_link (google.ads.googleads.v5.resources.types.AccountLink):
...
class MutateAccountLinkRequest(proto.Message):
    r"""Request message for
    [AccountLinkService.MutateAccountLink][google.ads.googleads.v5.services.AccountLinkService.MutateAccountLink].

    Attributes:
        customer_id (str):
            Required. The ID of the customer being
            modified.
        operation (google.ads.googleads.v5.services.types.AccountLinkOperation):
...
class MutateAccountLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v5.services.types.MutateAccountLinkResult):
