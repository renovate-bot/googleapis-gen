...
class CustomerFeedServiceClient(metaclass=CustomerFeedServiceClientMeta):
    ...
    def get_customer_feed(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetCustomerFeedRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.CustomerFeed:
                A customer feed.
        """
    ...
    def mutate_customer_feeds(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateCustomerFeedsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.CustomerFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateCustomerFeedsResponse:
