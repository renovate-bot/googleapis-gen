...
from google.ads.googleads.v5.resources.types import ad_group as gagr_ad_group
...
class GetAdGroupRequest(proto.Message):
    ...
    [AdGroupService.GetAdGroup][google.ads.googleads.v5.services.AdGroupService.GetAdGroup].
...
class MutateAdGroupsRequest(proto.Message):
    r"""Request message for
    [AdGroupService.MutateAdGroups][google.ads.googleads.v5.services.AdGroupService.MutateAdGroups].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ad
            groups are being modified.
        operations (Sequence[google.ads.googleads.v5.services.types.AdGroupOperation]):
...
class AdGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.AdGroup):
            Create operation: No resource name is
            expected for the new ad group.
        update (google.ads.googleads.v5.resources.types.AdGroup):
...
class MutateAdGroupsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateAdGroupResult]):
...
class MutateAdGroupResult(proto.Message):
    ...
    Attributes:
        ...
        ad_group (google.ads.googleads.v5.resources.types.AdGroup):
