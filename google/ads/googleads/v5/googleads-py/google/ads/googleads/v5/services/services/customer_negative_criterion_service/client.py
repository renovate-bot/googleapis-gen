...
class CustomerNegativeCriterionServiceClient(metaclass=CustomerNegativeCriterionServiceClientMeta):
    ...
    def get_customer_negative_criterion(self,
        ...
        Returns:
            google.ads.googleads.v5.resources.types.CustomerNegativeCriterion:
    ...
    def mutate_customer_negative_criteria(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.CustomerNegativeCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateCustomerNegativeCriteriaResponse:
