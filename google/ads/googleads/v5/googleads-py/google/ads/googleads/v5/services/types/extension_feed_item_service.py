...
from google.ads.googleads.v5.resources.types import extension_feed_item as gagr_extension_feed_item
...
class GetExtensionFeedItemRequest(proto.Message):
    ...
    [ExtensionFeedItemService.GetExtensionFeedItem][google.ads.googleads.v5.services.ExtensionFeedItemService.GetExtensionFeedItem].
...
class MutateExtensionFeedItemsRequest(proto.Message):
    r"""Request message for
    [ExtensionFeedItemService.MutateExtensionFeedItems][google.ads.googleads.v5.services.ExtensionFeedItemService.MutateExtensionFeedItems].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            extension feed items are being modified.
        operations (Sequence[google.ads.googleads.v5.services.types.ExtensionFeedItemOperation]):
...
class ExtensionFeedItemOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.ExtensionFeedItem):
            Create operation: No resource name is
            expected for the new extension feed item.
        update (google.ads.googleads.v5.resources.types.ExtensionFeedItem):
...
class MutateExtensionFeedItemsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateExtensionFeedItemResult]):
...
class MutateExtensionFeedItemResult(proto.Message):
    ...
    Attributes:
        ...
        extension_feed_item (google.ads.googleads.v5.resources.types.ExtensionFeedItem):
