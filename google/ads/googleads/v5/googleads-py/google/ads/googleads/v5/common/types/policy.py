...
class PolicyValidationParameter(proto.Message):
    ...
    Ignorable policy topics are only usable with expanded text ads
    and responsive search ads. All other ad types must use policy
    violation keys.
    ...
    Attributes:
        ...
        exempt_policy_violation_keys (Sequence[google.ads.googleads.v5.common.types.PolicyViolationKey]):
...
class PolicyTopicEntry(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v5.enums.types.PolicyTopicEntryTypeEnum.PolicyTopicEntryType):
            Describes the negative or positive effect
            this policy will have on serving.
        evidences (Sequence[google.ads.googleads.v5.common.types.PolicyTopicEvidence]):
            Additional information that explains policy
            finding (e.g. the brand name for a trademark
            finding).
        constraints (Sequence[google.ads.googleads.v5.common.types.PolicyTopicConstraint]):
...
class PolicyTopicEvidence(proto.Message):
    ...
    Attributes:
        website_list (google.ads.googleads.v5.common.types.PolicyTopicEvidence.WebsiteList):
            List of websites linked with this resource.
        text_list (google.ads.googleads.v5.common.types.PolicyTopicEvidence.TextList):
        ...
        language_code (str):
            ...
            "en-US".
        destination_text_list (google.ads.googleads.v5.common.types.PolicyTopicEvidence.DestinationTextList):
            The text in the destination of the resource
            that is causing a policy finding.
        destination_mismatch (google.ads.googleads.v5.common.types.PolicyTopicEvidence.DestinationMismatch):
            Mismatch between the destinations of a
            resource's URLs.
        destination_not_working (google.ads.googleads.v5.common.types.PolicyTopicEvidence.DestinationNotWorking):
    ...
    class DestinationMismatch(proto.Message):
        ...
        Attributes:
            url_types (Sequence[google.ads.googleads.v5.enums.types.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlType]):
    ...
    class DestinationNotWorking(proto.Message):
        ...
        Attributes:
            ...
            device (google.ads.googleads.v5.enums.types.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDevice):
            ...
            last_checked_date_time (str):
                ...
                14:34:30".
            dns_error_type (google.ads.googleads.v5.enums.types.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorType):
...
class PolicyTopicConstraint(proto.Message):
    ...
    Attributes:
        country_constraint_list (google.ads.googleads.v5.common.types.PolicyTopicConstraint.CountryConstraintList):
            Countries where the resource cannot serve.
        reseller_constraint (google.ads.googleads.v5.common.types.PolicyTopicConstraint.ResellerConstraint):
            Reseller constraint.
        certificate_missing_in_country_list (google.ads.googleads.v5.common.types.PolicyTopicConstraint.CountryConstraintList):
            Countries where a certificate is required for
            serving.
        certificate_domain_mismatch_in_country_list (google.ads.googleads.v5.common.types.PolicyTopicConstraint.CountryConstraintList):
    ...
    class CountryConstraintList(proto.Message):
        ...
        Attributes:
            total_targeted_countries (int):
                ...
                resource.
            countries (Sequence[google.ads.googleads.v5.common.types.PolicyTopicConstraint.CountryConstraint]):
