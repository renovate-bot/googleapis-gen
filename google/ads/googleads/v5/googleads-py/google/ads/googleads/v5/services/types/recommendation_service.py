...
class ApplyRecommendationRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            recommendation.
        operations (Sequence[google.ads.googleads.v5.services.types.ApplyRecommendationOperation]):
...
class ApplyRecommendationOperation(proto.Message):
    ...
    Attributes:
        resource_name (str):
            ...
            apply.
        campaign_budget (google.ads.googleads.v5.services.types.ApplyRecommendationOperation.CampaignBudgetParameters):
            Optional parameters to use when applying a
            campaign budget recommendation.
        text_ad (google.ads.googleads.v5.services.types.ApplyRecommendationOperation.TextAdParameters):
            Optional parameters to use when applying a
            text ad recommendation.
        keyword (google.ads.googleads.v5.services.types.ApplyRecommendationOperation.KeywordParameters):
            Optional parameters to use when applying
            keyword recommendation.
        target_cpa_opt_in (google.ads.googleads.v5.services.types.ApplyRecommendationOperation.TargetCpaOptInParameters):
            Optional parameters to use when applying
            target CPA opt-in recommendation.
        target_roas_opt_in (google.ads.googleads.v5.services.types.ApplyRecommendationOperation.TargetRoasOptInParameters):
            Optional parameters to use when applying
            target ROAS opt-in recommendation.
        callout_extension (google.ads.googleads.v5.services.types.ApplyRecommendationOperation.CalloutExtensionParameters):
            Parameters to use when applying callout
            extension recommendation.
        call_extension (google.ads.googleads.v5.services.types.ApplyRecommendationOperation.CallExtensionParameters):
            Parameters to use when applying call
            extension recommendation.
        sitelink_extension (google.ads.googleads.v5.services.types.ApplyRecommendationOperation.SitelinkExtensionParameters):
            Parameters to use when applying sitelink
            extension recommendation.
        move_unused_budget (google.ads.googleads.v5.services.types.ApplyRecommendationOperation.MoveUnusedBudgetParameters):
    ...
    class CampaignBudgetParameters(proto.Message):
        ...
        new_budget_amount_micros = proto.Field(proto.MESSAGE, number=1,
    ...
    class KeywordParameters(proto.Message):
        ...
        Attributes:
            ad_group (google.protobuf.wrappers_pb2.StringValue):
                ...
                is a required field.
            match_type (google.ads.googleads.v5.enums.types.KeywordMatchTypeEnum.KeywordMatchType):
    ...
    class TargetCpaOptInParameters(proto.Message):
        ...
        new_campaign_budget_amount_micros = proto.Field(proto.MESSAGE, number=2,
            message=wrappers.Int64Value,
        )
    ...
    class CalloutExtensionParameters(proto.Message):
        ...
        Attributes:
            callout_extensions (Sequence[google.ads.googleads.v5.common.types.CalloutFeedItem]):
    ...
    class CallExtensionParameters(proto.Message):
        ...
        Attributes:
            call_extensions (Sequence[google.ads.googleads.v5.common.types.CallFeedItem]):
    ...
    class SitelinkExtensionParameters(proto.Message):
        ...
        Attributes:
            sitelink_extensions (Sequence[google.ads.googleads.v5.common.types.SitelinkFeedItem]):
    ...
    class MoveUnusedBudgetParameters(proto.Message):
        ...
        budget_micros_to_move = proto.Field(proto.MESSAGE, number=1,
            message=wrappers.Int64Value,
        )
...
class ApplyRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v5.services.types.ApplyRecommendationResult]):
...
class DismissRecommendationRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer with the
            recommendation.
        operations (Sequence[google.ads.googleads.v5.services.types.DismissRecommendationRequest.DismissRecommendationOperation]):
...
class DismissRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v5.services.types.DismissRecommendationResponse.DismissRecommendationResult]):
