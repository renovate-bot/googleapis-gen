...
from google.ads.googleads.v5.resources.types import keyword_view
from google.ads.googleads.v5.services.types import keyword_view_service
    ...
    def get_keyword_view(self) -> Callable[
        ...
        if 'get_keyword_view' not in self._stubs:
            self._stubs['get_keyword_view'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v5.services.KeywordViewService/GetKeywordView',
