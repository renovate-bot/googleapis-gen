...
class UserInterest(proto.Message):
    ...
    Attributes:
        ...
        taxonomy_type (google.ads.googleads.v5.enums.types.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType):
        ...
        availabilities (Sequence[google.ads.googleads.v5.common.types.CriterionCategoryAvailability]):
