...
class ChangeStatusServiceClient(metaclass=ChangeStatusServiceClientMeta):
    ...
    def get_change_status(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetChangeStatusRequest`):
                The request object. Request message for
                '[ChangeStatusService.GetChangeStatus][google.ads.googleads.v5.services.ChangeStatusService.GetChangeStatus]'.
        ...
        Returns:
            google.ads.googleads.v5.resources.types.ChangeStatus:
