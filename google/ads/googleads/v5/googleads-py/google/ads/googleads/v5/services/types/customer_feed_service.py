...
from google.ads.googleads.v5.resources.types import customer_feed as gagr_customer_feed
...
class GetCustomerFeedRequest(proto.Message):
    ...
    [CustomerFeedService.GetCustomerFeed][google.ads.googleads.v5.services.CustomerFeedService.GetCustomerFeed].
...
class MutateCustomerFeedsRequest(proto.Message):
    r"""Request message for
    [CustomerFeedService.MutateCustomerFeeds][google.ads.googleads.v5.services.CustomerFeedService.MutateCustomerFeeds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            customer feeds are being modified.
        operations (Sequence[google.ads.googleads.v5.services.types.CustomerFeedOperation]):
...
class CustomerFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.CustomerFeed):
            Create operation: No resource name is
            expected for the new customer feed.
        update (google.ads.googleads.v5.resources.types.CustomerFeed):
...
class MutateCustomerFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateCustomerFeedResult]):
...
class MutateCustomerFeedResult(proto.Message):
    ...
    Attributes:
        ...
        customer_feed (google.ads.googleads.v5.resources.types.CustomerFeed):
