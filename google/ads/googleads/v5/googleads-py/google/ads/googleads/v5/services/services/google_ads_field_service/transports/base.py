...
from google.ads.googleads.v5.resources.types import google_ads_field
from google.ads.googleads.v5.services.types import google_ads_field_service
...
class GoogleAdsFieldServiceTransport(metaclass=abc.ABCMeta):
    ...
    @property
    def get_google_ads_field(self) -> typing.Callable[
            [google_ads_field_service.GetGoogleAdsFieldRequest],
            google_ads_field.GoogleAdsField]:
        raise NotImplementedError

    @property
    def search_google_ads_fields(self) -> typing.Callable[
