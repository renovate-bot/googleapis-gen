...
from google.ads.googleads.v5.services.types import billing_setup_service
...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    def get_billing_setup(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetBillingSetupRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.BillingSetup:
    ...
    def mutate_billing_setup(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateBillingSetupRequest`):
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v5.services.types.BillingSetupOperation`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateBillingSetupResponse:
