...
from google.ads.googleads.v5.services.types import conversion_upload_service
...
class ConversionUploadServiceClient(metaclass=ConversionUploadServiceClientMeta):
    ...
    def upload_call_conversions(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.UploadCallConversionsRequest`):
                The request object.
                Request message for
                [ConversionUploadService.UploadCallConversions][google.ads.googleads.v5.services.ConversionUploadService.UploadCallConversions].
            customer_id (:class:`str`):
                Required. The ID of the customer
                performing the upload.
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            conversions (:class:`Sequence[google.ads.googleads.v5.services.types.CallConversion]`):
                Required. The conversions that are
                being uploaded.
        ...
        Returns:
            google.ads.googleads.v5.services.types.UploadCallConversionsResponse:
                Response message for
                [ConversionUploadService.UploadCallConversions][google.ads.googleads.v5.services.ConversionUploadService.UploadCallConversions].
