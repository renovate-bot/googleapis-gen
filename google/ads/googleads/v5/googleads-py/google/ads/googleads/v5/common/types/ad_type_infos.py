...
from google.ads.googleads.v5.enums.types import display_upload_product_type as gage_display_upload_product_type
...
class CallOnlyAdInfo(proto.Message):
    ...
    Attributes:
        ...
        conversion_action (str):
            ...
            field is ignored.
        conversion_reporting_state (google.ads.googleads.v5.enums.types.CallConversionReportingStateEnum.CallConversionReportingState):
...
class GmailAdInfo(proto.Message):
    ...
    Attributes:
        teaser (google.ads.googleads.v5.common.types.GmailTeaser):
            The Gmail teaser.
        header_image (str):
        ...
        marketing_image_display_call_to_action (google.ads.googleads.v5.common.types.DisplayCallToAction):
            Display-call-to-action of the marketing
            image.
        product_images (Sequence[google.ads.googleads.v5.common.types.ProductImage]):
            Product images. Up to 15 images are
            supported.
        product_videos (Sequence[google.ads.googleads.v5.common.types.ProductVideo]):
...
class ProductImage(proto.Message):
    ...
    Attributes:
        ...
        display_call_to_action (google.ads.googleads.v5.common.types.DisplayCallToAction):
...
class VideoAdInfo(proto.Message):
    ...
    Attributes:
        ...
        in_stream (google.ads.googleads.v5.common.types.VideoTrueViewInStreamAdInfo):
            Video TrueView in-stream ad format.
        bumper (google.ads.googleads.v5.common.types.VideoBumperInStreamAdInfo):
            Video bumper in-stream ad format.
        out_stream (google.ads.googleads.v5.common.types.VideoOutstreamAdInfo):
            Video out-stream ad format.
        non_skippable (google.ads.googleads.v5.common.types.VideoNonSkippableInStreamAdInfo):
            Video non-skippable in-stream ad format.
        discovery (google.ads.googleads.v5.common.types.VideoTrueViewDiscoveryAdInfo):
...
class VideoResponsiveAdInfo(proto.Message):
    ...
    Attributes:
        headlines (Sequence[google.ads.googleads.v5.common.types.AdTextAsset]):
        ...
        long_headlines (Sequence[google.ads.googleads.v5.common.types.AdTextAsset]):
            List of text assets used for the long
            headline. Currently, only a single value for the
            long headline is supported.
        descriptions (Sequence[google.ads.googleads.v5.common.types.AdTextAsset]):
            List of text assets used for the description.
            Currently, only a single value for the
            description is supported.
        call_to_actions (Sequence[google.ads.googleads.v5.common.types.AdTextAsset]):
        ...
        videos (Sequence[google.ads.googleads.v5.common.types.AdVideoAsset]):
            List of YouTube video assets used for the ad.
            Currently, only a single value for the YouTube
            video asset is supported.
        companion_banners (Sequence[google.ads.googleads.v5.common.types.AdImageAsset]):
...
class LegacyResponsiveDisplayAdInfo(proto.Message):
    ...
    Attributes:
        ...
        format_setting (google.ads.googleads.v5.enums.types.DisplayAdFormatSettingEnum.DisplayAdFormatSetting):
...
class AppAdInfo(proto.Message):
    ...
    Attributes:
        mandatory_ad_text (google.ads.googleads.v5.common.types.AdTextAsset):
            Mandatory ad text.
        headlines (Sequence[google.ads.googleads.v5.common.types.AdTextAsset]):
            List of text assets for headlines. When the
            ad serves the headlines will be selected from
        ...
        descriptions (Sequence[google.ads.googleads.v5.common.types.AdTextAsset]):
            ...
            the ad serves the descriptions will be selected
            from this list.
        images (Sequence[google.ads.googleads.v5.common.types.AdImageAsset]):
            List of image assets that may be displayed
            with the ad.
        youtube_videos (Sequence[google.ads.googleads.v5.common.types.AdVideoAsset]):
            List of YouTube video assets that may be
            displayed with the ad.
        html5_media_bundles (Sequence[google.ads.googleads.v5.common.types.AdMediaBundleAsset]):
...
class LegacyAppInstallAdInfo(proto.Message):
    ...
    Attributes:
        ...
        app_store (google.ads.googleads.v5.enums.types.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore):
...
class ResponsiveDisplayAdInfo(proto.Message):
    ...
    Attributes:
        marketing_images (Sequence[google.ads.googleads.v5.common.types.AdImageAsset]):
        ...
        square_marketing_images (Sequence[google.ads.googleads.v5.common.types.AdImageAsset]):
            ...
            the maximum is 15.
        logo_images (Sequence[google.ads.googleads.v5.common.types.AdImageAsset]):
            Logo images to be used in the ad. Valid image types are GIF,
            JPEG, and PNG. The minimum size is 512x128 and the aspect
            ratio must be 4:1 (+-1%). Combined with square_logo_images
            the maximum is 5.
        square_logo_images (Sequence[google.ads.googleads.v5.common.types.AdImageAsset]):
        ...
        long_headline (google.ads.googleads.v5.common.types.AdTextAsset):
...
class DisplayUploadAdInfo(proto.Message):
    ...
    Attributes:
        display_upload_product_type (google.ads.googleads.v5.enums.types.DisplayUploadProductTypeEnum.DisplayUploadProductType):
            The product type of this ad. See comments on
            the enum for details.
        media_bundle (google.ads.googleads.v5.common.types.AdMediaBundleAsset):
