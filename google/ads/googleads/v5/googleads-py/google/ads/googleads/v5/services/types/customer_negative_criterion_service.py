...
class MutateCustomerNegativeCriteriaRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v5.services.types.CustomerNegativeCriterionOperation]):
...
class CustomerNegativeCriterionOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v5.resources.types.CustomerNegativeCriterion):
...
class MutateCustomerNegativeCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateCustomerNegativeCriteriaResult]):
