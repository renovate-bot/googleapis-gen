...
class AdGroupCriterion(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v5.enums.types.AdGroupCriterionStatusEnum.AdGroupCriterionStatus):
            ...
            added.
        quality_info (google.ads.googleads.v5.resources.types.AdGroupCriterion.QualityInfo):
        ...
        system_serving_status (google.ads.googleads.v5.enums.types.CriterionSystemServingStatusEnum.CriterionSystemServingStatus):
            Output only. Serving status of the criterion.
        approval_status (google.ads.googleads.v5.enums.types.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus):
        ...
        effective_percent_cpc_bid_micros (int):
            ...
            amount.
        effective_cpc_bid_source (google.ads.googleads.v5.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPC bid.
        effective_cpm_bid_source (google.ads.googleads.v5.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPM bid.
        effective_cpv_bid_source (google.ads.googleads.v5.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPV bid.
        effective_percent_cpc_bid_source (google.ads.googleads.v5.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective Percent
            CPC bid.
        position_estimates (google.ads.googleads.v5.resources.types.AdGroupCriterion.PositionEstimates):
        ...
        listing_group (google.ads.googleads.v5.common.types.ListingGroupInfo):
        ...
        webpage (google.ads.googleads.v5.common.types.WebpageInfo):
            Immutable. Webpage
        app_payment_model (google.ads.googleads.v5.common.types.AppPaymentModelInfo):
            Immutable. App Payment Model.
        custom_affinity (google.ads.googleads.v5.common.types.CustomAffinityInfo):
            Immutable. Custom Affinity.
        custom_intent (google.ads.googleads.v5.common.types.CustomIntentInfo):
    ...
    class QualityInfo(proto.Message):
        ...
        Attributes:
            quality_score (int):
                ...
                value.
            creative_quality_score (google.ads.googleads.v5.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
                Output only. The performance of the ad
                compared to other advertisers.
            post_click_quality_score (google.ads.googleads.v5.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
                Output only. The quality score of the landing
                page.
            search_predicted_ctr (google.ads.googleads.v5.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
