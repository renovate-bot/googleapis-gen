...
class ClickViewServiceClient(metaclass=ClickViewServiceClientMeta):
    ...
    def click_view_path(customer: str,click_view: str,) -> str:
        ...
        return "customers/{customer}/clickViews/{click_view}".format(customer=customer, click_view=click_view, )

    @staticmethod
    def parse_click_view_path(path: str) -> Dict[str,str]:
        """Parse a click_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer>.+?)/clickViews/(?P<click_view>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def get_click_view(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetClickViewRequest`):
                The request object.
                Request message for
                [ClickViewService.GetClickView][google.ads.googleads.v5.services.ClickViewService.GetClickView].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.ClickView:
