...
class MediaFile(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v5.enums.types.MediaTypeEnum.MediaType):
        ...
        file_size (int):
            ...
            bytes.
        image (google.ads.googleads.v5.resources.types.MediaImage):
            Immutable. Encapsulates an Image.
        media_bundle (google.ads.googleads.v5.resources.types.MediaBundle):
            Immutable. A ZIP archive media the content of
            which contains HTML5 assets.
        audio (google.ads.googleads.v5.resources.types.MediaAudio):
            Output only. Encapsulates an Audio.
        video (google.ads.googleads.v5.resources.types.MediaVideo):
