...
class AdGroupSimulation(proto.Message):
    ...
    Attributes:
        ...
        cpc_bid_point_list (google.ads.googleads.v5.common.types.CpcBidSimulationPointList):
            ...
            CPC_BID.
        cpv_bid_point_list (google.ads.googleads.v5.common.types.CpvBidSimulationPointList):
            Output only. Simulation points if the simulation type is
            CPV_BID.
        target_cpa_point_list (google.ads.googleads.v5.common.types.TargetCpaSimulationPointList):
            Output only. Simulation points if the simulation type is
            TARGET_CPA.
        target_roas_point_list (google.ads.googleads.v5.common.types.TargetRoasSimulationPointList):
            Output only. Simulation points if the simulation type is
            TARGET_ROAS.
    """
