...
class ProductBiddingCategoryConstantServiceClient(metaclass=ProductBiddingCategoryConstantServiceClientMeta):
    ...
    def get_product_bidding_category_constant(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetProductBiddingCategoryConstantRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.ProductBiddingCategoryConstant:
