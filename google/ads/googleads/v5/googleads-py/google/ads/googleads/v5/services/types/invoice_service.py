...
class ListInvoicesRequest(proto.Message):
    ...
    Attributes:
        ...
        issue_month (google.ads.googleads.v5.enums.types.MonthOfYearEnum.MonthOfYear):
...
class ListInvoicesResponse(proto.Message):
    ...
    [InvoiceService.ListInvoices][google.ads.googleads.v5.services.InvoiceService.ListInvoices].

    Attributes:
        invoices (Sequence[google.ads.googleads.v5.resources.types.Invoice]):
