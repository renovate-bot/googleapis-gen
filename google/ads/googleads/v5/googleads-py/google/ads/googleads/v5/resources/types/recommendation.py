...
from google.ads.googleads.v5.enums.types import target_cpa_opt_in_recommendation_goal
...
class Recommendation(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v5.enums.types.RecommendationTypeEnum.RecommendationType):
        ...
        dismissed (google.protobuf.wrappers_pb2.BoolValue):
            ...
            dismissed or not.
        campaign_budget_recommendation (google.ads.googleads.v5.resources.types.Recommendation.CampaignBudgetRecommendation):
            Output only. The campaign budget
            recommendation.
        keyword_recommendation (google.ads.googleads.v5.resources.types.Recommendation.KeywordRecommendation):
            Output only. The keyword recommendation.
        text_ad_recommendation (google.ads.googleads.v5.resources.types.Recommendation.TextAdRecommendation):
            Output only. Add expanded text ad
            recommendation.
        target_cpa_opt_in_recommendation (google.ads.googleads.v5.resources.types.Recommendation.TargetCpaOptInRecommendation):
            Output only. The TargetCPA opt-in
            recommendation.
        maximize_conversions_opt_in_recommendation (google.ads.googleads.v5.resources.types.Recommendation.MaximizeConversionsOptInRecommendation):
            Output only. The MaximizeConversions Opt-In
            recommendation.
        enhanced_cpc_opt_in_recommendation (google.ads.googleads.v5.resources.types.Recommendation.EnhancedCpcOptInRecommendation):
            Output only. The Enhanced Cost-Per-Click Opt-
            n recommendation.
        search_partners_opt_in_recommendation (google.ads.googleads.v5.resources.types.Recommendation.SearchPartnersOptInRecommendation):
            Output only. The Search Partners Opt-In
            recommendation.
        maximize_clicks_opt_in_recommendation (google.ads.googleads.v5.resources.types.Recommendation.MaximizeClicksOptInRecommendation):
            Output only. The MaximizeClicks Opt-In
            recommendation.
        optimize_ad_rotation_recommendation (google.ads.googleads.v5.resources.types.Recommendation.OptimizeAdRotationRecommendation):
            Output only. The Optimize Ad Rotation
            recommendation.
        callout_extension_recommendation (google.ads.googleads.v5.resources.types.Recommendation.CalloutExtensionRecommendation):
            Output only. The Callout extension
            recommendation.
        sitelink_extension_recommendation (google.ads.googleads.v5.resources.types.Recommendation.SitelinkExtensionRecommendation):
            Output only. The Sitelink extension
            recommendation.
        call_extension_recommendation (google.ads.googleads.v5.resources.types.Recommendation.CallExtensionRecommendation):
            Output only. The Call extension
            recommendation.
        keyword_match_type_recommendation (google.ads.googleads.v5.resources.types.Recommendation.KeywordMatchTypeRecommendation):
            Output only. The keyword match type
            recommendation.
        move_unused_budget_recommendation (google.ads.googleads.v5.resources.types.Recommendation.MoveUnusedBudgetRecommendation):
            Output only. The move unused budget
            recommendation.
        target_roas_opt_in_recommendation (google.ads.googleads.v5.resources.types.Recommendation.TargetRoasOptInRecommendation):
    ...
    class RecommendationImpact(proto.Message):
        ...
        Attributes:
            base_metrics (google.ads.googleads.v5.resources.types.Recommendation.RecommendationMetrics):
                Output only. Base metrics at the time the
                recommendation was generated.
            potential_metrics (google.ads.googleads.v5.resources.types.Recommendation.RecommendationMetrics):
    ...
    class RecommendationMetrics(proto.Message):
        ...
        clicks = proto.Field(proto.MESSAGE, number=2,
            message=wrappers.DoubleValue,
        )
        cost_micros = proto.Field(proto.MESSAGE, number=3,
            message=wrappers.Int64Value,
        )
        conversions = proto.Field(proto.MESSAGE, number=4,
            message=wrappers.DoubleValue,
        )
        video_views = proto.Field(proto.MESSAGE, number=5,
            message=wrappers.DoubleValue,
        )
    ...
    class CampaignBudgetRecommendation(proto.Message):
        ...
        Attributes:
            ...
            recommended_budget_amount_micros (google.protobuf.wrappers_pb2.Int64Value):
                ...
                micros.
            budget_options (Sequence[google.ads.googleads.v5.resources.types.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption]):
        ...
        class CampaignBudgetRecommendationOption(proto.Message):
            ...
            budget_amount_micros = proto.Field(proto.MESSAGE, number=1,
                message=wrappers.Int64Value,
            )
        ...
        current_budget_amount_micros = proto.Field(proto.MESSAGE, number=1,
            message=wrappers.Int64Value,
        )
        recommended_budget_amount_micros = proto.Field(proto.MESSAGE, number=2,
            message=wrappers.Int64Value,
        )
    ...
    class KeywordRecommendation(proto.Message):
        ...
        recommended_cpc_bid_micros = proto.Field(proto.MESSAGE, number=2,
            message=wrappers.Int64Value,
        )
    ...
    class TextAdRecommendation(proto.Message):
        ...
        creation_date = proto.Field(proto.MESSAGE, number=2,
            message=wrappers.StringValue,
        )
        auto_apply_date = proto.Field(proto.MESSAGE, number=3,
            message=wrappers.StringValue,
        )
    ...
    class TargetCpaOptInRecommendation(proto.Message):
        ...
        class TargetCpaOptInRecommendationOption(proto.Message):
            ...
            target_cpa_micros = proto.Field(proto.MESSAGE, number=2,
                message=wrappers.Int64Value,
            )
            required_campaign_budget_amount_micros = proto.Field(proto.MESSAGE, number=3,
                message=wrappers.Int64Value,
            )
    ...
    class CallExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v5.common.types.CallFeedItem]):
    ...
    class MaximizeConversionsOptInRecommendation(proto.Message):
        ...
        recommended_budget_amount_micros = proto.Field(proto.MESSAGE, number=1,
            message=wrappers.Int64Value,
        )
    ...
    class CalloutExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v5.common.types.CalloutFeedItem]):
    ...
    class KeywordMatchTypeRecommendation(proto.Message):
        ...
        Attributes:
            ...
            recommended_match_type (google.ads.googleads.v5.enums.types.KeywordMatchTypeEnum.KeywordMatchType):
    ...
    class SitelinkExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v5.common.types.SitelinkFeedItem]):
    ...
    class MoveUnusedBudgetRecommendation(proto.Message):
        ...
        Attributes:
            ...
            budget_recommendation (google.ads.googleads.v5.resources.types.Recommendation.CampaignBudgetRecommendation):
                Output only. The recommendation for the
                constrained budget to increase.
        """

        excess_campaign_budget = proto.Field(proto.MESSAGE, number=1,
            message=wrappers.StringValue,
        )
    ...
    campaign = proto.Field(proto.MESSAGE, number=6,
        message=wrappers.StringValue,
    )
    ad_group = proto.Field(proto.MESSAGE, number=7,
        message=wrappers.StringValue,
    )
    dismissed = proto.Field(proto.MESSAGE, number=13,
