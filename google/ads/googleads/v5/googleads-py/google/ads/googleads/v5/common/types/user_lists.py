...
class CrmBasedUserListInfo(proto.Message):
    ...
    Attributes:
        ...
        upload_key_type (google.ads.googleads.v5.enums.types.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType):
            Matching key type of the list.
            Mixed data types are not allowed on the same
            list. This field is required for an ADD
            operation.
        data_source_type (google.ads.googleads.v5.enums.types.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType):
...
class UserListRuleInfo(proto.Message):
    ...
    Attributes:
        rule_type (google.ads.googleads.v5.enums.types.UserListRuleTypeEnum.UserListRuleType):
        ...
        rule_item_groups (Sequence[google.ads.googleads.v5.common.types.UserListRuleItemGroupInfo]):
...
class UserListRuleItemGroupInfo(proto.Message):
    ...
    Attributes:
        rule_items (Sequence[google.ads.googleads.v5.common.types.UserListRuleItemInfo]):
...
class UserListRuleItemInfo(proto.Message):
    ...
    Attributes:
        ...
        number_rule_item (google.ads.googleads.v5.common.types.UserListNumberRuleItemInfo):
            An atomic rule item composed of a number
            operation.
        string_rule_item (google.ads.googleads.v5.common.types.UserListStringRuleItemInfo):
            An atomic rule item composed of a string
            operation.
        date_rule_item (google.ads.googleads.v5.common.types.UserListDateRuleItemInfo):
...
class UserListDateRuleItemInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v5.enums.types.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator):
...
class UserListNumberRuleItemInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v5.enums.types.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator):
...
class UserListStringRuleItemInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v5.enums.types.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator):
...
class CombinedRuleUserListInfo(proto.Message):
    ...
    Attributes:
        left_operand (google.ads.googleads.v5.common.types.UserListRuleInfo):
            Left operand of the combined rule.
            This field is required and must be populated
            when creating new combined rule based user list.
        right_operand (google.ads.googleads.v5.common.types.UserListRuleInfo):
            Right operand of the combined rule.
            This field is required and must be populated
            when creating new combined rule based user list.
        rule_operator (google.ads.googleads.v5.enums.types.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator):
...
class DateSpecificRuleUserListInfo(proto.Message):
    ...
    Attributes:
        rule (google.ads.googleads.v5.common.types.UserListRuleInfo):
...
class RuleBasedUserListInfo(proto.Message):
    ...
    Attributes:
        prepopulation_status (google.ads.googleads.v5.enums.types.UserListPrepopulationStatusEnum.UserListPrepopulationStatus):
            ...
            request fails.
        combined_rule_user_list (google.ads.googleads.v5.common.types.CombinedRuleUserListInfo):
            ...
            is false.
        date_specific_rule_user_list (google.ads.googleads.v5.common.types.DateSpecificRuleUserListInfo):
        ...
        expression_rule_user_list (google.ads.googleads.v5.common.types.ExpressionRuleUserListInfo):
...
class LogicalUserListInfo(proto.Message):
    ...
    Attributes:
        rules (Sequence[google.ads.googleads.v5.common.types.UserListLogicalRuleInfo]):
...
class UserListLogicalRuleInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v5.enums.types.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator):
            The logical operator of the rule.
        rule_operands (Sequence[google.ads.googleads.v5.common.types.LogicalUserListOperandInfo]):
...
class BasicUserListInfo(proto.Message):
    ...
    Attributes:
        actions (Sequence[google.ads.googleads.v5.common.types.UserListActionInfo]):
