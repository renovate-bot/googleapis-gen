...
class GoogleAdsField(proto.Message):
    ...
    Attributes:
        ...
        category (google.ads.googleads.v5.enums.types.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory):
        ...
        data_type (google.ads.googleads.v5.enums.types.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType):
