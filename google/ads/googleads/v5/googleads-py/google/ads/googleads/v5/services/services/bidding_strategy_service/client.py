...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def get_bidding_strategy(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetBiddingStrategyRequest`):
                The request object.
                Request message for
                [BiddingStrategyService.GetBiddingStrategy][google.ads.googleads.v5.services.BiddingStrategyService.GetBiddingStrategy].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.BiddingStrategy:
                A bidding strategy.
        """
    ...
    def mutate_bidding_strategies(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateBiddingStrategiesRequest`):
                The request object.
                Request message for
                [BiddingStrategyService.MutateBiddingStrategies][google.ads.googleads.v5.services.BiddingStrategyService.MutateBiddingStrategies].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.BiddingStrategyOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateBiddingStrategiesResponse:
