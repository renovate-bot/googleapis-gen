...
from google.ads.googleads.v5.resources.types import campaign_criterion as gagr_campaign_criterion
...
class MutateCampaignCriteriaRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v5.services.types.CampaignCriterionOperation]):
...
class CampaignCriterionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v5.resources.types.CampaignCriterion):
            Create operation: No resource name is
            expected for the new criterion.
        update (google.ads.googleads.v5.resources.types.CampaignCriterion):
...
class MutateCampaignCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v5.services.types.MutateCampaignCriterionResult]):
...
class MutateCampaignCriterionResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_criterion (google.ads.googleads.v5.resources.types.CampaignCriterion):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    campaign_criterion = proto.Field(proto.MESSAGE, number=2,
        message=gagr_campaign_criterion.CampaignCriterion,
    )
