...
from google.ads.googleads.v5.common.types import explorer_auto_optimizer_setting as gagc_explorer_auto_optimizer_setting
...
class AdGroup(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v5.enums.types.AdGroupStatusEnum.AdGroupStatus):
            The status of the ad group.
        type_ (google.ads.googleads.v5.enums.types.AdGroupTypeEnum.AdGroupType):
            Immutable. The type of the ad group.
        ad_rotation_mode (google.ads.googleads.v5.enums.types.AdGroupAdRotationModeEnum.AdGroupAdRotationMode):
        ...
        percent_cpc_bid_micros (int):
            ...
            1,000,000 \* [fraction].
        explorer_auto_optimizer_setting (google.ads.googleads.v5.common.types.ExplorerAutoOptimizerSetting):
            Settings for the Display Campaign Optimizer,
            initially termed "Explorer".
        display_custom_bid_dimension (google.ads.googleads.v5.enums.types.TargetingDimensionEnum.TargetingDimension):
        ...
        effective_target_cpa_source (google.ads.googleads.v5.enums.types.BiddingSourceEnum.BiddingSource):
        ...
        effective_target_roas_source (google.ads.googleads.v5.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective target
