...
from google.ads.googleads.v5.services.services.account_budget_proposal_service import AccountBudgetProposalServiceClient
from google.ads.googleads.v5.services.services.account_budget_proposal_service import transports
from google.ads.googleads.v5.services.types import account_budget_proposal_service
...
def test__get_default_mtls_endpoint():
    ...
    assert AccountBudgetProposalServiceClient._get_default_mtls_endpoint(None) is None
    assert AccountBudgetProposalServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert AccountBudgetProposalServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert AccountBudgetProposalServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert AccountBudgetProposalServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert AccountBudgetProposalServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_account_budget_proposal_service_client_from_service_account_info():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        info = {"valid": True}
        client = AccountBudgetProposalServiceClient.from_service_account_info(info)
...
def test_account_budget_proposal_service_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        ...
        client = AccountBudgetProposalServiceClient.from_service_account_json("dummy/file/path.json")
        assert client.transport._credentials == creds

        assert client.transport._host == 'googleads.googleapis.com:443'


def test_account_budget_proposal_service_client_get_transport_class():
    transport = AccountBudgetProposalServiceClient.get_transport_class()
    assert transport == transports.AccountBudgetProposalServiceGrpcTransport

    transport = AccountBudgetProposalServiceClient.get_transport_class("grpc")
    assert transport == transports.AccountBudgetProposalServiceGrpcTransport


@mock.patch.object(AccountBudgetProposalServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AccountBudgetProposalServiceClient))
def test_account_budget_proposal_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.account_budget_proposal_service.AccountBudgetProposalServiceClient.get_transport_class') as gtc:
        client = AccountBudgetProposalServiceClient(transport="grpc")
        gtc.assert_called()

    # Check the case api_endpoint is provided.
    options = client_options.ClientOptions(api_endpoint="squid.clam.whelk")
    with mock.patch('google.ads.googleads.v5.services.services.account_budget_proposal_service.transports.AccountBudgetProposalServiceGrpcTransport.__init__') as grpc_transport:
        grpc_transport.return_value = None
        client = AccountBudgetProposalServiceClient(client_options=options)
...
def test_account_budget_proposal_service_client_mtls_env_auto(use_client_cert_env):
...
def test_account_budget_proposal_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v5.services.services.account_budget_proposal_service.transports.AccountBudgetProposalServiceGrpcTransport.__init__') as grpc_transport:
        grpc_transport.return_value = None
        client = AccountBudgetProposalServiceClient(
...
def test_get_account_budget_proposal_from_dict():
    test_get_account_budget_proposal(request_type=dict)
...
def test_mutate_account_budget_proposal_from_dict():
    test_mutate_account_budget_proposal(request_type=dict)
...
def test_transport_grpc_default():
    ...
    assert isinstance(
        client.transport,
        transports.AccountBudgetProposalServiceGrpcTransport,
    )
...
def test_account_budget_proposal_service_base_transport():
...
def test_account_budget_proposal_service_grpc_transport_channel():
...
@pytest.mark.parametrize("transport_class", [transports.AccountBudgetProposalServiceGrpcTransport])
def test_account_budget_proposal_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.AccountBudgetProposalServiceGrpcTransport,])
def test_account_budget_proposal_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_parse_common_billing_account_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountBudgetProposalServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountBudgetProposalServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountBudgetProposalServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountBudgetProposalServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountBudgetProposalServiceClient.parse_common_location_path(path)
    assert expected == actual
