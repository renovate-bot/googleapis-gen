...
from google.ads.googleads.v5.services.services.campaign_draft_service import CampaignDraftServiceClient
from google.ads.googleads.v5.services.services.campaign_draft_service import pagers
from google.ads.googleads.v5.services.services.campaign_draft_service import transports
...
def test_campaign_draft_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.campaign_draft_service.CampaignDraftServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v5.services.services.campaign_draft_service.transports.CampaignDraftServiceGrpcTransport.__init__') as grpc_transport:
...
def test_campaign_draft_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.campaign_draft_service.transports.CampaignDraftServiceTransport.__init__') as Transport:
...
def test_campaign_draft_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v5.services.services.campaign_draft_service.transports.CampaignDraftServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CampaignDraftServiceTransport()
        adc.assert_called_once()
