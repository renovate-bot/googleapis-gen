...
from google.ads.googleads.v5.services.services.topic_constant_service import TopicConstantServiceClient
from google.ads.googleads.v5.services.services.topic_constant_service import transports
...
def test_topic_constant_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.topic_constant_service.TopicConstantServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v5.services.services.topic_constant_service.transports.TopicConstantServiceGrpcTransport.__init__') as grpc_transport:
...
def test_topic_constant_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.topic_constant_service.transports.TopicConstantServiceTransport.__init__') as Transport:
...
def test_topic_constant_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v5.services.services.topic_constant_service.transports.TopicConstantServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.TopicConstantServiceTransport()
        adc.assert_called_once()
