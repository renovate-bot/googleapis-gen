...
from google.ads.googleads.v5.services.services.account_link_service import AccountLinkServiceClient
from google.ads.googleads.v5.services.services.account_link_service import transports
...
def test_account_link_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.account_link_service.transports.AccountLinkServiceGrpcTransport.__init__') as grpc_transport:
...
def test_mutate_account_link_flattened():
    ...
    with mock.patch.object(
        ...
        client.mutate_account_link(
            customer_id='customer_id_value',
            operation=account_link_service.AccountLinkOperation(remove='remove_value'),
        )
