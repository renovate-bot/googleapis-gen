...
from google.ads.googleads.v5.services.services.customer_service import CustomerServiceClient
from google.ads.googleads.v5.services.services.customer_service import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert CustomerServiceClient._get_default_mtls_endpoint(None) is None
    assert CustomerServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert CustomerServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert CustomerServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert CustomerServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert CustomerServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_customer_service_client_from_service_account_info():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        info = {"valid": True}
        client = CustomerServiceClient.from_service_account_info(info)
...
def test_customer_service_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        ...
        client = CustomerServiceClient.from_service_account_json("dummy/file/path.json")
        assert client.transport._credentials == creds

        assert client.transport._host == 'googleads.googleapis.com:443'


def test_customer_service_client_get_transport_class():
    transport = CustomerServiceClient.get_transport_class()
    assert transport == transports.CustomerServiceGrpcTransport

    transport = CustomerServiceClient.get_transport_class("grpc")
    assert transport == transports.CustomerServiceGrpcTransport


@mock.patch.object(CustomerServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CustomerServiceClient))
def test_customer_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.customer_service.CustomerServiceClient.get_transport_class') as gtc:
        client = CustomerServiceClient(transport="grpc")
        gtc.assert_called()

    # Check the case api_endpoint is provided.
    options = client_options.ClientOptions(api_endpoint="squid.clam.whelk")
    with mock.patch('google.ads.googleads.v5.services.services.customer_service.transports.CustomerServiceGrpcTransport.__init__') as grpc_transport:
        grpc_transport.return_value = None
        client = CustomerServiceClient(client_options=options)
...
def test_customer_service_client_mtls_env_auto(use_client_cert_env):
...
def test_customer_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v5.services.services.customer_service.transports.CustomerServiceGrpcTransport.__init__') as grpc_transport:
        grpc_transport.return_value = None
        client = CustomerServiceClient(
...
def test_mutate_customer_from_dict():
    test_mutate_customer(request_type=dict)
...
def test_mutate_customer_flattened():
    ...
    with mock.patch.object(
        ...
        client.mutate_customer(
            ...
            operation=customer_service.CustomerOperation(update=customer.Customer(resource_name='resource_name_value')),
        )
...
def test_list_accessible_customers(transport: str = 'grpc', request_type=customer_service.ListAccessibleCustomersRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_accessible_customers),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_accessible_customers_from_dict():
    test_list_accessible_customers(request_type=dict)
...
def test_create_customer_client_from_dict():
    test_create_customer_client(request_type=dict)
...
def test_create_customer_client_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_customer_client(
            customer_id='customer_id_value',
            customer_client=customer.Customer(resource_name='resource_name_value'),
        )
...
def test_transport_grpc_default():
    ...
    assert isinstance(
        client.transport,
        transports.CustomerServiceGrpcTransport,
    )
...
def test_customer_service_base_transport():
...
def test_customer_service_grpc_transport_channel():
...
@pytest.mark.parametrize("transport_class", [transports.CustomerServiceGrpcTransport])
def test_customer_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.CustomerServiceGrpcTransport,])
def test_customer_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_parse_conversion_action_path():
    ...
    actual = CustomerServiceClient.parse_conversion_action_path(path)
    assert expected == actual
...
def test_parse_customer_path():
    ...
    # Check that the path construction is reversible.
    actual = CustomerServiceClient.parse_customer_path(path)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    # Check that the path construction is reversible.
    actual = CustomerServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = CustomerServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = CustomerServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = CustomerServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = CustomerServiceClient.parse_common_location_path(path)
    assert expected == actual
