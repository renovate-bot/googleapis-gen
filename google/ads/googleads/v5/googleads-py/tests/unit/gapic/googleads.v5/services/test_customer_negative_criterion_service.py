...
from google.ads.googleads.v5.services.services.customer_negative_criterion_service import CustomerNegativeCriterionServiceClient
from google.ads.googleads.v5.services.services.customer_negative_criterion_service import transports
...
def test_customer_negative_criterion_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.customer_negative_criterion_service.CustomerNegativeCriterionServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v5.services.services.customer_negative_criterion_service.transports.CustomerNegativeCriterionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_customer_negative_criterion_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.customer_negative_criterion_service.transports.CustomerNegativeCriterionServiceTransport.__init__') as Transport:
...
def test_customer_negative_criterion_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v5.services.services.customer_negative_criterion_service.transports.CustomerNegativeCriterionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CustomerNegativeCriterionServiceTransport()
        adc.assert_called_once()
