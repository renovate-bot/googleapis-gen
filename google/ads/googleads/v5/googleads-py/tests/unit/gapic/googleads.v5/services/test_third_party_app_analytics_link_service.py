...
def test_third_party_app_analytics_link_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.third_party_app_analytics_link_service.transports.ThirdPartyAppAnalyticsLinkServiceGrpcTransport.__init__') as grpc_transport:
