...
from google.ads.googleads.v5.enums.types import offline_user_data_job_failure_reason
from google.ads.googleads.v5.enums.types import offline_user_data_job_status
from google.ads.googleads.v5.enums.types import offline_user_data_job_type
from google.ads.googleads.v5.resources.types import offline_user_data_job
from google.ads.googleads.v5.services.services.offline_user_data_job_service import OfflineUserDataJobServiceClient
from google.ads.googleads.v5.services.services.offline_user_data_job_service import transports
from google.ads.googleads.v5.services.types import offline_user_data_job_service
...
def test_offline_user_data_job_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.offline_user_data_job_service.OfflineUserDataJobServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v5.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_offline_user_data_job(transport: str = 'grpc', request_type=offline_user_data_job_service.GetOfflineUserDataJobRequest):
    ...
    with mock.patch.object(
        ...
        call.return_value = offline_user_data_job.OfflineUserDataJob(
            ...
            customer_match_user_list_metadata=offline_user_data.CustomerMatchUserListMetadata(user_list=wrappers_pb2.StringValue(value='value_value')),
        )
...
def test_add_offline_user_data_job_operations_flattened():
    ...
    with mock.patch.object(
        ...
        client.add_offline_user_data_job_operations(
            resource_name='resource_name_value',
            operations=[offline_user_data_job_service.OfflineUserDataJobOperation(create=offline_user_data.UserData(user_identifiers=[offline_user_data.UserIdentifier(hashed_email=wrappers_pb2.StringValue(value='value_value'))]))],
        )
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].resource_name == 'resource_name_value'
        assert args[0].operations == [offline_user_data_job_service.OfflineUserDataJobOperation(create=offline_user_data.UserData(user_identifiers=[offline_user_data.UserIdentifier(hashed_email=wrappers_pb2.StringValue(value='value_value'))]))]
...
def test_offline_user_data_job_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceTransport.__init__') as Transport:
...
def test_offline_user_data_job_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v5.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OfflineUserDataJobServiceTransport()
        adc.assert_called_once()
