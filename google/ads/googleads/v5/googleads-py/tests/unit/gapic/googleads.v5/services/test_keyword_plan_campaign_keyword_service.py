...
from google.ads.googleads.v5.services.services.keyword_plan_campaign_keyword_service import KeywordPlanCampaignKeywordServiceClient
from google.ads.googleads.v5.services.services.keyword_plan_campaign_keyword_service import transports
...
def test_keyword_plan_campaign_keyword_service_client_from_service_account_info():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        info = {"valid": True}
        client = KeywordPlanCampaignKeywordServiceClient.from_service_account_info(info)
...
def test_keyword_plan_campaign_keyword_service_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        ...
        client = KeywordPlanCampaignKeywordServiceClient.from_service_account_json("dummy/file/path.json")
        assert client.transport._credentials == creds
...
def test_keyword_plan_campaign_keyword_service_client_client_options():
    # Check that if channel is provided we won't create a new one.
    with mock.patch('google.ads.googleads.v5.services.services.keyword_plan_campaign_keyword_service.KeywordPlanCampaignKeywordServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v5.services.services.keyword_plan_campaign_keyword_service.KeywordPlanCampaignKeywordServiceClient.get_transport_class') as gtc:
        client = KeywordPlanCampaignKeywordServiceClient(transport="grpc")
        gtc.assert_called()

    # Check the case api_endpoint is provided.
    options = client_options.ClientOptions(api_endpoint="squid.clam.whelk")
    with mock.patch('google.ads.googleads.v5.services.services.keyword_plan_campaign_keyword_service.transports.KeywordPlanCampaignKeywordServiceGrpcTransport.__init__') as grpc_transport:
        grpc_transport.return_value = None
        client = KeywordPlanCampaignKeywordServiceClient(client_options=options)
...
def test_keyword_plan_campaign_keyword_service_client_mtls_env_auto(use_client_cert_env):
...
def test_get_keyword_plan_campaign_keyword_from_dict():
    test_get_keyword_plan_campaign_keyword(request_type=dict)
...
def test_mutate_keyword_plan_campaign_keywords_from_dict():
    test_mutate_keyword_plan_campaign_keywords(request_type=dict)
...
def test_keyword_plan_campaign_keyword_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.keyword_plan_campaign_keyword_service.transports.KeywordPlanCampaignKeywordServiceTransport.__init__') as Transport:
...
def test_keyword_plan_campaign_keyword_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v5.services.services.keyword_plan_campaign_keyword_service.transports.KeywordPlanCampaignKeywordServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.KeywordPlanCampaignKeywordServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.KeywordPlanCampaignKeywordServiceGrpcTransport])
...
def test_keyword_plan_campaign_path():
    ...
    actual = KeywordPlanCampaignKeywordServiceClient.keyword_plan_campaign_path(customer, keyword_plan_campaign)
...
def test_keyword_plan_campaign_keyword_path():
    customer = "oyster"
    keyword_plan_campaign_keyword = "nudibranch"
    ...
    actual = KeywordPlanCampaignKeywordServiceClient.keyword_plan_campaign_keyword_path(customer, keyword_plan_campaign_keyword)
    assert expected == actual
...
def test_parse_keyword_plan_campaign_keyword_path():
    expected = {
        "customer": "cuttlefish",
        "keyword_plan_campaign_keyword": "mussel",
    }
