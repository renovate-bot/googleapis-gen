...
from google.ads.googleads.v5.services.services.extension_feed_item_service import ExtensionFeedItemServiceClient
from google.ads.googleads.v5.services.services.extension_feed_item_service import transports
...
def test_extension_feed_item_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.extension_feed_item_service.ExtensionFeedItemServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v5.services.services.extension_feed_item_service.transports.ExtensionFeedItemServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_extension_feed_item(transport: str = 'grpc', request_type=extension_feed_item_service.GetExtensionFeedItemRequest):
    ...
    with mock.patch.object(
        ...
        call.return_value = extension_feed_item.ExtensionFeedItem(
            ...
            sitelink_feed_item=extensions.SitelinkFeedItem(link_text=wrappers_pb2.StringValue(value='value_value')),
            targeted_campaign=wrappers_pb2.StringValue(value='value_value'),
        )
...
def test_extension_feed_item_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.extension_feed_item_service.transports.ExtensionFeedItemServiceTransport.__init__') as Transport:
...
def test_extension_feed_item_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v5.services.services.extension_feed_item_service.transports.ExtensionFeedItemServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ExtensionFeedItemServiceTransport()
        adc.assert_called_once()
