...
def test_campaign_label_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.campaign_label_service.transports.CampaignLabelServiceGrpcTransport.__init__') as grpc_transport:
