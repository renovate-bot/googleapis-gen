...
from google.ads.googleads.v5.services.services.campaign_shared_set_service import transports
...
def test_campaign_shared_set_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.campaign_shared_set_service.transports.CampaignSharedSetServiceGrpcTransport.__init__') as grpc_transport:
