...
from google.ads.googleads.v5.services.services.reach_plan_service import ReachPlanServiceClient
from google.ads.googleads.v5.services.services.reach_plan_service import transports
...
def test_reach_plan_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.reach_plan_service.ReachPlanServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v5.services.services.reach_plan_service.transports.ReachPlanServiceGrpcTransport.__init__') as grpc_transport:
...
def test_list_plannable_products_flattened():
    ...
    with mock.patch.object(
        ...
        client.list_plannable_products(
            plannable_location_id=wrappers_pb2.StringValue(value='value_value'),
        )
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0].plannable_location_id == wrappers_pb2.StringValue(value='value_value')
...
def test_generate_product_mix_ideas_flattened():
    ...
    with mock.patch.object(
        ...
        assert args[0].plannable_location_id == wrappers_pb2.StringValue(value='value_value')
        assert args[0].currency_code == wrappers_pb2.StringValue(value='value_value')
...
def test_generate_reach_forecast_flattened():
    ...
    with mock.patch.object(
        ...
        client.generate_reach_forecast(
            customer_id='customer_id_value',
            campaign_duration=reach_plan_service.CampaignDuration(duration_in_days=wrappers_pb2.Int32Value(value=541)),
            planned_products=[reach_plan_service.PlannedProduct(plannable_product_code=wrappers_pb2.StringValue(value='value_value'))],
        )
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].customer_id == 'customer_id_value'
        assert args[0].campaign_duration == reach_plan_service.CampaignDuration(duration_in_days=wrappers_pb2.Int32Value(value=541))
        assert args[0].planned_products == [reach_plan_service.PlannedProduct(plannable_product_code=wrappers_pb2.StringValue(value='value_value'))]
...
def test_reach_plan_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.reach_plan_service.transports.ReachPlanServiceTransport.__init__') as Transport:
...
def test_reach_plan_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v5.services.services.reach_plan_service.transports.ReachPlanServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ReachPlanServiceTransport()
        adc.assert_called_once()
