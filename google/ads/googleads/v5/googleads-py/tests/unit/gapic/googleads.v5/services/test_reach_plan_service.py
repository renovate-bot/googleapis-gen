...
def test_list_plannable_products_flattened():
    ...
    with mock.patch.object(
        ...
        client.list_plannable_products(
            plannable_location_id=wrappers.StringValue(value='value_value'),
        )
...
def test_generate_product_mix_ideas_flattened():
    ...
    with mock.patch.object(
        ...
        client.generate_product_mix_ideas(
            ...
            plannable_location_id=wrappers.StringValue(value='value_value'),
            currency_code=wrappers.StringValue(value='value_value'),
            budget_micros=wrappers.Int64Value(value=541),
        )
...
def test_generate_reach_forecast_flattened():
    ...
    with mock.patch.object(
        ...
        client.generate_reach_forecast(
            customer_id='customer_id_value',
            campaign_duration=reach_plan_service.CampaignDuration(duration_in_days=wrappers.Int32Value(value=541)),
            planned_products=[reach_plan_service.PlannedProduct(plannable_product_code=wrappers.StringValue(value='value_value'))],
        )
...
def test_reach_plan_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.ads.googleads.v5.services.services.reach_plan_service.transports.ReachPlanServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ReachPlanServiceTransport()
        adc.assert_called_once()
