...
from google.ads.googleads.v5.services.services.batch_job_service import BatchJobServiceClient
from google.ads.googleads.v5.services.services.batch_job_service import pagers
from google.ads.googleads.v5.services.services.batch_job_service import transports
...
def test_batch_job_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.batch_job_service.BatchJobServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v5.services.services.batch_job_service.transports.BatchJobServiceGrpcTransport.__init__') as grpc_transport:
...
def test_batch_job_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v5.services.services.batch_job_service.transports.BatchJobServiceTransport.__init__') as Transport:
...
def test_batch_job_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v5.services.services.batch_job_service.transports.BatchJobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BatchJobServiceTransport()
        adc.assert_called_once()
...
def test_campaign_asset_path():
    ...
    actual = BatchJobServiceClient.campaign_asset_path(customer, campaign_asset)
    assert expected == actual
...
def test_customer_extension_setting_path():
    customer = "scallop"
    customer_extension_setting = "abalone"
...
def test_keyword_plan_ad_group_path():
    customer = "oyster"
    keyword_plan_ad_group = "nudibranch"
...
def test_keyword_plan_ad_group_keyword_path():
    customer = "winkle"
    keyword_plan_ad_group_keyword = "nautilus"
