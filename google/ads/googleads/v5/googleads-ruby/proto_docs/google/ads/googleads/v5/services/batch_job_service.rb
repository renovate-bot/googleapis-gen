...
module Google
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for {::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client#mutate_batch_job BatchJobService.MutateBatchJob}.
          ...
          # Response message for {::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client#mutate_batch_job BatchJobService.MutateBatchJob}.
          # @!attribute [rw] result
          #   @return [::Google::Ads::GoogleAds::V5::Services::MutateBatchJobResult]
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client#get_batch_job BatchJobService.GetBatchJob}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client#run_batch_job BatchJobService.RunBatchJob}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client#add_batch_job_operations BatchJobService.AddBatchJobOperations}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          ...
          # Response message for {::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client#add_batch_job_operations BatchJobService.AddBatchJobOperations}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client#list_batch_job_results BatchJobService.ListBatchJobResults}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          ...
          # Response message for {::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client#list_batch_job_results BatchJobService.ListBatchJobResults}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::BatchJobResult>]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Services::MutateOperationResponse]
