    ...
    module GoogleAds
      module V5
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::FeedItemTargetTypeEnum::FeedItemTargetType]
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V5::Enums::FeedItemTargetStatusEnum::FeedItemTargetStatus]
          ...
          # @!attribute [rw] device
          #   @return [::Google::Ads::GoogleAds::V5::Enums::FeedItemTargetDeviceEnum::FeedItemTargetDevice]
          #     Immutable. The targeted device.
          # @!attribute [rw] ad_schedule
          #   @return [::Google::Ads::GoogleAds::V5::Common::AdScheduleInfo]
