...
module Google
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for {::Google::Ads::GoogleAds::V5::Services::BiddingStrategyService::Client#get_bidding_strategy BiddingStrategyService.GetBiddingStrategy}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::BiddingStrategyService::Client#mutate_bidding_strategies BiddingStrategyService.MutateBiddingStrategies}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose bidding strategies are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::BiddingStrategyOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::MutateBiddingStrategyResult>]
