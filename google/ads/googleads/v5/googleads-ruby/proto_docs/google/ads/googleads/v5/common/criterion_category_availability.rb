    ...
    module GoogleAds
      module V5
        module Common
          ...
          # @!attribute [rw] locale
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::CriterionCategoryLocaleAvailability>]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::CriterionCategoryChannelAvailabilityModeEnum::CriterionCategoryChannelAvailabilityMode]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType>]
          ...
          # @!attribute [rw] availability_mode
          #   @return [::Google::Ads::GoogleAds::V5::Enums::CriterionCategoryLocaleAvailabilityModeEnum::CriterionCategoryLocaleAvailabilityMode]
