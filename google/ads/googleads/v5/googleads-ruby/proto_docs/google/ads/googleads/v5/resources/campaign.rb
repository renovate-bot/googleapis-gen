    ...
    module GoogleAds
      module V5
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V5::Enums::CampaignStatusEnum::CampaignStatus]
          #     The status of the campaign.
          #
          #     When a new campaign is added, the status defaults to ENABLED.
          # @!attribute [r] serving_status
          #   @return [::Google::Ads::GoogleAds::V5::Enums::CampaignServingStatusEnum::CampaignServingStatus]
          #     Output only. The ad serving status of the campaign.
          # @!attribute [rw] ad_serving_optimization_status
          #   @return [::Google::Ads::GoogleAds::V5::Enums::AdServingOptimizationStatusEnum::AdServingOptimizationStatus]
          #     The ad serving optimization status of the campaign.
          # @!attribute [rw] advertising_channel_type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::AdvertisingChannelTypeEnum::AdvertisingChannelType]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::CampaignExperimentTypeEnum::CampaignExperimentType]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::BiddingStrategyTypeEnum::BiddingStrategyType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::FrequencyCapEntry>]
          #     A list that limits how often each user will see this campaign's ads.
          # @!attribute [r] video_brand_safety_suitability
          #   @return [::Google::Ads::GoogleAds::V5::Enums::BrandSafetySuitabilityEnum::BrandSafetySuitability]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::PaymentModeEnum::PaymentMode]
