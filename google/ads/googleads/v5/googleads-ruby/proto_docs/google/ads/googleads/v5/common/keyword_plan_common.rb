    ...
    module GoogleAds
      module V5
        module Common
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::MonthlySearchVolume>]
          #     Approximate number of searches on this query for the past twelve months.
          # @!attribute [rw] competition
          #   @return [::Google::Ads::GoogleAds::V5::Enums::KeywordPlanCompetitionLevelEnum::KeywordPlanCompetitionLevel]
