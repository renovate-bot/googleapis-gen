...
module Google
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for {::Google::Ads::GoogleAds::V5::Services::MediaFileService::Client#get_media_file MediaFileService.GetMediaFile}
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::MediaFileService::Client#mutate_media_files MediaFileService.MutateMediaFiles}
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose media files are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::MediaFileOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::MutateMediaFileResult>]
