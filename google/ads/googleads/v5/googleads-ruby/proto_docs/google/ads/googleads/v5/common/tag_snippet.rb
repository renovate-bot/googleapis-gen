    ...
    module GoogleAds
      module V5
        module Common
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::TrackingCodeTypeEnum::TrackingCodeType]
          #     The type of the generated tag snippets for tracking conversions.
          # @!attribute [rw] page_format
          #   @return [::Google::Ads::GoogleAds::V5::Enums::TrackingCodePageFormatEnum::TrackingCodePageFormat]
