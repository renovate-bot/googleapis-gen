...
module Google
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CampaignLabelService::Client#get_campaign_label CampaignLabelService.GetCampaignLabel}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CampaignLabelService::Client#mutate_campaign_labels CampaignLabelService.MutateCampaignLabels}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose campaign-label relationships are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::CampaignLabelOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::MutateCampaignLabelResult>]
