    ...
    module GoogleAds
      module V5
        module Resources
          ...
          #     conversion actions.
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ConversionActionStatusEnum::ConversionActionStatus]
          #     The status of this conversion action for conversion event accrual.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ConversionActionTypeEnum::ConversionActionType]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Resources::ConversionAction::ValueSettings]
          #     Settings related to the value for conversion events associated with this
          #     conversion action.
          # @!attribute [rw] counting_type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ConversionActionCountingTypeEnum::ConversionActionCountingType]
          #     How to count conversion events for the conversion action.
          # @!attribute [rw] attribution_model_settings
          #   @return [::Google::Ads::GoogleAds::V5::Resources::ConversionAction::AttributionModelSettings]
          #     Settings related to this conversion action's attribution model.
          # @!attribute [r] tag_snippets
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::TagSnippet>]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::MobileAppVendorEnum::MobileAppVendor]
          #     Output only. Mobile app vendor for an app conversion action.
          # @!attribute [r] firebase_settings
          #   @return [::Google::Ads::GoogleAds::V5::Resources::ConversionAction::FirebaseSettings]
          #     Output only. Firebase settings for Firebase conversion types.
          # @!attribute [r] third_party_app_analytics_settings
          #   @return [::Google::Ads::GoogleAds::V5::Resources::ConversionAction::ThirdPartyAppAnalyticsSettings]
          ...
          class ConversionAction
            ...
            #   @return [::Google::Ads::GoogleAds::V5::Enums::AttributionModelEnum::AttributionModel]
            #     The attribution model type of this conversion action.
            # @!attribute [r] data_driven_model_status
            #   @return [::Google::Ads::GoogleAds::V5::Enums::DataDrivenModelStatusEnum::DataDrivenModelStatus]
