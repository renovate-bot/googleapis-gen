...
module Google
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for {::Google::Ads::GoogleAds::V5::Services::GeoTargetConstantService::Client#get_geo_target_constant GeoTargetConstantService.GetGeoTargetConstant}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V5::Services::GeoTargetConstantService::Client#suggest_geo_target_constants GeoTargetConstantService.SuggestGeoTargetConstants}.
          # @!attribute [rw] locale
          #   @return [::String]
          ...
          # Response message for {::Google::Ads::GoogleAds::V5::Services::GeoTargetConstantService::Client#suggest_geo_target_constants GeoTargetConstantService.SuggestGeoTargetConstants}.
          # @!attribute [rw] geo_target_constant_suggestions
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::GeoTargetConstantSuggestion>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Resources::GeoTargetConstant>]
