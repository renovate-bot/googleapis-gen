    ...
    module GoogleAds
      module V5
        module Common
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::CallConversionReportingStateEnum::CallConversionReportingState]
          ...
          # A Gmail ad.
          # @!attribute [rw] teaser
          #   @return [::Google::Ads::GoogleAds::V5::Common::GmailTeaser]
          #     The Gmail teaser.
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Common::DisplayCallToAction]
          #     Display-call-to-action of the marketing image.
          # @!attribute [rw] product_images
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::ProductImage>]
          #     Product images. Up to 15 images are supported.
          # @!attribute [rw] product_videos
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::ProductVideo>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::AdTextAsset>]
          ...
          # @!attribute [rw] videos
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::AdVideoAsset>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::AdImageAsset>]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::DisplayAdFormatSettingEnum::DisplayAdFormatSetting]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Common::AdTextAsset]
          #     Mandatory ad text.
          # @!attribute [rw] headlines
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::AdTextAsset>]
          #     List of text assets for headlines. When the ad serves the headlines will
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::AdMediaBundleAsset>]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::LegacyAppInstallAdAppStoreEnum::LegacyAppInstallAdAppStore]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::DisplayUploadProductTypeEnum::DisplayUploadProductType]
          #     The product type of this ad. See comments on the enum for details.
          # @!attribute [rw] media_bundle
          #   @return [::Google::Ads::GoogleAds::V5::Common::AdMediaBundleAsset]
