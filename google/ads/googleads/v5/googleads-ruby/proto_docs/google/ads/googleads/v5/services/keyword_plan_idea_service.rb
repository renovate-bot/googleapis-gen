...
module Google
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for {::Google::Ads::GoogleAds::V5::Services::KeywordPlanIdeaService::Client#generate_keyword_ideas KeywordPlanIdeaService.GenerateKeywordIdeas}.
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::KeywordPlanNetworkEnum::KeywordPlanNetwork]
          #     Targeting network.
          # @!attribute [rw] keyword_and_url_seed
          #   @return [::Google::Ads::GoogleAds::V5::Services::KeywordAndUrlSeed]
          #     A Keyword and a specific Url to generate ideas from
          #     e.g. cars, www.example.com/cars.
          # @!attribute [rw] keyword_seed
          #   @return [::Google::Ads::GoogleAds::V5::Services::KeywordSeed]
          #     A Keyword or phrase to generate ideas from, e.g. cars.
          # @!attribute [rw] url_seed
          #   @return [::Google::Ads::GoogleAds::V5::Services::UrlSeed]
          #     A specific url to generate ideas from, e.g. www.example.com/cars.
          # @!attribute [rw] site_seed
          #   @return [::Google::Ads::GoogleAds::V5::Services::SiteSeed]
          ...
          # Response message for {::Google::Ads::GoogleAds::V5::Services::KeywordPlanIdeaService::Client#generate_keyword_ideas KeywordPlanIdeaService.GenerateKeywordIdeas}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::GenerateKeywordIdeaResult>]
