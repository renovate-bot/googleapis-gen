    ...
    module GoogleAds
      module V5
        module Common
          ...
          #     at any time.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::PolicyTopicEntryTypeEnum::PolicyTopicEntryType]
          #     Describes the negative or positive effect this policy will have on serving.
          # @!attribute [rw] evidences
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::PolicyTopicEvidence>]
          #     Additional information that explains policy finding
          #     (e.g. the brand name for a trademark finding).
          # @!attribute [rw] constraints
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::PolicyTopicConstraint>]
          ...
          class PolicyTopicEvidence
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V5::Enums::PolicyTopicEvidenceDestinationMismatchUrlTypeEnum::PolicyTopicEvidenceDestinationMismatchUrlType>]
            ...
            # @!attribute [rw] device
            #   @return [::Google::Ads::GoogleAds::V5::Enums::PolicyTopicEvidenceDestinationNotWorkingDeviceEnum::PolicyTopicEvidenceDestinationNotWorkingDevice]
            ...
            #   @return [::Google::Ads::GoogleAds::V5::Enums::PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum::PolicyTopicEvidenceDestinationNotWorkingDnsErrorType]
          ...
          class PolicyTopicConstraint
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::PolicyTopicConstraint::CountryConstraint>]
