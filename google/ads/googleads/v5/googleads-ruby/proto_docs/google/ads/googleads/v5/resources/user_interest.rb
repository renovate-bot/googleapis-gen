    ...
    module GoogleAds
      module V5
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::UserInterestTaxonomyTypeEnum::UserInterestTaxonomyType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::CriterionCategoryAvailability>]
