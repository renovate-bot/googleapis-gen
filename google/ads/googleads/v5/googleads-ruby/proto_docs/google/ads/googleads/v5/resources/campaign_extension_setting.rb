    ...
    module GoogleAds
      module V5
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ExtensionTypeEnum::ExtensionType]
          ...
          # @!attribute [rw] device
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ExtensionSettingDeviceEnum::ExtensionSettingDevice]
