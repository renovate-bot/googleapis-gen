    ...
    module GoogleAds
      module V5
        module Common
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::PreferredContentTypeEnum::PreferredContentType]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ListingGroupTypeEnum::ListingGroupType]
          #     Type of the listing group.
          # @!attribute [rw] case_value
          #   @return [::Google::Ads::GoogleAds::V5::Common::ListingDimensionInfo]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::ListingDimensionInfo>]
          ...
          # @!attribute [rw] level
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ProductBiddingCategoryLevelEnum::ProductBiddingCategoryLevel]
          ...
          # @!attribute [rw] index
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ProductCustomAttributeIndexEnum::ProductCustomAttributeIndex]
          ...
          #     Value of the type.
          # @!attribute [rw] level
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ProductTypeLevelEnum::ProductTypeLevel]
          #     Level of the type.
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::InteractionTypeEnum::InteractionType]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::MinuteOfHourEnum::MinuteOfHour]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::AgeRangeTypeEnum::AgeRangeType]
          ...
          # A gender criterion.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::GenderTypeEnum::GenderType]
          #     Type of the gender.
          class GenderInfo
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::IncomeRangeTypeEnum::IncomeRangeType]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ParentalStatusTypeEnum::ParentalStatusType]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Common::GeoPointInfo]
          #     Latitude and longitude.
          # @!attribute [rw] radius
          #   @return [::Float]
          #     The radius of the proximity.
          # @!attribute [rw] radius_units
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ProximityRadiusUnitsEnum::ProximityRadiusUnits]
          #     The unit of measurement of the radius. Default is KILOMETERS.
          # @!attribute [rw] address
          #   @return [::Google::Ads::GoogleAds::V5::Common::AddressInfo]
          #     Full address.
          class ProximityInfo
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::ContentLabelTypeEnum::ContentLabelType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Common::WebpageConditionInfo>]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::WebpageConditionOperandEnum::WebpageConditionOperand]
          #     Operand of webpage targeting condition.
          # @!attribute [rw] operator
          #   @return [::Google::Ads::GoogleAds::V5::Enums::WebpageConditionOperatorEnum::WebpageConditionOperator]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::AppPaymentModelTypeEnum::AppPaymentModelType]
          ...
          #     This is required and must be set in CREATE operations.
          # @!attribute [rw] radius_units
          #   @return [::Google::Ads::GoogleAds::V5::Enums::LocationGroupRadiusUnitsEnum::LocationGroupRadiusUnits]
