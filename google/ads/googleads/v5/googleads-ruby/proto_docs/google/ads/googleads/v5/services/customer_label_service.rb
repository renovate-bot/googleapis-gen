...
module Google
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CustomerLabelService::Client#get_customer_label CustomerLabelService.GetCustomerLabel}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CustomerLabelService::Client#mutate_customer_labels CustomerLabelService.MutateCustomerLabels}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose customer-label relationships are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::CustomerLabelOperation>]
          ...
          # @!attribute [rw] create
          #   @return [::Google::Ads::GoogleAds::V5::Resources::CustomerLabel]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::MutateCustomerLabelResult>]
