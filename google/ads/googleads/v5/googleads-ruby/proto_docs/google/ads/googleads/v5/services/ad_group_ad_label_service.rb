...
module Google
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for {::Google::Ads::GoogleAds::V5::Services::AdGroupAdLabelService::Client#get_ad_group_ad_label AdGroupAdLabelService.GetAdGroupAdLabel}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::AdGroupAdLabelService::Client#mutate_ad_group_ad_labels AdGroupAdLabelService.MutateAdGroupAdLabels}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose ad group ad labels are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::AdGroupAdLabelOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::MutateAdGroupAdLabelResult>]
