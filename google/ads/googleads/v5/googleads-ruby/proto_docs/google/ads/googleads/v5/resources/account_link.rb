    ...
    module GoogleAds
      module V5
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V5::Enums::AccountLinkStatusEnum::AccountLinkStatus]
          #     The status of the link.
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::LinkedAccountTypeEnum::LinkedAccountType]
