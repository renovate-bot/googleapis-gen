...
module Google
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CustomerService::Client#get_customer CustomerService.GetCustomer}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CustomerService::Client#mutate_customer CustomerService.MutateCustomer}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CustomerService::Client#create_customer_client CustomerService.CreateCustomerClient}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::AccessRoleEnum::AccessRole]
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CustomerService::Client#list_accessible_customers CustomerService.ListAccessibleCustomers}.
          class ListAccessibleCustomersRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end

          # Response message for {::Google::Ads::GoogleAds::V5::Services::CustomerService::Client#list_accessible_customers CustomerService.ListAccessibleCustomers}.
