    ...
    module GoogleAds
      module V5
        module Resources
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::OfflineUserDataJobTypeEnum::OfflineUserDataJobType]
          #     Immutable. Type of the job.
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V5::Enums::OfflineUserDataJobStatusEnum::OfflineUserDataJobStatus]
          #     Output only. Status of the job.
          # @!attribute [r] failure_reason
          #   @return [::Google::Ads::GoogleAds::V5::Enums::OfflineUserDataJobFailureReasonEnum::OfflineUserDataJobFailureReason]
