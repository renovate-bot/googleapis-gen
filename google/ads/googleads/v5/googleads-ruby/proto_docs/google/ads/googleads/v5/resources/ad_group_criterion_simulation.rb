    ...
    module GoogleAds
      module V5
        module Resources
          ...
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::SimulationTypeEnum::SimulationType]
          #     Output only. The field that the simulation modifies.
          # @!attribute [r] modification_method
          #   @return [::Google::Ads::GoogleAds::V5::Enums::SimulationModificationMethodEnum::SimulationModificationMethod]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Common::PercentCpcBidSimulationPointList]
