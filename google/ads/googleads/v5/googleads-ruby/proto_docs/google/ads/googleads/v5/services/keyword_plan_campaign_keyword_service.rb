  ...
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V5::Services::KeywordPlanCampaignKeywordService::Client#get_keyword_plan_campaign_keyword KeywordPlanCampaignKeywordService.GetKeywordPlanCampaignKeyword}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V5::Services::KeywordPlanCampaignKeywordService::Client#mutate_keyword_plan_campaign_keywords KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaign keywords are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::KeywordPlanCampaignKeywordOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::MutateKeywordPlanCampaignKeywordResult>]
