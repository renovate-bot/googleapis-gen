    ...
    module GoogleAds
      module V5
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V5::Enums::CustomInterestStatusEnum::CustomInterestStatus]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::CustomInterestTypeEnum::CustomInterestType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Resources::CustomInterestMember>]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Enums::CustomInterestMemberTypeEnum::CustomInterestMemberType]
