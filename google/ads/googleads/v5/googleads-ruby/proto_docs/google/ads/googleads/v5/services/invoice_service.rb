    ...
    module GoogleAds
      module V5
        module Services
          ...
          # Response message for {::Google::Ads::GoogleAds::V5::Services::InvoiceService::Client#list_invoices InvoiceService.ListInvoices}.
          # @!attribute [rw] invoices
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Resources::Invoice>]
