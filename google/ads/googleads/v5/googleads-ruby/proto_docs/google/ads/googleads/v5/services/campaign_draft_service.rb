...
module Google
  module Ads
    module GoogleAds
      module V5
        module Services
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CampaignDraftService::Client#get_campaign_draft CampaignDraftService.GetCampaignDraft}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CampaignDraftService::Client#mutate_campaign_drafts CampaignDraftService.MutateCampaignDrafts}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaign drafts are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::CampaignDraftOperation>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CampaignDraftService::Client#promote_campaign_draft CampaignDraftService.PromoteCampaignDraft}.
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Services::MutateCampaignDraftResult>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V5::Services::CampaignDraftService::Client#list_campaign_draft_async_errors CampaignDraftService.ListCampaignDraftAsyncErrors}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          ...
          # Response message for {::Google::Ads::GoogleAds::V5::Services::CampaignDraftService::Client#list_campaign_draft_async_errors CampaignDraftService.ListCampaignDraftAsyncErrors}.
          # @!attribute [rw] errors
