    ...
    module GoogleAds
      module V5
        module Resources
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Resources::FeedAttribute>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V5::Resources::FeedAttributeOperation>]
          #     The list of operations changing the feed attributes. Attributes can only
          #     be added, not removed.
          # @!attribute [rw] origin
          #   @return [::Google::Ads::GoogleAds::V5::Enums::FeedOriginEnum::FeedOrigin]
          #     Immutable. Specifies who manages the FeedAttributes for the Feed.
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V5::Enums::FeedStatusEnum::FeedStatus]
          #     Output only. Status of the feed.
          #     This field is read-only.
          # @!attribute [rw] places_location_feed_data
          #   @return [::Google::Ads::GoogleAds::V5::Resources::Feed::PlacesLocationFeedData]
          #     Data used to configure a location feed populated from Google My Business
          #     Locations.
          # @!attribute [rw] affiliate_location_feed_data
          #   @return [::Google::Ads::GoogleAds::V5::Resources::Feed::AffiliateLocationFeedData]
          ...
          class Feed
            ...
            #   @return [::Google::Ads::GoogleAds::V5::Enums::AffiliateLocationFeedRelationshipTypeEnum::AffiliateLocationFeedRelationshipType]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V5::Enums::FeedAttributeTypeEnum::FeedAttributeType]
          ...
          #   @return [::Google::Ads::GoogleAds::V5::Resources::FeedAttributeOperation::Operator]
