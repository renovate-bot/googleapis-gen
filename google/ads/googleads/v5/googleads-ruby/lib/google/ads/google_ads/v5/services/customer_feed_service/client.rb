...
require "google/ads/googleads/v5/services/customer_feed_service_pb"
        ...
        module Services
          module CustomerFeedService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V5::Services::CustomerFeedService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # ## Example
              #
              # To modify the configuration for all CustomerFeedService clients:
              #
              #     ::Google::Ads::GoogleAds::V5::Services::CustomerFeedService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # ## Examples
              #
              # To create a new CustomerFeedService client with the default
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V5::Services::CustomerFeedService::Client.new
              #
              # To create a new CustomerFeedService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V5::Services::CustomerFeedService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v5/services/customer_feed_service_services_pb"
                ...
                @customer_feed_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V5::Services::CustomerFeedService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::GetCustomerFeedRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::GetCustomerFeedRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V5::Resources::CustomerFeed]
              ...
              def get_customer_feed request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::GetCustomerFeedRequest
                ...
                @customer_feed_service_stub.call_rpc :get_customer_feed, request, options: options do |response, operation|
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::MutateCustomerFeedsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::MutateCustomerFeedsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V5::Services::CustomerFeedOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V5::Services::MutateCustomerFeedsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_customer_feeds request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::MutateCustomerFeedsRequest
                ...
                @customer_feed_service_stub.call_rpc :mutate_customer_feeds, request, options: options do |response, operation|
                  yield response, operation if block_given?
                  return response
                end
                # rescue GRPC::BadStatus => grpc_error
              ...
              # {::Google::Ads::GoogleAds::V5::Services::CustomerFeedService::Client::Configuration::Rpcs}
              ...
              # # Examples
              #
              # To modify the global config, setting the timeout for get_customer_feed
