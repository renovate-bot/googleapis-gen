...
require 'google/ads/googleads/v5/enums/interaction_event_type_pb'
require 'google/ads/googleads/v5/enums/quality_score_bucket_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v5/common/metrics.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v5.common.Metrics" do
      ...
      optional :historical_creative_quality_score, :enum, 80, "google.ads.googleads.v5.enums.QualityScoreBucketEnum.QualityScoreBucket"
      optional :historical_landing_page_quality_score, :enum, 81, "google.ads.googleads.v5.enums.QualityScoreBucketEnum.QualityScoreBucket"
      proto3_optional :historical_quality_score, :int64, 216
      optional :historical_search_predicted_ctr, :enum, 83, "google.ads.googleads.v5.enums.QualityScoreBucketEnum.QualityScoreBucket"
      ...
      repeated :interaction_event_types, :enum, 100, "google.ads.googleads.v5.enums.InteractionEventTypeEnum.InteractionEventType"
...
module Google
  module Ads
    module GoogleAds
      module V5
        module Common
          Metrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.common.Metrics").msgclass
        end
      end
    end
  end
