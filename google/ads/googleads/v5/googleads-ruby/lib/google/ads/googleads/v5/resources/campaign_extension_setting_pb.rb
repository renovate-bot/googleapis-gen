...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v5/resources/campaign_extension_setting.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v5.resources.CampaignExtensionSetting" do
...
module Google
  module Ads
    module GoogleAds
      module V5
        module Resources
          CampaignExtensionSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.resources.CampaignExtensionSetting").msgclass
        end
      end
    end
  end
