...
require "google/ads/googleads/v5/services/batch_job_service_pb"
        ...
        module Services
          module BatchJobService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # ## Example
              #
              # To modify the configuration for all BatchJobService clients:
              #
              #     ::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # ## Examples
              #
              # To create a new BatchJobService client with the default
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client.new
              #
              # To create a new BatchJobService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v5/services/batch_job_service_services_pb"
                ...
                @batch_job_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V5::Services::BatchJobService::Stub,
              ...
              #
              # @return [::Google::Ads::GoogleAds::V5::Services::BatchJobService::Operations]
              #
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::MutateBatchJobRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::MutateBatchJobRequest, ::Hash]
              ...
              #   @param operation [::Google::Ads::GoogleAds::V5::Services::BatchJobOperation, ::Hash]
              #     Required. The operation to perform on an individual batch job.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V5::Services::MutateBatchJobResponse]
              ...
              def mutate_batch_job request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::MutateBatchJobRequest
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::GetBatchJobRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::GetBatchJobRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V5::Resources::BatchJob]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def get_batch_job request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::GetBatchJobRequest
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::ListBatchJobResultsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::ListBatchJobResultsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload list_batch_job_results(resource_name: nil, page_token: nil, page_size: nil)
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V5::Services::BatchJobResult>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V5::Services::BatchJobResult>]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def list_batch_job_results request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::ListBatchJobResultsRequest
                ...
                @batch_job_service_stub.call_rpc :list_batch_job_results, request, options: options do |response, operation|
                  response = ::Gapic::PagedEnumerable.new @batch_job_service_stub, :list_batch_job_results, request, response, operation, options
                  yield response, operation if block_given?
                  return response
                end
                # rescue GRPC::BadStatus => grpc_error
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::RunBatchJobRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::RunBatchJobRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def run_batch_job request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::RunBatchJobRequest
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::AddBatchJobOperationsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::AddBatchJobOperationsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #     response.
              #   @param mutate_operations [::Array<::Google::Ads::GoogleAds::V5::Services::MutateOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V5::Services::AddBatchJobOperationsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def add_batch_job_operations request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::AddBatchJobOperationsRequest
                ...
                @batch_job_service_stub.call_rpc :add_batch_job_operations, request, options: options do |response, operation|
                  yield response, operation if block_given?
                  return response
                end
                # rescue GRPC::BadStatus => grpc_error
              ...
              # {::Google::Ads::GoogleAds::V5::Services::BatchJobService::Client::Configuration::Rpcs}
              ...
              # # Examples
              #
              # To modify the global config, setting the timeout for mutate_batch_job
              ...
              class Configuration
                ...
                class Rpcs
                  ...
                  ##
                  # RPC-specific configuration for `get_batch_job`
                  # @return [::Gapic::Config::Method]
                  #
                  attr_reader :get_batch_job
                  ##
