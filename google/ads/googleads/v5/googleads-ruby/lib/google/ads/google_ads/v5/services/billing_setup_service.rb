...
require "google/ads/google_ads/v5/services/billing_setup_service/credentials"
require "google/ads/google_ads/v5/services/billing_setup_service/paths"
require "google/ads/google_ads/v5/services/billing_setup_service/client"
    ...
    module GoogleAds
      module V5
        module Services
          ...
          #     client = ::Google::Ads::GoogleAds::V5::Services::BillingSetupService::Client.new
          #
...
helper_path = ::File.join __dir__, "billing_setup_service", "helpers.rb"
require "google/ads/google_ads/v5/services/billing_setup_service/helpers" if ::File.file? helper_path
