        ...
        module Services
          module GoogleAdsService
            ...
            module Paths
              ...
              #
              # @param customer [String]
              # @param batch_job [String]
              #
              # @return [::String]
              def batch_job_path customer:, batch_job:
                raise ::ArgumentError, "customer cannot contain /" if customer.to_s.include? "/"
              ...
              #
              # @param customer [String]
              # @param income_range_view [String]
              #
              # @return [::String]
              def income_range_view_path customer:, income_range_view:
                raise ::ArgumentError, "customer cannot contain /" if customer.to_s.include? "/"
              ...
              #
              # @param customer [String]
              # @param keyword_plan_ad_group_keyword [String]
              #
              # @return [::String]
              def keyword_plan_ad_group_keyword_path customer:, keyword_plan_ad_group_keyword:
                raise ::ArgumentError, "customer cannot contain /" if customer.to_s.include? "/"
              ...
              #
              # @param customer [String]
              # @param keyword_plan_campaign_keyword [String]
              #
              # @return [::String]
              def keyword_plan_campaign_keyword_path customer:, keyword_plan_campaign_keyword:
                raise ::ArgumentError, "customer cannot contain /" if customer.to_s.include? "/"
              ...
              #
              # @return [::String]
              def offline_user_data_job_path customer:, offline_user_data_job:
                raise ::ArgumentError, "customer cannot contain /" if customer.to_s.include? "/"
