...
public interface AccountBudgetProposalOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v5.resources.AccountBudgetProposal)
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v5.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType proposal_type = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v5.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus status = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v5.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus getStatus();
   ...
   */
  com.google.ads.googleads.v5.enums.TimeTypeEnum.TimeType getProposedStartTimeType();
   ...
   */
  com.google.ads.googleads.v5.enums.TimeTypeEnum.TimeType getProposedEndTimeType();
   ...
   */
  com.google.ads.googleads.v5.enums.TimeTypeEnum.TimeType getApprovedEndTimeType();
   ...
   */
  com.google.ads.googleads.v5.enums.SpendingLimitTypeEnum.SpendingLimitType getProposedSpendingLimitType();
   ...
   */
  com.google.ads.googleads.v5.enums.SpendingLimitTypeEnum.SpendingLimitType getApprovedSpendingLimitType();

  public com.google.ads.googleads.v5.resources.AccountBudgetProposal.ProposedStartTimeCase getProposedStartTimeCase();

  public com.google.ads.googleads.v5.resources.AccountBudgetProposal.ProposedEndTimeCase getProposedEndTimeCase();

  public com.google.ads.googleads.v5.resources.AccountBudgetProposal.ApprovedEndTimeCase getApprovedEndTimeCase();

  public com.google.ads.googleads.v5.resources.AccountBudgetProposal.ProposedSpendingLimitCase getProposedSpendingLimitCase();

  public com.google.ads.googleads.v5.resources.AccountBudgetProposal.ApprovedSpendingLimitCase getApprovedSpendingLimitCase();
}
