...
public class MerchantCenterLinkName implements ResourceName {
  private static final PathTemplate CUSTOMER_MERCHANT_CENTER_LINK =
  ...
  public static MerchantCenterLinkName of(String customer, String merchantCenterLink) {
    return newBuilder().setCustomer(customer).setMerchantCenterLink(merchantCenterLink).build();
  }
  ...
  public static MerchantCenterLinkName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_MERCHANT_CENTER_LINK.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return CUSTOMER_MERCHANT_CENTER_LINK.matches(formattedString);
  }
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (merchantCenterLink != null) {
            fieldMapBuilder.put("merchant_center_link", merchantCenterLink);
          }
  ...
  public String toString() {
    return CUSTOMER_MERCHANT_CENTER_LINK.instantiate(
        "customer", customer, "merchant_center_link", merchantCenterLink);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.customer, that.customer)
          && Objects.equals(this.merchantCenterLink, that.merchantCenterLink);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(merchantCenterLink);
    return h;
  }

  /** Builder for customers/{customer}/merchantCenterLinks/{merchant_center_link}. */
