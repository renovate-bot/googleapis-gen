...
public class LocationViewName implements ResourceName {
  private static final PathTemplate CUSTOMER_LOCATION_VIEW =
  ...
  public static LocationViewName of(String customer, String locationView) {
    return newBuilder().setCustomer(customer).setLocationView(locationView).build();
  }

  public static String format(String customer, String locationView) {
    return newBuilder().setCustomer(customer).setLocationView(locationView).build().toString();
  }
  ...
  public static LocationViewName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CUSTOMER_LOCATION_VIEW.validatedMatch(
            formattedString, "LocationViewName.parse: formattedString not in valid format");
  ...
  public static boolean isParsableFrom(String formattedString) {
    return CUSTOMER_LOCATION_VIEW.matches(formattedString);
  }
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (locationView != null) {
            fieldMapBuilder.put("location_view", locationView);
          }
  ...
  public String toString() {
    return CUSTOMER_LOCATION_VIEW.instantiate("customer", customer, "location_view", locationView);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.customer, that.customer)
          && Objects.equals(this.locationView, that.locationView);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(locationView);
    return h;
  }

  /** Builder for customers/{customer}/locationViews/{location_view}. */
