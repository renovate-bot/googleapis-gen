  ...
  public void getProductBiddingCategoryConstantTest() throws Exception {
    ProductBiddingCategoryConstant expectedResponse =
        ProductBiddingCategoryConstant.newBuilder()
            ...
            .setProductBiddingCategoryConstantParent(StringValue.newBuilder().build())
            .setLanguageCode(StringValue.newBuilder().build())
            .setLocalizedName(StringValue.newBuilder().build())
            .build();
