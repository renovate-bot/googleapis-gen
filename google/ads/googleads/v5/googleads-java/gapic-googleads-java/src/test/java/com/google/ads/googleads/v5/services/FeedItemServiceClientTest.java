...
import com.google.ads.googleads.v5.resources.FeedItemName;
import com.google.ads.googleads.v5.resources.FeedItemPlaceholderPolicyInfo;
...
public class FeedItemServiceClientTest {
  ...
  public void getFeedItemTest() throws Exception {
    FeedItem expectedResponse =
        FeedItem.newBuilder()
            .setResourceName(FeedItemName.of("[CUSTOMER]", "[FEED_ITEM]").toString())
            .setFeed(StringValue.newBuilder().build())
            .setId(Int64Value.newBuilder().build())
            .setStartDateTime(StringValue.newBuilder().build())
            .setEndDateTime(StringValue.newBuilder().build())
