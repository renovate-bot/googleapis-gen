...
import static com.google.ads.googleads.v5.services.CampaignExperimentServiceClient.ListCampaignExperimentAsyncErrorsPagedResponse;

import com.google.ads.googleads.v5.resources.CampaignExperiment;
import com.google.ads.googleads.v5.resources.CampaignExperimentName;
  ...
  public void getCampaignExperimentTest() throws Exception {
    CampaignExperiment expectedResponse =
        CampaignExperiment.newBuilder()
            ...
            .setCampaignDraft(StringValue.newBuilder().build())
            .setName(StringValue.newBuilder().build())
            .setDescription(StringValue.newBuilder().build())
            .setTrafficSplitPercent(Int64Value.newBuilder().build())
            .setExperimentCampaign(StringValue.newBuilder().build())
            .setLongRunningOperation(StringValue.newBuilder().build())
            .setStartDate(StringValue.newBuilder().build())
            .setEndDate(StringValue.newBuilder().build())
            .build();
