...
import com.google.ads.googleads.v5.common.CriterionCategoryAvailability;
import com.google.ads.googleads.v5.resources.UserInterest;
import com.google.ads.googleads.v5.resources.UserInterestName;
  ...
  public void getUserInterestTest() throws Exception {
    UserInterest expectedResponse =
        UserInterest.newBuilder()
            ...
            .setUserInterestId(Int64Value.newBuilder().build())
            .setName(StringValue.newBuilder().build())
            .setUserInterestParent(StringValue.newBuilder().build())
            .setLaunchedToAll(BoolValue.newBuilder().build())
