...
import com.google.ads.googleads.v5.resources.CampaignBidModifierName;
import com.google.ads.googleads.v5.services.stub.CampaignBidModifierServiceStub;
import com.google.ads.googleads.v5.services.stub.CampaignBidModifierServiceStubSettings;
...
public class CampaignBidModifierServiceClient implements BackgroundResource {
   ...
   *     CampaignBidModifierServiceClient.create()) {
   *   String resourceName =
   *       CampaignBidModifierName.of("[CUSTOMER]", "[CAMPAIGN_BID_MODIFIER]").toString();
   *   CampaignBidModifier response =
   *       campaignBidModifierServiceClient.getCampaignBidModifier(resourceName);
   * }
   * }</pre>
