...
import com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstantName;
import com.google.ads.googleads.v5.services.stub.ProductBiddingCategoryConstantServiceStub;
import com.google.ads.googleads.v5.services.stub.ProductBiddingCategoryConstantServiceStubSettings;
...
public class ProductBiddingCategoryConstantServiceClient implements BackgroundResource {
   ...
   *     ProductBiddingCategoryConstantServiceClient.create()) {
   *   String resourceName =
   *       ProductBiddingCategoryConstantName.of("[PRODUCT_BIDDING_CATEGORY_CONSTANT]").toString();
   *   ProductBiddingCategoryConstant response =
   *       productBiddingCategoryConstantServiceClient.getProductBiddingCategoryConstant(
   *           resourceName);
   * }
