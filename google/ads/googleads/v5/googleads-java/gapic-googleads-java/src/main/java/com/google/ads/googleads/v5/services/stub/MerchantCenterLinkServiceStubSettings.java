...
import com.google.ads.googleads.v5.services.GetMerchantCenterLinkRequest;
...
import com.google.ads.googleads.v5.services.MutateMerchantCenterLinkRequest;
...
/**
 * Settings class to configure an instance of {@link MerchantCenterLinkServiceStub}.
 *
 ...
 *
 * <pre>{@code
 * MerchantCenterLinkServiceStubSettings.Builder merchantCenterLinkServiceSettingsBuilder =
 *     MerchantCenterLinkServiceStubSettings.newBuilder();
 ...
 *             .build());
 * MerchantCenterLinkServiceStubSettings merchantCenterLinkServiceSettings =
...
public class MerchantCenterLinkServiceStubSettings
  ...
  private final UnaryCallSettings<ListMerchantCenterLinksRequest, ListMerchantCenterLinksResponse>
      listMerchantCenterLinksSettings;
  private final UnaryCallSettings<GetMerchantCenterLinkRequest, MerchantCenterLink>
      getMerchantCenterLinkSettings;
  private final UnaryCallSettings<MutateMerchantCenterLinkRequest, MutateMerchantCenterLinkResponse>
  ...
  public UnaryCallSettings<ListMerchantCenterLinksRequest, ListMerchantCenterLinksResponse>
      listMerchantCenterLinksSettings() {
    return listMerchantCenterLinksSettings;
  }
  ...
  public UnaryCallSettings<GetMerchantCenterLinkRequest, MerchantCenterLink>
      getMerchantCenterLinkSettings() {
    return getMerchantCenterLinkSettings;
  }
  ...
  public UnaryCallSettings<MutateMerchantCenterLinkRequest, MutateMerchantCenterLinkResponse>
      mutateMerchantCenterLinkSettings() {
    return mutateMerchantCenterLinkSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(MerchantCenterLinkServiceStubSettings.class))
        .setTransportToken(
  ...
  protected MerchantCenterLinkServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    listMerchantCenterLinksSettings = settingsBuilder.listMerchantCenterLinksSettings().build();
    getMerchantCenterLinkSettings = settingsBuilder.getMerchantCenterLinkSettings().build();
    mutateMerchantCenterLinkSettings = settingsBuilder.mutateMerchantCenterLinkSettings().build();
  }

  /** Builder for MerchantCenterLinkServiceStubSettings. */
  public static class Builder
    ...
    private final UnaryCallSettings.Builder<
        ...
        listMerchantCenterLinksSettings;
    private final UnaryCallSettings.Builder<GetMerchantCenterLinkRequest, MerchantCenterLink>
        getMerchantCenterLinkSettings;
    private final UnaryCallSettings.Builder<
    ...
    protected Builder(ClientContext clientContext) {
      ...
      listMerchantCenterLinksSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      getMerchantCenterLinkSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      mutateMerchantCenterLinkSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(MerchantCenterLinkServiceStubSettings settings) {
      ...
      listMerchantCenterLinksSettings = settings.listMerchantCenterLinksSettings.toBuilder();
      getMerchantCenterLinkSettings = settings.getMerchantCenterLinkSettings.toBuilder();
      mutateMerchantCenterLinkSettings = settings.mutateMerchantCenterLinkSettings.toBuilder();
