...
import com.google.ads.googleads.v5.resources.ManagedPlacementViewName;
import com.google.ads.googleads.v5.services.stub.ManagedPlacementViewServiceStub;
import com.google.ads.googleads.v5.services.stub.ManagedPlacementViewServiceStubSettings;
...
public class ManagedPlacementViewServiceClient implements BackgroundResource {
   ...
   * calls. This is for advanced usage - prefer using create(ManagedPlacementViewServiceSettings).
   */
   ...
   *     ManagedPlacementViewServiceClient.create()) {
   *   String resourceName =
   *       ManagedPlacementViewName.of("[CUSTOMER]", "[MANAGED_PLACEMENT_VIEW]").toString();
   *   ManagedPlacementView response =
   *       managedPlacementViewServiceClient.getManagedPlacementView(resourceName);
   * }
   * }</pre>
