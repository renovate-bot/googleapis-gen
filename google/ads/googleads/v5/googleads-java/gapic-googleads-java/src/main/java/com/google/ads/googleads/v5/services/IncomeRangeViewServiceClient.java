...
import com.google.ads.googleads.v5.resources.IncomeRangeViewName;
...
public class IncomeRangeViewServiceClient implements BackgroundResource {
   ...
   * try (IncomeRangeViewServiceClient incomeRangeViewServiceClient =
   *     IncomeRangeViewServiceClient.create()) {
   *   String resourceName = IncomeRangeViewName.of("[CUSTOMER]", "[INCOME_RANGE_VIEW]").toString();
   *   IncomeRangeView response = incomeRangeViewServiceClient.getIncomeRangeView(resourceName);
   * }
   * }</pre>
   *
   ...
   *       GetIncomeRangeViewRequest.newBuilder()
   *           .setResourceName(
   *               IncomeRangeViewName.of("[CUSTOMER]", "[INCOME_RANGE_VIEW]").toString())
   *           .build();
