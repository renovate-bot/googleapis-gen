...
import com.google.ads.googleads.v5.resources.AdGroupAdAssetViewName;
import com.google.ads.googleads.v5.services.stub.AdGroupAdAssetViewServiceStub;
import com.google.ads.googleads.v5.services.stub.AdGroupAdAssetViewServiceStubSettings;
...
public class AdGroupAdAssetViewServiceClient implements BackgroundResource {
   ...
   *               AdGroupAdAssetViewName.of("[CUSTOMER]", "[AD_GROUP_AD_ASSET_VIEW]").toString())
   *           .build();
   *   ApiFuture<AdGroupAdAssetView> future =
   *       adGroupAdAssetViewServiceClient.getAdGroupAdAssetViewCallable().futureCall(request);
   *   // Do something.
