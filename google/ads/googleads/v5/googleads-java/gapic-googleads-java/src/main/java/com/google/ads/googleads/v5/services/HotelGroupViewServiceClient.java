...
import com.google.ads.googleads.v5.resources.HotelGroupViewName;
import com.google.ads.googleads.v5.services.stub.HotelGroupViewServiceStub;
import com.google.ads.googleads.v5.services.stub.HotelGroupViewServiceStubSettings;
...
public class HotelGroupViewServiceClient implements BackgroundResource {
   ...
   * try (HotelGroupViewServiceClient hotelGroupViewServiceClient =
   *     HotelGroupViewServiceClient.create()) {
   *   String resourceName = HotelGroupViewName.of("[CUSTOMER]", "[HOTEL_GROUP_VIEW]").toString();
   *   HotelGroupView response = hotelGroupViewServiceClient.getHotelGroupView(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetHotelGroupViewRequest request =
   *       GetHotelGroupViewRequest.newBuilder()
   *           .setResourceName(HotelGroupViewName.of("[CUSTOMER]", "[HOTEL_GROUP_VIEW]").toString())
   *           .build();
   ...
   *           .setResourceName(HotelGroupViewName.of("[CUSTOMER]", "[HOTEL_GROUP_VIEW]").toString())
   *           .build();
   *   ApiFuture<HotelGroupView> future =
   *       hotelGroupViewServiceClient.getHotelGroupViewCallable().futureCall(request);
   *   // Do something.
