...
import com.google.ads.googleads.v5.resources.ShoppingPerformanceView;
import com.google.ads.googleads.v5.resources.ShoppingPerformanceViewName;
import com.google.ads.googleads.v5.services.stub.ShoppingPerformanceViewServiceStub;
import com.google.ads.googleads.v5.services.stub.ShoppingPerformanceViewServiceStubSettings;
...
public class ShoppingPerformanceViewServiceClient implements BackgroundResource {
   ...
   * try (ShoppingPerformanceViewServiceClient shoppingPerformanceViewServiceClient =
   *     ShoppingPerformanceViewServiceClient.create()) {
   *   String resourceName = ShoppingPerformanceViewName.of("[CUSTOMER]").toString();
   *   ShoppingPerformanceView response =
   *       shoppingPerformanceViewServiceClient.getShoppingPerformanceView(resourceName);
   * }
   * }</pre>
   ...
   *   GetShoppingPerformanceViewRequest request =
   *       GetShoppingPerformanceViewRequest.newBuilder()
   *           .setResourceName(ShoppingPerformanceViewName.of("[CUSTOMER]").toString())
   *           .build();
   *   ShoppingPerformanceView response =
   *       shoppingPerformanceViewServiceClient.getShoppingPerformanceView(request);
   * }
   * }</pre>
   *
   ...
   *           .setResourceName(ShoppingPerformanceViewName.of("[CUSTOMER]").toString())
   *           .build();
   *   ApiFuture<ShoppingPerformanceView> future =
