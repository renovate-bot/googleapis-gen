...
import com.google.ads.googleads.v5.resources.CustomerManagerLinkName;
import com.google.ads.googleads.v5.services.stub.CustomerManagerLinkServiceStub;
...
public class CustomerManagerLinkServiceClient implements BackgroundResource {
   ...
   *     CustomerManagerLinkServiceClient.create()) {
   *   String resourceName =
   *       CustomerManagerLinkName.of("[CUSTOMER]", "[CUSTOMER_MANAGER_LINK]").toString();
   *   CustomerManagerLink response =
   *       customerManagerLinkServiceClient.getCustomerManagerLink(resourceName);
   * }
   * }</pre>
