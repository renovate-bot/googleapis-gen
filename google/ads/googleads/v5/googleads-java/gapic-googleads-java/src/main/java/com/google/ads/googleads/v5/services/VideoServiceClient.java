...
import com.google.ads.googleads.v5.resources.VideoName;
import com.google.ads.googleads.v5.services.stub.VideoServiceStub;
import com.google.ads.googleads.v5.services.stub.VideoServiceStubSettings;
...
public class VideoServiceClient implements BackgroundResource {
   ...
   * <pre>{@code
   * try (VideoServiceClient videoServiceClient = VideoServiceClient.create()) {
   *   String resourceName = VideoName.of("[CUSTOMER]", "[VIDEO]").toString();
   *   Video response = videoServiceClient.getVideo(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetVideoRequest request =
   *       GetVideoRequest.newBuilder()
   *           .setResourceName(VideoName.of("[CUSTOMER]", "[VIDEO]").toString())
   *           .build();
