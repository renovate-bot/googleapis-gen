...
import com.google.ads.googleads.v5.resources.ProductGroupViewName;
import com.google.ads.googleads.v5.services.stub.ProductGroupViewServiceStub;
...
public class ProductGroupViewServiceClient implements BackgroundResource {
   ...
   *     ProductGroupViewServiceClient.create()) {
   *   String resourceName =
   *       ProductGroupViewName.of("[CUSTOMER]", "[PRODUCT_GROUP_VIEW]").toString();
   *   ProductGroupView response = productGroupViewServiceClient.getProductGroupView(resourceName);
   * }
   * }</pre>
   *
