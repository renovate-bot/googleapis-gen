...
import com.google.ads.googleads.v5.resources.UserLocationViewName;
import com.google.ads.googleads.v5.services.stub.UserLocationViewServiceStub;
import com.google.ads.googleads.v5.services.stub.UserLocationViewServiceStubSettings;
...
public class UserLocationViewServiceClient implements BackgroundResource {
   ...
   *     UserLocationViewServiceClient.create()) {
   *   String resourceName =
   *       UserLocationViewName.of("[CUSTOMER]", "[USER_LOCATION_VIEW]").toString();
   *   UserLocationView response = userLocationViewServiceClient.getUserLocationView(resourceName);
   * }
   * }</pre>
   *
