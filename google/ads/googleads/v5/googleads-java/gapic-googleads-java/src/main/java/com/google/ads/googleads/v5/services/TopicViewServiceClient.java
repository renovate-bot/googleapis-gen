...
import com.google.ads.googleads.v5.resources.TopicView;
import com.google.ads.googleads.v5.resources.TopicViewName;
import com.google.ads.googleads.v5.services.stub.TopicViewServiceStub;
import com.google.ads.googleads.v5.services.stub.TopicViewServiceStubSettings;
...
public class TopicViewServiceClient implements BackgroundResource {
   ...
   * <pre>{@code
   * try (TopicViewServiceClient topicViewServiceClient = TopicViewServiceClient.create()) {
   *   String resourceName = TopicViewName.of("[CUSTOMER]", "[TOPIC_VIEW]").toString();
   *   TopicView response = topicViewServiceClient.getTopicView(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetTopicViewRequest request =
   *       GetTopicViewRequest.newBuilder()
   *           .setResourceName(TopicViewName.of("[CUSTOMER]", "[TOPIC_VIEW]").toString())
   *           .build();
