...
import com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant;
import com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest;
...
/**
 * Settings class to configure an instance of {@link OperatingSystemVersionConstantServiceStub}.
 *
 ...
 *
 * <pre>{@code
 * OperatingSystemVersionConstantServiceStubSettings.Builder
 ...
 *             .build());
 * OperatingSystemVersionConstantServiceStubSettings
...
public class OperatingSystemVersionConstantServiceStubSettings
    ...
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            ...
            GaxProperties.getLibraryVersion(
                OperatingSystemVersionConstantServiceStubSettings.class))
        .setTransportToken(
  ...
  protected OperatingSystemVersionConstantServiceStubSettings(Builder settingsBuilder)
      throws IOException {
    super(settingsBuilder);

    getOperatingSystemVersionConstantSettings =
        settingsBuilder.getOperatingSystemVersionConstantSettings().build();
  }

  /** Builder for OperatingSystemVersionConstantServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<OperatingSystemVersionConstantServiceStubSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getOperatingSystemVersionConstantSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(OperatingSystemVersionConstantServiceStubSettings settings) {
      super(settings);

      getOperatingSystemVersionConstantSettings =
          settings.getOperatingSystemVersionConstantSettings.toBuilder();
    ...
    @Override
    public OperatingSystemVersionConstantServiceStubSettings build() throws IOException {
      return new OperatingSystemVersionConstantServiceStubSettings(this);
    }
  }
}
