...
import com.google.ads.googleads.v5.resources.LocationViewName;
import com.google.ads.googleads.v5.services.stub.LocationViewServiceStub;
import com.google.ads.googleads.v5.services.stub.LocationViewServiceStubSettings;
...
public class LocationViewServiceClient implements BackgroundResource {
   ...
   * This is for advanced usage - prefer using create(LocationViewServiceSettings).
   */
   ...
   * <pre>{@code
   * try (LocationViewServiceClient locationViewServiceClient = LocationViewServiceClient.create()) {
   *   String resourceName = LocationViewName.of("[CUSTOMER]", "[LOCATION_VIEW]").toString();
   *   LocationView response = locationViewServiceClient.getLocationView(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetLocationViewRequest request =
   *       GetLocationViewRequest.newBuilder()
   *           .setResourceName(LocationViewName.of("[CUSTOMER]", "[LOCATION_VIEW]").toString())
   *           .build();
