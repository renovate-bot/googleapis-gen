...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/operating_system_version_constant_service.proto")
public final class OperatingSystemVersionConstantServiceGrpc {

  private OperatingSystemVersionConstantServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.OperatingSystemVersionConstantService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest,
      com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant> getGetOperatingSystemVersionConstantMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetOperatingSystemVersionConstant",
      requestType = com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest.class,
      responseType = com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest,
      com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant> getGetOperatingSystemVersionConstantMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest, com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant> getGetOperatingSystemVersionConstantMethod;
      ...
      synchronized (OperatingSystemVersionConstantServiceGrpc.class) {
        if ((getGetOperatingSystemVersionConstantMethod = OperatingSystemVersionConstantServiceGrpc.getGetOperatingSystemVersionConstantMethod) == null) {
          OperatingSystemVersionConstantServiceGrpc.getGetOperatingSystemVersionConstantMethod = getGetOperatingSystemVersionConstantMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest, com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetOperatingSystemVersionConstant"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant.getDefaultInstance()))
  ...
  public static abstract class OperatingSystemVersionConstantServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getOperatingSystemVersionConstant(com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest,
                com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant>(
  ...
  public static final class OperatingSystemVersionConstantServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<OperatingSystemVersionConstantServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant getOperatingSystemVersionConstant(com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest request) {
  ...
  public static final class OperatingSystemVersionConstantServiceFutureStub extends io.grpc.stub.AbstractFutureStub<OperatingSystemVersionConstantServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant> getOperatingSystemVersionConstant(
        com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_OPERATING_SYSTEM_VERSION_CONSTANT:
          serviceImpl.getOperatingSystemVersionConstant((com.google.ads.googleads.v5.services.GetOperatingSystemVersionConstantRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.OperatingSystemVersionConstant>) responseObserver);
          break;
        default:
  ...
  private static abstract class OperatingSystemVersionConstantServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.OperatingSystemVersionConstantServiceProto.getDescriptor();
    }
