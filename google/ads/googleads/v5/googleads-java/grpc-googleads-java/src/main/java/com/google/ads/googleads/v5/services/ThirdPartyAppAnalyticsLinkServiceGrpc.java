...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/third_party_app_analytics_link_service.proto")
public final class ThirdPartyAppAnalyticsLinkServiceGrpc {

  private ThirdPartyAppAnalyticsLinkServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.ThirdPartyAppAnalyticsLinkService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetThirdPartyAppAnalyticsLinkRequest,
      com.google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink> getGetThirdPartyAppAnalyticsLinkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetThirdPartyAppAnalyticsLink",
      requestType = com.google.ads.googleads.v5.services.GetThirdPartyAppAnalyticsLinkRequest.class,
      responseType = com.google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetThirdPartyAppAnalyticsLinkRequest,
      com.google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink> getGetThirdPartyAppAnalyticsLinkMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetThirdPartyAppAnalyticsLinkRequest, com.google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink> getGetThirdPartyAppAnalyticsLinkMethod;
      ...
      synchronized (ThirdPartyAppAnalyticsLinkServiceGrpc.class) {
        if ((getGetThirdPartyAppAnalyticsLinkMethod = ThirdPartyAppAnalyticsLinkServiceGrpc.getGetThirdPartyAppAnalyticsLinkMethod) == null) {
          ThirdPartyAppAnalyticsLinkServiceGrpc.getGetThirdPartyAppAnalyticsLinkMethod = getGetThirdPartyAppAnalyticsLinkMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetThirdPartyAppAnalyticsLinkRequest, com.google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetThirdPartyAppAnalyticsLink"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetThirdPartyAppAnalyticsLinkRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.ThirdPartyAppAnalyticsLink.getDefaultInstance()))
  ...
  private static abstract class ThirdPartyAppAnalyticsLinkServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.ThirdPartyAppAnalyticsLinkServiceProto.getDescriptor();
    }
