...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/account_link_service.proto")
public final class AccountLinkServiceGrpc {

  private AccountLinkServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.AccountLinkService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetAccountLinkRequest,
      com.google.ads.googleads.v5.resources.AccountLink> getGetAccountLinkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAccountLink",
      requestType = com.google.ads.googleads.v5.services.GetAccountLinkRequest.class,
      responseType = com.google.ads.googleads.v5.resources.AccountLink.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetAccountLinkRequest,
      com.google.ads.googleads.v5.resources.AccountLink> getGetAccountLinkMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetAccountLinkRequest, com.google.ads.googleads.v5.resources.AccountLink> getGetAccountLinkMethod;
      ...
      synchronized (AccountLinkServiceGrpc.class) {
        if ((getGetAccountLinkMethod = AccountLinkServiceGrpc.getGetAccountLinkMethod) == null) {
          AccountLinkServiceGrpc.getGetAccountLinkMethod = getGetAccountLinkMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetAccountLinkRequest, com.google.ads.googleads.v5.resources.AccountLink>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAccountLink"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetAccountLinkRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.AccountLink.getDefaultInstance()))
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = com.google.ads.googleads.v5.services.MutateAccountLinkRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateAccountLinkResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateAccountLinkRequest,
      com.google.ads.googleads.v5.services.MutateAccountLinkResponse> getMutateAccountLinkMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateAccountLinkRequest, com.google.ads.googleads.v5.services.MutateAccountLinkResponse> getMutateAccountLinkMethod;
      ...
      synchronized (AccountLinkServiceGrpc.class) {
        if ((getMutateAccountLinkMethod = AccountLinkServiceGrpc.getMutateAccountLinkMethod) == null) {
          AccountLinkServiceGrpc.getMutateAccountLinkMethod = getMutateAccountLinkMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateAccountLinkRequest, com.google.ads.googleads.v5.services.MutateAccountLinkResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAccountLink"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateAccountLinkRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateAccountLinkResponse.getDefaultInstance()))
  ...
  public static abstract class AccountLinkServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAccountLink(com.google.ads.googleads.v5.services.GetAccountLinkRequest request,
    ...
    public void mutateAccountLink(com.google.ads.googleads.v5.services.MutateAccountLinkRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateAccountLinkResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateAccountLinkRequest,
                com.google.ads.googleads.v5.services.MutateAccountLinkResponse>(
  ...
  public static final class AccountLinkServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AccountLinkServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.AccountLink getAccountLink(com.google.ads.googleads.v5.services.GetAccountLinkRequest request) {
  ...
  public static final class AccountLinkServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AccountLinkServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.AccountLink> getAccountLink(
        com.google.ads.googleads.v5.services.GetAccountLinkRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateAccountLinkResponse> mutateAccountLink(
        com.google.ads.googleads.v5.services.MutateAccountLinkRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static abstract class AccountLinkServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.AccountLinkServiceProto.getDescriptor();
    }
