...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/mobile_device_constant_service.proto")
public final class MobileDeviceConstantServiceGrpc {

  private MobileDeviceConstantServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.MobileDeviceConstantService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest,
      com.google.ads.googleads.v5.resources.MobileDeviceConstant> getGetMobileDeviceConstantMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMobileDeviceConstant",
      requestType = com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest.class,
      responseType = com.google.ads.googleads.v5.resources.MobileDeviceConstant.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest,
      com.google.ads.googleads.v5.resources.MobileDeviceConstant> getGetMobileDeviceConstantMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest, com.google.ads.googleads.v5.resources.MobileDeviceConstant> getGetMobileDeviceConstantMethod;
      ...
      synchronized (MobileDeviceConstantServiceGrpc.class) {
        if ((getGetMobileDeviceConstantMethod = MobileDeviceConstantServiceGrpc.getGetMobileDeviceConstantMethod) == null) {
          MobileDeviceConstantServiceGrpc.getGetMobileDeviceConstantMethod = getGetMobileDeviceConstantMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest, com.google.ads.googleads.v5.resources.MobileDeviceConstant>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetMobileDeviceConstant"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.MobileDeviceConstant.getDefaultInstance()))
  ...
  public static abstract class MobileDeviceConstantServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getMobileDeviceConstant(com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.MobileDeviceConstant> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetMobileDeviceConstantMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest,
                com.google.ads.googleads.v5.resources.MobileDeviceConstant>(
  ...
  public static final class MobileDeviceConstantServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MobileDeviceConstantServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.MobileDeviceConstant getMobileDeviceConstant(com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest request) {
  ...
  public static final class MobileDeviceConstantServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MobileDeviceConstantServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.MobileDeviceConstant> getMobileDeviceConstant(
        com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MOBILE_DEVICE_CONSTANT:
          serviceImpl.getMobileDeviceConstant((com.google.ads.googleads.v5.services.GetMobileDeviceConstantRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.MobileDeviceConstant>) responseObserver);
          break;
        default:
  ...
  private static abstract class MobileDeviceConstantServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.MobileDeviceConstantServiceProto.getDescriptor();
    }
