...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/location_view_service.proto")
public final class LocationViewServiceGrpc {

  private LocationViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.LocationViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetLocationViewRequest,
      com.google.ads.googleads.v5.resources.LocationView> getGetLocationViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetLocationView",
      requestType = com.google.ads.googleads.v5.services.GetLocationViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.LocationView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetLocationViewRequest,
      com.google.ads.googleads.v5.resources.LocationView> getGetLocationViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetLocationViewRequest, com.google.ads.googleads.v5.resources.LocationView> getGetLocationViewMethod;
      ...
      synchronized (LocationViewServiceGrpc.class) {
        if ((getGetLocationViewMethod = LocationViewServiceGrpc.getGetLocationViewMethod) == null) {
          LocationViewServiceGrpc.getGetLocationViewMethod = getGetLocationViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetLocationViewRequest, com.google.ads.googleads.v5.resources.LocationView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetLocationView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetLocationViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.LocationView.getDefaultInstance()))
  ...
  public static abstract class LocationViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getLocationView(com.google.ads.googleads.v5.services.GetLocationViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.LocationView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetLocationViewRequest,
                com.google.ads.googleads.v5.resources.LocationView>(
  ...
  public static final class LocationViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LocationViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.LocationView getLocationView(com.google.ads.googleads.v5.services.GetLocationViewRequest request) {
  ...
  public static final class LocationViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LocationViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.LocationView> getLocationView(
        com.google.ads.googleads.v5.services.GetLocationViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_LOCATION_VIEW:
          serviceImpl.getLocationView((com.google.ads.googleads.v5.services.GetLocationViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.LocationView>) responseObserver);
          break;
        default:
  ...
  private static abstract class LocationViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.LocationViewServiceProto.getDescriptor();
    }
