...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/campaign_audience_view_service.proto")
public final class CampaignAudienceViewServiceGrpc {

  private CampaignAudienceViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.CampaignAudienceViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest,
      com.google.ads.googleads.v5.resources.CampaignAudienceView> getGetCampaignAudienceViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignAudienceView",
      requestType = com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.CampaignAudienceView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest,
      com.google.ads.googleads.v5.resources.CampaignAudienceView> getGetCampaignAudienceViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest, com.google.ads.googleads.v5.resources.CampaignAudienceView> getGetCampaignAudienceViewMethod;
      ...
      synchronized (CampaignAudienceViewServiceGrpc.class) {
        if ((getGetCampaignAudienceViewMethod = CampaignAudienceViewServiceGrpc.getGetCampaignAudienceViewMethod) == null) {
          CampaignAudienceViewServiceGrpc.getGetCampaignAudienceViewMethod = getGetCampaignAudienceViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest, com.google.ads.googleads.v5.resources.CampaignAudienceView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignAudienceView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.CampaignAudienceView.getDefaultInstance()))
  ...
  public static abstract class CampaignAudienceViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignAudienceView(com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CampaignAudienceView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest,
                com.google.ads.googleads.v5.resources.CampaignAudienceView>(
  ...
  public static final class CampaignAudienceViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignAudienceViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.CampaignAudienceView getCampaignAudienceView(com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest request) {
  ...
  public static final class CampaignAudienceViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignAudienceViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.CampaignAudienceView> getCampaignAudienceView(
        com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_AUDIENCE_VIEW:
          serviceImpl.getCampaignAudienceView((com.google.ads.googleads.v5.services.GetCampaignAudienceViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CampaignAudienceView>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignAudienceViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.CampaignAudienceViewServiceProto.getDescriptor();
    }
