...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/product_bidding_category_constant_service.proto")
public final class ProductBiddingCategoryConstantServiceGrpc {

  private ProductBiddingCategoryConstantServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.ProductBiddingCategoryConstantService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest,
      com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant> getGetProductBiddingCategoryConstantMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetProductBiddingCategoryConstant",
      requestType = com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest.class,
      responseType = com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest,
      com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant> getGetProductBiddingCategoryConstantMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest, com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant> getGetProductBiddingCategoryConstantMethod;
      ...
      synchronized (ProductBiddingCategoryConstantServiceGrpc.class) {
        if ((getGetProductBiddingCategoryConstantMethod = ProductBiddingCategoryConstantServiceGrpc.getGetProductBiddingCategoryConstantMethod) == null) {
          ProductBiddingCategoryConstantServiceGrpc.getGetProductBiddingCategoryConstantMethod = getGetProductBiddingCategoryConstantMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest, com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetProductBiddingCategoryConstant"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant.getDefaultInstance()))
  ...
  public static abstract class ProductBiddingCategoryConstantServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getProductBiddingCategoryConstant(com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetProductBiddingCategoryConstantMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest,
                com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant>(
  ...
  public static final class ProductBiddingCategoryConstantServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ProductBiddingCategoryConstantServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant getProductBiddingCategoryConstant(com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest request) {
  ...
  public static final class ProductBiddingCategoryConstantServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ProductBiddingCategoryConstantServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant> getProductBiddingCategoryConstant(
        com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PRODUCT_BIDDING_CATEGORY_CONSTANT:
          serviceImpl.getProductBiddingCategoryConstant((com.google.ads.googleads.v5.services.GetProductBiddingCategoryConstantRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.ProductBiddingCategoryConstant>) responseObserver);
          break;
        default:
  ...
  private static abstract class ProductBiddingCategoryConstantServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.ProductBiddingCategoryConstantServiceProto.getDescriptor();
    }
