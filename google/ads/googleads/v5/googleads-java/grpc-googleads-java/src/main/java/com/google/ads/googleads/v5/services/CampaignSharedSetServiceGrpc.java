...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/campaign_shared_set_service.proto")
public final class CampaignSharedSetServiceGrpc {

  private CampaignSharedSetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.CampaignSharedSetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest,
      com.google.ads.googleads.v5.resources.CampaignSharedSet> getGetCampaignSharedSetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignSharedSet",
      requestType = com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest.class,
      responseType = com.google.ads.googleads.v5.resources.CampaignSharedSet.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest,
      com.google.ads.googleads.v5.resources.CampaignSharedSet> getGetCampaignSharedSetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest, com.google.ads.googleads.v5.resources.CampaignSharedSet> getGetCampaignSharedSetMethod;
      ...
      synchronized (CampaignSharedSetServiceGrpc.class) {
        if ((getGetCampaignSharedSetMethod = CampaignSharedSetServiceGrpc.getGetCampaignSharedSetMethod) == null) {
          CampaignSharedSetServiceGrpc.getGetCampaignSharedSetMethod = getGetCampaignSharedSetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest, com.google.ads.googleads.v5.resources.CampaignSharedSet>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignSharedSet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.CampaignSharedSet.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest,
      com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse> getMutateCampaignSharedSetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCampaignSharedSets",
      requestType = com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest,
      com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse> getMutateCampaignSharedSetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest, com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse> getMutateCampaignSharedSetsMethod;
      ...
      synchronized (CampaignSharedSetServiceGrpc.class) {
        if ((getMutateCampaignSharedSetsMethod = CampaignSharedSetServiceGrpc.getMutateCampaignSharedSetsMethod) == null) {
          CampaignSharedSetServiceGrpc.getMutateCampaignSharedSetsMethod = getMutateCampaignSharedSetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest, com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCampaignSharedSets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse.getDefaultInstance()))
  ...
  public static abstract class CampaignSharedSetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignSharedSet(com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CampaignSharedSet> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCampaignSharedSets(com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest,
                com.google.ads.googleads.v5.resources.CampaignSharedSet>(
                  this, METHODID_GET_CAMPAIGN_SHARED_SET)))
          .addMethod(
            getMutateCampaignSharedSetsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest,
                com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse>(
  ...
  public static final class CampaignSharedSetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignSharedSetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.CampaignSharedSet getCampaignSharedSet(com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse mutateCampaignSharedSets(com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CampaignSharedSetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignSharedSetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.CampaignSharedSet> getCampaignSharedSet(
        com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse> mutateCampaignSharedSets(
        com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_SHARED_SET:
          serviceImpl.getCampaignSharedSet((com.google.ads.googleads.v5.services.GetCampaignSharedSetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CampaignSharedSet>) responseObserver);
          break;
        case METHODID_MUTATE_CAMPAIGN_SHARED_SETS:
          serviceImpl.mutateCampaignSharedSets((com.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignSharedSetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.CampaignSharedSetServiceProto.getDescriptor();
    }
