...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/shared_set_service.proto")
public final class SharedSetServiceGrpc {

  private SharedSetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.SharedSetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetSharedSetRequest,
      com.google.ads.googleads.v5.resources.SharedSet> getGetSharedSetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetSharedSet",
      requestType = com.google.ads.googleads.v5.services.GetSharedSetRequest.class,
      responseType = com.google.ads.googleads.v5.resources.SharedSet.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetSharedSetRequest,
      com.google.ads.googleads.v5.resources.SharedSet> getGetSharedSetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetSharedSetRequest, com.google.ads.googleads.v5.resources.SharedSet> getGetSharedSetMethod;
      ...
      synchronized (SharedSetServiceGrpc.class) {
        if ((getGetSharedSetMethod = SharedSetServiceGrpc.getGetSharedSetMethod) == null) {
          SharedSetServiceGrpc.getGetSharedSetMethod = getGetSharedSetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetSharedSetRequest, com.google.ads.googleads.v5.resources.SharedSet>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetSharedSet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetSharedSetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.SharedSet.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateSharedSetsRequest,
      com.google.ads.googleads.v5.services.MutateSharedSetsResponse> getMutateSharedSetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateSharedSets",
      requestType = com.google.ads.googleads.v5.services.MutateSharedSetsRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateSharedSetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateSharedSetsRequest,
      com.google.ads.googleads.v5.services.MutateSharedSetsResponse> getMutateSharedSetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateSharedSetsRequest, com.google.ads.googleads.v5.services.MutateSharedSetsResponse> getMutateSharedSetsMethod;
      ...
      synchronized (SharedSetServiceGrpc.class) {
        if ((getMutateSharedSetsMethod = SharedSetServiceGrpc.getMutateSharedSetsMethod) == null) {
          SharedSetServiceGrpc.getMutateSharedSetsMethod = getMutateSharedSetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateSharedSetsRequest, com.google.ads.googleads.v5.services.MutateSharedSetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateSharedSets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateSharedSetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateSharedSetsResponse.getDefaultInstance()))
  ...
  public static abstract class SharedSetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getSharedSet(com.google.ads.googleads.v5.services.GetSharedSetRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.SharedSet> responseObserver) {
     ...
     * </pre>
     */
    public void mutateSharedSets(com.google.ads.googleads.v5.services.MutateSharedSetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateSharedSetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetSharedSetRequest,
                com.google.ads.googleads.v5.resources.SharedSet>(
                  this, METHODID_GET_SHARED_SET)))
          .addMethod(
            getMutateSharedSetsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateSharedSetsRequest,
                com.google.ads.googleads.v5.services.MutateSharedSetsResponse>(
  ...
  public static final class SharedSetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SharedSetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.SharedSet getSharedSet(com.google.ads.googleads.v5.services.GetSharedSetRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateSharedSetsResponse mutateSharedSets(com.google.ads.googleads.v5.services.MutateSharedSetsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class SharedSetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SharedSetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.SharedSet> getSharedSet(
        com.google.ads.googleads.v5.services.GetSharedSetRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateSharedSetsResponse> mutateSharedSets(
        com.google.ads.googleads.v5.services.MutateSharedSetsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SHARED_SET:
          serviceImpl.getSharedSet((com.google.ads.googleads.v5.services.GetSharedSetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.SharedSet>) responseObserver);
          break;
        case METHODID_MUTATE_SHARED_SETS:
          serviceImpl.mutateSharedSets((com.google.ads.googleads.v5.services.MutateSharedSetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateSharedSetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SharedSetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.SharedSetServiceProto.getDescriptor();
    }
