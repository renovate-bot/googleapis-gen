...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/domain_category_service.proto")
public final class DomainCategoryServiceGrpc {

  private DomainCategoryServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.DomainCategoryService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetDomainCategoryRequest,
      com.google.ads.googleads.v5.resources.DomainCategory> getGetDomainCategoryMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDomainCategory",
      requestType = com.google.ads.googleads.v5.services.GetDomainCategoryRequest.class,
      responseType = com.google.ads.googleads.v5.resources.DomainCategory.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetDomainCategoryRequest,
      com.google.ads.googleads.v5.resources.DomainCategory> getGetDomainCategoryMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetDomainCategoryRequest, com.google.ads.googleads.v5.resources.DomainCategory> getGetDomainCategoryMethod;
      ...
      synchronized (DomainCategoryServiceGrpc.class) {
        if ((getGetDomainCategoryMethod = DomainCategoryServiceGrpc.getGetDomainCategoryMethod) == null) {
          DomainCategoryServiceGrpc.getGetDomainCategoryMethod = getGetDomainCategoryMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetDomainCategoryRequest, com.google.ads.googleads.v5.resources.DomainCategory>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDomainCategory"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetDomainCategoryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.DomainCategory.getDefaultInstance()))
  ...
  public static abstract class DomainCategoryServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getDomainCategory(com.google.ads.googleads.v5.services.GetDomainCategoryRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.DomainCategory> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetDomainCategoryMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetDomainCategoryRequest,
                com.google.ads.googleads.v5.resources.DomainCategory>(
  ...
  public static final class DomainCategoryServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DomainCategoryServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.DomainCategory getDomainCategory(com.google.ads.googleads.v5.services.GetDomainCategoryRequest request) {
  ...
  public static final class DomainCategoryServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DomainCategoryServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.DomainCategory> getDomainCategory(
        com.google.ads.googleads.v5.services.GetDomainCategoryRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DOMAIN_CATEGORY:
          serviceImpl.getDomainCategory((com.google.ads.googleads.v5.services.GetDomainCategoryRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.DomainCategory>) responseObserver);
          break;
        default:
  ...
  private static abstract class DomainCategoryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.DomainCategoryServiceProto.getDescriptor();
    }
