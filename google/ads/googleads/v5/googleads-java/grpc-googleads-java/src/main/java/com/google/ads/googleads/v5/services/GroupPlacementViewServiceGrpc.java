...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/group_placement_view_service.proto")
public final class GroupPlacementViewServiceGrpc {

  private GroupPlacementViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.GroupPlacementViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest,
      com.google.ads.googleads.v5.resources.GroupPlacementView> getGetGroupPlacementViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetGroupPlacementView",
      requestType = com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.GroupPlacementView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest,
      com.google.ads.googleads.v5.resources.GroupPlacementView> getGetGroupPlacementViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest, com.google.ads.googleads.v5.resources.GroupPlacementView> getGetGroupPlacementViewMethod;
      ...
      synchronized (GroupPlacementViewServiceGrpc.class) {
        if ((getGetGroupPlacementViewMethod = GroupPlacementViewServiceGrpc.getGetGroupPlacementViewMethod) == null) {
          GroupPlacementViewServiceGrpc.getGetGroupPlacementViewMethod = getGetGroupPlacementViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest, com.google.ads.googleads.v5.resources.GroupPlacementView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetGroupPlacementView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.GroupPlacementView.getDefaultInstance()))
  ...
  public static abstract class GroupPlacementViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getGroupPlacementView(com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.GroupPlacementView> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetGroupPlacementViewMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest,
                com.google.ads.googleads.v5.resources.GroupPlacementView>(
  ...
  public static final class GroupPlacementViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GroupPlacementViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.GroupPlacementView getGroupPlacementView(com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest request) {
  ...
  public static final class GroupPlacementViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GroupPlacementViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.GroupPlacementView> getGroupPlacementView(
        com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_GROUP_PLACEMENT_VIEW:
          serviceImpl.getGroupPlacementView((com.google.ads.googleads.v5.services.GetGroupPlacementViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.GroupPlacementView>) responseObserver);
          break;
        default:
  ...
  private static abstract class GroupPlacementViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.GroupPlacementViewServiceProto.getDescriptor();
    }
