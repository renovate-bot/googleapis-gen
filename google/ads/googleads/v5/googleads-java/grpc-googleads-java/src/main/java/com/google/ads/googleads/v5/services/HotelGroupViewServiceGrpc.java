...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/hotel_group_view_service.proto")
public final class HotelGroupViewServiceGrpc {

  private HotelGroupViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.HotelGroupViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetHotelGroupViewRequest,
      com.google.ads.googleads.v5.resources.HotelGroupView> getGetHotelGroupViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetHotelGroupView",
      requestType = com.google.ads.googleads.v5.services.GetHotelGroupViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.HotelGroupView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetHotelGroupViewRequest,
      com.google.ads.googleads.v5.resources.HotelGroupView> getGetHotelGroupViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetHotelGroupViewRequest, com.google.ads.googleads.v5.resources.HotelGroupView> getGetHotelGroupViewMethod;
      ...
      synchronized (HotelGroupViewServiceGrpc.class) {
        if ((getGetHotelGroupViewMethod = HotelGroupViewServiceGrpc.getGetHotelGroupViewMethod) == null) {
          HotelGroupViewServiceGrpc.getGetHotelGroupViewMethod = getGetHotelGroupViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetHotelGroupViewRequest, com.google.ads.googleads.v5.resources.HotelGroupView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetHotelGroupView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetHotelGroupViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.HotelGroupView.getDefaultInstance()))
  ...
  public static abstract class HotelGroupViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getHotelGroupView(com.google.ads.googleads.v5.services.GetHotelGroupViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.HotelGroupView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetHotelGroupViewRequest,
                com.google.ads.googleads.v5.resources.HotelGroupView>(
  ...
  public static final class HotelGroupViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HotelGroupViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.HotelGroupView getHotelGroupView(com.google.ads.googleads.v5.services.GetHotelGroupViewRequest request) {
  ...
  public static final class HotelGroupViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HotelGroupViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.HotelGroupView> getHotelGroupView(
        com.google.ads.googleads.v5.services.GetHotelGroupViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_HOTEL_GROUP_VIEW:
          serviceImpl.getHotelGroupView((com.google.ads.googleads.v5.services.GetHotelGroupViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.HotelGroupView>) responseObserver);
          break;
        default:
  ...
  private static abstract class HotelGroupViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.HotelGroupViewServiceProto.getDescriptor();
    }
