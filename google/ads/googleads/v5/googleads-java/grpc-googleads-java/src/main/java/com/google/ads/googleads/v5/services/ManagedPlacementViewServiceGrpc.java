...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/managed_placement_view_service.proto")
public final class ManagedPlacementViewServiceGrpc {

  private ManagedPlacementViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.ManagedPlacementViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest,
      com.google.ads.googleads.v5.resources.ManagedPlacementView> getGetManagedPlacementViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetManagedPlacementView",
      requestType = com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.ManagedPlacementView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest,
      com.google.ads.googleads.v5.resources.ManagedPlacementView> getGetManagedPlacementViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest, com.google.ads.googleads.v5.resources.ManagedPlacementView> getGetManagedPlacementViewMethod;
      ...
      synchronized (ManagedPlacementViewServiceGrpc.class) {
        if ((getGetManagedPlacementViewMethod = ManagedPlacementViewServiceGrpc.getGetManagedPlacementViewMethod) == null) {
          ManagedPlacementViewServiceGrpc.getGetManagedPlacementViewMethod = getGetManagedPlacementViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest, com.google.ads.googleads.v5.resources.ManagedPlacementView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetManagedPlacementView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.ManagedPlacementView.getDefaultInstance()))
  ...
  public static abstract class ManagedPlacementViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getManagedPlacementView(com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.ManagedPlacementView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest,
                com.google.ads.googleads.v5.resources.ManagedPlacementView>(
  ...
  public static final class ManagedPlacementViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ManagedPlacementViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.ManagedPlacementView getManagedPlacementView(com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest request) {
  ...
  public static final class ManagedPlacementViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ManagedPlacementViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.ManagedPlacementView> getManagedPlacementView(
        com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MANAGED_PLACEMENT_VIEW:
          serviceImpl.getManagedPlacementView((com.google.ads.googleads.v5.services.GetManagedPlacementViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.ManagedPlacementView>) responseObserver);
          break;
        default:
  ...
  private static abstract class ManagedPlacementViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.ManagedPlacementViewServiceProto.getDescriptor();
    }
