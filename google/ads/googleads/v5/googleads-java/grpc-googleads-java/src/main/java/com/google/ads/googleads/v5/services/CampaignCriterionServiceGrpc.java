...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/campaign_criterion_service.proto")
public final class CampaignCriterionServiceGrpc {

  private CampaignCriterionServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.CampaignCriterionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignCriterionRequest,
      com.google.ads.googleads.v5.resources.CampaignCriterion> getGetCampaignCriterionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignCriterion",
      requestType = com.google.ads.googleads.v5.services.GetCampaignCriterionRequest.class,
      responseType = com.google.ads.googleads.v5.resources.CampaignCriterion.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignCriterionRequest,
      com.google.ads.googleads.v5.resources.CampaignCriterion> getGetCampaignCriterionMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignCriterionRequest, com.google.ads.googleads.v5.resources.CampaignCriterion> getGetCampaignCriterionMethod;
      ...
      synchronized (CampaignCriterionServiceGrpc.class) {
        if ((getGetCampaignCriterionMethod = CampaignCriterionServiceGrpc.getGetCampaignCriterionMethod) == null) {
          CampaignCriterionServiceGrpc.getGetCampaignCriterionMethod = getGetCampaignCriterionMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetCampaignCriterionRequest, com.google.ads.googleads.v5.resources.CampaignCriterion>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignCriterion"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetCampaignCriterionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.CampaignCriterion.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest,
      com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse> getMutateCampaignCriteriaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCampaignCriteria",
      requestType = com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest,
      com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse> getMutateCampaignCriteriaMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest, com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse> getMutateCampaignCriteriaMethod;
      ...
      synchronized (CampaignCriterionServiceGrpc.class) {
        if ((getMutateCampaignCriteriaMethod = CampaignCriterionServiceGrpc.getMutateCampaignCriteriaMethod) == null) {
          CampaignCriterionServiceGrpc.getMutateCampaignCriteriaMethod = getMutateCampaignCriteriaMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest, com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCampaignCriteria"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse.getDefaultInstance()))
  ...
  public static abstract class CampaignCriterionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignCriterion(com.google.ads.googleads.v5.services.GetCampaignCriterionRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CampaignCriterion> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetCampaignCriterionMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public void mutateCampaignCriteria(com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetCampaignCriterionRequest,
                com.google.ads.googleads.v5.resources.CampaignCriterion>(
                  this, METHODID_GET_CAMPAIGN_CRITERION)))
          .addMethod(
            getMutateCampaignCriteriaMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest,
                com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse>(
  ...
  public static final class CampaignCriterionServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignCriterionServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.CampaignCriterion getCampaignCriterion(com.google.ads.googleads.v5.services.GetCampaignCriterionRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse mutateCampaignCriteria(com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CampaignCriterionServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignCriterionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.CampaignCriterion> getCampaignCriterion(
        com.google.ads.googleads.v5.services.GetCampaignCriterionRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse> mutateCampaignCriteria(
        com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_CRITERION:
          serviceImpl.getCampaignCriterion((com.google.ads.googleads.v5.services.GetCampaignCriterionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CampaignCriterion>) responseObserver);
          break;
        case METHODID_MUTATE_CAMPAIGN_CRITERIA:
          serviceImpl.mutateCampaignCriteria((com.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignCriterionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.CampaignCriterionServiceProto.getDescriptor();
    }
