...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/geo_target_constant_service.proto")
public final class GeoTargetConstantServiceGrpc {

  private GeoTargetConstantServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.GeoTargetConstantService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest,
      com.google.ads.googleads.v5.resources.GeoTargetConstant> getGetGeoTargetConstantMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetGeoTargetConstant",
      requestType = com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest.class,
      responseType = com.google.ads.googleads.v5.resources.GeoTargetConstant.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest,
      com.google.ads.googleads.v5.resources.GeoTargetConstant> getGetGeoTargetConstantMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest, com.google.ads.googleads.v5.resources.GeoTargetConstant> getGetGeoTargetConstantMethod;
      ...
      synchronized (GeoTargetConstantServiceGrpc.class) {
        if ((getGetGeoTargetConstantMethod = GeoTargetConstantServiceGrpc.getGetGeoTargetConstantMethod) == null) {
          GeoTargetConstantServiceGrpc.getGetGeoTargetConstantMethod = getGetGeoTargetConstantMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest, com.google.ads.googleads.v5.resources.GeoTargetConstant>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetGeoTargetConstant"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.GeoTargetConstant.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest,
      com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse> getSuggestGeoTargetConstantsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SuggestGeoTargetConstants",
      requestType = com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest.class,
      responseType = com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest,
      com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse> getSuggestGeoTargetConstantsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest, com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse> getSuggestGeoTargetConstantsMethod;
      ...
      synchronized (GeoTargetConstantServiceGrpc.class) {
        if ((getSuggestGeoTargetConstantsMethod = GeoTargetConstantServiceGrpc.getSuggestGeoTargetConstantsMethod) == null) {
          GeoTargetConstantServiceGrpc.getSuggestGeoTargetConstantsMethod = getSuggestGeoTargetConstantsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest, com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SuggestGeoTargetConstants"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse.getDefaultInstance()))
  ...
  public static abstract class GeoTargetConstantServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getGeoTargetConstant(com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.GeoTargetConstant> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetGeoTargetConstantMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public void suggestGeoTargetConstants(com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest,
                com.google.ads.googleads.v5.resources.GeoTargetConstant>(
                  this, METHODID_GET_GEO_TARGET_CONSTANT)))
          .addMethod(
            getSuggestGeoTargetConstantsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest,
                com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse>(
  ...
  public static final class GeoTargetConstantServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GeoTargetConstantServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.GeoTargetConstant getGeoTargetConstant(com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse suggestGeoTargetConstants(com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class GeoTargetConstantServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GeoTargetConstantServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.GeoTargetConstant> getGeoTargetConstant(
        com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse> suggestGeoTargetConstants(
        com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_GEO_TARGET_CONSTANT:
          serviceImpl.getGeoTargetConstant((com.google.ads.googleads.v5.services.GetGeoTargetConstantRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.GeoTargetConstant>) responseObserver);
          break;
        case METHODID_SUGGEST_GEO_TARGET_CONSTANTS:
          serviceImpl.suggestGeoTargetConstants((com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.SuggestGeoTargetConstantsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GeoTargetConstantServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.GeoTargetConstantServiceProto.getDescriptor();
    }
