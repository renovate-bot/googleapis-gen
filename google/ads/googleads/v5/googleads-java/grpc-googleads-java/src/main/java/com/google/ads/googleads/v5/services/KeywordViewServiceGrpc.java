...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/keyword_view_service.proto")
public final class KeywordViewServiceGrpc {

  private KeywordViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.KeywordViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordViewRequest,
      com.google.ads.googleads.v5.resources.KeywordView> getGetKeywordViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetKeywordView",
      requestType = com.google.ads.googleads.v5.services.GetKeywordViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.KeywordView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordViewRequest,
      com.google.ads.googleads.v5.resources.KeywordView> getGetKeywordViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordViewRequest, com.google.ads.googleads.v5.resources.KeywordView> getGetKeywordViewMethod;
      ...
      synchronized (KeywordViewServiceGrpc.class) {
        if ((getGetKeywordViewMethod = KeywordViewServiceGrpc.getGetKeywordViewMethod) == null) {
          KeywordViewServiceGrpc.getGetKeywordViewMethod = getGetKeywordViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetKeywordViewRequest, com.google.ads.googleads.v5.resources.KeywordView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetKeywordView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetKeywordViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.KeywordView.getDefaultInstance()))
  ...
  public static abstract class KeywordViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getKeywordView(com.google.ads.googleads.v5.services.GetKeywordViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.KeywordView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetKeywordViewRequest,
                com.google.ads.googleads.v5.resources.KeywordView>(
  ...
  public static final class KeywordViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<KeywordViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.KeywordView getKeywordView(com.google.ads.googleads.v5.services.GetKeywordViewRequest request) {
  ...
  public static final class KeywordViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<KeywordViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.KeywordView> getKeywordView(
        com.google.ads.googleads.v5.services.GetKeywordViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_KEYWORD_VIEW:
          serviceImpl.getKeywordView((com.google.ads.googleads.v5.services.GetKeywordViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.KeywordView>) responseObserver);
          break;
        default:
  ...
  private static abstract class KeywordViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.KeywordViewServiceProto.getDescriptor();
    }
