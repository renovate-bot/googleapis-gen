...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/display_keyword_view_service.proto")
public final class DisplayKeywordViewServiceGrpc {

  private DisplayKeywordViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.DisplayKeywordViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest,
      com.google.ads.googleads.v5.resources.DisplayKeywordView> getGetDisplayKeywordViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDisplayKeywordView",
      requestType = com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.DisplayKeywordView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest,
      com.google.ads.googleads.v5.resources.DisplayKeywordView> getGetDisplayKeywordViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest, com.google.ads.googleads.v5.resources.DisplayKeywordView> getGetDisplayKeywordViewMethod;
      ...
      synchronized (DisplayKeywordViewServiceGrpc.class) {
        if ((getGetDisplayKeywordViewMethod = DisplayKeywordViewServiceGrpc.getGetDisplayKeywordViewMethod) == null) {
          DisplayKeywordViewServiceGrpc.getGetDisplayKeywordViewMethod = getGetDisplayKeywordViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest, com.google.ads.googleads.v5.resources.DisplayKeywordView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDisplayKeywordView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.DisplayKeywordView.getDefaultInstance()))
  ...
  public static abstract class DisplayKeywordViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getDisplayKeywordView(com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.DisplayKeywordView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest,
                com.google.ads.googleads.v5.resources.DisplayKeywordView>(
  ...
  public static final class DisplayKeywordViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DisplayKeywordViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.DisplayKeywordView getDisplayKeywordView(com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest request) {
  ...
  public static final class DisplayKeywordViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DisplayKeywordViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.DisplayKeywordView> getDisplayKeywordView(
        com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DISPLAY_KEYWORD_VIEW:
          serviceImpl.getDisplayKeywordView((com.google.ads.googleads.v5.services.GetDisplayKeywordViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.DisplayKeywordView>) responseObserver);
          break;
        default:
  ...
  private static abstract class DisplayKeywordViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.DisplayKeywordViewServiceProto.getDescriptor();
    }
