...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/customer_label_service.proto")
public final class CustomerLabelServiceGrpc {

  private CustomerLabelServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.CustomerLabelService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCustomerLabelRequest,
      com.google.ads.googleads.v5.resources.CustomerLabel> getGetCustomerLabelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCustomerLabel",
      requestType = com.google.ads.googleads.v5.services.GetCustomerLabelRequest.class,
      responseType = com.google.ads.googleads.v5.resources.CustomerLabel.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCustomerLabelRequest,
      com.google.ads.googleads.v5.resources.CustomerLabel> getGetCustomerLabelMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCustomerLabelRequest, com.google.ads.googleads.v5.resources.CustomerLabel> getGetCustomerLabelMethod;
      ...
      synchronized (CustomerLabelServiceGrpc.class) {
        if ((getGetCustomerLabelMethod = CustomerLabelServiceGrpc.getGetCustomerLabelMethod) == null) {
          CustomerLabelServiceGrpc.getGetCustomerLabelMethod = getGetCustomerLabelMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetCustomerLabelRequest, com.google.ads.googleads.v5.resources.CustomerLabel>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCustomerLabel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetCustomerLabelRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.CustomerLabel.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest,
      com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse> getMutateCustomerLabelsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCustomerLabels",
      requestType = com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest,
      com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse> getMutateCustomerLabelsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest, com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse> getMutateCustomerLabelsMethod;
      ...
      synchronized (CustomerLabelServiceGrpc.class) {
        if ((getMutateCustomerLabelsMethod = CustomerLabelServiceGrpc.getMutateCustomerLabelsMethod) == null) {
          CustomerLabelServiceGrpc.getMutateCustomerLabelsMethod = getMutateCustomerLabelsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest, com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCustomerLabels"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse.getDefaultInstance()))
  ...
  public static abstract class CustomerLabelServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCustomerLabel(com.google.ads.googleads.v5.services.GetCustomerLabelRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CustomerLabel> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCustomerLabels(com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetCustomerLabelRequest,
                com.google.ads.googleads.v5.resources.CustomerLabel>(
                  this, METHODID_GET_CUSTOMER_LABEL)))
          .addMethod(
            getMutateCustomerLabelsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest,
                com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse>(
  ...
  public static final class CustomerLabelServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CustomerLabelServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.CustomerLabel getCustomerLabel(com.google.ads.googleads.v5.services.GetCustomerLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse mutateCustomerLabels(com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CustomerLabelServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CustomerLabelServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.CustomerLabel> getCustomerLabel(
        com.google.ads.googleads.v5.services.GetCustomerLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse> mutateCustomerLabels(
        com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CUSTOMER_LABEL:
          serviceImpl.getCustomerLabel((com.google.ads.googleads.v5.services.GetCustomerLabelRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CustomerLabel>) responseObserver);
          break;
        case METHODID_MUTATE_CUSTOMER_LABELS:
          serviceImpl.mutateCustomerLabels((com.google.ads.googleads.v5.services.MutateCustomerLabelsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateCustomerLabelsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CustomerLabelServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.CustomerLabelServiceProto.getDescriptor();
    }
