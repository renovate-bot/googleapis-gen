...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/parental_status_view_service.proto")
public final class ParentalStatusViewServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetParentalStatusViewRequest,
      com.google.ads.googleads.v5.resources.ParentalStatusView> getGetParentalStatusViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetParentalStatusView",
      requestType = com.google.ads.googleads.v5.services.GetParentalStatusViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.ParentalStatusView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetParentalStatusViewRequest,
      com.google.ads.googleads.v5.resources.ParentalStatusView> getGetParentalStatusViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetParentalStatusViewRequest, com.google.ads.googleads.v5.resources.ParentalStatusView> getGetParentalStatusViewMethod;
      ...
      synchronized (ParentalStatusViewServiceGrpc.class) {
        if ((getGetParentalStatusViewMethod = ParentalStatusViewServiceGrpc.getGetParentalStatusViewMethod) == null) {
          ParentalStatusViewServiceGrpc.getGetParentalStatusViewMethod = getGetParentalStatusViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetParentalStatusViewRequest, com.google.ads.googleads.v5.resources.ParentalStatusView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetParentalStatusView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetParentalStatusViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.ParentalStatusView.getDefaultInstance()))
  ...
  public static abstract class ParentalStatusViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getParentalStatusView(com.google.ads.googleads.v5.services.GetParentalStatusViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.ParentalStatusView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetParentalStatusViewRequest,
                com.google.ads.googleads.v5.resources.ParentalStatusView>(
  ...
  public static final class ParentalStatusViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ParentalStatusViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.ParentalStatusView getParentalStatusView(com.google.ads.googleads.v5.services.GetParentalStatusViewRequest request) {
  ...
  public static final class ParentalStatusViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ParentalStatusViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.ParentalStatusView> getParentalStatusView(
        com.google.ads.googleads.v5.services.GetParentalStatusViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PARENTAL_STATUS_VIEW:
          serviceImpl.getParentalStatusView((com.google.ads.googleads.v5.services.GetParentalStatusViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.ParentalStatusView>) responseObserver);
          break;
        default:
  ...
  private static abstract class ParentalStatusViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.ParentalStatusViewServiceProto.getDescriptor();
    }
