...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/income_range_view_service.proto")
public final class IncomeRangeViewServiceGrpc {

  private IncomeRangeViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.IncomeRangeViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest,
      com.google.ads.googleads.v5.resources.IncomeRangeView> getGetIncomeRangeViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetIncomeRangeView",
      requestType = com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest.class,
      responseType = com.google.ads.googleads.v5.resources.IncomeRangeView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest,
      com.google.ads.googleads.v5.resources.IncomeRangeView> getGetIncomeRangeViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest, com.google.ads.googleads.v5.resources.IncomeRangeView> getGetIncomeRangeViewMethod;
      ...
      synchronized (IncomeRangeViewServiceGrpc.class) {
        if ((getGetIncomeRangeViewMethod = IncomeRangeViewServiceGrpc.getGetIncomeRangeViewMethod) == null) {
          IncomeRangeViewServiceGrpc.getGetIncomeRangeViewMethod = getGetIncomeRangeViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest, com.google.ads.googleads.v5.resources.IncomeRangeView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetIncomeRangeView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.IncomeRangeView.getDefaultInstance()))
  ...
  public static abstract class IncomeRangeViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getIncomeRangeView(com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.IncomeRangeView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest,
                com.google.ads.googleads.v5.resources.IncomeRangeView>(
  ...
  public static final class IncomeRangeViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<IncomeRangeViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.IncomeRangeView getIncomeRangeView(com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest request) {
  ...
  public static final class IncomeRangeViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<IncomeRangeViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.IncomeRangeView> getIncomeRangeView(
        com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_INCOME_RANGE_VIEW:
          serviceImpl.getIncomeRangeView((com.google.ads.googleads.v5.services.GetIncomeRangeViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.IncomeRangeView>) responseObserver);
          break;
        default:
  ...
  private static abstract class IncomeRangeViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.IncomeRangeViewServiceProto.getDescriptor();
    }
