...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/bidding_strategy_service.proto")
public final class BiddingStrategyServiceGrpc {

  private BiddingStrategyServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.BiddingStrategyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetBiddingStrategyRequest,
      com.google.ads.googleads.v5.resources.BiddingStrategy> getGetBiddingStrategyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetBiddingStrategy",
      requestType = com.google.ads.googleads.v5.services.GetBiddingStrategyRequest.class,
      responseType = com.google.ads.googleads.v5.resources.BiddingStrategy.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetBiddingStrategyRequest,
      com.google.ads.googleads.v5.resources.BiddingStrategy> getGetBiddingStrategyMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetBiddingStrategyRequest, com.google.ads.googleads.v5.resources.BiddingStrategy> getGetBiddingStrategyMethod;
      ...
      synchronized (BiddingStrategyServiceGrpc.class) {
        if ((getGetBiddingStrategyMethod = BiddingStrategyServiceGrpc.getGetBiddingStrategyMethod) == null) {
          BiddingStrategyServiceGrpc.getGetBiddingStrategyMethod = getGetBiddingStrategyMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetBiddingStrategyRequest, com.google.ads.googleads.v5.resources.BiddingStrategy>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetBiddingStrategy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetBiddingStrategyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.BiddingStrategy.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest,
      com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse> getMutateBiddingStrategiesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateBiddingStrategies",
      requestType = com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest,
      com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse> getMutateBiddingStrategiesMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest, com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse> getMutateBiddingStrategiesMethod;
      ...
      synchronized (BiddingStrategyServiceGrpc.class) {
        if ((getMutateBiddingStrategiesMethod = BiddingStrategyServiceGrpc.getMutateBiddingStrategiesMethod) == null) {
          BiddingStrategyServiceGrpc.getMutateBiddingStrategiesMethod = getMutateBiddingStrategiesMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest, com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateBiddingStrategies"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse.getDefaultInstance()))
  ...
  public static abstract class BiddingStrategyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getBiddingStrategy(com.google.ads.googleads.v5.services.GetBiddingStrategyRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.BiddingStrategy> responseObserver) {
     ...
     * </pre>
     */
    public void mutateBiddingStrategies(com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetBiddingStrategyRequest,
                com.google.ads.googleads.v5.resources.BiddingStrategy>(
                  this, METHODID_GET_BIDDING_STRATEGY)))
          .addMethod(
            getMutateBiddingStrategiesMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest,
                com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse>(
  ...
  public static final class BiddingStrategyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BiddingStrategyServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.BiddingStrategy getBiddingStrategy(com.google.ads.googleads.v5.services.GetBiddingStrategyRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse mutateBiddingStrategies(com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class BiddingStrategyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BiddingStrategyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.BiddingStrategy> getBiddingStrategy(
        com.google.ads.googleads.v5.services.GetBiddingStrategyRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse> mutateBiddingStrategies(
        com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BIDDING_STRATEGY:
          serviceImpl.getBiddingStrategy((com.google.ads.googleads.v5.services.GetBiddingStrategyRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.BiddingStrategy>) responseObserver);
          break;
        case METHODID_MUTATE_BIDDING_STRATEGIES:
          serviceImpl.mutateBiddingStrategies((com.google.ads.googleads.v5.services.MutateBiddingStrategiesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateBiddingStrategiesResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BiddingStrategyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.BiddingStrategyServiceProto.getDescriptor();
    }
