...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/remarketing_action_service.proto")
public final class RemarketingActionServiceGrpc {

  private RemarketingActionServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.RemarketingActionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetRemarketingActionRequest,
      com.google.ads.googleads.v5.resources.RemarketingAction> getGetRemarketingActionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetRemarketingAction",
      requestType = com.google.ads.googleads.v5.services.GetRemarketingActionRequest.class,
      responseType = com.google.ads.googleads.v5.resources.RemarketingAction.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetRemarketingActionRequest,
      com.google.ads.googleads.v5.resources.RemarketingAction> getGetRemarketingActionMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetRemarketingActionRequest, com.google.ads.googleads.v5.resources.RemarketingAction> getGetRemarketingActionMethod;
      ...
      synchronized (RemarketingActionServiceGrpc.class) {
        if ((getGetRemarketingActionMethod = RemarketingActionServiceGrpc.getGetRemarketingActionMethod) == null) {
          RemarketingActionServiceGrpc.getGetRemarketingActionMethod = getGetRemarketingActionMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetRemarketingActionRequest, com.google.ads.googleads.v5.resources.RemarketingAction>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetRemarketingAction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetRemarketingActionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.RemarketingAction.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest,
      com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse> getMutateRemarketingActionsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateRemarketingActions",
      requestType = com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest,
      com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse> getMutateRemarketingActionsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest, com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse> getMutateRemarketingActionsMethod;
      ...
      synchronized (RemarketingActionServiceGrpc.class) {
        if ((getMutateRemarketingActionsMethod = RemarketingActionServiceGrpc.getMutateRemarketingActionsMethod) == null) {
          RemarketingActionServiceGrpc.getMutateRemarketingActionsMethod = getMutateRemarketingActionsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest, com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateRemarketingActions"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse.getDefaultInstance()))
  ...
  public static abstract class RemarketingActionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getRemarketingAction(com.google.ads.googleads.v5.services.GetRemarketingActionRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.RemarketingAction> responseObserver) {
     ...
     * </pre>
     */
    public void mutateRemarketingActions(com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetRemarketingActionRequest,
                com.google.ads.googleads.v5.resources.RemarketingAction>(
                  this, METHODID_GET_REMARKETING_ACTION)))
          .addMethod(
            getMutateRemarketingActionsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest,
                com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse>(
  ...
  public static final class RemarketingActionServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RemarketingActionServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.RemarketingAction getRemarketingAction(com.google.ads.googleads.v5.services.GetRemarketingActionRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse mutateRemarketingActions(com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class RemarketingActionServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RemarketingActionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.RemarketingAction> getRemarketingAction(
        com.google.ads.googleads.v5.services.GetRemarketingActionRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse> mutateRemarketingActions(
        com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_REMARKETING_ACTION:
          serviceImpl.getRemarketingAction((com.google.ads.googleads.v5.services.GetRemarketingActionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.RemarketingAction>) responseObserver);
          break;
        case METHODID_MUTATE_REMARKETING_ACTIONS:
          serviceImpl.mutateRemarketingActions((com.google.ads.googleads.v5.services.MutateRemarketingActionsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateRemarketingActionsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class RemarketingActionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.RemarketingActionServiceProto.getDescriptor();
    }
