...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/ad_group_extension_setting_service.proto")
public final class AdGroupExtensionSettingServiceGrpc {

  private AdGroupExtensionSettingServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.AdGroupExtensionSettingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest,
      com.google.ads.googleads.v5.resources.AdGroupExtensionSetting> getGetAdGroupExtensionSettingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupExtensionSetting",
      requestType = com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest.class,
      responseType = com.google.ads.googleads.v5.resources.AdGroupExtensionSetting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest,
      com.google.ads.googleads.v5.resources.AdGroupExtensionSetting> getGetAdGroupExtensionSettingMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest, com.google.ads.googleads.v5.resources.AdGroupExtensionSetting> getGetAdGroupExtensionSettingMethod;
      ...
      synchronized (AdGroupExtensionSettingServiceGrpc.class) {
        if ((getGetAdGroupExtensionSettingMethod = AdGroupExtensionSettingServiceGrpc.getGetAdGroupExtensionSettingMethod) == null) {
          AdGroupExtensionSettingServiceGrpc.getGetAdGroupExtensionSettingMethod = getGetAdGroupExtensionSettingMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest, com.google.ads.googleads.v5.resources.AdGroupExtensionSetting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupExtensionSetting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.AdGroupExtensionSetting.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest,
      com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse> getMutateAdGroupExtensionSettingsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdGroupExtensionSettings",
      requestType = com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest,
      com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse> getMutateAdGroupExtensionSettingsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest, com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse> getMutateAdGroupExtensionSettingsMethod;
      ...
      synchronized (AdGroupExtensionSettingServiceGrpc.class) {
        if ((getMutateAdGroupExtensionSettingsMethod = AdGroupExtensionSettingServiceGrpc.getMutateAdGroupExtensionSettingsMethod) == null) {
          AdGroupExtensionSettingServiceGrpc.getMutateAdGroupExtensionSettingsMethod = getMutateAdGroupExtensionSettingsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest, com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdGroupExtensionSettings"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse.getDefaultInstance()))
  ...
  public static abstract class AdGroupExtensionSettingServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroupExtensionSetting(com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.AdGroupExtensionSetting> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAdGroupExtensionSettings(com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest,
                com.google.ads.googleads.v5.resources.AdGroupExtensionSetting>(
                  this, METHODID_GET_AD_GROUP_EXTENSION_SETTING)))
          .addMethod(
            getMutateAdGroupExtensionSettingsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest,
                com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse>(
  ...
  public static final class AdGroupExtensionSettingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupExtensionSettingServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.AdGroupExtensionSetting getAdGroupExtensionSetting(com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse mutateAdGroupExtensionSettings(com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AdGroupExtensionSettingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupExtensionSettingServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.AdGroupExtensionSetting> getAdGroupExtensionSetting(
        com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse> mutateAdGroupExtensionSettings(
        com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_EXTENSION_SETTING:
          serviceImpl.getAdGroupExtensionSetting((com.google.ads.googleads.v5.services.GetAdGroupExtensionSettingRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.AdGroupExtensionSetting>) responseObserver);
          break;
        case METHODID_MUTATE_AD_GROUP_EXTENSION_SETTINGS:
          serviceImpl.mutateAdGroupExtensionSettings((com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateAdGroupExtensionSettingsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupExtensionSettingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.AdGroupExtensionSettingServiceProto.getDescriptor();
    }
