...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/keyword_plan_ad_group_service.proto")
public final class KeywordPlanAdGroupServiceGrpc {

  private KeywordPlanAdGroupServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.KeywordPlanAdGroupService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest,
      com.google.ads.googleads.v5.resources.KeywordPlanAdGroup> getGetKeywordPlanAdGroupMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetKeywordPlanAdGroup",
      requestType = com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest.class,
      responseType = com.google.ads.googleads.v5.resources.KeywordPlanAdGroup.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest,
      com.google.ads.googleads.v5.resources.KeywordPlanAdGroup> getGetKeywordPlanAdGroupMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest, com.google.ads.googleads.v5.resources.KeywordPlanAdGroup> getGetKeywordPlanAdGroupMethod;
      ...
      synchronized (KeywordPlanAdGroupServiceGrpc.class) {
        if ((getGetKeywordPlanAdGroupMethod = KeywordPlanAdGroupServiceGrpc.getGetKeywordPlanAdGroupMethod) == null) {
          KeywordPlanAdGroupServiceGrpc.getGetKeywordPlanAdGroupMethod = getGetKeywordPlanAdGroupMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest, com.google.ads.googleads.v5.resources.KeywordPlanAdGroup>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetKeywordPlanAdGroup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.KeywordPlanAdGroup.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest,
      com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse> getMutateKeywordPlanAdGroupsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateKeywordPlanAdGroups",
      requestType = com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest,
      com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse> getMutateKeywordPlanAdGroupsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest, com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse> getMutateKeywordPlanAdGroupsMethod;
      ...
      synchronized (KeywordPlanAdGroupServiceGrpc.class) {
        if ((getMutateKeywordPlanAdGroupsMethod = KeywordPlanAdGroupServiceGrpc.getMutateKeywordPlanAdGroupsMethod) == null) {
          KeywordPlanAdGroupServiceGrpc.getMutateKeywordPlanAdGroupsMethod = getMutateKeywordPlanAdGroupsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest, com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateKeywordPlanAdGroups"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse.getDefaultInstance()))
  ...
  public static abstract class KeywordPlanAdGroupServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getKeywordPlanAdGroup(com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.KeywordPlanAdGroup> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetKeywordPlanAdGroupMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public void mutateKeywordPlanAdGroups(com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest,
                com.google.ads.googleads.v5.resources.KeywordPlanAdGroup>(
                  this, METHODID_GET_KEYWORD_PLAN_AD_GROUP)))
          .addMethod(
            getMutateKeywordPlanAdGroupsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest,
                com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse>(
  ...
  public static final class KeywordPlanAdGroupServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<KeywordPlanAdGroupServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.KeywordPlanAdGroup getKeywordPlanAdGroup(com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse mutateKeywordPlanAdGroups(com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class KeywordPlanAdGroupServiceFutureStub extends io.grpc.stub.AbstractFutureStub<KeywordPlanAdGroupServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.KeywordPlanAdGroup> getKeywordPlanAdGroup(
        com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse> mutateKeywordPlanAdGroups(
        com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_KEYWORD_PLAN_AD_GROUP:
          serviceImpl.getKeywordPlanAdGroup((com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.KeywordPlanAdGroup>) responseObserver);
          break;
        case METHODID_MUTATE_KEYWORD_PLAN_AD_GROUPS:
          serviceImpl.mutateKeywordPlanAdGroups((com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class KeywordPlanAdGroupServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.KeywordPlanAdGroupServiceProto.getDescriptor();
    }
