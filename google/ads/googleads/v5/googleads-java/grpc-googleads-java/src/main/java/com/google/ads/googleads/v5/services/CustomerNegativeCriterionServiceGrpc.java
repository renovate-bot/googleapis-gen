...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/customer_negative_criterion_service.proto")
public final class CustomerNegativeCriterionServiceGrpc {

  private CustomerNegativeCriterionServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.CustomerNegativeCriterionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCustomerNegativeCriterionRequest,
      com.google.ads.googleads.v5.resources.CustomerNegativeCriterion> getGetCustomerNegativeCriterionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCustomerNegativeCriterion",
      requestType = com.google.ads.googleads.v5.services.GetCustomerNegativeCriterionRequest.class,
      responseType = com.google.ads.googleads.v5.resources.CustomerNegativeCriterion.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCustomerNegativeCriterionRequest,
      com.google.ads.googleads.v5.resources.CustomerNegativeCriterion> getGetCustomerNegativeCriterionMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCustomerNegativeCriterionRequest, com.google.ads.googleads.v5.resources.CustomerNegativeCriterion> getGetCustomerNegativeCriterionMethod;
      ...
      synchronized (CustomerNegativeCriterionServiceGrpc.class) {
        if ((getGetCustomerNegativeCriterionMethod = CustomerNegativeCriterionServiceGrpc.getGetCustomerNegativeCriterionMethod) == null) {
          CustomerNegativeCriterionServiceGrpc.getGetCustomerNegativeCriterionMethod = getGetCustomerNegativeCriterionMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetCustomerNegativeCriterionRequest, com.google.ads.googleads.v5.resources.CustomerNegativeCriterion>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCustomerNegativeCriterion"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetCustomerNegativeCriterionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.CustomerNegativeCriterion.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaRequest,
      com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaResponse> getMutateCustomerNegativeCriteriaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCustomerNegativeCriteria",
      requestType = com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaRequest,
      com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaResponse> getMutateCustomerNegativeCriteriaMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaRequest, com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaResponse> getMutateCustomerNegativeCriteriaMethod;
      ...
      synchronized (CustomerNegativeCriterionServiceGrpc.class) {
        if ((getMutateCustomerNegativeCriteriaMethod = CustomerNegativeCriterionServiceGrpc.getMutateCustomerNegativeCriteriaMethod) == null) {
          CustomerNegativeCriterionServiceGrpc.getMutateCustomerNegativeCriteriaMethod = getMutateCustomerNegativeCriteriaMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaRequest, com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCustomerNegativeCriteria"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaResponse.getDefaultInstance()))
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CUSTOMER_NEGATIVE_CRITERION:
          serviceImpl.getCustomerNegativeCriterion((com.google.ads.googleads.v5.services.GetCustomerNegativeCriterionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CustomerNegativeCriterion>) responseObserver);
          break;
        case METHODID_MUTATE_CUSTOMER_NEGATIVE_CRITERIA:
          serviceImpl.mutateCustomerNegativeCriteria((com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CustomerNegativeCriterionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.CustomerNegativeCriterionServiceProto.getDescriptor();
    }
