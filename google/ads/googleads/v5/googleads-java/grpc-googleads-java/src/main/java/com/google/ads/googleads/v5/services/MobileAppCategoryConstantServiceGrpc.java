...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/mobile_app_category_constant_service.proto")
public final class MobileAppCategoryConstantServiceGrpc {

  private MobileAppCategoryConstantServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.MobileAppCategoryConstantService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest,
      com.google.ads.googleads.v5.resources.MobileAppCategoryConstant> getGetMobileAppCategoryConstantMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMobileAppCategoryConstant",
      requestType = com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest.class,
      responseType = com.google.ads.googleads.v5.resources.MobileAppCategoryConstant.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest,
      com.google.ads.googleads.v5.resources.MobileAppCategoryConstant> getGetMobileAppCategoryConstantMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest, com.google.ads.googleads.v5.resources.MobileAppCategoryConstant> getGetMobileAppCategoryConstantMethod;
      ...
      synchronized (MobileAppCategoryConstantServiceGrpc.class) {
        if ((getGetMobileAppCategoryConstantMethod = MobileAppCategoryConstantServiceGrpc.getGetMobileAppCategoryConstantMethod) == null) {
          MobileAppCategoryConstantServiceGrpc.getGetMobileAppCategoryConstantMethod = getGetMobileAppCategoryConstantMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest, com.google.ads.googleads.v5.resources.MobileAppCategoryConstant>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetMobileAppCategoryConstant"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.MobileAppCategoryConstant.getDefaultInstance()))
  ...
  public static abstract class MobileAppCategoryConstantServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getMobileAppCategoryConstant(com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.MobileAppCategoryConstant> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest,
                com.google.ads.googleads.v5.resources.MobileAppCategoryConstant>(
  ...
  public static final class MobileAppCategoryConstantServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MobileAppCategoryConstantServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.MobileAppCategoryConstant getMobileAppCategoryConstant(com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest request) {
  ...
  public static final class MobileAppCategoryConstantServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MobileAppCategoryConstantServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.MobileAppCategoryConstant> getMobileAppCategoryConstant(
        com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MOBILE_APP_CATEGORY_CONSTANT:
          serviceImpl.getMobileAppCategoryConstant((com.google.ads.googleads.v5.services.GetMobileAppCategoryConstantRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.MobileAppCategoryConstant>) responseObserver);
          break;
        default:
  ...
  private static abstract class MobileAppCategoryConstantServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.MobileAppCategoryConstantServiceProto.getDescriptor();
    }
