...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/keyword_plan_ad_group_keyword_service.proto")
public final class KeywordPlanAdGroupKeywordServiceGrpc {

  private KeywordPlanAdGroupKeywordServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest,
      com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword> getGetKeywordPlanAdGroupKeywordMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetKeywordPlanAdGroupKeyword",
      requestType = com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest.class,
      responseType = com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest,
      com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword> getGetKeywordPlanAdGroupKeywordMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest, com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword> getGetKeywordPlanAdGroupKeywordMethod;
      ...
      synchronized (KeywordPlanAdGroupKeywordServiceGrpc.class) {
        if ((getGetKeywordPlanAdGroupKeywordMethod = KeywordPlanAdGroupKeywordServiceGrpc.getGetKeywordPlanAdGroupKeywordMethod) == null) {
          KeywordPlanAdGroupKeywordServiceGrpc.getGetKeywordPlanAdGroupKeywordMethod = getGetKeywordPlanAdGroupKeywordMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest, com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetKeywordPlanAdGroupKeyword"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest,
      com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse> getMutateKeywordPlanAdGroupKeywordsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateKeywordPlanAdGroupKeywords",
      requestType = com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest,
      com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse> getMutateKeywordPlanAdGroupKeywordsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest, com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse> getMutateKeywordPlanAdGroupKeywordsMethod;
      ...
      synchronized (KeywordPlanAdGroupKeywordServiceGrpc.class) {
        if ((getMutateKeywordPlanAdGroupKeywordsMethod = KeywordPlanAdGroupKeywordServiceGrpc.getMutateKeywordPlanAdGroupKeywordsMethod) == null) {
          KeywordPlanAdGroupKeywordServiceGrpc.getMutateKeywordPlanAdGroupKeywordsMethod = getMutateKeywordPlanAdGroupKeywordsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest, com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateKeywordPlanAdGroupKeywords"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse.getDefaultInstance()))
  ...
  public static abstract class KeywordPlanAdGroupKeywordServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getKeywordPlanAdGroupKeyword(com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword> responseObserver) {
     ...
     * </pre>
     */
    public void mutateKeywordPlanAdGroupKeywords(com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest,
                com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword>(
                  this, METHODID_GET_KEYWORD_PLAN_AD_GROUP_KEYWORD)))
          .addMethod(
            getMutateKeywordPlanAdGroupKeywordsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest,
                com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse>(
  ...
  public static final class KeywordPlanAdGroupKeywordServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<KeywordPlanAdGroupKeywordServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword getKeywordPlanAdGroupKeyword(com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse mutateKeywordPlanAdGroupKeywords(com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class KeywordPlanAdGroupKeywordServiceFutureStub extends io.grpc.stub.AbstractFutureStub<KeywordPlanAdGroupKeywordServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword> getKeywordPlanAdGroupKeyword(
        com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse> mutateKeywordPlanAdGroupKeywords(
        com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_KEYWORD_PLAN_AD_GROUP_KEYWORD:
          serviceImpl.getKeywordPlanAdGroupKeyword((com.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword>) responseObserver);
          break;
        case METHODID_MUTATE_KEYWORD_PLAN_AD_GROUP_KEYWORDS:
          serviceImpl.mutateKeywordPlanAdGroupKeywords((com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class KeywordPlanAdGroupKeywordServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordServiceProto.getDescriptor();
    }
