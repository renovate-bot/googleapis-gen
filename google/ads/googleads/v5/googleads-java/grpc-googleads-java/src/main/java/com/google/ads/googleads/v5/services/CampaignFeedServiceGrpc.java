...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/campaign_feed_service.proto")
public final class CampaignFeedServiceGrpc {

  private CampaignFeedServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.CampaignFeedService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignFeedRequest,
      com.google.ads.googleads.v5.resources.CampaignFeed> getGetCampaignFeedMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignFeed",
      requestType = com.google.ads.googleads.v5.services.GetCampaignFeedRequest.class,
      responseType = com.google.ads.googleads.v5.resources.CampaignFeed.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignFeedRequest,
      com.google.ads.googleads.v5.resources.CampaignFeed> getGetCampaignFeedMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetCampaignFeedRequest, com.google.ads.googleads.v5.resources.CampaignFeed> getGetCampaignFeedMethod;
      ...
      synchronized (CampaignFeedServiceGrpc.class) {
        if ((getGetCampaignFeedMethod = CampaignFeedServiceGrpc.getGetCampaignFeedMethod) == null) {
          CampaignFeedServiceGrpc.getGetCampaignFeedMethod = getGetCampaignFeedMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetCampaignFeedRequest, com.google.ads.googleads.v5.resources.CampaignFeed>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignFeed"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetCampaignFeedRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.CampaignFeed.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest,
      com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse> getMutateCampaignFeedsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCampaignFeeds",
      requestType = com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest.class,
      responseType = com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest,
      com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse> getMutateCampaignFeedsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest, com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse> getMutateCampaignFeedsMethod;
      ...
      synchronized (CampaignFeedServiceGrpc.class) {
        if ((getMutateCampaignFeedsMethod = CampaignFeedServiceGrpc.getMutateCampaignFeedsMethod) == null) {
          CampaignFeedServiceGrpc.getMutateCampaignFeedsMethod = getMutateCampaignFeedsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest, com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCampaignFeeds"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse.getDefaultInstance()))
  ...
  public static abstract class CampaignFeedServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignFeed(com.google.ads.googleads.v5.services.GetCampaignFeedRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CampaignFeed> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCampaignFeeds(com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetCampaignFeedRequest,
                com.google.ads.googleads.v5.resources.CampaignFeed>(
                  this, METHODID_GET_CAMPAIGN_FEED)))
          .addMethod(
            getMutateCampaignFeedsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest,
                com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse>(
  ...
  public static final class CampaignFeedServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignFeedServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.CampaignFeed getCampaignFeed(com.google.ads.googleads.v5.services.GetCampaignFeedRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse mutateCampaignFeeds(com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CampaignFeedServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignFeedServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.CampaignFeed> getCampaignFeed(
        com.google.ads.googleads.v5.services.GetCampaignFeedRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse> mutateCampaignFeeds(
        com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_FEED:
          serviceImpl.getCampaignFeed((com.google.ads.googleads.v5.services.GetCampaignFeedRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.CampaignFeed>) responseObserver);
          break;
        case METHODID_MUTATE_CAMPAIGN_FEEDS:
          serviceImpl.mutateCampaignFeeds((com.google.ads.googleads.v5.services.MutateCampaignFeedsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.MutateCampaignFeedsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignFeedServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.CampaignFeedServiceProto.getDescriptor();
    }
