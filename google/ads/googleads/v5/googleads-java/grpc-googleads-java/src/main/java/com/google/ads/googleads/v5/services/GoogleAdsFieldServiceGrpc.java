...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v5/services/google_ads_field_service.proto")
public final class GoogleAdsFieldServiceGrpc {

  private GoogleAdsFieldServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v5.services.GoogleAdsFieldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest,
      com.google.ads.googleads.v5.resources.GoogleAdsField> getGetGoogleAdsFieldMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetGoogleAdsField",
      requestType = com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest.class,
      responseType = com.google.ads.googleads.v5.resources.GoogleAdsField.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest,
      com.google.ads.googleads.v5.resources.GoogleAdsField> getGetGoogleAdsFieldMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest, com.google.ads.googleads.v5.resources.GoogleAdsField> getGetGoogleAdsFieldMethod;
      ...
      synchronized (GoogleAdsFieldServiceGrpc.class) {
        if ((getGetGoogleAdsFieldMethod = GoogleAdsFieldServiceGrpc.getGetGoogleAdsFieldMethod) == null) {
          GoogleAdsFieldServiceGrpc.getGetGoogleAdsFieldMethod = getGetGoogleAdsFieldMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest, com.google.ads.googleads.v5.resources.GoogleAdsField>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetGoogleAdsField"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.resources.GoogleAdsField.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest,
      com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse> getSearchGoogleAdsFieldsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SearchGoogleAdsFields",
      requestType = com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest.class,
      responseType = com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest,
      com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse> getSearchGoogleAdsFieldsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest, com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse> getSearchGoogleAdsFieldsMethod;
      ...
      synchronized (GoogleAdsFieldServiceGrpc.class) {
        if ((getSearchGoogleAdsFieldsMethod = GoogleAdsFieldServiceGrpc.getSearchGoogleAdsFieldsMethod) == null) {
          GoogleAdsFieldServiceGrpc.getSearchGoogleAdsFieldsMethod = getSearchGoogleAdsFieldsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest, com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SearchGoogleAdsFields"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse.getDefaultInstance()))
  ...
  public static abstract class GoogleAdsFieldServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getGoogleAdsField(com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.GoogleAdsField> responseObserver) {
     ...
     * </pre>
     */
    public void searchGoogleAdsFields(com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest,
                com.google.ads.googleads.v5.resources.GoogleAdsField>(
                  this, METHODID_GET_GOOGLE_ADS_FIELD)))
          .addMethod(
            getSearchGoogleAdsFieldsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest,
                com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse>(
  ...
  public static final class GoogleAdsFieldServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GoogleAdsFieldServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.resources.GoogleAdsField getGoogleAdsField(com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse searchGoogleAdsFields(com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class GoogleAdsFieldServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GoogleAdsFieldServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.resources.GoogleAdsField> getGoogleAdsField(
        com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse> searchGoogleAdsFields(
        com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_GOOGLE_ADS_FIELD:
          serviceImpl.getGoogleAdsField((com.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.resources.GoogleAdsField>) responseObserver);
          break;
        case METHODID_SEARCH_GOOGLE_ADS_FIELDS:
          serviceImpl.searchGoogleAdsFields((com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v5.services.SearchGoogleAdsFieldsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GoogleAdsFieldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v5.services.GoogleAdsFieldServiceProto.getDescriptor();
    }
