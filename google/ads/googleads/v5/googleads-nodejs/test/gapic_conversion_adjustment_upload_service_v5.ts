...
import * as conversionadjustmentuploadserviceModule from '../src';
...
describe('v5.ConversionAdjustmentUploadServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionadjustmentuploadserviceModule.v5.ConversionAdjustmentUploadServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionadjustmentuploadserviceModule.v5.ConversionAdjustmentUploadServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionadjustmentuploadserviceModule.v5.ConversionAdjustmentUploadServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionadjustmentuploadserviceModule.v5.ConversionAdjustmentUploadServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.conversionAdjustmentUploadServiceStub, undefined);
        await client.initialize();
        assert(client.conversionAdjustmentUploadServiceStub);
    });
    ...
    describe('uploadConversionAdjustments', () => {
        it('invokes uploadConversionAdjustments without error', async () => {
            const client = new conversionadjustmentuploadserviceModule.v5.ConversionAdjustmentUploadServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.UploadConversionAdjustmentsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.UploadConversionAdjustmentsResponse());
            client.innerApiCalls.uploadConversionAdjustments = stubSimpleCall(expectedResponse);
            const [response] = await client.uploadConversionAdjustments(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.uploadConversionAdjustments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes uploadConversionAdjustments without error using callback', async () => {
            const client = new conversionadjustmentuploadserviceModule.v5.ConversionAdjustmentUploadServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.UploadConversionAdjustmentsResponse());
            client.innerApiCalls.uploadConversionAdjustments = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.uploadConversionAdjustments(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IUploadConversionAdjustmentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes uploadConversionAdjustments with error', async () => {
            const client = new conversionadjustmentuploadserviceModule.v5.ConversionAdjustmentUploadServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.uploadConversionAdjustments = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.uploadConversionAdjustments(request), expectedError);
            assert((client.innerApiCalls.uploadConversionAdjustments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
