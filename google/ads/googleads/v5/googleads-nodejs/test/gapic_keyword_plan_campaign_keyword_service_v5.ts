...
describe('v5.KeywordPlanCampaignKeywordServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplancampaignkeywordserviceModule.v5.KeywordPlanCampaignKeywordServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplancampaignkeywordserviceModule.v5.KeywordPlanCampaignKeywordServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplancampaignkeywordserviceModule.v5.KeywordPlanCampaignKeywordServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplancampaignkeywordserviceModule.v5.KeywordPlanCampaignKeywordServiceClient();
        assert(client);
    });
    ...
    describe('getKeywordPlanCampaignKeyword', () => {
        it('invokes getKeywordPlanCampaignKeyword without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetKeywordPlanCampaignKeywordRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.KeywordPlanCampaignKeyword());
        ...
        it('invokes getKeywordPlanCampaignKeyword without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanCampaignKeyword(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IKeywordPlanCampaignKeyword|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateKeywordPlanCampaignKeywords', () => {
        it('invokes mutateKeywordPlanCampaignKeywords without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateKeywordPlanCampaignKeywordsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateKeywordPlanCampaignKeywordsResponse());
        ...
        it('invokes mutateKeywordPlanCampaignKeywords without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanCampaignKeywords(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignKeywordsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
