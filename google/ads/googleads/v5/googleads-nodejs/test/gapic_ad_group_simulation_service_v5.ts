...
import * as adgroupsimulationserviceModule from '../src';
...
describe('v5.AdGroupSimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupsimulationserviceModule.v5.AdGroupSimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupsimulationserviceModule.v5.AdGroupSimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupsimulationserviceModule.v5.AdGroupSimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupsimulationserviceModule.v5.AdGroupSimulationServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupSimulationServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupSimulationServiceStub);
    });
    ...
    describe('getAdGroupSimulation', () => {
        it('invokes getAdGroupSimulation without error', async () => {
            const client = new adgroupsimulationserviceModule.v5.AdGroupSimulationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAdGroupSimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupSimulation());
            client.innerApiCalls.getAdGroupSimulation = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupSimulation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupSimulation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupSimulation without error using callback', async () => {
            const client = new adgroupsimulationserviceModule.v5.AdGroupSimulationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupSimulation());
            client.innerApiCalls.getAdGroupSimulation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAdGroupSimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupSimulation with error', async () => {
            const client = new adgroupsimulationserviceModule.v5.AdGroupSimulationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdGroupSimulation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupSimulation(request), expectedError);
            assert((client.innerApiCalls.getAdGroupSimulation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
