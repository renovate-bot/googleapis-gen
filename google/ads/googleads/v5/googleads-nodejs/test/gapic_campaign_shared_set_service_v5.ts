...
import * as campaignsharedsetserviceModule from '../src';
...
describe('v5.CampaignSharedSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignsharedsetserviceModule.v5.CampaignSharedSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignsharedsetserviceModule.v5.CampaignSharedSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignsharedsetserviceModule.v5.CampaignSharedSetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignsharedsetserviceModule.v5.CampaignSharedSetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.campaignSharedSetServiceStub);
    });
    ...
    describe('getCampaignSharedSet', () => {
        it('invokes getCampaignSharedSet without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCampaignSharedSetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CampaignSharedSet());
            client.innerApiCalls.getCampaignSharedSet = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignSharedSet(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignSharedSet as SinonStub)
        ...
        it('invokes getCampaignSharedSet without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CampaignSharedSet());
            client.innerApiCalls.getCampaignSharedSet = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignSharedSet(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICampaignSharedSet|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignSharedSet with error', async () => {
            ...
            client.innerApiCalls.getCampaignSharedSet = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignSharedSet(request), expectedError);
            assert((client.innerApiCalls.getCampaignSharedSet as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateCampaignSharedSets', () => {
        it('invokes mutateCampaignSharedSets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignSharedSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse());
            client.innerApiCalls.mutateCampaignSharedSets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignSharedSets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaignSharedSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateCampaignSharedSets without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignSharedSetsResponse());
            client.innerApiCalls.mutateCampaignSharedSets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignSharedSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateCampaignSharedSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignSharedSets with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCampaignSharedSets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignSharedSets(request), expectedError);
            assert((client.innerApiCalls.mutateCampaignSharedSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
