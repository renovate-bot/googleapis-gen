...
describe('v5.LanguageConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = languageconstantserviceModule.v5.LanguageConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = languageconstantserviceModule.v5.LanguageConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = languageconstantserviceModule.v5.LanguageConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new languageconstantserviceModule.v5.LanguageConstantServiceClient();
        assert(client);
    });
    ...
    describe('getLanguageConstant', () => {
        it('invokes getLanguageConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetLanguageConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.LanguageConstant());
        ...
        it('invokes getLanguageConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLanguageConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ILanguageConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
