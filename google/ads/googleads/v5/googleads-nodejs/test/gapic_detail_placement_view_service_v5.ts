...
describe('v5.DetailPlacementViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = detailplacementviewserviceModule.v5.DetailPlacementViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = detailplacementviewserviceModule.v5.DetailPlacementViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = detailplacementviewserviceModule.v5.DetailPlacementViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new detailplacementviewserviceModule.v5.DetailPlacementViewServiceClient();
        assert(client);
    });
    ...
    describe('getDetailPlacementView', () => {
        it('invokes getDetailPlacementView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetDetailPlacementViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.DetailPlacementView());
        ...
        it('invokes getDetailPlacementView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDetailPlacementView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IDetailPlacementView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
