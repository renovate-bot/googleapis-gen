...
import * as landingpageviewserviceModule from '../src';
...
describe('v5.LandingPageViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = landingpageviewserviceModule.v5.LandingPageViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = landingpageviewserviceModule.v5.LandingPageViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = landingpageviewserviceModule.v5.LandingPageViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new landingpageviewserviceModule.v5.LandingPageViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.landingPageViewServiceStub, undefined);
        await client.initialize();
        assert(client.landingPageViewServiceStub);
    });
    ...
    describe('getLandingPageView', () => {
        it('invokes getLandingPageView without error', async () => {
            const client = new landingpageviewserviceModule.v5.LandingPageViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetLandingPageViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.LandingPageView());
            client.innerApiCalls.getLandingPageView = stubSimpleCall(expectedResponse);
            const [response] = await client.getLandingPageView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getLandingPageView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getLandingPageView without error using callback', async () => {
            const client = new landingpageviewserviceModule.v5.LandingPageViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.LandingPageView());
            client.innerApiCalls.getLandingPageView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getLandingPageView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ILandingPageView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getLandingPageView with error', async () => {
            const client = new landingpageviewserviceModule.v5.LandingPageViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getLandingPageView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getLandingPageView(request), expectedError);
            assert((client.innerApiCalls.getLandingPageView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
