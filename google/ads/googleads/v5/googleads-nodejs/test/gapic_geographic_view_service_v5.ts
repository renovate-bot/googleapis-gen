...
describe('v5.GeographicViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = geographicviewserviceModule.v5.GeographicViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = geographicviewserviceModule.v5.GeographicViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = geographicviewserviceModule.v5.GeographicViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new geographicviewserviceModule.v5.GeographicViewServiceClient();
        assert(client);
    });
    ...
    describe('getGeographicView', () => {
        it('invokes getGeographicView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetGeographicViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.GeographicView());
        ...
        it('invokes getGeographicView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGeographicView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IGeographicView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
