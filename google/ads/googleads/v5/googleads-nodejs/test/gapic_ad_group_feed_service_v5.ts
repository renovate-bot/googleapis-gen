...
describe('v5.AdGroupFeedServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupfeedserviceModule.v5.AdGroupFeedServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupfeedserviceModule.v5.AdGroupFeedServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupfeedserviceModule.v5.AdGroupFeedServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupfeedserviceModule.v5.AdGroupFeedServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupFeed', () => {
        it('invokes getAdGroupFeed without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAdGroupFeedRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupFeed());
        ...
        it('invokes getAdGroupFeed without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupFeed(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAdGroupFeed|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupFeeds', () => {
        it('invokes mutateAdGroupFeeds without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupFeedsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupFeedsResponse());
        ...
        it('invokes mutateAdGroupFeeds without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupFeeds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateAdGroupFeedsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
