...
import * as keywordplanadgroupkeywordserviceModule from '../src';
...
describe('v5.KeywordPlanAdGroupKeywordServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.keywordPlanAdGroupKeywordServiceStub, undefined);
        await client.initialize();
        assert(client.keywordPlanAdGroupKeywordServiceStub);
    });
    ...
    describe('getKeywordPlanAdGroupKeyword', () => {
        it('invokes getKeywordPlanAdGroupKeyword without error', async () => {
            const client = new keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetKeywordPlanAdGroupKeywordRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword());
            client.innerApiCalls.getKeywordPlanAdGroupKeyword = stubSimpleCall(expectedResponse);
            const [response] = await client.getKeywordPlanAdGroupKeyword(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getKeywordPlanAdGroupKeyword as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getKeywordPlanAdGroupKeyword without error using callback', async () => {
            const client = new keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword());
            client.innerApiCalls.getKeywordPlanAdGroupKeyword = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanAdGroupKeyword(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IKeywordPlanAdGroupKeyword|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getKeywordPlanAdGroupKeyword with error', async () => {
            const client = new keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getKeywordPlanAdGroupKeyword = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getKeywordPlanAdGroupKeyword(request), expectedError);
            assert((client.innerApiCalls.getKeywordPlanAdGroupKeyword as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateKeywordPlanAdGroupKeywords', () => {
        it('invokes mutateKeywordPlanAdGroupKeywords without error', async () => {
            const client = new keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse());
            client.innerApiCalls.mutateKeywordPlanAdGroupKeywords = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateKeywordPlanAdGroupKeywords(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateKeywordPlanAdGroupKeywords as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateKeywordPlanAdGroupKeywords without error using callback', async () => {
            const client = new keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse());
            client.innerApiCalls.mutateKeywordPlanAdGroupKeywords = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanAdGroupKeywords(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateKeywordPlanAdGroupKeywordsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateKeywordPlanAdGroupKeywords with error', async () => {
            const client = new keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateKeywordPlanAdGroupKeywords = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateKeywordPlanAdGroupKeywords(request), expectedError);
            assert((client.innerApiCalls.mutateKeywordPlanAdGroupKeywords as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('Path templates', () => {
        ...
        describe('campaignAsset', () => {
            ...
            const expectedParameters = {
                customer: "customerValue",
                campaign_asset: "campaignAssetValue",
            };
            const client = new keywordplanadgroupkeywordserviceModule.v5.KeywordPlanAdGroupKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            it('campaignAssetPath', () => {
                const result = client.campaignAssetPath("customerValue", "campaignAssetValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.campaignAssetPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchCustomerFromCampaignAssetName', () => {
                const result = client.matchCustomerFromCampaignAssetName(fakePath);
                assert.strictEqual(result, "customerValue");
                assert((client.pathTemplates.campaignAssetPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchCampaignAssetFromCampaignAssetName', () => {
                const result = client.matchCampaignAssetFromCampaignAssetName(fakePath);
                assert.strictEqual(result, "campaignAssetValue");
                assert((client.pathTemplates.campaignAssetPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
