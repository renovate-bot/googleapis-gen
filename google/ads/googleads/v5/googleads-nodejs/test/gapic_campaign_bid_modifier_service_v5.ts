...
describe('v5.CampaignBidModifierServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignbidmodifierserviceModule.v5.CampaignBidModifierServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignbidmodifierserviceModule.v5.CampaignBidModifierServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignbidmodifierserviceModule.v5.CampaignBidModifierServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignbidmodifierserviceModule.v5.CampaignBidModifierServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignBidModifier', () => {
        it('invokes getCampaignBidModifier without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCampaignBidModifierRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CampaignBidModifier());
        ...
        it('invokes getCampaignBidModifier without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignBidModifier(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICampaignBidModifier|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignBidModifiers', () => {
        it('invokes mutateCampaignBidModifiers without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignBidModifiersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignBidModifiersResponse());
        ...
        it('invokes mutateCampaignBidModifiers without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignBidModifiers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateCampaignBidModifiersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
