...
describe('v5.BillingSetupServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = billingsetupserviceModule.v5.BillingSetupServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = billingsetupserviceModule.v5.BillingSetupServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = billingsetupserviceModule.v5.BillingSetupServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new billingsetupserviceModule.v5.BillingSetupServiceClient();
        assert(client);
    });
    ...
    describe('getBillingSetup', () => {
        it('invokes getBillingSetup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetBillingSetupRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.BillingSetup());
        ...
        it('invokes getBillingSetup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBillingSetup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IBillingSetup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateBillingSetup', () => {
        it('invokes mutateBillingSetup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateBillingSetupRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateBillingSetupResponse());
        ...
        it('invokes mutateBillingSetup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBillingSetup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateBillingSetupResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
