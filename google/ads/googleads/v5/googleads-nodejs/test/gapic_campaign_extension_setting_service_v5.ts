...
import * as campaignextensionsettingserviceModule from '../src';
...
describe('v5.CampaignExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignextensionsettingserviceModule.v5.CampaignExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignextensionsettingserviceModule.v5.CampaignExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignextensionsettingserviceModule.v5.CampaignExtensionSettingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignextensionsettingserviceModule.v5.CampaignExtensionSettingServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.campaignExtensionSettingServiceStub);
    });
    ...
    describe('getCampaignExtensionSetting', () => {
        it('invokes getCampaignExtensionSetting without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCampaignExtensionSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CampaignExtensionSetting());
            client.innerApiCalls.getCampaignExtensionSetting = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignExtensionSetting(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignExtensionSetting as SinonStub)
        ...
        it('invokes getCampaignExtensionSetting without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CampaignExtensionSetting());
            client.innerApiCalls.getCampaignExtensionSetting = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICampaignExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignExtensionSetting with error', async () => {
            ...
            client.innerApiCalls.getCampaignExtensionSetting = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignExtensionSetting(request), expectedError);
            assert((client.innerApiCalls.getCampaignExtensionSetting as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateCampaignExtensionSettings', () => {
        it('invokes mutateCampaignExtensionSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignExtensionSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignExtensionSettingsResponse());
            client.innerApiCalls.mutateCampaignExtensionSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignExtensionSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaignExtensionSettings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateCampaignExtensionSettings without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignExtensionSettingsResponse());
            client.innerApiCalls.mutateCampaignExtensionSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateCampaignExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignExtensionSettings with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCampaignExtensionSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignExtensionSettings(request), expectedError);
            assert((client.innerApiCalls.mutateCampaignExtensionSettings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
