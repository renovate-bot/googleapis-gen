...
import * as adgroupcriterionsimulationserviceModule from '../src';
...
describe('v5.AdGroupCriterionSimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupcriterionsimulationserviceModule.v5.AdGroupCriterionSimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupcriterionsimulationserviceModule.v5.AdGroupCriterionSimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupcriterionsimulationserviceModule.v5.AdGroupCriterionSimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupcriterionsimulationserviceModule.v5.AdGroupCriterionSimulationServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupCriterionSimulationServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupCriterionSimulationServiceStub);
    });
    ...
    describe('getAdGroupCriterionSimulation', () => {
        it('invokes getAdGroupCriterionSimulation without error', async () => {
            const client = new adgroupcriterionsimulationserviceModule.v5.AdGroupCriterionSimulationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAdGroupCriterionSimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupCriterionSimulation());
            client.innerApiCalls.getAdGroupCriterionSimulation = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupCriterionSimulation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupCriterionSimulation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupCriterionSimulation without error using callback', async () => {
            const client = new adgroupcriterionsimulationserviceModule.v5.AdGroupCriterionSimulationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupCriterionSimulation());
            client.innerApiCalls.getAdGroupCriterionSimulation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupCriterionSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAdGroupCriterionSimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupCriterionSimulation with error', async () => {
            const client = new adgroupcriterionsimulationserviceModule.v5.AdGroupCriterionSimulationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdGroupCriterionSimulation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupCriterionSimulation(request), expectedError);
            assert((client.innerApiCalls.getAdGroupCriterionSimulation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
