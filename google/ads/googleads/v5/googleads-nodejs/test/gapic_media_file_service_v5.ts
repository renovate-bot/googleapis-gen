...
import * as mediafileserviceModule from '../src';
...
describe('v5.MediaFileServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = mediafileserviceModule.v5.MediaFileServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = mediafileserviceModule.v5.MediaFileServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = mediafileserviceModule.v5.MediaFileServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new mediafileserviceModule.v5.MediaFileServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.mediaFileServiceStub, undefined);
        await client.initialize();
        assert(client.mediaFileServiceStub);
    });
    ...
    describe('getMediaFile', () => {
        it('invokes getMediaFile without error', async () => {
            const client = new mediafileserviceModule.v5.MediaFileServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetMediaFileRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.MediaFile());
            client.innerApiCalls.getMediaFile = stubSimpleCall(expectedResponse);
            const [response] = await client.getMediaFile(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getMediaFile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getMediaFile without error using callback', async () => {
            const client = new mediafileserviceModule.v5.MediaFileServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.MediaFile());
            client.innerApiCalls.getMediaFile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMediaFile(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IMediaFile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMediaFile with error', async () => {
            const client = new mediafileserviceModule.v5.MediaFileServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getMediaFile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getMediaFile(request), expectedError);
            assert((client.innerApiCalls.getMediaFile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateMediaFiles', () => {
        it('invokes mutateMediaFiles without error', async () => {
            const client = new mediafileserviceModule.v5.MediaFileServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateMediaFilesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateMediaFilesResponse());
            client.innerApiCalls.mutateMediaFiles = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateMediaFiles(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateMediaFiles as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateMediaFiles without error using callback', async () => {
            const client = new mediafileserviceModule.v5.MediaFileServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateMediaFilesResponse());
            client.innerApiCalls.mutateMediaFiles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateMediaFiles(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateMediaFilesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateMediaFiles with error', async () => {
            const client = new mediafileserviceModule.v5.MediaFileServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateMediaFiles = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateMediaFiles(request), expectedError);
            assert((client.innerApiCalls.mutateMediaFiles as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
