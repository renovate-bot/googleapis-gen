...
import * as keywordplanideaserviceModule from '../src';
...
describe('v5.KeywordPlanIdeaServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanideaserviceModule.v5.KeywordPlanIdeaServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanideaserviceModule.v5.KeywordPlanIdeaServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanideaserviceModule.v5.KeywordPlanIdeaServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplanideaserviceModule.v5.KeywordPlanIdeaServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.keywordPlanIdeaServiceStub);
    });
    ...
    describe('generateKeywordIdeas', () => {
        it('invokes generateKeywordIdeas without error', async () => {
            const client = new keywordplanideaserviceModule.v5.KeywordPlanIdeaServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GenerateKeywordIdeasRequest());
            request.customerId = '';
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v5.services.GenerateKeywordIdeaResult()),
              generateSampleMessage(new protos.google.ads.googleads.v5.services.GenerateKeywordIdeaResult()),
              generateSampleMessage(new protos.google.ads.googleads.v5.services.GenerateKeywordIdeaResult()),
            ];
            client.innerApiCalls.generateKeywordIdeas = stubSimpleCall(expectedResponse);
            const [response] = await client.generateKeywordIdeas(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.generateKeywordIdeas as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes generateKeywordIdeas without error using callback', async () => {
            const client = new keywordplanideaserviceModule.v5.KeywordPlanIdeaServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateKeywordIdeas = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateKeywordIdeas(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IGenerateKeywordIdeaResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateKeywordIdeas with error', async () => {
            const client = new keywordplanideaserviceModule.v5.KeywordPlanIdeaServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.generateKeywordIdeas = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.generateKeywordIdeas(request), expectedError);
            assert((client.innerApiCalls.generateKeywordIdeas as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes generateKeywordIdeasStream without error', async () => {
            const client = new keywordplanideaserviceModule.v5.KeywordPlanIdeaServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.generateKeywordIdeas.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.generateKeywordIdeasStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v5.services.GenerateKeywordIdeaResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v5.services.GenerateKeywordIdeaResult) => {
            ...
            assert((client.descriptors.page.generateKeywordIdeas.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.generateKeywordIdeas, request));
            assert.strictEqual(
                (client.descriptors.page.generateKeywordIdeas.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });

        it('invokes generateKeywordIdeasStream with error', async () => {
            const client = new keywordplanideaserviceModule.v5.KeywordPlanIdeaServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = "customer_id=";
            const expectedError = new Error('expected');
            client.descriptors.page.generateKeywordIdeas.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.generateKeywordIdeasStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v5.services.GenerateKeywordIdeaResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v5.services.GenerateKeywordIdeaResult) => {
        ...
        it('uses async iteration with generateKeywordIdeas without error', async () => {
            ...
            client.descriptors.page.generateKeywordIdeas.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.googleads.v5.services.IGenerateKeywordIdeaResult[] = [];
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.generateKeywordIdeas.asyncIterate as SinonStub)
        ...
        it('uses async iteration with generateKeywordIdeas with error', async () => {
            const client = new keywordplanideaserviceModule.v5.KeywordPlanIdeaServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GenerateKeywordIdeasRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";const expectedError = new Error('expected');
            client.descriptors.page.generateKeywordIdeas.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.generateKeywordIdeasAsync(request);
