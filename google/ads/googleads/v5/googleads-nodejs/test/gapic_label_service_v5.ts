...
describe('v5.LabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = labelserviceModule.v5.LabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = labelserviceModule.v5.LabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = labelserviceModule.v5.LabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new labelserviceModule.v5.LabelServiceClient();
        assert(client);
    });
    ...
    describe('getLabel', () => {
        it('invokes getLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.Label());
        ...
        it('invokes getLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ILabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateLabels', () => {
        it('invokes mutateLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateLabelsResponse());
        ...
        it('invokes mutateLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
