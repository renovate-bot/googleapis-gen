...
describe('v5.ReachPlanServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = reachplanserviceModule.v5.ReachPlanServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = reachplanserviceModule.v5.ReachPlanServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = reachplanserviceModule.v5.ReachPlanServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new reachplanserviceModule.v5.ReachPlanServiceClient();
        assert(client);
    });
    ...
    describe('listPlannableLocations', () => {
        it('invokes listPlannableLocations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.ListPlannableLocationsRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.ListPlannableLocationsResponse());
        ...
        it('invokes listPlannableLocations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableLocations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IListPlannableLocationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listPlannableProducts', () => {
        it('invokes listPlannableProducts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.ListPlannableProductsRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.ListPlannableProductsResponse());
        ...
        it('invokes listPlannableProducts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableProducts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IListPlannableProductsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateProductMixIdeas', () => {
        it('invokes generateProductMixIdeas without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GenerateProductMixIdeasRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.GenerateProductMixIdeasResponse());
        ...
        it('invokes generateProductMixIdeas without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateProductMixIdeas(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IGenerateProductMixIdeasResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateReachForecast', () => {
        it('invokes generateReachForecast without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GenerateReachForecastRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.GenerateReachForecastResponse());
        ...
        it('invokes generateReachForecast without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateReachForecast(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IGenerateReachForecastResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
