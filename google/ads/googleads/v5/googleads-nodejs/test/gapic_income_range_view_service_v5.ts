...
describe('v5.IncomeRangeViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = incomerangeviewserviceModule.v5.IncomeRangeViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = incomerangeviewserviceModule.v5.IncomeRangeViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = incomerangeviewserviceModule.v5.IncomeRangeViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new incomerangeviewserviceModule.v5.IncomeRangeViewServiceClient();
        assert(client);
    });
    ...
    describe('getIncomeRangeView', () => {
        it('invokes getIncomeRangeView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetIncomeRangeViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.IncomeRangeView());
        ...
        it('invokes getIncomeRangeView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getIncomeRangeView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IIncomeRangeView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
