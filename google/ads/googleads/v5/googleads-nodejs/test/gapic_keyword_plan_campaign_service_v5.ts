...
import * as keywordplancampaignserviceModule from '../src';
...
describe('v5.KeywordPlanCampaignServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplancampaignserviceModule.v5.KeywordPlanCampaignServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplancampaignserviceModule.v5.KeywordPlanCampaignServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplancampaignserviceModule.v5.KeywordPlanCampaignServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplancampaignserviceModule.v5.KeywordPlanCampaignServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.keywordPlanCampaignServiceStub, undefined);
        await client.initialize();
        assert(client.keywordPlanCampaignServiceStub);
    });
    ...
    describe('getKeywordPlanCampaign', () => {
        it('invokes getKeywordPlanCampaign without error', async () => {
            const client = new keywordplancampaignserviceModule.v5.KeywordPlanCampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetKeywordPlanCampaignRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.KeywordPlanCampaign());
            client.innerApiCalls.getKeywordPlanCampaign = stubSimpleCall(expectedResponse);
            const [response] = await client.getKeywordPlanCampaign(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getKeywordPlanCampaign as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getKeywordPlanCampaign without error using callback', async () => {
            const client = new keywordplancampaignserviceModule.v5.KeywordPlanCampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.KeywordPlanCampaign());
            client.innerApiCalls.getKeywordPlanCampaign = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanCampaign(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IKeywordPlanCampaign|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getKeywordPlanCampaign with error', async () => {
            const client = new keywordplancampaignserviceModule.v5.KeywordPlanCampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getKeywordPlanCampaign = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getKeywordPlanCampaign(request), expectedError);
            assert((client.innerApiCalls.getKeywordPlanCampaign as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateKeywordPlanCampaigns', () => {
        it('invokes mutateKeywordPlanCampaigns without error', async () => {
            const client = new keywordplancampaignserviceModule.v5.KeywordPlanCampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse());
            client.innerApiCalls.mutateKeywordPlanCampaigns = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateKeywordPlanCampaigns(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateKeywordPlanCampaigns as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateKeywordPlanCampaigns without error using callback', async () => {
            const client = new keywordplancampaignserviceModule.v5.KeywordPlanCampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse());
            client.innerApiCalls.mutateKeywordPlanCampaigns = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanCampaigns(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateKeywordPlanCampaigns with error', async () => {
            const client = new keywordplancampaignserviceModule.v5.KeywordPlanCampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateKeywordPlanCampaigns = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateKeywordPlanCampaigns(request), expectedError);
            assert((client.innerApiCalls.mutateKeywordPlanCampaigns as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
