...
import * as campaigncriterionsimulationserviceModule from '../src';
...
describe('v5.CampaignCriterionSimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaigncriterionsimulationserviceModule.v5.CampaignCriterionSimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaigncriterionsimulationserviceModule.v5.CampaignCriterionSimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaigncriterionsimulationserviceModule.v5.CampaignCriterionSimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaigncriterionsimulationserviceModule.v5.CampaignCriterionSimulationServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.campaignCriterionSimulationServiceStub, undefined);
        await client.initialize();
        assert(client.campaignCriterionSimulationServiceStub);
    });
    ...
    describe('getCampaignCriterionSimulation', () => {
        it('invokes getCampaignCriterionSimulation without error', async () => {
            const client = new campaigncriterionsimulationserviceModule.v5.CampaignCriterionSimulationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCampaignCriterionSimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CampaignCriterionSimulation());
            client.innerApiCalls.getCampaignCriterionSimulation = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignCriterionSimulation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignCriterionSimulation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCampaignCriterionSimulation without error using callback', async () => {
            const client = new campaigncriterionsimulationserviceModule.v5.CampaignCriterionSimulationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CampaignCriterionSimulation());
            client.innerApiCalls.getCampaignCriterionSimulation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignCriterionSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICampaignCriterionSimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignCriterionSimulation with error', async () => {
            const client = new campaigncriterionsimulationserviceModule.v5.CampaignCriterionSimulationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCampaignCriterionSimulation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignCriterionSimulation(request), expectedError);
            assert((client.innerApiCalls.getCampaignCriterionSimulation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
