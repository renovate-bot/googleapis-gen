...
describe('v5.OfflineUserDataJobServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = offlineuserdatajobserviceModule.v5.OfflineUserDataJobServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = offlineuserdatajobserviceModule.v5.OfflineUserDataJobServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = offlineuserdatajobserviceModule.v5.OfflineUserDataJobServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new offlineuserdatajobserviceModule.v5.OfflineUserDataJobServiceClient();
        assert(client);
    });
    ...
    describe('createOfflineUserDataJob', () => {
        it('invokes createOfflineUserDataJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.CreateOfflineUserDataJobRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.CreateOfflineUserDataJobResponse());
        ...
        it('invokes createOfflineUserDataJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createOfflineUserDataJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.ICreateOfflineUserDataJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getOfflineUserDataJob', () => {
        it('invokes getOfflineUserDataJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetOfflineUserDataJobRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.OfflineUserDataJob());
        ...
        it('invokes getOfflineUserDataJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getOfflineUserDataJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IOfflineUserDataJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('addOfflineUserDataJobOperations', () => {
        it('invokes addOfflineUserDataJobOperations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.AddOfflineUserDataJobOperationsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.AddOfflineUserDataJobOperationsResponse());
        ...
        it('invokes addOfflineUserDataJobOperations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addOfflineUserDataJobOperations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IAddOfflineUserDataJobOperationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('runOfflineUserDataJob', () => {
        it('invokes runOfflineUserDataJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.RunOfflineUserDataJobRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
