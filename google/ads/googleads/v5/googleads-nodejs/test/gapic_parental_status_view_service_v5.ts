...
import * as parentalstatusviewserviceModule from '../src';
...
describe('v5.ParentalStatusViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = parentalstatusviewserviceModule.v5.ParentalStatusViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = parentalstatusviewserviceModule.v5.ParentalStatusViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = parentalstatusviewserviceModule.v5.ParentalStatusViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new parentalstatusviewserviceModule.v5.ParentalStatusViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.parentalStatusViewServiceStub, undefined);
        await client.initialize();
        assert(client.parentalStatusViewServiceStub);
    });
    ...
    describe('getParentalStatusView', () => {
        it('invokes getParentalStatusView without error', async () => {
            const client = new parentalstatusviewserviceModule.v5.ParentalStatusViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetParentalStatusViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.ParentalStatusView());
            client.innerApiCalls.getParentalStatusView = stubSimpleCall(expectedResponse);
            const [response] = await client.getParentalStatusView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getParentalStatusView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getParentalStatusView without error using callback', async () => {
            const client = new parentalstatusviewserviceModule.v5.ParentalStatusViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.ParentalStatusView());
            client.innerApiCalls.getParentalStatusView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getParentalStatusView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IParentalStatusView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getParentalStatusView with error', async () => {
            const client = new parentalstatusviewserviceModule.v5.ParentalStatusViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getParentalStatusView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getParentalStatusView(request), expectedError);
            assert((client.innerApiCalls.getParentalStatusView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
