...
import * as custominterestserviceModule from '../src';
...
describe('v5.CustomInterestServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = custominterestserviceModule.v5.CustomInterestServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = custominterestserviceModule.v5.CustomInterestServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = custominterestserviceModule.v5.CustomInterestServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new custominterestserviceModule.v5.CustomInterestServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.customInterestServiceStub);
    });
    ...
    describe('getCustomInterest', () => {
        it('invokes getCustomInterest without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCustomInterestRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CustomInterest());
            client.innerApiCalls.getCustomInterest = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomInterest(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomInterest as SinonStub)
        ...
        it('invokes getCustomInterest without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CustomInterest());
            client.innerApiCalls.getCustomInterest = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomInterest(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICustomInterest|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomInterest with error', async () => {
            ...
            client.innerApiCalls.getCustomInterest = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomInterest(request), expectedError);
            assert((client.innerApiCalls.getCustomInterest as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateCustomInterests', () => {
        it('invokes mutateCustomInterests without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCustomInterestsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCustomInterestsResponse());
            client.innerApiCalls.mutateCustomInterests = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomInterests(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomInterests as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateCustomInterests without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCustomInterestsResponse());
            client.innerApiCalls.mutateCustomInterests = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomInterests(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateCustomInterestsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomInterests with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCustomInterests = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomInterests(request), expectedError);
            assert((client.innerApiCalls.mutateCustomInterests as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
