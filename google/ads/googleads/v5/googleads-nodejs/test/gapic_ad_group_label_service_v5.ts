...
import * as adgrouplabelserviceModule from '../src';
...
describe('v5.AdGroupLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgrouplabelserviceModule.v5.AdGroupLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgrouplabelserviceModule.v5.AdGroupLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgrouplabelserviceModule.v5.AdGroupLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgrouplabelserviceModule.v5.AdGroupLabelServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.adGroupLabelServiceStub);
    });
    ...
    describe('getAdGroupLabel', () => {
        it('invokes getAdGroupLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAdGroupLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupLabel());
            client.innerApiCalls.getAdGroupLabel = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupLabel(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupLabel as SinonStub)
        ...
        it('invokes getAdGroupLabel without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupLabel());
            client.innerApiCalls.getAdGroupLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAdGroupLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupLabel with error', async () => {
            ...
            client.innerApiCalls.getAdGroupLabel = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupLabel(request), expectedError);
            assert((client.innerApiCalls.getAdGroupLabel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateAdGroupLabels', () => {
        it('invokes mutateAdGroupLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupLabelsResponse());
            client.innerApiCalls.mutateAdGroupLabels = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupLabels(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupLabels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateAdGroupLabels without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupLabelsResponse());
            client.innerApiCalls.mutateAdGroupLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateAdGroupLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupLabels with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdGroupLabels = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupLabels(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupLabels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
