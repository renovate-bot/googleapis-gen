...
import * as campaigncriterionserviceModule from '../src';
...
describe('v5.CampaignCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaigncriterionserviceModule.v5.CampaignCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaigncriterionserviceModule.v5.CampaignCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaigncriterionserviceModule.v5.CampaignCriterionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaigncriterionserviceModule.v5.CampaignCriterionServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.campaignCriterionServiceStub);
    });
    ...
    describe('getCampaignCriterion', () => {
        it('invokes getCampaignCriterion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCampaignCriterionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CampaignCriterion());
            client.innerApiCalls.getCampaignCriterion = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignCriterion(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignCriterion as SinonStub)
        ...
        it('invokes getCampaignCriterion without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CampaignCriterion());
            client.innerApiCalls.getCampaignCriterion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICampaignCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignCriterion with error', async () => {
            ...
            client.innerApiCalls.getCampaignCriterion = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignCriterion(request), expectedError);
            assert((client.innerApiCalls.getCampaignCriterion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateCampaignCriteria', () => {
        it('invokes mutateCampaignCriteria without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignCriteriaRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse());
            client.innerApiCalls.mutateCampaignCriteria = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignCriteria(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaignCriteria as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateCampaignCriteria without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignCriteriaResponse());
            client.innerApiCalls.mutateCampaignCriteria = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateCampaignCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignCriteria with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCampaignCriteria = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignCriteria(request), expectedError);
            assert((client.innerApiCalls.mutateCampaignCriteria as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
