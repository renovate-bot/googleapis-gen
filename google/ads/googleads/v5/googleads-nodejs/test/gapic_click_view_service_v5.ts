...
import * as clickviewserviceModule from '../src';
...
describe('v5.ClickViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = clickviewserviceModule.v5.ClickViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = clickviewserviceModule.v5.ClickViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = clickviewserviceModule.v5.ClickViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new clickviewserviceModule.v5.ClickViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.clickViewServiceStub, undefined);
        await client.initialize();
        assert(client.clickViewServiceStub);
    });
    ...
    describe('getClickView', () => {
        it('invokes getClickView without error', async () => {
            const client = new clickviewserviceModule.v5.ClickViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetClickViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.ClickView());
            client.innerApiCalls.getClickView = stubSimpleCall(expectedResponse);
            const [response] = await client.getClickView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getClickView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getClickView without error using callback', async () => {
            const client = new clickviewserviceModule.v5.ClickViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.ClickView());
            client.innerApiCalls.getClickView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getClickView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IClickView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getClickView with error', async () => {
            const client = new clickviewserviceModule.v5.ClickViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getClickView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getClickView(request), expectedError);
            assert((client.innerApiCalls.getClickView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
