...
describe('v5.CampaignAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignassetserviceModule.v5.CampaignAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignassetserviceModule.v5.CampaignAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignassetserviceModule.v5.CampaignAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignassetserviceModule.v5.CampaignAssetServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignAsset', () => {
        it('invokes getCampaignAsset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCampaignAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CampaignAsset());
        ...
        it('invokes getCampaignAsset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICampaignAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignAssets', () => {
        it('invokes mutateCampaignAssets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignAssetsResponse());
        ...
        it('invokes mutateCampaignAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateCampaignAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
