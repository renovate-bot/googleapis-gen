...
describe('v5.RecommendationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = recommendationserviceModule.v5.RecommendationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = recommendationserviceModule.v5.RecommendationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = recommendationserviceModule.v5.RecommendationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new recommendationserviceModule.v5.RecommendationServiceClient();
        assert(client);
    });
    ...
    describe('getRecommendation', () => {
        it('invokes getRecommendation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetRecommendationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.Recommendation());
        ...
        it('invokes getRecommendation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRecommendation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IRecommendation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('applyRecommendation', () => {
        it('invokes applyRecommendation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.ApplyRecommendationRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.ApplyRecommendationResponse());
        ...
        it('invokes applyRecommendation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.applyRecommendation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IApplyRecommendationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('dismissRecommendation', () => {
        it('invokes dismissRecommendation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.DismissRecommendationRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.DismissRecommendationResponse());
        ...
        it('invokes dismissRecommendation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.dismissRecommendation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IDismissRecommendationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
