...
describe('v5.AdServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adserviceModule.v5.AdServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adserviceModule.v5.AdServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adserviceModule.v5.AdServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adserviceModule.v5.AdServiceClient();
        assert(client);
    });
    ...
    describe('getAd', () => {
        it('invokes getAd without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAdRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.Ad());
        ...
        it('invokes getAd without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAd(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAd|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAds', () => {
        it('invokes mutateAds without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdsResponse());
        ...
        it('invokes mutateAds without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateAdsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
