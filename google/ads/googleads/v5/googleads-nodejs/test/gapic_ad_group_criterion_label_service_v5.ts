...
import * as adgroupcriterionlabelserviceModule from '../src';
...
describe('v5.AdGroupCriterionLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupcriterionlabelserviceModule.v5.AdGroupCriterionLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupcriterionlabelserviceModule.v5.AdGroupCriterionLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupcriterionlabelserviceModule.v5.AdGroupCriterionLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupcriterionlabelserviceModule.v5.AdGroupCriterionLabelServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupCriterionLabelServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupCriterionLabelServiceStub);
    });
    ...
    describe('getAdGroupCriterionLabel', () => {
        it('invokes getAdGroupCriterionLabel without error', async () => {
            const client = new adgroupcriterionlabelserviceModule.v5.AdGroupCriterionLabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAdGroupCriterionLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupCriterionLabel());
            client.innerApiCalls.getAdGroupCriterionLabel = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupCriterionLabel(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupCriterionLabel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupCriterionLabel without error using callback', async () => {
            const client = new adgroupcriterionlabelserviceModule.v5.AdGroupCriterionLabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupCriterionLabel());
            client.innerApiCalls.getAdGroupCriterionLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupCriterionLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAdGroupCriterionLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupCriterionLabel with error', async () => {
            const client = new adgroupcriterionlabelserviceModule.v5.AdGroupCriterionLabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdGroupCriterionLabel = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupCriterionLabel(request), expectedError);
            assert((client.innerApiCalls.getAdGroupCriterionLabel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAdGroupCriterionLabels', () => {
        it('invokes mutateAdGroupCriterionLabels without error', async () => {
            const client = new adgroupcriterionlabelserviceModule.v5.AdGroupCriterionLabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsResponse());
            client.innerApiCalls.mutateAdGroupCriterionLabels = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupCriterionLabels(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupCriterionLabels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroupCriterionLabels without error using callback', async () => {
            const client = new adgroupcriterionlabelserviceModule.v5.AdGroupCriterionLabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsResponse());
            client.innerApiCalls.mutateAdGroupCriterionLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupCriterionLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateAdGroupCriterionLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupCriterionLabels with error', async () => {
            const client = new adgroupcriterionlabelserviceModule.v5.AdGroupCriterionLabelServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdGroupCriterionLabels = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupCriterionLabels(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupCriterionLabels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
