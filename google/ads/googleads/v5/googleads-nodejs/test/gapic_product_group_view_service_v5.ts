...
describe('v5.ProductGroupViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = productgroupviewserviceModule.v5.ProductGroupViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = productgroupviewserviceModule.v5.ProductGroupViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = productgroupviewserviceModule.v5.ProductGroupViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new productgroupviewserviceModule.v5.ProductGroupViewServiceClient();
        assert(client);
    });
    ...
    describe('getProductGroupView', () => {
        it('invokes getProductGroupView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetProductGroupViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.ProductGroupView());
        ...
        it('invokes getProductGroupView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getProductGroupView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IProductGroupView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
