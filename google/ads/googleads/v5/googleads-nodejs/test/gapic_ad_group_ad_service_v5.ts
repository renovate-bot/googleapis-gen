...
describe('v5.AdGroupAdServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupadserviceModule.v5.AdGroupAdServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupadserviceModule.v5.AdGroupAdServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupadserviceModule.v5.AdGroupAdServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupadserviceModule.v5.AdGroupAdServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupAd', () => {
        it('invokes getAdGroupAd without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAdGroupAdRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupAd());
        ...
        it('invokes getAdGroupAd without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAd(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAdGroupAd|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupAds', () => {
        it('invokes mutateAdGroupAds without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupAdsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupAdsResponse());
        ...
        it('invokes mutateAdGroupAds without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupAds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateAdGroupAdsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
