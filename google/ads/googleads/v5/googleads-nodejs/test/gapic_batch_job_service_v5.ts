...
describe('v5.BatchJobServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = batchjobserviceModule.v5.BatchJobServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = batchjobserviceModule.v5.BatchJobServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = batchjobserviceModule.v5.BatchJobServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new batchjobserviceModule.v5.BatchJobServiceClient();
        assert(client);
    });
    ...
    describe('mutateBatchJob', () => {
        it('invokes mutateBatchJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateBatchJobRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateBatchJobResponse());
        ...
        it('invokes mutateBatchJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBatchJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateBatchJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBatchJob', () => {
        it('invokes getBatchJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetBatchJobRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.BatchJob());
        ...
        it('invokes getBatchJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBatchJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IBatchJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('addBatchJobOperations', () => {
        it('invokes addBatchJobOperations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.AddBatchJobOperationsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.AddBatchJobOperationsResponse());
        ...
        it('invokes addBatchJobOperations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addBatchJobOperations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IAddBatchJobOperationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('runBatchJob', () => {
        it('invokes runBatchJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.RunBatchJobRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes runBatchJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runBatchJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v5.resources.BatchJob.IBatchJobMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v5.resources.BatchJob.IBatchJobMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runBatchJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('listBatchJobResults', () => {
        it('invokes listBatchJobResults without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.ListBatchJobResultsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v5.services.BatchJobResult()),
              generateSampleMessage(new protos.google.ads.googleads.v5.services.BatchJobResult()),
              generateSampleMessage(new protos.google.ads.googleads.v5.services.BatchJobResult()),
            ];
        ...
        it('invokes listBatchJobResults without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listBatchJobResults(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IBatchJobResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listBatchJobResultsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v5.services.BatchJobResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v5.services.BatchJobResult) => {
        ...
        it('uses async iteration with listBatchJobResults without error', async () => {
            ...
            const responses: protos.google.ads.googleads.v5.services.IBatchJobResult[] = [];
