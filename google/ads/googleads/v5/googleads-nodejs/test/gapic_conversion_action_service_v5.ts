...
describe('v5.ConversionActionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionactionserviceModule.v5.ConversionActionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionactionserviceModule.v5.ConversionActionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionactionserviceModule.v5.ConversionActionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionactionserviceModule.v5.ConversionActionServiceClient();
        assert(client);
    });
    ...
    describe('getConversionAction', () => {
        it('invokes getConversionAction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetConversionActionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.ConversionAction());
        ...
        it('invokes getConversionAction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConversionAction(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IConversionAction|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateConversionActions', () => {
        it('invokes mutateConversionActions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateConversionActionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateConversionActionsResponse());
        ...
        it('invokes mutateConversionActions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionActions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateConversionActionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
