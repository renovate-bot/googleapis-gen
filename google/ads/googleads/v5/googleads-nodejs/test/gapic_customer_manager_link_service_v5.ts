...
describe('v5.CustomerManagerLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customermanagerlinkserviceModule.v5.CustomerManagerLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customermanagerlinkserviceModule.v5.CustomerManagerLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customermanagerlinkserviceModule.v5.CustomerManagerLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customermanagerlinkserviceModule.v5.CustomerManagerLinkServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerManagerLink', () => {
        it('invokes getCustomerManagerLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCustomerManagerLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CustomerManagerLink());
        ...
        it('invokes getCustomerManagerLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICustomerManagerLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerManagerLink', () => {
        it('invokes mutateCustomerManagerLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCustomerManagerLinkRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCustomerManagerLinkResponse());
        ...
        it('invokes mutateCustomerManagerLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateCustomerManagerLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('moveManagerLink', () => {
        it('invokes moveManagerLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MoveManagerLinkRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MoveManagerLinkResponse());
        ...
        it('invokes moveManagerLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMoveManagerLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
