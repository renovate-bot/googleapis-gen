...
import * as paymentsaccountserviceModule from '../src';
...
describe('v5.PaymentsAccountServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = paymentsaccountserviceModule.v5.PaymentsAccountServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = paymentsaccountserviceModule.v5.PaymentsAccountServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = paymentsaccountserviceModule.v5.PaymentsAccountServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new paymentsaccountserviceModule.v5.PaymentsAccountServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.paymentsAccountServiceStub, undefined);
        await client.initialize();
        assert(client.paymentsAccountServiceStub);
    });
    ...
    describe('listPaymentsAccounts', () => {
        it('invokes listPaymentsAccounts without error', async () => {
            const client = new paymentsaccountserviceModule.v5.PaymentsAccountServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.ListPaymentsAccountsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.ListPaymentsAccountsResponse());
            client.innerApiCalls.listPaymentsAccounts = stubSimpleCall(expectedResponse);
            const [response] = await client.listPaymentsAccounts(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listPaymentsAccounts as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listPaymentsAccounts without error using callback', async () => {
            const client = new paymentsaccountserviceModule.v5.PaymentsAccountServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.ListPaymentsAccountsResponse());
            client.innerApiCalls.listPaymentsAccounts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listPaymentsAccounts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IListPaymentsAccountsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listPaymentsAccounts with error', async () => {
            const client = new paymentsaccountserviceModule.v5.PaymentsAccountServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listPaymentsAccounts = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listPaymentsAccounts(request), expectedError);
            assert((client.innerApiCalls.listPaymentsAccounts as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
