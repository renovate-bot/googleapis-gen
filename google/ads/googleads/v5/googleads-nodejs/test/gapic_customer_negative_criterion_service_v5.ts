...
describe('v5.CustomerNegativeCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customernegativecriterionserviceModule.v5.CustomerNegativeCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customernegativecriterionserviceModule.v5.CustomerNegativeCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customernegativecriterionserviceModule.v5.CustomerNegativeCriterionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customernegativecriterionserviceModule.v5.CustomerNegativeCriterionServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerNegativeCriterion', () => {
        it('invokes getCustomerNegativeCriterion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCustomerNegativeCriterionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CustomerNegativeCriterion());
        ...
        it('invokes getCustomerNegativeCriterion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerNegativeCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICustomerNegativeCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerNegativeCriteria', () => {
        it('invokes mutateCustomerNegativeCriteria without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCustomerNegativeCriteriaResponse());
        ...
        it('invokes mutateCustomerNegativeCriteria without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerNegativeCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateCustomerNegativeCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
