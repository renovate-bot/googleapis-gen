...
describe('v5.LocationViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = locationviewserviceModule.v5.LocationViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = locationviewserviceModule.v5.LocationViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = locationviewserviceModule.v5.LocationViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new locationviewserviceModule.v5.LocationViewServiceClient();
        assert(client);
    });
    ...
    describe('getLocationView', () => {
        it('invokes getLocationView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetLocationViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.LocationView());
        ...
        it('invokes getLocationView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLocationView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ILocationView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
