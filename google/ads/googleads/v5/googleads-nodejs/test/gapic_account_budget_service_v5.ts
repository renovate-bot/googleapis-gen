...
import * as accountbudgetserviceModule from '../src';
...
describe('v5.AccountBudgetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = accountbudgetserviceModule.v5.AccountBudgetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = accountbudgetserviceModule.v5.AccountBudgetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = accountbudgetserviceModule.v5.AccountBudgetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new accountbudgetserviceModule.v5.AccountBudgetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.accountBudgetServiceStub, undefined);
        await client.initialize();
        assert(client.accountBudgetServiceStub);
    });
    ...
    describe('getAccountBudget', () => {
        it('invokes getAccountBudget without error', async () => {
            const client = new accountbudgetserviceModule.v5.AccountBudgetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAccountBudgetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AccountBudget());
            client.innerApiCalls.getAccountBudget = stubSimpleCall(expectedResponse);
            const [response] = await client.getAccountBudget(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAccountBudget as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAccountBudget without error using callback', async () => {
            const client = new accountbudgetserviceModule.v5.AccountBudgetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AccountBudget());
            client.innerApiCalls.getAccountBudget = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAccountBudget(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAccountBudget|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAccountBudget with error', async () => {
            const client = new accountbudgetserviceModule.v5.AccountBudgetServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAccountBudget = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAccountBudget(request), expectedError);
            assert((client.innerApiCalls.getAccountBudget as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
