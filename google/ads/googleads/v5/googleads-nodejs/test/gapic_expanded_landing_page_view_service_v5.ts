...
import * as expandedlandingpageviewserviceModule from '../src';
...
describe('v5.ExpandedLandingPageViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = expandedlandingpageviewserviceModule.v5.ExpandedLandingPageViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = expandedlandingpageviewserviceModule.v5.ExpandedLandingPageViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = expandedlandingpageviewserviceModule.v5.ExpandedLandingPageViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new expandedlandingpageviewserviceModule.v5.ExpandedLandingPageViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.expandedLandingPageViewServiceStub, undefined);
        await client.initialize();
        assert(client.expandedLandingPageViewServiceStub);
    });
    ...
    describe('getExpandedLandingPageView', () => {
        it('invokes getExpandedLandingPageView without error', async () => {
            const client = new expandedlandingpageviewserviceModule.v5.ExpandedLandingPageViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetExpandedLandingPageViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.ExpandedLandingPageView());
            client.innerApiCalls.getExpandedLandingPageView = stubSimpleCall(expectedResponse);
            const [response] = await client.getExpandedLandingPageView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getExpandedLandingPageView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getExpandedLandingPageView without error using callback', async () => {
            const client = new expandedlandingpageviewserviceModule.v5.ExpandedLandingPageViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.ExpandedLandingPageView());
            client.innerApiCalls.getExpandedLandingPageView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getExpandedLandingPageView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IExpandedLandingPageView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getExpandedLandingPageView with error', async () => {
            const client = new expandedlandingpageviewserviceModule.v5.ExpandedLandingPageViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getExpandedLandingPageView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getExpandedLandingPageView(request), expectedError);
            assert((client.innerApiCalls.getExpandedLandingPageView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
