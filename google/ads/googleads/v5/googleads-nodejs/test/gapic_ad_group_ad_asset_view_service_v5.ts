...
describe('v5.AdGroupAdAssetViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupadassetviewserviceModule.v5.AdGroupAdAssetViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupadassetviewserviceModule.v5.AdGroupAdAssetViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupadassetviewserviceModule.v5.AdGroupAdAssetViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupadassetviewserviceModule.v5.AdGroupAdAssetViewServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupAdAssetView', () => {
        it('invokes getAdGroupAdAssetView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAdGroupAdAssetViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroupAdAssetView());
        ...
        it('invokes getAdGroupAdAssetView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAdAssetView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAdGroupAdAssetView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
