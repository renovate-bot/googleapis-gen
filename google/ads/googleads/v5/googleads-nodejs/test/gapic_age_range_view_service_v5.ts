...
import * as agerangeviewserviceModule from '../src';
...
describe('v5.AgeRangeViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = agerangeviewserviceModule.v5.AgeRangeViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = agerangeviewserviceModule.v5.AgeRangeViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = agerangeviewserviceModule.v5.AgeRangeViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new agerangeviewserviceModule.v5.AgeRangeViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.ageRangeViewServiceStub, undefined);
        await client.initialize();
        assert(client.ageRangeViewServiceStub);
    });
    ...
    describe('getAgeRangeView', () => {
        it('invokes getAgeRangeView without error', async () => {
            const client = new agerangeviewserviceModule.v5.AgeRangeViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAgeRangeViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AgeRangeView());
            client.innerApiCalls.getAgeRangeView = stubSimpleCall(expectedResponse);
            const [response] = await client.getAgeRangeView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAgeRangeView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAgeRangeView without error using callback', async () => {
            const client = new agerangeviewserviceModule.v5.AgeRangeViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AgeRangeView());
            client.innerApiCalls.getAgeRangeView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAgeRangeView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAgeRangeView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAgeRangeView with error', async () => {
            const client = new agerangeviewserviceModule.v5.AgeRangeViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAgeRangeView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAgeRangeView(request), expectedError);
            assert((client.innerApiCalls.getAgeRangeView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
