...
describe('v5.GoogleAdsFieldServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = googleadsfieldserviceModule.v5.GoogleAdsFieldServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = googleadsfieldserviceModule.v5.GoogleAdsFieldServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = googleadsfieldserviceModule.v5.GoogleAdsFieldServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new googleadsfieldserviceModule.v5.GoogleAdsFieldServiceClient();
        assert(client);
    });
    ...
    describe('getGoogleAdsField', () => {
        it('invokes getGoogleAdsField without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetGoogleAdsFieldRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.GoogleAdsField());
        ...
        it('invokes getGoogleAdsField without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGoogleAdsField(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IGoogleAdsField|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('searchGoogleAdsFields', () => {
        it('invokes searchGoogleAdsFields without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest());
            const expectedOptions = {};
            const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v5.resources.GoogleAdsField()),
              generateSampleMessage(new protos.google.ads.googleads.v5.resources.GoogleAdsField()),
              generateSampleMessage(new protos.google.ads.googleads.v5.resources.GoogleAdsField()),
            ];
        ...
        it('invokes searchGoogleAdsFieldsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v5.resources.GoogleAdsField[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v5.resources.GoogleAdsField) => {
        ...
        it('uses async iteration with searchGoogleAdsFields without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest());const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v5.resources.GoogleAdsField()),
              generateSampleMessage(new protos.google.ads.googleads.v5.resources.GoogleAdsField()),
              generateSampleMessage(new protos.google.ads.googleads.v5.resources.GoogleAdsField()),
            ];
            client.descriptors.page.searchGoogleAdsFields.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.googleads.v5.resources.IGoogleAdsField[] = [];
        ...
        it('uses async iteration with searchGoogleAdsFields with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.SearchGoogleAdsFieldsRequest());const expectedError = new Error('expected');
