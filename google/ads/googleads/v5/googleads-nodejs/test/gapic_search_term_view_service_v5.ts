...
import * as searchtermviewserviceModule from '../src';
...
describe('v5.SearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = searchtermviewserviceModule.v5.SearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = searchtermviewserviceModule.v5.SearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = searchtermviewserviceModule.v5.SearchTermViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new searchtermviewserviceModule.v5.SearchTermViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.searchTermViewServiceStub, undefined);
        await client.initialize();
        assert(client.searchTermViewServiceStub);
    });
    ...
    describe('getSearchTermView', () => {
        it('invokes getSearchTermView without error', async () => {
            const client = new searchtermviewserviceModule.v5.SearchTermViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetSearchTermViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.SearchTermView());
            client.innerApiCalls.getSearchTermView = stubSimpleCall(expectedResponse);
            const [response] = await client.getSearchTermView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSearchTermView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getSearchTermView without error using callback', async () => {
            const client = new searchtermviewserviceModule.v5.SearchTermViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.SearchTermView());
            client.innerApiCalls.getSearchTermView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ISearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSearchTermView with error', async () => {
            const client = new searchtermviewserviceModule.v5.SearchTermViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getSearchTermView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getSearchTermView(request), expectedError);
            assert((client.innerApiCalls.getSearchTermView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
