...
import * as adgroupserviceModule from '../src';
...
describe('v5.AdGroupServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupserviceModule.v5.AdGroupServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupserviceModule.v5.AdGroupServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupserviceModule.v5.AdGroupServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupserviceModule.v5.AdGroupServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupServiceStub);
    });
    ...
    describe('getAdGroup', () => {
        it('invokes getAdGroup without error', async () => {
            const client = new adgroupserviceModule.v5.AdGroupServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAdGroupRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroup());
            client.innerApiCalls.getAdGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroup without error using callback', async () => {
            const client = new adgroupserviceModule.v5.AdGroupServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AdGroup());
            client.innerApiCalls.getAdGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAdGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroup with error', async () => {
            const client = new adgroupserviceModule.v5.AdGroupServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdGroup = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroup(request), expectedError);
            assert((client.innerApiCalls.getAdGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAdGroups', () => {
        it('invokes mutateAdGroups without error', async () => {
            const client = new adgroupserviceModule.v5.AdGroupServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupsResponse());
            client.innerApiCalls.mutateAdGroups = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroups(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroups as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroups without error using callback', async () => {
            const client = new adgroupserviceModule.v5.AdGroupServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAdGroupsResponse());
            client.innerApiCalls.mutateAdGroups = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroups(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateAdGroupsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroups with error', async () => {
            const client = new adgroupserviceModule.v5.AdGroupServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdGroups = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroups(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroups as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
