...
import * as dynamicsearchadssearchtermviewserviceModule from '../src';
...
describe('v5.DynamicSearchAdsSearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = dynamicsearchadssearchtermviewserviceModule.v5.DynamicSearchAdsSearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = dynamicsearchadssearchtermviewserviceModule.v5.DynamicSearchAdsSearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = dynamicsearchadssearchtermviewserviceModule.v5.DynamicSearchAdsSearchTermViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new dynamicsearchadssearchtermviewserviceModule.v5.DynamicSearchAdsSearchTermViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.dynamicSearchAdsSearchTermViewServiceStub, undefined);
        await client.initialize();
        assert(client.dynamicSearchAdsSearchTermViewServiceStub);
    });
    ...
    describe('getDynamicSearchAdsSearchTermView', () => {
        it('invokes getDynamicSearchAdsSearchTermView without error', async () => {
            const client = new dynamicsearchadssearchtermviewserviceModule.v5.DynamicSearchAdsSearchTermViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetDynamicSearchAdsSearchTermViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.DynamicSearchAdsSearchTermView());
            client.innerApiCalls.getDynamicSearchAdsSearchTermView = stubSimpleCall(expectedResponse);
            const [response] = await client.getDynamicSearchAdsSearchTermView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getDynamicSearchAdsSearchTermView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getDynamicSearchAdsSearchTermView without error using callback', async () => {
            const client = new dynamicsearchadssearchtermviewserviceModule.v5.DynamicSearchAdsSearchTermViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.DynamicSearchAdsSearchTermView());
            client.innerApiCalls.getDynamicSearchAdsSearchTermView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDynamicSearchAdsSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IDynamicSearchAdsSearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDynamicSearchAdsSearchTermView with error', async () => {
            const client = new dynamicsearchadssearchtermviewserviceModule.v5.DynamicSearchAdsSearchTermViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDynamicSearchAdsSearchTermView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDynamicSearchAdsSearchTermView(request), expectedError);
            assert((client.innerApiCalls.getDynamicSearchAdsSearchTermView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
