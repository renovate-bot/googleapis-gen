...
describe('v5.InvoiceServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = invoiceserviceModule.v5.InvoiceServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = invoiceserviceModule.v5.InvoiceServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = invoiceserviceModule.v5.InvoiceServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new invoiceserviceModule.v5.InvoiceServiceClient();
        assert(client);
    });
    ...
    describe('listInvoices', () => {
        it('invokes listInvoices without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.ListInvoicesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.ListInvoicesResponse());
        ...
        it('invokes listInvoices without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listInvoices(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IListInvoicesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
