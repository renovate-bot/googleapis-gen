...
import * as userinterestserviceModule from '../src';
...
describe('v5.UserInterestServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = userinterestserviceModule.v5.UserInterestServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = userinterestserviceModule.v5.UserInterestServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = userinterestserviceModule.v5.UserInterestServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new userinterestserviceModule.v5.UserInterestServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.userInterestServiceStub, undefined);
        await client.initialize();
        assert(client.userInterestServiceStub);
    });
    ...
    describe('getUserInterest', () => {
        it('invokes getUserInterest without error', async () => {
            const client = new userinterestserviceModule.v5.UserInterestServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetUserInterestRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.UserInterest());
            client.innerApiCalls.getUserInterest = stubSimpleCall(expectedResponse);
            const [response] = await client.getUserInterest(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getUserInterest as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getUserInterest without error using callback', async () => {
            const client = new userinterestserviceModule.v5.UserInterestServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.UserInterest());
            client.innerApiCalls.getUserInterest = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getUserInterest(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IUserInterest|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getUserInterest with error', async () => {
            const client = new userinterestserviceModule.v5.UserInterestServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getUserInterest = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getUserInterest(request), expectedError);
            assert((client.innerApiCalls.getUserInterest as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
