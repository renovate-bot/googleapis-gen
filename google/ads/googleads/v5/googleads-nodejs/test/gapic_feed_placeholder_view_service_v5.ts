...
describe('v5.FeedPlaceholderViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feedplaceholderviewserviceModule.v5.FeedPlaceholderViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feedplaceholderviewserviceModule.v5.FeedPlaceholderViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feedplaceholderviewserviceModule.v5.FeedPlaceholderViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feedplaceholderviewserviceModule.v5.FeedPlaceholderViewServiceClient();
        assert(client);
    });
    ...
    describe('getFeedPlaceholderView', () => {
        it('invokes getFeedPlaceholderView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetFeedPlaceholderViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.FeedPlaceholderView());
        ...
        it('invokes getFeedPlaceholderView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeedPlaceholderView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IFeedPlaceholderView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
