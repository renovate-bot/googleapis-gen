...
import * as accountbudgetproposalserviceModule from '../src';
...
describe('v5.AccountBudgetProposalServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = accountbudgetproposalserviceModule.v5.AccountBudgetProposalServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = accountbudgetproposalserviceModule.v5.AccountBudgetProposalServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = accountbudgetproposalserviceModule.v5.AccountBudgetProposalServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new accountbudgetproposalserviceModule.v5.AccountBudgetProposalServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.accountBudgetProposalServiceStub, undefined);
        await client.initialize();
        assert(client.accountBudgetProposalServiceStub);
    });
    ...
    describe('getAccountBudgetProposal', () => {
        it('invokes getAccountBudgetProposal without error', async () => {
            const client = new accountbudgetproposalserviceModule.v5.AccountBudgetProposalServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAccountBudgetProposalRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AccountBudgetProposal());
            client.innerApiCalls.getAccountBudgetProposal = stubSimpleCall(expectedResponse);
            const [response] = await client.getAccountBudgetProposal(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAccountBudgetProposal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAccountBudgetProposal without error using callback', async () => {
            const client = new accountbudgetproposalserviceModule.v5.AccountBudgetProposalServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.AccountBudgetProposal());
            client.innerApiCalls.getAccountBudgetProposal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAccountBudgetProposal(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAccountBudgetProposal|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAccountBudgetProposal with error', async () => {
            const client = new accountbudgetproposalserviceModule.v5.AccountBudgetProposalServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAccountBudgetProposal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAccountBudgetProposal(request), expectedError);
            assert((client.innerApiCalls.getAccountBudgetProposal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAccountBudgetProposal', () => {
        it('invokes mutateAccountBudgetProposal without error', async () => {
            const client = new accountbudgetproposalserviceModule.v5.AccountBudgetProposalServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAccountBudgetProposalRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAccountBudgetProposalResponse());
            client.innerApiCalls.mutateAccountBudgetProposal = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAccountBudgetProposal(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAccountBudgetProposal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAccountBudgetProposal without error using callback', async () => {
            const client = new accountbudgetproposalserviceModule.v5.AccountBudgetProposalServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAccountBudgetProposalResponse());
            client.innerApiCalls.mutateAccountBudgetProposal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAccountBudgetProposal(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateAccountBudgetProposalResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAccountBudgetProposal with error', async () => {
            const client = new accountbudgetproposalserviceModule.v5.AccountBudgetProposalServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAccountBudgetProposal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAccountBudgetProposal(request), expectedError);
            assert((client.innerApiCalls.mutateAccountBudgetProposal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
