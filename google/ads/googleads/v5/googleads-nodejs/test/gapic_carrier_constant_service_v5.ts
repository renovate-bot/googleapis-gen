...
import * as carrierconstantserviceModule from '../src';
...
describe('v5.CarrierConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = carrierconstantserviceModule.v5.CarrierConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = carrierconstantserviceModule.v5.CarrierConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = carrierconstantserviceModule.v5.CarrierConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new carrierconstantserviceModule.v5.CarrierConstantServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.carrierConstantServiceStub, undefined);
        await client.initialize();
        assert(client.carrierConstantServiceStub);
    });
    ...
    describe('getCarrierConstant', () => {
        it('invokes getCarrierConstant without error', async () => {
            const client = new carrierconstantserviceModule.v5.CarrierConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCarrierConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CarrierConstant());
            client.innerApiCalls.getCarrierConstant = stubSimpleCall(expectedResponse);
            const [response] = await client.getCarrierConstant(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCarrierConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCarrierConstant without error using callback', async () => {
            const client = new carrierconstantserviceModule.v5.CarrierConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CarrierConstant());
            client.innerApiCalls.getCarrierConstant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCarrierConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICarrierConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCarrierConstant with error', async () => {
            const client = new carrierconstantserviceModule.v5.CarrierConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCarrierConstant = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCarrierConstant(request), expectedError);
            assert((client.innerApiCalls.getCarrierConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
