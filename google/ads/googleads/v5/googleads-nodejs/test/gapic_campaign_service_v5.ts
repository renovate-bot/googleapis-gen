...
import * as campaignserviceModule from '../src';
...
describe('v5.CampaignServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignserviceModule.v5.CampaignServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignserviceModule.v5.CampaignServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignserviceModule.v5.CampaignServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignserviceModule.v5.CampaignServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.campaignServiceStub, undefined);
        await client.initialize();
        assert(client.campaignServiceStub);
    });
    ...
    describe('getCampaign', () => {
        it('invokes getCampaign without error', async () => {
            const client = new campaignserviceModule.v5.CampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCampaignRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.Campaign());
            client.innerApiCalls.getCampaign = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaign(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaign as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCampaign without error using callback', async () => {
            const client = new campaignserviceModule.v5.CampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.Campaign());
            client.innerApiCalls.getCampaign = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaign(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICampaign|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaign with error', async () => {
            const client = new campaignserviceModule.v5.CampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCampaign = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaign(request), expectedError);
            assert((client.innerApiCalls.getCampaign as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCampaigns', () => {
        it('invokes mutateCampaigns without error', async () => {
            const client = new campaignserviceModule.v5.CampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignsResponse());
            client.innerApiCalls.mutateCampaigns = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaigns(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaigns as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCampaigns without error using callback', async () => {
            const client = new campaignserviceModule.v5.CampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCampaignsResponse());
            client.innerApiCalls.mutateCampaigns = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaigns(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateCampaignsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaigns with error', async () => {
            const client = new campaignserviceModule.v5.CampaignServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCampaigns = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaigns(request), expectedError);
            assert((client.innerApiCalls.mutateCampaigns as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
