...
describe('v5.AssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = assetserviceModule.v5.AssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = assetserviceModule.v5.AssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = assetserviceModule.v5.AssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new assetserviceModule.v5.AssetServiceClient();
        assert(client);
    });
    ...
    describe('getAsset', () => {
        it('invokes getAsset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.Asset());
        ...
        it('invokes getAsset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAssets', () => {
        it('invokes mutateAssets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateAssetsResponse());
        ...
        it('invokes mutateAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
