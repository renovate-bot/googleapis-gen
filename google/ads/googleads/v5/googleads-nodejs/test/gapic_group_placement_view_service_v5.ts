...
describe('v5.GroupPlacementViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = groupplacementviewserviceModule.v5.GroupPlacementViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = groupplacementviewserviceModule.v5.GroupPlacementViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = groupplacementviewserviceModule.v5.GroupPlacementViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new groupplacementviewserviceModule.v5.GroupPlacementViewServiceClient();
        assert(client);
    });
    ...
    describe('getGroupPlacementView', () => {
        it('invokes getGroupPlacementView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetGroupPlacementViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.GroupPlacementView());
        ...
        it('invokes getGroupPlacementView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGroupPlacementView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.IGroupPlacementView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
