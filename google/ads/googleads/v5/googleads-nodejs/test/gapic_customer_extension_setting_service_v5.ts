...
import * as customerextensionsettingserviceModule from '../src';
...
describe('v5.CustomerExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerextensionsettingserviceModule.v5.CustomerExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerextensionsettingserviceModule.v5.CustomerExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerextensionsettingserviceModule.v5.CustomerExtensionSettingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerextensionsettingserviceModule.v5.CustomerExtensionSettingServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customerExtensionSettingServiceStub, undefined);
        await client.initialize();
        assert(client.customerExtensionSettingServiceStub);
    });
    ...
    describe('getCustomerExtensionSetting', () => {
        it('invokes getCustomerExtensionSetting without error', async () => {
            const client = new customerextensionsettingserviceModule.v5.CustomerExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCustomerExtensionSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CustomerExtensionSetting());
            client.innerApiCalls.getCustomerExtensionSetting = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomerExtensionSetting(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomerExtensionSetting as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCustomerExtensionSetting without error using callback', async () => {
            const client = new customerextensionsettingserviceModule.v5.CustomerExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CustomerExtensionSetting());
            client.innerApiCalls.getCustomerExtensionSetting = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICustomerExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomerExtensionSetting with error', async () => {
            const client = new customerextensionsettingserviceModule.v5.CustomerExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCustomerExtensionSetting = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomerExtensionSetting(request), expectedError);
            assert((client.innerApiCalls.getCustomerExtensionSetting as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCustomerExtensionSettings', () => {
        it('invokes mutateCustomerExtensionSettings without error', async () => {
            const client = new customerextensionsettingserviceModule.v5.CustomerExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCustomerExtensionSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCustomerExtensionSettingsResponse());
            client.innerApiCalls.mutateCustomerExtensionSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomerExtensionSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomerExtensionSettings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomerExtensionSettings without error using callback', async () => {
            const client = new customerextensionsettingserviceModule.v5.CustomerExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.services.MutateCustomerExtensionSettingsResponse());
            client.innerApiCalls.mutateCustomerExtensionSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.services.IMutateCustomerExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomerExtensionSettings with error', async () => {
            const client = new customerextensionsettingserviceModule.v5.CustomerExtensionSettingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCustomerExtensionSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomerExtensionSettings(request), expectedError);
            assert((client.innerApiCalls.mutateCustomerExtensionSettings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
