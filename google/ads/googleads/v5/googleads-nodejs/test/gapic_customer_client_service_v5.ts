...
import * as customerclientserviceModule from '../src';
...
describe('v5.CustomerClientServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerclientserviceModule.v5.CustomerClientServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerclientserviceModule.v5.CustomerClientServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerclientserviceModule.v5.CustomerClientServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerclientserviceModule.v5.CustomerClientServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customerClientServiceStub, undefined);
        await client.initialize();
        assert(client.customerClientServiceStub);
    });
    ...
    describe('getCustomerClient', () => {
        it('invokes getCustomerClient without error', async () => {
            const client = new customerclientserviceModule.v5.CustomerClientServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v5.services.GetCustomerClientRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CustomerClient());
            client.innerApiCalls.getCustomerClient = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomerClient(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomerClient as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCustomerClient without error using callback', async () => {
            const client = new customerclientserviceModule.v5.CustomerClientServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v5.resources.CustomerClient());
            client.innerApiCalls.getCustomerClient = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerClient(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v5.resources.ICustomerClient|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomerClient with error', async () => {
            const client = new customerclientserviceModule.v5.CustomerClientServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCustomerClient = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomerClient(request), expectedError);
            assert((client.innerApiCalls.getCustomerClient as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
