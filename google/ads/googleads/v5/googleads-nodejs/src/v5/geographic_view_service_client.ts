 ...
 * `src/v5/geographic_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './geographic_view_service_client_config.json';
...
export class GeographicViewServiceClient {
  ...
  geographicViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof GeographicViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.GeographicViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.geographicViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.GeographicViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.GeographicViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const geographicViewServiceStubMethods =
        ['getGeographicView'];
    for (const methodName of geographicViewServiceStubMethods) {
      const callPromise = this.geographicViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getGeographicView(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v5.services.IGetGeographicViewRequest|undefined, {}|undefined
      ]>;
  getGeographicView(
      request: protos.google.ads.googleads.v5.services.IGetGeographicViewRequest,
      options: CallOptions,
 ...
 *   The first element of the array is an object representing [GeographicView]{@link google.ads.googleads.v5.resources.GeographicView}.
 *   Please see the
