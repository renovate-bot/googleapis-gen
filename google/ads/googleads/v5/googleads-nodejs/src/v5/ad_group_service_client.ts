 ...
 * `src/v5/ad_group_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_service_client_config.json';
...
export class AdGroupServiceClient {
  ...
  adGroupServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdGroupServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.AdGroupService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.AdGroupService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.AdGroupService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupServiceStubMethods =
        ['getAdGroup', 'mutateAdGroups'];
    for (const methodName of adGroupServiceStubMethods) {
      const callPromise = this.adGroupServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getAdGroup(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IAdGroup,
        protos.google.ads.googleads.v5.services.IGetAdGroupRequest|undefined, {}|undefined
      ]>;
  getAdGroup(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IAdGroup,
          protos.google.ads.googleads.v5.services.IGetAdGroupRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroup(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AdGroup]{@link google.ads.googleads.v5.resources.AdGroup}.
 *   Please see the
 ...
 */
  ...
  mutateAdGroups(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateAdGroupsResponse,
        protos.google.ads.googleads.v5.services.IMutateAdGroupsRequest|undefined, {}|undefined
      ]>;
  mutateAdGroups(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateAdGroupsResponse,
          protos.google.ads.googleads.v5.services.IMutateAdGroupsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroups(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateAdGroupsResponse]{@link google.ads.googleads.v5.services.MutateAdGroupsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
