 ...
 * `src/v5/video_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './video_service_client_config.json';
...
export class VideoServiceClient {
  ...
  videoServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof VideoServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.VideoService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.videoServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.VideoService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.VideoService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const videoServiceStubMethods =
        ['getVideo'];
    for (const methodName of videoServiceStubMethods) {
      const callPromise = this.videoServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getVideo(
      request: protos.google.ads.googleads.v5.services.IGetVideoRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IVideo,
        protos.google.ads.googleads.v5.services.IGetVideoRequest|undefined, {}|undefined
      ]>;
  getVideo(
      request: protos.google.ads.googleads.v5.services.IGetVideoRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IVideo,
          protos.google.ads.googleads.v5.services.IGetVideoRequest|null|undefined,
          {}|null|undefined>): void;
  getVideo(
      request: protos.google.ads.googleads.v5.services.IGetVideoRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [Video]{@link google.ads.googleads.v5.resources.Video}.
 *   Please see the
