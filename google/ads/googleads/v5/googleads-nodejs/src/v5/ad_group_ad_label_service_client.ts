 ...
 * `src/v5/ad_group_ad_label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_ad_label_service_client_config.json';
...
export class AdGroupAdLabelServiceClient {
  ...
  adGroupAdLabelServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdGroupAdLabelServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.AdGroupAdLabelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupAdLabelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.AdGroupAdLabelService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.AdGroupAdLabelService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupAdLabelServiceStubMethods =
        ['getAdGroupAdLabel', 'mutateAdGroupAdLabels'];
    for (const methodName of adGroupAdLabelServiceStubMethods) {
      const callPromise = this.adGroupAdLabelServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getAdGroupAdLabel(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupAdLabelRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IAdGroupAdLabel,
        protos.google.ads.googleads.v5.services.IGetAdGroupAdLabelRequest|undefined, {}|undefined
      ]>;
  getAdGroupAdLabel(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupAdLabelRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IAdGroupAdLabel,
          protos.google.ads.googleads.v5.services.IGetAdGroupAdLabelRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroupAdLabel(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupAdLabelRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AdGroupAdLabel]{@link google.ads.googleads.v5.resources.AdGroupAdLabel}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.getAdGroupAdLabel(request);
 */
  getAdGroupAdLabel(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupAdLabelRequest,
  ...
  mutateAdGroupAdLabels(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupAdLabelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateAdGroupAdLabelsResponse,
        protos.google.ads.googleads.v5.services.IMutateAdGroupAdLabelsRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupAdLabels(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupAdLabelsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateAdGroupAdLabelsResponse,
          protos.google.ads.googleads.v5.services.IMutateAdGroupAdLabelsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroupAdLabels(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupAdLabelsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateAdGroupAdLabelsResponse]{@link google.ads.googleads.v5.services.MutateAdGroupAdLabelsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.mutateAdGroupAdLabels(request);
 */
  mutateAdGroupAdLabels(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupAdLabelsRequest,
      optionsOrCallback?: CallOptions|Callback<
