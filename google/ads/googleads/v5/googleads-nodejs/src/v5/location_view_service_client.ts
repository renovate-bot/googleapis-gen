 ...
 * `src/v5/location_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './location_view_service_client_config.json';
...
export class LocationViewServiceClient {
  ...
  locationViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof LocationViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.LocationViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.locationViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.LocationViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.LocationViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const locationViewServiceStubMethods =
        ['getLocationView'];
    for (const methodName of locationViewServiceStubMethods) {
      const callPromise = this.locationViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getLocationView(
      request?: protos.google.ads.googleads.v5.services.IGetLocationViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ILocationView,
        protos.google.ads.googleads.v5.services.IGetLocationViewRequest|undefined, {}|undefined
      ]>;
  getLocationView(
      request: protos.google.ads.googleads.v5.services.IGetLocationViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ILocationView,
          protos.google.ads.googleads.v5.services.IGetLocationViewRequest|null|undefined,
          {}|null|undefined>): void;
  getLocationView(
      request: protos.google.ads.googleads.v5.services.IGetLocationViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [LocationView]{@link google.ads.googleads.v5.resources.LocationView}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.getLocationView(request);
 */
  getLocationView(
      request?: protos.google.ads.googleads.v5.services.IGetLocationViewRequest,
