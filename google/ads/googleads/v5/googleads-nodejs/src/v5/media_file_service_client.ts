 ...
 * `src/v5/media_file_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './media_file_service_client_config.json';
...
export class MediaFileServiceClient {
  ...
  mediaFileServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof MediaFileServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.MediaFileService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.mediaFileServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.MediaFileService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.MediaFileService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const mediaFileServiceStubMethods =
        ['getMediaFile', 'mutateMediaFiles'];
    for (const methodName of mediaFileServiceStubMethods) {
      const callPromise = this.mediaFileServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getMediaFile(
      request?: protos.google.ads.googleads.v5.services.IGetMediaFileRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IMediaFile,
        protos.google.ads.googleads.v5.services.IGetMediaFileRequest|undefined, {}|undefined
      ]>;
  getMediaFile(
      request: protos.google.ads.googleads.v5.services.IGetMediaFileRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IMediaFile,
          protos.google.ads.googleads.v5.services.IGetMediaFileRequest|null|undefined,
          {}|null|undefined>): void;
  getMediaFile(
      request: protos.google.ads.googleads.v5.services.IGetMediaFileRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [MediaFile]{@link google.ads.googleads.v5.resources.MediaFile}.
 *   Please see the
 ...
 */
  ...
  mutateMediaFiles(
      request?: protos.google.ads.googleads.v5.services.IMutateMediaFilesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateMediaFilesResponse,
        protos.google.ads.googleads.v5.services.IMutateMediaFilesRequest|undefined, {}|undefined
      ]>;
  mutateMediaFiles(
      request: protos.google.ads.googleads.v5.services.IMutateMediaFilesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateMediaFilesResponse,
          protos.google.ads.googleads.v5.services.IMutateMediaFilesRequest|null|undefined,
          {}|null|undefined>): void;
  mutateMediaFiles(
      request: protos.google.ads.googleads.v5.services.IMutateMediaFilesRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateMediaFilesResponse]{@link google.ads.googleads.v5.services.MutateMediaFilesResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
