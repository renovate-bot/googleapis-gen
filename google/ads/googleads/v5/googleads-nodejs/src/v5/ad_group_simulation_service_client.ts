 ...
 * `src/v5/ad_group_simulation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_simulation_service_client_config.json';
...
export class AdGroupSimulationServiceClient {
  ...
  adGroupSimulationServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdGroupSimulationServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.AdGroupSimulationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupSimulationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.AdGroupSimulationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.AdGroupSimulationService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupSimulationServiceStubMethods =
        ['getAdGroupSimulation'];
    for (const methodName of adGroupSimulationServiceStubMethods) {
      const callPromise = this.adGroupSimulationServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getAdGroupSimulation(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupSimulationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IAdGroupSimulation,
        protos.google.ads.googleads.v5.services.IGetAdGroupSimulationRequest|undefined, {}|undefined
      ]>;
  getAdGroupSimulation(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupSimulationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IAdGroupSimulation,
          protos.google.ads.googleads.v5.services.IGetAdGroupSimulationRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroupSimulation(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupSimulationRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AdGroupSimulation]{@link google.ads.googleads.v5.resources.AdGroupSimulation}.
 *   Please see the
