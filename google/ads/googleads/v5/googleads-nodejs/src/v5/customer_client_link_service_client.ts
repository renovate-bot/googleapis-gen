 ...
 * `src/v5/customer_client_link_service_client_config.json`.
...
export class CustomerClientLinkServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.CustomerClientLinkService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerClientLinkServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.CustomerClientLinkService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.CustomerClientLinkService,
  ...
  getCustomerClientLink(
      request: protos.google.ads.googleads.v5.services.IGetCustomerClientLinkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ICustomerClientLink,
        protos.google.ads.googleads.v5.services.IGetCustomerClientLinkRequest|undefined, {}|undefined
      ]>;
  getCustomerClientLink(
      request: protos.google.ads.googleads.v5.services.IGetCustomerClientLinkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ICustomerClientLink,
          protos.google.ads.googleads.v5.services.IGetCustomerClientLinkRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomerClientLink(
      request: protos.google.ads.googleads.v5.services.IGetCustomerClientLinkRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CustomerClientLink]{@link google.ads.googleads.v5.resources.CustomerClientLink}.
 *   Please see the
 ...
 */
  ...
  mutateCustomerClientLink(
      request: protos.google.ads.googleads.v5.services.IMutateCustomerClientLinkRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateCustomerClientLinkResponse,
        protos.google.ads.googleads.v5.services.IMutateCustomerClientLinkRequest|undefined, {}|undefined
      ]>;
  mutateCustomerClientLink(
      request: protos.google.ads.googleads.v5.services.IMutateCustomerClientLinkRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateCustomerClientLinkResponse,
          protos.google.ads.googleads.v5.services.IMutateCustomerClientLinkRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerClientLink(
      request: protos.google.ads.googleads.v5.services.IMutateCustomerClientLinkRequest,
      callback: Callback<
 ...
 * @param {google.ads.googleads.v5.services.CustomerClientLinkOperation} request.operation
 *   Required. The operation to perform on the individual CustomerClientLink.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomerClientLinkResponse]{@link google.ads.googleads.v5.services.MutateCustomerClientLinkResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
