 ...
 * `src/v5/keyword_plan_ad_group_keyword_service_client_config.json`.
...
export class KeywordPlanAdGroupKeywordServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordPlanAdGroupKeywordServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.KeywordPlanAdGroupKeywordService,
  ...
  getKeywordPlanAdGroupKeyword(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v5.services.IGetKeywordPlanAdGroupKeywordRequest|undefined, {}|undefined
      ]>;
  getKeywordPlanAdGroupKeyword(
      request: protos.google.ads.googleads.v5.services.IGetKeywordPlanAdGroupKeywordRequest,
      options: CallOptions,
 ...
 *   The first element of the array is an object representing [KeywordPlanAdGroupKeyword]{@link google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword}.
 *   Please see the
 ...
 */
  ...
  mutateKeywordPlanAdGroupKeywords(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v5.services.IMutateKeywordPlanAdGroupKeywordsRequest|undefined, {}|undefined
      ]>;
  mutateKeywordPlanAdGroupKeywords(
      request: protos.google.ads.googleads.v5.services.IMutateKeywordPlanAdGroupKeywordsRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateKeywordPlanAdGroupKeywordsResponse]{@link google.ads.googleads.v5.services.MutateKeywordPlanAdGroupKeywordsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
