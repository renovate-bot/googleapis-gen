 ...
 * `src/v5/recommendation_service_client_config.json`.
...
export class RecommendationServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.RecommendationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.recommendationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.RecommendationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.RecommendationService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const recommendationServiceStubMethods =
        ['getRecommendation', 'applyRecommendation', 'dismissRecommendation'];
  ...
  // -------------------
  getRecommendation(
      request: protos.google.ads.googleads.v5.services.IGetRecommendationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IRecommendation,
        protos.google.ads.googleads.v5.services.IGetRecommendationRequest|undefined, {}|undefined
      ]>;
  getRecommendation(
      request: protos.google.ads.googleads.v5.services.IGetRecommendationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IRecommendation,
          protos.google.ads.googleads.v5.services.IGetRecommendationRequest|null|undefined,
          {}|null|undefined>): void;
  getRecommendation(
      request: protos.google.ads.googleads.v5.services.IGetRecommendationRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [Recommendation]{@link google.ads.googleads.v5.resources.Recommendation}.
 *   Please see the
 ...
 */
  ...
  applyRecommendation(
      request: protos.google.ads.googleads.v5.services.IApplyRecommendationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IApplyRecommendationResponse,
        protos.google.ads.googleads.v5.services.IApplyRecommendationRequest|undefined, {}|undefined
      ]>;
  applyRecommendation(
      request: protos.google.ads.googleads.v5.services.IApplyRecommendationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IApplyRecommendationResponse,
          protos.google.ads.googleads.v5.services.IApplyRecommendationRequest|null|undefined,
          {}|null|undefined>): void;
  applyRecommendation(
      request: protos.google.ads.googleads.v5.services.IApplyRecommendationRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [ApplyRecommendationResponse]{@link google.ads.googleads.v5.services.ApplyRecommendationResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  dismissRecommendation(
      request: protos.google.ads.googleads.v5.services.IDismissRecommendationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IDismissRecommendationResponse,
        protos.google.ads.googleads.v5.services.IDismissRecommendationRequest|undefined, {}|undefined
      ]>;
  dismissRecommendation(
      request: protos.google.ads.googleads.v5.services.IDismissRecommendationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IDismissRecommendationResponse,
          protos.google.ads.googleads.v5.services.IDismissRecommendationRequest|null|undefined,
          {}|null|undefined>): void;
  dismissRecommendation(
      request: protos.google.ads.googleads.v5.services.IDismissRecommendationRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [DismissRecommendationResponse]{@link google.ads.googleads.v5.services.DismissRecommendationResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
