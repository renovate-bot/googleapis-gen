 ...
 * `src/v5/dynamic_search_ads_search_term_view_service_client_config.json`.
...
export class DynamicSearchAdsSearchTermViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.DynamicSearchAdsSearchTermViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.dynamicSearchAdsSearchTermViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.DynamicSearchAdsSearchTermViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.DynamicSearchAdsSearchTermViewService,
  ...
  // -------------------
  getDynamicSearchAdsSearchTermView(
      request?: protos.google.ads.googleads.v5.services.IGetDynamicSearchAdsSearchTermViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IDynamicSearchAdsSearchTermView,
        protos.google.ads.googleads.v5.services.IGetDynamicSearchAdsSearchTermViewRequest|undefined, {}|undefined
      ]>;
  getDynamicSearchAdsSearchTermView(
      request: protos.google.ads.googleads.v5.services.IGetDynamicSearchAdsSearchTermViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IDynamicSearchAdsSearchTermView,
          protos.google.ads.googleads.v5.services.IGetDynamicSearchAdsSearchTermViewRequest|null|undefined,
          {}|null|undefined>): void;
  getDynamicSearchAdsSearchTermView(
      request: protos.google.ads.googleads.v5.services.IGetDynamicSearchAdsSearchTermViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [DynamicSearchAdsSearchTermView]{@link google.ads.googleads.v5.resources.DynamicSearchAdsSearchTermView}.
 *   Please see the
