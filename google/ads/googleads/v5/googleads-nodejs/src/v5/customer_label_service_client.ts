 ...
 * `src/v5/customer_label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_label_service_client_config.json';
...
export class CustomerLabelServiceClient {
  ...
  customerLabelServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CustomerLabelServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.CustomerLabelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerLabelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.CustomerLabelService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.CustomerLabelService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerLabelServiceStubMethods =
        ['getCustomerLabel', 'mutateCustomerLabels'];
    for (const methodName of customerLabelServiceStubMethods) {
      const callPromise = this.customerLabelServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getCustomerLabel(
      request: protos.google.ads.googleads.v5.services.IGetCustomerLabelRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ICustomerLabel,
        protos.google.ads.googleads.v5.services.IGetCustomerLabelRequest|undefined, {}|undefined
      ]>;
  getCustomerLabel(
      request: protos.google.ads.googleads.v5.services.IGetCustomerLabelRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ICustomerLabel,
          protos.google.ads.googleads.v5.services.IGetCustomerLabelRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomerLabel(
      request: protos.google.ads.googleads.v5.services.IGetCustomerLabelRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CustomerLabel]{@link google.ads.googleads.v5.resources.CustomerLabel}.
 *   Please see the
 ...
 */
  ...
  mutateCustomerLabels(
      request: protos.google.ads.googleads.v5.services.IMutateCustomerLabelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateCustomerLabelsResponse,
        protos.google.ads.googleads.v5.services.IMutateCustomerLabelsRequest|undefined, {}|undefined
      ]>;
  mutateCustomerLabels(
      request: protos.google.ads.googleads.v5.services.IMutateCustomerLabelsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateCustomerLabelsResponse,
          protos.google.ads.googleads.v5.services.IMutateCustomerLabelsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomerLabels(
      request: protos.google.ads.googleads.v5.services.IMutateCustomerLabelsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomerLabelsResponse]{@link google.ads.googleads.v5.services.MutateCustomerLabelsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
