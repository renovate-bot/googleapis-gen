 ...
 * `src/v5/campaign_draft_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './campaign_draft_service_client_config.json';
...
export class CampaignDraftServiceClient {
  ...
  campaignDraftServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const promoteCampaignDraftResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty') as gax.protobuf.Type;
    const promoteCampaignDraftMetadata = protoFilesRoot.lookup(
      '.google.protobuf.Empty') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      promoteCampaignDraft: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        promoteCampaignDraftResponse.decode.bind(promoteCampaignDraftResponse),
        promoteCampaignDraftMetadata.decode.bind(promoteCampaignDraftMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.CampaignDraftService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignDraftServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.CampaignDraftService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.CampaignDraftService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignDraftServiceStubMethods =
        ['getCampaignDraft', 'mutateCampaignDrafts', 'promoteCampaignDraft', 'listCampaignDraftAsyncErrors'];
    for (const methodName of campaignDraftServiceStubMethods) {
      const callPromise = this.campaignDraftServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getCampaignDraft(
      request: protos.google.ads.googleads.v5.services.IGetCampaignDraftRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ICampaignDraft,
        protos.google.ads.googleads.v5.services.IGetCampaignDraftRequest|undefined, {}|undefined
      ]>;
  getCampaignDraft(
      request: protos.google.ads.googleads.v5.services.IGetCampaignDraftRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ICampaignDraft,
          protos.google.ads.googleads.v5.services.IGetCampaignDraftRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignDraft(
      request: protos.google.ads.googleads.v5.services.IGetCampaignDraftRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CampaignDraft]{@link google.ads.googleads.v5.resources.CampaignDraft}.
 *   Please see the
 ...
 */
  ...
  mutateCampaignDrafts(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignDraftsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateCampaignDraftsResponse,
        protos.google.ads.googleads.v5.services.IMutateCampaignDraftsRequest|undefined, {}|undefined
      ]>;
  mutateCampaignDrafts(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignDraftsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateCampaignDraftsResponse,
          protos.google.ads.googleads.v5.services.IMutateCampaignDraftsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCampaignDrafts(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignDraftsRequest,
      callback: Callback<
 ...
 * @param {google.ads.googleads.v5.enums.ResponseContentTypeEnum.ResponseContentType} request.responseContentType
 *   The response content type setting. Determines whether the mutable resource
 *   or just the resource name should be returned post mutation.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCampaignDraftsResponse]{@link google.ads.googleads.v5.services.MutateCampaignDraftsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  promoteCampaignDraft(
      request: protos.google.ads.googleads.v5.services.IPromoteCampaignDraftRequest,
      options?: CallOptions):
      Promise<[
 ...
 * {@link google.ads.googleads.v5.services.CampaignDraftService.ListCampaignDraftAsyncErrors|CampaignDraftService.ListCampaignDraftAsyncErrors} to view the list of
 * error reasons.
 *
 * @param {Object} request
 *   The request object that will be sent.
 ...
 */
  ...
  listCampaignDraftAsyncErrors(
      request: protos.google.ads.googleads.v5.services.IListCampaignDraftAsyncErrorsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.rpc.IStatus[],
        protos.google.ads.googleads.v5.services.IListCampaignDraftAsyncErrorsRequest|null,
        protos.google.ads.googleads.v5.services.IListCampaignDraftAsyncErrorsResponse
      ]>;
  listCampaignDraftAsyncErrors(
      request: protos.google.ads.googleads.v5.services.IListCampaignDraftAsyncErrorsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.googleads.v5.services.IListCampaignDraftAsyncErrorsRequest,
          protos.google.ads.googleads.v5.services.IListCampaignDraftAsyncErrorsResponse|null|undefined,
