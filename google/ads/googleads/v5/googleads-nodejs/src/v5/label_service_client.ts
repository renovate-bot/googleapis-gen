 ...
 * `src/v5/label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './label_service_client_config.json';
...
export class LabelServiceClient {
  ...
  labelServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof LabelServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.LabelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.labelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.LabelService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.LabelService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const labelServiceStubMethods =
        ['getLabel', 'mutateLabels'];
    for (const methodName of labelServiceStubMethods) {
      const callPromise = this.labelServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getLabel(
      request: protos.google.ads.googleads.v5.services.IGetLabelRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ILabel,
        protos.google.ads.googleads.v5.services.IGetLabelRequest|undefined, {}|undefined
      ]>;
  getLabel(
      request: protos.google.ads.googleads.v5.services.IGetLabelRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ILabel,
          protos.google.ads.googleads.v5.services.IGetLabelRequest|null|undefined,
          {}|null|undefined>): void;
  getLabel(
      request: protos.google.ads.googleads.v5.services.IGetLabelRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [Label]{@link google.ads.googleads.v5.resources.Label}.
 *   Please see the
 ...
 */
  ...
  mutateLabels(
      request: protos.google.ads.googleads.v5.services.IMutateLabelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateLabelsResponse,
        protos.google.ads.googleads.v5.services.IMutateLabelsRequest|undefined, {}|undefined
      ]>;
  mutateLabels(
      request: protos.google.ads.googleads.v5.services.IMutateLabelsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateLabelsResponse,
          protos.google.ads.googleads.v5.services.IMutateLabelsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateLabels(
      request: protos.google.ads.googleads.v5.services.IMutateLabelsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateLabelsResponse]{@link google.ads.googleads.v5.services.MutateLabelsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
