 ...
 * `src/v5/customer_client_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './customer_client_service_client_config.json';
...
export class CustomerClientServiceClient {
  ...
  customerClientServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CustomerClientServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.CustomerClientService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.customerClientServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.CustomerClientService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.CustomerClientService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const customerClientServiceStubMethods =
        ['getCustomerClient'];
    for (const methodName of customerClientServiceStubMethods) {
      const callPromise = this.customerClientServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getCustomerClient(
      request: protos.google.ads.googleads.v5.services.IGetCustomerClientRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ICustomerClient,
        protos.google.ads.googleads.v5.services.IGetCustomerClientRequest|undefined, {}|undefined
      ]>;
  getCustomerClient(
      request: protos.google.ads.googleads.v5.services.IGetCustomerClientRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ICustomerClient,
          protos.google.ads.googleads.v5.services.IGetCustomerClientRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomerClient(
      request: protos.google.ads.googleads.v5.services.IGetCustomerClientRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CustomerClient]{@link google.ads.googleads.v5.resources.CustomerClient}.
 *   Please see the
