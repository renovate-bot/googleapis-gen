 ...
 * `src/v5/income_range_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './income_range_view_service_client_config.json';
 ...
 * @memberof v5
 */
export class IncomeRangeViewServiceClient {
  ...
  incomeRangeViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof IncomeRangeViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.IncomeRangeViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.incomeRangeViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.IncomeRangeViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.IncomeRangeViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const incomeRangeViewServiceStubMethods =
        ['getIncomeRangeView'];
    for (const methodName of incomeRangeViewServiceStubMethods) {
      const callPromise = this.incomeRangeViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getIncomeRangeView(
      request: protos.google.ads.googleads.v5.services.IGetIncomeRangeViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IIncomeRangeView,
        protos.google.ads.googleads.v5.services.IGetIncomeRangeViewRequest|undefined, {}|undefined
      ]>;
  getIncomeRangeView(
      request: protos.google.ads.googleads.v5.services.IGetIncomeRangeViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IIncomeRangeView,
          protos.google.ads.googleads.v5.services.IGetIncomeRangeViewRequest|null|undefined,
          {}|null|undefined>): void;
  getIncomeRangeView(
      request: protos.google.ads.googleads.v5.services.IGetIncomeRangeViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [IncomeRangeView]{@link google.ads.googleads.v5.resources.IncomeRangeView}.
 *   Please see the
