 ...
 * `src/v5/conversion_adjustment_upload_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './conversion_adjustment_upload_service_client_config.json';
...
export class ConversionAdjustmentUploadServiceClient {
  ...
  conversionAdjustmentUploadServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ConversionAdjustmentUploadServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.ConversionAdjustmentUploadService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.conversionAdjustmentUploadServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.ConversionAdjustmentUploadService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.ConversionAdjustmentUploadService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const conversionAdjustmentUploadServiceStubMethods =
        ['uploadConversionAdjustments'];
    for (const methodName of conversionAdjustmentUploadServiceStubMethods) {
      const callPromise = this.conversionAdjustmentUploadServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  uploadConversionAdjustments(
      request: protos.google.ads.googleads.v5.services.IUploadConversionAdjustmentsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IUploadConversionAdjustmentsResponse,
        protos.google.ads.googleads.v5.services.IUploadConversionAdjustmentsRequest|undefined, {}|undefined
      ]>;
  uploadConversionAdjustments(
      request: protos.google.ads.googleads.v5.services.IUploadConversionAdjustmentsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IUploadConversionAdjustmentsResponse,
          protos.google.ads.googleads.v5.services.IUploadConversionAdjustmentsRequest|null|undefined,
          {}|null|undefined>): void;
  uploadConversionAdjustments(
      request: protos.google.ads.googleads.v5.services.IUploadConversionAdjustmentsRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [UploadConversionAdjustmentsResponse]{@link google.ads.googleads.v5.services.UploadConversionAdjustmentsResponse}.
 *   Please see the
