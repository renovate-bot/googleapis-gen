 ...
 * `src/v5/campaign_budget_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './campaign_budget_service_client_config.json';
...
export class CampaignBudgetServiceClient {
  ...
  campaignBudgetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignBudgetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.CampaignBudgetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignBudgetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.CampaignBudgetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.CampaignBudgetService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignBudgetServiceStubMethods =
        ['getCampaignBudget', 'mutateCampaignBudgets'];
    for (const methodName of campaignBudgetServiceStubMethods) {
      const callPromise = this.campaignBudgetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getCampaignBudget(
      request: protos.google.ads.googleads.v5.services.IGetCampaignBudgetRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ICampaignBudget,
        protos.google.ads.googleads.v5.services.IGetCampaignBudgetRequest|undefined, {}|undefined
      ]>;
  getCampaignBudget(
      request: protos.google.ads.googleads.v5.services.IGetCampaignBudgetRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ICampaignBudget,
          protos.google.ads.googleads.v5.services.IGetCampaignBudgetRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignBudget(
      request: protos.google.ads.googleads.v5.services.IGetCampaignBudgetRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CampaignBudget]{@link google.ads.googleads.v5.resources.CampaignBudget}.
 *   Please see the
 ...
 */
  ...
  mutateCampaignBudgets(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignBudgetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateCampaignBudgetsResponse,
        protos.google.ads.googleads.v5.services.IMutateCampaignBudgetsRequest|undefined, {}|undefined
      ]>;
  mutateCampaignBudgets(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignBudgetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateCampaignBudgetsResponse,
          protos.google.ads.googleads.v5.services.IMutateCampaignBudgetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCampaignBudgets(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignBudgetsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCampaignBudgetsResponse]{@link google.ads.googleads.v5.services.MutateCampaignBudgetsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
