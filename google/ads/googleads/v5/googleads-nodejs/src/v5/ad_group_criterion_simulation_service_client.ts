 ...
 * `src/v5/ad_group_criterion_simulation_service_client_config.json`.
...
export class AdGroupCriterionSimulationServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.AdGroupCriterionSimulationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupCriterionSimulationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.AdGroupCriterionSimulationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.AdGroupCriterionSimulationService,
  ...
  // -------------------
  getAdGroupCriterionSimulation(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupCriterionSimulationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IAdGroupCriterionSimulation,
        protos.google.ads.googleads.v5.services.IGetAdGroupCriterionSimulationRequest|undefined, {}|undefined
      ]>;
  getAdGroupCriterionSimulation(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupCriterionSimulationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IAdGroupCriterionSimulation,
          protos.google.ads.googleads.v5.services.IGetAdGroupCriterionSimulationRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroupCriterionSimulation(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupCriterionSimulationRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AdGroupCriterionSimulation]{@link google.ads.googleads.v5.resources.AdGroupCriterionSimulation}.
 *   Please see the
