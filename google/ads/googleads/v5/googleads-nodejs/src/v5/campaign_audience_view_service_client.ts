 ...
 * `src/v5/campaign_audience_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './campaign_audience_view_service_client_config.json';
...
export class CampaignAudienceViewServiceClient {
  ...
  campaignAudienceViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignAudienceViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.CampaignAudienceViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignAudienceViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.CampaignAudienceViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.CampaignAudienceViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignAudienceViewServiceStubMethods =
        ['getCampaignAudienceView'];
    for (const methodName of campaignAudienceViewServiceStubMethods) {
      const callPromise = this.campaignAudienceViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getCampaignAudienceView(
      request: protos.google.ads.googleads.v5.services.IGetCampaignAudienceViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ICampaignAudienceView,
        protos.google.ads.googleads.v5.services.IGetCampaignAudienceViewRequest|undefined, {}|undefined
      ]>;
  getCampaignAudienceView(
      request: protos.google.ads.googleads.v5.services.IGetCampaignAudienceViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ICampaignAudienceView,
          protos.google.ads.googleads.v5.services.IGetCampaignAudienceViewRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignAudienceView(
      request: protos.google.ads.googleads.v5.services.IGetCampaignAudienceViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CampaignAudienceView]{@link google.ads.googleads.v5.resources.CampaignAudienceView}.
 *   Please see the
