 ...
 * `src/v5/mobile_app_category_constant_service_client_config.json`.
...
export class MobileAppCategoryConstantServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.MobileAppCategoryConstantService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.mobileAppCategoryConstantServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.MobileAppCategoryConstantService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.MobileAppCategoryConstantService,
  ...
  // -------------------
  getMobileAppCategoryConstant(
      request: protos.google.ads.googleads.v5.services.IGetMobileAppCategoryConstantRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IMobileAppCategoryConstant,
        protos.google.ads.googleads.v5.services.IGetMobileAppCategoryConstantRequest|undefined, {}|undefined
      ]>;
  getMobileAppCategoryConstant(
      request: protos.google.ads.googleads.v5.services.IGetMobileAppCategoryConstantRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IMobileAppCategoryConstant,
          protos.google.ads.googleads.v5.services.IGetMobileAppCategoryConstantRequest|null|undefined,
          {}|null|undefined>): void;
  getMobileAppCategoryConstant(
      request: protos.google.ads.googleads.v5.services.IGetMobileAppCategoryConstantRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [MobileAppCategoryConstant]{@link google.ads.googleads.v5.resources.MobileAppCategoryConstant}.
 *   Please see the
