 ...
 * `src/v5/click_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './click_view_service_client_config.json';
...
export class ClickViewServiceClient {
  ...
  clickViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ClickViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.ClickViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.clickViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.ClickViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.ClickViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const clickViewServiceStubMethods =
        ['getClickView'];
    for (const methodName of clickViewServiceStubMethods) {
      const callPromise = this.clickViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getClickView(
      request: protos.google.ads.googleads.v5.services.IGetClickViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IClickView,
        protos.google.ads.googleads.v5.services.IGetClickViewRequest|undefined, {}|undefined
      ]>;
  getClickView(
      request: protos.google.ads.googleads.v5.services.IGetClickViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IClickView,
          protos.google.ads.googleads.v5.services.IGetClickViewRequest|null|undefined,
          {}|null|undefined>): void;
  getClickView(
      request: protos.google.ads.googleads.v5.services.IGetClickViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [ClickView]{@link google.ads.googleads.v5.resources.ClickView}.
 *   Please see the
