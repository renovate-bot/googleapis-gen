 ...
 * `src/v5/ad_group_criterion_label_service_client_config.json`.
...
export class AdGroupCriterionLabelServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.AdGroupCriterionLabelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupCriterionLabelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.AdGroupCriterionLabelService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.AdGroupCriterionLabelService,
  ...
  getAdGroupCriterionLabel(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupCriterionLabelRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IAdGroupCriterionLabel,
        protos.google.ads.googleads.v5.services.IGetAdGroupCriterionLabelRequest|undefined, {}|undefined
      ]>;
  getAdGroupCriterionLabel(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupCriterionLabelRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IAdGroupCriterionLabel,
          protos.google.ads.googleads.v5.services.IGetAdGroupCriterionLabelRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroupCriterionLabel(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupCriterionLabelRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AdGroupCriterionLabel]{@link google.ads.googleads.v5.resources.AdGroupCriterionLabel}.
 *   Please see the
 ...
 */
  ...
  mutateAdGroupCriterionLabels(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupCriterionLabelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateAdGroupCriterionLabelsResponse,
        protos.google.ads.googleads.v5.services.IMutateAdGroupCriterionLabelsRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupCriterionLabels(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupCriterionLabelsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateAdGroupCriterionLabelsResponse,
          protos.google.ads.googleads.v5.services.IMutateAdGroupCriterionLabelsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroupCriterionLabels(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupCriterionLabelsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateAdGroupCriterionLabelsResponse]{@link google.ads.googleads.v5.services.MutateAdGroupCriterionLabelsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
