 ...
 * `src/v5/ad_group_bid_modifier_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_bid_modifier_service_client_config.json';
...
export class AdGroupBidModifierServiceClient {
  ...
  adGroupBidModifierServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdGroupBidModifierServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.AdGroupBidModifierService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupBidModifierServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.AdGroupBidModifierService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.AdGroupBidModifierService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupBidModifierServiceStubMethods =
        ['getAdGroupBidModifier', 'mutateAdGroupBidModifiers'];
    for (const methodName of adGroupBidModifierServiceStubMethods) {
      const callPromise = this.adGroupBidModifierServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getAdGroupBidModifier(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupBidModifierRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IAdGroupBidModifier,
        protos.google.ads.googleads.v5.services.IGetAdGroupBidModifierRequest|undefined, {}|undefined
      ]>;
  getAdGroupBidModifier(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupBidModifierRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IAdGroupBidModifier,
          protos.google.ads.googleads.v5.services.IGetAdGroupBidModifierRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroupBidModifier(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupBidModifierRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AdGroupBidModifier]{@link google.ads.googleads.v5.resources.AdGroupBidModifier}.
 *   Please see the
 ...
 */
  ...
  mutateAdGroupBidModifiers(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupBidModifiersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateAdGroupBidModifiersResponse,
        protos.google.ads.googleads.v5.services.IMutateAdGroupBidModifiersRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupBidModifiers(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupBidModifiersRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateAdGroupBidModifiersResponse,
          protos.google.ads.googleads.v5.services.IMutateAdGroupBidModifiersRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroupBidModifiers(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupBidModifiersRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateAdGroupBidModifiersResponse]{@link google.ads.googleads.v5.services.MutateAdGroupBidModifiersResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
