 ...
 * `src/v5/feed_item_target_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './feed_item_target_service_client_config.json';
...
export class FeedItemTargetServiceClient {
  ...
  feedItemTargetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof FeedItemTargetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.FeedItemTargetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.feedItemTargetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.FeedItemTargetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.FeedItemTargetService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const feedItemTargetServiceStubMethods =
        ['getFeedItemTarget', 'mutateFeedItemTargets'];
    for (const methodName of feedItemTargetServiceStubMethods) {
      const callPromise = this.feedItemTargetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getFeedItemTarget(
      request: protos.google.ads.googleads.v5.services.IGetFeedItemTargetRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IFeedItemTarget,
        protos.google.ads.googleads.v5.services.IGetFeedItemTargetRequest|undefined, {}|undefined
      ]>;
  getFeedItemTarget(
      request: protos.google.ads.googleads.v5.services.IGetFeedItemTargetRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IFeedItemTarget,
          protos.google.ads.googleads.v5.services.IGetFeedItemTargetRequest|null|undefined,
          {}|null|undefined>): void;
  getFeedItemTarget(
      request: protos.google.ads.googleads.v5.services.IGetFeedItemTargetRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [FeedItemTarget]{@link google.ads.googleads.v5.resources.FeedItemTarget}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.getFeedItemTarget(request);
 */
  getFeedItemTarget(
      request: protos.google.ads.googleads.v5.services.IGetFeedItemTargetRequest,
  ...
  mutateFeedItemTargets(
      request: protos.google.ads.googleads.v5.services.IMutateFeedItemTargetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateFeedItemTargetsResponse,
        protos.google.ads.googleads.v5.services.IMutateFeedItemTargetsRequest|undefined, {}|undefined
      ]>;
  mutateFeedItemTargets(
      request: protos.google.ads.googleads.v5.services.IMutateFeedItemTargetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateFeedItemTargetsResponse,
          protos.google.ads.googleads.v5.services.IMutateFeedItemTargetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateFeedItemTargets(
      request: protos.google.ads.googleads.v5.services.IMutateFeedItemTargetsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateFeedItemTargetsResponse]{@link google.ads.googleads.v5.services.MutateFeedItemTargetsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.mutateFeedItemTargets(request);
 */
  mutateFeedItemTargets(
      request: protos.google.ads.googleads.v5.services.IMutateFeedItemTargetsRequest,
      optionsOrCallback?: CallOptions|Callback<
