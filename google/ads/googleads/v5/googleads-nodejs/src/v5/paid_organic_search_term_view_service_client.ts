 ...
 * `src/v5/paid_organic_search_term_view_service_client_config.json`.
...
export class PaidOrganicSearchTermViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.PaidOrganicSearchTermViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.paidOrganicSearchTermViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.PaidOrganicSearchTermViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.PaidOrganicSearchTermViewService,
  ...
  // -------------------
  getPaidOrganicSearchTermView(
      request?: protos.google.ads.googleads.v5.services.IGetPaidOrganicSearchTermViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IPaidOrganicSearchTermView,
        protos.google.ads.googleads.v5.services.IGetPaidOrganicSearchTermViewRequest|undefined, {}|undefined
      ]>;
  getPaidOrganicSearchTermView(
      request: protos.google.ads.googleads.v5.services.IGetPaidOrganicSearchTermViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IPaidOrganicSearchTermView,
          protos.google.ads.googleads.v5.services.IGetPaidOrganicSearchTermViewRequest|null|undefined,
          {}|null|undefined>): void;
  getPaidOrganicSearchTermView(
      request: protos.google.ads.googleads.v5.services.IGetPaidOrganicSearchTermViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [PaidOrganicSearchTermView]{@link google.ads.googleads.v5.resources.PaidOrganicSearchTermView}.
 *   Please see the
