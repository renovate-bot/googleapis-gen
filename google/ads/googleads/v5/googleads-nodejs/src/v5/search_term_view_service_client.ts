 ...
 * `src/v5/search_term_view_service_client_config.json`.
...
export class SearchTermViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.SearchTermViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.searchTermViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.SearchTermViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.SearchTermViewService,
  ...
  // -------------------
  getSearchTermView(
      request: protos.google.ads.googleads.v5.services.IGetSearchTermViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ISearchTermView,
        protos.google.ads.googleads.v5.services.IGetSearchTermViewRequest|undefined, {}|undefined
      ]>;
  getSearchTermView(
      request: protos.google.ads.googleads.v5.services.IGetSearchTermViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ISearchTermView,
          protos.google.ads.googleads.v5.services.IGetSearchTermViewRequest|null|undefined,
          {}|null|undefined>): void;
  getSearchTermView(
      request: protos.google.ads.googleads.v5.services.IGetSearchTermViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [SearchTermView]{@link google.ads.googleads.v5.resources.SearchTermView}.
 *   Please see the
