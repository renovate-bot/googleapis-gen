 ...
 * `src/v5/reach_plan_service_client_config.json`.
...
export class ReachPlanServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.ReachPlanService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.reachPlanServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.ReachPlanService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.ReachPlanService,
  ...
  listPlannableLocations(
      request: protos.google.ads.googleads.v5.services.IListPlannableLocationsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IListPlannableLocationsResponse,
        protos.google.ads.googleads.v5.services.IListPlannableLocationsRequest|undefined, {}|undefined
      ]>;
  listPlannableLocations(
      request: protos.google.ads.googleads.v5.services.IListPlannableLocationsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IListPlannableLocationsResponse,
          protos.google.ads.googleads.v5.services.IListPlannableLocationsRequest|null|undefined,
          {}|null|undefined>): void;
  listPlannableLocations(
      request: protos.google.ads.googleads.v5.services.IListPlannableLocationsRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [ListPlannableLocationsResponse]{@link google.ads.googleads.v5.services.ListPlannableLocationsResponse}.
 *   Please see the
 ...
 */
  ...
  listPlannableProducts(
      request: protos.google.ads.googleads.v5.services.IListPlannableProductsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IListPlannableProductsResponse,
        protos.google.ads.googleads.v5.services.IListPlannableProductsRequest|undefined, {}|undefined
      ]>;
  listPlannableProducts(
      request: protos.google.ads.googleads.v5.services.IListPlannableProductsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IListPlannableProductsResponse,
          protos.google.ads.googleads.v5.services.IListPlannableProductsRequest|null|undefined,
          {}|null|undefined>): void;
  listPlannableProducts(
      request: protos.google.ads.googleads.v5.services.IListPlannableProductsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [ListPlannableProductsResponse]{@link google.ads.googleads.v5.services.ListPlannableProductsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  generateProductMixIdeas(
      request: protos.google.ads.googleads.v5.services.IGenerateProductMixIdeasRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IGenerateProductMixIdeasResponse,
        protos.google.ads.googleads.v5.services.IGenerateProductMixIdeasRequest|undefined, {}|undefined
      ]>;
  generateProductMixIdeas(
      request: protos.google.ads.googleads.v5.services.IGenerateProductMixIdeasRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IGenerateProductMixIdeasResponse,
          protos.google.ads.googleads.v5.services.IGenerateProductMixIdeasRequest|null|undefined,
          {}|null|undefined>): void;
  generateProductMixIdeas(
      request: protos.google.ads.googleads.v5.services.IGenerateProductMixIdeasRequest,
      callback: Callback<
 ...
 * @param {google.ads.googleads.v5.services.Preferences} request.preferences
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [GenerateProductMixIdeasResponse]{@link google.ads.googleads.v5.services.GenerateProductMixIdeasResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  generateReachForecast(
      request: protos.google.ads.googleads.v5.services.IGenerateReachForecastRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IGenerateReachForecastResponse,
        protos.google.ads.googleads.v5.services.IGenerateReachForecastRequest|undefined, {}|undefined
      ]>;
  generateReachForecast(
      request: protos.google.ads.googleads.v5.services.IGenerateReachForecastRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IGenerateReachForecastResponse,
          protos.google.ads.googleads.v5.services.IGenerateReachForecastRequest|null|undefined,
          {}|null|undefined>): void;
  generateReachForecast(
      request: protos.google.ads.googleads.v5.services.IGenerateReachForecastRequest,
      callback: Callback<
 ...
 *   The currency code.
 *   Three-character ISO 4217 currency code.
 * @param {google.ads.googleads.v5.services.CampaignDuration} request.campaignDuration
 ...
 * @param {google.ads.googleads.v5.services.FrequencyCap} request.cookieFrequencyCapSetting
 *   Desired cookie frequency cap that will be applied to each planned product.
 *   This is equivalent to the frequency cap exposed in Google Ads when creating
 *   a campaign, it represents the maximum number of times an ad can be shown to
 ...
 * @param {google.ads.googleads.v5.services.Targeting} request.targeting
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [GenerateReachForecastResponse]{@link google.ads.googleads.v5.services.GenerateReachForecastResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
