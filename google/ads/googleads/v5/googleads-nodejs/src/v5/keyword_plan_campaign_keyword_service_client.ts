 ...
 * `src/v5/keyword_plan_campaign_keyword_service_client_config.json`.
...
export class KeywordPlanCampaignKeywordServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.KeywordPlanCampaignKeywordService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordPlanCampaignKeywordServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.KeywordPlanCampaignKeywordService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.KeywordPlanCampaignKeywordService,
  ...
  getKeywordPlanCampaignKeyword(
      request: protos.google.ads.googleads.v5.services.IGetKeywordPlanCampaignKeywordRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IKeywordPlanCampaignKeyword,
        protos.google.ads.googleads.v5.services.IGetKeywordPlanCampaignKeywordRequest|undefined, {}|undefined
      ]>;
  getKeywordPlanCampaignKeyword(
      request: protos.google.ads.googleads.v5.services.IGetKeywordPlanCampaignKeywordRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IKeywordPlanCampaignKeyword,
          protos.google.ads.googleads.v5.services.IGetKeywordPlanCampaignKeywordRequest|null|undefined,
          {}|null|undefined>): void;
  getKeywordPlanCampaignKeyword(
      request: protos.google.ads.googleads.v5.services.IGetKeywordPlanCampaignKeywordRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [KeywordPlanCampaignKeyword]{@link google.ads.googleads.v5.resources.KeywordPlanCampaignKeyword}.
 *   Please see the
 ...
 */
  ...
  mutateKeywordPlanCampaignKeywords(
      request: protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignKeywordsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignKeywordsResponse,
        protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignKeywordsRequest|undefined, {}|undefined
      ]>;
  mutateKeywordPlanCampaignKeywords(
      request: protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignKeywordsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignKeywordsResponse,
          protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignKeywordsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateKeywordPlanCampaignKeywords(
      request: protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignKeywordsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateKeywordPlanCampaignKeywordsResponse]{@link google.ads.googleads.v5.services.MutateKeywordPlanCampaignKeywordsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
