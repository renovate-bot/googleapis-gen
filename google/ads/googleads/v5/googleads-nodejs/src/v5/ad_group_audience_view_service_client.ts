 ...
 * `src/v5/ad_group_audience_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_audience_view_service_client_config.json';
...
export class AdGroupAudienceViewServiceClient {
  ...
  adGroupAudienceViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdGroupAudienceViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.AdGroupAudienceViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupAudienceViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.AdGroupAudienceViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.AdGroupAudienceViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupAudienceViewServiceStubMethods =
        ['getAdGroupAudienceView'];
    for (const methodName of adGroupAudienceViewServiceStubMethods) {
      const callPromise = this.adGroupAudienceViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getAdGroupAudienceView(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupAudienceViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IAdGroupAudienceView,
        protos.google.ads.googleads.v5.services.IGetAdGroupAudienceViewRequest|undefined, {}|undefined
      ]>;
  getAdGroupAudienceView(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupAudienceViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IAdGroupAudienceView,
          protos.google.ads.googleads.v5.services.IGetAdGroupAudienceViewRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroupAudienceView(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupAudienceViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AdGroupAudienceView]{@link google.ads.googleads.v5.resources.AdGroupAudienceView}.
 *   Please see the
