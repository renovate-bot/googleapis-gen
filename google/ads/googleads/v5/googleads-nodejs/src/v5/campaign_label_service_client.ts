 ...
 * `src/v5/campaign_label_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './campaign_label_service_client_config.json';
...
export class CampaignLabelServiceClient {
  ...
  campaignLabelServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignLabelServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.CampaignLabelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignLabelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.CampaignLabelService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.CampaignLabelService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignLabelServiceStubMethods =
        ['getCampaignLabel', 'mutateCampaignLabels'];
    for (const methodName of campaignLabelServiceStubMethods) {
      const callPromise = this.campaignLabelServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getCampaignLabel(
      request: protos.google.ads.googleads.v5.services.IGetCampaignLabelRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ICampaignLabel,
        protos.google.ads.googleads.v5.services.IGetCampaignLabelRequest|undefined, {}|undefined
      ]>;
  getCampaignLabel(
      request: protos.google.ads.googleads.v5.services.IGetCampaignLabelRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ICampaignLabel,
          protos.google.ads.googleads.v5.services.IGetCampaignLabelRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignLabel(
      request: protos.google.ads.googleads.v5.services.IGetCampaignLabelRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CampaignLabel]{@link google.ads.googleads.v5.resources.CampaignLabel}.
 *   Please see the
 ...
 */
  ...
  mutateCampaignLabels(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignLabelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateCampaignLabelsResponse,
        protos.google.ads.googleads.v5.services.IMutateCampaignLabelsRequest|undefined, {}|undefined
      ]>;
  mutateCampaignLabels(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignLabelsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateCampaignLabelsResponse,
          protos.google.ads.googleads.v5.services.IMutateCampaignLabelsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCampaignLabels(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignLabelsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCampaignLabelsResponse]{@link google.ads.googleads.v5.services.MutateCampaignLabelsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
