 ...
 * `src/v5/topic_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './topic_view_service_client_config.json';
...
export class TopicViewServiceClient {
  ...
  topicViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof TopicViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.TopicViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.topicViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.TopicViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.TopicViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const topicViewServiceStubMethods =
        ['getTopicView'];
    for (const methodName of topicViewServiceStubMethods) {
      const callPromise = this.topicViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getTopicView(
      request: protos.google.ads.googleads.v5.services.IGetTopicViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ITopicView,
        protos.google.ads.googleads.v5.services.IGetTopicViewRequest|undefined, {}|undefined
      ]>;
  getTopicView(
      request: protos.google.ads.googleads.v5.services.IGetTopicViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ITopicView,
          protos.google.ads.googleads.v5.services.IGetTopicViewRequest|null|undefined,
          {}|null|undefined>): void;
  getTopicView(
      request: protos.google.ads.googleads.v5.services.IGetTopicViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [TopicView]{@link google.ads.googleads.v5.resources.TopicView}.
 *   Please see the
