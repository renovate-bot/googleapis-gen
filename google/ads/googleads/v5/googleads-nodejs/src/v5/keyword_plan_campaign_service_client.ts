 ...
 * `src/v5/keyword_plan_campaign_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './keyword_plan_campaign_service_client_config.json';
...
export class KeywordPlanCampaignServiceClient {
  ...
  keywordPlanCampaignServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof KeywordPlanCampaignServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.KeywordPlanCampaignService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordPlanCampaignServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.KeywordPlanCampaignService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.KeywordPlanCampaignService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const keywordPlanCampaignServiceStubMethods =
        ['getKeywordPlanCampaign', 'mutateKeywordPlanCampaigns'];
    for (const methodName of keywordPlanCampaignServiceStubMethods) {
      const callPromise = this.keywordPlanCampaignServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getKeywordPlanCampaign(
      request: protos.google.ads.googleads.v5.services.IGetKeywordPlanCampaignRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.IKeywordPlanCampaign,
        protos.google.ads.googleads.v5.services.IGetKeywordPlanCampaignRequest|undefined, {}|undefined
      ]>;
  getKeywordPlanCampaign(
      request: protos.google.ads.googleads.v5.services.IGetKeywordPlanCampaignRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.IKeywordPlanCampaign,
          protos.google.ads.googleads.v5.services.IGetKeywordPlanCampaignRequest|null|undefined,
          {}|null|undefined>): void;
  getKeywordPlanCampaign(
      request: protos.google.ads.googleads.v5.services.IGetKeywordPlanCampaignRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [KeywordPlanCampaign]{@link google.ads.googleads.v5.resources.KeywordPlanCampaign}.
 *   Please see the
 ...
 */
  ...
  mutateKeywordPlanCampaigns(
      request: protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignsResponse,
        protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignsRequest|undefined, {}|undefined
      ]>;
  mutateKeywordPlanCampaigns(
      request: protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignsResponse,
          protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateKeywordPlanCampaigns(
      request: protos.google.ads.googleads.v5.services.IMutateKeywordPlanCampaignsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateKeywordPlanCampaignsResponse]{@link google.ads.googleads.v5.services.MutateKeywordPlanCampaignsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
