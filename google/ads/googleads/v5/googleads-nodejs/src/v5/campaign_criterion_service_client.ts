 ...
 * `src/v5/campaign_criterion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './campaign_criterion_service_client_config.json';
...
export class CampaignCriterionServiceClient {
  ...
  campaignCriterionServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignCriterionServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.CampaignCriterionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignCriterionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.CampaignCriterionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.CampaignCriterionService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const campaignCriterionServiceStubMethods =
        ['getCampaignCriterion', 'mutateCampaignCriteria'];
    for (const methodName of campaignCriterionServiceStubMethods) {
      const callPromise = this.campaignCriterionServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getCampaignCriterion(
      request: protos.google.ads.googleads.v5.services.IGetCampaignCriterionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.resources.ICampaignCriterion,
        protos.google.ads.googleads.v5.services.IGetCampaignCriterionRequest|undefined, {}|undefined
      ]>;
  getCampaignCriterion(
      request: protos.google.ads.googleads.v5.services.IGetCampaignCriterionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.resources.ICampaignCriterion,
          protos.google.ads.googleads.v5.services.IGetCampaignCriterionRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignCriterion(
      request: protos.google.ads.googleads.v5.services.IGetCampaignCriterionRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CampaignCriterion]{@link google.ads.googleads.v5.resources.CampaignCriterion}.
 *   Please see the
 ...
 */
  ...
  mutateCampaignCriteria(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignCriteriaRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v5.services.IMutateCampaignCriteriaResponse,
        protos.google.ads.googleads.v5.services.IMutateCampaignCriteriaRequest|undefined, {}|undefined
      ]>;
  mutateCampaignCriteria(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignCriteriaRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v5.services.IMutateCampaignCriteriaResponse,
          protos.google.ads.googleads.v5.services.IMutateCampaignCriteriaRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCampaignCriteria(
      request: protos.google.ads.googleads.v5.services.IMutateCampaignCriteriaRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCampaignCriteriaResponse]{@link google.ads.googleads.v5.services.MutateCampaignCriteriaResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
