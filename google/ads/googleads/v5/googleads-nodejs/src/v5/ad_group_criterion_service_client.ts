 ...
 * `src/v5/ad_group_criterion_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_criterion_service_client_config.json';
...
export class AdGroupCriterionServiceClient {
  ...
  adGroupCriterionServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdGroupCriterionServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v5.services.AdGroupCriterionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupCriterionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v5.services.AdGroupCriterionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v5.services.AdGroupCriterionService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupCriterionServiceStubMethods =
        ['getAdGroupCriterion', 'mutateAdGroupCriteria'];
    for (const methodName of adGroupCriterionServiceStubMethods) {
      const callPromise = this.adGroupCriterionServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getAdGroupCriterion(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v5.services.IGetAdGroupCriterionRequest|undefined, {}|undefined
      ]>;
  getAdGroupCriterion(
      request: protos.google.ads.googleads.v5.services.IGetAdGroupCriterionRequest,
      options: CallOptions,
 ...
 *   The first element of the array is an object representing [AdGroupCriterion]{@link google.ads.googleads.v5.resources.AdGroupCriterion}.
 *   Please see the
 ...
 */
  ...
  mutateAdGroupCriteria(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v5.services.IMutateAdGroupCriteriaRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupCriteria(
      request: protos.google.ads.googleads.v5.services.IMutateAdGroupCriteriaRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateAdGroupCriteriaResponse]{@link google.ads.googleads.v5.services.MutateAdGroupCriteriaResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
