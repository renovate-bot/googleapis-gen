 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.errors.BillingSetupErrorEnum</code>
 */
class BillingSetupErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Errors\BillingSetupError::initOnce();
