 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.Targeting</code>
 */
class Targeting extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange age_range = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.common.GenderInfo genders = 3;</code>
     */
    private $genders;
    /**
     * Targeted devices.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.common.DeviceInfo devices = 4;</code>
     */
    private $devices;
    /**
     ...
     * by product and region and can be obtained from ListPlannableProducts.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.ReachPlanNetworkEnum.ReachPlanNetwork network = 5;</code>
     */
    protected $network = 0;
     ...
     *           Targeted age range.
     *           If not specified, targets all age ranges.
     *     @type \Google\Ads\GoogleAds\V5\Common\GenderInfo[]|\Google\Protobuf\Internal\RepeatedField $genders
     *           Targeted genders.
     *           If not specified, targets all genders.
     *     @type \Google\Ads\GoogleAds\V5\Common\DeviceInfo[]|\Google\Protobuf\Internal\RepeatedField $devices
     *           Targeted devices.
     *           If not specified, targets all applicable devices. Applicable devices vary
     *           by product and region and can be obtained from ListPlannableProducts.
     *     @type int $network
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\ReachPlanAgeRangeEnum\ReachPlanAgeRange::class);
        $this->age_range = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.common.GenderInfo genders = 3;</code>
     * @param \Google\Ads\GoogleAds\V5\Common\GenderInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setGenders($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V5\Common\GenderInfo::class);
        $this->genders = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.common.DeviceInfo devices = 4;</code>
     * @param \Google\Ads\GoogleAds\V5\Common\DeviceInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDevices($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V5\Common\DeviceInfo::class);
        $this->devices = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\ReachPlanNetworkEnum\ReachPlanNetwork::class);
        $this->network = $var;
