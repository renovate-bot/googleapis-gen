 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.FeedItemValidationError</code>
 */
class FeedItemValidationError extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.errors.FeedItemValidationErrorEnum.FeedItemValidationError validation_error = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Errors\FeedItemValidationErrorEnum\FeedItemValidationError::class);
