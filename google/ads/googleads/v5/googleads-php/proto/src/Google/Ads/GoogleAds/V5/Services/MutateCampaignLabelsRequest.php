 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.MutateCampaignLabelsRequest</code>
 */
class MutateCampaignLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.services.CampaignLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose campaign-label relationships are being modified.
     *     @type \Google\Ads\GoogleAds\V5\Services\CampaignLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on campaign-label relationships.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Services\CampaignLabelService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.services.CampaignLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V5\Services\CampaignLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V5\Services\CampaignLabelOperation::class);
        $this->operations = $arr;
