 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.BatchJob</code>
 */
class BatchJob extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.BatchJob.BatchJobMetadata metadata = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $metadata = null;
    /**
     * Output only. Status of this batch job.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.BatchJobStatusEnum.BatchJobStatus status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     *           Output only. The next sequence token to use when adding operations. Only set when the
     *           batch job status is PENDING.
     *     @type \Google\Ads\GoogleAds\V5\Resources\BatchJob\BatchJobMetadata $metadata
     *           Output only. Contains additional information about this batch job.
     *     @type int $status
     *           Output only. Status of this batch job.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.BatchJob.BatchJobMetadata metadata = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V5\Resources\BatchJob\BatchJobMetadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.BatchJob.BatchJobMetadata metadata = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V5\Resources\BatchJob\BatchJobMetadata $var
     * @return $this
     */
    public function setMetadata($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Resources\BatchJob\BatchJobMetadata::class);
        $this->metadata = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\BatchJobStatusEnum\BatchJobStatus::class);
        $this->status = $var;
