 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.MutateAccountBudgetProposalRequest</code>
 */
class MutateAccountBudgetProposalRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.services.AccountBudgetProposalOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The ID of the customer.
     *     @type \Google\Ads\GoogleAds\V5\Services\AccountBudgetProposalOperation $operation
     *           Required. The operation to perform on an individual account-level budget proposal.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.services.AccountBudgetProposalOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V5\Services\AccountBudgetProposalOperation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.services.AccountBudgetProposalOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V5\Services\AccountBudgetProposalOperation $var
     * @return $this
     */
    public function setOperation($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Services\AccountBudgetProposalOperation::class);
        $this->operation = $var;
