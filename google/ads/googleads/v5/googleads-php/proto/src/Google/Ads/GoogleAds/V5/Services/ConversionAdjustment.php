 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.ConversionAdjustment</code>
 */
class ConversionAdjustment extends \Google\Protobuf\Internal\Message
{
     ...
     * The adjustment type.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentType adjustment_type = 5;</code>
     */
     ...
     *           The adjustment type.
     *     @type \Google\Ads\GoogleAds\V5\Services\RestatementValue $restatement_value
     *           Information needed to restate the conversion's value.
     *           Required for restatements. Should not be supplied for retractions. An error
     *           will be returned if provided for a retraction.
     *           NOTE: If you want to upload a second restatement with a different adjusted
     ...
     *           Otherwise, it will be treated as a duplicate of the previous restatement
     *           and ignored.
     *     @type \Google\Ads\GoogleAds\V5\Services\GclidDateTimePair $gclid_date_time_pair
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\ConversionAdjustmentTypeEnum\ConversionAdjustmentType::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.services.RestatementValue restatement_value = 6;</code>
     * @param \Google\Ads\GoogleAds\V5\Services\RestatementValue $var
     * @return $this
     */
    public function setRestatementValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Services\RestatementValue::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.services.GclidDateTimePair gclid_date_time_pair = 1;</code>
     * @param \Google\Ads\GoogleAds\V5\Services\GclidDateTimePair $var
     * @return $this
     */
    public function setGclidDateTimePair($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Services\GclidDateTimePair::class);
