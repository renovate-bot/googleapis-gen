...
namespace Google\Ads\GoogleAds\V5\Resources\BatchJob;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.BatchJob.BatchJobMetadata</code>
 */
class BatchJobMetadata extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Resources\BatchJob::initOnce();
    ...
    {
        return isset($this->creation_date_time) ? $this->creation_date_time : null;
    }
    ...
    {
        return isset($this->completion_date_time) ? $this->completion_date_time : null;
    }
    ...
    {
        return isset($this->estimated_completion_ratio) ? $this->estimated_completion_ratio : null;
    }
    ...
    {
        return isset($this->operation_count) ? $this->operation_count : null;
    }
    ...
    {
        return isset($this->executed_operation_count) ? $this->executed_operation_count : null;
    }
...
class_alias(BatchJobMetadata::class, \Google\Ads\GoogleAds\V5\Resources\BatchJob_BatchJobMetadata::class);
