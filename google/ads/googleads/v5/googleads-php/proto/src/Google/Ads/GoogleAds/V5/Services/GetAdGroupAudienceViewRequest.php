 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.GetAdGroupAudienceViewRequest</code>
 */
class GetAdGroupAudienceViewRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Services\AdGroupAudienceViewService::initOnce();
