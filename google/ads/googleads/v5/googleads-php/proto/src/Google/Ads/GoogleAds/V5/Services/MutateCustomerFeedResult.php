 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.MutateCustomerFeedResult</code>
 */
class MutateCustomerFeedResult extends \Google\Protobuf\Internal\Message
{
     ...
     * "MUTABLE_RESOURCE".
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.CustomerFeed customer_feed = 2;</code>
     */
     ...
     *           Returned for successful operations.
     *     @type \Google\Ads\GoogleAds\V5\Resources\CustomerFeed $customer_feed
     *           The mutated customer feed with only mutable fields after mutate. The field
     *           will only be returned when response_content_type is set to
     *           "MUTABLE_RESOURCE".
     * }
