 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.common.CombinedRuleUserListInfo</code>
 */
class CombinedRuleUserListInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.UserListRuleInfo left_operand = 1;</code>
     */
     ...
     * rule based user list.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.UserListRuleInfo right_operand = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator rule_operator = 3;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V5\Common\UserListRuleInfo $left_operand
     *           Left operand of the combined rule.
     *           This field is required and must be populated when creating new combined
     *           rule based user list.
     *     @type \Google\Ads\GoogleAds\V5\Common\UserListRuleInfo $right_operand
     *           Right operand of the combined rule.
     *           This field is required and must be populated when creating new combined
     *           rule based user list.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\UserListCombinedRuleOperatorEnum\UserListCombinedRuleOperator::class);
