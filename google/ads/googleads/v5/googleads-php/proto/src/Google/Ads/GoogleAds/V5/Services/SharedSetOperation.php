 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.SharedSetOperation</code>
 */
class SharedSetOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V5\Resources\SharedSet $create
     *           Create operation: No resource name is expected for the new shared set.
     *     @type \Google\Ads\GoogleAds\V5\Resources\SharedSet $update
     ...
     * Create operation: No resource name is expected for the new shared set.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.SharedSet create = 1;</code>
     ...
     * name.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.SharedSet update = 2;</code>
     * @return \Google\Ads\GoogleAds\V5\Resources\SharedSet|null
     */
