 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.common.PolicyTopicEvidence.TextList</code>
 */
...
class_alias(TextList::class, \Google\Ads\GoogleAds\V5\Common\PolicyTopicEvidence_TextList::class);
