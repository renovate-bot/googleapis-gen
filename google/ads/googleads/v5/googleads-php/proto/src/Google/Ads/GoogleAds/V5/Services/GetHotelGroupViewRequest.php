 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.GetHotelGroupViewRequest</code>
 */
class GetHotelGroupViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Services\HotelGroupViewService::initOnce();
