 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.Preferences</code>
 */
class Preferences extends \Google\Protobuf\Internal\Message
{
     ...
     * If not set, default is any value.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.ReachPlanAdLengthEnum.ReachPlanAdLength ad_length = 3;</code>
     */
    ...
    {
        return isset($this->is_skippable) ? $this->is_skippable : null;
    }
    ...
    {
        return isset($this->starts_with_sound) ? $this->starts_with_sound : null;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\ReachPlanAdLengthEnum\ReachPlanAdLength::class);
        $this->ad_length = $var;
    ...
    {
        return isset($this->top_content_only) ? $this->top_content_only : null;
    }
    ...
    {
        return isset($this->has_guaranteed_price) ? $this->has_guaranteed_price : null;
    }
