...
namespace Google\Ads\GoogleAds\V5\Errors\BiddingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v5.errors.BiddingErrorEnum.BiddingError</code>
 */
class BiddingError
{
    /**
...
class_alias(BiddingError::class, \Google\Ads\GoogleAds\V5\Errors\BiddingErrorEnum_BiddingError::class);
