...
namespace Google\Ads\GoogleAds\V5\Services\SuggestGeoTargetConstantsRequest;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.SuggestGeoTargetConstantsRequest.GeoTargets</code>
 */
class GeoTargets extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Services\GeoTargetConstantService::initOnce();
...
class_alias(GeoTargets::class, \Google\Ads\GoogleAds\V5\Services\SuggestGeoTargetConstantsRequest_GeoTargets::class);
