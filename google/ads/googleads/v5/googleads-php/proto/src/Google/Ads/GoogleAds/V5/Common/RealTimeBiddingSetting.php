 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.common.RealTimeBiddingSetting</code>
 */
class RealTimeBiddingSetting extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Common\RealTimeBiddingSetting::initOnce();
