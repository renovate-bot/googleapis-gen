 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.common.UserListStringRuleItemInfo</code>
 */
class UserListStringRuleItemInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * rule item.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator operator = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\UserListStringRuleItemOperatorEnum\UserListStringRuleItemOperator::class);
        $this->operator = $var;
