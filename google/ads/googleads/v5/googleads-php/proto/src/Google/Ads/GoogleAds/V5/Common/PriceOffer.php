 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.common.PriceOffer</code>
 */
class PriceOffer extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit unit = 4;</code>
     */
    protected $unit = 0;
    /**
     ...
     *           Description text of this offer.
     *     @type \Google\Ads\GoogleAds\V5\Common\Money $price
     *           Price value of this offer.
     *     @type int $unit
     *           Price unit for this offer.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.Money price = 3;</code>
     * @param \Google\Ads\GoogleAds\V5\Common\Money $var
     * @return $this
     */
    public function setPrice($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Common\Money::class);
        $this->price = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\PriceExtensionPriceUnitEnum\PriceExtensionPriceUnit::class);
        $this->unit = $var;
