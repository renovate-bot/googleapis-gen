 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.errors.NotEmptyErrorEnum</code>
 */
class NotEmptyErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Errors\NotEmptyError::initOnce();
