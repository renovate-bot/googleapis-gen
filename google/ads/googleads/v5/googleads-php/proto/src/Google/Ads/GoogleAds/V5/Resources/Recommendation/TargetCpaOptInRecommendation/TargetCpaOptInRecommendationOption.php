...
namespace Google\Ads\GoogleAds\V5\Resources\Recommendation\TargetCpaOptInRecommendation;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption</code>
 */
class TargetCpaOptInRecommendationOption extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal goal = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $goal = 0;
    /**
     ...
     *           Amount is specified in micros, where one million is equivalent to one
     *           currency unit.
     *     @type \Google\Ads\GoogleAds\V5\Resources\Recommendation\RecommendationImpact $impact
     *           Output only. The impact estimate if this option is selected.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\TargetCpaOptInRecommendationGoalEnum\TargetCpaOptInRecommendationGoal::class);
        $this->goal = $var;
    ...
    {
        return isset($this->required_campaign_budget_amount_micros) ? $this->required_campaign_budget_amount_micros : null;
    }
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.Recommendation.RecommendationImpact impact = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V5\Resources\Recommendation\RecommendationImpact $var
     * @return $this
     */
    public function setImpact($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Resources\Recommendation\RecommendationImpact::class);
        $this->impact = $var;
...
class_alias(TargetCpaOptInRecommendationOption::class, \Google\Ads\GoogleAds\V5\Resources\Recommendation_TargetCpaOptInRecommendation_TargetCpaOptInRecommendationOption::class);
