 ...
 * A campaign draft.
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.CampaignDraft</code>
 */
class CampaignDraft extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.CampaignDraftStatusEnum.CampaignDraftStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Resources\CampaignDraft::initOnce();
    ...
    {
        return isset($this->draft_id) ? $this->draft_id : null;
    }
    ...
    {
        return isset($this->base_campaign) ? $this->base_campaign : null;
    }
    ...
    {
        return isset($this->draft_campaign) ? $this->draft_campaign : null;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\CampaignDraftStatusEnum\CampaignDraftStatus::class);
        $this->status = $var;
    ...
    {
        return isset($this->has_experiment_running) ? $this->has_experiment_running : null;
    }
