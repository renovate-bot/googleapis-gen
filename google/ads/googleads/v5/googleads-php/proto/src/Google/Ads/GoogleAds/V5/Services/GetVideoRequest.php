 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.GetVideoRequest</code>
 */
class GetVideoRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Services\VideoService::initOnce();
