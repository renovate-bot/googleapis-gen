 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.AdGroupBidModifier</code>
 */
class AdGroupBidModifier extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.BidModifierSourceEnum.BidModifierSource bid_modifier_source = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. Bid modifier source.
     *     @type \Google\Ads\GoogleAds\V5\Common\HotelDateSelectionTypeInfo $hotel_date_selection_type
     *           Immutable. Criterion for hotel date selection (default dates vs. user selected).
     *     @type \Google\Ads\GoogleAds\V5\Common\HotelAdvanceBookingWindowInfo $hotel_advance_booking_window
     *           Immutable. Criterion for number of days prior to the stay the booking is being made.
     *     @type \Google\Ads\GoogleAds\V5\Common\HotelLengthOfStayInfo $hotel_length_of_stay
     *           Immutable. Criterion for length of hotel stay in nights.
     *     @type \Google\Ads\GoogleAds\V5\Common\HotelCheckInDayInfo $hotel_check_in_day
     *           Immutable. Criterion for day of the week the booking is for.
     *     @type \Google\Ads\GoogleAds\V5\Common\DeviceInfo $device
     *           Immutable. A device criterion.
     *     @type \Google\Ads\GoogleAds\V5\Common\PreferredContentInfo $preferred_content
     *           Immutable. A preferred content criterion.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Resources\AdGroupBidModifier::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\BidModifierSourceEnum\BidModifierSource::class);
     ...
     * Immutable. Criterion for hotel date selection (default dates vs. user selected).
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.HotelDateSelectionTypeInfo hotel_date_selection_type = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V5\Common\HotelDateSelectionTypeInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.HotelDateSelectionTypeInfo hotel_date_selection_type = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V5\Common\HotelDateSelectionTypeInfo $var
     * @return $this
     */
    public function setHotelDateSelectionType($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Common\HotelDateSelectionTypeInfo::class);
     ...
     * Immutable. Criterion for number of days prior to the stay the booking is being made.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.HotelAdvanceBookingWindowInfo hotel_advance_booking_window = 6 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V5\Common\HotelAdvanceBookingWindowInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.HotelAdvanceBookingWindowInfo hotel_advance_booking_window = 6 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V5\Common\HotelAdvanceBookingWindowInfo $var
     * @return $this
     */
    public function setHotelAdvanceBookingWindow($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Common\HotelAdvanceBookingWindowInfo::class);
     ...
     * Immutable. Criterion for length of hotel stay in nights.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.HotelLengthOfStayInfo hotel_length_of_stay = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V5\Common\HotelLengthOfStayInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.HotelLengthOfStayInfo hotel_length_of_stay = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V5\Common\HotelLengthOfStayInfo $var
     * @return $this
     */
    public function setHotelLengthOfStay($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Common\HotelLengthOfStayInfo::class);
     ...
     * Immutable. Criterion for day of the week the booking is for.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.HotelCheckInDayInfo hotel_check_in_day = 8 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V5\Common\HotelCheckInDayInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.HotelCheckInDayInfo hotel_check_in_day = 8 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V5\Common\HotelCheckInDayInfo $var
     * @return $this
     */
    public function setHotelCheckInDay($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Common\HotelCheckInDayInfo::class);
     ...
     * Immutable. A device criterion.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.DeviceInfo device = 11 [(.google.api.field_behavior) = IMMUTABLE];</code>
     ...
     * Immutable. A preferred content criterion.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.PreferredContentInfo preferred_content = 12 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V5\Common\PreferredContentInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.PreferredContentInfo preferred_content = 12 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V5\Common\PreferredContentInfo $var
     * @return $this
     */
    public function setPreferredContent($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Common\PreferredContentInfo::class);
