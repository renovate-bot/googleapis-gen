 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.GetFeedPlaceholderViewRequest</code>
 */
class GetFeedPlaceholderViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Services\FeedPlaceholderViewService::initOnce();
