 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.enums.KeywordPlanCompetitionLevelEnum</code>
 */
class KeywordPlanCompetitionLevelEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Enums\KeywordPlanCompetitionLevel::initOnce();
