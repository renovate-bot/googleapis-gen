 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.common.WebpageInfo</code>
 */
class WebpageInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * operations.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.common.WebpageConditionInfo conditions = 2;</code>
     */
    private $conditions;
     ...
     *           This field is required for CREATE operations and is prohibited on UPDATE
     *           operations.
     *     @type \Google\Ads\GoogleAds\V5\Common\WebpageConditionInfo[]|\Google\Protobuf\Internal\RepeatedField $conditions
     *           Conditions, or logical expressions, for webpage targeting. The list of
     *           webpage targeting conditions are and-ed together when evaluated
     *           for targeting.
     *           This field is required for CREATE operations and is prohibited on UPDATE
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.common.WebpageConditionInfo conditions = 2;</code>
     * @param \Google\Ads\GoogleAds\V5\Common\WebpageConditionInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setConditions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V5\Common\WebpageConditionInfo::class);
        $this->conditions = $arr;
