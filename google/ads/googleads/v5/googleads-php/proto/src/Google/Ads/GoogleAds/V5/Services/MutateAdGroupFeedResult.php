 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.MutateAdGroupFeedResult</code>
 */
class MutateAdGroupFeedResult extends \Google\Protobuf\Internal\Message
{
     ...
     * "MUTABLE_RESOURCE".
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.AdGroupFeed ad_group_feed = 2;</code>
     */
     ...
     *           Returned for successful operations.
     *     @type \Google\Ads\GoogleAds\V5\Resources\AdGroupFeed $ad_group_feed
     *           The mutated ad group feed with only mutable fields after mutate. The field
     *           will only be returned when response_content_type is set to
     *           "MUTABLE_RESOURCE".
     * }
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Services\AdGroupFeedService::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.AdGroupFeed ad_group_feed = 2;</code>
     * @return \Google\Ads\GoogleAds\V5\Resources\AdGroupFeed|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.resources.AdGroupFeed ad_group_feed = 2;</code>
     * @param \Google\Ads\GoogleAds\V5\Resources\AdGroupFeed $var
     * @return $this
     */
    public function setAdGroupFeed($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Resources\AdGroupFeed::class);
