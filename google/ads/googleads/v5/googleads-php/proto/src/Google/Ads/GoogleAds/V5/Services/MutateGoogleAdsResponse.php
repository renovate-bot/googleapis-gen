 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.MutateGoogleAdsResponse</code>
 */
class MutateGoogleAdsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.services.MutateOperationResponse mutate_operation_responses = 1;</code>
     */
     ...
     *           operations. If any errors occur outside the operations (e.g., auth errors),
     *           we return an RPC level error.
     *     @type \Google\Ads\GoogleAds\V5\Services\MutateOperationResponse[]|\Google\Protobuf\Internal\RepeatedField $mutate_operation_responses
     *           All responses for the mutate.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.services.MutateOperationResponse mutate_operation_responses = 1;</code>
     * @param \Google\Ads\GoogleAds\V5\Services\MutateOperationResponse[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMutateOperationResponses($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V5\Services\MutateOperationResponse::class);
