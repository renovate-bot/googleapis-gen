...
# source: google/ads/googleads/v5/resources/customer_feed.proto
 ...
 * A customer feed.
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.resources.CustomerFeed</code>
 */
class CustomerFeed extends \Google\Protobuf\Internal\Message
{
     ...
     * customer. Required.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.enums.PlaceholderTypeEnum.PlaceholderType placeholder_types = 3;</code>
     */
     ...
     * Required.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.MatchingFunction matching_function = 4;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.enums.FeedLinkStatusEnum.FeedLinkStatus status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
     ...
     *           Indicates which placeholder types the feed may populate under the connected
     *           customer. Required.
     *     @type \Google\Ads\GoogleAds\V5\Common\MatchingFunction $matching_function
     *           Matching function associated with the CustomerFeed.
     *           The matching function is used to filter the set of feed items selected.
     *           Required.
     *     @type int $status
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Resources\CustomerFeed::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V5\Enums\PlaceholderTypeEnum\PlaceholderType::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.MatchingFunction matching_function = 4;</code>
     * @return \Google\Ads\GoogleAds\V5\Common\MatchingFunction|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v5.common.MatchingFunction matching_function = 4;</code>
     * @param \Google\Ads\GoogleAds\V5\Common\MatchingFunction $var
     * @return $this
     */
    public function setMatchingFunction($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V5\Common\MatchingFunction::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V5\Enums\FeedLinkStatusEnum\FeedLinkStatus::class);
        $this->status = $var;
