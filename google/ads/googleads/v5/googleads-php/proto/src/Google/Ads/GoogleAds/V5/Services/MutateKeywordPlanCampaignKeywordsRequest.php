 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.MutateKeywordPlanCampaignKeywordsRequest</code>
 */
class MutateKeywordPlanCampaignKeywordsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * keywords.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.services.KeywordPlanCampaignKeywordOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose campaign keywords are being modified.
     *     @type \Google\Ads\GoogleAds\V5\Services\KeywordPlanCampaignKeywordOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual Keyword Plan campaign
     *           keywords.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v5.services.KeywordPlanCampaignKeywordOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V5\Services\KeywordPlanCampaignKeywordOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V5\Services\KeywordPlanCampaignKeywordOperation::class);
        $this->operations = $arr;
