 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v5.services.GetCampaignSharedSetRequest</code>
 */
class GetCampaignSharedSetRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V5\Services\CampaignSharedSetService::initOnce();
