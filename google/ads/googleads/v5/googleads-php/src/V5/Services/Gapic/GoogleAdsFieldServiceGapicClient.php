 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/google_ads_field_service.proto
...
use Google\Ads\GoogleAds\V5\Services\GetGoogleAdsFieldRequest;
use Google\Ads\GoogleAds\V5\Services\SearchGoogleAdsFieldsRequest;
use Google\Ads\GoogleAds\V5\Services\SearchGoogleAdsFieldsResponse;
 ...
 * try {
 *     $formattedResourceName = $googleAdsFieldServiceClient->googleAdsFieldName('[GOOGLE_ADS_FIELD]');
 *     $response = $googleAdsFieldServiceClient->getGoogleAdsField($formattedResourceName);
 * } finally {
...
class GoogleAdsFieldServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.GoogleAdsFieldService';
    ...
    private static function getGoogleAdsFieldNameTemplate()
    {
        ...
        return self::$googleAdsFieldNameTemplate;
    }
    ...
    {
        return self::getGoogleAdsFieldNameTemplate()->render([
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Resources\GoogleAdsField
     *
