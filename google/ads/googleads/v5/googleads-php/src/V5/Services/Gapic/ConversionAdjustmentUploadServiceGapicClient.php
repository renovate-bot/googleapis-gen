 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/conversion_adjustment_upload_service.proto
...
use Google\Ads\GoogleAds\V5\Services\UploadConversionAdjustmentsRequest;

use Google\Ads\GoogleAds\V5\Services\UploadConversionAdjustmentsResponse;
...
class ConversionAdjustmentUploadServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.ConversionAdjustmentUploadService';
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\UploadConversionAdjustmentsResponse
     *
    ...
    public function uploadConversionAdjustments($customerId, $conversionAdjustments, $partialFailure, array $optionalArgs = [])
    {
        ...
        return $this->startCall('UploadConversionAdjustments', UploadConversionAdjustmentsResponse::class, $optionalArgs, $request)->wait();
    }
}
