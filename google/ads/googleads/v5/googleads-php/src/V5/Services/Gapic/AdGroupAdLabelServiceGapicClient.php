 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/ad_group_ad_label_service.proto
 * and updates to that file get reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V5\Services\Gapic;

use Google\Ads\GoogleAds\V5\Resources\AdGroupAdLabel;
use Google\Ads\GoogleAds\V5\Services\AdGroupAdLabelOperation;
use Google\Ads\GoogleAds\V5\Services\GetAdGroupAdLabelRequest;

use Google\Ads\GoogleAds\V5\Services\MutateAdGroupAdLabelsRequest;
use Google\Ads\GoogleAds\V5\Services\MutateAdGroupAdLabelsResponse;
...
class AdGroupAdLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.AdGroupAdLabelService';
    ...
    public function getAdGroupAdLabel($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetAdGroupAdLabel', AdGroupAdLabel::class, $optionalArgs, $request)->wait();
    }
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\MutateAdGroupAdLabelsResponse
     *
     * @throws ApiException if the remote call fails
     */
    public function mutateAdGroupAdLabels($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateAdGroupAdLabels', MutateAdGroupAdLabelsResponse::class, $optionalArgs, $request)->wait();
    }
}
