...
use Google\Ads\GoogleAds\V5\Services\GetAssetRequest;
use Google\Ads\GoogleAds\V5\Services\MutateAssetsRequest;
use Google\Ads\GoogleAds\V5\Services\MutateAssetsResponse;
...
class AssetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.AssetService';
