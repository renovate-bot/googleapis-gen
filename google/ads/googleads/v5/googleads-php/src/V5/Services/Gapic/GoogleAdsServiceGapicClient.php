 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/google_ads_service.proto
...
use Google\Ads\GoogleAds\V5\Enums\SummaryRowSettingEnum\SummaryRowSetting;
use Google\Ads\GoogleAds\V5\Services\MutateGoogleAdsRequest;
use Google\Ads\GoogleAds\V5\Services\MutateGoogleAdsResponse;
...
use Google\Ads\GoogleAds\V5\Services\SearchGoogleAdsStreamRequest;
use Google\Ads\GoogleAds\V5\Services\SearchGoogleAdsStreamResponse;
...
class GoogleAdsServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.GoogleAdsService';
     ...
     *          For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V5\Enums\SummaryRowSettingEnum\SummaryRowSetting}
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\MutateGoogleAdsResponse
     *
     * @throws ApiException if the remote call fails
     * @experimental
     */
