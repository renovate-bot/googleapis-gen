 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/conversion_action_service.proto
...
use Google\Ads\GoogleAds\V5\Services\GetConversionActionRequest;
use Google\Ads\GoogleAds\V5\Services\MutateConversionActionsRequest;
use Google\Ads\GoogleAds\V5\Services\MutateConversionActionsResponse;
 ...
 * try {
 *     $formattedResourceName = $conversionActionServiceClient->conversionActionName('[CUSTOMER]', '[CONVERSION_ACTION]');
...
class ConversionActionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.ConversionActionService';
     ...
     * @experimental
     */
    public static function conversionActionName($customer, $conversionAction)
    {
     ...
     * Template: Pattern
     * - conversionAction: customers/{customer}/conversionActions/{conversion_action}.
     *
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\MutateConversionActionsResponse
     *
     * @throws ApiException if the remote call fails
     * @experimental
     */
    public function mutateConversionActions($customerId, $operations, array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            ...
            MutateConversionActionsResponse::class,
            $optionalArgs,
            $request
        )->wait();
    }
