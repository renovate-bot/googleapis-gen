 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/shopping_performance_view_service.proto
 * and updates to that file get reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V5\Services\Gapic;

use Google\Ads\GoogleAds\V5\Resources\ShoppingPerformanceView;
use Google\Ads\GoogleAds\V5\Services\GetShoppingPerformanceViewRequest;
 ...
 */
class ShoppingPerformanceViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.ShoppingPerformanceViewService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/shopping_performance_view_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/shopping_performance_view_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/shopping_performance_view_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/shopping_performance_view_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * ```
     *
     * @param string $resourceName Required. The resource name of the Shopping performance view to fetch.
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Resources\ShoppingPerformanceView
     *
     * @throws ApiException if the remote call fails
     */
    public function getShoppingPerformanceView($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetShoppingPerformanceView', ShoppingPerformanceView::class, $optionalArgs, $request)->wait();
    }
}
