 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/keyword_plan_idea_service.proto
...
use Google\Ads\GoogleAds\V5\Services\GenerateKeywordIdeasRequest;
use Google\Ads\GoogleAds\V5\Services\KeywordAndUrlSeed;
use Google\Ads\GoogleAds\V5\Services\KeywordSeed;
use Google\Ads\GoogleAds\V5\Services\SiteSeed;
 ...
 *     $pagedResponse = $keywordPlanIdeaServiceClient->generateKeywordIdeas($language);
...
class KeywordPlanIdeaServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.KeywordPlanIdeaService';
     ...
     *          Targeting network.
     *          For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V5\Enums\KeywordPlanNetworkEnum\KeywordPlanNetwork}
