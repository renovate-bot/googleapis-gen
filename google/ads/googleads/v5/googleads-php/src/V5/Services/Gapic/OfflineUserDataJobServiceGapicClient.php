 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/offline_user_data_job_service.proto
...
use Google\Ads\GoogleAds\V5\Services\AddOfflineUserDataJobOperationsRequest;
use Google\Ads\GoogleAds\V5\Services\AddOfflineUserDataJobOperationsResponse;

use Google\Ads\GoogleAds\V5\Services\CreateOfflineUserDataJobRequest;

use Google\Ads\GoogleAds\V5\Services\CreateOfflineUserDataJobResponse;
use Google\Ads\GoogleAds\V5\Services\GetOfflineUserDataJobRequest;
use Google\Ads\GoogleAds\V5\Services\OfflineUserDataJobOperation;
use Google\Ads\GoogleAds\V5\Services\RunOfflineUserDataJobRequest;
...
class OfflineUserDataJobServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.OfflineUserDataJobService';
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\AddOfflineUserDataJobOperationsResponse
     *
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\CreateOfflineUserDataJobResponse
     *
     * @throws ApiException if the remote call fails
     */
