 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/hotel_performance_view_service.proto
...
use Google\Ads\GoogleAds\V5\Services\GetHotelPerformanceViewRequest;
...
class HotelPerformanceViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.HotelPerformanceViewService';
     ...
     * a hotel_performance_view resource.
     *
     ...
     * @experimental
     */
    public static function hotelPerformanceViewName($customer)
    {
