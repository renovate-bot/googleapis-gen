...
use Google\Ads\GoogleAds\V5\Services\ListInvoicesRequest;
use Google\Ads\GoogleAds\V5\Services\ListInvoicesResponse;
...
class InvoiceServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.InvoiceService';
     ...
     *                             For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V5\Enums\MonthOfYearEnum\MonthOfYear}
