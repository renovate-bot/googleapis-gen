 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/campaign_draft_service.proto
...
use Google\Ads\GoogleAds\V5\Services\GetCampaignDraftRequest;
use Google\Ads\GoogleAds\V5\Services\ListCampaignDraftAsyncErrorsRequest;
use Google\Ads\GoogleAds\V5\Services\ListCampaignDraftAsyncErrorsResponse;
use Google\Ads\GoogleAds\V5\Services\MutateCampaignDraftsRequest;
use Google\Ads\GoogleAds\V5\Services\MutateCampaignDraftsResponse;
use Google\Ads\GoogleAds\V5\Services\PromoteCampaignDraftRequest;
...
class CampaignDraftServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.CampaignDraftService';
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Resources\CampaignDraft
     *
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\MutateCampaignDraftsResponse
     *
     * @throws ApiException if the remote call fails
     * @experimental
     */
