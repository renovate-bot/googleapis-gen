 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/customer_service.proto
...
use Google\Ads\GoogleAds\V5\Enums\AccessRoleEnum\AccessRole;
...
use Google\Ads\GoogleAds\V5\Services\CreateCustomerClientRequest;
use Google\Ads\GoogleAds\V5\Services\CreateCustomerClientResponse;
use Google\Ads\GoogleAds\V5\Services\CustomerOperation;
use Google\Ads\GoogleAds\V5\Services\GetCustomerRequest;
use Google\Ads\GoogleAds\V5\Services\ListAccessibleCustomersRequest;
use Google\Ads\GoogleAds\V5\Services\ListAccessibleCustomersResponse;
use Google\Ads\GoogleAds\V5\Services\MutateCustomerRequest;
use Google\Ads\GoogleAds\V5\Services\MutateCustomerResponse;
...
class CustomerServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.CustomerService';
     ...
     *          For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V5\Enums\AccessRoleEnum\AccessRole}
     *     @type RetrySettings|array $retrySettings
     *          Retry settings to use for this call. Can be a
     *          {@see Google\ApiCore\RetrySettings} object, or an associative array
     *          of retry settings parameters. See the documentation on
