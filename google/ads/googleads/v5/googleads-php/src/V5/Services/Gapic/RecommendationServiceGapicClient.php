 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/recommendation_service.proto
...
use Google\Ads\GoogleAds\V5\Services\ApplyRecommendationRequest;

use Google\Ads\GoogleAds\V5\Services\ApplyRecommendationResponse;
use Google\Ads\GoogleAds\V5\Services\DismissRecommendationRequest;
use Google\Ads\GoogleAds\V5\Services\DismissRecommendationRequest\DismissRecommendationOperation;
use Google\Ads\GoogleAds\V5\Services\DismissRecommendationResponse;
use Google\Ads\GoogleAds\V5\Services\GetRecommendationRequest;
 ...
 */
class RecommendationServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.RecommendationService';
     ...
     */
    public static function recommendationName($customer, $recommendation)
    {
     ...
     * Template: Pattern
     * - recommendation: customers/{customer}/recommendations/{recommendation}
     *
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\ApplyRecommendationResponse
     *
    ...
    public function applyRecommendation($customerId, $operations, array $optionalArgs = [])
    {
        ...
        return $this->startCall('ApplyRecommendation', ApplyRecommendationResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\DismissRecommendationResponse
     *
     * @throws ApiException if the remote call fails
     */
    public function dismissRecommendation($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DismissRecommendation', DismissRecommendationResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * $recommendationServiceClient = new RecommendationServiceClient();
     * try {
     *     $formattedResourceName = $recommendationServiceClient->recommendationName('[CUSTOMER]', '[RECOMMENDATION]');
     *     $response = $recommendationServiceClient->getRecommendation($formattedResourceName);
     * } finally {
     *     $recommendationServiceClient->close();
     * }
     * ```
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Resources\Recommendation
     *
     * @throws ApiException if the remote call fails
     */
    public function getRecommendation($resourceName, array $optionalArgs = [])
    {
