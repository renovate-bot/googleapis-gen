 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/billing_setup_service.proto
...
use Google\Ads\GoogleAds\V5\Services\GetBillingSetupRequest;

use Google\Ads\GoogleAds\V5\Services\MutateBillingSetupRequest;
 ...
 * try {
 *     $formattedResourceName = $billingSetupServiceClient->billingSetupName('[CUSTOMER]', '[BILLING_SETUP]');
 *     $response = $billingSetupServiceClient->getBillingSetup($formattedResourceName);
 * } finally {
...
class BillingSetupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.BillingSetupService';
     ...
     */
    public static function billingSetupName($customer, $billingSetup)
    {
     ...
     * Template: Pattern
     * - billingSetup: customers/{customer}/billingSetups/{billing_setup}
     *
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Resources\BillingSetup
     *
     * @throws ApiException if the remote call fails
     */
    public function getBillingSetup($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetBillingSetup', BillingSetup::class, $optionalArgs, $request)->wait();
    }
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\MutateBillingSetupResponse
     *
     * @throws ApiException if the remote call fails
     */
