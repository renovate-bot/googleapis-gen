 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/feed_mapping_service.proto
...
use Google\Ads\GoogleAds\V5\Services\GetFeedMappingRequest;
use Google\Ads\GoogleAds\V5\Services\MutateFeedMappingsRequest;
use Google\Ads\GoogleAds\V5\Services\MutateFeedMappingsResponse;
 ...
 * try {
 *     $formattedResourceName = $feedMappingServiceClient->feedMappingName('[CUSTOMER]', '[FEED_MAPPING]');
...
class FeedMappingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.FeedMappingService';
    ...
    {
        if (null == self::$feedMappingNameTemplate) {
            self::$feedMappingNameTemplate = new PathTemplate('customers/{customer}/feedMappings/{feed_mapping}');
        }
     ...
     * a feed_mapping resource.
     *
     * @param string $customer
     * @param string $feedMapping
     *
     * @return string The formatted feed_mapping resource.
     * @experimental
     */
    public static function feedMappingName($customer, $feedMapping)
    {
     ...
     * Template: Pattern
     * - feedMapping: customers/{customer}/feedMappings/{feed_mapping}.
     *
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Resources\FeedMapping
     *
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\MutateFeedMappingsResponse
     *
     * @throws ApiException if the remote call fails
     * @experimental
     */
    public function mutateFeedMappings($customerId, $operations, array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            'MutateFeedMappings',
            MutateFeedMappingsResponse::class,
            $optionalArgs,
            $request
        )->wait();
    }
