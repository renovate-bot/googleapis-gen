...
class AdGroupFeedServiceGapicClient
{
    ...
    public function getAdGroupFeed($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetAdGroupFeed', AdGroupFeed::class, $optionalArgs, $request)->wait();
    }
    ...
    public function mutateAdGroupFeeds($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateAdGroupFeeds', MutateAdGroupFeedsResponse::class, $optionalArgs, $request)->wait();
    }
}
