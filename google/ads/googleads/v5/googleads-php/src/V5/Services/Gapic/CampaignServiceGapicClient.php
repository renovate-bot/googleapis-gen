 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/campaign_service.proto
...
use Google\Ads\GoogleAds\V5\Services\GetCampaignRequest;
use Google\Ads\GoogleAds\V5\Services\MutateCampaignsRequest;
 ...
 * try {
 *     $formattedResourceName = $campaignServiceClient->campaignName('[CUSTOMER]', '[CAMPAIGN]');
...
class CampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.CampaignService';
