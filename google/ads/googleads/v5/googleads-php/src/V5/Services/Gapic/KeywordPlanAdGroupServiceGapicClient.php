 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v5/services/keyword_plan_ad_group_service.proto
...
use Google\Ads\GoogleAds\V5\Services\GetKeywordPlanAdGroupRequest;
use Google\Ads\GoogleAds\V5\Services\KeywordPlanAdGroupOperation;
use Google\Ads\GoogleAds\V5\Services\MutateKeywordPlanAdGroupsRequest;
use Google\Ads\GoogleAds\V5\Services\MutateKeywordPlanAdGroupsResponse;
 ...
 * try {
 *     $formattedResourceName = $keywordPlanAdGroupServiceClient->keywordPlanAdGroupName('[CUSTOMER]', '[KEYWORD_PLAN_AD_GROUP]');
...
class KeywordPlanAdGroupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v5.services.KeywordPlanAdGroupService';
     ...
     * a keyword_plan_ad_group resource.
     *
     ...
     * @experimental
     */
    public static function keywordPlanAdGroupName($customer, $keywordPlanAdGroup)
    {
     ...
     * Template: Pattern
     * - keywordPlanAdGroup: customers/{customer}/keywordPlanAdGroups/{keyword_plan_ad_group}.
     *
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Resources\KeywordPlanAdGroup
     *
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V5\Services\MutateKeywordPlanAdGroupsResponse
     *
     * @throws ApiException if the remote call fails
     * @experimental
     */
    public function mutateKeywordPlanAdGroups($customerId, $operations, array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            ...
            MutateKeywordPlanAdGroupsResponse::class,
            $optionalArgs,
            $request
        )->wait();
    }
