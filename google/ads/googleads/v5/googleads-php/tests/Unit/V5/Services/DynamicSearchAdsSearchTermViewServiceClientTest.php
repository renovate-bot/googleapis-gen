...
use Google\Ads\GoogleAds\V5\Services\DynamicSearchAdsSearchTermViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\DynamicSearchAdsSearchTermView;
...
class DynamicSearchAdsSearchTermViewServiceClientTest extends GeneratedTest
{
    ...
    public function getDynamicSearchAdsSearchTermViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.DynamicSearchAdsSearchTermViewService/GetDynamicSearchAdsSearchTermView', $actualFuncCall);
