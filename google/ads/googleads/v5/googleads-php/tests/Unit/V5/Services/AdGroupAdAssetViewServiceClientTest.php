...
use Google\Ads\GoogleAds\V5\Services\AdGroupAdAssetViewServiceClient;
...
class AdGroupAdAssetViewServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupAdAssetViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AdGroupAdAssetViewService/GetAdGroupAdAssetView', $actualFuncCall);
