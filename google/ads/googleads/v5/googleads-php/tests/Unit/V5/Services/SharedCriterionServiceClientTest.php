...
use Google\Ads\GoogleAds\V5\Services\SharedCriterionServiceClient;
use Google\Ads\GoogleAds\V5\Resources\SharedCriterion;
use Google\Ads\GoogleAds\V5\Services\MutateSharedCriteriaResponse;
...
class SharedCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getSharedCriterionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.SharedCriterionService/GetSharedCriterion', $actualFuncCall);
    ...
    public function mutateSharedCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.SharedCriterionService/MutateSharedCriteria', $actualFuncCall);
