...
use Google\Ads\Googleads\V5\Services\TopicConstantServiceClient;
use Google\Ads\GoogleAds\V5\Resources\TopicConstant;
...
class TopicConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getTopicConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.TopicConstantService/GetTopicConstant', $actualFuncCall);
