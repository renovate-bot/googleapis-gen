...
use Google\Ads\GoogleAds\V5\Services\AdParameterServiceClient;
...
class AdParameterServiceClientTest extends GeneratedTest
{
    ...
    public function getAdParameterTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AdParameterService/GetAdParameter', $actualFuncCall);
    ...
    public function mutateAdParametersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.AdParameterService/MutateAdParameters', $actualFuncCall);
