...
use Google\Ads\GoogleAds\V5\Services\GroupPlacementViewServiceClient;
...
class GroupPlacementViewServiceClientTest extends GeneratedTest
{
    ...
    public function getGroupPlacementViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.GroupPlacementViewService/GetGroupPlacementView', $actualFuncCall);
