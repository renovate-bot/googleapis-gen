...
use Google\Ads\Googleads\V5\Services\CampaignExtensionSettingServiceClient;
...
class CampaignExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignExtensionSettingTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CampaignExtensionSettingService/GetCampaignExtensionSetting', $actualFuncCall);
    ...
    public function mutateCampaignExtensionSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CampaignExtensionSettingService/MutateCampaignExtensionSettings', $actualFuncCall);
