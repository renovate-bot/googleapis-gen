...
class AdGroupServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AdGroupService/GetAdGroup', $actualFuncCall);
    ...
    public function mutateAdGroupsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.AdGroupService/MutateAdGroups', $actualFuncCall);
