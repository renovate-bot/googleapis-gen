...
use Google\Ads\GoogleAds\V5\Services\CustomerLabelServiceClient;
use Google\Ads\GoogleAds\V5\Resources\CustomerLabel;
use Google\Ads\GoogleAds\V5\Services\MutateCustomerLabelsResponse;
...
class CustomerLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CustomerLabelService/GetCustomerLabel', $actualFuncCall);
    ...
    public function mutateCustomerLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CustomerLabelService/MutateCustomerLabels', $actualFuncCall);
