...
use Google\Ads\Googleads\V5\Services\LocationViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\LocationView;
...
class LocationViewServiceClientTest extends GeneratedTest
{
    ...
    public function getLocationViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.LocationViewService/GetLocationView', $actualFuncCall);
