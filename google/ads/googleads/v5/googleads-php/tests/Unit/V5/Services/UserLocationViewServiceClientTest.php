...
use Google\Ads\Googleads\V5\Services\UserLocationViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\UserLocationView;
...
class UserLocationViewServiceClientTest extends GeneratedTest
{
    ...
    public function getUserLocationViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.UserLocationViewService/GetUserLocationView', $actualFuncCall);
