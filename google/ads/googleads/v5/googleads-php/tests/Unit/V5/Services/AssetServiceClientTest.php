...
use Google\Ads\Googleads\V5\Services\AssetServiceClient;
...
class AssetServiceClientTest extends GeneratedTest
{
    ...
    public function getAssetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AssetService/GetAsset', $actualFuncCall);
    ...
    public function mutateAssetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.AssetService/MutateAssets', $actualFuncCall);
