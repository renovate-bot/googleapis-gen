...
use Google\Ads\Googleads\V5\Services\VideoServiceClient;
use Google\Ads\GoogleAds\V5\Resources\Video;
...
class VideoServiceClientTest extends GeneratedTest
{
    ...
    public function getVideoTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.VideoService/GetVideo', $actualFuncCall);
