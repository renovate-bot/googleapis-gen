...
use Google\Ads\GoogleAds\V5\Services\CustomerManagerLinkServiceClient;
use Google\Ads\GoogleAds\V5\Resources\CustomerManagerLink;
use Google\Ads\GoogleAds\V5\Services\MoveManagerLinkResponse;
use Google\Ads\GoogleAds\V5\Services\MutateCustomerManagerLinkResponse;
...
class CustomerManagerLinkServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerManagerLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CustomerManagerLinkService/GetCustomerManagerLink', $actualFuncCall);
    ...
    public function mutateCustomerManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CustomerManagerLinkService/MutateCustomerManagerLink', $actualFuncCall);
    ...
    public function moveManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CustomerManagerLinkService/MoveManagerLink', $actualFuncCall);
