...
use Google\Ads\GoogleAds\V5\Services\CustomerFeedServiceClient;
...
class CustomerFeedServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerFeedTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CustomerFeedService/GetCustomerFeed', $actualFuncCall);
    ...
    public function mutateCustomerFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CustomerFeedService/MutateCustomerFeeds', $actualFuncCall);
