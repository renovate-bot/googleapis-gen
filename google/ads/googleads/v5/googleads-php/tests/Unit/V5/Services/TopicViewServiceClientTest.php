...
use Google\Ads\GoogleAds\V5\Services\TopicViewServiceClient;
...
class TopicViewServiceClientTest extends GeneratedTest
{
    ...
    public function getTopicViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.TopicViewService/GetTopicView', $actualFuncCall);
