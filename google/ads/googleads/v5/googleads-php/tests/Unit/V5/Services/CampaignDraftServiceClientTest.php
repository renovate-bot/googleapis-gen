...
use Google\Ads\GoogleAds\V5\Services\CampaignDraftServiceClient;
...
class CampaignDraftServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CampaignDraftService/GetCampaignDraft', $actualFuncCall);
    ...
    public function listCampaignDraftAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CampaignDraftService/ListCampaignDraftAsyncErrors', $actualFuncCall);
        $actualValue = $actualRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateCampaignDraftsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CampaignDraftService/MutateCampaignDrafts', $actualFuncCall);
    ...
    public function promoteCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CampaignDraftService/PromoteCampaignDraft', $actualApiFuncCall);
