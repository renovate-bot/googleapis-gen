...
use Google\Ads\GoogleAds\V5\Services\CustomerClientLinkServiceClient;
use Google\Ads\GoogleAds\V5\Resources\CustomerClientLink;
use Google\Ads\GoogleAds\V5\Services\CustomerClientLinkOperation;

use Google\Ads\GoogleAds\V5\Services\MutateCustomerClientLinkResponse;
...
class CustomerClientLinkServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerClientLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CustomerClientLinkService/GetCustomerClientLink', $actualFuncCall);
    ...
    public function mutateCustomerClientLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CustomerClientLinkService/MutateCustomerClientLink', $actualFuncCall);
