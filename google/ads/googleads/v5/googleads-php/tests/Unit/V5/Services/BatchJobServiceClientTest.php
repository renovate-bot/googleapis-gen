...
use Google\Ads\GoogleAds\V5\Services\AddBatchJobOperationsResponse;
use Google\Ads\GoogleAds\V5\Services\BatchJobOperation;
use Google\Ads\GoogleAds\V5\Services\BatchJobResult;
use Google\Ads\GoogleAds\V5\Services\ListBatchJobResultsResponse;
use Google\Ads\GoogleAds\V5\Services\MutateBatchJobResponse;
...
class BatchJobServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBatchJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.BatchJobService/MutateBatchJob', $actualFuncCall);
    ...
    public function getBatchJobTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->batchJobName('[CUSTOMER]', '[BATCH_JOB]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.BatchJobService/GetBatchJob', $actualFuncCall);
    ...
    public function listBatchJobResultsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.BatchJobService/ListBatchJobResults', $actualFuncCall);
    ...
    public function runBatchJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.BatchJobService/RunBatchJob', $actualApiFuncCall);
    ...
    public function addBatchJobOperationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.BatchJobService/AddBatchJobOperations', $actualFuncCall);
