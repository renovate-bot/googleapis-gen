...
class CustomerServiceClientTest extends GeneratedTest
{
    ...
    public function createCustomerClientTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CustomerService/CreateCustomerClient', $actualFuncCall);
    ...
    public function getCustomerTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CustomerService/GetCustomer', $actualFuncCall);
    ...
    public function listAccessibleCustomersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CustomerService/ListAccessibleCustomers', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateCustomerTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CustomerService/MutateCustomer', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
