...
use Google\Ads\GoogleAds\V5\Services\BiddingStrategyServiceClient;
use Google\Ads\GoogleAds\V5\Resources\BiddingStrategy;
use Google\Ads\GoogleAds\V5\Services\MutateBiddingStrategiesResponse;
...
class BiddingStrategyServiceClientTest extends GeneratedTest
{
    ...
    public function getBiddingStrategyTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.BiddingStrategyService/GetBiddingStrategy', $actualFuncCall);
    ...
    public function mutateBiddingStrategiesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.BiddingStrategyService/MutateBiddingStrategies', $actualFuncCall);
