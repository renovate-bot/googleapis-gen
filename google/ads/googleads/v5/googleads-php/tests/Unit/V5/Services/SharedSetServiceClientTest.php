...
use Google\Ads\GoogleAds\V5\Services\SharedSetServiceClient;
...
class SharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function getSharedSetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.SharedSetService/GetSharedSet', $actualFuncCall);
    ...
    public function mutateSharedSetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.SharedSetService/MutateSharedSets', $actualFuncCall);
