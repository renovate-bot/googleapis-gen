...
use Google\Ads\Googleads\V5\Services\GoogleAdsFieldServiceClient;
...
class GoogleAdsFieldServiceClientTest extends GeneratedTest
{
    ...
    public function getGoogleAdsFieldTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.GoogleAdsFieldService/GetGoogleAdsField', $actualFuncCall);
    ...
    public function searchGoogleAdsFieldsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.GoogleAdsFieldService/SearchGoogleAdsFields', $actualFuncCall);
