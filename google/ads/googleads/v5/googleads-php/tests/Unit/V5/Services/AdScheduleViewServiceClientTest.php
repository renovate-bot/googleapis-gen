...
use Google\Ads\GoogleAds\V5\Services\AdScheduleViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\AdScheduleView;
...
class AdScheduleViewServiceClientTest extends GeneratedTest
{
    ...
    public function getAdScheduleViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AdScheduleViewService/GetAdScheduleView', $actualFuncCall);
