...
use Google\Ads\Googleads\V5\Services\CampaignSharedSetServiceClient;
...
class CampaignSharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignSharedSetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CampaignSharedSetService/GetCampaignSharedSet', $actualFuncCall);
    ...
    public function mutateCampaignSharedSetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CampaignSharedSetService/MutateCampaignSharedSets', $actualFuncCall);
