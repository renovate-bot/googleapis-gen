...
use Google\Ads\GoogleAds\V5\Services\HotelPerformanceViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\HotelPerformanceView;
...
class HotelPerformanceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getHotelPerformanceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.HotelPerformanceViewService/GetHotelPerformanceView', $actualFuncCall);
