...
use Google\Ads\GoogleAds\V5\Services\GeographicViewServiceClient;
...
class GeographicViewServiceClientTest extends GeneratedTest
{
    ...
    public function getGeographicViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.GeographicViewService/GetGeographicView', $actualFuncCall);
