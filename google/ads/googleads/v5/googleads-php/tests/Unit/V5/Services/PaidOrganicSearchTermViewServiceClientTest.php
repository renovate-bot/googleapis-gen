...
use Google\Ads\GoogleAds\V5\Services\PaidOrganicSearchTermViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\PaidOrganicSearchTermView;
...
class PaidOrganicSearchTermViewServiceClientTest extends GeneratedTest
{
    ...
    public function getPaidOrganicSearchTermViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.PaidOrganicSearchTermViewService/GetPaidOrganicSearchTermView', $actualFuncCall);
