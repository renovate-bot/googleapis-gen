...
use Google\Ads\GoogleAds\V5\Services\LanguageConstantServiceClient;
 ...
 * @group gapic
 */
class LanguageConstantServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getLanguageConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.LanguageConstantService/GetLanguageConstant', $actualFuncCall);
