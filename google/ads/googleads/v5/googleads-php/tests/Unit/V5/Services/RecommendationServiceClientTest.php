...
use Google\Ads\Googleads\V5\Services\RecommendationServiceClient;
...
class RecommendationServiceClientTest extends GeneratedTest
{
    ...
    public function getRecommendationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.RecommendationService/GetRecommendation', $actualFuncCall);
    ...
    public function applyRecommendationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.RecommendationService/ApplyRecommendation', $actualFuncCall);
    ...
    public function dismissRecommendationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.RecommendationService/DismissRecommendation', $actualFuncCall);
