...
use Google\Ads\GoogleAds\V5\Services\ExtensionFeedItemServiceClient;
use Google\Ads\GoogleAds\V5\Resources\ExtensionFeedItem;
use Google\Ads\GoogleAds\V5\Services\MutateExtensionFeedItemsResponse;
...
class ExtensionFeedItemServiceClientTest extends GeneratedTest
{
    ...
    public function getExtensionFeedItemTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.ExtensionFeedItemService/GetExtensionFeedItem', $actualFuncCall);
    ...
    public function mutateExtensionFeedItemsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.ExtensionFeedItemService/MutateExtensionFeedItems', $actualFuncCall);
