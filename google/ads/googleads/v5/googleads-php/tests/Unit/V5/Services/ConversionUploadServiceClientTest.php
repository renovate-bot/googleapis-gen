...
use Google\Ads\GoogleAds\V5\Services\ConversionUploadServiceClient;
use Google\Ads\GoogleAds\V5\Services\UploadCallConversionsResponse;
...
class ConversionUploadServiceClientTest extends GeneratedTest
{
    ...
    public function uploadCallConversionsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.ConversionUploadService/UploadCallConversions', $actualFuncCall);
    ...
    public function uploadClickConversionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.ConversionUploadService/UploadClickConversions', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getConversions();
        $this->assertProtobufEquals($conversions, $actualValue);
