...
use Google\Ads\Googleads\V5\Services\OperatingSystemVersionConstantServiceClient;
...
class OperatingSystemVersionConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getOperatingSystemVersionConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.OperatingSystemVersionConstantService/GetOperatingSystemVersionConstant', $actualFuncCall);
