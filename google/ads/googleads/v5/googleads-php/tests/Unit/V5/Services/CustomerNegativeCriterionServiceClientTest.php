...
use Google\Ads\GoogleAds\V5\Services\CustomerNegativeCriterionServiceClient;
use Google\Ads\GoogleAds\V5\Resources\CustomerNegativeCriterion;
use Google\Ads\GoogleAds\V5\Services\MutateCustomerNegativeCriteriaResponse;
...
class CustomerNegativeCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerNegativeCriterionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CustomerNegativeCriterionService/GetCustomerNegativeCriterion', $actualFuncCall);
    ...
    public function mutateCustomerNegativeCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria', $actualFuncCall);
