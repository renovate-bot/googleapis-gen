...
use Google\Ads\GoogleAds\V5\Services\DistanceViewServiceClient;
...
class DistanceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getDistanceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.DistanceViewService/GetDistanceView', $actualFuncCall);
