...
use Google\Ads\Googleads\V5\Services\CampaignLabelServiceClient;
...
class CampaignLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CampaignLabelService/GetCampaignLabel', $actualFuncCall);
    ...
    public function mutateCampaignLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CampaignLabelService/MutateCampaignLabels', $actualFuncCall);
