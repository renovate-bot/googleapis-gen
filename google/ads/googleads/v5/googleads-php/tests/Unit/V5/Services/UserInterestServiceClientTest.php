...
use Google\Ads\GoogleAds\V5\Services\UserInterestServiceClient;
...
class UserInterestServiceClientTest extends GeneratedTest
{
    ...
    public function getUserInterestTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.UserInterestService/GetUserInterest', $actualFuncCall);
