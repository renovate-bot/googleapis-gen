...
use Google\Ads\GoogleAds\V5\Services\UserListServiceClient;
use Google\Ads\GoogleAds\V5\Resources\UserList;
use Google\Ads\GoogleAds\V5\Services\MutateUserListsResponse;
...
class UserListServiceClientTest extends GeneratedTest
{
    ...
    public function getUserListTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.UserListService/GetUserList', $actualFuncCall);
    ...
    public function mutateUserListsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.UserListService/MutateUserLists', $actualFuncCall);
