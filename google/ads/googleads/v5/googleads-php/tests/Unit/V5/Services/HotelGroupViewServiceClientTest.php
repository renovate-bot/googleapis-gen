...
use Google\Ads\GoogleAds\V5\Services\HotelGroupViewServiceClient;
...
class HotelGroupViewServiceClientTest extends GeneratedTest
{
    ...
    public function getHotelGroupViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.HotelGroupViewService/GetHotelGroupView', $actualFuncCall);
