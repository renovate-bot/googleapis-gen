...
use Google\Ads\GoogleAds\V5\Services\AdGroupCriterionSimulationServiceClient;
use Google\Ads\GoogleAds\V5\Resources\AdGroupCriterionSimulation;
...
class AdGroupCriterionSimulationServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupCriterionSimulationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AdGroupCriterionSimulationService/GetAdGroupCriterionSimulation', $actualFuncCall);
