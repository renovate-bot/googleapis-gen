...
use Google\Ads\GoogleAds\V5\Services\GeoTargetConstantServiceClient;
...
class GeoTargetConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getGeoTargetConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.GeoTargetConstantService/GetGeoTargetConstant', $actualFuncCall);
    ...
    public function suggestGeoTargetConstantsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.GeoTargetConstantService/SuggestGeoTargetConstants', $actualFuncCall);
