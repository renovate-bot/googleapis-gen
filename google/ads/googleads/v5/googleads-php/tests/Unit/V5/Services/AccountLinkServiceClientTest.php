...
use Google\Ads\GoogleAds\V5\Services\AccountLinkServiceClient;
use Google\Ads\GoogleAds\V5\Resources\AccountLink;
use Google\Ads\GoogleAds\V5\Services\AccountLinkOperation;

use Google\Ads\GoogleAds\V5\Services\CreateAccountLinkResponse;
use Google\Ads\GoogleAds\V5\Services\MutateAccountLinkResponse;
...
class AccountLinkServiceClientTest extends GeneratedTest
{
    ...
    public function createAccountLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AccountLinkService/CreateAccountLink', $actualFuncCall);
    ...
    public function getAccountLinkTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->accountLinkName('[CUSTOMER]', '[ACCOUNT_LINK]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.AccountLinkService/GetAccountLink', $actualFuncCall);
    ...
    public function mutateAccountLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.AccountLinkService/MutateAccountLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
