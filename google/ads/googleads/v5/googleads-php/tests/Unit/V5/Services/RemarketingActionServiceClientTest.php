...
use Google\Ads\Googleads\V5\Services\RemarketingActionServiceClient;
use Google\Ads\GoogleAds\V5\Resources\RemarketingAction;
use Google\Ads\GoogleAds\V5\Services\MutateRemarketingActionsResponse;
...
class RemarketingActionServiceClientTest extends GeneratedTest
{
    ...
    public function getRemarketingActionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.RemarketingActionService/GetRemarketingAction', $actualFuncCall);
    ...
    public function mutateRemarketingActionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.RemarketingActionService/MutateRemarketingActions', $actualFuncCall);
