...
use Google\Ads\GoogleAds\V5\Services\ExpandedLandingPageViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\ExpandedLandingPageView;
...
class ExpandedLandingPageViewServiceClientTest extends GeneratedTest
{
    ...
    public function getExpandedLandingPageViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.ExpandedLandingPageViewService/GetExpandedLandingPageView', $actualFuncCall);
