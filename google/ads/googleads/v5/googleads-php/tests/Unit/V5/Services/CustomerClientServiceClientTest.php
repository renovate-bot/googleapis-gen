...
use Google\Ads\GoogleAds\V5\Services\CustomerClientServiceClient;
...
class CustomerClientServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerClientTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CustomerClientService/GetCustomerClient', $actualFuncCall);
