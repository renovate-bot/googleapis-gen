...
use Google\Ads\GoogleAds\V5\Services\ProductBiddingCategoryConstantServiceClient;
...
class ProductBiddingCategoryConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getProductBiddingCategoryConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.ProductBiddingCategoryConstantService/GetProductBiddingCategoryConstant', $actualFuncCall);
