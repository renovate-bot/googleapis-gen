...
class KeywordPlanCampaignServiceClientTest extends GeneratedTest
{
    ...
    public function getKeywordPlanCampaignTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.KeywordPlanCampaignService/GetKeywordPlanCampaign', $actualFuncCall);
    ...
    public function mutateKeywordPlanCampaignsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.KeywordPlanCampaignService/MutateKeywordPlanCampaigns', $actualFuncCall);
