...
use Google\Ads\Googleads\V5\Services\AdGroupAdLabelServiceClient;
...
class AdGroupAdLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupAdLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AdGroupAdLabelService/GetAdGroupAdLabel', $actualFuncCall);
    ...
    public function mutateAdGroupAdLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.AdGroupAdLabelService/MutateAdGroupAdLabels', $actualFuncCall);
