...
use Google\Ads\GoogleAds\V5\Services\DomainCategoryServiceClient;
use Google\Ads\GoogleAds\V5\Resources\DomainCategory;
...
class DomainCategoryServiceClientTest extends GeneratedTest
{
    ...
    public function getDomainCategoryTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.DomainCategoryService/GetDomainCategory', $actualFuncCall);
