...
use Google\Ads\Googleads\V5\Services\CampaignBidModifierServiceClient;
use Google\Ads\GoogleAds\V5\Resources\CampaignBidModifier;
use Google\Ads\GoogleAds\V5\Services\MutateCampaignBidModifiersResponse;
...
class CampaignBidModifierServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignBidModifierTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CampaignBidModifierService/GetCampaignBidModifier', $actualFuncCall);
    ...
    public function mutateCampaignBidModifiersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CampaignBidModifierService/MutateCampaignBidModifiers', $actualFuncCall);
