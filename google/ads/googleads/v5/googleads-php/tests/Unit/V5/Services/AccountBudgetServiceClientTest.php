...
use Google\Ads\Googleads\V5\Services\AccountBudgetServiceClient;
...
class AccountBudgetServiceClientTest extends GeneratedTest
{
    ...
    public function getAccountBudgetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AccountBudgetService/GetAccountBudget', $actualFuncCall);
