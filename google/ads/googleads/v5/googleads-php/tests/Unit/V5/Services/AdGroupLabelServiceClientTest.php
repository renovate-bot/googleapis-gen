...
use Google\Ads\GoogleAds\V5\Services\AdGroupLabelServiceClient;
...
class AdGroupLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AdGroupLabelService/GetAdGroupLabel', $actualFuncCall);
    ...
    public function mutateAdGroupLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.AdGroupLabelService/MutateAdGroupLabels', $actualFuncCall);
