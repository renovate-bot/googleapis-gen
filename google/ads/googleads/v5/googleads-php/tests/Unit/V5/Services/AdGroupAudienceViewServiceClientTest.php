...
use Google\Ads\GoogleAds\V5\Services\AdGroupAudienceViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\AdGroupAudienceView;
...
class AdGroupAudienceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupAudienceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.AdGroupAudienceViewService/GetAdGroupAudienceView', $actualFuncCall);
