...
use Google\Ads\GoogleAds\V5\Services\LandingPageViewServiceClient;
...
class LandingPageViewServiceClientTest extends GeneratedTest
{
    ...
    public function getLandingPageViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.LandingPageViewService/GetLandingPageView', $actualFuncCall);
