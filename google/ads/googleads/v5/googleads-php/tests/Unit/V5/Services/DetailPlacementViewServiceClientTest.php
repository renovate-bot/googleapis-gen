...
use Google\Ads\GoogleAds\V5\Services\DetailPlacementViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\DetailPlacementView;
...
class DetailPlacementViewServiceClientTest extends GeneratedTest
{
    ...
    public function getDetailPlacementViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.DetailPlacementViewService/GetDetailPlacementView', $actualFuncCall);
