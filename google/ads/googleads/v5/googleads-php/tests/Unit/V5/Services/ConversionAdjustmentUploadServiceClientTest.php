...
use Google\Ads\GoogleAds\V5\Services\ConversionAdjustmentUploadServiceClient;
...
class ConversionAdjustmentUploadServiceClientTest extends GeneratedTest
{
    ...
    public function uploadConversionAdjustmentsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.ConversionAdjustmentUploadService/UploadConversionAdjustments', $actualFuncCall);
