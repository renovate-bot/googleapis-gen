...
use Google\Ads\Googleads\V5\Services\CustomInterestServiceClient;
use Google\Ads\GoogleAds\V5\Resources\CustomInterest;
use Google\Ads\GoogleAds\V5\Services\MutateCustomInterestsResponse;
...
class CustomInterestServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomInterestTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CustomInterestService/GetCustomInterest', $actualFuncCall);
    ...
    public function mutateCustomInterestsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v5.services.CustomInterestService/MutateCustomInterests', $actualFuncCall);
