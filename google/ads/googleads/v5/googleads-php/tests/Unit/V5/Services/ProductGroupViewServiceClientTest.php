...
use Google\Ads\GoogleAds\V5\Services\ProductGroupViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\ProductGroupView;
...
class ProductGroupViewServiceClientTest extends GeneratedTest
{
    ...
    public function getProductGroupViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.ProductGroupViewService/GetProductGroupView', $actualFuncCall);
