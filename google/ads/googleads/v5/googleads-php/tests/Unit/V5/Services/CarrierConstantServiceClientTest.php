...
use Google\Ads\Googleads\V5\Services\CarrierConstantServiceClient;
 ...
 * @group gapic
 */
class CarrierConstantServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getCarrierConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.CarrierConstantService/GetCarrierConstant', $actualFuncCall);
