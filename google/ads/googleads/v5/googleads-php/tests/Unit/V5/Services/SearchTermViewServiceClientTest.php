...
use Google\Ads\Googleads\V5\Services\SearchTermViewServiceClient;
use Google\Ads\GoogleAds\V5\Resources\SearchTermView;
...
class SearchTermViewServiceClientTest extends GeneratedTest
{
    ...
    public function getSearchTermViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v5.services.SearchTermViewService/GetSearchTermView', $actualFuncCall);
