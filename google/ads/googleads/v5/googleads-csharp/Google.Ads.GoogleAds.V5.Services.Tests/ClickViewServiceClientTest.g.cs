    ...
    public sealed class GeneratedClickViewServiceClientTest
    {
        ...
        public void GetClickViewRequestObject()
        {
            ...
            gagvr::ClickView expectedResponse = new gagvr::ClickView
            {
                ...
                CampaignLocationTargetAsGeoTargetConstantName = gagvr::GeoTargetConstantName.FromGeoTargetConstant("[GEO_TARGET_CONSTANT]"),
                UserListAsUserListName = gagvr::UserListName.FromCustomerUserList("[CUSTOMER]", "[USER_LIST]"),
            };
