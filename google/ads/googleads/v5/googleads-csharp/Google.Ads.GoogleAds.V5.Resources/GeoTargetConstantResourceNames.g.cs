...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class GeoTargetConstantName : gax::IResourceName, sys::IEquatable<GeoTargetConstantName>
    {
        ...
        /// <summary>
        /// Creates a <see cref="GeoTargetConstantName"/> with the pattern <c>geoTargetConstants/{geo_target_constant}</c>
        /// .
        /// </summary>
        /// <param name="geoTargetConstantId">The <c>GeoTargetConstant</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="GeoTargetConstantName"/> constructed from the provided ids.</returns>
        public static GeoTargetConstantName FromGeoTargetConstant(string geoTargetConstantId) =>
            new GeoTargetConstantName(ResourceNameType.GeoTargetConstant, geoTargetConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(geoTargetConstantId, nameof(geoTargetConstantId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="GeoTargetConstantName"/> with pattern
        /// <c>geoTargetConstants/{geo_target_constant}</c>.
        /// </summary>
        /// <param name="geoTargetConstantId">The <c>GeoTargetConstant</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <c>geoTargetConstants/{geo_target_constant}</c>.
        /// </returns>
        public static string Format(string geoTargetConstantId) => FormatGeoTargetConstant(geoTargetConstantId);
        ...
        /// <c>geoTargetConstants/{geo_target_constant}</c>.
        /// </returns>
        public static string FormatGeoTargetConstant(string geoTargetConstantId) =>
            s_geoTargetConstant.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(geoTargetConstantId, nameof(geoTargetConstantId)));
        ...
        /// <list type="bullet">
        /// <item><description><c>geoTargetConstants/{geo_target_constant}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string geoTargetConstantName, bool allowUnparsed, out GeoTargetConstantName result)
        {
            ...
            if (s_geoTargetConstant.TryParseName(geoTargetConstantName, out resourceName))
            {
                result = FromGeoTargetConstant(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private GeoTargetConstantName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string geoTargetConstantId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            GeoTargetConstantId = geoTargetConstantId;
        }
        ...
        /// </summary>
        /// <param name="geoTargetConstantId">The <c>GeoTargetConstant</c> ID. Must not be <c>null</c> or empty.</param>
        public GeoTargetConstantName(string geoTargetConstantId) : this(ResourceNameType.GeoTargetConstant, geoTargetConstantId: gax::GaxPreconditions.CheckNotNullOrEmpty(geoTargetConstantId, nameof(geoTargetConstantId)))
        {
        }
        ...
        /// <summary>
        /// The <c>GeoTargetConstant</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
    ...
    public partial class GeoTargetConstant
    {
        ...
        /// property.
        /// </summary>
        public gagvr::GeoTargetConstantName ParentGeoTargetAsGeoTargetConstantName
        {
