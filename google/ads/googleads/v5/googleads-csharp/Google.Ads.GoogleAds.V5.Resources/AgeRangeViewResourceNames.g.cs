...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class AgeRangeViewName : gax::IResourceName, sys::IEquatable<AgeRangeViewName>
    {
        ...
        /// <c>customers/{customer}/ageRangeViews/{age_range_view}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="ageRangeViewId">The <c>AgeRangeView</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="AgeRangeViewName"/> constructed from the provided ids.</returns>
        public static AgeRangeViewName FromCustomerAgeRangeView(string customerId, string ageRangeViewId) =>
            new AgeRangeViewName(ResourceNameType.CustomerAgeRangeView, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), ageRangeViewId: gax::GaxPreconditions.CheckNotNullOrEmpty(ageRangeViewId, nameof(ageRangeViewId)));
        ...
        public static string Format(string customerId, string ageRangeViewId) =>
            FormatCustomerAgeRangeView(customerId, ageRangeViewId);
        ...
        /// <c>customers/{customer}/ageRangeViews/{age_range_view}</c>.
        /// </returns>
        public static string FormatCustomerAgeRangeView(string customerId, string ageRangeViewId) =>
            s_customerAgeRangeView.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(ageRangeViewId, nameof(ageRangeViewId)));

        /// <summary>Parses the given resource name string into a new <see cref="AgeRangeViewName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/ageRangeViews/{age_range_view}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string ageRangeViewName, bool allowUnparsed, out AgeRangeViewName result)
        {
            ...
            if (s_customerAgeRangeView.TryParseName(ageRangeViewName, out resourceName))
            {
                result = FromCustomerAgeRangeView(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private AgeRangeViewName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string ageRangeViewId = null, string customerId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            AgeRangeViewId = ageRangeViewId;
        ...
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="ageRangeViewId">The <c>AgeRangeView</c> ID. Must not be <c>null</c> or empty.</param>
        public AgeRangeViewName(string customerId, string ageRangeViewId) : this(ResourceNameType.CustomerAgeRangeView, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), ageRangeViewId: gax::GaxPreconditions.CheckNotNullOrEmpty(ageRangeViewId, nameof(ageRangeViewId)))
        {
        }
        ...
        /// <summary>
        /// The <c>AgeRangeView</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.CustomerAgeRangeView: return s_customerAgeRangeView.Expand(CustomerId, AgeRangeViewId);
    ...
    public partial class AgeRangeView
    {
        ...
        /// </summary>
        public AgeRangeViewName ResourceNameAsAgeRangeViewName
        {
