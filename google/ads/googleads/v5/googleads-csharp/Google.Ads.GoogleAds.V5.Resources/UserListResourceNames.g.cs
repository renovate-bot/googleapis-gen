...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class UserListName : gax::IResourceName, sys::IEquatable<UserListName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/userLists/{user_list}</c>.</summary>
            CustomerUserList = 1,
        }

        private static gax::PathTemplate s_customerUserList = new gax::PathTemplate("customers/{customer}/userLists/{user_list}");
        ...
        /// <summary>
        /// Creates a <see cref="UserListName"/> with the pattern <c>customers/{customer}/userLists/{user_list}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer}/userLists/{user_list}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="userListId">The <c>UserList</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/userLists/{user_list}</c></description></item>
        /// </list>
        /// </remarks>
