...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class UserInterestName : gax::IResourceName, sys::IEquatable<UserInterestName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer}/userInterests/{user_interest}</c>.
            /// </summary>
            CustomerUserInterest = 1,
        }

        private static gax::PathTemplate s_customerUserInterest = new gax::PathTemplate("customers/{customer}/userInterests/{user_interest}");
        ...
        /// <c>customers/{customer}/userInterests/{user_interest}</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/userInterests/{user_interest}</c></description></item>
        /// </list>
        /// </remarks>
