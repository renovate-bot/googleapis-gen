...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class AdScheduleViewName : gax::IResourceName, sys::IEquatable<AdScheduleViewName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer}/adScheduleViews/{ad_schedule_view}</c>.
            /// </summary>
            CustomerAdScheduleView = 1,
        }

        private static gax::PathTemplate s_customerAdScheduleView = new gax::PathTemplate("customers/{customer}/adScheduleViews/{ad_schedule_view}");
        ...
        /// <c>customers/{customer}/adScheduleViews/{ad_schedule_view}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="adScheduleViewId">The <c>AdScheduleView</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="AdScheduleViewName"/> constructed from the provided ids.</returns>
        public static AdScheduleViewName FromCustomerAdScheduleView(string customerId, string adScheduleViewId) =>
            new AdScheduleViewName(ResourceNameType.CustomerAdScheduleView, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), adScheduleViewId: gax::GaxPreconditions.CheckNotNullOrEmpty(adScheduleViewId, nameof(adScheduleViewId)));
        ...
        public static string Format(string customerId, string adScheduleViewId) =>
            FormatCustomerAdScheduleView(customerId, adScheduleViewId);
        ...
        /// <c>customers/{customer}/adScheduleViews/{ad_schedule_view}</c>.
        /// </returns>
        public static string FormatCustomerAdScheduleView(string customerId, string adScheduleViewId) =>
            s_customerAdScheduleView.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(adScheduleViewId, nameof(adScheduleViewId)));
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/adScheduleViews/{ad_schedule_view}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string adScheduleViewName, bool allowUnparsed, out AdScheduleViewName result)
        {
            ...
            if (s_customerAdScheduleView.TryParseName(adScheduleViewName, out resourceName))
            {
                result = FromCustomerAdScheduleView(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private AdScheduleViewName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string adScheduleViewId = null, string customerId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            AdScheduleViewId = adScheduleViewId;
        ...
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="adScheduleViewId">The <c>AdScheduleView</c> ID. Must not be <c>null</c> or empty.</param>
        public AdScheduleViewName(string customerId, string adScheduleViewId) : this(ResourceNameType.CustomerAdScheduleView, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), adScheduleViewId: gax::GaxPreconditions.CheckNotNullOrEmpty(adScheduleViewId, nameof(adScheduleViewId)))
        {
        }
        ...
        /// <summary>
        /// The <c>AdScheduleView</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.CustomerAdScheduleView: return s_customerAdScheduleView.Expand(CustomerId, AdScheduleViewId);
    ...
    public partial class AdScheduleView
    {
        ...
        /// </summary>
        public AdScheduleViewName ResourceNameAsAdScheduleViewName
        {
