...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class VideoName : gax::IResourceName, sys::IEquatable<VideoName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/videos/{video}</c>.</summary>
            CustomerVideo = 1,
        }

        private static gax::PathTemplate s_customerVideo = new gax::PathTemplate("customers/{customer}/videos/{video}");
        ...
        /// <summary>
        /// Creates a <see cref="VideoName"/> with the pattern <c>customers/{customer}/videos/{video}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer}/videos/{video}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="videoId">The <c>Video</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/videos/{video}</c></description></item>
        /// </list>
        /// </remarks>
    ...
    public partial class Video
    {
        ...
        /// </summary>
        public VideoName ResourceNameAsVideoName
        {
