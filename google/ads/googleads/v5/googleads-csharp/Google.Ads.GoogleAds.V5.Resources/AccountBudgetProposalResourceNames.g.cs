...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class AccountBudgetProposalName : gax::IResourceName, sys::IEquatable<AccountBudgetProposalName>
    {
        ...
        /// <c>customers/{customer}/accountBudgetProposals/{account_budget_proposal}</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>customers/{customer}/accountBudgetProposals/{account_budget_proposal}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        /// pattern <c>customers/{customer}/accountBudgetProposals/{account_budget_proposal}</c>
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="accountBudgetProposalId">
        /// The <c>AccountBudgetProposal</c> ID. Must not be <c>null</c> or empty.
    ...
    public partial class AccountBudgetProposal
    {
        ...
        /// property.
        /// </summary>
        public AccountBudgetProposalName ResourceNameAsAccountBudgetProposalName
        {
        ...
        /// </summary>
        public AccountBudgetName AccountBudgetAsAccountBudgetName
        {
