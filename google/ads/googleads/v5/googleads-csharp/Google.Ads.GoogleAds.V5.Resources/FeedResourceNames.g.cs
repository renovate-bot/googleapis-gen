...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class FeedName : gax::IResourceName, sys::IEquatable<FeedName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/feeds/{feed}</c>.</summary>
            CustomerFeed = 1,
        }

        private static gax::PathTemplate s_customerFeed = new gax::PathTemplate("customers/{customer}/feeds/{feed}");
        ...
        /// <summary>
        /// Creates a <see cref="FeedName"/> with the pattern <c>customers/{customer}/feeds/{feed}</c>.
        /// </summary>
        ...
        public static FeedName FromCustomerFeed(string customerId, string feedId) =>
            new FeedName(ResourceNameType.CustomerFeed, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), feedId: gax::GaxPreconditions.CheckNotNullOrEmpty(feedId, nameof(feedId)));

        /// <summary>
        /// Formats the IDs into the string representation of this <see cref="FeedName"/> with pattern
        /// <c>customers/{customer}/feeds/{feed}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="feedId">The <c>Feed</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="FeedName"/> with pattern <c>customers/{customer}/feeds/{feed}</c>
        /// .
        /// </returns>
        ...
        /// <list type="bullet"><item><description><c>customers/{customer}/feeds/{feed}</c></description></item></list>
        /// </remarks>
        ...
        public static bool TryParse(string feedName, bool allowUnparsed, out FeedName result)
        {
            ...
            if (s_customerFeed.TryParseName(feedName, out resourceName))
            {
        ...
        private FeedName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string customerId = null, string feedId = null)
        {
            Type = type;
        ...
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="feedId">The <c>Feed</c> ID. Must not be <c>null</c> or empty.</param>
        public FeedName(string customerId, string feedId) : this(ResourceNameType.CustomerFeed, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), feedId: gax::GaxPreconditions.CheckNotNullOrEmpty(feedId, nameof(feedId)))
        {
        }
    ...
    {
        /// <summary>
        /// <see cref="gagvr::FeedName"/>-typed view over the <see cref="ResourceName"/> resource name property.
        /// </summary>
        public gagvr::FeedName ResourceNameAsFeedName
        {
            get => string.IsNullOrEmpty(ResourceName) ? null : gagvr::FeedName.Parse(ResourceName, allowUnparsed: true);
            set => ResourceName = value?.ToString() ?? "";
        }

        /// <summary>
        /// <see cref="gagvr::FeedName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gagvr::FeedName FeedName
        {
            get => string.IsNullOrEmpty(Name) ? null : gagvr::FeedName.Parse(Name, allowUnparsed: true);
