...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class PaymentsAccountName : gax::IResourceName, sys::IEquatable<PaymentsAccountName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer}/paymentsAccounts/{payments_account}</c>.
            /// </summary>
            CustomerPaymentsAccount = 1,
        }

        private static gax::PathTemplate s_customerPaymentsAccount = new gax::PathTemplate("customers/{customer}/paymentsAccounts/{payments_account}");
        ...
        /// <c>customers/{customer}/paymentsAccounts/{payments_account}</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/paymentsAccounts/{payments_account}</c></description></item>
        /// </list>
        /// </remarks>
