...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class AccountLinkName : gax::IResourceName, sys::IEquatable<AccountLinkName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer}/accountLinks/{account_link}</c>.</summary>
            CustomerAccountLink = 1,
        }

        private static gax::PathTemplate s_customerAccountLink = new gax::PathTemplate("customers/{customer}/accountLinks/{account_link}");
        ...
        /// <summary>
        /// Creates a <see cref="AccountLinkName"/> with the pattern <c>customers/{customer}/accountLinks/{account_link}</c>
        /// .
        /// </summary>
        ...
        /// <c>customers/{customer}/accountLinks/{account_link}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="accountLinkId">The <c>AccountLink</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/accountLinks/{account_link}</c></description></item>
        /// </list>
        /// </remarks>
    ...
    public partial class AccountLink
    {
        ...
        /// </summary>
        public AccountLinkName ResourceNameAsAccountLinkName
        {
