...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class KeywordPlanAdGroupKeywordName : gax::IResourceName, sys::IEquatable<KeywordPlanAdGroupKeywordName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>customers/{customer}/keywordPlanAdGroupKeywords/{keyword_plan_ad_group_keyword}</c>.
            /// </summary>
            CustomerKeywordPlanAdGroupKeyword = 1,
        }

        private static gax::PathTemplate s_customerKeywordPlanAdGroupKeyword = new gax::PathTemplate("customers/{customer}/keywordPlanAdGroupKeywords/{keyword_plan_ad_group_keyword}");
        ...
        /// pattern <c>customers/{customer}/keywordPlanAdGroupKeywords/{keyword_plan_ad_group_keyword}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="keywordPlanAdGroupKeywordId">
        /// The <c>KeywordPlanAdGroupKeyword</c> ID. Must not be <c>null</c> or empty.
