...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class CampaignLabelName : gax::IResourceName, sys::IEquatable<CampaignLabelName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer}/campaignLabels/{campaign_label}</c>.
            /// </summary>
            CustomerCampaignLabel = 1,
        }

        private static gax::PathTemplate s_customerCampaignLabel = new gax::PathTemplate("customers/{customer}/campaignLabels/{campaign_label}");
        ...
        /// <c>customers/{customer}/campaignLabels/{campaign_label}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="campaignLabelId">The <c>CampaignLabel</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="CampaignLabelName"/> constructed from the provided ids.</returns>
        public static CampaignLabelName FromCustomerCampaignLabel(string customerId, string campaignLabelId) =>
            new CampaignLabelName(ResourceNameType.CustomerCampaignLabel, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), campaignLabelId: gax::GaxPreconditions.CheckNotNullOrEmpty(campaignLabelId, nameof(campaignLabelId)));
        ...
        public static string Format(string customerId, string campaignLabelId) =>
            FormatCustomerCampaignLabel(customerId, campaignLabelId);
        ...
        /// <c>customers/{customer}/campaignLabels/{campaign_label}</c>.
        /// </returns>
        public static string FormatCustomerCampaignLabel(string customerId, string campaignLabelId) =>
            s_customerCampaignLabel.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(campaignLabelId, nameof(campaignLabelId)));
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer}/campaignLabels/{campaign_label}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string campaignLabelName, bool allowUnparsed, out CampaignLabelName result)
        {
            ...
            {
                result = FromCustomerCampaignLabel(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private CampaignLabelName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string campaignLabelId = null, string customerId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            CampaignLabelId = campaignLabelId;
        ...
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="campaignLabelId">The <c>CampaignLabel</c> ID. Must not be <c>null</c> or empty.</param>
        public CampaignLabelName(string customerId, string campaignLabelId) : this(ResourceNameType.CustomerCampaignLabel, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), campaignLabelId: gax::GaxPreconditions.CheckNotNullOrEmpty(campaignLabelId, nameof(campaignLabelId)))
        {
        }
        ...
        /// <summary>
        /// The <c>CampaignLabel</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.CustomerCampaignLabel: return s_customerCampaignLabel.Expand(CustomerId, CampaignLabelId);
    ...
    public partial class CampaignLabel
    {
        ...
        /// </summary>
        public CampaignLabelName ResourceNameAsCampaignLabelName
        {
        ...
        /// </summary>
        public CampaignName CampaignAsCampaignName
        {
