...
namespace Google.Ads.GoogleAds.V5.Resources
{
    ...
    public sealed partial class MerchantCenterLinkName : gax::IResourceName, sys::IEquatable<MerchantCenterLinkName>
    {
        ...
        /// <c>customers/{customer}/merchantCenterLinks/{merchant_center_link}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="merchantCenterLinkId">
        /// The <c>MerchantCenterLink</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        /// <returns>A new instance of <see cref="MerchantCenterLinkName"/> constructed from the provided ids.</returns>
        public static MerchantCenterLinkName FromCustomerMerchantCenterLink(string customerId, string merchantCenterLinkId) =>
            new MerchantCenterLinkName(ResourceNameType.CustomerMerchantCenterLink, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), merchantCenterLinkId: gax::GaxPreconditions.CheckNotNullOrEmpty(merchantCenterLinkId, nameof(merchantCenterLinkId)));
        ...
        public static string Format(string customerId, string merchantCenterLinkId) =>
            FormatCustomerMerchantCenterLink(customerId, merchantCenterLinkId);
        ...
        /// <c>customers/{customer}/merchantCenterLinks/{merchant_center_link}</c>.
        /// </returns>
        public static string FormatCustomerMerchantCenterLink(string customerId, string merchantCenterLinkId) =>
            s_customerMerchantCenterLink.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), gax::GaxPreconditions.CheckNotNullOrEmpty(merchantCenterLinkId, nameof(merchantCenterLinkId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>customers/{customer}/merchantCenterLinks/{merchant_center_link}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string merchantCenterLinkName, bool allowUnparsed, out MerchantCenterLinkName result)
        {
            ...
            if (s_customerMerchantCenterLink.TryParseName(merchantCenterLinkName, out resourceName))
            {
                result = FromCustomerMerchantCenterLink(resourceName[0], resourceName[1]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private MerchantCenterLinkName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string customerId = null, string merchantCenterLinkId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            CustomerId = customerId;
            MerchantCenterLinkId = merchantCenterLinkId;
        }

        /// <summary>
        /// Constructs a new instance of a <see cref="MerchantCenterLinkName"/> class from the component parts of
        /// pattern <c>customers/{customer}/merchantCenterLinks/{merchant_center_link}</c>
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="merchantCenterLinkId">
        /// The <c>MerchantCenterLink</c> ID. Must not be <c>null</c> or empty.
        /// </param>
        public MerchantCenterLinkName(string customerId, string merchantCenterLinkId) : this(ResourceNameType.CustomerMerchantCenterLink, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), merchantCenterLinkId: gax::GaxPreconditions.CheckNotNullOrEmpty(merchantCenterLinkId, nameof(merchantCenterLinkId)))
        {
        }
        ...
        /// <summary>
        /// The <c>MerchantCenterLink</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed
        /// resource name.
        /// </summary>
    ...
    public partial class MerchantCenterLink
    {
        ...
        /// </summary>
        public MerchantCenterLinkName ResourceNameAsMerchantCenterLinkName
        {
