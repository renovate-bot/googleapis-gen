...
namespace Google.Ads.GoogleAds.V5.Services
{
    ...
    public sealed partial class BatchJobServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private BatchJobServiceSettings(BatchJobServiceSettings existing) : base(existing)
        {
            ...
            GetBatchJobSettings = existing.GetBatchJobSettings;
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>BatchJobServiceClient.GetBatchJob</c> and <c>BatchJobServiceClient.GetBatchJobAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 5000 milliseconds.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetBatchJobSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(3600000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(5000), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable, grpccore::StatusCode.DeadlineExceeded)));
    ...
    public abstract partial class BatchJobServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::BatchJob GetBatchJob(GetBatchJobRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BatchJob> GetBatchJobAsync(GetBatchJobRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BatchJob> GetBatchJobAsync(GetBatchJobRequest request, st::CancellationToken cancellationToken) =>
            GetBatchJobAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::BatchJob GetBatchJob(string resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetBatchJob(new GetBatchJobRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BatchJob> GetBatchJobAsync(string resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetBatchJobAsync(new GetBatchJobRequest
            {
                ResourceName = gax::GaxPreconditions.CheckNotNullOrEmpty(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BatchJob> GetBatchJobAsync(string resourceName, st::CancellationToken cancellationToken) =>
            GetBatchJobAsync(resourceName, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual gagvr::BatchJob GetBatchJob(gagvr::BatchJobName resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetBatchJob(new GetBatchJobRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BatchJob> GetBatchJobAsync(gagvr::BatchJobName resourceName, gaxgrpc::CallSettings callSettings = null) =>
            GetBatchJobAsync(new GetBatchJobRequest
            {
                ResourceNameAsBatchJobName = gax::GaxPreconditions.CheckNotNull(resourceName, nameof(resourceName)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<gagvr::BatchJob> GetBatchJobAsync(gagvr::BatchJobName resourceName, st::CancellationToken cancellationToken) =>
            GetBatchJobAsync(resourceName, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    ...
    public sealed partial class BatchJobServiceClientImpl : BatchJobServiceClient
    {
        ...
        private readonly gaxgrpc::ApiCall<GetBatchJobRequest, gagvr::BatchJob> _callGetBatchJob;
        ...
        public BatchJobServiceClientImpl(BatchJobService.BatchJobServiceClient grpcClient, BatchJobServiceSettings settings)
        {
            ...
            _callGetBatchJob = clientHelper.BuildApiCall<GetBatchJobRequest, gagvr::BatchJob>(grpcClient.GetBatchJobAsync, grpcClient.GetBatchJob, effectiveSettings.GetBatchJobSettings).WithGoogleRequestParam("resource_name", request => request.ResourceName);
            Modify_ApiCall(ref _callGetBatchJob);
            Modify_GetBatchJobApiCall(ref _callGetBatchJob);
        ...
        partial void Modify_GetBatchJobApiCall(ref gaxgrpc::ApiCall<GetBatchJobRequest, gagvr::BatchJob> call);
        ...
        partial void Modify_GetBatchJobRequest(ref GetBatchJobRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override gagvr::BatchJob GetBatchJob(GetBatchJobRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetBatchJobRequest(ref request, ref callSettings);
            return _callGetBatchJob.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<gagvr::BatchJob> GetBatchJobAsync(GetBatchJobRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetBatchJobRequest(ref request, ref callSettings);
            return _callGetBatchJob.Async(request, callSettings);
        }
