 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/campaign_draft_service.proto
...
use Google\Ads\GoogleAds\V3\Services\CampaignDraftOperation;
use Google\Ads\GoogleAds\V3\Services\GetCampaignDraftRequest;
use Google\Ads\GoogleAds\V3\Services\ListCampaignDraftAsyncErrorsRequest;
use Google\Ads\GoogleAds\V3\Services\ListCampaignDraftAsyncErrorsResponse;
use Google\Ads\GoogleAds\V3\Services\MutateCampaignDraftsRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCampaignDraftsResponse;
use Google\Ads\GoogleAds\V3\Services\PromoteCampaignDraftRequest;
...
class CampaignDraftServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.CampaignDraftService';
