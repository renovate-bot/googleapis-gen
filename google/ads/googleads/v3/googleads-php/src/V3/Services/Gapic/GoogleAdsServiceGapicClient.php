 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/google_ads_service.proto
...
use Google\Ads\GoogleAds\V3\Enums\SummaryRowSettingEnum\SummaryRowSetting;
use Google\Ads\GoogleAds\V3\Services\MutateGoogleAdsRequest;
use Google\Ads\GoogleAds\V3\Services\MutateGoogleAdsResponse;
...
use Google\Ads\GoogleAds\V3\Services\SearchGoogleAdsStreamRequest;
...
class GoogleAdsServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.GoogleAdsService';
     ...
     *          For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V3\Enums\SummaryRowSettingEnum\SummaryRowSetting}
