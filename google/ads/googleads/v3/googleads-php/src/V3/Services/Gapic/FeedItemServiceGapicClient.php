...
use Google\Ads\GoogleAds\V3\Services\GetFeedItemRequest;
use Google\Ads\GoogleAds\V3\Services\MutateFeedItemsRequest;
...
class FeedItemServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.FeedItemService';
