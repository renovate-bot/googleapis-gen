 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/invoice_service.proto
...
use Google\Ads\GoogleAds\V3\Services\ListInvoicesRequest;
use Google\Ads\GoogleAds\V3\Services\ListInvoicesResponse;
...
class InvoiceServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.InvoiceService';
     ...
     *                             For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V3\Enums\MonthOfYearEnum\MonthOfYear}
