...
use Google\Ads\GoogleAds\V3\Services\GetAdGroupRequest;
use Google\Ads\GoogleAds\V3\Services\MutateAdGroupsRequest;
...
class AdGroupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.AdGroupService';
