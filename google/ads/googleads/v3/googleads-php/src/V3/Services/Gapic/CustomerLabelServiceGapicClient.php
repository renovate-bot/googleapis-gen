...
use Google\Ads\GoogleAds\V3\Resources\CustomerLabel;
use Google\Ads\GoogleAds\V3\Services\CustomerLabelOperation;
use Google\Ads\GoogleAds\V3\Services\GetCustomerLabelRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCustomerLabelsRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCustomerLabelsResponse;
 ...
 * try {
 *     $formattedResourceName = $customerLabelServiceClient->customerLabelName('[CUSTOMER]', '[CUSTOMER_LABEL]');
...
class CustomerLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.CustomerLabelService';
     ...
     * @experimental
     */
    public static function customerLabelName($customer, $customerLabel)
    {
     ...
     * Template: Pattern
     * - customerLabel: customers/{customer}/customerLabels/{customer_label}.
     *
