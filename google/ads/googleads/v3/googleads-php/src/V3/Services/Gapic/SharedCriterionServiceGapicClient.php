 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/shared_criterion_service.proto
...
use Google\Ads\GoogleAds\V3\Services\GetSharedCriterionRequest;
use Google\Ads\GoogleAds\V3\Services\MutateSharedCriteriaRequest;
use Google\Ads\GoogleAds\V3\Services\MutateSharedCriteriaResponse;
use Google\Ads\GoogleAds\V3\Services\SharedCriterionOperation;
...
class SharedCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.SharedCriterionService';
