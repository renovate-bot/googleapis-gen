 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/merchant_center_link_service.proto
...
use Google\Ads\GoogleAds\V3\Services\GetMerchantCenterLinkRequest;
use Google\Ads\GoogleAds\V3\Services\ListMerchantCenterLinksRequest;
use Google\Ads\GoogleAds\V3\Services\ListMerchantCenterLinksResponse;
use Google\Ads\GoogleAds\V3\Services\MerchantCenterLinkOperation;
use Google\Ads\GoogleAds\V3\Services\MutateMerchantCenterLinkRequest;
use Google\Ads\GoogleAds\V3\Services\MutateMerchantCenterLinkResponse;
...
class MerchantCenterLinkServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.MerchantCenterLinkService';
