...
use Google\Ads\GoogleAds\V3\Services\GetCampaignBudgetRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCampaignBudgetsRequest;
 ...
 * try {
 *     $formattedResourceName = $campaignBudgetServiceClient->campaignBudgetName('[CUSTOMER]', '[CAMPAIGN_BUDGET]');
...
class CampaignBudgetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.CampaignBudgetService';
    ...
    {
        if (null == self::$campaignBudgetNameTemplate) {
            self::$campaignBudgetNameTemplate = new PathTemplate('customers/{customer}/campaignBudgets/{campaign_budget}');
        }
     ...
     * @experimental
     */
    public static function campaignBudgetName($customer, $campaignBudget)
    {
     ...
     * Template: Pattern
     * - campaignBudget: customers/{customer}/campaignBudgets/{campaign_budget}.
     *
