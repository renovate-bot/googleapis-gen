...
use Google\Ads\GoogleAds\V3\Services\CallConversion;
use Google\Ads\GoogleAds\V3\Services\ClickConversion;
use Google\Ads\GoogleAds\V3\Services\UploadCallConversionsRequest;
use Google\Ads\GoogleAds\V3\Services\UploadCallConversionsResponse;
use Google\Ads\GoogleAds\V3\Services\UploadClickConversionsRequest;
...
class ConversionUploadServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.ConversionUploadService';
