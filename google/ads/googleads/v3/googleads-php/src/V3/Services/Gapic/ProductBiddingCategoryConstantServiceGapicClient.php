 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/product_bidding_category_constant_service.proto
...
use Google\Ads\GoogleAds\V3\Resources\ProductBiddingCategoryConstant;
use Google\Ads\GoogleAds\V3\Services\GetProductBiddingCategoryConstantRequest;
 ...
 * try {
 *     $formattedResourceName = $productBiddingCategoryConstantServiceClient->productBiddingCategoryConstantName('[PRODUCT_BIDDING_CATEGORY_CONSTANT]');
...
class ProductBiddingCategoryConstantServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.ProductBiddingCategoryConstantService';
     ...
     *
     * @param string $productBiddingCategoryConstant
     *
     * @return string The formatted product_bidding_category_constant resource.
     * @experimental
     */
    public static function productBiddingCategoryConstantName($productBiddingCategoryConstant)
    {
     ...
     * Template: Pattern
     * - productBiddingCategoryConstant: productBiddingCategoryConstants/{product_bidding_category_constant}.
     *
