 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/asset_service.proto
...
use Google\Ads\GoogleAds\V3\Services\GetAssetRequest;
use Google\Ads\GoogleAds\V3\Services\MutateAssetsRequest;
 ...
 * try {
 *     $formattedResourceName = $assetServiceClient->assetName('[CUSTOMER]', '[ASSET]');
...
class AssetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.AssetService';
    ...
    private static function getAssetNameTemplate()
    {
        if (null == self::$assetNameTemplate) {
            self::$assetNameTemplate = new PathTemplate('customers/{customer}/assets/{asset}');
        }
     ...
     * @experimental
     */
    public static function assetName($customer, $asset)
    {
     ...
     * Template: Pattern
     * - asset: customers/{customer}/assets/{asset}.
     *
