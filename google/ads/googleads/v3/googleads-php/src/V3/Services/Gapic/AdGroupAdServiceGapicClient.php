 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/ad_group_ad_service.proto
...
use Google\Ads\GoogleAds\V3\Services\GetAdGroupAdRequest;
use Google\Ads\GoogleAds\V3\Services\MutateAdGroupAdsRequest;
 ...
 * try {
 *     $formattedResourceName = $adGroupAdServiceClient->adGroupAdName('[CUSTOMER]', '[AD_GROUP_AD]');
...
class AdGroupAdServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.AdGroupAdService';
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V3\Services\MutateAdGroupAdsResponse
     *
     * @throws ApiException if the remote call fails
     * @experimental
     */
    public function mutateAdGroupAds($customerId, $operations, array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            'MutateAdGroupAds',
            MutateAdGroupAdsResponse::class,
            $optionalArgs,
            $request
        )->wait();
    }
