 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/ad_group_feed_service.proto
...
use Google\Ads\GoogleAds\V3\Resources\AdGroupFeed;
use Google\Ads\GoogleAds\V3\Services\AdGroupFeedOperation;
use Google\Ads\GoogleAds\V3\Services\GetAdGroupFeedRequest;
use Google\Ads\GoogleAds\V3\Services\MutateAdGroupFeedsRequest;
use Google\Ads\GoogleAds\V3\Services\MutateAdGroupFeedsResponse;
...
class AdGroupFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.AdGroupFeedService';
