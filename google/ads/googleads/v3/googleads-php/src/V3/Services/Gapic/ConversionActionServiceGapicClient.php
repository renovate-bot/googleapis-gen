...
use Google\Ads\GoogleAds\V3\Services\ConversionActionOperation;
use Google\Ads\GoogleAds\V3\Services\GetConversionActionRequest;
use Google\Ads\GoogleAds\V3\Services\MutateConversionActionsRequest;
use Google\Ads\GoogleAds\V3\Services\MutateConversionActionsResponse;
...
class ConversionActionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.ConversionActionService';
