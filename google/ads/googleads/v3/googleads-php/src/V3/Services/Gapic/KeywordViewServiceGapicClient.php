...
use Google\Ads\GoogleAds\V3\Resources\KeywordView;
use Google\Ads\GoogleAds\V3\Services\GetKeywordViewRequest;
...
class KeywordViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.KeywordViewService';
