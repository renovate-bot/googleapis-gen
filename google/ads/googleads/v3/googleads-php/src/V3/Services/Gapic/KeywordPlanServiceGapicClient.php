 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/keyword_plan_service.proto
...
use Google\Ads\GoogleAds\V3\Services\GenerateForecastMetricsRequest;
use Google\Ads\GoogleAds\V3\Services\GenerateForecastMetricsResponse;
use Google\Ads\GoogleAds\V3\Services\GenerateHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V3\Services\GenerateHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V3\Services\GetKeywordPlanRequest;
use Google\Ads\GoogleAds\V3\Services\KeywordPlanOperation;
use Google\Ads\GoogleAds\V3\Services\MutateKeywordPlansRequest;
...
class KeywordPlanServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.KeywordPlanService';
