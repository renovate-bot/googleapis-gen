 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/customer_negative_criterion_service.proto
...
use Google\Ads\GoogleAds\V3\Services\CustomerNegativeCriterionOperation;
use Google\Ads\GoogleAds\V3\Services\GetCustomerNegativeCriterionRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCustomerNegativeCriteriaRequest;
use Google\Ads\GoogleAds\V3\Services\MutateCustomerNegativeCriteriaResponse;
...
class CustomerNegativeCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.CustomerNegativeCriterionService';
     ...
     * ```
     *
     * @param string $resourceName Required. The resource name of the criterion to fetch.
     ...
     * @experimental
     */
    public function getCustomerNegativeCriterion($resourceName, array $optionalArgs = [])
    {
        $request = new GetCustomerNegativeCriterionRequest();
        ...
        return $this->startCall(
            ...
            CustomerNegativeCriterion::class,
            $optionalArgs,
            $request
        )->wait();
    }
     ...
     *     $customerId = '';
     *     $operations = [];
     *     $response = $customerNegativeCriterionServiceClient->mutateCustomerNegativeCriteria($customerId, $operations);
     * } finally {
     *     $customerNegativeCriterionServiceClient->close();
     * }
     * ```
     ...
     * @param CustomerNegativeCriterionOperation[] $operations   Required. The list of operations to perform on individual criteria.
     * @param array                                $optionalArgs {
     *                                                           Optional.
     *
     ...
     * @experimental
     */
    public function mutateCustomerNegativeCriteria($customerId, $operations, array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            ...
            MutateCustomerNegativeCriteriaResponse::class,
            $optionalArgs,
            $request
        )->wait();
    }
