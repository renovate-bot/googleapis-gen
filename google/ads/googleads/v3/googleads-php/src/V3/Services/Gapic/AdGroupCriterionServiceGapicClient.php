 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/ad_group_criterion_service.proto
...
use Google\Ads\GoogleAds\V3\Services\GetAdGroupCriterionRequest;
use Google\Ads\GoogleAds\V3\Services\MutateAdGroupCriteriaRequest;
use Google\Ads\GoogleAds\V3\Services\MutateAdGroupCriteriaResponse;
...
class AdGroupCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.AdGroupCriterionService';
    ...
    public function mutateAdGroupCriteria($customerId, $operations, array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            ...
            MutateAdGroupCriteriaResponse::class,
            $optionalArgs,
            $request
        )->wait();
    }
