...
use Google\Ads\GoogleAds\V3\Services\ListPaymentsAccountsRequest;
use Google\Ads\GoogleAds\V3\Services\ListPaymentsAccountsResponse;
...
class PaymentsAccountServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.PaymentsAccountService';
