 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v3/services/bidding_strategy_service.proto
...
use Google\Ads\GoogleAds\V3\Services\BiddingStrategyOperation;
use Google\Ads\GoogleAds\V3\Services\GetBiddingStrategyRequest;
use Google\Ads\GoogleAds\V3\Services\MutateBiddingStrategiesRequest;
use Google\Ads\GoogleAds\V3\Services\MutateBiddingStrategiesResponse;
...
class BiddingStrategyServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.BiddingStrategyService';
