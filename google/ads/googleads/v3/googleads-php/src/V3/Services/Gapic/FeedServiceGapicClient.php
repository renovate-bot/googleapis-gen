...
use Google\Ads\GoogleAds\V3\Services\GetFeedRequest;
use Google\Ads\GoogleAds\V3\Services\MutateFeedsRequest;
...
class FeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v3.services.FeedService';
