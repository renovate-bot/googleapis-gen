...
class CustomerManagerLinkServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerManagerLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CustomerManagerLinkService/GetCustomerManagerLink', $actualFuncCall);
    ...
    public function mutateCustomerManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CustomerManagerLinkService/MutateCustomerManagerLink', $actualFuncCall);
    ...
    public function moveManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CustomerManagerLinkService/MoveManagerLink', $actualFuncCall);
