...
class AdGroupExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupExtensionSettingTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.AdGroupExtensionSettingService/GetAdGroupExtensionSetting', $actualFuncCall);
    ...
    public function mutateAdGroupExtensionSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.AdGroupExtensionSettingService/MutateAdGroupExtensionSettings', $actualFuncCall);
