...
use Google\Ads\GoogleAds\V3\Resources\ProductGroupView;
...
class ProductGroupViewServiceClientTest extends GeneratedTest
{
    ...
    public function getProductGroupViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.ProductGroupViewService/GetProductGroupView', $actualFuncCall);
