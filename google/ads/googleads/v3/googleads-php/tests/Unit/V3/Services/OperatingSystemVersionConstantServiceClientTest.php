...
use Google\Ads\GoogleAds\V3\Resources\OperatingSystemVersionConstant;
...
class OperatingSystemVersionConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getOperatingSystemVersionConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.OperatingSystemVersionConstantService/GetOperatingSystemVersionConstant', $actualFuncCall);
