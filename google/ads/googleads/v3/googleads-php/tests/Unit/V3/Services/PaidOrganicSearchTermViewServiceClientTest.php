...
use Google\Ads\GoogleAds\V3\Resources\PaidOrganicSearchTermView;
...
class PaidOrganicSearchTermViewServiceClientTest extends GeneratedTest
{
    ...
    public function getPaidOrganicSearchTermViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.PaidOrganicSearchTermViewService/GetPaidOrganicSearchTermView', $actualFuncCall);
