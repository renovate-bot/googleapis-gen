...
use Google\Ads\GoogleAds\V3\Services\DistanceViewServiceClient;
...
class DistanceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getDistanceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.DistanceViewService/GetDistanceView', $actualFuncCall);
