...
use Google\Ads\GoogleAds\V3\Services\ConversionUploadServiceClient;
use Google\Ads\GoogleAds\V3\Services\UploadCallConversionsResponse;
...
class ConversionUploadServiceClientTest extends GeneratedTest
{
    ...
    public function uploadClickConversionsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.ConversionUploadService/UploadClickConversions', $actualFuncCall);
    ...
    public function uploadCallConversionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.ConversionUploadService/UploadCallConversions', $actualFuncCall);
