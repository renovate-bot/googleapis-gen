...
use Google\Ads\GoogleAds\V3\Resources\HotelGroupView;
...
class HotelGroupViewServiceClientTest extends GeneratedTest
{
    ...
    public function getHotelGroupViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.HotelGroupViewService/GetHotelGroupView', $actualFuncCall);
