...
use Google\Ads\GoogleAds\V3\Resources\AdScheduleView;
...
class AdScheduleViewServiceClientTest extends GeneratedTest
{
    ...
    public function getAdScheduleViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.AdScheduleViewService/GetAdScheduleView', $actualFuncCall);
