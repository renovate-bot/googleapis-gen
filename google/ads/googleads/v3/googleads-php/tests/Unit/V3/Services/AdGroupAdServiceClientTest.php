...
class AdGroupAdServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupAdTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.AdGroupAdService/GetAdGroupAd', $actualFuncCall);
    ...
    public function mutateAdGroupAdsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.AdGroupAdService/MutateAdGroupAds', $actualFuncCall);
