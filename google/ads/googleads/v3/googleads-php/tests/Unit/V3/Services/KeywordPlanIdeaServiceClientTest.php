...
use Google\Ads\GoogleAds\V3\Services\KeywordPlanIdeaServiceClient;
use Google\Ads\GoogleAds\V3\Services\GenerateKeywordIdeaResponse;
...
class KeywordPlanIdeaServiceClientTest extends GeneratedTest
{
    ...
    public function generateKeywordIdeasTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.KeywordPlanIdeaService/GenerateKeywordIdeas', $actualFuncCall);
