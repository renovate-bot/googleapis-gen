...
class KeywordPlanAdGroupServiceClientTest extends GeneratedTest
{
    ...
    public function getKeywordPlanAdGroupTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.KeywordPlanAdGroupService/GetKeywordPlanAdGroup', $actualFuncCall);
    ...
    public function mutateKeywordPlanAdGroupsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups', $actualFuncCall);
