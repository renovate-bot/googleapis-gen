...
class CampaignExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignExtensionSettingTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CampaignExtensionSettingService/GetCampaignExtensionSetting', $actualFuncCall);
    ...
    public function mutateCampaignExtensionSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CampaignExtensionSettingService/MutateCampaignExtensionSettings', $actualFuncCall);
