...
use Google\Ads\GoogleAds\V3\Resources\Label;
use Google\Ads\GoogleAds\V3\Services\MutateLabelsResponse;
...
class LabelServiceClientTest extends GeneratedTest
{
    ...
    public function getLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.LabelService/GetLabel', $actualFuncCall);
    ...
    public function mutateLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.LabelService/MutateLabels', $actualFuncCall);
