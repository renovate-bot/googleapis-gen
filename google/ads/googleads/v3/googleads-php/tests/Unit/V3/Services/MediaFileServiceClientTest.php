...
use Google\Ads\GoogleAds\V3\Services\MutateMediaFilesResponse;
...
class MediaFileServiceClientTest extends GeneratedTest
{
    ...
    public function getMediaFileTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.MediaFileService/GetMediaFile', $actualFuncCall);
    ...
    public function mutateMediaFilesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.MediaFileService/MutateMediaFiles', $actualFuncCall);
