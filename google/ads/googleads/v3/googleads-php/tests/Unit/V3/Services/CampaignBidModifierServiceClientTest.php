...
class CampaignBidModifierServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignBidModifierTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CampaignBidModifierService/GetCampaignBidModifier', $actualFuncCall);
    ...
    public function mutateCampaignBidModifiersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CampaignBidModifierService/MutateCampaignBidModifiers', $actualFuncCall);
