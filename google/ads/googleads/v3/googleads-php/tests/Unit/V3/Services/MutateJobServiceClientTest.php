...
use Google\Ads\GoogleAds\V3\Resources\MutateJob;
use Google\Ads\GoogleAds\V3\Services\AddMutateJobOperationsResponse;
use Google\Ads\GoogleAds\V3\Services\CreateMutateJobResponse;
use Google\Ads\GoogleAds\V3\Services\ListMutateJobResultsResponse;
use Google\Ads\GoogleAds\V3\Services\MutateJobResult;
 ...
 * @group gapic
 */
class MutateJobServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function createMutateJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.MutateJobService/CreateMutateJob', $actualFuncCall);
    ...
    public function getMutateJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.MutateJobService/GetMutateJob', $actualFuncCall);
    ...
    public function listMutateJobResultsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.MutateJobService/ListMutateJobResults', $actualFuncCall);
    ...
    public function runMutateJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.MutateJobService/RunMutateJob', $actualApiFuncCall);
    ...
    public function addMutateJobOperationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.MutateJobService/AddMutateJobOperations', $actualFuncCall);
