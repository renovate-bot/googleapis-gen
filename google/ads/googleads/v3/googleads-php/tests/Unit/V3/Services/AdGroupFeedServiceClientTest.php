...
class AdGroupFeedServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupFeedTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.AdGroupFeedService/GetAdGroupFeed', $actualFuncCall);
    ...
    public function mutateAdGroupFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.AdGroupFeedService/MutateAdGroupFeeds', $actualFuncCall);
