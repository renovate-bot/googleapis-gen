...
use Google\Ads\GoogleAds\V3\Resources\HotelPerformanceView;
...
class HotelPerformanceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getHotelPerformanceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.HotelPerformanceViewService/GetHotelPerformanceView', $actualFuncCall);
