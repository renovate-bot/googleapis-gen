...
class CustomerFeedServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerFeedTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CustomerFeedService/GetCustomerFeed', $actualFuncCall);
    ...
    public function mutateCustomerFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CustomerFeedService/MutateCustomerFeeds', $actualFuncCall);
