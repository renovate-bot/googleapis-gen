...
class AdServiceClientTest extends GeneratedTest
{
    ...
    public function getAdTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.AdService/GetAd', $actualFuncCall);
    ...
    public function mutateAdsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.AdService/MutateAds', $actualFuncCall);
