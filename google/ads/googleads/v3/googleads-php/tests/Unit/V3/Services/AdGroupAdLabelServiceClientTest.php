...
use Google\Ads\GoogleAds\V3\Resources\AdGroupAdLabel;
use Google\Ads\GoogleAds\V3\Services\MutateAdGroupAdLabelsResponse;
...
class AdGroupAdLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupAdLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.AdGroupAdLabelService/GetAdGroupAdLabel', $actualFuncCall);
    ...
    public function mutateAdGroupAdLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.AdGroupAdLabelService/MutateAdGroupAdLabels', $actualFuncCall);
