...
use Google\Ads\GoogleAds\V3\Resources\Recommendation;
use Google\Ads\GoogleAds\V3\Services\ApplyRecommendationResponse;
use Google\Ads\GoogleAds\V3\Services\DismissRecommendationResponse;
...
class RecommendationServiceClientTest extends GeneratedTest
{
    ...
    public function getRecommendationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.RecommendationService/GetRecommendation', $actualFuncCall);
    ...
    public function applyRecommendationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.RecommendationService/ApplyRecommendation', $actualFuncCall);
    ...
    public function dismissRecommendationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.RecommendationService/DismissRecommendation', $actualFuncCall);
