...
use Google\Ads\GoogleAds\V3\Resources\SearchTermView;
...
class SearchTermViewServiceClientTest extends GeneratedTest
{
    ...
    public function getSearchTermViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.SearchTermViewService/GetSearchTermView', $actualFuncCall);
