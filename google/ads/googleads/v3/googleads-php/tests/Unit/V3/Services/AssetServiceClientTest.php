...
use Google\Ads\GoogleAds\V3\Services\MutateAssetsResponse;
...
class AssetServiceClientTest extends GeneratedTest
{
    ...
    public function getAssetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.AssetService/GetAsset', $actualFuncCall);
    ...
    public function mutateAssetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.AssetService/MutateAssets', $actualFuncCall);
