...
class CampaignDraftServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CampaignDraftService/GetCampaignDraft', $actualFuncCall);
    ...
    public function mutateCampaignDraftsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CampaignDraftService/MutateCampaignDrafts', $actualFuncCall);
    ...
    public function listCampaignDraftAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CampaignDraftService/ListCampaignDraftAsyncErrors', $actualFuncCall);
