...
use Google\Ads\GoogleAds\V3\Services\MutateAdParametersResponse;
...
class AdParameterServiceClientTest extends GeneratedTest
{
    ...
    public function getAdParameterTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.AdParameterService/GetAdParameter', $actualFuncCall);
    ...
    public function mutateAdParametersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.AdParameterService/MutateAdParameters', $actualFuncCall);
