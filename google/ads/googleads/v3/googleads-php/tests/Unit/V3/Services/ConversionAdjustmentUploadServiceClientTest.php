...
use Google\Ads\Googleads\V3\Services\ConversionAdjustmentUploadServiceClient;
use Google\Ads\GoogleAds\V3\Services\UploadConversionAdjustmentsResponse;
...
class ConversionAdjustmentUploadServiceClientTest extends GeneratedTest
{
    ...
    public function uploadConversionAdjustmentsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.ConversionAdjustmentUploadService/UploadConversionAdjustments', $actualFuncCall);
