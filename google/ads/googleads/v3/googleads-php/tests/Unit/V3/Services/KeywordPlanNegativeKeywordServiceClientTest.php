...
use Google\Ads\GoogleAds\V3\Services\MutateKeywordPlanNegativeKeywordsResponse;
...
class KeywordPlanNegativeKeywordServiceClientTest extends GeneratedTest
{
    ...
    public function getKeywordPlanNegativeKeywordTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.KeywordPlanNegativeKeywordService/GetKeywordPlanNegativeKeyword', $actualFuncCall);
    ...
    public function mutateKeywordPlanNegativeKeywordsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.KeywordPlanNegativeKeywordService/MutateKeywordPlanNegativeKeywords', $actualFuncCall);
