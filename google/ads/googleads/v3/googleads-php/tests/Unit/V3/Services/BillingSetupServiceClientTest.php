...
use Google\Ads\GoogleAds\V3\Resources\BillingSetup;
use Google\Ads\GoogleAds\V3\Services\BillingSetupOperation;
use Google\Ads\GoogleAds\V3\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceClientTest extends GeneratedTest
{
    ...
    public function getBillingSetupTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.BillingSetupService/GetBillingSetup', $actualFuncCall);
    ...
    public function mutateBillingSetupTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.BillingSetupService/MutateBillingSetup', $actualFuncCall);
