...
class CustomerNegativeCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerNegativeCriterionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CustomerNegativeCriterionService/GetCustomerNegativeCriterion', $actualFuncCall);
    ...
    public function mutateCustomerNegativeCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria', $actualFuncCall);
