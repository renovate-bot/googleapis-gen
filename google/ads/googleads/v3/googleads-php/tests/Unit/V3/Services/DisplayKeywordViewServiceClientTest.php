...
use Google\Ads\GoogleAds\V3\Resources\DisplayKeywordView;
...
class DisplayKeywordViewServiceClientTest extends GeneratedTest
{
    ...
    public function getDisplayKeywordViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.DisplayKeywordViewService/GetDisplayKeywordView', $actualFuncCall);
