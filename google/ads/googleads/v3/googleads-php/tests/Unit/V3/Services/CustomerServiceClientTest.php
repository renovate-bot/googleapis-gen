...
class CustomerServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CustomerService/GetCustomer', $actualFuncCall);
    ...
    public function mutateCustomerTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CustomerService/MutateCustomer', $actualFuncCall);
    ...
    public function listAccessibleCustomersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CustomerService/ListAccessibleCustomers', $actualFuncCall);
    ...
    public function createCustomerClientTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CustomerService/CreateCustomerClient', $actualFuncCall);
