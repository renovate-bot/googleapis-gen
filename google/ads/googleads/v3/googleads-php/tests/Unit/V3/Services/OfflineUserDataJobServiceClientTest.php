...
class OfflineUserDataJobServiceClientTest extends GeneratedTest
{
    ...
    public function runOfflineUserDataJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.OfflineUserDataJobService/RunOfflineUserDataJob', $actualApiFuncCall);
    ...
    public function createOfflineUserDataJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.OfflineUserDataJobService/CreateOfflineUserDataJob', $actualFuncCall);
    ...
    public function getOfflineUserDataJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.OfflineUserDataJobService/GetOfflineUserDataJob', $actualFuncCall);
    ...
    public function addOfflineUserDataJobOperationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.OfflineUserDataJobService/AddOfflineUserDataJobOperations', $actualFuncCall);
