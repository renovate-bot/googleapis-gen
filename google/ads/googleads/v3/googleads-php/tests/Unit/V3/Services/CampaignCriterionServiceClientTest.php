...
use Google\Ads\GoogleAds\V3\Services\MutateCampaignCriteriaResponse;
...
class CampaignCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignCriterionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CampaignCriterionService/GetCampaignCriterion', $actualFuncCall);
    ...
    public function mutateCampaignCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CampaignCriterionService/MutateCampaignCriteria', $actualFuncCall);
