...
use Google\Ads\GoogleAds\V3\Services\MutateCampaignSharedSetsResponse;
...
class CampaignSharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignSharedSetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v3.services.CampaignSharedSetService/GetCampaignSharedSet', $actualFuncCall);
    ...
    public function mutateCampaignSharedSetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v3.services.CampaignSharedSetService/MutateCampaignSharedSets', $actualFuncCall);
