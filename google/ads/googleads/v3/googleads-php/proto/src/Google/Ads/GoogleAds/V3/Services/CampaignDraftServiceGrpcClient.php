...
class CampaignDraftServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCampaignDraft(\Google\Ads\GoogleAds\V3\Services\GetCampaignDraftRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignDraftService/GetCampaignDraft',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CampaignDraft', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCampaignDrafts(\Google\Ads\GoogleAds\V3\Services\MutateCampaignDraftsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignDraftService/MutateCampaignDrafts',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCampaignDraftsResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function PromoteCampaignDraft(\Google\Ads\GoogleAds\V3\Services\PromoteCampaignDraftRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignDraftService/PromoteCampaignDraft',
        $argument,
    ...
    public function ListCampaignDraftAsyncErrors(\Google\Ads\GoogleAds\V3\Services\ListCampaignDraftAsyncErrorsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignDraftService/ListCampaignDraftAsyncErrors',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\ListCampaignDraftAsyncErrorsResponse', 'decode'],
        $metadata, $options);
    }
