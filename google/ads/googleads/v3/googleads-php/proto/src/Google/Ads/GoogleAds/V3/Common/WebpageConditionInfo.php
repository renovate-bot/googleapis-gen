...
class WebpageConditionInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\WebpageConditionOperandEnum\WebpageConditionOperand::class);
        $this->operand = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\WebpageConditionOperatorEnum\WebpageConditionOperator::class);
        $this->operator = $var;
