 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.GetGeographicViewRequest</code>
 */
class GetGeographicViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Services\GeographicViewService::initOnce();
