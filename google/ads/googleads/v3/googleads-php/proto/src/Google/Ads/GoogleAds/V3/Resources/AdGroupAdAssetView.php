 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.AdGroupAdAssetView</code>
 */
class AdGroupAdAssetView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\AdGroupAdAssetView::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AssetFieldTypeEnum\AssetFieldType::class);
        $this->field_type = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Resources\AdGroupAdAssetPolicySummary::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AssetPerformanceLabelEnum\AssetPerformanceLabel::class);
