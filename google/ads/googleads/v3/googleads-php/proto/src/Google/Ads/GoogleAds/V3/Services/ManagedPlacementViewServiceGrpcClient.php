...
class ManagedPlacementViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetManagedPlacementView(\Google\Ads\GoogleAds\V3\Services\GetManagedPlacementViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ManagedPlacementViewService/GetManagedPlacementView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\ManagedPlacementView', 'decode'],
        $metadata, $options);
    }
