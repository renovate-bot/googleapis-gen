...
class CustomerManagerLinkServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCustomerManagerLink(\Google\Ads\GoogleAds\V3\Services\GetCustomerManagerLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomerManagerLinkService/GetCustomerManagerLink',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CustomerManagerLink', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCustomerManagerLink(\Google\Ads\GoogleAds\V3\Services\MutateCustomerManagerLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomerManagerLinkService/MutateCustomerManagerLink',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCustomerManagerLinkResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function MoveManagerLink(\Google\Ads\GoogleAds\V3\Services\MoveManagerLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomerManagerLinkService/MoveManagerLink',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MoveManagerLinkResponse', 'decode'],
        $metadata, $options);
    }
