...
class CustomerClientLinkServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCustomerClientLink(\Google\Ads\GoogleAds\V3\Services\GetCustomerClientLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomerClientLinkService/GetCustomerClientLink',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CustomerClientLink', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCustomerClientLink(\Google\Ads\GoogleAds\V3\Services\MutateCustomerClientLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomerClientLinkService/MutateCustomerClientLink',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCustomerClientLinkResponse', 'decode'],
        $metadata, $options);
    }
