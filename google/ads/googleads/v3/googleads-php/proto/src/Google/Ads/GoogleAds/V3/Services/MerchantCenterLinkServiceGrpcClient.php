...
class MerchantCenterLinkServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function ListMerchantCenterLinks(\Google\Ads\GoogleAds\V3\Services\ListMerchantCenterLinksRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MerchantCenterLinkService/ListMerchantCenterLinks',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\ListMerchantCenterLinksResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function GetMerchantCenterLink(\Google\Ads\GoogleAds\V3\Services\GetMerchantCenterLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MerchantCenterLinkService/GetMerchantCenterLink',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\MerchantCenterLink', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateMerchantCenterLink(\Google\Ads\GoogleAds\V3\Services\MutateMerchantCenterLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MerchantCenterLinkService/MutateMerchantCenterLink',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateMerchantCenterLinkResponse', 'decode'],
        $metadata, $options);
    }
