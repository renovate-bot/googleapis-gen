 ...
 * MutateJob result.
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.MutateJobResult</code>
 */
class MutateJobResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.MutateOperationResponse mutate_operation_response = 2;</code>
     */
     ...
     *           Index of the mutate operation.
     *     @type \Google\Ads\GoogleAds\V3\Services\MutateOperationResponse $mutate_operation_response
     *           Response for the mutate.
     *           May be empty if errors occurred.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.MutateOperationResponse mutate_operation_response = 2;</code>
     * @param \Google\Ads\GoogleAds\V3\Services\MutateOperationResponse $var
     * @return $this
     */
    public function setMutateOperationResponse($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Services\MutateOperationResponse::class);
