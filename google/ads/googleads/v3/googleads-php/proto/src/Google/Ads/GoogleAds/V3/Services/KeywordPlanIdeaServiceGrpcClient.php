...
class KeywordPlanIdeaServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GenerateKeywordIdeas(\Google\Ads\GoogleAds\V3\Services\GenerateKeywordIdeasRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.KeywordPlanIdeaService/GenerateKeywordIdeas',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\GenerateKeywordIdeaResponse', 'decode'],
        $metadata, $options);
    }
