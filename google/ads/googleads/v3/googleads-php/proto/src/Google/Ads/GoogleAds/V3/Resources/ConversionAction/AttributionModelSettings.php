...
namespace Google\Ads\GoogleAds\V3\Resources\ConversionAction;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.ConversionAction.AttributionModelSettings</code>
 */
class AttributionModelSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.AttributionModelEnum.AttributionModel attribution_model = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AttributionModelEnum\AttributionModel::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\DataDrivenModelStatusEnum\DataDrivenModelStatus::class);
...
class_alias(AttributionModelSettings::class, \Google\Ads\GoogleAds\V3\Resources\ConversionAction_AttributionModelSettings::class);
