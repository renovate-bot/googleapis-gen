...
namespace Google\Ads\GoogleAds\V3\Common\PolicyTopicConstraint;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.PolicyTopicConstraint.CountryConstraintList</code>
 */
class CountryConstraintList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.common.PolicyTopicConstraint.CountryConstraint countries = 2;</code>
     */
    private $countries;
     ...
     *           Total number of countries targeted by the resource.
     *     @type \Google\Ads\GoogleAds\V3\Common\PolicyTopicConstraint\CountryConstraint[]|\Google\Protobuf\Internal\RepeatedField $countries
     *           Countries in which serving is restricted.
     * }
     */
    ...
    {
        return isset($this->total_targeted_countries) ? $this->total_targeted_countries : null;
    }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.common.PolicyTopicConstraint.CountryConstraint countries = 2;</code>
     * @param \Google\Ads\GoogleAds\V3\Common\PolicyTopicConstraint\CountryConstraint[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCountries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Common\PolicyTopicConstraint\CountryConstraint::class);
        $this->countries = $arr;
...
class_alias(CountryConstraintList::class, \Google\Ads\GoogleAds\V3\Common\PolicyTopicConstraint_CountryConstraintList::class);
