...
class CampaignAudienceViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCampaignAudienceView(\Google\Ads\GoogleAds\V3\Services\GetCampaignAudienceViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignAudienceViewService/GetCampaignAudienceView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CampaignAudienceView', 'decode'],
        $metadata, $options);
    }
