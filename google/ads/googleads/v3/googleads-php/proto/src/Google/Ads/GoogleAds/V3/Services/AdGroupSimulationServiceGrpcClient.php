...
class AdGroupSimulationServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetAdGroupSimulation(\Google\Ads\GoogleAds\V3\Services\GetAdGroupSimulationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AdGroupSimulationService/GetAdGroupSimulation',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\AdGroupSimulation', 'decode'],
        $metadata, $options);
    }
