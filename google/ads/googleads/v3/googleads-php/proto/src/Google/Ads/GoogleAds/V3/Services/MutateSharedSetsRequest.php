 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.MutateSharedSetsRequest</code>
 */
class MutateSharedSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.SharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose shared sets are being modified.
     *     @type \Google\Ads\GoogleAds\V3\Services\SharedSetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual shared sets.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Services\SharedSetService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.SharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V3\Services\SharedSetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\SharedSetOperation::class);
        $this->operations = $arr;
