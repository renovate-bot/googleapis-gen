...
class BiddingStrategy extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\BiddingStrategyStatusEnum\BiddingStrategyStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\BiddingStrategyTypeEnum\BiddingStrategyType::class);
        $this->type = $var;
