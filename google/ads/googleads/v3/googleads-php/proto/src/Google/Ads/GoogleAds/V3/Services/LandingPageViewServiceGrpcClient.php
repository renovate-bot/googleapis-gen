...
class LandingPageViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetLandingPageView(\Google\Ads\GoogleAds\V3\Services\GetLandingPageViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.LandingPageViewService/GetLandingPageView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\LandingPageView', 'decode'],
        $metadata, $options);
    }
