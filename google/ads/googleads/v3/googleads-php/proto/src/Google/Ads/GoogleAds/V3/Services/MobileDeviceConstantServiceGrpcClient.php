...
class MobileDeviceConstantServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetMobileDeviceConstant(\Google\Ads\GoogleAds\V3\Services\GetMobileDeviceConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MobileDeviceConstantService/GetMobileDeviceConstant',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\MobileDeviceConstant', 'decode'],
        $metadata, $options);
    }
