...
class GroupPlacementViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetGroupPlacementView(\Google\Ads\GoogleAds\V3\Services\GetGroupPlacementViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.GroupPlacementViewService/GetGroupPlacementView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\GroupPlacementView', 'decode'],
        $metadata, $options);
    }
