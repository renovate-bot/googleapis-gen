 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.CriterionCategoryLocaleAvailability</code>
 */
class CriterionCategoryLocaleAvailability extends \Google\Protobuf\Internal\Message
{
     ...
     * be set).
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode availability_mode = 1;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Common\CriterionCategoryAvailability::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\CriterionCategoryLocaleAvailabilityModeEnum\CriterionCategoryLocaleAvailabilityMode::class);
