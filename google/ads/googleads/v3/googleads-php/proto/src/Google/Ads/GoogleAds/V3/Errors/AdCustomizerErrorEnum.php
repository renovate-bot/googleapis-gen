 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.AdCustomizerErrorEnum</code>
 */
class AdCustomizerErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Errors\AdCustomizerError::initOnce();
