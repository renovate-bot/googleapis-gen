...
class ReachPlanServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function ListPlannableLocations(\Google\Ads\GoogleAds\V3\Services\ListPlannableLocationsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ReachPlanService/ListPlannableLocations',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\ListPlannableLocationsResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function ListPlannableProducts(\Google\Ads\GoogleAds\V3\Services\ListPlannableProductsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ReachPlanService/ListPlannableProducts',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\ListPlannableProductsResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateProductMixIdeas(\Google\Ads\GoogleAds\V3\Services\GenerateProductMixIdeasRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ReachPlanService/GenerateProductMixIdeas',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\GenerateProductMixIdeasResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateReachForecast(\Google\Ads\GoogleAds\V3\Services\GenerateReachForecastRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ReachPlanService/GenerateReachForecast',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\GenerateReachForecastResponse', 'decode'],
        $metadata, $options);
    }
