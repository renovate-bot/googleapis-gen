 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.FrequencyCapTimeUnitEnum</code>
 */
class FrequencyCapTimeUnitEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Enums\FrequencyCapTimeUnit::initOnce();
