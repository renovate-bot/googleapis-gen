...
class FeedMappingServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetFeedMapping(\Google\Ads\GoogleAds\V3\Services\GetFeedMappingRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.FeedMappingService/GetFeedMapping',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\FeedMapping', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateFeedMappings(\Google\Ads\GoogleAds\V3\Services\MutateFeedMappingsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.FeedMappingService/MutateFeedMappings',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateFeedMappingsResponse', 'decode'],
        $metadata, $options);
    }
