 ...
 * conversion action.
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.ConversionAction.ValueSettings</code>
 */
class ValueSettings extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->default_currency_code) ? $this->default_currency_code : null;
    }
    ...
    {
        return isset($this->always_use_default_value) ? $this->always_use_default_value : null;
    }
...
class_alias(ValueSettings::class, \Google\Ads\GoogleAds\V3\Resources\ConversionAction_ValueSettings::class);
