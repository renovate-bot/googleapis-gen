 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.UploadCallConversionsRequest</code>
 */
class UploadCallConversionsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.CallConversion conversions = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $conversions;
    /**
     ...
     *           Required. The ID of the customer performing the upload.
     *     @type \Google\Ads\GoogleAds\V3\Services\CallConversion[]|\Google\Protobuf\Internal\RepeatedField $conversions
     *           Required. The conversions that are being uploaded.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.CallConversion conversions = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V3\Services\CallConversion[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setConversions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\CallConversion::class);
