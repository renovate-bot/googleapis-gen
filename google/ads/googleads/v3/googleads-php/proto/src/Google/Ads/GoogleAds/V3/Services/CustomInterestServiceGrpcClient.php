...
class CustomInterestServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCustomInterest(\Google\Ads\GoogleAds\V3\Services\GetCustomInterestRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomInterestService/GetCustomInterest',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CustomInterest', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCustomInterests(\Google\Ads\GoogleAds\V3\Services\MutateCustomInterestsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomInterestService/MutateCustomInterests',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCustomInterestsResponse', 'decode'],
        $metadata, $options);
    }
