...
class AdGroupBidModifierServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetAdGroupBidModifier(\Google\Ads\GoogleAds\V3\Services\GetAdGroupBidModifierRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AdGroupBidModifierService/GetAdGroupBidModifier',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\AdGroupBidModifier', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateAdGroupBidModifiers(\Google\Ads\GoogleAds\V3\Services\MutateAdGroupBidModifiersRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AdGroupBidModifierService/MutateAdGroupBidModifiers',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateAdGroupBidModifiersResponse', 'decode'],
        $metadata, $options);
    }
