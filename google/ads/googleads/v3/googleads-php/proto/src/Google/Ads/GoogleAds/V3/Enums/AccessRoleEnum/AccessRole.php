...
namespace Google\Ads\GoogleAds\V3\Enums\AccessRoleEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.enums.AccessRoleEnum.AccessRole</code>
 */
class AccessRole
{
    /**
...
class_alias(AccessRole::class, \Google\Ads\GoogleAds\V3\Enums\AccessRoleEnum_AccessRole::class);
