...
namespace Google\Ads\GoogleAds\V3\Errors\UserListErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.UserListErrorEnum.UserListError</code>
 */
class UserListError
{
    /**
...
class_alias(UserListError::class, \Google\Ads\GoogleAds\V3\Errors\UserListErrorEnum_UserListError::class);
