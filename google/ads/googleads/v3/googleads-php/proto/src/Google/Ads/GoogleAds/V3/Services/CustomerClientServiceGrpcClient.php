...
class CustomerClientServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCustomerClient(\Google\Ads\GoogleAds\V3\Services\GetCustomerClientRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomerClientService/GetCustomerClient',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CustomerClient', 'decode'],
        $metadata, $options);
    }
