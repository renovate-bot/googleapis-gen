...
class HotelPerformanceViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetHotelPerformanceView(\Google\Ads\GoogleAds\V3\Services\GetHotelPerformanceViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.HotelPerformanceViewService/GetHotelPerformanceView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\HotelPerformanceView', 'decode'],
        $metadata, $options);
    }
