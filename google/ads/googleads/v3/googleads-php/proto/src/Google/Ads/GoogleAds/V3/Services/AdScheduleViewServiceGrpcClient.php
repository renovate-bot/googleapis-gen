...
class AdScheduleViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetAdScheduleView(\Google\Ads\GoogleAds\V3\Services\GetAdScheduleViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AdScheduleViewService/GetAdScheduleView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\AdScheduleView', 'decode'],
        $metadata, $options);
    }
