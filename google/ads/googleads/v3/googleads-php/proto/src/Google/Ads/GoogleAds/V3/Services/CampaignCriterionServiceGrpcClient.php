...
class CampaignCriterionServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCampaignCriterion(\Google\Ads\GoogleAds\V3\Services\GetCampaignCriterionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignCriterionService/GetCampaignCriterion',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CampaignCriterion', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCampaignCriteria(\Google\Ads\GoogleAds\V3\Services\MutateCampaignCriteriaRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignCriterionService/MutateCampaignCriteria',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCampaignCriteriaResponse', 'decode'],
        $metadata, $options);
    }
