 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.PriceFeedItem</code>
 */
class PriceFeedItem extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.PriceExtensionTypeEnum.PriceExtensionType type = 1;</code>
     */
    protected $type = 0;
    /**
     * Price qualifier for all offers of this price extension.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier price_qualifier = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.common.PriceOffer price_offerings = 5;</code>
     */
     ...
     *           The code of the language used for this price extension.
     *     @type \Google\Ads\GoogleAds\V3\Common\PriceOffer[]|\Google\Protobuf\Internal\RepeatedField $price_offerings
     *           The price offerings in this price extension.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\PriceExtensionTypeEnum\PriceExtensionType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\PriceExtensionPriceQualifierEnum\PriceExtensionPriceQualifier::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.common.PriceOffer price_offerings = 5;</code>
     * @param \Google\Ads\GoogleAds\V3\Common\PriceOffer[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPriceOfferings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Common\PriceOffer::class);
