 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.Recommendation.RecommendationImpact</code>
 */
class RecommendationImpact extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.resources.Recommendation.RecommendationMetrics base_metrics = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $base_metrics = null;
    /**
     * Output only. Estimated metrics if the recommendation is applied.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.resources.Recommendation.RecommendationMetrics potential_metrics = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V3\Resources\Recommendation\RecommendationMetrics $base_metrics
     *           Output only. Base metrics at the time the recommendation was generated.
     *     @type \Google\Ads\GoogleAds\V3\Resources\Recommendation\RecommendationMetrics $potential_metrics
     *           Output only. Estimated metrics if the recommendation is applied.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.resources.Recommendation.RecommendationMetrics base_metrics = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V3\Resources\Recommendation\RecommendationMetrics $var
     * @return $this
     */
    public function setBaseMetrics($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Resources\Recommendation\RecommendationMetrics::class);
...
class_alias(RecommendationImpact::class, \Google\Ads\GoogleAds\V3\Resources\Recommendation_RecommendationImpact::class);
