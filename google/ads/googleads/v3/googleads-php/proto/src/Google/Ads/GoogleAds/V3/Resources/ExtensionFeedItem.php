...
class ExtensionFeedItem extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\FeedItemTargetDeviceEnum\FeedItemTargetDevice::class);
        $this->device = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\FeedItemStatusEnum\FeedItemStatus::class);
        $this->status = $var;
