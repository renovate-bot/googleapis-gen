 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.CampaignBudgetErrorEnum</code>
 */
class CampaignBudgetErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Errors\CampaignBudgetError::initOnce();
