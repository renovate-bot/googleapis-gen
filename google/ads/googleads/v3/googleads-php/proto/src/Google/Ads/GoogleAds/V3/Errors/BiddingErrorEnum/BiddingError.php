...
namespace Google\Ads\GoogleAds\V3\Errors\BiddingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.BiddingErrorEnum.BiddingError</code>
 */
class BiddingError
{
    /**
...
class_alias(BiddingError::class, \Google\Ads\GoogleAds\V3\Errors\BiddingErrorEnum_BiddingError::class);
