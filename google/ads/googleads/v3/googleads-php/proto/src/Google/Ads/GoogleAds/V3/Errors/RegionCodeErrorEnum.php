 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.RegionCodeErrorEnum</code>
 */
class RegionCodeErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Errors\RegionCodeError::initOnce();
