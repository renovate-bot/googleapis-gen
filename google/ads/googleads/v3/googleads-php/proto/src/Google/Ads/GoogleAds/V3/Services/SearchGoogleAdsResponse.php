 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.SearchGoogleAdsResponse</code>
 */
class SearchGoogleAdsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.GoogleAdsRow results = 1;</code>
     */
    private $results;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.GoogleAdsRow summary_row = 6;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V3\Services\GoogleAdsRow[]|\Google\Protobuf\Internal\RepeatedField $results
     *           The list of rows that matched the query.
     ...
     *           FieldMask that represents what fields were requested by the user.
     *     @type \Google\Ads\GoogleAds\V3\Services\GoogleAdsRow $summary_row
     *           Summary row that contains summary of metrics in results.
     *           Summary of metrics means aggregation of metrics across all results,
     *           here aggregation could be sum, average, rate, etc.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.GoogleAdsRow results = 1;</code>
     * @param \Google\Ads\GoogleAds\V3\Services\GoogleAdsRow[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\GoogleAdsRow::class);
        $this->results = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.GoogleAdsRow summary_row = 6;</code>
     * @param \Google\Ads\GoogleAds\V3\Services\GoogleAdsRow $var
     * @return $this
     */
    public function setSummaryRow($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Services\GoogleAdsRow::class);
