...
class GeographicViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetGeographicView(\Google\Ads\GoogleAds\V3\Services\GetGeographicViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.GeographicViewService/GetGeographicView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\GeographicView', 'decode'],
        $metadata, $options);
    }
