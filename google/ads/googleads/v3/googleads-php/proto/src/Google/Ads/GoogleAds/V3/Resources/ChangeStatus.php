 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.ChangeStatus</code>
 */
class ChangeStatus extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\ChangeStatus::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\ChangeStatusResourceTypeEnum\ChangeStatusResourceType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\ChangeStatusOperationEnum\ChangeStatusOperation::class);
