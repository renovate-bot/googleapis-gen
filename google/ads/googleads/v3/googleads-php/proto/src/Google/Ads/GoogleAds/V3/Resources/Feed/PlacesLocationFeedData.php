 ...
 * Locations.
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.Feed.PlacesLocationFeedData</code>
 */
class PlacesLocationFeedData extends \Google\Protobuf\Internal\Message
{
     ...
     * are not selectable.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.resources.Feed.PlacesLocationFeedData.OAuthInfo oauth_info = 1 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V3\Resources\Feed\PlacesLocationFeedData\OAuthInfo $oauth_info
     *           Immutable. Required authentication token (from OAuth API) for the email.
     *           This field can only be specified in a create request. All its subfields
     *           are not selectable.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.resources.Feed.PlacesLocationFeedData.OAuthInfo oauth_info = 1 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V3\Resources\Feed\PlacesLocationFeedData\OAuthInfo $var
     * @return $this
     */
    public function setOauthInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Resources\Feed\PlacesLocationFeedData\OAuthInfo::class);
        $this->oauth_info = $var;
...
class_alias(PlacesLocationFeedData::class, \Google\Ads\GoogleAds\V3\Resources\Feed_PlacesLocationFeedData::class);
