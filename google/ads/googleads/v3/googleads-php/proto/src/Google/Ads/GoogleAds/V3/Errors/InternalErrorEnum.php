 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.InternalErrorEnum</code>
 */
class InternalErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Errors\InternalError::initOnce();
