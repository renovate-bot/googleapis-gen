...
class MobileAppCategoryConstantServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetMobileAppCategoryConstant(\Google\Ads\GoogleAds\V3\Services\GetMobileAppCategoryConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MobileAppCategoryConstantService/GetMobileAppCategoryConstant',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\MobileAppCategoryConstant', 'decode'],
        $metadata, $options);
    }
