...
namespace Google\Ads\GoogleAds\V3\Errors\AdGroupErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.AdGroupErrorEnum.AdGroupError</code>
 */
class AdGroupError
{
    /**
...
class_alias(AdGroupError::class, \Google\Ads\GoogleAds\V3\Errors\AdGroupErrorEnum_AdGroupError::class);
