 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.MutateAdGroupAdLabelsRequest</code>
 */
class MutateAdGroupAdLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.AdGroupAdLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose ad group ad labels are being modified.
     *     @type \Google\Ads\GoogleAds\V3\Services\AdGroupAdLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on ad group ad labels.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.AdGroupAdLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V3\Services\AdGroupAdLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\AdGroupAdLabelOperation::class);
        $this->operations = $arr;
