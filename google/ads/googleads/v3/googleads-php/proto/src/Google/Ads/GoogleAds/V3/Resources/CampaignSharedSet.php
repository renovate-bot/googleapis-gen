 ...
 * campaign.
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.CampaignSharedSet</code>
 */
class CampaignSharedSet extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\CampaignSharedSet::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\CampaignSharedSetStatusEnum\CampaignSharedSetStatus::class);
        $this->status = $var;
