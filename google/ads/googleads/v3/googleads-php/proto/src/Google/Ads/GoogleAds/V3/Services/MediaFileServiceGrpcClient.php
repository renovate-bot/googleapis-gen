...
class MediaFileServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetMediaFile(\Google\Ads\GoogleAds\V3\Services\GetMediaFileRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MediaFileService/GetMediaFile',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\MediaFile', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateMediaFiles(\Google\Ads\GoogleAds\V3\Services\MutateMediaFilesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MediaFileService/MutateMediaFiles',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateMediaFilesResponse', 'decode'],
        $metadata, $options);
    }
