 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.SuggestGeoTargetConstantsRequest</code>
 */
class SuggestGeoTargetConstantsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Returned geo targets are restricted to this country code.
     *     @type \Google\Ads\GoogleAds\V3\Services\SuggestGeoTargetConstantsRequest\LocationNames $location_names
     *           The location names to search by. At most 25 names can be set.
     *     @type \Google\Ads\GoogleAds\V3\Services\SuggestGeoTargetConstantsRequest\GeoTargets $geo_targets
     ...
     * The location names to search by. At most 25 names can be set.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.SuggestGeoTargetConstantsRequest.LocationNames location_names = 1;</code>
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.SuggestGeoTargetConstantsRequest.LocationNames location_names = 1;</code>
     * @param \Google\Ads\GoogleAds\V3\Services\SuggestGeoTargetConstantsRequest\LocationNames $var
     * @return $this
     */
    public function setLocationNames($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Services\SuggestGeoTargetConstantsRequest\LocationNames::class);
     ...
     * The geo target constant resource names to filter by.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.SuggestGeoTargetConstantsRequest.GeoTargets geo_targets = 2;</code>
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.SuggestGeoTargetConstantsRequest.GeoTargets geo_targets = 2;</code>
     * @param \Google\Ads\GoogleAds\V3\Services\SuggestGeoTargetConstantsRequest\GeoTargets $var
     * @return $this
     */
    public function setGeoTargets($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Services\SuggestGeoTargetConstantsRequest\GeoTargets::class);
