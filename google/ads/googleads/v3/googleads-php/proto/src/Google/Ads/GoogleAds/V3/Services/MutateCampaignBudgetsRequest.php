 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.MutateCampaignBudgetsRequest</code>
 */
class MutateCampaignBudgetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.CampaignBudgetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose campaign budgets are being modified.
     *     @type \Google\Ads\GoogleAds\V3\Services\CampaignBudgetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign budgets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.CampaignBudgetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V3\Services\CampaignBudgetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\CampaignBudgetOperation::class);
        $this->operations = $arr;
