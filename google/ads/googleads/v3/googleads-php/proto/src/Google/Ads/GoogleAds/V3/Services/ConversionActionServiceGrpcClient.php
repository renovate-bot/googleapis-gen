...
class ConversionActionServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetConversionAction(\Google\Ads\GoogleAds\V3\Services\GetConversionActionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ConversionActionService/GetConversionAction',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\ConversionAction', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateConversionActions(\Google\Ads\GoogleAds\V3\Services\MutateConversionActionsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ConversionActionService/MutateConversionActions',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateConversionActionsResponse', 'decode'],
        $metadata, $options);
    }
