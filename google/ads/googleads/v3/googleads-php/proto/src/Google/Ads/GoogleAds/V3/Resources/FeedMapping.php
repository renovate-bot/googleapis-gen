...
class FeedMapping extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\FeedMappingStatusEnum\FeedMappingStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\FeedMappingCriterionTypeEnum\FeedMappingCriterionType::class);
