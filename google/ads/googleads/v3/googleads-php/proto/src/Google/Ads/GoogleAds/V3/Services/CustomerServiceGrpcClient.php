...
class CustomerServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCustomer(\Google\Ads\GoogleAds\V3\Services\GetCustomerRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomerService/GetCustomer',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\Customer', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCustomer(\Google\Ads\GoogleAds\V3\Services\MutateCustomerRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomerService/MutateCustomer',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCustomerResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function ListAccessibleCustomers(\Google\Ads\GoogleAds\V3\Services\ListAccessibleCustomersRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomerService/ListAccessibleCustomers',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\ListAccessibleCustomersResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function CreateCustomerClient(\Google\Ads\GoogleAds\V3\Services\CreateCustomerClientRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CustomerService/CreateCustomerClient',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\CreateCustomerClientResponse', 'decode'],
        $metadata, $options);
    }
