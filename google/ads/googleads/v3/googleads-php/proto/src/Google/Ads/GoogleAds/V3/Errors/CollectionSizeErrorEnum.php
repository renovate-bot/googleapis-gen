 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.CollectionSizeErrorEnum</code>
 */
class CollectionSizeErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Errors\CollectionSizeError::initOnce();
