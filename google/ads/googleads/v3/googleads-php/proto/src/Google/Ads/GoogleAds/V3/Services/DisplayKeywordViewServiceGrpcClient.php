...
class DisplayKeywordViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetDisplayKeywordView(\Google\Ads\GoogleAds\V3\Services\GetDisplayKeywordViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.DisplayKeywordViewService/GetDisplayKeywordView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\DisplayKeywordView', 'decode'],
        $metadata, $options);
    }
