 ...
 * of a feed item.
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.FeedItemQualityDisapprovalReasonEnum</code>
 */
class FeedItemQualityDisapprovalReasonEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Enums\FeedItemQualityDisapprovalReason::initOnce();
