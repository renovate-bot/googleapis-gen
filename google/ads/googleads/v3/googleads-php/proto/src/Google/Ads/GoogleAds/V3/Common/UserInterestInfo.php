 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.UserInterestInfo</code>
 */
class UserInterestInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->user_interest_category) ? $this->user_interest_category : null;
    }
