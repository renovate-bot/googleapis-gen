 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.GenerateProductMixIdeasRequest</code>
 */
class GenerateProductMixIdeasRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.Preferences preferences = 5;</code>
     */
     ...
     *           Required. Total budget.
     *           Amount in micros. One million is equivalent to one unit.
     *     @type \Google\Ads\GoogleAds\V3\Services\Preferences $preferences
     *           The preferences of the suggested product mix.
     *           An unset preference is interpreted as all possible values are allowed,
     *           unless explicitly specified.
     * }
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.Preferences preferences = 5;</code>
     * @param \Google\Ads\GoogleAds\V3\Services\Preferences $var
     * @return $this
     */
    public function setPreferences($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Services\Preferences::class);
