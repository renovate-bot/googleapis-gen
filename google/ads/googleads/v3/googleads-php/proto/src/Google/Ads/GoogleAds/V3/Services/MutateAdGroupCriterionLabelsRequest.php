 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.MutateAdGroupCriterionLabelsRequest</code>
 */
class MutateAdGroupCriterionLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.AdGroupCriterionLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose ad group criterion labels are being modified.
     *     @type \Google\Ads\GoogleAds\V3\Services\AdGroupCriterionLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on ad group criterion labels.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.AdGroupCriterionLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V3\Services\AdGroupCriterionLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\AdGroupCriterionLabelOperation::class);
        $this->operations = $arr;
