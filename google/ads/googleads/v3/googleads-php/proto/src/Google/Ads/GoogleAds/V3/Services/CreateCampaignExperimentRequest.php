 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.CreateCampaignExperimentRequest</code>
 */
class CreateCampaignExperimentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.resources.CampaignExperiment campaign_experiment = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The ID of the customer whose campaign experiment is being created.
     *     @type \Google\Ads\GoogleAds\V3\Resources\CampaignExperiment $campaign_experiment
     *           Required. The campaign experiment to be created.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.resources.CampaignExperiment campaign_experiment = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V3\Resources\CampaignExperiment $var
     * @return $this
     */
    public function setCampaignExperiment($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Resources\CampaignExperiment::class);
