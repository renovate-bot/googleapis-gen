 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.VanityPharmaTextEnum</code>
 */
class VanityPharmaTextEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Enums\VanityPharmaText::initOnce();
