 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.Asset</code>
 */
class Asset extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\Asset::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AssetTypeEnum\AssetType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\YoutubeVideoAsset::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\MediaBundleAsset::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\ImageAsset::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\TextAsset::class);
