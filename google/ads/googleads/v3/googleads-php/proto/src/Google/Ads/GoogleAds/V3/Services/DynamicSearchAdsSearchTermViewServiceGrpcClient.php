...
class DynamicSearchAdsSearchTermViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetDynamicSearchAdsSearchTermView(\Google\Ads\GoogleAds\V3\Services\GetDynamicSearchAdsSearchTermViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.DynamicSearchAdsSearchTermViewService/GetDynamicSearchAdsSearchTermView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\DynamicSearchAdsSearchTermView', 'decode'],
        $metadata, $options);
    }
