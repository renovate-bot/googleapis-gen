 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.ProductCustomAttributeInfo</code>
 */
class ProductCustomAttributeInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.ProductCustomAttributeIndexEnum.ProductCustomAttributeIndex index = 2;</code>
     */
    protected $index = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\ProductCustomAttributeIndexEnum\ProductCustomAttributeIndex::class);
        $this->index = $var;
