...
class PaidOrganicSearchTermViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetPaidOrganicSearchTermView(\Google\Ads\GoogleAds\V3\Services\GetPaidOrganicSearchTermViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.PaidOrganicSearchTermViewService/GetPaidOrganicSearchTermView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\PaidOrganicSearchTermView', 'decode'],
        $metadata, $options);
    }
