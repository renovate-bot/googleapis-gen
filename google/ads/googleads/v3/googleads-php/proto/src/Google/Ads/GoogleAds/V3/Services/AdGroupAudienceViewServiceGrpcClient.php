...
class AdGroupAudienceViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetAdGroupAudienceView(\Google\Ads\GoogleAds\V3\Services\GetAdGroupAudienceViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AdGroupAudienceViewService/GetAdGroupAudienceView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\AdGroupAudienceView', 'decode'],
        $metadata, $options);
    }
