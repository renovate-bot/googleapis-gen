...
class SearchTermViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetSearchTermView(\Google\Ads\GoogleAds\V3\Services\GetSearchTermViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.SearchTermViewService/GetSearchTermView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\SearchTermView', 'decode'],
        $metadata, $options);
    }
