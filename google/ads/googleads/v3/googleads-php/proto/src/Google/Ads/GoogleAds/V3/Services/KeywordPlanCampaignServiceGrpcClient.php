...
class KeywordPlanCampaignServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetKeywordPlanCampaign(\Google\Ads\GoogleAds\V3\Services\GetKeywordPlanCampaignRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.KeywordPlanCampaignService/GetKeywordPlanCampaign',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\KeywordPlanCampaign', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateKeywordPlanCampaigns(\Google\Ads\GoogleAds\V3\Services\MutateKeywordPlanCampaignsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.KeywordPlanCampaignService/MutateKeywordPlanCampaigns',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateKeywordPlanCampaignsResponse', 'decode'],
        $metadata, $options);
    }
