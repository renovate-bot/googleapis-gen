 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.ListingGroupInfo</code>
 */
class ListingGroupInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.ListingGroupTypeEnum.ListingGroupType type = 1;</code>
     */
    protected $type = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.common.ListingDimensionInfo case_value = 2;</code>
     */
     ...
     *     @type int $type
     *           Type of the listing group.
     *     @type \Google\Ads\GoogleAds\V3\Common\ListingDimensionInfo $case_value
     *           Dimension value with which this listing group is refining its parent.
     *           Undefined for the root group.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\ListingGroupTypeEnum\ListingGroupType::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.common.ListingDimensionInfo case_value = 2;</code>
     * @param \Google\Ads\GoogleAds\V3\Common\ListingDimensionInfo $var
     * @return $this
     */
    public function setCaseValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\ListingDimensionInfo::class);
        $this->case_value = $var;
    ...
    {
        return isset($this->parent_ad_group_criterion) ? $this->parent_ad_group_criterion : null;
    }
