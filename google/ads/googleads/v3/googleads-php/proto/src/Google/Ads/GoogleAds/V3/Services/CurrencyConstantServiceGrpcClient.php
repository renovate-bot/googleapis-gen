...
class CurrencyConstantServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCurrencyConstant(\Google\Ads\GoogleAds\V3\Services\GetCurrencyConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CurrencyConstantService/GetCurrencyConstant',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CurrencyConstant', 'decode'],
        $metadata, $options);
    }
