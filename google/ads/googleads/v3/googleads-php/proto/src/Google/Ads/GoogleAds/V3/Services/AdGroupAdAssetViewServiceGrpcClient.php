...
class AdGroupAdAssetViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetAdGroupAdAssetView(\Google\Ads\GoogleAds\V3\Services\GetAdGroupAdAssetViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AdGroupAdAssetViewService/GetAdGroupAdAssetView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\AdGroupAdAssetView', 'decode'],
        $metadata, $options);
    }
