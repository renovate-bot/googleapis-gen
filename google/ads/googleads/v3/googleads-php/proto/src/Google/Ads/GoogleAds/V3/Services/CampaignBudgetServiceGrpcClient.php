...
class CampaignBudgetServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCampaignBudget(\Google\Ads\GoogleAds\V3\Services\GetCampaignBudgetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignBudgetService/GetCampaignBudget',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CampaignBudget', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCampaignBudgets(\Google\Ads\GoogleAds\V3\Services\MutateCampaignBudgetsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignBudgetService/MutateCampaignBudgets',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCampaignBudgetsResponse', 'decode'],
        $metadata, $options);
    }
