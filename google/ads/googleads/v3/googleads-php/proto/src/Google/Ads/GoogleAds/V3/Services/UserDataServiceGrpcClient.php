...
class UserDataServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function UploadUserData(\Google\Ads\GoogleAds\V3\Services\UploadUserDataRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.UserDataService/UploadUserData',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\UploadUserDataResponse', 'decode'],
        $metadata, $options);
    }
