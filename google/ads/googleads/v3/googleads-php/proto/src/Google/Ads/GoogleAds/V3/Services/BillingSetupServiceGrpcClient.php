...
class BillingSetupServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetBillingSetup(\Google\Ads\GoogleAds\V3\Services\GetBillingSetupRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.BillingSetupService/GetBillingSetup',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\BillingSetup', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateBillingSetup(\Google\Ads\GoogleAds\V3\Services\MutateBillingSetupRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.BillingSetupService/MutateBillingSetup',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateBillingSetupResponse', 'decode'],
        $metadata, $options);
    }
