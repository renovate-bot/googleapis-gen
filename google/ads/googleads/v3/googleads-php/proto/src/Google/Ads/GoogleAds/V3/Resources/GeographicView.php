 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.GeographicView</code>
 */
class GeographicView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\GeographicView::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\GeoTargetingTypeEnum\GeoTargetingType::class);
