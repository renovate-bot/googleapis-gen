 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.CampaignCriterionSimulation</code>
 */
class CampaignCriterionSimulation extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. Last day on which the simulation is based, in YYYY-MM-DD format.
     *     @type \Google\Ads\GoogleAds\V3\Common\BidModifierSimulationPointList $bid_modifier_point_list
     *           Output only. Simulation points if the simulation type is BID_MODIFIER.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\CampaignCriterionSimulation::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\SimulationTypeEnum\SimulationType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\SimulationModificationMethodEnum\SimulationModificationMethod::class);
     ...
     * Output only. Simulation points if the simulation type is BID_MODIFIER.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.common.BidModifierSimulationPointList bid_modifier_point_list = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.common.BidModifierSimulationPointList bid_modifier_point_list = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V3\Common\BidModifierSimulationPointList $var
     * @return $this
     */
    public function setBidModifierPointList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\BidModifierSimulationPointList::class);
