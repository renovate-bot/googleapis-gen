...
class PolicyTopicConstraint extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\PolicyTopicConstraint\CountryConstraintList::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\PolicyTopicConstraint\ResellerConstraint::class);
