 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.AdGroupCriterion</code>
 */
class AdGroupCriterion extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.AdGroupCriterionStatusEnum.AdGroupCriterionStatus status = 3;</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.common.CustomParameter url_custom_parameters = 14;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\AdGroupCriterion::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AdGroupCriterionStatusEnum\AdGroupCriterionStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Resources\AdGroupCriterion\QualityInfo::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\CriterionTypeEnum\CriterionType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\CriterionSystemServingStatusEnum\CriterionSystemServingStatus::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AdGroupCriterionApprovalStatusEnum\AdGroupCriterionApprovalStatus::class);
    ...
    {
        return isset($this->cpm_bid_micros) ? $this->cpm_bid_micros : null;
    }
    ...
    {
        return isset($this->cpv_bid_micros) ? $this->cpv_bid_micros : null;
    }
    ...
    {
        return isset($this->percent_cpc_bid_micros) ? $this->percent_cpc_bid_micros : null;
    }
    ...
    {
        return isset($this->effective_cpc_bid_micros) ? $this->effective_cpc_bid_micros : null;
    }
    ...
    {
        return isset($this->effective_cpm_bid_micros) ? $this->effective_cpm_bid_micros : null;
    }
    ...
    {
        return isset($this->effective_cpv_bid_micros) ? $this->effective_cpv_bid_micros : null;
    }
    ...
    {
        return isset($this->effective_percent_cpc_bid_micros) ? $this->effective_percent_cpc_bid_micros : null;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\BiddingSourceEnum\BiddingSource::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Resources\AdGroupCriterion\PositionEstimates::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\ListingGroupInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\AgeRangeInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\GenderInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\IncomeRangeInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\ParentalStatusInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\UserListInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\TopicInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\UserInterestInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\WebpageInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\AppPaymentModelInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\CustomAffinityInfo::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Common\CustomIntentInfo::class);
