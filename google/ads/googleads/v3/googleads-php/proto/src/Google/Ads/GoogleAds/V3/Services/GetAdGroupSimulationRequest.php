 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.GetAdGroupSimulationRequest</code>
 */
class GetAdGroupSimulationRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Services\AdGroupSimulationService::initOnce();
