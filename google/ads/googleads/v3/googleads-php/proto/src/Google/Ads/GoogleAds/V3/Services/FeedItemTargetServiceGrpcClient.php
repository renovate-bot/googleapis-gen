...
class FeedItemTargetServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetFeedItemTarget(\Google\Ads\GoogleAds\V3\Services\GetFeedItemTargetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.FeedItemTargetService/GetFeedItemTarget',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\FeedItemTarget', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateFeedItemTargets(\Google\Ads\GoogleAds\V3\Services\MutateFeedItemTargetsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.FeedItemTargetService/MutateFeedItemTargets',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateFeedItemTargetsResponse', 'decode'],
        $metadata, $options);
    }
