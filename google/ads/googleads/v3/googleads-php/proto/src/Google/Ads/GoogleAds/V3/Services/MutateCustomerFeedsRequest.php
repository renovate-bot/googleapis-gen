 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.MutateCustomerFeedsRequest</code>
 */
class MutateCustomerFeedsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.CustomerFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose customer feeds are being modified.
     *     @type \Google\Ads\GoogleAds\V3\Services\CustomerFeedOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual customer feeds.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.CustomerFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V3\Services\CustomerFeedOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\CustomerFeedOperation::class);
        $this->operations = $arr;
