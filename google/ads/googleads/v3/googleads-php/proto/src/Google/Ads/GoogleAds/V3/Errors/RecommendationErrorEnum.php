 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.RecommendationErrorEnum</code>
 */
class RecommendationErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Errors\RecommendationError::initOnce();
