 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.CustomerClient</code>
 */
class CustomerClient extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\CustomerClient::initOnce();
