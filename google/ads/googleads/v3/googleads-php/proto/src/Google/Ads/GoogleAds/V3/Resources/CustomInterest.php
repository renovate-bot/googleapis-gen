...
class CustomInterest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\CustomInterestStatusEnum\CustomInterestStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\CustomInterestTypeEnum\CustomInterestType::class);
        $this->type = $var;
