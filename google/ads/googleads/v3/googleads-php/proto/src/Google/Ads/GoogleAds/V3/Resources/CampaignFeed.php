 ...
 * A campaign feed.
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.CampaignFeed</code>
 */
class CampaignFeed extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\CampaignFeed::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\FeedLinkStatusEnum\FeedLinkStatus::class);
        $this->status = $var;
