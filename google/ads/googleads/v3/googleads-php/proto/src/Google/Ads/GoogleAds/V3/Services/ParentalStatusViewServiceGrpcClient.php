...
class ParentalStatusViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetParentalStatusView(\Google\Ads\GoogleAds\V3\Services\GetParentalStatusViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ParentalStatusViewService/GetParentalStatusView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\ParentalStatusView', 'decode'],
        $metadata, $options);
    }
