 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.Campaign.AppCampaignSetting</code>
 */
class AppCampaignSetting extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType bidding_strategy_goal_type = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AppCampaignBiddingStrategyGoalTypeEnum\AppCampaignBiddingStrategyGoalType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\AppCampaignAppStoreEnum\AppCampaignAppStore::class);
        $this->app_store = $var;
...
class_alias(AppCampaignSetting::class, \Google\Ads\GoogleAds\V3\Resources\Campaign_AppCampaignSetting::class);
