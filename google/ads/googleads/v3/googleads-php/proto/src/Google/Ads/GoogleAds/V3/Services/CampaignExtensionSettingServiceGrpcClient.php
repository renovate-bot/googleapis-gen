...
class CampaignExtensionSettingServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCampaignExtensionSetting(\Google\Ads\GoogleAds\V3\Services\GetCampaignExtensionSettingRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignExtensionSettingService/GetCampaignExtensionSetting',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CampaignExtensionSetting', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCampaignExtensionSettings(\Google\Ads\GoogleAds\V3\Services\MutateCampaignExtensionSettingsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignExtensionSettingService/MutateCampaignExtensionSettings',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCampaignExtensionSettingsResponse', 'decode'],
        $metadata, $options);
    }
