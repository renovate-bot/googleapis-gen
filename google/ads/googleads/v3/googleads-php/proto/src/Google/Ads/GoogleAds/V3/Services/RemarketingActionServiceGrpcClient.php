...
class RemarketingActionServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetRemarketingAction(\Google\Ads\GoogleAds\V3\Services\GetRemarketingActionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.RemarketingActionService/GetRemarketingAction',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\RemarketingAction', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateRemarketingActions(\Google\Ads\GoogleAds\V3\Services\MutateRemarketingActionsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.RemarketingActionService/MutateRemarketingActions',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateRemarketingActionsResponse', 'decode'],
        $metadata, $options);
    }
