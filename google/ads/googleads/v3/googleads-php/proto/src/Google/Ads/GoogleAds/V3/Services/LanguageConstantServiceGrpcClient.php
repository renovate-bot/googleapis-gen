...
class LanguageConstantServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetLanguageConstant(\Google\Ads\GoogleAds\V3\Services\GetLanguageConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.LanguageConstantService/GetLanguageConstant',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\LanguageConstant', 'decode'],
        $metadata, $options);
    }
