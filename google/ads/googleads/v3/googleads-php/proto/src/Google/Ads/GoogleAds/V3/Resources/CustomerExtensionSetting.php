 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.CustomerExtensionSetting</code>
 */
class CustomerExtensionSetting extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.enums.ExtensionSettingDeviceEnum.ExtensionSettingDevice device = 4;</code>
     */
    protected $device = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\CustomerExtensionSetting::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\ExtensionTypeEnum\ExtensionType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\ExtensionSettingDeviceEnum\ExtensionSettingDevice::class);
        $this->device = $var;
