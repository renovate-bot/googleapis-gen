...
class TagSnippet extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\TrackingCodeTypeEnum\TrackingCodeType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\TrackingCodePageFormatEnum\TrackingCodePageFormat::class);
