 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.FeedPlaceholderView</code>
 */
class FeedPlaceholderView extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\FeedPlaceholderView::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\PlaceholderTypeEnum\PlaceholderType::class);
