 ...
 * campaigns.
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.SharedSet</code>
 */
class SharedSet extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\SharedSet::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\SharedSetTypeEnum\SharedSetType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\SharedSetStatusEnum\SharedSetStatus::class);
        $this->status = $var;
