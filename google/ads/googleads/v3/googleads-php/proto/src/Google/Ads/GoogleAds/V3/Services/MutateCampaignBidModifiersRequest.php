 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.MutateCampaignBidModifiersRequest</code>
 */
class MutateCampaignBidModifiersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.CampaignBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose campaign bid modifiers are being modified.
     *     @type \Google\Ads\GoogleAds\V3\Services\CampaignBidModifierOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign bid modifiers.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.CampaignBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V3\Services\CampaignBidModifierOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\CampaignBidModifierOperation::class);
        $this->operations = $arr;
