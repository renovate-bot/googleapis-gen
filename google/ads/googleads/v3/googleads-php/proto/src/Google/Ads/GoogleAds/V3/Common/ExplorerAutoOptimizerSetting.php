 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.ExplorerAutoOptimizerSetting</code>
 */
class ExplorerAutoOptimizerSetting extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Common\ExplorerAutoOptimizerSetting::initOnce();
