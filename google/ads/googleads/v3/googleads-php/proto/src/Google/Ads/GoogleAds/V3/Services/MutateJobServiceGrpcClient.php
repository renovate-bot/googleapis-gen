...
class MutateJobServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function CreateMutateJob(\Google\Ads\GoogleAds\V3\Services\CreateMutateJobRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MutateJobService/CreateMutateJob',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\CreateMutateJobResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function GetMutateJob(\Google\Ads\GoogleAds\V3\Services\GetMutateJobRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MutateJobService/GetMutateJob',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\MutateJob', 'decode'],
        $metadata, $options);
    }
    ...
    public function ListMutateJobResults(\Google\Ads\GoogleAds\V3\Services\ListMutateJobResultsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MutateJobService/ListMutateJobResults',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\ListMutateJobResultsResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function RunMutateJob(\Google\Ads\GoogleAds\V3\Services\RunMutateJobRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MutateJobService/RunMutateJob',
        $argument,
    ...
    public function AddMutateJobOperations(\Google\Ads\GoogleAds\V3\Services\AddMutateJobOperationsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.MutateJobService/AddMutateJobOperations',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\AddMutateJobOperationsResponse', 'decode'],
        $metadata, $options);
    }
