...
class FeedItemTarget extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\FeedItemTargetTypeEnum\FeedItemTargetType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\FeedItemTargetStatusEnum\FeedItemTargetStatus::class);
        $this->status = $var;
