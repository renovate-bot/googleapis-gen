...
namespace Google\Ads\GoogleAds\V3\Errors\AssetErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v3.errors.AssetErrorEnum.AssetError</code>
 */
class AssetError
{
    /**
...
class_alias(AssetError::class, \Google\Ads\GoogleAds\V3\Errors\AssetErrorEnum_AssetError::class);
