 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.errors.NewResourceCreationErrorEnum</code>
 */
class NewResourceCreationErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Errors\NewResourceCreationError::initOnce();
