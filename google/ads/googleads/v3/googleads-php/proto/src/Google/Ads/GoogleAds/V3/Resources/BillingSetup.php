...
class BillingSetup extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\BillingSetupStatusEnum\BillingSetupStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Resources\BillingSetup\PaymentsAccountInfo::class);
