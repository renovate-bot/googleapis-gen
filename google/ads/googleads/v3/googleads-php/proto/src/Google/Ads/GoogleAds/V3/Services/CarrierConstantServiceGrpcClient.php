...
class CarrierConstantServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCarrierConstant(\Google\Ads\GoogleAds\V3\Services\GetCarrierConstantRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CarrierConstantService/GetCarrierConstant',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\CarrierConstant', 'decode'],
        $metadata, $options);
    }
