...
class ShoppingPerformanceViewServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetShoppingPerformanceView(\Google\Ads\GoogleAds\V3\Services\GetShoppingPerformanceViewRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.ShoppingPerformanceViewService/GetShoppingPerformanceView',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\ShoppingPerformanceView', 'decode'],
        $metadata, $options);
    }
