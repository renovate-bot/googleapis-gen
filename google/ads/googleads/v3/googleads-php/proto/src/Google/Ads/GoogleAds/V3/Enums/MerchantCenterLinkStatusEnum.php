 ...
 * link.
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.MerchantCenterLinkStatusEnum</code>
 */
class MerchantCenterLinkStatusEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Enums\MerchantCenterLinkStatus::initOnce();
