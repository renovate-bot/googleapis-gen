 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.GetLanguageConstantRequest</code>
 */
class GetLanguageConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Services\LanguageConstantService::initOnce();
