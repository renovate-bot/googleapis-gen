...
class CampaignServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetCampaign(\Google\Ads\GoogleAds\V3\Services\GetCampaignRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignService/GetCampaign',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\Campaign', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateCampaigns(\Google\Ads\GoogleAds\V3\Services\MutateCampaignsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.CampaignService/MutateCampaigns',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateCampaignsResponse', 'decode'],
        $metadata, $options);
    }
