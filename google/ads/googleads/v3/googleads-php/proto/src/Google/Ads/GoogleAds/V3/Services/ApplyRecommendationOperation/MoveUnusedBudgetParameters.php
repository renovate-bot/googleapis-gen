 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.ApplyRecommendationOperation.MoveUnusedBudgetParameters</code>
 */
class MoveUnusedBudgetParameters extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->budget_micros_to_move) ? $this->budget_micros_to_move : null;
    }
...
class_alias(MoveUnusedBudgetParameters::class, \Google\Ads\GoogleAds\V3\Services\ApplyRecommendationOperation_MoveUnusedBudgetParameters::class);
