 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.enums.AdGroupStatusEnum</code>
 */
class AdGroupStatusEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Enums\AdGroupStatus::initOnce();
