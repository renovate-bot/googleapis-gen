...
class OfflineUserDataJobServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function CreateOfflineUserDataJob(\Google\Ads\GoogleAds\V3\Services\CreateOfflineUserDataJobRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.OfflineUserDataJobService/CreateOfflineUserDataJob',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\CreateOfflineUserDataJobResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function GetOfflineUserDataJob(\Google\Ads\GoogleAds\V3\Services\GetOfflineUserDataJobRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.OfflineUserDataJobService/GetOfflineUserDataJob',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\OfflineUserDataJob', 'decode'],
        $metadata, $options);
    }
    ...
    public function AddOfflineUserDataJobOperations(\Google\Ads\GoogleAds\V3\Services\AddOfflineUserDataJobOperationsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.OfflineUserDataJobService/AddOfflineUserDataJobOperations',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\AddOfflineUserDataJobOperationsResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function RunOfflineUserDataJob(\Google\Ads\GoogleAds\V3\Services\RunOfflineUserDataJobRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.OfflineUserDataJobService/RunOfflineUserDataJob',
        $argument,
