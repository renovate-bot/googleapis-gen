 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.GenerateReachForecastRequest</code>
 */
class GenerateReachForecastRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.Targeting targeting = 6;</code>
     */
     ...
     *           The currency code.
     *           Three-character ISO 4217 currency code.
     *     @type \Google\Ads\GoogleAds\V3\Services\CampaignDuration $campaign_duration
     *           Required. Campaign duration.
     ...
     *           This won't affect the targeting, but just the reporting.
     *           If not specified, a default of 1 is applied.
     *     @type \Google\Ads\GoogleAds\V3\Services\Targeting $targeting
     *           The targeting to be applied to all products selected in the product mix.
     *           This is planned targeting: execution details might vary based on the
     *           advertising product, please consult an implementation specialist.
     *           See specific metrics for details on how targeting affects them.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V3\Services\CampaignDuration $var
     * @return $this
     */
    public function setCampaignDuration($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Services\CampaignDuration::class);
    ...
    {
        return isset($this->cookie_frequency_cap) ? $this->cookie_frequency_cap : null;
    }
    ...
    {
        return isset($this->min_effective_frequency) ? $this->min_effective_frequency : null;
    }
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.Targeting targeting = 6;</code>
     * @param \Google\Ads\GoogleAds\V3\Services\Targeting $var
     * @return $this
     */
    public function setTargeting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Services\Targeting::class);
        $this->targeting = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\PlannedProduct::class);
