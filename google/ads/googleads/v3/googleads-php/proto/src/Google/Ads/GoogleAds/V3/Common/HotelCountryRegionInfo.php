 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.common.HotelCountryRegionInfo</code>
 */
class HotelCountryRegionInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->country_region_criterion) ? $this->country_region_criterion : null;
    }
