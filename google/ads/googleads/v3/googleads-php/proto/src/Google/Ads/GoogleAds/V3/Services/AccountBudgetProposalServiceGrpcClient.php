...
class AccountBudgetProposalServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetAccountBudgetProposal(\Google\Ads\GoogleAds\V3\Services\GetAccountBudgetProposalRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AccountBudgetProposalService/GetAccountBudgetProposal',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Resources\AccountBudgetProposal', 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateAccountBudgetProposal(\Google\Ads\GoogleAds\V3\Services\MutateAccountBudgetProposalRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v3.services.AccountBudgetProposalService/MutateAccountBudgetProposal',
        $argument,
        ['\Google\Ads\GoogleAds\V3\Services\MutateAccountBudgetProposalResponse', 'decode'],
        $metadata, $options);
    }
