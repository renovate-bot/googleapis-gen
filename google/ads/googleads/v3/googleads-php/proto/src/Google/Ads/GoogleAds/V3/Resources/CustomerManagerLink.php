 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.resources.CustomerManagerLink</code>
 */
class CustomerManagerLink extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V3\Resources\CustomerManagerLink::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V3\Enums\ManagerLinkStatusEnum\ManagerLinkStatus::class);
        $this->status = $var;
