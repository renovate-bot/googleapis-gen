 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v3.services.ReachForecast</code>
 */
class ReachForecast extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.Forecast forecast = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.ProductAllocation forecasted_product_allocations = 3;</code>
     */
     ...
     *           The cost in micros.
     *     @type \Google\Ads\GoogleAds\V3\Services\Forecast $forecast
     *           Forecasted traffic metrics for this point.
     *     @type \Google\Ads\GoogleAds\V3\Services\ProductAllocation[]|\Google\Protobuf\Internal\RepeatedField $forecasted_product_allocations
     *           The forecasted allocation. This differs from the input allocation if one
     *           or more product cannot fulfill the budget because of limited inventory.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v3.services.Forecast forecast = 2;</code>
     * @param \Google\Ads\GoogleAds\V3\Services\Forecast $var
     * @return $this
     */
    public function setForecast($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V3\Services\Forecast::class);
        $this->forecast = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v3.services.ProductAllocation forecasted_product_allocations = 3;</code>
     * @param \Google\Ads\GoogleAds\V3\Services\ProductAllocation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setForecastedProductAllocations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V3\Services\ProductAllocation::class);
