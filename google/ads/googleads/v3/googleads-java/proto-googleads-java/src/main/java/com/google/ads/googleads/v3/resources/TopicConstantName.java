...
public class TopicConstantName implements ResourceName {
  private static final PathTemplate TOPIC_CONSTANT =
  ...
  public static TopicConstantName of(String topicConstant) {
    return newBuilder().setTopicConstant(topicConstant).build();
  }

  public static String format(String topicConstant) {
    return newBuilder().setTopicConstant(topicConstant).build().toString();
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return TOPIC_CONSTANT.matches(formattedString);
  }
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (topicConstant != null) {
            fieldMapBuilder.put("topic_constant", topicConstant);
          }
  ...
  public String toString() {
    return TOPIC_CONSTANT.instantiate("topic_constant", topicConstant);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.topicConstant, that.topicConstant);
    }
    return false;
  }
  ...
  public int hashCode() {
    int h = 1;
    h *= 1000003;
    h ^= Objects.hashCode(topicConstant);
    return h;
  }

  /** Builder for topicConstants/{topic_constant}. */
