...
public class AssetName implements ResourceName {
  private static final PathTemplate CUSTOMER_ASSET =
  ...
  public static AssetName of(String customer, String asset) {
    return newBuilder().setCustomer(customer).setAsset(asset).build();
  }

  public static String format(String customer, String asset) {
    return newBuilder().setCustomer(customer).setAsset(asset).build().toString();
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return CUSTOMER_ASSET.matches(formattedString);
  }
  ...
  public String toString() {
    return CUSTOMER_ASSET.instantiate("customer", customer, "asset", asset);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.customer, that.customer) && Objects.equals(this.asset, that.asset);
    }
    return false;
  }
  ...
  /** Builder for customers/{customer}/assets/{asset}. */
