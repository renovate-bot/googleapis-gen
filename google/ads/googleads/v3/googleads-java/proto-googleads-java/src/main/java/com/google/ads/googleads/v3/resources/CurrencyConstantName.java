...
public class CurrencyConstantName implements ResourceName {
  private static final PathTemplate CURRENCY_CONSTANT =
  ...
  public static CurrencyConstantName of(String currencyConstant) {
    return newBuilder().setCurrencyConstant(currencyConstant).build();
  }

  public static String format(String currencyConstant) {
    return newBuilder().setCurrencyConstant(currencyConstant).build().toString();
  }
  ...
  public static CurrencyConstantName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CURRENCY_CONSTANT.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return CURRENCY_CONSTANT.matches(formattedString);
  }
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (currencyConstant != null) {
            fieldMapBuilder.put("currency_constant", currencyConstant);
          }
  ...
  public String toString() {
    return CURRENCY_CONSTANT.instantiate("currency_constant", currencyConstant);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.currencyConstant, that.currencyConstant);
    }
    return false;
  }
  ...
  public int hashCode() {
    int h = 1;
    h *= 1000003;
    h ^= Objects.hashCode(currencyConstant);
    return h;
  }

  /** Builder for currencyConstants/{currency_constant}. */
