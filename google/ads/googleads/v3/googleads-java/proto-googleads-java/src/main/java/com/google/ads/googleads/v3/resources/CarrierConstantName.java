...
public class CarrierConstantName implements ResourceName {
  private static final PathTemplate CARRIER_CONSTANT =
  ...
  public static CarrierConstantName of(String carrierConstant) {
    return newBuilder().setCarrierConstant(carrierConstant).build();
  }

  public static String format(String carrierConstant) {
    return newBuilder().setCarrierConstant(carrierConstant).build().toString();
  }
  ...
  public static CarrierConstantName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CARRIER_CONSTANT.validatedMatch(
            formattedString, "CarrierConstantName.parse: formattedString not in valid format");
  ...
  public static boolean isParsableFrom(String formattedString) {
    return CARRIER_CONSTANT.matches(formattedString);
  }
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (carrierConstant != null) {
            fieldMapBuilder.put("carrier_constant", carrierConstant);
          }
  ...
  public String toString() {
    return CARRIER_CONSTANT.instantiate("carrier_constant", carrierConstant);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.carrierConstant, that.carrierConstant);
    }
    return false;
  }
  ...
  public int hashCode() {
    int h = 1;
    h *= 1000003;
    h ^= Objects.hashCode(carrierConstant);
    return h;
  }

  /** Builder for carrierConstants/{carrier_constant}. */
