...
import com.google.ads.googleads.v3.resources.SharedCriterionName;
  ...
  public void getSharedCriterionTest() throws Exception {
    SharedCriterion expectedResponse =
        SharedCriterion.newBuilder()
            .setResourceName(SharedCriterionName.of("[CUSTOMER]", "[SHARED_CRITERION]").toString())
            .setSharedSet(StringValue.newBuilder().build())
