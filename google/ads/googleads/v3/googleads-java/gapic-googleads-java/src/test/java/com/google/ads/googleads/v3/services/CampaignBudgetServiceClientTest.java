  ...
  public void getCampaignBudgetTest() throws Exception {
    CampaignBudget expectedResponse =
        CampaignBudget.newBuilder()
            ...
            .setAmountMicros(Int64Value.newBuilder().build())
            .setTotalAmountMicros(Int64Value.newBuilder().build())
            .setExplicitlyShared(BoolValue.newBuilder().build())
            .setReferenceCount(Int64Value.newBuilder().build())
            .setHasRecommendedBudget(BoolValue.newBuilder().build())
            .setRecommendedBudgetAmountMicros(Int64Value.newBuilder().build())
            .setRecommendedBudgetEstimatedChangeWeeklyClicks(Int64Value.newBuilder().build())
            .setRecommendedBudgetEstimatedChangeWeeklyCostMicros(Int64Value.newBuilder().build())
            .setRecommendedBudgetEstimatedChangeWeeklyInteractions(Int64Value.newBuilder().build())
            .setRecommendedBudgetEstimatedChangeWeeklyViews(Int64Value.newBuilder().build())
            .build();
