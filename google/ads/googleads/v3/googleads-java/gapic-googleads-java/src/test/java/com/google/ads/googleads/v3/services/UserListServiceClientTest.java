...
import com.google.ads.googleads.v3.resources.UserListName;
  ...
  public void getUserListTest() throws Exception {
    UserList expectedResponse =
        UserList.newBuilder()
            ...
            .setReadOnly(BoolValue.newBuilder().build())
            .setName(StringValue.newBuilder().build())
            .setDescription(StringValue.newBuilder().build())
            .setIntegrationCode(StringValue.newBuilder().build())
            .setMembershipLifeSpan(Int64Value.newBuilder().build())
            .setSizeForDisplay(Int64Value.newBuilder().build())
            .setSizeForSearch(Int64Value.newBuilder().build())
            .setEligibleForSearch(BoolValue.newBuilder().build())
            .setEligibleForDisplay(BoolValue.newBuilder().build())
            .build();
