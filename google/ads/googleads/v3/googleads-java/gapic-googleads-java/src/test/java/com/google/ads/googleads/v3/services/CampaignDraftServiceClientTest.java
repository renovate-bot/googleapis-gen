...
import com.google.ads.googleads.v3.resources.CampaignDraftName;
  ...
  public void getCampaignDraftTest() throws Exception {
    CampaignDraft expectedResponse =
        CampaignDraft.newBuilder()
            ...
            .setDraftId(Int64Value.newBuilder().build())
            .setBaseCampaign(StringValue.newBuilder().build())
            .setName(StringValue.newBuilder().build())
            .setDraftCampaign(StringValue.newBuilder().build())
            .setHasExperimentRunning(BoolValue.newBuilder().build())
