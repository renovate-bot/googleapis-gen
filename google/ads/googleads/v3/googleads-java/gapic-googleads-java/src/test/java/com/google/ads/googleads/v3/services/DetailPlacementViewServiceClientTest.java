...
import com.google.ads.googleads.v3.resources.DetailPlacementView;
import com.google.ads.googleads.v3.resources.DetailPlacementViewName;
  ...
  public void getDetailPlacementViewTest() throws Exception {
    DetailPlacementView expectedResponse =
        DetailPlacementView.newBuilder()
            .setResourceName(
                DetailPlacementViewName.of("[CUSTOMER]", "[DETAIL_PLACEMENT_VIEW]").toString())
            .setPlacement(StringValue.newBuilder().build())
            .setDisplayName(StringValue.newBuilder().build())
            .setGroupPlacementTargetUrl(StringValue.newBuilder().build())
            .setTargetUrl(StringValue.newBuilder().build())
            .build();
