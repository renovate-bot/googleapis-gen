...
import com.google.ads.googleads.v3.resources.Video;
import com.google.ads.googleads.v3.resources.VideoName;
  ...
  public void getVideoTest() throws Exception {
    Video expectedResponse =
        Video.newBuilder()
            ...
            .setId(StringValue.newBuilder().build())
            .setChannelId(StringValue.newBuilder().build())
            .setDurationMillis(Int64Value.newBuilder().build())
            .setTitle(StringValue.newBuilder().build())
            .build();
