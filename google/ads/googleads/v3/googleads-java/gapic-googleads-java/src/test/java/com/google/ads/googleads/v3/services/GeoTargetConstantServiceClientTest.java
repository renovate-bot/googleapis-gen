...
import com.google.ads.googleads.v3.resources.GeoTargetConstantName;
  ...
  public void getGeoTargetConstantTest() throws Exception {
    GeoTargetConstant expectedResponse =
        GeoTargetConstant.newBuilder()
            ...
            .setCountryCode(StringValue.newBuilder().build())
            .setTargetType(StringValue.newBuilder().build())
            .setCanonicalName(StringValue.newBuilder().build())
            .build();
  ...
  public void suggestGeoTargetConstantsTest() throws Exception {
    ...
    SuggestGeoTargetConstantsRequest request =
        SuggestGeoTargetConstantsRequest.newBuilder()
            .setLocale(StringValue.newBuilder().build())
            .setCountryCode(StringValue.newBuilder().build())
            .build();
