...
import com.google.ads.googleads.v3.resources.DynamicSearchAdsSearchTermViewName;
        ...
        DynamicSearchAdsSearchTermView.newBuilder()
            .setResourceName(
                DynamicSearchAdsSearchTermViewName.of(
                    ...
                    .toString())
            .setSearchTerm(StringValue.newBuilder().build())
            .setHeadline(StringValue.newBuilder().build())
            .setLandingPage(StringValue.newBuilder().build())
            .setPageUrl(StringValue.newBuilder().build())
            .setHasNegativeKeyword(BoolValue.newBuilder().build())
            .setHasMatchingKeyword(BoolValue.newBuilder().build())
            .setHasNegativeUrl(BoolValue.newBuilder().build())
            .build();
