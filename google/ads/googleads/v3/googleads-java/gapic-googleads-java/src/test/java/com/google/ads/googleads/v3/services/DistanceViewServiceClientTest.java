...
import com.google.ads.googleads.v3.resources.DistanceViewName;
  ...
  public void getDistanceViewTest() throws Exception {
    DistanceView expectedResponse =
        DistanceView.newBuilder()
            .setResourceName(DistanceViewName.of("[CUSTOMER]", "[DISTANCE_VIEW]").toString())
            .setMetricSystem(BoolValue.newBuilder().build())
            .build();
