...
import com.google.ads.googleads.v3.enums.CustomerPayPerConversionEligibilityFailureReasonEnum;
import com.google.ads.googleads.v3.resources.CallReportingSetting;
import com.google.ads.googleads.v3.resources.ConversionTrackingSetting;
import com.google.ads.googleads.v3.resources.Customer;
import com.google.ads.googleads.v3.resources.CustomerName;
import com.google.ads.googleads.v3.resources.RemarketingSetting;
...
public class CustomerServiceClientTest {
  ...
  public void getCustomerTest() throws Exception {
    Customer expectedResponse =
        Customer.newBuilder()
            ...
            .setDescriptiveName(StringValue.newBuilder().build())
            .setCurrencyCode(StringValue.newBuilder().build())
            .setTimeZone(StringValue.newBuilder().build())
            .setTrackingUrlTemplate(StringValue.newBuilder().build())
            .setFinalUrlSuffix(StringValue.newBuilder().build())
            .setAutoTaggingEnabled(BoolValue.newBuilder().build())
            .setHasPartnersBadge(BoolValue.newBuilder().build())
            .setManager(BoolValue.newBuilder().build())
            .setTestAccount(BoolValue.newBuilder().build())
  ...
  public void createCustomerClientTest() throws Exception {
    CreateCustomerClientResponse expectedResponse =
        CreateCustomerClientResponse.newBuilder().setResourceName("resourceName-384566343").build();
    mockCustomerService.addResponse(expectedResponse);
