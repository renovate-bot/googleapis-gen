...
import com.google.ads.googleads.v3.resources.CustomerClientName;
  ...
  public void getCustomerClientTest() throws Exception {
    CustomerClient expectedResponse =
        CustomerClient.newBuilder()
            ...
            .setClientCustomer(StringValue.newBuilder().build())
            .setHidden(BoolValue.newBuilder().build())
            .setLevel(Int64Value.newBuilder().build())
