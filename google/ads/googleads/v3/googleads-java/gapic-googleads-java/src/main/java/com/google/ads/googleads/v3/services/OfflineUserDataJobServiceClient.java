...
import com.google.ads.googleads.v3.services.stub.OfflineUserDataJobServiceStub;
import com.google.ads.googleads.v3.services.stub.OfflineUserDataJobServiceStubSettings;
...
public class OfflineUserDataJobServiceClient implements BackgroundResource {
   ...
   *           .setResourceName(
   *               OfflineUserDataJobName.of("[CUSTOMER]", "[OFFLINE_USER_DATA_JOB]").toString())
   *           .setEnablePartialFailure(BoolValue.newBuilder().build())
