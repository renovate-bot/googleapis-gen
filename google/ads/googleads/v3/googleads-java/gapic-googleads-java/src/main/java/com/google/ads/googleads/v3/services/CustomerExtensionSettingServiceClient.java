...
import com.google.ads.googleads.v3.resources.CustomerExtensionSettingName;
import com.google.ads.googleads.v3.services.stub.CustomerExtensionSettingServiceStub;
import com.google.ads.googleads.v3.services.stub.CustomerExtensionSettingServiceStubSettings;
...
public class CustomerExtensionSettingServiceClient implements BackgroundResource {
   ...
   *     CustomerExtensionSettingServiceClient.create()) {
   *   String resourceName =
   *       CustomerExtensionSettingName.of("[CUSTOMER]", "[CUSTOMER_EXTENSION_SETTING]").toString();
   *   CustomerExtensionSetting response =
   *       customerExtensionSettingServiceClient.getCustomerExtensionSetting(resourceName);
   * }
   * }</pre>
