...
import com.google.ads.googleads.v3.resources.Label;
import com.google.ads.googleads.v3.services.GetLabelRequest;
import com.google.ads.googleads.v3.services.MutateLabelsRequest;
import com.google.ads.googleads.v3.services.MutateLabelsResponse;
...
public class LabelServiceStubSettings extends StubSettings<LabelServiceStubSettings> {
  ...
  private final UnaryCallSettings<MutateLabelsRequest, MutateLabelsResponse> mutateLabelsSettings;
  ...
  protected LabelServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    mutateLabelsSettings = settingsBuilder.mutateLabelsSettings().build();
  }
  ...
  public static class Builder extends StubSettings.Builder<LabelServiceStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<MutateLabelsRequest, MutateLabelsResponse>
    ...
    protected Builder(ClientContext clientContext) {
      ...
      mutateLabelsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(getLabelSettings, mutateLabelsSettings);
      initDefaults(this);
    }
    ...
    protected Builder(LabelServiceStubSettings settings) {
      ...
      mutateLabelsSettings = settings.mutateLabelsSettings.toBuilder();
