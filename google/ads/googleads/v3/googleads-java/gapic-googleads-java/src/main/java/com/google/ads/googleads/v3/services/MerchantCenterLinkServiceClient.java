...
import com.google.ads.googleads.v3.resources.MerchantCenterLinkName;
import com.google.ads.googleads.v3.services.stub.MerchantCenterLinkServiceStub;
import com.google.ads.googleads.v3.services.stub.MerchantCenterLinkServiceStubSettings;
...
public class MerchantCenterLinkServiceClient implements BackgroundResource {
   ...
   *       MerchantCenterLinkName.of("[CUSTOMER]", "[MERCHANT_CENTER_LINK]");
   ...
   *     MerchantCenterLinkServiceClient.create()) {
   *   String resourceName =
   *       MerchantCenterLinkName.of("[CUSTOMER]", "[MERCHANT_CENTER_LINK]").toString();
   *   MerchantCenterLink response =
   *       merchantCenterLinkServiceClient.getMerchantCenterLink(resourceName);
   * }
   * }</pre>
