...
import com.google.ads.googleads.v3.resources.GeoTargetConstant;
import com.google.ads.googleads.v3.services.GetGeoTargetConstantRequest;
import com.google.ads.googleads.v3.services.SuggestGeoTargetConstantsRequest;
import com.google.ads.googleads.v3.services.SuggestGeoTargetConstantsResponse;
...
/**
 * Settings class to configure an instance of {@link GeoTargetConstantServiceStub}.
 *
 ...
 *
 * <pre>{@code
 * GeoTargetConstantServiceStubSettings.Builder geoTargetConstantServiceSettingsBuilder =
 *     GeoTargetConstantServiceStubSettings.newBuilder();
 ...
 *             .build());
 * GeoTargetConstantServiceStubSettings geoTargetConstantServiceSettings =
...
public class GeoTargetConstantServiceStubSettings
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(GeoTargetConstantServiceStubSettings.class))
        .setTransportToken(
  ...
  protected GeoTargetConstantServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<GeoTargetConstantServiceStubSettings, Builder> {
    ...
    protected Builder(GeoTargetConstantServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public GeoTargetConstantServiceStubSettings build() throws IOException {
      return new GeoTargetConstantServiceStubSettings(this);
    }
  }
}
