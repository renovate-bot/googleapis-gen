...
import com.google.ads.googleads.v3.resources.CustomInterest;
import com.google.ads.googleads.v3.services.GetCustomInterestRequest;
import com.google.ads.googleads.v3.services.MutateCustomInterestsRequest;
import com.google.ads.googleads.v3.services.MutateCustomInterestsResponse;
...
public class CustomInterestServiceStubSettings
  ...
  private final UnaryCallSettings<GetCustomInterestRequest, CustomInterest>
      getCustomInterestSettings;
  private final UnaryCallSettings<MutateCustomInterestsRequest, MutateCustomInterestsResponse>
  ...
  public UnaryCallSettings<GetCustomInterestRequest, CustomInterest> getCustomInterestSettings() {
    return getCustomInterestSettings;
  }
  ...
  public CustomInterestServiceStub createStub() throws IOException {
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(CustomInterestServiceStubSettings.class))
        .setTransportToken(
  ...
  protected CustomInterestServiceStubSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);

    getCustomInterestSettings = settingsBuilder.getCustomInterestSettings().build();
    mutateCustomInterestsSettings = settingsBuilder.mutateCustomInterestsSettings().build();
  }
  ...
  public static class Builder
    ...
    protected Builder(CustomInterestServiceStubSettings settings) {
      ...
      getCustomInterestSettings = settings.getCustomInterestSettings.toBuilder();
      mutateCustomInterestsSettings = settings.mutateCustomInterestsSettings.toBuilder();
    ...
    /** Returns the builder for the settings used for calls to getCustomInterest. */
    public UnaryCallSettings.Builder<GetCustomInterestRequest, CustomInterest>
        getCustomInterestSettings() {
      return getCustomInterestSettings;
    }

    /** Returns the builder for the settings used for calls to mutateCustomInterests. */
    public UnaryCallSettings.Builder<MutateCustomInterestsRequest, MutateCustomInterestsResponse>
        mutateCustomInterestsSettings() {
      return mutateCustomInterestsSettings;
    }

    @Override
    public CustomInterestServiceStubSettings build() throws IOException {
      return new CustomInterestServiceStubSettings(this);
    }
  }
}
