...
import com.google.ads.googleads.v3.resources.SearchTermView;
import com.google.ads.googleads.v3.resources.SearchTermViewName;
import com.google.ads.googleads.v3.services.stub.SearchTermViewServiceStub;
import com.google.ads.googleads.v3.services.stub.SearchTermViewServiceStubSettings;
...
public class SearchTermViewServiceClient implements BackgroundResource {
   ...
   * try (SearchTermViewServiceClient searchTermViewServiceClient =
   *     SearchTermViewServiceClient.create()) {
   *   String resourceName = SearchTermViewName.of("[CUSTOMER]", "[SEARCH_TERM_VIEW]").toString();
   *   SearchTermView response = searchTermViewServiceClient.getSearchTermView(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetSearchTermViewRequest request =
   *       GetSearchTermViewRequest.newBuilder()
   *           .setResourceName(SearchTermViewName.of("[CUSTOMER]", "[SEARCH_TERM_VIEW]").toString())
   *           .build();
