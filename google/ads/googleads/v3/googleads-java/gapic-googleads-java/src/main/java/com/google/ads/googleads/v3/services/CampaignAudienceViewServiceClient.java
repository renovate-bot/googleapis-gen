...
import com.google.ads.googleads.v3.resources.CampaignAudienceView;
import com.google.ads.googleads.v3.resources.CampaignAudienceViewName;
import com.google.ads.googleads.v3.services.stub.CampaignAudienceViewServiceStub;
import com.google.ads.googleads.v3.services.stub.CampaignAudienceViewServiceStubSettings;
...
public class CampaignAudienceViewServiceClient implements BackgroundResource {
   ...
   *     CampaignAudienceViewServiceClient.create()) {
   *   String resourceName =
   *       CampaignAudienceViewName.of("[CUSTOMER]", "[CAMPAIGN_AUDIENCE_VIEW]").toString();
   *   CampaignAudienceView response =
   *       campaignAudienceViewServiceClient.getCampaignAudienceView(resourceName);
   * }
   * }</pre>
