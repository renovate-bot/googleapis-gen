...
import com.google.ads.googleads.v3.resources.BillingSetup;
import com.google.ads.googleads.v3.services.stub.BillingSetupServiceStubSettings;
...
public class BillingSetupServiceSettings extends ClientSettings<BillingSetupServiceSettings> {
  ...
  public UnaryCallSettings<GetBillingSetupRequest, BillingSetup> getBillingSetupSettings() {
    return ((BillingSetupServiceStubSettings) getStubSettings()).getBillingSetupSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<BillingSetupServiceSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<GetBillingSetupRequest, BillingSetup>
        getBillingSetupSettings() {
      return getStubSettingsBuilder().getBillingSetupSettings();
    }
