...
import com.google.ads.googleads.v3.resources.CustomerLabel;
import com.google.ads.googleads.v3.resources.CustomerLabelName;
import com.google.ads.googleads.v3.services.stub.CustomerLabelServiceStub;
import com.google.ads.googleads.v3.services.stub.CustomerLabelServiceStubSettings;
...
public class CustomerLabelServiceClient implements BackgroundResource {
   ...
   * try (CustomerLabelServiceClient customerLabelServiceClient =
   *     CustomerLabelServiceClient.create()) {
   *   String resourceName = CustomerLabelName.of("[CUSTOMER]", "[CUSTOMER_LABEL]").toString();
   *   CustomerLabel response = customerLabelServiceClient.getCustomerLabel(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetCustomerLabelRequest request =
   *       GetCustomerLabelRequest.newBuilder()
   *           .setResourceName(CustomerLabelName.of("[CUSTOMER]", "[CUSTOMER_LABEL]").toString())
   *           .build();
   ...
   *           .setResourceName(CustomerLabelName.of("[CUSTOMER]", "[CUSTOMER_LABEL]").toString())
   *           .build();
   *   ApiFuture<CustomerLabel> future =
   *       customerLabelServiceClient.getCustomerLabelCallable().futureCall(request);
   *   // Do something.
