...
import com.google.ads.googleads.v3.resources.HotelPerformanceViewName;
import com.google.ads.googleads.v3.services.stub.HotelPerformanceViewServiceStub;
...
public class HotelPerformanceViewServiceClient implements BackgroundResource {
   ...
   * try (HotelPerformanceViewServiceClient hotelPerformanceViewServiceClient =
   *     HotelPerformanceViewServiceClient.create()) {
   *   String resourceName = HotelPerformanceViewName.of("[CUSTOMER]").toString();
   *   HotelPerformanceView response =
   *       hotelPerformanceViewServiceClient.getHotelPerformanceView(resourceName);
   * }
   * }</pre>
   ...
   *   GetHotelPerformanceViewRequest request =
   *       GetHotelPerformanceViewRequest.newBuilder()
   *           .setResourceName(HotelPerformanceViewName.of("[CUSTOMER]").toString())
   *           .build();
   *   HotelPerformanceView response =
