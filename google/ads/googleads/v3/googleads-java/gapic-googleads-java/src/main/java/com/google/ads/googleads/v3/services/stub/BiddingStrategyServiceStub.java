...
public abstract class BiddingStrategyServiceStub implements BackgroundResource {

  public UnaryCallable<GetBiddingStrategyRequest, BiddingStrategy> getBiddingStrategyCallable() {
    throw new UnsupportedOperationException("Not implemented: getBiddingStrategyCallable()");
  }

  public UnaryCallable<MutateBiddingStrategiesRequest, MutateBiddingStrategiesResponse>
      mutateBiddingStrategiesCallable() {
    throw new UnsupportedOperationException("Not implemented: mutateBiddingStrategiesCallable()");
  }
