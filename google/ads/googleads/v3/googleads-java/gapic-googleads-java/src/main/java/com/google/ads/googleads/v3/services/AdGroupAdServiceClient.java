...
import com.google.ads.googleads.v3.resources.AdGroupAdName;
import com.google.ads.googleads.v3.services.stub.AdGroupAdServiceStub;
import com.google.ads.googleads.v3.services.stub.AdGroupAdServiceStubSettings;
...
public class AdGroupAdServiceClient implements BackgroundResource {
   ...
   * <pre>{@code
   * try (AdGroupAdServiceClient adGroupAdServiceClient = AdGroupAdServiceClient.create()) {
   *   String resourceName = AdGroupAdName.of("[CUSTOMER]", "[AD_GROUP_AD]").toString();
   *   AdGroupAd response = adGroupAdServiceClient.getAdGroupAd(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetAdGroupAdRequest request =
   *       GetAdGroupAdRequest.newBuilder()
   *           .setResourceName(AdGroupAdName.of("[CUSTOMER]", "[AD_GROUP_AD]").toString())
   *           .build();
