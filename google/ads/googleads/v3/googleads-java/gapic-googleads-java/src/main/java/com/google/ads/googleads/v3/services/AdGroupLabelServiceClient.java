...
import com.google.ads.googleads.v3.services.stub.AdGroupLabelServiceStub;
import com.google.ads.googleads.v3.services.stub.AdGroupLabelServiceStubSettings;
...
public class AdGroupLabelServiceClient implements BackgroundResource {
   ...
   * <pre>{@code
   * try (AdGroupLabelServiceClient adGroupLabelServiceClient = AdGroupLabelServiceClient.create()) {
   *   String resourceName = AdGroupLabelName.of("[CUSTOMER]", "[AD_GROUP_LABEL]").toString();
   *   AdGroupLabel response = adGroupLabelServiceClient.getAdGroupLabel(resourceName);
   * }
   * }</pre>
   *
   ...
   *   GetAdGroupLabelRequest request =
   *       GetAdGroupLabelRequest.newBuilder()
   *           .setResourceName(AdGroupLabelName.of("[CUSTOMER]", "[AD_GROUP_LABEL]").toString())
   *           .build();
