...
import com.google.ads.googleads.v3.resources.ClickView;
import com.google.ads.googleads.v3.resources.ClickViewName;
import com.google.ads.googleads.v3.services.stub.ClickViewServiceStub;
import com.google.ads.googleads.v3.services.stub.ClickViewServiceStubSettings;
...
public class ClickViewServiceClient implements BackgroundResource {
   ...
   * <pre>{@code
   * try (ClickViewServiceClient clickViewServiceClient = ClickViewServiceClient.create()) {
   *   String resourceName = ClickViewName.of("[CUSTOMER]", "[CLICK_VIEW]").toString();
   *   ClickView response = clickViewServiceClient.getClickView(resourceName);
   * }
   * }</pre>
   *
