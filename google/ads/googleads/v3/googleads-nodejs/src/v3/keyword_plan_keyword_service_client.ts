 ...
 * `src/v3/keyword_plan_keyword_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './keyword_plan_keyword_service_client_config.json';
...
export class KeywordPlanKeywordServiceClient {
  ...
  keywordPlanKeywordServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of KeywordPlanKeywordServiceClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof KeywordPlanKeywordServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v3.services.KeywordPlanKeywordService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.keywordPlanKeywordServiceStub) {
      return this.keywordPlanKeywordServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.googleads.v3.services.KeywordPlanKeywordService.
    this.keywordPlanKeywordServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v3.services.KeywordPlanKeywordService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v3.services.KeywordPlanKeywordService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const keywordPlanKeywordServiceStubMethods =
        ['getKeywordPlanKeyword', 'mutateKeywordPlanKeywords'];
    for (const methodName of keywordPlanKeywordServiceStubMethods) {
      const callPromise = this.keywordPlanKeywordServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getKeywordPlanKeyword(
      request: protos.google.ads.googleads.v3.services.IGetKeywordPlanKeywordRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.resources.IKeywordPlanKeyword,
        protos.google.ads.googleads.v3.services.IGetKeywordPlanKeywordRequest|undefined, {}|undefined
      ]>;
  getKeywordPlanKeyword(
      request: protos.google.ads.googleads.v3.services.IGetKeywordPlanKeywordRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.resources.IKeywordPlanKeyword,
          protos.google.ads.googleads.v3.services.IGetKeywordPlanKeywordRequest|null|undefined,
          {}|null|undefined>): void;
  getKeywordPlanKeyword(
      request: protos.google.ads.googleads.v3.services.IGetKeywordPlanKeywordRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [KeywordPlanKeyword]{@link google.ads.googleads.v3.resources.KeywordPlanKeyword}.
 *   Please see the
 ...
 */
  getKeywordPlanKeyword(
    ...
    this.initialize();
    return this.innerApiCalls.getKeywordPlanKeyword(request, options, callback);
  }
  mutateKeywordPlanKeywords(
      request: protos.google.ads.googleads.v3.services.IMutateKeywordPlanKeywordsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.services.IMutateKeywordPlanKeywordsResponse,
        protos.google.ads.googleads.v3.services.IMutateKeywordPlanKeywordsRequest|undefined, {}|undefined
      ]>;
  mutateKeywordPlanKeywords(
      request: protos.google.ads.googleads.v3.services.IMutateKeywordPlanKeywordsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.services.IMutateKeywordPlanKeywordsResponse,
          protos.google.ads.googleads.v3.services.IMutateKeywordPlanKeywordsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateKeywordPlanKeywords(
      request: protos.google.ads.googleads.v3.services.IMutateKeywordPlanKeywordsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateKeywordPlanKeywordsResponse]{@link google.ads.googleads.v3.services.MutateKeywordPlanKeywordsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  mutateKeywordPlanKeywords(
    ...
    this.initialize();
    return this.innerApiCalls.mutateKeywordPlanKeywords(request, options, callback);
  }
  ...
  close(): Promise<void> {
    this.initialize();
    if (!this._terminated) {
      return this.keywordPlanKeywordServiceStub!.then(stub => {
