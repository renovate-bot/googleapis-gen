 ...
 * `src/v3/keyword_plan_negative_keyword_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './keyword_plan_negative_keyword_service_client_config.json';
...
export class KeywordPlanNegativeKeywordServiceClient {
  ...
  keywordPlanNegativeKeywordServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of KeywordPlanNegativeKeywordServiceClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof KeywordPlanNegativeKeywordServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v3.services.KeywordPlanNegativeKeywordService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.keywordPlanNegativeKeywordServiceStub) {
      return this.keywordPlanNegativeKeywordServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.googleads.v3.services.KeywordPlanNegativeKeywordService.
    this.keywordPlanNegativeKeywordServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v3.services.KeywordPlanNegativeKeywordService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v3.services.KeywordPlanNegativeKeywordService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const keywordPlanNegativeKeywordServiceStubMethods =
        ['getKeywordPlanNegativeKeyword', 'mutateKeywordPlanNegativeKeywords'];
    for (const methodName of keywordPlanNegativeKeywordServiceStubMethods) {
      const callPromise = this.keywordPlanNegativeKeywordServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getKeywordPlanNegativeKeyword(
      request: protos.google.ads.googleads.v3.services.IGetKeywordPlanNegativeKeywordRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.resources.IKeywordPlanNegativeKeyword,
        protos.google.ads.googleads.v3.services.IGetKeywordPlanNegativeKeywordRequest|undefined, {}|undefined
      ]>;
  getKeywordPlanNegativeKeyword(
      request: protos.google.ads.googleads.v3.services.IGetKeywordPlanNegativeKeywordRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.resources.IKeywordPlanNegativeKeyword,
          protos.google.ads.googleads.v3.services.IGetKeywordPlanNegativeKeywordRequest|null|undefined,
          {}|null|undefined>): void;
  getKeywordPlanNegativeKeyword(
      request: protos.google.ads.googleads.v3.services.IGetKeywordPlanNegativeKeywordRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [KeywordPlanNegativeKeyword]{@link google.ads.googleads.v3.resources.KeywordPlanNegativeKeyword}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.getKeywordPlanNegativeKeyword(request);
 */
  getKeywordPlanNegativeKeyword(
      request: protos.google.ads.googleads.v3.services.IGetKeywordPlanNegativeKeywordRequest,
    ...
    this.initialize();
    return this.innerApiCalls.getKeywordPlanNegativeKeyword(request, options, callback);
  }
  mutateKeywordPlanNegativeKeywords(
      request: protos.google.ads.googleads.v3.services.IMutateKeywordPlanNegativeKeywordsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.services.IMutateKeywordPlanNegativeKeywordsResponse,
        protos.google.ads.googleads.v3.services.IMutateKeywordPlanNegativeKeywordsRequest|undefined, {}|undefined
      ]>;
  mutateKeywordPlanNegativeKeywords(
      request: protos.google.ads.googleads.v3.services.IMutateKeywordPlanNegativeKeywordsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.services.IMutateKeywordPlanNegativeKeywordsResponse,
          protos.google.ads.googleads.v3.services.IMutateKeywordPlanNegativeKeywordsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateKeywordPlanNegativeKeywords(
      request: protos.google.ads.googleads.v3.services.IMutateKeywordPlanNegativeKeywordsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateKeywordPlanNegativeKeywordsResponse]{@link google.ads.googleads.v3.services.MutateKeywordPlanNegativeKeywordsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.mutateKeywordPlanNegativeKeywords(request);
 */
  mutateKeywordPlanNegativeKeywords(
      request: protos.google.ads.googleads.v3.services.IMutateKeywordPlanNegativeKeywordsRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.mutateKeywordPlanNegativeKeywords(request, options, callback);
  }
  ...
  close(): Promise<void> {
    this.initialize();
    if (!this._terminated) {
      return this.keywordPlanNegativeKeywordServiceStub!.then(stub => {
