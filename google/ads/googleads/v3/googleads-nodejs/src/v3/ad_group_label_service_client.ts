 ...
 * `src/v3/ad_group_label_service_client_config.json`.
...
export class AdGroupLabelServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v3.services.AdGroupLabelService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupLabelServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v3.services.AdGroupLabelService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v3.services.AdGroupLabelService,
  ...
  // -------------------
  getAdGroupLabel(
      request: protos.google.ads.googleads.v3.services.IGetAdGroupLabelRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.resources.IAdGroupLabel,
        protos.google.ads.googleads.v3.services.IGetAdGroupLabelRequest|undefined, {}|undefined
      ]>;
  getAdGroupLabel(
      request: protos.google.ads.googleads.v3.services.IGetAdGroupLabelRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.resources.IAdGroupLabel,
          protos.google.ads.googleads.v3.services.IGetAdGroupLabelRequest|null|undefined,
          {}|null|undefined>): void;
  getAdGroupLabel(
      request: protos.google.ads.googleads.v3.services.IGetAdGroupLabelRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [AdGroupLabel]{@link google.ads.googleads.v3.resources.AdGroupLabel}.
 *   Please see the
 ...
 */
  ...
  mutateAdGroupLabels(
      request: protos.google.ads.googleads.v3.services.IMutateAdGroupLabelsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.services.IMutateAdGroupLabelsResponse,
        protos.google.ads.googleads.v3.services.IMutateAdGroupLabelsRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupLabels(
      request: protos.google.ads.googleads.v3.services.IMutateAdGroupLabelsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.services.IMutateAdGroupLabelsResponse,
          protos.google.ads.googleads.v3.services.IMutateAdGroupLabelsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAdGroupLabels(
      request: protos.google.ads.googleads.v3.services.IMutateAdGroupLabelsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateAdGroupLabelsResponse]{@link google.ads.googleads.v3.services.MutateAdGroupLabelsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
