 ...
 * `src/v3/mutate_job_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './mutate_job_service_client_config.json';
...
export class MutateJobServiceClient {
  ...
  mutateJobServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of MutateJobServiceClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof MutateJobServiceClient;
    ...
    const runMutateJobResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty') as gax.protobuf.Type;
    const runMutateJobMetadata = protoFilesRoot.lookup(
      '.google.ads.googleads.v3.resources.MutateJob.MutateJobMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      runMutateJob: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        runMutateJobResponse.decode.bind(runMutateJobResponse),
        runMutateJobMetadata.decode.bind(runMutateJobMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v3.services.MutateJobService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.mutateJobServiceStub) {
      return this.mutateJobServiceStub;
    }

    // Put together the "service stub" for
    // google.ads.googleads.v3.services.MutateJobService.
    this.mutateJobServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v3.services.MutateJobService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v3.services.MutateJobService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const mutateJobServiceStubMethods =
        ['createMutateJob', 'getMutateJob', 'listMutateJobResults', 'runMutateJob', 'addMutateJobOperations'];
    for (const methodName of mutateJobServiceStubMethods) {
      const callPromise = this.mutateJobServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  createMutateJob(
      request: protos.google.ads.googleads.v3.services.ICreateMutateJobRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.services.ICreateMutateJobResponse,
        protos.google.ads.googleads.v3.services.ICreateMutateJobRequest|undefined, {}|undefined
      ]>;
  createMutateJob(
      request: protos.google.ads.googleads.v3.services.ICreateMutateJobRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.services.ICreateMutateJobResponse,
          protos.google.ads.googleads.v3.services.ICreateMutateJobRequest|null|undefined,
          {}|null|undefined>): void;
  createMutateJob(
      request: protos.google.ads.googleads.v3.services.ICreateMutateJobRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [CreateMutateJobResponse]{@link google.ads.googleads.v3.services.CreateMutateJobResponse}.
 *   Please see the
 ...
 */
  createMutateJob(
    ...
    this.initialize();
    return this.innerApiCalls.createMutateJob(request, options, callback);
  }
  getMutateJob(
      request: protos.google.ads.googleads.v3.services.IGetMutateJobRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.resources.IMutateJob,
        protos.google.ads.googleads.v3.services.IGetMutateJobRequest|undefined, {}|undefined
      ]>;
  getMutateJob(
      request: protos.google.ads.googleads.v3.services.IGetMutateJobRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.resources.IMutateJob,
          protos.google.ads.googleads.v3.services.IGetMutateJobRequest|null|undefined,
          {}|null|undefined>): void;
  getMutateJob(
      request: protos.google.ads.googleads.v3.services.IGetMutateJobRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateJob]{@link google.ads.googleads.v3.resources.MutateJob}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  getMutateJob(
    ...
    this.initialize();
    return this.innerApiCalls.getMutateJob(request, options, callback);
  }
  addMutateJobOperations(
      request: protos.google.ads.googleads.v3.services.IAddMutateJobOperationsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.services.IAddMutateJobOperationsResponse,
        protos.google.ads.googleads.v3.services.IAddMutateJobOperationsRequest|undefined, {}|undefined
      ]>;
  addMutateJobOperations(
      request: protos.google.ads.googleads.v3.services.IAddMutateJobOperationsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.services.IAddMutateJobOperationsResponse,
          protos.google.ads.googleads.v3.services.IAddMutateJobOperationsRequest|null|undefined,
          {}|null|undefined>): void;
  addMutateJobOperations(
      request: protos.google.ads.googleads.v3.services.IAddMutateJobOperationsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [AddMutateJobOperationsResponse]{@link google.ads.googleads.v3.services.AddMutateJobOperationsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  addMutateJobOperations(
    ...
    this.initialize();
    return this.innerApiCalls.addMutateJobOperations(request, options, callback);
  }

  runMutateJob(
      request: protos.google.ads.googleads.v3.services.IRunMutateJobRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v3.resources.MutateJob.IMutateJobMetadata>,
 ...
 */
  runMutateJob(
    ...
    this.initialize();
    return this.innerApiCalls.runMutateJob(request, options, callback);
  }
/**
 * Check the status of the long running operation returned by `runMutateJob()`.
 * @param {String} name
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkRunMutateJobProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
  async checkRunMutateJobProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.ads.googleads.v3.resources.MutateJob.MutateJobMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.runMutateJob, gax.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.ads.googleads.v3.resources.MutateJob.MutateJobMetadata>;
  }
  listMutateJobResults(
      request: protos.google.ads.googleads.v3.services.IListMutateJobResultsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.services.IMutateJobResult[],
        protos.google.ads.googleads.v3.services.IListMutateJobResultsRequest|null,
        protos.google.ads.googleads.v3.services.IListMutateJobResultsResponse
      ]>;
  listMutateJobResults(
      request: protos.google.ads.googleads.v3.services.IListMutateJobResultsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.googleads.v3.services.IListMutateJobResultsRequest,
          protos.google.ads.googleads.v3.services.IListMutateJobResultsResponse|null|undefined,
          protos.google.ads.googleads.v3.services.IMutateJobResult>): void;
  listMutateJobResults(
      request: protos.google.ads.googleads.v3.services.IListMutateJobResultsRequest,
      callback: PaginationCallback<
          protos.google.ads.googleads.v3.services.IListMutateJobResultsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [MutateJobResult]{@link google.ads.googleads.v3.services.MutateJobResult}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listMutateJobResultsAsync()`
 ...
 */
  listMutateJobResults(
    ...
    this.initialize();
    return this.innerApiCalls.listMutateJobResults(request, options, callback);
  }
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [MutateJobResult]{@link google.ads.googleads.v3.services.MutateJobResult} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listMutateJobResultsStream(
    ...
    this.initialize();
    return this.descriptors.page.listMutateJobResults.createStream(
      this.innerApiCalls.listMutateJobResults as gax.GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listMutateJobResults`, but returns an iterable object.
 *
 ...
 *   [MutateJobResult]{@link google.ads.googleads.v3.services.MutateJobResult}. The API will be called under the hood as needed, once per the page,
 ...
 * }
 */
  listMutateJobResultsAsync(
      request?: protos.google.ads.googleads.v3.services.IListMutateJobResultsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.googleads.v3.services.IMutateJobResult>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = new gax.CallSettings(options);
    this.initialize();
    return this.descriptors.page.listMutateJobResults.asyncIterate(
      this.innerApiCalls['listMutateJobResults'] as GaxCall,
      request as unknown as RequestType,
      callSettings
    ) as AsyncIterable<protos.google.ads.googleads.v3.services.IMutateJobResult>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
  ...
  close(): Promise<void> {
    this.initialize();
    if (!this._terminated) {
      return this.mutateJobServiceStub!.then(stub => {
