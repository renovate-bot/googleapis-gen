 ...
 * `src/v3/invoice_service_client_config.json`.
...
export class InvoiceServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v3.services.InvoiceService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.invoiceServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v3.services.InvoiceService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v3.services.InvoiceService,
  ...
  // -------------------
  listInvoices(
      request: protos.google.ads.googleads.v3.services.IListInvoicesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.services.IListInvoicesResponse,
        protos.google.ads.googleads.v3.services.IListInvoicesRequest|undefined, {}|undefined
      ]>;
  listInvoices(
      request: protos.google.ads.googleads.v3.services.IListInvoicesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.services.IListInvoicesResponse,
          protos.google.ads.googleads.v3.services.IListInvoicesRequest|null|undefined,
          {}|null|undefined>): void;
  listInvoices(
      request: protos.google.ads.googleads.v3.services.IListInvoicesRequest,
      callback: Callback<
 ...
 * @param {google.ads.googleads.v3.enums.MonthOfYearEnum.MonthOfYear} request.issueMonth
 *   Required. The issue month to retrieve invoices.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [ListInvoicesResponse]{@link google.ads.googleads.v3.services.ListInvoicesResponse}.
 *   Please see the
