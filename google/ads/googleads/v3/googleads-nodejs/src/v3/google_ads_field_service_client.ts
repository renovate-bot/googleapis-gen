 ...
 * `src/v3/google_ads_field_service_client_config.json`.
...
export class GoogleAdsFieldServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v3.services.GoogleAdsFieldService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.googleAdsFieldServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v3.services.GoogleAdsFieldService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v3.services.GoogleAdsFieldService,
  ...
  // -------------------
  getGoogleAdsField(
      request: protos.google.ads.googleads.v3.services.IGetGoogleAdsFieldRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.resources.IGoogleAdsField,
        protos.google.ads.googleads.v3.services.IGetGoogleAdsFieldRequest|undefined, {}|undefined
      ]>;
  getGoogleAdsField(
      request: protos.google.ads.googleads.v3.services.IGetGoogleAdsFieldRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.resources.IGoogleAdsField,
          protos.google.ads.googleads.v3.services.IGetGoogleAdsFieldRequest|null|undefined,
          {}|null|undefined>): void;
  getGoogleAdsField(
      request: protos.google.ads.googleads.v3.services.IGetGoogleAdsFieldRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [GoogleAdsField]{@link google.ads.googleads.v3.resources.GoogleAdsField}.
 *   Please see the
 ...
 */
  ...
  searchGoogleAdsFields(
      request: protos.google.ads.googleads.v3.services.ISearchGoogleAdsFieldsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.resources.IGoogleAdsField[],
        protos.google.ads.googleads.v3.services.ISearchGoogleAdsFieldsRequest|null,
        protos.google.ads.googleads.v3.services.ISearchGoogleAdsFieldsResponse
      ]>;
  searchGoogleAdsFields(
      request: protos.google.ads.googleads.v3.services.ISearchGoogleAdsFieldsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.ads.googleads.v3.services.ISearchGoogleAdsFieldsRequest,
          protos.google.ads.googleads.v3.services.ISearchGoogleAdsFieldsResponse|null|undefined,
          protos.google.ads.googleads.v3.resources.IGoogleAdsField>): void;
  searchGoogleAdsFields(
      request: protos.google.ads.googleads.v3.services.ISearchGoogleAdsFieldsRequest,
      callback: PaginationCallback<
          protos.google.ads.googleads.v3.services.ISearchGoogleAdsFieldsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [GoogleAdsField]{@link google.ads.googleads.v3.resources.GoogleAdsField}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [GoogleAdsField]{@link google.ads.googleads.v3.resources.GoogleAdsField} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [GoogleAdsField]{@link google.ads.googleads.v3.resources.GoogleAdsField}. The API will be called under the hood as needed, once per the page,
 ...
 */
  searchGoogleAdsFieldsAsync(
      request?: protos.google.ads.googleads.v3.services.ISearchGoogleAdsFieldsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.ads.googleads.v3.resources.IGoogleAdsField>{
    request = request || {};
    options = options || {};
    options = options || {};
    const callSettings = new gax.CallSettings(options);
    ...
    return this.descriptors.page.searchGoogleAdsFields.asyncIterate(
      ...
      callSettings
    ) as AsyncIterable<protos.google.ads.googleads.v3.resources.IGoogleAdsField>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
