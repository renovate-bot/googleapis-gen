 ...
 * `src/v3/user_data_service_client_config.json`.
...
export class UserDataServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v3.services.UserDataService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.userDataServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v3.services.UserDataService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v3.services.UserDataService,
  ...
  // -------------------
  uploadUserData(
      request: protos.google.ads.googleads.v3.services.IUploadUserDataRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.services.IUploadUserDataResponse,
        protos.google.ads.googleads.v3.services.IUploadUserDataRequest|undefined, {}|undefined
      ]>;
  uploadUserData(
      request: protos.google.ads.googleads.v3.services.IUploadUserDataRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.services.IUploadUserDataResponse,
          protos.google.ads.googleads.v3.services.IUploadUserDataRequest|null|undefined,
          {}|null|undefined>): void;
  uploadUserData(
      request: protos.google.ads.googleads.v3.services.IUploadUserDataRequest,
      callback: Callback<
 ...
 * @param {google.ads.googleads.v3.common.CustomerMatchUserListMetadata} request.customerMatchUserListMetadata
 *   Metadata for data updates to a Customer Match user list.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [UploadUserDataResponse]{@link google.ads.googleads.v3.services.UploadUserDataResponse}.
 *   Please see the
