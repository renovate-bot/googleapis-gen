 ...
 * `src/v3/keyword_plan_idea_service_client_config.json`.
...
export class KeywordPlanIdeaServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v3.services.KeywordPlanIdeaService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.keywordPlanIdeaServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v3.services.KeywordPlanIdeaService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v3.services.KeywordPlanIdeaService,
  ...
  // -------------------
  generateKeywordIdeas(
      request: protos.google.ads.googleads.v3.services.IGenerateKeywordIdeasRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v3.services.IGenerateKeywordIdeaResponse,
        protos.google.ads.googleads.v3.services.IGenerateKeywordIdeasRequest|undefined, {}|undefined
      ]>;
  generateKeywordIdeas(
      request: protos.google.ads.googleads.v3.services.IGenerateKeywordIdeasRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v3.services.IGenerateKeywordIdeaResponse,
          protos.google.ads.googleads.v3.services.IGenerateKeywordIdeasRequest|null|undefined,
          {}|null|undefined>): void;
  generateKeywordIdeas(
      request: protos.google.ads.googleads.v3.services.IGenerateKeywordIdeasRequest,
      callback: Callback<
 ...
 * @param {google.protobuf.StringValue} request.language
 *   Required. The resource name of the language to target.
 *   Required
 * @param {number[]} request.geoTargetConstants
 *   The resource names of the location to target.
 *   Max 10
 * @param {google.ads.googleads.v3.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork} request.keywordPlanNetwork
 *   Targeting network.
 * @param {google.ads.googleads.v3.services.KeywordAndUrlSeed} request.keywordAndUrlSeed
 *   A Keyword and a specific Url to generate ideas from
 *   e.g. cars, www.example.com/cars.
 * @param {google.ads.googleads.v3.services.KeywordSeed} request.keywordSeed
 *   A Keyword or phrase to generate ideas from, e.g. cars.
 * @param {google.ads.googleads.v3.services.UrlSeed} request.urlSeed
 *   A specific url to generate ideas from, e.g. www.example.com/cars.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [GenerateKeywordIdeaResponse]{@link google.ads.googleads.v3.services.GenerateKeywordIdeaResponse}.
 *   Please see the
