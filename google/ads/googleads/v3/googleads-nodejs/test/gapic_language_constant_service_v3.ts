...
describe('v3.LanguageConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = languageconstantserviceModule.v3.LanguageConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = languageconstantserviceModule.v3.LanguageConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = languageconstantserviceModule.v3.LanguageConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new languageconstantserviceModule.v3.LanguageConstantServiceClient();
        assert(client);
    });
    ...
    describe('getLanguageConstant', () => {
        it('invokes getLanguageConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetLanguageConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.LanguageConstant());
        ...
        it('invokes getLanguageConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLanguageConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.ILanguageConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
