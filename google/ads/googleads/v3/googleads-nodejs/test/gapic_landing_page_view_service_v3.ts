...
describe('v3.LandingPageViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = landingpageviewserviceModule.v3.LandingPageViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = landingpageviewserviceModule.v3.LandingPageViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = landingpageviewserviceModule.v3.LandingPageViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new landingpageviewserviceModule.v3.LandingPageViewServiceClient();
        assert(client);
    });
    ...
    describe('getLandingPageView', () => {
        it('invokes getLandingPageView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetLandingPageViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.LandingPageView());
        ...
        it('invokes getLandingPageView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLandingPageView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.ILandingPageView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
