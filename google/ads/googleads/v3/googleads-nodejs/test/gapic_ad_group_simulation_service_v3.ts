...
describe('v3.AdGroupSimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupsimulationserviceModule.v3.AdGroupSimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupsimulationserviceModule.v3.AdGroupSimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupsimulationserviceModule.v3.AdGroupSimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupsimulationserviceModule.v3.AdGroupSimulationServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupSimulation', () => {
        it('invokes getAdGroupSimulation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetAdGroupSimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.AdGroupSimulation());
        ...
        it('invokes getAdGroupSimulation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IAdGroupSimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
