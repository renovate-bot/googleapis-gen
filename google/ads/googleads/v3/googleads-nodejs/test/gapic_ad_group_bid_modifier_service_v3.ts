...
describe('v3.AdGroupBidModifierServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupbidmodifierserviceModule.v3.AdGroupBidModifierServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupbidmodifierserviceModule.v3.AdGroupBidModifierServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupbidmodifierserviceModule.v3.AdGroupBidModifierServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupbidmodifierserviceModule.v3.AdGroupBidModifierServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupBidModifier', () => {
        it('invokes getAdGroupBidModifier without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetAdGroupBidModifierRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.AdGroupBidModifier());
        ...
        it('invokes getAdGroupBidModifier without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupBidModifier(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IAdGroupBidModifier|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupBidModifiers', () => {
        it('invokes mutateAdGroupBidModifiers without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateAdGroupBidModifiersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateAdGroupBidModifiersResponse());
        ...
        it('invokes mutateAdGroupBidModifiers without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupBidModifiers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateAdGroupBidModifiersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
