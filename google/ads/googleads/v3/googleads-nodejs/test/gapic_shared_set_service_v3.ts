...
describe('v3.SharedSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = sharedsetserviceModule.v3.SharedSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = sharedsetserviceModule.v3.SharedSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = sharedsetserviceModule.v3.SharedSetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new sharedsetserviceModule.v3.SharedSetServiceClient();
        assert(client);
    });
    ...
    describe('getSharedSet', () => {
        it('invokes getSharedSet without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetSharedSetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.SharedSet());
        ...
        it('invokes getSharedSet without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSharedSet(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.ISharedSet|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateSharedSets', () => {
        it('invokes mutateSharedSets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateSharedSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateSharedSetsResponse());
        ...
        it('invokes mutateSharedSets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateSharedSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateSharedSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
