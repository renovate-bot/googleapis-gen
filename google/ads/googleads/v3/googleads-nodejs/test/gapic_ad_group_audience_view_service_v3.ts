...
import * as adgroupaudienceviewserviceModule from '../src';
...
describe('v3.AdGroupAudienceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupaudienceviewserviceModule.v3.AdGroupAudienceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupaudienceviewserviceModule.v3.AdGroupAudienceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupaudienceviewserviceModule.v3.AdGroupAudienceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupaudienceviewserviceModule.v3.AdGroupAudienceViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupAudienceViewServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupAudienceViewServiceStub);
    });
    ...
    describe('getAdGroupAudienceView', () => {
        it('invokes getAdGroupAudienceView without error', async () => {
            const client = new adgroupaudienceviewserviceModule.v3.AdGroupAudienceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetAdGroupAudienceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.AdGroupAudienceView());
            client.innerApiCalls.getAdGroupAudienceView = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupAudienceView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupAudienceView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupAudienceView without error using callback', async () => {
            const client = new adgroupaudienceviewserviceModule.v3.AdGroupAudienceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.AdGroupAudienceView());
            client.innerApiCalls.getAdGroupAudienceView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAudienceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IAdGroupAudienceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupAudienceView with error', async () => {
            const client = new adgroupaudienceviewserviceModule.v3.AdGroupAudienceViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdGroupAudienceView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupAudienceView(request), expectedError);
            assert((client.innerApiCalls.getAdGroupAudienceView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
