...
describe('v3.ProductBiddingCategoryConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = productbiddingcategoryconstantserviceModule.v3.ProductBiddingCategoryConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = productbiddingcategoryconstantserviceModule.v3.ProductBiddingCategoryConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = productbiddingcategoryconstantserviceModule.v3.ProductBiddingCategoryConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new productbiddingcategoryconstantserviceModule.v3.ProductBiddingCategoryConstantServiceClient();
        assert(client);
    });
    ...
    describe('getProductBiddingCategoryConstant', () => {
        it('invokes getProductBiddingCategoryConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetProductBiddingCategoryConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.ProductBiddingCategoryConstant());
        ...
        it('invokes getProductBiddingCategoryConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getProductBiddingCategoryConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IProductBiddingCategoryConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
