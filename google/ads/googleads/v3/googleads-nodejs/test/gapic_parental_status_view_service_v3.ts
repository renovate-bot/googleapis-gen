...
describe('v3.ParentalStatusViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = parentalstatusviewserviceModule.v3.ParentalStatusViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = parentalstatusviewserviceModule.v3.ParentalStatusViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = parentalstatusviewserviceModule.v3.ParentalStatusViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new parentalstatusviewserviceModule.v3.ParentalStatusViewServiceClient();
        assert(client);
    });
    ...
    describe('getParentalStatusView', () => {
        it('invokes getParentalStatusView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetParentalStatusViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.ParentalStatusView());
        ...
        it('invokes getParentalStatusView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getParentalStatusView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IParentalStatusView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
