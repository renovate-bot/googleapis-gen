...
describe('v3.ExtensionFeedItemServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = extensionfeeditemserviceModule.v3.ExtensionFeedItemServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = extensionfeeditemserviceModule.v3.ExtensionFeedItemServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = extensionfeeditemserviceModule.v3.ExtensionFeedItemServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new extensionfeeditemserviceModule.v3.ExtensionFeedItemServiceClient();
        assert(client);
    });
    ...
    describe('getExtensionFeedItem', () => {
        it('invokes getExtensionFeedItem without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetExtensionFeedItemRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.ExtensionFeedItem());
        ...
        it('invokes getExtensionFeedItem without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getExtensionFeedItem(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IExtensionFeedItem|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateExtensionFeedItems', () => {
        it('invokes mutateExtensionFeedItems without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateExtensionFeedItemsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateExtensionFeedItemsResponse());
        ...
        it('invokes mutateExtensionFeedItems without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateExtensionFeedItems(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateExtensionFeedItemsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
