...
describe('v3.DynamicSearchAdsSearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = dynamicsearchadssearchtermviewserviceModule.v3.DynamicSearchAdsSearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = dynamicsearchadssearchtermviewserviceModule.v3.DynamicSearchAdsSearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = dynamicsearchadssearchtermviewserviceModule.v3.DynamicSearchAdsSearchTermViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new dynamicsearchadssearchtermviewserviceModule.v3.DynamicSearchAdsSearchTermViewServiceClient();
        assert(client);
    });
    ...
    describe('getDynamicSearchAdsSearchTermView', () => {
        it('invokes getDynamicSearchAdsSearchTermView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetDynamicSearchAdsSearchTermViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.DynamicSearchAdsSearchTermView());
        ...
        it('invokes getDynamicSearchAdsSearchTermView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDynamicSearchAdsSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IDynamicSearchAdsSearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
