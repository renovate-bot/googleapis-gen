...
describe('v3.CustomerExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerextensionsettingserviceModule.v3.CustomerExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerextensionsettingserviceModule.v3.CustomerExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerextensionsettingserviceModule.v3.CustomerExtensionSettingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerextensionsettingserviceModule.v3.CustomerExtensionSettingServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerExtensionSetting', () => {
        it('invokes getCustomerExtensionSetting without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetCustomerExtensionSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.CustomerExtensionSetting());
        ...
        it('invokes getCustomerExtensionSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.ICustomerExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerExtensionSettings', () => {
        it('invokes mutateCustomerExtensionSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateCustomerExtensionSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateCustomerExtensionSettingsResponse());
        ...
        it('invokes mutateCustomerExtensionSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateCustomerExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
