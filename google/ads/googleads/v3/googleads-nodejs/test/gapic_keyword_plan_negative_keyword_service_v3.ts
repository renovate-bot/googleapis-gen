...
import * as keywordplannegativekeywordserviceModule from '../src';
...
describe('v3.KeywordPlanNegativeKeywordServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplannegativekeywordserviceModule.v3.KeywordPlanNegativeKeywordServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplannegativekeywordserviceModule.v3.KeywordPlanNegativeKeywordServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplannegativekeywordserviceModule.v3.KeywordPlanNegativeKeywordServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplannegativekeywordserviceModule.v3.KeywordPlanNegativeKeywordServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.keywordPlanNegativeKeywordServiceStub, undefined);
        await client.initialize();
        assert(client.keywordPlanNegativeKeywordServiceStub);
    });
    ...
    describe('getKeywordPlanNegativeKeyword', () => {
        it('invokes getKeywordPlanNegativeKeyword without error', async () => {
            const client = new keywordplannegativekeywordserviceModule.v3.KeywordPlanNegativeKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetKeywordPlanNegativeKeywordRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.KeywordPlanNegativeKeyword());
            client.innerApiCalls.getKeywordPlanNegativeKeyword = stubSimpleCall(expectedResponse);
            const [response] = await client.getKeywordPlanNegativeKeyword(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getKeywordPlanNegativeKeyword as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getKeywordPlanNegativeKeyword without error using callback', async () => {
            const client = new keywordplannegativekeywordserviceModule.v3.KeywordPlanNegativeKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.KeywordPlanNegativeKeyword());
            client.innerApiCalls.getKeywordPlanNegativeKeyword = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanNegativeKeyword(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IKeywordPlanNegativeKeyword|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getKeywordPlanNegativeKeyword with error', async () => {
            const client = new keywordplannegativekeywordserviceModule.v3.KeywordPlanNegativeKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getKeywordPlanNegativeKeyword = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getKeywordPlanNegativeKeyword(request), expectedError);
            assert((client.innerApiCalls.getKeywordPlanNegativeKeyword as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateKeywordPlanNegativeKeywords', () => {
        it('invokes mutateKeywordPlanNegativeKeywords without error', async () => {
            const client = new keywordplannegativekeywordserviceModule.v3.KeywordPlanNegativeKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateKeywordPlanNegativeKeywordsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateKeywordPlanNegativeKeywordsResponse());
            client.innerApiCalls.mutateKeywordPlanNegativeKeywords = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateKeywordPlanNegativeKeywords(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateKeywordPlanNegativeKeywords as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateKeywordPlanNegativeKeywords without error using callback', async () => {
            const client = new keywordplannegativekeywordserviceModule.v3.KeywordPlanNegativeKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateKeywordPlanNegativeKeywordsResponse());
            client.innerApiCalls.mutateKeywordPlanNegativeKeywords = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanNegativeKeywords(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateKeywordPlanNegativeKeywordsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateKeywordPlanNegativeKeywords with error', async () => {
            const client = new keywordplannegativekeywordserviceModule.v3.KeywordPlanNegativeKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateKeywordPlanNegativeKeywords = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateKeywordPlanNegativeKeywords(request), expectedError);
            assert((client.innerApiCalls.mutateKeywordPlanNegativeKeywords as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
