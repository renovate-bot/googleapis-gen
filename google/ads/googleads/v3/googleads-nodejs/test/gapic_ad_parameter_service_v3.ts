...
describe('v3.AdParameterServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adparameterserviceModule.v3.AdParameterServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adparameterserviceModule.v3.AdParameterServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adparameterserviceModule.v3.AdParameterServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adparameterserviceModule.v3.AdParameterServiceClient();
        assert(client);
    });
    ...
    describe('getAdParameter', () => {
        it('invokes getAdParameter without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetAdParameterRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.AdParameter());
        ...
        it('invokes getAdParameter without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdParameter(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IAdParameter|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdParameters', () => {
        it('invokes mutateAdParameters without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateAdParametersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateAdParametersResponse());
        ...
        it('invokes mutateAdParameters without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdParameters(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateAdParametersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
