...
describe('v3.ConversionUploadServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionuploadserviceModule.v3.ConversionUploadServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionuploadserviceModule.v3.ConversionUploadServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionuploadserviceModule.v3.ConversionUploadServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionuploadserviceModule.v3.ConversionUploadServiceClient();
        assert(client);
    });
    ...
    describe('uploadClickConversions', () => {
        it('invokes uploadClickConversions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.UploadClickConversionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.UploadClickConversionsResponse());
        ...
        it('invokes uploadClickConversions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.uploadClickConversions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IUploadClickConversionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('uploadCallConversions', () => {
        it('invokes uploadCallConversions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.UploadCallConversionsRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.UploadCallConversionsResponse());
        ...
        it('invokes uploadCallConversions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.uploadCallConversions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IUploadCallConversionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
