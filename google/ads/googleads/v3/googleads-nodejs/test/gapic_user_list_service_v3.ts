...
import * as userlistserviceModule from '../src';
...
describe('v3.UserListServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = userlistserviceModule.v3.UserListServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = userlistserviceModule.v3.UserListServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = userlistserviceModule.v3.UserListServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new userlistserviceModule.v3.UserListServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.userListServiceStub, undefined);
        await client.initialize();
        assert(client.userListServiceStub);
    });
    ...
    describe('getUserList', () => {
        it('invokes getUserList without error', async () => {
            const client = new userlistserviceModule.v3.UserListServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetUserListRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.UserList());
            client.innerApiCalls.getUserList = stubSimpleCall(expectedResponse);
            const [response] = await client.getUserList(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getUserList as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getUserList without error using callback', async () => {
            const client = new userlistserviceModule.v3.UserListServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.UserList());
            client.innerApiCalls.getUserList = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getUserList(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IUserList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getUserList with error', async () => {
            const client = new userlistserviceModule.v3.UserListServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getUserList = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getUserList(request), expectedError);
            assert((client.innerApiCalls.getUserList as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateUserLists', () => {
        it('invokes mutateUserLists without error', async () => {
            const client = new userlistserviceModule.v3.UserListServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateUserListsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateUserListsResponse());
            client.innerApiCalls.mutateUserLists = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateUserLists(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateUserLists as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateUserLists without error using callback', async () => {
            const client = new userlistserviceModule.v3.UserListServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateUserListsResponse());
            client.innerApiCalls.mutateUserLists = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateUserLists(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateUserListsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateUserLists with error', async () => {
            const client = new userlistserviceModule.v3.UserListServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateUserLists = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateUserLists(request), expectedError);
            assert((client.innerApiCalls.mutateUserLists as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
