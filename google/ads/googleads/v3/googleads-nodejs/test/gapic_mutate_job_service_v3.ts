...
import * as mutatejobserviceModule from '../src';
...
describe('v3.MutateJobServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = mutatejobserviceModule.v3.MutateJobServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = mutatejobserviceModule.v3.MutateJobServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = mutatejobserviceModule.v3.MutateJobServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new mutatejobserviceModule.v3.MutateJobServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.mutateJobServiceStub, undefined);
        await client.initialize();
        assert(client.mutateJobServiceStub);
    });
    ...
    describe('createMutateJob', () => {
        it('invokes createMutateJob without error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.CreateMutateJobRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.CreateMutateJobResponse());
            client.innerApiCalls.createMutateJob = stubSimpleCall(expectedResponse);
            const [response] = await client.createMutateJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createMutateJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes createMutateJob without error using callback', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.CreateMutateJobResponse());
            client.innerApiCalls.createMutateJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createMutateJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.ICreateMutateJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createMutateJob with error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createMutateJob = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createMutateJob(request), expectedError);
            assert((client.innerApiCalls.createMutateJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('getMutateJob', () => {
        it('invokes getMutateJob without error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetMutateJobRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.MutateJob());
            client.innerApiCalls.getMutateJob = stubSimpleCall(expectedResponse);
            const [response] = await client.getMutateJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getMutateJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getMutateJob without error using callback', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.MutateJob());
            client.innerApiCalls.getMutateJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMutateJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IMutateJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMutateJob with error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.getMutateJob = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getMutateJob(request), expectedError);
            assert((client.innerApiCalls.getMutateJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('addMutateJobOperations', () => {
        it('invokes addMutateJobOperations without error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.AddMutateJobOperationsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.AddMutateJobOperationsResponse());
            client.innerApiCalls.addMutateJobOperations = stubSimpleCall(expectedResponse);
            const [response] = await client.addMutateJobOperations(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.addMutateJobOperations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes addMutateJobOperations without error using callback', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.AddMutateJobOperationsResponse());
            client.innerApiCalls.addMutateJobOperations = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.addMutateJobOperations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IAddMutateJobOperationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes addMutateJobOperations with error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.addMutateJobOperations = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.addMutateJobOperations(request), expectedError);
            assert((client.innerApiCalls.addMutateJobOperations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('runMutateJob', () => {
        it('invokes runMutateJob without error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.RunMutateJobRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            client.innerApiCalls.runMutateJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.runMutateJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runMutateJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes runMutateJob without error using callback', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.runMutateJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.runMutateJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v3.resources.MutateJob.IMutateJobMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v3.resources.MutateJob.IMutateJobMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runMutateJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes runMutateJob with call error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.runMutateJob = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.runMutateJob(request), expectedError);
            assert((client.innerApiCalls.runMutateJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes runMutateJob with LRO error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.runMutateJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.runMutateJob(request);
        ...
        it('invokes checkRunMutateJobProgress without error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkRunMutateJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkRunMutateJobProgress with error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkRunMutateJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listMutateJobResults', () => {
        it('invokes listMutateJobResults without error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.ListMutateJobResultsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateJobResult()),
              generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateJobResult()),
              generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateJobResult()),
            ];
            client.innerApiCalls.listMutateJobResults = stubSimpleCall(expectedResponse);
            const [response] = await client.listMutateJobResults(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listMutateJobResults as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listMutateJobResults without error using callback', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listMutateJobResults = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listMutateJobResults(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateJobResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listMutateJobResults with error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listMutateJobResults = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listMutateJobResults(request), expectedError);
            assert((client.innerApiCalls.listMutateJobResults as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listMutateJobResultsStream without error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listMutateJobResults.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listMutateJobResultsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v3.services.MutateJobResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v3.services.MutateJobResult) => {
            ...
            assert((client.descriptors.page.listMutateJobResults.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listMutateJobResults, request));
            assert.strictEqual(
                (client.descriptors.page.listMutateJobResults.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });

        it('invokes listMutateJobResultsStream with error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = "resource_name=";
            const expectedError = new Error('expected');
            client.descriptors.page.listMutateJobResults.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listMutateJobResultsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v3.services.MutateJobResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v3.services.MutateJobResult) => {
        ...
        it('uses async iteration with listMutateJobResults without error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listMutateJobResults.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.ads.googleads.v3.services.IMutateJobResult[] = [];
            const iterable = client.listMutateJobResultsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listMutateJobResults.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listMutateJobResults with error', async () => {
            const client = new mutatejobserviceModule.v3.MutateJobServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listMutateJobResults.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listMutateJobResultsAsync(request);
