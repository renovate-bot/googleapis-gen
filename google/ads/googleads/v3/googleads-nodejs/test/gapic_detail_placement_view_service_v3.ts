...
import * as detailplacementviewserviceModule from '../src';
...
describe('v3.DetailPlacementViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = detailplacementviewserviceModule.v3.DetailPlacementViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = detailplacementviewserviceModule.v3.DetailPlacementViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = detailplacementviewserviceModule.v3.DetailPlacementViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new detailplacementviewserviceModule.v3.DetailPlacementViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.detailPlacementViewServiceStub, undefined);
        await client.initialize();
        assert(client.detailPlacementViewServiceStub);
    });
    ...
    describe('getDetailPlacementView', () => {
        it('invokes getDetailPlacementView without error', async () => {
            const client = new detailplacementviewserviceModule.v3.DetailPlacementViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetDetailPlacementViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.DetailPlacementView());
            client.innerApiCalls.getDetailPlacementView = stubSimpleCall(expectedResponse);
            const [response] = await client.getDetailPlacementView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getDetailPlacementView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getDetailPlacementView without error using callback', async () => {
            const client = new detailplacementviewserviceModule.v3.DetailPlacementViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.DetailPlacementView());
            client.innerApiCalls.getDetailPlacementView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDetailPlacementView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IDetailPlacementView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDetailPlacementView with error', async () => {
            const client = new detailplacementviewserviceModule.v3.DetailPlacementViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getDetailPlacementView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDetailPlacementView(request), expectedError);
            assert((client.innerApiCalls.getDetailPlacementView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
