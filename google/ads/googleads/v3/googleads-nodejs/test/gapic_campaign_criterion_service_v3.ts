...
describe('v3.CampaignCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaigncriterionserviceModule.v3.CampaignCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaigncriterionserviceModule.v3.CampaignCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaigncriterionserviceModule.v3.CampaignCriterionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaigncriterionserviceModule.v3.CampaignCriterionServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignCriterion', () => {
        it('invokes getCampaignCriterion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetCampaignCriterionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.CampaignCriterion());
        ...
        it('invokes getCampaignCriterion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.ICampaignCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignCriteria', () => {
        it('invokes mutateCampaignCriteria without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateCampaignCriteriaRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateCampaignCriteriaResponse());
        ...
        it('invokes mutateCampaignCriteria without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateCampaignCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
