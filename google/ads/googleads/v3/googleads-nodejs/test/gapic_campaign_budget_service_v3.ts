...
describe('v3.CampaignBudgetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignbudgetserviceModule.v3.CampaignBudgetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignbudgetserviceModule.v3.CampaignBudgetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignbudgetserviceModule.v3.CampaignBudgetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignbudgetserviceModule.v3.CampaignBudgetServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignBudget', () => {
        it('invokes getCampaignBudget without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetCampaignBudgetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.CampaignBudget());
        ...
        it('invokes getCampaignBudget without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignBudget(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.ICampaignBudget|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignBudgets', () => {
        it('invokes mutateCampaignBudgets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateCampaignBudgetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateCampaignBudgetsResponse());
        ...
        it('invokes mutateCampaignBudgets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignBudgets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateCampaignBudgetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
