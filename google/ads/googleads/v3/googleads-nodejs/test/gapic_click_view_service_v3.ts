...
describe('v3.ClickViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = clickviewserviceModule.v3.ClickViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = clickviewserviceModule.v3.ClickViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = clickviewserviceModule.v3.ClickViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new clickviewserviceModule.v3.ClickViewServiceClient();
        assert(client);
    });
    ...
    describe('getClickView', () => {
        it('invokes getClickView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetClickViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.ClickView());
        ...
        it('invokes getClickView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getClickView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IClickView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
