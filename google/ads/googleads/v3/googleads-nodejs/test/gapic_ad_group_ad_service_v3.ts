...
import * as adgroupadserviceModule from '../src';
...
describe('v3.AdGroupAdServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupadserviceModule.v3.AdGroupAdServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupadserviceModule.v3.AdGroupAdServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupadserviceModule.v3.AdGroupAdServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupadserviceModule.v3.AdGroupAdServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupAdServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupAdServiceStub);
    });
    ...
    describe('getAdGroupAd', () => {
        it('invokes getAdGroupAd without error', async () => {
            const client = new adgroupadserviceModule.v3.AdGroupAdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetAdGroupAdRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.AdGroupAd());
            client.innerApiCalls.getAdGroupAd = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupAd(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupAd as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupAd without error using callback', async () => {
            const client = new adgroupadserviceModule.v3.AdGroupAdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.AdGroupAd());
            client.innerApiCalls.getAdGroupAd = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAd(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IAdGroupAd|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupAd with error', async () => {
            const client = new adgroupadserviceModule.v3.AdGroupAdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getAdGroupAd = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupAd(request), expectedError);
            assert((client.innerApiCalls.getAdGroupAd as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAdGroupAds', () => {
        it('invokes mutateAdGroupAds without error', async () => {
            const client = new adgroupadserviceModule.v3.AdGroupAdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateAdGroupAdsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateAdGroupAdsResponse());
            client.innerApiCalls.mutateAdGroupAds = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupAds(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupAds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroupAds without error using callback', async () => {
            const client = new adgroupadserviceModule.v3.AdGroupAdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateAdGroupAdsResponse());
            client.innerApiCalls.mutateAdGroupAds = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupAds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateAdGroupAdsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupAds with error', async () => {
            const client = new adgroupadserviceModule.v3.AdGroupAdServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdGroupAds = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupAds(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupAds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
