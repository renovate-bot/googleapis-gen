...
describe('v3.KeywordPlanIdeaServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanideaserviceModule.v3.KeywordPlanIdeaServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanideaserviceModule.v3.KeywordPlanIdeaServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanideaserviceModule.v3.KeywordPlanIdeaServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplanideaserviceModule.v3.KeywordPlanIdeaServiceClient();
        assert(client);
    });
    ...
    describe('generateKeywordIdeas', () => {
        it('invokes generateKeywordIdeas without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GenerateKeywordIdeasRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.GenerateKeywordIdeaResponse());
        ...
        it('invokes generateKeywordIdeas without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateKeywordIdeas(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IGenerateKeywordIdeaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
