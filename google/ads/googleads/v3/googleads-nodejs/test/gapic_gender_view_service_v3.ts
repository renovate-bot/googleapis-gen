...
import * as genderviewserviceModule from '../src';
...
describe('v3.GenderViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = genderviewserviceModule.v3.GenderViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = genderviewserviceModule.v3.GenderViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = genderviewserviceModule.v3.GenderViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new genderviewserviceModule.v3.GenderViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.genderViewServiceStub, undefined);
        await client.initialize();
        assert(client.genderViewServiceStub);
    });
    ...
    describe('getGenderView', () => {
        it('invokes getGenderView without error', async () => {
            const client = new genderviewserviceModule.v3.GenderViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetGenderViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.GenderView());
            client.innerApiCalls.getGenderView = stubSimpleCall(expectedResponse);
            const [response] = await client.getGenderView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getGenderView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getGenderView without error using callback', async () => {
            const client = new genderviewserviceModule.v3.GenderViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.GenderView());
            client.innerApiCalls.getGenderView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGenderView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IGenderView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGenderView with error', async () => {
            const client = new genderviewserviceModule.v3.GenderViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getGenderView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getGenderView(request), expectedError);
            assert((client.innerApiCalls.getGenderView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
