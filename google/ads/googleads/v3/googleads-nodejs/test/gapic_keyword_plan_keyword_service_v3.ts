...
import * as keywordplankeywordserviceModule from '../src';
...
describe('v3.KeywordPlanKeywordServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplankeywordserviceModule.v3.KeywordPlanKeywordServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplankeywordserviceModule.v3.KeywordPlanKeywordServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplankeywordserviceModule.v3.KeywordPlanKeywordServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplankeywordserviceModule.v3.KeywordPlanKeywordServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.keywordPlanKeywordServiceStub, undefined);
        await client.initialize();
        assert(client.keywordPlanKeywordServiceStub);
    });
    ...
    describe('getKeywordPlanKeyword', () => {
        it('invokes getKeywordPlanKeyword without error', async () => {
            const client = new keywordplankeywordserviceModule.v3.KeywordPlanKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetKeywordPlanKeywordRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.KeywordPlanKeyword());
            client.innerApiCalls.getKeywordPlanKeyword = stubSimpleCall(expectedResponse);
            const [response] = await client.getKeywordPlanKeyword(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getKeywordPlanKeyword as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getKeywordPlanKeyword without error using callback', async () => {
            const client = new keywordplankeywordserviceModule.v3.KeywordPlanKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.KeywordPlanKeyword());
            client.innerApiCalls.getKeywordPlanKeyword = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanKeyword(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IKeywordPlanKeyword|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getKeywordPlanKeyword with error', async () => {
            const client = new keywordplankeywordserviceModule.v3.KeywordPlanKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getKeywordPlanKeyword = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getKeywordPlanKeyword(request), expectedError);
            assert((client.innerApiCalls.getKeywordPlanKeyword as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateKeywordPlanKeywords', () => {
        it('invokes mutateKeywordPlanKeywords without error', async () => {
            const client = new keywordplankeywordserviceModule.v3.KeywordPlanKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateKeywordPlanKeywordsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateKeywordPlanKeywordsResponse());
            client.innerApiCalls.mutateKeywordPlanKeywords = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateKeywordPlanKeywords(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateKeywordPlanKeywords as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateKeywordPlanKeywords without error using callback', async () => {
            const client = new keywordplankeywordserviceModule.v3.KeywordPlanKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.MutateKeywordPlanKeywordsResponse());
            client.innerApiCalls.mutateKeywordPlanKeywords = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanKeywords(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IMutateKeywordPlanKeywordsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateKeywordPlanKeywords with error', async () => {
            const client = new keywordplankeywordserviceModule.v3.KeywordPlanKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateKeywordPlanKeywords = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateKeywordPlanKeywords(request), expectedError);
            assert((client.innerApiCalls.mutateKeywordPlanKeywords as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
