...
describe('v3.CustomerClientServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerclientserviceModule.v3.CustomerClientServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerclientserviceModule.v3.CustomerClientServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerclientserviceModule.v3.CustomerClientServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerclientserviceModule.v3.CustomerClientServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerClient', () => {
        it('invokes getCustomerClient without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetCustomerClientRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.CustomerClient());
        ...
        it('invokes getCustomerClient without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerClient(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.ICustomerClient|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
