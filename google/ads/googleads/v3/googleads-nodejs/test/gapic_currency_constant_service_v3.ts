...
describe('v3.CurrencyConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = currencyconstantserviceModule.v3.CurrencyConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = currencyconstantserviceModule.v3.CurrencyConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = currencyconstantserviceModule.v3.CurrencyConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new currencyconstantserviceModule.v3.CurrencyConstantServiceClient();
        assert(client);
    });
    ...
    describe('getCurrencyConstant', () => {
        it('invokes getCurrencyConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetCurrencyConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.CurrencyConstant());
        ...
        it('invokes getCurrencyConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCurrencyConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.ICurrencyConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
