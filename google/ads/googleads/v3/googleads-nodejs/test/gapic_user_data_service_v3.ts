...
import * as userdataserviceModule from '../src';
...
describe('v3.UserDataServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = userdataserviceModule.v3.UserDataServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = userdataserviceModule.v3.UserDataServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = userdataserviceModule.v3.UserDataServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new userdataserviceModule.v3.UserDataServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.userDataServiceStub, undefined);
        await client.initialize();
        assert(client.userDataServiceStub);
    });
    ...
    describe('uploadUserData', () => {
        it('invokes uploadUserData without error', async () => {
            const client = new userdataserviceModule.v3.UserDataServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.UploadUserDataRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.UploadUserDataResponse());
            client.innerApiCalls.uploadUserData = stubSimpleCall(expectedResponse);
            const [response] = await client.uploadUserData(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.uploadUserData as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes uploadUserData without error using callback', async () => {
            const client = new userdataserviceModule.v3.UserDataServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.UploadUserDataResponse());
            client.innerApiCalls.uploadUserData = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.uploadUserData(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.IUploadUserDataResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes uploadUserData with error', async () => {
            const client = new userdataserviceModule.v3.UserDataServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.uploadUserData = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.uploadUserData(request), expectedError);
            assert((client.innerApiCalls.uploadUserData as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
