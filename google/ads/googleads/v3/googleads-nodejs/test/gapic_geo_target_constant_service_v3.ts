...
describe('v3.GeoTargetConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = geotargetconstantserviceModule.v3.GeoTargetConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = geotargetconstantserviceModule.v3.GeoTargetConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = geotargetconstantserviceModule.v3.GeoTargetConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new geotargetconstantserviceModule.v3.GeoTargetConstantServiceClient();
        assert(client);
    });
    ...
    describe('getGeoTargetConstant', () => {
        it('invokes getGeoTargetConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetGeoTargetConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.GeoTargetConstant());
        ...
        it('invokes getGeoTargetConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGeoTargetConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IGeoTargetConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestGeoTargetConstants', () => {
        it('invokes suggestGeoTargetConstants without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.SuggestGeoTargetConstantsRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.services.SuggestGeoTargetConstantsResponse());
        ...
        it('invokes suggestGeoTargetConstants without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestGeoTargetConstants(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.services.ISuggestGeoTargetConstantsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
