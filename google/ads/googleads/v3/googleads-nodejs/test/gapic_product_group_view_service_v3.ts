...
describe('v3.ProductGroupViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = productgroupviewserviceModule.v3.ProductGroupViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = productgroupviewserviceModule.v3.ProductGroupViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = productgroupviewserviceModule.v3.ProductGroupViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new productgroupviewserviceModule.v3.ProductGroupViewServiceClient();
        assert(client);
    });
    ...
    describe('getProductGroupView', () => {
        it('invokes getProductGroupView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v3.services.GetProductGroupViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v3.resources.ProductGroupView());
        ...
        it('invokes getProductGroupView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getProductGroupView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v3.resources.IProductGroupView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
