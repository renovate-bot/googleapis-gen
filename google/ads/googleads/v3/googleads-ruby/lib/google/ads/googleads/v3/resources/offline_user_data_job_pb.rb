...
require 'google/ads/googleads/v3/common/offline_user_data_pb'
require 'google/ads/googleads/v3/enums/offline_user_data_job_failure_reason_pb'
require 'google/ads/googleads/v3/enums/offline_user_data_job_status_pb'
require 'google/ads/googleads/v3/enums/offline_user_data_job_type_pb'
require 'google/api/field_behavior_pb'
require 'google/api/resource_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v3/resources/offline_user_data_job.proto", :syntax => :proto3) do
