...
# Source: google/ads/googleads/v3/services/google_ads_service.proto for package 'Google.Ads.GoogleAds.V3.Services'
        ...
        module Services
          module GoogleAdsService
            ...
            class Service
              ...
              self.service_name = 'google.ads.googleads.v3.services.GoogleAdsService'

              # Returns all rows that match the search query.
              rpc :Search, ::Google::Ads::GoogleAds::V3::Services::SearchGoogleAdsRequest, ::Google::Ads::GoogleAds::V3::Services::SearchGoogleAdsResponse
              # Returns all rows that match the search stream query.
              rpc :SearchStream, ::Google::Ads::GoogleAds::V3::Services::SearchGoogleAdsStreamRequest, stream(::Google::Ads::GoogleAds::V3::Services::SearchGoogleAdsStreamResponse)
              ...
              rpc :Mutate, ::Google::Ads::GoogleAds::V3::Services::MutateGoogleAdsRequest, ::Google::Ads::GoogleAds::V3::Services::MutateGoogleAdsResponse
            end
