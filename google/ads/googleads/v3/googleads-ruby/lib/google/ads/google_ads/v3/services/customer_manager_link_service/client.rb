        ...
        module Services
          module CustomerManagerLinkService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V3::Services::CustomerManagerLinkService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V3::Services::CustomerManagerLinkService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V3::Services::CustomerManagerLinkService::Client.new
              #
              ...
              def initialize
                ...
                @customer_manager_link_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V3::Services::CustomerManagerLinkService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V3::Services::GetCustomerManagerLinkRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V3::Services::GetCustomerManagerLinkRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V3::Resources::CustomerManagerLink]
              ...
              def get_customer_manager_link request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V3::Services::GetCustomerManagerLinkRequest
              ...
              #   {::Google::Ads::GoogleAds::V3::Services::MutateCustomerManagerLinkRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V3::Services::MutateCustomerManagerLinkRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V3::Services::CustomerManagerLinkOperation, ::Hash>]
              #     Required. The list of operations to perform on individual customer manager links.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V3::Services::MutateCustomerManagerLinkResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_customer_manager_link request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V3::Services::MutateCustomerManagerLinkRequest
              ...
              #   {::Google::Ads::GoogleAds::V3::Services::MoveManagerLinkRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V3::Services::MoveManagerLinkRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload move_manager_link(customer_id: nil, previous_customer_manager_link: nil, new_manager: nil)
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V3::Services::MoveManagerLinkResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def move_manager_link request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V3::Services::MoveManagerLinkRequest
                ...
                @customer_manager_link_service_stub.call_rpc :move_manager_link, request, options: options do |response, operation|
                  yield response, operation if block_given?
                  return response
                end
                # rescue GRPC::BadStatus => grpc_error
              ...
              # {::Google::Ads::GoogleAds::V3::Services::CustomerManagerLinkService::Client::Configuration::Rpcs}
