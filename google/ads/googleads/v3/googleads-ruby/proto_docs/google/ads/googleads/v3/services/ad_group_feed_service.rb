...
module Google
  module Ads
    module GoogleAds
      module V3
        module Services
          # Request message for {::Google::Ads::GoogleAds::V3::Services::AdGroupFeedService::Client#get_ad_group_feed AdGroupFeedService.GetAdGroupFeed}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V3::Services::AdGroupFeedService::Client#mutate_ad_group_feeds AdGroupFeedService.MutateAdGroupFeeds}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose ad group feeds are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V3::Services::AdGroupFeedOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V3::Services::MutateAdGroupFeedResult>]
