...
module Google
  module Ads
    module GoogleAds
      module V3
        module Services
          # Request message for {::Google::Ads::GoogleAds::V3::Services::SharedCriterionService::Client#get_shared_criterion SharedCriterionService.GetSharedCriterion}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V3::Services::SharedCriterionService::Client#mutate_shared_criteria SharedCriterionService.MutateSharedCriteria}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose shared criteria are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V3::Services::SharedCriterionOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V3::Services::MutateSharedCriterionResult>]
