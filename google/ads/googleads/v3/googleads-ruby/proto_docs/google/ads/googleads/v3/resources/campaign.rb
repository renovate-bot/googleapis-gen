    ...
    module GoogleAds
      module V3
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V3::Enums::CampaignStatusEnum::CampaignStatus]
          #     The status of the campaign.
          #
          #     When a new campaign is added, the status defaults to ENABLED.
          # @!attribute [r] serving_status
          #   @return [::Google::Ads::GoogleAds::V3::Enums::CampaignServingStatusEnum::CampaignServingStatus]
          #     Output only. The ad serving status of the campaign.
          # @!attribute [rw] ad_serving_optimization_status
          #   @return [::Google::Ads::GoogleAds::V3::Enums::AdServingOptimizationStatusEnum::AdServingOptimizationStatus]
          ...
          #   @return [::Google::Ads::GoogleAds::V3::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType]
          ...
          #   @return [::Google::Ads::GoogleAds::V3::Enums::CampaignExperimentTypeEnum::CampaignExperimentType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V3::Common::FrequencyCapEntry>]
          #     A list that limits how often each user will see this campaign's ads.
          # @!attribute [r] video_brand_safety_suitability
          #   @return [::Google::Ads::GoogleAds::V3::Enums::BrandSafetySuitabilityEnum::BrandSafetySuitability]
          ...
          #   @return [::Google::Ads::GoogleAds::V3::Enums::PaymentModeEnum::PaymentMode]
          ...
          class Campaign
            ...
            #   @return [::Google::Ads::GoogleAds::V3::Enums::VanityPharmaDisplayUrlModeEnum::VanityPharmaDisplayUrlMode]
            #     The display mode for vanity pharma URLs.
            # @!attribute [rw] vanity_pharma_text
            #   @return [::Google::Ads::GoogleAds::V3::Enums::VanityPharmaTextEnum::VanityPharmaText]
            ...
            #   @return [::Google::Ads::GoogleAds::V3::Enums::PositiveGeoTargetTypeEnum::PositiveGeoTargetType]
            #     The setting used for positive geotargeting in this particular campaign.
            # @!attribute [rw] negative_geo_target_type
            #   @return [::Google::Ads::GoogleAds::V3::Enums::NegativeGeoTargetTypeEnum::NegativeGeoTargetType]
            ...
            #   @return [::Google::Ads::GoogleAds::V3::Enums::AppCampaignBiddingStrategyGoalTypeEnum::AppCampaignBiddingStrategyGoalType]
            ...
            #   @return [::Google::Ads::GoogleAds::V3::Enums::AppCampaignAppStoreEnum::AppCampaignAppStore]
