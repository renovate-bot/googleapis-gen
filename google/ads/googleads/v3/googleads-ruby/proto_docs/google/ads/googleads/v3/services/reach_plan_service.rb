...
module Google
  module Ads
    module GoogleAds
      module V3
        module Services
          # Request message for {::Google::Ads::GoogleAds::V3::Services::ReachPlanService::Client#list_plannable_locations ReachPlanService.ListPlannableLocations}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V3::Services::ReachPlanService::Client#generate_product_mix_ideas ReachPlanService.GenerateProductMixIdeas}.
