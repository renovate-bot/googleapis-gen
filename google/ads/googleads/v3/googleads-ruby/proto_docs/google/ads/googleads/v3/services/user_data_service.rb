...
module Google
  module Ads
    module GoogleAds
      module V3
        module Services
          # Request message for {::Google::Ads::GoogleAds::V3::Services::UserDataService::Client#upload_user_data UserDataService.UploadUserData}
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer for which to update the user data.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V3::Services::UserDataOperation>]
          ...
          # Response message for {::Google::Ads::GoogleAds::V3::Services::UserDataService::Client#upload_user_data UserDataService.UploadUserData}
