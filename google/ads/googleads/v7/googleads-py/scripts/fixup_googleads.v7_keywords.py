...
class googleadsCallTransformer(cst.CSTTransformer):
    ...
    'add_offline_user_data_job_operations': ('resource_name', 'operations', 'enable_partial_failure', 'validate_only', ),
    ...
    'create_offline_user_data_job': ('customer_id', 'job', 'validate_only', ),
    ...
    'mutate_ad_group_assets': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
    ...
    'mutate_customer_assets': ('customer_id', 'operations', 'partial_failure', 'validate_only', ),
