...
class AdGroupAsset(proto.Message):
    ...
    Attributes:
        ...
        field_type (google.ads.googleads.v7.enums.types.AssetFieldTypeEnum.AssetFieldType):
            Required. Immutable. Role that the asset
            takes under the linked ad group.
        status (google.ads.googleads.v7.enums.types.AssetLinkStatusEnum.AssetLinkStatus):
