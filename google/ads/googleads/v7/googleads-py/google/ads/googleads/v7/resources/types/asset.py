...
class Asset(proto.Message):
    ...
    url_custom_parameters = proto.RepeatedField(proto.MESSAGE, number=18,
    ...
    promotion_asset = proto.Field(proto.MESSAGE, number=15, oneof='asset_data',
        message=asset_types.PromotionAsset,
    )
    callout_asset = proto.Field(proto.MESSAGE, number=20, oneof='asset_data',
        message=asset_types.CalloutAsset,
    )
    structured_snippet_asset = proto.Field(proto.MESSAGE, number=21, oneof='asset_data',
        message=asset_types.StructuredSnippetAsset,
    )
    sitelink_asset = proto.Field(proto.MESSAGE, number=22, oneof='asset_data',
