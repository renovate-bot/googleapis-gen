...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def get_campaign_feed(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignFeed:
                A campaign feed.
        """
    ...
    def mutate_campaign_feeds(self,
        ...
        r"""Creates, updates, or removes campaign feeds. Operation statuses
        are returned.
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignFeedsResponse:
