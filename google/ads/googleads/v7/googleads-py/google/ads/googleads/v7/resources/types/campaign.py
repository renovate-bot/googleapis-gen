...
from google.ads.googleads.v7.common.types import real_time_bidding_setting as gagc_real_time_bidding_setting
from google.ads.googleads.v7.common.types import targeting_setting as gagc_targeting_setting
from google.ads.googleads.v7.enums.types import ad_serving_optimization_status as gage_ad_serving_optimization_status
from google.ads.googleads.v7.enums.types import advertising_channel_sub_type as gage_advertising_channel_sub_type
from google.ads.googleads.v7.enums.types import advertising_channel_type as gage_advertising_channel_type
...
from google.ads.googleads.v7.enums.types import bidding_strategy_type as gage_bidding_strategy_type
...
from google.ads.googleads.v7.enums.types import location_source_type as gage_location_source_type
from google.ads.googleads.v7.enums.types import negative_geo_target_type as gage_negative_geo_target_type
from google.ads.googleads.v7.enums.types import optimization_goal_type
from google.ads.googleads.v7.enums.types import payment_mode as gage_payment_mode
from google.ads.googleads.v7.enums.types import positive_geo_target_type as gage_positive_geo_target_type
from google.ads.googleads.v7.enums.types import vanity_pharma_display_url_mode as gage_vanity_pharma_display_url_mode
from google.ads.googleads.v7.enums.types import vanity_pharma_text as gage_vanity_pharma_text
...
class Campaign(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v7.enums.types.CampaignStatusEnum.CampaignStatus):
            The status of the campaign.
            When a new campaign is added, the status
            defaults to ENABLED.
        serving_status (google.ads.googleads.v7.enums.types.CampaignServingStatusEnum.CampaignServingStatus):
            Output only. The ad serving status of the
            campaign.
        ad_serving_optimization_status (google.ads.googleads.v7.enums.types.AdServingOptimizationStatusEnum.AdServingOptimizationStatus):
            The ad serving optimization status of the
            campaign.
        advertising_channel_type (google.ads.googleads.v7.enums.types.AdvertisingChannelTypeEnum.AdvertisingChannelType):
        ...
        advertising_channel_sub_type (google.ads.googleads.v7.enums.types.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType):
        ...
        url_custom_parameters (Sequence[google.ads.googleads.v7.common.types.CustomParameter]):
            ...
            ``mobile_final_urls``.
        real_time_bidding_setting (google.ads.googleads.v7.common.types.RealTimeBiddingSetting):
            Settings for Real-Time Bidding, a feature
            only available for campaigns targeting the Ad
            Exchange network.
        network_settings (google.ads.googleads.v7.resources.types.Campaign.NetworkSettings):
            The network settings for the campaign.
        hotel_setting (google.ads.googleads.v7.resources.types.Campaign.HotelSettingInfo):
            Immutable. The hotel setting for the
            campaign.
        dynamic_search_ads_setting (google.ads.googleads.v7.resources.types.Campaign.DynamicSearchAdsSetting):
            The setting for controlling Dynamic Search
            Ads (DSA).
        shopping_setting (google.ads.googleads.v7.resources.types.Campaign.ShoppingSetting):
            The setting for controlling Shopping
            campaigns.
        targeting_setting (google.ads.googleads.v7.common.types.TargetingSetting):
            Setting for targeting related features.
        geo_target_type_setting (google.ads.googleads.v7.resources.types.Campaign.GeoTargetTypeSetting):
            The setting for ads geotargeting.
        local_campaign_setting (google.ads.googleads.v7.resources.types.Campaign.LocalCampaignSetting):
            The setting for local campaign.
        app_campaign_setting (google.ads.googleads.v7.resources.types.Campaign.AppCampaignSetting):
            The setting related to App Campaign.
        labels (Sequence[str]):
            Output only. The resource names of labels
            attached to this campaign.
        experiment_type (google.ads.googleads.v7.enums.types.CampaignExperimentTypeEnum.CampaignExperimentType):
        ...
        bidding_strategy_type (google.ads.googleads.v7.enums.types.BiddingStrategyTypeEnum.BiddingStrategyType):
        ...
        final_url_suffix (str):
            ...
            tracking.
        frequency_caps (Sequence[google.ads.googleads.v7.common.types.FrequencyCapEntry]):
            A list that limits how often each user will
            see this campaign's ads.
        video_brand_safety_suitability (google.ads.googleads.v7.enums.types.BrandSafetySuitabilityEnum.BrandSafetySuitability):
            Output only. 3-Tier Brand Safety setting for
            the campaign.
        vanity_pharma (google.ads.googleads.v7.resources.types.Campaign.VanityPharma):
            Describes how unbranded pharma ads will be
            displayed.
        selective_optimization (google.ads.googleads.v7.resources.types.Campaign.SelectiveOptimization):
        ...
        optimization_goal_setting (google.ads.googleads.v7.resources.types.Campaign.OptimizationGoalSetting):
            Optimization goal setting for this campaign,
            which includes a set of optimization goal types.
        tracking_setting (google.ads.googleads.v7.resources.types.Campaign.TrackingSetting):
            Output only. Campaign-level settings for
            tracking information.
        payment_mode (google.ads.googleads.v7.enums.types.PaymentModeEnum.PaymentMode):
        ...
        optimization_score (float):
            ...
            ads/answer/9061546.
            This field is read-only.
        excluded_parent_asset_field_types (Sequence[google.ads.googleads.v7.enums.types.AssetFieldTypeEnum.AssetFieldType]):
        ...
        commission (google.ads.googleads.v7.common.types.Commission):
            Commission is an automatic bidding strategy
            in which the advertiser pays a certain portion
            of the conversion value.
        manual_cpc (google.ads.googleads.v7.common.types.ManualCpc):
            Standard Manual CPC bidding strategy.
            Manual click-based bidding where user pays per
            click.
        manual_cpm (google.ads.googleads.v7.common.types.ManualCpm):
            Standard Manual CPM bidding strategy.
            Manual impression-based bidding where user pays
            per thousand impressions.
        manual_cpv (google.ads.googleads.v7.common.types.ManualCpv):
            Output only. A bidding strategy that pays a
            configurable amount per video view.
        maximize_conversions (google.ads.googleads.v7.common.types.MaximizeConversions):
        ...
        maximize_conversion_value (google.ads.googleads.v7.common.types.MaximizeConversionValue):
        ...
        target_cpa (google.ads.googleads.v7.common.types.TargetCpa):
        ...
        target_impression_share (google.ads.googleads.v7.common.types.TargetImpressionShare):
        ...
        target_roas (google.ads.googleads.v7.common.types.TargetRoas):
        ...
        target_spend (google.ads.googleads.v7.common.types.TargetSpend):
        ...
        percent_cpc (google.ads.googleads.v7.common.types.PercentCpc):
            Standard Percent Cpc bidding strategy where
            bids are a fraction of the advertised price for
            some good or service.
        target_cpm (google.ads.googleads.v7.common.types.TargetCpm):
    ...
    class NetworkSettings(proto.Message):
        ...
        target_content_network = proto.Field(proto.BOOL, number=7, optional=True)
    ...
    class DynamicSearchAdsSetting(proto.Message):
        ...
        use_supplied_urls_only = proto.Field(proto.BOOL, number=8, optional=True)
    ...
    class GeoTargetTypeSetting(proto.Message):
        ...
        Attributes:
            positive_geo_target_type (google.ads.googleads.v7.enums.types.PositiveGeoTargetTypeEnum.PositiveGeoTargetType):
                The setting used for positive geotargeting in
                this particular campaign.
            negative_geo_target_type (google.ads.googleads.v7.enums.types.NegativeGeoTargetTypeEnum.NegativeGeoTargetType):
                The setting used for negative geotargeting in
                this particular campaign.
        """

        positive_geo_target_type = proto.Field(proto.ENUM, number=1,
            enum=gage_positive_geo_target_type.PositiveGeoTargetTypeEnum.PositiveGeoTargetType,
        )
        negative_geo_target_type = proto.Field(proto.ENUM, number=2,
    ...
    class AppCampaignSetting(proto.Message):
        ...
        bidding_strategy_goal_type = proto.Field(proto.ENUM, number=1,
    ...
    class LocalCampaignSetting(proto.Message):
        ...
        Attributes:
            location_source_type (google.ads.googleads.v7.enums.types.LocationSourceTypeEnum.LocationSourceType):
                The location source type for this local
                campaign.
        """

        location_source_type = proto.Field(proto.ENUM, number=1,
    ...
    class VanityPharma(proto.Message):
        ...
        Attributes:
            vanity_pharma_display_url_mode (google.ads.googleads.v7.enums.types.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode):
                The display mode for vanity pharma URLs.
            vanity_pharma_text (google.ads.googleads.v7.enums.types.VanityPharmaTextEnum.VanityPharmaText):
        ...
        vanity_pharma_display_url_mode = proto.Field(proto.ENUM, number=1,
            enum=gage_vanity_pharma_display_url_mode.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode,
        )
        vanity_pharma_text = proto.Field(proto.ENUM, number=2,
    ...
    class OptimizationGoalSetting(proto.Message):
        ...
        optimization_goal_types = proto.RepeatedField(proto.ENUM, number=1,
    ...
    url_custom_parameters = proto.RepeatedField(proto.MESSAGE, number=12,
        message=custom_parameter.CustomParameter,
    )
    real_time_bidding_setting = proto.Field(proto.MESSAGE, number=39,
        message=gagc_real_time_bidding_setting.RealTimeBiddingSetting,
    )
    network_settings = proto.Field(proto.MESSAGE, number=14,
        message=NetworkSettings,
    )
    hotel_setting = proto.Field(proto.MESSAGE, number=32,
        message=HotelSettingInfo,
    )
    dynamic_search_ads_setting = proto.Field(proto.MESSAGE, number=33,
        message=DynamicSearchAdsSetting,
    )
    shopping_setting = proto.Field(proto.MESSAGE, number=36,
        message=ShoppingSetting,
    )
    targeting_setting = proto.Field(proto.MESSAGE, number=43,
        message=gagc_targeting_setting.TargetingSetting,
    )
    geo_target_type_setting = proto.Field(proto.MESSAGE, number=47,
        message=GeoTargetTypeSetting,
    )
    local_campaign_setting = proto.Field(proto.MESSAGE, number=50,
        message=LocalCampaignSetting,
    )
    app_campaign_setting = proto.Field(proto.MESSAGE, number=51,
        message=AppCampaignSetting,
    )
    labels = proto.RepeatedField(proto.STRING, number=61)
    experiment_type = proto.Field(proto.ENUM, number=17,
    ...
    bidding_strategy_type = proto.Field(proto.ENUM, number=22,
    ...
    frequency_caps = proto.RepeatedField(proto.MESSAGE, number=40,
        message=frequency_cap.FrequencyCapEntry,
    )
    video_brand_safety_suitability = proto.Field(proto.ENUM, number=42,
        enum=brand_safety_suitability.BrandSafetySuitabilityEnum.BrandSafetySuitability,
    )
    vanity_pharma = proto.Field(proto.MESSAGE, number=44,
        message=VanityPharma,
    )
    selective_optimization = proto.Field(proto.MESSAGE, number=45,
        message=SelectiveOptimization,
    )
    optimization_goal_setting = proto.Field(proto.MESSAGE, number=54,
        message=OptimizationGoalSetting,
    )
    tracking_setting = proto.Field(proto.MESSAGE, number=46,
        message=TrackingSetting,
    )
    payment_mode = proto.Field(proto.ENUM, number=52,
        enum=gage_payment_mode.PaymentModeEnum.PaymentMode,
    )
    optimization_score = proto.Field(proto.DOUBLE, number=66, optional=True)
    excluded_parent_asset_field_types = proto.RepeatedField(proto.ENUM, number=69,
        enum=asset_field_type.AssetFieldTypeEnum.AssetFieldType,
    )
    bidding_strategy = proto.Field(proto.STRING, number=67, oneof='campaign_bidding_strategy')
    commission = proto.Field(proto.MESSAGE, number=49, oneof='campaign_bidding_strategy',
        message=bidding.Commission,
    )
    manual_cpc = proto.Field(proto.MESSAGE, number=24, oneof='campaign_bidding_strategy',
        message=bidding.ManualCpc,
    )
    manual_cpm = proto.Field(proto.MESSAGE, number=25, oneof='campaign_bidding_strategy',
        message=bidding.ManualCpm,
    )
    manual_cpv = proto.Field(proto.MESSAGE, number=37, oneof='campaign_bidding_strategy',
        message=bidding.ManualCpv,
    )
    maximize_conversions = proto.Field(proto.MESSAGE, number=30, oneof='campaign_bidding_strategy',
        message=bidding.MaximizeConversions,
    )
    maximize_conversion_value = proto.Field(proto.MESSAGE, number=31, oneof='campaign_bidding_strategy',
        message=bidding.MaximizeConversionValue,
    )
    target_cpa = proto.Field(proto.MESSAGE, number=26, oneof='campaign_bidding_strategy',
        message=bidding.TargetCpa,
    )
    target_impression_share = proto.Field(proto.MESSAGE, number=48, oneof='campaign_bidding_strategy',
        message=bidding.TargetImpressionShare,
    )
    target_roas = proto.Field(proto.MESSAGE, number=29, oneof='campaign_bidding_strategy',
        message=bidding.TargetRoas,
    )
    target_spend = proto.Field(proto.MESSAGE, number=27, oneof='campaign_bidding_strategy',
        message=bidding.TargetSpend,
    )
    percent_cpc = proto.Field(proto.MESSAGE, number=34, oneof='campaign_bidding_strategy',
        message=bidding.PercentCpc,
    )
    target_cpm = proto.Field(proto.MESSAGE, number=41, oneof='campaign_bidding_strategy',
