...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def get_bidding_strategy(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetBiddingStrategyRequest, dict]):
    ...
    def mutate_bidding_strategies(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateBiddingStrategiesRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v7.services.types.BiddingStrategyOperation]):
