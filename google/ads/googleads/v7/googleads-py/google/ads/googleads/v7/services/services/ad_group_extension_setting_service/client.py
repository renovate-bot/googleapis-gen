...
class AdGroupExtensionSettingServiceClient(metaclass=AdGroupExtensionSettingServiceClientMeta):
    ...
    def get_ad_group_extension_setting(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AdGroupExtensionSetting:
    ...
    def mutate_ad_group_extension_settings(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.AdGroupExtensionSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAdGroupExtensionSettingsResponse:
