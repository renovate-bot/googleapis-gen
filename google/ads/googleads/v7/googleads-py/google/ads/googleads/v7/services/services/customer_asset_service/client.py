...
class CustomerAssetServiceClient(metaclass=CustomerAssetServiceClientMeta):
    ...
    def get_customer_asset(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCustomerAssetRequest, dict]):
    ...
    def mutate_customer_assets(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateCustomerAssetsRequest, dict]):
                The request object. Request message for
