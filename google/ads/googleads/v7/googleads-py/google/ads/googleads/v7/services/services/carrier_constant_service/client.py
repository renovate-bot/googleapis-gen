...
class CarrierConstantServiceClient(metaclass=CarrierConstantServiceClientMeta):
    ...
    def transport(self) -> CarrierConstantServiceTransport:
        ...
        Returns:
            CarrierConstantServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the carrier constant service client.
    ...
    def get_carrier_constant(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCarrierConstantRequest, dict]):
                The request object. Request message for
                [CarrierConstantService.GetCarrierConstant][google.ads.googleads.v7.services.CarrierConstantService.GetCarrierConstant].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CarrierConstant:
        ...
        if not isinstance(request, carrier_constant_service.GetCarrierConstantRequest):
            request = carrier_constant_service.GetCarrierConstantRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_carrier_constant]
