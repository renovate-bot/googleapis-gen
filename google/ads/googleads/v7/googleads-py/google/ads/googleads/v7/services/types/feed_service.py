...
class FeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.Feed):
            Create operation: No resource name is
            expected for the new feed.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v7.resources.types.Feed):
...
class MutateFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateFeedResult]):
