...
class MutateCustomerExtensionSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v7.services.types.CustomerExtensionSettingOperation]):
...
class CustomerExtensionSettingOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.CustomerExtensionSetting):
            Create operation: No resource name is
            expected for the new customer extension setting.
        update (google.ads.googleads.v7.resources.types.CustomerExtensionSetting):
...
class MutateCustomerExtensionSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateCustomerExtensionSettingResult]):
...
class MutateCustomerExtensionSettingResult(proto.Message):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    customer_extension_setting = proto.Field(proto.MESSAGE, number=2,
        message=gagr_customer_extension_setting.CustomerExtensionSetting,
    )
