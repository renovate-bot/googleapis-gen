...
class MutateUserListsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v7.services.types.UserListOperation]):
...
class UserListOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.UserList):
            Create operation: No resource name is
            expected for the new user list.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v7.resources.types.UserList):
...
class MutateUserListsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateUserListResult]):
