...
class ConversionCustomVariableServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_conversion_custom_variable: gapic_v1.method.wrap_method(
                self.get_conversion_custom_variable,
    ...
    @property
    def get_conversion_custom_variable(self) -> Callable[
            [conversion_custom_variable_service.GetConversionCustomVariableRequest],
            Union[
                conversion_custom_variable.ConversionCustomVariable,
                Awaitable[conversion_custom_variable.ConversionCustomVariable]
            ]]:
        raise NotImplementedError()

    @property
    def mutate_conversion_custom_variables(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[conversion_custom_variable_service.MutateConversionCustomVariablesResponse]
            ]]:
        raise NotImplementedError()
