...
class CampaignBidModifierServiceClient(metaclass=CampaignBidModifierServiceClientMeta):
    ...
    def get_campaign_bid_modifier(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetCampaignBidModifierRequest`):
    ...
    def mutate_campaign_bid_modifiers(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateCampaignBidModifiersRequest`):
                The request object. Request message for
