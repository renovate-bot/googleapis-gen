...
class CampaignBidModifierServiceClient(metaclass=CampaignBidModifierServiceClientMeta):
    ...
    def get_campaign_bid_modifier(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCampaignBidModifierRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignBidModifier:
    ...
    def mutate_campaign_bid_modifiers(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateCampaignBidModifiersRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CampaignBidModifierOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignBidModifiersResponse:
