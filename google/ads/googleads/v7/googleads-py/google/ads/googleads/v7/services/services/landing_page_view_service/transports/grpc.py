...
from .base import LandingPageViewServiceTransport, DEFAULT_CLIENT_INFO


class LandingPageViewServiceGrpcTransport(LandingPageViewServiceTransport):
    """gRPC backend transport for LandingPageViewService.
    ...
    @property
    def get_landing_page_view(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetLandingPageViewRequest],
                    ~.LandingPageView]:
        ...
        if 'get_landing_page_view' not in self._stubs:
            self._stubs['get_landing_page_view'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v7.services.LandingPageViewService/GetLandingPageView',
                request_serializer=landing_page_view_service.GetLandingPageViewRequest.serialize,
                response_deserializer=landing_page_view.LandingPageView.deserialize,
            )
