...
class MutateCustomerManagerLinkRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v7.services.types.CustomerManagerLinkOperation]):
...
class CustomerManagerLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v7.resources.types.CustomerManagerLink):
