...
class ConversionAdjustmentUploadServiceClient(metaclass=ConversionAdjustmentUploadServiceClientMeta):
    ...
    def upload_conversion_adjustments(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.UploadConversionAdjustmentsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            conversion_adjustments (Sequence[google.ads.googleads.v7.services.types.ConversionAdjustment]):
        ...
        Returns:
            google.ads.googleads.v7.services.types.UploadConversionAdjustmentsResponse:
