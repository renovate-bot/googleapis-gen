...
class MerchantCenterLinkServiceGrpcTransport(MerchantCenterLinkServiceTransport):
    """gRPC backend transport for MerchantCenterLinkService.
    ...
    def list_merchant_center_links(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListMerchantCenterLinksRequest],
        ...
        if 'list_merchant_center_links' not in self._stubs:
            self._stubs['list_merchant_center_links'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v7.services.MerchantCenterLinkService/ListMerchantCenterLinks',
                request_serializer=merchant_center_link_service.ListMerchantCenterLinksRequest.serialize,
                response_deserializer=merchant_center_link_service.ListMerchantCenterLinksResponse.deserialize,
            )
        return self._stubs['list_merchant_center_links']
    ...
    def get_merchant_center_link(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetMerchantCenterLinkRequest],
                    ~.MerchantCenterLink]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'get_merchant_center_link' not in self._stubs:
            self._stubs['get_merchant_center_link'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v7.services.MerchantCenterLinkService/GetMerchantCenterLink',
                request_serializer=merchant_center_link_service.GetMerchantCenterLinkRequest.serialize,
                response_deserializer=merchant_center_link.MerchantCenterLink.deserialize,
            )
        return self._stubs['get_merchant_center_link']
    ...
    def mutate_merchant_center_link(self) -> Callable[
        ...
        Returns:
            Callable[[~.MutateMerchantCenterLinkRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'mutate_merchant_center_link' not in self._stubs:
            self._stubs['mutate_merchant_center_link'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v7.services.MerchantCenterLinkService/MutateMerchantCenterLink',
                request_serializer=merchant_center_link_service.MutateMerchantCenterLinkRequest.serialize,
                response_deserializer=merchant_center_link_service.MutateMerchantCenterLinkResponse.deserialize,
            )
        return self._stubs['mutate_merchant_center_link']
