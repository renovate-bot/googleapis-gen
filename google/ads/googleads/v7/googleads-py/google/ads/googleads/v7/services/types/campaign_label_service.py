...
class MutateCampaignLabelsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v7.services.types.CampaignLabelOperation]):
...
class CampaignLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v7.resources.types.CampaignLabel):
...
class MutateCampaignLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateCampaignLabelResult]):
