...
class AdGroupCriterionLabelServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_ad_group_criterion_label: gapic_v1.method.wrap_method(
                self.get_ad_group_criterion_label,
    ...
    def get_ad_group_criterion_label(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[ad_group_criterion_label.AdGroupCriterionLabel]
            ]]:
        raise NotImplementedError()
    ...
    def mutate_ad_group_criterion_labels(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[ad_group_criterion_label_service.MutateAdGroupCriterionLabelsResponse]
            ]]:
        raise NotImplementedError()
