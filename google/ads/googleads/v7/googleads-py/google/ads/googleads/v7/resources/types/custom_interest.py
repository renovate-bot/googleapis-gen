...
class CustomInterest(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v7.enums.types.CustomInterestStatusEnum.CustomInterestStatus):
        ...
        type_ (google.ads.googleads.v7.enums.types.CustomInterestTypeEnum.CustomInterestType):
            Type of the custom interest, CUSTOM_AFFINITY or
            CUSTOM_INTENT. By default the type is set to
            CUSTOM_AFFINITY.
        description (str):
            Description of this custom interest audience.
        members (Sequence[google.ads.googleads.v7.resources.types.CustomInterestMember]):
...
class CustomInterestMember(proto.Message):
    ...
    Attributes:
        member_type (google.ads.googleads.v7.enums.types.CustomInterestMemberTypeEnum.CustomInterestMemberType):
