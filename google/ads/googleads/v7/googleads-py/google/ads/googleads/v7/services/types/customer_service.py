...
class MutateCustomerRequest(proto.Message):
    ...
    response_content_type = proto.Field(proto.ENUM, number=6,
...
class CustomerOperation(proto.Message):
    ...
    Attributes:
        update (google.ads.googleads.v7.resources.types.Customer):
...
class MutateCustomerResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v7.services.types.MutateCustomerResult):
