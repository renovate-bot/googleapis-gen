...
class ExtensionFeedItemOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.ExtensionFeedItem):
            Create operation: No resource name is
            expected for the new extension feed item.
        update (google.ads.googleads.v7.resources.types.ExtensionFeedItem):
...
class MutateExtensionFeedItemsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateExtensionFeedItemResult]):
