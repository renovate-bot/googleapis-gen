...
class RecommendationServiceClient(metaclass=RecommendationServiceClientMeta):
    ...
    def get_recommendation(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.Recommendation:
                A recommendation.
        """
    ...
    def apply_recommendation(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.ApplyRecommendationOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.ApplyRecommendationResponse:
    ...
    def dismiss_recommendation(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.DismissRecommendationRequest.DismissRecommendationOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.DismissRecommendationResponse:
                Response message for
                [RecommendationService.DismissRecommendation][google.ads.googleads.v7.services.RecommendationService.DismissRecommendation].
