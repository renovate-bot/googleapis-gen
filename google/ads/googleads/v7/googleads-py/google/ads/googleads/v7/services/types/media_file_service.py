...
class GetMediaFileRequest(proto.Message):
    ...
    [MediaFileService.GetMediaFile][google.ads.googleads.v7.services.MediaFileService.GetMediaFile]
...
class MutateMediaFilesRequest(proto.Message):
    r"""Request message for
    [MediaFileService.MutateMediaFiles][google.ads.googleads.v7.services.MediaFileService.MutateMediaFiles]

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose media
            files are being modified.
        operations (Sequence[google.ads.googleads.v7.services.types.MediaFileOperation]):
...
class MutateMediaFilesResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateMediaFileResult]):
...
class MutateMediaFileResult(proto.Message):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    media_file = proto.Field(proto.MESSAGE, number=2,
        message=gagr_media_file.MediaFile,
    )
