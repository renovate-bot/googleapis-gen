...
class AssetServiceClient(metaclass=AssetServiceClientMeta):
    ...
    def get_asset(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.Asset:
    ...
    def mutate_assets(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.AssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAssetsResponse:
