...
class AdGroupServiceTransport(abc.ABC):
    ...
    @property
    def get_ad_group(self) -> Callable[
            [ad_group_service.GetAdGroupRequest],
            Union[
                ad_group.AdGroup,
                Awaitable[ad_group.AdGroup]
            ]]:
        raise NotImplementedError()

    @property
    def mutate_ad_groups(self) -> Callable[
            [ad_group_service.MutateAdGroupsRequest],
            Union[
                ad_group_service.MutateAdGroupsResponse,
                Awaitable[ad_group_service.MutateAdGroupsResponse]
            ]]:
        raise NotImplementedError()
