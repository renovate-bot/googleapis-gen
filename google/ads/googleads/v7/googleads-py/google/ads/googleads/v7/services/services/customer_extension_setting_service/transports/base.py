...
class CustomerExtensionSettingServiceTransport(abc.ABC):
    """Abstract transport class for CustomerExtensionSettingService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_customer_extension_setting: gapic_v1.method.wrap_method(
                self.get_customer_extension_setting,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_customer_extension_settings: gapic_v1.method.wrap_method(
                self.mutate_customer_extension_settings,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    def get_customer_extension_setting(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[customer_extension_setting.CustomerExtensionSetting]
            ]]:
        raise NotImplementedError()
    ...
    def mutate_customer_extension_settings(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[customer_extension_setting_service.MutateCustomerExtensionSettingsResponse]
            ]]:
        raise NotImplementedError()
