...
class KeywordPlanCampaignServiceClient(metaclass=KeywordPlanCampaignServiceClientMeta):
    ...
    def transport(self) -> KeywordPlanCampaignServiceTransport:
        ...
        Returns:
            KeywordPlanCampaignServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the keyword plan campaign service client.
    ...
    def get_keyword_plan_campaign(self,
            request: Union[keyword_plan_campaign_service.GetKeywordPlanCampaignRequest, dict] = None,
            *,
        ...
        r"""Returns the requested Keyword Plan campaign in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetKeywordPlanCampaignRequest, dict]):
                The request object. Request message for
                [KeywordPlanCampaignService.GetKeywordPlanCampaign][google.ads.googleads.v7.services.KeywordPlanCampaignService.GetKeywordPlanCampaign].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.KeywordPlanCampaign:
    ...
    def mutate_keyword_plan_campaigns(self,
            request: Union[keyword_plan_campaign_service.MutateKeywordPlanCampaignsRequest, dict] = None,
            *,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateKeywordPlanCampaignsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v7.services.types.KeywordPlanCampaignOperation]):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateKeywordPlanCampaignsResponse:
