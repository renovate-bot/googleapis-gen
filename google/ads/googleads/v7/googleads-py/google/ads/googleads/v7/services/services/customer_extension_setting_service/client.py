...
class CustomerExtensionSettingServiceClient(metaclass=CustomerExtensionSettingServiceClientMeta):
    ...
    def get_customer_extension_setting(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCustomerExtensionSettingRequest, dict]):
    ...
    def mutate_customer_extension_settings(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateCustomerExtensionSettingsRequest, dict]):
                The request object. Request message for
