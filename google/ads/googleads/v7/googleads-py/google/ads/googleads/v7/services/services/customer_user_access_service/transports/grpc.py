...
class CustomerUserAccessServiceGrpcTransport(CustomerUserAccessServiceTransport):
    ...
    def get_customer_user_access(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetCustomerUserAccessRequest],
                    ~.CustomerUserAccess]:
        ...
        if 'get_customer_user_access' not in self._stubs:
            self._stubs['get_customer_user_access'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v7.services.CustomerUserAccessService/GetCustomerUserAccess',
                request_serializer=customer_user_access_service.GetCustomerUserAccessRequest.serialize,
                response_deserializer=customer_user_access.CustomerUserAccess.deserialize,
            )
        return self._stubs['get_customer_user_access']
    ...
    def mutate_customer_user_access(self) -> Callable[
        ...
        if 'mutate_customer_user_access' not in self._stubs:
            self._stubs['mutate_customer_user_access'] = self.grpc_channel.unary_unary(
