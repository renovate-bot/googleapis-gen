...
class CampaignAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.CampaignAsset):
            Create operation: No resource name is
            expected for the new campaign asset.
        update (google.ads.googleads.v7.resources.types.CampaignAsset):
    ...
    update = proto.Field(proto.MESSAGE, number=3, oneof='operation',
        message=campaign_asset.CampaignAsset,
    )
...
class MutateCampaignAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateCampaignAssetResult]):
