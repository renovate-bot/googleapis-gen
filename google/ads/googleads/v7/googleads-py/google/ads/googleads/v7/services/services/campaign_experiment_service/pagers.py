...
class ListCampaignExperimentAsyncErrorsPager:
    ...
    :class:`google.ads.googleads.v7.services.types.ListCampaignExperimentAsyncErrorsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v7.services.types.ListCampaignExperimentAsyncErrorsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v7.services.types.ListCampaignExperimentAsyncErrorsResponse`):
