...
from google.ads.googleads.v7.services.types import conversion_upload_service
...
class ConversionUploadServiceGrpcTransport(ConversionUploadServiceTransport):
    """gRPC backend transport for ConversionUploadService.
    ...
    def upload_click_conversions(self) -> Callable[
        ...
        if 'upload_click_conversions' not in self._stubs:
            self._stubs['upload_click_conversions'] = self.grpc_channel.unary_unary(
    ...
    def upload_call_conversions(self) -> Callable[
        ...
        if 'upload_call_conversions' not in self._stubs:
            self._stubs['upload_call_conversions'] = self.grpc_channel.unary_unary(
