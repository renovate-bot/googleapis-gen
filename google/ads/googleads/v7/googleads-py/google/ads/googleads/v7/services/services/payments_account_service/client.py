...
class PaymentsAccountServiceClient(metaclass=PaymentsAccountServiceClientMeta):
    ...
    def list_payments_accounts(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.ListPaymentsAccountsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v7.services.types.ListPaymentsAccountsResponse:
                Response message for
                [PaymentsAccountService.ListPaymentsAccounts][google.ads.googleads.v7.services.PaymentsAccountService.ListPaymentsAccounts].
