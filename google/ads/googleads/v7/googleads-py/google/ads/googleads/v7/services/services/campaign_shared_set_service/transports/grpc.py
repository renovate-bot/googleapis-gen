...
class CampaignSharedSetServiceGrpcTransport(CampaignSharedSetServiceTransport):
    """gRPC backend transport for CampaignSharedSetService.
    ...
    def get_campaign_shared_set(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetCampaignSharedSetRequest],
                    ~.CampaignSharedSet]:
        ...
        if 'get_campaign_shared_set' not in self._stubs:
            self._stubs['get_campaign_shared_set'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v7.services.CampaignSharedSetService/GetCampaignSharedSet',
                request_serializer=campaign_shared_set_service.GetCampaignSharedSetRequest.serialize,
                response_deserializer=campaign_shared_set.CampaignSharedSet.deserialize,
            )
        return self._stubs['get_campaign_shared_set']
    ...
    def mutate_campaign_shared_sets(self) -> Callable[
        ...
        Creates or removes campaign shared sets. Operation statuses are
        returned.
        ...
        Returns:
            Callable[[~.MutateCampaignSharedSetsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'mutate_campaign_shared_sets' not in self._stubs:
            self._stubs['mutate_campaign_shared_sets'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v7.services.CampaignSharedSetService/MutateCampaignSharedSets',
                request_serializer=campaign_shared_set_service.MutateCampaignSharedSetsRequest.serialize,
                response_deserializer=campaign_shared_set_service.MutateCampaignSharedSetsResponse.deserialize,
            )
        return self._stubs['mutate_campaign_shared_sets']
