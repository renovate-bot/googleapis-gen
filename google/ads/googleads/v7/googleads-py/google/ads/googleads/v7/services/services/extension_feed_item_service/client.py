...
class ExtensionFeedItemServiceClient(metaclass=ExtensionFeedItemServiceClientMeta):
    ...
    def get_extension_feed_item(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetExtensionFeedItemRequest`):
    ...
    def mutate_extension_feed_items(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateExtensionFeedItemsRequest`):
                The request object. Request message for
