...
class AdGroupAdLabelServiceClient(metaclass=AdGroupAdLabelServiceClientMeta):
    ...
    def transport(self) -> AdGroupAdLabelServiceTransport:
        ...
        Returns:
            AdGroupAdLabelServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the ad group ad label service client.
    ...
    def get_ad_group_ad_label(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AdGroupAdLabel:
    ...
    def mutate_ad_group_ad_labels(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v7.services.types.AdGroupAdLabelOperation]):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAdGroupAdLabelsResponse:
