...
class CampaignFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.CampaignFeed):
            Create operation: No resource name is
            expected for the new campaign feed.
        update (google.ads.googleads.v7.resources.types.CampaignFeed):
...
class MutateCampaignFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateCampaignFeedResult]):
