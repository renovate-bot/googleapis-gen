...
class AdGroupBidModifierServiceClient(metaclass=AdGroupBidModifierServiceClientMeta):
    ...
    def get_ad_group_bid_modifier(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetAdGroupBidModifierRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AdGroupBidModifier:
    ...
    def mutate_ad_group_bid_modifiers(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateAdGroupBidModifiersRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.AdGroupBidModifierOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAdGroupBidModifiersResponse:
