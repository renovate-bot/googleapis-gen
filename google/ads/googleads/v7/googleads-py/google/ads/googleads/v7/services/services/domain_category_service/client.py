...
class DomainCategoryServiceClient(metaclass=DomainCategoryServiceClientMeta):
    ...
    def transport(self) -> DomainCategoryServiceTransport:
        ...
        Returns:
            DomainCategoryServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the domain category service client.
    ...
    def get_domain_category(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.DomainCategory:
