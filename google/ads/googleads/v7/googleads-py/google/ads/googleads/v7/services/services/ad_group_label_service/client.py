...
class AdGroupLabelServiceClient(metaclass=AdGroupLabelServiceClientMeta):
    ...
    def get_ad_group_label(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AdGroupLabel:
    ...
    def mutate_ad_group_labels(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.AdGroupLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAdGroupLabelsResponse:
