...
class CampaignExperiment(proto.Message):
    ...
    Attributes:
        ...
        traffic_split_type (google.ads.googleads.v7.enums.types.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType):
        ...
        status (google.ads.googleads.v7.enums.types.CampaignExperimentStatusEnum.CampaignExperimentStatus):
