...
class CampaignBudgetServiceClient(metaclass=CampaignBudgetServiceClientMeta):
    ...
    def get_campaign_budget(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignBudget:
                A campaign budget.
        """
    ...
    def mutate_campaign_budgets(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CampaignBudgetOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignBudgetsResponse:
