...
class AccountLinkServiceClientMeta(type):
    """Metaclass for the AccountLinkService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AccountLinkServiceTransport]]
    _transport_registry['grpc'] = AccountLinkServiceGrpcTransport
...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AccountLinkServiceClient: The constructed client.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, AccountLinkServiceTransport, None] = None,
    ...
    def get_account_link(self,
        ...
        r"""Returns the account link in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetAccountLinkRequest, dict]):
                The request object. Request message for
                [AccountLinkService.GetAccountLink][google.ads.googleads.v7.services.AccountLinkService.GetAccountLink].
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AccountLink:
                Represents the data sharing
                connection between a Google Ads account
                and another account
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_account_link]
    ...
    def create_account_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.CreateAccountLinkRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            account_link (:class:`google.ads.googleads.v7.resources.types.AccountLink`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.CreateAccountLinkResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, account_link_service.CreateAccountLinkRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_account_link]
    ...
    def mutate_account_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateAccountLinkRequest, dict]):
                The request object. Request message for
                [AccountLinkService.MutateAccountLink][google.ads.googleads.v7.services.AccountLinkService.MutateAccountLink].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v7.services.types.AccountLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAccountLinkResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_account_link]
