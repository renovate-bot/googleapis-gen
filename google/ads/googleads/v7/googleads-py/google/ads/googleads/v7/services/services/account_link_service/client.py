...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def get_account_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetAccountLinkRequest`):
    ...
    def create_account_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.CreateAccountLinkRequest`):
                The request object. Request message for
    ...
    def mutate_account_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateAccountLinkRequest`):
                The request object. Request message for
