...
class KeywordPlanAdGroupKeywordServiceClient(metaclass=KeywordPlanAdGroupKeywordServiceClientMeta):
    ...
    def get_keyword_plan_ad_group_keyword(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetKeywordPlanAdGroupKeywordRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.KeywordPlanAdGroupKeyword:
    ...
    def mutate_keyword_plan_ad_group_keywords(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateKeywordPlanAdGroupKeywordsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.KeywordPlanAdGroupKeywordOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateKeywordPlanAdGroupKeywordsResponse:
