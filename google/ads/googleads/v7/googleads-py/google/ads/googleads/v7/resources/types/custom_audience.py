...
class CustomAudience(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v7.enums.types.CustomAudienceStatusEnum.CustomAudienceStatus):
        ...
        name (str):
            ...
            operations.
        type_ (google.ads.googleads.v7.enums.types.CustomAudienceTypeEnum.CustomAudienceType):
        ...
        members (Sequence[google.ads.googleads.v7.resources.types.CustomAudienceMember]):
...
class CustomAudienceMember(proto.Message):
    ...
    Attributes:
        member_type (google.ads.googleads.v7.enums.types.CustomAudienceMemberTypeEnum.CustomAudienceMemberType):
            The type of custom audience member, KEYWORD, URL,
            PLACE_CATEGORY or APP.
        keyword (str):
            A keyword or keyword phrase — at most 10
            words and 80 characters. Languages with double-
