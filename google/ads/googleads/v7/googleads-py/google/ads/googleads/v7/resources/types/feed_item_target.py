...
from google.ads.googleads.v7.enums.types import feed_item_target_type as gage_feed_item_target_type
...
class FeedItemTarget(proto.Message):
    ...
    Attributes:
        ...
        feed_item (str):
            ...
            item target belongs.
        feed_item_target_type (google.ads.googleads.v7.enums.types.FeedItemTargetTypeEnum.FeedItemTargetType):
        ...
        status (google.ads.googleads.v7.enums.types.FeedItemTargetStatusEnum.FeedItemTargetStatus):
        ...
        geo_target_constant (str):
            ...
            resource name.
        device (google.ads.googleads.v7.enums.types.FeedItemTargetDeviceEnum.FeedItemTargetDevice):
            Immutable. The targeted device.
        ad_schedule (google.ads.googleads.v7.common.types.AdScheduleInfo):
