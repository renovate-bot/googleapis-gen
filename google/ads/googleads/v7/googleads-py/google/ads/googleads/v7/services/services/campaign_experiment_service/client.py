...
class CampaignExperimentServiceClient(metaclass=CampaignExperimentServiceClientMeta):
    ...
    def get_campaign_experiment(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignExperiment:
    ...
    def mutate_campaign_experiments(self,
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignExperimentsResponse:
    ...
    def graduate_campaign_experiment(self,
        ...
        Returns:
            google.ads.googleads.v7.services.types.GraduateCampaignExperimentResponse:
                Response message for campaign
                experiment graduate.
    ...
    def list_campaign_experiment_async_errors(self,
        ...
        Returns:
            google.ads.googleads.v7.services.services.campaign_experiment_service.pagers.ListCampaignExperimentAsyncErrorsPager:
