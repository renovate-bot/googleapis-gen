...
from google.ads.googleads.v7.enums.types import ad_strength as gage_ad_strength
...
class AdGroupAd(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v7.enums.types.AdGroupAdStatusEnum.AdGroupAdStatus):
        ...
        ad (google.ads.googleads.v7.resources.types.Ad):
            Immutable. The ad.
        policy_summary (google.ads.googleads.v7.resources.types.AdGroupAdPolicySummary):
            Output only. Policy information for the ad.
        ad_strength (google.ads.googleads.v7.enums.types.AdStrengthEnum.AdStrength):
