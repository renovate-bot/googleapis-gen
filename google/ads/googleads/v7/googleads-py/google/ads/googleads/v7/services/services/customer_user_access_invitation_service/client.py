...
class CustomerUserAccessInvitationServiceClient(metaclass=CustomerUserAccessInvitationServiceClientMeta):
    ...
    def get_customer_user_access_invitation(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCustomerUserAccessInvitationRequest, dict]):
    ...
    def mutate_customer_user_access_invitation(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateCustomerUserAccessInvitationRequest, dict]):
                The request object. Request message for
