...
class CampaignSimulationServiceClient(metaclass=CampaignSimulationServiceClientMeta):
    ...
    def transport(self) -> CampaignSimulationServiceTransport:
        ...
        Returns:
            CampaignSimulationServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the campaign simulation service client.
    ...
    def get_campaign_simulation(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCampaignSimulationRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignSimulation:
