...
class Invoice(proto.Message):
    ...
    class AccountBudgetSummary(proto.Message):
        ...
        customer_descriptive_name = proto.Field(proto.STRING, number=11, optional=True)
        ...
        subtotal_amount_micros = proto.Field(proto.INT64, number=15, optional=True)
    ...
    regulatory_costs_subtotal_amount_micros = proto.Field(proto.INT64, number=22)
