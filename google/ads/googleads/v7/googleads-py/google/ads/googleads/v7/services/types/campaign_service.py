...
class MutateCampaignsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v7.services.types.CampaignOperation]):
...
class CampaignOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.Campaign):
            Create operation: No resource name is
            expected for the new campaign.
        update (google.ads.googleads.v7.resources.types.Campaign):
...
class MutateCampaignsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateCampaignResult]):
