...
class MutateAdParametersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v7.services.types.AdParameterOperation]):
...
class AdParameterOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.AdParameter):
            Create operation: No resource name is
            expected for the new ad parameter.
        update (google.ads.googleads.v7.resources.types.AdParameter):
...
class MutateAdParametersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateAdParameterResult]):
