...
class KeywordPlanCampaignKeywordServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_keyword_plan_campaign_keyword: gapic_v1.method.wrap_method(
                self.get_keyword_plan_campaign_keyword,
    ...
    def get_keyword_plan_campaign_keyword(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[keyword_plan_campaign_keyword.KeywordPlanCampaignKeyword]
            ]]:
        raise NotImplementedError()
    ...
    def mutate_keyword_plan_campaign_keywords(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[keyword_plan_campaign_keyword_service.MutateKeywordPlanCampaignKeywordsResponse]
            ]]:
        raise NotImplementedError()
