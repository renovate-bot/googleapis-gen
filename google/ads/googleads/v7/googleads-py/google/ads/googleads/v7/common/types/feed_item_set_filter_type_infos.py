...
class DynamicLocationSetFilter(proto.Message):
    ...
    Attributes:
        ...
        business_name_filter (google.ads.googleads.v7.common.types.BusinessNameFilter):
            Business name filter.
    """

    labels = proto.RepeatedField(proto.STRING, number=1)
    business_name_filter = proto.Field(proto.MESSAGE, number=2,
...
class BusinessNameFilter(proto.Message):
    ...
    Attributes:
        ...
        filter_type (google.ads.googleads.v7.enums.types.FeedItemSetStringFilterTypeEnum.FeedItemSetStringFilterType):
            The type of string matching to use when filtering with
            business_name.
    """

    business_name = proto.Field(proto.STRING, number=1)
    filter_type = proto.Field(proto.ENUM, number=2,
