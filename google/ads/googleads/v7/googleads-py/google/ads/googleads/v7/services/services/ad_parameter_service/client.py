...
class AdParameterServiceClient(metaclass=AdParameterServiceClientMeta):
    ...
    def get_ad_parameter(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AdParameter:
    ...
    def mutate_ad_parameters(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.AdParameterOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAdParametersResponse:
