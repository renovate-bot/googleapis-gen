...
class CustomAudienceServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for CustomAudienceService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_custom_audience: gapic_v1.method.wrap_method(
                self.get_custom_audience,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_custom_audiences: gapic_v1.method.wrap_method(
                self.mutate_custom_audiences,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def mutate_custom_audiences(self) -> typing.Callable[
