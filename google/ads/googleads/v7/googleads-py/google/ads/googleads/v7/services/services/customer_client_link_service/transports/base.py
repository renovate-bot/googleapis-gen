...
class CustomerClientLinkServiceTransport(abc.ABC):
    """Abstract transport class for CustomerClientLinkService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_customer_client_link: gapic_v1.method.wrap_method(
                self.get_customer_client_link,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_customer_client_link: gapic_v1.method.wrap_method(
                self.mutate_customer_client_link,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    def get_customer_client_link(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[customer_client_link.CustomerClientLink]
            ]]:
        raise NotImplementedError()
