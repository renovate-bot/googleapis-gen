...
class GetAdGroupBidModifierRequest(proto.Message):
    ...
    [AdGroupBidModifierService.GetAdGroupBidModifier][google.ads.googleads.v7.services.AdGroupBidModifierService.GetAdGroupBidModifier].
...
class MutateAdGroupBidModifiersRequest(proto.Message):
    r"""Request message for
    [AdGroupBidModifierService.MutateAdGroupBidModifiers][google.ads.googleads.v7.services.AdGroupBidModifierService.MutateAdGroupBidModifiers].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose ad group
            bid modifiers are being modified.
        operations (Sequence[google.ads.googleads.v7.services.types.AdGroupBidModifierOperation]):
...
class AdGroupBidModifierOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.AdGroupBidModifier):
            Create operation: No resource name is
            expected for the new ad group bid modifier.
        update (google.ads.googleads.v7.resources.types.AdGroupBidModifier):
...
class MutateAdGroupBidModifiersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateAdGroupBidModifierResult]):
...
class MutateAdGroupBidModifierResult(proto.Message):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    ad_group_bid_modifier = proto.Field(proto.MESSAGE, number=2,
        message=gagr_ad_group_bid_modifier.AdGroupBidModifier,
    )
