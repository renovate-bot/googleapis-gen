...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def get_campaign_asset(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetCampaignAssetRequest`):
    ...
    def mutate_campaign_assets(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateCampaignAssetsRequest`):
                The request object. Request message for
