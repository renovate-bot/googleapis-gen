...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def transport(self) -> CampaignAssetServiceTransport:
        ...
        Returns:
            CampaignAssetServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the campaign asset service client.
    ...
    def mutate_campaign_assets(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v7.services.types.CampaignAssetOperation]):
