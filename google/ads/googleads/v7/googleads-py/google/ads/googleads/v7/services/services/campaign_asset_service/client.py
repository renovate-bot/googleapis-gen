...
class CampaignAssetServiceClientMeta(type):
    """Metaclass for the CampaignAssetService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CampaignAssetServiceTransport]]
    _transport_registry['grpc'] = CampaignAssetServiceGrpcTransport
...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CampaignAssetServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CampaignAssetServiceTransport:
        ...
        Returns:
            CampaignAssetServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, CampaignAssetServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the campaign asset service client.
        ...
        Args:
            ...
            transport (Union[str, ~.CampaignAssetServiceTransport]): The
        ...
        if isinstance(transport, CampaignAssetServiceTransport):
            # transport is a CampaignAssetServiceTransport instance.
            if credentials:
            ...
            self._transport = CampaignAssetServiceGrpcTransport(
    ...
    def get_campaign_asset(self,
        ...
        r"""Returns the requested campaign asset in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCampaignAssetRequest, dict]):
                The request object. Request message for
                [CampaignAssetService.GetCampaignAsset][google.ads.googleads.v7.services.CampaignAssetService.GetCampaignAsset].
            resource_name (:class:`str`):
                Required. The resource name of the
                campaign asset to fetch.
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignAsset:
                A link between a Campaign and an
                Asset.
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_campaign_asset]
    ...
    def mutate_campaign_assets(self,
        ...
        r"""Creates, updates, or removes campaign assets. Operation statuses
        are returned.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateCampaignAssetsRequest, dict]):
                The request object. Request message for
                [CampaignAssetService.MutateCampaignAssets][google.ads.googleads.v7.services.CampaignAssetService.MutateCampaignAssets].
            customer_id (:class:`str`):
                Required. The ID of the customer
                whose campaign assets are being
                modified.

                This corresponds to the ``customer_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CampaignAssetOperation]`):
                Required. The list of operations to
                perform on individual campaign assets.
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignAssetsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_campaign_assets]
