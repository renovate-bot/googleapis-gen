...
class CampaignExtensionSettingServiceClient(metaclass=CampaignExtensionSettingServiceClientMeta):
    ...
    def get_campaign_extension_setting(self,
            request: Union[campaign_extension_setting_service.GetCampaignExtensionSettingRequest, dict] = None,
            *,
        ...
        r"""Returns the requested campaign extension setting in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCampaignExtensionSettingRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignExtensionSetting:
    ...
    def mutate_campaign_extension_settings(self,
            request: Union[campaign_extension_setting_service.MutateCampaignExtensionSettingsRequest, dict] = None,
            *,
        ...
        r"""Creates, updates, or removes campaign extension settings.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateCampaignExtensionSettingsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CampaignExtensionSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignExtensionSettingsResponse:
