...
class CampaignExtensionSettingServiceClient(metaclass=CampaignExtensionSettingServiceClientMeta):
    ...
    def transport(self) -> CampaignExtensionSettingServiceTransport:
        ...
        Returns:
            CampaignExtensionSettingServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the campaign extension setting service client.
    ...
    def mutate_campaign_extension_settings(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v7.services.types.CampaignExtensionSettingOperation]):
