...
class CampaignExtensionSettingServiceClient(metaclass=CampaignExtensionSettingServiceClientMeta):
    ...
    def get_campaign_extension_setting(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetCampaignExtensionSettingRequest`):
                The request object.
                Request message for
    ...
    def mutate_campaign_extension_settings(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateCampaignExtensionSettingsRequest`):
                The request object.
                Request message for
