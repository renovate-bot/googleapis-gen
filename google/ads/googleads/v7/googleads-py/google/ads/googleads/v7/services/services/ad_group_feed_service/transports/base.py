...
class AdGroupFeedServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for AdGroupFeedService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_ad_group_feed: gapic_v1.method.wrap_method(
                self.get_ad_group_feed,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_ad_group_feeds: gapic_v1.method.wrap_method(
                self.mutate_ad_group_feeds,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def mutate_ad_group_feeds(self) -> typing.Callable[
