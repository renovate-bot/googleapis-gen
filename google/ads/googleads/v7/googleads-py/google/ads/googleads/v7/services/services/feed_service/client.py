...
class FeedServiceClient(metaclass=FeedServiceClientMeta):
    ...
    def transport(self) -> FeedServiceTransport:
        ...
        Returns:
            FeedServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiate the feed service client.
        ...
        if isinstance(transport, FeedServiceTransport):
            ...
            self._transport = FeedServiceGrpcTransport(
    ...
    def get_feed(self,
        ...
        r"""Returns the requested feed in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetFeedRequest, dict]):
                The request object. Request message for
                [FeedService.GetFeed][google.ads.googleads.v7.services.FeedService.GetFeed].
        ...
        Returns:
            google.ads.googleads.v7.resources.types.Feed:
                A feed.
        """
        ...
        # in a feed_service.GetFeedRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, feed_service.GetFeedRequest):
            request = feed_service.GetFeedRequest(request)
    ...
    def mutate_feeds(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateFeedsRequest, dict]):
                The request object. Request message for
                [FeedService.MutateFeeds][google.ads.googleads.v7.services.FeedService.MutateFeeds].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.FeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateFeedsResponse:
