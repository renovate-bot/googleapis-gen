...
class KeywordPlanAdGroupServiceClient(metaclass=KeywordPlanAdGroupServiceClientMeta):
    ...
    def get_keyword_plan_ad_group(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.KeywordPlanAdGroup:
    ...
    def mutate_keyword_plan_ad_groups(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v7.services.types.KeywordPlanAdGroupOperation]):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateKeywordPlanAdGroupsResponse:
