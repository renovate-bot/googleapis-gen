...
class CustomerClientLinkServiceClient(metaclass=CustomerClientLinkServiceClientMeta):
    ...
    def get_customer_client_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCustomerClientLinkRequest, dict]):
    ...
    def mutate_customer_client_link(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateCustomerClientLinkRequest, dict]):
                The request object. Request message for
