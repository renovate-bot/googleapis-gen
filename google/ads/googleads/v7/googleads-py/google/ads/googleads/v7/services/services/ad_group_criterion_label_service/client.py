...
class AdGroupCriterionLabelServiceClient(metaclass=AdGroupCriterionLabelServiceClientMeta):
    ...
    def get_ad_group_criterion_label(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AdGroupCriterionLabel:
    ...
    def mutate_ad_group_criterion_labels(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.AdGroupCriterionLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAdGroupCriterionLabelsResponse:
