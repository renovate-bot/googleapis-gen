...
class ConversionCustomVariableServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ConversionCustomVariableServiceTransport]]
...
class ConversionCustomVariableServiceClient(metaclass=ConversionCustomVariableServiceClientMeta):
    ...
    def transport(self) -> ConversionCustomVariableServiceTransport:
        ...
        Returns:
            ConversionCustomVariableServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, ConversionCustomVariableServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the conversion custom variable service client.
    ...
    def get_conversion_custom_variable(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.ConversionCustomVariable:
        ...
        if not isinstance(request, conversion_custom_variable_service.GetConversionCustomVariableRequest):
            request = conversion_custom_variable_service.GetConversionCustomVariableRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_conversion_custom_variable]
    ...
    def mutate_conversion_custom_variables(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v7.services.types.ConversionCustomVariableOperation]):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateConversionCustomVariablesResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, conversion_custom_variable_service.MutateConversionCustomVariablesRequest):
            request = conversion_custom_variable_service.MutateConversionCustomVariablesRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_conversion_custom_variables]
