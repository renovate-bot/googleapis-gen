...
from .base import DomainCategoryServiceTransport, DEFAULT_CLIENT_INFO


class DomainCategoryServiceGrpcTransport(DomainCategoryServiceTransport):
    """gRPC backend transport for DomainCategoryService.
    ...
    @property
    def get_domain_category(self) -> Callable[
            [domain_category_service.GetDomainCategoryRequest],
            domain_category.DomainCategory]:
        r"""Return a callable for the get domain category method over gRPC.
        ...
        Returns:
            Callable[[~.GetDomainCategoryRequest],
                    ~.DomainCategory]:
        ...
        if 'get_domain_category' not in self._stubs:
            self._stubs['get_domain_category'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v7.services.DomainCategoryService/GetDomainCategory',
                request_serializer=domain_category_service.GetDomainCategoryRequest.serialize,
                response_deserializer=domain_category.DomainCategory.deserialize,
            )
        return self._stubs['get_domain_category']
