...
from google.ads.googleads.v7.enums.types import keyword_plan_competition_level
from google.ads.googleads.v7.enums.types import keyword_plan_concept_group_type
...
class KeywordPlanHistoricalMetrics(proto.Message):
    ...
    Attributes:
        ...
        monthly_search_volumes (Sequence[google.ads.googleads.v7.common.types.MonthlySearchVolume]):
            Approximate number of searches on this query
            for the past twelve months.
        competition (google.ads.googleads.v7.enums.types.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel):
...
class KeywordPlanDeviceSearches(proto.Message):
    ...
    Attributes:
        device (google.ads.googleads.v7.enums.types.DeviceEnum.Device):
            The device type.
        search_count (int):
...
class KeywordConcept(proto.Message):
    ...
    Attributes:
        ...
        concept_group (google.ads.googleads.v7.common.types.ConceptGroup):
...
class ConceptGroup(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v7.enums.types.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType):
