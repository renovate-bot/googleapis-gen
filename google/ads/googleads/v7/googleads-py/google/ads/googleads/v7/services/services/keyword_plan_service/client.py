...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
    ...
    def transport(self) -> KeywordPlanServiceTransport:
        ...
        Returns:
            KeywordPlanServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the keyword plan service client.
    ...
    def get_keyword_plan(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetKeywordPlanRequest, dict]):
                The request object. Request message for
                [KeywordPlanService.GetKeywordPlan][google.ads.googleads.v7.services.KeywordPlanService.GetKeywordPlan].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.KeywordPlan:
    ...
    def mutate_keyword_plans(self,
        ...
        r"""Creates, updates, or removes keyword plans. Operation statuses
        are returned.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateKeywordPlansRequest, dict]):
                The request object. Request message for
                [KeywordPlanService.MutateKeywordPlans][google.ads.googleads.v7.services.KeywordPlanService.MutateKeywordPlans].
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v7.services.types.KeywordPlanOperation]):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateKeywordPlansResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_keyword_plans]
    ...
    def generate_forecast_curve(self,
        ...
        r"""Returns the requested Keyword Plan forecast curve. Only the
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GenerateForecastCurveRequest, dict]):
                The request object. Request message for
                [KeywordPlanService.GenerateForecastCurve][google.ads.googleads.v7.services.KeywordPlanService.GenerateForecastCurve].
            keyword_plan (str):
                Required. The resource name of the
        ...
        Returns:
            google.ads.googleads.v7.services.types.GenerateForecastCurveResponse:
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([keyword_plan])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_forecast_curve]
    ...
    def generate_forecast_time_series(self,
        ...
        r"""Returns a forecast in the form of a time series for the Keyword
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GenerateForecastTimeSeriesRequest, dict]):
                The request object. Request message for
                [KeywordPlanService.GenerateForecastTimeSeries][google.ads.googleads.v7.services.KeywordPlanService.GenerateForecastTimeSeries].
            keyword_plan (str):
                Required. The resource name of the
                keyword plan to be forecasted.
        ...
        Returns:
            google.ads.googleads.v7.services.types.GenerateForecastTimeSeriesResponse:
                Response message for
                [KeywordPlanService.GenerateForecastTimeSeries][google.ads.googleads.v7.services.KeywordPlanService.GenerateForecastTimeSeries].
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a keyword_plan_service.GenerateForecastTimeSeriesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, keyword_plan_service.GenerateForecastTimeSeriesRequest):
            request = keyword_plan_service.GenerateForecastTimeSeriesRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if keyword_plan is not None:
                request.keyword_plan = keyword_plan
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_forecast_time_series]
    ...
    def generate_forecast_metrics(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GenerateForecastMetricsRequest, dict]):
                The request object. Request message for
                [KeywordPlanService.GenerateForecastMetrics][google.ads.googleads.v7.services.KeywordPlanService.GenerateForecastMetrics].
            keyword_plan (str):
                Required. The resource name of the
                keyword plan to be forecasted.
        ...
        Returns:
            google.ads.googleads.v7.services.types.GenerateForecastMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateForecastMetrics][google.ads.googleads.v7.services.KeywordPlanService.GenerateForecastMetrics].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_forecast_metrics]
    ...
    def generate_historical_metrics(self,
        ...
        r"""Returns the requested Keyword Plan historical metrics.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GenerateHistoricalMetricsRequest, dict]):
                The request object. Request message for
                [KeywordPlanService.GenerateHistoricalMetrics][google.ads.googleads.v7.services.KeywordPlanService.GenerateHistoricalMetrics].
            keyword_plan (str):
                Required. The resource name of the
        ...
        Returns:
            google.ads.googleads.v7.services.types.GenerateHistoricalMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateHistoricalMetrics][google.ads.googleads.v7.services.KeywordPlanService.GenerateHistoricalMetrics].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_historical_metrics]
