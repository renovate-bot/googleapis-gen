...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
    ...
    def get_keyword_plan(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetKeywordPlanRequest`):
                The request object.
                Request message for
    ...
    def mutate_keyword_plans(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateKeywordPlansRequest`):
                The request object.
                Request message for
    ...
    def generate_forecast_curve(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GenerateForecastCurveRequest`):
                The request object.
                Request message for
    ...
    def generate_forecast_time_series(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GenerateForecastTimeSeriesRequest`):
                The request object.
                Request message for
    ...
    def generate_forecast_metrics(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GenerateForecastMetricsRequest`):
                The request object.
                Request message for
    ...
    def generate_historical_metrics(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GenerateHistoricalMetricsRequest`):
                The request object.
                Request message for
