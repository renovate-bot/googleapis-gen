...
class ParentalStatusViewServiceGrpcTransport(ParentalStatusViewServiceTransport):
    ...
    def get_parental_status_view(self) -> Callable[
        ...
        if 'get_parental_status_view' not in self._stubs:
            self._stubs['get_parental_status_view'] = self.grpc_channel.unary_unary(
