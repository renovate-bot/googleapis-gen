...
class MutateKeywordPlansResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateKeywordPlansResult]):
...
class GenerateForecastCurveResponse(proto.Message):
    ...
    Attributes:
        campaign_forecast_curves (Sequence[google.ads.googleads.v7.services.types.KeywordPlanCampaignForecastCurve]):
...
class GenerateForecastTimeSeriesResponse(proto.Message):
    ...
    Attributes:
        weekly_time_series_forecasts (Sequence[google.ads.googleads.v7.services.types.KeywordPlanWeeklyTimeSeriesForecast]):
...
class GenerateForecastMetricsResponse(proto.Message):
    ...
    Attributes:
        campaign_forecasts (Sequence[google.ads.googleads.v7.services.types.KeywordPlanCampaignForecast]):
            List of campaign forecasts.
            One maximum.
        ad_group_forecasts (Sequence[google.ads.googleads.v7.services.types.KeywordPlanAdGroupForecast]):
            List of ad group forecasts.
        keyword_forecasts (Sequence[google.ads.googleads.v7.services.types.KeywordPlanKeywordForecast]):
...
class KeywordPlanMaxCpcBidForecastCurve(proto.Message):
    ...
    Attributes:
        max_cpc_bid_forecasts (Sequence[google.ads.googleads.v7.services.types.KeywordPlanMaxCpcBidForecast]):
...
class GenerateHistoricalMetricsRequest(proto.Message):
    ...
    keyword_plan = proto.Field(proto.STRING, number=1)
    aggregate_metrics = proto.Field(proto.MESSAGE, number=2,
        message=keyword_plan_common.KeywordPlanAggregateMetrics,
    )
    historical_metrics_options = proto.Field(proto.MESSAGE, number=3,
...
class GenerateHistoricalMetricsResponse(proto.Message):
    ...
    Attributes:
        metrics (Sequence[google.ads.googleads.v7.services.types.KeywordPlanKeywordHistoricalMetrics]):
    ...
    aggregate_metric_results = proto.Field(proto.MESSAGE, number=2,
...
class KeywordPlanKeywordHistoricalMetrics(proto.Message):
    ...
    Attributes:
        ...
        keyword_metrics (google.ads.googleads.v7.common.types.KeywordPlanHistoricalMetrics):
