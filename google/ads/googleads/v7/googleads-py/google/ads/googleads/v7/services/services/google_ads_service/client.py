...
class GoogleAdsServiceClient(metaclass=GoogleAdsServiceClientMeta):
    ...
    def search(self,
        ...
        Returns:
            google.ads.googleads.v7.services.services.google_ads_service.pagers.SearchPager:
    ...
    def search_stream(self,
        ...
        Returns:
            Iterable[google.ads.googleads.v7.services.types.SearchGoogleAdsStreamResponse]:
                Response message for
                [GoogleAdsService.SearchStream][google.ads.googleads.v7.services.GoogleAdsService.SearchStream].
    ...
    def mutate(self,
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateGoogleAdsResponse:
                Response message for
                [GoogleAdsService.Mutate][google.ads.googleads.v7.services.GoogleAdsService.Mutate].
