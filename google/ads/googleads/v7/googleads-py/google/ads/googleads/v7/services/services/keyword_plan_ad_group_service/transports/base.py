...
class KeywordPlanAdGroupServiceTransport(abc.ABC):
    """Abstract transport class for KeywordPlanAdGroupService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_keyword_plan_ad_group: gapic_v1.method.wrap_method(
                self.get_keyword_plan_ad_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_keyword_plan_ad_groups: gapic_v1.method.wrap_method(
    ...
    def get_keyword_plan_ad_group(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[keyword_plan_ad_group.KeywordPlanAdGroup]
            ]]:
        raise NotImplementedError()
