...
class CampaignCriterionSimulation(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v7.enums.types.SimulationTypeEnum.SimulationType):
            ...
            modifies.
        modification_method (google.ads.googleads.v7.enums.types.SimulationModificationMethodEnum.SimulationModificationMethod):
        ...
        bid_modifier_point_list (google.ads.googleads.v7.common.types.BidModifierSimulationPointList):
