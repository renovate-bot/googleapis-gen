...
from google.ads.googleads.v7.enums.types import geo_targeting_restriction as gage_geo_targeting_restriction
...
class FeedItem(proto.Message):
    ...
    Attributes:
        ...
        end_date_time (str):
            ...
            Examples: "2018-03-05 09:15:00" or "2018-02-01
            14:34:30".
        attribute_values (Sequence[google.ads.googleads.v7.resources.types.FeedItemAttributeValue]):
            The feed item's attribute values.
        geo_targeting_restriction (google.ads.googleads.v7.enums.types.GeoTargetingRestrictionEnum.GeoTargetingRestriction):
        ...
        url_custom_parameters (Sequence[google.ads.googleads.v7.common.types.CustomParameter]):
            ...
            ``mobile_final_urls``.
        status (google.ads.googleads.v7.enums.types.FeedItemStatusEnum.FeedItemStatus):
            Output only. Status of the feed item.
            This field is read-only.
        policy_infos (Sequence[google.ads.googleads.v7.resources.types.FeedItemPlaceholderPolicyInfo]):
...
class FeedItemAttributeValue(proto.Message):
    ...
    Attributes:
        ...
        price_value (google.ads.googleads.v7.common.types.Money):
...
class FeedItemPlaceholderPolicyInfo(proto.Message):
    ...
    Attributes:
        placeholder_type_enum (google.ads.googleads.v7.enums.types.PlaceholderTypeEnum.PlaceholderType):
        ...
        policy_topic_entries (Sequence[google.ads.googleads.v7.common.types.PolicyTopicEntry]):
            ...
            the placeholder type.
        validation_status (google.ads.googleads.v7.enums.types.FeedItemValidationStatusEnum.FeedItemValidationStatus):
            Output only. The validation status of the
            palceholder type.
        validation_errors (Sequence[google.ads.googleads.v7.resources.types.FeedItemValidationError]):
            Output only. List of placeholder type
            validation errors.
        quality_approval_status (google.ads.googleads.v7.enums.types.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus):
            Output only. Placeholder type quality
            evaluation approval status.
        quality_disapproval_reasons (Sequence[google.ads.googleads.v7.enums.types.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason]):
...
class FeedItemValidationError(proto.Message):
    ...
    Attributes:
        validation_error (google.ads.googleads.v7.errors.types.FeedItemValidationErrorEnum.FeedItemValidationError):
