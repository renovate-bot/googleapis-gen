...
class AccountLinkServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for AccountLinkService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_account_link: gapic_v1.method.wrap_method(
                self.get_account_link,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_account_link: gapic_v1.method.wrap_method(
                self.create_account_link,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_account_link: gapic_v1.method.wrap_method(
                self.mutate_account_link,
                default_timeout=None,
                client_info=client_info,
            ),
         }
