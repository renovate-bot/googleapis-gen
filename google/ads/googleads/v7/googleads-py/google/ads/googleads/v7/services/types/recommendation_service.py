...
class ApplyRecommendationRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            recommendation.
        operations (Sequence[google.ads.googleads.v7.services.types.ApplyRecommendationOperation]):
...
class ApplyRecommendationOperation(proto.Message):
    ...
    class CalloutExtensionParameters(proto.Message):
        ...
        Attributes:
            callout_extensions (Sequence[google.ads.googleads.v7.common.types.CalloutFeedItem]):
    ...
    class CallExtensionParameters(proto.Message):
        ...
        Attributes:
            call_extensions (Sequence[google.ads.googleads.v7.common.types.CallFeedItem]):
    ...
    class SitelinkExtensionParameters(proto.Message):
        ...
        Attributes:
            sitelink_extensions (Sequence[google.ads.googleads.v7.common.types.SitelinkFeedItem]):
...
class ApplyRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v7.services.types.ApplyRecommendationResult]):
...
class DismissRecommendationRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer with the
            recommendation.
        operations (Sequence[google.ads.googleads.v7.services.types.DismissRecommendationRequest.DismissRecommendationOperation]):
...
class DismissRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v7.services.types.DismissRecommendationResponse.DismissRecommendationResult]):
