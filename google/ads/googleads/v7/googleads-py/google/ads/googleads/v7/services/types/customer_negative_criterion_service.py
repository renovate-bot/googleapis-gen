...
class MutateCustomerNegativeCriteriaRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v7.services.types.CustomerNegativeCriterionOperation]):
...
class MutateCustomerNegativeCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateCustomerNegativeCriteriaResult]):
