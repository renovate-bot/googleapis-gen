...
from google.ads.googleads.v7.enums.types import app_store as gage_app_store
from google.ads.googleads.v7.enums.types import call_conversion_reporting_state as gage_call_conversion_reporting_state
...
class AppFeedItem(proto.Message):
    ...
    Attributes:
        ...
        app_store (google.ads.googleads.v7.enums.types.AppStoreEnum.AppStore):
...
class CallFeedItem(proto.Message):
    ...
    Attributes:
        ...
        call_conversion_tracking_disabled (bool):
            ...
            Optional.
        call_conversion_reporting_state (google.ads.googleads.v7.enums.types.CallConversionReportingStateEnum.CallConversionReportingState):
    ...
    call_conversion_action = proto.Field(proto.STRING, number=10, optional=True)
...
class PriceFeedItem(proto.Message):
    ...
    Attributes:
        ...
        price_qualifier (google.ads.googleads.v7.enums.types.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier):
        ...
        language_code (str):
            ...
            extension.
        price_offerings (Sequence[google.ads.googleads.v7.common.types.PriceOffer]):
...
class PriceOffer(proto.Message):
    ...
    Attributes:
        ...
        price (google.ads.googleads.v7.common.types.Money):
            Price value of this offer.
        unit (google.ads.googleads.v7.enums.types.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit):
...
class PromotionFeedItem(proto.Message):
    ...
    promotion_code = proto.Field(proto.STRING, number=18, oneof='promotion_trigger')
