...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def get_customer(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.Customer:
                A customer.
        """
    ...
    def mutate_customer(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v7.services.types.CustomerOperation`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCustomerResponse:
    ...
    def list_accessible_customers(self,
        ...
        Returns:
            google.ads.googleads.v7.services.types.ListAccessibleCustomersResponse:
    ...
    def create_customer_client(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            customer_client (:class:`google.ads.googleads.v7.resources.types.Customer`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.CreateCustomerClientResponse:
                Response message for
