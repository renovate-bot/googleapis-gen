...
class CustomerFeedServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CustomerFeedServiceTransport]]
...
class CustomerFeedServiceClient(metaclass=CustomerFeedServiceClientMeta):
    ...
    def transport(self) -> CustomerFeedServiceTransport:
        ...
        Returns:
            CustomerFeedServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiate the customer feed service client.
        ...
        if isinstance(transport, CustomerFeedServiceTransport):
            ...
            self._transport = CustomerFeedServiceGrpcTransport(
    ...
    def get_customer_feed(self,
            request: Union[customer_feed_service.GetCustomerFeedRequest, dict] = None,
            *,
        ...
        r"""Returns the requested customer feed in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCustomerFeedRequest, dict]):
                The request object. Request message for
                [CustomerFeedService.GetCustomerFeed][google.ads.googleads.v7.services.CustomerFeedService.GetCustomerFeed].
            resource_name (:class:`str`):
                Required. The resource name of the
                customer feed to fetch.
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CustomerFeed:
                A customer feed.
        """
        ...
        # in a customer_feed_service.GetCustomerFeedRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, customer_feed_service.GetCustomerFeedRequest):
            request = customer_feed_service.GetCustomerFeedRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_customer_feed]
    ...
    def mutate_customer_feeds(self,
            request: Union[customer_feed_service.MutateCustomerFeedsRequest, dict] = None,
            *,
            customer_id: str = None,
            operations: Sequence[customer_feed_service.CustomerFeedOperation] = None,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateCustomerFeedsRequest, dict]):
                The request object. Request message for
                [CustomerFeedService.MutateCustomerFeeds][google.ads.googleads.v7.services.CustomerFeedService.MutateCustomerFeeds].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CustomerFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCustomerFeedsResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, customer_feed_service.MutateCustomerFeedsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_customer_feeds]
