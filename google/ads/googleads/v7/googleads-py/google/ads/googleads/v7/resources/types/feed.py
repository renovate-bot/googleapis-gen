...
class Feed(proto.Message):
    ...
    Attributes:
        ...
        attributes (Sequence[google.ads.googleads.v7.resources.types.FeedAttribute]):
            ...
            attributes.
        attribute_operations (Sequence[google.ads.googleads.v7.resources.types.FeedAttributeOperation]):
            The list of operations changing the feed
            attributes. Attributes can only be added, not
            removed.
        origin (google.ads.googleads.v7.enums.types.FeedOriginEnum.FeedOrigin):
            Immutable. Specifies who manages the
            FeedAttributes for the Feed.
        status (google.ads.googleads.v7.enums.types.FeedStatusEnum.FeedStatus):
    ...
    class PlacesLocationFeedData(proto.Message):
        ...
        Attributes:
            oauth_info (google.ads.googleads.v7.resources.types.Feed.PlacesLocationFeedData.OAuthInfo):
    ...
    class AffiliateLocationFeedData(proto.Message):
        ...
        Attributes:
            ...
            relationship_type (google.ads.googleads.v7.enums.types.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType):
...
class FeedAttributeOperation(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v7.resources.types.FeedAttributeOperation.Operator):
            Output only. Type of list operation to
            perform.
        value (google.ads.googleads.v7.resources.types.FeedAttribute):
