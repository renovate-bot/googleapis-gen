...
class SearchGoogleAdsFieldsPager:
    ...
    :class:`google.ads.googleads.v7.services.types.SearchGoogleAdsFieldsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v7.services.types.SearchGoogleAdsFieldsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v7.services.types.SearchGoogleAdsFieldsResponse`):
