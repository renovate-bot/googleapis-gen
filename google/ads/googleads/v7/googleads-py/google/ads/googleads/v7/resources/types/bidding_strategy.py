...
class BiddingStrategy(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v7.enums.types.BiddingStrategyStatusEnum.BiddingStrategyStatus):
            Output only. The status of the bidding
            strategy.
            This field is read-only.
        type_ (google.ads.googleads.v7.enums.types.BiddingStrategyTypeEnum.BiddingStrategyType):
        ...
        non_removed_campaign_count (int):
            ...
            This field is read-only.
        enhanced_cpc (google.ads.googleads.v7.common.types.EnhancedCpc):
    ...
    maximize_conversion_value = proto.Field(proto.MESSAGE, number=21, oneof='scheme',
        message=bidding.MaximizeConversionValue,
    )
    maximize_conversions = proto.Field(proto.MESSAGE, number=22, oneof='scheme',
