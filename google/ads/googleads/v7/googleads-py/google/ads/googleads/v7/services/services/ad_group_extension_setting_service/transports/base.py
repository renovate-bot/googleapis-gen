...
class AdGroupExtensionSettingServiceTransport(abc.ABC):
    """Abstract transport class for AdGroupExtensionSettingService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_ad_group_extension_setting: gapic_v1.method.wrap_method(
                self.get_ad_group_extension_setting,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_ad_group_extension_settings: gapic_v1.method.wrap_method(
    ...
    @property
    def get_ad_group_extension_setting(self) -> Callable[
            [ad_group_extension_setting_service.GetAdGroupExtensionSettingRequest],
            Union[
                ad_group_extension_setting.AdGroupExtensionSetting,
                Awaitable[ad_group_extension_setting.AdGroupExtensionSetting]
            ]]:
        raise NotImplementedError()

    @property
    def mutate_ad_group_extension_settings(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[ad_group_extension_setting_service.MutateAdGroupExtensionSettingsResponse]
            ]]:
        raise NotImplementedError()
