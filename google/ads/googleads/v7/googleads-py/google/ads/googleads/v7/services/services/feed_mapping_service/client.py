...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def get_feed_mapping(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.FeedMapping:
                A feed mapping.
        """
    ...
    def mutate_feed_mappings(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.FeedMappingOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateFeedMappingsResponse:
