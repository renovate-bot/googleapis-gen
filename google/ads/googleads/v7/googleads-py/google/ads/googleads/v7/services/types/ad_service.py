...
class GetAdRequest(proto.Message):
    ...
    [AdService.GetAd][google.ads.googleads.v7.services.AdService.GetAd].
...
class MutateAdsRequest(proto.Message):
    r"""Request message for
    [AdService.MutateAds][google.ads.googleads.v7.services.AdService.MutateAds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ads
            are being modified.
        operations (Sequence[google.ads.googleads.v7.services.types.AdOperation]):
...
class AdOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v7.resources.types.Ad):
...
class MutateAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateAdResult]):
