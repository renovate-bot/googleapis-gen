...
class AccountBudgetProposalServiceClient(metaclass=AccountBudgetProposalServiceClientMeta):
    ...
    def get_account_budget_proposal(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetAccountBudgetProposalRequest`):
                The request object.
                Request message for
    ...
    def mutate_account_budget_proposal(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateAccountBudgetProposalRequest`):
                The request object.
                Request message for
