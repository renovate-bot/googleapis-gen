...
class AccountBudgetProposalServiceClient(metaclass=AccountBudgetProposalServiceClientMeta):
    ...
    def get_account_budget_proposal(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetAccountBudgetProposalRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AccountBudgetProposal:
    ...
    def mutate_account_budget_proposal(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateAccountBudgetProposalRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v7.services.types.AccountBudgetProposalOperation`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAccountBudgetProposalResponse:
