...
class GetSharedSetRequest(proto.Message):
    ...
    [SharedSetService.GetSharedSet][google.ads.googleads.v7.services.SharedSetService.GetSharedSet].
...
class MutateSharedSetsRequest(proto.Message):
    r"""Request message for
    [SharedSetService.MutateSharedSets][google.ads.googleads.v7.services.SharedSetService.MutateSharedSets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose shared
            sets are being modified.
        operations (Sequence[google.ads.googleads.v7.services.types.SharedSetOperation]):
...
class SharedSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.SharedSet):
            Create operation: No resource name is
            expected for the new shared set.
        update (google.ads.googleads.v7.resources.types.SharedSet):
...
class MutateSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateSharedSetResult]):
