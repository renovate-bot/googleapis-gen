...
class CampaignDraftOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.CampaignDraft):
            Create operation: No resource name is
            expected for the new campaign draft.
        update (google.ads.googleads.v7.resources.types.CampaignDraft):
...
class MutateCampaignDraftsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateCampaignDraftResult]):
