...
class SharedCriterionServiceClientMeta(type):
    """Metaclass for the SharedCriterionService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[SharedCriterionServiceTransport]]
    _transport_registry['grpc'] = SharedCriterionServiceGrpcTransport
...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def transport(self) -> SharedCriterionServiceTransport:
        ...
        Returns:
            SharedCriterionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, SharedCriterionServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the shared criterion service client.
        ...
        Args:
            ...
            transport (Union[str, SharedCriterionServiceTransport]): The
        ...
        if isinstance(transport, SharedCriterionServiceTransport):
            # transport is a SharedCriterionServiceTransport instance.
    ...
    def get_shared_criterion(self,
        ...
        r"""Returns the requested shared criterion in full detail.
        ...
        Returns:
            google.ads.googleads.v7.resources.types.SharedCriterion:
                A criterion belonging to a shared
                set.
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_shared_criterion]
    ...
    def mutate_shared_criteria(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v7.services.types.SharedCriterionOperation]):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateSharedCriteriaResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_shared_criteria]
