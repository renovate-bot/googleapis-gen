...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        """Instantiate the shared criterion service client.
        ...
        if isinstance(transport, SharedCriterionServiceTransport):
            ...
            self._transport = SharedCriterionServiceGrpcTransport(
    ...
    def mutate_shared_criteria(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.SharedCriterionOperation]`):
