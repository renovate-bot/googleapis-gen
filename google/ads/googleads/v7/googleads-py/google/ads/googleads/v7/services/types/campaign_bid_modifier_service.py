...
class GetCampaignBidModifierRequest(proto.Message):
    ...
    [CampaignBidModifierService.GetCampaignBidModifier][google.ads.googleads.v7.services.CampaignBidModifierService.GetCampaignBidModifier].
...
class MutateCampaignBidModifiersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v7.services.types.CampaignBidModifierOperation]):
...
class CampaignBidModifierOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v7.resources.types.CampaignBidModifier):
            Create operation: No resource name is
            expected for the new campaign bid modifier.
        update (google.ads.googleads.v7.resources.types.CampaignBidModifier):
...
class MutateCampaignBidModifiersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateCampaignBidModifierResult]):
