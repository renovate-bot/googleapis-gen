...
from google.ads.googleads.v7.enums.types import target_cpa_opt_in_recommendation_goal
...
class Recommendation(proto.Message):
    ...
    marginal_roi_campaign_budget_recommendation = proto.Field(proto.MESSAGE, number=29, oneof='recommendation',
        message=CampaignBudgetRecommendation,
    )
