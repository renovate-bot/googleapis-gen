...
from google.ads.googleads.v7.enums.types import batch_job_status
...
class BatchJobServiceClient(metaclass=BatchJobServiceClientMeta):
    ...
    def mutate_batch_job(self,
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateBatchJobResponse:
    ...
    def get_batch_job(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.BatchJob:
    ...
    def list_batch_job_results(self,
        ...
        Returns:
            google.ads.googleads.v7.services.services.batch_job_service.pagers.ListBatchJobResultsPager:
                Response message for
                [BatchJobService.ListBatchJobResults][google.ads.googleads.v7.services.BatchJobService.ListBatchJobResults].
    ...
    def add_batch_job_operations(self,
        ...
        Returns:
            google.ads.googleads.v7.services.types.AddBatchJobOperationsResponse:
                Response message for
                [BatchJobService.AddBatchJobOperations][google.ads.googleads.v7.services.BatchJobService.AddBatchJobOperations].
