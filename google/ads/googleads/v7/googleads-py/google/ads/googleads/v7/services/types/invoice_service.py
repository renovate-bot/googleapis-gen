...
class ListInvoicesRequest(proto.Message):
    ...
    Attributes:
        ...
        issue_month (google.ads.googleads.v7.enums.types.MonthOfYearEnum.MonthOfYear):
...
class ListInvoicesResponse(proto.Message):
    ...
    [InvoiceService.ListInvoices][google.ads.googleads.v7.services.InvoiceService.ListInvoices].

    Attributes:
        invoices (Sequence[google.ads.googleads.v7.resources.types.Invoice]):
