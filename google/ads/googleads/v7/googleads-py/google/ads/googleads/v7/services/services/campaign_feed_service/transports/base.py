...
class CampaignFeedServiceTransport(abc.ABC):
    """Abstract transport class for CampaignFeedService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_campaign_feed: gapic_v1.method.wrap_method(
                self.get_campaign_feed,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_campaign_feeds: gapic_v1.method.wrap_method(
                self.mutate_campaign_feeds,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    def get_campaign_feed(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[campaign_feed.CampaignFeed]
            ]]:
        raise NotImplementedError()
