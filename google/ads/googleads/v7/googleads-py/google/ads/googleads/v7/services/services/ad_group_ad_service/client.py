...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
    ...
    def get_ad_group_ad(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetAdGroupAdRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AdGroupAd:
                An ad group ad.
        """
    ...
    def mutate_ad_group_ads(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateAdGroupAdsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.AdGroupAdOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAdGroupAdsResponse:
