...
from google.ads.googleads.v7.common.types import text_label as gagc_text_label
...
class Label(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            and 80, inclusive.
        status (google.ads.googleads.v7.enums.types.LabelStatusEnum.LabelStatus):
            Output only. Status of the label. Read only.
        text_label (google.ads.googleads.v7.common.types.TextLabel):
