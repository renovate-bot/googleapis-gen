...
class MutateBatchJobResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v7.services.types.MutateBatchJobResult):
...
class ListBatchJobResultsRequest(proto.Message):
    ...
    response_content_type = proto.Field(proto.ENUM, number=4,
...
class ListBatchJobResultsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v7.services.types.BatchJobResult]):
...
class BatchJobResult(proto.Message):
    ...
    Attributes:
        ...
        mutate_operation_response (google.ads.googleads.v7.services.types.MutateOperationResponse):
