...
class AdGroupFeedServiceClient(metaclass=AdGroupFeedServiceClientMeta):
    ...
    def get_ad_group_feed(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AdGroupFeed:
                An ad group feed.
        """
    ...
    def mutate_ad_group_feeds(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.AdGroupFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAdGroupFeedsResponse:
