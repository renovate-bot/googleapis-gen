...
class MediaFileServiceClient(metaclass=MediaFileServiceClientMeta):
    ...
    def get_media_file(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetMediaFileRequest, dict]):
    ...
    def mutate_media_files(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateMediaFilesRequest, dict]):
                The request object. Request message for
