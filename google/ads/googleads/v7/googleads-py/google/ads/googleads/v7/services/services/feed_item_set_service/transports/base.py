...
class FeedItemSetServiceTransport(abc.ABC):
    """Abstract transport class for FeedItemSetService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_feed_item_set: gapic_v1.method.wrap_method(
                self.get_feed_item_set,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_feed_item_sets: gapic_v1.method.wrap_method(
                self.mutate_feed_item_sets,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    def get_feed_item_set(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[feed_item_set.FeedItemSet]
            ]]:
        raise NotImplementedError()
