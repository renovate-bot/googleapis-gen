...
class CampaignCriterionSimulationServiceClient(metaclass=CampaignCriterionSimulationServiceClientMeta):
    ...
    def get_campaign_criterion_simulation(self,
        ...
        r"""Returns the requested campaign criterion simulation in full
        detail.
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCampaignCriterionSimulationRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignCriterionSimulation:
