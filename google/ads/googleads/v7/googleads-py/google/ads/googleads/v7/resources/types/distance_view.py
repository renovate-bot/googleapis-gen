...
from google.ads.googleads.v7.enums.types import distance_bucket as gage_distance_bucket
...
class DistanceView(proto.Message):
    ...
    Attributes:
        ...
        distance_bucket (google.ads.googleads.v7.enums.types.DistanceBucketEnum.DistanceBucket):
