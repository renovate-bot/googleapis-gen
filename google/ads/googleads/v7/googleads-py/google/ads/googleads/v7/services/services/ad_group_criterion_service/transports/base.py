...
class AdGroupCriterionServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for AdGroupCriterionService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_ad_group_criterion: gapic_v1.method.wrap_method(
                self.get_ad_group_criterion,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_ad_group_criteria: gapic_v1.method.wrap_method(
                self.mutate_ad_group_criteria,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def get_ad_group_criterion(self) -> typing.Callable[
            [ad_group_criterion_service.GetAdGroupCriterionRequest],
            ad_group_criterion.AdGroupCriterion]:
        raise NotImplementedError

    @property
    def mutate_ad_group_criteria(self) -> typing.Callable[
