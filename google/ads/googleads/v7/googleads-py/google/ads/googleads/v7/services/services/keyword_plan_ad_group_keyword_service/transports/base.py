...
class KeywordPlanAdGroupKeywordServiceTransport(abc.ABC):
    ...
    def get_keyword_plan_ad_group_keyword(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[keyword_plan_ad_group_keyword.KeywordPlanAdGroupKeyword]
            ]]:
        raise NotImplementedError()
    ...
    def mutate_keyword_plan_ad_group_keywords(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[keyword_plan_ad_group_keyword_service.MutateKeywordPlanAdGroupKeywordsResponse]
            ]]:
        raise NotImplementedError()
