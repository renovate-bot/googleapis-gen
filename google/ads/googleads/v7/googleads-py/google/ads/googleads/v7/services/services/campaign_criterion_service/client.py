...
class CampaignCriterionServiceClient(metaclass=CampaignCriterionServiceClientMeta):
    ...
    def get_campaign_criterion(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCampaignCriterionRequest, dict]):
                The request object. Request message for
                [CampaignCriterionService.GetCampaignCriterion][google.ads.googleads.v7.services.CampaignCriterionService.GetCampaignCriterion].
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignCriterion:
    ...
    def mutate_campaign_criteria(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateCampaignCriteriaRequest, dict]):
                The request object. Request message for
                [CampaignCriterionService.MutateCampaignCriteria][google.ads.googleads.v7.services.CampaignCriterionService.MutateCampaignCriteria].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CampaignCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignCriteriaResponse:
