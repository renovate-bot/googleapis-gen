...
class CampaignCriterionServiceClient(metaclass=CampaignCriterionServiceClientMeta):
    ...
    def get_campaign_criterion(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetCampaignCriterionRequest`):
    ...
    def mutate_campaign_criteria(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateCampaignCriteriaRequest`):
                The request object. Request message for
