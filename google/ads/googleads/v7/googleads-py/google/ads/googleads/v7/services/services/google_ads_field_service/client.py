...
class GoogleAdsFieldServiceClient(metaclass=GoogleAdsFieldServiceClientMeta):
    ...
    def get_google_ads_field(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetGoogleAdsFieldRequest`):
                The request object.
                Request message for
    ...
    def search_google_ads_fields(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.SearchGoogleAdsFieldsRequest`):
                The request object.
                Request message for
