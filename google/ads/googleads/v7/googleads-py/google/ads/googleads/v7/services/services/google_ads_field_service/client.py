...
class GoogleAdsFieldServiceClient(metaclass=GoogleAdsFieldServiceClientMeta):
    ...
    def get_google_ads_field(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetGoogleAdsFieldRequest, dict]):
                The request object. Request message for
                [GoogleAdsFieldService.GetGoogleAdsField][google.ads.googleads.v7.services.GoogleAdsFieldService.GetGoogleAdsField].
        ...
        Returns:
            google.ads.googleads.v7.resources.types.GoogleAdsField:
    ...
    def search_google_ads_fields(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.SearchGoogleAdsFieldsRequest, dict]):
                The request object. Request message for
                [GoogleAdsFieldService.SearchGoogleAdsFields][google.ads.googleads.v7.services.GoogleAdsFieldService.SearchGoogleAdsFields].
            query (:class:`str`):
        ...
        Returns:
            google.ads.googleads.v7.services.services.google_ads_field_service.pagers.SearchGoogleAdsFieldsPager:
