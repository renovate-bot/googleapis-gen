...
class YearMonthRange(proto.Message):
    ...
    Attributes:
        start (google.ads.googleads.v7.common.types.YearMonth):
            The inclusive start year month.
        end (google.ads.googleads.v7.common.types.YearMonth):
...
class YearMonth(proto.Message):
    ...
    Attributes:
        year (int):
            The year (e.g. 2020).
        month (google.ads.googleads.v7.enums.types.MonthOfYearEnum.MonthOfYear):
