...
class LifeEventServiceTransport(abc.ABC):
    """Abstract transport class for LifeEventService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_life_event: gapic_v1.method.wrap_method(
                self.get_life_event,
    ...
    def get_life_event(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[life_event.LifeEvent]
            ]]:
        raise NotImplementedError()


__all__ = (
    'LifeEventServiceTransport',
)
