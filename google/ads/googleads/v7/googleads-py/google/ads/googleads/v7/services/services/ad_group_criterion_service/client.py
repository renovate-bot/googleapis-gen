...
from .transports.base import AdGroupCriterionServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import AdGroupCriterionServiceGrpcTransport


class AdGroupCriterionServiceClientMeta(type):
    """Metaclass for the AdGroupCriterionService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AdGroupCriterionServiceTransport]]
    _transport_registry['grpc'] = AdGroupCriterionServiceGrpcTransport
...
class AdGroupCriterionServiceClient(metaclass=AdGroupCriterionServiceClientMeta):
    ...
    def transport(self) -> AdGroupCriterionServiceTransport:
        ...
        Returns:
            AdGroupCriterionServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, AdGroupCriterionServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the ad group criterion service client.
        ...
        Args:
            ...
            transport (Union[str, ~.AdGroupCriterionServiceTransport]): The
        ...
        if isinstance(transport, AdGroupCriterionServiceTransport):
            # transport is a AdGroupCriterionServiceTransport instance.
            if credentials:
            ...
            self._transport = AdGroupCriterionServiceGrpcTransport(
    ...
    def get_ad_group_criterion(self,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AdGroupCriterion:
        ...
        # in a ad_group_criterion_service.GetAdGroupCriterionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, ad_group_criterion_service.GetAdGroupCriterionRequest):
            request = ad_group_criterion_service.GetAdGroupCriterionRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_ad_group_criterion]
    ...
    def mutate_ad_group_criteria(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.AdGroupCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAdGroupCriteriaResponse:
        ...
        if request is not None and any([customer_id, operations]):
           ...
           # Minor optimization to avoid making a copy if the user passes
        # in a ad_group_criterion_service.MutateAdGroupCriteriaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, ad_group_criterion_service.MutateAdGroupCriteriaRequest):
            request = ad_group_criterion_service.MutateAdGroupCriteriaRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_ad_group_criteria]
