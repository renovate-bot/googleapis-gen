...
class AdGroupCriterionServiceClient(metaclass=AdGroupCriterionServiceClientMeta):
    ...
    def transport(self) -> AdGroupCriterionServiceTransport:
        ...
        Returns:
            AdGroupCriterionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the ad group criterion service client.
    ...
    def mutate_ad_group_criteria(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v7.services.types.AdGroupCriterionOperation]):
