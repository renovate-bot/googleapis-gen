...
class AdGroupCriterionOperation(proto.Message):
    ...
    Attributes:
        ...
        exempt_policy_violation_keys (Sequence[google.ads.googleads.v7.common.types.PolicyViolationKey]):
...
class MutateAdGroupCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateAdGroupCriterionResult]):
