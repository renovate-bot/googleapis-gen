...
class CampaignDraftServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CampaignDraftServiceTransport]]
...
class CampaignDraftServiceClient(metaclass=CampaignDraftServiceClientMeta):
    ...
    def get_campaign_draft(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.GetCampaignDraftRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.GetCampaignDraft][google.ads.googleads.v7.services.CampaignDraftService.GetCampaignDraft].
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignDraft:
                A campaign draft.
        """
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_campaign_draft]
    ...
    def mutate_campaign_drafts(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.MutateCampaignDraftsRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.MutateCampaignDrafts][google.ads.googleads.v7.services.CampaignDraftService.MutateCampaignDrafts].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CampaignDraftOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignDraftsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_campaign_drafts]
    ...
    def promote_campaign_draft(self,
        ...
        use
        [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v7.services.CampaignDraftService.ListCampaignDraftAsyncErrors]
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.PromoteCampaignDraftRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.PromoteCampaignDraft][google.ads.googleads.v7.services.CampaignDraftService.PromoteCampaignDraft].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.promote_campaign_draft]
    ...
    def list_campaign_draft_async_errors(self,
        ...
        Args:
            request (Union[google.ads.googleads.v7.services.types.ListCampaignDraftAsyncErrorsRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v7.services.CampaignDraftService.ListCampaignDraftAsyncErrors].
            resource_name (:class:`str`):
        ...
        Returns:
            google.ads.googleads.v7.services.services.campaign_draft_service.pagers.ListCampaignDraftAsyncErrorsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_campaign_draft_async_errors]
