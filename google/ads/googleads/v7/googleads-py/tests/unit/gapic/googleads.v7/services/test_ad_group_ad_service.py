...
def test_ad_group_ad_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v7.services.services.ad_group_ad_service.AdGroupAdServiceClient.get_transport_class') as gtc:
...
def test_ad_group_ad_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v7.services.services.ad_group_ad_service.transports.AdGroupAdServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AdGroupAdServiceTransport()
        adc.assert_called_once()
