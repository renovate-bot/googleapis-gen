...
from google.ads.googleads.v7.services.services.customer_service import CustomerServiceClient
from google.ads.googleads.v7.services.services.customer_service import transports
...
def test_customer_service_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.CustomerServiceGrpcTransport, "grpc"),
])
def test_customer_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_customer_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (CustomerServiceClient, transports.CustomerServiceGrpcTransport, "grpc"),
])
@mock.patch.object(CustomerServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CustomerServiceClient))
def test_customer_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(CustomerServiceClient, 'get_transport_class') as gtc:
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (CustomerServiceClient, transports.CustomerServiceGrpcTransport, "grpc", "true"),
    (CustomerServiceClient, transports.CustomerServiceGrpcTransport, "grpc", "false"),
])
@mock.patch.object(CustomerServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CustomerServiceClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_customer_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_customer_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_customer_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_customer_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v7.services.services.customer_service.transports.CustomerServiceGrpcTransport.__init__') as grpc_transport:
...
def test_mutate_customer(request_type, transport: str = 'grpc'):
    client = CustomerServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_customer_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CustomerServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_mutate_customer_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = customer_service.CustomerOperation(update=customer.Customer(resource_name='resource_name_value'))
        assert arg == mock_val
...
def test_list_accessible_customers(request_type, transport: str = 'grpc'):
    client = CustomerServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_accessible_customers_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CustomerServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_customer_client(request_type, transport: str = 'grpc'):
    client = CustomerServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_customer_client_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CustomerServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_customer_client_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = 'customer_id_value'
        assert arg == mock_val
        arg = args[0].customer_client
        mock_val = customer.Customer(resource_name='resource_name_value')
        assert arg == mock_val
...
def test_customer_service_base_transport_error():
...
def test_customer_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v7.services.services.customer_service.transports.CustomerServiceTransport.__init__') as Transport:
...
def test_customer_service_base_transport_with_credentials_file():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.googleads.v7.services.services.customer_service.transports.CustomerServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_customer_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.googleads.v7.services.services.customer_service.transports.CustomerServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CustomerServiceTransport()
        adc.assert_called_once()
...
def test_customer_service_transport_auth_adc(transport_class):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.CustomerServiceGrpcTransport, grpc_helpers),
    ],
)
def test_customer_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_customer_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_conversion_action_path():
    ...
    actual = CustomerServiceClient.conversion_action_path(customer_id, conversion_action_id)
...
def test_customer_path():
    ...
    actual = CustomerServiceClient.customer_path(customer_id)
    assert expected == actual
