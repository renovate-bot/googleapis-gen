...
from google.ads.googleads.v7.services.services.asset_service import AssetServiceClient
from google.ads.googleads.v7.services.services.asset_service import transports
...
def test_asset_service_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        factory.return_value = creds
        client = AssetServiceClient.from_service_account_file("dummy/file/path.json")
        assert client.transport._credentials == creds

        client = AssetServiceClient.from_service_account_json("dummy/file/path.json")
        assert client.transport._credentials == creds
...
def test_asset_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v7.services.services.asset_service.AssetServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v7.services.services.asset_service.transports.AssetServiceGrpcTransport.__init__') as grpc_transport:
        grpc_transport.return_value = None
        client = AssetServiceClient(client_options=options)
...
def test_asset_service_client_mtls_env_auto(use_client_cert_env):
...
def test_get_asset(transport: str = 'grpc', request_type=asset_service.GetAssetRequest):
    client = AssetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.get_asset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = asset.Asset(
            resource_name='resource_name_value',
            id=205,
            name='name_value',
            type_=asset_type.AssetTypeEnum.AssetType.UNKNOWN,
            ...
            youtube_video_asset=asset_types.YoutubeVideoAsset(youtube_video_id='youtube_video_id_value'),
        )
        ...
        assert args[0] == asset_service.GetAssetRequest()

    # Establish that the response is the type that we expect.
    assert isinstance(response, asset.Asset)
    assert response.resource_name == 'resource_name_value'
    assert response.id == 205
    assert response.name == 'name_value'
    assert response.type_ == asset_type.AssetTypeEnum.AssetType.UNKNOWN
...
def test_get_asset_from_dict():
    test_get_asset(request_type=dict)
...
def test_mutate_assets(transport: str = 'grpc', request_type=asset_service.MutateAssetsRequest):
    client = AssetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.mutate_assets),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_mutate_assets_from_dict():
    test_mutate_assets(request_type=dict)


def test_mutate_assets_field_headers():
    client = AssetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_mutate_assets_flattened():
    client = AssetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.mutate_assets(
            ...
            operations=[asset_service.AssetOperation(update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))],
        )
        ...
        assert args[0].operations == [asset_service.AssetOperation(update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))]


def test_mutate_assets_flattened_error():
    client = AssetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_asset_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v7.services.services.asset_service.transports.AssetServiceTransport.__init__') as Transport:
...
def test_asset_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v7.services.services.asset_service.transports.AssetServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AssetServiceTransport()
        adc.assert_called_once()
...
def test_asset_service_transport_auth_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transports.AssetServiceGrpcTransport(host="squid.clam.whelk")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/adwords',
        ))
...
@pytest.mark.parametrize("transport_class", [transports.AssetServiceGrpcTransport])
...
def test_asset_path():
    ...
    actual = AssetServiceClient.asset_path(customer_id, asset_id)
