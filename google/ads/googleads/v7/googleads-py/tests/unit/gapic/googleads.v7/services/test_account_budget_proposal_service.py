...
from google.ads.googleads.v7.services.services.account_budget_proposal_service import AccountBudgetProposalServiceClient
from google.ads.googleads.v7.services.services.account_budget_proposal_service import transports
...
def test_account_budget_proposal_service_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.AccountBudgetProposalServiceGrpcTransport, "grpc"),
])
def test_account_budget_proposal_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_account_budget_proposal_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (AccountBudgetProposalServiceClient, transports.AccountBudgetProposalServiceGrpcTransport, "grpc"),
])
...
def test_account_budget_proposal_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(AccountBudgetProposalServiceClient, 'get_transport_class') as gtc:
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (AccountBudgetProposalServiceClient, transports.AccountBudgetProposalServiceGrpcTransport, "grpc", "true"),
    (AccountBudgetProposalServiceClient, transports.AccountBudgetProposalServiceGrpcTransport, "grpc", "false"),
])
@mock.patch.object(AccountBudgetProposalServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AccountBudgetProposalServiceClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_account_budget_proposal_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_account_budget_proposal_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_account_budget_proposal_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_account_budget_proposal_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v7.services.services.account_budget_proposal_service.transports.AccountBudgetProposalServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_account_budget_proposal(request_type, transport: str = 'grpc'):
    client = AccountBudgetProposalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = account_budget_proposal.AccountBudgetProposal(
            ...
            account_budget='account_budget_value',
            ...
            proposed_name='proposed_name_value',
            approved_start_date_time='approved_start_date_time_value',
            proposed_purchase_order_number='proposed_purchase_order_number_value',
            proposed_notes='proposed_notes_value',
            creation_date_time='creation_date_time_value',
            approval_date_time='approval_date_time_value',
    ...
    assert response.account_budget == 'account_budget_value'
    ...
    assert response.proposed_name == 'proposed_name_value'
    assert response.approved_start_date_time == 'approved_start_date_time_value'
    assert response.proposed_purchase_order_number == 'proposed_purchase_order_number_value'
    assert response.proposed_notes == 'proposed_notes_value'
    assert response.creation_date_time == 'creation_date_time_value'
    assert response.approval_date_time == 'approval_date_time_value'


def test_get_account_budget_proposal_empty_call():
...
def test_mutate_account_budget_proposal(request_type, transport: str = 'grpc'):
    client = AccountBudgetProposalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_account_budget_proposal_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = AccountBudgetProposalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_mutate_account_budget_proposal_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = account_budget_proposal_service.AccountBudgetProposalOperation(update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert arg == mock_val
...
def test_account_budget_proposal_service_base_transport_error():
...
def test_account_budget_proposal_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v7.services.services.account_budget_proposal_service.transports.AccountBudgetProposalServiceTransport.__init__') as Transport:
...
def test_account_budget_proposal_service_base_transport_with_credentials_file():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.googleads.v7.services.services.account_budget_proposal_service.transports.AccountBudgetProposalServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_account_budget_proposal_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.googleads.v7.services.services.account_budget_proposal_service.transports.AccountBudgetProposalServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AccountBudgetProposalServiceTransport()
        adc.assert_called_once()
...
def test_account_budget_proposal_service_transport_auth_adc(transport_class):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.AccountBudgetProposalServiceGrpcTransport, grpc_helpers),
    ],
)
def test_account_budget_proposal_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_account_budget_proposal_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_billing_setup_path():
    ...
    actual = AccountBudgetProposalServiceClient.billing_setup_path(customer_id, billing_setup_id)
    assert expected == actual
