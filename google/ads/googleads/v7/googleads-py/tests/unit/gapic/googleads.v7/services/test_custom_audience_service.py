...
def test_custom_audience_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v7.services.services.custom_audience_service.CustomAudienceServiceClient.get_transport_class') as gtc:
...
def test_mutate_custom_audiences_flattened():
    ...
    with mock.patch.object(
        ...
        client.mutate_custom_audiences(
            ...
            operations=[custom_audience_service.CustomAudienceOperation(update_mask=field_mask.FieldMask(paths=['paths_value']))],
        )
        ...
        assert args[0].operations == [custom_audience_service.CustomAudienceOperation(update_mask=field_mask.FieldMask(paths=['paths_value']))]
...
def test_custom_audience_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.ads.googleads.v7.services.services.custom_audience_service.transports.CustomAudienceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.CustomAudienceServiceTransport()
        adc.assert_called_once()
