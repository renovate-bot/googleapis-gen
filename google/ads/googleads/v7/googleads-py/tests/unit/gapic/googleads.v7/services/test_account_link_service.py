...
def test_account_link_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v7.services.services.account_link_service.AccountLinkServiceClient.get_transport_class') as gtc:
...
def test_account_link_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v7.services.services.account_link_service.transports.AccountLinkServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AccountLinkServiceTransport()
        adc.assert_called_once()
