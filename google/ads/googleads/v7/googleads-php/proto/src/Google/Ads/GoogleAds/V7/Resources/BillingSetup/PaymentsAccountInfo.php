...
namespace Google\Ads\GoogleAds\V7\Resources\BillingSetup;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.BillingSetup.PaymentsAccountInfo</code>
 */
class PaymentsAccountInfo extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Resources\BillingSetup::initOnce();
...
class_alias(PaymentsAccountInfo::class, \Google\Ads\GoogleAds\V7\Resources\BillingSetup_PaymentsAccountInfo::class);
