 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.ProductBiddingCategoryInfo</code>
 */
class ProductBiddingCategoryInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevel level = 3;</code>
     */
    protected $level = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\ProductBiddingCategoryLevelEnum\ProductBiddingCategoryLevel::class);
        $this->level = $var;
