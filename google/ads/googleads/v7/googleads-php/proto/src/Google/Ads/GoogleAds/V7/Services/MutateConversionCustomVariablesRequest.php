 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateConversionCustomVariablesRequest</code>
 */
class MutateConversionCustomVariablesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * variables.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.ConversionCustomVariableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose conversion custom variables are being
     *           modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\ConversionCustomVariableOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual conversion custom
     *           variables.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\ConversionCustomVariableService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.ConversionCustomVariableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\ConversionCustomVariableOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\ConversionCustomVariableOperation::class);
        $this->operations = $arr;
