 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.TransactionAttribute</code>
 */
class TransactionAttribute extends \Google\Protobuf\Internal\Message
{
     ...
     * Accessible only to customers on the allow-list.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.StoreAttribute store_attribute = 6;</code>
     */
     ...
     *           Transaction order id.
     *           Accessible only to customers on the allow-list.
     *     @type \Google\Ads\GoogleAds\V7\Common\StoreAttribute $store_attribute
     *           Store attributes of the transaction.
     *           Accessible only to customers on the allow-list.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.StoreAttribute store_attribute = 6;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\StoreAttribute|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.StoreAttribute store_attribute = 6;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\StoreAttribute $var
     * @return $this
     */
    public function setStoreAttribute($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\StoreAttribute::class);
