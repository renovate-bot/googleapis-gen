 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.errors.RegionCodeErrorEnum</code>
 */
class RegionCodeErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Errors\RegionCodeError::initOnce();
