 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.FeedItemSet</code>
 */
class FeedItemSet extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.FeedItemSetStatusEnum.FeedItemSetStatus status = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
     ...
     *           Output only. Status of the feed item set.
     *           This field is read-only.
     *     @type \Google\Ads\GoogleAds\V7\Common\DynamicLocationSetFilter $dynamic_location_set_filter
     *           Filter for dynamic location set.
     *           It is only used for sets of locations.
     *     @type \Google\Ads\GoogleAds\V7\Common\DynamicAffiliateLocationSetFilter $dynamic_affiliate_location_set_filter
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Resources\FeedItemSet::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\FeedItemSetStatusEnum\FeedItemSetStatus::class);
        $this->status = $var;
     ...
     * It is only used for sets of locations.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.DynamicLocationSetFilter dynamic_location_set_filter = 5;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\DynamicLocationSetFilter|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.DynamicLocationSetFilter dynamic_location_set_filter = 5;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\DynamicLocationSetFilter $var
     * @return $this
     */
    public function setDynamicLocationSetFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\DynamicLocationSetFilter::class);
     ...
     * sets of affiliate locations.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.DynamicAffiliateLocationSetFilter dynamic_affiliate_location_set_filter = 6;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\DynamicAffiliateLocationSetFilter|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.DynamicAffiliateLocationSetFilter dynamic_affiliate_location_set_filter = 6;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\DynamicAffiliateLocationSetFilter $var
     * @return $this
     */
    public function setDynamicAffiliateLocationSetFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\DynamicAffiliateLocationSetFilter::class);
