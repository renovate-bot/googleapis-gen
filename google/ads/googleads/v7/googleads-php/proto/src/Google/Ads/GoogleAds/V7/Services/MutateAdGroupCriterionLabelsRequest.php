 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateAdGroupCriterionLabelsRequest</code>
 */
class MutateAdGroupCriterionLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.AdGroupCriterionLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose ad group criterion labels are being modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\AdGroupCriterionLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on ad group criterion labels.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\AdGroupCriterionLabelService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.AdGroupCriterionLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\AdGroupCriterionLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\AdGroupCriterionLabelOperation::class);
        $this->operations = $arr;
