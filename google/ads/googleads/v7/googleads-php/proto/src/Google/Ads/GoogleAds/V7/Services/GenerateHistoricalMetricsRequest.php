 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GenerateHistoricalMetricsRequest</code>
 */
class GenerateHistoricalMetricsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordPlanAggregateMetrics aggregate_metrics = 2;</code>
     */
    protected $aggregate_metrics = null;
    /**
     * The options for historical metrics data.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.HistoricalMetricsOptions historical_metrics_options = 3;</code>
     */
     ...
     *           Required. The resource name of the keyword plan of which historical metrics are
     *           requested.
     *     @type \Google\Ads\GoogleAds\V7\Common\KeywordPlanAggregateMetrics $aggregate_metrics
     *           The aggregate fields to include in response.
     *     @type \Google\Ads\GoogleAds\V7\Common\HistoricalMetricsOptions $historical_metrics_options
     *           The options for historical metrics data.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordPlanAggregateMetrics aggregate_metrics = 2;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\KeywordPlanAggregateMetrics|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordPlanAggregateMetrics aggregate_metrics = 2;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\KeywordPlanAggregateMetrics $var
     * @return $this
     */
    public function setAggregateMetrics($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\KeywordPlanAggregateMetrics::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.HistoricalMetricsOptions historical_metrics_options = 3;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\HistoricalMetricsOptions|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.HistoricalMetricsOptions historical_metrics_options = 3;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\HistoricalMetricsOptions $var
     * @return $this
     */
    public function setHistoricalMetricsOptions($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\HistoricalMetricsOptions::class);
