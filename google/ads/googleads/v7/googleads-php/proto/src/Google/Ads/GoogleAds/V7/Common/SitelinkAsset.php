 ...
 * A Sitelink asset.
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.SitelinkAsset</code>
 */
class SitelinkAsset extends \Google\Protobuf\Internal\Message
{
     ...
     * total.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.common.AdScheduleInfo ad_schedule_targets = 6;</code>
     */
     ...
     *           Last date of when this asset is effective and still serving, in yyyy-MM-dd
     *           format.
     *     @type \Google\Ads\GoogleAds\V7\Common\AdScheduleInfo[]|\Google\Protobuf\Internal\RepeatedField $ad_schedule_targets
     *           List of non-overlapping schedules specifying all time intervals for which
     *           the asset may serve. There can be a maximum of 6 schedules per day, 42 in
     *           total.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.common.AdScheduleInfo ad_schedule_targets = 6;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\AdScheduleInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAdScheduleTargets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Common\AdScheduleInfo::class);
