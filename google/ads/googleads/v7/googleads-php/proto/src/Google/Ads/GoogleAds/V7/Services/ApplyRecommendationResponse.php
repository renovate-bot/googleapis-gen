 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.ApplyRecommendationResponse</code>
 */
class ApplyRecommendationResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.ApplyRecommendationResult results = 1;</code>
     */
    private $results;
    /**
     ...
     *
     *     @type \Google\Ads\GoogleAds\V7\Services\ApplyRecommendationResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           Results of operations to apply recommendations.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.ApplyRecommendationResult results = 1;</code>
     * @param \Google\Ads\GoogleAds\V7\Services\ApplyRecommendationResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\ApplyRecommendationResult::class);
        $this->results = $arr;
