 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.WebpageInfo</code>
 */
class WebpageInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * operations.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.common.WebpageConditionInfo conditions = 2;</code>
     */
    private $conditions;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.WebpageSampleInfo sample = 5;</code>
     */
     ...
     *           This field is required for CREATE operations and is prohibited on UPDATE
     *           operations.
     *     @type \Google\Ads\GoogleAds\V7\Common\WebpageConditionInfo[]|\Google\Protobuf\Internal\RepeatedField $conditions
     *           Conditions, or logical expressions, for webpage targeting. The list of
     *           webpage targeting conditions are and-ed together when evaluated
     *           for targeting.
     *           This field is required for CREATE operations and is prohibited on UPDATE
     ...
     *           coverage returns as 1, it indicates it has 100% coverage. This field is
     *           read-only.
     *     @type \Google\Ads\GoogleAds\V7\Common\WebpageSampleInfo $sample
     *           List of sample urls that match the website target. This field is read-only.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.common.WebpageConditionInfo conditions = 2;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\WebpageConditionInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setConditions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Common\WebpageConditionInfo::class);
        $this->conditions = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.WebpageSampleInfo sample = 5;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\WebpageSampleInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.WebpageSampleInfo sample = 5;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\WebpageSampleInfo $var
     * @return $this
     */
    public function setSample($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\WebpageSampleInfo::class);
        $this->sample = $var;
