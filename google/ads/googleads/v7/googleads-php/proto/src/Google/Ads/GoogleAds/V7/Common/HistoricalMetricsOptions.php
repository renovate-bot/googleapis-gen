 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.HistoricalMetricsOptions</code>
 */
class HistoricalMetricsOptions extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v7.common.YearMonthRange year_month_range = 1;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V7\Common\YearMonthRange $year_month_range
     *           The year month range for historical metrics. If not specified the searches
     *           will be returned for past 12 months.
     *           Searches data is available for the past 4 years. If the search volume is
     *           not available for the entire year_month_range provided, the subset of the
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v7.common.YearMonthRange year_month_range = 1;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\YearMonthRange|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v7.common.YearMonthRange year_month_range = 1;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\YearMonthRange $var
     * @return $this
     */
    public function setYearMonthRange($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\YearMonthRange::class);
