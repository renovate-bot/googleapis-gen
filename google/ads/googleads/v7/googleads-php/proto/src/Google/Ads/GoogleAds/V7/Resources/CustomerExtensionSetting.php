 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.CustomerExtensionSetting</code>
 */
class CustomerExtensionSetting extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.ExtensionTypeEnum.ExtensionType extension_type = 2 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.ExtensionSettingDeviceEnum.ExtensionSettingDevice device = 4;</code>
     */
    protected $device = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Resources\CustomerExtensionSetting::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\ExtensionTypeEnum\ExtensionType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\ExtensionSettingDeviceEnum\ExtensionSettingDevice::class);
        $this->device = $var;
