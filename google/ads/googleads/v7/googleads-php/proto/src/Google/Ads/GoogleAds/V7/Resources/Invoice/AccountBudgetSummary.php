...
namespace Google\Ads\GoogleAds\V7\Resources\Invoice;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.Invoice.AccountBudgetSummary</code>
 */
class AccountBudgetSummary extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.DateRange billable_activity_date_range = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           in micros. This equals the sum of the account budget subtotal amount and
     *           the account budget tax amount.
     *     @type \Google\Ads\GoogleAds\V7\Common\DateRange $billable_activity_date_range
     *           Output only. The billable activity date range of the account budget, within the
     *           service date range of this invoice. The end date is inclusive. This can
     *           be different from the account budget's start and end time.
     * }
...
class_alias(AccountBudgetSummary::class, \Google\Ads\GoogleAds\V7\Resources\Invoice_AccountBudgetSummary::class);
