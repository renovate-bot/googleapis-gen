 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.FeedAttribute</code>
 */
class FeedAttribute extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.FeedAttributeTypeEnum.FeedAttributeType type = 3;</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\FeedAttributeTypeEnum\FeedAttributeType::class);
        $this->type = $var;
