 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.errors.OperatorErrorEnum</code>
 */
class OperatorErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Errors\OperatorError::initOnce();
