 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.Recommendation.MoveUnusedBudgetRecommendation</code>
 */
class MoveUnusedBudgetRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.Recommendation.CampaignBudgetRecommendation budget_recommendation = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The excess budget's resource_name.
     *     @type \Google\Ads\GoogleAds\V7\Resources\Recommendation\CampaignBudgetRecommendation $budget_recommendation
     *           Output only. The recommendation for the constrained budget to increase.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.Recommendation.CampaignBudgetRecommendation budget_recommendation = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V7\Resources\Recommendation\CampaignBudgetRecommendation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.Recommendation.CampaignBudgetRecommendation budget_recommendation = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V7\Resources\Recommendation\CampaignBudgetRecommendation $var
     * @return $this
     */
    public function setBudgetRecommendation($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Resources\Recommendation\CampaignBudgetRecommendation::class);
...
class_alias(MoveUnusedBudgetRecommendation::class, \Google\Ads\GoogleAds\V7\Resources\Recommendation_MoveUnusedBudgetRecommendation::class);
