 ...
 * change.
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.ChangeEvent</code>
 */
class ChangeEvent extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.ChangeEventResourceTypeEnum.ChangeEventResourceType change_resource_type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.ChangeClientTypeEnum.ChangeClientType client_type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.ChangeEvent.ChangedResource old_resource = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $old_resource = null;
    /**
     * Output only. The new resource after the change. Only changed fields will be populated.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.ChangeEvent.ChangedResource new_resource = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $new_resource = null;
    /**
     * Output only. The operation on the changed resource.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.ResourceChangeOperationEnum.ResourceChangeOperation resource_change_operation = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The email of the user who made this change.
     *     @type \Google\Ads\GoogleAds\V7\Resources\ChangeEvent\ChangedResource $old_resource
     *           Output only. The old resource before the change. Only changed fields will be populated.
     *     @type \Google\Ads\GoogleAds\V7\Resources\ChangeEvent\ChangedResource $new_resource
     *           Output only. The new resource after the change. Only changed fields will be populated.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\ChangeEventResourceTypeEnum\ChangeEventResourceType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\ChangeClientTypeEnum\ChangeClientType::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.ChangeEvent.ChangedResource old_resource = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V7\Resources\ChangeEvent\ChangedResource|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.ChangeEvent.ChangedResource old_resource = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V7\Resources\ChangeEvent\ChangedResource $var
     * @return $this
     */
    public function setOldResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Resources\ChangeEvent\ChangedResource::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\ResourceChangeOperationEnum\ResourceChangeOperation::class);
