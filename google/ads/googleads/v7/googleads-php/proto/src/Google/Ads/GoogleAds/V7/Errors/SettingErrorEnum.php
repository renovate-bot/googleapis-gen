 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.errors.SettingErrorEnum</code>
 */
class SettingErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Errors\SettingError::initOnce();
