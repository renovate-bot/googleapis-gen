 ...
 * A campaign budget.
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.CampaignBudget</code>
 */
class CampaignBudget extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.BudgetStatusEnum.BudgetStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod delivery_method = 7;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.BudgetPeriodEnum.BudgetPeriod period = 13 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $period = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.BudgetTypeEnum.BudgetType type = 18 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $type = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Resources\CampaignBudget::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\BudgetStatusEnum\BudgetStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\BudgetDeliveryMethodEnum\BudgetDeliveryMethod::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\BudgetPeriodEnum\BudgetPeriod::class);
        $this->period = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\BudgetTypeEnum\BudgetType::class);
        $this->type = $var;
