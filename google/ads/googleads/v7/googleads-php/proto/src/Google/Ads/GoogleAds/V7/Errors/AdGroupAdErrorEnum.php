 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.errors.AdGroupAdErrorEnum</code>
 */
class AdGroupAdErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Errors\AdGroupAdError::initOnce();
