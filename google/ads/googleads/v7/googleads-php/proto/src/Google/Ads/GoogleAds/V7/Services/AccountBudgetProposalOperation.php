 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.AccountBudgetProposalOperation</code>
 */
class AccountBudgetProposalOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           Proposals that modify budgets have the 'update' proposal type.  Specifying
     *           a mask for any other proposal type is considered an error.
     *     @type \Google\Ads\GoogleAds\V7\Resources\AccountBudgetProposal $create
     ...
     * No resource name is expected for the new proposal.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.AccountBudgetProposal create = 2;</code>
     * @return \Google\Ads\GoogleAds\V7\Resources\AccountBudgetProposal|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.AccountBudgetProposal create = 2;</code>
     * @param \Google\Ads\GoogleAds\V7\Resources\AccountBudgetProposal $var
     * @return $this
     */
    public function setCreate($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Resources\AccountBudgetProposal::class);
