...
namespace Google\Ads\GoogleAds\V7\Resources\AdGroupCriterion;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.AdGroupCriterion.QualityInfo</code>
 */
class QualityInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.QualityScoreBucketEnum.QualityScoreBucket creative_quality_score = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $creative_quality_score = 0;
    /**
     * Output only. The quality score of the landing page.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.QualityScoreBucketEnum.QualityScoreBucket post_click_quality_score = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $post_click_quality_score = 0;
    /**
     * Output only. The click-through rate compared to that of other advertisers.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.QualityScoreBucketEnum.QualityScoreBucket search_predicted_ctr = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Resources\AdGroupCriterion::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\QualityScoreBucketEnum\QualityScoreBucket::class);
...
class_alias(QualityInfo::class, \Google\Ads\GoogleAds\V7\Resources\AdGroupCriterion_QualityInfo::class);
