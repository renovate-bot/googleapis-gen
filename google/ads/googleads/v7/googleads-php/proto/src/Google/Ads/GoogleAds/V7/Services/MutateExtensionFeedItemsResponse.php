 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateExtensionFeedItemsResponse</code>
 */
class MutateExtensionFeedItemsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.MutateExtensionFeedItemResult results = 2;</code>
     */
    private $results;
     ...
     *           operations. If any errors occur outside the operations (e.g. auth errors),
     *           we return an RPC level error.
     *     @type \Google\Ads\GoogleAds\V7\Services\MutateExtensionFeedItemResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           All results for the mutate.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\ExtensionFeedItemService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.MutateExtensionFeedItemResult results = 2;</code>
     * @param \Google\Ads\GoogleAds\V7\Services\MutateExtensionFeedItemResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\MutateExtensionFeedItemResult::class);
        $this->results = $arr;
