 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateCampaignExtensionSettingResult</code>
 */
class MutateCampaignExtensionSettingResult extends \Google\Protobuf\Internal\Message
{
     ...
     * to "MUTABLE_RESOURCE".
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.CampaignExtensionSetting campaign_extension_setting = 2;</code>
     */
     ...
     *           Returned for successful operations.
     *     @type \Google\Ads\GoogleAds\V7\Resources\CampaignExtensionSetting $campaign_extension_setting
     *           The mutated campaign extension setting with only mutable fields after
     *           mutate. The field will only be returned when response_content_type is set
     *           to "MUTABLE_RESOURCE".
     * }
