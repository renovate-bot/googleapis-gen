 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.UrlCollection</code>
 */
class UrlCollection extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Common\UrlCollection::initOnce();
