 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateMerchantCenterLinkRequest</code>
 */
class MutateMerchantCenterLinkRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.MerchantCenterLinkOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The ID of the customer being modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\MerchantCenterLinkOperation $operation
     *           Required. The operation to perform on the link
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.MerchantCenterLinkOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V7\Services\MerchantCenterLinkOperation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.MerchantCenterLinkOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\MerchantCenterLinkOperation $var
     * @return $this
     */
    public function setOperation($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Services\MerchantCenterLinkOperation::class);
        $this->operation = $var;
