 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GetMobileAppCategoryConstantRequest</code>
 */
class GetMobileAppCategoryConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\MobileAppCategoryConstantService::initOnce();
