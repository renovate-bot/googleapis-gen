 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GenerateReachForecastResponse</code>
 */
class GenerateReachForecastResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.OnTargetAudienceMetrics on_target_audience_metrics = 1;</code>
     */
    protected $on_target_audience_metrics = null;
    /**
     * The generated reach curve for the planned product mix.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.ReachCurve reach_curve = 2;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V7\Services\OnTargetAudienceMetrics $on_target_audience_metrics
     *           Reference on target audiences for this curve.
     *     @type \Google\Ads\GoogleAds\V7\Services\ReachCurve $reach_curve
     *           The generated reach curve for the planned product mix.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.OnTargetAudienceMetrics on_target_audience_metrics = 1;</code>
     * @return \Google\Ads\GoogleAds\V7\Services\OnTargetAudienceMetrics|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.OnTargetAudienceMetrics on_target_audience_metrics = 1;</code>
     * @param \Google\Ads\GoogleAds\V7\Services\OnTargetAudienceMetrics $var
     * @return $this
     */
    public function setOnTargetAudienceMetrics($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Services\OnTargetAudienceMetrics::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.ReachCurve reach_curve = 2;</code>
     * @return \Google\Ads\GoogleAds\V7\Services\ReachCurve|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.ReachCurve reach_curve = 2;</code>
     * @param \Google\Ads\GoogleAds\V7\Services\ReachCurve $var
     * @return $this
     */
    public function setReachCurve($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Services\ReachCurve::class);
