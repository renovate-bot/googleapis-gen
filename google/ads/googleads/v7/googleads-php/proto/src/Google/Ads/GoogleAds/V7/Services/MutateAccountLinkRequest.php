 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateAccountLinkRequest</code>
 */
class MutateAccountLinkRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.AccountLinkOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The ID of the customer being modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\AccountLinkOperation $operation
     *           Required. The operation to perform on the link.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.AccountLinkOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V7\Services\AccountLinkOperation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.AccountLinkOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\AccountLinkOperation $var
     * @return $this
     */
    public function setOperation($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Services\AccountLinkOperation::class);
        $this->operation = $var;
