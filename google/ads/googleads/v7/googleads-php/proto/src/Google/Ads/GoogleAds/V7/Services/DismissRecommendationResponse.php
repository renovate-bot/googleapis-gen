 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.DismissRecommendationResponse</code>
 */
class DismissRecommendationResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.DismissRecommendationResponse.DismissRecommendationResult results = 1;</code>
     */
    private $results;
    /**
     ...
     *
     *     @type \Google\Ads\GoogleAds\V7\Services\DismissRecommendationResponse\DismissRecommendationResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           Results of operations to dismiss recommendations.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\RecommendationService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.DismissRecommendationResponse.DismissRecommendationResult results = 1;</code>
     * @param \Google\Ads\GoogleAds\V7\Services\DismissRecommendationResponse\DismissRecommendationResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\DismissRecommendationResponse\DismissRecommendationResult::class);
        $this->results = $arr;
