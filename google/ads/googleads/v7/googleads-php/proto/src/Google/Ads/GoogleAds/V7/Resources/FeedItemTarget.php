 ...
 * A feed item target.
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.FeedItemTarget</code>
 */
class FeedItemTarget extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.FeedItemTargetTypeEnum.FeedItemTargetType feed_item_target_type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.FeedItemTargetStatusEnum.FeedItemTargetStatus status = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    protected $target;
     ...
     *     @type \Google\Ads\GoogleAds\V7\Common\KeywordInfo $keyword
     ...
     *     @type \Google\Ads\GoogleAds\V7\Common\AdScheduleInfo $ad_schedule
     *           Immutable. The targeted schedule.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Resources\FeedItemTarget::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\FeedItemTargetTypeEnum\FeedItemTargetType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\FeedItemTargetStatusEnum\FeedItemTargetStatus::class);
        $this->status = $var;
     ...
     * Immutable. The targeted keyword.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordInfo keyword = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V7\Common\KeywordInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordInfo keyword = 7 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V7\Common\KeywordInfo $var
     * @return $this
     */
    public function setKeyword($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\KeywordInfo::class);
     ...
     * Immutable. The targeted device.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice device = 9 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\FeedItemTargetDeviceEnum\FeedItemTargetDevice::class);
     ...
     * Immutable. The targeted schedule.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.AdScheduleInfo ad_schedule = 10 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Ads\GoogleAds\V7\Common\AdScheduleInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.AdScheduleInfo ad_schedule = 10 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Ads\GoogleAds\V7\Common\AdScheduleInfo $var
     * @return $this
     */
    public function setAdSchedule($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\AdScheduleInfo::class);
