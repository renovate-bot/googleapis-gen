 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GetDetailPlacementViewRequest</code>
 */
class GetDetailPlacementViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\DetailPlacementViewService::initOnce();
