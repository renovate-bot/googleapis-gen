 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateAdGroupAdsRequest</code>
 */
class MutateAdGroupAdsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.AdGroupAdOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose ads are being modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\AdGroupAdOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual ads.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.AdGroupAdOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\AdGroupAdOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\AdGroupAdOperation::class);
        $this->operations = $arr;
