 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.enums.BrandSafetySuitabilityEnum</code>
 */
class BrandSafetySuitabilityEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Enums\BrandSafetySuitability::initOnce();
