...
namespace Google\Ads\GoogleAds\V7\Services\ApplyRecommendationOperation;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.ApplyRecommendationOperation.ResponsiveSearchAdParameters</code>
 */
class ResponsiveSearchAdParameters extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.Ad ad = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $ad = null;
...
class_alias(ResponsiveSearchAdParameters::class, \Google\Ads\GoogleAds\V7\Services\ApplyRecommendationOperation_ResponsiveSearchAdParameters::class);
