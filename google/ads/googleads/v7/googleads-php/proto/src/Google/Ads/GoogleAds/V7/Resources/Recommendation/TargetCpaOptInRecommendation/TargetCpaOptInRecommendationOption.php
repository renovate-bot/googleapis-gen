...
namespace Google\Ads\GoogleAds\V7\Resources\Recommendation\TargetCpaOptInRecommendation;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption</code>
 */
class TargetCpaOptInRecommendationOption extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal goal = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $goal = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.Recommendation.RecommendationImpact impact = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\TargetCpaOptInRecommendationGoalEnum\TargetCpaOptInRecommendationGoal::class);
        $this->goal = $var;
...
class_alias(TargetCpaOptInRecommendationOption::class, \Google\Ads\GoogleAds\V7\Resources\Recommendation_TargetCpaOptInRecommendation_TargetCpaOptInRecommendationOption::class);
