 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GetHotelPerformanceViewRequest</code>
 */
class GetHotelPerformanceViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\HotelPerformanceViewService::initOnce();
