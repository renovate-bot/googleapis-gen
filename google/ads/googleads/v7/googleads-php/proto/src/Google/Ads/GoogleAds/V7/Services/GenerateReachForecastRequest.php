 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GenerateReachForecastRequest</code>
 */
class GenerateReachForecastRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           The currency code.
     *           Three-character ISO 4217 currency code.
     *     @type \Google\Ads\GoogleAds\V7\Services\CampaignDuration $campaign_duration
     *           Required. Campaign duration.
     ...
     *           This field is deprecated in v4 and will eventually be removed.
     *           Please use cookie_frequency_cap_setting instead.
     *     @type \Google\Ads\GoogleAds\V7\Services\FrequencyCap $cookie_frequency_cap_setting
     *           Desired cookie frequency cap that will be applied to each planned product.
     *           This is equivalent to the frequency cap exposed in Google Ads when creating
     *           a campaign, it represents the maximum number of times an ad can be shown to
     *           the same user during a specified time interval.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\ReachPlanService::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V7\Services\CampaignDuration|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.CampaignDuration campaign_duration = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\CampaignDuration $var
     * @return $this
     */
    public function setCampaignDuration($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Services\CampaignDuration::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.FrequencyCap cookie_frequency_cap_setting = 8;</code>
     * @return \Google\Ads\GoogleAds\V7\Services\FrequencyCap|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.FrequencyCap cookie_frequency_cap_setting = 8;</code>
     * @param \Google\Ads\GoogleAds\V7\Services\FrequencyCap $var
     * @return $this
     */
    public function setCookieFrequencyCapSetting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Services\FrequencyCap::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Services\Targeting::class);
        $this->targeting = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.PlannedProduct planned_products = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\PlannedProduct[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPlannedProducts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\PlannedProduct::class);
