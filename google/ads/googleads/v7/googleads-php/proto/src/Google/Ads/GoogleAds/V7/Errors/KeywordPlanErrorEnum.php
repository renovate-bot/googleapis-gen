 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.errors.KeywordPlanErrorEnum</code>
 */
class KeywordPlanErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Errors\KeywordPlanError::initOnce();
