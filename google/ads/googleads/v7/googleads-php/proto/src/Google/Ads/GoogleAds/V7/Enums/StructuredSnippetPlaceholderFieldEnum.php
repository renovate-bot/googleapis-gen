 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.enums.StructuredSnippetPlaceholderFieldEnum</code>
 */
class StructuredSnippetPlaceholderFieldEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Enums\StructuredSnippetPlaceholderField::initOnce();
