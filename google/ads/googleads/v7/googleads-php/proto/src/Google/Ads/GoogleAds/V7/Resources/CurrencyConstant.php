 ...
 * A currency constant.
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.CurrencyConstant</code>
 */
class CurrencyConstant extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Resources\CurrencyConstant::initOnce();
