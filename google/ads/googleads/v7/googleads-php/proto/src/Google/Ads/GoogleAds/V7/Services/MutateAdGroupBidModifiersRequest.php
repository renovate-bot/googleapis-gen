 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateAdGroupBidModifiersRequest</code>
 */
class MutateAdGroupBidModifiersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.AdGroupBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose ad group bid modifiers are being modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\AdGroupBidModifierOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual ad group bid modifiers.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\AdGroupBidModifierService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.AdGroupBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\AdGroupBidModifierOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\AdGroupBidModifierOperation::class);
        $this->operations = $arr;
