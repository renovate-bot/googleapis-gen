 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateKeywordPlanAdGroupKeywordsRequest</code>
 */
class MutateKeywordPlanAdGroupKeywordsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * keywords.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.KeywordPlanAdGroupKeywordOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose Keyword Plan ad group keywords are being
     *           modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\KeywordPlanAdGroupKeywordOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual Keyword Plan ad group
     *           keywords.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.KeywordPlanAdGroupKeywordOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\KeywordPlanAdGroupKeywordOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\KeywordPlanAdGroupKeywordOperation::class);
        $this->operations = $arr;
