 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.AdGroupAsset</code>
 */
class AdGroupAsset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.AssetFieldTypeEnum.AssetFieldType field_type = 4 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $field_type = 0;
    /**
     * Status of the ad group asset.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.AssetLinkStatusEnum.AssetLinkStatus status = 5;</code>
     */
    protected $status = 0;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Resources\AdGroupAsset::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\AssetLinkStatusEnum\AssetLinkStatus::class);
        $this->status = $var;
