 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.TagSnippet</code>
 */
class TagSnippet extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.TrackingCodeTypeEnum.TrackingCodeType type = 1;</code>
     */
    protected $type = 0;
    /**
     ...
     * installed, e.g. HTML.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat page_format = 2;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Common\TagSnippet::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\TrackingCodeTypeEnum\TrackingCodeType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\TrackingCodePageFormatEnum\TrackingCodePageFormat::class);
