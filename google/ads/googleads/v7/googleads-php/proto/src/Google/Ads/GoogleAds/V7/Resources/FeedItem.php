 ...
 * A feed item.
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.FeedItem</code>
 */
class FeedItem extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.resources.FeedItemAttributeValue attribute_values = 6;</code>
     */
     ...
     * for targeting.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.GeoTargetingRestrictionEnum.GeoTargetingRestriction geo_targeting_restriction = 7;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.common.CustomParameter url_custom_parameters = 8;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.FeedItemStatusEnum.FeedItemStatus status = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     * This field is read-only.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.resources.FeedItemPlaceholderPolicyInfo policy_infos = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           The format is "YYYY-MM-DD HH:MM:SS".
     *           Examples: "2018-03-05 09:15:00" or "2018-02-01 14:34:30"
     *     @type \Google\Ads\GoogleAds\V7\Resources\FeedItemAttributeValue[]|\Google\Protobuf\Internal\RepeatedField $attribute_values
     *           The feed item's attribute values.
     ...
     *           Output only. Status of the feed item.
     *           This field is read-only.
     *     @type \Google\Ads\GoogleAds\V7\Resources\FeedItemPlaceholderPolicyInfo[]|\Google\Protobuf\Internal\RepeatedField $policy_infos
     *           Output only. List of info about a feed item's validation and approval state for active
     *           feed mappings. There will be an entry in the list for each type of feed
     *           mapping associated with the feed, e.g. a feed with a sitelink and a call
     *           feed mapping would cause every feed item associated with that feed to have
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.resources.FeedItemAttributeValue attribute_values = 6;</code>
     * @param \Google\Ads\GoogleAds\V7\Resources\FeedItemAttributeValue[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAttributeValues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Resources\FeedItemAttributeValue::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\GeoTargetingRestrictionEnum\GeoTargetingRestriction::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\FeedItemStatusEnum\FeedItemStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.resources.FeedItemPlaceholderPolicyInfo policy_infos = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V7\Resources\FeedItemPlaceholderPolicyInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPolicyInfos($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Resources\FeedItemPlaceholderPolicyInfo::class);
