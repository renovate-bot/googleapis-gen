 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.MatchingFunction</code>
 */
class MatchingFunction extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.MatchingFunctionOperatorEnum.MatchingFunctionOperator operator = 4;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.common.Operand left_operands = 2;</code>
     */
    private $left_operands;
    /**
     * The operands on the right hand side of the equation.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.common.Operand right_operands = 3;</code>
     */
     ...
     *     @type int $operator
     *           Operator for a function.
     *     @type \Google\Ads\GoogleAds\V7\Common\Operand[]|\Google\Protobuf\Internal\RepeatedField $left_operands
     *           The operands on the left hand side of the equation. This is also the
     *           operand to be used for single operand expressions such as NOT.
     *     @type \Google\Ads\GoogleAds\V7\Common\Operand[]|\Google\Protobuf\Internal\RepeatedField $right_operands
     *           The operands on the right hand side of the equation.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Common\MatchingFunction::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\MatchingFunctionOperatorEnum\MatchingFunctionOperator::class);
        $this->operator = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.common.Operand left_operands = 2;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\Operand[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLeftOperands($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Common\Operand::class);
