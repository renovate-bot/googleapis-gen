 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateAdGroupAdLabelsRequest</code>
 */
class MutateAdGroupAdLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.AdGroupAdLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose ad group ad labels are being modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\AdGroupAdLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on ad group ad labels.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\AdGroupAdLabelService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.AdGroupAdLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\AdGroupAdLabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\AdGroupAdLabelOperation::class);
        $this->operations = $arr;
