 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.CreateOfflineUserDataJobRequest</code>
 */
class CreateOfflineUserDataJobRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.OfflineUserDataJob job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $job = null;
    /**
     ...
     *           Required. The ID of the customer for which to create an offline user data job.
     *     @type \Google\Ads\GoogleAds\V7\Resources\OfflineUserDataJob $job
     *           Required. The offline user data job to be created.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.OfflineUserDataJob job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V7\Resources\OfflineUserDataJob|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.OfflineUserDataJob job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Resources\OfflineUserDataJob $var
     * @return $this
     */
    public function setJob($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Resources\OfflineUserDataJob::class);
        $this->job = $var;
