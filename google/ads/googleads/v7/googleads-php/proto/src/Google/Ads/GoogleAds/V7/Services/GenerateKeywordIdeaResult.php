 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GenerateKeywordIdeaResult</code>
 */
class GenerateKeywordIdeaResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordPlanHistoricalMetrics keyword_idea_metrics = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordAnnotations keyword_annotations = 6;</code>
     */
     ...
     *           keyword, but the canonical form of multiple keywords.
     *           See KeywordPlanKeywordHistoricalMetrics message in KeywordPlanService.
     *     @type \Google\Ads\GoogleAds\V7\Common\KeywordPlanHistoricalMetrics $keyword_idea_metrics
     *           The historical metrics for the keyword.
     *     @type \Google\Ads\GoogleAds\V7\Common\KeywordAnnotations $keyword_annotations
     *           The annotations for the keyword.
     *           The annotation data is only provided if requested.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\KeywordPlanIdeaService::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordPlanHistoricalMetrics keyword_idea_metrics = 3;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\KeywordPlanHistoricalMetrics|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordPlanHistoricalMetrics keyword_idea_metrics = 3;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\KeywordPlanHistoricalMetrics $var
     * @return $this
     */
    public function setKeywordIdeaMetrics($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\KeywordPlanHistoricalMetrics::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordAnnotations keyword_annotations = 6;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\KeywordAnnotations|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.KeywordAnnotations keyword_annotations = 6;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\KeywordAnnotations $var
     * @return $this
     */
    public function setKeywordAnnotations($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\KeywordAnnotations::class);
