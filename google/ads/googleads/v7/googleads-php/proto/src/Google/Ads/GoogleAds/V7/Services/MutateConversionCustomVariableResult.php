 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateConversionCustomVariableResult</code>
 */
class MutateConversionCustomVariableResult extends \Google\Protobuf\Internal\Message
{
     ...
     * to "MUTABLE_RESOURCE".
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.ConversionCustomVariable conversion_custom_variable = 2;</code>
     */
     ...
     *           Returned for successful operations.
     *     @type \Google\Ads\GoogleAds\V7\Resources\ConversionCustomVariable $conversion_custom_variable
     *           The mutated conversion custom variable with only mutable fields after
     *           mutate. The field will only be returned when response_content_type is set
     *           to "MUTABLE_RESOURCE".
     * }
