 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.MutateMediaFilesRequest</code>
 */
class MutateMediaFilesRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.MediaFileOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose media files are being modified.
     *     @type \Google\Ads\GoogleAds\V7\Services\MediaFileOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual media file.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\MediaFileService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.MediaFileOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V7\Services\MediaFileOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\MediaFileOperation::class);
        $this->operations = $arr;
