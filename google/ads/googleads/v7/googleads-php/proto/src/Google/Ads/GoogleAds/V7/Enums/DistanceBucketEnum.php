 ...
 * location extension.
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.enums.DistanceBucketEnum</code>
 */
class DistanceBucketEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Enums\DistanceBucket::initOnce();
