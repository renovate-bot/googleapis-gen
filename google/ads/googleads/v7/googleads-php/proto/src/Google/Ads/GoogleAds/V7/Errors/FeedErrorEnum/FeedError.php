...
namespace Google\Ads\GoogleAds\V7\Errors\FeedErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v7.errors.FeedErrorEnum.FeedError</code>
 */
class FeedError
{
    /**
...
class_alias(FeedError::class, \Google\Ads\GoogleAds\V7\Errors\FeedErrorEnum_FeedError::class);
