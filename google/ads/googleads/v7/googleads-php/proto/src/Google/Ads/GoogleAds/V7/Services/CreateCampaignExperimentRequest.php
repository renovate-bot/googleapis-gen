 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.CreateCampaignExperimentRequest</code>
 */
class CreateCampaignExperimentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.resources.CampaignExperiment campaign_experiment = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The ID of the customer whose campaign experiment is being created.
     *     @type \Google\Ads\GoogleAds\V7\Resources\CampaignExperiment $campaign_experiment
     *           Required. The campaign experiment to be created.
