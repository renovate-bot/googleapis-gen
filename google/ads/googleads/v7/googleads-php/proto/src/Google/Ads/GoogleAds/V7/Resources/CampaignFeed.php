 ...
 * A campaign feed.
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.resources.CampaignFeed</code>
 */
class CampaignFeed extends \Google\Protobuf\Internal\Message
{
     ...
     * campaign. Required.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.enums.PlaceholderTypeEnum.PlaceholderType placeholder_types = 4;</code>
     */
     ...
     * Required.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.MatchingFunction matching_function = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.enums.FeedLinkStatusEnum.FeedLinkStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
     ...
     *           Indicates which placeholder types the feed may populate under the connected
     *           campaign. Required.
     *     @type \Google\Ads\GoogleAds\V7\Common\MatchingFunction $matching_function
     *           Matching function associated with the CampaignFeed.
     *           The matching function is used to filter the set of feed items selected.
     *           Required.
     *     @type int $status
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Resources\CampaignFeed::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V7\Enums\PlaceholderTypeEnum\PlaceholderType::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.MatchingFunction matching_function = 5;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\MatchingFunction|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.MatchingFunction matching_function = 5;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\MatchingFunction $var
     * @return $this
     */
    public function setMatchingFunction($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\MatchingFunction::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V7\Enums\FeedLinkStatusEnum\FeedLinkStatus::class);
        $this->status = $var;
