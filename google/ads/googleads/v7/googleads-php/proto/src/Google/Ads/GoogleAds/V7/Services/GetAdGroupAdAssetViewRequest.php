 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GetAdGroupAdAssetViewRequest</code>
 */
class GetAdGroupAdAssetViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\AdGroupAdAssetViewService::initOnce();
