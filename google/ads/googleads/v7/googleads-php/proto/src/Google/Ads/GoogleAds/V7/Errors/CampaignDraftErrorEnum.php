 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.errors.CampaignDraftErrorEnum</code>
 */
class CampaignDraftErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Errors\CampaignDraftError::initOnce();
