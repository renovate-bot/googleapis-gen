 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.ListPlannableLocationsResponse</code>
 */
class ListPlannableLocationsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v7.services.PlannableLocation plannable_locations = 1;</code>
     * @param \Google\Ads\GoogleAds\V7\Services\PlannableLocation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPlannableLocations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V7\Services\PlannableLocation::class);
