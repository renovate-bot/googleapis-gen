 ...
 * A keyword forecast.
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.KeywordPlanKeywordForecast</code>
 */
class KeywordPlanKeywordForecast extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string keyword_plan_ad_group_keyword = 3;</code>
     */
    protected $keyword_plan_ad_group_keyword = null;
    /**
     * The forecast for the Keyword Plan keyword.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.services.ForecastMetrics keyword_forecast = 2;</code>
     */
     ...
     *           The resource name of the Keyword Plan keyword related to the forecast.
     *           `customers/{customer_id}/keywordPlanAdGroupKeywords/{keyword_plan_ad_group_keyword_id}`
     *     @type \Google\Ads\GoogleAds\V7\Services\ForecastMetrics $keyword_forecast
     *           The forecast for the Keyword Plan keyword.
     * }
     */
