 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.enums.ListingGroupTypeEnum</code>
 */
class ListingGroupTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Enums\ListingGroupType::initOnce();
