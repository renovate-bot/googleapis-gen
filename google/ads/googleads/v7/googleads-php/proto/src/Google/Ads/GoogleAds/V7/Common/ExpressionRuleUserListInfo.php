 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.common.ExpressionRuleUserListInfo</code>
 */
class ExpressionRuleUserListInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.UserListRuleInfo rule = 1;</code>
     */
    protected $rule = null;
     ...
     *
     *     @type \Google\Ads\GoogleAds\V7\Common\UserListRuleInfo $rule
     *           Boolean rule that defines this user list. The rule consists of a list of
     *           rule item groups and each rule item group consists of a list of rule items.
     *           All the rule item groups are ORed or ANDed together for evaluation based on
     *           rule.rule_type.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.UserListRuleInfo rule = 1;</code>
     * @return \Google\Ads\GoogleAds\V7\Common\UserListRuleInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v7.common.UserListRuleInfo rule = 1;</code>
     * @param \Google\Ads\GoogleAds\V7\Common\UserListRuleInfo $var
     * @return $this
     */
    public function setRule($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V7\Common\UserListRuleInfo::class);
        $this->rule = $var;
