 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GetLifeEventRequest</code>
 */
class GetLifeEventRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\LifeEventService::initOnce();
