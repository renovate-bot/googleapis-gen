 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v7.services.GetCombinedAudienceRequest</code>
 */
class GetCombinedAudienceRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V7\Services\CombinedAudienceService::initOnce();
