...
use Google\Ads\GoogleAds\V7\Services\AdGroupCriterionServiceClient;
use Google\Ads\GoogleAds\V7\Resources\AdGroupCriterion;
use Google\Ads\GoogleAds\V7\Services\MutateAdGroupCriteriaResponse;
...
class AdGroupCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupCriterionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AdGroupCriterionService/GetAdGroupCriterion', $actualFuncCall);
    ...
    public function mutateAdGroupCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.AdGroupCriterionService/MutateAdGroupCriteria', $actualFuncCall);
