...
use Google\Ads\GoogleAds\V7\Services\AdGroupCriterionLabelServiceClient;
use Google\Ads\GoogleAds\V7\Resources\AdGroupCriterionLabel;
use Google\Ads\GoogleAds\V7\Services\MutateAdGroupCriterionLabelsResponse;
...
class AdGroupCriterionLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupCriterionLabelTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->adGroupCriterionLabelName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]', '[LABEL_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AdGroupCriterionLabelService/GetAdGroupCriterionLabel', $actualFuncCall);
    ...
    public function mutateAdGroupCriterionLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels', $actualFuncCall);
