...
use Google\Ads\GoogleAds\V7\Services\BiddingStrategySimulationServiceClient;
use Google\Ads\GoogleAds\V7\Resources\BiddingStrategySimulation;
...
class BiddingStrategySimulationServiceClientTest extends GeneratedTest
{
    ...
    public function getBiddingStrategySimulationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.BiddingStrategySimulationService/GetBiddingStrategySimulation', $actualFuncCall);
