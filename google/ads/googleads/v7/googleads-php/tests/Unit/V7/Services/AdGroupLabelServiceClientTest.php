...
use Google\Ads\GoogleAds\V7\Services\AdGroupLabelServiceClient;
use Google\Ads\GoogleAds\V7\Resources\AdGroupLabel;
use Google\Ads\GoogleAds\V7\Services\MutateAdGroupLabelsResponse;
...
class AdGroupLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupLabelTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->adGroupLabelName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[LABEL_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AdGroupLabelService/GetAdGroupLabel', $actualFuncCall);
    ...
    public function mutateAdGroupLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.AdGroupLabelService/MutateAdGroupLabels', $actualFuncCall);
