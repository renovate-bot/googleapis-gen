...
use Google\Ads\GoogleAds\V7\Services\AdGroupCriterionSimulationServiceClient;
...
class AdGroupCriterionSimulationServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupCriterionSimulationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AdGroupCriterionSimulationService/GetAdGroupCriterionSimulation', $actualFuncCall);
