...
use Google\Ads\GoogleAds\V7\Services\BiddingStrategyServiceClient;
...
class BiddingStrategyServiceClientTest extends GeneratedTest
{
    ...
    public function getBiddingStrategyTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.BiddingStrategyService/GetBiddingStrategy', $actualFuncCall);
    ...
    public function mutateBiddingStrategiesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.BiddingStrategyService/MutateBiddingStrategies', $actualFuncCall);
