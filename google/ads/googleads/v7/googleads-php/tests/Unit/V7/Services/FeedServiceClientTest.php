...
use Google\Ads\GoogleAds\V7\Services\FeedServiceClient;
use Google\Ads\GoogleAds\V7\Resources\Feed;
use Google\Ads\GoogleAds\V7\Services\MutateFeedsResponse;
...
class FeedServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.FeedService/GetFeed', $actualFuncCall);
    ...
    public function mutateFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.FeedService/MutateFeeds', $actualFuncCall);
