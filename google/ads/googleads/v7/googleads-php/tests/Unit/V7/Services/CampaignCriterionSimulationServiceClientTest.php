...
use Google\Ads\GoogleAds\V7\Services\CampaignCriterionSimulationServiceClient;
use Google\Ads\GoogleAds\V7\Resources\CampaignCriterionSimulation;
 ...
 * @group gapic
 */
class CampaignCriterionSimulationServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getCampaignCriterionSimulationTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->campaignCriterionSimulationName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[CRITERION_ID]', '[TYPE]', '[MODIFICATION_METHOD]', '[START_DATE]', '[END_DATE]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CampaignCriterionSimulationService/GetCampaignCriterionSimulation', $actualFuncCall);
