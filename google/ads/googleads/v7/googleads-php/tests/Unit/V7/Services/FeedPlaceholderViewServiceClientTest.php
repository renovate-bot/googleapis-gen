...
use Google\Ads\GoogleAds\V7\Services\FeedPlaceholderViewServiceClient;
use Google\Ads\GoogleAds\V7\Resources\FeedPlaceholderView;
...
class FeedPlaceholderViewServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedPlaceholderViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.FeedPlaceholderViewService/GetFeedPlaceholderView', $actualFuncCall);
