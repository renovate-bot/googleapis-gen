...
use Google\Ads\GoogleAds\V7\Services\SearchTermViewServiceClient;
use Google\Ads\GoogleAds\V7\Resources\SearchTermView;
...
class SearchTermViewServiceClientTest extends GeneratedTest
{
    ...
    public function getSearchTermViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.SearchTermViewService/GetSearchTermView', $actualFuncCall);
