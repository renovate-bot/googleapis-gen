...
use Google\Ads\GoogleAds\V7\Services\GenderViewServiceClient;
...
class GenderViewServiceClientTest extends GeneratedTest
{
    ...
    public function getGenderViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.GenderViewService/GetGenderView', $actualFuncCall);
