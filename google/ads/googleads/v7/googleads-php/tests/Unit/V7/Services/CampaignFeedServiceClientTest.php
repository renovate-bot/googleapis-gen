...
use Google\Ads\GoogleAds\V7\Services\CampaignFeedServiceClient;
use Google\Ads\GoogleAds\V7\Resources\CampaignFeed;
use Google\Ads\GoogleAds\V7\Services\MutateCampaignFeedsResponse;
...
class CampaignFeedServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignFeedTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CampaignFeedService/GetCampaignFeed', $actualFuncCall);
    ...
    public function mutateCampaignFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CampaignFeedService/MutateCampaignFeeds', $actualFuncCall);
