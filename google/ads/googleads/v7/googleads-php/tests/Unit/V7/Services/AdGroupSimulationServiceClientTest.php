...
use Google\Ads\GoogleAds\V7\Services\AdGroupSimulationServiceClient;
use Google\Ads\GoogleAds\V7\Resources\AdGroupSimulation;
 ...
 * @group gapic
 */
class AdGroupSimulationServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getAdGroupSimulationTest()
    {
        ...
        $expectedResponse->setAdGroupId($adGroupId);
        $expectedResponse->setStartDate($startDate);
        $expectedResponse->setEndDate($endDate);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->adGroupSimulationName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[TYPE]', '[MODIFICATION_METHOD]', '[START_DATE]', '[END_DATE]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AdGroupSimulationService/GetAdGroupSimulation', $actualFuncCall);
