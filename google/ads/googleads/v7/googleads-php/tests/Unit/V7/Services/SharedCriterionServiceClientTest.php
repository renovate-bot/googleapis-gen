...
use Google\Ads\GoogleAds\V7\Services\SharedCriterionServiceClient;
use Google\Ads\GoogleAds\V7\Resources\SharedCriterion;
use Google\Ads\GoogleAds\V7\Services\MutateSharedCriteriaResponse;
...
class SharedCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getSharedCriterionTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->sharedCriterionName('[CUSTOMER_ID]', '[SHARED_SET_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.SharedCriterionService/GetSharedCriterion', $actualFuncCall);
    ...
    public function mutateSharedCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.SharedCriterionService/MutateSharedCriteria', $actualFuncCall);
