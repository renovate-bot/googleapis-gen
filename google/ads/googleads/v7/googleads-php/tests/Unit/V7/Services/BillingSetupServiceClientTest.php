...
use Google\Ads\GoogleAds\V7\Services\BillingSetupServiceClient;
use Google\Ads\GoogleAds\V7\Resources\BillingSetup;
use Google\Ads\GoogleAds\V7\Services\BillingSetupOperation;

use Google\Ads\GoogleAds\V7\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceClientTest extends GeneratedTest
{
    ...
    public function getBillingSetupTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.BillingSetupService/GetBillingSetup', $actualFuncCall);
    ...
    public function mutateBillingSetupTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.BillingSetupService/MutateBillingSetup', $actualFuncCall);
