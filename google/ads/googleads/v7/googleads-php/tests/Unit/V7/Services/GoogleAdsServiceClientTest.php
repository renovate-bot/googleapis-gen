...
use Google\Ads\GoogleAds\V7\Services\GoogleAdsServiceClient;
use Google\Ads\GoogleAds\V7\Services\MutateGoogleAdsResponse;
use Google\Ads\GoogleAds\V7\Services\SearchGoogleAdsResponse;

use Google\Ads\GoogleAds\V7\Services\SearchGoogleAdsStreamResponse;
...
class GoogleAdsServiceClientTest extends GeneratedTest
{
    ...
    public function mutateTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.GoogleAdsService/Mutate', $actualFuncCall);
    ...
    public function searchTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.GoogleAdsService/Search', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function searchStreamTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.GoogleAdsService/SearchStream', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getQuery();
        $this->assertProtobufEquals($query, $actualValue);
