...
use Google\Ads\GoogleAds\V7\Services\CampaignAudienceViewServiceClient;
use Google\Ads\GoogleAds\V7\Resources\CampaignAudienceView;
 ...
 * @group gapic
 */
class CampaignAudienceViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getCampaignAudienceViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->campaignAudienceViewName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CampaignAudienceViewService/GetCampaignAudienceView', $actualFuncCall);
