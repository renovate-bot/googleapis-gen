...
use Google\Ads\GoogleAds\V7\Services\SharedSetServiceClient;
...
class SharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function getSharedSetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.SharedSetService/GetSharedSet', $actualFuncCall);
    ...
    public function mutateSharedSetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.SharedSetService/MutateSharedSets', $actualFuncCall);
