...
use Google\Ads\GoogleAds\V7\Services\ShoppingPerformanceViewServiceClient;
use Google\Ads\GoogleAds\V7\Resources\ShoppingPerformanceView;
 ...
 * @group gapic
 */
class ShoppingPerformanceViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getShoppingPerformanceViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->shoppingPerformanceViewName('[CUSTOMER_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.ShoppingPerformanceViewService/GetShoppingPerformanceView', $actualFuncCall);
