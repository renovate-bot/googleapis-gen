...
use Google\Ads\GoogleAds\V7\Services\InvoiceServiceClient;
use Google\Ads\GoogleAds\V7\Enums\MonthOfYearEnum\MonthOfYear;
use Google\Ads\GoogleAds\V7\Services\ListInvoicesResponse;
...
class InvoiceServiceClientTest extends GeneratedTest
{
    ...
    public function listInvoicesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.InvoiceService/ListInvoices', $actualFuncCall);
