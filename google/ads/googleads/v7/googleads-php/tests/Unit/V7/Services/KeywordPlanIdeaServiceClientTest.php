...
use Google\Ads\GoogleAds\V7\Services\KeywordPlanIdeaServiceClient;
use Google\Ads\GoogleAds\V7\Services\GenerateKeywordIdeaResponse;
use Google\Ads\GoogleAds\V7\Services\GenerateKeywordIdeaResult;
...
class KeywordPlanIdeaServiceClientTest extends GeneratedTest
{
    ...
    public function generateKeywordIdeasTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.KeywordPlanIdeaService/GenerateKeywordIdeas', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
