...
use Google\Ads\GoogleAds\V7\Services\MutateCampaignsResponse;
...
class CampaignServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CampaignService/GetCampaign', $actualFuncCall);
    ...
    public function mutateCampaignsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CampaignService/MutateCampaigns', $actualFuncCall);
