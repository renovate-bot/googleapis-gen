...
use Google\Ads\GoogleAds\V7\Resources\Recommendation;
use Google\Ads\GoogleAds\V7\Services\ApplyRecommendationResponse;
use Google\Ads\GoogleAds\V7\Services\DismissRecommendationResponse;

use Google\Ads\GoogleAds\V7\Services\RecommendationServiceClient;
...
class RecommendationServiceClientTest extends GeneratedTest
{
    ...
    public function applyRecommendationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.RecommendationService/ApplyRecommendation', $actualFuncCall);
    ...
    public function dismissRecommendationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.RecommendationService/DismissRecommendation', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getOperations();
        $this->assertProtobufEquals($operations, $actualValue);
    ...
    public function getRecommendationTest()
    {
        ...
        $expectedResponse->setDismissed($dismissed);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->recommendationName('[CUSTOMER_ID]', '[RECOMMENDATION_ID]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.RecommendationService/GetRecommendation', $actualFuncCall);
