...
use Google\Ads\GoogleAds\V7\Resources\PaidOrganicSearchTermView;
 ...
 * @group gapic
 */
class PaidOrganicSearchTermViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getPaidOrganicSearchTermViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->paidOrganicSearchTermViewName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[AD_GROUP_ID]', '[BASE64_SEARCH_TERM]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.PaidOrganicSearchTermViewService/GetPaidOrganicSearchTermView', $actualFuncCall);
