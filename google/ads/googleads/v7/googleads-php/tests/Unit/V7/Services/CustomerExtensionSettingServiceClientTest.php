...
use Google\Ads\GoogleAds\V7\Services\CustomerExtensionSettingServiceClient;
use Google\Ads\GoogleAds\V7\Resources\CustomerExtensionSetting;
use Google\Ads\GoogleAds\V7\Services\MutateCustomerExtensionSettingsResponse;
...
class CustomerExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerExtensionSettingTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->customerExtensionSettingName('[CUSTOMER_ID]', '[EXTENSION_TYPE]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CustomerExtensionSettingService/GetCustomerExtensionSetting', $actualFuncCall);
    ...
    public function mutateCustomerExtensionSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CustomerExtensionSettingService/MutateCustomerExtensionSettings', $actualFuncCall);
