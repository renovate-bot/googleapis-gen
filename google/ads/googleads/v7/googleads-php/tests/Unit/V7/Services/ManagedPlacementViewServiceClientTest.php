...
use Google\Ads\GoogleAds\V7\Services\ManagedPlacementViewServiceClient;
use Google\Ads\GoogleAds\V7\Resources\ManagedPlacementView;
...
class ManagedPlacementViewServiceClientTest extends GeneratedTest
{
    ...
    public function getManagedPlacementViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.ManagedPlacementViewService/GetManagedPlacementView', $actualFuncCall);
