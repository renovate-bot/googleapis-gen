...
use Google\Ads\GoogleAds\V7\Services\ConversionAdjustmentUploadServiceClient;
use Google\Ads\GoogleAds\V7\Services\UploadConversionAdjustmentsResponse;
...
class ConversionAdjustmentUploadServiceClientTest extends GeneratedTest
{
    ...
    public function uploadConversionAdjustmentsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.ConversionAdjustmentUploadService/UploadConversionAdjustments', $actualFuncCall);
