...
use Google\Ads\GoogleAds\V7\Services\AgeRangeViewServiceClient;
...
class AgeRangeViewServiceClientTest extends GeneratedTest
{
    ...
    public function getAgeRangeViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AgeRangeViewService/GetAgeRangeView', $actualFuncCall);
