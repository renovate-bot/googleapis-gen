...
use Google\Ads\GoogleAds\V7\Services\HotelGroupViewServiceClient;
use Google\Ads\GoogleAds\V7\Resources\HotelGroupView;
 ...
 * @group gapic
 */
class HotelGroupViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getHotelGroupViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->hotelGroupViewName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.HotelGroupViewService/GetHotelGroupView', $actualFuncCall);
