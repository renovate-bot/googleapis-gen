...
use Google\Ads\GoogleAds\V7\Services\CampaignCriterionServiceClient;
use Google\Ads\GoogleAds\V7\Resources\CampaignCriterion;
use Google\Ads\GoogleAds\V7\Services\MutateCampaignCriteriaResponse;
...
class CampaignCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignCriterionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CampaignCriterionService/GetCampaignCriterion', $actualFuncCall);
    ...
    public function mutateCampaignCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CampaignCriterionService/MutateCampaignCriteria', $actualFuncCall);
