...
use Google\Ads\GoogleAds\V7\Services\HotelPerformanceViewServiceClient;
use Google\Ads\GoogleAds\V7\Resources\HotelPerformanceView;
 ...
 * @group gapic
 */
class HotelPerformanceViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getHotelPerformanceViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->hotelPerformanceViewName('[CUSTOMER_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.HotelPerformanceViewService/GetHotelPerformanceView', $actualFuncCall);
