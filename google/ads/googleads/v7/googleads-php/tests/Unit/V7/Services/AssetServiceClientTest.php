...
use Google\Ads\GoogleAds\V7\Services\AssetServiceClient;
use Google\Ads\GoogleAds\V7\Resources\Asset;
use Google\Ads\GoogleAds\V7\Services\MutateAssetsResponse;
...
class AssetServiceClientTest extends GeneratedTest
{
    ...
    public function getAssetTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->assetName('[CUSTOMER_ID]', '[ASSET_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AssetService/GetAsset', $actualFuncCall);
    ...
    public function mutateAssetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.AssetService/MutateAssets', $actualFuncCall);
