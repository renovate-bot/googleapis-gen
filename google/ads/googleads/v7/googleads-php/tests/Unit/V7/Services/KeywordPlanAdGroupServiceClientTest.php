...
use Google\Ads\GoogleAds\V7\Services\KeywordPlanAdGroupServiceClient;
use Google\Ads\GoogleAds\V7\Resources\KeywordPlanAdGroup;
use Google\Ads\GoogleAds\V7\Services\MutateKeywordPlanAdGroupsResponse;
...
class KeywordPlanAdGroupServiceClientTest extends GeneratedTest
{
    ...
    public function getKeywordPlanAdGroupTest()
    {
        ...
        $keywordPlanCampaign = 'keywordPlanCampaign-1958147696';
        $id = 3355;
        $name = 'name3373707';
        $cpcBidMicros = 909381114;
        $expectedResponse = new KeywordPlanAdGroup();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setKeywordPlanCampaign($keywordPlanCampaign);
        $expectedResponse->setId($id);
        $expectedResponse->setName($name);
        $expectedResponse->setCpcBidMicros($cpcBidMicros);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->keywordPlanAdGroupName('[CUSTOMER_ID]', '[KEYWORD_PLAN_AD_GROUP_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.KeywordPlanAdGroupService/GetKeywordPlanAdGroup', $actualFuncCall);
    ...
    public function mutateKeywordPlanAdGroupsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups', $actualFuncCall);
