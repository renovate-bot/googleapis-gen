...
use Google\Ads\GoogleAds\V7\Services\CampaignSharedSetServiceClient;
use Google\Ads\GoogleAds\V7\Resources\CampaignSharedSet;
use Google\Ads\GoogleAds\V7\Services\MutateCampaignSharedSetsResponse;
...
class CampaignSharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignSharedSetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CampaignSharedSetService/GetCampaignSharedSet', $actualFuncCall);
    ...
    public function mutateCampaignSharedSetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CampaignSharedSetService/MutateCampaignSharedSets', $actualFuncCall);
