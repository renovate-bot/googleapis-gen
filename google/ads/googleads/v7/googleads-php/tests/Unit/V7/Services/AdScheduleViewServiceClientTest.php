...
use Google\Ads\GoogleAds\V7\Services\AdScheduleViewServiceClient;
use Google\Ads\GoogleAds\V7\Resources\AdScheduleView;
 ...
 * @group gapic
 */
class AdScheduleViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getAdScheduleViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->adScheduleViewName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AdScheduleViewService/GetAdScheduleView', $actualFuncCall);
