...
use Google\Ads\GoogleAds\V7\Services\CustomerUserAccessServiceClient;
use Google\Ads\GoogleAds\V7\Resources\CustomerUserAccess;
use Google\Ads\GoogleAds\V7\Services\CustomerUserAccessOperation;

use Google\Ads\GoogleAds\V7\Services\MutateCustomerUserAccessResponse;
...
class CustomerUserAccessServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerUserAccessTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CustomerUserAccessService/GetCustomerUserAccess', $actualFuncCall);
    ...
    public function mutateCustomerUserAccessTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CustomerUserAccessService/MutateCustomerUserAccess', $actualFuncCall);
