...
use Google\Ads\GoogleAds\V7\Services\ListMerchantCenterLinksResponse;
use Google\Ads\GoogleAds\V7\Services\MerchantCenterLinkOperation;

use Google\Ads\GoogleAds\V7\Services\MerchantCenterLinkServiceClient;
use Google\Ads\GoogleAds\V7\Services\MutateMerchantCenterLinkResponse;
...
class MerchantCenterLinkServiceClientTest extends GeneratedTest
{
    ...
    public function getMerchantCenterLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.MerchantCenterLinkService/GetMerchantCenterLink', $actualFuncCall);
    ...
    public function listMerchantCenterLinksTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.MerchantCenterLinkService/ListMerchantCenterLinks', $actualFuncCall);
    ...
    public function mutateMerchantCenterLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.MerchantCenterLinkService/MutateMerchantCenterLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
