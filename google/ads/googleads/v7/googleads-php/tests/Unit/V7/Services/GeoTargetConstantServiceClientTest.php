...
use Google\Ads\GoogleAds\V7\Services\GeoTargetConstantServiceClient;
use Google\Ads\GoogleAds\V7\Resources\GeoTargetConstant;
use Google\Ads\GoogleAds\V7\Services\SuggestGeoTargetConstantsResponse;
...
class GeoTargetConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getGeoTargetConstantTest()
    {
        ...
        $parentGeoTarget = 'parentGeoTarget1553158388';
        ...
        $expectedResponse->setParentGeoTarget($parentGeoTarget);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->geoTargetConstantName('[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.GeoTargetConstantService/GetGeoTargetConstant', $actualFuncCall);
    ...
    public function suggestGeoTargetConstantsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.GeoTargetConstantService/SuggestGeoTargetConstants', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
