...
use Google\Ads\GoogleAds\V7\Resources\AccountLink;
use Google\Ads\GoogleAds\V7\Services\AccountLinkOperation;

use Google\Ads\GoogleAds\V7\Services\CreateAccountLinkResponse;
use Google\Ads\GoogleAds\V7\Services\MutateAccountLinkResponse;
...
class AccountLinkServiceClientTest extends GeneratedTest
{
    ...
    public function createAccountLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AccountLinkService/CreateAccountLink', $actualFuncCall);
    ...
    public function getAccountLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.AccountLinkService/GetAccountLink', $actualFuncCall);
    ...
    public function mutateAccountLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.AccountLinkService/MutateAccountLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
