...
use Google\Ads\GoogleAds\V7\Resources\AccountBudget;
...
class AccountBudgetServiceClientTest extends GeneratedTest
{
    ...
    public function getAccountBudgetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.AccountBudgetService/GetAccountBudget', $actualFuncCall);
