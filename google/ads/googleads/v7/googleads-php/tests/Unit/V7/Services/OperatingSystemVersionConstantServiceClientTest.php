...
use Google\Ads\GoogleAds\V7\Resources\OperatingSystemVersionConstant;
...
class OperatingSystemVersionConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getOperatingSystemVersionConstantTest()
    {
        ...
        $id = 3355;
        $name = 'name3373707';
        $osMajorVersion = 1346408137;
        $osMinorVersion = 1088382771;
        $expectedResponse = new OperatingSystemVersionConstant();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setId($id);
        $expectedResponse->setName($name);
        $expectedResponse->setOsMajorVersion($osMajorVersion);
        $expectedResponse->setOsMinorVersion($osMinorVersion);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->operatingSystemVersionConstantName('[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.OperatingSystemVersionConstantService/GetOperatingSystemVersionConstant', $actualFuncCall);
