...
use Google\Ads\GoogleAds\V7\Services\LocationViewServiceClient;
use Google\Ads\GoogleAds\V7\Resources\LocationView;
 ...
 * @group gapic
 */
class LocationViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getLocationViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->locationViewName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.LocationViewService/GetLocationView', $actualFuncCall);
