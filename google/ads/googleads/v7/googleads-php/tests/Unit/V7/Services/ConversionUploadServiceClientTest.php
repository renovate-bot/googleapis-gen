...
use Google\Ads\GoogleAds\V7\Services\ConversionUploadServiceClient;
use Google\Ads\GoogleAds\V7\Services\UploadCallConversionsResponse;
...
class ConversionUploadServiceClientTest extends GeneratedTest
{
    ...
    public function uploadCallConversionsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.ConversionUploadService/UploadCallConversions', $actualFuncCall);
    ...
    public function uploadClickConversionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.ConversionUploadService/UploadClickConversions', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getConversions();
        $this->assertProtobufEquals($conversions, $actualValue);
