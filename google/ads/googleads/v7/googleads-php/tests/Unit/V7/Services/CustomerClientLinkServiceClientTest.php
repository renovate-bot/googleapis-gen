...
use Google\Ads\GoogleAds\V7\Services\CustomerClientLinkOperation;

use Google\Ads\GoogleAds\V7\Services\MutateCustomerClientLinkResponse;
...
class CustomerClientLinkServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerClientLinkTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->customerClientLinkName('[CUSTOMER_ID]', '[CLIENT_CUSTOMER_ID]', '[MANAGER_LINK_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CustomerClientLinkService/GetCustomerClientLink', $actualFuncCall);
    ...
    public function mutateCustomerClientLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CustomerClientLinkService/MutateCustomerClientLink', $actualFuncCall);
