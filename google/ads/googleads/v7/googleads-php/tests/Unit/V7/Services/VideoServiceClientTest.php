...
use Google\Ads\GoogleAds\V7\Resources\Video;
...
class VideoServiceClientTest extends GeneratedTest
{
    ...
    public function getVideoTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.VideoService/GetVideo', $actualFuncCall);
