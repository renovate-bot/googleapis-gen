...
use Google\Ads\GoogleAds\V7\Services\CampaignExperimentServiceClient;
use Google\Ads\GoogleAds\V7\Services\GraduateCampaignExperimentResponse;
use Google\Ads\GoogleAds\V7\Services\ListCampaignExperimentAsyncErrorsResponse;

use Google\Ads\GoogleAds\V7\Services\MutateCampaignExperimentsResponse;
...
class CampaignExperimentServiceClientTest extends GeneratedTest
{
    ...
    public function createCampaignExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CampaignExperimentService/CreateCampaignExperiment', $actualApiFuncCall);
    ...
    public function endCampaignExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v7.services.CampaignExperimentService/EndCampaignExperiment', $actualFuncCall);
    ...
    public function getCampaignExperimentTest()
    {
        ...
        $trafficSplitPercent = 1828954462;
        $experimentCampaign = 'experimentCampaign2023719698';
        ...
        $expectedResponse->setCampaignDraft($campaignDraft);
        $expectedResponse->setName($name);
        $expectedResponse->setDescription($description);
        $expectedResponse->setTrafficSplitPercent($trafficSplitPercent);
        $expectedResponse->setExperimentCampaign($experimentCampaign);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CampaignExperimentService/GetCampaignExperiment', $actualFuncCall);
    ...
    public function graduateCampaignExperimentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CampaignExperimentService/GraduateCampaignExperiment', $actualFuncCall);
        $actualValue = $actualRequestObject->getCampaignExperiment();
        $this->assertProtobufEquals($campaignExperiment, $actualValue);
    ...
    public function listCampaignExperimentAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CampaignExperimentService/ListCampaignExperimentAsyncErrors', $actualFuncCall);
        $actualValue = $actualRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateCampaignExperimentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CampaignExperimentService/MutateCampaignExperiments', $actualFuncCall);
    ...
    public function promoteCampaignExperimentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v7.services.CampaignExperimentService/PromoteCampaignExperiment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getCampaignExperiment();
        $this->assertProtobufEquals($campaignExperiment, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
