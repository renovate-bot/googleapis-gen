...
use Google\Ads\GoogleAds\V7\Services\GetGoogleAdsFieldRequest;
use Google\Ads\GoogleAds\V7\Services\SearchGoogleAdsFieldsRequest;
...
class GoogleAdsFieldServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.GoogleAdsFieldService';
