 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v7/services/keyword_plan_idea_service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V7\Services\Gapic;

use Google\Ads\GoogleAds\V7\Common\HistoricalMetricsOptions;
use Google\Ads\GoogleAds\V7\Common\KeywordPlanAggregateMetrics;

use Google\Ads\GoogleAds\V7\Services\GenerateKeywordIdeaResponse;

use Google\Ads\GoogleAds\V7\Services\GenerateKeywordIdeasRequest;
use Google\Ads\GoogleAds\V7\Services\KeywordAndUrlSeed;
use Google\Ads\GoogleAds\V7\Services\KeywordSeed;
use Google\Ads\GoogleAds\V7\Services\SiteSeed;
use Google\Ads\GoogleAds\V7\Services\UrlSeed;
...
class KeywordPlanIdeaServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.KeywordPlanIdeaService';
     ...
     *           Targeting network.
     *           For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V7\Enums\KeywordPlanNetworkEnum\KeywordPlanNetwork}
     *     @type int[] $keywordAnnotation
     *           The keyword annotations to include in response.
     *           For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V7\Enums\KeywordPlanKeywordAnnotationEnum\KeywordPlanKeywordAnnotation}
