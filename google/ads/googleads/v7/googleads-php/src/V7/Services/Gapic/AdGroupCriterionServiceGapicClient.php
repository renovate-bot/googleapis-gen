...
use Google\Ads\GoogleAds\V7\Services\AdGroupCriterionOperation;
use Google\Ads\GoogleAds\V7\Services\GetAdGroupCriterionRequest;

use Google\Ads\GoogleAds\V7\Services\MutateAdGroupCriteriaRequest;
...
class AdGroupCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.AdGroupCriterionService';
