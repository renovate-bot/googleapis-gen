 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v7/services/customer_extension_setting_service.proto
...
use Google\Ads\GoogleAds\V7\Services\CustomerExtensionSettingOperation;
use Google\Ads\GoogleAds\V7\Services\GetCustomerExtensionSettingRequest;

use Google\Ads\GoogleAds\V7\Services\MutateCustomerExtensionSettingsRequest;
 ...
 * try {
 *     $formattedResourceName = $customerExtensionSettingServiceClient->customerExtensionSettingName('[CUSTOMER_ID]', '[EXTENSION_TYPE]');
...
class CustomerExtensionSettingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.CustomerExtensionSettingService';
    ...
    public function getCustomerExtensionSetting($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetCustomerExtensionSetting', CustomerExtensionSetting::class, $optionalArgs, $request)->wait();
    }
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V7\Services\MutateCustomerExtensionSettingsResponse
     *
     * @throws ApiException if the remote call fails
     */
    public function mutateCustomerExtensionSettings($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateCustomerExtensionSettings', MutateCustomerExtensionSettingsResponse::class, $optionalArgs, $request)->wait();
    }
}
