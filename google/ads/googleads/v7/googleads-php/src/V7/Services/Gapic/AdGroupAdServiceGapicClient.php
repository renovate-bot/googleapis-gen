...
use Google\Ads\GoogleAds\V7\Services\GetAdGroupAdRequest;

use Google\Ads\GoogleAds\V7\Services\MutateAdGroupAdsRequest;
use Google\Ads\GoogleAds\V7\Services\MutateAdGroupAdsResponse;
...
class AdGroupAdServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.AdGroupAdService';
