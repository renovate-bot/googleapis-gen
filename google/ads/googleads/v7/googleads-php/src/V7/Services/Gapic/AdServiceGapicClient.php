...
use Google\Ads\GoogleAds\V7\Services\AdOperation;
use Google\Ads\GoogleAds\V7\Services\GetAdRequest;

use Google\Ads\GoogleAds\V7\Services\MutateAdsRequest;
use Google\Ads\GoogleAds\V7\Services\MutateAdsResponse;
 ...
 * try {
 *     $formattedResourceName = $adServiceClient->adName('[CUSTOMER_ID]', '[AD_ID]');
...
class AdServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.AdService';
