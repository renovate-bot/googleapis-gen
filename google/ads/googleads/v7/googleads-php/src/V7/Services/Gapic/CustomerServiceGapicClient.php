 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v7/services/customer_service.proto
...
use Google\Ads\GoogleAds\V7\Services\CreateCustomerClientRequest;
use Google\Ads\GoogleAds\V7\Services\CreateCustomerClientResponse;

use Google\Ads\GoogleAds\V7\Services\CustomerOperation;
use Google\Ads\GoogleAds\V7\Services\GetCustomerRequest;
use Google\Ads\GoogleAds\V7\Services\ListAccessibleCustomersRequest;
use Google\Ads\GoogleAds\V7\Services\ListAccessibleCustomersResponse;
use Google\Ads\GoogleAds\V7\Services\MutateCustomerRequest;
use Google\Ads\GoogleAds\V7\Services\MutateCustomerResponse;
...
class CustomerServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.CustomerService';
     ...
     *           For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V7\Enums\AccessRoleEnum\AccessRole}
