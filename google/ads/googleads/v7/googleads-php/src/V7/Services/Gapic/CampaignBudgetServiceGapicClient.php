 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v7/services/campaign_budget_service.proto
...
use Google\Ads\GoogleAds\V7\Services\CampaignBudgetOperation;
use Google\Ads\GoogleAds\V7\Services\GetCampaignBudgetRequest;

use Google\Ads\GoogleAds\V7\Services\MutateCampaignBudgetsRequest;
use Google\Ads\GoogleAds\V7\Services\MutateCampaignBudgetsResponse;
...
class CampaignBudgetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.CampaignBudgetService';
