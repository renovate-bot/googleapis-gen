 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v7/services/ad_group_feed_service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V7\Services\Gapic;

use Google\Ads\GoogleAds\V7\Resources\AdGroupFeed;
use Google\Ads\GoogleAds\V7\Services\AdGroupFeedOperation;
use Google\Ads\GoogleAds\V7\Services\GetAdGroupFeedRequest;

use Google\Ads\GoogleAds\V7\Services\MutateAdGroupFeedsRequest;
use Google\Ads\GoogleAds\V7\Services\MutateAdGroupFeedsResponse;
 ...
 * try {
 *     $formattedResourceName = $adGroupFeedServiceClient->adGroupFeedName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[FEED_ID]');
...
class AdGroupFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.AdGroupFeedService';
