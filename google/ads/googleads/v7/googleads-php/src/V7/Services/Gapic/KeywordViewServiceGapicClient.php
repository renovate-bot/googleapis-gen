...
use Google\Ads\GoogleAds\V7\Resources\KeywordView;
use Google\Ads\GoogleAds\V7\Services\GetKeywordViewRequest;
...
class KeywordViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.KeywordViewService';
