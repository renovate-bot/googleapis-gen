 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v7/services/bidding_strategy_service.proto
...
use Google\Ads\GoogleAds\V7\Services\BiddingStrategyOperation;
use Google\Ads\GoogleAds\V7\Services\GetBiddingStrategyRequest;

use Google\Ads\GoogleAds\V7\Services\MutateBiddingStrategiesRequest;
use Google\Ads\GoogleAds\V7\Services\MutateBiddingStrategiesResponse;
 ...
 * try {
 *     $formattedResourceName = $biddingStrategyServiceClient->biddingStrategyName('[CUSTOMER_ID]', '[BIDDING_STRATEGY_ID]');
...
class BiddingStrategyServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.BiddingStrategyService';
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V7\Services\MutateBiddingStrategiesResponse
     *
     * @throws ApiException if the remote call fails
     */
