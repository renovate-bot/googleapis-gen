...
use Google\Ads\GoogleAds\V7\Services\CampaignFeedOperation;
use Google\Ads\GoogleAds\V7\Services\GetCampaignFeedRequest;

use Google\Ads\GoogleAds\V7\Services\MutateCampaignFeedsRequest;
...
class CampaignFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.CampaignFeedService';
