 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v7/services/landing_page_view_service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V7\Services\Gapic;

use Google\Ads\GoogleAds\V7\Resources\LandingPageView;
use Google\Ads\GoogleAds\V7\Services\GetLandingPageViewRequest;
 ...
 * try {
 *     $formattedResourceName = $landingPageViewServiceClient->landingPageViewName('[CUSTOMER_ID]', '[UNEXPANDED_FINAL_URL_FINGERPRINT]');
...
class LandingPageViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.LandingPageViewService';
    ...
    private static function getLandingPageViewNameTemplate()
    {
        if (self::$landingPageViewNameTemplate == null) {
            self::$landingPageViewNameTemplate = new PathTemplate('customers/{customer_id}/landingPageViews/{unexpanded_final_url_fingerprint}');
        }
     ...
     */
    public static function landingPageViewName($customerId, $unexpandedFinalUrlFingerprint)
    {
     ...
     * Template: Pattern
     * - landingPageView: customers/{customer_id}/landingPageViews/{unexpanded_final_url_fingerprint}
     *
