 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v7/services/campaign_service.proto
...
use Google\Ads\GoogleAds\V7\Services\CampaignOperation;
use Google\Ads\GoogleAds\V7\Services\GetCampaignRequest;

use Google\Ads\GoogleAds\V7\Services\MutateCampaignsRequest;
 ...
 * try {
 *     $formattedResourceName = $campaignServiceClient->campaignName('[CUSTOMER_ID]', '[CAMPAIGN_ID]');
 *     $response = $campaignServiceClient->getCampaign($formattedResourceName);
 * } finally {
...
class CampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.CampaignService';
     ...
     * ```
     *
     * @param string $resourceName Required. The resource name of the campaign to fetch.
     ...
     */
    public function getCampaign($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetCampaign', Campaign::class, $optionalArgs, $request)->wait();
    }
