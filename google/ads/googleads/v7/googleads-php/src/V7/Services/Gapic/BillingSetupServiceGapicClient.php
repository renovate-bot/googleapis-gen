...
use Google\Ads\GoogleAds\V7\Services\GetBillingSetupRequest;

use Google\Ads\GoogleAds\V7\Services\MutateBillingSetupRequest;
...
class BillingSetupServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v7.services.BillingSetupService';
