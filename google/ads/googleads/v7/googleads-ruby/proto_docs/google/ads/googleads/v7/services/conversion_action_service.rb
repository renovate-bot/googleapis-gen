...
module Google
  module Ads
    module GoogleAds
      module V7
        module Services
          # Request message for {::Google::Ads::GoogleAds::V7::Services::ConversionActionService::Client#get_conversion_action ConversionActionService.GetConversionAction}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V7::Services::ConversionActionService::Client#mutate_conversion_actions ConversionActionService.MutateConversionActions}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose conversion actions are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::ConversionActionOperation>]
          ...
          # Response message for {::Google::Ads::GoogleAds::V7::Services::ConversionActionService::Client#mutate_conversion_actions ConversionActionService.MutateConversionActions}.
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::MutateConversionActionResult>]
