    ...
    module GoogleAds
      module V7
        module Services
          ...
          # Response message for {::Google::Ads::GoogleAds::V7::Services::InvoiceService::Client#list_invoices InvoiceService.ListInvoices}.
          # @!attribute [rw] invoices
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Resources::Invoice>]
