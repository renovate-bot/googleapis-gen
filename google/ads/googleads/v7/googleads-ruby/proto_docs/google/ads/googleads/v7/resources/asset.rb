    ...
    module GoogleAds
      module V7
        module Resources
          ...
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V7::Enums::AssetTypeEnum::AssetType]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Resources::AssetPolicySummary]
          #     Output only. Policy information for the asset.
          # @!attribute [rw] youtube_video_asset
          #   @return [::Google::Ads::GoogleAds::V7::Common::YoutubeVideoAsset]
          #     Immutable. A YouTube video asset.
          # @!attribute [rw] media_bundle_asset
          #   @return [::Google::Ads::GoogleAds::V7::Common::MediaBundleAsset]
          #     Immutable. A media bundle asset.
          # @!attribute [r] image_asset
          #   @return [::Google::Ads::GoogleAds::V7::Common::ImageAsset]
          #     Output only. An image asset.
          # @!attribute [r] text_asset
          #   @return [::Google::Ads::GoogleAds::V7::Common::TextAsset]
          #     Output only. A text asset.
          # @!attribute [rw] lead_form_asset
          #   @return [::Google::Ads::GoogleAds::V7::Common::LeadFormAsset]
          #     A lead form asset.
          # @!attribute [rw] book_on_google_asset
          #   @return [::Google::Ads::GoogleAds::V7::Common::BookOnGoogleAsset]
          #     A book on google asset.
          # @!attribute [rw] promotion_asset
          #   @return [::Google::Ads::GoogleAds::V7::Common::PromotionAsset]
          #     A promotion asset.
          # @!attribute [rw] callout_asset
          #   @return [::Google::Ads::GoogleAds::V7::Common::CalloutAsset]
          #     A callout asset.
          # @!attribute [rw] structured_snippet_asset
          #   @return [::Google::Ads::GoogleAds::V7::Common::StructuredSnippetAsset]
          #     A structured snippet asset.
          # @!attribute [rw] sitelink_asset
          #   @return [::Google::Ads::GoogleAds::V7::Common::SitelinkAsset]
          #     A sitelink asset.
          class Asset
