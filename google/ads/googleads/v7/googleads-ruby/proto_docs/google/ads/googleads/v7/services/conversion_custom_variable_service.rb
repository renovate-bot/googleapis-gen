  ...
  module Ads
    module GoogleAds
      module V7
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V7::Services::ConversionCustomVariableService::Client#get_conversion_custom_variable ConversionCustomVariableService.GetConversionCustomVariable}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V7::Services::ConversionCustomVariableService::Client#mutate_conversion_custom_variables ConversionCustomVariableService.MutateConversionCustomVariables}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose conversion custom variables are being
          #     modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::ConversionCustomVariableOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::MutateConversionCustomVariableResult>]
