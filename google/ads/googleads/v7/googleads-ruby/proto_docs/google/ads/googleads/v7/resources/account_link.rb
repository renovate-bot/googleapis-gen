    ...
    module GoogleAds
      module V7
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V7::Enums::AccountLinkStatusEnum::AccountLinkStatus]
          #     The status of the link.
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V7::Enums::LinkedAccountTypeEnum::LinkedAccountType]
          #     Output only. The type of the linked account.
          # @!attribute [rw] third_party_app_analytics
          #   @return [::Google::Ads::GoogleAds::V7::Resources::ThirdPartyAppAnalyticsLinkIdentifier]
          #     Immutable. A third party app analytics link.
          # @!attribute [r] data_partner
          #   @return [::Google::Ads::GoogleAds::V7::Resources::DataPartnerLinkIdentifier]
          #     Output only. Data partner link.
          # @!attribute [r] google_ads
          #   @return [::Google::Ads::GoogleAds::V7::Resources::GoogleAdsLinkIdentifier]
