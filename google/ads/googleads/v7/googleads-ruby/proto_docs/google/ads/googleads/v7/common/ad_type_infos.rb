    ...
    module GoogleAds
      module V7
        module Common
          ...
          # A Gmail ad.
          # @!attribute [rw] teaser
          #   @return [::Google::Ads::GoogleAds::V7::Common::GmailTeaser]
          #     The Gmail teaser.
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Common::DisplayCallToAction]
          #     Display-call-to-action of the marketing image.
          # @!attribute [rw] product_images
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Common::ProductImage>]
          #     Product images. Up to 15 images are supported.
          # @!attribute [rw] product_videos
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Common::ProductVideo>]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Enums::MimeTypeEnum::MimeType]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Common::VideoTrueViewInStreamAdInfo]
          #     Video TrueView in-stream ad format.
          # @!attribute [rw] bumper
          #   @return [::Google::Ads::GoogleAds::V7::Common::VideoBumperInStreamAdInfo]
          #     Video bumper in-stream ad format.
          # @!attribute [rw] out_stream
          #   @return [::Google::Ads::GoogleAds::V7::Common::VideoOutstreamAdInfo]
          #     Video out-stream ad format.
          # @!attribute [rw] non_skippable
          #   @return [::Google::Ads::GoogleAds::V7::Common::VideoNonSkippableInStreamAdInfo]
          #     Video non-skippable in-stream ad format.
          # @!attribute [rw] discovery
          #   @return [::Google::Ads::GoogleAds::V7::Common::VideoTrueViewDiscoveryAdInfo]
          ...
          # @!attribute [rw] videos
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Common::AdVideoAsset>]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Common::AdTextAsset]
          #     Mandatory ad text.
          # @!attribute [rw] headlines
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Common::AdTextAsset>]
          #     List of text assets for headlines. When the ad serves the headlines will
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Common::AdMediaBundleAsset>]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Common::ResponsiveDisplayAdControlSpec]
