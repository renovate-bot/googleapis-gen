    ...
    module GoogleAds
      module V7
        module Common
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V7::Enums::TrackingCodeTypeEnum::TrackingCodeType]
          #     The type of the generated tag snippets for tracking conversions.
          # @!attribute [rw] page_format
          #   @return [::Google::Ads::GoogleAds::V7::Enums::TrackingCodePageFormatEnum::TrackingCodePageFormat]
