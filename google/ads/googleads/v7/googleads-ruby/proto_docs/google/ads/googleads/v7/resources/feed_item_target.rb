    ...
    module GoogleAds
      module V7
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Enums::FeedItemTargetTypeEnum::FeedItemTargetType]
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V7::Enums::FeedItemTargetStatusEnum::FeedItemTargetStatus]
