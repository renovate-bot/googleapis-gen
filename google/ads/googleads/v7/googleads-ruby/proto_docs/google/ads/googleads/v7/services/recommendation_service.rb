...
module Google
  module Ads
    module GoogleAds
      module V7
        module Services
          # Request message for {::Google::Ads::GoogleAds::V7::Services::RecommendationService::Client#get_recommendation RecommendationService.GetRecommendation}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V7::Services::RecommendationService::Client#apply_recommendation RecommendationService.ApplyRecommendation}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer with the recommendation.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation>]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation::CampaignBudgetParameters]
          #     Optional parameters to use when applying a campaign budget
          #     recommendation.
          # @!attribute [rw] text_ad
          #   @return [::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation::TextAdParameters]
          #     Optional parameters to use when applying a text ad recommendation.
          # @!attribute [rw] keyword
          #   @return [::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation::KeywordParameters]
          #     Optional parameters to use when applying keyword recommendation.
          # @!attribute [rw] target_cpa_opt_in
          #   @return [::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation::TargetCpaOptInParameters]
          #     Optional parameters to use when applying target CPA opt-in
          #     recommendation.
          # @!attribute [rw] target_roas_opt_in
          #   @return [::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation::TargetRoasOptInParameters]
          #     Optional parameters to use when applying target ROAS opt-in
          #     recommendation.
          # @!attribute [rw] callout_extension
          #   @return [::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation::CalloutExtensionParameters]
          #     Parameters to use when applying callout extension recommendation.
          # @!attribute [rw] call_extension
          #   @return [::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation::CallExtensionParameters]
          #     Parameters to use when applying call extension recommendation.
          # @!attribute [rw] sitelink_extension
          #   @return [::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation::SitelinkExtensionParameters]
          #     Parameters to use when applying sitelink extension recommendation.
          # @!attribute [rw] move_unused_budget
          #   @return [::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation::MoveUnusedBudgetParameters]
          #     Parameters to use when applying move unused budget recommendation.
          # @!attribute [rw] responsive_search_ad
          #   @return [::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationOperation::ResponsiveSearchAdParameters]
          ...
          class ApplyRecommendationOperation
            ...
            #   @return [::Integer]
            #     Optional, budget amount to set for the campaign.
            class TargetRoasOptInParameters
              include ::Google::Protobuf::MessageExts
              extend ::Google::Protobuf::MessageExts::ClassMethods
            end
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V7::Common::CalloutFeedItem>]
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V7::Common::CallFeedItem>]
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V7::Common::SitelinkFeedItem>]
          ...
          # Response message for {::Google::Ads::GoogleAds::V7::Services::RecommendationService::Client#apply_recommendation RecommendationService.ApplyRecommendation}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::ApplyRecommendationResult>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V7::Services::RecommendationService::Client#dismiss_recommendation RecommendationService.DismissRecommendation}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer with the recommendation.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::DismissRecommendationRequest::DismissRecommendationOperation>]
          ...
          # Response message for {::Google::Ads::GoogleAds::V7::Services::RecommendationService::Client#dismiss_recommendation RecommendationService.DismissRecommendation}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::DismissRecommendationResponse::DismissRecommendationResult>]
