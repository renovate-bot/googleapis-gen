  ...
  module Ads
    module GoogleAds
      module V7
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V7::Services::BillingSetupService::Client#get_billing_setup BillingSetupService.GetBillingSetup}.
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Services::BillingSetupOperation]
          ...
          # @!attribute [rw] result
          #   @return [::Google::Ads::GoogleAds::V7::Services::MutateBillingSetupResult]
