    ...
    module GoogleAds
      module V7
        module Common
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Common::CriterionCategoryChannelAvailability]
          #     Channel types and subtypes that are available to the category.
          # @!attribute [rw] locale
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Common::CriterionCategoryLocaleAvailability>]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Enums::CriterionCategoryChannelAvailabilityModeEnum::CriterionCategoryChannelAvailabilityMode]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType>]
          ...
          # @!attribute [rw] availability_mode
          #   @return [::Google::Ads::GoogleAds::V7::Enums::CriterionCategoryLocaleAvailabilityModeEnum::CriterionCategoryLocaleAvailabilityMode]
