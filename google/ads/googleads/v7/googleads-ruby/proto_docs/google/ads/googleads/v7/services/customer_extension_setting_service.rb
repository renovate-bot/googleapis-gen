  ...
  module Ads
    module GoogleAds
      module V7
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V7::Services::CustomerExtensionSettingService::Client#get_customer_extension_setting CustomerExtensionSettingService.GetCustomerExtensionSetting}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V7::Services::CustomerExtensionSettingService::Client#mutate_customer_extension_settings CustomerExtensionSettingService.MutateCustomerExtensionSettings}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose customer extension settings are being
          #     modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::CustomerExtensionSettingOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::MutateCustomerExtensionSettingResult>]
