...
module Google
  module Ads
    module GoogleAds
      module V7
        module Services
          # Request message for {::Google::Ads::GoogleAds::V7::Services::UserListService::Client#get_user_list UserListService.GetUserList}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V7::Services::UserListService::Client#mutate_user_lists UserListService.MutateUserLists}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose user lists are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::UserListOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::MutateUserListResult>]
