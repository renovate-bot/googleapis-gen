    ...
    module GoogleAds
      module V7
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Common::PreferredContentInfo]
          #     Immutable. A preferred content criterion.
          # @!attribute [rw] hotel_check_in_date_range
          #   @return [::Google::Ads::GoogleAds::V7::Common::HotelCheckInDateRangeInfo]
