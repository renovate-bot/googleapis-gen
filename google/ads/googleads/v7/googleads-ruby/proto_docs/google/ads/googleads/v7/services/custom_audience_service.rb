...
module Google
  module Ads
    module GoogleAds
      module V7
        module Services
          # Request message for {::Google::Ads::GoogleAds::V7::Services::CustomAudienceService::Client#get_custom_audience CustomAudienceService.GetCustomAudience}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V7::Services::CustomAudienceService::Client#mutate_custom_audiences CustomAudienceService.MutateCustomAudiences}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose custom audiences are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::CustomAudienceOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::MutateCustomAudienceResult>]
