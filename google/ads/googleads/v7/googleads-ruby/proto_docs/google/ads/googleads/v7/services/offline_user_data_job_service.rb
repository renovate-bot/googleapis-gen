  ...
  module Ads
    module GoogleAds
      module V7
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V7::Services::OfflineUserDataJobService::Client#create_offline_user_data_job OfflineUserDataJobService.CreateOfflineUserDataJob}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V7::Services::OfflineUserDataJobService::Client#get_offline_user_data_job OfflineUserDataJobService.GetOfflineUserDataJob}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          ...
          # Request message for {::Google::Ads::GoogleAds::V7::Services::OfflineUserDataJobService::Client#run_offline_user_data_job OfflineUserDataJobService.RunOfflineUserDataJob}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V7::Services::OfflineUserDataJobService::Client#add_offline_user_data_job_operations OfflineUserDataJobService.AddOfflineUserDataJobOperations}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::OfflineUserDataJobOperation>]
