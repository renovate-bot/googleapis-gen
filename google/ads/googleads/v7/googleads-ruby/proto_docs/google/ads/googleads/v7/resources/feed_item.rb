    ...
    module GoogleAds
      module V7
        module Resources
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Resources::FeedItemAttributeValue>]
          #     The feed item's attribute values.
          # @!attribute [rw] geo_targeting_restriction
          #   @return [::Google::Ads::GoogleAds::V7::Enums::GeoTargetingRestrictionEnum::GeoTargetingRestriction]
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V7::Enums::FeedItemStatusEnum::FeedItemStatus]
          #     Output only. Status of the feed item.
          #     This field is read-only.
          # @!attribute [r] policy_infos
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Resources::FeedItemPlaceholderPolicyInfo>]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Common::Money]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Enums::PlaceholderTypeEnum::PlaceholderType]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Enums::PolicyReviewStatusEnum::PolicyReviewStatus]
          #     Output only. Where the placeholder type is in the review process.
          # @!attribute [r] approval_status
          #   @return [::Google::Ads::GoogleAds::V7::Enums::PolicyApprovalStatusEnum::PolicyApprovalStatus]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Enums::FeedItemValidationStatusEnum::FeedItemValidationStatus]
          #     Output only. The validation status of the palceholder type.
          # @!attribute [r] validation_errors
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Resources::FeedItemValidationError>]
          #     Output only. List of placeholder type validation errors.
          # @!attribute [r] quality_approval_status
          #   @return [::Google::Ads::GoogleAds::V7::Enums::FeedItemQualityApprovalStatusEnum::FeedItemQualityApprovalStatus]
          #     Output only. Placeholder type quality evaluation approval status.
          # @!attribute [r] quality_disapproval_reasons
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Enums::FeedItemQualityDisapprovalReasonEnum::FeedItemQualityDisapprovalReason>]
