...
module Google
  module Ads
    module GoogleAds
      module V7
        module Services
          # Request message for {::Google::Ads::GoogleAds::V7::Services::CustomerFeedService::Client#get_customer_feed CustomerFeedService.GetCustomerFeed}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V7::Services::CustomerFeedService::Client#mutate_customer_feeds CustomerFeedService.MutateCustomerFeeds}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose customer feeds are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::CustomerFeedOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::MutateCustomerFeedResult>]
