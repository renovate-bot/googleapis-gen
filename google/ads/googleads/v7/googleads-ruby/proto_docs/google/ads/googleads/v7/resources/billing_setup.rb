    ...
    module GoogleAds
      module V7
        module Resources
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V7::Enums::BillingSetupStatusEnum::BillingSetupStatus]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Resources::BillingSetup::PaymentsAccountInfo]
