    ...
    module GoogleAds
      module V7
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V7::Enums::AdGroupStatusEnum::AdGroupStatus]
          #     The status of the ad group.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V7::Enums::AdGroupTypeEnum::AdGroupType]
          #     Immutable. The type of the ad group.
          # @!attribute [rw] ad_rotation_mode
          #   @return [::Google::Ads::GoogleAds::V7::Enums::AdGroupAdRotationModeEnum::AdGroupAdRotationMode]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Common::ExplorerAutoOptimizerSetting]
