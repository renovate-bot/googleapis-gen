    ...
    module GoogleAds
      module V7
        module Services
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Services::CustomerUserAccessInvitationOperation]
          ...
          # @!attribute [rw] result
          #   @return [::Google::Ads::GoogleAds::V7::Services::MutateCustomerUserAccessInvitationResult]
