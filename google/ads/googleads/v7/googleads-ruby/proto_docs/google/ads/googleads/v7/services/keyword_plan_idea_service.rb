...
module Google
  module Ads
    module GoogleAds
      module V7
        module Services
          # Request message for {::Google::Ads::GoogleAds::V7::Services::KeywordPlanIdeaService::Client#generate_keyword_ideas KeywordPlanIdeaService.GenerateKeywordIdeas}.
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Enums::KeywordPlanNetworkEnum::KeywordPlanNetwork]
          #     Targeting network.
          # @!attribute [rw] keyword_annotation
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Enums::KeywordPlanKeywordAnnotationEnum::KeywordPlanKeywordAnnotation>]
          ...
          # Response message for {::Google::Ads::GoogleAds::V7::Services::KeywordPlanIdeaService::Client#generate_keyword_ideas KeywordPlanIdeaService.GenerateKeywordIdeas}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::GenerateKeywordIdeaResult>]
          ...
          #   @return [::Google::Ads::GoogleAds::V7::Common::KeywordAnnotations]
