    ...
    module GoogleAds
      module V7
        module Services
          ...
          # Request message for {::Google::Ads::GoogleAds::V7::Services::FeedItemSetLinkService::Client#mutate_feed_item_set_links FeedItemSetLinkService.MutateFeedItemSetLinks}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose feed item set links are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::FeedItemSetLinkOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V7::Services::MutateFeedItemSetLinkResult>]
