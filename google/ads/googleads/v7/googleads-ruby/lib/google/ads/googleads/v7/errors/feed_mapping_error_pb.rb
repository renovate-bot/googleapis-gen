...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v7/errors/feed_mapping_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v7.errors.FeedMappingErrorEnum" do
    end
    add_enum "google.ads.googleads.v7.errors.FeedMappingErrorEnum.FeedMappingError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V7
        module Errors
          FeedMappingErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.FeedMappingErrorEnum").msgclass
          FeedMappingErrorEnum::FeedMappingError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.FeedMappingErrorEnum.FeedMappingError").enummodule
        end
      end
    end
  end
