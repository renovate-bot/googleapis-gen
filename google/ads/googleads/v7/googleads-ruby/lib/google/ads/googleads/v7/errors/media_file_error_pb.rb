...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v7/errors/media_file_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v7.errors.MediaFileErrorEnum" do
    end
    add_enum "google.ads.googleads.v7.errors.MediaFileErrorEnum.MediaFileError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V7
        module Errors
          MediaFileErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.MediaFileErrorEnum").msgclass
          MediaFileErrorEnum::MediaFileError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.MediaFileErrorEnum.MediaFileError").enummodule
        end
      end
    end
  end
