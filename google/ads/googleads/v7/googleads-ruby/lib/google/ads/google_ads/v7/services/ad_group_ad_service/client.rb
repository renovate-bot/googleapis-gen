        ...
        module Services
          module AdGroupAdService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V7::Services::AdGroupAdService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all AdGroupAdService clients
              #   ::Google::Ads::GoogleAds::V7::Services::AdGroupAdService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V7::Services::AdGroupAdService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V7::Services::AdGroupAdService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v7/services/ad_group_ad_service_services_pb"
                ...
                @ad_group_ad_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V7::Services::AdGroupAdService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V7::Services::GetAdGroupAdRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V7::Services::GetAdGroupAdRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V7::Resources::AdGroupAd]
              ...
              #   request = Google::Ads::GoogleAds::V7::Services::GetAdGroupAdRequest.new
              #
              #   # Call the get_ad_group_ad method.
              #   result = client.get_ad_group_ad request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V7::Resources::AdGroupAd.
              #   p result
              #
              def get_ad_group_ad request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V7::Services::GetAdGroupAdRequest
              ...
              #   {::Google::Ads::GoogleAds::V7::Services::MutateAdGroupAdsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V7::Services::MutateAdGroupAdsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload mutate_ad_group_ads(customer_id: nil, operations: nil, partial_failure: nil, validate_only: nil, response_content_type: nil)
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V7::Services::AdGroupAdOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V7::Services::MutateAdGroupAdsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V7::Services::MutateAdGroupAdsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V7::Services::MutateAdGroupAdsRequest.new
              #
              #   # Call the mutate_ad_group_ads method.
              #   result = client.mutate_ad_group_ads request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V7::Services::MutateAdGroupAdsResponse.
              #   p result
              #
              def mutate_ad_group_ads request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V7::Services::MutateAdGroupAdsRequest
              ...
              # {::Google::Ads::GoogleAds::V7::Services::AdGroupAdService::Client::Configuration::Rpcs}
