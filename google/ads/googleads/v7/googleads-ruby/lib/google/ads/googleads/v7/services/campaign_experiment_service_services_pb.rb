...
# Source: google/ads/googleads/v7/services/campaign_experiment_service.proto for package 'Google.Ads.GoogleAds.V7.Services'
        ...
        module Services
          module CampaignExperimentService
            ...
            class Service
              ...
              self.service_name = 'google.ads.googleads.v7.services.CampaignExperimentService'
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :GetCampaignExperiment, ::Google::Ads::GoogleAds::V7::Services::GetCampaignExperimentRequest, ::Google::Ads::GoogleAds::V7::Resources::CampaignExperiment
              ...
              #   [RangeError]()
              #   [RequestError]()
              rpc :CreateCampaignExperiment, ::Google::Ads::GoogleAds::V7::Services::CreateCampaignExperimentRequest, ::Google::Longrunning::Operation
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :MutateCampaignExperiments, ::Google::Ads::GoogleAds::V7::Services::MutateCampaignExperimentsRequest, ::Google::Ads::GoogleAds::V7::Services::MutateCampaignExperimentsResponse
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :GraduateCampaignExperiment, ::Google::Ads::GoogleAds::V7::Services::GraduateCampaignExperimentRequest, ::Google::Ads::GoogleAds::V7::Services::GraduateCampaignExperimentResponse
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :PromoteCampaignExperiment, ::Google::Ads::GoogleAds::V7::Services::PromoteCampaignExperimentRequest, ::Google::Longrunning::Operation
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :EndCampaignExperiment, ::Google::Ads::GoogleAds::V7::Services::EndCampaignExperimentRequest, ::Google::Protobuf::Empty
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :ListCampaignExperimentAsyncErrors, ::Google::Ads::GoogleAds::V7::Services::ListCampaignExperimentAsyncErrorsRequest, ::Google::Ads::GoogleAds::V7::Services::ListCampaignExperimentAsyncErrorsResponse
            end
