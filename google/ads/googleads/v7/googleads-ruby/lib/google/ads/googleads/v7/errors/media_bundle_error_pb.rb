...
# source: google/ads/googleads/v7/errors/media_bundle_error.proto

require 'google/api/annotations_pb'
require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v7/errors/media_bundle_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v7.errors.MediaBundleErrorEnum" do
    end
    add_enum "google.ads.googleads.v7.errors.MediaBundleErrorEnum.MediaBundleError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
      value :BAD_REQUEST, 3
...
module Google
  module Ads
    module GoogleAds
      module V7
        module Errors
          MediaBundleErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.MediaBundleErrorEnum").msgclass
          MediaBundleErrorEnum::MediaBundleError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.MediaBundleErrorEnum.MediaBundleError").enummodule
        end
      end
    end
  end
