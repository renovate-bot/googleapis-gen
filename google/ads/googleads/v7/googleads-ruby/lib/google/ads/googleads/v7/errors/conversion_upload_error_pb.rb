...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v7/errors/conversion_upload_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v7.errors.ConversionUploadErrorEnum" do
    end
    add_enum "google.ads.googleads.v7.errors.ConversionUploadErrorEnum.ConversionUploadError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V7
        module Errors
          ConversionUploadErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.ConversionUploadErrorEnum").msgclass
          ConversionUploadErrorEnum::ConversionUploadError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.ConversionUploadErrorEnum.ConversionUploadError").enummodule
        end
      end
    end
  end
