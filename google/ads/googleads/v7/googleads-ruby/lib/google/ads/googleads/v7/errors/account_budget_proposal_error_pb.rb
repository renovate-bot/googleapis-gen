...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v7/errors/account_budget_proposal_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v7.errors.AccountBudgetProposalErrorEnum" do
    end
    add_enum "google.ads.googleads.v7.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
      ...
      value :CANNOT_CREATE_BUDGET_THROUGH_API, 25
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V7
        module Errors
          AccountBudgetProposalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.AccountBudgetProposalErrorEnum").msgclass
          AccountBudgetProposalErrorEnum::AccountBudgetProposalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError").enummodule
        end
      end
    end
  end
