...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v7/errors/asset_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v7.errors.AssetErrorEnum" do
    end
    add_enum "google.ads.googleads.v7.errors.AssetErrorEnum.AssetError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V7
        module Errors
          AssetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.AssetErrorEnum").msgclass
          AssetErrorEnum::AssetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.AssetErrorEnum.AssetError").enummodule
        end
      end
    end
  end
