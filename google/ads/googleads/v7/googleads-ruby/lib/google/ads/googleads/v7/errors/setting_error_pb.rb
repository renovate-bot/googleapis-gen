...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v7/errors/setting_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v7.errors.SettingErrorEnum" do
    end
    add_enum "google.ads.googleads.v7.errors.SettingErrorEnum.SettingError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V7
        module Errors
          SettingErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.SettingErrorEnum").msgclass
          SettingErrorEnum::SettingError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.SettingErrorEnum.SettingError").enummodule
        end
      end
    end
  end
