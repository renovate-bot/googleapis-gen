...
import com.google.ads.googleads.v7.services.CreateAccountLinkRequest;
import com.google.ads.googleads.v7.services.CreateAccountLinkResponse;
import com.google.ads.googleads.v7.services.GetAccountLinkRequest;
import com.google.ads.googleads.v7.services.MutateAccountLinkRequest;
import com.google.ads.googleads.v7.services.MutateAccountLinkResponse;
...
/**
 * Settings class to configure an instance of {@link AccountLinkServiceStub}.
 *
 ...
 *
 * <p>For example, to set the total timeout of getAccountLink to 30 seconds:
 *
 * <pre>{@code
 * AccountLinkServiceStubSettings.Builder accountLinkServiceSettingsBuilder =
 *     AccountLinkServiceStubSettings.newBuilder();
 ...
 *             .build());
 * AccountLinkServiceStubSettings accountLinkServiceSettings =
...
public class AccountLinkServiceStubSettings extends StubSettings<AccountLinkServiceStubSettings> {
  ...
  public AccountLinkServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcAccountLinkServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(AccountLinkServiceStubSettings.class))
        .setTransportToken(
  ...
  protected AccountLinkServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<AccountLinkServiceStubSettings, Builder> {
    ...
    protected Builder(AccountLinkServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public AccountLinkServiceStubSettings build() throws IOException {
      return new AccountLinkServiceStubSettings(this);
    }
  }
}
