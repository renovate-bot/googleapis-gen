...
import com.google.ads.googleads.v7.services.GetFeedRequest;
import com.google.ads.googleads.v7.services.MutateFeedsRequest;
...
public class FeedServiceStubSettings extends StubSettings<FeedServiceStubSettings> {
  ...
  private final UnaryCallSettings<MutateFeedsRequest, MutateFeedsResponse> mutateFeedsSettings;
  ...
  protected FeedServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    mutateFeedsSettings = settingsBuilder.mutateFeedsSettings().build();
  }
  ...
  public static class Builder extends StubSettings.Builder<FeedServiceStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<MutateFeedsRequest, MutateFeedsResponse>
        mutateFeedsSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      mutateFeedsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(getFeedSettings, mutateFeedsSettings);
      initDefaults(this);
    }
    ...
    protected Builder(FeedServiceStubSettings settings) {
      ...
      mutateFeedsSettings = settings.mutateFeedsSettings.toBuilder();
