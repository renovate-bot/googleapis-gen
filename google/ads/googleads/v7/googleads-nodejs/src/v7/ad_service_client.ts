 ...
 * `src/v7/ad_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_service_client_config.json';
...
export class AdServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.AdService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.AdService.
    this.adServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.AdService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.AdService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adServiceStubMethods =
        ['getAd', 'mutateAds'];
    for (const methodName of adServiceStubMethods) {
      const callPromise = this.adServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [Ad]{@link google.ads.googleads.v7.resources.Ad}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/ad_service.get_ad.js</caption>
 * region_tag:googleads_v7_generated_AdService_GetAd_async
 */
  getAd(
      request?: protos.google.ads.googleads.v7.services.IGetAdRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.resources.IAd,
        protos.google.ads.googleads.v7.services.IGetAdRequest|undefined, {}|undefined
      ]>;
  getAd(
      request: protos.google.ads.googleads.v7.services.IGetAdRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.resources.IAd,
          protos.google.ads.googleads.v7.services.IGetAdRequest|null|undefined,
          {}|null|undefined>): void;
  getAd(
      request: protos.google.ads.googleads.v7.services.IGetAdRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateAdsResponse]{@link google.ads.googleads.v7.services.MutateAdsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/ad_service.mutate_ads.js</caption>
 * region_tag:googleads_v7_generated_AdService_MutateAds_async
 */
  mutateAds(
      request?: protos.google.ads.googleads.v7.services.IMutateAdsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.services.IMutateAdsResponse,
        protos.google.ads.googleads.v7.services.IMutateAdsRequest|undefined, {}|undefined
      ]>;
  mutateAds(
      request: protos.google.ads.googleads.v7.services.IMutateAdsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.services.IMutateAdsResponse,
          protos.google.ads.googleads.v7.services.IMutateAdsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateAds(
      request: protos.google.ads.googleads.v7.services.IMutateAdsRequest,
      callback: Callback<
