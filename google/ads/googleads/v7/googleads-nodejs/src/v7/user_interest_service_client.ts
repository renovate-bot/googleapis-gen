 ...
 * `src/v7/user_interest_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './user_interest_service_client_config.json';
...
export class UserInterestServiceClient {
  ...
  userInterestServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof UserInterestServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.UserInterestService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.UserInterestService.
    this.userInterestServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.UserInterestService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.UserInterestService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const userInterestServiceStubMethods =
        ['getUserInterest'];
    for (const methodName of userInterestServiceStubMethods) {
      const callPromise = this.userInterestServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [UserInterest]{@link google.ads.googleads.v7.resources.UserInterest}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/user_interest_service.get_user_interest.js</caption>
 * region_tag:googleads_v7_generated_UserInterestService_GetUserInterest_async
 */
  getUserInterest(
      request?: protos.google.ads.googleads.v7.services.IGetUserInterestRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.resources.IUserInterest,
        protos.google.ads.googleads.v7.services.IGetUserInterestRequest|undefined, {}|undefined
      ]>;
  getUserInterest(
      request: protos.google.ads.googleads.v7.services.IGetUserInterestRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.resources.IUserInterest,
          protos.google.ads.googleads.v7.services.IGetUserInterestRequest|null|undefined,
          {}|null|undefined>): void;
  getUserInterest(
      request: protos.google.ads.googleads.v7.services.IGetUserInterestRequest,
      callback: Callback<
