 ...
 * @example <caption>include:samples/generated/v7/change_status_service.get_change_status.js</caption>
 * region_tag:googleads_v7_generated_ChangeStatusService_GetChangeStatus_async
 */
  getChangeStatus(
