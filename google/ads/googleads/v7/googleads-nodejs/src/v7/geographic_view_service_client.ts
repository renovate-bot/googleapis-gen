 ...
 * @example <caption>include:samples/generated/v7/geographic_view_service.get_geographic_view.js</caption>
 * region_tag:googleads_v7_generated_GeographicViewService_GetGeographicView_async
 */
  getGeographicView(
