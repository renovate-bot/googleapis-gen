 ...
 * `src/v7/ad_group_asset_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './ad_group_asset_service_client_config.json';
 ...
 * @memberof v7
 */
export class AdGroupAssetServiceClient {
  ...
  adGroupAssetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AdGroupAssetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.AdGroupAssetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.adGroupAssetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.AdGroupAssetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.AdGroupAssetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const adGroupAssetServiceStubMethods =
        ['getAdGroupAsset', 'mutateAdGroupAssets'];
    for (const methodName of adGroupAssetServiceStubMethods) {
      const callPromise = this.adGroupAssetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [AdGroupAsset]{@link google.ads.googleads.v7.resources.AdGroupAsset}.
 *   Please see the
 ...
 * region_tag:googleads_v7_generated_AdGroupAssetService_GetAdGroupAsset_async
 */
  getAdGroupAsset(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v7.services.IGetAdGroupAssetRequest|undefined, {}|undefined
      ]>;
  getAdGroupAsset(
      request: protos.google.ads.googleads.v7.services.IGetAdGroupAssetRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateAdGroupAssetsResponse]{@link google.ads.googleads.v7.services.MutateAdGroupAssetsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/ad_group_asset_service.mutate_ad_group_assets.js</caption>
 * region_tag:googleads_v7_generated_AdGroupAssetService_MutateAdGroupAssets_async
 */
  mutateAdGroupAssets(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v7.services.IMutateAdGroupAssetsRequest|undefined, {}|undefined
      ]>;
  mutateAdGroupAssets(
      request: protos.google.ads.googleads.v7.services.IMutateAdGroupAssetsRequest,
      options: CallOptions,
