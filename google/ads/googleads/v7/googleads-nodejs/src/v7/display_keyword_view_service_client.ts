 ...
 * `src/v7/display_keyword_view_service_client_config.json`.
...
export class DisplayKeywordViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.DisplayKeywordViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.DisplayKeywordViewService.
    this.displayKeywordViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.DisplayKeywordViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.DisplayKeywordViewService,
 ...
 *   The first element of the array is an object representing [DisplayKeywordView]{@link google.ads.googleads.v7.resources.DisplayKeywordView}.
 *   Please see the
