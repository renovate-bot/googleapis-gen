 ...
 * `src/v7/distance_view_service_client_config.json`.
...
export class DistanceViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.DistanceViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.distanceViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.DistanceViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.DistanceViewService,
 ...
 *   The first element of the array is an object representing [DistanceView]{@link google.ads.googleads.v7.resources.DistanceView}.
 *   Please see the
