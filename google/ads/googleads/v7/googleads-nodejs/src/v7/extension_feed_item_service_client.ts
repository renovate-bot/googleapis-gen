 ...
 * `src/v7/extension_feed_item_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './extension_feed_item_service_client_config.json';
...
export class ExtensionFeedItemServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.ExtensionFeedItemService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.ExtensionFeedItemService.
    this.extensionFeedItemServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.ExtensionFeedItemService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.ExtensionFeedItemService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const extensionFeedItemServiceStubMethods =
        ['getExtensionFeedItem', 'mutateExtensionFeedItems'];
    for (const methodName of extensionFeedItemServiceStubMethods) {
      const callPromise = this.extensionFeedItemServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [ExtensionFeedItem]{@link google.ads.googleads.v7.resources.ExtensionFeedItem}.
 *   Please see the
 ...
 * region_tag:googleads_v7_generated_ExtensionFeedItemService_GetExtensionFeedItem_async
 */
  getExtensionFeedItem(
      request?: protos.google.ads.googleads.v7.services.IGetExtensionFeedItemRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.resources.IExtensionFeedItem,
        protos.google.ads.googleads.v7.services.IGetExtensionFeedItemRequest|undefined, {}|undefined
      ]>;
  getExtensionFeedItem(
      request: protos.google.ads.googleads.v7.services.IGetExtensionFeedItemRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.resources.IExtensionFeedItem,
          protos.google.ads.googleads.v7.services.IGetExtensionFeedItemRequest|null|undefined,
          {}|null|undefined>): void;
  getExtensionFeedItem(
      request: protos.google.ads.googleads.v7.services.IGetExtensionFeedItemRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateExtensionFeedItemsResponse]{@link google.ads.googleads.v7.services.MutateExtensionFeedItemsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/extension_feed_item_service.mutate_extension_feed_items.js</caption>
 * region_tag:googleads_v7_generated_ExtensionFeedItemService_MutateExtensionFeedItems_async
 */
  mutateExtensionFeedItems(
      request?: protos.google.ads.googleads.v7.services.IMutateExtensionFeedItemsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.services.IMutateExtensionFeedItemsResponse,
        protos.google.ads.googleads.v7.services.IMutateExtensionFeedItemsRequest|undefined, {}|undefined
      ]>;
  mutateExtensionFeedItems(
      request: protos.google.ads.googleads.v7.services.IMutateExtensionFeedItemsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.services.IMutateExtensionFeedItemsResponse,
          protos.google.ads.googleads.v7.services.IMutateExtensionFeedItemsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateExtensionFeedItems(
      request: protos.google.ads.googleads.v7.services.IMutateExtensionFeedItemsRequest,
      callback: Callback<
