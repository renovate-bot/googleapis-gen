 ...
 * @example <caption>include:samples/generated/v7/webpage_view_service.get_webpage_view.js</caption>
 * region_tag:googleads_v7_generated_WebpageViewService_GetWebpageView_async
 */
  getWebpageView(
