 ...
 * @example <caption>include:samples/generated/v7/topic_view_service.get_topic_view.js</caption>
 * region_tag:googleads_v7_generated_TopicViewService_GetTopicView_async
 */
  getTopicView(
