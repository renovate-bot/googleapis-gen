 ...
 * `src/v7/campaign_criterion_simulation_service_client_config.json`.
...
export class CampaignCriterionSimulationServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.CampaignCriterionSimulationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignCriterionSimulationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.CampaignCriterionSimulationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.CampaignCriterionSimulationService,
 ...
 *   The first element of the array is an object representing [CampaignCriterionSimulation]{@link google.ads.googleads.v7.resources.CampaignCriterionSimulation}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/campaign_criterion_simulation_service.get_campaign_criterion_simulation.js</caption>
 * region_tag:googleads_v7_generated_CampaignCriterionSimulationService_GetCampaignCriterionSimulation_async
 */
  getCampaignCriterionSimulation(
      request?: protos.google.ads.googleads.v7.services.IGetCampaignCriterionSimulationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.resources.ICampaignCriterionSimulation,
        protos.google.ads.googleads.v7.services.IGetCampaignCriterionSimulationRequest|undefined, {}|undefined
      ]>;
  getCampaignCriterionSimulation(
      request: protos.google.ads.googleads.v7.services.IGetCampaignCriterionSimulationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.resources.ICampaignCriterionSimulation,
          protos.google.ads.googleads.v7.services.IGetCampaignCriterionSimulationRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignCriterionSimulation(
      request: protos.google.ads.googleads.v7.services.IGetCampaignCriterionSimulationRequest,
      callback: Callback<
