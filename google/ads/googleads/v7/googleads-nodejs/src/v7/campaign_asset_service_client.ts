 ...
 * `src/v7/campaign_asset_service_client_config.json`.
...
export class CampaignAssetServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.CampaignAssetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.campaignAssetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.CampaignAssetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.CampaignAssetService,
 ...
 *   The first element of the array is an object representing [CampaignAsset]{@link google.ads.googleads.v7.resources.CampaignAsset}.
 *   Please see the
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCampaignAssetsResponse]{@link google.ads.googleads.v7.services.MutateCampaignAssetsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
