 ...
 * `src/v7/billing_setup_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './billing_setup_service_client_config.json';
...
export class BillingSetupServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.BillingSetupService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.BillingSetupService.
    this.billingSetupServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.BillingSetupService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.BillingSetupService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const billingSetupServiceStubMethods =
        ['getBillingSetup', 'mutateBillingSetup'];
    for (const methodName of billingSetupServiceStubMethods) {
      const callPromise = this.billingSetupServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [BillingSetup]{@link google.ads.googleads.v7.resources.BillingSetup}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/billing_setup_service.get_billing_setup.js</caption>
 * region_tag:googleads_v7_generated_BillingSetupService_GetBillingSetup_async
 */
  getBillingSetup(
      request?: protos.google.ads.googleads.v7.services.IGetBillingSetupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.resources.IBillingSetup,
        protos.google.ads.googleads.v7.services.IGetBillingSetupRequest|undefined, {}|undefined
      ]>;
  getBillingSetup(
      request: protos.google.ads.googleads.v7.services.IGetBillingSetupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.resources.IBillingSetup,
          protos.google.ads.googleads.v7.services.IGetBillingSetupRequest|null|undefined,
          {}|null|undefined>): void;
  getBillingSetup(
      request: protos.google.ads.googleads.v7.services.IGetBillingSetupRequest,
      callback: Callback<
 ...
 * @param {google.ads.googleads.v7.services.BillingSetupOperation} request.operation
 *   Required. The operation to perform.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateBillingSetupResponse]{@link google.ads.googleads.v7.services.MutateBillingSetupResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/billing_setup_service.mutate_billing_setup.js</caption>
 * region_tag:googleads_v7_generated_BillingSetupService_MutateBillingSetup_async
 */
  mutateBillingSetup(
      request?: protos.google.ads.googleads.v7.services.IMutateBillingSetupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.services.IMutateBillingSetupResponse,
        protos.google.ads.googleads.v7.services.IMutateBillingSetupRequest|undefined, {}|undefined
      ]>;
  mutateBillingSetup(
      request: protos.google.ads.googleads.v7.services.IMutateBillingSetupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.services.IMutateBillingSetupResponse,
          protos.google.ads.googleads.v7.services.IMutateBillingSetupRequest|null|undefined,
          {}|null|undefined>): void;
  mutateBillingSetup(
      request: protos.google.ads.googleads.v7.services.IMutateBillingSetupRequest,
      callback: Callback<
