 ...
 * @example <caption>include:samples/generated/v7/hotel_group_view_service.get_hotel_group_view.js</caption>
 * region_tag:googleads_v7_generated_HotelGroupViewService_GetHotelGroupView_async
 */
  getHotelGroupView(
