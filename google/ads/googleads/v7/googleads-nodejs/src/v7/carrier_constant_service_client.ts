 ...
 * @example <caption>include:samples/generated/v7/carrier_constant_service.get_carrier_constant.js</caption>
 * region_tag:googleads_v7_generated_CarrierConstantService_GetCarrierConstant_async
 */
  getCarrierConstant(
