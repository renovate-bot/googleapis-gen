 ...
 * `src/v7/shared_set_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './shared_set_service_client_config.json';
...
export class SharedSetServiceClient {
  ...
  sharedSetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof SharedSetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.SharedSetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.SharedSetService.
    this.sharedSetServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.SharedSetService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.SharedSetService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const sharedSetServiceStubMethods =
        ['getSharedSet', 'mutateSharedSets'];
    for (const methodName of sharedSetServiceStubMethods) {
      const callPromise = this.sharedSetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [SharedSet]{@link google.ads.googleads.v7.resources.SharedSet}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/shared_set_service.get_shared_set.js</caption>
 * region_tag:googleads_v7_generated_SharedSetService_GetSharedSet_async
 */
  getSharedSet(
      request?: protos.google.ads.googleads.v7.services.IGetSharedSetRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.resources.ISharedSet,
        protos.google.ads.googleads.v7.services.IGetSharedSetRequest|undefined, {}|undefined
      ]>;
  getSharedSet(
      request: protos.google.ads.googleads.v7.services.IGetSharedSetRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.resources.ISharedSet,
          protos.google.ads.googleads.v7.services.IGetSharedSetRequest|null|undefined,
          {}|null|undefined>): void;
  getSharedSet(
      request: protos.google.ads.googleads.v7.services.IGetSharedSetRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateSharedSetsResponse]{@link google.ads.googleads.v7.services.MutateSharedSetsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/shared_set_service.mutate_shared_sets.js</caption>
 * region_tag:googleads_v7_generated_SharedSetService_MutateSharedSets_async
 */
  mutateSharedSets(
      request?: protos.google.ads.googleads.v7.services.IMutateSharedSetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.services.IMutateSharedSetsResponse,
        protos.google.ads.googleads.v7.services.IMutateSharedSetsRequest|undefined, {}|undefined
      ]>;
  mutateSharedSets(
      request: protos.google.ads.googleads.v7.services.IMutateSharedSetsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.services.IMutateSharedSetsResponse,
          protos.google.ads.googleads.v7.services.IMutateSharedSetsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateSharedSets(
      request: protos.google.ads.googleads.v7.services.IMutateSharedSetsRequest,
      callback: Callback<
