 ...
 * `src/v7/life_event_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './life_event_service_client_config.json';
 ...
 * @memberof v7
 */
export class LifeEventServiceClient {
  ...
  lifeEventServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof LifeEventServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.LifeEventService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.ads.googleads.v7.services.LifeEventService.
    this.lifeEventServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.LifeEventService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.LifeEventService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const lifeEventServiceStubMethods =
        ['getLifeEvent'];
    for (const methodName of lifeEventServiceStubMethods) {
      const callPromise = this.lifeEventServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getLifeEvent(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v7.services.IGetLifeEventRequest|undefined, {}|undefined
      ]>;
  getLifeEvent(
      request: protos.google.ads.googleads.v7.services.IGetLifeEventRequest,
      options: CallOptions,
