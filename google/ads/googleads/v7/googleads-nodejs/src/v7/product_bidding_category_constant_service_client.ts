 ...
 * `src/v7/product_bidding_category_constant_service_client_config.json`.
...
export class ProductBiddingCategoryConstantServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.ProductBiddingCategoryConstantService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.productBiddingCategoryConstantServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.ProductBiddingCategoryConstantService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.ProductBiddingCategoryConstantService,
 ...
 *   The first element of the array is an object representing [ProductBiddingCategoryConstant]{@link google.ads.googleads.v7.resources.ProductBiddingCategoryConstant}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/product_bidding_category_constant_service.get_product_bidding_category_constant.js</caption>
 * region_tag:googleads_v7_generated_ProductBiddingCategoryConstantService_GetProductBiddingCategoryConstant_async
 */
  getProductBiddingCategoryConstant(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v7.services.IGetProductBiddingCategoryConstantRequest|undefined, {}|undefined
      ]>;
  getProductBiddingCategoryConstant(
      request: protos.google.ads.googleads.v7.services.IGetProductBiddingCategoryConstantRequest,
      options: CallOptions,
