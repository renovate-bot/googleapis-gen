 ...
 * @example <caption>include:samples/generated/v7/account_budget_service.get_account_budget.js</caption>
 * region_tag:googleads_v7_generated_AccountBudgetService_GetAccountBudget_async
 */
  getAccountBudget(
