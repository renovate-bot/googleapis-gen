...
export class CampaignExperimentServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._protos = this._gaxGrpc.loadProto(
      ...
      'google/ads/googleads/v7/services/campaign_experiment_service.proto'
    );
    ...
    protoFilesRoot = this._gaxModule.protobuf.loadSync(
      path.join(__dirname, '..', '..', 'protos', 'google/ads/googleads/v7/services/campaign_experiment_service.proto'),
