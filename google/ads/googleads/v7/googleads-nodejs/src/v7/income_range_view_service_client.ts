 ...
 * @example <caption>include:samples/generated/v7/income_range_view_service.get_income_range_view.js</caption>
 * region_tag:googleads_v7_generated_IncomeRangeViewService_GetIncomeRangeView_async
 */
  getIncomeRangeView(
