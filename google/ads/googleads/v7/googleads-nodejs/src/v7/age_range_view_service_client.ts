 ...
 * `src/v7/age_range_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './age_range_view_service_client_config.json';
 ...
 * @memberof v7
 */
export class AgeRangeViewServiceClient {
  ...
  ageRangeViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AgeRangeViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v7.services.AgeRangeViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.ageRangeViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v7.services.AgeRangeViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v7.services.AgeRangeViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const ageRangeViewServiceStubMethods =
        ['getAgeRangeView'];
    for (const methodName of ageRangeViewServiceStubMethods) {
      const callPromise = this.ageRangeViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [AgeRangeView]{@link google.ads.googleads.v7.resources.AgeRangeView}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v7/age_range_view_service.get_age_range_view.js</caption>
 * region_tag:googleads_v7_generated_AgeRangeViewService_GetAgeRangeView_async
 */
  getAgeRangeView(
      request?: protos.google.ads.googleads.v7.services.IGetAgeRangeViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v7.resources.IAgeRangeView,
        protos.google.ads.googleads.v7.services.IGetAgeRangeViewRequest|undefined, {}|undefined
      ]>;
  getAgeRangeView(
      request: protos.google.ads.googleads.v7.services.IGetAgeRangeViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v7.resources.IAgeRangeView,
          protos.google.ads.googleads.v7.services.IGetAgeRangeViewRequest|null|undefined,
          {}|null|undefined>): void;
  getAgeRangeView(
      request: protos.google.ads.googleads.v7.services.IGetAgeRangeViewRequest,
      callback: Callback<
