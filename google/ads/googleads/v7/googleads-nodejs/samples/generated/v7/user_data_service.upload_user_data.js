...
function main(customerId, operations) {
  // [START googleads_v7_generated_UserDataService_UploadUserData_async]
  /**
  ...
  const {UserDataServiceClient} = require('google-ads').v7;
  ...
  callUploadUserData();
  // [END googleads_v7_generated_UserDataService_UploadUserData_async]
}
