...
function main(customerId, operations) {
  // [START googleads_v7_generated_AdGroupExtensionSettingService_MutateAdGroupExtensionSettings_async]
  /**
  ...
  const {AdGroupExtensionSettingServiceClient} = require('google-ads').v7;
  ...
  async function mutateAdGroupExtensionSettings() {
    ...
    // Run request
    const response = await googleadsClient.mutateAdGroupExtensionSettings(request);
    console.log(response);
  }

  mutateAdGroupExtensionSettings();
  // [END googleads_v7_generated_AdGroupExtensionSettingService_MutateAdGroupExtensionSettings_async]
}
