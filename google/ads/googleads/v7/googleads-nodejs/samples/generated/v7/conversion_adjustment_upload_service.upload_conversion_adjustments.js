...
function main(customerId, conversionAdjustments, partialFailure) {
  // [START googleads_v7_generated_ConversionAdjustmentUploadService_UploadConversionAdjustments_async]
  /**
  ...
  const {ConversionAdjustmentUploadServiceClient} = require('google-ads').v7;
  ...
  // [END googleads_v7_generated_ConversionAdjustmentUploadService_UploadConversionAdjustments_async]
}
