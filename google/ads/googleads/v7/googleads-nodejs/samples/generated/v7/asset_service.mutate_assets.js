...
function main(customerId, operations) {
  // [START googleads_v7_generated_AssetService_MutateAssets_async]
  /**
  ...
  const {AssetServiceClient} = require('google-ads').v7;
  ...
  mutateAssets();
  // [END googleads_v7_generated_AssetService_MutateAssets_async]
}
