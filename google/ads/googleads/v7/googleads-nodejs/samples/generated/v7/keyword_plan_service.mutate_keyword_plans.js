...
function main(customerId, operations) {
  // [START googleads_v7_generated_KeywordPlanService_MutateKeywordPlans_async]
  /**
  ...
  async function callMutateKeywordPlans() {
    // Construct request
    const request = {
      customerId,
      operations,
    ...
    // Run request
    const response = await googleadsClient.mutateKeywordPlans(request);
    console.log(response);
  }

  callMutateKeywordPlans();
  // [END googleads_v7_generated_KeywordPlanService_MutateKeywordPlans_async]
}
