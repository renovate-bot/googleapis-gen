...
function main(customerId, operations) {
  // [START googleads_v7_generated_CustomInterestService_MutateCustomInterests_async]
  /**
  ...
  const {CustomInterestServiceClient} = require('google-ads').v7;
  ...
  async function mutateCustomInterests() {
    ...
    // Run request
    const response = await googleadsClient.mutateCustomInterests(request);
    console.log(response);
  }

  mutateCustomInterests();
  // [END googleads_v7_generated_CustomInterestService_MutateCustomInterests_async]
}
