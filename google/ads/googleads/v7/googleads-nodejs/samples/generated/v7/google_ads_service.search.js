...
function main(customerId, query) {
  // [START googleads_v7_generated_GoogleAdsService_Search_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v7;
  ...
  callSearch();
  // [END googleads_v7_generated_GoogleAdsService_Search_async]
}
