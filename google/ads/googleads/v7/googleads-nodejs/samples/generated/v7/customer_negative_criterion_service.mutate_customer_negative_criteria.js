...
function main(customerId, operations) {
  // [START googleads_v7_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async]
  /**
  ...
  const {CustomerNegativeCriterionServiceClient} = require('google-ads').v7;
  ...
  // [END googleads_v7_generated_CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_async]
}
