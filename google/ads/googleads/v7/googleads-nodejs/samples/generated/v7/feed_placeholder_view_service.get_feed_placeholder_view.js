...
function main(resourceName) {
  // [START googleads_get_feed_placeholder_view_sample]
  /**
  ...
  const {FeedPlaceholderViewServiceClient} = require('google-ads').v7;
  ...
  async function getFeedPlaceholderView() {
    ...
    // Run request
    const response = await googleadsClient.getFeedPlaceholderView(request);
    console.log(response);
  }

  getFeedPlaceholderView();
  // [END googleads_get_feed_placeholder_view_sample]
}
