...
function main(resourceName) {
  // [START googleads_v7_generated_ShoppingPerformanceViewService_GetShoppingPerformanceView_async]
  /**
  ...
  const {ShoppingPerformanceViewServiceClient} = require('google-ads').v7;
