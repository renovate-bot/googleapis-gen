...
function main(customerId, operations) {
  // [START googleads_v7_generated_CampaignBudgetService_MutateCampaignBudgets_async]
  /**
  ...
  const {CampaignBudgetServiceClient} = require('google-ads').v7;
  ...
  // [END googleads_v7_generated_CampaignBudgetService_MutateCampaignBudgets_async]
}
