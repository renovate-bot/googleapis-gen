...
function main(resourceName) {
  // [START googleads_get_detail_placement_view_sample]
  /**
  ...
  const {DetailPlacementViewServiceClient} = require('google-ads').v7;
  ...
  async function getDetailPlacementView() {
    ...
    // Run request
    const response = await googleadsClient.getDetailPlacementView(request);
    console.log(response);
  }

  getDetailPlacementView();
  // [END googleads_get_detail_placement_view_sample]
}
