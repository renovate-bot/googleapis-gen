...
function main(customerId, previousCustomerManagerLink, newManager) {
  // [START googleads_v7_generated_CustomerManagerLinkService_MoveManagerLink_async]
  /**
   ...
   */
  // const previousCustomerManagerLink = 'abc123'
  /**
  ...
  async function moveManagerLink() {
    ...
    // Run request
    const response = await googleadsClient.moveManagerLink(request);
