...
function main(customerId, operations) {
  // [START googleads_v7_generated_CampaignExperimentService_MutateCampaignExperiments_async]
  /**
  ...
  async function mutateCampaignExperiments() {
    // Construct request
    const request = {
      customerId,
      operations,
  ...
  // [END googleads_v7_generated_CampaignExperimentService_MutateCampaignExperiments_async]
}
