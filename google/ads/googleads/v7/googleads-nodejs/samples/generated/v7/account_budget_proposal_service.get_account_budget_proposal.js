...
function main(resourceName) {
  // [START googleads_v7_generated_AccountBudgetProposalService_GetAccountBudgetProposal_async]
  /**
  ...
  const {AccountBudgetProposalServiceClient} = require('google-ads').v7;
