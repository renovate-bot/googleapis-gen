...
function main(customerId, operations) {
  // [START googleads_v7_generated_AdGroupFeedService_MutateAdGroupFeeds_async]
  /**
  ...
  const {AdGroupFeedServiceClient} = require('google-ads').v7;
  ...
  mutateAdGroupFeeds();
  // [END googleads_v7_generated_AdGroupFeedService_MutateAdGroupFeeds_async]
}
