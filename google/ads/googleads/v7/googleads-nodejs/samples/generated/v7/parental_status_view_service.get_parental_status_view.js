...
function main(resourceName) {
  // [START googleads_get_parental_status_view_sample]
  /**
  ...
  const {ParentalStatusViewServiceClient} = require('google-ads').v7;
  ...
  // [END googleads_get_parental_status_view_sample]
}
