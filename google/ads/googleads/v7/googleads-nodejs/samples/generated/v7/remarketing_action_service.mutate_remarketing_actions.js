...
function main(customerId, operations) {
  // [START googleads_v7_generated_RemarketingActionService_MutateRemarketingActions_async]
  /**
  ...
  const {RemarketingActionServiceClient} = require('google-ads').v7;
  ...
  async function callMutateRemarketingActions() {
    ...
    // Run request
    const response = await googleadsClient.mutateRemarketingActions(request);
    console.log(response);
  }

  callMutateRemarketingActions();
  // [END googleads_v7_generated_RemarketingActionService_MutateRemarketingActions_async]
}
