...
function main(resourceName) {
  // [START googleads_v7_generated_KeywordPlanService_GetKeywordPlan_async]
  /**
  ...
  async function getKeywordPlan() {
    ...
    // Run request
    const response = await googleadsClient.getKeywordPlan(request);
    console.log(response);
  }

  getKeywordPlan();
  // [END googleads_v7_generated_KeywordPlanService_GetKeywordPlan_async]
}
