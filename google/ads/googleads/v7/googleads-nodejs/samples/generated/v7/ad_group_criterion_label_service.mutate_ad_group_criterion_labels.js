...
function main(customerId, operations) {
  // [START googleads_v7_generated_AdGroupCriterionLabelService_MutateAdGroupCriterionLabels_async]
  /**
  ...
  const {AdGroupCriterionLabelServiceClient} = require('google-ads').v7;
  ...
  async function callMutateAdGroupCriterionLabels() {
    ...
    // Run request
    const response = await googleadsClient.mutateAdGroupCriterionLabels(request);
    console.log(response);
  }

  callMutateAdGroupCriterionLabels();
  // [END googleads_v7_generated_AdGroupCriterionLabelService_MutateAdGroupCriterionLabels_async]
}
