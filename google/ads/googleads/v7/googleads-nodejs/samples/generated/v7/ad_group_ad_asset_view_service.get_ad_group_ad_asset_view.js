...
function main(resourceName) {
  // [START googleads_get_ad_group_ad_asset_view_sample]
  /**
  ...
  const {AdGroupAdAssetViewServiceClient} = require('google-ads').v7;
  ...
  // [END googleads_get_ad_group_ad_asset_view_sample]
}
