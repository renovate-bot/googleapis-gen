...
function main(customerId, operations) {
  // [START googleads_v7_generated_LabelService_MutateLabels_async]
  /**
  ...
  const {LabelServiceClient} = require('google-ads').v7;
  ...
  mutateLabels();
  // [END googleads_v7_generated_LabelService_MutateLabels_async]
}
