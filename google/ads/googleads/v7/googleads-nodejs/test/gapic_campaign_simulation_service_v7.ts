...
describe('v7.CampaignSimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignsimulationserviceModule.v7.CampaignSimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignsimulationserviceModule.v7.CampaignSimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignsimulationserviceModule.v7.CampaignSimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignsimulationserviceModule.v7.CampaignSimulationServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignSimulation', () => {
        it('invokes getCampaignSimulation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCampaignSimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CampaignSimulation());
        ...
        it('invokes getCampaignSimulation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICampaignSimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
