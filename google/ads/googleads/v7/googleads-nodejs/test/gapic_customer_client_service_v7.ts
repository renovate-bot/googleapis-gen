...
describe('v7.CustomerClientServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerclientserviceModule.v7.CustomerClientServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerclientserviceModule.v7.CustomerClientServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerclientserviceModule.v7.CustomerClientServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerclientserviceModule.v7.CustomerClientServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerClient', () => {
        it('invokes getCustomerClient without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCustomerClientRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomerClient());
        ...
        it('invokes getCustomerClient without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerClient(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICustomerClient|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
