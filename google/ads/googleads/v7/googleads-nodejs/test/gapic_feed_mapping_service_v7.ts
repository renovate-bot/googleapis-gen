...
import * as feedmappingserviceModule from '../src';
...
describe('v7.FeedMappingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feedmappingserviceModule.v7.FeedMappingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feedmappingserviceModule.v7.FeedMappingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feedmappingserviceModule.v7.FeedMappingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feedmappingserviceModule.v7.FeedMappingServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.feedMappingServiceStub, undefined);
        await client.initialize();
        assert(client.feedMappingServiceStub);
    });
    ...
    describe('getFeedMapping', () => {
        it('invokes getFeedMapping without error', async () => {
            const client = new feedmappingserviceModule.v7.FeedMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetFeedMappingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.FeedMapping());
            client.innerApiCalls.getFeedMapping = stubSimpleCall(expectedResponse);
            const [response] = await client.getFeedMapping(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getFeedMapping as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getFeedMapping without error using callback', async () => {
            const client = new feedmappingserviceModule.v7.FeedMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.FeedMapping());
            client.innerApiCalls.getFeedMapping = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFeedMapping(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IFeedMapping|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFeedMapping with error', async () => {
            const client = new feedmappingserviceModule.v7.FeedMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getFeedMapping = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getFeedMapping(request), expectedError);
            assert((client.innerApiCalls.getFeedMapping as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateFeedMappings', () => {
        it('invokes mutateFeedMappings without error', async () => {
            const client = new feedmappingserviceModule.v7.FeedMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateFeedMappingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateFeedMappingsResponse());
            client.innerApiCalls.mutateFeedMappings = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateFeedMappings(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateFeedMappings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateFeedMappings without error using callback', async () => {
            const client = new feedmappingserviceModule.v7.FeedMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateFeedMappingsResponse());
            client.innerApiCalls.mutateFeedMappings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedMappings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateFeedMappingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateFeedMappings with error', async () => {
            const client = new feedmappingserviceModule.v7.FeedMappingServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateFeedMappings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateFeedMappings(request), expectedError);
            assert((client.innerApiCalls.mutateFeedMappings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
