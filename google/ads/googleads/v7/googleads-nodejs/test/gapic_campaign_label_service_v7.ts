...
describe('v7.CampaignLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignlabelserviceModule.v7.CampaignLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignlabelserviceModule.v7.CampaignLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignlabelserviceModule.v7.CampaignLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignlabelserviceModule.v7.CampaignLabelServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignLabel', () => {
        it('invokes getCampaignLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCampaignLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CampaignLabel());
        ...
        it('invokes getCampaignLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICampaignLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignLabels', () => {
        it('invokes mutateCampaignLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignLabelsResponse());
        ...
        it('invokes mutateCampaignLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCampaignLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
