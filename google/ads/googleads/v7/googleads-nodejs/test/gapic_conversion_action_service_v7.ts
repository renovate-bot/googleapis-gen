...
describe('v7.ConversionActionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionactionserviceModule.v7.ConversionActionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionactionserviceModule.v7.ConversionActionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionactionserviceModule.v7.ConversionActionServiceClient.port;
        assert(port);
    ...
    describe('getConversionAction', () => {
        it('invokes getConversionAction without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.ConversionAction());
        ...
        it('invokes getConversionAction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConversionAction(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IConversionAction|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateConversionActions', () => {
        it('invokes mutateConversionActions without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateConversionActionsResponse());
        ...
        it('invokes mutateConversionActions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionActions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateConversionActionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
