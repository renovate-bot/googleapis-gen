...
import * as campaignexperimentserviceModule from '../src';
...
describe('v7.CampaignExperimentServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignexperimentserviceModule.v7.CampaignExperimentServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignexperimentserviceModule.v7.CampaignExperimentServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignexperimentserviceModule.v7.CampaignExperimentServiceClient.port;
        assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.campaignExperimentServiceStub);
    });
    ...
    describe('getCampaignExperiment', () => {
        it('invokes getCampaignExperiment without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CampaignExperiment());
            client.innerApiCalls.getCampaignExperiment = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignExperiment(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignExperiment as SinonStub)
        ...
        it('invokes getCampaignExperiment without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CampaignExperiment());
            client.innerApiCalls.getCampaignExperiment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignExperiment(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICampaignExperiment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignExperiment with error', async () => {
            ...
            client.innerApiCalls.getCampaignExperiment = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignExperiment(request), expectedError);
            assert((client.innerApiCalls.getCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateCampaignExperiments', () => {
        it('invokes mutateCampaignExperiments without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignExperimentsResponse());
            client.innerApiCalls.mutateCampaignExperiments = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignExperiments(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaignExperiments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateCampaignExperiments without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignExperimentsResponse());
            client.innerApiCalls.mutateCampaignExperiments = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignExperiments(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCampaignExperimentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignExperiments with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCampaignExperiments = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignExperiments(request), expectedError);
            assert((client.innerApiCalls.mutateCampaignExperiments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('graduateCampaignExperiment', () => {
        it('invokes graduateCampaignExperiment without error', async () => {
            ...
            const expectedHeaderRequestParams = "campaign_experiment=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.GraduateCampaignExperimentResponse());
            client.innerApiCalls.graduateCampaignExperiment = stubSimpleCall(expectedResponse);
            const [response] = await client.graduateCampaignExperiment(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.graduateCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes graduateCampaignExperiment without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.GraduateCampaignExperimentResponse());
            client.innerApiCalls.graduateCampaignExperiment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.graduateCampaignExperiment(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IGraduateCampaignExperimentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes graduateCampaignExperiment with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.graduateCampaignExperiment = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.graduateCampaignExperiment(request), expectedError);
            assert((client.innerApiCalls.graduateCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('endCampaignExperiment', () => {
        it('invokes endCampaignExperiment without error', async () => {
            ...
            client.innerApiCalls.endCampaignExperiment = stubSimpleCall(expectedResponse);
            const [response] = await client.endCampaignExperiment(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.endCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes endCampaignExperiment without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.innerApiCalls.endCampaignExperiment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.endCampaignExperiment(
                    request,
        ...
        it('invokes endCampaignExperiment with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.endCampaignExperiment = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.endCampaignExperiment(request), expectedError);
            assert((client.innerApiCalls.endCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createCampaignExperiment', () => {
        it('invokes createCampaignExperiment without error', async () => {
            ...
            client.innerApiCalls.createCampaignExperiment = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createCampaignExperiment(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createCampaignExperiment without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.createCampaignExperiment = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCampaignExperiment(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v7.services.ICreateCampaignExperimentMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v7.services.ICreateCampaignExperimentMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes createCampaignExperiment with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createCampaignExperiment = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createCampaignExperiment(request), expectedError);
            assert((client.innerApiCalls.createCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createCampaignExperiment with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createCampaignExperiment = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createCampaignExperiment(request);
        ...
        it('invokes checkCreateCampaignExperimentProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateCampaignExperimentProgress(expectedResponse.name);
        ...
        it('invokes checkCreateCampaignExperimentProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateCampaignExperimentProgress(''), expectedError);
    ...
    describe('promoteCampaignExperiment', () => {
        it('invokes promoteCampaignExperiment without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.promoteCampaignExperiment = stubLongRunningCall(expectedResponse);
            const [operation] = await client.promoteCampaignExperiment(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.promoteCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes promoteCampaignExperiment without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.promoteCampaignExperiment = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.promoteCampaignExperiment(
                    request,
                    (err?: Error|null,
        ...
        it('invokes promoteCampaignExperiment with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.promoteCampaignExperiment = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.promoteCampaignExperiment(request), expectedError);
            assert((client.innerApiCalls.promoteCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes promoteCampaignExperiment with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.promoteCampaignExperiment = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.promoteCampaignExperiment(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.promoteCampaignExperiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkPromoteCampaignExperimentProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkPromoteCampaignExperimentProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkPromoteCampaignExperimentProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkPromoteCampaignExperimentProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listCampaignExperimentAsyncErrors', () => {
        it('invokes listCampaignExperimentAsyncErrors without error', async () => {
            const client = new campaignexperimentserviceModule.v7.CampaignExperimentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listCampaignExperimentAsyncErrors = stubSimpleCall(expectedResponse);
            const [response] = await client.listCampaignExperimentAsyncErrors(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listCampaignExperimentAsyncErrors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listCampaignExperimentAsyncErrors without error using callback', async () => {
            const client = new campaignexperimentserviceModule.v7.CampaignExperimentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listCampaignExperimentAsyncErrors = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listCampaignExperimentAsyncErrors(
                    request,
        ...
        it('invokes listCampaignExperimentAsyncErrors with error', async () => {
            const client = new campaignexperimentserviceModule.v7.CampaignExperimentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listCampaignExperimentAsyncErrors = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listCampaignExperimentAsyncErrors(request), expectedError);
            assert((client.innerApiCalls.listCampaignExperimentAsyncErrors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listCampaignExperimentAsyncErrorsStream without error', async () => {
            const client = new campaignexperimentserviceModule.v7.CampaignExperimentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listCampaignExperimentAsyncErrors.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCampaignExperimentAsyncErrorsStream(request);
            const promise = new Promise((resolve, reject) => {
            ...
            assert((client.descriptors.page.listCampaignExperimentAsyncErrors.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCampaignExperimentAsyncErrors, request));
            assert.strictEqual(
                (client.descriptors.page.listCampaignExperimentAsyncErrors.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });

        it('invokes listCampaignExperimentAsyncErrorsStream with error', async () => {
            const client = new campaignexperimentserviceModule.v7.CampaignExperimentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = "resource_name=";
            const expectedError = new Error('expected');
            client.descriptors.page.listCampaignExperimentAsyncErrors.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCampaignExperimentAsyncErrorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.rpc.Status[] = [];
                stream.on('data', (response: protos.google.rpc.Status) => {
        ...
        it('uses async iteration with listCampaignExperimentAsyncErrors without error', async () => {
            ...
            client.descriptors.page.listCampaignExperimentAsyncErrors.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listCampaignExperimentAsyncErrors.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listCampaignExperimentAsyncErrors with error', async () => {
            const client = new campaignexperimentserviceModule.v7.CampaignExperimentServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listCampaignExperimentAsyncErrors.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCampaignExperimentAsyncErrorsAsync(request);
