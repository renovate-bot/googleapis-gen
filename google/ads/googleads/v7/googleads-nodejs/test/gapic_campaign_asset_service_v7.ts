...
describe('v7.CampaignAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignassetserviceModule.v7.CampaignAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignassetserviceModule.v7.CampaignAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignassetserviceModule.v7.CampaignAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignassetserviceModule.v7.CampaignAssetServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignAsset', () => {
        it('invokes getCampaignAsset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCampaignAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CampaignAsset());
        ...
        it('invokes getCampaignAsset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICampaignAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignAssets', () => {
        it('invokes mutateCampaignAssets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignAssetsResponse());
        ...
        it('invokes mutateCampaignAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCampaignAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
