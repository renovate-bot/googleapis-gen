...
describe('v7.AccountBudgetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = accountbudgetserviceModule.v7.AccountBudgetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = accountbudgetserviceModule.v7.AccountBudgetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = accountbudgetserviceModule.v7.AccountBudgetServiceClient.port;
        assert(port);
    ...
    describe('getAccountBudget', () => {
        it('invokes getAccountBudget without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetAccountBudgetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.AccountBudget());
        ...
        it('invokes getAccountBudget without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAccountBudget(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IAccountBudget|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
