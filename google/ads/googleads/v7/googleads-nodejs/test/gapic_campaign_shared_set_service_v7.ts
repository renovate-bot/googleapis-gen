...
describe('v7.CampaignSharedSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignsharedsetserviceModule.v7.CampaignSharedSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignsharedsetserviceModule.v7.CampaignSharedSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignsharedsetserviceModule.v7.CampaignSharedSetServiceClient.port;
        assert(port);
    ...
    describe('getCampaignSharedSet', () => {
        it('invokes getCampaignSharedSet without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCampaignSharedSetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CampaignSharedSet());
        ...
        it('invokes getCampaignSharedSet without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignSharedSet(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICampaignSharedSet|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignSharedSets', () => {
        it('invokes mutateCampaignSharedSets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignSharedSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignSharedSetsResponse());
        ...
        it('invokes mutateCampaignSharedSets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignSharedSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCampaignSharedSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
