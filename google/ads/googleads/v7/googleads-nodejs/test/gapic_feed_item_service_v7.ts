...
import * as feeditemserviceModule from '../src';
...
describe('v7.FeedItemServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feeditemserviceModule.v7.FeedItemServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feeditemserviceModule.v7.FeedItemServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feeditemserviceModule.v7.FeedItemServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feeditemserviceModule.v7.FeedItemServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.feedItemServiceStub, undefined);
        await client.initialize();
        assert(client.feedItemServiceStub);
    });
    ...
    describe('getFeedItem', () => {
        it('invokes getFeedItem without error', async () => {
            const client = new feeditemserviceModule.v7.FeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetFeedItemRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.FeedItem());
            client.innerApiCalls.getFeedItem = stubSimpleCall(expectedResponse);
            const [response] = await client.getFeedItem(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getFeedItem as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getFeedItem without error using callback', async () => {
            const client = new feeditemserviceModule.v7.FeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.FeedItem());
            client.innerApiCalls.getFeedItem = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFeedItem(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IFeedItem|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFeedItem with error', async () => {
            const client = new feeditemserviceModule.v7.FeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getFeedItem = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getFeedItem(request), expectedError);
            assert((client.innerApiCalls.getFeedItem as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateFeedItems', () => {
        it('invokes mutateFeedItems without error', async () => {
            const client = new feeditemserviceModule.v7.FeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateFeedItemsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateFeedItemsResponse());
            client.innerApiCalls.mutateFeedItems = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateFeedItems(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateFeedItems as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateFeedItems without error using callback', async () => {
            const client = new feeditemserviceModule.v7.FeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateFeedItemsResponse());
            client.innerApiCalls.mutateFeedItems = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedItems(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateFeedItemsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateFeedItems with error', async () => {
            const client = new feeditemserviceModule.v7.FeedItemServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateFeedItems = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateFeedItems(request), expectedError);
            assert((client.innerApiCalls.mutateFeedItems as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
