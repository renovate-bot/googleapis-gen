...
describe('v7.FeedItemSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feeditemsetserviceModule.v7.FeedItemSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feeditemsetserviceModule.v7.FeedItemSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feeditemsetserviceModule.v7.FeedItemSetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feeditemsetserviceModule.v7.FeedItemSetServiceClient();
        assert(client);
    });
    ...
    describe('getFeedItemSet', () => {
        it('invokes getFeedItemSet without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetFeedItemSetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.FeedItemSet());
        ...
        it('invokes getFeedItemSet without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeedItemSet(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IFeedItemSet|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateFeedItemSets', () => {
        it('invokes mutateFeedItemSets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateFeedItemSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateFeedItemSetsResponse());
        ...
        it('invokes mutateFeedItemSets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedItemSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateFeedItemSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
