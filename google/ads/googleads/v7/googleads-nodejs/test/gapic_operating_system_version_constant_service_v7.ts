...
import * as operatingsystemversionconstantserviceModule from '../src';
...
describe('v7.OperatingSystemVersionConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = operatingsystemversionconstantserviceModule.v7.OperatingSystemVersionConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = operatingsystemversionconstantserviceModule.v7.OperatingSystemVersionConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = operatingsystemversionconstantserviceModule.v7.OperatingSystemVersionConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new operatingsystemversionconstantserviceModule.v7.OperatingSystemVersionConstantServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.operatingSystemVersionConstantServiceStub, undefined);
        await client.initialize();
        assert(client.operatingSystemVersionConstantServiceStub);
    });
    ...
    describe('getOperatingSystemVersionConstant', () => {
        it('invokes getOperatingSystemVersionConstant without error', async () => {
            const client = new operatingsystemversionconstantserviceModule.v7.OperatingSystemVersionConstantServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetOperatingSystemVersionConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.OperatingSystemVersionConstant());
            client.innerApiCalls.getOperatingSystemVersionConstant = stubSimpleCall(expectedResponse);
            const [response] = await client.getOperatingSystemVersionConstant(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getOperatingSystemVersionConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getOperatingSystemVersionConstant without error using callback', async () => {
            const client = new operatingsystemversionconstantserviceModule.v7.OperatingSystemVersionConstantServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.OperatingSystemVersionConstant());
            client.innerApiCalls.getOperatingSystemVersionConstant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getOperatingSystemVersionConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IOperatingSystemVersionConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getOperatingSystemVersionConstant with error', async () => {
            const client = new operatingsystemversionconstantserviceModule.v7.OperatingSystemVersionConstantServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getOperatingSystemVersionConstant = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getOperatingSystemVersionConstant(request), expectedError);
            assert((client.innerApiCalls.getOperatingSystemVersionConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
