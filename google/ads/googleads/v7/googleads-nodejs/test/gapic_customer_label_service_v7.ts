...
describe('v7.CustomerLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerlabelserviceModule.v7.CustomerLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerlabelserviceModule.v7.CustomerLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerlabelserviceModule.v7.CustomerLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerlabelserviceModule.v7.CustomerLabelServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerLabel', () => {
        it('invokes getCustomerLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCustomerLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomerLabel());
        ...
        it('invokes getCustomerLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICustomerLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerLabels', () => {
        it('invokes mutateCustomerLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerLabelsResponse());
        ...
        it('invokes mutateCustomerLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCustomerLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
