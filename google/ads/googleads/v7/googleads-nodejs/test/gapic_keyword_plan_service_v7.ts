...
describe('v7.KeywordPlanServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanserviceModule.v7.KeywordPlanServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanserviceModule.v7.KeywordPlanServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanserviceModule.v7.KeywordPlanServiceClient.port;
        assert(port);
    ...
    describe('getKeywordPlan', () => {
        it('invokes getKeywordPlan without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.KeywordPlan());
        ...
        it('invokes getKeywordPlan without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlan(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IKeywordPlan|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateKeywordPlans', () => {
        it('invokes mutateKeywordPlans without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateKeywordPlansResponse());
        ...
        it('invokes mutateKeywordPlans without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlans(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateKeywordPlansResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateForecastCurve', () => {
        it('invokes generateForecastCurve without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateForecastCurveResponse());
        ...
        it('invokes generateForecastCurve without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateForecastCurve(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IGenerateForecastCurveResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateForecastTimeSeries', () => {
        it('invokes generateForecastTimeSeries without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateForecastTimeSeriesResponse());
        ...
        it('invokes generateForecastTimeSeries without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateForecastTimeSeries(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IGenerateForecastTimeSeriesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateForecastMetrics', () => {
        it('invokes generateForecastMetrics without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateForecastMetricsResponse());
        ...
        it('invokes generateForecastMetrics without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateForecastMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IGenerateForecastMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateHistoricalMetrics', () => {
        it('invokes generateHistoricalMetrics without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateHistoricalMetricsResponse());
        ...
        it('invokes generateHistoricalMetrics without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateHistoricalMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IGenerateHistoricalMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
