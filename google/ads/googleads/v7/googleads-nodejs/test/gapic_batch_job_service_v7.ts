...
describe('v7.BatchJobServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = batchjobserviceModule.v7.BatchJobServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = batchjobserviceModule.v7.BatchJobServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = batchjobserviceModule.v7.BatchJobServiceClient.port;
        assert(port);
    ...
    describe('mutateBatchJob', () => {
        it('invokes mutateBatchJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateBatchJobResponse());
        ...
        it('invokes mutateBatchJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBatchJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateBatchJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBatchJob', () => {
        it('invokes getBatchJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.BatchJob());
        ...
        it('invokes getBatchJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBatchJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IBatchJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('addBatchJobOperations', () => {
        it('invokes addBatchJobOperations without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.AddBatchJobOperationsResponse());
        ...
        it('invokes addBatchJobOperations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addBatchJobOperations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IAddBatchJobOperationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes runBatchJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runBatchJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v7.resources.BatchJob.IBatchJobMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.ads.googleads.v7.resources.BatchJob.IBatchJobMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runBatchJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('listBatchJobResults', () => {
        ...
        it('invokes listBatchJobResults without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listBatchJobResults(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IBatchJobResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listBatchJobResultsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v7.services.BatchJobResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v7.services.BatchJobResult) => {
        ...
        it('uses async iteration with listBatchJobResults without error', async () => {
            ...
            const responses: protos.google.ads.googleads.v7.services.IBatchJobResult[] = [];
