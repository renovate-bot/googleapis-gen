...
describe('v7.GroupPlacementViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = groupplacementviewserviceModule.v7.GroupPlacementViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = groupplacementviewserviceModule.v7.GroupPlacementViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = groupplacementviewserviceModule.v7.GroupPlacementViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new groupplacementviewserviceModule.v7.GroupPlacementViewServiceClient();
        assert(client);
    });
    ...
    describe('getGroupPlacementView', () => {
        it('invokes getGroupPlacementView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetGroupPlacementViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.GroupPlacementView());
        ...
        it('invokes getGroupPlacementView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGroupPlacementView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IGroupPlacementView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
