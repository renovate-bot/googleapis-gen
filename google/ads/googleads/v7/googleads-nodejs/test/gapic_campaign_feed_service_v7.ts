...
describe('v7.CampaignFeedServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignfeedserviceModule.v7.CampaignFeedServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignfeedserviceModule.v7.CampaignFeedServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignfeedserviceModule.v7.CampaignFeedServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignfeedserviceModule.v7.CampaignFeedServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignFeed', () => {
        it('invokes getCampaignFeed without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCampaignFeedRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CampaignFeed());
        ...
        it('invokes getCampaignFeed without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignFeed(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICampaignFeed|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignFeeds', () => {
        it('invokes mutateCampaignFeeds without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignFeedsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignFeedsResponse());
        ...
        it('invokes mutateCampaignFeeds without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignFeeds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCampaignFeedsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
