...
import * as managedplacementviewserviceModule from '../src';
...
describe('v7.ManagedPlacementViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = managedplacementviewserviceModule.v7.ManagedPlacementViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = managedplacementviewserviceModule.v7.ManagedPlacementViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = managedplacementviewserviceModule.v7.ManagedPlacementViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new managedplacementviewserviceModule.v7.ManagedPlacementViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.managedPlacementViewServiceStub, undefined);
        await client.initialize();
        assert(client.managedPlacementViewServiceStub);
    });
    ...
    describe('getManagedPlacementView', () => {
        it('invokes getManagedPlacementView without error', async () => {
            const client = new managedplacementviewserviceModule.v7.ManagedPlacementViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetManagedPlacementViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.ManagedPlacementView());
            client.innerApiCalls.getManagedPlacementView = stubSimpleCall(expectedResponse);
            const [response] = await client.getManagedPlacementView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getManagedPlacementView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getManagedPlacementView without error using callback', async () => {
            const client = new managedplacementviewserviceModule.v7.ManagedPlacementViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.ManagedPlacementView());
            client.innerApiCalls.getManagedPlacementView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getManagedPlacementView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IManagedPlacementView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getManagedPlacementView with error', async () => {
            const client = new managedplacementviewserviceModule.v7.ManagedPlacementViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getManagedPlacementView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getManagedPlacementView(request), expectedError);
            assert((client.innerApiCalls.getManagedPlacementView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
