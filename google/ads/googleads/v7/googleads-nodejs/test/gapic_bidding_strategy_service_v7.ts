...
import * as biddingstrategyserviceModule from '../src';
...
describe('v7.BiddingStrategyServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = biddingstrategyserviceModule.v7.BiddingStrategyServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = biddingstrategyserviceModule.v7.BiddingStrategyServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = biddingstrategyserviceModule.v7.BiddingStrategyServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new biddingstrategyserviceModule.v7.BiddingStrategyServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.biddingStrategyServiceStub, undefined);
        await client.initialize();
        assert(client.biddingStrategyServiceStub);
    });
    ...
    describe('getBiddingStrategy', () => {
        it('invokes getBiddingStrategy without error', async () => {
            const client = new biddingstrategyserviceModule.v7.BiddingStrategyServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetBiddingStrategyRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.BiddingStrategy());
            client.innerApiCalls.getBiddingStrategy = stubSimpleCall(expectedResponse);
            const [response] = await client.getBiddingStrategy(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getBiddingStrategy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getBiddingStrategy without error using callback', async () => {
            const client = new biddingstrategyserviceModule.v7.BiddingStrategyServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.BiddingStrategy());
            client.innerApiCalls.getBiddingStrategy = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBiddingStrategy(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IBiddingStrategy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBiddingStrategy with error', async () => {
            const client = new biddingstrategyserviceModule.v7.BiddingStrategyServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getBiddingStrategy = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getBiddingStrategy(request), expectedError);
            assert((client.innerApiCalls.getBiddingStrategy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateBiddingStrategies', () => {
        it('invokes mutateBiddingStrategies without error', async () => {
            const client = new biddingstrategyserviceModule.v7.BiddingStrategyServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateBiddingStrategiesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateBiddingStrategiesResponse());
            client.innerApiCalls.mutateBiddingStrategies = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateBiddingStrategies(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateBiddingStrategies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateBiddingStrategies without error using callback', async () => {
            const client = new biddingstrategyserviceModule.v7.BiddingStrategyServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateBiddingStrategiesResponse());
            client.innerApiCalls.mutateBiddingStrategies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateBiddingStrategies(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateBiddingStrategiesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateBiddingStrategies with error', async () => {
            const client = new biddingstrategyserviceModule.v7.BiddingStrategyServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateBiddingStrategies = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateBiddingStrategies(request), expectedError);
            assert((client.innerApiCalls.mutateBiddingStrategies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
