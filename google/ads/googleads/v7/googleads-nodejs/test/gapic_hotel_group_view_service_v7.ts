...
describe('v7.HotelGroupViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = hotelgroupviewserviceModule.v7.HotelGroupViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = hotelgroupviewserviceModule.v7.HotelGroupViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = hotelgroupviewserviceModule.v7.HotelGroupViewServiceClient.port;
        assert(port);
    ...
    describe('getHotelGroupView', () => {
        it('invokes getHotelGroupView without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.HotelGroupView());
        ...
        it('invokes getHotelGroupView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getHotelGroupView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IHotelGroupView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
