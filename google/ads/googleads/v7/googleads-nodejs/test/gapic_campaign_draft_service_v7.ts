...
describe('v7.CampaignDraftServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaigndraftserviceModule.v7.CampaignDraftServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaigndraftserviceModule.v7.CampaignDraftServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaigndraftserviceModule.v7.CampaignDraftServiceClient.port;
        assert(port);
    ...
    describe('getCampaignDraft', () => {
        it('invokes getCampaignDraft without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CampaignDraft());
        ...
        it('invokes getCampaignDraft without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignDraft(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICampaignDraft|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignDrafts', () => {
        it('invokes mutateCampaignDrafts without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignDraftsResponse());
        ...
        it('invokes mutateCampaignDrafts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignDrafts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCampaignDraftsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
