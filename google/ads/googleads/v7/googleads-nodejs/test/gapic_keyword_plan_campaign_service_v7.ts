...
describe('v7.KeywordPlanCampaignServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplancampaignserviceModule.v7.KeywordPlanCampaignServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplancampaignserviceModule.v7.KeywordPlanCampaignServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplancampaignserviceModule.v7.KeywordPlanCampaignServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplancampaignserviceModule.v7.KeywordPlanCampaignServiceClient();
        assert(client);
    });
    ...
    describe('getKeywordPlanCampaign', () => {
        it('invokes getKeywordPlanCampaign without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetKeywordPlanCampaignRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.KeywordPlanCampaign());
        ...
        it('invokes getKeywordPlanCampaign without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanCampaign(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IKeywordPlanCampaign|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateKeywordPlanCampaigns', () => {
        it('invokes mutateKeywordPlanCampaigns without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateKeywordPlanCampaignsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateKeywordPlanCampaignsResponse());
        ...
        it('invokes mutateKeywordPlanCampaigns without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanCampaigns(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateKeywordPlanCampaignsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
