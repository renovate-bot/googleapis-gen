...
describe('v7.MobileDeviceConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = mobiledeviceconstantserviceModule.v7.MobileDeviceConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = mobiledeviceconstantserviceModule.v7.MobileDeviceConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = mobiledeviceconstantserviceModule.v7.MobileDeviceConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new mobiledeviceconstantserviceModule.v7.MobileDeviceConstantServiceClient();
        assert(client);
    });
    ...
    describe('getMobileDeviceConstant', () => {
        it('invokes getMobileDeviceConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetMobileDeviceConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.MobileDeviceConstant());
        ...
        it('invokes getMobileDeviceConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMobileDeviceConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IMobileDeviceConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
