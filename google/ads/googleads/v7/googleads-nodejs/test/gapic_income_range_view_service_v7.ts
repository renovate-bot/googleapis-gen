...
describe('v7.IncomeRangeViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = incomerangeviewserviceModule.v7.IncomeRangeViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = incomerangeviewserviceModule.v7.IncomeRangeViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = incomerangeviewserviceModule.v7.IncomeRangeViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new incomerangeviewserviceModule.v7.IncomeRangeViewServiceClient();
        assert(client);
    });
    ...
    describe('getIncomeRangeView', () => {
        it('invokes getIncomeRangeView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetIncomeRangeViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.IncomeRangeView());
        ...
        it('invokes getIncomeRangeView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getIncomeRangeView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IIncomeRangeView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
