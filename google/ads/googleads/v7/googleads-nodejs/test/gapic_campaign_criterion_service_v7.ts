...
describe('v7.CampaignCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaigncriterionserviceModule.v7.CampaignCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaigncriterionserviceModule.v7.CampaignCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaigncriterionserviceModule.v7.CampaignCriterionServiceClient.port;
        assert(port);
    ...
    describe('getCampaignCriterion', () => {
        it('invokes getCampaignCriterion without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CampaignCriterion());
        ...
        it('invokes getCampaignCriterion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICampaignCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignCriteria', () => {
        it('invokes mutateCampaignCriteria without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignCriteriaResponse());
        ...
        it('invokes mutateCampaignCriteria without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCampaignCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
