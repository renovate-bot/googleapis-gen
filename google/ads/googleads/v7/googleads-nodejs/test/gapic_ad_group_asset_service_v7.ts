...
describe('v7.AdGroupAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupassetserviceModule.v7.AdGroupAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupassetserviceModule.v7.AdGroupAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupassetserviceModule.v7.AdGroupAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupassetserviceModule.v7.AdGroupAssetServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupAsset', () => {
        it('invokes getAdGroupAsset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetAdGroupAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.AdGroupAsset());
        ...
        it('invokes getAdGroupAsset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IAdGroupAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupAssets', () => {
        it('invokes mutateAdGroupAssets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateAdGroupAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateAdGroupAssetsResponse());
        ...
        it('invokes mutateAdGroupAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateAdGroupAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
