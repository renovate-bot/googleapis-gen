...
describe('v7.RemarketingActionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = remarketingactionserviceModule.v7.RemarketingActionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = remarketingactionserviceModule.v7.RemarketingActionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = remarketingactionserviceModule.v7.RemarketingActionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new remarketingactionserviceModule.v7.RemarketingActionServiceClient();
        assert(client);
    });
    ...
    describe('getRemarketingAction', () => {
        it('invokes getRemarketingAction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetRemarketingActionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.RemarketingAction());
        ...
        it('invokes getRemarketingAction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRemarketingAction(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IRemarketingAction|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateRemarketingActions', () => {
        it('invokes mutateRemarketingActions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateRemarketingActionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateRemarketingActionsResponse());
        ...
        it('invokes mutateRemarketingActions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateRemarketingActions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateRemarketingActionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
