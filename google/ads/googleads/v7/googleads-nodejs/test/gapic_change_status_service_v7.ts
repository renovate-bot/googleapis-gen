...
describe('v7.ChangeStatusServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = changestatusserviceModule.v7.ChangeStatusServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = changestatusserviceModule.v7.ChangeStatusServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = changestatusserviceModule.v7.ChangeStatusServiceClient.port;
        assert(port);
    ...
    describe('getChangeStatus', () => {
        it('invokes getChangeStatus without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetChangeStatusRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.ChangeStatus());
        ...
        it('invokes getChangeStatus without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getChangeStatus(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IChangeStatus|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
