...
describe('v7.CustomerExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerextensionsettingserviceModule.v7.CustomerExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerextensionsettingserviceModule.v7.CustomerExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerextensionsettingserviceModule.v7.CustomerExtensionSettingServiceClient.port;
        assert(port);
    ...
    describe('getCustomerExtensionSetting', () => {
        it('invokes getCustomerExtensionSetting without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCustomerExtensionSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomerExtensionSetting());
        ...
        it('invokes getCustomerExtensionSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICustomerExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerExtensionSettings', () => {
        it('invokes mutateCustomerExtensionSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerExtensionSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerExtensionSettingsResponse());
        ...
        it('invokes mutateCustomerExtensionSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCustomerExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
