...
describe('v7.LifeEventServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = lifeeventserviceModule.v7.LifeEventServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = lifeeventserviceModule.v7.LifeEventServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = lifeeventserviceModule.v7.LifeEventServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new lifeeventserviceModule.v7.LifeEventServiceClient();
        assert(client);
    });
    ...
    describe('getLifeEvent', () => {
        it('invokes getLifeEvent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetLifeEventRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.LifeEvent());
        ...
        it('invokes getLifeEvent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLifeEvent(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ILifeEvent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
