...
describe('v7.CustomerNegativeCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customernegativecriterionserviceModule.v7.CustomerNegativeCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customernegativecriterionserviceModule.v7.CustomerNegativeCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customernegativecriterionserviceModule.v7.CustomerNegativeCriterionServiceClient.port;
        assert(port);
    ...
    describe('getCustomerNegativeCriterion', () => {
        it('invokes getCustomerNegativeCriterion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCustomerNegativeCriterionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomerNegativeCriterion());
        ...
        it('invokes getCustomerNegativeCriterion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerNegativeCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICustomerNegativeCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerNegativeCriteria', () => {
        it('invokes mutateCustomerNegativeCriteria without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerNegativeCriteriaResponse());
        ...
        it('invokes mutateCustomerNegativeCriteria without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerNegativeCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCustomerNegativeCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
