...
describe('v7.AdGroupCriterionSimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupcriterionsimulationserviceModule.v7.AdGroupCriterionSimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupcriterionsimulationserviceModule.v7.AdGroupCriterionSimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupcriterionsimulationserviceModule.v7.AdGroupCriterionSimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupcriterionsimulationserviceModule.v7.AdGroupCriterionSimulationServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupCriterionSimulation', () => {
        it('invokes getAdGroupCriterionSimulation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetAdGroupCriterionSimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.AdGroupCriterionSimulation());
        ...
        it('invokes getAdGroupCriterionSimulation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupCriterionSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IAdGroupCriterionSimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
