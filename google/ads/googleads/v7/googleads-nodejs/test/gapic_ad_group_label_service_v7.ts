...
describe('v7.AdGroupLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgrouplabelserviceModule.v7.AdGroupLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgrouplabelserviceModule.v7.AdGroupLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgrouplabelserviceModule.v7.AdGroupLabelServiceClient.port;
        assert(port);
    ...
    describe('getAdGroupLabel', () => {
        it('invokes getAdGroupLabel without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.AdGroupLabel());
        ...
        it('invokes getAdGroupLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IAdGroupLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupLabels', () => {
        it('invokes mutateAdGroupLabels without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateAdGroupLabelsResponse());
        ...
        it('invokes mutateAdGroupLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateAdGroupLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
