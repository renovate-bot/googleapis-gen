...
describe('v7.PaidOrganicSearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = paidorganicsearchtermviewserviceModule.v7.PaidOrganicSearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = paidorganicsearchtermviewserviceModule.v7.PaidOrganicSearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = paidorganicsearchtermviewserviceModule.v7.PaidOrganicSearchTermViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new paidorganicsearchtermviewserviceModule.v7.PaidOrganicSearchTermViewServiceClient();
        assert(client);
    });
    ...
    describe('getPaidOrganicSearchTermView', () => {
        it('invokes getPaidOrganicSearchTermView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetPaidOrganicSearchTermViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.PaidOrganicSearchTermView());
        ...
        it('invokes getPaidOrganicSearchTermView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPaidOrganicSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IPaidOrganicSearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
