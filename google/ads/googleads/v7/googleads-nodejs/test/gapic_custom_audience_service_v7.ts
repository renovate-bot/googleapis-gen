...
describe('v7.CustomAudienceServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customaudienceserviceModule.v7.CustomAudienceServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customaudienceserviceModule.v7.CustomAudienceServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customaudienceserviceModule.v7.CustomAudienceServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customaudienceserviceModule.v7.CustomAudienceServiceClient();
        assert(client);
    });
    ...
    describe('getCustomAudience', () => {
        it('invokes getCustomAudience without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCustomAudienceRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomAudience());
        ...
        it('invokes getCustomAudience without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomAudience(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICustomAudience|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomAudiences', () => {
        it('invokes mutateCustomAudiences without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomAudiencesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomAudiencesResponse());
        ...
        it('invokes mutateCustomAudiences without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomAudiences(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCustomAudiencesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
