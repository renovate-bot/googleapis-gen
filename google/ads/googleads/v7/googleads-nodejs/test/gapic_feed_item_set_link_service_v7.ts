...
describe('v7.FeedItemSetLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feeditemsetlinkserviceModule.v7.FeedItemSetLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feeditemsetlinkserviceModule.v7.FeedItemSetLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feeditemsetlinkserviceModule.v7.FeedItemSetLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feeditemsetlinkserviceModule.v7.FeedItemSetLinkServiceClient();
        assert(client);
    });
    ...
    describe('getFeedItemSetLink', () => {
        it('invokes getFeedItemSetLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetFeedItemSetLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.FeedItemSetLink());
        ...
        it('invokes getFeedItemSetLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeedItemSetLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IFeedItemSetLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateFeedItemSetLinks', () => {
        it('invokes mutateFeedItemSetLinks without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateFeedItemSetLinksRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateFeedItemSetLinksResponse());
        ...
        it('invokes mutateFeedItemSetLinks without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedItemSetLinks(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateFeedItemSetLinksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
