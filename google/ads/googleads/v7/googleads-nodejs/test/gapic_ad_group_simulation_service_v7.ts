...
describe('v7.AdGroupSimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupsimulationserviceModule.v7.AdGroupSimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupsimulationserviceModule.v7.AdGroupSimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupsimulationserviceModule.v7.AdGroupSimulationServiceClient.port;
        assert(port);
    ...
    describe('getAdGroupSimulation', () => {
        it('invokes getAdGroupSimulation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetAdGroupSimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.AdGroupSimulation());
        ...
        it('invokes getAdGroupSimulation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IAdGroupSimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
