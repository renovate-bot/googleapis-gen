...
describe('v7.AccountLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = accountlinkserviceModule.v7.AccountLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = accountlinkserviceModule.v7.AccountLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = accountlinkserviceModule.v7.AccountLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new accountlinkserviceModule.v7.AccountLinkServiceClient();
        assert(client);
    });
    ...
    describe('getAccountLink', () => {
        it('invokes getAccountLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetAccountLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.AccountLink());
        ...
        it('invokes getAccountLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAccountLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IAccountLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createAccountLink', () => {
        it('invokes createAccountLink without error', async () => {
            const client = new accountlinkserviceModule.v7.AccountLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.CreateAccountLinkRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.CreateAccountLinkResponse());
            client.innerApiCalls.createAccountLink = stubSimpleCall(expectedResponse);
            const [response] = await client.createAccountLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createAccountLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes createAccountLink without error using callback', async () => {
            const client = new accountlinkserviceModule.v7.AccountLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.CreateAccountLinkResponse());
            client.innerApiCalls.createAccountLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createAccountLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.ICreateAccountLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createAccountLink with error', async () => {
            const client = new accountlinkserviceModule.v7.AccountLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createAccountLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createAccountLink(request), expectedError);
            assert((client.innerApiCalls.createAccountLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateAccountLink', () => {
        it('invokes mutateAccountLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateAccountLinkRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateAccountLinkResponse());
        ...
        it('invokes mutateAccountLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAccountLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateAccountLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
