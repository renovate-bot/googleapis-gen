...
describe('v7.ShoppingPerformanceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = shoppingperformanceviewserviceModule.v7.ShoppingPerformanceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = shoppingperformanceviewserviceModule.v7.ShoppingPerformanceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = shoppingperformanceviewserviceModule.v7.ShoppingPerformanceViewServiceClient.port;
        assert(port);
    ...
    describe('getShoppingPerformanceView', () => {
        it('invokes getShoppingPerformanceView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetShoppingPerformanceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.ShoppingPerformanceView());
        ...
        it('invokes getShoppingPerformanceView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getShoppingPerformanceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IShoppingPerformanceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
