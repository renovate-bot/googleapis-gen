...
describe('v7.CombinedAudienceServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = combinedaudienceserviceModule.v7.CombinedAudienceServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = combinedaudienceserviceModule.v7.CombinedAudienceServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = combinedaudienceserviceModule.v7.CombinedAudienceServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new combinedaudienceserviceModule.v7.CombinedAudienceServiceClient();
        assert(client);
    });
    ...
    describe('getCombinedAudience', () => {
        it('invokes getCombinedAudience without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCombinedAudienceRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CombinedAudience());
        ...
        it('invokes getCombinedAudience without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCombinedAudience(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICombinedAudience|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
