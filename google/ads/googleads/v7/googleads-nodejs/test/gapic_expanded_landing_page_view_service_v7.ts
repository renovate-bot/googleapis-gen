...
describe('v7.ExpandedLandingPageViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = expandedlandingpageviewserviceModule.v7.ExpandedLandingPageViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = expandedlandingpageviewserviceModule.v7.ExpandedLandingPageViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = expandedlandingpageviewserviceModule.v7.ExpandedLandingPageViewServiceClient.port;
        assert(port);
    ...
    describe('getExpandedLandingPageView', () => {
        it('invokes getExpandedLandingPageView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetExpandedLandingPageViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.ExpandedLandingPageView());
        ...
        it('invokes getExpandedLandingPageView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getExpandedLandingPageView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IExpandedLandingPageView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
