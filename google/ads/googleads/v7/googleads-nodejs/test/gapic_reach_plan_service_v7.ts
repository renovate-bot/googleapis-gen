...
describe('v7.ReachPlanServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = reachplanserviceModule.v7.ReachPlanServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = reachplanserviceModule.v7.ReachPlanServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = reachplanserviceModule.v7.ReachPlanServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new reachplanserviceModule.v7.ReachPlanServiceClient();
        assert(client);
    });
    ...
    describe('listPlannableLocations', () => {
        it('invokes listPlannableLocations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.ListPlannableLocationsRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.ListPlannableLocationsResponse());
        ...
        it('invokes listPlannableLocations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableLocations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IListPlannableLocationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listPlannableProducts', () => {
        it('invokes listPlannableProducts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.ListPlannableProductsRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.ListPlannableProductsResponse());
        ...
        it('invokes listPlannableProducts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableProducts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IListPlannableProductsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateProductMixIdeas', () => {
        it('invokes generateProductMixIdeas without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateProductMixIdeasRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateProductMixIdeasResponse());
        ...
        it('invokes generateProductMixIdeas without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateProductMixIdeas(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IGenerateProductMixIdeasResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateReachForecast', () => {
        it('invokes generateReachForecast without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateReachForecastRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateReachForecastResponse());
        ...
        it('invokes generateReachForecast without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateReachForecast(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IGenerateReachForecastResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
