...
describe('v7.OfflineUserDataJobServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = offlineuserdatajobserviceModule.v7.OfflineUserDataJobServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = offlineuserdatajobserviceModule.v7.OfflineUserDataJobServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = offlineuserdatajobserviceModule.v7.OfflineUserDataJobServiceClient.port;
        assert(port);
    ...
    describe('createOfflineUserDataJob', () => {
        it('invokes createOfflineUserDataJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.CreateOfflineUserDataJobResponse());
        ...
        it('invokes createOfflineUserDataJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createOfflineUserDataJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.ICreateOfflineUserDataJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getOfflineUserDataJob', () => {
        it('invokes getOfflineUserDataJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.OfflineUserDataJob());
        ...
        it('invokes getOfflineUserDataJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getOfflineUserDataJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IOfflineUserDataJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('addOfflineUserDataJobOperations', () => {
        it('invokes addOfflineUserDataJobOperations without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.AddOfflineUserDataJobOperationsResponse());
        ...
        it('invokes addOfflineUserDataJobOperations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addOfflineUserDataJobOperations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IAddOfflineUserDataJobOperationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
