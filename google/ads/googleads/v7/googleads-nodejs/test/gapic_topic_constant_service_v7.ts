...
describe('v7.TopicConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = topicconstantserviceModule.v7.TopicConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = topicconstantserviceModule.v7.TopicConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = topicconstantserviceModule.v7.TopicConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new topicconstantserviceModule.v7.TopicConstantServiceClient();
        assert(client);
    });
    ...
    describe('getTopicConstant', () => {
        it('invokes getTopicConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetTopicConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.TopicConstant());
        ...
        it('invokes getTopicConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getTopicConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ITopicConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
