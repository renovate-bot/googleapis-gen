...
import * as customeruseraccessinvitationserviceModule from '../src';
...
describe('v7.CustomerUserAccessInvitationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customeruseraccessinvitationserviceModule.v7.CustomerUserAccessInvitationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customeruseraccessinvitationserviceModule.v7.CustomerUserAccessInvitationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customeruseraccessinvitationserviceModule.v7.CustomerUserAccessInvitationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customeruseraccessinvitationserviceModule.v7.CustomerUserAccessInvitationServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customerUserAccessInvitationServiceStub, undefined);
        await client.initialize();
        assert(client.customerUserAccessInvitationServiceStub);
    });
    ...
    describe('getCustomerUserAccessInvitation', () => {
        it('invokes getCustomerUserAccessInvitation without error', async () => {
            const client = new customeruseraccessinvitationserviceModule.v7.CustomerUserAccessInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCustomerUserAccessInvitationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomerUserAccessInvitation());
            client.innerApiCalls.getCustomerUserAccessInvitation = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomerUserAccessInvitation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomerUserAccessInvitation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCustomerUserAccessInvitation without error using callback', async () => {
            const client = new customeruseraccessinvitationserviceModule.v7.CustomerUserAccessInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomerUserAccessInvitation());
            client.innerApiCalls.getCustomerUserAccessInvitation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerUserAccessInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICustomerUserAccessInvitation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomerUserAccessInvitation with error', async () => {
            const client = new customeruseraccessinvitationserviceModule.v7.CustomerUserAccessInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getCustomerUserAccessInvitation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomerUserAccessInvitation(request), expectedError);
            assert((client.innerApiCalls.getCustomerUserAccessInvitation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCustomerUserAccessInvitation', () => {
        it('invokes mutateCustomerUserAccessInvitation without error', async () => {
            const client = new customeruseraccessinvitationserviceModule.v7.CustomerUserAccessInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationResponse());
            client.innerApiCalls.mutateCustomerUserAccessInvitation = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomerUserAccessInvitation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomerUserAccessInvitation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomerUserAccessInvitation without error using callback', async () => {
            const client = new customeruseraccessinvitationserviceModule.v7.CustomerUserAccessInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationResponse());
            client.innerApiCalls.mutateCustomerUserAccessInvitation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerUserAccessInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCustomerUserAccessInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomerUserAccessInvitation with error', async () => {
            const client = new customeruseraccessinvitationserviceModule.v7.CustomerUserAccessInvitationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCustomerUserAccessInvitation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomerUserAccessInvitation(request), expectedError);
            assert((client.innerApiCalls.mutateCustomerUserAccessInvitation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
