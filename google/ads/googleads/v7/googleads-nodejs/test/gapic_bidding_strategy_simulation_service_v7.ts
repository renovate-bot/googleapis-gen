...
describe('v7.BiddingStrategySimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = biddingstrategysimulationserviceModule.v7.BiddingStrategySimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = biddingstrategysimulationserviceModule.v7.BiddingStrategySimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = biddingstrategysimulationserviceModule.v7.BiddingStrategySimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new biddingstrategysimulationserviceModule.v7.BiddingStrategySimulationServiceClient();
        assert(client);
    });
    ...
    describe('getBiddingStrategySimulation', () => {
        it('invokes getBiddingStrategySimulation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetBiddingStrategySimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.BiddingStrategySimulation());
        ...
        it('invokes getBiddingStrategySimulation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBiddingStrategySimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IBiddingStrategySimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
