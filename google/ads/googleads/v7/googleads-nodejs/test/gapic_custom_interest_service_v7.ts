...
describe('v7.CustomInterestServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = custominterestserviceModule.v7.CustomInterestServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = custominterestserviceModule.v7.CustomInterestServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = custominterestserviceModule.v7.CustomInterestServiceClient.port;
        assert(port);
    ...
    describe('getCustomInterest', () => {
        it('invokes getCustomInterest without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomInterest());
        ...
        it('invokes getCustomInterest without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomInterest(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICustomInterest|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomInterests', () => {
        it('invokes mutateCustomInterests without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomInterestsResponse());
        ...
        it('invokes mutateCustomInterests without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomInterests(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCustomInterestsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
