...
describe('v7.ConversionAdjustmentUploadServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionadjustmentuploadserviceModule.v7.ConversionAdjustmentUploadServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionadjustmentuploadserviceModule.v7.ConversionAdjustmentUploadServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionadjustmentuploadserviceModule.v7.ConversionAdjustmentUploadServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionadjustmentuploadserviceModule.v7.ConversionAdjustmentUploadServiceClient();
        assert(client);
    });
    ...
    describe('uploadConversionAdjustments', () => {
        it('invokes uploadConversionAdjustments without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.UploadConversionAdjustmentsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.UploadConversionAdjustmentsResponse());
        ...
        it('invokes uploadConversionAdjustments without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.uploadConversionAdjustments(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IUploadConversionAdjustmentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
