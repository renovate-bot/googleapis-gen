...
describe('v7.KeywordPlanIdeaServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanideaserviceModule.v7.KeywordPlanIdeaServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanideaserviceModule.v7.KeywordPlanIdeaServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanideaserviceModule.v7.KeywordPlanIdeaServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplanideaserviceModule.v7.KeywordPlanIdeaServiceClient();
        assert(client);
    });
    ...
    describe('generateKeywordIdeas', () => {
        it('invokes generateKeywordIdeas without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateKeywordIdeasRequest());
            request.customerId = '';
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateKeywordIdeaResult()),
              generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateKeywordIdeaResult()),
              generateSampleMessage(new protos.google.ads.googleads.v7.services.GenerateKeywordIdeaResult()),
            ];
        ...
        it('invokes generateKeywordIdeas without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateKeywordIdeas(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IGenerateKeywordIdeaResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateKeywordIdeasStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v7.services.GenerateKeywordIdeaResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v7.services.GenerateKeywordIdeaResult) => {
        ...
        it('uses async iteration with generateKeywordIdeas without error', async () => {
            ...
            const responses: protos.google.ads.googleads.v7.services.IGenerateKeywordIdeaResult[] = [];
