...
describe('v7.AdGroupAudienceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupaudienceviewserviceModule.v7.AdGroupAudienceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupaudienceviewserviceModule.v7.AdGroupAudienceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupaudienceviewserviceModule.v7.AdGroupAudienceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupaudienceviewserviceModule.v7.AdGroupAudienceViewServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupAudienceView', () => {
        it('invokes getAdGroupAudienceView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetAdGroupAudienceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.AdGroupAudienceView());
        ...
        it('invokes getAdGroupAudienceView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAudienceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IAdGroupAudienceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
