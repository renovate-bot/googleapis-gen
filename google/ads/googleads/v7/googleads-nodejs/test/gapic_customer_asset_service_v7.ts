...
describe('v7.CustomerAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerassetserviceModule.v7.CustomerAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerassetserviceModule.v7.CustomerAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerassetserviceModule.v7.CustomerAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerassetserviceModule.v7.CustomerAssetServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerAsset', () => {
        it('invokes getCustomerAsset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCustomerAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomerAsset());
        ...
        it('invokes getCustomerAsset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICustomerAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerAssets', () => {
        it('invokes mutateCustomerAssets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerAssetsResponse());
        ...
        it('invokes mutateCustomerAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCustomerAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
