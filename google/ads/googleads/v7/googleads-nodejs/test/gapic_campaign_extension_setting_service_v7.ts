...
describe('v7.CampaignExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignextensionsettingserviceModule.v7.CampaignExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignextensionsettingserviceModule.v7.CampaignExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignextensionsettingserviceModule.v7.CampaignExtensionSettingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignextensionsettingserviceModule.v7.CampaignExtensionSettingServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignExtensionSetting', () => {
        it('invokes getCampaignExtensionSetting without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCampaignExtensionSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CampaignExtensionSetting());
        ...
        it('invokes getCampaignExtensionSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICampaignExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignExtensionSettings', () => {
        it('invokes mutateCampaignExtensionSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignExtensionSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCampaignExtensionSettingsResponse());
        ...
        it('invokes mutateCampaignExtensionSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCampaignExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
