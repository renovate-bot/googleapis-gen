...
describe('v7.AgeRangeViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = agerangeviewserviceModule.v7.AgeRangeViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = agerangeviewserviceModule.v7.AgeRangeViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = agerangeviewserviceModule.v7.AgeRangeViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new agerangeviewserviceModule.v7.AgeRangeViewServiceClient();
        assert(client);
    });
    ...
    describe('getAgeRangeView', () => {
        it('invokes getAgeRangeView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetAgeRangeViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.AgeRangeView());
        ...
        it('invokes getAgeRangeView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAgeRangeView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IAgeRangeView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
