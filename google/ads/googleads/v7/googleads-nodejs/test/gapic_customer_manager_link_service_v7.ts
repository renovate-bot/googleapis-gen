...
import * as customermanagerlinkserviceModule from '../src';
...
describe('v7.CustomerManagerLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customerManagerLinkServiceStub, undefined);
        await client.initialize();
        assert(client.customerManagerLinkServiceStub);
    });
    ...
    describe('getCustomerManagerLink', () => {
        it('invokes getCustomerManagerLink without error', async () => {
            const client = new customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetCustomerManagerLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomerManagerLink());
            client.innerApiCalls.getCustomerManagerLink = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomerManagerLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomerManagerLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCustomerManagerLink without error using callback', async () => {
            const client = new customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.CustomerManagerLink());
            client.innerApiCalls.getCustomerManagerLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ICustomerManagerLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomerManagerLink with error', async () => {
            const client = new customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getCustomerManagerLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomerManagerLink(request), expectedError);
            assert((client.innerApiCalls.getCustomerManagerLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCustomerManagerLink', () => {
        it('invokes mutateCustomerManagerLink without error', async () => {
            const client = new customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerManagerLinkRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerManagerLinkResponse());
            client.innerApiCalls.mutateCustomerManagerLink = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomerManagerLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomerManagerLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomerManagerLink without error using callback', async () => {
            const client = new customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateCustomerManagerLinkResponse());
            client.innerApiCalls.mutateCustomerManagerLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateCustomerManagerLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomerManagerLink with error', async () => {
            const client = new customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCustomerManagerLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomerManagerLink(request), expectedError);
            assert((client.innerApiCalls.mutateCustomerManagerLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('moveManagerLink', () => {
        it('invokes moveManagerLink without error', async () => {
            const client = new customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MoveManagerLinkRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MoveManagerLinkResponse());
            client.innerApiCalls.moveManagerLink = stubSimpleCall(expectedResponse);
            const [response] = await client.moveManagerLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.moveManagerLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes moveManagerLink without error using callback', async () => {
            const client = new customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MoveManagerLinkResponse());
            client.innerApiCalls.moveManagerLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.moveManagerLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMoveManagerLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes moveManagerLink with error', async () => {
            const client = new customermanagerlinkserviceModule.v7.CustomerManagerLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.moveManagerLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.moveManagerLink(request), expectedError);
            assert((client.innerApiCalls.moveManagerLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
