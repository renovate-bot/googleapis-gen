...
describe('v7.SearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = searchtermviewserviceModule.v7.SearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = searchtermviewserviceModule.v7.SearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = searchtermviewserviceModule.v7.SearchTermViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new searchtermviewserviceModule.v7.SearchTermViewServiceClient();
        assert(client);
    });
    ...
    describe('getSearchTermView', () => {
        it('invokes getSearchTermView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetSearchTermViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.SearchTermView());
        ...
        it('invokes getSearchTermView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ISearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
