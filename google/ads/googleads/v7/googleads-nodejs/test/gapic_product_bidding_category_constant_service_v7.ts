...
describe('v7.ProductBiddingCategoryConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = productbiddingcategoryconstantserviceModule.v7.ProductBiddingCategoryConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = productbiddingcategoryconstantserviceModule.v7.ProductBiddingCategoryConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = productbiddingcategoryconstantserviceModule.v7.ProductBiddingCategoryConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new productbiddingcategoryconstantserviceModule.v7.ProductBiddingCategoryConstantServiceClient();
        assert(client);
    });
    ...
    describe('getProductBiddingCategoryConstant', () => {
        it('invokes getProductBiddingCategoryConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetProductBiddingCategoryConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.ProductBiddingCategoryConstant());
        ...
        it('invokes getProductBiddingCategoryConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getProductBiddingCategoryConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IProductBiddingCategoryConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
