...
describe('v7.FeedPlaceholderViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feedplaceholderviewserviceModule.v7.FeedPlaceholderViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feedplaceholderviewserviceModule.v7.FeedPlaceholderViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feedplaceholderviewserviceModule.v7.FeedPlaceholderViewServiceClient.port;
        assert(port);
    ...
    describe('getFeedPlaceholderView', () => {
        it('invokes getFeedPlaceholderView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetFeedPlaceholderViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.FeedPlaceholderView());
        ...
        it('invokes getFeedPlaceholderView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeedPlaceholderView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IFeedPlaceholderView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
