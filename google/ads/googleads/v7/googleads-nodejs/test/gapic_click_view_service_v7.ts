...
describe('v7.ClickViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = clickviewserviceModule.v7.ClickViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = clickviewserviceModule.v7.ClickViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = clickviewserviceModule.v7.ClickViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new clickviewserviceModule.v7.ClickViewServiceClient();
        assert(client);
    });
    ...
    describe('getClickView', () => {
        it('invokes getClickView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetClickViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.ClickView());
        ...
        it('invokes getClickView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getClickView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IClickView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
