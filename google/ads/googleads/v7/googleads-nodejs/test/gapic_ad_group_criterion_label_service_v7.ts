...
describe('v7.AdGroupCriterionLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupcriterionlabelserviceModule.v7.AdGroupCriterionLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupcriterionlabelserviceModule.v7.AdGroupCriterionLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupcriterionlabelserviceModule.v7.AdGroupCriterionLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupcriterionlabelserviceModule.v7.AdGroupCriterionLabelServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupCriterionLabel', () => {
        it('invokes getAdGroupCriterionLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetAdGroupCriterionLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.AdGroupCriterionLabel());
        ...
        it('invokes getAdGroupCriterionLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupCriterionLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IAdGroupCriterionLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupCriterionLabels', () => {
        it('invokes mutateAdGroupCriterionLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateAdGroupCriterionLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateAdGroupCriterionLabelsResponse());
        ...
        it('invokes mutateAdGroupCriterionLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupCriterionLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateAdGroupCriterionLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
