...
describe('v7.GeographicViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = geographicviewserviceModule.v7.GeographicViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = geographicviewserviceModule.v7.GeographicViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = geographicviewserviceModule.v7.GeographicViewServiceClient.port;
        assert(port);
    ...
    describe('getGeographicView', () => {
        it('invokes getGeographicView without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.GeographicView());
        ...
        it('invokes getGeographicView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGeographicView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IGeographicView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
