...
import * as sharedsetserviceModule from '../src';
...
describe('v7.SharedSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = sharedsetserviceModule.v7.SharedSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = sharedsetserviceModule.v7.SharedSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = sharedsetserviceModule.v7.SharedSetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new sharedsetserviceModule.v7.SharedSetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.sharedSetServiceStub, undefined);
        await client.initialize();
        assert(client.sharedSetServiceStub);
    });
    ...
    describe('getSharedSet', () => {
        it('invokes getSharedSet without error', async () => {
            const client = new sharedsetserviceModule.v7.SharedSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetSharedSetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.SharedSet());
            client.innerApiCalls.getSharedSet = stubSimpleCall(expectedResponse);
            const [response] = await client.getSharedSet(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSharedSet as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getSharedSet without error using callback', async () => {
            const client = new sharedsetserviceModule.v7.SharedSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.SharedSet());
            client.innerApiCalls.getSharedSet = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSharedSet(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.ISharedSet|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSharedSet with error', async () => {
            const client = new sharedsetserviceModule.v7.SharedSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getSharedSet = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getSharedSet(request), expectedError);
            assert((client.innerApiCalls.getSharedSet as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateSharedSets', () => {
        it('invokes mutateSharedSets without error', async () => {
            const client = new sharedsetserviceModule.v7.SharedSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateSharedSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateSharedSetsResponse());
            client.innerApiCalls.mutateSharedSets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateSharedSets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateSharedSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateSharedSets without error using callback', async () => {
            const client = new sharedsetserviceModule.v7.SharedSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.services.MutateSharedSetsResponse());
            client.innerApiCalls.mutateSharedSets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateSharedSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.services.IMutateSharedSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateSharedSets with error', async () => {
            const client = new sharedsetserviceModule.v7.SharedSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateSharedSets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateSharedSets(request), expectedError);
            assert((client.innerApiCalls.mutateSharedSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
