...
describe('v7.VideoServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = videoserviceModule.v7.VideoServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = videoserviceModule.v7.VideoServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = videoserviceModule.v7.VideoServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new videoserviceModule.v7.VideoServiceClient();
        assert(client);
    });
    ...
    describe('getVideo', () => {
        it('invokes getVideo without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v7.services.GetVideoRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v7.resources.Video());
        ...
        it('invokes getVideo without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getVideo(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v7.resources.IVideo|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
