...
namespace Google.Ads.GoogleAds.V7.Services
{
    ...
    public sealed partial class ChangeStatusServiceClientBuilder : gaxgrpc::ClientBuilderBase<ChangeStatusServiceClient>
    {
        ...
        public ChangeStatusServiceClientBuilder()
        {
            UseJwtAccessWithScopes = ChangeStatusServiceClient.UseJwtAccessWithScopes;
        }
