...
namespace Google.Ads.GoogleAds.V7.Services
{
    ...
    public sealed partial class CarrierConstantServiceClientBuilder : gaxgrpc::ClientBuilderBase<CarrierConstantServiceClient>
    {
        ...
        public CarrierConstantServiceClientBuilder()
        {
            UseJwtAccessWithScopes = CarrierConstantServiceClient.UseJwtAccessWithScopes;
        }
    ...
    public abstract partial class CarrierConstantServiceClient
    {
        ...
        /// <remarks>
        /// The default CarrierConstantService scopes are:
