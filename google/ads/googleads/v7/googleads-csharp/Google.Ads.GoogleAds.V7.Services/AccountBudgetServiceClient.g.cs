...
namespace Google.Ads.GoogleAds.V7.Services
{
    ...
    public sealed partial class AccountBudgetServiceClientBuilder : gaxgrpc::ClientBuilderBase<AccountBudgetServiceClient>
    {
        ...
        public AccountBudgetServiceClientBuilder()
        {
            UseJwtAccessWithScopes = AccountBudgetServiceClient.UseJwtAccessWithScopes;
        }
