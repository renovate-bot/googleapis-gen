...
namespace Google.Ads.GoogleAds.V7.Services
{
    ...
    /// endpoint etc.
    /// </summary>
    public sealed partial class CustomAudienceServiceClientBuilder : gaxgrpc::ClientBuilderBase<CustomAudienceServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public CustomAudienceServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public CustomAudienceServiceClientBuilder()
        {
            UseJwtAccessWithScopes = CustomAudienceServiceClient.UseJwtAccessWithScopes;
        }
