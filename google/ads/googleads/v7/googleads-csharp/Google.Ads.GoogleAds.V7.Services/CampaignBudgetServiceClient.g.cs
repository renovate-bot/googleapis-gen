...
namespace Google.Ads.GoogleAds.V7.Services
{
    ...
    /// endpoint etc.
    /// </summary>
    public sealed partial class CampaignBudgetServiceClientBuilder : gaxgrpc::ClientBuilderBase<CampaignBudgetServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public CampaignBudgetServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public CampaignBudgetServiceClientBuilder()
        {
            UseJwtAccessWithScopes = CampaignBudgetServiceClient.UseJwtAccessWithScopes;
        }
