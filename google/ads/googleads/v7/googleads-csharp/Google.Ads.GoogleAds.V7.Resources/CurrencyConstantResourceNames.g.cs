...
namespace Google.Ads.GoogleAds.V7.Resources
{
    ...
    public sealed partial class CurrencyConstantName : gax::IResourceName, sys::IEquatable<CurrencyConstantName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>currencyConstants/{code}</c>.</summary>
            Code = 1,
        }

        private static gax::PathTemplate s_code = new gax::PathTemplate("currencyConstants/{code}");
        ...
        /// <summary>
        /// Creates a <see cref="CurrencyConstantName"/> with the pattern <c>currencyConstants/{code}</c>.
        /// </summary>
        /// <param name="codeId">The <c>Code</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        /// <c>currencyConstants/{code}</c>.
        /// </returns>
        public static string Format(string codeId) => FormatCode(codeId);
        ...
        /// <list type="bullet"><item><description><c>currencyConstants/{code}</c></description></item></list>
        /// </remarks>
        ...
        public static bool TryParse(string currencyConstantName, bool allowUnparsed, out CurrencyConstantName result)
        {
            ...
            if (s_code.TryParseName(currencyConstantName, out resourceName))
            {
                result = FromCode(resourceName[0]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private CurrencyConstantName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string codeId = null)
        {
            Type = type;
        ...
        /// </summary>
        /// <param name="codeId">The <c>Code</c> ID. Must not be <c>null</c> or empty.</param>
        public CurrencyConstantName(string codeId) : this(ResourceNameType.Code, codeId: gax::GaxPreconditions.CheckNotNullOrEmpty(codeId, nameof(codeId)))
        {
        }
        ...
        /// <summary>
        /// The <c>Code</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource name.
        /// </summary>
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.Code: return s_code.Expand(CodeId);
