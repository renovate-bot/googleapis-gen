...
namespace Google.Ads.GoogleAds.V7.Resources
{
    ...
    public sealed partial class HotelGroupViewName : gax::IResourceName, sys::IEquatable<HotelGroupViewName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer_id}/hotelGroupViews/{ad_group_id}~{criterion_id}</c>
            /// .
            /// </summary>
            CustomerAdGroupCriterion = 1,
        }

        private static gax::PathTemplate s_customerAdGroupCriterion = new gax::PathTemplate("customers/{customer_id}/hotelGroupViews/{ad_group_id_criterion_id}");
        ...
        /// <c>customers/{customer_id}/hotelGroupViews/{ad_group_id}~{criterion_id}</c>.
        /// </summary>
        ...
        public static HotelGroupViewName FromCustomerAdGroupCriterion(string customerId, string adGroupId, string criterionId) =>
            new HotelGroupViewName(ResourceNameType.CustomerAdGroupCriterion, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), adGroupId: gax::GaxPreconditions.CheckNotNullOrEmpty(adGroupId, nameof(adGroupId)), criterionId: gax::GaxPreconditions.CheckNotNullOrEmpty(criterionId, nameof(criterionId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>customers/{customer_id}/hotelGroupViews/{ad_group_id}~{criterion_id}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string hotelGroupViewName, bool allowUnparsed, out HotelGroupViewName result)
        {
            ...
            if (s_customerAdGroupCriterion.TryParseName(hotelGroupViewName, out resourceName))
            {
        ...
        private HotelGroupViewName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string adGroupId = null, string criterionId = null, string customerId = null)
        {
            Type = type;
    ...
    public partial class HotelGroupView
    {
        ...
        /// </summary>
        public HotelGroupViewName ResourceNameAsHotelGroupViewName
        {
