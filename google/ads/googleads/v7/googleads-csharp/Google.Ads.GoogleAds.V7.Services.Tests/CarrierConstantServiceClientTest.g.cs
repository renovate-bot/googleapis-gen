...
namespace Google.Ads.GoogleAds.V7.Services.Tests
{
    ...
    public sealed class GeneratedCarrierConstantServiceClientTest
    {
        ...
        public void GetCarrierConstantRequestObject()
        {
            ...
            {
                ResourceNameAsCarrierConstantName = gagvr::CarrierConstantName.FromCriterion("[CRITERION_ID]"),
            };
            gagvr::CarrierConstant expectedResponse = new gagvr::CarrierConstant
            {
                ResourceNameAsCarrierConstantName = gagvr::CarrierConstantName.FromCriterion("[CRITERION_ID]"),
                Id = -6774108720365892680L,
                CarrierConstantName = gagvr::CarrierConstantName.FromCriterion("[CRITERION_ID]"),
