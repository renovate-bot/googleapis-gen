...
namespace Google.Ads.GoogleAds.V7.Services.Snippets
{
    ...
    public sealed partial class GeneratedKeywordPlanServiceClientStandaloneSnippets
    {
        ...
        public async Task GenerateForecastTimeSeriesAsync()
        {
            // Snippet: GenerateForecastTimeSeriesAsync(string, CallSettings)
            // Additional: GenerateForecastTimeSeriesAsync(string, CancellationToken)
            // Create client
