...
namespace Google.Ads.GoogleAds.V7.Services.Snippets
{
    ...
    public sealed class GeneratedDistanceViewServiceClientSnippets
    {
        ...
        public void GetDistanceViewRequestObject()
        {
            ...
            {
                ResourceNameAsDistanceViewName = DistanceViewName.FromCustomerPlaceholderChainDistanceBucket("[CUSTOMER_ID]", "[PLACEHOLDER_CHAIN_ID]", "[DISTANCE_BUCKET]"),
            };
            // Make the request
        ...
        public void GetDistanceView()
        {
            ...
            DistanceViewServiceClient distanceViewServiceClient = DistanceViewServiceClient.Create();
            // Initialize request argument(s)
            string resourceName = "customers/[CUSTOMER_ID]/distanceViews/[PLACEHOLDER_CHAIN_ID]~[DISTANCE_BUCKET]";
            // Make the request
