...
public class ReachPlanServiceStubSettings extends StubSettings<ReachPlanServiceStubSettings> {
  ...
  private final UnaryCallSettings<GenerateProductMixIdeasRequest, GenerateProductMixIdeasResponse>
  ...
  public UnaryCallSettings<GenerateProductMixIdeasRequest, GenerateProductMixIdeasResponse>
      generateProductMixIdeasSettings() {
    return generateProductMixIdeasSettings;
  }
  ...
  protected ReachPlanServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    generateProductMixIdeasSettings = settingsBuilder.generateProductMixIdeasSettings().build();
  ...
  public static class Builder extends StubSettings.Builder<ReachPlanServiceStubSettings, Builder> {
    ...
    protected Builder(ReachPlanServiceStubSettings settings) {
      ...
      generateProductMixIdeasSettings = settings.generateProductMixIdeasSettings.toBuilder();
