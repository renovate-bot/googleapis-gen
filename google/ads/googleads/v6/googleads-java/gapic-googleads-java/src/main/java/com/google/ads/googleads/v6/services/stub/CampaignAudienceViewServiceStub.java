...
/**
 * Base stub class for the CampaignAudienceViewService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@Generated("by gapic-generator-java")
public abstract class CampaignAudienceViewServiceStub implements BackgroundResource {

  public UnaryCallable<GetCampaignAudienceViewRequest, CampaignAudienceView>
      getCampaignAudienceViewCallable() {
    throw new UnsupportedOperationException("Not implemented: getCampaignAudienceViewCallable()");
  }
