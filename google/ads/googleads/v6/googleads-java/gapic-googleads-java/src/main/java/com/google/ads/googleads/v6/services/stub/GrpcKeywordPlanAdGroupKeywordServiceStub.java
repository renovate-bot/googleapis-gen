  ...
  private static final MethodDescriptor<
      ...
      getKeywordPlanAdGroupKeywordMethodDescriptor =
          MethodDescriptor
              ...
              .setFullMethodName(
                  "google.ads.googleads.v6.services.KeywordPlanAdGroupKeywordService/GetKeywordPlanAdGroupKeyword")
    ...
    GrpcCallSettings<GetKeywordPlanAdGroupKeywordRequest, KeywordPlanAdGroupKeyword>
        getKeywordPlanAdGroupKeywordTransportSettings =
            GrpcCallSettings
                ...
                .setParamsExtractor(
                    new RequestParamsExtractor<GetKeywordPlanAdGroupKeywordRequest>() {
                      @Override
    ...
    GrpcCallSettings<
        ...
        mutateKeywordPlanAdGroupKeywordsTransportSettings =
            GrpcCallSettings
                ...
                .setParamsExtractor(
                    new RequestParamsExtractor<MutateKeywordPlanAdGroupKeywordsRequest>() {
                      @Override
                      public Map<String, String> extract(
