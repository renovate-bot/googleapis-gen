...
import com.google.ads.googleads.v6.services.stub.SharedCriterionServiceStubSettings;
 ...
 *
 * <p>For example, to set the total timeout of getSharedCriterion to 30 seconds:
 *
 * <pre>{@code
...
public class SharedCriterionServiceSettings extends ClientSettings<SharedCriterionServiceSettings> {
  ...
  /** Returns the object with the settings used for calls to getSharedCriterion. */
  public UnaryCallSettings<GetSharedCriterionRequest, SharedCriterion>
      getSharedCriterionSettings() {
    return ((SharedCriterionServiceStubSettings) getStubSettings()).getSharedCriterionSettings();
  }
  ...
  public static class Builder
    ...
    /** Returns the builder for the settings used for calls to getSharedCriterion. */
    public UnaryCallSettings.Builder<GetSharedCriterionRequest, SharedCriterion>
        getSharedCriterionSettings() {
      return getStubSettingsBuilder().getSharedCriterionSettings();
    }
