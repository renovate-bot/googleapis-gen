...
public class CustomerUserAccessInvitationServiceClient implements BackgroundResource {
   ...
   * }</pre>
   *
   * @param resourceName Required. Resource name of the access invitation.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final CustomerUserAccessInvitation getCustomerUserAccessInvitation(
      CustomerUserAccessInvitationName resourceName) {
    GetCustomerUserAccessInvitationRequest request =
        GetCustomerUserAccessInvitationRequest.newBuilder()
            .setResourceName(resourceName == null ? null : resourceName.toString())
            .build();
    return getCustomerUserAccessInvitation(request);
  }
  ...
  public final CustomerUserAccessInvitation getCustomerUserAccessInvitation(String resourceName) {
    GetCustomerUserAccessInvitationRequest request =
        GetCustomerUserAccessInvitationRequest.newBuilder().setResourceName(resourceName).build();
    return getCustomerUserAccessInvitation(request);
  }
   ...
   *           .build();
   *   CustomerUserAccessInvitation response =
   *       customerUserAccessInvitationServiceClient.getCustomerUserAccessInvitation(request);
   * }
   * }</pre>
   *
  ...
  public final CustomerUserAccessInvitation getCustomerUserAccessInvitation(
      GetCustomerUserAccessInvitationRequest request) {
    return getCustomerUserAccessInvitationCallable().call(request);
  }
   ...
   *                   .toString())
   *           .build();
   *   ApiFuture<CustomerUserAccessInvitation> future =
   *       customerUserAccessInvitationServiceClient
   *           .getCustomerUserAccessInvitationCallable()
   *           .futureCall(request);
   *   // Do something.
   *   CustomerUserAccessInvitation response = future.get();
   * }
   * }</pre>
   */
  public final UnaryCallable<GetCustomerUserAccessInvitationRequest, CustomerUserAccessInvitation>
      getCustomerUserAccessInvitationCallable() {
    return stub.getCustomerUserAccessInvitationCallable();
  }
