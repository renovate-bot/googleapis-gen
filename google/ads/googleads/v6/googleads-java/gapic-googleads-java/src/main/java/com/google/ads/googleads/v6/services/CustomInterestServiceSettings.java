...
import com.google.ads.googleads.v6.services.stub.CustomInterestServiceStubSettings;
...
public class CustomInterestServiceSettings extends ClientSettings<CustomInterestServiceSettings> {
  ...
  public static final CustomInterestServiceSettings create(CustomInterestServiceStubSettings stub)
      throws IOException {
    return new CustomInterestServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  protected CustomInterestServiceSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
    ...
    protected Builder(CustomInterestServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    public UnaryCallSettings.Builder<GetCustomInterestRequest, CustomInterest>
        getCustomInterestSettings() {
      return getStubSettingsBuilder().getCustomInterestSettings();
    }
    ...
    @Override
    public CustomInterestServiceSettings build() throws IOException {
