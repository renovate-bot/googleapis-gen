...
public interface FeedMappingOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.googleads.v6.resources.FeedMapping)
   ...
   * </pre>
   *
   * <code>repeated .google.ads.googleads.v6.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  java.util.List<com.google.ads.googleads.v6.resources.AttributeFieldMapping> 
   ...
   * <code>repeated .google.ads.googleads.v6.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v6.resources.AttributeFieldMapping getAttributeFieldMappings(int index);
  /**
   * <pre>
   * Immutable. Feed attributes to field mappings. These mappings are a one-to-many
   * relationship meaning that 1 feed attribute can be used to populate
   ...
   * <code>repeated .google.ads.googleads.v6.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  java.util.List<? extends com.google.ads.googleads.v6.resources.AttributeFieldMappingOrBuilder> 
   ...
   * <code>repeated .google.ads.googleads.v6.resources.AttributeFieldMapping attribute_field_mappings = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.ads.googleads.v6.resources.AttributeFieldMappingOrBuilder getAttributeFieldMappingsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.ads.googleads.v6.enums.FeedMappingStatusEnum.FeedMappingStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.ads.googleads.v6.enums.FeedMappingStatusEnum.FeedMappingStatus getStatus();
   ...
   */
  com.google.ads.googleads.v6.enums.FeedMappingCriterionTypeEnum.FeedMappingCriterionType getCriterionType();

  public com.google.ads.googleads.v6.resources.FeedMapping.TargetCase getTargetCase();
}
