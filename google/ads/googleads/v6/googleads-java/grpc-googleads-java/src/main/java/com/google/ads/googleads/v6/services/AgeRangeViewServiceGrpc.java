...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/age_range_view_service.proto")
public final class AgeRangeViewServiceGrpc {

  private AgeRangeViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.AgeRangeViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAgeRangeViewRequest,
      com.google.ads.googleads.v6.resources.AgeRangeView> getGetAgeRangeViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAgeRangeView",
      requestType = com.google.ads.googleads.v6.services.GetAgeRangeViewRequest.class,
      responseType = com.google.ads.googleads.v6.resources.AgeRangeView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAgeRangeViewRequest,
      com.google.ads.googleads.v6.resources.AgeRangeView> getGetAgeRangeViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAgeRangeViewRequest, com.google.ads.googleads.v6.resources.AgeRangeView> getGetAgeRangeViewMethod;
      ...
      synchronized (AgeRangeViewServiceGrpc.class) {
        if ((getGetAgeRangeViewMethod = AgeRangeViewServiceGrpc.getGetAgeRangeViewMethod) == null) {
          AgeRangeViewServiceGrpc.getGetAgeRangeViewMethod = getGetAgeRangeViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetAgeRangeViewRequest, com.google.ads.googleads.v6.resources.AgeRangeView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAgeRangeView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetAgeRangeViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.AgeRangeView.getDefaultInstance()))
  ...
  public static abstract class AgeRangeViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAgeRangeView(com.google.ads.googleads.v6.services.GetAgeRangeViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AgeRangeView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetAgeRangeViewRequest,
                com.google.ads.googleads.v6.resources.AgeRangeView>(
  ...
  public static final class AgeRangeViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AgeRangeViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.AgeRangeView getAgeRangeView(com.google.ads.googleads.v6.services.GetAgeRangeViewRequest request) {
  ...
  public static final class AgeRangeViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AgeRangeViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.AgeRangeView> getAgeRangeView(
        com.google.ads.googleads.v6.services.GetAgeRangeViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AGE_RANGE_VIEW:
          serviceImpl.getAgeRangeView((com.google.ads.googleads.v6.services.GetAgeRangeViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AgeRangeView>) responseObserver);
          break;
        default:
  ...
  private static abstract class AgeRangeViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.AgeRangeViewServiceProto.getDescriptor();
    }
