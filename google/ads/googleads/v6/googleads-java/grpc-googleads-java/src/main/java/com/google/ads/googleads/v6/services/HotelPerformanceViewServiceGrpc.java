...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/hotel_performance_view_service.proto")
public final class HotelPerformanceViewServiceGrpc {

  private HotelPerformanceViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.HotelPerformanceViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest,
      com.google.ads.googleads.v6.resources.HotelPerformanceView> getGetHotelPerformanceViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetHotelPerformanceView",
      requestType = com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest.class,
      responseType = com.google.ads.googleads.v6.resources.HotelPerformanceView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest,
      com.google.ads.googleads.v6.resources.HotelPerformanceView> getGetHotelPerformanceViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest, com.google.ads.googleads.v6.resources.HotelPerformanceView> getGetHotelPerformanceViewMethod;
      ...
      synchronized (HotelPerformanceViewServiceGrpc.class) {
        if ((getGetHotelPerformanceViewMethod = HotelPerformanceViewServiceGrpc.getGetHotelPerformanceViewMethod) == null) {
          HotelPerformanceViewServiceGrpc.getGetHotelPerformanceViewMethod = getGetHotelPerformanceViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest, com.google.ads.googleads.v6.resources.HotelPerformanceView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetHotelPerformanceView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.HotelPerformanceView.getDefaultInstance()))
  ...
  public static abstract class HotelPerformanceViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getHotelPerformanceView(com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.HotelPerformanceView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest,
                com.google.ads.googleads.v6.resources.HotelPerformanceView>(
  ...
  public static final class HotelPerformanceViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HotelPerformanceViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.HotelPerformanceView getHotelPerformanceView(com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest request) {
  ...
  public static final class HotelPerformanceViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HotelPerformanceViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.HotelPerformanceView> getHotelPerformanceView(
        com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_HOTEL_PERFORMANCE_VIEW:
          serviceImpl.getHotelPerformanceView((com.google.ads.googleads.v6.services.GetHotelPerformanceViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.HotelPerformanceView>) responseObserver);
          break;
        default:
  ...
  private static abstract class HotelPerformanceViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.HotelPerformanceViewServiceProto.getDescriptor();
    }
