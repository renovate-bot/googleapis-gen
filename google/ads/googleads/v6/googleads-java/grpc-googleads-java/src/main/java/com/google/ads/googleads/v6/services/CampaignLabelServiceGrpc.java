...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/campaign_label_service.proto")
public final class CampaignLabelServiceGrpc {

  private CampaignLabelServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.CampaignLabelService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCampaignLabelRequest,
      com.google.ads.googleads.v6.resources.CampaignLabel> getGetCampaignLabelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignLabel",
      requestType = com.google.ads.googleads.v6.services.GetCampaignLabelRequest.class,
      responseType = com.google.ads.googleads.v6.resources.CampaignLabel.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCampaignLabelRequest,
      com.google.ads.googleads.v6.resources.CampaignLabel> getGetCampaignLabelMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCampaignLabelRequest, com.google.ads.googleads.v6.resources.CampaignLabel> getGetCampaignLabelMethod;
      ...
      synchronized (CampaignLabelServiceGrpc.class) {
        if ((getGetCampaignLabelMethod = CampaignLabelServiceGrpc.getGetCampaignLabelMethod) == null) {
          CampaignLabelServiceGrpc.getGetCampaignLabelMethod = getGetCampaignLabelMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetCampaignLabelRequest, com.google.ads.googleads.v6.resources.CampaignLabel>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignLabel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetCampaignLabelRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.CampaignLabel.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest,
      com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse> getMutateCampaignLabelsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCampaignLabels",
      requestType = com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest,
      com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse> getMutateCampaignLabelsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest, com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse> getMutateCampaignLabelsMethod;
      ...
      synchronized (CampaignLabelServiceGrpc.class) {
        if ((getMutateCampaignLabelsMethod = CampaignLabelServiceGrpc.getMutateCampaignLabelsMethod) == null) {
          CampaignLabelServiceGrpc.getMutateCampaignLabelsMethod = getMutateCampaignLabelsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest, com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCampaignLabels"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse.getDefaultInstance()))
  ...
  public static abstract class CampaignLabelServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignLabel(com.google.ads.googleads.v6.services.GetCampaignLabelRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CampaignLabel> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCampaignLabels(com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetCampaignLabelRequest,
                com.google.ads.googleads.v6.resources.CampaignLabel>(
                  this, METHODID_GET_CAMPAIGN_LABEL)))
          .addMethod(
            getMutateCampaignLabelsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest,
                com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse>(
  ...
  public static final class CampaignLabelServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignLabelServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.CampaignLabel getCampaignLabel(com.google.ads.googleads.v6.services.GetCampaignLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse mutateCampaignLabels(com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CampaignLabelServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignLabelServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.CampaignLabel> getCampaignLabel(
        com.google.ads.googleads.v6.services.GetCampaignLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse> mutateCampaignLabels(
        com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_LABEL:
          serviceImpl.getCampaignLabel((com.google.ads.googleads.v6.services.GetCampaignLabelRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CampaignLabel>) responseObserver);
          break;
        case METHODID_MUTATE_CAMPAIGN_LABELS:
          serviceImpl.mutateCampaignLabels((com.google.ads.googleads.v6.services.MutateCampaignLabelsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateCampaignLabelsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignLabelServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.CampaignLabelServiceProto.getDescriptor();
    }
