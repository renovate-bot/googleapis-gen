...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/user_list_service.proto")
public final class UserListServiceGrpc {

  private UserListServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.UserListService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetUserListRequest,
      com.google.ads.googleads.v6.resources.UserList> getGetUserListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetUserList",
      requestType = com.google.ads.googleads.v6.services.GetUserListRequest.class,
      responseType = com.google.ads.googleads.v6.resources.UserList.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetUserListRequest,
      com.google.ads.googleads.v6.resources.UserList> getGetUserListMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetUserListRequest, com.google.ads.googleads.v6.resources.UserList> getGetUserListMethod;
      ...
      synchronized (UserListServiceGrpc.class) {
        if ((getGetUserListMethod = UserListServiceGrpc.getGetUserListMethod) == null) {
          UserListServiceGrpc.getGetUserListMethod = getGetUserListMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetUserListRequest, com.google.ads.googleads.v6.resources.UserList>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetUserList"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetUserListRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.UserList.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateUserListsRequest,
      com.google.ads.googleads.v6.services.MutateUserListsResponse> getMutateUserListsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateUserLists",
      requestType = com.google.ads.googleads.v6.services.MutateUserListsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateUserListsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateUserListsRequest,
      com.google.ads.googleads.v6.services.MutateUserListsResponse> getMutateUserListsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateUserListsRequest, com.google.ads.googleads.v6.services.MutateUserListsResponse> getMutateUserListsMethod;
      ...
      synchronized (UserListServiceGrpc.class) {
        if ((getMutateUserListsMethod = UserListServiceGrpc.getMutateUserListsMethod) == null) {
          UserListServiceGrpc.getMutateUserListsMethod = getMutateUserListsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateUserListsRequest, com.google.ads.googleads.v6.services.MutateUserListsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateUserLists"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateUserListsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateUserListsResponse.getDefaultInstance()))
  ...
  public static abstract class UserListServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getUserList(com.google.ads.googleads.v6.services.GetUserListRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.UserList> responseObserver) {
     ...
     * </pre>
     */
    public void mutateUserLists(com.google.ads.googleads.v6.services.MutateUserListsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateUserListsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetUserListRequest,
                com.google.ads.googleads.v6.resources.UserList>(
                  this, METHODID_GET_USER_LIST)))
          .addMethod(
            getMutateUserListsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateUserListsRequest,
                com.google.ads.googleads.v6.services.MutateUserListsResponse>(
  ...
  public static final class UserListServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<UserListServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.UserList getUserList(com.google.ads.googleads.v6.services.GetUserListRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateUserListsResponse mutateUserLists(com.google.ads.googleads.v6.services.MutateUserListsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class UserListServiceFutureStub extends io.grpc.stub.AbstractFutureStub<UserListServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.UserList> getUserList(
        com.google.ads.googleads.v6.services.GetUserListRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateUserListsResponse> mutateUserLists(
        com.google.ads.googleads.v6.services.MutateUserListsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_USER_LIST:
          serviceImpl.getUserList((com.google.ads.googleads.v6.services.GetUserListRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.UserList>) responseObserver);
          break;
        case METHODID_MUTATE_USER_LISTS:
          serviceImpl.mutateUserLists((com.google.ads.googleads.v6.services.MutateUserListsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateUserListsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class UserListServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.UserListServiceProto.getDescriptor();
    }
