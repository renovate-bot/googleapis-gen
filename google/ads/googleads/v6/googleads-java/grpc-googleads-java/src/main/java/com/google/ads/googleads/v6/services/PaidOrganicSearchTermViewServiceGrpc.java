...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/paid_organic_search_term_view_service.proto")
public final class PaidOrganicSearchTermViewServiceGrpc {

  private PaidOrganicSearchTermViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.PaidOrganicSearchTermViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest,
      com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView> getGetPaidOrganicSearchTermViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetPaidOrganicSearchTermView",
      requestType = com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest.class,
      responseType = com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest,
      com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView> getGetPaidOrganicSearchTermViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest, com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView> getGetPaidOrganicSearchTermViewMethod;
      ...
      synchronized (PaidOrganicSearchTermViewServiceGrpc.class) {
        if ((getGetPaidOrganicSearchTermViewMethod = PaidOrganicSearchTermViewServiceGrpc.getGetPaidOrganicSearchTermViewMethod) == null) {
          PaidOrganicSearchTermViewServiceGrpc.getGetPaidOrganicSearchTermViewMethod = getGetPaidOrganicSearchTermViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest, com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetPaidOrganicSearchTermView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView.getDefaultInstance()))
  ...
  public static abstract class PaidOrganicSearchTermViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getPaidOrganicSearchTermView(com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest,
                com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView>(
  ...
  public static final class PaidOrganicSearchTermViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PaidOrganicSearchTermViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView getPaidOrganicSearchTermView(com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest request) {
  ...
  public static final class PaidOrganicSearchTermViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PaidOrganicSearchTermViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView> getPaidOrganicSearchTermView(
        com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PAID_ORGANIC_SEARCH_TERM_VIEW:
          serviceImpl.getPaidOrganicSearchTermView((com.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.PaidOrganicSearchTermView>) responseObserver);
          break;
        default:
  ...
  private static abstract class PaidOrganicSearchTermViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.PaidOrganicSearchTermViewServiceProto.getDescriptor();
    }
