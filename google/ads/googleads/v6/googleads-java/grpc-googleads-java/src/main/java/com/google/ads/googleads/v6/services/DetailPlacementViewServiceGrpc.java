...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/detail_placement_view_service.proto")
public final class DetailPlacementViewServiceGrpc {

  private DetailPlacementViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.DetailPlacementViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest,
      com.google.ads.googleads.v6.resources.DetailPlacementView> getGetDetailPlacementViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDetailPlacementView",
      requestType = com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest.class,
      responseType = com.google.ads.googleads.v6.resources.DetailPlacementView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest,
      com.google.ads.googleads.v6.resources.DetailPlacementView> getGetDetailPlacementViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest, com.google.ads.googleads.v6.resources.DetailPlacementView> getGetDetailPlacementViewMethod;
      ...
      synchronized (DetailPlacementViewServiceGrpc.class) {
        if ((getGetDetailPlacementViewMethod = DetailPlacementViewServiceGrpc.getGetDetailPlacementViewMethod) == null) {
          DetailPlacementViewServiceGrpc.getGetDetailPlacementViewMethod = getGetDetailPlacementViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest, com.google.ads.googleads.v6.resources.DetailPlacementView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDetailPlacementView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.DetailPlacementView.getDefaultInstance()))
  ...
  public static abstract class DetailPlacementViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getDetailPlacementView(com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.DetailPlacementView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest,
                com.google.ads.googleads.v6.resources.DetailPlacementView>(
  ...
  public static final class DetailPlacementViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DetailPlacementViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.DetailPlacementView getDetailPlacementView(com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest request) {
  ...
  public static final class DetailPlacementViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DetailPlacementViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.DetailPlacementView> getDetailPlacementView(
        com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DETAIL_PLACEMENT_VIEW:
          serviceImpl.getDetailPlacementView((com.google.ads.googleads.v6.services.GetDetailPlacementViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.DetailPlacementView>) responseObserver);
          break;
        default:
  ...
  private static abstract class DetailPlacementViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.DetailPlacementViewServiceProto.getDescriptor();
    }
