...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/account_budget_service.proto")
public final class AccountBudgetServiceGrpc {

  private AccountBudgetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.AccountBudgetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAccountBudgetRequest,
      com.google.ads.googleads.v6.resources.AccountBudget> getGetAccountBudgetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAccountBudget",
      requestType = com.google.ads.googleads.v6.services.GetAccountBudgetRequest.class,
      responseType = com.google.ads.googleads.v6.resources.AccountBudget.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAccountBudgetRequest,
      com.google.ads.googleads.v6.resources.AccountBudget> getGetAccountBudgetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAccountBudgetRequest, com.google.ads.googleads.v6.resources.AccountBudget> getGetAccountBudgetMethod;
      ...
      synchronized (AccountBudgetServiceGrpc.class) {
        if ((getGetAccountBudgetMethod = AccountBudgetServiceGrpc.getGetAccountBudgetMethod) == null) {
          AccountBudgetServiceGrpc.getGetAccountBudgetMethod = getGetAccountBudgetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetAccountBudgetRequest, com.google.ads.googleads.v6.resources.AccountBudget>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAccountBudget"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetAccountBudgetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.AccountBudget.getDefaultInstance()))
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACCOUNT_BUDGET:
          serviceImpl.getAccountBudget((com.google.ads.googleads.v6.services.GetAccountBudgetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AccountBudget>) responseObserver);
          break;
        default:
  ...
  private static abstract class AccountBudgetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.AccountBudgetServiceProto.getDescriptor();
    }
