...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/keyword_plan_campaign_keyword_service.proto")
public final class KeywordPlanCampaignKeywordServiceGrpc {

  private KeywordPlanCampaignKeywordServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.KeywordPlanCampaignKeywordService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest,
      com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword> getGetKeywordPlanCampaignKeywordMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetKeywordPlanCampaignKeyword",
      requestType = com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest.class,
      responseType = com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest,
      com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword> getGetKeywordPlanCampaignKeywordMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest, com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword> getGetKeywordPlanCampaignKeywordMethod;
      ...
      synchronized (KeywordPlanCampaignKeywordServiceGrpc.class) {
        if ((getGetKeywordPlanCampaignKeywordMethod = KeywordPlanCampaignKeywordServiceGrpc.getGetKeywordPlanCampaignKeywordMethod) == null) {
          KeywordPlanCampaignKeywordServiceGrpc.getGetKeywordPlanCampaignKeywordMethod = getGetKeywordPlanCampaignKeywordMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest, com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetKeywordPlanCampaignKeyword"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest,
      com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse> getMutateKeywordPlanCampaignKeywordsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateKeywordPlanCampaignKeywords",
      requestType = com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest,
      com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse> getMutateKeywordPlanCampaignKeywordsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest, com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse> getMutateKeywordPlanCampaignKeywordsMethod;
      ...
      synchronized (KeywordPlanCampaignKeywordServiceGrpc.class) {
        if ((getMutateKeywordPlanCampaignKeywordsMethod = KeywordPlanCampaignKeywordServiceGrpc.getMutateKeywordPlanCampaignKeywordsMethod) == null) {
          KeywordPlanCampaignKeywordServiceGrpc.getMutateKeywordPlanCampaignKeywordsMethod = getMutateKeywordPlanCampaignKeywordsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest, com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateKeywordPlanCampaignKeywords"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse.getDefaultInstance()))
  ...
  public static abstract class KeywordPlanCampaignKeywordServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getKeywordPlanCampaignKeyword(com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetKeywordPlanCampaignKeywordMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public void mutateKeywordPlanCampaignKeywords(com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest,
                com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword>(
                  this, METHODID_GET_KEYWORD_PLAN_CAMPAIGN_KEYWORD)))
          .addMethod(
            getMutateKeywordPlanCampaignKeywordsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest,
                com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse>(
  ...
  public static final class KeywordPlanCampaignKeywordServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<KeywordPlanCampaignKeywordServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword getKeywordPlanCampaignKeyword(com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse mutateKeywordPlanCampaignKeywords(com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class KeywordPlanCampaignKeywordServiceFutureStub extends io.grpc.stub.AbstractFutureStub<KeywordPlanCampaignKeywordServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword> getKeywordPlanCampaignKeyword(
        com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse> mutateKeywordPlanCampaignKeywords(
        com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_KEYWORD_PLAN_CAMPAIGN_KEYWORD:
          serviceImpl.getKeywordPlanCampaignKeyword((com.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword>) responseObserver);
          break;
        case METHODID_MUTATE_KEYWORD_PLAN_CAMPAIGN_KEYWORDS:
          serviceImpl.mutateKeywordPlanCampaignKeywords((com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class KeywordPlanCampaignKeywordServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.KeywordPlanCampaignKeywordServiceProto.getDescriptor();
    }
