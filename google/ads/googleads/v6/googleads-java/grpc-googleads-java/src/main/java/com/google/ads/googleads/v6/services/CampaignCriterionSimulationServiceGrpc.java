...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/campaign_criterion_simulation_service.proto")
public final class CampaignCriterionSimulationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest,
      com.google.ads.googleads.v6.resources.CampaignCriterionSimulation> getGetCampaignCriterionSimulationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignCriterionSimulation",
      requestType = com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest.class,
      responseType = com.google.ads.googleads.v6.resources.CampaignCriterionSimulation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest,
      com.google.ads.googleads.v6.resources.CampaignCriterionSimulation> getGetCampaignCriterionSimulationMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest, com.google.ads.googleads.v6.resources.CampaignCriterionSimulation> getGetCampaignCriterionSimulationMethod;
      ...
      synchronized (CampaignCriterionSimulationServiceGrpc.class) {
        if ((getGetCampaignCriterionSimulationMethod = CampaignCriterionSimulationServiceGrpc.getGetCampaignCriterionSimulationMethod) == null) {
          CampaignCriterionSimulationServiceGrpc.getGetCampaignCriterionSimulationMethod = getGetCampaignCriterionSimulationMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest, com.google.ads.googleads.v6.resources.CampaignCriterionSimulation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignCriterionSimulation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.CampaignCriterionSimulation.getDefaultInstance()))
  ...
  public static abstract class CampaignCriterionSimulationServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignCriterionSimulation(com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CampaignCriterionSimulation> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest,
                com.google.ads.googleads.v6.resources.CampaignCriterionSimulation>(
  ...
  public static final class CampaignCriterionSimulationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignCriterionSimulationServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.CampaignCriterionSimulation getCampaignCriterionSimulation(com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest request) {
  ...
  public static final class CampaignCriterionSimulationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignCriterionSimulationServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.CampaignCriterionSimulation> getCampaignCriterionSimulation(
        com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_CRITERION_SIMULATION:
          serviceImpl.getCampaignCriterionSimulation((com.google.ads.googleads.v6.services.GetCampaignCriterionSimulationRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CampaignCriterionSimulation>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignCriterionSimulationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.CampaignCriterionSimulationServiceProto.getDescriptor();
    }
