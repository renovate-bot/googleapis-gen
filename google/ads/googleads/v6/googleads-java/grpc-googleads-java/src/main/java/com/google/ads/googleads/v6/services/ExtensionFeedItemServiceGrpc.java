...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/extension_feed_item_service.proto")
public final class ExtensionFeedItemServiceGrpc {

  private ExtensionFeedItemServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.ExtensionFeedItemService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest,
      com.google.ads.googleads.v6.resources.ExtensionFeedItem> getGetExtensionFeedItemMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetExtensionFeedItem",
      requestType = com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest.class,
      responseType = com.google.ads.googleads.v6.resources.ExtensionFeedItem.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest,
      com.google.ads.googleads.v6.resources.ExtensionFeedItem> getGetExtensionFeedItemMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest, com.google.ads.googleads.v6.resources.ExtensionFeedItem> getGetExtensionFeedItemMethod;
      ...
      synchronized (ExtensionFeedItemServiceGrpc.class) {
        if ((getGetExtensionFeedItemMethod = ExtensionFeedItemServiceGrpc.getGetExtensionFeedItemMethod) == null) {
          ExtensionFeedItemServiceGrpc.getGetExtensionFeedItemMethod = getGetExtensionFeedItemMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest, com.google.ads.googleads.v6.resources.ExtensionFeedItem>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetExtensionFeedItem"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.ExtensionFeedItem.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest,
      com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse> getMutateExtensionFeedItemsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateExtensionFeedItems",
      requestType = com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest,
      com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse> getMutateExtensionFeedItemsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest, com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse> getMutateExtensionFeedItemsMethod;
      ...
      synchronized (ExtensionFeedItemServiceGrpc.class) {
        if ((getMutateExtensionFeedItemsMethod = ExtensionFeedItemServiceGrpc.getMutateExtensionFeedItemsMethod) == null) {
          ExtensionFeedItemServiceGrpc.getMutateExtensionFeedItemsMethod = getMutateExtensionFeedItemsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest, com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateExtensionFeedItems"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse.getDefaultInstance()))
  ...
  public static abstract class ExtensionFeedItemServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getExtensionFeedItem(com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.ExtensionFeedItem> responseObserver) {
     ...
     * </pre>
     */
    public void mutateExtensionFeedItems(com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest,
                com.google.ads.googleads.v6.resources.ExtensionFeedItem>(
                  this, METHODID_GET_EXTENSION_FEED_ITEM)))
          .addMethod(
            getMutateExtensionFeedItemsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest,
                com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse>(
  ...
  public static final class ExtensionFeedItemServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ExtensionFeedItemServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.ExtensionFeedItem getExtensionFeedItem(com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse mutateExtensionFeedItems(com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ExtensionFeedItemServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ExtensionFeedItemServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.ExtensionFeedItem> getExtensionFeedItem(
        com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse> mutateExtensionFeedItems(
        com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EXTENSION_FEED_ITEM:
          serviceImpl.getExtensionFeedItem((com.google.ads.googleads.v6.services.GetExtensionFeedItemRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.ExtensionFeedItem>) responseObserver);
          break;
        case METHODID_MUTATE_EXTENSION_FEED_ITEMS:
          serviceImpl.mutateExtensionFeedItems((com.google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateExtensionFeedItemsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ExtensionFeedItemServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.ExtensionFeedItemServiceProto.getDescriptor();
    }
