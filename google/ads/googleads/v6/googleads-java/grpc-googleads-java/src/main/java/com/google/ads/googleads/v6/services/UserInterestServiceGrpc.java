...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/user_interest_service.proto")
public final class UserInterestServiceGrpc {

  private UserInterestServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.UserInterestService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetUserInterestRequest,
      com.google.ads.googleads.v6.resources.UserInterest> getGetUserInterestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetUserInterest",
      requestType = com.google.ads.googleads.v6.services.GetUserInterestRequest.class,
      responseType = com.google.ads.googleads.v6.resources.UserInterest.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetUserInterestRequest,
      com.google.ads.googleads.v6.resources.UserInterest> getGetUserInterestMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetUserInterestRequest, com.google.ads.googleads.v6.resources.UserInterest> getGetUserInterestMethod;
      ...
      synchronized (UserInterestServiceGrpc.class) {
        if ((getGetUserInterestMethod = UserInterestServiceGrpc.getGetUserInterestMethod) == null) {
          UserInterestServiceGrpc.getGetUserInterestMethod = getGetUserInterestMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetUserInterestRequest, com.google.ads.googleads.v6.resources.UserInterest>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetUserInterest"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetUserInterestRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.UserInterest.getDefaultInstance()))
  ...
  public static abstract class UserInterestServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getUserInterest(com.google.ads.googleads.v6.services.GetUserInterestRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.UserInterest> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetUserInterestRequest,
                com.google.ads.googleads.v6.resources.UserInterest>(
  ...
  public static final class UserInterestServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<UserInterestServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.UserInterest getUserInterest(com.google.ads.googleads.v6.services.GetUserInterestRequest request) {
  ...
  public static final class UserInterestServiceFutureStub extends io.grpc.stub.AbstractFutureStub<UserInterestServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.UserInterest> getUserInterest(
        com.google.ads.googleads.v6.services.GetUserInterestRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_USER_INTEREST:
          serviceImpl.getUserInterest((com.google.ads.googleads.v6.services.GetUserInterestRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.UserInterest>) responseObserver);
          break;
        default:
  ...
  private static abstract class UserInterestServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.UserInterestServiceProto.getDescriptor();
    }
