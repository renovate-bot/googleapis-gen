...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/ad_group_ad_label_service.proto")
public final class AdGroupAdLabelServiceGrpc {

  private AdGroupAdLabelServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.AdGroupAdLabelService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest,
      com.google.ads.googleads.v6.resources.AdGroupAdLabel> getGetAdGroupAdLabelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupAdLabel",
      requestType = com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest.class,
      responseType = com.google.ads.googleads.v6.resources.AdGroupAdLabel.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest,
      com.google.ads.googleads.v6.resources.AdGroupAdLabel> getGetAdGroupAdLabelMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest, com.google.ads.googleads.v6.resources.AdGroupAdLabel> getGetAdGroupAdLabelMethod;
      ...
      synchronized (AdGroupAdLabelServiceGrpc.class) {
        if ((getGetAdGroupAdLabelMethod = AdGroupAdLabelServiceGrpc.getGetAdGroupAdLabelMethod) == null) {
          AdGroupAdLabelServiceGrpc.getGetAdGroupAdLabelMethod = getGetAdGroupAdLabelMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest, com.google.ads.googleads.v6.resources.AdGroupAdLabel>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupAdLabel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.AdGroupAdLabel.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest,
      com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse> getMutateAdGroupAdLabelsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdGroupAdLabels",
      requestType = com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest,
      com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse> getMutateAdGroupAdLabelsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest, com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse> getMutateAdGroupAdLabelsMethod;
      ...
      synchronized (AdGroupAdLabelServiceGrpc.class) {
        if ((getMutateAdGroupAdLabelsMethod = AdGroupAdLabelServiceGrpc.getMutateAdGroupAdLabelsMethod) == null) {
          AdGroupAdLabelServiceGrpc.getMutateAdGroupAdLabelsMethod = getMutateAdGroupAdLabelsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest, com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdGroupAdLabels"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse.getDefaultInstance()))
  ...
  public static abstract class AdGroupAdLabelServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroupAdLabel(com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdGroupAdLabel> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAdGroupAdLabels(com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest,
                com.google.ads.googleads.v6.resources.AdGroupAdLabel>(
                  this, METHODID_GET_AD_GROUP_AD_LABEL)))
          .addMethod(
            getMutateAdGroupAdLabelsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest,
                com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse>(
  ...
  public static final class AdGroupAdLabelServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupAdLabelServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.AdGroupAdLabel getAdGroupAdLabel(com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse mutateAdGroupAdLabels(com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AdGroupAdLabelServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupAdLabelServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.AdGroupAdLabel> getAdGroupAdLabel(
        com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse> mutateAdGroupAdLabels(
        com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_AD_LABEL:
          serviceImpl.getAdGroupAdLabel((com.google.ads.googleads.v6.services.GetAdGroupAdLabelRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdGroupAdLabel>) responseObserver);
          break;
        case METHODID_MUTATE_AD_GROUP_AD_LABELS:
          serviceImpl.mutateAdGroupAdLabels((com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateAdGroupAdLabelsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupAdLabelServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.AdGroupAdLabelServiceProto.getDescriptor();
    }
