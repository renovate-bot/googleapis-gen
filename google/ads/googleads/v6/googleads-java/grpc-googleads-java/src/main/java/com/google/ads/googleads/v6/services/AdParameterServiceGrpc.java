...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/ad_parameter_service.proto")
public final class AdParameterServiceGrpc {

  private AdParameterServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.AdParameterService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdParameterRequest,
      com.google.ads.googleads.v6.resources.AdParameter> getGetAdParameterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdParameter",
      requestType = com.google.ads.googleads.v6.services.GetAdParameterRequest.class,
      responseType = com.google.ads.googleads.v6.resources.AdParameter.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdParameterRequest,
      com.google.ads.googleads.v6.resources.AdParameter> getGetAdParameterMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdParameterRequest, com.google.ads.googleads.v6.resources.AdParameter> getGetAdParameterMethod;
      ...
      synchronized (AdParameterServiceGrpc.class) {
        if ((getGetAdParameterMethod = AdParameterServiceGrpc.getGetAdParameterMethod) == null) {
          AdParameterServiceGrpc.getGetAdParameterMethod = getGetAdParameterMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetAdParameterRequest, com.google.ads.googleads.v6.resources.AdParameter>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdParameter"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetAdParameterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.AdParameter.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAdParametersRequest,
      com.google.ads.googleads.v6.services.MutateAdParametersResponse> getMutateAdParametersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdParameters",
      requestType = com.google.ads.googleads.v6.services.MutateAdParametersRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateAdParametersResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAdParametersRequest,
      com.google.ads.googleads.v6.services.MutateAdParametersResponse> getMutateAdParametersMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAdParametersRequest, com.google.ads.googleads.v6.services.MutateAdParametersResponse> getMutateAdParametersMethod;
      ...
      synchronized (AdParameterServiceGrpc.class) {
        if ((getMutateAdParametersMethod = AdParameterServiceGrpc.getMutateAdParametersMethod) == null) {
          AdParameterServiceGrpc.getMutateAdParametersMethod = getMutateAdParametersMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateAdParametersRequest, com.google.ads.googleads.v6.services.MutateAdParametersResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdParameters"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateAdParametersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateAdParametersResponse.getDefaultInstance()))
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_PARAMETER:
          serviceImpl.getAdParameter((com.google.ads.googleads.v6.services.GetAdParameterRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdParameter>) responseObserver);
          break;
        case METHODID_MUTATE_AD_PARAMETERS:
          serviceImpl.mutateAdParameters((com.google.ads.googleads.v6.services.MutateAdParametersRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateAdParametersResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdParameterServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.AdParameterServiceProto.getDescriptor();
    }
