...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/ad_group_simulation_service.proto")
public final class AdGroupSimulationServiceGrpc {

  private AdGroupSimulationServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.AdGroupSimulationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest,
      com.google.ads.googleads.v6.resources.AdGroupSimulation> getGetAdGroupSimulationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupSimulation",
      requestType = com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest.class,
      responseType = com.google.ads.googleads.v6.resources.AdGroupSimulation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest,
      com.google.ads.googleads.v6.resources.AdGroupSimulation> getGetAdGroupSimulationMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest, com.google.ads.googleads.v6.resources.AdGroupSimulation> getGetAdGroupSimulationMethod;
      ...
      synchronized (AdGroupSimulationServiceGrpc.class) {
        if ((getGetAdGroupSimulationMethod = AdGroupSimulationServiceGrpc.getGetAdGroupSimulationMethod) == null) {
          AdGroupSimulationServiceGrpc.getGetAdGroupSimulationMethod = getGetAdGroupSimulationMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest, com.google.ads.googleads.v6.resources.AdGroupSimulation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupSimulation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.AdGroupSimulation.getDefaultInstance()))
  ...
  public static abstract class AdGroupSimulationServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroupSimulation(com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdGroupSimulation> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest,
                com.google.ads.googleads.v6.resources.AdGroupSimulation>(
  ...
  public static final class AdGroupSimulationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupSimulationServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.AdGroupSimulation getAdGroupSimulation(com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest request) {
  ...
  public static final class AdGroupSimulationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupSimulationServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.AdGroupSimulation> getAdGroupSimulation(
        com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_SIMULATION:
          serviceImpl.getAdGroupSimulation((com.google.ads.googleads.v6.services.GetAdGroupSimulationRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdGroupSimulation>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupSimulationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.AdGroupSimulationServiceProto.getDescriptor();
    }
