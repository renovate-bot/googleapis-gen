...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/customer_user_access_service.proto")
public final class CustomerUserAccessServiceGrpc {

  private CustomerUserAccessServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.CustomerUserAccessService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomerUserAccessRequest,
      com.google.ads.googleads.v6.resources.CustomerUserAccess> getGetCustomerUserAccessMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCustomerUserAccess",
      requestType = com.google.ads.googleads.v6.services.GetCustomerUserAccessRequest.class,
      responseType = com.google.ads.googleads.v6.resources.CustomerUserAccess.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomerUserAccessRequest,
      com.google.ads.googleads.v6.resources.CustomerUserAccess> getGetCustomerUserAccessMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomerUserAccessRequest, com.google.ads.googleads.v6.resources.CustomerUserAccess> getGetCustomerUserAccessMethod;
      ...
      synchronized (CustomerUserAccessServiceGrpc.class) {
        if ((getGetCustomerUserAccessMethod = CustomerUserAccessServiceGrpc.getGetCustomerUserAccessMethod) == null) {
          CustomerUserAccessServiceGrpc.getGetCustomerUserAccessMethod = getGetCustomerUserAccessMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetCustomerUserAccessRequest, com.google.ads.googleads.v6.resources.CustomerUserAccess>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCustomerUserAccess"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetCustomerUserAccessRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.CustomerUserAccess.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCustomerUserAccessRequest,
      com.google.ads.googleads.v6.services.MutateCustomerUserAccessResponse> getMutateCustomerUserAccessMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCustomerUserAccess",
      requestType = com.google.ads.googleads.v6.services.MutateCustomerUserAccessRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateCustomerUserAccessResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCustomerUserAccessRequest,
      com.google.ads.googleads.v6.services.MutateCustomerUserAccessResponse> getMutateCustomerUserAccessMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCustomerUserAccessRequest, com.google.ads.googleads.v6.services.MutateCustomerUserAccessResponse> getMutateCustomerUserAccessMethod;
      ...
      synchronized (CustomerUserAccessServiceGrpc.class) {
        if ((getMutateCustomerUserAccessMethod = CustomerUserAccessServiceGrpc.getMutateCustomerUserAccessMethod) == null) {
          CustomerUserAccessServiceGrpc.getMutateCustomerUserAccessMethod = getMutateCustomerUserAccessMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateCustomerUserAccessRequest, com.google.ads.googleads.v6.services.MutateCustomerUserAccessResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCustomerUserAccess"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateCustomerUserAccessRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateCustomerUserAccessResponse.getDefaultInstance()))
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CUSTOMER_USER_ACCESS:
          serviceImpl.getCustomerUserAccess((com.google.ads.googleads.v6.services.GetCustomerUserAccessRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CustomerUserAccess>) responseObserver);
          break;
        case METHODID_MUTATE_CUSTOMER_USER_ACCESS:
          serviceImpl.mutateCustomerUserAccess((com.google.ads.googleads.v6.services.MutateCustomerUserAccessRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateCustomerUserAccessResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CustomerUserAccessServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.CustomerUserAccessServiceProto.getDescriptor();
    }
