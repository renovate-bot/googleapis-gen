...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/conversion_adjustment_upload_service.proto")
public final class ConversionAdjustmentUploadServiceGrpc {

  private ConversionAdjustmentUploadServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.ConversionAdjustmentUploadService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest,
      com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse> getUploadConversionAdjustmentsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UploadConversionAdjustments",
      requestType = com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest.class,
      responseType = com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest,
      com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse> getUploadConversionAdjustmentsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest, com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse> getUploadConversionAdjustmentsMethod;
      ...
      synchronized (ConversionAdjustmentUploadServiceGrpc.class) {
        if ((getUploadConversionAdjustmentsMethod = ConversionAdjustmentUploadServiceGrpc.getUploadConversionAdjustmentsMethod) == null) {
          ConversionAdjustmentUploadServiceGrpc.getUploadConversionAdjustmentsMethod = getUploadConversionAdjustmentsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest, com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UploadConversionAdjustments"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse.getDefaultInstance()))
  ...
  public static abstract class ConversionAdjustmentUploadServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void uploadConversionAdjustments(com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest,
                com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse>(
  ...
  public static final class ConversionAdjustmentUploadServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ConversionAdjustmentUploadServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse uploadConversionAdjustments(com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest request) {
  ...
  public static final class ConversionAdjustmentUploadServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ConversionAdjustmentUploadServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse> uploadConversionAdjustments(
        com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPLOAD_CONVERSION_ADJUSTMENTS:
          serviceImpl.uploadConversionAdjustments((com.google.ads.googleads.v6.services.UploadConversionAdjustmentsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.UploadConversionAdjustmentsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ConversionAdjustmentUploadServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.ConversionAdjustmentUploadServiceProto.getDescriptor();
    }
