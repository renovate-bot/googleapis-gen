...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/recommendation_service.proto")
public final class RecommendationServiceGrpc {

  private RecommendationServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.RecommendationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetRecommendationRequest,
      com.google.ads.googleads.v6.resources.Recommendation> getGetRecommendationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetRecommendation",
      requestType = com.google.ads.googleads.v6.services.GetRecommendationRequest.class,
      responseType = com.google.ads.googleads.v6.resources.Recommendation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetRecommendationRequest,
      com.google.ads.googleads.v6.resources.Recommendation> getGetRecommendationMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetRecommendationRequest, com.google.ads.googleads.v6.resources.Recommendation> getGetRecommendationMethod;
      ...
      synchronized (RecommendationServiceGrpc.class) {
        if ((getGetRecommendationMethod = RecommendationServiceGrpc.getGetRecommendationMethod) == null) {
          RecommendationServiceGrpc.getGetRecommendationMethod = getGetRecommendationMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetRecommendationRequest, com.google.ads.googleads.v6.resources.Recommendation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetRecommendation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetRecommendationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.Recommendation.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.ApplyRecommendationRequest,
      com.google.ads.googleads.v6.services.ApplyRecommendationResponse> getApplyRecommendationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ApplyRecommendation",
      requestType = com.google.ads.googleads.v6.services.ApplyRecommendationRequest.class,
      responseType = com.google.ads.googleads.v6.services.ApplyRecommendationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.ApplyRecommendationRequest,
      com.google.ads.googleads.v6.services.ApplyRecommendationResponse> getApplyRecommendationMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.ApplyRecommendationRequest, com.google.ads.googleads.v6.services.ApplyRecommendationResponse> getApplyRecommendationMethod;
      ...
      synchronized (RecommendationServiceGrpc.class) {
        if ((getApplyRecommendationMethod = RecommendationServiceGrpc.getApplyRecommendationMethod) == null) {
          RecommendationServiceGrpc.getApplyRecommendationMethod = getApplyRecommendationMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.ApplyRecommendationRequest, com.google.ads.googleads.v6.services.ApplyRecommendationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ApplyRecommendation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.ApplyRecommendationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.ApplyRecommendationResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.DismissRecommendationRequest,
      com.google.ads.googleads.v6.services.DismissRecommendationResponse> getDismissRecommendationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DismissRecommendation",
      requestType = com.google.ads.googleads.v6.services.DismissRecommendationRequest.class,
      responseType = com.google.ads.googleads.v6.services.DismissRecommendationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.DismissRecommendationRequest,
      com.google.ads.googleads.v6.services.DismissRecommendationResponse> getDismissRecommendationMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.DismissRecommendationRequest, com.google.ads.googleads.v6.services.DismissRecommendationResponse> getDismissRecommendationMethod;
      ...
      synchronized (RecommendationServiceGrpc.class) {
        if ((getDismissRecommendationMethod = RecommendationServiceGrpc.getDismissRecommendationMethod) == null) {
          RecommendationServiceGrpc.getDismissRecommendationMethod = getDismissRecommendationMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.DismissRecommendationRequest, com.google.ads.googleads.v6.services.DismissRecommendationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DismissRecommendation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.DismissRecommendationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.DismissRecommendationResponse.getDefaultInstance()))
  ...
  public static abstract class RecommendationServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getRecommendation(com.google.ads.googleads.v6.services.GetRecommendationRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.Recommendation> responseObserver) {
     ...
     * </pre>
     */
    public void applyRecommendation(com.google.ads.googleads.v6.services.ApplyRecommendationRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.ApplyRecommendationResponse> responseObserver) {
     ...
     * </pre>
     */
    public void dismissRecommendation(com.google.ads.googleads.v6.services.DismissRecommendationRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.DismissRecommendationResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetRecommendationRequest,
                com.google.ads.googleads.v6.resources.Recommendation>(
                  this, METHODID_GET_RECOMMENDATION)))
          .addMethod(
            getApplyRecommendationMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.ApplyRecommendationRequest,
                com.google.ads.googleads.v6.services.ApplyRecommendationResponse>(
                  this, METHODID_APPLY_RECOMMENDATION)))
          .addMethod(
            getDismissRecommendationMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.DismissRecommendationRequest,
                com.google.ads.googleads.v6.services.DismissRecommendationResponse>(
  ...
  public static final class RecommendationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RecommendationServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.Recommendation getRecommendation(com.google.ads.googleads.v6.services.GetRecommendationRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.ApplyRecommendationResponse applyRecommendation(com.google.ads.googleads.v6.services.ApplyRecommendationRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.DismissRecommendationResponse dismissRecommendation(com.google.ads.googleads.v6.services.DismissRecommendationRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class RecommendationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RecommendationServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.Recommendation> getRecommendation(
        com.google.ads.googleads.v6.services.GetRecommendationRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.ApplyRecommendationResponse> applyRecommendation(
        com.google.ads.googleads.v6.services.ApplyRecommendationRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.DismissRecommendationResponse> dismissRecommendation(
        com.google.ads.googleads.v6.services.DismissRecommendationRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_RECOMMENDATION:
          serviceImpl.getRecommendation((com.google.ads.googleads.v6.services.GetRecommendationRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.Recommendation>) responseObserver);
          break;
        case METHODID_APPLY_RECOMMENDATION:
          serviceImpl.applyRecommendation((com.google.ads.googleads.v6.services.ApplyRecommendationRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.ApplyRecommendationResponse>) responseObserver);
          break;
        case METHODID_DISMISS_RECOMMENDATION:
          serviceImpl.dismissRecommendation((com.google.ads.googleads.v6.services.DismissRecommendationRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.DismissRecommendationResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class RecommendationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.RecommendationServiceProto.getDescriptor();
    }
