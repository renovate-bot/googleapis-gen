...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/conversion_upload_service.proto")
public final class ConversionUploadServiceGrpc {

  private ConversionUploadServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.ConversionUploadService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.UploadClickConversionsRequest,
      com.google.ads.googleads.v6.services.UploadClickConversionsResponse> getUploadClickConversionsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UploadClickConversions",
      requestType = com.google.ads.googleads.v6.services.UploadClickConversionsRequest.class,
      responseType = com.google.ads.googleads.v6.services.UploadClickConversionsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.UploadClickConversionsRequest,
      com.google.ads.googleads.v6.services.UploadClickConversionsResponse> getUploadClickConversionsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.UploadClickConversionsRequest, com.google.ads.googleads.v6.services.UploadClickConversionsResponse> getUploadClickConversionsMethod;
      ...
      synchronized (ConversionUploadServiceGrpc.class) {
        if ((getUploadClickConversionsMethod = ConversionUploadServiceGrpc.getUploadClickConversionsMethod) == null) {
          ConversionUploadServiceGrpc.getUploadClickConversionsMethod = getUploadClickConversionsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.UploadClickConversionsRequest, com.google.ads.googleads.v6.services.UploadClickConversionsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UploadClickConversions"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.UploadClickConversionsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.UploadClickConversionsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.UploadCallConversionsRequest,
      com.google.ads.googleads.v6.services.UploadCallConversionsResponse> getUploadCallConversionsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UploadCallConversions",
      requestType = com.google.ads.googleads.v6.services.UploadCallConversionsRequest.class,
      responseType = com.google.ads.googleads.v6.services.UploadCallConversionsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.UploadCallConversionsRequest,
      com.google.ads.googleads.v6.services.UploadCallConversionsResponse> getUploadCallConversionsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.UploadCallConversionsRequest, com.google.ads.googleads.v6.services.UploadCallConversionsResponse> getUploadCallConversionsMethod;
      ...
      synchronized (ConversionUploadServiceGrpc.class) {
        if ((getUploadCallConversionsMethod = ConversionUploadServiceGrpc.getUploadCallConversionsMethod) == null) {
          ConversionUploadServiceGrpc.getUploadCallConversionsMethod = getUploadCallConversionsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.UploadCallConversionsRequest, com.google.ads.googleads.v6.services.UploadCallConversionsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UploadCallConversions"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.UploadCallConversionsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.UploadCallConversionsResponse.getDefaultInstance()))
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPLOAD_CLICK_CONVERSIONS:
          serviceImpl.uploadClickConversions((com.google.ads.googleads.v6.services.UploadClickConversionsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.UploadClickConversionsResponse>) responseObserver);
          break;
        case METHODID_UPLOAD_CALL_CONVERSIONS:
          serviceImpl.uploadCallConversions((com.google.ads.googleads.v6.services.UploadCallConversionsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.UploadCallConversionsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ConversionUploadServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.ConversionUploadServiceProto.getDescriptor();
    }
