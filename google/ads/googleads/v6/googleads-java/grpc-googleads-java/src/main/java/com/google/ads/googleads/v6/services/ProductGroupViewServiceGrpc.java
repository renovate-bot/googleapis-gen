...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/product_group_view_service.proto")
public final class ProductGroupViewServiceGrpc {

  private ProductGroupViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.ProductGroupViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetProductGroupViewRequest,
      com.google.ads.googleads.v6.resources.ProductGroupView> getGetProductGroupViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetProductGroupView",
      requestType = com.google.ads.googleads.v6.services.GetProductGroupViewRequest.class,
      responseType = com.google.ads.googleads.v6.resources.ProductGroupView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetProductGroupViewRequest,
      com.google.ads.googleads.v6.resources.ProductGroupView> getGetProductGroupViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetProductGroupViewRequest, com.google.ads.googleads.v6.resources.ProductGroupView> getGetProductGroupViewMethod;
      ...
      synchronized (ProductGroupViewServiceGrpc.class) {
        if ((getGetProductGroupViewMethod = ProductGroupViewServiceGrpc.getGetProductGroupViewMethod) == null) {
          ProductGroupViewServiceGrpc.getGetProductGroupViewMethod = getGetProductGroupViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetProductGroupViewRequest, com.google.ads.googleads.v6.resources.ProductGroupView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetProductGroupView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetProductGroupViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.ProductGroupView.getDefaultInstance()))
  ...
  public static abstract class ProductGroupViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getProductGroupView(com.google.ads.googleads.v6.services.GetProductGroupViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.ProductGroupView> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetProductGroupViewRequest,
                com.google.ads.googleads.v6.resources.ProductGroupView>(
  ...
  public static final class ProductGroupViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ProductGroupViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.ProductGroupView getProductGroupView(com.google.ads.googleads.v6.services.GetProductGroupViewRequest request) {
  ...
  public static final class ProductGroupViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ProductGroupViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.ProductGroupView> getProductGroupView(
        com.google.ads.googleads.v6.services.GetProductGroupViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PRODUCT_GROUP_VIEW:
          serviceImpl.getProductGroupView((com.google.ads.googleads.v6.services.GetProductGroupViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.ProductGroupView>) responseObserver);
          break;
        default:
  ...
  private static abstract class ProductGroupViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.ProductGroupViewServiceProto.getDescriptor();
    }
