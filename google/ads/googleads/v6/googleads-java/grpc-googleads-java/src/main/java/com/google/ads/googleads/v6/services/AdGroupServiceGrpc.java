...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/ad_group_service.proto")
public final class AdGroupServiceGrpc {

  private AdGroupServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.AdGroupService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupRequest,
      com.google.ads.googleads.v6.resources.AdGroup> getGetAdGroupMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroup",
      requestType = com.google.ads.googleads.v6.services.GetAdGroupRequest.class,
      responseType = com.google.ads.googleads.v6.resources.AdGroup.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupRequest,
      com.google.ads.googleads.v6.resources.AdGroup> getGetAdGroupMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupRequest, com.google.ads.googleads.v6.resources.AdGroup> getGetAdGroupMethod;
      ...
      synchronized (AdGroupServiceGrpc.class) {
        if ((getGetAdGroupMethod = AdGroupServiceGrpc.getGetAdGroupMethod) == null) {
          AdGroupServiceGrpc.getGetAdGroupMethod = getGetAdGroupMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetAdGroupRequest, com.google.ads.googleads.v6.resources.AdGroup>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetAdGroupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.AdGroup.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAdGroupsRequest,
      com.google.ads.googleads.v6.services.MutateAdGroupsResponse> getMutateAdGroupsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateAdGroups",
      requestType = com.google.ads.googleads.v6.services.MutateAdGroupsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateAdGroupsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAdGroupsRequest,
      com.google.ads.googleads.v6.services.MutateAdGroupsResponse> getMutateAdGroupsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateAdGroupsRequest, com.google.ads.googleads.v6.services.MutateAdGroupsResponse> getMutateAdGroupsMethod;
      ...
      synchronized (AdGroupServiceGrpc.class) {
        if ((getMutateAdGroupsMethod = AdGroupServiceGrpc.getMutateAdGroupsMethod) == null) {
          AdGroupServiceGrpc.getMutateAdGroupsMethod = getMutateAdGroupsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateAdGroupsRequest, com.google.ads.googleads.v6.services.MutateAdGroupsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateAdGroups"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateAdGroupsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateAdGroupsResponse.getDefaultInstance()))
  ...
  public static abstract class AdGroupServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroup(com.google.ads.googleads.v6.services.GetAdGroupRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdGroup> responseObserver) {
     ...
     * </pre>
     */
    public void mutateAdGroups(com.google.ads.googleads.v6.services.MutateAdGroupsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateAdGroupsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetAdGroupRequest,
                com.google.ads.googleads.v6.resources.AdGroup>(
                  this, METHODID_GET_AD_GROUP)))
          .addMethod(
            getMutateAdGroupsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateAdGroupsRequest,
                com.google.ads.googleads.v6.services.MutateAdGroupsResponse>(
  ...
  public static final class AdGroupServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.AdGroup getAdGroup(com.google.ads.googleads.v6.services.GetAdGroupRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateAdGroupsResponse mutateAdGroups(com.google.ads.googleads.v6.services.MutateAdGroupsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AdGroupServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.AdGroup> getAdGroup(
        com.google.ads.googleads.v6.services.GetAdGroupRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateAdGroupsResponse> mutateAdGroups(
        com.google.ads.googleads.v6.services.MutateAdGroupsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP:
          serviceImpl.getAdGroup((com.google.ads.googleads.v6.services.GetAdGroupRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdGroup>) responseObserver);
          break;
        case METHODID_MUTATE_AD_GROUPS:
          serviceImpl.mutateAdGroups((com.google.ads.googleads.v6.services.MutateAdGroupsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateAdGroupsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.AdGroupServiceProto.getDescriptor();
    }
