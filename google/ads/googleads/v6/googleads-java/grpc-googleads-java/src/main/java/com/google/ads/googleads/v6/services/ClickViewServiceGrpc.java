...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/click_view_service.proto")
public final class ClickViewServiceGrpc {

  private ClickViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.ClickViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetClickViewRequest,
      com.google.ads.googleads.v6.resources.ClickView> getGetClickViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetClickView",
      requestType = com.google.ads.googleads.v6.services.GetClickViewRequest.class,
      responseType = com.google.ads.googleads.v6.resources.ClickView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetClickViewRequest,
      com.google.ads.googleads.v6.resources.ClickView> getGetClickViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetClickViewRequest, com.google.ads.googleads.v6.resources.ClickView> getGetClickViewMethod;
      ...
      synchronized (ClickViewServiceGrpc.class) {
        if ((getGetClickViewMethod = ClickViewServiceGrpc.getGetClickViewMethod) == null) {
          ClickViewServiceGrpc.getGetClickViewMethod = getGetClickViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetClickViewRequest, com.google.ads.googleads.v6.resources.ClickView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetClickView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetClickViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.ClickView.getDefaultInstance()))
  ...
  public static abstract class ClickViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getClickView(com.google.ads.googleads.v6.services.GetClickViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.ClickView> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetClickViewMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetClickViewRequest,
                com.google.ads.googleads.v6.resources.ClickView>(
  ...
  public static final class ClickViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ClickViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.ClickView getClickView(com.google.ads.googleads.v6.services.GetClickViewRequest request) {
  ...
  public static final class ClickViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ClickViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.ClickView> getClickView(
        com.google.ads.googleads.v6.services.GetClickViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CLICK_VIEW:
          serviceImpl.getClickView((com.google.ads.googleads.v6.services.GetClickViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.ClickView>) responseObserver);
          break;
        default:
  ...
  private static abstract class ClickViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.ClickViewServiceProto.getDescriptor();
    }
