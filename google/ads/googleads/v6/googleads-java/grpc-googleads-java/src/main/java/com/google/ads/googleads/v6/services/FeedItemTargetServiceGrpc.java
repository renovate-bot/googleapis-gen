...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/feed_item_target_service.proto")
public final class FeedItemTargetServiceGrpc {

  private FeedItemTargetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.FeedItemTargetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetFeedItemTargetRequest,
      com.google.ads.googleads.v6.resources.FeedItemTarget> getGetFeedItemTargetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeedItemTarget",
      requestType = com.google.ads.googleads.v6.services.GetFeedItemTargetRequest.class,
      responseType = com.google.ads.googleads.v6.resources.FeedItemTarget.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetFeedItemTargetRequest,
      com.google.ads.googleads.v6.resources.FeedItemTarget> getGetFeedItemTargetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetFeedItemTargetRequest, com.google.ads.googleads.v6.resources.FeedItemTarget> getGetFeedItemTargetMethod;
      ...
      synchronized (FeedItemTargetServiceGrpc.class) {
        if ((getGetFeedItemTargetMethod = FeedItemTargetServiceGrpc.getGetFeedItemTargetMethod) == null) {
          FeedItemTargetServiceGrpc.getGetFeedItemTargetMethod = getGetFeedItemTargetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetFeedItemTargetRequest, com.google.ads.googleads.v6.resources.FeedItemTarget>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeedItemTarget"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetFeedItemTargetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.FeedItemTarget.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest,
      com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse> getMutateFeedItemTargetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateFeedItemTargets",
      requestType = com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest,
      com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse> getMutateFeedItemTargetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest, com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse> getMutateFeedItemTargetsMethod;
      ...
      synchronized (FeedItemTargetServiceGrpc.class) {
        if ((getMutateFeedItemTargetsMethod = FeedItemTargetServiceGrpc.getMutateFeedItemTargetsMethod) == null) {
          FeedItemTargetServiceGrpc.getMutateFeedItemTargetsMethod = getMutateFeedItemTargetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest, com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateFeedItemTargets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse.getDefaultInstance()))
  ...
  public static abstract class FeedItemTargetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeedItemTarget(com.google.ads.googleads.v6.services.GetFeedItemTargetRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.FeedItemTarget> responseObserver) {
     ...
     * </pre>
     */
    public void mutateFeedItemTargets(com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetFeedItemTargetRequest,
                com.google.ads.googleads.v6.resources.FeedItemTarget>(
                  this, METHODID_GET_FEED_ITEM_TARGET)))
          .addMethod(
            getMutateFeedItemTargetsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest,
                com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse>(
  ...
  public static final class FeedItemTargetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FeedItemTargetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.FeedItemTarget getFeedItemTarget(com.google.ads.googleads.v6.services.GetFeedItemTargetRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse mutateFeedItemTargets(com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class FeedItemTargetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FeedItemTargetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.FeedItemTarget> getFeedItemTarget(
        com.google.ads.googleads.v6.services.GetFeedItemTargetRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse> mutateFeedItemTargets(
        com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEED_ITEM_TARGET:
          serviceImpl.getFeedItemTarget((com.google.ads.googleads.v6.services.GetFeedItemTargetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.FeedItemTarget>) responseObserver);
          break;
        case METHODID_MUTATE_FEED_ITEM_TARGETS:
          serviceImpl.mutateFeedItemTargets((com.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class FeedItemTargetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.FeedItemTargetServiceProto.getDescriptor();
    }
