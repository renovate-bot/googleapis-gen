...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/feed_item_service.proto")
public final class FeedItemServiceGrpc {

  private FeedItemServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.FeedItemService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetFeedItemRequest,
      com.google.ads.googleads.v6.resources.FeedItem> getGetFeedItemMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeedItem",
      requestType = com.google.ads.googleads.v6.services.GetFeedItemRequest.class,
      responseType = com.google.ads.googleads.v6.resources.FeedItem.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetFeedItemRequest,
      com.google.ads.googleads.v6.resources.FeedItem> getGetFeedItemMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetFeedItemRequest, com.google.ads.googleads.v6.resources.FeedItem> getGetFeedItemMethod;
      ...
      synchronized (FeedItemServiceGrpc.class) {
        if ((getGetFeedItemMethod = FeedItemServiceGrpc.getGetFeedItemMethod) == null) {
          FeedItemServiceGrpc.getGetFeedItemMethod = getGetFeedItemMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetFeedItemRequest, com.google.ads.googleads.v6.resources.FeedItem>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeedItem"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetFeedItemRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.FeedItem.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateFeedItemsRequest,
      com.google.ads.googleads.v6.services.MutateFeedItemsResponse> getMutateFeedItemsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateFeedItems",
      requestType = com.google.ads.googleads.v6.services.MutateFeedItemsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateFeedItemsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateFeedItemsRequest,
      com.google.ads.googleads.v6.services.MutateFeedItemsResponse> getMutateFeedItemsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateFeedItemsRequest, com.google.ads.googleads.v6.services.MutateFeedItemsResponse> getMutateFeedItemsMethod;
      ...
      synchronized (FeedItemServiceGrpc.class) {
        if ((getMutateFeedItemsMethod = FeedItemServiceGrpc.getMutateFeedItemsMethod) == null) {
          FeedItemServiceGrpc.getMutateFeedItemsMethod = getMutateFeedItemsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateFeedItemsRequest, com.google.ads.googleads.v6.services.MutateFeedItemsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateFeedItems"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateFeedItemsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateFeedItemsResponse.getDefaultInstance()))
  ...
  public static abstract class FeedItemServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeedItem(com.google.ads.googleads.v6.services.GetFeedItemRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.FeedItem> responseObserver) {
     ...
     * </pre>
     */
    public void mutateFeedItems(com.google.ads.googleads.v6.services.MutateFeedItemsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateFeedItemsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetFeedItemRequest,
                com.google.ads.googleads.v6.resources.FeedItem>(
                  this, METHODID_GET_FEED_ITEM)))
          .addMethod(
            getMutateFeedItemsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateFeedItemsRequest,
                com.google.ads.googleads.v6.services.MutateFeedItemsResponse>(
  ...
  public static final class FeedItemServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FeedItemServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.FeedItem getFeedItem(com.google.ads.googleads.v6.services.GetFeedItemRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateFeedItemsResponse mutateFeedItems(com.google.ads.googleads.v6.services.MutateFeedItemsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class FeedItemServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FeedItemServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.FeedItem> getFeedItem(
        com.google.ads.googleads.v6.services.GetFeedItemRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateFeedItemsResponse> mutateFeedItems(
        com.google.ads.googleads.v6.services.MutateFeedItemsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEED_ITEM:
          serviceImpl.getFeedItem((com.google.ads.googleads.v6.services.GetFeedItemRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.FeedItem>) responseObserver);
          break;
        case METHODID_MUTATE_FEED_ITEMS:
          serviceImpl.mutateFeedItems((com.google.ads.googleads.v6.services.MutateFeedItemsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateFeedItemsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class FeedItemServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.FeedItemServiceProto.getDescriptor();
    }
