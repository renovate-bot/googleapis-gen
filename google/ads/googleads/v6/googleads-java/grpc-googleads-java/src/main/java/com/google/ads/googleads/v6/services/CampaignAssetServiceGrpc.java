...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/campaign_asset_service.proto")
public final class CampaignAssetServiceGrpc {

  private CampaignAssetServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.CampaignAssetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCampaignAssetRequest,
      com.google.ads.googleads.v6.resources.CampaignAsset> getGetCampaignAssetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCampaignAsset",
      requestType = com.google.ads.googleads.v6.services.GetCampaignAssetRequest.class,
      responseType = com.google.ads.googleads.v6.resources.CampaignAsset.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCampaignAssetRequest,
      com.google.ads.googleads.v6.resources.CampaignAsset> getGetCampaignAssetMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCampaignAssetRequest, com.google.ads.googleads.v6.resources.CampaignAsset> getGetCampaignAssetMethod;
      ...
      synchronized (CampaignAssetServiceGrpc.class) {
        if ((getGetCampaignAssetMethod = CampaignAssetServiceGrpc.getGetCampaignAssetMethod) == null) {
          CampaignAssetServiceGrpc.getGetCampaignAssetMethod = getGetCampaignAssetMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetCampaignAssetRequest, com.google.ads.googleads.v6.resources.CampaignAsset>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCampaignAsset"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetCampaignAssetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.CampaignAsset.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest,
      com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse> getMutateCampaignAssetsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCampaignAssets",
      requestType = com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest,
      com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse> getMutateCampaignAssetsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest, com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse> getMutateCampaignAssetsMethod;
      ...
      synchronized (CampaignAssetServiceGrpc.class) {
        if ((getMutateCampaignAssetsMethod = CampaignAssetServiceGrpc.getMutateCampaignAssetsMethod) == null) {
          CampaignAssetServiceGrpc.getMutateCampaignAssetsMethod = getMutateCampaignAssetsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest, com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCampaignAssets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse.getDefaultInstance()))
  ...
  public static abstract class CampaignAssetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCampaignAsset(com.google.ads.googleads.v6.services.GetCampaignAssetRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CampaignAsset> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetCampaignAssetMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public void mutateCampaignAssets(com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetCampaignAssetRequest,
                com.google.ads.googleads.v6.resources.CampaignAsset>(
                  this, METHODID_GET_CAMPAIGN_ASSET)))
          .addMethod(
            getMutateCampaignAssetsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest,
                com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse>(
  ...
  public static final class CampaignAssetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CampaignAssetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.CampaignAsset getCampaignAsset(com.google.ads.googleads.v6.services.GetCampaignAssetRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse mutateCampaignAssets(com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CampaignAssetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CampaignAssetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.CampaignAsset> getCampaignAsset(
        com.google.ads.googleads.v6.services.GetCampaignAssetRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse> mutateCampaignAssets(
        com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAMPAIGN_ASSET:
          serviceImpl.getCampaignAsset((com.google.ads.googleads.v6.services.GetCampaignAssetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CampaignAsset>) responseObserver);
          break;
        case METHODID_MUTATE_CAMPAIGN_ASSETS:
          serviceImpl.mutateCampaignAssets((com.google.ads.googleads.v6.services.MutateCampaignAssetsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateCampaignAssetsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CampaignAssetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.CampaignAssetServiceProto.getDescriptor();
    }
