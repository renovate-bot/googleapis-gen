...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/ad_group_criterion_simulation_service.proto")
public final class AdGroupCriterionSimulationServiceGrpc {

  private AdGroupCriterionSimulationServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.AdGroupCriterionSimulationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest,
      com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation> getGetAdGroupCriterionSimulationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAdGroupCriterionSimulation",
      requestType = com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest.class,
      responseType = com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest,
      com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation> getGetAdGroupCriterionSimulationMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest, com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation> getGetAdGroupCriterionSimulationMethod;
      ...
      synchronized (AdGroupCriterionSimulationServiceGrpc.class) {
        if ((getGetAdGroupCriterionSimulationMethod = AdGroupCriterionSimulationServiceGrpc.getGetAdGroupCriterionSimulationMethod) == null) {
          AdGroupCriterionSimulationServiceGrpc.getGetAdGroupCriterionSimulationMethod = getGetAdGroupCriterionSimulationMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest, com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAdGroupCriterionSimulation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation.getDefaultInstance()))
  ...
  public static abstract class AdGroupCriterionSimulationServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAdGroupCriterionSimulation(com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest,
                com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation>(
  ...
  public static final class AdGroupCriterionSimulationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AdGroupCriterionSimulationServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation getAdGroupCriterionSimulation(com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest request) {
  ...
  public static final class AdGroupCriterionSimulationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AdGroupCriterionSimulationServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation> getAdGroupCriterionSimulation(
        com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AD_GROUP_CRITERION_SIMULATION:
          serviceImpl.getAdGroupCriterionSimulation((com.google.ads.googleads.v6.services.GetAdGroupCriterionSimulationRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.AdGroupCriterionSimulation>) responseObserver);
          break;
        default:
  ...
  private static abstract class AdGroupCriterionSimulationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.AdGroupCriterionSimulationServiceProto.getDescriptor();
    }
