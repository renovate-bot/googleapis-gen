...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/shared_criterion_service.proto")
public final class SharedCriterionServiceGrpc {

  private SharedCriterionServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.SharedCriterionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetSharedCriterionRequest,
      com.google.ads.googleads.v6.resources.SharedCriterion> getGetSharedCriterionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetSharedCriterion",
      requestType = com.google.ads.googleads.v6.services.GetSharedCriterionRequest.class,
      responseType = com.google.ads.googleads.v6.resources.SharedCriterion.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetSharedCriterionRequest,
      com.google.ads.googleads.v6.resources.SharedCriterion> getGetSharedCriterionMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetSharedCriterionRequest, com.google.ads.googleads.v6.resources.SharedCriterion> getGetSharedCriterionMethod;
      ...
      synchronized (SharedCriterionServiceGrpc.class) {
        if ((getGetSharedCriterionMethod = SharedCriterionServiceGrpc.getGetSharedCriterionMethod) == null) {
          SharedCriterionServiceGrpc.getGetSharedCriterionMethod = getGetSharedCriterionMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetSharedCriterionRequest, com.google.ads.googleads.v6.resources.SharedCriterion>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetSharedCriterion"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetSharedCriterionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.SharedCriterion.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest,
      com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse> getMutateSharedCriteriaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateSharedCriteria",
      requestType = com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest,
      com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse> getMutateSharedCriteriaMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest, com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse> getMutateSharedCriteriaMethod;
      ...
      synchronized (SharedCriterionServiceGrpc.class) {
        if ((getMutateSharedCriteriaMethod = SharedCriterionServiceGrpc.getMutateSharedCriteriaMethod) == null) {
          SharedCriterionServiceGrpc.getMutateSharedCriteriaMethod = getMutateSharedCriteriaMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest, com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateSharedCriteria"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse.getDefaultInstance()))
  ...
  public static abstract class SharedCriterionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getSharedCriterion(com.google.ads.googleads.v6.services.GetSharedCriterionRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.SharedCriterion> responseObserver) {
     ...
     * </pre>
     */
    public void mutateSharedCriteria(com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetSharedCriterionRequest,
                com.google.ads.googleads.v6.resources.SharedCriterion>(
                  this, METHODID_GET_SHARED_CRITERION)))
          .addMethod(
            getMutateSharedCriteriaMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest,
                com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse>(
  ...
  public static final class SharedCriterionServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SharedCriterionServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.SharedCriterion getSharedCriterion(com.google.ads.googleads.v6.services.GetSharedCriterionRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse mutateSharedCriteria(com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class SharedCriterionServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SharedCriterionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.SharedCriterion> getSharedCriterion(
        com.google.ads.googleads.v6.services.GetSharedCriterionRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse> mutateSharedCriteria(
        com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SHARED_CRITERION:
          serviceImpl.getSharedCriterion((com.google.ads.googleads.v6.services.GetSharedCriterionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.SharedCriterion>) responseObserver);
          break;
        case METHODID_MUTATE_SHARED_CRITERIA:
          serviceImpl.mutateSharedCriteria((com.google.ads.googleads.v6.services.MutateSharedCriteriaRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateSharedCriteriaResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SharedCriterionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.SharedCriterionServiceProto.getDescriptor();
    }
