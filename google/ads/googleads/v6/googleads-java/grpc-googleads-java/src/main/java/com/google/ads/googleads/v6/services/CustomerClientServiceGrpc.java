...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/customer_client_service.proto")
public final class CustomerClientServiceGrpc {

  private CustomerClientServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.CustomerClientService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomerClientRequest,
      com.google.ads.googleads.v6.resources.CustomerClient> getGetCustomerClientMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCustomerClient",
      requestType = com.google.ads.googleads.v6.services.GetCustomerClientRequest.class,
      responseType = com.google.ads.googleads.v6.resources.CustomerClient.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomerClientRequest,
      com.google.ads.googleads.v6.resources.CustomerClient> getGetCustomerClientMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomerClientRequest, com.google.ads.googleads.v6.resources.CustomerClient> getGetCustomerClientMethod;
      ...
      synchronized (CustomerClientServiceGrpc.class) {
        if ((getGetCustomerClientMethod = CustomerClientServiceGrpc.getGetCustomerClientMethod) == null) {
          CustomerClientServiceGrpc.getGetCustomerClientMethod = getGetCustomerClientMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetCustomerClientRequest, com.google.ads.googleads.v6.resources.CustomerClient>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCustomerClient"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetCustomerClientRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.CustomerClient.getDefaultInstance()))
  ...
  public static abstract class CustomerClientServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCustomerClient(com.google.ads.googleads.v6.services.GetCustomerClientRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CustomerClient> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetCustomerClientMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetCustomerClientRequest,
                com.google.ads.googleads.v6.resources.CustomerClient>(
  ...
  public static final class CustomerClientServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CustomerClientServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.CustomerClient getCustomerClient(com.google.ads.googleads.v6.services.GetCustomerClientRequest request) {
  ...
  public static final class CustomerClientServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CustomerClientServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.CustomerClient> getCustomerClient(
        com.google.ads.googleads.v6.services.GetCustomerClientRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CUSTOMER_CLIENT:
          serviceImpl.getCustomerClient((com.google.ads.googleads.v6.services.GetCustomerClientRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CustomerClient>) responseObserver);
          break;
        default:
  ...
  private static abstract class CustomerClientServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.CustomerClientServiceProto.getDescriptor();
    }
