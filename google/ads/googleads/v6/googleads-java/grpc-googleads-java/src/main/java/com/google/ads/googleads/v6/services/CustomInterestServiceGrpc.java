...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/custom_interest_service.proto")
public final class CustomInterestServiceGrpc {

  private CustomInterestServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.CustomInterestService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomInterestRequest,
      com.google.ads.googleads.v6.resources.CustomInterest> getGetCustomInterestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCustomInterest",
      requestType = com.google.ads.googleads.v6.services.GetCustomInterestRequest.class,
      responseType = com.google.ads.googleads.v6.resources.CustomInterest.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomInterestRequest,
      com.google.ads.googleads.v6.resources.CustomInterest> getGetCustomInterestMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetCustomInterestRequest, com.google.ads.googleads.v6.resources.CustomInterest> getGetCustomInterestMethod;
      ...
      synchronized (CustomInterestServiceGrpc.class) {
        if ((getGetCustomInterestMethod = CustomInterestServiceGrpc.getGetCustomInterestMethod) == null) {
          CustomInterestServiceGrpc.getGetCustomInterestMethod = getGetCustomInterestMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetCustomInterestRequest, com.google.ads.googleads.v6.resources.CustomInterest>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCustomInterest"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetCustomInterestRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.CustomInterest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCustomInterestsRequest,
      com.google.ads.googleads.v6.services.MutateCustomInterestsResponse> getMutateCustomInterestsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateCustomInterests",
      requestType = com.google.ads.googleads.v6.services.MutateCustomInterestsRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateCustomInterestsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCustomInterestsRequest,
      com.google.ads.googleads.v6.services.MutateCustomInterestsResponse> getMutateCustomInterestsMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateCustomInterestsRequest, com.google.ads.googleads.v6.services.MutateCustomInterestsResponse> getMutateCustomInterestsMethod;
      ...
      synchronized (CustomInterestServiceGrpc.class) {
        if ((getMutateCustomInterestsMethod = CustomInterestServiceGrpc.getMutateCustomInterestsMethod) == null) {
          CustomInterestServiceGrpc.getMutateCustomInterestsMethod = getMutateCustomInterestsMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateCustomInterestsRequest, com.google.ads.googleads.v6.services.MutateCustomInterestsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateCustomInterests"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateCustomInterestsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateCustomInterestsResponse.getDefaultInstance()))
  ...
  public static abstract class CustomInterestServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCustomInterest(com.google.ads.googleads.v6.services.GetCustomInterestRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CustomInterest> responseObserver) {
     ...
     * </pre>
     */
    public void mutateCustomInterests(com.google.ads.googleads.v6.services.MutateCustomInterestsRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateCustomInterestsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetCustomInterestRequest,
                com.google.ads.googleads.v6.resources.CustomInterest>(
                  this, METHODID_GET_CUSTOM_INTEREST)))
          .addMethod(
            getMutateCustomInterestsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateCustomInterestsRequest,
                com.google.ads.googleads.v6.services.MutateCustomInterestsResponse>(
  ...
  public static final class CustomInterestServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CustomInterestServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.CustomInterest getCustomInterest(com.google.ads.googleads.v6.services.GetCustomInterestRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateCustomInterestsResponse mutateCustomInterests(com.google.ads.googleads.v6.services.MutateCustomInterestsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CustomInterestServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CustomInterestServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.CustomInterest> getCustomInterest(
        com.google.ads.googleads.v6.services.GetCustomInterestRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateCustomInterestsResponse> mutateCustomInterests(
        com.google.ads.googleads.v6.services.MutateCustomInterestsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CUSTOM_INTEREST:
          serviceImpl.getCustomInterest((com.google.ads.googleads.v6.services.GetCustomInterestRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.CustomInterest>) responseObserver);
          break;
        case METHODID_MUTATE_CUSTOM_INTERESTS:
          serviceImpl.mutateCustomInterests((com.google.ads.googleads.v6.services.MutateCustomInterestsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateCustomInterestsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CustomInterestServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.CustomInterestServiceProto.getDescriptor();
    }
