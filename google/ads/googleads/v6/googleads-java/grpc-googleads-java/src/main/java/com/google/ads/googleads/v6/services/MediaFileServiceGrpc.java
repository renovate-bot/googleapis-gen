...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/media_file_service.proto")
public final class MediaFileServiceGrpc {

  private MediaFileServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.MediaFileService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetMediaFileRequest,
      com.google.ads.googleads.v6.resources.MediaFile> getGetMediaFileMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMediaFile",
      requestType = com.google.ads.googleads.v6.services.GetMediaFileRequest.class,
      responseType = com.google.ads.googleads.v6.resources.MediaFile.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetMediaFileRequest,
      com.google.ads.googleads.v6.resources.MediaFile> getGetMediaFileMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetMediaFileRequest, com.google.ads.googleads.v6.resources.MediaFile> getGetMediaFileMethod;
      ...
      synchronized (MediaFileServiceGrpc.class) {
        if ((getGetMediaFileMethod = MediaFileServiceGrpc.getGetMediaFileMethod) == null) {
          MediaFileServiceGrpc.getGetMediaFileMethod = getGetMediaFileMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetMediaFileRequest, com.google.ads.googleads.v6.resources.MediaFile>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetMediaFile"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetMediaFileRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.MediaFile.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateMediaFilesRequest,
      com.google.ads.googleads.v6.services.MutateMediaFilesResponse> getMutateMediaFilesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MutateMediaFiles",
      requestType = com.google.ads.googleads.v6.services.MutateMediaFilesRequest.class,
      responseType = com.google.ads.googleads.v6.services.MutateMediaFilesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateMediaFilesRequest,
      com.google.ads.googleads.v6.services.MutateMediaFilesResponse> getMutateMediaFilesMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.MutateMediaFilesRequest, com.google.ads.googleads.v6.services.MutateMediaFilesResponse> getMutateMediaFilesMethod;
      ...
      synchronized (MediaFileServiceGrpc.class) {
        if ((getMutateMediaFilesMethod = MediaFileServiceGrpc.getMutateMediaFilesMethod) == null) {
          MediaFileServiceGrpc.getMutateMediaFilesMethod = getMutateMediaFilesMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.MutateMediaFilesRequest, com.google.ads.googleads.v6.services.MutateMediaFilesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MutateMediaFiles"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateMediaFilesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.MutateMediaFilesResponse.getDefaultInstance()))
  ...
  public static abstract class MediaFileServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getMediaFile(com.google.ads.googleads.v6.services.GetMediaFileRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.MediaFile> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetMediaFileMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public void mutateMediaFiles(com.google.ads.googleads.v6.services.MutateMediaFilesRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateMediaFilesResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetMediaFileRequest,
                com.google.ads.googleads.v6.resources.MediaFile>(
                  this, METHODID_GET_MEDIA_FILE)))
          .addMethod(
            getMutateMediaFilesMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.MutateMediaFilesRequest,
                com.google.ads.googleads.v6.services.MutateMediaFilesResponse>(
  ...
  public static final class MediaFileServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MediaFileServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.MediaFile getMediaFile(com.google.ads.googleads.v6.services.GetMediaFileRequest request) {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.services.MutateMediaFilesResponse mutateMediaFiles(com.google.ads.googleads.v6.services.MutateMediaFilesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MediaFileServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MediaFileServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.MediaFile> getMediaFile(
        com.google.ads.googleads.v6.services.GetMediaFileRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.services.MutateMediaFilesResponse> mutateMediaFiles(
        com.google.ads.googleads.v6.services.MutateMediaFilesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MEDIA_FILE:
          serviceImpl.getMediaFile((com.google.ads.googleads.v6.services.GetMediaFileRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.MediaFile>) responseObserver);
          break;
        case METHODID_MUTATE_MEDIA_FILES:
          serviceImpl.mutateMediaFiles((com.google.ads.googleads.v6.services.MutateMediaFilesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.services.MutateMediaFilesResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MediaFileServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.MediaFileServiceProto.getDescriptor();
    }
