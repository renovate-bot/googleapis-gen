...
@javax.annotation.Generated(
    ...
    comments = "Source: google/ads/googleads/v6/services/distance_view_service.proto")
public final class DistanceViewServiceGrpc {

  private DistanceViewServiceGrpc() {}

  public static final String SERVICE_NAME = "google.ads.googleads.v6.services.DistanceViewService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetDistanceViewRequest,
      com.google.ads.googleads.v6.resources.DistanceView> getGetDistanceViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDistanceView",
      requestType = com.google.ads.googleads.v6.services.GetDistanceViewRequest.class,
      responseType = com.google.ads.googleads.v6.resources.DistanceView.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetDistanceViewRequest,
      com.google.ads.googleads.v6.resources.DistanceView> getGetDistanceViewMethod() {
    io.grpc.MethodDescriptor<com.google.ads.googleads.v6.services.GetDistanceViewRequest, com.google.ads.googleads.v6.resources.DistanceView> getGetDistanceViewMethod;
      ...
      synchronized (DistanceViewServiceGrpc.class) {
        if ((getGetDistanceViewMethod = DistanceViewServiceGrpc.getGetDistanceViewMethod) == null) {
          DistanceViewServiceGrpc.getGetDistanceViewMethod = getGetDistanceViewMethod =
              io.grpc.MethodDescriptor.<com.google.ads.googleads.v6.services.GetDistanceViewRequest, com.google.ads.googleads.v6.resources.DistanceView>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDistanceView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.services.GetDistanceViewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.ads.googleads.v6.resources.DistanceView.getDefaultInstance()))
  ...
  public static abstract class DistanceViewServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getDistanceView(com.google.ads.googleads.v6.services.GetDistanceViewRequest request,
        io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.DistanceView> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetDistanceViewMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.ads.googleads.v6.services.GetDistanceViewRequest,
                com.google.ads.googleads.v6.resources.DistanceView>(
  ...
  public static final class DistanceViewServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DistanceViewServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.ads.googleads.v6.resources.DistanceView getDistanceView(com.google.ads.googleads.v6.services.GetDistanceViewRequest request) {
  ...
  public static final class DistanceViewServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DistanceViewServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.ads.googleads.v6.resources.DistanceView> getDistanceView(
        com.google.ads.googleads.v6.services.GetDistanceViewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DISTANCE_VIEW:
          serviceImpl.getDistanceView((com.google.ads.googleads.v6.services.GetDistanceViewRequest) request,
              (io.grpc.stub.StreamObserver<com.google.ads.googleads.v6.resources.DistanceView>) responseObserver);
          break;
        default:
  ...
  private static abstract class DistanceViewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.ads.googleads.v6.services.DistanceViewServiceProto.getDescriptor();
    }
