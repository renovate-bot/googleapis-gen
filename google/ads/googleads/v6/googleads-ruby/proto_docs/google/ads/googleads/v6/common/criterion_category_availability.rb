    ...
    module GoogleAds
      module V6
        module Common
          ...
          # @!attribute [rw] locale
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::CriterionCategoryLocaleAvailability>]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::CriterionCategoryChannelAvailabilityModeEnum::CriterionCategoryChannelAvailabilityMode]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::AdvertisingChannelTypeEnum::AdvertisingChannelType]
          #     Channel type the category is available to.
          # @!attribute [rw] advertising_channel_sub_type
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType>]
          ...
          # @!attribute [rw] availability_mode
          #   @return [::Google::Ads::GoogleAds::V6::Enums::CriterionCategoryLocaleAvailabilityModeEnum::CriterionCategoryLocaleAvailabilityMode]
