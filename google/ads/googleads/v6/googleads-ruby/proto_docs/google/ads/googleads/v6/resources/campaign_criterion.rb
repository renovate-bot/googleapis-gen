    ...
    module GoogleAds
      module V6
        module Resources
          ...
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::CriterionTypeEnum::CriterionType]
          #     Output only. The type of the criterion.
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V6::Enums::CampaignCriterionStatusEnum::CampaignCriterionStatus]
