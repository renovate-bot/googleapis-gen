...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::CampaignCriterionService::Client#get_campaign_criterion CampaignCriterionService.GetCampaignCriterion}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::CampaignCriterionService::Client#mutate_campaign_criteria CampaignCriterionService.MutateCampaignCriteria}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose criteria are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::CampaignCriterionOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::MutateCampaignCriterionResult>]
