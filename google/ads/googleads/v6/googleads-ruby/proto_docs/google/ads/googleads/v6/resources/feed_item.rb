    ...
    module GoogleAds
      module V6
        module Resources
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Resources::FeedItemAttributeValue>]
          #     The feed item's attribute values.
          # @!attribute [rw] geo_targeting_restriction
          #   @return [::Google::Ads::GoogleAds::V6::Enums::GeoTargetingRestrictionEnum::GeoTargetingRestriction]
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V6::Enums::FeedItemStatusEnum::FeedItemStatus]
          #     Output only. Status of the feed item.
          #     This field is read-only.
          # @!attribute [r] policy_infos
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Resources::FeedItemPlaceholderPolicyInfo>]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::FeedItemValidationStatusEnum::FeedItemValidationStatus]
          #     Output only. The validation status of the palceholder type.
          # @!attribute [r] validation_errors
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Resources::FeedItemValidationError>]
          #     Output only. List of placeholder type validation errors.
          # @!attribute [r] quality_approval_status
          #   @return [::Google::Ads::GoogleAds::V6::Enums::FeedItemQualityApprovalStatusEnum::FeedItemQualityApprovalStatus]
          #     Output only. Placeholder type quality evaluation approval status.
          # @!attribute [r] quality_disapproval_reasons
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Enums::FeedItemQualityDisapprovalReasonEnum::FeedItemQualityDisapprovalReason>]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Errors::FeedItemValidationErrorEnum::FeedItemValidationError]
