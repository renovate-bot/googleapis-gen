  ...
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V6::Services::AccountBudgetProposalService::Client#get_account_budget_proposal AccountBudgetProposalService.GetAccountBudgetProposal}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V6::Services::AccountBudgetProposalService::Client#mutate_account_budget_proposal AccountBudgetProposalService.MutateAccountBudgetProposal}.
