...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::FeedItemService::Client#get_feed_item FeedItemService.GetFeedItem}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::FeedItemService::Client#mutate_feed_items FeedItemService.MutateFeedItems}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose feed items are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::FeedItemOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::MutateFeedItemResult>]
