...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::FeedService::Client#get_feed FeedService.GetFeed}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::FeedService::Client#mutate_feeds FeedService.MutateFeeds}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose feeds are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::FeedOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::MutateFeedResult>]
