...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::CustomerManagerLinkService::Client#get_customer_manager_link CustomerManagerLinkService.GetCustomerManagerLink}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::CustomerManagerLinkService::Client#mutate_customer_manager_link CustomerManagerLinkService.MutateCustomerManagerLink}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose customer manager links are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::CustomerManagerLinkOperation>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::CustomerManagerLinkService::Client#move_manager_link CustomerManagerLinkService.MoveManagerLink}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::MutateCustomerManagerLinkResult>]
