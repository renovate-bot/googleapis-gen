...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::AdParameterService::Client#get_ad_parameter AdParameterService.GetAdParameter}
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::AdParameterService::Client#mutate_ad_parameters AdParameterService.MutateAdParameters}
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose ad parameters are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::AdParameterOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::MutateAdParameterResult>]
