...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::CampaignAssetService::Client#get_campaign_asset CampaignAssetService.GetCampaignAsset}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::CampaignAssetService::Client#mutate_campaign_assets CampaignAssetService.MutateCampaignAssets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaign assets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::CampaignAssetOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::MutateCampaignAssetResult>]
