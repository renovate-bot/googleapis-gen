    ...
    module GoogleAds
      module V6
        module Common
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::CustomerMatchUploadKeyTypeEnum::CustomerMatchUploadKeyType]
          #     Matching key type of the list.
          #     Mixed data types are not allowed on the same list.
          #     This field is required for an ADD operation.
          # @!attribute [rw] data_source_type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::UserListCrmDataSourceTypeEnum::UserListCrmDataSourceType]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::UserListRuleTypeEnum::UserListRuleType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::UserListRuleItemGroupInfo>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::UserListRuleItemInfo>]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::UserListDateRuleItemOperatorEnum::UserListDateRuleItemOperator]
          ...
          # @!attribute [rw] operator
          #   @return [::Google::Ads::GoogleAds::V6::Enums::UserListNumberRuleItemOperatorEnum::UserListNumberRuleItemOperator]
          ...
          # @!attribute [rw] operator
          #   @return [::Google::Ads::GoogleAds::V6::Enums::UserListStringRuleItemOperatorEnum::UserListStringRuleItemOperator]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::UserListCombinedRuleOperatorEnum::UserListCombinedRuleOperator]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::UserListPrepopulationStatusEnum::UserListPrepopulationStatus]
          ...
          # @!attribute [rw] rules
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::UserListLogicalRuleInfo>]
          ...
          # @!attribute [rw] operator
          #   @return [::Google::Ads::GoogleAds::V6::Enums::UserListLogicalRuleOperatorEnum::UserListLogicalRuleOperator]
          #     The logical operator of the rule.
          # @!attribute [rw] rule_operands
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::LogicalUserListOperandInfo>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::UserListActionInfo>]
