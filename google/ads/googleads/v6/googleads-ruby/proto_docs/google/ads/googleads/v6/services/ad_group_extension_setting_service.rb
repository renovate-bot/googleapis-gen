  ...
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V6::Services::AdGroupExtensionSettingService::Client#get_ad_group_extension_setting AdGroupExtensionSettingService.GetAdGroupExtensionSetting}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V6::Services::AdGroupExtensionSettingService::Client#mutate_ad_group_extension_settings AdGroupExtensionSettingService.MutateAdGroupExtensionSettings}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose ad group extension settings are being
          #     modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::AdGroupExtensionSettingOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::MutateAdGroupExtensionSettingResult>]
