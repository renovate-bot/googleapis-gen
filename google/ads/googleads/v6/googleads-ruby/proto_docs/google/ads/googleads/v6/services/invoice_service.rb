    ...
    module GoogleAds
      module V6
        module Services
          ...
          # Response message for {::Google::Ads::GoogleAds::V6::Services::InvoiceService::Client#list_invoices InvoiceService.ListInvoices}.
          # @!attribute [rw] invoices
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Resources::Invoice>]
