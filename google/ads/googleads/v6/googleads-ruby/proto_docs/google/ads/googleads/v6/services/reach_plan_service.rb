...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::ReachPlanService::Client#list_plannable_locations ReachPlanService.ListPlannableLocations}.
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::PlannableLocation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::ProductMetadata>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Enums::ReachPlanAgeRangeEnum::ReachPlanAgeRange>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::GenderInfo>]
          #     Targetable genders for the ad product.
          # @!attribute [rw] devices
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::DeviceInfo>]
          #     Targetable devices for the ad product.
          # @!attribute [rw] networks
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Enums::ReachPlanNetworkEnum::ReachPlanNetwork>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::ReachPlanService::Client#generate_product_mix_ideas ReachPlanService.GenerateProductMixIdeas}.
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ReachPlanAdLengthEnum::ReachPlanAdLength]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::ProductAllocation>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::ReachPlanService::Client#generate_reach_forecast ReachPlanService.GenerateReachForecast}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer.
          # @!attribute [rw] currency_code
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::PlannedProduct>]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ReachPlanAgeRangeEnum::ReachPlanAgeRange]
          #     Targeted age range.
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ReachPlanNetworkEnum::ReachPlanNetwork]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::ReachForecast>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::PlannedProductReachForecast>]
