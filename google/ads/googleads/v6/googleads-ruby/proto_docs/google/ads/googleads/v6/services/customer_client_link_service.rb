...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::CustomerClientLinkService::Client#get_customer_client_link CustomerClientLinkService.GetCustomerClientLink}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::CustomerClientLinkService::Client#mutate_customer_client_link CustomerClientLinkService.MutateCustomerClientLink}.
