    ...
    module GoogleAds
      module V6
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::AccountBudgetProposalTypeEnum::AccountBudgetProposalType]
          #     Immutable. The type of this proposal, e.g. END to end the budget associated with this
          #     proposal.
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V6::Enums::AccountBudgetProposalStatusEnum::AccountBudgetProposalStatus]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::SpendingLimitTypeEnum::SpendingLimitType]
