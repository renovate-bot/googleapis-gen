    ...
    module GoogleAds
      module V6
        module Resources
          ...
          # @!attribute [r] caller_region_code
          #   @return [::String]
          #     Output only. Region code of the caller.
          # @!attribute [r] caller_area_code
          #   @return [::String]
          #     Output only. Area code of the caller. Null if the call duration is shorter than 15
          #     seconds.
          # @!attribute [r] call_duration_seconds
          #   @return [::Integer]
          #     Output only. The advertiser-provided call duration in seconds.
          # @!attribute [r] start_call_date_time
          #   @return [::String]
          #     Output only. The advertiser-provided call start date time.
          # @!attribute [r] end_call_date_time
          #   @return [::String]
          #     Output only. The advertiser-provided call end date time.
          # @!attribute [r] call_tracking_display_location
          #   @return [::Google::Ads::GoogleAds::V6::Enums::CallTrackingDisplayLocationEnum::CallTrackingDisplayLocation]
          #     Output only. The call tracking display location.
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::CallTypeEnum::CallType]
          #     Output only. The type of the call.
          # @!attribute [r] call_status
          #   @return [::Google::Ads::GoogleAds::V6::Enums::GoogleVoiceCallStatusEnum::GoogleVoiceCallStatus]
