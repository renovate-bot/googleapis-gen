    ...
    module GoogleAds
      module V6
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::UserInterestTaxonomyTypeEnum::UserInterestTaxonomyType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::CriterionCategoryAvailability>]
