    ...
    module GoogleAds
      module V6
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::FeedItemTargetTypeEnum::FeedItemTargetType]
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V6::Enums::FeedItemTargetStatusEnum::FeedItemTargetStatus]
