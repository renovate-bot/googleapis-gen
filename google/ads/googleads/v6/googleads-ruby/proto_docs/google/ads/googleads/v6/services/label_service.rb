...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::LabelService::Client#get_label LabelService.GetLabel}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::LabelService::Client#mutate_labels LabelService.MutateLabels}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose labels are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::LabelOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::MutateLabelResult>]
