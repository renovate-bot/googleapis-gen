    ...
    module GoogleAds
      module V6
        module Resources
          ...
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::SimulationTypeEnum::SimulationType]
          #     Output only. The field that the simulation modifies.
          # @!attribute [r] modification_method
          #   @return [::Google::Ads::GoogleAds::V6::Enums::SimulationModificationMethodEnum::SimulationModificationMethod]
