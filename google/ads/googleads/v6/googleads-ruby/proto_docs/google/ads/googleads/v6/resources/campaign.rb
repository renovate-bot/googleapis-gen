    ...
    module GoogleAds
      module V6
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V6::Enums::CampaignStatusEnum::CampaignStatus]
          #     The status of the campaign.
          #
          #     When a new campaign is added, the status defaults to ENABLED.
          # @!attribute [r] serving_status
          #   @return [::Google::Ads::GoogleAds::V6::Enums::CampaignServingStatusEnum::CampaignServingStatus]
          #     Output only. The ad serving status of the campaign.
          # @!attribute [rw] ad_serving_optimization_status
          #   @return [::Google::Ads::GoogleAds::V6::Enums::AdServingOptimizationStatusEnum::AdServingOptimizationStatus]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::CampaignExperimentTypeEnum::CampaignExperimentType]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::BiddingStrategyTypeEnum::BiddingStrategyType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::FrequencyCapEntry>]
          #     A list that limits how often each user will see this campaign's ads.
          # @!attribute [r] video_brand_safety_suitability
          #   @return [::Google::Ads::GoogleAds::V6::Enums::BrandSafetySuitabilityEnum::BrandSafetySuitability]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::PaymentModeEnum::PaymentMode]
          ...
          class Campaign
            ...
            #   @return [::Google::Ads::GoogleAds::V6::Enums::VanityPharmaDisplayUrlModeEnum::VanityPharmaDisplayUrlMode]
            #     The display mode for vanity pharma URLs.
            # @!attribute [rw] vanity_pharma_text
            #   @return [::Google::Ads::GoogleAds::V6::Enums::VanityPharmaTextEnum::VanityPharmaText]
