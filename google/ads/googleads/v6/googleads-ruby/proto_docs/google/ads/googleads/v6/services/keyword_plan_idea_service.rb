...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::KeywordPlanIdeaService::Client#generate_keyword_ideas KeywordPlanIdeaService.GenerateKeywordIdeas}.
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::KeywordPlanNetworkEnum::KeywordPlanNetwork]
          #     Targeting network.
          ...
          # Response message for {::Google::Ads::GoogleAds::V6::Services::KeywordPlanIdeaService::Client#generate_keyword_ideas KeywordPlanIdeaService.GenerateKeywordIdeas}.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::GenerateKeywordIdeaResult>]
