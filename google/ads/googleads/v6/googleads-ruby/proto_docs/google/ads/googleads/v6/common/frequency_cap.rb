    ...
    module GoogleAds
      module V6
        module Common
          ...
          # @!attribute [rw] level
          #   @return [::Google::Ads::GoogleAds::V6::Enums::FrequencyCapLevelEnum::FrequencyCapLevel]
          #     The level on which the cap is to be applied (e.g. ad group ad, ad group).
          #     The cap is applied to all the entities of this level.
          # @!attribute [rw] event_type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::FrequencyCapEventTypeEnum::FrequencyCapEventType]
          #     The type of event that the cap applies to (e.g. impression).
          # @!attribute [rw] time_unit
          #   @return [::Google::Ads::GoogleAds::V6::Enums::FrequencyCapTimeUnitEnum::FrequencyCapTimeUnit]
