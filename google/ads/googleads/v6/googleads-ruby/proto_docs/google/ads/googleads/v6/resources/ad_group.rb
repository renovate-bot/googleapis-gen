    ...
    module GoogleAds
      module V6
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V6::Enums::AdGroupStatusEnum::AdGroupStatus]
          #     The status of the ad group.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::AdGroupTypeEnum::AdGroupType]
          #     Immutable. The type of the ad group.
          # @!attribute [rw] ad_rotation_mode
          #   @return [::Google::Ads::GoogleAds::V6::Enums::AdGroupAdRotationModeEnum::AdGroupAdRotationMode]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::TargetingDimensionEnum::TargetingDimension]
