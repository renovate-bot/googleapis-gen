...
module Google
  module Ads
    module GoogleAds
      module V6
        module Services
          # Request message for {::Google::Ads::GoogleAds::V6::Services::AdGroupService::Client#get_ad_group AdGroupService.GetAdGroup}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V6::Services::AdGroupService::Client#mutate_ad_groups AdGroupService.MutateAdGroups}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose ad groups are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::AdGroupOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Services::MutateAdGroupResult>]
