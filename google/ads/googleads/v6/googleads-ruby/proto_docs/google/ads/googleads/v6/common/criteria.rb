    ...
    module GoogleAds
      module V6
        module Common
          ...
          # A device criterion.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::DeviceEnum::Device]
          #     Type of the device.
          class DeviceInfo
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::PreferredContentTypeEnum::PreferredContentType]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ListingGroupTypeEnum::ListingGroupType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::ListingDimensionInfo>]
          ...
          # @!attribute [rw] level
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ProductBiddingCategoryLevelEnum::ProductBiddingCategoryLevel]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ProductChannelEnum::ProductChannel]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ProductChannelExclusivityEnum::ProductChannelExclusivity]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ProductConditionEnum::ProductCondition]
          ...
          # @!attribute [rw] index
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ProductCustomAttributeIndexEnum::ProductCustomAttributeIndex]
          ...
          #     Value of the type.
          # @!attribute [rw] level
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ProductTypeLevelEnum::ProductTypeLevel]
          #     Level of the type.
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::HotelDateSelectionTypeEnum::HotelDateSelectionType]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::DayOfWeekEnum::DayOfWeek]
          #     The day of the week.
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::InteractionTypeEnum::InteractionType]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::MinuteOfHourEnum::MinuteOfHour]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::AgeRangeTypeEnum::AgeRangeType]
          ...
          # A gender criterion.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::GenderTypeEnum::GenderType]
          #     Type of the gender.
          class GenderInfo
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::IncomeRangeTypeEnum::IncomeRangeType]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ParentalStatusTypeEnum::ParentalStatusType]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ProximityRadiusUnitsEnum::ProximityRadiusUnits]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::ContentLabelTypeEnum::ContentLabelType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V6::Common::WebpageConditionInfo>]
          ...
          #   @return [::Google::Ads::GoogleAds::V6::Enums::WebpageConditionOperandEnum::WebpageConditionOperand]
          #     Operand of webpage targeting condition.
          # @!attribute [rw] operator
          #   @return [::Google::Ads::GoogleAds::V6::Enums::WebpageConditionOperatorEnum::WebpageConditionOperator]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V6::Enums::AppPaymentModelTypeEnum::AppPaymentModelType]
          ...
          #     This is required and must be set in CREATE operations.
          # @!attribute [rw] radius_units
          #   @return [::Google::Ads::GoogleAds::V6::Enums::LocationGroupRadiusUnitsEnum::LocationGroupRadiusUnits]
