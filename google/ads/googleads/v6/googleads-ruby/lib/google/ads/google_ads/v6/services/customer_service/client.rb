...
require "google/ads/googleads/v6/services/customer_service_pb"
        ...
        module Services
          module CustomerService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V6::Services::CustomerService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V6::Services::CustomerService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::CustomerService::Client.new
              #
              # To create a new CustomerService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::CustomerService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v6/services/customer_service_services_pb"
                ...
                @customer_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V6::Services::CustomerService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GetCustomerRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GetCustomerRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Resources::Customer]
              ...
              def get_customer request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::GetCustomerRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::MutateCustomerRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::MutateCustomerRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operation [::Google::Ads::GoogleAds::V6::Services::CustomerOperation, ::Hash]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::MutateCustomerResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_customer request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::MutateCustomerRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::ListAccessibleCustomersRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::ListAccessibleCustomersRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::ListAccessibleCustomersResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def list_accessible_customers request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::ListAccessibleCustomersRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::CreateCustomerClientRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::CreateCustomerClientRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param customer_client [::Google::Ads::GoogleAds::V6::Resources::Customer, ::Hash]
              ...
              #   @param access_role [::Google::Ads::GoogleAds::V6::Enums::AccessRoleEnum::AccessRole]
              #     The proposed role of user on the created client customer.
              #     Accessible only to customers on the allow-list.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::CreateCustomerClientResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def create_customer_client request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::CreateCustomerClientRequest
              ...
              # {::Google::Ads::GoogleAds::V6::Services::CustomerService::Client::Configuration::Rpcs}
