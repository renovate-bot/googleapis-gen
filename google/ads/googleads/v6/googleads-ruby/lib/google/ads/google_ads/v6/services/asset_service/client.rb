...
require "google/ads/googleads/v6/services/asset_service_pb"
        ...
        module Services
          module AssetService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V6::Services::AssetService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V6::Services::AssetService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::AssetService::Client.new
              #
              # To create a new AssetService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::AssetService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v6/services/asset_service_services_pb"
                ...
                @asset_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V6::Services::AssetService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GetAssetRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GetAssetRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Resources::Asset]
              ...
              def get_asset request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::GetAssetRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::MutateAssetsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::MutateAssetsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload mutate_assets(customer_id: nil, operations: nil, response_content_type: nil)
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V6::Services::AssetOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::MutateAssetsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V6::Services::MutateAssetsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              ...
              # {::Google::Ads::GoogleAds::V6::Services::AssetService::Client::Configuration::Rpcs}
              ...
              # # Examples
              #
              # To modify the global config, setting the timeout for get_asset
