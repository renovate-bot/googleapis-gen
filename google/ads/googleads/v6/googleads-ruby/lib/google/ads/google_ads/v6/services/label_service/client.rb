...
require "google/ads/googleads/v6/services/label_service_pb"
        ...
        module Services
          module LabelService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V6::Services::LabelService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V6::Services::LabelService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::LabelService::Client.new
              #
              # To create a new LabelService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::LabelService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v6/services/label_service_services_pb"
                ...
                @label_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V6::Services::LabelService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GetLabelRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GetLabelRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Resources::Label]
              ...
              def get_label request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::GetLabelRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::MutateLabelsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::MutateLabelsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V6::Services::LabelOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::MutateLabelsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V6::Services::MutateLabelsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def mutate_labels request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::MutateLabelsRequest
              ...
              # {::Google::Ads::GoogleAds::V6::Services::LabelService::Client::Configuration::Rpcs}
