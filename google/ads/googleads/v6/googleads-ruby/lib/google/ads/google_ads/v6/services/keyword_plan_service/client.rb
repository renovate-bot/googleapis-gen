...
require "google/ads/googleads/v6/services/keyword_plan_service_pb"
        ...
        module Services
          module KeywordPlanService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V6::Services::KeywordPlanService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V6::Services::KeywordPlanService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::KeywordPlanService::Client.new
              #
              # To create a new KeywordPlanService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::KeywordPlanService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v6/services/keyword_plan_service_services_pb"
                ...
                @keyword_plan_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V6::Services::KeywordPlanService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GetKeywordPlanRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GetKeywordPlanRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Resources::KeywordPlan]
              ...
              def get_keyword_plan request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::GetKeywordPlanRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::MutateKeywordPlansRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::MutateKeywordPlansRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V6::Services::KeywordPlanOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::MutateKeywordPlansResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V6::Services::MutateKeywordPlansResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def mutate_keyword_plans request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::MutateKeywordPlansRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GenerateForecastCurveRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GenerateForecastCurveRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::GenerateForecastCurveResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V6::Services::GenerateForecastCurveResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def generate_forecast_curve request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::GenerateForecastCurveRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GenerateForecastTimeSeriesRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GenerateForecastTimeSeriesRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::GenerateForecastTimeSeriesResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V6::Services::GenerateForecastTimeSeriesResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def generate_forecast_time_series request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::GenerateForecastTimeSeriesRequest
                ...
                @keyword_plan_service_stub.call_rpc :generate_forecast_time_series, request, options: options do |response, operation|
                  yield response, operation if block_given?
                  return response
                end
                # rescue GRPC::BadStatus => grpc_error
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GenerateForecastMetricsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GenerateForecastMetricsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::GenerateForecastMetricsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V6::Services::GenerateForecastMetricsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def generate_forecast_metrics request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::GenerateForecastMetricsRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GenerateHistoricalMetricsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GenerateHistoricalMetricsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::GenerateHistoricalMetricsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V6::Services::GenerateHistoricalMetricsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def generate_historical_metrics request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::GenerateHistoricalMetricsRequest
              ...
              # {::Google::Ads::GoogleAds::V6::Services::KeywordPlanService::Client::Configuration::Rpcs}
