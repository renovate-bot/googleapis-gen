...
use Google\Ads\GoogleAds\V6\Services\GetExtensionFeedItemRequest;
use Google\Ads\GoogleAds\V6\Services\MutateExtensionFeedItemsRequest;
 ...
 * try {
 *     $formattedResourceName = $extensionFeedItemServiceClient->extensionFeedItemName('[CUSTOMER_ID]', '[FEED_ITEM_ID]');
...
class ExtensionFeedItemServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.ExtensionFeedItemService';
