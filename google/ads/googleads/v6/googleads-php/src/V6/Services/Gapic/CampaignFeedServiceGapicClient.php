 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v6/services/campaign_feed_service.proto
...
use Google\Ads\GoogleAds\V6\Services\GetCampaignFeedRequest;

use Google\Ads\GoogleAds\V6\Services\MutateCampaignFeedsRequest;
use Google\Ads\GoogleAds\V6\Services\MutateCampaignFeedsResponse;
 ...
 * try {
 *     $formattedResourceName = $campaignFeedServiceClient->campaignFeedName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[FEED_ID]');
...
class CampaignFeedServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.CampaignFeedService';
    ...
    public function getCampaignFeed($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetCampaignFeed', CampaignFeed::class, $optionalArgs, $request)->wait();
    }
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V6\Services\MutateCampaignFeedsResponse
     *
     * @throws ApiException if the remote call fails
     */
    public function mutateCampaignFeeds($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateCampaignFeeds', MutateCampaignFeedsResponse::class, $optionalArgs, $request)->wait();
    }
}
