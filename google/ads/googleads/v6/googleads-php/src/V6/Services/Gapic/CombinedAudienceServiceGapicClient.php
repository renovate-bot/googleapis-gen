 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v6/services/combined_audience_service.proto
...
use Google\Ads\GoogleAds\V6\Resources\CombinedAudience;
use Google\Ads\GoogleAds\V6\Services\GetCombinedAudienceRequest;
 ...
 *
 * ```
 * $combinedAudienceServiceClient = new CombinedAudienceServiceClient();
 * try {
 *     $formattedResourceName = $combinedAudienceServiceClient->combinedAudienceName('[CUSTOMER_ID]', '[COMBINED_AUDIENCE_ID]');
 *     $response = $combinedAudienceServiceClient->getCombinedAudience($formattedResourceName);
 * } finally {
 *     $combinedAudienceServiceClient->close();
 * }
 * ```
 *
 ...
 * @experimental
 */
class CombinedAudienceServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.CombinedAudienceService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__.'/../resources/combined_audience_service_client_config.json',
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__.'/../resources/combined_audience_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    {
        if (null == self::$combinedAudienceNameTemplate) {
     ...
     * ```
     *
     * @param string $resourceName Required. The resource name of the combined audience to fetch.
     ...
     * @experimental
     */
    public function getCombinedAudience($resourceName, array $optionalArgs = [])
    {
        $request = new GetCombinedAudienceRequest();
