 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v6/services/reach_plan_service.proto
...
use Google\Ads\GoogleAds\V6\Services\FrequencyCap;

use Google\Ads\GoogleAds\V6\Services\GenerateProductMixIdeasRequest;
use Google\Ads\GoogleAds\V6\Services\GenerateProductMixIdeasResponse;
use Google\Ads\GoogleAds\V6\Services\GenerateReachForecastRequest;
use Google\Ads\GoogleAds\V6\Services\GenerateReachForecastResponse;
use Google\Ads\GoogleAds\V6\Services\ListPlannableLocationsRequest;
use Google\Ads\GoogleAds\V6\Services\ListPlannableLocationsResponse;
use Google\Ads\GoogleAds\V6\Services\ListPlannableProductsRequest;
...
class ReachPlanServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.ReachPlanService';
