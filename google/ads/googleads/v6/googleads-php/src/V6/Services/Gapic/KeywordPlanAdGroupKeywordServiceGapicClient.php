 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v6/services/keyword_plan_ad_group_keyword_service.proto
...
use Google\Ads\GoogleAds\V6\Services\GetKeywordPlanAdGroupKeywordRequest;
use Google\Ads\GoogleAds\V6\Services\KeywordPlanAdGroupKeywordOperation;

use Google\Ads\GoogleAds\V6\Services\MutateKeywordPlanAdGroupKeywordsRequest;
use Google\Ads\GoogleAds\V6\Services\MutateKeywordPlanAdGroupKeywordsResponse;
 ...
 * try {
 *     $formattedResourceName = $keywordPlanAdGroupKeywordServiceClient->keywordPlanAdGroupKeywordName('[CUSTOMER_ID]', '[KEYWORD_PLAN_AD_GROUP_KEYWORD_ID]');
...
class KeywordPlanAdGroupKeywordServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.KeywordPlanAdGroupKeywordService';
    ...
    public function getKeywordPlanAdGroupKeyword($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetKeywordPlanAdGroupKeyword', KeywordPlanAdGroupKeyword::class, $optionalArgs, $request)->wait();
    }
    ...
    public function mutateKeywordPlanAdGroupKeywords($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateKeywordPlanAdGroupKeywords', MutateKeywordPlanAdGroupKeywordsResponse::class, $optionalArgs, $request)->wait();
    }
}
