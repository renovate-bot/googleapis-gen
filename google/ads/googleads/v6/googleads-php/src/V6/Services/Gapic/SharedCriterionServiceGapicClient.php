 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v6/services/shared_criterion_service.proto
...
use Google\Ads\GoogleAds\V6\Services\MutateSharedCriteriaResponse;
use Google\Ads\GoogleAds\V6\Services\SharedCriterionOperation;
 ...
 * try {
 *     $formattedResourceName = $sharedCriterionServiceClient->sharedCriterionName('[CUSTOMER_ID]', '[SHARED_SET_ID]', '[CRITERION_ID]');
...
class SharedCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.SharedCriterionService';
