 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v6/services/bidding_strategy_service.proto
...
use Google\Ads\GoogleAds\V6\Services\BiddingStrategyOperation;
use Google\Ads\GoogleAds\V6\Services\GetBiddingStrategyRequest;

use Google\Ads\GoogleAds\V6\Services\MutateBiddingStrategiesRequest;
use Google\Ads\GoogleAds\V6\Services\MutateBiddingStrategiesResponse;
...
class BiddingStrategyServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.BiddingStrategyService';
