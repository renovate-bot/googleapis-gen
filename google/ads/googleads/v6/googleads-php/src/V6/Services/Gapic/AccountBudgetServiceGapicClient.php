...
use Google\Ads\GoogleAds\V6\Resources\AccountBudget;
use Google\Ads\GoogleAds\V6\Services\GetAccountBudgetRequest;
 ...
 * try {
 *     $formattedResourceName = $accountBudgetServiceClient->accountBudgetName('[CUSTOMER_ID]', '[ACCOUNT_BUDGET_ID]');
...
class AccountBudgetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.AccountBudgetService';
