...
use Google\Ads\GoogleAds\V6\Services\MutateCampaignBidModifiersRequest;
use Google\Ads\GoogleAds\V6\Services\MutateCampaignBidModifiersResponse;
...
class CampaignBidModifierServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.CampaignBidModifierService';
