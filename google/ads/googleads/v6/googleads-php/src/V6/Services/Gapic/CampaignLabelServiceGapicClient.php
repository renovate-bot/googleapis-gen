...
use Google\Ads\GoogleAds\V6\Services\GetCampaignLabelRequest;
use Google\Ads\GoogleAds\V6\Services\MutateCampaignLabelsRequest;
use Google\Ads\GoogleAds\V6\Services\MutateCampaignLabelsResponse;
...
class CampaignLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.CampaignLabelService';
