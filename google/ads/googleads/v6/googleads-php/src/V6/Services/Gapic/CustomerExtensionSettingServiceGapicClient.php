 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v6/services/customer_extension_setting_service.proto
...
use Google\Ads\GoogleAds\V6\Services\GetCustomerExtensionSettingRequest;

use Google\Ads\GoogleAds\V6\Services\MutateCustomerExtensionSettingsRequest;
use Google\Ads\GoogleAds\V6\Services\MutateCustomerExtensionSettingsResponse;
...
class CustomerExtensionSettingServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.CustomerExtensionSettingService';
