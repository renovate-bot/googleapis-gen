 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v6/services/campaign_draft_service.proto
...
use Google\Ads\GoogleAds\V6\Services\GetCampaignDraftRequest;

use Google\Ads\GoogleAds\V6\Services\ListCampaignDraftAsyncErrorsRequest;

use Google\Ads\GoogleAds\V6\Services\ListCampaignDraftAsyncErrorsResponse;
use Google\Ads\GoogleAds\V6\Services\MutateCampaignDraftsRequest;
use Google\Ads\GoogleAds\V6\Services\MutateCampaignDraftsResponse;
use Google\Ads\GoogleAds\V6\Services\PromoteCampaignDraftRequest;
...
class CampaignDraftServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.CampaignDraftService';
