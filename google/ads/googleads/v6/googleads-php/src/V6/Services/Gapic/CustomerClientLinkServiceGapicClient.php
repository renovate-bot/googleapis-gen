...
use Google\Ads\GoogleAds\V6\Services\GetCustomerClientLinkRequest;
use Google\Ads\GoogleAds\V6\Services\MutateCustomerClientLinkRequest;
use Google\Ads\GoogleAds\V6\Services\MutateCustomerClientLinkResponse;
 ...
 * try {
 *     $formattedResourceName = $customerClientLinkServiceClient->customerClientLinkName('[CUSTOMER_ID]', '[CLIENT_CUSTOMER_ID]', '[MANAGER_LINK_ID]');
...
class CustomerClientLinkServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.CustomerClientLinkService';
