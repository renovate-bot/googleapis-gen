 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v6/services/landing_page_view_service.proto
 * and updates to that file get reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V6\Services\Gapic;

use Google\Ads\GoogleAds\V6\Resources\LandingPageView;
use Google\Ads\GoogleAds\V6\Services\GetLandingPageViewRequest;
...
class LandingPageViewServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.LandingPageViewService';
