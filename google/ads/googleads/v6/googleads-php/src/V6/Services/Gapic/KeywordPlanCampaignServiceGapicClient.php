 ...
 * https://github.com/google/googleapis/blob/master/google/ads/googleads/v6/services/keyword_plan_campaign_service.proto
...
use Google\Ads\GoogleAds\V6\Services\GetKeywordPlanCampaignRequest;
use Google\Ads\GoogleAds\V6\Services\KeywordPlanCampaignOperation;

use Google\Ads\GoogleAds\V6\Services\MutateKeywordPlanCampaignsRequest;
use Google\Ads\GoogleAds\V6\Services\MutateKeywordPlanCampaignsResponse;
 ...
 * try {
 *     $formattedResourceName = $keywordPlanCampaignServiceClient->keywordPlanCampaignName('[CUSTOMER_ID]', '[KEYWORD_PLAN_CAMPAIGN_ID]');
...
class KeywordPlanCampaignServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v6.services.KeywordPlanCampaignService';
    ...
    public function getKeywordPlanCampaign($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetKeywordPlanCampaign', KeywordPlanCampaign::class, $optionalArgs, $request)->wait();
    }
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V6\Services\MutateKeywordPlanCampaignsResponse
     *
     * @throws ApiException if the remote call fails
     */
    public function mutateKeywordPlanCampaigns($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateKeywordPlanCampaigns', MutateKeywordPlanCampaignsResponse::class, $optionalArgs, $request)->wait();
    }
}
