...
use Google\Ads\GoogleAds\V6\Resources\AdScheduleView;
...
class AdScheduleViewServiceClientTest extends GeneratedTest
{
    ...
    public function getAdScheduleViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.AdScheduleViewService/GetAdScheduleView', $actualFuncCall);
