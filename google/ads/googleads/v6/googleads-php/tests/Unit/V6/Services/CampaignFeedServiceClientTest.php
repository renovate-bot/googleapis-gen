...
class CampaignFeedServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignFeedTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->campaignFeedName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[FEED_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.CampaignFeedService/GetCampaignFeed', $actualFuncCall);
    ...
    public function mutateCampaignFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.CampaignFeedService/MutateCampaignFeeds', $actualFuncCall);
