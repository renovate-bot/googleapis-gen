...
use Google\Ads\GoogleAds\V6\Services\MutateCustomerNegativeCriteriaResponse;
...
class CustomerNegativeCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerNegativeCriterionTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->customerNegativeCriterionName('[CUSTOMER_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.CustomerNegativeCriterionService/GetCustomerNegativeCriterion', $actualFuncCall);
    ...
    public function mutateCustomerNegativeCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria', $actualFuncCall);
