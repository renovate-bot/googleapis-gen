...
use Google\Ads\GoogleAds\V6\Resources\AdGroupCriterionSimulation;
 ...
 * @group gapic
 */
class AdGroupCriterionSimulationServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getAdGroupCriterionSimulationTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->adGroupCriterionSimulationName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]', '[TYPE]', '[MODIFICATION_METHOD]', '[START_DATE]', '[END_DATE]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.AdGroupCriterionSimulationService/GetAdGroupCriterionSimulation', $actualFuncCall);
