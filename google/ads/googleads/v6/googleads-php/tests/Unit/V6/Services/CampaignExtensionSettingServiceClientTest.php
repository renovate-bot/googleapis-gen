...
use Google\Ads\GoogleAds\V6\Services\MutateCampaignExtensionSettingsResponse;
...
class CampaignExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignExtensionSettingTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->campaignExtensionSettingName('[CUSTOMER_ID]', '[CAMPAIGN_ID]', '[EXTENSION_TYPE]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.CampaignExtensionSettingService/GetCampaignExtensionSetting', $actualFuncCall);
    ...
    public function mutateCampaignExtensionSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.CampaignExtensionSettingService/MutateCampaignExtensionSettings', $actualFuncCall);
