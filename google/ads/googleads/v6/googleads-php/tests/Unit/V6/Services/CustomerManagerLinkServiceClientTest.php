...
use Google\Ads\GoogleAds\V6\Services\MoveManagerLinkResponse;
use Google\Ads\GoogleAds\V6\Services\MutateCustomerManagerLinkResponse;
...
class CustomerManagerLinkServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerManagerLinkTest()
    {
        ...
        $managerCustomer = 'managerCustomer1293939760';
        $managerLinkId = 614908142;
        $expectedResponse = new CustomerManagerLink();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setManagerCustomer($managerCustomer);
        $expectedResponse->setManagerLinkId($managerLinkId);
        $transport->addResponse($expectedResponse);

        // Mock request
        $formattedResourceName = $client->customerManagerLinkName('[CUSTOMER_ID]', '[MANAGER_CUSTOMER_ID]', '[MANAGER_LINK_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.CustomerManagerLinkService/GetCustomerManagerLink', $actualFuncCall);
    ...
    public function mutateCustomerManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.CustomerManagerLinkService/MutateCustomerManagerLink', $actualFuncCall);
    ...
    public function moveManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.CustomerManagerLinkService/MoveManagerLink', $actualFuncCall);
