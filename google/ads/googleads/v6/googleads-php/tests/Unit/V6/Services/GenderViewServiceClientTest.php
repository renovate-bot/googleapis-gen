...
use Google\Ads\GoogleAds\V6\Resources\GenderView;
 ...
 * @group gapic
 */
class GenderViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getGenderViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->genderViewName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.GenderViewService/GetGenderView', $actualFuncCall);
