...
use Google\Ads\GoogleAds\V6\Resources\CampaignCriterionSimulation;
...
class CampaignCriterionSimulationServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignCriterionSimulationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.CampaignCriterionSimulationService/GetCampaignCriterionSimulation', $actualFuncCall);
