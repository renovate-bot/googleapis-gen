...
class FeedMappingServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedMappingTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->feedMappingName('[CUSTOMER_ID]', '[FEED_ID]', '[FEED_MAPPING_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.FeedMappingService/GetFeedMapping', $actualFuncCall);
    ...
    public function mutateFeedMappingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.FeedMappingService/MutateFeedMappings', $actualFuncCall);
