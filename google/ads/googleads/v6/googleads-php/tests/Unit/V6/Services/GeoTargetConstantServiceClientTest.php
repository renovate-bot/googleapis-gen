...
use Google\Ads\GoogleAds\V6\Resources\GeoTargetConstant;
use Google\Ads\GoogleAds\V6\Services\SuggestGeoTargetConstantsResponse;
...
class GeoTargetConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getGeoTargetConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.GeoTargetConstantService/GetGeoTargetConstant', $actualFuncCall);
    ...
    public function suggestGeoTargetConstantsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.GeoTargetConstantService/SuggestGeoTargetConstants', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
