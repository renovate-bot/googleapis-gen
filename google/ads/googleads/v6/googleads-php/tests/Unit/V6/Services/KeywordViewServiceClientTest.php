 ...
 * @group gapic
 */
class KeywordViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getKeywordViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->keywordViewName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.KeywordViewService/GetKeywordView', $actualFuncCall);
