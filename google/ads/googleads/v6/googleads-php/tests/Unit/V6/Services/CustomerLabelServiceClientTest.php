...
class CustomerLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.CustomerLabelService/GetCustomerLabel', $actualFuncCall);
    ...
    public function mutateCustomerLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.CustomerLabelService/MutateCustomerLabels', $actualFuncCall);
