...
use Google\Ads\GoogleAds\V6\Services\MutateUserListsResponse;
...
class UserListServiceClientTest extends GeneratedTest
{
    ...
    public function getUserListTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.UserListService/GetUserList', $actualFuncCall);
    ...
    public function mutateUserListsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.UserListService/MutateUserLists', $actualFuncCall);
