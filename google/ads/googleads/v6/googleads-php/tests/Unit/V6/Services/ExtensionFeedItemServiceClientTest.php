...
use Google\Ads\GoogleAds\V6\Services\MutateExtensionFeedItemsResponse;
...
class ExtensionFeedItemServiceClientTest extends GeneratedTest
{
    ...
    public function getExtensionFeedItemTest()
    {
        ...
        $targetedGeoTargetConstant = 'targetedGeoTargetConstant-1048081195';
        $targetedCampaign = 'targetedCampaign-1487371649';
        ...
        $expectedResponse->setTargetedGeoTargetConstant($targetedGeoTargetConstant);
        $expectedResponse->setTargetedCampaign($targetedCampaign);
        $transport->addResponse($expectedResponse);

        // Mock request
        $formattedResourceName = $client->extensionFeedItemName('[CUSTOMER_ID]', '[FEED_ITEM_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.ExtensionFeedItemService/GetExtensionFeedItem', $actualFuncCall);
    ...
    public function mutateExtensionFeedItemsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.ExtensionFeedItemService/MutateExtensionFeedItems', $actualFuncCall);
