...
use Google\Ads\GoogleAds\V6\Resources\FeedPlaceholderView;
...
class FeedPlaceholderViewServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedPlaceholderViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.FeedPlaceholderViewService/GetFeedPlaceholderView', $actualFuncCall);
