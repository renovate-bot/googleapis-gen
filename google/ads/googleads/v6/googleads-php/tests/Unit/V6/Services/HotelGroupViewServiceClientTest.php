...
use Google\Ads\GoogleAds\V6\Resources\HotelGroupView;
...
class HotelGroupViewServiceClientTest extends GeneratedTest
{
    ...
    public function getHotelGroupViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.HotelGroupViewService/GetHotelGroupView', $actualFuncCall);
