...
use Google\Ads\GoogleAds\V6\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceClientTest extends GeneratedTest
{
    ...
    public function getBillingSetupTest()
    {
        ...
        $id = 3355;
        $paymentsAccount = 'paymentsAccount-1588215013';
        ...
        $expectedResponse->setPaymentsAccount($paymentsAccount);
        $expectedResponse->setStartDateTime($startDateTime);
        $expectedResponse->setEndDateTime($endDateTime);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->billingSetupName('[CUSTOMER_ID]', '[BILLING_SETUP_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.BillingSetupService/GetBillingSetup', $actualFuncCall);
    ...
    public function mutateBillingSetupTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.BillingSetupService/MutateBillingSetup', $actualFuncCall);
