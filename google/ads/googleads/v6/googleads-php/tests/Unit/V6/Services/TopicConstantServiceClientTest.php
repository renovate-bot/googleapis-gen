...
use Google\Ads\GoogleAds\V6\Resources\TopicConstant;
...
class TopicConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getTopicConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.TopicConstantService/GetTopicConstant', $actualFuncCall);
