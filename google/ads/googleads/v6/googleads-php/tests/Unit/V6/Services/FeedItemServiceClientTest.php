...
use Google\Ads\GoogleAds\V6\Services\MutateFeedItemsResponse;
...
class FeedItemServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedItemTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.FeedItemService/GetFeedItem', $actualFuncCall);
    ...
    public function mutateFeedItemsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.FeedItemService/MutateFeedItems', $actualFuncCall);
