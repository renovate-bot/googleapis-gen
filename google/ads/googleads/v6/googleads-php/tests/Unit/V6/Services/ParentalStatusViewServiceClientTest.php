...
use Google\Ads\GoogleAds\V6\Resources\ParentalStatusView;
...
class ParentalStatusViewServiceClientTest extends GeneratedTest
{
    ...
    public function getParentalStatusViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.ParentalStatusViewService/GetParentalStatusView', $actualFuncCall);
