...
class RemarketingActionServiceClientTest extends GeneratedTest
{
    ...
    public function getRemarketingActionTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->remarketingActionName('[CUSTOMER_ID]', '[REMARKETING_ACTION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.RemarketingActionService/GetRemarketingAction', $actualFuncCall);
    ...
    public function mutateRemarketingActionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.RemarketingActionService/MutateRemarketingActions', $actualFuncCall);
