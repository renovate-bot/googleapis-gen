...
use Google\Ads\GoogleAds\V6\Resources\HotelPerformanceView;
...
class HotelPerformanceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getHotelPerformanceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.HotelPerformanceViewService/GetHotelPerformanceView', $actualFuncCall);
