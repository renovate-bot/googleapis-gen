...
class LabelServiceClientTest extends GeneratedTest
{
    ...
    public function getLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.LabelService/GetLabel', $actualFuncCall);
    ...
    public function mutateLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.LabelService/MutateLabels', $actualFuncCall);
