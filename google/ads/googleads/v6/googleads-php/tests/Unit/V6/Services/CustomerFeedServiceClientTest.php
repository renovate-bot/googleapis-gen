...
class CustomerFeedServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerFeedTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->customerFeedName('[CUSTOMER_ID]', '[FEED_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.CustomerFeedService/GetCustomerFeed', $actualFuncCall);
    ...
    public function mutateCustomerFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.CustomerFeedService/MutateCustomerFeeds', $actualFuncCall);
