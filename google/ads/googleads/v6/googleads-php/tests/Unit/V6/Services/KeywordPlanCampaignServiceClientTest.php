...
class KeywordPlanCampaignServiceClientTest extends GeneratedTest
{
    ...
    public function getKeywordPlanCampaignTest()
    {
        ...
        $expectedResponse->setKeywordPlan($keywordPlan);
        $expectedResponse->setId($id);
        $expectedResponse->setName($name);
        $expectedResponse->setCpcBidMicros($cpcBidMicros);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->keywordPlanCampaignName('[CUSTOMER_ID]', '[KEYWORD_PLAN_CAMPAIGN_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.KeywordPlanCampaignService/GetKeywordPlanCampaign', $actualFuncCall);
    ...
    public function mutateKeywordPlanCampaignsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.KeywordPlanCampaignService/MutateKeywordPlanCampaigns', $actualFuncCall);
