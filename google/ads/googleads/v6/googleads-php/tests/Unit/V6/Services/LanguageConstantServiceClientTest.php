...
use Google\Ads\GoogleAds\V6\Resources\LanguageConstant;
...
class LanguageConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getLanguageConstantTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->languageConstantName('[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.LanguageConstantService/GetLanguageConstant', $actualFuncCall);
