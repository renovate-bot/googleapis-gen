...
use Google\Ads\GoogleAds\V6\Resources\ManagedPlacementView;
...
class ManagedPlacementViewServiceClientTest extends GeneratedTest
{
    ...
    public function getManagedPlacementViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.ManagedPlacementViewService/GetManagedPlacementView', $actualFuncCall);
