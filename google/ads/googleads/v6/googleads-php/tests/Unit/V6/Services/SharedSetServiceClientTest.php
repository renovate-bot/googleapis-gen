...
use Google\Ads\GoogleAds\V6\Services\MutateSharedSetsResponse;
...
class SharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function getSharedSetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.SharedSetService/GetSharedSet', $actualFuncCall);
    ...
    public function mutateSharedSetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.SharedSetService/MutateSharedSets', $actualFuncCall);
