 ...
 * @group gapic
 */
class TopicViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getTopicViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->topicViewName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v6.services.TopicViewService/GetTopicView', $actualFuncCall);
