...
class CampaignDraftServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.CampaignDraftService/GetCampaignDraft', $actualFuncCall);
    ...
    public function mutateCampaignDraftsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.CampaignDraftService/MutateCampaignDrafts', $actualFuncCall);
    ...
    public function promoteCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v6.services.CampaignDraftService/PromoteCampaignDraft', $actualApiFuncCall);
    ...
    public function listCampaignDraftAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v6.services.CampaignDraftService/ListCampaignDraftAsyncErrors', $actualFuncCall);
