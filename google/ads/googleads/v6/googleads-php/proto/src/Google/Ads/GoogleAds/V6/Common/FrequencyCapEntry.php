 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.FrequencyCapEntry</code>
 */
class FrequencyCapEntry extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Ads\GoogleAds\V6\Common\FrequencyCapKey $key
     *           The key of a particular frequency cap. There can be no more
     *           than one frequency cap with the same key.
     *     @type int $cap
     *           Maximum number of events allowed during the time range by this cap.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Common\FrequencyCap::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.FrequencyCapKey key = 1;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\FrequencyCapKey $var
     * @return $this
     */
    public function setKey($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\FrequencyCapKey::class);
        $this->key = $var;
