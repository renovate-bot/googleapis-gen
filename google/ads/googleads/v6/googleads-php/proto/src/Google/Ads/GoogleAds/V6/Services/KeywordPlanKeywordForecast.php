 ...
 * A keyword forecast.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.KeywordPlanKeywordForecast</code>
 */
class KeywordPlanKeywordForecast extends \Google\Protobuf\Internal\Message
{
     ...
     *           The resource name of the Keyword Plan keyword related to the forecast.
     *           `customers/{customer_id}/keywordPlanAdGroupKeywords/{keyword_plan_ad_group_keyword_id}`
     *     @type \Google\Ads\GoogleAds\V6\Services\ForecastMetrics $keyword_forecast
     *           The forecast for the Keyword Plan keyword.
     * }
     */
