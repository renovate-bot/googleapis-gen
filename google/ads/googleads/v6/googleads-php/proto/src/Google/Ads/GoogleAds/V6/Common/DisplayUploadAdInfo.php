 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.DisplayUploadAdInfo</code>
 */
class DisplayUploadAdInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.DisplayUploadProductTypeEnum.DisplayUploadProductType display_upload_product_type = 1;</code>
     */
     ...
     *           The product type of this ad. See comments on the enum for details.
     *     @type \Google\Ads\GoogleAds\V6\Common\AdMediaBundleAsset $media_bundle
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\DisplayUploadProductTypeEnum\DisplayUploadProductType::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.AdMediaBundleAsset media_bundle = 2;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\AdMediaBundleAsset $var
     * @return $this
     */
    public function setMediaBundle($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\AdMediaBundleAsset::class);
