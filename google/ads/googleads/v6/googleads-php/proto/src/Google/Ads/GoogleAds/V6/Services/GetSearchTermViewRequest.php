...
/**
 * Request message for [SearchTermViewService.GetSearchTermView][google.ads.googleads.v6.services.SearchTermViewService.GetSearchTermView].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.GetSearchTermViewRequest</code>
 */
class GetSearchTermViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\SearchTermViewService::initOnce();
