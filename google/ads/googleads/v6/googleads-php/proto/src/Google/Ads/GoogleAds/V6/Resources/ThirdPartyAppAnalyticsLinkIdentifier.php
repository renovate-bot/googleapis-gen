 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.ThirdPartyAppAnalyticsLinkIdentifier</code>
 */
class ThirdPartyAppAnalyticsLinkIdentifier extends \Google\Protobuf\Internal\Message
{
     ...
     * the link.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.MobileAppVendorEnum.MobileAppVendor app_vendor = 3 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\MobileAppVendorEnum\MobileAppVendor::class);
        $this->app_vendor = $var;
