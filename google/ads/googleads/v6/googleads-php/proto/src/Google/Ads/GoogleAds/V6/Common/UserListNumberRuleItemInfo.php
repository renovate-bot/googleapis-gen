 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.UserListNumberRuleItemInfo</code>
 */
class UserListNumberRuleItemInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * rule item.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator operator = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\UserListNumberRuleItemOperatorEnum\UserListNumberRuleItemOperator::class);
        $this->operator = $var;
