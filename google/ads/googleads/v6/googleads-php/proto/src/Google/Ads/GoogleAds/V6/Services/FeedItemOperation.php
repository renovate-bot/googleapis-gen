 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.FeedItemOperation</code>
 */
class FeedItemOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V6\Resources\FeedItem $create
     *           Create operation: No resource name is expected for the new feed item.
     *     @type \Google\Ads\GoogleAds\V6\Resources\FeedItem $update
     ...
     * Create operation: No resource name is expected for the new feed item.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.resources.FeedItem create = 1;</code>
     ...
     * name.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.resources.FeedItem update = 2;</code>
     * @return \Google\Ads\GoogleAds\V6\Resources\FeedItem|null
     */
