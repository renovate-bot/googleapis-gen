 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.RemarketingActionOperation</code>
 */
class RemarketingActionOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V6\Resources\RemarketingAction $create
     *           Create operation: No resource name is expected for the new remarketing
     *           action.
     *     @type \Google\Ads\GoogleAds\V6\Resources\RemarketingAction $update
