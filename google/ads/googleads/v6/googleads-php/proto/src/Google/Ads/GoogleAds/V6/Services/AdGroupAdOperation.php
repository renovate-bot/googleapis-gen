 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.AdGroupAdOperation</code>
 */
class AdGroupAdOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyValidationParameter $policy_validation_parameter
     *           Configuration for how policies are validated.
     *     @type \Google\Ads\GoogleAds\V6\Resources\AdGroupAd $create
     *           Create operation: No resource name is expected for the new ad.
     *     @type \Google\Ads\GoogleAds\V6\Resources\AdGroupAd $update
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\AdGroupAdService::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.PolicyValidationParameter policy_validation_parameter = 5;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PolicyValidationParameter $var
     * @return $this
     */
    public function setPolicyValidationParameter($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\PolicyValidationParameter::class);
