 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.errors.ListOperationErrorEnum</code>
 */
class ListOperationErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Errors\ListOperationError::initOnce();
