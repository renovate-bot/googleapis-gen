 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.CampaignCriterionSimulation</code>
 */
class CampaignCriterionSimulation extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. Last day on which the simulation is based, in YYYY-MM-DD format.
     *     @type \Google\Ads\GoogleAds\V6\Common\BidModifierSimulationPointList $bid_modifier_point_list
     *           Output only. Simulation points if the simulation type is BID_MODIFIER.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Resources\CampaignCriterionSimulation::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.BidModifierSimulationPointList bid_modifier_point_list = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V6\Common\BidModifierSimulationPointList $var
     * @return $this
     */
    public function setBidModifierPointList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\BidModifierSimulationPointList::class);
