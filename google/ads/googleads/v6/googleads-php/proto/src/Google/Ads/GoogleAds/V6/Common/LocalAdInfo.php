 ...
 * A local ad.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.LocalAdInfo</code>
 */
class LocalAdInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.AdTextAsset call_to_actions = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.AdImageAsset marketing_images = 4;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.AdImageAsset logo_images = 5;</code>
     */
    private $logo_images;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.AdVideoAsset videos = 6;</code>
     */
    private $videos;
    /**
     ...
     *           will be selected from this list. At least 1 and at most 5 descriptions must
     *           be specified.
     *     @type \Google\Ads\GoogleAds\V6\Common\AdTextAsset[]|\Google\Protobuf\Internal\RepeatedField $call_to_actions
     *           List of text assets for call-to-actions. When the ad serves the
     *           call-to-actions will be selected from this list. Call-to-actions are
     *           optional and at most 5 can be specified.
     *     @type \Google\Ads\GoogleAds\V6\Common\AdImageAsset[]|\Google\Protobuf\Internal\RepeatedField $marketing_images
     *           List of marketing image assets that may be displayed with the ad. The
     *           images must be 314x600 pixels or 320x320 pixels. At least 1 and at most
     *           20 image assets must be specified.
     *     @type \Google\Ads\GoogleAds\V6\Common\AdImageAsset[]|\Google\Protobuf\Internal\RepeatedField $logo_images
     *           List of logo image assets that may be displayed with the ad. The images
     *           must be 128x128 pixels and not larger than 120KB. At least 1 and at most 5
     *           image assets must be specified.
     *     @type \Google\Ads\GoogleAds\V6\Common\AdVideoAsset[]|\Google\Protobuf\Internal\RepeatedField $videos
     *           List of YouTube video assets that may be displayed with the ad. Videos
     *           are optional and at most 20 can be specified.
     *     @type string $path1
     *           First part of optional text that may appear appended to the url displayed
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.AdImageAsset marketing_images = 4;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\AdImageAsset[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMarketingImages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Common\AdImageAsset::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.AdVideoAsset videos = 6;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\AdVideoAsset[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setVideos($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Common\AdVideoAsset::class);
        $this->videos = $arr;
