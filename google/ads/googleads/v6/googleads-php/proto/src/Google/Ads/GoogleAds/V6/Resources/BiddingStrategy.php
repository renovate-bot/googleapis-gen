 ...
 * A bidding strategy.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.BiddingStrategy</code>
 */
class BiddingStrategy extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.BiddingStrategyStatusEnum.BiddingStrategyStatus status = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     * This field is read-only.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.BiddingStrategyTypeEnum.BiddingStrategyType type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $type = 0;
    /**
     ...
     *           Output only. The number of non-removed campaigns attached to this bidding strategy.
     *           This field is read-only.
     *     @type \Google\Ads\GoogleAds\V6\Common\EnhancedCpc $enhanced_cpc
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Resources\BiddingStrategy::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\BiddingStrategyStatusEnum\BiddingStrategyStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.EnhancedCpc enhanced_cpc = 7;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\EnhancedCpc $var
     * @return $this
     */
    public function setEnhancedCpc($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\EnhancedCpc::class);
