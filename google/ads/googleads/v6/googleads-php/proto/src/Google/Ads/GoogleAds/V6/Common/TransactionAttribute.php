 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.TransactionAttribute</code>
 */
class TransactionAttribute extends \Google\Protobuf\Internal\Message
{
     ...
     *           Transaction order id.
     *           Accessible only to customers on the allow-list.
     *     @type \Google\Ads\GoogleAds\V6\Common\StoreAttribute $store_attribute
     *           Store attributes of the transaction.
     *           Accessible only to customers on the allow-list.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.StoreAttribute store_attribute = 6;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\StoreAttribute $var
     * @return $this
     */
    public function setStoreAttribute($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\StoreAttribute::class);
