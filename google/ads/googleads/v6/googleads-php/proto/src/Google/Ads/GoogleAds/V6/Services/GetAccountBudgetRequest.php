 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.GetAccountBudgetRequest</code>
 */
class GetAccountBudgetRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\AccountBudgetService::initOnce();
