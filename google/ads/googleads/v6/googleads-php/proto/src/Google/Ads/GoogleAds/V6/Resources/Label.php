 ...
 * A label.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.Label</code>
 */
class Label extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.LabelStatusEnum.LabelStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     *     @type int $status
     *           Output only. Status of the label. Read only.
     *     @type \Google\Ads\GoogleAds\V6\Common\TextLabel $text_label
     *           A type of label displaying text on a colored background.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Resources\Label::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\LabelStatusEnum\LabelStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.TextLabel text_label = 5;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\TextLabel $var
     * @return $this
     */
    public function setTextLabel($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\TextLabel::class);
        $this->text_label = $var;
