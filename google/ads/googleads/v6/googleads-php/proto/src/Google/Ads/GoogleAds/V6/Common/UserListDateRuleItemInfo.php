 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.UserListDateRuleItemInfo</code>
 */
class UserListDateRuleItemInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * rule item.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator operator = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\UserListDateRuleItemOperatorEnum\UserListDateRuleItemOperator::class);
        $this->operator = $var;
