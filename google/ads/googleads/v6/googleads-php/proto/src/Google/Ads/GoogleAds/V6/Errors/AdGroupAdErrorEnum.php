 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.errors.AdGroupAdErrorEnum</code>
 */
class AdGroupAdErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Errors\AdGroupAdError::initOnce();
