...
/**
 * Request message for [LabelService.MutateLabels][google.ads.googleads.v6.services.LabelService.MutateLabels].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateLabelsRequest</code>
 */
class MutateLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.LabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose labels are being modified.
     *     @type \Google\Ads\GoogleAds\V6\Services\LabelOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on labels.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.LabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\LabelOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Services\LabelOperation::class);
        $this->operations = $arr;
