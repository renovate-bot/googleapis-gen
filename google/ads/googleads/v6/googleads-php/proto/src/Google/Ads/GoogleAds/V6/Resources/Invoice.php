 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.Invoice</code>
 */
class Invoice extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.InvoiceTypeEnum.InvoiceType type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $type = 0;
    /**
     ...
     * invoice.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.resources.Invoice.AccountBudgetSummary account_budget_summaries = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The due date in yyyy-mm-dd format.
     *     @type \Google\Ads\GoogleAds\V6\Common\DateRange $service_date_range
     *           Output only. The service period date range of this invoice. The end date is inclusive.
     ...
     *           Output only. The URL to a PDF copy of the invoice. Users need to pass in their OAuth
     *           token to request the PDF with this URL.
     *     @type \Google\Ads\GoogleAds\V6\Resources\Invoice\AccountBudgetSummary[]|\Google\Protobuf\Internal\RepeatedField $account_budget_summaries
     *           Output only. The list of summarized account budget information associated with this
     *           invoice.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\InvoiceTypeEnum\InvoiceType::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.resources.Invoice.AccountBudgetSummary account_budget_summaries = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V6\Resources\Invoice\AccountBudgetSummary[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAccountBudgetSummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Resources\Invoice\AccountBudgetSummary::class);
