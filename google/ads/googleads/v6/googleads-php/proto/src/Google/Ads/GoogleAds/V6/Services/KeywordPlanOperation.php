 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.KeywordPlanOperation</code>
 */
class KeywordPlanOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           The FieldMask that determines which resource fields are modified in an
     *           update.
     *     @type \Google\Ads\GoogleAds\V6\Resources\KeywordPlan $create
     *           Create operation: No resource name is expected for the new keyword plan.
     *     @type \Google\Ads\GoogleAds\V6\Resources\KeywordPlan $update
