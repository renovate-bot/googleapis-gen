 ...
 * keyword.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.KeywordPlanCampaignKeywordOperation</code>
 */
class KeywordPlanCampaignKeywordOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           The FieldMask that determines which resource fields are modified in an
     *           update.
     *     @type \Google\Ads\GoogleAds\V6\Resources\KeywordPlanCampaignKeyword $create
     *           Create operation: No resource name is expected for the new Keyword Plan
     *           campaign keyword.
     *     @type \Google\Ads\GoogleAds\V6\Resources\KeywordPlanCampaignKeyword $update
