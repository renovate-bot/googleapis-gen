 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.DynamicAffiliateLocationSetFilter</code>
 */
class DynamicAffiliateLocationSetFilter extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Common\FeedItemSetFilterTypeInfos::initOnce();
