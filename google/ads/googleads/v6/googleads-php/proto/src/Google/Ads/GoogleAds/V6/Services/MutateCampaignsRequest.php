 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateCampaignsRequest</code>
 */
class MutateCampaignsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.CampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose campaigns are being modified.
     *     @type \Google\Ads\GoogleAds\V6\Services\CampaignOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaigns.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.CampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\CampaignOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Services\CampaignOperation::class);
        $this->operations = $arr;
