...
/**
 * Request message for [LanguageConstantService.GetLanguageConstant][google.ads.googleads.v6.services.LanguageConstantService.GetLanguageConstant].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.GetLanguageConstantRequest</code>
 */
class GetLanguageConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\LanguageConstantService::initOnce();
