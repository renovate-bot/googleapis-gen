 ...
 * A Gmail ad.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.GmailAdInfo</code>
 */
class GmailAdInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.ProductImage product_images = 7;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.ProductVideo product_videos = 8;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V6\Common\GmailTeaser $teaser
     *           The Gmail teaser.
     ...
     *           Description of the marketing image.
     *     @type \Google\Ads\GoogleAds\V6\Common\DisplayCallToAction $marketing_image_display_call_to_action
     *           Display-call-to-action of the marketing image.
     *     @type \Google\Ads\GoogleAds\V6\Common\ProductImage[]|\Google\Protobuf\Internal\RepeatedField $product_images
     *           Product images. Up to 15 images are supported.
     *     @type \Google\Ads\GoogleAds\V6\Common\ProductVideo[]|\Google\Protobuf\Internal\RepeatedField $product_videos
     *           Product videos. Up to 7 videos are supported. At least one product video
     *           or a marketing image must be specified.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.GmailTeaser teaser = 1;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\GmailTeaser $var
     * @return $this
     */
    public function setTeaser($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\GmailTeaser::class);
        $this->teaser = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.DisplayCallToAction marketing_image_display_call_to_action = 6;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\DisplayCallToAction $var
     * @return $this
     */
    public function setMarketingImageDisplayCallToAction($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\DisplayCallToAction::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.ProductImage product_images = 7;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\ProductImage[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProductImages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Common\ProductImage::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.ProductVideo product_videos = 8;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\ProductVideo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProductVideos($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Common\ProductVideo::class);
