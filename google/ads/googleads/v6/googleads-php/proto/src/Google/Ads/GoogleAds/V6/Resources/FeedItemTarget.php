 ...
 * A feed item target.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.FeedItemTarget</code>
 */
class FeedItemTarget extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.FeedItemTargetTypeEnum.FeedItemTargetType feed_item_target_type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.FeedItemTargetStatusEnum.FeedItemTargetStatus status = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    protected $target;
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Resources\FeedItemTarget::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\FeedItemTargetTypeEnum\FeedItemTargetType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\FeedItemTargetStatusEnum\FeedItemTargetStatus::class);
        $this->status = $var;
     ...
     * Immutable. The targeted device.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice device = 9 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\FeedItemTargetDeviceEnum\FeedItemTargetDevice::class);
