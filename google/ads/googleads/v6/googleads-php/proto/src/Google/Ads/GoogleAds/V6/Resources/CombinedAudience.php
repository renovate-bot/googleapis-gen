 ...
 * audiences.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.CombinedAudience</code>
 */
class CombinedAudience extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.CombinedAudienceStatusEnum.CombinedAudienceStatus status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Resources\CombinedAudience::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\CombinedAudienceStatusEnum\CombinedAudienceStatus::class);
        $this->status = $var;
