...
/**
 * Request message for [ExtensionFeedItemService.MutateExtensionFeedItems][google.ads.googleads.v6.services.ExtensionFeedItemService.MutateExtensionFeedItems].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateExtensionFeedItemsRequest</code>
 */
class MutateExtensionFeedItemsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.ExtensionFeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose extension feed items are being
     *           modified.
     *     @type \Google\Ads\GoogleAds\V6\Services\ExtensionFeedItemOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual extension feed items.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.ExtensionFeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\ExtensionFeedItemOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Services\ExtensionFeedItemOperation::class);
        $this->operations = $arr;
