 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.enums.ConversionActionCountingTypeEnum</code>
 */
class ConversionActionCountingTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Enums\ConversionActionCountingType::initOnce();
