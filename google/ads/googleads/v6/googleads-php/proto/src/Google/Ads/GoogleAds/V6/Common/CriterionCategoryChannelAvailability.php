 ...
 * in.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.CriterionCategoryChannelAvailability</code>
 */
class CriterionCategoryChannelAvailability extends \Google\Protobuf\Internal\Message
{
     ...
     * be set).
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode availability_mode = 1;</code>
     */
    protected $availability_mode = 0;
    /**
     * Channel type the category is available to.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType advertising_channel_type = 2;</code>
     */
    protected $advertising_channel_type = 0;
    /**
     * Channel subtypes under the channel type the category is available to.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType advertising_channel_sub_type = 3;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Common\CriterionCategoryAvailability::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\CriterionCategoryChannelAvailabilityModeEnum\CriterionCategoryChannelAvailabilityMode::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V6\Enums\AdvertisingChannelSubTypeEnum\AdvertisingChannelSubType::class);
