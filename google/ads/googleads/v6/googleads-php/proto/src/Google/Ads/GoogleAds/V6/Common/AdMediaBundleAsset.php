 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.AdMediaBundleAsset</code>
 */
class AdMediaBundleAsset extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Common\AdAsset::initOnce();
