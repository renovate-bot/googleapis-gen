 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.Preferences</code>
 */
class Preferences extends \Google\Protobuf\Internal\Message
{
     ...
     * If not set, default is any value.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.ReachPlanAdLengthEnum.ReachPlanAdLength ad_length = 3;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\ReachPlanAdLengthEnum\ReachPlanAdLength::class);
        $this->ad_length = $var;
