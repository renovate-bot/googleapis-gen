 ...
 * be validated.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.ProximityInfo</code>
 */
class ProximityInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.ProximityRadiusUnitsEnum.ProximityRadiusUnits radius_units = 3;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V6\Common\GeoPointInfo $geo_point
     *           Latitude and longitude.
     *     @type float $radius
     *           The radius of the proximity.
     *     @type int $radius_units
     *           The unit of measurement of the radius. Default is KILOMETERS.
     *     @type \Google\Ads\GoogleAds\V6\Common\AddressInfo $address
     *           Full address.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.GeoPointInfo geo_point = 1;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\GeoPointInfo $var
     * @return $this
     */
    public function setGeoPoint($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\GeoPointInfo::class);
        $this->geo_point = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\ProximityRadiusUnitsEnum\ProximityRadiusUnits::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.AddressInfo address = 4;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\AddressInfo $var
     * @return $this
     */
    public function setAddress($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\AddressInfo::class);
        $this->address = $var;
