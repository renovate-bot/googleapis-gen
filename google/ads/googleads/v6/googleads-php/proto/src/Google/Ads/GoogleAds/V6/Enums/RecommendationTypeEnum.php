 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.enums.RecommendationTypeEnum</code>
 */
class RecommendationTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Enums\RecommendationType::initOnce();
