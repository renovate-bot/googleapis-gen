...
/**
 * Request message for [CurrencyConstantService.GetCurrencyConstant][google.ads.googleads.v6.services.CurrencyConstantService.GetCurrencyConstant].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.GetCurrencyConstantRequest</code>
 */
class GetCurrencyConstantRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\CurrencyConstantService::initOnce();
