 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.errors.AdGroupBidModifierErrorEnum</code>
 */
class AdGroupBidModifierErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Errors\AdGroupBidModifierError::initOnce();
