...
/**
 * Request message for [AdGroupCriterionService.MutateAdGroupCriteria][google.ads.googleads.v6.services.AdGroupCriterionService.MutateAdGroupCriteria].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateAdGroupCriteriaRequest</code>
 */
class MutateAdGroupCriteriaRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.AdGroupCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. ID of the customer whose criteria are being modified.
     *     @type \Google\Ads\GoogleAds\V6\Services\AdGroupCriterionOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual criteria.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\AdGroupCriterionService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.AdGroupCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\AdGroupCriterionOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Services\AdGroupCriterionOperation::class);
        $this->operations = $arr;
