 ...
 * extensions.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.CallView</code>
 */
class CallView extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string caller_region_code = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $caller_region_code = '';
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation call_tracking_display_location = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $call_tracking_display_location = 0;
    /**
     * Output only. The type of the call.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.CallTypeEnum.CallType type = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $type = 0;
    /**
     * Output only. The status of the call.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus call_status = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Call view resource names have the form:
     *           `customers/{customer_id}/callViews/{call_detail_id}`
     *     @type string $caller_region_code
     *           Output only. Region code of the caller.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Resources\CallView::initOnce();
     ...
     * @return string
     */
    public function getCallerRegionCode()
    {
        return $this->caller_region_code;
    }
     ...
     * @return $this
     */
    public function setCallerRegionCode($var)
    {
        GPBUtil::checkString($var, True);
        $this->caller_region_code = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\CallTrackingDisplayLocationEnum\CallTrackingDisplayLocation::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\CallTypeEnum\CallType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\GoogleVoiceCallStatusEnum\GoogleVoiceCallStatus::class);
