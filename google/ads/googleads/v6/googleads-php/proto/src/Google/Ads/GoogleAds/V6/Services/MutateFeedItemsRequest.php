...
/**
 * Request message for [FeedItemService.MutateFeedItems][google.ads.googleads.v6.services.FeedItemService.MutateFeedItems].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateFeedItemsRequest</code>
 */
class MutateFeedItemsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.FeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose feed items are being modified.
     *     @type \Google\Ads\GoogleAds\V6\Services\FeedItemOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual feed items.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\FeedItemService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.FeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\FeedItemOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Services\FeedItemOperation::class);
        $this->operations = $arr;
