 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.BiddingStrategyOperation</code>
 */
class BiddingStrategyOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V6\Resources\BiddingStrategy $create
     *           Create operation: No resource name is expected for the new bidding
     *           strategy.
     *     @type \Google\Ads\GoogleAds\V6\Resources\BiddingStrategy $update
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\BiddingStrategyService::initOnce();
