 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateAdGroupAdsResponse</code>
 */
class MutateAdGroupAdsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.MutateAdGroupAdResult results = 2;</code>
     */
    private $results;
     ...
     *           operations. If any errors occur outside the operations (e.g. auth errors),
     *           we return an RPC level error.
     *     @type \Google\Ads\GoogleAds\V6\Services\MutateAdGroupAdResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           All results for the mutate.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.MutateAdGroupAdResult results = 2;</code>
     * @param \Google\Ads\GoogleAds\V6\Services\MutateAdGroupAdResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Services\MutateAdGroupAdResult::class);
        $this->results = $arr;
