 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.PriceOffer</code>
 */
class PriceOffer extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit unit = 4;</code>
     */
    protected $unit = 0;
    /**
     ...
     *           Description text of this offer.
     *     @type \Google\Ads\GoogleAds\V6\Common\Money $price
     *           Price value of this offer.
     *     @type int $unit
     *           Price unit for this offer.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\PriceExtensionPriceUnitEnum\PriceExtensionPriceUnit::class);
        $this->unit = $var;
