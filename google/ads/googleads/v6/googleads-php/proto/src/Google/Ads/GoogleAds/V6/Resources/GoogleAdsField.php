 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.GoogleAdsField</code>
 */
class GoogleAdsField extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory category = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * in WHERE clauses.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType data_type = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Resources\GoogleAdsField::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\GoogleAdsFieldCategoryEnum\GoogleAdsFieldCategory::class);
        $this->category = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\GoogleAdsFieldDataTypeEnum\GoogleAdsFieldDataType::class);
        $this->data_type = $var;
