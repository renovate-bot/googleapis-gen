 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateCustomerClientLinkRequest</code>
 */
class MutateCustomerClientLinkRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The ID of the customer whose customer link are being modified.
     *     @type \Google\Ads\GoogleAds\V6\Services\CustomerClientLinkOperation $operation
     *           Required. The operation to perform on the individual CustomerClientLink.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.services.CustomerClientLinkOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\CustomerClientLinkOperation $var
     * @return $this
     */
    public function setOperation($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Services\CustomerClientLinkOperation::class);
        $this->operation = $var;
