 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.KeywordPlanAdGroupOperation</code>
 */
class KeywordPlanAdGroupOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           The FieldMask that determines which resource fields are modified in an
     *           update.
     *     @type \Google\Ads\GoogleAds\V6\Resources\KeywordPlanAdGroup $create
     *           Create operation: No resource name is expected for the new Keyword Plan
     *           ad group.
     *     @type \Google\Ads\GoogleAds\V6\Resources\KeywordPlanAdGroup $update
