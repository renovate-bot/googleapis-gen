 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.CustomInterestOperation</code>
 */
class CustomInterestOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V6\Resources\CustomInterest $create
     *           Create operation: No resource name is expected for the new custom
     *           interest.
     *     @type \Google\Ads\GoogleAds\V6\Resources\CustomInterest $update
