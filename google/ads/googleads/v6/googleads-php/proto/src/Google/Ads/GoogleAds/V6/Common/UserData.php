 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.UserData</code>
 */
class UserData extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.UserIdentifier user_identifiers = 1;</code>
     */
     ...
     *
     *     @type \Google\Ads\GoogleAds\V6\Common\UserIdentifier[]|\Google\Protobuf\Internal\RepeatedField $user_identifiers
     *           User identification info. Required.
     *     @type \Google\Ads\GoogleAds\V6\Common\TransactionAttribute $transaction_attribute
     *           Additional transactions/attributes associated with the user.
     *           Required when updating store sales data.
     *     @type \Google\Ads\GoogleAds\V6\Common\UserAttribute $user_attribute
     *           Additional attributes associated with the user. Required when updating
     *           customer match attributes. These have an expiration of 540 days.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.UserIdentifier user_identifiers = 1;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\UserIdentifier[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setUserIdentifiers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Common\UserIdentifier::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.TransactionAttribute transaction_attribute = 2;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\TransactionAttribute $var
     * @return $this
     */
    public function setTransactionAttribute($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\TransactionAttribute::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.UserAttribute user_attribute = 3;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\UserAttribute $var
     * @return $this
     */
    public function setUserAttribute($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\UserAttribute::class);
