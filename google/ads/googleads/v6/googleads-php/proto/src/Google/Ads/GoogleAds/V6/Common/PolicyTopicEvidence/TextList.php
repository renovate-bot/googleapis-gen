 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.PolicyTopicEvidence.TextList</code>
 */
...
class_alias(TextList::class, \Google\Ads\GoogleAds\V6\Common\PolicyTopicEvidence_TextList::class);
