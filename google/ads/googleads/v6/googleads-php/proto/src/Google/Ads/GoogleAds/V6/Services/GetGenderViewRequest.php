...
/**
 * Request message for [GenderViewService.GetGenderView][google.ads.googleads.v6.services.GenderViewService.GetGenderView].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.GetGenderViewRequest</code>
 */
class GetGenderViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\GenderViewService::initOnce();
