 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.enums.CriterionCategoryChannelAvailabilityModeEnum</code>
 */
class CriterionCategoryChannelAvailabilityModeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Enums\CriterionCategoryChannelAvailabilityMode::initOnce();
