...
/**
 * Request message for [ProductGroupViewService.GetProductGroupView][google.ads.googleads.v6.services.ProductGroupViewService.GetProductGroupView].
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.GetProductGroupViewRequest</code>
 */
class GetProductGroupViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\ProductGroupViewService::initOnce();
