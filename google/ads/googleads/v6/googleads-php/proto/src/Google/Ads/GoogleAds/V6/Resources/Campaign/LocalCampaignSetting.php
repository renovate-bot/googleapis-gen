 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.Campaign.LocalCampaignSetting</code>
 */
class LocalCampaignSetting extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.LocationSourceTypeEnum.LocationSourceType location_source_type = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\LocationSourceTypeEnum\LocationSourceType::class);
...
class_alias(LocalCampaignSetting::class, \Google\Ads\GoogleAds\V6\Resources\Campaign_LocalCampaignSetting::class);
