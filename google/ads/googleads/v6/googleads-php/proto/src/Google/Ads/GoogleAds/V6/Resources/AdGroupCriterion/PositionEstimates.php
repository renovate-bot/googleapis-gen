...
namespace Google\Ads\GoogleAds\V6\Resources\AdGroupCriterion;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.AdGroupCriterion.PositionEstimates</code>
 */
class PositionEstimates extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Resources\AdGroupCriterion::initOnce();
...
class_alias(PositionEstimates::class, \Google\Ads\GoogleAds\V6\Resources\AdGroupCriterion_PositionEstimates::class);
