 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.CampaignBudgetOperation</code>
 */
class CampaignBudgetOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V6\Resources\CampaignBudget $create
     *           Create operation: No resource name is expected for the new budget.
     *     @type \Google\Ads\GoogleAds\V6\Resources\CampaignBudget $update
