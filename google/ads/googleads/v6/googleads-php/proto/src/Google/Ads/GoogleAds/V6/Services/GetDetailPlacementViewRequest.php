 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.GetDetailPlacementViewRequest</code>
 */
class GetDetailPlacementViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Services\DetailPlacementViewService::initOnce();
