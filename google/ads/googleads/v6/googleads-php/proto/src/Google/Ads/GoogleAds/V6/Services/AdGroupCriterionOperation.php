 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.AdGroupCriterionOperation</code>
 */
class AdGroupCriterionOperation extends \Google\Protobuf\Internal\Message
{
     ...
     * certificates.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.PolicyViolationKey exempt_policy_violation_keys = 5;</code>
     */
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V6\Common\PolicyViolationKey[]|\Google\Protobuf\Internal\RepeatedField $exempt_policy_violation_keys
     *           The list of policy violation keys that should not cause a
     *           PolicyViolationError to be reported. Not all policy violations are
     *           exemptable, please refer to the is_exemptible field in the returned
     *           PolicyViolationError.
     ...
     *           policies, re-review of the resource, or a change in advertiser
     *           certificates.
     *     @type \Google\Ads\GoogleAds\V6\Resources\AdGroupCriterion $create
     *           Create operation: No resource name is expected for the new criterion.
     *     @type \Google\Ads\GoogleAds\V6\Resources\AdGroupCriterion $update
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.common.PolicyViolationKey exempt_policy_violation_keys = 5;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\PolicyViolationKey[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setExemptPolicyViolationKeys($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Common\PolicyViolationKey::class);
