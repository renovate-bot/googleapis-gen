 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.enums.KeywordPlanCompetitionLevelEnum</code>
 */
class KeywordPlanCompetitionLevelEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Enums\KeywordPlanCompetitionLevel::initOnce();
