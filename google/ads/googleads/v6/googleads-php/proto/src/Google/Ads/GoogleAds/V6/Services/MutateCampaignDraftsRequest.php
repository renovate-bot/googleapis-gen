 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateCampaignDraftsRequest</code>
 */
class MutateCampaignDraftsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.CampaignDraftOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose campaign drafts are being modified.
     *     @type \Google\Ads\GoogleAds\V6\Services\CampaignDraftOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign drafts.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.CampaignDraftOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\CampaignDraftOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Services\CampaignDraftOperation::class);
        $this->operations = $arr;
