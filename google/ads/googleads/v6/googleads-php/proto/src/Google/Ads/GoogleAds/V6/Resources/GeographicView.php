 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.resources.GeographicView</code>
 */
class GeographicView extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.GeoTargetingTypeEnum.GeoTargetingType location_type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Resources\GeographicView::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\GeoTargetingTypeEnum\GeoTargetingType::class);
