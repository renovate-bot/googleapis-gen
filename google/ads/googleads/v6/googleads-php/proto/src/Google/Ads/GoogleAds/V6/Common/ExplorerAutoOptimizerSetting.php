 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.ExplorerAutoOptimizerSetting</code>
 */
class ExplorerAutoOptimizerSetting extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V6\Common\ExplorerAutoOptimizerSetting::initOnce();
