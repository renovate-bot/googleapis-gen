...
/**
 * Request message for [MediaFileService.MutateMediaFiles][google.ads.googleads.v6.services.MediaFileService.MutateMediaFiles]
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.services.MutateMediaFilesRequest</code>
 */
class MutateMediaFilesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.MediaFileOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose media files are being modified.
     *     @type \Google\Ads\GoogleAds\V6\Services\MediaFileOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual media file.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v6.services.MediaFileOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V6\Services\MediaFileOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V6\Services\MediaFileOperation::class);
        $this->operations = $arr;
