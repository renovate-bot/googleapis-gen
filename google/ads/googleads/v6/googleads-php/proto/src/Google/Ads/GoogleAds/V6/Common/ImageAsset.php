 ...
 * An Image asset.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.ImageAsset</code>
 */
class ImageAsset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.enums.MimeTypeEnum.MimeType mime_type = 3;</code>
     */
     ...
     *     @type int $mime_type
     *           MIME type of the image asset.
     *     @type \Google\Ads\GoogleAds\V6\Common\ImageDimension $full_size
     *           Metadata for this image at its original size.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V6\Enums\MimeTypeEnum\MimeType::class);
        $this->mime_type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.ImageDimension full_size = 4;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\ImageDimension $var
     * @return $this
     */
    public function setFullSize($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\ImageDimension::class);
        $this->full_size = $var;
