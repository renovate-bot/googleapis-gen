 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.Operand.FeedAttributeOperand</code>
 */
...
class_alias(FeedAttributeOperand::class, \Google\Ads\GoogleAds\V6\Common\Operand_FeedAttributeOperand::class);
