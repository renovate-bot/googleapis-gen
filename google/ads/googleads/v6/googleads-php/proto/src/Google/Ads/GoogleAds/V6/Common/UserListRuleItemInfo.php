 ...
 * An atomic rule item.
 *
 * Generated from protobuf message <code>google.ads.googleads.v6.common.UserListRuleItemInfo</code>
 */
class UserListRuleItemInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *           referrer URL (name = 'ref_url__').
     *           This field must be populated when creating a new rule item.
     *     @type \Google\Ads\GoogleAds\V6\Common\UserListNumberRuleItemInfo $number_rule_item
     *           An atomic rule item composed of a number operation.
     *     @type \Google\Ads\GoogleAds\V6\Common\UserListStringRuleItemInfo $string_rule_item
     *           An atomic rule item composed of a string operation.
     *     @type \Google\Ads\GoogleAds\V6\Common\UserListDateRuleItemInfo $date_rule_item
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.UserListNumberRuleItemInfo number_rule_item = 2;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\UserListNumberRuleItemInfo $var
     * @return $this
     */
    public function setNumberRuleItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\UserListNumberRuleItemInfo::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.UserListStringRuleItemInfo string_rule_item = 3;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\UserListStringRuleItemInfo $var
     * @return $this
     */
    public function setStringRuleItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\UserListStringRuleItemInfo::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v6.common.UserListDateRuleItemInfo date_rule_item = 4;</code>
     * @param \Google\Ads\GoogleAds\V6\Common\UserListDateRuleItemInfo $var
     * @return $this
     */
    public function setDateRuleItem($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V6\Common\UserListDateRuleItemInfo::class);
