...
class googleadsCallTransformer(cst.CSTTransformer):
    ...
    'generate_keyword_ideas': ('customer_id', 'language', 'geo_target_constants', 'include_adult_keywords', 'page_token', 'page_size', 'keyword_plan_network', 'keyword_and_url_seed', 'keyword_seed', 'url_seed', 'site_seed', ),
    ...
    'mutate_feed_item_targets': ('customer_id', 'operations', 'response_content_type', ),
