...
from google.ads.googleads.v6.services.services.geographic_view_service import transports
...
def test_geographic_view_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.geographic_view_service.transports.GeographicViewServiceGrpcTransport.__init__') as grpc_transport:
