...
from google.ads.googleads.v6.services.services.feed_mapping_service import FeedMappingServiceClient
from google.ads.googleads.v6.services.services.feed_mapping_service import transports
...
def test_feed_mapping_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.feed_mapping_service.FeedMappingServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v6.services.services.feed_mapping_service.transports.FeedMappingServiceGrpcTransport.__init__') as grpc_transport:
...
def test_feed_mapping_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.feed_mapping_service.transports.FeedMappingServiceTransport.__init__') as Transport:
...
def test_feed_mapping_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v6.services.services.feed_mapping_service.transports.FeedMappingServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.FeedMappingServiceTransport()
        adc.assert_called_once()
