...
from google.ads.googleads.v6.enums.types import summary_row_setting
...
from google.ads.googleads.v6.services.services.google_ads_service import GoogleAdsServiceClient
from google.ads.googleads.v6.services.services.google_ads_service import pagers
from google.ads.googleads.v6.services.services.google_ads_service import transports
...
def test_google_ads_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.google_ads_service.GoogleAdsServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v6.services.services.google_ads_service.transports.GoogleAdsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_google_ads_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.google_ads_service.transports.GoogleAdsServiceTransport.__init__') as Transport:
...
def test_google_ads_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v6.services.services.google_ads_service.transports.GoogleAdsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GoogleAdsServiceTransport()
        adc.assert_called_once()
...
def test_distance_view_path():
    customer_id = "oyster"
    placeholder_chain_id = "nudibranch"
    distance_bucket = "cuttlefish"
...
def test_parse_distance_view_path():
    expected = {
        "customer_id": "mussel",
        "placeholder_chain_id": "winkle",
        "distance_bucket": "nautilus",
    }
...
def test_parse_expanded_landing_page_view_path():
    expected = {
        "customer_id": "winkle",
        "expanded_final_url_fingerprint": "nautilus",
    }
