...
from google.ads.googleads.v6.enums.types import account_link_status
from google.ads.googleads.v6.enums.types import linked_account_type
...
from google.ads.googleads.v6.services.services.account_link_service import AccountLinkServiceClient
from google.ads.googleads.v6.services.services.account_link_service import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert AccountLinkServiceClient._get_default_mtls_endpoint(None) is None
    assert AccountLinkServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert AccountLinkServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert AccountLinkServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert AccountLinkServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert AccountLinkServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_account_link_service_client_from_service_account_info():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        info = {"valid": True}
        client = AccountLinkServiceClient.from_service_account_info(info)
...
def test_account_link_service_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        ...
        client = AccountLinkServiceClient.from_service_account_json("dummy/file/path.json")
        assert client.transport._credentials == creds

        assert client.transport._host == 'googleads.googleapis.com:443'


def test_account_link_service_client_get_transport_class():
    transport = AccountLinkServiceClient.get_transport_class()
    assert transport == transports.AccountLinkServiceGrpcTransport

    transport = AccountLinkServiceClient.get_transport_class("grpc")
    assert transport == transports.AccountLinkServiceGrpcTransport


@mock.patch.object(AccountLinkServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AccountLinkServiceClient))
def test_account_link_service_client_client_options():
    # Check that if channel is provided we won't create a new one.
    with mock.patch('google.ads.googleads.v6.services.services.account_link_service.AccountLinkServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v6.services.services.account_link_service.AccountLinkServiceClient.get_transport_class') as gtc:
        client = AccountLinkServiceClient(transport="grpc")
        gtc.assert_called()

    # Check the case api_endpoint is provided.
    options = client_options.ClientOptions(api_endpoint="squid.clam.whelk")
    with mock.patch('google.ads.googleads.v6.services.services.account_link_service.transports.AccountLinkServiceGrpcTransport.__init__') as grpc_transport:
        grpc_transport.return_value = None
        client = AccountLinkServiceClient(client_options=options)
...
def test_account_link_service_client_mtls_env_auto(use_client_cert_env):
...
def test_account_link_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v6.services.services.account_link_service.transports.AccountLinkServiceGrpcTransport.__init__') as grpc_transport:
        grpc_transport.return_value = None
        client = AccountLinkServiceClient(
...
def test_get_account_link_from_dict():
    test_get_account_link(request_type=dict)
...
def test_create_account_link_from_dict():
    test_create_account_link(request_type=dict)
...
def test_create_account_link_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_account_link(
            ...
            account_link=gagr_account_link.AccountLink(resource_name='resource_name_value'),
        )
...
def test_mutate_account_link_from_dict():
    test_mutate_account_link(request_type=dict)
...
def test_mutate_account_link_flattened():
    ...
    with mock.patch.object(
        ...
        client.mutate_account_link(
            customer_id='customer_id_value',
            operation=account_link_service.AccountLinkOperation(update_mask=field_mask_pb2.FieldMask(paths=['paths_value'])),
        )
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].customer_id == 'customer_id_value'
        assert args[0].operation == account_link_service.AccountLinkOperation(update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
def test_account_link_service_base_transport():
    # Instantiate the base transport.
    with mock.patch('google.ads.googleads.v6.services.services.account_link_service.transports.AccountLinkServiceTransport.__init__') as Transport:
...
def test_account_link_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v6.services.services.account_link_service.transports.AccountLinkServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AccountLinkServiceTransport()
        adc.assert_called_once()
...
def test_account_link_service_grpc_transport_channel():
...
@pytest.mark.parametrize("transport_class", [transports.AccountLinkServiceGrpcTransport])
def test_account_link_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.AccountLinkServiceGrpcTransport,])
def test_account_link_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_parse_customer_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountLinkServiceClient.parse_customer_path(path)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountLinkServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountLinkServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountLinkServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountLinkServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = AccountLinkServiceClient.parse_common_location_path(path)
    assert expected == actual
