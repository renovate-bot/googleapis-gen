...
from google.ads.googleads.v6.services.services.billing_setup_service import BillingSetupServiceClient
from google.ads.googleads.v6.services.services.billing_setup_service import transports
...
def test_billing_setup_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.billing_setup_service.BillingSetupServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v6.services.services.billing_setup_service.transports.BillingSetupServiceGrpcTransport.__init__') as grpc_transport:
...
def test_billing_setup_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.billing_setup_service.transports.BillingSetupServiceTransport.__init__') as Transport:
...
def test_billing_setup_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v6.services.services.billing_setup_service.transports.BillingSetupServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BillingSetupServiceTransport()
        adc.assert_called_once()
