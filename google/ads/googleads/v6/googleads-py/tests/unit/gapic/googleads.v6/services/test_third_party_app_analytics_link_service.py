...
from google.ads.googleads.v6.services.services.third_party_app_analytics_link_service import ThirdPartyAppAnalyticsLinkServiceClient
from google.ads.googleads.v6.services.services.third_party_app_analytics_link_service import transports
...
def test_third_party_app_analytics_link_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.third_party_app_analytics_link_service.ThirdPartyAppAnalyticsLinkServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v6.services.services.third_party_app_analytics_link_service.transports.ThirdPartyAppAnalyticsLinkServiceGrpcTransport.__init__') as grpc_transport:
...
def test_third_party_app_analytics_link_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.third_party_app_analytics_link_service.transports.ThirdPartyAppAnalyticsLinkServiceTransport.__init__') as Transport:
...
def test_third_party_app_analytics_link_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v6.services.services.third_party_app_analytics_link_service.transports.ThirdPartyAppAnalyticsLinkServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ThirdPartyAppAnalyticsLinkServiceTransport()
        adc.assert_called_once()
