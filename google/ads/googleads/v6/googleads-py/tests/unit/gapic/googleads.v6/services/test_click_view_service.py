...
from google.ads.googleads.v6.resources.types import click_view
from google.ads.googleads.v6.services.services.click_view_service import ClickViewServiceClient
from google.ads.googleads.v6.services.services.click_view_service import transports
from google.ads.googleads.v6.services.types import click_view_service
...
def test_click_view_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.click_view_service.ClickViewServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v6.services.services.click_view_service.transports.ClickViewServiceGrpcTransport.__init__') as grpc_transport:
...
def test_click_view_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.click_view_service.transports.ClickViewServiceTransport.__init__') as Transport:
...
def test_click_view_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v6.services.services.click_view_service.transports.ClickViewServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ClickViewServiceTransport()
        adc.assert_called_once()
