...
def test_keyword_plan_campaign_keyword_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.ads.googleads.v6.services.services.keyword_plan_campaign_keyword_service.transports.KeywordPlanCampaignKeywordServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.KeywordPlanCampaignKeywordServiceTransport()
        adc.assert_called_once()
