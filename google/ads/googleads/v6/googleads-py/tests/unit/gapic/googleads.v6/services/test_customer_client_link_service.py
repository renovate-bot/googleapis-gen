...
from google.ads.googleads.v6.services.services.customer_client_link_service import CustomerClientLinkServiceClient
from google.ads.googleads.v6.services.services.customer_client_link_service import transports
...
def test_customer_client_link_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.customer_client_link_service.CustomerClientLinkServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v6.services.services.customer_client_link_service.transports.CustomerClientLinkServiceGrpcTransport.__init__') as grpc_transport:
...
def test_customer_client_link_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.customer_client_link_service.transports.CustomerClientLinkServiceTransport.__init__') as Transport:
...
def test_customer_client_link_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v6.services.services.customer_client_link_service.transports.CustomerClientLinkServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CustomerClientLinkServiceTransport()
        adc.assert_called_once()
