...
from google.ads.googleads.v6.enums.types import offline_user_data_job_failure_reason
from google.ads.googleads.v6.enums.types import offline_user_data_job_status
from google.ads.googleads.v6.enums.types import offline_user_data_job_type
from google.ads.googleads.v6.enums.types import user_identifier_source
from google.ads.googleads.v6.resources.types import offline_user_data_job
from google.ads.googleads.v6.services.services.offline_user_data_job_service import OfflineUserDataJobServiceClient
from google.ads.googleads.v6.services.services.offline_user_data_job_service import transports
...
def test_offline_user_data_job_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.offline_user_data_job_service.OfflineUserDataJobServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v6.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceGrpcTransport.__init__') as grpc_transport:
...
def test_offline_user_data_job_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceTransport.__init__') as Transport:
...
def test_offline_user_data_job_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v6.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OfflineUserDataJobServiceTransport()
        adc.assert_called_once()
