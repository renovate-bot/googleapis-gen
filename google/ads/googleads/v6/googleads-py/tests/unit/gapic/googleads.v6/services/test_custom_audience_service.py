...
from google.ads.googleads.v6.services.services.custom_audience_service import CustomAudienceServiceClient
from google.ads.googleads.v6.services.services.custom_audience_service import transports
...
def test_custom_audience_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.custom_audience_service.CustomAudienceServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v6.services.services.custom_audience_service.transports.CustomAudienceServiceGrpcTransport.__init__') as grpc_transport:
...
def test_custom_audience_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v6.services.services.custom_audience_service.transports.CustomAudienceServiceTransport.__init__') as Transport:
...
def test_custom_audience_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v6.services.services.custom_audience_service.transports.CustomAudienceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CustomAudienceServiceTransport()
        adc.assert_called_once()
