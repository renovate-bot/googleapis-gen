...
from google.ads.googleads.v6.resources.types import campaign_bid_modifier as gagr_campaign_bid_modifier
...
class GetCampaignBidModifierRequest(proto.Message):
    ...
    [CampaignBidModifierService.GetCampaignBidModifier][google.ads.googleads.v6.services.CampaignBidModifierService.GetCampaignBidModifier].
...
class MutateCampaignBidModifiersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v6.services.types.CampaignBidModifierOperation]):
...
class CampaignBidModifierOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.CampaignBidModifier):
            Create operation: No resource name is
            expected for the new campaign bid modifier.
        update (google.ads.googleads.v6.resources.types.CampaignBidModifier):
...
class MutateCampaignBidModifiersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateCampaignBidModifierResult]):
...
class MutateCampaignBidModifierResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_bid_modifier (google.ads.googleads.v6.resources.types.CampaignBidModifier):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    campaign_bid_modifier = proto.Field(proto.MESSAGE, number=2,
        message=gagr_campaign_bid_modifier.CampaignBidModifier,
    )
