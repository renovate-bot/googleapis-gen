...
from google.ads.googleads.v6.resources.types import label as gagr_label
...
class GetLabelRequest(proto.Message):
    ...
    [LabelService.GetLabel][google.ads.googleads.v6.services.LabelService.GetLabel].

    Attributes:
        resource_name (str):
            Required. The resource name of the label to
            fetch.
    """
...
class MutateLabelsRequest(proto.Message):
    r"""Request message for
    [LabelService.MutateLabels][google.ads.googleads.v6.services.LabelService.MutateLabels].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose labels are
            being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.LabelOperation]):
...
class LabelOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.Label):
            Create operation: No resource name is
            expected for the new label.
        update (google.ads.googleads.v6.resources.types.Label):
...
class MutateLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateLabelResult]):
...
class MutateLabelResult(proto.Message):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    label = proto.Field(proto.MESSAGE, number=2,
        message=gagr_label.Label,
    )
