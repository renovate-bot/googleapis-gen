...
class GetAdGroupFeedRequest(proto.Message):
    ...
    [AdGroupFeedService.GetAdGroupFeed][google.ads.googleads.v6.services.AdGroupFeedService.GetAdGroupFeed].
...
class MutateAdGroupFeedsRequest(proto.Message):
    r"""Request message for
    [AdGroupFeedService.MutateAdGroupFeeds][google.ads.googleads.v6.services.AdGroupFeedService.MutateAdGroupFeeds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ad
            group feeds are being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.AdGroupFeedOperation]):
...
class AdGroupFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.AdGroupFeed):
            Create operation: No resource name is
            expected for the new ad group feed.
        update (google.ads.googleads.v6.resources.types.AdGroupFeed):
...
class MutateAdGroupFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateAdGroupFeedResult]):
...
class MutateAdGroupFeedResult(proto.Message):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    ad_group_feed = proto.Field(proto.MESSAGE, number=2,
        message=gagr_ad_group_feed.AdGroupFeed,
    )
