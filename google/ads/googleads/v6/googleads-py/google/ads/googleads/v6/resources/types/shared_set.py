...
class SharedSet(proto.Message):
    ...
    Attributes:
        ...
        id (int):
            ...
            only.
        type_ (google.ads.googleads.v6.enums.types.SharedSetTypeEnum.SharedSetType):
        ...
        status (google.ads.googleads.v6.enums.types.SharedSetStatusEnum.SharedSetStatus):
