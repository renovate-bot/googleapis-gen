...
class MutateBatchJobRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            create a batch job.
        operation (google.ads.googleads.v6.services.types.BatchJobOperation):
...
class BatchJobOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v6.resources.types.BatchJob):
...
class MutateBatchJobResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v6.services.types.MutateBatchJobResult):
...
class ListBatchJobResultsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v6.services.types.BatchJobResult]):
...
class BatchJobResult(proto.Message):
    ...
    Attributes:
        ...
        mutate_operation_response (google.ads.googleads.v6.services.types.MutateOperationResponse):
