...
class GetAdGroupCriterionRequest(proto.Message):
    ...
    [AdGroupCriterionService.GetAdGroupCriterion][google.ads.googleads.v6.services.AdGroupCriterionService.GetAdGroupCriterion].
...
class MutateAdGroupCriteriaRequest(proto.Message):
    r"""Request message for
    [AdGroupCriterionService.MutateAdGroupCriteria][google.ads.googleads.v6.services.AdGroupCriterionService.MutateAdGroupCriteria].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose criteria
            are being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.AdGroupCriterionOperation]):
...
class AdGroupCriterionOperation(proto.Message):
    ...
    Attributes:
        ...
        exempt_policy_violation_keys (Sequence[google.ads.googleads.v6.common.types.PolicyViolationKey]):
        ...
        create (google.ads.googleads.v6.resources.types.AdGroupCriterion):
            Create operation: No resource name is
            expected for the new criterion.
        update (google.ads.googleads.v6.resources.types.AdGroupCriterion):
...
class MutateAdGroupCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateAdGroupCriterionResult]):
