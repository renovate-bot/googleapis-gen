...
class GetCampaignFeedRequest(proto.Message):
    ...
    [CampaignFeedService.GetCampaignFeed][google.ads.googleads.v6.services.CampaignFeedService.GetCampaignFeed].
...
class MutateCampaignFeedsRequest(proto.Message):
    r"""Request message for
    [CampaignFeedService.MutateCampaignFeeds][google.ads.googleads.v6.services.CampaignFeedService.MutateCampaignFeeds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign feeds are being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.CampaignFeedOperation]):
...
class CampaignFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.CampaignFeed):
            Create operation: No resource name is
            expected for the new campaign feed.
        update (google.ads.googleads.v6.resources.types.CampaignFeed):
...
class MutateCampaignFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateCampaignFeedResult]):
...
class MutateCampaignFeedResult(proto.Message):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    campaign_feed = proto.Field(proto.MESSAGE, number=2,
        message=gagr_campaign_feed.CampaignFeed,
    )
