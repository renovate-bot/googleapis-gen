...
class CustomerNegativeCriterionServiceClientMeta(type):
    """Metaclass for the CustomerNegativeCriterionService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CustomerNegativeCriterionServiceTransport]]
    _transport_registry['grpc'] = CustomerNegativeCriterionServiceGrpcTransport
...
class CustomerNegativeCriterionServiceClient(metaclass=CustomerNegativeCriterionServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CustomerNegativeCriterionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CustomerNegativeCriterionServiceTransport:
        ...
        Returns:
            CustomerNegativeCriterionServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, CustomerNegativeCriterionServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the customer negative criterion service client.
        ...
        Args:
            ...
            transport (Union[str, ~.CustomerNegativeCriterionServiceTransport]): The
        ...
        if isinstance(transport, CustomerNegativeCriterionServiceTransport):
            # transport is a CustomerNegativeCriterionServiceTransport instance.
            if credentials:
            ...
            self._transport = CustomerNegativeCriterionServiceGrpcTransport(
    ...
    def get_customer_negative_criterion(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCustomerNegativeCriterionRequest`):
                The request object. Request message for
                [CustomerNegativeCriterionService.GetCustomerNegativeCriterion][google.ads.googleads.v6.services.CustomerNegativeCriterionService.GetCustomerNegativeCriterion].
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CustomerNegativeCriterion:
                A negative criterion for exclusions
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_customer_negative_criterion]
    ...
    def mutate_customer_negative_criteria(self,
        ...
        r"""Creates or removes criteria. Operation statuses are
        returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateCustomerNegativeCriteriaRequest`):
                The request object. Request message for
                [CustomerNegativeCriterionService.MutateCustomerNegativeCriteria][google.ads.googleads.v6.services.CustomerNegativeCriterionService.MutateCustomerNegativeCriteria].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.CustomerNegativeCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCustomerNegativeCriteriaResponse:
                Response message for customer
                negative criterion mutate.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_customer_negative_criteria]
