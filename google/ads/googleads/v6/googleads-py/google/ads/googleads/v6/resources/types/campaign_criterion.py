...
class CampaignCriterion(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v6.enums.types.CampaignCriterionStatusEnum.CampaignCriterionStatus):
        ...
        location (google.ads.googleads.v6.common.types.LocationInfo):
            Immutable. Location.
        device (google.ads.googleads.v6.common.types.DeviceInfo):
            Immutable. Device.
        ad_schedule (google.ads.googleads.v6.common.types.AdScheduleInfo):
        ...
        proximity (google.ads.googleads.v6.common.types.ProximityInfo):
            Immutable. Proximity.
        topic (google.ads.googleads.v6.common.types.TopicInfo):
            Immutable. Topic.
        listing_scope (google.ads.googleads.v6.common.types.ListingScopeInfo):
            Immutable. Listing scope.
        language (google.ads.googleads.v6.common.types.LanguageInfo):
            Immutable. Language.
        ip_block (google.ads.googleads.v6.common.types.IpBlockInfo):
            Immutable. IpBlock.
        content_label (google.ads.googleads.v6.common.types.ContentLabelInfo):
            Immutable. ContentLabel.
        carrier (google.ads.googleads.v6.common.types.CarrierInfo):
            Immutable. Carrier.
        ...
        webpage (google.ads.googleads.v6.common.types.WebpageInfo):
            Immutable. Webpage.
        operating_system_version (google.ads.googleads.v6.common.types.OperatingSystemVersionInfo):
            Immutable. Operating system version.
        mobile_device (google.ads.googleads.v6.common.types.MobileDeviceInfo):
            Immutable. Mobile Device.
        location_group (google.ads.googleads.v6.common.types.LocationGroupInfo):
    ...
    custom_audience = proto.Field(proto.MESSAGE, number=41, oneof='criterion',
        message=criteria.CustomAudienceInfo,
    )
    combined_audience = proto.Field(proto.MESSAGE, number=42, oneof='criterion',
