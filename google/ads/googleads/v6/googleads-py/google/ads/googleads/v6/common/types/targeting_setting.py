...
class TargetingSetting(proto.Message):
    ...
    Attributes:
        target_restrictions (Sequence[google.ads.googleads.v6.common.types.TargetRestriction]):
            The per-targeting-dimension setting to
            restrict the reach of your campaign or ad group.
        target_restriction_operations (Sequence[google.ads.googleads.v6.common.types.TargetRestrictionOperation]):
...
class TargetRestrictionOperation(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v6.common.types.TargetRestrictionOperation.Operator):
            Type of list operation to perform.
        value (google.ads.googleads.v6.common.types.TargetRestriction):
