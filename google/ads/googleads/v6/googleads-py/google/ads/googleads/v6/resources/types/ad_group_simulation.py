...
class AdGroupSimulation(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v6.enums.types.SimulationTypeEnum.SimulationType):
            Output only. The field that the simulation
            modifies.
        modification_method (google.ads.googleads.v6.enums.types.SimulationModificationMethodEnum.SimulationModificationMethod):
        ...
        cpc_bid_point_list (google.ads.googleads.v6.common.types.CpcBidSimulationPointList):
            Output only. Simulation points if the simulation type is
            CPC_BID.
        cpv_bid_point_list (google.ads.googleads.v6.common.types.CpvBidSimulationPointList):
            Output only. Simulation points if the simulation type is
            CPV_BID.
        target_cpa_point_list (google.ads.googleads.v6.common.types.TargetCpaSimulationPointList):
            Output only. Simulation points if the simulation type is
            TARGET_CPA.
        target_roas_point_list (google.ads.googleads.v6.common.types.TargetRoasSimulationPointList):
            Output only. Simulation points if the simulation type is
            TARGET_ROAS.
    """
