...
class AdGroupServiceClient(metaclass=AdGroupServiceClientMeta):
    ...
    def get_ad_group(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetAdGroupRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.resources.types.AdGroup:
                An ad group.
        """
    ...
    def mutate_ad_groups(self,
        ...
        r"""Creates, updates, or removes ad groups. Operation
        statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateAdGroupsRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.AdGroupOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateAdGroupsResponse:
