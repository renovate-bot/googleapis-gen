...
class DynamicSearchAdsSearchTermViewServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for DynamicSearchAdsSearchTermViewService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_dynamic_search_ads_search_term_view: gapic_v1.method.wrap_method(
                self.get_dynamic_search_ads_search_term_view,
    ...
    @property
    def get_dynamic_search_ads_search_term_view(self) -> typing.Callable[
