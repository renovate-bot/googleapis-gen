...
class CampaignLabelServiceClient(metaclass=CampaignLabelServiceClientMeta):
    ...
    def get_campaign_label(self,
        ...
        r"""Returns the requested campaign-label relationship in
        full detail.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCampaignLabelRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CampaignLabel:
    ...
    def mutate_campaign_labels(self,
        ...
        r"""Creates and removes campaign-label relationships.
        Operation statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateCampaignLabelsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.CampaignLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCampaignLabelsResponse:
