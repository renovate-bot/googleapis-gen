...
from google.ads.googleads.v6.enums.types import resource_change_operation as gage_resource_change_operation
...
from google.ads.googleads.v6.resources.types import ad_group_ad as gagr_ad_group_ad
from google.ads.googleads.v6.resources.types import ad_group_bid_modifier as gagr_ad_group_bid_modifier
from google.ads.googleads.v6.resources.types import ad_group_criterion as gagr_ad_group_criterion
from google.ads.googleads.v6.resources.types import ad_group_feed as gagr_ad_group_feed
from google.ads.googleads.v6.resources.types import campaign as gagr_campaign
from google.ads.googleads.v6.resources.types import campaign_budget as gagr_campaign_budget
from google.ads.googleads.v6.resources.types import campaign_criterion as gagr_campaign_criterion
from google.ads.googleads.v6.resources.types import campaign_feed as gagr_campaign_feed
from google.ads.googleads.v6.resources.types import feed as gagr_feed
from google.ads.googleads.v6.resources.types import feed_item as gagr_feed_item
...
class ChangeEvent(proto.Message):
    ...
    Attributes:
        ...
        change_resource_type (google.ads.googleads.v6.enums.types.ChangeEventResourceTypeEnum.ChangeEventResourceType):
        ...
        change_resource_name (str):
            ...
            occurred on.
        client_type (google.ads.googleads.v6.enums.types.ChangeClientTypeEnum.ChangeClientType):
            Output only. Where the change was made
            through.
        user_email (str):
            Output only. The email of the user who made
            this change.
        old_resource (google.ads.googleads.v6.resources.types.ChangeEvent.ChangedResource):
            Output only. The old resource before the
            change. Only changed fields will be populated.
        new_resource (google.ads.googleads.v6.resources.types.ChangeEvent.ChangedResource):
            Output only. The new resource after the
            change. Only changed fields will be populated.
        resource_change_operation (google.ads.googleads.v6.enums.types.ResourceChangeOperationEnum.ResourceChangeOperation):
    ...
    class ChangedResource(proto.Message):
        ...
        Attributes:
            ...
            ad_group_criterion (google.ads.googleads.v6.resources.types.AdGroupCriterion):
            ...
            campaign_budget (google.ads.googleads.v6.resources.types.CampaignBudget):
                Output only. Set if change_resource_type == CAMPAIGN_BUDGET.
            ad_group_bid_modifier (google.ads.googleads.v6.resources.types.AdGroupBidModifier):
                Output only. Set if change_resource_type ==
                AD_GROUP_BID_MODIFIER.
            campaign_criterion (google.ads.googleads.v6.resources.types.CampaignCriterion):
                Output only. Set if change_resource_type ==
                CAMPAIGN_CRITERION.
            feed (google.ads.googleads.v6.resources.types.Feed):
                Output only. Set if change_resource_type == FEED.
            feed_item (google.ads.googleads.v6.resources.types.FeedItem):
                Output only. Set if change_resource_type == FEED_ITEM.
            campaign_feed (google.ads.googleads.v6.resources.types.CampaignFeed):
                Output only. Set if change_resource_type == CAMPAIGN_FEED.
            ad_group_feed (google.ads.googleads.v6.resources.types.AdGroupFeed):
