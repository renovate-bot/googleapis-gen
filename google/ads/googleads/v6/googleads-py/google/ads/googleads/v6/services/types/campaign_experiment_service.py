...
class MutateCampaignExperimentsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v6.services.types.CampaignExperimentOperation]):
...
class CampaignExperimentOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v6.resources.types.CampaignExperiment):
...
class MutateCampaignExperimentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateCampaignExperimentResult]):
