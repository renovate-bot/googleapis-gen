...
class KeywordPlanAdGroupServiceClient(metaclass=KeywordPlanAdGroupServiceClientMeta):
    ...
    def get_keyword_plan_ad_group(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetKeywordPlanAdGroupRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.resources.types.KeywordPlanAdGroup:
    ...
    def mutate_keyword_plan_ad_groups(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateKeywordPlanAdGroupsRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.KeywordPlanAdGroupOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateKeywordPlanAdGroupsResponse:
