...
class CampaignAssetServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for CampaignAssetService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_campaign_asset: gapic_v1.method.wrap_method(
                self.get_campaign_asset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_campaign_assets: gapic_v1.method.wrap_method(
                self.mutate_campaign_assets,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def get_campaign_asset(self) -> typing.Callable[
            [campaign_asset_service.GetCampaignAssetRequest],
            campaign_asset.CampaignAsset]:
        raise NotImplementedError

    @property
    def mutate_campaign_assets(self) -> typing.Callable[
