...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def transport(self) -> FeedMappingServiceTransport:
        ...
        Returns:
            FeedMappingServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiate the feed mapping service client.
        ...
        if isinstance(transport, FeedMappingServiceTransport):
            ...
            self._transport = FeedMappingServiceGrpcTransport(
    ...
    def get_feed_mapping(self,
        ...
        r"""Returns the requested feed mapping in full detail.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetFeedMappingRequest`):
                The request object. Request message for
                [FeedMappingService.GetFeedMapping][google.ads.googleads.v6.services.FeedMappingService.GetFeedMapping].
            resource_name (:class:`str`):
                Required. The resource name of the
                feed mapping to fetch.
        ...
        Returns:
            google.ads.googleads.v6.resources.types.FeedMapping:
                A feed mapping.
        """
        ...
        # in a feed_mapping_service.GetFeedMappingRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, feed_mapping_service.GetFeedMappingRequest):
            request = feed_mapping_service.GetFeedMappingRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_feed_mapping]
    ...
    def mutate_feed_mappings(self,
        ...
        r"""Creates or removes feed mappings. Operation statuses
        are returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateFeedMappingsRequest`):
                The request object. Request message for
                [FeedMappingService.MutateFeedMappings][google.ads.googleads.v6.services.FeedMappingService.MutateFeedMappings].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.FeedMappingOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateFeedMappingsResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, feed_mapping_service.MutateFeedMappingsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_feed_mappings]
