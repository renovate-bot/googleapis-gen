    ...
    def upload_click_conversions(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            conversions (:class:`Sequence[google.ads.googleads.v6.services.types.ClickConversion]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.UploadClickConversionsResponse:
    ...
    def upload_call_conversions(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            conversions (:class:`Sequence[google.ads.googleads.v6.services.types.CallConversion]`):
                Required. The conversions that are
                being uploaded.
        ...
        Returns:
            google.ads.googleads.v6.services.types.UploadCallConversionsResponse:
                Response message for
                [ConversionUploadService.UploadCallConversions][google.ads.googleads.v6.services.ConversionUploadService.UploadCallConversions].
