...
from google.ads.googleads.v6.enums.types import asset_performance_label as gage_asset_performance_label
...
class AdTextAsset(proto.Message):
    ...
    Attributes:
        text (str):
            Asset text.
        pinned_field (google.ads.googleads.v6.enums.types.ServedAssetFieldTypeEnum.ServedAssetFieldType):
        ...
        asset_performance_label (google.ads.googleads.v6.enums.types.AssetPerformanceLabelEnum.AssetPerformanceLabel):
            The performance label of this text asset.
        policy_summary_info (google.ads.googleads.v6.common.types.AdAssetPolicySummary):
