...
class CustomAudienceServiceGrpcTransport(CustomAudienceServiceTransport):
    ...
    def get_custom_audience(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetCustomAudienceRequest],
                    ~.CustomAudience]:
        ...
        if 'get_custom_audience' not in self._stubs:
            self._stubs['get_custom_audience'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v6.services.CustomAudienceService/GetCustomAudience',
                request_serializer=custom_audience_service.GetCustomAudienceRequest.serialize,
                response_deserializer=custom_audience.CustomAudience.deserialize,
            )
        return self._stubs['get_custom_audience']
    ...
    def mutate_custom_audiences(self) -> Callable[
        ...
        if 'mutate_custom_audiences' not in self._stubs:
            self._stubs['mutate_custom_audiences'] = self.grpc_channel.unary_unary(
