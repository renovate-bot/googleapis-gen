...
class AccountBudgetProposalServiceClient(metaclass=AccountBudgetProposalServiceClientMeta):
    ...
    def get_account_budget_proposal(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetAccountBudgetProposalRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.resources.types.AccountBudgetProposal:
    ...
    def mutate_account_budget_proposal(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateAccountBudgetProposalRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v6.services.types.AccountBudgetProposalOperation`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateAccountBudgetProposalResponse:
