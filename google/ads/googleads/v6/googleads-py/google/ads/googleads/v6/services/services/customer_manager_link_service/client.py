...
class CustomerManagerLinkServiceClient(metaclass=CustomerManagerLinkServiceClientMeta):
    ...
    def get_customer_manager_link(self,
        ...
        r"""Returns the requested CustomerManagerLink in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCustomerManagerLinkRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CustomerManagerLink:
    ...
    def mutate_customer_manager_link(self,
        ...
        r"""Creates or updates customer manager links. Operation
        statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateCustomerManagerLinkRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.CustomerManagerLinkOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCustomerManagerLinkResponse:
    ...
    def move_manager_link(self,
        ...
        r"""Moves a client customer to a new manager customer.
        This simplifies the complex request that requires two
        operations to move a client customer to a new manager.
        i.e:
        1. Update operation with Status INACTIVE (previous
        manager) and, 2. Update operation with Status ACTIVE
        (new manager).

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MoveManagerLinkRequest`):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v6.services.types.MoveManagerLinkResponse:
                Response message for a
