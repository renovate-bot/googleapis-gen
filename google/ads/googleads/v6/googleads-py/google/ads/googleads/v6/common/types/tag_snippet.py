...
class TagSnippet(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.TrackingCodeTypeEnum.TrackingCodeType):
            The type of the generated tag snippets for
            tracking conversions.
        page_format (google.ads.googleads.v6.enums.types.TrackingCodePageFormatEnum.TrackingCodePageFormat):
