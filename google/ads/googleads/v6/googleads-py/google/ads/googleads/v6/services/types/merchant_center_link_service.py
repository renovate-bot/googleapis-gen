...
class ListMerchantCenterLinksResponse(proto.Message):
    ...
    Attributes:
        merchant_center_links (Sequence[google.ads.googleads.v6.resources.types.MerchantCenterLink]):
...
class MutateMerchantCenterLinkRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            modified.
        operation (google.ads.googleads.v6.services.types.MerchantCenterLinkOperation):
...
class MerchantCenterLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v6.resources.types.MerchantCenterLink):
...
class MutateMerchantCenterLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v6.services.types.MutateMerchantCenterLinkResult):
