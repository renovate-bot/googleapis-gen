...
class MatchingFunction(proto.Message):
    ...
    Attributes:
        ...
        operator (google.ads.googleads.v6.enums.types.MatchingFunctionOperatorEnum.MatchingFunctionOperator):
            Operator for a function.
        left_operands (Sequence[google.ads.googleads.v6.common.types.Operand]):
        ...
        right_operands (Sequence[google.ads.googleads.v6.common.types.Operand]):
...
class Operand(proto.Message):
    ...
    Attributes:
        constant_operand (google.ads.googleads.v6.common.types.Operand.ConstantOperand):
            A constant operand in a matching function.
        feed_attribute_operand (google.ads.googleads.v6.common.types.Operand.FeedAttributeOperand):
            This operand specifies a feed attribute in
            feed.
        function_operand (google.ads.googleads.v6.common.types.Operand.FunctionOperand):
            A function operand in a matching function.
            Used to represent nested functions.
        request_context_operand (google.ads.googleads.v6.common.types.Operand.RequestContextOperand):
    ...
    class ConstantOperand(proto.Message):
        ...
        boolean_value = proto.Field(proto.BOOL, number=7, oneof='constant_operand_value')
    ...
    class FunctionOperand(proto.Message):
        ...
        Attributes:
            matching_function (google.ads.googleads.v6.common.types.MatchingFunction):
    ...
    class RequestContextOperand(proto.Message):
        ...
        Attributes:
            context_type (google.ads.googleads.v6.enums.types.MatchingFunctionContextTypeEnum.MatchingFunctionContextType):
