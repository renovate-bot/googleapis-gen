...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def get_account_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetAccountLinkRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.resources.types.AccountLink:
    ...
    def create_account_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.CreateAccountLinkRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            account_link (:class:`google.ads.googleads.v6.resources.types.AccountLink`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.CreateAccountLinkResponse:
    ...
    def mutate_account_link(self,
        ...
        r"""Creates or removes an account link.
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateAccountLinkRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v6.services.types.AccountLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateAccountLinkResponse:
