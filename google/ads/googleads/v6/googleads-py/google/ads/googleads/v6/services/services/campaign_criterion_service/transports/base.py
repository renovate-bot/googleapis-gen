...
class CampaignCriterionServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for CampaignCriterionService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_campaign_criterion: gapic_v1.method.wrap_method(
                self.get_campaign_criterion,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_campaign_criteria: gapic_v1.method.wrap_method(
                self.mutate_campaign_criteria,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def get_campaign_criterion(self) -> typing.Callable[
            [campaign_criterion_service.GetCampaignCriterionRequest],
            campaign_criterion.CampaignCriterion]:
        raise NotImplementedError

    @property
    def mutate_campaign_criteria(self) -> typing.Callable[
