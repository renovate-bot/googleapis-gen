...
class Feed(proto.Message):
    ...
    Attributes:
        ...
        attributes (Sequence[google.ads.googleads.v6.resources.types.FeedAttribute]):
            ...
            attributes.
        attribute_operations (Sequence[google.ads.googleads.v6.resources.types.FeedAttributeOperation]):
            The list of operations changing the feed
            attributes. Attributes can only be added, not
            removed.
        origin (google.ads.googleads.v6.enums.types.FeedOriginEnum.FeedOrigin):
            Immutable. Specifies who manages the
            FeedAttributes for the Feed.
        status (google.ads.googleads.v6.enums.types.FeedStatusEnum.FeedStatus):
            Output only. Status of the feed.
            This field is read-only.
        places_location_feed_data (google.ads.googleads.v6.resources.types.Feed.PlacesLocationFeedData):
            Data used to configure a location feed
            populated from Google My Business Locations.
        affiliate_location_feed_data (google.ads.googleads.v6.resources.types.Feed.AffiliateLocationFeedData):
    ...
    class PlacesLocationFeedData(proto.Message):
        ...
        Attributes:
            oauth_info (google.ads.googleads.v6.resources.types.Feed.PlacesLocationFeedData.OAuthInfo):
        ...
        business_name_filter = proto.Field(proto.STRING, number=9, optional=True)
    ...
    class AffiliateLocationFeedData(proto.Message):
        ...
        Attributes:
            ...
            relationship_type (google.ads.googleads.v6.enums.types.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType):
...
class FeedAttribute(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v6.enums.types.FeedAttributeTypeEnum.FeedAttributeType):
...
class FeedAttributeOperation(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v6.resources.types.FeedAttributeOperation.Operator):
            Output only. Type of list operation to
            perform.
        value (google.ads.googleads.v6.resources.types.FeedAttribute):
