...
class MutateAssetsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            are being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.AssetOperation]):
...
class AssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.Asset):
            Create operation: No resource name is
            expected for the new asset.
        update (google.ads.googleads.v6.resources.types.Asset):
