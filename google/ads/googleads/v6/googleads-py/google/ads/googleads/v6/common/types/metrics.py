...
class Metrics(proto.Message):
    ...
    all_conversions_value_by_conversion_date = proto.Field(proto.DOUBLE, number=240)
    ...
    value_per_all_conversions_by_conversion_date = proto.Field(proto.DOUBLE, number=244, optional=True)
