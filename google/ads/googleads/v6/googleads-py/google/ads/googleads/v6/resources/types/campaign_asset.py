...
class CampaignAsset(proto.Message):
    ...
    Attributes:
        ...
        asset (str):
            ...
            campaign.
        field_type (google.ads.googleads.v6.enums.types.AssetFieldTypeEnum.AssetFieldType):
            Immutable. Role that the asset takes under
            the linked campaign. Required.
        status (google.ads.googleads.v6.enums.types.AssetLinkStatusEnum.AssetLinkStatus):
