...
from google.ads.googleads.v6.enums.types import user_identifier_source as gage_user_identifier_source
...
class UserIdentifier(proto.Message):
    ...
    Attributes:
        user_identifier_source (google.ads.googleads.v6.enums.types.UserIdentifierSourceEnum.UserIdentifierSource):
        ...
        third_party_user_id (str):
            ...
            for SSD.
        address_info (google.ads.googleads.v6.common.types.OfflineUserAddressInfo):
            Address information.
    """
...
class TransactionAttribute(proto.Message):
    ...
    Attributes:
        ...
        store_attribute (google.ads.googleads.v6.common.types.StoreAttribute):
...
class UserData(proto.Message):
    ...
    Attributes:
        user_identifiers (Sequence[google.ads.googleads.v6.common.types.UserIdentifier]):
            User identification info. Required.
        transaction_attribute (google.ads.googleads.v6.common.types.TransactionAttribute):
            Additional transactions/attributes associated
            with the user. Required when updating store
            sales data.
        user_attribute (google.ads.googleads.v6.common.types.UserAttribute):
...
class StoreSalesMetadata(proto.Message):
    ...
    Attributes:
        ...
        custom_key (str):
            ...
            Accessible only to customers on the allow-list.
        third_party_metadata (google.ads.googleads.v6.common.types.StoreSalesThirdPartyMetadata):
