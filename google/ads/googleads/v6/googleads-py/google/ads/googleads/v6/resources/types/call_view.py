...
from google.ads.googleads.v6.enums.types import google_voice_call_status
...
class CallView(proto.Message):
    ...
    Attributes:
        ...
        end_call_date_time (str):
            ...
            date time.
        call_tracking_display_location (google.ads.googleads.v6.enums.types.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation):
            Output only. The call tracking display
            location.
        type_ (google.ads.googleads.v6.enums.types.CallTypeEnum.CallType):
            Output only. The type of the call.
        call_status (google.ads.googleads.v6.enums.types.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus):
