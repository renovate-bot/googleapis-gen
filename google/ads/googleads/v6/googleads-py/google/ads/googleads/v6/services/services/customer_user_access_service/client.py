...
class CustomerUserAccessServiceClient(metaclass=CustomerUserAccessServiceClientMeta):
    ...
    def get_customer_user_access(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCustomerUserAccessRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CustomerUserAccess:
    ...
    def mutate_customer_user_access(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateCustomerUserAccessRequest`):
                The request object. Mutate Request for
                [CustomerUserAccessService.MutateCustomerUserAccess][google.ads.googleads.v6.services.CustomerUserAccessService.MutateCustomerUserAccess].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v6.services.types.CustomerUserAccessOperation`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCustomerUserAccessResponse:
