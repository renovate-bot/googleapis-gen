...
class ListPaymentsAccountsResponse(proto.Message):
    ...
    [PaymentsAccountService.ListPaymentsAccounts][google.ads.googleads.v6.services.PaymentsAccountService.ListPaymentsAccounts].

    Attributes:
        payments_accounts (Sequence[google.ads.googleads.v6.resources.types.PaymentsAccount]):
