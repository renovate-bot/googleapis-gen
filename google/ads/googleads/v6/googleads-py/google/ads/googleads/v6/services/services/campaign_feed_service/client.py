...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def get_campaign_feed(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCampaignFeedRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CampaignFeed:
                A campaign feed.
        """
    ...
    def mutate_campaign_feeds(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateCampaignFeedsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.CampaignFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCampaignFeedsResponse:
