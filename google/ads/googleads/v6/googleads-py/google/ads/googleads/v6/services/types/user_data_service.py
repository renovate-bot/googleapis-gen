...
from google.ads.googleads.v6.common.types import offline_user_data
...
class UploadUserDataRequest(proto.Message):
    ...
    [UserDataService.UploadUserData][google.ads.googleads.v6.services.UserDataService.UploadUserData]

    Attributes:
        customer_id (str):
            Required. The ID of the customer for which to
            update the user data.
        operations (Sequence[google.ads.googleads.v6.services.types.UserDataOperation]):
            Required. The list of operations to be done.
        customer_match_user_list_metadata (google.ads.googleads.v6.common.types.CustomerMatchUserListMetadata):
...
class UserDataOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v6.common.types.UserData):
            The list of user data to be appended to the
            user list.
        remove (google.ads.googleads.v6.common.types.UserData):
