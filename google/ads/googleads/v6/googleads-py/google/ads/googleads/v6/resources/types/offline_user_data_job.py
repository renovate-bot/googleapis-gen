...
class OfflineUserDataJob(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v6.enums.types.OfflineUserDataJobTypeEnum.OfflineUserDataJobType):
            Immutable. Type of the job.
        status (google.ads.googleads.v6.enums.types.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus):
            Output only. Status of the job.
        failure_reason (google.ads.googleads.v6.enums.types.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason):
        ...
        customer_match_user_list_metadata (google.ads.googleads.v6.common.types.CustomerMatchUserListMetadata):
            ...
            CRM-based user list.
        store_sales_metadata (google.ads.googleads.v6.common.types.StoreSalesMetadata):
