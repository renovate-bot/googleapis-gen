...
class SharedCriterionServiceGrpcTransport(SharedCriterionServiceTransport):
    ...
    def get_shared_criterion(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetSharedCriterionRequest],
                    ~.SharedCriterion]:
        ...
        if 'get_shared_criterion' not in self._stubs:
            self._stubs['get_shared_criterion'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v6.services.SharedCriterionService/GetSharedCriterion',
                request_serializer=shared_criterion_service.GetSharedCriterionRequest.serialize,
                response_deserializer=shared_criterion.SharedCriterion.deserialize,
            )
        return self._stubs['get_shared_criterion']
    ...
    def mutate_shared_criteria(self) -> Callable[
        ...
        if 'mutate_shared_criteria' not in self._stubs:
            self._stubs['mutate_shared_criteria'] = self.grpc_channel.unary_unary(
