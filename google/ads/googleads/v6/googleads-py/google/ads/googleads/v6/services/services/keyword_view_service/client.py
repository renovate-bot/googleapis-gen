...
class KeywordViewServiceClient(metaclass=KeywordViewServiceClientMeta):
    ...
    def get_keyword_view(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetKeywordViewRequest`):
                The request object.
                Request message for
                [KeywordViewService.GetKeywordView][google.ads.googleads.v6.services.KeywordViewService.GetKeywordView].
        ...
        Returns:
            google.ads.googleads.v6.resources.types.KeywordView:
                A keyword view.
        """
