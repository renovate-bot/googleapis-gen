...
class DetailPlacementViewServiceClient(metaclass=DetailPlacementViewServiceClientMeta):
    ...
    def get_detail_placement_view(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetDetailPlacementViewRequest`):
                The request object. Request message for
                [DetailPlacementViewService.GetDetailPlacementView][google.ads.googleads.v6.services.DetailPlacementViewService.GetDetailPlacementView].
        ...
        Returns:
            google.ads.googleads.v6.resources.types.DetailPlacementView:
