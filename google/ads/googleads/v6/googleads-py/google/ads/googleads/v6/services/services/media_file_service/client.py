...
class MediaFileServiceClient(metaclass=MediaFileServiceClientMeta):
    ...
    def get_media_file(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetMediaFileRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.MediaFile:
                A media file.
        """
    ...
    def mutate_media_files(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateMediaFilesRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.MediaFileOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateMediaFilesResponse:
