...
class GetGeoTargetConstantRequest(proto.Message):
    ...
    [GeoTargetConstantService.GetGeoTargetConstant][google.ads.googleads.v6.services.GeoTargetConstantService.GetGeoTargetConstant].
...
class SuggestGeoTargetConstantsRequest(proto.Message):
    ...
    Attributes:
        ...
        country_code (str):
            ...
            country code.
        location_names (google.ads.googleads.v6.services.types.SuggestGeoTargetConstantsRequest.LocationNames):
            The location names to search by. At most 25
            names can be set.
        geo_targets (google.ads.googleads.v6.services.types.SuggestGeoTargetConstantsRequest.GeoTargets):
...
class SuggestGeoTargetConstantsResponse(proto.Message):
    ...
    Attributes:
        geo_target_constant_suggestions (Sequence[google.ads.googleads.v6.services.types.GeoTargetConstantSuggestion]):
...
class GeoTargetConstantSuggestion(proto.Message):
    ...
    Attributes:
        ...
        geo_target_constant_parents (Sequence[google.ads.googleads.v6.resources.types.GeoTargetConstant]):
