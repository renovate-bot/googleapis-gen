...
class AdGroupAdLabelServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AdGroupAdLabelServiceTransport]]
...
class AdGroupAdLabelServiceClient(metaclass=AdGroupAdLabelServiceClientMeta):
    ...
    def get_ad_group_ad_label(self,
        ...
        r"""Returns the requested ad group ad label in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetAdGroupAdLabelRequest`):
                The request object.
                Request message for
                [AdGroupAdLabelService.GetAdGroupAdLabel][google.ads.googleads.v6.services.AdGroupAdLabelService.GetAdGroupAdLabel].
        ...
        Returns:
            google.ads.googleads.v6.resources.types.AdGroupAdLabel:
        ...
        if not isinstance(request, ad_group_ad_label_service.GetAdGroupAdLabelRequest):
            request = ad_group_ad_label_service.GetAdGroupAdLabelRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_ad_group_ad_label]
    ...
    def mutate_ad_group_ad_labels(self,
        ...
        r"""Creates and removes ad group ad labels.
        Operation statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateAdGroupAdLabelsRequest`):
                The request object.
                Request message for
                [AdGroupAdLabelService.MutateAdGroupAdLabels][google.ads.googleads.v6.services.AdGroupAdLabelService.MutateAdGroupAdLabels].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.AdGroupAdLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateAdGroupAdLabelsResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, ad_group_ad_label_service.MutateAdGroupAdLabelsRequest):
            request = ad_group_ad_label_service.MutateAdGroupAdLabelsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_ad_group_ad_labels]
