...
class AdGroupFeed(proto.Message):
    ...
    Attributes:
        ...
        ad_group (str):
            ...
            feed.
        placeholder_types (Sequence[google.ads.googleads.v6.enums.types.PlaceholderTypeEnum.PlaceholderType]):
        ...
        status (google.ads.googleads.v6.enums.types.FeedLinkStatusEnum.FeedLinkStatus):
