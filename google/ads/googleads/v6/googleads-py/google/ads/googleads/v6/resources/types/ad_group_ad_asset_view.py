...
class AdGroupAdAssetView(proto.Message):
    ...
    Attributes:
        ...
        policy_summary (google.ads.googleads.v6.resources.types.AdGroupAdAssetPolicySummary):
            Output only. Policy information for the ad
            group ad asset.
        performance_label (google.ads.googleads.v6.enums.types.AssetPerformanceLabelEnum.AssetPerformanceLabel):
