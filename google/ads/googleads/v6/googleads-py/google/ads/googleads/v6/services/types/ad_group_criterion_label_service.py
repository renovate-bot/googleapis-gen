...
class GetAdGroupCriterionLabelRequest(proto.Message):
    ...
    [AdGroupCriterionLabelService.GetAdGroupCriterionLabel][google.ads.googleads.v6.services.AdGroupCriterionLabelService.GetAdGroupCriterionLabel].
...
class MutateAdGroupCriterionLabelsRequest(proto.Message):
    r"""Request message for
    [AdGroupCriterionLabelService.MutateAdGroupCriterionLabels][google.ads.googleads.v6.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose ad group
            criterion labels are being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.AdGroupCriterionLabelOperation]):
...
class AdGroupCriterionLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v6.resources.types.AdGroupCriterionLabel):
...
class MutateAdGroupCriterionLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateAdGroupCriterionLabelResult]):
