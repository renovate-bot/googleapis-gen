...
class AdParameterServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AdParameterServiceTransport]]
...
class AdParameterServiceClient(metaclass=AdParameterServiceClientMeta):
    ...
    def transport(self) -> AdParameterServiceTransport:
        ...
        Returns:
            AdParameterServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, AdParameterServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the ad parameter service client.
        ...
        Args:
            ...
            transport (Union[str, ~.AdParameterServiceTransport]): The
        ...
        if isinstance(transport, AdParameterServiceTransport):
            ...
            self._transport = AdParameterServiceGrpcTransport(
    ...
    def get_ad_parameter(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetAdParameterRequest`):
                The request object. Request message for
                [AdParameterService.GetAdParameter][google.ads.googleads.v6.services.AdParameterService.GetAdParameter]
        ...
        Returns:
            google.ads.googleads.v6.resources.types.AdParameter:
    ...
    def mutate_ad_parameters(self,
        ...
        r"""Creates, updates, or removes ad parameters. Operation
        statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateAdParametersRequest`):
                The request object. Request message for
                [AdParameterService.MutateAdParameters][google.ads.googleads.v6.services.AdParameterService.MutateAdParameters]
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.AdParameterOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateAdParametersResponse:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a ad_parameter_service.MutateAdParametersRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, ad_parameter_service.MutateAdParametersRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_ad_parameters]
