...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
    ...
    def get_campaign(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCampaignRequest`):
                The request object.
                Request message for
                [CampaignService.GetCampaign][google.ads.googleads.v6.services.CampaignService.GetCampaign].
        ...
        Returns:
            google.ads.googleads.v6.resources.types.Campaign:
                A campaign.
        """
    ...
    def mutate_campaigns(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateCampaignsRequest`):
                The request object.
                Request message for
                [CampaignService.MutateCampaigns][google.ads.googleads.v6.services.CampaignService.MutateCampaigns].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.CampaignOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCampaignsResponse:
