...
from google.ads.googleads.v6.resources.types import shared_set as gagr_shared_set
...
class GetSharedSetRequest(proto.Message):
    ...
    [SharedSetService.GetSharedSet][google.ads.googleads.v6.services.SharedSetService.GetSharedSet].
...
class MutateSharedSetsRequest(proto.Message):
    r"""Request message for
    [SharedSetService.MutateSharedSets][google.ads.googleads.v6.services.SharedSetService.MutateSharedSets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose shared
            sets are being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.SharedSetOperation]):
...
class SharedSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.SharedSet):
            Create operation: No resource name is
            expected for the new shared set.
        update (google.ads.googleads.v6.resources.types.SharedSet):
...
class MutateSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateSharedSetResult]):
...
class MutateSharedSetResult(proto.Message):
    ...
    Attributes:
        ...
        shared_set (google.ads.googleads.v6.resources.types.SharedSet):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    shared_set = proto.Field(proto.MESSAGE, number=2,
        message=gagr_shared_set.SharedSet,
    )
