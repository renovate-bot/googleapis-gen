...
class MutateKeywordPlanCampaignsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v6.services.types.KeywordPlanCampaignOperation]):
...
class KeywordPlanCampaignOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.KeywordPlanCampaign):
            Create operation: No resource name is
            expected for the new Keyword Plan campaign.
        update (google.ads.googleads.v6.resources.types.KeywordPlanCampaign):
...
class MutateKeywordPlanCampaignsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateKeywordPlanCampaignResult]):
