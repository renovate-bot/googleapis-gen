...
class AdGroupBidModifierServiceClient(metaclass=AdGroupBidModifierServiceClientMeta):
    ...
    def get_ad_group_bid_modifier(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetAdGroupBidModifierRequest`):
                The request object. Request message for
                [AdGroupBidModifierService.GetAdGroupBidModifier][google.ads.googleads.v6.services.AdGroupBidModifierService.GetAdGroupBidModifier].
        ...
        Returns:
            google.ads.googleads.v6.resources.types.AdGroupBidModifier:
    ...
    def mutate_ad_group_bid_modifiers(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateAdGroupBidModifiersRequest`):
                The request object. Request message for
                [AdGroupBidModifierService.MutateAdGroupBidModifiers][google.ads.googleads.v6.services.AdGroupBidModifierService.MutateAdGroupBidModifiers].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.AdGroupBidModifierOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateAdGroupBidModifiersResponse:
