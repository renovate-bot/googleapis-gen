...
from google.ads.googleads.v6.enums.types import day_of_week as gage_day_of_week
...
from google.ads.googleads.v6.enums.types import product_channel as gage_product_channel
from google.ads.googleads.v6.enums.types import product_channel_exclusivity as gage_product_channel_exclusivity
from google.ads.googleads.v6.enums.types import product_condition as gage_product_condition
...
class MobileAppCategoryInfo(proto.Message):
    ...
    mobile_app_category_constant = proto.Field(proto.STRING, number=2, optional=True)
...
class DeviceInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.DeviceEnum.Device):
            Type of the device.
    """
...
class PreferredContentInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.PreferredContentTypeEnum.PreferredContentType):
...
class ListingGroupInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.ListingGroupTypeEnum.ListingGroupType):
            Type of the listing group.
        case_value (google.ads.googleads.v6.common.types.ListingDimensionInfo):
    ...
    parent_ad_group_criterion = proto.Field(proto.STRING, number=4, optional=True)
...
class ListingScopeInfo(proto.Message):
    ...
    Attributes:
        dimensions (Sequence[google.ads.googleads.v6.common.types.ListingDimensionInfo]):
...
class ListingDimensionInfo(proto.Message):
    ...
    Attributes:
        hotel_id (google.ads.googleads.v6.common.types.HotelIdInfo):
            Advertiser-specific hotel ID.
        hotel_class (google.ads.googleads.v6.common.types.HotelClassInfo):
            Class of the hotel as a number of stars 1 to
            5.
        hotel_country_region (google.ads.googleads.v6.common.types.HotelCountryRegionInfo):
            Country or Region the hotel is located in.
        hotel_state (google.ads.googleads.v6.common.types.HotelStateInfo):
            State the hotel is located in.
        hotel_city (google.ads.googleads.v6.common.types.HotelCityInfo):
            City the hotel is located in.
        product_bidding_category (google.ads.googleads.v6.common.types.ProductBiddingCategoryInfo):
            Bidding category of a product offer.
        product_brand (google.ads.googleads.v6.common.types.ProductBrandInfo):
            Brand of a product offer.
        product_channel (google.ads.googleads.v6.common.types.ProductChannelInfo):
            Locality of a product offer.
        product_channel_exclusivity (google.ads.googleads.v6.common.types.ProductChannelExclusivityInfo):
            Availability of a product offer.
        product_condition (google.ads.googleads.v6.common.types.ProductConditionInfo):
            Condition of a product offer.
        product_custom_attribute (google.ads.googleads.v6.common.types.ProductCustomAttributeInfo):
            Custom attribute of a product offer.
        product_item_id (google.ads.googleads.v6.common.types.ProductItemIdInfo):
            Item id of a product offer.
        product_type (google.ads.googleads.v6.common.types.ProductTypeInfo):
            Type of a product offer.
        unknown_listing_dimension (google.ads.googleads.v6.common.types.UnknownListingDimensionInfo):
...
class HotelCountryRegionInfo(proto.Message):
    ...
    country_region_criterion = proto.Field(proto.STRING, number=2, optional=True)
...
class ProductChannelInfo(proto.Message):
    ...
    Attributes:
        channel (google.ads.googleads.v6.enums.types.ProductChannelEnum.ProductChannel):
...
class ProductChannelExclusivityInfo(proto.Message):
    ...
    Attributes:
        channel_exclusivity (google.ads.googleads.v6.enums.types.ProductChannelExclusivityEnum.ProductChannelExclusivity):
...
class ProductConditionInfo(proto.Message):
    ...
    Attributes:
        condition (google.ads.googleads.v6.enums.types.ProductConditionEnum.ProductCondition):
...
class ProductCustomAttributeInfo(proto.Message):
    ...
    Attributes:
        ...
        index (google.ads.googleads.v6.enums.types.ProductCustomAttributeIndexEnum.ProductCustomAttributeIndex):
...
class ProductTypeInfo(proto.Message):
    ...
    Attributes:
        value (str):
            Value of the type.
        level (google.ads.googleads.v6.enums.types.ProductTypeLevelEnum.ProductTypeLevel):
            Level of the type.
    """
...
class HotelDateSelectionTypeInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.HotelDateSelectionTypeEnum.HotelDateSelectionType):
...
class HotelCheckInDayInfo(proto.Message):
    ...
    Attributes:
        day_of_week (google.ads.googleads.v6.enums.types.DayOfWeekEnum.DayOfWeek):
            The day of the week.
    """
...
class InteractionTypeInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.InteractionTypeEnum.InteractionType):
...
class AdScheduleInfo(proto.Message):
    ...
    Attributes:
        start_minute (google.ads.googleads.v6.enums.types.MinuteOfHourEnum.MinuteOfHour):
        ...
        end_minute (google.ads.googleads.v6.enums.types.MinuteOfHourEnum.MinuteOfHour):
...
class AgeRangeInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.AgeRangeTypeEnum.AgeRangeType):
...
class GenderInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.GenderTypeEnum.GenderType):
            Type of the gender.
    """
...
class IncomeRangeInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.IncomeRangeTypeEnum.IncomeRangeType):
...
class ParentalStatusInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.ParentalStatusTypeEnum.ParentalStatusType):
...
class ProximityInfo(proto.Message):
    ...
    Attributes:
        geo_point (google.ads.googleads.v6.common.types.GeoPointInfo):
            Latitude and longitude.
        radius (float):
            The radius of the proximity.
        radius_units (google.ads.googleads.v6.enums.types.ProximityRadiusUnitsEnum.ProximityRadiusUnits):
            The unit of measurement of the radius.
            Default is KILOMETERS.
        address (google.ads.googleads.v6.common.types.AddressInfo):
            Full address.
    """
...
class ContentLabelInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.ContentLabelTypeEnum.ContentLabelType):
...
class WebpageInfo(proto.Message):
    ...
    Attributes:
        criterion_name (str):
            ...
            This field is required for CREATE operations and
            is prohibited on UPDATE operations.
        conditions (Sequence[google.ads.googleads.v6.common.types.WebpageConditionInfo]):
...
class WebpageConditionInfo(proto.Message):
    ...
    Attributes:
        operand (google.ads.googleads.v6.enums.types.WebpageConditionOperandEnum.WebpageConditionOperand):
            Operand of webpage targeting condition.
        operator (google.ads.googleads.v6.enums.types.WebpageConditionOperatorEnum.WebpageConditionOperator):
...
class OperatingSystemVersionInfo(proto.Message):
    ...
    operating_system_version_constant = proto.Field(proto.STRING, number=2, optional=True)
...
class AppPaymentModelInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v6.enums.types.AppPaymentModelTypeEnum.AppPaymentModelType):
...
class LocationGroupInfo(proto.Message):
    ...
    Attributes:
        ...
        radius_units (google.ads.googleads.v6.enums.types.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnits):
