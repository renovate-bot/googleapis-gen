...
class MutateCustomerUserAccessInvitationRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.ads.googleads.v6.services.types.CustomerUserAccessInvitationOperation):
...
class CustomerUserAccessInvitationOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v6.resources.types.CustomerUserAccessInvitation):
...
class MutateCustomerUserAccessInvitationResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v6.services.types.MutateCustomerUserAccessInvitationResult):
