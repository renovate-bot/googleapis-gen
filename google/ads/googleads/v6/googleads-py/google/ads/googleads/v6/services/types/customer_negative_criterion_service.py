...
class MutateCustomerNegativeCriteriaRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v6.services.types.CustomerNegativeCriterionOperation]):
...
class CustomerNegativeCriterionOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v6.resources.types.CustomerNegativeCriterion):
...
class MutateCustomerNegativeCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateCustomerNegativeCriteriaResult]):
...
class MutateCustomerNegativeCriteriaResult(proto.Message):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    customer_negative_criterion = proto.Field(proto.MESSAGE, number=2,
        message=gagr_customer_negative_criterion.CustomerNegativeCriterion,
    )
