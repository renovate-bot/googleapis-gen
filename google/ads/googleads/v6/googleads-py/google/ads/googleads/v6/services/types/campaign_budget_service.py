...
class GetCampaignBudgetRequest(proto.Message):
    ...
    [CampaignBudgetService.GetCampaignBudget][google.ads.googleads.v6.services.CampaignBudgetService.GetCampaignBudget].
...
class MutateCampaignBudgetsRequest(proto.Message):
    r"""Request message for
    [CampaignBudgetService.MutateCampaignBudgets][google.ads.googleads.v6.services.CampaignBudgetService.MutateCampaignBudgets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign budgets are being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.CampaignBudgetOperation]):
...
class CampaignBudgetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.CampaignBudget):
            Create operation: No resource name is
            expected for the new budget.
        update (google.ads.googleads.v6.resources.types.CampaignBudget):
...
class MutateCampaignBudgetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateCampaignBudgetResult]):
...
class MutateCampaignBudgetResult(proto.Message):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    campaign_budget = proto.Field(proto.MESSAGE, number=2,
        message=gagr_campaign_budget.CampaignBudget,
    )
