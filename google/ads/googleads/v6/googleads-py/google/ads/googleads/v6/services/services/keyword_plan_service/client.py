...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
    ...
    def get_keyword_plan(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetKeywordPlanRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.resources.types.KeywordPlan:
    ...
    def mutate_keyword_plans(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateKeywordPlansRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.KeywordPlanOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateKeywordPlansResponse:
    ...
    def generate_forecast_curve(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GenerateForecastCurveRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.services.types.GenerateForecastCurveResponse:
    ...
    def generate_forecast_time_series(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GenerateForecastTimeSeriesRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.services.types.GenerateForecastTimeSeriesResponse:
                Response message for
                [KeywordPlanService.GenerateForecastTimeSeries][google.ads.googleads.v6.services.KeywordPlanService.GenerateForecastTimeSeries].
    ...
    def generate_forecast_metrics(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GenerateForecastMetricsRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.services.types.GenerateForecastMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateForecastMetrics][google.ads.googleads.v6.services.KeywordPlanService.GenerateForecastMetrics].
    ...
    def generate_historical_metrics(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GenerateHistoricalMetricsRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.services.types.GenerateHistoricalMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateHistoricalMetrics][google.ads.googleads.v6.services.KeywordPlanService.GenerateHistoricalMetrics].
