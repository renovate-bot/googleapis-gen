...
from google.ads.googleads.v6.resources.types import campaign_audience_view
from google.ads.googleads.v6.services.types import campaign_audience_view_service
...
class CampaignAudienceViewServiceClient(metaclass=CampaignAudienceViewServiceClientMeta):
    ...
    def get_campaign_audience_view(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCampaignAudienceViewRequest`):
                The request object.
                Request message for
                [CampaignAudienceViewService.GetCampaignAudienceView][google.ads.googleads.v6.services.CampaignAudienceViewService.GetCampaignAudienceView].
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CampaignAudienceView:
