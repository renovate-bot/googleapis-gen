...
class ProductBiddingCategoryConstantServiceClient(metaclass=ProductBiddingCategoryConstantServiceClientMeta):
    ...
    def get_product_bidding_category_constant(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetProductBiddingCategoryConstantRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.ProductBiddingCategoryConstant:
