...
class ExtensionFeedItemServiceClient(metaclass=ExtensionFeedItemServiceClientMeta):
    ...
    def get_extension_feed_item(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetExtensionFeedItemRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.ExtensionFeedItem:
    ...
    def mutate_extension_feed_items(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateExtensionFeedItemsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.ExtensionFeedItemOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateExtensionFeedItemsResponse:
