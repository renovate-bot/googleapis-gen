...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
    ...
    def get_feed_item_set_link(self,
        ...
        r"""Returns the requested feed item set link in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetFeedItemSetLinkRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.FeedItemSetLink:
    ...
    def mutate_feed_item_set_links(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateFeedItemSetLinksRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.FeedItemSetLinkOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateFeedItemSetLinksResponse:
