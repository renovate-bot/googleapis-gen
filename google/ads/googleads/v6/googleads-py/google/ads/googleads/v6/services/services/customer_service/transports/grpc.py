...
class CustomerServiceGrpcTransport(CustomerServiceTransport):
    """gRPC backend transport for CustomerService.
    ...
    def get_customer(self) -> Callable[
        ...
        if 'get_customer' not in self._stubs:
            self._stubs['get_customer'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=customer_service.GetCustomerRequest.serialize,
                response_deserializer=customer.Customer.deserialize,
            )
    ...
    def mutate_customer(self) -> Callable[
        ...
        Returns:
            Callable[[~.MutateCustomerRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'mutate_customer' not in self._stubs:
            self._stubs['mutate_customer'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v6.services.CustomerService/MutateCustomer',
                request_serializer=customer_service.MutateCustomerRequest.serialize,
                response_deserializer=customer_service.MutateCustomerResponse.deserialize,
            )
        return self._stubs['mutate_customer']
    ...
    def list_accessible_customers(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListAccessibleCustomersRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'list_accessible_customers' not in self._stubs:
            self._stubs['list_accessible_customers'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v6.services.CustomerService/ListAccessibleCustomers',
                request_serializer=customer_service.ListAccessibleCustomersRequest.serialize,
                response_deserializer=customer_service.ListAccessibleCustomersResponse.deserialize,
            )
        return self._stubs['list_accessible_customers']
    ...
    def create_customer_client(self) -> Callable[
        ...
        Returns:
            Callable[[~.CreateCustomerClientRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'create_customer_client' not in self._stubs:
            self._stubs['create_customer_client'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v6.services.CustomerService/CreateCustomerClient',
                request_serializer=customer_service.CreateCustomerClientRequest.serialize,
                response_deserializer=customer_service.CreateCustomerClientResponse.deserialize,
            )
        return self._stubs['create_customer_client']
