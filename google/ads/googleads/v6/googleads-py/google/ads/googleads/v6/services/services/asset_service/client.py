...
class AssetServiceClient(metaclass=AssetServiceClientMeta):
    ...
    def get_asset(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetAssetRequest`):
                The request object. Request message for
                [AssetService.GetAsset][google.ads.googleads.v6.services.AssetService.GetAsset]
        ...
        Returns:
            google.ads.googleads.v6.resources.types.Asset:
    ...
    def mutate_assets(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateAssetsRequest`):
                The request object. Request message for
                [AssetService.MutateAssets][google.ads.googleads.v6.services.AssetService.MutateAssets]
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.AssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateAssetsResponse:
