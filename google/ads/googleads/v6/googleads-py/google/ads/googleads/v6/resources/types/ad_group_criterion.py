...
class AdGroupCriterion(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v6.enums.types.AdGroupCriterionStatusEnum.AdGroupCriterionStatus):
            ...
            added.
        quality_info (google.ads.googleads.v6.resources.types.AdGroupCriterion.QualityInfo):
            Output only. Information regarding the
            quality of the criterion.
        ad_group (str):
            Immutable. The ad group to which the
            criterion belongs.
        type_ (google.ads.googleads.v6.enums.types.CriterionTypeEnum.CriterionType):
        ...
        system_serving_status (google.ads.googleads.v6.enums.types.CriterionSystemServingStatusEnum.CriterionSystemServingStatus):
            Output only. Serving status of the criterion.
        approval_status (google.ads.googleads.v6.enums.types.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus):
        ...
        effective_percent_cpc_bid_micros (int):
            ...
            amount.
        effective_cpc_bid_source (google.ads.googleads.v6.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPC bid.
        effective_cpm_bid_source (google.ads.googleads.v6.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPM bid.
        effective_cpv_bid_source (google.ads.googleads.v6.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPV bid.
        effective_percent_cpc_bid_source (google.ads.googleads.v6.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective Percent
            CPC bid.
        position_estimates (google.ads.googleads.v6.resources.types.AdGroupCriterion.PositionEstimates):
        ...
        keyword (google.ads.googleads.v6.common.types.KeywordInfo):
            Immutable. Keyword.
        placement (google.ads.googleads.v6.common.types.PlacementInfo):
            Immutable. Placement.
        mobile_app_category (google.ads.googleads.v6.common.types.MobileAppCategoryInfo):
            Immutable. Mobile app category.
        mobile_application (google.ads.googleads.v6.common.types.MobileApplicationInfo):
            Immutable. Mobile application.
        listing_group (google.ads.googleads.v6.common.types.ListingGroupInfo):
            Immutable. Listing group.
        age_range (google.ads.googleads.v6.common.types.AgeRangeInfo):
            Immutable. Age range.
        gender (google.ads.googleads.v6.common.types.GenderInfo):
            Immutable. Gender.
        income_range (google.ads.googleads.v6.common.types.IncomeRangeInfo):
            Immutable. Income range.
        parental_status (google.ads.googleads.v6.common.types.ParentalStatusInfo):
            Immutable. Parental status.
        user_list (google.ads.googleads.v6.common.types.UserListInfo):
            Immutable. User List.
        youtube_video (google.ads.googleads.v6.common.types.YouTubeVideoInfo):
            Immutable. YouTube Video.
        youtube_channel (google.ads.googleads.v6.common.types.YouTubeChannelInfo):
            Immutable. YouTube Channel.
        topic (google.ads.googleads.v6.common.types.TopicInfo):
            Immutable. Topic.
        user_interest (google.ads.googleads.v6.common.types.UserInterestInfo):
            Immutable. User Interest.
        webpage (google.ads.googleads.v6.common.types.WebpageInfo):
            Immutable. Webpage
        app_payment_model (google.ads.googleads.v6.common.types.AppPaymentModelInfo):
            Immutable. App Payment Model.
        custom_affinity (google.ads.googleads.v6.common.types.CustomAffinityInfo):
            Immutable. Custom Affinity.
        custom_intent (google.ads.googleads.v6.common.types.CustomIntentInfo):
            Immutable. Custom Intent.
        custom_audience (google.ads.googleads.v6.common.types.CustomAudienceInfo):
            Immutable. Custom Audience.
        combined_audience (google.ads.googleads.v6.common.types.CombinedAudienceInfo):
    ...
    class QualityInfo(proto.Message):
        ...
        Attributes:
            quality_score (int):
                ...
                value.
            creative_quality_score (google.ads.googleads.v6.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
                Output only. The performance of the ad
                compared to other advertisers.
            post_click_quality_score (google.ads.googleads.v6.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
                Output only. The quality score of the landing
                page.
            search_predicted_ctr (google.ads.googleads.v6.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
        ...
        creative_quality_score = proto.Field(proto.ENUM, number=2,
            enum=quality_score_bucket.QualityScoreBucketEnum.QualityScoreBucket,
        )
        post_click_quality_score = proto.Field(proto.ENUM, number=3,
            enum=quality_score_bucket.QualityScoreBucketEnum.QualityScoreBucket,
        )
        search_predicted_ctr = proto.Field(proto.ENUM, number=4,
            enum=quality_score_bucket.QualityScoreBucketEnum.QualityScoreBucket,
        )
    ...
    effective_cpc_bid_micros = proto.Field(proto.INT64, number=66, optional=True)
    effective_cpm_bid_micros = proto.Field(proto.INT64, number=67, optional=True)
    ...
    effective_cpc_bid_source = proto.Field(proto.ENUM, number=21,
        enum=bidding_source.BiddingSourceEnum.BiddingSource,
    )
    effective_cpm_bid_source = proto.Field(proto.ENUM, number=22,
        enum=bidding_source.BiddingSourceEnum.BiddingSource,
    )
    effective_cpv_bid_source = proto.Field(proto.ENUM, number=23,
        enum=bidding_source.BiddingSourceEnum.BiddingSource,
    )
    effective_percent_cpc_bid_source = proto.Field(proto.ENUM, number=35,
        enum=bidding_source.BiddingSourceEnum.BiddingSource,
    )
    position_estimates = proto.Field(proto.MESSAGE, number=10,
    ...
    url_custom_parameters = proto.RepeatedField(proto.MESSAGE, number=14,
        message=custom_parameter.CustomParameter,
    )
    keyword = proto.Field(proto.MESSAGE, number=27, oneof='criterion',
        message=criteria.KeywordInfo,
    )
    placement = proto.Field(proto.MESSAGE, number=28, oneof='criterion',
        message=criteria.PlacementInfo,
    )
    mobile_app_category = proto.Field(proto.MESSAGE, number=29, oneof='criterion',
        message=criteria.MobileAppCategoryInfo,
    )
    mobile_application = proto.Field(proto.MESSAGE, number=30, oneof='criterion',
        message=criteria.MobileApplicationInfo,
    )
    listing_group = proto.Field(proto.MESSAGE, number=32, oneof='criterion',
        message=criteria.ListingGroupInfo,
    )
    age_range = proto.Field(proto.MESSAGE, number=36, oneof='criterion',
        message=criteria.AgeRangeInfo,
    )
    gender = proto.Field(proto.MESSAGE, number=37, oneof='criterion',
        message=criteria.GenderInfo,
    )
    income_range = proto.Field(proto.MESSAGE, number=38, oneof='criterion',
        message=criteria.IncomeRangeInfo,
    )
    parental_status = proto.Field(proto.MESSAGE, number=39, oneof='criterion',
        message=criteria.ParentalStatusInfo,
    )
    user_list = proto.Field(proto.MESSAGE, number=42, oneof='criterion',
        message=criteria.UserListInfo,
    )
    youtube_video = proto.Field(proto.MESSAGE, number=40, oneof='criterion',
        message=criteria.YouTubeVideoInfo,
    )
    youtube_channel = proto.Field(proto.MESSAGE, number=41, oneof='criterion',
        message=criteria.YouTubeChannelInfo,
    )
    topic = proto.Field(proto.MESSAGE, number=43, oneof='criterion',
        message=criteria.TopicInfo,
    )
    user_interest = proto.Field(proto.MESSAGE, number=45, oneof='criterion',
        message=criteria.UserInterestInfo,
    )
    webpage = proto.Field(proto.MESSAGE, number=46, oneof='criterion',
        message=criteria.WebpageInfo,
    )
    app_payment_model = proto.Field(proto.MESSAGE, number=47, oneof='criterion',
        message=criteria.AppPaymentModelInfo,
    )
    custom_affinity = proto.Field(proto.MESSAGE, number=48, oneof='criterion',
        message=criteria.CustomAffinityInfo,
    )
    custom_intent = proto.Field(proto.MESSAGE, number=49, oneof='criterion',
        message=criteria.CustomIntentInfo,
    )
    custom_audience = proto.Field(proto.MESSAGE, number=74, oneof='criterion',
        message=criteria.CustomAudienceInfo,
    )
    combined_audience = proto.Field(proto.MESSAGE, number=75, oneof='criterion',
