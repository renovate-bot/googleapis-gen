...
class ExtensionFeedItem(proto.Message):
    ...
    Attributes:
        ...
        id (int):
            ...
            nly.
        extension_type (google.ads.googleads.v6.enums.types.ExtensionTypeEnum.ExtensionType):
        ...
        end_date_time (str):
            ...
            Examples: "2018-03-05 09:15:00" or "2018-02-01
            14:34:30".
        ad_schedules (Sequence[google.ads.googleads.v6.common.types.AdScheduleInfo]):
            ...
            day.
        device (google.ads.googleads.v6.enums.types.FeedItemTargetDeviceEnum.FeedItemTargetDevice):
            The targeted device.
        targeted_geo_target_constant (str):
            The targeted geo target constant.
        targeted_keyword (google.ads.googleads.v6.common.types.KeywordInfo):
            The targeted keyword.
        status (google.ads.googleads.v6.enums.types.FeedItemStatusEnum.FeedItemStatus):
            Output only. Status of the feed item.
            This field is read-only.
        sitelink_feed_item (google.ads.googleads.v6.common.types.SitelinkFeedItem):
            Sitelink extension.
        structured_snippet_feed_item (google.ads.googleads.v6.common.types.StructuredSnippetFeedItem):
            Structured snippet extension.
        app_feed_item (google.ads.googleads.v6.common.types.AppFeedItem):
            App extension.
        call_feed_item (google.ads.googleads.v6.common.types.CallFeedItem):
            Call extension.
        callout_feed_item (google.ads.googleads.v6.common.types.CalloutFeedItem):
            Callout extension.
        text_message_feed_item (google.ads.googleads.v6.common.types.TextMessageFeedItem):
            Text message extension.
        price_feed_item (google.ads.googleads.v6.common.types.PriceFeedItem):
            Price extension.
        promotion_feed_item (google.ads.googleads.v6.common.types.PromotionFeedItem):
            Promotion extension.
        location_feed_item (google.ads.googleads.v6.common.types.LocationFeedItem):
            Output only. Location extension. Locations
            are synced from a GMB account into a feed. This
            field is read-only.
        affiliate_location_feed_item (google.ads.googleads.v6.common.types.AffiliateLocationFeedItem):
        ...
        hotel_callout_feed_item (google.ads.googleads.v6.common.types.HotelCalloutFeedItem):
            Hotel Callout extension.
        image_feed_item (google.ads.googleads.v6.common.types.ImageFeedItem):
    ...
    targeted_geo_target_constant = proto.Field(proto.STRING, number=30, optional=True)
    ...
    image_feed_item = proto.Field(proto.MESSAGE, number=31, oneof='extension',
        message=extensions.ImageFeedItem,
    )
    targeted_campaign = proto.Field(proto.STRING, number=28, oneof='serving_resource_targeting')
    targeted_ad_group = proto.Field(proto.STRING, number=29, oneof='serving_resource_targeting')
