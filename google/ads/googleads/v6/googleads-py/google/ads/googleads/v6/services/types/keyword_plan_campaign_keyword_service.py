...
class GetKeywordPlanCampaignKeywordRequest(proto.Message):
    ...
    [KeywordPlanCampaignKeywordService.GetKeywordPlanCampaignKeyword][google.ads.googleads.v6.services.KeywordPlanCampaignKeywordService.GetKeywordPlanCampaignKeyword].
...
class MutateKeywordPlanCampaignKeywordsRequest(proto.Message):
    r"""Request message for
    [KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords][google.ads.googleads.v6.services.KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign keywords are being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.KeywordPlanCampaignKeywordOperation]):
...
class KeywordPlanCampaignKeywordOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.KeywordPlanCampaignKeyword):
            Create operation: No resource name is
            expected for the new Keyword Plan campaign
            keyword.
        update (google.ads.googleads.v6.resources.types.KeywordPlanCampaignKeyword):
...
class MutateKeywordPlanCampaignKeywordsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateKeywordPlanCampaignKeywordResult]):
