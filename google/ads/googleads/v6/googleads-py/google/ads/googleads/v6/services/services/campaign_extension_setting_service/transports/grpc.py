...
class CampaignExtensionSettingServiceGrpcTransport(CampaignExtensionSettingServiceTransport):
    ...
    def get_campaign_extension_setting(self) -> Callable[
        ...
        if 'get_campaign_extension_setting' not in self._stubs:
            self._stubs['get_campaign_extension_setting'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v6.services.CampaignExtensionSettingService/GetCampaignExtensionSetting',
    ...
    def mutate_campaign_extension_settings(self) -> Callable[
        ...
        if 'mutate_campaign_extension_settings' not in self._stubs:
            self._stubs['mutate_campaign_extension_settings'] = self.grpc_channel.unary_unary(
