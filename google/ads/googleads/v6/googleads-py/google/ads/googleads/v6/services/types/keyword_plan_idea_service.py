...
class GenerateKeywordIdeasRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            ...
            results.
        keyword_plan_network (google.ads.googleads.v6.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            Targeting network.
        keyword_and_url_seed (google.ads.googleads.v6.services.types.KeywordAndUrlSeed):
            A Keyword and a specific Url to generate
            ideas from e.g. cars, www.example.com/cars.
        keyword_seed (google.ads.googleads.v6.services.types.KeywordSeed):
            A Keyword or phrase to generate ideas from,
            e.g. cars.
        url_seed (google.ads.googleads.v6.services.types.UrlSeed):
            A specific url to generate ideas from, e.g.
            www.example.com/cars.
        site_seed (google.ads.googleads.v6.services.types.SiteSeed):
...
class GenerateKeywordIdeaResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v6.services.types.GenerateKeywordIdeaResult]):
...
class GenerateKeywordIdeaResult(proto.Message):
    ...
    Attributes:
        text (str):
            ...
            KeywordPlanService.
        keyword_idea_metrics (google.ads.googleads.v6.common.types.KeywordPlanHistoricalMetrics):
