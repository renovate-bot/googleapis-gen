...
class ConversionAdjustmentUploadServiceClient(metaclass=ConversionAdjustmentUploadServiceClientMeta):
    ...
    def upload_conversion_adjustments(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.UploadConversionAdjustmentsRequest`):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            conversion_adjustments (:class:`Sequence[google.ads.googleads.v6.services.types.ConversionAdjustment]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.UploadConversionAdjustmentsResponse:
        ...
        if request is not None and any([customer_id, conversion_adjustments, partial_failure]):
