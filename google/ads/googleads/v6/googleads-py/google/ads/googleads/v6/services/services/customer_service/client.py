...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def get_customer(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCustomerRequest`):
                The request object. Request message for
                [CustomerService.GetCustomer][google.ads.googleads.v6.services.CustomerService.GetCustomer].
    ...
    def mutate_customer(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateCustomerRequest`):
                The request object. Request message for
                [CustomerService.MutateCustomer][google.ads.googleads.v6.services.CustomerService.MutateCustomer].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v6.services.types.CustomerOperation`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCustomerResponse:
    ...
    def list_accessible_customers(self,
        ...
        r"""Returns resource names of customers directly
        accessible by the user authenticating the call.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.ListAccessibleCustomersRequest`):
                The request object. Request message for
                [CustomerService.ListAccessibleCustomers][google.ads.googleads.v6.services.CustomerService.ListAccessibleCustomers].
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
        ...
        Returns:
            google.ads.googleads.v6.services.types.ListAccessibleCustomersResponse:
    ...
    def create_customer_client(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.CreateCustomerClientRequest`):
                The request object. Request message for
                [CustomerService.CreateCustomerClient][google.ads.googleads.v6.services.CustomerService.CreateCustomerClient].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            customer_client (:class:`google.ads.googleads.v6.resources.types.Customer`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.CreateCustomerClientResponse:
                Response message for
