...
class CustomerClientLinkServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CustomerClientLinkServiceTransport]]
...
class CustomerClientLinkServiceClient(metaclass=CustomerClientLinkServiceClientMeta):
    ...
    def transport(self) -> CustomerClientLinkServiceTransport:
        ...
        Returns:
            CustomerClientLinkServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiate the customer client link service client.
        ...
        if isinstance(transport, CustomerClientLinkServiceTransport):
            ...
            self._transport = CustomerClientLinkServiceGrpcTransport(
    ...
    def get_customer_client_link(self,
        ...
        r"""Returns the requested CustomerClientLink in full
        detail.
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CustomerClientLink:
                Represents customer client link
                relationship.
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_customer_client_link]
    ...
    def mutate_customer_client_link(self,
        ...
        r"""Creates or updates a customer client link. Operation
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v6.services.types.CustomerClientLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCustomerClientLinkResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_customer_client_link]
