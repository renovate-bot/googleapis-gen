...
class MutateKeywordPlanAdGroupKeywordsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            modified.
        operations (Sequence[google.ads.googleads.v6.services.types.KeywordPlanAdGroupKeywordOperation]):
...
class KeywordPlanAdGroupKeywordOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.KeywordPlanAdGroupKeyword):
            Create operation: No resource name is
            expected for the new Keyword Plan ad group
            keyword.
        update (google.ads.googleads.v6.resources.types.KeywordPlanAdGroupKeyword):
...
class MutateKeywordPlanAdGroupKeywordsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateKeywordPlanAdGroupKeywordResult]):
