...
class FeedItemSet(proto.Message):
    ...
    Attributes:
        ...
        display_name (str):
            ...
            account.
        status (google.ads.googleads.v6.enums.types.FeedItemSetStatusEnum.FeedItemSetStatus):
            Output only. Status of the feed item set.
            This field is read-only.
        dynamic_location_set_filter (google.ads.googleads.v6.common.types.DynamicLocationSetFilter):
            Filter for dynamic location set.
            It is only used for sets of locations.
        dynamic_affiliate_location_set_filter (google.ads.googleads.v6.common.types.DynamicAffiliateLocationSetFilter):
