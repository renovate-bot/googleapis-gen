...
class AdParameterServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for AdParameterService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_ad_parameter: gapic_v1.method.wrap_method(
                self.get_ad_parameter,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_ad_parameters: gapic_v1.method.wrap_method(
    ...
    @property
    def mutate_ad_parameters(self) -> typing.Callable[
