...
class MutateFeedMappingsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v6.services.types.FeedMappingOperation]):
...
class MutateFeedMappingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateFeedMappingResult]):
...
class MutateFeedMappingResult(proto.Message):
    ...
    Attributes:
        ...
        feed_mapping (google.ads.googleads.v6.resources.types.FeedMapping):
