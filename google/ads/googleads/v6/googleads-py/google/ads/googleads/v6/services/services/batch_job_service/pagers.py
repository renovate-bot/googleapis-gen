...
class ListBatchJobResultsPager:
    ...
    :class:`google.ads.googleads.v6.services.types.ListBatchJobResultsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v6.services.types.ListBatchJobResultsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v6.services.types.ListBatchJobResultsResponse`):
