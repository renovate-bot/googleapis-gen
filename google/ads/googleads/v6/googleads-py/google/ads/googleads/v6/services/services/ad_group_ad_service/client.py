...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
    ...
    def get_ad_group_ad(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetAdGroupAdRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.resources.types.AdGroupAd:
                An ad group ad.
        """
    ...
    def mutate_ad_group_ads(self,
        ...
        r"""Creates, updates, or removes ads. Operation statuses
        are returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateAdGroupAdsRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.AdGroupAdOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateAdGroupAdsResponse:
