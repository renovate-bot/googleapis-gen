...
class CampaignDraftServiceGrpcTransport(CampaignDraftServiceTransport):
    ...
    def mutate_campaign_drafts(self) -> Callable[
        ...
        if 'mutate_campaign_drafts' not in self._stubs:
            self._stubs['mutate_campaign_drafts'] = self.grpc_channel.unary_unary(
    ...
    def promote_campaign_draft(self) -> Callable[
        ...
        if 'promote_campaign_draft' not in self._stubs:
            self._stubs['promote_campaign_draft'] = self.grpc_channel.unary_unary(
    ...
    def list_campaign_draft_async_errors(self) -> Callable[
        ...
        if 'list_campaign_draft_async_errors' not in self._stubs:
            self._stubs['list_campaign_draft_async_errors'] = self.grpc_channel.unary_unary(
