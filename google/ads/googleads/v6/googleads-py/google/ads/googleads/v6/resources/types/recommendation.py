...
from google.ads.googleads.v6.enums.types import recommendation_type
from google.ads.googleads.v6.enums.types import target_cpa_opt_in_recommendation_goal
...
class Recommendation(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v6.enums.types.RecommendationTypeEnum.RecommendationType):
            Output only. The type of recommendation.
        impact (google.ads.googleads.v6.resources.types.Recommendation.RecommendationImpact):
        ...
        dismissed (bool):
            ...
            dismissed or not.
        campaign_budget_recommendation (google.ads.googleads.v6.resources.types.Recommendation.CampaignBudgetRecommendation):
            Output only. The campaign budget
            recommendation.
        forecasting_campaign_budget_recommendation (google.ads.googleads.v6.resources.types.Recommendation.CampaignBudgetRecommendation):
            Output only. The forecasting campaign budget
            recommendation.
        keyword_recommendation (google.ads.googleads.v6.resources.types.Recommendation.KeywordRecommendation):
            Output only. The keyword recommendation.
        text_ad_recommendation (google.ads.googleads.v6.resources.types.Recommendation.TextAdRecommendation):
            Output only. Add expanded text ad
            recommendation.
        target_cpa_opt_in_recommendation (google.ads.googleads.v6.resources.types.Recommendation.TargetCpaOptInRecommendation):
            Output only. The TargetCPA opt-in
            recommendation.
        maximize_conversions_opt_in_recommendation (google.ads.googleads.v6.resources.types.Recommendation.MaximizeConversionsOptInRecommendation):
            Output only. The MaximizeConversions Opt-In
            recommendation.
        enhanced_cpc_opt_in_recommendation (google.ads.googleads.v6.resources.types.Recommendation.EnhancedCpcOptInRecommendation):
            Output only. The Enhanced Cost-Per-Click Opt-
            n recommendation.
        search_partners_opt_in_recommendation (google.ads.googleads.v6.resources.types.Recommendation.SearchPartnersOptInRecommendation):
            Output only. The Search Partners Opt-In
            recommendation.
        maximize_clicks_opt_in_recommendation (google.ads.googleads.v6.resources.types.Recommendation.MaximizeClicksOptInRecommendation):
            Output only. The MaximizeClicks Opt-In
            recommendation.
        optimize_ad_rotation_recommendation (google.ads.googleads.v6.resources.types.Recommendation.OptimizeAdRotationRecommendation):
            Output only. The Optimize Ad Rotation
            recommendation.
        callout_extension_recommendation (google.ads.googleads.v6.resources.types.Recommendation.CalloutExtensionRecommendation):
            Output only. The Callout extension
            recommendation.
        sitelink_extension_recommendation (google.ads.googleads.v6.resources.types.Recommendation.SitelinkExtensionRecommendation):
            Output only. The Sitelink extension
            recommendation.
        call_extension_recommendation (google.ads.googleads.v6.resources.types.Recommendation.CallExtensionRecommendation):
            Output only. The Call extension
            recommendation.
        keyword_match_type_recommendation (google.ads.googleads.v6.resources.types.Recommendation.KeywordMatchTypeRecommendation):
            Output only. The keyword match type
            recommendation.
        move_unused_budget_recommendation (google.ads.googleads.v6.resources.types.Recommendation.MoveUnusedBudgetRecommendation):
            Output only. The move unused budget
            recommendation.
        target_roas_opt_in_recommendation (google.ads.googleads.v6.resources.types.Recommendation.TargetRoasOptInRecommendation):
            Output only. The Target ROAS opt-in
            recommendation.
        responsive_search_ad_recommendation (google.ads.googleads.v6.resources.types.Recommendation.ResponsiveSearchAdRecommendation):
    ...
    class RecommendationImpact(proto.Message):
        ...
        Attributes:
            base_metrics (google.ads.googleads.v6.resources.types.Recommendation.RecommendationMetrics):
                Output only. Base metrics at the time the
                recommendation was generated.
            potential_metrics (google.ads.googleads.v6.resources.types.Recommendation.RecommendationMetrics):
                Output only. Estimated metrics if the
                recommendation is applied.
        """

        base_metrics = proto.Field(proto.MESSAGE, number=1,
            message='Recommendation.RecommendationMetrics',
        )
        potential_metrics = proto.Field(proto.MESSAGE, number=2,
            message='Recommendation.RecommendationMetrics',
        )
    ...
    class CampaignBudgetRecommendation(proto.Message):
        ...
        Attributes:
            ...
            recommended_budget_amount_micros (int):
                ...
                micros.
            budget_options (Sequence[google.ads.googleads.v6.resources.types.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption]):
        ...
        class CampaignBudgetRecommendationOption(proto.Message):
            ...
            budget_amount_micros = proto.Field(proto.INT64, number=3, optional=True)
            impact = proto.Field(proto.MESSAGE, number=2,
                message='Recommendation.RecommendationImpact',
            )

        current_budget_amount_micros = proto.Field(proto.INT64, number=7, optional=True)
        recommended_budget_amount_micros = proto.Field(proto.INT64, number=8, optional=True)
        budget_options = proto.RepeatedField(proto.MESSAGE, number=3,
    ...
    class KeywordRecommendation(proto.Message):
        ...
        Attributes:
            keyword (google.ads.googleads.v6.common.types.KeywordInfo):
        ...
        keyword = proto.Field(proto.MESSAGE, number=1,
            message=criteria.KeywordInfo,
        )
        recommended_cpc_bid_micros = proto.Field(proto.INT64, number=3, optional=True)
    ...
    class TargetCpaOptInRecommendation(proto.Message):
        ...
        Attributes:
            options_ (Sequence[google.ads.googleads.v6.resources.types.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption]):
        ...
        class TargetCpaOptInRecommendationOption(proto.Message):
            ...
            Attributes:
                goal (google.ads.googleads.v6.enums.types.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal):
        ...
        recommended_target_cpa_micros = proto.Field(proto.INT64, number=3, optional=True)
    ...
    class CalloutExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v6.common.types.CalloutFeedItem]):
                Output only. Callout extensions recommended
                to be added.
        """

        recommended_extensions = proto.RepeatedField(proto.MESSAGE, number=1,
    ...
    class MoveUnusedBudgetRecommendation(proto.Message):
        ...
        Attributes:
            ...
            budget_recommendation (google.ads.googleads.v6.resources.types.Recommendation.CampaignBudgetRecommendation):
                Output only. The recommendation for the
                constrained budget to increase.
        """

        excess_campaign_budget = proto.Field(proto.STRING, number=3, optional=True)
        budget_recommendation = proto.Field(proto.MESSAGE, number=2,
    ...
    class SitelinkExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v6.common.types.SitelinkFeedItem]):
    ...
    class KeywordMatchTypeRecommendation(proto.Message):
        ...
        Attributes:
            ...
            recommended_match_type (google.ads.googleads.v6.enums.types.KeywordMatchTypeEnum.KeywordMatchType):
        ...
        recommended_match_type = proto.Field(proto.ENUM, number=2,
    ...
    class CallExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v6.common.types.CallFeedItem]):
    ...
    class TargetRoasOptInRecommendation(proto.Message):
        ...
        recommended_target_roas = proto.Field(proto.DOUBLE, number=1, optional=True)
    ...
    impact = proto.Field(proto.MESSAGE, number=3,
    ...
    campaign_budget_recommendation = proto.Field(proto.MESSAGE, number=4, oneof='recommendation',
        message=CampaignBudgetRecommendation,
    )
    forecasting_campaign_budget_recommendation = proto.Field(proto.MESSAGE, number=22, oneof='recommendation',
        message=CampaignBudgetRecommendation,
    )
    keyword_recommendation = proto.Field(proto.MESSAGE, number=8, oneof='recommendation',
        message=KeywordRecommendation,
    )
    text_ad_recommendation = proto.Field(proto.MESSAGE, number=9, oneof='recommendation',
        message=TextAdRecommendation,
    )
    target_cpa_opt_in_recommendation = proto.Field(proto.MESSAGE, number=10, oneof='recommendation',
        message=TargetCpaOptInRecommendation,
    )
    maximize_conversions_opt_in_recommendation = proto.Field(proto.MESSAGE, number=11, oneof='recommendation',
        message=MaximizeConversionsOptInRecommendation,
    )
    enhanced_cpc_opt_in_recommendation = proto.Field(proto.MESSAGE, number=12, oneof='recommendation',
        message=EnhancedCpcOptInRecommendation,
    )
    search_partners_opt_in_recommendation = proto.Field(proto.MESSAGE, number=14, oneof='recommendation',
        message=SearchPartnersOptInRecommendation,
    )
    maximize_clicks_opt_in_recommendation = proto.Field(proto.MESSAGE, number=15, oneof='recommendation',
        message=MaximizeClicksOptInRecommendation,
    )
    optimize_ad_rotation_recommendation = proto.Field(proto.MESSAGE, number=16, oneof='recommendation',
        message=OptimizeAdRotationRecommendation,
    )
    callout_extension_recommendation = proto.Field(proto.MESSAGE, number=17, oneof='recommendation',
        message=CalloutExtensionRecommendation,
    )
    sitelink_extension_recommendation = proto.Field(proto.MESSAGE, number=18, oneof='recommendation',
        message=SitelinkExtensionRecommendation,
    )
    call_extension_recommendation = proto.Field(proto.MESSAGE, number=19, oneof='recommendation',
        message=CallExtensionRecommendation,
    )
    keyword_match_type_recommendation = proto.Field(proto.MESSAGE, number=20, oneof='recommendation',
        message=KeywordMatchTypeRecommendation,
    )
    move_unused_budget_recommendation = proto.Field(proto.MESSAGE, number=21, oneof='recommendation',
        message=MoveUnusedBudgetRecommendation,
    )
    target_roas_opt_in_recommendation = proto.Field(proto.MESSAGE, number=23, oneof='recommendation',
        message=TargetRoasOptInRecommendation,
    )
    responsive_search_ad_recommendation = proto.Field(proto.MESSAGE, number=28, oneof='recommendation',
