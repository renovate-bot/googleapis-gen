...
class MutateCustomerExtensionSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v6.services.types.CustomerExtensionSettingOperation]):
...
class CustomerExtensionSettingOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.CustomerExtensionSetting):
            Create operation: No resource name is
            expected for the new customer extension setting.
        update (google.ads.googleads.v6.resources.types.CustomerExtensionSetting):
    ...
    create = proto.Field(proto.MESSAGE, number=1, oneof='operation',
        message=customer_extension_setting.CustomerExtensionSetting,
    )
...
class MutateCustomerExtensionSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateCustomerExtensionSettingResult]):
