...
class MerchantCenterLinkServiceClient(metaclass=MerchantCenterLinkServiceClientMeta):
    ...
    def list_merchant_center_links(self,
        ...
        r"""Returns Merchant Center links available for this
        customer.
        ...
        Returns:
            google.ads.googleads.v6.services.types.ListMerchantCenterLinksResponse:
    ...
    def get_merchant_center_link(self,
        ...
        Returns:
            google.ads.googleads.v6.resources.types.MerchantCenterLink:
    ...
    def mutate_merchant_center_link(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v6.services.types.MerchantCenterLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateMerchantCenterLinkResponse:
