...
class OfflineUserDataJobServiceClient(metaclass=OfflineUserDataJobServiceClientMeta):
    ...
    def create_offline_user_data_job(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            job (:class:`google.ads.googleads.v6.resources.types.OfflineUserDataJob`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.CreateOfflineUserDataJobResponse:
    ...
    def get_offline_user_data_job(self,
        ...
        Returns:
            google.ads.googleads.v6.resources.types.OfflineUserDataJob:
    ...
    def add_offline_user_data_job_operations(self,
        ...
        Args:
            ...
            resource_name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.OfflineUserDataJobOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.AddOfflineUserDataJobOperationsResponse:
                Response message for
                   [OfflineUserDataJobService.AddOfflineUserDataJobOperations][google.ads.googleads.v6.services.OfflineUserDataJobService.AddOfflineUserDataJobOperations].
