...
from .transports.base import CampaignCriterionSimulationServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import CampaignCriterionSimulationServiceGrpcTransport


class CampaignCriterionSimulationServiceClientMeta(type):
    """Metaclass for the CampaignCriterionSimulationService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CampaignCriterionSimulationServiceTransport]]
    _transport_registry['grpc'] = CampaignCriterionSimulationServiceGrpcTransport
...
class CampaignCriterionSimulationServiceClient(metaclass=CampaignCriterionSimulationServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, CampaignCriterionSimulationServiceTransport, None] = None,
    ...
    def get_campaign_criterion_simulation(self,
        ...
        r"""Returns the requested campaign criterion simulation
        in full detail.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCampaignCriterionSimulationRequest`):
                The request object.
                Request message for
                [CampaignCriterionSimulationService.GetCampaignCriterionSimulation][google.ads.googleads.v6.services.CampaignCriterionSimulationService.GetCampaignCriterionSimulation].
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CampaignCriterionSimulation:
                A campaign criterion simulation. Supported combinations of advertising
                   channel type, criterion ids, simulation type and
                   simulation modification method is detailed below
                   respectively.
        ...
        if not isinstance(request, campaign_criterion_simulation_service.GetCampaignCriterionSimulationRequest):
            request = campaign_criterion_simulation_service.GetCampaignCriterionSimulationRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_campaign_criterion_simulation]
