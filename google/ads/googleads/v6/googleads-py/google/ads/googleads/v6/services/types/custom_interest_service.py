...
class GetCustomInterestRequest(proto.Message):
    ...
    [CustomInterestService.GetCustomInterest][google.ads.googleads.v6.services.CustomInterestService.GetCustomInterest].
...
class MutateCustomInterestsRequest(proto.Message):
    r"""Request message for
    [CustomInterestService.MutateCustomInterests][google.ads.googleads.v6.services.CustomInterestService.MutateCustomInterests].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose custom
            interests are being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.CustomInterestOperation]):
...
class CustomInterestOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.CustomInterest):
            Create operation: No resource name is
            expected for the new custom interest.
        update (google.ads.googleads.v6.resources.types.CustomInterest):
