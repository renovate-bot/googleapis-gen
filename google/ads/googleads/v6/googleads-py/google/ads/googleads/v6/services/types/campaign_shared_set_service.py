...
from google.ads.googleads.v6.resources.types import campaign_shared_set as gagr_campaign_shared_set
...
class GetCampaignSharedSetRequest(proto.Message):
    ...
    [CampaignSharedSetService.GetCampaignSharedSet][google.ads.googleads.v6.services.CampaignSharedSetService.GetCampaignSharedSet].
...
class MutateCampaignSharedSetsRequest(proto.Message):
    r"""Request message for
    [CampaignSharedSetService.MutateCampaignSharedSets][google.ads.googleads.v6.services.CampaignSharedSetService.MutateCampaignSharedSets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign shared sets are being modified.
        operations (Sequence[google.ads.googleads.v6.services.types.CampaignSharedSetOperation]):
...
class CampaignSharedSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v6.resources.types.CampaignSharedSet):
...
class MutateCampaignSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v6.services.types.MutateCampaignSharedSetResult]):
...
class MutateCampaignSharedSetResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_shared_set (google.ads.googleads.v6.resources.types.CampaignSharedSet):
    ...
    resource_name = proto.Field(proto.STRING, number=1)
    campaign_shared_set = proto.Field(proto.MESSAGE, number=2,
        message=gagr_campaign_shared_set.CampaignSharedSet,
    )
