...
from google.ads.googleads.v6.enums.types import custom_audience_type
...
class CustomAudienceServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CustomAudienceServiceTransport]]
...
class CustomAudienceServiceClient(metaclass=CustomAudienceServiceClientMeta):
    ...
    def get_custom_audience(self,
        ...
        r"""Returns the requested custom audience in full detail.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCustomAudienceRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CustomAudience:
                A custom audience. This is a list of
                users by interest.
        ...
        if not isinstance(request, custom_audience_service.GetCustomAudienceRequest):
            request = custom_audience_service.GetCustomAudienceRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_custom_audience]
    ...
    def mutate_custom_audiences(self,
        ...
        r"""Creates or updates custom audiences. Operation
        statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateCustomAudiencesRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.CustomAudienceOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCustomAudiencesResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, custom_audience_service.MutateCustomAudiencesRequest):
            request = custom_audience_service.MutateCustomAudiencesRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_custom_audiences]
