...
class MutateCustomerClientLinkRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.ads.googleads.v6.services.types.CustomerClientLinkOperation):
...
class CustomerClientLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v6.resources.types.CustomerClientLink):
            Create operation: No resource name is
            expected for the new link.
        update (google.ads.googleads.v6.resources.types.CustomerClientLink):
...
class MutateCustomerClientLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v6.services.types.MutateCustomerClientLinkResult):
