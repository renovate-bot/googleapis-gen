...
class KeywordPlanAdGroupKeywordServiceClient(metaclass=KeywordPlanAdGroupKeywordServiceClientMeta):
    ...
    def get_keyword_plan_ad_group_keyword(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetKeywordPlanAdGroupKeywordRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v6.resources.types.KeywordPlanAdGroupKeyword:
    ...
    def mutate_keyword_plan_ad_group_keywords(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateKeywordPlanAdGroupKeywordsRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.KeywordPlanAdGroupKeywordOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateKeywordPlanAdGroupKeywordsResponse:
