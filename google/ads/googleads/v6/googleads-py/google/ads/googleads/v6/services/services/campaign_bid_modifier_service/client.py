...
class CampaignBidModifierServiceClient(metaclass=CampaignBidModifierServiceClientMeta):
    ...
    def get_campaign_bid_modifier(self,
        ...
        r"""Returns the requested campaign bid modifier in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCampaignBidModifierRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CampaignBidModifier:
    ...
    def mutate_campaign_bid_modifiers(self,
        ...
        r"""Creates, updates, or removes campaign bid modifiers.
        Operation statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateCampaignBidModifiersRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.CampaignBidModifierOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCampaignBidModifiersResponse:
