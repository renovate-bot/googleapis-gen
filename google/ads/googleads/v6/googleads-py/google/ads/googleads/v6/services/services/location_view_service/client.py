...
class LocationViewServiceClient(metaclass=LocationViewServiceClientMeta):
    ...
    def get_location_view(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetLocationViewRequest`):
                The request object. Request message for
                [LocationViewService.GetLocationView][google.ads.googleads.v6.services.LocationViewService.GetLocationView].
        ...
        Returns:
            google.ads.googleads.v6.resources.types.LocationView:
