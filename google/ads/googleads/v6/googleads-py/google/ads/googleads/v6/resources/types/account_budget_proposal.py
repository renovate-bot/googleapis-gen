...
from google.ads.googleads.v6.enums.types import account_budget_proposal_status
from google.ads.googleads.v6.enums.types import account_budget_proposal_type
...
class AccountBudgetProposal(proto.Message):
    ...
    Attributes:
        ...
        proposal_type (google.ads.googleads.v6.enums.types.AccountBudgetProposalTypeEnum.AccountBudgetProposalType):
            Immutable. The type of this proposal, e.g.
            END to end the budget associated with this
            proposal.
        status (google.ads.googleads.v6.enums.types.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus):
        ...
        proposed_start_date_time (str):
            ...
            yyyy-mm-dd hh:mm:ss format.
        proposed_start_time_type (google.ads.googleads.v6.enums.types.TimeTypeEnum.TimeType):
        ...
        proposed_end_date_time (str):
            ...
            yyyy-mm-dd hh:mm:ss format.
        proposed_end_time_type (google.ads.googleads.v6.enums.types.TimeTypeEnum.TimeType):
        ...
        approved_end_date_time (str):
            ...
            yyyy-mm-dd hh:mm:ss format.
        approved_end_time_type (google.ads.googleads.v6.enums.types.TimeTypeEnum.TimeType):
        ...
        proposed_spending_limit_type (google.ads.googleads.v6.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
        ...
        approved_spending_limit_micros (int):
            ...
            micros.  One million is equivalent to one unit.
        approved_spending_limit_type (google.ads.googleads.v6.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
    ...
    proposed_purchase_order_number = proto.Field(proto.STRING, number=35, optional=True)
    ...
    proposed_end_date_time = proto.Field(proto.STRING, number=31, oneof='proposed_end_time')
    proposed_end_time_type = proto.Field(proto.ENUM, number=9, oneof='proposed_end_time',
        enum=time_type.TimeTypeEnum.TimeType,
    )
    approved_end_date_time = proto.Field(proto.STRING, number=32, oneof='approved_end_time')
    approved_end_time_type = proto.Field(proto.ENUM, number=22, oneof='approved_end_time',
        enum=time_type.TimeTypeEnum.TimeType,
    )
    proposed_spending_limit_micros = proto.Field(proto.INT64, number=33, oneof='proposed_spending_limit')
    ...
    approved_spending_limit_micros = proto.Field(proto.INT64, number=34, oneof='approved_spending_limit')
