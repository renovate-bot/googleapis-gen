...
from google.ads.googleads.v6.resources.types import invoice
from google.ads.googleads.v6.services.types import invoice_service
...
class InvoiceServiceClientMeta(type):
    """Metaclass for the InvoiceService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[InvoiceServiceTransport]]
    _transport_registry['grpc'] = InvoiceServiceGrpcTransport
...
class InvoiceServiceClient(metaclass=InvoiceServiceClientMeta):
    """A service to fetch invoices issued for a billing setup during
    a given month.
    """
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            InvoiceServiceClient: The constructed client.
        """
    ...
    def transport(self) -> InvoiceServiceTransport:
        ...
        Returns:
            InvoiceServiceTransport: The transport used by the client instance.
        """
        return self._transport

    @staticmethod
    def invoice_path(customer_id: str,invoice_id: str,) -> str:
        """Return a fully-qualified invoice string."""
        return "customers/{customer_id}/invoices/{invoice_id}".format(customer_id=customer_id, invoice_id=invoice_id, )

    @staticmethod
    def parse_invoice_path(path: str) -> Dict[str,str]:
        """Parse a invoice path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/invoices/(?P<invoice_id>.+?)$", path)
    ...
    def __init__(self, *,
            ...
            transport: Union[str, InvoiceServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the invoice service client.
        ...
        Args:
            ...
            transport (Union[str, ~.InvoiceServiceTransport]): The
        ...
        if isinstance(transport, InvoiceServiceTransport):
            # transport is a InvoiceServiceTransport instance.
            if credentials:
            ...
            self._transport = InvoiceServiceGrpcTransport(
    ...
    def list_invoices(self,
        ...
        r"""Returns all invoices associated with a billing setup,
        for a given month.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.ListInvoicesRequest`):
            ...
            issue_year (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            issue_month (:class:`google.ads.googleads.v6.enums.types.MonthOfYearEnum.MonthOfYear`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.ListInvoicesResponse:
                Response message for
                [InvoiceService.ListInvoices][google.ads.googleads.v6.services.InvoiceService.ListInvoices].

        """
        # Create or coerce a protobuf request object.
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        if request is not None and any([customer_id, billing_setup, issue_year, issue_month]):
