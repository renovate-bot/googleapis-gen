...
class UserInterest(proto.Message):
    ...
    Attributes:
        ...
        taxonomy_type (google.ads.googleads.v6.enums.types.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType):
        ...
        availabilities (Sequence[google.ads.googleads.v6.common.types.CriterionCategoryAvailability]):
