...
class FeedMapping(proto.Message):
    ...
    Attributes:
        ...
        attribute_field_mappings (Sequence[google.ads.googleads.v6.resources.types.AttributeFieldMapping]):
            ...
            attributes. Required.
        status (google.ads.googleads.v6.enums.types.FeedMappingStatusEnum.FeedMappingStatus):
            Output only. Status of the feed mapping.
            This field is read-only.
        placeholder_type (google.ads.googleads.v6.enums.types.PlaceholderTypeEnum.PlaceholderType):
            Immutable. The placeholder type of this
            mapping (i.e., if the mapping maps feed
            attributes to placeholder fields).
        criterion_type (google.ads.googleads.v6.enums.types.FeedMappingCriterionTypeEnum.FeedMappingCriterionType):
...
class AttributeFieldMapping(proto.Message):
    ...
    Attributes:
        ...
        field_id (int):
            ...
            This field is read-only.
        sitelink_field (google.ads.googleads.v6.enums.types.SitelinkPlaceholderFieldEnum.SitelinkPlaceholderField):
            Immutable. Sitelink Placeholder Fields.
        call_field (google.ads.googleads.v6.enums.types.CallPlaceholderFieldEnum.CallPlaceholderField):
            Immutable. Call Placeholder Fields.
        app_field (google.ads.googleads.v6.enums.types.AppPlaceholderFieldEnum.AppPlaceholderField):
            Immutable. App Placeholder Fields.
        location_field (google.ads.googleads.v6.enums.types.LocationPlaceholderFieldEnum.LocationPlaceholderField):
            Output only. Location Placeholder Fields.
            This field is read-only.
        affiliate_location_field (google.ads.googleads.v6.enums.types.AffiliateLocationPlaceholderFieldEnum.AffiliateLocationPlaceholderField):
            Output only. Affiliate Location Placeholder
            Fields. This field is read-only.
        callout_field (google.ads.googleads.v6.enums.types.CalloutPlaceholderFieldEnum.CalloutPlaceholderField):
            Immutable. Callout Placeholder Fields.
        structured_snippet_field (google.ads.googleads.v6.enums.types.StructuredSnippetPlaceholderFieldEnum.StructuredSnippetPlaceholderField):
            Immutable. Structured Snippet Placeholder
            Fields.
        message_field (google.ads.googleads.v6.enums.types.MessagePlaceholderFieldEnum.MessagePlaceholderField):
            Immutable. Message Placeholder Fields.
        price_field (google.ads.googleads.v6.enums.types.PricePlaceholderFieldEnum.PricePlaceholderField):
            Immutable. Price Placeholder Fields.
        promotion_field (google.ads.googleads.v6.enums.types.PromotionPlaceholderFieldEnum.PromotionPlaceholderField):
            Immutable. Promotion Placeholder Fields.
        ad_customizer_field (google.ads.googleads.v6.enums.types.AdCustomizerPlaceholderFieldEnum.AdCustomizerPlaceholderField):
            Immutable. Ad Customizer Placeholder Fields
        dsa_page_feed_field (google.ads.googleads.v6.enums.types.DsaPageFeedCriterionFieldEnum.DsaPageFeedCriterionField):
            Immutable. Dynamic Search Ad Page Feed
            Fields.
        location_extension_targeting_field (google.ads.googleads.v6.enums.types.LocationExtensionTargetingCriterionFieldEnum.LocationExtensionTargetingCriterionField):
            Immutable. Location Target Fields.
        education_field (google.ads.googleads.v6.enums.types.EducationPlaceholderFieldEnum.EducationPlaceholderField):
            Immutable. Education Placeholder Fields
        flight_field (google.ads.googleads.v6.enums.types.FlightPlaceholderFieldEnum.FlightPlaceholderField):
            Immutable. Flight Placeholder Fields
        custom_field (google.ads.googleads.v6.enums.types.CustomPlaceholderFieldEnum.CustomPlaceholderField):
            Immutable. Custom Placeholder Fields
        hotel_field (google.ads.googleads.v6.enums.types.HotelPlaceholderFieldEnum.HotelPlaceholderField):
            Immutable. Hotel Placeholder Fields
        real_estate_field (google.ads.googleads.v6.enums.types.RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField):
            Immutable. Real Estate Placeholder Fields
        travel_field (google.ads.googleads.v6.enums.types.TravelPlaceholderFieldEnum.TravelPlaceholderField):
            Immutable. Travel Placeholder Fields
        local_field (google.ads.googleads.v6.enums.types.LocalPlaceholderFieldEnum.LocalPlaceholderField):
            Immutable. Local Placeholder Fields
        job_field (google.ads.googleads.v6.enums.types.JobPlaceholderFieldEnum.JobPlaceholderField):
            Immutable. Job Placeholder Fields
        image_field (google.ads.googleads.v6.enums.types.ImagePlaceholderFieldEnum.ImagePlaceholderField):
