 ...
 * `src/v6/dynamic_search_ads_search_term_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './dynamic_search_ads_search_term_view_service_client_config.json';
...
export class DynamicSearchAdsSearchTermViewServiceClient {
  ...
  dynamicSearchAdsSearchTermViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof DynamicSearchAdsSearchTermViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v6.services.DynamicSearchAdsSearchTermViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.dynamicSearchAdsSearchTermViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v6.services.DynamicSearchAdsSearchTermViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v6.services.DynamicSearchAdsSearchTermViewService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const dynamicSearchAdsSearchTermViewServiceStubMethods =
        ['getDynamicSearchAdsSearchTermView'];
    for (const methodName of dynamicSearchAdsSearchTermViewServiceStubMethods) {
      const callPromise = this.dynamicSearchAdsSearchTermViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getDynamicSearchAdsSearchTermView(
      request: protos.google.ads.googleads.v6.services.IGetDynamicSearchAdsSearchTermViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v6.resources.IDynamicSearchAdsSearchTermView,
        protos.google.ads.googleads.v6.services.IGetDynamicSearchAdsSearchTermViewRequest|undefined, {}|undefined
      ]>;
  getDynamicSearchAdsSearchTermView(
      request: protos.google.ads.googleads.v6.services.IGetDynamicSearchAdsSearchTermViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v6.resources.IDynamicSearchAdsSearchTermView,
          protos.google.ads.googleads.v6.services.IGetDynamicSearchAdsSearchTermViewRequest|null|undefined,
          {}|null|undefined>): void;
  getDynamicSearchAdsSearchTermView(
      request: protos.google.ads.googleads.v6.services.IGetDynamicSearchAdsSearchTermViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [DynamicSearchAdsSearchTermView]{@link google.ads.googleads.v6.resources.DynamicSearchAdsSearchTermView}.
 *   Please see the
