 ...
 * `src/v6/change_status_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './change_status_service_client_config.json';
...
export class ChangeStatusServiceClient {
  ...
  changeStatusServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ChangeStatusServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v6.services.ChangeStatusService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.changeStatusServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v6.services.ChangeStatusService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v6.services.ChangeStatusService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const changeStatusServiceStubMethods =
        ['getChangeStatus'];
    for (const methodName of changeStatusServiceStubMethods) {
      const callPromise = this.changeStatusServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getChangeStatus(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v6.services.IGetChangeStatusRequest|undefined, {}|undefined
      ]>;
  getChangeStatus(
      request: protos.google.ads.googleads.v6.services.IGetChangeStatusRequest,
      options: CallOptions,
 ...
 *   The first element of the array is an object representing [ChangeStatus]{@link google.ads.googleads.v6.resources.ChangeStatus}.
 *   Please see the
