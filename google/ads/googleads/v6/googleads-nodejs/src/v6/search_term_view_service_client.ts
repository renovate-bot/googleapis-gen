 ...
 * `src/v6/search_term_view_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './search_term_view_service_client_config.json';
...
export class SearchTermViewServiceClient {
  ...
  searchTermViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof SearchTermViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v6.services.SearchTermViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.searchTermViewServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v6.services.SearchTermViewService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v6.services.SearchTermViewService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const searchTermViewServiceStubMethods =
        ['getSearchTermView'];
    for (const methodName of searchTermViewServiceStubMethods) {
      const callPromise = this.searchTermViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  getSearchTermView(
      request?: protos.google.ads.googleads.v6.services.IGetSearchTermViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v6.resources.ISearchTermView,
        protos.google.ads.googleads.v6.services.IGetSearchTermViewRequest|undefined, {}|undefined
      ]>;
  getSearchTermView(
      request: protos.google.ads.googleads.v6.services.IGetSearchTermViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v6.resources.ISearchTermView,
          protos.google.ads.googleads.v6.services.IGetSearchTermViewRequest|null|undefined,
          {}|null|undefined>): void;
  getSearchTermView(
      request: protos.google.ads.googleads.v6.services.IGetSearchTermViewRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [SearchTermView]{@link google.ads.googleads.v6.resources.SearchTermView}.
 *   Please see the
