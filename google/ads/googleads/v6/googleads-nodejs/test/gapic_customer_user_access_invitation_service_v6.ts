...
describe('v6.CustomerUserAccessInvitationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customeruseraccessinvitationserviceModule.v6.CustomerUserAccessInvitationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customeruseraccessinvitationserviceModule.v6.CustomerUserAccessInvitationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customeruseraccessinvitationserviceModule.v6.CustomerUserAccessInvitationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customeruseraccessinvitationserviceModule.v6.CustomerUserAccessInvitationServiceClient();
        assert(client);
    });
    ...
    describe('getCustomerUserAccessInvitation', () => {
        it('invokes getCustomerUserAccessInvitation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetCustomerUserAccessInvitationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CustomerUserAccessInvitation());
        ...
        it('invokes getCustomerUserAccessInvitation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerUserAccessInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ICustomerUserAccessInvitation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerUserAccessInvitation', () => {
        it('invokes mutateCustomerUserAccessInvitation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationResponse());
        ...
        it('invokes mutateCustomerUserAccessInvitation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerUserAccessInvitation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateCustomerUserAccessInvitationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
