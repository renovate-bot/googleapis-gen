...
import * as mobileappcategoryconstantserviceModule from '../src';
...
describe('v6.MobileAppCategoryConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = mobileappcategoryconstantserviceModule.v6.MobileAppCategoryConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = mobileappcategoryconstantserviceModule.v6.MobileAppCategoryConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = mobileappcategoryconstantserviceModule.v6.MobileAppCategoryConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new mobileappcategoryconstantserviceModule.v6.MobileAppCategoryConstantServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.mobileAppCategoryConstantServiceStub, undefined);
        await client.initialize();
        assert(client.mobileAppCategoryConstantServiceStub);
    });
    ...
    describe('getMobileAppCategoryConstant', () => {
        it('invokes getMobileAppCategoryConstant without error', async () => {
            const client = new mobileappcategoryconstantserviceModule.v6.MobileAppCategoryConstantServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetMobileAppCategoryConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.MobileAppCategoryConstant());
            client.innerApiCalls.getMobileAppCategoryConstant = stubSimpleCall(expectedResponse);
            const [response] = await client.getMobileAppCategoryConstant(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getMobileAppCategoryConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getMobileAppCategoryConstant without error using callback', async () => {
            const client = new mobileappcategoryconstantserviceModule.v6.MobileAppCategoryConstantServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.MobileAppCategoryConstant());
            client.innerApiCalls.getMobileAppCategoryConstant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMobileAppCategoryConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IMobileAppCategoryConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMobileAppCategoryConstant with error', async () => {
            const client = new mobileappcategoryconstantserviceModule.v6.MobileAppCategoryConstantServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getMobileAppCategoryConstant = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getMobileAppCategoryConstant(request), expectedError);
            assert((client.innerApiCalls.getMobileAppCategoryConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
