...
describe('v6.HotelGroupViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = hotelgroupviewserviceModule.v6.HotelGroupViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = hotelgroupviewserviceModule.v6.HotelGroupViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = hotelgroupviewserviceModule.v6.HotelGroupViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new hotelgroupviewserviceModule.v6.HotelGroupViewServiceClient();
        assert(client);
    });
    ...
    describe('getHotelGroupView', () => {
        it('invokes getHotelGroupView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetHotelGroupViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.HotelGroupView());
        ...
        it('invokes getHotelGroupView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getHotelGroupView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IHotelGroupView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
