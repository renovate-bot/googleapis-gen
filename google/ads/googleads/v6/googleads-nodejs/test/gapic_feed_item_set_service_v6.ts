...
import * as feeditemsetserviceModule from '../src';
...
describe('v6.FeedItemSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feeditemsetserviceModule.v6.FeedItemSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feeditemsetserviceModule.v6.FeedItemSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feeditemsetserviceModule.v6.FeedItemSetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feeditemsetserviceModule.v6.FeedItemSetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.feedItemSetServiceStub, undefined);
        await client.initialize();
        assert(client.feedItemSetServiceStub);
    });
    ...
    describe('getFeedItemSet', () => {
        it('invokes getFeedItemSet without error', async () => {
            const client = new feeditemsetserviceModule.v6.FeedItemSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetFeedItemSetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.FeedItemSet());
            client.innerApiCalls.getFeedItemSet = stubSimpleCall(expectedResponse);
            const [response] = await client.getFeedItemSet(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getFeedItemSet as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getFeedItemSet without error using callback', async () => {
            const client = new feeditemsetserviceModule.v6.FeedItemSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.FeedItemSet());
            client.innerApiCalls.getFeedItemSet = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFeedItemSet(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IFeedItemSet|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFeedItemSet with error', async () => {
            const client = new feeditemsetserviceModule.v6.FeedItemSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getFeedItemSet = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getFeedItemSet(request), expectedError);
            assert((client.innerApiCalls.getFeedItemSet as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateFeedItemSets', () => {
        it('invokes mutateFeedItemSets without error', async () => {
            const client = new feeditemsetserviceModule.v6.FeedItemSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateFeedItemSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateFeedItemSetsResponse());
            client.innerApiCalls.mutateFeedItemSets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateFeedItemSets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateFeedItemSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateFeedItemSets without error using callback', async () => {
            const client = new feeditemsetserviceModule.v6.FeedItemSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateFeedItemSetsResponse());
            client.innerApiCalls.mutateFeedItemSets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedItemSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateFeedItemSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateFeedItemSets with error', async () => {
            const client = new feeditemsetserviceModule.v6.FeedItemSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateFeedItemSets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateFeedItemSets(request), expectedError);
            assert((client.innerApiCalls.mutateFeedItemSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
