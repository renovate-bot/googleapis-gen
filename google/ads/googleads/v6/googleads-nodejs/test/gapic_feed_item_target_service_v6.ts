...
describe('v6.FeedItemTargetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feeditemtargetserviceModule.v6.FeedItemTargetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feeditemtargetserviceModule.v6.FeedItemTargetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feeditemtargetserviceModule.v6.FeedItemTargetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feeditemtargetserviceModule.v6.FeedItemTargetServiceClient();
        assert(client);
    });
    ...
    describe('getFeedItemTarget', () => {
        it('invokes getFeedItemTarget without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetFeedItemTargetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.FeedItemTarget());
        ...
        it('invokes getFeedItemTarget without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeedItemTarget(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IFeedItemTarget|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateFeedItemTargets', () => {
        it('invokes mutateFeedItemTargets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateFeedItemTargetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateFeedItemTargetsResponse());
        ...
        it('invokes mutateFeedItemTargets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedItemTargets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateFeedItemTargetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
