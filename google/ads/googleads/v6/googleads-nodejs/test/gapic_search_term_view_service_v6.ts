...
describe('v6.SearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = searchtermviewserviceModule.v6.SearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = searchtermviewserviceModule.v6.SearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = searchtermviewserviceModule.v6.SearchTermViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new searchtermviewserviceModule.v6.SearchTermViewServiceClient();
        assert(client);
    });
    ...
    describe('getSearchTermView', () => {
        it('invokes getSearchTermView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetSearchTermViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.SearchTermView());
        ...
        it('invokes getSearchTermView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ISearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
