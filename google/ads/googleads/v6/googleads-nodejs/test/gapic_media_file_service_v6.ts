...
describe('v6.MediaFileServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = mediafileserviceModule.v6.MediaFileServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = mediafileserviceModule.v6.MediaFileServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = mediafileserviceModule.v6.MediaFileServiceClient.port;
        assert(port);
    ...
    describe('getMediaFile', () => {
        it('invokes getMediaFile without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetMediaFileRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.MediaFile());
        ...
        it('invokes getMediaFile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMediaFile(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IMediaFile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateMediaFiles', () => {
        it('invokes mutateMediaFiles without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateMediaFilesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateMediaFilesResponse());
        ...
        it('invokes mutateMediaFiles without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateMediaFiles(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateMediaFilesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
