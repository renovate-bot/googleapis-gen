...
import * as remarketingactionserviceModule from '../src';
...
describe('v6.RemarketingActionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = remarketingactionserviceModule.v6.RemarketingActionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = remarketingactionserviceModule.v6.RemarketingActionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = remarketingactionserviceModule.v6.RemarketingActionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new remarketingactionserviceModule.v6.RemarketingActionServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.remarketingActionServiceStub);
    });
    ...
    describe('getRemarketingAction', () => {
        it('invokes getRemarketingAction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetRemarketingActionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.RemarketingAction());
            client.innerApiCalls.getRemarketingAction = stubSimpleCall(expectedResponse);
            const [response] = await client.getRemarketingAction(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getRemarketingAction as SinonStub)
        ...
        it('invokes getRemarketingAction without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.RemarketingAction());
            client.innerApiCalls.getRemarketingAction = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getRemarketingAction(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IRemarketingAction|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getRemarketingAction with error', async () => {
            ...
            client.innerApiCalls.getRemarketingAction = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getRemarketingAction(request), expectedError);
            assert((client.innerApiCalls.getRemarketingAction as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateRemarketingActions', () => {
        it('invokes mutateRemarketingActions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateRemarketingActionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateRemarketingActionsResponse());
            client.innerApiCalls.mutateRemarketingActions = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateRemarketingActions(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateRemarketingActions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateRemarketingActions without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateRemarketingActionsResponse());
            client.innerApiCalls.mutateRemarketingActions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateRemarketingActions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateRemarketingActionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateRemarketingActions with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateRemarketingActions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateRemarketingActions(request), expectedError);
            assert((client.innerApiCalls.mutateRemarketingActions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
