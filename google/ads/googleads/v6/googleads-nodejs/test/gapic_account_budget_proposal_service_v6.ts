...
describe('v6.AccountBudgetProposalServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = accountbudgetproposalserviceModule.v6.AccountBudgetProposalServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = accountbudgetproposalserviceModule.v6.AccountBudgetProposalServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = accountbudgetproposalserviceModule.v6.AccountBudgetProposalServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new accountbudgetproposalserviceModule.v6.AccountBudgetProposalServiceClient();
        assert(client);
    });
    ...
    describe('getAccountBudgetProposal', () => {
        it('invokes getAccountBudgetProposal without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetAccountBudgetProposalRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.AccountBudgetProposal());
        ...
        it('invokes getAccountBudgetProposal without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAccountBudgetProposal(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IAccountBudgetProposal|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAccountBudgetProposal', () => {
        it('invokes mutateAccountBudgetProposal without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateAccountBudgetProposalRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateAccountBudgetProposalResponse());
        ...
        it('invokes mutateAccountBudgetProposal without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAccountBudgetProposal(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateAccountBudgetProposalResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
