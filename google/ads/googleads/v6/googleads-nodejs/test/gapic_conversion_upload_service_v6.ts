...
describe('v6.ConversionUploadServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionuploadserviceModule.v6.ConversionUploadServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionuploadserviceModule.v6.ConversionUploadServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionuploadserviceModule.v6.ConversionUploadServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionuploadserviceModule.v6.ConversionUploadServiceClient();
        assert(client);
    });
    ...
    describe('uploadClickConversions', () => {
        it('invokes uploadClickConversions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.UploadClickConversionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.UploadClickConversionsResponse());
        ...
        it('invokes uploadClickConversions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.uploadClickConversions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IUploadClickConversionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('uploadCallConversions', () => {
        it('invokes uploadCallConversions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.UploadCallConversionsRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.UploadCallConversionsResponse());
        ...
        it('invokes uploadCallConversions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.uploadCallConversions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IUploadCallConversionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
