...
import * as campaigndraftserviceModule from '../src';
...
describe('v6.CampaignDraftServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaigndraftserviceModule.v6.CampaignDraftServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaigndraftserviceModule.v6.CampaignDraftServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaigndraftserviceModule.v6.CampaignDraftServiceClient.port;
        assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.campaignDraftServiceStub);
    });
    ...
    describe('getCampaignDraft', () => {
        it('invokes getCampaignDraft without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetCampaignDraftRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CampaignDraft());
            client.innerApiCalls.getCampaignDraft = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignDraft(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignDraft as SinonStub)
        ...
        it('invokes getCampaignDraft without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CampaignDraft());
            client.innerApiCalls.getCampaignDraft = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignDraft(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ICampaignDraft|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignDraft with error', async () => {
            ...
            client.innerApiCalls.getCampaignDraft = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignDraft(request), expectedError);
            assert((client.innerApiCalls.getCampaignDraft as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('mutateCampaignDrafts', () => {
        it('invokes mutateCampaignDrafts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCampaignDraftsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCampaignDraftsResponse());
            client.innerApiCalls.mutateCampaignDrafts = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignDrafts(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaignDrafts as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateCampaignDrafts without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCampaignDraftsResponse());
            client.innerApiCalls.mutateCampaignDrafts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignDrafts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateCampaignDraftsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignDrafts with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCampaignDrafts = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignDrafts(request), expectedError);
            assert((client.innerApiCalls.mutateCampaignDrafts as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('promoteCampaignDraft', () => {
        it('invokes promoteCampaignDraft without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.PromoteCampaignDraftRequest());
            request.campaignDraft = '';
            const expectedHeaderRequestParams = "campaign_draft=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
            ...
            client.innerApiCalls.promoteCampaignDraft = stubLongRunningCall(expectedResponse);
            const [operation] = await client.promoteCampaignDraft(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.promoteCampaignDraft as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes promoteCampaignDraft without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.promoteCampaignDraft = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.promoteCampaignDraft(
                    request,
                    (err?: Error|null,
        ...
        it('invokes promoteCampaignDraft with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.promoteCampaignDraft = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.promoteCampaignDraft(request), expectedError);
            assert((client.innerApiCalls.promoteCampaignDraft as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes promoteCampaignDraft with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.promoteCampaignDraft = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.promoteCampaignDraft(request);
        ...
        it('invokes checkPromoteCampaignDraftProgress without error', async () => {
            ...
            const decodedOperation = await client.checkPromoteCampaignDraftProgress(expectedResponse.name);
        ...
        it('invokes checkPromoteCampaignDraftProgress with error', async () => {
            ...
            await assert.rejects(client.checkPromoteCampaignDraftProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listCampaignDraftAsyncErrors', () => {
        it('invokes listCampaignDraftAsyncErrors without error', async () => {
            const client = new campaigndraftserviceModule.v6.CampaignDraftServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.ListCampaignDraftAsyncErrorsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            client.innerApiCalls.listCampaignDraftAsyncErrors = stubSimpleCall(expectedResponse);
            const [response] = await client.listCampaignDraftAsyncErrors(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listCampaignDraftAsyncErrors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listCampaignDraftAsyncErrors without error using callback', async () => {
            const client = new campaigndraftserviceModule.v6.CampaignDraftServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listCampaignDraftAsyncErrors = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listCampaignDraftAsyncErrors(
                    request,
        ...
        it('invokes listCampaignDraftAsyncErrors with error', async () => {
            const client = new campaigndraftserviceModule.v6.CampaignDraftServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listCampaignDraftAsyncErrors = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listCampaignDraftAsyncErrors(request), expectedError);
            assert((client.innerApiCalls.listCampaignDraftAsyncErrors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listCampaignDraftAsyncErrorsStream without error', async () => {
            const client = new campaigndraftserviceModule.v6.CampaignDraftServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listCampaignDraftAsyncErrors.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCampaignDraftAsyncErrorsStream(request);
            const promise = new Promise((resolve, reject) => {
            ...
            assert((client.descriptors.page.listCampaignDraftAsyncErrors.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCampaignDraftAsyncErrors, request));
            assert.strictEqual(
                (client.descriptors.page.listCampaignDraftAsyncErrors.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });

        it('invokes listCampaignDraftAsyncErrorsStream with error', async () => {
            const client = new campaigndraftserviceModule.v6.CampaignDraftServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = "resource_name=";
            const expectedError = new Error('expected');
            client.descriptors.page.listCampaignDraftAsyncErrors.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCampaignDraftAsyncErrorsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.rpc.Status[] = [];
                stream.on('data', (response: protos.google.rpc.Status) => {
        ...
        it('uses async iteration with listCampaignDraftAsyncErrors without error', async () => {
            ...
            client.descriptors.page.listCampaignDraftAsyncErrors.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listCampaignDraftAsyncErrors.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listCampaignDraftAsyncErrors with error', async () => {
            const client = new campaigndraftserviceModule.v6.CampaignDraftServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listCampaignDraftAsyncErrors.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCampaignDraftAsyncErrorsAsync(request);
