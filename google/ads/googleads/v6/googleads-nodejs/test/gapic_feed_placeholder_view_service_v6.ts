...
import * as feedplaceholderviewserviceModule from '../src';
...
describe('v6.FeedPlaceholderViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feedplaceholderviewserviceModule.v6.FeedPlaceholderViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feedplaceholderviewserviceModule.v6.FeedPlaceholderViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feedplaceholderviewserviceModule.v6.FeedPlaceholderViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feedplaceholderviewserviceModule.v6.FeedPlaceholderViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.feedPlaceholderViewServiceStub, undefined);
        await client.initialize();
        assert(client.feedPlaceholderViewServiceStub);
    });
    ...
    describe('getFeedPlaceholderView', () => {
        it('invokes getFeedPlaceholderView without error', async () => {
            const client = new feedplaceholderviewserviceModule.v6.FeedPlaceholderViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetFeedPlaceholderViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.FeedPlaceholderView());
            client.innerApiCalls.getFeedPlaceholderView = stubSimpleCall(expectedResponse);
            const [response] = await client.getFeedPlaceholderView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getFeedPlaceholderView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getFeedPlaceholderView without error using callback', async () => {
            const client = new feedplaceholderviewserviceModule.v6.FeedPlaceholderViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.FeedPlaceholderView());
            client.innerApiCalls.getFeedPlaceholderView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFeedPlaceholderView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IFeedPlaceholderView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFeedPlaceholderView with error', async () => {
            const client = new feedplaceholderviewserviceModule.v6.FeedPlaceholderViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getFeedPlaceholderView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getFeedPlaceholderView(request), expectedError);
            assert((client.innerApiCalls.getFeedPlaceholderView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
