...
describe('v6.CampaignAudienceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignaudienceviewserviceModule.v6.CampaignAudienceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignaudienceviewserviceModule.v6.CampaignAudienceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignaudienceviewserviceModule.v6.CampaignAudienceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignaudienceviewserviceModule.v6.CampaignAudienceViewServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignAudienceView', () => {
        it('invokes getCampaignAudienceView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetCampaignAudienceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CampaignAudienceView());
        ...
        it('invokes getCampaignAudienceView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignAudienceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ICampaignAudienceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
