...
describe('v6.CustomerUserAccessServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customeruseraccessserviceModule.v6.CustomerUserAccessServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customeruseraccessserviceModule.v6.CustomerUserAccessServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customeruseraccessserviceModule.v6.CustomerUserAccessServiceClient.port;
        assert(port);
    ...
    describe('getCustomerUserAccess', () => {
        it('invokes getCustomerUserAccess without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetCustomerUserAccessRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CustomerUserAccess());
        ...
        it('invokes getCustomerUserAccess without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerUserAccess(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ICustomerUserAccess|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomerUserAccess', () => {
        it('invokes mutateCustomerUserAccess without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCustomerUserAccessRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCustomerUserAccessResponse());
        ...
        it('invokes mutateCustomerUserAccess without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerUserAccess(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateCustomerUserAccessResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
