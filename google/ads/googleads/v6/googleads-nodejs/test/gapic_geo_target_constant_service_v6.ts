...
import * as geotargetconstantserviceModule from '../src';
...
describe('v6.GeoTargetConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = geotargetconstantserviceModule.v6.GeoTargetConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = geotargetconstantserviceModule.v6.GeoTargetConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = geotargetconstantserviceModule.v6.GeoTargetConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new geotargetconstantserviceModule.v6.GeoTargetConstantServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.geoTargetConstantServiceStub, undefined);
        await client.initialize();
        assert(client.geoTargetConstantServiceStub);
    });
    ...
    describe('getGeoTargetConstant', () => {
        it('invokes getGeoTargetConstant without error', async () => {
            const client = new geotargetconstantserviceModule.v6.GeoTargetConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetGeoTargetConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.GeoTargetConstant());
            client.innerApiCalls.getGeoTargetConstant = stubSimpleCall(expectedResponse);
            const [response] = await client.getGeoTargetConstant(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getGeoTargetConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getGeoTargetConstant without error using callback', async () => {
            const client = new geotargetconstantserviceModule.v6.GeoTargetConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.GeoTargetConstant());
            client.innerApiCalls.getGeoTargetConstant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGeoTargetConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IGeoTargetConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGeoTargetConstant with error', async () => {
            const client = new geotargetconstantserviceModule.v6.GeoTargetConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getGeoTargetConstant = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getGeoTargetConstant(request), expectedError);
            assert((client.innerApiCalls.getGeoTargetConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('suggestGeoTargetConstants', () => {
        it('invokes suggestGeoTargetConstants without error', async () => {
            const client = new geotargetconstantserviceModule.v6.GeoTargetConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.SuggestGeoTargetConstantsRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.SuggestGeoTargetConstantsResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.suggestGeoTargetConstants as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes suggestGeoTargetConstants without error using callback', async () => {
            const client = new geotargetconstantserviceModule.v6.GeoTargetConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestGeoTargetConstants(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.ISuggestGeoTargetConstantsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestGeoTargetConstants with error', async () => {
            const client = new geotargetconstantserviceModule.v6.GeoTargetConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
