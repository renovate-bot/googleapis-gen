...
describe('v6.AdScheduleViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adscheduleviewserviceModule.v6.AdScheduleViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adscheduleviewserviceModule.v6.AdScheduleViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adscheduleviewserviceModule.v6.AdScheduleViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adscheduleviewserviceModule.v6.AdScheduleViewServiceClient();
        assert(client);
    });
    ...
    describe('getAdScheduleView', () => {
        it('invokes getAdScheduleView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetAdScheduleViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.AdScheduleView());
        ...
        it('invokes getAdScheduleView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdScheduleView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IAdScheduleView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
