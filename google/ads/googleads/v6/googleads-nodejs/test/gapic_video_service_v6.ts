...
describe('v6.VideoServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = videoserviceModule.v6.VideoServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = videoserviceModule.v6.VideoServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = videoserviceModule.v6.VideoServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new videoserviceModule.v6.VideoServiceClient();
        assert(client);
    });
    ...
    describe('getVideo', () => {
        it('invokes getVideo without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetVideoRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.Video());
        ...
        it('invokes getVideo without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getVideo(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IVideo|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
