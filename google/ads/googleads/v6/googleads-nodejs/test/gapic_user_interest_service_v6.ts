...
describe('v6.UserInterestServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = userinterestserviceModule.v6.UserInterestServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = userinterestserviceModule.v6.UserInterestServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = userinterestserviceModule.v6.UserInterestServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new userinterestserviceModule.v6.UserInterestServiceClient();
        assert(client);
    });
    ...
    describe('getUserInterest', () => {
        it('invokes getUserInterest without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetUserInterestRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.UserInterest());
        ...
        it('invokes getUserInterest without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getUserInterest(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IUserInterest|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
