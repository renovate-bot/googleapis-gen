...
import * as paidorganicsearchtermviewserviceModule from '../src';
...
describe('v6.PaidOrganicSearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = paidorganicsearchtermviewserviceModule.v6.PaidOrganicSearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = paidorganicsearchtermviewserviceModule.v6.PaidOrganicSearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = paidorganicsearchtermviewserviceModule.v6.PaidOrganicSearchTermViewServiceClient.port;
        assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.paidOrganicSearchTermViewServiceStub);
    });
    ...
    describe('getPaidOrganicSearchTermView', () => {
        it('invokes getPaidOrganicSearchTermView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetPaidOrganicSearchTermViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.PaidOrganicSearchTermView());
            client.innerApiCalls.getPaidOrganicSearchTermView = stubSimpleCall(expectedResponse);
            const [response] = await client.getPaidOrganicSearchTermView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getPaidOrganicSearchTermView as SinonStub)
        ...
        it('invokes getPaidOrganicSearchTermView without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.PaidOrganicSearchTermView());
            client.innerApiCalls.getPaidOrganicSearchTermView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPaidOrganicSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IPaidOrganicSearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getPaidOrganicSearchTermView with error', async () => {
            ...
            client.innerApiCalls.getPaidOrganicSearchTermView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getPaidOrganicSearchTermView(request), expectedError);
            assert((client.innerApiCalls.getPaidOrganicSearchTermView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
