...
describe('v6.CampaignAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignassetserviceModule.v6.CampaignAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignassetserviceModule.v6.CampaignAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignassetserviceModule.v6.CampaignAssetServiceClient.port;
        assert(port);
    ...
    describe('getCampaignAsset', () => {
        it('invokes getCampaignAsset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetCampaignAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CampaignAsset());
        ...
        it('invokes getCampaignAsset without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ICampaignAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignAssets', () => {
        it('invokes mutateCampaignAssets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCampaignAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCampaignAssetsResponse());
        ...
        it('invokes mutateCampaignAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateCampaignAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
