...
import * as customerserviceModule from '../src';
...
describe('v6.CustomerServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerserviceModule.v6.CustomerServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerserviceModule.v6.CustomerServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerserviceModule.v6.CustomerServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerserviceModule.v6.CustomerServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.customerServiceStub);
    });
    ...
    describe('getCustomer', () => {
        it('invokes getCustomer without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetCustomerRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.Customer());
        ...
        it('invokes getCustomer without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomer(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ICustomer|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomer', () => {
        it('invokes mutateCustomer without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCustomerRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCustomerResponse());
            client.innerApiCalls.mutateCustomer = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomer(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomer as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes mutateCustomer without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateCustomerResponse());
            client.innerApiCalls.mutateCustomer = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomer(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateCustomerResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomer with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCustomer = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomer(request), expectedError);
            assert((client.innerApiCalls.mutateCustomer as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listAccessibleCustomers', () => {
        it('invokes listAccessibleCustomers without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.ListAccessibleCustomersRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.ListAccessibleCustomersResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAccessibleCustomers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listAccessibleCustomers without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listAccessibleCustomers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IListAccessibleCustomersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCustomerClient', () => {
        it('invokes createCustomerClient without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.CreateCustomerClientRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.CreateCustomerClientResponse());
            client.innerApiCalls.createCustomerClient = stubSimpleCall(expectedResponse);
            const [response] = await client.createCustomerClient(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createCustomerClient as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createCustomerClient without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.CreateCustomerClientResponse());
            client.innerApiCalls.createCustomerClient = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCustomerClient(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.ICreateCustomerClientResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createCustomerClient with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createCustomerClient = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createCustomerClient(request), expectedError);
            assert((client.innerApiCalls.createCustomerClient as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
