...
import * as adgroupcriterionserviceModule from '../src';
...
describe('v6.AdGroupCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupcriterionserviceModule.v6.AdGroupCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupcriterionserviceModule.v6.AdGroupCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupcriterionserviceModule.v6.AdGroupCriterionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupcriterionserviceModule.v6.AdGroupCriterionServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupCriterionServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupCriterionServiceStub);
    });
    ...
    describe('getAdGroupCriterion', () => {
        it('invokes getAdGroupCriterion without error', async () => {
            const client = new adgroupcriterionserviceModule.v6.AdGroupCriterionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetAdGroupCriterionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.AdGroupCriterion());
            client.innerApiCalls.getAdGroupCriterion = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupCriterion(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupCriterion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupCriterion without error using callback', async () => {
            const client = new adgroupcriterionserviceModule.v6.AdGroupCriterionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.AdGroupCriterion());
            client.innerApiCalls.getAdGroupCriterion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IAdGroupCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupCriterion with error', async () => {
            const client = new adgroupcriterionserviceModule.v6.AdGroupCriterionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getAdGroupCriterion = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupCriterion(request), expectedError);
            assert((client.innerApiCalls.getAdGroupCriterion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAdGroupCriteria', () => {
        it('invokes mutateAdGroupCriteria without error', async () => {
            const client = new adgroupcriterionserviceModule.v6.AdGroupCriterionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateAdGroupCriteriaRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateAdGroupCriteriaResponse());
            client.innerApiCalls.mutateAdGroupCriteria = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupCriteria(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupCriteria as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroupCriteria without error using callback', async () => {
            const client = new adgroupcriterionserviceModule.v6.AdGroupCriterionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateAdGroupCriteriaResponse());
            client.innerApiCalls.mutateAdGroupCriteria = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateAdGroupCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupCriteria with error', async () => {
            const client = new adgroupcriterionserviceModule.v6.AdGroupCriterionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdGroupCriteria = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupCriteria(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupCriteria as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
