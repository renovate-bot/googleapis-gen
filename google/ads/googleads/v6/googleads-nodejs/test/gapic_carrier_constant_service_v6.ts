...
describe('v6.CarrierConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = carrierconstantserviceModule.v6.CarrierConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = carrierconstantserviceModule.v6.CarrierConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = carrierconstantserviceModule.v6.CarrierConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new carrierconstantserviceModule.v6.CarrierConstantServiceClient();
        assert(client);
    });
    ...
    describe('getCarrierConstant', () => {
        it('invokes getCarrierConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetCarrierConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CarrierConstant());
        ...
        it('invokes getCarrierConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCarrierConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ICarrierConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
