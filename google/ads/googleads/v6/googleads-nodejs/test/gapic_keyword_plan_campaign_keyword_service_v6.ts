...
import * as keywordplancampaignkeywordserviceModule from '../src';
...
describe('v6.KeywordPlanCampaignKeywordServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplancampaignkeywordserviceModule.v6.KeywordPlanCampaignKeywordServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplancampaignkeywordserviceModule.v6.KeywordPlanCampaignKeywordServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplancampaignkeywordserviceModule.v6.KeywordPlanCampaignKeywordServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplancampaignkeywordserviceModule.v6.KeywordPlanCampaignKeywordServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.keywordPlanCampaignKeywordServiceStub, undefined);
        await client.initialize();
        assert(client.keywordPlanCampaignKeywordServiceStub);
    });
    ...
    describe('getKeywordPlanCampaignKeyword', () => {
        it('invokes getKeywordPlanCampaignKeyword without error', async () => {
            const client = new keywordplancampaignkeywordserviceModule.v6.KeywordPlanCampaignKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetKeywordPlanCampaignKeywordRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword());
            client.innerApiCalls.getKeywordPlanCampaignKeyword = stubSimpleCall(expectedResponse);
            const [response] = await client.getKeywordPlanCampaignKeyword(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getKeywordPlanCampaignKeyword as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getKeywordPlanCampaignKeyword without error using callback', async () => {
            const client = new keywordplancampaignkeywordserviceModule.v6.KeywordPlanCampaignKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.KeywordPlanCampaignKeyword());
            client.innerApiCalls.getKeywordPlanCampaignKeyword = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanCampaignKeyword(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IKeywordPlanCampaignKeyword|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getKeywordPlanCampaignKeyword with error', async () => {
            const client = new keywordplancampaignkeywordserviceModule.v6.KeywordPlanCampaignKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getKeywordPlanCampaignKeyword = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getKeywordPlanCampaignKeyword(request), expectedError);
            assert((client.innerApiCalls.getKeywordPlanCampaignKeyword as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateKeywordPlanCampaignKeywords', () => {
        it('invokes mutateKeywordPlanCampaignKeywords without error', async () => {
            const client = new keywordplancampaignkeywordserviceModule.v6.KeywordPlanCampaignKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse());
            client.innerApiCalls.mutateKeywordPlanCampaignKeywords = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateKeywordPlanCampaignKeywords(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateKeywordPlanCampaignKeywords as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateKeywordPlanCampaignKeywords without error using callback', async () => {
            const client = new keywordplancampaignkeywordserviceModule.v6.KeywordPlanCampaignKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateKeywordPlanCampaignKeywordsResponse());
            client.innerApiCalls.mutateKeywordPlanCampaignKeywords = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanCampaignKeywords(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateKeywordPlanCampaignKeywordsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateKeywordPlanCampaignKeywords with error', async () => {
            const client = new keywordplancampaignkeywordserviceModule.v6.KeywordPlanCampaignKeywordServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateKeywordPlanCampaignKeywords = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateKeywordPlanCampaignKeywords(request), expectedError);
            assert((client.innerApiCalls.mutateKeywordPlanCampaignKeywords as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
