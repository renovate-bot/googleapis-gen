...
describe('v6.ChangeStatusServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = changestatusserviceModule.v6.ChangeStatusServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = changestatusserviceModule.v6.ChangeStatusServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = changestatusserviceModule.v6.ChangeStatusServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new changestatusserviceModule.v6.ChangeStatusServiceClient();
        assert(client);
    });
    ...
    describe('getChangeStatus', () => {
        it('invokes getChangeStatus without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetChangeStatusRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.ChangeStatus());
        ...
        it('invokes getChangeStatus without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getChangeStatus(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IChangeStatus|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
