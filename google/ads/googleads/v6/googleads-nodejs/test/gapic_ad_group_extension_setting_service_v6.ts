...
describe('v6.AdGroupExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupextensionsettingserviceModule.v6.AdGroupExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupextensionsettingserviceModule.v6.AdGroupExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupextensionsettingserviceModule.v6.AdGroupExtensionSettingServiceClient.port;
        assert(port);
    ...
    describe('getAdGroupExtensionSetting', () => {
        it('invokes getAdGroupExtensionSetting without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetAdGroupExtensionSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.AdGroupExtensionSetting());
        ...
        it('invokes getAdGroupExtensionSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IAdGroupExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupExtensionSettings', () => {
        it('invokes mutateAdGroupExtensionSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateAdGroupExtensionSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.services.MutateAdGroupExtensionSettingsResponse());
        ...
        it('invokes mutateAdGroupExtensionSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.services.IMutateAdGroupExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
