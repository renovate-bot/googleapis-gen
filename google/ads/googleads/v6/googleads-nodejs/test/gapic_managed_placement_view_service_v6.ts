...
describe('v6.ManagedPlacementViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = managedplacementviewserviceModule.v6.ManagedPlacementViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = managedplacementviewserviceModule.v6.ManagedPlacementViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = managedplacementviewserviceModule.v6.ManagedPlacementViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new managedplacementviewserviceModule.v6.ManagedPlacementViewServiceClient();
        assert(client);
    });
    ...
    describe('getManagedPlacementView', () => {
        it('invokes getManagedPlacementView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetManagedPlacementViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.ManagedPlacementView());
        ...
        it('invokes getManagedPlacementView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getManagedPlacementView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.IManagedPlacementView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
