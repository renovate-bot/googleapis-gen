...
import * as combinedaudienceserviceModule from '../src';
...
describe('v6.CombinedAudienceServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = combinedaudienceserviceModule.v6.CombinedAudienceServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = combinedaudienceserviceModule.v6.CombinedAudienceServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = combinedaudienceserviceModule.v6.CombinedAudienceServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new combinedaudienceserviceModule.v6.CombinedAudienceServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.combinedAudienceServiceStub, undefined);
        await client.initialize();
        assert(client.combinedAudienceServiceStub);
    });
    ...
    describe('getCombinedAudience', () => {
        it('invokes getCombinedAudience without error', async () => {
            const client = new combinedaudienceserviceModule.v6.CombinedAudienceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v6.services.GetCombinedAudienceRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CombinedAudience());
            client.innerApiCalls.getCombinedAudience = stubSimpleCall(expectedResponse);
            const [response] = await client.getCombinedAudience(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCombinedAudience as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCombinedAudience without error using callback', async () => {
            const client = new combinedaudienceserviceModule.v6.CombinedAudienceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v6.resources.CombinedAudience());
            client.innerApiCalls.getCombinedAudience = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCombinedAudience(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v6.resources.ICombinedAudience|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCombinedAudience with error', async () => {
            const client = new combinedaudienceserviceModule.v6.CombinedAudienceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCombinedAudience = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCombinedAudience(request), expectedError);
            assert((client.innerApiCalls.getCombinedAudience as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
