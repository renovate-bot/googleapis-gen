...
namespace Google.Ads.GoogleAds.V6.Resources
{
    ...
    public sealed partial class LocationViewName : gax::IResourceName, sys::IEquatable<LocationViewName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer_id}/locationViews/{campaign_id}~{criterion_id}</c>.
            /// </summary>
            CustomerCampaignCriterion = 1,
        }

        private static gax::PathTemplate s_customerCampaignCriterion = new gax::PathTemplate("customers/{customer_id}/locationViews/{campaign_id_criterion_id}");
        ...
        /// <c>customers/{customer_id}/locationViews/{campaign_id}~{criterion_id}</c>.
        /// </summary>
        ...
        public static LocationViewName FromCustomerCampaignCriterion(string customerId, string campaignId, string criterionId) =>
            new LocationViewName(ResourceNameType.CustomerCampaignCriterion, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), campaignId: gax::GaxPreconditions.CheckNotNullOrEmpty(campaignId, nameof(campaignId)), criterionId: gax::GaxPreconditions.CheckNotNullOrEmpty(criterionId, nameof(criterionId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>customers/{customer_id}/locationViews/{campaign_id}~{criterion_id}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string locationViewName, bool allowUnparsed, out LocationViewName result)
        {
            ...
            if (s_customerCampaignCriterion.TryParseName(locationViewName, out resourceName))
            {
        ...
        private LocationViewName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string campaignId = null, string criterionId = null, string customerId = null)
        {
            Type = type;
        ...
        /// <param name="campaignId">The <c>Campaign</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="criterionId">The <c>Criterion</c> ID. Must not be <c>null</c> or empty.</param>
        public LocationViewName(string customerId, string campaignId, string criterionId) : this(ResourceNameType.CustomerCampaignCriterion, customerId: gax::GaxPreconditions.CheckNotNullOrEmpty(customerId, nameof(customerId)), campaignId: gax::GaxPreconditions.CheckNotNullOrEmpty(campaignId, nameof(campaignId)), criterionId: gax::GaxPreconditions.CheckNotNullOrEmpty(criterionId, nameof(criterionId)))
        {
        }
    ...
    public partial class LocationView
    {
        ...
        /// </summary>
        public LocationViewName ResourceNameAsLocationViewName
        {
