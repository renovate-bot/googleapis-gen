...
namespace Google.Ads.GoogleAds.V6.Resources
{
    ...
    public sealed partial class KeywordPlanAdGroupName : gax::IResourceName, sys::IEquatable<KeywordPlanAdGroupName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer_id}/keywordPlanAdGroups/{keyword_plan_ad_group_id}</c>
            /// .
            /// </summary>
            CustomerKeywordPlanAdGroup = 1,
        }

        private static gax::PathTemplate s_customerKeywordPlanAdGroup = new gax::PathTemplate("customers/{customer_id}/keywordPlanAdGroups/{keyword_plan_ad_group_id}");
        ...
        /// <c>customers/{customer_id}/keywordPlanAdGroups/{keyword_plan_ad_group_id}</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>customers/{customer_id}/keywordPlanAdGroups/{keyword_plan_ad_group_id}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        /// pattern <c>customers/{customer_id}/keywordPlanAdGroups/{keyword_plan_ad_group_id}</c>
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="keywordPlanAdGroupId">
        /// The <c>KeywordPlanAdGroup</c> ID. Must not be <c>null</c> or empty.
    ...
    public partial class KeywordPlanAdGroup
    {
        ...
        /// property.
        /// </summary>
        public KeywordPlanCampaignName KeywordPlanCampaignAsKeywordPlanCampaignName
        {
