...
namespace Google.Ads.GoogleAds.V6.Resources
{
    ...
    public sealed partial class CustomInterestName : gax::IResourceName, sys::IEquatable<CustomInterestName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>customers/{customer_id}/customInterests/{custom_interest_id}</c>.
            /// </summary>
            CustomerCustomInterest = 1,
        }

        private static gax::PathTemplate s_customerCustomInterest = new gax::PathTemplate("customers/{customer_id}/customInterests/{custom_interest_id}");
        ...
        /// <c>customers/{customer_id}/customInterests/{custom_interest_id}</c>.
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer_id}/customInterests/{custom_interest_id}</c></description></item>
        /// </list>
        /// </remarks>
