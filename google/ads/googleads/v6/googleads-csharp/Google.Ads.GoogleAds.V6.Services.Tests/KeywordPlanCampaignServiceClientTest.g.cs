...
namespace Google.Ads.GoogleAds.V6.Services.Tests
{
    ...
    public sealed class GeneratedKeywordPlanCampaignServiceClientTest
    {
        ...
        public void GetKeywordPlanCampaignRequestObject()
        {
            ...
            {
                ResourceNameAsKeywordPlanCampaignName = gagvr::KeywordPlanCampaignName.FromCustomerKeywordPlanCampaign("[CUSTOMER_ID]", "[KEYWORD_PLAN_CAMPAIGN_ID]"),
            };
            gagvr::KeywordPlanCampaign expectedResponse = new gagvr::KeywordPlanCampaign
            {
                ...
                KeywordPlanCampaignName = gagvr::KeywordPlanCampaignName.FromCustomerKeywordPlanCampaign("[CUSTOMER_ID]", "[KEYWORD_PLAN_CAMPAIGN_ID]"),
                LanguageConstantsAsLanguageConstantNames =
                {
                    gagvr::LanguageConstantName.FromCriterion("[CRITERION_ID]"),
                },
