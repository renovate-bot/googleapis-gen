...
namespace Google.Ads.GoogleAds.V6.Services.Tests
{
    ...
    public sealed class GeneratedCampaignDraftServiceClientTest
    {
        ...
        public void GetCampaignDraftRequestObject()
        {
            ...
            {
                ResourceNameAsCampaignDraftName = gagvr::CampaignDraftName.FromCustomerBaseCampaignDraft("[CUSTOMER_ID]", "[BASE_CAMPAIGN_ID]", "[DRAFT_ID]"),
            };
            gagvr::CampaignDraft expectedResponse = new gagvr::CampaignDraft
            {
                ...
                CampaignDraftName = gagvr::CampaignDraftName.FromCustomerBaseCampaignDraft("[CUSTOMER_ID]", "[BASE_CAMPAIGN_ID]", "[DRAFT_ID]"),
                DraftCampaignAsCampaignName = gagvr::CampaignName.FromCustomerCampaign("[CUSTOMER_ID]", "[CAMPAIGN_ID]"),
