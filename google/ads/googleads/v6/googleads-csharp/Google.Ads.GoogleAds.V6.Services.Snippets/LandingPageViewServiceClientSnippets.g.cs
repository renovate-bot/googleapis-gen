...
namespace Google.Ads.GoogleAds.V6.Services.Snippets
{
    ...
    public sealed class GeneratedLandingPageViewServiceClientSnippets
    {
        ...
        public void GetLandingPageViewRequestObject()
        {
            ...
            {
                ResourceNameAsLandingPageViewName = LandingPageViewName.FromCustomerUnexpandedFinalUrlFingerprint("[CUSTOMER_ID]", "[UNEXPANDED_FINAL_URL_FINGERPRINT]"),
            };
            // Make the request
        ...
        public void GetLandingPageView()
        {
            ...
            LandingPageViewServiceClient landingPageViewServiceClient = LandingPageViewServiceClient.Create();
            // Initialize request argument(s)
            string resourceName = "customers/[CUSTOMER_ID]/landingPageViews/[UNEXPANDED_FINAL_URL_FINGERPRINT]";
            // Make the request
        ...
        public void GetLandingPageViewResourceNames()
        {
            ...
            LandingPageViewServiceClient landingPageViewServiceClient = LandingPageViewServiceClient.Create();
            // Initialize request argument(s)
            LandingPageViewName resourceName = LandingPageViewName.FromCustomerUnexpandedFinalUrlFingerprint("[CUSTOMER_ID]", "[UNEXPANDED_FINAL_URL_FINGERPRINT]");
            // Make the request
            LandingPageView response = landingPageViewServiceClient.GetLandingPageView(resourceName);
            // End snippet
        }
