...
namespace Google.Ads.GoogleAds.V6.Services.Snippets
{
    ...
    public sealed class GeneratedIncomeRangeViewServiceClientSnippets
    {
        ...
        public void GetIncomeRangeViewRequestObject()
        {
            ...
            {
                ResourceNameAsIncomeRangeViewName = IncomeRangeViewName.FromCustomerAdGroupCriterion("[CUSTOMER_ID]", "[AD_GROUP_ID]", "[CRITERION_ID]"),
            };
            // Make the request
        ...
        public void GetIncomeRangeView()
        {
            ...
            IncomeRangeViewServiceClient incomeRangeViewServiceClient = IncomeRangeViewServiceClient.Create();
            // Initialize request argument(s)
            string resourceName = "customers/[CUSTOMER_ID]/incomeRangeViews/[AD_GROUP_ID]~[CRITERION_ID]";
            // Make the request
        ...
        public void GetIncomeRangeViewResourceNames()
        {
            ...
            IncomeRangeViewServiceClient incomeRangeViewServiceClient = IncomeRangeViewServiceClient.Create();
            // Initialize request argument(s)
            IncomeRangeViewName resourceName = IncomeRangeViewName.FromCustomerAdGroupCriterion("[CUSTOMER_ID]", "[AD_GROUP_ID]", "[CRITERION_ID]");
            // Make the request
            IncomeRangeView response = incomeRangeViewServiceClient.GetIncomeRangeView(resourceName);
            // End snippet
        }
