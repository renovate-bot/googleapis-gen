...
namespace Google.Ads.GoogleAds.V6.Services.Snippets
{
    ...
    public sealed class GeneratedAdGroupAdLabelServiceClientSnippets
    {
        ...
        public void GetAdGroupAdLabelRequestObject()
        {
            ...
            {
                ResourceNameAsAdGroupAdLabelName = AdGroupAdLabelName.FromCustomerAdGroupAdLabel("[CUSTOMER_ID]", "[AD_GROUP_ID]", "[AD_ID]", "[LABEL_ID]"),
            };
            // Make the request
        ...
        public void GetAdGroupAdLabel()
        {
            ...
            AdGroupAdLabelServiceClient adGroupAdLabelServiceClient = AdGroupAdLabelServiceClient.Create();
            // Initialize request argument(s)
            string resourceName = "customers/[CUSTOMER_ID]/adGroupAdLabels/[AD_GROUP_ID]~[AD_ID]~[LABEL_ID]";
            // Make the request
