...
namespace Google.Ads.GoogleAds.V8.Services
{
    ...
    public sealed partial class ParentalStatusViewServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetParentalStatusViewSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(3600000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(5000), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable, grpccore::StatusCode.DeadlineExceeded)));
    ...
    /// endpoint etc.
    /// </summary>
    public sealed partial class ParentalStatusViewServiceClientBuilder : gaxgrpc::ClientBuilderBase<ParentalStatusViewServiceClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public ParentalStatusViewServiceSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public ParentalStatusViewServiceClientBuilder()
        {
            UseJwtAccessWithScopes = ParentalStatusViewServiceClient.UseJwtAccessWithScopes;
        }
