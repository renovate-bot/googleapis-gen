...
namespace Google.Ads.GoogleAds.V8.Services.Tests
{
    ...
    public sealed class GeneratedMediaFileServiceClientTest
    {
        ...
        public void GetMediaFileRequestObject()
        {
            ...
            {
                ResourceNameAsMediaFileName = gagvr::MediaFileName.FromCustomerMediaFile("[CUSTOMER_ID]", "[MEDIA_FILE_ID]"),
            };
            gagvr::MediaFile expectedResponse = new gagvr::MediaFile
            {
                ...
                MediaFileName = gagvr::MediaFileName.FromCustomerMediaFile("[CUSTOMER_ID]", "[MEDIA_FILE_ID]"),
