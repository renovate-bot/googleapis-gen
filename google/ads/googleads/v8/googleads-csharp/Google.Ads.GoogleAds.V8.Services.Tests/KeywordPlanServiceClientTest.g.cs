...
namespace Google.Ads.GoogleAds.V8.Services.Tests
{
    ...
    public sealed class GeneratedKeywordPlanServiceClientTest
    {
        ...
        public void GetKeywordPlanRequestObject()
        {
            ...
            {
                ResourceNameAsKeywordPlanName = gagvr::KeywordPlanName.FromCustomerKeywordPlan("[CUSTOMER_ID]", "[KEYWORD_PLAN_ID]"),
            };
            gagvr::KeywordPlan expectedResponse = new gagvr::KeywordPlan
            {
                ...
                KeywordPlanName = gagvr::KeywordPlanName.FromCustomerKeywordPlan("[CUSTOMER_ID]", "[KEYWORD_PLAN_ID]"),
            };
