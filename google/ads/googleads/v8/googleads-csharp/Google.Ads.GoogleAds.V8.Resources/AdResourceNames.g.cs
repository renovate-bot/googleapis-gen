...
namespace Google.Ads.GoogleAds.V8.Resources
{
    ...
    public sealed partial class AdName : gax::IResourceName, sys::IEquatable<AdName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer_id}/ads/{ad_id}</c>.</summary>
            CustomerAd = 1,
        }

        private static gax::PathTemplate s_customerAd = new gax::PathTemplate("customers/{customer_id}/ads/{ad_id}");
        ...
        /// <summary>
        /// Creates a <see cref="AdName"/> with the pattern <c>customers/{customer_id}/ads/{ad_id}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer_id}/ads/{ad_id}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="adId">The <c>Ad</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        /// The string representation of this <see cref="AdName"/> with pattern <c>customers/{customer_id}/ads/{ad_id}</c>
        /// .
        /// </returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer_id}/ads/{ad_id}</c></description></item>
        /// </list>
        /// </remarks>
