...
namespace Google.Ads.GoogleAds.V8.Resources
{
    ...
    public sealed partial class FeedName : gax::IResourceName, sys::IEquatable<FeedName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>A resource name with pattern <c>customers/{customer_id}/feeds/{feed_id}</c>.</summary>
            CustomerFeed = 1,
        }

        private static gax::PathTemplate s_customerFeed = new gax::PathTemplate("customers/{customer_id}/feeds/{feed_id}");
        ...
        /// <summary>
        /// Creates a <see cref="FeedName"/> with the pattern <c>customers/{customer_id}/feeds/{feed_id}</c>.
        /// </summary>
        ...
        /// <c>customers/{customer_id}/feeds/{feed_id}</c>.
        /// </summary>
        /// <param name="customerId">The <c>Customer</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="feedId">The <c>Feed</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description><c>customers/{customer_id}/feeds/{feed_id}</c></description></item>
        /// </list>
        /// </remarks>
