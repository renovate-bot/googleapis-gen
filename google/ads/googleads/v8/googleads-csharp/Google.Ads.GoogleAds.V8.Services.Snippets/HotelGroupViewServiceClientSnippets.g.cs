...
namespace Google.Ads.GoogleAds.V8.Services.Snippets
{
    ...
    public sealed class GeneratedHotelGroupViewServiceClientSnippets
    {
        ...
        public void GetHotelGroupViewRequestObject()
        {
            ...
            {
                ResourceNameAsHotelGroupViewName = HotelGroupViewName.FromCustomerAdGroupCriterion("[CUSTOMER_ID]", "[AD_GROUP_ID]", "[CRITERION_ID]"),
            };
            // Make the request
        ...
        public void GetHotelGroupView()
        {
            ...
            HotelGroupViewServiceClient hotelGroupViewServiceClient = HotelGroupViewServiceClient.Create();
            // Initialize request argument(s)
            string resourceName = "customers/[CUSTOMER_ID]/hotelGroupViews/[AD_GROUP_ID]~[CRITERION_ID]";
            // Make the request
        ...
        public void GetHotelGroupViewResourceNames()
        {
            ...
            HotelGroupViewServiceClient hotelGroupViewServiceClient = HotelGroupViewServiceClient.Create();
            // Initialize request argument(s)
            HotelGroupViewName resourceName = HotelGroupViewName.FromCustomerAdGroupCriterion("[CUSTOMER_ID]", "[AD_GROUP_ID]", "[CRITERION_ID]");
            // Make the request
            HotelGroupView response = hotelGroupViewServiceClient.GetHotelGroupView(resourceName);
            // End snippet
        }
