...
from google.ads.googleads.v8.services.services.customer_negative_criterion_service import CustomerNegativeCriterionServiceClient
from google.ads.googleads.v8.services.services.customer_negative_criterion_service import transports
...
def test_customer_negative_criterion_service_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.CustomerNegativeCriterionServiceGrpcTransport, "grpc"),
])
def test_customer_negative_criterion_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_customer_negative_criterion_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (CustomerNegativeCriterionServiceClient, transports.CustomerNegativeCriterionServiceGrpcTransport, "grpc"),
])
...
def test_customer_negative_criterion_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(CustomerNegativeCriterionServiceClient, 'get_transport_class') as gtc:
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (CustomerNegativeCriterionServiceClient, transports.CustomerNegativeCriterionServiceGrpcTransport, "grpc", "true"),
    (CustomerNegativeCriterionServiceClient, transports.CustomerNegativeCriterionServiceGrpcTransport, "grpc", "false"),
])
@mock.patch.object(CustomerNegativeCriterionServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CustomerNegativeCriterionServiceClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_customer_negative_criterion_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_customer_negative_criterion_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_customer_negative_criterion_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_customer_negative_criterion_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v8.services.services.customer_negative_criterion_service.transports.CustomerNegativeCriterionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_customer_negative_criterion(request_type, transport: str = 'grpc'):
    client = CustomerNegativeCriterionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_customer_negative_criterion_empty_call():
...
def test_mutate_customer_negative_criteria(request_type, transport: str = 'grpc'):
    client = CustomerNegativeCriterionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_customer_negative_criteria_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = CustomerNegativeCriterionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_mutate_customer_negative_criteria_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = [customer_negative_criterion_service.CustomerNegativeCriterionOperation(create=customer_negative_criterion.CustomerNegativeCriterion(resource_name='resource_name_value'))]
        assert arg == mock_val
...
def test_customer_negative_criterion_service_base_transport_error():
...
def test_customer_negative_criterion_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v8.services.services.customer_negative_criterion_service.transports.CustomerNegativeCriterionServiceTransport.__init__') as Transport:
...
def test_customer_negative_criterion_service_base_transport_with_credentials_file():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.googleads.v8.services.services.customer_negative_criterion_service.transports.CustomerNegativeCriterionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_customer_negative_criterion_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.googleads.v8.services.services.customer_negative_criterion_service.transports.CustomerNegativeCriterionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CustomerNegativeCriterionServiceTransport()
        adc.assert_called_once()
...
def test_customer_negative_criterion_service_transport_auth_adc(transport_class):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.CustomerNegativeCriterionServiceGrpcTransport, grpc_helpers),
    ],
)
def test_customer_negative_criterion_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_customer_negative_criterion_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_customer_negative_criterion_path():
    ...
    actual = CustomerNegativeCriterionServiceClient.customer_negative_criterion_path(customer_id, criterion_id)
