...
def test_batch_job_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v8.services.services.batch_job_service.BatchJobServiceClient.get_transport_class') as gtc:
...
def test_batch_job_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v8.services.services.batch_job_service.transports.BatchJobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BatchJobServiceTransport()
        adc.assert_called_once()
...
def test_feed_item_target_path():
    ...
    feed_id = "abalone"
    feed_item_id = "squid"
    feed_item_target_type = "clam"
    feed_item_target_id = "whelk"
...
def test_parse_feed_item_target_path():
    expected = {
        ...
        "feed_id": "oyster",
        "feed_item_id": "nudibranch",
        "feed_item_target_type": "cuttlefish",
        "feed_item_target_id": "mussel",
    }
