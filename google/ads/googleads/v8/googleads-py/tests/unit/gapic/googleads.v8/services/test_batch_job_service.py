...
from google.ads.googleads.v8.services.services.batch_job_service import BatchJobServiceClient
from google.ads.googleads.v8.services.services.batch_job_service import pagers
from google.ads.googleads.v8.services.services.batch_job_service import transports
...
def test_batch_job_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v8.services.services.batch_job_service.transports.BatchJobServiceGrpcTransport.__init__') as grpc_transport:
...
def test_batch_job_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v8.services.services.batch_job_service.transports.BatchJobServiceTransport.__init__') as Transport:
...
def test_batch_job_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.googleads.v8.services.services.batch_job_service.transports.BatchJobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_batch_job_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.googleads.v8.services.services.batch_job_service.transports.BatchJobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BatchJobServiceTransport()
        adc.assert_called_once()
...
def test_conversion_value_rule_set_path():
    customer_id = "cuttlefish"
    conversion_value_rule_set_id = "mussel"
