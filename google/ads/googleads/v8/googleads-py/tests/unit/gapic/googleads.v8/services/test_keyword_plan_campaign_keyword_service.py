...
def test_keyword_plan_campaign_keyword_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v8.services.services.keyword_plan_campaign_keyword_service.KeywordPlanCampaignKeywordServiceClient.get_transport_class') as gtc:
...
def test_keyword_plan_campaign_keyword_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v8.services.services.keyword_plan_campaign_keyword_service.transports.KeywordPlanCampaignKeywordServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.KeywordPlanCampaignKeywordServiceTransport()
        adc.assert_called_once()
