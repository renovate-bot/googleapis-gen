...
from google.ads.googleads.v8.services.services.campaign_criterion_service import CampaignCriterionServiceClient
from google.ads.googleads.v8.services.services.campaign_criterion_service import transports
...
def test_campaign_criterion_service_client_client_options_from_dict():
    with mock.patch('google.ads.googleads.v8.services.services.campaign_criterion_service.transports.CampaignCriterionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_campaign_criterion_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v8.services.services.campaign_criterion_service.transports.CampaignCriterionServiceTransport.__init__') as Transport:
...
def test_campaign_criterion_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.ads.googleads.v8.services.services.campaign_criterion_service.transports.CampaignCriterionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_campaign_criterion_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.ads.googleads.v8.services.services.campaign_criterion_service.transports.CampaignCriterionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CampaignCriterionServiceTransport()
        adc.assert_called_once()
