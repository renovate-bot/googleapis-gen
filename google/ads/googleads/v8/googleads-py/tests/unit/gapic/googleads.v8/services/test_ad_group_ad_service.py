...
from google.ads.googleads.v8.services.services.ad_group_ad_service import AdGroupAdServiceClient
from google.ads.googleads.v8.services.services.ad_group_ad_service import transports
...
def test_ad_group_ad_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v8.services.services.ad_group_ad_service.AdGroupAdServiceClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.ads.googleads.v8.services.services.ad_group_ad_service.transports.AdGroupAdServiceGrpcTransport.__init__') as grpc_transport:
...
def test_mutate_ad_group_ads_flattened():
    ...
    with mock.patch.object(
        ...
        assert args[0].operations == [ad_group_ad_service.AdGroupAdOperation(update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))]
...
def test_ad_group_ad_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v8.services.services.ad_group_ad_service.transports.AdGroupAdServiceTransport.__init__') as Transport:
...
def test_ad_group_ad_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v8.services.services.ad_group_ad_service.transports.AdGroupAdServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AdGroupAdServiceTransport()
        adc.assert_called_once()
