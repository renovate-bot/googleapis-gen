...
from google.ads.googleads.v8.services.services.campaign_experiment_service import CampaignExperimentServiceClient
...
def test_campaign_experiment_service_base_transport():
    ...
    with mock.patch('google.ads.googleads.v8.services.services.campaign_experiment_service.transports.CampaignExperimentServiceTransport.__init__') as Transport:
