...
def test_offline_user_data_job_service_client_client_options():
    ...
    with mock.patch('google.ads.googleads.v8.services.services.offline_user_data_job_service.OfflineUserDataJobServiceClient.get_transport_class') as gtc:
...
def test_offline_user_data_job_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default') as adc, mock.patch('google.ads.googleads.v8.services.services.offline_user_data_job_service.transports.OfflineUserDataJobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OfflineUserDataJobServiceTransport()
        adc.assert_called_once()
