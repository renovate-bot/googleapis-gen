...
from google.ads.googleads.v8.resources.types import campaign_shared_set as gagr_campaign_shared_set
...
class MutateCampaignSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateCampaignSharedSetResult]):
...
class MutateCampaignSharedSetResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_shared_set (google.ads.googleads.v8.resources.types.CampaignSharedSet):
