...
class MutateCustomerAssetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v8.services.types.CustomerAssetOperation]):
...
class CustomerAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.CustomerAsset):
            Create operation: No resource name is
            expected for the new customer asset.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v8.resources.types.CustomerAsset):
...
class MutateCustomerAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateCustomerAssetResult]):
