...
class CampaignBudgetServiceGrpcTransport(CampaignBudgetServiceTransport):
    ...
    def get_campaign_budget(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetCampaignBudgetRequest],
                    ~.CampaignBudget]:
        ...
        if 'get_campaign_budget' not in self._stubs:
            self._stubs['get_campaign_budget'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.CampaignBudgetService/GetCampaignBudget',
                request_serializer=campaign_budget_service.GetCampaignBudgetRequest.serialize,
                response_deserializer=campaign_budget.CampaignBudget.deserialize,
            )
        return self._stubs['get_campaign_budget']
    ...
    def mutate_campaign_budgets(self) -> Callable[
        ...
        if 'mutate_campaign_budgets' not in self._stubs:
            self._stubs['mutate_campaign_budgets'] = self.grpc_channel.unary_unary(
