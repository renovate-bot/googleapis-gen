...
from google.ads.googleads.v8.services.services.campaign_draft_service import pagers
    ...
    def mutate_campaign_drafts(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v8.services.types.CampaignDraftOperation]):
