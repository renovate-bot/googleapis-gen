...
class UploadClickConversionsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            the upload.
        conversions (Sequence[google.ads.googleads.v8.services.types.ClickConversion]):
...
class UploadClickConversionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            ads/api/docs/best-practices/partial-failures for
            more information about partial failure.
        results (Sequence[google.ads.googleads.v8.services.types.ClickConversionResult]):
...
class UploadCallConversionsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer performing
            the upload.
        conversions (Sequence[google.ads.googleads.v8.services.types.CallConversion]):
            Required. The conversions that are being
            uploaded.
        partial_failure (bool):
            Required. If true, successful operations will
...
class UploadCallConversionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            ads/api/docs/best-practices/partial-failures for
            more information about partial failure.
        results (Sequence[google.ads.googleads.v8.services.types.CallConversionResult]):
            Returned for successfully processed conversions. Proto will
            be empty for rows that received an error. Results are not
            returned when validate_only is true.
    """
...
class ClickConversion(proto.Message):
    ...
    Attributes:
        ...
        external_attribution_data (google.ads.googleads.v8.services.types.ExternalAttributionData):
            ...
            otherwise.
        custom_variables (Sequence[google.ads.googleads.v8.services.types.CustomVariable]):
...
class CartData(proto.Message):
    ...
    Attributes:
        ...
        items (Sequence[google.ads.googleads.v8.services.types.CartData.Item]):
    ...
    feed_country_code = proto.Field(
        proto.STRING,
        number=2,
    )
    feed_language_code = proto.Field(
        proto.STRING,
        number=3,
    )
    local_transaction_cost = proto.Field(
        proto.DOUBLE,
        number=4,
    )
