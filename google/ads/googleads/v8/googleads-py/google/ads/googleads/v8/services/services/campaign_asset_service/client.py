...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def get_campaign_asset(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.CampaignAsset:
    ...
    def mutate_campaign_assets(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.CampaignAssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateCampaignAssetsResponse:
