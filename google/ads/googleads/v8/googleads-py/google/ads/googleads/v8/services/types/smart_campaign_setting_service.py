...
class SmartCampaignSettingOperation(proto.Message):
    ...
    Attributes:
        update (google.ads.googleads.v8.resources.types.SmartCampaignSetting):
...
class MutateSmartCampaignSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateSmartCampaignSettingResult]):
