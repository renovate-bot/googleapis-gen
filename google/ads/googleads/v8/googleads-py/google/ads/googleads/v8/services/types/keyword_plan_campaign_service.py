...
class GetKeywordPlanCampaignRequest(proto.Message):
    ...
    [KeywordPlanCampaignService.GetKeywordPlanCampaign][google.ads.googleads.v8.services.KeywordPlanCampaignService.GetKeywordPlanCampaign].
...
class MutateKeywordPlanCampaignsRequest(proto.Message):
    r"""Request message for
    [KeywordPlanCampaignService.MutateKeywordPlanCampaigns][google.ads.googleads.v8.services.KeywordPlanCampaignService.MutateKeywordPlanCampaigns].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            Keyword Plan campaigns are being modified.
        operations (Sequence[google.ads.googleads.v8.services.types.KeywordPlanCampaignOperation]):
...
class KeywordPlanCampaignOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.KeywordPlanCampaign):
            Create operation: No resource name is
            expected for the new Keyword Plan campaign.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v8.resources.types.KeywordPlanCampaign):
...
class MutateKeywordPlanCampaignsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateKeywordPlanCampaignResult]):
