...
from .base import BiddingSeasonalityAdjustmentServiceTransport, DEFAULT_CLIENT_INFO


class BiddingSeasonalityAdjustmentServiceGrpcTransport(BiddingSeasonalityAdjustmentServiceTransport):
    ...
    @property
    def get_bidding_seasonality_adjustment(self) -> Callable[
        ...
        if 'get_bidding_seasonality_adjustment' not in self._stubs:
            self._stubs['get_bidding_seasonality_adjustment'] = self.grpc_channel.unary_unary(
    ...
    @property
    def mutate_bidding_seasonality_adjustments(self) -> Callable[
        ...
        if 'mutate_bidding_seasonality_adjustments' not in self._stubs:
            self._stubs['mutate_bidding_seasonality_adjustments'] = self.grpc_channel.unary_unary(
