...
class AdParameterServiceClient(metaclass=AdParameterServiceClientMeta):
    ...
    def get_ad_parameter(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetAdParameterRequest, dict]):
    ...
    def mutate_ad_parameters(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateAdParametersRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.AdParameterOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateAdParametersResponse:
