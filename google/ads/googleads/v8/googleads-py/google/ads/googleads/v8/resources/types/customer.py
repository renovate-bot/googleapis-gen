...
class Customer(proto.Message):
    ...
    Attributes:
        ...
        call_reporting_setting (google.ads.googleads.v8.resources.types.CallReportingSetting):
            Call reporting setting for a customer.
        conversion_tracking_setting (google.ads.googleads.v8.resources.types.ConversionTrackingSetting):
            Output only. Conversion tracking setting for
            a customer.
        remarketing_setting (google.ads.googleads.v8.resources.types.RemarketingSetting):
            Output only. Remarketing setting for a
            customer.
        pay_per_conversion_eligibility_failure_reasons (Sequence[google.ads.googleads.v8.enums.types.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason]):
