...
from google.ads.googleads.v8.resources.types import keyword_plan as gagr_keyword_plan
...
class MutateKeywordPlansRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v8.services.types.KeywordPlanOperation]):
...
class KeywordPlanOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.KeywordPlan):
            Create operation: No resource name is
            expected for the new keyword plan.
        update (google.ads.googleads.v8.resources.types.KeywordPlan):
...
class MutateKeywordPlansResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateKeywordPlansResult]):
...
class GenerateForecastCurveResponse(proto.Message):
    ...
    Attributes:
        campaign_forecast_curves (Sequence[google.ads.googleads.v8.services.types.KeywordPlanCampaignForecastCurve]):
...
class GenerateForecastTimeSeriesResponse(proto.Message):
    ...
    Attributes:
        weekly_time_series_forecasts (Sequence[google.ads.googleads.v8.services.types.KeywordPlanWeeklyTimeSeriesForecast]):
...
class GenerateForecastMetricsResponse(proto.Message):
    ...
    Attributes:
        campaign_forecasts (Sequence[google.ads.googleads.v8.services.types.KeywordPlanCampaignForecast]):
            List of campaign forecasts.
            One maximum.
        ad_group_forecasts (Sequence[google.ads.googleads.v8.services.types.KeywordPlanAdGroupForecast]):
            List of ad group forecasts.
        keyword_forecasts (Sequence[google.ads.googleads.v8.services.types.KeywordPlanKeywordForecast]):
...
class KeywordPlanCampaignForecast(proto.Message):
    ...
    Attributes:
        ...
        campaign_forecast (google.ads.googleads.v8.services.types.ForecastMetrics):
...
class KeywordPlanAdGroupForecast(proto.Message):
    ...
    Attributes:
        ...
        ad_group_forecast (google.ads.googleads.v8.services.types.ForecastMetrics):
...
class KeywordPlanKeywordForecast(proto.Message):
    ...
    Attributes:
        ...
        keyword_forecast (google.ads.googleads.v8.services.types.ForecastMetrics):
...
class KeywordPlanCampaignForecastCurve(proto.Message):
    ...
    Attributes:
        keyword_plan_campaign (str):
            ...
            ``customers/{customer_id}/keywordPlanCampaigns/{keyword_plan_campaign_id}``
        max_cpc_bid_forecast_curve (google.ads.googleads.v8.services.types.KeywordPlanMaxCpcBidForecastCurve):
...
class KeywordPlanMaxCpcBidForecast(proto.Message):
    ...
    Attributes:
        ...
        max_cpc_bid_forecast (google.ads.googleads.v8.services.types.ForecastMetrics):
...
class KeywordPlanWeeklyTimeSeriesForecast(proto.Message):
    ...
    Attributes:
        keyword_plan_campaign (str):
            ...
            ``customers/{customer_id}/keywordPlanCampaigns/{keyword_plan_campaign_id}``
        weekly_forecasts (Sequence[google.ads.googleads.v8.services.types.KeywordPlanWeeklyForecast]):
            The forecasts for the Keyword Plan campaign
            at different max CPC bids.
    """
...
class KeywordPlanWeeklyForecast(proto.Message):
    ...
    Attributes:
        start_date (str):
            ...
            date is inclusive.
        forecast (google.ads.googleads.v8.services.types.ForecastMetrics):
            The forecast for the Keyword Plan campaign
            for the week.
    """
...
class GenerateHistoricalMetricsResponse(proto.Message):
    ...
    Attributes:
        metrics (Sequence[google.ads.googleads.v8.services.types.KeywordPlanKeywordHistoricalMetrics]):
            List of keyword historical metrics.
        aggregate_metric_results (google.ads.googleads.v8.common.types.KeywordPlanAggregateMetricResults):
...
class KeywordPlanKeywordHistoricalMetrics(proto.Message):
    ...
    Attributes:
        ...
        keyword_metrics (google.ads.googleads.v8.common.types.KeywordPlanHistoricalMetrics):
