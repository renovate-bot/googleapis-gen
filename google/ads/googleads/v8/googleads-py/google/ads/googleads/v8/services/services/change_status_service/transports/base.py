...
class ChangeStatusServiceTransport(abc.ABC):
    """Abstract transport class for ChangeStatusService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_change_status: gapic_v1.method.wrap_method(
    ...
    def get_change_status(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[change_status.ChangeStatus]
            ]]:
        raise NotImplementedError()
