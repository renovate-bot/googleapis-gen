...
from google.ads.googleads.v8.resources.types import ad_parameter as gagr_ad_parameter
...
class MutateAdParametersRequest(proto.Message):
    r"""Request message for
    [AdParameterService.MutateAdParameters][google.ads.googleads.v8.services.AdParameterService.MutateAdParameters]

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose ad
            parameters are being modified.
        operations (Sequence[google.ads.googleads.v8.services.types.AdParameterOperation]):
...
class MutateAdParametersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateAdParameterResult]):
...
class MutateAdParameterResult(proto.Message):
    ...
    Attributes:
        resource_name (str):
            ...
            operations.
        ad_parameter (google.ads.googleads.v8.resources.types.AdParameter):
