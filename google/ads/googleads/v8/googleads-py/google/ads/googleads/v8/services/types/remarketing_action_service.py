...
class MutateRemarketingActionsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v8.services.types.RemarketingActionOperation]):
...
class RemarketingActionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.RemarketingAction):
            Create operation: No resource name is
            expected for the new remarketing action.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v8.resources.types.RemarketingAction):
...
class MutateRemarketingActionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateRemarketingActionResult]):
