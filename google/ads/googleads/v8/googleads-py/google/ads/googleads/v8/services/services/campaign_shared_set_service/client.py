...
class CampaignSharedSetServiceClient(metaclass=CampaignSharedSetServiceClientMeta):
    ...
    def transport(self) -> CampaignSharedSetServiceTransport:
        ...
        Returns:
            CampaignSharedSetServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the campaign shared set service client.
    ...
    def mutate_campaign_shared_sets(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v8.services.types.CampaignSharedSetOperation]):
