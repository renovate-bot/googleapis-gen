...
class CustomInterestServiceTransport(abc.ABC):
    """Abstract transport class for CustomInterestService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_custom_interest: gapic_v1.method.wrap_method(
                self.get_custom_interest,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_custom_interests: gapic_v1.method.wrap_method(
                self.mutate_custom_interests,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    def get_custom_interest(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[custom_interest.CustomInterest]
            ]]:
        raise NotImplementedError()
    ...
    def mutate_custom_interests(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[custom_interest_service.MutateCustomInterestsResponse]
            ]]:
        raise NotImplementedError()
