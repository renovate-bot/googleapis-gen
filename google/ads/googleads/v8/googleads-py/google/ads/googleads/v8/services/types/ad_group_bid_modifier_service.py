...
class AdGroupBidModifierOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.AdGroupBidModifier):
            Create operation: No resource name is
            expected for the new ad group bid modifier.
        update (google.ads.googleads.v8.resources.types.AdGroupBidModifier):
...
class MutateAdGroupBidModifiersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateAdGroupBidModifierResult]):
