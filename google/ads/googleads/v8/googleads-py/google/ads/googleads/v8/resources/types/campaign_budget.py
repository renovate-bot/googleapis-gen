...
class CampaignBudget(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v8.enums.types.BudgetStatusEnum.BudgetStatus):
            Output only. The status of this campaign
            budget. This field is read-only.
        delivery_method (google.ads.googleads.v8.enums.types.BudgetDeliveryMethodEnum.BudgetDeliveryMethod):
        ...
        period (google.ads.googleads.v8.enums.types.BudgetPeriodEnum.BudgetPeriod):
        ...
        type_ (google.ads.googleads.v8.enums.types.BudgetTypeEnum.BudgetType):
