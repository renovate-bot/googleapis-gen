...
class KeywordPlanCampaignServiceClient(metaclass=KeywordPlanCampaignServiceClientMeta):
    ...
    def get_keyword_plan_campaign(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetKeywordPlanCampaignRequest, dict]):
    ...
    def mutate_keyword_plan_campaigns(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateKeywordPlanCampaignsRequest, dict]):
                The request object. Request message for
