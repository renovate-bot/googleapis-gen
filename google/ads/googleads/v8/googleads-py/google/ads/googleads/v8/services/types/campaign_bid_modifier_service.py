...
from google.ads.googleads.v8.resources.types import campaign_bid_modifier as gagr_campaign_bid_modifier
...
class MutateCampaignBidModifiersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v8.services.types.CampaignBidModifierOperation]):
...
class MutateCampaignBidModifiersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateCampaignBidModifierResult]):
...
class MutateCampaignBidModifierResult(proto.Message):
    ...
    Attributes:
        ...
        campaign_bid_modifier (google.ads.googleads.v8.resources.types.CampaignBidModifier):
