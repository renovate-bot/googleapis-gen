...
class HotelGroupViewServiceClient(metaclass=HotelGroupViewServiceClientMeta):
    ...
    def get_hotel_group_view(self,
            request: hotel_group_view_service.GetHotelGroupViewRequest = None,
            *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetHotelGroupViewRequest`):
                The request object. Request message for
                [HotelGroupViewService.GetHotelGroupView][google.ads.googleads.v8.services.HotelGroupViewService.GetHotelGroupView].
        ...
        Returns:
            google.ads.googleads.v8.resources.types.HotelGroupView:
                A hotel group view.
        """
