...
class AdGroupExtensionSettingServiceClient(metaclass=AdGroupExtensionSettingServiceClientMeta):
    ...
    def get_ad_group_extension_setting(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetAdGroupExtensionSettingRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.AdGroupExtensionSetting:
    ...
    def mutate_ad_group_extension_settings(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateAdGroupExtensionSettingsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.AdGroupExtensionSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateAdGroupExtensionSettingsResponse:
