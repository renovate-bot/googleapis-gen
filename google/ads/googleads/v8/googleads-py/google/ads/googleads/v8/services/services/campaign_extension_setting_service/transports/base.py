...
class CampaignExtensionSettingServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_campaign_extension_setting: gapic_v1.method.wrap_method(
                self.get_campaign_extension_setting,
    ...
    def get_campaign_extension_setting(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[campaign_extension_setting.CampaignExtensionSetting]
            ]]:
        raise NotImplementedError()
    ...
    def mutate_campaign_extension_settings(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[campaign_extension_setting_service.MutateCampaignExtensionSettingsResponse]
            ]]:
        raise NotImplementedError()
