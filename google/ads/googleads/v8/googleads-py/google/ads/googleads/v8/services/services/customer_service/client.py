...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def get_customer(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetCustomerRequest, dict]):
    ...
    def mutate_customer(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateCustomerRequest, dict]):
                The request object. Request message for
    ...
    def list_accessible_customers(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.ListAccessibleCustomersRequest, dict]):
                The request object. Request message for
    ...
    def create_customer_client(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.CreateCustomerClientRequest, dict]):
                The request object. Request message for
