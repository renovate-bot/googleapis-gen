...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def get_feed_mapping(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetFeedMappingRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.FeedMapping:
                A feed mapping.
        """
    ...
    def mutate_feed_mappings(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateFeedMappingsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.FeedMappingOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateFeedMappingsResponse:
