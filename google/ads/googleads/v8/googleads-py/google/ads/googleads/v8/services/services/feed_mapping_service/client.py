...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def get_feed_mapping(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetFeedMappingRequest`):
    ...
    def mutate_feed_mappings(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateFeedMappingsRequest`):
                The request object. Request message for
