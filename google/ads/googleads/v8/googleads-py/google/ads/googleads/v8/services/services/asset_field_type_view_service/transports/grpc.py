...
class AssetFieldTypeViewServiceGrpcTransport(AssetFieldTypeViewServiceTransport):
    ...
    @property
    def get_asset_field_type_view(self) -> Callable[
            [asset_field_type_view_service.GetAssetFieldTypeViewRequest],
            asset_field_type_view.AssetFieldTypeView]:
        r"""Return a callable for the get asset field type view method over gRPC.

        Returns the requested asset field type view in full
        detail.

        Returns:
            Callable[[~.GetAssetFieldTypeViewRequest],
                    ~.AssetFieldTypeView]:
        ...
        if 'get_asset_field_type_view' not in self._stubs:
            self._stubs['get_asset_field_type_view'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.AssetFieldTypeViewService/GetAssetFieldTypeView',
                request_serializer=asset_field_type_view_service.GetAssetFieldTypeViewRequest.serialize,
                response_deserializer=asset_field_type_view.AssetFieldTypeView.deserialize,
            )
        return self._stubs['get_asset_field_type_view']


__all__ = (
    'AssetFieldTypeViewServiceGrpcTransport',
)
