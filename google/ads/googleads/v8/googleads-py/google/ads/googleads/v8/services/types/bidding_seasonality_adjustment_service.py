...
class MutateBiddingSeasonalityAdjustmentsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v8.services.types.BiddingSeasonalityAdjustmentOperation]):
...
class BiddingSeasonalityAdjustmentOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.BiddingSeasonalityAdjustment):
            Create operation: No resource name is
            expected for the new seasonality adjustment.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v8.resources.types.BiddingSeasonalityAdjustment):
...
class MutateBiddingSeasonalityAdjustmentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateBiddingSeasonalityAdjustmentsResult]):
