...
class AdGroupAssetServiceClient(metaclass=AdGroupAssetServiceClientMeta):
    ...
    def get_ad_group_asset(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetAdGroupAssetRequest, dict]):
    ...
    def mutate_ad_group_assets(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateAdGroupAssetsRequest, dict]):
                The request object. Request message for
