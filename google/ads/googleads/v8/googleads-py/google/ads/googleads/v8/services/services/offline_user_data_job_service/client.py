...
from google.ads.googleads.v8.enums.types import offline_user_data_job_failure_reason
from google.ads.googleads.v8.enums.types import offline_user_data_job_status
from google.ads.googleads.v8.enums.types import offline_user_data_job_type
from google.ads.googleads.v8.resources.types import offline_user_data_job
from google.ads.googleads.v8.services.types import offline_user_data_job_service
...
class OfflineUserDataJobServiceClient(metaclass=OfflineUserDataJobServiceClientMeta):
    ...
    def create_offline_user_data_job(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            job (:class:`google.ads.googleads.v8.resources.types.OfflineUserDataJob`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.CreateOfflineUserDataJobResponse:
    ...
    def get_offline_user_data_job(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.OfflineUserDataJob:
    ...
    def add_offline_user_data_job_operations(self,
        ...
        Args:
            ...
            resource_name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.OfflineUserDataJobOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.AddOfflineUserDataJobOperationsResponse:
                Response message for
                   [OfflineUserDataJobService.AddOfflineUserDataJobOperations][google.ads.googleads.v8.services.OfflineUserDataJobService.AddOfflineUserDataJobOperations].
