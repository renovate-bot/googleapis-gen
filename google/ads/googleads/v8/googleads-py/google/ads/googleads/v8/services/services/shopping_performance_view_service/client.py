...
class ShoppingPerformanceViewServiceClient(metaclass=ShoppingPerformanceViewServiceClientMeta):
    ...
    def transport(self) -> ShoppingPerformanceViewServiceTransport:
        ...
        Returns:
            ShoppingPerformanceViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the shopping performance view service client.
    ...
    def get_shopping_performance_view(self,
        ...
        r"""Returns the requested Shopping performance view in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetShoppingPerformanceViewRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.ShoppingPerformanceView:
