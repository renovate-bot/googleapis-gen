...
class ConversionCustomVariableServiceClient(metaclass=ConversionCustomVariableServiceClientMeta):
    ...
    def get_conversion_custom_variable(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetConversionCustomVariableRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.ConversionCustomVariable:
    ...
    def mutate_conversion_custom_variables(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateConversionCustomVariablesRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.ConversionCustomVariableOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateConversionCustomVariablesResponse:
