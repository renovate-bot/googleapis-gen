...
class RecommendationServiceClient(metaclass=RecommendationServiceClientMeta):
    ...
    def get_recommendation(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetRecommendationRequest, dict]):
    ...
    def apply_recommendation(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.ApplyRecommendationRequest, dict]):
                The request object. Request message for
    ...
    def dismiss_recommendation(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.DismissRecommendationRequest, dict]):
                The request object. Request message for
