...
class AdGroupBidModifierServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_ad_group_bid_modifier: gapic_v1.method.wrap_method(
                self.get_ad_group_bid_modifier,
    ...
    def get_ad_group_bid_modifier(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[ad_group_bid_modifier.AdGroupBidModifier]
            ]]:
        raise NotImplementedError()
    ...
    def mutate_ad_group_bid_modifiers(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[ad_group_bid_modifier_service.MutateAdGroupBidModifiersResponse]
            ]]:
        raise NotImplementedError()
