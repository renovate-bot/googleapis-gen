...
class GenerateKeywordIdeasPager:
    ...
    :class:`google.ads.googleads.v8.services.types.GenerateKeywordIdeaResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v8.services.types.GenerateKeywordIdeaResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v8.services.types.GenerateKeywordIdeaResponse`):
