...
class CustomerUserAccessInvitationServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_customer_user_access_invitation: gapic_v1.method.wrap_method(
                self.get_customer_user_access_invitation,
    ...
    def get_customer_user_access_invitation(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[customer_user_access_invitation.CustomerUserAccessInvitation]
            ]]:
        raise NotImplementedError()
    ...
    def mutate_customer_user_access_invitation(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[customer_user_access_invitation_service.MutateCustomerUserAccessInvitationResponse]
            ]]:
        raise NotImplementedError()
