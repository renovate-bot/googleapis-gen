...
class CustomerExtensionSettingOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.CustomerExtensionSetting):
            Create operation: No resource name is
            expected for the new customer extension setting.
        update (google.ads.googleads.v8.resources.types.CustomerExtensionSetting):
...
class MutateCustomerExtensionSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateCustomerExtensionSettingResult]):
