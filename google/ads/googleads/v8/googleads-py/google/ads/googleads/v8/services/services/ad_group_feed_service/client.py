...
class AdGroupFeedServiceClient(metaclass=AdGroupFeedServiceClientMeta):
    ...
    def get_ad_group_feed(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetAdGroupFeedRequest, dict]):
    ...
    def mutate_ad_group_feeds(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateAdGroupFeedsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v8.services.types.AdGroupFeedOperation]):
