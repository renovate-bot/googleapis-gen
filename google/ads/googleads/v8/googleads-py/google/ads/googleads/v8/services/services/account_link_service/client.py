...
from google.ads.googleads.v8.enums.types import account_link_status
from google.ads.googleads.v8.enums.types import linked_account_type
from google.ads.googleads.v8.resources.types import account_link
from google.ads.googleads.v8.resources.types import account_link as gagr_account_link
...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def get_account_link(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.AccountLink:
    ...
    def create_account_link(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            account_link (google.ads.googleads.v8.resources.types.AccountLink):
    ...
    def mutate_account_link(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (google.ads.googleads.v8.services.types.AccountLinkOperation):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateAccountLinkResponse:
