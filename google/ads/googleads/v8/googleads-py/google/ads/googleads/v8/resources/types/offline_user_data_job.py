...
class OfflineUserDataJob(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v8.enums.types.OfflineUserDataJobTypeEnum.OfflineUserDataJobType):
            Immutable. Type of the job.
        status (google.ads.googleads.v8.enums.types.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus):
            Output only. Status of the job.
        failure_reason (google.ads.googleads.v8.enums.types.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason):
        ...
        store_sales_metadata (google.ads.googleads.v8.common.types.StoreSalesMetadata):
