...
class CampaignExperimentServiceClient(metaclass=CampaignExperimentServiceClientMeta):
    ...
    def get_campaign_experiment(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetCampaignExperimentRequest`):
    ...
    def create_campaign_experiment(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.CreateCampaignExperimentRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            campaign_experiment (:class:`google.ads.googleads.v8.resources.types.CampaignExperiment`):
    ...
    def mutate_campaign_experiments(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateCampaignExperimentsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.CampaignExperimentOperation]`):
    ...
    def graduate_campaign_experiment(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GraduateCampaignExperimentRequest`):
                The request object. Request message for
    ...
    def promote_campaign_experiment(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.PromoteCampaignExperimentRequest`):
                The request object. Request message for
    ...
    def end_campaign_experiment(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.EndCampaignExperimentRequest`):
                The request object. Request message for
    ...
    def list_campaign_experiment_async_errors(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.ListCampaignExperimentAsyncErrorsRequest`):
                The request object. Request message for
