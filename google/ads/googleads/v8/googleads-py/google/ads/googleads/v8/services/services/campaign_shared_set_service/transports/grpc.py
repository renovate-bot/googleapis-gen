    ...
    def get_campaign_shared_set(self) -> Callable[
        ...
        if 'get_campaign_shared_set' not in self._stubs:
            self._stubs['get_campaign_shared_set'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.CampaignSharedSetService/GetCampaignSharedSet',
    ...
    def mutate_campaign_shared_sets(self) -> Callable[
        ...
        if 'mutate_campaign_shared_sets' not in self._stubs:
            self._stubs['mutate_campaign_shared_sets'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.CampaignSharedSetService/MutateCampaignSharedSets',
