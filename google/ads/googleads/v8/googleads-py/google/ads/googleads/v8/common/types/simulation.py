...
class BidModifierSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v8.common.types.BidModifierSimulationPoint]):
...
class TargetCpaSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v8.common.types.TargetCpaSimulationPoint]):
...
class TargetRoasSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v8.common.types.TargetRoasSimulationPoint]):
...
class PercentCpcBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v8.common.types.PercentCpcBidSimulationPoint]):
...
class BudgetSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v8.common.types.BudgetSimulationPoint]):
...
class TargetImpressionShareSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v8.common.types.TargetImpressionShareSimulationPoint]):
