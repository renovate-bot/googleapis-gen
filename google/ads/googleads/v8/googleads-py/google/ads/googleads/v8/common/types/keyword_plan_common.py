...
from google.ads.googleads.v8.enums.types import keyword_plan_competition_level
from google.ads.googleads.v8.enums.types import keyword_plan_concept_group_type
...
class KeywordConcept(proto.Message):
    ...
    Attributes:
        ...
        concept_group (google.ads.googleads.v8.common.types.ConceptGroup):
...
class ConceptGroup(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v8.enums.types.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType):
