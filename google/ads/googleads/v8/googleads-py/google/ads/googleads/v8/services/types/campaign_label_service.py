...
class GetCampaignLabelRequest(proto.Message):
    ...
    [CampaignLabelService.GetCampaignLabel][google.ads.googleads.v8.services.CampaignLabelService.GetCampaignLabel].
...
class MutateCampaignLabelsRequest(proto.Message):
    r"""Request message for
    [CampaignLabelService.MutateCampaignLabels][google.ads.googleads.v8.services.CampaignLabelService.MutateCampaignLabels].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose campaign-
            abel relationships are being modified.
        operations (Sequence[google.ads.googleads.v8.services.types.CampaignLabelOperation]):
...
class CampaignLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v8.resources.types.CampaignLabel):
...
class MutateCampaignLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateCampaignLabelResult]):
