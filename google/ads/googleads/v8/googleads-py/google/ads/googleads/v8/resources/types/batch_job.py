...
class BatchJob(proto.Message):
    ...
    Attributes:
        ...
        metadata (google.ads.googleads.v8.resources.types.BatchJob.BatchJobMetadata):
            Output only. Contains additional information
            about this batch job.
        status (google.ads.googleads.v8.enums.types.BatchJobStatusEnum.BatchJobStatus):
