...
class MutateCampaignCriteriaRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v8.services.types.CampaignCriterionOperation]):
...
class CampaignCriterionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.CampaignCriterion):
            Create operation: No resource name is
            expected for the new criterion.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v8.resources.types.CampaignCriterion):
...
class MutateCampaignCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateCampaignCriterionResult]):
