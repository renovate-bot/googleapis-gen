...
class ConversionValueRuleServiceClient(metaclass=ConversionValueRuleServiceClientMeta):
    ...
    def get_conversion_value_rule(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.ConversionValueRule:
    ...
    def mutate_conversion_value_rules(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.ConversionValueRuleOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateConversionValueRulesResponse:
