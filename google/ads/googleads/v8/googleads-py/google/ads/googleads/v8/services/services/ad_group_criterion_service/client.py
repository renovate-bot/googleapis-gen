...
class AdGroupCriterionServiceClient(metaclass=AdGroupCriterionServiceClientMeta):
    ...
    def get_ad_group_criterion(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetAdGroupCriterionRequest, dict]):
    ...
    def mutate_ad_group_criteria(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateAdGroupCriteriaRequest, dict]):
                The request object. Request message for
