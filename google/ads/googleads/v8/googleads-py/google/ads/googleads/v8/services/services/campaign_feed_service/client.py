...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def get_campaign_feed(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetCampaignFeedRequest`):
    ...
    def mutate_campaign_feeds(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateCampaignFeedsRequest`):
                The request object. Request message for
