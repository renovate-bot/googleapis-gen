...
class AdGroupServiceClient(metaclass=AdGroupServiceClientMeta):
    ...
    def get_ad_group(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetAdGroupRequest, dict]):
    ...
    def mutate_ad_groups(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateAdGroupsRequest, dict]):
                The request object. Request message for
