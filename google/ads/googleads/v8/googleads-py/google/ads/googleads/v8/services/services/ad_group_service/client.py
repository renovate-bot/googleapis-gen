...
class AdGroupServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AdGroupServiceTransport]]
...
class AdGroupServiceClient(metaclass=AdGroupServiceClientMeta):
    ...
    def get_ad_group(self,
            request: ad_group_service.GetAdGroupRequest = None,
            *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetAdGroupRequest`):
                The request object. Request message for
                [AdGroupService.GetAdGroup][google.ads.googleads.v8.services.AdGroupService.GetAdGroup].
        ...
        Returns:
            google.ads.googleads.v8.resources.types.AdGroup:
                An ad group.
        """
    ...
    def mutate_ad_groups(self,
            request: ad_group_service.MutateAdGroupsRequest = None,
            *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateAdGroupsRequest`):
                The request object. Request message for
                [AdGroupService.MutateAdGroups][google.ads.googleads.v8.services.AdGroupService.MutateAdGroups].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.AdGroupOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateAdGroupsResponse:
