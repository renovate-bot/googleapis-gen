...
class FeedItemSetServiceClient(metaclass=FeedItemSetServiceClientMeta):
    ...
    def transport(self) -> FeedItemSetServiceTransport:
        ...
        Returns:
            FeedItemSetServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the feed item set service client.
    ...
    def get_feed_item_set(self,
            request: Union[feed_item_set_service.GetFeedItemSetRequest, dict] = None,
            *,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetFeedItemSetRequest, dict]):
    ...
    def mutate_feed_item_sets(self,
            request: Union[feed_item_set_service.MutateFeedItemSetsRequest, dict] = None,
            *,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateFeedItemSetsRequest, dict]):
                The request object. Request message for
