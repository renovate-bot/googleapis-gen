...
class UploadUserDataRequest(proto.Message):
    ...
    [UserDataService.UploadUserData][google.ads.googleads.v8.services.UserDataService.UploadUserData]

    Attributes:
        customer_id (str):
            Required. The ID of the customer for which to
            update the user data.
        operations (Sequence[google.ads.googleads.v8.services.types.UserDataOperation]):
            Required. The list of operations to be done.
        customer_match_user_list_metadata (google.ads.googleads.v8.common.types.CustomerMatchUserListMetadata):
