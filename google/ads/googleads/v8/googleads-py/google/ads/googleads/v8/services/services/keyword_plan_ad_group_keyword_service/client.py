...
class KeywordPlanAdGroupKeywordServiceClient(metaclass=KeywordPlanAdGroupKeywordServiceClientMeta):
    ...
    def get_keyword_plan_ad_group_keyword(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetKeywordPlanAdGroupKeywordRequest`):
    ...
    def mutate_keyword_plan_ad_group_keywords(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateKeywordPlanAdGroupKeywordsRequest`):
                The request object. Request message for
