...
class IncomeRangeViewServiceClient(metaclass=IncomeRangeViewServiceClientMeta):
    ...
    def transport(self) -> IncomeRangeViewServiceTransport:
        ...
        Returns:
            IncomeRangeViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the income range view service client.
    ...
    def get_income_range_view(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetIncomeRangeViewRequest, dict]):
                The request object. Request message for
                [IncomeRangeViewService.GetIncomeRangeView][google.ads.googleads.v8.services.IncomeRangeViewService.GetIncomeRangeView].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.IncomeRangeView:
