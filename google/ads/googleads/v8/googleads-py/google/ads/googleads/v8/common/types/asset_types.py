...
class ImageAsset(proto.Message):
    ...
    Attributes:
        ...
        full_size (google.ads.googleads.v8.common.types.ImageDimension):
...
class LeadFormAsset(proto.Message):
    ...
    Attributes:
        business_name (str):
            ...
            advertised.
        call_to_action_type (google.ads.googleads.v8.enums.types.LeadFormCallToActionTypeEnum.LeadFormCallToActionType):
        ...
        delivery_methods (Sequence[google.ads.googleads.v8.common.types.LeadFormDeliveryMethod]):
        ...
        post_submit_call_to_action_type (google.ads.googleads.v8.enums.types.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType):
...
class LeadFormField(proto.Message):
    ...
    Attributes:
        input_type (google.ads.googleads.v8.enums.types.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType):
            Describes the input type, which may be a
            predefined type such as "full name" or a pre-
            vetted question like "Do you own a car?".
        single_choice_answers (google.ads.googleads.v8.common.types.LeadFormSingleChoiceAnswers):
...
class PromotionAsset(proto.Message):
    ...
    Attributes:
        ...
        ad_schedule_targets (Sequence[google.ads.googleads.v8.common.types.AdScheduleInfo]):
