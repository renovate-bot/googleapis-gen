...
class GoogleAdsFieldServiceClient(metaclass=GoogleAdsFieldServiceClientMeta):
    ...
    def get_google_ads_field(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.GoogleAdsField:
    ...
    def search_google_ads_fields(self,
        ...
        Returns:
            google.ads.googleads.v8.services.services.google_ads_field_service.pagers.SearchGoogleAdsFieldsPager:
