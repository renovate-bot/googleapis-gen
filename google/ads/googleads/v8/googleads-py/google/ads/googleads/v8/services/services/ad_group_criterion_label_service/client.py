...
class AdGroupCriterionLabelServiceClient(metaclass=AdGroupCriterionLabelServiceClientMeta):
    ...
    def get_ad_group_criterion_label(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetAdGroupCriterionLabelRequest`):
    ...
    def mutate_ad_group_criterion_labels(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateAdGroupCriterionLabelsRequest`):
                The request object. Request message for
