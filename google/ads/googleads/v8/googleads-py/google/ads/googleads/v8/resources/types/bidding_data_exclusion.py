...
class BiddingDataExclusion(proto.Message):
    ...
    Attributes:
        ...
        scope (google.ads.googleads.v8.enums.types.SeasonalityEventScopeEnum.SeasonalityEventScope):
            The scope of the data exclusion.
        status (google.ads.googleads.v8.enums.types.SeasonalityEventStatusEnum.SeasonalityEventStatus):
        ...
        devices (Sequence[google.ads.googleads.v8.enums.types.DeviceEnum.Device]):
        ...
        campaigns (Sequence[str]):
            ...
            supported.
        advertising_channel_types (Sequence[google.ads.googleads.v8.enums.types.AdvertisingChannelTypeEnum.AdvertisingChannelType]):
