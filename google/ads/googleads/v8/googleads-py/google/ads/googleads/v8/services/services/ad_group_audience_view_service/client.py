...
class AdGroupAudienceViewServiceClient(metaclass=AdGroupAudienceViewServiceClientMeta):
    ...
    def transport(self) -> AdGroupAudienceViewServiceTransport:
        ...
        Returns:
            AdGroupAudienceViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the ad group audience view service client.
    ...
    def get_ad_group_audience_view(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetAdGroupAudienceViewRequest, dict]):
                The request object. Request message for
                [AdGroupAudienceViewService.GetAdGroupAudienceView][google.ads.googleads.v8.services.AdGroupAudienceViewService.GetAdGroupAudienceView].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.AdGroupAudienceView:
