...
from .transports.base import LanguageConstantServiceTransport, DEFAULT_CLIENT_INFO
...
class LanguageConstantServiceClient(metaclass=LanguageConstantServiceClientMeta):
    ...
    def transport(self) -> LanguageConstantServiceTransport:
        ...
        Returns:
            LanguageConstantServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the language constant service client.
    ...
    def get_language_constant(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.LanguageConstant:
                A language.
        """
        ...
        if not isinstance(request, language_constant_service.GetLanguageConstantRequest):
            request = language_constant_service.GetLanguageConstantRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_language_constant]
