...
class AgeRangeViewServiceClient(metaclass=AgeRangeViewServiceClientMeta):
    ...
    def transport(self) -> AgeRangeViewServiceTransport:
        ...
        Returns:
            AgeRangeViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the age range view service client.
    ...
    def get_age_range_view(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetAgeRangeViewRequest, dict]):
