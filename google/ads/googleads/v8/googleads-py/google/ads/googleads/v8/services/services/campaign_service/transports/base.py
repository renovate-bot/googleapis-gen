...
class CampaignServiceTransport(abc.ABC):
    """Abstract transport class for CampaignService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_campaign: gapic_v1.method.wrap_method(
                self.get_campaign,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_campaigns: gapic_v1.method.wrap_method(
                self.mutate_campaigns,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def get_campaign(self) -> Callable[
            [campaign_service.GetCampaignRequest],
            Union[
                campaign.Campaign,
                Awaitable[campaign.Campaign]
            ]]:
        raise NotImplementedError()

    @property
    def mutate_campaigns(self) -> Callable[
