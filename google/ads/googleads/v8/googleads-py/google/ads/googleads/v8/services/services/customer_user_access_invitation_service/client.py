...
from google.ads.googleads.v8.services.types import customer_user_access_invitation_service
...
class CustomerUserAccessInvitationServiceClient(metaclass=CustomerUserAccessInvitationServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        """Instantiate the customer user access invitation service client.
        ...
        if isinstance(transport, CustomerUserAccessInvitationServiceTransport):
            ...
            self._transport = CustomerUserAccessInvitationServiceGrpcTransport(
    ...
    def get_customer_user_access_invitation(self,
        ...
        r"""Returns the requested access invitation in full detail.
        ...
        Returns:
            google.ads.googleads.v8.resources.types.CustomerUserAccessInvitation:
                Represent an invitation to a new user
                on this customer account.
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_customer_user_access_invitation]
    ...
    def mutate_customer_user_access_invitation(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v8.services.types.CustomerUserAccessInvitationOperation`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateCustomerUserAccessInvitationResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_customer_user_access_invitation]
