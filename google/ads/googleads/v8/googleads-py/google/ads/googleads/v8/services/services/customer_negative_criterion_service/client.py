...
class CustomerNegativeCriterionServiceClient(metaclass=CustomerNegativeCriterionServiceClientMeta):
    ...
    def get_customer_negative_criterion(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetCustomerNegativeCriterionRequest`):
    ...
    def mutate_customer_negative_criteria(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateCustomerNegativeCriteriaRequest`):
                The request object. Request message for
