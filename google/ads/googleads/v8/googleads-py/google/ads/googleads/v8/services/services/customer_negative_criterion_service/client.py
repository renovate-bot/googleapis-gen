...
class CustomerNegativeCriterionServiceClient(metaclass=CustomerNegativeCriterionServiceClientMeta):
    ...
    def get_customer_negative_criterion(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetCustomerNegativeCriterionRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.CustomerNegativeCriterion:
    ...
    def mutate_customer_negative_criteria(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateCustomerNegativeCriteriaRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.CustomerNegativeCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateCustomerNegativeCriteriaResponse:
