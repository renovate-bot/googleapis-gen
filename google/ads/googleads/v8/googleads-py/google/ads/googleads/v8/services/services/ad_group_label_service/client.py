...
class AdGroupLabelServiceClient(metaclass=AdGroupLabelServiceClientMeta):
    ...
    def get_ad_group_label(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetAdGroupLabelRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.AdGroupLabel:
    ...
    def mutate_ad_group_labels(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateAdGroupLabelsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.AdGroupLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateAdGroupLabelsResponse:
