...
class AdGroupLabelServiceClient(metaclass=AdGroupLabelServiceClientMeta):
    ...
    def get_ad_group_label(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetAdGroupLabelRequest`):
    ...
    def mutate_ad_group_labels(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateAdGroupLabelsRequest`):
                The request object. Request message for
