...
from google.ads.googleads.v8.enums.types import user_interest_taxonomy_type
...
class UserInterestServiceClient(metaclass=UserInterestServiceClientMeta):
    ...
    def transport(self) -> UserInterestServiceTransport:
        ...
        Returns:
            UserInterestServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the user interest service client.
    ...
    def get_user_interest(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.UserInterest:
