...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
    ...
    def get_feed_item(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetFeedItemRequest, dict]):
    ...
    def mutate_feed_items(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateFeedItemsRequest, dict]):
                The request object. Request message for
