...
class BiddingDataExclusionServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[BiddingDataExclusionServiceTransport]]
...
class BiddingDataExclusionServiceClient(metaclass=BiddingDataExclusionServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, BiddingDataExclusionServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the bidding data exclusion service client.
        ...
        Args:
            ...
            transport (Union[str, ~.BiddingDataExclusionServiceTransport]): The
        ...
        if isinstance(transport, BiddingDataExclusionServiceTransport):
            ...
            self._transport = BiddingDataExclusionServiceGrpcTransport(
    ...
    def get_bidding_data_exclusion(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.BiddingDataExclusion:
        ...
        # in a bidding_data_exclusion_service.GetBiddingDataExclusionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, bidding_data_exclusion_service.GetBiddingDataExclusionRequest):
            request = bidding_data_exclusion_service.GetBiddingDataExclusionRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_bidding_data_exclusion]
    ...
    def mutate_bidding_data_exclusions(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.BiddingDataExclusionOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateBiddingDataExclusionsResponse:
                Response message for data exlusions
                mutate.
        ...
        if request is not None and any([customer_id, operations]):
           ...
           # Minor optimization to avoid making a copy if the user passes
        # in a bidding_data_exclusion_service.MutateBiddingDataExclusionsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, bidding_data_exclusion_service.MutateBiddingDataExclusionsRequest):
            request = bidding_data_exclusion_service.MutateBiddingDataExclusionsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_bidding_data_exclusions]
