...
class ProductBiddingCategoryConstantServiceClient(metaclass=ProductBiddingCategoryConstantServiceClientMeta):
    ...
    def transport(self) -> ProductBiddingCategoryConstantServiceTransport:
        ...
        Returns:
            ProductBiddingCategoryConstantServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the product bidding category constant service client.
    ...
    def get_product_bidding_category_constant(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetProductBiddingCategoryConstantRequest, dict]):
