...
from google.ads.googleads.v8.enums.types import keyword_plan_network as gage_keyword_plan_network
...
class KeywordPlanCampaign(proto.Message):
    ...
    Attributes:
        ...
        cpc_bid_micros (int):
            ...
            This field is required and should not be empty
            when creating Keyword Plan campaigns.
        geo_targets (Sequence[google.ads.googleads.v8.resources.types.KeywordPlanGeoTarget]):
            The geo targets.
