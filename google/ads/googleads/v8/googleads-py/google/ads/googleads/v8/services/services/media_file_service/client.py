...
class MediaFileServiceClient(metaclass=MediaFileServiceClientMeta):
    ...
    def get_media_file(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.MediaFile:
                A media file.
        """
    ...
    def mutate_media_files(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.MediaFileOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateMediaFilesResponse:
