...
class CampaignServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CampaignServiceTransport]]
...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
    ...
    def get_campaign(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetCampaignRequest, dict]):
                The request object. Request message for
                [CampaignService.GetCampaign][google.ads.googleads.v8.services.CampaignService.GetCampaign].
        ...
        Returns:
            google.ads.googleads.v8.resources.types.Campaign:
                A campaign.
        """
    ...
    def mutate_campaigns(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateCampaignsRequest, dict]):
                The request object. Request message for
                [CampaignService.MutateCampaigns][google.ads.googleads.v8.services.CampaignService.MutateCampaigns].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.CampaignOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateCampaignsResponse:
