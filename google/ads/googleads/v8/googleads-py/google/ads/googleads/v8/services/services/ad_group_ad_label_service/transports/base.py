...
class AdGroupAdLabelServiceTransport(abc.ABC):
    """Abstract transport class for AdGroupAdLabelService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_ad_group_ad_label: gapic_v1.method.wrap_method(
                self.get_ad_group_ad_label,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_ad_group_ad_labels: gapic_v1.method.wrap_method(
                self.mutate_ad_group_ad_labels,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    def get_ad_group_ad_label(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[ad_group_ad_label.AdGroupAdLabel]
            ]]:
        raise NotImplementedError()
