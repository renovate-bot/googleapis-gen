...
class KeywordPlanCampaignKeywordServiceGrpcTransport(KeywordPlanCampaignKeywordServiceTransport):
    """gRPC backend transport for KeywordPlanCampaignKeywordService.
    ...
    def get_keyword_plan_campaign_keyword(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetKeywordPlanCampaignKeywordRequest],
        ...
        if 'get_keyword_plan_campaign_keyword' not in self._stubs:
            self._stubs['get_keyword_plan_campaign_keyword'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.KeywordPlanCampaignKeywordService/GetKeywordPlanCampaignKeyword',
                request_serializer=keyword_plan_campaign_keyword_service.GetKeywordPlanCampaignKeywordRequest.serialize,
                response_deserializer=keyword_plan_campaign_keyword.KeywordPlanCampaignKeyword.deserialize,
            )
        return self._stubs['get_keyword_plan_campaign_keyword']
    ...
    def mutate_keyword_plan_campaign_keywords(self) -> Callable[
        ...
        if 'mutate_keyword_plan_campaign_keywords' not in self._stubs:
            self._stubs['mutate_keyword_plan_campaign_keywords'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.KeywordPlanCampaignKeywordService/MutateKeywordPlanCampaignKeywords',
