...
class GetRecommendationRequest(proto.Message):
    ...
    [RecommendationService.GetRecommendation][google.ads.googleads.v8.services.RecommendationService.GetRecommendation].
...
class ApplyRecommendationRequest(proto.Message):
    r"""Request message for
    [RecommendationService.ApplyRecommendation][google.ads.googleads.v8.services.RecommendationService.ApplyRecommendation].

    Attributes:
        customer_id (str):
            Required. The ID of the customer with the
            recommendation.
        operations (Sequence[google.ads.googleads.v8.services.types.ApplyRecommendationOperation]):
...
class ApplyRecommendationOperation(proto.Message):
    ...
    class CalloutExtensionParameters(proto.Message):
        ...
        Attributes:
            callout_extensions (Sequence[google.ads.googleads.v8.common.types.CalloutFeedItem]):
    ...
    class CallExtensionParameters(proto.Message):
        ...
        Attributes:
            call_extensions (Sequence[google.ads.googleads.v8.common.types.CallFeedItem]):
    ...
    class SitelinkExtensionParameters(proto.Message):
        ...
        Attributes:
            sitelink_extensions (Sequence[google.ads.googleads.v8.common.types.SitelinkFeedItem]):
...
class ApplyRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v8.services.types.ApplyRecommendationResult]):
...
class DismissRecommendationRequest(proto.Message):
    r"""Request message for
    [RecommendationService.DismissRecommendation][google.ads.googleads.v8.services.RecommendationService.DismissRecommendation].

    Attributes:
        customer_id (str):
            Required. The ID of the customer with the
            recommendation.
        operations (Sequence[google.ads.googleads.v8.services.types.DismissRecommendationRequest.DismissRecommendationOperation]):
...
class DismissRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v8.services.types.DismissRecommendationResponse.DismissRecommendationResult]):
