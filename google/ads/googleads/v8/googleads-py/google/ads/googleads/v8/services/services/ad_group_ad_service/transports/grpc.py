...
class AdGroupAdServiceGrpcTransport(AdGroupAdServiceTransport):
    ...
    @property
    def get_ad_group_ad(self) -> Callable[
            [ad_group_ad_service.GetAdGroupAdRequest],
            ad_group_ad.AdGroupAd]:
        r"""Return a callable for the get ad group ad method over gRPC.
        ...
        if 'get_ad_group_ad' not in self._stubs:
            self._stubs['get_ad_group_ad'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.AdGroupAdService/GetAdGroupAd',
                request_serializer=ad_group_ad_service.GetAdGroupAdRequest.serialize,
                response_deserializer=ad_group_ad.AdGroupAd.deserialize,
            )
        return self._stubs['get_ad_group_ad']

    @property
    def mutate_ad_group_ads(self) -> Callable[
