...
class SmartCampaignSettingServiceClient(metaclass=SmartCampaignSettingServiceClientMeta):
    ...
    def transport(self) -> SmartCampaignSettingServiceTransport:
        ...
        Returns:
            SmartCampaignSettingServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the smart campaign setting service client.
    ...
    def mutate_smart_campaign_settings(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v8.services.types.SmartCampaignSettingOperation]):
