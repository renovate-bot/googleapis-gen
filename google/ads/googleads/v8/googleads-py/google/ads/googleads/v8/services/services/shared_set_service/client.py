...
class SharedSetServiceClient(metaclass=SharedSetServiceClientMeta):
    ...
    def get_shared_set(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.SharedSet:
    ...
    def mutate_shared_sets(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.SharedSetOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateSharedSetsResponse:
