...
class LabelServiceClient(metaclass=LabelServiceClientMeta):
    ...
    def get_label(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.Label:
                A label.
        """
    ...
    def mutate_labels(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.LabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateLabelsResponse:
