...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def get_shared_criterion(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetSharedCriterionRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.SharedCriterion:
    ...
    def mutate_shared_criteria(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateSharedCriteriaRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.SharedCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateSharedCriteriaResponse:
