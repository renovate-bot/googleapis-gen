...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def get_shared_criterion(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetSharedCriterionRequest`):
    ...
    def mutate_shared_criteria(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateSharedCriteriaRequest`):
                The request object. Request message for
