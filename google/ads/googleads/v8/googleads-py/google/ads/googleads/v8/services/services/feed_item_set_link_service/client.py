...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
    ...
    def get_feed_item_set_link(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetFeedItemSetLinkRequest`):
    ...
    def mutate_feed_item_set_links(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateFeedItemSetLinksRequest`):
                The request object. Request message for
