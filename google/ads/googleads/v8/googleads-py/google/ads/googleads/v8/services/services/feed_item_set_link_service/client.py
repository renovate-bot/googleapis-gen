...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
    ...
    def transport(self) -> FeedItemSetLinkServiceTransport:
        ...
        Returns:
            FeedItemSetLinkServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the feed item set link service client.
    ...
    def mutate_feed_item_set_links(self,
        ...
        Args:
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v8.services.types.FeedItemSetLinkOperation]):
