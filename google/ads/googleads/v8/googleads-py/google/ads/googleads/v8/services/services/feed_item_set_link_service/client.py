...
from .transports.base import FeedItemSetLinkServiceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import FeedItemSetLinkServiceGrpcTransport


class FeedItemSetLinkServiceClientMeta(type):
    """Metaclass for the FeedItemSetLinkService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[FeedItemSetLinkServiceTransport]]
    _transport_registry['grpc'] = FeedItemSetLinkServiceGrpcTransport
...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            FeedItemSetLinkServiceClient: The constructed client.
        """
    ...
    def transport(self) -> FeedItemSetLinkServiceTransport:
        ...
        Returns:
            FeedItemSetLinkServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, FeedItemSetLinkServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiate the feed item set link service client.
        ...
        Args:
            ...
            transport (Union[str, ~.FeedItemSetLinkServiceTransport]): The
        ...
        if isinstance(transport, FeedItemSetLinkServiceTransport):
            # transport is a FeedItemSetLinkServiceTransport instance.
            if credentials:
            ...
            self._transport = FeedItemSetLinkServiceGrpcTransport(
    ...
    def get_feed_item_set_link(self,
        ...
        r"""Returns the requested feed item set link in full detail.
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetFeedItemSetLinkRequest, dict]):
                The request object. Request message for
                [FeedItemSetLinkService.GetFeedItemSetLinks][].
            resource_name (:class:`str`):
                Required. The resource name of the
                feed item set link to fetch.
        ...
        Returns:
            google.ads.googleads.v8.resources.types.FeedItemSetLink:
                Represents a link between a FeedItem
                and a FeedItemSet.
        ...
        # in a feed_item_set_link_service.GetFeedItemSetLinkRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, feed_item_set_link_service.GetFeedItemSetLinkRequest):
            request = feed_item_set_link_service.GetFeedItemSetLinkRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_feed_item_set_link]
    ...
    def mutate_feed_item_set_links(self,
        ...
        r"""Creates, updates, or removes feed item set links.
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateFeedItemSetLinksRequest, dict]):
                The request object. Request message for
                [FeedItemSetLinkService.MutateFeedItemSetLinks][google.ads.googleads.v8.services.FeedItemSetLinkService.MutateFeedItemSetLinks].
            customer_id (:class:`str`):
                Required. The ID of the customer
                whose feed item set links are being
                modified.

                This corresponds to the ``customer_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.FeedItemSetLinkOperation]`):
                Required. The list of operations to
                perform on individual feed item set
                links.
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateFeedItemSetLinksResponse:
                Response message for a feed item set
                link mutate.
        ...
        if request is not None and any([customer_id, operations]):
           ...
           # Minor optimization to avoid making a copy if the user passes
        # in a feed_item_set_link_service.MutateFeedItemSetLinksRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, feed_item_set_link_service.MutateFeedItemSetLinksRequest):
            request = feed_item_set_link_service.MutateFeedItemSetLinksRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_feed_item_set_links]
