...
class KeywordPlanCampaignKeywordServiceClient(metaclass=KeywordPlanCampaignKeywordServiceClientMeta):
    ...
    def get_keyword_plan_campaign_keyword(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetKeywordPlanCampaignKeywordRequest, dict]):
    ...
    def mutate_keyword_plan_campaign_keywords(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateKeywordPlanCampaignKeywordsRequest, dict]):
                The request object. Request message for
