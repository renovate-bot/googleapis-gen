...
class BiddingStrategy(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v8.enums.types.BiddingStrategyStatusEnum.BiddingStrategyStatus):
        ...
        enhanced_cpc (google.ads.googleads.v8.common.types.EnhancedCpc):
