...
class GetAdGroupLabelRequest(proto.Message):
    ...
    [AdGroupLabelService.GetAdGroupLabel][google.ads.googleads.v8.services.AdGroupLabelService.GetAdGroupLabel].
...
class MutateAdGroupLabelsRequest(proto.Message):
    r"""Request message for
    [AdGroupLabelService.MutateAdGroupLabels][google.ads.googleads.v8.services.AdGroupLabelService.MutateAdGroupLabels].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose ad group
            labels are being modified.
        operations (Sequence[google.ads.googleads.v8.services.types.AdGroupLabelOperation]):
...
class MutateAdGroupLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateAdGroupLabelResult]):
