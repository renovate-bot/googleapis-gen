...
class GetFeedItemRequest(proto.Message):
    ...
    [FeedItemService.GetFeedItem][google.ads.googleads.v8.services.FeedItemService.GetFeedItem].
...
class MutateFeedItemsRequest(proto.Message):
    r"""Request message for
    [FeedItemService.MutateFeedItems][google.ads.googleads.v8.services.FeedItemService.MutateFeedItems].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose feed
            items are being modified.
        operations (Sequence[google.ads.googleads.v8.services.types.FeedItemOperation]):
...
class FeedItemOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.FeedItem):
            Create operation: No resource name is
            expected for the new feed item.
        update (google.ads.googleads.v8.resources.types.FeedItem):
...
class MutateFeedItemsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateFeedItemResult]):
