...
from .base import CampaignCriterionSimulationServiceTransport, DEFAULT_CLIENT_INFO


class CampaignCriterionSimulationServiceGrpcTransport(CampaignCriterionSimulationServiceTransport):
    ...
    @property
    def get_campaign_criterion_simulation(self) -> Callable[
        ...
        if 'get_campaign_criterion_simulation' not in self._stubs:
            self._stubs['get_campaign_criterion_simulation'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.CampaignCriterionSimulationService/GetCampaignCriterionSimulation',
