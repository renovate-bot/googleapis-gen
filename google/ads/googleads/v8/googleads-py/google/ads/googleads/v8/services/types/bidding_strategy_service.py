...
class MutateBiddingStrategiesRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v8.services.types.BiddingStrategyOperation]):
...
class BiddingStrategyOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.BiddingStrategy):
            Create operation: No resource name is
            expected for the new bidding strategy.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v8.resources.types.BiddingStrategy):
...
class MutateBiddingStrategiesResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateBiddingStrategyResult]):
