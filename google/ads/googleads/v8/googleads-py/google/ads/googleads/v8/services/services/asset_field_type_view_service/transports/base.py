...
class AssetFieldTypeViewServiceTransport(abc.ABC):
    """Abstract transport class for AssetFieldTypeViewService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_asset_field_type_view: gapic_v1.method.wrap_method(
                self.get_asset_field_type_view,
    ...
    def get_asset_field_type_view(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[asset_field_type_view.AssetFieldTypeView]
            ]]:
        raise NotImplementedError()
