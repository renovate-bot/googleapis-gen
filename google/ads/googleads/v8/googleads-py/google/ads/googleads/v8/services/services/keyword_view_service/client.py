...
class KeywordViewServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[KeywordViewServiceTransport]]
...
class KeywordViewServiceClient(metaclass=KeywordViewServiceClientMeta):
    ...
    def transport(self) -> KeywordViewServiceTransport:
        ...
        Returns:
            KeywordViewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiates the keyword view service client.
    ...
    def get_keyword_view(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetKeywordViewRequest, dict]):
                The request object. Request message for
                [KeywordViewService.GetKeywordView][google.ads.googleads.v8.services.KeywordViewService.GetKeywordView].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.KeywordView:
                A keyword view.
        """
