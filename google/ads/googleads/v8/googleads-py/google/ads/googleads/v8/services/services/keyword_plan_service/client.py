...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
    ...
    def get_keyword_plan(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.KeywordPlan:
    ...
    def mutate_keyword_plans(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.KeywordPlanOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateKeywordPlansResponse:
    ...
    def generate_forecast_curve(self,
        ...
        Returns:
            google.ads.googleads.v8.services.types.GenerateForecastCurveResponse:
    ...
    def generate_forecast_time_series(self,
        ...
        Returns:
            google.ads.googleads.v8.services.types.GenerateForecastTimeSeriesResponse:
                Response message for
                [KeywordPlanService.GenerateForecastTimeSeries][google.ads.googleads.v8.services.KeywordPlanService.GenerateForecastTimeSeries].
    ...
    def generate_forecast_metrics(self,
        ...
        Returns:
            google.ads.googleads.v8.services.types.GenerateForecastMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateForecastMetrics][google.ads.googleads.v8.services.KeywordPlanService.GenerateForecastMetrics].
    ...
    def generate_historical_metrics(self,
        ...
        Returns:
            google.ads.googleads.v8.services.types.GenerateHistoricalMetricsResponse:
                Response message for
                [KeywordPlanService.GenerateHistoricalMetrics][google.ads.googleads.v8.services.KeywordPlanService.GenerateHistoricalMetrics].
