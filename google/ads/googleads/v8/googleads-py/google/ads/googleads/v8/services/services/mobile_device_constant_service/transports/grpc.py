...
class MobileDeviceConstantServiceGrpcTransport(MobileDeviceConstantServiceTransport):
    ...
    @property
    def get_mobile_device_constant(self) -> Callable[
            [mobile_device_constant_service.GetMobileDeviceConstantRequest],
            mobile_device_constant.MobileDeviceConstant]:
        r"""Return a callable for the get mobile device constant method over gRPC.
        ...
        if 'get_mobile_device_constant' not in self._stubs:
            self._stubs['get_mobile_device_constant'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.MobileDeviceConstantService/GetMobileDeviceConstant',
