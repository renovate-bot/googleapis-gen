...
from google.ads.googleads.v8.common.types import matching_function as gagc_matching_function
...
class AdGroupFeed(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v8.enums.types.FeedLinkStatusEnum.FeedLinkStatus):
