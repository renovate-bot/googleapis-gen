...
class GoogleAdsServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[GoogleAdsServiceTransport]]
...
class GoogleAdsServiceClient(metaclass=GoogleAdsServiceClientMeta):
    ...
    def parse_ad_group_ad_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_ad_asset_view_path(customer_id: str,ad_group_id: str,ad_id: str,asset_id: str,field_type: str,) -> str:
        """Return a fully-qualified ad_group_ad_asset_view string."""
        return "customers/{customer_id}/adGroupAdAssetViews/{ad_group_id}~{ad_id}~{asset_id}~{field_type}".format(customer_id=customer_id, ad_group_id=ad_group_id, ad_id=ad_id, asset_id=asset_id, field_type=field_type, )
    ...
    def parse_ad_group_ad_asset_view_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/adGroupAdAssetViews/(?P<ad_group_id>.+?)~(?P<ad_id>.+?)~(?P<asset_id>.+?)~(?P<field_type>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_ad_group_criterion_label_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_criterion_simulation_path(customer_id: str,ad_group_id: str,criterion_id: str,type: str,modification_method: str,start_date: str,end_date: str,) -> str:
        """Return a fully-qualified ad_group_criterion_simulation string."""
        return "customers/{customer_id}/adGroupCriterionSimulations/{ad_group_id}~{criterion_id}~{type}~{modification_method}~{start_date}~{end_date}".format(customer_id=customer_id, ad_group_id=ad_group_id, criterion_id=criterion_id, type=type, modification_method=modification_method, start_date=start_date, end_date=end_date, )
    ...
    def parse_ad_group_criterion_simulation_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/adGroupCriterionSimulations/(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)~(?P<type>.+?)~(?P<modification_method>.+?)~(?P<start_date>.+?)~(?P<end_date>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_ad_group_label_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def ad_group_simulation_path(customer_id: str,ad_group_id: str,type: str,modification_method: str,start_date: str,end_date: str,) -> str:
        """Return a fully-qualified ad_group_simulation string."""
        return "customers/{customer_id}/adGroupSimulations/{ad_group_id}~{type}~{modification_method}~{start_date}~{end_date}".format(customer_id=customer_id, ad_group_id=ad_group_id, type=type, modification_method=modification_method, start_date=start_date, end_date=end_date, )

    @staticmethod
    def parse_ad_group_simulation_path(path: str) -> Dict[str,str]:
        """Parse a ad_group_simulation path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/adGroupSimulations/(?P<ad_group_id>.+?)~(?P<type>.+?)~(?P<modification_method>.+?)~(?P<start_date>.+?)~(?P<end_date>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_ad_parameter_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def ad_schedule_view_path(customer_id: str,campaign_id: str,criterion_id: str,) -> str:
        """Return a fully-qualified ad_schedule_view string."""
        return "customers/{customer_id}/adScheduleViews/{campaign_id}~{criterion_id}".format(customer_id=customer_id, campaign_id=campaign_id, criterion_id=criterion_id, )

    @staticmethod
    def parse_ad_schedule_view_path(path: str) -> Dict[str,str]:
        """Parse a ad_schedule_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/adScheduleViews/(?P<campaign_id>.+?)~(?P<criterion_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def asset_field_type_view_path(customer_id: str,field_type: str,) -> str:
        ...
        return "customers/{customer_id}/assetFieldTypeViews/{field_type}".format(customer_id=customer_id, field_type=field_type, )

    @staticmethod
    def parse_asset_field_type_view_path(path: str) -> Dict[str,str]:
        """Parse a asset_field_type_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/assetFieldTypeViews/(?P<field_type>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_batch_job_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def bidding_data_exclusion_path(customer_id: str,seasonality_event_id: str,) -> str:
        """Return a fully-qualified bidding_data_exclusion string."""
        return "customers/{customer_id}/biddingDataExclusions/{seasonality_event_id}".format(customer_id=customer_id, seasonality_event_id=seasonality_event_id, )
    ...
    def parse_bidding_data_exclusion_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/biddingDataExclusions/(?P<seasonality_event_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def bidding_seasonality_adjustment_path(customer_id: str,seasonality_event_id: str,) -> str:
        ...
        return "customers/{customer_id}/biddingSeasonalityAdjustments/{seasonality_event_id}".format(customer_id=customer_id, seasonality_event_id=seasonality_event_id, )
    ...
    def parse_bidding_seasonality_adjustment_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/biddingSeasonalityAdjustments/(?P<seasonality_event_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def bidding_strategy_simulation_path(customer_id: str,bidding_strategy_id: str,type: str,modification_method: str,start_date: str,end_date: str,) -> str:
        ...
        return "customers/{customer_id}/biddingStrategySimulations/{bidding_strategy_id}~{type}~{modification_method}~{start_date}~{end_date}".format(customer_id=customer_id, bidding_strategy_id=bidding_strategy_id, type=type, modification_method=modification_method, start_date=start_date, end_date=end_date, )

    @staticmethod
    def parse_bidding_strategy_simulation_path(path: str) -> Dict[str,str]:
        """Parse a bidding_strategy_simulation path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/biddingStrategySimulations/(?P<bidding_strategy_id>.+?)~(?P<type>.+?)~(?P<modification_method>.+?)~(?P<start_date>.+?)~(?P<end_date>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def call_view_path(customer_id: str,call_detail_id: str,) -> str:
        ...
        return "customers/{customer_id}/callViews/{call_detail_id}".format(customer_id=customer_id, call_detail_id=call_detail_id, )

    @staticmethod
    def parse_call_view_path(path: str) -> Dict[str,str]:
        """Parse a call_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/callViews/(?P<call_detail_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def carrier_constant_path(criterion_id: str,) -> str:
        ...
        return "carrierConstants/{criterion_id}".format(criterion_id=criterion_id, )
    ...
    def parse_carrier_constant_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def change_event_path(customer_id: str,timestamp_micros: str,command_index: str,mutate_index: str,) -> str:
        """Return a fully-qualified change_event string."""
        return "customers/{customer_id}/changeEvents/{timestamp_micros}~{command_index}~{mutate_index}".format(customer_id=customer_id, timestamp_micros=timestamp_micros, command_index=command_index, mutate_index=mutate_index, )

    @staticmethod
    def parse_change_event_path(path: str) -> Dict[str,str]:
        """Parse a change_event path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/changeEvents/(?P<timestamp_micros>.+?)~(?P<command_index>.+?)~(?P<mutate_index>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def change_status_path(customer_id: str,change_status_id: str,) -> str:
        """Return a fully-qualified change_status string."""
        return "customers/{customer_id}/changeStatus/{change_status_id}".format(customer_id=customer_id, change_status_id=change_status_id, )

    @staticmethod
    def parse_change_status_path(path: str) -> Dict[str,str]:
        """Parse a change_status path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/changeStatus/(?P<change_status_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def click_view_path(customer_id: str,date: str,gclid: str,) -> str:
        """Return a fully-qualified click_view string."""
        return "customers/{customer_id}/clickViews/{date}~{gclid}".format(customer_id=customer_id, date=date, gclid=gclid, )

    @staticmethod
    def parse_click_view_path(path: str) -> Dict[str,str]:
        """Parse a click_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/clickViews/(?P<date>.+?)~(?P<gclid>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def conversion_value_rule_path(customer_id: str,conversion_value_rule_id: str,) -> str:
        ...
        return "customers/{customer_id}/conversionValueRules/{conversion_value_rule_id}".format(customer_id=customer_id, conversion_value_rule_id=conversion_value_rule_id, )

    @staticmethod
    def parse_conversion_value_rule_path(path: str) -> Dict[str,str]:
        """Parse a conversion_value_rule path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/conversionValueRules/(?P<conversion_value_rule_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def conversion_value_rule_set_path(customer_id: str,conversion_value_rule_set_id: str,) -> str:
        """Return a fully-qualified conversion_value_rule_set string."""
        return "customers/{customer_id}/conversionValueRuleSets/{conversion_value_rule_set_id}".format(customer_id=customer_id, conversion_value_rule_set_id=conversion_value_rule_set_id, )
    ...
    def parse_conversion_value_rule_set_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/conversionValueRuleSets/(?P<conversion_value_rule_set_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def customer_client_path(customer_id: str,client_customer_id: str,) -> str:
        ...
        return "customers/{customer_id}/customerClients/{client_customer_id}".format(customer_id=customer_id, client_customer_id=client_customer_id, )

    @staticmethod
    def parse_customer_client_path(path: str) -> Dict[str,str]:
        """Parse a customer_client path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/customerClients/(?P<client_customer_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def customer_client_link_path(customer_id: str,client_customer_id: str,manager_link_id: str,) -> str:
        """Return a fully-qualified customer_client_link string."""
        return "customers/{customer_id}/customerClientLinks/{client_customer_id}~{manager_link_id}".format(customer_id=customer_id, client_customer_id=client_customer_id, manager_link_id=manager_link_id, )
    ...
    def parse_customer_user_access_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def customer_user_access_invitation_path(customer_id: str,invitation_id: str,) -> str:
    ...
    def custom_interest_path(customer_id: str,custom_interest_id: str,) -> str:
        ...
        return "customers/{customer_id}/customInterests/{custom_interest_id}".format(customer_id=customer_id, custom_interest_id=custom_interest_id, )

    @staticmethod
    def parse_custom_interest_path(path: str) -> Dict[str,str]:
        """Parse a custom_interest path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/customInterests/(?P<custom_interest_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def detailed_demographic_path(customer_id: str,detailed_demographic_id: str,) -> str:
        """Return a fully-qualified detailed_demographic string."""
        return "customers/{customer_id}/detailedDemographics/{detailed_demographic_id}".format(customer_id=customer_id, detailed_demographic_id=detailed_demographic_id, )

    @staticmethod
    def parse_detailed_demographic_path(path: str) -> Dict[str,str]:
        """Parse a detailed_demographic path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/detailedDemographics/(?P<detailed_demographic_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def detail_placement_view_path(customer_id: str,ad_group_id: str,base64_placement: str,) -> str:
        ...
        return "customers/{customer_id}/detailPlacementViews/{ad_group_id}~{base64_placement}".format(customer_id=customer_id, ad_group_id=ad_group_id, base64_placement=base64_placement, )

    @staticmethod
    def parse_detail_placement_view_path(path: str) -> Dict[str,str]:
        """Parse a detail_placement_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/detailPlacementViews/(?P<ad_group_id>.+?)~(?P<base64_placement>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def display_keyword_view_path(customer_id: str,ad_group_id: str,criterion_id: str,) -> str:
        """Return a fully-qualified display_keyword_view string."""
        return "customers/{customer_id}/displayKeywordViews/{ad_group_id}~{criterion_id}".format(customer_id=customer_id, ad_group_id=ad_group_id, criterion_id=criterion_id, )

    @staticmethod
    def parse_display_keyword_view_path(path: str) -> Dict[str,str]:
        """Parse a display_keyword_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/displayKeywordViews/(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def distance_view_path(customer_id: str,placeholder_chain_id: str,distance_bucket: str,) -> str:
        """Return a fully-qualified distance_view string."""
        return "customers/{customer_id}/distanceViews/{placeholder_chain_id}~{distance_bucket}".format(customer_id=customer_id, placeholder_chain_id=placeholder_chain_id, distance_bucket=distance_bucket, )

    @staticmethod
    def parse_distance_view_path(path: str) -> Dict[str,str]:
        """Parse a distance_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/distanceViews/(?P<placeholder_chain_id>.+?)~(?P<distance_bucket>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def domain_category_path(customer_id: str,campaign_id: str,base64_category: str,language_code: str,) -> str:
        """Return a fully-qualified domain_category string."""
        return "customers/{customer_id}/domainCategories/{campaign_id}~{base64_category}~{language_code}".format(customer_id=customer_id, campaign_id=campaign_id, base64_category=base64_category, language_code=language_code, )

    @staticmethod
    def parse_domain_category_path(path: str) -> Dict[str,str]:
        """Parse a domain_category path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/domainCategories/(?P<campaign_id>.+?)~(?P<base64_category>.+?)~(?P<language_code>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_dynamic_search_ads_search_term_view_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/dynamicSearchAdsSearchTermViews/(?P<ad_group_id>.+?)~(?P<search_term_fingerprint>.+?)~(?P<headline_fingerprint>.+?)~(?P<landing_page_fingerprint>.+?)~(?P<page_url_fingerprint>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def expanded_landing_page_view_path(customer_id: str,expanded_final_url_fingerprint: str,) -> str:
        """Return a fully-qualified expanded_landing_page_view string."""
        return "customers/{customer_id}/expandedLandingPageViews/{expanded_final_url_fingerprint}".format(customer_id=customer_id, expanded_final_url_fingerprint=expanded_final_url_fingerprint, )
    ...
    def parse_expanded_landing_page_view_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/expandedLandingPageViews/(?P<expanded_final_url_fingerprint>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_feed_placeholder_view_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/feedPlaceholderViews/(?P<placeholder_type>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_gender_view_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def geographic_view_path(customer_id: str,country_criterion_id: str,location_type: str,) -> str:
        """Return a fully-qualified geographic_view string."""
        return "customers/{customer_id}/geographicViews/{country_criterion_id}~{location_type}".format(customer_id=customer_id, country_criterion_id=country_criterion_id, location_type=location_type, )

    @staticmethod
    def parse_geographic_view_path(path: str) -> Dict[str,str]:
        """Parse a geographic_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/geographicViews/(?P<country_criterion_id>.+?)~(?P<location_type>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_geo_target_constant_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def group_placement_view_path(customer_id: str,ad_group_id: str,base64_placement: str,) -> str:
        """Return a fully-qualified group_placement_view string."""
        return "customers/{customer_id}/groupPlacementViews/{ad_group_id}~{base64_placement}".format(customer_id=customer_id, ad_group_id=ad_group_id, base64_placement=base64_placement, )

    @staticmethod
    def parse_group_placement_view_path(path: str) -> Dict[str,str]:
        """Parse a group_placement_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/groupPlacementViews/(?P<ad_group_id>.+?)~(?P<base64_placement>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def hotel_group_view_path(customer_id: str,ad_group_id: str,criterion_id: str,) -> str:
        """Return a fully-qualified hotel_group_view string."""
        return "customers/{customer_id}/hotelGroupViews/{ad_group_id}~{criterion_id}".format(customer_id=customer_id, ad_group_id=ad_group_id, criterion_id=criterion_id, )

    @staticmethod
    def parse_hotel_group_view_path(path: str) -> Dict[str,str]:
        """Parse a hotel_group_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/hotelGroupViews/(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_hotel_performance_view_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/hotelPerformanceView$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def income_range_view_path(customer_id: str,ad_group_id: str,criterion_id: str,) -> str:
        """Return a fully-qualified income_range_view string."""
        return "customers/{customer_id}/incomeRangeViews/{ad_group_id}~{criterion_id}".format(customer_id=customer_id, ad_group_id=ad_group_id, criterion_id=criterion_id, )

    @staticmethod
    def parse_income_range_view_path(path: str) -> Dict[str,str]:
        """Parse a income_range_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/incomeRangeViews/(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def keyword_theme_constant_path(express_category_id: str,express_sub_category_id: str,) -> str:
        """Return a fully-qualified keyword_theme_constant string."""
        return "keywordThemeConstants/{express_category_id}~{express_sub_category_id}".format(express_category_id=express_category_id, express_sub_category_id=express_sub_category_id, )

    @staticmethod
    def parse_keyword_theme_constant_path(path: str) -> Dict[str,str]:
        """Parse a keyword_theme_constant path into its component segments."""
        m = re.match(r"^keywordThemeConstants/(?P<express_category_id>.+?)~(?P<express_sub_category_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_label_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def landing_page_view_path(customer_id: str,unexpanded_final_url_fingerprint: str,) -> str:
        """Return a fully-qualified landing_page_view string."""
        return "customers/{customer_id}/landingPageViews/{unexpanded_final_url_fingerprint}".format(customer_id=customer_id, unexpanded_final_url_fingerprint=unexpanded_final_url_fingerprint, )

    @staticmethod
    def parse_landing_page_view_path(path: str) -> Dict[str,str]:
        """Parse a landing_page_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/landingPageViews/(?P<unexpanded_final_url_fingerprint>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def life_event_path(customer_id: str,life_event_id: str,) -> str:
        ...
        return "customers/{customer_id}/lifeEvents/{life_event_id}".format(customer_id=customer_id, life_event_id=life_event_id, )

    @staticmethod
    def parse_life_event_path(path: str) -> Dict[str,str]:
        """Parse a life_event path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/lifeEvents/(?P<life_event_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_location_view_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def managed_placement_view_path(customer_id: str,ad_group_id: str,criterion_id: str,) -> str:
        """Return a fully-qualified managed_placement_view string."""
        return "customers/{customer_id}/managedPlacementViews/{ad_group_id}~{criterion_id}".format(customer_id=customer_id, ad_group_id=ad_group_id, criterion_id=criterion_id, )
    ...
    def parse_managed_placement_view_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/managedPlacementViews/(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def mobile_app_category_constant_path(mobile_app_category_id: str,) -> str:
        ...
        return "mobileAppCategoryConstants/{mobile_app_category_id}".format(mobile_app_category_id=mobile_app_category_id, )
    ...
    def parse_mobile_app_category_constant_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^mobileAppCategoryConstants/(?P<mobile_app_category_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def offline_user_data_job_path(customer_id: str,offline_user_data_update_id: str,) -> str:
        ...
        return "customers/{customer_id}/offlineUserDataJobs/{offline_user_data_update_id}".format(customer_id=customer_id, offline_user_data_update_id=offline_user_data_update_id, )
    ...
    def operating_system_version_constant_path(criterion_id: str,) -> str:
        ...
        return "operatingSystemVersionConstants/{criterion_id}".format(criterion_id=criterion_id, )
    ...
    def parse_operating_system_version_constant_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^operatingSystemVersionConstants/(?P<criterion_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def paid_organic_search_term_view_path(customer_id: str,campaign_id: str,ad_group_id: str,base64_search_term: str,) -> str:
        """Return a fully-qualified paid_organic_search_term_view string."""
        return "customers/{customer_id}/paidOrganicSearchTermViews/{campaign_id}~{ad_group_id}~{base64_search_term}".format(customer_id=customer_id, campaign_id=campaign_id, ad_group_id=ad_group_id, base64_search_term=base64_search_term, )
    ...
    def parse_paid_organic_search_term_view_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/paidOrganicSearchTermViews/(?P<campaign_id>.+?)~(?P<ad_group_id>.+?)~(?P<base64_search_term>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def parental_status_view_path(customer_id: str,ad_group_id: str,criterion_id: str,) -> str:
        """Return a fully-qualified parental_status_view string."""
        return "customers/{customer_id}/parentalStatusViews/{ad_group_id}~{criterion_id}".format(customer_id=customer_id, ad_group_id=ad_group_id, criterion_id=criterion_id, )

    @staticmethod
    def parse_parental_status_view_path(path: str) -> Dict[str,str]:
        """Parse a parental_status_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/parentalStatusViews/(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_payments_account_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def product_bidding_category_constant_path(country_code: str,level: str,id: str,) -> str:
    ...
    def parse_product_bidding_category_constant_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^productBiddingCategoryConstants/(?P<country_code>.+?)~(?P<level>.+?)~(?P<id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def recommendation_path(customer_id: str,recommendation_id: str,) -> str:
        ...
        return "customers/{customer_id}/recommendations/{recommendation_id}".format(customer_id=customer_id, recommendation_id=recommendation_id, )

    @staticmethod
    def parse_recommendation_path(path: str) -> Dict[str,str]:
        """Parse a recommendation path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/recommendations/(?P<recommendation_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_remarketing_action_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def search_term_view_path(customer_id: str,campaign_id: str,ad_group_id: str,query: str,) -> str:
        """Return a fully-qualified search_term_view string."""
        return "customers/{customer_id}/searchTermViews/{campaign_id}~{ad_group_id}~{query}".format(customer_id=customer_id, campaign_id=campaign_id, ad_group_id=ad_group_id, query=query, )

    @staticmethod
    def parse_search_term_view_path(path: str) -> Dict[str,str]:
        """Parse a search_term_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/searchTermViews/(?P<campaign_id>.+?)~(?P<ad_group_id>.+?)~(?P<query>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_shopping_performance_view_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def smart_campaign_search_term_view_path(customer_id: str,campaign_id: str,query: str,) -> str:
        """Return a fully-qualified smart_campaign_search_term_view string."""
        return "customers/{customer_id}/smartCampaignSearchTermViews/{campaign_id}~{query}".format(customer_id=customer_id, campaign_id=campaign_id, query=query, )

    @staticmethod
    def parse_smart_campaign_search_term_view_path(path: str) -> Dict[str,str]:
        """Parse a smart_campaign_search_term_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/smartCampaignSearchTermViews/(?P<campaign_id>.+?)~(?P<query>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def smart_campaign_setting_path(customer_id: str,campaign_id: str,) -> str:
        """Return a fully-qualified smart_campaign_setting string."""
        return "customers/{customer_id}/smartCampaignSettings/{campaign_id}".format(customer_id=customer_id, campaign_id=campaign_id, )

    @staticmethod
    def parse_smart_campaign_setting_path(path: str) -> Dict[str,str]:
        """Parse a smart_campaign_setting path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/smartCampaignSettings/(?P<campaign_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def third_party_app_analytics_link_path(customer_id: str,customer_link_id: str,) -> str:
        """Return a fully-qualified third_party_app_analytics_link string."""
        return "customers/{customer_id}/thirdPartyAppAnalyticsLinks/{customer_link_id}".format(customer_id=customer_id, customer_link_id=customer_link_id, )
    ...
    def parse_third_party_app_analytics_link_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^customers/(?P<customer_id>.+?)/thirdPartyAppAnalyticsLinks/(?P<customer_link_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_topic_constant_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def topic_view_path(customer_id: str,ad_group_id: str,criterion_id: str,) -> str:
        """Return a fully-qualified topic_view string."""
        return "customers/{customer_id}/topicViews/{ad_group_id}~{criterion_id}".format(customer_id=customer_id, ad_group_id=ad_group_id, criterion_id=criterion_id, )

    @staticmethod
    def parse_topic_view_path(path: str) -> Dict[str,str]:
        """Parse a topic_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/topicViews/(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    ...
    def parse_user_list_path(path: str) -> Dict[str,str]:
        ...
        return m.groupdict() if m else {}
    @staticmethod
    def user_location_view_path(customer_id: str,country_criterion_id: str,is_targeting_location: str,) -> str:
        """Return a fully-qualified user_location_view string."""
        return "customers/{customer_id}/userLocationViews/{country_criterion_id}~{is_targeting_location}".format(customer_id=customer_id, country_criterion_id=country_criterion_id, is_targeting_location=is_targeting_location, )

    @staticmethod
    def parse_user_location_view_path(path: str) -> Dict[str,str]:
        """Parse a user_location_view path into its component segments."""
        m = re.match(r"^customers/(?P<customer_id>.+?)/userLocationViews/(?P<country_criterion_id>.+?)~(?P<is_targeting_location>.+?)$", path)
        return m.groupdict() if m else {}
    @staticmethod
    def video_path(customer_id: str,video_id: str,) -> str:
        """Return a fully-qualified video string."""
        return "customers/{customer_id}/videos/{video_id}".format(customer_id=customer_id, video_id=video_id, )
    ...
    def webpage_view_path(customer_id: str,ad_group_id: str,criterion_id: str,) -> str:
        """Return a fully-qualified webpage_view string."""
    ...
    def parse_webpage_view_path(path: str) -> Dict[str,str]:
        """Parse a webpage_view path into its component segments."""
    ...
    def search(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.SearchGoogleAdsRequest, dict]):
                The request object. Request message for
                [GoogleAdsService.Search][google.ads.googleads.v8.services.GoogleAdsService.Search].
        ...
        Returns:
            google.ads.googleads.v8.services.services.google_ads_service.pagers.SearchPager:
    ...
    def search_stream(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.SearchGoogleAdsStreamRequest, dict]):
                The request object. Request message for
                [GoogleAdsService.SearchStream][google.ads.googleads.v8.services.GoogleAdsService.SearchStream].
            customer_id (:class:`str`):
                Required. The ID of the customer
                being queried.
        ...
        Returns:
            Iterable[google.ads.googleads.v8.services.types.SearchGoogleAdsStreamResponse]:
                Response message for
                [GoogleAdsService.SearchStream][google.ads.googleads.v8.services.GoogleAdsService.SearchStream].
    ...
    def mutate(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateGoogleAdsRequest, dict]):
                The request object. Request message for
                [GoogleAdsService.Mutate][google.ads.googleads.v8.services.GoogleAdsService.Mutate].
            customer_id (:class:`str`):
                Required. The ID of the customer
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mutate_operations (:class:`Sequence[google.ads.googleads.v8.services.types.MutateOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateGoogleAdsResponse:
                Response message for
                [GoogleAdsService.Mutate][google.ads.googleads.v8.services.GoogleAdsService.Mutate].
