...
class KeywordViewServiceTransport(abc.ABC):
    """Abstract transport class for KeywordViewService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_keyword_view: gapic_v1.method.wrap_method(
    ...
    def get_keyword_view(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[keyword_view.KeywordView]
            ]]:
        raise NotImplementedError()


__all__ = (
    'KeywordViewServiceTransport',
)
