...
from .transports.base import AccessibleBiddingStrategyServiceTransport, DEFAULT_CLIENT_INFO
...
class AccessibleBiddingStrategyServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AccessibleBiddingStrategyServiceTransport]]
...
class AccessibleBiddingStrategyServiceClient(metaclass=AccessibleBiddingStrategyServiceClientMeta):
    ...
    def transport(self) -> AccessibleBiddingStrategyServiceTransport:
        ...
        Returns:
            AccessibleBiddingStrategyServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, AccessibleBiddingStrategyServiceTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the accessible bidding strategy service client.
    ...
    def get_accessible_bidding_strategy(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.AccessibleBiddingStrategy:
        ...
        if not isinstance(request, accessible_bidding_strategy_service.GetAccessibleBiddingStrategyRequest):
            request = accessible_bidding_strategy_service.GetAccessibleBiddingStrategyRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_accessible_bidding_strategy]
