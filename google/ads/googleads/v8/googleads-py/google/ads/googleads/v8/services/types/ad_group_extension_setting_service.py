...
class MutateAdGroupExtensionSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v8.services.types.AdGroupExtensionSettingOperation]):
...
class AdGroupExtensionSettingOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.AdGroupExtensionSetting):
            Create operation: No resource name is
            expected for the new ad group extension setting.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v8.resources.types.AdGroupExtensionSetting):
...
class MutateAdGroupExtensionSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateAdGroupExtensionSettingResult]):
