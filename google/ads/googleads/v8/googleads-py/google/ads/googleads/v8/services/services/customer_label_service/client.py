...
class CustomerLabelServiceClient(metaclass=CustomerLabelServiceClientMeta):
    ...
    def get_customer_label(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetCustomerLabelRequest`):
    ...
    def mutate_customer_labels(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateCustomerLabelsRequest`):
                The request object. Request message for
