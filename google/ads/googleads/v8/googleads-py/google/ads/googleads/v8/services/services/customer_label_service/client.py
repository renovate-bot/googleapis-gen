...
class CustomerLabelServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CustomerLabelServiceTransport]]
...
class CustomerLabelServiceClient(metaclass=CustomerLabelServiceClientMeta):
    ...
    def get_customer_label(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetCustomerLabelRequest, dict]):
                The request object. Request message for
                [CustomerLabelService.GetCustomerLabel][google.ads.googleads.v8.services.CustomerLabelService.GetCustomerLabel].
        ...
        Returns:
            google.ads.googleads.v8.resources.types.CustomerLabel:
        ...
        if not isinstance(request, customer_label_service.GetCustomerLabelRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_customer_label]
    ...
    def mutate_customer_labels(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateCustomerLabelsRequest, dict]):
                The request object. Request message for
                [CustomerLabelService.MutateCustomerLabels][google.ads.googleads.v8.services.CustomerLabelService.MutateCustomerLabels].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.CustomerLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateCustomerLabelsResponse:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, customer_label_service.MutateCustomerLabelsRequest):
            request = customer_label_service.MutateCustomerLabelsRequest(request)
             # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.mutate_customer_labels]
