...
class KeywordPlanAdGroupServiceClient(metaclass=KeywordPlanAdGroupServiceClientMeta):
    ...
    def get_keyword_plan_ad_group(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetKeywordPlanAdGroupRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.KeywordPlanAdGroup:
    ...
    def mutate_keyword_plan_ad_groups(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateKeywordPlanAdGroupsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateKeywordPlanAdGroupsResponse:
