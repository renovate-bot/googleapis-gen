...
class KeywordPlanAdGroupServiceClient(metaclass=KeywordPlanAdGroupServiceClientMeta):
    ...
    def get_keyword_plan_ad_group(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetKeywordPlanAdGroupRequest`):
    ...
    def mutate_keyword_plan_ad_groups(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateKeywordPlanAdGroupsRequest`):
                The request object. Request message for
