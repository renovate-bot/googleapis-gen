...
class FeedServiceClient(metaclass=FeedServiceClientMeta):
    ...
    def get_feed(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.Feed:
                A feed.
        """
    ...
    def mutate_feeds(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.FeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateFeedsResponse:
