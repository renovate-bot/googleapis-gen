...
class GetCampaignFeedRequest(proto.Message):
    ...
    [CampaignFeedService.GetCampaignFeed][google.ads.googleads.v8.services.CampaignFeedService.GetCampaignFeed].
...
class MutateCampaignFeedsRequest(proto.Message):
    r"""Request message for
    [CampaignFeedService.MutateCampaignFeeds][google.ads.googleads.v8.services.CampaignFeedService.MutateCampaignFeeds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            campaign feeds are being modified.
        operations (Sequence[google.ads.googleads.v8.services.types.CampaignFeedOperation]):
...
class MutateCampaignFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateCampaignFeedResult]):
