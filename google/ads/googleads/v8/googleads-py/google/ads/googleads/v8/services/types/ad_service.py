...
class MutateAdsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            are being modified.
        operations (Sequence[google.ads.googleads.v8.services.types.AdOperation]):
...
class AdOperation(proto.Message):
    ...
    Attributes:
        ...
        policy_validation_parameter (google.ads.googleads.v8.common.types.PolicyValidationParameter):
            Configuration for how policies are validated.
        update (google.ads.googleads.v8.resources.types.Ad):
...
class MutateAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateAdResult]):
