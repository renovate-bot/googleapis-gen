...
class CampaignSimulationServiceGrpcTransport(CampaignSimulationServiceTransport):
    """gRPC backend transport for CampaignSimulationService.
    ...
    def get_campaign_simulation(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetCampaignSimulationRequest],
                    ~.CampaignSimulation]:
        ...
        if 'get_campaign_simulation' not in self._stubs:
            self._stubs['get_campaign_simulation'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.CampaignSimulationService/GetCampaignSimulation',
                request_serializer=campaign_simulation_service.GetCampaignSimulationRequest.serialize,
                response_deserializer=campaign_simulation.CampaignSimulation.deserialize,
            )
        return self._stubs['get_campaign_simulation']

    def close(self):
        self.grpc_channel.close()

__all__ = (
    'CampaignSimulationServiceGrpcTransport',
)
