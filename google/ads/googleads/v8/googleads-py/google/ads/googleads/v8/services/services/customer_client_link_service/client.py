...
class CustomerClientLinkServiceClient(metaclass=CustomerClientLinkServiceClientMeta):
    ...
    def get_customer_client_link(self,
        ...
        r"""Returns the requested CustomerClientLink in full detail.
        ...
        Returns:
            google.ads.googleads.v8.resources.types.CustomerClientLink:
    ...
    def mutate_customer_client_link(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v8.services.types.CustomerClientLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateCustomerClientLinkResponse:
