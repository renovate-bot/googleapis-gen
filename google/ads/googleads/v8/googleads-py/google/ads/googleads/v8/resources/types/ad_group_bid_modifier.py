...
from google.ads.googleads.v8.enums.types import bid_modifier_source as gage_bid_modifier_source
...
class AdGroupBidModifier(proto.Message):
    ...
    Attributes:
        ...
        bid_modifier_source (google.ads.googleads.v8.enums.types.BidModifierSourceEnum.BidModifierSource):
            Output only. Bid modifier source.
        hotel_date_selection_type (google.ads.googleads.v8.common.types.HotelDateSelectionTypeInfo):
            Immutable. Criterion for hotel date selection
            (default dates vs. user selected).

            This field is a member of `oneof`_ ``criterion``.
        hotel_advance_booking_window (google.ads.googleads.v8.common.types.HotelAdvanceBookingWindowInfo):
            Immutable. Criterion for number of days prior
            to the stay the booking is being made.

            This field is a member of `oneof`_ ``criterion``.
        hotel_length_of_stay (google.ads.googleads.v8.common.types.HotelLengthOfStayInfo):
            Immutable. Criterion for length of hotel stay
            in nights.

            This field is a member of `oneof`_ ``criterion``.
        hotel_check_in_day (google.ads.googleads.v8.common.types.HotelCheckInDayInfo):
        ...
        device (google.ads.googleads.v8.common.types.DeviceInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        preferred_content (google.ads.googleads.v8.common.types.PreferredContentInfo):
            Immutable. A preferred content criterion.

            This field is a member of `oneof`_ ``criterion``.
        hotel_check_in_date_range (google.ads.googleads.v8.common.types.HotelCheckInDateRangeInfo):
