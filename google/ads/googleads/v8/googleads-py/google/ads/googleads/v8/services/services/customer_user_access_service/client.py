...
class CustomerUserAccessServiceClient(metaclass=CustomerUserAccessServiceClientMeta):
    ...
    def get_customer_user_access(self,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.CustomerUserAccess:
    ...
    def mutate_customer_user_access(self,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v8.services.types.CustomerUserAccessOperation`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateCustomerUserAccessResponse:
