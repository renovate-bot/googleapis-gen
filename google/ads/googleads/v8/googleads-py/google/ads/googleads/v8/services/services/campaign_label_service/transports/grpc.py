...
class CampaignLabelServiceGrpcTransport(CampaignLabelServiceTransport):
    ...
    def get_campaign_label(self) -> Callable[
        ...
        Returns the requested campaign-label relationship in full
        detail.
    ...
    def mutate_campaign_labels(self) -> Callable[
        ...
        Creates and removes campaign-label relationships. Operation
        ...
        if 'mutate_campaign_labels' not in self._stubs:
            self._stubs['mutate_campaign_labels'] = self.grpc_channel.unary_unary(
