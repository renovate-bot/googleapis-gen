...
class CustomerFeedServiceClient(metaclass=CustomerFeedServiceClientMeta):
    ...
    def get_customer_feed(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetCustomerFeedRequest`):
    ...
    def mutate_customer_feeds(self,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateCustomerFeedsRequest`):
                The request object. Request message for
