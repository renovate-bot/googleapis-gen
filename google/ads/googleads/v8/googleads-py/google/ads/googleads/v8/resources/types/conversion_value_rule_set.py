...
class ConversionValueRuleSet(proto.Message):
    ...
    Attributes:
        ...
        dimensions (Sequence[google.ads.googleads.v8.enums.types.ValueRuleSetDimensionEnum.ValueRuleSetDimension]):
        ...
        owner_customer (str):
            ...
            \*\* Read-only \*\*
        attachment_type (google.ads.googleads.v8.enums.types.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType):
            Defines the scope where the conversion value
            rule set is attached.
        campaign (str):
            The resource name of the campaign when the
            conversion value rule set is attached to a
            campaign.
        status (google.ads.googleads.v8.enums.types.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus):
