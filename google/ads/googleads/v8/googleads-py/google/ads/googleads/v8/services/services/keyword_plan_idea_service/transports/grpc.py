...
class KeywordPlanIdeaServiceGrpcTransport(KeywordPlanIdeaServiceTransport):
    ...
    @property
    def generate_keyword_ideas(self) -> Callable[
        ...
        if 'generate_keyword_ideas' not in self._stubs:
            self._stubs['generate_keyword_ideas'] = self.grpc_channel.unary_unary(
                '/google.ads.googleads.v8.services.KeywordPlanIdeaService/GenerateKeywordIdeas',
