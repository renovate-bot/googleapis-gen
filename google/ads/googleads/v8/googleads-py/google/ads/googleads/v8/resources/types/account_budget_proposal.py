...
class AccountBudgetProposal(proto.Message):
    ...
    Attributes:
        ...
        proposal_type (google.ads.googleads.v8.enums.types.AccountBudgetProposalTypeEnum.AccountBudgetProposalType):
            Immutable. The type of this proposal, e.g.
            END to end the budget associated with this
            proposal.
        status (google.ads.googleads.v8.enums.types.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus):
        ...
        proposed_start_date_time (str):
            ...
            yyyy-mm-dd hh:mm:ss format.
        proposed_start_time_type (google.ads.googleads.v8.enums.types.TimeTypeEnum.TimeType):
        ...
        proposed_end_date_time (str):
            ...
            yyyy-mm-dd hh:mm:ss format.
        proposed_end_time_type (google.ads.googleads.v8.enums.types.TimeTypeEnum.TimeType):
        ...
        approved_end_date_time (str):
            ...
            yyyy-mm-dd hh:mm:ss format.
        approved_end_time_type (google.ads.googleads.v8.enums.types.TimeTypeEnum.TimeType):
        ...
        proposed_spending_limit_type (google.ads.googleads.v8.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
        ...
        approved_spending_limit_micros (int):
            ...
            micros.  One million is equivalent to one unit.
        approved_spending_limit_type (google.ads.googleads.v8.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
