...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def get_feed_item_target(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.GetFeedItemTargetRequest, dict]):
    ...
    def mutate_feed_item_targets(self,
        ...
        Args:
            request (Union[google.ads.googleads.v8.services.types.MutateFeedItemTargetsRequest, dict]):
                The request object. Request message for
