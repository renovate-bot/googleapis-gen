...
class FeedMappingServiceTransport(abc.ABC):
    """Abstract transport class for FeedMappingService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_feed_mapping: gapic_v1.method.wrap_method(
                self.get_feed_mapping,
                default_timeout=None,
                client_info=client_info,
            ),
            self.mutate_feed_mappings: gapic_v1.method.wrap_method(
                self.mutate_feed_mappings,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    def get_feed_mapping(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[feed_mapping.FeedMapping]
            ]]:
        raise NotImplementedError()
