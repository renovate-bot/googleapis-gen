...
class FeedPlaceholderViewServiceTransport(abc.ABC):
    """Abstract transport class for FeedPlaceholderViewService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_feed_placeholder_view: gapic_v1.method.wrap_method(
                self.get_feed_placeholder_view,
    ...
    def get_feed_placeholder_view(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[feed_placeholder_view.FeedPlaceholderView]
            ]]:
        raise NotImplementedError()
