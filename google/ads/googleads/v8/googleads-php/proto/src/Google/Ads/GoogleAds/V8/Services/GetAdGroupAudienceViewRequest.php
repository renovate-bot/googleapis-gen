 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.GetAdGroupAudienceViewRequest</code>
 */
class GetAdGroupAudienceViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Services\AdGroupAudienceViewService::initOnce();
