...
namespace Google\Ads\GoogleAds\V8\Resources\Recommendation\TargetCpaOptInRecommendation;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption</code>
 */
class TargetCpaOptInRecommendationOption extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal goal = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $goal = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.resources.Recommendation.RecommendationImpact impact = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Amount is specified in micros, where one million is equivalent to one
     *           currency unit.
     *     @type \Google\Ads\GoogleAds\V8\Resources\Recommendation\RecommendationImpact $impact
     *           Output only. The impact estimate if this option is selected.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\TargetCpaOptInRecommendationGoalEnum\TargetCpaOptInRecommendationGoal::class);
        $this->goal = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.resources.Recommendation.RecommendationImpact impact = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V8\Resources\Recommendation\RecommendationImpact|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.resources.Recommendation.RecommendationImpact impact = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V8\Resources\Recommendation\RecommendationImpact $var
     * @return $this
     */
    public function setImpact($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V8\Resources\Recommendation\RecommendationImpact::class);
        $this->impact = $var;
...
class_alias(TargetCpaOptInRecommendationOption::class, \Google\Ads\GoogleAds\V8\Resources\Recommendation_TargetCpaOptInRecommendation_TargetCpaOptInRecommendationOption::class);
