 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.Preferences</code>
 */
class Preferences extends \Google\Protobuf\Internal\Message
{
     ...
     * If not set, default is any value.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.ReachPlanAdLengthEnum.ReachPlanAdLength ad_length = 3;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\ReachPlanAdLengthEnum\ReachPlanAdLength::class);
        $this->ad_length = $var;
