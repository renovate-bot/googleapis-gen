 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.common.CustomParameter</code>
 */
class CustomParameter extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Common\CustomParameter::initOnce();
