...
namespace Google\Ads\GoogleAds\V8\Services\CartData;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.CartData.Item</code>
 */
...
class_alias(Item::class, \Google\Ads\GoogleAds\V8\Services\CartData_Item::class);
