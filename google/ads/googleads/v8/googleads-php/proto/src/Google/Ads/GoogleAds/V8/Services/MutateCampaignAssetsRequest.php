 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.MutateCampaignAssetsRequest</code>
 */
class MutateCampaignAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.CampaignAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose campaign assets are being modified.
     *     @type \Google\Ads\GoogleAds\V8\Services\CampaignAssetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign assets.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Services\CampaignAssetService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.CampaignAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V8\Services\CampaignAssetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Services\CampaignAssetOperation::class);
        $this->operations = $arr;
