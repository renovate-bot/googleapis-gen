 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.errors.SettingErrorEnum</code>
 */
class SettingErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Errors\SettingError::initOnce();
