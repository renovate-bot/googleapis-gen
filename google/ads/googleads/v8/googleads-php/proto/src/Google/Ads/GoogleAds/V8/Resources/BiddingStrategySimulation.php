 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.BiddingStrategySimulation</code>
 */
class BiddingStrategySimulation extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Resources\BiddingStrategySimulation::initOnce();
     ...
     * Output only. Simulation points if the simulation type is TARGET_CPA.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.TargetCpaSimulationPointList target_cpa_point_list = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     ...
     * Output only. Simulation points if the simulation type is TARGET_ROAS.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.TargetRoasSimulationPointList target_roas_point_list = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
