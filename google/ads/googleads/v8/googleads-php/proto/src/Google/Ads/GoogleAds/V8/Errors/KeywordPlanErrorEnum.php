 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.errors.KeywordPlanErrorEnum</code>
 */
class KeywordPlanErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Errors\KeywordPlanError::initOnce();
