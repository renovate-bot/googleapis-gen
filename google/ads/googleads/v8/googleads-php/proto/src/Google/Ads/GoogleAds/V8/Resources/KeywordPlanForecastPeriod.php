 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.KeywordPlanForecastPeriod</code>
 */
class KeywordPlanForecastPeriod extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Google\Ads\GoogleAds\V8\Common\DateRange $date_range
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Resources\KeywordPlan::initOnce();
     ...
     * A future date range relative to the current date used for forecasting.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval date_interval = 1;</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\KeywordPlanForecastIntervalEnum\KeywordPlanForecastInterval::class);
     ...
     * The start and end dates are inclusive.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.DateRange date_range = 2;</code>
