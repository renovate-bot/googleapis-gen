...
namespace Google\Ads\GoogleAds\V8\Resources\AccessibleBiddingStrategy;
 ...
 * location).
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.AccessibleBiddingStrategy.TargetImpressionShare</code>
 */
class TargetImpressionShare extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.TargetImpressionShareLocationEnum.TargetImpressionShareLocation location = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\TargetImpressionShareLocationEnum\TargetImpressionShareLocation::class);
        $this->location = $var;
...
class_alias(TargetImpressionShare::class, \Google\Ads\GoogleAds\V8\Resources\AccessibleBiddingStrategy_TargetImpressionShare::class);
