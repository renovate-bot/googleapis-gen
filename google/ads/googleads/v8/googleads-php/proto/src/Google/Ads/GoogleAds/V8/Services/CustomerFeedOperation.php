 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.CustomerFeedOperation</code>
 */
class CustomerFeedOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V8\Resources\CustomerFeed $create
     *           Create operation: No resource name is expected for the new customer feed.
     *     @type \Google\Ads\GoogleAds\V8\Resources\CustomerFeed $update
     ...
     * Create operation: No resource name is expected for the new customer feed.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.resources.CustomerFeed create = 1;</code>
     ...
     * name.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.resources.CustomerFeed update = 2;</code>
     * @return \Google\Ads\GoogleAds\V8\Resources\CustomerFeed|null
     */
