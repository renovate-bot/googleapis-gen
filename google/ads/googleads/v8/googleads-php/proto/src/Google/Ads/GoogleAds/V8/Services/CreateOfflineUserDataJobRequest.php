 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.CreateOfflineUserDataJobRequest</code>
 */
class CreateOfflineUserDataJobRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.resources.OfflineUserDataJob job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $job = null;
    /**
     ...
     *           Required. The ID of the customer for which to create an offline user data job.
     *     @type \Google\Ads\GoogleAds\V8\Resources\OfflineUserDataJob $job
     *           Required. The offline user data job to be created.
