 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.ProductBiddingCategoryConstant</code>
 */
class ProductBiddingCategoryConstant extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevel level = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $level = 0;
    /**
     * Output only. Status of the product bidding category.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Resources\ProductBiddingCategoryConstant::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\ProductBiddingCategoryLevelEnum\ProductBiddingCategoryLevel::class);
        $this->level = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\ProductBiddingCategoryStatusEnum\ProductBiddingCategoryStatus::class);
        $this->status = $var;
