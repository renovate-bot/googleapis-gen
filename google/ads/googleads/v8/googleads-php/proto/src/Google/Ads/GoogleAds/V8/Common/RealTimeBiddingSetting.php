 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.common.RealTimeBiddingSetting</code>
 */
class RealTimeBiddingSetting extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Common\RealTimeBiddingSetting::initOnce();
