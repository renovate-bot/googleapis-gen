 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.errors.CampaignBudgetErrorEnum</code>
 */
class CampaignBudgetErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Errors\CampaignBudgetError::initOnce();
