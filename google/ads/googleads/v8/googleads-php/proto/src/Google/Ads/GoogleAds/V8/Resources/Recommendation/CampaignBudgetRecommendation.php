 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.Recommendation.CampaignBudgetRecommendation</code>
 */
class CampaignBudgetRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.resources.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption budget_options = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The recommended budget amount in micros.
     *     @type \Google\Ads\GoogleAds\V8\Resources\Recommendation\CampaignBudgetRecommendation\CampaignBudgetRecommendationOption[]|\Google\Protobuf\Internal\RepeatedField $budget_options
     *           Output only. The budget amounts and associated impact estimates for some values of
     *           possible budget amounts.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.resources.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption budget_options = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V8\Resources\Recommendation\CampaignBudgetRecommendation\CampaignBudgetRecommendationOption[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBudgetOptions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Resources\Recommendation\CampaignBudgetRecommendation\CampaignBudgetRecommendationOption::class);
...
class_alias(CampaignBudgetRecommendation::class, \Google\Ads\GoogleAds\V8\Resources\Recommendation_CampaignBudgetRecommendation::class);
