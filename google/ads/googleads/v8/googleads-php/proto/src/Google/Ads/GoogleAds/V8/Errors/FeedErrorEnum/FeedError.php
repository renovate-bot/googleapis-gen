...
namespace Google\Ads\GoogleAds\V8\Errors\FeedErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.FeedErrorEnum.FeedError</code>
 */
class FeedError
{
    /**
...
class_alias(FeedError::class, \Google\Ads\GoogleAds\V8\Errors\FeedErrorEnum_FeedError::class);
