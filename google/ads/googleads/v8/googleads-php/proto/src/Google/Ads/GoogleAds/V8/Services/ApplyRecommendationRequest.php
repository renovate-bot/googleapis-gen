 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.ApplyRecommendationRequest</code>
 */
class ApplyRecommendationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.ApplyRecommendationOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer with the recommendation.
     *     @type \Google\Ads\GoogleAds\V8\Services\ApplyRecommendationOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to apply recommendations.
     *           If partial_failure=false all recommendations should be of the same type
     *           There is a limit of 100 operations per request.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.ApplyRecommendationOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V8\Services\ApplyRecommendationOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Services\ApplyRecommendationOperation::class);
        $this->operations = $arr;
