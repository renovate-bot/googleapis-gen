 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.CreateCustomerClientRequest</code>
 */
class CreateCustomerClientRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * will be ignored.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.resources.Customer customer_client = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.AccessRoleEnum.AccessRole access_role = 4;</code>
     */
     ...
     *           Required. The ID of the Manager under whom client customer is being created.
     *     @type \Google\Ads\GoogleAds\V8\Resources\Customer $customer_client
     *           Required. The new client customer to create. The resource name on this customer
     *           will be ignored.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\AccessRoleEnum\AccessRole::class);
