 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.GetProductGroupViewRequest</code>
 */
class GetProductGroupViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Services\ProductGroupViewService::initOnce();
