...
namespace Google\Ads\GoogleAds\V8\Errors\UrlFieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v8.errors.UrlFieldErrorEnum.UrlFieldError</code>
 */
class UrlFieldError
{
    /**
...
class_alias(UrlFieldError::class, \Google\Ads\GoogleAds\V8\Errors\UrlFieldErrorEnum_UrlFieldError::class);
