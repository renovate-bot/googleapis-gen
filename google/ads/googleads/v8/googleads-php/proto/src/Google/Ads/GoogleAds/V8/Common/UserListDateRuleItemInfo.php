 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.common.UserListDateRuleItemInfo</code>
 */
class UserListDateRuleItemInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * rule item.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator operator = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\UserListDateRuleItemOperatorEnum\UserListDateRuleItemOperator::class);
        $this->operator = $var;
