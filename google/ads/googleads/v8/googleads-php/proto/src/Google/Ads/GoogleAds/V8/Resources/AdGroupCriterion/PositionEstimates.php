...
namespace Google\Ads\GoogleAds\V8\Resources\AdGroupCriterion;
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.AdGroupCriterion.PositionEstimates</code>
 */
class PositionEstimates extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Resources\AdGroupCriterion::initOnce();
...
class_alias(PositionEstimates::class, \Google\Ads\GoogleAds\V8\Resources\AdGroupCriterion_PositionEstimates::class);
