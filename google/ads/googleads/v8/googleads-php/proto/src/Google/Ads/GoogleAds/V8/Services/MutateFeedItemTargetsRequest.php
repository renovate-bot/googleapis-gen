 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.MutateFeedItemTargetsRequest</code>
 */
class MutateFeedItemTargetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.FeedItemTargetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose feed item targets are being modified.
     *     @type \Google\Ads\GoogleAds\V8\Services\FeedItemTargetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual feed item targets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.FeedItemTargetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V8\Services\FeedItemTargetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Services\FeedItemTargetOperation::class);
        $this->operations = $arr;
