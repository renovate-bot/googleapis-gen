 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.KeywordPlanCampaign</code>
 */
class KeywordPlanCampaign extends \Google\Protobuf\Internal\Message
{
     ...
     * campaigns.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork keyword_plan_network = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.resources.KeywordPlanGeoTarget geo_targets = 8;</code>
     */
    private $geo_targets;
     ...
     *           This field is required and should not be empty when creating Keyword Plan
     *           campaigns.
     *     @type \Google\Ads\GoogleAds\V8\Resources\KeywordPlanGeoTarget[]|\Google\Protobuf\Internal\RepeatedField $geo_targets
     *           The geo targets.
     *           Max number allowed: 20.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Resources\KeywordPlanCampaign::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\KeywordPlanNetworkEnum\KeywordPlanNetwork::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.resources.KeywordPlanGeoTarget geo_targets = 8;</code>
     * @param \Google\Ads\GoogleAds\V8\Resources\KeywordPlanGeoTarget[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setGeoTargets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Resources\KeywordPlanGeoTarget::class);
