 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.AssetOperation</code>
 */
class AssetOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           FieldMask that determines which resource fields are modified in an update.
     *     @type \Google\Ads\GoogleAds\V8\Resources\Asset $create
     *           Create operation: No resource name is expected for the new asset.
     *     @type \Google\Ads\GoogleAds\V8\Resources\Asset $update
     ...
     * Create operation: No resource name is expected for the new asset.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.resources.Asset create = 1;</code>
     ...
     * `customers/{customer_id}/assets/{asset_id}`
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.resources.Asset update = 2;</code>
     * @return \Google\Ads\GoogleAds\V8\Resources\Asset|null
     */
