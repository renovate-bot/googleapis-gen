 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.MutateCampaignSharedSetsRequest</code>
 */
class MutateCampaignSharedSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.CampaignSharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose campaign shared sets are being modified.
     *     @type \Google\Ads\GoogleAds\V8\Services\CampaignSharedSetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaign shared sets.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Services\CampaignSharedSetService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.CampaignSharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V8\Services\CampaignSharedSetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Services\CampaignSharedSetOperation::class);
        $this->operations = $arr;
