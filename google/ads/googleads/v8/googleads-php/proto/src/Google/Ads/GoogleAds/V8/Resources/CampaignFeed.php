 ...
 * A campaign feed.
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.resources.CampaignFeed</code>
 */
class CampaignFeed extends \Google\Protobuf\Internal\Message
{
     ...
     * campaign. Required.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.enums.PlaceholderTypeEnum.PlaceholderType placeholder_types = 4;</code>
     */
     ...
     * Required.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.MatchingFunction matching_function = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.FeedLinkStatusEnum.FeedLinkStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
     ...
     *           Indicates which placeholder types the feed may populate under the connected
     *           campaign. Required.
     *     @type \Google\Ads\GoogleAds\V8\Common\MatchingFunction $matching_function
     *           Matching function associated with the CampaignFeed.
     *           The matching function is used to filter the set of feed items selected.
     *           Required.
     *     @type int $status
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Resources\CampaignFeed::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V8\Enums\PlaceholderTypeEnum\PlaceholderType::class);
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.MatchingFunction matching_function = 5;</code>
     * @return \Google\Ads\GoogleAds\V8\Common\MatchingFunction|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.MatchingFunction matching_function = 5;</code>
     * @param \Google\Ads\GoogleAds\V8\Common\MatchingFunction $var
     * @return $this
     */
    public function setMatchingFunction($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V8\Common\MatchingFunction::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\FeedLinkStatusEnum\FeedLinkStatus::class);
        $this->status = $var;
