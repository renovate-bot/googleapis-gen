 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.enums.GoogleAdsFieldDataTypeEnum</code>
 */
class GoogleAdsFieldDataTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Enums\GoogleAdsFieldDataType::initOnce();
