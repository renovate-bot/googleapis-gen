 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.MutateGoogleAdsRequest</code>
 */
class MutateGoogleAdsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The ID of the customer whose resources are being modified.
     *     @type \Google\Ads\GoogleAds\V8\Services\MutateOperation[]|\Google\Protobuf\Internal\RepeatedField $mutate_operations
     *           Required. The list of operations to perform on individual resources.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V8\Services\MutateOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMutateOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Services\MutateOperation::class);
