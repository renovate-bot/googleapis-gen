 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.SmartCampaignSuggestionInfo</code>
 */
class SmartCampaignSuggestionInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.common.AdScheduleInfo ad_schedules = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Optional. The two letter advertising language for the Smart campaign to be
     *           constructed, default to 'en' if not set.
     *     @type \Google\Ads\GoogleAds\V8\Common\AdScheduleInfo[]|\Google\Protobuf\Internal\RepeatedField $ad_schedules
     *           Optional. The business ad schedule.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.common.KeywordThemeInfo keyword_themes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Ads\GoogleAds\V8\Common\KeywordThemeInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setKeywordThemes($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Common\KeywordThemeInfo::class);
     ...
     * @return \Google\Ads\GoogleAds\V8\Services\SmartCampaignSuggestionInfo\LocationList|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.services.SmartCampaignSuggestionInfo.LocationList location_list = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Ads\GoogleAds\V8\Services\SmartCampaignSuggestionInfo\LocationList $var
     * @return $this
     */
    public function setLocationList($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V8\Services\SmartCampaignSuggestionInfo\LocationList::class);
     ...
     * Optional. The targeting geo location by proximity.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.ProximityInfo proximity = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Ads\GoogleAds\V8\Common\ProximityInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.ProximityInfo proximity = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Ads\GoogleAds\V8\Common\ProximityInfo $var
     * @return $this
     */
    public function setProximity($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V8\Common\ProximityInfo::class);
