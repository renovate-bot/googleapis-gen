 ...
 * A campaign forecast.
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.KeywordPlanCampaignForecast</code>
 */
class KeywordPlanCampaignForecast extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.services.ForecastMetrics campaign_forecast = 2;</code>
     */
     ...
     *           The resource name of the Keyword Plan campaign related to the forecast.
     *           `customers/{customer_id}/keywordPlanCampaigns/{keyword_plan_campaign_id}`
     *     @type \Google\Ads\GoogleAds\V8\Services\ForecastMetrics $campaign_forecast
     *           The forecast for the Keyword Plan campaign.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.services.ForecastMetrics campaign_forecast = 2;</code>
     * @return \Google\Ads\GoogleAds\V8\Services\ForecastMetrics|null
     */
    public function getCampaignForecast()
    {
        return isset($this->campaign_forecast) ? $this->campaign_forecast : null;
    }
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.services.ForecastMetrics campaign_forecast = 2;</code>
     * @param \Google\Ads\GoogleAds\V8\Services\ForecastMetrics $var
     * @return $this
     */
    public function setCampaignForecast($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V8\Services\ForecastMetrics::class);
