 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.enums.FlightPlaceholderFieldEnum</code>
 */
class FlightPlaceholderFieldEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Enums\FlightPlaceholderField::initOnce();
