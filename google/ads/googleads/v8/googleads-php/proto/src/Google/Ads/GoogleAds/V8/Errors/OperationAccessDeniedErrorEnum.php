 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.errors.OperationAccessDeniedErrorEnum</code>
 */
class OperationAccessDeniedErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Errors\OperationAccessDeniedError::initOnce();
