 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.MutateAdGroupAssetsRequest</code>
 */
class MutateAdGroupAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.AdGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *           Required. The ID of the customer whose ad group assets are being modified.
     *     @type \Google\Ads\GoogleAds\V8\Services\AdGroupAssetOperation[]|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual ad group assets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.AdGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V8\Services\AdGroupAssetOperation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Services\AdGroupAssetOperation::class);
        $this->operations = $arr;
