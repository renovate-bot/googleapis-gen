 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.MutateConversionValueRuleSetsResponse</code>
 */
class MutateConversionValueRuleSetsResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * All results for the mutate.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.MutateConversionValueRuleSetResult results = 1;</code>
     */
    private $results;
    /**
     ...
     *
     *     @type \Google\Ads\GoogleAds\V8\Services\MutateConversionValueRuleSetResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           All results for the mutate.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.services.MutateConversionValueRuleSetResult results = 1;</code>
     * @param \Google\Ads\GoogleAds\V8\Services\MutateConversionValueRuleSetResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V8\Services\MutateConversionValueRuleSetResult::class);
        $this->results = $arr;
