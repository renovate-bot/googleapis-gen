 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.SuggestSmartCampaignAdRequest</code>
 */
class SuggestSmartCampaignAdRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.services.SmartCampaignSuggestionInfo suggestion_info = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The ID of the customer.
     *     @type \Google\Ads\GoogleAds\V8\Services\SmartCampaignSuggestionInfo $suggestion_info
     *           Required. Inputs used to suggest a Smart campaign ad.
     *           Required fields: final_url, language_code, keyword_themes.
     *           Optional but recommended fields to improve the quality of the suggestion:
     *           business_setting and geo_target.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.services.SmartCampaignSuggestionInfo suggestion_info = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V8\Services\SmartCampaignSuggestionInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.services.SmartCampaignSuggestionInfo suggestion_info = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V8\Services\SmartCampaignSuggestionInfo $var
     * @return $this
     */
    public function setSuggestionInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V8\Services\SmartCampaignSuggestionInfo::class);
