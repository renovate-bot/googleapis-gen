 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.common.FinalAppUrl</code>
 */
class FinalAppUrl extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.enums.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemType os_type = 1;</code>
     */
    protected $os_type = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Common\FinalAppUrl::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\AppUrlOperatingSystemTypeEnum\AppUrlOperatingSystemType::class);
        $this->os_type = $var;
