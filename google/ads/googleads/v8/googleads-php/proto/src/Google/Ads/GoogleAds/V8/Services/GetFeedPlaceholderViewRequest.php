 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.GetFeedPlaceholderViewRequest</code>
 */
class GetFeedPlaceholderViewRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Services\FeedPlaceholderViewService::initOnce();
