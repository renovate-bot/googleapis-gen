 ...
 * value rule.
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.enums.ValueRuleDeviceTypeEnum</code>
 */
class ValueRuleDeviceTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Enums\ValueRuleDeviceType::initOnce();
