 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.enums.AdvertisingChannelTypeEnum</code>
 */
class AdvertisingChannelTypeEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Enums\AdvertisingChannelType::initOnce();
