 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.common.DynamicLocationSetFilter</code>
 */
class DynamicLocationSetFilter extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.BusinessNameFilter business_name_filter = 2;</code>
     */
     ...
     *           If multiple labels are set, then only feeditems marked with all the labels
     *           will be added to the FeedItemSet.
     *     @type \Google\Ads\GoogleAds\V8\Common\BusinessNameFilter $business_name_filter
     *           Business name filter.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.BusinessNameFilter business_name_filter = 2;</code>
     * @return \Google\Ads\GoogleAds\V8\Common\BusinessNameFilter|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.common.BusinessNameFilter business_name_filter = 2;</code>
     * @param \Google\Ads\GoogleAds\V8\Common\BusinessNameFilter $var
     * @return $this
     */
    public function setBusinessNameFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V8\Common\BusinessNameFilter::class);
