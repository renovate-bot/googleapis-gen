 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.common.KeywordPlanAggregateMetrics</code>
 */
class KeywordPlanAggregateMetrics extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v8.enums.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType aggregate_metric_types = 1;</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V8\Enums\KeywordPlanAggregateMetricTypeEnum\KeywordPlanAggregateMetricType::class);
