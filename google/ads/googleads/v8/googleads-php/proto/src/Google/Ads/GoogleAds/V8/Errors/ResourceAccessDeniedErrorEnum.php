 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.errors.ResourceAccessDeniedErrorEnum</code>
 */
class ResourceAccessDeniedErrorEnum extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\Googleads\V8\Errors\ResourceAccessDeniedError::initOnce();
