...
class UserIdentifier extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V8\Enums\UserIdentifierSourceEnum\UserIdentifierSource::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V8\Common\OfflineUserAddressInfo::class);
