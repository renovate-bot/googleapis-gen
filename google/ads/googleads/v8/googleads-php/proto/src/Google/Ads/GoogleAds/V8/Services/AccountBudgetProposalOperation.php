 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v8.services.AccountBudgetProposalOperation</code>
 */
class AccountBudgetProposalOperation extends \Google\Protobuf\Internal\Message
{
     ...
     *           Proposals that modify budgets have the 'update' proposal type.  Specifying
     *           a mask for any other proposal type is considered an error.
     *     @type \Google\Ads\GoogleAds\V8\Resources\AccountBudgetProposal $create
     ...
     * No resource name is expected for the new proposal.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v8.resources.AccountBudgetProposal create = 2;</code>
