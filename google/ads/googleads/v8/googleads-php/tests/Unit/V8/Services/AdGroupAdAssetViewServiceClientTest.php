...
use Google\Ads\GoogleAds\V8\Resources\AdGroupAdAssetView;
...
class AdGroupAdAssetViewServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupAdAssetViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupAdAssetViewService/GetAdGroupAdAssetView', $actualFuncCall);
