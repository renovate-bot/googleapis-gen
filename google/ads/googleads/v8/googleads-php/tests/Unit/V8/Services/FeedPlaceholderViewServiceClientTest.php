...
use Google\Ads\GoogleAds\V8\Resources\FeedPlaceholderView;
...
class FeedPlaceholderViewServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedPlaceholderViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.FeedPlaceholderViewService/GetFeedPlaceholderView', $actualFuncCall);
