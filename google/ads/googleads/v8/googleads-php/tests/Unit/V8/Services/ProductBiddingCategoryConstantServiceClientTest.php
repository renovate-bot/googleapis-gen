...
use Google\Ads\GoogleAds\V8\Resources\ProductBiddingCategoryConstant;
...
class ProductBiddingCategoryConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getProductBiddingCategoryConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.ProductBiddingCategoryConstantService/GetProductBiddingCategoryConstant', $actualFuncCall);
