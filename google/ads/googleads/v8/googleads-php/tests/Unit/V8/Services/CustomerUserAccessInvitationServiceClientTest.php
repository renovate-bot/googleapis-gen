...
use Google\Ads\GoogleAds\V8\Services\MutateCustomerUserAccessInvitationResponse;
...
class CustomerUserAccessInvitationServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerUserAccessInvitationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CustomerUserAccessInvitationService/GetCustomerUserAccessInvitation', $actualFuncCall);
    ...
    public function mutateCustomerUserAccessInvitationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.CustomerUserAccessInvitationService/MutateCustomerUserAccessInvitation', $actualFuncCall);
