...
use Google\Ads\GoogleAds\V8\Services\MutateSmartCampaignSettingsResponse;
...
class SmartCampaignSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getSmartCampaignSettingTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.SmartCampaignSettingService/GetSmartCampaignSetting', $actualFuncCall);
    ...
    public function mutateSmartCampaignSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.SmartCampaignSettingService/MutateSmartCampaignSettings', $actualFuncCall);
