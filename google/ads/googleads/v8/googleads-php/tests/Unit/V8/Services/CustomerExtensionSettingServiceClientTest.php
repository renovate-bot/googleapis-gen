...
use Google\Ads\GoogleAds\V8\Services\MutateCustomerExtensionSettingsResponse;
...
class CustomerExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerExtensionSettingTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CustomerExtensionSettingService/GetCustomerExtensionSetting', $actualFuncCall);
    ...
    public function mutateCustomerExtensionSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.CustomerExtensionSettingService/MutateCustomerExtensionSettings', $actualFuncCall);
