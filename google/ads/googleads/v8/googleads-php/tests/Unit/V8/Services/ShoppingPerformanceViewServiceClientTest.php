...
use Google\Ads\GoogleAds\V8\Resources\ShoppingPerformanceView;
...
class ShoppingPerformanceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getShoppingPerformanceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.ShoppingPerformanceViewService/GetShoppingPerformanceView', $actualFuncCall);
