...
use Google\Ads\GoogleAds\V8\Services\MutateCustomerFeedsResponse;
...
class CustomerFeedServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerFeedTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CustomerFeedService/GetCustomerFeed', $actualFuncCall);
    ...
    public function mutateCustomerFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.CustomerFeedService/MutateCustomerFeeds', $actualFuncCall);
