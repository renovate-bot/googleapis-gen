...
use Google\Ads\GoogleAds\V8\Resources\CustomInterest;
use Google\Ads\GoogleAds\V8\Services\MutateCustomInterestsResponse;
...
class CustomInterestServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomInterestTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->customInterestName('[CUSTOMER_ID]', '[CUSTOM_INTEREST_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CustomInterestService/GetCustomInterest', $actualFuncCall);
    ...
    public function mutateCustomInterestsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.CustomInterestService/MutateCustomInterests', $actualFuncCall);
