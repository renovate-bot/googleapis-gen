...
use Google\Ads\GoogleAds\V8\Resources\UserLocationView;
...
class UserLocationViewServiceClientTest extends GeneratedTest
{
    ...
    public function getUserLocationViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.UserLocationViewService/GetUserLocationView', $actualFuncCall);
