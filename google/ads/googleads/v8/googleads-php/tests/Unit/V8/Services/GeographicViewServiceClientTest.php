...
use Google\Ads\GoogleAds\V8\Resources\GeographicView;
...
class GeographicViewServiceClientTest extends GeneratedTest
{
    ...
    public function getGeographicViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.GeographicViewService/GetGeographicView', $actualFuncCall);
