...
use Google\Ads\GoogleAds\V8\Resources\DetailPlacementView;
...
class DetailPlacementViewServiceClientTest extends GeneratedTest
{
    ...
    public function getDetailPlacementViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.DetailPlacementViewService/GetDetailPlacementView', $actualFuncCall);
