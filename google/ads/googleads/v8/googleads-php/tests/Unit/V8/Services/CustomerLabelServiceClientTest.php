...
use Google\Ads\GoogleAds\V8\Resources\CustomerLabel;
use Google\Ads\GoogleAds\V8\Services\MutateCustomerLabelsResponse;
...
class CustomerLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getCustomerLabelTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->customerLabelName('[CUSTOMER_ID]', '[LABEL_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CustomerLabelService/GetCustomerLabel', $actualFuncCall);
    ...
    public function mutateCustomerLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.CustomerLabelService/MutateCustomerLabels', $actualFuncCall);
