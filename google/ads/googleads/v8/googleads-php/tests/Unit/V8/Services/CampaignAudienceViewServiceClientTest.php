...
use Google\Ads\GoogleAds\V8\Resources\CampaignAudienceView;
...
class CampaignAudienceViewServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignAudienceViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CampaignAudienceViewService/GetCampaignAudienceView', $actualFuncCall);
