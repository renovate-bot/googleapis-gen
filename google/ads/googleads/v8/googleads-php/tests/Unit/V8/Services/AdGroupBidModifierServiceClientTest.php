...
use Google\Ads\GoogleAds\V8\Services\MutateAdGroupBidModifiersResponse;
...
class AdGroupBidModifierServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupBidModifierTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupBidModifierService/GetAdGroupBidModifier', $actualFuncCall);
    ...
    public function mutateAdGroupBidModifiersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupBidModifierService/MutateAdGroupBidModifiers', $actualFuncCall);
