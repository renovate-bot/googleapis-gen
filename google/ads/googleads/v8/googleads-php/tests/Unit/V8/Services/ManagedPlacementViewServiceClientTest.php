...
use Google\Ads\GoogleAds\V8\Resources\ManagedPlacementView;
 ...
 * @group gapic
 */
class ManagedPlacementViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getManagedPlacementViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->managedPlacementViewName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v8.services.ManagedPlacementViewService/GetManagedPlacementView', $actualFuncCall);
