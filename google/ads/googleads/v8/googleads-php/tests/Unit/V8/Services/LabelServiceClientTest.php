...
use Google\Ads\GoogleAds\V8\Resources\Label;
use Google\Ads\GoogleAds\V8\Services\MutateLabelsResponse;
...
class LabelServiceClientTest extends GeneratedTest
{
    ...
    public function getLabelTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->labelName('[CUSTOMER_ID]', '[LABEL_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v8.services.LabelService/GetLabel', $actualFuncCall);
    ...
    public function mutateLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.LabelService/MutateLabels', $actualFuncCall);
