...
use Google\Ads\GoogleAds\V8\Resources\DisplayKeywordView;
...
class DisplayKeywordViewServiceClientTest extends GeneratedTest
{
    ...
    public function getDisplayKeywordViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.DisplayKeywordViewService/GetDisplayKeywordView', $actualFuncCall);
