...
use Google\Ads\GoogleAds\V8\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceClientTest extends GeneratedTest
{
    ...
    public function getBillingSetupTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.BillingSetupService/GetBillingSetup', $actualFuncCall);
    ...
    public function mutateBillingSetupTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.BillingSetupService/MutateBillingSetup', $actualFuncCall);
