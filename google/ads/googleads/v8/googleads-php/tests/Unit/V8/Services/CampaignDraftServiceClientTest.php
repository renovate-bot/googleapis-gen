...
class CampaignDraftServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignDraftTest()
    {
        ...
        $name = 'name3373707';
        $draftCampaign = 'draftCampaign1556086254';
        $hasExperimentRunning = true;
        $longRunningOperation = 'longRunningOperation827165668';
        $expectedResponse = new CampaignDraft();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setDraftId($draftId);
        $expectedResponse->setBaseCampaign($baseCampaign);
        $expectedResponse->setName($name);
        $expectedResponse->setDraftCampaign($draftCampaign);
        $expectedResponse->setHasExperimentRunning($hasExperimentRunning);
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CampaignDraftService/GetCampaignDraft', $actualFuncCall);
    ...
    public function listCampaignDraftAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.CampaignDraftService/ListCampaignDraftAsyncErrors', $actualFuncCall);
        $actualValue = $actualRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateCampaignDraftsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.CampaignDraftService/MutateCampaignDrafts', $actualFuncCall);
    ...
    public function promoteCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CampaignDraftService/PromoteCampaignDraft', $actualApiFuncCall);
