...
use Google\Ads\GoogleAds\V8\Services\MutateAdGroupExtensionSettingsResponse;
...
class AdGroupExtensionSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupExtensionSettingTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupExtensionSettingService/GetAdGroupExtensionSetting', $actualFuncCall);
    ...
    public function mutateAdGroupExtensionSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupExtensionSettingService/MutateAdGroupExtensionSettings', $actualFuncCall);
