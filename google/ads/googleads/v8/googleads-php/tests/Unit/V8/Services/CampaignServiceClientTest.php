...
class CampaignServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CampaignService/GetCampaign', $actualFuncCall);
    ...
    public function mutateCampaignsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.CampaignService/MutateCampaigns', $actualFuncCall);
