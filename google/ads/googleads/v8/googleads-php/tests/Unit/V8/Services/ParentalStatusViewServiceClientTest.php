...
use Google\Ads\GoogleAds\V8\Resources\ParentalStatusView;
...
class ParentalStatusViewServiceClientTest extends GeneratedTest
{
    ...
    public function getParentalStatusViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.ParentalStatusViewService/GetParentalStatusView', $actualFuncCall);
