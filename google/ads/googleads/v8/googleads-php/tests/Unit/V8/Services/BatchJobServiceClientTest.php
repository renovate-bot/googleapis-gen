...
use Google\Ads\GoogleAds\V8\Services\AddBatchJobOperationsResponse;
...
use Google\Ads\GoogleAds\V8\Services\MutateBatchJobResponse;
...
class BatchJobServiceClientTest extends GeneratedTest
{
    ...
    public function addBatchJobOperationsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.BatchJobService/AddBatchJobOperations', $actualFuncCall);
    ...
    public function getBatchJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.BatchJobService/GetBatchJob', $actualFuncCall);
        $actualValue = $actualRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBatchJobResultsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.BatchJobService/ListBatchJobResults', $actualFuncCall);
        $actualValue = $actualRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateBatchJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.BatchJobService/MutateBatchJob', $actualFuncCall);
    ...
    public function runBatchJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.BatchJobService/RunBatchJob', $actualApiFuncCall);
