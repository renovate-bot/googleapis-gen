...
use Google\Ads\GoogleAds\V8\Resources\ProductGroupView;
 ...
 * @group gapic
 */
class ProductGroupViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getProductGroupViewTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->productGroupViewName('[CUSTOMER_ID]', '[ADGROUP_ID]', '[CRITERION_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v8.services.ProductGroupViewService/GetProductGroupView', $actualFuncCall);
