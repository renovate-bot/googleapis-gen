...
use Google\Ads\GoogleAds\V8\Resources\MobileDeviceConstant;
...
class MobileDeviceConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getMobileDeviceConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.MobileDeviceConstantService/GetMobileDeviceConstant', $actualFuncCall);
