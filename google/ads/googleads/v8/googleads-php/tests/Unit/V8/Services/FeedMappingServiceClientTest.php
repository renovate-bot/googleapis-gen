...
use Google\Ads\GoogleAds\V8\Services\MutateFeedMappingsResponse;
...
class FeedMappingServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedMappingTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.FeedMappingService/GetFeedMapping', $actualFuncCall);
    ...
    public function mutateFeedMappingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.FeedMappingService/MutateFeedMappings', $actualFuncCall);
