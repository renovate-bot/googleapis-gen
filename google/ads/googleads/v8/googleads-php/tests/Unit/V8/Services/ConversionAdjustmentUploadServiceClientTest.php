...
use Google\Ads\GoogleAds\V8\Services\UploadConversionAdjustmentsResponse;
...
class ConversionAdjustmentUploadServiceClientTest extends GeneratedTest
{
    ...
    public function uploadConversionAdjustmentsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.ConversionAdjustmentUploadService/UploadConversionAdjustments', $actualFuncCall);
