...
use Google\Ads\GoogleAds\V8\Services\MutateCampaignSharedSetsResponse;
...
class CampaignSharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignSharedSetTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CampaignSharedSetService/GetCampaignSharedSet', $actualFuncCall);
    ...
    public function mutateCampaignSharedSetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.CampaignSharedSetService/MutateCampaignSharedSets', $actualFuncCall);
