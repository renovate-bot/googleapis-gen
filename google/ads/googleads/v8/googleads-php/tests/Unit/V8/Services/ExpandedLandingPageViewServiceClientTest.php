...
use Google\Ads\GoogleAds\V8\Resources\ExpandedLandingPageView;
...
class ExpandedLandingPageViewServiceClientTest extends GeneratedTest
{
    ...
    public function getExpandedLandingPageViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.ExpandedLandingPageViewService/GetExpandedLandingPageView', $actualFuncCall);
