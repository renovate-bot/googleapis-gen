...
use Google\Ads\GoogleAds\V8\Services\MutateSharedCriteriaResponse;
...
class SharedCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function getSharedCriterionTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.SharedCriterionService/GetSharedCriterion', $actualFuncCall);
    ...
    public function mutateSharedCriteriaTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.SharedCriterionService/MutateSharedCriteria', $actualFuncCall);
