...
use Google\Ads\GoogleAds\V8\Resources\AdScheduleView;
...
class AdScheduleViewServiceClientTest extends GeneratedTest
{
    ...
    public function getAdScheduleViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.AdScheduleViewService/GetAdScheduleView', $actualFuncCall);
