...
use Google\Ads\GoogleAds\V8\Resources\CampaignCriterionSimulation;
...
class CampaignCriterionSimulationServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignCriterionSimulationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CampaignCriterionSimulationService/GetCampaignCriterionSimulation', $actualFuncCall);
