...
use Google\Ads\GoogleAds\V8\Resources\AdGroupCriterionLabel;
use Google\Ads\GoogleAds\V8\Services\MutateAdGroupCriterionLabelsResponse;
...
class AdGroupCriterionLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupCriterionLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupCriterionLabelService/GetAdGroupCriterionLabel', $actualFuncCall);
    ...
    public function mutateAdGroupCriterionLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels', $actualFuncCall);
