...
use Google\Ads\GoogleAds\V8\Resources\CampaignSimulation;
...
class CampaignSimulationServiceClientTest extends GeneratedTest
{
    ...
    public function getCampaignSimulationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.CampaignSimulationService/GetCampaignSimulation', $actualFuncCall);
