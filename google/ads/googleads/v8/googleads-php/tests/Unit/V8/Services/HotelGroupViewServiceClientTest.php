...
use Google\Ads\GoogleAds\V8\Resources\HotelGroupView;
...
class HotelGroupViewServiceClientTest extends GeneratedTest
{
    ...
    public function getHotelGroupViewTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.HotelGroupViewService/GetHotelGroupView', $actualFuncCall);
