...
use Google\Ads\GoogleAds\V8\Services\MutateFeedsResponse;
...
class FeedServiceClientTest extends GeneratedTest
{
    ...
    public function getFeedTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->feedName('[CUSTOMER_ID]', '[FEED_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v8.services.FeedService/GetFeed', $actualFuncCall);
    ...
    public function mutateFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.FeedService/MutateFeeds', $actualFuncCall);
