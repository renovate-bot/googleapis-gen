...
use Google\Ads\GoogleAds\V8\Resources\LandingPageView;
 ...
 * @group gapic
 */
class LandingPageViewServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getLandingPageViewTest()
    {
        ...
        $unexpandedFinalUrl = 'unexpandedFinalUrl2091506041';
        $expectedResponse = new LandingPageView();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setUnexpandedFinalUrl($unexpandedFinalUrl);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->landingPageViewName('[CUSTOMER_ID]', '[UNEXPANDED_FINAL_URL_FINGERPRINT]');
        ...
        $this->assertSame('/google.ads.googleads.v8.services.LandingPageViewService/GetLandingPageView', $actualFuncCall);
