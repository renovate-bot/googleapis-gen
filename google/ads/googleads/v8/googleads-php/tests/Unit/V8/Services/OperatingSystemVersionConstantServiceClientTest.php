...
use Google\Ads\GoogleAds\V8\Resources\OperatingSystemVersionConstant;
...
class OperatingSystemVersionConstantServiceClientTest extends GeneratedTest
{
    ...
    public function getOperatingSystemVersionConstantTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.OperatingSystemVersionConstantService/GetOperatingSystemVersionConstant', $actualFuncCall);
