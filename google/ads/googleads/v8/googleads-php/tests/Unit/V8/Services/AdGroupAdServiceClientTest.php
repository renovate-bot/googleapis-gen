...
class AdGroupAdServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupAdTest()
    {
        ...
        // Mock request
        $formattedResourceName = $client->adGroupAdName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[AD_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupAdService/GetAdGroupAd', $actualFuncCall);
    ...
    public function mutateAdGroupAdsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupAdService/MutateAdGroupAds', $actualFuncCall);
