...
use Google\Ads\GoogleAds\V8\Services\MutateMediaFilesResponse;
 ...
 * @group gapic
 */
class MediaFileServiceClientTest extends GeneratedTest
{
    /**
    ...
    public function getMediaFileTest()
    {
        ...
        $id = 3355;
        $sourceUrl = 'sourceUrl-1111107765';
        $name = 'name3373707';
        $fileSize = 1316310812;
        $expectedResponse = new MediaFile();
        $expectedResponse->setResourceName($resourceName2);
        $expectedResponse->setId($id);
        $expectedResponse->setSourceUrl($sourceUrl);
        $expectedResponse->setName($name);
        $expectedResponse->setFileSize($fileSize);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedResourceName = $client->mediaFileName('[CUSTOMER_ID]', '[MEDIA_FILE_ID]');
        ...
        $this->assertSame('/google.ads.googleads.v8.services.MediaFileService/GetMediaFile', $actualFuncCall);
    ...
    public function mutateMediaFilesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.MediaFileService/MutateMediaFiles', $actualFuncCall);
