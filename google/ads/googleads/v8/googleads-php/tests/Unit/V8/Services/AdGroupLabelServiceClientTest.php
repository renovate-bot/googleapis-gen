...
use Google\Ads\GoogleAds\V8\Resources\AdGroupLabel;
use Google\Ads\GoogleAds\V8\Services\MutateAdGroupLabelsResponse;
...
class AdGroupLabelServiceClientTest extends GeneratedTest
{
    ...
    public function getAdGroupLabelTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupLabelService/GetAdGroupLabel', $actualFuncCall);
    ...
    public function mutateAdGroupLabelsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v8.services.AdGroupLabelService/MutateAdGroupLabels', $actualFuncCall);
