 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v8/services/customer_service.proto
...
use Google\Ads\GoogleAds\V8\Services\CreateCustomerClientRequest;
use Google\Ads\GoogleAds\V8\Services\CreateCustomerClientResponse;

use Google\Ads\GoogleAds\V8\Services\CustomerOperation;
use Google\Ads\GoogleAds\V8\Services\GetCustomerRequest;
use Google\Ads\GoogleAds\V8\Services\ListAccessibleCustomersRequest;
use Google\Ads\GoogleAds\V8\Services\ListAccessibleCustomersResponse;
use Google\Ads\GoogleAds\V8\Services\MutateCustomerRequest;
use Google\Ads\GoogleAds\V8\Services\MutateCustomerResponse;
...
class CustomerServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.CustomerService';
     ...
     *           For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V8\Enums\AccessRoleEnum\AccessRole}
