 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v8/services/ad_group_ad_label_service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Ads\GoogleAds\V8\Services\Gapic;

use Google\Ads\GoogleAds\V8\Resources\AdGroupAdLabel;
use Google\Ads\GoogleAds\V8\Services\AdGroupAdLabelOperation;
use Google\Ads\GoogleAds\V8\Services\GetAdGroupAdLabelRequest;

use Google\Ads\GoogleAds\V8\Services\MutateAdGroupAdLabelsRequest;
use Google\Ads\GoogleAds\V8\Services\MutateAdGroupAdLabelsResponse;
 ...
 * try {
 *     $formattedResourceName = $adGroupAdLabelServiceClient->adGroupAdLabelName('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[AD_ID]', '[LABEL_ID]');
...
class AdGroupAdLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.AdGroupAdLabelService';
