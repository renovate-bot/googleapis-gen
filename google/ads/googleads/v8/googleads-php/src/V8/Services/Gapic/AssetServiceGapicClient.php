...
use Google\Ads\GoogleAds\V8\Services\GetAssetRequest;

use Google\Ads\GoogleAds\V8\Services\MutateAssetsRequest;
...
class AssetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.AssetService';
