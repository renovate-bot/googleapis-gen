 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v8/services/customer_label_service.proto
...
use Google\Ads\GoogleAds\V8\Services\CustomerLabelOperation;
use Google\Ads\GoogleAds\V8\Services\GetCustomerLabelRequest;

use Google\Ads\GoogleAds\V8\Services\MutateCustomerLabelsRequest;
...
class CustomerLabelServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.CustomerLabelService';
    ...
    public function getCustomerLabel($resourceName, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetCustomerLabel', CustomerLabel::class, $optionalArgs, $request)->wait();
    }
     ...
     * }
     *
     * @return \Google\Ads\GoogleAds\V8\Services\MutateCustomerLabelsResponse
     *
     * @throws ApiException if the remote call fails
     */
    public function mutateCustomerLabels($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateCustomerLabels', MutateCustomerLabelsResponse::class, $optionalArgs, $request)->wait();
    }
}
