...
use Google\Ads\GoogleAds\V8\Services\GetCustomerNegativeCriterionRequest;

use Google\Ads\GoogleAds\V8\Services\MutateCustomerNegativeCriteriaRequest;
...
class CustomerNegativeCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.CustomerNegativeCriterionService';
