...
return [
    'interfaces' => [
        'google.ads.googleads.v8.services.GoogleAdsService' => [
            'Mutate' => [
                'method' => 'post',
                'uriTemplate' => '/v8/customers/{customer_id=*}/googleAds:mutate',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'Search' => [
                'method' => 'post',
                'uriTemplate' => '/v8/customers/{customer_id=*}/googleAds:search',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
            ...
            'SearchStream' => [
                'method' => 'post',
                'uriTemplate' => '/v8/customers/{customer_id=*}/googleAds:searchStream',
                'body' => '*',
                'placeholders' => [
                    'customer_id' => [
                        'getters' => [
