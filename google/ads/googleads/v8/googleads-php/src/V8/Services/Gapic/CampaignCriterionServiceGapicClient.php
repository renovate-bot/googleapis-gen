...
use Google\Ads\GoogleAds\V8\Services\GetCampaignCriterionRequest;

use Google\Ads\GoogleAds\V8\Services\MutateCampaignCriteriaRequest;
...
class CampaignCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.CampaignCriterionService';
