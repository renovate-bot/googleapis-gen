 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v8/services/bidding_data_exclusion_service.proto
...
use Google\Ads\GoogleAds\V8\Services\GetBiddingDataExclusionRequest;

use Google\Ads\GoogleAds\V8\Services\MutateBiddingDataExclusionsRequest;
use Google\Ads\GoogleAds\V8\Services\MutateBiddingDataExclusionsResponse;
 ...
 *
 * ```
 * $biddingDataExclusionServiceClient = new BiddingDataExclusionServiceClient();
 * try {
 *     $formattedResourceName = $biddingDataExclusionServiceClient->biddingDataExclusionName('[CUSTOMER_ID]', '[SEASONALITY_EVENT_ID]');
 *     $response = $biddingDataExclusionServiceClient->getBiddingDataExclusion($formattedResourceName);
 * } finally {
 *     $biddingDataExclusionServiceClient->close();
 * }
 * ```
 *
 ...
 */
class BiddingDataExclusionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.BiddingDataExclusionService';
     ...
     * ```
     *
     * @param string $resourceName Required. The resource name of the data exclusion to fetch.
     ...
     */
    public function getBiddingDataExclusion($resourceName, array $optionalArgs = [])
    {
        $request = new GetBiddingDataExclusionRequest();
        $requestParamHeaders = [];
        $request->setResourceName($resourceName);
        $requestParamHeaders['resource_name'] = $resourceName;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetBiddingDataExclusion', BiddingDataExclusion::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $operations = [];
     *     $response = $biddingDataExclusionServiceClient->mutateBiddingDataExclusions($customerId, $operations);
     * } finally {
     *     $biddingDataExclusionServiceClient->close();
     * }
     * ```
     ...
     * @param BiddingDataExclusionOperation[] $operations   Required. The list of operations to perform on individual data exclusions.
     * @param array                           $optionalArgs {
     *     Optional.
     *
     ...
     * @throws ApiException if the remote call fails
     */
    public function mutateBiddingDataExclusions($customerId, $operations, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MutateBiddingDataExclusions', MutateBiddingDataExclusionsResponse::class, $optionalArgs, $request)->wait();
    }
}
