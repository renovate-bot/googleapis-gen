...
use Google\Ads\GoogleAds\V8\Services\GetAdGroupCriterionRequest;

use Google\Ads\GoogleAds\V8\Services\MutateAdGroupCriteriaRequest;
...
class AdGroupCriterionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.ads.googleads.v8.services.AdGroupCriterionService';
