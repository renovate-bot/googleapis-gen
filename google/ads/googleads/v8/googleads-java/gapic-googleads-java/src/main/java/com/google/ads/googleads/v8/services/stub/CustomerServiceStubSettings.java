...
import com.google.ads.googleads.v8.services.CreateCustomerClientRequest;
import com.google.ads.googleads.v8.services.CreateCustomerClientResponse;
import com.google.ads.googleads.v8.services.GetCustomerRequest;
...
import com.google.ads.googleads.v8.services.MutateCustomerRequest;
...
/**
 * Settings class to configure an instance of {@link CustomerServiceStub}.
 *
 ...
 *
 * <pre>{@code
 * CustomerServiceStubSettings.Builder customerServiceSettingsBuilder =
 *     CustomerServiceStubSettings.newBuilder();
...
public class CustomerServiceStubSettings extends StubSettings<CustomerServiceStubSettings> {
  ...
  public CustomerServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcCustomerServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(CustomerServiceStubSettings.class))
        .setTransportToken(
  ...
  protected CustomerServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<CustomerServiceStubSettings, Builder> {
    ...
    protected Builder(CustomerServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public CustomerServiceStubSettings build() throws IOException {
      return new CustomerServiceStubSettings(this);
    }
  }
}
