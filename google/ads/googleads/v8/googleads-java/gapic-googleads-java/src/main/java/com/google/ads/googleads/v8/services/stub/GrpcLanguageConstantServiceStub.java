...
import com.google.ads.googleads.v8.resources.LanguageConstant;
import com.google.ads.googleads.v8.services.GetLanguageConstantRequest;
    ...
    GrpcCallSettings<GetLanguageConstantRequest, LanguageConstant>
        getLanguageConstantTransportSettings =
            GrpcCallSettings.<GetLanguageConstantRequest, LanguageConstant>newBuilder()
                ...
                .setParamsExtractor(
                    new RequestParamsExtractor<GetLanguageConstantRequest>() {
                      @Override
                      public Map<String, String> extract(GetLanguageConstantRequest request) {
