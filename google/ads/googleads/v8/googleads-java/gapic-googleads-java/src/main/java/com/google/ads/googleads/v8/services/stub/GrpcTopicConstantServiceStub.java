...
import com.google.ads.googleads.v8.resources.TopicConstant;
import com.google.ads.googleads.v8.services.GetTopicConstantRequest;
  ...
  protected GrpcTopicConstantServiceStub(
    ...
    GrpcCallSettings<GetTopicConstantRequest, TopicConstant> getTopicConstantTransportSettings =
        GrpcCallSettings.<GetTopicConstantRequest, TopicConstant>newBuilder()
            ...
            .setParamsExtractor(
                new RequestParamsExtractor<GetTopicConstantRequest>() {
                  @Override
                  public Map<String, String> extract(GetTopicConstantRequest request) {
