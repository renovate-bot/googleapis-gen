...
import com.google.ads.googleads.v8.services.GetFeedItemRequest;
import com.google.ads.googleads.v8.services.MutateFeedItemsRequest;
...
public class FeedItemServiceStubSettings extends StubSettings<FeedItemServiceStubSettings> {
  ...
  private final UnaryCallSettings<GetFeedItemRequest, FeedItem> getFeedItemSettings;
  ...
  protected FeedItemServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getFeedItemSettings = settingsBuilder.getFeedItemSettings().build();
  ...
  public static class Builder extends StubSettings.Builder<FeedItemServiceStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<GetFeedItemRequest, FeedItem> getFeedItemSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getFeedItemSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      mutateFeedItemsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getFeedItemSettings, mutateFeedItemsSettings);
      initDefaults(this);
    }
    ...
    protected Builder(FeedItemServiceStubSettings settings) {
      ...
      getFeedItemSettings = settings.getFeedItemSettings.toBuilder();
