...
function main(customerId, operations) {
  // [START googleads_v8_generated_AdGroupExtensionSettingService_MutateAdGroupExtensionSettings_async]
  /**
  ...
  const {AdGroupExtensionSettingServiceClient} = require('google-ads').v8;
  ...
  // [END googleads_v8_generated_AdGroupExtensionSettingService_MutateAdGroupExtensionSettings_async]
}
