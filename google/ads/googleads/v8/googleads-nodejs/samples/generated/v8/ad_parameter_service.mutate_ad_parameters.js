...
function main(customerId, operations) {
  // [START googleads_v8_generated_AdParameterService_MutateAdParameters_async]
  /**
  ...
  const {AdParameterServiceClient} = require('google-ads').v8;
  ...
  mutateAdParameters();
  // [END googleads_v8_generated_AdParameterService_MutateAdParameters_async]
}
