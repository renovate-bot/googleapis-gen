...
function main(resourceName) {
  // [START googleads_get_smart_campaign_search_term_view_sample]
  /**
  ...
  const {SmartCampaignSearchTermViewServiceClient} = require('google-ads').v8;
  ...
  // [END googleads_get_smart_campaign_search_term_view_sample]
}
