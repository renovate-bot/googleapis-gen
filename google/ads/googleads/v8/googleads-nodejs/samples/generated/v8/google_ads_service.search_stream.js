...
function main(customerId, query) {
  // [START googleads_v8_generated_GoogleAdsService_SearchStream_async]
  /**
  ...
  const {GoogleAdsServiceClient} = require('google-ads').v8;
  ...
  searchStream();
  // [END googleads_v8_generated_GoogleAdsService_SearchStream_async]
}
