...
function main(resourceName) {
  // [START googleads_get_group_placement_view_sample]
  /**
  ...
  const {GroupPlacementViewServiceClient} = require('google-ads').v8;
  ...
  // [END googleads_get_group_placement_view_sample]
}
