...
function main(customerId, operations) {
  // [START googleads_v8_generated_CampaignService_MutateCampaigns_async]
  /**
  ...
  const {CampaignServiceClient} = require('google-ads').v8;
  ...
  mutateCampaigns();
  // [END googleads_v8_generated_CampaignService_MutateCampaigns_async]
}
