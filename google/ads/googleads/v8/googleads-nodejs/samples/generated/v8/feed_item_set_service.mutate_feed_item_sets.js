...
function main(customerId, operations) {
  // [START googleads_v8_generated_FeedItemSetService_MutateFeedItemSets_async]
  /**
  ...
  const {FeedItemSetServiceClient} = require('google-ads').v8;
  ...
  // [END googleads_v8_generated_FeedItemSetService_MutateFeedItemSets_async]
}
