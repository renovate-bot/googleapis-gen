...
function main(customerId, operations) {
  // [START googleads_v8_generated_FeedItemSetLinkService_MutateFeedItemSetLinks_async]
  /**
  ...
  // [END googleads_v8_generated_FeedItemSetLinkService_MutateFeedItemSetLinks_async]
}
