...
function main(customerId, operation) {
  // [START googleads_v8_generated_CustomerClientLinkService_MutateCustomerClientLink_async]
  /**
  ...
  const {CustomerClientLinkServiceClient} = require('google-ads').v8;
  ...
  // [END googleads_v8_generated_CustomerClientLinkService_MutateCustomerClientLink_async]
}
