...
function main(customerId, job) {
  // [START googleads_create_offline_user_data_job_sample]
  /**
  ...
  const {OfflineUserDataJobServiceClient} = require('google-ads').v8;
  ...
  // [END googleads_create_offline_user_data_job_sample]
}
