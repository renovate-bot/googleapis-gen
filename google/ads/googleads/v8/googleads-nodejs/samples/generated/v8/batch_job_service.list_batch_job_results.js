...
function main(resourceName) {
  // [START googleads_v8_generated_BatchJobService_ListBatchJobResults_async]
  /**
  ...
  async function listBatchJobResults() {
    ...
    // Run request
    const iterable = await googleadsClient.listBatchJobResultsAsync(request);
  ...
  listBatchJobResults();
  // [END googleads_v8_generated_BatchJobService_ListBatchJobResults_async]
}
