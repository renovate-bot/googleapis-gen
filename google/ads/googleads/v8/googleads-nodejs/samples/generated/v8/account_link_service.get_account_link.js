...
function main(resourceName) {
  // [START googleads_v8_generated_AccountLinkService_GetAccountLink_async]
  /**
  ...
  async function callGetAccountLink() {
    ...
    // Run request
    const response = await googleadsClient.getAccountLink(request);
    console.log(response);
  }

  callGetAccountLink();
  // [END googleads_v8_generated_AccountLinkService_GetAccountLink_async]
}
