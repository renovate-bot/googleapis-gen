...
function main(customerId, operations) {
  // [START googleads_v8_generated_CampaignSharedSetService_MutateCampaignSharedSets_async]
  /**
  ...
  const {CampaignSharedSetServiceClient} = require('google-ads').v8;

  // Instantiates a client
  const googleadsClient = new CampaignSharedSetServiceClient();

  async function mutateCampaignSharedSets() {
    // Construct request
    const request = {
      customerId,
      operations,
  ...
  // [END googleads_v8_generated_CampaignSharedSetService_MutateCampaignSharedSets_async]
}
