...
function main(customerId, operations) {
  // [START googleads_v8_generated_AdGroupCriterionLabelService_MutateAdGroupCriterionLabels_async]
  /**
  ...
  const {AdGroupCriterionLabelServiceClient} = require('google-ads').v8;
