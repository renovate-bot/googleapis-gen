 ...
 */
import * as gapicConfig from './hotel_group_view_service_client_config.json';
...
export class HotelGroupViewServiceClient {
  ...
  hotelGroupViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof HotelGroupViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.HotelGroupViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const hotelGroupViewServiceStubMethods =
        ['getHotelGroupView'];
    for (const methodName of hotelGroupViewServiceStubMethods) {
      const callPromise = this.hotelGroupViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [HotelGroupView]{@link google.ads.googleads.v8.resources.HotelGroupView}.
 *   Please see the
 ...
 * region_tag:googleads_v8_generated_HotelGroupViewService_GetHotelGroupView_async
 */
  getHotelGroupView(
      request?: protos.google.ads.googleads.v8.services.IGetHotelGroupViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v8.resources.IHotelGroupView,
        protos.google.ads.googleads.v8.services.IGetHotelGroupViewRequest|undefined, {}|undefined
      ]>;
  getHotelGroupView(
      request: protos.google.ads.googleads.v8.services.IGetHotelGroupViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v8.resources.IHotelGroupView,
          protos.google.ads.googleads.v8.services.IGetHotelGroupViewRequest|null|undefined,
          {}|null|undefined>): void;
  getHotelGroupView(
      request: protos.google.ads.googleads.v8.services.IGetHotelGroupViewRequest,
      callback: Callback<
