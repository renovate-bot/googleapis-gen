 ...
 */
import * as gapicConfig from './account_budget_service_client_config.json';
...
export class AccountBudgetServiceClient {
  ...
  accountBudgetServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AccountBudgetServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.AccountBudgetService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const accountBudgetServiceStubMethods =
        ['getAccountBudget'];
    for (const methodName of accountBudgetServiceStubMethods) {
      const callPromise = this.accountBudgetServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [AccountBudget]{@link google.ads.googleads.v8.resources.AccountBudget}.
 *   Please see the
