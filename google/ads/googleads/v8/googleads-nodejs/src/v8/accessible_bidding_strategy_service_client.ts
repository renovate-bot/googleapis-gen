 ...
 */
import * as gapicConfig from './accessible_bidding_strategy_service_client_config.json';
 ...
 * @memberof v8
 */
export class AccessibleBiddingStrategyServiceClient {
  ...
  accessibleBiddingStrategyServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AccessibleBiddingStrategyServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.AccessibleBiddingStrategyService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const accessibleBiddingStrategyServiceStubMethods =
        ['getAccessibleBiddingStrategy'];
    for (const methodName of accessibleBiddingStrategyServiceStubMethods) {
      const callPromise = this.accessibleBiddingStrategyServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [AccessibleBiddingStrategy]{@link google.ads.googleads.v8.resources.AccessibleBiddingStrategy}.
 *   Please see the
 ...
 * region_tag:googleads_v8_generated_AccessibleBiddingStrategyService_GetAccessibleBiddingStrategy_async
 */
  getAccessibleBiddingStrategy(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v8.services.IGetAccessibleBiddingStrategyRequest|undefined, {}|undefined
      ]>;
  getAccessibleBiddingStrategy(
      request: protos.google.ads.googleads.v8.services.IGetAccessibleBiddingStrategyRequest,
      options: CallOptions,
