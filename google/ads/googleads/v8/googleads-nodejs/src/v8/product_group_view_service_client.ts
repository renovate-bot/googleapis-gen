...
export class ProductGroupViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.ProductGroupViewService', gapicConfig as gax.ClientConfig,
 ...
 *   The first element of the array is an object representing [ProductGroupView]{@link google.ads.googleads.v8.resources.ProductGroupView}.
 *   Please see the
