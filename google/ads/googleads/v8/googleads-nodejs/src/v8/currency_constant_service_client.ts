 ...
 * @example <caption>include:samples/generated/v8/currency_constant_service.get_currency_constant.js</caption>
 * region_tag:googleads_v8_generated_CurrencyConstantService_GetCurrencyConstant_async
 */
  getCurrencyConstant(
