 ...
 */
import * as gapicConfig from './custom_interest_service_client_config.json';
...
export class CustomInterestServiceClient {
  ...
  customInterestServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CustomInterestServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.CustomInterestService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const customInterestServiceStubMethods =
        ['getCustomInterest', 'mutateCustomInterests'];
    for (const methodName of customInterestServiceStubMethods) {
      const callPromise = this.customInterestServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [CustomInterest]{@link google.ads.googleads.v8.resources.CustomInterest}.
 *   Please see the
 ...
 * region_tag:googleads_v8_generated_CustomInterestService_GetCustomInterest_async
 */
  getCustomInterest(
      request?: protos.google.ads.googleads.v8.services.IGetCustomInterestRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v8.resources.ICustomInterest,
        protos.google.ads.googleads.v8.services.IGetCustomInterestRequest|undefined, {}|undefined
      ]>;
  getCustomInterest(
      request: protos.google.ads.googleads.v8.services.IGetCustomInterestRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v8.resources.ICustomInterest,
          protos.google.ads.googleads.v8.services.IGetCustomInterestRequest|null|undefined,
          {}|null|undefined>): void;
  getCustomInterest(
      request: protos.google.ads.googleads.v8.services.IGetCustomInterestRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomInterestsResponse]{@link google.ads.googleads.v8.services.MutateCustomInterestsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v8/custom_interest_service.mutate_custom_interests.js</caption>
 * region_tag:googleads_v8_generated_CustomInterestService_MutateCustomInterests_async
 */
  mutateCustomInterests(
      request?: protos.google.ads.googleads.v8.services.IMutateCustomInterestsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v8.services.IMutateCustomInterestsResponse,
        protos.google.ads.googleads.v8.services.IMutateCustomInterestsRequest|undefined, {}|undefined
      ]>;
  mutateCustomInterests(
      request: protos.google.ads.googleads.v8.services.IMutateCustomInterestsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v8.services.IMutateCustomInterestsResponse,
          protos.google.ads.googleads.v8.services.IMutateCustomInterestsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCustomInterests(
      request: protos.google.ads.googleads.v8.services.IMutateCustomInterestsRequest,
      callback: Callback<
