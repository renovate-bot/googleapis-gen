 ...
 */
import * as gapicConfig from './remarketing_action_service_client_config.json';
...
export class RemarketingActionServiceClient {
  ...
  remarketingActionServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof RemarketingActionServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.RemarketingActionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const remarketingActionServiceStubMethods =
        ['getRemarketingAction', 'mutateRemarketingActions'];
    for (const methodName of remarketingActionServiceStubMethods) {
      const callPromise = this.remarketingActionServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [RemarketingAction]{@link google.ads.googleads.v8.resources.RemarketingAction}.
 *   Please see the
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateRemarketingActionsResponse]{@link google.ads.googleads.v8.services.MutateRemarketingActionsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
