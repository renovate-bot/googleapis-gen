 ...
 * @example <caption>include:samples/generated/v8/location_view_service.get_location_view.js</caption>
 * region_tag:googleads_v8_generated_LocationViewService_GetLocationView_async
 */
  getLocationView(
