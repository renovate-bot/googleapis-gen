 ...
 * `src/v8/bidding_seasonality_adjustment_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './bidding_seasonality_adjustment_service_client_config.json';
 ...
 * @memberof v8
 */
export class BiddingSeasonalityAdjustmentServiceClient {
  ...
  biddingSeasonalityAdjustmentServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof BiddingSeasonalityAdjustmentServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.BiddingSeasonalityAdjustmentService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.biddingSeasonalityAdjustmentServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.ads.googleads.v8.services.BiddingSeasonalityAdjustmentService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.ads.googleads.v8.services.BiddingSeasonalityAdjustmentService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const biddingSeasonalityAdjustmentServiceStubMethods =
        ['getBiddingSeasonalityAdjustment', 'mutateBiddingSeasonalityAdjustments'];
    for (const methodName of biddingSeasonalityAdjustmentServiceStubMethods) {
      const callPromise = this.biddingSeasonalityAdjustmentServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getBiddingSeasonalityAdjustment(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v8.services.IGetBiddingSeasonalityAdjustmentRequest|undefined, {}|undefined
      ]>;
  getBiddingSeasonalityAdjustment(
      request: protos.google.ads.googleads.v8.services.IGetBiddingSeasonalityAdjustmentRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateBiddingSeasonalityAdjustmentsResponse]{@link google.ads.googleads.v8.services.MutateBiddingSeasonalityAdjustmentsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
