 ...
 * @example <caption>include:samples/generated/v8/distance_view_service.get_distance_view.js</caption>
 * region_tag:googleads_v8_generated_DistanceViewService_GetDistanceView_async
 */
  getDistanceView(
