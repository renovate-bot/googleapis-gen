 ...
 */
import * as gapicConfig from './domain_category_service_client_config.json';
...
export class DomainCategoryServiceClient {
  ...
  domainCategoryServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof DomainCategoryServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.DomainCategoryService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const domainCategoryServiceStubMethods =
        ['getDomainCategory'];
    for (const methodName of domainCategoryServiceStubMethods) {
      const callPromise = this.domainCategoryServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [DomainCategory]{@link google.ads.googleads.v8.resources.DomainCategory}.
 *   Please see the
 ...
 * region_tag:googleads_v8_generated_DomainCategoryService_GetDomainCategory_async
 */
  getDomainCategory(
      request?: protos.google.ads.googleads.v8.services.IGetDomainCategoryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v8.resources.IDomainCategory,
        protos.google.ads.googleads.v8.services.IGetDomainCategoryRequest|undefined, {}|undefined
      ]>;
  getDomainCategory(
      request: protos.google.ads.googleads.v8.services.IGetDomainCategoryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v8.resources.IDomainCategory,
          protos.google.ads.googleads.v8.services.IGetDomainCategoryRequest|null|undefined,
          {}|null|undefined>): void;
  getDomainCategory(
      request: protos.google.ads.googleads.v8.services.IGetDomainCategoryRequest,
      callback: Callback<
