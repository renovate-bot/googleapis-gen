 ...
 */
import * as gapicConfig from './landing_page_view_service_client_config.json';
...
export class LandingPageViewServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.LandingPageViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const landingPageViewServiceStubMethods =
        ['getLandingPageView'];
    for (const methodName of landingPageViewServiceStubMethods) {
      const callPromise = this.landingPageViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [LandingPageView]{@link google.ads.googleads.v8.resources.LandingPageView}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v8/landing_page_view_service.get_landing_page_view.js</caption>
 * region_tag:googleads_v8_generated_LandingPageViewService_GetLandingPageView_async
 */
  getLandingPageView(
      ...
      Promise<[
        ...
        protos.google.ads.googleads.v8.services.IGetLandingPageViewRequest|undefined, {}|undefined
      ]>;
  getLandingPageView(
      request: protos.google.ads.googleads.v8.services.IGetLandingPageViewRequest,
      options: CallOptions,
