 ...
 */
import * as gapicConfig from './customer_feed_service_client_config.json';
...
export class CustomerFeedServiceClient {
  ...
  customerFeedServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CustomerFeedServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.CustomerFeedService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const customerFeedServiceStubMethods =
        ['getCustomerFeed', 'mutateCustomerFeeds'];
    for (const methodName of customerFeedServiceStubMethods) {
      const callPromise = this.customerFeedServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [CustomerFeed]{@link google.ads.googleads.v8.resources.CustomerFeed}.
 *   Please see the
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCustomerFeedsResponse]{@link google.ads.googleads.v8.services.MutateCustomerFeedsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
