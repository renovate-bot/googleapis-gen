 ...
 */
import * as gapicConfig from './feed_mapping_service_client_config.json';
...
export class FeedMappingServiceClient {
  ...
  feedMappingServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof FeedMappingServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.FeedMappingService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const feedMappingServiceStubMethods =
        ['getFeedMapping', 'mutateFeedMappings'];
    for (const methodName of feedMappingServiceStubMethods) {
      const callPromise = this.feedMappingServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [FeedMapping]{@link google.ads.googleads.v8.resources.FeedMapping}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v8/feed_mapping_service.get_feed_mapping.js</caption>
 * region_tag:googleads_v8_generated_FeedMappingService_GetFeedMapping_async
 */
  getFeedMapping(
      request?: protos.google.ads.googleads.v8.services.IGetFeedMappingRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v8.resources.IFeedMapping,
        protos.google.ads.googleads.v8.services.IGetFeedMappingRequest|undefined, {}|undefined
      ]>;
  getFeedMapping(
      request: protos.google.ads.googleads.v8.services.IGetFeedMappingRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v8.resources.IFeedMapping,
          protos.google.ads.googleads.v8.services.IGetFeedMappingRequest|null|undefined,
          {}|null|undefined>): void;
  getFeedMapping(
      request: protos.google.ads.googleads.v8.services.IGetFeedMappingRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateFeedMappingsResponse]{@link google.ads.googleads.v8.services.MutateFeedMappingsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v8/feed_mapping_service.mutate_feed_mappings.js</caption>
 * region_tag:googleads_v8_generated_FeedMappingService_MutateFeedMappings_async
 */
  mutateFeedMappings(
      request?: protos.google.ads.googleads.v8.services.IMutateFeedMappingsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v8.services.IMutateFeedMappingsResponse,
        protos.google.ads.googleads.v8.services.IMutateFeedMappingsRequest|undefined, {}|undefined
      ]>;
  mutateFeedMappings(
      request: protos.google.ads.googleads.v8.services.IMutateFeedMappingsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v8.services.IMutateFeedMappingsResponse,
          protos.google.ads.googleads.v8.services.IMutateFeedMappingsRequest|null|undefined,
          {}|null|undefined>): void;
  mutateFeedMappings(
      request: protos.google.ads.googleads.v8.services.IMutateFeedMappingsRequest,
      callback: Callback<
