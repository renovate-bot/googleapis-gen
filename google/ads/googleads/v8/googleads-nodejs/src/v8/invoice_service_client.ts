 ...
 */
import * as gapicConfig from './invoice_service_client_config.json';
...
export class InvoiceServiceClient {
  ...
  invoiceServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof InvoiceServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.InvoiceService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const invoiceServiceStubMethods =
        ['listInvoices'];
    for (const methodName of invoiceServiceStubMethods) {
      const callPromise = this.invoiceServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {google.ads.googleads.v8.enums.MonthOfYearEnum.MonthOfYear} request.issueMonth
 *   Required. The issue month to retrieve invoices.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [ListInvoicesResponse]{@link google.ads.googleads.v8.services.ListInvoicesResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v8/invoice_service.list_invoices.js</caption>
 * region_tag:googleads_v8_generated_InvoiceService_ListInvoices_async
 */
  listInvoices(
      request?: protos.google.ads.googleads.v8.services.IListInvoicesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v8.services.IListInvoicesResponse,
        protos.google.ads.googleads.v8.services.IListInvoicesRequest|undefined, {}|undefined
      ]>;
  listInvoices(
      request: protos.google.ads.googleads.v8.services.IListInvoicesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v8.services.IListInvoicesResponse,
          protos.google.ads.googleads.v8.services.IListInvoicesRequest|null|undefined,
          {}|null|undefined>): void;
  listInvoices(
      request: protos.google.ads.googleads.v8.services.IListInvoicesRequest,
      callback: Callback<
