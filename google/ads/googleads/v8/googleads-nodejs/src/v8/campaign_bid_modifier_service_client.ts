 ...
 */
import * as gapicConfig from './campaign_bid_modifier_service_client_config.json';
...
export class CampaignBidModifierServiceClient {
  ...
  campaignBidModifierServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof CampaignBidModifierServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.CampaignBidModifierService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const campaignBidModifierServiceStubMethods =
        ['getCampaignBidModifier', 'mutateCampaignBidModifiers'];
    for (const methodName of campaignBidModifierServiceStubMethods) {
      const callPromise = this.campaignBidModifierServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [CampaignBidModifier]{@link google.ads.googleads.v8.resources.CampaignBidModifier}.
 *   Please see the
 ...
 * region_tag:googleads_v8_generated_CampaignBidModifierService_GetCampaignBidModifier_async
 */
  getCampaignBidModifier(
      request?: protos.google.ads.googleads.v8.services.IGetCampaignBidModifierRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v8.resources.ICampaignBidModifier,
        protos.google.ads.googleads.v8.services.IGetCampaignBidModifierRequest|undefined, {}|undefined
      ]>;
  getCampaignBidModifier(
      request: protos.google.ads.googleads.v8.services.IGetCampaignBidModifierRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v8.resources.ICampaignBidModifier,
          protos.google.ads.googleads.v8.services.IGetCampaignBidModifierRequest|null|undefined,
          {}|null|undefined>): void;
  getCampaignBidModifier(
      request: protos.google.ads.googleads.v8.services.IGetCampaignBidModifierRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MutateCampaignBidModifiersResponse]{@link google.ads.googleads.v8.services.MutateCampaignBidModifiersResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v8/campaign_bid_modifier_service.mutate_campaign_bid_modifiers.js</caption>
 * region_tag:googleads_v8_generated_CampaignBidModifierService_MutateCampaignBidModifiers_async
 */
  mutateCampaignBidModifiers(
      request?: protos.google.ads.googleads.v8.services.IMutateCampaignBidModifiersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v8.services.IMutateCampaignBidModifiersResponse,
        protos.google.ads.googleads.v8.services.IMutateCampaignBidModifiersRequest|undefined, {}|undefined
      ]>;
  mutateCampaignBidModifiers(
      request: protos.google.ads.googleads.v8.services.IMutateCampaignBidModifiersRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v8.services.IMutateCampaignBidModifiersResponse,
          protos.google.ads.googleads.v8.services.IMutateCampaignBidModifiersRequest|null|undefined,
          {}|null|undefined>): void;
  mutateCampaignBidModifiers(
      request: protos.google.ads.googleads.v8.services.IMutateCampaignBidModifiersRequest,
      callback: Callback<
