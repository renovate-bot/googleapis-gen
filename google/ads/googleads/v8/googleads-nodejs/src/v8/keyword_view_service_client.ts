 ...
 */
import * as gapicConfig from './keyword_view_service_client_config.json';
...
export class KeywordViewServiceClient {
  ...
  keywordViewServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof KeywordViewServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.ads.googleads.v8.services.KeywordViewService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    const keywordViewServiceStubMethods =
        ['getKeywordView'];
    for (const methodName of keywordViewServiceStubMethods) {
      const callPromise = this.keywordViewServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [KeywordView]{@link google.ads.googleads.v8.resources.KeywordView}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v8/keyword_view_service.get_keyword_view.js</caption>
 * region_tag:googleads_v8_generated_KeywordViewService_GetKeywordView_async
 */
  getKeywordView(
      request?: protos.google.ads.googleads.v8.services.IGetKeywordViewRequest,
      options?: CallOptions):
      Promise<[
        protos.google.ads.googleads.v8.resources.IKeywordView,
        protos.google.ads.googleads.v8.services.IGetKeywordViewRequest|undefined, {}|undefined
      ]>;
  getKeywordView(
      request: protos.google.ads.googleads.v8.services.IGetKeywordViewRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.ads.googleads.v8.resources.IKeywordView,
          protos.google.ads.googleads.v8.services.IGetKeywordViewRequest|null|undefined,
          {}|null|undefined>): void;
  getKeywordView(
      request: protos.google.ads.googleads.v8.services.IGetKeywordViewRequest,
      callback: Callback<
