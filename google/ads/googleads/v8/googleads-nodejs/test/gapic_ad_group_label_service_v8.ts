...
describe('v8.AdGroupLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgrouplabelserviceModule.v8.AdGroupLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgrouplabelserviceModule.v8.AdGroupLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgrouplabelserviceModule.v8.AdGroupLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgrouplabelserviceModule.v8.AdGroupLabelServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroupLabel', () => {
        it('invokes getAdGroupLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetAdGroupLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AdGroupLabel());
        ...
        it('invokes getAdGroupLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IAdGroupLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroupLabels', () => {
        it('invokes mutateAdGroupLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAdGroupLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAdGroupLabelsResponse());
        ...
        it('invokes mutateAdGroupLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateAdGroupLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
