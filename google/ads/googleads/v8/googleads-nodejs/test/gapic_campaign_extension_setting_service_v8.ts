...
describe('v8.CampaignExtensionSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignextensionsettingserviceModule.v8.CampaignExtensionSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignextensionsettingserviceModule.v8.CampaignExtensionSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignextensionsettingserviceModule.v8.CampaignExtensionSettingServiceClient.port;
        assert(port);
    ...
    describe('getCampaignExtensionSetting', () => {
        it('invokes getCampaignExtensionSetting without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CampaignExtensionSetting());
        ...
        it('invokes getCampaignExtensionSetting without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignExtensionSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICampaignExtensionSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignExtensionSettings', () => {
        it('invokes mutateCampaignExtensionSettings without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCampaignExtensionSettingsResponse());
        ...
        it('invokes mutateCampaignExtensionSettings without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignExtensionSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateCampaignExtensionSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
