...
import * as keywordthemeconstantserviceModule from '../src';
...
describe('v8.KeywordThemeConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordthemeconstantserviceModule.v8.KeywordThemeConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordthemeconstantserviceModule.v8.KeywordThemeConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordthemeconstantserviceModule.v8.KeywordThemeConstantServiceClient.port;
        assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.keywordThemeConstantServiceStub);
    });
    ...
    describe('getKeywordThemeConstant', () => {
        it('invokes getKeywordThemeConstant without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.KeywordThemeConstant());
            client.innerApiCalls.getKeywordThemeConstant = stubSimpleCall(expectedResponse);
            const [response] = await client.getKeywordThemeConstant(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getKeywordThemeConstant as SinonStub)
        ...
        it('invokes getKeywordThemeConstant without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.KeywordThemeConstant());
            client.innerApiCalls.getKeywordThemeConstant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordThemeConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IKeywordThemeConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getKeywordThemeConstant with error', async () => {
            ...
            client.innerApiCalls.getKeywordThemeConstant = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getKeywordThemeConstant(request), expectedError);
            assert((client.innerApiCalls.getKeywordThemeConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('suggestKeywordThemeConstants', () => {
        it('invokes suggestKeywordThemeConstants without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.suggestKeywordThemeConstants as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes suggestKeywordThemeConstants without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestKeywordThemeConstants(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.ISuggestKeywordThemeConstantsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
