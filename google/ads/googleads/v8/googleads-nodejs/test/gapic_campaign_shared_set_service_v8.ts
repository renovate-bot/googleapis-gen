...
describe('v8.CampaignSharedSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignsharedsetserviceModule.v8.CampaignSharedSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignsharedsetserviceModule.v8.CampaignSharedSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignsharedsetserviceModule.v8.CampaignSharedSetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignsharedsetserviceModule.v8.CampaignSharedSetServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignSharedSet', () => {
        it('invokes getCampaignSharedSet without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCampaignSharedSetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CampaignSharedSet());
        ...
        it('invokes getCampaignSharedSet without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignSharedSet(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICampaignSharedSet|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignSharedSets', () => {
        it('invokes mutateCampaignSharedSets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCampaignSharedSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCampaignSharedSetsResponse());
        ...
        it('invokes mutateCampaignSharedSets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignSharedSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateCampaignSharedSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
