...
describe('v8.DetailPlacementViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = detailplacementviewserviceModule.v8.DetailPlacementViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = detailplacementviewserviceModule.v8.DetailPlacementViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = detailplacementviewserviceModule.v8.DetailPlacementViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new detailplacementviewserviceModule.v8.DetailPlacementViewServiceClient();
        assert(client);
    });
    ...
    describe('getDetailPlacementView', () => {
        it('invokes getDetailPlacementView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetDetailPlacementViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.DetailPlacementView());
        ...
        it('invokes getDetailPlacementView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDetailPlacementView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IDetailPlacementView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
