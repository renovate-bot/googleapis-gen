...
import * as smartcampaignsettingserviceModule from '../src';
...
describe('v8.SmartCampaignSettingServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = smartcampaignsettingserviceModule.v8.SmartCampaignSettingServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = smartcampaignsettingserviceModule.v8.SmartCampaignSettingServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = smartcampaignsettingserviceModule.v8.SmartCampaignSettingServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new smartcampaignsettingserviceModule.v8.SmartCampaignSettingServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.smartCampaignSettingServiceStub, undefined);
        await client.initialize();
        assert(client.smartCampaignSettingServiceStub);
    });
    ...
    describe('getSmartCampaignSetting', () => {
        it('invokes getSmartCampaignSetting without error', async () => {
            const client = new smartcampaignsettingserviceModule.v8.SmartCampaignSettingServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetSmartCampaignSettingRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.SmartCampaignSetting());
            client.innerApiCalls.getSmartCampaignSetting = stubSimpleCall(expectedResponse);
            const [response] = await client.getSmartCampaignSetting(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSmartCampaignSetting as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getSmartCampaignSetting without error using callback', async () => {
            const client = new smartcampaignsettingserviceModule.v8.SmartCampaignSettingServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.SmartCampaignSetting());
            client.innerApiCalls.getSmartCampaignSetting = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSmartCampaignSetting(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ISmartCampaignSetting|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getSmartCampaignSetting with error', async () => {
            const client = new smartcampaignsettingserviceModule.v8.SmartCampaignSettingServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getSmartCampaignSetting = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getSmartCampaignSetting(request), expectedError);
            assert((client.innerApiCalls.getSmartCampaignSetting as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateSmartCampaignSettings', () => {
        it('invokes mutateSmartCampaignSettings without error', async () => {
            const client = new smartcampaignsettingserviceModule.v8.SmartCampaignSettingServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateSmartCampaignSettingsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateSmartCampaignSettingsResponse());
            client.innerApiCalls.mutateSmartCampaignSettings = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateSmartCampaignSettings(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateSmartCampaignSettings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateSmartCampaignSettings without error using callback', async () => {
            const client = new smartcampaignsettingserviceModule.v8.SmartCampaignSettingServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateSmartCampaignSettingsResponse());
            client.innerApiCalls.mutateSmartCampaignSettings = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateSmartCampaignSettings(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateSmartCampaignSettingsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateSmartCampaignSettings with error', async () => {
            const client = new smartcampaignsettingserviceModule.v8.SmartCampaignSettingServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateSmartCampaignSettings = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateSmartCampaignSettings(request), expectedError);
            assert((client.innerApiCalls.mutateSmartCampaignSettings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
