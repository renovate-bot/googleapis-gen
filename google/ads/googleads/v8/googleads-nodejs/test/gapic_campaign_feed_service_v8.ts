...
describe('v8.CampaignFeedServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignfeedserviceModule.v8.CampaignFeedServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignfeedserviceModule.v8.CampaignFeedServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignfeedserviceModule.v8.CampaignFeedServiceClient.port;
        assert(port);
    ...
    describe('getCampaignFeed', () => {
        it('invokes getCampaignFeed without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CampaignFeed());
        ...
        it('invokes getCampaignFeed without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignFeed(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICampaignFeed|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignFeeds', () => {
        it('invokes mutateCampaignFeeds without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCampaignFeedsResponse());
        ...
        it('invokes mutateCampaignFeeds without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignFeeds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateCampaignFeedsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
