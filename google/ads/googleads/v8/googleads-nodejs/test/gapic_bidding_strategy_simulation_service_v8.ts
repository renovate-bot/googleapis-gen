...
describe('v8.BiddingStrategySimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = biddingstrategysimulationserviceModule.v8.BiddingStrategySimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = biddingstrategysimulationserviceModule.v8.BiddingStrategySimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = biddingstrategysimulationserviceModule.v8.BiddingStrategySimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new biddingstrategysimulationserviceModule.v8.BiddingStrategySimulationServiceClient();
        assert(client);
    });
    ...
    describe('getBiddingStrategySimulation', () => {
        it('invokes getBiddingStrategySimulation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetBiddingStrategySimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.BiddingStrategySimulation());
        ...
        it('invokes getBiddingStrategySimulation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBiddingStrategySimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IBiddingStrategySimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
