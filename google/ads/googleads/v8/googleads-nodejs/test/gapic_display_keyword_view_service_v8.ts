...
describe('v8.DisplayKeywordViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = displaykeywordviewserviceModule.v8.DisplayKeywordViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = displaykeywordviewserviceModule.v8.DisplayKeywordViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = displaykeywordviewserviceModule.v8.DisplayKeywordViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new displaykeywordviewserviceModule.v8.DisplayKeywordViewServiceClient();
        assert(client);
    });
    ...
    describe('getDisplayKeywordView', () => {
        it('invokes getDisplayKeywordView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetDisplayKeywordViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.DisplayKeywordView());
        ...
        it('invokes getDisplayKeywordView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDisplayKeywordView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IDisplayKeywordView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
