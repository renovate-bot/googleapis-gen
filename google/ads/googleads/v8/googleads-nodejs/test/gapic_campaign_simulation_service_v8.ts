...
import * as campaignsimulationserviceModule from '../src';
...
describe('v8.CampaignSimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignsimulationserviceModule.v8.CampaignSimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignsimulationserviceModule.v8.CampaignSimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignsimulationserviceModule.v8.CampaignSimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignsimulationserviceModule.v8.CampaignSimulationServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.campaignSimulationServiceStub, undefined);
        await client.initialize();
        assert(client.campaignSimulationServiceStub);
    });
    ...
    describe('getCampaignSimulation', () => {
        it('invokes getCampaignSimulation without error', async () => {
            const client = new campaignsimulationserviceModule.v8.CampaignSimulationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCampaignSimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CampaignSimulation());
            client.innerApiCalls.getCampaignSimulation = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignSimulation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignSimulation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCampaignSimulation without error using callback', async () => {
            const client = new campaignsimulationserviceModule.v8.CampaignSimulationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CampaignSimulation());
            client.innerApiCalls.getCampaignSimulation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICampaignSimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignSimulation with error', async () => {
            const client = new campaignsimulationserviceModule.v8.CampaignSimulationServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getCampaignSimulation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignSimulation(request), expectedError);
            assert((client.innerApiCalls.getCampaignSimulation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
