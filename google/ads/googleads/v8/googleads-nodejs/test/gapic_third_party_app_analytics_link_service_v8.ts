...
import * as thirdpartyappanalyticslinkserviceModule from '../src';
...
describe('v8.ThirdPartyAppAnalyticsLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = thirdpartyappanalyticslinkserviceModule.v8.ThirdPartyAppAnalyticsLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = thirdpartyappanalyticslinkserviceModule.v8.ThirdPartyAppAnalyticsLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = thirdpartyappanalyticslinkserviceModule.v8.ThirdPartyAppAnalyticsLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new thirdpartyappanalyticslinkserviceModule.v8.ThirdPartyAppAnalyticsLinkServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.thirdPartyAppAnalyticsLinkServiceStub, undefined);
        await client.initialize();
        assert(client.thirdPartyAppAnalyticsLinkServiceStub);
    });
    ...
    describe('getThirdPartyAppAnalyticsLink', () => {
        it('invokes getThirdPartyAppAnalyticsLink without error', async () => {
            const client = new thirdpartyappanalyticslinkserviceModule.v8.ThirdPartyAppAnalyticsLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetThirdPartyAppAnalyticsLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ThirdPartyAppAnalyticsLink());
            client.innerApiCalls.getThirdPartyAppAnalyticsLink = stubSimpleCall(expectedResponse);
            const [response] = await client.getThirdPartyAppAnalyticsLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getThirdPartyAppAnalyticsLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getThirdPartyAppAnalyticsLink without error using callback', async () => {
            const client = new thirdpartyappanalyticslinkserviceModule.v8.ThirdPartyAppAnalyticsLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ThirdPartyAppAnalyticsLink());
            client.innerApiCalls.getThirdPartyAppAnalyticsLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getThirdPartyAppAnalyticsLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IThirdPartyAppAnalyticsLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getThirdPartyAppAnalyticsLink with error', async () => {
            const client = new thirdpartyappanalyticslinkserviceModule.v8.ThirdPartyAppAnalyticsLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getThirdPartyAppAnalyticsLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getThirdPartyAppAnalyticsLink(request), expectedError);
            assert((client.innerApiCalls.getThirdPartyAppAnalyticsLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('regenerateShareableLinkId', () => {
        it('invokes regenerateShareableLinkId without error', async () => {
            const client = new thirdpartyappanalyticslinkserviceModule.v8.ThirdPartyAppAnalyticsLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.RegenerateShareableLinkIdRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.RegenerateShareableLinkIdResponse());
            client.innerApiCalls.regenerateShareableLinkId = stubSimpleCall(expectedResponse);
            const [response] = await client.regenerateShareableLinkId(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.regenerateShareableLinkId as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes regenerateShareableLinkId without error using callback', async () => {
            const client = new thirdpartyappanalyticslinkserviceModule.v8.ThirdPartyAppAnalyticsLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.RegenerateShareableLinkIdResponse());
            client.innerApiCalls.regenerateShareableLinkId = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.regenerateShareableLinkId(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IRegenerateShareableLinkIdResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes regenerateShareableLinkId with error', async () => {
            const client = new thirdpartyappanalyticslinkserviceModule.v8.ThirdPartyAppAnalyticsLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.regenerateShareableLinkId = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.regenerateShareableLinkId(request), expectedError);
            assert((client.innerApiCalls.regenerateShareableLinkId as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
