...
describe('v8.PaidOrganicSearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = paidorganicsearchtermviewserviceModule.v8.PaidOrganicSearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = paidorganicsearchtermviewserviceModule.v8.PaidOrganicSearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = paidorganicsearchtermviewserviceModule.v8.PaidOrganicSearchTermViewServiceClient.port;
        assert(port);
    ...
    describe('getPaidOrganicSearchTermView', () => {
        it('invokes getPaidOrganicSearchTermView without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.PaidOrganicSearchTermView());
        ...
        it('invokes getPaidOrganicSearchTermView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPaidOrganicSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IPaidOrganicSearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
