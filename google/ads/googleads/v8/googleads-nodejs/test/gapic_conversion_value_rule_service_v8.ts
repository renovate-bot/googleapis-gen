...
describe('v8.ConversionValueRuleServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionvalueruleserviceModule.v8.ConversionValueRuleServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionvalueruleserviceModule.v8.ConversionValueRuleServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionvalueruleserviceModule.v8.ConversionValueRuleServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionvalueruleserviceModule.v8.ConversionValueRuleServiceClient();
        assert(client);
    });
    ...
    describe('getConversionValueRule', () => {
        it('invokes getConversionValueRule without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetConversionValueRuleRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ConversionValueRule());
        ...
        it('invokes getConversionValueRule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConversionValueRule(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IConversionValueRule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateConversionValueRules', () => {
        it('invokes mutateConversionValueRules without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateConversionValueRulesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateConversionValueRulesResponse());
        ...
        it('invokes mutateConversionValueRules without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionValueRules(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateConversionValueRulesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
