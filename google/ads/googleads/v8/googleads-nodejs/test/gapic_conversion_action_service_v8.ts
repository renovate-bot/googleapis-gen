...
describe('v8.ConversionActionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionactionserviceModule.v8.ConversionActionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionactionserviceModule.v8.ConversionActionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionactionserviceModule.v8.ConversionActionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionactionserviceModule.v8.ConversionActionServiceClient();
        assert(client);
    });
    ...
    describe('getConversionAction', () => {
        it('invokes getConversionAction without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetConversionActionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ConversionAction());
        ...
        it('invokes getConversionAction without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConversionAction(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IConversionAction|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateConversionActions', () => {
        it('invokes mutateConversionActions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateConversionActionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateConversionActionsResponse());
        ...
        it('invokes mutateConversionActions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionActions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateConversionActionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
