...
describe('v8.CurrencyConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = currencyconstantserviceModule.v8.CurrencyConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = currencyconstantserviceModule.v8.CurrencyConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = currencyconstantserviceModule.v8.CurrencyConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new currencyconstantserviceModule.v8.CurrencyConstantServiceClient();
        assert(client);
    });
    ...
    describe('getCurrencyConstant', () => {
        it('invokes getCurrencyConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCurrencyConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CurrencyConstant());
        ...
        it('invokes getCurrencyConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCurrencyConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICurrencyConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
