...
import * as campaignbidmodifierserviceModule from '../src';
...
describe('v8.CampaignBidModifierServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignbidmodifierserviceModule.v8.CampaignBidModifierServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignbidmodifierserviceModule.v8.CampaignBidModifierServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignbidmodifierserviceModule.v8.CampaignBidModifierServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignbidmodifierserviceModule.v8.CampaignBidModifierServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.campaignBidModifierServiceStub, undefined);
        await client.initialize();
        assert(client.campaignBidModifierServiceStub);
    });
    ...
    describe('getCampaignBidModifier', () => {
        it('invokes getCampaignBidModifier without error', async () => {
            const client = new campaignbidmodifierserviceModule.v8.CampaignBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCampaignBidModifierRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CampaignBidModifier());
            client.innerApiCalls.getCampaignBidModifier = stubSimpleCall(expectedResponse);
            const [response] = await client.getCampaignBidModifier(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCampaignBidModifier as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCampaignBidModifier without error using callback', async () => {
            const client = new campaignbidmodifierserviceModule.v8.CampaignBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CampaignBidModifier());
            client.innerApiCalls.getCampaignBidModifier = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignBidModifier(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICampaignBidModifier|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCampaignBidModifier with error', async () => {
            const client = new campaignbidmodifierserviceModule.v8.CampaignBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getCampaignBidModifier = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCampaignBidModifier(request), expectedError);
            assert((client.innerApiCalls.getCampaignBidModifier as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCampaignBidModifiers', () => {
        it('invokes mutateCampaignBidModifiers without error', async () => {
            const client = new campaignbidmodifierserviceModule.v8.CampaignBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCampaignBidModifiersRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCampaignBidModifiersResponse());
            client.innerApiCalls.mutateCampaignBidModifiers = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCampaignBidModifiers(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCampaignBidModifiers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCampaignBidModifiers without error using callback', async () => {
            const client = new campaignbidmodifierserviceModule.v8.CampaignBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCampaignBidModifiersResponse());
            client.innerApiCalls.mutateCampaignBidModifiers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignBidModifiers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateCampaignBidModifiersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCampaignBidModifiers with error', async () => {
            const client = new campaignbidmodifierserviceModule.v8.CampaignBidModifierServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCampaignBidModifiers = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCampaignBidModifiers(request), expectedError);
            assert((client.innerApiCalls.mutateCampaignBidModifiers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
