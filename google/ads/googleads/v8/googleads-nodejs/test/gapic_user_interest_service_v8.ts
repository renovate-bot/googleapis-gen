...
describe('v8.UserInterestServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = userinterestserviceModule.v8.UserInterestServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = userinterestserviceModule.v8.UserInterestServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = userinterestserviceModule.v8.UserInterestServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new userinterestserviceModule.v8.UserInterestServiceClient();
        assert(client);
    });
    ...
    describe('getUserInterest', () => {
        it('invokes getUserInterest without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetUserInterestRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.UserInterest());
        ...
        it('invokes getUserInterest without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getUserInterest(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IUserInterest|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
