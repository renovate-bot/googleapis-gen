...
import * as offlineuserdatajobserviceModule from '../src';
...
describe('v8.OfflineUserDataJobServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = offlineuserdatajobserviceModule.v8.OfflineUserDataJobServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = offlineuserdatajobserviceModule.v8.OfflineUserDataJobServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = offlineuserdatajobserviceModule.v8.OfflineUserDataJobServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new offlineuserdatajobserviceModule.v8.OfflineUserDataJobServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.offlineUserDataJobServiceStub);
    });
    ...
    describe('createOfflineUserDataJob', () => {
        it('invokes createOfflineUserDataJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.CreateOfflineUserDataJobRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.CreateOfflineUserDataJobResponse());
            client.innerApiCalls.createOfflineUserDataJob = stubSimpleCall(expectedResponse);
            const [response] = await client.createOfflineUserDataJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createOfflineUserDataJob as SinonStub)
        ...
        it('invokes createOfflineUserDataJob without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.CreateOfflineUserDataJobResponse());
            client.innerApiCalls.createOfflineUserDataJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createOfflineUserDataJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.ICreateOfflineUserDataJobResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createOfflineUserDataJob with error', async () => {
            ...
            client.innerApiCalls.createOfflineUserDataJob = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createOfflineUserDataJob(request), expectedError);
            assert((client.innerApiCalls.createOfflineUserDataJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getOfflineUserDataJob', () => {
        it('invokes getOfflineUserDataJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetOfflineUserDataJobRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.OfflineUserDataJob());
            client.innerApiCalls.getOfflineUserDataJob = stubSimpleCall(expectedResponse);
            const [response] = await client.getOfflineUserDataJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getOfflineUserDataJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getOfflineUserDataJob without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.OfflineUserDataJob());
            client.innerApiCalls.getOfflineUserDataJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getOfflineUserDataJob(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IOfflineUserDataJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getOfflineUserDataJob with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.getOfflineUserDataJob = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getOfflineUserDataJob(request), expectedError);
            assert((client.innerApiCalls.getOfflineUserDataJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('addOfflineUserDataJobOperations', () => {
        it('invokes addOfflineUserDataJobOperations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.AddOfflineUserDataJobOperationsRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.AddOfflineUserDataJobOperationsResponse());
            client.innerApiCalls.addOfflineUserDataJobOperations = stubSimpleCall(expectedResponse);
            const [response] = await client.addOfflineUserDataJobOperations(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.addOfflineUserDataJobOperations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes addOfflineUserDataJobOperations without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.AddOfflineUserDataJobOperationsResponse());
            client.innerApiCalls.addOfflineUserDataJobOperations = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.addOfflineUserDataJobOperations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IAddOfflineUserDataJobOperationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes addOfflineUserDataJobOperations with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.addOfflineUserDataJobOperations = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.addOfflineUserDataJobOperations(request), expectedError);
            assert((client.innerApiCalls.addOfflineUserDataJobOperations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('runOfflineUserDataJob', () => {
        it('invokes runOfflineUserDataJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.RunOfflineUserDataJobRequest());
            request.resourceName = '';
            const expectedHeaderRequestParams = "resource_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            client.innerApiCalls.runOfflineUserDataJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.runOfflineUserDataJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runOfflineUserDataJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes runOfflineUserDataJob without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.runOfflineUserDataJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.runOfflineUserDataJob(
                    request,
                    (err?: Error|null,
        ...
        it('invokes runOfflineUserDataJob with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.runOfflineUserDataJob = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.runOfflineUserDataJob(request), expectedError);
            assert((client.innerApiCalls.runOfflineUserDataJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes runOfflineUserDataJob with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.runOfflineUserDataJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.runOfflineUserDataJob(request);
        ...
        it('invokes checkRunOfflineUserDataJobProgress without error', async () => {
            ...
            const decodedOperation = await client.checkRunOfflineUserDataJobProgress(expectedResponse.name);
        ...
        it('invokes checkRunOfflineUserDataJobProgress with error', async () => {
            ...
            await assert.rejects(client.checkRunOfflineUserDataJobProgress(''), expectedError);
