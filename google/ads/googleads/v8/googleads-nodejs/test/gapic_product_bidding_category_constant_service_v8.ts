...
import * as productbiddingcategoryconstantserviceModule from '../src';
...
describe('v8.ProductBiddingCategoryConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = productbiddingcategoryconstantserviceModule.v8.ProductBiddingCategoryConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = productbiddingcategoryconstantserviceModule.v8.ProductBiddingCategoryConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = productbiddingcategoryconstantserviceModule.v8.ProductBiddingCategoryConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new productbiddingcategoryconstantserviceModule.v8.ProductBiddingCategoryConstantServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.productBiddingCategoryConstantServiceStub, undefined);
        await client.initialize();
        assert(client.productBiddingCategoryConstantServiceStub);
    });
    ...
    describe('getProductBiddingCategoryConstant', () => {
        it('invokes getProductBiddingCategoryConstant without error', async () => {
            const client = new productbiddingcategoryconstantserviceModule.v8.ProductBiddingCategoryConstantServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetProductBiddingCategoryConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ProductBiddingCategoryConstant());
            client.innerApiCalls.getProductBiddingCategoryConstant = stubSimpleCall(expectedResponse);
            const [response] = await client.getProductBiddingCategoryConstant(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getProductBiddingCategoryConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getProductBiddingCategoryConstant without error using callback', async () => {
            const client = new productbiddingcategoryconstantserviceModule.v8.ProductBiddingCategoryConstantServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ProductBiddingCategoryConstant());
            client.innerApiCalls.getProductBiddingCategoryConstant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getProductBiddingCategoryConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IProductBiddingCategoryConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getProductBiddingCategoryConstant with error', async () => {
            const client = new productbiddingcategoryconstantserviceModule.v8.ProductBiddingCategoryConstantServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getProductBiddingCategoryConstant = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getProductBiddingCategoryConstant(request), expectedError);
            assert((client.innerApiCalls.getProductBiddingCategoryConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
