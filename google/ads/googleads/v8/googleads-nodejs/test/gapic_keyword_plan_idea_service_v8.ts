...
describe('v8.KeywordPlanIdeaServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanideaserviceModule.v8.KeywordPlanIdeaServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanideaserviceModule.v8.KeywordPlanIdeaServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanideaserviceModule.v8.KeywordPlanIdeaServiceClient.port;
        assert(port);
    ...
    describe('generateKeywordIdeas', () => {
        ...
        it('invokes generateKeywordIdeas without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateKeywordIdeas(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IGenerateKeywordIdeaResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes generateKeywordIdeasStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v8.services.GenerateKeywordIdeaResult[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v8.services.GenerateKeywordIdeaResult) => {
        ...
        it('uses async iteration with generateKeywordIdeas without error', async () => {
            ...
            const responses: protos.google.ads.googleads.v8.services.IGenerateKeywordIdeaResult[] = [];
