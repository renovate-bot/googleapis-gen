...
describe('v8.CampaignCriterionSimulationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaigncriterionsimulationserviceModule.v8.CampaignCriterionSimulationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaigncriterionsimulationserviceModule.v8.CampaignCriterionSimulationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaigncriterionsimulationserviceModule.v8.CampaignCriterionSimulationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaigncriterionsimulationserviceModule.v8.CampaignCriterionSimulationServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignCriterionSimulation', () => {
        it('invokes getCampaignCriterionSimulation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCampaignCriterionSimulationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CampaignCriterionSimulation());
        ...
        it('invokes getCampaignCriterionSimulation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignCriterionSimulation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICampaignCriterionSimulation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
