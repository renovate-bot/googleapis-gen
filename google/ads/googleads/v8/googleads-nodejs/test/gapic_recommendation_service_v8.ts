...
describe('v8.RecommendationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = recommendationserviceModule.v8.RecommendationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = recommendationserviceModule.v8.RecommendationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = recommendationserviceModule.v8.RecommendationServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new recommendationserviceModule.v8.RecommendationServiceClient();
        assert(client);
    });
    ...
    describe('getRecommendation', () => {
        it('invokes getRecommendation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetRecommendationRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.Recommendation());
            ...
            assert((client.innerApiCalls.getRecommendation as SinonStub)
        ...
        it('invokes getRecommendation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRecommendation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IRecommendation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('applyRecommendation', () => {
        it('invokes applyRecommendation without error', async () => {
            const client = new recommendationserviceModule.v8.RecommendationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.ApplyRecommendationRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.ApplyRecommendationResponse());
            client.innerApiCalls.applyRecommendation = stubSimpleCall(expectedResponse);
            const [response] = await client.applyRecommendation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.applyRecommendation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes applyRecommendation without error using callback', async () => {
            const client = new recommendationserviceModule.v8.RecommendationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.ApplyRecommendationResponse());
            client.innerApiCalls.applyRecommendation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.applyRecommendation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IApplyRecommendationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes applyRecommendation with error', async () => {
            const client = new recommendationserviceModule.v8.RecommendationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.applyRecommendation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.applyRecommendation(request), expectedError);
            assert((client.innerApiCalls.applyRecommendation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('dismissRecommendation', () => {
        it('invokes dismissRecommendation without error', async () => {
            const client = new recommendationserviceModule.v8.RecommendationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.DismissRecommendationRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.DismissRecommendationResponse());
            client.innerApiCalls.dismissRecommendation = stubSimpleCall(expectedResponse);
            const [response] = await client.dismissRecommendation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.dismissRecommendation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes dismissRecommendation without error using callback', async () => {
            const client = new recommendationserviceModule.v8.RecommendationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.DismissRecommendationResponse());
            client.innerApiCalls.dismissRecommendation = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.dismissRecommendation(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IDismissRecommendationResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes dismissRecommendation with error', async () => {
            const client = new recommendationserviceModule.v8.RecommendationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.dismissRecommendation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.dismissRecommendation(request), expectedError);
            assert((client.innerApiCalls.dismissRecommendation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
