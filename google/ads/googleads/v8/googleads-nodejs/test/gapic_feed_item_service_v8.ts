...
describe('v8.FeedItemServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feeditemserviceModule.v8.FeedItemServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feeditemserviceModule.v8.FeedItemServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feeditemserviceModule.v8.FeedItemServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feeditemserviceModule.v8.FeedItemServiceClient();
        assert(client);
    });
    ...
    describe('getFeedItem', () => {
        it('invokes getFeedItem without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetFeedItemRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.FeedItem());
        ...
        it('invokes getFeedItem without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeedItem(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IFeedItem|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateFeedItems', () => {
        it('invokes mutateFeedItems without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateFeedItemsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateFeedItemsResponse());
        ...
        it('invokes mutateFeedItems without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedItems(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateFeedItemsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
