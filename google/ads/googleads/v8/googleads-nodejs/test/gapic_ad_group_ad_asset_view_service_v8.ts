...
describe('v8.AdGroupAdAssetViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupadassetviewserviceModule.v8.AdGroupAdAssetViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupadassetviewserviceModule.v8.AdGroupAdAssetViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupadassetviewserviceModule.v8.AdGroupAdAssetViewServiceClient.port;
        assert(port);
    ...
    describe('getAdGroupAdAssetView', () => {
        it('invokes getAdGroupAdAssetView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetAdGroupAdAssetViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AdGroupAdAssetView());
        ...
        it('invokes getAdGroupAdAssetView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAdAssetView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IAdGroupAdAssetView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
