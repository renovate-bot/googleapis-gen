...
import * as conversionvaluerulesetserviceModule from '../src';
...
describe('v8.ConversionValueRuleSetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversionvaluerulesetserviceModule.v8.ConversionValueRuleSetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversionvaluerulesetserviceModule.v8.ConversionValueRuleSetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversionvaluerulesetserviceModule.v8.ConversionValueRuleSetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversionvaluerulesetserviceModule.v8.ConversionValueRuleSetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.conversionValueRuleSetServiceStub, undefined);
        await client.initialize();
        assert(client.conversionValueRuleSetServiceStub);
    });
    ...
    describe('getConversionValueRuleSet', () => {
        it('invokes getConversionValueRuleSet without error', async () => {
            const client = new conversionvaluerulesetserviceModule.v8.ConversionValueRuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetConversionValueRuleSetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ConversionValueRuleSet());
            client.innerApiCalls.getConversionValueRuleSet = stubSimpleCall(expectedResponse);
            const [response] = await client.getConversionValueRuleSet(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getConversionValueRuleSet as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getConversionValueRuleSet without error using callback', async () => {
            const client = new conversionvaluerulesetserviceModule.v8.ConversionValueRuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ConversionValueRuleSet());
            client.innerApiCalls.getConversionValueRuleSet = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConversionValueRuleSet(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IConversionValueRuleSet|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConversionValueRuleSet with error', async () => {
            const client = new conversionvaluerulesetserviceModule.v8.ConversionValueRuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getConversionValueRuleSet = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getConversionValueRuleSet(request), expectedError);
            assert((client.innerApiCalls.getConversionValueRuleSet as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateConversionValueRuleSets', () => {
        it('invokes mutateConversionValueRuleSets without error', async () => {
            const client = new conversionvaluerulesetserviceModule.v8.ConversionValueRuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateConversionValueRuleSetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateConversionValueRuleSetsResponse());
            client.innerApiCalls.mutateConversionValueRuleSets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateConversionValueRuleSets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateConversionValueRuleSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateConversionValueRuleSets without error using callback', async () => {
            const client = new conversionvaluerulesetserviceModule.v8.ConversionValueRuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateConversionValueRuleSetsResponse());
            client.innerApiCalls.mutateConversionValueRuleSets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionValueRuleSets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateConversionValueRuleSetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateConversionValueRuleSets with error', async () => {
            const client = new conversionvaluerulesetserviceModule.v8.ConversionValueRuleSetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateConversionValueRuleSets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateConversionValueRuleSets(request), expectedError);
            assert((client.innerApiCalls.mutateConversionValueRuleSets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
