...
import * as conversioncustomvariableserviceModule from '../src';
...
describe('v8.ConversionCustomVariableServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = conversioncustomvariableserviceModule.v8.ConversionCustomVariableServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversioncustomvariableserviceModule.v8.ConversionCustomVariableServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversioncustomvariableserviceModule.v8.ConversionCustomVariableServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversioncustomvariableserviceModule.v8.ConversionCustomVariableServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.conversionCustomVariableServiceStub, undefined);
        await client.initialize();
        assert(client.conversionCustomVariableServiceStub);
    });
    ...
    describe('getConversionCustomVariable', () => {
        it('invokes getConversionCustomVariable without error', async () => {
            const client = new conversioncustomvariableserviceModule.v8.ConversionCustomVariableServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetConversionCustomVariableRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ConversionCustomVariable());
            client.innerApiCalls.getConversionCustomVariable = stubSimpleCall(expectedResponse);
            const [response] = await client.getConversionCustomVariable(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getConversionCustomVariable as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getConversionCustomVariable without error using callback', async () => {
            const client = new conversioncustomvariableserviceModule.v8.ConversionCustomVariableServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ConversionCustomVariable());
            client.innerApiCalls.getConversionCustomVariable = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConversionCustomVariable(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IConversionCustomVariable|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConversionCustomVariable with error', async () => {
            const client = new conversioncustomvariableserviceModule.v8.ConversionCustomVariableServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getConversionCustomVariable = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getConversionCustomVariable(request), expectedError);
            assert((client.innerApiCalls.getConversionCustomVariable as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateConversionCustomVariables', () => {
        it('invokes mutateConversionCustomVariables without error', async () => {
            const client = new conversioncustomvariableserviceModule.v8.ConversionCustomVariableServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateConversionCustomVariablesRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateConversionCustomVariablesResponse());
            client.innerApiCalls.mutateConversionCustomVariables = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateConversionCustomVariables(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateConversionCustomVariables as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateConversionCustomVariables without error using callback', async () => {
            const client = new conversioncustomvariableserviceModule.v8.ConversionCustomVariableServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateConversionCustomVariablesResponse());
            client.innerApiCalls.mutateConversionCustomVariables = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateConversionCustomVariables(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateConversionCustomVariablesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateConversionCustomVariables with error', async () => {
            const client = new conversioncustomvariableserviceModule.v8.ConversionCustomVariableServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateConversionCustomVariables = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateConversionCustomVariables(request), expectedError);
            assert((client.innerApiCalls.mutateConversionCustomVariables as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
