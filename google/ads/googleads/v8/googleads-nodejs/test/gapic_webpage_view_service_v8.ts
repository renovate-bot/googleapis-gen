...
describe('v8.WebpageViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = webpageviewserviceModule.v8.WebpageViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = webpageviewserviceModule.v8.WebpageViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = webpageviewserviceModule.v8.WebpageViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new webpageviewserviceModule.v8.WebpageViewServiceClient();
        assert(client);
    });
    ...
    describe('getWebpageView', () => {
        it('invokes getWebpageView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetWebpageViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.WebpageView());
        ...
        it('invokes getWebpageView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getWebpageView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IWebpageView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
