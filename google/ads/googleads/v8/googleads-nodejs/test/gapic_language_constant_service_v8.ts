...
import * as languageconstantserviceModule from '../src';
...
describe('v8.LanguageConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = languageconstantserviceModule.v8.LanguageConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = languageconstantserviceModule.v8.LanguageConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = languageconstantserviceModule.v8.LanguageConstantServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new languageconstantserviceModule.v8.LanguageConstantServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.languageConstantServiceStub, undefined);
        await client.initialize();
        assert(client.languageConstantServiceStub);
    });
    ...
    describe('getLanguageConstant', () => {
        it('invokes getLanguageConstant without error', async () => {
            const client = new languageconstantserviceModule.v8.LanguageConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetLanguageConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.LanguageConstant());
            client.innerApiCalls.getLanguageConstant = stubSimpleCall(expectedResponse);
            const [response] = await client.getLanguageConstant(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getLanguageConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getLanguageConstant without error using callback', async () => {
            const client = new languageconstantserviceModule.v8.LanguageConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.LanguageConstant());
            client.innerApiCalls.getLanguageConstant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getLanguageConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ILanguageConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getLanguageConstant with error', async () => {
            const client = new languageconstantserviceModule.v8.LanguageConstantServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getLanguageConstant = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getLanguageConstant(request), expectedError);
            assert((client.innerApiCalls.getLanguageConstant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
