...
import * as adgroupadlabelserviceModule from '../src';
...
describe('v8.AdGroupAdLabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupadlabelserviceModule.v8.AdGroupAdLabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupadlabelserviceModule.v8.AdGroupAdLabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupadlabelserviceModule.v8.AdGroupAdLabelServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupadlabelserviceModule.v8.AdGroupAdLabelServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupAdLabelServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupAdLabelServiceStub);
    });
    ...
    describe('getAdGroupAdLabel', () => {
        it('invokes getAdGroupAdLabel without error', async () => {
            const client = new adgroupadlabelserviceModule.v8.AdGroupAdLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetAdGroupAdLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AdGroupAdLabel());
            client.innerApiCalls.getAdGroupAdLabel = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupAdLabel(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupAdLabel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupAdLabel without error using callback', async () => {
            const client = new adgroupadlabelserviceModule.v8.AdGroupAdLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AdGroupAdLabel());
            client.innerApiCalls.getAdGroupAdLabel = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAdLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IAdGroupAdLabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupAdLabel with error', async () => {
            const client = new adgroupadlabelserviceModule.v8.AdGroupAdLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getAdGroupAdLabel = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupAdLabel(request), expectedError);
            assert((client.innerApiCalls.getAdGroupAdLabel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAdGroupAdLabels', () => {
        it('invokes mutateAdGroupAdLabels without error', async () => {
            const client = new adgroupadlabelserviceModule.v8.AdGroupAdLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAdGroupAdLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAdGroupAdLabelsResponse());
            client.innerApiCalls.mutateAdGroupAdLabels = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupAdLabels(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupAdLabels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroupAdLabels without error using callback', async () => {
            const client = new adgroupadlabelserviceModule.v8.AdGroupAdLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAdGroupAdLabelsResponse());
            client.innerApiCalls.mutateAdGroupAdLabels = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupAdLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateAdGroupAdLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupAdLabels with error', async () => {
            const client = new adgroupadlabelserviceModule.v8.AdGroupAdLabelServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdGroupAdLabels = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupAdLabels(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupAdLabels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
