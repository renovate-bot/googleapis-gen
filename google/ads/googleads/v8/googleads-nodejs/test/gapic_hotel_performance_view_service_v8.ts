...
describe('v8.HotelPerformanceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = hotelperformanceviewserviceModule.v8.HotelPerformanceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = hotelperformanceviewserviceModule.v8.HotelPerformanceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = hotelperformanceviewserviceModule.v8.HotelPerformanceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new hotelperformanceviewserviceModule.v8.HotelPerformanceViewServiceClient();
        assert(client);
    });
    ...
    describe('getHotelPerformanceView', () => {
        it('invokes getHotelPerformanceView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetHotelPerformanceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.HotelPerformanceView());
        ...
        it('invokes getHotelPerformanceView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getHotelPerformanceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IHotelPerformanceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
