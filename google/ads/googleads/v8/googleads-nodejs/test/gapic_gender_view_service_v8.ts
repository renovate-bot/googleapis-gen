...
describe('v8.GenderViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = genderviewserviceModule.v8.GenderViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = genderviewserviceModule.v8.GenderViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = genderviewserviceModule.v8.GenderViewServiceClient.port;
        assert(port);
    ...
    describe('getGenderView', () => {
        it('invokes getGenderView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetGenderViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.GenderView());
        ...
        it('invokes getGenderView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGenderView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IGenderView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
