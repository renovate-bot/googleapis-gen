...
describe('v8.SmartCampaignSearchTermViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = smartcampaignsearchtermviewserviceModule.v8.SmartCampaignSearchTermViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = smartcampaignsearchtermviewserviceModule.v8.SmartCampaignSearchTermViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = smartcampaignsearchtermviewserviceModule.v8.SmartCampaignSearchTermViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new smartcampaignsearchtermviewserviceModule.v8.SmartCampaignSearchTermViewServiceClient();
        assert(client);
    });
    ...
    describe('getSmartCampaignSearchTermView', () => {
        it('invokes getSmartCampaignSearchTermView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetSmartCampaignSearchTermViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.SmartCampaignSearchTermView());
        ...
        it('invokes getSmartCampaignSearchTermView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSmartCampaignSearchTermView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ISmartCampaignSearchTermView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
