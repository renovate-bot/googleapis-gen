...
import * as customerassetserviceModule from '../src';
...
describe('v8.CustomerAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerassetserviceModule.v8.CustomerAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerassetserviceModule.v8.CustomerAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerassetserviceModule.v8.CustomerAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerassetserviceModule.v8.CustomerAssetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customerAssetServiceStub, undefined);
        await client.initialize();
        assert(client.customerAssetServiceStub);
    });
    ...
    describe('getCustomerAsset', () => {
        it('invokes getCustomerAsset without error', async () => {
            const client = new customerassetserviceModule.v8.CustomerAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCustomerAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CustomerAsset());
            client.innerApiCalls.getCustomerAsset = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomerAsset(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomerAsset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCustomerAsset without error using callback', async () => {
            const client = new customerassetserviceModule.v8.CustomerAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CustomerAsset());
            client.innerApiCalls.getCustomerAsset = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICustomerAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomerAsset with error', async () => {
            const client = new customerassetserviceModule.v8.CustomerAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getCustomerAsset = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomerAsset(request), expectedError);
            assert((client.innerApiCalls.getCustomerAsset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCustomerAssets', () => {
        it('invokes mutateCustomerAssets without error', async () => {
            const client = new customerassetserviceModule.v8.CustomerAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCustomerAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCustomerAssetsResponse());
            client.innerApiCalls.mutateCustomerAssets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomerAssets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomerAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomerAssets without error using callback', async () => {
            const client = new customerassetserviceModule.v8.CustomerAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCustomerAssetsResponse());
            client.innerApiCalls.mutateCustomerAssets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateCustomerAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomerAssets with error', async () => {
            const client = new customerassetserviceModule.v8.CustomerAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCustomerAssets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomerAssets(request), expectedError);
            assert((client.innerApiCalls.mutateCustomerAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
