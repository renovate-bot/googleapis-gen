...
import * as feeditemsetlinkserviceModule from '../src';
...
describe('v8.FeedItemSetLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feeditemsetlinkserviceModule.v8.FeedItemSetLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feeditemsetlinkserviceModule.v8.FeedItemSetLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feeditemsetlinkserviceModule.v8.FeedItemSetLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feeditemsetlinkserviceModule.v8.FeedItemSetLinkServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.feedItemSetLinkServiceStub, undefined);
        await client.initialize();
        assert(client.feedItemSetLinkServiceStub);
    });
    ...
    describe('getFeedItemSetLink', () => {
        it('invokes getFeedItemSetLink without error', async () => {
            const client = new feeditemsetlinkserviceModule.v8.FeedItemSetLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetFeedItemSetLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.FeedItemSetLink());
            client.innerApiCalls.getFeedItemSetLink = stubSimpleCall(expectedResponse);
            const [response] = await client.getFeedItemSetLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getFeedItemSetLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getFeedItemSetLink without error using callback', async () => {
            const client = new feeditemsetlinkserviceModule.v8.FeedItemSetLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.FeedItemSetLink());
            client.innerApiCalls.getFeedItemSetLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getFeedItemSetLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IFeedItemSetLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getFeedItemSetLink with error', async () => {
            const client = new feeditemsetlinkserviceModule.v8.FeedItemSetLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getFeedItemSetLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getFeedItemSetLink(request), expectedError);
            assert((client.innerApiCalls.getFeedItemSetLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateFeedItemSetLinks', () => {
        it('invokes mutateFeedItemSetLinks without error', async () => {
            const client = new feeditemsetlinkserviceModule.v8.FeedItemSetLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateFeedItemSetLinksRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateFeedItemSetLinksResponse());
            client.innerApiCalls.mutateFeedItemSetLinks = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateFeedItemSetLinks(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateFeedItemSetLinks as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateFeedItemSetLinks without error using callback', async () => {
            const client = new feeditemsetlinkserviceModule.v8.FeedItemSetLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateFeedItemSetLinksResponse());
            client.innerApiCalls.mutateFeedItemSetLinks = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeedItemSetLinks(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateFeedItemSetLinksResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateFeedItemSetLinks with error', async () => {
            const client = new feeditemsetlinkserviceModule.v8.FeedItemSetLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateFeedItemSetLinks = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateFeedItemSetLinks(request), expectedError);
            assert((client.innerApiCalls.mutateFeedItemSetLinks as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
