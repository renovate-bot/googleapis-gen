...
describe('v8.AccessibleBiddingStrategyServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = accessiblebiddingstrategyserviceModule.v8.AccessibleBiddingStrategyServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = accessiblebiddingstrategyserviceModule.v8.AccessibleBiddingStrategyServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = accessiblebiddingstrategyserviceModule.v8.AccessibleBiddingStrategyServiceClient.port;
        assert(port);
    ...
    describe('getAccessibleBiddingStrategy', () => {
        it('invokes getAccessibleBiddingStrategy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetAccessibleBiddingStrategyRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AccessibleBiddingStrategy());
        ...
        it('invokes getAccessibleBiddingStrategy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAccessibleBiddingStrategy(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IAccessibleBiddingStrategy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
