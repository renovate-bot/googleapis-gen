...
import * as detaileddemographicserviceModule from '../src';
...
describe('v8.DetailedDemographicServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = detaileddemographicserviceModule.v8.DetailedDemographicServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = detaileddemographicserviceModule.v8.DetailedDemographicServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = detaileddemographicserviceModule.v8.DetailedDemographicServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new detaileddemographicserviceModule.v8.DetailedDemographicServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.detailedDemographicServiceStub, undefined);
        await client.initialize();
        assert(client.detailedDemographicServiceStub);
    });
    ...
    describe('getDetailedDemographic', () => {
        it('invokes getDetailedDemographic without error', async () => {
            const client = new detaileddemographicserviceModule.v8.DetailedDemographicServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetDetailedDemographicRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.DetailedDemographic());
            client.innerApiCalls.getDetailedDemographic = stubSimpleCall(expectedResponse);
            const [response] = await client.getDetailedDemographic(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getDetailedDemographic as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getDetailedDemographic without error using callback', async () => {
            const client = new detaileddemographicserviceModule.v8.DetailedDemographicServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.DetailedDemographic());
            client.innerApiCalls.getDetailedDemographic = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDetailedDemographic(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IDetailedDemographic|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDetailedDemographic with error', async () => {
            const client = new detaileddemographicserviceModule.v8.DetailedDemographicServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getDetailedDemographic = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDetailedDemographic(request), expectedError);
            assert((client.innerApiCalls.getDetailedDemographic as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
