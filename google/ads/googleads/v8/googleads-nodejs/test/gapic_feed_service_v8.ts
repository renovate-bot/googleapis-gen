...
describe('v8.FeedServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = feedserviceModule.v8.FeedServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = feedserviceModule.v8.FeedServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = feedserviceModule.v8.FeedServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new feedserviceModule.v8.FeedServiceClient();
        assert(client);
    });
    ...
    describe('getFeed', () => {
        it('invokes getFeed without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetFeedRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.Feed());
        ...
        it('invokes getFeed without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeed(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IFeed|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateFeeds', () => {
        it('invokes mutateFeeds without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateFeedsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateFeedsResponse());
        ...
        it('invokes mutateFeeds without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateFeeds(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateFeedsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
