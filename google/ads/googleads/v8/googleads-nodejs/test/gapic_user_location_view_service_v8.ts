...
import * as userlocationviewserviceModule from '../src';
...
describe('v8.UserLocationViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = userlocationviewserviceModule.v8.UserLocationViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = userlocationviewserviceModule.v8.UserLocationViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = userlocationviewserviceModule.v8.UserLocationViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new userlocationviewserviceModule.v8.UserLocationViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.userLocationViewServiceStub, undefined);
        await client.initialize();
        assert(client.userLocationViewServiceStub);
    });
    ...
    describe('getUserLocationView', () => {
        it('invokes getUserLocationView without error', async () => {
            const client = new userlocationviewserviceModule.v8.UserLocationViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetUserLocationViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.UserLocationView());
            client.innerApiCalls.getUserLocationView = stubSimpleCall(expectedResponse);
            const [response] = await client.getUserLocationView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getUserLocationView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getUserLocationView without error using callback', async () => {
            const client = new userlocationviewserviceModule.v8.UserLocationViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.UserLocationView());
            client.innerApiCalls.getUserLocationView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getUserLocationView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IUserLocationView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getUserLocationView with error', async () => {
            const client = new userlocationviewserviceModule.v8.UserLocationViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getUserLocationView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getUserLocationView(request), expectedError);
            assert((client.innerApiCalls.getUserLocationView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
