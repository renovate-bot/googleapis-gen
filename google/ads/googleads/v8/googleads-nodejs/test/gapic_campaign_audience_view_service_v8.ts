...
describe('v8.CampaignAudienceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaignaudienceviewserviceModule.v8.CampaignAudienceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaignaudienceviewserviceModule.v8.CampaignAudienceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaignaudienceviewserviceModule.v8.CampaignAudienceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaignaudienceviewserviceModule.v8.CampaignAudienceViewServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignAudienceView', () => {
        it('invokes getCampaignAudienceView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCampaignAudienceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CampaignAudienceView());
        ...
        it('invokes getCampaignAudienceView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignAudienceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICampaignAudienceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
