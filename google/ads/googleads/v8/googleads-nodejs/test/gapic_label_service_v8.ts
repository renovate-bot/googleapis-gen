...
describe('v8.LabelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = labelserviceModule.v8.LabelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = labelserviceModule.v8.LabelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = labelserviceModule.v8.LabelServiceClient.port;
        assert(port);
    ...
    describe('getLabel', () => {
        it('invokes getLabel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetLabelRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.Label());
        ...
        it('invokes getLabel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLabel(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ILabel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateLabels', () => {
        it('invokes mutateLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateLabelsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateLabelsResponse());
        ...
        it('invokes mutateLabels without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateLabels(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateLabelsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
