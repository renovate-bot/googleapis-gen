...
describe('v8.BiddingSeasonalityAdjustmentServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = biddingseasonalityadjustmentserviceModule.v8.BiddingSeasonalityAdjustmentServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = biddingseasonalityadjustmentserviceModule.v8.BiddingSeasonalityAdjustmentServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = biddingseasonalityadjustmentserviceModule.v8.BiddingSeasonalityAdjustmentServiceClient.port;
        assert(port);
    ...
    describe('getBiddingSeasonalityAdjustment', () => {
        it('invokes getBiddingSeasonalityAdjustment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetBiddingSeasonalityAdjustmentRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.BiddingSeasonalityAdjustment());
        ...
        it('invokes getBiddingSeasonalityAdjustment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBiddingSeasonalityAdjustment(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IBiddingSeasonalityAdjustment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateBiddingSeasonalityAdjustments', () => {
        it('invokes mutateBiddingSeasonalityAdjustments without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateBiddingSeasonalityAdjustmentsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateBiddingSeasonalityAdjustmentsResponse());
        ...
        it('invokes mutateBiddingSeasonalityAdjustments without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateBiddingSeasonalityAdjustments(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateBiddingSeasonalityAdjustmentsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
