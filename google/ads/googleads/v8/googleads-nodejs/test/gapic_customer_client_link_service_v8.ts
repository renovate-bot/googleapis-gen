...
import * as customerclientlinkserviceModule from '../src';
...
describe('v8.CustomerClientLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerclientlinkserviceModule.v8.CustomerClientLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerclientlinkserviceModule.v8.CustomerClientLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerclientlinkserviceModule.v8.CustomerClientLinkServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customerclientlinkserviceModule.v8.CustomerClientLinkServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customerClientLinkServiceStub, undefined);
        await client.initialize();
        assert(client.customerClientLinkServiceStub);
    });
    ...
    describe('getCustomerClientLink', () => {
        it('invokes getCustomerClientLink without error', async () => {
            const client = new customerclientlinkserviceModule.v8.CustomerClientLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCustomerClientLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CustomerClientLink());
            client.innerApiCalls.getCustomerClientLink = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomerClientLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomerClientLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCustomerClientLink without error using callback', async () => {
            const client = new customerclientlinkserviceModule.v8.CustomerClientLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CustomerClientLink());
            client.innerApiCalls.getCustomerClientLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerClientLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICustomerClientLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomerClientLink with error', async () => {
            const client = new customerclientlinkserviceModule.v8.CustomerClientLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getCustomerClientLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomerClientLink(request), expectedError);
            assert((client.innerApiCalls.getCustomerClientLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCustomerClientLink', () => {
        it('invokes mutateCustomerClientLink without error', async () => {
            const client = new customerclientlinkserviceModule.v8.CustomerClientLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCustomerClientLinkRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCustomerClientLinkResponse());
            client.innerApiCalls.mutateCustomerClientLink = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomerClientLink(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomerClientLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomerClientLink without error using callback', async () => {
            const client = new customerclientlinkserviceModule.v8.CustomerClientLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCustomerClientLinkResponse());
            client.innerApiCalls.mutateCustomerClientLink = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerClientLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateCustomerClientLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomerClientLink with error', async () => {
            const client = new customerclientlinkserviceModule.v8.CustomerClientLinkServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCustomerClientLink = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomerClientLink(request), expectedError);
            assert((client.innerApiCalls.mutateCustomerClientLink as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
