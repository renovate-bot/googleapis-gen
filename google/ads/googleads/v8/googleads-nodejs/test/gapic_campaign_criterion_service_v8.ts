...
describe('v8.CampaignCriterionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = campaigncriterionserviceModule.v8.CampaignCriterionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = campaigncriterionserviceModule.v8.CampaignCriterionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = campaigncriterionserviceModule.v8.CampaignCriterionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new campaigncriterionserviceModule.v8.CampaignCriterionServiceClient();
        assert(client);
    });
    ...
    describe('getCampaignCriterion', () => {
        it('invokes getCampaignCriterion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCampaignCriterionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CampaignCriterion());
        ...
        it('invokes getCampaignCriterion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCampaignCriterion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICampaignCriterion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCampaignCriteria', () => {
        it('invokes mutateCampaignCriteria without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCampaignCriteriaRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCampaignCriteriaResponse());
        ...
        it('invokes mutateCampaignCriteria without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCampaignCriteria(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateCampaignCriteriaResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
