...
describe('v8.AdScheduleViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adscheduleviewserviceModule.v8.AdScheduleViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adscheduleviewserviceModule.v8.AdScheduleViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adscheduleviewserviceModule.v8.AdScheduleViewServiceClient.port;
        assert(port);
    ...
    describe('getAdScheduleView', () => {
        it('invokes getAdScheduleView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetAdScheduleViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AdScheduleView());
        ...
        it('invokes getAdScheduleView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdScheduleView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IAdScheduleView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
