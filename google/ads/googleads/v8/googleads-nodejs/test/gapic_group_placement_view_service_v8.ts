...
import * as groupplacementviewserviceModule from '../src';
...
describe('v8.GroupPlacementViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = groupplacementviewserviceModule.v8.GroupPlacementViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = groupplacementviewserviceModule.v8.GroupPlacementViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = groupplacementviewserviceModule.v8.GroupPlacementViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new groupplacementviewserviceModule.v8.GroupPlacementViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.groupPlacementViewServiceStub, undefined);
        await client.initialize();
        assert(client.groupPlacementViewServiceStub);
    });
    ...
    describe('getGroupPlacementView', () => {
        it('invokes getGroupPlacementView without error', async () => {
            const client = new groupplacementviewserviceModule.v8.GroupPlacementViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetGroupPlacementViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.GroupPlacementView());
            client.innerApiCalls.getGroupPlacementView = stubSimpleCall(expectedResponse);
            const [response] = await client.getGroupPlacementView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getGroupPlacementView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getGroupPlacementView without error using callback', async () => {
            const client = new groupplacementviewserviceModule.v8.GroupPlacementViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.GroupPlacementView());
            client.innerApiCalls.getGroupPlacementView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getGroupPlacementView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IGroupPlacementView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getGroupPlacementView with error', async () => {
            const client = new groupplacementviewserviceModule.v8.GroupPlacementViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getGroupPlacementView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getGroupPlacementView(request), expectedError);
            assert((client.innerApiCalls.getGroupPlacementView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
