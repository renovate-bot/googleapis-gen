...
describe('v8.KeywordPlanServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanserviceModule.v8.KeywordPlanServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanserviceModule.v8.KeywordPlanServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanserviceModule.v8.KeywordPlanServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplanserviceModule.v8.KeywordPlanServiceClient();
        assert(client);
    });
    ...
    describe('getKeywordPlan', () => {
        it('invokes getKeywordPlan without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetKeywordPlanRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.KeywordPlan());
        ...
        it('invokes getKeywordPlan without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlan(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IKeywordPlan|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateKeywordPlans', () => {
        it('invokes mutateKeywordPlans without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateKeywordPlansRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateKeywordPlansResponse());
        ...
        it('invokes mutateKeywordPlans without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlans(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateKeywordPlansResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateForecastCurve', () => {
        it('invokes generateForecastCurve without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GenerateForecastCurveRequest());
            request.keywordPlan = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.GenerateForecastCurveResponse());
        ...
        it('invokes generateForecastCurve without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateForecastCurve(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IGenerateForecastCurveResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateForecastTimeSeries', () => {
        it('invokes generateForecastTimeSeries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GenerateForecastTimeSeriesRequest());
            request.keywordPlan = '';
            const expectedHeaderRequestParams = "keyword_plan=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.GenerateForecastTimeSeriesResponse());
        ...
        it('invokes generateForecastTimeSeries without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateForecastTimeSeries(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IGenerateForecastTimeSeriesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateForecastMetrics', () => {
        it('invokes generateForecastMetrics without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GenerateForecastMetricsRequest());
            request.keywordPlan = '';
            const expectedHeaderRequestParams = "keyword_plan=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.GenerateForecastMetricsResponse());
        ...
        it('invokes generateForecastMetrics without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateForecastMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IGenerateForecastMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateHistoricalMetrics', () => {
        it('invokes generateHistoricalMetrics without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GenerateHistoricalMetricsRequest());
            request.keywordPlan = '';
            const expectedHeaderRequestParams = "keyword_plan=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.GenerateHistoricalMetricsResponse());
        ...
        it('invokes generateHistoricalMetrics without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateHistoricalMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IGenerateHistoricalMetricsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
