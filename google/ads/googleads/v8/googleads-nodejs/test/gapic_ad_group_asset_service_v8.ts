...
import * as adgroupassetserviceModule from '../src';
...
describe('v8.AdGroupAssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupassetserviceModule.v8.AdGroupAssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupassetserviceModule.v8.AdGroupAssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupassetserviceModule.v8.AdGroupAssetServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupassetserviceModule.v8.AdGroupAssetServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.adGroupAssetServiceStub, undefined);
        await client.initialize();
        assert(client.adGroupAssetServiceStub);
    });
    ...
    describe('getAdGroupAsset', () => {
        it('invokes getAdGroupAsset without error', async () => {
            const client = new adgroupassetserviceModule.v8.AdGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetAdGroupAssetRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AdGroupAsset());
            client.innerApiCalls.getAdGroupAsset = stubSimpleCall(expectedResponse);
            const [response] = await client.getAdGroupAsset(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAdGroupAsset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAdGroupAsset without error using callback', async () => {
            const client = new adgroupassetserviceModule.v8.AdGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AdGroupAsset());
            client.innerApiCalls.getAdGroupAsset = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroupAsset(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IAdGroupAsset|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAdGroupAsset with error', async () => {
            const client = new adgroupassetserviceModule.v8.AdGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getAdGroupAsset = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAdGroupAsset(request), expectedError);
            assert((client.innerApiCalls.getAdGroupAsset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateAdGroupAssets', () => {
        it('invokes mutateAdGroupAssets without error', async () => {
            const client = new adgroupassetserviceModule.v8.AdGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAdGroupAssetsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAdGroupAssetsResponse());
            client.innerApiCalls.mutateAdGroupAssets = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateAdGroupAssets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateAdGroupAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateAdGroupAssets without error using callback', async () => {
            const client = new adgroupassetserviceModule.v8.AdGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAdGroupAssetsResponse());
            client.innerApiCalls.mutateAdGroupAssets = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroupAssets(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateAdGroupAssetsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateAdGroupAssets with error', async () => {
            const client = new adgroupassetserviceModule.v8.AdGroupAssetServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateAdGroupAssets = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateAdGroupAssets(request), expectedError);
            assert((client.innerApiCalls.mutateAdGroupAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
