...
describe('v8.KeywordViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordviewserviceModule.v8.KeywordViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordviewserviceModule.v8.KeywordViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordviewserviceModule.v8.KeywordViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordviewserviceModule.v8.KeywordViewServiceClient();
        assert(client);
    });
    ...
    describe('getKeywordView', () => {
        it('invokes getKeywordView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetKeywordViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.KeywordView());
        ...
        it('invokes getKeywordView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IKeywordView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
