...
describe('v8.ExtensionFeedItemServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = extensionfeeditemserviceModule.v8.ExtensionFeedItemServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = extensionfeeditemserviceModule.v8.ExtensionFeedItemServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = extensionfeeditemserviceModule.v8.ExtensionFeedItemServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new extensionfeeditemserviceModule.v8.ExtensionFeedItemServiceClient();
        assert(client);
    });
    ...
    describe('getExtensionFeedItem', () => {
        it('invokes getExtensionFeedItem without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetExtensionFeedItemRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ExtensionFeedItem());
        ...
        it('invokes getExtensionFeedItem without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getExtensionFeedItem(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IExtensionFeedItem|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateExtensionFeedItems', () => {
        it('invokes mutateExtensionFeedItems without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateExtensionFeedItemsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateExtensionFeedItemsResponse());
        ...
        it('invokes mutateExtensionFeedItems without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateExtensionFeedItems(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateExtensionFeedItemsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
