...
import * as keywordplanadgroupserviceModule from '../src';
...
describe('v8.KeywordPlanAdGroupServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = keywordplanadgroupserviceModule.v8.KeywordPlanAdGroupServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = keywordplanadgroupserviceModule.v8.KeywordPlanAdGroupServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = keywordplanadgroupserviceModule.v8.KeywordPlanAdGroupServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new keywordplanadgroupserviceModule.v8.KeywordPlanAdGroupServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.keywordPlanAdGroupServiceStub, undefined);
        await client.initialize();
        assert(client.keywordPlanAdGroupServiceStub);
    });
    ...
    describe('getKeywordPlanAdGroup', () => {
        it('invokes getKeywordPlanAdGroup without error', async () => {
            const client = new keywordplanadgroupserviceModule.v8.KeywordPlanAdGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetKeywordPlanAdGroupRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.KeywordPlanAdGroup());
            client.innerApiCalls.getKeywordPlanAdGroup = stubSimpleCall(expectedResponse);
            const [response] = await client.getKeywordPlanAdGroup(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getKeywordPlanAdGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getKeywordPlanAdGroup without error using callback', async () => {
            const client = new keywordplanadgroupserviceModule.v8.KeywordPlanAdGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.KeywordPlanAdGroup());
            client.innerApiCalls.getKeywordPlanAdGroup = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKeywordPlanAdGroup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IKeywordPlanAdGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getKeywordPlanAdGroup with error', async () => {
            const client = new keywordplanadgroupserviceModule.v8.KeywordPlanAdGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getKeywordPlanAdGroup = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getKeywordPlanAdGroup(request), expectedError);
            assert((client.innerApiCalls.getKeywordPlanAdGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateKeywordPlanAdGroups', () => {
        it('invokes mutateKeywordPlanAdGroups without error', async () => {
            const client = new keywordplanadgroupserviceModule.v8.KeywordPlanAdGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateKeywordPlanAdGroupsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateKeywordPlanAdGroupsResponse());
            client.innerApiCalls.mutateKeywordPlanAdGroups = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateKeywordPlanAdGroups(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateKeywordPlanAdGroups as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateKeywordPlanAdGroups without error using callback', async () => {
            const client = new keywordplanadgroupserviceModule.v8.KeywordPlanAdGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateKeywordPlanAdGroupsResponse());
            client.innerApiCalls.mutateKeywordPlanAdGroups = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateKeywordPlanAdGroups(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateKeywordPlanAdGroupsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateKeywordPlanAdGroups with error', async () => {
            const client = new keywordplanadgroupserviceModule.v8.KeywordPlanAdGroupServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateKeywordPlanAdGroups = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateKeywordPlanAdGroups(request), expectedError);
            assert((client.innerApiCalls.mutateKeywordPlanAdGroups as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
