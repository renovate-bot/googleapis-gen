...
import * as domaincategoryserviceModule from '../src';
...
describe('v8.DomainCategoryServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = domaincategoryserviceModule.v8.DomainCategoryServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = domaincategoryserviceModule.v8.DomainCategoryServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = domaincategoryserviceModule.v8.DomainCategoryServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new domaincategoryserviceModule.v8.DomainCategoryServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.domainCategoryServiceStub, undefined);
        await client.initialize();
        assert(client.domainCategoryServiceStub);
    });
    ...
    describe('getDomainCategory', () => {
        it('invokes getDomainCategory without error', async () => {
            const client = new domaincategoryserviceModule.v8.DomainCategoryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetDomainCategoryRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.DomainCategory());
            client.innerApiCalls.getDomainCategory = stubSimpleCall(expectedResponse);
            const [response] = await client.getDomainCategory(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getDomainCategory as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getDomainCategory without error using callback', async () => {
            const client = new domaincategoryserviceModule.v8.DomainCategoryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.DomainCategory());
            client.innerApiCalls.getDomainCategory = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getDomainCategory(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IDomainCategory|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getDomainCategory with error', async () => {
            const client = new domaincategoryserviceModule.v8.DomainCategoryServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getDomainCategory = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getDomainCategory(request), expectedError);
            assert((client.innerApiCalls.getDomainCategory as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
