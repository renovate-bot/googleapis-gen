...
import * as biddingdataexclusionserviceModule from '../src';
...
describe('v8.BiddingDataExclusionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = biddingdataexclusionserviceModule.v8.BiddingDataExclusionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = biddingdataexclusionserviceModule.v8.BiddingDataExclusionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = biddingdataexclusionserviceModule.v8.BiddingDataExclusionServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new biddingdataexclusionserviceModule.v8.BiddingDataExclusionServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.biddingDataExclusionServiceStub, undefined);
        await client.initialize();
        assert(client.biddingDataExclusionServiceStub);
    });
    ...
    describe('getBiddingDataExclusion', () => {
        it('invokes getBiddingDataExclusion without error', async () => {
            const client = new biddingdataexclusionserviceModule.v8.BiddingDataExclusionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetBiddingDataExclusionRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.BiddingDataExclusion());
            client.innerApiCalls.getBiddingDataExclusion = stubSimpleCall(expectedResponse);
            const [response] = await client.getBiddingDataExclusion(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getBiddingDataExclusion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getBiddingDataExclusion without error using callback', async () => {
            const client = new biddingdataexclusionserviceModule.v8.BiddingDataExclusionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.BiddingDataExclusion());
            client.innerApiCalls.getBiddingDataExclusion = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getBiddingDataExclusion(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IBiddingDataExclusion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getBiddingDataExclusion with error', async () => {
            const client = new biddingdataexclusionserviceModule.v8.BiddingDataExclusionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getBiddingDataExclusion = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getBiddingDataExclusion(request), expectedError);
            assert((client.innerApiCalls.getBiddingDataExclusion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateBiddingDataExclusions', () => {
        it('invokes mutateBiddingDataExclusions without error', async () => {
            const client = new biddingdataexclusionserviceModule.v8.BiddingDataExclusionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateBiddingDataExclusionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse());
            client.innerApiCalls.mutateBiddingDataExclusions = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateBiddingDataExclusions(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateBiddingDataExclusions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateBiddingDataExclusions without error using callback', async () => {
            const client = new biddingdataexclusionserviceModule.v8.BiddingDataExclusionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateBiddingDataExclusionsResponse());
            client.innerApiCalls.mutateBiddingDataExclusions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateBiddingDataExclusions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateBiddingDataExclusionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateBiddingDataExclusions with error', async () => {
            const client = new biddingdataexclusionserviceModule.v8.BiddingDataExclusionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateBiddingDataExclusions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateBiddingDataExclusions(request), expectedError);
            assert((client.innerApiCalls.mutateBiddingDataExclusions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
