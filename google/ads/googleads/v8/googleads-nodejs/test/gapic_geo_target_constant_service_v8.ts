...
describe('v8.GeoTargetConstantServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = geotargetconstantserviceModule.v8.GeoTargetConstantServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = geotargetconstantserviceModule.v8.GeoTargetConstantServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = geotargetconstantserviceModule.v8.GeoTargetConstantServiceClient.port;
        assert(port);
    ...
    describe('getGeoTargetConstant', () => {
        it('invokes getGeoTargetConstant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetGeoTargetConstantRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.GeoTargetConstant());
        ...
        it('invokes getGeoTargetConstant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getGeoTargetConstant(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IGeoTargetConstant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('suggestGeoTargetConstants', () => {
        it('invokes suggestGeoTargetConstants without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.SuggestGeoTargetConstantsRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.SuggestGeoTargetConstantsResponse());
        ...
        it('invokes suggestGeoTargetConstants without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestGeoTargetConstants(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.ISuggestGeoTargetConstantsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
