...
describe('v8.CustomerServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customerserviceModule.v8.CustomerServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customerserviceModule.v8.CustomerServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customerserviceModule.v8.CustomerServiceClient.port;
        assert(port);
    ...
    describe('getCustomer', () => {
        it('invokes getCustomer without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.Customer());
        ...
        it('invokes getCustomer without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCustomer(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICustomer|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateCustomer', () => {
        it('invokes mutateCustomer without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCustomerResponse());
        ...
        it('invokes mutateCustomer without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomer(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateCustomerResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listAccessibleCustomers', () => {
        it('invokes listAccessibleCustomers without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.ListAccessibleCustomersResponse());
        ...
        it('invokes listAccessibleCustomers without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listAccessibleCustomers(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IListAccessibleCustomersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCustomerClient', () => {
        it('invokes createCustomerClient without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.CreateCustomerClientResponse());
        ...
        it('invokes createCustomerClient without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCustomerClient(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.ICreateCustomerClientResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
