...
describe('v8.AdGroupServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = adgroupserviceModule.v8.AdGroupServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = adgroupserviceModule.v8.AdGroupServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = adgroupserviceModule.v8.AdGroupServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new adgroupserviceModule.v8.AdGroupServiceClient();
        assert(client);
    });
    ...
    describe('getAdGroup', () => {
        it('invokes getAdGroup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetAdGroupRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AdGroup());
        ...
        it('invokes getAdGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAdGroup(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IAdGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAdGroups', () => {
        it('invokes mutateAdGroups without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAdGroupsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAdGroupsResponse());
        ...
        it('invokes mutateAdGroups without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAdGroups(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateAdGroupsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
