...
describe('v8.CombinedAudienceServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = combinedaudienceserviceModule.v8.CombinedAudienceServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = combinedaudienceserviceModule.v8.CombinedAudienceServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = combinedaudienceserviceModule.v8.CombinedAudienceServiceClient.port;
        assert(port);
    ...
    describe('getCombinedAudience', () => {
        it('invokes getCombinedAudience without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCombinedAudienceRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CombinedAudience());
        ...
        it('invokes getCombinedAudience without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCombinedAudience(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICombinedAudience|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
