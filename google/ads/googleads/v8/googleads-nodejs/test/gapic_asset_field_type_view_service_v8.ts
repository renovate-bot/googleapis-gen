...
import * as assetfieldtypeviewserviceModule from '../src';
...
describe('v8.AssetFieldTypeViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = assetfieldtypeviewserviceModule.v8.AssetFieldTypeViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = assetfieldtypeviewserviceModule.v8.AssetFieldTypeViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = assetfieldtypeviewserviceModule.v8.AssetFieldTypeViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new assetfieldtypeviewserviceModule.v8.AssetFieldTypeViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.assetFieldTypeViewServiceStub, undefined);
        await client.initialize();
        assert(client.assetFieldTypeViewServiceStub);
    });
    ...
    describe('getAssetFieldTypeView', () => {
        it('invokes getAssetFieldTypeView without error', async () => {
            const client = new assetfieldtypeviewserviceModule.v8.AssetFieldTypeViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetAssetFieldTypeViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AssetFieldTypeView());
            client.innerApiCalls.getAssetFieldTypeView = stubSimpleCall(expectedResponse);
            const [response] = await client.getAssetFieldTypeView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAssetFieldTypeView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getAssetFieldTypeView without error using callback', async () => {
            const client = new assetfieldtypeviewserviceModule.v8.AssetFieldTypeViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AssetFieldTypeView());
            client.innerApiCalls.getAssetFieldTypeView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAssetFieldTypeView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IAssetFieldTypeView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAssetFieldTypeView with error', async () => {
            const client = new assetfieldtypeviewserviceModule.v8.AssetFieldTypeViewServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getAssetFieldTypeView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getAssetFieldTypeView(request), expectedError);
            assert((client.innerApiCalls.getAssetFieldTypeView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
