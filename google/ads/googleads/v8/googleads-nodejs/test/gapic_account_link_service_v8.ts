...
describe('v8.AccountLinkServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = accountlinkserviceModule.v8.AccountLinkServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = accountlinkserviceModule.v8.AccountLinkServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = accountlinkserviceModule.v8.AccountLinkServiceClient.port;
        assert(port);
    ...
    describe('getAccountLink', () => {
        it('invokes getAccountLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetAccountLinkRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AccountLink());
        ...
        it('invokes getAccountLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAccountLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IAccountLink|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createAccountLink', () => {
        it('invokes createAccountLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.CreateAccountLinkRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.CreateAccountLinkResponse());
        ...
        it('invokes createAccountLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createAccountLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.ICreateAccountLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('mutateAccountLink', () => {
        it('invokes mutateAccountLink without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAccountLinkRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateAccountLinkResponse());
        ...
        it('invokes mutateAccountLink without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutateAccountLink(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateAccountLinkResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
