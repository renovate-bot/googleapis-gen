...
describe('v8.SmartCampaignSuggestServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = smartcampaignsuggestserviceModule.v8.SmartCampaignSuggestServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = smartcampaignsuggestserviceModule.v8.SmartCampaignSuggestServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = smartcampaignsuggestserviceModule.v8.SmartCampaignSuggestServiceClient.port;
        assert(port);
    ...
    describe('suggestSmartCampaignBudgetOptions', () => {
        it('invokes suggestSmartCampaignBudgetOptions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.SuggestSmartCampaignBudgetOptionsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.SuggestSmartCampaignBudgetOptionsResponse());
        ...
        it('invokes suggestSmartCampaignBudgetOptions without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suggestSmartCampaignBudgetOptions(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.ISuggestSmartCampaignBudgetOptionsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
