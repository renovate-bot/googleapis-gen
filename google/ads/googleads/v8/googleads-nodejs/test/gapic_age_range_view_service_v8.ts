...
describe('v8.AgeRangeViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = agerangeviewserviceModule.v8.AgeRangeViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = agerangeviewserviceModule.v8.AgeRangeViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = agerangeviewserviceModule.v8.AgeRangeViewServiceClient.port;
        assert(port);
    ...
    describe('getAgeRangeView', () => {
        it('invokes getAgeRangeView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetAgeRangeViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.AgeRangeView());
        ...
        it('invokes getAgeRangeView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAgeRangeView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IAgeRangeView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
