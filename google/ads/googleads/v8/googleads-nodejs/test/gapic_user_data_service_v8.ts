...
describe('v8.UserDataServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = userdataserviceModule.v8.UserDataServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = userdataserviceModule.v8.UserDataServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = userdataserviceModule.v8.UserDataServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new userdataserviceModule.v8.UserDataServiceClient();
        assert(client);
    });
    ...
    describe('uploadUserData', () => {
        it('invokes uploadUserData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.UploadUserDataRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.UploadUserDataResponse());
        ...
        it('invokes uploadUserData without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.uploadUserData(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IUploadUserDataResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
