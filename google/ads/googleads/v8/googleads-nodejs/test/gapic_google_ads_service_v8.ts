...
describe('v8.GoogleAdsServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = googleadsserviceModule.v8.GoogleAdsServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = googleadsserviceModule.v8.GoogleAdsServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = googleadsserviceModule.v8.GoogleAdsServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new googleadsserviceModule.v8.GoogleAdsServiceClient();
        assert(client);
    });
    ...
    describe('mutate', () => {
        it('invokes mutate without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateGoogleAdsRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateGoogleAdsResponse());
        ...
        it('invokes mutate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.mutate(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateGoogleAdsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('searchStream', () => {
        it('invokes searchStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.SearchGoogleAdsStreamRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.SearchGoogleAdsStreamResponse());
            client.innerApiCalls.searchStream = stubServerStreamingCall(expectedResponse);
            const stream = client.searchStream(request);
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.ads.googleads.v8.services.SearchGoogleAdsStreamResponse) => {
                    resolve(response);
                });
    ...
    describe('search', () => {
        it('invokes search without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.SearchGoogleAdsRequest());
            request.customerId = '';
            const expectedHeaderRequestParams = "customer_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.ads.googleads.v8.services.GoogleAdsRow()),
              generateSampleMessage(new protos.google.ads.googleads.v8.services.GoogleAdsRow()),
              generateSampleMessage(new protos.google.ads.googleads.v8.services.GoogleAdsRow()),
            ];
        ...
        it('invokes search without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.search(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IGoogleAdsRow[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchStream1 without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.ads.googleads.v8.services.GoogleAdsRow[] = [];
                stream.on('data', (response: protos.google.ads.googleads.v8.services.GoogleAdsRow) => {
        ...
        it('uses async iteration with search without error', async () => {
            ...
            const responses: protos.google.ads.googleads.v8.services.IGoogleAdsRow[] = [];
