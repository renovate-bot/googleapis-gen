...
describe('v8.ReachPlanServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = reachplanserviceModule.v8.ReachPlanServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = reachplanserviceModule.v8.ReachPlanServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = reachplanserviceModule.v8.ReachPlanServiceClient.port;
        assert(port);
    ...
    describe('listPlannableLocations', () => {
        it('invokes listPlannableLocations without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.ListPlannableLocationsResponse());
        ...
        it('invokes listPlannableLocations without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableLocations(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IListPlannableLocationsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listPlannableProducts', () => {
        it('invokes listPlannableProducts without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.ListPlannableProductsResponse());
        ...
        it('invokes listPlannableProducts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPlannableProducts(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IListPlannableProductsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateProductMixIdeas', () => {
        it('invokes generateProductMixIdeas without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.GenerateProductMixIdeasResponse());
        ...
        it('invokes generateProductMixIdeas without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateProductMixIdeas(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IGenerateProductMixIdeasResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('generateReachForecast', () => {
        it('invokes generateReachForecast without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.GenerateReachForecastResponse());
        ...
        it('invokes generateReachForecast without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.generateReachForecast(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IGenerateReachForecastResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
