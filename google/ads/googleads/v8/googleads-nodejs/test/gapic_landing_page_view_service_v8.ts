...
describe('v8.LandingPageViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = landingpageviewserviceModule.v8.LandingPageViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = landingpageviewserviceModule.v8.LandingPageViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = landingpageviewserviceModule.v8.LandingPageViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new landingpageviewserviceModule.v8.LandingPageViewServiceClient();
        assert(client);
    });
    ...
    describe('getLandingPageView', () => {
        it('invokes getLandingPageView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetLandingPageViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.LandingPageView());
        ...
        it('invokes getLandingPageView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getLandingPageView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ILandingPageView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
