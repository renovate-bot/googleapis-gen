...
import * as productgroupviewserviceModule from '../src';
...
describe('v8.ProductGroupViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = productgroupviewserviceModule.v8.ProductGroupViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = productgroupviewserviceModule.v8.ProductGroupViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = productgroupviewserviceModule.v8.ProductGroupViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new productgroupviewserviceModule.v8.ProductGroupViewServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.productGroupViewServiceStub, undefined);
        await client.initialize();
        assert(client.productGroupViewServiceStub);
    });
    ...
    describe('getProductGroupView', () => {
        it('invokes getProductGroupView without error', async () => {
            const client = new productgroupviewserviceModule.v8.ProductGroupViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetProductGroupViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ProductGroupView());
            client.innerApiCalls.getProductGroupView = stubSimpleCall(expectedResponse);
            const [response] = await client.getProductGroupView(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getProductGroupView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getProductGroupView without error using callback', async () => {
            const client = new productgroupviewserviceModule.v8.ProductGroupViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ProductGroupView());
            client.innerApiCalls.getProductGroupView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getProductGroupView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IProductGroupView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getProductGroupView with error', async () => {
            const client = new productgroupviewserviceModule.v8.ProductGroupViewServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getProductGroupView = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getProductGroupView(request), expectedError);
            assert((client.innerApiCalls.getProductGroupView as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
