...
import * as customeruseraccessserviceModule from '../src';
...
describe('v8.CustomerUserAccessServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = customeruseraccessserviceModule.v8.CustomerUserAccessServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = customeruseraccessserviceModule.v8.CustomerUserAccessServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = customeruseraccessserviceModule.v8.CustomerUserAccessServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new customeruseraccessserviceModule.v8.CustomerUserAccessServiceClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.customerUserAccessServiceStub, undefined);
        await client.initialize();
        assert(client.customerUserAccessServiceStub);
    });
    ...
    describe('getCustomerUserAccess', () => {
        it('invokes getCustomerUserAccess without error', async () => {
            const client = new customeruseraccessserviceModule.v8.CustomerUserAccessServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetCustomerUserAccessRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CustomerUserAccess());
            client.innerApiCalls.getCustomerUserAccess = stubSimpleCall(expectedResponse);
            const [response] = await client.getCustomerUserAccess(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomerUserAccess as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getCustomerUserAccess without error using callback', async () => {
            const client = new customeruseraccessserviceModule.v8.CustomerUserAccessServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.CustomerUserAccess());
            client.innerApiCalls.getCustomerUserAccess = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomerUserAccess(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.ICustomerUserAccess|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getCustomerUserAccess with error', async () => {
            const client = new customeruseraccessserviceModule.v8.CustomerUserAccessServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.innerApiCalls.getCustomerUserAccess = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getCustomerUserAccess(request), expectedError);
            assert((client.innerApiCalls.getCustomerUserAccess as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('mutateCustomerUserAccess', () => {
        it('invokes mutateCustomerUserAccess without error', async () => {
            const client = new customeruseraccessserviceModule.v8.CustomerUserAccessServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCustomerUserAccessRequest());
            request.customerId = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCustomerUserAccessResponse());
            client.innerApiCalls.mutateCustomerUserAccess = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateCustomerUserAccess(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateCustomerUserAccess as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes mutateCustomerUserAccess without error using callback', async () => {
            const client = new customeruseraccessserviceModule.v8.CustomerUserAccessServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.services.MutateCustomerUserAccessResponse());
            client.innerApiCalls.mutateCustomerUserAccess = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateCustomerUserAccess(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.services.IMutateCustomerUserAccessResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes mutateCustomerUserAccess with error', async () => {
            const client = new customeruseraccessserviceModule.v8.CustomerUserAccessServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateCustomerUserAccess = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.mutateCustomerUserAccess(request), expectedError);
            assert((client.innerApiCalls.mutateCustomerUserAccess as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
