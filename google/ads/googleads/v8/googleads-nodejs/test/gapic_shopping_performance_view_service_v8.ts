...
describe('v8.ShoppingPerformanceViewServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = shoppingperformanceviewserviceModule.v8.ShoppingPerformanceViewServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = shoppingperformanceviewserviceModule.v8.ShoppingPerformanceViewServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = shoppingperformanceviewserviceModule.v8.ShoppingPerformanceViewServiceClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new shoppingperformanceviewserviceModule.v8.ShoppingPerformanceViewServiceClient();
        assert(client);
    });
    ...
    describe('getShoppingPerformanceView', () => {
        it('invokes getShoppingPerformanceView without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.ads.googleads.v8.services.GetShoppingPerformanceViewRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.ads.googleads.v8.resources.ShoppingPerformanceView());
        ...
        it('invokes getShoppingPerformanceView without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getShoppingPerformanceView(
                    request,
                    (err?: Error|null, result?: protos.google.ads.googleads.v8.resources.IShoppingPerformanceView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
