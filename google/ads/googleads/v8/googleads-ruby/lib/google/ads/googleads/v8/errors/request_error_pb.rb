...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/errors/request_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.errors.RequestErrorEnum" do
    end
    add_enum "google.ads.googleads.v8.errors.RequestErrorEnum.RequestError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Errors
          RequestErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.RequestErrorEnum").msgclass
          RequestErrorEnum::RequestError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.RequestErrorEnum.RequestError").enummodule
        end
      end
    end
  end
