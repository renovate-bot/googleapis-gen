...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/errors/date_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.errors.DateErrorEnum" do
    end
    add_enum "google.ads.googleads.v8.errors.DateErrorEnum.DateError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Errors
          DateErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.DateErrorEnum").msgclass
          DateErrorEnum::DateError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.DateErrorEnum.DateError").enummodule
        end
      end
    end
  end
