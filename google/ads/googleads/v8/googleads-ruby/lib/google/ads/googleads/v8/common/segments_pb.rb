...
require 'google/ads/googleads/v8/common/criteria_pb'
require 'google/ads/googleads/v8/enums/ad_destination_type_pb'
require 'google/ads/googleads/v8/enums/ad_network_type_pb'
require 'google/ads/googleads/v8/enums/budget_campaign_association_status_pb'
require 'google/ads/googleads/v8/enums/click_type_pb'
require 'google/ads/googleads/v8/enums/conversion_action_category_pb'
require 'google/ads/googleads/v8/enums/conversion_attribution_event_type_pb'
require 'google/ads/googleads/v8/enums/conversion_lag_bucket_pb'
require 'google/ads/googleads/v8/enums/conversion_or_adjustment_lag_bucket_pb'
require 'google/ads/googleads/v8/enums/conversion_value_rule_primary_dimension_pb'
require 'google/ads/googleads/v8/enums/day_of_week_pb'
require 'google/ads/googleads/v8/enums/device_pb'
require 'google/ads/googleads/v8/enums/external_conversion_source_pb'
require 'google/ads/googleads/v8/enums/hotel_date_selection_type_pb'
require 'google/ads/googleads/v8/enums/hotel_price_bucket_pb'
require 'google/ads/googleads/v8/enums/hotel_rate_type_pb'
require 'google/ads/googleads/v8/enums/month_of_year_pb'
require 'google/ads/googleads/v8/enums/placeholder_type_pb'
require 'google/ads/googleads/v8/enums/product_channel_pb'
require 'google/ads/googleads/v8/enums/product_channel_exclusivity_pb'
require 'google/ads/googleads/v8/enums/product_condition_pb'
require 'google/ads/googleads/v8/enums/recommendation_type_pb'
require 'google/ads/googleads/v8/enums/search_engine_results_page_type_pb'
require 'google/ads/googleads/v8/enums/search_term_match_type_pb'
require 'google/ads/googleads/v8/enums/slot_pb'
require 'google/api/annotations_pb'
require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/common/segments.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.common.Segments" do
      optional :ad_destination_type, :enum, 136, "google.ads.googleads.v8.enums.AdDestinationTypeEnum.AdDestinationType"
      optional :ad_network_type, :enum, 3, "google.ads.googleads.v8.enums.AdNetworkTypeEnum.AdNetworkType"
      optional :budget_campaign_association_status, :message, 134, "google.ads.googleads.v8.common.BudgetCampaignAssociationStatus"
      optional :click_type, :enum, 26, "google.ads.googleads.v8.enums.ClickTypeEnum.ClickType"
      proto3_optional :conversion_action, :string, 113
      optional :conversion_action_category, :enum, 53, "google.ads.googleads.v8.enums.ConversionActionCategoryEnum.ConversionActionCategory"
      proto3_optional :conversion_action_name, :string, 114
      proto3_optional :conversion_adjustment, :bool, 115
      optional :conversion_attribution_event_type, :enum, 2, "google.ads.googleads.v8.enums.ConversionAttributionEventTypeEnum.ConversionAttributionEventType"
      optional :conversion_lag_bucket, :enum, 50, "google.ads.googleads.v8.enums.ConversionLagBucketEnum.ConversionLagBucket"
      optional :conversion_or_adjustment_lag_bucket, :enum, 51, "google.ads.googleads.v8.enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket"
      proto3_optional :date, :string, 79
      optional :day_of_week, :enum, 5, "google.ads.googleads.v8.enums.DayOfWeekEnum.DayOfWeek"
      optional :device, :enum, 1, "google.ads.googleads.v8.enums.DeviceEnum.Device"
      optional :external_conversion_source, :enum, 55, "google.ads.googleads.v8.enums.ExternalConversionSourceEnum.ExternalConversionSource"
      ...
      optional :hotel_check_in_day_of_week, :enum, 9, "google.ads.googleads.v8.enums.DayOfWeekEnum.DayOfWeek"
      proto3_optional :hotel_city, :string, 82
      proto3_optional :hotel_class, :int32, 83
      proto3_optional :hotel_country, :string, 84
      optional :hotel_date_selection_type, :enum, 13, "google.ads.googleads.v8.enums.HotelDateSelectionTypeEnum.HotelDateSelectionType"
      proto3_optional :hotel_length_of_stay, :int32, 85
      proto3_optional :hotel_rate_rule_id, :string, 86
      optional :hotel_rate_type, :enum, 74, "google.ads.googleads.v8.enums.HotelRateTypeEnum.HotelRateType"
      optional :hotel_price_bucket, :enum, 78, "google.ads.googleads.v8.enums.HotelPriceBucketEnum.HotelPriceBucket"
      proto3_optional :hotel_state, :string, 87
      proto3_optional :hour, :int32, 88
      proto3_optional :interaction_on_this_extension, :bool, 89
      optional :keyword, :message, 61, "google.ads.googleads.v8.common.Keyword"
      proto3_optional :month, :string, 90
      optional :month_of_year, :enum, 18, "google.ads.googleads.v8.enums.MonthOfYearEnum.MonthOfYear"
      proto3_optional :partner_hotel_id, :string, 91
      optional :placeholder_type, :enum, 20, "google.ads.googleads.v8.enums.PlaceholderTypeEnum.PlaceholderType"
      ...
      optional :product_channel, :enum, 30, "google.ads.googleads.v8.enums.ProductChannelEnum.ProductChannel"
      optional :product_channel_exclusivity, :enum, 31, "google.ads.googleads.v8.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity"
      optional :product_condition, :enum, 32, "google.ads.googleads.v8.enums.ProductConditionEnum.ProductCondition"
    ...
    add_message "google.ads.googleads.v8.common.Keyword" do
      ...
      optional :info, :message, 2, "google.ads.googleads.v8.common.KeywordInfo"
    end
