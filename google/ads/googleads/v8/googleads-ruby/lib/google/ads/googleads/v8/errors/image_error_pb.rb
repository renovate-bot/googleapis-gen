...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/errors/image_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.errors.ImageErrorEnum" do
    end
    add_enum "google.ads.googleads.v8.errors.ImageErrorEnum.ImageError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Errors
          ImageErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.ImageErrorEnum").msgclass
          ImageErrorEnum::ImageError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.ImageErrorEnum.ImageError").enummodule
        end
      end
    end
  end
