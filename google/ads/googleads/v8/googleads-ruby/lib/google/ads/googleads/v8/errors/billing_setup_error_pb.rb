...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/errors/billing_setup_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.errors.BillingSetupErrorEnum" do
    end
    add_enum "google.ads.googleads.v8.errors.BillingSetupErrorEnum.BillingSetupError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Errors
          BillingSetupErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.BillingSetupErrorEnum").msgclass
          BillingSetupErrorEnum::BillingSetupError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.BillingSetupErrorEnum.BillingSetupError").enummodule
        end
      end
    end
  end
