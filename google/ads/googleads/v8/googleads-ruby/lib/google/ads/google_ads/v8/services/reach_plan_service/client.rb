...
require "google/ads/googleads/v8/services/reach_plan_service_pb"
        ...
        module Services
          module ReachPlanService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V8::Services::ReachPlanService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all ReachPlanService clients
              #   ::Google::Ads::GoogleAds::V8::Services::ReachPlanService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V8::Services::ReachPlanService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v8/services/reach_plan_service_services_pb"
                ...
                @reach_plan_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V8::Services::ReachPlanService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::ListPlannableLocationsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::ListPlannableLocationsRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Services::ListPlannableLocationsResponse]
              ...
              def list_plannable_locations request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::ListPlannableLocationsRequest
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::ListPlannableProductsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::ListPlannableProductsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              def list_plannable_products request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::ListPlannableProductsRequest
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::GenerateProductMixIdeasRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::GenerateProductMixIdeasRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param preferences [::Google::Ads::GoogleAds::V8::Services::Preferences, ::Hash]
              #     The preferences of the suggested product mix.
              #     An unset preference is interpreted as all possible values are allowed,
              #     unless explicitly specified.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Services::GenerateProductMixIdeasResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def generate_product_mix_ideas request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::GenerateProductMixIdeasRequest
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::GenerateReachForecastRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::GenerateReachForecastRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #     The currency code.
              #     Three-character ISO 4217 currency code.
              #   @param campaign_duration [::Google::Ads::GoogleAds::V8::Services::CampaignDuration, ::Hash]
              ...
              #   @param cookie_frequency_cap_setting [::Google::Ads::GoogleAds::V8::Services::FrequencyCap, ::Hash]
              #     Desired cookie frequency cap that will be applied to each planned product.
              #     This is equivalent to the frequency cap exposed in Google Ads when creating
              #     a campaign, it represents the maximum number of times an ad can be shown to
              ...
              #   @param planned_products [::Array<::Google::Ads::GoogleAds::V8::Services::PlannedProduct, ::Hash>]
              #     Required. The products to be forecast.
              #     The max number of allowed planned products is 15.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Services::GenerateReachForecastResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def generate_reach_forecast request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::GenerateReachForecastRequest
              ...
              # {::Google::Ads::GoogleAds::V8::Services::ReachPlanService::Client::Configuration::Rpcs}
