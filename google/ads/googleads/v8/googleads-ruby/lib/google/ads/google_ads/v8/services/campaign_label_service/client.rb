...
require "google/ads/googleads/v8/services/campaign_label_service_pb"
        ...
        module Services
          module CampaignLabelService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V8::Services::CampaignLabelService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all CampaignLabelService clients
              #   ::Google::Ads::GoogleAds::V8::Services::CampaignLabelService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V8::Services::CampaignLabelService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V8::Services::CampaignLabelService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v8/services/campaign_label_service_services_pb"
                ...
                @campaign_label_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V8::Services::CampaignLabelService::Stub,
              ...
              #   [RequestError]()
              #
              # @overload get_campaign_label(request, options = nil)
              #   Pass arguments to `get_campaign_label` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V8::Services::GetCampaignLabelRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::GetCampaignLabelRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload get_campaign_label(resource_name: nil)
              #   Pass arguments to `get_campaign_label` via keyword arguments. Note that at
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Resources::CampaignLabel]
              ...
              #   request = Google::Ads::GoogleAds::V8::Services::GetCampaignLabelRequest.new
              #
              #   # Call the get_campaign_label method.
              #   result = client.get_campaign_label request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V8::Resources::CampaignLabel.
              #   p result
              #
              def get_campaign_label request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::GetCampaignLabelRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                metadata = @config.rpcs.get_campaign_label.metadata.to_h
                ...
                options.apply_defaults timeout:      @config.rpcs.get_campaign_label.timeout,
                                       metadata:     metadata,
                                       retry_policy: @config.rpcs.get_campaign_label.retry_policy

                options.apply_defaults timeout:      @config.timeout,
                                       metadata:     @config.metadata,
                                       retry_policy: @config.retry_policy

                @campaign_label_service_stub.call_rpc :get_campaign_label, request,
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::MutateCampaignLabelsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::MutateCampaignLabelsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V8::Services::CampaignLabelOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Services::MutateCampaignLabelsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V8::Services::MutateCampaignLabelsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V8::Services::MutateCampaignLabelsRequest.new
              #
              #   # Call the mutate_campaign_labels method.
              #   result = client.mutate_campaign_labels request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V8::Services::MutateCampaignLabelsResponse.
              #   p result
              #
              def mutate_campaign_labels request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::MutateCampaignLabelsRequest
              ...
              # {::Google::Ads::GoogleAds::V8::Services::CampaignLabelService::Client::Configuration::Rpcs}
              ...
              #   # get_campaign_label to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Ads::GoogleAds::V8::Services::CampaignLabelService::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.get_campaign_label.timeout = 20.0
              #   end
              #
              ...
              class Configuration
                ...
                class Rpcs
                  ##
                  # RPC-specific configuration for `get_campaign_label`
                  # @return [::Gapic::Config::Method]
                  #
                  attr_reader :get_campaign_label
                  ##
                  ...
                  def initialize parent_rpcs = nil
                    get_campaign_label_config = parent_rpcs.get_campaign_label if parent_rpcs.respond_to? :get_campaign_label
                    @get_campaign_label = ::Gapic::Config::Method.new get_campaign_label_config
