...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/enums/click_type.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.enums.ClickTypeEnum" do
    end
    add_enum "google.ads.googleads.v8.enums.ClickTypeEnum.ClickType" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Enums
          ClickTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.enums.ClickTypeEnum").msgclass
          ClickTypeEnum::ClickType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.enums.ClickTypeEnum.ClickType").enummodule
        end
      end
    end
  end
