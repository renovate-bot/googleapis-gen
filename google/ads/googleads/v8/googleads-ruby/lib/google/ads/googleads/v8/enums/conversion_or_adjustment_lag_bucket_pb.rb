...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/enums/conversion_or_adjustment_lag_bucket.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.enums.ConversionOrAdjustmentLagBucketEnum" do
    end
    add_enum "google.ads.googleads.v8.enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Enums
          ConversionOrAdjustmentLagBucketEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.enums.ConversionOrAdjustmentLagBucketEnum").msgclass
          ConversionOrAdjustmentLagBucketEnum::ConversionOrAdjustmentLagBucket = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket").enummodule
        end
      end
    end
  end
