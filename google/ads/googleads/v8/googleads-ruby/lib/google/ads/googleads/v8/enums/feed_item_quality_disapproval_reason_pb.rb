...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/enums/feed_item_quality_disapproval_reason.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.enums.FeedItemQualityDisapprovalReasonEnum" do
    end
    add_enum "google.ads.googleads.v8.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Enums
          FeedItemQualityDisapprovalReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.enums.FeedItemQualityDisapprovalReasonEnum").msgclass
          FeedItemQualityDisapprovalReasonEnum::FeedItemQualityDisapprovalReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason").enummodule
        end
      end
    end
  end
