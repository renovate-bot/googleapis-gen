...
require "google/ads/googleads/v8/services/recommendation_service_pb"
        ...
        module Services
          module RecommendationService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V8::Services::RecommendationService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all RecommendationService clients
              #   ::Google::Ads::GoogleAds::V8::Services::RecommendationService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V8::Services::RecommendationService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V8::Services::RecommendationService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v8/services/recommendation_service_services_pb"
                ...
                @recommendation_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V8::Services::RecommendationService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::GetRecommendationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::GetRecommendationRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Resources::Recommendation]
              ...
              #   request = Google::Ads::GoogleAds::V8::Services::GetRecommendationRequest.new
              #
              #   # Call the get_recommendation method.
              #   result = client.get_recommendation request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V8::Resources::Recommendation.
              #   p result
              #
              def get_recommendation request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::GetRecommendationRequest
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::ApplyRecommendationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::ApplyRecommendationRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V8::Services::ApplyRecommendationOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Services::ApplyRecommendationResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V8::Services::ApplyRecommendationResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V8::Services::ApplyRecommendationRequest.new
              #
              #   # Call the apply_recommendation method.
              #   result = client.apply_recommendation request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V8::Services::ApplyRecommendationResponse.
              #   p result
              #
              def apply_recommendation request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::ApplyRecommendationRequest
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::DismissRecommendationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::DismissRecommendationRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param customer_id [::String]
              #     Required. The ID of the customer with the recommendation.
              #   @param operations [::Array<::Google::Ads::GoogleAds::V8::Services::DismissRecommendationRequest::DismissRecommendationOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Services::DismissRecommendationResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V8::Services::DismissRecommendationResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V8::Services::DismissRecommendationRequest.new
              #
              #   # Call the dismiss_recommendation method.
              #   result = client.dismiss_recommendation request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V8::Services::DismissRecommendationResponse.
              #   p result
              #
              def dismiss_recommendation request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::DismissRecommendationRequest
              ...
              # {::Google::Ads::GoogleAds::V8::Services::RecommendationService::Client::Configuration::Rpcs}
