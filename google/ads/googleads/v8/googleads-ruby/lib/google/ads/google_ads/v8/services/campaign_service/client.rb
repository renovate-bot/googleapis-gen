...
require "google/ads/googleads/v8/services/campaign_service_pb"
        ...
        module Services
          module CampaignService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V8::Services::CampaignService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all CampaignService clients
              #   ::Google::Ads::GoogleAds::V8::Services::CampaignService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V8::Services::CampaignService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V8::Services::CampaignService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v8/services/campaign_service_services_pb"
                ...
                @campaign_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V8::Services::CampaignService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::GetCampaignRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::GetCampaignRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Resources::Campaign]
              ...
              #   request = Google::Ads::GoogleAds::V8::Services::GetCampaignRequest.new
              #
              #   # Call the get_campaign method.
              #   result = client.get_campaign request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V8::Resources::Campaign.
              #   p result
              #
              def get_campaign request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::GetCampaignRequest
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::MutateCampaignsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::MutateCampaignsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V8::Services::CampaignOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Services::MutateCampaignsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V8::Services::MutateCampaignsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V8::Services::MutateCampaignsRequest.new
              #
              #   # Call the mutate_campaigns method.
              #   result = client.mutate_campaigns request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V8::Services::MutateCampaignsResponse.
              #   p result
              #
              def mutate_campaigns request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::MutateCampaignsRequest
              ...
              # {::Google::Ads::GoogleAds::V8::Services::CampaignService::Client::Configuration::Rpcs}
