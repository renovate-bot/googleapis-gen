...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/errors/feed_item_validation_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.errors.FeedItemValidationErrorEnum" do
    end
    add_enum "google.ads.googleads.v8.errors.FeedItemValidationErrorEnum.FeedItemValidationError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
      ...
      value :CUSTOMER_NOT_IN_ALLOWLIST_FOR_CALLTRACKING, 99
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Errors
          FeedItemValidationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.FeedItemValidationErrorEnum").msgclass
          FeedItemValidationErrorEnum::FeedItemValidationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.FeedItemValidationErrorEnum.FeedItemValidationError").enummodule
        end
      end
    end
  end
