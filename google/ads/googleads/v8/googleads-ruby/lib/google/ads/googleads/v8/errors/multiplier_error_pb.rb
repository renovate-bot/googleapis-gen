...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/errors/multiplier_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.errors.MultiplierErrorEnum" do
    end
    add_enum "google.ads.googleads.v8.errors.MultiplierErrorEnum.MultiplierError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Errors
          MultiplierErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.MultiplierErrorEnum").msgclass
          MultiplierErrorEnum::MultiplierError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.MultiplierErrorEnum.MultiplierError").enummodule
        end
      end
    end
  end
