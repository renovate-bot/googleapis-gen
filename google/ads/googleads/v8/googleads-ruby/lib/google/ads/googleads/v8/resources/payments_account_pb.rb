...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/resources/payments_account.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.resources.PaymentsAccount" do
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Resources
          PaymentsAccount = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.resources.PaymentsAccount").msgclass
        end
      end
    end
  end
