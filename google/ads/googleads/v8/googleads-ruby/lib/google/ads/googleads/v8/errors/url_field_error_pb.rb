...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/errors/url_field_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.errors.UrlFieldErrorEnum" do
    end
    add_enum "google.ads.googleads.v8.errors.UrlFieldErrorEnum.UrlFieldError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Errors
          UrlFieldErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.UrlFieldErrorEnum").msgclass
          UrlFieldErrorEnum::UrlFieldError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.UrlFieldErrorEnum.UrlFieldError").enummodule
        end
      end
    end
  end
