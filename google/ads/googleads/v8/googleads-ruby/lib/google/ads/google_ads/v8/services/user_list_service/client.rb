...
require "google/ads/googleads/v8/services/user_list_service_pb"
        ...
        module Services
          module UserListService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V8::Services::UserListService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all UserListService clients
              #   ::Google::Ads::GoogleAds::V8::Services::UserListService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V8::Services::UserListService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V8::Services::UserListService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/googleads/v8/services/user_list_service_services_pb"
                ...
                @user_list_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V8::Services::UserListService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V8::Services::GetUserListRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::GetUserListRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Resources::UserList]
              ...
              #   request = Google::Ads::GoogleAds::V8::Services::GetUserListRequest.new
              #
              #   # Call the get_user_list method.
              #   result = client.get_user_list request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V8::Resources::UserList.
              #   p result
              #
              def get_user_list request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::GetUserListRequest
              ...
              #   Pass arguments to `mutate_user_lists` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V8::Services::MutateUserListsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V8::Services::MutateUserListsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   Pass arguments to `mutate_user_lists` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param customer_id [::String]
              #     Required. The ID of the customer whose user lists are being modified.
              #   @param operations [::Array<::Google::Ads::GoogleAds::V8::Services::UserListOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Services::MutateUserListsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V8::Services::MutateUserListsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V8::Services::MutateUserListsRequest.new
              #
              #   # Call the mutate_user_lists method.
              #   result = client.mutate_user_lists request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V8::Services::MutateUserListsResponse.
              #   p result
              #
              def mutate_user_lists request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V8::Services::MutateUserListsRequest
              ...
              # {::Google::Ads::GoogleAds::V8::Services::UserListService::Client::Configuration::Rpcs}
