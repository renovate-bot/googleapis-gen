...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/errors/campaign_budget_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.errors.CampaignBudgetErrorEnum" do
    end
    add_enum "google.ads.googleads.v8.errors.CampaignBudgetErrorEnum.CampaignBudgetError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Errors
          CampaignBudgetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.CampaignBudgetErrorEnum").msgclass
          CampaignBudgetErrorEnum::CampaignBudgetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.errors.CampaignBudgetErrorEnum.CampaignBudgetError").enummodule
        end
      end
    end
  end
