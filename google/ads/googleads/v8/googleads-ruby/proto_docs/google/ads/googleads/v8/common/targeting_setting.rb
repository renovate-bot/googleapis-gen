    ...
    module GoogleAds
      module V8
        module Common
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::TargetRestriction>]
          #     The per-targeting-dimension setting to restrict the reach of your campaign
          #     or ad group.
          # @!attribute [rw] target_restriction_operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::TargetRestrictionOperation>]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Common::TargetRestrictionOperation::Operator]
          #     Type of list operation to perform.
          # @!attribute [rw] value
          #   @return [::Google::Ads::GoogleAds::V8::Common::TargetRestriction]
