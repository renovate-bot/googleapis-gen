  ...
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::ConversionAdjustmentUploadService::Client#upload_conversion_adjustments ConversionAdjustmentUploadService.UploadConversionAdjustments}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer performing the upload.
          # @!attribute [rw] conversion_adjustments
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::ConversionAdjustment>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::ConversionAdjustmentResult>]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::ConversionAdjustmentTypeEnum::ConversionAdjustmentType]
          #     The adjustment type.
          # @!attribute [rw] restatement_value
          #   @return [::Google::Ads::GoogleAds::V8::Services::RestatementValue]
