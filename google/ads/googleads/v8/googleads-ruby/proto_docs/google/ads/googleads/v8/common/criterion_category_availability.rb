    ...
    module GoogleAds
      module V8
        module Common
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Common::CriterionCategoryChannelAvailability]
          #     Channel types and subtypes that are available to the category.
          # @!attribute [rw] locale
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::CriterionCategoryLocaleAvailability>]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::CriterionCategoryChannelAvailabilityModeEnum::CriterionCategoryChannelAvailabilityMode]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType>]
          ...
          # @!attribute [rw] availability_mode
          #   @return [::Google::Ads::GoogleAds::V8::Enums::CriterionCategoryLocaleAvailabilityModeEnum::CriterionCategoryLocaleAvailabilityMode]
