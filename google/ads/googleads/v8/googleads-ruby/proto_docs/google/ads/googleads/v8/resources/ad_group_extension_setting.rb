    ...
    module GoogleAds
      module V8
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::ExtensionTypeEnum::ExtensionType]
          ...
          # @!attribute [rw] device
          #   @return [::Google::Ads::GoogleAds::V8::Enums::ExtensionSettingDeviceEnum::ExtensionSettingDevice]
