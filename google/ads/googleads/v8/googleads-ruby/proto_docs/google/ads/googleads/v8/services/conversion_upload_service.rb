...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::ConversionUploadService::Client#upload_click_conversions ConversionUploadService.UploadClickConversions}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer performing the upload.
          # @!attribute [rw] conversions
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::ClickConversion>]
          ...
          # Response message for {::Google::Ads::GoogleAds::V8::Services::ConversionUploadService::Client#upload_click_conversions ConversionUploadService.UploadClickConversions}.
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::ClickConversionResult>]
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::ConversionUploadService::Client#upload_call_conversions ConversionUploadService.UploadCallConversions}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer performing the upload.
          # @!attribute [rw] conversions
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::CallConversion>]
          #     Required. The conversions that are being uploaded.
          # @!attribute [rw] partial_failure
          #   @return [::Boolean]
          #     Required. If true, successful operations will be carried out and invalid
          ...
          # Response message for {::Google::Ads::GoogleAds::V8::Services::ConversionUploadService::Client#upload_call_conversions ConversionUploadService.UploadCallConversions}.
          # @!attribute [rw] partial_failure_error
          #   @return [::Google::Rpc::Status]
          #     Errors that pertain to conversion failures in the partial failure mode.
          #     Returned when all errors occur inside the conversions. If any errors occur
          ...
          #     for more information about partial failure.
          # @!attribute [rw] results
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::CallConversionResult>]
          #     Returned for successfully processed conversions. Proto will be empty for
          #     rows that received an error. Results are not returned when validate_only is
          #     true.
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Services::ExternalAttributionData]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::CustomVariable>]
          ...
          # @!attribute [rw] items
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::CartData::Item>]
