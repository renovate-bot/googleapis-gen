  ...
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::BillingSetupService::Client#get_billing_setup BillingSetupService.GetBillingSetup}.
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Services::BillingSetupOperation]
          ...
          # @!attribute [rw] result
          #   @return [::Google::Ads::GoogleAds::V8::Services::MutateBillingSetupResult]
