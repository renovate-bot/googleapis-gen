...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::GeoTargetConstantService::Client#get_geo_target_constant GeoTargetConstantService.GetGeoTargetConstant}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::GeoTargetConstantService::Client#suggest_geo_target_constants GeoTargetConstantService.SuggestGeoTargetConstants}.
          # @!attribute [rw] locale
          #   @return [::String]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Services::SuggestGeoTargetConstantsRequest::LocationNames]
          #     The location names to search by. At most 25 names can be set.
          # @!attribute [rw] geo_targets
          #   @return [::Google::Ads::GoogleAds::V8::Services::SuggestGeoTargetConstantsRequest::GeoTargets]
          ...
          # Response message for {::Google::Ads::GoogleAds::V8::Services::GeoTargetConstantService::Client#suggest_geo_target_constants GeoTargetConstantService.SuggestGeoTargetConstants}.
          # @!attribute [rw] geo_target_constant_suggestions
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::GeoTargetConstantSuggestion>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Resources::GeoTargetConstant>]
