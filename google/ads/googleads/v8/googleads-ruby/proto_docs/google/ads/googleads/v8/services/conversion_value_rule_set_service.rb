  ...
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::ConversionValueRuleSetService::Client#get_conversion_value_rule_set ConversionValueRuleSetService.GetConversionValueRuleSet}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          #     Required. The resource name of the conversion value rule set to fetch.
          class GetConversionValueRuleSetRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end

          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::ConversionValueRuleSetService::Client#mutate_conversion_value_rule_sets ConversionValueRuleSetService.MutateConversionValueRuleSets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose conversion value rule sets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::ConversionValueRuleSetOperation>]
          ...
          class MutateConversionValueRuleSetsRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          class ConversionValueRuleSetOperation
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateConversionValueRuleSetResult>]
          ...
          class MutateConversionValueRuleSetsResponse
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #     to "MUTABLE_RESOURCE".
          class MutateConversionValueRuleSetResult
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
        end
