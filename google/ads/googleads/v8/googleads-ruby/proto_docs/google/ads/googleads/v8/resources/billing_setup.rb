    ...
    module GoogleAds
      module V8
        module Resources
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V8::Enums::BillingSetupStatusEnum::BillingSetupStatus]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Resources::BillingSetup::PaymentsAccountInfo]
