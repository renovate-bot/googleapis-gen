...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::AdGroupLabelService::Client#get_ad_group_label AdGroupLabelService.GetAdGroupLabel}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::AdGroupLabelService::Client#mutate_ad_group_labels AdGroupLabelService.MutateAdGroupLabels}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose ad group labels are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::AdGroupLabelOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateAdGroupLabelResult>]
