    ...
    module GoogleAds
      module V8
        module Common
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::MonthlySearchVolume>]
          #     Approximate number of searches on this query for the past twelve months.
          # @!attribute [rw] competition
          #   @return [::Google::Ads::GoogleAds::V8::Enums::KeywordPlanCompetitionLevelEnum::KeywordPlanCompetitionLevel]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Common::YearMonthRange]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Enums::KeywordPlanAggregateMetricTypeEnum::KeywordPlanAggregateMetricType>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::KeywordPlanDeviceSearches>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::KeywordConcept>]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Common::ConceptGroup]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V8::Enums::KeywordPlanConceptGroupTypeEnum::KeywordPlanConceptGroupType]
