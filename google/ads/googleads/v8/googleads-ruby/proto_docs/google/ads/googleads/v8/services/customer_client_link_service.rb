...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CustomerClientLinkService::Client#get_customer_client_link CustomerClientLinkService.GetCustomerClientLink}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CustomerClientLinkService::Client#mutate_customer_client_link CustomerClientLinkService.MutateCustomerClientLink}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose customer link are being modified.
          # @!attribute [rw] operation
          #   @return [::Google::Ads::GoogleAds::V8::Services::CustomerClientLinkOperation]
          ...
          # @!attribute [rw] result
          #   @return [::Google::Ads::GoogleAds::V8::Services::MutateCustomerClientLinkResult]
