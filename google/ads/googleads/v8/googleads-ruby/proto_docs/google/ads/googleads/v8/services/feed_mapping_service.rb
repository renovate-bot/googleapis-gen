...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::FeedMappingService::Client#get_feed_mapping FeedMappingService.GetFeedMapping}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::FeedMappingService::Client#mutate_feed_mappings FeedMappingService.MutateFeedMappings}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose feed mappings are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::FeedMappingOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateFeedMappingResult>]
