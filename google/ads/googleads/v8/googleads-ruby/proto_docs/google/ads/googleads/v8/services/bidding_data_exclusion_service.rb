  ...
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::BiddingDataExclusionService::Client#get_bidding_data_exclusion BiddingDataExclusionService.GetBiddingDataExclusion}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          #     Required. The resource name of the data exclusion to fetch.
          class GetBiddingDataExclusionRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end

          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::BiddingDataExclusionService::Client#mutate_bidding_data_exclusions BiddingDataExclusionService.MutateBiddingDataExclusions}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose data exclusions are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::BiddingDataExclusionOperation>]
          ...
          class MutateBiddingDataExclusionsRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          class BiddingDataExclusionOperation
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateBiddingDataExclusionsResult>]
          #     All results for the mutate.
          class MutateBiddingDataExclusionsResponse
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #     to "MUTABLE_RESOURCE".
          class MutateBiddingDataExclusionsResult
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
        end
