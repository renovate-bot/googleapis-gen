...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CampaignFeedService::Client#get_campaign_feed CampaignFeedService.GetCampaignFeed}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CampaignFeedService::Client#mutate_campaign_feeds CampaignFeedService.MutateCampaignFeeds}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose campaign feeds are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::CampaignFeedOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateCampaignFeedResult>]
