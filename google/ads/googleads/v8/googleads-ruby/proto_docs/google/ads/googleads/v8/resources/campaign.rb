    ...
    module GoogleAds
      module V8
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V8::Enums::CampaignStatusEnum::CampaignStatus]
          #     The status of the campaign.
          #
          #     When a new campaign is added, the status defaults to ENABLED.
          # @!attribute [r] serving_status
          #   @return [::Google::Ads::GoogleAds::V8::Enums::CampaignServingStatusEnum::CampaignServingStatus]
          #     Output only. The ad serving status of the campaign.
          # @!attribute [rw] ad_serving_optimization_status
          #   @return [::Google::Ads::GoogleAds::V8::Enums::AdServingOptimizationStatusEnum::AdServingOptimizationStatus]
          #     The ad serving optimization status of the campaign.
          # @!attribute [rw] advertising_channel_type
          #   @return [::Google::Ads::GoogleAds::V8::Enums::AdvertisingChannelTypeEnum::AdvertisingChannelType]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::AdvertisingChannelSubTypeEnum::AdvertisingChannelSubType]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Common::RealTimeBiddingSetting]
          #     Settings for Real-Time Bidding, a feature only available for campaigns
          #     targeting the Ad Exchange network.
          # @!attribute [rw] network_settings
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::NetworkSettings]
          #     The network settings for the campaign.
          # @!attribute [rw] hotel_setting
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::HotelSettingInfo]
          #     Immutable. The hotel setting for the campaign.
          # @!attribute [rw] dynamic_search_ads_setting
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::DynamicSearchAdsSetting]
          #     The setting for controlling Dynamic Search Ads (DSA).
          # @!attribute [rw] shopping_setting
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::ShoppingSetting]
          #     The setting for controlling Shopping campaigns.
          # @!attribute [rw] targeting_setting
          #   @return [::Google::Ads::GoogleAds::V8::Common::TargetingSetting]
          #     Setting for targeting related features.
          # @!attribute [rw] geo_target_type_setting
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::GeoTargetTypeSetting]
          #     The setting for ads geotargeting.
          # @!attribute [rw] local_campaign_setting
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::LocalCampaignSetting]
          #     The setting for local campaign.
          # @!attribute [rw] app_campaign_setting
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::AppCampaignSetting]
          #     The setting related to App Campaign.
          # @!attribute [r] labels
          #   @return [::Array<::String>]
          #     Output only. The resource names of labels attached to this campaign.
          # @!attribute [r] experiment_type
          #   @return [::Google::Ads::GoogleAds::V8::Enums::CampaignExperimentTypeEnum::CampaignExperimentType]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::BiddingStrategyTypeEnum::BiddingStrategyType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::FrequencyCapEntry>]
          #     A list that limits how often each user will see this campaign's ads.
          # @!attribute [r] video_brand_safety_suitability
          #   @return [::Google::Ads::GoogleAds::V8::Enums::BrandSafetySuitabilityEnum::BrandSafetySuitability]
          #     Output only. 3-Tier Brand Safety setting for the campaign.
          # @!attribute [rw] vanity_pharma
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::VanityPharma]
          #     Describes how unbranded pharma ads will be displayed.
          # @!attribute [rw] selective_optimization
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::SelectiveOptimization]
          #     Selective optimization setting for this campaign, which includes a set of
          #     conversion actions to optimize this campaign towards.
          # @!attribute [rw] optimization_goal_setting
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::OptimizationGoalSetting]
          #     Optimization goal setting for this campaign, which includes a set of
          #     optimization goal types.
          # @!attribute [r] tracking_setting
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Campaign::TrackingSetting]
          #     Output only. Campaign-level settings for tracking information.
          # @!attribute [rw] payment_mode
          #   @return [::Google::Ads::GoogleAds::V8::Enums::PaymentModeEnum::PaymentMode]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Enums::AssetFieldTypeEnum::AssetFieldType>]
          ...
          class Campaign
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V8::Enums::OptimizationGoalTypeEnum::OptimizationGoalType>]
            ...
            #   @return [::Google::Ads::GoogleAds::V8::Enums::PositiveGeoTargetTypeEnum::PositiveGeoTargetType]
            #     The setting used for positive geotargeting in this particular campaign.
            # @!attribute [rw] negative_geo_target_type
            #   @return [::Google::Ads::GoogleAds::V8::Enums::NegativeGeoTargetTypeEnum::NegativeGeoTargetType]
            ...
            #   @return [::Google::Ads::GoogleAds::V8::Enums::LocationSourceTypeEnum::LocationSourceType]
            ...
            #   @return [::Google::Ads::GoogleAds::V8::Enums::AppCampaignBiddingStrategyGoalTypeEnum::AppCampaignBiddingStrategyGoalType]
            ...
            #   @return [::Google::Ads::GoogleAds::V8::Enums::AppCampaignAppStoreEnum::AppCampaignAppStore]
            ...
            #   @return [::Google::Ads::GoogleAds::V8::Enums::VanityPharmaDisplayUrlModeEnum::VanityPharmaDisplayUrlMode]
            #     The display mode for vanity pharma URLs.
            # @!attribute [rw] vanity_pharma_text
            #   @return [::Google::Ads::GoogleAds::V8::Enums::VanityPharmaTextEnum::VanityPharmaText]
