...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::AdGroupCriterionService::Client#get_ad_group_criterion AdGroupCriterionService.GetAdGroupCriterion}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::AdGroupCriterionService::Client#mutate_ad_group_criteria AdGroupCriterionService.MutateAdGroupCriteria}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose criteria are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::AdGroupCriterionOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateAdGroupCriterionResult>]
