  ...
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::ConversionValueRuleService::Client#get_conversion_value_rule ConversionValueRuleService.GetConversionValueRule}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          #     Required. The resource name of the conversion value rule to fetch.
          class GetConversionValueRuleRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end

          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::ConversionValueRuleService::Client#mutate_conversion_value_rules ConversionValueRuleService.MutateConversionValueRules}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose conversion value rules are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::ConversionValueRuleOperation>]
          ...
          class MutateConversionValueRulesRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateConversionValueRuleResult>]
          ...
          class MutateConversionValueRulesResponse
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
