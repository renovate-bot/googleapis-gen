    ...
    module GoogleAds
      module V8
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Resources::KeywordPlanForecastPeriod]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::KeywordPlanForecastIntervalEnum::KeywordPlanForecastInterval]
          #     A future date range relative to the current date used for forecasting.
          # @!attribute [rw] date_range
          #   @return [::Google::Ads::GoogleAds::V8::Common::DateRange]
