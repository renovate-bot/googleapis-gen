    ...
    module GoogleAds
      module V8
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::CallTrackingDisplayLocationEnum::CallTrackingDisplayLocation]
          #     Output only. The call tracking display location.
          # @!attribute [r] type
          #   @return [::Google::Ads::GoogleAds::V8::Enums::CallTypeEnum::CallType]
          #     Output only. The type of the call.
          # @!attribute [r] call_status
          #   @return [::Google::Ads::GoogleAds::V8::Enums::GoogleVoiceCallStatusEnum::GoogleVoiceCallStatus]
