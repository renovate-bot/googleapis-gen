...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::UserDataService::Client#upload_user_data UserDataService.UploadUserData}
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer for which to update the user data.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::UserDataOperation>]
          #     Required. The list of operations to be done.
          # @!attribute [rw] customer_match_user_list_metadata
          #   @return [::Google::Ads::GoogleAds::V8::Common::CustomerMatchUserListMetadata]
          ...
          # @!attribute [rw] create
          #   @return [::Google::Ads::GoogleAds::V8::Common::UserData]
          ...
          # Response message for {::Google::Ads::GoogleAds::V8::Services::UserDataService::Client#upload_user_data UserDataService.UploadUserData}
