...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CustomerService::Client#get_customer CustomerService.GetCustomer}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CustomerService::Client#mutate_customer CustomerService.MutateCustomer}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CustomerService::Client#create_customer_client CustomerService.CreateCustomerClient}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CustomerService::Client#list_accessible_customers CustomerService.ListAccessibleCustomers}.
          class ListAccessibleCustomersRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end

          # Response message for {::Google::Ads::GoogleAds::V8::Services::CustomerService::Client#list_accessible_customers CustomerService.ListAccessibleCustomers}.
