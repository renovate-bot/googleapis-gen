    ...
    module GoogleAds
      module V8
        module Services
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Services::CustomerUserAccessInvitationOperation]
          ...
          # @!attribute [rw] result
          #   @return [::Google::Ads::GoogleAds::V8::Services::MutateCustomerUserAccessInvitationResult]
