    ...
    module GoogleAds
      module V8
        module Resources
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V8::Enums::FeedItemSetStatusEnum::FeedItemSetStatus]
          #     Output only. Status of the feed item set.
          #     This field is read-only.
          # @!attribute [rw] dynamic_location_set_filter
          #   @return [::Google::Ads::GoogleAds::V8::Common::DynamicLocationSetFilter]
          #     Filter for dynamic location set.
          #     It is only used for sets of locations.
          # @!attribute [rw] dynamic_affiliate_location_set_filter
          #   @return [::Google::Ads::GoogleAds::V8::Common::DynamicAffiliateLocationSetFilter]
