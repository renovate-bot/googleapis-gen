  ...
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::AccountBudgetProposalService::Client#get_account_budget_proposal AccountBudgetProposalService.GetAccountBudgetProposal}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::AccountBudgetProposalService::Client#mutate_account_budget_proposal AccountBudgetProposalService.MutateAccountBudgetProposal}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer.
          # @!attribute [rw] operation
          #   @return [::Google::Ads::GoogleAds::V8::Services::AccountBudgetProposalOperation]
          ...
          # @!attribute [rw] result
          #   @return [::Google::Ads::GoogleAds::V8::Services::MutateAccountBudgetProposalResult]
