  ...
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::BiddingSeasonalityAdjustmentService::Client#get_bidding_seasonality_adjustment BiddingSeasonalityAdjustmentService.GetBiddingSeasonalityAdjustment}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::BiddingSeasonalityAdjustmentService::Client#mutate_bidding_seasonality_adjustments BiddingSeasonalityAdjustmentService.MutateBiddingSeasonalityAdjustments}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose seasonality adjustments are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::BiddingSeasonalityAdjustmentOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateBiddingSeasonalityAdjustmentsResult>]
