    ...
    module GoogleAds
      module V8
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::UserInterestTaxonomyTypeEnum::UserInterestTaxonomyType]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::CriterionCategoryAvailability>]
