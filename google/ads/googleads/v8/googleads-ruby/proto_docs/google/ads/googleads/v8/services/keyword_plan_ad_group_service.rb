...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::KeywordPlanAdGroupService::Client#get_keyword_plan_ad_group KeywordPlanAdGroupService.GetKeywordPlanAdGroup}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::KeywordPlanAdGroupService::Client#mutate_keyword_plan_ad_groups KeywordPlanAdGroupService.MutateKeywordPlanAdGroups}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose Keyword Plan ad groups are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::KeywordPlanAdGroupOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateKeywordPlanAdGroupResult>]
