  ...
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::CustomerUserAccessService::Client#get_customer_user_access CustomerUserAccessService.GetCustomerUserAccess}.
          ...
          # Mutate Request for
          # {::Google::Ads::GoogleAds::V8::Services::CustomerUserAccessService::Client#mutate_customer_user_access CustomerUserAccessService.MutateCustomerUserAccess}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer being modified.
          # @!attribute [rw] operation
          #   @return [::Google::Ads::GoogleAds::V8::Services::CustomerUserAccessOperation]
          ...
          # @!attribute [rw] result
          #   @return [::Google::Ads::GoogleAds::V8::Services::MutateCustomerUserAccessResult]
