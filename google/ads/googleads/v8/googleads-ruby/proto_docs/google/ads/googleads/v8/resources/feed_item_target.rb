    ...
    module GoogleAds
      module V8
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::FeedItemTargetTypeEnum::FeedItemTargetType]
          ...
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V8::Enums::FeedItemTargetStatusEnum::FeedItemTargetStatus]
          ...
          # @!attribute [rw] device
          #   @return [::Google::Ads::GoogleAds::V8::Enums::FeedItemTargetDeviceEnum::FeedItemTargetDevice]
          #     Immutable. The targeted device.
          # @!attribute [rw] ad_schedule
          #   @return [::Google::Ads::GoogleAds::V8::Common::AdScheduleInfo]
