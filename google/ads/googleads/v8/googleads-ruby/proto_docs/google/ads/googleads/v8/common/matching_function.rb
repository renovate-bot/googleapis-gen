    ...
    module GoogleAds
      module V8
        module Common
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::MatchingFunctionOperatorEnum::MatchingFunctionOperator]
          #     Operator for a function.
          # @!attribute [rw] left_operands
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::Operand>]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Common::Operand::ConstantOperand]
          #     A constant operand in a matching function.
          # @!attribute [rw] feed_attribute_operand
          #   @return [::Google::Ads::GoogleAds::V8::Common::Operand::FeedAttributeOperand]
          #     This operand specifies a feed attribute in feed.
          # @!attribute [rw] function_operand
          #   @return [::Google::Ads::GoogleAds::V8::Common::Operand::FunctionOperand]
          #     A function operand in a matching function.
          #     Used to represent nested functions.
          # @!attribute [rw] request_context_operand
          #   @return [::Google::Ads::GoogleAds::V8::Common::Operand::RequestContextOperand]
          ...
          class Operand
            ...
            #   @return [::Google::Ads::GoogleAds::V8::Common::MatchingFunction]
            ...
            #   @return [::Google::Ads::GoogleAds::V8::Enums::MatchingFunctionContextTypeEnum::MatchingFunctionContextType]
