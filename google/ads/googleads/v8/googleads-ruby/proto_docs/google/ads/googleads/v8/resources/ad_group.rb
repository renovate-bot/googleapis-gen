    ...
    module GoogleAds
      module V8
        module Resources
          ...
          # @!attribute [rw] status
          #   @return [::Google::Ads::GoogleAds::V8::Enums::AdGroupStatusEnum::AdGroupStatus]
          #     The status of the ad group.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V8::Enums::AdGroupTypeEnum::AdGroupType]
          #     Immutable. The type of the ad group.
          # @!attribute [rw] ad_rotation_mode
          #   @return [::Google::Ads::GoogleAds::V8::Enums::AdGroupAdRotationModeEnum::AdGroupAdRotationMode]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Common::ExplorerAutoOptimizerSetting]
          #     Settings for the Display Campaign Optimizer, initially termed "Explorer".
          # @!attribute [rw] display_custom_bid_dimension
          #   @return [::Google::Ads::GoogleAds::V8::Enums::TargetingDimensionEnum::TargetingDimension]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Enums::BiddingSourceEnum::BiddingSource]
