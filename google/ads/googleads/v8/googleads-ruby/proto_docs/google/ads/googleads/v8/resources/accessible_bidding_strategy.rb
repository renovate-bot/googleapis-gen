    ...
    module GoogleAds
      module V8
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Resources::AccessibleBiddingStrategy::MaximizeConversionValue]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Resources::AccessibleBiddingStrategy::MaximizeConversions]
          #     Output only. An automated bidding strategy to help get the most conversions for your
          #     campaigns while spending your budget.
          # @!attribute [r] target_cpa
          #   @return [::Google::Ads::GoogleAds::V8::Resources::AccessibleBiddingStrategy::TargetCpa]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Resources::AccessibleBiddingStrategy::TargetImpressionShare]
          #     Output only. A bidding strategy that automatically optimizes towards a desired
          #     percentage of impressions.
          # @!attribute [r] target_roas
          #   @return [::Google::Ads::GoogleAds::V8::Resources::AccessibleBiddingStrategy::TargetRoas]
          #     Output only. A bidding strategy that helps you maximize revenue while averaging a
          #     specific target Return On Ad Spend (ROAS).
          # @!attribute [r] target_spend
          #   @return [::Google::Ads::GoogleAds::V8::Resources::AccessibleBiddingStrategy::TargetSpend]
