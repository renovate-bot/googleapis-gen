...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CampaignBidModifierService::Client#get_campaign_bid_modifier CampaignBidModifierService.GetCampaignBidModifier}.
          ...
          # Request message for
          # {::Google::Ads::GoogleAds::V8::Services::CampaignBidModifierService::Client#mutate_campaign_bid_modifiers CampaignBidModifierService.MutateCampaignBidModifiers}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose campaign bid modifiers are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::CampaignBidModifierOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateCampaignBidModifierResult>]
