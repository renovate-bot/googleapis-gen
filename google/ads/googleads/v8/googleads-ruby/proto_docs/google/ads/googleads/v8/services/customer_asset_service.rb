...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CustomerAssetService::Client#get_customer_asset CustomerAssetService.GetCustomerAsset}.
          # @!attribute [rw] resource_name
          #   @return [::String]
          #     Required. The resource name of the customer asset to fetch.
          class GetCustomerAssetRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end

          # Request message for {::Google::Ads::GoogleAds::V8::Services::CustomerAssetService::Client#mutate_customer_assets CustomerAssetService.MutateCustomerAssets}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. The ID of the customer whose customer assets are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::CustomerAssetOperation>]
          ...
          class MutateCustomerAssetsRequest
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateCustomerAssetResult>]
          #     All results for the mutate.
          class MutateCustomerAssetsResponse
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #     to "MUTABLE_RESOURCE".
          class MutateCustomerAssetResult
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
        end
