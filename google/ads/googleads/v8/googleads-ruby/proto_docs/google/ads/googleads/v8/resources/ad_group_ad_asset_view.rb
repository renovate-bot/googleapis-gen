    ...
    module GoogleAds
      module V8
        module Resources
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Resources::AdGroupAdAssetPolicySummary]
          #     Output only. Policy information for the ad group ad asset.
          # @!attribute [r] performance_label
          #   @return [::Google::Ads::GoogleAds::V8::Enums::AssetPerformanceLabelEnum::AssetPerformanceLabel]
