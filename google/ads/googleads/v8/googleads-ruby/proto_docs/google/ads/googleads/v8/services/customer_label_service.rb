...
module Google
  module Ads
    module GoogleAds
      module V8
        module Services
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CustomerLabelService::Client#get_customer_label CustomerLabelService.GetCustomerLabel}.
          ...
          # Request message for {::Google::Ads::GoogleAds::V8::Services::CustomerLabelService::Client#mutate_customer_labels CustomerLabelService.MutateCustomerLabels}.
          # @!attribute [rw] customer_id
          #   @return [::String]
          #     Required. ID of the customer whose customer-label relationships are being modified.
          # @!attribute [rw] operations
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::CustomerLabelOperation>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Services::MutateCustomerLabelResult>]
