    ...
    module GoogleAds
      module V8
        module Common
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::PolicyViolationKey>]
          ...
          #     at any time.
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V8::Enums::PolicyTopicEntryTypeEnum::PolicyTopicEntryType]
          #     Describes the negative or positive effect this policy will have on serving.
          # @!attribute [rw] evidences
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::PolicyTopicEvidence>]
          #     Additional information that explains policy finding
          #     (e.g. the brand name for a trademark finding).
          # @!attribute [rw] constraints
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::PolicyTopicConstraint>]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Common::PolicyTopicEvidence::WebsiteList]
          #     List of websites linked with this resource.
          # @!attribute [rw] text_list
          #   @return [::Google::Ads::GoogleAds::V8::Common::PolicyTopicEvidence::TextList]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Common::PolicyTopicEvidence::DestinationTextList]
          #     The text in the destination of the resource that is causing a policy
          #     finding.
          # @!attribute [rw] destination_mismatch
          #   @return [::Google::Ads::GoogleAds::V8::Common::PolicyTopicEvidence::DestinationMismatch]
          #     Mismatch between the destinations of a resource's URLs.
          # @!attribute [rw] destination_not_working
          #   @return [::Google::Ads::GoogleAds::V8::Common::PolicyTopicEvidence::DestinationNotWorking]
          ...
          class PolicyTopicEvidence
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V8::Enums::PolicyTopicEvidenceDestinationMismatchUrlTypeEnum::PolicyTopicEvidenceDestinationMismatchUrlType>]
            ...
            # @!attribute [rw] device
            #   @return [::Google::Ads::GoogleAds::V8::Enums::PolicyTopicEvidenceDestinationNotWorkingDeviceEnum::PolicyTopicEvidenceDestinationNotWorkingDevice]
            ...
            #   @return [::Google::Ads::GoogleAds::V8::Enums::PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum::PolicyTopicEvidenceDestinationNotWorkingDnsErrorType]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Common::PolicyTopicConstraint::CountryConstraintList]
          #     Countries where the resource cannot serve.
          # @!attribute [rw] reseller_constraint
          #   @return [::Google::Ads::GoogleAds::V8::Common::PolicyTopicConstraint::ResellerConstraint]
          #     Reseller constraint.
          ...
          class PolicyTopicConstraint
            ...
            #   @return [::Array<::Google::Ads::GoogleAds::V8::Common::PolicyTopicConstraint::CountryConstraint>]
