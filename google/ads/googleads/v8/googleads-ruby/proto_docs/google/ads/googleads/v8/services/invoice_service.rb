    ...
    module GoogleAds
      module V8
        module Services
          ...
          # Response message for {::Google::Ads::GoogleAds::V8::Services::InvoiceService::Client#list_invoices InvoiceService.ListInvoices}.
          # @!attribute [rw] invoices
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Resources::Invoice>]
