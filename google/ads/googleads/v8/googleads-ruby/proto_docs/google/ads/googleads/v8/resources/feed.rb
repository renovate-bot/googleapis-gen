    ...
    module GoogleAds
      module V8
        module Resources
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Resources::FeedAttribute>]
          ...
          #   @return [::Array<::Google::Ads::GoogleAds::V8::Resources::FeedAttributeOperation>]
          #     The list of operations changing the feed attributes. Attributes can only
          #     be added, not removed.
          # @!attribute [rw] origin
          #   @return [::Google::Ads::GoogleAds::V8::Enums::FeedOriginEnum::FeedOrigin]
          #     Immutable. Specifies who manages the FeedAttributes for the Feed.
          # @!attribute [r] status
          #   @return [::Google::Ads::GoogleAds::V8::Enums::FeedStatusEnum::FeedStatus]
          #     Output only. Status of the feed.
          #     This field is read-only.
          # @!attribute [rw] places_location_feed_data
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Feed::PlacesLocationFeedData]
          #     Data used to configure a location feed populated from Business Profile.
          # @!attribute [rw] affiliate_location_feed_data
          #   @return [::Google::Ads::GoogleAds::V8::Resources::Feed::AffiliateLocationFeedData]
          ...
          class Feed
            ...
            #   @return [::Google::Ads::GoogleAds::V8::Resources::Feed::PlacesLocationFeedData::OAuthInfo]
            ...
            #   @return [::Google::Ads::GoogleAds::V8::Enums::AffiliateLocationFeedRelationshipTypeEnum::AffiliateLocationFeedRelationshipType]
          ...
          # @!attribute [rw] type
          #   @return [::Google::Ads::GoogleAds::V8::Enums::FeedAttributeTypeEnum::FeedAttributeType]
          ...
          #   @return [::Google::Ads::GoogleAds::V8::Resources::FeedAttributeOperation::Operator]
          #     Output only. Type of list operation to perform.
          # @!attribute [r] value
          #   @return [::Google::Ads::GoogleAds::V8::Resources::FeedAttribute]
