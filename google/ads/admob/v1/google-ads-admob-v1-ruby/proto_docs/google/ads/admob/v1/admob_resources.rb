  ...
  module Ads
    module Admob
      module V1
        ...
        #   @return [::Google::Protobuf::Map{::String => ::Google::Ads::Admob::V1::ReportRow::DimensionValue}]
        #     Map of dimension values in a row, with keys as enum name of the dimensions.
        # @!attribute [rw] metric_values
        #   @return [::Google::Protobuf::Map{::String => ::Google::Ads::Admob::V1::ReportRow::MetricValue}]
        ...
        class ReportRow
          ...
          #   @return [::String]
          # @!attribute [rw] value
          #   @return [::Google::Ads::Admob::V1::ReportRow::DimensionValue]
          class DimensionValuesEntry
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          #   @return [::String]
          # @!attribute [rw] value
          #   @return [::Google::Ads::Admob::V1::ReportRow::MetricValue]
          class MetricValuesEntry
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
        end
