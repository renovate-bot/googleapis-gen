...
class AdMobApiClientMeta(type):
    """Metaclass for the AdMobApi client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AdMobApiTransport]]
    _transport_registry["grpc"] = AdMobApiGrpcTransport
    _transport_registry["grpc_asyncio"] = AdMobApiGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: str = None,
        ) -> Type[AdMobApiTransport]:
...
class AdMobApiClient(metaclass=AdMobApiClientMeta):
    ...
    DEFAULT_ENDPOINT = "admob.googleapis.com"
    ...
    def transport(self) -> AdMobApiTransport:
        ...
        Returns:
            AdMobApiTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def publisher_account_path(publisher: str,) -> str:
        """Returns a fully-qualified publisher_account string."""
        return "accounts/{publisher}".format(publisher=publisher, )

    @staticmethod
    def parse_publisher_account_path(path: str) -> Dict[str,str]:
        """Parses a publisher_account path into its component segments."""
        m = re.match(r"^accounts/(?P<publisher>.+?)$", path)
    ...
    def __init__(self, *,
            ...
            transport: Union[str, AdMobApiTransport, None] = None,
        ...
        if isinstance(transport, AdMobApiTransport):
            # transport is a AdMobApiTransport instance.
    ...
    def get_publisher_account(self,
        ...
        # in a admob_api.GetPublisherAccountRequest.
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_publisher_account]
    ...
    def list_publisher_accounts(self,
        ...
        Returns:
            google.ads.admob_v1.services.ad_mob_api.pagers.ListPublisherAccountsPager:
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, admob_api.ListPublisherAccountsRequest):
            request = admob_api.ListPublisherAccountsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_publisher_accounts]
        ...
        response = pagers.ListPublisherAccountsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def generate_network_report(self,
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, admob_api.GenerateNetworkReportRequest):
            request = admob_api.GenerateNetworkReportRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_network_report]
    ...
    def generate_mediation_report(self,
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, admob_api.GenerateMediationReportRequest):
            request = admob_api.GenerateMediationReportRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_mediation_report]
