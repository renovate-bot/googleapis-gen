...
class AdMobApiClientTest extends GeneratedTest
{
    ...
    public function getPublisherAccountTest()
    {
        ...
        $response = $client->getPublisherAccount($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admob.v1.AdMobApi/GetPublisherAccount', $actualFuncCall);
    ...
    public function listPublisherAccountsTest()
    {
        ...
        // Mock response
        $nextPageToken = '';
        $accountElement = new PublisherAccount();
        $account = [$accountElement];
        $expectedResponse = new ListPublisherAccountsResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setAccount($account);
        $transport->addResponse($expectedResponse);

        $response = $client->listPublisherAccounts();
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getAccount()[0], $resources[0]);

        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admob.v1.AdMobApi/ListPublisherAccounts', $actualFuncCall);
    ...
    public function generateNetworkReportTest()
    {
        ...
        // Mock response
        $expectedResponse = new GenerateNetworkReportResponse();
        $transport->addResponse($expectedResponse);
        $expectedResponse2 = new GenerateNetworkReportResponse();
        $transport->addResponse($expectedResponse2);
        $expectedResponse3 = new GenerateNetworkReportResponse();
        ...
        $serverStream = $client->generateNetworkReport($formattedParent, $reportSpec);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admob.v1.AdMobApi/GenerateNetworkReport', $actualFuncCall);

        $actualValue = $actualRequestObject->getParent();

        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getReportSpec();

        $this->assertProtobufEquals($reportSpec, $actualValue);
    ...
    public function generateMediationReportTest()
    {
        ...
        // Mock response
        $expectedResponse = new GenerateMediationReportResponse();
        $transport->addResponse($expectedResponse);
        $expectedResponse2 = new GenerateMediationReportResponse();
        $transport->addResponse($expectedResponse2);
        $expectedResponse3 = new GenerateMediationReportResponse();
        $transport->addResponse($expectedResponse3);
        ...
        $serverStream = $client->generateMediationReport($formattedParent, $reportSpec);
        $this->assertInstanceOf(ServerStream::class, $serverStream);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admob.v1.AdMobApi/GenerateMediationReport', $actualFuncCall);
