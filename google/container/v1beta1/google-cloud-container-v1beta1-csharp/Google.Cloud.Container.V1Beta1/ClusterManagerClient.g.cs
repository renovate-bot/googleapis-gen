...
namespace Google.Cloud.Container.V1Beta1
{
    ...
    public sealed partial class ClusterManagerSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListUsableSubnetworksSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(20000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 5, initialBackoff: sys::TimeSpan.FromMilliseconds(100), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable, grpccore::StatusCode.DeadlineExceeded)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>ClusterManagerClient.ListLocations</c> and <c>ClusterManagerClient.ListLocationsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListLocationsSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(20000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 5, initialBackoff: sys::TimeSpan.FromMilliseconds(100), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable, grpccore::StatusCode.DeadlineExceeded)));
    ...
    public abstract partial class ClusterManagerClient
    {
        ...
        public virtual Operation SetLabels(string projectId, string zone, string clusterId, scg::IDictionary<string, string> resourceLabels, string labelFingerprint, gaxgrpc::CallSettings callSettings = null) =>
            SetLabels(new SetLabelsRequest
            {
                ...
                LabelFingerprint = gax::GaxPreconditions.CheckNotNullOrEmpty(labelFingerprint, nameof(labelFingerprint)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="UsableSubnetwork"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListUsableSubnetworksResponse, UsableSubnetwork> ListUsableSubnetworks(string parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListUsableSubnetworks(new ListUsableSubnetworksRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="UsableSubnetwork"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListUsableSubnetworksResponse, UsableSubnetwork> ListUsableSubnetworksAsync(string parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListUsableSubnetworksAsync(new ListUsableSubnetworksRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                PageToken = pageToken ?? "",
                PageSize = pageSize ?? 0,
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ListLocationsResponse ListLocations(ListLocationsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListLocationsResponse> ListLocationsAsync(ListLocationsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListLocationsResponse> ListLocationsAsync(ListLocationsRequest request, st::CancellationToken cancellationToken) =>
            ListLocationsAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ListLocationsResponse ListLocations(string parent, gaxgrpc::CallSettings callSettings = null) =>
            ListLocations(new ListLocationsRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListLocationsResponse> ListLocationsAsync(string parent, gaxgrpc::CallSettings callSettings = null) =>
            ListLocationsAsync(new ListLocationsRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListLocationsResponse> ListLocationsAsync(string parent, st::CancellationToken cancellationToken) =>
            ListLocationsAsync(parent, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
...
#pragma warning restore CS0612
            ...
            _callListLocations = clientHelper.BuildApiCall<ListLocationsRequest, ListLocationsResponse>(grpcClient.ListLocationsAsync, grpcClient.ListLocations, effectiveSettings.ListLocationsSettings).WithGoogleRequestParam("parent", request => request.Parent);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override ListLocationsResponse ListLocations(ListLocationsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListLocationsRequest(ref request, ref callSettings);
            return _callListLocations.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<ListLocationsResponse> ListLocationsAsync(ListLocationsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListLocationsRequest(ref request, ref callSettings);
            return _callListLocations.Async(request, callSettings);
        }
    }
