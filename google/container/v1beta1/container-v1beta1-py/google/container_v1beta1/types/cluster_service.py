...
class LinuxNodeConfig(proto.Message):
    ...
    Attributes:
        sysctls (Sequence[google.container_v1beta1.types.LinuxNodeConfig.SysctlsEntry]):
...
class NodeKubeletConfig(proto.Message):
    ...
    cpu_cfs_quota = proto.Field(proto.MESSAGE, number=2,
...
class NodeConfig(proto.Message):
    ...
    Attributes:
        ...
        metadata (Sequence[google.container_v1beta1.types.NodeConfig.MetadataEntry]):
        ...
        image_type (str):
            ...
            of it will be used.
        labels (Sequence[google.container_v1beta1.types.NodeConfig.LabelsEntry]):
        ...
        preemptible (bool):
            ...
            instances.
        accelerators (Sequence[google.container_v1beta1.types.AcceleratorConfig]):
        ...
        sandbox_config (google.container_v1beta1.types.SandboxConfig):
        ...
        reservation_affinity (google.container_v1beta1.types.ReservationAffinity):
        ...
        workload_metadata_config (google.container_v1beta1.types.WorkloadMetadataConfig):
            The workload metadata configuration for this
            node.
        taints (Sequence[google.container_v1beta1.types.NodeTaint]):
        ...
        shielded_instance_config (google.container_v1beta1.types.ShieldedInstanceConfig):
            Shielded Instance options.
        linux_node_config (google.container_v1beta1.types.LinuxNodeConfig):
            Parameters that can be configured on Linux
            nodes.
        kubelet_config (google.container_v1beta1.types.NodeKubeletConfig):
            Node kubelet configs.
        ephemeral_storage_config (google.container_v1beta1.types.EphemeralStorageConfig):
    ...
    accelerators = proto.RepeatedField(proto.MESSAGE, number=11,
        message='AcceleratorConfig',
    )

    sandbox_config = proto.Field(proto.MESSAGE, number=17,
        message='SandboxConfig',
    )

    node_group = proto.Field(proto.STRING, number=18)

    reservation_affinity = proto.Field(proto.MESSAGE, number=19,
    ...
    workload_metadata_config = proto.Field(proto.MESSAGE, number=14,
        message='WorkloadMetadataConfig',
    )

    taints = proto.RepeatedField(proto.MESSAGE, number=15,
        message='NodeTaint',
    )

    boot_disk_kms_key = proto.Field(proto.STRING, number=23)

    shielded_instance_config = proto.Field(proto.MESSAGE, number=20,
        message='ShieldedInstanceConfig',
    )

    linux_node_config = proto.Field(proto.MESSAGE, number=21,
        message='LinuxNodeConfig',
    )

    kubelet_config = proto.Field(proto.MESSAGE, number=22,
        message='NodeKubeletConfig',
    )

    ephemeral_storage_config = proto.Field(proto.MESSAGE, number=24,
...
class SandboxConfig(proto.Message):
    ...
    Attributes:
        sandbox_type (str):
            ...
            'gvisor')
        type_ (google.container_v1beta1.types.SandboxConfig.Type):
...
class ReservationAffinity(proto.Message):
    ...
    Attributes:
        consume_reservation_type (google.container_v1beta1.types.ReservationAffinity.Type):
    ...
    consume_reservation_type = proto.Field(proto.ENUM, number=1,
        enum=Type,
    )
...
class NodeTaint(proto.Message):
    ...
    Attributes:
        ...
        value (str):
            Value for taint.
        effect (google.container_v1beta1.types.NodeTaint.Effect):
            Effect for taint.
    """
    ...
    effect = proto.Field(proto.ENUM, number=3,
        enum=Effect,
    )
...
class MasterAuth(proto.Message):
    ...
    Attributes:
        ...
        password (str):
            ...
            https://cloud.google.com/kubernetes-
            engine/docs/how-to/api-server-authentication
        client_certificate_config (google.container_v1beta1.types.ClientCertificateConfig):
    ...
    client_certificate_config = proto.Field(proto.MESSAGE, number=3,
...
class AddonsConfig(proto.Message):
    ...
    Attributes:
        http_load_balancing (google.container_v1beta1.types.HttpLoadBalancing):
            ...
            cluster.
        horizontal_pod_autoscaling (google.container_v1beta1.types.HorizontalPodAutoscaling):
        ...
        kubernetes_dashboard (google.container_v1beta1.types.KubernetesDashboard):
        ...
        network_policy_config (google.container_v1beta1.types.NetworkPolicyConfig):
        ...
        istio_config (google.container_v1beta1.types.IstioConfig):
            Configuration for Istio, an open platform to
            connect, manage, and secure microservices.
        cloud_run_config (google.container_v1beta1.types.CloudRunConfig):
        ...
        dns_cache_config (google.container_v1beta1.types.DnsCacheConfig):
            Configuration for NodeLocalDNS, a dns cache
            running on cluster nodes
        config_connector_config (google.container_v1beta1.types.ConfigConnectorConfig):
        ...
        gce_persistent_disk_csi_driver_config (google.container_v1beta1.types.GcePersistentDiskCsiDriverConfig):
            Configuration for the Compute Engine
            Persistent Disk CSI driver.
        kalm_config (google.container_v1beta1.types.KalmConfig):
            Configuration for the KALM addon, which
            manages the lifecycle of k8s applications.
    """

    http_load_balancing = proto.Field(proto.MESSAGE, number=1,
        message='HttpLoadBalancing',
    )

    horizontal_pod_autoscaling = proto.Field(proto.MESSAGE, number=2,
        message='HorizontalPodAutoscaling',
    )

    kubernetes_dashboard = proto.Field(proto.MESSAGE, number=3,
        message='KubernetesDashboard',
    )

    network_policy_config = proto.Field(proto.MESSAGE, number=4,
        message='NetworkPolicyConfig',
    )

    istio_config = proto.Field(proto.MESSAGE, number=5,
        message='IstioConfig',
    )

    cloud_run_config = proto.Field(proto.MESSAGE, number=7,
        message='CloudRunConfig',
    )

    dns_cache_config = proto.Field(proto.MESSAGE, number=8,
        message='DnsCacheConfig',
    )

    config_connector_config = proto.Field(proto.MESSAGE, number=10,
        message='ConfigConnectorConfig',
    )

    gce_persistent_disk_csi_driver_config = proto.Field(proto.MESSAGE, number=11,
        message='GcePersistentDiskCsiDriverConfig',
    )

    kalm_config = proto.Field(proto.MESSAGE, number=12,
        message='KalmConfig',
    )
...
class PrivateClusterConfig(proto.Message):
    ...
    Attributes:
        ...
        master_global_access_config (google.container_v1beta1.types.PrivateClusterMasterGlobalAccessConfig):
    ...
    master_global_access_config = proto.Field(proto.MESSAGE, number=8,
...
class CloudRunConfig(proto.Message):
    ...
    Attributes:
        disabled (bool):
            ...
            cluster.
        load_balancer_type (google.container_v1beta1.types.CloudRunConfig.LoadBalancerType):
    ...
    load_balancer_type = proto.Field(proto.ENUM, number=3,
...
class MasterAuthorizedNetworksConfig(proto.Message):
    ...
    Attributes:
        enabled (bool):
            ...
            enabled.
        cidr_blocks (Sequence[google.container_v1beta1.types.MasterAuthorizedNetworksConfig.CidrBlock]):
    ...
    cidr_blocks = proto.RepeatedField(proto.MESSAGE, number=2,
        message=CidrBlock,
    )
...
class NetworkPolicy(proto.Message):
    ...
    Attributes:
        provider (google.container_v1beta1.types.NetworkPolicy.Provider):
    ...
    provider = proto.Field(proto.ENUM, number=1,
        enum=Provider,
    )
...
class ClusterTelemetry(proto.Message):
    ...
    Attributes:
        type_ (google.container_v1beta1.types.ClusterTelemetry.Type):
...
class Cluster(proto.Message):
    ...
    Attributes:
        ...
        initial_node_count (int):
            ...
            instead.
        node_config (google.container_v1beta1.types.NodeConfig):
        ...
        master_auth (google.container_v1beta1.types.MasterAuth):
        ...
        node_pools (Sequence[google.container_v1beta1.types.NodePool]):
        ...
        enable_kubernetes_alpha (bool):
            ...
            after creation.
        resource_labels (Sequence[google.container_v1beta1.types.Cluster.ResourceLabelsEntry]):
        ...
        label_fingerprint (str):
            ...
            cluster.
        legacy_abac (google.container_v1beta1.types.LegacyAbac):
            Configuration for the legacy ABAC
            authorization mode.
        network_policy (google.container_v1beta1.types.NetworkPolicy):
            Configuration options for the NetworkPolicy
            feature.
        ip_allocation_policy (google.container_v1beta1.types.IPAllocationPolicy):
            Configuration for cluster IP allocation.
        master_authorized_networks_config (google.container_v1beta1.types.MasterAuthorizedNetworksConfig):
            The configuration options for master
            authorized networks feature.
        maintenance_policy (google.container_v1beta1.types.MaintenancePolicy):
            Configure the maintenance policy for this
            cluster.
        binary_authorization (google.container_v1beta1.types.BinaryAuthorization):
            Configuration for Binary Authorization.
        pod_security_policy_config (google.container_v1beta1.types.PodSecurityPolicyConfig):
            Configuration for the PodSecurityPolicy
            feature.
        autoscaling (google.container_v1beta1.types.ClusterAutoscaling):
            Cluster-level autoscaling configuration.
        network_config (google.container_v1beta1.types.NetworkConfig):
        ...
        default_max_pods_constraint (google.container_v1beta1.types.MaxPodsConstraint):
        ...
        resource_usage_export_config (google.container_v1beta1.types.ResourceUsageExportConfig):
            Configuration for exporting resource usages.
            Resource usage export is disabled when this
            config unspecified.
        authenticator_groups_config (google.container_v1beta1.types.AuthenticatorGroupsConfig):
            Configuration controlling RBAC group
            membership information.
        private_cluster_config (google.container_v1beta1.types.PrivateClusterConfig):
            Configuration for private cluster.
        vertical_pod_autoscaling (google.container_v1beta1.types.VerticalPodAutoscaling):
            Cluster-level Vertical Pod Autoscaling
            configuration.
        shielded_nodes (google.container_v1beta1.types.ShieldedNodes):
            Shielded Nodes configuration.
        release_channel (google.container_v1beta1.types.ReleaseChannel):
            Release channel configuration.
        workload_identity_config (google.container_v1beta1.types.WorkloadIdentityConfig):
            Configuration for the use of Kubernetes
            Service Accounts in GCP IAM policies.
        cluster_telemetry (google.container_v1beta1.types.ClusterTelemetry):
            Telemetry integration for the cluster.
        tpu_config (google.container_v1beta1.types.TpuConfig):
            Configuration for Cloud TPU support;
        notification_config (google.container_v1beta1.types.NotificationConfig):
            Notification configuration of the cluster.
        confidential_nodes (google.container_v1beta1.types.ConfidentialNodes):
        ...
        create_time (str):
            ...
            format.
        status (google.container_v1beta1.types.Cluster.Status):
        ...
        database_encryption (google.container_v1beta1.types.DatabaseEncryption):
            Configuration of etcd encryption.
        conditions (Sequence[google.container_v1beta1.types.StatusCondition]):
            Which conditions caused the current cluster
            state.
        master (google.container_v1beta1.types.Master):
    ...
    node_config = proto.Field(proto.MESSAGE, number=4,
        message='NodeConfig',
    )

    master_auth = proto.Field(proto.MESSAGE, number=5,
        message='MasterAuth',
    )
    ...
    addons_config = proto.Field(proto.MESSAGE, number=10,
        message='AddonsConfig',
    )

    subnetwork = proto.Field(proto.STRING, number=11)

    node_pools = proto.RepeatedField(proto.MESSAGE, number=12,
        message='NodePool',
    )
    ...
    legacy_abac = proto.Field(proto.MESSAGE, number=18,
        message='LegacyAbac',
    )

    network_policy = proto.Field(proto.MESSAGE, number=19,
        message='NetworkPolicy',
    )

    ip_allocation_policy = proto.Field(proto.MESSAGE, number=20,
        message='IPAllocationPolicy',
    )

    master_authorized_networks_config = proto.Field(proto.MESSAGE, number=22,
        message='MasterAuthorizedNetworksConfig',
    )

    maintenance_policy = proto.Field(proto.MESSAGE, number=23,
        message='MaintenancePolicy',
    )

    binary_authorization = proto.Field(proto.MESSAGE, number=24,
        message='BinaryAuthorization',
    )

    pod_security_policy_config = proto.Field(proto.MESSAGE, number=25,
        message='PodSecurityPolicyConfig',
    )

    autoscaling = proto.Field(proto.MESSAGE, number=26,
        message='ClusterAutoscaling',
    )

    network_config = proto.Field(proto.MESSAGE, number=27,
    ...
    default_max_pods_constraint = proto.Field(proto.MESSAGE, number=30,
        message='MaxPodsConstraint',
    )

    resource_usage_export_config = proto.Field(proto.MESSAGE, number=33,
        message='ResourceUsageExportConfig',
    )

    authenticator_groups_config = proto.Field(proto.MESSAGE, number=34,
        message='AuthenticatorGroupsConfig',
    )

    private_cluster_config = proto.Field(proto.MESSAGE, number=37,
        message='PrivateClusterConfig',
    )

    vertical_pod_autoscaling = proto.Field(proto.MESSAGE, number=39,
        message='VerticalPodAutoscaling',
    )

    shielded_nodes = proto.Field(proto.MESSAGE, number=40,
        message='ShieldedNodes',
    )

    release_channel = proto.Field(proto.MESSAGE, number=41,
        message='ReleaseChannel',
    )

    workload_identity_config = proto.Field(proto.MESSAGE, number=43,
        message='WorkloadIdentityConfig',
    )

    cluster_telemetry = proto.Field(proto.MESSAGE, number=46,
        message='ClusterTelemetry',
    )

    tpu_config = proto.Field(proto.MESSAGE, number=47,
        message='TpuConfig',
    )

    notification_config = proto.Field(proto.MESSAGE, number=49,
        message='NotificationConfig',
    )

    confidential_nodes = proto.Field(proto.MESSAGE, number=50,
    ...
    status = proto.Field(proto.ENUM, number=107,
        enum=Status,
    )
    ...
    database_encryption = proto.Field(proto.MESSAGE, number=38,
        message='DatabaseEncryption',
    )

    conditions = proto.RepeatedField(proto.MESSAGE, number=118,
        message='StatusCondition',
    )

    master = proto.Field(proto.MESSAGE, number=124,
        message='Master',
    )
...
class ClusterUpdate(proto.Message):
    ...
    Attributes:
        ...
        desired_monitoring_service (str):
            ...
            used for GKE 1.14+ or ``monitoring.googleapis.com`` for
            earlier versions.
        desired_addons_config (google.container_v1beta1.types.AddonsConfig):
            Configurations for the various addons
            available to run in the cluster.
        ...
        desired_node_pool_autoscaling (google.container_v1beta1.types.NodePoolAutoscaling):
        ...
        desired_master_authorized_networks_config (google.container_v1beta1.types.MasterAuthorizedNetworksConfig):
            The desired configuration options for master
            authorized networks feature.
        desired_pod_security_policy_config (google.container_v1beta1.types.PodSecurityPolicyConfig):
            The desired configuration options for the
            PodSecurityPolicy feature.
        desired_cluster_autoscaling (google.container_v1beta1.types.ClusterAutoscaling):
            Cluster-level autoscaling configuration.
        desired_binary_authorization (google.container_v1beta1.types.BinaryAuthorization):
            The desired configuration options for the
        ...
        desired_logging_service (str):
            ...
            for GKE 1.14+ or ``logging.googleapis.com`` for earlier
            versions.
        desired_resource_usage_export_config (google.container_v1beta1.types.ResourceUsageExportConfig):
            The desired configuration for exporting
            resource usage.
        desired_vertical_pod_autoscaling (google.container_v1beta1.types.VerticalPodAutoscaling):
            Cluster-level Vertical Pod Autoscaling
            configuration.
        desired_private_cluster_config (google.container_v1beta1.types.PrivateClusterConfig):
            The desired private cluster configuration.
        desired_intra_node_visibility_config (google.container_v1beta1.types.IntraNodeVisibilityConfig):
            The desired config of Intra-node visibility.
        desired_default_snat_status (google.container_v1beta1.types.DefaultSnatStatus):
            The desired status of whether to disable
            default sNAT for this cluster.
        desired_cluster_telemetry (google.container_v1beta1.types.ClusterTelemetry):
            The desired telemetry integration for the
            cluster.
        desired_release_channel (google.container_v1beta1.types.ReleaseChannel):
            The desired release channel configuration.
        desired_tpu_config (google.container_v1beta1.types.TpuConfig):
            The desired Cloud TPU configuration.
        desired_datapath_provider (google.container_v1beta1.types.DatapathProvider):
            The desired datapath provider for the
            cluster.
        desired_notification_config (google.container_v1beta1.types.NotificationConfig):
        ...
        desired_master_version (str):
            ...
            Kubernetes version - "-": picks the default
            Kubernetes version
        desired_database_encryption (google.container_v1beta1.types.DatabaseEncryption):
            Configuration of etcd encryption.
        desired_workload_identity_config (google.container_v1beta1.types.WorkloadIdentityConfig):
            Configuration for Workload Identity.
        desired_shielded_nodes (google.container_v1beta1.types.ShieldedNodes):
    ...
    desired_addons_config = proto.Field(proto.MESSAGE, number=6,
        message='AddonsConfig',
    )
    ...
    desired_node_pool_autoscaling = proto.Field(proto.MESSAGE, number=9,
        message='NodePoolAutoscaling',
    )

    desired_locations = proto.RepeatedField(proto.STRING, number=10)

    desired_master_authorized_networks_config = proto.Field(proto.MESSAGE, number=12,
        message='MasterAuthorizedNetworksConfig',
    )

    desired_pod_security_policy_config = proto.Field(proto.MESSAGE, number=14,
        message='PodSecurityPolicyConfig',
    )

    desired_cluster_autoscaling = proto.Field(proto.MESSAGE, number=15,
        message='ClusterAutoscaling',
    )

    desired_binary_authorization = proto.Field(proto.MESSAGE, number=16,
        message='BinaryAuthorization',
    )

    desired_logging_service = proto.Field(proto.STRING, number=19)

    desired_resource_usage_export_config = proto.Field(proto.MESSAGE, number=21,
        message='ResourceUsageExportConfig',
    )

    desired_vertical_pod_autoscaling = proto.Field(proto.MESSAGE, number=22,
        message='VerticalPodAutoscaling',
    )

    desired_private_cluster_config = proto.Field(proto.MESSAGE, number=25,
        message='PrivateClusterConfig',
    )

    desired_intra_node_visibility_config = proto.Field(proto.MESSAGE, number=26,
        message='IntraNodeVisibilityConfig',
    )

    desired_default_snat_status = proto.Field(proto.MESSAGE, number=28,
        message='DefaultSnatStatus',
    )

    desired_cluster_telemetry = proto.Field(proto.MESSAGE, number=30,
        message='ClusterTelemetry',
    )

    desired_release_channel = proto.Field(proto.MESSAGE, number=31,
        message='ReleaseChannel',
    )

    desired_tpu_config = proto.Field(proto.MESSAGE, number=38,
        message='TpuConfig',
    )

    desired_datapath_provider = proto.Field(proto.ENUM, number=50,
        enum='DatapathProvider',
    )

    desired_notification_config = proto.Field(proto.MESSAGE, number=55,
        message='NotificationConfig',
    )

    desired_master_version = proto.Field(proto.STRING, number=100)

    desired_database_encryption = proto.Field(proto.MESSAGE, number=46,
        message='DatabaseEncryption',
    )

    desired_workload_identity_config = proto.Field(proto.MESSAGE, number=47,
        message='WorkloadIdentityConfig',
    )

    desired_shielded_nodes = proto.Field(proto.MESSAGE, number=48,
        message='ShieldedNodes',
    )

    desired_master = proto.Field(proto.MESSAGE, number=52,
        message='Master',
    )
...
class Operation(proto.Message):
    ...
    Attributes:
        ...
        operation_type (google.container_v1beta1.types.Operation.Type):
            The operation type.
        status (google.container_v1beta1.types.Operation.Status):
        ...
        end_time (str):
            ...
            `RFC3339 <https://www.ietf.org/rfc/rfc3339.txt>`__ text
            format.
        progress (google.container_v1beta1.types.OperationProgress):
            Output only. [Output only] Progress information for an
            operation.
        cluster_conditions (Sequence[google.container_v1beta1.types.StatusCondition]):
            Which conditions caused the current cluster
            state. Deprecated. Use field error instead.
        nodepool_conditions (Sequence[google.container_v1beta1.types.StatusCondition]):
    ...
    progress = proto.Field(proto.MESSAGE, number=12,
        message='OperationProgress',
    )

    cluster_conditions = proto.RepeatedField(proto.MESSAGE, number=13,
        message='StatusCondition',
    )

    nodepool_conditions = proto.RepeatedField(proto.MESSAGE, number=14,
        message='StatusCondition',
    )
...
class OperationProgress(proto.Message):
    ...
    Attributes:
        ...
        metrics (Sequence[google.container_v1beta1.types.OperationProgress.Metric]):
        ...
        stages (Sequence[google.container_v1beta1.types.OperationProgress]):
    ...
    stages = proto.RepeatedField(proto.MESSAGE, number=4,
        message='OperationProgress',
    )
...
class CreateClusterRequest(proto.Message):
    ...
    Attributes:
        ...
        cluster (google.container_v1beta1.types.Cluster):
            Required. A `cluster
...
class UpdateClusterRequest(proto.Message):
    ...
    Attributes:
        ...
        cluster_id (str):
            ...
            replaced by the name field.
        update (google.container_v1beta1.types.ClusterUpdate):
    ...
    update = proto.Field(proto.MESSAGE, number=4,
...
class UpdateNodePoolRequest(proto.Message):
    ...
    Attributes:
        ...
        upgrade_settings (google.container_v1beta1.types.NodePool.UpgradeSettings):
    ...
    upgrade_settings = proto.Field(proto.MESSAGE, number=15,
        message='NodePool.UpgradeSettings',
    )

    linux_node_config = proto.Field(proto.MESSAGE, number=19,
        message='LinuxNodeConfig',
    )

    kubelet_config = proto.Field(proto.MESSAGE, number=20,
        message='NodeKubeletConfig',
    )
...
class SetNodePoolAutoscalingRequest(proto.Message):
    ...
    Attributes:
        ...
        node_pool_id (str):
            ...
            pool to upgrade. This field has been deprecated
            and replaced by the name field.
        autoscaling (google.container_v1beta1.types.NodePoolAutoscaling):
    ...
    autoscaling = proto.Field(proto.MESSAGE, number=5,
        message='NodePoolAutoscaling',
    )
...
class SetAddonsConfigRequest(proto.Message):
    ...
    addons_config = proto.Field(proto.MESSAGE, number=4,
        message='AddonsConfig',
    )
...
class SetMasterAuthRequest(proto.Message):
    ...
    Attributes:
        ...
        cluster_id (str):
            ...
            to upgrade. This field has been deprecated and
            replaced by the name field.
        action (google.container_v1beta1.types.SetMasterAuthRequest.Action):
            Required. The exact form of action to be
            taken on the master auth.
        update (google.container_v1beta1.types.MasterAuth):
            Required. A description of the update.
        name (str):
            The name (project, location, cluster) of the cluster to set
    ...
    action = proto.Field(proto.ENUM, number=4,
        enum=Action,
    )

    update = proto.Field(proto.MESSAGE, number=5,
        message='MasterAuth',
    )
...
class ListClustersResponse(proto.Message):
    ...
    Attributes:
        clusters (Sequence[google.container_v1beta1.types.Cluster]):
...
class ListOperationsResponse(proto.Message):
    ...
    Attributes:
        operations (Sequence[google.container_v1beta1.types.Operation]):
...
class ServerConfig(proto.Message):
    ...
    Attributes:
        ...
        valid_master_versions (Sequence[str]):
            ...
            order.
        channels (Sequence[google.container_v1beta1.types.ServerConfig.ReleaseChannelConfig]):
    ...
    class ReleaseChannelConfig(proto.Message):
        ...
        Attributes:
            channel (google.container_v1beta1.types.ReleaseChannel.Channel):
                The release channel this configuration
                applies to.
            default_version (str):
                The default version for newly created
                clusters on the channel.
            available_versions (Sequence[google.container_v1beta1.types.ServerConfig.ReleaseChannelConfig.AvailableVersion]):
        ...
        available_versions = proto.RepeatedField(proto.MESSAGE, number=3,
    ...
    channels = proto.RepeatedField(proto.MESSAGE, number=9,
...
class CreateNodePoolRequest(proto.Message):
    ...
    Attributes:
        ...
        node_pool (google.container_v1beta1.types.NodePool):
    ...
    node_pool = proto.Field(proto.MESSAGE, number=4,
        message='NodePool',
    )
...
class NodePool(proto.Message):
    ...
    Attributes:
        ...
        config (google.container_v1beta1.types.NodeConfig):
        ...
        status (google.container_v1beta1.types.NodePool.Status):
        ...
        management (google.container_v1beta1.types.NodeManagement):
            NodeManagement configuration for this
            NodePool.
        max_pods_constraint (google.container_v1beta1.types.MaxPodsConstraint):
    ...
    status = proto.Field(proto.ENUM, number=103,
        enum=Status,
    )

    status_message = proto.Field(proto.STRING, number=104)

    autoscaling = proto.Field(proto.MESSAGE, number=4,
        message='NodePoolAutoscaling',
    )

    management = proto.Field(proto.MESSAGE, number=5,
        message='NodeManagement',
    )

    max_pods_constraint = proto.Field(proto.MESSAGE, number=6,
        message='MaxPodsConstraint',
    )

    conditions = proto.RepeatedField(proto.MESSAGE, number=105,
        message='StatusCondition',
    )

    pod_ipv4_cidr_size = proto.Field(proto.INT32, number=7)

    upgrade_settings = proto.Field(proto.MESSAGE, number=107,
...
class NodeManagement(proto.Message):
    ...
    Attributes:
        ...
        auto_repair (bool):
            Whether the nodes will be automatically
            repaired.
        upgrade_options (google.container_v1beta1.types.AutoUpgradeOptions):
    ...
    upgrade_options = proto.Field(proto.MESSAGE, number=10,
...
class MaintenancePolicy(proto.Message):
    ...
    Attributes:
        window (google.container_v1beta1.types.MaintenanceWindow):
...
class MaintenanceWindow(proto.Message):
    ...
    Attributes:
        daily_maintenance_window (google.container_v1beta1.types.DailyMaintenanceWindow):
            DailyMaintenanceWindow specifies a daily
            maintenance operation window.
        recurring_window (google.container_v1beta1.types.RecurringTimeWindow):
            ...
            occur at any time.
        maintenance_exclusions (Sequence[google.container_v1beta1.types.MaintenanceWindow.MaintenanceExclusionsEntry]):
            Exceptions to maintenance window. Non-
            mergency maintenance should not occur in these
            windows.
    """

    daily_maintenance_window = proto.Field(proto.MESSAGE, number=2, oneof='policy',
        message='DailyMaintenanceWindow',
    )

    recurring_window = proto.Field(proto.MESSAGE, number=3, oneof='policy',
        message='RecurringTimeWindow',
    )

    maintenance_exclusions = proto.MapField(proto.STRING, proto.MESSAGE, number=4,
        message='TimeWindow',
    )
...
class RecurringTimeWindow(proto.Message):
    ...
    Attributes:
        window (google.container_v1beta1.types.TimeWindow):
...
class ListNodePoolsResponse(proto.Message):
    ...
    node_pools = proto.RepeatedField(proto.MESSAGE, number=1,
        message='NodePool',
    )
...
class ClusterAutoscaling(proto.Message):
    ...
    Attributes:
        enable_node_autoprovisioning (bool):
            ...
            deletion.
        resource_limits (Sequence[google.container_v1beta1.types.ResourceLimit]):
            Contains global constraints regarding minimum
            and maximum amount of resources in the cluster.
        autoscaling_profile (google.container_v1beta1.types.ClusterAutoscaling.AutoscalingProfile):
            Defines autoscaling behaviour.
        autoprovisioning_node_pool_defaults (google.container_v1beta1.types.AutoprovisioningNodePoolDefaults):
    ...
    resource_limits = proto.RepeatedField(proto.MESSAGE, number=2,
        message='ResourceLimit',
    )

    autoscaling_profile = proto.Field(proto.ENUM, number=3,
        enum=AutoscalingProfile,
    )

    autoprovisioning_node_pool_defaults = proto.Field(proto.MESSAGE, number=4,
...
class AutoprovisioningNodePoolDefaults(proto.Message):
    ...
    upgrade_settings = proto.Field(proto.MESSAGE, number=3,
        message='NodePool.UpgradeSettings',
    )

    management = proto.Field(proto.MESSAGE, number=4,
        message='NodeManagement',
    )
    ...
    shielded_instance_config = proto.Field(proto.MESSAGE, number=8,
        message='ShieldedInstanceConfig',
    )
...
class SetLabelsRequest(proto.Message):
    ...
    Attributes:
        ...
        cluster_id (str):
            ...
            cluster. This field has been deprecated and
            replaced by the name field.
        resource_labels (Sequence[google.container_v1beta1.types.SetLabelsRequest.ResourceLabelsEntry]):
...
class WorkloadMetadataConfig(proto.Message):
    ...
    Attributes:
        node_metadata (google.container_v1beta1.types.WorkloadMetadataConfig.NodeMetadata):
            NodeMetadata is the configuration for how to
            expose metadata to the workloads running on the
            node.
        mode (google.container_v1beta1.types.WorkloadMetadataConfig.Mode):
    ...
    node_metadata = proto.Field(proto.ENUM, number=1,
        enum=NodeMetadata,
    )
...
class SetNetworkPolicyRequest(proto.Message):
    ...
    network_policy = proto.Field(proto.MESSAGE, number=4,
        message='NetworkPolicy',
    )
...
class SetMaintenancePolicyRequest(proto.Message):
    ...
    maintenance_policy = proto.Field(proto.MESSAGE, number=4,
        message='MaintenancePolicy',
    )
...
class ListLocationsResponse(proto.Message):
    ...
    Attributes:
        locations (Sequence[google.container_v1beta1.types.Location]):
...
class Location(proto.Message):
    ...
    Attributes:
        type_ (google.container_v1beta1.types.Location.LocationType):
...
class StatusCondition(proto.Message):
    ...
    Attributes:
        code (google.container_v1beta1.types.StatusCondition.Code):
    ...
    canonical_code = proto.Field(proto.ENUM, number=3,
        enum=gr_code.Code,
    )
...
class NetworkConfig(proto.Message):
    ...
    Attributes:
        ...
        default_snat_status (google.container_v1beta1.types.DefaultSnatStatus):
        ...
        datapath_provider (google.container_v1beta1.types.DatapathProvider):
    ...
    default_snat_status = proto.Field(proto.MESSAGE, number=7,
        message='DefaultSnatStatus',
    )

    datapath_provider = proto.Field(proto.ENUM, number=11,
        enum='DatapathProvider',
    )
...
class ListUsableSubnetworksResponse(proto.Message):
    ...
    Attributes:
        subnetworks (Sequence[google.container_v1beta1.types.UsableSubnetwork]):
    ...
    subnetworks = proto.RepeatedField(proto.MESSAGE, number=1,
...
class UsableSubnetworkSecondaryRange(proto.Message):
    ...
    Attributes:
        ...
        status (google.container_v1beta1.types.UsableSubnetworkSecondaryRange.Status):
...
class UsableSubnetwork(proto.Message):
    ...
    Attributes:
        ...
        secondary_ip_ranges (Sequence[google.container_v1beta1.types.UsableSubnetworkSecondaryRange]):
            Secondary IP ranges.
        status_message (str):
    ...
    secondary_ip_ranges = proto.RepeatedField(proto.MESSAGE, number=4,
...
class DatabaseEncryption(proto.Message):
    ...
    Attributes:
        state (google.container_v1beta1.types.DatabaseEncryption.State):
...
class ResourceUsageExportConfig(proto.Message):
    ...
    Attributes:
        bigquery_destination (google.container_v1beta1.types.ResourceUsageExportConfig.BigQueryDestination):
        ...
        enable_network_egress_metering (bool):
            ...
            traffic.
        consumption_metering_config (google.container_v1beta1.types.ResourceUsageExportConfig.ConsumptionMeteringConfig):
    ...
    bigquery_destination = proto.Field(proto.MESSAGE, number=1,
        message=BigQueryDestination,
    )

    enable_network_egress_metering = proto.Field(proto.BOOL, number=2)

    consumption_metering_config = proto.Field(proto.MESSAGE, number=3,
...
class GetJSONWebKeysResponse(proto.Message):
    ...
    Attributes:
        keys (Sequence[google.container_v1beta1.types.Jwk]):
...
class NotificationConfig(proto.Message):
    ...
    Attributes:
        pubsub (google.container_v1beta1.types.NotificationConfig.PubSub):
    ...
    pubsub = proto.Field(proto.MESSAGE, number=1,
        message=PubSub,
    )
...
class UpgradeEvent(proto.Message):
    ...
    Attributes:
        resource_type (google.container_v1beta1.types.UpgradeResourceType):
    ...
    resource_type = proto.Field(proto.ENUM, number=1,
        enum='UpgradeResourceType',
    )

    operation = proto.Field(proto.STRING, number=2)

    operation_start_time = proto.Field(proto.MESSAGE, number=3,
        message=timestamp.Timestamp,
    )
