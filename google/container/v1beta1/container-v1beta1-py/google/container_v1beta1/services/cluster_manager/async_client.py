...
class ClusterManagerAsyncClient:
    ...
    get_transport_class = functools.partial(type(ClusterManagerClient).get_transport_class, type(ClusterManagerClient))
    ...
    async def list_clusters(self,
        ...
        Returns:
            google.container_v1beta1.types.ListClustersResponse:
    ...
    async def get_cluster(self,
        ...
        Returns:
            google.container_v1beta1.types.Cluster:
    ...
    async def create_cluster(self,
        ...
        Args:
            ...
            zone (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            cluster (:class:`google.container_v1beta1.types.Cluster`):
                Required. A `cluster
        ...
        Returns:
            google.container_v1beta1.types.Operation:
    ...
    async def update_cluster(self,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            update (:class:`google.container_v1beta1.types.ClusterUpdate`):
    ...
    async def set_addons_config(self,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            addons_config (:class:`google.container_v1beta1.types.AddonsConfig`):
    ...
    async def list_operations(self,
        ...
        Returns:
            google.container_v1beta1.types.ListOperationsResponse:
    ...
    async def get_server_config(self,
        ...
        Returns:
            google.container_v1beta1.types.ServerConfig:
                Kubernetes Engine service
                configuration.
    ...
    async def list_node_pools(self,
        ...
        Returns:
            google.container_v1beta1.types.ListNodePoolsResponse:
    ...
    async def get_json_web_keys(self,
        ...
        Returns:
            google.container_v1beta1.types.GetJSONWebKeysResponse:
    ...
    async def get_node_pool(self,
        ...
        Returns:
            google.container_v1beta1.types.NodePool:
    ...
    async def create_node_pool(self,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            node_pool (:class:`google.container_v1beta1.types.NodePool`):
    ...
    async def set_node_pool_management(self,
        ...
        Args:
            ...
            node_pool_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            management (:class:`google.container_v1beta1.types.NodeManagement`):
    ...
    async def set_labels(self,
            ...
            *,
            ...
            zone: str = None,
            cluster_id: str = None,
            resource_labels: Sequence[cluster_service.SetLabelsRequest.ResourceLabelsEntry] = None,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            resource_labels (:class:`Sequence[google.container_v1beta1.types.SetLabelsRequest.ResourceLabelsEntry]`):
    ...
    async def set_network_policy(self,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            network_policy (:class:`google.container_v1beta1.types.NetworkPolicy`):
    ...
    async def set_maintenance_policy(self,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            maintenance_policy (:class:`google.container_v1beta1.types.MaintenancePolicy`):
    ...
    async def list_usable_subnetworks(self,
        ...
        Returns:
            google.container_v1beta1.services.cluster_manager.pagers.ListUsableSubnetworksAsyncPager:
    ...
    async def list_locations(self,
        ...
        Returns:
            google.container_v1beta1.types.ListLocationsResponse:
