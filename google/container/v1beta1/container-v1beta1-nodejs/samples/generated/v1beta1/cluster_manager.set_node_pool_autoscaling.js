...
function main(projectId, zone, clusterId, nodePoolId, autoscaling) {
  // [START container_set_node_pool_autoscaling_sample]
  /**
  ...
  // [END container_set_node_pool_autoscaling_sample]
}
