 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.LoggingComponentConfig</code>
 */
class LoggingComponentConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.container.v1beta1.LoggingComponentConfig.Component enable_components = 1;</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Container\V1beta1\LoggingComponentConfig\Component::class);
