...
namespace Google\Cloud\Container\V1beta1\MonitoringComponentConfig;
 ...
 *
 * Protobuf type <code>google.container.v1beta1.MonitoringComponentConfig.Component</code>
 */
class Component
{
    /**
...
class_alias(Component::class, \Google\Cloud\Container\V1beta1\MonitoringComponentConfig_Component::class);
