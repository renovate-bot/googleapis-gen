 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.IPAllocationPolicy</code>
 */
class IPAllocationPolicy extends \Google\Protobuf\Internal\Message
{
     ...
     *    fully-specified.
     *
     * Generated from protobuf field <code>bool allow_route_overlap = 12;</code>
     */
    protected $allow_route_overlap = false;
    /**
     ...
     * @return bool
     */
    public function getAllowRouteOverlap()
    {
        return $this->allow_route_overlap;
    }
     ...
     * @return $this
     */
    public function setAllowRouteOverlap($var)
    {
        GPBUtil::checkBool($var);
        $this->allow_route_overlap = $var;
