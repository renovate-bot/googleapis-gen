 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.ResourceUsageExportConfig</code>
 */
class ResourceUsageExportConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.ResourceUsageExportConfig.BigQueryDestination bigquery_destination = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.ResourceUsageExportConfig.ConsumptionMeteringConfig consumption_metering_config = 3;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Container\V1beta1\ResourceUsageExportConfig\BigQueryDestination $bigquery_destination
     *           Configuration to use BigQuery as usage export destination.
     *     @type bool $enable_network_egress_metering
     *           Whether to enable network egress metering for this cluster. If enabled, a
     *           daemonset will be created in the cluster to meter network egress traffic.
     *     @type \Google\Cloud\Container\V1beta1\ResourceUsageExportConfig\ConsumptionMeteringConfig $consumption_metering_config
     *           Configuration to enable resource consumption metering.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.ResourceUsageExportConfig.BigQueryDestination bigquery_destination = 1;</code>
     * @return \Google\Cloud\Container\V1beta1\ResourceUsageExportConfig\BigQueryDestination|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.ResourceUsageExportConfig.BigQueryDestination bigquery_destination = 1;</code>
     * @param \Google\Cloud\Container\V1beta1\ResourceUsageExportConfig\BigQueryDestination $var
     * @return $this
     */
    public function setBigqueryDestination($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\ResourceUsageExportConfig\BigQueryDestination::class);
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.ResourceUsageExportConfig.ConsumptionMeteringConfig consumption_metering_config = 3;</code>
     * @return \Google\Cloud\Container\V1beta1\ResourceUsageExportConfig\ConsumptionMeteringConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.ResourceUsageExportConfig.ConsumptionMeteringConfig consumption_metering_config = 3;</code>
     * @param \Google\Cloud\Container\V1beta1\ResourceUsageExportConfig\ConsumptionMeteringConfig $var
     * @return $this
     */
    public function setConsumptionMeteringConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\ResourceUsageExportConfig\ConsumptionMeteringConfig::class);
