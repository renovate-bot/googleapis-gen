 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.MaintenancePolicy</code>
 */
class MaintenancePolicy extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.MaintenanceWindow window = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Container\V1beta1\MaintenanceWindow $window
     *           Specifies the maintenance window in which maintenance may be performed.
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.MaintenanceWindow window = 1;</code>
     * @return \Google\Cloud\Container\V1beta1\MaintenanceWindow|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.MaintenanceWindow window = 1;</code>
     * @param \Google\Cloud\Container\V1beta1\MaintenanceWindow $var
     * @return $this
     */
    public function setWindow($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\MaintenanceWindow::class);
        $this->window = $var;
