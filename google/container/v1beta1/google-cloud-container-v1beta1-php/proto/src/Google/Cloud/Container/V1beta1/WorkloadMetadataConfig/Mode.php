 ...
 * on the node.
 *
 * Protobuf type <code>google.container.v1beta1.WorkloadMetadataConfig.Mode</code>
 */
class Mode
{
    /**
...
class_alias(Mode::class, \Google\Cloud\Container\V1beta1\WorkloadMetadataConfig_Mode::class);
