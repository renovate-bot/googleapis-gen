...
class NodeConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *           See https://cloud.google.com/compute/docs/gpus for more information about
     *           support for GPUs.
     *     @type \Google\Cloud\Container\V1beta1\SandboxConfig $sandbox_config
     *           Sandbox configuration for this node.
     ...
     *           workloads on [sole tenant
     *           nodes](https://cloud.google.com/compute/docs/nodes/sole-tenant-nodes).
     *     @type \Google\Cloud\Container\V1beta1\ReservationAffinity $reservation_affinity
     *           The optional reservation affinity. Setting this field will apply
     *           the specified [Zonal Compute
     *           Reservation](https://cloud.google.com/compute/docs/instances/reserving-zonal-resources)
     *           to this node pool.
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.SandboxConfig sandbox_config = 17;</code>
     * @param \Google\Cloud\Container\V1beta1\SandboxConfig $var
     * @return $this
     */
    public function setSandboxConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\SandboxConfig::class);
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.ReservationAffinity reservation_affinity = 19;</code>
     * @param \Google\Cloud\Container\V1beta1\ReservationAffinity $var
     * @return $this
     */
    public function setReservationAffinity($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\ReservationAffinity::class);
    ...
    {
        return isset($this->ephemeral_storage_config);
    }

    public function clearEphemeralStorageConfig()
    {
        unset($this->ephemeral_storage_config);
    }
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.EphemeralStorageConfig ephemeral_storage_config = 24;</code>
     * @param \Google\Cloud\Container\V1beta1\EphemeralStorageConfig $var
     * @return $this
     */
    public function setEphemeralStorageConfig($var)
    {
