 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.UsableSubnetworkSecondaryRange</code>
 */
class UsableSubnetworkSecondaryRange extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.UsableSubnetworkSecondaryRange.Status status = 3;</code>
     */
    protected $status = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Container\V1beta1\UsableSubnetworkSecondaryRange\Status::class);
        $this->status = $var;
