...
class CreateNodePoolRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.NodePool node_pool = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. Deprecated. The name of the cluster.
     *           This field has been deprecated and replaced by the parent field.
     *     @type \Google\Cloud\Container\V1beta1\NodePool $node_pool
     *           Required. The node pool to create.
     *     @type string $parent
     *           The parent (project, location, cluster id) where the node pool will be
     *           created. Specified in the format
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.NodePool node_pool = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Container\V1beta1\NodePool|null
     */
