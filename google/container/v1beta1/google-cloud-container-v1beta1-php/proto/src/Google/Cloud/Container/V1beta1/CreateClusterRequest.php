 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.CreateClusterRequest</code>
 */
class CreateClusterRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           cluster resides. This field has been deprecated and replaced by the parent
     *           field.
     *     @type \Google\Cloud\Container\V1beta1\Cluster $cluster
     *           Required. A [cluster
     *           resource](https://cloud.google.com/container-engine/reference/rest/v1beta1/projects.locations.clusters)
     *     @type string $parent
     *           The parent (project and location) where the cluster will be created.
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.Cluster cluster = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Container\V1beta1\Cluster $var
     * @return $this
     */
    public function setCluster($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\Cluster::class);
        $this->cluster = $var;
