 ...
 * by NAP.
 *
 * Generated from protobuf message <code>google.container.v1beta1.AutoprovisioningNodePoolDefaults</code>
 */
class AutoprovisioningNodePoolDefaults extends \Google\Protobuf\Internal\Message
{
     ...
     *           'pd-balanced')
     *           If unspecified, the default disk type is 'pd-standard'
     *     @type \Google\Cloud\Container\V1beta1\ShieldedInstanceConfig $shielded_instance_config
     *           Shielded Instance options.
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.ShieldedInstanceConfig shielded_instance_config = 8;</code>
     * @param \Google\Cloud\Container\V1beta1\ShieldedInstanceConfig $var
     * @return $this
     */
    public function setShieldedInstanceConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\ShieldedInstanceConfig::class);
