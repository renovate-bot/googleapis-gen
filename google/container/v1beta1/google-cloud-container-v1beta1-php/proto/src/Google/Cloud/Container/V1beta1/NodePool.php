...
class NodePool extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.NodePool.Status status = 103;</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.container.v1beta1.StatusCondition conditions = 105;</code>
     */
    private $conditions;
    /**
     ...
     *     @type string $name
     *           The name of the node pool.
     *     @type \Google\Cloud\Container\V1beta1\NodeConfig $config
     *           The node configuration of the pool.
     ...
     *           Autoscaler configuration for this NodePool. Autoscaler is enabled
     *           only if a valid configuration is present.
     *     @type \Google\Cloud\Container\V1beta1\NodeManagement $management
     *           NodeManagement configuration for this NodePool.
     *     @type \Google\Cloud\Container\V1beta1\MaxPodsConstraint $max_pods_constraint
     *           The constraint on the maximum number of pods that can be run
     *           simultaneously on a node in the node pool.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Container\V1beta1\NodePool\Status::class);
        $this->status = $var;
