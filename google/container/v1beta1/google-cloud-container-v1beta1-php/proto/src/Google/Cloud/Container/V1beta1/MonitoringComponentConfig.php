 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.MonitoringComponentConfig</code>
 */
class MonitoringComponentConfig extends \Google\Protobuf\Internal\Message
{
     ...
     * monitoring.
     *
     * Generated from protobuf field <code>repeated .google.container.v1beta1.MonitoringComponentConfig.Component enable_components = 1;</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Container\V1beta1\MonitoringComponentConfig\Component::class);
