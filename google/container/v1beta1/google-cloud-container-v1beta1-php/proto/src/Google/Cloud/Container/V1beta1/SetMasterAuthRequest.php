...
class SetMasterAuthRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.SetMasterAuthRequest.Action action = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $action = 0;
    /**
     * Required. A description of the update.
     *
     * Generated from protobuf field <code>.google.container.v1beta1.MasterAuth update = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *     @type int $action
     *           Required. The exact form of action to be taken on the master auth.
     *     @type \Google\Cloud\Container\V1beta1\MasterAuth $update
     *           Required. A description of the update.
     *     @type string $name
     *           The name (project, location, cluster) of the cluster to set auth.
     *           Specified in the format `projects/&#42;&#47;locations/&#42;&#47;clusters/&#42;`.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Container\V1beta1\SetMasterAuthRequest\Action::class);
        $this->action = $var;
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.MasterAuth update = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Container\V1beta1\MasterAuth|null
     */
