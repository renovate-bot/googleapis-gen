 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.DatabaseEncryption</code>
 */
class DatabaseEncryption extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.DatabaseEncryption.State state = 2;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Container\V1beta1\DatabaseEncryption\State::class);
        $this->state = $var;
