 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.SetMaintenancePolicyRequest</code>
 */
class SetMaintenancePolicyRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.MaintenancePolicy maintenance_policy = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The name of the cluster to update.
     *     @type \Google\Cloud\Container\V1beta1\MaintenancePolicy $maintenance_policy
     *           Required. The maintenance policy to be set for the cluster. An empty field
     *           clears the existing maintenance policy.
     *     @type string $name
     *           The name (project, location, cluster id) of the cluster to set maintenance
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.MaintenancePolicy maintenance_policy = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Container\V1beta1\MaintenancePolicy|null
     */
