 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.NotificationConfig</code>
 */
class NotificationConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Container\V1beta1\NotificationConfig\PubSub $pubsub
     *           Notification config for Pub/Sub.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.NotificationConfig.PubSub pubsub = 1;</code>
     * @param \Google\Cloud\Container\V1beta1\NotificationConfig\PubSub $var
     * @return $this
     */
    public function setPubsub($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\NotificationConfig\PubSub::class);
        $this->pubsub = $var;
