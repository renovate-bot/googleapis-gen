...
namespace Google\Cloud\Container\V1beta1\DNSConfig;
 ...
 *
 * Protobuf type <code>google.container.v1beta1.DNSConfig.Provider</code>
 */
class Provider
{
    /**
...
class_alias(Provider::class, \Google\Cloud\Container\V1beta1\DNSConfig_Provider::class);
