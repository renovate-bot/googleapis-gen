...
namespace Google\Cloud\Container\V1beta1\ReservationAffinity;
 ...
 *
 * Protobuf type <code>google.container.v1beta1.ReservationAffinity.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\Container\V1beta1\ReservationAffinity_Type::class);
