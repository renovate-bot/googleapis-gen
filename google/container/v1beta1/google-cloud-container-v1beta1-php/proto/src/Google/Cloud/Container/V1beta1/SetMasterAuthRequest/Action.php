...
namespace Google\Cloud\Container\V1beta1\SetMasterAuthRequest;
 ...
 *
 * Protobuf type <code>google.container.v1beta1.SetMasterAuthRequest.Action</code>
 */
class Action
{
    /**
...
class_alias(Action::class, \Google\Cloud\Container\V1beta1\SetMasterAuthRequest_Action::class);
