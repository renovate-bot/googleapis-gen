...
import (
	...
	containerpb "google.golang.org/genproto/googleapis/container/v1beta1"
...
type internalClusterManagerClient interface {
	...
	ListLocations(context.Context, *containerpb.ListLocationsRequest, ...gax.CallOption) (*containerpb.ListLocationsResponse, error)
}
...
func (c *ClusterManagerClient) setGoogleClientInfo(...string) {
...
// Deprecated. Use
// projects.locations.clusters.update (at https://cloud.google.com/kubernetes-engine/docs/reference/rest/v1beta1/projects.locations.clusters/update)
// instead.
//
...
func (c *ClusterManagerClient) ListLocations(ctx context.Context, req *containerpb.ListLocationsRequest, opts ...gax.CallOption) (*containerpb.ListLocationsResponse, error) {
...
func (c *clusterManagerGRPCClient) ListLocations(ctx context.Context, req *containerpb.ListLocationsRequest, opts ...gax.CallOption) (*containerpb.ListLocationsResponse, error) {
	if _, ok := ctx.Deadline(); !ok && !c.disableDeadlines {
		cctx, cancel := context.WithTimeout(ctx, 20000*time.Millisecond)
		defer cancel()
		ctx = cctx
	...
	var resp *containerpb.ListLocationsResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.clusterManagerClient.ListLocations(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
