...
class NodeConfig(proto.Message):
    ...
    Attributes:
        ...
        metadata (Sequence[google.container_v1.types.NodeConfig.MetadataEntry]):
        ...
        image_type (str):
            ...
            of it will be used.
        labels (Sequence[google.container_v1.types.NodeConfig.LabelsEntry]):
        ...
        preemptible (bool):
            ...
            instances.
        accelerators (Sequence[google.container_v1.types.AcceleratorConfig]):
        ...
        workload_metadata_config (google.container_v1.types.WorkloadMetadataConfig):
            The workload metadata configuration for this
            node.
        taints (Sequence[google.container_v1.types.NodeTaint]):
            ...
            and-toleration/
        sandbox_config (google.container_v1.types.SandboxConfig):
        ...
        reservation_affinity (google.container_v1.types.ReservationAffinity):
            ...
            to this node pool.
        shielded_instance_config (google.container_v1.types.ShieldedInstanceConfig):
...
class SandboxConfig(proto.Message):
    ...
    Attributes:
        type_ (google.container_v1.types.SandboxConfig.Type):
...
class ReservationAffinity(proto.Message):
    ...
    Attributes:
        consume_reservation_type (google.container_v1.types.ReservationAffinity.Type):
...
class NodeTaint(proto.Message):
    ...
    Attributes:
        ...
        value (str):
            Value for taint.
        effect (google.container_v1.types.NodeTaint.Effect):
            Effect for taint.
    """
...
class MasterAuth(proto.Message):
    ...
    Attributes:
        ...
        password (str):
            ...
            https://cloud.google.com/kubernetes-
            engine/docs/how-to/api-server-authentication
        client_certificate_config (google.container_v1.types.ClientCertificateConfig):
...
class AddonsConfig(proto.Message):
    ...
    Attributes:
        http_load_balancing (google.container_v1.types.HttpLoadBalancing):
            ...
            cluster.
        horizontal_pod_autoscaling (google.container_v1.types.HorizontalPodAutoscaling):
        ...
        kubernetes_dashboard (google.container_v1.types.KubernetesDashboard):
        ...
        network_policy_config (google.container_v1.types.NetworkPolicyConfig):
        ...
        cloud_run_config (google.container_v1.types.CloudRunConfig):
            Configuration for the Cloud Run addon, which
            allows the user to use a managed Knative
            service.
        dns_cache_config (google.container_v1.types.DnsCacheConfig):
            Configuration for NodeLocalDNS, a dns cache
            running on cluster nodes
        config_connector_config (google.container_v1.types.ConfigConnectorConfig):
...
class PrivateClusterConfig(proto.Message):
    ...
    Attributes:
        ...
        master_global_access_config (google.container_v1.types.PrivateClusterMasterGlobalAccessConfig):
...
class CloudRunConfig(proto.Message):
    ...
    Attributes:
        disabled (bool):
            ...
            cluster.
        load_balancer_type (google.container_v1.types.CloudRunConfig.LoadBalancerType):
...
class MasterAuthorizedNetworksConfig(proto.Message):
    ...
    Attributes:
        enabled (bool):
            ...
            enabled.
        cidr_blocks (Sequence[google.container_v1.types.MasterAuthorizedNetworksConfig.CidrBlock]):
...
class NetworkPolicy(proto.Message):
    ...
    Attributes:
        provider (google.container_v1.types.NetworkPolicy.Provider):
...
class Cluster(proto.Message):
    ...
    Attributes:
        ...
        initial_node_count (int):
            ...
            instead.
        node_config (google.container_v1.types.NodeConfig):
        ...
        master_auth (google.container_v1.types.MasterAuth):
        ...
        resource_labels (Sequence[google.container_v1.types.Cluster.ResourceLabelsEntry]):
        ...
        label_fingerprint (str):
            ...
            cluster.
        legacy_abac (google.container_v1.types.LegacyAbac):
        ...
        network_policy (google.container_v1.types.NetworkPolicy):
            ...
            feature.
        ip_allocation_policy (google.container_v1.types.IPAllocationPolicy):
            Configuration for cluster IP allocation.
        master_authorized_networks_config (google.container_v1.types.MasterAuthorizedNetworksConfig):
        ...
        maintenance_policy (google.container_v1.types.MaintenancePolicy):
            ...
            cluster.
        binary_authorization (google.container_v1.types.BinaryAuthorization):
            Configuration for Binary Authorization.
        autoscaling (google.container_v1.types.ClusterAutoscaling):
            Cluster-level autoscaling configuration.
        network_config (google.container_v1.types.NetworkConfig):
            Configuration for cluster networking.
        default_max_pods_constraint (google.container_v1.types.MaxPodsConstraint):
        ...
        resource_usage_export_config (google.container_v1.types.ResourceUsageExportConfig):
            Configuration for exporting resource usages.
            Resource usage export is disabled when this
            config is unspecified.
        authenticator_groups_config (google.container_v1.types.AuthenticatorGroupsConfig):
            Configuration controlling RBAC group
            membership information.
        private_cluster_config (google.container_v1.types.PrivateClusterConfig):
            Configuration for private cluster.
        database_encryption (google.container_v1.types.DatabaseEncryption):
            Configuration of etcd encryption.
        vertical_pod_autoscaling (google.container_v1.types.VerticalPodAutoscaling):
            Cluster-level Vertical Pod Autoscaling
            configuration.
        shielded_nodes (google.container_v1.types.ShieldedNodes):
            Shielded Nodes configuration.
        release_channel (google.container_v1.types.ReleaseChannel):
            Release channel configuration.
        workload_identity_config (google.container_v1.types.WorkloadIdentityConfig):
        ...
        create_time (str):
            ...
            format.
        status (google.container_v1.types.Cluster.Status):
        ...
        conditions (Sequence[google.container_v1.types.StatusCondition]):
...
class ClusterUpdate(proto.Message):
    ...
    Attributes:
        ...
        desired_monitoring_service (str):
            ...
            used for GKE 1.14+ or ``monitoring.googleapis.com`` for
            earlier versions.
        desired_addons_config (google.container_v1.types.AddonsConfig):
            Configurations for the various addons
            available to run in the cluster.
        ...
        desired_database_encryption (google.container_v1.types.DatabaseEncryption):
            Configuration of etcd encryption.
        desired_workload_identity_config (google.container_v1.types.WorkloadIdentityConfig):
            Configuration for Workload Identity.
        desired_shielded_nodes (google.container_v1.types.ShieldedNodes):
            Configuration for Shielded Nodes.
        desired_node_pool_autoscaling (google.container_v1.types.NodePoolAutoscaling):
        ...
        desired_master_authorized_networks_config (google.container_v1.types.MasterAuthorizedNetworksConfig):
            The desired configuration options for master
            authorized networks feature.
        desired_cluster_autoscaling (google.container_v1.types.ClusterAutoscaling):
            Cluster-level autoscaling configuration.
        desired_binary_authorization (google.container_v1.types.BinaryAuthorization):
        ...
        desired_logging_service (str):
            ...
            for GKE 1.14+ or ``logging.googleapis.com`` for earlier
            versions.
        desired_resource_usage_export_config (google.container_v1.types.ResourceUsageExportConfig):
            The desired configuration for exporting
            resource usage.
        desired_vertical_pod_autoscaling (google.container_v1.types.VerticalPodAutoscaling):
            Cluster-level Vertical Pod Autoscaling
            configuration.
        desired_private_cluster_config (google.container_v1.types.PrivateClusterConfig):
            The desired private cluster configuration.
        desired_intra_node_visibility_config (google.container_v1.types.IntraNodeVisibilityConfig):
            The desired config of Intra-node visibility.
        desired_default_snat_status (google.container_v1.types.DefaultSnatStatus):
...
class Operation(proto.Message):
    ...
    Attributes:
        ...
        operation_type (google.container_v1.types.Operation.Type):
            The operation type.
        status (google.container_v1.types.Operation.Status):
        ...
        end_time (str):
            ...
            `RFC3339 <https://www.ietf.org/rfc/rfc3339.txt>`__ text
            format.
        progress (google.container_v1.types.OperationProgress):
            Output only. [Output only] Progress information for an
            operation.
        cluster_conditions (Sequence[google.container_v1.types.StatusCondition]):
            Which conditions caused the current cluster
            state.
        nodepool_conditions (Sequence[google.container_v1.types.StatusCondition]):
...
class OperationProgress(proto.Message):
    ...
    Attributes:
        ...
        metrics (Sequence[google.container_v1.types.OperationProgress.Metric]):
        ...
        stages (Sequence[google.container_v1.types.OperationProgress]):
...
class UpdateNodePoolRequest(proto.Message):
    ...
    Attributes:
        ...
        workload_metadata_config (google.container_v1.types.WorkloadMetadataConfig):
            ...
            node pool.
        upgrade_settings (google.container_v1.types.NodePool.UpgradeSettings):
...
class SetNodePoolAutoscalingRequest(proto.Message):
    ...
    Attributes:
        ...
        node_pool_id (str):
            ...
            upgrade. This field has been deprecated and
            replaced by the name field.
        autoscaling (google.container_v1.types.NodePoolAutoscaling):
...
class SetMasterAuthRequest(proto.Message):
    ...
    Attributes:
        ...
        cluster_id (str):
            ...
            upgrade. This field has been deprecated and
            replaced by the name field.
        action (google.container_v1.types.SetMasterAuthRequest.Action):
            Required. The exact form of action to be
            taken on the master auth.
        update (google.container_v1.types.MasterAuth):
            Required. A description of the update.
        name (str):
            The name (project, location, cluster) of the cluster to set
...
class ListOperationsResponse(proto.Message):
    ...
    Attributes:
        operations (Sequence[google.container_v1.types.Operation]):
...
class ServerConfig(proto.Message):
    ...
    Attributes:
        ...
        valid_master_versions (Sequence[str]):
            ...
            order.
        channels (Sequence[google.container_v1.types.ServerConfig.ReleaseChannelConfig]):
    ...
    class ReleaseChannelConfig(proto.Message):
        ...
        Attributes:
            channel (google.container_v1.types.ReleaseChannel.Channel):
...
class NodePool(proto.Message):
    ...
    Attributes:
        ...
        config (google.container_v1.types.NodeConfig):
        ...
        status (google.container_v1.types.NodePool.Status):
        ...
        management (google.container_v1.types.NodeManagement):
            NodeManagement configuration for this
            NodePool.
        max_pods_constraint (google.container_v1.types.MaxPodsConstraint):
...
class NodeManagement(proto.Message):
    ...
    Attributes:
        auto_upgrade (bool):
            A flag that specifies whether node auto-
            pgrade is enabled for the node pool. If enabled,
            node auto-upgrade helps keep the nodes in your
            node pool up to date with the latest release
            version of Kubernetes.
        auto_repair (bool):
            A flag that specifies whether the node auto-
            epair is enabled for the node pool. If enabled,
        ...
        upgrade_options (google.container_v1.types.AutoUpgradeOptions):
...
class MaintenancePolicy(proto.Message):
    ...
    Attributes:
        window (google.container_v1.types.MaintenanceWindow):
...
class ClusterAutoscaling(proto.Message):
    ...
    Attributes:
        enable_node_autoprovisioning (bool):
            ...
            deletion.
        resource_limits (Sequence[google.container_v1.types.ResourceLimit]):
            Contains global constraints regarding minimum
            and maximum amount of resources in the cluster.
        autoprovisioning_node_pool_defaults (google.container_v1.types.AutoprovisioningNodePoolDefaults):
...
class SetLabelsRequest(proto.Message):
    ...
    Attributes:
        ...
        cluster_id (str):
            ...
            This field has been deprecated and replaced by
            the name field.
        resource_labels (Sequence[google.container_v1.types.SetLabelsRequest.ResourceLabelsEntry]):
...
class WorkloadMetadataConfig(proto.Message):
    ...
    Attributes:
        mode (google.container_v1.types.WorkloadMetadataConfig.Mode):
...
class StatusCondition(proto.Message):
    ...
    Attributes:
        code (google.container_v1.types.StatusCondition.Code):
...
class NetworkConfig(proto.Message):
    ...
    Attributes:
        ...
        default_snat_status (google.container_v1.types.DefaultSnatStatus):
...
class GetJSONWebKeysResponse(proto.Message):
    ...
    Attributes:
        keys (Sequence[google.container_v1.types.Jwk]):
...
class ListUsableSubnetworksResponse(proto.Message):
    ...
    Attributes:
        subnetworks (Sequence[google.container_v1.types.UsableSubnetwork]):
...
class UsableSubnetworkSecondaryRange(proto.Message):
    ...
    Attributes:
        ...
        status (google.container_v1.types.UsableSubnetworkSecondaryRange.Status):
...
class UsableSubnetwork(proto.Message):
    ...
    Attributes:
        ...
        secondary_ip_ranges (Sequence[google.container_v1.types.UsableSubnetworkSecondaryRange]):
            Secondary IP ranges.
        status_message (str):
...
class ResourceUsageExportConfig(proto.Message):
    ...
    Attributes:
        ...
        enable_network_egress_metering (bool):
            ...
            traffic.
        consumption_metering_config (google.container_v1.types.ResourceUsageExportConfig.ConsumptionMeteringConfig):
