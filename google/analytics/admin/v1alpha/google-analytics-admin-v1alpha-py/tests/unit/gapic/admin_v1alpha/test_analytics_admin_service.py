...
from google.analytics.admin_v1alpha.services.analytics_admin_service import AnalyticsAdminServiceAsyncClient
...
from google.analytics.admin_v1alpha.services.analytics_admin_service.transports.base import _API_CORE_VERSION
from google.analytics.admin_v1alpha.services.analytics_admin_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert AnalyticsAdminServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert AnalyticsAdminServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert AnalyticsAdminServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert AnalyticsAdminServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert AnalyticsAdminServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (AnalyticsAdminServiceClient, transports.AnalyticsAdminServiceGrpcTransport, "grpc"),
    (AnalyticsAdminServiceAsyncClient, transports.AnalyticsAdminServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(AnalyticsAdminServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AnalyticsAdminServiceClient))
@mock.patch.object(AnalyticsAdminServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AnalyticsAdminServiceAsyncClient))
def test_analytics_admin_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (AnalyticsAdminServiceClient, transports.AnalyticsAdminServiceGrpcTransport, "grpc", "true"),
    (AnalyticsAdminServiceAsyncClient, transports.AnalyticsAdminServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (AnalyticsAdminServiceClient, transports.AnalyticsAdminServiceGrpcTransport, "grpc", "false"),
    (AnalyticsAdminServiceAsyncClient, transports.AnalyticsAdminServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(AnalyticsAdminServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AnalyticsAdminServiceClient))
@mock.patch.object(AnalyticsAdminServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AnalyticsAdminServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_analytics_admin_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_analytics_admin_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_analytics_admin_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_analytics_admin_service_client_client_options_from_dict():
    with mock.patch('google.analytics.admin_v1alpha.services.analytics_admin_service.transports.AnalyticsAdminServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_account(transport: str = 'grpc', request_type=analytics_admin.GetAccountRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.get_account),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_get_account_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetAccountRequest):
...
def test_list_accounts(transport: str = 'grpc', request_type=analytics_admin.ListAccountsRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_accounts),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_accounts_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListAccountsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListAccountsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_accounts_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, resources.Account)
                   for i in results)
...
def test_delete_account(transport: str = 'grpc', request_type=analytics_admin.DeleteAccountRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_account),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_delete_account_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteAccountRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_account(transport: str = 'grpc', request_type=analytics_admin.UpdateAccountRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_account),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.Account(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_account_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateAccountRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_provision_account_ticket(transport: str = 'grpc', request_type=analytics_admin.ProvisionAccountTicketRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.provision_account_ticket),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_provision_account_ticket_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ProvisionAccountTicketRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ProvisionAccountTicketResponse(
            account_ticket_id='account_ticket_id_value',
        ))
...
def test_list_account_summaries(transport: str = 'grpc', request_type=analytics_admin.ListAccountSummariesRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_account_summaries_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListAccountSummariesRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListAccountSummariesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_account_summaries_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.AccountSummary)
                   for i in results)
...
def test_get_property(transport: str = 'grpc', request_type=analytics_admin.GetPropertyRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_property),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_property_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetPropertyRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_properties(transport: str = 'grpc', request_type=analytics_admin.ListPropertiesRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_properties),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_properties_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListPropertiesRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListPropertiesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_properties_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.Property)
                   for i in results)
...
def test_create_property(transport: str = 'grpc', request_type=analytics_admin.CreatePropertyRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_property),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.Property(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_property_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreatePropertyRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_property(transport: str = 'grpc', request_type=analytics_admin.DeletePropertyRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_property),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_property_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeletePropertyRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_property(transport: str = 'grpc', request_type=analytics_admin.UpdatePropertyRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_property),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.Property(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_property_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdatePropertyRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_user_link(transport: str = 'grpc', request_type=analytics_admin.GetUserLinkRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_user_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_user_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetUserLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_get_user_links(transport: str = 'grpc', request_type=analytics_admin.BatchGetUserLinksRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_get_user_links),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_batch_get_user_links_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.BatchGetUserLinksRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_user_links(transport: str = 'grpc', request_type=analytics_admin.ListUserLinksRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_user_links),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_user_links_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListUserLinksRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListUserLinksResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_user_links_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.UserLink)
                   for i in results)
...
def test_audit_user_links(transport: str = 'grpc', request_type=analytics_admin.AuditUserLinksRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.audit_user_links),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_audit_user_links_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.AuditUserLinksRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.AuditUserLinksResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_audit_user_links_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.AuditUserLink)
                   for i in results)
...
def test_create_user_link(transport: str = 'grpc', request_type=analytics_admin.CreateUserLinkRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_user_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.UserLink(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_user_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateUserLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_create_user_links(transport: str = 'grpc', request_type=analytics_admin.BatchCreateUserLinksRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_create_user_links),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_batch_create_user_links_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.BatchCreateUserLinksRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.BatchCreateUserLinksResponse(
        ))
...
def test_update_user_link(transport: str = 'grpc', request_type=analytics_admin.UpdateUserLinkRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_user_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.UserLink(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_user_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateUserLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_update_user_links(transport: str = 'grpc', request_type=analytics_admin.BatchUpdateUserLinksRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_update_user_links),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_batch_update_user_links_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.BatchUpdateUserLinksRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.BatchUpdateUserLinksResponse(
        ))
...
def test_delete_user_link(transport: str = 'grpc', request_type=analytics_admin.DeleteUserLinkRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_user_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_user_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteUserLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_delete_user_links(transport: str = 'grpc', request_type=analytics_admin.BatchDeleteUserLinksRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_delete_user_links),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_batch_delete_user_links_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.BatchDeleteUserLinksRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_web_data_stream(transport: str = 'grpc', request_type=analytics_admin.GetWebDataStreamRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_web_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_web_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetWebDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.WebDataStream(
            name='name_value',
            measurement_id='measurement_id_value',
            firebase_app_id='firebase_app_id_value',
            default_uri='default_uri_value',
...
def test_delete_web_data_stream(transport: str = 'grpc', request_type=analytics_admin.DeleteWebDataStreamRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_web_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_web_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteWebDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_delete_web_data_stream_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_web_data_stream(
            name='name_value',
        )
...
def test_update_web_data_stream(transport: str = 'grpc', request_type=analytics_admin.UpdateWebDataStreamRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_web_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.WebDataStream(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_web_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateWebDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_web_data_stream(transport: str = 'grpc', request_type=analytics_admin.CreateWebDataStreamRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_web_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.WebDataStream(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_web_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateWebDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_web_data_streams(transport: str = 'grpc', request_type=analytics_admin.ListWebDataStreamsRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_web_data_streams_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListWebDataStreamsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListWebDataStreamsResponse(
            next_page_token='next_page_token_value',
        ))
...
async def test_list_web_data_streams_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_web_data_streams(
            parent='parent_value',
        )
...
def test_list_web_data_streams_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.WebDataStream)
                   for i in results)
...
def test_get_ios_app_data_stream(transport: str = 'grpc', request_type=analytics_admin.GetIosAppDataStreamRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_ios_app_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_ios_app_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetIosAppDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.IosAppDataStream(
            name='name_value',
            firebase_app_id='firebase_app_id_value',
            bundle_id='bundle_id_value',
            display_name='display_name_value',
...
async def test_get_ios_app_data_stream_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_ios_app_data_stream(
            name='name_value',
        )
...
def test_delete_ios_app_data_stream(transport: str = 'grpc', request_type=analytics_admin.DeleteIosAppDataStreamRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_ios_app_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_ios_app_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteIosAppDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_delete_ios_app_data_stream_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_ios_app_data_stream(
            name='name_value',
        )
...
def test_update_ios_app_data_stream(transport: str = 'grpc', request_type=analytics_admin.UpdateIosAppDataStreamRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_ios_app_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateIosAppDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_ios_app_data_stream_flattened():
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0].ios_app_data_stream == resources.IosAppDataStream(name='name_value')
        assert args[0].update_mask == field_mask.FieldMask(paths=['paths_value'])
...
def test_create_ios_app_data_stream(transport: str = 'grpc', request_type=analytics_admin.CreateIosAppDataStreamRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_ios_app_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.IosAppDataStream(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_ios_app_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateIosAppDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_ios_app_data_streams(transport: str = 'grpc', request_type=analytics_admin.ListIosAppDataStreamsRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_ios_app_data_streams_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListIosAppDataStreamsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListIosAppDataStreamsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_ios_app_data_streams_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.IosAppDataStream)
                   for i in results)
...
def test_get_android_app_data_stream(transport: str = 'grpc', request_type=analytics_admin.GetAndroidAppDataStreamRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_android_app_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_android_app_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetAndroidAppDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.AndroidAppDataStream(
            name='name_value',
            firebase_app_id='firebase_app_id_value',
            package_name='package_name_value',
            display_name='display_name_value',
...
def test_delete_android_app_data_stream(transport: str = 'grpc', request_type=analytics_admin.DeleteAndroidAppDataStreamRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_android_app_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_android_app_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteAndroidAppDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_delete_android_app_data_stream_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_android_app_data_stream(
            name='name_value',
        )
...
def test_update_android_app_data_stream(transport: str = 'grpc', request_type=analytics_admin.UpdateAndroidAppDataStreamRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_android_app_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.AndroidAppDataStream(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_android_app_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateAndroidAppDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_android_app_data_stream_flattened():
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0].android_app_data_stream == resources.AndroidAppDataStream(name='name_value')
        assert args[0].update_mask == field_mask.FieldMask(paths=['paths_value'])
...
def test_create_android_app_data_stream(transport: str = 'grpc', request_type=analytics_admin.CreateAndroidAppDataStreamRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_android_app_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.AndroidAppDataStream(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_android_app_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateAndroidAppDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_android_app_data_streams(transport: str = 'grpc', request_type=analytics_admin.ListAndroidAppDataStreamsRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_android_app_data_streams_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListAndroidAppDataStreamsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_list_android_app_data_streams_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_android_app_data_streams(
            parent='parent_value',
        )
...
def test_list_android_app_data_streams_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.AndroidAppDataStream)
                   for i in results)
...
async def test_list_android_app_data_streams_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_android_app_data_streams(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token

def test_get_enhanced_measurement_settings(transport: str = 'grpc', request_type=analytics_admin.GetEnhancedMeasurementSettingsRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_enhanced_measurement_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_enhanced_measurement_settings_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetEnhancedMeasurementSettingsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_enhanced_measurement_settings(transport: str = 'grpc', request_type=analytics_admin.UpdateEnhancedMeasurementSettingsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_enhanced_measurement_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.EnhancedMeasurementSettings(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_enhanced_measurement_settings_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateEnhancedMeasurementSettingsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_enhanced_measurement_settings_field_headers():
    ...
    request.enhanced_measurement_settings.name = 'enhanced_measurement_settings.name/value'
...
def test_update_enhanced_measurement_settings_flattened():
    ...
    with mock.patch.object(
        ...
        # using the keyword arguments to the method.
        client.update_enhanced_measurement_settings(
            enhanced_measurement_settings=resources.EnhancedMeasurementSettings(name='name_value'),
            update_mask=field_mask.FieldMask(paths=['paths_value']),
        )
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0].enhanced_measurement_settings == resources.EnhancedMeasurementSettings(name='name_value')
        assert args[0].update_mask == field_mask.FieldMask(paths=['paths_value'])
...
def test_create_firebase_link(transport: str = 'grpc', request_type=analytics_admin.CreateFirebaseLinkRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_firebase_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_firebase_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateFirebaseLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.FirebaseLink(
            name='name_value',
            project='project_value',
            maximum_user_access=resources.MaximumUserAccess.NO_ACCESS,
        ))
...
def test_update_firebase_link(transport: str = 'grpc', request_type=analytics_admin.UpdateFirebaseLinkRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_firebase_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.FirebaseLink(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_firebase_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateFirebaseLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_firebase_link(transport: str = 'grpc', request_type=analytics_admin.DeleteFirebaseLinkRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_firebase_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_firebase_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteFirebaseLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_firebase_links(transport: str = 'grpc', request_type=analytics_admin.ListFirebaseLinksRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_firebase_links_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListFirebaseLinksRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListFirebaseLinksResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_firebase_links_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.FirebaseLink)
                   for i in results)
...
def test_get_global_site_tag(transport: str = 'grpc', request_type=analytics_admin.GetGlobalSiteTagRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_global_site_tag),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_global_site_tag_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetGlobalSiteTagRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.GlobalSiteTag(
            name='name_value',
            snippet='snippet_value',
        ))
...
def test_create_google_ads_link(transport: str = 'grpc', request_type=analytics_admin.CreateGoogleAdsLinkRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_google_ads_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_google_ads_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateGoogleAdsLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.GoogleAdsLink(
            name='name_value',
            customer_id='customer_id_value',
            can_manage_clients=True,
            email_address='email_address_value',
...
def test_update_google_ads_link(transport: str = 'grpc', request_type=analytics_admin.UpdateGoogleAdsLinkRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_google_ads_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.GoogleAdsLink(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_google_ads_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateGoogleAdsLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_google_ads_link(transport: str = 'grpc', request_type=analytics_admin.DeleteGoogleAdsLinkRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_google_ads_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_google_ads_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteGoogleAdsLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_google_ads_links_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListGoogleAdsLinksRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListGoogleAdsLinksResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_google_ads_links_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.GoogleAdsLink)
                   for i in results)
...
def test_get_data_sharing_settings(transport: str = 'grpc', request_type=analytics_admin.GetDataSharingSettingsRequest):
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_sharing_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_data_sharing_settings_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetDataSharingSettingsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.DataSharingSettings(
            name='name_value',
            sharing_with_google_support_enabled=True,
            sharing_with_google_assigned_sales_enabled=True,
            sharing_with_google_any_sales_enabled=True,
...
def test_analytics_admin_service_base_transport():
    ...
    with mock.patch('google.analytics.admin_v1alpha.services.analytics_admin_service.transports.AnalyticsAdminServiceTransport.__init__') as Transport:
...
def test_analytics_admin_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.analytics.admin_v1alpha.services.analytics_admin_service.transports.AnalyticsAdminServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_analytics_admin_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.analytics.admin_v1alpha.services.analytics_admin_service.transports.AnalyticsAdminServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.AnalyticsAdminServiceTransport()
        adc.assert_called_once()
...
def test_analytics_admin_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_analytics_admin_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_analytics_admin_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@pytest.mark.parametrize("transport_class", [transports.AnalyticsAdminServiceGrpcTransport, transports.AnalyticsAdminServiceGrpcAsyncIOTransport])
...
def test_analytics_admin_service_host_no_port():
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='analyticsadmin.googleapis.com'),
    )
    assert client.transport._host == 'analyticsadmin.googleapis.com:443'
...
def test_analytics_admin_service_host_with_port():
    client = AnalyticsAdminServiceClient(
        credentials=credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='analyticsadmin.googleapis.com:8000'),
    )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.AnalyticsAdminServiceGrpcTransport, transports.AnalyticsAdminServiceGrpcAsyncIOTransport])
def test_analytics_admin_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_account_summary_path():
    ...
    expected = "accountSummaries/{account_summary}".format(account_summary=account_summary, )
...
def test_android_app_data_stream_path():
    ...
    expected = "properties/{property}/androidAppDataStreams/{android_app_data_stream}".format(property=property, android_app_data_stream=android_app_data_stream, )
    actual = AnalyticsAdminServiceClient.android_app_data_stream_path(property, android_app_data_stream)
    assert expected == actual
...
def test_enhanced_measurement_settings_path():
    ...
    expected = "properties/{property}/webDataStreams/{web_data_stream}/enhancedMeasurementSettings".format(property=property, web_data_stream=web_data_stream, )
    actual = AnalyticsAdminServiceClient.enhanced_measurement_settings_path(property, web_data_stream)
    assert expected == actual
...
def test_firebase_link_path():
    ...
    expected = "properties/{property}/firebaseLinks/{firebase_link}".format(property=property, firebase_link=firebase_link, )
...
def test_google_ads_link_path():
    ...
    expected = "properties/{property}/googleAdsLinks/{google_ads_link}".format(property=property, google_ads_link=google_ads_link, )
...
def test_ios_app_data_stream_path():
    ...
    expected = "properties/{property}/iosAppDataStreams/{ios_app_data_stream}".format(property=property, ios_app_data_stream=ios_app_data_stream, )
    actual = AnalyticsAdminServiceClient.ios_app_data_stream_path(property, ios_app_data_stream)
    assert expected == actual
...
def test_user_link_path():
    account = "cuttlefish"
    user_link = "mussel"
    expected = "accounts/{account}/userLinks/{user_link}".format(account=account, user_link=user_link, )
...
def test_web_data_stream_path():
    property = "scallop"
    web_data_stream = "abalone"
    expected = "properties/{property}/webDataStreams/{web_data_stream}".format(property=property, web_data_stream=web_data_stream, )
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.AnalyticsAdminServiceTransport, '_prep_wrapped_messages') as prep:
        client = AnalyticsAdminServiceClient(
            credentials=credentials.AnonymousCredentials(),
