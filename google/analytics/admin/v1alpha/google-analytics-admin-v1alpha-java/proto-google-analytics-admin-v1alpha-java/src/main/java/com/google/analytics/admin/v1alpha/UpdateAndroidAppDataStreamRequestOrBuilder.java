...
public interface UpdateAndroidAppDataStreamRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.UpdateAndroidAppDataStreamRequest)
