...
class Dimension(proto.Message):
    ...
    dimension_expression = proto.Field(proto.MESSAGE, number=2,
...
class DimensionExpression(proto.Message):
    ...
    lower_case = proto.Field(proto.MESSAGE, number=4, oneof='one_expression',
        message=CaseExpression,
    )

    upper_case = proto.Field(proto.MESSAGE, number=5, oneof='one_expression',
        message=CaseExpression,
    )

    concatenate = proto.Field(proto.MESSAGE, number=6, oneof='one_expression',
...
class FilterExpression(proto.Message):
    ...
    and_group = proto.Field(proto.MESSAGE, number=1, oneof='expr',
        message='FilterExpressionList',
    )

    or_group = proto.Field(proto.MESSAGE, number=2, oneof='expr',
        message='FilterExpressionList',
    )

    not_expression = proto.Field(proto.MESSAGE, number=3, oneof='expr',
        message='FilterExpression',
    )

    filter = proto.Field(proto.MESSAGE, number=4, oneof='expr',
        message='Filter',
    )
...
class FilterExpressionList(proto.Message):
    ...
    expressions = proto.RepeatedField(proto.MESSAGE, number=1,
        message='FilterExpression',
    )
...
class Filter(proto.Message):
    ...
    class StringFilter(proto.Message):
        ...
        match_type = proto.Field(proto.ENUM, number=1,
    ...
    class NumericFilter(proto.Message):
        ...
        operation = proto.Field(proto.ENUM, number=1,
    ...
    class BetweenFilter(proto.Message):
        ...
        from_value = proto.Field(proto.MESSAGE, number=1,
            message='NumericValue',
        )

        to_value = proto.Field(proto.MESSAGE, number=2,
            message='NumericValue',
        )

    field_name = proto.Field(proto.STRING, number=1)

    string_filter = proto.Field(proto.MESSAGE, number=3, oneof='one_filter',
        message=StringFilter,
    )

    in_list_filter = proto.Field(proto.MESSAGE, number=4, oneof='one_filter',
        message=InListFilter,
    )

    numeric_filter = proto.Field(proto.MESSAGE, number=5, oneof='one_filter',
        message=NumericFilter,
    )

    between_filter = proto.Field(proto.MESSAGE, number=6, oneof='one_filter',
...
class OrderBy(proto.Message):
    ...
    class DimensionOrderBy(proto.Message):
        ...
        order_type = proto.Field(proto.ENUM, number=2,
    ...
    class PivotOrderBy(proto.Message):
        ...
        pivot_selections = proto.RepeatedField(proto.MESSAGE, number=2,
            message='OrderBy.PivotOrderBy.PivotSelection',
        )

    metric = proto.Field(proto.MESSAGE, number=1, oneof='one_order_by',
        message=MetricOrderBy,
    )

    dimension = proto.Field(proto.MESSAGE, number=2, oneof='one_order_by',
        message=DimensionOrderBy,
    )

    pivot = proto.Field(proto.MESSAGE, number=3, oneof='one_order_by',
...
class Pivot(proto.Message):
    ...
    order_bys = proto.RepeatedField(proto.MESSAGE, number=2,
        message='OrderBy',
    )
    ...
    metric_aggregations = proto.RepeatedField(proto.ENUM, number=5,
...
class CohortSpec(proto.Message):
    ...
    cohorts = proto.RepeatedField(proto.MESSAGE, number=1,
        message='Cohort',
    )

    cohorts_range = proto.Field(proto.MESSAGE, number=2,
        message='CohortsRange',
    )

    cohort_report_settings = proto.Field(proto.MESSAGE, number=3,
...
class Cohort(proto.Message):
    ...
    date_range = proto.Field(proto.MESSAGE, number=3,
        message='DateRange',
    )
...
class CohortsRange(proto.Message):
    ...
    granularity = proto.Field(proto.ENUM, number=1,
        enum=Granularity,
    )
...
class PivotHeader(proto.Message):
    ...
    pivot_dimension_headers = proto.RepeatedField(proto.MESSAGE, number=1,
...
class PivotDimensionHeader(proto.Message):
    ...
    dimension_values = proto.RepeatedField(proto.MESSAGE, number=1,
...
class PropertyQuota(proto.Message):
    ...
    tokens_per_day = proto.Field(proto.MESSAGE, number=1,
        message='QuotaStatus',
    )

    tokens_per_hour = proto.Field(proto.MESSAGE, number=2,
        message='QuotaStatus',
    )

    concurrent_requests = proto.Field(proto.MESSAGE, number=3,
        message='QuotaStatus',
    )

    server_errors_per_project_per_hour = proto.Field(proto.MESSAGE, number=4,
        message='QuotaStatus',
    )
