...
class BetaAnalyticsDataTransport(abc.ABC):
    ...
    @property
    def run_report(self) -> typing.Callable[
    ...
    @property
    def run_pivot_report(self) -> typing.Callable[
    ...
    @property
    def batch_run_reports(self) -> typing.Callable[
    ...
    @property
    def batch_run_pivot_reports(self) -> typing.Callable[
    ...
    @property
    def get_metadata(self) -> typing.Callable[
            [analytics_data_api.GetMetadataRequest],
            typing.Union[
                analytics_data_api.Metadata,
                typing.Awaitable[analytics_data_api.Metadata]
            ]]:
        raise NotImplementedError()

    @property
    def run_realtime_report(self) -> typing.Callable[
