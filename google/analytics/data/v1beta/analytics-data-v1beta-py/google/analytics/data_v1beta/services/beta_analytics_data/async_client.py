...
class BetaAnalyticsDataAsyncClient:
    ...
    get_transport_class = functools.partial(type(BetaAnalyticsDataClient).get_transport_class, type(BetaAnalyticsDataClient))
    ...
    async def run_pivot_report(self,
    ...
    async def batch_run_reports(self,
    ...
    async def batch_run_pivot_reports(self,
    ...
    async def run_realtime_report(self,
