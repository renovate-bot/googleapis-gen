    ...
    module Data
      module V1beta
        module BetaAnalyticsData
          ##
          # Client for the BetaAnalyticsData service.
          #
          ...
          class Client
            ...
            # @private
            attr_reader :beta_analytics_data_stub

            ##
            # Configure the BetaAnalyticsData Client class.
            #
            # See {::Google::Analytics::Data::V1beta::BetaAnalyticsData::Client::Configuration}
            # for a description of the configuration fields.
            #
            # ## Example
            #
            # To modify the configuration for all BetaAnalyticsData clients:
            #
            ...
            ##
            # Configure the BetaAnalyticsData Client instance.
            #
            ...
            ##
            # Create a new BetaAnalyticsData client object.
            #
            # ## Examples
            #
            # To create a new BetaAnalyticsData client with the default
            # configuration:
            #
            #     client = ::Google::Analytics::Data::V1beta::BetaAnalyticsData::Client.new
            #
            # To create a new BetaAnalyticsData client with a custom
            # configuration:
            #
            ...
            #     end
            #
            # @yield [config] Configure the BetaAnalyticsData client.
            # @yieldparam config [Client::Configuration]
            #
            def initialize
              ...
              @beta_analytics_data_stub = ::Gapic::ServiceStub.new(
            ...
            def run_report request, options = nil
              ...
              metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                ...
                gapic_version: ::Google::Analytics::Data::V1::VERSION
            ...
            def run_pivot_report request, options = nil
              ...
              @beta_analytics_data_stub.call_rpc :run_pivot_report, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            def batch_run_reports request, options = nil
              ...
              @beta_analytics_data_stub.call_rpc :batch_run_reports, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            def batch_run_pivot_reports request, options = nil
              ...
              @beta_analytics_data_stub.call_rpc :batch_run_pivot_reports, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            def get_metadata request, options = nil
              ...
              @beta_analytics_data_stub.call_rpc :get_metadata, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            def run_realtime_report request, options = nil
              ...
              @beta_analytics_data_stub.call_rpc :run_realtime_report, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            ##
            # Configuration class for the BetaAnalyticsData API.
            #
            # This class represents the configuration for BetaAnalyticsData,
            # providing control over timeouts, retry behavior, logging, transport
            # parameters, and other low-level controls. Certain parameters can also be
            # applied individually to specific RPCs. See
            # {::Google::Analytics::Data::V1beta::BetaAnalyticsData::Client::Configuration::Rpcs}
            ...
            class Configuration
              ...
              ##
              # Configuration RPC class for the BetaAnalyticsData API.
              #
