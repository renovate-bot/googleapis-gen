 ...
 *
 * Generated from protobuf message <code>google.analytics.data.v1alpha.PivotHeader</code>
 */
class PivotHeader extends \Google\Protobuf\Internal\Message
{
     ...
     * combinations.
     *
     * Generated from protobuf field <code>repeated .google.analytics.data.v1alpha.PivotDimensionHeader pivot_dimension_headers = 1;</code>
     */
     ...
     *
     *     @type \Google\Analytics\Data\V1alpha\PivotDimensionHeader[]|\Google\Protobuf\Internal\RepeatedField $pivot_dimension_headers
     *           The size is the same as the cardinality of the corresponding dimension
     *           combinations.
     *     @type int $row_count
     *           The cardinality of the pivot as if offset = 0 and limit = -1. The total
     ...
     *
     * Generated from protobuf field <code>repeated .google.analytics.data.v1alpha.PivotDimensionHeader pivot_dimension_headers = 1;</code>
     * @param \Google\Analytics\Data\V1alpha\PivotDimensionHeader[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPivotDimensionHeaders($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Analytics\Data\V1alpha\PivotDimensionHeader::class);
