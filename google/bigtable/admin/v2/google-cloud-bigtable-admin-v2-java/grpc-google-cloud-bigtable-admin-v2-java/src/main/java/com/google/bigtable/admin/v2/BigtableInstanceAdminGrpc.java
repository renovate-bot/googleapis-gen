...
public final class BigtableInstanceAdminGrpc {
      ...
      synchronized (BigtableInstanceAdminGrpc.class) {
        if ((getPartialUpdateInstanceMethod = BigtableInstanceAdminGrpc.getPartialUpdateInstanceMethod) == null) {
          BigtableInstanceAdminGrpc.getPartialUpdateInstanceMethod = getPartialUpdateInstanceMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PartialUpdateInstance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static BigtableInstanceAdminStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<BigtableInstanceAdminStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<BigtableInstanceAdminStub>() {
        @java.lang.Override
        public BigtableInstanceAdminStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static BigtableInstanceAdminBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<BigtableInstanceAdminBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<BigtableInstanceAdminBlockingStub>() {
        @java.lang.Override
        public BigtableInstanceAdminBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static BigtableInstanceAdminFutureStub newFutureStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<BigtableInstanceAdminFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<BigtableInstanceAdminFutureStub>() {
        @java.lang.Override
        public BigtableInstanceAdminFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static abstract class BigtableInstanceAdminImplBase implements io.grpc.BindableService {
    ...
    public void partialUpdateInstance(com.google.bigtable.admin.v2.PartialUpdateInstanceRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPartialUpdateInstanceMethod(), responseObserver);
    }
    ...
    public void createAppProfile(com.google.bigtable.admin.v2.CreateAppProfileRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateAppProfileMethod(), responseObserver);
    }
    ...
    public void getAppProfile(com.google.bigtable.admin.v2.GetAppProfileRequest request,
        io.grpc.stub.StreamObserver<com.google.bigtable.admin.v2.AppProfile> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetAppProfileMethod(), responseObserver);
    }
    ...
    public void listAppProfiles(com.google.bigtable.admin.v2.ListAppProfilesRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListAppProfilesMethod(), responseObserver);
    }
    ...
    public void updateAppProfile(com.google.bigtable.admin.v2.UpdateAppProfileRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getUpdateAppProfileMethod(), responseObserver);
    }
    ...
    public void deleteAppProfile(com.google.bigtable.admin.v2.DeleteAppProfileRequest request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getDeleteAppProfileMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public static final class BigtableInstanceAdminStub extends io.grpc.stub.AbstractAsyncStub<BigtableInstanceAdminStub> {
    ...
    public void partialUpdateInstance(com.google.bigtable.admin.v2.PartialUpdateInstanceRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getPartialUpdateInstanceMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void createAppProfile(com.google.bigtable.admin.v2.CreateAppProfileRequest request,
        io.grpc.stub.StreamObserver<com.google.bigtable.admin.v2.AppProfile> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateAppProfileMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void getAppProfile(com.google.bigtable.admin.v2.GetAppProfileRequest request,
        io.grpc.stub.StreamObserver<com.google.bigtable.admin.v2.AppProfile> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetAppProfileMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void listAppProfiles(com.google.bigtable.admin.v2.ListAppProfilesRequest request,
        io.grpc.stub.StreamObserver<com.google.bigtable.admin.v2.ListAppProfilesResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListAppProfilesMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void updateAppProfile(com.google.bigtable.admin.v2.UpdateAppProfileRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getUpdateAppProfileMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void deleteAppProfile(com.google.bigtable.admin.v2.DeleteAppProfileRequest request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDeleteAppProfileMethod(), getCallOptions()), request, responseObserver);
    }
   ...
   * </pre>
   */
  public static final class BigtableInstanceAdminBlockingStub extends io.grpc.stub.AbstractBlockingStub<BigtableInstanceAdminBlockingStub> {
   ...
   * </pre>
   */
  public static final class BigtableInstanceAdminFutureStub extends io.grpc.stub.AbstractFutureStub<BigtableInstanceAdminFutureStub> {
