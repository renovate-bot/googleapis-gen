...
class AIStreamsTransport(abc.ABC):
    ...
    def list_clusters(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[aistreams.ListClustersResponse]
            ]]:
        raise NotImplementedError()
    ...
    def get_cluster(self) -> typing.Callable[
            ...
            typing.Union[
                aistreams.Cluster,
                typing.Awaitable[aistreams.Cluster]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def list_streams(self) -> typing.Callable[
            [aistreams.ListStreamsRequest],
            typing.Union[
                aistreams.ListStreamsResponse,
                typing.Awaitable[aistreams.ListStreamsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_stream(self) -> typing.Callable[
            [aistreams.GetStreamRequest],
            typing.Union[
                aistreams.Stream,
                typing.Awaitable[aistreams.Stream]
            ]]:
        raise NotImplementedError()

    @property
    def create_stream(self) -> typing.Callable[
    ...
    @property
    def update_stream(self) -> typing.Callable[
    ...
    @property
    def delete_stream(self) -> typing.Callable[
