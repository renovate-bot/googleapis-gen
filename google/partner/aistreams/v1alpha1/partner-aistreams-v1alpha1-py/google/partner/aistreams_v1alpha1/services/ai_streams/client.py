...
class AIStreamsClientMeta(type):
    """Metaclass for the AIStreams client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AIStreamsTransport]]
    _transport_registry["grpc"] = AIStreamsGrpcTransport
    _transport_registry["grpc_asyncio"] = AIStreamsGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: str = None,
        ) -> Type[AIStreamsTransport]:
...
class AIStreamsClient(metaclass=AIStreamsClientMeta):
    """AIStreams service."""
    ...
    DEFAULT_ENDPOINT = "aistreams.googleapis.com"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AIStreamsClient: The constructed client.
        """
    ...
    def transport(self) -> AIStreamsTransport:
        ...
        Returns:
            AIStreamsTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, AIStreamsTransport):
            # transport is a AIStreamsTransport instance.
    ...
    def list_clusters(self,
        ...
        Returns:
            google.partner.aistreams_v1alpha1.services.ai_streams.pagers.ListClustersPager:
        ...
        # in a aistreams.ListClustersRequest.
    ...
    def get_cluster(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a aistreams.GetClusterRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_cluster(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a aistreams.CreateClusterRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_cluster(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a aistreams.UpdateClusterRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_cluster(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a aistreams.DeleteClusterRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_streams(self,
        ...
        Returns:
            google.partner.aistreams_v1alpha1.services.ai_streams.pagers.ListStreamsPager:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a aistreams.ListStreamsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_stream(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a aistreams.GetStreamRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_stream(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a aistreams.CreateStreamRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_stream(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a aistreams.UpdateStreamRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_stream(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a aistreams.DeleteStreamRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
