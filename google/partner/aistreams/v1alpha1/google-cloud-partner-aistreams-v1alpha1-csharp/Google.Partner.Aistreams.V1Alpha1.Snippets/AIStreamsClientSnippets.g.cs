...
namespace Google.Partner.Aistreams.V1Alpha1.Snippets
{
    ...
    public sealed class GeneratedAIStreamsClientSnippets
    {
        ...
        public void ListClustersRequestObject()
        {
            ...
            // Make the request
            PagedEnumerable<ListClustersResponse, Cluster> response = aIStreamsClient.ListClusters(request);
        ...
        public async Task ListClustersRequestObjectAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListClustersResponse, Cluster> response = aIStreamsClient.ListClustersAsync(request);
        ...
        public void ListClusters()
        {
            ...
            // Make the request
            PagedEnumerable<ListClustersResponse, Cluster> response = aIStreamsClient.ListClusters(parent);
        ...
        public async Task ListClustersAsync()
        {
            ...
            string parent = "projects/[PROJECT]/locations/[LOCATION]";
            // Make the request
            PagedAsyncEnumerable<ListClustersResponse, Cluster> response = aIStreamsClient.ListClustersAsync(parent);
        ...
        public async Task GetClusterRequestObjectAsync()
        {
            ...
            // Make the request
            Cluster response = await aIStreamsClient.GetClusterAsync(request);
            // End snippet
        }
        ...
        public void CreateClusterRequestObject()
        {
            ...
            // Make the request
            Operation<Cluster, OperationMetadata> response = aIStreamsClient.CreateCluster(request);
            ...
            Operation<Cluster, OperationMetadata> retrievedResponse = aIStreamsClient.PollOnceCreateCluster(operationName);
        ...
        public async Task CreateClusterRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Cluster, OperationMetadata> response = await aIStreamsClient.CreateClusterAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Cluster, OperationMetadata> retrievedResponse = await aIStreamsClient.PollOnceCreateClusterAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public void CreateCluster()
        {
            ...
            string clusterId = "";
            // Make the request
            Operation<Cluster, OperationMetadata> response = aIStreamsClient.CreateCluster(parent, cluster, clusterId);
        ...
        public async Task CreateClusterAsync()
        {
            ...
            string clusterId = "";
            // Make the request
            Operation<Cluster, OperationMetadata> response = await aIStreamsClient.CreateClusterAsync(parent, cluster, clusterId);
        ...
        public void UpdateClusterRequestObject()
        {
            ...
            // Make the request
            Operation<Cluster, OperationMetadata> response = aIStreamsClient.UpdateCluster(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Cluster, OperationMetadata> retrievedResponse = aIStreamsClient.PollOnceUpdateCluster(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public async Task UpdateClusterRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Cluster, OperationMetadata> response = await aIStreamsClient.UpdateClusterAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Cluster, OperationMetadata> retrievedResponse = await aIStreamsClient.PollOnceUpdateClusterAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public void UpdateCluster()
        {
            ...
            // Make the request
            Operation<Cluster, OperationMetadata> response = aIStreamsClient.UpdateCluster(cluster, updateMask);
        ...
        public async Task UpdateClusterAsync()
        {
            ...
            FieldMask updateMask = new FieldMask();
            // Make the request
            Operation<Cluster, OperationMetadata> response = await aIStreamsClient.UpdateClusterAsync(cluster, updateMask);
        ...
        public void DeleteClusterRequestObject()
        {
            ...
            // Make the request
            Operation<Empty, OperationMetadata> response = aIStreamsClient.DeleteCluster(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Empty, OperationMetadata> retrievedResponse = aIStreamsClient.PollOnceDeleteCluster(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public async Task DeleteClusterRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Empty, OperationMetadata> response = await aIStreamsClient.DeleteClusterAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Empty, OperationMetadata> retrievedResponse = await aIStreamsClient.PollOnceDeleteClusterAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public void DeleteCluster()
        {
            ...
            string name = "projects/[PROJECT]/locations/[LOCATION]/clusters/[CLUSTER]";
            // Make the request
            Operation<Empty, OperationMetadata> response = aIStreamsClient.DeleteCluster(name);
        ...
        public async Task DeleteClusterAsync()
        {
            ...
            string name = "projects/[PROJECT]/locations/[LOCATION]/clusters/[CLUSTER]";
            // Make the request
            Operation<Empty, OperationMetadata> response = await aIStreamsClient.DeleteClusterAsync(name);
        ...
        public void ListStreamsRequestObject()
        {
            ...
            // Make the request
            PagedEnumerable<ListStreamsResponse, Stream> response = aIStreamsClient.ListStreams(request);
        ...
        public async Task ListStreamsRequestObjectAsync()
        {
            ...
            // Make the request
            PagedAsyncEnumerable<ListStreamsResponse, Stream> response = aIStreamsClient.ListStreamsAsync(request);
        ...
        public void ListStreams()
        {
            ...
            // Make the request
            PagedEnumerable<ListStreamsResponse, Stream> response = aIStreamsClient.ListStreams(parent);
        ...
        public async Task ListStreamsAsync()
        {
            ...
            string parent = "projects/[PROJECT]/locations/[LOCATION]/clusters/[CLUSTER]";
            // Make the request
            PagedAsyncEnumerable<ListStreamsResponse, Stream> response = aIStreamsClient.ListStreamsAsync(parent);
        ...
        public async Task GetStreamRequestObjectAsync()
        {
            ...
            // Make the request
            Stream response = await aIStreamsClient.GetStreamAsync(request);
            // End snippet
        }
        ...
        public async Task GetStreamAsync()
        {
            ...
            string name = "projects/[PROJECT]/locations/[LOCATION]/clusters/[CLUSTER]/streams/[STREAM]";
            // Make the request
            Stream response = await aIStreamsClient.GetStreamAsync(name);
            // End snippet
        }
        ...
        public void CreateStreamRequestObject()
        {
            ...
            // Make the request
            Operation<Stream, OperationMetadata> response = aIStreamsClient.CreateStream(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Stream, OperationMetadata> retrievedResponse = aIStreamsClient.PollOnceCreateStream(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public async Task CreateStreamRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Stream, OperationMetadata> response = await aIStreamsClient.CreateStreamAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Stream, OperationMetadata> retrievedResponse = await aIStreamsClient.PollOnceCreateStreamAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public void CreateStream()
        {
            ...
            string streamId = "";
            // Make the request
            Operation<Stream, OperationMetadata> response = aIStreamsClient.CreateStream(parent, stream, streamId);
        ...
        public async Task CreateStreamAsync()
        {
            ...
            string streamId = "";
            // Make the request
            Operation<Stream, OperationMetadata> response = await aIStreamsClient.CreateStreamAsync(parent, stream, streamId);
        ...
        public void UpdateStreamRequestObject()
        {
            ...
            // Make the request
            Operation<Stream, OperationMetadata> response = aIStreamsClient.UpdateStream(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Stream, OperationMetadata> retrievedResponse = aIStreamsClient.PollOnceUpdateStream(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public async Task UpdateStreamRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Stream, OperationMetadata> response = await aIStreamsClient.UpdateStreamAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Stream, OperationMetadata> retrievedResponse = await aIStreamsClient.PollOnceUpdateStreamAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public void UpdateStream()
        {
            ...
            FieldMask updateMask = new FieldMask();
            // Make the request
            Operation<Stream, OperationMetadata> response = aIStreamsClient.UpdateStream(stream, updateMask);
        ...
        public async Task UpdateStreamAsync()
        {
            ...
            FieldMask updateMask = new FieldMask();
            // Make the request
            Operation<Stream, OperationMetadata> response = await aIStreamsClient.UpdateStreamAsync(stream, updateMask);
        ...
        public void DeleteStreamRequestObject()
        {
            ...
            // Make the request
            Operation<Empty, OperationMetadata> response = aIStreamsClient.DeleteStream(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Empty, OperationMetadata> retrievedResponse = aIStreamsClient.PollOnceDeleteStream(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public async Task DeleteStreamRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Empty, OperationMetadata> response = await aIStreamsClient.DeleteStreamAsync(request);
            ...
            string operationName = response.Name;
            // This name can be stored, then the long-running operation retrieved later by name
            Operation<Empty, OperationMetadata> retrievedResponse = await aIStreamsClient.PollOnceDeleteStreamAsync(operationName);
            // Check if the retrieved long-running operation has completed
            if (retrievedResponse.IsCompleted)
            {
                // If it has completed, then access the result
        ...
        public void DeleteStream()
        {
            ...
            string name = "projects/[PROJECT]/locations/[LOCATION]/clusters/[CLUSTER]/streams/[STREAM]";
            // Make the request
            Operation<Empty, OperationMetadata> response = aIStreamsClient.DeleteStream(name);
        ...
        public async Task DeleteStreamAsync()
        {
            ...
            string name = "projects/[PROJECT]/locations/[LOCATION]/clusters/[CLUSTER]/streams/[STREAM]";
            // Make the request
            Operation<Empty, OperationMetadata> response = await aIStreamsClient.DeleteStreamAsync(name);
