...
class ::Google::Partner::Aistreams::V1alpha1::AIStreams::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Partner::Aistreams::V1alpha1::AIStreams::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Partner::Aistreams::V1alpha1::AIStreams::Operations::Configuration, config
  end
end
