 ...
 *
 * Generated from protobuf message <code>google.partner.aistreams.v1alpha1.UpdateClusterRequest</code>
 */
class UpdateClusterRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           the full request. A field will be overwritten if it is in the mask. If the
     *           user does not provide a mask then all fields will be overwritten.
     *     @type \Google\Cloud\Partner\Aistreams\V1alpha1\Cluster $cluster
     *           Required. The Cluster resource to update.
     ...
     *
     * Generated from protobuf field <code>.google.partner.aistreams.v1alpha1.Cluster cluster = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Partner\Aistreams\V1alpha1\Cluster|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.partner.aistreams.v1alpha1.Cluster cluster = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Partner\Aistreams\V1alpha1\Cluster $var
     * @return $this
     */
    public function setCluster($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Partner\Aistreams\V1alpha1\Cluster::class);
        $this->cluster = $var;
