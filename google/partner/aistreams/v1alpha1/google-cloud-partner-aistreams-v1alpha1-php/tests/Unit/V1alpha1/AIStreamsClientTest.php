...
namespace Google\Cloud\Partner\Aistreams\Tests\Unit\V1alpha1;

use Google\Cloud\Partner\Aistreams\V1alpha1\AIStreamsClient;
 ...
 * @group gapic
 */
class AIStreamsClientTest extends GeneratedTest
{
    /**
    ...
    private function createClient(array $options = [])
    {
        ...
        return new AIStreamsClient($options);
    }
    ...
    public function listClustersTest()
    {
        ...
        $this->assertSame('/google.partner.aistreams.v1alpha1.AIStreams/ListClusters', $actualFuncCall);
    ...
    public function getClusterTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.partner.aistreams.v1alpha1.AIStreams/GetCluster', $actualFuncCall);
    ...
    public function createClusterTest()
    {
        ...
        $this->assertSame('/google.partner.aistreams.v1alpha1.AIStreams/CreateCluster', $actualApiFuncCall);
    ...
    public function updateClusterTest()
    {
        ...
        $response = $client->updateCluster($updateMask, $cluster);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.partner.aistreams.v1alpha1.AIStreams/UpdateCluster', $actualApiFuncCall);
    ...
    public function deleteClusterTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.partner.aistreams.v1alpha1.AIStreams/DeleteCluster', $actualApiFuncCall);
    ...
    public function listStreamsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.partner.aistreams.v1alpha1.AIStreams/ListStreams', $actualFuncCall);
    ...
    public function getStreamTest()
    {
        ...
        // Mock request
        $formattedName = $client->streamName('[PROJECT]', '[LOCATION]', '[CLUSTER]', '[STREAM]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.partner.aistreams.v1alpha1.AIStreams/GetStream', $actualFuncCall);
    ...
    public function createStreamTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.partner.aistreams.v1alpha1.AIStreams/CreateStream', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
    ...
    public function updateStreamTest()
    {
        ...
        $response = $client->updateStream($updateMask, $stream);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.partner.aistreams.v1alpha1.AIStreams/UpdateStream', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getUpdateMask();
    ...
    public function deleteStreamTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.partner.aistreams.v1alpha1.AIStreams/DeleteStream', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
