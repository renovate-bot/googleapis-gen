...
class ::Google::Chromeos::Moblab::V1beta1::BuildService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Chromeos::Moblab::V1beta1::BuildService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Chromeos::Moblab::V1beta1::BuildService::Operations::Configuration, config
  end
end
