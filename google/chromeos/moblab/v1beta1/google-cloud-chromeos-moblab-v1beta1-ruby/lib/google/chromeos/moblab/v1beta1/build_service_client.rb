...
require "google/chromeos/moblab/v1beta1/credentials"
      ...
      module V1beta1
        ...
        class BuildServiceClient
          ...
          def initialize \
            ...
            credentials ||= Google::Chromeos::Moblab::V1beta1::Credentials.default
            ...
            if credentials.is_a?(String) || credentials.is_a?(Hash)
              updater_proc = Google::Chromeos::Moblab::V1beta1::Credentials.new(credentials).updater_proc
            end
            ...
            package_version = Gem.loaded_specs['google-chromeos-moblab'].version.version
          ...
          #
          #   build_client = Google::Chromeos::Moblab.new(version: :v1beta1)
