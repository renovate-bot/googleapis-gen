...
from .grpc import BuildServiceGrpcTransport


class BuildServiceGrpcAsyncIOTransport(BuildServiceTransport):
    """gRPC AsyncIO backend transport for BuildService.
    ...
    def list_build_targets(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListBuildTargetsRequest],
                    Awaitable[~.ListBuildTargetsResponse]]:
    ...
    def check_build_stage_status(self) -> Callable[
            ...
            Awaitable[build_service.CheckBuildStageStatusResponse]]:
        ...
        Returns:
            Callable[[~.CheckBuildStageStatusRequest],
                    Awaitable[~.CheckBuildStageStatusResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def find_most_stable_build(self) -> Callable[
        ...
        Returns:
            Callable[[~.FindMostStableBuildRequest],
                    Awaitable[~.FindMostStableBuildResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
