...
class BuildServiceTransport(abc.ABC):
    """Abstract transport class for BuildService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.check_build_stage_status: gapic_v1.method.wrap_method(
                self.check_build_stage_status,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.stage_build: gapic_v1.method.wrap_method(
                self.stage_build,
                default_timeout=60.0,
                client_info=client_info,
            ),
    ...
    def list_builds(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[build_service.ListBuildsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def check_build_stage_status(self) -> typing.Callable[
            [build_service.CheckBuildStageStatusRequest],
            typing.Union[
                build_service.CheckBuildStageStatusResponse,
                typing.Awaitable[build_service.CheckBuildStageStatusResponse]
            ]]:
        raise NotImplementedError()

    @property
    def stage_build(self) -> typing.Callable[
