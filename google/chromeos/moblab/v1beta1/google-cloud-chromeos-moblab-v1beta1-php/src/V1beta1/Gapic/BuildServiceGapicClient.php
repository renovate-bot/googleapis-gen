...
use Google\Chromeos\Moblab\V1beta1\ListModelsRequest;
...
class BuildServiceGapicClient
{
     ...
     * $buildServiceClient = new BuildServiceClient();
     * try {
     *     $formattedParent = $buildServiceClient->buildTargetName('[BUILD_TARGET]');
     *     // Iterate over pages of elements
     *     $pagedResponse = $buildServiceClient->listModels($formattedParent);
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
     ...
     * ```
     *
     * @param string $parent       Required. The full resource name of build target.
     * @param array  $optionalArgs {
     *     Optional.
     *
     *     @type int $pageSize
