...
class Book(proto.Message):
    ...
    author = proto.Field(proto.STRING, number=2)

    title = proto.Field(proto.STRING, number=3)

    read = proto.Field(proto.BOOL, number=4)
...
class Shelf(proto.Message):
    ...
    theme = proto.Field(proto.STRING, number=2)
...
class CreateShelfRequest(proto.Message):
    ...
    shelf = proto.Field(proto.MESSAGE, number=1,
        message='Shelf',
    )
...
class ListShelvesResponse(proto.Message):
    ...
    shelves = proto.RepeatedField(proto.MESSAGE, number=1,
        message='Shelf',
    )
...
class ListBooksResponse(proto.Message):
    ...
    books = proto.RepeatedField(proto.MESSAGE, number=1,
        message='Book',
    )
