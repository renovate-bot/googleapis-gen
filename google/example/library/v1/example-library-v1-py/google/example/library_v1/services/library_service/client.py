...
class LibraryServiceClient(metaclass=LibraryServiceClientMeta):
    ...
    def transport(self) -> LibraryServiceTransport:
        ...
        Returns:
            LibraryServiceTransport: The transport used by the client
                instance.
        """
