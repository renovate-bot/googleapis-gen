...
project = u"google-cloud-datastore"
...
htmlhelp_basename = "google-cloud-datastore-doc"
...
latex_documents = [
    (
        ...
        u"google-cloud-datastore Documentation",
        author,
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-datastore",
        "GAPIC library for Google Cloud Datastore API",
        "APIs",
    )
]
