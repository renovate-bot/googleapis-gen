...
class DatastoreTransport(abc.ABC):
    ...
    @property
    def lookup(self) -> typing.Callable[
            [datastore.LookupRequest],
            typing.Union[
                datastore.LookupResponse,
                typing.Awaitable[datastore.LookupResponse]
            ]]:
    ...
    def run_query(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[datastore.RunQueryResponse]
            ]]:
        raise NotImplementedError()
    ...
    def commit(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[datastore.CommitResponse]
            ]]:
        raise NotImplementedError()
    ...
    def rollback(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[datastore.RollbackResponse]
            ]]:
        raise NotImplementedError()

    @property
    def allocate_ids(self) -> typing.Callable[
    ...
    @property
    def reserve_ids(self) -> typing.Callable[
            [datastore.ReserveIdsRequest],
            typing.Union[
                datastore.ReserveIdsResponse,
                typing.Awaitable[datastore.ReserveIdsResponse]
            ]]:
        raise NotImplementedError()
