...
class Value(proto.Message):
    ...
    null_value = proto.Field(proto.ENUM, number=11, oneof='value_type',
    ...
    geo_point_value = proto.Field(proto.MESSAGE, number=8, oneof='value_type',
        message=latlng.LatLng,
    )

    entity_value = proto.Field(proto.MESSAGE, number=6, oneof='value_type',
        message='Entity',
    )

    array_value = proto.Field(proto.MESSAGE, number=9, oneof='value_type',
        message='ArrayValue',
    )
...
class Entity(proto.Message):
    ...
    properties = proto.MapField(proto.STRING, proto.MESSAGE, number=3,
        message='Value',
    )
