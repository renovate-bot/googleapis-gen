...
class Query(proto.Message):
    ...
    projection = proto.RepeatedField(proto.MESSAGE, number=2,
        message='Projection',
    )

    kind = proto.RepeatedField(proto.MESSAGE, number=3,
        message='KindExpression',
    )

    filter = proto.Field(proto.MESSAGE, number=4,
        message='Filter',
    )

    order = proto.RepeatedField(proto.MESSAGE, number=5,
        message='PropertyOrder',
    )

    distinct_on = proto.RepeatedField(proto.MESSAGE, number=6,
    ...
    limit = proto.Field(proto.MESSAGE, number=12,
...
class Filter(proto.Message):
    ...
    property_filter = proto.Field(proto.MESSAGE, number=2, oneof='filter_type',
...
class GqlQuery(proto.Message):
    ...
    named_bindings = proto.MapField(proto.STRING, proto.MESSAGE, number=5,
        message='GqlQueryParameter',
    )

    positional_bindings = proto.RepeatedField(proto.MESSAGE, number=4,
        message='GqlQueryParameter',
    )
...
class GqlQueryParameter(proto.Message):
    ...
    value = proto.Field(proto.MESSAGE, number=2, oneof='parameter_type',
        message=gd_entity.Value,
    )
...
class QueryResultBatch(proto.Message):
    ...
    entity_result_type = proto.Field(proto.ENUM, number=1,
        enum='EntityResult.ResultType',
    )

    entity_results = proto.RepeatedField(proto.MESSAGE, number=2,
        message='EntityResult',
    )

    end_cursor = proto.Field(proto.BYTES, number=4)

    more_results = proto.Field(proto.ENUM, number=5,
