...
class ListIndexesPager:
    ...
    """
    def __init__(self,
            method: Callable[..., datastore_admin.ListIndexesResponse],
    ...
    @property
    def pages(self) -> Iterable[datastore_admin.ListIndexesResponse]:
...
class ListIndexesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[datastore_admin.ListIndexesResponse]],
            request: datastore_admin.ListIndexesRequest,
            response: datastore_admin.ListIndexesResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterable[datastore_admin.ListIndexesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
