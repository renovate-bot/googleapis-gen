...
from google.cloud.datastore_admin_v1.services.datastore_admin import DatastoreAdminAsyncClient
...
def test__get_default_mtls_endpoint():
    ...
    assert DatastoreAdminClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert DatastoreAdminClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert DatastoreAdminClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert DatastoreAdminClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert DatastoreAdminClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (DatastoreAdminAsyncClient, transports.DatastoreAdminGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_datastore_admin_client_client_options(client_class, transport_class, transport_name):
...
def test_datastore_admin_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_datastore_admin_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_datastore_admin_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_datastore_admin_client_client_options_from_dict():
    with mock.patch('google.cloud.datastore_admin_v1.services.datastore_admin.transports.DatastoreAdminGrpcTransport.__init__') as grpc_transport:
...
def test_export_entities(transport: str = 'grpc', request_type=datastore_admin.ExportEntitiesRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.export_entities),
            '__call__') as call:
...
def test_import_entities(transport: str = 'grpc', request_type=datastore_admin.ImportEntitiesRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_entities),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_index(transport: str = 'grpc', request_type=datastore_admin.CreateIndexRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_index(transport: str = 'grpc', request_type=datastore_admin.DeleteIndexRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_index(transport: str = 'grpc', request_type=datastore_admin.GetIndexRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_indexes(transport: str = 'grpc', request_type=datastore_admin.ListIndexesRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_datastore_admin_base_transport():
    ...
    with mock.patch('google.cloud.datastore_admin_v1.services.datastore_admin.transports.DatastoreAdminTransport.__init__') as Transport:
...
def test_datastore_admin_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.datastore_admin_v1.services.datastore_admin.transports.DatastoreAdminTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_datastore_admin_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.datastore_admin_v1.services.datastore_admin.transports.DatastoreAdminTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DatastoreAdminTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.DatastoreAdminGrpcTransport, transports.DatastoreAdminGrpcAsyncIOTransport])
...
def test_datastore_admin_host_no_port():
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='datastore.googleapis.com'),
    )
    assert client.transport._host == 'datastore.googleapis.com:443'
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DatastoreAdminGrpcTransport, transports.DatastoreAdminGrpcAsyncIOTransport])
def test_datastore_admin_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.DatastoreAdminTransport, '_prep_wrapped_messages') as prep:
        client = DatastoreAdminClient(
            credentials=ga_credentials.AnonymousCredentials(),
