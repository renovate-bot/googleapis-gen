...
class IndexOperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Datastore\Admin\V1\CommonMetadata $common
     *           Metadata common to all Datastore Admin operations.
     *     @type \Google\Datastore\Admin\V1\Progress $progress_entities
     *           An estimate of the number of entities processed.
     ...
     *
     * Generated from protobuf field <code>.google.datastore.admin.v1.CommonMetadata common = 1;</code>
     * @return \Google\Datastore\Admin\V1\CommonMetadata
     */
     ...
     *
     * Generated from protobuf field <code>.google.datastore.admin.v1.CommonMetadata common = 1;</code>
     * @param \Google\Datastore\Admin\V1\CommonMetadata $var
     * @return $this
     */
    public function setCommon($var)
    {
        GPBUtil::checkMessage($var, \Google\Datastore\Admin\V1\CommonMetadata::class);
        $this->common = $var;
     ...
     *
     * Generated from protobuf field <code>.google.datastore.admin.v1.Progress progress_entities = 2;</code>
     * @return \Google\Datastore\Admin\V1\Progress
     */
     ...
     *
     * Generated from protobuf field <code>.google.datastore.admin.v1.Progress progress_entities = 2;</code>
     * @param \Google\Datastore\Admin\V1\Progress $var
     * @return $this
     */
    public function setProgressEntities($var)
    {
        GPBUtil::checkMessage($var, \Google\Datastore\Admin\V1\Progress::class);
