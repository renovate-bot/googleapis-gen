...
namespace Google.Cloud.Datastore.Admin.V1.Snippets
{
    ...
    public sealed partial class GeneratedDatastoreAdminClientStandaloneSnippets
    {
        ...
        public void DeleteIndexRequestObject()
        {
            ...
            // Make the request
            Operation<Index, IndexOperationMetadata> response = datastoreAdminClient.DeleteIndex(request);
            ...
            Operation<Index, IndexOperationMetadata> retrievedResponse = datastoreAdminClient.PollOnceDeleteIndex(operationName);
