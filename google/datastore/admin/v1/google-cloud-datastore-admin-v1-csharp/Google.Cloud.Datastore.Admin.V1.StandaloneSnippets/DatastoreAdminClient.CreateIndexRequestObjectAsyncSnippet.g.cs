...
namespace Google.Cloud.Datastore.Admin.V1.Snippets
{
    ...
    public sealed partial class GeneratedDatastoreAdminClientStandaloneSnippets
    {
        ...
        public async Task CreateIndexRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Index, IndexOperationMetadata> response = await datastoreAdminClient.CreateIndexAsync(request);
            ...
            Operation<Index, IndexOperationMetadata> retrievedResponse = await datastoreAdminClient.PollOnceCreateIndexAsync(operationName);
