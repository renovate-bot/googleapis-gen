...
use Google\Appengine\V1\ServicesClient;
...
class ServicesClientTest extends GeneratedTest
{
    ...
    public function listServicesTest()
    {
        ...
        $this->assertSame('/google.appengine.v1.Services/ListServices', $actualFuncCall);
    ...
    public function getServiceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.appengine.v1.Services/GetService', $actualFuncCall);
    ...
    public function updateServiceTest()
    {
        ...
        $this->assertSame('/google.appengine.v1.Services/UpdateService', $actualApiFuncCall);
    ...
    public function deleteServiceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.appengine.v1.Services/DeleteService', $actualApiFuncCall);
