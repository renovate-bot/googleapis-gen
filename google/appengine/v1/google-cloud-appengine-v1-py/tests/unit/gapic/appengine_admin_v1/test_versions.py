...
def test_versions_client_client_options_from_dict():
    with mock.patch('google.cloud.appengine_admin_v1.services.versions.transports.VersionsGrpcTransport.__init__') as grpc_transport:
...
def test_versions_base_transport():
    ...
    with mock.patch('google.cloud.appengine_admin_v1.services.versions.transports.VersionsTransport.__init__') as Transport:
