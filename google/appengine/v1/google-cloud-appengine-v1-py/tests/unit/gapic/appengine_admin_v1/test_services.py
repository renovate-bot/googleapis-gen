...
def test_services_client_client_options_from_dict():
    with mock.patch('google.cloud.appengine_admin_v1.services.services.transports.ServicesGrpcTransport.__init__') as grpc_transport:
...
def test_services_base_transport():
    ...
    with mock.patch('google.cloud.appengine_admin_v1.services.services.transports.ServicesTransport.__init__') as Transport:
