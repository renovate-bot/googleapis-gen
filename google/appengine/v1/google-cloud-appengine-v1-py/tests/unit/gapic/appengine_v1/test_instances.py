...
from google.cloud.appengine_v1.services.instances import InstancesAsyncClient
from google.cloud.appengine_v1.services.instances import InstancesClient
from google.cloud.appengine_v1.services.instances import pagers
from google.cloud.appengine_v1.services.instances import transports
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (InstancesAsyncClient, transports.InstancesGrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(InstancesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(InstancesClient))
@mock.patch.object(InstancesAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(InstancesAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (InstancesAsyncClient, transports.InstancesGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (InstancesClient, transports.InstancesGrpcTransport, "grpc", "false"),
    (InstancesAsyncClient, transports.InstancesGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_instances_client_client_options_from_dict():
    with mock.patch('google.cloud.appengine_v1.services.instances.transports.InstancesGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_list_instances_async(transport: str = 'grpc_asyncio', request_type=appengine.ListInstancesRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(appengine.ListInstancesResponse(
            next_page_token='next_page_token_value',
        ))
...
@pytest.mark.asyncio
async def test_get_instance_async(transport: str = 'grpc_asyncio', request_type=appengine.GetInstanceRequest):
    client = InstancesAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_instance_async(transport: str = 'grpc_asyncio', request_type=appengine.DeleteInstanceRequest):
    client = InstancesAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_debug_instance(transport: str = 'grpc', request_type=appengine.DebugInstanceRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.debug_instance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_debug_instance_async(transport: str = 'grpc_asyncio', request_type=appengine.DebugInstanceRequest):
    client = InstancesAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_instances_base_transport():
    ...
    with mock.patch('google.cloud.appengine_v1.services.instances.transports.InstancesTransport.__init__') as Transport:
...
def test_instances_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.appengine_v1.services.instances.transports.InstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_instances_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.appengine_v1.services.instances.transports.InstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.InstancesTransport()
        adc.assert_called_once()
...
def test_instances_transport_auth_adc():
    ...
    with mock.patch.object(auth, 'default') as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.InstancesGrpcTransport(host="squid.clam.whelk", quota_project_id="octopus")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/appengine.admin',
            'https://www.googleapis.com/auth/cloud-platform',
            'https://www.googleapis.com/auth/cloud-platform.read-only',),
...
@pytest.mark.parametrize("transport_class", [transports.InstancesGrpcTransport, transports.InstancesGrpcAsyncIOTransport])
...
@pytest.mark.parametrize("transport_class", [transports.InstancesGrpcTransport, transports.InstancesGrpcAsyncIOTransport])
def test_instances_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.InstancesGrpcTransport, transports.InstancesGrpcAsyncIOTransport])
def test_instances_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_instance_path():
    ...
    expected = "apps/{app}/services/{service}/versions/{version}/instances/{instance}".format(app=app, service=service, version=version, instance=instance, )
