...
from google.cloud.appengine_v1.services.authorized_certificates import AuthorizedCertificatesAsyncClient
from google.cloud.appengine_v1.services.authorized_certificates import AuthorizedCertificatesClient
from google.cloud.appengine_v1.services.authorized_certificates import pagers
from google.cloud.appengine_v1.services.authorized_certificates import transports
from google.cloud.appengine_v1.types import appengine
from google.cloud.appengine_v1.types import certificate
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (AuthorizedCertificatesClient, transports.AuthorizedCertificatesGrpcTransport, "grpc"),
    (AuthorizedCertificatesAsyncClient, transports.AuthorizedCertificatesGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (AuthorizedCertificatesClient, transports.AuthorizedCertificatesGrpcTransport, "grpc", "true"),
    (AuthorizedCertificatesAsyncClient, transports.AuthorizedCertificatesGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (AuthorizedCertificatesClient, transports.AuthorizedCertificatesGrpcTransport, "grpc", "false"),
    (AuthorizedCertificatesAsyncClient, transports.AuthorizedCertificatesGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_authorized_certificates_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_authorized_certificates_client_client_options_from_dict():
    with mock.patch('google.cloud.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesGrpcTransport.__init__') as grpc_transport:
...
def test_list_authorized_certificates(transport: str = 'grpc', request_type=appengine.ListAuthorizedCertificatesRequest):
    client = AuthorizedCertificatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_authorized_certificates_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, certificate.AuthorizedCertificate)
                   for i in results)
...
def test_get_authorized_certificate(transport: str = 'grpc', request_type=appengine.GetAuthorizedCertificateRequest):
    client = AuthorizedCertificatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_authorized_certificate),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_authorized_certificate(transport: str = 'grpc', request_type=appengine.CreateAuthorizedCertificateRequest):
    client = AuthorizedCertificatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_authorized_certificate),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = certificate.AuthorizedCertificate(
            name='name_value',
...
def test_update_authorized_certificate(transport: str = 'grpc', request_type=appengine.UpdateAuthorizedCertificateRequest):
    client = AuthorizedCertificatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_authorized_certificate(transport: str = 'grpc', request_type=appengine.DeleteAuthorizedCertificateRequest):
    client = AuthorizedCertificatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_authorized_certificates_base_transport():
    ...
    with mock.patch('google.cloud.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesTransport.__init__') as Transport:
...
def test_authorized_certificates_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_authorized_certificates_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.AuthorizedCertificatesTransport()
        adc.assert_called_once()
...
def test_authorized_certificates_transport_auth_adc():
    ...
    with mock.patch.object(auth, 'default') as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.AuthorizedCertificatesGrpcTransport(host="squid.clam.whelk", quota_project_id="octopus")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/appengine.admin',
            'https://www.googleapis.com/auth/cloud-platform',
            'https://www.googleapis.com/auth/cloud-platform.read-only',),
