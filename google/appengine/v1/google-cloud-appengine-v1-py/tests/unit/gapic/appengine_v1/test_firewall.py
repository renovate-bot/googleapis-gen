...
from google.cloud.appengine_v1.services.firewall import FirewallAsyncClient
from google.cloud.appengine_v1.services.firewall import FirewallClient
from google.cloud.appengine_v1.services.firewall import pagers
from google.cloud.appengine_v1.services.firewall import transports
...
def test_firewall_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_firewall_client_client_options_from_dict():
    with mock.patch('google.cloud.appengine_v1.services.firewall.transports.FirewallGrpcTransport.__init__') as grpc_transport:
...
def test_firewall_base_transport():
    ...
    with mock.patch('google.cloud.appengine_v1.services.firewall.transports.FirewallTransport.__init__') as Transport:
...
def test_firewall_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.appengine_v1.services.firewall.transports.FirewallTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_firewall_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.appengine_v1.services.firewall.transports.FirewallTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.FirewallTransport()
        adc.assert_called_once()
