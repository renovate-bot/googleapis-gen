...
from google.cloud.appengine_v1.services.applications import ApplicationsAsyncClient
from google.cloud.appengine_v1.services.applications import ApplicationsClient
from google.cloud.appengine_v1.services.applications import transports
...
def test_applications_client_client_options_from_dict():
    with mock.patch('google.cloud.appengine_v1.services.applications.transports.ApplicationsGrpcTransport.__init__') as grpc_transport:
...
def test_applications_base_transport():
    ...
    with mock.patch('google.cloud.appengine_v1.services.applications.transports.ApplicationsTransport.__init__') as Transport:
...
def test_applications_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.appengine_v1.services.applications.transports.ApplicationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_applications_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.appengine_v1.services.applications.transports.ApplicationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ApplicationsTransport()
        adc.assert_called_once()
