...
class Version(proto.Message):
    ...
    Attributes:
        ...
        automatic_scaling (google.cloud.appengine_v1.types.AutomaticScaling):
        ...
        basic_scaling (google.cloud.appengine_v1.types.BasicScaling):
            ...
            activity.
        manual_scaling (google.cloud.appengine_v1.types.ManualScaling):
        ...
        inbound_services (Sequence[google.cloud.appengine_v1.types.InboundServiceType]):
        ...
        network (google.cloud.appengine_v1.types.Network):
        ...
        resources (google.cloud.appengine_v1.types.Resources):
        ...
        beta_settings (Sequence[google.cloud.appengine_v1.types.Version.BetaSettingsEntry]):
        ...
        serving_status (google.cloud.appengine_v1.types.ServingStatus):
        ...
        service_account (str):
            ...
            CLI flag.
        handlers (Sequence[google.cloud.appengine_v1.types.UrlMap]):
        ...
        error_handlers (Sequence[google.cloud.appengine_v1.types.ErrorHandler]):
            Custom static error pages. Limited to 10KB per page.

            Only returned in ``GET`` requests if ``view=FULL`` is set.
        libraries (Sequence[google.cloud.appengine_v1.types.Library]):
            Configuration for third-party Python runtime libraries that
            are required by the application.

            Only returned in ``GET`` requests if ``view=FULL`` is set.
        api_config (google.cloud.appengine_v1.types.ApiConfigHandler):
            Serving configuration for `Google Cloud
            Endpoints <https://cloud.google.com/appengine/docs/python/endpoints/>`__.

            Only returned in ``GET`` requests if ``view=FULL`` is set.
        env_variables (Sequence[google.cloud.appengine_v1.types.Version.EnvVariablesEntry]):
            Environment variables available to the application.

            Only returned in ``GET`` requests if ``view=FULL`` is set.
        build_env_variables (Sequence[google.cloud.appengine_v1.types.Version.BuildEnvVariablesEntry]):
        ...
        default_expiration (google.protobuf.duration_pb2.Duration):
            ...
            Only returned in ``GET`` requests if ``view=FULL`` is set.
        health_check (google.cloud.appengine_v1.types.HealthCheck):
            ...
            Only returned in ``GET`` requests if ``view=FULL`` is set.
        readiness_check (google.cloud.appengine_v1.types.ReadinessCheck):
            Configures readiness health checking for instances.
            Unhealthy instances are not put into the backend traffic
            rotation.

            Only returned in ``GET`` requests if ``view=FULL`` is set.
        liveness_check (google.cloud.appengine_v1.types.LivenessCheck):
        ...
        nobuild_files_regex (str):
            ...
            Only returned in ``GET`` requests if ``view=FULL`` is set.
        deployment (google.cloud.appengine_v1.types.Deployment):
        ...
        version_url (str):
            ...
            myapp.appspot.com"
            @OutputOnly
        endpoints_api_service (google.cloud.appengine_v1.types.EndpointsApiService):
            Cloud Endpoints configuration.

            If endpoints_api_service is set, the Cloud Endpoints
            Extensible Service Proxy will be provided to serve the API
            implemented by the app.
        entrypoint (google.cloud.appengine_v1.types.Entrypoint):
            The entrypoint for the application.
        vpc_access_connector (google.cloud.appengine_v1.types.VpcAccessConnector):
    ...
    automatic_scaling = proto.Field(proto.MESSAGE, number=3, oneof='scaling',
        message='AutomaticScaling',
    )

    basic_scaling = proto.Field(proto.MESSAGE, number=4, oneof='scaling',
        message='BasicScaling',
    )

    manual_scaling = proto.Field(proto.MESSAGE, number=5, oneof='scaling',
        message='ManualScaling',
    )

    inbound_services = proto.RepeatedField(proto.ENUM, number=6,
        enum='InboundServiceType',
    )

    instance_class = proto.Field(proto.STRING, number=7)

    network = proto.Field(proto.MESSAGE, number=8,
        message='Network',
    )

    zones = proto.RepeatedField(proto.STRING, number=118)

    resources = proto.Field(proto.MESSAGE, number=9,
        message='Resources',
    )
    ...
    serving_status = proto.Field(proto.ENUM, number=15,
        enum='ServingStatus',
    )

    created_by = proto.Field(proto.STRING, number=16)

    create_time = proto.Field(proto.MESSAGE, number=17,
    ...
    handlers = proto.RepeatedField(proto.MESSAGE, number=100,
        message=app_yaml.UrlMap,
    )

    error_handlers = proto.RepeatedField(proto.MESSAGE, number=101,
        message=app_yaml.ErrorHandler,
    )

    libraries = proto.RepeatedField(proto.MESSAGE, number=102,
        message=app_yaml.Library,
    )

    api_config = proto.Field(proto.MESSAGE, number=103,
    ...
    default_expiration = proto.Field(proto.MESSAGE, number=105,
        message=duration.Duration,
    )

    health_check = proto.Field(proto.MESSAGE, number=106,
        message=app_yaml.HealthCheck,
    )

    readiness_check = proto.Field(proto.MESSAGE, number=112,
        message=app_yaml.ReadinessCheck,
    )

    liveness_check = proto.Field(proto.MESSAGE, number=113,
        message=app_yaml.LivenessCheck,
    )

    nobuild_files_regex = proto.Field(proto.STRING, number=107)

    deployment = proto.Field(proto.MESSAGE, number=108,
        message=deploy.Deployment,
    )

    version_url = proto.Field(proto.STRING, number=109)

    endpoints_api_service = proto.Field(proto.MESSAGE, number=110,
        message='EndpointsApiService',
    )

    entrypoint = proto.Field(proto.MESSAGE, number=122,
        message='Entrypoint',
    )

    vpc_access_connector = proto.Field(proto.MESSAGE, number=121,
...
class EndpointsApiService(proto.Message):
    ...
    Attributes:
        ...
        config_id (str):
            ...
            omitted.
        rollout_strategy (google.cloud.appengine_v1.types.EndpointsApiService.RolloutStrategy):
    ...
    rollout_strategy = proto.Field(proto.ENUM, number=3,
...
class AutomaticScaling(proto.Message):
    ...
    Attributes:
        ...
        cpu_utilization (google.cloud.appengine_v1.types.CpuUtilization):
        ...
        min_pending_latency (google.protobuf.duration_pb2.Duration):
            ...
            instance to handle it.
        request_utilization (google.cloud.appengine_v1.types.RequestUtilization):
            Target scaling by request utilization.
        disk_utilization (google.cloud.appengine_v1.types.DiskUtilization):
            Target scaling by disk usage.
        network_utilization (google.cloud.appengine_v1.types.NetworkUtilization):
            Target scaling by network usage.
        standard_scheduler_settings (google.cloud.appengine_v1.types.StandardSchedulerSettings):
            Scheduler settings for standard environment.
    """

    cool_down_period = proto.Field(proto.MESSAGE, number=1,
        message=duration.Duration,
    )

    cpu_utilization = proto.Field(proto.MESSAGE, number=2,
    ...
    max_pending_latency = proto.Field(proto.MESSAGE, number=6,
        message=duration.Duration,
    )
    ...
    min_pending_latency = proto.Field(proto.MESSAGE, number=9,
        message=duration.Duration,
    )

    request_utilization = proto.Field(proto.MESSAGE, number=10,
        message='RequestUtilization',
    )

    disk_utilization = proto.Field(proto.MESSAGE, number=11,
        message='DiskUtilization',
    )

    network_utilization = proto.Field(proto.MESSAGE, number=12,
        message='NetworkUtilization',
    )

    standard_scheduler_settings = proto.Field(proto.MESSAGE, number=20,
...
class BasicScaling(proto.Message):
    ...
    idle_timeout = proto.Field(proto.MESSAGE, number=1,
        message=duration.Duration,
    )
...
class CpuUtilization(proto.Message):
    ...
    aggregation_window_length = proto.Field(proto.MESSAGE, number=1,
        message=duration.Duration,
    )
...
class Resources(proto.Message):
    ...
    Attributes:
        ...
        memory_gb (float):
            Memory (GB) needed.
        volumes (Sequence[google.cloud.appengine_v1.types.Volume]):
    ...
    volumes = proto.RepeatedField(proto.MESSAGE, number=4,
        message='Volume',
    )
