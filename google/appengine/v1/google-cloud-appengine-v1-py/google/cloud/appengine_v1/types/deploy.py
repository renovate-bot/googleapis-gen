...
class Deployment(proto.Message):
    ...
    Attributes:
        files (Sequence[google.cloud.appengine_v1.types.Deployment.FilesEntry]):
        ...
        container (google.cloud.appengine_v1.types.ContainerInfo):
        ...
        zip_ (google.cloud.appengine_v1.types.ZipInfo):
            The zip file for this deployment, if this is
            a zip deployment.
        cloud_build_options (google.cloud.appengine_v1.types.CloudBuildOptions):
