...
from google.cloud.appengine_v1.types import network_settings as ga_network_settings
...
class Service(proto.Message):
    ...
    Attributes:
        ...
        id (str):
            ...
            @OutputOnly
        split (google.cloud.appengine_v1.types.TrafficSplit):
            Mapping that defines fractional HTTP traffic
            diversion to different versions within the
            service.
        network_settings (google.cloud.appengine_v1.types.NetworkSettings):
...
class TrafficSplit(proto.Message):
    ...
    Attributes:
        shard_by (google.cloud.appengine_v1.types.TrafficSplit.ShardBy):
        ...
        allocations (Sequence[google.cloud.appengine_v1.types.TrafficSplit.AllocationsEntry]):
