...
class ApiConfigHandler(proto.Message):
    ...
    Attributes:
        auth_fail_action (google.cloud.appengine_v1.types.AuthFailAction):
            Action to take when users access resources that require
            authentication. Defaults to ``redirect``.
        login (google.cloud.appengine_v1.types.LoginRequirement):
            Level of login required to access this resource. Defaults to
            ``optional``.
        script (str):
            Path to the script from the application root
            directory.
        security_level (google.cloud.appengine_v1.types.SecurityLevel):
...
class ErrorHandler(proto.Message):
    ...
    Attributes:
        error_code (google.cloud.appengine_v1.types.ErrorHandler.ErrorCode):
...
class UrlMap(proto.Message):
    ...
    Attributes:
        ...
        static_files (google.cloud.appengine_v1.types.StaticFilesHandler):
            Returns the contents of a file, such as an
            image, as the response.
        script (google.cloud.appengine_v1.types.ScriptHandler):
            ...
            ``"script": "auto"``.
        api_endpoint (google.cloud.appengine_v1.types.ApiEndpointHandler):
        ...
        auth_fail_action (google.cloud.appengine_v1.types.AuthFailAction):
            Action to take when users access resources that require
            authentication. Defaults to ``redirect``.
        redirect_http_response_code (google.cloud.appengine_v1.types.UrlMap.RedirectHttpResponseCode):
...
class StaticFilesHandler(proto.Message):
    ...
    Attributes:
        ...
        upload_path_regex (str):
            ...
            this handler.
        http_headers (Sequence[google.cloud.appengine_v1.types.StaticFilesHandler.HttpHeadersEntry]):
