...
from google.cloud.appengine_v1.types import application as ga_application
from google.cloud.appengine_v1.types import certificate as ga_certificate
from google.cloud.appengine_v1.types import domain
from google.cloud.appengine_v1.types import domain_mapping as ga_domain_mapping
from google.cloud.appengine_v1.types import firewall
from google.cloud.appengine_v1.types import instance
from google.cloud.appengine_v1.types import service as ga_service
from google.cloud.appengine_v1.types import version as ga_version
...
class CreateApplicationRequest(proto.Message):
    ...
    Attributes:
        application (google.cloud.appengine_v1.types.Application):
            Application configuration.
    """

    application = proto.Field(proto.MESSAGE, number=2,
...
class ListServicesResponse(proto.Message):
    ...
    Attributes:
        services (Sequence[google.cloud.appengine_v1.types.Service]):
...
class UpdateServiceRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            ``apps/myapp/services/default``.
        service (google.cloud.appengine_v1.types.Service):
...
class ListVersionsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            ``apps/myapp/services/default``.
        view (google.cloud.appengine_v1.types.VersionView):
...
class ListVersionsResponse(proto.Message):
    ...
    Attributes:
        versions (Sequence[google.cloud.appengine_v1.types.Version]):
...
class CreateVersionRequest(proto.Message):
    ...
    Attributes:
        ...
        version (google.cloud.appengine_v1.types.Version):
...
class ListInstancesResponse(proto.Message):
    ...
    Attributes:
        instances (Sequence[google.cloud.appengine_v1.types.Instance]):
...
class ListIngressRulesResponse(proto.Message):
    ...
    Attributes:
        ingress_rules (Sequence[google.cloud.appengine_v1.types.FirewallRule]):
    ...
    ingress_rules = proto.RepeatedField(proto.MESSAGE, number=1,
...
class BatchUpdateIngressRulesRequest(proto.Message):
    ...
    ingress_rules = proto.RepeatedField(proto.MESSAGE, number=2,
        message=firewall.FirewallRule,
    )
...
class CreateIngressRuleRequest(proto.Message):
    ...
    Attributes:
        ...
        rule (google.cloud.appengine_v1.types.FirewallRule):
    ...
    rule = proto.Field(proto.MESSAGE, number=2,
        message=firewall.FirewallRule,
    )
...
class ListAuthorizedDomainsResponse(proto.Message):
    ...
    Attributes:
        domains (Sequence[google.cloud.appengine_v1.types.AuthorizedDomain]):
    ...
    domains = proto.RepeatedField(proto.MESSAGE, number=1,
...
class ListAuthorizedCertificatesRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Name of the parent ``Application`` resource. Example:
            ``apps/myapp``.
        view (google.cloud.appengine_v1.types.AuthorizedCertificateView):
            Controls the set of fields returned in the ``LIST``
            response.
        page_size (int):
            Maximum results to return per page.
...
class ListAuthorizedCertificatesResponse(proto.Message):
    ...
    Attributes:
        certificates (Sequence[google.cloud.appengine_v1.types.AuthorizedCertificate]):
    ...
    certificates = proto.RepeatedField(proto.MESSAGE, number=1,
...
class CreateAuthorizedCertificateRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Name of the parent ``Application`` resource. Example:
            ``apps/myapp``.
        certificate (google.cloud.appengine_v1.types.AuthorizedCertificate):
            SSL certificate data.
    """

    parent = proto.Field(proto.STRING, number=1)

    certificate = proto.Field(proto.MESSAGE, number=2,
        message=ga_certificate.AuthorizedCertificate,
    )
...
class ListDomainMappingsResponse(proto.Message):
    ...
    Attributes:
        domain_mappings (Sequence[google.cloud.appengine_v1.types.DomainMapping]):
    ...
    domain_mappings = proto.RepeatedField(proto.MESSAGE, number=1,
...
class CreateDomainMappingRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Name of the parent Application resource. Example:
            ``apps/myapp``.
        domain_mapping (google.cloud.appengine_v1.types.DomainMapping):
            Domain mapping configuration.
        override_strategy (google.cloud.appengine_v1.types.DomainOverrideStrategy):
    ...
    domain_mapping = proto.Field(proto.MESSAGE, number=2,
        message=ga_domain_mapping.DomainMapping,
    )

    override_strategy = proto.Field(proto.ENUM, number=4,
