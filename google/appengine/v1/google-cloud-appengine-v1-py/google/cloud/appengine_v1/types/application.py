...
class Application(proto.Message):
    ...
    Attributes:
        ...
        id (str):
            ...
            ``myapp``.
        dispatch_rules (Sequence[google.cloud.appengine_v1.types.UrlDispatchRule]):
        ...
        default_cookie_expiration (google.protobuf.duration_pb2.Duration):
            ...
            application.
        serving_status (google.cloud.appengine_v1.types.Application.ServingStatus):
        ...
        default_bucket (str):
            ...
            @OutputOnly
        iap (google.cloud.appengine_v1.types.Application.IdentityAwareProxy):

        gcr_domain (str):
            The Google Container Registry domain used for
            storing managed build docker images for this
            application.
        database_type (google.cloud.appengine_v1.types.Application.DatabaseType):
            The type of the Cloud Firestore or Cloud
            Datastore database associated with this
            application.
        feature_settings (google.cloud.appengine_v1.types.Application.FeatureSettings):
    ...
    dispatch_rules = proto.RepeatedField(proto.MESSAGE, number=3,
    ...
    default_cookie_expiration = proto.Field(proto.MESSAGE, number=9,
        message=duration.Duration,
    )

    serving_status = proto.Field(proto.ENUM, number=10,
        enum=ServingStatus,
    )
    ...
    iap = proto.Field(proto.MESSAGE, number=14,
        message=IdentityAwareProxy,
    )

    gcr_domain = proto.Field(proto.STRING, number=16)

    database_type = proto.Field(proto.ENUM, number=17,
        enum=DatabaseType,
    )

    feature_settings = proto.Field(proto.MESSAGE, number=18,
