...
class Instance(proto.Message):
    ...
    Attributes:
        ...
        app_engine_release (str):
            ...
            is running on.
        availability (google.cloud.appengine_v1.types.Instance.Availability):
        ...
        vm_liveness (google.cloud.appengine_v1.types.Instance.Liveness.LivenessState):
    ...
    availability = proto.Field(proto.ENUM, number=4,
        enum=Availability,
    )
    ...
    vm_liveness = proto.Field(proto.ENUM, number=17,
