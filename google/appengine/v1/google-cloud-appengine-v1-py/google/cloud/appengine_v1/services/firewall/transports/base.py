...
class FirewallTransport(abc.ABC):
    """Abstract transport class for Firewall."""
    ...
    @property
    def list_ingress_rules(self) -> typing.Callable[
    ...
    @property
    def batch_update_ingress_rules(self) -> typing.Callable[
    ...
    @property
    def create_ingress_rule(self) -> typing.Callable[
            [appengine.CreateIngressRuleRequest],
            typing.Union[
                firewall.FirewallRule,
                typing.Awaitable[firewall.FirewallRule]
            ]]:
        raise NotImplementedError()

    @property
    def get_ingress_rule(self) -> typing.Callable[
    ...
    @property
    def update_ingress_rule(self) -> typing.Callable[
    ...
    @property
    def delete_ingress_rule(self) -> typing.Callable[
