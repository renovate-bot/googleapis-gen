...
from google.cloud.appengine_v1.types import deploy
from google.cloud.appengine_v1.types import operation as ga_operation
from google.cloud.appengine_v1.types import version
...
class VersionsAsyncClient:
    ...
    async def list_versions(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.ListVersionsRequest`):
        ...
        Returns:
            google.cloud.appengine_v1.services.versions.pagers.ListVersionsAsyncPager:
    ...
    async def get_version(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.GetVersionRequest`):
                The request object. Request message for
                `Versions.GetVersion`.
        ...
        Returns:
            google.cloud.appengine_v1.types.Version:
    ...
    async def create_version(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.CreateVersionRequest`):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.appengine_v1.types.Version` A Version resource is a specific set of source code and configuration files
                   that are deployed into a service.
    ...
    async def update_version(self,
        ...
        *manual scaling* in the flexible environment:
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.UpdateVersionRequest`):
                The request object. Request message for
    ...
    async def delete_version(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.DeleteVersionRequest`):
                The request object. Request message for
