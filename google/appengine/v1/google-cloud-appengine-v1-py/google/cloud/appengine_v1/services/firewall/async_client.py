...
class FirewallAsyncClient:
    ...
    async def list_ingress_rules(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.ListIngressRulesRequest`):
        ...
        Returns:
            google.cloud.appengine_v1.services.firewall.pagers.ListIngressRulesAsyncPager:
    ...
    async def batch_update_ingress_rules(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.BatchUpdateIngressRulesRequest`):
                The request object. Request message for
        ...
        Returns:
            google.cloud.appengine_v1.types.BatchUpdateIngressRulesResponse:
    ...
    async def create_ingress_rule(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.CreateIngressRuleRequest`):
                The request object. Request message for
        ...
        Returns:
            google.cloud.appengine_v1.types.FirewallRule:
    ...
    async def get_ingress_rule(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.GetIngressRuleRequest`):
                The request object. Request message for
    ...
    async def update_ingress_rule(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.UpdateIngressRuleRequest`):
                The request object. Request message for
    ...
    async def delete_ingress_rule(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.DeleteIngressRuleRequest`):
                The request object. Request message for
