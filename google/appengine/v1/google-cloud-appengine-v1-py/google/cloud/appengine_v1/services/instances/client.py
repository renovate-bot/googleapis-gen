...
class InstancesClient(metaclass=InstancesClientMeta):
    ...
    def instance_path(app: str,service: str,version: str,instance: str,) -> str:
        ...
        return "apps/{app}/services/{service}/versions/{version}/instances/{instance}".format(app=app, service=service, version=version, instance=instance, )

    @staticmethod
    def parse_instance_path(path: str) -> Dict[str,str]:
        """Parse a instance path into its component segments."""
        m = re.match(r"^apps/(?P<app>.+?)/services/(?P<service>.+?)/versions/(?P<version>.+?)/instances/(?P<instance>.+?)$", path)
    ...
    def list_instances(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.ListInstancesRequest):
        ...
        Returns:
            google.cloud.appengine_v1.services.instances.pagers.ListInstancesPager:
    ...
    def get_instance(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.GetInstanceRequest):
                The request object. Request message for
        ...
        Returns:
            google.cloud.appengine_v1.types.Instance:
    ...
    def delete_instance(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.DeleteInstanceRequest):
                The request object. Request message for
    ...
    def debug_instance(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.DebugInstanceRequest):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.appengine_v1.types.Instance` An Instance resource is the computing unit that App Engine uses to
                   automatically scale an application.
