...
class ListAuthorizedCertificatesPager:
    ...
    :class:`google.cloud.appengine_v1.types.ListAuthorizedCertificatesResponse` object, and
    ...
    All the usual :class:`google.cloud.appengine_v1.types.ListAuthorizedCertificatesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.appengine_v1.types.ListAuthorizedCertificatesRequest):
                The initial request object.
            response (google.cloud.appengine_v1.types.ListAuthorizedCertificatesResponse):
...
class ListAuthorizedCertificatesAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterable[appengine.ListAuthorizedCertificatesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
