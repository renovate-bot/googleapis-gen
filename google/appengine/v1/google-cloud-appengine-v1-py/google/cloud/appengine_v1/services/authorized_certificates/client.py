...
class AuthorizedCertificatesClient(metaclass=AuthorizedCertificatesClientMeta):
    ...
    def list_authorized_certificates(self,
        ...
        Returns:
            google.cloud.appengine_v1.services.authorized_certificates.pagers.ListAuthorizedCertificatesPager:
    ...
    def get_authorized_certificate(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.GetAuthorizedCertificateRequest):
                The request object. Request message for
    ...
    def create_authorized_certificate(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.CreateAuthorizedCertificateRequest):
                The request object. Request message for
    ...
    def update_authorized_certificate(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.UpdateAuthorizedCertificateRequest):
                The request object. Request message for
    ...
    def delete_authorized_certificate(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.DeleteAuthorizedCertificateRequest):
                The request object. Request message for
