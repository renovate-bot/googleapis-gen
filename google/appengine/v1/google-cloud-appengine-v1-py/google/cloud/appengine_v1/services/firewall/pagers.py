...
class ListIngressRulesPager:
    ...
    :class:`google.cloud.appengine_v1.types.ListIngressRulesResponse` object, and
    ...
    All the usual :class:`google.cloud.appengine_v1.types.ListIngressRulesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.appengine_v1.types.ListIngressRulesResponse):
