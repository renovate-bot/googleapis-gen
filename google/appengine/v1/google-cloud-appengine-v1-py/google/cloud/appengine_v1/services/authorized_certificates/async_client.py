...
class AuthorizedCertificatesAsyncClient:
    ...
    async def list_authorized_certificates(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.ListAuthorizedCertificatesRequest`):
        ...
        Returns:
            google.cloud.appengine_v1.services.authorized_certificates.pagers.ListAuthorizedCertificatesAsyncPager:
    ...
    async def get_authorized_certificate(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.GetAuthorizedCertificateRequest`):
                The request object. Request message for
        ...
        Returns:
            google.cloud.appengine_v1.types.AuthorizedCertificate:
    ...
    async def create_authorized_certificate(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.CreateAuthorizedCertificateRequest`):
                The request object. Request message for
    ...
    async def update_authorized_certificate(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.UpdateAuthorizedCertificateRequest`):
                The request object. Request message for
    ...
    async def delete_authorized_certificate(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.DeleteAuthorizedCertificateRequest`):
                The request object. Request message for
