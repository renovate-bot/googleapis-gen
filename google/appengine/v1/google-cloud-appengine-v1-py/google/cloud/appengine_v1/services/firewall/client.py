...
class FirewallClient(metaclass=FirewallClientMeta):
    ...
    def list_ingress_rules(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.ListIngressRulesRequest):
        ...
        Returns:
            google.cloud.appengine_v1.services.firewall.pagers.ListIngressRulesPager:
    ...
    def batch_update_ingress_rules(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.BatchUpdateIngressRulesRequest):
                The request object. Request message for
    ...
    def create_ingress_rule(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.CreateIngressRuleRequest):
                The request object. Request message for
    ...
    def get_ingress_rule(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.GetIngressRuleRequest):
                The request object. Request message for
    ...
    def update_ingress_rule(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.UpdateIngressRuleRequest):
                The request object. Request message for
    ...
    def delete_ingress_rule(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.DeleteIngressRuleRequest):
                The request object. Request message for
