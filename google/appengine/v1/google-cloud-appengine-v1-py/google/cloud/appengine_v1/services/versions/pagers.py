...
class ListVersionsPager:
    ...
    :class:`google.cloud.appengine_v1.types.ListVersionsResponse` object, and
    ...
    All the usual :class:`google.cloud.appengine_v1.types.ListVersionsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.appengine_v1.types.ListVersionsResponse):
