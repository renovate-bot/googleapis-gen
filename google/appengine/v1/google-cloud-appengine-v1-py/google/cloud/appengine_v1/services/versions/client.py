...
class VersionsClient(metaclass=VersionsClientMeta):
    ...
    def list_versions(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.ListVersionsRequest):
        ...
        Returns:
            google.cloud.appengine_v1.services.versions.pagers.ListVersionsPager:
    ...
    def get_version(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.GetVersionRequest):
                The request object. Request message for
                `Versions.GetVersion`.
    ...
    def create_version(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.CreateVersionRequest):
                The request object. Request message for
    ...
    def update_version(self,
        ...
        *manual scaling* in the flexible environment:
        ...
        Args:
            request (google.cloud.appengine_v1.types.UpdateVersionRequest):
                The request object. Request message for
    ...
    def delete_version(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.DeleteVersionRequest):
                The request object. Request message for
