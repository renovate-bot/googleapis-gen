...
class AuthorizedCertificatesGrpcAsyncIOTransport(AuthorizedCertificatesTransport):
    """gRPC AsyncIO backend transport for AuthorizedCertificates.
    ...
    def list_authorized_certificates(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListAuthorizedCertificatesRequest],
                    Awaitable[~.ListAuthorizedCertificatesResponse]]:
        ...
        if 'list_authorized_certificates' not in self._stubs:
            self._stubs['list_authorized_certificates'] = self.grpc_channel.unary_unary(
    ...
    def get_authorized_certificate(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetAuthorizedCertificateRequest],
                    Awaitable[~.AuthorizedCertificate]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if 'get_authorized_certificate' not in self._stubs:
            self._stubs['get_authorized_certificate'] = self.grpc_channel.unary_unary(
    ...
    def create_authorized_certificate(self) -> Callable[
        ...
        Returns:
            Callable[[~.CreateAuthorizedCertificateRequest],
                    Awaitable[~.AuthorizedCertificate]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if 'create_authorized_certificate' not in self._stubs:
            self._stubs['create_authorized_certificate'] = self.grpc_channel.unary_unary(
    ...
    def update_authorized_certificate(self) -> Callable[
        ...
        Returns:
            Callable[[~.UpdateAuthorizedCertificateRequest],
                    Awaitable[~.AuthorizedCertificate]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if 'update_authorized_certificate' not in self._stubs:
            self._stubs['update_authorized_certificate'] = self.grpc_channel.unary_unary(
    ...
    def delete_authorized_certificate(self) -> Callable[
        ...
        Returns:
            Callable[[~.DeleteAuthorizedCertificateRequest],
                    Awaitable[~.Empty]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if 'delete_authorized_certificate' not in self._stubs:
            self._stubs['delete_authorized_certificate'] = self.grpc_channel.unary_unary(
