...
class ApplicationsAsyncClient:
    ...
    async def get_application(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.GetApplicationRequest`):
    ...
    async def create_application(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.CreateApplicationRequest`):
                The request object. Request message for
    ...
    async def update_application(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.UpdateApplicationRequest`):
                The request object. Request message for
    ...
    async def repair_application(self,
        ...
        Args:
            request (:class:`google.cloud.appengine_v1.types.RepairApplicationRequest`):
                The request object. Request message for
