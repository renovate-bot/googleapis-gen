...
class ServicesClient(metaclass=ServicesClientMeta):
    ...
    def list_services(self,
        ...
        Returns:
            google.cloud.appengine_v1.services.services.pagers.ListServicesPager:
    ...
    def get_service(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.GetServiceRequest):
                The request object. Request message for
                `Services.GetService`.
    ...
    def delete_service(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.DeleteServiceRequest):
                The request object. Request message for
