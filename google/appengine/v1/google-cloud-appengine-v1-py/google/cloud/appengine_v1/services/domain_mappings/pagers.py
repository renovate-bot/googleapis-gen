...
class ListDomainMappingsPager:
    ...
    :class:`google.cloud.appengine_v1.types.ListDomainMappingsResponse` object, and
    ...
    All the usual :class:`google.cloud.appengine_v1.types.ListDomainMappingsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.appengine_v1.types.ListDomainMappingsRequest):
                The initial request object.
            response (google.cloud.appengine_v1.types.ListDomainMappingsResponse):
