...
class ApplicationsClientMeta(type):
    """Metaclass for the Applications client.
...
class ApplicationsClient(metaclass=ApplicationsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ApplicationsClient: The constructed client.
        """
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, ApplicationsTransport):
            # transport is a ApplicationsTransport instance.
    ...
    def get_application(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.GetApplicationRequest):
        ...
        Returns:
            google.cloud.appengine_v1.types.Application:
    ...
    def create_application(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.CreateApplicationRequest):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.appengine_v1.types.Application` An Application resource contains the top-level configuration of an App
                   Engine application.
    ...
    def update_application(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.UpdateApplicationRequest):
                The request object. Request message for
    ...
    def repair_application(self,
        ...
        Args:
            request (google.cloud.appengine_v1.types.RepairApplicationRequest):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.repair_application]
