...
class DomainMappingsClientMeta(type):
    """Metaclass for the DomainMappings client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[DomainMappingsTransport]]
...
class DomainMappingsClient(metaclass=DomainMappingsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DomainMappingsClient: The constructed client.
        """
    ...
    def __init__(self, *,
        ...
        """Instantiate the domain mappings client.
        ...
        if isinstance(transport, DomainMappingsTransport):
            # transport is a DomainMappingsTransport instance.
    ...
    def list_domain_mappings(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_domain_mappings]
    ...
    def get_domain_mapping(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_domain_mapping]
    ...
    def create_domain_mapping(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_domain_mapping]
    ...
    def update_domain_mapping(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_domain_mapping]
    ...
    def delete_domain_mapping(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_domain_mapping]
