...
from .base import AuthorizedDomainsTransport, DEFAULT_CLIENT_INFO
from .grpc import AuthorizedDomainsGrpcTransport


class AuthorizedDomainsGrpcAsyncIOTransport(AuthorizedDomainsTransport):
    ...
    def list_authorized_domains(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListAuthorizedDomainsRequest],
                    Awaitable[~.ListAuthorizedDomainsResponse]]:
        ...
        if 'list_authorized_domains' not in self._stubs:
            self._stubs['list_authorized_domains'] = self.grpc_channel.unary_unary(
                '/google.appengine.v1.AuthorizedDomains/ListAuthorizedDomains',
                request_serializer=appengine.ListAuthorizedDomainsRequest.serialize,
                response_deserializer=appengine.ListAuthorizedDomainsResponse.deserialize,
            )
