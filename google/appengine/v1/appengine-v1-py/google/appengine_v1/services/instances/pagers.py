...
class ListInstancesPager:
    ...
    :class:`google.appengine_v1.types.ListInstancesResponse` object, and
    ...
    All the usual :class:`google.appengine_v1.types.ListInstancesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.appengine_v1.types.ListInstancesResponse):
