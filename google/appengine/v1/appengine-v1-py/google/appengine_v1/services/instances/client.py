...
class InstancesClient(metaclass=InstancesClientMeta):
    ...
    def list_instances(self,
        ...
        Args:
            request (google.appengine_v1.types.ListInstancesRequest):
        ...
        Returns:
            google.appengine_v1.services.instances.pagers.ListInstancesPager:
    ...
    def get_instance(self,
        ...
        Args:
            request (google.appengine_v1.types.GetInstanceRequest):
                The request object. Request message for
    ...
    def delete_instance(self,
        ...
        Args:
            request (google.appengine_v1.types.DeleteInstanceRequest):
                The request object. Request message for
    ...
    def debug_instance(self,
        ...
        Args:
            request (google.appengine_v1.types.DebugInstanceRequest):
                The request object. Request message for
