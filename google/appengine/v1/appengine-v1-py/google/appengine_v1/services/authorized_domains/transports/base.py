...
class AuthorizedDomainsTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_authorized_domains: gapic_v1.method.wrap_method(
                self.list_authorized_domains,
    ...
    @property
    def list_authorized_domains(self) -> typing.Callable[
            [appengine.ListAuthorizedDomainsRequest],
            typing.Union[
                appengine.ListAuthorizedDomainsResponse,
                typing.Awaitable[appengine.ListAuthorizedDomainsResponse]
            ]]:
