...
from google.appengine_v1.services.authorized_domains import pagers
...
class AuthorizedDomainsClientMeta(type):
    """Metaclass for the AuthorizedDomains client.
...
class AuthorizedDomainsClient(metaclass=AuthorizedDomainsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AuthorizedDomainsClient: The constructed client.
        """
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, AuthorizedDomainsTransport):
            # transport is a AuthorizedDomainsTransport instance.
    ...
    def list_authorized_domains(self,
        ...
        Returns:
            google.appengine_v1.services.authorized_domains.pagers.ListAuthorizedDomainsPager:
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_authorized_domains]
