...
class AuthorizedDomainsAsyncClient:
    ...
    async def list_authorized_domains(self,
        ...
        Args:
            request (:class:`google.appengine_v1.types.ListAuthorizedDomainsRequest`):
        ...
        Returns:
            google.appengine_v1.services.authorized_domains.pagers.ListAuthorizedDomainsAsyncPager:
