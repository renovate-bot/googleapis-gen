...
class ListIngressRulesPager:
    ...
    :class:`google.appengine_v1.types.ListIngressRulesResponse` object, and
    ...
    All the usual :class:`google.appengine_v1.types.ListIngressRulesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.appengine_v1.types.ListIngressRulesResponse):
