...
class ListAuthorizedCertificatesPager:
    ...
    :class:`google.appengine_v1.types.ListAuthorizedCertificatesResponse` object, and
    ...
    All the usual :class:`google.appengine_v1.types.ListAuthorizedCertificatesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.appengine_v1.types.ListAuthorizedCertificatesResponse):
