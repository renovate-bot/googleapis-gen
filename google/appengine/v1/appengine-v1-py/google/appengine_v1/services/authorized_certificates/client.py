...
from google.appengine_v1.services.authorized_certificates import pagers
from google.appengine_v1.types import appengine
from google.appengine_v1.types import certificate
...
class AuthorizedCertificatesClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AuthorizedCertificatesTransport]]
...
class AuthorizedCertificatesClient(metaclass=AuthorizedCertificatesClientMeta):
    ...
    def __init__(self, *,
        ...
        """Instantiate the authorized certificates client.
    ...
    def list_authorized_certificates(self,
        ...
        Args:
            request (google.appengine_v1.types.ListAuthorizedCertificatesRequest):
        ...
        Returns:
            google.appengine_v1.services.authorized_certificates.pagers.ListAuthorizedCertificatesPager:
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_authorized_certificates]
    ...
    def get_authorized_certificate(self,
        ...
        Args:
            request (google.appengine_v1.types.GetAuthorizedCertificateRequest):
                The request object. Request message for
        ...
        Returns:
            google.appengine_v1.types.AuthorizedCertificate:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_authorized_certificate]
    ...
    def create_authorized_certificate(self,
        ...
        Args:
            request (google.appengine_v1.types.CreateAuthorizedCertificateRequest):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_authorized_certificate]
    ...
    def update_authorized_certificate(self,
        ...
        Args:
            request (google.appengine_v1.types.UpdateAuthorizedCertificateRequest):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_authorized_certificate]
    ...
    def delete_authorized_certificate(self,
        ...
        Args:
            request (google.appengine_v1.types.DeleteAuthorizedCertificateRequest):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_authorized_certificate]
