...
class ApplicationsAsyncClient:
    ...
    async def get_application(self,
        ...
        Args:
            request (:class:`google.appengine_v1.types.GetApplicationRequest`):
        ...
        Returns:
            google.appengine_v1.types.Application:
    ...
    async def create_application(self,
        ...
        Args:
            request (:class:`google.appengine_v1.types.CreateApplicationRequest`):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.appengine_v1.types.Application` An Application resource contains the top-level configuration of an App
                   Engine application.
    ...
    async def update_application(self,
        ...
        Args:
            request (:class:`google.appengine_v1.types.UpdateApplicationRequest`):
                The request object. Request message for
    ...
    async def repair_application(self,
        ...
        Args:
            request (:class:`google.appengine_v1.types.RepairApplicationRequest`):
                The request object. Request message for
