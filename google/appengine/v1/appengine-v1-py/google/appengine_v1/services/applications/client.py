...
class ApplicationsClient(metaclass=ApplicationsClientMeta):
    ...
    def get_application(self,
        ...
        Args:
            request (google.appengine_v1.types.GetApplicationRequest):
    ...
    def create_application(self,
        ...
        Args:
            request (google.appengine_v1.types.CreateApplicationRequest):
                The request object. Request message for
    ...
    def update_application(self,
        ...
        Args:
            request (google.appengine_v1.types.UpdateApplicationRequest):
                The request object. Request message for
    ...
    def repair_application(self,
        ...
        Args:
            request (google.appengine_v1.types.RepairApplicationRequest):
                The request object. Request message for
