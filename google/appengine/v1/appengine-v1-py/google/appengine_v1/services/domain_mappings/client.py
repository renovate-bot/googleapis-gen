...
class DomainMappingsClient(metaclass=DomainMappingsClientMeta):
    ...
    def list_domain_mappings(self,
        ...
        Returns:
            google.appengine_v1.services.domain_mappings.pagers.ListDomainMappingsPager:
    ...
    def get_domain_mapping(self,
        ...
        Args:
            request (google.appengine_v1.types.GetDomainMappingRequest):
                The request object. Request message for
    ...
    def create_domain_mapping(self,
        ...
        Args:
            request (google.appengine_v1.types.CreateDomainMappingRequest):
                The request object. Request message for
    ...
    def update_domain_mapping(self,
        ...
        Args:
            request (google.appengine_v1.types.UpdateDomainMappingRequest):
                The request object. Request message for
    ...
    def delete_domain_mapping(self,
        ...
        Args:
            request (google.appengine_v1.types.DeleteDomainMappingRequest):
                The request object. Request message for
