...
from google.appengine_v1.types import domain_mapping
...
class ListDomainMappingsPager:
    ...
    :class:`google.appengine_v1.types.ListDomainMappingsResponse` object, and
    ...
    All the usual :class:`google.appengine_v1.types.ListDomainMappingsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.appengine_v1.types.ListDomainMappingsRequest):
                The initial request object.
            response (google.appengine_v1.types.ListDomainMappingsResponse):
