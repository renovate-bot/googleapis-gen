...
from google.appengine_v1.services.domain_mappings import pagers
...
class DomainMappingsAsyncClient:
    ...
    async def list_domain_mappings(self,
        ...
        Args:
            request (:class:`google.appengine_v1.types.ListDomainMappingsRequest`):
        ...
        Returns:
            google.appengine_v1.services.domain_mappings.pagers.ListDomainMappingsAsyncPager:
    ...
    async def get_domain_mapping(self,
        ...
        Args:
            request (:class:`google.appengine_v1.types.GetDomainMappingRequest`):
                The request object. Request message for
        ...
        Returns:
            google.appengine_v1.types.DomainMapping:
    ...
    async def create_domain_mapping(self,
        ...
        Args:
            request (:class:`google.appengine_v1.types.CreateDomainMappingRequest`):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.appengine_v1.types.DomainMapping` A
    ...
    async def update_domain_mapping(self,
        ...
        Args:
            request (:class:`google.appengine_v1.types.UpdateDomainMappingRequest`):
                The request object. Request message for
    ...
    async def delete_domain_mapping(self,
        ...
        Args:
            request (:class:`google.appengine_v1.types.DeleteDomainMappingRequest`):
                The request object. Request message for
