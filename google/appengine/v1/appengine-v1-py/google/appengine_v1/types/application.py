...
class Application(proto.Message):
    ...
    Attributes:
        ...
        id (str):
            ...
            ``myapp``.
        dispatch_rules (Sequence[google.appengine_v1.types.UrlDispatchRule]):
        ...
        default_cookie_expiration (google.protobuf.duration_pb2.Duration):
            ...
            application.
        serving_status (google.appengine_v1.types.Application.ServingStatus):
        ...
        default_bucket (str):
            ...
            @OutputOnly
        iap (google.appengine_v1.types.Application.IdentityAwareProxy):

        gcr_domain (str):
            The Google Container Registry domain used for
            storing managed build docker images for this
            application.
        database_type (google.appengine_v1.types.Application.DatabaseType):
            The type of the Cloud Firestore or Cloud
            Datastore database associated with this
            application.
        feature_settings (google.appengine_v1.types.Application.FeatureSettings):
