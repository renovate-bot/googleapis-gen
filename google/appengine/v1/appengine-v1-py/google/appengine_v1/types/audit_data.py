...
class AuditData(proto.Message):
    ...
    Attributes:
        update_service (google.appengine_v1.types.UpdateServiceMethod):
            Detailed information about UpdateService
            call.
        create_version (google.appengine_v1.types.CreateVersionMethod):
...
class UpdateServiceMethod(proto.Message):
    ...
    Attributes:
        request (google.appengine_v1.types.UpdateServiceRequest):
