...
from google.appengine_v1.types import network_settings as ga_network_settings
...
class Service(proto.Message):
    ...
    Attributes:
        ...
        id (str):
            ...
            @OutputOnly
        split (google.appengine_v1.types.TrafficSplit):
            Mapping that defines fractional HTTP traffic
            diversion to different versions within the
            service.
        network_settings (google.appengine_v1.types.NetworkSettings):
    ...
    split = proto.Field(proto.MESSAGE, number=3,
        message='TrafficSplit',
    )

    network_settings = proto.Field(proto.MESSAGE, number=6,
...
class TrafficSplit(proto.Message):
    ...
    Attributes:
        shard_by (google.appengine_v1.types.TrafficSplit.ShardBy):
        ...
        allocations (Sequence[google.appengine_v1.types.TrafficSplit.AllocationsEntry]):
    ...
    shard_by = proto.Field(proto.ENUM, number=1,
        enum=ShardBy,
    )
