...
class DomainMapping(proto.Message):
    ...
    Attributes:
        ...
        id (str):
            ...
            Example: ``example.com``.
        ssl_settings (google.appengine_v1.types.SslSettings):
            SSL configuration for this domain. If
            unconfigured, this domain will not serve with
            SSL.
        resource_records (Sequence[google.appengine_v1.types.ResourceRecord]):
...
class SslSettings(proto.Message):
    ...
    Attributes:
        certificate_id (str):
            ...
            Example: ``12345``.
        ssl_management_type (google.appengine_v1.types.SslSettings.SslManagementType):
...
class ResourceRecord(proto.Message):
    ...
    Attributes:
        ...
        rrdata (str):
            ...
            1034 (section 3.6.1).
        type_ (google.appengine_v1.types.ResourceRecord.RecordType):
