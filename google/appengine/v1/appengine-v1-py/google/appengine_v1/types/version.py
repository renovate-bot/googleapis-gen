...
class Version(proto.Message):
    ...
    Attributes:
        ...
        automatic_scaling (google.appengine_v1.types.AutomaticScaling):
        ...
        basic_scaling (google.appengine_v1.types.BasicScaling):
            ...
            activity.
        manual_scaling (google.appengine_v1.types.ManualScaling):
        ...
        inbound_services (Sequence[google.appengine_v1.types.InboundServiceType]):
        ...
        network (google.appengine_v1.types.Network):
        ...
        resources (google.appengine_v1.types.Resources):
        ...
        beta_settings (Sequence[google.appengine_v1.types.Version.BetaSettingsEntry]):
        ...
        serving_status (google.appengine_v1.types.ServingStatus):
        ...
        service_account (str):
            ...
            CLI flag.
        handlers (Sequence[google.appengine_v1.types.UrlMap]):
        ...
        error_handlers (Sequence[google.appengine_v1.types.ErrorHandler]):
            Custom static error pages. Limited to 10KB per page.

            Only returned in ``GET`` requests if ``view=FULL`` is set.
        libraries (Sequence[google.appengine_v1.types.Library]):
            Configuration for third-party Python runtime libraries that
            are required by the application.

            Only returned in ``GET`` requests if ``view=FULL`` is set.
        api_config (google.appengine_v1.types.ApiConfigHandler):
            Serving configuration for `Google Cloud
            Endpoints <https://cloud.google.com/appengine/docs/python/endpoints/>`__.

            Only returned in ``GET`` requests if ``view=FULL`` is set.
        env_variables (Sequence[google.appengine_v1.types.Version.EnvVariablesEntry]):
            Environment variables available to the application.

            Only returned in ``GET`` requests if ``view=FULL`` is set.
        build_env_variables (Sequence[google.appengine_v1.types.Version.BuildEnvVariablesEntry]):
        ...
        default_expiration (google.protobuf.duration_pb2.Duration):
            ...
            Only returned in ``GET`` requests if ``view=FULL`` is set.
        health_check (google.appengine_v1.types.HealthCheck):
            ...
            Only returned in ``GET`` requests if ``view=FULL`` is set.
        readiness_check (google.appengine_v1.types.ReadinessCheck):
            Configures readiness health checking for instances.
            Unhealthy instances are not put into the backend traffic
            rotation.

            Only returned in ``GET`` requests if ``view=FULL`` is set.
        liveness_check (google.appengine_v1.types.LivenessCheck):
        ...
        nobuild_files_regex (str):
            ...
            Only returned in ``GET`` requests if ``view=FULL`` is set.
        deployment (google.appengine_v1.types.Deployment):
        ...
        version_url (str):
            ...
            myapp.appspot.com"
            @OutputOnly
        endpoints_api_service (google.appengine_v1.types.EndpointsApiService):
            Cloud Endpoints configuration.

            If endpoints_api_service is set, the Cloud Endpoints
            Extensible Service Proxy will be provided to serve the API
            implemented by the app.
        entrypoint (google.appengine_v1.types.Entrypoint):
            The entrypoint for the application.
        vpc_access_connector (google.appengine_v1.types.VpcAccessConnector):
...
class EndpointsApiService(proto.Message):
    ...
    Attributes:
        ...
        config_id (str):
            ...
            omitted.
        rollout_strategy (google.appengine_v1.types.EndpointsApiService.RolloutStrategy):
...
class AutomaticScaling(proto.Message):
    ...
    Attributes:
        ...
        cpu_utilization (google.appengine_v1.types.CpuUtilization):
        ...
        min_pending_latency (google.protobuf.duration_pb2.Duration):
            ...
            instance to handle it.
        request_utilization (google.appengine_v1.types.RequestUtilization):
            Target scaling by request utilization.
        disk_utilization (google.appengine_v1.types.DiskUtilization):
            Target scaling by disk usage.
        network_utilization (google.appengine_v1.types.NetworkUtilization):
            Target scaling by network usage.
        standard_scheduler_settings (google.appengine_v1.types.StandardSchedulerSettings):
...
class Resources(proto.Message):
    ...
    Attributes:
        ...
        memory_gb (float):
            Memory (GB) needed.
        volumes (Sequence[google.appengine_v1.types.Volume]):
