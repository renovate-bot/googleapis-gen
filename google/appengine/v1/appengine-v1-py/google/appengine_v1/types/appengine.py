...
from google.appengine_v1.types import application as ga_application
from google.appengine_v1.types import certificate as ga_certificate
from google.appengine_v1.types import domain
from google.appengine_v1.types import domain_mapping as ga_domain_mapping
from google.appengine_v1.types import firewall
from google.appengine_v1.types import instance
from google.appengine_v1.types import service as ga_service
from google.appengine_v1.types import version as ga_version
...
class CreateApplicationRequest(proto.Message):
    ...
    Attributes:
        application (google.appengine_v1.types.Application):
...
class ListServicesResponse(proto.Message):
    ...
    Attributes:
        services (Sequence[google.appengine_v1.types.Service]):
...
class UpdateServiceRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            ``apps/myapp/services/default``.
        service (google.appengine_v1.types.Service):
...
class ListVersionsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            ``apps/myapp/services/default``.
        view (google.appengine_v1.types.VersionView):
...
class ListVersionsResponse(proto.Message):
    ...
    Attributes:
        versions (Sequence[google.appengine_v1.types.Version]):
...
class CreateVersionRequest(proto.Message):
    ...
    Attributes:
        ...
        version (google.appengine_v1.types.Version):
...
class ListInstancesResponse(proto.Message):
    ...
    Attributes:
        instances (Sequence[google.appengine_v1.types.Instance]):
...
class ListIngressRulesResponse(proto.Message):
    ...
    Attributes:
        ingress_rules (Sequence[google.appengine_v1.types.FirewallRule]):
...
class CreateIngressRuleRequest(proto.Message):
    ...
    Attributes:
        ...
        rule (google.appengine_v1.types.FirewallRule):
...
class ListAuthorizedDomainsResponse(proto.Message):
    ...
    Attributes:
        domains (Sequence[google.appengine_v1.types.AuthorizedDomain]):
...
class ListAuthorizedCertificatesRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Name of the parent ``Application`` resource. Example:
            ``apps/myapp``.
        view (google.appengine_v1.types.AuthorizedCertificateView):
            Controls the set of fields returned in the ``LIST``
            response.
        page_size (int):
            Maximum results to return per page.
...
class ListAuthorizedCertificatesResponse(proto.Message):
    ...
    Attributes:
        certificates (Sequence[google.appengine_v1.types.AuthorizedCertificate]):
...
class CreateAuthorizedCertificateRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Name of the parent ``Application`` resource. Example:
            ``apps/myapp``.
        certificate (google.appengine_v1.types.AuthorizedCertificate):
...
class ListDomainMappingsResponse(proto.Message):
    ...
    Attributes:
        domain_mappings (Sequence[google.appengine_v1.types.DomainMapping]):
...
class CreateDomainMappingRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Name of the parent Application resource. Example:
            ``apps/myapp``.
        domain_mapping (google.appengine_v1.types.DomainMapping):
            Domain mapping configuration.
        override_strategy (google.appengine_v1.types.DomainOverrideStrategy):
