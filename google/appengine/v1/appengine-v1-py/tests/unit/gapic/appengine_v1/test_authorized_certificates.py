...
from google.appengine_v1.services.authorized_certificates import AuthorizedCertificatesAsyncClient
from google.appengine_v1.services.authorized_certificates import AuthorizedCertificatesClient
from google.appengine_v1.services.authorized_certificates import pagers
from google.appengine_v1.services.authorized_certificates import transports
...
def test_authorized_certificates_client_client_options_from_dict():
    with mock.patch('google.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesGrpcTransport.__init__') as grpc_transport:
...
def test_authorized_certificates_base_transport():
    ...
    with mock.patch('google.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesTransport.__init__') as Transport:
...
def test_authorized_certificates_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_authorized_certificates_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.appengine_v1.services.authorized_certificates.transports.AuthorizedCertificatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.AuthorizedCertificatesTransport()
        adc.assert_called_once()
