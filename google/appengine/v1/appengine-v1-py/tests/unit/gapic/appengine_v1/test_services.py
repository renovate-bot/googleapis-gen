...
from google.appengine_v1.services.services import ServicesAsyncClient
from google.appengine_v1.services.services import ServicesClient
from google.appengine_v1.services.services import pagers
from google.appengine_v1.services.services import transports
from google.appengine_v1.types import appengine
from google.appengine_v1.types import network_settings
from google.appengine_v1.types import operation as ga_operation
from google.appengine_v1.types import service
...
def test_services_client_client_options_from_dict():
    with mock.patch('google.appengine_v1.services.services.transports.ServicesGrpcTransport.__init__') as grpc_transport:
...
def test_services_base_transport():
    ...
    with mock.patch('google.appengine_v1.services.services.transports.ServicesTransport.__init__') as Transport:
...
def test_services_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.appengine_v1.services.services.transports.ServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_services_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.appengine_v1.services.services.transports.ServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ServicesTransport()
        adc.assert_called_once()
