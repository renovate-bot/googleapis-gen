...
from google.appengine_v1.services.authorized_domains import AuthorizedDomainsAsyncClient
from google.appengine_v1.services.authorized_domains import AuthorizedDomainsClient
from google.appengine_v1.services.authorized_domains import pagers
from google.appengine_v1.services.authorized_domains import transports
...
def test_authorized_domains_client_client_options_from_dict():
    with mock.patch('google.appengine_v1.services.authorized_domains.transports.AuthorizedDomainsGrpcTransport.__init__') as grpc_transport:
...
def test_authorized_domains_base_transport():
    ...
    with mock.patch('google.appengine_v1.services.authorized_domains.transports.AuthorizedDomainsTransport.__init__') as Transport:
...
def test_authorized_domains_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.appengine_v1.services.authorized_domains.transports.AuthorizedDomainsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_authorized_domains_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.appengine_v1.services.authorized_domains.transports.AuthorizedDomainsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.AuthorizedDomainsTransport()
        adc.assert_called_once()
