...
from google.appengine_v1.services.instances import InstancesAsyncClient
from google.appengine_v1.services.instances import InstancesClient
from google.appengine_v1.services.instances import pagers
from google.appengine_v1.services.instances import transports
...
def test_instances_client_client_options_from_dict():
    with mock.patch('google.appengine_v1.services.instances.transports.InstancesGrpcTransport.__init__') as grpc_transport:
...
def test_instances_base_transport():
    ...
    with mock.patch('google.appengine_v1.services.instances.transports.InstancesTransport.__init__') as Transport:
...
def test_instances_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.appengine_v1.services.instances.transports.InstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_instances_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.appengine_v1.services.instances.transports.InstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.InstancesTransport()
        adc.assert_called_once()
