...
from google.appengine_v1.services.domain_mappings import DomainMappingsAsyncClient
from google.appengine_v1.services.domain_mappings import DomainMappingsClient
from google.appengine_v1.services.domain_mappings import pagers
from google.appengine_v1.services.domain_mappings import transports
...
def test_domain_mappings_client_client_options_from_dict():
    with mock.patch('google.appengine_v1.services.domain_mappings.transports.DomainMappingsGrpcTransport.__init__') as grpc_transport:
...
def test_domain_mappings_base_transport():
    ...
    with mock.patch('google.appengine_v1.services.domain_mappings.transports.DomainMappingsTransport.__init__') as Transport:
...
def test_domain_mappings_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.appengine_v1.services.domain_mappings.transports.DomainMappingsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_domain_mappings_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.appengine_v1.services.domain_mappings.transports.DomainMappingsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.DomainMappingsTransport()
        adc.assert_called_once()
