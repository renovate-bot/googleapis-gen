...
from google.appengine_v1.services.applications import ApplicationsAsyncClient
from google.appengine_v1.services.applications import ApplicationsClient
from google.appengine_v1.services.applications import transports
from google.appengine_v1.types import appengine
from google.appengine_v1.types import application
...
def test__get_default_mtls_endpoint():
    ...
    assert ApplicationsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert ApplicationsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ApplicationsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ApplicationsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ApplicationsAsyncClient, transports.ApplicationsGrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(ApplicationsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ApplicationsClient))
@mock.patch.object(ApplicationsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ApplicationsAsyncClient))
def test_applications_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (ApplicationsAsyncClient, transports.ApplicationsGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ApplicationsClient, transports.ApplicationsGrpcTransport, "grpc", "false"),
    (ApplicationsAsyncClient, transports.ApplicationsGrpcAsyncIOTransport, "grpc_asyncio", "false"),

])
@mock.patch.object(ApplicationsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ApplicationsClient))
@mock.patch.object(ApplicationsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ApplicationsAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_applications_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_applications_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_applications_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_applications_client_client_options_from_dict():
    with mock.patch('google.appengine_v1.services.applications.transports.ApplicationsGrpcTransport.__init__') as grpc_transport:
...
def test_get_application(transport: str = 'grpc', request_type=appengine.GetApplicationRequest):
    client = ApplicationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    assert response.database_type == application.Application.DatabaseType.CLOUD_DATASTORE
...
@pytest.mark.asyncio
async def test_get_application_async(transport: str = 'grpc_asyncio', request_type=appengine.GetApplicationRequest):
...
def test_create_application(transport: str = 'grpc', request_type=appengine.CreateApplicationRequest):
    client = ApplicationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_application_async(transport: str = 'grpc_asyncio', request_type=appengine.CreateApplicationRequest):
    client = ApplicationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_application(transport: str = 'grpc', request_type=appengine.UpdateApplicationRequest):
    client = ApplicationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_application_async(transport: str = 'grpc_asyncio', request_type=appengine.UpdateApplicationRequest):
    client = ApplicationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_repair_application(transport: str = 'grpc', request_type=appengine.RepairApplicationRequest):
    client = ApplicationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.repair_application),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_repair_application_async(transport: str = 'grpc_asyncio', request_type=appengine.RepairApplicationRequest):
    client = ApplicationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_applications_base_transport():
    ...
    with mock.patch('google.appengine_v1.services.applications.transports.ApplicationsTransport.__init__') as Transport:
...
def test_applications_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.appengine_v1.services.applications.transports.ApplicationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_applications_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.appengine_v1.services.applications.transports.ApplicationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ApplicationsTransport()
        adc.assert_called_once()
...
def test_applications_transport_auth_adc():
    ...
    with mock.patch.object(auth, 'default') as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.ApplicationsGrpcTransport(host="squid.clam.whelk", quota_project_id="octopus")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/appengine.admin',
            'https://www.googleapis.com/auth/cloud-platform',
            'https://www.googleapis.com/auth/cloud-platform.read-only',),
...
@pytest.mark.parametrize("transport_class", [transports.ApplicationsGrpcTransport, transports.ApplicationsGrpcAsyncIOTransport])
def test_applications_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.ApplicationsGrpcTransport, transports.ApplicationsGrpcAsyncIOTransport])
def test_applications_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ApplicationsGrpcTransport, transports.ApplicationsGrpcAsyncIOTransport])
def test_applications_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.ApplicationsTransport, '_prep_wrapped_messages') as prep:
        client = ApplicationsClient(
            credentials=credentials.AnonymousCredentials(),
