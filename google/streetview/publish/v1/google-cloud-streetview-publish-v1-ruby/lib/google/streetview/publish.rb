...
module Google
  module Streetview
    ...
    module Publish
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("publish"))
      ...
      def self.new(*args, version: :v1, **kwargs)
        ...
        version_module = Google::Streetview::Publish
          .constants
          .select {|sym| sym.to_s.downcase == version.to_s.downcase}
          .first
        Google::Streetview::Publish.const_get(version_module).new(*args, **kwargs)
      end
    end
  end
end
