...
module Google
  module Streetview
    module Publish
      ...
      ##
      # # Ruby Client for Street View Publish API ([Alpha](https://github.com/GoogleCloudPlatform/google-cloud-ruby#versioning))
      #
      ...
      # 3. [Enable the Street View Publish API.](https://console.cloud.google.com/apis/library/streetview-publish.googleapis.com)
      ...
      #
      # [Product Documentation]: https://cloud.google.com/streetview-publish
      #
      # ## Enabling Logging
      #
      ...
      module V1
        ...
        def self.new \
          ...
          Google::Streetview::Publish::V1::StreetViewPublishServiceClient.new(**kwargs)
        end
      end
    end
  end
