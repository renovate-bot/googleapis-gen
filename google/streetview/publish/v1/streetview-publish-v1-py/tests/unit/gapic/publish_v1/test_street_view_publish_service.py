...
def test__get_default_mtls_endpoint():
    ...
    assert StreetViewPublishServiceClient._get_default_mtls_endpoint(None) is None
    assert StreetViewPublishServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert StreetViewPublishServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert StreetViewPublishServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert StreetViewPublishServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test_street_view_publish_service_client_service_account_always_use_jwt(client_class):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.StreetViewPublishServiceGrpcTransport, "grpc"),
    (transports.StreetViewPublishServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
def test_street_view_publish_service_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
def test_street_view_publish_service_client_get_transport_class():
    transport = StreetViewPublishServiceClient.get_transport_class()
    available_transports = [
        transports.StreetViewPublishServiceGrpcTransport,
    ]
    assert transport in available_transports

    transport = StreetViewPublishServiceClient.get_transport_class("grpc")
    assert transport == transports.StreetViewPublishServiceGrpcTransport


@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (StreetViewPublishServiceClient, transports.StreetViewPublishServiceGrpcTransport, "grpc"),
    (StreetViewPublishServiceAsyncClient, transports.StreetViewPublishServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_street_view_publish_service_client_client_options(client_class, transport_class, transport_name):
...
def test_street_view_publish_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_street_view_publish_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_street_view_publish_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
@pytest.mark.asyncio
async def test_start_upload_async_from_dict():
    await test_start_upload_async(request_type=dict)
...
@pytest.mark.asyncio
async def test_create_photo_async_from_dict():
    await test_create_photo_async(request_type=dict)
...
async def test_create_photo_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_photo(
            photo=resources.Photo(photo_id=resources.PhotoId(id='id_value')),
        )
...
@pytest.mark.asyncio
async def test_get_photo_async_from_dict():
    await test_get_photo_async(request_type=dict)
...
async def test_get_photo_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_photo(
            photo_id='photo_id_value',
            view=rpcmessages.PhotoView.INCLUDE_DOWNLOAD_URL,
        )
...
@pytest.mark.asyncio
async def test_batch_get_photos_async_from_dict():
    await test_batch_get_photos_async(request_type=dict)
...
@pytest.mark.asyncio
async def test_list_photos_async_from_dict():
    await test_list_photos_async(request_type=dict)
...
async def test_list_photos_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_photos(
            view=rpcmessages.PhotoView.INCLUDE_DOWNLOAD_URL,
            filter='filter_value',
        )
...
def test_list_photos_pager():
    ...
    with mock.patch.object(
        ...
        metadata = ()
        pager = client.list_photos(request={})
...
def test_list_photos_pages():
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_photos(request={}).pages)
...
async def test_list_photos_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_photos(request={},)
...
async def test_list_photos_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_photos(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_update_photo_async_from_dict():
    await test_update_photo_async(request_type=dict)
...
@pytest.mark.asyncio
async def test_batch_update_photos_async_from_dict():
    await test_batch_update_photos_async(request_type=dict)
...
def test_batch_update_photos_flattened():
    ...
    with mock.patch.object(
        ...
        # using the keyword arguments to the method.
        client.batch_update_photos(
            update_photo_requests=[rpcmessages.UpdatePhotoRequest(photo=resources.Photo(photo_id=resources.PhotoId(id='id_value')))],
        )
...
async def test_batch_update_photos_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.batch_update_photos(
            update_photo_requests=[rpcmessages.UpdatePhotoRequest(photo=resources.Photo(photo_id=resources.PhotoId(id='id_value')))],
        )
...
async def test_batch_update_photos_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.batch_update_photos(
            rpcmessages.BatchUpdatePhotosRequest(),
            update_photo_requests=[rpcmessages.UpdatePhotoRequest(photo=resources.Photo(photo_id=resources.PhotoId(id='id_value')))],
        )
...
@pytest.mark.asyncio
async def test_delete_photo_async_from_dict():
    await test_delete_photo_async(request_type=dict)
...
async def test_delete_photo_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_photo(
            photo_id='photo_id_value',
        )
...
@pytest.mark.asyncio
async def test_batch_delete_photos_async_from_dict():
    await test_batch_delete_photos_async(request_type=dict)
...
async def test_batch_delete_photos_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.batch_delete_photos(
            photo_ids=['photo_ids_value'],
        )
...
async def test_batch_delete_photos_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.batch_delete_photos(
            rpcmessages.BatchDeletePhotosRequest(),
            photo_ids=['photo_ids_value'],
        )
...
def test_street_view_publish_service_base_transport():
...
@pytest.mark.parametrize("transport_class", [transports.StreetViewPublishServiceGrpcTransport, transports.StreetViewPublishServiceGrpcAsyncIOTransport])
...
def test_street_view_publish_service_grpc_asyncio_transport_channel():
...
@pytest.mark.parametrize("transport_class", [transports.StreetViewPublishServiceGrpcTransport, transports.StreetViewPublishServiceGrpcAsyncIOTransport])
def test_street_view_publish_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.StreetViewPublishServiceGrpcTransport, transports.StreetViewPublishServiceGrpcAsyncIOTransport])
def test_street_view_publish_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_parse_common_billing_account_path():
    ...
    actual = StreetViewPublishServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = StreetViewPublishServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = StreetViewPublishServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = StreetViewPublishServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = StreetViewPublishServiceClient.parse_common_location_path(path)
    assert expected == actual
