...
class TestStreetViewPublishServiceClient(object):
    ...
    def test_create_photo(self):
        ...
        expected_response = {'download_url': download_url, 'thumbnail_url': thumbnail_url, 'share_link': share_link, 'view_count': view_count}
    ...
    def test_get_photo(self):
        ...
        assert len(channel.requests) == 1
        expected_request = rpcmessages_pb2.GetPhotoRequest(photo_id=photo_id, view=view)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_batch_get_photos(self):
        # Setup Expected Response
        expected_response = {}
        expected_response = rpcmessages_pb2.BatchGetPhotosResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = rpcmessages_pb2.BatchGetPhotosRequest(photo_ids=photo_ids, view=view)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_photos(self):
        ...
        expected_response = rpcmessages_pb2.ListPhotosResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = rpcmessages_pb2.ListPhotosRequest(view=view, filter=filter_)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_photo(self):
        ...
        assert len(channel.requests) == 1
        expected_request = rpcmessages_pb2.UpdatePhotoRequest(photo=photo, update_mask=update_mask)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_batch_update_photos(self):
        # Setup Expected Response
        expected_response = {}
        expected_response = rpcmessages_pb2.BatchUpdatePhotosResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = rpcmessages_pb2.BatchUpdatePhotosRequest(update_photo_requests=update_photo_requests)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_delete_photo(self):
        ...
        assert len(channel.requests) == 1
        expected_request = rpcmessages_pb2.DeletePhotoRequest(photo_id=photo_id)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_batch_delete_photos(self):
        # Setup Expected Response
        expected_response = {}
        expected_response = rpcmessages_pb2.BatchDeletePhotosResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = rpcmessages_pb2.BatchDeletePhotosRequest(photo_ids=photo_ids)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
