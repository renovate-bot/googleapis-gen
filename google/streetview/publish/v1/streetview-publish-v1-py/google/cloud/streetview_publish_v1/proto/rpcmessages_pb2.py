...
# source: google/cloud/streetview_publish_v1/proto/rpcmessages.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/streetview_publish_v1/proto/rpcmessages.proto',
...
_CREATEPHOTOREQUEST.fields_by_name['photo'].message_type = google_dot_cloud_dot_streetview__publish__v1_dot_proto_dot_resources__pb2._PHOTO
...
_PHOTORESPONSE.fields_by_name['photo'].message_type = google_dot_cloud_dot_streetview__publish__v1_dot_proto_dot_resources__pb2._PHOTO
_LISTPHOTOSREQUEST.fields_by_name['view'].enum_type = _PHOTOVIEW
_LISTPHOTOSRESPONSE.fields_by_name['photos'].message_type = google_dot_cloud_dot_streetview__publish__v1_dot_proto_dot_resources__pb2._PHOTO
_UPDATEPHOTOREQUEST.fields_by_name['photo'].message_type = google_dot_cloud_dot_streetview__publish__v1_dot_proto_dot_resources__pb2._PHOTO
...
CreatePhotoRequest = _reflection.GeneratedProtocolMessageType('CreatePhotoRequest', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.streetview_publish_v1.proto.rpcmessages_pb2'
  ,
...
GetPhotoRequest = _reflection.GeneratedProtocolMessageType('GetPhotoRequest', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.streetview_publish_v1.proto.rpcmessages_pb2'
  ,
  '__doc__': """Request to get a [Photo][google.streetview.publish.v1.Photo].  By
  default  -  does not return the download URL for the photo bytes.
  Parameters:  -  ``view`` controls if the download URL for the photo
  bytes is    returned.
  ...
  Attributes:
      ...
      language_code:
          ...
          code_locale_identifier. If language_code is unspecified, the
...
BatchGetPhotosRequest = _reflection.GeneratedProtocolMessageType('BatchGetPhotosRequest', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.streetview_publish_v1.proto.rpcmessages_pb2'
  ,
  '__doc__': """Request to get one or more
  [Photos][google.streetview.publish.v1.Photo]. By default  -  does not
  return the download URL for the photo bytes.  Parameters:  -  ``view``
...
PhotoResponse = _reflection.GeneratedProtocolMessageType('PhotoResponse', (_message.Message,), {
  ...
  including [BatchGetPhotos][google.streetview.publish.v1.StreetViewPubl
  ishService.BatchGetPhotos] and [BatchUpdatePhotos][google.streetview.p
  ublish.v1.StreetViewPublishService.BatchUpdatePhotos].
...
ListPhotosRequest = _reflection.GeneratedProtocolMessageType('ListPhotosRequest', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.streetview_publish_v1.proto.rpcmessages_pb2'
  ,
  '__doc__': """Request to list all photos that belong to the user sending the
  request.  By default  -  does not return the download URL for the
  photo bytes.  Parameters:  -  ``view`` controls if the download URL
  for the photo bytes is    returned. -  ``pageSize`` determines the
  maximum number of photos to return. -  ``pageToken`` is the next page
  token value returned from a previous    [ListPhotos][google.streetview
  ...
  Attributes:
      ...
      page_token:
          ...
          ponse.next_page_token] value returned from a previous [ListPho
          tos][google.streetview.publish.v1.StreetViewPublishService.Lis
          tPhotos] request, if any.
      filter:
...
ListPhotosResponse = _reflection.GeneratedProtocolMessageType('ListPhotosResponse', (_message.Message,), {
  ...
  Attributes:
      photos:
          ...
          stPhotosRequest.page_size] field in the request determines the
...
BatchUpdatePhotosRequest = _reflection.GeneratedProtocolMessageType('BatchUpdatePhotosRequest', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.streetview_publish_v1.proto.rpcmessages_pb2'
  ,
  '__doc__': """Request to update the metadata of photos. Updating the pixels of
...
BatchDeletePhotosRequest = _reflection.GeneratedProtocolMessageType('BatchDeletePhotosRequest', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.streetview_publish_v1.proto.rpcmessages_pb2'
  ,
  '__doc__': """Request to delete multiple
  [Photos][google.streetview.publish.v1.Photo].
