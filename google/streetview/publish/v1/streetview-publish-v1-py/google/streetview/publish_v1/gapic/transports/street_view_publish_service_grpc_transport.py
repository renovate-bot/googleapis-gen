...
class StreetViewPublishServiceGrpcTransport(object):
    ...
    def __init__(self, channel=None, credentials=None,
        ...
        self._stubs = {
            'street_view_publish_service_stub': streetview_publish_pb2_grpc.StreetViewPublishServiceStub(channel),
        }
    ...
    def update_photo(self):
        ...
        Updates the metadata of a ``Photo``, such as pose, place
    ...
    def batch_update_photos(self):
        ...
        Returns:
            Callable: A callable which accepts the appropriate
                ...
                deserialized response object.
        """
        return self._stubs['street_view_publish_service_stub'].BatchUpdatePhotos
    ...
    def batch_delete_photos(self):
        ...
        Returns:
            Callable: A callable which accepts the appropriate
                ...
                deserialized response object.
        """
        return self._stubs['street_view_publish_service_stub'].BatchDeletePhotos