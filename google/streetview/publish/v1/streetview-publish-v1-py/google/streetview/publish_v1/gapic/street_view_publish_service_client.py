...
_GAPIC_LIBRARY_VERSION = pkg_resources.get_distribution(
    'google-cloud-streetview-publish',
).version
...
class StreetViewPublishServiceClient(object):
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=street_view_publish_service_grpc_transport.StreetViewPublishServiceGrpcTransport,
    ...
    def start_upload(
        ...
        if 'start_upload' not in self._inner_api_calls:
            self._inner_api_calls['start_upload'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.start_upload,
                default_retry=self._method_configs['StartUpload'].retry,
                default_timeout=self._method_configs['StartUpload'].timeout,
                client_info=self._client_info,
            )

        request = empty_pb2.Empty()
        return self._inner_api_calls['start_upload'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def create_photo(
        ...
        if 'create_photo' not in self._inner_api_calls:
            self._inner_api_calls['create_photo'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.create_photo,
                default_retry=self._method_configs['CreatePhoto'].retry,
                default_timeout=self._method_configs['CreatePhoto'].timeout,
                client_info=self._client_info,
            )

        request = rpcmessages_pb2.CreatePhotoRequest(
            photo=photo,
        )
        return self._inner_api_calls['create_photo'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def get_photo(
        ...
        Args:
            ...
            view (~google.streetview.publish_v1.types.PhotoView): Specifies if a download URL for the photo bytes should be returned
        ...
        if 'get_photo' not in self._inner_api_calls:
            self._inner_api_calls['get_photo'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        try:
            routing_header = [('photo_id', photo_id)]
        ...
        return self._inner_api_calls['get_photo'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def batch_get_photos(
        ...
        Args:
            photo_ids (list[str]): Required. IDs of the ``Photos``. HTTP GET requests require the
        ...
        if 'batch_get_photos' not in self._inner_api_calls:
            self._inner_api_calls['batch_get_photos'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.batch_get_photos,
                default_retry=self._method_configs['BatchGetPhotos'].retry,
                default_timeout=self._method_configs['BatchGetPhotos'].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls['batch_get_photos'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def list_photos(
        ...
        Returns:
            ...
            An iterable of :class:`~google.streetview.publish_v1.types.Photo` instances.
        ...
        if 'list_photos' not in self._inner_api_calls:
            self._inner_api_calls['list_photos'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_photos'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
            items_field='photos',
    ...
    def update_photo(
        ...
        if 'update_photo' not in self._inner_api_calls:
            self._inner_api_calls['update_photo'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.update_photo,
                default_retry=self._method_configs['UpdatePhoto'].retry,
                default_timeout=self._method_configs['UpdatePhoto'].timeout,
                client_info=self._client_info,
            )
        ...
        metadata = list(metadata)
        try:
            routing_header = [('photo.photo_id.id', photo.photo_id.id)]
        except AttributeError:
            pass
        else:
            routing_metadata = google.api_core.gapic_v1.routing_header.to_grpc_metadata(routing_header)
        ...
        return self._inner_api_calls['update_photo'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def batch_update_photos(
        ...
        if 'batch_update_photos' not in self._inner_api_calls:
            self._inner_api_calls['batch_update_photos'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.batch_update_photos,
                default_retry=self._method_configs['BatchUpdatePhotos'].retry,
                default_timeout=self._method_configs['BatchUpdatePhotos'].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls['batch_update_photos'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def delete_photo(
        ...
        if 'delete_photo' not in self._inner_api_calls:
            self._inner_api_calls['delete_photo'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.delete_photo,
                default_retry=self._method_configs['DeletePhoto'].retry,
                default_timeout=self._method_configs['DeletePhoto'].timeout,
                client_info=self._client_info,
            )

        request = rpcmessages_pb2.DeletePhotoRequest(
            photo_id=photo_id,
        )
        if metadata is None:
            metadata = []
        ...
        self._inner_api_calls['delete_photo'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def batch_delete_photos(
        ...
        if 'batch_delete_photos' not in self._inner_api_calls:
            self._inner_api_calls['batch_delete_photos'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.batch_delete_photos,
                default_retry=self._method_configs['BatchDeletePhotos'].retry,
                default_timeout=self._method_configs['BatchDeletePhotos'].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls['batch_delete_photos'](request, retry=retry, timeout=timeout, metadata=metadata)
