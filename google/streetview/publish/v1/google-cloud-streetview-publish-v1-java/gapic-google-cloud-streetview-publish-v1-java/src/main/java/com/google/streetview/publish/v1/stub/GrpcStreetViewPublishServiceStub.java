  ...
  protected GrpcStreetViewPublishServiceStub(
    ...
    GrpcCallSettings<GetPhotoRequest, Photo> getPhotoTransportSettings =
        GrpcCallSettings.<GetPhotoRequest, Photo>newBuilder()
            ...
            .setParamsExtractor(
                new RequestParamsExtractor<GetPhotoRequest>() {
                  @Override
                  public Map<String, String> extract(GetPhotoRequest request) {
    ...
    GrpcCallSettings<UpdatePhotoRequest, Photo> updatePhotoTransportSettings =
        GrpcCallSettings.<UpdatePhotoRequest, Photo>newBuilder()
            ...
            .setParamsExtractor(
                new RequestParamsExtractor<UpdatePhotoRequest>() {
                  @Override
                  public Map<String, String> extract(UpdatePhotoRequest request) {
                    ImmutableMap.Builder<String, String> params = ImmutableMap.builder();
                    params.put(
                        "photo.photo_id.id",
    ...
    GrpcCallSettings<DeletePhotoRequest, Empty> deletePhotoTransportSettings =
        GrpcCallSettings.<DeletePhotoRequest, Empty>newBuilder()
            ...
            .setParamsExtractor(
                new RequestParamsExtractor<DeletePhotoRequest>() {
                  @Override
                  public Map<String, String> extract(DeletePhotoRequest request) {
                    ImmutableMap.Builder<String, String> params = ImmutableMap.builder();
                    params.put("photo_id", String.valueOf(request.getPhotoId()));
                    return params.build();
                  }
