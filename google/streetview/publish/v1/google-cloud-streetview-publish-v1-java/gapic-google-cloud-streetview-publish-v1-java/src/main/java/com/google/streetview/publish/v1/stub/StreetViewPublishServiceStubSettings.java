 ...
 *             .build());
 * StreetViewPublishServiceStubSettings streetViewPublishServiceSettings =
...
public class StreetViewPublishServiceStubSettings
  ...
  private final UnaryCallSettings<Empty, StreetViewPublishResources.UploadRef> startUploadSettings;
  ...
  private final UnaryCallSettings<StreetViewPublishRpcMessages.DeletePhotoRequest, Empty>
      deletePhotoSettings;
  private final UnaryCallSettings<
  ...
  private static final PagedListDescriptor<
      ...
      LIST_PHOTOS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public StreetViewPublishRpcMessages.ListPhotosRequest injectToken(
                StreetViewPublishRpcMessages.ListPhotosRequest payload, String token) {
              return StreetViewPublishRpcMessages.ListPhotosRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public StreetViewPublishRpcMessages.ListPhotosRequest injectPageSize(
                StreetViewPublishRpcMessages.ListPhotosRequest payload, int pageSize) {
              return StreetViewPublishRpcMessages.ListPhotosRequest.newBuilder(payload)
            ...
            @Override
            public Integer extractPageSize(StreetViewPublishRpcMessages.ListPhotosRequest payload) {
              return payload.getPageSize();
            }

            @Override
            public String extractNextToken(
                StreetViewPublishRpcMessages.ListPhotosResponse payload) {
              return payload.getNextPageToken();
            }

            @Override
            public Iterable<StreetViewPublishResources.Photo> extractResources(
                StreetViewPublishRpcMessages.ListPhotosResponse payload) {
              return payload.getPhotosList() == null
                  ? ImmutableList.<StreetViewPublishResources.Photo>of()
  ...
  public static String getDefaultMtlsEndpoint() {
    return "streetviewpublish.mtls.googleapis.com:443";
  }
  ...
  public static class Builder
    ...
    private final UnaryCallSettings.Builder<Empty, StreetViewPublishResources.UploadRef>
        startUploadSettings;
    ...
    private final UnaryCallSettings.Builder<
            ...
            StreetViewPublishRpcMessages.BatchUpdatePhotosResponse>
        batchUpdatePhotosSettings;
    private final UnaryCallSettings.Builder<StreetViewPublishRpcMessages.DeletePhotoRequest, Empty>
        deletePhotoSettings;
    private final UnaryCallSettings.Builder<
            StreetViewPublishRpcMessages.BatchDeletePhotosRequest,
            StreetViewPublishRpcMessages.BatchDeletePhotosResponse>
