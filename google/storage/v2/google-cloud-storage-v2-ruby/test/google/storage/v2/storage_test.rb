...
class ::Google::Storage::V2::Storage::ClientTest < Minitest::Test
  ...
  def test_get_object
    # Create GRPC objects.
    grpc_response = ::Google::Storage::V2::Object.new
    ...
    get_object_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Storage::V2::GetObjectRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_object_client_stub do
      ...
      # Use protobuf object
      client.get_object ::Google::Storage::V2::GetObjectRequest.new(bucket: bucket, object: object, generation: generation, if_generation_match: if_generation_match, if_generation_not_match: if_generation_not_match, if_metageneration_match: if_metageneration_match, if_metageneration_not_match: if_metageneration_not_match, common_object_request_params: common_object_request_params, common_request_params: common_request_params, read_mask: read_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
