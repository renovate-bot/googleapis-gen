# Ruby Client for the Google Cloud Storage V2 API

API Client library for the Google Cloud Storage V2 API

google-cloud-storage-v2 is the official client library for the Google Cloud Storage V2 API.

https://github.com/googleapis/google-cloud-ruby

This gem is a _versioned_ client. It provides basic client classes for a
specific version of the Google Cloud Storage V2 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-storage-v2
```
...
is part of the name, e.g. `google-cloud-storage-v2`.
