...
class FieldTransform extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Firestore\V1beta1\DocumentTransform\FieldTransform\ServerValue::class);
     ...
     * @return \Google\Cloud\Firestore\V1beta1\Value|null
     */
