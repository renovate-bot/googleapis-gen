...
class UnaryFilter extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Firestore\V1beta1\StructuredQuery\UnaryFilter\Operator::class);
        $this->op = $var;
...
class_alias(UnaryFilter::class, \Google\Cloud\Firestore\V1beta1\StructuredQuery_UnaryFilter::class);
