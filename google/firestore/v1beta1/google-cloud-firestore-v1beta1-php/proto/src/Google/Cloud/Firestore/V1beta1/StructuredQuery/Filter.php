...
class Filter extends \Google\Protobuf\Internal\Message
{
     ...
     * @return \Google\Cloud\Firestore\V1beta1\StructuredQuery\CompositeFilter|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Firestore\V1beta1\StructuredQuery\CompositeFilter::class);
     ...
     * @return \Google\Cloud\Firestore\V1beta1\StructuredQuery\FieldFilter|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Firestore\V1beta1\StructuredQuery\FieldFilter::class);
     ...
     * @return \Google\Cloud\Firestore\V1beta1\StructuredQuery\UnaryFilter|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Firestore\V1beta1\StructuredQuery\UnaryFilter::class);
