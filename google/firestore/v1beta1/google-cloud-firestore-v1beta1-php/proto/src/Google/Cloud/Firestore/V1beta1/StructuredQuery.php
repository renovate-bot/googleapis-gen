...
class StructuredQuery extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.Projection select = 1;</code>
     * @return \Google\Cloud\Firestore\V1beta1\StructuredQuery\Projection|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Firestore\V1beta1\StructuredQuery\Projection::class);
        $this->select = $var;
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.Filter where = 3;</code>
     * @return \Google\Cloud\Firestore\V1beta1\StructuredQuery\Filter|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Firestore\V1beta1\StructuredQuery\Filter::class);
        $this->where = $var;
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.Cursor start_at = 7;</code>
     * @return \Google\Cloud\Firestore\V1beta1\Cursor|null
     */
