...
class Target extends \Google\Protobuf\Internal\Message
{
     ...
     * @return \Google\Cloud\Firestore\V1beta1\Target\QueryTarget|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Firestore\V1beta1\Target\QueryTarget::class);
     ...
     * @return \Google\Cloud\Firestore\V1beta1\Target\DocumentsTarget|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Firestore\V1beta1\Target\DocumentsTarget::class);
