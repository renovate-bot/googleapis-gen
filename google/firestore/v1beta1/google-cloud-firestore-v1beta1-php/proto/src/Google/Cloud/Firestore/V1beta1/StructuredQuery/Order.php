...
class Order extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.FieldReference field = 1;</code>
     * @return \Google\Cloud\Firestore\V1beta1\StructuredQuery\FieldReference|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Firestore\V1beta1\StructuredQuery\FieldReference::class);
        $this->field = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Firestore\V1beta1\StructuredQuery\Direction::class);
        $this->direction = $var;
...
class_alias(Order::class, \Google\Cloud\Firestore\V1beta1\StructuredQuery_Order::class);
