...
from google.firestore_v1beta1.services.firestore.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert FirestoreClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert FirestoreClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert FirestoreClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test_firestore_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (FirestoreAsyncClient, transports.FirestoreGrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(FirestoreClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FirestoreClient))
@mock.patch.object(FirestoreAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FirestoreAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (FirestoreAsyncClient, transports.FirestoreGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (FirestoreClient, transports.FirestoreGrpcTransport, "grpc", "false"),
    (FirestoreAsyncClient, transports.FirestoreGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(FirestoreClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FirestoreClient))
@mock.patch.object(FirestoreAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FirestoreAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_firestore_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_firestore_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_firestore_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_firestore_client_client_options_from_dict():
    with mock.patch('google.firestore_v1beta1.services.firestore.transports.FirestoreGrpcTransport.__init__') as grpc_transport:
...
def test_get_document(transport: str = 'grpc', request_type=firestore.GetDocumentRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_document_async(transport: str = 'grpc_asyncio', request_type=firestore.GetDocumentRequest):
...
def test_list_documents(transport: str = 'grpc', request_type=firestore.ListDocumentsRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_documents_async(transport: str = 'grpc_asyncio', request_type=firestore.ListDocumentsRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_document(transport: str = 'grpc', request_type=firestore.UpdateDocumentRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_document_async(transport: str = 'grpc_asyncio', request_type=firestore.UpdateDocumentRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gf_document.Document(
            name='name_value',
        ))
...
def test_delete_document(transport: str = 'grpc', request_type=firestore.DeleteDocumentRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_document_async(transport: str = 'grpc_asyncio', request_type=firestore.DeleteDocumentRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_get_documents(transport: str = 'grpc', request_type=firestore.BatchGetDocumentsRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_get_documents),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_batch_get_documents_async(transport: str = 'grpc_asyncio', request_type=firestore.BatchGetDocumentsRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        call.return_value.read = mock.AsyncMock(side_effect=[firestore.BatchGetDocumentsResponse()])
...
def test_begin_transaction(transport: str = 'grpc', request_type=firestore.BeginTransactionRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_begin_transaction_async(transport: str = 'grpc_asyncio', request_type=firestore.BeginTransactionRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(firestore.BeginTransactionResponse(
            transaction=b'transaction_blob',
        ))
...
@pytest.mark.asyncio
async def test_commit_async(transport: str = 'grpc_asyncio', request_type=firestore.CommitRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_rollback_async(transport: str = 'grpc_asyncio', request_type=firestore.RollbackRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_run_query_async(transport: str = 'grpc_asyncio', request_type=firestore.RunQueryRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[firestore.RunQueryResponse()])
...
def test_partition_query(transport: str = 'grpc', request_type=firestore.PartitionQueryRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_partition_query_async(transport: str = 'grpc_asyncio', request_type=firestore.PartitionQueryRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_partition_query_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, query.Cursor)
                   for i in results)
...
@pytest.mark.asyncio
async def test_write_async(transport: str = 'grpc_asyncio', request_type=firestore.WriteRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_listen_async(transport: str = 'grpc_asyncio', request_type=firestore.ListenRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_collection_ids(transport: str = 'grpc', request_type=firestore.ListCollectionIdsRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_collection_ids_async(transport: str = 'grpc_asyncio', request_type=firestore.ListCollectionIdsRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_batch_write_async(transport: str = 'grpc_asyncio', request_type=firestore.BatchWriteRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(firestore.BatchWriteResponse(
        ))
...
def test_create_document(transport: str = 'grpc', request_type=firestore.CreateDocumentRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_document_async(transport: str = 'grpc_asyncio', request_type=firestore.CreateDocumentRequest):
    client = FirestoreAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_firestore_base_transport():
    ...
    with mock.patch('google.firestore_v1beta1.services.firestore.transports.FirestoreTransport.__init__') as Transport:
...
def test_firestore_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.firestore_v1beta1.services.firestore.transports.FirestoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_firestore_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.firestore_v1beta1.services.firestore.transports.FirestoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.FirestoreTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.FirestoreGrpcTransport, transports.FirestoreGrpcAsyncIOTransport])
def test_firestore_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_firestore_host_no_port():
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='firestore.googleapis.com'),
    )
    assert client.transport._host == 'firestore.googleapis.com:443'
...
def test_firestore_host_with_port():
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='firestore.googleapis.com:8000'),
    )
...
@pytest.mark.parametrize("transport_class", [transports.FirestoreGrpcTransport, transports.FirestoreGrpcAsyncIOTransport])
def test_firestore_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.FirestoreGrpcTransport, transports.FirestoreGrpcAsyncIOTransport])
def test_firestore_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.FirestoreTransport, '_prep_wrapped_messages') as prep:
        client = FirestoreClient(
            credentials=ga_credentials.AnonymousCredentials(),
