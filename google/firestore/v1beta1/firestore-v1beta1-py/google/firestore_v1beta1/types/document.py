...
class Document(proto.Message):
    ...
    Attributes:
        ...
        fields (Sequence[google.firestore_v1beta1.types.Document.FieldsEntry]):
...
class Value(proto.Message):
    ...
    Attributes:
        ...
        geo_point_value (google.type.latlng_pb2.LatLng):
            ...
            surface of Earth.
            This field is a member of `oneof`_ ``value_type``.
        array_value (google.firestore_v1beta1.types.ArrayValue):
            An array value.
            Cannot directly contain another array value,
            though can contain an map which contains another
            array.
            This field is a member of `oneof`_ ``value_type``.
        map_value (google.firestore_v1beta1.types.MapValue):
            A map value.
            This field is a member of `oneof`_ ``value_type``.
    """
...
class MapValue(proto.Message):
    ...
    Attributes:
        fields (Sequence[google.firestore_v1beta1.types.MapValue.FieldsEntry]):
            The map's fields.
