...
class Write(proto.Message):
    ...
    Attributes:
        update (google.firestore_v1beta1.types.Document):
            A document to write.
        delete (str):
    ...
    transform = proto.Field(proto.MESSAGE, number=6, oneof='operation',
...
class DocumentTransform(proto.Message):
    ...
    Attributes:
        ...
        field_transforms (Sequence[google.firestore_v1beta1.types.DocumentTransform.FieldTransform]):
    ...
    class FieldTransform(proto.Message):
        ...
        Attributes:
            ...
            set_to_server_value (google.firestore_v1beta1.types.DocumentTransform.FieldTransform.ServerValue):
                Sets the field to the given server value.
            increment (google.firestore_v1beta1.types.Value):
            ...
            maximum (google.firestore_v1beta1.types.Value):
                ...
                NaN.
            minimum (google.firestore_v1beta1.types.Value):
                ...
                NaN.
            append_missing_elements (google.firestore_v1beta1.types.ArrayValue):
            ...
            remove_all_from_array (google.firestore_v1beta1.types.ArrayValue):
        ...
        set_to_server_value = proto.Field(proto.ENUM, number=2, oneof='transform_type',
            enum='DocumentTransform.FieldTransform.ServerValue',
        )

        increment = proto.Field(proto.MESSAGE, number=3, oneof='transform_type',
            message=gf_document.Value,
        )

        maximum = proto.Field(proto.MESSAGE, number=4, oneof='transform_type',
            message=gf_document.Value,
        )

        minimum = proto.Field(proto.MESSAGE, number=5, oneof='transform_type',
            message=gf_document.Value,
        )

        append_missing_elements = proto.Field(proto.MESSAGE, number=6, oneof='transform_type',
            message=gf_document.ArrayValue,
        )

        remove_all_from_array = proto.Field(proto.MESSAGE, number=7, oneof='transform_type',
            message=gf_document.ArrayValue,
        )
...
class WriteResult(proto.Message):
    ...
    Attributes:
        ...
        transform_results (Sequence[google.firestore_v1beta1.types.Value]):
