...
class StructuredQuery(proto.Message):
    ...
    Attributes:
        ...
        from_ (Sequence[google.firestore_v1beta1.types.StructuredQuery.CollectionSelector]):
            The collections to query.
        where (google.firestore_v1beta1.types.StructuredQuery.Filter):
            The filter to apply.
        order_by (Sequence[google.firestore_v1beta1.types.StructuredQuery.Order]):
        ...
        start_at (google.firestore_v1beta1.types.Cursor):
            A starting point for the query results.
        end_at (google.firestore_v1beta1.types.Cursor):
    ...
    class Filter(proto.Message):
        ...
        Attributes:
            ...
            field_filter (google.firestore_v1beta1.types.StructuredQuery.FieldFilter):
                A filter on a document field.

                This field is a member of `oneof`_ ``filter_type``.
            unary_filter (google.firestore_v1beta1.types.StructuredQuery.UnaryFilter):
    ...
    class CompositeFilter(proto.Message):
        ...
        Attributes:
            op (google.firestore_v1beta1.types.StructuredQuery.CompositeFilter.Operator):
                The operator for combining multiple filters.
            filters (Sequence[google.firestore_v1beta1.types.StructuredQuery.Filter]):
    ...
    class FieldFilter(proto.Message):
        ...
        Attributes:
            ...
            op (google.firestore_v1beta1.types.StructuredQuery.FieldFilter.Operator):
                The operator to filter by.
            value (google.firestore_v1beta1.types.Value):
    ...
    class Order(proto.Message):
        ...
        Attributes:
            ...
            direction (google.firestore_v1beta1.types.StructuredQuery.Direction):
