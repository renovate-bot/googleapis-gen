...
require "google/cloud/firestore/v1beta1/firestore"

class ::Google::Cloud::Firestore::V1beta1::Firestore::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_get_document
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::Document.new
    ...
    get_document_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::GetDocumentRequest, request
      assert_equal "hello world", request["name"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Firestore::V1beta1::DocumentMask), request["mask"]
    ...
    Gapic::ServiceStub.stub :new, get_document_client_stub do
      # Create client
      client = ::Google::Cloud::Firestore::V1beta1::Firestore::Client.new do |config|
      ...
      # Use protobuf object
      client.get_document ::Google::Cloud::Firestore::V1beta1::GetDocumentRequest.new(name: name, mask: mask, transaction: transaction) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.get_document(::Google::Cloud::Firestore::V1beta1::GetDocumentRequest.new(name: name, mask: mask, transaction: transaction), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_documents
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::ListDocumentsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_documents_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::ListDocumentsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_documents_client_stub do
      ...
      # Use protobuf object
      client.list_documents ::Google::Cloud::Firestore::V1beta1::ListDocumentsRequest.new(parent: parent, collection_id: collection_id, page_size: page_size, page_token: page_token, order_by: order_by, mask: mask, transaction: transaction, show_missing: show_missing) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_documents(::Google::Cloud::Firestore::V1beta1::ListDocumentsRequest.new(parent: parent, collection_id: collection_id, page_size: page_size, page_token: page_token, order_by: order_by, mask: mask, transaction: transaction, show_missing: show_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_document
    ...
    update_document_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::UpdateDocumentRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Firestore::V1beta1::Document), request["document"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Firestore::V1beta1::DocumentMask), request["update_mask"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Firestore::V1beta1::DocumentMask), request["mask"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Firestore::V1beta1::Precondition), request["current_document"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, update_document_client_stub do
      ...
      # Use protobuf object
      client.update_document ::Google::Cloud::Firestore::V1beta1::UpdateDocumentRequest.new(document: document, update_mask: update_mask, mask: mask, current_document: current_document) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_document(::Google::Cloud::Firestore::V1beta1::UpdateDocumentRequest.new(document: document, update_mask: update_mask, mask: mask, current_document: current_document), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_document
    ...
    delete_document_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::DeleteDocumentRequest, request
      assert_equal "hello world", request["name"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Firestore::V1beta1::Precondition), request["current_document"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_document_client_stub do
      ...
      # Use protobuf object
      client.delete_document ::Google::Cloud::Firestore::V1beta1::DeleteDocumentRequest.new(name: name, current_document: current_document) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_document(::Google::Cloud::Firestore::V1beta1::DeleteDocumentRequest.new(name: name, current_document: current_document), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_get_documents
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    batch_get_documents_client_stub = ClientStub.new [grpc_response].to_enum, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsRequest, request
    ...
    Gapic::ServiceStub.stub :new, batch_get_documents_client_stub do
      ...
      client.batch_get_documents({ database: database, documents: documents, mask: mask, transaction: transaction }) do |response, operation|
        ...
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsResponse, r
        end
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.batch_get_documents ::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsRequest.new(database: database, documents: documents, mask: mask, transaction: transaction) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsResponse, r
        end
      ...
      # Use protobuf object with options
      client.batch_get_documents(::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsRequest.new(database: database, documents: documents, mask: mask, transaction: transaction), grpc_options) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsResponse, r
        end
  ...
  def test_begin_transaction
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::BeginTransactionResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    begin_transaction_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::BeginTransactionRequest, request
      assert_equal "hello world", request["database"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Firestore::V1beta1::TransactionOptions), request["options"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, begin_transaction_client_stub do
      ...
      # Use protobuf object
      client.begin_transaction ::Google::Cloud::Firestore::V1beta1::BeginTransactionRequest.new(database: database, options: options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.begin_transaction(::Google::Cloud::Firestore::V1beta1::BeginTransactionRequest.new(database: database, options: options), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_commit
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::CommitResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    commit_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::CommitRequest, request
      assert_equal "hello world", request["database"]
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::Write, request["writes"].first
      assert_equal "hello world", request["transaction"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, commit_client_stub do
      ...
      # Use protobuf object
      client.commit ::Google::Cloud::Firestore::V1beta1::CommitRequest.new(database: database, writes: writes, transaction: transaction) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.commit(::Google::Cloud::Firestore::V1beta1::CommitRequest.new(database: database, writes: writes, transaction: transaction), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_rollback
    ...
    rollback_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::RollbackRequest, request
      assert_equal "hello world", request["database"]
      assert_equal "hello world", request["transaction"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, rollback_client_stub do
      ...
      # Use protobuf object
      client.rollback ::Google::Cloud::Firestore::V1beta1::RollbackRequest.new(database: database, transaction: transaction) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.rollback(::Google::Cloud::Firestore::V1beta1::RollbackRequest.new(database: database, transaction: transaction), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_run_query
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::RunQueryResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    run_query_client_stub = ClientStub.new [grpc_response].to_enum, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::RunQueryRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Firestore::V1beta1::StructuredQuery), request["structured_query"]
    ...
    Gapic::ServiceStub.stub :new, run_query_client_stub do
      ...
      client.run_query({ parent: parent, structured_query: structured_query, transaction: transaction }) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::RunQueryResponse, r
        end
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.run_query ::Google::Cloud::Firestore::V1beta1::RunQueryRequest.new(parent: parent, structured_query: structured_query, transaction: transaction) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::RunQueryResponse, r
        end
      ...
      # Use protobuf object with options
      client.run_query(::Google::Cloud::Firestore::V1beta1::RunQueryRequest.new(parent: parent, structured_query: structured_query, transaction: transaction), grpc_options) do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::RunQueryResponse, r
        end
  ...
  def test_partition_query
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::PartitionQueryResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    partition_query_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::PartitionQueryRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Firestore::V1beta1::StructuredQuery), request["structured_query"]
      assert_equal :structured_query, request.query_type
    ...
    Gapic::ServiceStub.stub :new, partition_query_client_stub do
      ...
      # Use protobuf object
      client.partition_query ::Google::Cloud::Firestore::V1beta1::PartitionQueryRequest.new(parent: parent, structured_query: structured_query, partition_count: partition_count, page_token: page_token, page_size: page_size) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.partition_query(::Google::Cloud::Firestore::V1beta1::PartitionQueryRequest.new(parent: parent, structured_query: structured_query, partition_count: partition_count, page_token: page_token, page_size: page_size), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_write
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::WriteResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    Gapic::ServiceStub.stub :new, write_client_stub do
      ...
      request_proto = ::Google::Cloud::Firestore::V1beta1::WriteRequest.new database: database, stream_id: stream_id, writes: writes, stream_token: stream_token, labels: labels
      enum_input = [request_hash, request_proto].to_enum
      client.write enum_input do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::WriteResponse, r
        end
        assert_equal grpc_operation, operation
      end
      ...
      write_client_stub.requests.each do |request|
        request.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::WriteRequest, r
          assert_equal "hello world", r["database"]
          assert_equal "hello world", r["stream_id"]
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::Write, r["writes"].first
  ...
  def test_listen
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::ListenResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    Gapic::ServiceStub.stub :new, listen_client_stub do
      ...
      request_proto = ::Google::Cloud::Firestore::V1beta1::ListenRequest.new database: database, add_target: add_target, labels: labels
      enum_input = [request_hash, request_proto].to_enum
      client.listen enum_input do |response, operation|
        assert_kind_of Enumerable, response
        response.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::ListenResponse, r
        end
        assert_equal grpc_operation, operation
      end
      ...
      listen_client_stub.requests.each do |request|
        request.to_a.each do |r|
          assert_kind_of ::Google::Cloud::Firestore::V1beta1::ListenRequest, r
          assert_equal "hello world", r["database"]
          assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Firestore::V1beta1::Target), r["add_target"]
  ...
  def test_list_collection_ids
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::ListCollectionIdsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_collection_ids_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::ListCollectionIdsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, list_collection_ids_client_stub do
      ...
      # Use protobuf object
      client.list_collection_ids ::Google::Cloud::Firestore::V1beta1::ListCollectionIdsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_collection_ids(::Google::Cloud::Firestore::V1beta1::ListCollectionIdsRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_write
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Firestore::V1beta1::BatchWriteResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    batch_write_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::BatchWriteRequest, request
      assert_equal "hello world", request["database"]
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::Write, request["writes"].first
    ...
    Gapic::ServiceStub.stub :new, batch_write_client_stub do
      ...
      # Use protobuf object
      client.batch_write ::Google::Cloud::Firestore::V1beta1::BatchWriteRequest.new(database: database, writes: writes, labels: labels) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.batch_write(::Google::Cloud::Firestore::V1beta1::BatchWriteRequest.new(database: database, writes: writes, labels: labels), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_document
    ...
    create_document_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Firestore::V1beta1::CreateDocumentRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["collection_id"]
    ...
    Gapic::ServiceStub.stub :new, create_document_client_stub do
      ...
      # Use protobuf object
      client.create_document ::Google::Cloud::Firestore::V1beta1::CreateDocumentRequest.new(parent: parent, collection_id: collection_id, document_id: document_id, document: document, mask: mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_document(::Google::Cloud::Firestore::V1beta1::CreateDocumentRequest.new(parent: parent, collection_id: collection_id, document_id: document_id, document: document, mask: mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Firestore::V1beta1::Firestore::Client::Configuration, config
  end
end
