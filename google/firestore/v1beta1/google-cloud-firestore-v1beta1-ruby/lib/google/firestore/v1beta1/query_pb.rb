...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/firestore/v1beta1/query.proto", :syntax => :proto3) do
    add_message "google.firestore.v1beta1.StructuredQuery" do
      optional :select, :message, 1, "google.firestore.v1beta1.StructuredQuery.Projection"
      repeated :from, :message, 2, "google.firestore.v1beta1.StructuredQuery.CollectionSelector"
      optional :where, :message, 3, "google.firestore.v1beta1.StructuredQuery.Filter"
      repeated :order_by, :message, 4, "google.firestore.v1beta1.StructuredQuery.Order"
      optional :start_at, :message, 7, "google.firestore.v1beta1.Cursor"
      optional :end_at, :message, 8, "google.firestore.v1beta1.Cursor"
      optional :offset, :int32, 6
      optional :limit, :message, 5, "google.protobuf.Int32Value"
    end
    add_message "google.firestore.v1beta1.StructuredQuery.CollectionSelector" do
      optional :collection_id, :string, 2
      optional :all_descendants, :bool, 3
    end
    add_message "google.firestore.v1beta1.StructuredQuery.Filter" do
      oneof :filter_type do
        optional :composite_filter, :message, 1, "google.firestore.v1beta1.StructuredQuery.CompositeFilter"
        optional :field_filter, :message, 2, "google.firestore.v1beta1.StructuredQuery.FieldFilter"
        optional :unary_filter, :message, 3, "google.firestore.v1beta1.StructuredQuery.UnaryFilter"
      end
    end
    add_message "google.firestore.v1beta1.StructuredQuery.CompositeFilter" do
      optional :op, :enum, 1, "google.firestore.v1beta1.StructuredQuery.CompositeFilter.Operator"
      repeated :filters, :message, 2, "google.firestore.v1beta1.StructuredQuery.Filter"
    end
    add_enum "google.firestore.v1beta1.StructuredQuery.CompositeFilter.Operator" do
      value :OPERATOR_UNSPECIFIED, 0
      value :AND, 1
    end
    add_message "google.firestore.v1beta1.StructuredQuery.FieldFilter" do
      optional :field, :message, 1, "google.firestore.v1beta1.StructuredQuery.FieldReference"
      optional :op, :enum, 2, "google.firestore.v1beta1.StructuredQuery.FieldFilter.Operator"
      optional :value, :message, 3, "google.firestore.v1beta1.Value"
    end
    add_enum "google.firestore.v1beta1.StructuredQuery.FieldFilter.Operator" do
      value :OPERATOR_UNSPECIFIED, 0
      value :LESS_THAN, 1
    ...
    add_message "google.firestore.v1beta1.StructuredQuery.UnaryFilter" do
      ...
      oneof :operand_type do
        optional :field, :message, 2, "google.firestore.v1beta1.StructuredQuery.FieldReference"
      end
    end
    add_enum "google.firestore.v1beta1.StructuredQuery.UnaryFilter.Operator" do
      value :OPERATOR_UNSPECIFIED, 0
      value :IS_NAN, 2
      value :IS_NULL, 3
      value :IS_NOT_NAN, 4
    ...
    add_message "google.firestore.v1beta1.StructuredQuery.Order" do
      optional :field, :message, 1, "google.firestore.v1beta1.StructuredQuery.FieldReference"
    ...
    add_message "google.firestore.v1beta1.Cursor" do
