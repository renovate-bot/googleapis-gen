...
module Google
  module Firestore
    module V1beta1
      ...
      # The request for {Google::Firestore::V1beta1::Firestore::PartitionQuery Firestore::PartitionQuery}.
      # @!attribute [rw] parent
      #   @return [String]
      #     Required. The parent resource name. In the format:
      ...
      # The response for {Google::Firestore::V1beta1::Firestore::PartitionQuery Firestore::PartitionQuery}.
      # @!attribute [rw] partitions
      #   @return [Array<Google::Firestore::V1beta1::Cursor>]
      #     Partition results.
      ...
      # The request for {Google::Firestore::V1beta1::Firestore::BatchWrite Firestore::BatchWrite}.
      # @!attribute [rw] database
      #   @return [String]
      #     Required. The database name. In the format:
      #     `projects/{project_id}/databases/{database_id}`.
      ...
      # The response from {Google::Firestore::V1beta1::Firestore::BatchWrite Firestore::BatchWrite}.
      # @!attribute [rw] write_results
      #   @return [Array<Google::Firestore::V1beta1::WriteResult>]
      #     The result of applying the writes.
      #
