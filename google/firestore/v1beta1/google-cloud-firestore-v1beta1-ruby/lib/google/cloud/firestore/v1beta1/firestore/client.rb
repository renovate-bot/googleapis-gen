      ...
      module V1beta1
        module Firestore
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Firestore::V1beta1::Firestore::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all Firestore clients
            #   ::Google::Cloud::Firestore::V1beta1::Firestore::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::Firestore::V1beta1::Firestore::Client.new
            #
            ...
            def initialize
              ...
              @firestore_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Firestore::V1beta1::Firestore::Stub,
            ...
            #   {::Google::Cloud::Firestore::V1beta1::GetDocumentRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::GetDocumentRequest, ::Hash]
            ...
            #   @param mask [::Google::Cloud::Firestore::V1beta1::DocumentMask, ::Hash]
            ...
            # @yieldparam response [::Google::Cloud::Firestore::V1beta1::Document]
            ...
            #   request = Google::Cloud::Firestore::V1beta1::GetDocumentRequest.new
            #
            #   # Call the get_document method.
            #   result = client.get_document request
            #
            #   # The returned object is of type Google::Cloud::Firestore::V1beta1::Document.
            #   p result
            #
            def get_document request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::GetDocumentRequest
              ...
              metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                ...
                gapic_version: ::Google::Cloud::Firestore::V1beta1::VERSION
            ...
            #   {::Google::Cloud::Firestore::V1beta1::ListDocumentsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::ListDocumentsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     be returned with a key but will not have fields, {::Google::Cloud::Firestore::V1beta1::Document#create_time Document.create_time},
            #     or {::Google::Cloud::Firestore::V1beta1::Document#update_time Document.update_time} set.
            #
            #     Requests with `show_missing` may not specify `where` or
            #     `order_by`.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Firestore::V1beta1::Document>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Firestore::V1beta1::Document>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::ListDocumentsRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::Firestore::V1beta1::Document.
            #     p response
            #   end
            #
            def list_documents request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::ListDocumentsRequest
            ...
            #   {::Google::Cloud::Firestore::V1beta1::UpdateDocumentRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::UpdateDocumentRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #   the default parameter values, pass an empty Hash as a request object (see above).
            #
            #   @param document [::Google::Cloud::Firestore::V1beta1::Document, ::Hash]
            #     Required. The updated document.
            #     Creates the document if it does not already exist.
            #   @param update_mask [::Google::Cloud::Firestore::V1beta1::DocumentMask, ::Hash]
            ...
            #     If the document has a field that is not present in this mask, that field
            #     will not be returned in the response.
            #   @param current_document [::Google::Cloud::Firestore::V1beta1::Precondition, ::Hash]
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::UpdateDocumentRequest.new
            #
            ...
            def update_document request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::UpdateDocumentRequest
            ...
            #   {::Google::Cloud::Firestore::V1beta1::DeleteDocumentRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::DeleteDocumentRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::DeleteDocumentRequest.new
            #
            ...
            def delete_document request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::DeleteDocumentRequest
            ...
            #   {::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #   @param transaction [::String]
            #     Reads documents in a transaction.
            #   @param new_transaction [::Google::Cloud::Firestore::V1beta1::TransactionOptions, ::Hash]
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Enumerable<::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsResponse>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Enumerable<::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsResponse>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::BatchGetDocumentsRequest.new
            #
            #   # Call the batch_get_documents method.
            #   result = client.batch_get_documents request
            #
            #   # The returned object is a streamed enumerable yielding elements of
            #   # type ::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsResponse.
            #   result.each do |response|
            #     p response
            #   end
            #
            def batch_get_documents request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::BatchGetDocumentsRequest
            ...
            #   {::Google::Cloud::Firestore::V1beta1::BeginTransactionRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::BeginTransactionRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     Required. The database name. In the format:
            #     `projects/{project_id}/databases/{database_id}`.
            #   @param options [::Google::Cloud::Firestore::V1beta1::TransactionOptions, ::Hash]
            #     The options for the transaction.
            #     Defaults to a read-write transaction.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Firestore::V1beta1::BeginTransactionResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::BeginTransactionRequest.new
            #
            #   # Call the begin_transaction method.
            #   result = client.begin_transaction request
            #
            #   # The returned object is of type Google::Cloud::Firestore::V1beta1::BeginTransactionResponse.
            #   p result
            #
            def begin_transaction request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::BeginTransactionRequest
            ...
            #   {::Google::Cloud::Firestore::V1beta1::CommitRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::CommitRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     Required. The database name. In the format:
            #     `projects/{project_id}/databases/{database_id}`.
            #   @param writes [::Array<::Google::Cloud::Firestore::V1beta1::Write, ::Hash>]
            #     The writes to apply.
            #
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Firestore::V1beta1::CommitResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::CommitRequest.new
            #
            #   # Call the commit method.
            #   result = client.commit request
            #
            #   # The returned object is of type Google::Cloud::Firestore::V1beta1::CommitResponse.
            #   p result
            #
            def commit request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::CommitRequest
            ...
            #   {::Google::Cloud::Firestore::V1beta1::RollbackRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::RollbackRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::RollbackRequest.new
            #
            ...
            def rollback request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::RollbackRequest
            ...
            #   {::Google::Cloud::Firestore::V1beta1::RunQueryRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::RunQueryRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     `projects/my-project/databases/my-database/documents` or
            #     `projects/my-project/databases/my-database/documents/chatrooms/my-chatroom`
            #   @param structured_query [::Google::Cloud::Firestore::V1beta1::StructuredQuery, ::Hash]
            #     A structured query.
            #   @param transaction [::String]
            #     Reads documents in a transaction.
            #   @param new_transaction [::Google::Cloud::Firestore::V1beta1::TransactionOptions, ::Hash]
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Enumerable<::Google::Cloud::Firestore::V1beta1::RunQueryResponse>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Enumerable<::Google::Cloud::Firestore::V1beta1::RunQueryResponse>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::RunQueryRequest.new
            #
            #   # Call the run_query method.
            #   result = client.run_query request
            #
            #   # The returned object is a streamed enumerable yielding elements of
            #   # type ::Google::Cloud::Firestore::V1beta1::RunQueryResponse.
            #   result.each do |response|
            #     p response
            #   end
            #
            def run_query request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::RunQueryRequest
            ...
            #   {::Google::Cloud::Firestore::V1beta1::PartitionQueryRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::PartitionQueryRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Firestore::V1beta1::Cursor>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Firestore::V1beta1::Cursor>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::PartitionQueryRequest.new
            #
            ...
            #   # methods are also available for managing paging directly.
            #   result.each do |response|
            #     # Each element is of type ::Google::Cloud::Firestore::V1beta1::Cursor.
            #     p response
            #   end
            #
            def partition_query request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::PartitionQueryRequest
            ...
            #
            # @param request [::Gapic::StreamInput, ::Enumerable<::Google::Cloud::Firestore::V1beta1::WriteRequest, ::Hash>]
            #   An enumerable of {::Google::Cloud::Firestore::V1beta1::WriteRequest} instances.
            # @param options [::Gapic::CallOptions, ::Hash]
            #   Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Enumerable<::Google::Cloud::Firestore::V1beta1::WriteResponse>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Enumerable<::Google::Cloud::Firestore::V1beta1::WriteResponse>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #   input << Google::Cloud::Firestore::V1beta1::WriteRequest.new
            #   input << Google::Cloud::Firestore::V1beta1::WriteRequest.new
            #   input.close
            #
            #   # Handle streamed responses. These may be interleaved with inputs.
            #   # Each response is of type ::Google::Cloud::Firestore::V1beta1::WriteResponse.
            ...
            def write request, options = nil
              ...
              request = request.lazy.map do |req|
                ::Gapic::Protobuf.coerce req, to: ::Google::Cloud::Firestore::V1beta1::WriteRequest
              end
            ...
            # Listens to changes.
            #
            # @param request [::Gapic::StreamInput, ::Enumerable<::Google::Cloud::Firestore::V1beta1::ListenRequest, ::Hash>]
            #   An enumerable of {::Google::Cloud::Firestore::V1beta1::ListenRequest} instances.
            # @param options [::Gapic::CallOptions, ::Hash]
            #   Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Enumerable<::Google::Cloud::Firestore::V1beta1::ListenResponse>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Enumerable<::Google::Cloud::Firestore::V1beta1::ListenResponse>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #   # Send requests on the stream. For each request, pass in keyword
            #   # arguments to set fields. Be sure to close the stream when done.
            #   input << Google::Cloud::Firestore::V1beta1::ListenRequest.new
            #   input << Google::Cloud::Firestore::V1beta1::ListenRequest.new
            #   input.close
            #
            #   # Handle streamed responses. These may be interleaved with inputs.
            #   # Each response is of type ::Google::Cloud::Firestore::V1beta1::ListenResponse.
            #   output.each do |response|
            #     p response
            #   end
            #
            def listen request, options = nil
              ...
              request = request.lazy.map do |req|
                ::Gapic::Protobuf.coerce req, to: ::Google::Cloud::Firestore::V1beta1::ListenRequest
              end
            ...
            #   {::Google::Cloud::Firestore::V1beta1::ListCollectionIdsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::ListCollectionIdsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Firestore::V1beta1::ListCollectionIdsResponse ListCollectionIdsResponse}.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Firestore::V1beta1::ListCollectionIdsResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Google::Cloud::Firestore::V1beta1::ListCollectionIdsResponse]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::ListCollectionIdsRequest.new
            #
            #   # Call the list_collection_ids method.
            #   result = client.list_collection_ids request
            #
            #   # The returned object is of type Google::Cloud::Firestore::V1beta1::ListCollectionIdsResponse.
            #   p result
            #
            def list_collection_ids request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::ListCollectionIdsRequest
            ...
            # {::Google::Cloud::Firestore::V1beta1::BatchWriteResponse BatchWriteResponse} for the success status of each write.
            #
            # If you require an atomically applied set of writes, use
            # {::Google::Cloud::Firestore::V1beta1::Firestore::Client#commit Commit} instead.
            #
            # @overload batch_write(request, options = nil)
            #   Pass arguments to `batch_write` via a request object, either of type
            #   {::Google::Cloud::Firestore::V1beta1::BatchWriteRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::BatchWriteRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Firestore::V1beta1::BatchWriteResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::BatchWriteRequest.new
            #
            #   # Call the batch_write method.
            #   result = client.batch_write request
            #
            #   # The returned object is of type Google::Cloud::Firestore::V1beta1::BatchWriteResponse.
            #   p result
            #
            def batch_write request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::BatchWriteRequest
            ...
            #   {::Google::Cloud::Firestore::V1beta1::CreateDocumentRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Firestore::V1beta1::CreateDocumentRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Firestore::V1beta1::CreateDocumentRequest.new
            #
            ...
            def create_document request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Firestore::V1beta1::CreateDocumentRequest
            ...
            # {::Google::Cloud::Firestore::V1beta1::Firestore::Client::Configuration::Rpcs}
