...
class FirestoreAdminTransport(abc.ABC):
    ...
    @property
    def get_field(self) -> typing.Callable[
            [firestore_admin.GetFieldRequest],
            typing.Union[
                field.Field,
                typing.Awaitable[field.Field]
            ]]:
        raise NotImplementedError()

    @property
    def update_field(self) -> typing.Callable[
    ...
    @property
    def list_fields(self) -> typing.Callable[
    ...
    @property
    def export_documents(self) -> typing.Callable[
