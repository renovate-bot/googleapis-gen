...
require File.expand_path("lib/google/cloud/firestore/admin/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-firestore-admin-v1"
  gem.version       = Google::Cloud::Firestore::Admin::V1::VERSION
