...
class ::Google::Cloud::Firestore::Admin::V1::FirestoreAdmin::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Firestore::Admin::V1::FirestoreAdmin::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Firestore::Admin::V1::FirestoreAdmin::Operations::Configuration, config
  end
end
