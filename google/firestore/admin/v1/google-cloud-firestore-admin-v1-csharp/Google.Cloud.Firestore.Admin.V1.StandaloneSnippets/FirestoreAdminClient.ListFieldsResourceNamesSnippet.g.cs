...
namespace Google.Cloud.Firestore.Admin.V1.Snippets
{
    ...
    public sealed partial class GeneratedFirestoreAdminClientStandaloneSnippets
    {
        ...
        public void ListFieldsResourceNames()
        {
            ...
            // Make the request
            PagedEnumerable<ListFieldsResponse, Field> response = firestoreAdminClient.ListFields(parent);

            // Iterate over all response items, lazily performing RPCs as required
            foreach (Field item in response)
            {
            ...
            int pageSize = 10;
            Page<Field> singlePage = response.ReadPage(pageSize);
