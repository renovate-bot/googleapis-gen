      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            secret_ = input.readMessage(com.google.cloud.secretmanager.v1beta1.Secret.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.secretmanager.v1beta1.UpdateSecretRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeSecret(com.google.cloud.secretmanager.v1beta1.Secret value) {
      if (secretBuilder_ == null) {
        if (secret_ != null) {
          secret_ =
            com.google.cloud.secretmanager.v1beta1.Secret.newBuilder(secret_).mergeFrom(value).buildPartial();
        } else {
          secret_ = value;
        }
        onChanged();
