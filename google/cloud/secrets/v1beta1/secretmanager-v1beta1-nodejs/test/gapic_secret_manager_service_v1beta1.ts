...
describe('v1beta1.SecretManagerServiceClient', () => {
    ...
    describe('createSecret', () => {
        it('invokes createSecret without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.CreateSecretRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.Secret());
            ...
            assert((client.innerApiCalls.createSecret as SinonStub)
        ...
        it('invokes createSecret without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSecret(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.secrets.v1beta1.ISecret|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('addSecretVersion', () => {
        it('invokes addSecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.AddSecretVersionRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.SecretVersion());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.addSecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes addSecretVersion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addSecretVersion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.secrets.v1beta1.ISecretVersion|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSecret', () => {
        it('invokes getSecret without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.GetSecretRequest());
            request.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSecret as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateSecret', () => {
        it('invokes updateSecret without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.UpdateSecretRequest());
            request.secret = {};
            request.secret.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateSecret as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteSecret', () => {
        it('invokes deleteSecret without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.DeleteSecretRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteSecret as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getSecretVersion', () => {
        it('invokes getSecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.GetSecretVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('accessSecretVersion', () => {
        it('invokes accessSecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.AccessSecretVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.AccessSecretVersionResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.accessSecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes accessSecretVersion without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.accessSecretVersion(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.secrets.v1beta1.IAccessSecretVersionResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('disableSecretVersion', () => {
        it('invokes disableSecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.DisableSecretVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.disableSecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('enableSecretVersion', () => {
        it('invokes enableSecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.EnableSecretVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.enableSecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('destroySecretVersion', () => {
        it('invokes destroySecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.DestroySecretVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.destroySecretVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listSecrets', () => {
        it('invokes listSecrets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.ListSecretsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listSecrets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listSecretsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.secrets.v1beta1.Secret) => {
    ...
    describe('listSecretVersions', () => {
        it('invokes listSecretVersions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secrets.v1beta1.ListSecretVersionsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.secrets.v1beta1.SecretVersion()),
              generateSampleMessage(new protos.google.cloud.secrets.v1beta1.SecretVersion()),
              generateSampleMessage(new protos.google.cloud.secrets.v1beta1.SecretVersion()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listSecretVersions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listSecretVersionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.secrets.v1beta1.SecretVersion) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('Path templates', () => {
        ...
        describe('secret', () => {
            ...
            client.initialize();
            client.pathTemplates.secretPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.secretPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('secretPath', () => {
                const result = client.secretPath("projectValue", "secretValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.secretPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromSecretName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.secretPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
