...
function main(name) {
  // [START secrets_v1beta1_generated_SecretManagerService_DeleteSecret_async]
  /**
  ...
  async function deleteSecret() {
    ...
    // Run request
    const response = await secretsClient.deleteSecret(request);
    console.log(response);
  }

  deleteSecret();
  // [END secrets_v1beta1_generated_SecretManagerService_DeleteSecret_async]
}
