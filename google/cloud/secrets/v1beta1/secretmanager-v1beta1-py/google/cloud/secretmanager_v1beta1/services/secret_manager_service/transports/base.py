...
class SecretManagerServiceTransport(abc.ABC):
    ...
    @property
    def list_secrets(self) -> typing.Callable[
            [service.ListSecretsRequest],
            typing.Union[
                service.ListSecretsResponse,
                typing.Awaitable[service.ListSecretsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def create_secret(self) -> typing.Callable[
            [service.CreateSecretRequest],
            typing.Union[
                resources.Secret,
                typing.Awaitable[resources.Secret]
            ]]:
        raise NotImplementedError()

    @property
    def add_secret_version(self) -> typing.Callable[
            [service.AddSecretVersionRequest],
            typing.Union[
                resources.SecretVersion,
                typing.Awaitable[resources.SecretVersion]
            ]]:
        raise NotImplementedError()

    @property
    def get_secret(self) -> typing.Callable[
    ...
    @property
    def update_secret(self) -> typing.Callable[
    ...
    @property
    def delete_secret(self) -> typing.Callable[
    ...
    @property
    def list_secret_versions(self) -> typing.Callable[
    ...
    @property
    def get_secret_version(self) -> typing.Callable[
    ...
    @property
    def access_secret_version(self) -> typing.Callable[
    ...
    @property
    def disable_secret_version(self) -> typing.Callable[
    ...
    @property
    def enable_secret_version(self) -> typing.Callable[
    ...
    @property
    def destroy_secret_version(self) -> typing.Callable[
