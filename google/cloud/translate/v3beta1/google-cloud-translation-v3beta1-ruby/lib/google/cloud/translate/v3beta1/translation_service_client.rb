...
require "google/cloud/translate/v3beta1/credentials"
  ...
  module Cloud
    module Translate
      module V3beta1
        ...
        #   @return [Google::Cloud::Translation::V3beta1::TranslationService::Stub]
        class TranslationServiceClient
          ...
          def initialize \
            ...
            credentials ||= Google::Cloud::Translate::V3beta1::Credentials.default
            ...
            if credentials.is_a?(String) || credentials.is_a?(Hash)
              updater_proc = Google::Cloud::Translate::V3beta1::Credentials.new(credentials).updater_proc
            end
            ...
            package_version = Gem.loaded_specs['google-cloud-translate'].version.version
            ...
            @translation_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Translation::V3beta1::TranslationService::Stub.method(:new)
            )
          ...
          # @param glossary_config [Google::Cloud::Translation::V3beta1::TranslateTextGlossaryConfig | Hash]
          #   Optional. Glossary to be applied. The glossary must be
          #   within the same region (have the same location-id) as the model, otherwise
          #   an INVALID_ARGUMENT (400) error is returned.
          #   A hash of the same form as `Google::Cloud::Translation::V3beta1::TranslateTextGlossaryConfig`
          ...
          # @yieldparam result [Google::Cloud::Translation::V3beta1::TranslateTextResponse]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Cloud::Translation::V3beta1::TranslateTextResponse]
          # @raise [Google::Gax::GaxError] if the RPC is aborted.
          # @example
          #   require "google/cloud/translate"
          #
          #   translation_client = Google::Cloud::Translate.new(version: :v3beta1)
          #
          ...
          def translate_text \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Translation::V3beta1::TranslateTextRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Translation::V3beta1::DetectLanguageResponse]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Cloud::Translation::V3beta1::DetectLanguageResponse]
          # @raise [Google::Gax::GaxError] if the RPC is aborted.
          # @example
          #   require "google/cloud/translate"
          #
          ...
          def detect_language \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Translation::V3beta1::DetectLanguageRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Translation::V3beta1::SupportedLanguages]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Cloud::Translation::V3beta1::SupportedLanguages]
          # @raise [Google::Gax::GaxError] if the RPC is aborted.
          # @example
          #   require "google/cloud/translate"
          #
          ...
          def get_supported_languages \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Translation::V3beta1::GetSupportedLanguagesRequest)
          ...
          # @param input_configs [Array<Google::Cloud::Translation::V3beta1::InputConfig | Hash>]
          #   Required. Input configurations.
          #   The total number of files matched should be <= 1000.
          #   The total content size should be <= 100M Unicode codepoints.
          #   The files must use UTF-8 encoding.
          #   A hash of the same form as `Google::Cloud::Translation::V3beta1::InputConfig`
          #   can also be provided.
          # @param output_config [Google::Cloud::Translation::V3beta1::OutputConfig | Hash]
          #   Required. Output configuration.
          #   If 2 input configs match to the same file (that is, same input path),
          #   we don't generate output for duplicate inputs.
          #   A hash of the same form as `Google::Cloud::Translation::V3beta1::OutputConfig`
          #   can also be provided.
          ...
          # @param glossaries [Hash{String => Google::Cloud::Translation::V3beta1::TranslateTextGlossaryConfig | Hash}]
          ...
          def batch_translate_text \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Translation::V3beta1::BatchTranslateTextRequest)
          ...
          # @param glossary [Google::Cloud::Translation::V3beta1::Glossary | Hash]
          #   Required. The glossary to create.
          #   A hash of the same form as `Google::Cloud::Translation::V3beta1::Glossary`
          #   can also be provided.
          # @param options [Google::Gax::CallOptions]
          #   Overrides the default settings for this call, e.g, timeout,
          #   retries, etc.
          ...
          def create_glossary \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Translation::V3beta1::CreateGlossaryRequest)
            operation = Google::Gax::Operation.new(
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Translation::V3beta1::Glossary>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Translation::V3beta1::Glossary>]
          #   An enumerable of Google::Cloud::Translation::V3beta1::Glossary instances.
          ...
          def list_glossaries \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Translation::V3beta1::ListGlossariesRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Translation::V3beta1::Glossary]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Cloud::Translation::V3beta1::Glossary]
          # @raise [Google::Gax::GaxError] if the RPC is aborted.
          # @example
          #   require "google/cloud/translate"
          #
          ...
          def get_glossary \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Translation::V3beta1::GetGlossaryRequest)
          ...
          def delete_glossary \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Translation::V3beta1::DeleteGlossaryRequest)
            operation = Google::Gax::Operation.new(
