  ...
  module Cloud
    module Translation
      module V3beta1
        ...
        #   @return [Google::Cloud::Translation::V3beta1::TranslateTextGlossaryConfig]
        ...
        #   @return [Array<Google::Cloud::Translation::V3beta1::Translation>]
        #     Text translation responses with no glossary applied.
        #     This field has the same length as
        #     {Google::Cloud::Translation::V3beta1::TranslateTextRequest#contents `contents`}.
        # @!attribute [rw] glossary_translations
        #   @return [Array<Google::Cloud::Translation::V3beta1::Translation>]
        #     Text translation responses if a glossary is provided in the request.
        #     This can be the same as
        #     {Google::Cloud::Translation::V3beta1::TranslateTextResponse#translations `translations`} if no terms apply.
        #     This field has the same length as
        #     {Google::Cloud::Translation::V3beta1::TranslateTextRequest#contents `contents`}.
        ...
        #   @return [Array<Google::Cloud::Translation::V3beta1::DetectedLanguage>]
        ...
        # @!attribute [rw] languages
        #   @return [Array<Google::Cloud::Translation::V3beta1::SupportedLanguage>]
        ...
        #   @return [Google::Cloud::Translation::V3beta1::GcsSource]
        ...
        #   @return [Google::Cloud::Translation::V3beta1::GcsDestination]
        ...
        #   @return [Array<Google::Cloud::Translation::V3beta1::InputConfig>]
        #     Required. Input configurations.
        #     The total number of files matched should be <= 1000.
        #     The total content size should be <= 100M Unicode codepoints.
        #     The files must use UTF-8 encoding.
        # @!attribute [rw] output_config
        #   @return [Google::Cloud::Translation::V3beta1::OutputConfig]
        #     Required. Output configuration.
        #     If 2 input configs match to the same file (that is, same input path),
        #     we don't generate output for duplicate inputs.
        # @!attribute [rw] glossaries
        #   @return [Hash{String => Google::Cloud::Translation::V3beta1::TranslateTextGlossaryConfig}]
        ...
        # @!attribute [rw] state
        #   @return [Google::Cloud::Translation::V3beta1::BatchTranslateMetadata::State]
        ...
        #   @return [Google::Cloud::Translation::V3beta1::Glossary::LanguageCodePair]
        #     Used with unidirectional glossaries.
        # @!attribute [rw] language_codes_set
        #   @return [Google::Cloud::Translation::V3beta1::Glossary::LanguageCodesSet]
        #     Used with equivalent term set glossaries.
        # @!attribute [rw] input_config
        #   @return [Google::Cloud::Translation::V3beta1::GlossaryInputConfig]
        ...
        # @!attribute [rw] glossaries
        #   @return [Array<Google::Cloud::Translation::V3beta1::Glossary>]
        ...
        # @!attribute [rw] state
        #   @return [Google::Cloud::Translation::V3beta1::CreateGlossaryMetadata::State]
        ...
        # @!attribute [rw] state
        #   @return [Google::Cloud::Translation::V3beta1::DeleteGlossaryMetadata::State]
