...
class ::Google::Cloud::Translate::V3beta1::TranslationService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Translate::V3beta1::TranslationService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Translate::V3beta1::TranslationService::Operations::Configuration, config
  end
end
