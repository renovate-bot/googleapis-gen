...
class ::Google::Cloud::Translate::V3beta1::TranslationService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_translate_text
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Translate::V3beta1::TranslateTextResponse.new
    ...
    translate_text_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Translate::V3beta1::TranslateTextRequest, request
      ...
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Translate::V3beta1::TranslateTextGlossaryConfig), request["glossary_config"]
    ...
    Gapic::ServiceStub.stub :new, translate_text_client_stub do
      ...
      # Use protobuf object
      client.translate_text ::Google::Cloud::Translate::V3beta1::TranslateTextRequest.new(contents: contents, mime_type: mime_type, source_language_code: source_language_code, target_language_code: target_language_code, parent: parent, model: model, glossary_config: glossary_config, labels: labels) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_detect_language
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Translate::V3beta1::DetectLanguageResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    detect_language_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Translate::V3beta1::DetectLanguageRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["model"]
    ...
    Gapic::ServiceStub.stub :new, detect_language_client_stub do
      ...
      # Use protobuf object
      client.detect_language ::Google::Cloud::Translate::V3beta1::DetectLanguageRequest.new(parent: parent, model: model, content: content, mime_type: mime_type, labels: labels) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_supported_languages
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Translate::V3beta1::SupportedLanguages.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_supported_languages_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Translate::V3beta1::GetSupportedLanguagesRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, get_supported_languages_client_stub do
      ...
      # Use protobuf object
      client.get_supported_languages ::Google::Cloud::Translate::V3beta1::GetSupportedLanguagesRequest.new(parent: parent, display_language_code: display_language_code, model: model) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_translate_document
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Translate::V3beta1::TranslateDocumentResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    translate_document_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Translate::V3beta1::TranslateDocumentRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["source_language_code"]
      assert_equal "hello world", request["target_language_code"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Translate::V3beta1::DocumentInputConfig), request["document_input_config"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Translate::V3beta1::DocumentOutputConfig), request["document_output_config"]
      assert_equal "hello world", request["model"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Translate::V3beta1::TranslateTextGlossaryConfig), request["glossary_config"]
      assert_equal({}, request["labels"].to_h)
      refute_nil options
  ...
  def test_batch_translate_text
    ...
    batch_translate_text_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Translate::V3beta1::BatchTranslateTextRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["source_language_code"]
      assert_equal ["hello world"], request["target_language_codes"]
      assert_equal({}, request["models"].to_h)
      assert_kind_of ::Google::Cloud::Translate::V3beta1::InputConfig, request["input_configs"].first
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Translate::V3beta1::OutputConfig), request["output_config"]
  ...
  def test_batch_translate_document
    ...
    batch_translate_document_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Translate::V3beta1::BatchTranslateDocumentRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["source_language_code"]
      assert_equal ["hello world"], request["target_language_codes"]
      assert_kind_of ::Google::Cloud::Translate::V3beta1::BatchDocumentInputConfig, request["input_configs"].first
  ...
  def test_create_glossary
    ...
    create_glossary_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Translate::V3beta1::CreateGlossaryRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Translate::V3beta1::Glossary), request["glossary"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_glossary_client_stub do
      ...
      # Use protobuf object
      client.create_glossary ::Google::Cloud::Translate::V3beta1::CreateGlossaryRequest.new(parent: parent, glossary: glossary) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_glossaries
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Translate::V3beta1::ListGlossariesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_glossaries_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Translate::V3beta1::ListGlossariesRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_glossaries_client_stub do
      ...
      # Use protobuf object
      client.list_glossaries ::Google::Cloud::Translate::V3beta1::ListGlossariesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_glossary
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Translate::V3beta1::Glossary.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_glossary_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Translate::V3beta1::GetGlossaryRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_glossary_client_stub do
      ...
      # Use protobuf object
      client.get_glossary ::Google::Cloud::Translate::V3beta1::GetGlossaryRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_glossary
    ...
    delete_glossary_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Translate::V3beta1::DeleteGlossaryRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_glossary_client_stub do
      ...
      # Use protobuf object
      client.delete_glossary ::Google::Cloud::Translate::V3beta1::DeleteGlossaryRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Translate::V3beta1::TranslationService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Translate::V3beta1::TranslationService::Operations, client.operations_client
  end
end
