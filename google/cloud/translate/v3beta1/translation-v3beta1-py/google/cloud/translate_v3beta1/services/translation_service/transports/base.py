...
class TranslationServiceTransport(abc.ABC):
    ...
    @property
    def translate_text(self) -> typing.Callable[
    ...
    @property
    def detect_language(self) -> typing.Callable[
    ...
    @property
    def get_supported_languages(self) -> typing.Callable[
    ...
    @property
    def translate_document(self) -> typing.Callable[
    ...
    @property
    def batch_translate_text(self) -> typing.Callable[
    ...
    @property
    def batch_translate_document(self) -> typing.Callable[
    ...
    @property
    def create_glossary(self) -> typing.Callable[
    ...
    @property
    def list_glossaries(self) -> typing.Callable[
    ...
    @property
    def get_glossary(self) -> typing.Callable[
            [translation_service.GetGlossaryRequest],
            typing.Union[
                translation_service.Glossary,
                typing.Awaitable[translation_service.Glossary]
            ]]:
        raise NotImplementedError()

    @property
    def delete_glossary(self) -> typing.Callable[
