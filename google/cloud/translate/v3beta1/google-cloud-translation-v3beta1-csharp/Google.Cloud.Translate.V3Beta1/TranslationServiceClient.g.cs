...
namespace Google.Cloud.Translate.V3Beta1
{
    ...
    public abstract partial class TranslationServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual DetectLanguageResponse DetectLanguage(string parent, string model, string mimeType, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<DetectLanguageResponse> DetectLanguageAsync(string parent, string model, string mimeType, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<DetectLanguageResponse> DetectLanguageAsync(string parent, string model, string mimeType, st::CancellationToken cancellationToken) =>
            DetectLanguageAsync(parent, model, mimeType, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual DetectLanguageResponse DetectLanguage(gagr::LocationName parent, string model, string mimeType, gaxgrpc::CallSettings callSettings = null) =>
            DetectLanguage(new DetectLanguageRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<DetectLanguageResponse> DetectLanguageAsync(gagr::LocationName parent, string model, string mimeType, gaxgrpc::CallSettings callSettings = null) =>
            DetectLanguageAsync(new DetectLanguageRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Model = model ?? "",
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<DetectLanguageResponse> DetectLanguageAsync(gagr::LocationName parent, string model, string mimeType, st::CancellationToken cancellationToken) =>
            DetectLanguageAsync(parent, model, mimeType, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual SupportedLanguages GetSupportedLanguages(string parent, string displayLanguageCode, string model, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<SupportedLanguages> GetSupportedLanguagesAsync(string parent, string displayLanguageCode, string model, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<SupportedLanguages> GetSupportedLanguagesAsync(string parent, string displayLanguageCode, string model, st::CancellationToken cancellationToken) =>
            GetSupportedLanguagesAsync(parent, displayLanguageCode, model, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual SupportedLanguages GetSupportedLanguages(gagr::LocationName parent, string displayLanguageCode, string model, gaxgrpc::CallSettings callSettings = null) =>
            GetSupportedLanguages(new GetSupportedLanguagesRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                DisplayLanguageCode = displayLanguageCode ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<SupportedLanguages> GetSupportedLanguagesAsync(gagr::LocationName parent, string displayLanguageCode, string model, gaxgrpc::CallSettings callSettings = null) =>
            GetSupportedLanguagesAsync(new GetSupportedLanguagesRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                DisplayLanguageCode = displayLanguageCode ?? "",
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<SupportedLanguages> GetSupportedLanguagesAsync(gagr::LocationName parent, string displayLanguageCode, string model, st::CancellationToken cancellationToken) =>
            GetSupportedLanguagesAsync(parent, displayLanguageCode, model, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="Glossary"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListGlossariesResponse, Glossary> ListGlossaries(string parent, string filter, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="Glossary"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListGlossariesResponse, Glossary> ListGlossariesAsync(string parent, string filter, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="Glossary"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListGlossariesResponse, Glossary> ListGlossaries(gagr::LocationName parent, string filter, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListGlossaries(new ListGlossariesRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Filter = filter ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="Glossary"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListGlossariesResponse, Glossary> ListGlossariesAsync(gagr::LocationName parent, string filter, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListGlossariesAsync(new ListGlossariesRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                Filter = filter ?? "",
