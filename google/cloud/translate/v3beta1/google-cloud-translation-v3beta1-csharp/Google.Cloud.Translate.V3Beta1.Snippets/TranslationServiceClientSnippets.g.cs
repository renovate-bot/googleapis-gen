...
namespace Google.Cloud.Translate.V3Beta1.Snippets
{
    ...
    public sealed class GeneratedTranslationServiceClientSnippets
    {
        ...
        {
            // Snippet: DetectLanguage(string, string, string, CallSettings)
            // Create client
            TranslationServiceClient translationServiceClient = TranslationServiceClient.Create();
            // Initialize request argument(s)
        ...
        {
            // Snippet: DetectLanguageAsync(string, string, string, CallSettings)
            // Additional: DetectLanguageAsync(string, string, string, CancellationToken)
            // Create client
            TranslationServiceClient translationServiceClient = await TranslationServiceClient.CreateAsync();
            // Initialize request argument(s)
            string parent = "projects/[PROJECT]/locations/[LOCATION]";
            ...
            string mimeType = "";
            // Make the request
            DetectLanguageResponse response = await translationServiceClient.DetectLanguageAsync(parent, model, mimeType);
            // End snippet
        }
        ...
        {
            // Snippet: DetectLanguageAsync(LocationName, string, string, CallSettings)
            // Additional: DetectLanguageAsync(LocationName, string, string, CancellationToken)
            // Create client
            TranslationServiceClient translationServiceClient = await TranslationServiceClient.CreateAsync();
            // Initialize request argument(s)
            LocationName parent = LocationName.FromProjectLocation("[PROJECT]", "[LOCATION]");
        ...
        public async Task ListGlossariesAsync()
        {
            ...
            string filter = "";
            // Make the request
            PagedAsyncEnumerable<ListGlossariesResponse, Glossary> response = translationServiceClient.ListGlossariesAsync(parent, filter);
