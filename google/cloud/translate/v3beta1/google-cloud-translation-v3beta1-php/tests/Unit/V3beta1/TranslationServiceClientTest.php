...
namespace Google\Cloud\Translate\Tests\Unit\V3beta1;
...
class TranslationServiceClientTest extends GeneratedTest
{
    ...
    public function translateTextTest()
    {
        ...
        $this->assertSame('/google.cloud.translation.v3beta1.TranslationService/TranslateText', $actualFuncCall);
    ...
    public function detectLanguageTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.translation.v3beta1.TranslationService/DetectLanguage', $actualFuncCall);
    ...
    public function getSupportedLanguagesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.translation.v3beta1.TranslationService/GetSupportedLanguages', $actualFuncCall);
    ...
    public function batchTranslateTextTest()
    {
        ...
        $this->assertSame('/google.cloud.translation.v3beta1.TranslationService/BatchTranslateText', $actualApiFuncCall);
    ...
    public function createGlossaryTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.translation.v3beta1.TranslationService/CreateGlossary', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
    ...
    public function listGlossariesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.translation.v3beta1.TranslationService/ListGlossaries', $actualFuncCall);
    ...
    public function getGlossaryTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.translation.v3beta1.TranslationService/GetGlossary', $actualFuncCall);
    ...
    public function deleteGlossaryTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.translation.v3beta1.TranslationService/DeleteGlossary', $actualApiFuncCall);
