 ...
 *
 * Generated from protobuf message <code>google.cloud.translation.v3beta1.Glossary.LanguageCodesSet</code>
 */
...
class_alias(LanguageCodesSet::class, \Google\Cloud\Translate\V3beta1\Glossary_LanguageCodesSet::class);
