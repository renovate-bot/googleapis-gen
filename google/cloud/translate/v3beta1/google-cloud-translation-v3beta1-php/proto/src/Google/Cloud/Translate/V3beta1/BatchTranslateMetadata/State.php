...
namespace Google\Cloud\Translate\V3beta1\BatchTranslateMetadata;
 ...
 * State of the job.
 *
 * Protobuf type <code>google.cloud.translation.v3beta1.BatchTranslateMetadata.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Translate\V3beta1\BatchTranslateMetadata_State::class);
