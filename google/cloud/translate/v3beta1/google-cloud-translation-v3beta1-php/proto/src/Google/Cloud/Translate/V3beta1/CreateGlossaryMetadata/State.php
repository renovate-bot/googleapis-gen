...
namespace Google\Cloud\Translate\V3beta1\CreateGlossaryMetadata;
 ...
 *
 * Protobuf type <code>google.cloud.translation.v3beta1.CreateGlossaryMetadata.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Translate\V3beta1\CreateGlossaryMetadata_State::class);
