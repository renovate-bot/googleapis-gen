 ...
 * DeleteGlossary.
 *
 * Generated from protobuf message <code>google.cloud.translation.v3beta1.DeleteGlossaryMetadata</code>
 */
class DeleteGlossaryMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DeleteGlossaryMetadata.State state = 2;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Translate\V3beta1\DeleteGlossaryMetadata\State::class);
        $this->state = $var;
