 ...
 *
 * Generated from protobuf message <code>google.cloud.translation.v3beta1.Glossary</code>
 */
class Glossary extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Google\Cloud\Translate\V3beta1\GlossaryInputConfig $input_config
     *           Required. Provides examples to build the glossary from.
     *           Total glossary must not exceed 10M Unicode codepoints.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.Glossary.LanguageCodePair language_pair = 3;</code>
     * @param \Google\Cloud\Translate\V3beta1\Glossary\LanguageCodePair $var
     * @return $this
     */
    public function setLanguagePair($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Translate\V3beta1\Glossary\LanguageCodePair::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.Glossary.LanguageCodesSet language_codes_set = 4;</code>
     * @param \Google\Cloud\Translate\V3beta1\Glossary\LanguageCodesSet $var
     * @return $this
     */
    public function setLanguageCodesSet($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Translate\V3beta1\Glossary\LanguageCodesSet::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.GlossaryInputConfig input_config = 5;</code>
     * @param \Google\Cloud\Translate\V3beta1\GlossaryInputConfig $var
     * @return $this
     */
    public function setInputConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Translate\V3beta1\GlossaryInputConfig::class);
