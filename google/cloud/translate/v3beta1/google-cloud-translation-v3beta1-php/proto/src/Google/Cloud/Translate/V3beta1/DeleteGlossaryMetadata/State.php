...
namespace Google\Cloud\Translate\V3beta1\DeleteGlossaryMetadata;
 ...
 *
 * Protobuf type <code>google.cloud.translation.v3beta1.DeleteGlossaryMetadata.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Translate\V3beta1\DeleteGlossaryMetadata_State::class);
