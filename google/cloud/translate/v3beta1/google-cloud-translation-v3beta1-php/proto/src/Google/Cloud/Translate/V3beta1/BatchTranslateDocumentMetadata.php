 ...
 *
 * Generated from protobuf message <code>google.cloud.translation.v3beta1.BatchTranslateDocumentMetadata</code>
 */
class BatchTranslateDocumentMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.BatchTranslateDocumentMetadata.State state = 1;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Translate\V3beta1\BatchTranslateDocumentMetadata\State::class);
        $this->state = $var;
