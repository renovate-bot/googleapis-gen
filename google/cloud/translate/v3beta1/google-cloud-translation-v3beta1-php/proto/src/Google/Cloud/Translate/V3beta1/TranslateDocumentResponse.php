 ...
 *
 * Generated from protobuf message <code>google.cloud.translation.v3beta1.TranslateDocumentResponse</code>
 */
class TranslateDocumentResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * Translated document.
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DocumentTranslation document_translation = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DocumentTranslation glossary_document_translation = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.TranslateTextGlossaryConfig glossary_config = 4;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Translate\V3beta1\DocumentTranslation $document_translation
     *           Translated document.
     *     @type \Google\Cloud\Translate\V3beta1\DocumentTranslation $glossary_document_translation
     *           The document's translation output if a glossary is provided in the request.
     *           This can be the same as [TranslateDocumentResponse.document_translation]
     *           if no glossary terms apply.
     *     @type string $model
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DocumentTranslation document_translation = 1;</code>
     * @return \Google\Cloud\Translate\V3beta1\DocumentTranslation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DocumentTranslation document_translation = 1;</code>
     * @param \Google\Cloud\Translate\V3beta1\DocumentTranslation $var
     * @return $this
     */
    public function setDocumentTranslation($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Translate\V3beta1\DocumentTranslation::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.TranslateTextGlossaryConfig glossary_config = 4;</code>
     * @return \Google\Cloud\Translate\V3beta1\TranslateTextGlossaryConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.TranslateTextGlossaryConfig glossary_config = 4;</code>
     * @param \Google\Cloud\Translate\V3beta1\TranslateTextGlossaryConfig $var
     * @return $this
     */
    public function setGlossaryConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Translate\V3beta1\TranslateTextGlossaryConfig::class);
