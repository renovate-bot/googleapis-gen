...
namespace Google\Cloud\Translate\V3beta1\BatchTranslateDocumentMetadata;
 ...
 * State of the job.
 *
 * Protobuf type <code>google.cloud.translation.v3beta1.BatchTranslateDocumentMetadata.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Translate\V3beta1\BatchTranslateDocumentMetadata_State::class);
