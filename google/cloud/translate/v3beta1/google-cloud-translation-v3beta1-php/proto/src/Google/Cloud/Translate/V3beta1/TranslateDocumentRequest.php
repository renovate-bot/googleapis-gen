 ...
 *
 * Generated from protobuf message <code>google.cloud.translation.v3beta1.TranslateDocumentRequest</code>
 */
class TranslateDocumentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DocumentInputConfig document_input_config = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DocumentOutputConfig document_output_config = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Required. The BCP-47 language code to use for translation of the input
     *           document, set to one of the language codes listed in Language Support.
     *     @type \Google\Cloud\Translate\V3beta1\DocumentInputConfig $document_input_config
     *           Required. Input configurations.
     *     @type \Google\Cloud\Translate\V3beta1\DocumentOutputConfig $document_output_config
     *           Optional. Output configurations.
     *           Defines if the output file should be stored within Cloud Storage as well
     *           as the desired output format. If not provided the translated file will
     *           only be returned through a byte-stream and its output mime type will be
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DocumentInputConfig document_input_config = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Translate\V3beta1\DocumentInputConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DocumentInputConfig document_input_config = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Translate\V3beta1\DocumentInputConfig $var
     * @return $this
     */
    public function setDocumentInputConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Translate\V3beta1\DocumentInputConfig::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DocumentOutputConfig document_output_config = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\Translate\V3beta1\DocumentOutputConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.translation.v3beta1.DocumentOutputConfig document_output_config = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Translate\V3beta1\DocumentOutputConfig $var
     * @return $this
     */
    public function setDocumentOutputConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Translate\V3beta1\DocumentOutputConfig::class);
