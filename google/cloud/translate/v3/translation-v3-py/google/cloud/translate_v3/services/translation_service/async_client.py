...
class TranslationServiceAsyncClient:
    ...
    from_service_account_info = TranslationServiceClient.from_service_account_info
    ...
    get_transport_class = functools.partial(type(TranslationServiceClient).get_transport_class, type(TranslationServiceClient))
    ...
    async def create_glossary(self,
    ...
    async def list_glossaries(self,
    ...
    async def delete_glossary(self,
