...
type TransferableSku struct {
	...
	IsCommitment *wrapperspb.BoolValue `protobuf:"bytes,6,opt,name=is_commitment,json=isCommitment,proto3" json:"is_commitment,omitempty"`
	// Commitment end timestamp.
	CommitmentEndTimestamp *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=commitment_end_timestamp,json=commitmentEndTimestamp,proto3" json:"commitment_end_timestamp,omitempty"`
