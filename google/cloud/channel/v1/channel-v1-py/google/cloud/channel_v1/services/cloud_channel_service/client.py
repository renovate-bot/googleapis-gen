...
class CloudChannelServiceClient(metaclass=CloudChannelServiceClientMeta):
    ...
    def check_cloud_identity_accounts_exist(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.check_cloud_identity_accounts_exist]
    ...
    def list_transferable_skus(self,
    ...
    def list_transferable_offers(self,
    ...
    def change_renewal_settings(self,
    ...
    def transfer_entitlements(self,
    ...
    def transfer_entitlements_to_google(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.transfer_entitlements_to_google]
    ...
    def list_channel_partner_links(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_channel_partner_links]
    ...
    def get_channel_partner_link(self,
    ...
    def create_channel_partner_link(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_channel_partner_link]
    ...
    def update_channel_partner_link(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_channel_partner_link]
    ...
    def list_purchasable_skus(self,
    ...
    def list_purchasable_offers(self,
