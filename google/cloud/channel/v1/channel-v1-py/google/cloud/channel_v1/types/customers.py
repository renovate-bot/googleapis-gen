...
class Customer(proto.Message):
    ...
    org_postal_address = proto.Field(proto.MESSAGE, number=3,
        message=postal_address.PostalAddress,
    )

    primary_contact_info = proto.Field(proto.MESSAGE, number=4,
        message='ContactInfo',
    )
    ...
    cloud_identity_info = proto.Field(proto.MESSAGE, number=12,
