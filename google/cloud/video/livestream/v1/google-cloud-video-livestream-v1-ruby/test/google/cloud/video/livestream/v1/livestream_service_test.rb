...
class ::Google::Cloud::Video::Livestream::V1::LivestreamService::ClientTest < Minitest::Test
  ...
  def test_delete_channel
    ...
    Gapic::ServiceStub.stub :new, delete_channel_client_stub do
      ...
      # Use hash object
      client.delete_channel({ name: name, request_id: request_id }) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.delete_channel ::Google::Cloud::Video::Livestream::V1::DeleteChannelRequest.new(name: name, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.delete_channel({ name: name, request_id: request_id }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_channel(::Google::Cloud::Video::Livestream::V1::DeleteChannelRequest.new(name: name, request_id: request_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
