...
class livestreamCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'delete_channel': ('name', 'request_id', ),
...
def fix_files(
    ...
    *,
    transformer=livestreamCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the livestream client library.
