...
class LivestreamServiceAsyncClient:
    ...
    async def create_channel(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.CreateChannelRequest, dict]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            channel (:class:`google.cloud.video.livestream_v1.types.Channel`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.video.livestream_v1.types.Channel` Channel resource represents the processor that does a user-defined
        ...
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.create_channel,
    ...
    async def list_channels(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.ListChannelsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.video.livestream_v1.services.livestream_service.pagers.ListChannelsAsyncPager:
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_channel(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.GetChannelRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.video.livestream_v1.types.Channel:
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def delete_channel(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.DeleteChannelRequest, dict]):
                The request object. Request message for
    ...
    async def update_channel(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.UpdateChannelRequest, dict]):
                The request object. Request message for
    ...
    async def start_channel(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.StartChannelRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.video.livestream_v1.types.ChannelOperationResponse`
    ...
    async def stop_channel(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.StopChannelRequest, dict]):
                The request object. Request message for
    ...
    async def create_input(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.CreateInputRequest, dict]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            input (:class:`google.cloud.video.livestream_v1.types.Input`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.video.livestream_v1.types.Input` Input resource represents the endpoint from which the channel ingests
                   the input stream.
    ...
    async def list_inputs(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.ListInputsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.video.livestream_v1.services.livestream_service.pagers.ListInputsAsyncPager:
                Response message for
                "LivestreamService.ListInputs".
                Iterating over this object will yield
                results and resolve additional pages
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_input(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.GetInputRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.video.livestream_v1.types.Input:
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def delete_input(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.DeleteInputRequest, dict]):
                The request object. Request message for
    ...
    async def update_input(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.UpdateInputRequest, dict]):
                The request object. Request message for
    ...
    async def create_event(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.CreateEventRequest, dict]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            event (:class:`google.cloud.video.livestream_v1.types.Event`):
        ...
        Returns:
            google.cloud.video.livestream_v1.types.Event:
    ...
    async def list_events(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.ListEventsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.video.livestream_v1.services.livestream_service.pagers.ListEventsAsyncPager:
                Response message for
                "LivestreamService.ListEvents".
                Iterating over this object will yield
                results and resolve additional pages
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_event(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.GetEventRequest, dict]):
                The request object. Request message for
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def delete_event(self,
        ...
        Args:
            request (Union[google.cloud.video.livestream_v1.types.DeleteEventRequest, dict]):
                The request object. Request message for
