...
class CreateChannelRequest(proto.Message):
    ...
    Attributes:
        ...
        channel (google.cloud.video.livestream_v1.types.Channel):
...
class ListChannelsResponse(proto.Message):
    ...
    Attributes:
        channels (Sequence[google.cloud.video.livestream_v1.types.Channel]):
            A list of channels.
        next_page_token (str):
...
class CreateInputRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Required. The parent location for the resource, in the form
            of: ``projects/{project}/locations/{location}``.
        input (google.cloud.video.livestream_v1.types.Input):
...
class ListInputsResponse(proto.Message):
    ...
    Attributes:
        inputs (Sequence[google.cloud.video.livestream_v1.types.Input]):
            A list of inputs.
        next_page_token (str):
            Token to retrieve the next page of results,
            or empty if there are no more results in the
...
class CreateEventRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            of:
            ``projects/{project}/locations/{location}/channels/{channelId}``.
        event (google.cloud.video.livestream_v1.types.Event):
...
class ListEventsResponse(proto.Message):
    ...
    Attributes:
        events (Sequence[google.cloud.video.livestream_v1.types.Event]):
            A list of events.
        next_page_token (str):
            Token to retrieve the next page of results,
            or empty if there are no more results in the
