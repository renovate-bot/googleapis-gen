...
class ElementaryStream(proto.Message):
    ...
    Attributes:
        ...
        video_stream (google.cloud.video.livestream_v1.types.VideoStream):
            Encoding of a video stream.

            This field is a member of `oneof`_ ``elementary_stream``.
        audio_stream (google.cloud.video.livestream_v1.types.AudioStream):
            Encoding of an audio stream.

            This field is a member of `oneof`_ ``elementary_stream``.
        text_stream (google.cloud.video.livestream_v1.types.TextStream):
...
class MuxStream(proto.Message):
    ...
    Attributes:
        ...
        segment_settings (google.cloud.video.livestream_v1.types.SegmentSettings):
...
class Manifest(proto.Message):
    ...
    Attributes:
        file_name (str):
            ...
            a unique file name.
        type_ (google.cloud.video.livestream_v1.types.Manifest.ManifestType):
...
class PreprocessingConfig(proto.Message):
    ...
    Attributes:
        crop (google.cloud.video.livestream_v1.types.PreprocessingConfig.Crop):
            Specify the video cropping configuration.
        pad (google.cloud.video.livestream_v1.types.PreprocessingConfig.Pad):
...
class VideoStream(proto.Message):
    ...
    Attributes:
        h264 (google.cloud.video.livestream_v1.types.VideoStream.H264CodecSettings):
            H264 codec settings.
    ...
    class H264CodecSettings(proto.Message):
        ...
        Attributes:
            ...
            bitrate_bps (int):
                ...
                second. Must be between 10,000 and 80,000,000.
            allow_open_gop (bool):
