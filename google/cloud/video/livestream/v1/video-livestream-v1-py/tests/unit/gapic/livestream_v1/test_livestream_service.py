...
from google.cloud.video.livestream_v1.services.livestream_service import LivestreamServiceAsyncClient
from google.cloud.video.livestream_v1.services.livestream_service import LivestreamServiceClient
from google.cloud.video.livestream_v1.services.livestream_service import pagers
from google.cloud.video.livestream_v1.services.livestream_service import transports
from google.cloud.video.livestream_v1.types import outputs
from google.cloud.video.livestream_v1.types import resources
from google.cloud.video.livestream_v1.types import service
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (LivestreamServiceAsyncClient, transports.LivestreamServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (LivestreamServiceClient, transports.LivestreamServiceGrpcTransport, "grpc", "true"),
    (LivestreamServiceAsyncClient, transports.LivestreamServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (LivestreamServiceClient, transports.LivestreamServiceGrpcTransport, "grpc", "false"),
    (LivestreamServiceAsyncClient, transports.LivestreamServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(LivestreamServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(LivestreamServiceClient))
@mock.patch.object(LivestreamServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(LivestreamServiceAsyncClient))
...
def test_livestream_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_create_channel(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_channel),
            '__call__') as call:
...
def test_update_channel_field_headers():
    ...
    assert (
        'x-goog-request-params',
        'channel.name=channel.name/value',
    ) in kw['metadata']
...
def test_start_channel(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.start_channel),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_input(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_input),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_inputs(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_inputs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_input(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_input),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_input(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_input),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_input(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_input),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_event(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = resources.Event(
            ...
            ad_break=resources.Event.AdBreakTask(duration=duration_pb2.Duration(seconds=751)),
        )
...
def test_livestream_service_base_transport():
    ...
    with mock.patch('google.cloud.video.livestream_v1.services.livestream_service.transports.LivestreamServiceTransport.__init__') as Transport:
...
def test_livestream_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.video.livestream_v1.services.livestream_service.transports.LivestreamServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_livestream_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.video.livestream_v1.services.livestream_service.transports.LivestreamServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LivestreamServiceTransport()
        adc.assert_called_once()
...
def test_livestream_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_livestream_service_host_no_port():
    client = LivestreamServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='livestream.googleapis.com'),
    )
    assert client.transport._host == 'livestream.googleapis.com:443'
...
def test_livestream_service_host_with_port():
    client = LivestreamServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='livestream.googleapis.com:8000'),
    )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.LivestreamServiceGrpcTransport, transports.LivestreamServiceGrpcAsyncIOTransport])
def test_livestream_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
