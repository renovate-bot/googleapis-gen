      ...
      module Transcoder
        module V1beta1
          ...
          class Overlay
            ...
            class NormalizedCoordinate; end
          ...
          class Encryption
            ...
            #     * 'cenc'
            #     * 'cbcs'
            class MpegCommonEncryption; end
          end
