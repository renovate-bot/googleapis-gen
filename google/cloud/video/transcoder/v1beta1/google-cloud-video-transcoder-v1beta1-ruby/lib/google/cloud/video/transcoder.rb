...
module Google
  module Cloud
    module Video
      ...
      ##
      # # Ruby Client for Transcoder API ([Beta](https://github.com/GoogleCloudPlatform/google-cloud-ruby#versioning))
      #
      # [Transcoder API][Product Documentation]:
      ...
      # 3. [Enable the Transcoder API.](https://console.cloud.google.com/apis/library/video-transcoder.googleapis.com)
      ...
      #
      # ### Next Steps
      # - Read the [Transcoder API Product documentation][Product Documentation]
      #   to learn more about the product and see How-to Guides.
      # - View this [repository's main README](https://github.com/GoogleCloudPlatform/google-cloud-ruby/blob/master/README.md)
      #   to see the full list of Cloud APIs that we cover.
      #
      # [Product Documentation]: https://cloud.google.com/video-transcoder
      #
      # ## Enabling Logging
      #
      ...
      module Transcoder
        ...
        FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("transcoder"))
        ...
        def self.new(*args, version: :v1beta1, **kwargs)
          ...
          version_module = Google::Cloud::Video::Transcoder
            .constants
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Video::Transcoder.const_get(version_module).new(*args, **kwargs)
        end
      end
    end
  end
