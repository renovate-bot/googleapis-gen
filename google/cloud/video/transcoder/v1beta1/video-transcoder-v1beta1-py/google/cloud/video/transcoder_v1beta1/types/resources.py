...
class AudioStream(proto.Message):
    ...
    class AudioAtom(proto.Message):
        ...
        channels = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
            message='AudioStream.AudioAtom.AudioChannel',
        )
...
class TextStream(proto.Message):
    ...
    class TextAtom(proto.Message):
        ...
        inputs = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
            message='TextStream.TextAtom.TextInput',
        )
...
class Progress(proto.Message):
    ...
    uploaded = proto.Field(
        proto.DOUBLE,
        number=3,
    )
    notified = proto.Field(
        proto.DOUBLE,
        number=4,
    )
