...
class TranscoderServiceTransport(abc.ABC):
    ...
    def create_job(self) -> typing.Callable[
            ...
            typing.Union[
                resources.Job,
                typing.Awaitable[resources.Job]
            ]]:
    ...
    def list_jobs(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[services.ListJobsResponse]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def create_job_template(self) -> typing.Callable[
            [services.CreateJobTemplateRequest],
            typing.Union[
                resources.JobTemplate,
                typing.Awaitable[resources.JobTemplate]
            ]]:
        raise NotImplementedError()

    @property
    def list_job_templates(self) -> typing.Callable[
            [services.ListJobTemplatesRequest],
            typing.Union[
                services.ListJobTemplatesResponse,
                typing.Awaitable[services.ListJobTemplatesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_job_template(self) -> typing.Callable[
    ...
    @property
    def delete_job_template(self) -> typing.Callable[
