...
public class OsConfigServiceSettings extends ClientSettings<OsConfigServiceSettings> {
  ...
  public UnaryCallSettings<GuestPolicies.CreateGuestPolicyRequest, GuestPolicies.GuestPolicy>
    ...
    return ((OsConfigServiceStubSettings) getStubSettings()).createGuestPolicySettings();
  }
  ...
  public UnaryCallSettings<GuestPolicies.GetGuestPolicyRequest, GuestPolicies.GuestPolicy>
    ...
    return ((OsConfigServiceStubSettings) getStubSettings()).getGuestPolicySettings();
  }
  ...
  public PagedCallSettings<
    ...
    return ((OsConfigServiceStubSettings) getStubSettings()).listGuestPoliciesSettings();
  }
  ...
  public UnaryCallSettings<GuestPolicies.UpdateGuestPolicyRequest, GuestPolicies.GuestPolicy>
    ...
    return ((OsConfigServiceStubSettings) getStubSettings()).updateGuestPolicySettings();
  }
  ...
  public UnaryCallSettings<GuestPolicies.DeleteGuestPolicyRequest, Empty>
    ...
    return ((OsConfigServiceStubSettings) getStubSettings()).deleteGuestPolicySettings();
  }
  ...
  public UnaryCallSettings<
    ...
    return ((OsConfigServiceStubSettings) getStubSettings()).lookupEffectiveGuestPolicySettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<OsConfigServiceSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<
        ...
        createGuestPolicySettings() {
      return getStubSettingsBuilder().createGuestPolicySettings();
    }
    ...
    public UnaryCallSettings.Builder<GuestPolicies.GetGuestPolicyRequest, GuestPolicies.GuestPolicy>
        getGuestPolicySettings() {
      return getStubSettingsBuilder().getGuestPolicySettings();
    }
    ...
    public PagedCallSettings.Builder<
            ...
            ListGuestPoliciesPagedResponse>
        listGuestPoliciesSettings() {
      return getStubSettingsBuilder().listGuestPoliciesSettings();
    }
    ...
    public UnaryCallSettings.Builder<
        ...
        updateGuestPolicySettings() {
      return getStubSettingsBuilder().updateGuestPolicySettings();
    }
    ...
    public UnaryCallSettings.Builder<GuestPolicies.DeleteGuestPolicyRequest, Empty>
        deleteGuestPolicySettings() {
      return getStubSettingsBuilder().deleteGuestPolicySettings();
    }
