...
use Google\Cloud\Osconfig\V1beta\PatchDeployment\ScheduleOneof;
...
class OsConfigServiceClientTest extends GeneratedTest
{
    ...
    public function createPatchDeploymentTest()
    {
        ...
        $schedule = new ScheduleOneof();
        $schedule->setOneTimeSchedule(new OneTimeSchedule());
        $patchDeployment->setOneTimeSchedule($schedule);
        $schedule = new ScheduleOneof();
        $schedule->setRecurringSchedule(new RecurringSchedule());
        $patchDeployment->setRecurringSchedule($schedule);
