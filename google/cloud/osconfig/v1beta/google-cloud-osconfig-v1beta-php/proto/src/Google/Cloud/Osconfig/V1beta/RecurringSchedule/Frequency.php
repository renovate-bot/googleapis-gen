...
namespace Google\Cloud\Osconfig\V1beta\RecurringSchedule;
 ...
 *
 * Protobuf type <code>google.cloud.osconfig.v1beta.RecurringSchedule.Frequency</code>
 */
class Frequency
{
    /**
...
class_alias(Frequency::class, \Google\Cloud\Osconfig\V1beta\RecurringSchedule_Frequency::class);
