...
namespace Google\Cloud\Osconfig\V1beta\Instance;
 ...
 *
 * Protobuf type <code>google.cloud.osconfig.v1beta.Instance.PatchState</code>
 */
class PatchState
{
    /**
...
class_alias(PatchState::class, \Google\Cloud\Osconfig\V1beta\Instance_PatchState::class);
