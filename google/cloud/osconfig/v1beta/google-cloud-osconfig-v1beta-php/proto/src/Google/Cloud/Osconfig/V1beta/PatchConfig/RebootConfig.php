...
namespace Google\Cloud\Osconfig\V1beta\PatchConfig;
 ...
 *
 * Protobuf type <code>google.cloud.osconfig.v1beta.PatchConfig.RebootConfig</code>
 */
class RebootConfig
{
    /**
...
class_alias(RebootConfig::class, \Google\Cloud\Osconfig\V1beta\PatchConfig_RebootConfig::class);
