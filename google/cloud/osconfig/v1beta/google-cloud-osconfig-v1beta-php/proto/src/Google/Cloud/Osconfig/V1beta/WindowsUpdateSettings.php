 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1beta.WindowsUpdateSettings</code>
 */
class WindowsUpdateSettings extends \Google\Protobuf\Internal\Message
{
     ...
     * updates are applied.
     *
     * Generated from protobuf field <code>repeated .google.cloud.osconfig.v1beta.WindowsUpdateSettings.Classification classifications = 1;</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Osconfig\V1beta\WindowsUpdateSettings\Classification::class);
