 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1beta.AptSettings</code>
 */
class AptSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.AptSettings.Type type = 1;</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Osconfig\V1beta\AptSettings\Type::class);
        $this->type = $var;
