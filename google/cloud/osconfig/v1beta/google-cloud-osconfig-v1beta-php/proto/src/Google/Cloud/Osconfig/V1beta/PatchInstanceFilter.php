 ...
 * zones.
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1beta.PatchInstanceFilter</code>
 */
class PatchInstanceFilter extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.osconfig.v1beta.PatchInstanceFilter.GroupLabel group_labels = 2;</code>
     */
     ...
     *           Target all VM instances in the project. If true, no other criteria is
     *           permitted.
     *     @type \Google\Cloud\Osconfig\V1beta\PatchInstanceFilter\GroupLabel[]|\Google\Protobuf\Internal\RepeatedField $group_labels
     *           Targets VM instances matching at least one of these label sets. This allows
     *           targeting of disparate groups, for example "env=prod or env=staging".
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.osconfig.v1beta.PatchInstanceFilter.GroupLabel group_labels = 2;</code>
     * @param \Google\Cloud\Osconfig\V1beta\PatchInstanceFilter\GroupLabel[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setGroupLabels($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Osconfig\V1beta\PatchInstanceFilter\GroupLabel::class);
