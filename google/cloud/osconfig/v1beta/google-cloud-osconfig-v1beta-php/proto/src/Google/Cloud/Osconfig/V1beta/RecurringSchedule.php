 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1beta.RecurringSchedule</code>
 */
class RecurringSchedule extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.RecurringSchedule.Frequency frequency = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *     @type int $frequency
     *           Required. The frequency unit of this recurring schedule.
     *     @type \Google\Cloud\Osconfig\V1beta\WeeklySchedule $weekly
     *           Required. Schedule with weekly executions.
     *     @type \Google\Cloud\Osconfig\V1beta\MonthlySchedule $monthly
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Osconfig\V1beta\RecurringSchedule\Frequency::class);
        $this->frequency = $var;
     ...
     * Required. Schedule with weekly executions.
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.WeeklySchedule weekly = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Osconfig\V1beta\WeeklySchedule|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.WeeklySchedule weekly = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Osconfig\V1beta\WeeklySchedule $var
     * @return $this
     */
    public function setWeekly($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Osconfig\V1beta\WeeklySchedule::class);
     ...
     * Required. Schedule with monthly executions.
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.MonthlySchedule monthly = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Osconfig\V1beta\MonthlySchedule|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.MonthlySchedule monthly = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Osconfig\V1beta\MonthlySchedule $var
     * @return $this
     */
    public function setMonthly($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Osconfig\V1beta\MonthlySchedule::class);
