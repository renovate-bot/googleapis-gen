 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1beta.PatchJobInstanceDetails</code>
 */
class PatchJobInstanceDetails extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.Instance.PatchState state = 3;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Osconfig\V1beta\Instance\PatchState::class);
        $this->state = $var;
