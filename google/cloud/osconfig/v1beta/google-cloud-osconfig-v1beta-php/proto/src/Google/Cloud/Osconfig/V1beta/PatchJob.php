 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1beta.PatchJob</code>
 */
class PatchJob extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.PatchJob.State state = 5;</code>
     */
    protected $state = 0;
    /**
     * Instances to patch.
     ...
     *
     * Generated from protobuf field <code>string patch_deployment = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Duration of the patch job. After the duration ends, the
     *           patch job times out.
     *     @type \Google\Cloud\Osconfig\V1beta\PatchJob\InstanceDetailsSummary $instance_details_summary
     *           Summary of instance details.
     *     @type bool $dry_run
     *           If this patch job is a dry run, the agent reports that it has
     *           finished without running any updates on the VM instance.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Osconfig\V1beta\PatchJob\State::class);
        $this->state = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.PatchJob.InstanceDetailsSummary instance_details_summary = 9;</code>
     * @param \Google\Cloud\Osconfig\V1beta\PatchJob\InstanceDetailsSummary $var
     * @return $this
     */
    public function setInstanceDetailsSummary($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Osconfig\V1beta\PatchJob\InstanceDetailsSummary::class);
