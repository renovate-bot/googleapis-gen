 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1beta.ExecStepConfig</code>
 */
class ExecStepConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.ExecStepConfig.Interpreter interpreter = 4;</code>
     */
     ...
     *     @type \Google\Cloud\Osconfig\V1beta\GcsObject $gcs_object
     ...
     * A Google Cloud Storage object containing the executable.
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.GcsObject gcs_object = 2;</code>
     * @return \Google\Cloud\Osconfig\V1beta\GcsObject|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.GcsObject gcs_object = 2;</code>
     * @param \Google\Cloud\Osconfig\V1beta\GcsObject $var
     * @return $this
     */
    public function setGcsObject($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Osconfig\V1beta\GcsObject::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Osconfig\V1beta\ExecStepConfig\Interpreter::class);
