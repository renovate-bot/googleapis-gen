...
namespace Google\Cloud\Osconfig\V1beta\ExecStepConfig;
 ...
 *
 * Protobuf type <code>google.cloud.osconfig.v1beta.ExecStepConfig.Interpreter</code>
 */
class Interpreter
{
    /**
...
class_alias(Interpreter::class, \Google\Cloud\Osconfig\V1beta\ExecStepConfig_Interpreter::class);
