 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1beta.MonthlySchedule</code>
 */
class MonthlySchedule extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Osconfig\V1beta\WeekDayOfMonth $week_day_of_month
     ...
     * Required. Week day in a month.
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.WeekDayOfMonth week_day_of_month = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Osconfig\V1beta\WeekDayOfMonth|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.WeekDayOfMonth week_day_of_month = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Osconfig\V1beta\WeekDayOfMonth $var
     * @return $this
     */
    public function setWeekDayOfMonth($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Osconfig\V1beta\WeekDayOfMonth::class);
