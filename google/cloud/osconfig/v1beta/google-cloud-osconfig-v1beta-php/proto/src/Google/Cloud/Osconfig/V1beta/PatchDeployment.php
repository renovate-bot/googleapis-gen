 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1beta.PatchDeployment</code>
 */
class PatchDeployment extends \Google\Protobuf\Internal\Message
{
     ...
     *           Optional. Description of the patch deployment. Length of the description is limited
     *           to 1024 characters.
     *     @type \Google\Cloud\Osconfig\V1beta\PatchInstanceFilter $instance_filter
     *           Required. VM instances to patch.
     *     @type \Google\Cloud\Osconfig\V1beta\PatchConfig $patch_config
     *           Optional. Patch configuration that is applied.
     *     @type \Google\Protobuf\Duration $duration
     *           Optional. Duration of the patch. After the duration ends, the patch times out.
     *     @type \Google\Cloud\Osconfig\V1beta\OneTimeSchedule $one_time_schedule
     *           Required. Schedule a one-time execution.
     *     @type \Google\Cloud\Osconfig\V1beta\RecurringSchedule $recurring_schedule
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.PatchInstanceFilter instance_filter = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Osconfig\V1beta\PatchInstanceFilter $var
     * @return $this
     */
    public function setInstanceFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Osconfig\V1beta\PatchInstanceFilter::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.PatchConfig patch_config = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Osconfig\V1beta\PatchConfig $var
     * @return $this
     */
    public function setPatchConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Osconfig\V1beta\PatchConfig::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.OneTimeSchedule one_time_schedule = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Osconfig\V1beta\OneTimeSchedule $var
     * @return $this
     */
    public function setOneTimeSchedule($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Osconfig\V1beta\OneTimeSchedule::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1beta.RecurringSchedule recurring_schedule = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Osconfig\V1beta\RecurringSchedule $var
     * @return $this
     */
    public function setRecurringSchedule($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Osconfig\V1beta\RecurringSchedule::class);
