...
class OsConfigServiceGrpcAsyncIOTransport(OsConfigServiceTransport):
    ...
    def create_guest_policy(self) -> Callable[
            ...
            Awaitable[guest_policies.GuestPolicy]]:
    ...
    def list_guest_policies(self) -> Callable[
            ...
            Awaitable[guest_policies.ListGuestPoliciesResponse]]:
        ...
        Returns:
            Callable[[~.ListGuestPoliciesRequest],
                    Awaitable[~.ListGuestPoliciesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def lookup_effective_guest_policy(self) -> Callable[
        ...
        Returns:
            Callable[[~.LookupEffectiveGuestPolicyRequest],
                    Awaitable[~.EffectiveGuestPolicy]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
