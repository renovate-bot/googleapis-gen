...
class ExecutePatchJobRequest(proto.Message):
    r"""A request message to initiate patching across Google Compute
    Engine instances.
...
class ListPatchJobInstanceDetailsResponse(proto.Message):
    ...
    Attributes:
        patch_job_instance_details (Sequence[google.cloud.osconfig_v1beta.types.PatchJobInstanceDetails]):
...
class PatchJobInstanceDetails(proto.Message):
    ...
    job </compute/docs/os-patch-management/manage-patch-jobs#list-instance-details>`__.
    ...
    Attributes:
        ...
        state (google.cloud.osconfig_v1beta.types.Instance.PatchState):
...
class ListPatchJobsResponse(proto.Message):
    ...
    Attributes:
        patch_jobs (Sequence[google.cloud.osconfig_v1beta.types.PatchJob]):
...
class PatchJob(proto.Message):
    ...
    jobs </compute/docs/os-patch-management/create-patch-job>`__.
    ...
    Attributes:
        ...
        state (google.cloud.osconfig_v1beta.types.PatchJob.State):
        ...
        duration (google.protobuf.duration_pb2.Duration):
            Duration of the patch job. After the duration
            ends, the patch job times out.
        instance_details_summary (google.cloud.osconfig_v1beta.types.PatchJob.InstanceDetailsSummary):
...
class PatchConfig(proto.Message):
    ...
    Attributes:
        reboot_config (google.cloud.osconfig_v1beta.types.PatchConfig.RebootConfig):
            Post-patch reboot settings.
        apt (google.cloud.osconfig_v1beta.types.AptSettings):
            Apt update settings. Use this setting to override the
            default ``apt`` patch rules.
        yum (google.cloud.osconfig_v1beta.types.YumSettings):
            Yum update settings. Use this setting to override the
            default ``yum`` patch rules.
        goo (google.cloud.osconfig_v1beta.types.GooSettings):
            Goo update settings. Use this setting to override the
            default ``goo`` patch rules.
        zypper (google.cloud.osconfig_v1beta.types.ZypperSettings):
            Zypper update settings. Use this setting to override the
            default ``zypper`` patch rules.
        windows_update (google.cloud.osconfig_v1beta.types.WindowsUpdateSettings):
            Windows update settings. Use this override
            the default windows patch rules.
        pre_step (google.cloud.osconfig_v1beta.types.ExecStep):
            The ``ExecStep`` to run before the patch update.
        post_step (google.cloud.osconfig_v1beta.types.ExecStep):
...
class AptSettings(proto.Message):
    ...
    Attributes:
        type_ (google.cloud.osconfig_v1beta.types.AptSettings.Type):
...
class WindowsUpdateSettings(proto.Message):
    ...
    Attributes:
        classifications (Sequence[google.cloud.osconfig_v1beta.types.WindowsUpdateSettings.Classification]):
...
class ExecStep(proto.Message):
    ...
    Attributes:
        linux_exec_step_config (google.cloud.osconfig_v1beta.types.ExecStepConfig):
            The ExecStepConfig for all Linux VMs targeted
            by the PatchJob.
        windows_exec_step_config (google.cloud.osconfig_v1beta.types.ExecStepConfig):
...
class ExecStepConfig(proto.Message):
    ...
    Attributes:
        ...
        gcs_object (google.cloud.osconfig_v1beta.types.GcsObject):
            A Google Cloud Storage object containing the
            executable.
        allowed_success_codes (Sequence[int]):
            Defaults to [0]. A list of possible return values that the
            execution can return to indicate a success.
        interpreter (google.cloud.osconfig_v1beta.types.ExecStepConfig.Interpreter):
...
class GcsObject(proto.Message):
    ...
    Attributes:
        bucket (str):
            ...
            object.
        object_ (str):
            Required. Name of the Google Cloud Storage
            object.
        generation_number (int):
            Required. Generation number of the Google
...
class PatchInstanceFilter(proto.Message):
    ...
    Attributes:
        ...
        group_labels (Sequence[google.cloud.osconfig_v1beta.types.PatchInstanceFilter.GroupLabel]):
            Targets VM instances matching at least one of
            these label sets. This allows targeting of
            disparate groups, for example "env=prod or
            env=staging".
        zones (Sequence[str]):
    ...
    class GroupLabel(proto.Message):
        r"""Represents a group of VMs that can be identified as having
        all these labels, for example "env=prod and app=web".

        Attributes:
            labels (Sequence[google.cloud.osconfig_v1beta.types.PatchInstanceFilter.GroupLabel.LabelsEntry]):
