...
class ListPatchJobsPager:
    ...
    :class:`google.cloud.osconfig_v1beta.types.ListPatchJobsResponse` object, and
    ...
    All the usual :class:`google.cloud.osconfig_v1beta.types.ListPatchJobsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.osconfig_v1beta.types.ListPatchJobsResponse):
...
class ListPatchJobInstanceDetailsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.osconfig_v1beta.types.ListPatchJobInstanceDetailsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.osconfig_v1beta.types.ListPatchJobInstanceDetailsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.osconfig_v1beta.types.ListPatchJobInstanceDetailsRequest):
                The initial request object.
            response (google.cloud.osconfig_v1beta.types.ListPatchJobInstanceDetailsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
...
class ListPatchDeploymentsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.osconfig_v1beta.types.ListPatchDeploymentsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.osconfig_v1beta.types.ListPatchDeploymentsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.osconfig_v1beta.types.ListPatchDeploymentsRequest):
                The initial request object.
            response (google.cloud.osconfig_v1beta.types.ListPatchDeploymentsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
...
class ListGuestPoliciesPager:
    """A pager for iterating through ``list_guest_policies`` requests.

    This class thinly wraps an initial
    :class:`google.cloud.osconfig_v1beta.types.ListGuestPoliciesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``guest_policies`` field.

    If there are more pages, the ``__iter__`` method will make additional
    ``ListGuestPolicies`` requests and continue to iterate
    through the ``guest_policies`` field on the
    corresponding responses.

    All the usual :class:`google.cloud.osconfig_v1beta.types.ListGuestPoliciesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
            method: Callable[..., guest_policies.ListGuestPoliciesResponse],
            request: guest_policies.ListGuestPoliciesRequest,
            response: guest_policies.ListGuestPoliciesResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
        """Instantiate the pager.
        ...
        Args:
            ...
            request (google.cloud.osconfig_v1beta.types.ListGuestPoliciesRequest):
                The initial request object.
            response (google.cloud.osconfig_v1beta.types.ListGuestPoliciesResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
        self._method = method
        self._request = guest_policies.ListGuestPoliciesRequest(request)
        self._response = response
        self._metadata = metadata
...
class ListGuestPoliciesAsyncPager:
    """A pager for iterating through ``list_guest_policies`` requests.
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[guest_policies.ListGuestPoliciesResponse]],
            request: guest_policies.ListGuestPoliciesRequest,
            response: guest_policies.ListGuestPoliciesResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
