...
def test_create_guest_policy(request_type, transport: str = 'grpc'):
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_guest_policy_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_guest_policy_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = 'parent_value'
        assert arg == mock_val
        arg = args[0].guest_policy
        mock_val = guest_policies.GuestPolicy(name='name_value')
        assert arg == mock_val
...
def test_get_guest_policy(request_type, transport: str = 'grpc'):
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_guest_policy_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_guest_policies(request_type, transport: str = 'grpc'):
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_guest_policies_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_guest_policies_pager(transport_name: str = "grpc"):
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials,
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, guest_policies.GuestPolicy)
                   for i in results)
def test_list_guest_policies_pages(transport_name: str = "grpc"):
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials,
        transport=transport_name,
    )
...
def test_update_guest_policy(request_type, transport: str = 'grpc'):
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_guest_policy_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_delete_guest_policy(request_type, transport: str = 'grpc'):
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_guest_policy_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = OsConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_os_config_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.osconfig_v1beta.services.os_config_service.transports.OsConfigServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_os_config_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.osconfig_v1beta.services.os_config_service.transports.OsConfigServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OsConfigServiceTransport()
        adc.assert_called_once()
