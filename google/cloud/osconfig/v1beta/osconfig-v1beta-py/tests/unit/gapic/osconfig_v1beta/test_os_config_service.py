...
from google.cloud.osconfig_v1beta.services.os_config_service.transports.base import _API_CORE_VERSION
from google.cloud.osconfig_v1beta.services.os_config_service.transports.base import _GOOGLE_AUTH_VERSION
