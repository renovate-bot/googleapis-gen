...
class ::Google::Cloud::Osconfig::V1beta::OsConfigService::ClientPathsTest < Minitest::Test
  def test_guest_policy_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.guest_policy_path project: "value0", guest_policy: "value1"
      assert_equal "projects/value0/guestPolicies/value1", path
    end
  end
