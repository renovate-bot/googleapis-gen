 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.AptRepository</code>
 */
class AptRepository extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.AptRepository.ArchiveType archive_type = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\OsConfig\V1alpha\OSPolicy\Resource\RepositoryResource\AptRepository\ArchiveType::class);
...
class_alias(AptRepository::class, \Google\Cloud\OsConfig\V1alpha\OSPolicy_Resource_RepositoryResource_AptRepository::class);
