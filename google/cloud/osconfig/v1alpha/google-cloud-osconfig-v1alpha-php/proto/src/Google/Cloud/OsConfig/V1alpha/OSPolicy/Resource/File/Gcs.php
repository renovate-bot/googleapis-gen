 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.OSPolicy.Resource.File.Gcs</code>
 */
...
class_alias(Gcs::class, \Google\Cloud\OsConfig\V1alpha\OSPolicy_Resource_File_Gcs::class);
