 ...
 * were chosen.
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.OSPolicy.Resource.ExecResource</code>
 */
class ExecResource extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicy.Resource.ExecResource.Exec enforce = 2;</code>
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\OsConfig\V1alpha\OSPolicy\Resource\ExecResource\Exec::class);
        $this->validate = $var;
...
class_alias(ExecResource::class, \Google\Cloud\OsConfig\V1alpha\OSPolicy_Resource_ExecResource::class);
