 ...
 * possible.
 *
 * Protobuf type <code>google.cloud.osconfig.v1alpha.CVSSv3.AttackVector</code>
 */
class AttackVector
{
    /**
...
class_alias(AttackVector::class, \Google\Cloud\OsConfig\V1alpha\CVSSv3_AttackVector::class);
