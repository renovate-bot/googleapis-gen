 ...
 * class="external" }
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.Inventory.WindowsApplication</code>
 */
...
class_alias(WindowsApplication::class, \Google\Cloud\OsConfig\V1alpha\Inventory_WindowsApplication::class);
