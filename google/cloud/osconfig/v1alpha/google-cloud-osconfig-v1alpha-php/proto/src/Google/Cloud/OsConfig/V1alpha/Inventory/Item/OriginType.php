...
namespace Google\Cloud\OsConfig\V1alpha\Inventory\Item;
 ...
 *
 * Protobuf type <code>google.cloud.osconfig.v1alpha.Inventory.Item.OriginType</code>
 */
class OriginType
{
    /**
...
class_alias(OriginType::class, \Google\Cloud\OsConfig\V1alpha\Inventory_Item_OriginType::class);
