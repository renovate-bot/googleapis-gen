 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.Inventory.WindowsUpdatePackage</code>
 */
class WindowsUpdatePackage extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.osconfig.v1alpha.Inventory.WindowsUpdatePackage.WindowsUpdateCategory categories = 3;</code>
     */
    private $categories;
    /**
     ...
     *           The localized description of the update package.
     *     @type \Google\Cloud\OsConfig\V1alpha\Inventory\WindowsUpdatePackage\WindowsUpdateCategory[]|\Google\Protobuf\Internal\RepeatedField $categories
     *           The categories that are associated with this update package.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.osconfig.v1alpha.Inventory.WindowsUpdatePackage.WindowsUpdateCategory categories = 3;</code>
     * @param \Google\Cloud\OsConfig\V1alpha\Inventory\WindowsUpdatePackage\WindowsUpdateCategory[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCategories($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\OsConfig\V1alpha\Inventory\WindowsUpdatePackage\WindowsUpdateCategory::class);
        $this->categories = $arr;
...
class_alias(WindowsUpdatePackage::class, \Google\Cloud\OsConfig\V1alpha\Inventory_WindowsUpdatePackage::class);
