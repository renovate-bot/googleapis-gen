 ...
 *
 * Protobuf type <code>google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.DesiredState</code>
 */
class DesiredState
{
    /**
...
class_alias(DesiredState::class, \Google\Cloud\OsConfig\V1alpha\OSPolicy_Resource_PackageResource_DesiredState::class);
