 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.CVSSv3</code>
 */
class CVSSv3 extends \Google\Protobuf\Internal\Message
{
     ...
     * possible.
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.CVSSv3.AttackVector attack_vector = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.CVSSv3.AttackComplexity attack_complexity = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.CVSSv3.PrivilegesRequired privileges_required = 7;</code>
     */
     ...
     * component.
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.CVSSv3.UserInteraction user_interaction = 8;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.CVSSv3.Scope scope = 9;</code>
     */
    protected $scope = 0;
    /**
     ...
     * vulnerability.
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.CVSSv3.Impact confidentiality_impact = 10;</code>
     */
     ...
     * vulnerability.
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.CVSSv3.Impact integrity_impact = 11;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.CVSSv3.Impact availability_impact = 12;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\OsConfig\V1alpha\CVSSv3\AttackVector::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\OsConfig\V1alpha\CVSSv3\AttackComplexity::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\OsConfig\V1alpha\CVSSv3\PrivilegesRequired::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\OsConfig\V1alpha\CVSSv3\UserInteraction::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\OsConfig\V1alpha\CVSSv3\Scope::class);
        $this->scope = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\OsConfig\V1alpha\CVSSv3\Impact::class);
