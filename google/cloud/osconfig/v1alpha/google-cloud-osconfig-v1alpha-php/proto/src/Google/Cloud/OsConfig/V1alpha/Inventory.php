 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.Inventory</code>
 */
class Inventory extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.Inventory.OsInfo os_info = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.Inventory.OsInfo os_info = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\OsConfig\V1alpha\Inventory\OsInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.Inventory.OsInfo os_info = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\OsConfig\V1alpha\Inventory\OsInfo $var
     * @return $this
     */
    public function setOsInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\OsConfig\V1alpha\Inventory\OsInfo::class);
        $this->os_info = $var;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\OsConfig\V1alpha\Inventory\Item::class);
        $this->items = $arr;
