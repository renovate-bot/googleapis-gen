 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.OSPolicyAssignment</code>
 */
class OSPolicyAssignment extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.osconfig.v1alpha.OSPolicy os_policies = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $os_policies;
    /**
     * Required. Filter to select VMs.
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignment.InstanceFilter instance_filter = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignment.Rollout rollout = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignment.RolloutState rollout_state = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           OS policy assignment description.
     *           Length of the description is limited to 1024 characters.
     *     @type \Google\Cloud\OsConfig\V1alpha\OSPolicy[]|\Google\Protobuf\Internal\RepeatedField $os_policies
     *           Required. List of OS policies to be applied to the VMs.
     *     @type \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment\InstanceFilter $instance_filter
     *           Required. Filter to select VMs.
     *     @type \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment\Rollout $rollout
     *           Required. Rollout to deploy the OS policy assignment.
     *           A rollout is triggered in the following situations:
     *           1) OSPolicyAssignment is created.
     *           2) OSPolicyAssignment is updated and the update contains changes to one of
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.osconfig.v1alpha.OSPolicy os_policies = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\OsConfig\V1alpha\OSPolicy[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOsPolicies($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\OsConfig\V1alpha\OSPolicy::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignment.InstanceFilter instance_filter = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment\InstanceFilter|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignment.InstanceFilter instance_filter = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment\InstanceFilter $var
     * @return $this
     */
    public function setInstanceFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment\InstanceFilter::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignment.Rollout rollout = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment\Rollout|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignment.Rollout rollout = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment\Rollout $var
     * @return $this
     */
    public function setRollout($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment\Rollout::class);
        $this->rollout = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment\RolloutState::class);
