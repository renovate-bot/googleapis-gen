 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.OSPolicyAssignmentOperationMetadata</code>
 */
class OSPolicyAssignmentOperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignmentOperationMetadata.APIMethod api_method = 2;</code>
     */
    protected $api_method = 0;
    /**
     * State of the rollout
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignmentOperationMetadata.RolloutState rollout_state = 3;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignmentOperationMetadata\APIMethod::class);
        $this->api_method = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignmentOperationMetadata\RolloutState::class);
