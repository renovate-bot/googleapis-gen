 ...
 * assignment.
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.OSPolicyAssignment.Rollout</code>
 */
class Rollout extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\OsConfig\V1alpha\FixedOrPercent::class);
...
class_alias(Rollout::class, \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment_Rollout::class);
