 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.Inventory.ZypperPatch</code>
 */
...
class_alias(ZypperPatch::class, \Google\Cloud\OsConfig\V1alpha\Inventory_ZypperPatch::class);
