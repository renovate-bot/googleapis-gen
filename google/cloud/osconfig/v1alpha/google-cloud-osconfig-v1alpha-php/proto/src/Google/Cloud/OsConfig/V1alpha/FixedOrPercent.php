 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.FixedOrPercent</code>
 */
class FixedOrPercent extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Osconfig\V1Alpha\OsconfigCommon::initOnce();
