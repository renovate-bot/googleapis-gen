...
namespace Google\Cloud\OsConfig\V1alpha\OSPolicy\Resource\FileResource;
 ...
 *
 * Protobuf type <code>google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource.DesiredState</code>
 */
class DesiredState
{
    /**
...
class_alias(DesiredState::class, \Google\Cloud\OsConfig\V1alpha\OSPolicy_Resource_FileResource_DesiredState::class);
