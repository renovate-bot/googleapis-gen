 ...
 *
 * Protobuf type <code>google.cloud.osconfig.v1alpha.OSPolicyAssignment.RolloutState</code>
 */
class RolloutState
{
    /**
...
class_alias(RolloutState::class, \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment_RolloutState::class);
