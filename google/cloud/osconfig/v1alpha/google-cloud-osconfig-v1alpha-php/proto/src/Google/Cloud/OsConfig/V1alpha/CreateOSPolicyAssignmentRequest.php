 ...
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.CreateOSPolicyAssignmentRequest</code>
 */
class CreateOSPolicyAssignmentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignment os_policy_assignment = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignment os_policy_assignment = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.osconfig.v1alpha.OSPolicyAssignment os_policy_assignment = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment $var
     * @return $this
     */
    public function setOsPolicyAssignment($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment::class);
