 ...
 *
 * Protobuf type <code>google.cloud.osconfig.v1alpha.CVSSv3.AttackComplexity</code>
 */
...
class_alias(AttackComplexity::class, \Google\Cloud\OsConfig\V1alpha\CVSSv3_AttackComplexity::class);
