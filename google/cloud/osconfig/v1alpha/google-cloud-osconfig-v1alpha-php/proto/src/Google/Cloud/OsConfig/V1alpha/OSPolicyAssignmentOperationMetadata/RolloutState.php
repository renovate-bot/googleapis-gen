 ...
 *
 * Protobuf type <code>google.cloud.osconfig.v1alpha.OSPolicyAssignmentOperationMetadata.RolloutState</code>
 */
class RolloutState
{
    /**
...
class_alias(RolloutState::class, \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignmentOperationMetadata_RolloutState::class);
