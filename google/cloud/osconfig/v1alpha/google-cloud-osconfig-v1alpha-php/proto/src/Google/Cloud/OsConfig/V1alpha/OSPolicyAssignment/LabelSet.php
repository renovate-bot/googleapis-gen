 ...
 *            present.
 *
 * Generated from protobuf message <code>google.cloud.osconfig.v1alpha.OSPolicyAssignment.LabelSet</code>
 */
...
class_alias(LabelSet::class, \Google\Cloud\OsConfig\V1alpha\OSPolicyAssignment_LabelSet::class);
