...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/osconfig/v1alpha/os_policy.proto", :syntax => :proto3) do
    add_message "google.cloud.osconfig.v1alpha.OSPolicy" do
      ...
      optional :mode, :enum, 3, "google.cloud.osconfig.v1alpha.OSPolicy.Mode"
      repeated :resource_groups, :message, 4, "google.cloud.osconfig.v1alpha.OSPolicy.ResourceGroup"
    ...
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource" do
      ...
      oneof :resource_type do
        optional :pkg, :message, 2, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource"
        optional :repository, :message, 3, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource"
        optional :exec, :message, 4, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.ExecResource"
        optional :file, :message, 5, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource"
      end
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.File" do
      optional :allow_insecure, :bool, 4
      oneof :type do
        optional :remote, :message, 1, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.File.Remote"
        optional :gcs, :message, 2, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.File.Gcs"
        optional :local_path, :string, 3
      end
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.File.Remote" do
      optional :uri, :string, 1
      optional :sha256_checksum, :string, 2
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.File.Gcs" do
      optional :bucket, :string, 1
      optional :object, :string, 2
      optional :generation, :int64, 3
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource" do
      optional :desired_state, :enum, 1, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.DesiredState"
      oneof :system_package do
        optional :apt, :message, 2, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.APT"
        optional :deb, :message, 3, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.Deb"
        optional :yum, :message, 4, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.YUM"
        optional :zypper, :message, 5, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.Zypper"
        optional :rpm, :message, 6, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.RPM"
        optional :googet, :message, 7, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.GooGet"
        optional :msi, :message, 8, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.MSI"
      end
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.Deb" do
      optional :source, :message, 1, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.File"
      optional :pull_deps, :bool, 2
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.APT" do
      optional :name, :string, 1
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.RPM" do
      optional :source, :message, 1, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.File"
      optional :pull_deps, :bool, 2
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.YUM" do
      optional :name, :string, 1
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.Zypper" do
      optional :name, :string, 1
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.GooGet" do
      optional :name, :string, 1
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.MSI" do
      optional :source, :message, 1, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.File"
      repeated :properties, :string, 2
    end
    add_enum "google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.DesiredState" do
      value :DESIRED_STATE_UNSPECIFIED, 0
      value :INSTALLED, 1
      value :REMOVED, 2
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource" do
      oneof :repository do
        optional :apt, :message, 1, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.AptRepository"
        optional :yum, :message, 2, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.YumRepository"
        optional :zypper, :message, 3, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.ZypperRepository"
        optional :goo, :message, 4, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.GooRepository"
      end
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.AptRepository" do
      optional :archive_type, :enum, 1, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.AptRepository.ArchiveType"
      optional :uri, :string, 2
      optional :distribution, :string, 3
      repeated :components, :string, 4
      optional :gpg_key, :string, 5
    end
    add_enum "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.AptRepository.ArchiveType" do
      value :ARCHIVE_TYPE_UNSPECIFIED, 0
      value :DEB, 1
      value :DEB_SRC, 2
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.YumRepository" do
      optional :id, :string, 1
      optional :display_name, :string, 2
      optional :base_url, :string, 3
      repeated :gpg_keys, :string, 4
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.ZypperRepository" do
      optional :id, :string, 1
      optional :display_name, :string, 2
      optional :base_url, :string, 3
      repeated :gpg_keys, :string, 4
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.GooRepository" do
      optional :name, :string, 1
      optional :url, :string, 2
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.ExecResource" do
      optional :validate, :message, 1, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.ExecResource.Exec"
      optional :enforce, :message, 2, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.ExecResource.Exec"
    end
    ...
    add_enum "google.cloud.osconfig.v1alpha.OSPolicy.Resource.ExecResource.Exec.Interpreter" do
      value :INTERPRETER_UNSPECIFIED, 0
      value :NONE, 1
      value :SHELL, 2
      value :POWERSHELL, 3
    end
    add_message "google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource" do
      optional :path, :string, 3
      optional :state, :enum, 4, "google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource.DesiredState"
    ...
    add_enum "google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource.DesiredState" do
      value :DESIRED_STATE_UNSPECIFIED, 0
      value :PRESENT, 1
      value :ABSENT, 2
