...
Gem::Specification.new do |gem|
  ...
  gem.description   = "google-cloud-os_config-v1alpha is the official client library for the Google Cloud OsConfig V1alpha API. Note that google-cloud-os_config-v1alpha is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-os_config instead. See the readme for more details."
  gem.summary       = "API Client library for the Google Cloud OsConfig V1alpha API"
