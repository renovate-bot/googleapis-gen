...
from google.cloud.osconfig_v1alpha.services.os_config_zonal_service import OsConfigZonalServiceAsyncClient
...
from google.cloud.osconfig_v1alpha.services.os_config_zonal_service.transports.base import _API_CORE_VERSION
from google.cloud.osconfig_v1alpha.services.os_config_zonal_service.transports.base import _GOOGLE_AUTH_VERSION
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (OsConfigZonalServiceClient, transports.OsConfigZonalServiceGrpcTransport, "grpc"),
    (OsConfigZonalServiceAsyncClient, transports.OsConfigZonalServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (OsConfigZonalServiceClient, transports.OsConfigZonalServiceGrpcTransport, "grpc", "true"),
    (OsConfigZonalServiceAsyncClient, transports.OsConfigZonalServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (OsConfigZonalServiceClient, transports.OsConfigZonalServiceGrpcTransport, "grpc", "false"),
    (OsConfigZonalServiceAsyncClient, transports.OsConfigZonalServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(OsConfigZonalServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OsConfigZonalServiceClient))
@mock.patch.object(OsConfigZonalServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OsConfigZonalServiceAsyncClient))
...
def test_os_config_zonal_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_create_os_policy_assignment(transport: str = 'grpc', request_type=os_policy_assignments.CreateOSPolicyAssignmentRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.create_os_policy_assignment),
            '__call__') as call:
...
def test_create_os_policy_assignment_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_os_policy_assignment(
            parent='parent_value',
            os_policy_assignment=os_policy_assignments.OSPolicyAssignment(name='name_value'),
        ...
        assert args[0].os_policy_assignment == os_policy_assignments.OSPolicyAssignment(name='name_value')
...
def test_update_os_policy_assignment(transport: str = 'grpc', request_type=os_policy_assignments.UpdateOSPolicyAssignmentRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_os_policy_assignment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_os_policy_assignment(transport: str = 'grpc', request_type=os_policy_assignments.GetOSPolicyAssignmentRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_os_policy_assignment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_os_policy_assignments(transport: str = 'grpc', request_type=os_policy_assignments.ListOSPolicyAssignmentsRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_os_policy_assignments_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, os_policy_assignments.OSPolicyAssignment)
                   for i in results)
...
def test_list_os_policy_assignment_revisions(transport: str = 'grpc', request_type=os_policy_assignments.ListOSPolicyAssignmentRevisionsRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_os_policy_assignment(transport: str = 'grpc', request_type=os_policy_assignments.DeleteOSPolicyAssignmentRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_os_policy_assignment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_instance_os_policies_compliance(transport: str = 'grpc', request_type=instance_os_policies_compliance.GetInstanceOSPoliciesComplianceRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_instance_os_policies_compliance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_instance_os_policies_compliances(transport: str = 'grpc', request_type=instance_os_policies_compliance.ListInstanceOSPoliciesCompliancesRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_instance_os_policies_compliances_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, instance_os_policies_compliance.InstanceOSPoliciesCompliance)
                   for i in results)
...
def test_get_inventory(transport: str = 'grpc', request_type=inventory.GetInventoryRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_inventory),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_inventories(transport: str = 'grpc', request_type=inventory.ListInventoriesRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_inventories),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_inventories_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, inventory.Inventory)
                   for i in results)
...
def test_get_vulnerability_report(transport: str = 'grpc', request_type=vulnerability.GetVulnerabilityReportRequest):
    client = OsConfigZonalServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_vulnerability_report),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_vulnerability_reports_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, vulnerability.VulnerabilityReport)
                   for i in results)
...
def test_os_config_zonal_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_os_config_zonal_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.OsConfigZonalServiceGrpcTransport, transports.OsConfigZonalServiceGrpcAsyncIOTransport])
def test_os_config_zonal_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
