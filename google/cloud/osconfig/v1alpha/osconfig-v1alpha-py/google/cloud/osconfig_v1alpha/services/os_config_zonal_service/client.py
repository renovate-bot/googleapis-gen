...
class OsConfigZonalServiceClient(metaclass=OsConfigZonalServiceClientMeta):
    ...
    def instance_os_policies_compliance_path(project: str,location: str,instance: str,) -> str:
        """Return a fully-qualified instance_os_policies_compliance string."""
    ...
    def parse_instance_os_policies_compliance_path(path: str) -> Dict[str,str]:
        """Parse a instance_os_policies_compliance path into its component segments."""
    ...
    def parse_inventory_path(path: str) -> Dict[str,str]:
        """Parse a inventory path into its component segments."""
    ...
    def vulnerability_report_path(project: str,location: str,instance: str,) -> str:
        """Return a fully-qualified vulnerability_report string."""
    ...
    def parse_vulnerability_report_path(path: str) -> Dict[str,str]:
        """Parse a vulnerability_report path into its component segments."""
