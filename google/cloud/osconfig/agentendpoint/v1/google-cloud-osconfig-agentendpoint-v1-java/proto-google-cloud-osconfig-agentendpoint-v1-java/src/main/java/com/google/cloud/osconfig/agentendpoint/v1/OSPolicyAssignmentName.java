...
public class OSPolicyAssignmentName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_OS_POLICY_ASSIGNMENT =
  ...
  protected OSPolicyAssignmentName() {
    project = null;
    location = null;
    osPolicyAssignment = null;
  }

  private OSPolicyAssignmentName(Builder builder) {
    project = Preconditions.checkNotNull(builder.getProject());
    location = Preconditions.checkNotNull(builder.getLocation());
    osPolicyAssignment = Preconditions.checkNotNull(builder.getOsPolicyAssignment());
  }
  ...
  public static OSPolicyAssignmentName of(
      String project, String location, String osPolicyAssignment) {
    return newBuilder()
        .setProject(project)
  ...
  public static OSPolicyAssignmentName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_OS_POLICY_ASSIGNMENT.validatedMatch(
            formattedString, "OSPolicyAssignmentName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"), matchMap.get("location"), matchMap.get("os_policy_assignment"));
  }

  public static List<OSPolicyAssignmentName> parseList(List<String> formattedStrings) {
    List<OSPolicyAssignmentName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (osPolicyAssignment != null) {
            fieldMapBuilder.put("os_policy_assignment", osPolicyAssignment);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_OS_POLICY_ASSIGNMENT.instantiate(
        "project", project, "location", location, "os_policy_assignment", osPolicyAssignment);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.osPolicyAssignment, that.osPolicyAssignment);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(osPolicyAssignment);
    return h;
  }
