...
public class AgentEndpointServiceSettings extends ClientSettings<AgentEndpointServiceSettings> {
  ...
  /** Returns the object with the settings used for calls to reportInventory. */
  public UnaryCallSettings<ReportInventoryRequest, ReportInventoryResponse>
      reportInventorySettings() {
    return ((AgentEndpointServiceStubSettings) getStubSettings()).reportInventorySettings();
  }
  ...
  public static class Builder
    ...
    /** Returns the builder for the settings used for calls to reportInventory. */
    public UnaryCallSettings.Builder<ReportInventoryRequest, ReportInventoryResponse>
        reportInventorySettings() {
      return getStubSettingsBuilder().reportInventorySettings();
    }
