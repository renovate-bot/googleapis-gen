...
class PatchConfig(proto.Message):
    ...
    Attributes:
        reboot_config (google.cloud.osconfig.agentendpoint_v1.types.PatchConfig.RebootConfig):
            Post-patch reboot settings.
        retry_strategy (google.cloud.osconfig.agentendpoint_v1.types.RetryStrategy):
        ...
        apt (google.cloud.osconfig.agentendpoint_v1.types.AptSettings):
            Apt update settings. Use this override the
            default apt patch rules.
        yum (google.cloud.osconfig.agentendpoint_v1.types.YumSettings):
            Yum update settings. Use this override the
            default yum patch rules.
        goo (google.cloud.osconfig.agentendpoint_v1.types.GooSettings):
            Goo update settings. Use this override the
            default goo patch rules.
        zypper (google.cloud.osconfig.agentendpoint_v1.types.ZypperSettings):
            Zypper update settings. Use this override the
            default zypper patch rules.
        windows_update (google.cloud.osconfig.agentendpoint_v1.types.WindowsUpdateSettings):
            Windows update settings. Use this override
            the default windows patch rules.
        pre_step (google.cloud.osconfig.agentendpoint_v1.types.ExecStep):
            The ExecStep to run before the patch update.
        post_step (google.cloud.osconfig.agentendpoint_v1.types.ExecStep):
...
class AptSettings(proto.Message):
    ...
    Attributes:
        type_ (google.cloud.osconfig.agentendpoint_v1.types.AptSettings.Type):
...
class ExecStep(proto.Message):
    ...
    Attributes:
        linux_exec_step_config (google.cloud.osconfig.agentendpoint_v1.types.ExecStepConfig):
            ...
            by the PatchJob.
        windows_exec_step_config (google.cloud.osconfig.agentendpoint_v1.types.ExecStepConfig):
...
class ExecStepConfig(proto.Message):
    ...
    Attributes:
        ...
        gcs_object (google.cloud.osconfig.agentendpoint_v1.types.GcsObject):
        ...
        interpreter (google.cloud.osconfig.agentendpoint_v1.types.ExecStepConfig.Interpreter):
