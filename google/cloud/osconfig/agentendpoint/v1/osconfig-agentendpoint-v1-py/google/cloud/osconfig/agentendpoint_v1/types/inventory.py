...
class Inventory(proto.Message):
    ...
    class VersionedPackage(proto.Message):
        ...
        package_name = proto.Field(proto.STRING, number=1)
    ...
    class ZypperPatch(proto.Message):
        ...
        patch_name = proto.Field(proto.STRING, number=1)
    ...
    class WindowsUpdatePackage(proto.Message):
        ...
        support_url = proto.Field(proto.STRING, number=5)

        more_info_urls = proto.RepeatedField(proto.STRING, number=6)

        update_id = proto.Field(proto.STRING, number=7)

        revision_number = proto.Field(proto.INT32, number=8)

        last_deployment_change_time = proto.Field(proto.MESSAGE, number=9,
    ...
    class WindowsQuickFixEngineeringPackage(proto.Message):
        ...
        install_time = proto.Field(proto.MESSAGE, number=4,
            message=timestamp.Timestamp,
        )
    ...
    installed_packages = proto.RepeatedField(proto.MESSAGE, number=2,
        message=SoftwarePackage,
    )

    available_packages = proto.RepeatedField(proto.MESSAGE, number=3,
        message=SoftwarePackage,
    )
