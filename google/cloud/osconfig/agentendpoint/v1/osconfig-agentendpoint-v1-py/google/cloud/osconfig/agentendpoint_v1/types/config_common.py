...
class OSPolicyResourceConfigStep(proto.Message):
    ...
    Attributes:
        type_ (google.cloud.osconfig.agentendpoint_v1.types.OSPolicyResourceConfigStep.Type):
            Configuration step type.
        outcome (google.cloud.osconfig.agentendpoint_v1.types.OSPolicyResourceConfigStep.Outcome):
...
class OSPolicyResourceCompliance(proto.Message):
    ...
    Attributes:
        ...
        config_steps (Sequence[google.cloud.osconfig.agentendpoint_v1.types.OSPolicyResourceConfigStep]):
            Ordered list of configuration steps taken by
            the agent for the OS policy resource.
        state (google.cloud.osconfig.agentendpoint_v1.types.OSPolicyComplianceState):
            Compliance state of the OS policy resource.
        exec_resource_output (google.cloud.osconfig.agentendpoint_v1.types.OSPolicyResourceCompliance.ExecResourceOutput):
