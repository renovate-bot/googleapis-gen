...
namespace Google.Cloud.Osconfig.Agentendpoint.V1Beta.Snippets
{
    ...
    public sealed class GeneratedAgentEndpointServiceClientSnippets
    {
        ...
        public void LookupEffectiveGuestPolicyRequestObject()
        {
            ...
            // Make the request
            EffectiveGuestPolicy response = agentEndpointServiceClient.LookupEffectiveGuestPolicy(request);
            // End snippet
        }
        ...
        public async Task LookupEffectiveGuestPolicyRequestObjectAsync()
        {
            ...
            // Make the request
            EffectiveGuestPolicy response = await agentEndpointServiceClient.LookupEffectiveGuestPolicyAsync(request);
            // End snippet
        }
