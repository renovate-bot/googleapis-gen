...
namespace Google.Cloud.Osconfig.Agentendpoint.V1Beta.Tests
{
    ...
    public sealed class GeneratedAgentEndpointServiceClientTest
    {
        ...
        public void LookupEffectiveGuestPolicy()
        {
            ...
            mockGrpcClient.Setup(x => x.LookupEffectiveGuestPolicy(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            AgentEndpointServiceClient client = new AgentEndpointServiceClientImpl(mockGrpcClient.Object, null);
            EffectiveGuestPolicy response = client.LookupEffectiveGuestPolicy(request.InstanceIdToken, request.OsShortName, request.OsVersion, request.OsArchitecture);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task LookupEffectiveGuestPolicyAsync()
        {
            moq::Mock<AgentEndpointService.AgentEndpointServiceClient> mockGrpcClient = new moq::Mock<AgentEndpointService.AgentEndpointServiceClient>(moq::MockBehavior.Strict);
            LookupEffectiveGuestPolicyRequest request = new LookupEffectiveGuestPolicyRequest
            {
            ...
            mockGrpcClient.Setup(x => x.LookupEffectiveGuestPolicyAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<EffectiveGuestPolicy>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            AgentEndpointServiceClient client = new AgentEndpointServiceClientImpl(mockGrpcClient.Object, null);
            EffectiveGuestPolicy responseCallSettings = await client.LookupEffectiveGuestPolicyAsync(request.InstanceIdToken, request.OsShortName, request.OsVersion, request.OsArchitecture, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            EffectiveGuestPolicy responseCancellationToken = await client.LookupEffectiveGuestPolicyAsync(request.InstanceIdToken, request.OsShortName, request.OsVersion, request.OsArchitecture, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
