...
namespace Google.Cloud.Osconfig.Agentendpoint.V1Beta
{
    ...
    public sealed partial class AgentEndpointServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>AgentEndpointServiceClient.LookupEffectiveGuestPolicy</c> and
        /// <c>AgentEndpointServiceClient.LookupEffectiveGuestPolicyAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 1000 milliseconds.</description></item>
    ...
    public abstract partial class AgentEndpointServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual EffectiveGuestPolicy LookupEffectiveGuestPolicy(string instanceIdToken, string osShortName, string osVersion, string osArchitecture, gaxgrpc::CallSettings callSettings = null) =>
            LookupEffectiveGuestPolicy(new LookupEffectiveGuestPolicyRequest
            {
                InstanceIdToken = gax::GaxPreconditions.CheckNotNullOrEmpty(instanceIdToken, nameof(instanceIdToken)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<EffectiveGuestPolicy> LookupEffectiveGuestPolicyAsync(string instanceIdToken, string osShortName, string osVersion, string osArchitecture, gaxgrpc::CallSettings callSettings = null) =>
            LookupEffectiveGuestPolicyAsync(new LookupEffectiveGuestPolicyRequest
            {
                InstanceIdToken = gax::GaxPreconditions.CheckNotNullOrEmpty(instanceIdToken, nameof(instanceIdToken)),
                OsShortName = osShortName ?? "",
                OsVersion = osVersion ?? "",
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<EffectiveGuestPolicy> LookupEffectiveGuestPolicyAsync(string instanceIdToken, string osShortName, string osVersion, string osArchitecture, st::CancellationToken cancellationToken) =>
            LookupEffectiveGuestPolicyAsync(instanceIdToken, osShortName, osVersion, osArchitecture, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
