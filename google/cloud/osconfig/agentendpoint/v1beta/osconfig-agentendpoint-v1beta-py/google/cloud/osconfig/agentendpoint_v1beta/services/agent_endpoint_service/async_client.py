...
class AgentEndpointServiceAsyncClient:
    ...
    from_service_account_info = AgentEndpointServiceClient.from_service_account_info
    from_service_account_file = AgentEndpointServiceClient.from_service_account_file
