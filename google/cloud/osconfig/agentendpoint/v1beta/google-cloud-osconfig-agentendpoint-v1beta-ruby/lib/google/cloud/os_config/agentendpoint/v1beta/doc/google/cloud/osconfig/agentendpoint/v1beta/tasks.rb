    ...
    module Osconfig
      module Agentendpoint
        module V1beta
          ...
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::ApplyPatchesTask]
          #     Details about the apply patches task to perform.
          # @!attribute [rw] exec_step_task
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::ExecStepTask]
          ...
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::PatchConfig]
          ...
          # @!attribute [rw] state
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::ApplyPatchesTaskProgress::State]
          ...
          # Information reported from the agent about applying patches execution.
          # @!attribute [rw] state
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::ApplyPatchesTaskOutput::State]
          ...
          # @!attribute [rw] state
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::ExecStepTaskProgress::State]
          ...
          # Information reported from the agent about the exec step execution.
          # @!attribute [rw] state
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::ExecStepTaskOutput::State]
