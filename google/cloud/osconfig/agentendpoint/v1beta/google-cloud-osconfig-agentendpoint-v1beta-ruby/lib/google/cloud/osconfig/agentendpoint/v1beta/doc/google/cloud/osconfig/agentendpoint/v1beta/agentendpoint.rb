    ...
    module Osconfig
      module Agentendpoint
        module V1beta
          ...
          # @!attribute [rw] task
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::Task]
          ...
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::TaskType]
          ...
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::ApplyPatchesTaskProgress]
          #     Details about the progress of the apply patches task.
          # @!attribute [rw] exec_step_task_progress
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::ExecStepTaskProgress]
          ...
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::TaskDirective]
          ...
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::ApplyPatchesTaskOutput]
          #     Final output details of the apply patches task;
          # @!attribute [rw] exec_step_task_output
          #   @return [Google::Cloud::Osconfig::Agentendpoint::V1beta::ExecStepTaskOutput]
