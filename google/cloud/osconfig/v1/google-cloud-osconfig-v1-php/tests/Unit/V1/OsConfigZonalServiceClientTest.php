...
class OsConfigZonalServiceClientTest extends GeneratedTest
{
    ...
    public function createOSPolicyAssignmentTest()
    {
        ...
        $incompleteOperation->setName('operations/createOSPolicyAssignmentTest');
        ...
        $reconciling = false;
        $uid = 'uid115792';
        $expectedResponse = new OSPolicyAssignment();
        $expectedResponse->setName($name);
        $expectedResponse->setDescription($description);
        $expectedResponse->setRevisionId($revisionId);
        $expectedResponse->setEtag($etag);
        $expectedResponse->setBaseline($baseline);
        ...
        $completeOperation->setName('operations/createOSPolicyAssignmentTest');
        ...
        $osPolicyAssignment->setInstanceFilter($osPolicyAssignmentInstanceFilter);
        $osPolicyAssignmentRollout = new Rollout();
        $rolloutDisruptionBudget = new FixedOrPercent();
        $osPolicyAssignmentRollout->setDisruptionBudget($rolloutDisruptionBudget);
        ...
        $actualValue = $actualApiRequestObject->getOsPolicyAssignmentId();
        $this->assertProtobufEquals($osPolicyAssignmentId, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/createOSPolicyAssignmentTest');
    ...
    public function deleteOSPolicyAssignmentTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteOSPolicyAssignmentTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteOSPolicyAssignmentTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/deleteOSPolicyAssignmentTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    public function getInventoryTest()
    {
        ...
        $this->assertSame('/google.cloud.osconfig.v1.OsConfigZonalService/GetInventory', $actualFuncCall);
    ...
    public function getOSPolicyAssignmentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.osconfig.v1.OsConfigZonalService/GetOSPolicyAssignment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getOSPolicyAssignmentReportTest()
    {
        ...
        $osPolicyAssignment = 'osPolicyAssignment-945935777';
        $lastRunId = 'lastRunId2008161560';
        $expectedResponse = new OSPolicyAssignmentReport();
        $expectedResponse->setName($name2);
        $expectedResponse->setInstance($instance);
        $expectedResponse->setOsPolicyAssignment($osPolicyAssignment);
    ...
    public function getVulnerabilityReportTest()
    {
        ...
        // Mock response
        $name2 = 'name2-1052831874';
        $expectedResponse = new VulnerabilityReport();
        $expectedResponse->setName($name2);
        $transport->addResponse($expectedResponse);
        // Mock request
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.osconfig.v1.OsConfigZonalService/GetVulnerabilityReport', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listInventoriesTest()
    {
        ...
        $this->assertEquals($expectedResponse->getInventories()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.osconfig.v1.OsConfigZonalService/ListInventories', $actualFuncCall);
    ...
    public function listOSPolicyAssignmentReportsTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getOsPolicyAssignmentReports()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function listOSPolicyAssignmentRevisionsTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getOsPolicyAssignments()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function listOSPolicyAssignmentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.osconfig.v1.OsConfigZonalService/ListOSPolicyAssignments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listVulnerabilityReportsTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getVulnerabilityReports()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.osconfig.v1.OsConfigZonalService/ListVulnerabilityReports', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateOSPolicyAssignmentTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateOSPolicyAssignmentTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $description = 'description-1724546052';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateOSPolicyAssignmentTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $this->assertProtobufEquals($osPolicyAssignment, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/updateOSPolicyAssignmentTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
