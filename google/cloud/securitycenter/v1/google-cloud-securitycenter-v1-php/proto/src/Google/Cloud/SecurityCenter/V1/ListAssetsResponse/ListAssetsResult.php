...
class ListAssetsResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\SecurityCenter\V1\Asset $asset
     *           Asset matching the search request.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securitycenter.v1.Asset asset = 1;</code>
     * @return \Google\Cloud\SecurityCenter\V1\Asset|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securitycenter.v1.Asset asset = 1;</code>
     * @param \Google\Cloud\SecurityCenter\V1\Asset $var
     * @return $this
     */
    public function setAsset($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\SecurityCenter\V1\Asset::class);
        $this->asset = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\SecurityCenter\V1\ListAssetsResponse\ListAssetsResult\StateChange::class);
