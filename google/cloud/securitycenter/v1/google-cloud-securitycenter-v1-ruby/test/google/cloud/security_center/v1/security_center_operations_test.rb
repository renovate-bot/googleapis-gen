...
class ::Google::Cloud::SecurityCenter::V1::SecurityCenter::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::SecurityCenter::V1::SecurityCenter::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::SecurityCenter::V1::SecurityCenter::Operations::Configuration, config
  end
end
