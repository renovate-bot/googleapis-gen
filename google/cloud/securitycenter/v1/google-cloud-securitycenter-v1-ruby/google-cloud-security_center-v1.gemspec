...
require File.expand_path("lib/google/cloud/security_center/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-security_center-v1"
  gem.version       = Google::Cloud::SecurityCenter::V1::VERSION
  ...
  gem.summary       = "API Client library for the Cloud Security Command Center V1 API"
