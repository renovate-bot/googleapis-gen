...
export class SecurityCenterClient {
  ...
  initialize() {
    ...
    const securityCenterStubMethods =
        ['bulkMuteFindings', 'createSource', 'createFinding', 'createMuteConfig', 'createNotificationConfig', 'deleteMuteConfig', 'deleteNotificationConfig', 'getIamPolicy', 'getMuteConfig', 'getNotificationConfig', 'getOrganizationSettings', 'getSource', 'groupAssets', 'groupFindings', 'listAssets', 'listFindings', 'listMuteConfigs', 'listNotificationConfigs', 'listSources', 'runAssetDiscovery', 'setFindingState', 'setMute', 'setIamPolicy', 'testIamPermissions', 'updateExternalSystem', 'updateFinding', 'updateMuteConfig', 'updateNotificationConfig', 'updateOrganizationSettings', 'updateSource', 'updateSecurityMarks'];
 ...
 */
  async checkBulkMuteFindingsProgress(name: string): Promise<LROperation<protos.google.cloud.securitycenter.v1.BulkMuteFindingsResponse, protos.google.protobuf.Empty>>{
    ...
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.bulkMuteFindings, gax.createDefaultBackoffSettings());
