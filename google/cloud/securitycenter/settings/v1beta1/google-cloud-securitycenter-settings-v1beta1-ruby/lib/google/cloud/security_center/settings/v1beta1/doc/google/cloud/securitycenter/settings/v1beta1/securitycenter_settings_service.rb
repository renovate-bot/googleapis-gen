    ...
    module Securitycenter
      module Settings
        module V1beta1
          ...
          class UpdateSettingsRequest; end
          ...
          class ResetSettingsRequest; end
          ...
          class CalculateEffectiveSettingsRequest; end
          ...
          class BatchCalculateEffectiveSettingsRequest; end

          # Response message for BatchGetEffectiveSettings.
          # @!attribute [rw] settings
          #   @return [Array<Google::Cloud::Securitycenter::Settings::V1beta1::Settings>]
          #     Settings requested.
          class BatchCalculateEffectiveSettingsResponse; end
          ...
          class GetComponentSettingsRequest; end
          ...
          class UpdateComponentSettingsRequest; end
          ...
          #     then the existing settings will be blindly overwritten.
          class ResetComponentSettingsRequest; end
          ...
          #     * `projects/{project}/regions/{region}/clusters/{cluster}/components/{component}/settings`
          #       * `projects/{project}/zones/{zone}/clusters/{cluster}/components/{component}/settings`
          class CalculateEffectiveComponentSettingsRequest; end
          ...
          class ListDetectorsRequest; end
          ...
          class ListDetectorsResponse; end
          ...
          #     match the call that provided the page token.
          class ListComponentsRequest; end
          ...
          #     A token that can be sent as `page_token` to retrieve the next page.
          #     If this field is omitted, there are no subsequent pages.
          class ListComponentsResponse; end
        end
      end
    end
  end
