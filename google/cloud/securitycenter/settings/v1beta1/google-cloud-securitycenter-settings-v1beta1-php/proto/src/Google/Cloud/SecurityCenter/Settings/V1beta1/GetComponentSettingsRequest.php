 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.settings.v1beta1.GetComponentSettingsRequest</code>
 */
class GetComponentSettingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
