...
namespace Google.Cloud.Securitycenter.V1Beta1.Snippets
{
    ...
    public sealed partial class GeneratedSecurityCenterClientStandaloneSnippets
    {
        ...
        public void RunAssetDiscoveryRequestObject()
        {
            ...
            // Make the request
            Operation<Empty, Empty> response = securityCenterClient.RunAssetDiscovery(request);
            ...
            Operation<Empty, Empty> retrievedResponse = securityCenterClient.PollOnceRunAssetDiscovery(operationName);
