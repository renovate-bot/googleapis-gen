...
namespace Google.Cloud.Securitycenter.V1Beta1.Snippets
{
    ...
    public sealed partial class GeneratedSecurityCenterClientStandaloneSnippets
    {
        ...
        public async Task RunAssetDiscoveryAsync()
        {
            ...
            // Make the request
            Operation<Empty, Empty> response = await securityCenterClient.RunAssetDiscoveryAsync(parent);
            ...
            Operation<Empty, Empty> retrievedResponse = await securityCenterClient.PollOnceRunAssetDiscoveryAsync(operationName);
