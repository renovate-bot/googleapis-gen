...
namespace Google.Cloud.Securitycenter.V1Beta1.Snippets
{
    ...
    public sealed class GeneratedSecurityCenterClientSnippets
    {
        ...
        public void ListFindingsRequestObject()
        {
            ...
            // Make the request
            PagedEnumerable<ListFindingsResponse, Finding> response = securityCenterClient.ListFindings(request);
        ...
        public async Task RunAssetDiscoveryRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Empty, Empty> response = await securityCenterClient.RunAssetDiscoveryAsync(request);
