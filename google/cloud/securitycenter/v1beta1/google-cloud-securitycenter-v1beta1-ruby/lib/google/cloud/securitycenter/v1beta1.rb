...
require "google/cloud/securitycenter/v1beta1/security_center_client"
require "google/cloud/securitycenter/v1beta1/run_asset_discovery_response_pb"
...
module Google
  module Cloud
    module Securitycenter
      ...
      ##
      # # Ruby Client for Security Command Center API ([Beta](https://github.com/GoogleCloudPlatform/google-cloud-ruby#versioning))
      #
      ...
      module V1beta1
        ...
        def self.new \
          ...
          Google::Cloud::Securitycenter::V1beta1::SecurityCenterClient.new(**kwargs)
        end
      end
    end
  end
