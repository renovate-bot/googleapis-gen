...
require "google/cloud/securitycenter/v1beta1/securitycenter_service_services_pb"
require "google/cloud/securitycenter/v1beta1/security_center"

class ::Google::Cloud::Securitycenter::V1beta1::SecurityCenter::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Securitycenter::V1beta1::SecurityCenter::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Securitycenter::V1beta1::SecurityCenter::Operations::Configuration, config
  end
end
