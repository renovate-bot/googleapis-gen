...
namespace Google\Cloud\Securitycenter\V1beta1\OrganizationSettings\AssetDiscoveryConfig;
 ...
 * discovery.
 *
 * Protobuf type <code>google.cloud.securitycenter.v1beta1.OrganizationSettings.AssetDiscoveryConfig.InclusionMode</code>
 */
class InclusionMode
{
    /**
...
class_alias(InclusionMode::class, \Google\Cloud\Securitycenter\V1beta1\OrganizationSettings_AssetDiscoveryConfig_InclusionMode::class);
