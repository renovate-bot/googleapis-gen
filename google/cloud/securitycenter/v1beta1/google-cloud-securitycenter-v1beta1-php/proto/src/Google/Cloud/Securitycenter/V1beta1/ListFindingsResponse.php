 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v1beta1.ListFindingsResponse</code>
 */
class ListFindingsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.securitycenter.v1beta1.Finding findings = 1;</code>
     */
    private $findings;
    /**
     ...
     *
     *     @type \Google\Cloud\Securitycenter\V1beta1\Finding[]|\Google\Protobuf\Internal\RepeatedField $findings
     *           Findings matching the list request.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.securitycenter.v1beta1.Finding findings = 1;</code>
     * @param \Google\Cloud\Securitycenter\V1beta1\Finding[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFindings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Securitycenter\V1beta1\Finding::class);
        $this->findings = $arr;
