...
namespace Google\Cloud\Securitycenter\V1beta1\OrganizationSettings;
...
class AssetDiscoveryConfig extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Securitycenter\V1beta1\OrganizationSettings\AssetDiscoveryConfig\InclusionMode::class);
...
class_alias(AssetDiscoveryConfig::class, \Google\Cloud\Securitycenter\V1beta1\OrganizationSettings_AssetDiscoveryConfig::class);
