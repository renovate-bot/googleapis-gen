...
namespace Google\Cloud\Securitycenter\Tests\Unit\V1beta1;
...
use Google\Cloud\Securitycenter\V1beta1\GroupResult;
use Google\Cloud\Securitycenter\V1beta1\ListAssetsResponse;
use Google\Cloud\Securitycenter\V1beta1\ListAssetsResponse\ListAssetsResult;
...
use Google\Cloud\Securitycenter\V1beta1\SecurityCenterClient;
...
class SecurityCenterClientTest extends GeneratedTest
{
    ...
    public function createFindingTest()
    {
        ...
        $finding = new Finding();
        $response = $client->createFinding($formattedParent, $findingId, $finding);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/CreateFinding', $actualFuncCall);
    ...
    public function createFindingExceptionTest()
    {
        ...
        $finding = new Finding();
        try {
            $client->createFinding($formattedParent, $findingId, $finding);
    ...
    public function createSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/CreateSource', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function getIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/GetIamPolicy', $actualFuncCall);
    ...
    public function getOrganizationSettingsTest()
    {
        ...
        $response = $client->getOrganizationSettings($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/GetOrganizationSettings', $actualFuncCall);
    ...
    public function getOrganizationSettingsExceptionTest()
    {
        ...
        $formattedName = $client->organizationSettingsName('[ORGANIZATION]');
        try {
            $client->getOrganizationSettings($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/GetSource', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function groupAssetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/GroupAssets', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function groupFindingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/GroupFindings', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getGroupBy();
        $this->assertProtobufEquals($groupBy, $actualValue);
    ...
    public function listAssetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/ListAssets', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listFindingsTest()
    {
        ...
        // Mock request
        $formattedParent = $client->sourceName('[ORGANIZATION]', '[SOURCE]');
        $response = $client->listFindings($formattedParent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/ListFindings', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listFindingsExceptionTest()
    {
        ...
        $formattedParent = $client->sourceName('[ORGANIZATION]', '[SOURCE]');
        try {
            $client->listFindings($formattedParent);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listSourcesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/ListSources', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function runAssetDiscoveryTest()
    {
        ...
        // Mock request
        $formattedParent = $client->organizationName('[ORGANIZATION]');
        $response = $client->runAssetDiscovery($formattedParent);
        ...
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/RunAssetDiscovery', $actualApiFuncCall);
    ...
    public function setFindingStateTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/SetFindingState', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
    ...
    public function setFindingStateExceptionTest()
    {
        ...
        $startTime = new Timestamp();
        try {
            $client->setFindingState($formattedName, $state, $startTime);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function setIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/SetIamPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getResource();
        $this->assertProtobufEquals($resource, $actualValue);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getResource();
        $this->assertProtobufEquals($resource, $actualValue);
    ...
    public function updateFindingTest()
    {
        ...
        // Mock request
        $finding = new Finding();
        $response = $client->updateFinding($finding);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/UpdateFinding', $actualFuncCall);
        $actualValue = $actualRequestObject->getFinding();
        $this->assertProtobufEquals($finding, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateOrganizationSettingsTest()
    {
        ...
        $response = $client->updateOrganizationSettings($organizationSettings);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/UpdateOrganizationSettings', $actualFuncCall);
    ...
    public function updateSecurityMarksTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/UpdateSecurityMarks', $actualFuncCall);
    ...
    public function updateSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.securitycenter.v1beta1.SecurityCenter/UpdateSource', $actualFuncCall);
        $actualValue = $actualRequestObject->getSource();
        $this->assertProtobufEquals($source, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
