...
require File.expand_path("lib/google/cloud/security_center/v1p1beta1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-security_center-v1p1beta1"
  gem.version       = Google::Cloud::SecurityCenter::V1p1beta1::VERSION

  gem.authors       = ["Google LLC"]
  gem.email         = "googleapis-packages@google.com"
  gem.description   = "Security Command Center API provides access to temporal views of assets and findings within an organization. Note that google-cloud-security_center-v1p1beta1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-security_center instead. See the readme for more details."
  gem.summary       = "API Client library for the Cloud Security Command Center V1p1beta1 API"
