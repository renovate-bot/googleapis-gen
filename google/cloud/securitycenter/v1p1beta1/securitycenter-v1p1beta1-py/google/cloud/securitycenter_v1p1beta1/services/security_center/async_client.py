...
class SecurityCenterAsyncClient:
    ...
    notification_config_path = staticmethod(SecurityCenterClient.notification_config_path)
    parse_notification_config_path = staticmethod(SecurityCenterClient.parse_notification_config_path)
    organization_settings_path = staticmethod(SecurityCenterClient.organization_settings_path)
    parse_organization_settings_path = staticmethod(SecurityCenterClient.parse_organization_settings_path)
    ...
    from_service_account_info = SecurityCenterClient.from_service_account_info
    ...
    get_transport_class = functools.partial(type(SecurityCenterClient).get_transport_class, type(SecurityCenterClient))
    ...
    async def run_asset_discovery(self,
    ...
    async def set_finding_state(self,
    ...
    async def update_notification_config(self,
    ...
    async def update_organization_settings(self,
    ...
    async def update_security_marks(self,
