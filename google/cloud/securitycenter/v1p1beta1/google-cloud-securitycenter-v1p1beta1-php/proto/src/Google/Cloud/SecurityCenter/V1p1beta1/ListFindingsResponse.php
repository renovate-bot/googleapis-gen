 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v1p1beta1.ListFindingsResponse</code>
 */
class ListFindingsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return $this->list_findings_results;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\SecurityCenter\V1p1beta1\ListFindingsResponse\ListFindingsResult::class);
