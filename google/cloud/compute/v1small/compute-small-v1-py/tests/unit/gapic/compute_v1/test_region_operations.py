...
from google.cloud.compute_v1.services.region_operations import RegionOperationsClient
from google.cloud.compute_v1.services.region_operations import transports
...
def test_region_operations_client_from_service_account_info(client_class):
...
def test_region_operations_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (RegionOperationsClient, transports.RegionOperationsRestTransport, "rest", "true"),
    (RegionOperationsClient, transports.RegionOperationsRestTransport, "rest", "false"),
])
@mock.patch.object(RegionOperationsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegionOperationsClient))
...
def test_region_operations_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    request = compute_small.GetRegionOperationRequest({'project': 'sample1', 'region': 'sample2', 'operation': 'sample3'})
...
def test_get_rest_required_fields(request_type=compute_small.GetRegionOperationRequest):
    ...
    assert jsonified_request["operation"] == request_init["operation"]
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute_small.GetRegionOperationRequest):
    client = RegionOperationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/operations/{operation}" % client.transport._host, args[1])
...
def test_wait_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute_small.WaitRegionOperationRequest({'project': 'sample1', 'region': 'sample2', 'operation': 'sample3'})
...
def test_wait_rest_required_fields(request_type=compute_small.WaitRegionOperationRequest):
    transport_class = transports.RegionOperationsRestTransport
...
def test_wait_rest_bad_request(transport: str = 'rest', request_type=compute_small.WaitRegionOperationRequest):
    client = RegionOperationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/projects/{project}/regions/{region}/operations/{operation}/wait" % client.transport._host, args[1])
...
def test_region_operations_host_no_port():
    client = RegionOperationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_region_operations_host_with_port():
    client = RegionOperationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
