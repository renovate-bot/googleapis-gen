...
class AddressesClientMeta(type):
    """Metaclass for the Addresses client.
...
class AddressesClient(metaclass=AddressesClientMeta):
    """Services
    The Addresses API.
    """
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AddressesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> AddressesTransport:
        """Returns the transport used by the client instance.

        Returns:
            AddressesTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, AddressesTransport):
            # transport is a AddressesTransport instance.
    ...
    def aggregated_list(self,
            request: Union[compute_small.AggregatedListAddressesRequest, dict] = None,
            *,
            project: str = None,
        ...
        # in a compute_small.AggregatedListAddressesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, compute_small.AggregatedListAddressesRequest):
            request = compute_small.AggregatedListAddressesRequest(request)
    ...
    def delete(self,
            request: Union[compute_small.DeleteAddressRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
            address: str = None,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute_small.DeleteAddressRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, compute_small.DeleteAddressRequest):
            request = compute_small.DeleteAddressRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def insert(self,
            request: Union[compute_small.InsertAddressRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
            address_resource: compute_small.Address = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute_small.Operation:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute_small.InsertAddressRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, compute_small.InsertAddressRequest):
            request = compute_small.InsertAddressRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def list(self,
            request: Union[compute_small.ListAddressesRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
            order_by: str = None,
        ...
        Args:
            ...
            region (str):
                ...
                should not be set.
            order_by (str):
                Sorts list results by a certain
                order. By default, results are returned
                in alphanumerical order based on the
                resource name.  You can also sort
                results in descending order based on the
                creation timestamp using
                orderBy="creationTimestamp desc". This
                sorts results based on the
                creationTimestamp field in reverse
                chronological order (newest result
                first). Use this to sort resources like
                operations so that the newest operation
                is returned first.
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, region, order_by])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')

        # Minor optimization to avoid making a copy if the user passes
        # in a compute_small.ListAddressesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, compute_small.ListAddressesRequest):
            request = compute_small.ListAddressesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
