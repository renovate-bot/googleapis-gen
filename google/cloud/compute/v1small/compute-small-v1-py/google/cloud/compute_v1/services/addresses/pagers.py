...
class AggregatedListPager:
    ...
    """
    def __init__(self,
            method: Callable[..., compute_small.AddressAggregatedList],
            request: compute_small.AggregatedListAddressesRequest,
            response: compute_small.AddressAggregatedList,
            *,
        ...
        """
        self._method = method
        self._request = compute_small.AggregatedListAddressesRequest(request)
    ...
    @property
    def pages(self) -> Iterator[compute_small.AddressAggregatedList]:
    ...
    def __iter__(self) -> Iterator[Tuple[str, compute_small.AddressesScopedList]]:
        for page in self.pages:
            yield from page.items.items()

    def get(self, key: str) -> Optional[compute_small.AddressesScopedList]:
...
class ListPager:
    ...
    """
    def __init__(self,
            method: Callable[..., compute_small.AddressList],
            request: compute_small.ListAddressesRequest,
            response: compute_small.AddressList,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
        """Instantiate the pager.
        ...
        """
        self._method = method
        self._request = compute_small.ListAddressesRequest(request)
        self._response = response
        self._metadata = metadata
    ...
    @property
    def pages(self) -> Iterator[compute_small.AddressList]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, metadata=self._metadata)
    ...
    def __iter__(self) -> Iterator[compute_small.Address]:
        for page in self.pages:
