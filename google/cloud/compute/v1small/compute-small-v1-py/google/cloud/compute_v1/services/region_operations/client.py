...
class RegionOperationsClient(metaclass=RegionOperationsClientMeta):
    ...
    def get(self,
            request: Union[compute_small.GetRegionOperationRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
            operation: str = None,
        ...
        # in a compute_small.GetRegionOperationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, compute_small.GetRegionOperationRequest):
            request = compute_small.GetRegionOperationRequest(request)
    ...
    def wait(self,
            request: Union[compute_small.WaitRegionOperationRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
            operation: str = None,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute_small.WaitRegionOperationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, compute_small.WaitRegionOperationRequest):
            request = compute_small.WaitRegionOperationRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
