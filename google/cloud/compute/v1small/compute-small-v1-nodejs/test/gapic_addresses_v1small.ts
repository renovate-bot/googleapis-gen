...
describe('v1small.AddressesClient', () => {
    ...
    describe('aggregatedList', () => {
        it('invokes aggregatedList without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1small.AddressAggregatedList());
        ...
        it('invokes aggregatedList without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.aggregatedList(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1small.IAddressAggregatedList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1small.AddressList());
        ...
        it('invokes list without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.list(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1small.IAddressList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
