...
export class RegionOperationsClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.compute.v1.RegionOperations', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.regionOperationsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.compute.v1.RegionOperations') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.compute.v1.RegionOperations,
