...
from google.cloud.compute_v1.services.service_attachments import ServiceAttachmentsClient
from google.cloud.compute_v1.services.service_attachments import pagers
from google.cloud.compute_v1.services.service_attachments import transports
...
def test_service_attachments_client_from_service_account_info(client_class):
...
def test_service_attachments_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (ServiceAttachmentsClient, transports.ServiceAttachmentsRestTransport, "rest", "true"),
    (ServiceAttachmentsClient, transports.ServiceAttachmentsRestTransport, "rest", "false"),
])
@mock.patch.object(ServiceAttachmentsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ServiceAttachmentsClient))
...
def test_service_attachments_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListServiceAttachmentsRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        json_return_value = compute.ServiceAttachmentAggregatedList.to_json(return_value)
...
def test_aggregated_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/serviceAttachments" % client.transport._host, args[1])
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            response = (
                compute.ServiceAttachmentAggregatedList(
                    items={
                        'a':compute.ServiceAttachmentsScopedList(),
                        'b':compute.ServiceAttachmentsScopedList(),
                        'c':compute.ServiceAttachmentsScopedList(),
                    },
                    next_page_token='abc',
                ),
                compute.ServiceAttachmentAggregatedList(
                ...
                compute.ServiceAttachmentAggregatedList(
                    items={
                        'h':compute.ServiceAttachmentsScopedList(),
                        'i':compute.ServiceAttachmentsScopedList(),
                    },
                ),
            )
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteServiceAttachmentRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/serviceAttachments/{service_attachment}" % client.transport._host, args[1])
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetServiceAttachmentRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    assert response.connection_preference == compute.ServiceAttachment.ConnectionPreference.ACCEPT_AUTOMATIC
...
def test_get_iam_policy_rest(transport: str = 'rest', request_type=compute.GetIamPolicyServiceAttachmentRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/serviceAttachments/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertServiceAttachmentRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["service_attachment_resource"] = compute.ServiceAttachment(connected_endpoints=[compute.ServiceAttachmentConnectedEndpoint(endpoint='endpoint_value')])
    request = request_type(request_init)
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            region='region_value',
            service_attachment_resource=compute.ServiceAttachment(connected_endpoints=[compute.ServiceAttachmentConnectedEndpoint(endpoint='endpoint_value')]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/serviceAttachments" % client.transport._host, args[1])
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListServiceAttachmentsRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            results = list(pager)
            assert len(results) == 6
            assert all(isinstance(i, compute.ServiceAttachment)
                    for i in results)
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchServiceAttachmentRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_iam_policy_rest(transport: str = 'rest', request_type=compute.SetIamPolicyServiceAttachmentRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/serviceAttachments/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest(transport: str = 'rest', request_type=compute.TestIamPermissionsServiceAttachmentRequest):
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/serviceAttachments/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_service_attachments_host_no_port():
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_service_attachments_host_with_port():
    client = ServiceAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
