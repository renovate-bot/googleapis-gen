...
def test_ssl_certificates_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListSslCertificatesRequest):
...
def test_aggregated_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/sslCertificates" % client.transport._host, args[1])
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteSslCertificateRequest):
    client = SslCertificatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/sslCertificates/{ssl_certificate}" % client.transport._host, args[1])
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetSslCertificateRequest):
    client = SslCertificatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertSslCertificateRequest):
    client = SslCertificatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request_init["ssl_certificate_resource"] = compute.SslCertificate(certificate='certificate_value')
    request = request_type(request_init)
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/sslCertificates" % client.transport._host, args[1])
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListSslCertificatesRequest):
    client = SslCertificatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
