...
def test__get_default_mtls_endpoint():
    ...
    assert ImagesClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ImagesClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ImagesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
@pytest.mark.parametrize("transport_class,transport_name", [
    (transports.ImagesRestTransport, "rest"),
])
...
@mock.patch.object(ImagesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ImagesClient))
...
def test_images_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_images_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_images_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_deprecate_rest(transport: str = 'rest', request_type=compute.DeprecateImageRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "image": "sample2"}
    request_init["deprecation_status_resource"] = compute.DeprecationStatus(deleted='deleted_value')
    request = request_type(request_init)
...
def test_get_from_family_rest(transport: str = 'rest', request_type=compute.GetFromFamilyImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_from_family_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/images/family/{family}" % client.transport._host, args[1])
...
def test_get_iam_policy_rest(transport: str = 'rest', request_type=compute.GetIamPolicyImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/images/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_list_rest_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            assert all(isinstance(i, compute.Image)
                    for i in results)
...
def test_set_iam_policy_rest(transport: str = 'rest', request_type=compute.SetIamPolicyImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "resource": "sample2"}
    request_init["global_set_policy_request_resource"] = compute.GlobalSetPolicyRequest(bindings=[compute.Binding(binding_id='binding_id_value')])
    request = request_type(request_init)
...
def test_set_iam_policy_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/images/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest(transport: str = 'rest', request_type=compute.TestIamPermissionsImageRequest):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/images/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_images_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.images.transports.ImagesTransport.__init__') as Transport:
...
def test_images_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.images.transports.ImagesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_images_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.images.transports.ImagesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ImagesTransport()
        adc.assert_called_once()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.ImagesTransport, '_prep_wrapped_messages') as prep:
        client = ImagesClient(
            credentials=ga_credentials.AnonymousCredentials(),
