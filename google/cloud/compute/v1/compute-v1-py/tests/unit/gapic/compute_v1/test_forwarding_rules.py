...
def test__get_default_mtls_endpoint():
    ...
    assert ForwardingRulesClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert ForwardingRulesClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ForwardingRulesClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ForwardingRulesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert ForwardingRulesClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


@pytest.mark.parametrize("client_class", [
    ForwardingRulesClient,
])
def test_forwarding_rules_client_from_service_account_info(client_class):
...
def test_forwarding_rules_client_service_account_always_use_jwt(transport_class, transport_name):
...
@mock.patch.object(ForwardingRulesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ForwardingRulesClient))
def test_forwarding_rules_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (ForwardingRulesClient, transports.ForwardingRulesRestTransport, "rest", "true"),
    (ForwardingRulesClient, transports.ForwardingRulesRestTransport, "rest", "false"),
])
@mock.patch.object(ForwardingRulesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ForwardingRulesClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_forwarding_rules_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_forwarding_rules_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_forwarding_rules_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListForwardingRulesRequest):
...
def test_aggregated_list_rest_bad_request(transport: str = 'rest', request_type=compute.AggregatedListForwardingRulesRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_aggregated_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/forwardingRules" % client.transport._host, args[1])
...
def test_aggregated_list_rest_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            response = tuple(compute.ForwardingRuleAggregatedList.to_json(x) for x in response)
            ...
            for result in results:
                ...
                assert tuple(type(t) for t in result) == (str, compute.ForwardingRulesScopedList)
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "forwarding_rule": "sample3"}
    request = request_type(request_init)
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"project": "sample1", "region": "sample2", "forwarding_rule": "sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/forwardingRules/{forwarding_rule}" % client.transport._host, args[1])
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    assert response.load_balancing_scheme == compute.ForwardingRule.LoadBalancingScheme.EXTERNAL
    assert response.name == 'name_value'
    ...
    assert response.psc_connection_status == compute.ForwardingRule.PscConnectionStatus.ACCEPTED
    assert response.region == 'region_value'
    assert response.self_link == 'self_link_value'
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["forwarding_rule_resource"] = compute.ForwardingRule(I_p_address='I_p_address_value')
    request = request_type(request_init)
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            region='region_value',
            forwarding_rule_resource=compute.ForwardingRule(I_p_address='I_p_address_value'),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/forwardingRules" % client.transport._host, args[1])
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListForwardingRulesRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListForwardingRulesRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            results = list(pager)
            assert len(results) == 6
            assert all(isinstance(i, compute.ForwardingRule)
                    for i in results)
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rest_bad_request(transport: str = 'rest', request_type=compute.PatchForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_labels_rest(transport: str = 'rest', request_type=compute.SetLabelsForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["region_set_labels_request_resource"] = compute.RegionSetLabelsRequest(label_fingerprint='label_fingerprint_value')
    request = request_type(request_init)
...
def test_set_labels_rest_bad_request(transport: str = 'rest', request_type=compute.SetLabelsForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_labels_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/forwardingRules/{resource}/setLabels" % client.transport._host, args[1])
...
def test_set_target_rest(transport: str = 'rest', request_type=compute.SetTargetForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_target_rest_bad_request(transport: str = 'rest', request_type=compute.SetTargetForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_target_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/forwardingRules/{forwarding_rule}/setTarget" % client.transport._host, args[1])
...
def test_forwarding_rules_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.forwarding_rules.transports.ForwardingRulesTransport.__init__') as Transport:
...
def test_forwarding_rules_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.forwarding_rules.transports.ForwardingRulesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_forwarding_rules_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.forwarding_rules.transports.ForwardingRulesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ForwardingRulesTransport()
        adc.assert_called_once()
...
def test_forwarding_rules_host_no_port():
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.ForwardingRulesTransport, '_prep_wrapped_messages') as prep:
        client = ForwardingRulesClient(
            credentials=ga_credentials.AnonymousCredentials(),
