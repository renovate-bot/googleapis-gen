...
def test_disable_xpn_resource_rest(transport: str = 'rest', request_type=compute.DisableXpnResourceProjectRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request_init["projects_disable_xpn_resource_request_resource"] = compute.ProjectsDisableXpnResourceRequest(xpn_resource=compute.XpnResourceId(id='id_value'))
    request = request_type(request_init)
...
def test_enable_xpn_resource_rest(transport: str = 'rest', request_type=compute.EnableXpnResourceProjectRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request_init["projects_enable_xpn_resource_request_resource"] = compute.ProjectsEnableXpnResourceRequest(xpn_resource=compute.XpnResourceId(id='id_value'))
    request = request_type(request_init)
...
def test_get_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}" % client.transport._host, args[1])
...
def test_get_xpn_host_rest(transport: str = 'rest', request_type=compute.GetXpnHostProjectRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_xpn_host_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/getXpnHost" % client.transport._host, args[1])
...
def test_get_xpn_resources_rest(transport: str = 'rest', request_type=compute.GetXpnResourcesProjectsRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_xpn_resources_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/getXpnResources" % client.transport._host, args[1])
...
def test_get_xpn_resources_rest_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            assert all(isinstance(i, compute.XpnResourceId)
                    for i in results)
...
def test_list_xpn_hosts_rest(transport: str = 'rest', request_type=compute.ListXpnHostsProjectsRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request_init["projects_list_xpn_hosts_request_resource"] = compute.ProjectsListXpnHostsRequest(organization='organization_value')
    request = request_type(request_init)
...
def test_list_xpn_hosts_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/listXpnHosts" % client.transport._host, args[1])
...
def test_list_xpn_hosts_rest_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            results = list(pager)
            assert len(results) == 6
            assert all(isinstance(i, compute.Project)
                    for i in results)
...
def test_move_disk_rest(transport: str = 'rest', request_type=compute.MoveDiskProjectRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request_init["disk_move_request_resource"] = compute.DiskMoveRequest(destination_zone='destination_zone_value')
    request = request_type(request_init)
...
def test_move_instance_rest(transport: str = 'rest', request_type=compute.MoveInstanceProjectRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request_init["instance_move_request_resource"] = compute.InstanceMoveRequest(destination_zone='destination_zone_value')
    request = request_type(request_init)
...
def test_set_usage_export_bucket_rest(transport: str = 'rest', request_type=compute.SetUsageExportBucketProjectRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request_init["usage_export_location_resource"] = compute.UsageExportLocation(bucket_name='bucket_name_value')
    request = request_type(request_init)
...
def test_projects_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.projects.transports.ProjectsTransport.__init__') as Transport:
...
def test_projects_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.projects.transports.ProjectsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_projects_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.projects.transports.ProjectsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ProjectsTransport()
        adc.assert_called_once()
