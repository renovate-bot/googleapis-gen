...
from google.cloud.compute_v1.services.region_network_endpoint_groups import RegionNetworkEndpointGroupsClient
from google.cloud.compute_v1.services.region_network_endpoint_groups import pagers
from google.cloud.compute_v1.services.region_network_endpoint_groups import transports
...
def test_region_network_endpoint_groups_client_from_service_account_info(client_class):
...
def test_region_network_endpoint_groups_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (RegionNetworkEndpointGroupsClient, transports.RegionNetworkEndpointGroupsRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (RegionNetworkEndpointGroupsClient, transports.RegionNetworkEndpointGroupsRestTransport, "rest", "true"),
    (RegionNetworkEndpointGroupsClient, transports.RegionNetworkEndpointGroupsRestTransport, "rest", "false"),
])
@mock.patch.object(RegionNetworkEndpointGroupsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegionNetworkEndpointGroupsClient))
...
def test_region_network_endpoint_groups_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteRegionNetworkEndpointGroupRequest):
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}" % client.transport._host, args[1])
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups" % client.transport._host, args[1])
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListRegionNetworkEndpointGroupsRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_region_network_endpoint_groups_host_no_port():
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
