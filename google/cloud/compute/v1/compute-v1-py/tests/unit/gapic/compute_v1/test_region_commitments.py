...
def test__get_default_mtls_endpoint():
    ...
    assert RegionCommitmentsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert RegionCommitmentsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert RegionCommitmentsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert RegionCommitmentsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert RegionCommitmentsClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_region_commitments_client_service_account_always_use_jwt(transport_class, transport_name):
...
@mock.patch.object(RegionCommitmentsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegionCommitmentsClient))
def test_region_commitments_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (RegionCommitmentsClient, transports.RegionCommitmentsRestTransport, "rest", "true"),
    (RegionCommitmentsClient, transports.RegionCommitmentsRestTransport, "rest", "false"),
])
@mock.patch.object(RegionCommitmentsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegionCommitmentsClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_region_commitments_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_region_commitments_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_region_commitments_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListRegionCommitmentsRequest):
...
def test_aggregated_list_rest_bad_request(transport: str = 'rest', request_type=compute.AggregatedListRegionCommitmentsRequest):
    client = RegionCommitmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_aggregated_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/commitments" % client.transport._host, args[1])
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            for result in results:
                ...
                assert tuple(type(t) for t in result) == (str, compute.CommitmentsScopedList)
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetRegionCommitmentRequest):
    client = RegionCommitmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetRegionCommitmentRequest):
    client = RegionCommitmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"project": "sample1", "region": "sample2", "commitment": "sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/commitments/{commitment}" % client.transport._host, args[1])
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertRegionCommitmentRequest):
    client = RegionCommitmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["commitment_resource"] = compute.Commitment(category=compute.Commitment.Category.CATEGORY_UNSPECIFIED)
    request = request_type(request_init)
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertRegionCommitmentRequest):
    client = RegionCommitmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            region='region_value',
            commitment_resource=compute.Commitment(category=compute.Commitment.Category.CATEGORY_UNSPECIFIED),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/commitments" % client.transport._host, args[1])
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListRegionCommitmentsRequest):
    client = RegionCommitmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListRegionCommitmentsRequest):
    client = RegionCommitmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            results = list(pager)
            assert len(results) == 6
            assert all(isinstance(i, compute.Commitment)
                    for i in results)
...
def test_region_commitments_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.region_commitments.transports.RegionCommitmentsTransport.__init__') as Transport:
...
def test_region_commitments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_commitments.transports.RegionCommitmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_commitments_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_commitments.transports.RegionCommitmentsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegionCommitmentsTransport()
        adc.assert_called_once()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.RegionCommitmentsTransport, '_prep_wrapped_messages') as prep:
        client = RegionCommitmentsClient(
            credentials=ga_credentials.AnonymousCredentials(),
