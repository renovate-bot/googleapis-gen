...
def test_public_delegated_prefixes_client_from_service_account_info(client_class):
...
def test_public_delegated_prefixes_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
def test_public_delegated_prefixes_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/publicDelegatedPrefixes" % client.transport._host, args[1])
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeletePublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}" % client.transport._host, args[1])
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertPublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/publicDelegatedPrefixes" % client.transport._host, args[1])
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchPublicDelegatedPrefixeRequest):
    client = PublicDelegatedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_public_delegated_prefixes_host_no_port():
    client = PublicDelegatedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_public_delegated_prefixes_host_with_port():
    client = PublicDelegatedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
