...
def test_snapshots_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteSnapshotRequest):
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/snapshots/{snapshot}" % client.transport._host, args[1])
...
def test_get_iam_policy_rest(transport: str = 'rest', request_type=compute.GetIamPolicySnapshotRequest):
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/snapshots/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/snapshots" % client.transport._host, args[1])
...
def test_set_iam_policy_rest(transport: str = 'rest', request_type=compute.SetIamPolicySnapshotRequest):
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/snapshots/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_set_labels_rest(transport: str = 'rest', request_type=compute.SetLabelsSnapshotRequest):
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_labels_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/snapshots/{resource}/setLabels" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest(transport: str = 'rest', request_type=compute.TestIamPermissionsSnapshotRequest):
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/snapshots/{resource}/testIamPermissions" % client.transport._host, args[1])
