...
from google.cloud.compute_v1.services.region_health_checks import RegionHealthChecksClient
...
def test_region_health_checks_client_from_service_account_info(client_class):
...
def test_region_health_checks_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteRegionHealthCheckRequest):
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/healthChecks/{health_check}" % client.transport._host, args[1])
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertRegionHealthCheckRequest):
    client = RegionHealthChecksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/healthChecks" % client.transport._host, args[1])
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchRegionHealthCheckRequest):
    client = RegionHealthChecksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_rest(transport: str = 'rest', request_type=compute.UpdateRegionHealthCheckRequest):
    client = RegionHealthChecksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_region_health_checks_host_no_port():
    client = RegionHealthChecksClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_region_health_checks_host_with_port():
    client = RegionHealthChecksClient(
        credentials=ga_credentials.AnonymousCredentials(),
