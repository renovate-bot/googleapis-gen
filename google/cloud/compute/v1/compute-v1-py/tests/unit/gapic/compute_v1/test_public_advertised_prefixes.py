...
from google.cloud.compute_v1.services.public_advertised_prefixes import PublicAdvertisedPrefixesClient
from google.cloud.compute_v1.services.public_advertised_prefixes import pagers
from google.cloud.compute_v1.services.public_advertised_prefixes import transports
...
def test_public_advertised_prefixes_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (PublicAdvertisedPrefixesClient, transports.PublicAdvertisedPrefixesRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (PublicAdvertisedPrefixesClient, transports.PublicAdvertisedPrefixesRestTransport, "rest", "true"),
    (PublicAdvertisedPrefixesClient, transports.PublicAdvertisedPrefixesRestTransport, "rest", "false"),
])
@mock.patch.object(PublicAdvertisedPrefixesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PublicAdvertisedPrefixesClient))
...
def test_public_advertised_prefixes_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeletePublicAdvertisedPrefixeRequest):
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/publicAdvertisedPrefixes/{public_advertised_prefix}" % client.transport._host, args[1])
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertPublicAdvertisedPrefixeRequest):
    client = PublicAdvertisedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/publicAdvertisedPrefixes" % client.transport._host, args[1])
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchPublicAdvertisedPrefixeRequest):
    client = PublicAdvertisedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_public_advertised_prefixes_host_no_port():
    client = PublicAdvertisedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_public_advertised_prefixes_host_with_port():
    client = PublicAdvertisedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
