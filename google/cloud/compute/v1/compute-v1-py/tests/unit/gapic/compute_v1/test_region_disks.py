...
def test_region_disks_client_from_service_account_info(client_class):
...
def test_region_disks_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
def test_region_disks_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_add_resource_policies_rest(transport: str = 'rest', request_type=compute.AddResourcePoliciesRegionDiskRequest):
    ...
    request_init["region_disks_add_resource_policies_request_resource"] = compute.RegionDisksAddResourcePoliciesRequest(resource_policies=['resource_policies_value'])
...
def test_add_resource_policies_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            disk='disk_value',
            region_disks_add_resource_policies_request_resource=compute.RegionDisksAddResourcePoliciesRequest(resource_policies=['resource_policies_value']),
        )
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/disks/{disk}/addResourcePolicies" % client.transport._host, args[1])
...
def test_create_snapshot_rest(transport: str = 'rest', request_type=compute.CreateSnapshotRegionDiskRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_snapshot_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/disks/{disk}/createSnapshot" % client.transport._host, args[1])
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteRegionDiskRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/disks/{disk}" % client.transport._host, args[1])
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetRegionDiskRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest(transport: str = 'rest', request_type=compute.GetIamPolicyRegionDiskRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/disks/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertRegionDiskRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["disk_resource"] = compute.Disk(creation_timestamp='creation_timestamp_value')
    request = request_type(request_init)
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/disks" % client.transport._host, args[1])
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListRegionDisksRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            assert all(isinstance(i, compute.Disk)
                    for i in results)
...
def test_remove_resource_policies_rest(transport: str = 'rest', request_type=compute.RemoveResourcePoliciesRegionDiskRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "disk": "sample3"}
    request_init["region_disks_remove_resource_policies_request_resource"] = compute.RegionDisksRemoveResourcePoliciesRequest(resource_policies=['resource_policies_value'])
    request = request_type(request_init)
...
def test_remove_resource_policies_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            disk='disk_value',
            region_disks_remove_resource_policies_request_resource=compute.RegionDisksRemoveResourcePoliciesRequest(resource_policies=['resource_policies_value']),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/disks/{disk}/removeResourcePolicies" % client.transport._host, args[1])
...
def test_resize_rest(transport: str = 'rest', request_type=compute.ResizeRegionDiskRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "disk": "sample3"}
    request_init["region_disks_resize_request_resource"] = compute.RegionDisksResizeRequest(size_gb=739)
    request = request_type(request_init)
...
def test_resize_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        mock_args = dict(
            ...
            region='region_value',
            disk='disk_value',
            region_disks_resize_request_resource=compute.RegionDisksResizeRequest(size_gb=739),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/disks/{disk}/resize" % client.transport._host, args[1])
...
def test_set_iam_policy_rest(transport: str = 'rest', request_type=compute.SetIamPolicyRegionDiskRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/disks/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_set_labels_rest(transport: str = 'rest', request_type=compute.SetLabelsRegionDiskRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_labels_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/disks/{resource}/setLabels" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest(transport: str = 'rest', request_type=compute.TestIamPermissionsRegionDiskRequest):
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/disks/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_region_disks_host_no_port():
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_region_disks_host_with_port():
    client = RegionDisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
