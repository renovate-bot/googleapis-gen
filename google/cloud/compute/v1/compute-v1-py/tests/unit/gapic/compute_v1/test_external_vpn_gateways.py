...
def test_external_vpn_gateways_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteExternalVpnGatewayRequest):
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/externalVpnGateways/{external_vpn_gateway}" % client.transport._host, args[1])
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    assert response.name == 'name_value'
    assert response.redundancy_type == compute.ExternalVpnGateway.RedundancyType.FOUR_IPS_REDUNDANCY
    assert response.self_link == 'self_link_value'
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["external_vpn_gateway_resource"] = compute.ExternalVpnGateway(creation_timestamp='creation_timestamp_value')
    request = request_type(request_init)
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/externalVpnGateways" % client.transport._host, args[1])
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListExternalVpnGatewaysRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_labels_rest(transport: str = 'rest', request_type=compute.SetLabelsExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_labels_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/externalVpnGateways/{resource}/setLabels" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest(transport: str = 'rest', request_type=compute.TestIamPermissionsExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/externalVpnGateways/{resource}/testIamPermissions" % client.transport._host, args[1])
