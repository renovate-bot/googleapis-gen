...
def test_firewall_policies_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_add_association_rest(transport: str = 'rest', request_type=compute.AddAssociationFirewallPolicyRequest):
...
def test_add_association_rest_bad_request(transport: str = 'rest', request_type=compute.AddAssociationFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_association_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/addAssociation" % client.transport._host, args[1])
...
def test_add_rule_rest(transport: str = 'rest', request_type=compute.AddRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_rule_rest_bad_request(transport: str = 'rest', request_type=compute.AddRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_rule_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/addRule" % client.transport._host, args[1])
...
def test_clone_rules_rest(transport: str = 'rest', request_type=compute.CloneRulesFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_clone_rules_rest_bad_request(transport: str = 'rest', request_type=compute.CloneRulesFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_clone_rules_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/cloneRules" % client.transport._host, args[1])
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}" % client.transport._host, args[1])
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_association_rest_bad_request(transport: str = 'rest', request_type=compute.GetAssociationFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_association_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/getAssociation" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_bad_request(transport: str = 'rest', request_type=compute.GetIamPolicyFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_get_rule_rest_bad_request(transport: str = 'rest', request_type=compute.GetRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rule_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/getRule" % client.transport._host, args[1])
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies" % client.transport._host, args[1])
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListFirewallPoliciesRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_associations_rest_bad_request(transport: str = 'rest', request_type=compute.ListAssociationsFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_rest(transport: str = 'rest', request_type=compute.MoveFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_rest_bad_request(transport: str = 'rest', request_type=compute.MoveFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/move" % client.transport._host, args[1])
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rest_bad_request(transport: str = 'rest', request_type=compute.PatchFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rule_rest(transport: str = 'rest', request_type=compute.PatchRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rule_rest_bad_request(transport: str = 'rest', request_type=compute.PatchRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rule_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/patchRule" % client.transport._host, args[1])
...
def test_remove_association_rest(transport: str = 'rest', request_type=compute.RemoveAssociationFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_association_rest_bad_request(transport: str = 'rest', request_type=compute.RemoveAssociationFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_association_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/removeAssociation" % client.transport._host, args[1])
...
def test_remove_rule_rest(transport: str = 'rest', request_type=compute.RemoveRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_rule_rest_bad_request(transport: str = 'rest', request_type=compute.RemoveRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_rule_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/removeRule" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_bad_request(transport: str = 'rest', request_type=compute.SetIamPolicyFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        mock_args = dict(
            resource='resource_value',
            global_organization_set_policy_request_resource=compute.GlobalOrganizationSetPolicyRequest(bindings=[compute.Binding(binding_id='binding_id_value')]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_bad_request(transport: str = 'rest', request_type=compute.TestIamPermissionsFirewallPolicyRequest):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/locations/global/firewallPolicies/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_firewall_policies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.firewall_policies.transports.FirewallPoliciesTransport.__init__') as Transport:
...
def test_firewall_policies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.firewall_policies.transports.FirewallPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_firewall_policies_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.firewall_policies.transports.FirewallPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.FirewallPoliciesTransport()
        adc.assert_called_once()
