...
def test_network_endpoint_groups_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_aggregated_list_rest_bad_request(transport: str = 'rest', request_type=compute.AggregatedListNetworkEndpointGroupsRequest):
    client = NetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_aggregated_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/networkEndpointGroups" % client.transport._host, args[1])
...
def test_attach_network_endpoints_rest_bad_request(transport: str = 'rest', request_type=compute.AttachNetworkEndpointsNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_attach_network_endpoints_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}/attachNetworkEndpoints" % client.transport._host, args[1])
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}" % client.transport._host, args[1])
...
def test_detach_network_endpoints_rest_bad_request(transport: str = 'rest', request_type=compute.DetachNetworkEndpointsNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_detach_network_endpoints_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}/detachNetworkEndpoints" % client.transport._host, args[1])
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups" % client.transport._host, args[1])
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListNetworkEndpointGroupsRequest):
    client = NetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_network_endpoints_rest_bad_request(transport: str = 'rest', request_type=compute.ListNetworkEndpointsNetworkEndpointGroupsRequest):
    client = NetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_network_endpoints_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}/listNetworkEndpoints" % client.transport._host, args[1])
...
def test_list_network_endpoints_rest_pager():
    client = NetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_test_iam_permissions_rest_bad_request(transport: str = 'rest', request_type=compute.TestIamPermissionsNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_network_endpoint_groups_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.network_endpoint_groups.transports.NetworkEndpointGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_network_endpoint_groups_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.network_endpoint_groups.transports.NetworkEndpointGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworkEndpointGroupsTransport()
        adc.assert_called_once()
