...
def test_ssl_policies_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteSslPolicyRequest):
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/sslPolicies/{ssl_policy}" % client.transport._host, args[1])
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertSslPolicyRequest):
    client = SslPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["ssl_policy_resource"] = compute.SslPolicy(creation_timestamp='creation_timestamp_value')
    request = request_type(request_init)
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/sslPolicies" % client.transport._host, args[1])
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListSslPoliciesRequest):
    client = SslPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            assert all(isinstance(i, compute.SslPolicy)
                    for i in results)
...
def test_list_available_features_rest(transport: str = 'rest', request_type=compute.ListAvailableFeaturesSslPoliciesRequest):
    client = SslPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        json_return_value = compute.SslPoliciesListAvailableFeaturesResponse.to_json(return_value)
        response_value._content = json_return_value.encode('UTF-8')
        req.return_value = response_value
...
def test_list_available_features_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/sslPolicies/listAvailableFeatures" % client.transport._host, args[1])
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchSslPolicyRequest):
    client = SslPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
