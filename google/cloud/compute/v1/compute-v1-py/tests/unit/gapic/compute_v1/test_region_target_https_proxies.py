...
def test_region_target_https_proxies_client_from_service_account_info(client_class):
...
def test_region_target_https_proxies_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteRegionTargetHttpsProxyRequest):
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}" % client.transport._host, args[1])
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["target_https_proxy_resource"] = compute.TargetHttpsProxy(authorization_policy='authorization_policy_value')
    request = request_type(request_init)
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/targetHttpsProxies" % client.transport._host, args[1])
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListRegionTargetHttpsProxiesRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_ssl_certificates_rest(transport: str = 'rest', request_type=compute.SetSslCertificatesRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "target_https_proxy": "sample3"}
    request_init["region_target_https_proxies_set_ssl_certificates_request_resource"] = compute.RegionTargetHttpsProxiesSetSslCertificatesRequest(ssl_certificates=['ssl_certificates_value'])
    request = request_type(request_init)
...
def test_set_ssl_certificates_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}/setSslCertificates" % client.transport._host, args[1])
...
def test_set_url_map_rest(transport: str = 'rest', request_type=compute.SetUrlMapRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "target_https_proxy": "sample3"}
    request_init["url_map_reference_resource"] = compute.UrlMapReference(url_map='url_map_value')
    request = request_type(request_init)
...
def test_set_url_map_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}/setUrlMap" % client.transport._host, args[1])
