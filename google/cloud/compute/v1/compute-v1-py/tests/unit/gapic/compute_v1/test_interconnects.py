...
def test__get_default_mtls_endpoint():
    ...
    assert InterconnectsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert InterconnectsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert InterconnectsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert InterconnectsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert InterconnectsClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test_interconnects_client_service_account_always_use_jwt(transport_class, transport_name):
...
@mock.patch.object(InterconnectsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(InterconnectsClient))
def test_interconnects_client_client_options(client_class, transport_class, transport_name):
...
def test_interconnects_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_interconnects_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_interconnects_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteInterconnectRequest):
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/interconnects/{interconnect}" % client.transport._host, args[1])
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetInterconnectRequest):
    ...
    assert response.kind == 'kind_value'
    assert response.link_type == compute.Interconnect.LinkType.LINK_TYPE_ETHERNET_100G_LR
    assert response.location == 'location_value'
    assert response.name == 'name_value'
    assert response.noc_contact_email == 'noc_contact_email_value'
    assert response.operational_status == compute.Interconnect.OperationalStatus.OS_ACTIVE
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_diagnostics_rest(transport: str = 'rest', request_type=compute.GetDiagnosticsInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        json_return_value = compute.InterconnectsGetDiagnosticsResponse.to_json(return_value)
        response_value._content = json_return_value.encode('UTF-8')
        req.return_value = response_value
...
def test_get_diagnostics_rest_bad_request(transport: str = 'rest', request_type=compute.GetDiagnosticsInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_diagnostics_rest_flattened(transport: str = 'rest'):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/interconnects/{interconnect}/getDiagnostics" % client.transport._host, args[1])
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["interconnect_resource"] = compute.Interconnect(admin_enabled=True)
    request = request_type(request_init)
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/interconnects" % client.transport._host, args[1])
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListInterconnectsRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListInterconnectsRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        #with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            assert all(isinstance(i, compute.Interconnect)
                    for i in results)
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rest_bad_request(transport: str = 'rest', request_type=compute.PatchInterconnectRequest):
    client = InterconnectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_interconnects_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.interconnects.transports.InterconnectsTransport.__init__') as Transport:
...
def test_interconnects_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.interconnects.transports.InterconnectsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_interconnects_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.interconnects.transports.InterconnectsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.InterconnectsTransport()
        adc.assert_called_once()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.InterconnectsTransport, '_prep_wrapped_messages') as prep:
        client = InterconnectsClient(
            credentials=ga_credentials.AnonymousCredentials(),
