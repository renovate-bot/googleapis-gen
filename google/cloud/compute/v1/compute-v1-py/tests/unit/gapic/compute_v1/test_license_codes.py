...
from google.cloud.compute_v1.services.license_codes import LicenseCodesClient
from google.cloud.compute_v1.services.license_codes import transports
...
def test_license_codes_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (LicenseCodesClient, transports.LicenseCodesRestTransport, "rest", "true"),
    (LicenseCodesClient, transports.LicenseCodesRestTransport, "rest", "false"),
])
@mock.patch.object(LicenseCodesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(LicenseCodesClient))
...
def test_license_codes_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetLicenseCodeRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        json_return_value = compute.LicenseCode.to_json(return_value)
...
def test_get_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/licenseCodes/{license_code}" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest(transport: str = 'rest', request_type=compute.TestIamPermissionsLicenseCodeRequest):
    client = LicenseCodesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/licenseCodes/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_credentials_transport_error():
    ...
    transport = transports.LicenseCodesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = LicenseCodesClient(
...
def test_license_codes_host_no_port():
    client = LicenseCodesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_license_codes_host_with_port():
    client = LicenseCodesClient(
        credentials=ga_credentials.AnonymousCredentials(),
