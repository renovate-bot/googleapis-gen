...
class computeCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        'aggregated_list': ('project', 'filter', 'include_all_scopes', 'max_results', 'order_by', 'page_token', ),
        'delete': ('address', 'project', 'region', 'request_id', ),
        'get': ('operation', 'project', 'region', ),
        'insert': ('address_resource', 'project', 'region', 'request_id', ),
        'list': ('order_by', 'project', 'region', 'filter', 'max_results', 'page_token', ),
