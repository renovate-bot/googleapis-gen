...
describe('v1.ServiceAttachmentsClient', () => {
    ...
    describe('aggregatedList', () => {
        it('invokes aggregatedList without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.ServiceAttachmentAggregatedList());
        ...
        it('invokes aggregatedList without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.aggregatedList(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IServiceAttachmentAggregatedList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.ServiceAttachmentList());
        ...
        it('invokes list without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.list(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IServiceAttachmentList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
