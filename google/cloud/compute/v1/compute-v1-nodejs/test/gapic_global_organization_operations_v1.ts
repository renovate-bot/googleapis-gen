...
describe('v1.GlobalOrganizationOperationsClient', () => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.DeleteGlobalOrganizationOperationRequest());
            request.operation = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.DeleteGlobalOrganizationOperationResponse());
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListGlobalOrganizationOperationsRequest());
            const expectedOptions = {otherArgs: {headers: {}}};;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.OperationList());
        ...
        it('invokes list without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.list(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IOperationList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
