...
export class AddressesClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.compute.v1.Addresses', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.addressesStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.compute.v1.Addresses') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.compute.v1.Addresses,
 ...
 *   The first element of the array is an object representing [AddressAggregatedList]{@link google.cloud.compute.v1.AddressAggregatedList}.
 *   Please see the
 ...
 */
  aggregatedList(
      ...
      options?: CallOptions):
      Promise<[
        protos.google.cloud.compute.v1.IAddressAggregatedList,
        protos.google.cloud.compute.v1.IAggregatedListAddressesRequest|undefined, {}|undefined
      ]>;
  aggregatedList(
      request: protos.google.cloud.compute.v1.IAggregatedListAddressesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.IAddressAggregatedList,
          protos.google.cloud.compute.v1.IAggregatedListAddressesRequest|null|undefined,
          {}|null|undefined>): void;
  aggregatedList(
      request: protos.google.cloud.compute.v1.IAggregatedListAddressesRequest,
      callback: Callback<
 ...
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/addresses.delete.js</caption>
 * region_tag:compute_v1_generated_Addresses_Delete_async
 */
  delete(
 ...
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/addresses.get.js</caption>
 * region_tag:compute_v1_generated_Addresses_Get_async
 */
  get(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IGetAddressRequest|undefined, {}|undefined
      ]>;
  get(
      request: protos.google.cloud.compute.v1.IGetAddressRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.IAddress,
          protos.google.cloud.compute.v1.IGetAddressRequest|null|undefined,
          {}|null|undefined>): void;
  get(
      request: protos.google.cloud.compute.v1.IGetAddressRequest,
      callback: Callback<
 ...
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/addresses.insert.js</caption>
 * region_tag:compute_v1_generated_Addresses_Insert_async
 */
  insert(
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [AddressList]{@link google.cloud.compute.v1.AddressList}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 */
  list(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IListAddressesRequest|undefined, {}|undefined
      ]>;
  list(
      request: protos.google.cloud.compute.v1.IListAddressesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.IAddressList,
          protos.google.cloud.compute.v1.IListAddressesRequest|null|undefined,
          {}|null|undefined>): void;
  list(
      request: protos.google.cloud.compute.v1.IListAddressesRequest,
      callback: Callback<
