...
export class RegionBackendServicesClient {
  ...
  initialize() {
    ...
    const regionBackendServicesStubMethods =
        ['delete', 'get', 'getHealth', 'insert', 'list', 'patch', 'update'];
 ...
 */
  delete(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IDeleteRegionBackendServiceRequest|undefined, {}|undefined
      ]>;
  delete(
      request: protos.google.cloud.compute.v1.IDeleteRegionBackendServiceRequest,
      options: CallOptions,
 ...
 */
  insert(
      ...
      Promise<[
        protos.google.cloud.compute.v1.IOperation,
        protos.google.cloud.compute.v1.IInsertRegionBackendServiceRequest|undefined, {}|undefined
      ]>;
  insert(
      request: protos.google.cloud.compute.v1.IInsertRegionBackendServiceRequest,
      options: CallOptions,
 ...
 */
  list(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IListRegionBackendServicesRequest|undefined, {}|undefined
      ]>;
  list(
      request: protos.google.cloud.compute.v1.IListRegionBackendServicesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.IBackendServiceList,
          protos.google.cloud.compute.v1.IListRegionBackendServicesRequest|null|undefined,
          {}|null|undefined>): void;
  list(
      request: protos.google.cloud.compute.v1.IListRegionBackendServicesRequest,
      callback: Callback<
 ...
 */
  patch(
      ...
      Promise<[
        protos.google.cloud.compute.v1.IOperation,
        protos.google.cloud.compute.v1.IPatchRegionBackendServiceRequest|undefined, {}|undefined
      ]>;
  patch(
      request: protos.google.cloud.compute.v1.IPatchRegionBackendServiceRequest,
      options: CallOptions,
 ...
 */
  update(
      ...
      Promise<[
        protos.google.cloud.compute.v1.IOperation,
        protos.google.cloud.compute.v1.IUpdateRegionBackendServiceRequest|undefined, {}|undefined
      ]>;
  update(
      request: protos.google.cloud.compute.v1.IUpdateRegionBackendServiceRequest,
      options: CallOptions,
