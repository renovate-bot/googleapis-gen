 ...
 * `src/v1/url_maps_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './url_maps_client_config.json';
...
export class UrlMapsClient {
  ...
  urlMapsStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof UrlMapsClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.compute.v1.UrlMaps', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.urlMapsStub) {
      return this.urlMapsStub;
    }

    // Put together the "service stub" for
    // google.cloud.compute.v1.UrlMaps.
    this.urlMapsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.compute.v1.UrlMaps') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.compute.v1.UrlMaps,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const urlMapsStubMethods =
        ['aggregatedList', 'delete', 'get', 'insert', 'invalidateCache', 'list', 'patch', 'update', 'validate'];
    for (const methodName of urlMapsStubMethods) {
      const callPromise = this.urlMapsStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/url_maps.get.js</caption>
 * region_tag:compute_v1_generated_UrlMaps_Get_async
 */
  get(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IGetUrlMapRequest|undefined, {}|undefined
      ]>;
  get(
      request: protos.google.cloud.compute.v1.IGetUrlMapRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.IUrlMap,
          protos.google.cloud.compute.v1.IGetUrlMapRequest|null|undefined,
          {}|null|undefined>): void;
  get(
      request: protos.google.cloud.compute.v1.IGetUrlMapRequest,
      callback: Callback<
 ...
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/url_maps.validate.js</caption>
 * region_tag:compute_v1_generated_UrlMaps_Validate_async
 */
  validate(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IValidateUrlMapRequest|undefined, {}|undefined
      ]>;
  validate(
      request: protos.google.cloud.compute.v1.IValidateUrlMapRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.IUrlMapsValidateResponse,
          protos.google.cloud.compute.v1.IValidateUrlMapRequest|null|undefined,
          {}|null|undefined>): void;
  validate(
      request: protos.google.cloud.compute.v1.IValidateUrlMapRequest,
      callback: Callback<
