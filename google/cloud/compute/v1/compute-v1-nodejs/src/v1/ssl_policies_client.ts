...
export class SslPoliciesClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.compute.v1.SslPolicies', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.sslPoliciesStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.compute.v1.SslPolicies') :
    ...
    const sslPoliciesStubMethods =
        ['delete', 'get', 'insert', 'list', 'listAvailableFeatures', 'patch'];
 ...
 * @example <caption>include:samples/generated/v1/ssl_policies.delete.js</caption>
 * region_tag:compute_v1_generated_SslPolicies_Delete_async
 */
  delete(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IDeleteSslPolicyRequest|undefined, {}|undefined
      ]>;
  delete(
      request: protos.google.cloud.compute.v1.IDeleteSslPolicyRequest,
      options: CallOptions,
 ...
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/ssl_policies.get.js</caption>
 * region_tag:compute_v1_generated_SslPolicies_Get_async
 */
  get(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IGetSslPolicyRequest|undefined, {}|undefined
      ]>;
  get(
      request: protos.google.cloud.compute.v1.IGetSslPolicyRequest,
      options: CallOptions,
 ...
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/ssl_policies.insert.js</caption>
 * region_tag:compute_v1_generated_SslPolicies_Insert_async
 */
  insert(
      ...
      Promise<[
        protos.google.cloud.compute.v1.IOperation,
        protos.google.cloud.compute.v1.IInsertSslPolicyRequest|undefined, {}|undefined
      ]>;
  insert(
      request: protos.google.cloud.compute.v1.IInsertSslPolicyRequest,
      options: CallOptions,
 ...
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/ssl_policies.list.js</caption>
 * region_tag:compute_v1_generated_SslPolicies_List_async
 */
  list(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IListSslPoliciesRequest|undefined, {}|undefined
      ]>;
  list(
      request: protos.google.cloud.compute.v1.IListSslPoliciesRequest,
      options: CallOptions,
 ...
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/ssl_policies.list_available_features.js</caption>
 * region_tag:compute_v1_generated_SslPolicies_ListAvailableFeatures_async
 */
  listAvailableFeatures(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IListAvailableFeaturesSslPoliciesRequest|undefined, {}|undefined
      ]>;
  listAvailableFeatures(
      request: protos.google.cloud.compute.v1.IListAvailableFeaturesSslPoliciesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.ISslPoliciesListAvailableFeaturesResponse,
          protos.google.cloud.compute.v1.IListAvailableFeaturesSslPoliciesRequest|null|undefined,
          {}|null|undefined>): void;
  listAvailableFeatures(
      request: protos.google.cloud.compute.v1.IListAvailableFeaturesSslPoliciesRequest,
      callback: Callback<
 ...
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/ssl_policies.patch.js</caption>
 * region_tag:compute_v1_generated_SslPolicies_Patch_async
 */
  patch(
      ...
      Promise<[
        protos.google.cloud.compute.v1.IOperation,
        protos.google.cloud.compute.v1.IPatchSslPolicyRequest|undefined, {}|undefined
      ]>;
  patch(
      request: protos.google.cloud.compute.v1.IPatchSslPolicyRequest,
      options: CallOptions,
