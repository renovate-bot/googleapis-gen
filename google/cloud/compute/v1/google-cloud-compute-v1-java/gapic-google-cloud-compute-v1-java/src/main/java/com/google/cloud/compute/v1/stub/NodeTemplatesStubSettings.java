...
/**
 * Settings class to configure an instance of {@link NodeTemplatesStub}.
 *
...
public class NodeTemplatesStubSettings extends StubSettings<NodeTemplatesStubSettings> {
  ...
  private final OperationCallSettings<DeleteNodeTemplateRequest, Operation, Operation>
  ...
  private final OperationCallSettings<InsertNodeTemplateRequest, Operation, Operation>
      insertOperationSettings;
  private final PagedCallSettings<ListNodeTemplatesRequest, NodeTemplateList, ListPagedResponse>
      listSettings;
  private final UnaryCallSettings<SetIamPolicyNodeTemplateRequest, Policy> setIamPolicySettings;
  private final UnaryCallSettings<TestIamPermissionsNodeTemplateRequest, TestPermissionsResponse>
  ...
  private static final PagedListDescriptor<
      ...
      AGGREGATED_LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public AggregatedListNodeTemplatesRequest injectToken(
                AggregatedListNodeTemplatesRequest payload, String token) {
              return AggregatedListNodeTemplatesRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public AggregatedListNodeTemplatesRequest injectPageSize(
                AggregatedListNodeTemplatesRequest payload, int pageSize) {
              return AggregatedListNodeTemplatesRequest.newBuilder(payload)
            ...
            @Override
            public Iterable<Map.Entry<String, NodeTemplatesScopedList>> extractResources(
                NodeTemplateAggregatedList payload) {
              return payload.getItemsMap() == null
                  ? Collections.<Map.Entry<String, NodeTemplatesScopedList>>emptySet()
                  : payload.getItemsMap().entrySet();
            }
          };

  private static final PagedListDescriptor<ListNodeTemplatesRequest, NodeTemplateList, NodeTemplate>
      LIST_PAGE_STR_DESC =
          new PagedListDescriptor<ListNodeTemplatesRequest, NodeTemplateList, NodeTemplate>() {
            @Override
            public String emptyToken() {
              return "";
            }
            ...
            @Override
            public ListNodeTemplatesRequest injectToken(
                ListNodeTemplatesRequest payload, String token) {
              return ListNodeTemplatesRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListNodeTemplatesRequest injectPageSize(
                ListNodeTemplatesRequest payload, int pageSize) {
              return ListNodeTemplatesRequest.newBuilder(payload).setMaxResults(pageSize).build();
            }
  ...
  private static final PagedListResponseFactory<
          ListNodeTemplatesRequest, NodeTemplateList, ListPagedResponse>
      LIST_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListNodeTemplatesRequest, NodeTemplateList, ListPagedResponse>() {
            @Override
            public ApiFuture<ListPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListNodeTemplatesRequest, NodeTemplateList> callable,
                ListNodeTemplatesRequest request,
                ApiCallContext context,
                ApiFuture<NodeTemplateList> futureResponse) {
              PageContext<ListNodeTemplatesRequest, NodeTemplateList, NodeTemplate> pageContext =
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(NodeTemplatesStubSettings.class))
        .setTransportToken(
  ...
  public static class Builder extends StubSettings.Builder<NodeTemplatesStubSettings, Builder> {
    ...
    private final OperationCallSettings.Builder<DeleteNodeTemplateRequest, Operation, Operation>
        deleteOperationSettings;
    private final UnaryCallSettings.Builder<GetNodeTemplateRequest, NodeTemplate> getSettings;
    private final UnaryCallSettings.Builder<GetIamPolicyNodeTemplateRequest, Policy>
        getIamPolicySettings;
    private final UnaryCallSettings.Builder<InsertNodeTemplateRequest, Operation> insertSettings;
    private final OperationCallSettings.Builder<InsertNodeTemplateRequest, Operation, Operation>
        insertOperationSettings;
    private final PagedCallSettings.Builder<
            ListNodeTemplatesRequest, NodeTemplateList, ListPagedResponse>
        listSettings;
    private final UnaryCallSettings.Builder<SetIamPolicyNodeTemplateRequest, Policy>
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<DeleteNodeTemplateRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<InsertNodeTemplateRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
          .setResponseTransformer(
