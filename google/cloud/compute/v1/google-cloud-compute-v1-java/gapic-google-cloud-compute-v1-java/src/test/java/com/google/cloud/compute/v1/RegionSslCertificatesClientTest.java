...
public class RegionSslCertificatesClientTest {
  private static MockHttpService mockService;
  private static RegionSslCertificatesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionSslCertificatesStub.getMethodDescriptors(),
            RegionSslCertificatesSettings.getDefaultEndpoint());
    RegionSslCertificatesSettings settings =
        RegionSslCertificatesSettings.newBuilder()
            .setTransportChannelProvider(
                RegionSslCertificatesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionSslCertificatesClient.create(settings);
  }
  ...
  public void getTest() throws Exception {
    SslCertificate expectedResponse =
        SslCertificate.newBuilder()
            ...
            .setId(3355)
            .setKind("kind3292052")
            .setManaged(SslCertificateManagedSslCertificate.newBuilder().build())
            .setName("name3373707")
            .setPrivateKey("privateKey-1876070948")
            .setRegion("region-934795532")
            .setSelfLink("selfLink1191800166")
