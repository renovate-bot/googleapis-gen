...
public class SslPoliciesClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonSslPoliciesStub.getMethodDescriptors(),
            SslPoliciesSettings.getDefaultEndpoint());
    SslPoliciesSettings settings =
        SslPoliciesSettings.newBuilder()
            ...
            .build();
    client = SslPoliciesClient.create(settings);
  }
  ...
  public void getTest() throws Exception {
    SslPolicy expectedResponse =
        SslPolicy.newBuilder()
            .setCreationTimestamp("creationTimestamp-370203401")
            .addAllCustomFeatures(new ArrayList<String>())
            .setDescription("description-1724546052")
  ...
  @Test
  public void listAvailableFeaturesTest() throws Exception {
