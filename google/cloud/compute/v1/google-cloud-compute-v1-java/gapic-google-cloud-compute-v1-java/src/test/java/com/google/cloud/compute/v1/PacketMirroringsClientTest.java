...
public class PacketMirroringsClientTest {
  private static MockHttpService mockService;
  private static PacketMirroringsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonPacketMirroringsStub.getMethodDescriptors(),
            PacketMirroringsSettings.getDefaultEndpoint());
    PacketMirroringsSettings settings =
        PacketMirroringsSettings.newBuilder()
            .setTransportChannelProvider(
                PacketMirroringsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = PacketMirroringsClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    PacketMirroringsScopedList responsesElement = PacketMirroringsScopedList.newBuilder().build();
    ...
    List<Map.Entry<String, PacketMirroringsScopedList>> resources =
  ...
  public void getTest() throws Exception {
    PacketMirroring expectedResponse =
        PacketMirroring.newBuilder()
            ...
            .setId(3355)
            .setKind("kind3292052")
            .setMirroredResources(PacketMirroringMirroredResourceInfo.newBuilder().build())
            .setName("name3373707")
            .setNetwork(PacketMirroringNetworkInfo.newBuilder().build())
  ...
  public void listTest() throws Exception {
    PacketMirroring responsesElement = PacketMirroring.newBuilder().build();
