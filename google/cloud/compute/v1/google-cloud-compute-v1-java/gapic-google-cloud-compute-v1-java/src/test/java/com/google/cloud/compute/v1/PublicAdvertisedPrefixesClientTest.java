...
import com.google.cloud.compute.v1.stub.HttpJsonPublicAdvertisedPrefixesStub;
...
public class PublicAdvertisedPrefixesClientTest {
  private static MockHttpService mockService;
  private static PublicAdvertisedPrefixesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonPublicAdvertisedPrefixesStub.getMethodDescriptors(),
            PublicAdvertisedPrefixesSettings.getDefaultEndpoint());
    PublicAdvertisedPrefixesSettings settings =
        PublicAdvertisedPrefixesSettings.newBuilder()
            .setTransportChannelProvider(
                PublicAdvertisedPrefixesSettings.defaultHttpJsonTransportProviderBuilder()
  ...
  public void getTest() throws Exception {
    PublicAdvertisedPrefix expectedResponse =
        PublicAdvertisedPrefix.newBuilder()
            .setCreationTimestamp("creationTimestamp-370203401")
            .setDescription("description-1724546052")
            .setDnsVerificationIp("dnsVerificationIp1850235435")
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, publicAdvertisedPrefixResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void listTest() throws Exception {
    PublicAdvertisedPrefix responsesElement = PublicAdvertisedPrefix.newBuilder().build();
    PublicAdvertisedPrefixList expectedResponse =
        PublicAdvertisedPrefixList.newBuilder()
            .setNextPageToken("")
    ...
    List<PublicAdvertisedPrefix> resources = Lists.newArrayList(pagedListResponse.iterateAll());
