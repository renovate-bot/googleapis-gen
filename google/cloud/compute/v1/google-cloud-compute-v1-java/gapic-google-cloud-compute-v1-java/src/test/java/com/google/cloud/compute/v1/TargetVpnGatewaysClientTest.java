...
public class TargetVpnGatewaysClientTest {
  private static MockHttpService mockService;
  private static TargetVpnGatewaysClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonTargetVpnGatewaysStub.getMethodDescriptors(),
            TargetVpnGatewaysSettings.getDefaultEndpoint());
    TargetVpnGatewaysSettings settings =
        TargetVpnGatewaysSettings.newBuilder()
            .setTransportChannelProvider(
                TargetVpnGatewaysSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = TargetVpnGatewaysClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    ...
    List<Map.Entry<String, TargetVpnGatewaysScopedList>> resources =
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, region, targetVpnGateway).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-934795532";
      String targetVpnGateway = "targetVpnGateway935274273";
      client.deleteAsync(project, region, targetVpnGateway).get();
      Assert.fail("No exception raised");
  ...
  public void getTest() throws Exception {
    ...
    TargetVpnGateway actualResponse = client.get(project, region, targetVpnGateway);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, region, targetVpnGatewayResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-934795532";
      TargetVpnGateway targetVpnGatewayResource = TargetVpnGateway.newBuilder().build();
      client.insertAsync(project, region, targetVpnGatewayResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
