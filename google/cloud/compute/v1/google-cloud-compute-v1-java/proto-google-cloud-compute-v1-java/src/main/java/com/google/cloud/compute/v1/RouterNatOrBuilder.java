...
public interface RouterNatOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.compute.v1.RouterNatRule> 
      getRulesList();
  /**
   * <pre>
   * A list of rules associated with this NAT.
   ...
   * <code>repeated .google.cloud.compute.v1.RouterNatRule rules = 108873975;</code>
   */
  com.google.cloud.compute.v1.RouterNatRuleOrBuilder getRulesOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.compute.v1.RouterNatSubnetworkToNat subnetworks = 415853125;</code>
   */
  java.util.List<com.google.cloud.compute.v1.RouterNatSubnetworkToNat> 
      getSubnetworksList();
  /**
   * <pre>
   * A list of Subnetwork resources whose traffic should be translated by NAT Gateway. It is used only when LIST_OF_SUBNETWORKS is selected for the SubnetworkIpRangeToNatOption above.
   ...
   * <code>repeated .google.cloud.compute.v1.RouterNatSubnetworkToNat subnetworks = 415853125;</code>
   */
  com.google.cloud.compute.v1.RouterNatSubnetworkToNatOrBuilder getSubnetworksOrBuilder(
      int index);
