...
class UrlMapsGapicClient
{
     ...
     *     $project = 'project';
     *     $urlMap = 'url_map';
     *     $operationResponse = $urlMapsClient->delete($project, $urlMap);
     ...
     *     // ... do other work
     *     $newOperationResponse = $urlMapsClient->resumeOperation($operationName, 'delete');
     ...
     *     $operationResponse = $urlMapsClient->insert($project, $urlMapResource);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $urlMapsClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     *     $project = 'project';
     *     $urlMap = 'url_map';
     *     $operationResponse = $urlMapsClient->invalidateCache($cacheInvalidationRuleResource, $project, $urlMap);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $urlMapsClient->resumeOperation($operationName, 'invalidateCache');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
    ...
    public function invalidateCache($cacheInvalidationRuleResource, $project, $urlMap, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('InvalidateCache', $optionalArgs, $request, $this->getOperationsClient(), null, Operation::class)->wait();
    }
     ...
     *     $urlMap = 'url_map';
     *     $urlMapResource = new UrlMap();
     *     $operationResponse = $urlMapsClient->patch($project, $urlMap, $urlMapResource);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $urlMapsClient->resumeOperation($operationName, 'patch');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     *     $urlMap = 'url_map';
     *     $urlMapResource = new UrlMap();
     *     $operationResponse = $urlMapsClient->update($project, $urlMap, $urlMapResource);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $urlMapsClient->resumeOperation($operationName, 'update');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
