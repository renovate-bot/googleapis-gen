...
class ZonesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.Zones';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/zones_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/zones_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/zones_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function get($project, $zone, array $optionalArgs = [])
    {
        ...
        return $this->startCall('Get', Zone::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $pagedResponse = $zonesClient->list($project);
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, ZoneList::class, $request);
    }
}
