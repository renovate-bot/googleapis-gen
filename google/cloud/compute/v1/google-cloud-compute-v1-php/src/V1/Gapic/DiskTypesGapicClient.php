...
class DiskTypesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.DiskTypes';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/disk_types_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/disk_types_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/disk_types_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, DiskTypeAggregatedList::class, $request);
    }
     ...
     *     $project = 'project';
     *     $zone = 'zone';
     *     $response = $diskTypesClient->get($diskType, $project, $zone);
     * } finally {
     *     $diskTypesClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($diskType, $project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['disk_type'] = $diskType;
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['zone'] = $zone;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', DiskType::class, $optionalArgs, $request)->wait();
    }
    ...
    public function list($project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, DiskTypeList::class, $request);
    }
}
