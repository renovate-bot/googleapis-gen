 ...
 * ```
 */
class TargetInstancesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.TargetInstances';
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, TargetInstanceAggregatedList::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function delete($project, $targetInstance, $zone, array $optionalArgs = [])
    {
        $request = new DeleteTargetInstanceRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setTargetInstance($targetInstance);
        $request->setZone($zone);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['target_instance'] = $targetInstance;
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($project, $targetInstance, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', TargetInstance::class, $optionalArgs, $request)->wait();
    }
    ...
    public function list($project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, TargetInstanceList::class, $request);
    }
}
