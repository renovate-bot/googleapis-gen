...
class VpnGatewaysGapicClient
{
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, VpnGatewayAggregatedList::class, $request);
    }
     ...
     *     $operationResponse = $vpnGatewaysClient->delete($project, $region, $vpnGateway);
     ...
     *     // ... do other work
     *     $newOperationResponse = $vpnGatewaysClient->resumeOperation($operationName, 'delete');
    ...
    public function delete($project, $region, $vpnGateway, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['vpn_gateway'] = $vpnGateway;
    ...
    public function get($project, $region, $vpnGateway, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', VpnGateway::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getStatus($project, $region, $vpnGateway, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetStatus', VpnGatewaysGetStatusResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $operationResponse = $vpnGatewaysClient->insert($project, $region, $vpnGatewayResource);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $vpnGatewaysClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, VpnGatewayList::class, $request);
    }
     ...
     *     $resource = 'resource';
     *     $operationResponse = $vpnGatewaysClient->setLabels($project, $region, $regionSetLabelsRequestResource, $resource);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $vpnGatewaysClient->resumeOperation($operationName, 'setLabels');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
