...
use Google\Cloud\Compute\V1\AggregatedListRegionCommitmentsRequest;
use Google\Cloud\Compute\V1\Commitment;
use Google\Cloud\Compute\V1\CommitmentAggregatedList;
use Google\Cloud\Compute\V1\CommitmentList;
...
class RegionCommitmentsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.RegionCommitments';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/region_commitments_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/region_commitments_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/region_commitments_rest_client_config.php',
                ],
            ],
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, CommitmentAggregatedList::class, $request);
    }
    ...
    public function get($commitment, $project, $region, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['commitment'] = $commitment;
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['region'] = $region;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', Commitment::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $operationResponse = $regionCommitmentsClient->insert($commitmentResource, $project, $region);
     ...
     *     // ... do other work
     *     $newOperationResponse = $regionCommitmentsClient->resumeOperation($operationName, 'insert');
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, CommitmentList::class, $request);
    }
}
