 ...
 * ```
 */
class InstanceTemplatesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.InstanceTemplates';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/instance_templates_client_config.json',
     ...
     */
    public function delete($instanceTemplate, $project, array $optionalArgs = [])
    {
     ...
     *     $instanceTemplate = 'instance_template';
     *     $project = 'project';
     *     $response = $instanceTemplatesClient->get($instanceTemplate, $project);
     * } finally {
     *     $instanceTemplatesClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($instanceTemplate, $project, array $optionalArgs = [])
    {
     ...
     *     $project = 'project';
     *     $resource = 'resource';
     *     $response = $instanceTemplatesClient->getIamPolicy($project, $resource);
     * } finally {
     *     $instanceTemplatesClient->close();
     * }
     * ```
     ...
     *     $project = 'project';
     *     $operationResponse = $instanceTemplatesClient->insert($instanceTemplateResource, $project);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $instanceTemplatesClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($instanceTemplateResource, $project, array $optionalArgs = [])
    {
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, InstanceTemplateList::class, $request);
    }
     ...
     *     $project = 'project';
     *     $resource = 'resource';
     *     $response = $instanceTemplatesClient->setIamPolicy($globalSetPolicyRequestResource, $project, $resource);
     * } finally {
     *     $instanceTemplatesClient->close();
     * }
     * ```
     ...
     *     $response = $instanceTemplatesClient->testIamPermissions($project, $resource, $testPermissionsRequestResource);
     * } finally {
     *     $instanceTemplatesClient->close();
     * }
     * ```
