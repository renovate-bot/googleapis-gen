...
use Google\Cloud\Compute\V1\DeleteRouteRequest;
...
use Google\Cloud\Compute\V1\RouteList;
...
class RoutesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.Routes';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/routes_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/routes_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/routes_rest_client_config.php',
                ],
            ],
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, RouteList::class, $request);
    }
}
