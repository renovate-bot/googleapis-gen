...
class ResourcePoliciesGapicClient
{
    ...
    {
        $request = new AggregatedListResourcePoliciesRequest();
        $requestParamHeaders = [];
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, ResourcePolicyAggregatedList::class, $request);
    }
     ...
     *     $operationResponse = $resourcePoliciesClient->delete($project, $region, $resourcePolicy);
     ...
     *     // ... do other work
     *     $newOperationResponse = $resourcePoliciesClient->resumeOperation($operationName, 'delete');
     ...
     * @throws ApiException if the remote call fails
     */
    public function delete($project, $region, $resourcePolicy, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($project, $region, $resourcePolicy, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', ResourcePolicy::class, $optionalArgs, $request)->wait();
    }
    ...
    {
        $request = new GetIamPolicyResourcePolicyRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setRegion($region);
     ...
     *     $operationResponse = $resourcePoliciesClient->insert($project, $region, $resourcePolicyResource);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $resourcePoliciesClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
