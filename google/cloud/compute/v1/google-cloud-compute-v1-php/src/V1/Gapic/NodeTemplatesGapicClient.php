...
class NodeTemplatesGapicClient
{
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $operationResponse = $nodeTemplatesClient->delete($nodeTemplate, $project, $region);
     ...
     *     // ... do other work
     *     $newOperationResponse = $nodeTemplatesClient->resumeOperation($operationName, 'delete');
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $operationResponse = $nodeTemplatesClient->insert($nodeTemplateResource, $project, $region);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $nodeTemplatesClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
