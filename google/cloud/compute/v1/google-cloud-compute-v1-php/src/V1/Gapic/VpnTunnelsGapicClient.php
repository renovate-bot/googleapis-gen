 ...
 *     $pagedResponse = $vpnTunnelsClient->aggregatedList($project);
...
class VpnTunnelsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.VpnTunnels';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/vpn_tunnels_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/vpn_tunnels_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/vpn_tunnels_rest_client_config.php',
                ],
            ],
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, VpnTunnelAggregatedList::class, $request);
    }
     ...
     *     $operationResponse = $vpnTunnelsClient->delete($project, $region, $vpnTunnel);
     ...
     *     // ... do other work
     *     $newOperationResponse = $vpnTunnelsClient->resumeOperation($operationName, 'delete');
     ...
     * @throws ApiException if the remote call fails
     */
    public function delete($project, $region, $vpnTunnel, array $optionalArgs = [])
    {
        $request = new DeleteVpnTunnelRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setRegion($region);
        $request->setVpnTunnel($vpnTunnel);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['region'] = $region;
        $requestParamHeaders['vpn_tunnel'] = $vpnTunnel;
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($project, $region, $vpnTunnel, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', VpnTunnel::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $operationResponse = $vpnTunnelsClient->insert($project, $region, $vpnTunnelResource);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $vpnTunnelsClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @param string    $project           Project ID for this request.
     * @param string    $region            Name of the region for this request.
     * @param VpnTunnel $vpnTunnelResource The body resource for this request
     * @param array     $optionalArgs      {
     *     Optional.
     *
     *     @type string $requestId
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($project, $region, $vpnTunnelResource, array $optionalArgs = [])
    {
        $request = new InsertVpnTunnelRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setRegion($region);
        $request->setVpnTunnelResource($vpnTunnelResource);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['region'] = $region;
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, VpnTunnelList::class, $request);
    }
}
