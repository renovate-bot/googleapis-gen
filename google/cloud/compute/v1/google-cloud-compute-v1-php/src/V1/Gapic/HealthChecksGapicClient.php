...
use Google\Cloud\Compute\V1\HealthChecksAggregatedList;
...
class HealthChecksGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.HealthChecks';
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, HealthChecksAggregatedList::class, $request);
    }
     ...
     *     $project = 'project';
     *     $operationResponse = $healthChecksClient->delete($healthCheck, $project);
     ...
     *     // ... do other work
     *     $newOperationResponse = $healthChecksClient->resumeOperation($operationName, 'delete');
    ...
    public function delete($healthCheck, $project, array $optionalArgs = [])
    {
        ...
        $request->setProject($project);
        $requestParamHeaders['health_check'] = $healthCheck;
        $requestParamHeaders['project'] = $project;
     ...
     *     $healthCheck = 'health_check';
     *     $project = 'project';
     *     $response = $healthChecksClient->get($healthCheck, $project);
     * } finally {
     *     $healthChecksClient->close();
     * }
     * ```
    ...
    public function get($healthCheck, $project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', HealthCheck::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $project = 'project';
     *     $operationResponse = $healthChecksClient->insert($healthCheckResource, $project);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $healthChecksClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($healthCheckResource, $project, array $optionalArgs = [])
    {
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, HealthCheckList::class, $request);
    }
     ...
     *     $healthCheckResource = new HealthCheck();
     *     $project = 'project';
     *     $operationResponse = $healthChecksClient->patch($healthCheck, $healthCheckResource, $project);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $healthChecksClient->resumeOperation($operationName, 'patch');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function patch($healthCheck, $healthCheckResource, $project, array $optionalArgs = [])
    {
     ...
     *     $healthCheckResource = new HealthCheck();
     *     $project = 'project';
     *     $operationResponse = $healthChecksClient->update($healthCheck, $healthCheckResource, $project);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $healthChecksClient->resumeOperation($operationName, 'update');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function update($healthCheck, $healthCheckResource, $project, array $optionalArgs = [])
    {
