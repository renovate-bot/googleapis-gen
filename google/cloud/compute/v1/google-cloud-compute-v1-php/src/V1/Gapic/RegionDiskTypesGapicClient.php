...
use Google\Cloud\Compute\V1\RegionDiskTypeList;
...
class RegionDiskTypesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.RegionDiskTypes';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/region_disk_types_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/region_disk_types_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/region_disk_types_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, RegionDiskTypeList::class, $request);
    }
}
