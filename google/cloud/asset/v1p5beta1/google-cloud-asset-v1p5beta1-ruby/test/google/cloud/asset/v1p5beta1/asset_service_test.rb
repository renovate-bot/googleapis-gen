...
class ::Google::Cloud::Asset::V1p5beta1::AssetService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_assets
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Asset::V1p5beta1::ListAssetsResponse.new
    ...
    list_assets_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Asset::V1p5beta1::ListAssetsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_assets_client_stub do
      ...
      # Use protobuf object
      client.list_assets ::Google::Cloud::Asset::V1p5beta1::ListAssetsRequest.new(parent: parent, read_time: read_time, asset_types: asset_types, content_type: content_type, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      client.list_assets(::Google::Cloud::Asset::V1p5beta1::ListAssetsRequest.new(parent: parent, read_time: read_time, asset_types: asset_types, content_type: content_type, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Asset::V1p5beta1::AssetService::Client::Configuration, config
  end
end
