...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/asset/v1p5beta1/assets.proto", :syntax => :proto3) do
    add_message "google.cloud.asset.v1p5beta1.Asset" do
      optional :name, :string, 1
      optional :asset_type, :string, 2
      optional :resource, :message, 3, "google.cloud.asset.v1p5beta1.Resource"
    ...
    add_message "google.cloud.asset.v1p5beta1.Resource" do
...
module Google
  module Cloud
    module Asset
      module V1p5beta1
        Asset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.asset.v1p5beta1.Asset").msgclass
        Resource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.asset.v1p5beta1.Resource").msgclass
      end
    end
  end
end
