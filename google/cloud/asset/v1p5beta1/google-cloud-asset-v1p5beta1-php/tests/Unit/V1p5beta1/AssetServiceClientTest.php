...
namespace Google\Cloud\Asset\Tests\Unit\V1p5beta1;
...
use Google\Cloud\Asset\V1p5beta1\Asset;
use Google\Cloud\Asset\V1p5beta1\AssetServiceClient;
...
class AssetServiceClientTest extends GeneratedTest
{
    ...
    public function listAssetsTest()
    {
        ...
        $response = $client->listAssets($parent);
        ...
        $this->assertSame('/google.cloud.asset.v1p5beta1.AssetService/ListAssets', $actualFuncCall);
