...
class ::Google::Cloud::Asset::V1p7beta1::AssetService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Asset::V1p7beta1::AssetService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Asset::V1p7beta1::AssetService::Operations::Configuration, config
  end
end
