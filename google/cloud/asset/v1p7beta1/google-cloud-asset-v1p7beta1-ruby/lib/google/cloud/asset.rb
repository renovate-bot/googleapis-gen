...
module Google
  module Cloud
    ...
    ##
    # # Ruby Client for Cloud Asset API ([Beta](https://github.com/GoogleCloudPlatform/google-cloud-ruby#versioning))
    #
    ...
    module Asset
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("asset"))
      ...
      #   The major version of the service to be used. By default :v1p7beta1
      #   is used.
      ...
      def self.new(*args, version: :v1p7beta1, **kwargs)
