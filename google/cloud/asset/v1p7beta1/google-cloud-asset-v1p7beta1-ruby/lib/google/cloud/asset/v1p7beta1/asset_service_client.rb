...
require "google/cloud/asset/v1p7beta1/credentials"
  ...
  module Cloud
    module Asset
      module V1p7beta1
        ...
        #   @return [Google::Cloud::Asset::V1p7beta1::AssetService::Stub]
        class AssetServiceClient
          ...
          def initialize \
            ...
            credentials ||= Google::Cloud::Asset::V1p7beta1::Credentials.default
            ...
            if credentials.is_a?(String) || credentials.is_a?(Hash)
              updater_proc = Google::Cloud::Asset::V1p7beta1::Credentials.new(credentials).updater_proc
            end
            ...
            @asset_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Asset::V1p7beta1::AssetService::Stub.method(:new)
            )
          ...
          #   to.
          #   A hash of the same form as `Google::Cloud::Asset::V1p7beta1::OutputConfig`
          ...
          #
          #   asset_client = Google::Cloud::Asset.new(version: :v1p7beta1)
          #
          ...
          def export_assets \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Asset::V1p7beta1::ExportAssetsRequest)
