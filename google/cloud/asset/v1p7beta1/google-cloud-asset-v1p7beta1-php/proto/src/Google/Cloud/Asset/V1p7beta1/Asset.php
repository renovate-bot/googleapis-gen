 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p7beta1.Asset</code>
 */
class Asset extends \Google\Protobuf\Internal\Message
{
     ...
     *           types](https://cloud.google.com/asset-inventory/docs/supported-asset-types)
     *           for more information.
     *     @type \Google\Cloud\Asset\V1p7beta1\Resource $resource
     *           A representation of the resource.
     ...
     *     @type \Google\Cloud\Asset\V1p7beta1\RelatedAssets $related_assets
     *           The related assets of the asset of one relationship type.
     *           One asset only represents one type of relationship.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p7beta1.Resource resource = 3;</code>
     * @param \Google\Cloud\Asset\V1p7beta1\Resource $var
     * @return $this
     */
    public function setResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\V1p7beta1\Resource::class);
        $this->resource = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p7beta1.RelatedAssets related_assets = 13;</code>
     * @param \Google\Cloud\Asset\V1p7beta1\RelatedAssets $var
     * @return $this
     */
    public function setRelatedAssets($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\V1p7beta1\RelatedAssets::class);
