...
namespace Google\Cloud\Asset\V1p7beta1\PartitionSpec;
 ...
 *
 * Protobuf type <code>google.cloud.asset.v1p7beta1.PartitionSpec.PartitionKey</code>
 */
class PartitionKey
{
    /**
...
class_alias(PartitionKey::class, \Google\Cloud\Asset\V1p7beta1\PartitionSpec_PartitionKey::class);
