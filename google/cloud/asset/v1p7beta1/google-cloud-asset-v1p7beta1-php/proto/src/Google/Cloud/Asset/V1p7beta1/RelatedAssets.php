 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p7beta1.RelatedAssets</code>
 */
class RelatedAssets extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.asset.v1p7beta1.RelatedAsset assets = 2;</code>
     */
    private $assets;
     ...
     *
     *     @type \Google\Cloud\Asset\V1p7beta1\RelationshipAttributes $relationship_attributes
     *           The detailed relation attributes.
     *     @type \Google\Cloud\Asset\V1p7beta1\RelatedAsset[]|\Google\Protobuf\Internal\RepeatedField $assets
     *           The peer resources of the relationship.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p7beta1.RelationshipAttributes relationship_attributes = 1;</code>
     * @param \Google\Cloud\Asset\V1p7beta1\RelationshipAttributes $var
     * @return $this
     */
    public function setRelationshipAttributes($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\V1p7beta1\RelationshipAttributes::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.asset.v1p7beta1.RelatedAsset assets = 2;</code>
     * @param \Google\Cloud\Asset\V1p7beta1\RelatedAsset[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAssets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Asset\V1p7beta1\RelatedAsset::class);
        $this->assets = $arr;
