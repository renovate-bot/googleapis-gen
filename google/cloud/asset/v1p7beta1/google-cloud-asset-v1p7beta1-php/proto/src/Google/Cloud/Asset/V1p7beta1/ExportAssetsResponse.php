 ...
 * field.
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p7beta1.ExportAssetsResponse</code>
 */
class ExportAssetsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p7beta1.OutputConfig output_config = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p7beta1.OutputResult output_result = 3;</code>
     */
     ...
     *           Time the snapshot was taken.
     *     @type \Google\Cloud\Asset\V1p7beta1\OutputConfig $output_config
     *           Output configuration indicating where the results were output to.
     *     @type \Google\Cloud\Asset\V1p7beta1\OutputResult $output_result
     *           Output result indicating where the assets were exported to. For example, a
     *           set of actual Google Cloud Storage object uris where the assets are
     *           exported to. The uris can be different from what [output_config] has
     *           specified, as the service will split the output object into multiple ones
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p7beta1.OutputConfig output_config = 2;</code>
     * @param \Google\Cloud\Asset\V1p7beta1\OutputConfig $var
     * @return $this
     */
    public function setOutputConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\V1p7beta1\OutputConfig::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p7beta1.OutputResult output_result = 3;</code>
     * @return \Google\Cloud\Asset\V1p7beta1\OutputResult|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p7beta1.OutputResult output_result = 3;</code>
     * @param \Google\Cloud\Asset\V1p7beta1\OutputResult $var
     * @return $this
     */
    public function setOutputResult($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\V1p7beta1\OutputResult::class);
