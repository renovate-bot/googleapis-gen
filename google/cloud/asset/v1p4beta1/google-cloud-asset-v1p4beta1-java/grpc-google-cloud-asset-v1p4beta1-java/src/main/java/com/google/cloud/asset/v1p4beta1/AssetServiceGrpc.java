...
public final class AssetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyRequest,
      com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse> getAnalyzeIamPolicyMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyRequest,
      com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse> getAnalyzeIamPolicyMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyRequest, com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse> getAnalyzeIamPolicyMethod;
    if ((getAnalyzeIamPolicyMethod = AssetServiceGrpc.getAnalyzeIamPolicyMethod) == null) {
      synchronized (AssetServiceGrpc.class) {
        if ((getAnalyzeIamPolicyMethod = AssetServiceGrpc.getAnalyzeIamPolicyMethod) == null) {
          AssetServiceGrpc.getAnalyzeIamPolicyMethod = getAnalyzeIamPolicyMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyRequest, com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AnalyzeIamPolicy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse.getDefaultInstance()))
              .setSchemaDescriptor(new AssetServiceMethodDescriptorSupplier("AnalyzeIamPolicy"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.asset.v1p4beta1.ExportIamPolicyAnalysisRequest,
      com.google.longrunning.Operation> getExportIamPolicyAnalysisMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.asset.v1p4beta1.ExportIamPolicyAnalysisRequest,
      com.google.longrunning.Operation> getExportIamPolicyAnalysisMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.asset.v1p4beta1.ExportIamPolicyAnalysisRequest, com.google.longrunning.Operation> getExportIamPolicyAnalysisMethod;
    if ((getExportIamPolicyAnalysisMethod = AssetServiceGrpc.getExportIamPolicyAnalysisMethod) == null) {
      synchronized (AssetServiceGrpc.class) {
        if ((getExportIamPolicyAnalysisMethod = AssetServiceGrpc.getExportIamPolicyAnalysisMethod) == null) {
          AssetServiceGrpc.getExportIamPolicyAnalysisMethod = getExportIamPolicyAnalysisMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.asset.v1p4beta1.ExportIamPolicyAnalysisRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExportIamPolicyAnalysis"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.asset.v1p4beta1.ExportIamPolicyAnalysisRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.longrunning.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new AssetServiceMethodDescriptorSupplier("ExportIamPolicyAnalysis"))
              .build();
        }
      }
    }
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.google.longrunning.Operation>(
                  this, METHODID_EXPORT_IAM_POLICY_ANALYSIS)))
          .build();
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ANALYZE_IAM_POLICY:
          serviceImpl.analyzeIamPolicy((com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse>) responseObserver);
          break;
        case METHODID_EXPORT_IAM_POLICY_ANALYSIS:
          serviceImpl.exportIamPolicyAnalysis((com.google.cloud.asset.v1p4beta1.ExportIamPolicyAnalysisRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        default:
