 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/asset/v1p4beta1/asset_service.proto
 * Updates to the above are reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\Asset\V1p4beta1\Gapic;
...
use Google\Cloud\Asset\V1p4beta1\AnalyzeIamPolicyRequest;
use Google\Cloud\Asset\V1p4beta1\AnalyzeIamPolicyRequest\Options;
use Google\Cloud\Asset\V1p4beta1\AnalyzeIamPolicyResponse;
use Google\Cloud\Asset\V1p4beta1\ExportIamPolicyAnalysisRequest;
...
class AssetServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.asset.v1p4beta1.AssetService';
     ...
     * }
     *
     * @return \Google\Cloud\Asset\V1p4beta1\AnalyzeIamPolicyResponse
     *
    ...
    public function analyzeIamPolicy($analysisQuery, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['analysis_query.parent'] = $analysisQuery->getParent();
     ...
     *     $operationResponse = $assetServiceClient->exportIamPolicyAnalysis($analysisQuery, $outputConfig);
     ...
     *     // ... do other work
     *     $newOperationResponse = $assetServiceClient->resumeOperation($operationName, 'exportIamPolicyAnalysis');
     ...
     * @experimental
     */
    public function exportIamPolicyAnalysis($analysisQuery, $outputConfig, array $optionalArgs = [])
    {
        $request = new ExportIamPolicyAnalysisRequest();
        $requestParamHeaders = [];
        $request->setAnalysisQuery($analysisQuery);
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('ExportIamPolicyAnalysis', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
