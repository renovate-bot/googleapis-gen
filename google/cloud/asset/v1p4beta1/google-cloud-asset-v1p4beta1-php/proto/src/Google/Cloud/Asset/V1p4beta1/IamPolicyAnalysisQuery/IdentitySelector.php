 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery.IdentitySelector</code>
 */
...
class_alias(IdentitySelector::class, \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisQuery_IdentitySelector::class);
