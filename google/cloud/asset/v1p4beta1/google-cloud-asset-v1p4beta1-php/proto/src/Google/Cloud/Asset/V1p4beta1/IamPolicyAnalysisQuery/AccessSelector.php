 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery.AccessSelector</code>
 */
...
class_alias(AccessSelector::class, \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisQuery_AccessSelector::class);
