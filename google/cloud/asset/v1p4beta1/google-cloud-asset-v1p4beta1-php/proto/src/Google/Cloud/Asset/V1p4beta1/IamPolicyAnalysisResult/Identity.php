 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult.Identity</code>
 */
...
class_alias(Identity::class, \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult_Identity::class);
