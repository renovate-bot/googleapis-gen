...
namespace Google\Cloud\Asset\V1p4beta1\AnalyzeIamPolicyResponse;
 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse.IamPolicyAnalysis</code>
 */
class IamPolicyAnalysis extends \Google\Protobuf\Internal\Message
{
     ...
     * The analysis query.
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery analysis_query = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult analysis_results = 2;</code>
     */
     ...
     *           The analysis query.
     *     @type \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult[]|\Google\Protobuf\Internal\RepeatedField $analysis_results
     *           A list of [IamPolicyAnalysisResult][google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult] that matches the analysis query, or
     *           empty if no result is found.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult analysis_results = 2;</code>
     * @param \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAnalysisResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult::class);
...
class_alias(IamPolicyAnalysis::class, \Google\Cloud\Asset\V1p4beta1\AnalyzeIamPolicyResponse_IamPolicyAnalysis::class);
