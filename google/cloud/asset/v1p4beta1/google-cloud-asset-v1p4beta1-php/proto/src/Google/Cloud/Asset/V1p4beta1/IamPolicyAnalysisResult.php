 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult</code>
 */
class IamPolicyAnalysisResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult.AccessControlList access_control_lists = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult.IdentityList identity_list = 4;</code>
     */
     ...
     *           The Cloud IAM policy binding under analysis.
     *     @type \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult\AccessControlList[]|\Google\Protobuf\Internal\RepeatedField $access_control_lists
     *           The access control lists derived from the [iam_binding][google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult.iam_binding] that match or
     *           potentially match resource and access selectors specified in the request.
     *     @type \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult\IdentityList $identity_list
     *           The identity list derived from members of the [iam_binding][google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult.iam_binding] that match or
     *           potentially match identity selector specified in the request.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult.AccessControlList access_control_lists = 3;</code>
     * @param \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult\AccessControlList[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAccessControlLists($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult\AccessControlList::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult.IdentityList identity_list = 4;</code>
     * @return \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult\IdentityList|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult.IdentityList identity_list = 4;</code>
     * @param \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult\IdentityList $var
     * @return $this
     */
    public function setIdentityList($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisResult\IdentityList::class);
