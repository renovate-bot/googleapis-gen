 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p4beta1.IamPolicyAnalysisOutputConfig</code>
 */
class IamPolicyAnalysisOutputConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisOutputConfig\GcsDestination $gcs_destination
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p4beta1.IamPolicyAnalysisOutputConfig.GcsDestination gcs_destination = 1;</code>
     * @param \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisOutputConfig\GcsDestination $var
     * @return $this
     */
    public function setGcsDestination($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\V1p4beta1\IamPolicyAnalysisOutputConfig\GcsDestination::class);
