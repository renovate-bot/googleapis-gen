...
require "google/cloud/asset/v1p2beta1/credentials"
  ...
  module Cloud
    module Asset
      module V1p2beta1
        ...
        #   @return [Google::Cloud::Asset::V1p2beta1::AssetService::Stub]
        class AssetServiceClient
          ...
          def initialize \
            ...
            credentials ||= Google::Cloud::Asset::V1p2beta1::Credentials.default

            if credentials.is_a?(String) || credentials.is_a?(Hash)
              updater_proc = Google::Cloud::Asset::V1p2beta1::Credentials.new(credentials).updater_proc
            end
            ...
            @asset_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Asset::V1p2beta1::AssetService::Stub.method(:new)
            )
          ...
          #
          #   asset_client = Google::Cloud::Asset.new(version: :v1p2beta1)
          #
          #   # TODO: Initialize `name`:
          #   name = ''
          #   asset_client.delete_feed(name)
          ...
          def delete_feed \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Asset::V1p2beta1::DeleteFeedRequest)
          ...
          # @param feed [Google::Cloud::Asset::V1p2beta1::Feed | Hash]
          #   Required. The feed details. The field `name` must be empty and it will be generated
          #   in the format of:
          #   projects/project_number/feeds/feed_id
          #   folders/folder_number/feeds/feed_id
          #   organizations/organization_number/feeds/feed_id
          #   A hash of the same form as `Google::Cloud::Asset::V1p2beta1::Feed`
          #   can also be provided.
          # @param options [Google::Gax::CallOptions]
          #   Overrides the default settings for this call, e.g, timeout,
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Asset::V1p2beta1::Feed]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          ...
          def create_feed \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Asset::V1p2beta1::CreateFeedRequest)
          ...
          #   # TODO: Initialize `name`:
          #   name = ''
          #   response = asset_client.get_feed(name)
          ...
          def get_feed \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Asset::V1p2beta1::GetFeedRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Asset::V1p2beta1::ListFeedsResponse]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          ...
          def list_feeds \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Asset::V1p2beta1::ListFeedsRequest)
          ...
          def update_feed \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Asset::V1p2beta1::UpdateFeedRequest)
