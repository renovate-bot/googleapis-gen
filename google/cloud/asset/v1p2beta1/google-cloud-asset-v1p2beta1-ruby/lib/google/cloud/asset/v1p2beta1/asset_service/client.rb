      ...
      module V1p2beta1
        module AssetService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Asset::V1p2beta1::AssetService::Client::Configuration}
            ...
            #
            #     ::Google::Cloud::Asset::V1p2beta1::AssetService::Client.configure do |config|
            #       config.timeout = 10.0
            #     end
            #
            ...
            def initialize
              ...
              @asset_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Asset::V1p2beta1::AssetService::Stub,
            ...
            #   {::Google::Cloud::Asset::V1p2beta1::CreateFeedRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Asset::V1p2beta1::CreateFeedRequest, ::Hash]
            ...
            # @yieldparam response [::Google::Cloud::Asset::V1p2beta1::Feed]
            ...
            def create_feed request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Asset::V1p2beta1::CreateFeedRequest
              ...
              metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                ...
                gapic_version: ::Google::Cloud::Asset::V1p2beta1::VERSION
            ...
            #   {::Google::Cloud::Asset::V1p2beta1::GetFeedRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Asset::V1p2beta1::GetFeedRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def get_feed request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Asset::V1p2beta1::GetFeedRequest
            ...
            #   {::Google::Cloud::Asset::V1p2beta1::ListFeedsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Asset::V1p2beta1::ListFeedsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Asset::V1p2beta1::ListFeedsResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def list_feeds request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Asset::V1p2beta1::ListFeedsRequest
            ...
            #   {::Google::Cloud::Asset::V1p2beta1::UpdateFeedRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Asset::V1p2beta1::UpdateFeedRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def update_feed request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Asset::V1p2beta1::UpdateFeedRequest
            ...
            #   {::Google::Cloud::Asset::V1p2beta1::DeleteFeedRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Asset::V1p2beta1::DeleteFeedRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def delete_feed request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Asset::V1p2beta1::DeleteFeedRequest
            ...
            # {::Google::Cloud::Asset::V1p2beta1::AssetService::Client::Configuration::Rpcs}
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for create_feed
