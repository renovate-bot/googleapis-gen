 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p2beta1.OutputConfig</code>
 */
class OutputConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Asset\V1p2beta1\GcsDestination $gcs_destination
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p2beta1.GcsDestination gcs_destination = 1;</code>
     * @param \Google\Cloud\Asset\V1p2beta1\GcsDestination $var
     * @return $this
     */
    public function setGcsDestination($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\V1p2beta1\GcsDestination::class);
