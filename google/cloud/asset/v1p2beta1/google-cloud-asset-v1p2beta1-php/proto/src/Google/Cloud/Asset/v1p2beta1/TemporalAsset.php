 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p2beta1.TemporalAsset</code>
 */
class TemporalAsset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Asset\v1p2beta1\TimeWindow $window
     *           The time window when the asset data and state was observed.
     *     @type bool $deleted
     *           If the asset is deleted or not.
     *     @type \Google\Cloud\Asset\v1p2beta1\Asset $asset
     *           Asset.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p2beta1.TimeWindow window = 1;</code>
     * @param \Google\Cloud\Asset\v1p2beta1\TimeWindow $var
     * @return $this
     */
    public function setWindow($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\v1p2beta1\TimeWindow::class);
        $this->window = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p2beta1.Asset asset = 3;</code>
     * @param \Google\Cloud\Asset\v1p2beta1\Asset $var
     * @return $this
     */
    public function setAsset($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\v1p2beta1\Asset::class);
        $this->asset = $var;
