 ...
 *
 * Generated from protobuf message <code>google.cloud.asset.v1p2beta1.Asset</code>
 */
class Asset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated string ancestors = 6;</code>
     */
    private $ancestors;
     ...
     *           Type of the asset. Example: "compute.googleapis.com/Disk".
     *     @type \Google\Cloud\Asset\v1p2beta1\Resource $resource
     *           Representation of the resource.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.asset.v1p2beta1.Resource resource = 3;</code>
     * @param \Google\Cloud\Asset\v1p2beta1\Resource $var
     * @return $this
     */
    public function setResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Asset\v1p2beta1\Resource::class);
        $this->resource = $var;
