...
class AssetServiceClientTest extends GeneratedTest
{
    ...
    public function createFeedTest()
    {
        ...
        $this->assertSame('/google.cloud.asset.v1p2beta1.AssetService/CreateFeed', $actualFuncCall);
    ...
    public function deleteFeedTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.asset.v1p2beta1.AssetService/DeleteFeed', $actualFuncCall);
    ...
    public function getFeedTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.asset.v1p2beta1.AssetService/GetFeed', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listFeedsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.asset.v1p2beta1.AssetService/ListFeeds', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($parent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateFeedTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.asset.v1p2beta1.AssetService/UpdateFeed', $actualFuncCall);
        $actualValue = $actualRequestObject->getFeed();
        $this->assertProtobufEquals($feed, $actualValue);
