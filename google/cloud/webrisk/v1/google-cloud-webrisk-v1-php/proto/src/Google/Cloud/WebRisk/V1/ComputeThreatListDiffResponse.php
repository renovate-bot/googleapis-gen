...
/**
 * Generated from protobuf message <code>google.cloud.webrisk.v1.ComputeThreatListDiffResponse</code>
 */
class ComputeThreatListDiffResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.webrisk.v1.ComputeThreatListDiffResponse.ResponseType response_type = 4;</code>
     */
    protected $response_type = 0;
    /**
     * A set of entries to add to a local threat type's list.
     *
     * Generated from protobuf field <code>.google.cloud.webrisk.v1.ThreatEntryAdditions additions = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.webrisk.v1.ThreatEntryRemovals removals = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.webrisk.v1.ComputeThreatListDiffResponse.Checksum checksum = 8;</code>
     */
     ...
     *           The type of response. This may indicate that an action must be taken by the
     *           client when the response is received.
     *     @type \Google\Cloud\WebRisk\V1\ThreatEntryAdditions $additions
     *           A set of entries to add to a local threat type's list.
     *     @type \Google\Cloud\WebRisk\V1\ThreatEntryRemovals $removals
     *           A set of entries to remove from a local threat type's list.
     *           This field may be empty.
     ...
     *           and passed into the next call of ComputeThreatListDiff as 'version_token'.
     *           A separate version token should be stored and used for each threatList.
     *     @type \Google\Cloud\WebRisk\V1\ComputeThreatListDiffResponse\Checksum $checksum
     *           The expected SHA256 hash of the client state; that is, of the sorted list
     *           of all hashes present in the database after applying the provided diff.
     *           If the client state doesn't match the expected state, the client must
     *           discard this diff and retry later.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.webrisk.v1.ThreatEntryAdditions additions = 5;</code>
     * @return \Google\Cloud\WebRisk\V1\ThreatEntryAdditions|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.webrisk.v1.ThreatEntryAdditions additions = 5;</code>
     * @param \Google\Cloud\WebRisk\V1\ThreatEntryAdditions $var
     * @return $this
     */
    public function setAdditions($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\WebRisk\V1\ThreatEntryAdditions::class);
        $this->additions = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.webrisk.v1.ThreatEntryRemovals removals = 6;</code>
     * @return \Google\Cloud\WebRisk\V1\ThreatEntryRemovals|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.webrisk.v1.ThreatEntryRemovals removals = 6;</code>
     * @param \Google\Cloud\WebRisk\V1\ThreatEntryRemovals $var
     * @return $this
     */
    public function setRemovals($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\WebRisk\V1\ThreatEntryRemovals::class);
        $this->removals = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.webrisk.v1.ComputeThreatListDiffResponse.Checksum checksum = 8;</code>
     * @return \Google\Cloud\WebRisk\V1\ComputeThreatListDiffResponse\Checksum|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.webrisk.v1.ComputeThreatListDiffResponse.Checksum checksum = 8;</code>
     * @param \Google\Cloud\WebRisk\V1\ComputeThreatListDiffResponse\Checksum $var
     * @return $this
     */
