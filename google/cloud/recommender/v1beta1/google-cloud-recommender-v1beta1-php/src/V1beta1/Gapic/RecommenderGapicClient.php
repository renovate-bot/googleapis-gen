 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/recommender/v1beta1/recommender_service.proto
 * and updates to that file get reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\Recommender\V1beta1\Gapic;
...
use Google\Cloud\Recommender\V1beta1\GetInsightRequest;
use Google\Cloud\Recommender\V1beta1\GetRecommendationRequest;
use Google\Cloud\Recommender\V1beta1\Insight;
use Google\Cloud\Recommender\V1beta1\ListInsightsRequest;
use Google\Cloud\Recommender\V1beta1\ListInsightsResponse;
use Google\Cloud\Recommender\V1beta1\ListRecommendationsRequest;
use Google\Cloud\Recommender\V1beta1\ListRecommendationsResponse;
use Google\Cloud\Recommender\V1beta1\MarkInsightAcceptedRequest;
use Google\Cloud\Recommender\V1beta1\MarkRecommendationClaimedRequest;
use Google\Cloud\Recommender\V1beta1\MarkRecommendationFailedRequest;
use Google\Cloud\Recommender\V1beta1\MarkRecommendationSucceededRequest;
...
class RecommenderGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.recommender.v1beta1.Recommender';
