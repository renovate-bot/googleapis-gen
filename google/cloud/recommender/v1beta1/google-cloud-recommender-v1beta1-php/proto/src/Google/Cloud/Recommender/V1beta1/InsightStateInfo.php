 ...
 *
 * Generated from protobuf message <code>google.cloud.recommender.v1beta1.InsightStateInfo</code>
 */
class InsightStateInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * Insight state.
     *
     * Generated from protobuf field <code>.google.cloud.recommender.v1beta1.InsightStateInfo.State state = 1;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Recommender\V1beta1\InsightStateInfo\State::class);
        $this->state = $var;
