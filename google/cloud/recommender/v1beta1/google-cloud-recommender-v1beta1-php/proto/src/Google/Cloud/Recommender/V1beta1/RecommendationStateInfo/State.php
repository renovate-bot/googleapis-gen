...
namespace Google\Cloud\Recommender\V1beta1\RecommendationStateInfo;
 ...
 *
 * Protobuf type <code>google.cloud.recommender.v1beta1.RecommendationStateInfo.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Recommender\V1beta1\RecommendationStateInfo_State::class);
