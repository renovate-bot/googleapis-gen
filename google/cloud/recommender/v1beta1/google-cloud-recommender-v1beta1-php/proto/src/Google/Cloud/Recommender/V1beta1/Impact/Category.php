...
namespace Google\Cloud\Recommender\V1beta1\Impact;
 ...
 *
 * Protobuf type <code>google.cloud.recommender.v1beta1.Impact.Category</code>
 */
class Category
{
    /**
...
class_alias(Category::class, \Google\Cloud\Recommender\V1beta1\Impact_Category::class);
