...
namespace Google\Cloud\Recommender\V1beta1\Insight;
 ...
 * Insight category.
 *
 * Protobuf type <code>google.cloud.recommender.v1beta1.Insight.Category</code>
 */
class Category
{
    /**
...
class_alias(Category::class, \Google\Cloud\Recommender\V1beta1\Insight_Category::class);
