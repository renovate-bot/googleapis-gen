 ...
 *
 * Generated from protobuf message <code>google.cloud.recommender.v1beta1.RecommendationStateInfo</code>
 */
class RecommendationStateInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.recommender.v1beta1.RecommendationStateInfo.State state = 1;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Recommender\V1beta1\RecommendationStateInfo\State::class);
        $this->state = $var;
