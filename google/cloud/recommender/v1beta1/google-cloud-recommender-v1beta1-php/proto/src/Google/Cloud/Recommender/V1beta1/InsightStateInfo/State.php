...
namespace Google\Cloud\Recommender\V1beta1\InsightStateInfo;
 ...
 *
 * Protobuf type <code>google.cloud.recommender.v1beta1.InsightStateInfo.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Recommender\V1beta1\InsightStateInfo_State::class);
