 ...
 *
 * Generated from protobuf message <code>google.cloud.recommender.v1beta1.Operation</code>
 */
class Operation extends \Google\Protobuf\Internal\Message
{
     ...
     * must be performed.
     *
     * Generated from protobuf field <code>map<string, .google.cloud.recommender.v1beta1.ValueMatcher> path_value_matchers = 11;</code>
     */
     ...
     *     @type \Google\Cloud\Recommender\V1beta1\ValueMatcher $value_matcher
     ...
     * 'path' field. Either this or `value` will be set for 'test' operation.
     *
     * Generated from protobuf field <code>.google.cloud.recommender.v1beta1.ValueMatcher value_matcher = 10;</code>
     * @return \Google\Cloud\Recommender\V1beta1\ValueMatcher|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.recommender.v1beta1.ValueMatcher value_matcher = 10;</code>
     * @param \Google\Cloud\Recommender\V1beta1\ValueMatcher $var
     * @return $this
     */
    public function setValueMatcher($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Recommender\V1beta1\ValueMatcher::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Recommender\V1beta1\ValueMatcher::class);
