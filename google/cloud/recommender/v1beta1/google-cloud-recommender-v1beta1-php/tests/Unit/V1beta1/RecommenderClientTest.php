...
namespace Google\Cloud\Recommender\Tests\Unit\V1beta1;

use Google\Cloud\Recommender\V1beta1\RecommenderClient;
use Google\ApiCore\ApiException;
use Google\ApiCore\CredentialsWrapper;
use Google\ApiCore\Testing\GeneratedTest;
use Google\ApiCore\Testing\MockTransport;
use Google\Cloud\Recommender\V1beta1\Insight;
use Google\Cloud\Recommender\V1beta1\ListInsightsResponse;
use Google\Cloud\Recommender\V1beta1\ListRecommendationsResponse;
use Google\Cloud\Recommender\V1beta1\Recommendation;
...
class RecommenderClientTest extends GeneratedTest
{
    ...
    public function listInsightsTest()
    {
        ...
        $this->assertSame('/google.cloud.recommender.v1beta1.Recommender/ListInsights', $actualFuncCall);
    ...
    public function getInsightTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.recommender.v1beta1.Recommender/GetInsight', $actualFuncCall);
    ...
    public function markInsightAcceptedTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.recommender.v1beta1.Recommender/MarkInsightAccepted', $actualFuncCall);
    ...
    public function listRecommendationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.recommender.v1beta1.Recommender/ListRecommendations', $actualFuncCall);
    ...
    public function getRecommendationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.recommender.v1beta1.Recommender/GetRecommendation', $actualFuncCall);
    ...
    public function markRecommendationClaimedTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.recommender.v1beta1.Recommender/MarkRecommendationClaimed', $actualFuncCall);
    ...
    public function markRecommendationSucceededTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.recommender.v1beta1.Recommender/MarkRecommendationSucceeded', $actualFuncCall);
    ...
    public function markRecommendationFailedTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.recommender.v1beta1.Recommender/MarkRecommendationFailed', $actualFuncCall);
