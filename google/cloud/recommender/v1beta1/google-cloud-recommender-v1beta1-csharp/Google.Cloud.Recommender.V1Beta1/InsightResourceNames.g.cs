...
namespace Google.Cloud.Recommender.V1Beta1
{
    ...
    public sealed partial class InsightName : gax::IResourceName, sys::IEquatable<InsightName>
    {
        ...
        /// <param name="insightTypeId">The <c>InsightType</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="InsightName"/> constructed from the provided ids.</returns>
        public static InsightName FromFolderLocationInsightType(string folderId, string locationId, string insightTypeId) =>
            new InsightName(ResourceNameType.FolderLocationInsightType, folderId: gax::GaxPreconditions.CheckNotNullOrEmpty(folderId, nameof(folderId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), insightTypeId: gax::GaxPreconditions.CheckNotNullOrEmpty(insightTypeId, nameof(insightTypeId)));
        ...
        /// <param name="insightTypeId">The <c>InsightType</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="InsightName"/> constructed from the provided ids.</returns>
        public static InsightName FromOrganizationLocationInsightType(string organizationId, string locationId, string insightTypeId) =>
            new InsightName(ResourceNameType.OrganizationLocationInsightType, organizationId: gax::GaxPreconditions.CheckNotNullOrEmpty(organizationId, nameof(organizationId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), insightTypeId: gax::GaxPreconditions.CheckNotNullOrEmpty(insightTypeId, nameof(insightTypeId)));
        ...
        public static bool TryParse(string insightName, bool allowUnparsed, out InsightName result)
        {
            ...
            if (s_folderLocationInsightType.TryParseName(insightName, out resourceName))
            {
                result = FromFolderLocationInsightType(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (s_organizationLocationInsightType.TryParseName(insightName, out resourceName))
            {
