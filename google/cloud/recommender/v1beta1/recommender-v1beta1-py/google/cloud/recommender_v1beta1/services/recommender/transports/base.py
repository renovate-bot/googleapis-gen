...
class RecommenderTransport(abc.ABC):
    ...
    @property
    def list_insights(self) -> typing.Callable[
            [recommender_service.ListInsightsRequest],
            typing.Union[
                recommender_service.ListInsightsResponse,
                typing.Awaitable[recommender_service.ListInsightsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_insight(self) -> typing.Callable[
            [recommender_service.GetInsightRequest],
            typing.Union[
                insight.Insight,
                typing.Awaitable[insight.Insight]
            ]]:
        raise NotImplementedError()

    @property
    def mark_insight_accepted(self) -> typing.Callable[
    ...
    @property
    def list_recommendations(self) -> typing.Callable[
    ...
    @property
    def get_recommendation(self) -> typing.Callable[
    ...
    @property
    def mark_recommendation_claimed(self) -> typing.Callable[
    ...
    @property
    def mark_recommendation_succeeded(self) -> typing.Callable[
    ...
    @property
    def mark_recommendation_failed(self) -> typing.Callable[
