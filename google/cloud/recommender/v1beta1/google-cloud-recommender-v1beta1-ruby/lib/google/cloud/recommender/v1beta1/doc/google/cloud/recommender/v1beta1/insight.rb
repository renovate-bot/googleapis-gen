  ...
  module Cloud
    module Recommender
      module V1beta1
        ...
        #   @return [Google::Cloud::Recommender::V1beta1::Insight::Category]
        ...
        #   @return [Array<Google::Cloud::Recommender::V1beta1::Insight::RecommendationReference>]
        ...
        class Insight
          ...
          class RecommendationReference; end
        ...
        # @!attribute [rw] state
        #   @return [Google::Cloud::Recommender::V1beta1::InsightStateInfo::State]
        #     Insight state.
