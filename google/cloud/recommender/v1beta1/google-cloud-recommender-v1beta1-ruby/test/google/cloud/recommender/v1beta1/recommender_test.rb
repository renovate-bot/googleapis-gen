...
class ::Google::Cloud::Recommender::V1beta1::Recommender::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_insights
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Recommender::V1beta1::ListInsightsResponse.new
    ...
    list_insights_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Recommender::V1beta1::ListInsightsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_insights_client_stub do
      ...
      # Use protobuf object
      client.list_insights ::Google::Cloud::Recommender::V1beta1::ListInsightsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      client.list_insights(::Google::Cloud::Recommender::V1beta1::ListInsightsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_insight
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Recommender::V1beta1::Insight.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_insight_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Recommender::V1beta1::GetInsightRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_insight_client_stub do
      ...
      # Use protobuf object
      client.get_insight ::Google::Cloud::Recommender::V1beta1::GetInsightRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_insight(::Google::Cloud::Recommender::V1beta1::GetInsightRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_mark_insight_accepted
    ...
    mark_insight_accepted_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Recommender::V1beta1::MarkInsightAcceptedRequest, request
      assert_equal "hello world", request["name"]
    ...
    Gapic::ServiceStub.stub :new, mark_insight_accepted_client_stub do
      ...
      # Use protobuf object
      client.mark_insight_accepted ::Google::Cloud::Recommender::V1beta1::MarkInsightAcceptedRequest.new(name: name, state_metadata: state_metadata, etag: etag) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.mark_insight_accepted(::Google::Cloud::Recommender::V1beta1::MarkInsightAcceptedRequest.new(name: name, state_metadata: state_metadata, etag: etag), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_recommendations
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Recommender::V1beta1::ListRecommendationsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_recommendations_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Recommender::V1beta1::ListRecommendationsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      assert_equal "hello world", request["filter"]
    ...
    Gapic::ServiceStub.stub :new, list_recommendations_client_stub do
      ...
      # Use protobuf object
      client.list_recommendations ::Google::Cloud::Recommender::V1beta1::ListRecommendationsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_recommendations(::Google::Cloud::Recommender::V1beta1::ListRecommendationsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_recommendation
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Recommender::V1beta1::Recommendation.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_recommendation_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Recommender::V1beta1::GetRecommendationRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_recommendation_client_stub do
      ...
      # Use protobuf object
      client.get_recommendation ::Google::Cloud::Recommender::V1beta1::GetRecommendationRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_recommendation(::Google::Cloud::Recommender::V1beta1::GetRecommendationRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_mark_recommendation_claimed
    ...
    mark_recommendation_claimed_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Recommender::V1beta1::MarkRecommendationClaimedRequest, request
      assert_equal "hello world", request["name"]
      assert_equal({}, request["state_metadata"].to_h)
      assert_equal "hello world", request["etag"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, mark_recommendation_claimed_client_stub do
      ...
      # Use protobuf object
      client.mark_recommendation_claimed ::Google::Cloud::Recommender::V1beta1::MarkRecommendationClaimedRequest.new(name: name, state_metadata: state_metadata, etag: etag) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.mark_recommendation_claimed(::Google::Cloud::Recommender::V1beta1::MarkRecommendationClaimedRequest.new(name: name, state_metadata: state_metadata, etag: etag), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_mark_recommendation_succeeded
    ...
    mark_recommendation_succeeded_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Recommender::V1beta1::MarkRecommendationSucceededRequest, request
      assert_equal "hello world", request["name"]
      assert_equal({}, request["state_metadata"].to_h)
      assert_equal "hello world", request["etag"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, mark_recommendation_succeeded_client_stub do
      ...
      # Use protobuf object
      client.mark_recommendation_succeeded ::Google::Cloud::Recommender::V1beta1::MarkRecommendationSucceededRequest.new(name: name, state_metadata: state_metadata, etag: etag) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.mark_recommendation_succeeded(::Google::Cloud::Recommender::V1beta1::MarkRecommendationSucceededRequest.new(name: name, state_metadata: state_metadata, etag: etag), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_mark_recommendation_failed
    ...
    mark_recommendation_failed_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Recommender::V1beta1::MarkRecommendationFailedRequest, request
      assert_equal "hello world", request["name"]
      assert_equal({}, request["state_metadata"].to_h)
      assert_equal "hello world", request["etag"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, mark_recommendation_failed_client_stub do
      ...
      # Use protobuf object
      client.mark_recommendation_failed ::Google::Cloud::Recommender::V1beta1::MarkRecommendationFailedRequest.new(name: name, state_metadata: state_metadata, etag: etag) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.mark_recommendation_failed(::Google::Cloud::Recommender::V1beta1::MarkRecommendationFailedRequest.new(name: name, state_metadata: state_metadata, etag: etag), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Recommender::V1beta1::Recommender::Client::Configuration, config
  end
end
