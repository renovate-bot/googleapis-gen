...
# [START recommender_v1beta1_generated_Recommender_MarkRecommendationClaimed_sync]
...
request = Google::Cloud::Recommender::V1beta1::MarkRecommendationClaimedRequest.new
