...
describe('v1beta1.RecommenderClient', () => {
    ...
    describe('getInsight', () => {
        it('invokes getInsight without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.recommender.v1beta1.Insight());
            client.innerApiCalls.getInsight = stubSimpleCall(expectedResponse);
            const [response] = await client.getInsight(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getInsight as SinonStub)
    ...
    describe('markInsightAccepted', () => {
        it('invokes markInsightAccepted without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.recommender.v1beta1.MarkInsightAcceptedRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.markInsightAccepted as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getRecommendation', () => {
        it('invokes getRecommendation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.recommender.v1beta1.GetRecommendationRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.recommender.v1beta1.Recommendation());
    ...
    describe('markRecommendationClaimed', () => {
        it('invokes markRecommendationClaimed without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.markRecommendationClaimed as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('markRecommendationSucceeded', () => {
        it('invokes markRecommendationSucceeded without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.recommender.v1beta1.MarkRecommendationSucceededRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.markRecommendationSucceeded as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('markRecommendationFailed', () => {
        it('invokes markRecommendationFailed without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.markRecommendationFailed as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listInsights', () => {
        it('invokes listInsights without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.recommender.v1beta1.ListInsightsRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listInsights as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listRecommendations', () => {
        it('invokes listRecommendations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.recommender.v1beta1.ListRecommendationsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listRecommendations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
