...
class SecuritySettingsServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_security_settings: gapic_v1.method.wrap_method(
            ...
            self.list_security_settings: gapic_v1.method.wrap_method(
                self.list_security_settings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_security_settings: gapic_v1.method.wrap_method(
    ...
    @property
    def create_security_settings(self) -> typing.Callable[
            [gcdc_security_settings.CreateSecuritySettingsRequest],
            typing.Union[
                gcdc_security_settings.SecuritySettings,
                typing.Awaitable[gcdc_security_settings.SecuritySettings]
            ]]:
        raise NotImplementedError()

    @property
    def get_security_settings(self) -> typing.Callable[
    ...
    @property
    def update_security_settings(self) -> typing.Callable[
    ...
    @property
    def list_security_settings(self) -> typing.Callable[
            [security_settings.ListSecuritySettingsRequest],
            typing.Union[
                security_settings.ListSecuritySettingsResponse,
                typing.Awaitable[security_settings.ListSecuritySettingsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def delete_security_settings(self) -> typing.Callable[
