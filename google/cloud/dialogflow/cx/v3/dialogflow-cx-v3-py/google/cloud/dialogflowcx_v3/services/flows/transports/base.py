...
class FlowsTransport(abc.ABC):
    ...
    @property
    def create_flow(self) -> typing.Callable[
            [gcdc_flow.CreateFlowRequest],
            typing.Union[
                gcdc_flow.Flow,
                typing.Awaitable[gcdc_flow.Flow]
            ]]:
        raise NotImplementedError()

    @property
    def delete_flow(self) -> typing.Callable[
    ...
    @property
    def list_flows(self) -> typing.Callable[
            [flow.ListFlowsRequest],
            typing.Union[
                flow.ListFlowsResponse,
                typing.Awaitable[flow.ListFlowsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_flow(self) -> typing.Callable[
            [flow.GetFlowRequest],
            typing.Union[
                flow.Flow,
                typing.Awaitable[flow.Flow]
            ]]:
        raise NotImplementedError()

    @property
    def update_flow(self) -> typing.Callable[
    ...
    @property
    def train_flow(self) -> typing.Callable[
    ...
    @property
    def validate_flow(self) -> typing.Callable[
            [flow.ValidateFlowRequest],
            typing.Union[
                flow.FlowValidationResult,
                typing.Awaitable[flow.FlowValidationResult]
            ]]:
        raise NotImplementedError()

    @property
    def get_flow_validation_result(self) -> typing.Callable[
    ...
    @property
    def import_flow(self) -> typing.Callable[
    ...
    @property
    def export_flow(self) -> typing.Callable[
