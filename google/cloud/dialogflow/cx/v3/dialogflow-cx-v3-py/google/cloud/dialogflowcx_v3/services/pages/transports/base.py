...
class PagesTransport(abc.ABC):
    ...
    @property
    def list_pages(self) -> typing.Callable[
            [page.ListPagesRequest],
            typing.Union[
                page.ListPagesResponse,
                typing.Awaitable[page.ListPagesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_page(self) -> typing.Callable[
            [page.GetPageRequest],
            typing.Union[
                page.Page,
                typing.Awaitable[page.Page]
            ]]:
        raise NotImplementedError()

    @property
    def create_page(self) -> typing.Callable[
            [gcdc_page.CreatePageRequest],
            typing.Union[
                gcdc_page.Page,
                typing.Awaitable[gcdc_page.Page]
            ]]:
        raise NotImplementedError()

    @property
    def update_page(self) -> typing.Callable[
    ...
    @property
    def delete_page(self) -> typing.Callable[
