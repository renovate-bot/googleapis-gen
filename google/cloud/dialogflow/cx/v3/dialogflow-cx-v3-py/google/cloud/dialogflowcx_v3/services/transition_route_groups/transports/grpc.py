...
class TransitionRouteGroupsGrpcTransport(TransitionRouteGroupsTransport):
    ...
    def create_transition_route_group(self) -> Callable[
        ...
        if 'create_transition_route_group' not in self._stubs:
            self._stubs['create_transition_route_group'] = self.grpc_channel.unary_unary(
    ...
    def update_transition_route_group(self) -> Callable[
        ...
        if 'update_transition_route_group' not in self._stubs:
            self._stubs['update_transition_route_group'] = self.grpc_channel.unary_unary(
    ...
    def delete_transition_route_group(self) -> Callable[
        ...
        if 'delete_transition_route_group' not in self._stubs:
            self._stubs['delete_transition_route_group'] = self.grpc_channel.unary_unary(
