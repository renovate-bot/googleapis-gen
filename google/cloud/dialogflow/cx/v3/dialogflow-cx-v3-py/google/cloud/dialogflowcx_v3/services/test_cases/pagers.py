...
class ListTestCasesPager:
    ...
    :class:`google.cloud.dialogflowcx_v3.types.ListTestCasesResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3.types.ListTestCasesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.dialogflowcx_v3.types.ListTestCasesResponse):
...
class ListTestCaseResultsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.dialogflowcx_v3.types.ListTestCaseResultsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3.types.ListTestCaseResultsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.dialogflowcx_v3.types.ListTestCaseResultsRequest):
                The initial request object.
            response (google.cloud.dialogflowcx_v3.types.ListTestCaseResultsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
