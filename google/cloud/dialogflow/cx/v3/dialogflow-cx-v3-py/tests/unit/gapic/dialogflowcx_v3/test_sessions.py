...
from google.cloud.dialogflowcx_v3.services.sessions.transports.base import _API_CORE_VERSION
from google.cloud.dialogflowcx_v3.services.sessions.transports.base import _GOOGLE_AUTH_VERSION
...
def test_sessions_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3.services.sessions.transports.SessionsGrpcTransport.__init__') as grpc_transport:
...
def test_detect_intent(transport: str = 'grpc', request_type=session.DetectIntentRequest):
    client = SessionsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_detect_intent_async(transport: str = 'grpc_asyncio', request_type=session.DetectIntentRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(session.DetectIntentResponse(
            response_id='response_id_value',
            output_audio=b'output_audio_blob',
        ))
...
def test_match_intent(transport: str = 'grpc', request_type=session.MatchIntentRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.match_intent),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_match_intent_async(transport: str = 'grpc_asyncio', request_type=session.MatchIntentRequest):
    client = SessionsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(session.MatchIntentResponse(
        ))
...
def test_fulfill_intent(transport: str = 'grpc', request_type=session.FulfillIntentRequest):
    client = SessionsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fulfill_intent),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_fulfill_intent_async(transport: str = 'grpc_asyncio', request_type=session.FulfillIntentRequest):
    client = SessionsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(session.FulfillIntentResponse(
            response_id='response_id_value',
            output_audio=b'output_audio_blob',
        ))
...
def test_sessions_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3.services.sessions.transports.SessionsTransport.__init__') as Transport:
...
def test_sessions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.sessions.transports.SessionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_sessions_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.sessions.transports.SessionsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.SessionsTransport()
        adc.assert_called_once()
...
def test_session_path():
    ...
    agent = "squid"
    session = "clam"
    expected = "projects/{project}/locations/{location}/agents/{agent}/sessions/{session}".format(project=project, location=location, agent=agent, session=session, )
...
def test_session_entity_type_path():
    ...
    actual = SessionsClient.session_entity_type_path(project, location, agent, session, entity_type)
    assert expected == actual
...
def test_transition_route_group_path():
    ...
    actual = SessionsClient.transition_route_group_path(project, location, agent, flow, transition_route_group)
    assert expected == actual
