...
from google.cloud.dialogflowcx_v3.services.entity_types import EntityTypesAsyncClient
...
from google.cloud.dialogflowcx_v3.services.entity_types.transports.base import _API_CORE_VERSION
from google.cloud.dialogflowcx_v3.services.entity_types.transports.base import _GOOGLE_AUTH_VERSION
...
def test_entity_types_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3.services.entity_types.transports.EntityTypesGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_create_entity_type_async(transport: str = 'grpc_asyncio', request_type=gcdc_entity_type.CreateEntityTypeRequest):
    client = EntityTypesAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gcdc_entity_type.EntityType(
            name='name_value',
            display_name='display_name_value',
            kind=gcdc_entity_type.EntityType.Kind.KIND_MAP,
            auto_expansion_mode=gcdc_entity_type.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_DEFAULT,
...
@pytest.mark.asyncio
async def test_update_entity_type_async(transport: str = 'grpc_asyncio', request_type=gcdc_entity_type.UpdateEntityTypeRequest):
    client = EntityTypesAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_entity_types_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3.services.entity_types.transports.EntityTypesTransport.__init__') as Transport:
...
def test_entity_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.entity_types.transports.EntityTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_entity_types_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.entity_types.transports.EntityTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.EntityTypesTransport()
        adc.assert_called_once()
