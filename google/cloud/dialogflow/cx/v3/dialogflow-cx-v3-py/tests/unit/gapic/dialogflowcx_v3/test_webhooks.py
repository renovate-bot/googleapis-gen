...
from google.cloud.dialogflowcx_v3.services.webhooks.transports.base import _API_CORE_VERSION
from google.cloud.dialogflowcx_v3.services.webhooks.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert WebhooksClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert WebhooksClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert WebhooksClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test_webhooks_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_webhooks_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_webhooks_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_webhooks_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3.services.webhooks.transports.WebhooksGrpcTransport.__init__') as grpc_transport:
...
def test_list_webhooks(transport: str = 'grpc', request_type=webhook.ListWebhooksRequest):
    client = WebhooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_webhooks_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, webhook.Webhook)
                   for i in results)
...
def test_update_webhook(transport: str = 'grpc', request_type=gcdc_webhook.UpdateWebhookRequest):
    client = WebhooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_webhook(transport: str = 'grpc', request_type=webhook.DeleteWebhookRequest):
    client = WebhooksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_webhooks_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3.services.webhooks.transports.WebhooksTransport.__init__') as Transport:
...
def test_webhooks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflowcx_v3.services.webhooks.transports.WebhooksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_webhooks_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflowcx_v3.services.webhooks.transports.WebhooksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.WebhooksTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.WebhooksGrpcTransport, transports.WebhooksGrpcAsyncIOTransport])
def test_webhooks_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.WebhooksGrpcTransport, transports.WebhooksGrpcAsyncIOTransport])
def test_webhooks_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.WebhooksTransport, '_prep_wrapped_messages') as prep:
        client = WebhooksClient(
            credentials=ga_credentials.AnonymousCredentials(),
