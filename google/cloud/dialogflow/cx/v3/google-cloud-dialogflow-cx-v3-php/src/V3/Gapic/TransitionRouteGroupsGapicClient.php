...
class TransitionRouteGroupsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3.TransitionRouteGroups';
     ...
     * ```
     *
     * @param string               $parent               Required. The flow to create an [TransitionRouteGroup][google.cloud.dialogflow.cx.v3.TransitionRouteGroup] for.
     *                                                   Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
     *                                                   ID>/flows/<Flow ID>`.
     ...
     * ```
     *
     * @param string $name         Required. The name of the [TransitionRouteGroup][google.cloud.dialogflow.cx.v3.TransitionRouteGroup] to delete.
     *                             Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
     *                             ID>/flows/<Flow ID>/transitionRouteGroups/<Transition Route Group ID>`.
     * @param array  $optionalArgs {
     *                             Optional.
