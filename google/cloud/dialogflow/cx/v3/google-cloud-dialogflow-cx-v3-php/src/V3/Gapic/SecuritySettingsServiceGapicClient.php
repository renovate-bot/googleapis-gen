 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/dialogflow/cx/v3/security_settings.proto
...
use Google\Cloud\Dialogflow\Cx\V3\ListSecuritySettingsResponse;
...
class SecuritySettingsServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3.SecuritySettingsService';
     ...
     * ```
     *
     * @param string           $parent           Required. The location to create an [SecuritySettings][google.cloud.dialogflow.cx.v3.SecuritySettings] for.
    ...
    public function updateSecuritySettings($securitySettings, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor([
          'security_settings.name' => $request->getSecuritySettings()->getName(),
        ]);
        $optionalArgs['headers'] = isset($optionalArgs['headers'])
            ? array_merge($requestParams->getHeader(), $optionalArgs['headers'])
            : $requestParams->getHeader();
    ...
    public function listSecuritySettings($parent, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse(
            ...
            $optionalArgs,
            ListSecuritySettingsResponse::class,
            $request
        );
    }
     ...
     * ```
     *
     * @param string $name         Required. The name of the [SecuritySettings][google.cloud.dialogflow.cx.v3.SecuritySettings] to delete.
     *                             Format: `projects/<Project ID>/locations/<Location
     *                             ID>/securitySettings/<Security Settings ID>`.
     * @param array  $optionalArgs {
     *                             Optional.
