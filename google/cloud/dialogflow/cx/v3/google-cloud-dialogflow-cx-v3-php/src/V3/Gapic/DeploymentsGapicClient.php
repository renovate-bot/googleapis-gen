 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/dialogflow/cx/v3/deployment.proto
...
class DeploymentsGapicClient
{
     ...
     * ```
     *
     * @param string $name         Required. The name of the [Deployment][google.cloud.dialogflow.cx.v3.Deployment].
