 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.ListExperimentsRequest</code>
 */
class ListExperimentsRequest extends \Google\Protobuf\Internal\Message
{
    /**
