 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.ValidateAgentRequest</code>
 */
class ValidateAgentRequest extends \Google\Protobuf\Internal\Message
{
    /**
