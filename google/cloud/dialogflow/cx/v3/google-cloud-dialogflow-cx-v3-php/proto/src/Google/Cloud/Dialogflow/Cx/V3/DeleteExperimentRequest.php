 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.DeleteExperimentRequest</code>
 */
class DeleteExperimentRequest extends \Google\Protobuf\Internal\Message
{
    /**
