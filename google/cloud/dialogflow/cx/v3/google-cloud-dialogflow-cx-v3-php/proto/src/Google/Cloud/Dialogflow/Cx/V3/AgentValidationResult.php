...
class AgentValidationResult extends \Google\Protobuf\Internal\Message
{
     ...
     *           Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
     *           ID>/validationResult`.
     *     @type \Google\Cloud\Dialogflow\Cx\V3\FlowValidationResult[]|\Google\Protobuf\Internal\RepeatedField $flow_validation_results
     *           Contains all flow validation results.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.FlowValidationResult flow_validation_results = 2;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\FlowValidationResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
