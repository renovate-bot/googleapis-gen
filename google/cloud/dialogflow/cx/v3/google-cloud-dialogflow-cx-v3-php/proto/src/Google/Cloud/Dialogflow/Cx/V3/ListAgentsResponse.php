...
class ListAgentsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Dialogflow\Cx\V3\Agent[]|\Google\Protobuf\Internal\RepeatedField $agents
     *           The list of agents. There will be a maximum number of items returned based
     *           on the page_size field in the request.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.Agent agents = 1;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\Agent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
