...
class VirtualAgentOutput extends \Google\Protobuf\Internal\Message
{
     ...
     *           The session parameters available to the bot at this point.
     *     @type \Google\Cloud\Dialogflow\Cx\V3\TestRunDifference[]|\Google\Protobuf\Internal\RepeatedField $differences
     *           Output only. If this is part of a [result conversation
     *           turn][TestCaseResult.conversation_turns], the list of differences
     *           between the original run and the replay for this output, if any.
     ...
     *           The [Page][google.cloud.dialogflow.cx.v3.Page] on which the utterance was spoken. Only name and displayName
     *           will be set.
     *     @type \Google\Cloud\Dialogflow\Cx\V3\ResponseMessage\Text[]|\Google\Protobuf\Internal\RepeatedField $text_responses
     *           The [text][google.cloud.dialogflow.cx.v3.ResponseMessage.Text] responses from the agent for the turn.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.TestRunDifference differences = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\TestRunDifference[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.ResponseMessage.Text text_responses = 9;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\ResponseMessage\Text[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
...
class_alias(VirtualAgentOutput::class, \Google\Cloud\Dialogflow\Cx\V3\ConversationTurn_VirtualAgentOutput::class);
