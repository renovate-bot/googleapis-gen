...
class Coverage extends \Google\Protobuf\Internal\Message
{
     ...
     *           Transition route group metadata. Only name and displayName will be set.
     *     @type \Google\Cloud\Dialogflow\Cx\V3\TransitionRouteGroupCoverage\Coverage\Transition[]|\Google\Protobuf\Internal\RepeatedField $transitions
     *           The list of transition routes and coverage in the transition route group.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.TransitionRouteGroupCoverage.Coverage.Transition transitions = 2;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\TransitionRouteGroupCoverage\Coverage\Transition[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
