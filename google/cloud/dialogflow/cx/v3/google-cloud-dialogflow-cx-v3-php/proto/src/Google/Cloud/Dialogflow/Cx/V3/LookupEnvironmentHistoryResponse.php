...
class LookupEnvironmentHistoryResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Dialogflow\Cx\V3\Environment[]|\Google\Protobuf\Internal\RepeatedField $environments
     *           Represents a list of snapshots for an environment. Time of the snapshots is
     *           stored in [`update_time`][google.cloud.dialogflow.cx.v3.Environment.update_time].
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.Environment environments = 1;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\Environment[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
