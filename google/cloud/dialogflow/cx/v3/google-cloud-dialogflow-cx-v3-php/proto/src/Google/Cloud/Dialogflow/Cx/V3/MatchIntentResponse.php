...
class MatchIntentResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.Match matches = 4;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\Match[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMatches($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3\Match::class);
        $this->matches = $arr;
