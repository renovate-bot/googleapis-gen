...
class MatchIntentResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Google\Cloud\Dialogflow\Cx\V3\PBMatch[]|\Google\Protobuf\Internal\RepeatedField $matches
     *           Match results, if more than one, ordered descendingly by the confidence
     *           we have that the particular intent matches the query.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.Match matches = 4;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\PBMatch[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
