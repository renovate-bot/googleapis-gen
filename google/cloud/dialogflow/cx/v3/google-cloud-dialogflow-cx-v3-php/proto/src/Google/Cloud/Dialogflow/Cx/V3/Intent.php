...
class Intent extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The human-readable name of the intent, unique within the agent.
     *     @type \Google\Cloud\Dialogflow\Cx\V3\Intent\TrainingPhrase[]|\Google\Protobuf\Internal\RepeatedField $training_phrases
     *           The collection of training phrases the agent is trained on to identify the
     *           intent.
     *     @type \Google\Cloud\Dialogflow\Cx\V3\Intent\Parameter[]|\Google\Protobuf\Internal\RepeatedField $parameters
     *           The collection of parameters associated with the intent.
     *     @type int $priority
     *           The priority of this intent. Higher numbers represent higher
     *           priorities.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.Intent.TrainingPhrase training_phrases = 3;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\Intent\TrainingPhrase[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.Intent.Parameter parameters = 4;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\Intent\Parameter[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
