...
class BatchRunTestCasesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Dialogflow\Cx\V3\TestCaseResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           The test case results. The detailed
     *           [conversation turns][google.cloud.dialogflow.cx.v3.TestCaseResult.conversation_turns] are empty in this
     *           response.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3.TestCaseResult results = 1;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\TestCaseResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
