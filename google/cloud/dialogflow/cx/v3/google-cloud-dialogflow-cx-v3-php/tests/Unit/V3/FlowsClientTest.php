...
class FlowsClientTest extends GeneratedTest
{
    ...
    public function deleteFlowTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->flowName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]');
        $client->deleteFlow($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function exportFlowTest()
    {
        ...
        // Mock request
        $formattedName = $client->flowName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]');
        $response = $client->exportFlow($formattedName);
    ...
    public function getFlowTest()
    {
        ...
        // Mock request
        $formattedName = $client->flowName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]');
        $response = $client->getFlow($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getFlowValidationResultTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->flowValidationResultName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]');
        $response = $client->getFlowValidationResult($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getFlowValidationResultExceptionTest()
    {
        ...
        $formattedName = $client->flowValidationResultName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]');
        try {
            $client->getFlowValidationResult($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function importFlowTest()
    {
        ...
        // Mock request
        $formattedParent = $client->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        $response = $client->importFlow($formattedParent);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function listFlowsTest()
    {
        ...
        // Mock request
        $formattedParent = $client->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        $response = $client->listFlows($formattedParent);
    ...
    public function listFlowsExceptionTest()
    {
        ...
        $formattedParent = $client->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        try {
            $client->listFlows($formattedParent);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function trainFlowTest()
    {
        ...
        // Mock request
        $formattedName = $client->flowName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]');
        $response = $client->trainFlow($formattedName);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function validateFlowTest()
    {
        ...
        // Mock request
        $formattedName = $client->flowName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]');
        $response = $client->validateFlow($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function validateFlowExceptionTest()
    {
        ...
        $formattedName = $client->flowName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]');
        try {
            $client->validateFlow($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
