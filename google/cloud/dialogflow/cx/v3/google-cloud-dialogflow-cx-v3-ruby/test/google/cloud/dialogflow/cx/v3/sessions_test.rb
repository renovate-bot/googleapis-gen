...
class ::Google::Cloud::Dialogflow::Cx::V3::Sessions::ClientTest < Minitest::Test
  ...
  def test_streaming_detect_intent
    ...
    Gapic::ServiceStub.stub :new, streaming_detect_intent_client_stub do
      ...
      request_proto = ::Google::Cloud::Dialogflow::Cx::V3::StreamingDetectIntentRequest.new session: session, query_params: query_params, query_input: query_input, output_audio_config: output_audio_config
