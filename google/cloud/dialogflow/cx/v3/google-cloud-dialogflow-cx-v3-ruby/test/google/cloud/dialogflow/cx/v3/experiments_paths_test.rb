...
class ::Google::Cloud::Dialogflow::Cx::V3::Experiments::ClientPathsTest < Minitest::Test
  ...
  def test_experiment_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.experiment_path project: "value0", location: "value1", agent: "value2", environment: "value3", experiment: "value4"
      assert_equal "projects/value0/locations/value1/agents/value2/environments/value3/experiments/value4", path
    end
  end
