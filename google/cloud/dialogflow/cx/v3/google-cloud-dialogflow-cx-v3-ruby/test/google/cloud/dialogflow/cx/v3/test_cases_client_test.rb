...
describe Google::Cloud::Dialogflow::Cx::V3::TestCasesClient do
  ...
  describe 'get_test_case_result' do
    custom_error = CustomTestError_v3.new "Custom test error for Google::Cloud::Dialogflow::Cx::V3::TestCasesClient#get_test_case_result."
    ...
    it 'invokes get_test_case_result without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::Cx::V3::TestCaseResult)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::Cx::V3::GetTestCaseResultRequest, request)
        assert_equal(formatted_name, request.name)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v3.new(:get_test_case_result, mock_method)

      # Mock auth layer
      mock_credentials = MockTestCasesCredentials_v3.new("get_test_case_result")
