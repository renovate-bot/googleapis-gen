    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3::Sessions::Stub]
          class SessionsClient
            ...
            def initialize \
              ...
              @sessions_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3::Sessions::Stub.method(:new)
              )
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::QueryInput`
            #   can also be provided.
            # @param query_params [Google::Cloud::Dialogflow::Cx::V3::QueryParameters | Hash]
            #   The parameters of this query.
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::QueryParameters`
            #   can also be provided.
            # @param output_audio_config [Google::Cloud::Dialogflow::Cx::V3::OutputAudioConfig | Hash]
            #   Instructs the speech synthesizer how to generate the output audio.
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::OutputAudioConfig`
            #   can also be provided.
            ...
            #
            #   sessions_client = Google::Cloud::Dialogflow::Cx::Sessions.new(version: :v3)
            #
            ...
            def detect_intent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::DetectIntentRequest)
            ...
            # environments](https://cloud.google.com/dialogflow/cx/docs/concept/version).
            #
            # @param reqs [Enumerable<Google::Cloud::Dialogflow::Cx::V3::StreamingDetectIntentRequest>]
            #   The input requests.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @return [Enumerable<Google::Cloud::Dialogflow::Cx::V3::StreamingDetectIntentResponse>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3::StreamingDetectIntentResponse instances.
            #
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            #
            # @note
            ...
            def streaming_detect_intent reqs, options: nil
              request_protos = reqs.lazy.map do |req|
                Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::StreamingDetectIntentRequest)
              end
            ...
            def match_intent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::MatchIntentRequest)
              @match_intent.call(req, options, &block)
            end

            # Fulfills a matched intent returned by {Google::Cloud::Dialogflow::Cx::V3::Sessions::MatchIntent MatchIntent}.
            # Must be called after {Google::Cloud::Dialogflow::Cx::V3::Sessions::MatchIntent MatchIntent}, with input from
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::MatchIntentRequest`
            #   can also be provided.
            # @param match [Google::Cloud::Dialogflow::Cx::V3::Match | Hash]
            #   The matched intent/event to fulfill.
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::Match`
            #   can also be provided.
            # @param output_audio_config [Google::Cloud::Dialogflow::Cx::V3::OutputAudioConfig | Hash]
            ...
            def fulfill_intent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::FulfillIntentRequest)
