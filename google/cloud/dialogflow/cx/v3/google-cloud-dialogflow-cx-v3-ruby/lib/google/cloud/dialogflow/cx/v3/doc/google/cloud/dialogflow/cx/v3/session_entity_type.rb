        ...
        module V3
          ...
          class SessionEntityType
            ...
            module EntityOverrideMode
              ...
              # please call {Google::Cloud::Dialogflow::Cx::V3::EntityTypes::GetEntityType EntityTypes::GetEntityType} on the custom entity type
              # and merge.
              ENTITY_OVERRIDE_MODE_SUPPLEMENT = 2
            end
          end

          # The request message for {Google::Cloud::Dialogflow::Cx::V3::SessionEntityTypes::ListSessionEntityTypes SessionEntityTypes::ListSessionEntityTypes}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The response message for {Google::Cloud::Dialogflow::Cx::V3::SessionEntityTypes::ListSessionEntityTypes SessionEntityTypes::ListSessionEntityTypes}.
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::SessionEntityTypes::GetSessionEntityType SessionEntityTypes::GetSessionEntityType}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::SessionEntityTypes::CreateSessionEntityType SessionEntityTypes::CreateSessionEntityType}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::SessionEntityTypes::UpdateSessionEntityType SessionEntityTypes::UpdateSessionEntityType}.
          # @!attribute [rw] session_entity_type
          #   @return [Google::Cloud::Dialogflow::Cx::V3::SessionEntityType]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::SessionEntityTypes::DeleteSessionEntityType SessionEntityTypes::DeleteSessionEntityType}.
          # @!attribute [rw] name
          #   @return [String]
