    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #     Required for the {Google::Cloud::Dialogflow::Cx::V3::Agents::UpdateAgent Agents::UpdateAgent} method. {Google::Cloud::Dialogflow::Cx::V3::Agents::CreateAgent Agents::CreateAgent}
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Agents::ListAgents Agents::ListAgents}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The response message for {Google::Cloud::Dialogflow::Cx::V3::Agents::ListAgents Agents::ListAgents}.
          # @!attribute [rw] agents
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Agents::GetAgent Agents::GetAgent}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Agents::CreateAgent Agents::CreateAgent}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Agents::UpdateAgent Agents::UpdateAgent}.
          # @!attribute [rw] agent
          #   @return [Google::Cloud::Dialogflow::Cx::V3::Agent]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Agents::DeleteAgent Agents::DeleteAgent}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Agents::ExportAgent Agents::ExportAgent}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The response message for {Google::Cloud::Dialogflow::Cx::V3::Agents::ExportAgent Agents::ExportAgent}.
          # @!attribute [rw] agent_uri
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Agents::RestoreAgent Agents::RestoreAgent}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Agents::GetAgentValidationResult Agents::GetAgentValidationResult}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The response message for {Google::Cloud::Dialogflow::Cx::V3::Agents::GetAgentValidationResult Agents::GetAgentValidationResult}.
          # @!attribute [rw] name
          #   @return [String]
