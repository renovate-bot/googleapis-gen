    ...
    module Dialogflow
      module Cx
        module V3
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Environments::ListEnvironments Environments::ListEnvironments}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The response message for {Google::Cloud::Dialogflow::Cx::V3::Environments::ListEnvironments Environments::ListEnvironments}.
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Environments::GetEnvironment Environments::GetEnvironment}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Environments::CreateEnvironment Environments::CreateEnvironment}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Environments::UpdateEnvironment Environments::UpdateEnvironment}.
          # @!attribute [rw] environment
          #   @return [Google::Cloud::Dialogflow::Cx::V3::Environment]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Environments::DeleteEnvironment Environments::DeleteEnvironment}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Environments::LookupEnvironmentHistory Environments::LookupEnvironmentHistory}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The response message for {Google::Cloud::Dialogflow::Cx::V3::Environments::LookupEnvironmentHistory Environments::LookupEnvironmentHistory}.
          # @!attribute [rw] environments
          #   @return [Array<Google::Cloud::Dialogflow::Cx::V3::Environment>]
