    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #     Required for the {Google::Cloud::Dialogflow::Cx::V3::Pages::UpdatePage Pages::UpdatePage} method. {Google::Cloud::Dialogflow::Cx::V3::Pages::CreatePage Pages::CreatePage}
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Pages::ListPages Pages::ListPages}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The response message for {Google::Cloud::Dialogflow::Cx::V3::Pages::ListPages Pages::ListPages}.
          # @!attribute [rw] pages
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Pages::GetPage Pages::GetPage}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Pages::CreatePage Pages::CreatePage}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Pages::UpdatePage Pages::UpdatePage}.
          # @!attribute [rw] page
          #   @return [Google::Cloud::Dialogflow::Cx::V3::Page]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Pages::DeletePage Pages::DeletePage}.
          # @!attribute [rw] name
          #   @return [String]
