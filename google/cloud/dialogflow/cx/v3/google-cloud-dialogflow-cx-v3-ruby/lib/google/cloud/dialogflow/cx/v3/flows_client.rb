    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3::Flows::Stub]
          class FlowsClient
            ...
            def initialize \
              ...
              @flows_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3::Flows::Stub.method(:new)
              )
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::Flow`
            ...
            #
            #   flows_client = Google::Cloud::Dialogflow::Cx::Flows.new(version: :v3)
            ...
            def create_flow \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::CreateFlowRequest)
            ...
            def delete_flow \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::DeleteFlowRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::Flow>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::Flow>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3::Flow instances.
            ...
            def list_flows \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::ListFlowsRequest)
            ...
            def get_flow \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::GetFlowRequest)
            ...
            def update_flow \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::UpdateFlowRequest)
            ...
            def train_flow \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::TrainFlowRequest)
            ...
            def validate_flow \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::ValidateFlowRequest)
            ...
            def get_flow_validation_result \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::GetFlowValidationResultRequest)
