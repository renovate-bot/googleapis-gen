    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3::SessionEntityTypes::Stub]
          class SessionEntityTypesClient
            ...
            def initialize \
              ...
              @session_entity_types_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3::SessionEntityTypes::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::SessionEntityType>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::SessionEntityType>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3::SessionEntityType instances.
            ...
            #
            #   session_entity_types_client = Google::Cloud::Dialogflow::Cx::SessionEntityTypes.new(version: :v3)
            #
            ...
            def list_session_entity_types \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::ListSessionEntityTypesRequest)
            ...
            def get_session_entity_type \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::GetSessionEntityTypeRequest)
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::SessionEntityType`
            ...
            def create_session_entity_type \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::CreateSessionEntityTypeRequest)
            ...
            def update_session_entity_type \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::UpdateSessionEntityTypeRequest)
            ...
            def delete_session_entity_type \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::DeleteSessionEntityTypeRequest)
