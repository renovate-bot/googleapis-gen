    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3::EntityTypes::Stub]
          class EntityTypesClient
            ...
            def initialize \
              ...
              @entity_types_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3::EntityTypes::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::EntityType>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::EntityType>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3::EntityType instances.
            ...
            #
            #   entity_types_client = Google::Cloud::Dialogflow::Cx::EntityTypes.new(version: :v3)
            ...
            def list_entity_types \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::ListEntityTypesRequest)
            ...
            def get_entity_type \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::GetEntityTypeRequest)
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::EntityType`
            ...
            def create_entity_type \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::CreateEntityTypeRequest)
            ...
            def update_entity_type \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::UpdateEntityTypeRequest)
            ...
            def delete_entity_type \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::DeleteEntityTypeRequest)
