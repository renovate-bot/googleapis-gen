        ...
        module V3
          module TransitionRouteGroups
            ...
            class Client
              ...
              # ## Example
              #
              # To modify the configuration for all TransitionRouteGroups clients:
              #
              ...
              # ## Examples
              #
              # To create a new TransitionRouteGroups client with the default
              # configuration:
              #
              #     client = ::Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroups::Client.new
              #
              # To create a new TransitionRouteGroups client with a custom
              # configuration:
              #
              ...
              # # Examples
              #
              # To modify the global config, setting the timeout for list_transition_route_groups
