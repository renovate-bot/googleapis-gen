    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroups::Stub]
          class TransitionRouteGroupsClient
            ...
            def initialize \
              ...
              @transition_route_groups_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroups::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroup>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroup>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroup instances.
            ...
            #
            #   transition_route_groups_client = Google::Cloud::Dialogflow::Cx::TransitionRouteGroups.new(version: :v3)
            ...
            def list_transition_route_groups \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::ListTransitionRouteGroupsRequest)
            ...
            def get_transition_route_group \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::GetTransitionRouteGroupRequest)
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroup`
            ...
            def create_transition_route_group \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::CreateTransitionRouteGroupRequest)
            ...
            def update_transition_route_group \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::UpdateTransitionRouteGroupRequest)
            ...
            def delete_transition_route_group \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::DeleteTransitionRouteGroupRequest)
