    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3::Intents::Stub]
          class IntentsClient
            ...
            def initialize \
              ...
              @intents_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3::Intents::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::Intent>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::Intent>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3::Intent instances.
            ...
            #
            #   intents_client = Google::Cloud::Dialogflow::Cx::Intents.new(version: :v3)
            ...
            def list_intents \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::ListIntentsRequest)
            ...
            def get_intent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::GetIntentRequest)
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::Intent`
            ...
            def create_intent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::CreateIntentRequest)
            ...
            def update_intent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::UpdateIntentRequest)
            ...
            def delete_intent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::DeleteIntentRequest)
