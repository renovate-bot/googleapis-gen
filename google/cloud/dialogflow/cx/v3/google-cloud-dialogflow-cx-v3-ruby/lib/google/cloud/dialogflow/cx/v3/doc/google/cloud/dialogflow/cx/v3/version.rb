    ...
    module Dialogflow
      module Cx
        module V3
          ...
          # {Google::Cloud::Dialogflow::Cx::V3::Versions::CreateVersion Versions::CreateVersion}.
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Versions::ListVersions Versions::ListVersions}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The response message for {Google::Cloud::Dialogflow::Cx::V3::Versions::ListVersions Versions::ListVersions}.
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Versions::GetVersion Versions::GetVersion}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Versions::CreateVersion Versions::CreateVersion}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Versions::UpdateVersion Versions::UpdateVersion}.
          # @!attribute [rw] version
          #   @return [Google::Cloud::Dialogflow::Cx::V3::Version]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Versions::DeleteVersion Versions::DeleteVersion}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::Versions::LoadVersion Versions::LoadVersion}.
          # @!attribute [rw] name
          #   @return [String]
