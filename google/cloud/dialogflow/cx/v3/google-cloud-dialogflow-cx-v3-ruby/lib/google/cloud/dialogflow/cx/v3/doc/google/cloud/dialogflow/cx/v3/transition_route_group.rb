    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #     {Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroups::CreateTransitionRouteGroup TransitionRouteGroups::CreateTransitionRouteGroup} populates the name
          #     automatically.
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroups::ListTransitionRouteGroups TransitionRouteGroups::ListTransitionRouteGroups}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The response message for {Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroups::ListTransitionRouteGroups TransitionRouteGroups::ListTransitionRouteGroups}.
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroups::GetTransitionRouteGroup TransitionRouteGroups::GetTransitionRouteGroup}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroups::CreateTransitionRouteGroup TransitionRouteGroups::CreateTransitionRouteGroup}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroups::UpdateTransitionRouteGroup TransitionRouteGroups::UpdateTransitionRouteGroup}.
          # @!attribute [rw] transition_route_group
          #   @return [Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroup]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3::TransitionRouteGroups::DeleteTransitionRouteGroup TransitionRouteGroups::DeleteTransitionRouteGroup}.
          # @!attribute [rw] name
          #   @return [String]
