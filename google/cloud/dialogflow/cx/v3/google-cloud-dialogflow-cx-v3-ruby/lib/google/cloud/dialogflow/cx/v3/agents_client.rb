    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3::Agents::Stub]
          class AgentsClient
            ...
            def initialize \
              ...
              @agents_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3::Agents::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::Agent>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::Agent>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3::Agent instances.
            ...
            #
            #   agents_client = Google::Cloud::Dialogflow::Cx::Agents.new(version: :v3)
            ...
            def list_agents \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::ListAgentsRequest)
            ...
            def get_agent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::GetAgentRequest)
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::Agent`
            ...
            def create_agent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::CreateAgentRequest)
            ...
            def update_agent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::UpdateAgentRequest)
            ...
            def delete_agent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::DeleteAgentRequest)
            ...
            def export_agent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::ExportAgentRequest)
            ...
            def restore_agent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::RestoreAgentRequest)
              operation = Google::Gax::Operation.new(
            ...
            def validate_agent \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::ValidateAgentRequest)
            ...
            def get_agent_validation_result \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::GetAgentValidationResultRequest)
