    ...
    module Dialogflow
      module Cx
        module V3
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3::SecuritySettingsService::Stub]
          class SecuritySettingsServiceClient
            ...
            def initialize \
              ...
              @security_settings_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3::SecuritySettingsService::Stub.method(:new)
              )
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3::SecuritySettings`
            ...
            #
            #   security_settings_client = Google::Cloud::Dialogflow::Cx::SecuritySettings.new(version: :v3)
            #   formatted_parent = Google::Cloud::Dialogflow::Cx::V3::SecuritySettingsServiceClient.location_path("[PROJECT]", "[LOCATION]")
            #
            ...
            def create_security_settings \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::CreateSecuritySettingsRequest)
            ...
            #
            #   security_settings_client = Google::Cloud::Dialogflow::Cx::SecuritySettings.new(version: :v3)
            #   formatted_name = Google::Cloud::Dialogflow::Cx::V3::SecuritySettingsServiceClient.security_settings_path("[PROJECT]", "[LOCATION]", "[SECURITY_SETTINGS]")
            ...
            def get_security_settings \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::GetSecuritySettingsRequest)
            ...
            def update_security_settings \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::UpdateSecuritySettingsRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::SecuritySettings>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3::SecuritySettings>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3::SecuritySettings instances.
            ...
            def list_security_settings \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::ListSecuritySettingsRequest)
            ...
            def delete_security_settings \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3::DeleteSecuritySettingsRequest)
