...
using gcdcv = Google.Cloud.Dialogflow.Cx.V3Beta1;
using sys = System;
...
namespace Google.Cloud.Dialogflow.Cx.V3Beta1
{
    ...
    public sealed partial class EntityTypeName : gax::IResourceName, sys::IEquatable<EntityTypeName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/locations/{location}/agents/{agent}/entityTypes/{entity_type}</c>.
            /// </summary>
            ProjectLocationAgentEntityType = 1,
        }

        private static gax::PathTemplate s_projectLocationAgentEntityType = new gax::PathTemplate("projects/{project}/locations/{location}/agents/{agent}/entityTypes/{entity_type}");
        ...
        public static EntityTypeName FromProjectLocationAgentEntityType(string projectId, string locationId, string agentId, string entityTypeId) =>
            new EntityTypeName(ResourceNameType.ProjectLocationAgentEntityType, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), agentId: gax::GaxPreconditions.CheckNotNullOrEmpty(agentId, nameof(agentId)), entityTypeId: gax::GaxPreconditions.CheckNotNullOrEmpty(entityTypeId, nameof(entityTypeId)));
        ...
        /// <c>projects/{project}/locations/{location}/agents/{agent}/entityTypes/{entity_type}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string agentId, string entityTypeId) =>
            FormatProjectLocationAgentEntityType(projectId, locationId, agentId, entityTypeId);
        ...
        /// <c>projects/{project}/locations/{location}/agents/{agent}/entityTypes/{entity_type}</c>.
        /// </returns>
        public static string FormatProjectLocationAgentEntityType(string projectId, string locationId, string agentId, string entityTypeId) =>
            s_projectLocationAgentEntityType.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(agentId, nameof(agentId)), gax::GaxPreconditions.CheckNotNullOrEmpty(entityTypeId, nameof(entityTypeId)));
        ...
        public static bool TryParse(string entityTypeName, bool allowUnparsed, out EntityTypeName result)
        {
            ...
            if (s_projectLocationAgentEntityType.TryParseName(entityTypeName, out resourceName))
            {
                result = FromProjectLocationAgentEntityType(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private EntityTypeName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string agentId = null, string entityTypeId = null, string locationId = null, string projectId = null)
        {
            Type = type;
        ...
        /// <param name="agentId">The <c>Agent</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="entityTypeId">The <c>EntityType</c> ID. Must not be <c>null</c> or empty.</param>
        public EntityTypeName(string projectId, string locationId, string agentId, string entityTypeId) : this(ResourceNameType.ProjectLocationAgentEntityType, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), agentId: gax::GaxPreconditions.CheckNotNullOrEmpty(agentId, nameof(agentId)), entityTypeId: gax::GaxPreconditions.CheckNotNullOrEmpty(entityTypeId, nameof(entityTypeId)))
        {
        }
        ...
        public override string ToString()
        {
            switch (Type)
            {
                ...
                case ResourceNameType.ProjectLocationAgentEntityType: return s_projectLocationAgentEntityType.Expand(ProjectId, LocationId, AgentId, EntityTypeId);
    ...
    {
        /// <summary>
        /// <see cref="gcdcv::EntityTypeName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcdcv::EntityTypeName EntityTypeName
        {
