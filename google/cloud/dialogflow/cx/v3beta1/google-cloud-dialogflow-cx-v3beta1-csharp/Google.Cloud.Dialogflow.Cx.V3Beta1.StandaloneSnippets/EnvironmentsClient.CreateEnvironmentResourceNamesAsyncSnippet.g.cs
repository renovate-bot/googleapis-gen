...
namespace Google.Cloud.Dialogflow.Cx.V3Beta1.Snippets
{
    ...
    public sealed partial class GeneratedEnvironmentsClientStandaloneSnippets
    {
        ...
        public async Task CreateEnvironmentResourceNamesAsync()
        {
            ...
            // Make the request
            Operation<Environment, Struct> response = await environmentsClient.CreateEnvironmentAsync(parent, environment);
            ...
            Operation<Environment, Struct> retrievedResponse = await environmentsClient.PollOnceCreateEnvironmentAsync(operationName);
