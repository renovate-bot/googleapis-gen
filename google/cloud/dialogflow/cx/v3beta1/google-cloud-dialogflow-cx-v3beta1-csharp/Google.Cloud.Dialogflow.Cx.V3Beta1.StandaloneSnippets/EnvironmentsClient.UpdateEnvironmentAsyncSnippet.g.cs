...
namespace Google.Cloud.Dialogflow.Cx.V3Beta1.Snippets
{
    ...
    public sealed partial class GeneratedEnvironmentsClientStandaloneSnippets
    {
        ...
        public async Task UpdateEnvironmentAsync()
        {
            ...
            // Make the request
            Operation<Environment, Struct> response = await environmentsClient.UpdateEnvironmentAsync(environment, updateMask);

            // Poll until the returned long-running operation is complete
            Operation<Environment, Struct> completedResponse = await response.PollUntilCompletedAsync();
            ...
            Operation<Environment, Struct> retrievedResponse = await environmentsClient.PollOnceUpdateEnvironmentAsync(operationName);
