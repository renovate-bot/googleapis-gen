    ...
    module Dialogflow
      module CX
        module V3beta1
          ...
          #   @return [::Google::Cloud::Dialogflow::CX::V3beta1::DetectIntentResponse::ResponseType]
          #     Response type.
          ...
          # {::Google::Cloud::Dialogflow::CX::V3beta1::Sessions::Client#streaming_detect_intent Sessions.StreamingDetectIntent} method.
          #
          ...
          # {::Google::Cloud::Dialogflow::CX::V3beta1::Sessions::Client#streaming_detect_intent StreamingDetectIntent} method.
          #
          ...
          #     See the {::Google::Cloud::Dialogflow::CX::V3beta1::StreamingRecognitionResult StreamingRecognitionResult} message for details
          ...
          #     These responses set the {::Google::Cloud::Dialogflow::CX::V3beta1::DetectIntentResponse#response_type DetectIntentResponse.response_type} field
          #     to `PARTIAL`.
          #
          # For the final Nth response message, the `detect_intent_response` is fully
          # populated, and {::Google::Cloud::Dialogflow::CX::V3beta1::DetectIntentResponse#response_type DetectIntentResponse.response_type} is set to `FINAL`.
          ...
          #   @return [::String]
          #     The unique identifier of the {::Google::Cloud::Dialogflow::CX::V3beta1::Page page} to override the [current
          ...
          #     In most cases, {::Google::Cloud::Dialogflow::CX::V3beta1::QueryParameters#current_page current_page} and
          #     {::Google::Cloud::Dialogflow::CX::V3beta1::QueryParameters#parameters parameters} should be configured together to
