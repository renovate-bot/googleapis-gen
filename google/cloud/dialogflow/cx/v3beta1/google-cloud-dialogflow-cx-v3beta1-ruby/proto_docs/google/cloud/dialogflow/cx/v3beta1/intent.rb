    ...
    module Dialogflow
      module Cx
        module V3beta1
          ...
          #     Required for the {::Google::Cloud::Dialogflow::Cx::V3beta1::Intents::Client#update_intent Intents.UpdateIntent} method. {::Google::Cloud::Dialogflow::Cx::V3beta1::Intents::Client#create_intent Intents.CreateIntent}
          ...
          # The request message for {::Google::Cloud::Dialogflow::Cx::V3beta1::Intents::Client#list_intents Intents.ListIntents}.
          # @!attribute [rw] parent
          #   @return [::String]
          ...
          # The response message for {::Google::Cloud::Dialogflow::Cx::V3beta1::Intents::Client#list_intents Intents.ListIntents}.
          ...
          # The request message for {::Google::Cloud::Dialogflow::Cx::V3beta1::Intents::Client#get_intent Intents.GetIntent}.
          # @!attribute [rw] name
          #   @return [::String]
          ...
          # The request message for {::Google::Cloud::Dialogflow::Cx::V3beta1::Intents::Client#create_intent Intents.CreateIntent}.
          # @!attribute [rw] parent
          #   @return [::String]
          ...
          # The request message for {::Google::Cloud::Dialogflow::Cx::V3beta1::Intents::Client#update_intent Intents.UpdateIntent}.
          # @!attribute [rw] intent
          #   @return [::Google::Cloud::Dialogflow::Cx::V3beta1::Intent]
          ...
          # The request message for {::Google::Cloud::Dialogflow::Cx::V3beta1::Intents::Client#delete_intent Intents.DeleteIntent}.
          # @!attribute [rw] name
          #   @return [::String]
