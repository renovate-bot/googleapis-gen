    ...
    module Dialogflow
      module CX
        module V3beta1
          ...
          #   @return [::Google::Cloud::Dialogflow::CX::V3beta1::Environment::TestCasesConfig]
          ...
          class Environment
            ...
            #   @return [::Boolean]
            #     Whether to run test cases in {::Google::Cloud::Dialogflow::CX::V3beta1::Environment::TestCasesConfig#test_cases TestCasesConfig.test_cases} periodically.
            #     Default false. If set to true, run once a day.
            # @!attribute [rw] enable_predeployment_run
            #   @return [::Boolean]
            #     Whether to run test cases in {::Google::Cloud::Dialogflow::CX::V3beta1::Environment::TestCasesConfig#test_cases TestCasesConfig.test_cases} before
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#list_environments Environments.ListEnvironments}.
          # @!attribute [rw] parent
          #   @return [::String]
          ...
          # The response message for {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#list_environments Environments.ListEnvironments}.
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#get_environment Environments.GetEnvironment}.
          # @!attribute [rw] name
          #   @return [::String]
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#create_environment Environments.CreateEnvironment}.
          # @!attribute [rw] parent
          #   @return [::String]
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#update_environment Environments.UpdateEnvironment}.
          # @!attribute [rw] environment
          #   @return [::Google::Cloud::Dialogflow::CX::V3beta1::Environment]
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#delete_environment Environments.DeleteEnvironment}.
          # @!attribute [rw] name
          #   @return [::String]
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#lookup_environment_history Environments.LookupEnvironmentHistory}.
          # @!attribute [rw] name
          #   @return [::String]
          ...
          # The response message for {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#lookup_environment_history Environments.LookupEnvironmentHistory}.
          # @!attribute [rw] environments
          #   @return [::Array<::Google::Cloud::Dialogflow::CX::V3beta1::Environment>]
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#deploy_flow Environments.DeployFlow}.
          # @!attribute [rw] environment
          #   @return [::String]
          ...
          # The response message for {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#deploy_flow Environments.DeployFlow}.
          # @!attribute [rw] environment
          #   @return [::Google::Cloud::Dialogflow::CX::V3beta1::Environment]
          ...
          # Metadata returned for the {::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Client#deploy_flow Environments.DeployFlow} long running
          # operation.
