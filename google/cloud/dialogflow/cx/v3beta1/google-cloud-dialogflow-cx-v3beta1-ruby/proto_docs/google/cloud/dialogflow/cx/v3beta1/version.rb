    ...
    module Dialogflow
      module CX
        module V3beta1
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Versions::Client#compare_versions Versions.CompareVersions}.
          ...
          # The response message for {::Google::Cloud::Dialogflow::CX::V3beta1::Versions::Client#compare_versions Versions.CompareVersions}.
