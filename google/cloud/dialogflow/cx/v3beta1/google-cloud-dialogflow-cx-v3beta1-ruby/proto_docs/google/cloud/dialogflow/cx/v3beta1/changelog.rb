...
module Google
  module Cloud
    module Dialogflow
      module CX
        module V3beta1
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Changelogs::Client#list_changelogs Changelogs.ListChangelogs}.
          # @!attribute [rw] parent
          #   @return [::String]
          ...
          # The response message for {::Google::Cloud::Dialogflow::CX::V3beta1::Changelogs::Client#list_changelogs Changelogs.ListChangelogs}.
          # @!attribute [rw] changelogs
          #   @return [::Array<::Google::Cloud::Dialogflow::CX::V3beta1::Changelog>]
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Changelogs::Client#get_changelog Changelogs.GetChangelog}.
          # @!attribute [rw] name
          #   @return [::String]
