...
module Google
  module Cloud
    module Dialogflow
      module CX
        module V3beta1
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::SecuritySettingsService::Client#get_security_settings SecuritySettingsService.GetSecuritySettings}.
          # @!attribute [rw] name
          #   @return [::String]
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::SecuritySettingsService::Client#update_security_settings SecuritySettingsService.UpdateSecuritySettings}.
          ...
          # @!attribute [rw] security_settings
          #   @return [::Array<::Google::Cloud::Dialogflow::CX::V3beta1::SecuritySettings>]
          ...
          #     Required for the {::Google::Cloud::Dialogflow::CX::V3beta1::SecuritySettingsService::Client#update_security_settings SecuritySettingsService.UpdateSecuritySettings} method.
          #     {::Google::Cloud::Dialogflow::CX::V3beta1::SecuritySettingsService::Client#create_security_settings SecuritySettingsService.CreateSecuritySettings} populates the name
          #     automatically.
          #     Format: `projects/<Project ID>/locations/<Location
          #     ID>/securitySettings/<Security Settings ID>`.
          ...
          #   @return [::Google::Cloud::Dialogflow::CX::V3beta1::SecuritySettings::RedactionStrategy]
          #     Strategy that defines how we do redaction.
          # @!attribute [rw] redaction_scope
          #   @return [::Google::Cloud::Dialogflow::CX::V3beta1::SecuritySettings::RedactionScope]
          ...
          #   @return [::Array<::Google::Cloud::Dialogflow::CX::V3beta1::SecuritySettings::PurgeDataType>]
