    ...
    module Dialogflow
      module CX
        module V3beta1
          ...
          #     Required for the {::Google::Cloud::Dialogflow::CX::V3beta1::Pages::Client#update_page Pages.UpdatePage} method. {::Google::Cloud::Dialogflow::CX::V3beta1::Pages::Client#create_page Pages.CreatePage}
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Pages::Client#list_pages Pages.ListPages}.
          # @!attribute [rw] parent
          #   @return [::String]
          ...
          # The response message for {::Google::Cloud::Dialogflow::CX::V3beta1::Pages::Client#list_pages Pages.ListPages}.
          # @!attribute [rw] pages
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Pages::Client#get_page Pages.GetPage}.
          # @!attribute [rw] name
          #   @return [::String]
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Pages::Client#create_page Pages.CreatePage}.
          # @!attribute [rw] parent
          #   @return [::String]
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Pages::Client#update_page Pages.UpdatePage}.
          # @!attribute [rw] page
          #   @return [::Google::Cloud::Dialogflow::CX::V3beta1::Page]
          ...
          # The request message for {::Google::Cloud::Dialogflow::CX::V3beta1::Pages::Client#delete_page Pages.DeletePage}.
          # @!attribute [rw] name
          #   @return [::String]
