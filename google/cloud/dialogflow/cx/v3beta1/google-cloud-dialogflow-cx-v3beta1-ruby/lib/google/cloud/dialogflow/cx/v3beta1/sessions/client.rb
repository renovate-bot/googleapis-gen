      ...
      module CX
        module V3beta1
          module Sessions
            ...
            # and pass it to the {::Google::Cloud::Dialogflow::CX::V3beta1::Sessions::Client#detect_intent DetectIntent} method to determine
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Dialogflow::CX::V3beta1::Sessions::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all Sessions clients
              #   ::Google::Cloud::Dialogflow::CX::V3beta1::Sessions::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @sessions_stub = ::Gapic::ServiceStub.new(
                  ::Google::Cloud::Dialogflow::CX::V3beta1::Sessions::Stub,
              ...
              #   {::Google::Cloud::Dialogflow::CX::V3beta1::DetectIntentRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Dialogflow::CX::V3beta1::DetectIntentRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Cloud::Dialogflow::CX::V3beta1::DetectIntentResponse]
              ...
              def detect_intent request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3beta1::DetectIntentRequest
              ...
              # environments](https://cloud.google.com/dialogflow/cx/docs/concept/version).
              #
              # @param request [::Gapic::StreamInput, ::Enumerable<::Google::Cloud::Dialogflow::CX::V3beta1::StreamingDetectIntentRequest, ::Hash>]
              #   An enumerable of {::Google::Cloud::Dialogflow::CX::V3beta1::StreamingDetectIntentRequest} instances.
              # @param options [::Gapic::CallOptions, ::Hash]
              #   Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Enumerable<::Google::Cloud::Dialogflow::CX::V3beta1::StreamingDetectIntentResponse>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def streaming_detect_intent request, options = nil
                ...
                request = request.lazy.map do |req|
                  ::Gapic::Protobuf.coerce req, to: ::Google::Cloud::Dialogflow::CX::V3beta1::StreamingDetectIntentRequest
                end
              ...
              #   {::Google::Cloud::Dialogflow::CX::V3beta1::MatchIntentRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Dialogflow::CX::V3beta1::MatchIntentRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Cloud::Dialogflow::CX::V3beta1::MatchIntentResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def match_intent request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3beta1::MatchIntentRequest
              ...
              ##
              # Fulfills a matched intent returned by {::Google::Cloud::Dialogflow::CX::V3beta1::Sessions::Client#match_intent MatchIntent}.
              # Must be called after {::Google::Cloud::Dialogflow::CX::V3beta1::Sessions::Client#match_intent MatchIntent}, with input from
              ...
              #   {::Google::Cloud::Dialogflow::CX::V3beta1::FulfillIntentRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Dialogflow::CX::V3beta1::FulfillIntentRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Cloud::Dialogflow::CX::V3beta1::FulfillIntentResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def fulfill_intent request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3beta1::FulfillIntentRequest
              ...
              # {::Google::Cloud::Dialogflow::CX::V3beta1::Sessions::Client::Configuration::Rpcs}
