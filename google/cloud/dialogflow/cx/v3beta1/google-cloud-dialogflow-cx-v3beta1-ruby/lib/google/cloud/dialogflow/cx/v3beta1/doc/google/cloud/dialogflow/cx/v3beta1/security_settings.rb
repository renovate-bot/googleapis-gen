...
module Google
  module Cloud
    module Dialogflow
      module Cx
        module V3beta1
          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::SecuritySettingsService::GetSecuritySettings SecuritySettingsService::GetSecuritySettings}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::SecuritySettingsService::UpdateSecuritySettings SecuritySettingsService::UpdateSecuritySettings}.
