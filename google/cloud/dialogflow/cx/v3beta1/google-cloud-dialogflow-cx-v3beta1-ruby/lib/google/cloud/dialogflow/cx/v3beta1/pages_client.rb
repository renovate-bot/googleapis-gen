    ...
    module Dialogflow
      module Cx
        module V3beta1
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3beta1::Pages::Stub]
          class PagesClient
            ...
            def initialize \
              ...
              @pages_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3beta1::Pages::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3beta1::Page>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3beta1::Page>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3beta1::Page instances.
            ...
            #
            #   pages_client = Google::Cloud::Dialogflow::Cx::Pages.new(version: :v3beta1)
            ...
            def list_pages \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::ListPagesRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Cloud::Dialogflow::Cx::V3beta1::Page]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def get_page \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::GetPageRequest)
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3beta1::Page`
            ...
            def create_page \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::CreatePageRequest)
            ...
            def update_page \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::UpdatePageRequest)
            ...
            def delete_page \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::DeletePageRequest)
