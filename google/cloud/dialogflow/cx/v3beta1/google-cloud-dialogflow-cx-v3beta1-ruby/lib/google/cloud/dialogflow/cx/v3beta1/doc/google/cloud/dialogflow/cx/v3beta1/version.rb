    ...
    module Dialogflow
      module Cx
        module V3beta1
          ...
          # {Google::Cloud::Dialogflow::Cx::V3beta1::Versions::CreateVersion Versions::CreateVersion}.
          # @!attribute [rw] version
          #   @return [String]
          #     Name of the created version.
          #     Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
          #     ID>/flows/<Flow ID>/versions/<Version ID>`.
          class CreateVersionOperationMetadata; end
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::Versions::ListVersions Versions::ListVersions}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          class ListVersionsRequest; end

          # The response message for {Google::Cloud::Dialogflow::Cx::V3beta1::Versions::ListVersions Versions::ListVersions}.
          ...
          #     results in the list.
          class ListVersionsResponse; end

          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::Versions::GetVersion Versions::GetVersion}.
          # @!attribute [rw] name
          #   @return [String]
          #     Required. The name of the {Google::Cloud::Dialogflow::Cx::V3beta1::Version Version}.
          #     Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
          #     ID>/flows/<Flow ID>/versions/<Version ID>`.
          class GetVersionRequest; end

          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::Versions::CreateVersion Versions::CreateVersion}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          class CreateVersionRequest; end

          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::Versions::UpdateVersion Versions::UpdateVersion}.
          # @!attribute [rw] version
          #   @return [Google::Cloud::Dialogflow::Cx::V3beta1::Version]
          ...
          class UpdateVersionRequest; end

          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::Versions::DeleteVersion Versions::DeleteVersion}.
          # @!attribute [rw] name
          #   @return [String]
          #     Required. The name of the {Google::Cloud::Dialogflow::Cx::V3beta1::Version Version} to delete.
          #     Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
          #     ID>/flows/<Flow ID>/versions/<Version ID>`.
          class DeleteVersionRequest; end

          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::Versions::LoadVersion Versions::LoadVersion}.
          # @!attribute [rw] name
          #   @return [String]
