...
require "google/cloud/dialogflow/cx/v3beta1/changelog_pb"
      ...
      module CX
        module V3beta1
          module Changelogs
            ...
            #
            # Service for managing {::Google::Cloud::Dialogflow::CX::V3beta1::Changelog Changelogs}.
            #
            class Client
              include Paths
              ...
              #
              # See {::Google::Cloud::Dialogflow::CX::V3beta1::Changelogs::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all Changelogs clients
              #   ::Google::Cloud::Dialogflow::CX::V3beta1::Changelogs::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Cloud::Dialogflow::CX::V3beta1::Changelogs::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Cloud::Dialogflow::CX::V3beta1::Changelogs::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/cloud/dialogflow/cx/v3beta1/changelog_services_pb"
                ...
                @changelogs_stub = ::Gapic::ServiceStub.new(
                  ::Google::Cloud::Dialogflow::CX::V3beta1::Changelogs::Stub,
              ...
              #   {::Google::Cloud::Dialogflow::CX::V3beta1::ListChangelogsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Dialogflow::CX::V3beta1::ListChangelogsRequest, ::Hash]
              ...
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::CX::V3beta1::Changelog>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::CX::V3beta1::Changelog>]
              #
              ...
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::ListChangelogsRequest.new
              #
              ...
              #     # Each element is of type ::Google::Cloud::Dialogflow::CX::V3beta1::Changelog.
              #     p response
              #   end
              #
              def list_changelogs request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3beta1::ListChangelogsRequest
              ...
              #   {::Google::Cloud::Dialogflow::CX::V3beta1::GetChangelogRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Dialogflow::CX::V3beta1::GetChangelogRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Cloud::Dialogflow::CX::V3beta1::Changelog]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::GetChangelogRequest.new
              #
              #   # Call the get_changelog method.
              #   result = client.get_changelog request
              #
              #   # The returned object is of type Google::Cloud::Dialogflow::CX::V3beta1::Changelog.
              #   p result
              #
              def get_changelog request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3beta1::GetChangelogRequest
              ...
              # {::Google::Cloud::Dialogflow::CX::V3beta1::Changelogs::Client::Configuration::Rpcs}
