...
# https://github.com/googleapis/googleapis/blob/master/google/cloud/dialogflow/cx/v3beta1/experiment.proto,
        ...
        module V3beta1
          ...
          class ExperimentsClient
            ...
            def initialize \
              ...
              require "google/cloud/dialogflow/cx/v3beta1/experiment_services_pb"
              ...
              @experiments_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3beta1::Experiments::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3beta1::Experiment>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3beta1::Experiment>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3beta1::Experiment instances.
            ...
            #
            #   experiments_client = Google::Cloud::Dialogflow::Cx::Experiments.new(version: :v3beta1)
            #   formatted_parent = Google::Cloud::Dialogflow::Cx::V3beta1::ExperimentsClient.environment_path("[PROJECT]", "[LOCATION]", "[AGENT]", "[ENVIRONMENT]")
            #
            ...
            def list_experiments \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::ListExperimentsRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Cloud::Dialogflow::Cx::V3beta1::Experiment]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            #
            #   experiments_client = Google::Cloud::Dialogflow::Cx::Experiments.new(version: :v3beta1)
            #   formatted_name = Google::Cloud::Dialogflow::Cx::V3beta1::ExperimentsClient.experiment_path("[PROJECT]", "[LOCATION]", "[AGENT]", "[ENVIRONMENT]", "[EXPERIMENT]")
            ...
            def get_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::GetExperimentRequest)
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3beta1::Experiment`
            ...
            def create_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::CreateExperimentRequest)
            ...
            def update_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::UpdateExperimentRequest)
            ...
            def delete_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::DeleteExperimentRequest)
            ...
            def start_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::StartExperimentRequest)
            ...
            def stop_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::StopExperimentRequest)
