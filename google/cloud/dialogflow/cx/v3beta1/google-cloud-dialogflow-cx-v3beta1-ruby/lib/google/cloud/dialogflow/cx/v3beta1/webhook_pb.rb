  ...
  add_file("google/cloud/dialogflow/cx/v3beta1/webhook.proto", :syntax => :proto3) do
    add_message "google.cloud.dialogflow.cx.v3beta1.Webhook" do
      ...
      oneof :webhook do
        ...
        optional :service_directory, :message, 7, "google.cloud.dialogflow.cx.v3beta1.Webhook.ServiceDirectoryConfig"
      end
    end
    ...
    add_message "google.cloud.dialogflow.cx.v3beta1.Webhook.ServiceDirectoryConfig" do
      optional :service, :string, 1
      optional :generic_web_service, :message, 2, "google.cloud.dialogflow.cx.v3beta1.Webhook.GenericWebService"
    end
    ...
    module Dialogflow
      module CX
        module V3beta1
          ...
          Webhook::ServiceDirectoryConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.dialogflow.cx.v3beta1.Webhook.ServiceDirectoryConfig").msgclass
