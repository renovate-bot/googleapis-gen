...
# https://github.com/googleapis/googleapis/blob/master/google/cloud/dialogflow/cx/v3beta1/webhook.proto,
    ...
    module Dialogflow
      module Cx
        module V3beta1
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3beta1::Webhooks::Stub]
          class WebhooksClient
            ...
            def initialize \
              ...
              require "google/cloud/dialogflow/cx/v3beta1/webhook_services_pb"
              ...
              @webhooks_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Dialogflow::Cx::V3beta1::Webhooks::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3beta1::Webhook>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::Cx::V3beta1::Webhook>]
            #   An enumerable of Google::Cloud::Dialogflow::Cx::V3beta1::Webhook instances.
            ...
            #
            #   webhooks_client = Google::Cloud::Dialogflow::Cx::Webhooks.new(version: :v3beta1)
            #   formatted_parent = Google::Cloud::Dialogflow::Cx::V3beta1::WebhooksClient.agent_path("[PROJECT]", "[LOCATION]", "[AGENT]")
            #
            ...
            def list_webhooks \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::ListWebhooksRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Cloud::Dialogflow::Cx::V3beta1::Webhook]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            #
            #   webhooks_client = Google::Cloud::Dialogflow::Cx::Webhooks.new(version: :v3beta1)
            #   formatted_name = Google::Cloud::Dialogflow::Cx::V3beta1::WebhooksClient.webhook_path("[PROJECT]", "[LOCATION]", "[AGENT]", "[WEBHOOK]")
            ...
            def get_webhook \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::GetWebhookRequest)
            ...
            #   A hash of the same form as `Google::Cloud::Dialogflow::Cx::V3beta1::Webhook`
            ...
            def create_webhook \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::CreateWebhookRequest)
            ...
            def update_webhook \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::UpdateWebhookRequest)
            ...
            def delete_webhook \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::Cx::V3beta1::DeleteWebhookRequest)
