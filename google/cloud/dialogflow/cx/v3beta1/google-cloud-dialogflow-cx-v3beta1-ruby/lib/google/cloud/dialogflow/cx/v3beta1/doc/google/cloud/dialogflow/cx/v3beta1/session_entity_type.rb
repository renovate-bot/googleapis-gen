    ...
    module Dialogflow
      module Cx
        module V3beta1
          ...
          # replace a {Google::Cloud::Dialogflow::Cx::V3beta1::EntityType custom entity type} at the user session level (we
          ...
          #   @return [Google::Cloud::Dialogflow::Cx::V3beta1::SessionEntityType::EntityOverrideMode]
          ...
          class SessionEntityType
            ...
            module EntityOverrideMode
              ...
              # please call {Google::Cloud::Dialogflow::Cx::V3beta1::EntityTypes::GetEntityType EntityTypes::GetEntityType} on the custom entity type
              # and merge.
              ENTITY_OVERRIDE_MODE_SUPPLEMENT = 2
            end
          end

          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::SessionEntityTypes::ListSessionEntityTypes SessionEntityTypes::ListSessionEntityTypes}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The response message for {Google::Cloud::Dialogflow::Cx::V3beta1::SessionEntityTypes::ListSessionEntityTypes SessionEntityTypes::ListSessionEntityTypes}.
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::SessionEntityTypes::GetSessionEntityType SessionEntityTypes::GetSessionEntityType}.
          # @!attribute [rw] name
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::SessionEntityTypes::CreateSessionEntityType SessionEntityTypes::CreateSessionEntityType}.
          # @!attribute [rw] parent
          #   @return [String]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::SessionEntityTypes::UpdateSessionEntityType SessionEntityTypes::UpdateSessionEntityType}.
          # @!attribute [rw] session_entity_type
          #   @return [Google::Cloud::Dialogflow::Cx::V3beta1::SessionEntityType]
          ...
          # The request message for {Google::Cloud::Dialogflow::Cx::V3beta1::SessionEntityTypes::DeleteSessionEntityType SessionEntityTypes::DeleteSessionEntityType}.
          # @!attribute [rw] name
          #   @return [String]
