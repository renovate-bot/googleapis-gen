        ...
        module V3beta1
          module Experiments
            ...
            class Client
              ...
              # ## Example
              #
              # To modify the configuration for all Experiments clients:
              #
              ...
              # ## Examples
              #
              # To create a new Experiments client with the default
              # configuration:
              #
              #     client = ::Google::Cloud::Dialogflow::Cx::V3beta1::Experiments::Client.new
              #
              # To create a new Experiments client with a custom
              # configuration:
              #
              ...
              # # Examples
              #
              # To modify the global config, setting the timeout for list_experiments
