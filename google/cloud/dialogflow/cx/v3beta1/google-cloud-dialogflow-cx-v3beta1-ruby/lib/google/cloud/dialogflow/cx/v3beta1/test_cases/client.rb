        ...
        module V3beta1
          module TestCases
            ...
            class Client
              ...
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::ListTestCasesRequest.new
              #
              ...
              #     # Each element is of type ::Google::Cloud::Dialogflow::CX::V3beta1::TestCase.
              #     p response
              #   end
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::GetTestCaseRequest.new
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::UpdateTestCaseRequest.new
              #
              ...
              #
              # - `metadata`: {::Google::Cloud::Dialogflow::CX::V3beta1::RunTestCaseMetadata RunTestCaseMetadata}
              # - `response`: {::Google::Cloud::Dialogflow::CX::V3beta1::RunTestCaseResponse RunTestCaseResponse}
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::RunTestCaseRequest.new
              #
              ...
              # The returned `Operation` type has the following method-specific fields:
              #
              # - `metadata`: {::Google::Cloud::Dialogflow::CX::V3beta1::BatchRunTestCasesMetadata BatchRunTestCasesMetadata}
              # - `response`: {::Google::Cloud::Dialogflow::CX::V3beta1::BatchRunTestCasesResponse BatchRunTestCasesResponse}
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::BatchRunTestCasesRequest.new
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::CalculateCoverageRequest.new
              #
              #   # Call the calculate_coverage method.
              #   result = client.calculate_coverage request
              #
              #   # The returned object is of type Google::Cloud::Dialogflow::CX::V3beta1::CalculateCoverageResponse.
              #   p result
              #
              ...
              # The returned `Operation` type has the following method-specific fields:
              #
              # - `metadata`: {::Google::Cloud::Dialogflow::CX::V3beta1::ImportTestCasesMetadata ImportTestCasesMetadata}
              # - `response`: {::Google::Cloud::Dialogflow::CX::V3beta1::ImportTestCasesResponse ImportTestCasesResponse}
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::ImportTestCasesRequest.new
              #
              ...
              # The returned `Operation` type has the following method-specific fields:
              #
              # - `metadata`: {::Google::Cloud::Dialogflow::CX::V3beta1::ExportTestCasesMetadata ExportTestCasesMetadata}
              # - `response`: {::Google::Cloud::Dialogflow::CX::V3beta1::ExportTestCasesResponse ExportTestCasesResponse}
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::ExportTestCasesRequest.new
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::ListTestCaseResultsRequest.new
              #
              ...
              #   # methods are also available for managing paging directly.
              #   result.each do |response|
              #     # Each element is of type ::Google::Cloud::Dialogflow::CX::V3beta1::TestCaseResult.
              #     p response
              #   end
              #
