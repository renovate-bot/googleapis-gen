...
require "google/cloud/dialogflow/cx/v3beta1/deployment_pb"
        ...
        module V3beta1
          module Deployments
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Dialogflow::CX::V3beta1::Deployments::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all Deployments clients
              #   ::Google::Cloud::Dialogflow::CX::V3beta1::Deployments::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/cloud/dialogflow/cx/v3beta1/deployment_services_pb"
                ...
                @deployments_stub = ::Gapic::ServiceStub.new(
                  ::Google::Cloud::Dialogflow::CX::V3beta1::Deployments::Stub,
              ...
              ##
              # Returns the list of all deployments in the specified {::Google::Cloud::Dialogflow::CX::V3beta1::Environment Environment}.
              #
              # @overload list_deployments(request, options = nil)
              #   Pass arguments to `list_deployments` via a request object, either of type
              #   {::Google::Cloud::Dialogflow::CX::V3beta1::ListDeploymentsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Dialogflow::CX::V3beta1::ListDeploymentsRequest, ::Hash]
              ...
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::CX::V3beta1::Deployment>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::CX::V3beta1::Deployment>]
              #
              ...
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::ListDeploymentsRequest.new
              #
              ...
              #     # Each element is of type ::Google::Cloud::Dialogflow::CX::V3beta1::Deployment.
              #     p response
              #   end
              #
              def list_deployments request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3beta1::ListDeploymentsRequest
              ...
              ##
              # Retrieves the specified {::Google::Cloud::Dialogflow::CX::V3beta1::Deployment Deployment}.
              #
              # @overload get_deployment(request, options = nil)
              #   Pass arguments to `get_deployment` via a request object, either of type
              #   {::Google::Cloud::Dialogflow::CX::V3beta1::GetDeploymentRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Dialogflow::CX::V3beta1::GetDeploymentRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Cloud::Dialogflow::CX::V3beta1::Deployment]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Dialogflow::CX::V3beta1::GetDeploymentRequest.new
              #
              #   # Call the get_deployment method.
              #   result = client.get_deployment request
              #
              #   # The returned object is of type Google::Cloud::Dialogflow::CX::V3beta1::Deployment.
              #   p result
              #
              def get_deployment request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::CX::V3beta1::GetDeploymentRequest
              ...
              # {::Google::Cloud::Dialogflow::CX::V3beta1::Deployments::Client::Configuration::Rpcs}
