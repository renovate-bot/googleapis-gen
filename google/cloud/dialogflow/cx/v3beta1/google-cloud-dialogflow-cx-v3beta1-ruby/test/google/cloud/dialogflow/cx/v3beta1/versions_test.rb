...
class ::Google::Cloud::Dialogflow::CX::V3beta1::Versions::ClientTest < Minitest::Test
  ...
  def test_compare_versions
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::CX::V3beta1::CompareVersionsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    compare_versions_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::CX::V3beta1::CompareVersionsRequest, request
    ...
    Gapic::ServiceStub.stub :new, compare_versions_client_stub do
      ...
      # Use protobuf object
      client.compare_versions ::Google::Cloud::Dialogflow::CX::V3beta1::CompareVersionsRequest.new(base_version: base_version, target_version: target_version, language_code: language_code) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.compare_versions(::Google::Cloud::Dialogflow::CX::V3beta1::CompareVersionsRequest.new(base_version: base_version, target_version: target_version, language_code: language_code), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
