...
class ::Google::Cloud::Dialogflow::CX::V3beta1::Environments::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::CX::V3beta1::Environments::Operations::Configuration, config
  end
end
