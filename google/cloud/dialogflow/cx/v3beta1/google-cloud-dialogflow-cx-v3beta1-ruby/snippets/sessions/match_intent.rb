...
request = Google::Cloud::Dialogflow::CX::V3beta1::MatchIntentRequest.new

# Call the match_intent method.
result = client.match_intent request

# The returned object is of type Google::Cloud::Dialogflow::CX::V3beta1::MatchIntentResponse.
p result
