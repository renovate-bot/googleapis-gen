...
request = Google::Cloud::Dialogflow::CX::V3beta1::GetSecuritySettingsRequest.new

# Call the get_security_settings method.
result = client.get_security_settings request

# The returned object is of type Google::Cloud::Dialogflow::CX::V3beta1::SecuritySettings.
p result
# [END dialogflow_v3beta1_generated_SecuritySettingsService_GetSecuritySettings_sync]
