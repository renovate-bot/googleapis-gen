...
request = Google::Cloud::Dialogflow::CX::V3beta1::GetTransitionRouteGroupRequest.new
...
p result
# [END dialogflow_v3beta1_generated_TransitionRouteGroups_GetTransitionRouteGroup_sync]
