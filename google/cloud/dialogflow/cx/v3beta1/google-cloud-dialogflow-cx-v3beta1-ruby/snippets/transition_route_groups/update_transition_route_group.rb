...
request = Google::Cloud::Dialogflow::CX::V3beta1::UpdateTransitionRouteGroupRequest.new

# Call the update_transition_route_group method.
result = client.update_transition_route_group request

# The returned object is of type Google::Cloud::Dialogflow::CX::V3beta1::TransitionRouteGroup.
p result
# [END dialogflow_v3beta1_generated_TransitionRouteGroups_UpdateTransitionRouteGroup_sync]
