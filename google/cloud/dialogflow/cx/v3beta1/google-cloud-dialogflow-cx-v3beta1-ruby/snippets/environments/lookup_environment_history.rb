...
# [START dialogflow_v3beta1_generated_Environments_LookupEnvironmentHistory_sync]
...
request = Google::Cloud::Dialogflow::CX::V3beta1::LookupEnvironmentHistoryRequest.new
...
result.each do |response|
  # Each element is of type ::Google::Cloud::Dialogflow::CX::V3beta1::Environment.
  p response
end
