...
request = Google::Cloud::Dialogflow::CX::V3beta1::ListContinuousTestResultsRequest.new
...
result.each do |response|
  # Each element is of type ::Google::Cloud::Dialogflow::CX::V3beta1::ContinuousTestResult.
  p response
end
# [END dialogflow_v3beta1_generated_Environments_ListContinuousTestResults_sync]
