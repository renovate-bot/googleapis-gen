# Ruby Client for the Dialogflow CX V3beta1 API

API Client library for the Dialogflow CX V3beta1 API
...
specific version of the Dialogflow CX V3beta1 API. Most users should consider using
the main client gem,
