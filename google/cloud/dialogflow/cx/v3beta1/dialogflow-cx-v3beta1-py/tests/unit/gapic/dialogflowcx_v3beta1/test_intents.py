...
def test_intents_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflowcx_v3beta1.services.intents.transports.IntentsGrpcTransport.__init__') as grpc_transport:
...
def test_intents_base_transport():
    ...
    with mock.patch('google.cloud.dialogflowcx_v3beta1.services.intents.transports.IntentsTransport.__init__') as Transport:
