...
class SessionsTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.detect_intent: gapic_v1.method.wrap_method(
                self.detect_intent,
    ...
    @property
    def detect_intent(self) -> typing.Callable[
            [session.DetectIntentRequest],
            typing.Union[
                session.DetectIntentResponse,
                typing.Awaitable[session.DetectIntentResponse]
            ]]:
        raise NotImplementedError()

    @property
    def streaming_detect_intent(self) -> typing.Callable[
            [session.StreamingDetectIntentRequest],
            typing.Union[
                session.StreamingDetectIntentResponse,
                typing.Awaitable[session.StreamingDetectIntentResponse]
            ]]:
        raise NotImplementedError()

    @property
    def match_intent(self) -> typing.Callable[
            [session.MatchIntentRequest],
            typing.Union[
                session.MatchIntentResponse,
                typing.Awaitable[session.MatchIntentResponse]
            ]]:
        raise NotImplementedError()

    @property
    def fulfill_intent(self) -> typing.Callable[
            [session.FulfillIntentRequest],
            typing.Union[
                session.FulfillIntentResponse,
                typing.Awaitable[session.FulfillIntentResponse]
            ]]:
        raise NotImplementedError()
