...
class FlowsAsyncClient:
    ...
    parse_flow_validation_result_path = staticmethod(FlowsClient.parse_flow_validation_result_path)
    ...
    get_transport_class = functools.partial(type(FlowsClient).get_transport_class, type(FlowsClient))
    ...
    async def get_flow_validation_result(self,
