...
class TestCasesTransport(abc.ABC):
    ...
    @property
    def list_test_cases(self) -> typing.Callable[
    ...
    @property
    def batch_delete_test_cases(self) -> typing.Callable[
    ...
    @property
    def get_test_case(self) -> typing.Callable[
            [test_case.GetTestCaseRequest],
            typing.Union[
                test_case.TestCase,
                typing.Awaitable[test_case.TestCase]
            ]]:
        raise NotImplementedError()

    @property
    def create_test_case(self) -> typing.Callable[
            [gcdc_test_case.CreateTestCaseRequest],
            typing.Union[
                gcdc_test_case.TestCase,
                typing.Awaitable[gcdc_test_case.TestCase]
            ]]:
        raise NotImplementedError()

    @property
    def update_test_case(self) -> typing.Callable[
    ...
    @property
    def run_test_case(self) -> typing.Callable[
    ...
    @property
    def batch_run_test_cases(self) -> typing.Callable[
    ...
    @property
    def calculate_coverage(self) -> typing.Callable[
    ...
    @property
    def import_test_cases(self) -> typing.Callable[
    ...
    @property
    def export_test_cases(self) -> typing.Callable[
    ...
    @property
    def list_test_case_results(self) -> typing.Callable[
