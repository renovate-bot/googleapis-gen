...
class ListTransitionRouteGroupsPager:
    ...
    :class:`google.cloud.dialogflowcx_v3beta1.types.ListTransitionRouteGroupsResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3beta1.types.ListTransitionRouteGroupsResponse`
    ...
    @property
    def pages(self) -> Iterable[transition_route_group.ListTransitionRouteGroupsResponse]:
...
class ListTransitionRouteGroupsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[transition_route_group.ListTransitionRouteGroupsResponse]],
            request: transition_route_group.ListTransitionRouteGroupsRequest,
            response: transition_route_group.ListTransitionRouteGroupsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterable[transition_route_group.ListTransitionRouteGroupsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
