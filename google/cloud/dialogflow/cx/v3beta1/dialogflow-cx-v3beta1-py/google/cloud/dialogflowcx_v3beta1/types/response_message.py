...
class ResponseMessage(proto.Message):
    ...
    conversation_success = proto.Field(proto.MESSAGE, number=9, oneof='message',
        message=ConversationSuccess,
    )

    output_audio_text = proto.Field(proto.MESSAGE, number=8, oneof='message',
        message=OutputAudioText,
    )

    live_agent_handoff = proto.Field(proto.MESSAGE, number=10, oneof='message',
        message=LiveAgentHandoff,
    )

    end_interaction = proto.Field(proto.MESSAGE, number=11, oneof='message',
        message=EndInteraction,
    )

    play_audio = proto.Field(proto.MESSAGE, number=12, oneof='message',
        message=PlayAudio,
    )

    mixed_audio = proto.Field(proto.MESSAGE, number=13, oneof='message',
        message=MixedAudio,
    )
