...
class ExperimentsAsyncClient:
    ...
    from_service_account_info = ExperimentsClient.from_service_account_info
    ...
    get_transport_class = functools.partial(type(ExperimentsClient).get_transport_class, type(ExperimentsClient))
