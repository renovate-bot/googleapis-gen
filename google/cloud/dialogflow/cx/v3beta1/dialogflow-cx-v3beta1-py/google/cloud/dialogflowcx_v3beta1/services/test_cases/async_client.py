...
class TestCasesAsyncClient:
    ...
    from_service_account_info = TestCasesClient.from_service_account_info
    from_service_account_file = TestCasesClient.from_service_account_file
    ...
    async def update_test_case(self,
    ...
    async def batch_run_test_cases(self,
    ...
    async def calculate_coverage(self,
    ...
    async def import_test_cases(self,
    ...
    async def list_test_case_results(self,
