...
class ExperimentsTransport(abc.ABC):
    ...
    @property
    def list_experiments(self) -> typing.Callable[
    ...
    @property
    def get_experiment(self) -> typing.Callable[
    ...
    @property
    def create_experiment(self) -> typing.Callable[
            [gcdc_experiment.CreateExperimentRequest],
            typing.Union[
                gcdc_experiment.Experiment,
                typing.Awaitable[gcdc_experiment.Experiment]
            ]]:
        raise NotImplementedError()

    @property
    def update_experiment(self) -> typing.Callable[
    ...
    @property
    def delete_experiment(self) -> typing.Callable[
    ...
    @property
    def start_experiment(self) -> typing.Callable[
    ...
    @property
    def stop_experiment(self) -> typing.Callable[
