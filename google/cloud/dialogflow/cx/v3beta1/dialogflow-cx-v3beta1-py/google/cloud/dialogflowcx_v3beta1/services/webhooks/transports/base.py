...
class WebhooksTransport(abc.ABC):
    ...
    @property
    def list_webhooks(self) -> typing.Callable[
            [webhook.ListWebhooksRequest],
            typing.Union[
                webhook.ListWebhooksResponse,
                typing.Awaitable[webhook.ListWebhooksResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_webhook(self) -> typing.Callable[
            [webhook.GetWebhookRequest],
            typing.Union[
                webhook.Webhook,
                typing.Awaitable[webhook.Webhook]
            ]]:
        raise NotImplementedError()

    @property
    def create_webhook(self) -> typing.Callable[
            [gcdc_webhook.CreateWebhookRequest],
            typing.Union[
                gcdc_webhook.Webhook,
                typing.Awaitable[gcdc_webhook.Webhook]
            ]]:
        raise NotImplementedError()

    @property
    def update_webhook(self) -> typing.Callable[
    ...
    @property
    def delete_webhook(self) -> typing.Callable[
