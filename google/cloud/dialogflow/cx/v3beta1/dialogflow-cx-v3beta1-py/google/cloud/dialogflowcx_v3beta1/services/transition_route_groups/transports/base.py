...
class TransitionRouteGroupsTransport(abc.ABC):
    ...
    @property
    def list_transition_route_groups(self) -> typing.Callable[
            [transition_route_group.ListTransitionRouteGroupsRequest],
            typing.Union[
                transition_route_group.ListTransitionRouteGroupsResponse,
                typing.Awaitable[transition_route_group.ListTransitionRouteGroupsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_transition_route_group(self) -> typing.Callable[
            [transition_route_group.GetTransitionRouteGroupRequest],
            typing.Union[
                transition_route_group.TransitionRouteGroup,
                typing.Awaitable[transition_route_group.TransitionRouteGroup]
            ]]:
        raise NotImplementedError()

    @property
    def create_transition_route_group(self) -> typing.Callable[
            [gcdc_transition_route_group.CreateTransitionRouteGroupRequest],
            typing.Union[
                gcdc_transition_route_group.TransitionRouteGroup,
                typing.Awaitable[gcdc_transition_route_group.TransitionRouteGroup]
            ]]:
        raise NotImplementedError()

    @property
    def update_transition_route_group(self) -> typing.Callable[
    ...
    @property
    def delete_transition_route_group(self) -> typing.Callable[
