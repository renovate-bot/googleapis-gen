...
class ListSecuritySettingsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[security_settings.ListSecuritySettingsResponse]],
            request: security_settings.ListSecuritySettingsRequest,
            response: security_settings.ListSecuritySettingsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterable[security_settings.ListSecuritySettingsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
