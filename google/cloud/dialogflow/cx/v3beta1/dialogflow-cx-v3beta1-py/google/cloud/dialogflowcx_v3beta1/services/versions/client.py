...
class VersionsClient(metaclass=VersionsClientMeta):
    ...
    def list_versions(self,
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.versions.pagers.ListVersionsPager:
    ...
    def load_version(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a version.LoadVersionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.load_version]
