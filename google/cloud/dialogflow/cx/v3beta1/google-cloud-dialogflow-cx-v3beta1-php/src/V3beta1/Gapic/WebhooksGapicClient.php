 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/dialogflow/cx/v3beta1/webhook.proto
...
use Google\Cloud\Dialogflow\Cx\V3beta1\CreateWebhookRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\DeleteWebhookRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\GetWebhookRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\ListWebhooksRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\ListWebhooksResponse;
use Google\Cloud\Dialogflow\Cx\V3beta1\UpdateWebhookRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\Webhook;
...
class WebhooksGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3beta1.Webhooks';
