 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/dialogflow/cx/v3beta1/changelog.proto
...
use Google\Cloud\Dialogflow\Cx\V3beta1\GetChangelogRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\ListChangelogsRequest;
 ...
 * try {
 *     $formattedName = $changelogsClient->changelogName('[PROJECT]', '[LOCATION]', '[AGENT]', '[CHANGELOG]');
 *     $response = $changelogsClient->getChangelog($formattedName);
 * } finally {
 *     $changelogsClient->close();
 * }
 * ```
 *
...
class ChangelogsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3beta1.Changelogs';
    ...
    private static $changelogNameTemplate;
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/changelogs_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/changelogs_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/changelogs_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/changelogs_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    private static function getChangelogNameTemplate()
    {
        if (self::$changelogNameTemplate == null) {
            self::$changelogNameTemplate = new PathTemplate('projects/{project}/locations/{location}/agents/{agent}/changelogs/{changelog}');
        }

        return self::$changelogNameTemplate;
    }
    ...
    private static function getPathTemplateMap()
    {
        if (self::$pathTemplateMap == null) {
            self::$pathTemplateMap = [
                ...
                'changelog' => self::getChangelogNameTemplate(),
            ];
        }
     ...
     * @experimental
     */
    public static function changelogName($project, $location, $agent, $changelog)
    {
        return self::getChangelogNameTemplate()->render([
            'project' => $project,
            'location' => $location,
            'agent' => $agent,
            'changelog' => $changelog,
     ...
     * }
     *
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\Changelog
     *
     * @throws ApiException if the remote call fails
     *
     * @experimental
     */
    public function getChangelog($name, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetChangelog', Changelog::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $pagedResponse = $changelogsClient->listChangelogs($formattedParent);
     ...
     * @experimental
     */
    public function listChangelogs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListChangelogs', $optionalArgs, ListChangelogsResponse::class, $request);
    }
}
