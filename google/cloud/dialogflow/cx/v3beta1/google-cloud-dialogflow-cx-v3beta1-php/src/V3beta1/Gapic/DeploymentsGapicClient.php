 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/dialogflow/cx/v3beta1/deployment.proto
...
use Google\Cloud\Dialogflow\Cx\V3beta1\GetDeploymentRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\ListDeploymentsRequest;
...
class DeploymentsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3beta1.Deployments';
     ...
     * ```
     *
     * @param string $name         Required. The name of the [Deployment][google.cloud.dialogflow.cx.v3beta1.Deployment].
     ...
     * }
     *
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\Deployment
     *
