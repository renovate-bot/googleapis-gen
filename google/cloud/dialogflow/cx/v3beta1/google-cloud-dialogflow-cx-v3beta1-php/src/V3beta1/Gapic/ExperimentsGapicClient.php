...
use Google\Cloud\Dialogflow\Cx\V3beta1\CreateExperimentRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\DeleteExperimentRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\Experiment;
use Google\Cloud\Dialogflow\Cx\V3beta1\GetExperimentRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\ListExperimentsRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\ListExperimentsResponse;
use Google\Cloud\Dialogflow\Cx\V3beta1\StartExperimentRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\StopExperimentRequest;
use Google\Cloud\Dialogflow\Cx\V3beta1\UpdateExperimentRequest;
...
class ExperimentsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3beta1.Experiments';
