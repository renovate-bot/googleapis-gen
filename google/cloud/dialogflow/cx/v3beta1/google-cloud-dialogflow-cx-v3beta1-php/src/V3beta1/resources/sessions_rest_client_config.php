...
return [
    'interfaces' => [
        'google.cloud.dialogflow.cx.v3beta1.Sessions' => [
            'DetectIntent' => [
                'method' => 'post',
                'uriTemplate' => '/v3beta1/{session=projects/*/locations/*/agents/*/sessions/*}:detectIntent',
                'body' => '*',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v3beta1/{session=projects/*/locations/*/agents/*/environments/*/sessions/*}:detectIntent',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
            ...
            'FulfillIntent' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v3beta1/{match_intent_request.session=projects/*/locations/*/agents/*/environments/*/sessions/*}:fulfillIntent',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
