...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\Form;
 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.Form.Parameter</code>
 */
class Parameter extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type bool $is_list
     *           Indicates whether the parameter represents a list of values.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\Form\Parameter\FillBehavior $fill_behavior
     *           Required. Defines fill behavior for the parameter.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Form.Parameter.FillBehavior fill_behavior = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\Form\Parameter\FillBehavior $var
     * @return $this
     */
    public function setFillBehavior($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\Form\Parameter\FillBehavior::class);
...
class_alias(Parameter::class, \Google\Cloud\Dialogflow\Cx\V3beta1\Form_Parameter::class);
