...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\StreamingRecognitionResult;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.StreamingRecognitionResult.MessageType</code>
 */
class MessageType
{
    /**
...
class_alias(MessageType::class, \Google\Cloud\Dialogflow\Cx\V3beta1\StreamingRecognitionResult_MessageType::class);
