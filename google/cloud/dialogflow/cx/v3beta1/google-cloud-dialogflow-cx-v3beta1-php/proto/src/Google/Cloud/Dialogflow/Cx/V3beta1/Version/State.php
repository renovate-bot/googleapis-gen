...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\Version;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.Version.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Dialogflow\Cx\V3beta1\Version_State::class);
