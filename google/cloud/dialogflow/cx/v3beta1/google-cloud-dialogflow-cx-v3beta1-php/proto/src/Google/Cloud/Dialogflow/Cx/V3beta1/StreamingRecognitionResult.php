 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.StreamingRecognitionResult</code>
 */
class StreamingRecognitionResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.StreamingRecognitionResult.MessageType message_type = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.SpeechWordInfo speech_word_info = 7;</code>
     */
     ...
     *           * Otherwise, the value is in (0.0, 1.0] where 0.0 means completely
     *             unstable and 1.0 means completely stable.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\SpeechWordInfo[]|\Google\Protobuf\Internal\RepeatedField $speech_word_info
     *           Word-specific information for the words recognized by Speech in
     *           [transcript][google.cloud.dialogflow.cx.v3beta1.StreamingRecognitionResult.transcript]. Populated if and only if `message_type` = `TRANSCRIPT` and
     *           [InputAudioConfig.enable_word_info] is set.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\StreamingRecognitionResult\MessageType::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.SpeechWordInfo speech_word_info = 7;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\SpeechWordInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSpeechWordInfo($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3beta1\SpeechWordInfo::class);
