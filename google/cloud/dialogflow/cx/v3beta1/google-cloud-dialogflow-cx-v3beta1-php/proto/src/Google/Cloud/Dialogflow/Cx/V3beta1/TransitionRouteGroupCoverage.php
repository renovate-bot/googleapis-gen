 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroupCoverage</code>
 */
class TransitionRouteGroupCoverage extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroupCoverage.Coverage coverages = 1;</code>
     */
    private $coverages;
    /**
     ...
     *
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\TransitionRouteGroupCoverage\Coverage[]|\Google\Protobuf\Internal\RepeatedField $coverages
     *           Transition route group coverages.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroupCoverage.Coverage coverages = 1;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\TransitionRouteGroupCoverage\Coverage[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCoverages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3beta1\TransitionRouteGroupCoverage\Coverage::class);
        $this->coverages = $arr;
