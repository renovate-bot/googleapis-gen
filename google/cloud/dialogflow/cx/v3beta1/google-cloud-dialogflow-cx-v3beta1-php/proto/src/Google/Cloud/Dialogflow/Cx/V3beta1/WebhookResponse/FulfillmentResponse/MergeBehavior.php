...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\WebhookResponse\FulfillmentResponse;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.WebhookResponse.FulfillmentResponse.MergeBehavior</code>
 */
class MergeBehavior
{
    /**
...
class_alias(MergeBehavior::class, \Google\Cloud\Dialogflow\Cx\V3beta1\WebhookResponse_FulfillmentResponse_MergeBehavior::class);
