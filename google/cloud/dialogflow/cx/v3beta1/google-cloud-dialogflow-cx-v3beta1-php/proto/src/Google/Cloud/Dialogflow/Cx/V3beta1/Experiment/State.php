 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.Experiment.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment_State::class);
