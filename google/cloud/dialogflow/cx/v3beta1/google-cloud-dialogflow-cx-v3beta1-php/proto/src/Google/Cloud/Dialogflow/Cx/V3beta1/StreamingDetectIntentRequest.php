 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.StreamingDetectIntentRequest</code>
 */
class StreamingDetectIntentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           See [Versions and
     *           environments](https://cloud.google.com/dialogflow/cx/docs/concept/version).
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\QueryParameters $query_params
     *           The parameters of this query.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\QueryInput $query_input
     *           Required. The input specification.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.QueryParameters query_params = 2;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\QueryParameters $var
     * @return $this
     */
    public function setQueryParams($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\QueryParameters::class);
