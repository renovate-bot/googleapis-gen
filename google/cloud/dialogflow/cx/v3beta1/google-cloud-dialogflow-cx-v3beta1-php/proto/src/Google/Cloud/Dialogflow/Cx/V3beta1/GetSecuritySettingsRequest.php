 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.GetSecuritySettingsRequest</code>
 */
class GetSecuritySettingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
