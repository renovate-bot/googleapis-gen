 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.UpdateSecuritySettingsRequest</code>
 */
class UpdateSecuritySettingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\SecuritySettings $security_settings
     *           Required. [SecuritySettings] object that contains values for each of the
     *           fields to update.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.SecuritySettings security_settings = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\SecuritySettings $var
     * @return $this
     */
    public function setSecuritySettings($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\SecuritySettings::class);
