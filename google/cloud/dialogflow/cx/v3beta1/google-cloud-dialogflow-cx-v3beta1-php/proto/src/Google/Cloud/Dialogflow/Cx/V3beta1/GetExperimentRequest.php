 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.GetExperimentRequest</code>
 */
class GetExperimentRequest extends \Google\Protobuf\Internal\Message
{
    /**
