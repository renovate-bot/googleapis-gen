...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\DetectIntentResponse;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.DetectIntentResponse.ResponseType</code>
 */
class ResponseType
{
    /**
...
class_alias(ResponseType::class, \Google\Cloud\Dialogflow\Cx\V3beta1\DetectIntentResponse_ResponseType::class);
