 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.FulfillIntentRequest</code>
 */
class FulfillIntentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.MatchIntentRequest match_intent_request = 1;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\MatchIntentRequest $var
     * @return $this
     */
    public function setMatchIntentRequest($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\MatchIntentRequest::class);
