 ...
 * auto-rollout, etc.
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.Deployment</code>
 */
class Deployment extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Deployment.State state = 3;</code>
     */
    protected $state = 0;
    /**
     * Result of the deployment.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Deployment.Result result = 4;</code>
     */
     ...
     *     @type int $state
     *           The current state of the deployment.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\Deployment\Result $result
     *           Result of the deployment.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\Deployment\State::class);
        $this->state = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Deployment.Result result = 4;</code>
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\Deployment\Result|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Deployment.Result result = 4;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\Deployment\Result $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\Deployment\Result::class);
        $this->result = $var;
