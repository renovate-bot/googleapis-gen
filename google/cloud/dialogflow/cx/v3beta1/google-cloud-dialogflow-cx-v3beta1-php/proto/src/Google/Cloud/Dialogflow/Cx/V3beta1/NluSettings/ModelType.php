 ...
 * NLU model type.
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.NluSettings.ModelType</code>
 */
class ModelType
{
    /**
...
class_alias(ModelType::class, \Google\Cloud\Dialogflow\Cx\V3beta1\NluSettings_ModelType::class);
