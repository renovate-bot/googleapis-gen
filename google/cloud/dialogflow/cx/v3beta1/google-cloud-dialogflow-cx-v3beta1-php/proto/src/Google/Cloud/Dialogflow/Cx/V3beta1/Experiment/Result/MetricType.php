 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.Experiment.Result.MetricType</code>
 */
class MetricType
{
    /**
...
class_alias(MetricType::class, \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment_Result_MetricType::class);
