...
class SecuritySettingsServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\CreateSecuritySettingsRequest $argument input argument
     ...
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\GetSecuritySettingsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
     ...
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\UpdateSecuritySettingsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
     ...
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\ListSecuritySettingsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
     ...
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\DeleteSecuritySettingsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function DeleteSecuritySettings(\Google\Cloud\Dialogflow\Cx\V3beta1\DeleteSecuritySettingsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.dialogflow.cx.v3beta1.SecuritySettingsService/DeleteSecuritySettings',
        $argument,
