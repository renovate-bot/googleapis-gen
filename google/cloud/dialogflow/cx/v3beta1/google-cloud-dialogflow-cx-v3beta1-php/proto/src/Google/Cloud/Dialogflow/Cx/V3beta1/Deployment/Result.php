...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\Deployment;
 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.Deployment.Result</code>
 */
class Result extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $deployment_test_results
     *           Results of test cases running before the deployment.
     *           Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
     *           ID>/testCases/<TestCase ID>/results/<TestCaseResult ID>`.
...
class_alias(Result::class, \Google\Cloud\Dialogflow\Cx\V3beta1\Deployment_Result::class);
