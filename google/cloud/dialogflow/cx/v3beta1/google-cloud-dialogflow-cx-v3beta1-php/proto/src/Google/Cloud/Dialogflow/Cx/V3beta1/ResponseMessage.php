 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.ResponseMessage</code>
 */
class ResponseMessage extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\Text $text
     *           Returns a text response.
     *     @type \Google\Protobuf\Struct $payload
     *           Returns a response containing a custom, platform-specific payload.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\ConversationSuccess $conversation_success
     *           Indicates that the conversation succeeded.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\OutputAudioText $output_audio_text
     *           A text or ssml response that is preferentially used for TTS output audio
     *           synthesis, as described in the comment on the ResponseMessage message.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\LiveAgentHandoff $live_agent_handoff
     *           Hands off conversation to a human agent.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\EndInteraction $end_interaction
     ...
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\PlayAudio $play_audio
     ...
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\MixedAudio $mixed_audio
     ...
     *           defined by the user.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\TelephonyTransferCall $telephony_transfer_call
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ResponseMessage.Text text = 1;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\Text $var
     * @return $this
     */
    public function setText($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\Text::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ResponseMessage.ConversationSuccess conversation_success = 9;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\ConversationSuccess $var
     * @return $this
     */
    public function setConversationSuccess($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\ConversationSuccess::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ResponseMessage.OutputAudioText output_audio_text = 8;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\OutputAudioText $var
     * @return $this
     */
    public function setOutputAudioText($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\OutputAudioText::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ResponseMessage.LiveAgentHandoff live_agent_handoff = 10;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\LiveAgentHandoff $var
     * @return $this
     */
    public function setLiveAgentHandoff($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\LiveAgentHandoff::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ResponseMessage.EndInteraction end_interaction = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\EndInteraction $var
     * @return $this
     */
    public function setEndInteraction($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\EndInteraction::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ResponseMessage.PlayAudio play_audio = 12;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\PlayAudio $var
     * @return $this
     */
    public function setPlayAudio($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\PlayAudio::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ResponseMessage.MixedAudio mixed_audio = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\MixedAudio $var
     * @return $this
     */
    public function setMixedAudio($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\MixedAudio::class);
     ...
     * this agent to a third-party endpoint.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ResponseMessage.TelephonyTransferCall telephony_transfer_call = 18;</code>
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\TelephonyTransferCall|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ResponseMessage.TelephonyTransferCall telephony_transfer_call = 18;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\TelephonyTransferCall $var
     * @return $this
     */
    public function setTelephonyTransferCall($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\TelephonyTransferCall::class);
