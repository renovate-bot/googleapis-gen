...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\ValidationMessage;
 ...
 * Severity level.
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.ValidationMessage.Severity</code>
 */
class Severity
{
    /**
...
class_alias(Severity::class, \Google\Cloud\Dialogflow\Cx\V3beta1\ValidationMessage_Severity::class);
