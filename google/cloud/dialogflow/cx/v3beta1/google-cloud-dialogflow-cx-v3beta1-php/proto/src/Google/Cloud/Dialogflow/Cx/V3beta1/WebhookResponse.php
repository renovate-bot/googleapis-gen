 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.WebhookResponse</code>
 */
class WebhookResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\WebhookResponse\FulfillmentResponse $fulfillment_response
     *           The fulfillment response to send to the user. This field can be omitted by
     *           the webhook if it does not intend to send any response to the user.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.WebhookResponse.FulfillmentResponse fulfillment_response = 1;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\WebhookResponse\FulfillmentResponse $var
     * @return $this
     */
