 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.PageInfo</code>
 */
class PageInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.PageInfo.FormInfo form_info = 3;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\PageInfo\FormInfo $var
     * @return $this
     */
    public function setFormInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\PageInfo\FormInfo::class);
        $this->form_info = $var;
