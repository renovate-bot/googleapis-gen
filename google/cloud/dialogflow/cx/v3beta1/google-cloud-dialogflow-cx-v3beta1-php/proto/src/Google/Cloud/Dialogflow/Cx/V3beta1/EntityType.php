 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.EntityType</code>
 */
class EntityType extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.EntityType.Kind kind = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $kind = 0;
    /**
     * Indicates whether the entity type can be automatically expanded.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.EntityType.AutoExpansionMode auto_expansion_mode = 4;</code>
     */
    protected $auto_expansion_mode = 0;
    /**
     * The collection of entity entries associated with the entity type.
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.EntityType.Entity entities = 5;</code>
     */
    private $entities;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.EntityType.ExcludedPhrase excluded_phrases = 6;</code>
     */
     ...
     *           Indicates whether the entity type can be automatically expanded.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\Entity[]|\Google\Protobuf\Internal\RepeatedField $entities
     *           The collection of entity entries associated with the entity type.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\ExcludedPhrase[]|\Google\Protobuf\Internal\RepeatedField $excluded_phrases
     *           Collection of exceptional words and phrases that shouldn't be matched.
     *           For example, if you have a size entity type with entry `giant`(an
     *           adjective), you might consider adding `giants`(a noun) as an exclusion.
     *           If the kind of entity type is `KIND_MAP`, then the phrases specified by
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\Kind::class);
        $this->kind = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\AutoExpansionMode::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.EntityType.Entity entities = 5;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\Entity[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.EntityType.ExcludedPhrase excluded_phrases = 6;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\ExcludedPhrase[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setExcludedPhrases($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\ExcludedPhrase::class);
