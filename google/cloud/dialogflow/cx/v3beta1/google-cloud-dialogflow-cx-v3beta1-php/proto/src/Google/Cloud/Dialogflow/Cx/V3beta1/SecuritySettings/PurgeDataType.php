 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.SecuritySettings.PurgeDataType</code>
 */
class PurgeDataType
{
    /**
...
class_alias(PurgeDataType::class, \Google\Cloud\Dialogflow\Cx\V3beta1\SecuritySettings_PurgeDataType::class);
