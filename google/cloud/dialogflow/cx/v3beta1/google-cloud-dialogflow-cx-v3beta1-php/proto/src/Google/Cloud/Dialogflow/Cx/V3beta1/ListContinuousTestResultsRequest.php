 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.ListContinuousTestResultsRequest</code>
 */
class ListContinuousTestResultsRequest extends \Google\Protobuf\Internal\Message
{
    /**
