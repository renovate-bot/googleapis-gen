 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.ContinuousTestResult</code>
 */
class ContinuousTestResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ContinuousTestResult.AggregatedTestResult result = 2;</code>
     */
    protected $result = 0;
    /**
     ...
     *           The result of this continuous test run, i.e. whether all the tests in this
     *           continuous test run pass or not.
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $test_case_results
     *           A list of individual test case results names in this continuous test run.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ContinuousTestResult\AggregatedTestResult::class);
        $this->result = $var;
