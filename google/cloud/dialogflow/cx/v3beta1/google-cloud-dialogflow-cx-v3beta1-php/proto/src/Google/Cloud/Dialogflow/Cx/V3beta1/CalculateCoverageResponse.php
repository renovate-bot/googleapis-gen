 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.CalculateCoverageResponse</code>
 */
class CalculateCoverageResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *           The agent to calculate coverage for.
     *           Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>`.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\IntentCoverage $intent_coverage
     *           Intent coverage.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\TransitionCoverage $transition_coverage
     *           Transition (excluding transition route groups) coverage.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\TransitionRouteGroupCoverage $route_group_coverage
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.IntentCoverage intent_coverage = 2;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\IntentCoverage $var
     * @return $this
     */
    public function setIntentCoverage($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\IntentCoverage::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.TransitionCoverage transition_coverage = 4;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\TransitionCoverage $var
     * @return $this
     */
    public function setTransitionCoverage($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\TransitionCoverage::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroupCoverage route_group_coverage = 6;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\TransitionRouteGroupCoverage $var
     * @return $this
     */
    public function setRouteGroupCoverage($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\TransitionRouteGroupCoverage::class);
