 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.EntityType.Kind</code>
 */
class Kind
{
    /**
...
class_alias(Kind::class, \Google\Cloud\Dialogflow\Cx\V3beta1\EntityType_Kind::class);
