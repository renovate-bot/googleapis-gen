...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\TestRunDifference;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.TestRunDifference.DiffType</code>
 */
class DiffType
{
    /**
...
class_alias(DiffType::class, \Google\Cloud\Dialogflow\Cx\V3beta1\TestRunDifference_DiffType::class);
