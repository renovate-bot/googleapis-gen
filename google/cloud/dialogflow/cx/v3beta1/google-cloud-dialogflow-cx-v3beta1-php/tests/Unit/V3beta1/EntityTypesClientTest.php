...
use Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\Kind;
...
class EntityTypesClientTest extends GeneratedTest
{
    ...
    public function createEntityTypeTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.EntityTypes/CreateEntityType', $actualFuncCall);
    ...
    public function deleteEntityTypeTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->entityTypeName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENTITY_TYPE]');
        $client->deleteEntityType($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.EntityTypes/DeleteEntityType', $actualFuncCall);
    ...
    public function getEntityTypeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.EntityTypes/GetEntityType', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listEntityTypesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.EntityTypes/ListEntityTypes', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateEntityTypeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.EntityTypes/UpdateEntityType', $actualFuncCall);
        $actualValue = $actualRequestObject->getEntityType();
        $this->assertProtobufEquals($entityType, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
