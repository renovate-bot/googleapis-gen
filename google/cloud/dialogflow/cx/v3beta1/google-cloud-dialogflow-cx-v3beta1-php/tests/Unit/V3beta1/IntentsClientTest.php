...
class IntentsClientTest extends GeneratedTest
{
    ...
    public function createIntentTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Intents/CreateIntent', $actualFuncCall);
    ...
    public function deleteIntentTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->intentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[INTENT]');
        $client->deleteIntent($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Intents/DeleteIntent', $actualFuncCall);
    ...
    public function getIntentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Intents/GetIntent', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listIntentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Intents/ListIntents', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateIntentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Intents/UpdateIntent', $actualFuncCall);
        $actualValue = $actualRequestObject->getIntent();
        $this->assertProtobufEquals($intent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
