...
use Google\Cloud\Dialogflow\Cx\V3beta1\ContinuousTestResult;
use Google\Cloud\Dialogflow\Cx\V3beta1\DeployFlowResponse;

use Google\Cloud\Dialogflow\Cx\V3beta1\Environment;
use Google\Cloud\Dialogflow\Cx\V3beta1\EnvironmentsClient;
use Google\Cloud\Dialogflow\Cx\V3beta1\ListContinuousTestResultsResponse;
...
class EnvironmentsClientTest extends GeneratedTest
{
    ...
    public function createEnvironmentTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Environments/CreateEnvironment', $actualApiFuncCall);
    ...
    public function deleteEnvironmentTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Environments/DeleteEnvironment', $actualFuncCall);
     ...
     * @test
     */
    public function deployFlowTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deployFlowTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $deployment = 'deployment1939520197';
        $expectedResponse = new DeployFlowResponse();
        $expectedResponse->setDeployment($deployment);
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deployFlowTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedEnvironment = $client->environmentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENVIRONMENT]');
        $formattedFlowVersion = $client->versionName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]', '[VERSION]');
        $response = $client->deployFlow($formattedEnvironment, $formattedFlowVersion);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Environments/DeployFlow', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getEnvironment();
        $this->assertProtobufEquals($formattedEnvironment, $actualValue);
        $actualValue = $actualApiRequestObject->getFlowVersion();
        $this->assertProtobufEquals($formattedFlowVersion, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/deployFlowTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
     ...
     * @test
     */
    public function deployFlowExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
    ...
    public function getEnvironmentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Environments/GetEnvironment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
     ...
     * @test
     */
    public function listContinuousTestResultsTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        // Mock response
        $nextPageToken = '';
        $continuousTestResultsElement = new ContinuousTestResult();
        $continuousTestResults = [
            $continuousTestResultsElement,
        ];
        $expectedResponse = new ListContinuousTestResultsResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setContinuousTestResults($continuousTestResults);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $client->environmentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENVIRONMENT]');
        $response = $client->listContinuousTestResults($formattedParent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getContinuousTestResults()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Environments/ListContinuousTestResults', $actualFuncCall);
     ...
     * @test
     */
    public function listContinuousTestResultsExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        $formattedParent = $client->environmentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENVIRONMENT]');
        try {
            $client->listContinuousTestResults($formattedParent);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listEnvironmentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Environments/ListEnvironments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function lookupEnvironmentHistoryTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Environments/LookupEnvironmentHistory', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
     ...
     * @test
     */
    public function runContinuousTestTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/runContinuousTestTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new RunContinuousTestResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/runContinuousTestTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedEnvironment = $client->environmentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENVIRONMENT]');
        $response = $client->runContinuousTest($formattedEnvironment);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Environments/RunContinuousTest', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getEnvironment();
        $this->assertProtobufEquals($formattedEnvironment, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/runContinuousTestTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
     ...
     * @test
     */
    public function runContinuousTestExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
    ...
    public function updateEnvironmentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Environments/UpdateEnvironment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getEnvironment();
        $this->assertProtobufEquals($environment, $actualValue);
