...
use Google\Cloud\Dialogflow\Cx\V3beta1\SessionEntityType\EntityOverrideMode;
use Google\Cloud\Dialogflow\Cx\V3beta1\SessionEntityTypesClient;
...
class SessionEntityTypesClientTest extends GeneratedTest
{
    ...
    public function createSessionEntityTypeTest()
    {
        ...
        // Mock request
        $formattedParent = $client->sessionName('[PROJECT]', '[LOCATION]', '[AGENT]', '[SESSION]');
        ...
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.SessionEntityTypes/CreateSessionEntityType', $actualFuncCall);
    ...
    public function deleteSessionEntityTypeTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->sessionEntityTypeName('[PROJECT]', '[LOCATION]', '[AGENT]', '[SESSION]', '[ENTITY_TYPE]');
        $client->deleteSessionEntityType($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.SessionEntityTypes/DeleteSessionEntityType', $actualFuncCall);
    ...
    public function getSessionEntityTypeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.SessionEntityTypes/GetSessionEntityType', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listSessionEntityTypesTest()
    {
        ...
        $this->assertEquals($expectedResponse->getSessionEntityTypes()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.SessionEntityTypes/ListSessionEntityTypes', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateSessionEntityTypeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.SessionEntityTypes/UpdateSessionEntityType', $actualFuncCall);
        $actualValue = $actualRequestObject->getSessionEntityType();
        $this->assertProtobufEquals($sessionEntityType, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
