...
public interface SecuritySettingsOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.dialogflow.cx.v3beta1.SecuritySettings.RedactionStrategy redaction_strategy = 3;</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.dialogflow.cx.v3beta1.SecuritySettings.PurgeDataType purge_data_types = 8;</code>
   * @return A list containing the purgeDataTypes.
   */
  java.util.List<com.google.cloud.dialogflow.cx.v3beta1.SecuritySettings.PurgeDataType> getPurgeDataTypesList();
  /**
   * <pre>
   * List of types of data to remove when retention settings triggers purge.
   * </pre>
   ...
   */
  com.google.cloud.dialogflow.cx.v3beta1.SecuritySettings.PurgeDataType getPurgeDataTypes(int index);
  /**
   * <pre>
   * List of types of data to remove when retention settings triggers purge.
   * </pre>
  ...
  public com.google.cloud.dialogflow.cx.v3beta1.SecuritySettings.DataRetentionCase getDataRetentionCase();
}
