...
public interface WebhookResponseOrBuilder extends
   ...
   */
  com.google.cloud.dialogflow.cx.v3beta1.WebhookResponse.FulfillmentResponse getFulfillmentResponse();
  /**
   * <pre>
   * The fulfillment response to send to the user. This field can be omitted by
   * the webhook if it does not intend to send any response to the user.
   ...
   * <code>.google.cloud.dialogflow.cx.v3beta1.WebhookResponse.FulfillmentResponse fulfillment_response = 1;</code>
   */
  com.google.cloud.dialogflow.cx.v3beta1.WebhookResponse.FulfillmentResponseOrBuilder getFulfillmentResponseOrBuilder();
  ...
  public com.google.cloud.dialogflow.cx.v3beta1.WebhookResponse.TransitionCase getTransitionCase();
}
