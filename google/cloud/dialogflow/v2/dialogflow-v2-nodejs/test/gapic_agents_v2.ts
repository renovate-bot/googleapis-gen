...
describe('v2.AgentsClient', () => {
    ...
    describe('getAgent', () => {
        it('invokes getAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.GetAgentRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.Agent());
        ...
        it('invokes getAgent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAgent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IAgent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteAgent', () => {
        it('invokes deleteAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.DeleteAgentRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('getValidationResult', () => {
        it('invokes getValidationResult without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.GetValidationResultRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ValidationResult());
        ...
        it('invokes getValidationResult without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getValidationResult(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IValidationResult|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('trainAgent', () => {
        it('invokes trainAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.TrainAgentRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            client.innerApiCalls.trainAgent = stubLongRunningCall(expectedResponse);
        ...
        it('invokes trainAgent without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.trainAgent = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.trainAgent(
                    request,
                    (err?: Error|null,
        ...
        it('invokes trainAgent with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.trainAgent = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes trainAgent with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.trainAgent = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.trainAgent(request);
        ...
        it('invokes checkTrainAgentProgress without error', async () => {
            ...
            const decodedOperation = await client.checkTrainAgentProgress(expectedResponse.name);
    ...
    describe('exportAgent', () => {
        it('invokes exportAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ExportAgentRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes exportAgent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportAgent(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2.IExportAgentResponse, protos.google.protobuf.IStruct>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2.IExportAgentResponse, protos.google.protobuf.IStruct>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.exportAgent as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('importAgent', () => {
        it('invokes importAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ImportAgentRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.importAgent = stubLongRunningCall(expectedResponse);
        ...
        it('invokes importAgent without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.importAgent = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.importAgent(
                    request,
                    (err?: Error|null,
        ...
        it('invokes importAgent with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.importAgent = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes importAgent with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.importAgent = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.importAgent(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.importAgent as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkImportAgentProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkImportAgentProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('restoreAgent', () => {
        it('invokes restoreAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.RestoreAgentRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('searchAgents', () => {
        it('invokes searchAgents without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.SearchAgentsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.Agent()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.Agent()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.Agent()),
            ];
        ...
        it('invokes searchAgentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.Agent[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.Agent) => {
