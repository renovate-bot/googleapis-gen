...
describe('v2.ParticipantsClient', () => {
    it('has servicePath', () => {
        const servicePath = participantsModule.v2.ParticipantsClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = participantsModule.v2.ParticipantsClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = participantsModule.v2.ParticipantsClient.port;
        assert(port);
    ...
    describe('createParticipant', () => {
        it('invokes createParticipant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.CreateParticipantRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.Participant());
            ...
            assert((client.innerApiCalls.createParticipant as SinonStub)
        ...
        it('invokes createParticipant without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.Participant());
            client.innerApiCalls.createParticipant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createParticipant(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IParticipant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createParticipant with error', async () => {
            ...
            client.innerApiCalls.createParticipant = stubSimpleCall(undefined, expectedError);
    ...
    describe('getParticipant', () => {
        it('invokes getParticipant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.GetParticipantRequest());
            request.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getParticipant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getParticipant without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.Participant());
            client.innerApiCalls.getParticipant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getParticipant with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.getParticipant = stubSimpleCall(undefined, expectedError);
    ...
    describe('updateParticipant', () => {
        it('invokes updateParticipant without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.UpdateParticipantRequest());
            request.participant = {};
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateParticipant as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateParticipant without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.Participant());
            client.innerApiCalls.updateParticipant = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateParticipant with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.updateParticipant = stubSimpleCall(undefined, expectedError);
    ...
    describe('analyzeContent', () => {
        it('invokes analyzeContent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.AnalyzeContentRequest());
            request.participant = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.AnalyzeContentResponse());
            client.innerApiCalls.analyzeContent = stubSimpleCall(expectedResponse);
            const [response] = await client.analyzeContent(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.analyzeContent as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes analyzeContent without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.AnalyzeContentResponse());
            client.innerApiCalls.analyzeContent = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.analyzeContent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IAnalyzeContentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes analyzeContent with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.analyzeContent = stubSimpleCall(undefined, expectedError);
    ...
    describe('suggestArticles', () => {
        it('invokes suggestArticles without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.SuggestArticlesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.SuggestArticlesResponse());
            client.innerApiCalls.suggestArticles = stubSimpleCall(expectedResponse);
            const [response] = await client.suggestArticles(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.suggestArticles as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes suggestArticles without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.SuggestArticlesResponse());
            client.innerApiCalls.suggestArticles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.suggestArticles(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ISuggestArticlesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestArticles with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.suggestArticles = stubSimpleCall(undefined, expectedError);
    ...
    describe('suggestFaqAnswers', () => {
        it('invokes suggestFaqAnswers without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.SuggestFaqAnswersResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.suggestFaqAnswers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes suggestFaqAnswers without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.SuggestFaqAnswersResponse());
            client.innerApiCalls.suggestFaqAnswers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.suggestFaqAnswers(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ISuggestFaqAnswersResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes suggestFaqAnswers with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.suggestFaqAnswers = stubSimpleCall(undefined, expectedError);
    ...
    describe('listParticipants', () => {
        it('invokes listParticipants without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ListParticipantsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.Participant()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.Participant()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.Participant()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listParticipants as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listParticipants without error using callback', async () => {
            ...
            client.innerApiCalls.listParticipants = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listParticipants with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listParticipants = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listParticipantsStream without error', async () => {
            ...
            client.descriptors.page.listParticipants.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listParticipantsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.Participant[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.Participant) => {
            ...
            assert((client.descriptors.page.listParticipants.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listParticipants, request));
            assert.strictEqual(
        ...
        it('invokes listParticipantsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.listParticipants.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listParticipantsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.Participant[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.Participant) => {
        ...
        it('uses async iteration with listParticipants without error', async () => {
            ...
            client.descriptors.page.listParticipants.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2.IParticipant[] = [];
        ...
        it('uses async iteration with listParticipants with error', async () => {
            ...
            client.descriptors.page.listParticipants.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listParticipantsAsync(request);
