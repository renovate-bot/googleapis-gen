...
describe('v2.KnowledgeBasesClient', () => {
    ...
    describe('getKnowledgeBase', () => {
        it('invokes getKnowledgeBase without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.KnowledgeBase());
            ...
            assert((client.innerApiCalls.getKnowledgeBase as SinonStub)
    ...
    describe('createKnowledgeBase', () => {
        it('invokes createKnowledgeBase without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createKnowledgeBase as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteKnowledgeBase', () => {
        it('invokes deleteKnowledgeBase without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.DeleteKnowledgeBaseRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteKnowledgeBase as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateKnowledgeBase', () => {
        it('invokes updateKnowledgeBase without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.UpdateKnowledgeBaseRequest());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateKnowledgeBase as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listKnowledgeBases', () => {
        it('invokes listKnowledgeBases without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listKnowledgeBases as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
