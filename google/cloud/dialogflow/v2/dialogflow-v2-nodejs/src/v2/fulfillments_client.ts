 ...
 */
import * as gapicConfig from './fulfillments_client_config.json';
...
export class FulfillmentsClient {
  ...
  fulfillmentsStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof FulfillmentsClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2.Fulfillments', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.fulfillmentsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2.Fulfillments') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2.Fulfillments,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const fulfillmentsStubMethods =
        ['getFulfillment', 'updateFulfillment'];
    for (const methodName of fulfillmentsStubMethods) {
      const callPromise = this.fulfillmentsStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  getFulfillment(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2.IGetFulfillmentRequest|undefined, {}|undefined
      ]>;
  getFulfillment(
      request: protos.google.cloud.dialogflow.v2.IGetFulfillmentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.IFulfillment,
          protos.google.cloud.dialogflow.v2.IGetFulfillmentRequest|null|undefined,
          {}|null|undefined>): void;
  getFulfillment(
      request: protos.google.cloud.dialogflow.v2.IGetFulfillmentRequest,
      callback: Callback<
 ...
 */
  ...
  updateFulfillment(
      ...
      Promise<[
        protos.google.cloud.dialogflow.v2.IFulfillment,
        protos.google.cloud.dialogflow.v2.IUpdateFulfillmentRequest|undefined, {}|undefined
      ]>;
  updateFulfillment(
      request: protos.google.cloud.dialogflow.v2.IUpdateFulfillmentRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.IFulfillment,
          protos.google.cloud.dialogflow.v2.IUpdateFulfillmentRequest|null|undefined,
          {}|null|undefined>): void;
  updateFulfillment(
      request: protos.google.cloud.dialogflow.v2.IUpdateFulfillmentRequest,
      callback: Callback<
