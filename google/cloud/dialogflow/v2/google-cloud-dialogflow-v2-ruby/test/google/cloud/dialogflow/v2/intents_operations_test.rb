...
class ::Google::Cloud::Dialogflow::V2::Intents::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Dialogflow::V2::Intents::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::Intents::Operations::Configuration, config
  end
end
