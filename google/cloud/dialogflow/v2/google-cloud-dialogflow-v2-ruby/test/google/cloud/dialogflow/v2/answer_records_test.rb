...
class ::Google::Cloud::Dialogflow::V2::AnswerRecords::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_answer_records
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2::ListAnswerRecordsResponse.new
    ...
    list_answer_records_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2::ListAnswerRecordsRequest, request
  ...
  def test_update_answer_record
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2::AnswerRecord.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    update_answer_record_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2::UpdateAnswerRecordRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::V2::AnswerRecord), request["answer_record"]
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2::AnswerRecords::Client::Configuration, config
  end
end
