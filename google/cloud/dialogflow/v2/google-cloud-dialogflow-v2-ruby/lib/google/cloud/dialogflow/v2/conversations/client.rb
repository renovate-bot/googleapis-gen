      ...
      module V2
        module Conversations
          ...
          class Client
            ...
            #
            # @overload create_call_matcher(request, options = nil)
            #   Pass arguments to `create_call_matcher` via a request object, either of type
            #   {::Google::Cloud::Dialogflow::V2::CreateCallMatcherRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2::CreateCallMatcherRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @overload create_call_matcher(parent: nil, call_matcher: nil)
            #   Pass arguments to `create_call_matcher` via keyword arguments. Note that at
            #   least one keyword argument is required. To specify no parameters, or to keep all
            #   the default parameter values, pass an empty Hash as a request object (see above).
            #
            #   @param parent [::String]
            ...
            #     Format: `projects/<Project ID>/locations/<Location
            #     ID>/conversations/<Conversation ID>`.
            #   @param call_matcher [::Google::Cloud::Dialogflow::V2::CallMatcher, ::Hash]
            #     Required. The call matcher to create.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Dialogflow::V2::CallMatcher]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            def create_call_matcher request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2::CreateCallMatcherRequest

              # Converts hash and nil to an options object
              options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

              # Customize the options with defaults
              metadata = @config.rpcs.create_call_matcher.metadata.to_h
              ...
              options.apply_defaults timeout:      @config.rpcs.create_call_matcher.timeout,
                                     metadata:     metadata,
                                     retry_policy: @config.rpcs.create_call_matcher.retry_policy
              options.apply_defaults metadata:     @config.metadata,
                                     retry_policy: @config.retry_policy

              @conversations_stub.call_rpc :create_call_matcher, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            #
            # @overload list_call_matchers(request, options = nil)
            #   Pass arguments to `list_call_matchers` via a request object, either of type
            #   {::Google::Cloud::Dialogflow::V2::ListCallMatchersRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2::ListCallMatchersRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @overload list_call_matchers(parent: nil, page_size: nil, page_token: nil)
            #   Pass arguments to `list_call_matchers` via keyword arguments. Note that at
            #   least one keyword argument is required. To specify no parameters, or to keep all
            #   the default parameter values, pass an empty Hash as a request object (see above).
            #
            #   @param parent [::String]
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2::CallMatcher>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2::CallMatcher>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            def list_call_matchers request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2::ListCallMatchersRequest

              # Converts hash and nil to an options object
              options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

              # Customize the options with defaults
              metadata = @config.rpcs.list_call_matchers.metadata.to_h
              ...
              options.apply_defaults timeout:      @config.rpcs.list_call_matchers.timeout,
                                     metadata:     metadata,
                                     retry_policy: @config.rpcs.list_call_matchers.retry_policy
              options.apply_defaults metadata:     @config.metadata,
                                     retry_policy: @config.retry_policy

              @conversations_stub.call_rpc :list_call_matchers, request, options: options do |response, operation|
                response = ::Gapic::PagedEnumerable.new @conversations_stub, :list_call_matchers, request, response, operation, options
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            #
            # @overload delete_call_matcher(request, options = nil)
            #   Pass arguments to `delete_call_matcher` via a request object, either of type
            #   {::Google::Cloud::Dialogflow::V2::DeleteCallMatcherRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2::DeleteCallMatcherRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @overload delete_call_matcher(name: nil)
            #   Pass arguments to `delete_call_matcher` via keyword arguments. Note that at
            #   least one keyword argument is required. To specify no parameters, or to keep all
            #   the default parameter values, pass an empty Hash as a request object (see above).
            #
            #   @param name [::String]
            ...
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            def delete_call_matcher request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2::DeleteCallMatcherRequest

              # Converts hash and nil to an options object
              options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

              # Customize the options with defaults
              metadata = @config.rpcs.delete_call_matcher.metadata.to_h
              ...
              options.apply_defaults timeout:      @config.rpcs.delete_call_matcher.timeout,
                                     metadata:     metadata,
                                     retry_policy: @config.rpcs.delete_call_matcher.retry_policy
              options.apply_defaults metadata:     @config.metadata,
                                     retry_policy: @config.retry_policy

              @conversations_stub.call_rpc :delete_call_matcher, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            class Configuration
              ...
              class Rpcs
                ...
                ##
                # RPC-specific configuration for `create_call_matcher`
                # @return [::Gapic::Config::Method]
                #
                attr_reader :create_call_matcher
                ##
                # RPC-specific configuration for `list_call_matchers`
                # @return [::Gapic::Config::Method]
                #
                attr_reader :list_call_matchers
                ##
                # RPC-specific configuration for `delete_call_matcher`
                # @return [::Gapic::Config::Method]
                #
                attr_reader :delete_call_matcher
                ##
                ...
                def initialize parent_rpcs = nil
                  ...
                  create_call_matcher_config = parent_rpcs&.create_call_matcher if parent_rpcs&.respond_to? :create_call_matcher
                  @create_call_matcher = ::Gapic::Config::Method.new create_call_matcher_config
                  list_call_matchers_config = parent_rpcs&.list_call_matchers if parent_rpcs&.respond_to? :list_call_matchers
                  @list_call_matchers = ::Gapic::Config::Method.new list_call_matchers_config
                  delete_call_matcher_config = parent_rpcs&.delete_call_matcher if parent_rpcs&.respond_to? :delete_call_matcher
                  @delete_call_matcher = ::Gapic::Config::Method.new delete_call_matcher_config
