...
namespace Google.Cloud.Dialogflow.V2
{
    ...
    public sealed partial class KnowledgeBasesClientBuilder : gaxgrpc::ClientBuilderBase<KnowledgeBasesClient>
    {
        ...
        private KnowledgeBasesClient BuildImpl()
        {
            ...
            return KnowledgeBasesClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => KnowledgeBasesClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => KnowledgeBasesClient.DefaultScopes;
    ...
    public abstract partial class KnowledgeBasesClient
    {
        ...
        /// <returns>The created <see cref="KnowledgeBasesClient"/>.</returns>
        internal static KnowledgeBasesClient Create(grpccore::CallInvoker callInvoker, KnowledgeBasesSettings settings = null)
        {
            ...
            return new KnowledgeBasesClientImpl(grpcClient, settings);
        }
    ...
    public sealed partial class KnowledgeBasesClientImpl : KnowledgeBasesClient
    {
        ...
        public KnowledgeBasesClientImpl(KnowledgeBases.KnowledgeBasesClient grpcClient, KnowledgeBasesSettings settings)
        {
            GrpcClient = grpcClient;
            KnowledgeBasesSettings effectiveSettings = settings ?? KnowledgeBasesSettings.GetDefault();
            gaxgrpc::ClientHelper clientHelper = new gaxgrpc::ClientHelper(effectiveSettings);
            _callListKnowledgeBases = clientHelper.BuildApiCall<ListKnowledgeBasesRequest, ListKnowledgeBasesResponse>(grpcClient.ListKnowledgeBasesAsync, grpcClient.ListKnowledgeBases, effectiveSettings.ListKnowledgeBasesSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callListKnowledgeBases);
            Modify_ListKnowledgeBasesApiCall(ref _callListKnowledgeBases);
            _callGetKnowledgeBase = clientHelper.BuildApiCall<GetKnowledgeBaseRequest, KnowledgeBase>(grpcClient.GetKnowledgeBaseAsync, grpcClient.GetKnowledgeBase, effectiveSettings.GetKnowledgeBaseSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callGetKnowledgeBase);
            Modify_GetKnowledgeBaseApiCall(ref _callGetKnowledgeBase);
            _callCreateKnowledgeBase = clientHelper.BuildApiCall<CreateKnowledgeBaseRequest, KnowledgeBase>(grpcClient.CreateKnowledgeBaseAsync, grpcClient.CreateKnowledgeBase, effectiveSettings.CreateKnowledgeBaseSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callCreateKnowledgeBase);
            Modify_CreateKnowledgeBaseApiCall(ref _callCreateKnowledgeBase);
            _callDeleteKnowledgeBase = clientHelper.BuildApiCall<DeleteKnowledgeBaseRequest, wkt::Empty>(grpcClient.DeleteKnowledgeBaseAsync, grpcClient.DeleteKnowledgeBase, effectiveSettings.DeleteKnowledgeBaseSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callDeleteKnowledgeBase);
            Modify_DeleteKnowledgeBaseApiCall(ref _callDeleteKnowledgeBase);
            _callUpdateKnowledgeBase = clientHelper.BuildApiCall<UpdateKnowledgeBaseRequest, KnowledgeBase>(grpcClient.UpdateKnowledgeBaseAsync, grpcClient.UpdateKnowledgeBase, effectiveSettings.UpdateKnowledgeBaseSettings).WithGoogleRequestParam("knowledge_base.name", request => request.KnowledgeBase?.Name);
