...
public final class SessionEntityTypeProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tityTypesResponse\"\264\002\202\323\344\223\002\244\002\0224/v2/{parent" +
      "=projects/*/agent/sessions/*}/entityType" +
      "sZM\022K/v2/{parent=projects/*/agent/enviro" +
      "nments/*/users/*/sessions/*}/entityTypes" +
      "ZB\022@/v2/{parent=projects/*/locations/*/a" +
      "gent/sessions/*}/entityTypesZY\022W/v2/{par" +
      "ent=projects/*/locations/*/agent/environ" +
      "ments/*/users/*/sessions/*}/entityTypes\332" +
      "A\006parent\022\263\003\n\024GetSessionEntityType\0227.goog" +
      "le.cloud.dialogflow.v2.GetSessionEntityT" +
      "ypeRequest\032-.google.cloud.dialogflow.v2." +
      "SessionEntityType\"\262\002\202\323\344\223\002\244\002\0224/v2/{name=p" +
      "rojects/*/agent/sessions/*/entityTypes/*" +
      "}ZM\022K/v2/{name=projects/*/agent/environm" +
      "ents/*/users/*/sessions/*/entityTypes/*}" +
      "ZB\022@/v2/{name=projects/*/locations/*/age" +
      "nt/sessions/*/entityTypes/*}ZY\022W/v2/{nam" +
      "e=projects/*/locations/*/agent/environme" +
      "nts/*/users/*/sessions/*/entityTypes/*}\332" +
      "A\004name\022\243\004\n\027CreateSessionEntityType\022:.goo" +
      "gle.cloud.dialogflow.v2.CreateSessionEnt" +
      "ityTypeRequest\032-.google.cloud.dialogflow" +
      ".v2.SessionEntityType\"\234\003\202\323\344\223\002\370\002\"4/v2/{pa" +
      "rent=projects/*/agent/sessions/*}/entity" +
      "Types:\023session_entity_typeZb\"K/v2/{paren" +
      "t=projects/*/agent/environments/*/users/" +
      "*/sessions/*}/entityTypes:\023session_entit" +
      "y_typeZW\"@/v2/{parent=projects/*/locatio" +
      "ns/*/agent/sessions/*}/entityTypes:\023sess" +
      "ion_entity_typeZn\"W/v2/{parent=projects/" +
      "*/locations/*/agent/environments/*/users" +
      "/*/sessions/*}/entityTypes:\023session_enti" +
      "ty_type\332A\032parent,session_entity_type\022\217\005\n" +
      "\027UpdateSessionEntityType\022:.google.cloud." +
      "dialogflow.v2.UpdateSessionEntityTypeReq" +
      "uest\032-.google.cloud.dialogflow.v2.Sessio" +
      "nEntityType\"\210\004\202\323\344\223\002\311\0032H/v2/{session_enti" +
      "ty_type.name=projects/*/agent/sessions/*" +
      "/entityTypes/*}:\023session_entity_typeZv2_" +
      "/v2/{session_entity_type.name=projects/*" +
      "/agent/environments/*/users/*/sessions/*" +
      "/entityTypes/*}:\023session_entity_typeZk2T" +
      "/v2/{session_entity_type.name=projects/*" +
      "/locations/*/agent/sessions/*/entityType" +
      "s/*}:\023session_entity_typeZ\202\0012k/v2/{sessi" +
      "on_entity_type.name=projects/*/locations" +
      "/*/agent/environments/*/users/*/sessions" +
      "/*/entityTypes/*}:\023session_entity_type\332A" +
      "\023session_entity_type\332A\037session_entity_ty" +
      "pe,update_mask\022\242\003\n\027DeleteSessionEntityTy" +
      "pe\022:.google.cloud.dialogflow.v2.DeleteSe" +
      "ssionEntityTypeRequest\032\026.google.protobuf" +
      ".Empty\"\262\002\202\323\344\223\002\244\002*4/v2/{name=projects/*/a" +
      "gent/sessions/*/entityTypes/*}ZM*K/v2/{n" +
      "ame=projects/*/agent/environments/*/user" +
      "s/*/sessions/*/entityTypes/*}ZB*@/v2/{na" +
      "me=projects/*/locations/*/agent/sessions" +
      "/*/entityTypes/*}ZY*W/v2/{name=projects/" +
      "*/locations/*/agent/environments/*/users" +
