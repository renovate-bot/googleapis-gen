...
public interface EnvironmentHistoryOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.dialogflow.v2.EnvironmentHistory.Entry entries = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.dialogflow.v2.EnvironmentHistory.Entry> 
      getEntriesList();
  /**
   * <pre>
   * Output only. The list of agent environments. There will be a maximum number of items
   ...
   * <code>repeated .google.cloud.dialogflow.v2.EnvironmentHistory.Entry entries = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.dialogflow.v2.EnvironmentHistory.EntryOrBuilder getEntriesOrBuilder(
      int index);
