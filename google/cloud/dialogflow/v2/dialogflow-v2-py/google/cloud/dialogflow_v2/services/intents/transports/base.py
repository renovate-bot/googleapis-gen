...
class IntentsTransport(abc.ABC):
    ...
    @property
    def list_intents(self) -> typing.Callable[
            [intent.ListIntentsRequest],
            typing.Union[
                intent.ListIntentsResponse,
                typing.Awaitable[intent.ListIntentsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_intent(self) -> typing.Callable[
            [intent.GetIntentRequest],
            typing.Union[
                intent.Intent,
                typing.Awaitable[intent.Intent]
            ]]:
        raise NotImplementedError()

    @property
    def create_intent(self) -> typing.Callable[
            [gcd_intent.CreateIntentRequest],
            typing.Union[
                gcd_intent.Intent,
                typing.Awaitable[gcd_intent.Intent]
            ]]:
        raise NotImplementedError()

    @property
    def update_intent(self) -> typing.Callable[
    ...
    @property
    def delete_intent(self) -> typing.Callable[
    ...
    @property
    def batch_update_intents(self) -> typing.Callable[
    ...
    @property
    def batch_delete_intents(self) -> typing.Callable[
