...
class FulfillmentsTransport(abc.ABC):
    ...
    @property
    def get_fulfillment(self) -> typing.Callable[
            [fulfillment.GetFulfillmentRequest],
            typing.Union[
                fulfillment.Fulfillment,
                typing.Awaitable[fulfillment.Fulfillment]
            ]]:
        raise NotImplementedError()

    @property
    def update_fulfillment(self) -> typing.Callable[
            [gcd_fulfillment.UpdateFulfillmentRequest],
            typing.Union[
                gcd_fulfillment.Fulfillment,
                typing.Awaitable[gcd_fulfillment.Fulfillment]
            ]]:
        raise NotImplementedError()
