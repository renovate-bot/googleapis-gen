...
from google.cloud.dialogflow_v2.services.conversations import ConversationsAsyncClient
from google.cloud.dialogflow_v2.services.conversations import ConversationsClient
from google.cloud.dialogflow_v2.services.conversations import pagers
from google.cloud.dialogflow_v2.services.conversations import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert ConversationsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert ConversationsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ConversationsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ConversationsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert ConversationsClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ConversationsAsyncClient, transports.ConversationsGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_conversations_client_client_options(client_class, transport_class, transport_name):
...
def test_conversations_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_conversations_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_conversations_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_conversations_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflow_v2.services.conversations.transports.ConversationsGrpcTransport.__init__') as grpc_transport:
...
def test_create_conversation(transport: str = 'grpc', request_type=gcd_conversation.CreateConversationRequest):
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_conversations(transport: str = 'grpc', request_type=conversation.ListConversationsRequest):
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_conversations_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, conversation.Conversation)
                   for i in results)
...
def test_create_call_matcher(transport: str = 'grpc', request_type=conversation.CreateCallMatcherRequest):
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_call_matcher),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = conversation.CallMatcher(
            name='name_value',

            to_header='to_header_value',

            from_header='from_header_value',

            call_id_header='call_id_header_value',

        )

        response = client.create_call_matcher(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]

        assert args[0] == conversation.CreateCallMatcherRequest()

    # Establish that the response is the type that we expect.

    assert isinstance(response, conversation.CallMatcher)

    assert response.name == 'name_value'

    assert response.to_header == 'to_header_value'

    assert response.from_header == 'from_header_value'

    assert response.call_id_header == 'call_id_header_value'


def test_create_call_matcher_from_dict():
    test_create_call_matcher(request_type=dict)


def test_create_call_matcher_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_call_matcher_async(transport: str = 'grpc_asyncio', request_type=conversation.CreateCallMatcherRequest):
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(conversation.CallMatcher(
            name='name_value',
            to_header='to_header_value',
            from_header='from_header_value',
            call_id_header='call_id_header_value',
        ...
        response = await client.create_call_matcher(request)
...
@pytest.mark.asyncio
async def test_create_call_matcher_async_from_dict():
    await test_create_call_matcher_async(request_type=dict)


def test_create_call_matcher_field_headers():
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.create_call_matcher(request)
...
@pytest.mark.asyncio
async def test_create_call_matcher_field_headers_async():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        await client.create_call_matcher(request)
...
def test_create_call_matcher_flattened():
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.create_call_matcher(
            parent='parent_value',
            call_matcher=conversation.CallMatcher(name='name_value'),
        )
        ...
        assert args[0].call_matcher == conversation.CallMatcher(name='name_value')
...
@pytest.mark.asyncio
async def test_create_call_matcher_flattened_async():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_call_matcher(
            parent='parent_value',
            call_matcher=conversation.CallMatcher(name='name_value'),
        )
...
@pytest.mark.asyncio
async def test_create_call_matcher_flattened_error_async():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_call_matcher(
            conversation.CreateCallMatcherRequest(),
            parent='parent_value',
            call_matcher=conversation.CallMatcher(name='name_value'),
        )
...
def test_list_call_matchers(transport: str = 'grpc', request_type=conversation.ListCallMatchersRequest):
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_call_matchers),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = conversation.ListCallMatchersResponse(
            next_page_token='next_page_token_value',

        )

        response = client.list_call_matchers(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]

        assert args[0] == conversation.ListCallMatchersRequest()

    # Establish that the response is the type that we expect.

    assert isinstance(response, pagers.ListCallMatchersPager)

    assert response.next_page_token == 'next_page_token_value'


def test_list_call_matchers_from_dict():
    test_list_call_matchers(request_type=dict)


def test_list_call_matchers_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_list_call_matchers_async(transport: str = 'grpc_asyncio', request_type=conversation.ListCallMatchersRequest):
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(conversation.ListCallMatchersResponse(
            next_page_token='next_page_token_value',
        ))

        response = await client.list_call_matchers(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListCallMatchersAsyncPager)

    assert response.next_page_token == 'next_page_token_value'


@pytest.mark.asyncio
async def test_list_call_matchers_async_from_dict():
    await test_list_call_matchers_async(request_type=dict)


def test_list_call_matchers_field_headers():
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.list_call_matchers(request)
...
@pytest.mark.asyncio
async def test_list_call_matchers_field_headers_async():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        await client.list_call_matchers(request)
...
def test_list_call_matchers_flattened():
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
    )
...
def test_list_call_matchers_flattened_error():
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_call_matchers_flattened_async():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_call_matchers(
            parent='parent_value',
        )
...
@pytest.mark.asyncio
async def test_list_call_matchers_flattened_error_async():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_call_matchers(
            conversation.ListCallMatchersRequest(),
            parent='parent_value',
        )


def test_list_call_matchers_pager():
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials,
    )
    ...
    with mock.patch.object(
        ...
        pager = client.list_call_matchers(request={})

        assert pager._metadata == metadata

        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, conversation.CallMatcher)
                   for i in results)

def test_list_call_matchers_pages():
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_call_matchers(request={}).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token

@pytest.mark.asyncio
async def test_list_call_matchers_async_pager():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials,
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_call_matchers(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager:
            responses.append(response)
...
@pytest.mark.asyncio
async def test_list_call_matchers_async_pages():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials,
    )
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_call_matchers(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token


def test_delete_call_matcher(transport: str = 'grpc', request_type=conversation.DeleteCallMatcherRequest):
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_call_matcher),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None

        response = client.delete_call_matcher(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]

        assert args[0] == conversation.DeleteCallMatcherRequest()

    # Establish that the response is the type that we expect.
    assert response is None


def test_delete_call_matcher_from_dict():
    test_delete_call_matcher(request_type=dict)


def test_delete_call_matcher_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_call_matcher_async(transport: str = 'grpc_asyncio', request_type=conversation.DeleteCallMatcherRequest):
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.delete_call_matcher(request)
...
@pytest.mark.asyncio
async def test_delete_call_matcher_async_from_dict():
    await test_delete_call_matcher_async(request_type=dict)


def test_delete_call_matcher_field_headers():
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.delete_call_matcher(request)
...
@pytest.mark.asyncio
async def test_delete_call_matcher_field_headers_async():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_call_matcher(request)
...
def test_delete_call_matcher_flattened():
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
    )
...
def test_delete_call_matcher_flattened_error():
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_call_matcher_flattened_async():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_call_matcher(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_delete_call_matcher_flattened_error_async():
    client = ConversationsAsyncClient(
        credentials=credentials.AnonymousCredentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_call_matcher(
            conversation.DeleteCallMatcherRequest(),
            name='name_value',
        )


def test_list_messages(transport: str = 'grpc', request_type=conversation.ListMessagesRequest):
    client = ConversationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_messages_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, participant.Message)
                   for i in results)
...
def test_conversations_base_transport():
    ...
    with mock.patch('google.cloud.dialogflow_v2.services.conversations.transports.ConversationsTransport.__init__') as Transport:
...
def test_conversations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.dialogflow_v2.services.conversations.transports.ConversationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_conversations_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.dialogflow_v2.services.conversations.transports.ConversationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ConversationsTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.ConversationsGrpcTransport, transports.ConversationsGrpcAsyncIOTransport])
def test_conversations_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.ConversationsGrpcTransport, transports.ConversationsGrpcAsyncIOTransport])
def test_conversations_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ConversationsGrpcTransport, transports.ConversationsGrpcAsyncIOTransport])
def test_conversations_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_call_matcher_path():
    ...
    expected = "projects/{project}/conversations/{conversation}/callMatchers/{call_matcher}".format(project=project, conversation=conversation, call_matcher=call_matcher, )
    actual = ConversationsClient.call_matcher_path(project, conversation, call_matcher)
    assert expected == actual


def test_parse_call_matcher_path():
    expected = {
    "project": "octopus",
    "conversation": "oyster",
    "call_matcher": "nudibranch",

    }
    path = ConversationsClient.call_matcher_path(**expected)

    # Check that the path construction is reversible.
    actual = ConversationsClient.parse_call_matcher_path(path)
    assert expected == actual
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.ConversationsTransport, '_prep_wrapped_messages') as prep:
        client = ConversationsClient(
            credentials=credentials.AnonymousCredentials(),
