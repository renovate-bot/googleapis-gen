...
from google.cloud.dialogflow_v2.services.contexts.transports.base import _API_CORE_VERSION
from google.cloud.dialogflow_v2.services.contexts.transports.base import _GOOGLE_AUTH_VERSION
...
def test_contexts_client_client_options_from_dict():
    with mock.patch('google.cloud.dialogflow_v2.services.contexts.transports.ContextsGrpcTransport.__init__') as grpc_transport:
...
def test_contexts_base_transport():
    ...
    with mock.patch('google.cloud.dialogflow_v2.services.contexts.transports.ContextsTransport.__init__') as Transport:
...
def test_contexts_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2.services.contexts.transports.ContextsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_contexts_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2.services.contexts.transports.ContextsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ContextsTransport()
        adc.assert_called_once()
