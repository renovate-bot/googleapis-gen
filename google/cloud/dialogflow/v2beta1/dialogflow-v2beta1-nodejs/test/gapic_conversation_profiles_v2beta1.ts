...
describe('v2beta1.ConversationProfilesClient', () => {
    it('has servicePath', () => {
        const servicePath = conversationprofilesModule.v2beta1.ConversationProfilesClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = conversationprofilesModule.v2beta1.ConversationProfilesClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = conversationprofilesModule.v2beta1.ConversationProfilesClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new conversationprofilesModule.v2beta1.ConversationProfilesClient();
        assert(client);
    });
    ...
    describe('getConversationProfile', () => {
        it('invokes getConversationProfile without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.GetConversationProfileRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.ConversationProfile());
        ...
        it('invokes getConversationProfile without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getConversationProfile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IConversationProfile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createConversationProfile', () => {
        it('invokes createConversationProfile without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.CreateConversationProfileRequest());
            request.parent = '';
    ...
    describe('deleteConversationProfile', () => {
        it('invokes deleteConversationProfile without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.DeleteConversationProfileRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listConversationProfiles', () => {
        it('invokes listConversationProfiles without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.ListConversationProfilesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.ConversationProfile()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.ConversationProfile()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.ConversationProfile()),
            ];
        ...
        it('invokes listConversationProfilesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.ConversationProfile) => {
