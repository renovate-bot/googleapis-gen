...
describe('v2beta1.ParticipantsClient', () => {
    ...
    describe('createParticipant', () => {
        it('invokes createParticipant without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.Participant());
    ...
    describe('analyzeContent', () => {
        it('invokes analyzeContent without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.AnalyzeContentResponse());
    ...
    describe('suggestArticles', () => {
        it('invokes suggestArticles without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.SuggestArticlesResponse());
    ...
    describe('suggestFaqAnswers', () => {
        it('invokes suggestFaqAnswers without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.SuggestFaqAnswersResponse());
    ...
    describe('suggestSmartReplies', () => {
        it('invokes suggestSmartReplies without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.SuggestSmartRepliesResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.suggestSmartReplies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('compileSuggestion', () => {
        it('invokes compileSuggestion without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.CompileSuggestionResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.compileSuggestion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listSuggestions', () => {
        it('invokes listSuggestions without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listSuggestions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
