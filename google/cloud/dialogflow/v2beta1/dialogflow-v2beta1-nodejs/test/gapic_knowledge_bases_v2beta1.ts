...
describe('v2beta1.KnowledgeBasesClient', () => {
    ...
    describe('getKnowledgeBase', () => {
        it('invokes getKnowledgeBase without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.KnowledgeBase());
        ...
        it('invokes getKnowledgeBase without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getKnowledgeBase(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.IKnowledgeBase|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
