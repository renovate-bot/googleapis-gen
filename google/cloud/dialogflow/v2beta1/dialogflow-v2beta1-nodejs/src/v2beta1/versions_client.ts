...
export class VersionsClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2beta1.Versions', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.versionsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2beta1.Versions') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2beta1.Versions,
  ...
  // -------------------
  getVersion(
      request: protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IVersion,
        protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest|undefined, {}|undefined
      ]>;
  getVersion(
      request: protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IVersion,
          protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest|null|undefined,
          {}|null|undefined>): void;
  getVersion(
      request: protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest,
      callback: Callback<
 ...
 */
  ...
  createVersion(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IVersion,
        protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest|undefined, {}|undefined
      ]>;
  createVersion(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IVersion,
          protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest|null|undefined,
          {}|null|undefined>): void;
  createVersion(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest,
      callback: Callback<
 ...
 */
  ...
  updateVersion(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IVersion,
        protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest|undefined, {}|undefined
      ]>;
  updateVersion(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IVersion,
          protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest|null|undefined,
          {}|null|undefined>): void;
  updateVersion(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest,
      callback: Callback<
 ...
 */
  ...
  deleteVersion(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest|undefined, {}|undefined
      ]>;
  deleteVersion(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest|null|undefined,
          {}|null|undefined>): void;
  deleteVersion(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest,
      callback: Callback<
 ...
 */
  ...
  listVersions(
      request: protos.google.cloud.dialogflow.v2beta1.IListVersionsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IVersion[],
  ...
  listVersions(
      ...
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListVersionsRequest,
          protos.google.cloud.dialogflow.v2beta1.IListVersionsResponse|null|undefined,
          protos.google.cloud.dialogflow.v2beta1.IVersion>): void;
  listVersions(
      request: protos.google.cloud.dialogflow.v2beta1.IListVersionsRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListVersionsRequest,
 ...
 */
  listVersionsAsync(
      request?: protos.google.cloud.dialogflow.v2beta1.IListVersionsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IVersion>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listVersions.asyncIterate(
      ...
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IVersion>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
