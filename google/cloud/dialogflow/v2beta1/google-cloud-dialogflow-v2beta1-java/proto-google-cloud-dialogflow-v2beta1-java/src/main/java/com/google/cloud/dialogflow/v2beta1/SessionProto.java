...
public final class SessionProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "GITS\020\003\022\033\n\027END_OF_SINGLE_UTTERANCE\020\002\022\027\n\023P" +
      "ARTIAL_DTMF_DIGITS\020\004\"0\n\tTextInput\022\014\n\004tex" +
      "t\030\001 \001(\t\022\025\n\rlanguage_code\030\002 \001(\t\"^\n\nEventI" +
      "nput\022\014\n\004name\030\001 \001(\t\022+\n\nparameters\030\002 \001(\0132\027" +
      ".google.protobuf.Struct\022\025\n\rlanguage_code" +
      "\030\003 \001(\t\"F\n\036SentimentAnalysisRequestConfig" +
      ...
      "\347\003\n\014DetectIntent\0224.google.cloud.dialogfl" +
      "ow.v2beta1.DetectIntentRequest\0325.google." +
      "cloud.dialogflow.v2beta1.DetectIntentRes" +
      "ponse\"\351\002\202\323\344\223\002\314\002\";/v2beta1/{session=proje" +
      "cts/*/agent/sessions/*}:detectIntent:\001*Z" +
      "W\"R/v2beta1/{session=projects/*/agent/en" +
      "vironments/*/users/*/sessions/*}:detectI" +
      "ntent:\001*ZL\"G/v2beta1/{session=projects/*" +
      "/locations/*/agent/sessions/*}:detectInt" +
      "ent:\001*Zc\"^/v2beta1/{session=projects/*/l" +
      "ocations/*/agent/environments/*/users/*/" +
      "sessions/*}:detectIntent:\001*\332A\023session,qu" +
      "ery_input\022\234\001\n\025StreamingDetectIntent\022=.go" +
      "ogle.cloud.dialogflow.v2beta1.StreamingD" +
      "etectIntentRequest\032>.google.cloud.dialog" +
      "flow.v2beta1.StreamingDetectIntentRespon" +
      "se\"\000(\0010\001\032x\312A\031dialogflow.googleapis.com\322A" +
      "Yhttps://www.googleapis.com/auth/cloud-p" +
      "latform,https://www.googleapis.com/auth/" +
      "dialogflowB\377\003\n#com.google.cloud.dialogfl" +
      "ow.v2beta1B\014SessionProtoP\001ZIgoogle.golan" +
      "g.org/genproto/googleapis/cloud/dialogfl" +
      "ow/v2beta1;dialogflow\370\001\001\242\002\002DF\252\002\037Google.C" +
      "loud.Dialogflow.V2beta1\352A\321\002\n!dialogflow." +
      "googleapis.com/Session\022+projects/{projec" +
      "t}/agent/sessions/{session}\022Sprojects/{p" +
      "roject}/agent/environments/{environment}" +
      "/users/{user}/sessions/{session}\022@projec" +
      "ts/{project}/locations/{location}/agent/" +
      "sessions/{session}\022hprojects/{project}/l" +
