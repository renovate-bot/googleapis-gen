# Ruby Client for the Dialogflow V2beta1 API

API Client library for the Dialogflow V2beta1 API
...
specific version of the Dialogflow V2beta1 API. Most users should consider using
the main client gem,
