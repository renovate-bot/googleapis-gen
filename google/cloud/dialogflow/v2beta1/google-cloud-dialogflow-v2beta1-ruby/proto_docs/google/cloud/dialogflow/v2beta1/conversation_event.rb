  ...
  module Cloud
    module Dialogflow
      module V2beta1
        ...
        # @!attribute [rw] type
        #   @return [::Google::Cloud::Dialogflow::V2beta1::ConversationEvent::Type]
        ...
        class ConversationEvent
          ...
          module Type
            ...
            # {::Google::Cloud::Dialogflow::V2beta1::ConversationProfile#new_message_event_notification_config ConversationProfile.new_message_event_notification_config}
            NEW_MESSAGE = 5
