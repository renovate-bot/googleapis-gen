    ...
    module Dialogflow
      module V2beta1
        ...
        class HumanAgentAssistantConfig
          ...
          #     For {::Google::Cloud::Dialogflow::V2beta1::Participants::Client#analyze_content Participants.AnalyzeContent} method, result will be in
          #     {::Google::Cloud::Dialogflow::V2beta1::AnalyzeContentResponse#message AnalyzeContentResponse.message.SentimentAnalysisResult}
          #     For {::Google::Cloud::Dialogflow::V2beta1::Conversations::Client#list_messages Conversations.ListMessages} method, result will be in
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client#list_conversation_profiles ConversationProfiles.ListConversationProfiles}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # The response message for {::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client#list_conversation_profiles ConversationProfiles.ListConversationProfiles}.
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client#get_conversation_profile ConversationProfiles.GetConversationProfile}.
        # @!attribute [rw] name
        #   @return [::String]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client#create_conversation_profile ConversationProfiles.CreateConversationProfile}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client#update_conversation_profile ConversationProfiles.UpdateConversationProfile}.
        # @!attribute [rw] conversation_profile
        #   @return [::Google::Cloud::Dialogflow::V2beta1::ConversationProfile]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client#delete_conversation_profile ConversationProfiles.DeleteConversationProfile}.
        #
