  ...
  module Cloud
    module Dialogflow
      module V2beta1
        ...
        #       ID>`
        # @!attribute [r] state
        #   @return [::Google::Cloud::Dialogflow::V2beta1::Environment::State]
        ...
        #   @return [::Google::Protobuf::Map{::String => ::Google::Cloud::Dialogflow::V2beta1::SynthesizeSpeechConfig}]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Environments::Client#list_environments Environments.ListEnvironments}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # The response message for {::Google::Cloud::Dialogflow::V2beta1::Environments::Client#list_environments Environments.ListEnvironments}.
        # @!attribute [rw] environments
        #   @return [::Array<::Google::Cloud::Dialogflow::V2beta1::Environment>]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Environments::Client#get_environment Environments.GetEnvironment}.
        # @!attribute [rw] name
        #   @return [::String]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Environments::Client#create_environment Environments.CreateEnvironment}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Environments::Client#update_environment Environments.UpdateEnvironment}.
        # @!attribute [rw] environment
        #   @return [::Google::Cloud::Dialogflow::V2beta1::Environment]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Environments::Client#delete_environment Environments.DeleteEnvironment}.
        # @!attribute [rw] name
        #   @return [::String]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Environments::Client#get_environment_history Environments.GetEnvironmentHistory}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # The response message for {::Google::Cloud::Dialogflow::V2beta1::Environments::Client#get_environment_history Environments.GetEnvironmentHistory}.
        # @!attribute [r] parent
        #   @return [::String]
        ...
        #        ID>/agent/environments/<Environment ID>`
        # @!attribute [r] entries
        #   @return [::Array<::Google::Cloud::Dialogflow::V2beta1::EnvironmentHistory::Entry>]
