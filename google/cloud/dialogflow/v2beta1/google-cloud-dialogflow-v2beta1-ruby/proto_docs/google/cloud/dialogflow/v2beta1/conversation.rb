  ...
  module Cloud
    module Dialogflow
      module V2beta1
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Conversations::Client#create_conversation Conversations.CreateConversation}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Conversations::Client#list_conversations Conversations.ListConversations}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # The response message for {::Google::Cloud::Dialogflow::V2beta1::Conversations::Client#list_conversations Conversations.ListConversations}.
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Conversations::Client#get_conversation Conversations.GetConversation}.
        # @!attribute [rw] name
        #   @return [::String]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Conversations::Client#complete_conversation Conversations.CompleteConversation}.
        # @!attribute [rw] name
        #   @return [::String]
        ...
        # The request message for {::Google::Cloud::Dialogflow::V2beta1::Conversations::Client#list_messages Conversations.ListMessages}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # The response message for {::Google::Cloud::Dialogflow::V2beta1::Conversations::Client#list_messages Conversations.ListMessages}.
        # @!attribute [rw] messages
        #   @return [::Array<::Google::Cloud::Dialogflow::V2beta1::Message>]
