  ...
  module Cloud
    module Dialogflow
      module V2beta1
        ...
        # an error will be returned in the {::Google::Cloud::Dialogflow::V2beta1::QueryResult#diagnostic_info QueryResult.diagnostic_info} field.
        ...
        #     {::Google::Cloud::Dialogflow::V2beta1::QueryResult#fulfillment_text QueryResult.fulfillment_text} sent to the integration or API caller.
        # @!attribute [rw] fulfillment_messages
        #   @return [::Array<::Google::Cloud::Dialogflow::V2beta1::Intent::Message>]
        #     Optional. The rich response messages intended for the end-user.
        #     When provided, Dialogflow uses this field to populate
        #     {::Google::Cloud::Dialogflow::V2beta1::QueryResult#fulfillment_messages QueryResult.fulfillment_messages} sent to the integration or API caller.
        # @!attribute [rw] source
        #   @return [::String]
        #     Optional. A custom field used to identify the webhook source.
        #     Arbitrary strings are supported.
        #     When provided, Dialogflow uses this field to populate
        #     {::Google::Cloud::Dialogflow::V2beta1::QueryResult#webhook_source QueryResult.webhook_source} sent to the integration or API caller.
        ...
        #     When provided, Dialogflow uses this field to populate
        #     {::Google::Cloud::Dialogflow::V2beta1::QueryResult#webhook_payload QueryResult.webhook_payload} sent to the integration or API caller.
        ...
        #     When provided, Dialogflow uses this field to populate
        #     {::Google::Cloud::Dialogflow::V2beta1::QueryResult#output_contexts QueryResult.output_contexts} sent to the integration or API caller.
        ...
        #     `streamingDetectIntent` or {::Google::Cloud::Dialogflow::V2beta1::SessionEntityType SessionEntityType} management methods.
