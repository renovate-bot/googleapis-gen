...
require "google/cloud/dialogflow/v2beta1/version_pb"
    ...
    module Dialogflow
      module V2beta1
        module Versions
          ...
          #
          # Service for managing {::Google::Cloud::Dialogflow::V2beta1::Version Versions}.
          #
          class Client
            include Paths
            ...
            #
            # See {::Google::Cloud::Dialogflow::V2beta1::Versions::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all Versions clients
            #   ::Google::Cloud::Dialogflow::V2beta1::Versions::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              require "gapic/grpc"
              require "google/cloud/dialogflow/v2beta1/version_services_pb"
              ...
              @versions_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Dialogflow::V2beta1::Versions::Stub,
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::ListVersionsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::ListVersionsRequest, ::Hash]
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::Version>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::Version>]
            #
            ...
            #   request = Google::Cloud::Dialogflow::V2beta1::ListVersionsRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::Dialogflow::V2beta1::Version.
            #     p response
            #   end
            #
            def list_versions request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::ListVersionsRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::GetVersionRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::GetVersionRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Dialogflow::V2beta1::Version]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::GetVersionRequest.new
            #
            #   # Call the get_version method.
            #   result = client.get_version request
            #
            #   # The returned object is of type Google::Cloud::Dialogflow::V2beta1::Version.
            #   p result
            #
            def get_version request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::GetVersionRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::CreateVersionRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::CreateVersionRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     - `projects/<Project ID>/agent`
            #     - `projects/<Project ID>/locations/<Location ID>/agent`
            #   @param version [::Google::Cloud::Dialogflow::V2beta1::Version, ::Hash]
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::CreateVersionRequest.new
            #
            ...
            def create_version request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::CreateVersionRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::UpdateVersionRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::UpdateVersionRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::UpdateVersionRequest.new
            #
            ...
            def update_version request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::UpdateVersionRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::DeleteVersionRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::DeleteVersionRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def delete_version request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::DeleteVersionRequest
            ...
            # {::Google::Cloud::Dialogflow::V2beta1::Versions::Client::Configuration::Rpcs}
