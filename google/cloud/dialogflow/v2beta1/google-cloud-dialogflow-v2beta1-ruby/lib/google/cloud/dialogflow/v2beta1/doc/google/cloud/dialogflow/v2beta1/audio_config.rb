  ...
  module Cloud
    module Dialogflow
      module V2beta1
        ...
        #   @return [Google::Cloud::Dialogflow::V2beta1::AudioEncoding]
        ...
        #   @return [true, false]
        #     If `true`, Dialogflow returns {Google::Cloud::Dialogflow::V2beta1::SpeechWordInfo SpeechWordInfo} in
        #     {Google::Cloud::Dialogflow::V2beta1::StreamingRecognitionResult StreamingRecognitionResult} with information about the recognized speech
        ...
        #   @return [Array<Google::Cloud::Dialogflow::V2beta1::SpeechContext>]
        ...
        #     Which variant of the {Google::Cloud::Dialogflow::V2beta1::InputAudioConfig#model Speech model} to use.
        ...
        #     {Google::Cloud::Dialogflow::V2beta1::VoiceSelectionParams#ssml_gender ssml_gender}.
        #
        #     For the list of available voices, please refer to [Supported voices and
        #     languages](https://cloud.google.com/text-to-speech/docs/voices).
        # @!attribute [rw] ssml_gender
        #   @return [Google::Cloud::Dialogflow::V2beta1::SsmlVoiceGender]
        #     Optional. The preferred gender of the voice. If not set, the service will
        #     choose a voice based on the other parameters such as language_code and
        #     {Google::Cloud::Dialogflow::V2beta1::VoiceSelectionParams#name name}. Note that this is only a preference, not requirement. If a
        ...
        # @!attribute [rw] audio_encoding
        #   @return [Google::Cloud::Dialogflow::V2beta1::OutputAudioEncoding]
        ...
        # Variant of the specified {Google::Cloud::Dialogflow::V2beta1::InputAudioConfig#model Speech model} to use.
        #
        # See the [Cloud Speech
        ...
        module SpeechModelVariant
          ...
          #   {Google::Cloud::Dialogflow::V2beta1::InputAudioConfig#model model} and request language, Dialogflow falls
