      ...
      module V2beta1
        module AnswerRecords
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Dialogflow::V2beta1::AnswerRecords::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all AnswerRecords clients
            #   ::Google::Cloud::Dialogflow::V2beta1::AnswerRecords::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::Dialogflow::V2beta1::AnswerRecords::Client.new
            #
            ...
            def initialize
              ...
              @answer_records_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Dialogflow::V2beta1::AnswerRecords::Stub,
            ...
            #
            # @overload get_answer_record(request, options = nil)
            #   Pass arguments to `get_answer_record` via a request object, either of type
            #   {::Google::Cloud::Dialogflow::V2beta1::GetAnswerRecordRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::GetAnswerRecordRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @overload get_answer_record(name: nil)
            #   Pass arguments to `get_answer_record` via keyword arguments. Note that at
            ...
            # @yieldparam response [::Google::Cloud::Dialogflow::V2beta1::AnswerRecord]
            ...
            #   request = Google::Cloud::Dialogflow::V2beta1::GetAnswerRecordRequest.new
            #
            #   # Call the get_answer_record method.
            #   result = client.get_answer_record request
            #
            #   # The returned object is of type Google::Cloud::Dialogflow::V2beta1::AnswerRecord.
            #   p result
            #
            def get_answer_record request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::GetAnswerRecordRequest

              # Converts hash and nil to an options object
              options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

              # Customize the options with defaults
              metadata = @config.rpcs.get_answer_record.metadata.to_h
              ...
              options.apply_defaults timeout:      @config.rpcs.get_answer_record.timeout,
                                     metadata:     metadata,
                                     retry_policy: @config.rpcs.get_answer_record.retry_policy

              options.apply_defaults timeout:      @config.timeout,
                                     metadata:     @config.metadata,
                                     retry_policy: @config.retry_policy

              @answer_records_stub.call_rpc :get_answer_record, request, options: options do |response, operation|
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::ListAnswerRecordsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::ListAnswerRecordsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @overload list_answer_records(parent: nil, page_size: nil, page_token: nil)
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::AnswerRecord>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::AnswerRecord>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::ListAnswerRecordsRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::Dialogflow::V2beta1::AnswerRecord.
            #     p response
            #   end
            #
            def list_answer_records request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::ListAnswerRecordsRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::UpdateAnswerRecordRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::UpdateAnswerRecordRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::UpdateAnswerRecordRequest.new
            #
            ...
            def update_answer_record request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::UpdateAnswerRecordRequest
            ...
            # {::Google::Cloud::Dialogflow::V2beta1::AnswerRecords::Client::Configuration::Rpcs}
            ...
            #   # get_answer_record to 20 seconds,
            #   # and all remaining timeouts to 10 seconds.
            #   ::Google::Cloud::Dialogflow::V2beta1::AnswerRecords::Client.configure do |config|
            #     config.timeout = 10.0
            #     config.rpcs.get_answer_record.timeout = 20.0
            #   end
            #
            ...
            class Configuration
              ...
              class Rpcs
                ##
                # RPC-specific configuration for `get_answer_record`
                # @return [::Gapic::Config::Method]
                #
                attr_reader :get_answer_record
                ##
                ...
                def initialize parent_rpcs = nil
                  get_answer_record_config = parent_rpcs.get_answer_record if parent_rpcs.respond_to? :get_answer_record
                  @get_answer_record = ::Gapic::Config::Method.new get_answer_record_config
