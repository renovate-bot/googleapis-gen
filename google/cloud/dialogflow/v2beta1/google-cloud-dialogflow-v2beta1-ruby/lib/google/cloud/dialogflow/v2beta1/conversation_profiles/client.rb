      ...
      module V2beta1
        module ConversationProfiles
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all ConversationProfiles clients
            #   ::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client.new
            #
            #   # Create a client using a custom configuration
            #   client = ::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client.new do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @conversation_profiles_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Stub,
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::ListConversationProfilesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::ListConversationProfilesRequest, ::Hash]
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::ConversationProfile>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::ConversationProfile>]
            #
            ...
            #   request = Google::Cloud::Dialogflow::V2beta1::ListConversationProfilesRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::Dialogflow::V2beta1::ConversationProfile.
            #     p response
            #   end
            #
            def list_conversation_profiles request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::ListConversationProfilesRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::GetConversationProfileRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::GetConversationProfileRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Dialogflow::V2beta1::ConversationProfile]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::GetConversationProfileRequest.new
            #
            #   # Call the get_conversation_profile method.
            #   result = client.get_conversation_profile request
            #
            #   # The returned object is of type Google::Cloud::Dialogflow::V2beta1::ConversationProfile.
            #   p result
            #
            def get_conversation_profile request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::GetConversationProfileRequest
            ...
            # {::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client#get_conversation_profile GetConversationProfile} API.
            #
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::CreateConversationProfileRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::CreateConversationProfileRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::CreateConversationProfileRequest.new
            #
            ...
            def create_conversation_profile request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::CreateConversationProfileRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::UpdateConversationProfileRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::UpdateConversationProfileRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::UpdateConversationProfileRequest.new
            #
            ...
            def update_conversation_profile request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::UpdateConversationProfileRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::DeleteConversationProfileRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::DeleteConversationProfileRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::DeleteConversationProfileRequest.new
            #
            ...
            def delete_conversation_profile request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::DeleteConversationProfileRequest
            ...
            # {::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client::Configuration::Rpcs}
