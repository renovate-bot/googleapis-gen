      ...
      module V2beta1
        module Conversations
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Dialogflow::V2beta1::Conversations::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all Conversations clients
            #   ::Google::Cloud::Dialogflow::V2beta1::Conversations::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::Dialogflow::V2beta1::Conversations::Client.new
            #
            #   # Create a client using a custom configuration
            #   client = ::Google::Cloud::Dialogflow::V2beta1::Conversations::Client.new do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @conversations_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Dialogflow::V2beta1::Conversations::Stub,
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::CreateConversationRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::CreateConversationRequest, ::Hash]
            ...
            # @yieldparam response [::Google::Cloud::Dialogflow::V2beta1::Conversation]
            ...
            #   request = Google::Cloud::Dialogflow::V2beta1::CreateConversationRequest.new
            #
            #   # Call the create_conversation method.
            #   result = client.create_conversation request
            #
            #   # The returned object is of type Google::Cloud::Dialogflow::V2beta1::Conversation.
            #   p result
            #
            def create_conversation request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::CreateConversationRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::ListConversationsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::ListConversationsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::Conversation>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::Conversation>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::ListConversationsRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::Dialogflow::V2beta1::Conversation.
            #     p response
            #   end
            #
            def list_conversations request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::ListConversationsRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::GetConversationRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::GetConversationRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::GetConversationRequest.new
            #
            ...
            def get_conversation request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::GetConversationRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::CompleteConversationRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::CompleteConversationRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::CompleteConversationRequest.new
            #
            ...
            def complete_conversation request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::CompleteConversationRequest
            ...
            #
            # @overload batch_create_messages(request, options = nil)
            #   Pass arguments to `batch_create_messages` via a request object, either of type
            #   {::Google::Cloud::Dialogflow::V2beta1::BatchCreateMessagesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::BatchCreateMessagesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @overload batch_create_messages(parent: nil, requests: nil)
            #   Pass arguments to `batch_create_messages` via keyword arguments. Note that at
            #   least one keyword argument is required. To specify no parameters, or to keep all
            #   the default parameter values, pass an empty Hash as a request object (see above).
            #
            #   @param parent [::String]
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Dialogflow::V2beta1::BatchCreateMessagesResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::BatchCreateMessagesRequest.new
            #
            #   # Call the batch_create_messages method.
            #   result = client.batch_create_messages request
            #
            #   # The returned object is of type Google::Cloud::Dialogflow::V2beta1::BatchCreateMessagesResponse.
            #   p result
            #
            def batch_create_messages request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::BatchCreateMessagesRequest

              # Converts hash and nil to an options object
              options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

              # Customize the options with defaults
              metadata = @config.rpcs.batch_create_messages.metadata.to_h
              ...
              options.apply_defaults timeout:      @config.rpcs.batch_create_messages.timeout,
                                     metadata:     metadata,
                                     retry_policy: @config.rpcs.batch_create_messages.retry_policy

              options.apply_defaults timeout:      @config.timeout,
                                     metadata:     @config.metadata,
                                     retry_policy: @config.retry_policy

              @conversations_stub.call_rpc :batch_create_messages, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::ListMessagesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::ListMessagesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::Message>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::Message>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::ListMessagesRequest.new
            #
            ...
            #   # methods are also available for managing paging directly.
            #   result.each do |response|
            #     # Each element is of type ::Google::Cloud::Dialogflow::V2beta1::Message.
            #     p response
            #   end
            #
            def list_messages request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::ListMessagesRequest
            ...
            # {::Google::Cloud::Dialogflow::V2beta1::Conversations::Client::Configuration::Rpcs}
            ...
            class Configuration
              ...
              class Rpcs
                ...
                ##
                # RPC-specific configuration for `batch_create_messages`
                # @return [::Gapic::Config::Method]
                #
                attr_reader :batch_create_messages
                ##
                ...
                def initialize parent_rpcs = nil
                  ...
                  batch_create_messages_config = parent_rpcs.batch_create_messages if parent_rpcs.respond_to? :batch_create_messages
                  @batch_create_messages = ::Gapic::Config::Method.new batch_create_messages_config
