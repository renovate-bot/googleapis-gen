      ...
      module Environments
        ...
        def self.new(*args, version: :v2beta1, **kwargs)
          ...
          version_module = Google::Cloud::Dialogflow
            ...
            .first
          Google::Cloud::Dialogflow.const_get(version_module)::Environments.new(*args, **kwargs)
        end
      end
      ...
      module Participants
        ...
        def self.new(*args, version: :v2beta1, **kwargs)
          ...
          version_module = Google::Cloud::Dialogflow
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Dialogflow.const_get(version_module)::Participants.new(*args, **kwargs)
        end
      end
      ...
      module AnswerRecords
        ...
        def self.new(*args, version: :v2beta1, **kwargs)
          ...
          version_module = Google::Cloud::Dialogflow
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Dialogflow.const_get(version_module)::AnswerRecords.new(*args, **kwargs)
        end
      end
      ...
      module Conversations
        ...
        def self.new(*args, version: :v2beta1, **kwargs)
          ...
          version_module = Google::Cloud::Dialogflow
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Dialogflow.const_get(version_module)::Conversations.new(*args, **kwargs)
        end
      end
      ...
      module Documents
        ...
        def self.new(*args, version: :v2beta1, **kwargs)
          ...
          version_module = Google::Cloud::Dialogflow
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Dialogflow.const_get(version_module)::Documents.new(*args, **kwargs)
        end
      end
      ...
      module ConversationProfiles
        ...
        def self.new(*args, version: :v2beta1, **kwargs)
          ...
          version_module = Google::Cloud::Dialogflow
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Dialogflow.const_get(version_module)::ConversationProfiles.new(*args, **kwargs)
        end
      end
      ...
      module KnowledgeBases
        ...
        def self.new(*args, version: :v2beta1, **kwargs)
          ...
          version_module = Google::Cloud::Dialogflow
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Dialogflow.const_get(version_module)::KnowledgeBases.new(*args, **kwargs)
        end
      end
    end
  end
