    ...
    module Dialogflow
      module V2beta1
        ...
        class SessionEntityTypesClient
          ...
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::V2beta1::SessionEntityType>]
          ...
          #
          #   session_entity_types_client = Google::Cloud::Dialogflow::SessionEntityTypes.new(version: :v2beta1)
          #
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Dialogflow::V2beta1::SessionEntityType]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
