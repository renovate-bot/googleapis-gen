      ...
      module V2beta1
        module SessionEntityTypes
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Dialogflow::V2beta1::SessionEntityTypes::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all SessionEntityTypes clients
            #   ::Google::Cloud::Dialogflow::V2beta1::SessionEntityTypes::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @session_entity_types_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Dialogflow::V2beta1::SessionEntityTypes::Stub,
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::ListSessionEntityTypesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::ListSessionEntityTypesRequest, ::Hash]
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::SessionEntityType>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Dialogflow::V2beta1::SessionEntityType>]
            #
            ...
            #   request = Google::Cloud::Dialogflow::V2beta1::ListSessionEntityTypesRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::Dialogflow::V2beta1::SessionEntityType.
            #     p response
            #   end
            #
            def list_session_entity_types request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::ListSessionEntityTypesRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::GetSessionEntityTypeRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::GetSessionEntityTypeRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Dialogflow::V2beta1::SessionEntityType]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::GetSessionEntityTypeRequest.new
            #
            #   # Call the get_session_entity_type method.
            #   result = client.get_session_entity_type request
            #
            #   # The returned object is of type Google::Cloud::Dialogflow::V2beta1::SessionEntityType.
            #   p result
            #
            def get_session_entity_type request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::GetSessionEntityTypeRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::CreateSessionEntityTypeRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::CreateSessionEntityTypeRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::CreateSessionEntityTypeRequest.new
            #
            ...
            def create_session_entity_type request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::CreateSessionEntityTypeRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::UpdateSessionEntityTypeRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::UpdateSessionEntityTypeRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Dialogflow::V2beta1::UpdateSessionEntityTypeRequest.new
            #
            ...
            def update_session_entity_type request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::UpdateSessionEntityTypeRequest
            ...
            #   {::Google::Cloud::Dialogflow::V2beta1::DeleteSessionEntityTypeRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Dialogflow::V2beta1::DeleteSessionEntityTypeRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def delete_session_entity_type request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Dialogflow::V2beta1::DeleteSessionEntityTypeRequest
            ...
            # {::Google::Cloud::Dialogflow::V2beta1::SessionEntityTypes::Client::Configuration::Rpcs}
