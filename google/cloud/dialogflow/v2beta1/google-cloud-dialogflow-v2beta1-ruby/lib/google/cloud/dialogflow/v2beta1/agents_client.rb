    ...
    module Dialogflow
      module V2beta1
        ...
        class AgentsClient
          ...
          # @yieldparam result [Google::Cloud::Dialogflow::V2beta1::Agent]
          ...
          #
          #   agents_client = Google::Cloud::Dialogflow::Agents.new(version: :v2beta1)
          ...
          #   A hash of the same form as `Google::Cloud::Dialogflow::V2beta1::Agent`
          ...
          def set_agent \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::SetAgentRequest)
          ...
          def delete_agent \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::DeleteAgentRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::V2beta1::Agent>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          ...
          # call {Google::Cloud::Dialogflow::V2beta1::Agents::TrainAgent TrainAgent} and wait for the operation it returns in order to train
          # explicitly.
          #
          #
          # Operation <response: {Google::Protobuf::Empty}>
          ...
          # completed yet. Please call {Google::Cloud::Dialogflow::V2beta1::Agents::TrainAgent TrainAgent} and wait for the operation it
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Dialogflow::V2beta1::ValidationResult]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          ...
          #   agents_client = Google::Cloud::Dialogflow::Agents.new(version: :v2beta1)
          #   formatted_parent = Google::Cloud::Dialogflow::V2beta1::AgentsClient.project_path("[PROJECT]")
          #   response = agents_client.get_validation_result(formatted_parent)
          ...
          def get_validation_result \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::GetValidationResultRequest)
