    ...
    module Dialogflow
      module V2beta1
        ...
        class ContextsClient
          ...
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::V2beta1::Context>]
          ...
          #
          #   contexts_client = Google::Cloud::Dialogflow::Contexts.new(version: :v2beta1)
          #
          #   # TODO: Initialize `parent`:
          #   parent = ''
          #
          #   # Iterate over all results.
          #   contexts_client.list_contexts(parent).each do |element|
          #     # Process element.
          #   end
          #
          #   # Or iterate over results one page at a time.
          #   contexts_client.list_contexts(parent).each_page do |page|
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Dialogflow::V2beta1::Context]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          ...
          #   name = ''
          #   response = contexts_client.get_context(name)
          ...
          #   context = {}
          #   response = contexts_client.create_context(parent, context)
          ...
          #   # TODO: Initialize `name`:
          #   name = ''
          #   contexts_client.delete_context(name)
          ...
          #   # TODO: Initialize `parent`:
          #   parent = ''
          #   contexts_client.delete_all_contexts(parent)
