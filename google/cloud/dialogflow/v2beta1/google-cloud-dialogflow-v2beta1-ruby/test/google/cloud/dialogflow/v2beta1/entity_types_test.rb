...
class ::Google::Cloud::Dialogflow::V2beta1::EntityTypes::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_entity_types
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2beta1::ListEntityTypesResponse.new
    ...
    list_entity_types_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::ListEntityTypesRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_entity_types_client_stub do
      # Create client
      client = ::Google::Cloud::Dialogflow::V2beta1::EntityTypes::Client.new do |config|
      ...
      # Use protobuf object
      client.list_entity_types ::Google::Cloud::Dialogflow::V2beta1::ListEntityTypesRequest.new(parent: parent, language_code: language_code, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      client.list_entity_types(::Google::Cloud::Dialogflow::V2beta1::ListEntityTypesRequest.new(parent: parent, language_code: language_code, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_entity_type
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2beta1::EntityType.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_entity_type_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::GetEntityTypeRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_entity_type_client_stub do
      ...
      # Use protobuf object
      client.get_entity_type ::Google::Cloud::Dialogflow::V2beta1::GetEntityTypeRequest.new(name: name, language_code: language_code) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_entity_type(::Google::Cloud::Dialogflow::V2beta1::GetEntityTypeRequest.new(name: name, language_code: language_code), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_entity_type
    ...
    create_entity_type_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::CreateEntityTypeRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::V2beta1::EntityType), request["entity_type"]
      assert_equal "hello world", request["language_code"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_entity_type_client_stub do
      ...
      # Use protobuf object
      client.create_entity_type ::Google::Cloud::Dialogflow::V2beta1::CreateEntityTypeRequest.new(parent: parent, entity_type: entity_type, language_code: language_code) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_entity_type(::Google::Cloud::Dialogflow::V2beta1::CreateEntityTypeRequest.new(parent: parent, entity_type: entity_type, language_code: language_code), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_entity_type
    ...
    update_entity_type_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::UpdateEntityTypeRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::V2beta1::EntityType), request["entity_type"]
      assert_equal "hello world", request["language_code"]
    ...
    Gapic::ServiceStub.stub :new, update_entity_type_client_stub do
      ...
      # Use protobuf object
      client.update_entity_type ::Google::Cloud::Dialogflow::V2beta1::UpdateEntityTypeRequest.new(entity_type: entity_type, language_code: language_code, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_entity_type(::Google::Cloud::Dialogflow::V2beta1::UpdateEntityTypeRequest.new(entity_type: entity_type, language_code: language_code, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_entity_type
    ...
    delete_entity_type_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::DeleteEntityTypeRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_entity_type_client_stub do
      ...
      # Use protobuf object
      client.delete_entity_type ::Google::Cloud::Dialogflow::V2beta1::DeleteEntityTypeRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_entity_type(::Google::Cloud::Dialogflow::V2beta1::DeleteEntityTypeRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_update_entity_types
    ...
    batch_update_entity_types_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::BatchUpdateEntityTypesRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, batch_update_entity_types_client_stub do
      ...
      # Use protobuf object
      client.batch_update_entity_types ::Google::Cloud::Dialogflow::V2beta1::BatchUpdateEntityTypesRequest.new(parent: parent, entity_type_batch_uri: entity_type_batch_uri, language_code: language_code, update_mask: update_mask) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.batch_update_entity_types(::Google::Cloud::Dialogflow::V2beta1::BatchUpdateEntityTypesRequest.new(parent: parent, entity_type_batch_uri: entity_type_batch_uri, language_code: language_code, update_mask: update_mask), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_delete_entity_types
    ...
    batch_delete_entity_types_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::BatchDeleteEntityTypesRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, batch_delete_entity_types_client_stub do
      ...
      # Use protobuf object
      client.batch_delete_entity_types ::Google::Cloud::Dialogflow::V2beta1::BatchDeleteEntityTypesRequest.new(parent: parent, entity_type_names: entity_type_names) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.batch_delete_entity_types(::Google::Cloud::Dialogflow::V2beta1::BatchDeleteEntityTypesRequest.new(parent: parent, entity_type_names: entity_type_names), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_create_entities
    ...
    batch_create_entities_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::BatchCreateEntitiesRequest, request
      assert_equal "hello world", request["parent"]
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::EntityType::Entity, request["entities"].first
      assert_equal "hello world", request["language_code"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, batch_create_entities_client_stub do
      ...
      # Use protobuf object
      client.batch_create_entities ::Google::Cloud::Dialogflow::V2beta1::BatchCreateEntitiesRequest.new(parent: parent, entities: entities, language_code: language_code) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.batch_create_entities(::Google::Cloud::Dialogflow::V2beta1::BatchCreateEntitiesRequest.new(parent: parent, entities: entities, language_code: language_code), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_update_entities
    ...
    batch_update_entities_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::BatchUpdateEntitiesRequest, request
      assert_equal "hello world", request["parent"]
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::EntityType::Entity, request["entities"].first
      assert_equal "hello world", request["language_code"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
    ...
    Gapic::ServiceStub.stub :new, batch_update_entities_client_stub do
      ...
      # Use protobuf object
      client.batch_update_entities ::Google::Cloud::Dialogflow::V2beta1::BatchUpdateEntitiesRequest.new(parent: parent, entities: entities, language_code: language_code, update_mask: update_mask) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.batch_update_entities(::Google::Cloud::Dialogflow::V2beta1::BatchUpdateEntitiesRequest.new(parent: parent, entities: entities, language_code: language_code, update_mask: update_mask), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_delete_entities
    ...
    batch_delete_entities_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::BatchDeleteEntitiesRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, batch_delete_entities_client_stub do
      ...
      # Use protobuf object
      client.batch_delete_entities ::Google::Cloud::Dialogflow::V2beta1::BatchDeleteEntitiesRequest.new(parent: parent, entity_values: entity_values, language_code: language_code) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.batch_delete_entities(::Google::Cloud::Dialogflow::V2beta1::BatchDeleteEntitiesRequest.new(parent: parent, entity_values: entity_values, language_code: language_code), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::EntityTypes::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::EntityTypes::Operations, client.operations_client
  end
end
