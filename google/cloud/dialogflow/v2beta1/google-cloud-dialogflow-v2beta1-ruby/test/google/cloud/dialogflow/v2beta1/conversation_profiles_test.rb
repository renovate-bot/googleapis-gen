...
class ::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_conversation_profiles
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2beta1::ListConversationProfilesResponse.new
    ...
    list_conversation_profiles_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::ListConversationProfilesRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_conversation_profiles_client_stub do
      ...
      # Use protobuf object
      client.list_conversation_profiles ::Google::Cloud::Dialogflow::V2beta1::ListConversationProfilesRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      client.list_conversation_profiles(::Google::Cloud::Dialogflow::V2beta1::ListConversationProfilesRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_conversation_profile
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Dialogflow::V2beta1::ConversationProfile.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_conversation_profile_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::GetConversationProfileRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_conversation_profile_client_stub do
      ...
      # Use protobuf object
      client.get_conversation_profile ::Google::Cloud::Dialogflow::V2beta1::GetConversationProfileRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_conversation_profile(::Google::Cloud::Dialogflow::V2beta1::GetConversationProfileRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_conversation_profile
    ...
    create_conversation_profile_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::CreateConversationProfileRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::V2beta1::ConversationProfile), request["conversation_profile"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_conversation_profile_client_stub do
      ...
      # Use protobuf object
      client.create_conversation_profile ::Google::Cloud::Dialogflow::V2beta1::CreateConversationProfileRequest.new(parent: parent, conversation_profile: conversation_profile) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_conversation_profile(::Google::Cloud::Dialogflow::V2beta1::CreateConversationProfileRequest.new(parent: parent, conversation_profile: conversation_profile), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_conversation_profile
    ...
    update_conversation_profile_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::UpdateConversationProfileRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Dialogflow::V2beta1::ConversationProfile), request["conversation_profile"]
    ...
    Gapic::ServiceStub.stub :new, update_conversation_profile_client_stub do
      ...
      # Use protobuf object
      client.update_conversation_profile ::Google::Cloud::Dialogflow::V2beta1::UpdateConversationProfileRequest.new(conversation_profile: conversation_profile, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_conversation_profile(::Google::Cloud::Dialogflow::V2beta1::UpdateConversationProfileRequest.new(conversation_profile: conversation_profile, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_conversation_profile
    ...
    delete_conversation_profile_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::DeleteConversationProfileRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_conversation_profile_client_stub do
      ...
      # Use protobuf object
      client.delete_conversation_profile ::Google::Cloud::Dialogflow::V2beta1::DeleteConversationProfileRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_conversation_profile(::Google::Cloud::Dialogflow::V2beta1::DeleteConversationProfileRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dialogflow::V2beta1::ConversationProfiles::Client::Configuration, config
  end
end
