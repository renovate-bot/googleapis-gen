...
describe Google::Cloud::Dialogflow::V2beta1::ConversationsClient do
  ...
  describe 'create_call_matcher' do
    custom_error = CustomTestError_v2beta1.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::ConversationsClient#create_call_matcher."

    it 'invokes create_call_matcher without error' do
      # Create request parameters
      parent = ''

      # Create expected grpc response
      name = "name3373707"
      to_header = "toHeader-1840668463"
      from_header = "fromHeader-117132094"
      call_id_header = "callIdHeader734299536"
      expected_response = {
        name: name,
        to_header: to_header,
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::CallMatcher)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::CreateCallMatcherRequest, request)
        assert_equal(parent, request.parent)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2beta1.new(:create_call_matcher, mock_method)

      # Mock auth layer
      mock_credentials = MockConversationsCredentials_v2beta1.new("create_call_matcher")
      ...
      Google::Cloud::Dialogflow::V2beta1::Conversations::Stub.stub(:new, mock_stub) do
        Google::Cloud::Dialogflow::V2beta1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          response = client.create_call_matcher(parent)

          # Verify the response
          assert_equal(expected_response, response)

          # Call method with block
          client.create_call_matcher(parent) do |response, operation|
            # Verify the response
            assert_equal(expected_response, response)
            refute_nil(operation)
          end
    ...
    it 'invokes create_call_matcher with error' do
      # Create request parameters
      parent = ''
      ...
      Google::Cloud::Dialogflow::V2beta1::Conversations::Stub.stub(:new, mock_stub) do
        Google::Cloud::Dialogflow::V2beta1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          err = assert_raises Google::Gax::GaxError, CustomTestError_v2beta1 do
            client.create_call_matcher(parent)
          end
  ...
  describe 'list_call_matchers' do
    custom_error = CustomTestError_v2beta1.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::ConversationsClient#list_call_matchers."

    it 'invokes list_call_matchers without error' do
      # Create request parameters
      parent = ''

      # Create expected grpc response
      next_page_token = ""
      call_matchers_element = {}
      call_matchers = [call_matchers_element]
      expected_response = { next_page_token: next_page_token, call_matchers: call_matchers }
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::ListCallMatchersResponse)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::ListCallMatchersRequest, request)
        assert_equal(parent, request.parent)
        OpenStruct.new(execute: expected_response)
      end
      mock_stub = MockGrpcClientStub_v2beta1.new(:list_call_matchers, mock_method)

      # Mock auth layer
      mock_credentials = MockConversationsCredentials_v2beta1.new("list_call_matchers")
      ...
      Google::Cloud::Dialogflow::V2beta1::Conversations::Stub.stub(:new, mock_stub) do
        Google::Cloud::Dialogflow::V2beta1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          response = client.list_call_matchers(parent)

          # Verify the response
          assert(response.instance_of?(Google::Gax::PagedEnumerable))
          assert_equal(expected_response, response.page.response)
          assert_nil(response.next_page)
          assert_equal(expected_response.call_matchers.to_a, response.to_a)
        end
      end
    end

    it 'invokes list_call_matchers with error' do
      # Create request parameters
      parent = ''
      ...
      Google::Cloud::Dialogflow::V2beta1::Conversations::Stub.stub(:new, mock_stub) do
        Google::Cloud::Dialogflow::V2beta1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          err = assert_raises Google::Gax::GaxError, CustomTestError_v2beta1 do
            client.list_call_matchers(parent)
          end
  ...
  describe 'delete_call_matcher' do
    custom_error = CustomTestError_v2beta1.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::ConversationsClient#delete_call_matcher."

    it 'invokes delete_call_matcher without error' do
      # Create request parameters
      name = ''

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::DeleteCallMatcherRequest, request)
        assert_equal(name, request.name)
        OpenStruct.new(execute: nil)
      end
      mock_stub = MockGrpcClientStub_v2beta1.new(:delete_call_matcher, mock_method)

      # Mock auth layer
      mock_credentials = MockConversationsCredentials_v2beta1.new("delete_call_matcher")
      ...
      Google::Cloud::Dialogflow::V2beta1::Conversations::Stub.stub(:new, mock_stub) do
        Google::Cloud::Dialogflow::V2beta1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          response = client.delete_call_matcher(name)

          # Verify the response
          assert_nil(response)

          # Call method with block
          client.delete_call_matcher(name) do |response, operation|
            # Verify the response
            assert_nil(response)
            refute_nil(operation)
          end
    ...
    it 'invokes delete_call_matcher with error' do
      # Create request parameters
      name = ''
      ...
      Google::Cloud::Dialogflow::V2beta1::Conversations::Stub.stub(:new, mock_stub) do
        Google::Cloud::Dialogflow::V2beta1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          err = assert_raises Google::Gax::GaxError, CustomTestError_v2beta1 do
            client.delete_call_matcher(name)
          end
