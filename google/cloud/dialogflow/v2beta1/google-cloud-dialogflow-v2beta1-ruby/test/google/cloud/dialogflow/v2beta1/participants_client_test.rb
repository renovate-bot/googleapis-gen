...
describe Google::Cloud::Dialogflow::V2beta1::ParticipantsClient do
  ...
  describe 'streaming_analyze_content' do
    custom_error = CustomTestError_v2beta1.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::ParticipantsClient#streaming_analyze_content."

    it 'invokes streaming_analyze_content without error' do
      # Create request parameters
      participant = ''
      ...
      reply_text = "replyText-549180062"
      expected_response = { reply_text: reply_text }
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::StreamingAnalyzeContentResponse)

      # Mock Grpc layer
      mock_method = proc do |requests|
        request = requests.first
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::StreamingAnalyzeContentRequest, request)
        assert_equal(participant, request.participant)
        OpenStruct.new(execute: [expected_response])
      end
      mock_stub = MockGrpcClientStub_v2beta1.new(:streaming_analyze_content, mock_method)

      # Mock auth layer
      mock_credentials = MockParticipantsCredentials_v2beta1.new("streaming_analyze_content")
      ...
      Google::Cloud::Dialogflow::V2beta1::Participants::Stub.stub(:new, mock_stub) do
        Google::Cloud::Dialogflow::V2beta1::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method
          response = client.streaming_analyze_content([request])
    ...
    it 'invokes streaming_analyze_content with error' do
      # Create request parameters
      participant = ''
      request = { participant: participant }
