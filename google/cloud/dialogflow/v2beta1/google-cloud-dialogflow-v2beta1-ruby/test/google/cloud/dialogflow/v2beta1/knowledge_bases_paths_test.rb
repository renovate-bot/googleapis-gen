...
class ::Google::Cloud::Dialogflow::V2beta1::KnowledgeBases::ClientPathsTest < Minitest::Test
  def test_knowledge_base_path
    grpc_channel = ::GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ::Gapic::ServiceStub.stub :new, nil do
      client = ::Google::Cloud::Dialogflow::V2beta1::KnowledgeBases::Client.new do |config|
