 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.QueryResult</code>
 */
class QueryResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.Intent.Message fulfillment_messages = 7;</code>
     */
     ...
     * before the query.
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.Context output_contexts = 10;</code>
     */
     ...
     */
    protected $knowledge_answers = null;
     ...
     *           The text to be pronounced to the user or shown on the screen.
     *           Note: This is a legacy field, `fulfillment_messages` should be preferred.
     *     @type \Google\Cloud\Dialogflow\V2beta1\Intent\Message[]|\Google\Protobuf\Internal\RepeatedField $fulfillment_messages
     *           The collection of rich messages to present to the user.
     ...
     *           - webhook call latency
     *           - webhook errors
     *     @type \Google\Cloud\Dialogflow\V2beta1\SentimentAnalysisResult $sentiment_analysis_result
     *           The sentiment analysis result, which depends on the
     *           `sentiment_analysis_request_config` specified in the request.
     *     @type \Google\Cloud\Dialogflow\V2beta1\KnowledgeAnswers $knowledge_answers
     *           The result from Knowledge Connector (if any), ordered by decreasing
     *           `KnowledgeAnswers.match_confidence`.
     * }
     */
    ...
    {
        return isset($this->knowledge_answers) ? $this->knowledge_answers : null;
    }

    public function hasKnowledgeAnswers()
    {
        return isset($this->knowledge_answers);
    }

    public function clearKnowledgeAnswers()
    {
        unset($this->knowledge_answers);
    }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.KnowledgeAnswers knowledge_answers = 18;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\KnowledgeAnswers $var
     * @return $this
     */
    public function setKnowledgeAnswers($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\KnowledgeAnswers::class);
        $this->knowledge_answers = $var;
