 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.ListAnswerRecordsResponse</code>
 */
class ListAnswerRecordsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.AnswerRecord answer_records = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Dialogflow\V2beta1\AnswerRecord[]|\Google\Protobuf\Internal\RepeatedField $answer_records
     *           The list of answer records.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.AnswerRecord answer_records = 1;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\AnswerRecord[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAnswerRecords($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\AnswerRecord::class);
