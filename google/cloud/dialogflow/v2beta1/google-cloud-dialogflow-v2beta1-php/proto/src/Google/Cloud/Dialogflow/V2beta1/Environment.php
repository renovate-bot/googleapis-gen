 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.Environment</code>
 */
class Environment extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Environment.State state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\Environment\State::class);
        $this->state = $var;
