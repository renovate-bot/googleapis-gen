 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.OutputAudio</code>
 */
class OutputAudio extends \Google\Protobuf\Internal\Message
{
     ...
     * audio.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.OutputAudioConfig config = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Dialogflow\V2beta1\OutputAudioConfig $config
     *           Required. Instructs the speech synthesizer how to generate the speech
     *           audio.
     *     @type string $audio
     *           Required. The natural language speech audio.
