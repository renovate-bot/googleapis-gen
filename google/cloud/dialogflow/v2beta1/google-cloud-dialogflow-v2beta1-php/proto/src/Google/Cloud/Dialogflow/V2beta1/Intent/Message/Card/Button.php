...
namespace Google\Cloud\Dialogflow\V2beta1\Intent\Message\Card;
...
class_alias(Button::class, \Google\Cloud\Dialogflow\V2beta1\Intent_Message_Card_Button::class);
