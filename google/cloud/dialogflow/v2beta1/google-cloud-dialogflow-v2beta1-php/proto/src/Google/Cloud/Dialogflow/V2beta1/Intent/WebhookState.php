 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.Intent.WebhookState</code>
 */
class WebhookState
{
    /**
...
class_alias(WebhookState::class, \Google\Cloud\Dialogflow\V2beta1\Intent_WebhookState::class);
