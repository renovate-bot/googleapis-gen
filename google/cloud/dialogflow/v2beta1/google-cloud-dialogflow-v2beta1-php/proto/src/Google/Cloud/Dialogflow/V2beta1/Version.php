 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.Version</code>
 */
class Version extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Version.VersionStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\Version\VersionStatus::class);
        $this->status = $var;
