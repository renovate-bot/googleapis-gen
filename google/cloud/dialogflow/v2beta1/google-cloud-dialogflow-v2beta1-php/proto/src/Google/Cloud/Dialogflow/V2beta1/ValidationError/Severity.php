...
namespace Google\Cloud\Dialogflow\V2beta1\ValidationError;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.ValidationError.Severity</code>
 */
class Severity
{
    /**
...
class_alias(Severity::class, \Google\Cloud\Dialogflow\V2beta1\ValidationError_Severity::class);
