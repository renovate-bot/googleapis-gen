 ...
 * lifecycle events.
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.ConversationEvent</code>
 */
class ConversationEvent extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.ConversationEvent.Type type = 2;</code>
     */
    protected $type = 0;
    /**
     ...
     *           Optional. More detailed information about an error. Only set for type
     *           UNRECOVERABLE_ERROR_IN_PHONE_CALL.
     *     @type \Google\Cloud\Dialogflow\V2beta1\Message $new_message_payload
     *           Payload of NEW_MESSAGE event.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Dialogflow\V2Beta1\ConversationEvent::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\ConversationEvent\Type::class);
        $this->type = $var;
     ...
     * Payload of NEW_MESSAGE event.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Message new_message_payload = 4;</code>
