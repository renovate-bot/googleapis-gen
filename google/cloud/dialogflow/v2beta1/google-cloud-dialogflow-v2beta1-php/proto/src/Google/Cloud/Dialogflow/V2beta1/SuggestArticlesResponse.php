 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.SuggestArticlesResponse</code>
 */
class SuggestArticlesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.ArticleAnswer article_answers = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Dialogflow\V2beta1\ArticleAnswer[]|\Google\Protobuf\Internal\RepeatedField $article_answers
     *           Output only. Articles ordered by score in descending order.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.ArticleAnswer article_answers = 1;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\ArticleAnswer[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setArticleAnswers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\ArticleAnswer::class);
