 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.AgentAssistantFeedback.DocumentCorrectness</code>
 */
...
class_alias(DocumentCorrectness::class, \Google\Cloud\Dialogflow\V2beta1\AgentAssistantFeedback_DocumentCorrectness::class);
