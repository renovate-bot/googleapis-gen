 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.Intent.Parameter</code>
 */
...
class_alias(Parameter::class, \Google\Cloud\Dialogflow\V2beta1\Intent_Parameter::class);
