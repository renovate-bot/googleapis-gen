 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.Intent.Message.TableCardCell</code>
 */
...
class_alias(TableCardCell::class, \Google\Cloud\Dialogflow\V2beta1\Intent_Message_TableCardCell::class);
