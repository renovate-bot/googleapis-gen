 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionConfig</code>
 */
class SuggestionConfig extends \Google\Protobuf\Internal\Message
{
     ...
     * one config.
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig feature_configs = 2;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Dialogflow\V2beta1\HumanAgentAssistantConfig\SuggestionFeatureConfig[]|\Google\Protobuf\Internal\RepeatedField $feature_configs
     *           Configuration of different suggestion features. One feature can have only
     *           one config.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig feature_configs = 2;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\HumanAgentAssistantConfig\SuggestionFeatureConfig[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFeatureConfigs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\HumanAgentAssistantConfig\SuggestionFeatureConfig::class);
...
class_alias(SuggestionConfig::class, \Google\Cloud\Dialogflow\V2beta1\HumanAgentAssistantConfig_SuggestionConfig::class);
