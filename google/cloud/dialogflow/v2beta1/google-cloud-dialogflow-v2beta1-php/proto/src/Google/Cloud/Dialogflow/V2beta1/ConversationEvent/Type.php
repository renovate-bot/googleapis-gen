...
namespace Google\Cloud\Dialogflow\V2beta1\ConversationEvent;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.ConversationEvent.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\Dialogflow\V2beta1\ConversationEvent_Type::class);
