 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.HumanAgentAssistantEvent</code>
 */
class HumanAgentAssistantEvent extends \Google\Protobuf\Internal\Message
{
     ...
     * sets to true.
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.SuggestionResult suggestion_results = 5;</code>
     */
     ...
     *           [HumanAgentAssistantConfig.name][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.name] for more
     *           information.
     *     @type \Google\Cloud\Dialogflow\V2beta1\SuggestionResult[]|\Google\Protobuf\Internal\RepeatedField $suggestion_results
     *           The suggestion results payload that this notification refers to. It will
     *           only be set when
     *           [HumanAgentAssistantConfig.SuggestionConfig.group_suggestion_responses][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionConfig.group_suggestion_responses]
     *           sets to true.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Dialogflow\V2Beta1\HumanAgentAssistantEvent::initOnce();
