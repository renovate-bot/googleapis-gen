 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.AgentAssistantFeedback.DocumentEfficiency</code>
 */
...
class_alias(DocumentEfficiency::class, \Google\Cloud\Dialogflow\V2beta1\AgentAssistantFeedback_DocumentEfficiency::class);
