 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.Message</code>
 */
class Message extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Participant.Role participant_role = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.MessageAnnotation message_annotation = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $message_annotation = null;
    /**
     * Output only. The sentiment analysis result for the message.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.SentimentAnalysisResult sentiment_analysis = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Optional. The time when the message was sent.
     *     @type \Google\Cloud\Dialogflow\V2beta1\MessageAnnotation $message_annotation
     *           Output only. The annotation for the message.
     *     @type \Google\Cloud\Dialogflow\V2beta1\SentimentAnalysisResult $sentiment_analysis
     *           Output only. The sentiment analysis result for the message.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.MessageAnnotation message_annotation = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\MessageAnnotation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.MessageAnnotation message_annotation = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\MessageAnnotation $var
     * @return $this
     */
    public function setMessageAnnotation($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\MessageAnnotation::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.SentimentAnalysisResult sentiment_analysis = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\SentimentAnalysisResult $var
     * @return $this
     */
    public function setSentimentAnalysis($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\SentimentAnalysisResult::class);
