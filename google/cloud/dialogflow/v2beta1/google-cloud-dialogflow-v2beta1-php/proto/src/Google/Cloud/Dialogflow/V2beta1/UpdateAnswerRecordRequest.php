 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.UpdateAnswerRecordRequest</code>
 */
class UpdateAnswerRecordRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.AnswerRecord answer_record = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = {</code>
     */
     ...
     *
     *     @type \Google\Cloud\Dialogflow\V2beta1\AnswerRecord $answer_record
     *           Required. Answer record to update.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.AnswerRecord answer_record = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = {</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\AnswerRecord|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.AnswerRecord answer_record = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = {</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\AnswerRecord $var
     * @return $this
     */
    public function setAnswerRecord($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\AnswerRecord::class);
