 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.Intent.Message.LinkOutSuggestion</code>
 */
...
class_alias(LinkOutSuggestion::class, \Google\Cloud\Dialogflow\V2beta1\Intent_Message_LinkOutSuggestion::class);
