 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.SynthesizeSpeechConfig</code>
 */
class SynthesizeSpeechConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.VoiceSelectionParams voice = 4;</code>
     */
     ...
     *           applied on (post synthesized) text to speech. Effects are applied on top of
     *           each other in the order they are given.
     *     @type \Google\Cloud\Dialogflow\V2beta1\VoiceSelectionParams $voice
     *           Optional. The desired voice of the synthesized audio.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.VoiceSelectionParams voice = 4;</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\VoiceSelectionParams|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.VoiceSelectionParams voice = 4;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\VoiceSelectionParams $var
     * @return $this
     */
    public function setVoice($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\VoiceSelectionParams::class);
        $this->voice = $var;
