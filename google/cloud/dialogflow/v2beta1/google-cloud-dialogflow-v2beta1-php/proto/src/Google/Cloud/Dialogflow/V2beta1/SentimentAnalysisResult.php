 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.SentimentAnalysisResult</code>
 */
class SentimentAnalysisResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Sentiment query_text_sentiment = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Dialogflow\V2beta1\Sentiment $query_text_sentiment
     *           The sentiment analysis result for `query_text`.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Sentiment query_text_sentiment = 1;</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\Sentiment|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Sentiment query_text_sentiment = 1;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\Sentiment $var
     * @return $this
     */
    public function setQueryTextSentiment($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\Sentiment::class);
