...
class Answer extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string source = 1 [(.google.api.resource_reference) = {</code>
     */
    protected $source = '';
    /**
     ...
     */
    protected $match_confidence_level = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\KnowledgeAnswers\Answer\MatchConfidenceLevel::class);
