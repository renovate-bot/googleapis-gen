 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.UpdateIntentRequest</code>
 */
class UpdateIntentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Intent intent = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.IntentView intent_view = 4;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Dialogflow\V2beta1\Intent $intent
     *           Required. The intent to update.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Intent intent = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\Intent $var
     * @return $this
     */
    public function setIntent($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\Intent::class);
        $this->intent = $var;
