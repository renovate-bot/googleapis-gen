 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.Agent.ApiVersion</code>
 */
class ApiVersion
{
    /**
...
class_alias(ApiVersion::class, \Google\Cloud\Dialogflow\V2beta1\Agent_ApiVersion::class);
