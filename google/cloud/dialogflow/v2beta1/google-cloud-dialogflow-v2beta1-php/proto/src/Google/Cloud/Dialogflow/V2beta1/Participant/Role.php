...
namespace Google\Cloud\Dialogflow\V2beta1\Participant;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.Participant.Role</code>
 */
class Role
{
    /**
...
class_alias(Role::class, \Google\Cloud\Dialogflow\V2beta1\Participant_Role::class);
