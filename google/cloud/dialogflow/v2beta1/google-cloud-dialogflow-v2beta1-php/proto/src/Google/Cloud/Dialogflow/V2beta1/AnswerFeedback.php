 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.AnswerFeedback</code>
 */
class AnswerFeedback extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.AnswerFeedback.CorrectnessLevel correctness_level = 1;</code>
     */
     ...
     *           The correctness level of the specific answer.
     *     @type \Google\Cloud\Dialogflow\V2beta1\AgentAssistantFeedback $agent_assistant_detail_feedback
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\AnswerFeedback\CorrectnessLevel::class);
     ...
     * Optional. Detail feedback of agent assistant suggestions.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.AgentAssistantFeedback agent_assistant_detail_feedback = 2;</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\AgentAssistantFeedback|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.AgentAssistantFeedback agent_assistant_detail_feedback = 2;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\AgentAssistantFeedback $var
     * @return $this
     */
    public function setAgentAssistantDetailFeedback($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\AgentAssistantFeedback::class);
