...
namespace Google\Cloud\Dialogflow\V2beta1\SuggestionFeature;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.SuggestionFeature.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\Dialogflow\V2beta1\SuggestionFeature_Type::class);
