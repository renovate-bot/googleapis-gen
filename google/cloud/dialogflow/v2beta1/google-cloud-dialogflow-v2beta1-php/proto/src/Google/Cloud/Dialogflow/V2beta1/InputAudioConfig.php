 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.InputAudioConfig</code>
 */
class InputAudioConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.AudioEncoding audio_encoding = 1;</code>
     */
     ...
     * for more details.
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.SpeechContext speech_contexts = 11;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.SpeechModelVariant model_variant = 10;</code>
     */
     ...
     *           specify both [phrase_hints]() and [speech_contexts](), Dialogflow will
     *           treat the [phrase_hints]() as a single additional [SpeechContext]().
     *     @type \Google\Cloud\Dialogflow\V2beta1\SpeechContext[]|\Google\Protobuf\Internal\RepeatedField $speech_contexts
     *           Context information to assist speech recognition.
     *           See [the Cloud Speech
     *           documentation](https://cloud.google.com/speech-to-text/docs/basics#phrase-hints)
     *           for more details.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\AudioEncoding::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.SpeechContext speech_contexts = 11;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\SpeechContext[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSpeechContexts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\SpeechContext::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\SpeechModelVariant::class);
