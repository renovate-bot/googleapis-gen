...
class ParticipantsGrpcClient extends \Grpc\BaseStub {
    ...
    public function StreamingAnalyzeContent($metadata = [], $options = []) {
        return $this->_bidiRequest('/google.cloud.dialogflow.v2beta1.Participants/StreamingAnalyzeContent',
        ['\Google\Cloud\Dialogflow\V2beta1\StreamingAnalyzeContentResponse','decode'],
        $metadata, $options);
    }
