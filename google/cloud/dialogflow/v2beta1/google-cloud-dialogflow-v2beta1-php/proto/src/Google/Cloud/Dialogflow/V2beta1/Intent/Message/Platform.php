 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.Intent.Message.Platform</code>
 */
class Platform
{
    /**
     ...
     * Telephony Gateway.
     *
     * Generated from protobuf enum <code>TELEPHONY = 10;</code>
     */
    const TELEPHONY = 10;
    /**
     * Google Hangouts.
...
class_alias(Platform::class, \Google\Cloud\Dialogflow\V2beta1\Intent_Message_Platform::class);
