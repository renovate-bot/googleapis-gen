...
class QueryParameters extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.SubAgent sub_agents = 13;</code>
     */
    private $sub_agents;
    /**
     ...
     *           Note: Sentiment Analysis is only currently available for Essentials Edition
     *           agents.
     *     @type \Google\Cloud\Dialogflow\V2beta1\SubAgent[]|\Google\Protobuf\Internal\RepeatedField $sub_agents
     *           For mega agent query, directly specify which sub agents to query.
     *           If any specified sub agent is not linked to the mega agent, an error will
     *           be returned. If empty, Dialogflow will decide which sub agents to query.
     *           If specified for a non-mega-agent query, will be silently ignored.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.SubAgent sub_agents = 13;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\SubAgent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSubAgents($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\SubAgent::class);
        $this->sub_agents = $arr;
