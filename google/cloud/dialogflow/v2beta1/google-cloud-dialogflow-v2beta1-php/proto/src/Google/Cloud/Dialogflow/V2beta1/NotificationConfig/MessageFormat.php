...
namespace Google\Cloud\Dialogflow\V2beta1\NotificationConfig;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.NotificationConfig.MessageFormat</code>
 */
class MessageFormat
{
    /**
...
class_alias(MessageFormat::class, \Google\Cloud\Dialogflow\V2beta1\NotificationConfig_MessageFormat::class);
