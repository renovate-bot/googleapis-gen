 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequest</code>
 */
class BatchUpdateIntentsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.IntentView intent_view = 6;</code>
     */
     ...
     *     @type \Google\Cloud\Dialogflow\V2beta1\IntentBatch $intent_batch_inline
     ...
     * The collection of intents to update or create.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.IntentBatch intent_batch_inline = 3;</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\IntentBatch|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.IntentBatch intent_batch_inline = 3;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\IntentBatch $var
     * @return $this
     */
    public function setIntentBatchInline($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\IntentBatch::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\IntentView::class);
