...
namespace Google\Cloud\Dialogflow\V2beta1\Environment;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.Environment.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Dialogflow\V2beta1\Environment_State::class);
