 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.SuggestSmartRepliesResponse</code>
 */
class SuggestSmartRepliesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.SmartReplyAnswer smart_reply_answers = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Dialogflow\V2beta1\SmartReplyAnswer[]|\Google\Protobuf\Internal\RepeatedField $smart_reply_answers
     *           Output only. Multiple reply options provided by smart reply service. The
     *           order is based on the rank of the model prediction.
     *           The maximum number of the returned replies is set in SmartReplyConfig.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.SmartReplyAnswer smart_reply_answers = 1;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\SmartReplyAnswer[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSmartReplyAnswers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\SmartReplyAnswer::class);
