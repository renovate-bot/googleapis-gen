 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.CreateCallMatcherRequest</code>
 */
class CreateCallMatcherRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.CallMatcher call_matcher = 2;</code>
     */
     ...
     *           Format: `projects/<Project ID>/locations/<Location
     *           ID>/conversations/<Conversation ID>`.
     *     @type \Google\Cloud\Dialogflow\V2beta1\CallMatcher $call_matcher
     *           Required. The call matcher to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.CallMatcher call_matcher = 2;</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\CallMatcher|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.CallMatcher call_matcher = 2;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\CallMatcher $var
     * @return $this
     */
    public function setCallMatcher($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\CallMatcher::class);
