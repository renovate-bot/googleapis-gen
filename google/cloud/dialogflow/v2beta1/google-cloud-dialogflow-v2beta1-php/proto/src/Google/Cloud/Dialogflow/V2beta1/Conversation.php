 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.Conversation</code>
 */
class Conversation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Conversation.LifecycleState lifecycle_state = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * telephony.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.ConversationPhoneNumber phone_number = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * [ConversationStage.HUMAN_ASSIST_STAGE][google.cloud.dialogflow.v2beta1.Conversation.ConversationStage.HUMAN_ASSIST_STAGE].
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Conversation.ConversationStage conversation_stage = 7;</code>
     */
     ...
     *           Format: `projects/<Project ID>/locations/<Location
     *           ID>/conversationProfiles/<Conversation Profile ID>`.
     *     @type \Google\Cloud\Dialogflow\V2beta1\ConversationPhoneNumber $phone_number
     *           Output only. Required if the conversation is to be connected over
     *           telephony.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\Conversation\LifecycleState::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.ConversationPhoneNumber phone_number = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\ConversationPhoneNumber|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.ConversationPhoneNumber phone_number = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\ConversationPhoneNumber $var
     * @return $this
     */
    public function setPhoneNumber($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\ConversationPhoneNumber::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2beta1\Conversation\ConversationStage::class);
