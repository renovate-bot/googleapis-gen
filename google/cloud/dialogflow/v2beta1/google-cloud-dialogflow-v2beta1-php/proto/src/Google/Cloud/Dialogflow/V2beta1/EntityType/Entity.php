 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.EntityType.Entity</code>
 */
...
class_alias(Entity::class, \Google\Cloud\Dialogflow\V2beta1\EntityType_Entity::class);
