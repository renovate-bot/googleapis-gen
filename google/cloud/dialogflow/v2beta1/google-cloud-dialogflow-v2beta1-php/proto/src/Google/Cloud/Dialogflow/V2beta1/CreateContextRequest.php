 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.CreateContextRequest</code>
 */
class CreateContextRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           `Environment ID` is not specified, we assume default 'draft' environment.
     *           If `User ID` is not specified, we assume default '-' user.
     *     @type \Google\Cloud\Dialogflow\V2beta1\Context $context
     *           Required. The context to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Context context = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\Context $var
     * @return $this
     */
    public function setContext($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\Context::class);
        $this->context = $var;
