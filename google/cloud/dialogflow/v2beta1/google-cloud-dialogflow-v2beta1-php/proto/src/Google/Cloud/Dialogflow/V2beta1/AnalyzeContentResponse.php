 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.AnalyzeContentResponse</code>
 */
class AnalyzeContentResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * has content.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.OutputAudio reply_audio = 2;</code>
     */
     ...
     * instead.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.AutomatedAgentReply automated_agent_reply = 3;</code>
     */
    protected $automated_agent_reply = null;
    /**
     * Output only. Message analyzed by CCAI.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Message message = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.SuggestionResult human_agent_suggestion_results = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.SuggestionResult end_user_suggestion_results = 7;</code>
     */
    private $end_user_suggestion_results;
    /**
     * Indicates the parameters of DTMF.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.DtmfParameters dtmf_parameters = 9;</code>
     */
     ...
     *           This field is set if the automated agent responded with text to show to
     *           the user.
     *     @type \Google\Cloud\Dialogflow\V2beta1\OutputAudio $reply_audio
     *           Optional. The audio data bytes encoded as specified in the request.
     *           This field is set if:
     *            - `reply_audio_config` was specified in the request, or
     *            - The automated agent responded with audio to play to the user. In such
     ...
     *           response structure. In these cases, only the top-most-level audio output
     *           has content.
     *     @type \Google\Cloud\Dialogflow\V2beta1\AutomatedAgentReply $automated_agent_reply
     *           Optional. Only set if a Dialogflow automated agent has responded.
     *           Note that: [AutomatedAgentReply.detect_intent_response.output_audio][]
     *           and [AutomatedAgentReply.detect_intent_response.output_audio_config][]
     *           are always empty, use
     ...
     *           Output only. Message analyzed by CCAI.
     *     @type \Google\Cloud\Dialogflow\V2beta1\SuggestionResult[]|\Google\Protobuf\Internal\RepeatedField $human_agent_suggestion_results
     *           The suggestions for most recent human agent. The order is the same as
     *           [HumanAgentAssistantConfig.SuggestionConfig.feature_configs][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionConfig.feature_configs]
     *           of
     *           [HumanAgentAssistantConfig.human_agent_suggestion_config][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.human_agent_suggestion_config].
     *     @type \Google\Cloud\Dialogflow\V2beta1\SuggestionResult[]|\Google\Protobuf\Internal\RepeatedField $end_user_suggestion_results
     *           The suggestions for end user. The order is the same as
     *           [HumanAgentAssistantConfig.SuggestionConfig.feature_configs][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionConfig.feature_configs]
     *           of
     *           [HumanAgentAssistantConfig.end_user_suggestion_config][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.end_user_suggestion_config].
     *     @type \Google\Cloud\Dialogflow\V2beta1\DtmfParameters $dtmf_parameters
     *           Indicates the parameters of DTMF.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.OutputAudio reply_audio = 2;</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\OutputAudio|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.OutputAudio reply_audio = 2;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\OutputAudio $var
     * @return $this
     */
    public function setReplyAudio($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\OutputAudio::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.AutomatedAgentReply automated_agent_reply = 3;</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\AutomatedAgentReply|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.AutomatedAgentReply automated_agent_reply = 3;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\AutomatedAgentReply $var
     * @return $this
     */
    public function setAutomatedAgentReply($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\AutomatedAgentReply::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.SuggestionResult human_agent_suggestion_results = 6;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\SuggestionResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setHumanAgentSuggestionResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\SuggestionResult::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.DtmfParameters dtmf_parameters = 9;</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\DtmfParameters|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.DtmfParameters dtmf_parameters = 9;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\DtmfParameters $var
     * @return $this
     */
    public function setDtmfParameters($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\DtmfParameters::class);
