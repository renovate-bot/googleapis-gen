 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.CallMatcher</code>
 */
class CallMatcher extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $call_id_header = '';
    /**
     * Custom SIP headers that must match.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.CallMatcher.CustomHeaders custom_headers = 5;</code>
     */
     ...
     *           empty or unspecified, we don't match to the
     *           [`Call-ID` header](https://tools.ietf.org/html/rfc3261#section-8.1.1.4).
     *     @type \Google\Cloud\Dialogflow\V2beta1\CallMatcher\CustomHeaders $custom_headers
     *           Custom SIP headers that must match.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.CallMatcher.CustomHeaders custom_headers = 5;</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\CallMatcher\CustomHeaders|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.CallMatcher.CustomHeaders custom_headers = 5;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\CallMatcher\CustomHeaders $var
     * @return $this
     */
    public function setCustomHeaders($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\CallMatcher\CustomHeaders::class);
