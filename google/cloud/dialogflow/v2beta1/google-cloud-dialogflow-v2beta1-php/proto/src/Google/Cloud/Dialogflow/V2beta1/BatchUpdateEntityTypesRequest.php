 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.BatchUpdateEntityTypesRequest</code>
 */
class BatchUpdateEntityTypesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           "gs://".
     *     @type \Google\Cloud\Dialogflow\V2beta1\EntityTypeBatch $entity_type_batch_inline
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.EntityTypeBatch entity_type_batch_inline = 3;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\EntityTypeBatch $var
     * @return $this
     */
    public function setEntityTypeBatchInline($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\EntityTypeBatch::class);
