 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.Conversation.ConversationStage</code>
 */
...
class_alias(ConversationStage::class, \Google\Cloud\Dialogflow\V2beta1\Conversation_ConversationStage::class);
