 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.CreateConversationRequest</code>
 */
class CreateConversationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Conversation conversation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. Resource identifier of the project creating the conversation.
     *           Format: `projects/<Project ID>/locations/<Location ID>`.
     *     @type \Google\Cloud\Dialogflow\V2beta1\Conversation $conversation
     *           Required. The conversation to create.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Conversation conversation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Dialogflow\V2beta1\Conversation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.v2beta1.Conversation conversation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\Conversation $var
     * @return $this
     */
    public function setConversation($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\V2beta1\Conversation::class);
