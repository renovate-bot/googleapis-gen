...
namespace Google\Cloud\Dialogflow\V2beta1\Intent\Message\CarouselSelect;
...
class_alias(Item::class, \Google\Cloud\Dialogflow\V2beta1\Intent_Message_CarouselSelect_Item::class);
