 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.AgentAssistantFeedback.AnswerRelevance</code>
 */
...
class_alias(AnswerRelevance::class, \Google\Cloud\Dialogflow\V2beta1\AgentAssistantFeedback_AnswerRelevance::class);
