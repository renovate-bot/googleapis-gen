...
namespace Google\Cloud\Dialogflow\V2beta1\Agent;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.v2beta1.Agent.MatchMode</code>
 */
class MatchMode
{
    /**
...
class_alias(MatchMode::class, \Google\Cloud\Dialogflow\V2beta1\Agent_MatchMode::class);
