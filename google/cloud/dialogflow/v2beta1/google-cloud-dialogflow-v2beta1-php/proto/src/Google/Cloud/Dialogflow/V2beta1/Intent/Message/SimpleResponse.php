 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponse</code>
 */
...
class_alias(SimpleResponse::class, \Google\Cloud\Dialogflow\V2beta1\Intent_Message_SimpleResponse::class);
