 ...
 *     $requests = [];
 *     $response = $conversationsClient->batchCreateMessages($formattedParent, $requests);
 * } finally {
...
class ConversationsGapicClient
{
    ...
    public function batchCreateMessages($parent, $requests, array $optionalArgs = [])
    {
        ...
        return $this->startCall('BatchCreateMessages', BatchCreateMessagesResponse::class, $optionalArgs, $request)->wait();
    }
