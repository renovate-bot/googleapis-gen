...
use Google\Cloud\Dialogflow\V2beta1\EntityType\Entity;
 ...
 *     $pagedResponse = $entityTypesClient->listEntityTypes($parent);
...
class EntityTypesGapicClient
{
    ...
    {
        if (null == self::$projectEntityTypeNameTemplate) {
    ...
    {
        if (null == self::$projectLocationEntityTypeNameTemplate) {
    ...
    /**
     * Formats a string containing the fully-qualified path to represent
     * a project_entity_type resource.
     *
     * @param string $project
     * @param string $entityType
     *
    ...
    /**
     * Formats a string containing the fully-qualified path to represent
     * a project_location_entity_type resource.
     *
     * @param string $project
     * @param string $location
     * @param string $entityType
     ...
     * try {
     *     $name = '';
     *     $response = $entityTypesClient->getEntityType($name);
     * } finally {
     *     $entityTypesClient->close();
     * }
     * ```
     ...
     * try {
     *     $parent = '';
     *     $operationResponse = $entityTypesClient->batchUpdateEntityTypes($parent);
     ...
     *     $parent = '';
     *     $entityTypeNames = [];
     *     $operationResponse = $entityTypesClient->batchDeleteEntityTypes($parent, $entityTypeNames);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     ...
     * ```
     *
     * @param string   $parent          Required. The name of the agent to delete all entities types for.
     *                                  Supported formats:
     *                                  - `projects/<Project ID>/agent`,
     *                                  - `projects/<Project ID>/locations/<Location ID>/agent`.
     ...
     *     $parent = '';
     *     $entities = [];
     *     $operationResponse = $entityTypesClient->batchCreateEntities($parent, $entities);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // operation succeeded and returns no value
     *     } else {
     ...
     * ```
     *
     * @param string   $parent       Required. The name of the entity type to create entities in.
     *                               Supported formats:
     *                               - `projects/<Project ID>/agent/entityTypes/<Entity Type ID>`
     *                               - `projects/<Project ID>/locations/<Location ID>/agent/entityTypes/<Entity
     *                               Type ID>`
     ...
     *     $parent = '';
     *     $entities = [];
     *     $operationResponse = $entityTypesClient->batchUpdateEntities($parent, $entities);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // operation succeeded and returns no value
     *     } else {
     ...
     *     $parent = '';
     *     $entityValues = [];
     *     $operationResponse = $entityTypesClient->batchDeleteEntities($parent, $entityValues);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // operation succeeded and returns no value
     *     } else {
     ...
     * ```
     *
     * @param string   $parent       Required. The name of the entity type to delete entries for.
     *                               Supported formats:
     *                               - `projects/<Project ID>/agent/entityTypes/<Entity Type ID>`
     *                               - `projects/<Project ID>/locations/<Location ID>/agent/entityTypes/<Entity
     *                               Type ID>`
