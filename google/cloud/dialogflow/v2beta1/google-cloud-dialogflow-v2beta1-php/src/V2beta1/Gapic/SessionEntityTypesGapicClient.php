...
class SessionEntityTypesGapicClient
{
    ...
    {
        if (null == self::$projectLocationSessionEntityTypeNameTemplate) {
    ...
    /**
     * Formats a string containing the fully-qualified path to represent
     * a project_location_session_entity_type resource.
     *
     * @param string $project
     * @param string $location
     * @param string $session
     ...
     * ```
     *
     * @param string $name Required. The name of the session entity type. Supported formats:
