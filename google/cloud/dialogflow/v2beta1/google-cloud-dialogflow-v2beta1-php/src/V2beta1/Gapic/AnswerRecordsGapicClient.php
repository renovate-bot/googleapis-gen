...
use Google\Cloud\Dialogflow\V2beta1\GetAnswerRecordRequest;
use Google\Cloud\Dialogflow\V2beta1\ListAnswerRecordsRequest;
use Google\Cloud\Dialogflow\V2beta1\ListAnswerRecordsResponse;
use Google\Cloud\Dialogflow\V2beta1\UpdateAnswerRecordRequest;
use Google\Protobuf\FieldMask;

/**
 * Service Description: Service for managing [AnswerRecords][google.cloud.dialogflow.v2beta1.AnswerRecord].
 *
 ...
 * try {
 *     $response = $answerRecordsClient->getAnswerRecord();
 * } finally {
...
class AnswerRecordsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.v2beta1.AnswerRecords';
     ...
     * @experimental
     */
    public function getAnswerRecord(array $optionalArgs = [])
    {
        $request = new GetAnswerRecordRequest();
     ...
     *     $response = $answerRecordsClient->updateAnswerRecord($answerRecord);
     * } finally {
     *     $answerRecordsClient->close();
     * }
     * ```
     ...
     * @experimental
     */
    public function updateAnswerRecord($answerRecord, array $optionalArgs = [])
    {
