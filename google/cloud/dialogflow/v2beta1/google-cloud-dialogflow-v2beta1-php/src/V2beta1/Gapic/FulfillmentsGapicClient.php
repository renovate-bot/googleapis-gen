...
use Google\Cloud\Dialogflow\V2beta1\GetFulfillmentRequest;
use Google\Cloud\Dialogflow\V2beta1\UpdateFulfillmentRequest;
...
class FulfillmentsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.v2beta1.Fulfillments';
