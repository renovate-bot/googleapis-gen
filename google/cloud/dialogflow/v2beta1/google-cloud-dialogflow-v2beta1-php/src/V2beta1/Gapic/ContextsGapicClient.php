...
use Google\Cloud\Dialogflow\V2beta1\Context;
use Google\Cloud\Dialogflow\V2beta1\CreateContextRequest;
use Google\Cloud\Dialogflow\V2beta1\DeleteAllContextsRequest;
use Google\Cloud\Dialogflow\V2beta1\DeleteContextRequest;
use Google\Cloud\Dialogflow\V2beta1\GetContextRequest;
use Google\Cloud\Dialogflow\V2beta1\ListContextsRequest;
use Google\Cloud\Dialogflow\V2beta1\ListContextsResponse;
use Google\Cloud\Dialogflow\V2beta1\UpdateContextRequest;
...
class ContextsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.v2beta1.Contexts';
    ...
    {
        if (null == self::$projectLocationSessionNameTemplate) {
    ...
    {
        if (null == self::$projectLocationSessionContextNameTemplate) {
    ...
    /**
     * Formats a string containing the fully-qualified path to represent
     * a project_location_session resource.
     *
     * @param string $project
    ...
    /**
     * Formats a string containing the fully-qualified path to represent
     * a project_location_session_context resource.
     *
     * @param string $project
     * @param string $location
     * @param string $session
     ...
     * ```
     *
     * @param string $name Required. The name of the context. Supported formats:
     ...
     * ```
     *
     * @param string $name Required. The name of the context to delete. Supported formats:
     *                     - `projects/<Project ID>/agent/sessions/<Session ID>/contexts/<Context
     *                     ID>`,
     *                     - `projects/<Project ID>/locations/<Location ID>/agent/sessions/<Session
     *                     ID>/contexts/<Context ID>`,
