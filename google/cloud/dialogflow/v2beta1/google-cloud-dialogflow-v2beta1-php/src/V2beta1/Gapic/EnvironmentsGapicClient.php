 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/dialogflow/v2beta1/environment.proto
...
use Google\Cloud\Dialogflow\V2beta1\ListEnvironmentsRequest;
 ...
 *     $pagedResponse = $environmentsClient->listEnvironments($parent);
...
class EnvironmentsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.v2beta1.Environments';
    ...
    {
        if (null == self::$projectLocationAgentNameTemplate) {
    ...
    /**
     * Formats a string containing the fully-qualified path to represent
     * a project_location_agent resource.
     *
     * @param string $project
