        ...
        'google.cloud.dialogflow.v2beta1.KnowledgeBases' => [
            'CreateKnowledgeBase' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v2beta1/{parent=projects/*/locations/*}/knowledgeBases',
                        'body' => 'knowledge_base',
                    ],
                    [
                        'method' => 'post',
            ...
            'DeleteKnowledgeBase' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'delete',
                        'uriTemplate' => '/v2beta1/{name=projects/*/locations/*/knowledgeBases/*}',
                    ],
                    [
                        'method' => 'delete',
            ...
            'UpdateKnowledgeBase' => [
                'method' => 'patch',
                'uriTemplate' => '/v2beta1/{knowledge_base.name=projects/*/knowledgeBases/*}',
                'body' => 'knowledge_base',
                'additionalBindings' => [
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v2beta1/{knowledge_base.name=projects/*/locations/*/knowledgeBases/*}',
                        'body' => 'knowledge_base',
                    ],
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v2beta1/{knowledge_base.name=projects/*/agent/knowledgeBases/*}',
                        'body' => 'knowledge_base',
                    ],
                ],
                'placeholders' => [
