        ...
        'google.cloud.dialogflow.v2beta1.SessionEntityTypes' => [
            'CreateSessionEntityType' => [
                ...
                'additionalBindings' => [
                    ...
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v2beta1/{parent=projects/*/locations/*/agent/sessions/*}/entityTypes',
                        'body' => 'session_entity_type',
                    ],
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v2beta1/{parent=projects/*/locations/*/agent/environments/*/users/*/sessions/*}/entityTypes',
                        'body' => 'session_entity_type',
                    ],
                ],
                'placeholders' => [
            ...
            'DeleteSessionEntityType' => [
                ...
                'additionalBindings' => [
                    ...
                    [
                        'method' => 'delete',
                        'uriTemplate' => '/v2beta1/{name=projects/*/locations/*/agent/sessions/*/entityTypes/*}',
                    ],
                    [
                        'method' => 'delete',
                        'uriTemplate' => '/v2beta1/{name=projects/*/locations/*/agent/environments/*/users/*/sessions/*/entityTypes/*}',
                    ],
                ],
                'placeholders' => [
                    'name' => [
            ...
            'UpdateSessionEntityType' => [
                ...
                'additionalBindings' => [
                    ...
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v2beta1/{session_entity_type.name=projects/*/locations/*/agent/sessions/*/entityTypes/*}',
                        'body' => 'session_entity_type',
                    ],
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v2beta1/{session_entity_type.name=projects/*/locations/*/agent/environments/*/users/*/sessions/*/entityTypes/*}',
                        'body' => 'session_entity_type',
                    ],
                ],
                'placeholders' => [
