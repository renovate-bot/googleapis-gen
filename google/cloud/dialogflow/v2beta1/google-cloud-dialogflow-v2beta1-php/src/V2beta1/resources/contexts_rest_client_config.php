        ...
        'google.cloud.dialogflow.v2beta1.Contexts' => [
            'ListContexts' => [
                ...
                'additionalBindings' => [
                    ...
                    [
                        'method' => 'get',
                        'uriTemplate' => '/v2beta1/{parent=projects/*/locations/*/agent/sessions/*}/contexts',
                    ],
                    [
                        'method' => 'get',
                        'uriTemplate' => '/v2beta1/{parent=projects/*/locations/*/agent/environments/*/users/*/sessions/*}/contexts',
                    ],
                ],
                'placeholders' => [
                    'parent' => [
            ...
            'GetContext' => [
                ...
                'additionalBindings' => [
                    ...
                    [
                        'method' => 'get',
                        'uriTemplate' => '/v2beta1/{name=projects/*/locations/*/agent/sessions/*/contexts/*}',
                    ],
                    [
                        'method' => 'get',
                        'uriTemplate' => '/v2beta1/{name=projects/*/locations/*/agent/environments/*/users/*/sessions/*/contexts/*}',
                    ],
                ],
                'placeholders' => [
                    'name' => [
            ...
            'UpdateContext' => [
                ...
                'additionalBindings' => [
                    ...
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v2beta1/{context.name=projects/*/locations/*/agent/sessions/*/contexts/*}',
                        'body' => 'context',
                    ],
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v2beta1/{context.name=projects/*/locations/*/agent/environments/*/users/*/sessions/*/contexts/*}',
                        'body' => 'context',
                    ],
                ],
                'placeholders' => [
