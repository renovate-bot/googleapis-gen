...
use Google\Cloud\Dialogflow\V2beta1\Fulfillment;
use Google\Cloud\Dialogflow\V2beta1\FulfillmentsClient;
...
class FulfillmentsClientTest extends GeneratedTest
{
    ...
    public function getFulfillmentTest()
    {
        ...
        $enabled = false;
        $expectedResponse = new Fulfillment();
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Fulfillments/GetFulfillment', $actualFuncCall);
    ...
    public function updateFulfillmentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Fulfillments/UpdateFulfillment', $actualFuncCall);
