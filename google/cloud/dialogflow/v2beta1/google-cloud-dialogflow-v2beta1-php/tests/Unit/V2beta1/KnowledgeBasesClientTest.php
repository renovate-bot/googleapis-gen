...
class KnowledgeBasesClientTest extends GeneratedTest
{
    ...
    public function listKnowledgeBasesTest()
    {
        ...
        $this->assertEquals($expectedResponse->getKnowledgeBases()[0], $resources[0]);

        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.KnowledgeBases/ListKnowledgeBases', $actualFuncCall);
    ...
    public function getKnowledgeBaseTest()
    {
        ...
        $expectedResponse = new KnowledgeBase();
        ...
        $response = $client->getKnowledgeBase($name);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.KnowledgeBases/GetKnowledgeBase', $actualFuncCall);
    ...
    public function createKnowledgeBaseTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.KnowledgeBases/CreateKnowledgeBase', $actualFuncCall);
    ...
    public function deleteKnowledgeBaseTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.KnowledgeBases/DeleteKnowledgeBase', $actualFuncCall);
    ...
    public function updateKnowledgeBaseTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.KnowledgeBases/UpdateKnowledgeBase', $actualFuncCall);
