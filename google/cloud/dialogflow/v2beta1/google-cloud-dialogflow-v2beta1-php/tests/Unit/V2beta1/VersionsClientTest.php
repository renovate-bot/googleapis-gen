...
use Google\Cloud\Dialogflow\V2beta1\ListVersionsResponse;
use Google\Cloud\Dialogflow\V2beta1\Version;
use Google\Cloud\Dialogflow\V2beta1\VersionsClient;
...
class VersionsClientTest extends GeneratedTest
{
    ...
    public function createVersionTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Versions/CreateVersion', $actualFuncCall);
    ...
    public function deleteVersionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Versions/DeleteVersion', $actualFuncCall);
    ...
    public function getVersionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Versions/GetVersion', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listVersionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Versions/ListVersions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateVersionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Versions/UpdateVersion', $actualFuncCall);
        $actualValue = $actualRequestObject->getVersion();
        $this->assertProtobufEquals($version, $actualValue);
