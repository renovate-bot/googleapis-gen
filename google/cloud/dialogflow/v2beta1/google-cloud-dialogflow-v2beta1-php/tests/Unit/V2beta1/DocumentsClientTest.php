...
use Google\Cloud\Dialogflow\V2beta1\DocumentsClient;
...
class DocumentsClientTest extends GeneratedTest
{
    ...
    public function listDocumentsTest()
    {
        ...
        $response = $client->listDocuments($parent);
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Documents/ListDocuments', $actualFuncCall);
    ...
    public function getDocumentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Documents/GetDocument', $actualFuncCall);
    ...
    public function createDocumentTest()
    {
        ...
        $incompleteOperation->setName('operations/createDocumentTest');
        ...
        $completeOperation->setName('operations/createDocumentTest');
        ...
        $response = $client->createDocument($parent, $document);
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Documents/CreateDocument', $actualApiFuncCall);
    ...
    public function importDocumentsTest()
    {
        ...
        $response = $client->importDocuments($parent, $documentTemplate);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Documents/ImportDocuments', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
    ...
    public function deleteDocumentTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteDocumentTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteDocumentTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        ...
        $response = $client->deleteDocument($name);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Documents/DeleteDocument', $actualApiFuncCall);
    ...
    public function updateDocumentTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateDocumentTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateDocumentTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Documents/UpdateDocument', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getDocument();
    ...
    public function reloadDocumentTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/reloadDocumentTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name2 = 'name2-1052831874';
        $displayName = 'displayName1615086568';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/reloadDocumentTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        ...
        $response = $client->reloadDocument($name);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Documents/ReloadDocument', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
