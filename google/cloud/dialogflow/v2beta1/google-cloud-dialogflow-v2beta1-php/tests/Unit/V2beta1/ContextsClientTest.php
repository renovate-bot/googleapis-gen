...
use Google\Cloud\Dialogflow\V2beta1\ContextsClient;
...
class ContextsClientTest extends GeneratedTest
{
    ...
    public function listContextsTest()
    {
        ...
        $response = $client->listContexts($parent);
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Contexts/ListContexts', $actualFuncCall);
    ...
    public function getContextTest()
    {
        ...
        $response = $client->getContext($name);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Contexts/GetContext', $actualFuncCall);
    ...
    public function createContextTest()
    {
        ...
        $response = $client->createContext($parent, $context);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Contexts/CreateContext', $actualFuncCall);
    ...
    public function updateContextTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Contexts/UpdateContext', $actualFuncCall);
    ...
    public function deleteContextTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Contexts/DeleteContext', $actualFuncCall);
    ...
    public function deleteAllContextsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Contexts/DeleteAllContexts', $actualFuncCall);
