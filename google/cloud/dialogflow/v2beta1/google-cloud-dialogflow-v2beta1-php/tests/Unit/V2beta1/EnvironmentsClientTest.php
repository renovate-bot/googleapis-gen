...
use Google\Cloud\Dialogflow\V2beta1\Environment;
use Google\Cloud\Dialogflow\V2beta1\EnvironmentHistory;
use Google\Cloud\Dialogflow\V2beta1\EnvironmentHistory\Entry;
use Google\Cloud\Dialogflow\V2beta1\EnvironmentsClient;
use Google\Cloud\Dialogflow\V2beta1\ListEnvironmentsResponse;
...
class EnvironmentsClientTest extends GeneratedTest
{
    ...
    public function createEnvironmentTest()
    {
        ...
        $agentVersion = 'agentVersion-26267234';
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Environments/CreateEnvironment', $actualFuncCall);
    ...
    public function deleteEnvironmentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Environments/DeleteEnvironment', $actualFuncCall);
    ...
    public function getEnvironmentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Environments/GetEnvironment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getEnvironmentHistoryTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Environments/GetEnvironmentHistory', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listEnvironmentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Environments/ListEnvironments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateEnvironmentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Environments/UpdateEnvironment', $actualFuncCall);
        $actualValue = $actualRequestObject->getEnvironment();
        $this->assertProtobufEquals($environment, $actualValue);
