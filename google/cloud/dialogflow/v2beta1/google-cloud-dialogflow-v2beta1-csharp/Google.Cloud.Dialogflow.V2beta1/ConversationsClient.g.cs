...
namespace Google.Cloud.Dialogflow.V2beta1
{
    ...
    public sealed partial class ConversationsClientImpl : ConversationsClient
    {
        ...
        public ConversationsClientImpl(Conversations.ConversationsClient grpcClient, ConversationsSettings settings)
        {
            ...
            _callBatchCreateMessages = clientHelper.BuildApiCall<BatchCreateMessagesRequest, BatchCreateMessagesResponse>(grpcClient.BatchCreateMessagesAsync, grpcClient.BatchCreateMessages, effectiveSettings.BatchCreateMessagesSettings).WithGoogleRequestParam("parent", request => request.Parent);
