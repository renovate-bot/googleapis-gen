...
#pragma warning disable CS0612
            _callListSuggestions = clientHelper.BuildApiCall<ListSuggestionsRequest, ListSuggestionsResponse>(grpcClient.ListSuggestionsAsync, grpcClient.ListSuggestions, effectiveSettings.ListSuggestionsSettings).WithGoogleRequestParam("parent", request => request.Parent);
#pragma warning restore CS0612
            Modify_ApiCall(ref _callListSuggestions);
            Modify_ListSuggestionsApiCall(ref _callListSuggestions);
#pragma warning disable CS0612
            _callCompileSuggestion = clientHelper.BuildApiCall<CompileSuggestionRequest, CompileSuggestionResponse>(grpcClient.CompileSuggestionAsync, grpcClient.CompileSuggestion, effectiveSettings.CompileSuggestionSettings).WithGoogleRequestParam("parent", request => request.Parent);
#pragma warning restore CS0612
