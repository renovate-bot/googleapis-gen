...
class ParticipantsTransport(abc.ABC):
    ...
    @property
    def create_participant(self) -> typing.Callable[
            [gcd_participant.CreateParticipantRequest],
            typing.Union[
                gcd_participant.Participant,
                typing.Awaitable[gcd_participant.Participant]
            ]]:
        raise NotImplementedError()

    @property
    def get_participant(self) -> typing.Callable[
            [participant.GetParticipantRequest],
            typing.Union[
                participant.Participant,
                typing.Awaitable[participant.Participant]
            ]]:
        raise NotImplementedError()

    @property
    def list_participants(self) -> typing.Callable[
    ...
    @property
    def update_participant(self) -> typing.Callable[
    ...
    @property
    def analyze_content(self) -> typing.Callable[
    ...
    @property
    def suggest_articles(self) -> typing.Callable[
    ...
    @property
    def suggest_faq_answers(self) -> typing.Callable[
    ...
    @property
    def suggest_smart_replies(self) -> typing.Callable[
    ...
    @property
    def list_suggestions(self) -> typing.Callable[
    ...
    @property
    def compile_suggestion(self) -> typing.Callable[
