...
class AnswerRecordsTransport(abc.ABC):
    ...
    @property
    def get_answer_record(self) -> typing.Callable[
            [answer_record.GetAnswerRecordRequest],
            typing.Union[
                answer_record.AnswerRecord,
                typing.Awaitable[answer_record.AnswerRecord]
            ]]:
        raise NotImplementedError()

    @property
    def list_answer_records(self) -> typing.Callable[
            [answer_record.ListAnswerRecordsRequest],
            typing.Union[
                answer_record.ListAnswerRecordsResponse,
                typing.Awaitable[answer_record.ListAnswerRecordsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def update_answer_record(self) -> typing.Callable[
            [gcd_answer_record.UpdateAnswerRecordRequest],
            typing.Union[
                gcd_answer_record.AnswerRecord,
                typing.Awaitable[gcd_answer_record.AnswerRecord]
            ]]:
        raise NotImplementedError()


__all__ = (
    'AnswerRecordsTransport',
)
