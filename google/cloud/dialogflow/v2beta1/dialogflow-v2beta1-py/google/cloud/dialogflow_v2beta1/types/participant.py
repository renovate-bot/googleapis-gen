...
class Message(proto.Message):
    ...
    send_time = proto.Field(proto.MESSAGE, number=9,
        message=timestamp.Timestamp,
    )
    ...
    sentiment_analysis = proto.Field(proto.MESSAGE, number=8,
...
class AutomatedAgentReply(proto.Message):
    ...
    response_messages = proto.RepeatedField(proto.MESSAGE, number=3,
    ...
    cx_session_parameters = proto.Field(proto.MESSAGE, number=6,
...
class AnalyzeContentRequest(proto.Message):
    ...
    Attributes:
        participant (str):
            ...
            Format:
            ``projects/<Project ID>/locations/<Location ID>/conversations/<Conversation ID>/participants/<Participant ID>``.
        text (google.cloud.dialogflow_v2beta1.types.InputText):
            The natural language text to be processed.
        audio (google.cloud.dialogflow_v2beta1.types.InputAudio):
    ...
    text = proto.Field(proto.MESSAGE, number=3, oneof='input',
        message='InputText',
    )

    audio = proto.Field(proto.MESSAGE, number=4, oneof='input',
        message='InputAudio',
    )
    ...
    audio_input = proto.Field(proto.MESSAGE, number=7, oneof='input',
        message='AudioInput',
    )
    ...
    message_send_time = proto.Field(proto.MESSAGE, number=10,
        message=timestamp.Timestamp,
    )
...
class StreamingAnalyzeContentRequest(proto.Message):
    ...
    Attributes:
        ...
        enable_extended_streaming (bool):
            Enable full bidirectional streaming. You can keep streaming
            the audio until timeout, and there's no need to half close
            the stream to get the response.
    ...
    audio_config = proto.Field(proto.MESSAGE, number=2, oneof='config',
        message=gcd_audio_config.InputAudioConfig,
    )

    text_config = proto.Field(proto.MESSAGE, number=3, oneof='config',
        message='InputTextConfig',
    )

    reply_audio_config = proto.Field(proto.MESSAGE, number=4,
        message=gcd_audio_config.OutputAudioConfig,
    )
    ...
    input_dtmf = proto.Field(proto.MESSAGE, number=9, oneof='input',
        message=gcd_audio_config.TelephonyDtmfEvents,
    )

    query_params = proto.Field(proto.MESSAGE, number=7,
        message=session.QueryParameters,
    )

    enable_extended_streaming = proto.Field(proto.BOOL, number=11)
...
class StreamingAnalyzeContentResponse(proto.Message):
    ...
    recognition_result = proto.Field(proto.MESSAGE, number=1,
        message=session.StreamingRecognitionResult,
    )

    reply_text = proto.Field(proto.STRING, number=2)

    reply_audio = proto.Field(proto.MESSAGE, number=3,
        message='OutputAudio',
    )

    automated_agent_reply = proto.Field(proto.MESSAGE, number=4,
        message='AutomatedAgentReply',
    )

    message = proto.Field(proto.MESSAGE, number=6,
        message='Message',
    )

    human_agent_suggestion_results = proto.RepeatedField(proto.MESSAGE, number=7,
        message='SuggestionResult',
    )

    end_user_suggestion_results = proto.RepeatedField(proto.MESSAGE, number=8,
        message='SuggestionResult',
    )

    dtmf_parameters = proto.Field(proto.MESSAGE, number=10,
        message='DtmfParameters',
    )
...
class SuggestionResult(proto.Message):
    ...
    suggest_smart_replies_response = proto.Field(proto.MESSAGE, number=4, oneof='suggestion_response',
...
class SuggestSmartRepliesRequest(proto.Message):
    ...
    current_text_input = proto.Field(proto.MESSAGE, number=4,
        message=session.TextInput,
    )
...
class SuggestSmartRepliesResponse(proto.Message):
    ...
    smart_reply_answers = proto.RepeatedField(proto.MESSAGE, number=1,
...
class Suggestion(proto.Message):
    ...
    articles = proto.RepeatedField(proto.MESSAGE, number=2,
        message=Article,
    )

    faq_answers = proto.RepeatedField(proto.MESSAGE, number=4,
        message=FaqAnswer,
    )
...
class CompileSuggestionResponse(proto.Message):
    ...
    suggestion = proto.Field(proto.MESSAGE, number=1,
        message='Suggestion',
    )
...
class ResponseMessage(proto.Message):
    ...
    payload = proto.Field(proto.MESSAGE, number=2, oneof='message',
        message=struct.Struct,
    )

    live_agent_handoff = proto.Field(proto.MESSAGE, number=3, oneof='message',
        message=LiveAgentHandoff,
    )

    end_interaction = proto.Field(proto.MESSAGE, number=4, oneof='message',
        message=EndInteraction,
    )

    mixed_audio = proto.Field(proto.MESSAGE, number=5, oneof='message',
        message=MixedAudio,
    )
