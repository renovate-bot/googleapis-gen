...
class CallMatcher(proto.Message):
    ...
    custom_headers = proto.Field(proto.MESSAGE, number=5,
...
class CreateCallMatcherRequest(proto.Message):
    ...
    call_matcher = proto.Field(proto.MESSAGE, number=2,
        message='CallMatcher',
    )
...
class ListCallMatchersResponse(proto.Message):
    ...
    call_matchers = proto.RepeatedField(proto.MESSAGE, number=1,
        message='CallMatcher',
    )
