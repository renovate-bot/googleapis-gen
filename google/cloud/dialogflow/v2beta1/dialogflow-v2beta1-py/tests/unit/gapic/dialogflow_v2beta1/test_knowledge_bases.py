...
from google.cloud.dialogflow_v2beta1.services.knowledge_bases.transports.base import _API_CORE_VERSION
from google.cloud.dialogflow_v2beta1.services.knowledge_bases.transports.base import _GOOGLE_AUTH_VERSION
...
def test_knowledge_bases_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_knowledge_bases_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dialogflow_v2beta1.services.knowledge_bases.transports.KnowledgeBasesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_knowledge_bases_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dialogflow_v2beta1.services.knowledge_bases.transports.KnowledgeBasesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.KnowledgeBasesTransport()
        adc.assert_called_once()
