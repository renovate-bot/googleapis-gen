...
public interface ModelOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.Model.ExportFormat> 
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.Model.DeploymentResourcesType> getSupportedDeploymentResourcesTypesList();
  /**
   * <pre>
   * Output only. When this Model is deployed, its prediction resources are described by the
   * `prediction_resources` field of the [Endpoint.deployed_models][google.cloud.aiplatform.v1.Endpoint.deployed_models] object.
   ...
   */
  com.google.cloud.aiplatform.v1.Model.DeploymentResourcesType getSupportedDeploymentResourcesTypes(int index);
  /**
   * <pre>
   * Output only. When this Model is deployed, its prediction resources are described by the
   * `prediction_resources` field of the [Endpoint.deployed_models][google.cloud.aiplatform.v1.Endpoint.deployed_models] object.
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.DeployedModelRef> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1.DeployedModelRef deployed_models = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.aiplatform.v1.DeployedModelRefOrBuilder getDeployedModelsOrBuilder(
      int index);
