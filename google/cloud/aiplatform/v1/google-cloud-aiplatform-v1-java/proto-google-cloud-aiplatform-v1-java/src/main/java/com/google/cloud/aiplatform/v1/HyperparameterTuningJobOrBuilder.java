...
public interface HyperparameterTuningJobOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1.HyperparameterTuningJob)
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.StudySpec study_spec = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.CustomJobSpec trial_job_spec = 8 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.aiplatform.v1.CustomJobSpec trial_job_spec = 8 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.aiplatform.v1.CustomJobSpecOrBuilder getTrialJobSpecOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.Trial trials = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
