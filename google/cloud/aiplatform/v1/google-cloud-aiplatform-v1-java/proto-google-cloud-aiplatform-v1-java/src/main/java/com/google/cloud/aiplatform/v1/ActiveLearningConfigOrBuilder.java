...
public interface ActiveLearningConfigOrBuilder extends
   ...
   */
  com.google.cloud.aiplatform.v1.SampleConfig getSampleConfig();
  /**
   * <pre>
   * Active learning data sampling config. For every active learning labeling
   * iteration, it will select a batch of data based on the sampling strategy.
   ...
   * <code>.google.cloud.aiplatform.v1.SampleConfig sample_config = 3;</code>
   */
  com.google.cloud.aiplatform.v1.SampleConfigOrBuilder getSampleConfigOrBuilder();
   ...
   */
  com.google.cloud.aiplatform.v1.TrainingConfig getTrainingConfig();
  /**
   * <pre>
   * CMLE training config. For every active learning labeling iteration, system
   * will train a machine learning model on CMLE. The trained model will be used
  ...
  public com.google.cloud.aiplatform.v1.ActiveLearningConfig.HumanLabelingBudgetCase getHumanLabelingBudgetCase();
}
