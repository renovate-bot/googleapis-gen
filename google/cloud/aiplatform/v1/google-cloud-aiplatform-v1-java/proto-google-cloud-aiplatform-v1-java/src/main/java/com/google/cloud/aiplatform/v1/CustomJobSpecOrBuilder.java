...
public interface CustomJobSpecOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.WorkerPoolSpec worker_pool_specs = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.cloud.aiplatform.v1.WorkerPoolSpec> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1.WorkerPoolSpec worker_pool_specs = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.aiplatform.v1.WorkerPoolSpecOrBuilder getWorkerPoolSpecsOrBuilder(
      int index);
