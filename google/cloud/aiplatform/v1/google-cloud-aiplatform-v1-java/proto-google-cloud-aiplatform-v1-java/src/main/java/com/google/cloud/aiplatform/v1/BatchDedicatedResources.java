...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.google.cloud.aiplatform.v1.MachineSpec.Builder subBuilder = null;
            if (machineSpec_ != null) {
              subBuilder = machineSpec_.toBuilder();
            }
            machineSpec_ = input.readMessage(com.google.cloud.aiplatform.v1.MachineSpec.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.aiplatform.v1.BatchDedicatedResources parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.aiplatform.v1.BatchDedicatedResources) e.getUnfinishedMessage();
