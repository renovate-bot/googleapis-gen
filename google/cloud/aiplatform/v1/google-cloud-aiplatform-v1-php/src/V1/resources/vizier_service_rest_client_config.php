...
return [
    'interfaces' => [
        'google.cloud.aiplatform.v1.VizierService' => [
            'AddTrialMeasurement' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{trial_name=projects/*/locations/*/studies/*/trials/*}:addTrialMeasurement',
                'body' => '*',
                'placeholders' => [
                    'trial_name' => [
                        'getters' => [
            ...
            'CheckTrialEarlyStoppingState' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{trial_name=projects/*/locations/*/studies/*/trials/*}:checkTrialEarlyStoppingState',
                'body' => '*',
                'placeholders' => [
                    'trial_name' => [
                        'getters' => [
            ...
            'CompleteTrial' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/studies/*/trials/*}:complete',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'CreateStudy' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/studies',
                'body' => 'study',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'CreateTrial' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/studies/*}/trials',
                'body' => 'trial',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteStudy' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/studies/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'DeleteTrial' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/studies/*/trials/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'ListOptimalTrials' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/studies/*}/trials:listOptimalTrials',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'LookupStudy' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/studies:lookup',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'StopTrial' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/studies/*/trials/*}:stop',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'SuggestTrials' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/studies/*}/trials:suggest',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
