...
return [
    'interfaces' => [
        'google.cloud.aiplatform.v1.PipelineService' => [
            'CancelPipelineJob' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/pipelineJobs/*}:cancel',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'CreatePipelineJob' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/pipelineJobs',
                'body' => 'pipeline_job',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeletePipelineJob' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/pipelineJobs/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
