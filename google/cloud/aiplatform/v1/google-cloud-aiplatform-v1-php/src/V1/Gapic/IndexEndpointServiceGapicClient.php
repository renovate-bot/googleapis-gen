 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/aiplatform/v1/index_endpoint_service.proto
...
class IndexEndpointServiceGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/index_endpoint_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/index_endpoint_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/index_endpoint_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/index_endpoint_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    private static function getIndexNameTemplate()
    {
        if (self::$indexNameTemplate == null) {
            self::$indexNameTemplate = new PathTemplate('projects/{project}/locations/{location}/indexes/{index}');
        }
     ...
     * @throws ApiException if the remote call fails
     */
    public function undeployIndex($indexEndpoint, $deployedIndexId, array $optionalArgs = [])
    {
    ...
    public function updateIndexEndpoint($indexEndpoint, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateIndexEndpoint', IndexEndpoint::class, $optionalArgs, $request)->wait();
    }
}
