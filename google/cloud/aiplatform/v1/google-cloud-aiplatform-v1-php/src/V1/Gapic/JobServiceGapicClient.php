 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/aiplatform/v1/job_service.proto
...
class JobServiceGapicClient
{
    ...
    public function cancelBatchPredictionJob($name, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CancelBatchPredictionJob', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function cancelCustomJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CancelCustomJob', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function cancelDataLabelingJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CancelDataLabelingJob', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function cancelHyperparameterTuningJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CancelHyperparameterTuningJob', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function createBatchPredictionJob($parent, $batchPredictionJob, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateBatchPredictionJob', BatchPredictionJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function createCustomJob($parent, $customJob, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateCustomJob', CustomJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function createDataLabelingJob($parent, $dataLabelingJob, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateDataLabelingJob', DataLabelingJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function createHyperparameterTuningJob($parent, $hyperparameterTuningJob, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateHyperparameterTuningJob', HyperparameterTuningJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteBatchPredictionJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteBatchPredictionJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteCustomJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteCustomJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteDataLabelingJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteDataLabelingJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteHyperparameterTuningJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteHyperparameterTuningJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getBatchPredictionJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetBatchPredictionJob', BatchPredictionJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getCustomJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetCustomJob', CustomJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getDataLabelingJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetDataLabelingJob', DataLabelingJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listBatchPredictionJobs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListBatchPredictionJobs', $optionalArgs, ListBatchPredictionJobsResponse::class, $request);
    }
    ...
    public function listCustomJobs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListCustomJobs', $optionalArgs, ListCustomJobsResponse::class, $request);
    }
    ...
    public function listDataLabelingJobs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListDataLabelingJobs', $optionalArgs, ListDataLabelingJobsResponse::class, $request);
    }
