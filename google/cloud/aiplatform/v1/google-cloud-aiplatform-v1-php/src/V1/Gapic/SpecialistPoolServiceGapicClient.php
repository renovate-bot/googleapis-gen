 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/aiplatform/v1/specialist_pool_service.proto
...
class SpecialistPoolServiceGapicClient
{
    ...
    public function createSpecialistPool($parent, $specialistPool, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateSpecialistPool', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteSpecialistPool($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteSpecialistPool', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getSpecialistPool($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetSpecialistPool', SpecialistPool::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listSpecialistPools($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListSpecialistPools', $optionalArgs, ListSpecialistPoolsResponse::class, $request);
    }
    ...
    public function updateSpecialistPool($specialistPool, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['specialist_pool.name'] = $specialistPool->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateSpecialistPool', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
