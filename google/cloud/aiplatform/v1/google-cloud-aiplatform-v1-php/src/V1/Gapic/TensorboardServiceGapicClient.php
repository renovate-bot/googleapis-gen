 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/aiplatform/v1/tensorboard_service.proto
...
class TensorboardServiceGapicClient
{
    ...
    private static function getTensorboardNameTemplate()
    {
        if (self::$tensorboardNameTemplate == null) {
            self::$tensorboardNameTemplate = new PathTemplate('projects/{project}/locations/{location}/tensorboards/{tensorboard}');
        }
    ...
    private static function getTensorboardExperimentNameTemplate()
    {
        if (self::$tensorboardExperimentNameTemplate == null) {
            self::$tensorboardExperimentNameTemplate = new PathTemplate('projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}');
        }
    ...
    private static function getTensorboardRunNameTemplate()
    {
        if (self::$tensorboardRunNameTemplate == null) {
            self::$tensorboardRunNameTemplate = new PathTemplate('projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}');
        }
    ...
    private static function getTensorboardTimeSeriesNameTemplate()
    {
        if (self::$tensorboardTimeSeriesNameTemplate == null) {
            self::$tensorboardTimeSeriesNameTemplate = new PathTemplate('projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}/timeSeries/{time_series}');
        }
     ...
     */
    public static function tensorboardExperimentName($project, $location, $tensorboard, $experiment)
    {
     ...
     */
    public static function tensorboardRunName($project, $location, $tensorboard, $experiment, $run)
    {
     ...
     */
    public static function tensorboardTimeSeriesName($project, $location, $tensorboard, $experiment, $run, $timeSeries)
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function createTensorboard($parent, $tensorboard, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateTensorboard', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createTensorboardExperiment($parent, $tensorboardExperimentId, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['tensorboardExperiment'])) {
            $request->setTensorboardExperiment($optionalArgs['tensorboardExperiment']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateTensorboardExperiment', TensorboardExperiment::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createTensorboardRun($parent, $tensorboardRun, $tensorboardRunId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateTensorboardRun', TensorboardRun::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createTensorboardTimeSeries($parent, $tensorboardTimeSeries, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['tensorboardTimeSeriesId'])) {
            $request->setTensorboardTimeSeriesId($optionalArgs['tensorboardTimeSeriesId']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateTensorboardTimeSeries', TensorboardTimeSeries::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteTensorboard($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteTensorboard', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteTensorboardExperiment($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteTensorboardExperiment', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteTensorboardRun($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteTensorboardRun', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteTensorboardTimeSeries($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteTensorboardTimeSeries', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function exportTensorboardTimeSeriesData($tensorboardTimeSeries, array $optionalArgs = [])
    {
        $request = new ExportTensorboardTimeSeriesDataRequest();
        $requestParamHeaders = [];
        $request->setTensorboardTimeSeries($tensorboardTimeSeries);
        $requestParamHeaders['tensorboard_time_series'] = $tensorboardTimeSeries;
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ExportTensorboardTimeSeriesData', $optionalArgs, ExportTensorboardTimeSeriesDataResponse::class, $request);
    }
    ...
    public function getTensorboard($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetTensorboard', Tensorboard::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getTensorboardExperiment($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetTensorboardExperiment', TensorboardExperiment::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getTensorboardRun($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetTensorboardRun', TensorboardRun::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getTensorboardTimeSeries($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetTensorboardTimeSeries', TensorboardTimeSeries::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listTensorboardExperiments($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListTensorboardExperiments', $optionalArgs, ListTensorboardExperimentsResponse::class, $request);
    }
    ...
    public function listTensorboardRuns($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListTensorboardRuns', $optionalArgs, ListTensorboardRunsResponse::class, $request);
    }
    ...
    public function listTensorboardTimeSeries($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListTensorboardTimeSeries', $optionalArgs, ListTensorboardTimeSeriesResponse::class, $request);
    }
    ...
    public function listTensorboards($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListTensorboards', $optionalArgs, ListTensorboardsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function readTensorboardBlobData($timeSeries, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ReadTensorboardBlobData', ReadTensorboardBlobDataResponse::class, $optionalArgs, $request, Call::SERVER_STREAMING_CALL);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function readTensorboardTimeSeriesData($tensorboardTimeSeries, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ReadTensorboardTimeSeriesData', ReadTensorboardTimeSeriesDataResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateTensorboard($updateMask, $tensorboard, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateTensorboard', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateTensorboardExperiment($updateMask, $tensorboardExperiment, array $optionalArgs = [])
    {
        $request = new UpdateTensorboardExperimentRequest();
        $requestParamHeaders = [];
        $request->setUpdateMask($updateMask);
        $request->setTensorboardExperiment($tensorboardExperiment);
        $requestParamHeaders['tensorboard_experiment.name'] = $tensorboardExperiment->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateTensorboardExperiment', TensorboardExperiment::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateTensorboardRun($updateMask, $tensorboardRun, array $optionalArgs = [])
    {
        $request = new UpdateTensorboardRunRequest();
        $requestParamHeaders = [];
        $request->setUpdateMask($updateMask);
        $request->setTensorboardRun($tensorboardRun);
        $requestParamHeaders['tensorboard_run.name'] = $tensorboardRun->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateTensorboardRun', TensorboardRun::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateTensorboardTimeSeries($updateMask, $tensorboardTimeSeries, array $optionalArgs = [])
    {
        $request = new UpdateTensorboardTimeSeriesRequest();
        $requestParamHeaders = [];
        $request->setUpdateMask($updateMask);
        $request->setTensorboardTimeSeries($tensorboardTimeSeries);
        $requestParamHeaders['tensorboard_time_series.name'] = $tensorboardTimeSeries->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
     ...
     * @throws ApiException if the remote call fails
     */
    public function writeTensorboardRunData($tensorboardRun, $timeSeriesData, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('WriteTensorboardRunData', WriteTensorboardRunDataResponse::class, $optionalArgs, $request)->wait();
    }
}
