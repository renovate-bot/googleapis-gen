...
from google.cloud.aiplatform_v1.services.prediction_service import PredictionServiceAsyncClient
from google.cloud.aiplatform_v1.services.prediction_service import PredictionServiceClient
from google.cloud.aiplatform_v1.services.prediction_service import transports
from google.cloud.aiplatform_v1.services.prediction_service.transports.base import _API_CORE_VERSION
from google.cloud.aiplatform_v1.services.prediction_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_prediction_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.prediction_service.transports.PredictionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_predict_flattened():
    ...
    with mock.patch.object(
        ...
        assert args[0].instances == [struct.Value(null_value=struct.NullValue.NULL_VALUE)]
...
def test_prediction_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.prediction_service.transports.PredictionServiceTransport.__init__') as Transport:
...
def test_prediction_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_prediction_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.PredictionServiceTransport()
        adc.assert_called_once()
