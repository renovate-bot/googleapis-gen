...
from google.cloud.aiplatform_v1.services.endpoint_service import EndpointServiceAsyncClient
...
def test_endpoint_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.endpoint_service.transports.EndpointServiceGrpcTransport.__init__') as grpc_transport:
...
def test_endpoint_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.endpoint_service.transports.EndpointServiceTransport.__init__') as Transport:
