  ...
  module Cloud
    module Aiplatform
      module V1
        ...
        #     the {Google::Cloud::Aiplatform::V1::BatchPredictionJob#model Model's}
        ...
        #     may be specified via the {Google::Cloud::Aiplatform::V1::BatchPredictionJob#model Model's}
        #     {Google::Cloud::Aiplatform::V1::Model#predict_schemata PredictSchemata's}
        ...
        #     of {Google::Cloud::Aiplatform::V1::BatchPredictionJob#model Model's}
        #     {Google::Cloud::Aiplatform::V1::Model#predict_schemata PredictSchemata's}
        #     {Google::Cloud::Aiplatform::V1::PredictSchemata#instance_schema_uri instance_schema_uri}
        #     and
        ...
        class BatchPredictionJob
          ...
          #     {Google::Cloud::Aiplatform::V1::BatchPredictionJob#model Model's}
