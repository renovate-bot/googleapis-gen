  ...
  module Cloud
    module Aiplatform
      module V1
        ...
        # {Google::Cloud::Aiplatform::V1::ModelService::UploadModel upload} the Model to AI Platform, and evaluate the
        # Model.
        # @!attribute [rw] name
        #   @return [String]
        ...
        #     Describes the Model that may be uploaded (via {Google::Cloud::Aiplatform::V1::ModelService::UploadModel ModelService::UploadModel})
        ...
        #     {Google::Cloud::Aiplatform::V1::DatasetService::ListAnnotations ListAnnotations} may be used, but note
        ...
        #     as the one used in {Google::Cloud::Aiplatform::V1::DatasetService::ListDataItems DatasetService::ListDataItems} may be used. If a
