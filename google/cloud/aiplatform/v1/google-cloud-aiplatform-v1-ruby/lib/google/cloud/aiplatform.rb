...
module Google
  module Cloud
    ...
    ##
    # # Ruby Client for Cloud AI Platform API ([Alpha](https://github.com/GoogleCloudPlatform/google-cloud-ruby#versioning))
    #
    ...
    module Aiplatform
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("aiplatform"))
      ...
      module Dataset
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Aiplatform
            .constants
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Aiplatform.const_get(version_module)::Dataset.new(*args, **kwargs)
        end
      end
      ...
      module Endpoint
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Aiplatform
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Aiplatform.const_get(version_module)::Endpoint.new(*args, **kwargs)
        end
      end
      ...
      module Job
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Aiplatform
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Aiplatform.const_get(version_module)::Job.new(*args, **kwargs)
        end
      end
      ...
      module Migration
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Aiplatform
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Aiplatform.const_get(version_module)::Migration.new(*args, **kwargs)
        end
      end
      ...
      module Model
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Aiplatform
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Aiplatform.const_get(version_module)::Model.new(*args, **kwargs)
        end
      end
      ...
      module Pipeline
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Aiplatform
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Aiplatform.const_get(version_module)::Pipeline.new(*args, **kwargs)
        end
      end
      ...
      module Prediction
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Aiplatform
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Aiplatform.const_get(version_module)::Prediction.new(*args, **kwargs)
        end
      end
      ...
      module SpecialistPool
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Aiplatform
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Aiplatform.const_get(version_module)::SpecialistPool.new(*args, **kwargs)
        end
      end
    end
  end
