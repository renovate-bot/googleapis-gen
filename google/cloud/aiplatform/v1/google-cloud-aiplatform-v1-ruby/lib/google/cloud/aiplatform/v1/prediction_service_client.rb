  ...
  module Cloud
    module Aiplatform
      module V1
        ...
        #   @return [Google::Cloud::Aiplatform::V1::PredictionService::Stub]
        class PredictionServiceClient
          ...
          def initialize \
            ...
            @prediction_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Aiplatform::V1::PredictionService::Stub.method(:new)
            )
          ...
          #
          #   prediction_client = Google::Cloud::Aiplatform::Prediction.new(version: :v1)
          ...
          def predict \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::PredictRequest)
