  ...
  module Cloud
    module Aiplatform
      module V1
        ...
        #     To add or remove DeployedModels use {Google::Cloud::Aiplatform::V1::EndpointService::DeployModel EndpointService::DeployModel} and
        #     {Google::Cloud::Aiplatform::V1::EndpointService::UndeployModel EndpointService::UndeployModel} respectively.
