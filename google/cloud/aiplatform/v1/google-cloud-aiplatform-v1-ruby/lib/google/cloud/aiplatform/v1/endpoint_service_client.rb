  ...
  module Cloud
    module Aiplatform
      module V1
        ...
        #   @return [Google::Cloud::Aiplatform::V1::EndpointService::Stub]
        class EndpointServiceClient
          ...
          def initialize \
            ...
            @endpoint_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Aiplatform::V1::EndpointService::Stub.method(:new)
            )
          ...
          #   A hash of the same form as `Google::Cloud::Aiplatform::V1::Endpoint`
          ...
          #
          #   endpoint_client = Google::Cloud::Aiplatform::Endpoint.new(version: :v1)
          ...
          def create_endpoint \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::CreateEndpointRequest)
          ...
          def get_endpoint \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::GetEndpointRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::Endpoint>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::Endpoint>]
          #   An enumerable of Google::Cloud::Aiplatform::V1::Endpoint instances.
          ...
          def list_endpoints \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::ListEndpointsRequest)
          ...
          def update_endpoint \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::UpdateEndpointRequest)
          ...
          def delete_endpoint \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::DeleteEndpointRequest)
            operation = Google::Gax::Operation.new(
          ...
          #   {Google::Cloud::Aiplatform::V1::EndpointService::UpdateEndpoint EndpointService::UpdateEndpoint}.
          #   A hash of the same form as `Google::Cloud::Aiplatform::V1::DeployedModel`
          #   can also be provided.
          ...
          def deploy_model \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::DeployModelRequest)
            operation = Google::Gax::Operation.new(
          ...
          def undeploy_model \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::UndeployModelRequest)
            operation = Google::Gax::Operation.new(
