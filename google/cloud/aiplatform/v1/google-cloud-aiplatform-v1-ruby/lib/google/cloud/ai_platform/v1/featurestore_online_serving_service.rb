...
helper_path = ::File.join __dir__, "featurestore_online_serving_service", "helpers.rb"
require "google/cloud/ai_platform/v1/featurestore_online_serving_service/helpers" if ::File.file? helper_path
