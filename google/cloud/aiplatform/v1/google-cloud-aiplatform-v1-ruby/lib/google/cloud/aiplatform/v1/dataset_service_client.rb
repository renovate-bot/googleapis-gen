  ...
  module Cloud
    module Aiplatform
      module V1
        ...
        #   @return [Google::Cloud::Aiplatform::V1::DatasetService::Stub]
        class DatasetServiceClient
          ...
          def initialize \
            ...
            @dataset_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Aiplatform::V1::DatasetService::Stub.method(:new)
            )
          ...
          #   A hash of the same form as `Google::Cloud::Aiplatform::V1::Dataset`
          ...
          #
          #   dataset_client = Google::Cloud::Aiplatform::Dataset.new(version: :v1)
          ...
          def create_dataset \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::CreateDatasetRequest)
          ...
          def get_dataset \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::GetDatasetRequest)
          ...
          def update_dataset \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::UpdateDatasetRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::Dataset>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::Dataset>]
          #   An enumerable of Google::Cloud::Aiplatform::V1::Dataset instances.
          ...
          def list_datasets \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::ListDatasetsRequest)
          ...
          def delete_dataset \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::DeleteDatasetRequest)
            operation = Google::Gax::Operation.new(
          ...
          #   A hash of the same form as `Google::Cloud::Aiplatform::V1::ImportDataConfig`
          #   can also be provided.
          # @param options [Google::Gax::CallOptions]
          #   Overrides the default settings for this call, e.g, timeout,
          #   retries, etc.
          ...
          def import_data \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::ImportDataRequest)
            operation = Google::Gax::Operation.new(
          ...
          #   A hash of the same form as `Google::Cloud::Aiplatform::V1::ExportDataConfig`
          #   can also be provided.
          # @param options [Google::Gax::CallOptions]
          #   Overrides the default settings for this call, e.g, timeout,
          #   retries, etc.
          ...
          def export_data \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::ExportDataRequest)
            operation = Google::Gax::Operation.new(
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::DataItem>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::DataItem>]
          #   An enumerable of Google::Cloud::Aiplatform::V1::DataItem instances.
          #   See Google::Gax::PagedEnumerable documentation for other
          #   operations such as per-page iteration or access to the response
          #   object.
          # @raise [Google::Gax::GaxError] if the RPC is aborted.
          ...
          def list_data_items \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::ListDataItemsRequest)
          ...
          def get_annotation_spec \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::GetAnnotationSpecRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::Annotation>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::Annotation>]
          #   An enumerable of Google::Cloud::Aiplatform::V1::Annotation instances.
          #   See Google::Gax::PagedEnumerable documentation for other
          #   operations such as per-page iteration or access to the response
          #   object.
          # @raise [Google::Gax::GaxError] if the RPC is aborted.
          ...
          def list_annotations \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::ListAnnotationsRequest)
