...
module Google
  module Cloud
    module Aiplatform
      module V1
        # Request message for {Google::Cloud::Aiplatform::V1::SpecialistPoolService::CreateSpecialistPool SpecialistPoolService::CreateSpecialistPool}.
        # @!attribute [rw] parent
        #   @return [String]
        ...
        # {Google::Cloud::Aiplatform::V1::SpecialistPoolService::CreateSpecialistPool SpecialistPoolService::CreateSpecialistPool}.
        # @!attribute [rw] generic_metadata
        #   @return [Google::Cloud::Aiplatform::V1::GenericOperationMetadata]
        #     The operation generic information.
        class CreateSpecialistPoolOperationMetadata; end

        # Request message for {Google::Cloud::Aiplatform::V1::SpecialistPoolService::GetSpecialistPool SpecialistPoolService::GetSpecialistPool}.
        # @!attribute [rw] name
        #   @return [String]
        ...
        # Request message for {Google::Cloud::Aiplatform::V1::SpecialistPoolService::ListSpecialistPools SpecialistPoolService::ListSpecialistPools}.
        # @!attribute [rw] parent
        #   @return [String]
        ...
        #     the previous {Google::Cloud::Aiplatform::V1::SpecialistPoolService::ListSpecialistPools SpecialistPoolService::ListSpecialistPools} call. Return
        #     first page if empty.
        ...
        # Response message for {Google::Cloud::Aiplatform::V1::SpecialistPoolService::ListSpecialistPools SpecialistPoolService::ListSpecialistPools}.
        ...
        # Request message for {Google::Cloud::Aiplatform::V1::SpecialistPoolService::DeleteSpecialistPool SpecialistPoolService::DeleteSpecialistPool}.
        # @!attribute [rw] name
        #   @return [String]
        ...
        # Request message for {Google::Cloud::Aiplatform::V1::SpecialistPoolService::UpdateSpecialistPool SpecialistPoolService::UpdateSpecialistPool}.
        # @!attribute [rw] specialist_pool
        #   @return [Google::Cloud::Aiplatform::V1::SpecialistPool]
        ...
        # {Google::Cloud::Aiplatform::V1::SpecialistPoolService::UpdateSpecialistPool SpecialistPoolService::UpdateSpecialistPool}.
        # @!attribute [rw] specialist_pool
        #   @return [String]
