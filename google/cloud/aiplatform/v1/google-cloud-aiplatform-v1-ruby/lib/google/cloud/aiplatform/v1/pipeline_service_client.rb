  ...
  module Cloud
    module Aiplatform
      module V1
        ...
        #   @return [Google::Cloud::Aiplatform::V1::PipelineService::Stub]
        class PipelineServiceClient
          ...
          def initialize \
            ...
            @pipeline_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Aiplatform::V1::PipelineService::Stub.method(:new)
            )
          ...
          #   A hash of the same form as `Google::Cloud::Aiplatform::V1::TrainingPipeline`
          ...
          #
          #   pipeline_client = Google::Cloud::Aiplatform::Pipeline.new(version: :v1)
          ...
          def create_training_pipeline \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::CreateTrainingPipelineRequest)
          ...
          def get_training_pipeline \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::GetTrainingPipelineRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::TrainingPipeline>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::TrainingPipeline>]
          #   An enumerable of Google::Cloud::Aiplatform::V1::TrainingPipeline instances.
          ...
          def list_training_pipelines \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::ListTrainingPipelinesRequest)
          ...
          def delete_training_pipeline \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::DeleteTrainingPipelineRequest)
          ...
          # guaranteed. Clients can use {Google::Cloud::Aiplatform::V1::PipelineService::GetTrainingPipeline PipelineService::GetTrainingPipeline} or
          # other methods to check whether the cancellation succeeded or whether the
          # pipeline completed despite cancellation. On successful cancellation,
          # the TrainingPipeline is not deleted; instead it becomes a pipeline with
          # a {Google::Cloud::Aiplatform::V1::TrainingPipeline#error TrainingPipeline#error} value with a {Google::Rpc::Status#code} of 1,
          ...
          def cancel_training_pipeline \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::CancelTrainingPipelineRequest)
