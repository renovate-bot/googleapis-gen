  ...
  module Cloud
    module Aiplatform
      module V1
        ...
        #   @return [Google::Cloud::Aiplatform::V1::SpecialistPoolService::Stub]
        class SpecialistPoolServiceClient
          ...
          def initialize \
            ...
            @specialist_pool_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Aiplatform::V1::SpecialistPoolService::Stub.method(:new)
            )
          ...
          #   A hash of the same form as `Google::Cloud::Aiplatform::V1::SpecialistPool`
          ...
          #
          #   specialist_pool_client = Google::Cloud::Aiplatform::SpecialistPool.new(version: :v1)
          ...
          def create_specialist_pool \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::CreateSpecialistPoolRequest)
          ...
          def get_specialist_pool \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::GetSpecialistPoolRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::SpecialistPool>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::SpecialistPool>]
          #   An enumerable of Google::Cloud::Aiplatform::V1::SpecialistPool instances.
          ...
          def list_specialist_pools \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::ListSpecialistPoolsRequest)
          ...
          def delete_specialist_pool \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::DeleteSpecialistPoolRequest)
            operation = Google::Gax::Operation.new(
          ...
          def update_specialist_pool \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::UpdateSpecialistPoolRequest)
            operation = Google::Gax::Operation.new(
