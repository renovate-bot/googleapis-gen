  ...
  module Cloud
    module Aiplatform
      module V1
        ...
        #   @return [Google::Cloud::Aiplatform::V1::MigrationService::Stub]
        class MigrationServiceClient
          ...
          def initialize \
            ...
            @migration_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Aiplatform::V1::MigrationService::Stub.method(:new)
            )
          ...
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::MigratableResource>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1::MigratableResource>]
          #   An enumerable of Google::Cloud::Aiplatform::V1::MigratableResource instances.
          ...
          #
          #   migration_client = Google::Cloud::Aiplatform::Migration.new(version: :v1)
          ...
          def search_migratable_resources \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::SearchMigratableResourcesRequest)
          ...
          #   A hash of the same form as `Google::Cloud::Aiplatform::V1::MigrateResourceRequest`
          ...
          def batch_migrate_resources \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1::BatchMigrateResourcesRequest)
