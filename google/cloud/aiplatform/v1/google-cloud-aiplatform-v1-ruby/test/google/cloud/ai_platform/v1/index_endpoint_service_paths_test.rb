...
class ::Google::Cloud::AIPlatform::V1::IndexEndpointService::ClientPathsTest < Minitest::Test
  def test_index_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.index_path project: "value0", location: "value1", index: "value2"
      assert_equal "projects/value0/locations/value1/indexes/value2", path
    end
  end
