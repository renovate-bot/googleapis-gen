...
class IndexServiceClientMeta(type):
    """Metaclass for the IndexService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[IndexServiceTransport]]
...
class IndexServiceClient(metaclass=IndexServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            IndexServiceClient: The constructed client.
        """
    ...
    def index_path(project: str,location: str,index: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/indexes/{index}".format(project=project, location=location, index=index, )

    @staticmethod
    def parse_index_path(path: str) -> Dict[str,str]:
        """Parses a index path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/indexes/(?P<index>.+?)$", path)
    ...
    def index_endpoint_path(project: str,location: str,index_endpoint: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/indexEndpoints/{index_endpoint}".format(project=project, location=location, index_endpoint=index_endpoint, )

    @staticmethod
    def parse_index_endpoint_path(path: str) -> Dict[str,str]:
        """Parses a index_endpoint path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/indexEndpoints/(?P<index_endpoint>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, IndexServiceTransport):
            # transport is a IndexServiceTransport instance.
    ...
    def create_index(self,
        ...
        # in a index_service.CreateIndexRequest.
    ...
    def get_index(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a index_service.GetIndexRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_indexes(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a index_service.ListIndexesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_index(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a index_service.UpdateIndexRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_index(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a index_service.DeleteIndexRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
