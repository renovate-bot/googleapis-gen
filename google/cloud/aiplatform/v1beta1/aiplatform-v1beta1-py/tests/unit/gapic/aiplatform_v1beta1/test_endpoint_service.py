...
from google.cloud.aiplatform_v1beta1.services.endpoint_service import EndpointServiceAsyncClient
...
from google.cloud.aiplatform_v1beta1.services.endpoint_service.transports.base import _API_CORE_VERSION
from google.cloud.aiplatform_v1beta1.services.endpoint_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert EndpointServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert EndpointServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert EndpointServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert EndpointServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert EndpointServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (EndpointServiceAsyncClient, transports.EndpointServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_endpoint_service_client_client_options(client_class, transport_class, transport_name):
...
def test_endpoint_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_endpoint_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_endpoint_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_endpoint_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1beta1.services.endpoint_service.transports.EndpointServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_endpoint(transport: str = 'grpc', request_type=endpoint_service.CreateEndpointRequest):
    client = EndpointServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_endpoints(transport: str = 'grpc', request_type=endpoint_service.ListEndpointsRequest):
    client = EndpointServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_deploy_model(transport: str = 'grpc', request_type=endpoint_service.DeployModelRequest):
    client = EndpointServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_deploy_model_flattened():
    ...
    with mock.patch.object(
        ...
        client.deploy_model(
            ...
            deployed_model=gca_endpoint.DeployedModel(dedicated_resources=machine_resources.DedicatedResources(machine_spec=machine_resources.MachineSpec(machine_type='machine_type_value'))),
...
def test_undeploy_model(transport: str = 'grpc', request_type=endpoint_service.UndeployModelRequest):
    client = EndpointServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_endpoint_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.endpoint_service.transports.EndpointServiceTransport.__init__') as Transport:
...
def test_endpoint_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.endpoint_service.transports.EndpointServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_endpoint_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.endpoint_service.transports.EndpointServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.EndpointServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.EndpointServiceGrpcTransport, transports.EndpointServiceGrpcAsyncIOTransport])
def test_endpoint_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.EndpointServiceGrpcTransport, transports.EndpointServiceGrpcAsyncIOTransport])
def test_endpoint_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.EndpointServiceTransport, '_prep_wrapped_messages') as prep:
        client = EndpointServiceClient(
            credentials=credentials.AnonymousCredentials(),
