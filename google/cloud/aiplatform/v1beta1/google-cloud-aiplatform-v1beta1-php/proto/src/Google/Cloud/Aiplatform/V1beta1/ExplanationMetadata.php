 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ExplanationMetadata</code>
 */
class ExplanationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata> inputs = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $inputs;
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.aiplatform.v1beta1.ExplanationMetadata.OutputMetadata> outputs = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $outputs;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\ExplanationMetadata\InputMetadata::class);
        $this->inputs = $arr;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\ExplanationMetadata\OutputMetadata::class);
        $this->outputs = $arr;
