 ...
 * values.
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.Measurement</code>
 */
class Measurement extends \Google\Protobuf\Internal\Message
{
     ...
     * Parameter values.
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Measurement.Metric metrics = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $metrics;
     ...
     *           Output only. The number of steps the machine learning model has been trained for.
     *           Must be non-negative.
     *     @type \Google\Cloud\Aiplatform\V1beta1\Measurement\Metric[]|\Google\Protobuf\Internal\RepeatedField $metrics
     *           Output only. A list of metrics got by evaluating the objective functions using suggested
     *           Parameter values.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Measurement.Metric metrics = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\Measurement\Metric[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMetrics($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\Measurement\Metric::class);
        $this->metrics = $arr;
