 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ModelEvaluation</code>
 */
class ModelEvaluation extends \Google\Protobuf\Internal\Message
{
     ...
     *           [ModelService.ListModelEvaluationSlices][google.cloud.aiplatform.v1beta1.ModelService.ListModelEvaluationSlices] request, in the form of
     *           `slice.dimension = <dimension>`.
     *     @type \Google\Cloud\AIPlatform\V1beta1\ModelExplanation $model_explanation
     *           Output only. Aggregated explanation metrics for the Model's prediction output over the
     *           data this ModelEvaluation uses. This field is populated only if the Model
     *           is evaluated with explanations, and only for AutoML tabular Models.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelExplanation model_explanation = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ModelExplanation $var
     * @return $this
     */
