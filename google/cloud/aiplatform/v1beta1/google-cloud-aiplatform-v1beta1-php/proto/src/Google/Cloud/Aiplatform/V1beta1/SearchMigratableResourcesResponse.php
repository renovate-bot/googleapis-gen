 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.SearchMigratableResourcesResponse</code>
 */
class SearchMigratableResourcesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.MigratableResource migratable_resources = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Aiplatform\V1beta1\MigratableResource[]|\Google\Protobuf\Internal\RepeatedField $migratable_resources
     *           All migratable resources that can be migrated to the
     *           location specified in the request.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.MigratableResource migratable_resources = 1;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\MigratableResource[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMigratableResources($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\MigratableResource::class);
