...
namespace Google\Cloud\AIPlatform\V1beta1\Feature;
 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.Feature.ValueType</code>
 */
class ValueType
{
    /**
...
class_alias(ValueType::class, \Google\Cloud\AIPlatform\V1beta1\Feature_ValueType::class);
