 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreateArtifactRequest</code>
 */
class CreateArtifactRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Artifact artifact = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Format:
     *           projects/{project}/locations/{location}/metadataStores/{metadatastore}
     *     @type \Google\Cloud\AIPlatform\V1beta1\Artifact $artifact
     *           Required. The Artifact to create.
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\Artifact::class);
        $this->artifact = $var;
