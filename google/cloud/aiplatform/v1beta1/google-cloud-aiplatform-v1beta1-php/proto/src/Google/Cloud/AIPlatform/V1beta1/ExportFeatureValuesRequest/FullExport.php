 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ExportFeatureValuesRequest.FullExport</code>
 */
...
class_alias(FullExport::class, \Google\Cloud\AIPlatform\V1beta1\ExportFeatureValuesRequest_FullExport::class);
