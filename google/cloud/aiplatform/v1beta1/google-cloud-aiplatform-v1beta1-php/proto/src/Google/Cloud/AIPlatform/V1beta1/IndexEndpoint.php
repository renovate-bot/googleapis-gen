 ...
 * DeployedIndexes.
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.IndexEndpoint</code>
 */
class IndexEndpoint extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.DeployedIndex deployed_indexes = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           The description of the IndexEndpoint.
     *     @type \Google\Cloud\AIPlatform\V1beta1\DeployedIndex[]|\Google\Protobuf\Internal\RepeatedField $deployed_indexes
     *           Output only. The indexes deployed in this endpoint.
     *     @type string $etag
     *           Used to perform consistent read-modify-write updates. If not set, a blind
     *           "overwrite" update happens.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.DeployedIndex deployed_indexes = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\DeployedIndex[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDeployedIndexes($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\DeployedIndex::class);
