...
/**
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.NearestNeighborSearchOperationMetadata.RecordError</code>
 */
class RecordError extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.NearestNeighborSearchOperationMetadata.RecordError.RecordErrorType error_type = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Aiplatform\V1beta1\NearestNeighborSearchOperationMetadata\RecordError\RecordErrorType::class);
        $this->error_type = $var;
...
class_alias(RecordError::class, \Google\Cloud\Aiplatform\V1beta1\NearestNeighborSearchOperationMetadata_RecordError::class);
