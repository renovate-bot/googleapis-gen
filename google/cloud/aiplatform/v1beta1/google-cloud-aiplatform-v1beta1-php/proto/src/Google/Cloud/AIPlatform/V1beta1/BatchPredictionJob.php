 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.BatchPredictionJob</code>
 */
class BatchPredictionJob extends \Google\Protobuf\Internal\Message
{
     ...
     * Exactly one of model and unmanaged_container_model must be set.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.UnmanagedContainerModel unmanaged_container_model = 28;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchPredictionJob.InputConfig input_config = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputConfig output_config = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * must be provided.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchDedicatedResources dedicated_resources = 7;</code>
     */
     ...
     * the tuning itself).
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ManualBatchTuningParameters manual_batch_tuning_parameters = 8 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputInfo output_info = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $output_info = null;
    /**
     * Output only. The detailed state of the job.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.JobState state = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     * use AutoML Models.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ResourcesConsumed resources_consumed = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $resources_consumed = null;
    /**
     * Output only. Statistics on completed and failed prediction instances.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CompletionStats completion_stats = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           and their resources.
     *           Exactly one of model and unmanaged_container_model must be set.
     *     @type \Google\Cloud\AIPlatform\V1beta1\UnmanagedContainerModel $unmanaged_container_model
     *           Contains model information necessary to perform batch prediction without
     *           requiring uploading to model registry.
     *           Exactly one of model and unmanaged_container_model must be set.
     *     @type \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\InputConfig $input_config
     *           Required. Input configuration of the instances on which predictions are performed.
     *           The schema of any single instance may be specified via
     *           the [Model's][google.cloud.aiplatform.v1beta1.BatchPredictionJob.model]
     *           [PredictSchemata's][google.cloud.aiplatform.v1beta1.Model.predict_schemata]
     ...
     *           [PredictSchemata's][google.cloud.aiplatform.v1beta1.Model.predict_schemata]
     *           [parameters_schema_uri][google.cloud.aiplatform.v1beta1.PredictSchemata.parameters_schema_uri].
     *     @type \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\OutputConfig $output_config
     *           Required. The Configuration specifying where output predictions should
     *           be written.
     *           The schema of any single prediction may be specified as a concatenation
     *           of [Model's][google.cloud.aiplatform.v1beta1.BatchPredictionJob.model]
     ...
     *           and
     *           [prediction_schema_uri][google.cloud.aiplatform.v1beta1.PredictSchemata.prediction_schema_uri].
     *     @type \Google\Cloud\AIPlatform\V1beta1\BatchDedicatedResources $dedicated_resources
     *           The config of resources used by the Model during the batch prediction. If
     *           the Model [supports][google.cloud.aiplatform.v1beta1.Model.supported_deployment_resources_types]
     *           DEDICATED_RESOURCES this config may be provided (and the job will use these
     *           resources), if the Model doesn't support AUTOMATIC_RESOURCES, this config
     *           must be provided.
     *     @type \Google\Cloud\AIPlatform\V1beta1\ManualBatchTuningParameters $manual_batch_tuning_parameters
     *           Immutable. Parameters configuring the batch behavior. Currently only applicable when
     *           [dedicated_resources][google.cloud.aiplatform.v1beta1.BatchPredictionJob.dedicated_resources] are used (in other cases Vertex AI does
     *           the tuning itself).
     ...
     *           This field never exceeds 20 entries.
     *           Status details fields contain standard GCP error details.
     *     @type \Google\Cloud\AIPlatform\V1beta1\ResourcesConsumed $resources_consumed
     *           Output only. Information about resources that had been consumed by this job.
     *           Provided in real time at best effort basis, as well as a final value
     *           once the job completes.
     *           Note: This field currently may be not populated for batch predictions that
     *           use AutoML Models.
     *     @type \Google\Cloud\AIPlatform\V1beta1\CompletionStats $completion_stats
     *           Output only. Statistics on completed and failed prediction instances.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.UnmanagedContainerModel unmanaged_container_model = 28;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\UnmanagedContainerModel|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.UnmanagedContainerModel unmanaged_container_model = 28;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\UnmanagedContainerModel $var
     * @return $this
     */
    public function setUnmanagedContainerModel($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\UnmanagedContainerModel::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchPredictionJob.InputConfig input_config = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\InputConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchPredictionJob.InputConfig input_config = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\InputConfig $var
     * @return $this
     */
    public function setInputConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\InputConfig::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputConfig output_config = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\OutputConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputConfig output_config = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\OutputConfig $var
     * @return $this
     */
    public function setOutputConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\OutputConfig::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchDedicatedResources dedicated_resources = 7;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\BatchDedicatedResources|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchDedicatedResources dedicated_resources = 7;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\BatchDedicatedResources $var
     * @return $this
     */
    public function setDedicatedResources($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\BatchDedicatedResources::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ManualBatchTuningParameters manual_batch_tuning_parameters = 8 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\ManualBatchTuningParameters|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ManualBatchTuningParameters manual_batch_tuning_parameters = 8 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ManualBatchTuningParameters $var
     * @return $this
     */
    public function setManualBatchTuningParameters($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\ManualBatchTuningParameters::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputInfo output_info = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\OutputInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputInfo output_info = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\OutputInfo $var
     * @return $this
     */
    public function setOutputInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob\OutputInfo::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ResourcesConsumed resources_consumed = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\ResourcesConsumed|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ResourcesConsumed resources_consumed = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ResourcesConsumed $var
     * @return $this
     */
    public function setResourcesConsumed($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\ResourcesConsumed::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CompletionStats completion_stats = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\CompletionStats|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CompletionStats completion_stats = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\CompletionStats $var
     * @return $this
     */
    public function setCompletionStats($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\CompletionStats::class);
