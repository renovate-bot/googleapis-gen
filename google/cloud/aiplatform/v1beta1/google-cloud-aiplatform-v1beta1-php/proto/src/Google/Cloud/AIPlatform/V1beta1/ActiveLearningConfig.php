 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ActiveLearningConfig</code>
 */
class ActiveLearningConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SampleConfig sample_config = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TrainingConfig training_config = 4;</code>
     */
     ...
     *     @type \Google\Cloud\AIPlatform\V1beta1\SampleConfig $sample_config
     *           Active learning data sampling config. For every active learning labeling
     *           iteration, it will select a batch of data based on the sampling strategy.
     *     @type \Google\Cloud\AIPlatform\V1beta1\TrainingConfig $training_config
     *           CMLE training config. For every active learning labeling iteration, system
     *           will train a machine learning model on CMLE. The trained model will be used
     *           by data sampling algorithm to select DataItems.
     * }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SampleConfig sample_config = 3;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\SampleConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SampleConfig sample_config = 3;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\SampleConfig $var
     * @return $this
     */
    public function setSampleConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\SampleConfig::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TrainingConfig training_config = 4;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\TrainingConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TrainingConfig training_config = 4;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\TrainingConfig $var
     * @return $this
     */
    public function setTrainingConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\TrainingConfig::class);
