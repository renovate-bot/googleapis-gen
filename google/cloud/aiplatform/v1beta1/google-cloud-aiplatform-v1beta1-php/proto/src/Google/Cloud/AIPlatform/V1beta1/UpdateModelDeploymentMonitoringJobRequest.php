 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.UpdateModelDeploymentMonitoringJobRequest</code>
 */
class UpdateModelDeploymentMonitoringJobRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * server.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob model_deployment_monitoring_job = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringJob $model_deployment_monitoring_job
     *           Required. The model monitoring configuration which replaces the resource on the
     *           server.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob model_deployment_monitoring_job = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringJob|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob model_deployment_monitoring_job = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringJob $var
     * @return $this
     */
