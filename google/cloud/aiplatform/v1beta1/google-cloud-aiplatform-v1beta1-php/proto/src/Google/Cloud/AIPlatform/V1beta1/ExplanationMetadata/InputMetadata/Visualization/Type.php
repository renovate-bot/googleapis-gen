...
namespace Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\Visualization;
...
class_alias(Type::class, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata_InputMetadata_Visualization_Type::class);
