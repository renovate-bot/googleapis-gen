 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringBigQueryTable</code>
 */
class ModelDeploymentMonitoringBigQueryTable extends \Google\Protobuf\Internal\Message
{
     ...
     * The source of log.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringBigQueryTable.LogSource log_source = 1;</code>
     */
    protected $log_source = 0;
    /**
     * The type of log.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringBigQueryTable.LogType log_type = 2;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringBigQueryTable\LogSource::class);
        $this->log_source = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringBigQueryTable\LogType::class);
        $this->log_type = $var;
