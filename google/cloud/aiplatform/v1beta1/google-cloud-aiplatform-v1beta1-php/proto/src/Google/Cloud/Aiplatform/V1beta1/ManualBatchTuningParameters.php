 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ManualBatchTuningParameters</code>
 */
class ManualBatchTuningParameters extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Aiplatform\V1Beta1\ManualBatchTuningParameters::initOnce();
