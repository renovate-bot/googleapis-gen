 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ModelMonitoringObjectiveConfig.ExplanationConfig</code>
 */
class ExplanationConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelMonitoringObjectiveConfig.ExplanationConfig.ExplanationBaseline explanation_baseline = 2;</code>
     */
     ...
     *           If set to true, Vertex AI will log the feature attributions from
     *           explain response and do the skew/drift detection for them.
     *     @type \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringObjectiveConfig\ExplanationConfig\ExplanationBaseline $explanation_baseline
     *           Predictions generated by the BatchPredictionJob using baseline dataset.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelMonitoringObjectiveConfig.ExplanationConfig.ExplanationBaseline explanation_baseline = 2;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringObjectiveConfig\ExplanationConfig\ExplanationBaseline|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelMonitoringObjectiveConfig.ExplanationConfig.ExplanationBaseline explanation_baseline = 2;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringObjectiveConfig\ExplanationConfig\ExplanationBaseline $var
     * @return $this
     */
    public function setExplanationBaseline($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringObjectiveConfig\ExplanationConfig\ExplanationBaseline::class);
...
class_alias(ExplanationConfig::class, \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringObjectiveConfig_ExplanationConfig::class);
