 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ImportFeatureValuesRequest</code>
 */
class ImportFeatureValuesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.ImportFeatureValuesRequest.FeatureSpec feature_specs = 8 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\Aiplatform\V1beta1\AvroSource $avro_source
     *     @type \Google\Cloud\Aiplatform\V1beta1\BigQuerySource $bigquery_source
     *     @type \Google\Cloud\Aiplatform\V1beta1\CsvSource $csv_source
     ...
     *           Source column that holds entity IDs. If not provided, entity IDs are
     *           extracted from the column named `entity_id`.
     *     @type \Google\Cloud\Aiplatform\V1beta1\ImportFeatureValuesRequest\FeatureSpec[]|\Google\Protobuf\Internal\RepeatedField $feature_specs
     *           Required. Specifications defining which Feature values to import from the entity. The
     *           request fails if no feature_specs are provided, and having multiple
     *           feature_specs for one Feature is not allowed.
    ...
    /**
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.AvroSource avro_source = 2;</code>
     * @return \Google\Cloud\Aiplatform\V1beta1\AvroSource|null
     */
    ...
    /**
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.AvroSource avro_source = 2;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\AvroSource $var
     * @return $this
     */
    public function setAvroSource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\AvroSource::class);
    ...
    /**
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CsvSource csv_source = 4;</code>
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.ImportFeatureValuesRequest.FeatureSpec feature_specs = 8 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\ImportFeatureValuesRequest\FeatureSpec[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFeatureSpecs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\ImportFeatureValuesRequest\FeatureSpec::class);
