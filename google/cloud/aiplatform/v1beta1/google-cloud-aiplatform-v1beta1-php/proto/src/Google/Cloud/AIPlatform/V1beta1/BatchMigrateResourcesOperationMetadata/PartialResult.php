...
namespace Google\Cloud\AIPlatform\V1beta1\BatchMigrateResourcesOperationMetadata;
...
class PartialResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.MigrateResourceRequest request = 1;</code>
     */
     ...
     *     @type \Google\Cloud\AIPlatform\V1beta1\MigrateResourceRequest $request
     *           It's the same as the value in
     *           [MigrateResourceRequest.migrate_resource_requests][].
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.MigrateResourceRequest request = 1;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\MigrateResourceRequest|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.MigrateResourceRequest request = 1;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\MigrateResourceRequest $var
     * @return $this
     */
    public function setRequest($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\MigrateResourceRequest::class);
        $this->request = $var;
...
class_alias(PartialResult::class, \Google\Cloud\AIPlatform\V1beta1\BatchMigrateResourcesOperationMetadata_PartialResult::class);
