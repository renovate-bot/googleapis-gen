 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.Execution</code>
 */
class Execution extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\Execution\State::class);
        $this->state = $var;
