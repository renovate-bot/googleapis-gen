 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.BatchMigrateResourcesRequest</code>
 */
class BatchMigrateResourcesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.MigrateResourceRequest migrate_resource_requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The location of the migrated resource will live in.
     *           Format: `projects/{project}/locations/{location}`
     *     @type \Google\Cloud\Aiplatform\V1beta1\MigrateResourceRequest[]|\Google\Protobuf\Internal\RepeatedField $migrate_resource_requests
     *           Required. The request messages specifying the resources to migrate.
     *           They must be in the same location as the destination.
     *           Up to 50 resources can be migrated in one batch.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.MigrateResourceRequest migrate_resource_requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\MigrateResourceRequest[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMigrateResourceRequests($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\MigrateResourceRequest::class);
