...
namespace Google\Cloud\Aiplatform\V1beta1\TensorboardTimeSeries;
 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.ValueType</code>
 */
class ValueType
{
    /**
...
class_alias(ValueType::class, \Google\Cloud\Aiplatform\V1beta1\TensorboardTimeSeries_ValueType::class);
