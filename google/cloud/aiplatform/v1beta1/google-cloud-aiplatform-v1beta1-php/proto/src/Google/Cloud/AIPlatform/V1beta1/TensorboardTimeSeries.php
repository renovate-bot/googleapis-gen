 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.TensorboardTimeSeries</code>
 */
class TensorboardTimeSeries extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.ValueType value_type = 4 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.Metadata metadata = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Data of the current plugin, with the size limited to 65KB.
     *     @type \Google\Cloud\AIPlatform\V1beta1\TensorboardTimeSeries\Metadata $metadata
     *           Output only. Scalar, Tensor, or Blob metadata for this TensorboardTimeSeries.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\TensorboardTimeSeries\ValueType::class);
        $this->value_type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.Metadata metadata = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\TensorboardTimeSeries\Metadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.Metadata metadata = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\TensorboardTimeSeries\Metadata $var
     * @return $this
     */
    public function setMetadata($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\TensorboardTimeSeries\Metadata::class);
        $this->metadata = $var;
