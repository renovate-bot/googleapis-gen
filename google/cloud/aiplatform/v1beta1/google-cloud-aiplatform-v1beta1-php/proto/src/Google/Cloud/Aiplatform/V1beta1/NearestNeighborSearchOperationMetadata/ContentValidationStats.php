...
namespace Google\Cloud\Aiplatform\V1beta1\NearestNeighborSearchOperationMetadata;
...
/**
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.NearestNeighborSearchOperationMetadata.ContentValidationStats</code>
 */
class ContentValidationStats extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.NearestNeighborSearchOperationMetadata.RecordError partial_errors = 4;</code>
     */
     ...
     *           Number of records in this file we skipped due to validate errors.
     *     @type \Google\Cloud\Aiplatform\V1beta1\NearestNeighborSearchOperationMetadata\RecordError[]|\Google\Protobuf\Internal\RepeatedField $partial_errors
     *           The detail information of the partial failures encountered for those
     *           invalid records that couldn't be parsed.
     *           Up to 50 partial errors will be reported.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.NearestNeighborSearchOperationMetadata.RecordError partial_errors = 4;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\NearestNeighborSearchOperationMetadata\RecordError[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPartialErrors($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\NearestNeighborSearchOperationMetadata\RecordError::class);
...
class_alias(ContentValidationStats::class, \Google\Cloud\Aiplatform\V1beta1\NearestNeighborSearchOperationMetadata_ContentValidationStats::class);
