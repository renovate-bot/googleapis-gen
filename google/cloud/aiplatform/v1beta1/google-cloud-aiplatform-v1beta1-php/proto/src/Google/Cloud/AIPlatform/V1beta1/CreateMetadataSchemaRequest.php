 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreateMetadataSchemaRequest</code>
 */
class CreateMetadataSchemaRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.MetadataSchema metadata_schema = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Format:
     *           projects/{project}/locations/{location}/metadataStores/{metadatastore}
     *     @type \Google\Cloud\AIPlatform\V1beta1\MetadataSchema $metadata_schema
     *           Required. The MetadataSchema to create.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.MetadataSchema metadata_schema = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\MetadataSchema|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.MetadataSchema metadata_schema = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\MetadataSchema $var
     * @return $this
     */
