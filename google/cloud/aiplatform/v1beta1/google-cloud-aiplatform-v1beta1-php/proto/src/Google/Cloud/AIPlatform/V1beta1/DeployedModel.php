 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.DeployedModel</code>
 */
class DeployedModel extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $enable_container_logging = false;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PrivateEndpoints private_endpoints = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     *     @type \Google\Cloud\AIPlatform\V1beta1\DedicatedResources $dedicated_resources
     ...
     *           receives prediction requests at a high queries per second rate (QPS).
     *           Estimate your costs before enabling this option.
     *     @type \Google\Cloud\AIPlatform\V1beta1\PrivateEndpoints $private_endpoints
     *           Output only. Provide paths for users to send predict/explain/health requests directly to
     *           the deployed model services running on Cloud via private services access.
     *           This field is populated if [network][google.cloud.aiplatform.v1beta1.Endpoint.network] is configured.
     * }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DedicatedResources dedicated_resources = 7;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\DedicatedResources $var
     * @return $this
     */
    public function setDedicatedResources($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\DedicatedResources::class);
     ...
     * @return bool
     */
    public function getEnableContainerLogging()
    {
        return $this->enable_container_logging;
    }
     ...
     * @return $this
     */
    public function setEnableContainerLogging($var)
    {
        GPBUtil::checkBool($var);
        $this->enable_container_logging = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PrivateEndpoints private_endpoints = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\PrivateEndpoints|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PrivateEndpoints private_endpoints = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\PrivateEndpoints $var
     * @return $this
     */
    public function setPrivateEndpoints($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\PrivateEndpoints::class);
