...
namespace Google\Cloud\Aiplatform\V1beta1\Model;
...
class ExportFormat extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Model.ExportFormat.ExportableContent exportable_contents = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Aiplatform\V1beta1\Model\ExportFormat\ExportableContent::class);
...
class_alias(ExportFormat::class, \Google\Cloud\Aiplatform\V1beta1\Model_ExportFormat::class);
