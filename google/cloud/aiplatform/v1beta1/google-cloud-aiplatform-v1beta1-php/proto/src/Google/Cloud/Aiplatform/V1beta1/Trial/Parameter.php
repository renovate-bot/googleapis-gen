...
namespace Google\Cloud\Aiplatform\V1beta1\Trial;
 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.Trial.Parameter</code>
 */
...
class_alias(Parameter::class, \Google\Cloud\Aiplatform\V1beta1\Trial_Parameter::class);
