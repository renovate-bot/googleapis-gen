 ...
 * abnormal behaviors.
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob</code>
 */
class ModelDeploymentMonitoringJob extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.JobState state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     * Output only. Schedule state when the monitoring job is in Running state.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob.MonitoringScheduleState schedule_state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringScheduleConfig model_deployment_monitoring_schedule_config = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $model_deployment_monitoring_schedule_config = null;
    /**
     * Required. Sample Strategy for logging.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SamplingStrategy logging_sampling_strategy = 8 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $logging_sampling_strategy = null;
    /**
     * Alert config for model monitoring.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelMonitoringAlertConfig model_monitoring_alert_config = 15;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringBigQueryTable bigquery_tables = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Required. Sample Strategy for logging.
     *     @type \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringAlertConfig $model_monitoring_alert_config
     *           Alert config for model monitoring.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\JobState::class);
        $this->state = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringJob\MonitoringScheduleState::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringObjectiveConfig::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringScheduleConfig model_deployment_monitoring_schedule_config = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringScheduleConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringScheduleConfig model_deployment_monitoring_schedule_config = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringScheduleConfig $var
     * @return $this
     */
    public function setModelDeploymentMonitoringScheduleConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringScheduleConfig::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SamplingStrategy logging_sampling_strategy = 8 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\SamplingStrategy|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SamplingStrategy logging_sampling_strategy = 8 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\SamplingStrategy $var
     * @return $this
     */
    public function setLoggingSamplingStrategy($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\SamplingStrategy::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelMonitoringAlertConfig model_monitoring_alert_config = 15;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringAlertConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelMonitoringAlertConfig model_monitoring_alert_config = 15;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringAlertConfig $var
     * @return $this
     */
    public function setModelMonitoringAlertConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringAlertConfig::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringBigQueryTable bigquery_tables = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringBigQueryTable[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBigqueryTables($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringBigQueryTable::class);
