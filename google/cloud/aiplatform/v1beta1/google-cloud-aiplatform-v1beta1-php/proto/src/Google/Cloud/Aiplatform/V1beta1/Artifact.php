 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.Artifact</code>
 */
class Artifact extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Aiplatform\V1beta1\Artifact\State::class);
        $this->state = $var;
