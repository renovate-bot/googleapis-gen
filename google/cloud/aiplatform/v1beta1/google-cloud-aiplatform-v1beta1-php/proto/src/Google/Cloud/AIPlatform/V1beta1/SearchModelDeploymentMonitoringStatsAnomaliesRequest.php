 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.SearchModelDeploymentMonitoringStatsAnomaliesRequest</code>
 */
class SearchModelDeploymentMonitoringStatsAnomaliesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.SearchModelDeploymentMonitoringStatsAnomaliesRequest.StatsAnomaliesObjective objectives = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $objectives;
    /**
     ...
     *           [ModelMonitoringStatsAnomalies.FeatureHistoricStatsAnomalies.feature_display_name][google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies.FeatureHistoricStatsAnomalies.feature_display_name],
     *           example: "user_destination".
     *     @type \Google\Cloud\AIPlatform\V1beta1\SearchModelDeploymentMonitoringStatsAnomaliesRequest\StatsAnomaliesObjective[]|\Google\Protobuf\Internal\RepeatedField $objectives
     *           Required. Objectives of the stats to retrieve.
     *     @type int $page_size
     *           The standard list page size.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.SearchModelDeploymentMonitoringStatsAnomaliesRequest.StatsAnomaliesObjective objectives = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\SearchModelDeploymentMonitoringStatsAnomaliesRequest\StatsAnomaliesObjective[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setObjectives($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\SearchModelDeploymentMonitoringStatsAnomaliesRequest\StatsAnomaliesObjective::class);
        $this->objectives = $arr;
