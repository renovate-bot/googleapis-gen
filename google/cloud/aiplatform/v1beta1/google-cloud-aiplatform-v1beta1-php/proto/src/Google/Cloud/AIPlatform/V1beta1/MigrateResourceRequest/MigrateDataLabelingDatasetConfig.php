...
class MigrateDataLabelingDatasetConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfig migrate_data_labeling_annotated_dataset_configs = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Optional. Display name of the Dataset in Vertex AI.
     *           System will pick a display name if unspecified.
     *     @type \Google\Cloud\AIPlatform\V1beta1\MigrateResourceRequest\MigrateDataLabelingDatasetConfig\MigrateDataLabelingAnnotatedDatasetConfig[]|\Google\Protobuf\Internal\RepeatedField $migrate_data_labeling_annotated_dataset_configs
     *           Optional. Configs for migrating AnnotatedDataset in datalabeling.googleapis.com to
     *           Vertex AI's SavedQuery. The specified AnnotatedDatasets have to belong
     *           to the datalabeling Dataset.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfig migrate_data_labeling_annotated_dataset_configs = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\MigrateResourceRequest\MigrateDataLabelingDatasetConfig\MigrateDataLabelingAnnotatedDatasetConfig[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMigrateDataLabelingAnnotatedDatasetConfigs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\MigrateResourceRequest\MigrateDataLabelingDatasetConfig\MigrateDataLabelingAnnotatedDatasetConfig::class);
...
class_alias(MigrateDataLabelingDatasetConfig::class, \Google\Cloud\AIPlatform\V1beta1\MigrateResourceRequest_MigrateDataLabelingDatasetConfig::class);
