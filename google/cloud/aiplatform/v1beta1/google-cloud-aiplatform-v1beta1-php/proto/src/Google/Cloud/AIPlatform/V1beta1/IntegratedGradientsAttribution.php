 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.IntegratedGradientsAttribution</code>
 */
class IntegratedGradientsAttribution extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BlurBaselineConfig blur_baseline_config = 3;</code>
     */
     ...
     *           sum to diff property is within the desired error range.
     *           Valid range of its value is [1, 100], inclusively.
     *     @type \Google\Cloud\AIPlatform\V1beta1\SmoothGradConfig $smooth_grad_config
     *           Config for SmoothGrad approximation of gradients.
     *           When enabled, the gradients are approximated by averaging the gradients
     *           from noisy samples in the vicinity of the inputs. Adding
     *           noise can help improve the computed gradients. Refer to this paper for more
     *           details: https://arxiv.org/pdf/1706.03825.pdf
     *     @type \Google\Cloud\AIPlatform\V1beta1\BlurBaselineConfig $blur_baseline_config
     *           Config for IG with blur baseline.
     *           When enabled, a linear path from the maximally blurred image to the input
     *           image is created. Using a blurred baseline instead of zero (black image) is
     *           motivated by the BlurIG approach explained here:
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SmoothGradConfig smooth_grad_config = 2;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\SmoothGradConfig $var
     * @return $this
     */
    public function setSmoothGradConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\SmoothGradConfig::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BlurBaselineConfig blur_baseline_config = 3;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\BlurBaselineConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BlurBaselineConfig blur_baseline_config = 3;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\BlurBaselineConfig $var
     * @return $this
     */
    public function setBlurBaselineConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\BlurBaselineConfig::class);
