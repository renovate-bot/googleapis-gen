 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.Explanation</code>
 */
class Explanation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Attribution attributions = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     *     @type \Google\Cloud\Aiplatform\V1beta1\Attribution[]|\Google\Protobuf\Internal\RepeatedField $attributions
     *           Output only. Feature attributions grouped by predicted outputs.
     *           For Models that predict only one output, such as regression Models that
     *           predict only one score, there is only one attibution that explains the
     *           predicted output. For Models that predict multiple outputs, such as
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Attribution attributions = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\Attribution[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAttributions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\Attribution::class);
