 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreateExecutionRequest</code>
 */
class CreateExecutionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Execution execution = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Format:
     *           projects/{project}/locations/{location}/metadataStores/{metadatastore}
     *     @type \Google\Cloud\Aiplatform\V1beta1\Execution $execution
     *           Required. The Execution to create.
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\Execution::class);
        $this->execution = $var;
