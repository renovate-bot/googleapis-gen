 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.MigratableResource.AutomlDataset</code>
 */
...
class_alias(AutomlDataset::class, \Google\Cloud\AIPlatform\V1beta1\MigratableResource_AutomlDataset::class);
