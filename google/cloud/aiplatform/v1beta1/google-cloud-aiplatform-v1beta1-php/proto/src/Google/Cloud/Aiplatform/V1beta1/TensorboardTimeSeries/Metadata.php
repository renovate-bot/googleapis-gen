 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.Metadata</code>
 */
...
class_alias(Metadata::class, \Google\Cloud\Aiplatform\V1beta1\TensorboardTimeSeries_Metadata::class);
