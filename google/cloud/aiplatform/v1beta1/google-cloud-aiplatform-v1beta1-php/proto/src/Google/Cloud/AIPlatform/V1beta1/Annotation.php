 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.Annotation</code>
 */
class Annotation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.UserActionReference annotation_source = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\UserActionReference $var
     * @return $this
     */
    public function setAnnotationSource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\UserActionReference::class);
