...
namespace Google\Cloud\AIPlatform\V1beta1\SearchModelDeploymentMonitoringStatsAnomaliesRequest;
 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.SearchModelDeploymentMonitoringStatsAnomaliesRequest.StatsAnomaliesObjective</code>
 */
class StatsAnomaliesObjective extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringObjectiveType type = 1;</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringObjectiveType::class);
        $this->type = $var;
...
class_alias(StatsAnomaliesObjective::class, \Google\Cloud\AIPlatform\V1beta1\SearchModelDeploymentMonitoringStatsAnomaliesRequest_StatsAnomaliesObjective::class);
