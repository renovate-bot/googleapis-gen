 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.UpdateFeaturestoreRequest</code>
 */
class UpdateFeaturestoreRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Featurestore featurestore = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\Aiplatform\V1beta1\Featurestore $featurestore
     *           Required. The Featurestore's `name` field is used to identify the Featurestore to be
     *           updated.
     *           Format:
     *           `projects/{project}/locations/{location}/featurestores/{featurestore}`
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Featurestore featurestore = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Aiplatform\V1beta1\Featurestore|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Featurestore featurestore = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\Featurestore $var
     * @return $this
     */
    public function setFeaturestore($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\Featurestore::class);
