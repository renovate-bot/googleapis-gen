 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ExportFeatureValuesRequest</code>
 */
class ExportFeatureValuesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.FeatureValueDestination destination = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $destination = null;
    /**
     * Required. Selects Features to export values of.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.FeatureSelector feature_selector = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $feature_selector = null;
    /**
     * Per-Feature export settings.
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.DestinationFeatureSetting settings = 6;</code>
     */
    private $settings;
    protected $mode;
     ...
     *           Format:
     *           `projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}`
     *     @type \Google\Cloud\AIPlatform\V1beta1\FeatureValueDestination $destination
     *           Required. Specifies destination location and format.
     *     @type \Google\Cloud\AIPlatform\V1beta1\FeatureSelector $feature_selector
     *           Required. Selects Features to export values of.
     *     @type \Google\Cloud\AIPlatform\V1beta1\DestinationFeatureSetting[]|\Google\Protobuf\Internal\RepeatedField $settings
     *           Per-Feature export settings.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.FeatureValueDestination destination = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\FeatureValueDestination|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.FeatureValueDestination destination = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\FeatureValueDestination $var
     * @return $this
     */
    public function setDestination($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\FeatureValueDestination::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.FeatureSelector feature_selector = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\FeatureSelector|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.FeatureSelector feature_selector = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\FeatureSelector $var
     * @return $this
     */
    public function setFeatureSelector($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\FeatureSelector::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.DestinationFeatureSetting settings = 6;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\DestinationFeatureSetting[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSettings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\DestinationFeatureSetting::class);
        $this->settings = $arr;
