 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreatePipelineJobRequest</code>
 */
class CreatePipelineJobRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineJob pipeline_job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The resource name of the Location to create the PipelineJob in.
     *           Format: `projects/{project}/locations/{location}`
     *     @type \Google\Cloud\AIPlatform\V1beta1\PipelineJob $pipeline_job
     *           Required. The PipelineJob to create.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineJob pipeline_job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\PipelineJob|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineJob pipeline_job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\PipelineJob $var
     * @return $this
     */
    public function setPipelineJob($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\PipelineJob::class);
