...
namespace Google\Cloud\AIPlatform\V1beta1\NearestNeighborSearchOperationMetadata\RecordError;

use UnexpectedValueException;

/**
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.NearestNeighborSearchOperationMetadata.RecordError.RecordErrorType</code>
 */
...
class_alias(RecordErrorType::class, \Google\Cloud\AIPlatform\V1beta1\NearestNeighborSearchOperationMetadata_RecordError_RecordErrorType::class);
