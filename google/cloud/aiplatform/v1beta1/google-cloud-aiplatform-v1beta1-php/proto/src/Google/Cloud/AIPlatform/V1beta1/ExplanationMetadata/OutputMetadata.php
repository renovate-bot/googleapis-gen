 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ExplanationMetadata.OutputMetadata</code>
 */
...
class_alias(OutputMetadata::class, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata_OutputMetadata::class);
