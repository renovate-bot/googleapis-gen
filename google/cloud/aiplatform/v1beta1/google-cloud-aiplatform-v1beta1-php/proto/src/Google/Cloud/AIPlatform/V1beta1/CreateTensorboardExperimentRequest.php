 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreateTensorboardExperimentRequest</code>
 */
class CreateTensorboardExperimentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TensorboardExperiment tensorboard_experiment = 2;</code>
     */
     ...
     *           in. Format:
     *           `projects/{project}/locations/{location}/tensorboards/{tensorboard}`
     *     @type \Google\Cloud\AIPlatform\V1beta1\TensorboardExperiment $tensorboard_experiment
     *           The TensorboardExperiment to create.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TensorboardExperiment tensorboard_experiment = 2;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\TensorboardExperiment|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TensorboardExperiment tensorboard_experiment = 2;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\TensorboardExperiment $var
     * @return $this
     */
    public function setTensorboardExperiment($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\TensorboardExperiment::class);
