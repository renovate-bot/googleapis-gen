 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.Model</code>
 */
class Model extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Model.ExportFormat supported_export_formats = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Model.DeploymentResourcesType supported_deployment_resources_types = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.DeployedModelRef deployed_models = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           The description of the Model.
     *     @type \Google\Cloud\Aiplatform\V1beta1\PredictSchemata $predict_schemata
     *           The schemata that describe formats of the Model's predictions and
     *           explanations as given and returned via
     *           [PredictionService.Predict][google.cloud.aiplatform.v1beta1.PredictionService.Predict] and [PredictionService.Explain][google.cloud.aiplatform.v1beta1.PredictionService.Explain].
     ...
     *           be found in [metadata_schema][google.cloud.aiplatform.v1beta1.Model.metadata_schema_uri].
     *           Unset if the Model does not have any additional information.
     *     @type \Google\Cloud\Aiplatform\V1beta1\Model\ExportFormat[]|\Google\Protobuf\Internal\RepeatedField $supported_export_formats
     *           Output only. The formats in which this Model may be exported. If empty, this Model is
     *           not available for export.
     ...
     *           Output only. Timestamp when this Model was most recently updated.
     *     @type \Google\Cloud\Aiplatform\V1beta1\DeployedModelRef[]|\Google\Protobuf\Internal\RepeatedField $deployed_models
     *           Output only. The pointers to DeployedModels created from this Model. Note that
     *           Model could have been deployed to Endpoints in different Locations.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PredictSchemata predict_schemata = 4;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\PredictSchemata $var
     * @return $this
     */
    public function setPredictSchemata($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\PredictSchemata::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Model.ExportFormat supported_export_formats = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\Model\ExportFormat[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSupportedExportFormats($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\Model\ExportFormat::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelContainerSpec container_spec = 9 [(.google.api.field_behavior) = INPUT_ONLY];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\ModelContainerSpec $var
     * @return $this
     */
    public function setContainerSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\ModelContainerSpec::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Aiplatform\V1beta1\Model\DeploymentResourcesType::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.DeployedModelRef deployed_models = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\DeployedModelRef[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDeployedModels($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\DeployedModelRef::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\ExplanationSpec::class);
