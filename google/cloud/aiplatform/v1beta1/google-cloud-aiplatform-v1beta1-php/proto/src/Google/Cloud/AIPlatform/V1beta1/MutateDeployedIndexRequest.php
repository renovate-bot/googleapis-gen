 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.MutateDeployedIndexRequest</code>
 */
class MutateDeployedIndexRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DeployedIndex deployed_index = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Format:
     *           `projects/{project}/locations/{location}/indexEndpoints/{index_endpoint}`
     *     @type \Google\Cloud\AIPlatform\V1beta1\DeployedIndex $deployed_index
     *           Required. The DeployedIndex to be updated within the IndexEndpoint.
     *           Currently, the updatable fields are [DeployedIndex][automatic_resources]
     *           and [DeployedIndex][dedicated_resources]
     * }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DeployedIndex deployed_index = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\DeployedIndex|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DeployedIndex deployed_index = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\DeployedIndex $var
     * @return $this
     */
    public function setDeployedIndex($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\DeployedIndex::class);
