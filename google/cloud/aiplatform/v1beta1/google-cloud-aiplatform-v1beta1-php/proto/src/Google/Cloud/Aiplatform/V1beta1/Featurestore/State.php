 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.Featurestore.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Aiplatform\V1beta1\Featurestore_State::class);
