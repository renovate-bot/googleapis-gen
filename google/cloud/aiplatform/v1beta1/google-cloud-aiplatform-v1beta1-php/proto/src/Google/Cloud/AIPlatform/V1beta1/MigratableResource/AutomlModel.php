 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.MigratableResource.AutomlModel</code>
 */
...
class_alias(AutomlModel::class, \Google\Cloud\AIPlatform\V1beta1\MigratableResource_AutomlModel::class);
