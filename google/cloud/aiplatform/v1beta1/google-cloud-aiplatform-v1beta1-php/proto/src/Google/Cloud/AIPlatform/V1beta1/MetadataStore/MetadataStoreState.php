...
namespace Google\Cloud\AIPlatform\V1beta1\MetadataStore;
...
class_alias(MetadataStoreState::class, \Google\Cloud\AIPlatform\V1beta1\MetadataStore_MetadataStoreState::class);
