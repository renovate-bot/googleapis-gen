 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.BatchPredictionJob.OutputConfig</code>
 */
...
class_alias(OutputConfig::class, \Google\Cloud\Aiplatform\V1beta1\BatchPredictionJob_OutputConfig::class);
