 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreateContextRequest</code>
 */
class CreateContextRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Context context = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Format:
     *           `projects/{project}/locations/{location}/metadataStores/{metadatastore}`
     *     @type \Google\Cloud\AIPlatform\V1beta1\Context $context
     *           Required. The Context to create.
