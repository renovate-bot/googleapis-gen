 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.PipelineJob</code>
 */
class PipelineJob extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineState state = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     * Output only. The details of pipeline run. Not available in the list view.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineJobDetail job_detail = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineJob.RuntimeConfig runtime_config = 12;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.EncryptionSpec encryption_spec = 16;</code>
     */
     ...
     *           characters, underscores and dashes. International characters are allowed.
     *           See https://goo.gl/xmQnxf for more information and examples of labels.
     *     @type \Google\Cloud\Aiplatform\V1beta1\PipelineJob\RuntimeConfig $runtime_config
     *           Runtime config of the pipeline.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineJobDetail job_detail = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\Aiplatform\V1beta1\PipelineJobDetail|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineJobDetail job_detail = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\PipelineJobDetail $var
     * @return $this
     */
    public function setJobDetail($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\PipelineJobDetail::class);
        $this->job_detail = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineJob.RuntimeConfig runtime_config = 12;</code>
     * @return \Google\Cloud\Aiplatform\V1beta1\PipelineJob\RuntimeConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineJob.RuntimeConfig runtime_config = 12;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\PipelineJob\RuntimeConfig $var
     * @return $this
     */
    public function setRuntimeConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\PipelineJob\RuntimeConfig::class);
