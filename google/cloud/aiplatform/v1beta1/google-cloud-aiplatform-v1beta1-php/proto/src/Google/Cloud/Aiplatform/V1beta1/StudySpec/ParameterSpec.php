 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec</code>
 */
class ParameterSpec extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ScaleType scale_type = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec conditional_parameter_specs = 10;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\DoubleValueSpec $double_value_spec
     *           The value spec for a 'DOUBLE' parameter.
     *     @type \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\IntegerValueSpec $integer_value_spec
     *           The value spec for an 'INTEGER' parameter.
     *     @type \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\CategoricalValueSpec $categorical_value_spec
     *           The value spec for a 'CATEGORICAL' parameter.
     *     @type \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\DiscreteValueSpec $discrete_value_spec
     ...
     *           How the parameter should be scaled.
     *           Leave unset for `CATEGORICAL` parameters.
     *     @type \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\ConditionalParameterSpec[]|\Google\Protobuf\Internal\RepeatedField $conditional_parameter_specs
     *           A conditional parameter node is active if the parameter's value matches
     *           the conditional node's parent_value_condition.
     *           If two items in conditional_parameter_specs have the same name, they
     *           must have disjoint parent_value_condition.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.DoubleValueSpec double_value_spec = 2;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\DoubleValueSpec $var
     * @return $this
     */
    public function setDoubleValueSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\DoubleValueSpec::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.IntegerValueSpec integer_value_spec = 3;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\IntegerValueSpec $var
     * @return $this
     */
    public function setIntegerValueSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\IntegerValueSpec::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.CategoricalValueSpec categorical_value_spec = 4;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\CategoricalValueSpec $var
     * @return $this
     */
    public function setCategoricalValueSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\CategoricalValueSpec::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.DiscreteValueSpec discrete_value_spec = 5;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\DiscreteValueSpec $var
     * @return $this
     */
    public function setDiscreteValueSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\DiscreteValueSpec::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\ScaleType::class);
        $this->scale_type = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec conditional_parameter_specs = 10;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\ConditionalParameterSpec[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setConditionalParameterSpecs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\StudySpec\ParameterSpec\ConditionalParameterSpec::class);
...
class_alias(ParameterSpec::class, \Google\Cloud\Aiplatform\V1beta1\StudySpec_ParameterSpec::class);
