 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.StudySpec.MeasurementSelectionType</code>
 */
...
class_alias(MeasurementSelectionType::class, \Google\Cloud\AIPlatform\V1beta1\StudySpec_MeasurementSelectionType::class);
