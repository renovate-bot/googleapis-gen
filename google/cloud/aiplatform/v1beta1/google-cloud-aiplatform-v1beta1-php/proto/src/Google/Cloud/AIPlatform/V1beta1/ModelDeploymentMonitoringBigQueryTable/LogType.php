...
namespace Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringBigQueryTable;
 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringBigQueryTable.LogType</code>
 */
class LogType
{
    /**
...
class_alias(LogType::class, \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringBigQueryTable_LogType::class);
