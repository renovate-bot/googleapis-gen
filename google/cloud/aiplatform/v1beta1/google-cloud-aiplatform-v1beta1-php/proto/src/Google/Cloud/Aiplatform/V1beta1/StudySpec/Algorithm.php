 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.StudySpec.Algorithm</code>
 */
class Algorithm
{
    /**
...
class_alias(Algorithm::class, \Google\Cloud\Aiplatform\V1beta1\StudySpec_Algorithm::class);
