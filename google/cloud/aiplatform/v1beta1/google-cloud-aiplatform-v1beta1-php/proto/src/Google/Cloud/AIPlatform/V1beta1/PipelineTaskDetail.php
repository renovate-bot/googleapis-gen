 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.PipelineTaskDetail</code>
 */
class PipelineTaskDetail extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail executor_detail = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $executor_detail = null;
    /**
     * Output only. State of the task.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineTaskDetail.State state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     * Output only. The execution metadata of the task.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Execution execution = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.aiplatform.v1beta1.PipelineTaskDetail.ArtifactList> outputs = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $outputs;
     ...
     *           Output only. Task end time.
     *     @type \Google\Cloud\AIPlatform\V1beta1\PipelineTaskExecutorDetail $executor_detail
     *           Output only. The detailed execution info.
     *     @type int $state
     *           Output only. State of the task.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail executor_detail = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\PipelineTaskExecutorDetail|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail executor_detail = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\PipelineTaskExecutorDetail $var
     * @return $this
     */
    public function setExecutorDetail($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\PipelineTaskExecutorDetail::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\PipelineTaskDetail\ArtifactList::class);
        $this->inputs = $arr;
