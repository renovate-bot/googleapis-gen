 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.SampleConfig</code>
 */
class SampleConfig extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Aiplatform\V1beta1\SampleConfig\SampleStrategy::class);
