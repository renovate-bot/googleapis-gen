 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.WorkerPoolSpec</code>
 */
class WorkerPoolSpec extends \Google\Protobuf\Internal\Message
{
     ...
     * Disk spec.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DiskSpec disk_spec = 5;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Aiplatform\V1beta1\ContainerSpec $container_spec
     ...
     * The custom container task.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ContainerSpec container_spec = 6;</code>
     * @return \Google\Cloud\Aiplatform\V1beta1\ContainerSpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ContainerSpec container_spec = 6;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\ContainerSpec $var
     * @return $this
     */
    public function setContainerSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\ContainerSpec::class);
     ...
     * The Python packaged task.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PythonPackageSpec python_package_spec = 7;</code>
     * @return \Google\Cloud\Aiplatform\V1beta1\PythonPackageSpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PythonPackageSpec python_package_spec = 7;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\PythonPackageSpec $var
     * @return $this
     */
    public function setPythonPackageSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\PythonPackageSpec::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DiskSpec disk_spec = 5;</code>
     * @return \Google\Cloud\Aiplatform\V1beta1\DiskSpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DiskSpec disk_spec = 5;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\DiskSpec $var
     * @return $this
     */
    public function setDiskSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\DiskSpec::class);
        $this->disk_spec = $var;
