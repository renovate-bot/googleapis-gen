 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ScaleType</code>
 */
class ScaleType
{
    /**
...
class_alias(ScaleType::class, \Google\Cloud\AIPlatform\V1beta1\StudySpec_ParameterSpec_ScaleType::class);
