 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ExplainResponse</code>
 */
class ExplainResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * to be explained.
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Explanation explanations = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\AIPlatform\V1beta1\Explanation[]|\Google\Protobuf\Internal\RepeatedField $explanations
     *           The explanations of the Model's [PredictResponse.predictions][google.cloud.aiplatform.v1beta1.PredictResponse.predictions].
     *           It has the same number of elements as [instances][google.cloud.aiplatform.v1beta1.ExplainRequest.instances]
     *           to be explained.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Explanation explanations = 1;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\Explanation[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setExplanations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\Explanation::class);
