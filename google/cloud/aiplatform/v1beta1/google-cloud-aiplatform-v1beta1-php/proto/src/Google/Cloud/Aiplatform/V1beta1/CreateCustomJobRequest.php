 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreateCustomJobRequest</code>
 */
class CreateCustomJobRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CustomJob custom_job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The resource name of the Location to create the CustomJob in.
     *           Format: `projects/{project}/locations/{location}`
     *     @type \Google\Cloud\Aiplatform\V1beta1\CustomJob $custom_job
     *           Required. The CustomJob to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CustomJob custom_job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Aiplatform\V1beta1\CustomJob|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CustomJob custom_job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\CustomJob $var
     * @return $this
     */
    public function setCustomJob($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\CustomJob::class);
        $this->custom_job = $var;
