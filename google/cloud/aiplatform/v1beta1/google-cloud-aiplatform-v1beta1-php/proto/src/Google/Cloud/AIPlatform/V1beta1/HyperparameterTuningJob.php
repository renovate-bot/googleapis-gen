 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.HyperparameterTuningJob</code>
 */
class HyperparameterTuningJob extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.StudySpec study_spec = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * in all the trials.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CustomJobSpec trial_job_spec = 8 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $trial_job_spec = null;
    /**
     * Output only. Trials of the HyperparameterTuningJob.
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Trial trials = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $trials;
    /**
     ...
     *           The name can be up to 128 characters long and can be consist of any UTF-8
     *           characters.
     *     @type \Google\Cloud\AIPlatform\V1beta1\StudySpec $study_spec
     *           Required. Study configuration of the HyperparameterTuningJob.
     ...
     *           If set to 0, Vertex AI decides how many Trials must fail
     *           before the whole job fails.
     *     @type \Google\Cloud\AIPlatform\V1beta1\CustomJobSpec $trial_job_spec
     *           Required. The spec of a trial job. The same spec applies to the CustomJobs created
     *           in all the trials.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.StudySpec study_spec = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\StudySpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.StudySpec study_spec = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\StudySpec $var
     * @return $this
     */
    public function setStudySpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\StudySpec::class);
        $this->study_spec = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CustomJobSpec trial_job_spec = 8 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\CustomJobSpec $var
     * @return $this
     */
    public function setTrialJobSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\CustomJobSpec::class);
