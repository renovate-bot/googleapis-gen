 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.WriteTensorboardExperimentDataRequest</code>
 */
class WriteTensorboardExperimentDataRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.WriteTensorboardRunDataRequest write_run_data_requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Format:
     *           `projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}`
     *     @type \Google\Cloud\AIPlatform\V1beta1\WriteTensorboardRunDataRequest[]|\Google\Protobuf\Internal\RepeatedField $write_run_data_requests
     *           Required. Requests containing per-run TensorboardTimeSeries data to write.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.WriteTensorboardRunDataRequest write_run_data_requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\WriteTensorboardRunDataRequest[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setWriteRunDataRequests($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\WriteTensorboardRunDataRequest::class);
