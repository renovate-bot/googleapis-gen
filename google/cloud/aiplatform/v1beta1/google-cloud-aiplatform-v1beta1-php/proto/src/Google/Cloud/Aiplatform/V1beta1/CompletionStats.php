 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CompletionStats</code>
 */
class CompletionStats extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Aiplatform\V1Beta1\CompletionStats::initOnce();
