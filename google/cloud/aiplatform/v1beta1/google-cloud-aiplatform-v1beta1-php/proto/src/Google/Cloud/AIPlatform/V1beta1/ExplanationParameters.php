 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ExplanationParameters</code>
 */
class ExplanationParameters extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\AIPlatform\V1beta1\SampledShapleyAttribution $sampled_shapley_attribution
     *           An attribution method that approximates Shapley values for features that
     *           contribute to the label being predicted. A sampling strategy is used to
     *           approximate the value rather than considering all subsets of features.
     *           Refer to this paper for model details: https://arxiv.org/abs/1306.4265.
     *     @type \Google\Cloud\AIPlatform\V1beta1\IntegratedGradientsAttribution $integrated_gradients_attribution
     *           An attribution method that computes Aumann-Shapley values taking
     *           advantage of the model's fully differentiable structure. Refer to this
     *           paper for more details: https://arxiv.org/abs/1703.01365
     *     @type \Google\Cloud\AIPlatform\V1beta1\XraiAttribution $xrai_attribution
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SampledShapleyAttribution sampled_shapley_attribution = 1;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\SampledShapleyAttribution $var
     * @return $this
     */
    public function setSampledShapleyAttribution($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\SampledShapleyAttribution::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.IntegratedGradientsAttribution integrated_gradients_attribution = 2;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\IntegratedGradientsAttribution $var
     * @return $this
     */
    public function setIntegratedGradientsAttribution($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\IntegratedGradientsAttribution::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.XraiAttribution xrai_attribution = 3;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\XraiAttribution $var
     * @return $this
     */
