 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ExplanationMetadataOverride</code>
 */
class ExplanationMetadataOverride extends \Google\Protobuf\Internal\Message
{
     ...
     * overridden.
     *
     * Generated from protobuf field <code>map<string, .google.cloud.aiplatform.v1beta1.ExplanationMetadataOverride.InputMetadataOverride> inputs = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $inputs;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\ExplanationMetadataOverride\InputMetadataOverride::class);
        $this->inputs = $arr;
