 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.Polarity</code>
 */
class Polarity
{
    /**
...
class_alias(Polarity::class, \Google\Cloud\Aiplatform\V1beta1\ExplanationMetadata_InputMetadata_Visualization_Polarity::class);
