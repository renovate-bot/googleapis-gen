...
class TensorboardServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Cloud\AIPlatform\V1beta1\BatchReadTensorboardTimeSeriesDataRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function BatchReadTensorboardTimeSeriesData(\Google\Cloud\AIPlatform\V1beta1\BatchReadTensorboardTimeSeriesDataRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.aiplatform.v1beta1.TensorboardService/BatchReadTensorboardTimeSeriesData',
        $argument,
        ['\Google\Cloud\AIPlatform\V1beta1\BatchReadTensorboardTimeSeriesDataResponse', 'decode'],
        $metadata, $options);
    }
