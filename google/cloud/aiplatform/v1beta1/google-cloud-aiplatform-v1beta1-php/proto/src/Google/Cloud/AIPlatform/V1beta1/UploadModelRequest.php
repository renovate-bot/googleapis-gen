 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.UploadModelRequest</code>
 */
class UploadModelRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Model model = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The resource name of the Location into which to upload the Model.
     *           Format: `projects/{project}/locations/{location}`
     *     @type \Google\Cloud\AIPlatform\V1beta1\Model $model
     *           Required. The Model to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Model model = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\Model $var
     * @return $this
     */
    public function setModel($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\Model::class);
        $this->model = $var;
