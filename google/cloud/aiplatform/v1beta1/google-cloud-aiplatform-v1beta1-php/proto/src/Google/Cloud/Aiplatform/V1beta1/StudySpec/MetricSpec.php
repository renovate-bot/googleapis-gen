 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.StudySpec.MetricSpec</code>
 */
class MetricSpec extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.StudySpec.MetricSpec.GoalType goal = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $goal = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Aiplatform\V1beta1\StudySpec\MetricSpec\GoalType::class);
        $this->goal = $var;
...
class_alias(MetricSpec::class, \Google\Cloud\Aiplatform\V1beta1\StudySpec_MetricSpec::class);
