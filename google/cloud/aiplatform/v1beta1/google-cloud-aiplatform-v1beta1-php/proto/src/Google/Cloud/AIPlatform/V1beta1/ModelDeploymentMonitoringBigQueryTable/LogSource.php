 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringBigQueryTable.LogSource</code>
 */
class LogSource
{
    /**
...
class_alias(LogSource::class, \Google\Cloud\AIPlatform\V1beta1\ModelDeploymentMonitoringBigQueryTable_LogSource::class);
