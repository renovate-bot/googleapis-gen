 ...
 * a lineage graph.
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.Event</code>
 */
class Event extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Event.Type type = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\Event\Type::class);
        $this->type = $var;
