 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.DeployedIndex</code>
 */
class DeployedIndex extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.IndexPrivateEndpoints private_endpoints = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.AutomaticResources automatic_resources = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DeployedIndexAuthConfig deployed_index_auth_config = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Output only. Timestamp when the DeployedIndex was created.
     *     @type \Google\Cloud\AIPlatform\V1beta1\IndexPrivateEndpoints $private_endpoints
     *           Output only. Provides paths for users to send requests directly to the deployed index
     *           services running on Cloud via private services access. This field is
     *           populated if [network][google.cloud.aiplatform.v1beta1.IndexEndpoint.network] is configured.
     ...
     *           index receives a high queries per second rate (QPS).
     *           Estimate your costs before enabling this option.
     *     @type \Google\Cloud\AIPlatform\V1beta1\DeployedIndexAuthConfig $deployed_index_auth_config
     *           Optional. If set, the authentication is enabled for the private endpoint.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.IndexPrivateEndpoints private_endpoints = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\IndexPrivateEndpoints|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.IndexPrivateEndpoints private_endpoints = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\IndexPrivateEndpoints $var
     * @return $this
     */
    public function setPrivateEndpoints($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\IndexPrivateEndpoints::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\AutomaticResources::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DeployedIndexAuthConfig deployed_index_auth_config = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\DeployedIndexAuthConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DeployedIndexAuthConfig deployed_index_auth_config = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\DeployedIndexAuthConfig $var
     * @return $this
     */
    public function setDeployedIndexAuthConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\DeployedIndexAuthConfig::class);
