 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ModelEvaluationSlice</code>
 */
class ModelEvaluationSlice extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.Slice slice = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *     @type string $name
     *           Output only. The resource name of the ModelEvaluationSlice.
     *     @type \Google\Cloud\Aiplatform\V1beta1\ModelEvaluationSlice\Slice $slice
     *           Output only. The slice of the test data that is used to evaluate the Model.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.Slice slice = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\Aiplatform\V1beta1\ModelEvaluationSlice\Slice|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.Slice slice = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\ModelEvaluationSlice\Slice $var
     * @return $this
     */
    public function setSlice($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\ModelEvaluationSlice\Slice::class);
        $this->slice = $var;
