...
namespace Google\Cloud\AIPlatform\V1beta1\Execution;
 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.Execution.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\AIPlatform\V1beta1\Execution_State::class);
