...
class Featurestore extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Featurestore.OnlineServingConfig online_serving_config = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $online_serving_config = null;
    /**
     * Output only. State of the featurestore.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Featurestore.State state = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.EncryptionSpec encryption_spec = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           System reserved label keys are prefixed with "aiplatform.googleapis.com/"
     *           and are immutable.
     *     @type \Google\Cloud\AIPlatform\V1beta1\Featurestore\OnlineServingConfig $online_serving_config
     *           Required. Config for online serving resources.
     *     @type int $state
     *           Output only. State of the featurestore.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Featurestore.OnlineServingConfig online_serving_config = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\Featurestore\OnlineServingConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.Featurestore.OnlineServingConfig online_serving_config = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\Featurestore\OnlineServingConfig $var
     * @return $this
     */
    public function setOnlineServingConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\Featurestore\OnlineServingConfig::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\Featurestore\State::class);
        $this->state = $var;
