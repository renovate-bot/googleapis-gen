 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreateBatchPredictionJobRequest</code>
 */
class CreateBatchPredictionJobRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The resource name of the Location to create the BatchPredictionJob in.
     *           Format: `projects/{project}/locations/{location}`
     *     @type \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob $batch_prediction_job
     *           Required. The BatchPredictionJob to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BatchPredictionJob batch_prediction_job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob $var
     * @return $this
     */
    public function setBatchPredictionJob($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\BatchPredictionJob::class);
