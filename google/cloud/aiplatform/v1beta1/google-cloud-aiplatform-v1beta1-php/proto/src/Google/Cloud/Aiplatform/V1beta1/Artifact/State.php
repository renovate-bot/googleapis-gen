...
namespace Google\Cloud\Aiplatform\V1beta1\Artifact;
 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.Artifact.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Aiplatform\V1beta1\Artifact_State::class);
