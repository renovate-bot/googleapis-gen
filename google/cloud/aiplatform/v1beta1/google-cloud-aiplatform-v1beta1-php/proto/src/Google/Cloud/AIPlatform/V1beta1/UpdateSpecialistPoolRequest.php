 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.UpdateSpecialistPoolRequest</code>
 */
class UpdateSpecialistPoolRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SpecialistPool specialist_pool = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\AIPlatform\V1beta1\SpecialistPool $specialist_pool
     *           Required. The SpecialistPool which replaces the resource on the server.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SpecialistPool specialist_pool = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\SpecialistPool|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.SpecialistPool specialist_pool = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\SpecialistPool $var
     * @return $this
     */
    public function setSpecialistPool($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\SpecialistPool::class);
