 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.FeatureValueDestination</code>
 */
class FeatureValueDestination extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Google\Cloud\AIPlatform\V1beta1\TFRecordDestination $tfrecord_destination
     ...
     *     @type \Google\Cloud\AIPlatform\V1beta1\CsvDestination $csv_destination
     ...
     * [FeatureValueDestination.bigquery_destination][google.cloud.aiplatform.v1beta1.FeatureValueDestination.bigquery_destination] must refer to a table.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BigQueryDestination bigquery_destination = 1;</code>
     ...
     *     BOOL, BOOL_ARRAY (true, false)             | BYTES_LIST
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TFRecordDestination tfrecord_destination = 2;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\TFRecordDestination|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TFRecordDestination tfrecord_destination = 2;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\TFRecordDestination $var
     * @return $this
     */
    public function setTfrecordDestination($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\TFRecordDestination::class);
     ...
     * format.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CsvDestination csv_destination = 3;</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\CsvDestination|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.CsvDestination csv_destination = 3;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\CsvDestination $var
     * @return $this
     */
    public function setCsvDestination($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\CsvDestination::class);
