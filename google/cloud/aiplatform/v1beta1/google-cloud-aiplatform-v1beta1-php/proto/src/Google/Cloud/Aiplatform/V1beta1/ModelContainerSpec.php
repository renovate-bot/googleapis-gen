...
class ModelContainerSpec extends \Google\Protobuf\Internal\Message
{
     ...
     * [v1 core API](https://tinyurl.com/k8s-io-api/v1.18/#container-v1-core).
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.EnvVar env = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    private $env;
    /**
     ...
     * [v1 core API](https://tinyurl.com/k8s-io-api/v1.18/#container-v1-core).
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Port ports = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    private $ports;
    /**
     ...
     *           This field corresponds to the `args` field of the Kubernetes Containers
     *           [v1 core API](https://tinyurl.com/k8s-io-api/v1.18/#container-v1-core).
     *     @type \Google\Cloud\Aiplatform\V1beta1\EnvVar[]|\Google\Protobuf\Internal\RepeatedField $env
     *           Immutable. List of environment variables to set in the container. After the container
     *           starts running, code running in the container can read these environment
     *           variables.
     *           Additionally, the [command][google.cloud.aiplatform.v1beta1.ModelContainerSpec.command] and
     ...
     *           This field corresponds to the `env` field of the Kubernetes Containers
     *           [v1 core API](https://tinyurl.com/k8s-io-api/v1.18/#container-v1-core).
     *     @type \Google\Cloud\Aiplatform\V1beta1\Port[]|\Google\Protobuf\Internal\RepeatedField $ports
     *           Immutable. List of ports to expose from the container. AI Platform sends any
     *           prediction requests that it receives to the first port on this list. AI
     *           Platform also sends
     *           [liveness and health checks](https://tinyurl.com/cust-cont-reqs#health)
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.EnvVar env = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\EnvVar[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEnv($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\EnvVar::class);
        $this->env = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.Port ports = 5 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\Port[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPorts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Aiplatform\V1beta1\Port::class);
        $this->ports = $arr;
