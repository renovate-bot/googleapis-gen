 ...
 *
 * Protobuf type <code>google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.ColorMap</code>
 */
class ColorMap
{
    /**
...
class_alias(ColorMap::class, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata_InputMetadata_Visualization_ColorMap::class);
