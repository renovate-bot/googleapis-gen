 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.DoubleValueSpec</code>
 */
...
class_alias(DoubleValueSpec::class, \Google\Cloud\AIPlatform\V1beta1\StudySpec_ParameterSpec_DoubleValueSpec::class);
