...
namespace Google\Cloud\AIPlatform\V1beta1\ModelMonitoringObjectiveConfig\ExplanationConfig;
 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ModelMonitoringObjectiveConfig.ExplanationConfig.ExplanationBaseline</code>
 */
class ExplanationBaseline extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ModelMonitoringObjectiveConfig.ExplanationConfig.ExplanationBaseline.PredictionFormat prediction_format = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\AIPlatform\V1beta1\GcsDestination $gcs
     *           Cloud Storage location for BatchExplain output.
     *     @type \Google\Cloud\AIPlatform\V1beta1\BigQueryDestination $bigquery
     ...
     * Cloud Storage location for BatchExplain output.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.GcsDestination gcs = 2;</code>
     ...
     * BigQuery location for BatchExplain output.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.BigQueryDestination bigquery = 3;</code>
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringObjectiveConfig\ExplanationConfig\ExplanationBaseline\PredictionFormat::class);
...
class_alias(ExplanationBaseline::class, \Google\Cloud\AIPlatform\V1beta1\ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline::class);
