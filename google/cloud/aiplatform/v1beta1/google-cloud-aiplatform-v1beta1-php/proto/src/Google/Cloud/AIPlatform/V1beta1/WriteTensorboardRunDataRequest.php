 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.WriteTensorboardRunDataRequest</code>
 */
class WriteTensorboardRunDataRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.TimeSeriesData time_series_data = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Format:
     *           `projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}`
     *     @type \Google\Cloud\AIPlatform\V1beta1\TimeSeriesData[]|\Google\Protobuf\Internal\RepeatedField $time_series_data
     *           Required. The TensorboardTimeSeries data to write.
     *           Values with in a time series are indexed by their step value.
     *           Repeated writes to the same step will overwrite the existing value for that
     *           step.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.TimeSeriesData time_series_data = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\TimeSeriesData[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTimeSeriesData($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\TimeSeriesData::class);
