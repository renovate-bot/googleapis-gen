 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.DataLabelingJob</code>
 */
class DataLabelingJob extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.JobState state = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *           The SpecialistPools' resource names associated with this job.
     *     @type \Google\Cloud\Aiplatform\V1beta1\ActiveLearningConfig $active_learning_config
     *           Paramaters that configure active learning pipeline. Active learning will
     *           label the data incrementally via several iterations. For every iteration,
     *           it will select a batch of data based on the sampling strategy.
     * }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ActiveLearningConfig active_learning_config = 21;</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\ActiveLearningConfig $var
     * @return $this
     */
    public function setActiveLearningConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\ActiveLearningConfig::class);
