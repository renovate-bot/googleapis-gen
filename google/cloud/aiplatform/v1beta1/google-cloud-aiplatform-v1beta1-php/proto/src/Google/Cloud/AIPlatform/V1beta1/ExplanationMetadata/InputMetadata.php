...
namespace Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata;
...
class InputMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     * IDENTITY.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Encoding encoding = 3;</code>
     */
     ...
     *           Modality of the feature. Valid values are: numeric, image. Defaults to
     *           numeric.
     *     @type \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\FeatureValueDomain $feature_value_domain
     *           The domain details of the input feature value. Like min/max, original
     *           mean or standard deviation if normalized.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\Encoding::class);
        $this->encoding = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.FeatureValueDomain feature_value_domain = 5;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\FeatureValueDomain $var
     * @return $this
     */
    public function setFeatureValueDomain($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\FeatureValueDomain::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization visualization = 11;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\Visualization $var
     * @return $this
     */
    public function setVisualization($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\Visualization::class);
...
class_alias(InputMetadata::class, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata_InputMetadata::class);
