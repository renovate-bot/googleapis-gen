...
namespace Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata;
 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization</code>
 */
class Visualization extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.Type type = 1;</code>
     */
    protected $type = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.Polarity polarity = 2;</code>
     */
     ...
     * influential in blue.
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.ColorMap color_map = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.ExplanationMetadata.InputMetadata.Visualization.OverlayType overlay_type = 6;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Aiplatform\V1Beta1\ExplanationMetadata::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\Visualization\Type::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\Visualization\Polarity::class);
        $this->polarity = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\Visualization\ColorMap::class);
        $this->color_map = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata\InputMetadata\Visualization\OverlayType::class);
...
class_alias(Visualization::class, \Google\Cloud\AIPlatform\V1beta1\ExplanationMetadata_InputMetadata_Visualization::class);
