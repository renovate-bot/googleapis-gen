 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.DeployedModelRef</code>
 */
class DeployedModelRef extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Aiplatform\V1Beta1\DeployedModelRef::initOnce();
