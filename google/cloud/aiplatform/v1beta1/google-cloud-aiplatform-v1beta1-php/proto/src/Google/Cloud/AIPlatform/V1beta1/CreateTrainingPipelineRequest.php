 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreateTrainingPipelineRequest</code>
 */
class CreateTrainingPipelineRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TrainingPipeline training_pipeline = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The resource name of the Location to create the TrainingPipeline in.
     *           Format: `projects/{project}/locations/{location}`
     *     @type \Google\Cloud\AIPlatform\V1beta1\TrainingPipeline $training_pipeline
     *           Required. The TrainingPipeline to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TrainingPipeline training_pipeline = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\TrainingPipeline|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.TrainingPipeline training_pipeline = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\TrainingPipeline $var
     * @return $this
     */
    public function setTrainingPipeline($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\TrainingPipeline::class);
