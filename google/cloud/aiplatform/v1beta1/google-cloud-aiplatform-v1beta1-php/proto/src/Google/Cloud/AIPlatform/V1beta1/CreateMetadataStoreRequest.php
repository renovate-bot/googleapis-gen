 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreateMetadataStoreRequest</code>
 */
class CreateMetadataStoreRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.MetadataStore metadata_store = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           be created.
     *           Format: `projects/{project}/locations/{location}/`
     *     @type \Google\Cloud\AIPlatform\V1beta1\MetadataStore $metadata_store
     *           Required. The MetadataStore to create.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.MetadataStore metadata_store = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\MetadataStore|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.MetadataStore metadata_store = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\MetadataStore $var
     * @return $this
     */
    public function setMetadataStore($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\MetadataStore::class);
