 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CreateDataLabelingJobRequest</code>
 */
class CreateDataLabelingJobRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The parent of the DataLabelingJob.
     *           Format: `projects/{project}/locations/{location}`
     *     @type \Google\Cloud\Aiplatform\V1beta1\DataLabelingJob $data_labeling_job
     *           Required. The DataLabelingJob to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.DataLabelingJob data_labeling_job = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Aiplatform\V1beta1\DataLabelingJob $var
     * @return $this
     */
    public function setDataLabelingJob($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Aiplatform\V1beta1\DataLabelingJob::class);
