...
namespace Google\Cloud\AIPlatform\V1beta1\ReadFeatureValuesResponse;
 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse.Header</code>
 */
class Header extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse.FeatureDescriptor feature_descriptors = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse.FeatureDescriptor feature_descriptors = 2;</code>
     * @param \Google\Cloud\AIPlatform\V1beta1\ReadFeatureValuesResponse\FeatureDescriptor[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFeatureDescriptors($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AIPlatform\V1beta1\ReadFeatureValuesResponse\FeatureDescriptor::class);
...
class_alias(Header::class, \Google\Cloud\AIPlatform\V1beta1\ReadFeatureValuesResponse_Header::class);
