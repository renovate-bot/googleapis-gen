 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.PipelineTaskDetail.PipelineTaskStatus</code>
 */
class PipelineTaskStatus extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.PipelineTaskDetail.State state = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AIPlatform\V1beta1\PipelineTaskDetail\State::class);
        $this->state = $var;
...
class_alias(PipelineTaskStatus::class, \Google\Cloud\AIPlatform\V1beta1\PipelineTaskDetail_PipelineTaskStatus::class);
