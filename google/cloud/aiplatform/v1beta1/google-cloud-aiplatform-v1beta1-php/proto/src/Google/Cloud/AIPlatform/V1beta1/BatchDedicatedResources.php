 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.BatchDedicatedResources</code>
 */
class BatchDedicatedResources extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.MachineSpec machine_spec = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Cloud\AIPlatform\V1beta1\MachineSpec|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AIPlatform\V1beta1\MachineSpec::class);
