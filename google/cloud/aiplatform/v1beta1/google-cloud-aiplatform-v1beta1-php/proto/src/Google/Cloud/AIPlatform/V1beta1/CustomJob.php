 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1beta1.CustomJob</code>
 */
class CustomJob extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.aiplatform.v1beta1.JobState state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *           The name can be up to 128 characters long and can be consist of any UTF-8
     *           characters.
     *     @type \Google\Cloud\AIPlatform\V1beta1\CustomJobSpec $job_spec
     *           Required. Job spec.
     *     @type int $state
     *           Output only. The detailed state of the job.
