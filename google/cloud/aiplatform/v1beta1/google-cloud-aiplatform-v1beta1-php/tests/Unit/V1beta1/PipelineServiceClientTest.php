...
use Google\Cloud\Aiplatform\V1beta1\PipelineServiceClient;
...
class PipelineServiceClientTest extends GeneratedTest
{
    ...
    public function cancelPipelineJobTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1beta1.PipelineService/CancelPipelineJob', $actualFuncCall);
    ...
    public function cancelTrainingPipelineTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.PipelineService/CancelTrainingPipeline', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function createPipelineJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.PipelineService/CreatePipelineJob', $actualFuncCall);
    ...
    public function createTrainingPipelineTest()
    {
        ...
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        $trainingTaskDefinition = 'trainingTaskDefinition-1916695832';
        $expectedResponse = new TrainingPipeline();
        $expectedResponse->setName($name);
        $expectedResponse->setDisplayName($displayName);
        $expectedResponse->setTrainingTaskDefinition($trainingTaskDefinition);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $client->locationName('[PROJECT]', '[LOCATION]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.PipelineService/CreateTrainingPipeline', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function deletePipelineJobTest()
    {
        ...
        $incompleteOperation->setName('operations/deletePipelineJobTest');
        ...
        $completeOperation->setName('operations/deletePipelineJobTest');
        ...
        $this->assertSame('/google.cloud.aiplatform.v1beta1.PipelineService/DeletePipelineJob', $actualApiFuncCall);
    ...
    public function deleteTrainingPipelineTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteTrainingPipelineTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new GPBEmpty();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteTrainingPipelineTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.PipelineService/DeleteTrainingPipeline', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getPipelineJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.PipelineService/GetPipelineJob', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getTrainingPipelineTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.PipelineService/GetTrainingPipeline', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listPipelineJobsTest()
    {
        ...
        $this->assertEquals($expectedResponse->getPipelineJobs()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.PipelineService/ListPipelineJobs', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listTrainingPipelinesTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getTrainingPipelines()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.PipelineService/ListTrainingPipelines', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
