...
use Google\Cloud\Aiplatform\V1beta1\IndexServiceClient;
...
class IndexServiceClientTest extends GeneratedTest
{
    ...
    public function createIndexTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexService/CreateIndex', $actualApiFuncCall);
    ...
    public function deleteIndexTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexService/DeleteIndex', $actualApiFuncCall);
    ...
    public function getIndexTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexService/GetIndex', $actualFuncCall);
    ...
    public function listIndexesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexService/ListIndexes', $actualFuncCall);
    ...
    public function updateIndexTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexService/UpdateIndex', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getIndex();
        $this->assertProtobufEquals($index, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
