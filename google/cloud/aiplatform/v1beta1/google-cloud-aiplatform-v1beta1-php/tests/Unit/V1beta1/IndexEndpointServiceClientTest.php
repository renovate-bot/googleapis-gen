...
use Google\Cloud\Aiplatform\V1beta1\DeployIndexResponse;
...
class IndexEndpointServiceClientTest extends GeneratedTest
{
    ...
    public function createIndexEndpointTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexEndpointService/CreateIndexEndpoint', $actualApiFuncCall);
    ...
    public function deleteIndexEndpointTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexEndpointService/DeleteIndexEndpoint', $actualApiFuncCall);
    ...
    public function deployIndexTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexEndpointService/DeployIndex', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getIndexEndpoint();
    ...
    public function getIndexEndpointTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexEndpointService/GetIndexEndpoint', $actualFuncCall);
    ...
    public function listIndexEndpointsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexEndpointService/ListIndexEndpoints', $actualFuncCall);
    ...
    public function undeployIndexTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexEndpointService/UndeployIndex', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getIndexEndpoint();
        $this->assertProtobufEquals($formattedIndexEndpoint, $actualValue);
    ...
    public function updateIndexEndpointTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.IndexEndpointService/UpdateIndexEndpoint', $actualFuncCall);
