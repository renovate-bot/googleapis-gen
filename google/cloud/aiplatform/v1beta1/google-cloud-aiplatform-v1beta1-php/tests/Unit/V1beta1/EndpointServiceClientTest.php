...
class EndpointServiceClientTest extends GeneratedTest
{
    ...
    public function createEndpointTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1beta1.EndpointService/CreateEndpoint', $actualApiFuncCall);
    ...
    public function deleteEndpointTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.EndpointService/DeleteEndpoint', $actualApiFuncCall);
    ...
    public function deployModelTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.EndpointService/DeployModel', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getEndpoint();
    ...
    public function getEndpointTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1beta1.EndpointService/GetEndpoint', $actualFuncCall);
    ...
    public function listEndpointsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.EndpointService/ListEndpoints', $actualFuncCall);
    ...
    public function undeployModelTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.EndpointService/UndeployModel', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getEndpoint();
        $this->assertProtobufEquals($formattedEndpoint, $actualValue);
    ...
    public function updateEndpointTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.EndpointService/UpdateEndpoint', $actualFuncCall);
