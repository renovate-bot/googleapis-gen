...
use Google\Cloud\Aiplatform\V1beta1\SpecialistPoolServiceClient;
...
class SpecialistPoolServiceClientTest extends GeneratedTest
{
    ...
    public function createSpecialistPoolTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1beta1.SpecialistPoolService/CreateSpecialistPool', $actualApiFuncCall);
    ...
    public function deleteSpecialistPoolTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.SpecialistPoolService/DeleteSpecialistPool', $actualApiFuncCall);
    ...
    public function getSpecialistPoolTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1beta1.SpecialistPoolService/GetSpecialistPool', $actualFuncCall);
    ...
    public function listSpecialistPoolsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.SpecialistPoolService/ListSpecialistPools', $actualFuncCall);
    ...
    public function updateSpecialistPoolTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1beta1.SpecialistPoolService/UpdateSpecialistPool', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getSpecialistPool();
        $this->assertProtobufEquals($specialistPool, $actualValue);
