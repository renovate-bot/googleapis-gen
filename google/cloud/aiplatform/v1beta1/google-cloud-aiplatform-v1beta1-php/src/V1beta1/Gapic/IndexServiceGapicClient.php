 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/aiplatform/v1beta1/index_service.proto
...
class IndexServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.aiplatform.v1beta1.IndexService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/index_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/index_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/index_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/index_service_rest_client_config.php',
                ],
            ],
        ];
    }
