...
class FeaturestoreServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.aiplatform.v1beta1.FeaturestoreService';
    ...
    private static function getFeaturestoreNameTemplate()
    {
        if (self::$featurestoreNameTemplate == null) {
            self::$featurestoreNameTemplate = new PathTemplate('projects/{project}/locations/{location}/featurestores/{featurestore}');
        }
     ...
     * @experimental
     */
    public function batchCreateFeatures($parent, $requests, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('BatchCreateFeatures', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function batchReadFeatureValues($featurestore, $destination, $entityTypeSpecs, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('BatchReadFeatureValues', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function createEntityType($parent, $entityTypeId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateEntityType', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function createFeaturestore($parent, $featurestore, $featurestoreId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateFeaturestore', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteEntityType($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteEntityType', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteFeaturestore($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteFeaturestore', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function exportFeatureValues($entityType, $destination, $featureSelector, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('ExportFeatureValues', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getFeaturestore($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetFeaturestore', Featurestore::class, $optionalArgs, $request)->wait();
    }
     ...
     * @experimental
     */
    public function importFeatureValues($entityType, $featureSpecs, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['disableOnlineServing'])) {
            $request->setDisableOnlineServing($optionalArgs['disableOnlineServing']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('ImportFeatureValues', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function listFeaturestores($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListFeaturestores', $optionalArgs, ListFeaturestoresResponse::class, $request);
    }
    ...
    public function searchFeatures($location, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('SearchFeatures', $optionalArgs, SearchFeaturesResponse::class, $request);
    }
    ...
    public function updateFeature($feature, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateFeature', Feature::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updateFeaturestore($featurestore, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateFeaturestore', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
