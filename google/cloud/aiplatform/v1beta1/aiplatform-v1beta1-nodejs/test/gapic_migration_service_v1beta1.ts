...
describe('v1beta1.MigrationServiceClient', () => {
    ...
    describe('batchMigrateResources', () => {
        it('invokes batchMigrateResources without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.BatchMigrateResourcesRequest());
            request.parent = '';
            ...
            assert((client.innerApiCalls.batchMigrateResources as SinonStub)
    ...
    describe('searchMigratableResources', () => {
        it('invokes searchMigratableResources without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.SearchMigratableResourcesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchMigratableResources as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
