...
describe('v1beta1.ModelServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = modelserviceModule.v1beta1.ModelServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = modelserviceModule.v1beta1.ModelServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = modelserviceModule.v1beta1.ModelServiceClient.port;
        assert(port);
    ...
    describe('getModel', () => {
        it('invokes getModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.GetModelRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Model());
        ...
        it('invokes getModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getModel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateModel', () => {
        it('invokes updateModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.UpdateModelRequest());
            request.model = {};
            request.model.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getModelEvaluation', () => {
        it('invokes getModelEvaluation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.GetModelEvaluationRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelEvaluation());
            client.innerApiCalls.getModelEvaluation = stubSimpleCall(expectedResponse);
            const [response] = await client.getModelEvaluation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getModelEvaluation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getModelEvaluation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getModelEvaluation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IModelEvaluation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getModelEvaluationSlice', () => {
        it('invokes getModelEvaluationSlice without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.GetModelEvaluationSliceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice());
            client.innerApiCalls.getModelEvaluationSlice = stubSimpleCall(expectedResponse);
            const [response] = await client.getModelEvaluationSlice(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getModelEvaluationSlice as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getModelEvaluationSlice without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice());
            client.innerApiCalls.getModelEvaluationSlice = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getModelEvaluationSlice(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IModelEvaluationSlice|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getModelEvaluationSlice with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.getModelEvaluationSlice = stubSimpleCall(undefined, expectedError);
    ...
    describe('uploadModel', () => {
        it('invokes uploadModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.UploadModelRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.uploadModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes uploadModel without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.uploadModel = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.uploadModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IUploadModelResponse, protos.google.cloud.aiplatform.v1beta1.IUploadModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IUploadModelResponse, protos.google.cloud.aiplatform.v1beta1.IUploadModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.uploadModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes uploadModel with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.uploadModel = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes uploadModel with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.uploadModel = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.uploadModel(request);
        ...
        it('invokes checkUploadModelProgress without error', async () => {
            ...
            const decodedOperation = await client.checkUploadModelProgress(expectedResponse.name);
    ...
    describe('deleteModel', () => {
        it('invokes deleteModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.DeleteModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('exportModel', () => {
        it('invokes exportModel without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.exportModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes exportModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IExportModelResponse, protos.google.cloud.aiplatform.v1beta1.IExportModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IExportModelResponse, protos.google.cloud.aiplatform.v1beta1.IExportModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.exportModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ListModelsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Model()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Model()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Model()),
            ];
        ...
        it('invokes listModelsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.Model[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.Model) => {
        ...
        it('uses async iteration with listModels without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.IModel[] = [];
    ...
    describe('listModelEvaluations', () => {
        it('invokes listModelEvaluations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ListModelEvaluationsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelEvaluation()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelEvaluation()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelEvaluation()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listModelEvaluations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listModelEvaluationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ModelEvaluation[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelEvaluation) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listModelEvaluations without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.IModelEvaluation[] = [];
    ...
    describe('listModelEvaluationSlices', () => {
        it('invokes listModelEvaluationSlices without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ListModelEvaluationSlicesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice()),
            ];
            client.innerApiCalls.listModelEvaluationSlices = stubSimpleCall(expectedResponse);
            const [response] = await client.listModelEvaluationSlices(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listModelEvaluationSlices as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listModelEvaluationSlices without error using callback', async () => {
            ...
            client.innerApiCalls.listModelEvaluationSlices = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listModelEvaluationSlices with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listModelEvaluationSlices = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listModelEvaluationSlices(request), expectedError);
            assert((client.innerApiCalls.listModelEvaluationSlices as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listModelEvaluationSlicesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listModelEvaluationSlices.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listModelEvaluationSlices, request));
            assert.strictEqual(
                (client.descriptors.page.listModelEvaluationSlices.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });
        ...
        it('invokes listModelEvaluationSlicesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.listModelEvaluationSlices.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listModelEvaluationSlicesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice) => {
        ...
        it('uses async iteration with listModelEvaluationSlices without error', async () => {
            ...
            client.descriptors.page.listModelEvaluationSlices.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1beta1.IModelEvaluationSlice[] = [];
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listModelEvaluationSlices.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert.strictEqual(
                (client.descriptors.page.listModelEvaluationSlices.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
        ...
        it('uses async iteration with listModelEvaluationSlices with error', async () => {
            ...
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";const expectedError = new Error('expected');
            client.descriptors.page.listModelEvaluationSlices.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listModelEvaluationSlicesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1beta1.IModelEvaluationSlice[] = [];
                for await (const resource of iterable) {
