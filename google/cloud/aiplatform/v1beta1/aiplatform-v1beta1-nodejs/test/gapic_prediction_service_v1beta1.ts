...
describe('v1beta1.PredictionServiceClient', () => {
    ...
    describe('predict', () => {
        it('invokes predict without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.PredictRequest());
            request.endpoint = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.PredictResponse());
    ...
    describe('explain', () => {
        it('invokes explain without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ExplainRequest());
            request.endpoint = '';
            const expectedHeaderRequestParams = "endpoint=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.explain as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
