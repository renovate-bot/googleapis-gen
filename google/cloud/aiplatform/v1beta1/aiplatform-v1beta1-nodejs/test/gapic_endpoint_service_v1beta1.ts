...
describe('v1beta1.EndpointServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = endpointserviceModule.v1beta1.EndpointServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = endpointserviceModule.v1beta1.EndpointServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = endpointserviceModule.v1beta1.EndpointServiceClient.port;
        assert(port);
    ...
    describe('getEndpoint', () => {
        it('invokes getEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.GetEndpointRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Endpoint());
        ...
        it('invokes getEndpoint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEndpoint(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IEndpoint|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateEndpoint', () => {
        it('invokes updateEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.UpdateEndpointRequest());
            request.endpoint = {};
    ...
    describe('createEndpoint', () => {
        it('invokes createEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.CreateEndpointRequest());
            request.parent = '';
        ...
        it('invokes createEndpoint without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createEndpoint(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IEndpoint, protos.google.cloud.aiplatform.v1beta1.ICreateEndpointOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IEndpoint, protos.google.cloud.aiplatform.v1beta1.ICreateEndpointOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createEndpoint as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('deleteEndpoint', () => {
        it('invokes deleteEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.DeleteEndpointRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deployModel', () => {
        it('invokes deployModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.DeployModelRequest());
            request.endpoint = '';
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deployModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deployModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deployModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IDeployModelResponse, protos.google.cloud.aiplatform.v1beta1.IDeployModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IDeployModelResponse, protos.google.cloud.aiplatform.v1beta1.IDeployModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deployModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('undeployModel', () => {
        it('invokes undeployModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.UndeployModelRequest());
            request.endpoint = '';
            const expectedHeaderRequestParams = "endpoint=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.undeployModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes undeployModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.undeployModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IUndeployModelResponse, protos.google.cloud.aiplatform.v1beta1.IUndeployModelOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IUndeployModelResponse, protos.google.cloud.aiplatform.v1beta1.IUndeployModelOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.undeployModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('listEndpoints', () => {
        it('invokes listEndpoints without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ListEndpointsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes listEndpointsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.Endpoint[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.Endpoint) => {
        ...
        it('uses async iteration with listEndpoints without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.IEndpoint[] = [];
