      ...
      module V1beta1
        module FeaturestoreOnlineServingService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Aiplatform::V1beta1::FeaturestoreOnlineServingService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # ## Example
            #
            # To modify the configuration for all FeaturestoreOnlineServingService clients:
            #
            #     ::Google::Cloud::Aiplatform::V1beta1::FeaturestoreOnlineServingService::Client.configure do |config|
            #       config.timeout = 10.0
            #     end
            #
            ...
            def self.configure
              @configure ||= begin
                ...
                default_config.rpcs.read_feature_values.timeout = 5.0

                default_config.rpcs.streaming_read_feature_values.timeout = 5.0
            ...
            # ## Examples
            #
            # To create a new FeaturestoreOnlineServingService client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::Aiplatform::V1beta1::FeaturestoreOnlineServingService::Client.new
            #
            # To create a new FeaturestoreOnlineServingService client with a custom
            # configuration:
            #
            ...
            def initialize
              ...
              require "gapic/grpc"
              require "google/cloud/aiplatform/v1beta1/featurestore_online_service_services_pb"
              ...
              @featurestore_online_serving_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Aiplatform::V1beta1::FeaturestoreOnlineServingService::Stub,
            ...
            #   {::Google::Cloud::Aiplatform::V1beta1::ReadFeatureValuesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Aiplatform::V1beta1::ReadFeatureValuesRequest, ::Hash]
            ...
            # @yieldparam response [::Google::Cloud::Aiplatform::V1beta1::ReadFeatureValuesResponse]
            ...
            def read_feature_values request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Aiplatform::V1beta1::ReadFeatureValuesRequest
            ...
            #   {::Google::Cloud::Aiplatform::V1beta1::StreamingReadFeatureValuesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Aiplatform::V1beta1::StreamingReadFeatureValuesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Enumerable<::Google::Cloud::Aiplatform::V1beta1::ReadFeatureValuesResponse>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def streaming_read_feature_values request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Aiplatform::V1beta1::StreamingReadFeatureValuesRequest
            ...
            # {::Google::Cloud::Aiplatform::V1beta1::FeaturestoreOnlineServingService::Client::Configuration::Rpcs}
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for read_feature_values
