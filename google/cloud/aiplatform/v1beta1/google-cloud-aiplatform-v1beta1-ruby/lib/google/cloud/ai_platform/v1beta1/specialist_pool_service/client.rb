      ...
      module V1beta1
        module SpecialistPoolService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::AIPlatform::V1beta1::SpecialistPoolService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # ## Example
            #
            # To modify the configuration for all SpecialistPoolService clients:
            #
            #     ::Google::Cloud::AIPlatform::V1beta1::SpecialistPoolService::Client.configure do |config|
            #       config.timeout = 10.0
            #     end
            #
            ...
            # ## Examples
            #
            # To create a new SpecialistPoolService client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::AIPlatform::V1beta1::SpecialistPoolService::Client.new
            #
            # To create a new SpecialistPoolService client with a custom
            # configuration:
            #
            ...
            def initialize
              ...
              @specialist_pool_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::AIPlatform::V1beta1::SpecialistPoolService::Stub,
            ...
            #
            # @return [::Google::Cloud::AIPlatform::V1beta1::SpecialistPoolService::Operations]
            #
            ...
            #   {::Google::Cloud::AIPlatform::V1beta1::CreateSpecialistPoolRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AIPlatform::V1beta1::CreateSpecialistPoolRequest, ::Hash]
            ...
            def create_specialist_pool request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1beta1::CreateSpecialistPoolRequest
            ...
            #   {::Google::Cloud::AIPlatform::V1beta1::GetSpecialistPoolRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AIPlatform::V1beta1::GetSpecialistPoolRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::AIPlatform::V1beta1::SpecialistPool]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def get_specialist_pool request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1beta1::GetSpecialistPoolRequest
            ...
            #   {::Google::Cloud::AIPlatform::V1beta1::ListSpecialistPoolsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AIPlatform::V1beta1::ListSpecialistPoolsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::AIPlatform::V1beta1::SpecialistPool>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::AIPlatform::V1beta1::SpecialistPool>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            def list_specialist_pools request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1beta1::ListSpecialistPoolsRequest
            ...
            #   {::Google::Cloud::AIPlatform::V1beta1::DeleteSpecialistPoolRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AIPlatform::V1beta1::DeleteSpecialistPoolRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def delete_specialist_pool request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1beta1::DeleteSpecialistPoolRequest
            ...
            #   {::Google::Cloud::AIPlatform::V1beta1::UpdateSpecialistPoolRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AIPlatform::V1beta1::UpdateSpecialistPoolRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def update_specialist_pool request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1beta1::UpdateSpecialistPoolRequest
            ...
            # {::Google::Cloud::AIPlatform::V1beta1::SpecialistPoolService::Client::Configuration::Rpcs}
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for create_specialist_pool
