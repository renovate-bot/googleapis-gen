...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/aiplatform/v1beta1/pipeline_service.proto", :syntax => :proto3) do
    add_message "google.cloud.aiplatform.v1beta1.CreateTrainingPipelineRequest" do
      optional :parent, :string, 1
      optional :training_pipeline, :message, 2, "google.cloud.aiplatform.v1beta1.TrainingPipeline"
    end
    add_message "google.cloud.aiplatform.v1beta1.GetTrainingPipelineRequest" do
      optional :name, :string, 1
    end
    add_message "google.cloud.aiplatform.v1beta1.ListTrainingPipelinesRequest" do
      optional :parent, :string, 1
    ...
    add_message "google.cloud.aiplatform.v1beta1.ListTrainingPipelinesResponse" do
      repeated :training_pipelines, :message, 1, "google.cloud.aiplatform.v1beta1.TrainingPipeline"
      optional :next_page_token, :string, 2
    end
    add_message "google.cloud.aiplatform.v1beta1.DeleteTrainingPipelineRequest" do
      optional :name, :string, 1
    end
...
module Google
  module Cloud
    module AIPlatform
      module V1beta1
        CreateTrainingPipelineRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.CreateTrainingPipelineRequest").msgclass
        GetTrainingPipelineRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.GetTrainingPipelineRequest").msgclass
        ListTrainingPipelinesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.ListTrainingPipelinesRequest").msgclass
