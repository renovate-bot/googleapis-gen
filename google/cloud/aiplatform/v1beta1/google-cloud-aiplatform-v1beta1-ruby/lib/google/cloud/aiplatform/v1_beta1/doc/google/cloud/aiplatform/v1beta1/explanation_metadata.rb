  ...
  module Cloud
    module Aiplatform
      module V1beta1
        ...
        # @!attribute [rw] inputs
        #   @return [Hash{String => Google::Cloud::Aiplatform::V1beta1::ExplanationMetadata::InputMetadata}]
        ...
        class ExplanationMetadata
          ...
          #     {Google::Cloud::Aiplatform::V1beta1::DeployedModel#model Model's}
