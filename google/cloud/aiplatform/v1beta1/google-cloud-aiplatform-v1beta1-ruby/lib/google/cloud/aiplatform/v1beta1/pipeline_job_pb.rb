...
require 'google/cloud/aiplatform/v1beta1/value_pb'
...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/aiplatform/v1beta1/pipeline_job.proto", :syntax => :proto3) do
    add_message "google.cloud.aiplatform.v1beta1.PipelineJob" do
      ...
      optional :state, :enum, 8, "google.cloud.aiplatform.v1beta1.PipelineState"
      optional :job_detail, :message, 9, "google.cloud.aiplatform.v1beta1.PipelineJobDetail"
      optional :error, :message, 10, "google.rpc.Status"
      map :labels, :string, :string, 11
      optional :runtime_config, :message, 12, "google.cloud.aiplatform.v1beta1.PipelineJob.RuntimeConfig"
      optional :encryption_spec, :message, 16, "google.cloud.aiplatform.v1beta1.EncryptionSpec"
    ...
    add_message "google.cloud.aiplatform.v1beta1.PipelineJobDetail" do
      ...
      optional :pipeline_run_context, :message, 2, "google.cloud.aiplatform.v1beta1.Context"
      repeated :task_details, :message, 3, "google.cloud.aiplatform.v1beta1.PipelineTaskDetail"
    end
    add_message "google.cloud.aiplatform.v1beta1.PipelineTaskDetail" do
      ...
      optional :start_time, :message, 4, "google.protobuf.Timestamp"
      optional :end_time, :message, 5, "google.protobuf.Timestamp"
      optional :executor_detail, :message, 6, "google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail"
    ...
    add_enum "google.cloud.aiplatform.v1beta1.PipelineTaskDetail.State" do
    ...
    add_message "google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail" do
      oneof :details do
        optional :container_detail, :message, 1, "google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail.ContainerDetail"
        optional :custom_job_detail, :message, 2, "google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail.CustomJobDetail"
      end
    end
    add_message "google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail.ContainerDetail" do
      optional :main_job, :string, 1
      optional :pre_caching_check_job, :string, 2
    end
    add_message "google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail.CustomJobDetail" do
...
module Google
  module Cloud
    module AIPlatform
      module V1beta1
        PipelineJob = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.PipelineJob").msgclass
        ...
        PipelineTaskExecutorDetail::ContainerDetail = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail.ContainerDetail").msgclass
        PipelineTaskExecutorDetail::CustomJobDetail = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.PipelineTaskExecutorDetail.CustomJobDetail").msgclass
      end
    end
  end
end
