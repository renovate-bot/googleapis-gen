      ...
      module V1beta1
        module EndpointService
          ...
          class Client
            ...
            # ## Example
            #
            # To modify the configuration for all EndpointService clients:
            #
            ...
            # ## Examples
            #
            # To create a new EndpointService client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client.new
            #
            # To create a new EndpointService client with a custom
            # configuration:
            #
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for create_endpoint
