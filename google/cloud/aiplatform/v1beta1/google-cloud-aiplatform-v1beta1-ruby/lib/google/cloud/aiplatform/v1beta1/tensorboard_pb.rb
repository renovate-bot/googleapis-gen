...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/aiplatform/v1beta1/tensorboard.proto", :syntax => :proto3) do
    add_message "google.cloud.aiplatform.v1beta1.Tensorboard" do
...
module Google
  module Cloud
    module AIPlatform
      module V1beta1
        Tensorboard = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.Tensorboard").msgclass
      end
    end
  end
end
