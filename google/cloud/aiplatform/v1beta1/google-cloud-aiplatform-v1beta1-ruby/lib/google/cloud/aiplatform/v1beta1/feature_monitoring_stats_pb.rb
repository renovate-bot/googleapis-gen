...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/aiplatform/v1beta1/feature_monitoring_stats.proto", :syntax => :proto3) do
    add_message "google.cloud.aiplatform.v1beta1.FeatureStatsAnomaly" do
...
module Google
  module Cloud
    module AIPlatform
      module V1beta1
        FeatureStatsAnomaly = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.FeatureStatsAnomaly").msgclass
      end
    end
  end
end
