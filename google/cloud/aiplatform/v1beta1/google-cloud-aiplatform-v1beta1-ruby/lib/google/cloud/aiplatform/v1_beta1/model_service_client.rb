  ...
  module Cloud
    module Aiplatform
      module V1Beta1
        ...
        #   @return [Google::Cloud::Aiplatform::V1beta1::ModelService::Stub]
        class ModelServiceClient
          ...
          def initialize \
            ...
            @model_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Aiplatform::V1beta1::ModelService::Stub.method(:new)
            )
          ...
          #   A hash of the same form as `Google::Cloud::Aiplatform::V1beta1::Model`
          ...
          #
          #   model_client = Google::Cloud::Aiplatform::V1Beta1::Model.new(version: :v1beta1)
          ...
          def upload_model \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1beta1::UploadModelRequest)
          ...
          # @yieldparam result [Google::Cloud::Aiplatform::V1beta1::Model]
          ...
          def get_model \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1beta1::GetModelRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1beta1::Model>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1beta1::Model>]
          #   An enumerable of Google::Cloud::Aiplatform::V1beta1::Model instances.
          ...
          def list_models \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1beta1::ListModelsRequest)
          ...
          def update_model \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1beta1::UpdateModelRequest)
          ...
          def delete_model \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1beta1::DeleteModelRequest)
            operation = Google::Gax::Operation.new(
          ...
          #   A hash of the same form as `Google::Cloud::Aiplatform::V1beta1::ExportModelRequest::OutputConfig`
          #   can also be provided.
          # @param options [Google::Gax::CallOptions]
          #   Overrides the default settings for this call, e.g, timeout,
          #   retries, etc.
          ...
          def export_model \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1beta1::ExportModelRequest)
            operation = Google::Gax::Operation.new(
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Aiplatform::V1beta1::ModelEvaluation]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          ...
          def get_model_evaluation \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1beta1::GetModelEvaluationRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1beta1::ModelEvaluation>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1beta1::ModelEvaluation>]
          #   An enumerable of Google::Cloud::Aiplatform::V1beta1::ModelEvaluation instances.
          #   See Google::Gax::PagedEnumerable documentation for other
          #   operations such as per-page iteration or access to the response
          #   object.
          # @raise [Google::Gax::GaxError] if the RPC is aborted.
          ...
          def list_model_evaluations \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1beta1::ListModelEvaluationsRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Aiplatform::V1beta1::ModelEvaluationSlice]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          ...
          def get_model_evaluation_slice \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1beta1::GetModelEvaluationSliceRequest)
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1beta1::ModelEvaluationSlice>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Aiplatform::V1beta1::ModelEvaluationSlice>]
          #   An enumerable of Google::Cloud::Aiplatform::V1beta1::ModelEvaluationSlice instances.
          #   See Google::Gax::PagedEnumerable documentation for other
          #   operations such as per-page iteration or access to the response
          #   object.
          # @raise [Google::Gax::GaxError] if the RPC is aborted.
          ...
          def list_model_evaluation_slices \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Aiplatform::V1beta1::ListModelEvaluationSlicesRequest)
