      ...
      module V1beta1
        module PredictionService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Aiplatform::V1beta1::PredictionService::Client::Configuration}
            ...
            #
            #     ::Google::Cloud::Aiplatform::V1beta1::PredictionService::Client.configure do |config|
            #       config.timeout = 10.0
            #     end
            #
            ...
            def self.configure
              @configure ||= begin
                ...
                default_config.rpcs.explain.timeout = 5.0
            ...
            # configuration:
            #
            #     client = ::Google::Cloud::Aiplatform::V1beta1::PredictionService::Client.new do |config|
            #       config.timeout = 10.0
            #     end
            #
            ...
            def initialize
              ...
              @prediction_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Aiplatform::V1beta1::PredictionService::Stub,
            ...
            #   {::Google::Cloud::Aiplatform::V1beta1::PredictRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Aiplatform::V1beta1::PredictRequest, ::Hash]
            ...
            # @yieldparam response [::Google::Cloud::Aiplatform::V1beta1::PredictResponse]
            ...
            def predict request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Aiplatform::V1beta1::PredictRequest
            ...
            #   {::Google::Cloud::Aiplatform::V1beta1::ExplainRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Aiplatform::V1beta1::ExplainRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Aiplatform::V1beta1::ExplainResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def explain request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Aiplatform::V1beta1::ExplainRequest
            ...
            # {::Google::Cloud::Aiplatform::V1beta1::PredictionService::Client::Configuration::Rpcs}
