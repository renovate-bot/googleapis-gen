...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/aiplatform/v1beta1/execution.proto", :syntax => :proto3) do
    add_message "google.cloud.aiplatform.v1beta1.Execution" do
      optional :name, :string, 1
      optional :display_name, :string, 2
      optional :state, :enum, 6, "google.cloud.aiplatform.v1beta1.Execution.State"
    ...
    add_enum "google.cloud.aiplatform.v1beta1.Execution.State" do
