...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/aiplatform/v1beta1/study.proto", :syntax => :proto3) do
    ...
    add_enum "google.cloud.aiplatform.v1beta1.Trial.State" do
      value :STATE_UNSPECIFIED, 0
      value :REQUESTED, 1
      value :ACTIVE, 2
      value :STOPPING, 3
    ...
    add_message "google.cloud.aiplatform.v1beta1.StudySpec" do
    ...
    add_message "google.cloud.aiplatform.v1beta1.StudySpec.MetricSpec" do
      ...
      optional :goal, :enum, 2, "google.cloud.aiplatform.v1beta1.StudySpec.MetricSpec.GoalType"
    end
    add_enum "google.cloud.aiplatform.v1beta1.StudySpec.MetricSpec.GoalType" do
      value :GOAL_TYPE_UNSPECIFIED, 0
      value :MAXIMIZE, 1
      value :MINIMIZE, 2
    end
    add_message "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec" do
      optional :parameter_id, :string, 1
      optional :scale_type, :enum, 6, "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ScaleType"
      repeated :conditional_parameter_specs, :message, 10, "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec"
      oneof :parameter_value_spec do
        optional :double_value_spec, :message, 2, "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.DoubleValueSpec"
        optional :integer_value_spec, :message, 3, "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.IntegerValueSpec"
        optional :categorical_value_spec, :message, 4, "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.CategoricalValueSpec"
        optional :discrete_value_spec, :message, 5, "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.DiscreteValueSpec"
      end
    end
    ...
    add_message "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec" do
      ...
      oneof :parent_value_condition do
        optional :parent_discrete_values, :message, 2, "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec.DiscreteValueCondition"
        optional :parent_int_values, :message, 3, "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec.IntValueCondition"
        optional :parent_categorical_values, :message, 4, "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec.CategoricalValueCondition"
      end
    end
    add_message "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec.DiscreteValueCondition" do
      repeated :values, :double, 1
    end
    add_message "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec.IntValueCondition" do
      repeated :values, :int64, 1
    end
    add_message "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec.CategoricalValueCondition" do
      repeated :values, :string, 1
    end
    add_enum "google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ScaleType" do
    ...
    add_message "google.cloud.aiplatform.v1beta1.Measurement.Metric" do
      optional :metric_id, :string, 1
  ...
  module Cloud
    module Aiplatform
      module V1beta1
        ...
        StudySpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.StudySpec").msgclass
        StudySpec::MetricSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.StudySpec.MetricSpec").msgclass
        StudySpec::MetricSpec::GoalType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.StudySpec.MetricSpec.GoalType").enummodule
        StudySpec::ParameterSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec").msgclass
        StudySpec::ParameterSpec::DoubleValueSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.DoubleValueSpec").msgclass
        StudySpec::ParameterSpec::IntegerValueSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.IntegerValueSpec").msgclass
        StudySpec::ParameterSpec::CategoricalValueSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.CategoricalValueSpec").msgclass
        StudySpec::ParameterSpec::DiscreteValueSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.DiscreteValueSpec").msgclass
        StudySpec::ParameterSpec::ConditionalParameterSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec").msgclass
        StudySpec::ParameterSpec::ConditionalParameterSpec::DiscreteValueCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.cloud.aiplatform.v1beta1.StudySpec.ParameterSpec.ConditionalParameterSpec.DiscreteValueCondition").msgclass
