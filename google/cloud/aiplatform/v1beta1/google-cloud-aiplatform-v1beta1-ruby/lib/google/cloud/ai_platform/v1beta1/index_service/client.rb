          ...
          class Client
            ...
            def self.configure
              @configure ||= begin
                ...
                default_config.rpcs.create_index.timeout = 5.0

                default_config.rpcs.get_index.timeout = 5.0

                default_config.rpcs.list_indexes.timeout = 5.0

                default_config.rpcs.update_index.timeout = 5.0

                default_config.rpcs.delete_index.timeout = 5.0
            ...
            def initialize
              ...
              @index_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::AIPlatform::V1beta1::IndexService::Stub,
            ...
            #
            # @return [::Google::Cloud::AIPlatform::V1beta1::IndexService::Operations]
            #
            ...
            #   {::Google::Cloud::AIPlatform::V1beta1::CreateIndexRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AIPlatform::V1beta1::CreateIndexRequest, ::Hash]
            ...
            #   @param index [::Google::Cloud::AIPlatform::V1beta1::Index, ::Hash]
            ...
            def create_index request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1beta1::CreateIndexRequest
            ...
            #   {::Google::Cloud::AIPlatform::V1beta1::GetIndexRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AIPlatform::V1beta1::GetIndexRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::AIPlatform::V1beta1::Index]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::AIPlatform::V1beta1::GetIndexRequest.new
            #
            #   # Call the get_index method.
            #   result = client.get_index request
            #
            #   # The returned object is of type Google::Cloud::AIPlatform::V1beta1::Index.
            #   p result
            #
            def get_index request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1beta1::GetIndexRequest
            ...
            #   {::Google::Cloud::AIPlatform::V1beta1::ListIndexesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AIPlatform::V1beta1::ListIndexesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::AIPlatform::V1beta1::Index>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::AIPlatform::V1beta1::Index>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            def list_indexes request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1beta1::ListIndexesRequest
            ...
            #   {::Google::Cloud::AIPlatform::V1beta1::UpdateIndexRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AIPlatform::V1beta1::UpdateIndexRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def update_index request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1beta1::UpdateIndexRequest
            ...
            # {::Google::Cloud::AIPlatform::V1beta1::Index#deployed_indexes DeployedIndexes} had been undeployed.
            #
            # @overload delete_index(request, options = nil)
            #   Pass arguments to `delete_index` via a request object, either of type
            #   {::Google::Cloud::AIPlatform::V1beta1::DeleteIndexRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::AIPlatform::V1beta1::DeleteIndexRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def delete_index request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::AIPlatform::V1beta1::DeleteIndexRequest
            ...
            # {::Google::Cloud::AIPlatform::V1beta1::IndexService::Client::Configuration::Rpcs}
