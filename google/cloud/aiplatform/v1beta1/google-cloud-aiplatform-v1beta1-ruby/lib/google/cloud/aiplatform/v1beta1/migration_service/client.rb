      ...
      module V1beta1
        module MigrationService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Aiplatform::V1beta1::MigrationService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # ## Example
            #
            # To modify the configuration for all MigrationService clients:
            #
            #     ::Google::Cloud::Aiplatform::V1beta1::MigrationService::Client.configure do |config|
            #       config.timeout = 10.0
            #     end
            #
            ...
            # ## Examples
            #
            # To create a new MigrationService client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::Aiplatform::V1beta1::MigrationService::Client.new
            #
            # To create a new MigrationService client with a custom
            # configuration:
            #
            ...
            def initialize
              ...
              @migration_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Aiplatform::V1beta1::MigrationService::Stub,
            ...
            #
            # @return [::Google::Cloud::Aiplatform::V1beta1::MigrationService::Operations]
            #
            ...
            #   {::Google::Cloud::Aiplatform::V1beta1::SearchMigratableResourcesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Aiplatform::V1beta1::SearchMigratableResourcesRequest, ::Hash]
            ...
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Aiplatform::V1beta1::MigratableResource>]
            #
            ...
            def search_migratable_resources request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Aiplatform::V1beta1::SearchMigratableResourcesRequest
            ...
            #   {::Google::Cloud::Aiplatform::V1beta1::BatchMigrateResourcesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Aiplatform::V1beta1::BatchMigrateResourcesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def batch_migrate_resources request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Aiplatform::V1beta1::BatchMigrateResourcesRequest
            ...
            # {::Google::Cloud::Aiplatform::V1beta1::MigrationService::Client::Configuration::Rpcs}
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for search_migratable_resources
