...
class ::Google::Cloud::Aiplatform::V1beta1::FeaturestoreService::ClientTest < Minitest::Test
  ...
  def test_batch_read_feature_values
    ...
    Gapic::ServiceStub.stub :new, batch_read_feature_values_client_stub do
      ...
      # Use hash object
      client.batch_read_feature_values({ csv_read_instances: csv_read_instances, featurestore: featurestore, destination: destination, entity_type_specs: entity_type_specs }) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.batch_read_feature_values ::Google::Cloud::Aiplatform::V1beta1::BatchReadFeatureValuesRequest.new(csv_read_instances: csv_read_instances, featurestore: featurestore, destination: destination, entity_type_specs: entity_type_specs) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.batch_read_feature_values({ csv_read_instances: csv_read_instances, featurestore: featurestore, destination: destination, entity_type_specs: entity_type_specs }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.batch_read_feature_values(::Google::Cloud::Aiplatform::V1beta1::BatchReadFeatureValuesRequest.new(csv_read_instances: csv_read_instances, featurestore: featurestore, destination: destination, entity_type_specs: entity_type_specs), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
