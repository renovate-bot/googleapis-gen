...
class ::Google::Cloud::Aiplatform::V1beta1::IndexEndpointService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Aiplatform::V1beta1::IndexEndpointService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Aiplatform::V1beta1::IndexEndpointService::Operations::Configuration, config
  end
end
