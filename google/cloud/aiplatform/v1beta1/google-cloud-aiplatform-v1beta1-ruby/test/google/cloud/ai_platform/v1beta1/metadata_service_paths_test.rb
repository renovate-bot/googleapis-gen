...
require "google/cloud/ai_platform/v1beta1/metadata_service"

class ::Google::Cloud::AIPlatform::V1beta1::MetadataService::ClientPathsTest < Minitest::Test
  ...
  def test_metadata_schema_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.metadata_schema_path project: "value0", location: "value1", metadata_store: "value2", metadata_schema: "value3"
      assert_equal "projects/value0/locations/value1/metadataStores/value2/metadataSchemas/value3", path
    end
  end
  ...
  def test_metadata_store_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.metadata_store_path project: "value0", location: "value1", metadata_store: "value2"
      assert_equal "projects/value0/locations/value1/metadataStores/value2", path
    end
  end
end
