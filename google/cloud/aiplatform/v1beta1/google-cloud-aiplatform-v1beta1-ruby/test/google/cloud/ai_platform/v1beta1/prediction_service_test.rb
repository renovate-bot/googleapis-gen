...
class ::Google::Cloud::AIPlatform::V1beta1::PredictionService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_predict
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1beta1::PredictResponse.new
    ...
    predict_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::PredictRequest, request
    ...
    Gapic::ServiceStub.stub :new, predict_client_stub do
      ...
      # Use protobuf object
      client.predict ::Google::Cloud::AIPlatform::V1beta1::PredictRequest.new(endpoint: endpoint, instances: instances, parameters: parameters) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.predict(::Google::Cloud::AIPlatform::V1beta1::PredictRequest.new(endpoint: endpoint, instances: instances, parameters: parameters), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_raw_predict
    ...
    raw_predict_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::RawPredictRequest, request
      assert_equal "hello world", request["endpoint"]
    ...
    Gapic::ServiceStub.stub :new, raw_predict_client_stub do
      ...
      # Use protobuf object
      client.raw_predict ::Google::Cloud::AIPlatform::V1beta1::RawPredictRequest.new(endpoint: endpoint, http_body: http_body) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.raw_predict(::Google::Cloud::AIPlatform::V1beta1::RawPredictRequest.new(endpoint: endpoint, http_body: http_body), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_explain
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1beta1::ExplainResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    explain_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::ExplainRequest, request
      assert_equal "hello world", request["endpoint"]
      assert_kind_of ::Google::Protobuf::Value, request["instances"].first
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::Value), request["parameters"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::ExplanationSpecOverride), request["explanation_spec_override"]
    ...
    Gapic::ServiceStub.stub :new, explain_client_stub do
      ...
      # Use protobuf object
      client.explain ::Google::Cloud::AIPlatform::V1beta1::ExplainRequest.new(endpoint: endpoint, instances: instances, parameters: parameters, explanation_spec_override: explanation_spec_override, deployed_model_id: deployed_model_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.explain(::Google::Cloud::AIPlatform::V1beta1::ExplainRequest.new(endpoint: endpoint, instances: instances, parameters: parameters, explanation_spec_override: explanation_spec_override, deployed_model_id: deployed_model_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::PredictionService::Client::Configuration, config
  end
end
