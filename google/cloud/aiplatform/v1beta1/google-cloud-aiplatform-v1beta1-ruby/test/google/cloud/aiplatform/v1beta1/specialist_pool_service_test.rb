...
class ::Google::Cloud::Aiplatform::V1beta1::SpecialistPoolService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_specialist_pool
    ...
    create_specialist_pool_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Aiplatform::V1beta1::CreateSpecialistPoolRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Aiplatform::V1beta1::SpecialistPool), request["specialist_pool"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_specialist_pool_client_stub do
      ...
      # Use protobuf object
      client.create_specialist_pool ::Google::Cloud::Aiplatform::V1beta1::CreateSpecialistPoolRequest.new(parent: parent, specialist_pool: specialist_pool) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      client.create_specialist_pool(::Google::Cloud::Aiplatform::V1beta1::CreateSpecialistPoolRequest.new(parent: parent, specialist_pool: specialist_pool), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_specialist_pool
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Aiplatform::V1beta1::SpecialistPool.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_specialist_pool_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Aiplatform::V1beta1::GetSpecialistPoolRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_specialist_pool_client_stub do
      ...
      # Use protobuf object
      client.get_specialist_pool ::Google::Cloud::Aiplatform::V1beta1::GetSpecialistPoolRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_specialist_pool(::Google::Cloud::Aiplatform::V1beta1::GetSpecialistPoolRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_specialist_pools
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Aiplatform::V1beta1::ListSpecialistPoolsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_specialist_pools_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Aiplatform::V1beta1::ListSpecialistPoolsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_specialist_pools_client_stub do
      ...
      # Use protobuf object
      client.list_specialist_pools ::Google::Cloud::Aiplatform::V1beta1::ListSpecialistPoolsRequest.new(parent: parent, page_size: page_size, page_token: page_token, read_mask: read_mask) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_specialist_pools(::Google::Cloud::Aiplatform::V1beta1::ListSpecialistPoolsRequest.new(parent: parent, page_size: page_size, page_token: page_token, read_mask: read_mask), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_specialist_pool
    ...
    delete_specialist_pool_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Aiplatform::V1beta1::DeleteSpecialistPoolRequest, request
      assert_equal "hello world", request["name"]
    ...
    Gapic::ServiceStub.stub :new, delete_specialist_pool_client_stub do
      ...
      # Use protobuf object
      client.delete_specialist_pool ::Google::Cloud::Aiplatform::V1beta1::DeleteSpecialistPoolRequest.new(name: name, force: force) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_specialist_pool(::Google::Cloud::Aiplatform::V1beta1::DeleteSpecialistPoolRequest.new(name: name, force: force), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_specialist_pool
    ...
    update_specialist_pool_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Aiplatform::V1beta1::UpdateSpecialistPoolRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Aiplatform::V1beta1::SpecialistPool), request["specialist_pool"]
    ...
    Gapic::ServiceStub.stub :new, update_specialist_pool_client_stub do
      ...
      # Use protobuf object
      client.update_specialist_pool ::Google::Cloud::Aiplatform::V1beta1::UpdateSpecialistPoolRequest.new(specialist_pool: specialist_pool, update_mask: update_mask) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_specialist_pool(::Google::Cloud::Aiplatform::V1beta1::UpdateSpecialistPoolRequest.new(specialist_pool: specialist_pool, update_mask: update_mask), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Aiplatform::V1beta1::SpecialistPoolService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Aiplatform::V1beta1::SpecialistPoolService::Operations, client.operations_client
  end
end
