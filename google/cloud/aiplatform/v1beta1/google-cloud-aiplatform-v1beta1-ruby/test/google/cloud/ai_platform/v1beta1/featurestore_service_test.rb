...
require "google/cloud/aiplatform/v1beta1/featurestore_service_pb"
require "google/cloud/aiplatform/v1beta1/featurestore_service_services_pb"
require "google/cloud/ai_platform/v1beta1/featurestore_service"

class ::Google::Cloud::AIPlatform::V1beta1::FeaturestoreService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_featurestore
    ...
    create_featurestore_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::CreateFeaturestoreRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::Featurestore), request["featurestore"]
    ...
    Gapic::ServiceStub.stub :new, create_featurestore_client_stub do
      ...
      # Use protobuf object
      client.create_featurestore ::Google::Cloud::AIPlatform::V1beta1::CreateFeaturestoreRequest.new(parent: parent, featurestore: featurestore, featurestore_id: featurestore_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      client.create_featurestore(::Google::Cloud::AIPlatform::V1beta1::CreateFeaturestoreRequest.new(parent: parent, featurestore: featurestore, featurestore_id: featurestore_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_featurestore
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1beta1::Featurestore.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_featurestore_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::GetFeaturestoreRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_featurestore_client_stub do
      ...
      # Use protobuf object
      client.get_featurestore ::Google::Cloud::AIPlatform::V1beta1::GetFeaturestoreRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_featurestore(::Google::Cloud::AIPlatform::V1beta1::GetFeaturestoreRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_featurestores
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1beta1::ListFeaturestoresResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_featurestores_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::ListFeaturestoresRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_featurestores_client_stub do
      ...
      # Use protobuf object
      client.list_featurestores ::Google::Cloud::AIPlatform::V1beta1::ListFeaturestoresRequest.new(parent: parent, filter: filter, page_size: page_size, page_token: page_token, order_by: order_by, read_mask: read_mask) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_featurestores(::Google::Cloud::AIPlatform::V1beta1::ListFeaturestoresRequest.new(parent: parent, filter: filter, page_size: page_size, page_token: page_token, order_by: order_by, read_mask: read_mask), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_featurestore
    ...
    update_featurestore_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::UpdateFeaturestoreRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::Featurestore), request["featurestore"]
    ...
    Gapic::ServiceStub.stub :new, update_featurestore_client_stub do
      ...
      # Use protobuf object
      client.update_featurestore ::Google::Cloud::AIPlatform::V1beta1::UpdateFeaturestoreRequest.new(featurestore: featurestore, update_mask: update_mask) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_featurestore(::Google::Cloud::AIPlatform::V1beta1::UpdateFeaturestoreRequest.new(featurestore: featurestore, update_mask: update_mask), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_featurestore
    ...
    delete_featurestore_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::DeleteFeaturestoreRequest, request
      assert_equal "hello world", request["name"]
    ...
    Gapic::ServiceStub.stub :new, delete_featurestore_client_stub do
      ...
      # Use protobuf object
      client.delete_featurestore ::Google::Cloud::AIPlatform::V1beta1::DeleteFeaturestoreRequest.new(name: name, force: force) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_featurestore(::Google::Cloud::AIPlatform::V1beta1::DeleteFeaturestoreRequest.new(name: name, force: force), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_entity_type
    ...
    create_entity_type_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::CreateEntityTypeRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::EntityType), request["entity_type"]
    ...
    Gapic::ServiceStub.stub :new, create_entity_type_client_stub do
      ...
      # Use protobuf object
      client.create_entity_type ::Google::Cloud::AIPlatform::V1beta1::CreateEntityTypeRequest.new(parent: parent, entity_type: entity_type, entity_type_id: entity_type_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_entity_type(::Google::Cloud::AIPlatform::V1beta1::CreateEntityTypeRequest.new(parent: parent, entity_type: entity_type, entity_type_id: entity_type_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_entity_type
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1beta1::EntityType.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_entity_type_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::GetEntityTypeRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_entity_type_client_stub do
      ...
      # Use protobuf object
      client.get_entity_type ::Google::Cloud::AIPlatform::V1beta1::GetEntityTypeRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_entity_type(::Google::Cloud::AIPlatform::V1beta1::GetEntityTypeRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_entity_types
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1beta1::ListEntityTypesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_entity_types_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::ListEntityTypesRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["filter"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
    ...
    Gapic::ServiceStub.stub :new, list_entity_types_client_stub do
      ...
      # Use protobuf object
      client.list_entity_types ::Google::Cloud::AIPlatform::V1beta1::ListEntityTypesRequest.new(parent: parent, filter: filter, page_size: page_size, page_token: page_token, order_by: order_by, read_mask: read_mask) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_entity_types(::Google::Cloud::AIPlatform::V1beta1::ListEntityTypesRequest.new(parent: parent, filter: filter, page_size: page_size, page_token: page_token, order_by: order_by, read_mask: read_mask), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_entity_type
    ...
    update_entity_type_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::UpdateEntityTypeRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::EntityType), request["entity_type"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, update_entity_type_client_stub do
      ...
      # Use protobuf object
      client.update_entity_type ::Google::Cloud::AIPlatform::V1beta1::UpdateEntityTypeRequest.new(entity_type: entity_type, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_entity_type(::Google::Cloud::AIPlatform::V1beta1::UpdateEntityTypeRequest.new(entity_type: entity_type, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_entity_type
    ...
    delete_entity_type_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::DeleteEntityTypeRequest, request
      assert_equal "hello world", request["name"]
      assert_equal true, request["force"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_entity_type_client_stub do
      ...
      # Use protobuf object
      client.delete_entity_type ::Google::Cloud::AIPlatform::V1beta1::DeleteEntityTypeRequest.new(name: name, force: force) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_entity_type(::Google::Cloud::AIPlatform::V1beta1::DeleteEntityTypeRequest.new(name: name, force: force), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_feature
    ...
    create_feature_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::CreateFeatureRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::Feature), request["feature"]
    ...
    Gapic::ServiceStub.stub :new, create_feature_client_stub do
      ...
      # Use protobuf object
      client.create_feature ::Google::Cloud::AIPlatform::V1beta1::CreateFeatureRequest.new(parent: parent, feature: feature, feature_id: feature_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_feature(::Google::Cloud::AIPlatform::V1beta1::CreateFeatureRequest.new(parent: parent, feature: feature, feature_id: feature_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_batch_create_features
    ...
    batch_create_features_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::BatchCreateFeaturesRequest, request
      assert_equal "hello world", request["parent"]
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::CreateFeatureRequest, request["requests"].first
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, batch_create_features_client_stub do
      ...
      # Use protobuf object
      client.batch_create_features ::Google::Cloud::AIPlatform::V1beta1::BatchCreateFeaturesRequest.new(parent: parent, requests: requests) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.batch_create_features(::Google::Cloud::AIPlatform::V1beta1::BatchCreateFeaturesRequest.new(parent: parent, requests: requests), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_feature
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1beta1::Feature.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_feature_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::GetFeatureRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_feature_client_stub do
      ...
      # Use protobuf object
      client.get_feature ::Google::Cloud::AIPlatform::V1beta1::GetFeatureRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_feature(::Google::Cloud::AIPlatform::V1beta1::GetFeatureRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_features
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1beta1::ListFeaturesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_features_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::ListFeaturesRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["filter"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
    ...
    Gapic::ServiceStub.stub :new, list_features_client_stub do
      ...
      # Use protobuf object
      client.list_features ::Google::Cloud::AIPlatform::V1beta1::ListFeaturesRequest.new(parent: parent, filter: filter, page_size: page_size, page_token: page_token, order_by: order_by, read_mask: read_mask, latest_stats_count: latest_stats_count) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_features(::Google::Cloud::AIPlatform::V1beta1::ListFeaturesRequest.new(parent: parent, filter: filter, page_size: page_size, page_token: page_token, order_by: order_by, read_mask: read_mask, latest_stats_count: latest_stats_count), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_feature
    ...
    update_feature_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::UpdateFeatureRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::Feature), request["feature"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, update_feature_client_stub do
      ...
      # Use protobuf object
      client.update_feature ::Google::Cloud::AIPlatform::V1beta1::UpdateFeatureRequest.new(feature: feature, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_feature(::Google::Cloud::AIPlatform::V1beta1::UpdateFeatureRequest.new(feature: feature, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_feature
    ...
    delete_feature_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::DeleteFeatureRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_feature_client_stub do
      ...
      # Use protobuf object
      client.delete_feature ::Google::Cloud::AIPlatform::V1beta1::DeleteFeatureRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_feature(::Google::Cloud::AIPlatform::V1beta1::DeleteFeatureRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_feature_values
    ...
    import_feature_values_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::ImportFeatureValuesRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::AvroSource), request["avro_source"]
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::ImportFeatureValuesRequest::FeatureSpec, request["feature_specs"].first
  ...
  def test_batch_read_feature_values
    ...
    batch_read_feature_values_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::BatchReadFeatureValuesRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::CsvSource), request["csv_read_instances"]
      assert_equal :csv_read_instances, request.read_option
      assert_equal "hello world", request["featurestore"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::FeatureValueDestination), request["destination"]
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::BatchReadFeatureValuesRequest::PassThroughField, request["pass_through_fields"].first
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::BatchReadFeatureValuesRequest::EntityTypeSpec, request["entity_type_specs"].first
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, batch_read_feature_values_client_stub do
      ...
      # Use protobuf object
      client.batch_read_feature_values ::Google::Cloud::AIPlatform::V1beta1::BatchReadFeatureValuesRequest.new(csv_read_instances: csv_read_instances, featurestore: featurestore, destination: destination, pass_through_fields: pass_through_fields, entity_type_specs: entity_type_specs) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.batch_read_feature_values(::Google::Cloud::AIPlatform::V1beta1::BatchReadFeatureValuesRequest.new(csv_read_instances: csv_read_instances, featurestore: featurestore, destination: destination, pass_through_fields: pass_through_fields, entity_type_specs: entity_type_specs), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_export_feature_values
    ...
    export_feature_values_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::ExportFeatureValuesRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::ExportFeatureValuesRequest::SnapshotExport), request["snapshot_export"]
      assert_equal :snapshot_export, request.mode
      assert_equal "hello world", request["entity_type"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::FeatureValueDestination), request["destination"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::AIPlatform::V1beta1::FeatureSelector), request["feature_selector"]
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::DestinationFeatureSetting, request["settings"].first
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, export_feature_values_client_stub do
      ...
      # Use protobuf object
      client.export_feature_values ::Google::Cloud::AIPlatform::V1beta1::ExportFeatureValuesRequest.new(snapshot_export: snapshot_export, entity_type: entity_type, destination: destination, feature_selector: feature_selector, settings: settings) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.export_feature_values(::Google::Cloud::AIPlatform::V1beta1::ExportFeatureValuesRequest.new(snapshot_export: snapshot_export, entity_type: entity_type, destination: destination, feature_selector: feature_selector, settings: settings), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_search_features
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::AIPlatform::V1beta1::SearchFeaturesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    search_features_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::SearchFeaturesRequest, request
    ...
    Gapic::ServiceStub.stub :new, search_features_client_stub do
      ...
      # Use protobuf object
      client.search_features ::Google::Cloud::AIPlatform::V1beta1::SearchFeaturesRequest.new(location: location, query: query, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.search_features(::Google::Cloud::AIPlatform::V1beta1::SearchFeaturesRequest.new(location: location, query: query, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::FeaturestoreService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::AIPlatform::V1beta1::FeaturestoreService::Operations, client.operations_client
  end
end
