...
require "google/cloud/aiplatform/v1beta1/tensorboard_service_services_pb"
require "google/cloud/aiplatform/v1beta1/tensorboard_service"

class ::Google::Cloud::Aiplatform::V1beta1::TensorboardService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Aiplatform::V1beta1::TensorboardService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Aiplatform::V1beta1::TensorboardService::Operations::Configuration, config
  end
end
