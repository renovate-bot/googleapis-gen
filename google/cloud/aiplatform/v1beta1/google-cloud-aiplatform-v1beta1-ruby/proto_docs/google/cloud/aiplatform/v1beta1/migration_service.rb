...
module Google
  module Cloud
    module Aiplatform
      module V1beta1
        # Request message for {::Google::Cloud::Aiplatform::V1beta1::MigrationService::Client#search_migratable_resources MigrationService.SearchMigratableResources}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # Response message for {::Google::Cloud::Aiplatform::V1beta1::MigrationService::Client#search_migratable_resources MigrationService.SearchMigratableResources}.
        ...
        # Request message for {::Google::Cloud::Aiplatform::V1beta1::MigrationService::Client#batch_migrate_resources MigrationService.BatchMigrateResources}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # Response message for {::Google::Cloud::Aiplatform::V1beta1::MigrationService::Client#batch_migrate_resources MigrationService.BatchMigrateResources}.
        ...
        # Runtime operation information for {::Google::Cloud::Aiplatform::V1beta1::MigrationService::Client#batch_migrate_resources MigrationService.BatchMigrateResources}.
