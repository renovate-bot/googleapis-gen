  ...
  module Cloud
    module Aiplatform
      module V1beta1
        ...
        # @!attribute [rw] inputs
        #   @return [::Google::Protobuf::Map{::String => ::Google::Cloud::Aiplatform::V1beta1::ExplanationMetadataOverride::InputMetadataOverride}]
        ...
        class ExplanationMetadataOverride
          ...
          #   @return [::String]
          # @!attribute [rw] value
          #   @return [::Google::Cloud::Aiplatform::V1beta1::ExplanationMetadataOverride::InputMetadataOverride]
          class InputsEntry
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
