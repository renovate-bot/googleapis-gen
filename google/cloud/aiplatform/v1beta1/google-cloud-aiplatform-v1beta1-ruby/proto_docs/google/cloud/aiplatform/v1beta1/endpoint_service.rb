...
module Google
  module Cloud
    module Aiplatform
      module V1beta1
        # Request message for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#create_endpoint EndpointService.CreateEndpoint}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # Runtime operation information for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#create_endpoint EndpointService.CreateEndpoint}.
        ...
        # Request message for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#get_endpoint EndpointService.GetEndpoint}
        # @!attribute [rw] name
        #   @return [::String]
        ...
        # Request message for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#list_endpoints EndpointService.ListEndpoints}.
        # @!attribute [rw] parent
        #   @return [::String]
        ...
        # Response message for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#list_endpoints EndpointService.ListEndpoints}.
        ...
        # Request message for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#update_endpoint EndpointService.UpdateEndpoint}.
        # @!attribute [rw] endpoint
        #   @return [::Google::Cloud::Aiplatform::V1beta1::Endpoint]
        ...
        # Request message for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#delete_endpoint EndpointService.DeleteEndpoint}.
        # @!attribute [rw] name
        #   @return [::String]
        ...
        # Request message for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#deploy_model EndpointService.DeployModel}.
        # @!attribute [rw] endpoint
        #   @return [::String]
        ...
        # Response message for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#deploy_model EndpointService.DeployModel}.
        # @!attribute [rw] deployed_model
        #   @return [::Google::Cloud::Aiplatform::V1beta1::DeployedModel]
        ...
        # Runtime operation information for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#deploy_model EndpointService.DeployModel}.
        # @!attribute [rw] generic_metadata
        #   @return [::Google::Cloud::Aiplatform::V1beta1::GenericOperationMetadata]
        #     The operation generic information.
        ...
        # Request message for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#undeploy_model EndpointService.UndeployModel}.
        # @!attribute [rw] endpoint
        #   @return [::String]
        ...
        # Response message for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#undeploy_model EndpointService.UndeployModel}.
        class UndeployModelResponse
          include ::Google::Protobuf::MessageExts
          extend ::Google::Protobuf::MessageExts::ClassMethods
        end

        # Runtime operation information for {::Google::Cloud::Aiplatform::V1beta1::EndpointService::Client#undeploy_model EndpointService.UndeployModel}.
        # @!attribute [rw] generic_metadata
        #   @return [::Google::Cloud::Aiplatform::V1beta1::GenericOperationMetadata]
        #     The operation generic information.
