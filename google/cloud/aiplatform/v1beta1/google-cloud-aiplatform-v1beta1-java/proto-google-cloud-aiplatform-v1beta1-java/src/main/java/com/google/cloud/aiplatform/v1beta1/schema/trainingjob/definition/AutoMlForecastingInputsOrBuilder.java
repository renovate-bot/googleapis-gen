...
public interface AutoMlForecastingInputsOrBuilder extends
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlForecastingInputs.Transformation transformations = 4;</code>
   */
  com.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlForecastingInputs.Transformation getTransformations(int index);
  /**
   * <pre>
   * Each transformation will apply transform function to given input column.
   * And the result will be used for training.
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlForecastingInputs.Transformation transformations = 4;</code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlForecastingInputs.TransformationOrBuilder> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlForecastingInputs.Transformation transformations = 4;</code>
   */
  com.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlForecastingInputs.TransformationOrBuilder getTransformationsOrBuilder(
      int index);
   ...
   */
  com.google.protobuf.ByteString
      getStaticColumnsBytes(int index);
   ...
   */
  java.util.List<java.lang.String>
      getTimeVariantPastOnlyColumnsList();
  /**
   * <pre>
   * Column names that should be used as time variant past only columns.
   * This column contains information for the given entity (identified by the
   ...
   */
  com.google.protobuf.ByteString
      getTimeVariantPastOnlyColumnsBytes(int index);
   ...
   */
  java.util.List<java.lang.String>
      getTimeVariantPastAndFutureColumnsList();
  /**
   * <pre>
   * Column names that should be used as time variant past and future columns.
   * This column contains information for the given entity (identified by the
   ...
   */
  com.google.protobuf.ByteString
      getTimeVariantPastAndFutureColumnsBytes(int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlForecastingInputs.Period period = 11;</code>
   ...
   * @return The period.
   */
  com.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlForecastingInputs.Period getPeriod();
  /**
   * <pre>
   * Expected difference in time granularity between rows in the data. If it is
   * not set, the period is inferred from data.
   ...
   * <code>.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlForecastingInputs.Period period = 11;</code>
   */
  com.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlForecastingInputs.PeriodOrBuilder getPeriodOrBuilder();
