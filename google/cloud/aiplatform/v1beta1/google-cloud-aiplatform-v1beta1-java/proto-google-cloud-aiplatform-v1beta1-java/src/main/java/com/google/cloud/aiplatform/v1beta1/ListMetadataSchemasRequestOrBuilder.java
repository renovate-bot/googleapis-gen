...
public interface ListMetadataSchemasRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.ListMetadataSchemasRequest)
