...
func defaultFeaturestoreOnlineServingClientOptions() []option.ClientOption {
...
// NewFeaturestoreOnlineServingClient creates a new featurestore online serving service client.
//
...
func NewFeaturestoreOnlineServingClient(ctx context.Context, opts ...option.ClientOption) (*FeaturestoreOnlineServingClient, error) {
	clientOpts := defaultFeaturestoreOnlineServingClientOptions()
	...
	c := &FeaturestoreOnlineServingClient{
		...
		CallOptions:      defaultFeaturestoreOnlineServingCallOptions(),
