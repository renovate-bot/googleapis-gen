...
@javax.annotation.Generated(
    ...
    comments = "Source: google/cloud/ondemandscanning/v1beta1/scanner_service.proto")
public final class ScannerServiceGrpc {

  private ScannerServiceGrpc() {}

  public static final String SERVICE_NAME = "google.cloud.ondemandscanning.v1beta1.ScannerService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest,
      com.google.longrunning.Operation> getAnalyzePackagesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AnalyzePackages",
      requestType = com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest.class,
      responseType = com.google.longrunning.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest,
      com.google.longrunning.Operation> getAnalyzePackagesMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest, com.google.longrunning.Operation> getAnalyzePackagesMethod;
      ...
      synchronized (ScannerServiceGrpc.class) {
        if ((getAnalyzePackagesMethod = ScannerServiceGrpc.getAnalyzePackagesMethod) == null) {
          ScannerServiceGrpc.getAnalyzePackagesMethod = getAnalyzePackagesMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AnalyzePackages"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest,
      com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse> getListVulnerabilitiesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListVulnerabilities",
      requestType = com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest.class,
      responseType = com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest,
      com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse> getListVulnerabilitiesMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest, com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse> getListVulnerabilitiesMethod;
      ...
      synchronized (ScannerServiceGrpc.class) {
        if ((getListVulnerabilitiesMethod = ScannerServiceGrpc.getListVulnerabilitiesMethod) == null) {
          ScannerServiceGrpc.getListVulnerabilitiesMethod = getListVulnerabilitiesMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest, com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListVulnerabilities"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse.getDefaultInstance()))
  ...
  public static abstract class ScannerServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void analyzePackages(com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest request,
     ...
     * </pre>
     */
    public void listVulnerabilities(com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest,
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest,
                com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse>(
  ...
  public static final class ScannerServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ScannerServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.longrunning.Operation analyzePackages(com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest request) {
     ...
     * </pre>
     */
    public com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse listVulnerabilities(com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ScannerServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ScannerServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation> analyzePackages(
        com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse> listVulnerabilities(
        com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ANALYZE_PACKAGES:
          serviceImpl.analyzePackages((com.google.cloud.ondemandscanning.v1beta1.AnalyzePackagesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        case METHODID_LIST_VULNERABILITIES:
          serviceImpl.listVulnerabilities((com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.ondemandscanning.v1beta1.ListVulnerabilitiesResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ScannerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.cloud.ondemandscanning.v1beta1.ScannerServiceProto.getDescriptor();
    }
