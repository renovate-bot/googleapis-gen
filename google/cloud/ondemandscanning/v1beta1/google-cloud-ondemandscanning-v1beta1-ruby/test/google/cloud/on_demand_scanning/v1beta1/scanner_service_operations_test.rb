...
class ::Google::Cloud::OnDemandScanning::V1beta1::ScannerService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::OnDemandScanning::V1beta1::ScannerService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::OnDemandScanning::V1beta1::ScannerService::Operations::Configuration, config
  end
end
