...
from .transports.grpc import ScannerServiceGrpcTransport
from .transports.grpc_asyncio import ScannerServiceGrpcAsyncIOTransport


class ScannerServiceClientMeta(type):
    """Metaclass for the ScannerService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ScannerServiceTransport]]
    _transport_registry["grpc"] = ScannerServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = ScannerServiceGrpcAsyncIOTransport
...
class ScannerServiceClient(metaclass=ScannerServiceClientMeta):
    ...
    DEFAULT_ENDPOINT = "ondemandscanning.googleapis.com"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ScannerServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ScannerServiceTransport:
        ...
        Returns:
            ScannerServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, ScannerServiceTransport, None] = None,
        ...
        if isinstance(transport, ScannerServiceTransport):
            # transport is a ScannerServiceTransport instance.
    ...
    def analyze_packages(self,
        ...
        Args:
            request (google.cloud.ondemandscanning_v1beta1.types.AnalyzePackagesRequest):
        ...
        # in a scanner_service.AnalyzePackagesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, scanner_service.AnalyzePackagesRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.analyze_packages]
    ...
    def list_vulnerabilities(self,
            ...
            *,
            ...
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> pagers.ListVulnerabilitiesPager:
        ...
        Returns:
            google.cloud.ondemandscanning_v1beta1.services.scanner_service.pagers.ListVulnerabilitiesPager:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a scanner_service.ListVulnerabilitiesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, scanner_service.ListVulnerabilitiesRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_vulnerabilities]
        ...
        response = pagers.ListVulnerabilitiesPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
