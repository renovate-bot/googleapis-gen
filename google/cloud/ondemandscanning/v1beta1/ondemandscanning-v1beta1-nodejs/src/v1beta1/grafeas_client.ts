 ...
 * `src/v1beta1/grafeas_client_config.json`.
...
export class GrafeasClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.ondemandscanning.v1beta1.Grafeas', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.cloud.ondemandscanning.v1beta1.Grafeas.
    this.grafeasStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.ondemandscanning.v1beta1.Grafeas') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.ondemandscanning.v1beta1.Grafeas,
