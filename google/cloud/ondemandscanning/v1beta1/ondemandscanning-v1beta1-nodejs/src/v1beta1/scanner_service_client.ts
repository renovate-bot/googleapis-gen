 ...
 * `src/v1beta1/scanner_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './scanner_service_client_config.json';
...
export class ScannerServiceClient {
  ...
  scannerServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of ScannerServiceClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ScannerServiceClient;
    ...
    const analyzePackagesResponse = protoFilesRoot.lookup(
      '.g.AnalyzePackagesResponse') as gax.protobuf.Type;
    const analyzePackagesMetadata = protoFilesRoot.lookup(
      '.g.AnalyzePackagesMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      analyzePackages: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        analyzePackagesResponse.decode.bind(analyzePackagesResponse),
        analyzePackagesMetadata.decode.bind(analyzePackagesMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.ondemandscanning.v1beta1.ScannerService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.scannerServiceStub) {
      return this.scannerServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.ondemandscanning.v1beta1.ScannerService.
    this.scannerServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.ondemandscanning.v1beta1.ScannerService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.ondemandscanning.v1beta1.ScannerService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const scannerServiceStubMethods =
        ['analyzePackages', 'listVulnerabilities'];
    for (const methodName of scannerServiceStubMethods) {
      const callPromise = this.scannerServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  static get servicePath() {
    return 'ondemandscanning.googleapis.com';
  }
  ...
  analyzePackages(
      request?: protos.google.cloud.ondemandscanning.v1beta1.IAnalyzePackagesRequest,
      options?: CallOptions):
      Promise<[
 ...
 */
  analyzePackages(
    ...
    this.initialize();
    return this.innerApiCalls.analyzePackages(request, options, callback);
  }
/**
 * Check the status of the long running operation returned by `analyzePackages()`.
 * @param {String} name
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkAnalyzePackagesProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
  async checkAnalyzePackagesProgress(name: string): Promise<LROperation<protos.g.AnalyzePackagesResponse, protos.g.AnalyzePackagesMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.analyzePackages, gax.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.g.AnalyzePackagesResponse, protos.g.AnalyzePackagesMetadata>;
  }
  listVulnerabilities(
      request?: protos.google.cloud.ondemandscanning.v1beta1.IListVulnerabilitiesRequest,
      options?: CallOptions):
      Promise<[
        protos.grafeas.v1.IOccurrence[],
        protos.google.cloud.ondemandscanning.v1beta1.IListVulnerabilitiesRequest|null,
        protos.google.cloud.ondemandscanning.v1beta1.IListVulnerabilitiesResponse
      ]>;
  listVulnerabilities(
      request: protos.google.cloud.ondemandscanning.v1beta1.IListVulnerabilitiesRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.ondemandscanning.v1beta1.IListVulnerabilitiesRequest,
          protos.google.cloud.ondemandscanning.v1beta1.IListVulnerabilitiesResponse|null|undefined,
 ...
 *   We recommend using `listVulnerabilitiesAsync()`
 ...
 */
  listVulnerabilities(
    ...
    this.initialize();
    return this.innerApiCalls.listVulnerabilities(request, options, callback);
  }
 ...
 */
  listVulnerabilitiesStream(
    ...
    this.initialize();
    return this.descriptors.page.listVulnerabilities.createStream(
      this.innerApiCalls.listVulnerabilities as gax.GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listVulnerabilities`, but returns an iterable object.
 *
 ...
 */
  listVulnerabilitiesAsync(
    ...
    const callSettings = new gax.CallSettings(options);
    this.initialize();
    return this.descriptors.page.listVulnerabilities.asyncIterate(
      this.innerApiCalls['listVulnerabilities'] as GaxCall,
  ...
  close(): Promise<void> {
    this.initialize();
    if (!this._terminated) {
      return this.scannerServiceStub!.then(stub => {
