 ...
 * `src/v1/scanner_service_client_config.json`.
...
export class ScannerServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.ondemandscanning.v1.ScannerService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.scannerServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.ondemandscanning.v1.ScannerService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.ondemandscanning.v1.ScannerService,
 ...
 */
  ...
  listVulnerabilities(
      ...
      Promise<[
        ...
        protos.google.cloud.ondemandscanning.v1.IListVulnerabilitiesRequest|null,
        protos.google.cloud.ondemandscanning.v1.IListVulnerabilitiesResponse
      ]>;
  listVulnerabilities(
      request: protos.google.cloud.ondemandscanning.v1.IListVulnerabilitiesRequest,
      options: CallOptions,
