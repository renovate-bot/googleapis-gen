...
class ListVulnerabilitiesPager:
    ...
    :class:`google.cloud.ondemandscanning_v1.types.ListVulnerabilitiesResponse` object, and
    ...
    All the usual :class:`google.cloud.ondemandscanning_v1.types.ListVulnerabilitiesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.ondemandscanning_v1.types.ListVulnerabilitiesRequest):
                The initial request object.
            response (google.cloud.ondemandscanning_v1.types.ListVulnerabilitiesResponse):
