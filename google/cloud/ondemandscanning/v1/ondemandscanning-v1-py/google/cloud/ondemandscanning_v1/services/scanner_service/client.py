...
class ScannerServiceClient(metaclass=ScannerServiceClientMeta):
    ...
    def analyze_packages(self,
        ...
        Args:
            request (google.cloud.ondemandscanning_v1.types.AnalyzePackagesRequest):
    ...
    def list_vulnerabilities(self,
        ...
        Returns:
            google.cloud.ondemandscanning_v1.services.scanner_service.pagers.ListVulnerabilitiesPager:
