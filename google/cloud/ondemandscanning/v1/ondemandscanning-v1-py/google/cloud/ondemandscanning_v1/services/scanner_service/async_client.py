...
class ScannerServiceAsyncClient:
    ...
    async def analyze_packages(self,
        ...
        Args:
            request (:class:`google.cloud.ondemandscanning_v1.types.AnalyzePackagesRequest`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.ondemandscanning_v1.types.AnalyzePackagesResponse` AnalyzePackagesResponse contains the information necessary to find results
                   for the given scan.
    ...
    async def list_vulnerabilities(self,
        ...
        Args:
            request (:class:`google.cloud.ondemandscanning_v1.types.ListVulnerabilitiesRequest`):
        ...
        Returns:
            google.cloud.ondemandscanning_v1.services.scanner_service.pagers.ListVulnerabilitiesAsyncPager:
