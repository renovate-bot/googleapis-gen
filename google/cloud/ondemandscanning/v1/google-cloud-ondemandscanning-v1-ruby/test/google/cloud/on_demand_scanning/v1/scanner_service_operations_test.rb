...
require "google/cloud/ondemandscanning/v1/scanner_service_services_pb"
require "google/cloud/on_demand_scanning/v1/scanner_service"

class ::Google::Cloud::OnDemandScanning::V1::ScannerService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::OnDemandScanning::V1::ScannerService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::OnDemandScanning::V1::ScannerService::Operations::Configuration, config
  end
end
