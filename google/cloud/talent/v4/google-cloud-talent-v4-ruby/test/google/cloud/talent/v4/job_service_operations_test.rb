...
class ::Google::Cloud::Talent::V4::JobService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Talent::V4::JobService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Talent::V4::JobService::Operations::Configuration, config
  end
end
