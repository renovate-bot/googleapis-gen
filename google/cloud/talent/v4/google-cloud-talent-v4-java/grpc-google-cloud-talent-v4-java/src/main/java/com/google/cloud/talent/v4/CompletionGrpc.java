...
public final class CompletionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.talent.v4.CompleteQueryRequest,
      com.google.cloud.talent.v4.CompleteQueryResponse> getCompleteQueryMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.talent.v4.CompleteQueryRequest,
      com.google.cloud.talent.v4.CompleteQueryResponse> getCompleteQueryMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.talent.v4.CompleteQueryRequest, com.google.cloud.talent.v4.CompleteQueryResponse> getCompleteQueryMethod;
    if ((getCompleteQueryMethod = CompletionGrpc.getCompleteQueryMethod) == null) {
      synchronized (CompletionGrpc.class) {
        if ((getCompleteQueryMethod = CompletionGrpc.getCompleteQueryMethod) == null) {
          CompletionGrpc.getCompleteQueryMethod = getCompleteQueryMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.talent.v4.CompleteQueryRequest, com.google.cloud.talent.v4.CompleteQueryResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.talent.v4.CompleteQueryResponse.getDefaultInstance()))
   ...
   */
  public static CompletionBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<CompletionBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<CompletionBlockingStub>() {
        @java.lang.Override
        public CompletionBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static CompletionFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CompletionFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<CompletionFutureStub>() {
        @java.lang.Override
        public CompletionFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static abstract class CompletionImplBase implements io.grpc.BindableService {
    ...
    public void completeQuery(com.google.cloud.talent.v4.CompleteQueryRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.talent.v4.CompleteQueryResponse> responseObserver) {
  ...
  public static final class CompletionStub extends io.grpc.stub.AbstractAsyncStub<CompletionStub> {
    ...
    @java.lang.Override
    protected CompletionStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new CompletionStub(channel, callOptions);
    }
   ...
   * </pre>
   */
  public static final class CompletionBlockingStub extends io.grpc.stub.AbstractBlockingStub<CompletionBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.talent.v4.CompleteQueryResponse completeQuery(com.google.cloud.talent.v4.CompleteQueryRequest request) {
   ...
   * </pre>
   */
  public static final class CompletionFutureStub extends io.grpc.stub.AbstractFutureStub<CompletionFutureStub> {
    private CompletionFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected CompletionFutureStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new CompletionFutureStub(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.talent.v4.CompleteQueryResponse> completeQuery(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_COMPLETE_QUERY:
          serviceImpl.completeQuery((com.google.cloud.talent.v4.CompleteQueryRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.talent.v4.CompleteQueryResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CompletionBaseDescriptorSupplier
