 ...
 */
public final class JobQuery extends
...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.google.cloud.talent.v4.FiltersProto.internal_static_google_cloud_talent_v4_JobQuery_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.cloud.talent.v4.JobQuery.class, com.google.cloud.talent.v4.JobQuery.Builder.class);
  }
  ...
  public java.util.List<com.google.cloud.talent.v4.JobCategory> getJobCategoriesList() {
    return new com.google.protobuf.Internal.ListAdapter<
        java.lang.Integer, com.google.cloud.talent.v4.JobCategory>(jobCategories_, jobCategories_converter_);
  }
  /**
   * <pre>
   * The category filter specifies the categories of jobs to search against.
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < locationFilters_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(3, locationFilters_.get(i));
    }
    {
      int dataSize = 0;
      for (int i = 0; i < jobCategories_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream
          .computeEnumSizeNoTag(jobCategories_.get(i));
      }
      size += dataSize;
      if (!getJobCategoriesList().isEmpty()) {  size += 1;
        size += com.google.protobuf.CodedOutputStream
    ...
    if (commuteFilter_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(5, getCommuteFilter());
    }
    {
      int dataSize = 0;
      for (int i = 0; i < companyDisplayNames_.size(); i++) {
    ...
    if (disableSpellCheck_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(9, disableSpellCheck_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < employmentTypes_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream
          .computeEnumSizeNoTag(employmentTypes_.get(i));
      }
      size += dataSize;
      if (!getEmploymentTypesList().isEmpty()) {  size += 1;
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32SizeNoTag(dataSize);
    ...
    if (publishTimeRange_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(12, getPublishTimeRange());
    }
    {
      int dataSize = 0;
      for (int i = 0; i < excludedJobs_.size(); i++) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getQueryLanguageCode()
        .equals(other.getQueryLanguageCode())) return false;
    if (!getCompaniesList()
    ...
    if (hasCommuteFilter()) {
      if (!getCommuteFilter()
          .equals(other.getCommuteFilter())) return false;
    }
    if (!getCompanyDisplayNamesList()
        .equals(other.getCompanyDisplayNamesList())) return false;
    if (hasCompensationFilter() != other.hasCompensationFilter()) return false;
    if (hasCompensationFilter()) {
      if (!getCompensationFilter()
          .equals(other.getCompensationFilter())) return false;
    }
    ...
    if (hasPublishTimeRange()) {
      if (!getPublishTimeRange()
          .equals(other.getPublishTimeRange())) return false;
    }
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder setJobCategories(
        int index, com.google.cloud.talent.v4.JobCategory value) {
      if (value == null) {
        throw new NullPointerException();
      }
      ensureJobCategoriesIsMutable();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.talent.v4.CommuteFilter, com.google.cloud.talent.v4.CommuteFilter.Builder, com.google.cloud.talent.v4.CommuteFilterOrBuilder> commuteFilterBuilder_;
    /**
     * <pre>
     * Allows filtering jobs by commute time with different travel methods (for
     *  example, driving or public transit).
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder setEmploymentTypes(
        int index, com.google.cloud.talent.v4.EmploymentType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      ensureEmploymentTypesIsMutable();
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.cloud.talent.v4.TimestampRange publishTimeRange_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.talent.v4.TimestampRange, com.google.cloud.talent.v4.TimestampRange.Builder, com.google.cloud.talent.v4.TimestampRangeOrBuilder> publishTimeRangeBuilder_;
    /**
     * <pre>
     * Jobs published within a range specified by this filter are searched
     * against.
  ...
  private static final com.google.protobuf.Parser<JobQuery>
      PARSER = new com.google.protobuf.AbstractParser<JobQuery>() {
    @java.lang.Override
