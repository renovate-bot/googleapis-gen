...
class CompanyServiceTransport(abc.ABC):
    ...
    @property
    def create_company(self) -> typing.Callable[
            [company_service.CreateCompanyRequest],
            typing.Union[
                gct_company.Company,
                typing.Awaitable[gct_company.Company]
            ]]:
        raise NotImplementedError()

    @property
    def get_company(self) -> typing.Callable[
            [company_service.GetCompanyRequest],
            typing.Union[
                company.Company,
                typing.Awaitable[company.Company]
            ]]:
        raise NotImplementedError()

    @property
    def update_company(self) -> typing.Callable[
    ...
    @property
    def delete_company(self) -> typing.Callable[
    ...
    @property
    def list_companies(self) -> typing.Callable[
