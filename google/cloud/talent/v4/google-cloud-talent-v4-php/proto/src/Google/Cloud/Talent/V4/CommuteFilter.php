 ...
 *
 * Generated from protobuf message <code>google.cloud.talent.v4.CommuteFilter</code>
 */
class CommuteFilter extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.talent.v4.CommuteMethod commute_method = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Talent\V4\CommuteMethod::class);
     ...
     * Specifies the traffic density to use when calculating commute time.
     *
     * Generated from protobuf field <code>.google.cloud.talent.v4.CommuteFilter.RoadTraffic road_traffic = 5;</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Talent\V4\CommuteFilter\RoadTraffic::class);
