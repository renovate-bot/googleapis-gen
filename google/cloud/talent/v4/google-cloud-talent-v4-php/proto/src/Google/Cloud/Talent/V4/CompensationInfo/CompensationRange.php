 ...
 * Compensation range.
 *
 * Generated from protobuf message <code>google.cloud.talent.v4.CompensationInfo.CompensationRange</code>
 */
...
class_alias(CompensationRange::class, \Google\Cloud\Talent\V4\CompensationInfo_CompensationRange::class);
