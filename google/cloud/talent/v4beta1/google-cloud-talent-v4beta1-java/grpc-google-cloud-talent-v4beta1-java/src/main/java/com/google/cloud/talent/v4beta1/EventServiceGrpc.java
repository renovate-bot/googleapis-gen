...
public final class EventServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.talent.v4beta1.CreateClientEventRequest,
      com.google.cloud.talent.v4beta1.ClientEvent> getCreateClientEventMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.talent.v4beta1.CreateClientEventRequest,
      com.google.cloud.talent.v4beta1.ClientEvent> getCreateClientEventMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.talent.v4beta1.CreateClientEventRequest, com.google.cloud.talent.v4beta1.ClientEvent> getCreateClientEventMethod;
    if ((getCreateClientEventMethod = EventServiceGrpc.getCreateClientEventMethod) == null) {
      synchronized (EventServiceGrpc.class) {
        if ((getCreateClientEventMethod = EventServiceGrpc.getCreateClientEventMethod) == null) {
          EventServiceGrpc.getCreateClientEventMethod = getCreateClientEventMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.talent.v4beta1.CreateClientEventRequest, com.google.cloud.talent.v4beta1.ClientEvent>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateClientEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.talent.v4beta1.CreateClientEventRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.talent.v4beta1.ClientEvent.getDefaultInstance()))
              .setSchemaDescriptor(new EventServiceMethodDescriptorSupplier("CreateClientEvent"))
              .build();
        }
      }
    }
  ...
  public static abstract class EventServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void createClientEvent(com.google.cloud.talent.v4beta1.CreateClientEventRequest request,
  ...
  public static final class EventServiceStub extends io.grpc.stub.AbstractAsyncStub<EventServiceStub> {
    ...
    public void createClientEvent(com.google.cloud.talent.v4beta1.CreateClientEventRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.talent.v4beta1.ClientEvent> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getCreateClientEventMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class EventServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EventServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.talent.v4beta1.ClientEvent createClientEvent(com.google.cloud.talent.v4beta1.CreateClientEventRequest request) {
  ...
  public static final class EventServiceFutureStub extends io.grpc.stub.AbstractFutureStub<EventServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.talent.v4beta1.ClientEvent> createClientEvent(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_CLIENT_EVENT:
          serviceImpl.createClientEvent((com.google.cloud.talent.v4beta1.CreateClientEventRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.talent.v4beta1.ClientEvent>) responseObserver);
          break;
        default:
