...
/**
 * Settings class to configure an instance of {@link EventServiceStub}.
 *
...
public class EventServiceStubSettings extends StubSettings<EventServiceStubSettings> {
  ...
  private final UnaryCallSettings<CreateClientEventRequest, ClientEvent> createClientEventSettings;
  ...
  public EventServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcEventServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(EventServiceStubSettings.class))
        .setTransportToken(
  ...
  protected EventServiceStubSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);

    createClientEventSettings = settingsBuilder.createClientEventSettings().build();
  }

  /** Builder for EventServiceStubSettings. */
  public static class Builder extends StubSettings.Builder<EventServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<CreateClientEventRequest, ClientEvent>
        createClientEventSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      createClientEventSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(createClientEventSettings);
      initDefaults(this);
    }

    protected Builder(EventServiceStubSettings settings) {
      super(settings);

      createClientEventSettings = settings.createClientEventSettings.toBuilder();
