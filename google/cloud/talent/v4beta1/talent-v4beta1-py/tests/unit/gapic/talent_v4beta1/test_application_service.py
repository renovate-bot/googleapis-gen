...
from google.cloud.talent_v4beta1.services.application_service import ApplicationServiceAsyncClient
...
def test_application_service_client_from_service_account_info():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        info = {"valid": True}
        client = ApplicationServiceClient.from_service_account_info(info)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ApplicationServiceAsyncClient, transports.ApplicationServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_application_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_application_service_client_client_options_from_dict():
    with mock.patch('google.cloud.talent_v4beta1.services.application_service.transports.ApplicationServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_application(transport: str = 'grpc', request_type=application_service.CreateApplicationRequest):
    client = ApplicationServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_application(transport: str = 'grpc', request_type=application_service.GetApplicationRequest):
    client = ApplicationServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_application(transport: str = 'grpc', request_type=application_service.UpdateApplicationRequest):
    client = ApplicationServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_application_field_headers():
    ...
    assert (
        'x-goog-request-params',
        'application.name=application.name/value',
    ) in kw['metadata']
...
def test_delete_application(transport: str = 'grpc', request_type=application_service.DeleteApplicationRequest):
    client = ApplicationServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_applications(transport: str = 'grpc', request_type=application_service.ListApplicationsRequest):
    client = ApplicationServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_application_service_base_transport():
    ...
    with mock.patch('google.cloud.talent_v4beta1.services.application_service.transports.ApplicationServiceTransport.__init__') as Transport:
...
@pytest.mark.parametrize("transport_class", [transports.ApplicationServiceGrpcTransport, transports.ApplicationServiceGrpcAsyncIOTransport])
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ApplicationServiceGrpcTransport, transports.ApplicationServiceGrpcAsyncIOTransport])
def test_application_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
