...
from google.cloud.talent_v4beta1.services.job_service.transports.base import _API_CORE_VERSION
from google.cloud.talent_v4beta1.services.job_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_batch_create_jobs(transport: str = 'grpc', request_type=job_service.BatchCreateJobsRequest):
    client = JobServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_create_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_batch_update_jobs(transport: str = 'grpc', request_type=job_service.BatchUpdateJobsRequest):
    client = JobServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_update_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_batch_delete_jobs(transport: str = 'grpc', request_type=job_service.BatchDeleteJobsRequest):
    client = JobServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_delete_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_search_jobs(transport: str = 'grpc', request_type=job_service.SearchJobsRequest):
    client = JobServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_search_jobs_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, job_service.SearchJobsResponse.MatchingJob)
                   for i in results)
...
def test_search_jobs_for_alert(transport: str = 'grpc', request_type=job_service.SearchJobsRequest):
    client = JobServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_job_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.talent_v4beta1.services.job_service.transports.JobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_job_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.talent_v4beta1.services.job_service.transports.JobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.JobServiceTransport()
        adc.assert_called_once()
