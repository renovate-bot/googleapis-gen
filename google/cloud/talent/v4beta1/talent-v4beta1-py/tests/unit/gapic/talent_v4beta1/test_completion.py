...
from google.cloud.talent_v4beta1.services.completion.transports.base import _API_CORE_VERSION
from google.cloud.talent_v4beta1.services.completion.transports.base import _GOOGLE_AUTH_VERSION
...
def test_completion_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.talent_v4beta1.services.completion.transports.CompletionTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_completion_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.talent_v4beta1.services.completion.transports.CompletionTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.CompletionTransport()
        adc.assert_called_once()
