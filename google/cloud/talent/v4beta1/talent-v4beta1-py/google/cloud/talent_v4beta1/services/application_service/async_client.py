...
class ApplicationServiceAsyncClient:
    ...
    parse_application_path = staticmethod(ApplicationServiceClient.parse_application_path)
    ...
    from_service_account_info = ApplicationServiceClient.from_service_account_info
    ...
    get_transport_class = functools.partial(type(ApplicationServiceClient).get_transport_class, type(ApplicationServiceClient))
