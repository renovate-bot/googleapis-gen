...
class TenantServiceTransport(abc.ABC):
    ...
    @property
    def create_tenant(self) -> typing.Callable[
            [tenant_service.CreateTenantRequest],
            typing.Union[
                gct_tenant.Tenant,
                typing.Awaitable[gct_tenant.Tenant]
            ]]:
        raise NotImplementedError()

    @property
    def get_tenant(self) -> typing.Callable[
            [tenant_service.GetTenantRequest],
            typing.Union[
                tenant.Tenant,
                typing.Awaitable[tenant.Tenant]
            ]]:
        raise NotImplementedError()

    @property
    def update_tenant(self) -> typing.Callable[
    ...
    @property
    def delete_tenant(self) -> typing.Callable[
    ...
    @property
    def list_tenants(self) -> typing.Callable[
