...
class ProfileServiceTransport(abc.ABC):
    ...
    @property
    def list_profiles(self) -> typing.Callable[
    ...
    @property
    def create_profile(self) -> typing.Callable[
            [profile_service.CreateProfileRequest],
            typing.Union[
                gct_profile.Profile,
                typing.Awaitable[gct_profile.Profile]
            ]]:
        raise NotImplementedError()

    @property
    def get_profile(self) -> typing.Callable[
            [profile_service.GetProfileRequest],
            typing.Union[
                profile.Profile,
                typing.Awaitable[profile.Profile]
            ]]:
        raise NotImplementedError()

    @property
    def update_profile(self) -> typing.Callable[
    ...
    @property
    def delete_profile(self) -> typing.Callable[
    ...
    @property
    def search_profiles(self) -> typing.Callable[
