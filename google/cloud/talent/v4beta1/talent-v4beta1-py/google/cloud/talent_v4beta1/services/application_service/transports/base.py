...
class ApplicationServiceTransport(abc.ABC):
    ...
    @property
    def create_application(self) -> typing.Callable[
            [application_service.CreateApplicationRequest],
            typing.Union[
                gct_application.Application,
                typing.Awaitable[gct_application.Application]
            ]]:
        raise NotImplementedError()

    @property
    def get_application(self) -> typing.Callable[
            [application_service.GetApplicationRequest],
            typing.Union[
                application.Application,
                typing.Awaitable[application.Application]
            ]]:
        raise NotImplementedError()

    @property
    def update_application(self) -> typing.Callable[
    ...
    @property
    def delete_application(self) -> typing.Callable[
    ...
    @property
    def list_applications(self) -> typing.Callable[
