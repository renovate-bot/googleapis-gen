...
import * as partitionassignmentserviceModule from '../src';
...
describe('v1.PartitionAssignmentServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = partitionassignmentserviceModule.v1.PartitionAssignmentServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = partitionassignmentserviceModule.v1.PartitionAssignmentServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = partitionassignmentserviceModule.v1.PartitionAssignmentServiceClient.port;
        assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert(client.partitionAssignmentServiceStub);
    });
    ...
    describe('assignPartitions', () => {
        it('invokes assignPartitions without error', async () => {
            ...
            client.innerApiCalls.assignPartitions = stubBidiStreamingCall(expectedResponse);
            const stream = client.assignPartitions();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.pubsublite.v1.PartitionAssignment) => {
                    resolve(response);
                });
            ...
            assert((client.innerApiCalls.assignPartitions as SinonStub)
