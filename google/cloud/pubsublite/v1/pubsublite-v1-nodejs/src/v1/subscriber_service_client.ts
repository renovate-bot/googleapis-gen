 ...
 * `src/v1/subscriber_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './subscriber_service_client_config.json';
 ...
 * @memberof v1
 */
export class SubscriberServiceClient {
  ...
  subscriberServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of SubscriberServiceClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof SubscriberServiceClient;
    ...
    this.descriptors.stream = {
      subscribe: new this._gaxModule.StreamDescriptor(gax.StreamType.BIDI_STREAMING)
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.pubsublite.v1.SubscriberService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.subscriberServiceStub) {
      return this.subscriberServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.pubsublite.v1.SubscriberService.
    this.subscriberServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.pubsublite.v1.SubscriberService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.pubsublite.v1.SubscriberService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const subscriberServiceStubMethods =
        ['subscribe'];
    for (const methodName of subscriberServiceStubMethods) {
      const callPromise = this.subscriberServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   representing [SubscribeRequest]{@link google.cloud.pubsublite.v1.SubscribeRequest} for write() method, and
 *   will emit objects representing [SubscribeResponse]{@link google.cloud.pubsublite.v1.SubscribeResponse} on 'data' event asynchronously.
 *   Please see the
 ...
 */
  subscribe(
    ...
    this.initialize();
    return this.innerApiCalls.subscribe(options);
  }
  ...
  close(): Promise<void> {
    this.initialize();
    if (!this._terminated) {
      return this.subscriberServiceStub!.then(stub => {
