...
/**
 * Settings class to configure an instance of {@link PublisherServiceStub}.
 *
...
public class PublisherServiceStubSettings extends StubSettings<PublisherServiceStubSettings> {
  ...
  private final StreamingCallSettings<PublishRequest, PublishResponse> publishSettings;
  ...
  public PublisherServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcPublisherServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(PublisherServiceStubSettings.class))
        .setTransportToken(
  ...
  protected PublisherServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<PublisherServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final StreamingCallSettings.Builder<PublishRequest, PublishResponse> publishSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      publishSettings = StreamingCallSettings.newBuilder();

      unaryMethodSettingsBuilders = ImmutableList.<UnaryCallSettings.Builder<?, ?>>of();
      initDefaults(this);
    }

    protected Builder(PublisherServiceStubSettings settings) {
      super(settings);
