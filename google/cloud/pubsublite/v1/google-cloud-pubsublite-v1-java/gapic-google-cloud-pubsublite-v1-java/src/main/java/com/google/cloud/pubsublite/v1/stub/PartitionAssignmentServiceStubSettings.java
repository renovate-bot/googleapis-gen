...
/**
 * Settings class to configure an instance of {@link PartitionAssignmentServiceStub}.
 *
...
public class PartitionAssignmentServiceStubSettings
  ...
  private final StreamingCallSettings<PartitionAssignmentRequest, PartitionAssignment>
      assignPartitionsSettings;
  ...
  public PartitionAssignmentServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcPartitionAssignmentServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(PartitionAssignmentServiceStubSettings.class))
        .setTransportToken(
  ...
  protected PartitionAssignmentServiceStubSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);

    assignPartitionsSettings = settingsBuilder.assignPartitionsSettings().build();
  }

  /** Builder for PartitionAssignmentServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<PartitionAssignmentServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final StreamingCallSettings.Builder<PartitionAssignmentRequest, PartitionAssignment>
        assignPartitionsSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      assignPartitionsSettings = StreamingCallSettings.newBuilder();

      unaryMethodSettingsBuilders = ImmutableList.<UnaryCallSettings.Builder<?, ?>>of();
      initDefaults(this);
    }

    protected Builder(PartitionAssignmentServiceStubSettings settings) {
      super(settings);

      assignPartitionsSettings = settings.assignPartitionsSettings.toBuilder();
