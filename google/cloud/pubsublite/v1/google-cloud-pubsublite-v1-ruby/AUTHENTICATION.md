...
```sh
export PUBSUBLITE_CREDENTIALS=path/to/keyfile.json
```
...
1. `PUBSUBLITE_CREDENTIALS` - Path to JSON file, or JSON contents
2. `PUBSUBLITE_KEYFILE` - Path to JSON file, or JSON contents
...
ENV["PUBSUBLITE_CREDENTIALS"] = "path/to/keyfile.json"
