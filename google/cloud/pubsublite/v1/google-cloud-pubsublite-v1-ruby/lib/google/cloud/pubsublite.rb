...
module Google
  module Cloud
    ...
    module Pubsublite
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("pubsublite"))
      ...
      module Admin
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Pubsublite
            .constants
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Pubsublite.const_get(version_module)::Admin.new(*args, **kwargs)
        end
      end
      ...
      module Cursor
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Pubsublite
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Pubsublite.const_get(version_module)::Cursor.new(*args, **kwargs)
        end
      end
      ...
      module Publisher
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Pubsublite
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Pubsublite.const_get(version_module)::Publisher.new(*args, **kwargs)
        end
      end
      ...
      module Subscriber
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Pubsublite
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Pubsublite.const_get(version_module)::Subscriber.new(*args, **kwargs)
        end
      end

      module PartitionAssignment
        ##
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Pubsublite
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Pubsublite.const_get(version_module)::PartitionAssignment.new(*args, **kwargs)
        end
      end
      ...
      module TopicStats
        ...
        def self.new(*args, version: :v1, **kwargs)
          ...
          version_module = Google::Cloud::Pubsublite
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Pubsublite.const_get(version_module)::TopicStats.new(*args, **kwargs)
        end
      end
    end
  end
