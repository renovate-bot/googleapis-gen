...
# https://github.com/googleapis/googleapis/blob/master/google/cloud/pubsublite/v1/publisher.proto,
  ...
  module Cloud
    module Pubsublite
      module V1
        ...
        #
        # @!attribute [r] publisher_service_stub
        #   @return [Google::Cloud::Pubsublite::V1::PublisherService::Stub]
        class PublisherServiceClient
          attr_reader :publisher_service_stub
          ...
          def initialize \
            ...
            require "google/cloud/pubsublite/v1/publisher_services_pb"
            ...
            client_config_file = Pathname.new(__dir__).join(
              "publisher_service_client_config.json"
            )
            ...
            @publisher_service_stub = Google::Gax::Grpc.create_stub(
              service_path,
              port,
              ...
              &Google::Cloud::Pubsublite::V1::PublisherService::Stub.method(:new)
            )

            @publish = Google::Gax.create_api_call(
              @publisher_service_stub.method(:publish),
              defaults["publish"],
          ...
          #
          # @param reqs [Enumerable<Google::Cloud::Pubsublite::V1::PublishRequest>]
          #   The input requests.
          # @param options [Google::Gax::CallOptions]
          #   Overrides the default settings for this call, e.g, timeout,
          #   retries, etc.
          # @return [Enumerable<Google::Cloud::Pubsublite::V1::PublishResponse>]
          #   An enumerable of Google::Cloud::Pubsublite::V1::PublishResponse instances.
          #
          ...
          #
          #   publisher_client = Google::Cloud::Pubsublite::Publisher.new(version: :v1)
          #   request = {}
          #   requests = [request]
          #   publisher_client.publish(requests).each do |element|
          #     # Process element.
          #   end

          def publish reqs, options: nil
            request_protos = reqs.lazy.map do |req|
              Google::Gax::to_proto(req, Google::Cloud::Pubsublite::V1::PublishRequest)
            end
            @publish.call(request_protos, options)
          end
        end
      end
    end
