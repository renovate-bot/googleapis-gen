...
class ::Google::Cloud::PubSubLite::V1::AdminService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::PubSubLite::V1::AdminService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::PubSubLite::V1::AdminService::Operations::Configuration, config
  end
end
