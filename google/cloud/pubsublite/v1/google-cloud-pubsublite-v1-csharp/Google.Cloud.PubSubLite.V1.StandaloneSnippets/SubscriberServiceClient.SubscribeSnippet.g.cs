...
namespace Google.Cloud.PubSubLite.V1.Snippets
{
    ...
    public sealed partial class GeneratedSubscriberServiceClientStandaloneSnippets
    {
        ...
        public async Task Subscribe()
        {
            ...
            SubscriberServiceClient.SubscribeStream response = subscriberServiceClient.Subscribe();
            ...
            Task responseHandlerTask = Task.Run(async () =>
            {
                ...
                AsyncResponseStream<SubscribeResponse> responseStream = response.GetResponseStream();
                while (await responseStream.MoveNextAsync())
                {
                    SubscribeResponse responseItem = responseStream.Current;
