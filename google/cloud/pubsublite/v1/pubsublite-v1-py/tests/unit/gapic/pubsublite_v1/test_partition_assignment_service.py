...
def test__get_default_mtls_endpoint():
    ...
    assert PartitionAssignmentServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert PartitionAssignmentServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert PartitionAssignmentServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert PartitionAssignmentServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert PartitionAssignmentServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (PartitionAssignmentServiceClient, transports.PartitionAssignmentServiceGrpcTransport, "grpc"),
    (PartitionAssignmentServiceAsyncClient, transports.PartitionAssignmentServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_partition_assignment_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(PartitionAssignmentServiceClient, 'get_transport_class') as gtc:
...
def test_partition_assignment_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_partition_assignment_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_partition_assignment_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_partition_assignment_service_client_client_options_from_dict():
    with mock.patch('google.cloud.pubsublite_v1.services.partition_assignment_service.transports.PartitionAssignmentServiceGrpcTransport.__init__') as grpc_transport:
...
def test_assign_partitions(transport: str = 'grpc', request_type=subscriber.PartitionAssignmentRequest):
    client = PartitionAssignmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.assign_partitions),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_assign_partitions_async(transport: str = 'grpc_asyncio', request_type=subscriber.PartitionAssignmentRequest):
...
def test_partition_assignment_service_base_transport():
    ...
    with mock.patch('google.cloud.pubsublite_v1.services.partition_assignment_service.transports.PartitionAssignmentServiceTransport.__init__') as Transport:
...
def test_partition_assignment_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.pubsublite_v1.services.partition_assignment_service.transports.PartitionAssignmentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_partition_assignment_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.pubsublite_v1.services.partition_assignment_service.transports.PartitionAssignmentServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PartitionAssignmentServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.PartitionAssignmentServiceGrpcTransport, transports.PartitionAssignmentServiceGrpcAsyncIOTransport])
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.PartitionAssignmentServiceGrpcTransport, transports.PartitionAssignmentServiceGrpcAsyncIOTransport])
def test_partition_assignment_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.PartitionAssignmentServiceTransport, '_prep_wrapped_messages') as prep:
        client = PartitionAssignmentServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
