...
from google.cloud.pubsublite_v1.services.topic_stats_service.transports.base import _API_CORE_VERSION
from google.cloud.pubsublite_v1.services.topic_stats_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_topic_stats_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_compute_message_stats(transport: str = 'grpc', request_type=topic_stats.ComputeMessageStatsRequest):
    client = TopicStatsServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_compute_head_cursor(transport: str = 'grpc', request_type=topic_stats.ComputeHeadCursorRequest):
    client = TopicStatsServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_compute_time_cursor(transport: str = 'grpc', request_type=topic_stats.ComputeTimeCursorRequest):
    client = TopicStatsServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_topic_stats_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.pubsublite_v1.services.topic_stats_service.transports.TopicStatsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_topic_stats_service_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.pubsublite_v1.services.topic_stats_service.transports.TopicStatsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_topic_stats_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.pubsublite_v1.services.topic_stats_service.transports.TopicStatsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.TopicStatsServiceTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_topic_stats_service_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        TopicStatsServiceClient()
...
@requires_google_auth_lt_1_25_0
def test_topic_stats_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
...
def test_topic_stats_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_topic_stats_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
