...
class PartitionAssignmentServiceGrpcAsyncIOTransport(PartitionAssignmentServiceTransport):
    """gRPC AsyncIO backend transport for PartitionAssignmentService.
...
__all__ = (
    'PartitionAssignmentServiceGrpcAsyncIOTransport',
)
