...
class CursorServiceAsyncClient:
    ...
    from_service_account_info = CursorServiceClient.from_service_account_info
    ...
    get_transport_class = functools.partial(type(CursorServiceClient).get_transport_class, type(CursorServiceClient))
    ...
    async def list_partition_cursors(self,
