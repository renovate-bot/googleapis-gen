...
class SubscriberServiceClient(metaclass=SubscriberServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, SubscriberServiceTransport):
            # transport is a SubscriberServiceTransport instance.
    ...
    def subscribe(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.subscribe]
