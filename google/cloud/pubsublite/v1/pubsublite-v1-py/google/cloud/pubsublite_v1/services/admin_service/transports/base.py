...
class AdminServiceTransport(abc.ABC):
    ...
    @property
    def get_topic_partitions(self) -> typing.Callable[
            [admin.GetTopicPartitionsRequest],
            typing.Union[
                admin.TopicPartitions,
                typing.Awaitable[admin.TopicPartitions]
            ]]:
        raise NotImplementedError()
    ...
    def list_topics(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[admin.ListTopicsResponse]
            ]]:
        raise NotImplementedError()
    ...
    def create_subscription(self) -> typing.Callable[
            ...
            typing.Union[
                common.Subscription,
                typing.Awaitable[common.Subscription]
            ]]:
        raise NotImplementedError()
