...
class PartitionAssignmentServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(PartitionAssignmentServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(PartitionAssignmentServiceClient.parse_common_billing_account_path)

    common_folder_path = staticmethod(PartitionAssignmentServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(PartitionAssignmentServiceClient.parse_common_folder_path)

    common_organization_path = staticmethod(PartitionAssignmentServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(PartitionAssignmentServiceClient.parse_common_organization_path)

    common_project_path = staticmethod(PartitionAssignmentServiceClient.common_project_path)
    parse_common_project_path = staticmethod(PartitionAssignmentServiceClient.parse_common_project_path)

    common_location_path = staticmethod(PartitionAssignmentServiceClient.common_location_path)
    parse_common_location_path = staticmethod(PartitionAssignmentServiceClient.parse_common_location_path)

    from_service_account_info = PartitionAssignmentServiceClient.from_service_account_info
    from_service_account_file = PartitionAssignmentServiceClient.from_service_account_file
    ...
    get_transport_class = functools.partial(type(PartitionAssignmentServiceClient).get_transport_class, type(PartitionAssignmentServiceClient))
