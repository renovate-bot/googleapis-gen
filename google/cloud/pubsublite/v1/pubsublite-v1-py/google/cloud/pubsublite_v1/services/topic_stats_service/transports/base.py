...
class TopicStatsServiceTransport(abc.ABC):
    ...
    @property
    def compute_message_stats(self) -> typing.Callable[
    ...
    @property
    def compute_head_cursor(self) -> typing.Callable[
    ...
    @property
    def compute_time_cursor(self) -> typing.Callable[
            [topic_stats.ComputeTimeCursorRequest],
            typing.Union[
                topic_stats.ComputeTimeCursorResponse,
                typing.Awaitable[topic_stats.ComputeTimeCursorResponse]
            ]]:
        raise NotImplementedError()
