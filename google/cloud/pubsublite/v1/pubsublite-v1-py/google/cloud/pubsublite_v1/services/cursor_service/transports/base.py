...
class CursorServiceTransport(abc.ABC):
    ...
    @property
    def streaming_commit_cursor(self) -> typing.Callable[
    ...
    @property
    def commit_cursor(self) -> typing.Callable[
            [cursor.CommitCursorRequest],
            typing.Union[
                cursor.CommitCursorResponse,
                typing.Awaitable[cursor.CommitCursorResponse]
            ]]:
        raise NotImplementedError()

    @property
    def list_partition_cursors(self) -> typing.Callable[
