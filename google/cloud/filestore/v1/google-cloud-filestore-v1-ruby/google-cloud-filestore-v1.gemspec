...
Gem::Specification.new do |gem|
  ...
  gem.description   = "google-cloud-filestore-v1 is the official client library for the Google Cloud Filestore V1 API. Note that google-cloud-filestore-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-filestore instead. See the readme for more details."
  gem.summary       = "API Client library for the Google Cloud Filestore V1 API"
