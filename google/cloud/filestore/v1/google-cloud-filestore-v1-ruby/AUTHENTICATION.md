...
```sh
export FILESTORE_CREDENTIALS=path/to/keyfile.json
```
...
1. `FILESTORE_CREDENTIALS` - Path to JSON file, or JSON contents
2. `FILESTORE_KEYFILE` - Path to JSON file, or JSON contents
...
ENV["FILESTORE_CREDENTIALS"] = "path/to/keyfile.json"
