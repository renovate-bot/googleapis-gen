 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/filestore/v1/cloud_filestore_service.proto
...
class CloudFilestoreManagerGapicClient
{
     ...
     */
    public function createBackup($parent, $backup, $backupId, array $optionalArgs = [])
    {
     ...
     *                             `projects/{project_number}/locations/{location_id}/instances/{instance_id}`.
     * @param string $fileShare    Required. Name of the file share in the Cloud Filestore instance that the backup
    ...
    public function restoreInstance($name, $fileShare, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('RestoreInstance', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function updateBackup($backup, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateBackup', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
