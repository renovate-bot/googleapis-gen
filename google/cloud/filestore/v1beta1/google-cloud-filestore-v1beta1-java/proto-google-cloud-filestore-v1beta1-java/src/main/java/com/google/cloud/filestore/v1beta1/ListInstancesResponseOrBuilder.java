...
public interface ListInstancesResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.filestore.v1beta1.ListInstancesResponse)
   ...
   */
  java.util.List<com.google.cloud.filestore.v1beta1.Instance> 
      getInstancesList();
  /**
   * <pre>
   * A list of instances in the project for the specified location.
