 ...
 * The squash mode.
 *
 * Protobuf type <code>google.cloud.filestore.v1beta1.NfsExportOptions.SquashMode</code>
 */
class SquashMode
{
    /**
...
class_alias(SquashMode::class, \Google\Cloud\Filestore\V1beta1\NfsExportOptions_SquashMode::class);
