...
namespace Google\Cloud\Filestore\V1beta1\Backup;
 ...
 * The backup state.
 *
 * Protobuf type <code>google.cloud.filestore.v1beta1.Backup.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Filestore\V1beta1\Backup_State::class);
