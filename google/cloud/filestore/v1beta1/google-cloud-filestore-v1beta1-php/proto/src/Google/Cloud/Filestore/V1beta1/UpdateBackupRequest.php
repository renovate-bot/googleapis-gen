 ...
 *
 * Generated from protobuf message <code>google.cloud.filestore.v1beta1.UpdateBackupRequest</code>
 */
class UpdateBackupRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Filestore\V1beta1\Backup::class);
        $this->backup = $var;
