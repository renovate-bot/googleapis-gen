 ...
 *
 * Generated from protobuf message <code>google.cloud.filestore.v1beta1.Backup</code>
 */
class Backup extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.filestore.v1beta1.Backup.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     * is created from.
     *
     * Generated from protobuf field <code>.google.cloud.filestore.v1beta1.Instance.Tier source_instance_tier = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Filestore\V1beta1\Backup\State::class);
        $this->state = $var;
