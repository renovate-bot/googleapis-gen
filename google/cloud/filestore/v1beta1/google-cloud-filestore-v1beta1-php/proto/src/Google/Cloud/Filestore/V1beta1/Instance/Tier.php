...
namespace Google\Cloud\Filestore\V1beta1\Instance;
 ...
 *
 * Protobuf type <code>google.cloud.filestore.v1beta1.Instance.Tier</code>
 */
class Tier
{
    /**
     ...
     * capabilities.
     *
     * Generated from protobuf enum <code>HIGH_SCALE_SSD = 6;</code>
     */
    const HIGH_SCALE_SSD = 6;
...
class_alias(Tier::class, \Google\Cloud\Filestore\V1beta1\Instance_Tier::class);
