...
namespace Google\Cloud\Filestore\V1beta1\NetworkConfig;
 ...
 *
 * Protobuf type <code>google.cloud.filestore.v1beta1.NetworkConfig.AddressMode</code>
 */
class AddressMode
{
    /**
...
class_alias(AddressMode::class, \Google\Cloud\Filestore\V1beta1\NetworkConfig_AddressMode::class);
