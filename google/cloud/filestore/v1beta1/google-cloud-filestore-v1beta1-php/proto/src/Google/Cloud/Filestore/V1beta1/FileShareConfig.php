 ...
 *
 * Generated from protobuf message <code>google.cloud.filestore.v1beta1.FileShareConfig</code>
 */
class FileShareConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.filestore.v1beta1.NfsExportOptions nfs_export_options = 8;</code>
     */
     ...
     *     @type \Google\Cloud\Filestore\V1beta1\NfsExportOptions[]|\Google\Protobuf\Internal\RepeatedField $nfs_export_options
     *           Nfs Export Options.
     *           There is a limit of 10 export options per file share.
     * }
     */
     ...
     * this file share has been restored from.
     *
     * Generated from protobuf field <code>string source_backup = 9 [(.google.api.resource_reference) = {</code>
     * @return string
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.filestore.v1beta1.NfsExportOptions nfs_export_options = 8;</code>
     * @param \Google\Cloud\Filestore\V1beta1\NfsExportOptions[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setNfsExportOptions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Filestore\V1beta1\NfsExportOptions::class);
