...
return [
    'interfaces' => [
        'google.cloud.filestore.v1beta1.CloudFilestoreManager' => [
            'CreateBackup' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta1/{parent=projects/*/locations/*}/backups',
                'body' => 'backup',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteBackup' => [
                'method' => 'delete',
                'uriTemplate' => '/v1beta1/{name=projects/*/locations/*/backups/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'RestoreInstance' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta1/{name=projects/*/locations/*/instances/*}:restore',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'UpdateBackup' => [
                'method' => 'patch',
                'uriTemplate' => '/v1beta1/{backup.name=projects/*/locations/*/backups/*}',
                'body' => 'backup',
                'placeholders' => [
                    'backup.name' => [
                        'getters' => [
