...
namespace Google\Cloud\Filestore\V1beta1\Gapic;
...
use Google\Cloud\Filestore\V1beta1\CreateBackupRequest;
use Google\Cloud\Filestore\V1beta1\CreateInstanceRequest;
use Google\Cloud\Filestore\V1beta1\DeleteBackupRequest;
use Google\Cloud\Filestore\V1beta1\DeleteInstanceRequest;
use Google\Cloud\Filestore\V1beta1\GetBackupRequest;
use Google\Cloud\Filestore\V1beta1\GetInstanceRequest;
use Google\Cloud\Filestore\V1beta1\Instance;
use Google\Cloud\Filestore\V1beta1\ListBackupsRequest;
use Google\Cloud\Filestore\V1beta1\ListBackupsResponse;
use Google\Cloud\Filestore\V1beta1\ListInstancesRequest;
use Google\Cloud\Filestore\V1beta1\ListInstancesResponse;
use Google\Cloud\Filestore\V1beta1\RestoreInstanceRequest;
use Google\Cloud\Filestore\V1beta1\UpdateBackupRequest;
use Google\Cloud\Filestore\V1beta1\UpdateInstanceRequest;
...
class CloudFilestoreManagerGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.filestore.v1beta1.CloudFilestoreManager';
    ...
    private static function getSnapshotNameTemplate()
    {
        if (self::$snapshotNameTemplate == null) {
            self::$snapshotNameTemplate = new PathTemplate('projects/{project}/locations/{location}/snapshots/{snapshot}');
        }
     ...
     * @experimental
     */
    public static function snapshotName($project, $location, $snapshot)
    {
     ...
     * - snapshot: projects/{project}/locations/{location}/snapshots/{snapshot}
     *
     ...
     *     $updateMask = new FieldMask();
     *     $instance = new Instance();
     *     $operationResponse = $cloudFilestoreManagerClient->updateInstance($updateMask, $instance);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *     // doSomethingWith($result)
     ...
     *                                * "file_shares"
     *                                * "labels"
     * @param Instance  $instance     Required. Only fields specified in update_mask are updated.
     * @param array     $optionalArgs {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
