...
namespace Google\Cloud\Filestore\Tests\Unit\V1beta1;
...
use Google\Cloud\Filestore\V1beta1\Backup;
use Google\Cloud\Filestore\V1beta1\CloudFilestoreManagerClient;

use Google\Cloud\Filestore\V1beta1\Instance;
use Google\Cloud\Filestore\V1beta1\ListBackupsResponse;
use Google\Cloud\Filestore\V1beta1\ListInstancesResponse;
...
class CloudFilestoreManagerClientTest extends GeneratedTest
{
    ...
    public function createBackupTest()
    {
        ...
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/CreateBackup', $actualApiFuncCall);
    ...
    public function createInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/CreateInstance', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function deleteBackupTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/DeleteBackup', $actualApiFuncCall);
    ...
    public function deleteInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/DeleteInstance', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getBackupTest()
    {
        ...
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/GetBackup', $actualFuncCall);
    ...
    public function getInstanceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/GetInstance', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBackupsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/ListBackups', $actualFuncCall);
    ...
    public function listInstancesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/ListInstances', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function restoreInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/RestoreInstance', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
    ...
    public function updateBackupTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/UpdateBackup', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getBackup();
        $this->assertProtobufEquals($backup, $actualValue);
    ...
    public function updateInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.filestore.v1beta1.CloudFilestoreManager/UpdateInstance', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getUpdateMask();
        $this->assertProtobufEquals($updateMask, $actualValue);
        $actualValue = $actualApiRequestObject->getInstance();
        $this->assertProtobufEquals($instance, $actualValue);
