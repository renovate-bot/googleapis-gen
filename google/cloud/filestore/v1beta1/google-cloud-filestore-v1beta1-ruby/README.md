...
```
$ gem install google-cloud-filestore-v1beta1
```
...
request = ::Google::Cloud::Filestore::V1beta1::ListInstancesRequest.new # (request fields as keyword arguments...)
...
is part of the name, e.g. `google-cloud-filestore-v1beta1`.
