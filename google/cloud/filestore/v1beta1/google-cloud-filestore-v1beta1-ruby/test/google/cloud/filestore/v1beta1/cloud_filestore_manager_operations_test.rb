...
require "google/cloud/filestore/v1beta1/cloud_filestore_service_services_pb"
require "google/cloud/filestore/v1beta1/cloud_filestore_manager"

class ::Google::Cloud::Filestore::V1beta1::CloudFilestoreManager::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Filestore::V1beta1::CloudFilestoreManager::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Filestore::V1beta1::CloudFilestoreManager::Operations::Configuration, config
  end
end
