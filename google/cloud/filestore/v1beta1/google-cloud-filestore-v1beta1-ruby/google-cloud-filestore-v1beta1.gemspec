...
require File.expand_path("lib/google/cloud/filestore/v1beta1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-filestore-v1beta1"
  gem.version       = Google::Cloud::Filestore::V1beta1::VERSION
