...
using gcfv = Google.Cloud.Filestore.V1Beta1;
using sys = System;
...
namespace Google.Cloud.Filestore.V1Beta1
{
    ...
    public sealed partial class SnapshotName : gax::IResourceName, sys::IEquatable<SnapshotName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/snapshots/{snapshot}</c>.
            /// </summary>
            ProjectLocationSnapshot = 1,
        }

        private static gax::PathTemplate s_projectLocationSnapshot = new gax::PathTemplate("projects/{project}/locations/{location}/snapshots/{snapshot}");
        ...
        /// <c>projects/{project}/locations/{location}/snapshots/{snapshot}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        ...
        public static SnapshotName FromProjectLocationSnapshot(string projectId, string locationId, string snapshotId) =>
            new SnapshotName(ResourceNameType.ProjectLocationSnapshot, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), snapshotId: gax::GaxPreconditions.CheckNotNullOrEmpty(snapshotId, nameof(snapshotId)));
        ...
        /// <c>projects/{project}/locations/{location}/snapshots/{snapshot}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string snapshotId) =>
            FormatProjectLocationSnapshot(projectId, locationId, snapshotId);
        ...
        /// <c>projects/{project}/locations/{location}/snapshots/{snapshot}</c>.
        /// </returns>
        public static string FormatProjectLocationSnapshot(string projectId, string locationId, string snapshotId) =>
            s_projectLocationSnapshot.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(snapshotId, nameof(snapshotId)));

        /// <summary>Parses the given resource name string into a new <see cref="SnapshotName"/> instance.</summary>
        /// <remarks>
        /// To parse successfully, the resource name must be formatted as one of the following:
        /// <list type="bullet">
        /// <item><description><c>projects/{project}/locations/{location}/snapshots/{snapshot}</c></description></item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string snapshotName, bool allowUnparsed, out SnapshotName result)
        {
            ...
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationSnapshot.TryParseName(snapshotName, out resourceName))
            {
                result = FromProjectLocationSnapshot(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private SnapshotName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string locationId = null, string projectId = null, string snapshotId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            LocationId = locationId;
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="snapshotId">The <c>Snapshot</c> ID. Must not be <c>null</c> or empty.</param>
        public SnapshotName(string projectId, string locationId, string snapshotId) : this(ResourceNameType.ProjectLocationSnapshot, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), snapshotId: gax::GaxPreconditions.CheckNotNullOrEmpty(snapshotId, nameof(snapshotId)))
        {
        }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationSnapshot: return s_projectLocationSnapshot.Expand(ProjectId, LocationId, SnapshotId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
    ...
    public partial class FileShareConfig
    {
        /// <summary>
    ...
    public partial class RestoreInstanceRequest
    {
        /// <summary>
        /// <see cref="gcfv::InstanceName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
    ...
    {
        /// <summary>
        /// <see cref="gcfv::BackupName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcfv::BackupName BackupName
        {
        ...
        /// <summary>
        /// <see cref="InstanceName"/>-typed view over the <see cref="SourceInstance"/> resource name property.
        /// </summary>
        public InstanceName SourceInstanceAsInstanceName
        {
            get => string.IsNullOrEmpty(SourceInstance) ? null : InstanceName.Parse(SourceInstance, allowUnparsed: true);
            set => SourceInstance = value?.ToString() ?? "";
        }
    }
