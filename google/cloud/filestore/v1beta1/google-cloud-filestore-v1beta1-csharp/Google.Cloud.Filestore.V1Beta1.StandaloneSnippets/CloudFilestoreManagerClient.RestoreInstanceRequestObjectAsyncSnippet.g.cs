...
namespace Google.Cloud.Filestore.V1Beta1.Snippets
{
    using Google.Cloud.Common;
    using Google.Cloud.Filestore.V1Beta1;
    using Google.LongRunning;
    using System.Threading.Tasks;

    public sealed partial class GeneratedCloudFilestoreManagerClientStandaloneSnippets
    {
        ...
        public async Task RestoreInstanceRequestObjectAsync()
        {
            ...
            RestoreInstanceRequest request = new RestoreInstanceRequest
            {
                ...
                FileShare = "",
                SourceSnapshotAsSnapshotName = SnapshotName.FromProjectLocationSnapshot("[PROJECT]", "[LOCATION]", "[SNAPSHOT]"),
            };
            // Make the request
