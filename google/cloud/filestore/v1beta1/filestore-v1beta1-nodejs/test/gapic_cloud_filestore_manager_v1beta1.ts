...
describe('v1beta1.CloudFilestoreManagerClient', () => {
    it('has servicePath', () => {
        const servicePath = cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new cloudfilestoremanagerModule.v1beta1.CloudFilestoreManagerClient();
        assert(client);
    });
    ...
    describe('getInstance', () => {
        it('invokes getInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.filestore.v1beta1.GetInstanceRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Instance());
        ...
        it('invokes getInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInstance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.filestore.v1beta1.IInstance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBackup', () => {
        it('invokes getBackup without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Backup());
        ...
        it('invokes createInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.filestore.v1beta1.IInstance, protos.google.cloud.common.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.filestore.v1beta1.IInstance, protos.google.cloud.common.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('restoreInstance', () => {
        it('invokes restoreInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.filestore.v1beta1.RestoreInstanceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.restoreInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createBackup', () => {
        it('invokes createBackup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.filestore.v1beta1.CreateBackupRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes createBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createBackup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.filestore.v1beta1.IBackup, protos.google.cloud.common.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.filestore.v1beta1.IBackup, protos.google.cloud.common.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createBackup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('deleteBackup', () => {
        it('invokes deleteBackup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.filestore.v1beta1.DeleteBackupRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updateBackup', () => {
        it('invokes updateBackup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.filestore.v1beta1.UpdateBackupRequest());
            request.backup = {};
            request.backup.name = '';
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.filestore.v1beta1.ListInstancesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Instance()),
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Instance()),
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Instance()),
            ];
        ...
        it('invokes listInstancesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.filestore.v1beta1.Instance[] = [];
                stream.on('data', (response: protos.google.cloud.filestore.v1beta1.Instance) => {
        ...
        it('uses async iteration with listInstances without error', async () => {
            ...
            const responses: protos.google.cloud.filestore.v1beta1.IInstance[] = [];
    ...
    describe('listBackups', () => {
        it('invokes listBackups without error', async () => {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Backup()),
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Backup()),
              generateSampleMessage(new protos.google.cloud.filestore.v1beta1.Backup()),
            ];
        ...
        it('invokes listBackupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.filestore.v1beta1.Backup[] = [];
                stream.on('data', (response: protos.google.cloud.filestore.v1beta1.Backup) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listBackups without error', async () => {
            ...
            const responses: protos.google.cloud.filestore.v1beta1.IBackup[] = [];
    ...
    describe('Path templates', () => {
        ...
        describe('snapshot', () => {
            ...
            it('snapshotPath', () => {
                const result = client.snapshotPath("projectValue", "locationValue", "snapshotValue");
                assert.strictEqual(result, fakePath);
