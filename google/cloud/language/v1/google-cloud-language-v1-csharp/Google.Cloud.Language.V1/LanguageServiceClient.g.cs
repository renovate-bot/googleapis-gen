...
namespace Google.Cloud.Language.V1
{
    ...
    public sealed partial class LanguageServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings AnalyzeEntitySentimentSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(600000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(100), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.DeadlineExceeded, grpccore::StatusCode.Unavailable)));
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings AnalyzeSyntaxSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(600000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 2147483647, initialBackoff: sys::TimeSpan.FromMilliseconds(100), maxBackoff: sys::TimeSpan.FromMilliseconds(60000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.DeadlineExceeded, grpccore::StatusCode.Unavailable)));
    ...
    public abstract partial class LanguageServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual AnalyzeEntitySentimentResponse AnalyzeEntitySentiment(Document document, gaxgrpc::CallSettings callSettings = null) =>
            AnalyzeEntitySentiment(new AnalyzeEntitySentimentRequest
            {
                Document = gax::GaxPreconditions.CheckNotNull(document, nameof(document)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AnalyzeEntitySentimentResponse> AnalyzeEntitySentimentAsync(Document document, gaxgrpc::CallSettings callSettings = null) =>
            AnalyzeEntitySentimentAsync(new AnalyzeEntitySentimentRequest
            {
                Document = gax::GaxPreconditions.CheckNotNull(document, nameof(document)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AnalyzeEntitySentimentResponse> AnalyzeEntitySentimentAsync(Document document, st::CancellationToken cancellationToken) =>
            AnalyzeEntitySentimentAsync(document, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual AnalyzeSyntaxResponse AnalyzeSyntax(Document document, gaxgrpc::CallSettings callSettings = null) =>
            AnalyzeSyntax(new AnalyzeSyntaxRequest
            {
                Document = gax::GaxPreconditions.CheckNotNull(document, nameof(document)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AnalyzeSyntaxResponse> AnalyzeSyntaxAsync(Document document, gaxgrpc::CallSettings callSettings = null) =>
            AnalyzeSyntaxAsync(new AnalyzeSyntaxRequest
            {
                Document = gax::GaxPreconditions.CheckNotNull(document, nameof(document)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AnalyzeSyntaxResponse> AnalyzeSyntaxAsync(Document document, st::CancellationToken cancellationToken) =>
            AnalyzeSyntaxAsync(document, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
