...
class ListGameServerClustersPager:
    ...
    :class:`google.cloud.gaming_v1.types.ListGameServerClustersResponse` object, and
    ...
    All the usual :class:`google.cloud.gaming_v1.types.ListGameServerClustersResponse`
