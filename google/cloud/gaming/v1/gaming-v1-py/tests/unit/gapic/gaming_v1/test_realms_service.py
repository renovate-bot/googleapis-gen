...
def test_realms_service_client_client_options_from_dict():
    with mock.patch('google.cloud.gaming_v1.services.realms_service.transports.RealmsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_realms_service_base_transport():
    ...
    with mock.patch('google.cloud.gaming_v1.services.realms_service.transports.RealmsServiceTransport.__init__') as Transport:
...
def test_realms_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.gaming_v1.services.realms_service.transports.RealmsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_realms_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.gaming_v1.services.realms_service.transports.RealmsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.RealmsServiceTransport()
        adc.assert_called_once()
