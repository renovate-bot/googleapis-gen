...
class GameServerDeploymentsServiceClientTest extends GeneratedTest
{
    ...
    public function createGameServerDeploymentTest()
    {
        ...
        $this->assertSame('/google.cloud.gaming.v1.GameServerDeploymentsService/CreateGameServerDeployment', $actualApiFuncCall);
    ...
    public function deleteGameServerDeploymentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gaming.v1.GameServerDeploymentsService/DeleteGameServerDeployment', $actualApiFuncCall);
    ...
    public function fetchDeploymentStateTest()
    {
        ...
        $this->assertSame('/google.cloud.gaming.v1.GameServerDeploymentsService/FetchDeploymentState', $actualFuncCall);
    ...
    public function getGameServerDeploymentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gaming.v1.GameServerDeploymentsService/GetGameServerDeployment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getGameServerDeploymentRolloutTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gaming.v1.GameServerDeploymentsService/GetGameServerDeploymentRollout', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listGameServerDeploymentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gaming.v1.GameServerDeploymentsService/ListGameServerDeployments', $actualFuncCall);
    ...
    public function previewGameServerDeploymentRolloutTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gaming.v1.GameServerDeploymentsService/PreviewGameServerDeploymentRollout', $actualFuncCall);
    ...
    public function updateGameServerDeploymentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gaming.v1.GameServerDeploymentsService/UpdateGameServerDeployment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getGameServerDeployment();
        $this->assertProtobufEquals($gameServerDeployment, $actualValue);
    ...
    public function updateGameServerDeploymentRolloutTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gaming.v1.GameServerDeploymentsService/UpdateGameServerDeploymentRollout', $actualApiFuncCall);
