...
class GameServerDeploymentsServiceGapicClient
{
    ...
    {
        if (self::$gameServerDeploymentNameTemplate == null) {
    ...
    {
        if (self::$gameServerDeploymentRolloutNameTemplate == null) {
    ...
    public function createGameServerDeployment($parent, $deploymentId, $gameServerDeployment, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateGameServerDeployment', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteGameServerDeployment($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteGameServerDeployment', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function fetchDeploymentState($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('FetchDeploymentState', FetchDeploymentStateResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getGameServerDeployment($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetGameServerDeployment', GameServerDeployment::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getGameServerDeploymentRollout($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetGameServerDeploymentRollout', GameServerDeploymentRollout::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listGameServerDeployments($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListGameServerDeployments', $optionalArgs, ListGameServerDeploymentsResponse::class, $request);
    }
    ...
    public function previewGameServerDeploymentRollout($rollout, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['rollout.name'] = $rollout->getName();
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('PreviewGameServerDeploymentRollout', PreviewGameServerDeploymentRolloutResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updateGameServerDeployment($gameServerDeployment, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['game_server_deployment.name'] = $gameServerDeployment->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateGameServerDeployment', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function updateGameServerDeploymentRollout($rollout, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateGameServerDeploymentRollout', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
