...
/**
 * Base stub class for the AllocationEndpointService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@BetaApi
@Generated("by gapic-generator-java")
public abstract class AllocationEndpointServiceStub implements BackgroundResource {

  public UnaryCallable<AllocationRequest, AllocationResponse> allocateCallable() {
    throw new UnsupportedOperationException("Not implemented: allocateCallable()");
  }
