 ...
 *
 * Generated from protobuf message <code>google.cloud.gaming.v1beta.TargetDetails</code>
 */
class TargetDetails extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $game_server_deployment_name = '';
    /**
     * Agones fleet details for game server clusters and game server deployments.
     *
     * Generated from protobuf field <code>repeated .google.cloud.gaming.v1beta.TargetDetails.TargetFleetDetails fleet_details = 3;</code>
     */
     ...
     *           The game server deployment name. Uses the form:
     *           `projects/{project}/locations/{location}/gameServerDeployments/{deployment_id}`.
     *     @type \Google\Cloud\Gaming\V1beta\TargetDetails\TargetFleetDetails[]|\Google\Protobuf\Internal\RepeatedField $fleet_details
     *           Agones fleet details for game server clusters and game server deployments.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.gaming.v1beta.TargetDetails.TargetFleetDetails fleet_details = 3;</code>
     * @param \Google\Cloud\Gaming\V1beta\TargetDetails\TargetFleetDetails[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFleetDetails($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Gaming\V1beta\TargetDetails\TargetFleetDetails::class);
