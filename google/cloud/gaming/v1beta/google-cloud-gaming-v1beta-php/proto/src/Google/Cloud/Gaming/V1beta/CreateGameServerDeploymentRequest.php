 ...
 *
 * Generated from protobuf message <code>google.cloud.gaming.v1beta.CreateGameServerDeploymentRequest</code>
 */
class CreateGameServerDeploymentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gaming.v1beta.GameServerDeployment game_server_deployment = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $game_server_deployment = null;
     ...
     *           Required. The ID of the game server delpoyment resource to be created.
     *     @type \Google\Cloud\Gaming\V1beta\GameServerDeployment $game_server_deployment
     *           Required. The game server delpoyment resource to be created.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gaming.v1beta.GameServerDeployment game_server_deployment = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Gaming\V1beta\GameServerDeployment|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gaming.v1beta.GameServerDeployment game_server_deployment = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Gaming\V1beta\GameServerDeployment $var
     * @return $this
     */
    public function setGameServerDeployment($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Gaming\V1beta\GameServerDeployment::class);
