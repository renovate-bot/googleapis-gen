 ...
 *
 * Generated from protobuf message <code>google.cloud.gaming.v1beta.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.gaming.v1beta.OperationStatus> operation_status = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Gaming\V1beta\OperationStatus::class);
