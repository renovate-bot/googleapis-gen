 ...
 *
 * Generated from protobuf message <code>google.cloud.gaming.v1beta.UpdateGameServerDeploymentRolloutRequest</code>
 */
class UpdateGameServerDeploymentRolloutRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Gaming\V1beta\GameServerDeploymentRollout $rollout
     *           Required. The game server delpoyment rollout to be updated.
     *           Only fields specified in update_mask are updated.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gaming.v1beta.GameServerDeploymentRollout rollout = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Gaming\V1beta\GameServerDeploymentRollout $var
     * @return $this
     */
    public function setRollout($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Gaming\V1beta\GameServerDeploymentRollout::class);
        $this->rollout = $var;
