...
namespace Google\Cloud\Gaming\V1beta\OperationStatus;

use UnexpectedValueException;

/**
 * Protobuf type <code>google.cloud.gaming.v1beta.OperationStatus.ErrorCode</code>
 */
class ErrorCode
{
    /**
...
class_alias(ErrorCode::class, \Google\Cloud\Gaming\V1beta\OperationStatus_ErrorCode::class);
