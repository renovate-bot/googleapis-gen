 ...
 *
 * Generated from protobuf message <code>google.cloud.gaming.v1beta.PreviewRealmUpdateRequest</code>
 */
class PreviewRealmUpdateRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gaming.v1beta.Realm realm = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\Gaming\V1beta\Realm $realm
     *           Required. The realm to be updated.
     *           Only fields specified in update_mask are updated.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gaming.v1beta.Realm realm = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Gaming\V1beta\Realm $var
     * @return $this
     */
    public function setRealm($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Gaming\V1beta\Realm::class);
        $this->realm = $var;
