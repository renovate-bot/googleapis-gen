 ...
 * state.
 *
 * Generated from protobuf message <code>google.cloud.gaming.v1beta.GameServerDeploymentRollout</code>
 */
class GameServerDeploymentRollout extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.gaming.v1beta.GameServerConfigOverride game_server_config_overrides = 5;</code>
     */
     ...
     *           in the rollout. For example,
     *           `projects/my-project/locations/global/gameServerDeployments/my-game/configs/my-config`.
     *     @type \Google\Cloud\Gaming\V1beta\GameServerConfigOverride[]|\Google\Protobuf\Internal\RepeatedField $game_server_config_overrides
     *           Contains the game server config rollout overrides. Overrides are processed
     *           in the order they are listed. Once a match is found for a realm, the rest
     *           of the list is not processed.
     *     @type string $etag
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.gaming.v1beta.GameServerConfigOverride game_server_config_overrides = 5;</code>
     * @param \Google\Cloud\Gaming\V1beta\GameServerConfigOverride[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setGameServerConfigOverrides($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Gaming\V1beta\GameServerConfigOverride::class);
