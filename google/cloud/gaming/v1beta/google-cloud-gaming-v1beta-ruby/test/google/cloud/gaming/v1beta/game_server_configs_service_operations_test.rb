...
class ::Google::Cloud::Gaming::V1beta::GameServerConfigsService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Operations::Configuration, config
  end
end
