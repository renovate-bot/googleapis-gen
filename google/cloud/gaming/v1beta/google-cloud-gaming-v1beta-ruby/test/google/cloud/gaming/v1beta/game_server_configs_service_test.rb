...
class ::Google::Cloud::Gaming::V1beta::GameServerConfigsService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_game_server_configs
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Gaming::V1beta::ListGameServerConfigsResponse.new
    ...
    list_game_server_configs_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Gaming::V1beta::ListGameServerConfigsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_game_server_configs_client_stub do
      ...
      # Use protobuf object
      client.list_game_server_configs ::Google::Cloud::Gaming::V1beta::ListGameServerConfigsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      client.list_game_server_configs(::Google::Cloud::Gaming::V1beta::ListGameServerConfigsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_game_server_config
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Gaming::V1beta::GameServerConfig.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_game_server_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Gaming::V1beta::GetGameServerConfigRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_game_server_config_client_stub do
      ...
      # Use protobuf object
      client.get_game_server_config ::Google::Cloud::Gaming::V1beta::GetGameServerConfigRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_game_server_config(::Google::Cloud::Gaming::V1beta::GetGameServerConfigRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_game_server_config
    ...
    create_game_server_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Gaming::V1beta::CreateGameServerConfigRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["config_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Gaming::V1beta::GameServerConfig), request["game_server_config"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_game_server_config_client_stub do
      ...
      # Use protobuf object
      client.create_game_server_config ::Google::Cloud::Gaming::V1beta::CreateGameServerConfigRequest.new(parent: parent, config_id: config_id, game_server_config: game_server_config) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.create_game_server_config(::Google::Cloud::Gaming::V1beta::CreateGameServerConfigRequest.new(parent: parent, config_id: config_id, game_server_config: game_server_config), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_game_server_config
    ...
    delete_game_server_config_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Gaming::V1beta::DeleteGameServerConfigRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_game_server_config_client_stub do
      ...
      # Use protobuf object
      client.delete_game_server_config ::Google::Cloud::Gaming::V1beta::DeleteGameServerConfigRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_game_server_config(::Google::Cloud::Gaming::V1beta::DeleteGameServerConfigRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Operations, client.operations_client
  end
end
