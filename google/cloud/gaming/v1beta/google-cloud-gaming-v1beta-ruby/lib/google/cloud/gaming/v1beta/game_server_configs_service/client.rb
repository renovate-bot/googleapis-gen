      ...
      module V1beta
        module GameServerConfigsService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all GameServerConfigsService clients
            #   ::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Client.new
            #
            #   # Create a client using a custom configuration
            #   client = ::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Client.new do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @game_server_configs_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Stub,
            ...
            #
            # @return [::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Operations]
            #
            ...
            #   {::Google::Cloud::Gaming::V1beta::ListGameServerConfigsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Gaming::V1beta::ListGameServerConfigsRequest, ::Hash]
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Gaming::V1beta::GameServerConfig>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Gaming::V1beta::GameServerConfig>]
            #
            ...
            #   request = Google::Cloud::Gaming::V1beta::ListGameServerConfigsRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::Gaming::V1beta::GameServerConfig.
            #     p response
            #   end
            #
            def list_game_server_configs request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Gaming::V1beta::ListGameServerConfigsRequest
            ...
            #   {::Google::Cloud::Gaming::V1beta::GetGameServerConfigRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Gaming::V1beta::GetGameServerConfigRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Gaming::V1beta::GameServerConfig]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Gaming::V1beta::GetGameServerConfigRequest.new
            #
            #   # Call the get_game_server_config method.
            #   result = client.get_game_server_config request
            #
            #   # The returned object is of type Google::Cloud::Gaming::V1beta::GameServerConfig.
            #   p result
            #
            def get_game_server_config request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Gaming::V1beta::GetGameServerConfigRequest
            ...
            #   {::Google::Cloud::Gaming::V1beta::CreateGameServerConfigRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Gaming::V1beta::CreateGameServerConfigRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Gaming::V1beta::CreateGameServerConfigRequest.new
            #
            ...
            def create_game_server_config request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Gaming::V1beta::CreateGameServerConfigRequest
            ...
            #   {::Google::Cloud::Gaming::V1beta::DeleteGameServerConfigRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Gaming::V1beta::DeleteGameServerConfigRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Gaming::V1beta::DeleteGameServerConfigRequest.new
            #
            ...
            def delete_game_server_config request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Gaming::V1beta::DeleteGameServerConfigRequest
            ...
            # {::Google::Cloud::Gaming::V1beta::GameServerConfigsService::Client::Configuration::Rpcs}
