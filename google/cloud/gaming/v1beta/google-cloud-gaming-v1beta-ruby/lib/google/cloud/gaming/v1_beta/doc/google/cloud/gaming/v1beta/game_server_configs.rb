  ...
  module Cloud
    module Gaming
      module V1beta
        ...
        #     {Google::Cloud::Gaming::V1beta::ListGameServerConfigsResponse#next_page_token next_page_token} to
        ...
        class ListGameServerConfigsRequest; end

        # Response message for GameServerConfigsService.ListGameServerConfigs.
        # @!attribute [rw] game_server_configs
        #   @return [Array<Google::Cloud::Gaming::V1beta::GameServerConfig>]
        ...
        class ListGameServerConfigsResponse; end
        ...
        class GetGameServerConfigRequest; end
        ...
        class CreateGameServerConfigRequest; end
        ...
        #
        #     `projects/{project}/locations/{location}/gameServerDeployments/{deployment}/configs/{config}`.
        class DeleteGameServerConfigRequest; end
        ...
        #   @return [Array<Google::Cloud::Gaming::V1beta::LabelSelector>]
        ...
        #   @return [Array<Google::Cloud::Gaming::V1beta::Schedule>]
        #     The schedules to which this Scaling Config applies.
        class ScalingConfig; end
        ...
        #   @return [Array<Google::Cloud::Gaming::V1beta::FleetConfig>]
        #     FleetConfig contains a list of Agones fleet specs. Only one FleetConfig
        #     is allowed.
        # @!attribute [rw] scaling_configs
        #   @return [Array<Google::Cloud::Gaming::V1beta::ScalingConfig>]
        #     The autoscaling settings.
        # @!attribute [rw] description
        #   @return [String]
        #     The description of the game server config.
        class GameServerConfig; end
      end
    end
  end
end