  ...
  module Cloud
    module Gaming
      module V1beta
        ...
        #     {Google::Cloud::Gaming::V1beta::ListGameServerDeploymentsResponse#next_page_token next_page_token} to
        ...
        class ListGameServerDeploymentsRequest; end
        ...
        class ListGameServerDeploymentsResponse; end
        ...
        class GetGameServerDeploymentRequest; end
        ...
        class GetGameServerDeploymentRolloutRequest; end
        ...
        class CreateGameServerDeploymentRequest; end
        ...
        #
        #     `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`.
        class DeleteGameServerDeploymentRequest; end
        ...
        class UpdateGameServerDeploymentRequest; end
        ...
        #     //developers.google.com/protocol-buffers
        #     // /docs/reference/google.protobuf#fieldmask
        class UpdateGameServerDeploymentRolloutRequest; end
        ...
        #
        #     `projects/{project}/locations/{location}/gameServerDeployments/{deployment}`.
        class FetchDeploymentStateRequest; end
        ...
        class FetchDeploymentStateResponse
          ...
          #     game server cluster.
          class DeployedClusterState; end
        end
        ...
        class GameServerDeployment; end
        ...
        class GameServerConfigOverride; end
        ...
        #   @return [String]
        #     ETag of the resource.
        class GameServerDeploymentRollout; end
        ...
        class PreviewGameServerDeploymentRolloutRequest; end
        ...
        #     The target state.
        class PreviewGameServerDeploymentRolloutResponse; end
      end
    end
  end
end