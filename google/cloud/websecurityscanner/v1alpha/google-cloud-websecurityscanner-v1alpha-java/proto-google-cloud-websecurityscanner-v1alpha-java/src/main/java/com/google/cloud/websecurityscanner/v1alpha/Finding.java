...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 122: {
            com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Builder subBuilder = null;
            if (vulnerableHeaders_ != null) {
              subBuilder = vulnerableHeaders_.toBuilder();
            }
            vulnerableHeaders_ = input.readMessage(com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public enum FindingType
    ...
    public static FindingType forNumber(int value) {
      switch (value) {
        ...
        case 7: return INVALID_CONTENT_TYPE;
        case 8: return XSS_ANGULAR_CALLBACK;
        case 9: return INVALID_HEADER;
        case 10: return MISSPELLED_SECURITY_HEADER_NAME;
        case 11: return MISMATCHING_SECURITY_HEADER_VALUES;
        default: return null;
      }
    }
   ...
   */
  @java.lang.Override public int getFindingTypeValue() {
    return findingType_;
  }
  /**
   * <pre>
   ...
   * </pre>
   *
   * <code>.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders vulnerable_headers = 15;</code>
  ...
  public com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders getVulnerableHeaders() {
    return vulnerableHeaders_ == null ? com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.getDefaultInstance() : vulnerableHeaders_;
  }
  /**
   * <pre>
   * An addon containing information about vulnerable or missing HTTP headers.
   ...
   */
  @java.lang.Override
  public com.google.cloud.websecurityscanner.v1alpha.VulnerableHeadersOrBuilder getVulnerableHeadersOrBuilder() {
  ...
  public int getSerializedSize() {
    ...
    if (vulnerableHeaders_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(15, getVulnerableHeaders());
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getFuzzedUrl()
        .equals(other.getFuzzedUrl())) return false;
    if (!getBody()
        .equals(other.getBody())) return false;
    if (!getDescription()
        .equals(other.getDescription())) return false;
    if (!getReproductionUrl()
        .equals(other.getReproductionUrl())) return false;
    if (!getFrameUrl()
        .equals(other.getFrameUrl())) return false;
    if (!getFinalUrl()
    ...
    if (hasOutdatedLibrary()) {
      if (!getOutdatedLibrary()
          .equals(other.getOutdatedLibrary())) return false;
    }
    if (hasViolatingResource() != other.hasViolatingResource()) return false;
    if (hasViolatingResource()) {
      if (!getViolatingResource()
          .equals(other.getViolatingResource())) return false;
    }
    if (hasVulnerableHeaders() != other.hasVulnerableHeaders()) return false;
    if (hasVulnerableHeaders()) {
      if (!getVulnerableHeaders()
          .equals(other.getVulnerableHeaders())) return false;
    }
    if (hasVulnerableParameters() != other.hasVulnerableParameters()) return false;
    if (hasVulnerableParameters()) {
      if (!getVulnerableParameters()
          .equals(other.getVulnerableParameters())) return false;
    }
    if (hasXss() != other.hasXss()) return false;
    if (hasXss()) {
      if (!getXss()
          .equals(other.getXss())) return false;
    }
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders vulnerableHeaders_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders, com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Builder, com.google.cloud.websecurityscanner.v1alpha.VulnerableHeadersOrBuilder> vulnerableHeadersBuilder_;
    /**
     * <pre>
     * An addon containing information about vulnerable or missing HTTP headers.
     * </pre>
     ...
     * <code>.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders vulnerable_headers = 15;</code>
     */
    public Builder setVulnerableHeaders(com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders value) {
      if (vulnerableHeadersBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders vulnerable_headers = 15;</code>
     */
    public Builder mergeVulnerableHeaders(com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders value) {
      if (vulnerableHeadersBuilder_ == null) {
        if (vulnerableHeaders_ != null) {
          vulnerableHeaders_ =
            com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.newBuilder(vulnerableHeaders_).mergeFrom(value).buildPartial();
        } else {
          vulnerableHeaders_ = value;
        }
        onChanged();
     ...
     * <code>.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders vulnerable_headers = 15;</code>
     */
    public com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Builder getVulnerableHeadersBuilder() {
    ...
    public com.google.cloud.websecurityscanner.v1alpha.VulnerableHeadersOrBuilder getVulnerableHeadersOrBuilder() {
      if (vulnerableHeadersBuilder_ != null) {
        ...
        return vulnerableHeaders_ == null ?
            com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.getDefaultInstance() : vulnerableHeaders_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders, com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Builder, com.google.cloud.websecurityscanner.v1alpha.VulnerableHeadersOrBuilder> 
        getVulnerableHeadersFieldBuilder() {
      if (vulnerableHeadersBuilder_ == null) {
        vulnerableHeadersBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders, com.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Builder, com.google.cloud.websecurityscanner.v1alpha.VulnerableHeadersOrBuilder>(
