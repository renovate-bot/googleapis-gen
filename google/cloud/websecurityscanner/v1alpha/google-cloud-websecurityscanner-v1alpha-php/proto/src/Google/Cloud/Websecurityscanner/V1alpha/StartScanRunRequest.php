 ...
 *
 * Generated from protobuf message <code>google.cloud.websecurityscanner.v1alpha.StartScanRunRequest</code>
 */
class StartScanRunRequest extends \Google\Protobuf\Internal\Message
{
    /**
