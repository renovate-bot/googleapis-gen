 ...
 * ScanRun.
 *
 * Generated from protobuf message <code>google.cloud.websecurityscanner.v1alpha.Finding</code>
 */
class Finding extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.websecurityscanner.v1alpha.Finding.FindingType finding_type = 2;</code>
     */
     ...
     *           The tracking ID uniquely identifies a vulnerability instance across
     *           multiple ScanRuns.
     *     @type \Google\Cloud\Websecurityscanner\V1alpha\OutdatedLibrary $outdated_library
     *           An addon containing information about outdated libraries.
     *     @type \Google\Cloud\Websecurityscanner\V1alpha\ViolatingResource $violating_resource
     *           An addon containing detailed information regarding any resource causing the
     *           vulnerability such as JavaScript sources, image, audio files, etc.
     *     @type \Google\Cloud\Websecurityscanner\V1alpha\VulnerableHeaders $vulnerable_headers
     *           An addon containing information about vulnerable or missing HTTP headers.
     *     @type \Google\Cloud\Websecurityscanner\V1alpha\VulnerableParameters $vulnerable_parameters
     *           An addon containing information about request parameters which were found
     *           to be vulnerable.
     *     @type \Google\Cloud\Websecurityscanner\V1alpha\Xss $xss
     *           An addon containing information reported for an XSS, if any.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.websecurityscanner.v1alpha.OutdatedLibrary outdated_library = 11;</code>
     * @param \Google\Cloud\Websecurityscanner\V1alpha\OutdatedLibrary $var
     * @return $this
     */
    public function setOutdatedLibrary($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Websecurityscanner\V1alpha\OutdatedLibrary::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.websecurityscanner.v1alpha.ViolatingResource violating_resource = 12;</code>
     * @param \Google\Cloud\Websecurityscanner\V1alpha\ViolatingResource $var
     * @return $this
     */
    public function setViolatingResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Websecurityscanner\V1alpha\ViolatingResource::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders vulnerable_headers = 15;</code>
     * @param \Google\Cloud\Websecurityscanner\V1alpha\VulnerableHeaders $var
     * @return $this
     */
    public function setVulnerableHeaders($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Websecurityscanner\V1alpha\VulnerableHeaders::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.websecurityscanner.v1alpha.VulnerableParameters vulnerable_parameters = 13;</code>
     * @param \Google\Cloud\Websecurityscanner\V1alpha\VulnerableParameters $var
     * @return $this
     */
    public function setVulnerableParameters($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Websecurityscanner\V1alpha\VulnerableParameters::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.websecurityscanner.v1alpha.Xss xss = 14;</code>
     * @param \Google\Cloud\Websecurityscanner\V1alpha\Xss $var
     * @return $this
     */
    public function setXss($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Websecurityscanner\V1alpha\Xss::class);
        $this->xss = $var;
