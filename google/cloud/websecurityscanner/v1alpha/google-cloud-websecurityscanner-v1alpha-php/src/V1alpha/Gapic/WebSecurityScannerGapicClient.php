...
namespace Google\Cloud\Websecurityscanner\V1alpha\Gapic;
...
use Google\Cloud\Websecurityscanner\V1alpha\CreateScanConfigRequest;
use Google\Cloud\Websecurityscanner\V1alpha\DeleteScanConfigRequest;
use Google\Cloud\Websecurityscanner\V1alpha\Finding;
use Google\Cloud\Websecurityscanner\V1alpha\GetFindingRequest;
use Google\Cloud\Websecurityscanner\V1alpha\GetScanConfigRequest;
use Google\Cloud\Websecurityscanner\V1alpha\GetScanRunRequest;
use Google\Cloud\Websecurityscanner\V1alpha\ListCrawledUrlsRequest;
use Google\Cloud\Websecurityscanner\V1alpha\ListCrawledUrlsResponse;
use Google\Cloud\Websecurityscanner\V1alpha\ListFindingTypeStatsRequest;
use Google\Cloud\Websecurityscanner\V1alpha\ListFindingTypeStatsResponse;
use Google\Cloud\Websecurityscanner\V1alpha\ListFindingsRequest;
use Google\Cloud\Websecurityscanner\V1alpha\ListFindingsResponse;
use Google\Cloud\Websecurityscanner\V1alpha\ListScanConfigsRequest;
use Google\Cloud\Websecurityscanner\V1alpha\ListScanConfigsResponse;
use Google\Cloud\Websecurityscanner\V1alpha\ListScanRunsRequest;
use Google\Cloud\Websecurityscanner\V1alpha\ListScanRunsResponse;
use Google\Cloud\Websecurityscanner\V1alpha\ScanConfig;
use Google\Cloud\Websecurityscanner\V1alpha\ScanRun;
use Google\Cloud\Websecurityscanner\V1alpha\StartScanRunRequest;
use Google\Cloud\Websecurityscanner\V1alpha\StopScanRunRequest;
use Google\Cloud\Websecurityscanner\V1alpha\UpdateScanConfigRequest;
...
class WebSecurityScannerGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.websecurityscanner.v1alpha.WebSecurityScanner';
    ...
    {
        if (null == self::$scanConfigNameTemplate) {
    ...
    {
        if (null == self::$scanRunNameTemplate) {
