...
from google.cloud.websecurityscanner_v1.services.web_security_scanner import WebSecurityScannerAsyncClient
from google.cloud.websecurityscanner_v1.services.web_security_scanner import WebSecurityScannerClient
from google.cloud.websecurityscanner_v1.services.web_security_scanner import pagers
from google.cloud.websecurityscanner_v1.services.web_security_scanner import transports
from google.cloud.websecurityscanner_v1.services.web_security_scanner.transports.base import _API_CORE_VERSION
from google.cloud.websecurityscanner_v1.services.web_security_scanner.transports.base import _GOOGLE_AUTH_VERSION
...
def test_web_security_scanner_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_web_security_scanner_client_client_options_from_dict():
    with mock.patch('google.cloud.websecurityscanner_v1.services.web_security_scanner.transports.WebSecurityScannerGrpcTransport.__init__') as grpc_transport:
...
def test_web_security_scanner_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.websecurityscanner_v1.services.web_security_scanner.transports.WebSecurityScannerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_web_security_scanner_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.websecurityscanner_v1.services.web_security_scanner.transports.WebSecurityScannerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.WebSecurityScannerTransport()
        adc.assert_called_once()
...
def test_web_security_scanner_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_web_security_scanner_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.WebSecurityScannerGrpcTransport, transports.WebSecurityScannerGrpcAsyncIOTransport])
def test_web_security_scanner_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
