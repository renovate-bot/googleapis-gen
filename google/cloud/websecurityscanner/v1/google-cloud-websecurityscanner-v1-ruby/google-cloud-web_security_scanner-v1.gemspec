...
require File.expand_path("lib/google/cloud/web_security_scanner/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-web_security_scanner-v1"
  gem.version       = Google::Cloud::WebSecurityScanner::V1::VERSION
