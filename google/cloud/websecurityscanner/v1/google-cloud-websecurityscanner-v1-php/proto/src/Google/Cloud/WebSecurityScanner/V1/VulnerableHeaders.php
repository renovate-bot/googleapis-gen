...
class VulnerableHeaders extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\WebSecurityScanner\V1\VulnerableHeaders\Header[]|\Google\Protobuf\Internal\RepeatedField $headers
     *           List of vulnerable headers.
     *     @type \Google\Cloud\WebSecurityScanner\V1\VulnerableHeaders\Header[]|\Google\Protobuf\Internal\RepeatedField $missing_headers
     *           List of missing headers.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.websecurityscanner.v1.VulnerableHeaders.Header headers = 1;</code>
     * @param \Google\Cloud\WebSecurityScanner\V1\VulnerableHeaders\Header[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
