 ...
 *
 * Generated from protobuf message <code>google.cloud.websecurityscanner.v1.ListScanConfigsResponse</code>
 */
class ListScanConfigsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\WebSecurityScanner\V1\ScanConfig[]|\Google\Protobuf\Internal\RepeatedField $scan_configs
     *           The list of ScanConfigs returned.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.websecurityscanner.v1.ScanConfig scan_configs = 1;</code>
     * @param \Google\Cloud\WebSecurityScanner\V1\ScanConfig[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setScanConfigs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\WebSecurityScanner\V1\ScanConfig::class);
