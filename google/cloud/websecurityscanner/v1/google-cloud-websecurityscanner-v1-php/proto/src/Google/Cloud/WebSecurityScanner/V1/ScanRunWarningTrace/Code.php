...
namespace Google\Cloud\WebSecurityScanner\V1\ScanRunWarningTrace;
 ...
 * Next id: 6
 *
 * Protobuf type <code>google.cloud.websecurityscanner.v1.ScanRunWarningTrace.Code</code>
 */
class Code
{
    /**
...
class_alias(Code::class, \Google\Cloud\WebSecurityScanner\V1\ScanRunWarningTrace_Code::class);
