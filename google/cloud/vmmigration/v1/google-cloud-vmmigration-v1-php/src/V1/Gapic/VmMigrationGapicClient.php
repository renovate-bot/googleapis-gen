 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/vmmigration/v1/vmmigration.proto
...
class VmMigrationGapicClient
{
    ...
    private static function getCloneJobNameTemplate()
    {
        if (self::$cloneJobNameTemplate == null) {
            self::$cloneJobNameTemplate = new PathTemplate('projects/{project}/locations/{location}/sources/{source}/migratingVms/{migrating_vm}/cloneJobs/{clone_job}');
        }
    ...
    private static function getCutoverJobNameTemplate()
    {
        if (self::$cutoverJobNameTemplate == null) {
            self::$cutoverJobNameTemplate = new PathTemplate('projects/{project}/locations/{location}/sources/{source}/migratingVms/{migrating_vm}/cutoverJobs/{cutover_job}');
        }
    ...
    private static function getDatacenterConnectorNameTemplate()
    {
        if (self::$datacenterConnectorNameTemplate == null) {
            self::$datacenterConnectorNameTemplate = new PathTemplate('projects/{project}/locations/{location}/sources/{source}/datacenterConnectors/{datacenter_connector}');
        }
    ...
    private static function getGroupNameTemplate()
    {
        if (self::$groupNameTemplate == null) {
            self::$groupNameTemplate = new PathTemplate('projects/{project}/locations/{location}/groups/{group}');
        }
    ...
    private static function getMigratingVmNameTemplate()
    {
        if (self::$migratingVmNameTemplate == null) {
            self::$migratingVmNameTemplate = new PathTemplate('projects/{project}/locations/{location}/sources/{source}/migratingVms/{migrating_vm}');
        }
    ...
    private static function getSourceNameTemplate()
    {
        if (self::$sourceNameTemplate == null) {
            self::$sourceNameTemplate = new PathTemplate('projects/{project}/locations/{location}/sources/{source}');
        }
    ...
    private static function getTargetProjectNameTemplate()
    {
        if (self::$targetProjectNameTemplate == null) {
            self::$targetProjectNameTemplate = new PathTemplate('projects/{project}/locations/{location}/targetProjects/{target_project}');
        }
    ...
    private static function getUtilizationReportNameTemplate()
    {
        if (self::$utilizationReportNameTemplate == null) {
            self::$utilizationReportNameTemplate = new PathTemplate('projects/{project}/locations/{location}/sources/{source}/utilizationReports/{utilization_report}');
        }
     ...
     */
    public static function cloneJobName($project, $location, $source, $migratingVm, $cloneJob)
    {
     ...
     */
    public static function cutoverJobName($project, $location, $source, $migratingVm, $cutoverJob)
    {
     ...
     */
    public static function datacenterConnectorName($project, $location, $source, $datacenterConnector)
    {
     ...
     */
    public static function migratingVmName($project, $location, $source, $migratingVm)
    {
     ...
     */
    public static function targetProjectName($project, $location, $targetProject)
    {
     ...
     */
    public static function utilizationReportName($project, $location, $source, $utilizationReport)
    {
    ...
    public function addGroupMigration($group, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('AddGroupMigration', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function cancelCloneJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CancelCloneJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function cancelCutoverJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CancelCutoverJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createCloneJob($parent, $cloneJobId, $cloneJob, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateCloneJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createCutoverJob($parent, $cutoverJobId, $cutoverJob, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateCutoverJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createDatacenterConnector($parent, $datacenterConnectorId, $datacenterConnector, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateDatacenterConnector', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createGroup($parent, $groupId, $group, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateGroup', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createMigratingVm($parent, $migratingVmId, $migratingVm, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateMigratingVm', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createSource($parent, $sourceId, $source, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateSource', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createTargetProject($parent, $targetProjectId, $targetProject, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateTargetProject', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createUtilizationReport($parent, $utilizationReport, $utilizationReportId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateUtilizationReport', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteDatacenterConnector($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteDatacenterConnector', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteGroup($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteGroup', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteMigratingVm($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteMigratingVm', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteSource($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteSource', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteTargetProject($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteTargetProject', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteUtilizationReport($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteUtilizationReport', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function fetchInventory($source, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('FetchInventory', FetchInventoryResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function finalizeMigration($migratingVm, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('FinalizeMigration', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getCloneJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetCloneJob', CloneJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getCutoverJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetCutoverJob', CutoverJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getDatacenterConnector($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetDatacenterConnector', DatacenterConnector::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getMigratingVm($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetMigratingVm', MigratingVm::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getTargetProject($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetTargetProject', TargetProject::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getUtilizationReport($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetUtilizationReport', UtilizationReport::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listCloneJobs($parent, $pageToken, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListCloneJobs', $optionalArgs, ListCloneJobsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listCutoverJobs($parent, $pageToken, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListCutoverJobs', $optionalArgs, ListCutoverJobsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listDatacenterConnectors($parent, $pageToken, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListDatacenterConnectors', $optionalArgs, ListDatacenterConnectorsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listMigratingVms($parent, $pageToken, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListMigratingVms', $optionalArgs, ListMigratingVmsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listTargetProjects($parent, $pageToken, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListTargetProjects', $optionalArgs, ListTargetProjectsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listUtilizationReports($parent, $pageToken, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListUtilizationReports', $optionalArgs, ListUtilizationReportsResponse::class, $request);
    }
    ...
    public function pauseMigration($migratingVm, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('PauseMigration', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function removeGroupMigration($group, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('RemoveGroupMigration', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function resumeMigration($migratingVm, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('ResumeMigration', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function startMigration($migratingVm, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('StartMigration', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function updateGroup($group, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateGroup', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function updateMigratingVm($migratingVm, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateMigratingVm', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function updateSource($source, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateSource', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateTargetProject($targetProject, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateTargetProject', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
