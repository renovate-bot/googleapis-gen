...
use Google\Cloud\RecaptchaEnterprise\V1beta1\AnnotateAssessmentRequest\Annotation;
...
use Google\Cloud\RecaptchaEnterprise\V1beta1\CreateKeyRequest;
use Google\Cloud\RecaptchaEnterprise\V1beta1\DeleteKeyRequest;
use Google\Cloud\RecaptchaEnterprise\V1beta1\GetKeyRequest;
use Google\Cloud\RecaptchaEnterprise\V1beta1\Key;
use Google\Cloud\RecaptchaEnterprise\V1beta1\ListKeysRequest;
use Google\Cloud\RecaptchaEnterprise\V1beta1\ListKeysResponse;
use Google\Cloud\RecaptchaEnterprise\V1beta1\UpdateKeyRequest;
...
class RecaptchaEnterpriseServiceV1Beta1GapicClient
{
     ...
     *                             For allowed values, use constants defined on {@see \Google\Cloud\RecaptchaEnterprise\V1beta1\AnnotateAssessmentRequest\Annotation}
     * @param array  $optionalArgs {
     *                             Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *     $formattedParent = $recaptchaEnterpriseServiceV1Beta1Client->projectName('[PROJECT]');
     *     $key = new Key();
     *     $response = $recaptchaEnterpriseServiceV1Beta1Client->createKey($formattedParent, $key);
     * } finally {
     *     $recaptchaEnterpriseServiceV1Beta1Client->close();
     * }
     * ```
     ...
     *     $pagedResponse = $recaptchaEnterpriseServiceV1Beta1Client->listKeys($formattedParent);
     ...
     * $recaptchaEnterpriseServiceV1Beta1Client = new RecaptchaEnterpriseServiceV1Beta1Client();
     * try {
     *     $formattedName = $recaptchaEnterpriseServiceV1Beta1Client->keyName('[PROJECT]', '[KEY]');
     *     $response = $recaptchaEnterpriseServiceV1Beta1Client->getKey($formattedName);
     * } finally {
     *     $recaptchaEnterpriseServiceV1Beta1Client->close();
     * }
     * ```
     ...
     * try {
     *     $key = new Key();
     *     $response = $recaptchaEnterpriseServiceV1Beta1Client->updateKey($key);
     * } finally {
     *     $recaptchaEnterpriseServiceV1Beta1Client->close();
     * }
     * ```
     ...
     * try {
     *     $formattedName = $recaptchaEnterpriseServiceV1Beta1Client->keyName('[PROJECT]', '[KEY]');
     *     $recaptchaEnterpriseServiceV1Beta1Client->deleteKey($formattedName);
     * } finally {
     *     $recaptchaEnterpriseServiceV1Beta1Client->close();
     * }
     * ```
