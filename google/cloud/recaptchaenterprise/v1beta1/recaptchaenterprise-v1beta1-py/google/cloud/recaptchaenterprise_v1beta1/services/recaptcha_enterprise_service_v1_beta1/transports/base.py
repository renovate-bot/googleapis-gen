...
class RecaptchaEnterpriseServiceV1Beta1Transport(abc.ABC):
    ...
    @property
    def create_assessment(self) -> typing.Callable[
    ...
    @property
    def annotate_assessment(self) -> typing.Callable[
    ...
    @property
    def create_key(self) -> typing.Callable[
            [recaptchaenterprise.CreateKeyRequest],
            typing.Union[
                recaptchaenterprise.Key,
                typing.Awaitable[recaptchaenterprise.Key]
            ]]:
        raise NotImplementedError()

    @property
    def list_keys(self) -> typing.Callable[
    ...
    @property
    def get_key(self) -> typing.Callable[
    ...
    @property
    def update_key(self) -> typing.Callable[
    ...
    @property
    def delete_key(self) -> typing.Callable[
