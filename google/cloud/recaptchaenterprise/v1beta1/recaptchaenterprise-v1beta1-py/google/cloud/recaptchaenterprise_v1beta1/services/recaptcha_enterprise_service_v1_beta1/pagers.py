...
class ListKeysPager:
    ...
    :class:`google.cloud.recaptchaenterprise_v1beta1.types.ListKeysResponse` object, and
    ...
    All the usual :class:`google.cloud.recaptchaenterprise_v1beta1.types.ListKeysResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.recaptchaenterprise_v1beta1.types.ListKeysResponse):
