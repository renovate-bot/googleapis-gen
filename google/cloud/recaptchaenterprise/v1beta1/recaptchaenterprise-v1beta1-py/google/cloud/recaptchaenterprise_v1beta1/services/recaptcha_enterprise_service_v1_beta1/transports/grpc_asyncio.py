...
from .base import RecaptchaEnterpriseServiceV1Beta1Transport, DEFAULT_CLIENT_INFO
from .grpc import RecaptchaEnterpriseServiceV1Beta1GrpcTransport


class RecaptchaEnterpriseServiceV1Beta1GrpcAsyncIOTransport(RecaptchaEnterpriseServiceV1Beta1Transport):
    """gRPC AsyncIO backend transport for RecaptchaEnterpriseServiceV1Beta1.
