...
class RecaptchaEnterpriseServiceV1Beta1ClientMeta(type):
    """Metaclass for the RecaptchaEnterpriseServiceV1Beta1 client.
    ...
    def get_transport_class(cls,
            label: str = None,
        ) -> Type[RecaptchaEnterpriseServiceV1Beta1Transport]:
...
class RecaptchaEnterpriseServiceV1Beta1Client(metaclass=RecaptchaEnterpriseServiceV1Beta1ClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RecaptchaEnterpriseServiceV1Beta1Client: The constructed client.
        """
    ...
    def transport(self) -> RecaptchaEnterpriseServiceV1Beta1Transport:
        ...
        Returns:
            RecaptchaEnterpriseServiceV1Beta1Transport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, RecaptchaEnterpriseServiceV1Beta1Transport):
            # transport is a RecaptchaEnterpriseServiceV1Beta1Transport instance.
    ...
    def list_keys(self,
        ...
        Returns:
            google.cloud.recaptchaenterprise_v1beta1.services.recaptcha_enterprise_service_v1_beta1.pagers.ListKeysPager:
