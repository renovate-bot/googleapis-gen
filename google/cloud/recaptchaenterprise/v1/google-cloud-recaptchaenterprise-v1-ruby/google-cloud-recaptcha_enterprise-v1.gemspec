...
require File.expand_path("lib/google/cloud/recaptcha_enterprise/v1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-recaptcha_enterprise-v1"
  gem.version       = Google::Cloud::RecaptchaEnterprise::V1::VERSION
  ...
  gem.summary       = "API Client library for the reCAPTCHA Enterprise V1 API"
