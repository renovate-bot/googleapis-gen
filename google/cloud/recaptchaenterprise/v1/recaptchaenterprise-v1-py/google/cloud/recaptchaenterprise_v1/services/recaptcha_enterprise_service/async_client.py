...
class RecaptchaEnterpriseServiceAsyncClient:
    ...
    from_service_account_info = RecaptchaEnterpriseServiceClient.from_service_account_info
    from_service_account_file = RecaptchaEnterpriseServiceClient.from_service_account_file
