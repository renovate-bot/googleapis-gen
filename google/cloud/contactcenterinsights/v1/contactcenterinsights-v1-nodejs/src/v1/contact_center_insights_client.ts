...
export class ContactCenterInsightsClient {
  ...
  initialize() {
    ...
    const contactCenterInsightsStubMethods =
        ['createConversation', 'updateConversation', 'getConversation', 'listConversations', 'deleteConversation', 'createAnalysis', 'getAnalysis', 'listAnalyses', 'deleteAnalysis', 'exportInsightsData', 'getIssueModel', 'listIssueModels', 'getIssue', 'listIssues', 'calculateIssueModelStats', 'createPhraseMatcher', 'getPhraseMatcher', 'listPhraseMatchers', 'deletePhraseMatcher', 'calculateStats', 'getSettings', 'updateSettings'];
 ...
 */
   ...
   */
  analysisPath(project:string,location:string,conversation:string,analysis:string) {
  ...
  matchConversationFromAnalysisName(analysisName: string) {
    return this.pathTemplates.analysisPathTemplate.match(analysisName).conversation;
  }
