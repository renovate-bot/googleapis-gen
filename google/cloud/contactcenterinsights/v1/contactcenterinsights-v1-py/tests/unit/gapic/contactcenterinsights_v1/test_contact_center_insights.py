...
from google.cloud.contactcenterinsights_v1.services.contact_center_insights import ContactCenterInsightsAsyncClient
from google.cloud.contactcenterinsights_v1.services.contact_center_insights import ContactCenterInsightsClient
from google.cloud.contactcenterinsights_v1.services.contact_center_insights import pagers
from google.cloud.contactcenterinsights_v1.services.contact_center_insights import transports
from google.cloud.contactcenterinsights_v1.services.contact_center_insights.transports.base import _API_CORE_VERSION
from google.cloud.contactcenterinsights_v1.services.contact_center_insights.transports.base import _GOOGLE_AUTH_VERSION
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (ContactCenterInsightsClient, transports.ContactCenterInsightsGrpcTransport, "grpc"),
    (ContactCenterInsightsAsyncClient, transports.ContactCenterInsightsGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (ContactCenterInsightsClient, transports.ContactCenterInsightsGrpcTransport, "grpc", "true"),
    (ContactCenterInsightsAsyncClient, transports.ContactCenterInsightsGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ContactCenterInsightsClient, transports.ContactCenterInsightsGrpcTransport, "grpc", "false"),
    (ContactCenterInsightsAsyncClient, transports.ContactCenterInsightsGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(ContactCenterInsightsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ContactCenterInsightsClient))
@mock.patch.object(ContactCenterInsightsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ContactCenterInsightsAsyncClient))
...
def test_contact_center_insights_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_contact_center_insights_client_client_options_from_dict():
    with mock.patch('google.cloud.contactcenterinsights_v1.services.contact_center_insights.transports.ContactCenterInsightsGrpcTransport.__init__') as grpc_transport:
...
def test_create_conversation_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_conversation(
            parent='parent_value',
            conversation=resources.Conversation(call_metadata=resources.Conversation.CallMetadata(customer_channel=1706)),
        ...
        assert args[0].conversation == resources.Conversation(call_metadata=resources.Conversation.CallMetadata(customer_channel=1706))
        assert args[0].conversation_id == 'conversation_id_value'
...
def test_update_conversation(transport: str = 'grpc', request_type=contact_center_insights.UpdateConversationRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_conversation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.Conversation(
            name='name_value',
...
def test_delete_conversation(transport: str = 'grpc', request_type=contact_center_insights.DeleteConversationRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_conversation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_analysis_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].analysis == resources.Analysis(name='name_value')
...
def test_export_insights_data(transport: str = 'grpc', request_type=contact_center_insights.ExportInsightsDataRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_insights_data),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_issue_model(transport: str = 'grpc', request_type=contact_center_insights.GetIssueModelRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_issue_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_issue_models(transport: str = 'grpc', request_type=contact_center_insights.ListIssueModelsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_issue_models),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_issue(transport: str = 'grpc', request_type=contact_center_insights.GetIssueRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_issue),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_issues(transport: str = 'grpc', request_type=contact_center_insights.ListIssuesRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_issues),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_calculate_issue_model_stats(transport: str = 'grpc', request_type=contact_center_insights.CalculateIssueModelStatsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.calculate_issue_model_stats),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_calculate_issue_model_stats_flattened():
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0].issue_model == 'issue_model_value'
...
def test_create_phrase_matcher(transport: str = 'grpc', request_type=contact_center_insights.CreatePhraseMatcherRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_phrase_matcher),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_phrase_matcher(transport: str = 'grpc', request_type=contact_center_insights.GetPhraseMatcherRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_phrase_matcher),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.PhraseMatcher(
            name='name_value',
...
def test_delete_phrase_matcher(transport: str = 'grpc', request_type=contact_center_insights.DeletePhraseMatcherRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_phrase_matcher),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_calculate_stats(transport: str = 'grpc', request_type=contact_center_insights.CalculateStatsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.calculate_stats),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_settings_flattened():
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0].settings == resources.Settings(name='name_value')
        assert args[0].update_mask == field_mask_pb2.FieldMask(paths=['paths_value'])
...
def test_contact_center_insights_base_transport():
    ...
    with mock.patch('google.cloud.contactcenterinsights_v1.services.contact_center_insights.transports.ContactCenterInsightsTransport.__init__') as Transport:
...
def test_contact_center_insights_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.contactcenterinsights_v1.services.contact_center_insights.transports.ContactCenterInsightsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_contact_center_insights_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.contactcenterinsights_v1.services.contact_center_insights.transports.ContactCenterInsightsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_contact_center_insights_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.contactcenterinsights_v1.services.contact_center_insights.transports.ContactCenterInsightsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ContactCenterInsightsTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_contact_center_insights_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        ContactCenterInsightsClient()
...
@requires_google_auth_lt_1_25_0
def test_contact_center_insights_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_contact_center_insights_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_contact_center_insights_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
def test_contact_center_insights_host_no_port():
    client = ContactCenterInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='contactcenterinsights.googleapis.com'),
    )
    assert client.transport._host == 'contactcenterinsights.googleapis.com:443'
...
def test_contact_center_insights_host_with_port():
    client = ContactCenterInsightsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='contactcenterinsights.googleapis.com:8000'),
    )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ContactCenterInsightsGrpcTransport, transports.ContactCenterInsightsGrpcAsyncIOTransport])
def test_contact_center_insights_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
