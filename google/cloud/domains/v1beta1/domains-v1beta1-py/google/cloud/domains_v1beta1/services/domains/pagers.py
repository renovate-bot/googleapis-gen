...
class ListRegistrationsPager:
    ...
    :class:`google.cloud.domains_v1beta1.types.ListRegistrationsResponse` object, and
    ...
    All the usual :class:`google.cloud.domains_v1beta1.types.ListRegistrationsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.domains_v1beta1.types.ListRegistrationsResponse):
