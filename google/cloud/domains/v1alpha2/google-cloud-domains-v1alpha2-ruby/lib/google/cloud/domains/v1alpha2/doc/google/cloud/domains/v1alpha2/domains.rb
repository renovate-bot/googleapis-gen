  ...
  module Cloud
    module Domains
      module V1alpha2
        ...
        # @!attribute [rw] state
        #   @return [Google::Cloud::Domains::V1alpha2::Registration::State]
        #     Output only. The state of the `Registration`
        # @!attribute [rw] issues
        #   @return [Array<Google::Cloud::Domains::V1alpha2::Registration::Issue>]
        ...
        #   @return [Google::Cloud::Domains::V1alpha2::ContactSettings]
        ...
        #   @return [Array<Google::Cloud::Domains::V1alpha2::ContactPrivacy>]
        ...
        #   @return [Google::Cloud::Domains::V1alpha2::ManagementSettings::RenewalMethod]
        #     Output only. The renewal method for this `Registration`.
        # @!attribute [rw] transfer_lock_state
        #   @return [Google::Cloud::Domains::V1alpha2::TransferLockState]
        ...
        #   @return [Array<Google::Cloud::Domains::V1alpha2::DnsSettings::GlueRecord>]
        ...
        class DnsSettings
          ...
          #   @return [Array<Google::Cloud::Domains::V1alpha2::DnsSettings::DsRecord>]
          ...
          #   @return [Google::Cloud::Domains::V1alpha2::DnsSettings::DsState]
          ...
          #   @return [Google::Cloud::Domains::V1alpha2::DnsSettings::DsRecord::Algorithm]
          #     The algorithm used to generate the referenced DNSKEY.
          # @!attribute [rw] digest_type
          #   @return [Google::Cloud::Domains::V1alpha2::DnsSettings::DsRecord::DigestType]
        ...
        #   @return [Google::Cloud::Domains::V1alpha2::ContactPrivacy]
        ...
        #   @return [Array<Google::Cloud::Domains::V1alpha2::RegisterParameters>]
        ...
        # @!attribute [rw] register_parameters
        #   @return [Google::Cloud::Domains::V1alpha2::RegisterParameters]
        ...
        #   @return [Array<Google::Cloud::Domains::V1alpha2::DomainNotice>]
        #     The list of domain notices that you acknowledge. Call
        #     `RetrieveRegisterParameters` to see the notices that need acknowledgement.
        # @!attribute [rw] contact_notices
        #   @return [Array<Google::Cloud::Domains::V1alpha2::ContactNotice>]
        ...
        #   @return [Array<Google::Cloud::Domains::V1alpha2::Registration>]
        ...
        #   @return [Google::Cloud::Domains::V1alpha2::RegisterParameters::Availability]
