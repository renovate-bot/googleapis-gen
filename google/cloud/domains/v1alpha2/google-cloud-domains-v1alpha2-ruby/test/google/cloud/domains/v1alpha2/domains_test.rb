...
class ::Google::Cloud::Domains::V1alpha2::Domains::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_search_domains
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Domains::V1alpha2::SearchDomainsResponse.new
    ...
    search_domains_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::SearchDomainsRequest, request
    ...
    Gapic::ServiceStub.stub :new, search_domains_client_stub do
      ...
      # Use protobuf object
      client.search_domains ::Google::Cloud::Domains::V1alpha2::SearchDomainsRequest.new(query: query, location: location) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.search_domains(::Google::Cloud::Domains::V1alpha2::SearchDomainsRequest.new(query: query, location: location), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_retrieve_register_parameters
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Domains::V1alpha2::RetrieveRegisterParametersResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    retrieve_register_parameters_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::RetrieveRegisterParametersRequest, request
    ...
    Gapic::ServiceStub.stub :new, retrieve_register_parameters_client_stub do
      ...
      # Use protobuf object
      client.retrieve_register_parameters ::Google::Cloud::Domains::V1alpha2::RetrieveRegisterParametersRequest.new(domain_name: domain_name, location: location) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.retrieve_register_parameters(::Google::Cloud::Domains::V1alpha2::RetrieveRegisterParametersRequest.new(domain_name: domain_name, location: location), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_register_domain
    ...
    register_domain_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::RegisterDomainRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Domains::V1alpha2::Registration), request["registration"]
    ...
    Gapic::ServiceStub.stub :new, register_domain_client_stub do
      ...
      # Use protobuf object
      client.register_domain ::Google::Cloud::Domains::V1alpha2::RegisterDomainRequest.new(parent: parent, registration: registration, domain_notices: domain_notices, contact_notices: contact_notices, yearly_price: yearly_price, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.register_domain(::Google::Cloud::Domains::V1alpha2::RegisterDomainRequest.new(parent: parent, registration: registration, domain_notices: domain_notices, contact_notices: contact_notices, yearly_price: yearly_price, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_retrieve_transfer_parameters
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Domains::V1alpha2::RetrieveTransferParametersResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    retrieve_transfer_parameters_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::RetrieveTransferParametersRequest, request
      assert_equal "hello world", request["domain_name"]
      assert_equal "hello world", request["location"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, retrieve_transfer_parameters_client_stub do
      ...
      # Use protobuf object
      client.retrieve_transfer_parameters ::Google::Cloud::Domains::V1alpha2::RetrieveTransferParametersRequest.new(domain_name: domain_name, location: location) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.retrieve_transfer_parameters(::Google::Cloud::Domains::V1alpha2::RetrieveTransferParametersRequest.new(domain_name: domain_name, location: location), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_transfer_domain
    ...
    transfer_domain_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::TransferDomainRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Domains::V1alpha2::Registration), request["registration"]
      assert_equal [:CONTACT_NOTICE_UNSPECIFIED], request["contact_notices"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Type::Money), request["yearly_price"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Domains::V1alpha2::AuthorizationCode), request["authorization_code"]
      assert_equal true, request["validate_only"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, transfer_domain_client_stub do
      ...
      # Use protobuf object
      client.transfer_domain ::Google::Cloud::Domains::V1alpha2::TransferDomainRequest.new(parent: parent, registration: registration, contact_notices: contact_notices, yearly_price: yearly_price, authorization_code: authorization_code, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.transfer_domain(::Google::Cloud::Domains::V1alpha2::TransferDomainRequest.new(parent: parent, registration: registration, contact_notices: contact_notices, yearly_price: yearly_price, authorization_code: authorization_code, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_registrations
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Domains::V1alpha2::ListRegistrationsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_registrations_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::ListRegistrationsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_registrations_client_stub do
      ...
      # Use protobuf object
      client.list_registrations ::Google::Cloud::Domains::V1alpha2::ListRegistrationsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_registrations(::Google::Cloud::Domains::V1alpha2::ListRegistrationsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_registration
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Domains::V1alpha2::Registration.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_registration_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::GetRegistrationRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_registration_client_stub do
      ...
      # Use protobuf object
      client.get_registration ::Google::Cloud::Domains::V1alpha2::GetRegistrationRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_registration(::Google::Cloud::Domains::V1alpha2::GetRegistrationRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_registration
    ...
    update_registration_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::UpdateRegistrationRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Domains::V1alpha2::Registration), request["registration"]
    ...
    Gapic::ServiceStub.stub :new, update_registration_client_stub do
      ...
      # Use protobuf object
      client.update_registration ::Google::Cloud::Domains::V1alpha2::UpdateRegistrationRequest.new(registration: registration, update_mask: update_mask) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_registration(::Google::Cloud::Domains::V1alpha2::UpdateRegistrationRequest.new(registration: registration, update_mask: update_mask), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure_management_settings
    ...
    configure_management_settings_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::ConfigureManagementSettingsRequest, request
      assert_equal "hello world", request["registration"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Domains::V1alpha2::ManagementSettings), request["management_settings"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, configure_management_settings_client_stub do
      ...
      # Use protobuf object
      client.configure_management_settings ::Google::Cloud::Domains::V1alpha2::ConfigureManagementSettingsRequest.new(registration: registration, management_settings: management_settings, update_mask: update_mask) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.configure_management_settings(::Google::Cloud::Domains::V1alpha2::ConfigureManagementSettingsRequest.new(registration: registration, management_settings: management_settings, update_mask: update_mask), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure_dns_settings
    ...
    configure_dns_settings_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::ConfigureDnsSettingsRequest, request
      assert_equal "hello world", request["registration"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Domains::V1alpha2::DnsSettings), request["dns_settings"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
      assert_equal true, request["validate_only"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, configure_dns_settings_client_stub do
      ...
      # Use protobuf object
      client.configure_dns_settings ::Google::Cloud::Domains::V1alpha2::ConfigureDnsSettingsRequest.new(registration: registration, dns_settings: dns_settings, update_mask: update_mask, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.configure_dns_settings(::Google::Cloud::Domains::V1alpha2::ConfigureDnsSettingsRequest.new(registration: registration, dns_settings: dns_settings, update_mask: update_mask, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure_contact_settings
    ...
    configure_contact_settings_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::ConfigureContactSettingsRequest, request
      assert_equal "hello world", request["registration"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Domains::V1alpha2::ContactSettings), request["contact_settings"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
      assert_equal [:CONTACT_NOTICE_UNSPECIFIED], request["contact_notices"]
      assert_equal true, request["validate_only"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, configure_contact_settings_client_stub do
      ...
      # Use protobuf object
      client.configure_contact_settings ::Google::Cloud::Domains::V1alpha2::ConfigureContactSettingsRequest.new(registration: registration, contact_settings: contact_settings, update_mask: update_mask, contact_notices: contact_notices, validate_only: validate_only) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.configure_contact_settings(::Google::Cloud::Domains::V1alpha2::ConfigureContactSettingsRequest.new(registration: registration, contact_settings: contact_settings, update_mask: update_mask, contact_notices: contact_notices, validate_only: validate_only), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_export_registration
    ...
    export_registration_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::ExportRegistrationRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, export_registration_client_stub do
      ...
      # Use protobuf object
      client.export_registration ::Google::Cloud::Domains::V1alpha2::ExportRegistrationRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.export_registration(::Google::Cloud::Domains::V1alpha2::ExportRegistrationRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_registration
    ...
    delete_registration_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::DeleteRegistrationRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_registration_client_stub do
      ...
      # Use protobuf object
      client.delete_registration ::Google::Cloud::Domains::V1alpha2::DeleteRegistrationRequest.new(name: name) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_registration(::Google::Cloud::Domains::V1alpha2::DeleteRegistrationRequest.new(name: name), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_retrieve_authorization_code
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Domains::V1alpha2::AuthorizationCode.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    retrieve_authorization_code_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::RetrieveAuthorizationCodeRequest, request
      assert_equal "hello world", request["registration"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, retrieve_authorization_code_client_stub do
      ...
      # Use protobuf object
      client.retrieve_authorization_code ::Google::Cloud::Domains::V1alpha2::RetrieveAuthorizationCodeRequest.new(registration: registration) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.retrieve_authorization_code(::Google::Cloud::Domains::V1alpha2::RetrieveAuthorizationCodeRequest.new(registration: registration), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_reset_authorization_code
    ...
    reset_authorization_code_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Domains::V1alpha2::ResetAuthorizationCodeRequest, request
      assert_equal "hello world", request["registration"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, reset_authorization_code_client_stub do
      ...
      # Use protobuf object
      client.reset_authorization_code ::Google::Cloud::Domains::V1alpha2::ResetAuthorizationCodeRequest.new(registration: registration) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.reset_authorization_code(::Google::Cloud::Domains::V1alpha2::ResetAuthorizationCodeRequest.new(registration: registration), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Domains::V1alpha2::Domains::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Domains::V1alpha2::Domains::Operations, client.operations_client
  end
end
