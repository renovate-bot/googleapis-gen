...
class ListRegistrationsPager:
    ...
    :class:`google.cloud.domains_v1alpha2.types.ListRegistrationsResponse` object, and
    ...
    All the usual :class:`google.cloud.domains_v1alpha2.types.ListRegistrationsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.domains_v1alpha2.types.ListRegistrationsResponse):
    ...
    @property
    def pages(self) -> Iterable[domains.ListRegistrationsResponse]:
    ...
    def __iter__(self) -> Iterable[domains.Registration]:
...
class ListRegistrationsAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterable[domains.ListRegistrationsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
    ...
    def __aiter__(self) -> AsyncIterable[domains.Registration]:
