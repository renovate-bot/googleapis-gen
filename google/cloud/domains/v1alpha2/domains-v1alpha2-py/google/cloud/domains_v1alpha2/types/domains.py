...
class Registration(proto.Message):
    ...
    Attributes:
        ...
        expire_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            ``Registration``.
        state (google.cloud.domains_v1alpha2.types.Registration.State):
            Output only. The state of the ``Registration``
        issues (Sequence[google.cloud.domains_v1alpha2.types.Registration.Issue]):
            Output only. The set of issues with the ``Registration``
            that require attention.
        labels (Sequence[google.cloud.domains_v1alpha2.types.Registration.LabelsEntry]):
        ...
        pending_contact_settings (google.cloud.domains_v1alpha2.types.ContactSettings):
...
class ManagementSettings(proto.Message):
    ...
    Attributes:
        renewal_method (google.cloud.domains_v1alpha2.types.ManagementSettings.RenewalMethod):
...
class DnsSettings(proto.Message):
    ...
    Attributes:
        custom_dns (google.cloud.domains_v1alpha2.types.DnsSettings.CustomDns):
            An arbitrary DNS provider identified by its
            name servers.
        google_domains_dns (google.cloud.domains_v1alpha2.types.DnsSettings.GoogleDomainsDns):
            The free DNS zone provided by `Google
            Domains <https://domains.google/>`__.
        glue_records (Sequence[google.cloud.domains_v1alpha2.types.DnsSettings.GlueRecord]):
    ...
    class CustomDns(proto.Message):
        ...
        Attributes:
            ...
            ds_records (Sequence[google.cloud.domains_v1alpha2.types.DnsSettings.DsRecord]):
    ...
    class GoogleDomainsDns(proto.Message):
        ...
        Attributes:
            ...
            ds_state (google.cloud.domains_v1alpha2.types.DnsSettings.DsState):
    ...
    class DsRecord(proto.Message):
        ...
        Attributes:
            key_tag (int):
                ...
                range 0 -- 65535.
            algorithm (google.cloud.domains_v1alpha2.types.DnsSettings.DsRecord.Algorithm):
                The algorithm used to generate the referenced
                DNSKEY.
            digest_type (google.cloud.domains_v1alpha2.types.DnsSettings.DsRecord.DigestType):
...
class ContactSettings(proto.Message):
    ...
    Attributes:
        privacy (google.cloud.domains_v1alpha2.types.ContactPrivacy):
            Required. Privacy setting for the contacts associated with
            the ``Registration``.
        registrant_contact (google.cloud.domains_v1alpha2.types.ContactSettings.Contact):
        ...
        admin_contact (google.cloud.domains_v1alpha2.types.ContactSettings.Contact):
            ...
            ``Registration``.
        technical_contact (google.cloud.domains_v1alpha2.types.ContactSettings.Contact):
...
class SearchDomainsResponse(proto.Message):
    ...
    Attributes:
        register_parameters (Sequence[google.cloud.domains_v1alpha2.types.RegisterParameters]):
...
class RetrieveRegisterParametersResponse(proto.Message):
    ...
    Attributes:
        register_parameters (google.cloud.domains_v1alpha2.types.RegisterParameters):
...
class RegisterDomainRequest(proto.Message):
    ...
    Attributes:
        ...
        registration (google.cloud.domains_v1alpha2.types.Registration):
            ...
            created.
        domain_notices (Sequence[google.cloud.domains_v1alpha2.types.DomainNotice]):
...
class ListRegistrationsResponse(proto.Message):
    ...
    Attributes:
        registrations (Sequence[google.cloud.domains_v1alpha2.types.Registration]):
...
class RegisterParameters(proto.Message):
    ...
    Attributes:
        domain_name (str):
            ...
            expressed in Punycode format.
        availability (google.cloud.domains_v1alpha2.types.RegisterParameters.Availability):
