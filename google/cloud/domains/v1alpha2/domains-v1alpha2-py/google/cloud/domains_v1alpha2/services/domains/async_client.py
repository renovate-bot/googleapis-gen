...
class DomainsAsyncClient:
    ...
    get_transport_class = functools.partial(type(DomainsClient).get_transport_class, type(DomainsClient))
    ...
    async def search_domains(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.SearchDomainsRequest, dict]):
        ...
        Returns:
            google.cloud.domains_v1alpha2.types.SearchDomainsResponse:
    ...
    async def retrieve_register_parameters(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.RetrieveRegisterParametersRequest, dict]):
        ...
        Returns:
            google.cloud.domains_v1alpha2.types.RetrieveRegisterParametersResponse:
    ...
    async def register_domain(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.RegisterDomainRequest, dict]):
    ...
    async def retrieve_transfer_parameters(self,
    ...
    async def transfer_domain(self,
        ...
        Args:
            ...
            yearly_price (:class:`google.type.money_pb2.Money`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            authorization_code (:class:`google.cloud.domains_v1alpha2.types.AuthorizationCode`):
    ...
    async def list_registrations(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.ListRegistrationsRequest, dict]):
        ...
        Returns:
            google.cloud.domains_v1alpha2.services.domains.pagers.ListRegistrationsAsyncPager:
    ...
    async def get_registration(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.GetRegistrationRequest, dict]):
        ...
        Returns:
            google.cloud.domains_v1alpha2.types.Registration:
    ...
    async def update_registration(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.UpdateRegistrationRequest, dict]):
    ...
    async def configure_management_settings(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.ConfigureManagementSettingsRequest, dict]):
                The request object. Request for the
            ...
            registration (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            management_settings (:class:`google.cloud.domains_v1alpha2.types.ManagementSettings`):
    ...
    async def configure_dns_settings(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.ConfigureDnsSettingsRequest, dict]):
                The request object. Request for the
            ...
            registration (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            dns_settings (:class:`google.cloud.domains_v1alpha2.types.DnsSettings`):
    ...
    async def configure_contact_settings(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.ConfigureContactSettingsRequest, dict]):
                The request object. Request for the
            ...
            registration (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            contact_settings (:class:`google.cloud.domains_v1alpha2.types.ContactSettings`):
    ...
    async def export_registration(self,
    ...
    async def delete_registration(self,
    ...
    async def retrieve_authorization_code(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.RetrieveAuthorizationCodeRequest, dict]):
                The request object. Request for the
        ...
        Returns:
            google.cloud.domains_v1alpha2.types.AuthorizationCode:
    ...
    async def reset_authorization_code(self,
        ...
        Args:
            request (Union[google.cloud.domains_v1alpha2.types.ResetAuthorizationCodeRequest, dict]):
                The request object. Request for the
