...
class DomainsAsyncClient:
    ...
    async def retrieve_transfer_parameters(self,
        ...
        Args:
            request (:class:`google.cloud.domains_v1alpha2.types.RetrieveTransferParametersRequest`):
                The request object. Request for the
    ...
    async def transfer_domain(self,
        ...
        Args:
            request (:class:`google.cloud.domains_v1alpha2.types.TransferDomainRequest`):
