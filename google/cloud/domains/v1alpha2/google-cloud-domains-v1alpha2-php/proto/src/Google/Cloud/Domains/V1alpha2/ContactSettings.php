 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1alpha2.ContactSettings</code>
 */
class ContactSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1alpha2.ContactPrivacy privacy = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $privacy = 0;
    /**
     ...
     *     @type int $privacy
     *           Required. Privacy setting for the contacts associated with the `Registration`.
     *     @type \Google\Cloud\Domains\V1alpha2\ContactSettings\Contact $registrant_contact
     *           Required. The registrant contact for the `Registration`.
     *           *Caution: Anyone with access to this email address, phone number,
     *           and/or postal address can take control of the domain.*
     *           *Warning: For new `Registration`s, the registrant will receive an email
     ...
     *           Required. The administrative contact for the `Registration`.
     *     @type \Google\Cloud\Domains\V1alpha2\ContactSettings\Contact $technical_contact
     *           Required. The technical contact for the `Registration`.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Domains\V1alpha2\ContactPrivacy::class);
        $this->privacy = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1alpha2.ContactSettings.Contact registrant_contact = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Domains\V1alpha2\ContactSettings\Contact $var
     * @return $this
     */
    public function setRegistrantContact($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Domains\V1alpha2\ContactSettings\Contact::class);
