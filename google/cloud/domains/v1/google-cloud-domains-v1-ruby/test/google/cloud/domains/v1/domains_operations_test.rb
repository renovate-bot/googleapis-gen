...
class ::Google::Cloud::Domains::V1::Domains::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Domains::V1::Domains::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Domains::V1::Domains::Operations::Configuration, config
  end
end
