...
specific version of the Cloud Domains V1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-domains-v1
```
...
request = ::Google::Cloud::Domains::V1::SearchDomainsRequest.new # (request fields as keyword arguments...)
response = client.search_domains request
```

View the [Client Library Documentation](https://googleapis.dev/ruby/google-cloud-domains-v1/latest)
