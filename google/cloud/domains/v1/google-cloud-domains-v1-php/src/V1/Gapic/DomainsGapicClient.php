 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/domains/v1/domains.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\Domains\V1\Gapic;
...
use Google\Cloud\Domains\V1\DnsSettings;
...
use Google\Cloud\Domains\V1\ManagementSettings;
...
class DomainsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.domains.v1.Domains';
     ...
     *           For allowed values, use constants defined on {@see \Google\Cloud\Domains\V1\ContactNotice}
     ...
     *           For allowed values, use constants defined on {@see \Google\Cloud\Domains\V1\DomainNotice}
     *     @type int[] $contactNotices
     *           The list of contact notices that the caller acknowledges. The notices
