 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1.Registration</code>
 */
class Registration extends \Google\Protobuf\Internal\Message
{
     ...
     *           method. To update these settings, use the `ConfigureManagementSettings`
     *           method.
     *     @type \Google\Cloud\Domains\V1\DnsSettings $dns_settings
     *           Settings controlling the DNS configuration of the `Registration`. You
     *           cannot update these with the `UpdateRegistration` method. To update these
     *           settings, use the `ConfigureDnsSettings` method.
     ...
     *           update these with the `UpdateRegistration` method. To update these
     *           settings, use the `ConfigureContactSettings` method.
     *     @type \Google\Cloud\Domains\V1\ContactSettings $pending_contact_settings
     *           Output only. Pending contact settings for the `Registration`. Updates to the
     *           `contact_settings` field that change its `registrant_contact` or `privacy`
     *           fields require email confirmation by the `registrant_contact`
     *           before taking effect. This field is set only if there are pending updates
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Domains\V1\Registration\State::class);
        $this->state = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Domains\V1\Registration\Issue::class);
        $this->issues = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1.DnsSettings dns_settings = 11;</code>
     * @return \Google\Cloud\Domains\V1\DnsSettings|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1.DnsSettings dns_settings = 11;</code>
     * @param \Google\Cloud\Domains\V1\DnsSettings $var
     * @return $this
     */
    public function setDnsSettings($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Domains\V1\DnsSettings::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1.ContactSettings contact_settings = 12 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Domains\V1\ContactSettings|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1.ContactSettings contact_settings = 12 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Domains\V1\ContactSettings $var
     * @return $this
     */
    public function setContactSettings($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Domains\V1\ContactSettings::class);
