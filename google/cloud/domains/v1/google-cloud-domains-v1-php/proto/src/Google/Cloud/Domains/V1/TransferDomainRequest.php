 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1.TransferDomainRequest</code>
 */
class TransferDomainRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Call `RetrieveTransferParameters` to obtain the price, which you must
     *           acknowledge.
     *     @type \Google\Cloud\Domains\V1\AuthorizationCode $authorization_code
     *           The domain's transfer authorization code. You can obtain this from the
     *           domain's current registrar.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1.Registration registration = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Domains\V1\Registration|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1.Registration registration = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Domains\V1\Registration $var
     * @return $this
     */
    public function setRegistration($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Domains\V1\Registration::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Domains\V1\ContactNotice::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1.AuthorizationCode authorization_code = 5;</code>
     * @return \Google\Cloud\Domains\V1\AuthorizationCode|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1.AuthorizationCode authorization_code = 5;</code>
     * @param \Google\Cloud\Domains\V1\AuthorizationCode $var
     * @return $this
     */
    public function setAuthorizationCode($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Domains\V1\AuthorizationCode::class);
