...
from google.cloud.networkservices_v1.services.network_services import pagers
from google.cloud.networkservices_v1.types import common
from google.cloud.networkservices_v1.types import endpoint_policy
from google.cloud.networkservices_v1.types import endpoint_policy as gcn_endpoint_policy
...
class NetworkServicesClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[NetworkServicesTransport]]
...
class NetworkServicesClient(metaclass=NetworkServicesClientMeta):
    ...
    @staticmethod
    def endpoint_policy_path(project: str,location: str,endpoint_policy: str,) -> str:
        """Returns a fully-qualified endpoint_policy string."""
        return "projects/{project}/locations/{location}/endpointPolicies/{endpoint_policy}".format(project=project, location=location, endpoint_policy=endpoint_policy, )

    @staticmethod
    def parse_endpoint_policy_path(path: str) -> Dict[str,str]:
        """Parses a endpoint_policy path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/endpointPolicies/(?P<endpoint_policy>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def list_endpoint_policies(self,
        ...
        Args:
            request (Union[google.cloud.networkservices_v1.types.ListEndpointPoliciesRequest, dict]):
        ...
        Returns:
            google.cloud.networkservices_v1.services.network_services.pagers.ListEndpointPoliciesPager:
    ...
    def get_endpoint_policy(self,
        ...
        Args:
            request (Union[google.cloud.networkservices_v1.types.GetEndpointPolicyRequest, dict]):
                The request object. Request used with the
        ...
        Returns:
            google.cloud.networkservices_v1.types.EndpointPolicy:
    ...
    def create_endpoint_policy(self,
        ...
        Args:
            request (Union[google.cloud.networkservices_v1.types.CreateEndpointPolicyRequest, dict]):
                The request object. Request used with the
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            endpoint_policy (google.cloud.networkservices_v1.types.EndpointPolicy):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.networkservices_v1.types.EndpointPolicy` EndpointPolicy is a resource that helps apply desired configuration
    ...
    def update_endpoint_policy(self,
        ...
        Args:
            request (Union[google.cloud.networkservices_v1.types.UpdateEndpointPolicyRequest, dict]):
                The request object. Request used with the
    ...
    def delete_endpoint_policy(self,
        ...
        Args:
            request (Union[google.cloud.networkservices_v1.types.DeleteEndpointPolicyRequest, dict]):
                The request object. Request used with the
