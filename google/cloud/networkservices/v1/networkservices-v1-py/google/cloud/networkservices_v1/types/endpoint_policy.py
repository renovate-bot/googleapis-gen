...
class EndpointPolicy(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The timestamp when the resource
            was updated.
        labels (Sequence[google.cloud.networkservices_v1.types.EndpointPolicy.LabelsEntry]):
            Optional. Set of label tags associated with
            the EndpointPolicy resource.
        type_ (google.cloud.networkservices_v1.types.EndpointPolicy.EndpointPolicyType):
        ...
        endpoint_matcher (google.cloud.networkservices_v1.types.EndpointMatcher):
            Required. A matcher that selects endpoints to
            which the policies should be applied.
        traffic_port_selector (google.cloud.networkservices_v1.types.TrafficPortSelector):
...
class ListEndpointPoliciesResponse(proto.Message):
    ...
    Attributes:
        endpoint_policies (Sequence[google.cloud.networkservices_v1.types.EndpointPolicy]):
