...
class EndpointMatcher(proto.Message):
    ...
    Attributes:
        metadata_label_matcher (google.cloud.networkservices_v1.types.EndpointMatcher.MetadataLabelMatcher):
    ...
    class MetadataLabelMatcher(proto.Message):
        ...
        Attributes:
            metadata_label_match_criteria (google.cloud.networkservices_v1.types.EndpointMatcher.MetadataLabelMatcher.MetadataLabelMatchCriteria):
            ...
            metadata_labels (Sequence[google.cloud.networkservices_v1.types.EndpointMatcher.MetadataLabelMatcher.MetadataLabels]):
