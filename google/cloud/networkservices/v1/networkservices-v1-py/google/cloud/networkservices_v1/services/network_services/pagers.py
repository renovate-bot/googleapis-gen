...
class ListEndpointPoliciesPager:
    ...
    :class:`google.cloud.networkservices_v1.types.ListEndpointPoliciesResponse` object, and
    ...
    All the usual :class:`google.cloud.networkservices_v1.types.ListEndpointPoliciesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.networkservices_v1.types.ListEndpointPoliciesRequest):
                The initial request object.
            response (google.cloud.networkservices_v1.types.ListEndpointPoliciesResponse):
