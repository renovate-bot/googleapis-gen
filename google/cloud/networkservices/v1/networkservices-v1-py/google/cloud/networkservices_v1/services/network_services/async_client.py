...
class NetworkServicesAsyncClient:
    ...
    async def list_endpoint_policies(self,
        ...
        Returns:
            google.cloud.networkservices_v1.services.network_services.pagers.ListEndpointPoliciesAsyncPager:
    ...
    async def create_endpoint_policy(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            endpoint_policy (:class:`google.cloud.networkservices_v1.types.EndpointPolicy`):
