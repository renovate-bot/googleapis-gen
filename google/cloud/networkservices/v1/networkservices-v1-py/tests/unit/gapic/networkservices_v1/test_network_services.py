...
from google.cloud.networkservices_v1.services.network_services import NetworkServicesAsyncClient
from google.cloud.networkservices_v1.services.network_services import NetworkServicesClient
from google.cloud.networkservices_v1.services.network_services import pagers
from google.cloud.networkservices_v1.services.network_services import transports
...
def test_network_services_client_from_service_account_info(client_class):
...
def test_network_services_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (NetworkServicesAsyncClient, transports.NetworkServicesGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (NetworkServicesClient, transports.NetworkServicesGrpcTransport, "grpc", "true"),
    (NetworkServicesAsyncClient, transports.NetworkServicesGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (NetworkServicesClient, transports.NetworkServicesGrpcTransport, "grpc", "false"),
    (NetworkServicesAsyncClient, transports.NetworkServicesGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(NetworkServicesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(NetworkServicesClient))
@mock.patch.object(NetworkServicesAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(NetworkServicesAsyncClient))
...
def test_network_services_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_get_endpoint_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_endpoint_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_endpoint_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_endpoint_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_endpoint_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_endpoint_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_endpoint_policy(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_endpoint_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_network_services_base_transport():
    ...
    with mock.patch('google.cloud.networkservices_v1.services.network_services.transports.NetworkServicesTransport.__init__') as Transport:
...
def test_network_services_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.networkservices_v1.services.network_services.transports.NetworkServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_network_services_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.networkservices_v1.services.network_services.transports.NetworkServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworkServicesTransport()
        adc.assert_called_once()
...
def test_network_services_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_network_services_host_no_port():
    client = NetworkServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_network_services_host_with_port():
    client = NetworkServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.NetworkServicesGrpcTransport, transports.NetworkServicesGrpcAsyncIOTransport])
def test_network_services_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
