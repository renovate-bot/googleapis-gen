...
describe('v1.NetworkServicesClient', () => {
    ...
    describe('getEndpointPolicy', () => {
        it('invokes getEndpointPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkservices.v1.GetEndpointPolicyRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.networkservices.v1.EndpointPolicy());
    ...
    describe('updateEndpointPolicy', () => {
        it('invokes updateEndpointPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkservices.v1.UpdateEndpointPolicyRequest());
    ...
    describe('deleteEndpointPolicy', () => {
        it('invokes deleteEndpointPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkservices.v1.DeleteEndpointPolicyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
