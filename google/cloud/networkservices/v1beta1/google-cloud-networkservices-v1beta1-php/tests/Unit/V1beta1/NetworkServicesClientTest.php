...
namespace Google\Cloud\NetworkServices\Tests\Unit\V1beta1;
...
use Google\Cloud\NetworkServices\V1beta1\EndpointMatcher;
use Google\Cloud\NetworkServices\V1beta1\EndpointPolicy;

use Google\Cloud\NetworkServices\V1beta1\EndpointPolicy\EndpointPolicyType;
use Google\Cloud\NetworkServices\V1beta1\ListEndpointPoliciesResponse;
...
class NetworkServicesClientTest extends GeneratedTest
{
    ...
    public function createEndpointPolicyTest()
    {
        ...
        $response = $client->createEndpointPolicy($formattedParent, $endpointPolicyId, $endpointPolicy);
        ...
        $this->assertSame('/google.cloud.networkservices.v1beta1.NetworkServices/CreateEndpointPolicy', $actualApiFuncCall);
    ...
    public function deleteEndpointPolicyTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $client->endpointPolicyName('[PROJECT]', '[LOCATION]', '[ENDPOINT_POLICY]');
        $response = $client->deleteEndpointPolicy($formattedName);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkservices.v1beta1.NetworkServices/DeleteEndpointPolicy', $actualApiFuncCall);
    ...
    public function getEndpointPolicyTest()
    {
        ...
        // Mock request
        $formattedName = $client->endpointPolicyName('[PROJECT]', '[LOCATION]', '[ENDPOINT_POLICY]');
        $response = $client->getEndpointPolicy($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkservices.v1beta1.NetworkServices/GetEndpointPolicy', $actualFuncCall);
    ...
    public function getEndpointPolicyExceptionTest()
    {
        ...
        $formattedName = $client->endpointPolicyName('[PROJECT]', '[LOCATION]', '[ENDPOINT_POLICY]');
        try {
            $client->getEndpointPolicy($formattedName);
    ...
    public function listEndpointPoliciesTest()
    {
        ...
        // Mock request
        $formattedParent = $client->locationName('[PROJECT]', '[LOCATION]');
        $response = $client->listEndpointPolicies($formattedParent);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkservices.v1beta1.NetworkServices/ListEndpointPolicies', $actualFuncCall);
    ...
    public function listEndpointPoliciesExceptionTest()
    {
        ...
        $formattedParent = $client->locationName('[PROJECT]', '[LOCATION]');
        try {
            $client->listEndpointPolicies($formattedParent);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateEndpointPolicyTest()
    {
        ...
        $endpointPolicyEndpointMatcher = new EndpointMatcher();
        $endpointPolicy->setEndpointMatcher($endpointPolicyEndpointMatcher);
        $response = $client->updateEndpointPolicy($endpointPolicy);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkservices.v1beta1.NetworkServices/UpdateEndpointPolicy', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getEndpointPolicy();
        $this->assertProtobufEquals($endpointPolicy, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
