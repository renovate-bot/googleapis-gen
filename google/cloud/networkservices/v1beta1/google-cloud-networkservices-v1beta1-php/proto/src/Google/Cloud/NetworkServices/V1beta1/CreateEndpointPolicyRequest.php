 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1beta1.CreateEndpointPolicyRequest</code>
 */
class CreateEndpointPolicyRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.EndpointPolicy endpoint_policy = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. Short name of the EndpointPolicy resource to be created.
     *           E.g. "CustomECS".
     *     @type \Google\Cloud\NetworkServices\V1beta1\EndpointPolicy $endpoint_policy
     *           Required. EndpointPolicy resource to be created.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.EndpointPolicy endpoint_policy = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\NetworkServices\V1beta1\EndpointPolicy|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\NetworkServices\V1beta1\EndpointPolicy::class);
