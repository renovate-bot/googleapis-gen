 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1beta1.EndpointPolicy</code>
 */
class EndpointPolicy extends \Google\Protobuf\Internal\Message
{
     ...
     * the configuration.
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.EndpointPolicy.EndpointPolicyType type = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $type = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.EndpointMatcher endpoint_matcher = 9 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.TrafficPortSelector traffic_port_selector = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           endpoint. Applicable only when EndpointPolicyType is
     *           SIDECAR_PROXY.
     *     @type \Google\Cloud\NetworkServices\V1beta1\EndpointMatcher $endpoint_matcher
     *           Required. A matcher that selects endpoints to which the policies should be applied.
     *     @type \Google\Cloud\NetworkServices\V1beta1\TrafficPortSelector $traffic_port_selector
     *           Optional. Port selector for the (matched) endpoints. If no port selector is
     *           provided, the matched config is applied to all ports.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\NetworkServices\V1beta1\EndpointPolicy\EndpointPolicyType::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.EndpointMatcher endpoint_matcher = 9 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\NetworkServices\V1beta1\EndpointMatcher|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.EndpointMatcher endpoint_matcher = 9 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\NetworkServices\V1beta1\EndpointMatcher $var
     * @return $this
     */
    public function setEndpointMatcher($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\NetworkServices\V1beta1\EndpointMatcher::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.TrafficPortSelector traffic_port_selector = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\NetworkServices\V1beta1\TrafficPortSelector|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.TrafficPortSelector traffic_port_selector = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\NetworkServices\V1beta1\TrafficPortSelector $var
     * @return $this
     */
    public function setTrafficPortSelector($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\NetworkServices\V1beta1\TrafficPortSelector::class);
