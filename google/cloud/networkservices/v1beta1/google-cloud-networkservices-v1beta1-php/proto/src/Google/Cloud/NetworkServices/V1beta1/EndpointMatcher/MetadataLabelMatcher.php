...
class MetadataLabelMatcher extends \Google\Protobuf\Internal\Message
{
     ...
     *           config P4 with selector <A:1,D:1> exists and if a client with
     *           label <A:1,B:1,D:1> connects), an error will be thrown.
     *     @type \Google\Cloud\NetworkServices\V1beta1\EndpointMatcher\MetadataLabelMatcher\MetadataLabels[]|\Google\Protobuf\Internal\RepeatedField $metadata_labels
     *           The list of label value pairs that must match labels in the
     *           provided metadata based on filterMatchCriteria This list can
     *           have at most 64 entries. The list can be empty if the match
     *           criteria is MATCH_ANY, to specify a wildcard match (i.e this
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher.MetadataLabels metadata_labels = 2;</code>
     * @param \Google\Cloud\NetworkServices\V1beta1\EndpointMatcher\MetadataLabelMatcher\MetadataLabels[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
...
class_alias(MetadataLabelMatcher::class, \Google\Cloud\NetworkServices\V1beta1\EndpointMatcher_MetadataLabelMatcher::class);
