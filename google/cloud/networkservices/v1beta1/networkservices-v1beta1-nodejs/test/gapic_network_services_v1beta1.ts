...
describe('v1beta1.NetworkServicesClient', () => {
    ...
    describe('getEndpointPolicy', () => {
        it('invokes getEndpointPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkservices.v1beta1.GetEndpointPolicyRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.networkservices.v1beta1.EndpointPolicy());
            ...
            assert((client.innerApiCalls.getEndpointPolicy as SinonStub)
    ...
    describe('createEndpointPolicy', () => {
        it('invokes createEndpointPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkservices.v1beta1.CreateEndpointPolicyRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createEndpointPolicy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateEndpointPolicy', () => {
        it('invokes updateEndpointPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkservices.v1beta1.UpdateEndpointPolicyRequest());
            request.endpointPolicy = {};
            request.endpointPolicy.name = '';
            const expectedHeaderRequestParams = "endpoint_policy.name=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateEndpointPolicy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteEndpointPolicy', () => {
        it('invokes deleteEndpointPolicy without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteEndpointPolicy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listEndpointPolicies', () => {
        it('invokes listEndpointPolicies without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listEndpointPolicies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
