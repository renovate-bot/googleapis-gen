...
from google.cloud.networkservices_v1beta1.services.network_services import NetworkServicesAsyncClient
from google.cloud.networkservices_v1beta1.services.network_services import NetworkServicesClient
from google.cloud.networkservices_v1beta1.services.network_services import pagers
from google.cloud.networkservices_v1beta1.services.network_services import transports
from google.cloud.networkservices_v1beta1.services.network_services.transports.base import _GOOGLE_AUTH_VERSION
...
def test_network_services_client_client_options_from_dict():
    with mock.patch('google.cloud.networkservices_v1beta1.services.network_services.transports.NetworkServicesGrpcTransport.__init__') as grpc_transport:
...
def test_network_services_base_transport():
    ...
    with mock.patch('google.cloud.networkservices_v1beta1.services.network_services.transports.NetworkServicesTransport.__init__') as Transport:
...
def test_network_services_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.networkservices_v1beta1.services.network_services.transports.NetworkServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_network_services_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.networkservices_v1beta1.services.network_services.transports.NetworkServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_network_services_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.networkservices_v1beta1.services.network_services.transports.NetworkServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworkServicesTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_network_services_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        NetworkServicesClient()
...
@requires_google_auth_lt_1_25_0
def test_network_services_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
