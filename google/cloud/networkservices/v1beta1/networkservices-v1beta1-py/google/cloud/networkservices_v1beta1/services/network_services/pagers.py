...
class ListEndpointPoliciesPager:
    ...
    :class:`google.cloud.networkservices_v1beta1.types.ListEndpointPoliciesResponse` object, and
    ...
    All the usual :class:`google.cloud.networkservices_v1beta1.types.ListEndpointPoliciesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.networkservices_v1beta1.types.ListEndpointPoliciesResponse):
    ...
    @property
    def pages(self) -> Iterable[endpoint_policy.ListEndpointPoliciesResponse]:
    ...
    def __iter__(self) -> Iterable[endpoint_policy.EndpointPolicy]:
...
class ListEndpointPoliciesAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterable[endpoint_policy.ListEndpointPoliciesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
    ...
    def __aiter__(self) -> AsyncIterable[endpoint_policy.EndpointPolicy]:
