...
class EndpointPolicy(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The timestamp when the resource
            was updated.
        labels (Sequence[google.cloud.networkservices_v1beta1.types.EndpointPolicy.LabelsEntry]):
            Optional. Set of label tags associated with
            the EndpointPolicy resource.
        type_ (google.cloud.networkservices_v1beta1.types.EndpointPolicy.EndpointPolicyType):
        ...
        authorization_policy (str):
            ...
            AuthorizationPolicy resource that applies authorization
            policies to the inbound traffic at the matched endpoints.
            Refer to Authorization. If this field is not specified,
            authorization is disabled(no authz checks) for this
            endpoint. Applicable only when EndpointPolicyType is
            SIDECAR_PROXY.
        endpoint_matcher (google.cloud.networkservices_v1beta1.types.EndpointMatcher):
            Required. A matcher that selects endpoints to
            which the policies should be applied.
        traffic_port_selector (google.cloud.networkservices_v1beta1.types.TrafficPortSelector):
