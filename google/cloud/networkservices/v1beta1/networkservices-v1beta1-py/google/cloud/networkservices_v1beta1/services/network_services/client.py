...
from google.cloud.networkservices_v1beta1.types import common
from google.cloud.networkservices_v1beta1.types import endpoint_policy
from google.cloud.networkservices_v1beta1.types import endpoint_policy as gcn_endpoint_policy
...
class NetworkServicesClient(metaclass=NetworkServicesClientMeta):
    ...
    def list_endpoint_policies(self,
        ...
        Returns:
            google.cloud.networkservices_v1beta1.services.network_services.pagers.ListEndpointPoliciesPager:
    ...
    def get_endpoint_policy(self,
        ...
        Returns:
            google.cloud.networkservices_v1beta1.types.EndpointPolicy:
    ...
    def create_endpoint_policy(self,
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.networkservices_v1beta1.types.EndpointPolicy` EndpointPolicy is a resource that helps apply desired configuration
