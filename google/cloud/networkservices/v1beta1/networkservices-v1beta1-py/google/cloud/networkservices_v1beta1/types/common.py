...
class EndpointMatcher(proto.Message):
    ...
    class MetadataLabelMatcher(proto.Message):
        ...
        Attributes:
            metadata_label_match_criteria (google.cloud.networkservices_v1beta1.types.EndpointMatcher.MetadataLabelMatcher.MetadataLabelMatchCriteria):
            ...
            metadata_labels (Sequence[google.cloud.networkservices_v1beta1.types.EndpointMatcher.MetadataLabelMatcher.MetadataLabels]):
