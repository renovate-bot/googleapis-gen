...
from .base import NetworkServicesTransport, DEFAULT_CLIENT_INFO
...
class NetworkServicesGrpcAsyncIOTransport(NetworkServicesTransport):
    ...
    @property
    def list_endpoint_policies(self) -> Callable[
    ...
    @property
    def get_endpoint_policy(self) -> Callable[
    ...
    @property
    def create_endpoint_policy(self) -> Callable[
    ...
    @property
    def update_endpoint_policy(self) -> Callable[
    ...
    @property
    def delete_endpoint_policy(self) -> Callable[
