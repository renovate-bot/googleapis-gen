...
class DeviceManagerClient(metaclass=DeviceManagerClientMeta):
    ...
    def modify_cloud_to_device_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.modify_cloud_to_device_config]
    ...
    def list_device_config_versions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_device_config_versions]
    ...
    def unbind_device_from_gateway(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.unbind_device_from_gateway]
