 ...
 * `src/v2/account_management_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './account_management_service_client_config.json';
 ...
 * @memberof v2
 */
export class AccountManagementServiceClient {
  ...
  accountManagementServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of AccountManagementServiceClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AccountManagementServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.identitytoolkit.v2.AccountManagementService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.accountManagementServiceStub) {
      return this.accountManagementServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.identitytoolkit.v2.AccountManagementService.
    this.accountManagementServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.identitytoolkit.v2.AccountManagementService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.identitytoolkit.v2.AccountManagementService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const accountManagementServiceStubMethods =
        ['finalizeMfaEnrollment', 'startMfaEnrollment', 'withdrawMfa'];
    for (const methodName of accountManagementServiceStubMethods) {
      const callPromise = this.accountManagementServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing [FinalizeMfaEnrollmentResponse]{@link google.cloud.identitytoolkit.v2.FinalizeMfaEnrollmentResponse}.
 *   Please see the
 ...
 * @param {google.cloud.identitytoolkit.v2.StartMfaPhoneRequestInfo} request.phoneEnrollmentInfo
 *   Verification info to authorize sending an SMS for phone verification.
 * @param {string} request.tenantId
 *   The ID of the Identity Platform tenant that the user enrolling MFA belongs
 *   to. If not set, the user belongs to the default Identity Platform project.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [StartMfaEnrollmentResponse]{@link google.cloud.identitytoolkit.v2.StartMfaEnrollmentResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [WithdrawMfaResponse]{@link google.cloud.identitytoolkit.v2.WithdrawMfaResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 */
  ...
  close(): Promise<void> {
    this.initialize();
    if (!this._terminated) {
      return this.accountManagementServiceStub!.then(stub => {
