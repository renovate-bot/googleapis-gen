...
func ExampleAuthenticationClient_FinalizeMfaSignIn() {
	...
	req := &identitytoolkitpb.FinalizeMfaSignInRequest{
		...
		// See https://pkg.go.dev/google.golang.org/genproto/googleapis/cloud/identitytoolkit/v2#FinalizeMfaSignInRequest.
	}
...
func ExampleAuthenticationClient_StartMfaSignIn() {
	...
	req := &identitytoolkitpb.StartMfaSignInRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/google.golang.org/genproto/googleapis/cloud/identitytoolkit/v2#StartMfaSignInRequest.
	}
