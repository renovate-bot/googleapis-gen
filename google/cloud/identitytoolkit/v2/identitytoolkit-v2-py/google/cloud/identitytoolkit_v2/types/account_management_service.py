...
class StartMfaEnrollmentRequest(proto.Message):
    ...
    Attributes:
        ...
        phone_enrollment_info (google.cloud.identitytoolkit_v2.types.StartMfaPhoneRequestInfo):
            Verification info to authorize sending an SMS
            for phone verification.
        tenant_id (str):
            The ID of the Identity Platform tenant that
...
class StartMfaEnrollmentResponse(proto.Message):
    ...
    Attributes:
        phone_session_info (google.cloud.identitytoolkit_v2.types.StartMfaPhoneResponseInfo):
            Verification info to authorize sending an SMS
            for phone verification.
    """
