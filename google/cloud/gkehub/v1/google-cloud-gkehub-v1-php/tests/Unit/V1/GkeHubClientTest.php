...
namespace Google\Cloud\GkeHub\Tests\Unit\V1;
...
use Google\Cloud\GkeHub\V1\ListFeaturesResponse;
use Google\Cloud\GkeHub\V1\ListMembershipsResponse;
...
class GkeHubClientTest extends GeneratedTest
{
    ...
    public function createFeatureTest()
    {
        ...
        $this->assertSame('/google.cloud.gkehub.v1.GkeHub/CreateFeature', $actualApiFuncCall);
    ...
    public function createMembershipTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gkehub.v1.GkeHub/CreateMembership', $actualApiFuncCall);
    ...
    public function deleteFeatureTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gkehub.v1.GkeHub/DeleteFeature', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function deleteMembershipTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gkehub.v1.GkeHub/DeleteMembership', $actualApiFuncCall);
    ...
    public function generateConnectManifestTest()
    {
        ...
        $this->assertSame('/google.cloud.gkehub.v1.GkeHub/GenerateConnectManifest', $actualFuncCall);
    ...
    public function getFeatureTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gkehub.v1.GkeHub/GetFeature', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getMembershipTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gkehub.v1.GkeHub/GetMembership', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listFeaturesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gkehub.v1.GkeHub/ListFeatures', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listMembershipsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gkehub.v1.GkeHub/ListMemberships', $actualFuncCall);
    ...
    public function updateMembershipTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gkehub.v1.GkeHub/UpdateMembership', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($name, $actualValue);
