 ...
 *
 * Generated from protobuf message <code>google.cloud.gkehub.v1.GenerateConnectManifestResponse</code>
 */
class GenerateConnectManifestResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\GkeHub\V1\ConnectAgentResource[]|\Google\Protobuf\Internal\RepeatedField $manifest
     *           The ordered list of Kubernetes resources that need to be applied to the
     *           cluster for GKE Connect agent installation/upgrade.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.gkehub.v1.ConnectAgentResource manifest = 1;</code>
     * @param \Google\Cloud\GkeHub\V1\ConnectAgentResource[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
