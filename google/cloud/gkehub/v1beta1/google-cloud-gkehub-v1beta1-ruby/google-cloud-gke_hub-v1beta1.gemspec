...
require File.expand_path("lib/google/cloud/gke_hub/v1beta1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-gke_hub-v1beta1"
  gem.version       = Google::Cloud::GkeHub::V1beta1::VERSION
  ...
  gem.summary       = "API Client library for the GKE Hub V1beta1 API"
