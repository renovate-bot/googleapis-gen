...
class GkeHubMembershipServiceTransport(abc.ABC):
    ...
    @property
    def list_memberships(self) -> typing.Callable[
    ...
    @property
    def get_membership(self) -> typing.Callable[
            [membership.GetMembershipRequest],
            typing.Union[
                membership.Membership,
                typing.Awaitable[membership.Membership]
            ]]:
        raise NotImplementedError()

    @property
    def create_membership(self) -> typing.Callable[
    ...
    @property
    def delete_membership(self) -> typing.Callable[
    ...
    @property
    def update_membership(self) -> typing.Callable[
    ...
    @property
    def generate_connect_manifest(self) -> typing.Callable[
    ...
    @property
    def validate_exclusivity(self) -> typing.Callable[
    ...
    @property
    def generate_exclusivity_manifest(self) -> typing.Callable[
