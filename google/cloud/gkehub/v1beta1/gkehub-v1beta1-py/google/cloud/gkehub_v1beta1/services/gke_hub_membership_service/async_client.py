...
class GkeHubMembershipServiceAsyncClient:
    ...
    from_service_account_info = GkeHubMembershipServiceClient.from_service_account_info
    from_service_account_file = GkeHubMembershipServiceClient.from_service_account_file
