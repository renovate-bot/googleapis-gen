...
require "google/cloud/gke_hub/v1alpha/gke_hub"

class ::Google::Cloud::GkeHub::V1alpha::GkeHub::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::GkeHub::V1alpha::GkeHub::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::GkeHub::V1alpha::GkeHub::Operations::Configuration, config
  end
end
