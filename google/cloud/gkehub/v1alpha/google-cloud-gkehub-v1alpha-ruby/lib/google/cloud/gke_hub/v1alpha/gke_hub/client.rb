    ...
    module GkeHub
      module V1alpha
        module GkeHub
          ...
          # * {::Google::Cloud::GkeHub::V1alpha::Feature Feature}
          #
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::GkeHub::V1alpha::GkeHub::Client::Configuration}
            ...
            #
            #     ::Google::Cloud::GkeHub::V1alpha::GkeHub::Client.configure do |config|
            #       config.timeout = 10.0
            #     end
            #
            ...
            # configuration:
            #
            #     client = ::Google::Cloud::GkeHub::V1alpha::GkeHub::Client.new do |config|
            #       config.timeout = 10.0
            #     end
            #
            ...
            def initialize
              ...
              require "gapic/grpc"
              require "google/cloud/gkehub/v1alpha/service_services_pb"
              ...
              @gke_hub_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::GkeHub::V1alpha::GkeHub::Stub,
            ...
            #
            # @return [::Google::Cloud::GkeHub::V1alpha::GkeHub::Operations]
            #
            ...
            #   {::Google::Cloud::GkeHub::V1alpha::ListFeaturesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::GkeHub::V1alpha::ListFeaturesRequest, ::Hash]
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::GkeHub::V1alpha::Feature>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::GkeHub::V1alpha::Feature>]
            #
            ...
            def list_features request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::GkeHub::V1alpha::ListFeaturesRequest
              ...
              metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                ...
                gapic_version: ::Google::Cloud::Gkehub::V1alpha::VERSION
            ...
            #   {::Google::Cloud::GkeHub::V1alpha::GetFeatureRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::GkeHub::V1alpha::GetFeatureRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::GkeHub::V1alpha::Feature]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def get_feature request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::GkeHub::V1alpha::GetFeatureRequest
            ...
            #   {::Google::Cloud::GkeHub::V1alpha::CreateFeatureRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::GkeHub::V1alpha::CreateFeatureRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #   @param resource [::Google::Cloud::GkeHub::V1alpha::Feature, ::Hash]
            ...
            def create_feature request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::GkeHub::V1alpha::CreateFeatureRequest
            ...
            #   {::Google::Cloud::GkeHub::V1alpha::DeleteFeatureRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::GkeHub::V1alpha::DeleteFeatureRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def delete_feature request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::GkeHub::V1alpha::DeleteFeatureRequest
            ...
            #   {::Google::Cloud::GkeHub::V1alpha::UpdateFeatureRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::GkeHub::V1alpha::UpdateFeatureRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def update_feature request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::GkeHub::V1alpha::UpdateFeatureRequest
            ...
            # {::Google::Cloud::GkeHub::V1alpha::GkeHub::Client::Configuration::Rpcs}
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for list_features
