  ...
  module Cloud
    module GkeHub
      module V1alpha
        ...
        #   @return [::Google::Cloud::GkeHub::V1alpha::FeatureResourceState]
        #     Output only. State of the Feature resource itself.
        # @!attribute [rw] spec
        #   @return [::Google::Cloud::GkeHub::V1alpha::CommonFeatureSpec]
        ...
        #   @return [::Google::Protobuf::Map{::String => ::Google::Cloud::GkeHub::V1alpha::MembershipFeatureSpec}]
        ...
        #     mutating a Feature.
        # @!attribute [r] state
        #   @return [::Google::Cloud::GkeHub::V1alpha::CommonFeatureState]
        #     Output only. The Hub-wide Feature state.
        # @!attribute [r] membership_states
        #   @return [::Google::Protobuf::Map{::String => ::Google::Cloud::GkeHub::V1alpha::MembershipFeatureState}]
        ...
        class Feature
          ...
          #   @return [::String]
          # @!attribute [rw] value
          #   @return [::Google::Cloud::GkeHub::V1alpha::MembershipFeatureSpec]
          ...
          #   @return [::String]
          # @!attribute [rw] value
          #   @return [::Google::Cloud::GkeHub::V1alpha::MembershipFeatureState]
        ...
        # @!attribute [rw] state
        #   @return [::Google::Cloud::GkeHub::V1alpha::FeatureResourceState::State]
        ...
        # on the context.
        # @!attribute [rw] code
        #   @return [::Google::Cloud::GkeHub::V1alpha::FeatureState::Code]
        ...
        #   @return [::Google::Cloud::GkeHub::MultiClusterIngress::V1alpha::FeatureSpec]
        #     Multicluster Ingress-specific spec.
        # @!attribute [rw] cloudauditlogging
        #   @return [::Google::Cloud::GkeHub::CloudAuditLogging::V1alpha::FeatureSpec]
        ...
        # @!attribute [rw] servicemesh
        #   @return [::Google::Cloud::GkeHub::ServiceMesh::V1alpha::FeatureState]
        #     Service Mesh-specific state.
        # @!attribute [r] state
        #   @return [::Google::Cloud::GkeHub::V1alpha::FeatureState]
        ...
        # Membership.
        # @!attribute [rw] servicemesh
        #   @return [::Google::Cloud::GkeHub::ServiceMesh::V1alpha::MembershipState]
        #     Service Mesh-specific state.
        # @!attribute [rw] metering
        #   @return [::Google::Cloud::GkeHub::Metering::V1alpha::MembershipState]
        #     Metering-specific spec.
        # @!attribute [rw] configmanagement
        #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::MembershipState]
