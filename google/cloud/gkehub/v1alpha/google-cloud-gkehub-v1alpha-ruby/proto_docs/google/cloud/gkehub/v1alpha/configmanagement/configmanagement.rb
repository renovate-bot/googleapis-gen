    ...
    module GkeHub
      module ConfigManagement
        module V1alpha
          ...
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::MembershipSpec]
          ...
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::OperatorState]
          #     Current install status of ACM's Operator
          # @!attribute [rw] config_sync_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::ConfigSyncState]
          #     Current sync status
          # @!attribute [rw] policy_controller_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::PolicyControllerState]
          #     PolicyController status
          # @!attribute [rw] binauthz_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::BinauthzState]
          #     Binauthz status
          # @!attribute [rw] hierarchy_controller_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::HierarchyControllerState]
          ...
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::ConfigSync]
          #     Config Sync configuration for the cluster.
          # @!attribute [rw] policy_controller
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::PolicyController]
          #     Policy Controller configuration for the cluster.
          # @!attribute [rw] binauthz
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::BinauthzConfig]
          #     Binauthz conifguration for the cluster.
          # @!attribute [rw] hierarchy_controller
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::HierarchyControllerConfig]
          ...
          # @!attribute [rw] git
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::GitConfig]
          ...
          # @!attribute [rw] hnc
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::DeploymentState]
          ...
          # @!attribute [rw] version
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::HierarchyControllerVersion]
          #     The version for Hierarchy Controller
          # @!attribute [rw] state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::HierarchyControllerDeploymentState]
          ...
          # @!attribute [rw] errors
          #   @return [::Array<::Google::Cloud::GkeHub::ConfigManagement::V1alpha::InstallError>]
          #     Install errors.
          class OperatorState
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          # @!attribute [rw] version
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::ConfigSyncVersion]
          #     The version of ConfigSync deployed
          # @!attribute [rw] deployment_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::ConfigSyncDeploymentState]
          #     Information about the deployment of ConfigSync, including the version
          #     of the various Pods deployed
          # @!attribute [rw] sync_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::SyncState]
          ...
          # @!attribute [rw] code
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::SyncState::SyncCode]
          #     Sync status code
          # @!attribute [rw] errors
          #   @return [::Array<::Google::Cloud::GkeHub::ConfigManagement::V1alpha::SyncError>]
          ...
          #   @return [::Array<::Google::Cloud::GkeHub::ConfigManagement::V1alpha::ErrorResource>]
          ...
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::GroupVersionKind]
          ...
          # @!attribute [rw] version
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::PolicyControllerVersion]
          #     The version of Gatekeeper Policy Controller deployed.
          # @!attribute [rw] deployment_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::GatekeeperDeploymentState]
          ...
          # @!attribute [rw] version
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::BinauthzVersion]
          ...
          # @!attribute [rw] webhook_version
          #   @return [::String]
          #     The version of the binauthz webhook.
          class BinauthzVersion
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          end
          ...
          # @!attribute [rw] gatekeeper_mutation
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1alpha::DeploymentState]
