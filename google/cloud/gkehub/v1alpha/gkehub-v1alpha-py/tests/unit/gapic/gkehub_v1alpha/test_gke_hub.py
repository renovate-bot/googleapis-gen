...
from google.cloud.gkehub_v1alpha.services.gke_hub import GkeHubAsyncClient
from google.cloud.gkehub_v1alpha.services.gke_hub import GkeHubClient
from google.cloud.gkehub_v1alpha.services.gke_hub import pagers
from google.cloud.gkehub_v1alpha.services.gke_hub import transports
from google.cloud.gkehub_v1alpha.services.gke_hub.transports.base import _GOOGLE_AUTH_VERSION
...
def test_gke_hub_client_client_options_from_dict():
    with mock.patch('google.cloud.gkehub_v1alpha.services.gke_hub.transports.GkeHubGrpcTransport.__init__') as grpc_transport:
...
def test_gke_hub_base_transport():
    ...
    with mock.patch('google.cloud.gkehub_v1alpha.services.gke_hub.transports.GkeHubTransport.__init__') as Transport:
...
def test_gke_hub_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.gkehub_v1alpha.services.gke_hub.transports.GkeHubTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_gke_hub_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.gkehub_v1alpha.services.gke_hub.transports.GkeHubTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GkeHubTransport()
        adc.assert_called_once()
