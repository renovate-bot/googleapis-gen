...
from google.cloud.gkehub.cloudauditlogging.v1alpha import cloudauditlogging_pb2  # type: ignore
from google.cloud.gkehub.configmanagement.v1alpha import configmanagement_pb2  # type: ignore
from google.cloud.gkehub.metering.v1alpha import metering_pb2  # type: ignore
from google.cloud.gkehub.multiclusteringress.v1alpha import multiclusteringress_pb2  # type: ignore
from google.cloud.gkehub.servicemesh.v1alpha import servicemesh_pb2  # type: ignore
...
class Feature(proto.Message):
    ...
    Attributes:
        ...
        labels (Sequence[google.cloud.gkehub_v1alpha.types.Feature.LabelsEntry]):
            GCP labels for this Feature.
        resource_state (google.cloud.gkehub_v1alpha.types.FeatureResourceState):
            Output only. State of the Feature resource
            itself.
        spec (google.cloud.gkehub_v1alpha.types.CommonFeatureSpec):
        ...
        membership_specs (Sequence[google.cloud.gkehub_v1alpha.types.Feature.MembershipSpecsEntry]):
            ...
            mutating a Feature.
        state (google.cloud.gkehub_v1alpha.types.CommonFeatureState):
            Output only. The Hub-wide Feature state.
        membership_states (Sequence[google.cloud.gkehub_v1alpha.types.Feature.MembershipStatesEntry]):
...
class FeatureResourceState(proto.Message):
    ...
    Attributes:
        state (google.cloud.gkehub_v1alpha.types.FeatureResourceState.State):
...
class FeatureState(proto.Message):
    ...
    Attributes:
        code (google.cloud.gkehub_v1alpha.types.FeatureState.Code):
...
class CommonFeatureSpec(proto.Message):
    ...
    cloudauditlogging = proto.Field(
        proto.MESSAGE,
        number=108,
        oneof='feature_spec',
        message=cloudauditlogging_pb2.FeatureSpec,
    )
...
class CommonFeatureState(proto.Message):
    ...
    servicemesh = proto.Field(
        proto.MESSAGE,
        number=100,
        oneof='feature_state',
        message=servicemesh_pb2.FeatureState,
    )
    state = proto.Field(
        proto.MESSAGE,
        number=1,
...
class MembershipFeatureState(proto.Message):
    ...
    servicemesh = proto.Field(
        ...
        number=100,
        oneof='feature_state',
        message=servicemesh_pb2.MembershipState,
    )
    metering = proto.Field(
        proto.MESSAGE,
        number=104,
        oneof='feature_state',
        message=metering_pb2.MembershipState,
    )
    configmanagement = proto.Field(
        proto.MESSAGE,
        number=106,
