...
namespace Google\Cloud\GkeHub\V1alpha\FeatureResourceState;
 ...
 *
 * Protobuf type <code>google.cloud.gkehub.v1alpha.FeatureResourceState.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\GkeHub\V1alpha\FeatureResourceState_State::class);
