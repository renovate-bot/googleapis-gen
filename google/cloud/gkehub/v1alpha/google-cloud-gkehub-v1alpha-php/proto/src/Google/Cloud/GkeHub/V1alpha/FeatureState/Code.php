...
namespace Google\Cloud\GkeHub\V1alpha\FeatureState;
 ...
 *
 * Protobuf type <code>google.cloud.gkehub.v1alpha.FeatureState.Code</code>
 */
class Code
{
    /**
...
class_alias(Code::class, \Google\Cloud\GkeHub\V1alpha\FeatureState_Code::class);
