 ...
 *
 * Generated from protobuf message <code>google.cloud.gkehub.v1alpha.Feature</code>
 */
class Feature extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha.FeatureResourceState resource_state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha.CommonFeatureSpec spec = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $spec = null;
    /**
     ...
     * mutating a Feature.
     *
     * Generated from protobuf field <code>map<string, .google.cloud.gkehub.v1alpha.MembershipFeatureSpec> membership_specs = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    private $membership_specs;
    /**
     * Output only. The Hub-wide Feature state.
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha.CommonFeatureState state = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * project number.
     *
     * Generated from protobuf field <code>map<string, .google.cloud.gkehub.v1alpha.MembershipFeatureState> membership_states = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           GCP labels for this Feature.
     *     @type \Google\Cloud\GkeHub\V1alpha\FeatureResourceState $resource_state
     *           Output only. State of the Feature resource itself.
     *     @type \Google\Cloud\GkeHub\V1alpha\CommonFeatureSpec $spec
     *           Optional. Hub-wide Feature configuration. If this Feature does not support any
     *           Hub-wide configuration, this field may be unused.
     ...
     *           reason, it is recommended the same format be used for all entries when
     *           mutating a Feature.
     *     @type \Google\Cloud\GkeHub\V1alpha\CommonFeatureState $state
     *           Output only. The Hub-wide Feature state.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha.FeatureResourceState resource_state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\GkeHub\V1alpha\FeatureResourceState|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha.FeatureResourceState resource_state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\GkeHub\V1alpha\FeatureResourceState $var
     * @return $this
     */
    public function setResourceState($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\GkeHub\V1alpha\FeatureResourceState::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha.CommonFeatureSpec spec = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\GkeHub\V1alpha\CommonFeatureSpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha.CommonFeatureSpec spec = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\GkeHub\V1alpha\CommonFeatureSpec $var
     * @return $this
     */
    public function setSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\GkeHub\V1alpha\CommonFeatureSpec::class);
        $this->spec = $var;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\GkeHub\V1alpha\MembershipFeatureSpec::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha.CommonFeatureState state = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\GkeHub\V1alpha\CommonFeatureState|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha.CommonFeatureState state = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\GkeHub\V1alpha\CommonFeatureState $var
     * @return $this
     */
    public function setState($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\GkeHub\V1alpha\CommonFeatureState::class);
        $this->state = $var;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\GkeHub\V1alpha\MembershipFeatureState::class);
