...
namespace Google\Cloud\GkeHub\V1beta\FeatureResourceState;
 ...
 *
 * Protobuf type <code>google.cloud.gkehub.v1beta.FeatureResourceState.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\GkeHub\V1beta\FeatureResourceState_State::class);
