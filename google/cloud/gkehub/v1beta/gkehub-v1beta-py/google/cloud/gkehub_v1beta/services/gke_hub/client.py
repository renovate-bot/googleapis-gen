...
class GkeHubClient(metaclass=GkeHubClientMeta):
    ...
    **Membership management may be non-trivial:** it is recommended to
    ...
    def feature_path(project: str,location: str,feature: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/features/{feature}".format(project=project, location=location, feature=feature, )

    @staticmethod
    def parse_feature_path(path: str) -> Dict[str,str]:
        """Parses a feature path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/features/(?P<feature>.+?)$", path)
    ...
    def list_features(self,
        ...
        Returns:
            google.cloud.gkehub_v1beta.services.gke_hub.pagers.ListFeaturesPager:
    ...
    def get_feature(self,
        ...
        Returns:
            google.cloud.gkehub_v1beta.types.Feature:
    ...
    def create_feature(self,
        ...
        Args:
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            resource (google.cloud.gkehub_v1beta.types.Feature):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.gkehub_v1beta.types.Feature`
