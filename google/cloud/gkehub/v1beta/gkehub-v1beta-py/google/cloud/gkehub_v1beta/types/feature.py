...
class Feature(proto.Message):
    ...
    Attributes:
        ...
        labels (Sequence[google.cloud.gkehub_v1beta.types.Feature.LabelsEntry]):
            GCP labels for this Feature.
        resource_state (google.cloud.gkehub_v1beta.types.FeatureResourceState):
            Output only. State of the Feature resource
            itself.
        spec (google.cloud.gkehub_v1beta.types.CommonFeatureSpec):
        ...
        membership_specs (Sequence[google.cloud.gkehub_v1beta.types.Feature.MembershipSpecsEntry]):
            ...
            mutating a Feature.
        state (google.cloud.gkehub_v1beta.types.CommonFeatureState):
...
class FeatureResourceState(proto.Message):
    ...
    Attributes:
        state (google.cloud.gkehub_v1beta.types.FeatureResourceState.State):
...
class FeatureState(proto.Message):
    ...
    Attributes:
        code (google.cloud.gkehub_v1beta.types.FeatureState.Code):
