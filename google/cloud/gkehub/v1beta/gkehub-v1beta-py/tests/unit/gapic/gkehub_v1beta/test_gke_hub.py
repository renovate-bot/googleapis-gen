...
from google.cloud.gkehub.configmanagement.v1beta import configmanagement_pb2  # type: ignore
from google.cloud.gkehub.metering.v1beta import metering_pb2  # type: ignore
from google.cloud.gkehub.multiclusteringress.v1beta import multiclusteringress_pb2  # type: ignore
from google.cloud.gkehub_v1beta.services.gke_hub import GkeHubAsyncClient
from google.cloud.gkehub_v1beta.services.gke_hub import GkeHubClient
from google.cloud.gkehub_v1beta.services.gke_hub import pagers
from google.cloud.gkehub_v1beta.services.gke_hub import transports
from google.cloud.gkehub_v1beta.services.gke_hub.transports.base import _GOOGLE_AUTH_VERSION
...
def test_gke_hub_client_client_options_from_dict():
    with mock.patch('google.cloud.gkehub_v1beta.services.gke_hub.transports.GkeHubGrpcTransport.__init__') as grpc_transport:
...
def test_list_features(transport: str = 'grpc', request_type=service.ListFeaturesRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_feature(transport: str = 'grpc', request_type=service.CreateFeatureRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_feature(transport: str = 'grpc', request_type=service.DeleteFeatureRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_gke_hub_base_transport():
    ...
    with mock.patch('google.cloud.gkehub_v1beta.services.gke_hub.transports.GkeHubTransport.__init__') as Transport:
...
def test_gke_hub_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.gkehub_v1beta.services.gke_hub.transports.GkeHubTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_gke_hub_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.gkehub_v1beta.services.gke_hub.transports.GkeHubTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GkeHubTransport()
        adc.assert_called_once()
