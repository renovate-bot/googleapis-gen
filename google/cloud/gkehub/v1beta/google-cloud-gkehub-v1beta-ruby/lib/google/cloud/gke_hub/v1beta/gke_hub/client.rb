    ...
    module GkeHub
      module V1beta
        module GkeHub
          ...
          # * {::Google::Cloud::GkeHub::V1beta::Feature Feature}
          #
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::GkeHub::V1beta::GkeHub::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all GkeHub clients
            #   ::Google::Cloud::GkeHub::V1beta::GkeHub::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::GkeHub::V1beta::GkeHub::Client.new
            #
            #   # Create a client using a custom configuration
            #   client = ::Google::Cloud::GkeHub::V1beta::GkeHub::Client.new do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              require "gapic/grpc"
              require "google/cloud/gkehub/v1beta/service_services_pb"
              ...
              @gke_hub_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::GkeHub::V1beta::GkeHub::Stub,
            ...
            #
            # @return [::Google::Cloud::GkeHub::V1beta::GkeHub::Operations]
            #
            ...
            #   {::Google::Cloud::GkeHub::V1beta::ListFeaturesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::GkeHub::V1beta::ListFeaturesRequest, ::Hash]
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::GkeHub::V1beta::Feature>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::GkeHub::V1beta::Feature>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            #   require "google/cloud/gke_hub/v1beta"
            #
            #   # Create a client object. The client can be reused for multiple calls.
            #   client = Google::Cloud::GkeHub::V1beta::GkeHub::Client.new
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::GkeHub::V1beta::ListFeaturesRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::GkeHub::V1beta::Feature.
            #     p response
            #   end
            #
            def list_features request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::GkeHub::V1beta::ListFeaturesRequest
              ...
              metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                ...
                gapic_version: ::Google::Cloud::GkeHub::V1beta::VERSION
            ...
            #   {::Google::Cloud::GkeHub::V1beta::GetFeatureRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::GkeHub::V1beta::GetFeatureRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::GkeHub::V1beta::Feature]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::GkeHub::V1beta::GetFeatureRequest.new
            #
            #   # Call the get_feature method.
            #   result = client.get_feature request
            #
            #   # The returned object is of type Google::Cloud::GkeHub::V1beta::Feature.
            #   p result
            #
            def get_feature request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::GkeHub::V1beta::GetFeatureRequest
            ...
            #   {::Google::Cloud::GkeHub::V1beta::CreateFeatureRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::GkeHub::V1beta::CreateFeatureRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #   @param resource [::Google::Cloud::GkeHub::V1beta::Feature, ::Hash]
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::GkeHub::V1beta::CreateFeatureRequest.new
            #
            ...
            def create_feature request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::GkeHub::V1beta::CreateFeatureRequest
            ...
            #   {::Google::Cloud::GkeHub::V1beta::DeleteFeatureRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::GkeHub::V1beta::DeleteFeatureRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::GkeHub::V1beta::DeleteFeatureRequest.new
            #
            ...
            def delete_feature request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::GkeHub::V1beta::DeleteFeatureRequest
            ...
            #   {::Google::Cloud::GkeHub::V1beta::UpdateFeatureRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::GkeHub::V1beta::UpdateFeatureRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::GkeHub::V1beta::UpdateFeatureRequest.new
            #
            ...
            def update_feature request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::GkeHub::V1beta::UpdateFeatureRequest
            ...
            # {::Google::Cloud::GkeHub::V1beta::GkeHub::Client::Configuration::Rpcs}
            ...
            #   # list_features to 20 seconds,
            #   # and all remaining timeouts to 10 seconds.
            #   ::Google::Cloud::GkeHub::V1beta::GkeHub::Client.configure do |config|
            #     config.timeout = 10.0
            #     config.rpcs.list_features.timeout = 20.0
            #   end
            #
