    ...
    module GkeHub
      module ConfigManagement
        module V1beta
          ...
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::OperatorState]
          #     Current install status of ACM's Operator
          # @!attribute [rw] config_sync_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::ConfigSyncState]
          #     Current sync status
          # @!attribute [rw] policy_controller_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::PolicyControllerState]
          #     PolicyController status
          # @!attribute [rw] binauthz_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::BinauthzState]
          #     Binauthz status
          # @!attribute [rw] hierarchy_controller_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::HierarchyControllerState]
          ...
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::ConfigSync]
          #     Config Sync configuration for the cluster.
          # @!attribute [rw] policy_controller
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::PolicyController]
          #     Policy Controller configuration for the cluster.
          # @!attribute [rw] binauthz
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::BinauthzConfig]
          #     Binauthz conifguration for the cluster.
          # @!attribute [rw] hierarchy_controller
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::HierarchyControllerConfig]
          ...
          # @!attribute [rw] git
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::GitConfig]
          ...
          # @!attribute [rw] hnc
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::DeploymentState]
          ...
          # @!attribute [rw] version
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::HierarchyControllerVersion]
          #     The version for Hierarchy Controller
          # @!attribute [rw] state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::HierarchyControllerDeploymentState]
          ...
          # @!attribute [rw] errors
          #   @return [::Array<::Google::Cloud::GkeHub::ConfigManagement::V1beta::InstallError>]
          #     Install errors.
          class OperatorState
            include ::Google::Protobuf::MessageExts
            extend ::Google::Protobuf::MessageExts::ClassMethods
          ...
          # @!attribute [rw] version
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::ConfigSyncVersion]
          #     The version of ConfigSync deployed
          # @!attribute [rw] deployment_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::ConfigSyncDeploymentState]
          #     Information about the deployment of ConfigSync, including the version
          #     of the various Pods deployed
          # @!attribute [rw] sync_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::SyncState]
          ...
          # @!attribute [rw] code
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::SyncState::SyncCode]
          #     Sync status code
          # @!attribute [rw] errors
          #   @return [::Array<::Google::Cloud::GkeHub::ConfigManagement::V1beta::SyncError>]
          ...
          #   @return [::Array<::Google::Cloud::GkeHub::ConfigManagement::V1beta::ErrorResource>]
          ...
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::GroupVersionKind]
          ...
          # @!attribute [rw] version
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::PolicyControllerVersion]
          #     The version of Gatekeeper Policy Controller deployed.
          # @!attribute [rw] deployment_state
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::GatekeeperDeploymentState]
          ...
          # @!attribute [rw] version
          #   @return [::Google::Cloud::GkeHub::ConfigManagement::V1beta::BinauthzVersion]
