...
namespace Google\Cloud\GkeHub\V1alpha2\Membership;
 ...
 * during registration.
 *
 * Protobuf type <code>google.cloud.gkehub.v1alpha2.Membership.InfrastructureType</code>
 */
...
class_alias(InfrastructureType::class, \Google\Cloud\GkeHub\V1alpha2\Membership_InfrastructureType::class);
