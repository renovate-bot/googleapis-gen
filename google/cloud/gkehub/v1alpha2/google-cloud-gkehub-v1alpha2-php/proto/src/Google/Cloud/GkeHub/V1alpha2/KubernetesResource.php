 ...
 *
 * Generated from protobuf message <code>google.cloud.gkehub.v1alpha2.KubernetesResource</code>
 */
class KubernetesResource extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.gkehub.v1alpha2.ResourceManifest membership_resources = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * make a UpdateMembership call with an empty field mask.
     *
     * Generated from protobuf field <code>repeated .google.cloud.gkehub.v1alpha2.ResourceManifest connect_resources = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $connect_resources;
    /**
     * Optional. Options for Kubernetes resource generation.
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha2.ResourceOptions resource_options = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           manifest is used to validate the cluster has not been registered with
     *           another Membership.
     *     @type \Google\Cloud\GkeHub\V1alpha2\ResourceManifest[]|\Google\Protobuf\Internal\RepeatedField $membership_resources
     *           Output only. Additional Kubernetes resources that need to be applied to the cluster
     *           after Membership creation, and after every update.
     *           This field is only populated in the Membership returned from a successful
     *           long-running operation from CreateMembership or UpdateMembership. It is not
     ...
     *           the resource manifest after the initial registration, the caller should
     *           make a UpdateMembership call with an empty field mask.
     *     @type \Google\Cloud\GkeHub\V1alpha2\ResourceManifest[]|\Google\Protobuf\Internal\RepeatedField $connect_resources
     *           Output only. The Kubernetes resources for installing the GKE Connect agent.
     *           This field is only populated in the Membership returned from a successful
     *           long-running operation from CreateMembership or UpdateMembership. It is not
     *           populated during normal GetMembership or ListMemberships requests. To get
     *           the resource manifest after the initial registration, the caller should
     *           make a UpdateMembership call with an empty field mask.
     *     @type \Google\Cloud\GkeHub\V1alpha2\ResourceOptions $resource_options
     *           Optional. Options for Kubernetes resource generation.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.gkehub.v1alpha2.ResourceManifest membership_resources = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\GkeHub\V1alpha2\ResourceManifest[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMembershipResources($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\GkeHub\V1alpha2\ResourceManifest::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha2.ResourceOptions resource_options = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\GkeHub\V1alpha2\ResourceOptions|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkehub.v1alpha2.ResourceOptions resource_options = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\GkeHub\V1alpha2\ResourceOptions $var
     * @return $this
     */
    public function setResourceOptions($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\GkeHub\V1alpha2\ResourceOptions::class);
