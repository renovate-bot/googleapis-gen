 ...
 *
 * Generated from protobuf message <code>google.cloud.gkehub.v1alpha2.Authority</code>
 */
class Authority extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>bytes oidc_jwks = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $oidc_jwks = '';
    /**
     ...
     *
     * Generated from protobuf field <code>string workload_identity_pool = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
