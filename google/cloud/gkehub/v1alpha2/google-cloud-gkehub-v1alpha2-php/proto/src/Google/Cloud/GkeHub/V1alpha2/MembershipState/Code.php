...
namespace Google\Cloud\GkeHub\V1alpha2\MembershipState;
 ...
 *
 * Protobuf type <code>google.cloud.gkehub.v1alpha2.MembershipState.Code</code>
 */
class Code
{
    /**
...
class_alias(Code::class, \Google\Cloud\GkeHub\V1alpha2\MembershipState_Code::class);
