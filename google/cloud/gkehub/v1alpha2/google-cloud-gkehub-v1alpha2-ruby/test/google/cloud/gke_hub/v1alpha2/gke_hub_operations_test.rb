...
class ::Google::Cloud::GkeHub::V1alpha2::GkeHub::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::GkeHub::V1alpha2::GkeHub::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::GkeHub::V1alpha2::GkeHub::Operations::Configuration, config
  end
end
