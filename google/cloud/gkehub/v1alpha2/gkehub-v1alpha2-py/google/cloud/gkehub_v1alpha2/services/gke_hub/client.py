...
class GkeHubClient(metaclass=GkeHubClientMeta):
    ...
    **Membership management may be non-trivial:** it is recommended to
    ...
    def list_memberships(self,
        ...
        Returns:
            google.cloud.gkehub_v1alpha2.services.gke_hub.pagers.ListMembershipsPager:
    ...
    def initialize_hub(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a membership.InitializeHubRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, membership.InitializeHubRequest):
            request = membership.InitializeHubRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.initialize_hub]
