...
from google.cloud.gkehub_v1alpha2.services.gke_hub import GkeHubAsyncClient
from google.cloud.gkehub_v1alpha2.services.gke_hub import GkeHubClient
from google.cloud.gkehub_v1alpha2.services.gke_hub import pagers
from google.cloud.gkehub_v1alpha2.services.gke_hub import transports
from google.cloud.gkehub_v1alpha2.services.gke_hub.transports.base import _GOOGLE_AUTH_VERSION
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (GkeHubAsyncClient, transports.GkeHubGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (GkeHubClient, transports.GkeHubGrpcTransport, "grpc", "false"),
    (GkeHubAsyncClient, transports.GkeHubGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(GkeHubClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GkeHubClient))
@mock.patch.object(GkeHubAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GkeHubAsyncClient))
...
def test_gke_hub_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_gke_hub_client_client_options_from_dict():
    with mock.patch('google.cloud.gkehub_v1alpha2.services.gke_hub.transports.GkeHubGrpcTransport.__init__') as grpc_transport:
...
def test_list_memberships(transport: str = 'grpc', request_type=membership.ListMembershipsRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_membership(transport: str = 'grpc', request_type=membership.GetMembershipRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_membership(transport: str = 'grpc', request_type=membership.CreateMembershipRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_membership(transport: str = 'grpc', request_type=membership.DeleteMembershipRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_membership(transport: str = 'grpc', request_type=membership.UpdateMembershipRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_initialize_hub(transport: str = 'grpc', request_type=membership.InitializeHubRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.initialize_hub),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = membership.InitializeHubResponse(
            service_identity='service_identity_value',
            workload_identity_pool='workload_identity_pool_value',
        )
        response = client.initialize_hub(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0] == membership.InitializeHubRequest()

    # Establish that the response is the type that we expect.
    assert isinstance(response, membership.InitializeHubResponse)
    assert response.service_identity == 'service_identity_value'
    assert response.workload_identity_pool == 'workload_identity_pool_value'


def test_initialize_hub_from_dict():
    test_initialize_hub(request_type=dict)


def test_initialize_hub_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_initialize_hub_async(transport: str = 'grpc_asyncio', request_type=membership.InitializeHubRequest):
    client = GkeHubAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(membership.InitializeHubResponse(
            service_identity='service_identity_value',
            workload_identity_pool='workload_identity_pool_value',
        ))
        response = await client.initialize_hub(request)
...
@pytest.mark.asyncio
async def test_initialize_hub_async_from_dict():
    await test_initialize_hub_async(request_type=dict)


def test_initialize_hub_field_headers():
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = membership.InitializeHubRequest()
...
@pytest.mark.asyncio
async def test_initialize_hub_field_headers_async():
    client = GkeHubAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(membership.InitializeHubResponse())
        await client.initialize_hub(request)
...
def test_gke_hub_base_transport():
    ...
    with mock.patch('google.cloud.gkehub_v1alpha2.services.gke_hub.transports.GkeHubTransport.__init__') as Transport:
...
def test_gke_hub_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.gkehub_v1alpha2.services.gke_hub.transports.GkeHubTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_gke_hub_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.gkehub_v1alpha2.services.gke_hub.transports.GkeHubTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GkeHubTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.GkeHubGrpcTransport, transports.GkeHubGrpcAsyncIOTransport])
def test_gke_hub_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.GkeHubGrpcTransport, transports.GkeHubGrpcAsyncIOTransport])
def test_gke_hub_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
