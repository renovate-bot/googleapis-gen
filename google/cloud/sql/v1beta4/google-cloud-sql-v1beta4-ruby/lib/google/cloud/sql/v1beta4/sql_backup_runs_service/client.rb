      ...
      module V1beta4
        module SqlBackupRunsService
          ...
          class Client
            ...
            # ## Example
            #
            # To modify the configuration for all SqlBackupRunsService clients:
            #
            ...
            # ## Examples
            #
            # To create a new SqlBackupRunsService client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::Sql::V1beta4::SqlBackupRunsService::Client.new
            #
            # To create a new SqlBackupRunsService client with a custom
            # configuration:
            #
