      ...
      module V1beta4
        module SqlSslCertsService
          ...
          class Client
            ...
            # ## Example
            #
            # To modify the configuration for all SqlSslCertsService clients:
            #
            ...
            # ## Examples
            #
            # To create a new SqlSslCertsService client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::Sql::V1beta4::SqlSslCertsService::Client.new
            #
            # To create a new SqlSslCertsService client with a custom
            # configuration:
            #
