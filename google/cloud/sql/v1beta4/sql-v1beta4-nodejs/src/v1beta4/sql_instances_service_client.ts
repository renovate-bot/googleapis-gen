...
export class SqlInstancesServiceClient {
  ...
  initialize() {
    ...
    const sqlInstancesServiceStubMethods =
        ['addServerCa', 'clone', 'delete', 'demoteMaster', 'export', 'failover', 'get', 'import', 'insert', 'list', 'listServerCas', 'patch', 'promoteReplica', 'resetSslConfig', 'restart', 'restoreBackup', 'rotateServerCa', 'startReplica', 'stopReplica', 'truncateLog', 'update', 'createEphemeral', 'rescheduleMaintenance', 'verifyExternalSyncSettings', 'startExternalSync'];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [InstancesListResponse]{@link google.cloud.sql.v1beta4.InstancesListResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [InstancesListServerCasResponse]{@link google.cloud.sql.v1beta4.InstancesListServerCasResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [SqlInstancesVerifyExternalSyncSettingsResponse]{@link google.cloud.sql.v1beta4.SqlInstancesVerifyExternalSyncSettingsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
