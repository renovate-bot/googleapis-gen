...
function doStuffWithSqlInstancesServiceClient(client: SqlInstancesServiceClient) {
  client.close();
}
function doStuffWithSqlOperationsServiceClient(client: SqlOperationsServiceClient) {
  client.close();
}
