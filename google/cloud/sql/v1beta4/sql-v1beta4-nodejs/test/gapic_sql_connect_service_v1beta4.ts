...
describe('v1beta4.SqlConnectServiceClient', () => {
    ...
    describe('getConnectSettings', () => {
        it('invokes getConnectSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.sql.v1beta4.GetConnectSettingsRequest());
            request.project = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.sql.v1beta4.ConnectSettings());
    ...
    describe('generateEphemeralCert', () => {
        it('invokes generateEphemeralCert without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.sql.v1beta4.GenerateEphemeralCertRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.sql.v1beta4.GenerateEphemeralCertResponse());
