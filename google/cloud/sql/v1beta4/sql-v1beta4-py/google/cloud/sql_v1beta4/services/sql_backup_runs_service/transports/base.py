...
class SqlBackupRunsServiceTransport(abc.ABC):
    """Abstract transport class for SqlBackupRunsService."""
    ...
    def get(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[cloud_sql_resources.BackupRun]
            ]]:
        raise NotImplementedError()
    ...
    def list(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[cloud_sql_resources.BackupRunsListResponse]
            ]]:
        raise NotImplementedError()
