    ...
    def list(self) -> Callable[
        ...
        if 'list' not in self._stubs:
            self._stubs['list'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=cloud_sql.SqlFlagsListRequest.serialize,
                response_deserializer=cloud_sql_resources.FlagsListResponse.deserialize,
            )
