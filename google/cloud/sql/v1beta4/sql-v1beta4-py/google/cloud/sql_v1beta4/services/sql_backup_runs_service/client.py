...
class SqlBackupRunsServiceClient(metaclass=SqlBackupRunsServiceClientMeta):
    ...
    def delete(self,
        ...
        # in a cloud_sql.SqlBackupRunsDeleteRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql.SqlBackupRunsDeleteRequest):
            request = cloud_sql.SqlBackupRunsDeleteRequest(request)
    ...
    def get(self,
        ...
        Returns:
            google.cloud.sql_v1beta4.types.BackupRun:
                A BackupRun resource.
        """
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql.SqlBackupRunsGetRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql.SqlBackupRunsGetRequest):
            request = cloud_sql.SqlBackupRunsGetRequest(request)
    ...
    def insert(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql.SqlBackupRunsInsertRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql.SqlBackupRunsInsertRequest):
            request = cloud_sql.SqlBackupRunsInsertRequest(request)
    ...
    def list(self,
        ...
        Returns:
            google.cloud.sql_v1beta4.services.sql_backup_runs_service.pagers.ListPager:
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql.SqlBackupRunsListRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql.SqlBackupRunsListRequest):
            request = cloud_sql.SqlBackupRunsListRequest(request)
