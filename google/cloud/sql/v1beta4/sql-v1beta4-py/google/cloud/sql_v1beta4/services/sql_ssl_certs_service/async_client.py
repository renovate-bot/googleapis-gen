...
class SqlSslCertsServiceAsyncClient:
    ...
    async def delete(self,
            request: cloud_sql.SqlSslCertsDeleteRequest = None,
            *,
        ...
        Args:
            request (:class:`google.cloud.sql_v1beta4.types.SqlSslCertsDeleteRequest`):
                The request object.
        ...
        request = cloud_sql.SqlSslCertsDeleteRequest(request)
    ...
    async def get(self,
            request: cloud_sql.SqlSslCertsGetRequest = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (:class:`google.cloud.sql_v1beta4.types.SqlSslCertsGetRequest`):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        """
        # Create or coerce a protobuf request object.
        request = cloud_sql.SqlSslCertsGetRequest(request)
    ...
    async def insert(self,
            request: cloud_sql.SqlSslCertsInsertRequest = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (:class:`google.cloud.sql_v1beta4.types.SqlSslCertsInsertRequest`):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.cloud.sql_v1beta4.types.SslCertsInsertResponse:
                SslCert insert response.
        """
        # Create or coerce a protobuf request object.
        request = cloud_sql.SqlSslCertsInsertRequest(request)
    ...
    async def list(self,
            request: cloud_sql.SqlSslCertsListRequest = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (:class:`google.cloud.sql_v1beta4.types.SqlSslCertsListRequest`):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.cloud.sql_v1beta4.types.SslCertsListResponse:
                SslCerts list response.
        """
        # Create or coerce a protobuf request object.
        request = cloud_sql.SqlSslCertsListRequest(request)
