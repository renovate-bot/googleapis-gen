...
class SqlDatabasesServiceClient(metaclass=SqlDatabasesServiceClientMeta):
    ...
    def delete(self,
        ...
        Args:
            request (google.cloud.sql_v1beta4.types.SqlDatabasesDeleteRequest):
                The request object.
        ...
        # in a cloud_sql.SqlDatabasesDeleteRequest.
    ...
    def get(self,
        ...
        Args:
            request (google.cloud.sql_v1beta4.types.SqlDatabasesGetRequest):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.cloud.sql_v1beta4.types.Database:
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql.SqlDatabasesGetRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def insert(self,
        ...
        Args:
            request (google.cloud.sql_v1beta4.types.SqlDatabasesInsertRequest):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql.SqlDatabasesInsertRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(self,
        ...
        Args:
            request (google.cloud.sql_v1beta4.types.SqlDatabasesListRequest):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.cloud.sql_v1beta4.types.DatabasesListResponse:
                Database list response.
        """
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql.SqlDatabasesListRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def patch(self,
        ...
        Args:
            request (google.cloud.sql_v1beta4.types.SqlDatabasesUpdateRequest):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql.SqlDatabasesUpdateRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
