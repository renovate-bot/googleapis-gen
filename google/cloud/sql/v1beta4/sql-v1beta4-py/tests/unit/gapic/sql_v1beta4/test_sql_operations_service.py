...
from google.cloud.sql_v1beta4.services.sql_operations_service import SqlOperationsServiceAsyncClient
from google.cloud.sql_v1beta4.services.sql_operations_service import SqlOperationsServiceClient
from google.cloud.sql_v1beta4.services.sql_operations_service import pagers
from google.cloud.sql_v1beta4.services.sql_operations_service import transports
from google.cloud.sql_v1beta4.services.sql_operations_service.transports.base import _API_CORE_VERSION
from google.cloud.sql_v1beta4.services.sql_operations_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_sql_operations_service_client_client_options_from_dict():
    with mock.patch('google.cloud.sql_v1beta4.services.sql_operations_service.transports.SqlOperationsServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get(transport: str = 'grpc', request_type=cloud_sql.SqlOperationsGetRequest):
    client = SqlOperationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        assert args[0] == cloud_sql.SqlOperationsGetRequest()
...
@pytest.mark.asyncio
async def test_get_async(transport: str = 'grpc_asyncio', request_type=cloud_sql.SqlOperationsGetRequest):
...
def test_list(transport: str = 'grpc', request_type=cloud_sql.SqlOperationsListRequest):
    client = SqlOperationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0] == cloud_sql.SqlOperationsListRequest()
...
@pytest.mark.asyncio
async def test_list_async(transport: str = 'grpc_asyncio', request_type=cloud_sql.SqlOperationsListRequest):
    client = SqlOperationsServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(cloud_sql_resources.OperationsListResponse(
            kind='kind_value',
            next_page_token='next_page_token_value',
        ))
...
def test_sql_operations_service_base_transport():
    ...
    with mock.patch('google.cloud.sql_v1beta4.services.sql_operations_service.transports.SqlOperationsServiceTransport.__init__') as Transport:
...
def test_sql_operations_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.sql_v1beta4.services.sql_operations_service.transports.SqlOperationsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_sql_operations_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.sql_v1beta4.services.sql_operations_service.transports.SqlOperationsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SqlOperationsServiceTransport()
        adc.assert_called_once()
...
def test_sql_operations_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_sql_operations_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
