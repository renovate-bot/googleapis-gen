...
from google.cloud.sql_v1beta4.services.sql_backup_runs_service.transports.base import _API_CORE_VERSION
from google.cloud.sql_v1beta4.services.sql_backup_runs_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_delete(transport: str = 'grpc', request_type=cloud_sql.SqlBackupRunsDeleteRequest):
    client = SqlBackupRunsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get(transport: str = 'grpc', request_type=cloud_sql.SqlBackupRunsGetRequest):
    client = SqlBackupRunsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert(transport: str = 'grpc', request_type=cloud_sql.SqlBackupRunsInsertRequest):
    client = SqlBackupRunsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list(transport: str = 'grpc', request_type=cloud_sql.SqlBackupRunsListRequest):
    client = SqlBackupRunsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_sql_backup_runs_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_sql_backup_runs_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
