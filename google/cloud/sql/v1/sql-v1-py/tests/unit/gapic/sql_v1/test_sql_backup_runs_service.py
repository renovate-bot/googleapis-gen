...
from google.cloud.sql_v1.services.sql_backup_runs_service import SqlBackupRunsServiceAsyncClient
from google.cloud.sql_v1.services.sql_backup_runs_service import SqlBackupRunsServiceClient
from google.cloud.sql_v1.services.sql_backup_runs_service import pagers
from google.cloud.sql_v1.services.sql_backup_runs_service import transports
from google.cloud.sql_v1.services.sql_backup_runs_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_delete(transport: str = 'grpc', request_type=cloud_sql_backup_runs.SqlBackupRunsDeleteRequest):
    ...
    with mock.patch.object(
        ...
        assert args[0] == cloud_sql_backup_runs.SqlBackupRunsDeleteRequest()
...
@pytest.mark.asyncio
async def test_delete_async(transport: str = 'grpc_asyncio', request_type=cloud_sql_backup_runs.SqlBackupRunsDeleteRequest):
...
def test_get(transport: str = 'grpc', request_type=cloud_sql_backup_runs.SqlBackupRunsGetRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = cloud_sql_backup_runs.BackupRun(
            kind='kind_value',
            status=cloud_sql_backup_runs.SqlBackupRunStatus.ENQUEUED,
            id=205,
            type_=cloud_sql_backup_runs.SqlBackupRunType.AUTOMATED,
            description='description_value',
            instance='instance_value',
            self_link='self_link_value',
            location='location_value',
            backup_kind=cloud_sql_backup_runs.SqlBackupKind.SNAPSHOT,
        )
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0] == cloud_sql_backup_runs.SqlBackupRunsGetRequest()

    # Establish that the response is the type that we expect.
    assert isinstance(response, cloud_sql_backup_runs.BackupRun)
    assert response.kind == 'kind_value'
    assert response.status == cloud_sql_backup_runs.SqlBackupRunStatus.ENQUEUED
    assert response.id == 205
    assert response.type_ == cloud_sql_backup_runs.SqlBackupRunType.AUTOMATED
...
@pytest.mark.asyncio
async def test_get_async(transport: str = 'grpc_asyncio', request_type=cloud_sql_backup_runs.SqlBackupRunsGetRequest):
    client = SqlBackupRunsServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(cloud_sql_backup_runs.BackupRun(
            kind='kind_value',
            status=cloud_sql_backup_runs.SqlBackupRunStatus.ENQUEUED,
            id=205,
            type_=cloud_sql_backup_runs.SqlBackupRunType.AUTOMATED,
...
def test_insert(transport: str = 'grpc', request_type=cloud_sql_backup_runs.SqlBackupRunsInsertRequest):
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0] == cloud_sql_backup_runs.SqlBackupRunsInsertRequest()
...
@pytest.mark.asyncio
async def test_insert_async(transport: str = 'grpc_asyncio', request_type=cloud_sql_backup_runs.SqlBackupRunsInsertRequest):
    client = SqlBackupRunsServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list(transport: str = 'grpc', request_type=cloud_sql_backup_runs.SqlBackupRunsListRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = cloud_sql_backup_runs.BackupRunsListResponse(
            kind='kind_value',
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0] == cloud_sql_backup_runs.SqlBackupRunsListRequest()
...
@pytest.mark.asyncio
async def test_list_async(transport: str = 'grpc_asyncio', request_type=cloud_sql_backup_runs.SqlBackupRunsListRequest):
    client = SqlBackupRunsServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(cloud_sql_backup_runs.BackupRunsListResponse(
            kind='kind_value',
            next_page_token='next_page_token_value',
        ))
...
def test_list_pager():
    ...
    with mock.patch.object(
        ...
        call.side_effect = (
            cloud_sql_backup_runs.BackupRunsListResponse(
                items=[
...
def test_sql_backup_runs_service_base_transport():
    ...
    with mock.patch('google.cloud.sql_v1.services.sql_backup_runs_service.transports.SqlBackupRunsServiceTransport.__init__') as Transport:
...
def test_sql_backup_runs_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.sql_v1.services.sql_backup_runs_service.transports.SqlBackupRunsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_sql_backup_runs_service_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.sql_v1.services.sql_backup_runs_service.transports.SqlBackupRunsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_sql_backup_runs_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.sql_v1.services.sql_backup_runs_service.transports.SqlBackupRunsServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SqlBackupRunsServiceTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_sql_backup_runs_service_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        SqlBackupRunsServiceClient()
...
@requires_google_auth_lt_1_25_0
def test_sql_backup_runs_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
