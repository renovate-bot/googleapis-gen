...
class SqlDatabasesServiceClient(metaclass=SqlDatabasesServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, SqlDatabasesServiceTransport, None] = None,
        ...
        if isinstance(transport, SqlDatabasesServiceTransport):
    ...
    def delete(self,
            request: Union[cloud_sql_databases.SqlDatabasesDeleteRequest, dict] = None,
            *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlDatabasesDeleteRequest, dict]):
        ...
        # in a cloud_sql_databases.SqlDatabasesDeleteRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql_databases.SqlDatabasesDeleteRequest):
    ...
    def get(self,
            request: Union[cloud_sql_databases.SqlDatabasesGetRequest, dict] = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlDatabasesGetRequest, dict]):
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_databases.SqlDatabasesGetRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql_databases.SqlDatabasesGetRequest):
    ...
    def insert(self,
            request: Union[cloud_sql_databases.SqlDatabasesInsertRequest, dict] = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlDatabasesInsertRequest, dict]):
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_databases.SqlDatabasesInsertRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql_databases.SqlDatabasesInsertRequest):
    ...
    def list(self,
            request: Union[cloud_sql_databases.SqlDatabasesListRequest, dict] = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlDatabasesListRequest, dict]):
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_databases.SqlDatabasesListRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql_databases.SqlDatabasesListRequest):
    ...
    def patch(self,
            request: Union[cloud_sql_databases.SqlDatabasesUpdateRequest, dict] = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlDatabasesUpdateRequest, dict]):
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_databases.SqlDatabasesUpdateRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql_databases.SqlDatabasesUpdateRequest):
