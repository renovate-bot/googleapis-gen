...
from .grpc import SqlSslCertsServiceGrpcTransport


class SqlSslCertsServiceGrpcAsyncIOTransport(SqlSslCertsServiceTransport):
    """gRPC AsyncIO backend transport for SqlSslCertsService.
    ...
    def insert(self) -> Callable[
        ...
        Returns:
            Callable[[~.SqlSslCertsInsertRequest],
                    Awaitable[~.SslCertsInsertResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list(self) -> Callable[
        ...
        Returns:
            Callable[[~.SqlSslCertsListRequest],
                    Awaitable[~.SslCertsListResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
