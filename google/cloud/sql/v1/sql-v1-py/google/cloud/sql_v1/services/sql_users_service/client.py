...
class SqlUsersServiceClient(metaclass=SqlUsersServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, SqlUsersServiceTransport, None] = None,
        ...
        if isinstance(transport, SqlUsersServiceTransport):
    ...
    def delete(self,
        ...
        Args:
            request (google.cloud.sql_v1.types.SqlUsersDeleteRequest):
                The request object.
        ...
        # in a cloud_sql_users.SqlUsersDeleteRequest.
    ...
    def insert(self,
        ...
        Args:
            request (google.cloud.sql_v1.types.SqlUsersInsertRequest):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_users.SqlUsersInsertRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(self,
        ...
        Args:
            request (google.cloud.sql_v1.types.SqlUsersListRequest):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_users.SqlUsersListRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update(self,
        ...
        Args:
            request (google.cloud.sql_v1.types.SqlUsersUpdateRequest):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_users.SqlUsersUpdateRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
