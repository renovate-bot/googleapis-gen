...
from .transports.grpc import SqlConnectServiceGrpcTransport
from .transports.grpc_asyncio import SqlConnectServiceGrpcAsyncIOTransport


class SqlConnectServiceClientMeta(type):
    """Metaclass for the SqlConnectService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[SqlConnectServiceTransport]]
    _transport_registry["grpc"] = SqlConnectServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = SqlConnectServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: str = None,
        ) -> Type[SqlConnectServiceTransport]:
...
class SqlConnectServiceClient(metaclass=SqlConnectServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SqlConnectServiceClient: The constructed client.
        """
    ...
    def transport(self) -> SqlConnectServiceTransport:
        ...
        Returns:
            SqlConnectServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Union[str, SqlConnectServiceTransport, None] = None,
        ...
        if isinstance(transport, SqlConnectServiceTransport):
            # transport is a SqlConnectServiceTransport instance.
    ...
    def get_connect_settings(self,
        ...
        Returns:
            google.cloud.sql_v1.types.ConnectSettings:
                Connect settings retrieval response.
        """
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_connect.GetConnectSettingsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql_connect.GetConnectSettingsRequest):
            request = cloud_sql_connect.GetConnectSettingsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_connect_settings]
    ...
    def generate_ephemeral_cert(self,
        ...
        Returns:
            google.cloud.sql_v1.types.GenerateEphemeralCertResponse:
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_connect.GenerateEphemeralCertRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, cloud_sql_connect.GenerateEphemeralCertRequest):
            request = cloud_sql_connect.GenerateEphemeralCertRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_ephemeral_cert]
