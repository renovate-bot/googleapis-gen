...
class SqlOperationsServiceTransport(abc.ABC):
    """Abstract transport class for SqlOperationsService."""
    ...
    def list(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[cloud_sql_operations.OperationsListResponse]
            ]]:
        raise NotImplementedError()


__all__ = (
    'SqlOperationsServiceTransport',
)
