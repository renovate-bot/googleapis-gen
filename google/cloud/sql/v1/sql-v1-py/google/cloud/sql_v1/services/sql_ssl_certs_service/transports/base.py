...
class SqlSslCertsServiceTransport(abc.ABC):
    """Abstract transport class for SqlSslCertsService."""
    ...
    def insert(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[cloud_sql_ssl_certs.SslCertsInsertResponse]
            ]]:
        raise NotImplementedError()
    ...
    def list(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[cloud_sql_ssl_certs.SslCertsListResponse]
            ]]:
        raise NotImplementedError()


__all__ = (
    'SqlSslCertsServiceTransport',
)
