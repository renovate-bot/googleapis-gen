...
class SqlBackupRunsServiceClient(metaclass=SqlBackupRunsServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, SqlBackupRunsServiceTransport, None] = None,
        ...
        if isinstance(transport, SqlBackupRunsServiceTransport):
    ...
    def delete(self,
            request: cloud_sql_backup_runs.SqlBackupRunsDeleteRequest = None,
            *,
        ...
        Args:
            request (google.cloud.sql_v1.types.SqlBackupRunsDeleteRequest):
        ...
        # in a cloud_sql_backup_runs.SqlBackupRunsDeleteRequest.
    ...
    def get(self,
            request: cloud_sql_backup_runs.SqlBackupRunsGetRequest = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (google.cloud.sql_v1.types.SqlBackupRunsGetRequest):
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_backup_runs.SqlBackupRunsGetRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def insert(self,
            request: cloud_sql_backup_runs.SqlBackupRunsInsertRequest = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (google.cloud.sql_v1.types.SqlBackupRunsInsertRequest):
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_backup_runs.SqlBackupRunsInsertRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(self,
            request: cloud_sql_backup_runs.SqlBackupRunsListRequest = None,
            *,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        Args:
            request (google.cloud.sql_v1.types.SqlBackupRunsListRequest):
        ...
        Returns:
            google.cloud.sql_v1.services.sql_backup_runs_service.pagers.ListPager:
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a cloud_sql_backup_runs.SqlBackupRunsListRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
