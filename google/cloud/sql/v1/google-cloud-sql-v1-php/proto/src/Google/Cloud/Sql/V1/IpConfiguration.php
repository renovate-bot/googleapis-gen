...
class IpConfiguration extends \Google\Protobuf\Internal\Message
{
     ...
     *           Whether SSL connections over IP are enforced or not.
     *     @type \Google\Cloud\Sql\V1\AclEntry[]|\Google\Protobuf\Internal\RepeatedField $authorized_networks
     *           The list of external networks that are allowed to connect to the instance
     *           using the IP. In 'CIDR' notation, also known as 'slash' notation (for
     *           example: **192.168.100.0/24**).
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.sql.v1.AclEntry authorized_networks = 4;</code>
     * @param \Google\Cloud\Sql\V1\AclEntry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
