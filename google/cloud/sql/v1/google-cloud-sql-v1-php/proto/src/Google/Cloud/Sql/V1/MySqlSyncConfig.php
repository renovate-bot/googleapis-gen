...
class MySqlSyncConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Sql\V1\SyncFlags[]|\Google\Protobuf\Internal\RepeatedField $initial_sync_flags
     *           Flags to use for the initial dump.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.sql.v1.SyncFlags initial_sync_flags = 1;</code>
     * @param \Google\Cloud\Sql\V1\SyncFlags[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
