...
class BackupRunsListResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $kind
     *           This is always **sql#backupRunsList**.
     *     @type \Google\Cloud\Sql\V1\BackupRun[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of backup runs in reverse chronological order of the enqueued time.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.sql.v1.BackupRun items = 2;</code>
     * @param \Google\Cloud\Sql\V1\BackupRun[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
