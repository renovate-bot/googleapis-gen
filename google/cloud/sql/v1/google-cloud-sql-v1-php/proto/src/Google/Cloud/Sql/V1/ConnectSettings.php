...
class ConnectSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *           SSL configuration.
     *     @type \Google\Cloud\Sql\V1\IpMapping[]|\Google\Protobuf\Internal\RepeatedField $ip_addresses
     *           The assigned IP addresses for the instance.
     *     @type string $region
     *           The cloud region for the instance. e.g. **us-central1**, **europe-west1**.
     *           The region cannot be changed after instance creation.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.sql.v1.IpMapping ip_addresses = 3;</code>
     * @param \Google\Cloud\Sql\V1\IpMapping[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
