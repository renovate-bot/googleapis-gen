 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/sql/v1/cloud_sql_instances.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\Sql\V1\Gapic;
...
use Google\Cloud\Sql\V1\InstancesDemoteMasterRequest;
use Google\Cloud\Sql\V1\InstancesExportRequest;
use Google\Cloud\Sql\V1\InstancesFailoverRequest;
use Google\Cloud\Sql\V1\InstancesImportRequest;
use Google\Cloud\Sql\V1\InstancesListResponse;
use Google\Cloud\Sql\V1\InstancesListServerCasResponse;
use Google\Cloud\Sql\V1\InstancesRestoreBackupRequest;
use Google\Cloud\Sql\V1\InstancesRotateServerCaRequest;
use Google\Cloud\Sql\V1\InstancesTruncateLogRequest;
use Google\Cloud\Sql\V1\MySqlSyncConfig;
...
use Google\Cloud\Sql\V1\SqlInstancesRescheduleMaintenanceRequestBody;
...
use Google\Cloud\Sql\V1\SslCertsCreateEphemeralRequest;
...
class SqlInstancesServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.sql.v1.SqlInstancesService';
     ...
     *     @type int $syncMode
     *           External sync mode.
     *           For allowed values, use constants defined on {@see \Google\Cloud\Sql\V1\SqlInstancesVerifyExternalSyncSettingsRequest\ExternalSyncMode}
