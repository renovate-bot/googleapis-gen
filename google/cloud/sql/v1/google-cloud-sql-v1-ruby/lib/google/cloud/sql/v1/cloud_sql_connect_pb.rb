...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/sql/v1/cloud_sql_connect.proto", :syntax => :proto3) do
    add_message "google.cloud.sql.v1.GetConnectSettingsRequest" do
      optional :instance, :string, 1
      optional :project, :string, 2
      optional :read_time, :message, 7, "google.protobuf.Timestamp"
    end
    add_message "google.cloud.sql.v1.ConnectSettings" do
      optional :kind, :string, 1
      optional :server_ca_cert, :message, 2, "google.cloud.sql.v1.SslCert"
      repeated :ip_addresses, :message, 3, "google.cloud.sql.v1.IpMapping"
      optional :region, :string, 4
      optional :database_version, :enum, 31, "google.cloud.sql.v1.SqlDatabaseVersion"
      optional :backend_type, :enum, 32, "google.cloud.sql.v1.SqlBackendType"
    end
    add_message "google.cloud.sql.v1.GenerateEphemeralCertRequest" do
      optional :instance, :string, 1
      optional :project, :string, 2
    ...
    add_message "google.cloud.sql.v1.GenerateEphemeralCertResponse" do
      optional :ephemeral_cert, :message, 1, "google.cloud.sql.v1.SslCert"
    end
  end
end
