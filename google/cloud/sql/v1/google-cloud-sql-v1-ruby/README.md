# Ruby Client for the Google Cloud Sql V1 API

API Client library for the Google Cloud Sql V1 API

google-cloud-sql-v1 is the official client library for the Google Cloud Sql V1 API.

https://github.com/googleapis/google-cloud-ruby

This gem is a _versioned_ client. It provides basic client classes for a
specific version of the Google Cloud Sql V1 API. Most users should consider using
the main client gem,
...
View the [Client Library Documentation](https://googleapis.dev/ruby/google-cloud-sql-v1/latest)
