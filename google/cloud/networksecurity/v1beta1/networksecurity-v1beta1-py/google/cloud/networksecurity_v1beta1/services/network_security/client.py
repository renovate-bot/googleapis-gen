...
class NetworkSecurityClient(metaclass=NetworkSecurityClientMeta):
    ...
    def list_authorization_policies(self,
        ...
        Returns:
            google.cloud.networksecurity_v1beta1.services.network_security.pagers.ListAuthorizationPoliciesPager:
    ...
    def get_authorization_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.GetAuthorizationPolicyRequest):
    ...
    def create_authorization_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.CreateAuthorizationPolicyRequest):
                The request object. Request used by the
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            authorization_policy (google.cloud.networksecurity_v1beta1.types.AuthorizationPolicy):
    ...
    def update_authorization_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.UpdateAuthorizationPolicyRequest):
                The request object. Request used by the
    ...
    def delete_authorization_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.DeleteAuthorizationPolicyRequest):
                The request object. Request used by the
    ...
    def list_server_tls_policies(self,
        ...
        Returns:
            google.cloud.networksecurity_v1beta1.services.network_security.pagers.ListServerTlsPoliciesPager:
                Response returned by the
                ListServerTlsPolicies method.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def get_server_tls_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.GetServerTlsPolicyRequest):
                The request object. Request used by the
    ...
    def create_server_tls_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.CreateServerTlsPolicyRequest):
                The request object. Request used by the
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            server_tls_policy (google.cloud.networksecurity_v1beta1.types.ServerTlsPolicy):
    ...
    def update_server_tls_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.UpdateServerTlsPolicyRequest):
    ...
    def delete_server_tls_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.DeleteServerTlsPolicyRequest):
                The request object. Request used by the
    ...
    def list_client_tls_policies(self,
        ...
        Returns:
            google.cloud.networksecurity_v1beta1.services.network_security.pagers.ListClientTlsPoliciesPager:
                Response returned by the
                ListClientTlsPolicies method.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def get_client_tls_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.GetClientTlsPolicyRequest):
                The request object. Request used by the
    ...
    def create_client_tls_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.CreateClientTlsPolicyRequest):
                The request object. Request used by the
    ...
    def update_client_tls_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.UpdateClientTlsPolicyRequest):
                The request object. Request used by
    ...
    def delete_client_tls_policy(self,
        ...
        Args:
            request (google.cloud.networksecurity_v1beta1.types.DeleteClientTlsPolicyRequest):
                The request object. Request used by the
