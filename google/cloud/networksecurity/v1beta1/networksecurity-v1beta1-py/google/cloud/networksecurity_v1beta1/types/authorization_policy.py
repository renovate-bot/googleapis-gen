...
class AuthorizationPolicy(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The timestamp when the resource
            was updated.
        labels (Sequence[google.cloud.networksecurity_v1beta1.types.AuthorizationPolicy.LabelsEntry]):
            Optional. Set of label tags associated with
            the AuthorizationPolicy resource.
        action (google.cloud.networksecurity_v1beta1.types.AuthorizationPolicy.Action):
            Required. The action to take when a rule
            match is found. Possible values are "ALLOW" or
            "DENY".
        rules (Sequence[google.cloud.networksecurity_v1beta1.types.AuthorizationPolicy.Rule]):
    ...
    class Rule(proto.Message):
        ...
        Attributes:
            sources (Sequence[google.cloud.networksecurity_v1beta1.types.AuthorizationPolicy.Rule.Source]):
            ...
            destinations (Sequence[google.cloud.networksecurity_v1beta1.types.AuthorizationPolicy.Rule.Destination]):
        ...
        class Destination(proto.Message):
            ...
            Attributes:
                ...
                methods (Sequence[str]):
                    ...
                    for gRPC services.
                http_header_match (google.cloud.networksecurity_v1beta1.types.AuthorizationPolicy.Rule.Destination.HttpHeaderMatch):
...
class ListAuthorizationPoliciesResponse(proto.Message):
    ...
    Attributes:
        authorization_policies (Sequence[google.cloud.networksecurity_v1beta1.types.AuthorizationPolicy]):
