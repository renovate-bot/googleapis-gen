...
def test_network_security_client_service_account_always_use_jwt(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (NetworkSecurityAsyncClient, transports.NetworkSecurityGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (NetworkSecurityClient, transports.NetworkSecurityGrpcTransport, "grpc", "true"),
    (NetworkSecurityAsyncClient, transports.NetworkSecurityGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (NetworkSecurityClient, transports.NetworkSecurityGrpcTransport, "grpc", "false"),
    (NetworkSecurityAsyncClient, transports.NetworkSecurityGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(NetworkSecurityClient, "DEFAULT_ENDPOINT", modify_default_endpoint(NetworkSecurityClient))
@mock.patch.object(NetworkSecurityAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(NetworkSecurityAsyncClient))
...
def test_network_security_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_list_authorization_policies(transport: str = 'grpc', request_type=authorization_policy.ListAuthorizationPoliciesRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_authorization_policies_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, authorization_policy.AuthorizationPolicy)
                   for i in results)
...
def test_get_authorization_policy(transport: str = 'grpc', request_type=authorization_policy.GetAuthorizationPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_authorization_policy(transport: str = 'grpc', request_type=gcn_authorization_policy.CreateAuthorizationPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_authorization_policy_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_authorization_policy(
            parent='parent_value',
            authorization_policy=gcn_authorization_policy.AuthorizationPolicy(name='name_value'),
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].authorization_policy == gcn_authorization_policy.AuthorizationPolicy(name='name_value')
...
def test_update_authorization_policy(transport: str = 'grpc', request_type=gcn_authorization_policy.UpdateAuthorizationPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_authorization_policy(transport: str = 'grpc', request_type=authorization_policy.DeleteAuthorizationPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_server_tls_policies(transport: str = 'grpc', request_type=server_tls_policy.ListServerTlsPoliciesRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_server_tls_policies_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, server_tls_policy.ServerTlsPolicy)
                   for i in results)
...
def test_get_server_tls_policy(transport: str = 'grpc', request_type=server_tls_policy.GetServerTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_server_tls_policy(transport: str = 'grpc', request_type=gcn_server_tls_policy.CreateServerTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_server_tls_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_server_tls_policy_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].server_tls_policy == gcn_server_tls_policy.ServerTlsPolicy(name='name_value')
...
def test_update_server_tls_policy(transport: str = 'grpc', request_type=gcn_server_tls_policy.UpdateServerTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_server_tls_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_server_tls_policy(transport: str = 'grpc', request_type=server_tls_policy.DeleteServerTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_server_tls_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_client_tls_policies(transport: str = 'grpc', request_type=client_tls_policy.ListClientTlsPoliciesRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_client_tls_policies_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, client_tls_policy.ClientTlsPolicy)
                   for i in results)
...
def test_get_client_tls_policy(transport: str = 'grpc', request_type=client_tls_policy.GetClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_client_tls_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_client_tls_policy(transport: str = 'grpc', request_type=gcn_client_tls_policy.CreateClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_client_tls_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_client_tls_policy_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].client_tls_policy == gcn_client_tls_policy.ClientTlsPolicy(name='name_value')
...
def test_update_client_tls_policy(transport: str = 'grpc', request_type=gcn_client_tls_policy.UpdateClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_client_tls_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_client_tls_policy(transport: str = 'grpc', request_type=client_tls_policy.DeleteClientTlsPolicyRequest):
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_client_tls_policy),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@requires_google_auth_lt_1_25_0
def test_network_security_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        NetworkSecurityClient()
...
@requires_google_auth_lt_1_25_0
def test_network_security_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_network_security_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_network_security_host_no_port():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.NetworkSecurityGrpcTransport, transports.NetworkSecurityGrpcAsyncIOTransport])
def test_network_security_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
