...
function main(parent) {
  // [START networksecurity_list_client_tls_policies_sample]
  /**
  ...
  async function listClientTlsPolicies() {
    ...
    // Run request
    const iterable = await networksecurityClient.listClientTlsPoliciesAsync(request);
  ...
  // [END networksecurity_list_client_tls_policies_sample]
}
