 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/networksecurity/v1beta1/network_security.proto
...
class NetworkSecurityGapicClient
{
     ...
     * @experimental
     */
    public function createAuthorizationPolicy($parent, $authorizationPolicyId, $authorizationPolicy, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateAuthorizationPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function createClientTlsPolicy($parent, $clientTlsPolicyId, $clientTlsPolicy, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateClientTlsPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function createServerTlsPolicy($parent, $serverTlsPolicyId, $serverTlsPolicy, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateServerTlsPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteAuthorizationPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteAuthorizationPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteClientTlsPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteClientTlsPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteServerTlsPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteServerTlsPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getAuthorizationPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetAuthorizationPolicy', AuthorizationPolicy::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getClientTlsPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetClientTlsPolicy', ClientTlsPolicy::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getServerTlsPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetServerTlsPolicy', ServerTlsPolicy::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listAuthorizationPolicies($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListAuthorizationPolicies', $optionalArgs, ListAuthorizationPoliciesResponse::class, $request);
    }
    ...
    public function listClientTlsPolicies($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListClientTlsPolicies', $optionalArgs, ListClientTlsPoliciesResponse::class, $request);
    }
    ...
    public function listServerTlsPolicies($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListServerTlsPolicies', $optionalArgs, ListServerTlsPoliciesResponse::class, $request);
    }
     ...
     * @experimental
     */
    public function updateAuthorizationPolicy($authorizationPolicy, array $optionalArgs = [])
    {
        $request = new UpdateAuthorizationPolicyRequest();
        $requestParamHeaders = [];
        $request->setAuthorizationPolicy($authorizationPolicy);
        $requestParamHeaders['authorization_policy.name'] = $authorizationPolicy->getName();
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateAuthorizationPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function updateClientTlsPolicy($clientTlsPolicy, array $optionalArgs = [])
    {
        $request = new UpdateClientTlsPolicyRequest();
        $requestParamHeaders = [];
        $request->setClientTlsPolicy($clientTlsPolicy);
        $requestParamHeaders['client_tls_policy.name'] = $clientTlsPolicy->getName();
        if (isset($optionalArgs['updateMask'])) {
            $request->setUpdateMask($optionalArgs['updateMask']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateClientTlsPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function updateServerTlsPolicy($serverTlsPolicy, array $optionalArgs = [])
    {
        $request = new UpdateServerTlsPolicyRequest();
        $requestParamHeaders = [];
        $request->setServerTlsPolicy($serverTlsPolicy);
        $requestParamHeaders['server_tls_policy.name'] = $serverTlsPolicy->getName();
        if (isset($optionalArgs['updateMask'])) {
            $request->setUpdateMask($optionalArgs['updateMask']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateServerTlsPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
