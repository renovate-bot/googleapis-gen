      ...
      module V1
        module IamChecker
          ...
          class Client
            ...
            ##
            # Configuration class for the IamChecker API.
            #
            # This class represents the configuration for IamChecker,
            # providing control over timeouts, retry behavior, logging, transport
            # parameters, and other low-level controls. Certain parameters can also be
            # applied individually to specific RPCs. See
            # {::Google::Cloud::PolicyTroubleshooter::V1::IamChecker::Client::Configuration::Rpcs}
