 ...
 *
 * Generated from protobuf message <code>google.cloud.security.privateca.v1.ListCertificateRevocationListsResponse</code>
 */
class ListCertificateRevocationListsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return $this->certificate_revocation_lists;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Security\PrivateCA\V1\CertificateRevocationList::class);
        $this->certificate_revocation_lists = $arr;
