...
class CertificateAuthorityServiceClient(metaclass=CertificateAuthorityServiceClientMeta):
    ...
    def activate_certificate_authority(self,
    ...
    def disable_certificate_authority(self,
    ...
    def enable_certificate_authority(self,
    ...
    def fetch_certificate_authority_csr(self,
    ...
    def undelete_certificate_authority(self,
    ...
    def list_certificate_revocation_lists(self,
    ...
    def delete_certificate_template(self,
    ...
    def update_certificate_template(self,
