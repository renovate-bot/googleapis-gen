...
class CertificateAuthorityServiceTransport(abc.ABC):
    ...
    @property
    def create_certificate(self) -> typing.Callable[
            [service.CreateCertificateRequest],
            typing.Union[
                resources.Certificate,
                typing.Awaitable[resources.Certificate]
            ]]:
        raise NotImplementedError()

    @property
    def get_certificate(self) -> typing.Callable[
    ...
    @property
    def list_certificates(self) -> typing.Callable[
    ...
    @property
    def revoke_certificate(self) -> typing.Callable[
    ...
    @property
    def update_certificate(self) -> typing.Callable[
    ...
    @property
    def activate_certificate_authority(self) -> typing.Callable[
    ...
    @property
    def create_certificate_authority(self) -> typing.Callable[
    ...
    @property
    def disable_certificate_authority(self) -> typing.Callable[
    ...
    @property
    def enable_certificate_authority(self) -> typing.Callable[
    ...
    @property
    def fetch_certificate_authority_csr(self) -> typing.Callable[
    ...
    @property
    def get_certificate_authority(self) -> typing.Callable[
    ...
    @property
    def list_certificate_authorities(self) -> typing.Callable[
    ...
    @property
    def restore_certificate_authority(self) -> typing.Callable[
    ...
    @property
    def schedule_delete_certificate_authority(self) -> typing.Callable[
    ...
    @property
    def update_certificate_authority(self) -> typing.Callable[
    ...
    @property
    def get_certificate_revocation_list(self) -> typing.Callable[
    ...
    @property
    def list_certificate_revocation_lists(self) -> typing.Callable[
    ...
    @property
    def update_certificate_revocation_list(self) -> typing.Callable[
    ...
    @property
    def get_reusable_config(self) -> typing.Callable[
            [service.GetReusableConfigRequest],
            typing.Union[
                resources.ReusableConfig,
                typing.Awaitable[resources.ReusableConfig]
            ]]:
        raise NotImplementedError()

    @property
    def list_reusable_configs(self) -> typing.Callable[
