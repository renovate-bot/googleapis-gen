...
class CertificateAuthorityServiceAsyncClient:
    ...
    reusable_config_path = staticmethod(CertificateAuthorityServiceClient.reusable_config_path)
    parse_reusable_config_path = staticmethod(CertificateAuthorityServiceClient.parse_reusable_config_path)
    ...
    from_service_account_info = CertificateAuthorityServiceClient.from_service_account_info
    from_service_account_file = CertificateAuthorityServiceClient.from_service_account_file
