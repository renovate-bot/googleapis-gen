...
class CertificateAuthorityServiceGrpcAsyncIOTransport(CertificateAuthorityServiceTransport):
    ...
    def create_certificate(self) -> Callable[
            ...
            Awaitable[resources.Certificate]]:
    ...
    def activate_certificate_authority(self) -> Callable[
        ...
        if 'activate_certificate_authority' not in self._stubs:
            self._stubs['activate_certificate_authority'] = self.grpc_channel.unary_unary(
    ...
    def disable_certificate_authority(self) -> Callable[
        ...
        if 'disable_certificate_authority' not in self._stubs:
            self._stubs['disable_certificate_authority'] = self.grpc_channel.unary_unary(
    ...
    def fetch_certificate_authority_csr(self) -> Callable[
        ...
        if 'fetch_certificate_authority_csr' not in self._stubs:
            self._stubs['fetch_certificate_authority_csr'] = self.grpc_channel.unary_unary(
    ...
    @property
    def restore_certificate_authority(self) -> Callable[
        ...
        if 'restore_certificate_authority' not in self._stubs:
            self._stubs['restore_certificate_authority'] = self.grpc_channel.unary_unary(
    ...
    @property
    def schedule_delete_certificate_authority(self) -> Callable[
        ...
        if 'schedule_delete_certificate_authority' not in self._stubs:
            self._stubs['schedule_delete_certificate_authority'] = self.grpc_channel.unary_unary(
    ...
    def get_certificate_revocation_list(self) -> Callable[
        ...
        if 'get_certificate_revocation_list' not in self._stubs:
            self._stubs['get_certificate_revocation_list'] = self.grpc_channel.unary_unary(
    ...
    def list_certificate_revocation_lists(self) -> Callable[
        ...
        if 'list_certificate_revocation_lists' not in self._stubs:
            self._stubs['list_certificate_revocation_lists'] = self.grpc_channel.unary_unary(
    ...
    def update_certificate_revocation_list(self) -> Callable[
        ...
        if 'update_certificate_revocation_list' not in self._stubs:
            self._stubs['update_certificate_revocation_list'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_reusable_config(self) -> Callable[
            [service.GetReusableConfigRequest],
            Awaitable[resources.ReusableConfig]]:
    ...
    @property
    def list_reusable_configs(self) -> Callable[
