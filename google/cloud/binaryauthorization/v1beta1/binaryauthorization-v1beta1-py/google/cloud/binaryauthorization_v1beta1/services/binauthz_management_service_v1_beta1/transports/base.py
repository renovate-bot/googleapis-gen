...
class BinauthzManagementServiceV1Beta1Transport(abc.ABC):
    ...
    @property
    def get_policy(self) -> typing.Callable[
            [service.GetPolicyRequest],
            typing.Union[
                resources.Policy,
                typing.Awaitable[resources.Policy]
            ]]:
        raise NotImplementedError()

    @property
    def update_policy(self) -> typing.Callable[
    ...
    @property
    def create_attestor(self) -> typing.Callable[
            [service.CreateAttestorRequest],
            typing.Union[
                resources.Attestor,
                typing.Awaitable[resources.Attestor]
            ]]:
        raise NotImplementedError()

    @property
    def get_attestor(self) -> typing.Callable[
    ...
    @property
    def update_attestor(self) -> typing.Callable[
    ...
    @property
    def list_attestors(self) -> typing.Callable[
    ...
    @property
    def delete_attestor(self) -> typing.Callable[
