...
class BinauthzManagementServiceV1Beta1AsyncClient:
    ...
    from_service_account_info = BinauthzManagementServiceV1Beta1Client.from_service_account_info
    from_service_account_file = BinauthzManagementServiceV1Beta1Client.from_service_account_file
    ...
    get_transport_class = functools.partial(type(BinauthzManagementServiceV1Beta1Client).get_transport_class, type(BinauthzManagementServiceV1Beta1Client))

    def __init__(self, *,
            credentials: credentials.Credentials = None,
            transport: Union[str, BinauthzManagementServiceV1Beta1Transport] = 'grpc_asyncio',
    ...
    async def create_attestor(self,
    ...
    async def update_attestor(self,
    ...
    async def delete_attestor(self,
