...
class BinauthzManagementServiceV1Beta1Client(metaclass=BinauthzManagementServiceV1Beta1ClientMeta):
    ...
    def attestor_path(project: str,attestor: str,) -> str:
        ...
        return "projects/{project}/attestors/{attestor}".format(project=project, attestor=attestor, )
