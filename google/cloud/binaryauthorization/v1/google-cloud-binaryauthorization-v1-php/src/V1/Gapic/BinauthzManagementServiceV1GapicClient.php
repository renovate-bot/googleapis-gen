 ...
 *     $response = $binauthzManagementServiceV1Client->createAttestor($formattedParent, $attestorId, $attestor);
 * } finally {
 *     $binauthzManagementServiceV1Client->close();
 * }
 * ```
 *
 ...
 */
class BinauthzManagementServiceV1GapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.binaryauthorization.v1.BinauthzManagementServiceV1';
     ...
     * @param Attestor $attestor     Required. The initial [attestor][google.cloud.binaryauthorization.v1.Attestor] value. The service will
     ...
     *     $binauthzManagementServiceV1Client->deleteAttestor($formattedName);
     * } finally {
     *     $binauthzManagementServiceV1Client->close();
     * }
     * ```
     ...
     * try {
     *     $formattedName = $binauthzManagementServiceV1Client->attestorName('[PROJECT]', '[ATTESTOR]');
     *     $response = $binauthzManagementServiceV1Client->getAttestor($formattedName);
     * } finally {
     *     $binauthzManagementServiceV1Client->close();
     * }
     * ```
     ...
     *     $response = $binauthzManagementServiceV1Client->getPolicy($formattedName);
     * } finally {
     *     $binauthzManagementServiceV1Client->close();
     * }
     * ```
     ...
     *     $pagedResponse = $binauthzManagementServiceV1Client->listAttestors($formattedParent);
     ...
     * try {
     *     $attestor = new Attestor();
     *     $response = $binauthzManagementServiceV1Client->updateAttestor($attestor);
     * } finally {
     *     $binauthzManagementServiceV1Client->close();
     * }
     * ```
     *
     * @param Attestor $attestor     Required. The updated [attestor][google.cloud.binaryauthorization.v1.Attestor] value. The service will
     *                               overwrite the [attestor name][google.cloud.binaryauthorization.v1.Attestor.name] field with the resource name
     ...
     * try {
     *     $policy = new Policy();
     *     $response = $binauthzManagementServiceV1Client->updatePolicy($policy);
     * } finally {
     *     $binauthzManagementServiceV1Client->close();
     * }
     * ```
     *
     * @param Policy $policy       Required. A new or updated [policy][google.cloud.binaryauthorization.v1.Policy] value. The service will
