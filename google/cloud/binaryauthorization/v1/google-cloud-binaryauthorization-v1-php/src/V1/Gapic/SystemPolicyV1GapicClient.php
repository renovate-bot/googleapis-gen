 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/binaryauthorization/v1/service.proto
 ...
 *     $response = $systemPolicyV1Client->getSystemPolicy($formattedName);
 * } finally {
 *     $systemPolicyV1Client->close();
 * }
 * ```
 *
 ...
 */
class SystemPolicyV1GapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.binaryauthorization.v1.SystemPolicyV1';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/system_policy_v1_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/system_policy_v1_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/system_policy_v1_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/system_policy_v1_rest_client_config.php',
                ],
            ],
        ];
    }
