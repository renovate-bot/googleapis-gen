...
class CloudRedisTransport(abc.ABC):
    ...
    def get_instance(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[cloud_redis.Instance]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def import_instance(self) -> typing.Callable[
    ...
    @property
    def export_instance(self) -> typing.Callable[
    ...
    @property
    def failover_instance(self) -> typing.Callable[
