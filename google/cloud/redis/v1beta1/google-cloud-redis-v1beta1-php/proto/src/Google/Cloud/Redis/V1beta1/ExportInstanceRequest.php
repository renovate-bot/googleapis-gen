...
class ExportInstanceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *               `projects/{project_id}/locations/{location_id}/instances/{instance_id}`
     *           where `location_id` refers to a GCP region.
     *     @type \Google\Cloud\Redis\V1beta1\OutputConfig $output_config
     *           Required. Specify data to be exported.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.redis.v1beta1.OutputConfig output_config = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Redis\V1beta1\OutputConfig $var
     * @return $this
     */
    public function setOutputConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Redis\V1beta1\OutputConfig::class);
