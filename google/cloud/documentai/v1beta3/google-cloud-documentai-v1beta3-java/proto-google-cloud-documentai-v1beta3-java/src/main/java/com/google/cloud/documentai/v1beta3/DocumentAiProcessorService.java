...
public final class DocumentAiProcessorService {
  ...
  static {
    ...
    internal_static_google_cloud_documentai_v1beta3_BatchProcessMetadata_IndividualProcessStatus_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_documentai_v1beta3_BatchProcessMetadata_IndividualProcessStatus_descriptor,
        new java.lang.String[] { "InputGcsSource", "Status", "OutputGcsDestination", "HumanReviewOperation", });
    internal_static_google_cloud_documentai_v1beta3_ReviewDocumentRequest_descriptor =
      getDescriptor().getMessageTypes().get(5);
    internal_static_google_cloud_documentai_v1beta3_ReviewDocumentRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_documentai_v1beta3_ReviewDocumentRequest_descriptor,
        new java.lang.String[] { "HumanReviewConfig", "Document", });
    internal_static_google_cloud_documentai_v1beta3_ReviewDocumentResponse_descriptor =
