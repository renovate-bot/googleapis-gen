...
public interface DocumentOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.documentai.v1beta3.Document.Page> 
      getPagesList();
  /**
   * <pre>
   * Visual page layout for the [Document][google.cloud.documentai.v1beta3.Document].
   ...
   * <code>repeated .google.cloud.documentai.v1beta3.Document.Page pages = 6;</code>
   */
  com.google.cloud.documentai.v1beta3.Document.PageOrBuilder getPagesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.documentai.v1beta3.Document.Entity> 
      getEntitiesList();
  /**
   * <pre>
   * A list of entities detected on [Document.text][google.cloud.documentai.v1beta3.Document.text]. For document shards,
   ...
   * <code>repeated .google.cloud.documentai.v1beta3.Document.Entity entities = 7;</code>
   */
  com.google.cloud.documentai.v1beta3.Document.EntityOrBuilder getEntitiesOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.documentai.v1beta3.Document.EntityRelation entity_relations = 8;</code>
   */
   ...
   */
  java.util.List<com.google.cloud.documentai.v1beta3.Document.Translation> 
      getTranslationsList();
  /**
   * <pre>
   * A list of translations on [Document.text][google.cloud.documentai.v1beta3.Document.text]. For document shards,
   ...
   */
  java.util.List<com.google.cloud.documentai.v1beta3.Document.TextChange> 
      getTextChangesList();
  /**
   * <pre>
   * A list of text corrections made to [Document.text].  This is usually
   ...
   * <code>repeated .google.cloud.documentai.v1beta3.Document.TextChange text_changes = 14;</code>
   */
  com.google.cloud.documentai.v1beta3.Document.TextChangeOrBuilder getTextChangesOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.documentai.v1beta3.Document.ShardInfo shard_info = 9;</code>
   ...
   * <code>.google.cloud.documentai.v1beta3.Document.ShardInfo shard_info = 9;</code>
   */
  com.google.cloud.documentai.v1beta3.Document.ShardInfoOrBuilder getShardInfoOrBuilder();
   ...
   */
  java.util.List<com.google.cloud.documentai.v1beta3.Document.Revision> 
      getRevisionsList();
  /**
   * <pre>
   * Revision history of this document.
   ...
   * <code>repeated .google.cloud.documentai.v1beta3.Document.Revision revisions = 13;</code>
   */
  com.google.cloud.documentai.v1beta3.Document.RevisionOrBuilder getRevisionsOrBuilder(
      int index);

  public com.google.cloud.documentai.v1beta3.Document.SourceCase getSourceCase();
}
