 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.Document.Page.Layout</code>
 */
class Layout extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.BoundingPoly bounding_poly = 3;</code>
     */
    protected $bounding_poly = null;
    /**
     * Detected orientation for the [Layout][google.cloud.documentai.v1beta3.Document.Page.Layout].
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.Document.Page.Layout.Orientation orientation = 4;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DocumentAI\V1beta3\Document\Page\Layout\Orientation::class);
...
class_alias(Layout::class, \Google\Cloud\DocumentAI\V1beta3\Document_Page_Layout::class);
