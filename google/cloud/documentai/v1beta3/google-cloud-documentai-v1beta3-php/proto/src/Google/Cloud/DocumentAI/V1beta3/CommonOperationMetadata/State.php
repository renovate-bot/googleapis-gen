...
namespace Google\Cloud\DocumentAI\V1beta3\CommonOperationMetadata;
 ...
 *
 * Protobuf type <code>google.cloud.documentai.v1beta3.CommonOperationMetadata.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\DocumentAI\V1beta3\CommonOperationMetadata_State::class);
