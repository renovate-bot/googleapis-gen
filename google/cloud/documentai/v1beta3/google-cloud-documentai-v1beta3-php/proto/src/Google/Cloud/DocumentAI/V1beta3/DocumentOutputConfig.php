 ...
 * as a JSON file.
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.DocumentOutputConfig</code>
 */
class DocumentOutputConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\DocumentAI\V1beta3\DocumentOutputConfig\GcsOutputConfig $gcs_output_config
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.DocumentOutputConfig.GcsOutputConfig gcs_output_config = 1;</code>
     * @param \Google\Cloud\DocumentAI\V1beta3\DocumentOutputConfig\GcsOutputConfig $var
     * @return $this
     */
    public function setGcsOutputConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DocumentAI\V1beta3\DocumentOutputConfig\GcsOutputConfig::class);
