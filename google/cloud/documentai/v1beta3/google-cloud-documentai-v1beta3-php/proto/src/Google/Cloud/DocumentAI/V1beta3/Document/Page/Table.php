...
namespace Google\Cloud\DocumentAI\V1beta3\Document\Page;
 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.Document.Page.Table</code>
 */
class Table extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.documentai.v1beta3.Document.Page.Table.TableRow header_rows = 2;</code>
     */
    private $header_rows;
    /**
     * Body rows of the table.
     *
     * Generated from protobuf field <code>repeated .google.cloud.documentai.v1beta3.Document.Page.Table.TableRow body_rows = 3;</code>
     */
    private $body_rows;
    /**
     ...
     *           [Layout][google.cloud.documentai.v1beta3.Document.Page.Layout] for [Table][google.cloud.documentai.v1beta3.Document.Page.Table].
     *     @type \Google\Cloud\DocumentAI\V1beta3\Document\Page\Table\TableRow[]|\Google\Protobuf\Internal\RepeatedField $header_rows
     *           Header rows of the table.
     *     @type \Google\Cloud\DocumentAI\V1beta3\Document\Page\Table\TableRow[]|\Google\Protobuf\Internal\RepeatedField $body_rows
     *           Body rows of the table.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.documentai.v1beta3.Document.Page.Table.TableRow header_rows = 2;</code>
     * @param \Google\Cloud\DocumentAI\V1beta3\Document\Page\Table\TableRow[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setHeaderRows($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DocumentAI\V1beta3\Document\Page\Table\TableRow::class);
...
class_alias(Table::class, \Google\Cloud\DocumentAI\V1beta3\Document_Page_Table::class);
