 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.HumanReviewStatus</code>
 */
class HumanReviewStatus extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.HumanReviewStatus.State state = 1;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DocumentAI\V1beta3\HumanReviewStatus\State::class);
        $this->state = $var;
