 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.Processor</code>
 */
class Processor extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.Processor.State state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     * The default processor version.
     *
     * Generated from protobuf field <code>string default_processor_version = 9;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Documentai\V1Beta3\Processor::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DocumentAI\V1beta3\Processor\State::class);
        $this->state = $var;
