 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.Document.EntityRelation</code>
 */
...
class_alias(EntityRelation::class, \Google\Cloud\DocumentAI\V1beta3\Document_EntityRelation::class);
