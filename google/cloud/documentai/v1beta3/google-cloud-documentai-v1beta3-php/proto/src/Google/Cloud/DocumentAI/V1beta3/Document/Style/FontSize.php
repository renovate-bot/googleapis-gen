...
namespace Google\Cloud\DocumentAI\V1beta3\Document\Style;
 ...
 * Font size with unit.
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.Document.Style.FontSize</code>
 */
...
class_alias(FontSize::class, \Google\Cloud\DocumentAI\V1beta3\Document_Style_FontSize::class);
