...
class ::Google::Cloud::DocumentAI::V1::DocumentProcessorService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::DocumentAI::V1::DocumentProcessorService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DocumentAI::V1::DocumentProcessorService::Operations::Configuration, config
  end
end
