...
public final class DocumentProcessorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.documentai.v1.ProcessRequest,
      com.google.cloud.documentai.v1.ProcessResponse> getProcessDocumentMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.documentai.v1.ProcessRequest,
      com.google.cloud.documentai.v1.ProcessResponse> getProcessDocumentMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.documentai.v1.ProcessRequest, com.google.cloud.documentai.v1.ProcessResponse> getProcessDocumentMethod;
      ...
      synchronized (DocumentProcessorServiceGrpc.class) {
        if ((getProcessDocumentMethod = DocumentProcessorServiceGrpc.getProcessDocumentMethod) == null) {
          DocumentProcessorServiceGrpc.getProcessDocumentMethod = getProcessDocumentMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.documentai.v1.ProcessRequest, com.google.cloud.documentai.v1.ProcessResponse>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.documentai.v1.BatchProcessRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.documentai.v1.BatchProcessRequest,
      com.google.longrunning.Operation> getBatchProcessDocumentsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.documentai.v1.BatchProcessRequest, com.google.longrunning.Operation> getBatchProcessDocumentsMethod;
      ...
      synchronized (DocumentProcessorServiceGrpc.class) {
        if ((getBatchProcessDocumentsMethod = DocumentProcessorServiceGrpc.getBatchProcessDocumentsMethod) == null) {
          DocumentProcessorServiceGrpc.getBatchProcessDocumentsMethod = getBatchProcessDocumentsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.documentai.v1.BatchProcessRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "BatchProcessDocuments"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.documentai.v1.BatchProcessRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.documentai.v1.ReviewDocumentRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = com.google.longrunning.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.documentai.v1.ReviewDocumentRequest,
      com.google.longrunning.Operation> getReviewDocumentMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.documentai.v1.ReviewDocumentRequest, com.google.longrunning.Operation> getReviewDocumentMethod;
      ...
      synchronized (DocumentProcessorServiceGrpc.class) {
        if ((getReviewDocumentMethod = DocumentProcessorServiceGrpc.getReviewDocumentMethod) == null) {
          DocumentProcessorServiceGrpc.getReviewDocumentMethod = getReviewDocumentMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.documentai.v1.ReviewDocumentRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReviewDocument"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.documentai.v1.ReviewDocumentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.longrunning.Operation.getDefaultInstance()))
  ...
  public static abstract class DocumentProcessorServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void processDocument(com.google.cloud.documentai.v1.ProcessRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.documentai.v1.ProcessResponse> responseObserver) {
     ...
     * </pre>
     */
    public void batchProcessDocuments(com.google.cloud.documentai.v1.BatchProcessRequest request,
     ...
     * </pre>
     */
    public void reviewDocument(com.google.cloud.documentai.v1.ReviewDocumentRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
  ...
  public static final class DocumentProcessorServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DocumentProcessorServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.documentai.v1.ProcessResponse processDocument(com.google.cloud.documentai.v1.ProcessRequest request) {
     ...
     * </pre>
     */
    public com.google.longrunning.Operation batchProcessDocuments(com.google.cloud.documentai.v1.BatchProcessRequest request) {
      return blockingUnaryCall(
     ...
     * </pre>
     */
    public com.google.longrunning.Operation reviewDocument(com.google.cloud.documentai.v1.ReviewDocumentRequest request) {
      return blockingUnaryCall(
  ...
  public static final class DocumentProcessorServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DocumentProcessorServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.documentai.v1.ProcessResponse> processDocument(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PROCESS_DOCUMENT:
          serviceImpl.processDocument((com.google.cloud.documentai.v1.ProcessRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.documentai.v1.ProcessResponse>) responseObserver);
          break;
        case METHODID_BATCH_PROCESS_DOCUMENTS:
          serviceImpl.batchProcessDocuments((com.google.cloud.documentai.v1.BatchProcessRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        case METHODID_REVIEW_DOCUMENT:
          serviceImpl.reviewDocument((com.google.cloud.documentai.v1.ReviewDocumentRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        default:
