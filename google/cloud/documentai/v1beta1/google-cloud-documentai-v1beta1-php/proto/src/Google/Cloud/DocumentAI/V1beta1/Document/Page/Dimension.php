 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta1.Document.Page.Dimension</code>
 */
...
class_alias(Dimension::class, \Google\Cloud\DocumentAI\V1beta1\Document_Page_Dimension::class);
