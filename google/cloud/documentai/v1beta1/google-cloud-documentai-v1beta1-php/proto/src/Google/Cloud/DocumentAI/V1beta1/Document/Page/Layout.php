 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta1.Document.Page.Layout</code>
 */
class Layout extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta1.BoundingPoly bounding_poly = 3;</code>
     */
     ...
     * [Layout][google.cloud.documentai.v1beta1.Document.Page.Layout].
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta1.Document.Page.Layout.Orientation orientation = 4;</code>
     */
     ...
     *           single token, a table, a visual element, etc. depending on context.
     *           Range [0, 1].
     *     @type \Google\Cloud\DocumentAI\V1beta1\BoundingPoly $bounding_poly
     *           The bounding polygon for the
     *           [Layout][google.cloud.documentai.v1beta1.Document.Page.Layout].
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta1.BoundingPoly bounding_poly = 3;</code>
     * @param \Google\Cloud\DocumentAI\V1beta1\BoundingPoly $var
     * @return $this
     */
    public function setBoundingPoly($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DocumentAI\V1beta1\BoundingPoly::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DocumentAI\V1beta1\Document\Page\Layout\Orientation::class);
...
class_alias(Layout::class, \Google\Cloud\DocumentAI\V1beta1\Document_Page_Layout::class);
