 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta1.Document.EntityRelation</code>
 */
...
class_alias(EntityRelation::class, \Google\Cloud\DocumentAI\V1beta1\Document_EntityRelation::class);
