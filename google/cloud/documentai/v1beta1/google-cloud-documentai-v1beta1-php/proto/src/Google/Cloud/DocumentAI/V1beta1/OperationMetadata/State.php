...
namespace Google\Cloud\DocumentAI\V1beta1\OperationMetadata;

use UnexpectedValueException;

/**
 * Protobuf type <code>google.cloud.documentai.v1beta1.OperationMetadata.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\DocumentAI\V1beta1\OperationMetadata_State::class);
