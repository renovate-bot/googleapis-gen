 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta1.Document.Style</code>
 */
class Style extends \Google\Protobuf\Internal\Message
{
     ...
     *           <text-decoration-line> <text-decoration-color> <text-decoration-style>
     *           https://www.w3schools.com/cssref/pr_text_text-decoration.asp
     *     @type \Google\Cloud\DocumentAI\V1beta1\Document\Style\FontSize $font_size
     *           Font size.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta1.Document.Style.FontSize font_size = 7;</code>
     * @param \Google\Cloud\DocumentAI\V1beta1\Document\Style\FontSize $var
     * @return $this
     */
    public function setFontSize($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DocumentAI\V1beta1\Document\Style\FontSize::class);
        $this->font_size = $var;
...
class_alias(Style::class, \Google\Cloud\DocumentAI\V1beta1\Document_Style::class);
