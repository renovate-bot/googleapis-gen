...
namespace Google\Cloud\DocumentAI\V1beta1\Document\Page;
 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta1.Document.Page.FormField</code>
 */
class FormField extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage name_detected_languages = 3;</code>
     */
    private $name_detected_languages;
    /**
     * A list of detected languages for value together with confidence.
     *
     * Generated from protobuf field <code>repeated .google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage value_detected_languages = 4;</code>
     */
     ...
     *
     *     @type \Google\Cloud\DocumentAI\V1beta1\Document\Page\Layout $field_name
     *           [Layout][google.cloud.documentai.v1beta1.Document.Page.Layout] for the
     *           [FormField][google.cloud.documentai.v1beta1.Document.Page.FormField]
     *           name. e.g. `Address`, `Email`, `Grand total`, `Phone number`, etc.
     *     @type \Google\Cloud\DocumentAI\V1beta1\Document\Page\Layout $field_value
     *           [Layout][google.cloud.documentai.v1beta1.Document.Page.Layout] for the
     *           [FormField][google.cloud.documentai.v1beta1.Document.Page.FormField]
     *           value.
     *     @type \Google\Cloud\DocumentAI\V1beta1\Document\Page\DetectedLanguage[]|\Google\Protobuf\Internal\RepeatedField $name_detected_languages
     *           A list of detected languages for name together with confidence.
     *     @type \Google\Cloud\DocumentAI\V1beta1\Document\Page\DetectedLanguage[]|\Google\Protobuf\Internal\RepeatedField $value_detected_languages
     *           A list of detected languages for value together with confidence.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta1.Document.Page.Layout field_name = 1;</code>
     * @param \Google\Cloud\DocumentAI\V1beta1\Document\Page\Layout $var
     * @return $this
     */
    public function setFieldName($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DocumentAI\V1beta1\Document\Page\Layout::class);
        $this->field_name = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage name_detected_languages = 3;</code>
     * @param \Google\Cloud\DocumentAI\V1beta1\Document\Page\DetectedLanguage[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setNameDetectedLanguages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DocumentAI\V1beta1\Document\Page\DetectedLanguage::class);
...
class_alias(FormField::class, \Google\Cloud\DocumentAI\V1beta1\Document_Page_FormField::class);
