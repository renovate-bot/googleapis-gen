...
namespace Google\Cloud\DocumentAI\V1beta1\Document\Page\Layout;
 ...
 *
 * Protobuf type <code>google.cloud.documentai.v1beta1.Document.Page.Layout.Orientation</code>
 */
class Orientation
{
    /**
...
class_alias(Orientation::class, \Google\Cloud\DocumentAI\V1beta1\Document_Page_Layout_Orientation::class);
