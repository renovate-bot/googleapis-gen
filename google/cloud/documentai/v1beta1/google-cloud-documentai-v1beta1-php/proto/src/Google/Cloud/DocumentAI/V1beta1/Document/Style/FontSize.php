...
namespace Google\Cloud\DocumentAI\V1beta1\Document\Style;
 ...
 * Font size with unit.
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta1.Document.Style.FontSize</code>
 */
...
class_alias(FontSize::class, \Google\Cloud\DocumentAI\V1beta1\Document_Style_FontSize::class);
