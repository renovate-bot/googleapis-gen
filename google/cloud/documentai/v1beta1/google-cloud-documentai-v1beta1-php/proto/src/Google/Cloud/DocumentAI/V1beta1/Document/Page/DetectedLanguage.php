 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage</code>
 */
...
class_alias(DetectedLanguage::class, \Google\Cloud\DocumentAI\V1beta1\Document_Page_DetectedLanguage::class);
