 ...
 * shard it is.
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta1.Document.ShardInfo</code>
 */
...
class_alias(ShardInfo::class, \Google\Cloud\DocumentAI\V1beta1\Document_ShardInfo::class);
