...
class BatchProcessDocumentsRequest(proto.Message):
    r"""Request to batch process documents as an asynchronous
    operation.
...
class ProcessDocumentRequest(proto.Message):
    ...
    Attributes:
        input_config (google.cloud.documentai_v1beta1.types.InputConfig):
            Required. Information about the input file.
        output_config (google.cloud.documentai_v1beta1.types.OutputConfig):
        ...
        table_extraction_params (google.cloud.documentai_v1beta1.types.TableExtractionParams):
            Controls table extraction behavior. If not
            specified, the system will decide reasonable
            defaults.
        form_extraction_params (google.cloud.documentai_v1beta1.types.FormExtractionParams):
            Controls form extraction behavior. If not
            specified, the system will decide reasonable
            defaults.
        entity_extraction_params (google.cloud.documentai_v1beta1.types.EntityExtractionParams):
            Controls entity extraction behavior. If not
            specified, the system will decide reasonable
            defaults.
        ocr_params (google.cloud.documentai_v1beta1.types.OcrParams):
...
class BatchProcessDocumentsResponse(proto.Message):
    ...
    Attributes:
        responses (Sequence[google.cloud.documentai_v1beta1.types.ProcessDocumentResponse]):
...
class TableExtractionParams(proto.Message):
    ...
    Attributes:
        ...
        table_bound_hints (Sequence[google.cloud.documentai_v1beta1.types.TableBoundHint]):
...
class TableBoundHint(proto.Message):
    ...
    Attributes:
        page_number (int):
            ...
            is 1-based.
        bounding_box (google.cloud.documentai_v1beta1.types.BoundingPoly):
...
class FormExtractionParams(proto.Message):
    ...
    Attributes:
        ...
        key_value_pair_hints (Sequence[google.cloud.documentai_v1beta1.types.KeyValuePairHint]):
...
class OperationMetadata(proto.Message):
    ...
    Attributes:
        state (google.cloud.documentai_v1beta1.types.OperationMetadata.State):
