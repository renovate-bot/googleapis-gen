    ...
    async def batch_process_documents(self,
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.documentai_v1beta1.types.BatchProcessDocumentsResponse` Response to an batch document processing request. This is returned in
