...
from google.cloud.documentai_v1beta1.types import geometry
...
class Document(proto.Message):
    ...
    Attributes:
        ...
        text (str):
            ...
            document.
        text_styles (Sequence[google.cloud.documentai_v1beta1.types.Document.Style]):
            Styles for the
            [Document.text][google.cloud.documentai.v1beta1.Document.text].
        pages (Sequence[google.cloud.documentai_v1beta1.types.Document.Page]):
            Visual page layout for the
            [Document][google.cloud.documentai.v1beta1.Document].
        entities (Sequence[google.cloud.documentai_v1beta1.types.Document.Entity]):
            A list of entities detected on
            [Document.text][google.cloud.documentai.v1beta1.Document.text].
            For document shards, entities in this list may cross shard
            boundaries.
        entity_relations (Sequence[google.cloud.documentai_v1beta1.types.Document.EntityRelation]):
            Relationship among
            [Document.entities][google.cloud.documentai.v1beta1.Document.entities].
        shard_info (google.cloud.documentai_v1beta1.types.Document.ShardInfo):
    ...
    class Style(proto.Message):
        ...
        Attributes:
            text_anchor (google.cloud.documentai_v1beta1.types.Document.TextAnchor):
            ...
            font_size (google.cloud.documentai_v1beta1.types.Document.Style.FontSize):
                Font size.
        """
        ...
        color = proto.Field(proto.MESSAGE, number=2,
            message=gt_color.Color,
        )

        background_color = proto.Field(proto.MESSAGE, number=3,
            message=gt_color.Color,
        )
        ...
        font_size = proto.Field(proto.MESSAGE, number=7,
            message='Document.Style.FontSize',
        )

    class Page(proto.Message):
        r"""A page in a [Document][google.cloud.documentai.v1beta1.Document].
        ...
        Attributes:
            ...
            dimension (google.cloud.documentai_v1beta1.types.Document.Page.Dimension):
                Physical dimension of the page.
            layout (google.cloud.documentai_v1beta1.types.Document.Page.Layout):
                [Layout][google.cloud.documentai.v1beta1.Document.Page.Layout]
                for the page.
            detected_languages (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.DetectedLanguage]):
                A list of detected languages together with
                confidence.
            blocks (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.Block]):
                ...
                and orientation.
            paragraphs (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.Paragraph]):
                A list of visually detected text paragraphs
                on the page. A collection of lines that a human
                would perceive as a paragraph.
            lines (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.Line]):
                A list of visually detected text lines on the
                page. A collection of tokens that a human would
                perceive as a line.
            tokens (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.Token]):
                A list of visually detected tokens on the
                page.
            visual_elements (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.VisualElement]):
                A list of detected non-text visual elements
                e.g. checkbox, signature etc. on the page.
            tables (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.Table]):
                A list of visually detected tables on the
                page.
            form_fields (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.FormField]):
        ...
        class Layout(proto.Message):
            ...
            Attributes:
                ...
                bounding_poly (google.cloud.documentai_v1beta1.types.BoundingPoly):
                    The bounding polygon for the
                    [Layout][google.cloud.documentai.v1beta1.Document.Page.Layout].
                orientation (google.cloud.documentai_v1beta1.types.Document.Page.Layout.Orientation):
            ...
            orientation = proto.Field(proto.ENUM, number=4,
        ...
        class Block(proto.Message):
            ...
            layout = proto.Field(proto.MESSAGE, number=1,
                message='Document.Page.Layout',
            )

            detected_languages = proto.RepeatedField(proto.MESSAGE, number=2,
        ...
        class Token(proto.Message):
            ...
            Attributes:
                ...
                detected_break (google.cloud.documentai_v1beta1.types.Document.Page.Token.DetectedBreak):
            ...
            class DetectedBreak(proto.Message):
                ...
                Attributes:
                    type_ (google.cloud.documentai_v1beta1.types.Document.Page.Token.DetectedBreak.Type):
                        Detected break type.
                """
            ...
            detected_languages = proto.RepeatedField(proto.MESSAGE, number=3,
                message='Document.Page.DetectedLanguage',
            )
        ...
        class Table(proto.Message):
            ...
            Attributes:
                ...
                header_rows (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.Table.TableRow]):
                    Header rows of the table.
                body_rows (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.Table.TableRow]):
            ...
            class TableRow(proto.Message):
                ...
                Attributes:
                    cells (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.Table.TableCell]):
            ...
            class TableCell(proto.Message):
                ...
                detected_languages = proto.RepeatedField(proto.MESSAGE, number=4,
                    message='Document.Page.DetectedLanguage',
                )
            ...
            header_rows = proto.RepeatedField(proto.MESSAGE, number=2,
                message='Document.Page.Table.TableRow',
            )

            body_rows = proto.RepeatedField(proto.MESSAGE, number=3,
                message='Document.Page.Table.TableRow',
            )
        ...
        class FormField(proto.Message):
            ...
            Attributes:
                field_name (google.cloud.documentai_v1beta1.types.Document.Page.Layout):
                    [Layout][google.cloud.documentai.v1beta1.Document.Page.Layout]
                    for the
                    [FormField][google.cloud.documentai.v1beta1.Document.Page.FormField]
                    name. e.g. ``Address``, ``Email``, ``Grand total``,
                    ``Phone number``, etc.
                field_value (google.cloud.documentai_v1beta1.types.Document.Page.Layout):
                    [Layout][google.cloud.documentai.v1beta1.Document.Page.Layout]
                    for the
                    [FormField][google.cloud.documentai.v1beta1.Document.Page.FormField]
                    value.
                name_detected_languages (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.DetectedLanguage]):
                    A list of detected languages for name
                    together with confidence.
                value_detected_languages (Sequence[google.cloud.documentai_v1beta1.types.Document.Page.DetectedLanguage]):
                    A list of detected languages for value
                    together with confidence.
            """

            field_name = proto.Field(proto.MESSAGE, number=1,
                message='Document.Page.Layout',
            )

            field_value = proto.Field(proto.MESSAGE, number=2,
                message='Document.Page.Layout',
            )

            name_detected_languages = proto.RepeatedField(proto.MESSAGE, number=3,
                message='Document.Page.DetectedLanguage',
            )

            value_detected_languages = proto.RepeatedField(proto.MESSAGE, number=4,
                message='Document.Page.DetectedLanguage',
            )
        ...
        dimension = proto.Field(proto.MESSAGE, number=2,
            message='Document.Page.Dimension',
        )

        layout = proto.Field(proto.MESSAGE, number=3,
            message='Document.Page.Layout',
        )
        ...
        blocks = proto.RepeatedField(proto.MESSAGE, number=5,
            message='Document.Page.Block',
        )

        paragraphs = proto.RepeatedField(proto.MESSAGE, number=6,
            message='Document.Page.Paragraph',
        )

        lines = proto.RepeatedField(proto.MESSAGE, number=7,
            message='Document.Page.Line',
        )

        tokens = proto.RepeatedField(proto.MESSAGE, number=8,
            message='Document.Page.Token',
        )

        visual_elements = proto.RepeatedField(proto.MESSAGE, number=9,
            message='Document.Page.VisualElement',
        )

        tables = proto.RepeatedField(proto.MESSAGE, number=10,
            message='Document.Page.Table',
        )

        form_fields = proto.RepeatedField(proto.MESSAGE, number=11,
    ...
    class Entity(proto.Message):
        ...
        Attributes:
            ...
            mention_id (str):
                Canonical mention name. This will be a unique
    ...
    class TextAnchor(proto.Message):
        ...
        Attributes:
            text_segments (Sequence[google.cloud.documentai_v1beta1.types.Document.TextAnchor.TextSegment]):
        ...
        text_segments = proto.RepeatedField(proto.MESSAGE, number=1,
    ...
    text_styles = proto.RepeatedField(proto.MESSAGE, number=5,
        message=Style,
    )

    pages = proto.RepeatedField(proto.MESSAGE, number=6,
        message=Page,
    )

    entities = proto.RepeatedField(proto.MESSAGE, number=7,
        message=Entity,
    )
    ...
    shard_info = proto.Field(proto.MESSAGE, number=9,
        message=ShardInfo,
    )
