...
from google.cloud.documentai_v1beta1.services.document_understanding_service import DocumentUnderstandingServiceAsyncClient
from google.cloud.documentai_v1beta1.services.document_understanding_service import DocumentUnderstandingServiceClient
from google.cloud.documentai_v1beta1.services.document_understanding_service import transports
from google.cloud.documentai_v1beta1.services.document_understanding_service.transports.base import _API_CORE_VERSION
from google.cloud.documentai_v1beta1.services.document_understanding_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_document_understanding_service_client_client_options_from_dict():
    with mock.patch('google.cloud.documentai_v1beta1.services.document_understanding_service.transports.DocumentUnderstandingServiceGrpcTransport.__init__') as grpc_transport:
...
def test_batch_process_documents_flattened():
    ...
    with mock.patch.object(
        ...
        client.batch_process_documents(
            requests=[document_understanding.ProcessDocumentRequest(input_config=document_understanding.InputConfig(gcs_source=document_understanding.GcsSource(uri='uri_value')))],
        )
...
def test_document_understanding_service_base_transport():
    ...
    with mock.patch('google.cloud.documentai_v1beta1.services.document_understanding_service.transports.DocumentUnderstandingServiceTransport.__init__') as Transport:
...
def test_document_understanding_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.documentai_v1beta1.services.document_understanding_service.transports.DocumentUnderstandingServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_document_understanding_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.documentai_v1beta1.services.document_understanding_service.transports.DocumentUnderstandingServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DocumentUnderstandingServiceTransport()
        adc.assert_called_once()
