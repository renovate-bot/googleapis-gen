      ...
      module V1beta2
        module DocumentUnderstandingService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::DocumentAI::V1beta2::DocumentUnderstandingService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # ## Example
            #
            # To modify the configuration for all DocumentUnderstandingService clients:
            #
            ...
            # ## Examples
            #
            # To create a new DocumentUnderstandingService client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::DocumentAI::V1beta2::DocumentUnderstandingService::Client.new
            #
            # To create a new DocumentUnderstandingService client with a custom
            # configuration:
            #
            ...
            def initialize
              ...
              @document_understanding_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::DocumentAI::V1beta2::DocumentUnderstandingService::Stub,
            ...
            #
            # @return [::Google::Cloud::DocumentAI::V1beta2::DocumentUnderstandingService::Operations]
            #
            ...
            #   {::Google::Cloud::DocumentAI::V1beta2::BatchProcessDocumentsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::DocumentAI::V1beta2::BatchProcessDocumentsRequest, ::Hash]
            ...
            def batch_process_documents request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DocumentAI::V1beta2::BatchProcessDocumentsRequest
            ...
            #   {::Google::Cloud::DocumentAI::V1beta2::ProcessDocumentRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::DocumentAI::V1beta2::ProcessDocumentRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @overload process_document(parent: nil, input_config: nil, output_config: nil, document_type: nil, table_extraction_params: nil, form_extraction_params: nil, entity_extraction_params: nil, ocr_params: nil, automl_params: nil)
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::DocumentAI::V1beta2::Document]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def process_document request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::DocumentAI::V1beta2::ProcessDocumentRequest
              ...
              @document_understanding_service_stub.call_rpc :process_document, request, options: options do |response, operation|
                yield response, operation if block_given?
                return response
              end
            rescue ::GRPC::BadStatus => e
            ...
            # {::Google::Cloud::DocumentAI::V1beta2::DocumentUnderstandingService::Client::Configuration::Rpcs}
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for batch_process_documents
