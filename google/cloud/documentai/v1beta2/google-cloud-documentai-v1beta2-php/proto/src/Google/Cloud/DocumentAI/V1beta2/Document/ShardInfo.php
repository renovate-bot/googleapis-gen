 ...
 * shard it is.
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta2.Document.ShardInfo</code>
 */
...
class_alias(ShardInfo::class, \Google\Cloud\DocumentAI\V1beta2\Document_ShardInfo::class);
