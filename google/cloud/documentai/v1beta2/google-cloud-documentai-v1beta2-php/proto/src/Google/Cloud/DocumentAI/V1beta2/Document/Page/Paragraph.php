 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta2.Document.Page.Paragraph</code>
 */
...
class_alias(Paragraph::class, \Google\Cloud\DocumentAI\V1beta2\Document_Page_Paragraph::class);
