 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta2.Document.Page.Table.TableCell</code>
 */
...
class_alias(TableCell::class, \Google\Cloud\DocumentAI\V1beta2\Document_Page_Table_TableCell::class);
