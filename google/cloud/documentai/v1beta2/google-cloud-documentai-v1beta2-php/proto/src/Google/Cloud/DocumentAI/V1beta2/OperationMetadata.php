 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta2.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta2.OperationMetadata.State state = 1;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DocumentAI\V1beta2\OperationMetadata\State::class);
        $this->state = $var;
