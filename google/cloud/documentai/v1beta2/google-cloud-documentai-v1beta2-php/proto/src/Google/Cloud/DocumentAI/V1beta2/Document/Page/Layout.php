 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta2.Document.Page.Layout</code>
 */
class Layout extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta2.Document.Page.Layout.Orientation orientation = 4;</code>
     */
     ...
     *           layout is for. e.g. confidence can be for a single token, a table,
     *           a visual element, etc. depending on context. Range [0, 1].
     *     @type \Google\Cloud\DocumentAI\V1beta2\BoundingPoly $bounding_poly
     *           The bounding polygon for the [Layout][google.cloud.documentai.v1beta2.Document.Page.Layout].
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DocumentAI\V1beta2\Document\Page\Layout\Orientation::class);
...
class_alias(Layout::class, \Google\Cloud\DocumentAI\V1beta2\Document_Page_Layout::class);
