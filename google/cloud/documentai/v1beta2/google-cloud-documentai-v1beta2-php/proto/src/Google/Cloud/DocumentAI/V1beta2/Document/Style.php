 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta2.Document.Style</code>
 */
class Style extends \Google\Protobuf\Internal\Message
{
     ...
     * Font size.
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta2.Document.Style.FontSize font_size = 7;</code>
     */
     ...
     *
     *     @type \Google\Cloud\DocumentAI\V1beta2\Document\TextAnchor $text_anchor
     *           Text anchor indexing into the [Document.text][google.cloud.documentai.v1beta2.Document.text].
     ...
     *           <text-decoration-line> <text-decoration-color> <text-decoration-style>
     *           https://www.w3schools.com/cssref/pr_text_text-decoration.asp
     *     @type \Google\Cloud\DocumentAI\V1beta2\Document\Style\FontSize $font_size
     *           Font size.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta2.Document.TextAnchor text_anchor = 1;</code>
     * @param \Google\Cloud\DocumentAI\V1beta2\Document\TextAnchor $var
     * @return $this
     */
    public function setTextAnchor($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DocumentAI\V1beta2\Document\TextAnchor::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta2.Document.Style.FontSize font_size = 7;</code>
     * @return \Google\Cloud\DocumentAI\V1beta2\Document\Style\FontSize|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta2.Document.Style.FontSize font_size = 7;</code>
     * @param \Google\Cloud\DocumentAI\V1beta2\Document\Style\FontSize $var
     * @return $this
     */
    public function setFontSize($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DocumentAI\V1beta2\Document\Style\FontSize::class);
        $this->font_size = $var;
...
class_alias(Style::class, \Google\Cloud\DocumentAI\V1beta2\Document_Style::class);
