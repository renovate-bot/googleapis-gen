 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta2.Document.Page.DetectedLanguage</code>
 */
...
class_alias(DetectedLanguage::class, \Google\Cloud\DocumentAI\V1beta2\Document_Page_DetectedLanguage::class);
