...
private static final long serialVersionUID = 0L;
  ...
  public interface TextTranslationResultOrBuilder extends
     ...
     * </pre>
     *
     * <code>string detected_source_language_code = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public int getSerializedSize() {
      ...
      if (!getDetectedSourceLanguageCodeBytes().isEmpty()) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(3, detectedSourceLanguageCode_);
      }
