...
from .base import SpeechTranslationServiceTransport, DEFAULT_CLIENT_INFO
from .grpc import SpeechTranslationServiceGrpcTransport


class SpeechTranslationServiceGrpcAsyncIOTransport(SpeechTranslationServiceTransport):
    """gRPC AsyncIO backend transport for SpeechTranslationService.
    ...
    def streaming_translate_speech(self) -> Callable[
        ...
        Returns:
            Callable[[~.StreamingTranslateSpeechRequest],
                    Awaitable[~.StreamingTranslateSpeechResponse]]:
