...
class ResourceSettingsServiceAsyncClient:
    ...
    setting_value_path = staticmethod(ResourceSettingsServiceClient.setting_value_path)
    parse_setting_value_path = staticmethod(ResourceSettingsServiceClient.parse_setting_value_path)
    ...
    def __init__(self, *,
        ...
        """Instantiate the resource settings service client.
    ...
    async def search_setting_values(self,
        ...
        Returns:
            google.cloud.resourcesettings_v1.services.resource_settings_service.pagers.SearchSettingValuesAsyncPager:
                The response from
                SearchSettingValues.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.search_setting_values,
            default_retry=retries.Retry(
                initial=1.0,
                maximum=10.0,
                multiplier=1.3,
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.SearchSettingValuesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    async def get_setting_value(self,
        ...
        Args:
            request (:class:`google.cloud.resourcesettings_v1.types.GetSettingValueRequest`):
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.get_setting_value,
            default_retry=retries.Retry(
                initial=1.0,
                maximum=10.0,
                multiplier=1.3,
    ...
    async def lookup_effective_setting_value(self,
        ...
        Args:
            request (:class:`google.cloud.resourcesettings_v1.types.LookupEffectiveSettingValueRequest`):
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.lookup_effective_setting_value,
            default_retry=retries.Retry(
                initial=1.0,
                maximum=10.0,
                multiplier=1.3,
    ...
    async def create_setting_value(self,
        ...
        Args:
            request (:class:`google.cloud.resourcesettings_v1.types.CreateSettingValueRequest`):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            setting_value (:class:`google.cloud.resourcesettings_v1.types.SettingValue`):
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.create_setting_value,
            default_retry=retries.Retry(
                initial=1.0,
                maximum=10.0,
                multiplier=1.3,
    ...
    async def update_setting_value(self,
        ...
        Args:
            request (:class:`google.cloud.resourcesettings_v1.types.UpdateSettingValueRequest`):
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.update_setting_value,
            default_retry=retries.Retry(
                initial=1.0,
                maximum=10.0,
                multiplier=1.3,
    ...
    async def delete_setting_value(self,
        ...
        Args:
            request (:class:`google.cloud.resourcesettings_v1.types.DeleteSettingValueRequest`):
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.delete_setting_value,
            default_retry=retries.Retry(
                initial=1.0,
                maximum=10.0,
                multiplier=1.3,
