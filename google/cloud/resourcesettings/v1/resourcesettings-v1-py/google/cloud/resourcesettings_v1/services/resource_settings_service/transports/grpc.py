...
class ResourceSettingsServiceGrpcTransport(ResourceSettingsServiceTransport):
    ...
    @property
    def search_setting_values(self) -> Callable[
    ...
    @property
    def get_setting_value(self) -> Callable[
    ...
    @property
    def lookup_effective_setting_value(self) -> Callable[
        ...
        if 'lookup_effective_setting_value' not in self._stubs:
            self._stubs['lookup_effective_setting_value'] = self.grpc_channel.unary_unary(
    ...
    @property
    def create_setting_value(self) -> Callable[
    ...
    @property
    def update_setting_value(self) -> Callable[
    ...
    @property
    def delete_setting_value(self) -> Callable[
