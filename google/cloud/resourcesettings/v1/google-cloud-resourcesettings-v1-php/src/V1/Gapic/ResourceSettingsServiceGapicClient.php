...
class ResourceSettingsServiceGapicClient
{
    ...
    private static function getFolderSettingNameNameTemplate()
    {
        if (self::$folderSettingNameNameTemplate == null) {
            self::$folderSettingNameNameTemplate = new PathTemplate('folders/{folder}/settings/{setting_name}');
        }
    ...
    private static function getOrganizationSettingNameNameTemplate()
    {
        if (self::$organizationSettingNameNameTemplate == null) {
            self::$organizationSettingNameNameTemplate = new PathTemplate('organizations/{organization}/settings/{setting_name}');
        }
    ...
    private static function getProjectNumberSettingNameNameTemplate()
    {
        if (self::$projectNumberSettingNameNameTemplate == null) {
            self::$projectNumberSettingNameNameTemplate = new PathTemplate('projects/{project_number}/settings/{setting_name}');
        }
    ...
    private static function getSettingNameTemplate()
    {
        if (self::$settingNameTemplate == null) {
            self::$settingNameTemplate = new PathTemplate('projects/{project_number}/settings/{setting_name}');
        }
     ...
     */
    public static function organizationSettingNameName($organization, $settingName)
    {
     ...
     */
    public static function projectNumberSettingNameName($projectNumber, $settingName)
    {
    ...
    public function getSetting($name, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetSetting', Setting::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listSettings($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListSettings', $optionalArgs, ListSettingsResponse::class, $request);
    }
    ...
    public function updateSetting($setting, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateSetting', Setting::class, $optionalArgs, $request)->wait();
    }
}
