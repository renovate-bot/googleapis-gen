...
public class QuestionName implements ResourceName {
  ...
  private QuestionName(Builder builder) {
  ...
  public static QuestionName of(String project, String location, String question) {
  ...
  public static QuestionName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_QUESTION.validatedMatch(
            formattedString, "QuestionName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("question"));
  }

  public static List<QuestionName> parseList(List<String> formattedStrings) {
    List<QuestionName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<QuestionName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (QuestionName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      QuestionName that = ((QuestionName) o);
  ...
  /** Builder for projects/{project}/locations/{location}/questions/{question}. */
