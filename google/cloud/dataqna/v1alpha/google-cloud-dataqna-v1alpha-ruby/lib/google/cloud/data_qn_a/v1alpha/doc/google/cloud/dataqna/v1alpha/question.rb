    ...
    module Dataqna
      module V1alpha
        ...
        class InterpretError
          ...
          class InterpretErrorDetails; end
          ...
          #   @return [Array<String>]
          #     Unsupported intents.
          class InterpretUnsupportedDetails; end
          ...
          class InterpretIncompleteQueryDetails; end
          ...
          class InterpretAmbiguityDetails; end
