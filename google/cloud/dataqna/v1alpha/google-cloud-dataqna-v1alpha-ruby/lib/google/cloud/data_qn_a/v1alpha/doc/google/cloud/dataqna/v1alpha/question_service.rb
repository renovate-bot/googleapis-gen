  ...
  module Cloud
    module Dataqna
      module V1alpha
        ...
        class CreateQuestionRequest; end
        ...
        class ExecuteQuestionRequest; end
        ...
        class GetUserFeedbackRequest; end
        ...
        class UpdateUserFeedbackRequest; end
      end
    end
  end
end