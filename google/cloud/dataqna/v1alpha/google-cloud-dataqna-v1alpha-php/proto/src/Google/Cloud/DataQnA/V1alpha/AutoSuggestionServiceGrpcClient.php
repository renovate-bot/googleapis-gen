 ...
 * ```
 */
class AutoSuggestionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Cloud\DataQnA\V1alpha\SuggestQueriesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function SuggestQueries(\Google\Cloud\DataQnA\V1alpha\SuggestQueriesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.dataqna.v1alpha.AutoSuggestionService/SuggestQueries',
        $argument,
        ['\Google\Cloud\DataQnA\V1alpha\SuggestQueriesResponse', 'decode'],
        $metadata, $options);
    }
