...
var file_google_cloud_dataqna_v1alpha_user_feedback_proto_rawDesc = []byte{
	...
	0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x42, 0xdc, 0x01, 0x0a, 0x20, 0x63, 0x6f, 0x6d,
...
var file_google_cloud_dataqna_v1alpha_user_feedback_proto_goTypes = []interface{}{
...
func file_google_cloud_dataqna_v1alpha_user_feedback_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_dataqna_v1alpha_user_feedback_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
