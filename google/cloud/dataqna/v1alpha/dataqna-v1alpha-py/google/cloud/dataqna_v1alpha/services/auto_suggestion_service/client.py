...
class AutoSuggestionServiceClientMeta(type):
    """Metaclass for the AutoSuggestionService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AutoSuggestionServiceTransport]]
...
class AutoSuggestionServiceClient(metaclass=AutoSuggestionServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        """Instantiate the auto suggestion service client.
    ...
    def suggest_queries(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.suggest_queries]
