...
describe('v1alpha1.DatastreamClient', () => {
    it('has servicePath', () => {
        const servicePath = datastreamModule.v1alpha1.DatastreamClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = datastreamModule.v1alpha1.DatastreamClient.apiEndpoint;
        assert(apiEndpoint);
    });
    ...
    describe('getConnectionProfile', () => {
        it('invokes getConnectionProfile without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.GetConnectionProfileRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.ConnectionProfile());
            client.innerApiCalls.getConnectionProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.getConnectionProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getConnectionProfile as SinonStub)
        ...
        it('invokes getConnectionProfile without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.ConnectionProfile());
            client.innerApiCalls.getConnectionProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getConnectionProfile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1alpha1.IConnectionProfile|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getConnectionProfile with error', async () => {
            ...
            client.innerApiCalls.getConnectionProfile = stubSimpleCall(undefined, expectedError);
    ...
    describe('discoverConnectionProfile', () => {
        it('invokes discoverConnectionProfile without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.DiscoverConnectionProfileRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.DiscoverConnectionProfileResponse());
            client.innerApiCalls.discoverConnectionProfile = stubSimpleCall(expectedResponse);
            const [response] = await client.discoverConnectionProfile(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.discoverConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes discoverConnectionProfile without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.DiscoverConnectionProfileResponse());
            client.innerApiCalls.discoverConnectionProfile = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.discoverConnectionProfile(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1alpha1.IDiscoverConnectionProfileResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes discoverConnectionProfile with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.discoverConnectionProfile = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.discoverConnectionProfile(request), expectedError);
            assert((client.innerApiCalls.discoverConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getStream', () => {
        it('invokes getStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.GetStreamRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.Stream());
        ...
        it('invokes getStream without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getStream(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1alpha1.IStream|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getPrivateConnection', () => {
        it('invokes getPrivateConnection without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.GetPrivateConnectionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.PrivateConnection());
            client.innerApiCalls.getPrivateConnection = stubSimpleCall(expectedResponse);
            const [response] = await client.getPrivateConnection(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getPrivateConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getPrivateConnection without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.PrivateConnection());
            client.innerApiCalls.getPrivateConnection = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPrivateConnection(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1alpha1.IPrivateConnection|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getPrivateConnection with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.getPrivateConnection = stubSimpleCall(undefined, expectedError);
    ...
    describe('getRoute', () => {
        it('invokes getRoute without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.GetRouteRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.Route());
            client.innerApiCalls.getRoute = stubSimpleCall(expectedResponse);
            const [response] = await client.getRoute(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getRoute as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getRoute without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.Route());
            client.innerApiCalls.getRoute = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getRoute(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1alpha1.IRoute|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createConnectionProfile', () => {
        it('invokes createConnectionProfile without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.CreateConnectionProfileRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            client.innerApiCalls.createConnectionProfile = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createConnectionProfile(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createConnectionProfile without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.createConnectionProfile = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createConnectionProfile(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datastream.v1alpha1.IConnectionProfile, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datastream.v1alpha1.IConnectionProfile, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes createConnectionProfile with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createConnectionProfile = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createConnectionProfile(request), expectedError);
            assert((client.innerApiCalls.createConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createConnectionProfile with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createConnectionProfile = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createConnectionProfile(request);
        ...
        it('invokes checkCreateConnectionProfileProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateConnectionProfileProgress(expectedResponse.name);
        ...
        it('invokes checkCreateConnectionProfileProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateConnectionProfileProgress(''), expectedError);
    ...
    describe('updateConnectionProfile', () => {
        it('invokes updateConnectionProfile without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.UpdateConnectionProfileRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.updateConnectionProfile = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateConnectionProfile(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateConnectionProfile without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.updateConnectionProfile = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateConnectionProfile with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.updateConnectionProfile = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateConnectionProfile(request), expectedError);
            assert((client.innerApiCalls.updateConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateConnectionProfile with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.updateConnectionProfile = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateConnectionProfile(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.updateConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkUpdateConnectionProfileProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateConnectionProfileProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateConnectionProfileProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateConnectionProfileProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteConnectionProfile', () => {
        it('invokes deleteConnectionProfile without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.DeleteConnectionProfileRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.deleteConnectionProfile = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteConnectionProfile(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteConnectionProfile without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.deleteConnectionProfile = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteConnectionProfile(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes deleteConnectionProfile with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConnectionProfile = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteConnectionProfile(request), expectedError);
            assert((client.innerApiCalls.deleteConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteConnectionProfile with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteConnectionProfile = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteConnectionProfile(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.deleteConnectionProfile as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkDeleteConnectionProfileProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteConnectionProfileProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteConnectionProfileProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteConnectionProfileProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createStream', () => {
        it('invokes createStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.CreateStreamRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes createStream without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createStream(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datastream.v1alpha1.IStream, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datastream.v1alpha1.IStream, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createStream as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('updateStream', () => {
        it('invokes updateStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.UpdateStreamRequest());
            request.stream = {};
            request.stream.name = '';
    ...
    describe('deleteStream', () => {
        it('invokes deleteStream without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.DeleteStreamRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('fetchErrors', () => {
        it('invokes fetchErrors without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.FetchErrorsRequest());
            request.stream = '';
            const expectedHeaderRequestParams = "stream=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.fetchErrors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes fetchErrors without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.fetchErrors = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.fetchErrors(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datastream.v1alpha1.IFetchErrorsResponse, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datastream.v1alpha1.IFetchErrorsResponse, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.fetchErrors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes fetchErrors with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchErrors = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes fetchErrors with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchErrors = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.fetchErrors(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.fetchErrors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkFetchErrorsProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkFetchErrorsProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('createPrivateConnection', () => {
        it('invokes createPrivateConnection without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.CreatePrivateConnectionRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.createPrivateConnection = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createPrivateConnection(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createPrivateConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createPrivateConnection without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.createPrivateConnection = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createPrivateConnection(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datastream.v1alpha1.IPrivateConnection, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datastream.v1alpha1.IPrivateConnection, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createPrivateConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes createPrivateConnection with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createPrivateConnection = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createPrivateConnection(request), expectedError);
            assert((client.innerApiCalls.createPrivateConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createPrivateConnection with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createPrivateConnection = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createPrivateConnection(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.createPrivateConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkCreatePrivateConnectionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreatePrivateConnectionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreatePrivateConnectionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreatePrivateConnectionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deletePrivateConnection', () => {
        it('invokes deletePrivateConnection without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.DeletePrivateConnectionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.deletePrivateConnection = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deletePrivateConnection(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deletePrivateConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deletePrivateConnection without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.deletePrivateConnection = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deletePrivateConnection with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deletePrivateConnection = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deletePrivateConnection(request), expectedError);
            assert((client.innerApiCalls.deletePrivateConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deletePrivateConnection with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deletePrivateConnection = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deletePrivateConnection(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.deletePrivateConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkDeletePrivateConnectionProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeletePrivateConnectionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeletePrivateConnectionProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeletePrivateConnectionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createRoute', () => {
        it('invokes createRoute without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.CreateRouteRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createRoute as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createRoute without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.createRoute = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createRoute(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.datastream.v1alpha1.IRoute, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.datastream.v1alpha1.IRoute, protos.google.cloud.datastream.v1alpha1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createRoute as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes createRoute with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createRoute = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createRoute with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createRoute = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createRoute(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.createRoute as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkCreateRouteProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateRouteProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('deleteRoute', () => {
        it('invokes deleteRoute without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.DeleteRouteRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteRoute as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteRoute without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.deleteRoute = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteRoute(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deleteRoute with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteRoute = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteRoute with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteRoute = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteRoute(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.deleteRoute as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkDeleteRouteProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteRouteProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('listConnectionProfiles', () => {
        it('invokes listConnectionProfiles without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.ListConnectionProfilesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.ConnectionProfile()),
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.ConnectionProfile()),
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.ConnectionProfile()),
            ];
            client.innerApiCalls.listConnectionProfiles = stubSimpleCall(expectedResponse);
            const [response] = await client.listConnectionProfiles(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listConnectionProfiles as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listConnectionProfiles without error using callback', async () => {
            ...
            client.innerApiCalls.listConnectionProfiles = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listConnectionProfiles with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listConnectionProfiles = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listConnectionProfiles(request), expectedError);
            assert((client.innerApiCalls.listConnectionProfiles as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listConnectionProfilesStream without error', async () => {
            ...
            client.descriptors.page.listConnectionProfiles.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datastream.v1alpha1.ConnectionProfile) => {
            ...
            assert((client.descriptors.page.listConnectionProfiles.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listConnectionProfiles, request));
            assert.strictEqual(
                (client.descriptors.page.listConnectionProfiles.createStream as SinonStub)
        ...
        it('invokes listConnectionProfilesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.listConnectionProfiles.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listConnectionProfilesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.datastream.v1alpha1.ConnectionProfile[] = [];
                stream.on('data', (response: protos.google.cloud.datastream.v1alpha1.ConnectionProfile) => {
        ...
        it('uses async iteration with listConnectionProfiles without error', async () => {
            ...
            client.descriptors.page.listConnectionProfiles.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listConnectionProfiles.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listConnectionProfiles with error', async () => {
            ...
            client.descriptors.page.listConnectionProfiles.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listConnectionProfilesAsync(request);
    ...
    describe('listStreams', () => {
        it('invokes listStreams without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.ListStreamsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.Stream()),
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.Stream()),
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.Stream()),
            ];
        ...
        it('invokes listStreamsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datastream.v1alpha1.Stream) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('fetchStaticIps', () => {
        it('invokes fetchStaticIps without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.FetchStaticIpsRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.fetchStaticIps as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes fetchStaticIps without error using callback', async () => {
            ...
            const expectedResponse = [new String(), new String(), new String()];
            client.innerApiCalls.fetchStaticIps = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes fetchStaticIps with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.fetchStaticIps = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes fetchStaticIpsStream without error', async () => {
            ...
            const expectedHeaderRequestParams = "name=";
            const expectedResponse = [new String(), new String(), new String()];
            client.descriptors.page.fetchStaticIps.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.fetchStaticIps.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.fetchStaticIps, request));
            assert.strictEqual(
        ...
        it('invokes fetchStaticIpsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "name=";
            const expectedError = new Error('expected');
            client.descriptors.page.fetchStaticIps.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.fetchStaticIpsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: string[] = [];
                stream.on('data', (response: string) => {
        ...
        it('uses async iteration with fetchStaticIps without error', async () => {
            ...
            client.descriptors.page.fetchStaticIps.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: string[] = [];
        ...
        it('uses async iteration with fetchStaticIps with error', async () => {
            ...
            client.descriptors.page.fetchStaticIps.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.fetchStaticIpsAsync(request);
            await assert.rejects(async () => {
                const responses: string[] = [];
                for await (const resource of iterable) {
    ...
    describe('listPrivateConnections', () => {
        it('invokes listPrivateConnections without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.ListPrivateConnectionsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.PrivateConnection()),
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.PrivateConnection()),
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.PrivateConnection()),
            ];
            client.innerApiCalls.listPrivateConnections = stubSimpleCall(expectedResponse);
            const [response] = await client.listPrivateConnections(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listPrivateConnections as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listPrivateConnections without error using callback', async () => {
            ...
            client.innerApiCalls.listPrivateConnections = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listPrivateConnections with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listPrivateConnections = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listPrivateConnections(request), expectedError);
            assert((client.innerApiCalls.listPrivateConnections as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listPrivateConnectionsStream without error', async () => {
            ...
            client.descriptors.page.listPrivateConnections.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.datastream.v1alpha1.PrivateConnection) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listPrivateConnections.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPrivateConnections, request));
            assert.strictEqual(
                (client.descriptors.page.listPrivateConnections.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });
        ...
        it('invokes listPrivateConnectionsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.listPrivateConnections.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPrivateConnectionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.datastream.v1alpha1.PrivateConnection[] = [];
                stream.on('data', (response: protos.google.cloud.datastream.v1alpha1.PrivateConnection) => {
        ...
        it('uses async iteration with listPrivateConnections without error', async () => {
            ...
            client.descriptors.page.listPrivateConnections.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listPrivateConnections.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert.strictEqual(
                (client.descriptors.page.listPrivateConnections.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
        ...
        it('uses async iteration with listPrivateConnections with error', async () => {
            ...
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";const expectedError = new Error('expected');
            client.descriptors.page.listPrivateConnections.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPrivateConnectionsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.datastream.v1alpha1.IPrivateConnection[] = [];
                for await (const resource of iterable) {
    ...
    describe('listRoutes', () => {
        it('invokes listRoutes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.ListRoutesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.Route()),
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.Route()),
              generateSampleMessage(new protos.google.cloud.datastream.v1alpha1.Route()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listRoutes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listRoutes without error using callback', async () => {
            ...
            client.innerApiCalls.listRoutes = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listRoutes(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.datastream.v1alpha1.IRoute[]|null) => {
        ...
        it('invokes listRoutes with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listRoutes = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listRoutesStream without error', async () => {
            ...
            client.descriptors.page.listRoutes.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listRoutesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.datastream.v1alpha1.Route[] = [];
                stream.on('data', (response: protos.google.cloud.datastream.v1alpha1.Route) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listRoutes.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRoutes, request));
            assert.strictEqual(
        ...
        it('invokes listRoutesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.listRoutes.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listRoutesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.datastream.v1alpha1.Route[] = [];
                stream.on('data', (response: protos.google.cloud.datastream.v1alpha1.Route) => {
        ...
        it('uses async iteration with listRoutes without error', async () => {
            ...
            client.descriptors.page.listRoutes.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listRoutes with error', async () => {
            ...
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";const expectedError = new Error('expected');
            client.descriptors.page.listRoutes.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listRoutesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.datastream.v1alpha1.IRoute[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('connectionProfile', () => {
            ...
            client.initialize();
            client.pathTemplates.connectionProfilePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.connectionProfilePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('connectionProfilePath', () => {
                const result = client.connectionProfilePath("projectValue", "locationValue", "connectionProfileValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.connectionProfilePathTemplate.render as SinonStub)
            ...
            it('matchProjectFromConnectionProfileName', () => {
                ...
                assert((client.pathTemplates.connectionProfilePathTemplate.match as SinonStub)
            ...
            it('matchConnectionProfileFromConnectionProfileName', () => {
                const result = client.matchConnectionProfileFromConnectionProfileName(fakePath);
        ...
        describe('privateConnection', () => {
            ...
            client.initialize();
            client.pathTemplates.privateConnectionPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.privateConnectionPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('privateConnectionPath', () => {
                const result = client.privateConnectionPath("projectValue", "locationValue", "privateConnectionValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.privateConnectionPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromPrivateConnectionName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.privateConnectionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchPrivateConnectionFromPrivateConnectionName', () => {
                const result = client.matchPrivateConnectionFromPrivateConnectionName(fakePath);
        ...
        describe('route', () => {
            ...
            client.initialize();
            client.pathTemplates.routePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.routePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('routePath', () => {
                const result = client.routePath("projectValue", "locationValue", "privateConnectionValue", "routeValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.routePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromRouteName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.routePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
