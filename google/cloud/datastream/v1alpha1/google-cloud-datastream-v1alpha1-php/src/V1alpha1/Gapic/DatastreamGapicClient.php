 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/datastream/v1alpha1/datastream.proto
 * Updates to the above are reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\Datastream\V1alpha1\Gapic;
...
use Google\Cloud\Datastream\V1alpha1\ConnectionProfile;
use Google\Cloud\Datastream\V1alpha1\CreateConnectionProfileRequest;
use Google\Cloud\Datastream\V1alpha1\CreatePrivateConnectionRequest;
use Google\Cloud\Datastream\V1alpha1\CreateRouteRequest;
use Google\Cloud\Datastream\V1alpha1\CreateStreamRequest;
use Google\Cloud\Datastream\V1alpha1\DeleteConnectionProfileRequest;
use Google\Cloud\Datastream\V1alpha1\DeletePrivateConnectionRequest;
use Google\Cloud\Datastream\V1alpha1\DeleteRouteRequest;
use Google\Cloud\Datastream\V1alpha1\DeleteStreamRequest;
use Google\Cloud\Datastream\V1alpha1\DiscoverConnectionProfileRequest;
use Google\Cloud\Datastream\V1alpha1\DiscoverConnectionProfileResponse;
use Google\Cloud\Datastream\V1alpha1\FetchErrorsRequest;
use Google\Cloud\Datastream\V1alpha1\FetchStaticIpsRequest;
use Google\Cloud\Datastream\V1alpha1\FetchStaticIpsResponse;
use Google\Cloud\Datastream\V1alpha1\GetConnectionProfileRequest;
use Google\Cloud\Datastream\V1alpha1\GetPrivateConnectionRequest;
use Google\Cloud\Datastream\V1alpha1\GetRouteRequest;
use Google\Cloud\Datastream\V1alpha1\GetStreamRequest;
use Google\Cloud\Datastream\V1alpha1\ListConnectionProfilesRequest;
use Google\Cloud\Datastream\V1alpha1\ListConnectionProfilesResponse;
use Google\Cloud\Datastream\V1alpha1\ListPrivateConnectionsRequest;
use Google\Cloud\Datastream\V1alpha1\ListPrivateConnectionsResponse;
use Google\Cloud\Datastream\V1alpha1\ListRoutesRequest;
use Google\Cloud\Datastream\V1alpha1\ListRoutesResponse;
use Google\Cloud\Datastream\V1alpha1\ListStreamsRequest;
use Google\Cloud\Datastream\V1alpha1\ListStreamsResponse;
use Google\Cloud\Datastream\V1alpha1\MysqlRdbms;
use Google\Cloud\Datastream\V1alpha1\OracleRdbms;
use Google\Cloud\Datastream\V1alpha1\PrivateConnection;
use Google\Cloud\Datastream\V1alpha1\Route;
use Google\Cloud\Datastream\V1alpha1\Stream;
use Google\Cloud\Datastream\V1alpha1\UpdateConnectionProfileRequest;
use Google\Cloud\Datastream\V1alpha1\UpdateStreamRequest;
...
class DatastreamGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.datastream.v1alpha1.Datastream';
     ...
     * @experimental
     */
    public static function routeName($project, $location, $privateConnection, $route)
    {
     ...
     * @experimental
     */
    public function createRoute($parent, $routeId, $route, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateRoute', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteRoute($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteRoute', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * ```
     *
     * @param string $parent       Required. The parent resource of the ConnectionProfile type. Must be in the
    ...
    public function discoverConnectionProfile($parent, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['connectionProfileName'])) {
            $request->setConnectionProfileName($optionalArgs['connectionProfileName']);
        }
        ...
        if (isset($optionalArgs['recursionDepth'])) {
            $request->setRecursionDepth($optionalArgs['recursionDepth']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DiscoverConnectionProfile', DiscoverConnectionProfileResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * $datastreamClient = new DatastreamClient();
     * try {
     *     $operationResponse = $datastreamClient->fetchErrors();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *     // doSomethingWith($result)
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $datastreamClient->resumeOperation($operationName, 'fetchErrors');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @experimental
     */
    public function fetchErrors(array $optionalArgs = [])
    {
        $request = new FetchErrorsRequest();
        $requestParamHeaders = [];
        if (isset($optionalArgs['stream'])) {
            $request->setStream($optionalArgs['stream']);
            $requestParamHeaders['stream'] = $optionalArgs['stream'];
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('FetchErrors', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * ```
     *
     * @param string $name         Required. The name resource of the Response type. Must be in the
     *                             format `projects/&#42;/locations/*`.
     * @param array  $optionalArgs {
     *     Optional.
     *
    ...
    public function getRoute($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetRoute', Route::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listRoutes($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListRoutes', $optionalArgs, ListRoutesResponse::class, $request);
    }
     ...
     * ```
     *
     * @param ConnectionProfile $connectionProfile Required. The ConnectionProfile to update.
     * @param array             $optionalArgs      {
     *     Optional.
     *
     ...
     * @experimental
     */
    public function updateConnectionProfile($connectionProfile, array $optionalArgs = [])
    {
