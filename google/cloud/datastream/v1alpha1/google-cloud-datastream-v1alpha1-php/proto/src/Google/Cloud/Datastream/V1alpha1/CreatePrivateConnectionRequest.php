...
/**
 * Generated from protobuf message <code>google.cloud.datastream.v1alpha1.CreatePrivateConnectionRequest</code>
 */
class CreatePrivateConnectionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.PrivateConnection private_connection = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The private connectivity identifier.
     *     @type \Google\Cloud\Datastream\V1alpha1\PrivateConnection $private_connection
     *           Required. The Private Connectivity resource to create.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.PrivateConnection private_connection = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Datastream\V1alpha1\PrivateConnection|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.PrivateConnection private_connection = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Datastream\V1alpha1\PrivateConnection $var
     * @return $this
     */
    public function setPrivateConnection($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Datastream\V1alpha1\PrivateConnection::class);
