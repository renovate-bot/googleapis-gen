...
namespace Google\Cloud\Datastream\V1alpha1\Validation;
 ...
 *
 * Protobuf type <code>google.cloud.datastream.v1alpha1.Validation.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \Google\Cloud\Datastream\V1alpha1\Validation_Status::class);
