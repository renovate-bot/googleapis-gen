...
namespace Google\Cloud\Datastream\V1alpha1\JsonFileFormat;
 ...
 *
 * Protobuf type <code>google.cloud.datastream.v1alpha1.JsonFileFormat.JsonCompression</code>
 */
...
class_alias(JsonCompression::class, \Google\Cloud\Datastream\V1alpha1\JsonFileFormat_JsonCompression::class);
