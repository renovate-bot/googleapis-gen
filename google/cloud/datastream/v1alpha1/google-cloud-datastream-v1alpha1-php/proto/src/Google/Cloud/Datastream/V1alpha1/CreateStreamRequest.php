...
/**
 * Generated from protobuf message <code>google.cloud.datastream.v1alpha1.CreateStreamRequest</code>
 */
class CreateStreamRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.Stream stream = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The stream identifier.
     *     @type \Google\Cloud\Datastream\V1alpha1\Stream $stream
     *           Required. The stream resource to create.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.Stream stream = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Datastream\V1alpha1\Stream|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.Stream stream = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Datastream\V1alpha1\Stream $var
     * @return $this
     */
    public function setStream($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Datastream\V1alpha1\Stream::class);
        $this->stream = $var;
