 ...
 *
 * Generated from protobuf message <code>google.cloud.datastream.v1alpha1.MysqlProfile</code>
 */
class MysqlProfile extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.MysqlSslConfig ssl_config = 5;</code>
     */
     ...
     *           Required. Input only. Password for the MySQL connection.
     *     @type \Google\Cloud\Datastream\V1alpha1\MysqlSslConfig $ssl_config
     *           SSL configuration for the MySQL connection.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.MysqlSslConfig ssl_config = 5;</code>
     * @return \Google\Cloud\Datastream\V1alpha1\MysqlSslConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.MysqlSslConfig ssl_config = 5;</code>
     * @param \Google\Cloud\Datastream\V1alpha1\MysqlSslConfig $var
     * @return $this
     */
    public function setSslConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Datastream\V1alpha1\MysqlSslConfig::class);
        $this->ssl_config = $var;
