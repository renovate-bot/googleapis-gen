 ...
 *
 * Generated from protobuf message <code>google.cloud.datastream.v1alpha1.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.ValidationResult validation_result = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. API version used to start the operation.
     *     @type \Google\Cloud\Datastream\V1alpha1\ValidationResult $validation_result
     *           Output only. Results of executed validations if there are any.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.ValidationResult validation_result = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\Datastream\V1alpha1\ValidationResult|null
     */
    public function getValidationResult()
    {
        return isset($this->validation_result) ? $this->validation_result : null;
    }

    public function hasValidationResult()
    {
        return isset($this->validation_result);
    }

    public function clearValidationResult()
    {
        unset($this->validation_result);
    }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datastream.v1alpha1.ValidationResult validation_result = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Datastream\V1alpha1\ValidationResult $var
     * @return $this
     */
    public function setValidationResult($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Datastream\V1alpha1\ValidationResult::class);
        $this->validation_result = $var;
