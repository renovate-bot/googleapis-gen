...
from google.cloud.datastream_v1alpha1.services.datastream import DatastreamClient
from google.cloud.datastream_v1alpha1.services.datastream import pagers
from google.cloud.datastream_v1alpha1.services.datastream import transports
from google.cloud.datastream_v1alpha1.services.datastream.transports.base import _API_CORE_VERSION
from google.cloud.datastream_v1alpha1.services.datastream.transports.base import _GOOGLE_AUTH_VERSION
...
def test_datastream_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_datastream_client_client_options_from_dict():
    with mock.patch('google.cloud.datastream_v1alpha1.services.datastream.transports.DatastreamGrpcTransport.__init__') as grpc_transport:
...
def test_list_connection_profiles(transport: str = 'grpc', request_type=datastream.ListConnectionProfilesRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_connection_profiles_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, datastream_resources.ConnectionProfile)
                   for i in results)
...
def test_get_connection_profile(transport: str = 'grpc', request_type=datastream.GetConnectionProfileRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = datastream_resources.ConnectionProfile(
            ...
            oracle_profile=datastream_resources.OracleProfile(hostname='hostname_value'),
...
def test_create_connection_profile(transport: str = 'grpc', request_type=datastream.CreateConnectionProfileRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_connection_profile(transport: str = 'grpc', request_type=datastream.UpdateConnectionProfileRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_discover_connection_profile(transport: str = 'grpc', request_type=datastream.DiscoverConnectionProfileRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.discover_connection_profile),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datastream.DiscoverConnectionProfileResponse(
            oracle_rdbms=datastream_resources.OracleRdbms(oracle_schemas=[datastream_resources.OracleSchema(schema_name='schema_name_value')]),
        )
...
def test_discover_connection_profile_flattened():
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_discover_connection_profile_flattened_error():
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_discover_connection_profile_flattened_async():
    client = DatastreamAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_discover_connection_profile_flattened_error_async():
    client = DatastreamAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.discover_connection_profile(
            datastream.DiscoverConnectionProfileRequest(),
            parent='parent_value',
        )


def test_list_streams(transport: str = 'grpc', request_type=datastream.ListStreamsRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_streams_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, datastream_resources.Stream)
                   for i in results)
...
def test_get_stream(transport: str = 'grpc', request_type=datastream.GetStreamRequest):
    ...
    with mock.patch.object(
        ...
        call.return_value = datastream_resources.Stream(
            ...
            backfill_all=datastream_resources.Stream.BackfillAllStrategy(oracle_excluded_objects=datastream_resources.OracleRdbms(oracle_schemas=[datastream_resources.OracleSchema(schema_name='schema_name_value')])),
        )
...
def test_create_stream(transport: str = 'grpc', request_type=datastream.CreateStreamRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_stream(transport: str = 'grpc', request_type=datastream.UpdateStreamRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_stream(transport: str = 'grpc', request_type=datastream.DeleteStreamRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_errors(transport: str = 'grpc', request_type=datastream.FetchErrorsRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_errors),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_fetch_errors_async(transport: str = 'grpc_asyncio', request_type=datastream.FetchErrorsRequest):
    client = DatastreamAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_fetch_static_ips(transport: str = 'grpc', request_type=datastream.FetchStaticIpsRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_private_connection(transport: str = 'grpc', request_type=datastream.CreatePrivateConnectionRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_private_connection(transport: str = 'grpc', request_type=datastream.GetPrivateConnectionRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_private_connections(transport: str = 'grpc', request_type=datastream.ListPrivateConnectionsRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_private_connections_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, datastream_resources.PrivateConnection)
                   for i in results)
...
def test_delete_private_connection(transport: str = 'grpc', request_type=datastream.DeletePrivateConnectionRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_route(transport: str = 'grpc', request_type=datastream.CreateRouteRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_route(transport: str = 'grpc', request_type=datastream.GetRouteRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_routes(transport: str = 'grpc', request_type=datastream.ListRoutesRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_routes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_routes_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, datastream_resources.Route)
                   for i in results)
...
def test_delete_route(transport: str = 'grpc', request_type=datastream.DeleteRouteRequest):
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_datastream_base_transport():
    ...
    with mock.patch('google.cloud.datastream_v1alpha1.services.datastream.transports.DatastreamTransport.__init__') as Transport:
...
def test_datastream_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.datastream_v1alpha1.services.datastream.transports.DatastreamTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_datastream_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.datastream_v1alpha1.services.datastream.transports.DatastreamTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DatastreamTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_datastream_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        DatastreamClient()
...
@requires_google_auth_lt_1_25_0
def test_datastream_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_datastream_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_datastream_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@pytest.mark.parametrize("transport_class", [transports.DatastreamGrpcTransport, transports.DatastreamGrpcAsyncIOTransport])
def test_datastream_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DatastreamGrpcTransport, transports.DatastreamGrpcAsyncIOTransport])
def test_datastream_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
