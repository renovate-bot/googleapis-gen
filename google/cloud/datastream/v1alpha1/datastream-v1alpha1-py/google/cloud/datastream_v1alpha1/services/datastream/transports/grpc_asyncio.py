...
class DatastreamGrpcAsyncIOTransport(DatastreamTransport):
    ...
    def list_streams(self) -> Callable[
            ...
            Awaitable[datastream.ListStreamsResponse]]:
    ...
    def get_stream(self) -> Callable[
            ...
            Awaitable[datastream_resources.Stream]]:
    ...
    def get_route(self) -> Callable[
            ...
            Awaitable[datastream_resources.Route]]:
    ...
    def list_routes(self) -> Callable[
            ...
            Awaitable[datastream.ListRoutesResponse]]:
