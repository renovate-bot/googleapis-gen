...
class ::Google::Cloud::ManagedIdentities::V1beta1::ManagedIdentitiesService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::ManagedIdentities::V1beta1::ManagedIdentitiesService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ManagedIdentities::V1beta1::ManagedIdentitiesService::Operations::Configuration, config
  end
end
