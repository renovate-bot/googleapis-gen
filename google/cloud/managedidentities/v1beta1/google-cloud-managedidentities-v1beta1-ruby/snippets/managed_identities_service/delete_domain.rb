...
# [START managedidentities_v1beta1_generated_ManagedIdentitiesService_DeleteDomain_sync]
...
request = Google::Cloud::ManagedIdentities::V1beta1::DeleteDomainRequest.new
