...
class Domain(proto.Message):
    ...
    Attributes:
        ...
        labels (Sequence[google.cloud.managedidentities_v1beta1.types.Domain.LabelsEntry]):
        ...
        state (google.cloud.managedidentities_v1beta1.types.Domain.State):
            Output only. The current state of this
            domain.
        status_message (str):
            Output only. Additional information about the
            current status of this domain, if available.
        trusts (Sequence[google.cloud.managedidentities_v1beta1.types.Trust]):
...
class Trust(proto.Message):
    ...
    Attributes:
        ...
        trust_type (google.cloud.managedidentities_v1beta1.types.Trust.TrustType):
            The type of trust represented by the trust
            resource.
        trust_direction (google.cloud.managedidentities_v1beta1.types.Trust.TrustDirection):
            The trust direction, which decides if the
            current domain is trusted, trusting, or both.
        selective_authentication (bool):
            The trust authentication type, which decides
            whether the trusted side has forest/domain wide
            access or selective access to an approved set of
            resources.
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The last update time.
        state (google.cloud.managedidentities_v1beta1.types.Trust.State):
