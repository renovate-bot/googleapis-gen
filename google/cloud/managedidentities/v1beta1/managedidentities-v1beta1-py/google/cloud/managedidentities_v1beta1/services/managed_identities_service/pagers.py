...
class ListDomainsPager:
    ...
    :class:`google.cloud.managedidentities_v1beta1.types.ListDomainsResponse` object, and
    ...
    All the usual :class:`google.cloud.managedidentities_v1beta1.types.ListDomainsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.managedidentities_v1beta1.types.ListDomainsResponse):
