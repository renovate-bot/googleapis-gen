...
class ManagedIdentitiesServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_microsoft_ad_domain: gapic_v1.method.wrap_method(
                self.create_microsoft_ad_domain,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.reset_admin_password: gapic_v1.method.wrap_method(
    ...
    @property
    def create_microsoft_ad_domain(self) -> typing.Callable[
    ...
    @property
    def reset_admin_password(self) -> typing.Callable[
            [managed_identities_service.ResetAdminPasswordRequest],
            typing.Union[
                managed_identities_service.ResetAdminPasswordResponse,
                typing.Awaitable[managed_identities_service.ResetAdminPasswordResponse]
            ]]:
        raise NotImplementedError()

    @property
    def list_domains(self) -> typing.Callable[
    ...
    @property
    def get_domain(self) -> typing.Callable[
            [managed_identities_service.GetDomainRequest],
            typing.Union[
                resource.Domain,
                typing.Awaitable[resource.Domain]
            ]]:
        raise NotImplementedError()

    @property
    def update_domain(self) -> typing.Callable[
    ...
    @property
    def delete_domain(self) -> typing.Callable[
    ...
    @property
    def attach_trust(self) -> typing.Callable[
    ...
    @property
    def reconfigure_trust(self) -> typing.Callable[
    ...
    @property
    def detach_trust(self) -> typing.Callable[
    ...
    @property
    def validate_trust(self) -> typing.Callable[
