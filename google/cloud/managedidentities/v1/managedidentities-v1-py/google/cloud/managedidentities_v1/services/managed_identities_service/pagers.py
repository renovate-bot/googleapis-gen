...
class ListDomainsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[managed_identities_service.ListDomainsResponse]],
            request: managed_identities_service.ListDomainsRequest,
            response: managed_identities_service.ListDomainsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterable[managed_identities_service.ListDomainsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
