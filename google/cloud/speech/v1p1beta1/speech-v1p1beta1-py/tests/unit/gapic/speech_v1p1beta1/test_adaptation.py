...
from google.cloud.speech_v1p1beta1.services.adaptation.transports.base import _API_CORE_VERSION
from google.cloud.speech_v1p1beta1.services.adaptation.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert AdaptationClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert AdaptationClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert AdaptationClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert AdaptationClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (AdaptationAsyncClient, transports.AdaptationGrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(AdaptationClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AdaptationClient))
@mock.patch.object(AdaptationAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AdaptationAsyncClient))
def test_adaptation_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (AdaptationAsyncClient, transports.AdaptationGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (AdaptationClient, transports.AdaptationGrpcTransport, "grpc", "false"),
    (AdaptationAsyncClient, transports.AdaptationGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(AdaptationClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AdaptationClient))
@mock.patch.object(AdaptationAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AdaptationAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_adaptation_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_adaptation_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_adaptation_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_adaptation_client_client_options_from_dict():
    with mock.patch('google.cloud.speech_v1p1beta1.services.adaptation.transports.AdaptationGrpcTransport.__init__') as grpc_transport:
...
def test_create_phrase_set(transport: str = 'grpc', request_type=cloud_speech_adaptation.CreatePhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.create_phrase_set),
            '__call__') as call:
...
def test_create_phrase_set_from_dict():
    test_create_phrase_set(request_type=dict)
...
@pytest.mark.asyncio
async def test_create_phrase_set_async(transport: str = 'grpc_asyncio', request_type=cloud_speech_adaptation.CreatePhraseSetRequest):
...
def test_get_phrase_set(transport: str = 'grpc', request_type=cloud_speech_adaptation.GetPhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_phrase_set),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resource.PhraseSet(
            name='name_value',
...
def test_get_phrase_set_from_dict():
    test_get_phrase_set(request_type=dict)
...
@pytest.mark.asyncio
async def test_get_phrase_set_async(transport: str = 'grpc_asyncio', request_type=cloud_speech_adaptation.GetPhraseSetRequest):
    client = AdaptationAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_phrase_set(transport: str = 'grpc', request_type=cloud_speech_adaptation.ListPhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_phrase_set),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_phrase_set_from_dict():
    test_list_phrase_set(request_type=dict)
...
@pytest.mark.asyncio
async def test_list_phrase_set_async(transport: str = 'grpc_asyncio', request_type=cloud_speech_adaptation.ListPhraseSetRequest):
    client = AdaptationAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_phrase_set_pager():
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials,
    )
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, resource.PhraseSet)
                   for i in results)

def test_list_phrase_set_pages():
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials,
    )
...
def test_update_phrase_set(transport: str = 'grpc', request_type=cloud_speech_adaptation.UpdatePhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_phrase_set),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resource.PhraseSet(
            name='name_value',
...
def test_update_phrase_set_from_dict():
    test_update_phrase_set(request_type=dict)
...
@pytest.mark.asyncio
async def test_update_phrase_set_async(transport: str = 'grpc_asyncio', request_type=cloud_speech_adaptation.UpdatePhraseSetRequest):
    client = AdaptationAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_phrase_set(transport: str = 'grpc', request_type=cloud_speech_adaptation.DeletePhraseSetRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_phrase_set),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_phrase_set_from_dict():
    test_delete_phrase_set(request_type=dict)
...
@pytest.mark.asyncio
async def test_delete_phrase_set_async(transport: str = 'grpc_asyncio', request_type=cloud_speech_adaptation.DeletePhraseSetRequest):
    client = AdaptationAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_custom_class(transport: str = 'grpc', request_type=cloud_speech_adaptation.CreateCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_custom_class),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_custom_class_from_dict():
    test_create_custom_class(request_type=dict)
...
@pytest.mark.asyncio
async def test_create_custom_class_async(transport: str = 'grpc_asyncio', request_type=cloud_speech_adaptation.CreateCustomClassRequest):
    client = AdaptationAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resource.CustomClass(
            name='name_value',
            custom_class_id='custom_class_id_value',
        ))
...
def test_get_custom_class(transport: str = 'grpc', request_type=cloud_speech_adaptation.GetCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_custom_class),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resource.CustomClass(
            name='name_value',
...
def test_get_custom_class_from_dict():
    test_get_custom_class(request_type=dict)
...
@pytest.mark.asyncio
async def test_get_custom_class_async(transport: str = 'grpc_asyncio', request_type=cloud_speech_adaptation.GetCustomClassRequest):
    client = AdaptationAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_custom_classes(transport: str = 'grpc', request_type=cloud_speech_adaptation.ListCustomClassesRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_custom_classes_from_dict():
    test_list_custom_classes(request_type=dict)
...
@pytest.mark.asyncio
async def test_list_custom_classes_async(transport: str = 'grpc_asyncio', request_type=cloud_speech_adaptation.ListCustomClassesRequest):
    client = AdaptationAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(cloud_speech_adaptation.ListCustomClassesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_custom_classes_pager():
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials,
    )
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resource.CustomClass)
                   for i in results)

def test_list_custom_classes_pages():
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials,
    )
...
def test_update_custom_class(transport: str = 'grpc', request_type=cloud_speech_adaptation.UpdateCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_custom_class),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resource.CustomClass(
            name='name_value',
...
def test_update_custom_class_from_dict():
    test_update_custom_class(request_type=dict)
...
@pytest.mark.asyncio
async def test_update_custom_class_async(transport: str = 'grpc_asyncio', request_type=cloud_speech_adaptation.UpdateCustomClassRequest):
    client = AdaptationAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_custom_class(transport: str = 'grpc', request_type=cloud_speech_adaptation.DeleteCustomClassRequest):
    client = AdaptationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_custom_class),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_custom_class_from_dict():
    test_delete_custom_class(request_type=dict)
...
@pytest.mark.asyncio
async def test_delete_custom_class_async(transport: str = 'grpc_asyncio', request_type=cloud_speech_adaptation.DeleteCustomClassRequest):
    client = AdaptationAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_adaptation_base_transport():
    ...
    with mock.patch('google.cloud.speech_v1p1beta1.services.adaptation.transports.AdaptationTransport.__init__') as Transport:
...
def test_adaptation_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.speech_v1p1beta1.services.adaptation.transports.AdaptationTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_adaptation_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.speech_v1p1beta1.services.adaptation.transports.AdaptationTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_adaptation_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.speech_v1p1beta1.services.adaptation.transports.AdaptationTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AdaptationTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_adaptation_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        AdaptationClient()
...
@requires_google_auth_lt_1_25_0
def test_adaptation_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_adaptation_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_adaptation_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@pytest.mark.parametrize("transport_class", [transports.AdaptationGrpcTransport, transports.AdaptationGrpcAsyncIOTransport])
def test_adaptation_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.AdaptationGrpcTransport, transports.AdaptationGrpcAsyncIOTransport])
def test_adaptation_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.AdaptationGrpcTransport, transports.AdaptationGrpcAsyncIOTransport])
def test_adaptation_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_custom_class_path():
    ...
    location = "clam"
    custom_class = "whelk"
    expected = "projects/{project}/locations/{location}/customClasses/{custom_class}".format(project=project, location=location, custom_class=custom_class, )
...
def test_phrase_set_path():
    ...
    location = "mussel"
    phrase_set = "winkle"
    expected = "projects/{project}/locations/{location}/phraseSets/{phrase_set}".format(project=project, location=location, phrase_set=phrase_set, )
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.AdaptationTransport, '_prep_wrapped_messages') as prep:
        client = AdaptationClient(
            credentials=ga_credentials.AnonymousCredentials(),
