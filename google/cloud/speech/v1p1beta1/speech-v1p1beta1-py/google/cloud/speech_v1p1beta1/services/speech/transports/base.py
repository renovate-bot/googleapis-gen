...
class SpeechTransport(abc.ABC):
    ...
    @property
    def recognize(self) -> typing.Callable[
            [cloud_speech.RecognizeRequest],
            typing.Union[
                cloud_speech.RecognizeResponse,
                typing.Awaitable[cloud_speech.RecognizeResponse]
            ]]:
        raise NotImplementedError()

    @property
    def long_running_recognize(self) -> typing.Callable[
    ...
    @property
    def streaming_recognize(self) -> typing.Callable[
            [cloud_speech.StreamingRecognizeRequest],
            typing.Union[
                cloud_speech.StreamingRecognizeResponse,
                typing.Awaitable[cloud_speech.StreamingRecognizeResponse]
            ]]:
        raise NotImplementedError()
