...
class AdaptationTransport(abc.ABC):
    ...
    @property
    def create_phrase_set(self) -> typing.Callable[
            [cloud_speech_adaptation.CreatePhraseSetRequest],
            typing.Union[
                resource.PhraseSet,
                typing.Awaitable[resource.PhraseSet]
            ]]:
        raise NotImplementedError()

    @property
    def get_phrase_set(self) -> typing.Callable[
    ...
    @property
    def list_phrase_set(self) -> typing.Callable[
    ...
    @property
    def update_phrase_set(self) -> typing.Callable[
    ...
    @property
    def delete_phrase_set(self) -> typing.Callable[
    ...
    @property
    def create_custom_class(self) -> typing.Callable[
            [cloud_speech_adaptation.CreateCustomClassRequest],
            typing.Union[
                resource.CustomClass,
                typing.Awaitable[resource.CustomClass]
            ]]:
        raise NotImplementedError()

    @property
    def get_custom_class(self) -> typing.Callable[
    ...
    @property
    def list_custom_classes(self) -> typing.Callable[
    ...
    @property
    def update_custom_class(self) -> typing.Callable[
    ...
    @property
    def delete_custom_class(self) -> typing.Callable[
