...
class RecognitionConfig(proto.Message):
    ...
    adaptation = proto.Field(proto.MESSAGE, number=20,
        message=resource.SpeechAdaptation,
    )

    speech_contexts = proto.RepeatedField(proto.MESSAGE, number=6,
    ...
    enable_spoken_punctuation = proto.Field(proto.MESSAGE, number=22,
        message=wrappers.BoolValue,
    )

    enable_spoken_emojis = proto.Field(proto.MESSAGE, number=23,
        message=wrappers.BoolValue,
    )
    ...
    diarization_config = proto.Field(proto.MESSAGE, number=19,
        message='SpeakerDiarizationConfig',
    )

    metadata = proto.Field(proto.MESSAGE, number=9,
...
class RecognitionMetadata(proto.Message):
    ...
    interaction_type = proto.Field(proto.ENUM, number=1,
        enum=InteractionType,
    )

    industry_naics_code_of_audio = proto.Field(proto.UINT32, number=3)

    microphone_distance = proto.Field(proto.ENUM, number=4,
        enum=MicrophoneDistance,
    )

    original_media_type = proto.Field(proto.ENUM, number=5,
        enum=OriginalMediaType,
    )

    recording_device_type = proto.Field(proto.ENUM, number=6,
...
class LongRunningRecognizeResponse(proto.Message):
    ...
    output_error = proto.Field(proto.MESSAGE, number=7,
...
class LongRunningRecognizeMetadata(proto.Message):
    ...
    last_update_time = proto.Field(proto.MESSAGE, number=3,
        message=timestamp.Timestamp,
    )
...
class StreamingRecognizeResponse(proto.Message):
    ...
    speech_event_type = proto.Field(proto.ENUM, number=4,
...
class StreamingRecognitionResult(proto.Message):
    ...
    alternatives = proto.RepeatedField(proto.MESSAGE, number=1,
    ...
    result_end_time = proto.Field(proto.MESSAGE, number=4,
