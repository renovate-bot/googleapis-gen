...
class ::Google::Cloud::Speech::V1p1beta1::Speech::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Speech::V1p1beta1::Speech::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Speech::V1p1beta1::Speech::Operations::Configuration, config
  end
end
