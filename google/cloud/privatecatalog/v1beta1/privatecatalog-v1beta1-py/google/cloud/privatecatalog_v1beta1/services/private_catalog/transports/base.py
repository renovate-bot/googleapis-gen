...
class PrivateCatalogTransport(abc.ABC):
    ...
    @property
    def search_catalogs(self) -> typing.Callable[
            [private_catalog.SearchCatalogsRequest],
            typing.Union[
                private_catalog.SearchCatalogsResponse,
                typing.Awaitable[private_catalog.SearchCatalogsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def search_products(self) -> typing.Callable[
            [private_catalog.SearchProductsRequest],
            typing.Union[
                private_catalog.SearchProductsResponse,
                typing.Awaitable[private_catalog.SearchProductsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def search_versions(self) -> typing.Callable[
            [private_catalog.SearchVersionsRequest],
            typing.Union[
                private_catalog.SearchVersionsResponse,
                typing.Awaitable[private_catalog.SearchVersionsResponse]
            ]]:
        raise NotImplementedError()
