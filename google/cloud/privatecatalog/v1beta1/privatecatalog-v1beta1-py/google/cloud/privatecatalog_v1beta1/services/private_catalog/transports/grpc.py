...
class PrivateCatalogGrpcTransport(PrivateCatalogTransport):
    """gRPC backend transport for PrivateCatalog.
    ...
    def search_catalogs(self) -> Callable[
        ...
        Returns:
            Callable[[~.SearchCatalogsRequest],
        ...
        if 'search_catalogs' not in self._stubs:
            self._stubs['search_catalogs'] = self.grpc_channel.unary_unary(
                '/google.cloud.privatecatalog.v1beta1.PrivateCatalog/SearchCatalogs',
                request_serializer=private_catalog.SearchCatalogsRequest.serialize,
                response_deserializer=private_catalog.SearchCatalogsResponse.deserialize,
            )
        return self._stubs['search_catalogs']
    ...
    def search_products(self) -> Callable[
        ...
        Returns:
            Callable[[~.SearchProductsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'search_products' not in self._stubs:
            self._stubs['search_products'] = self.grpc_channel.unary_unary(
        ...
        return self._stubs['search_products']
    ...
    def search_versions(self) -> Callable[
        ...
        Returns:
            Callable[[~.SearchVersionsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if 'search_versions' not in self._stubs:
            self._stubs['search_versions'] = self.grpc_channel.unary_unary(
                '/google.cloud.privatecatalog.v1beta1.PrivateCatalog/SearchVersions',
                request_serializer=private_catalog.SearchVersionsRequest.serialize,
                response_deserializer=private_catalog.SearchVersionsResponse.deserialize,
            )
