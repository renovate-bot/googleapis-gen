...
require "google/cloud/privatecatalog/v1beta1/private_catalog"
...
class ::Google::Cloud::Privatecatalog::V1beta1::PrivateCatalog::ClientTest < Minitest::Test
  ...
  def test_search_catalogs
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Privatecatalog::V1beta1::SearchCatalogsResponse.new
    ...
    search_catalogs_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :search_catalogs, name
      assert_kind_of ::Google::Cloud::Privatecatalog::V1beta1::SearchCatalogsRequest, request
    ...
    Gapic::ServiceStub.stub :new, search_catalogs_client_stub do
      ...
      # Verify method calls
      assert_equal 5, search_catalogs_client_stub.call_rpc_count
    end
  end

  def test_search_products
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Privatecatalog::V1beta1::SearchProductsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    search_products_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :search_products, name
      assert_kind_of ::Google::Cloud::Privatecatalog::V1beta1::SearchProductsRequest, request
      assert_equal "hello world", request["resource"]
      assert_equal "hello world", request["query"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
    ...
    Gapic::ServiceStub.stub :new, search_products_client_stub do
      ...
      # Verify method calls
      assert_equal 5, search_products_client_stub.call_rpc_count
    end
  end

  def test_search_versions
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Privatecatalog::V1beta1::SearchVersionsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    search_versions_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :search_versions, name
      assert_kind_of ::Google::Cloud::Privatecatalog::V1beta1::SearchVersionsRequest, request
      assert_equal "hello world", request["resource"]
      assert_equal "hello world", request["query"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
    ...
    Gapic::ServiceStub.stub :new, search_versions_client_stub do
      ...
      # Verify method calls
      assert_equal 5, search_versions_client_stub.call_rpc_count
    end
  end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Privatecatalog::V1beta1::PrivateCatalog::Client::Configuration, config
  end
end
