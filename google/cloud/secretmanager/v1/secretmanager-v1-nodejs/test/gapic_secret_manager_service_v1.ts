...
describe('v1.SecretManagerServiceClient', () => {
    ...
    describe('createSecret', () => {
        it('invokes createSecret without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secretmanager.v1.CreateSecretRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.secretmanager.v1.Secret());
    ...
    describe('addSecretVersion', () => {
        it('invokes addSecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secretmanager.v1.AddSecretVersionRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.secretmanager.v1.SecretVersion());
    ...
    describe('getSecret', () => {
        it('invokes getSecret without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secretmanager.v1.GetSecretRequest());
            request.name = '';
    ...
    describe('updateSecret', () => {
        it('invokes updateSecret without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secretmanager.v1.UpdateSecretRequest());
            request.secret = {};
            request.secret.name = '';
    ...
    describe('deleteSecret', () => {
        it('invokes deleteSecret without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secretmanager.v1.DeleteSecretRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('getSecretVersion', () => {
        it('invokes getSecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secretmanager.v1.GetSecretVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('accessSecretVersion', () => {
        it('invokes accessSecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secretmanager.v1.AccessSecretVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.secretmanager.v1.AccessSecretVersionResponse());
    ...
    describe('enableSecretVersion', () => {
        it('invokes enableSecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secretmanager.v1.EnableSecretVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('destroySecretVersion', () => {
        it('invokes destroySecretVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secretmanager.v1.DestroySecretVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listSecrets', () => {
        it('invokes listSecrets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.secretmanager.v1.ListSecretsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
