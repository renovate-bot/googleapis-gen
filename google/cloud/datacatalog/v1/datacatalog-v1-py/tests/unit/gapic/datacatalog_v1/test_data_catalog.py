...
from google.cloud.datacatalog_v1.services.data_catalog import DataCatalogAsyncClient
from google.cloud.datacatalog_v1.services.data_catalog import DataCatalogClient
...
def test_data_catalog_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_data_catalog_client_client_options_from_dict():
    with mock.patch('google.cloud.datacatalog_v1.services.data_catalog.transports.DataCatalogGrpcTransport.__init__') as grpc_transport:
...
def test_search_catalog(transport: str = 'grpc', request_type=datacatalog.SearchCatalogRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.search_catalog),
            '__call__') as call:
...
def test_search_catalog_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, search.SearchCatalogResult)
                   for i in results)
...
def test_create_entry_group(transport: str = 'grpc', request_type=datacatalog.CreateEntryGroupRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_entry_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_entry_group(transport: str = 'grpc', request_type=datacatalog.GetEntryGroupRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_entry_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datacatalog.EntryGroup(
            name='name_value',
...
def test_update_entry_group(transport: str = 'grpc', request_type=datacatalog.UpdateEntryGroupRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_entry_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datacatalog.EntryGroup(
            name='name_value',
...
def test_delete_entry_group(transport: str = 'grpc', request_type=datacatalog.DeleteEntryGroupRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_entry_group),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_entry_groups(transport: str = 'grpc', request_type=datacatalog.ListEntryGroupsRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_entry_groups_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, datacatalog.EntryGroup)
                   for i in results)
...
def test_create_entry(transport: str = 'grpc', request_type=datacatalog.CreateEntryRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datacatalog.Entry(
            ...
            database_table_spec=datacatalog.DatabaseTableSpec(type_=datacatalog.DatabaseTableSpec.TableType.NATIVE),
        )
...
def test_update_entry(transport: str = 'grpc', request_type=datacatalog.UpdateEntryRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datacatalog.Entry(
            name='name_value',
...
def test_delete_entry(transport: str = 'grpc', request_type=datacatalog.DeleteEntryRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_get_entry(transport: str = 'grpc', request_type=datacatalog.GetEntryRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datacatalog.Entry(
            name='name_value',
...
def test_lookup_entry(transport: str = 'grpc', request_type=datacatalog.LookupEntryRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.lookup_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datacatalog.Entry(
            name='name_value',
...
def test_list_entries(transport: str = 'grpc', request_type=datacatalog.ListEntriesRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_entries),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_entries_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, datacatalog.Entry)
                   for i in results)
...
def test_create_tag_template(transport: str = 'grpc', request_type=datacatalog.CreateTagTemplateRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_tag_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_tag_template(transport: str = 'grpc', request_type=datacatalog.GetTagTemplateRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_tag_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = tags.TagTemplate(
            name='name_value',
...
def test_update_tag_template(transport: str = 'grpc', request_type=datacatalog.UpdateTagTemplateRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_tag_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = tags.TagTemplate(
            name='name_value',
...
def test_delete_tag_template(transport: str = 'grpc', request_type=datacatalog.DeleteTagTemplateRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_tag_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_create_tag_template_field(transport: str = 'grpc', request_type=datacatalog.CreateTagTemplateFieldRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_tag_template_field(transport: str = 'grpc', request_type=datacatalog.UpdateTagTemplateFieldRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_tag_template_field),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = tags.TagTemplateField(
            name='name_value',
...
def test_rename_tag_template_field(transport: str = 'grpc', request_type=datacatalog.RenameTagTemplateFieldRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rename_tag_template_field),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = tags.TagTemplateField(
            name='name_value',
...
def test_rename_tag_template_field_enum_value(transport: str = 'grpc', request_type=datacatalog.RenameTagTemplateFieldEnumValueRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rename_tag_template_field_enum_value),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = tags.TagTemplateField(
            name='name_value',
...
def test_rename_tag_template_field_enum_value_flattened():
    ...
    with mock.patch.object(
        ...
        assert args[0].new_enum_value_display_name == 'new_enum_value_display_name_value'
...
def test_delete_tag_template_field(transport: str = 'grpc', request_type=datacatalog.DeleteTagTemplateFieldRequest):
    client = DataCatalogClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_tag_template_field),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_list_tags_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, tags.Tag)
                   for i in results)
...
def test_data_catalog_base_transport():
    ...
    with mock.patch('google.cloud.datacatalog_v1.services.data_catalog.transports.DataCatalogTransport.__init__') as Transport:
...
def test_data_catalog_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.datacatalog_v1.services.data_catalog.transports.DataCatalogTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_catalog_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.datacatalog_v1.services.data_catalog.transports.DataCatalogTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.DataCatalogTransport()
        adc.assert_called_once()
...
def test_data_catalog_transport_auth_adc():
    ...
    with mock.patch.object(auth, 'default') as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.DataCatalogGrpcTransport(host="squid.clam.whelk", quota_project_id="octopus")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/cloud-platform',),
            quota_project_id="octopus",
        )
...
def test_data_catalog_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.DataCatalogGrpcTransport, transports.DataCatalogGrpcAsyncIOTransport])
def test_data_catalog_transport_channel_mtls_with_client_cert_source(
    transport_class
):
