...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    if (entryTypeCase_ == 2) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(2, ((java.lang.Integer) entryType_));
    }
    if (!getDisplayNameBytes().isEmpty()) {
    ...
    if (typeSpecCase_ == 6) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(6, (com.google.cloud.datacatalog.v1.GcsFilesetSpec) typeSpec_);
    }
    if (sourceSystemTimestamps_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(7, getSourceSystemTimestamps());
    }
    if (!getLinkedResourceBytes().isEmpty()) {
    ...
    if (systemCase_ == 17) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(17, ((java.lang.Integer) system_));
    }
    if (systemCase_ == 18) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    switch (entryTypeCase_) {
      case 2:
        ...
        break;
      case 16:
        if (!getUserSpecifiedType()
            .equals(other.getUserSpecifiedType())) return false;
        break;
      case 0:
      default:
    }
    ...
    switch (systemCase_) {
      case 17:
        if (getIntegratedSystemValue()
            != other.getIntegratedSystemValue()) return false;
        break;
      case 18:
        if (!getUserSpecifiedSystem()
            .equals(other.getUserSpecifiedSystem())) return false;
        break;
      case 0:
      default:
    }
    ...
    switch (typeSpecCase_) {
      case 6:
        if (!getGcsFilesetSpec()
            .equals(other.getGcsFilesetSpec())) return false;
        break;
      case 12:
        if (!getBigqueryTableSpec()
            .equals(other.getBigqueryTableSpec())) return false;
        break;
      case 15:
        if (!getBigqueryDateShardedSpec()
            .equals(other.getBigqueryDateShardedSpec())) return false;
        break;
      case 0:
      default:
    }
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeBigqueryTableSpec(com.google.cloud.datacatalog.v1.BigQueryTableSpec value) {
      if (bigqueryTableSpecBuilder_ == null) {
        if (typeSpecCase_ == 12 &&
          ...
          typeSpec_ = com.google.cloud.datacatalog.v1.BigQueryTableSpec.newBuilder((com.google.cloud.datacatalog.v1.BigQueryTableSpec) typeSpec_)
              .mergeFrom(value).buildPartial();
        } else {
          typeSpec_ = value;
        }
    ...
    public Builder mergeBigqueryDateShardedSpec(com.google.cloud.datacatalog.v1.BigQueryDateShardedSpec value) {
      if (bigqueryDateShardedSpecBuilder_ == null) {
        if (typeSpecCase_ == 15 &&
          ...
          typeSpec_ = com.google.cloud.datacatalog.v1.BigQueryDateShardedSpec.newBuilder((com.google.cloud.datacatalog.v1.BigQueryDateShardedSpec) typeSpec_)
              .mergeFrom(value).buildPartial();
        } else {
          typeSpec_ = value;
        }
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
      ...
      if (bigqueryDateShardedSpecBuilder_ == null) {
        ...
        bigqueryDateShardedSpecBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.datacatalog.v1.BigQueryDateShardedSpec, com.google.cloud.datacatalog.v1.BigQueryDateShardedSpec.Builder, com.google.cloud.datacatalog.v1.BigQueryDateShardedSpecOrBuilder>(
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.cloud.datacatalog.v1.Schema schema_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.datacatalog.v1.Schema, com.google.cloud.datacatalog.v1.Schema.Builder, com.google.cloud.datacatalog.v1.SchemaOrBuilder> schemaBuilder_;
    /**
     * <pre>
     * Schema of the entry. An entry might not have any schema attached to it.
     * </pre>
    ...
    public com.google.cloud.datacatalog.v1.SchemaOrBuilder getSchemaOrBuilder() {
      if (schemaBuilder_ != null) {
        ...
        return schema_ == null ?
            com.google.cloud.datacatalog.v1.Schema.getDefaultInstance() : schema_;
      }
    }
    /**
     * <pre>
