...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            com.google.cloud.datacatalog.v1.Taxonomy.Builder subBuilder = null;
            if (taxonomy_ != null) {
              subBuilder = taxonomy_.toBuilder();
            }
            taxonomy_ = input.readMessage(com.google.cloud.datacatalog.v1.Taxonomy.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.datacatalog.v1.CreateTaxonomyRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.datacatalog.v1.CreateTaxonomyRequest) e.getUnfinishedMessage();
