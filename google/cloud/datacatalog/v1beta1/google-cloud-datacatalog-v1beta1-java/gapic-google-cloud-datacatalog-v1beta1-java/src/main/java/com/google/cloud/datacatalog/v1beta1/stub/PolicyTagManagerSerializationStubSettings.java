...
/**
 * Settings class to configure an instance of {@link PolicyTagManagerSerializationStub}.
 *
...
public class PolicyTagManagerSerializationStubSettings
  ...
  public UnaryCallSettings<ImportTaxonomiesRequest, ImportTaxonomiesResponse>
      importTaxonomiesSettings() {
    return importTaxonomiesSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic",
            GaxProperties.getLibraryVersion(PolicyTagManagerSerializationStubSettings.class))
        .setTransportToken(
