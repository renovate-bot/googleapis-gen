...
class PolicyTagManagerSerializationAsyncClient:
    ...
    from_service_account_info = PolicyTagManagerSerializationClient.from_service_account_info
    from_service_account_file = PolicyTagManagerSerializationClient.from_service_account_file
