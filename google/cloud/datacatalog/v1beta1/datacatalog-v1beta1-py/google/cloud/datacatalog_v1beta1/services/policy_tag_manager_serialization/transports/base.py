...
class PolicyTagManagerSerializationTransport(abc.ABC):
    ...
    @property
    def import_taxonomies(self) -> typing.Callable[
    ...
    @property
    def export_taxonomies(self) -> typing.Callable[
            [policytagmanagerserialization.ExportTaxonomiesRequest],
            typing.Union[
                policytagmanagerserialization.ExportTaxonomiesResponse,
                typing.Awaitable[policytagmanagerserialization.ExportTaxonomiesResponse]
            ]]:
        raise NotImplementedError()
