...
use Google\Cloud\DataCatalog\V1beta1\PolicyTagManagerSerializationClient;
use Google\Rpc\Code;
use stdClass;
...
class PolicyTagManagerSerializationClientTest extends GeneratedTest
{
    ...
    public function exportTaxonomiesTest()
    {
        ...
        $this->assertSame('/google.cloud.datacatalog.v1beta1.PolicyTagManagerSerialization/ExportTaxonomies', $actualFuncCall);
    ...
    public function importTaxonomiesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datacatalog.v1beta1.PolicyTagManagerSerialization/ImportTaxonomies', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
