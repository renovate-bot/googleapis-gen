 ...
 *
 * Generated from protobuf message <code>google.cloud.datacatalog.v1beta1.UpdateTaxonomyRequest</code>
 */
class UpdateTaxonomyRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\DataCatalog\V1beta1\Taxonomy $taxonomy
     *           The taxonomy to update. Only description, display_name, and activated
     *           policy types can be updated.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.Taxonomy taxonomy = 1;</code>
     * @param \Google\Cloud\DataCatalog\V1beta1\Taxonomy $var
     * @return $this
     */
    public function setTaxonomy($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DataCatalog\V1beta1\Taxonomy::class);
        $this->taxonomy = $var;
