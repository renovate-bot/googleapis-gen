 ...
 *
 * Generated from protobuf message <code>google.cloud.datacatalog.v1beta1.GcsFilesetSpec</code>
 */
class GcsFilesetSpec extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.datacatalog.v1beta1.GcsFileSpec sample_gcs_file_specs = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           You can combine wildcards to provide more powerful matches, for example:
     *            * `gs://bucket_name/[a-m]??.j*g`
     *     @type \Google\Cloud\DataCatalog\V1beta1\GcsFileSpec[]|\Google\Protobuf\Internal\RepeatedField $sample_gcs_file_specs
     *           Output only. Sample files contained in this fileset, not all files contained in this
     *           fileset are represented here.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Datacatalog\V1Beta1\GcsFilesetSpec::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.datacatalog.v1beta1.GcsFileSpec sample_gcs_file_specs = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\DataCatalog\V1beta1\GcsFileSpec[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSampleGcsFileSpecs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DataCatalog\V1beta1\GcsFileSpec::class);
