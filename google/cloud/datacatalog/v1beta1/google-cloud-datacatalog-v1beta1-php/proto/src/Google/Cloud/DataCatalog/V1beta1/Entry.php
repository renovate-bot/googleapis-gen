 ...
 *
 * Generated from protobuf message <code>google.cloud.datacatalog.v1beta1.Entry</code>
 */
class Entry extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.Schema schema = 5;</code>
     */
     ...
     * timestamp.
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.SystemTimestamps source_system_timestamps = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           long.
     *     @type \Google\Cloud\DataCatalog\V1beta1\GcsFilesetSpec $gcs_fileset_spec
     *           Specification that applies to a Cloud Storage fileset. This is only valid
     *           on entries of type FILESET.
     *     @type \Google\Cloud\DataCatalog\V1beta1\BigQueryTableSpec $bigquery_table_spec
     *           Specification that applies to a BigQuery table. This is only valid on
     *           entries of type `TABLE`.
     *     @type \Google\Cloud\DataCatalog\V1beta1\BigQueryDateShardedSpec $bigquery_date_sharded_spec
     ...
     *           Entry description, which can consist of several sentences or paragraphs
     *           that describe entry contents. Default value is an empty string.
     *     @type \Google\Cloud\DataCatalog\V1beta1\Schema $schema
     *           Schema of the entry. An entry might not have any schema attached to it.
     *     @type \Google\Cloud\DataCatalog\V1beta1\SystemTimestamps $source_system_timestamps
     *           Output only. Timestamps about the underlying resource, not about this Data Catalog
     *           entry. Output only when Entry is of type in the EntryType enum. For entries
     *           with user_specified_type, this field is optional and defaults to an empty
     *           timestamp.
     ...
     * Only used for Entries with types in the EntryType enum.
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.EntryType type = 2;</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DataCatalog\V1beta1\EntryType::class);
     ...
     * integrates with, such as BigQuery or Pub/Sub.
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.IntegratedSystem integrated_system = 17 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DataCatalog\V1beta1\IntegratedSystem::class);
     ...
     * on entries of type FILESET.
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.GcsFilesetSpec gcs_fileset_spec = 6;</code>
     * @return \Google\Cloud\DataCatalog\V1beta1\GcsFilesetSpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.GcsFilesetSpec gcs_fileset_spec = 6;</code>
     * @param \Google\Cloud\DataCatalog\V1beta1\GcsFilesetSpec $var
     * @return $this
     */
    public function setGcsFilesetSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DataCatalog\V1beta1\GcsFilesetSpec::class);
     ...
     * entries of type `TABLE`.
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.BigQueryTableSpec bigquery_table_spec = 12;</code>
     * @return \Google\Cloud\DataCatalog\V1beta1\BigQueryTableSpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.BigQueryTableSpec bigquery_table_spec = 12;</code>
     * @param \Google\Cloud\DataCatalog\V1beta1\BigQueryTableSpec $var
     * @return $this
     */
    public function setBigqueryTableSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DataCatalog\V1beta1\BigQueryTableSpec::class);
     ...
     * https://cloud.google.com/bigquery/docs/partitioned-tables#partitioning_versus_sharding.
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.BigQueryDateShardedSpec bigquery_date_sharded_spec = 15;</code>
     * @return \Google\Cloud\DataCatalog\V1beta1\BigQueryDateShardedSpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.BigQueryDateShardedSpec bigquery_date_sharded_spec = 15;</code>
     * @param \Google\Cloud\DataCatalog\V1beta1\BigQueryDateShardedSpec $var
     * @return $this
     */
    public function setBigqueryDateShardedSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DataCatalog\V1beta1\BigQueryDateShardedSpec::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.Schema schema = 5;</code>
     * @return \Google\Cloud\DataCatalog\V1beta1\Schema|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.Schema schema = 5;</code>
     * @param \Google\Cloud\DataCatalog\V1beta1\Schema $var
     * @return $this
     */
    public function setSchema($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DataCatalog\V1beta1\Schema::class);
        $this->schema = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.SystemTimestamps source_system_timestamps = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\DataCatalog\V1beta1\SystemTimestamps $var
     * @return $this
     */
    public function setSourceSystemTimestamps($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DataCatalog\V1beta1\SystemTimestamps::class);
