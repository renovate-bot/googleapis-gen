 ...
 * other columns.
 *
 * Generated from protobuf message <code>google.cloud.datacatalog.v1beta1.ColumnSchema</code>
 */
class ColumnSchema extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.datacatalog.v1beta1.ColumnSchema subcolumns = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    private $subcolumns;
     ...
     *           nullable, etc. Only `NULLABLE`, `REQUIRED` and `REPEATED` are supported.
     *           Default mode is `NULLABLE`.
     *     @type \Google\Cloud\DataCatalog\V1beta1\ColumnSchema[]|\Google\Protobuf\Internal\RepeatedField $subcolumns
     *           Optional. Schema of sub-columns. A column can have zero or more sub-columns.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Datacatalog\V1Beta1\Schema::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.datacatalog.v1beta1.ColumnSchema subcolumns = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\DataCatalog\V1beta1\ColumnSchema[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSubcolumns($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DataCatalog\V1beta1\ColumnSchema::class);
        $this->subcolumns = $arr;
