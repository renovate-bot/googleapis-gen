...
namespace Google\Cloud\DataCatalog\V1beta1\Taxonomy;
 ...
 *
 * Protobuf type <code>google.cloud.datacatalog.v1beta1.Taxonomy.PolicyType</code>
 */
class PolicyType
{
    /**
...
class_alias(PolicyType::class, \Google\Cloud\DataCatalog\V1beta1\Taxonomy_PolicyType::class);
