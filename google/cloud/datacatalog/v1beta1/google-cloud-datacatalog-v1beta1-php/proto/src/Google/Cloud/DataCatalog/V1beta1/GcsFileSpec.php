 ...
 *
 * Generated from protobuf message <code>google.cloud.datacatalog.v1beta1.GcsFileSpec</code>
 */
class GcsFileSpec extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The full file path. Example: `gs://bucket_name/a/b.txt`.
     *     @type \Google\Cloud\DataCatalog\V1beta1\SystemTimestamps $gcs_timestamps
     *           Output only. Timestamps about the Cloud Storage file.
