 ...
 *
 * Generated from protobuf message <code>google.cloud.datacatalog.v1beta1.Tag</code>
 */
class Tag extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.datacatalog.v1beta1.TagField> fields = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $fields;
    protected $scope;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DataCatalog\V1beta1\TagField::class);
        $this->fields = $arr;
