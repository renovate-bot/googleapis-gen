 ...
 *
 * Generated from protobuf message <code>google.cloud.datacatalog.v1beta1.CreateTagTemplateRequest</code>
 */
class CreateTagTemplateRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.TagTemplate tag_template = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The id of the tag template to create.
     *     @type \Google\Cloud\DataCatalog\V1beta1\TagTemplate $tag_template
     *           Required. The tag template to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.TagTemplate tag_template = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\DataCatalog\V1beta1\TagTemplate|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.TagTemplate tag_template = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\DataCatalog\V1beta1\TagTemplate $var
     * @return $this
     */
    public function setTagTemplate($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DataCatalog\V1beta1\TagTemplate::class);
