 ...
 *
 * Generated from protobuf message <code>google.cloud.datacatalog.v1beta1.EntryGroup</code>
 */
class EntryGroup extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.SystemTimestamps data_catalog_timestamps = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           paragraphs that describe entry group contents. Default value is an empty
     *           string.
     *     @type \Google\Cloud\DataCatalog\V1beta1\SystemTimestamps $data_catalog_timestamps
     *           Output only. Timestamps about this EntryGroup. Default value is empty timestamps.
     * }
     */
