 ...
 *
 * Generated from protobuf message <code>google.cloud.datacatalog.v1beta1.CreateTagTemplateFieldRequest</code>
 */
class CreateTagTemplateFieldRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.TagTemplateField tag_template_field = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           character long and at most 128 characters long. Field IDs must also be
     *           unique within their template.
     *     @type \Google\Cloud\DataCatalog\V1beta1\TagTemplateField $tag_template_field
     *           Required. The tag template field to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.TagTemplateField tag_template_field = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\DataCatalog\V1beta1\TagTemplateField|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.datacatalog.v1beta1.TagTemplateField tag_template_field = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\DataCatalog\V1beta1\TagTemplateField $var
     * @return $this
     */
    public function setTagTemplateField($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DataCatalog\V1beta1\TagTemplateField::class);
