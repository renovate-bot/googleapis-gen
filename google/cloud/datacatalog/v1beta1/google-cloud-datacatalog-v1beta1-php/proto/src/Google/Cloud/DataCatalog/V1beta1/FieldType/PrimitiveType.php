...
namespace Google\Cloud\DataCatalog\V1beta1\FieldType;

use UnexpectedValueException;

/**
 * Protobuf type <code>google.cloud.datacatalog.v1beta1.FieldType.PrimitiveType</code>
 */
class PrimitiveType
{
    /**
...
class_alias(PrimitiveType::class, \Google\Cloud\DataCatalog\V1beta1\FieldType_PrimitiveType::class);
