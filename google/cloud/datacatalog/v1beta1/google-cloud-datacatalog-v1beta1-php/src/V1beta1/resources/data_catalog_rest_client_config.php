...
return [
    'interfaces' => [
        'google.cloud.datacatalog.v1beta1.DataCatalog' => [
            ...
            'DeleteTag' => [
                'method' => 'delete',
                'uriTemplate' => '/v1beta1/{name=projects/*/locations/*/entryGroups/*/entries/*/tags/*}',
                'additionalBindings' => [
                    [
                        'method' => 'delete',
                        'uriTemplate' => '/v1beta1/{name=projects/*/locations/*/entryGroups/*/tags/*}',
                    ],
                ],
                'placeholders' => [
                    'name' => [
            ...
            'GetIamPolicy' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta1/{resource=projects/*/locations/*/tagTemplates/*}:getIamPolicy',
                'body' => '*',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1beta1/{resource=projects/*/locations/*/entryGroups/*}:getIamPolicy',
                        'body' => '*',
                    ],
                    [
                        'method' => 'post',
            ...
            'TestIamPermissions' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta1/{resource=projects/*/locations/*/tagTemplates/*}:testIamPermissions',
                'body' => '*',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1beta1/{resource=projects/*/locations/*/entryGroups/*}:testIamPermissions',
                        'body' => '*',
                    ],
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1beta1/{resource=projects/*/locations/*/entryGroups/*/entries/*}:testIamPermissions',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
