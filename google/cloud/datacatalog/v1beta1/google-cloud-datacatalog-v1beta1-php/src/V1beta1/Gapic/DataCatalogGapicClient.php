 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/datacatalog/v1beta1/datacatalog.proto
...
use Google\Cloud\DataCatalog\V1beta1\CreateEntryGroupRequest;
use Google\Cloud\DataCatalog\V1beta1\CreateEntryRequest;
use Google\Cloud\DataCatalog\V1beta1\CreateTagRequest;
use Google\Cloud\DataCatalog\V1beta1\CreateTagTemplateFieldRequest;
use Google\Cloud\DataCatalog\V1beta1\CreateTagTemplateRequest;
use Google\Cloud\DataCatalog\V1beta1\DeleteEntryGroupRequest;
use Google\Cloud\DataCatalog\V1beta1\DeleteEntryRequest;
use Google\Cloud\DataCatalog\V1beta1\DeleteTagRequest;
use Google\Cloud\DataCatalog\V1beta1\DeleteTagTemplateFieldRequest;
use Google\Cloud\DataCatalog\V1beta1\DeleteTagTemplateRequest;
use Google\Cloud\DataCatalog\V1beta1\Entry;
use Google\Cloud\DataCatalog\V1beta1\EntryGroup;
use Google\Cloud\DataCatalog\V1beta1\GetEntryGroupRequest;
use Google\Cloud\DataCatalog\V1beta1\GetEntryRequest;
use Google\Cloud\DataCatalog\V1beta1\GetTagTemplateRequest;
use Google\Cloud\DataCatalog\V1beta1\ListEntriesRequest;
use Google\Cloud\DataCatalog\V1beta1\ListEntriesResponse;
use Google\Cloud\DataCatalog\V1beta1\ListEntryGroupsRequest;
use Google\Cloud\DataCatalog\V1beta1\ListEntryGroupsResponse;
use Google\Cloud\DataCatalog\V1beta1\ListTagsRequest;
use Google\Cloud\DataCatalog\V1beta1\ListTagsResponse;
use Google\Cloud\DataCatalog\V1beta1\LookupEntryRequest;
use Google\Cloud\DataCatalog\V1beta1\RenameTagTemplateFieldRequest;
use Google\Cloud\DataCatalog\V1beta1\SearchCatalogRequest;
...
use Google\Cloud\DataCatalog\V1beta1\UpdateEntryGroupRequest;
use Google\Cloud\DataCatalog\V1beta1\UpdateEntryRequest;
use Google\Cloud\DataCatalog\V1beta1\UpdateTagRequest;
use Google\Cloud\DataCatalog\V1beta1\UpdateTagTemplateFieldRequest;
use Google\Cloud\DataCatalog\V1beta1\UpdateTagTemplateRequest;
...
class DataCatalogGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.datacatalog.v1beta1.DataCatalog';
