...
class ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManager::ClientTest < Minitest::Test
  ...
  def test_list_taxonomies
    ...
    Gapic::ServiceStub.stub :new, list_taxonomies_client_stub do
      ...
      # Use protobuf object
      client.list_taxonomies ::Google::Cloud::DataCatalog::V1beta1::ListTaxonomiesRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_taxonomies(::Google::Cloud::DataCatalog::V1beta1::ListTaxonomiesRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
