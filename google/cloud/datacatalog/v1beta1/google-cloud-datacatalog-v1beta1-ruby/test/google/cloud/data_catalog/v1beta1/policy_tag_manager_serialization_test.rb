...
class ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManagerSerialization::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_import_taxonomies
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DataCatalog::V1beta1::ImportTaxonomiesResponse.new
    ...
    import_taxonomies_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DataCatalog::V1beta1::ImportTaxonomiesRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::DataCatalog::V1beta1::InlineSource), request["inline_source"]
  ...
  def test_export_taxonomies
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::DataCatalog::V1beta1::ExportTaxonomiesResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    export_taxonomies_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::DataCatalog::V1beta1::ExportTaxonomiesRequest, request
      assert_equal "hello world", request["parent"]
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DataCatalog::V1beta1::PolicyTagManagerSerialization::Client::Configuration, config
  end
end
