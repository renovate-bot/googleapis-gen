...
module Google
  module Cloud
    module Datacatalog
      module V1beta1
        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::SearchCatalog SearchCatalog}.
        # @!attribute [rw] scope
        ...
        #     {Google::Cloud::Datacatalog::V1beta1::DataCatalog::SearchCatalog SearchCatalogRequest}
        ...
        class SearchCatalogResponse; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::CreateEntryGroup CreateEntryGroup}.
        # @!attribute [rw] parent
        #   @return [String]
        ...
        class CreateEntryGroupRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::UpdateEntryGroup UpdateEntryGroup}.
        # @!attribute [rw] entry_group
        #   @return [Google::Cloud::Datacatalog::V1beta1::EntryGroup]
        ...
        #     fields are updated.
        class UpdateEntryGroupRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::GetEntryGroup GetEntryGroup}.
        # @!attribute [rw] name
        #   @return [String]
        ...
        class GetEntryGroupRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::DeleteEntryGroup DeleteEntryGroup}.
        # @!attribute [rw] name
        #   @return [String]
        #     Required. The name of the entry group. For example,
        #     `projects/{project_id}/locations/{location}/entryGroups/{entry_group_id}`.
        ...
        class DeleteEntryGroupRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::ListEntryGroups ListEntryGroups}.
        # @!attribute [rw] parent
        #   @return [String]
        ...
        #     returned.
        class ListEntryGroupsRequest; end
        ...
        #     remain in results.
        class ListEntryGroupsResponse; end
        ...
        class CreateEntryRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::UpdateEntry UpdateEntry}.
        # @!attribute [rw] entry
        #   @return [Google::Cloud::Datacatalog::V1beta1::Entry]
        ...
        class UpdateEntryRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::DeleteEntry DeleteEntry}.
        # @!attribute [rw] name
        #   @return [String]
        #     Required. The name of the entry. Example:
        #
        #     * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id}/entries/{entry_id}
        class DeleteEntryRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::GetEntry GetEntry}.
        # @!attribute [rw] name
        #   @return [String]
        #     Required. The name of the entry. Example:
        #
        #     * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id}/entries/{entry_id}
        class GetEntryRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::LookupEntry LookupEntry}.
        ...
        # @!attribute [rw] integrated_system
        ...
        #     string.
        # @!attribute [rw] data_catalog_timestamps
        #   @return [Google::Cloud::Datacatalog::V1beta1::SystemTimestamps]
        #     Output only. Timestamps about this EntryGroup. Default value is empty timestamps.
        class EntryGroup; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::CreateTagTemplate CreateTagTemplate}.
        # @!attribute [rw] parent
        #   @return [String]
        ...
        class CreateTagTemplateRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::GetTagTemplate GetTagTemplate}.
        # @!attribute [rw] name
        #   @return [String]
        #     Required. The name of the tag template. Example:
        #
        #     * projects/{project_id}/locations/{location}/tagTemplates/{tag_template_id}
        class GetTagTemplateRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::UpdateTagTemplate UpdateTagTemplate}.
        # @!attribute [rw] tag_template
        #   @return [Google::Cloud::Datacatalog::V1beta1::TagTemplate]
        ...
        class UpdateTagTemplateRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::DeleteTagTemplate DeleteTagTemplate}.
        # @!attribute [rw] name
        #   @return [String]
        ...
        class DeleteTagTemplateRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::CreateTag CreateTag}.
        # @!attribute [rw] parent
        #   @return [String]
        ...
        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::UpdateTag UpdateTag}.
        # @!attribute [rw] tag
        #   @return [Google::Cloud::Datacatalog::V1beta1::Tag]
        ...
        class UpdateTagRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::DeleteTag DeleteTag}.
        # @!attribute [rw] name
        #   @return [String]
        ...
        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::CreateTagTemplateField CreateTagTemplateField}.
        # @!attribute [rw] parent
        #   @return [String]
        #     Required. The name of the project and the template location
        #     [region](https://cloud.google.com/data-catalog/docs/concepts/regions).
        ...
        class CreateTagTemplateFieldRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::UpdateTagTemplateField UpdateTagTemplateField}.
        # @!attribute [rw] name
        #   @return [String]
        ...
        class UpdateTagTemplateFieldRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::RenameTagTemplateField RenameTagTemplateField}.
        # @!attribute [rw] name
        #   @return [String]
        #     Required. The name of the tag template. Example:
        #
        ...
        class RenameTagTemplateFieldRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::DeleteTagTemplateField DeleteTagTemplateField}.
        # @!attribute [rw] name
        #   @return [String]
        ...
        #     `force = false` will be supported in the future.
        class DeleteTagTemplateFieldRequest; end

        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::ListTags ListTags}.
        # @!attribute [rw] parent
        #   @return [String]
        ...
        # Request message for
        # {Google::Cloud::Datacatalog::V1beta1::DataCatalog::ListEntries ListEntries}.
        # @!attribute [rw] parent
        #   @return [String]
