  ...
  module Cloud
    module Datacatalog
      module V1beta1
        ...
        # @!attribute [rw] template_display_name
        #   @return [String]
        ...
        # @!attribute [rw] fields
        #   @return [Hash{String => Google::Cloud::Datacatalog::V1beta1::TagField}]
        ...
        #     set in {Google::Cloud::Datacatalog::V1beta1::TagTemplateField#order Tag}. For
        ...
        # @!attribute [rw] fields
        #   @return [Hash{String => Google::Cloud::Datacatalog::V1beta1::TagTemplateField}]
