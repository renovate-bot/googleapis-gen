...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/datacatalog/v1beta1/datacatalog.proto", :syntax => :proto3) do
    add_message "google.cloud.datacatalog.v1beta1.SearchCatalogRequest" do
      optional :scope, :message, 6, "google.cloud.datacatalog.v1beta1.SearchCatalogRequest.Scope"
      optional :query, :string, 1
      optional :page_size, :int32, 2
      optional :page_token, :string, 3
      optional :order_by, :string, 5
    end
    add_message "google.cloud.datacatalog.v1beta1.SearchCatalogRequest.Scope" do
      repeated :include_org_ids, :string, 2
      repeated :include_project_ids, :string, 3
      optional :include_gcp_public_datasets, :bool, 7
    end
    add_message "google.cloud.datacatalog.v1beta1.SearchCatalogResponse" do
      repeated :results, :message, 1, "google.cloud.datacatalog.v1beta1.SearchCatalogResult"
      optional :next_page_token, :string, 3
    end
    add_message "google.cloud.datacatalog.v1beta1.CreateEntryGroupRequest" do
      optional :parent, :string, 1
      optional :entry_group_id, :string, 3
      optional :entry_group, :message, 2, "google.cloud.datacatalog.v1beta1.EntryGroup"
    end
    add_message "google.cloud.datacatalog.v1beta1.UpdateEntryGroupRequest" do
      optional :entry_group, :message, 1, "google.cloud.datacatalog.v1beta1.EntryGroup"
      optional :update_mask, :message, 2, "google.protobuf.FieldMask"
    end
    add_message "google.cloud.datacatalog.v1beta1.GetEntryGroupRequest" do
      optional :name, :string, 1
      optional :read_mask, :message, 2, "google.protobuf.FieldMask"
    end
    add_message "google.cloud.datacatalog.v1beta1.DeleteEntryGroupRequest" do
      optional :name, :string, 1
      optional :force, :bool, 2
    end
    add_message "google.cloud.datacatalog.v1beta1.ListEntryGroupsRequest" do
      optional :parent, :string, 1
      optional :page_size, :int32, 2
      optional :page_token, :string, 3
    end
    add_message "google.cloud.datacatalog.v1beta1.ListEntryGroupsResponse" do
      repeated :entry_groups, :message, 1, "google.cloud.datacatalog.v1beta1.EntryGroup"
      optional :next_page_token, :string, 2
    end
    add_message "google.cloud.datacatalog.v1beta1.CreateEntryRequest" do
      optional :parent, :string, 1
      optional :entry_id, :string, 3
      optional :entry, :message, 2, "google.cloud.datacatalog.v1beta1.Entry"
    end
    add_message "google.cloud.datacatalog.v1beta1.UpdateEntryRequest" do
      optional :entry, :message, 1, "google.cloud.datacatalog.v1beta1.Entry"
      optional :update_mask, :message, 2, "google.protobuf.FieldMask"
    end
    add_message "google.cloud.datacatalog.v1beta1.DeleteEntryRequest" do
      optional :name, :string, 1
    end
    add_message "google.cloud.datacatalog.v1beta1.GetEntryRequest" do
      optional :name, :string, 1
    end
    add_message "google.cloud.datacatalog.v1beta1.LookupEntryRequest" do
      oneof :target_name do
        optional :linked_resource, :string, 1
        optional :sql_resource, :string, 3
      end
    end
    add_message "google.cloud.datacatalog.v1beta1.Entry" do
      optional :name, :string, 1
      optional :linked_resource, :string, 9
      optional :display_name, :string, 3
      optional :description, :string, 4
      optional :schema, :message, 5, "google.cloud.datacatalog.v1beta1.Schema"
      optional :source_system_timestamps, :message, 7, "google.cloud.datacatalog.v1beta1.SystemTimestamps"
      oneof :entry_type do
        optional :type, :enum, 2, "google.cloud.datacatalog.v1beta1.EntryType"
        optional :user_specified_type, :string, 16
      end
      oneof :system do
        optional :integrated_system, :enum, 17, "google.cloud.datacatalog.v1beta1.IntegratedSystem"
        optional :user_specified_system, :string, 18
      end
      oneof :type_spec do
        optional :gcs_fileset_spec, :message, 6, "google.cloud.datacatalog.v1beta1.GcsFilesetSpec"
        optional :bigquery_table_spec, :message, 12, "google.cloud.datacatalog.v1beta1.BigQueryTableSpec"
        optional :bigquery_date_sharded_spec, :message, 15, "google.cloud.datacatalog.v1beta1.BigQueryDateShardedSpec"
      end
    end
    add_message "google.cloud.datacatalog.v1beta1.EntryGroup" do
      optional :name, :string, 1
      optional :display_name, :string, 2
      optional :description, :string, 3
      optional :data_catalog_timestamps, :message, 4, "google.cloud.datacatalog.v1beta1.SystemTimestamps"
    end
    add_message "google.cloud.datacatalog.v1beta1.CreateTagTemplateRequest" do
      optional :parent, :string, 1
      optional :tag_template_id, :string, 3
      optional :tag_template, :message, 2, "google.cloud.datacatalog.v1beta1.TagTemplate"
    end
    add_message "google.cloud.datacatalog.v1beta1.GetTagTemplateRequest" do
      optional :name, :string, 1
    end
    add_message "google.cloud.datacatalog.v1beta1.UpdateTagTemplateRequest" do
      optional :tag_template, :message, 1, "google.cloud.datacatalog.v1beta1.TagTemplate"
      optional :update_mask, :message, 2, "google.protobuf.FieldMask"
    end
    add_message "google.cloud.datacatalog.v1beta1.DeleteTagTemplateRequest" do
      optional :name, :string, 1
      optional :force, :bool, 2
    end
    add_message "google.cloud.datacatalog.v1beta1.CreateTagRequest" do
      optional :parent, :string, 1
      optional :tag, :message, 2, "google.cloud.datacatalog.v1beta1.Tag"
    end
    add_message "google.cloud.datacatalog.v1beta1.UpdateTagRequest" do
      optional :tag, :message, 1, "google.cloud.datacatalog.v1beta1.Tag"
      optional :update_mask, :message, 2, "google.protobuf.FieldMask"
    end
    add_message "google.cloud.datacatalog.v1beta1.DeleteTagRequest" do
      optional :name, :string, 1
    end
    add_message "google.cloud.datacatalog.v1beta1.CreateTagTemplateFieldRequest" do
      optional :parent, :string, 1
      optional :tag_template_field_id, :string, 2
      optional :tag_template_field, :message, 3, "google.cloud.datacatalog.v1beta1.TagTemplateField"
    end
    add_message "google.cloud.datacatalog.v1beta1.UpdateTagTemplateFieldRequest" do
      optional :name, :string, 1
      optional :tag_template_field, :message, 2, "google.cloud.datacatalog.v1beta1.TagTemplateField"
      optional :update_mask, :message, 3, "google.protobuf.FieldMask"
    end
    add_message "google.cloud.datacatalog.v1beta1.RenameTagTemplateFieldRequest" do
      optional :name, :string, 1
      optional :new_tag_template_field_id, :string, 2
    end
    add_message "google.cloud.datacatalog.v1beta1.DeleteTagTemplateFieldRequest" do
      optional :name, :string, 1
      optional :force, :bool, 2
    end
    add_message "google.cloud.datacatalog.v1beta1.ListTagsRequest" do
      optional :parent, :string, 1
      optional :page_size, :int32, 2
      optional :page_token, :string, 3
    end
    add_message "google.cloud.datacatalog.v1beta1.ListTagsResponse" do
      repeated :tags, :message, 1, "google.cloud.datacatalog.v1beta1.Tag"
      optional :next_page_token, :string, 2
    end
    add_message "google.cloud.datacatalog.v1beta1.ListEntriesRequest" do
      optional :parent, :string, 1
      optional :page_size, :int32, 2
      optional :page_token, :string, 3
      optional :read_mask, :message, 4, "google.protobuf.FieldMask"
    end
    add_message "google.cloud.datacatalog.v1beta1.ListEntriesResponse" do
      repeated :entries, :message, 1, "google.cloud.datacatalog.v1beta1.Entry"
      optional :next_page_token, :string, 2
    end
    add_enum "google.cloud.datacatalog.v1beta1.EntryType" do
