...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/cloud/datacatalog/v1beta1/table_spec.proto", :syntax => :proto3) do
    add_message "google.cloud.datacatalog.v1beta1.BigQueryTableSpec" do
      optional :table_source_type, :enum, 1, "google.cloud.datacatalog.v1beta1.TableSourceType"
      oneof :type_spec do
        optional :view_spec, :message, 2, "google.cloud.datacatalog.v1beta1.ViewSpec"
        optional :table_spec, :message, 3, "google.cloud.datacatalog.v1beta1.TableSpec"
      end
    end
    add_message "google.cloud.datacatalog.v1beta1.ViewSpec" do
      optional :view_query, :string, 1
    end
    add_message "google.cloud.datacatalog.v1beta1.TableSpec" do
      optional :grouped_entry, :string, 1
    end
    add_message "google.cloud.datacatalog.v1beta1.BigQueryDateShardedSpec" do
      optional :dataset, :string, 1
      optional :table_prefix, :string, 2
      optional :shard_count, :int64, 3
    end
    add_enum "google.cloud.datacatalog.v1beta1.TableSourceType" do
