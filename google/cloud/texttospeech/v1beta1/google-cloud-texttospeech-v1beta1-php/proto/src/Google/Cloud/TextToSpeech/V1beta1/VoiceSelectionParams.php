...
class VoiceSelectionParams extends \Google\Protobuf\Internal\Message
{
     ...
     * configuration.
     *
     * Generated from protobuf field <code>.google.cloud.texttospeech.v1beta1.CustomVoiceParams custom_voice = 4;</code>
     */
     ...
     *           voice of the appropriate gender is not available, the synthesizer should
     *           substitute a voice with a different gender rather than failing the request.
     *     @type \Google\Cloud\TextToSpeech\V1beta1\CustomVoiceParams $custom_voice
     *           The configuration for a custom voice. If [CustomVoiceParams.model] is set,
     *           the service will choose the custom voice matching the specified
     *           configuration.
     * }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.texttospeech.v1beta1.CustomVoiceParams custom_voice = 4;</code>
     * @return \Google\Cloud\TextToSpeech\V1beta1\CustomVoiceParams|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.texttospeech.v1beta1.CustomVoiceParams custom_voice = 4;</code>
     * @param \Google\Cloud\TextToSpeech\V1beta1\CustomVoiceParams $var
     * @return $this
     */
    public function setCustomVoice($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\TextToSpeech\V1beta1\CustomVoiceParams::class);
