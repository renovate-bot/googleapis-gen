...
namespace Google\Cloud\TextToSpeech\V1beta1\CustomVoiceParams;
 ...
 *
 * Protobuf type <code>google.cloud.texttospeech.v1beta1.CustomVoiceParams.ReportedUsage</code>
 */
class ReportedUsage
{
    /**
...
class_alias(ReportedUsage::class, \Google\Cloud\TextToSpeech\V1beta1\CustomVoiceParams_ReportedUsage::class);
