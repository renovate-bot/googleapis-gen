 ...
 *
 * Generated from protobuf message <code>google.cloud.texttospeech.v1beta1.CustomVoiceParams</code>
 */
class CustomVoiceParams extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.texttospeech.v1beta1.CustomVoiceParams.ReportedUsage reported_usage = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\TextToSpeech\V1beta1\CustomVoiceParams\ReportedUsage::class);
