 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/texttospeech/v1beta1/cloud_tts.proto
 * and updates to that file get reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\TextToSpeech\V1beta1\Gapic;
...
use Google\Cloud\TextToSpeech\V1beta1\AudioConfig;
use Google\Cloud\TextToSpeech\V1beta1\ListVoicesRequest;
use Google\Cloud\TextToSpeech\V1beta1\ListVoicesResponse;
use Google\Cloud\TextToSpeech\V1beta1\SynthesisInput;
use Google\Cloud\TextToSpeech\V1beta1\SynthesizeSpeechRequest;
use Google\Cloud\TextToSpeech\V1beta1\SynthesizeSpeechResponse;
use Google\Cloud\TextToSpeech\V1beta1\VoiceSelectionParams;
...
class TextToSpeechGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.texttospeech.v1beta1.TextToSpeech';
    ...
    public function synthesizeSpeech($input, $voice, $audioConfig, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['enableTimePointing'])) {
            $request->setEnableTimePointing($optionalArgs['enableTimePointing']);
        }
