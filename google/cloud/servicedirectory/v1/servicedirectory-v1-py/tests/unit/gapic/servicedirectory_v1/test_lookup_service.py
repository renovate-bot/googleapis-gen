...
from google.cloud.servicedirectory_v1.services.lookup_service import LookupServiceAsyncClient
from google.cloud.servicedirectory_v1.services.lookup_service import LookupServiceClient
from google.cloud.servicedirectory_v1.services.lookup_service import transports
from google.cloud.servicedirectory_v1.services.lookup_service.transports.base import _API_CORE_VERSION
from google.cloud.servicedirectory_v1.services.lookup_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_lookup_service_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (LookupServiceClient, transports.LookupServiceGrpcTransport, "grpc", "true"),
    (LookupServiceAsyncClient, transports.LookupServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (LookupServiceClient, transports.LookupServiceGrpcTransport, "grpc", "false"),
    (LookupServiceAsyncClient, transports.LookupServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(LookupServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(LookupServiceClient))
@mock.patch.object(LookupServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(LookupServiceAsyncClient))
...
def test_resolve_service(transport: str = 'grpc', request_type=lookup_service.ResolveServiceRequest):
    ...
    with mock.patch.object(
            type(client.transport.resolve_service),
            '__call__') as call:
...
def test_lookup_service_base_transport():
    ...
    with mock.patch('google.cloud.servicedirectory_v1.services.lookup_service.transports.LookupServiceTransport.__init__') as Transport:
...
def test_lookup_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.servicedirectory_v1.services.lookup_service.transports.LookupServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_lookup_service_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.servicedirectory_v1.services.lookup_service.transports.LookupServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_lookup_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.servicedirectory_v1.services.lookup_service.transports.LookupServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.LookupServiceTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_lookup_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize(
    ...
    [
        (transports.LookupServiceGrpcTransport, grpc_helpers),
        (transports.LookupServiceGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_lookup_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_lookup_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
def test_lookup_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.LookupServiceGrpcTransport, transports.LookupServiceGrpcAsyncIOTransport])
def test_lookup_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.LookupServiceGrpcTransport, transports.LookupServiceGrpcAsyncIOTransport])
def test_lookup_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
