...
def test_phishing_protection_service_v1_beta1_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.phishingprotection_v1beta1.services.phishing_protection_service_v1_beta1.transports.PhishingProtectionServiceV1Beta1Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_phishing_protection_service_v1_beta1_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.phishingprotection_v1beta1.services.phishing_protection_service_v1_beta1.transports.PhishingProtectionServiceV1Beta1Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.PhishingProtectionServiceV1Beta1Transport()
        adc.assert_called_once()
