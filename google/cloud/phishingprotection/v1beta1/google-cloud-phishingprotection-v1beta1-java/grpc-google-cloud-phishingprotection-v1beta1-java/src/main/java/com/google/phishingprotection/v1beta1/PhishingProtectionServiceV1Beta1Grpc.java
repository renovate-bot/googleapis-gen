...
public final class PhishingProtectionServiceV1Beta1Grpc {
  ...
  public static final String SERVICE_NAME = "google.cloud.phishingprotection.v1beta1.PhishingProtectionServiceV1Beta1";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.phishingprotection.v1beta1.ReportPhishingRequest,
      com.google.phishingprotection.v1beta1.ReportPhishingResponse> getReportPhishingMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.phishingprotection.v1beta1.ReportPhishingRequest,
      com.google.phishingprotection.v1beta1.ReportPhishingResponse> getReportPhishingMethod() {
    io.grpc.MethodDescriptor<com.google.phishingprotection.v1beta1.ReportPhishingRequest, com.google.phishingprotection.v1beta1.ReportPhishingResponse> getReportPhishingMethod;
    if ((getReportPhishingMethod = PhishingProtectionServiceV1Beta1Grpc.getReportPhishingMethod) == null) {
      synchronized (PhishingProtectionServiceV1Beta1Grpc.class) {
        if ((getReportPhishingMethod = PhishingProtectionServiceV1Beta1Grpc.getReportPhishingMethod) == null) {
          PhishingProtectionServiceV1Beta1Grpc.getReportPhishingMethod = getReportPhishingMethod =
              io.grpc.MethodDescriptor.<com.google.phishingprotection.v1beta1.ReportPhishingRequest, com.google.phishingprotection.v1beta1.ReportPhishingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReportPhishing"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.phishingprotection.v1beta1.ReportPhishingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.phishingprotection.v1beta1.ReportPhishingResponse.getDefaultInstance()))
              .setSchemaDescriptor(new PhishingProtectionServiceV1Beta1MethodDescriptorSupplier("ReportPhishing"))
              .build();
        }
      }
    }
  ...
  public static PhishingProtectionServiceV1Beta1Stub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PhishingProtectionServiceV1Beta1Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<PhishingProtectionServiceV1Beta1Stub>() {
        @java.lang.Override
        public PhishingProtectionServiceV1Beta1Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static PhishingProtectionServiceV1Beta1BlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<PhishingProtectionServiceV1Beta1BlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<PhishingProtectionServiceV1Beta1BlockingStub>() {
        @java.lang.Override
        public PhishingProtectionServiceV1Beta1BlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static PhishingProtectionServiceV1Beta1FutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PhishingProtectionServiceV1Beta1FutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<PhishingProtectionServiceV1Beta1FutureStub>() {
        @java.lang.Override
        public PhishingProtectionServiceV1Beta1FutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static abstract class PhishingProtectionServiceV1Beta1ImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void reportPhishing(com.google.phishingprotection.v1beta1.ReportPhishingRequest request,
        io.grpc.stub.StreamObserver<com.google.phishingprotection.v1beta1.ReportPhishingResponse> responseObserver) {
   ...
   * </pre>
   */
  public static final class PhishingProtectionServiceV1Beta1Stub extends io.grpc.stub.AbstractAsyncStub<PhishingProtectionServiceV1Beta1Stub> {
    ...
    public void reportPhishing(com.google.phishingprotection.v1beta1.ReportPhishingRequest request,
        io.grpc.stub.StreamObserver<com.google.phishingprotection.v1beta1.ReportPhishingResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getReportPhishingMethod(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class PhishingProtectionServiceV1Beta1BlockingStub extends io.grpc.stub.AbstractBlockingStub<PhishingProtectionServiceV1Beta1BlockingStub> {
     ...
     * </pre>
     */
    public com.google.phishingprotection.v1beta1.ReportPhishingResponse reportPhishing(com.google.phishingprotection.v1beta1.ReportPhishingRequest request) {
   ...
   * </pre>
   */
  public static final class PhishingProtectionServiceV1Beta1FutureStub extends io.grpc.stub.AbstractFutureStub<PhishingProtectionServiceV1Beta1FutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.phishingprotection.v1beta1.ReportPhishingResponse> reportPhishing(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REPORT_PHISHING:
          serviceImpl.reportPhishing((com.google.phishingprotection.v1beta1.ReportPhishingRequest) request,
              (io.grpc.stub.StreamObserver<com.google.phishingprotection.v1beta1.ReportPhishingResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class PhishingProtectionServiceV1Beta1BaseDescriptorSupplier
      ...
      synchronized (PhishingProtectionServiceV1Beta1Grpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new PhishingProtectionServiceV1Beta1FileDescriptorSupplier())
