...
from google.cloud.memcache_v1.services.cloud_memcache.transports.base import _API_CORE_VERSION
from google.cloud.memcache_v1.services.cloud_memcache.transports.base import _GOOGLE_AUTH_VERSION
...
def test_cloud_memcache_client_client_options_from_dict():
    with mock.patch('google.cloud.memcache_v1.services.cloud_memcache.transports.CloudMemcacheGrpcTransport.__init__') as grpc_transport:
...
def test_cloud_memcache_base_transport():
    ...
    with mock.patch('google.cloud.memcache_v1.services.cloud_memcache.transports.CloudMemcacheTransport.__init__') as Transport:
...
def test_cloud_memcache_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.memcache_v1.services.cloud_memcache.transports.CloudMemcacheTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cloud_memcache_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.memcache_v1.services.cloud_memcache.transports.CloudMemcacheTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.CloudMemcacheTransport()
        adc.assert_called_once()
