...
describe('v1beta2.CloudMemcacheClient', () => {
    it('has servicePath', () => {
        const servicePath = cloudmemcacheModule.v1beta2.CloudMemcacheClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = cloudmemcacheModule.v1beta2.CloudMemcacheClient.apiEndpoint;
        assert(apiEndpoint);
    });
    ...
    describe('getInstance', () => {
        it('invokes getInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.memcache.v1beta2.GetInstanceRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.memcache.v1beta2.Instance());
        ...
        it('invokes getInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getInstance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.memcache.v1beta2.IInstance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createInstance', () => {
        it('invokes createInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.memcache.v1beta2.CreateInstanceRequest());
            request.parent = '';
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.memcache.v1beta2.UpdateInstanceRequest());
            request.resource = {};
    ...
    describe('updateParameters', () => {
        it('invokes updateParameters without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.memcache.v1beta2.UpdateParametersRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateParameters as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteInstance', () => {
        it('invokes deleteInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.memcache.v1beta2.DeleteInstanceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes deleteInstance without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.memcache.v1beta2.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.memcache.v1beta2.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('applyParameters', () => {
        it('invokes applyParameters without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.memcache.v1beta2.ApplyParametersRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.applyParameters as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.memcache.v1beta2.ListInstancesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.memcache.v1beta2.Instance()),
              generateSampleMessage(new protos.google.cloud.memcache.v1beta2.Instance()),
              generateSampleMessage(new protos.google.cloud.memcache.v1beta2.Instance()),
            ];
        ...
        it('invokes listInstancesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.memcache.v1beta2.Instance) => {
