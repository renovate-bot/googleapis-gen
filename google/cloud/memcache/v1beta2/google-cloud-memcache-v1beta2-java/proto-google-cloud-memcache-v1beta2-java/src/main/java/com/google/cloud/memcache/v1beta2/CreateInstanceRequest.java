      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            ...
            resource_ = input.readMessage(com.google.cloud.memcache.v1beta2.Instance.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.memcache.v1beta2.CreateInstanceRequest) e.getUnfinishedMessage();
