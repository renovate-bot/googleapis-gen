...
class ::Google::Cloud::Memcache::V1beta2::CloudMemcache::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Memcache::V1beta2::CloudMemcache::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Memcache::V1beta2::CloudMemcache::Operations::Configuration, config
  end
end
