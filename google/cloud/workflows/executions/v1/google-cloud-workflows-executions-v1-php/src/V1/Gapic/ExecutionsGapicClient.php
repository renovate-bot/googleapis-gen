 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/workflows/executions/v1/executions.proto
 * and updates to that file get reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\Workflows\Executions\V1\Gapic;
...
class ExecutionsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.workflows.executions.v1.Executions';
     ...
     *          For allowed values, use constants defined on {@see \Google\Cloud\Workflows\Executions\V1\ExecutionView}
