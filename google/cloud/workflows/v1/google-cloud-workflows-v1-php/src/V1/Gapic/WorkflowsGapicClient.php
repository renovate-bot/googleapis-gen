 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/workflows/v1/workflows.proto
 * and updates to that file get reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\Workflows\V1\Gapic;
...
class WorkflowsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.workflows.v1.Workflows';
