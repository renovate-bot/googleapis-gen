...
from google.cloud.workflows_v1.services.workflows.transports.base import _API_CORE_VERSION
from google.cloud.workflows_v1.services.workflows.transports.base import _GOOGLE_AUTH_VERSION
...
def test_workflows_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_workflows_client_client_options_from_dict():
    with mock.patch('google.cloud.workflows_v1.services.workflows.transports.WorkflowsGrpcTransport.__init__') as grpc_transport:
...
def test_list_workflows(transport: str = 'grpc', request_type=workflows.ListWorkflowsRequest):
    client = WorkflowsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_workflows_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, workflows.Workflow)
                   for i in results)
...
def test_create_workflow(transport: str = 'grpc', request_type=workflows.CreateWorkflowRequest):
    client = WorkflowsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_workflow(transport: str = 'grpc', request_type=workflows.DeleteWorkflowRequest):
    client = WorkflowsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_workflow(transport: str = 'grpc', request_type=workflows.UpdateWorkflowRequest):
    client = WorkflowsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_workflows_base_transport():
    ...
    with mock.patch('google.cloud.workflows_v1.services.workflows.transports.WorkflowsTransport.__init__') as Transport:
...
def test_workflows_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.workflows_v1.services.workflows.transports.WorkflowsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_workflows_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.workflows_v1.services.workflows.transports.WorkflowsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.WorkflowsTransport()
        adc.assert_called_once()
...
def test_workflows_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.WorkflowsGrpcTransport, transports.WorkflowsGrpcAsyncIOTransport])
def test_workflows_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.WorkflowsGrpcTransport, transports.WorkflowsGrpcAsyncIOTransport])
def test_workflows_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
