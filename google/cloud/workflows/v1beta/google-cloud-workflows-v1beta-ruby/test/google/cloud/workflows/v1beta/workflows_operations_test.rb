...
class ::Google::Cloud::Workflows::V1beta::Workflows::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Workflows::V1beta::Workflows::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Workflows::V1beta::Workflows::Operations::Configuration, config
  end
end
