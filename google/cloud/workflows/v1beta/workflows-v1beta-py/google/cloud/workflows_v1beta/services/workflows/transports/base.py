...
class WorkflowsTransport(abc.ABC):
    ...
    @property
    def list_workflows(self) -> typing.Callable[
            [workflows.ListWorkflowsRequest],
            typing.Union[
                workflows.ListWorkflowsResponse,
                typing.Awaitable[workflows.ListWorkflowsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_workflow(self) -> typing.Callable[
            [workflows.GetWorkflowRequest],
            typing.Union[
                workflows.Workflow,
                typing.Awaitable[workflows.Workflow]
            ]]:
        raise NotImplementedError()

    @property
    def create_workflow(self) -> typing.Callable[
    ...
    @property
    def delete_workflow(self) -> typing.Callable[
    ...
    @property
    def update_workflow(self) -> typing.Callable[
