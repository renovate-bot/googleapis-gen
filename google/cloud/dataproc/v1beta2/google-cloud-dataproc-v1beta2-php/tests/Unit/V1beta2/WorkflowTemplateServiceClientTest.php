...
use Google\Cloud\Dataproc\V1beta2\WorkflowTemplateServiceClient;
...
class WorkflowTemplateServiceClientTest extends GeneratedTest
{
    ...
    public function createWorkflowTemplateTest()
    {
        ...
        $this->assertSame('/google.cloud.dataproc.v1beta2.WorkflowTemplateService/CreateWorkflowTemplate', $actualFuncCall);
    ...
    public function deleteWorkflowTemplateTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dataproc.v1beta2.WorkflowTemplateService/DeleteWorkflowTemplate', $actualFuncCall);
    ...
    public function getWorkflowTemplateTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dataproc.v1beta2.WorkflowTemplateService/GetWorkflowTemplate', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function instantiateInlineWorkflowTemplateTest()
    {
        ...
        $incompleteOperation->setName('operations/instantiateInlineWorkflowTemplateTest');
        ...
        $completeOperation->setName('operations/instantiateInlineWorkflowTemplateTest');
        ...
        $this->assertSame('/google.cloud.dataproc.v1beta2.WorkflowTemplateService/InstantiateInlineWorkflowTemplate', $actualApiFuncCall);
    ...
    public function instantiateWorkflowTemplateTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/instantiateWorkflowTemplateTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new GPBEmpty();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/instantiateWorkflowTemplateTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dataproc.v1beta2.WorkflowTemplateService/InstantiateWorkflowTemplate', $actualApiFuncCall);
    ...
    public function listWorkflowTemplatesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dataproc.v1beta2.WorkflowTemplateService/ListWorkflowTemplates', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateWorkflowTemplateTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dataproc.v1beta2.WorkflowTemplateService/UpdateWorkflowTemplate', $actualFuncCall);
        $actualValue = $actualRequestObject->getTemplate();
        $this->assertProtobufEquals($template, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
