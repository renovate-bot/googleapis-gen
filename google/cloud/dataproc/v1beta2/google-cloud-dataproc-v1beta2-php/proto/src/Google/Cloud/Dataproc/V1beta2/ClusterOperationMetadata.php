 ...
 *
 * Generated from protobuf message <code>google.cloud.dataproc.v1beta2.ClusterOperationMetadata</code>
 */
class ClusterOperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dataproc.v1beta2.ClusterOperationStatus status_history = 10;</code>
     */
     ...
     *           Output only. Cluster UUID for the operation.
     *     @type \Google\Cloud\Dataproc\V1beta2\ClusterOperationStatus $status
     *           Output only. Current operation status.
     *     @type \Google\Cloud\Dataproc\V1beta2\ClusterOperationStatus[]|\Google\Protobuf\Internal\RepeatedField $status_history
     *           Output only. The previous operation status.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataproc.v1beta2.ClusterOperationStatus status = 9;</code>
     * @param \Google\Cloud\Dataproc\V1beta2\ClusterOperationStatus $var
     * @return $this
     */
    public function setStatus($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dataproc\V1beta2\ClusterOperationStatus::class);
        $this->status = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dataproc.v1beta2.ClusterOperationStatus status_history = 10;</code>
     * @param \Google\Cloud\Dataproc\V1beta2\ClusterOperationStatus[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setStatusHistory($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dataproc\V1beta2\ClusterOperationStatus::class);
