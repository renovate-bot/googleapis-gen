 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/dataproc/v1beta2/jobs.proto
...
use Google\Cloud\Dataproc\V1beta2\CancelJobRequest;
use Google\Cloud\Dataproc\V1beta2\DeleteJobRequest;
...
class JobControllerGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dataproc.v1beta2.JobController';
     ...
     *          For allowed values, use constants defined on {@see \Google\Cloud\Dataproc\V1beta2\ListJobsRequest\JobStateMatcher}
     *     @type string $filter
