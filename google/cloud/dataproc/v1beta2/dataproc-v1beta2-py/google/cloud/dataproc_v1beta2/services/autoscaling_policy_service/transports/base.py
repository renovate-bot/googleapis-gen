...
class AutoscalingPolicyServiceTransport(abc.ABC):
    ...
    @property
    def create_autoscaling_policy(self) -> typing.Callable[
    ...
    @property
    def update_autoscaling_policy(self) -> typing.Callable[
    ...
    @property
    def get_autoscaling_policy(self) -> typing.Callable[
    ...
    @property
    def list_autoscaling_policies(self) -> typing.Callable[
    ...
    @property
    def delete_autoscaling_policy(self) -> typing.Callable[
