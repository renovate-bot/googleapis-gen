...
class WorkflowTemplateServiceTransport(abc.ABC):
    ...
    @property
    def create_workflow_template(self) -> typing.Callable[
            [workflow_templates.CreateWorkflowTemplateRequest],
            typing.Union[
                workflow_templates.WorkflowTemplate,
                typing.Awaitable[workflow_templates.WorkflowTemplate]
            ]]:
        raise NotImplementedError()

    @property
    def get_workflow_template(self) -> typing.Callable[
    ...
    @property
    def instantiate_workflow_template(self) -> typing.Callable[
    ...
    @property
    def instantiate_inline_workflow_template(self) -> typing.Callable[
    ...
    @property
    def update_workflow_template(self) -> typing.Callable[
    ...
    @property
    def list_workflow_templates(self) -> typing.Callable[
            [workflow_templates.ListWorkflowTemplatesRequest],
            typing.Union[
                workflow_templates.ListWorkflowTemplatesResponse,
                typing.Awaitable[workflow_templates.ListWorkflowTemplatesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def delete_workflow_template(self) -> typing.Callable[
