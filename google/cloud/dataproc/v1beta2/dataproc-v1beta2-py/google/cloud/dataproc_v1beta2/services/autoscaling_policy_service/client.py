...
class AutoscalingPolicyServiceClient(metaclass=AutoscalingPolicyServiceClientMeta):
    ...
    @staticmethod
    def autoscaling_policy_path(project: str,location: str,autoscaling_policy: str,) -> str:
        """Return a fully-qualified autoscaling_policy string."""
        return "projects/{project}/locations/{location}/autoscalingPolicies/{autoscaling_policy}".format(project=project, location=location, autoscaling_policy=autoscaling_policy, )

    @staticmethod
    def parse_autoscaling_policy_path(path: str) -> Dict[str,str]:
        """Parse a autoscaling_policy path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/autoscalingPolicies/(?P<autoscaling_policy>.+?)$", path)
    ...
    def create_autoscaling_policy(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_autoscaling_policy]
    ...
    def update_autoscaling_policy(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_autoscaling_policy]
    ...
    def list_autoscaling_policies(self,
        ...
        Returns:
            google.cloud.dataproc_v1beta2.services.autoscaling_policy_service.pagers.ListAutoscalingPoliciesPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_autoscaling_policies]
    ...
    def delete_autoscaling_policy(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_autoscaling_policy]
