...
class WorkflowTemplateServiceClient(metaclass=WorkflowTemplateServiceClientMeta):
    ...
    @staticmethod
    def workflow_template_path(project: str,region: str,workflow_template: str,) -> str:
        """Return a fully-qualified workflow_template string."""
        return "projects/{project}/regions/{region}/workflowTemplates/{workflow_template}".format(project=project, region=region, workflow_template=workflow_template, )
    ...
    def create_workflow_template(self,
        ...
        Returns:
            google.cloud.dataproc_v1beta2.types.WorkflowTemplate:
    ...
    def instantiate_workflow_template(self,
        ...
        Args:
            ...
            name (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            parameters (Sequence[google.cloud.dataproc_v1beta2.types.InstantiateWorkflowTemplateRequest.ParametersEntry]):
    ...
    def list_workflow_templates(self,
        ...
        Returns:
            google.cloud.dataproc_v1beta2.services.workflow_template_service.pagers.ListWorkflowTemplatesPager:
