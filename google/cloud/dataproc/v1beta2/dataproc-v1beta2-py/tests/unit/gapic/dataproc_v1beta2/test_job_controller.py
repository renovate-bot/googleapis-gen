...
from google.cloud.dataproc_v1beta2.services.job_controller import JobControllerAsyncClient
...
def test_job_controller_client_from_service_account_info():
    creds = credentials.AnonymousCredentials()
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        factory.return_value = creds
        info = {"valid": True}
        client = JobControllerClient.from_service_account_info(info)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (JobControllerAsyncClient, transports.JobControllerGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (JobControllerAsyncClient, transports.JobControllerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (JobControllerClient, transports.JobControllerGrpcTransport, "grpc", "false"),
    (JobControllerAsyncClient, transports.JobControllerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_job_controller_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_job_controller_client_client_options_from_dict():
    with mock.patch('google.cloud.dataproc_v1beta2.services.job_controller.transports.JobControllerGrpcTransport.__init__') as grpc_transport:
...
def test_submit_job(transport: str = 'grpc', request_type=jobs.SubmitJobRequest):
    ...
    with mock.patch.object(
            type(client.transport.submit_job),
            '__call__') as call:
...
def test_submit_job_as_operation(transport: str = 'grpc', request_type=jobs.SubmitJobRequest):
    client = JobControllerClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.submit_job_as_operation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_job_controller_base_transport():
    ...
    with mock.patch('google.cloud.dataproc_v1beta2.services.job_controller.transports.JobControllerTransport.__init__') as Transport:
...
def test_job_controller_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.dataproc_v1beta2.services.job_controller.transports.JobControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_job_controller_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.dataproc_v1beta2.services.job_controller.transports.JobControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.JobControllerTransport()
        adc.assert_called_once()
...
def test_job_controller_transport_auth_adc():
    ...
    with mock.patch.object(auth, 'default') as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.JobControllerGrpcTransport(host="squid.clam.whelk", quota_project_id="octopus")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/cloud-platform',),
            quota_project_id="octopus",
        )
...
def test_job_controller_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.JobControllerGrpcTransport, transports.JobControllerGrpcAsyncIOTransport])
def test_job_controller_transport_channel_mtls_with_client_cert_source(
    transport_class
):
