...
from google.cloud.dataproc_v1beta2.services.workflow_template_service import WorkflowTemplateServiceAsyncClient
from google.cloud.dataproc_v1beta2.services.workflow_template_service import WorkflowTemplateServiceClient
from google.cloud.dataproc_v1beta2.services.workflow_template_service import pagers
from google.cloud.dataproc_v1beta2.services.workflow_template_service import transports
...
def test_workflow_template_service_client_from_service_account_info():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        info = {"valid": True}
        client = WorkflowTemplateServiceClient.from_service_account_info(info)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (WorkflowTemplateServiceClient, transports.WorkflowTemplateServiceGrpcTransport, "grpc"),
    (WorkflowTemplateServiceAsyncClient, transports.WorkflowTemplateServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (WorkflowTemplateServiceClient, transports.WorkflowTemplateServiceGrpcTransport, "grpc", "true"),
    (WorkflowTemplateServiceAsyncClient, transports.WorkflowTemplateServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (WorkflowTemplateServiceClient, transports.WorkflowTemplateServiceGrpcTransport, "grpc", "false"),
    (WorkflowTemplateServiceAsyncClient, transports.WorkflowTemplateServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_workflow_template_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_workflow_template_service_client_client_options_from_dict():
    with mock.patch('google.cloud.dataproc_v1beta2.services.workflow_template_service.transports.WorkflowTemplateServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_workflow_template(transport: str = 'grpc', request_type=workflow_templates.CreateWorkflowTemplateRequest):
    client = WorkflowTemplateServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.create_workflow_template),
            '__call__') as call:
...
def test_get_workflow_template(transport: str = 'grpc', request_type=workflow_templates.GetWorkflowTemplateRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_workflow_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = workflow_templates.WorkflowTemplate(
            id='id_value',
...
def test_instantiate_workflow_template(transport: str = 'grpc', request_type=workflow_templates.InstantiateWorkflowTemplateRequest):
    client = WorkflowTemplateServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.instantiate_workflow_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_instantiate_inline_workflow_template(transport: str = 'grpc', request_type=workflow_templates.InstantiateInlineWorkflowTemplateRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.instantiate_inline_workflow_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_workflow_template(transport: str = 'grpc', request_type=workflow_templates.UpdateWorkflowTemplateRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_workflow_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = workflow_templates.WorkflowTemplate(
            id='id_value',
...
def test_list_workflow_templates(transport: str = 'grpc', request_type=workflow_templates.ListWorkflowTemplatesRequest):
    client = WorkflowTemplateServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_workflow_templates_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, workflow_templates.WorkflowTemplate)
                   for i in results)
...
def test_delete_workflow_template(transport: str = 'grpc', request_type=workflow_templates.DeleteWorkflowTemplateRequest):
    client = WorkflowTemplateServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_workflow_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_workflow_template_service_base_transport():
    ...
    with mock.patch('google.cloud.dataproc_v1beta2.services.workflow_template_service.transports.WorkflowTemplateServiceTransport.__init__') as Transport:
...
def test_workflow_template_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.dataproc_v1beta2.services.workflow_template_service.transports.WorkflowTemplateServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_workflow_template_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.dataproc_v1beta2.services.workflow_template_service.transports.WorkflowTemplateServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.WorkflowTemplateServiceTransport()
        adc.assert_called_once()
...
def test_workflow_template_service_transport_auth_adc():
    ...
    with mock.patch.object(auth, 'default') as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.WorkflowTemplateServiceGrpcTransport(host="squid.clam.whelk", quota_project_id="octopus")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/cloud-platform',),
            quota_project_id="octopus",
        )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.WorkflowTemplateServiceGrpcTransport, transports.WorkflowTemplateServiceGrpcAsyncIOTransport])
def test_workflow_template_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
