...
class ::Google::Cloud::Dataproc::V1beta2::ClusterController::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Dataproc::V1beta2::ClusterController::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Dataproc::V1beta2::ClusterController::Operations::Configuration, config
  end
end
