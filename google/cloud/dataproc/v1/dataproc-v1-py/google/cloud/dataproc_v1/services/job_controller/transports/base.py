...
class JobControllerTransport(abc.ABC):
    ...
    @property
    def submit_job(self) -> typing.Callable[
            [jobs.SubmitJobRequest],
            typing.Union[
                jobs.Job,
                typing.Awaitable[jobs.Job]
            ]]:
        raise NotImplementedError()

    @property
    def submit_job_as_operation(self) -> typing.Callable[
            [jobs.SubmitJobRequest],
            typing.Union[
    ...
    def list_jobs(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[jobs.ListJobsResponse]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def cancel_job(self) -> typing.Callable[
