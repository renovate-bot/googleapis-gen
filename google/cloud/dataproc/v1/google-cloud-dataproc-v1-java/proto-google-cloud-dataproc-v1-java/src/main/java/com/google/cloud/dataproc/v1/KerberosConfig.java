...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.google.cloud.dataproc.v1.ClustersProto.internal_static_google_cloud_dataproc_v1_KerberosConfig_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.cloud.dataproc.v1.KerberosConfig.class, com.google.cloud.dataproc.v1.KerberosConfig.Builder.class);
  }
  ...
  public int getSerializedSize() {
    ...
    if (enableKerberos_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(1, enableKerberos_);
    }
    if (!getRootPrincipalPasswordUriBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(2, rootPrincipalPasswordUri_);
    }
    if (!getKmsKeyUriBytes().isEmpty()) {
    ...
    if (!getCrossRealmTrustAdminServerBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(11, crossRealmTrustAdminServer_);
    }
    if (!getCrossRealmTrustSharedPasswordUriBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(12, crossRealmTrustSharedPasswordUri_);
    }
    if (!getKdcDbKeyUriBytes().isEmpty()) {
    ...
    if (tgtLifetimeHours_ != 0) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt32Size(14, tgtLifetimeHours_);
    }
    if (!getRealmBytes().isEmpty()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.dataproc.v1.KerberosConfig other = (com.google.cloud.dataproc.v1.KerberosConfig) obj;

    if (getEnableKerberos()
        != other.getEnableKerberos()) return false;
    if (!getRootPrincipalPasswordUri()
        .equals(other.getRootPrincipalPasswordUri())) return false;
    if (!getKmsKeyUri()
        .equals(other.getKmsKeyUri())) return false;
    if (!getKeystoreUri()
        .equals(other.getKeystoreUri())) return false;
    if (!getTruststoreUri()
        .equals(other.getTruststoreUri())) return false;
    if (!getKeystorePasswordUri()
        .equals(other.getKeystorePasswordUri())) return false;
    if (!getKeyPasswordUri()
        .equals(other.getKeyPasswordUri())) return false;
    if (!getTruststorePasswordUri()
        .equals(other.getTruststorePasswordUri())) return false;
    if (!getCrossRealmTrustRealm()
        .equals(other.getCrossRealmTrustRealm())) return false;
    if (!getCrossRealmTrustKdc()
        .equals(other.getCrossRealmTrustKdc())) return false;
    if (!getCrossRealmTrustAdminServer()
        .equals(other.getCrossRealmTrustAdminServer())) return false;
    if (!getCrossRealmTrustSharedPasswordUri()
        .equals(other.getCrossRealmTrustSharedPasswordUri())) return false;
    if (!getKdcDbKeyUri()
        .equals(other.getKdcDbKeyUri())) return false;
    if (getTgtLifetimeHours()
  ...
  public static com.google.cloud.dataproc.v1.KerberosConfig parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
