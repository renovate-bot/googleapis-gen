...
require "google/cloud/vpcaccess/v1/vpc_access_service"

class ::Google::Cloud::Vpcaccess::V1::VpcAccessService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Vpcaccess::V1::VpcAccessService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Vpcaccess::V1::VpcAccessService::Operations::Configuration, config
  end
end
