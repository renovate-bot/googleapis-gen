...
class VpcAccessServiceTransport(abc.ABC):
    ...
    @property
    def create_connector(self) -> typing.Callable[
    ...
    @property
    def get_connector(self) -> typing.Callable[
            [vpc_access.GetConnectorRequest],
            typing.Union[
                vpc_access.Connector,
                typing.Awaitable[vpc_access.Connector]
            ]]:
        raise NotImplementedError()

    @property
    def list_connectors(self) -> typing.Callable[
            [vpc_access.ListConnectorsRequest],
            typing.Union[
                vpc_access.ListConnectorsResponse,
                typing.Awaitable[vpc_access.ListConnectorsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def delete_connector(self) -> typing.Callable[
