...
public class PublicKeyName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}/publicKey");
  ...
  public static PublicKeyName of(String project, String location, String keyRing, String cryptoKey, String cryptoKeyVersion) {
    return newBuilder()
      .setProject(project)
  ...
  public static PublicKeyName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "PublicKeyName.parse: formattedString not in valid format");
