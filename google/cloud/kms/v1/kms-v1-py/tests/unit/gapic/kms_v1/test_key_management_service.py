...
from google.cloud.kms_v1.services.key_management_service import KeyManagementServiceAsyncClient
...
from google.cloud.kms_v1.services.key_management_service.transports.base import _API_CORE_VERSION
from google.cloud.kms_v1.services.key_management_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_key_management_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_list_key_rings(transport: str = 'grpc', request_type=service.ListKeyRingsRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_key_rings_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, resources.KeyRing)
                   for i in results)
...
def test_list_crypto_keys(transport: str = 'grpc', request_type=service.ListCryptoKeysRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_crypto_keys_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.CryptoKey)
                   for i in results)
...
def test_list_crypto_key_versions(transport: str = 'grpc', request_type=service.ListCryptoKeyVersionsRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_crypto_key_versions_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.CryptoKeyVersion)
                   for i in results)
...
def test_list_import_jobs(transport: str = 'grpc', request_type=service.ListImportJobsRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_import_jobs_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, resources.ImportJob)
                   for i in results)
...
def test_get_crypto_key(transport: str = 'grpc', request_type=service.GetCryptoKeyRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_crypto_key_version(transport: str = 'grpc', request_type=service.GetCryptoKeyVersionRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_public_key(transport: str = 'grpc', request_type=service.GetPublicKeyRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_import_job(transport: str = 'grpc', request_type=service.GetImportJobRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_key_ring(transport: str = 'grpc', request_type=service.CreateKeyRingRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_crypto_key(transport: str = 'grpc', request_type=service.CreateCryptoKeyRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_crypto_key_version(transport: str = 'grpc', request_type=service.CreateCryptoKeyVersionRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_crypto_key_version_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].crypto_key_version == resources.CryptoKeyVersion(name='name_value')
...
def test_import_crypto_key_version(transport: str = 'grpc', request_type=service.ImportCryptoKeyVersionRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_import_job(transport: str = 'grpc', request_type=service.CreateImportJobRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_crypto_key(transport: str = 'grpc', request_type=service.UpdateCryptoKeyRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_crypto_key_version(transport: str = 'grpc', request_type=service.UpdateCryptoKeyVersionRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_asymmetric_sign(transport: str = 'grpc', request_type=service.AsymmetricSignRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_asymmetric_decrypt(transport: str = 'grpc', request_type=service.AsymmetricDecryptRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_destroy_crypto_key_version(transport: str = 'grpc', request_type=service.DestroyCryptoKeyVersionRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_restore_crypto_key_version(transport: str = 'grpc', request_type=service.RestoreCryptoKeyVersionRequest):
    client = KeyManagementServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_key_management_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.kms_v1.services.key_management_service.transports.KeyManagementServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_key_management_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.kms_v1.services.key_management_service.transports.KeyManagementServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.KeyManagementServiceTransport()
        adc.assert_called_once()
...
def test_key_management_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_key_management_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.KeyManagementServiceGrpcTransport, transports.KeyManagementServiceGrpcAsyncIOTransport])
def test_key_management_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
