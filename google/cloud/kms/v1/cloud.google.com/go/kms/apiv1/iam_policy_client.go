...
// internalIamPolicyClient is an interface that defines the methods availaible from Cloud Key Management Service (KMS) API.
...
// IamPolicyClient is a client for interacting with Cloud Key Management Service (KMS) API.
...
// iamPolicyGRPCClient is a client for interacting with Cloud Key Management Service (KMS) API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
