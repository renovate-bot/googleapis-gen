...
class ::Google::Cloud::Lifesciences::V2beta::WorkflowsServiceV2Beta::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Lifesciences::V2beta::WorkflowsServiceV2Beta::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Lifesciences::V2beta::WorkflowsServiceV2Beta::Operations, client.operations_client
  end
end
