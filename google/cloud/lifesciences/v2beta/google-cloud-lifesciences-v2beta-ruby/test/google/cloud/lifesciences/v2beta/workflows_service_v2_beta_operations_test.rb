...
class ::Google::Cloud::Lifesciences::V2beta::WorkflowsServiceV2Beta::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Lifesciences::V2beta::WorkflowsServiceV2Beta::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Lifesciences::V2beta::WorkflowsServiceV2Beta::Operations::Configuration, config
  end
end
