 ...
 *
 * Generated from protobuf message <code>google.cloud.tasks.v2.CreateTaskRequest</code>
 */
class CreateTaskRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
     *           The queue must already exist.
     *     @type \Google\Cloud\Tasks\V2\Task $task
     *           Required. The task to add.
     *           Task names have the following format:
     *           `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`.
     *           The user can optionally specify a task [name][google.cloud.tasks.v2.Task.name]. If a
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Tasks\V2\Task::class);
        $this->task = $var;
