...
namespace Google\Cloud\Tasks\Tests\Unit\V2beta3;
...
class CloudTasksClientTest extends GeneratedTest
{
    ...
    public function listQueuesTest()
    {
        ...
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/ListQueues', $actualFuncCall);
    ...
    public function getQueueTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/GetQueue', $actualFuncCall);
    ...
    public function createQueueTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/CreateQueue', $actualFuncCall);
    ...
    public function updateQueueTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/UpdateQueue', $actualFuncCall);
    ...
    public function deleteQueueTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/DeleteQueue', $actualFuncCall);
    ...
    public function purgeQueueTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/PurgeQueue', $actualFuncCall);
    ...
    public function pauseQueueTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/PauseQueue', $actualFuncCall);
    ...
    public function resumeQueueTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/ResumeQueue', $actualFuncCall);
    ...
    public function getIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/GetIamPolicy', $actualFuncCall);
    ...
    public function setIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/SetIamPolicy', $actualFuncCall);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/TestIamPermissions', $actualFuncCall);
    ...
    public function listTasksTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/ListTasks', $actualFuncCall);
    ...
    public function getTaskTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/GetTask', $actualFuncCall);
    ...
    public function createTaskTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/CreateTask', $actualFuncCall);
    ...
    public function deleteTaskTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/DeleteTask', $actualFuncCall);
    ...
    public function runTaskTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tasks.v2beta3.CloudTasks/RunTask', $actualFuncCall);
