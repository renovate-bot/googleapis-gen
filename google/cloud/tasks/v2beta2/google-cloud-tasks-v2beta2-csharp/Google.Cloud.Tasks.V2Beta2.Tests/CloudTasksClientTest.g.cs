    ...
    public sealed class GeneratedCloudTasksClientTest
    {
        ...
        public void LeaseTasksRequestObject()
        {
            ...
            LeaseTasksRequest request = new LeaseTasksRequest
            {
                ParentAsQueueName = QueueName.FromProjectLocationQueue("[PROJECT]", "[LOCATION]", "[QUEUE]"),
                MaxTasks = -1117339770,
                LeaseDuration = new wkt::Duration(),
                ResponseView = Task.Types.View.Basic,
                Filter = "filtere47ac9b2",
            };
            LeaseTasksResponse expectedResponse = new LeaseTasksResponse { Tasks = { new Task(), }, };
            mockGrpcClient.Setup(x => x.LeaseTasks(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
        ...
        [xunit::FactAttribute]
        public async stt::Task LeaseTasksRequestObjectAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            LeaseTasksRequest request = new LeaseTasksRequest
            {
            ...
            LeaseTasksResponse expectedResponse = new LeaseTasksResponse { Tasks = { new Task(), }, };
            mockGrpcClient.Setup(x => x.LeaseTasksAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<LeaseTasksResponse>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            LeaseTasksResponse responseCallSettings = await client.LeaseTasksAsync(request, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            LeaseTasksResponse responseCancellationToken = await client.LeaseTasksAsync(request, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void LeaseTasks()
        {
            ...
            mockGrpcClient.Setup(x => x.LeaseTasks(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            LeaseTasksResponse response = client.LeaseTasks(request.Parent, request.LeaseDuration);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task LeaseTasksAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            LeaseTasksRequest request = new LeaseTasksRequest
            {
            ...
            mockGrpcClient.Setup(x => x.LeaseTasksAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<LeaseTasksResponse>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            LeaseTasksResponse responseCallSettings = await client.LeaseTasksAsync(request.Parent, request.LeaseDuration, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            LeaseTasksResponse responseCancellationToken = await client.LeaseTasksAsync(request.Parent, request.LeaseDuration, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void LeaseTasksResourceNames()
        {
            ...
            mockGrpcClient.Setup(x => x.LeaseTasks(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            LeaseTasksResponse response = client.LeaseTasks(request.ParentAsQueueName, request.LeaseDuration);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task LeaseTasksResourceNamesAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            LeaseTasksRequest request = new LeaseTasksRequest
            {
            ...
            mockGrpcClient.Setup(x => x.LeaseTasksAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<LeaseTasksResponse>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            LeaseTasksResponse responseCallSettings = await client.LeaseTasksAsync(request.ParentAsQueueName, request.LeaseDuration, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            LeaseTasksResponse responseCancellationToken = await client.LeaseTasksAsync(request.ParentAsQueueName, request.LeaseDuration, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void AcknowledgeTaskRequestObject()
        {
            ...
            wkt::Empty expectedResponse = new wkt::Empty { };
            mockGrpcClient.Setup(x => x.AcknowledgeTask(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
        ...
        [xunit::FactAttribute]
        public async stt::Task AcknowledgeTaskRequestObjectAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            AcknowledgeTaskRequest request = new AcknowledgeTaskRequest
            {
            ...
            wkt::Empty expectedResponse = new wkt::Empty { };
            mockGrpcClient.Setup(x => x.AcknowledgeTaskAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<wkt::Empty>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            await client.AcknowledgeTaskAsync(request, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            await client.AcknowledgeTaskAsync(request, st::CancellationToken.None);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void AcknowledgeTask()
        {
            ...
            mockGrpcClient.Setup(x => x.AcknowledgeTask(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            client.AcknowledgeTask(request.Name, request.ScheduleTime);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task AcknowledgeTaskAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            AcknowledgeTaskRequest request = new AcknowledgeTaskRequest
            {
            ...
            mockGrpcClient.Setup(x => x.AcknowledgeTaskAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<wkt::Empty>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            await client.AcknowledgeTaskAsync(request.Name, request.ScheduleTime, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            await client.AcknowledgeTaskAsync(request.Name, request.ScheduleTime, st::CancellationToken.None);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void AcknowledgeTaskResourceNames()
        {
            ...
            mockGrpcClient.Setup(x => x.AcknowledgeTask(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            client.AcknowledgeTask(request.TaskName, request.ScheduleTime);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task AcknowledgeTaskResourceNamesAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            AcknowledgeTaskRequest request = new AcknowledgeTaskRequest
            {
            ...
            mockGrpcClient.Setup(x => x.AcknowledgeTaskAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<wkt::Empty>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            await client.AcknowledgeTaskAsync(request.TaskName, request.ScheduleTime, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            await client.AcknowledgeTaskAsync(request.TaskName, request.ScheduleTime, st::CancellationToken.None);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void RenewLeaseRequestObject()
        {
            ...
            mockGrpcClient.Setup(x => x.RenewLease(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task response = client.RenewLease(request);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task RenewLeaseRequestObjectAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            RenewLeaseRequest request = new RenewLeaseRequest
            {
            ...
            mockGrpcClient.Setup(x => x.RenewLeaseAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<Task>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task responseCallSettings = await client.RenewLeaseAsync(request, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            Task responseCancellationToken = await client.RenewLeaseAsync(request, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void RenewLease()
        {
            ...
            mockGrpcClient.Setup(x => x.RenewLease(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task response = client.RenewLease(request.Name, request.ScheduleTime, request.LeaseDuration);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task RenewLeaseAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            RenewLeaseRequest request = new RenewLeaseRequest
            {
            ...
            mockGrpcClient.Setup(x => x.RenewLeaseAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<Task>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task responseCallSettings = await client.RenewLeaseAsync(request.Name, request.ScheduleTime, request.LeaseDuration, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            Task responseCancellationToken = await client.RenewLeaseAsync(request.Name, request.ScheduleTime, request.LeaseDuration, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void RenewLeaseResourceNames()
        {
            ...
            mockGrpcClient.Setup(x => x.RenewLease(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task response = client.RenewLease(request.TaskName, request.ScheduleTime, request.LeaseDuration);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task RenewLeaseResourceNamesAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            RenewLeaseRequest request = new RenewLeaseRequest
            {
            ...
            mockGrpcClient.Setup(x => x.RenewLeaseAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<Task>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task responseCallSettings = await client.RenewLeaseAsync(request.TaskName, request.ScheduleTime, request.LeaseDuration, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            Task responseCancellationToken = await client.RenewLeaseAsync(request.TaskName, request.ScheduleTime, request.LeaseDuration, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void CancelLeaseRequestObject()
        {
            ...
            mockGrpcClient.Setup(x => x.CancelLease(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task response = client.CancelLease(request);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task CancelLeaseRequestObjectAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            CancelLeaseRequest request = new CancelLeaseRequest
            {
            ...
            mockGrpcClient.Setup(x => x.CancelLeaseAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<Task>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task responseCallSettings = await client.CancelLeaseAsync(request, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            Task responseCancellationToken = await client.CancelLeaseAsync(request, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void CancelLease()
        {
            ...
            mockGrpcClient.Setup(x => x.CancelLease(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task response = client.CancelLease(request.Name, request.ScheduleTime);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task CancelLeaseAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            CancelLeaseRequest request = new CancelLeaseRequest
            {
            ...
            mockGrpcClient.Setup(x => x.CancelLeaseAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<Task>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task responseCallSettings = await client.CancelLeaseAsync(request.Name, request.ScheduleTime, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            Task responseCancellationToken = await client.CancelLeaseAsync(request.Name, request.ScheduleTime, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void CancelLeaseResourceNames()
        {
            ...
            mockGrpcClient.Setup(x => x.CancelLease(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task response = client.CancelLease(request.TaskName, request.ScheduleTime);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task CancelLeaseResourceNamesAsync()
        {
            moq::Mock<CloudTasks.CloudTasksClient> mockGrpcClient = new moq::Mock<CloudTasks.CloudTasksClient>(moq::MockBehavior.Strict);
            CancelLeaseRequest request = new CancelLeaseRequest
            {
            ...
            mockGrpcClient.Setup(x => x.CancelLeaseAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<Task>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            CloudTasksClient client = new CloudTasksClientImpl(mockGrpcClient.Object, null);
            Task responseCallSettings = await client.CancelLeaseAsync(request.TaskName, request.ScheduleTime, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            Task responseCancellationToken = await client.CancelLeaseAsync(request.TaskName, request.ScheduleTime, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
