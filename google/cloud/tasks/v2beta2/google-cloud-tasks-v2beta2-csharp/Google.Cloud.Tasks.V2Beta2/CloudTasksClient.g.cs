...
namespace Google.Cloud.Tasks.V2Beta2
{
    ...
    public sealed partial class CloudTasksSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private CloudTasksSettings(CloudTasksSettings existing) : base(existing)
        {
            ...
            LeaseTasksSettings = existing.LeaseTasksSettings;
            AcknowledgeTaskSettings = existing.AcknowledgeTaskSettings;
            RenewLeaseSettings = existing.RenewLeaseSettings;
            CancelLeaseSettings = existing.CancelLeaseSettings;
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to <c>CloudTasksClient.LeaseTasks</c>
        ///  and <c>CloudTasksClient.LeaseTasksAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings LeaseTasksSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(20000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>CloudTasksClient.AcknowledgeTask</c> and <c>CloudTasksClient.AcknowledgeTaskAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings AcknowledgeTaskSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(20000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to <c>CloudTasksClient.RenewLease</c>
        ///  and <c>CloudTasksClient.RenewLeaseAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings RenewLeaseSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(20000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>CloudTasksClient.CancelLease</c> and <c>CloudTasksClient.CancelLeaseAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings CancelLeaseSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(20000)));
    ...
    public abstract partial class CloudTasksClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual LeaseTasksResponse LeaseTasks(LeaseTasksRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<LeaseTasksResponse> LeaseTasksAsync(LeaseTasksRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<LeaseTasksResponse> LeaseTasksAsync(LeaseTasksRequest request, st::CancellationToken cancellationToken) =>
            LeaseTasksAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual LeaseTasksResponse LeaseTasks(string parent, wkt::Duration leaseDuration, gaxgrpc::CallSettings callSettings = null) =>
            LeaseTasks(new LeaseTasksRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<LeaseTasksResponse> LeaseTasksAsync(string parent, wkt::Duration leaseDuration, gaxgrpc::CallSettings callSettings = null) =>
            LeaseTasksAsync(new LeaseTasksRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                LeaseDuration = gax::GaxPreconditions.CheckNotNull(leaseDuration, nameof(leaseDuration)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<LeaseTasksResponse> LeaseTasksAsync(string parent, wkt::Duration leaseDuration, st::CancellationToken cancellationToken) =>
            LeaseTasksAsync(parent, leaseDuration, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual LeaseTasksResponse LeaseTasks(QueueName parent, wkt::Duration leaseDuration, gaxgrpc::CallSettings callSettings = null) =>
            LeaseTasks(new LeaseTasksRequest
            {
                ParentAsQueueName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                LeaseDuration = gax::GaxPreconditions.CheckNotNull(leaseDuration, nameof(leaseDuration)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<LeaseTasksResponse> LeaseTasksAsync(QueueName parent, wkt::Duration leaseDuration, gaxgrpc::CallSettings callSettings = null) =>
            LeaseTasksAsync(new LeaseTasksRequest
            {
                ParentAsQueueName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                LeaseDuration = gax::GaxPreconditions.CheckNotNull(leaseDuration, nameof(leaseDuration)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<LeaseTasksResponse> LeaseTasksAsync(QueueName parent, wkt::Duration leaseDuration, st::CancellationToken cancellationToken) =>
            LeaseTasksAsync(parent, leaseDuration, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void AcknowledgeTask(AcknowledgeTaskRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task AcknowledgeTaskAsync(AcknowledgeTaskRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task AcknowledgeTaskAsync(AcknowledgeTaskRequest request, st::CancellationToken cancellationToken) =>
            AcknowledgeTaskAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void AcknowledgeTask(string name, wkt::Timestamp scheduleTime, gaxgrpc::CallSettings callSettings = null) =>
            AcknowledgeTask(new AcknowledgeTaskRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task AcknowledgeTaskAsync(string name, wkt::Timestamp scheduleTime, gaxgrpc::CallSettings callSettings = null) =>
            AcknowledgeTaskAsync(new AcknowledgeTaskRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task AcknowledgeTaskAsync(string name, wkt::Timestamp scheduleTime, st::CancellationToken cancellationToken) =>
            AcknowledgeTaskAsync(name, scheduleTime, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void AcknowledgeTask(TaskName name, wkt::Timestamp scheduleTime, gaxgrpc::CallSettings callSettings = null) =>
            AcknowledgeTask(new AcknowledgeTaskRequest
            {
                TaskName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task AcknowledgeTaskAsync(TaskName name, wkt::Timestamp scheduleTime, gaxgrpc::CallSettings callSettings = null) =>
            AcknowledgeTaskAsync(new AcknowledgeTaskRequest
            {
                TaskName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task AcknowledgeTaskAsync(TaskName name, wkt::Timestamp scheduleTime, st::CancellationToken cancellationToken) =>
            AcknowledgeTaskAsync(name, scheduleTime, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Task RenewLease(RenewLeaseRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> RenewLeaseAsync(RenewLeaseRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> RenewLeaseAsync(RenewLeaseRequest request, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Task RenewLease(string name, wkt::Timestamp scheduleTime, wkt::Duration leaseDuration, gaxgrpc::CallSettings callSettings = null) =>
            RenewLease(new RenewLeaseRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
                LeaseDuration = gax::GaxPreconditions.CheckNotNull(leaseDuration, nameof(leaseDuration)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> RenewLeaseAsync(string name, wkt::Timestamp scheduleTime, wkt::Duration leaseDuration, gaxgrpc::CallSettings callSettings = null) =>
            RenewLeaseAsync(new RenewLeaseRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
                LeaseDuration = gax::GaxPreconditions.CheckNotNull(leaseDuration, nameof(leaseDuration)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> RenewLeaseAsync(string name, wkt::Timestamp scheduleTime, wkt::Duration leaseDuration, st::CancellationToken cancellationToken) =>
            RenewLeaseAsync(name, scheduleTime, leaseDuration, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Task RenewLease(TaskName name, wkt::Timestamp scheduleTime, wkt::Duration leaseDuration, gaxgrpc::CallSettings callSettings = null) =>
            RenewLease(new RenewLeaseRequest
            {
                TaskName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> RenewLeaseAsync(TaskName name, wkt::Timestamp scheduleTime, wkt::Duration leaseDuration, gaxgrpc::CallSettings callSettings = null) =>
            RenewLeaseAsync(new RenewLeaseRequest
            {
                TaskName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> RenewLeaseAsync(TaskName name, wkt::Timestamp scheduleTime, wkt::Duration leaseDuration, st::CancellationToken cancellationToken) =>
            RenewLeaseAsync(name, scheduleTime, leaseDuration, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Task CancelLease(CancelLeaseRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> CancelLeaseAsync(CancelLeaseRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> CancelLeaseAsync(CancelLeaseRequest request, st::CancellationToken cancellationToken) =>
            CancelLeaseAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Task CancelLease(string name, wkt::Timestamp scheduleTime, gaxgrpc::CallSettings callSettings = null) =>
            CancelLease(new CancelLeaseRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> CancelLeaseAsync(string name, wkt::Timestamp scheduleTime, gaxgrpc::CallSettings callSettings = null) =>
            CancelLeaseAsync(new CancelLeaseRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> CancelLeaseAsync(string name, wkt::Timestamp scheduleTime, st::CancellationToken cancellationToken) =>
            CancelLeaseAsync(name, scheduleTime, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual Task CancelLease(TaskName name, wkt::Timestamp scheduleTime, gaxgrpc::CallSettings callSettings = null) =>
            CancelLease(new CancelLeaseRequest
            {
                TaskName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> CancelLeaseAsync(TaskName name, wkt::Timestamp scheduleTime, gaxgrpc::CallSettings callSettings = null) =>
            CancelLeaseAsync(new CancelLeaseRequest
            {
                TaskName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
                ScheduleTime = gax::GaxPreconditions.CheckNotNull(scheduleTime, nameof(scheduleTime)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<Task> CancelLeaseAsync(TaskName name, wkt::Timestamp scheduleTime, st::CancellationToken cancellationToken) =>
            CancelLeaseAsync(name, scheduleTime, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    ...
    public sealed partial class CloudTasksClientImpl : CloudTasksClient
    {
        ...
        private readonly gaxgrpc::ApiCall<LeaseTasksRequest, LeaseTasksResponse> _callLeaseTasks;

        private readonly gaxgrpc::ApiCall<AcknowledgeTaskRequest, wkt::Empty> _callAcknowledgeTask;

        private readonly gaxgrpc::ApiCall<RenewLeaseRequest, Task> _callRenewLease;

        private readonly gaxgrpc::ApiCall<CancelLeaseRequest, Task> _callCancelLease;
        ...
        public CloudTasksClientImpl(CloudTasks.CloudTasksClient grpcClient, CloudTasksSettings settings)
        {
            ...
            _callLeaseTasks = clientHelper.BuildApiCall<LeaseTasksRequest, LeaseTasksResponse>(grpcClient.LeaseTasksAsync, grpcClient.LeaseTasks, effectiveSettings.LeaseTasksSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callLeaseTasks);
            Modify_LeaseTasksApiCall(ref _callLeaseTasks);
            _callAcknowledgeTask = clientHelper.BuildApiCall<AcknowledgeTaskRequest, wkt::Empty>(grpcClient.AcknowledgeTaskAsync, grpcClient.AcknowledgeTask, effectiveSettings.AcknowledgeTaskSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callAcknowledgeTask);
            Modify_AcknowledgeTaskApiCall(ref _callAcknowledgeTask);
            _callRenewLease = clientHelper.BuildApiCall<RenewLeaseRequest, Task>(grpcClient.RenewLeaseAsync, grpcClient.RenewLease, effectiveSettings.RenewLeaseSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callRenewLease);
            Modify_RenewLeaseApiCall(ref _callRenewLease);
            _callCancelLease = clientHelper.BuildApiCall<CancelLeaseRequest, Task>(grpcClient.CancelLeaseAsync, grpcClient.CancelLease, effectiveSettings.CancelLeaseSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callCancelLease);
            Modify_CancelLeaseApiCall(ref _callCancelLease);
        ...
        partial void Modify_LeaseTasksApiCall(ref gaxgrpc::ApiCall<LeaseTasksRequest, LeaseTasksResponse> call);

        partial void Modify_AcknowledgeTaskApiCall(ref gaxgrpc::ApiCall<AcknowledgeTaskRequest, wkt::Empty> call);

        partial void Modify_RenewLeaseApiCall(ref gaxgrpc::ApiCall<RenewLeaseRequest, Task> call);

        partial void Modify_CancelLeaseApiCall(ref gaxgrpc::ApiCall<CancelLeaseRequest, Task> call);
        ...
        partial void Modify_LeaseTasksRequest(ref LeaseTasksRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_AcknowledgeTaskRequest(ref AcknowledgeTaskRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_RenewLeaseRequest(ref RenewLeaseRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_CancelLeaseRequest(ref CancelLeaseRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override LeaseTasksResponse LeaseTasks(LeaseTasksRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_LeaseTasksRequest(ref request, ref callSettings);
            return _callLeaseTasks.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<LeaseTasksResponse> LeaseTasksAsync(LeaseTasksRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_LeaseTasksRequest(ref request, ref callSettings);
            return _callLeaseTasks.Async(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override void AcknowledgeTask(AcknowledgeTaskRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_AcknowledgeTaskRequest(ref request, ref callSettings);
            _callAcknowledgeTask.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task AcknowledgeTaskAsync(AcknowledgeTaskRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_AcknowledgeTaskRequest(ref request, ref callSettings);
            return _callAcknowledgeTask.Async(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override Task RenewLease(RenewLeaseRequest request, gaxgrpc::CallSettings callSettings = null)
        {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<Task> RenewLeaseAsync(RenewLeaseRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_RenewLeaseRequest(ref request, ref callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override Task CancelLease(CancelLeaseRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_CancelLeaseRequest(ref request, ref callSettings);
            return _callCancelLease.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<Task> CancelLeaseAsync(CancelLeaseRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_CancelLeaseRequest(ref request, ref callSettings);
            return _callCancelLease.Async(request, callSettings);
        }
