...
def test_cloud_tasks_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_cloud_tasks_client_client_options_from_dict():
    with mock.patch('google.cloud.tasks_v2beta2.services.cloud_tasks.transports.CloudTasksGrpcTransport.__init__') as grpc_transport:
...
def test_get_queue(transport: str = 'grpc', request_type=cloudtasks.GetQueueRequest):
    ...
    with mock.patch.object(
        ...
        call.return_value = queue.Queue(
            ...
            app_engine_http_target=target.AppEngineHttpTarget(app_engine_routing_override=target.AppEngineRouting(service='service_value')),
        )
...
def test_get_task(transport: str = 'grpc', request_type=cloudtasks.GetTaskRequest):
    ...
    with mock.patch.object(
        ...
        call.return_value = task.Task(
            ...
            app_engine_http_request=target.AppEngineHttpRequest(http_method=target.HttpMethod.POST),
        )
...
def test_lease_tasks(transport: str = 'grpc', request_type=cloudtasks.LeaseTasksRequest):
    client = CloudTasksClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.lease_tasks),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_lease_tasks_async(transport: str = 'grpc_asyncio', request_type=cloudtasks.LeaseTasksRequest):
    client = CloudTasksAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(cloudtasks.LeaseTasksResponse(
        ))
...
def test_lease_tasks_flattened():
    ...
    with mock.patch.object(
        ...
        assert DurationRule().to_proto(args[0].lease_duration) == duration.Duration(seconds=751)
...
def test_acknowledge_task(transport: str = 'grpc', request_type=cloudtasks.AcknowledgeTaskRequest):
    client = CloudTasksClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.acknowledge_task),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_acknowledge_task_async(transport: str = 'grpc_asyncio', request_type=cloudtasks.AcknowledgeTaskRequest):
    client = CloudTasksAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_acknowledge_task_flattened():
    ...
    with mock.patch.object(
        ...
        assert TimestampRule().to_proto(args[0].schedule_time) == timestamp.Timestamp(seconds=751)
...
def test_renew_lease(transport: str = 'grpc', request_type=cloudtasks.RenewLeaseRequest):
    client = CloudTasksClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.renew_lease),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = task.Task(
            name='name_value',
...
@pytest.mark.asyncio
async def test_renew_lease_async(transport: str = 'grpc_asyncio', request_type=cloudtasks.RenewLeaseRequest):
    client = CloudTasksAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_lease(transport: str = 'grpc', request_type=cloudtasks.CancelLeaseRequest):
    client = CloudTasksClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.cancel_lease),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = task.Task(
            name='name_value',
...
@pytest.mark.asyncio
async def test_cancel_lease_async(transport: str = 'grpc_asyncio', request_type=cloudtasks.CancelLeaseRequest):
    client = CloudTasksAsyncClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cloud_tasks_base_transport():
    ...
    with mock.patch('google.cloud.tasks_v2beta2.services.cloud_tasks.transports.CloudTasksTransport.__init__') as Transport:
...
def test_cloud_tasks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.tasks_v2beta2.services.cloud_tasks.transports.CloudTasksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cloud_tasks_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.tasks_v2beta2.services.cloud_tasks.transports.CloudTasksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.CloudTasksTransport()
        adc.assert_called_once()
...
def test_cloud_tasks_transport_auth_adc():
    ...
    with mock.patch.object(auth, 'default') as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.CloudTasksGrpcTransport(host="squid.clam.whelk", quota_project_id="octopus")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/cloud-platform',),
            quota_project_id="octopus",
        )
