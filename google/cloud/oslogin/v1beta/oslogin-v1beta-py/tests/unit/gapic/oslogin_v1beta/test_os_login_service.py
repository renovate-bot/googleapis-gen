...
from google.cloud.oslogin_v1beta.services.os_login_service import OsLoginServiceAsyncClient
from google.cloud.oslogin_v1beta.services.os_login_service import OsLoginServiceClient
from google.cloud.oslogin_v1beta.services.os_login_service import transports
from google.cloud.oslogin_v1beta.services.os_login_service.transports.base import _API_CORE_VERSION
from google.cloud.oslogin_v1beta.services.os_login_service.transports.base import _GOOGLE_AUTH_VERSION
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (OsLoginServiceAsyncClient, transports.OsLoginServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (OsLoginServiceClient, transports.OsLoginServiceGrpcTransport, "grpc", "false"),
    (OsLoginServiceAsyncClient, transports.OsLoginServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(OsLoginServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OsLoginServiceClient))
@mock.patch.object(OsLoginServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OsLoginServiceAsyncClient))
...
def test_os_login_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_os_login_service_client_client_options_from_dict():
    with mock.patch('google.cloud.oslogin_v1beta.services.os_login_service.transports.OsLoginServiceGrpcTransport.__init__') as grpc_transport:
...
async def test_get_ssh_public_key_async(transport: str = 'grpc_asyncio', request_type=oslogin.GetSshPublicKeyRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(common_pb2.SshPublicKey(
            key='key_value',
            expiration_time_usec=2144,
            fingerprint='fingerprint_value',
            name='name_value',
...
def test_os_login_service_base_transport():
    ...
    with mock.patch('google.cloud.oslogin_v1beta.services.os_login_service.transports.OsLoginServiceTransport.__init__') as Transport:
...
def test_os_login_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.oslogin_v1beta.services.os_login_service.transports.OsLoginServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_os_login_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.oslogin_v1beta.services.os_login_service.transports.OsLoginServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.OsLoginServiceTransport()
        adc.assert_called_once()
...
def test_os_login_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_os_login_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
def test_os_login_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_os_login_service_host_no_port():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='oslogin.googleapis.com'),
    )
    assert client.transport._host == 'oslogin.googleapis.com:443'
...
def test_os_login_service_host_with_port():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='oslogin.googleapis.com:8000'),
    )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.OsLoginServiceGrpcTransport, transports.OsLoginServiceGrpcAsyncIOTransport])
def test_os_login_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_user_path():
    ...
    actual = OsLoginServiceClient.user_path(user)
    assert expected == actual
...
def test_parse_user_path():
    ...
    path = OsLoginServiceClient.user_path(**expected)

    # Check that the path construction is reversible.
    actual = OsLoginServiceClient.parse_user_path(path)
    assert expected == actual
