...
class LoginProfile(proto.Message):
    ...
    Attributes:
        ...
        posix_accounts (Sequence[google.cloud.oslogin.common.common_pb2.PosixAccount]):
            ...
            the user.
        ssh_public_keys (Sequence[google.cloud.oslogin_v1beta.types.LoginProfile.SshPublicKeysEntry]):
...
class ImportSshPublicKeyResponse(proto.Message):
    ...
    Attributes:
        login_profile (google.cloud.oslogin_v1beta.types.LoginProfile):
