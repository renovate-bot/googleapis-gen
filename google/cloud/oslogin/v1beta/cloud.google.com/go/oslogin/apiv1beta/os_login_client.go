...
// internalClient is an interface that defines the methods availaible from Google Cloud OS Login API.
...
// gRPCClient is a client for interacting with Google Cloud OS Login API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
