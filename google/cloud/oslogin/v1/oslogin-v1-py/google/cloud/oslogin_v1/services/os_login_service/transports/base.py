...
class OsLoginServiceTransport(abc.ABC):
    ...
    @property
    def delete_posix_account(self) -> typing.Callable[
    ...
    @property
    def delete_ssh_public_key(self) -> typing.Callable[
    ...
    @property
    def get_login_profile(self) -> typing.Callable[
            [oslogin.GetLoginProfileRequest],
            typing.Union[
                oslogin.LoginProfile,
                typing.Awaitable[oslogin.LoginProfile]
            ]]:
        raise NotImplementedError()

    @property
    def get_ssh_public_key(self) -> typing.Callable[
            [oslogin.GetSshPublicKeyRequest],
            typing.Union[
                common.SshPublicKey,
                typing.Awaitable[common.SshPublicKey]
            ]]:
        raise NotImplementedError()

    @property
    def import_ssh_public_key(self) -> typing.Callable[
    ...
    @property
    def update_ssh_public_key(self) -> typing.Callable[
