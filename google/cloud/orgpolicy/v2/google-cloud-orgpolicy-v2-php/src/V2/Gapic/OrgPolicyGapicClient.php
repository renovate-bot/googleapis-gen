 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/orgpolicy/v2/orgpolicy.proto
...
class OrgPolicyGapicClient
{
    ...
    {
        if (null == self::$folderPolicyNameTemplate) {
    ...
    {
        if (null == self::$organizationPolicyNameTemplate) {
    ...
    {
        if (null == self::$policyNameTemplate) {
    ...
    {
        if (null == self::$projectPolicyNameTemplate) {
    ...
    /**
     * Formats a string containing the fully-qualified path to represent
     * a organization_policy resource.
     *
     * @param string $organization
     * @param string $policy
     *
     ...
     * try {
     *     $name = '';
     *     $response = $orgPolicyClient->getPolicy($name);
     * } finally {
     *     $orgPolicyClient->close();
     * }
     * ```
     ...
     * try {
     *     $name = '';
     *     $response = $orgPolicyClient->getEffectivePolicy($name);
     * } finally {
     *     $orgPolicyClient->close();
     * }
     * ```
