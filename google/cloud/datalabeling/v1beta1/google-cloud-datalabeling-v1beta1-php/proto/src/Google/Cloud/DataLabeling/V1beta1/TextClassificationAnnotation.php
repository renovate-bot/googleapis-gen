 ...
 *
 * Generated from protobuf message <code>google.cloud.datalabeling.v1beta1.TextClassificationAnnotation</code>
 */
class TextClassificationAnnotation extends \Google\Protobuf\Internal\Message
{
    /**
     * Label of the text.
     *
