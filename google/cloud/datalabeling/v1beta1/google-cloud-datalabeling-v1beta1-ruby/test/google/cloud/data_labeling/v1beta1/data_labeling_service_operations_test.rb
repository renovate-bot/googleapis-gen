...
class ::Google::Cloud::DataLabeling::V1beta1::DataLabelingService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::DataLabeling::V1beta1::DataLabelingService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DataLabeling::V1beta1::DataLabelingService::Operations::Configuration, config
  end
end
