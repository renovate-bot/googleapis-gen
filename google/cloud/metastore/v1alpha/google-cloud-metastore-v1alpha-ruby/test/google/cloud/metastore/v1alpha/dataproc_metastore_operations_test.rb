...
class ::Google::Cloud::Metastore::V1alpha::DataprocMetastore::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Metastore::V1alpha::DataprocMetastore::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Metastore::V1alpha::DataprocMetastore::Operations::Configuration, config
  end
end
