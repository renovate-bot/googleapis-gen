...
class ::Google::Cloud::Metastore::V1alpha::DataprocMetastore::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_services
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Metastore::V1alpha::ListServicesResponse.new
    ...
    list_services_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::ListServicesRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_services_client_stub do
      ...
      # Use protobuf object
      client.list_services ::Google::Cloud::Metastore::V1alpha::ListServicesRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_service
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Metastore::V1alpha::Service.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_service_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::GetServiceRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_service_client_stub do
      ...
      # Use protobuf object
      client.get_service ::Google::Cloud::Metastore::V1alpha::GetServiceRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_service
    ...
    create_service_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::CreateServiceRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["service_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Metastore::V1alpha::Service), request["service"]
    ...
    Gapic::ServiceStub.stub :new, create_service_client_stub do
      ...
      # Use protobuf object
      client.create_service ::Google::Cloud::Metastore::V1alpha::CreateServiceRequest.new(parent: parent, service_id: service_id, service: service, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_service
    ...
    update_service_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::UpdateServiceRequest, request
    ...
    Gapic::ServiceStub.stub :new, update_service_client_stub do
      ...
      # Use protobuf object
      client.update_service ::Google::Cloud::Metastore::V1alpha::UpdateServiceRequest.new(update_mask: update_mask, service: service, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_service
    ...
    delete_service_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::DeleteServiceRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_service_client_stub do
      ...
      # Use protobuf object
      client.delete_service ::Google::Cloud::Metastore::V1alpha::DeleteServiceRequest.new(name: name, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_metadata_imports
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Metastore::V1alpha::ListMetadataImportsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_metadata_imports_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::ListMetadataImportsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      assert_equal "hello world", request["filter"]
    ...
    Gapic::ServiceStub.stub :new, list_metadata_imports_client_stub do
      ...
      # Use protobuf object
      client.list_metadata_imports ::Google::Cloud::Metastore::V1alpha::ListMetadataImportsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_metadata_import
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Metastore::V1alpha::MetadataImport.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_metadata_import_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::GetMetadataImportRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_metadata_import_client_stub do
      ...
      # Use protobuf object
      client.get_metadata_import ::Google::Cloud::Metastore::V1alpha::GetMetadataImportRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_metadata_import
    ...
    create_metadata_import_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::CreateMetadataImportRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["metadata_import_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Metastore::V1alpha::MetadataImport), request["metadata_import"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_metadata_import_client_stub do
      ...
      # Use protobuf object
      client.create_metadata_import ::Google::Cloud::Metastore::V1alpha::CreateMetadataImportRequest.new(parent: parent, metadata_import_id: metadata_import_id, metadata_import: metadata_import, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_metadata_import
    ...
    update_metadata_import_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::UpdateMetadataImportRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Metastore::V1alpha::MetadataImport), request["metadata_import"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    ...
    Gapic::ServiceStub.stub :new, update_metadata_import_client_stub do
      ...
      # Use protobuf object
      client.update_metadata_import ::Google::Cloud::Metastore::V1alpha::UpdateMetadataImportRequest.new(update_mask: update_mask, metadata_import: metadata_import, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_export_metadata
    ...
    export_metadata_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::ExportMetadataRequest, request
    ...
    Gapic::ServiceStub.stub :new, export_metadata_client_stub do
      ...
      # Use protobuf object
      client.export_metadata ::Google::Cloud::Metastore::V1alpha::ExportMetadataRequest.new(destination_gcs_folder: destination_gcs_folder, service: service, request_id: request_id, database_dump_type: database_dump_type) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_restore_service
    ...
    restore_service_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::RestoreServiceRequest, request
      assert_equal "hello world", request["service"]
    ...
    Gapic::ServiceStub.stub :new, restore_service_client_stub do
      ...
      # Use protobuf object
      client.restore_service ::Google::Cloud::Metastore::V1alpha::RestoreServiceRequest.new(service: service, backup: backup, restore_type: restore_type, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_backups
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Metastore::V1alpha::ListBackupsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_backups_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::ListBackupsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      assert_equal "hello world", request["filter"]
    ...
    Gapic::ServiceStub.stub :new, list_backups_client_stub do
      ...
      # Use protobuf object
      client.list_backups ::Google::Cloud::Metastore::V1alpha::ListBackupsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, order_by: order_by) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_backup
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Metastore::V1alpha::Backup.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_backup_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::GetBackupRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_backup_client_stub do
      ...
      # Use protobuf object
      client.get_backup ::Google::Cloud::Metastore::V1alpha::GetBackupRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_create_backup
    ...
    create_backup_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::CreateBackupRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["backup_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Metastore::V1alpha::Backup), request["backup"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_backup_client_stub do
      ...
      # Use protobuf object
      client.create_backup ::Google::Cloud::Metastore::V1alpha::CreateBackupRequest.new(parent: parent, backup_id: backup_id, backup: backup, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_backup
    ...
    delete_backup_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Metastore::V1alpha::DeleteBackupRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_backup_client_stub do
      ...
      # Use protobuf object
      client.delete_backup ::Google::Cloud::Metastore::V1alpha::DeleteBackupRequest.new(name: name, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Metastore::V1alpha::DataprocMetastore::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Metastore::V1alpha::DataprocMetastore::Operations, client.operations_client
  end
end
