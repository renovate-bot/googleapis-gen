 ...
 *
 * Generated from protobuf message <code>google.cloud.metastore.v1alpha.MetadataImport</code>
 */
class MetadataImport extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.metastore.v1alpha.MetadataImport.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    protected $metadata;
