...
class DataprocMetastoreAsyncClient:
    ...
    from_service_account_info = DataprocMetastoreClient.from_service_account_info
    from_service_account_file = DataprocMetastoreClient.from_service_account_file
