...
def test_get_service(transport: str = 'grpc', request_type=metastore.GetServiceRequest):
    ...
    assert response.tier == metastore.Service.Tier.ENTERPRISE
...
def test_create_service_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_service(
            parent='parent_value',
            service=metastore.Service(name='name_value'),
        ...
        assert args[0].service == metastore.Service(name='name_value')
...
def test_create_metadata_import_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_metadata_import(
            parent='parent_value',
            metadata_import=metastore.MetadataImport(name='name_value'),
        ...
        assert args[0].metadata_import == metastore.MetadataImport(name='name_value')
...
def test_dataproc_metastore_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.cloud.metastore_v1alpha.services.dataproc_metastore.transports.DataprocMetastoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_dataproc_metastore_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.cloud.metastore_v1alpha.services.dataproc_metastore.transports.DataprocMetastoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.DataprocMetastoreTransport()
        adc.assert_called_once()
