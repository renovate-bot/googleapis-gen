...
Gem::Specification.new do |gem|
  ...
  gem.description   = "google-cloud-metastore-v1 is the official client library for the Google Cloud Metastore V1 API. Note that google-cloud-metastore-v1 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-metastore instead. See the readme for more details."
  gem.summary       = "API Client library for the Google Cloud Metastore V1 API"
