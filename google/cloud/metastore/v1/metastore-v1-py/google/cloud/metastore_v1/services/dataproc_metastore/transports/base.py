...
class DataprocMetastoreTransport(abc.ABC):
    ...
    def list_services(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[metastore.ListServicesResponse]
            ]]:
        raise NotImplementedError()
    ...
    def get_service(self) -> typing.Callable[
            ...
            typing.Union[
                metastore.Service,
                typing.Awaitable[metastore.Service]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def list_metadata_imports(self) -> typing.Callable[
            [metastore.ListMetadataImportsRequest],
            typing.Union[
                metastore.ListMetadataImportsResponse,
                typing.Awaitable[metastore.ListMetadataImportsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_metadata_import(self) -> typing.Callable[
            [metastore.GetMetadataImportRequest],
            typing.Union[
                metastore.MetadataImport,
                typing.Awaitable[metastore.MetadataImport]
            ]]:
        raise NotImplementedError()

    @property
    def create_metadata_import(self) -> typing.Callable[
