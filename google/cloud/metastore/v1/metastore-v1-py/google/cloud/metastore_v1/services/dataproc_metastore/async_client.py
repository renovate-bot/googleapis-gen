...
class DataprocMetastoreAsyncClient:
    ...
    parse_metadata_import_path = staticmethod(DataprocMetastoreClient.parse_metadata_import_path)
    ...
    get_transport_class = functools.partial(type(DataprocMetastoreClient).get_transport_class, type(DataprocMetastoreClient))
    ...
    async def list_metadata_imports(self,
    ...
    async def get_metadata_import(self,
    ...
    async def create_metadata_import(self,
    ...
    async def update_metadata_import(self,
