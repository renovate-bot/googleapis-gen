 ...
 *
 * Generated from protobuf message <code>google.cloud.metastore.v1beta.MetadataImport</code>
 */
class MetadataImport extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.metastore.v1beta.MetadataImport.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    protected $metadata;
     ...
     * Immutable. A database dump from a pre-existing metastore's database.
     *
     * Generated from protobuf field <code>.google.cloud.metastore.v1beta.MetadataImport.DatabaseDump database_dump = 6 [(.google.api.field_behavior) = IMMUTABLE];</code>
