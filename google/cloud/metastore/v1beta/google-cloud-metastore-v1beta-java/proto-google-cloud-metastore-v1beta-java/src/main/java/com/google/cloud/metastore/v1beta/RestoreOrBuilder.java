...
public interface RestoreOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.metastore.v1beta.Restore)
   ...
   * </pre>
   *
   * <code>.google.cloud.metastore.v1beta.Restore.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>string backup = 4 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.resource_reference) = { ... }</code>
   * @return The backup.
   */
   ...
   * </pre>
   *
   * <code>.google.cloud.metastore.v1beta.Restore.RestoreType type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
