...
public interface CreateBackupRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.metastore.v1beta.CreateBackupRequest)
   ...
   * @return The backup.
   */
  com.google.cloud.metastore.v1beta.Backup getBackup();
  /**
   * <pre>
   * Required. The backup to create. The `name` field is ignored. The ID of the created
   * backup must be provided in the request's `backup_id` field.
   ...
   * <code>.google.cloud.metastore.v1beta.Backup backup = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.metastore.v1beta.BackupOrBuilder getBackupOrBuilder();
