...
class CreateWorkloadRequest(proto.Message):
    ...
    workload = proto.Field(proto.MESSAGE, number=2,
        message='Workload',
    )
...
class UpdateWorkloadRequest(proto.Message):
    ...
    workload = proto.Field(proto.MESSAGE, number=1,
        message='Workload',
    )
...
class ListWorkloadsResponse(proto.Message):
    ...
    workloads = proto.RepeatedField(proto.MESSAGE, number=1,
        message='Workload',
    )
...
class Workload(proto.Message):
    ...
    class IL4Settings(proto.Message):
        ...
        kms_settings = proto.Field(proto.MESSAGE, number=1,
    ...
    resources = proto.RepeatedField(proto.MESSAGE, number=3,
        message=ResourceInfo,
    )

    compliance_regime = proto.Field(proto.ENUM, number=4,
    ...
    il4_settings = proto.Field(proto.MESSAGE, number=7, oneof='compliance_regime_settings',
        message=IL4Settings,
    )

    cjis_settings = proto.Field(proto.MESSAGE, number=8, oneof='compliance_regime_settings',
        message=CJISSettings,
    )

    fedramp_high_settings = proto.Field(proto.MESSAGE, number=11, oneof='compliance_regime_settings',
        message=FedrampHighSettings,
    )

    fedramp_moderate_settings = proto.Field(proto.MESSAGE, number=12, oneof='compliance_regime_settings',
