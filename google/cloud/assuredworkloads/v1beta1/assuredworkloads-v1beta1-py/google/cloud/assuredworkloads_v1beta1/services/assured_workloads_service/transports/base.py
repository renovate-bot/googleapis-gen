...
class AssuredWorkloadsServiceTransport(abc.ABC):
    ...
    @property
    def create_workload(self) -> typing.Callable[
    ...
    @property
    def update_workload(self) -> typing.Callable[
            [assuredworkloads_v1beta1.UpdateWorkloadRequest],
            typing.Union[
                assuredworkloads_v1beta1.Workload,
                typing.Awaitable[assuredworkloads_v1beta1.Workload]
            ]]:
        raise NotImplementedError()

    @property
    def delete_workload(self) -> typing.Callable[
    ...
    @property
    def get_workload(self) -> typing.Callable[
    ...
    @property
    def list_workloads(self) -> typing.Callable[
            [assuredworkloads_v1beta1.ListWorkloadsRequest],
            typing.Union[
                assuredworkloads_v1beta1.ListWorkloadsResponse,
                typing.Awaitable[assuredworkloads_v1beta1.ListWorkloadsResponse]
            ]]:
        raise NotImplementedError()
