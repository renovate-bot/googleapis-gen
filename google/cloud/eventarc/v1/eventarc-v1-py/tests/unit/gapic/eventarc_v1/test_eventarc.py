...
from google.cloud.eventarc_v1.services.eventarc.transports.base import _API_CORE_VERSION
from google.cloud.eventarc_v1.services.eventarc.transports.base import _GOOGLE_AUTH_VERSION
...
def test_eventarc_client_from_service_account_info(client_class):
...
def test_eventarc_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_list_triggers(transport: str = 'grpc', request_type=eventarc.ListTriggersRequest):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_trigger(transport: str = 'grpc', request_type=eventarc.CreateTriggerRequest):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_trigger(transport: str = 'grpc', request_type=eventarc.UpdateTriggerRequest):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_trigger(transport: str = 'grpc', request_type=eventarc.DeleteTriggerRequest):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_eventarc_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.eventarc_v1.services.eventarc.transports.EventarcTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@requires_google_auth_lt_1_25_0
def test_eventarc_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        EventarcClient()
...
@requires_google_auth_lt_1_25_0
def test_eventarc_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_eventarc_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_eventarc_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
def test_eventarc_host_no_port():
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_eventarc_host_with_port():
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
