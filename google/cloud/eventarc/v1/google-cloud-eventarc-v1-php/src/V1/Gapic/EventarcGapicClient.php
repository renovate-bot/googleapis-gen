 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/eventarc/v1/eventarc.proto
...
class EventarcGapicClient
{
    ...
    private static function getTriggerNameTemplate()
    {
        if (self::$triggerNameTemplate == null) {
            self::$triggerNameTemplate = new PathTemplate('projects/{project}/locations/{location}/triggers/{trigger}');
        }
     ...
     */
    public function createTrigger($parent, $trigger, $triggerId, $validateOnly, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateTrigger', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function deleteTrigger($name, $validateOnly, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteTrigger', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getTrigger($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetTrigger', Trigger::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listTriggers($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListTriggers', $optionalArgs, ListTriggersResponse::class, $request);
    }
    ...
    public function updateTrigger($validateOnly, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateTrigger', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
