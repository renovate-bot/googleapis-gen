...
from google.cloud.eventarc.publishing_v1.services.publisher import PublisherAsyncClient
from google.cloud.eventarc.publishing_v1.services.publisher import PublisherClient
from google.cloud.eventarc.publishing_v1.services.publisher import transports
...
def test_publisher_client_client_options_from_dict():
    with mock.patch('google.cloud.eventarc.publishing_v1.services.publisher.transports.PublisherGrpcTransport.__init__') as grpc_transport:
...
def test_publish_channel_connection_events(transport: str = 'grpc', request_type=publisher.PublishChannelConnectionEventsRequest):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_publish_channel_connection_events_from_dict():
    test_publish_channel_connection_events(request_type=dict)
...
def test_publisher_base_transport():
    ...
    with mock.patch('google.cloud.eventarc.publishing_v1.services.publisher.transports.PublisherTransport.__init__') as Transport:
...
def test_publisher_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.eventarc.publishing_v1.services.publisher.transports.PublisherTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_publisher_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.eventarc.publishing_v1.services.publisher.transports.PublisherTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PublisherTransport()
        adc.assert_called_once()
