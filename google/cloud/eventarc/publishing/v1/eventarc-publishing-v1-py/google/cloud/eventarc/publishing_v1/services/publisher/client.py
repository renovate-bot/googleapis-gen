...
class PublisherClient(metaclass=PublisherClientMeta):
    ...
    def publish_channel_connection_events(self,
        ...
        # in a publisher.PublishChannelConnectionEventsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, publisher.PublishChannelConnectionEventsRequest):
            request = publisher.PublishChannelConnectionEventsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.publish_channel_connection_events]
