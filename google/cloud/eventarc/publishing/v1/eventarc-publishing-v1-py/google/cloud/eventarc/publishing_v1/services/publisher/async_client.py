...
from google.cloud.eventarc.publishing_v1.types import publisher
...
class PublisherAsyncClient:
    ...
    common_billing_account_path = staticmethod(PublisherClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(PublisherClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(PublisherClient.parse_common_organization_path)
    ...
    parse_common_location_path = staticmethod(PublisherClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(PublisherClient).get_transport_class, type(PublisherClient))
    ...
    async def publish_channel_connection_events(self,
        ...
        Args:
            request (Union[google.cloud.eventarc.publishing_v1.types.PublishChannelConnectionEventsRequest, dict]):
        ...
        Returns:
            google.cloud.eventarc.publishing_v1.types.PublishChannelConnectionEventsResponse:
                The response message for the
                PublishChannelConnectionEvents method.

        """
        # Create or coerce a protobuf request object.
        request = publisher.PublishChannelConnectionEventsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.publish_channel_connection_events,
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("channel_connection", request.channel_connection),
            )),
        )
