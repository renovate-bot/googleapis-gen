...
class ::Google::Cloud::Resourcemanager::V3::Folders::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Resourcemanager::V3::Folders::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Resourcemanager::V3::Folders::Operations::Configuration, config
  end
end
