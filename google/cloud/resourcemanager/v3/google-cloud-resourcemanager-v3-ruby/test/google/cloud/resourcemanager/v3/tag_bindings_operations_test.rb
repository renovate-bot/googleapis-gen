...
class ::Google::Cloud::Resourcemanager::V3::TagBindings::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Resourcemanager::V3::TagBindings::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Resourcemanager::V3::TagBindings::Operations::Configuration, config
  end
end
