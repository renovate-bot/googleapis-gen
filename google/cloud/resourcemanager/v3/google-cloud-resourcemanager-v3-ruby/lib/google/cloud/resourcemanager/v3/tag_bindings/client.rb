      ...
      module V3
        module TagBindings
          ...
          class Client
            ...
            # ## Example
            #
            # To modify the configuration for all TagBindings clients:
            #
            ...
            # ## Examples
            #
            # To create a new TagBindings client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::Resourcemanager::V3::TagBindings::Client.new
            #
            # To create a new TagBindings client with a custom
            # configuration:
            #
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for list_tag_bindings
