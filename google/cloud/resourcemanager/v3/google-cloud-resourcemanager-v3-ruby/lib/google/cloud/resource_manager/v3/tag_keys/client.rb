      ...
      module V3
        module TagKeys
          ...
          class Client
            ...
            # ## Example
            #
            # To modify the configuration for all TagKeys clients:
            #
            ...
            # ## Examples
            #
            # To create a new TagKeys client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::ResourceManager::V3::TagKeys::Client.new
            #
            # To create a new TagKeys client with a custom
            # configuration:
            #
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for list_tag_keys
