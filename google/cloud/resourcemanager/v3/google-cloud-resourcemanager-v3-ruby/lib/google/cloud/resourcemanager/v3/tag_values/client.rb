      ...
      module V3
        module TagValues
          ...
          class Client
            ...
            # ## Example
            #
            # To modify the configuration for all TagValues clients:
            #
            ...
            # ## Examples
            #
            # To create a new TagValues client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::Resourcemanager::V3::TagValues::Client.new
            #
            # To create a new TagValues client with a custom
            # configuration:
            #
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for list_tag_values
