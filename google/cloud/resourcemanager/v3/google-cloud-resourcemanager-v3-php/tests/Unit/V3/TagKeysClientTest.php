...
class TagKeysClientTest extends GeneratedTest
{
    ...
    public function listTagKeysTest()
    {
        ...
        $response = $client->listTagKeys($parent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getTagKeys()[0], $resources[0]);
    ...
    public function getTagKeyTest()
    {
        ...
        // Mock request
        $formattedName = $client->tagKeyName('[TAG_KEY]');

        $response = $client->getTagKey($formattedName);
    ...
    public function getTagKeyExceptionTest()
    {
        ...
        try {
            $client->getTagKey($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function createTagKeyTest()
    {
        ...
        $incompleteOperation->setName('operations/createTagKeyTest');
        ...
        $completeOperation->setName('operations/createTagKeyTest');
        ...
        $response = $client->createTagKey($tagKey);
    ...
    public function updateTagKeyTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateTagKeyTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $parent = 'parent-995424086';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateTagKeyTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        ...
        $response = $client->updateTagKey($tagKey);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function deleteTagKeyTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteTagKeyTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name2 = 'name2-1052831874';
        $parent = 'parent-995424086';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteTagKeyTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        ...
        $response = $client->deleteTagKey($formattedName);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function getIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.resourcemanager.v3.TagKeys/GetIamPolicy', $actualFuncCall);
    ...
    public function setIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.resourcemanager.v3.TagKeys/SetIamPolicy', $actualFuncCall);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.resourcemanager.v3.TagKeys/TestIamPermissions', $actualFuncCall);
