 ...
 * @group gapic
 */
class TagValuesClientTest extends GeneratedTest
{
    /**
    ...
    private function createClient(array $options = [])
    {
        ...
        return new TagValuesClient($options);
    }

    /**
     * @test
     */
    public function listTagValuesTest()
    {
        ...
        $response = $client->listTagValues($parent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getTagValues()[0], $resources[0]);
     ...
     * @test
     */
    public function listTagValuesExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
     ...
     * @test
     */
    public function getTagValueTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
        ...
        // Mock request
        $formattedName = $client->tagValueName('[TAG_VALUE]');

        $response = $client->getTagValue($formattedName);
     ...
     * @test
     */
    public function getTagValueExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
        ...
        try {
            $client->getTagValue($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
     ...
     * @test
     */
    public function createTagValueTest()
    {
        ...
        $incompleteOperation->setName('operations/createTagValueTest');
        ...
        $completeOperation->setName('operations/createTagValueTest');
        ...
        $response = $client->createTagValue($tagValue);
     ...
     * @test
     */
    public function createTagValueExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
     ...
     * @test
     */
    public function updateTagValueTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateTagValueTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $parent = 'parent-995424086';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateTagValueTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        ...
        $response = $client->updateTagValue($tagValue);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
     ...
     * @test
     */
    public function updateTagValueExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
     ...
     * @test
     */
    public function deleteTagValueTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteTagValueTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name2 = 'name2-1052831874';
        $parent = 'parent-995424086';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteTagValueTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        ...
        $response = $client->deleteTagValue($formattedName);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
     ...
     * @test
     */
    public function deleteTagValueExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
    ...
    public function getIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.resourcemanager.v3.TagValues/GetIamPolicy', $actualFuncCall);
    ...
    public function setIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.resourcemanager.v3.TagValues/SetIamPolicy', $actualFuncCall);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.resourcemanager.v3.TagValues/TestIamPermissions', $actualFuncCall);
