...
from google.cloud.resourcemanager_v3.services.projects.transports.base import _API_CORE_VERSION
from google.cloud.resourcemanager_v3.services.projects.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert ProjectsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ProjectsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ProjectsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
@mock.patch.object(ProjectsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ProjectsClient))
@mock.patch.object(ProjectsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ProjectsAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (ProjectsAsyncClient, transports.ProjectsGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ProjectsClient, transports.ProjectsGrpcTransport, "grpc", "false"),
    (ProjectsAsyncClient, transports.ProjectsGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(ProjectsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ProjectsClient))
@mock.patch.object(ProjectsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ProjectsAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_projects_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_projects_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_projects_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_get_project(transport: str = 'grpc', request_type=projects.GetProjectRequest):
    ...
    with mock.patch.object(
            type(client.transport.get_project),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_get_project_async(transport: str = 'grpc_asyncio', request_type=projects.GetProjectRequest):
...
def test_list_projects(transport: str = 'grpc', request_type=projects.ListProjectsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_projects),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_projects_async(transport: str = 'grpc_asyncio', request_type=projects.ListProjectsRequest):
    client = ProjectsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(projects.ListProjectsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_search_projects(transport: str = 'grpc', request_type=projects.SearchProjectsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_projects),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_search_projects_async(transport: str = 'grpc_asyncio', request_type=projects.SearchProjectsRequest):
    client = ProjectsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(projects.SearchProjectsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_create_project(transport: str = 'grpc', request_type=projects.CreateProjectRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_project),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_project_async(transport: str = 'grpc_asyncio', request_type=projects.CreateProjectRequest):
    client = ProjectsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_project(transport: str = 'grpc', request_type=projects.UpdateProjectRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_project),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_project_async(transport: str = 'grpc_asyncio', request_type=projects.UpdateProjectRequest):
    client = ProjectsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_project(transport: str = 'grpc', request_type=projects.MoveProjectRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.move_project),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_move_project_async(transport: str = 'grpc_asyncio', request_type=projects.MoveProjectRequest):
    client = ProjectsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_project(transport: str = 'grpc', request_type=projects.DeleteProjectRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_project),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_project_async(transport: str = 'grpc_asyncio', request_type=projects.DeleteProjectRequest):
    client = ProjectsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_undelete_project(transport: str = 'grpc', request_type=projects.UndeleteProjectRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.undelete_project),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_undelete_project_async(transport: str = 'grpc_asyncio', request_type=projects.UndeleteProjectRequest):
    client = ProjectsAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_projects_base_transport():
    ...
    with mock.patch('google.cloud.resourcemanager_v3.services.projects.transports.ProjectsTransport.__init__') as Transport:
...
def test_projects_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.resourcemanager_v3.services.projects.transports.ProjectsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_projects_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.resourcemanager_v3.services.projects.transports.ProjectsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ProjectsTransport()
        adc.assert_called_once()
...
def test_projects_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_projects_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@pytest.mark.parametrize("transport_class", [transports.ProjectsGrpcTransport, transports.ProjectsGrpcAsyncIOTransport])
def test_projects_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.ProjectsGrpcTransport, transports.ProjectsGrpcAsyncIOTransport])
def test_projects_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ProjectsGrpcTransport, transports.ProjectsGrpcAsyncIOTransport])
def test_projects_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
