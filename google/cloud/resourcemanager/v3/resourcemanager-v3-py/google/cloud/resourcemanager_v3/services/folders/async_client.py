...
class FoldersAsyncClient:
    ...
    get_transport_class = functools.partial(type(FoldersClient).get_transport_class, type(FoldersClient))
    ...
    def __init__(self, *,
        ...
        """Instantiate the folders client.
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def undelete_folder(self,
