...
class TagKeysTransport(abc.ABC):
    ...
    @property
    def list_tag_keys(self) -> typing.Callable[
            [tag_keys.ListTagKeysRequest],
            typing.Union[
                tag_keys.ListTagKeysResponse,
                typing.Awaitable[tag_keys.ListTagKeysResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_tag_key(self) -> typing.Callable[
            [tag_keys.GetTagKeyRequest],
            typing.Union[
                tag_keys.TagKey,
                typing.Awaitable[tag_keys.TagKey]
            ]]:
        raise NotImplementedError()

    @property
    def create_tag_key(self) -> typing.Callable[
    ...
    @property
    def update_tag_key(self) -> typing.Callable[
    ...
    @property
    def delete_tag_key(self) -> typing.Callable[
