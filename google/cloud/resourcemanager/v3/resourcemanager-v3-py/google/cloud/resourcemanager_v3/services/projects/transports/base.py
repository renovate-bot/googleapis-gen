...
class ProjectsTransport(abc.ABC):
    ...
    @property
    def get_project(self) -> typing.Callable[
            [projects.GetProjectRequest],
            typing.Union[
                projects.Project,
                typing.Awaitable[projects.Project]
            ]]:
        raise NotImplementedError()

    @property
    def list_projects(self) -> typing.Callable[
            [projects.ListProjectsRequest],
            typing.Union[
                projects.ListProjectsResponse,
                typing.Awaitable[projects.ListProjectsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def search_projects(self) -> typing.Callable[
            [projects.SearchProjectsRequest],
            typing.Union[
                projects.SearchProjectsResponse,
                typing.Awaitable[projects.SearchProjectsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def create_project(self) -> typing.Callable[
    ...
    @property
    def update_project(self) -> typing.Callable[
    ...
    @property
    def move_project(self) -> typing.Callable[
    ...
    @property
    def delete_project(self) -> typing.Callable[
    ...
    @property
    def undelete_project(self) -> typing.Callable[
