...
class TagBindingsTransport(abc.ABC):
    ...
    @property
    def list_tag_bindings(self) -> typing.Callable[
            [tag_bindings.ListTagBindingsRequest],
            typing.Union[
                tag_bindings.ListTagBindingsResponse,
                typing.Awaitable[tag_bindings.ListTagBindingsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def create_tag_binding(self) -> typing.Callable[
    ...
    @property
    def delete_tag_binding(self) -> typing.Callable[
