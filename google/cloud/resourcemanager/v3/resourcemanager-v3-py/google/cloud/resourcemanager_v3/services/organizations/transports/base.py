...
class OrganizationsTransport(abc.ABC):
    ...
    @property
    def get_organization(self) -> typing.Callable[
            [organizations.GetOrganizationRequest],
            typing.Union[
                organizations.Organization,
                typing.Awaitable[organizations.Organization]
            ]]:
        raise NotImplementedError()

    @property
    def search_organizations(self) -> typing.Callable[
            [organizations.SearchOrganizationsRequest],
            typing.Union[
                organizations.SearchOrganizationsResponse,
                typing.Awaitable[organizations.SearchOrganizationsResponse]
            ]]:
        raise NotImplementedError()
