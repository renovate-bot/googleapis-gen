...
class TagValuesTransport(abc.ABC):
    ...
    @property
    def list_tag_values(self) -> typing.Callable[
            [tag_values.ListTagValuesRequest],
            typing.Union[
                tag_values.ListTagValuesResponse,
                typing.Awaitable[tag_values.ListTagValuesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_tag_value(self) -> typing.Callable[
            [tag_values.GetTagValueRequest],
            typing.Union[
                tag_values.TagValue,
                typing.Awaitable[tag_values.TagValue]
            ]]:
        raise NotImplementedError()

    @property
    def create_tag_value(self) -> typing.Callable[
    ...
    @property
    def update_tag_value(self) -> typing.Callable[
    ...
    @property
    def delete_tag_value(self) -> typing.Callable[
