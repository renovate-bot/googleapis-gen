...
class TagBindingsClient(metaclass=TagBindingsClientMeta):
    ...
    @staticmethod
    def tag_binding_path(tag_binding: str,) -> str:
        """Return a fully-qualified tag_binding string."""
        return "tagBindings/{tag_binding}".format(tag_binding=tag_binding, )

    @staticmethod
    def parse_tag_binding_path(path: str) -> Dict[str,str]:
        """Parse a tag_binding path into its component segments."""
    ...
    def __init__(self, *,
        ...
        """Instantiate the tag bindings client.
