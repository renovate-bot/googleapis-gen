...
describe('v3.OrganizationsClient', () => {
    it('has servicePath', () => {
        const servicePath = organizationsModule.v3.OrganizationsClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = organizationsModule.v3.OrganizationsClient.apiEndpoint;
        assert(apiEndpoint);
    });
    ...
    describe('getOrganization', () => {
        it('invokes getOrganization without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.Organization());
        ...
        it('invokes getOrganization without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getOrganization(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.resourcemanager.v3.IOrganization|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('searchOrganizations', () => {
        it('invokes searchOrganizations without error', async () => {
            ...
            client.innerApiCalls.searchOrganizations = stubSimpleCall(expectedResponse);
            const [response] = await client.searchOrganizations(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchOrganizations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes searchOrganizations without error using callback', async () => {
            ...
            client.innerApiCalls.searchOrganizations = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes searchOrganizationsStream without error', async () => {
            ...
            client.descriptors.page.searchOrganizations.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.searchOrganizationsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.resourcemanager.v3.Organization[] = [];
                stream.on('data', (response: protos.google.cloud.resourcemanager.v3.Organization) => {
            ...
            assert((client.descriptors.page.searchOrganizations.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchOrganizations, request));
        });
        ...
        it('invokes searchOrganizationsStream with error', async () => {
            ...
            const request = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.SearchOrganizationsRequest());
            const expectedError = new Error('expected');
            client.descriptors.page.searchOrganizations.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchOrganizationsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.resourcemanager.v3.Organization[] = [];
                stream.on('data', (response: protos.google.cloud.resourcemanager.v3.Organization) => {
        ...
        it('uses async iteration with searchOrganizations without error', async () => {
            ...
            client.descriptors.page.searchOrganizations.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with searchOrganizations with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.SearchOrganizationsRequest());const expectedError = new Error('expected');
            client.descriptors.page.searchOrganizations.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchOrganizationsAsync(request);
