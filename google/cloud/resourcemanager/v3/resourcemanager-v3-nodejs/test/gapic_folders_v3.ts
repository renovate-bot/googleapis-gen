...
describe('v3.FoldersClient', () => {
    ...
    describe('getFolder', () => {
        it('invokes getFolder without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.Folder());
            client.innerApiCalls.getFolder = stubSimpleCall(expectedResponse);
            const [response] = await client.getFolder(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getFolder as SinonStub)
        ...
        it('invokes getFolder without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFolder(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.resourcemanager.v3.IFolder|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createFolder', () => {
        it('invokes createFolder without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createFolder without error using callback', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.createFolder = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createFolder(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.resourcemanager.v3.IFolder, protos.google.cloud.resourcemanager.v3.ICreateFolderMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.resourcemanager.v3.IFolder, protos.google.cloud.resourcemanager.v3.ICreateFolderMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes createFolder with call error', async () => {
            ...
            const expectedOptions = {};
            const expectedError = new Error('expected');
            client.innerApiCalls.createFolder = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createFolder with LRO error', async () => {
            ...
            const expectedOptions = {};
            const expectedError = new Error('expected');
            client.innerApiCalls.createFolder = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createFolder(request);
        ...
        it('invokes checkCreateFolderProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateFolderProgress(expectedResponse.name);
    ...
    describe('updateFolder', () => {
        it('invokes updateFolder without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateFolder without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.updateFolder = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateFolder(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.resourcemanager.v3.IFolder, protos.google.cloud.resourcemanager.v3.IUpdateFolderMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.resourcemanager.v3.IFolder, protos.google.cloud.resourcemanager.v3.IUpdateFolderMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes updateFolder with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFolder = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateFolder with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.updateFolder = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateFolder(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.updateFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkUpdateFolderProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateFolderProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('moveFolder', () => {
        it('invokes moveFolder without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.moveFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes moveFolder without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.moveFolder(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.resourcemanager.v3.IFolder, protos.google.cloud.resourcemanager.v3.IMoveFolderMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.resourcemanager.v3.IFolder, protos.google.cloud.resourcemanager.v3.IMoveFolderMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.moveFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('deleteFolder', () => {
        it('invokes deleteFolder without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteFolder without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.deleteFolder = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteFolder(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.resourcemanager.v3.IFolder, protos.google.cloud.resourcemanager.v3.IDeleteFolderMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.resourcemanager.v3.IFolder, protos.google.cloud.resourcemanager.v3.IDeleteFolderMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes deleteFolder with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFolder = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteFolder with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteFolder = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteFolder(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.deleteFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkDeleteFolderProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteFolderProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('undeleteFolder', () => {
        it('invokes undeleteFolder without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.undeleteFolder = stubLongRunningCall(expectedResponse);
            const [operation] = await client.undeleteFolder(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.undeleteFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes undeleteFolder without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.undeleteFolder = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.undeleteFolder(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.resourcemanager.v3.IFolder, protos.google.cloud.resourcemanager.v3.IUndeleteFolderMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.resourcemanager.v3.IFolder, protos.google.cloud.resourcemanager.v3.IUndeleteFolderMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.undeleteFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
        ...
        it('invokes undeleteFolder with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.undeleteFolder = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes undeleteFolder with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.undeleteFolder = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.undeleteFolder(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.undeleteFolder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkUndeleteFolderProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUndeleteFolderProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUndeleteFolderProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUndeleteFolderProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listFolders', () => {
        it('invokes listFolders without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listFolders as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listFoldersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.resourcemanager.v3.Folder) => {
        ...
        it('uses async iteration with listFolders with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.ListFoldersRequest());const expectedError = new Error('expected');
    ...
    describe('searchFolders', () => {
        it('invokes searchFolders without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchFolders as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes searchFolders without error using callback', async () => {
            ...
            client.innerApiCalls.searchFolders = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes searchFolders with error', async () => {
            ...
            const expectedOptions = {};
            const expectedError = new Error('expected');
            client.innerApiCalls.searchFolders = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes searchFoldersStream without error', async () => {
            ...
            client.descriptors.page.searchFolders.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchFolders.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchFolders, request));
        });
        ...
        it('invokes searchFoldersStream with error', async () => {
            ...
            const request = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.SearchFoldersRequest());
            const expectedError = new Error('expected');
            client.descriptors.page.searchFolders.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchFoldersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.resourcemanager.v3.Folder[] = [];
                stream.on('data', (response: protos.google.cloud.resourcemanager.v3.Folder) => {
        ...
        it('uses async iteration with searchFolders without error', async () => {
            ...
            client.descriptors.page.searchFolders.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.resourcemanager.v3.IFolder[] = [];
        ...
        it('uses async iteration with searchFolders with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.SearchFoldersRequest());const expectedError = new Error('expected');
            client.descriptors.page.searchFolders.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchFoldersAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.resourcemanager.v3.IFolder[] = [];
                for await (const resource of iterable) {
