...
describe('v3.ProjectsClient', () => {
    ...
    describe('getProject', () => {
        it('invokes getProject without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.Project());
    ...
    describe('moveProject', () => {
        it('invokes moveProject without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.moveProject as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('undeleteProject', () => {
        it('invokes undeleteProject without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.undeleteProject as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listProjects', () => {
        ...
        it('uses async iteration with listProjects with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.ListProjectsRequest());const expectedError = new Error('expected');
    ...
    describe('searchProjects', () => {
        it('invokes searchProjects without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchProjects as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('uses async iteration with searchProjects with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.SearchProjectsRequest());const expectedError = new Error('expected');
