...
describe('v3.TagKeysClient', () => {
    ...
    describe('getTagKey', () => {
        it('invokes getTagKey without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.TagKey());
            client.innerApiCalls.getTagKey = stubSimpleCall(expectedResponse);
            const [response] = await client.getTagKey(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getTagKey as SinonStub)
    ...
    describe('createTagKey', () => {
        it('invokes createTagKey without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createTagKey as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateTagKey', () => {
        it('invokes updateTagKey without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateTagKey as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteTagKey', () => {
        it('invokes deleteTagKey without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteTagKey as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listTagKeys', () => {
        it('invokes listTagKeys without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listTagKeys as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('uses async iteration with listTagKeys with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.resourcemanager.v3.ListTagKeysRequest());const expectedError = new Error('expected');
