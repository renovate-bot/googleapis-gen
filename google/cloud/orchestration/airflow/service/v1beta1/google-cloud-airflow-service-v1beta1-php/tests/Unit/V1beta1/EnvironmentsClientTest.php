...
use Google\Cloud\Orchestration\Airflow\Service\V1beta1\CheckUpgradeResponse;
use Google\Cloud\Orchestration\Airflow\Service\V1beta1\Environment;

use Google\Cloud\Orchestration\Airflow\Service\V1beta1\EnvironmentsClient;
...
class EnvironmentsClientTest extends GeneratedTest
{
    ...
    public function checkUpgradeTest()
    {
        ...
        $this->assertSame('/google.cloud.orchestration.airflow.service.v1beta1.Environments/CheckUpgrade', $actualApiFuncCall);
    ...
    public function createEnvironmentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.orchestration.airflow.service.v1beta1.Environments/CreateEnvironment', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function deleteEnvironmentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.orchestration.airflow.service.v1beta1.Environments/DeleteEnvironment', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getEnvironmentTest()
    {
        ...
        $this->assertSame('/google.cloud.orchestration.airflow.service.v1beta1.Environments/GetEnvironment', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listEnvironmentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.orchestration.airflow.service.v1beta1.Environments/ListEnvironments', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
     ...
     * @test
     */
    public function restartWebServerTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/restartWebServerTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name2 = 'name2-1052831874';
        $uuid = 'uuid3601339';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/restartWebServerTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $client->restartWebServer();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.orchestration.airflow.service.v1beta1.Environments/RestartWebServer', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/restartWebServerTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
     ...
     * @test
     */
    public function restartWebServerExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
    ...
    public function updateEnvironmentTest()
    {
        ...
        $response = $client->updateEnvironment($updateMask);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.orchestration.airflow.service.v1beta1.Environments/UpdateEnvironment', $actualApiFuncCall);
