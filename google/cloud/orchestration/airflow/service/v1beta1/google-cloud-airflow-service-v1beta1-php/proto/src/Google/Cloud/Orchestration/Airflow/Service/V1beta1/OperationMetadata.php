 ...
 *
 * Generated from protobuf message <code>google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.State state = 1;</code>
     */
    protected $state = 0;
    /**
     * Output only. The type of operation being performed.
     *
     * Generated from protobuf field <code>.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata.Type operation_type = 2;</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Orchestration\Airflow\Service\V1Beta1\Operations::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Orchestration\Airflow\Service\V1beta1\OperationMetadata\State::class);
        $this->state = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Orchestration\Airflow\Service\V1beta1\OperationMetadata\Type::class);
