 ...
 *
 * Generated from protobuf message <code>google.cloud.orchestration.airflow.service.v1beta1.NodeConfig</code>
 */
class NodeConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string location = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $location = '';
    /**
     ...
     *
     * Generated from protobuf field <code>int32 disk_size_gb = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated string oauth_scopes = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.orchestration.airflow.service.v1beta1.IPAllocationPolicy ip_allocation_policy = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * Cannot be updated.
     *
     * Generated from protobuf field <code>int32 max_pods_per_node = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           the list must comply with [RFC1035](https://www.ietf.org/rfc/rfc1035.txt).
     *           Cannot be updated.
     *     @type \Google\Cloud\Orchestration\Airflow\Service\V1beta1\IPAllocationPolicy $ip_allocation_policy
     *           Optional. The IPAllocationPolicy fields for the GKE cluster.
     *     @type int $max_pods_per_node
     *           Optional. The maximum number of pods per node in the Cloud Composer GKE cluster.
     *           The value must be between 8 and 110 and it can be set only if
     *           the environment is VPC-native.
     *           The default value is 32. Values of this field will be propagated both to
     ...
     *
     * Generated from protobuf field <code>.google.cloud.orchestration.airflow.service.v1beta1.IPAllocationPolicy ip_allocation_policy = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\Orchestration\Airflow\Service\V1beta1\IPAllocationPolicy|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.orchestration.airflow.service.v1beta1.IPAllocationPolicy ip_allocation_policy = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Orchestration\Airflow\Service\V1beta1\IPAllocationPolicy $var
     * @return $this
     */
    public function setIpAllocationPolicy($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Orchestration\Airflow\Service\V1beta1\IPAllocationPolicy::class);
