...
namespace Google\Cloud\Orchestration\Airflow\Service\V1beta1\Environment;
 ...
 *
 * Protobuf type <code>google.cloud.orchestration.airflow.service.v1beta1.Environment.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Orchestration\Airflow\Service\V1beta1\Environment_State::class);
