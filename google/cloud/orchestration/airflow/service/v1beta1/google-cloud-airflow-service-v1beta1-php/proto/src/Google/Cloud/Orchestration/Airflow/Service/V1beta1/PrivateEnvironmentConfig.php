 ...
 * environment.
 *
 * Generated from protobuf message <code>google.cloud.orchestration.airflow.service.v1beta1.PrivateEnvironmentConfig</code>
 */
class PrivateEnvironmentConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.orchestration.airflow.service.v1beta1.PrivateClusterConfig private_cluster_config = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           If this field is set to true, `IPAllocationPolicy.use_ip_aliases` must be
     *           set to true .
     *     @type \Google\Cloud\Orchestration\Airflow\Service\V1beta1\PrivateClusterConfig $private_cluster_config
     *           Optional. Configuration for the private GKE cluster for a Private IP
     *           Cloud Composer environment.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.orchestration.airflow.service.v1beta1.PrivateClusterConfig private_cluster_config = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\Orchestration\Airflow\Service\V1beta1\PrivateClusterConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.orchestration.airflow.service.v1beta1.PrivateClusterConfig private_cluster_config = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Orchestration\Airflow\Service\V1beta1\PrivateClusterConfig $var
     * @return $this
     */
    public function setPrivateClusterConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Orchestration\Airflow\Service\V1beta1\PrivateClusterConfig::class);
