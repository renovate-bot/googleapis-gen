 ...
 *
 * Generated from protobuf message <code>google.cloud.orchestration.airflow.service.v1beta1.SoftwareConfig</code>
 */
class SoftwareConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>map<string, string> airflow_config_overrides = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * the value.
     *
     * Generated from protobuf field <code>map<string, string> pypi_packages = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * * `SQL_USER`
     *
     * Generated from protobuf field <code>map<string, string> env_variables = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * updated.
     *
     * Generated from protobuf field <code>string python_version = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
