...
export class EnvironmentsClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    const createEnvironmentResponse = protoFilesRoot.lookup(
      '.google.cloud.orchestration.airflow.service.v1beta1.Environment') as gax.protobuf.Type;
    const createEnvironmentMetadata = protoFilesRoot.lookup(
      '.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata') as gax.protobuf.Type;
    ...
    const checkUpgradeResponse = protoFilesRoot.lookup(
      '.google.cloud.orchestration.airflow.service.v1beta1.CheckUpgradeResponse') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.orchestration.airflow.service.v1beta1.Environments', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.environmentsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.orchestration.airflow.service.v1beta1.Environments') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.orchestration.airflow.service.v1beta1.Environments,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const environmentsStubMethods =
        ['createEnvironment', 'getEnvironment', 'listEnvironments', 'updateEnvironment', 'deleteEnvironment', 'restartWebServer', 'checkUpgrade'];
  ...
  getEnvironment(
      ...
      Promise<[
        ...
        protos.google.cloud.orchestration.airflow.service.v1beta1.IGetEnvironmentRequest|undefined, {}|undefined
      ]>;
  getEnvironment(
      request: protos.google.cloud.orchestration.airflow.service.v1beta1.IGetEnvironmentRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Environment]{@link google.cloud.orchestration.airflow.service.v1beta1.Environment} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [Environment]{@link google.cloud.orchestration.airflow.service.v1beta1.Environment}. The API will be called under the hood as needed, once per the page,
