...
namespace Google.Cloud.Orchestration.Airflow.Service.V1Beta1
{
    ...
    public sealed partial class EnvironmentsSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private EnvironmentsSettings(EnvironmentsSettings existing) : base(existing)
        {
            ...
            RestartWebServerSettings = existing.RestartWebServerSettings;
            RestartWebServerOperationsSettings = existing.RestartWebServerOperationsSettings.Clone();
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>EnvironmentsClient.RestartWebServer</c> and <c>EnvironmentsClient.RestartWebServerAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings RestartWebServerSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.None);

        /// <summary>
        /// Long Running Operation settings for calls to <c>EnvironmentsClient.RestartWebServer</c> and
        /// <c>EnvironmentsClient.RestartWebServerAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
        ...
        /// </list>
        /// </remarks>
        public lro::OperationsSettings RestartWebServerOperationsSettings { get; set; } = new lro::OperationsSettings
        {
            DefaultPollSettings = new gax::PollSettings(gax::Expiration.FromTimeout(sys::TimeSpan.FromHours(24)), sys::TimeSpan.FromSeconds(20), 1.5, sys::TimeSpan.FromSeconds(45)),
        };
    ...
    public abstract partial class EnvironmentsClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Environment, OperationMetadata> RestartWebServer(RestartWebServerRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Environment, OperationMetadata>> RestartWebServerAsync(RestartWebServerRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Environment, OperationMetadata>> RestartWebServerAsync(RestartWebServerRequest request, st::CancellationToken cancellationToken) =>
            RestartWebServerAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));

        /// <summary>The long-running operations client for <c>RestartWebServer</c>.</summary>
        public virtual lro::OperationsClient RestartWebServerOperationsClient => throw new sys::NotImplementedException();

        /// <summary>
        /// Poll an operation once, using an <c>operationName</c> from a previous invocation of <c>RestartWebServer</c>.
        /// </summary>
        /// <param name="operationName">
        /// The name of a previously invoked operation. Must not be <c>null</c> or empty.
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The result of polling the operation.</returns>
        public virtual lro::Operation<Environment, OperationMetadata> PollOnceRestartWebServer(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<Environment, OperationMetadata>.PollOnceFromName(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), RestartWebServerOperationsClient, callSettings);

        /// <summary>
        /// Asynchronously poll an operation once, using an <c>operationName</c> from a previous invocation of
        /// <c>RestartWebServer</c>.
        /// </summary>
        /// <param name="operationName">
        /// The name of a previously invoked operation. Must not be <c>null</c> or empty.
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A task representing the result of polling the operation.</returns>
        public virtual stt::Task<lro::Operation<Environment, OperationMetadata>> PollOnceRestartWebServerAsync(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<Environment, OperationMetadata>.PollOnceFromNameAsync(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), RestartWebServerOperationsClient, callSettings);
    ...
    public sealed partial class EnvironmentsClientImpl : EnvironmentsClient
    {
        ...
        private readonly gaxgrpc::ApiCall<RestartWebServerRequest, lro::Operation> _callRestartWebServer;
        ...
        public EnvironmentsClientImpl(Environments.EnvironmentsClient grpcClient, EnvironmentsSettings settings)
        {
            ...
            RestartWebServerOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.RestartWebServerOperationsSettings);
            CheckUpgradeOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.CheckUpgradeOperationsSettings);
            ...
            _callRestartWebServer = clientHelper.BuildApiCall<RestartWebServerRequest, lro::Operation>(grpcClient.RestartWebServerAsync, grpcClient.RestartWebServer, effectiveSettings.RestartWebServerSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callRestartWebServer);
            Modify_RestartWebServerApiCall(ref _callRestartWebServer);
            _callCheckUpgrade = clientHelper.BuildApiCall<CheckUpgradeRequest, lro::Operation>(grpcClient.CheckUpgradeAsync, grpcClient.CheckUpgrade, effectiveSettings.CheckUpgradeSettings).WithGoogleRequestParam("environment", request => request.Environment);
        ...
        partial void Modify_RestartWebServerApiCall(ref gaxgrpc::ApiCall<RestartWebServerRequest, lro::Operation> call);
        ...
        partial void Modify_RestartWebServerRequest(ref RestartWebServerRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <summary>The long-running operations client for <c>RestartWebServer</c>.</summary>
        public override lro::OperationsClient RestartWebServerOperationsClient { get; }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<Environment, OperationMetadata> RestartWebServer(RestartWebServerRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_RestartWebServerRequest(ref request, ref callSettings);
            return new lro::Operation<Environment, OperationMetadata>(_callRestartWebServer.Sync(request, callSettings), RestartWebServerOperationsClient);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<Environment, OperationMetadata>> RestartWebServerAsync(RestartWebServerRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_RestartWebServerRequest(ref request, ref callSettings);
            return new lro::Operation<Environment, OperationMetadata>(await _callRestartWebServer.Async(request, callSettings).ConfigureAwait(false), RestartWebServerOperationsClient);
        }
