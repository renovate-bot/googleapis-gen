...
namespace Google.Cloud.Orchestration.Airflow.Service.V1Beta1.Snippets
{
    ...
    {
        /// <summary>Snippet for RestartWebServerAsync</summary>
        /// <remarks>
        /// This snippet has been automatically generated for illustrative purposes only.
        /// It may require modifications to work in your environment.
        /// </remarks>
        public async Task RestartWebServerRequestObjectAsync()
        {
            // Create client
            EnvironmentsClient environmentsClient = await EnvironmentsClient.CreateAsync();
            // Initialize request argument(s)
            RestartWebServerRequest request = new RestartWebServerRequest { Name = "", };
            // Make the request
            Operation<Environment, OperationMetadata> response = await environmentsClient.RestartWebServerAsync(request);
            ...
            Operation<Environment, OperationMetadata> retrievedResponse = await environmentsClient.PollOnceRestartWebServerAsync(operationName);
