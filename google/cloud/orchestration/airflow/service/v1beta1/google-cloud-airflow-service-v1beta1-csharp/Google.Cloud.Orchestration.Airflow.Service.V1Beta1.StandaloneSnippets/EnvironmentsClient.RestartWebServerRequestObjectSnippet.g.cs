...
namespace Google.Cloud.Orchestration.Airflow.Service.V1Beta1.Snippets
{
    ...
    {
        /// <summary>Snippet for RestartWebServer</summary>
        /// <remarks>
        /// This snippet has been automatically generated for illustrative purposes only.
        /// It may require modifications to work in your environment.
        /// </remarks>
        public void RestartWebServerRequestObject()
        {
            // Create client
            ...
            // Make the request
            Operation<Environment, OperationMetadata> response = environmentsClient.RestartWebServer(request);
            ...
            Operation<Environment, OperationMetadata> retrievedResponse = environmentsClient.PollOnceRestartWebServer(operationName);
