...
type EnvironmentsCallOptions struct {
	...
	RestartWebServer  []gax.CallOption
...
type internalEnvironmentsClient interface {
	...
	RestartWebServer(context.Context, *servicepb.RestartWebServerRequest, ...gax.CallOption) (*RestartWebServerOperation, error)
	RestartWebServerOperation(name string) *RestartWebServerOperation
...
func (c *EnvironmentsClient) RestartWebServer(ctx context.Context, req *servicepb.RestartWebServerRequest, opts ...gax.CallOption) (*RestartWebServerOperation, error) {
	return c.internalClient.RestartWebServer(ctx, req, opts...)
}

// RestartWebServerOperation returns a new RestartWebServerOperation from a given name.
// The name must be that of a previously created RestartWebServerOperation, possibly from a different process.
func (c *EnvironmentsClient) RestartWebServerOperation(name string) *RestartWebServerOperation {
	return c.internalClient.RestartWebServerOperation(name)
}
...
func (c *environmentsGRPCClient) RestartWebServer(ctx context.Context, req *servicepb.RestartWebServerRequest, opts ...gax.CallOption) (*RestartWebServerOperation, error) {
	md := metadata.Pairs("x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName())))
	ctx = insertMetadata(ctx, c.xGoogMetadata, md)
	opts = append((*c.CallOptions).RestartWebServer[0:len((*c.CallOptions).RestartWebServer):len((*c.CallOptions).RestartWebServer)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.environmentsClient.RestartWebServer(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &RestartWebServerOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}
...
// RestartWebServerOperation manages a long-running operation from RestartWebServer.
type RestartWebServerOperation struct {
	lro *longrunning.Operation
}

// RestartWebServerOperation returns a new RestartWebServerOperation from a given name.
// The name must be that of a previously created RestartWebServerOperation, possibly from a different process.
func (c *environmentsGRPCClient) RestartWebServerOperation(name string) *RestartWebServerOperation {
	return &RestartWebServerOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
//
// See documentation of Poll for error-handling information.
func (op *RestartWebServerOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*servicepb.Environment, error) {
	var resp servicepb.Environment
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *RestartWebServerOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*servicepb.Environment, error) {
	var resp servicepb.Environment
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
	}
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *RestartWebServerOperation) Metadata() (*servicepb.OperationMetadata, error) {
	var meta servicepb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *RestartWebServerOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *RestartWebServerOperation) Name() string {
	return op.lro.Name()
}
