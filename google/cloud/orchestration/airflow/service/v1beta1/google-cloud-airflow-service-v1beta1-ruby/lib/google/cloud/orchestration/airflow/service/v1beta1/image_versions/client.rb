...
require "google/cloud/orchestration/airflow/service/v1beta1/image_versions_pb"
          ...
          module V1beta1
            module ImageVersions
              ...
              class Client
                ...
                #
                # See {::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ImageVersions::Client::Configuration}
                # for a description of the configuration fields.
                #
                # @example
                #
                #   # Modify the configuration for all ImageVersions clients
                #   ::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ImageVersions::Client.configure do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                #   client = ::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ImageVersions::Client.new
                #
                #   # Create a client using a custom configuration
                #   client = ::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ImageVersions::Client.new do |config|
                #     config.timeout = 10.0
                #   end
                #
                ...
                def initialize
                  ...
                  require "gapic/grpc"
                  require "google/cloud/orchestration/airflow/service/v1beta1/image_versions_services_pb"
                  ...
                  @image_versions_stub = ::Gapic::ServiceStub.new(
                    ::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ImageVersions::Stub,
                ...
                #   {::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ListImageVersionsRequest} or an equivalent Hash.
                #
                #   @param request [::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ListImageVersionsRequest, ::Hash]
                ...
                # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ImageVersion>]
                # @yieldparam operation [::GRPC::ActiveCall::Operation]
                #
                # @return [::Gapic::PagedEnumerable<::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ImageVersion>]
                #
                # @raise [::Google::Cloud::Error] if the RPC is aborted.
                #
                # @example Basic example
                #   require "google/cloud/orchestration/airflow/service/v1beta1"
                #
                #   # Create a client object. The client can be reused for multiple calls.
                #   client = Google::Cloud::Orchestration::Airflow::Service::V1beta1::ImageVersions::Client.new
                #
                #   # Create a request. To set request fields, pass in keyword arguments.
                #   request = Google::Cloud::Orchestration::Airflow::Service::V1beta1::ListImageVersionsRequest.new
                #
                ...
                #     # Each element is of type ::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ImageVersion.
                #     p response
                #   end
                #
                def list_image_versions request, options = nil
                  ...
                  request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ListImageVersionsRequest
                  ...
                  metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                    ...
                    gapic_version: ::Google::Cloud::Orchestration::Airflow::Service::V1beta1::VERSION
                ...
                # {::Google::Cloud::Orchestration::Airflow::Service::V1beta1::ImageVersions::Client::Configuration::Rpcs}
