...
class ImageVersionsAsyncClient:
    ...
    common_billing_account_path = staticmethod(ImageVersionsClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ImageVersionsClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ImageVersionsClient.common_folder_path)
    parse_common_folder_path = staticmethod(ImageVersionsClient.parse_common_folder_path)
    common_organization_path = staticmethod(ImageVersionsClient.common_organization_path)
    parse_common_organization_path = staticmethod(ImageVersionsClient.parse_common_organization_path)
    common_project_path = staticmethod(ImageVersionsClient.common_project_path)
    parse_common_project_path = staticmethod(ImageVersionsClient.parse_common_project_path)
    common_location_path = staticmethod(ImageVersionsClient.common_location_path)
    parse_common_location_path = staticmethod(ImageVersionsClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(ImageVersionsClient).get_transport_class, type(ImageVersionsClient))
    ...
    async def list_image_versions(self,
