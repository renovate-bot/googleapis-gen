...
class ::Google::Cloud::Shell::V1::CloudShellService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Shell::V1::CloudShellService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Shell::V1::CloudShellService::Operations::Configuration, config
  end
end
