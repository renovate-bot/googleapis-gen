...
class CloudShellServiceTransport(abc.ABC):
    ...
    def get_environment(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[cloudshell.Environment]
            ]]:
        raise NotImplementedError()

    @property
    def start_environment(self) -> typing.Callable[
    ...
    @property
    def authorize_environment(self) -> typing.Callable[
    ...
    @property
    def add_public_key(self) -> typing.Callable[
    ...
    @property
    def remove_public_key(self) -> typing.Callable[
