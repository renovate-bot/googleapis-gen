...
class CloudShellServiceAsyncClient:
    ...
    from_service_account_info = CloudShellServiceClient.from_service_account_info
    from_service_account_file = CloudShellServiceClient.from_service_account_file
