...
class ::Google::Cloud::Apigeeconnect::V1::ConnectionService::ClientTest < Minitest::Test
  ...
  def test_list_connections
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Apigeeconnect::V1::ListConnectionsResponse.new
    ...
    list_connections_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Apigeeconnect::V1::ListConnectionsRequest, request
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Apigeeconnect::V1::ConnectionService::Client::Configuration, config
  end
end
