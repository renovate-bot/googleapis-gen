 ...
 *   The first element of the array is Array of [Connection]{@link google.cloud.apigeeconnect.v1.Connection}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Connection]{@link google.cloud.apigeeconnect.v1.Connection} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [Connection]{@link google.cloud.apigeeconnect.v1.Connection}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listConnectionsAsync(
    ...
    return this.descriptors.page.listConnections.asyncIterate(
      ...
      callSettings
    ) as AsyncIterable<protos.google.cloud.apigeeconnect.v1.IConnection>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
