...
from google.cloud.scheduler_v1beta1.services.cloud_scheduler import CloudSchedulerAsyncClient
from google.cloud.scheduler_v1beta1.services.cloud_scheduler import CloudSchedulerClient
from google.cloud.scheduler_v1beta1.services.cloud_scheduler import pagers
from google.cloud.scheduler_v1beta1.services.cloud_scheduler import transports
from google.cloud.scheduler_v1beta1.services.cloud_scheduler.transports.base import _API_CORE_VERSION
from google.cloud.scheduler_v1beta1.services.cloud_scheduler.transports.base import _GOOGLE_AUTH_VERSION
...
def test_cloud_scheduler_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_list_jobs(transport: str = 'grpc', request_type=cloudscheduler.ListJobsRequest):
    client = CloudSchedulerClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_job(transport: str = 'grpc', request_type=cloudscheduler.CreateJobRequest):
    client = CloudSchedulerClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_job(transport: str = 'grpc', request_type=cloudscheduler.UpdateJobRequest):
    client = CloudSchedulerClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_job(transport: str = 'grpc', request_type=cloudscheduler.DeleteJobRequest):
    client = CloudSchedulerClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_pause_job(transport: str = 'grpc', request_type=cloudscheduler.PauseJobRequest):
    client = CloudSchedulerClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resume_job(transport: str = 'grpc', request_type=cloudscheduler.ResumeJobRequest):
    client = CloudSchedulerClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cloud_scheduler_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.scheduler_v1beta1.services.cloud_scheduler.transports.CloudSchedulerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cloud_scheduler_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.scheduler_v1beta1.services.cloud_scheduler.transports.CloudSchedulerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.CloudSchedulerTransport()
        adc.assert_called_once()
...
def test_cloud_scheduler_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_cloud_scheduler_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
