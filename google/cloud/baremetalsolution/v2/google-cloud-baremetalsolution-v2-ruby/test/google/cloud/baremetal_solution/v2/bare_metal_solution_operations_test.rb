...
class ::Google::Cloud::BaremetalSolution::V2::BareMetalSolution::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::BaremetalSolution::V2::BareMetalSolution::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::BaremetalSolution::V2::BareMetalSolution::Operations::Configuration, config
  end
end
