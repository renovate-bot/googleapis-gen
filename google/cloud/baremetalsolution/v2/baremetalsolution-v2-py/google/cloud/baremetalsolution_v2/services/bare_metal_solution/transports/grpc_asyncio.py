...
class BareMetalSolutionGrpcAsyncIOTransport(BareMetalSolutionTransport):
    ...
    def get_instance(self) -> Callable[
            ...
            Awaitable[baremetalsolution.Instance]]:
    ...
    def get_volume(self) -> Callable[
            ...
            Awaitable[baremetalsolution.Volume]]:
    ...
    @property
    def list_networks(self) -> Callable[
    ...
    @property
    def get_network(self) -> Callable[
            [baremetalsolution.GetNetworkRequest],
            Awaitable[baremetalsolution.Network]]:
    ...
    @property
    def list_snapshot_schedule_policies(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListSnapshotSchedulePoliciesRequest],
                    Awaitable[~.ListSnapshotSchedulePoliciesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if 'list_snapshot_schedule_policies' not in self._stubs:
            self._stubs['list_snapshot_schedule_policies'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_snapshot_schedule_policy(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetSnapshotSchedulePolicyRequest],
                    Awaitable[~.SnapshotSchedulePolicy]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    @property
    def create_snapshot_schedule_policy(self) -> Callable[
        ...
        if 'create_snapshot_schedule_policy' not in self._stubs:
            self._stubs['create_snapshot_schedule_policy'] = self.grpc_channel.unary_unary(
    ...
    @property
    def update_snapshot_schedule_policy(self) -> Callable[
        ...
        if 'update_snapshot_schedule_policy' not in self._stubs:
            self._stubs['update_snapshot_schedule_policy'] = self.grpc_channel.unary_unary(
    ...
    @property
    def delete_snapshot_schedule_policy(self) -> Callable[
        ...
        if 'delete_snapshot_schedule_policy' not in self._stubs:
            self._stubs['delete_snapshot_schedule_policy'] = self.grpc_channel.unary_unary(
    ...
    @property
    def create_volume_snapshot(self) -> Callable[
    ...
    @property
    def restore_volume_snapshot(self) -> Callable[
    ...
    @property
    def delete_volume_snapshot(self) -> Callable[
    ...
    @property
    def get_volume_snapshot(self) -> Callable[
    ...
    @property
    def list_volume_snapshots(self) -> Callable[
    ...
    @property
    def get_lun(self) -> Callable[
            [baremetalsolution.GetLunRequest],
            Awaitable[baremetalsolution.Lun]]:
