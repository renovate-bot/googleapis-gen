...
class BareMetalSolutionClient(metaclass=BareMetalSolutionClientMeta):
    ...
    def lun_path(project: str,location: str,volume: str,lun: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/volumes/{volume}/luns/{lun}".format(project=project, location=location, volume=volume, lun=lun, )

    @staticmethod
    def parse_lun_path(path: str) -> Dict[str,str]:
        """Parses a lun path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/volumes/(?P<volume>.+?)/luns/(?P<lun>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def network_path(project: str,location: str,network: str,) -> str:
        """Returns a fully-qualified network string."""
        return "projects/{project}/locations/{location}/networks/{network}".format(project=project, location=location, network=network, )

    @staticmethod
    def parse_network_path(path: str) -> Dict[str,str]:
        """Parses a network path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/networks/(?P<network>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def snapshot_schedule_policy_path(project: str,location: str,snapshot_schedule_policy: str,) -> str:
        """Returns a fully-qualified snapshot_schedule_policy string."""
        return "projects/{project}/locations/{location}/snapshotSchedulePolicies/{snapshot_schedule_policy}".format(project=project, location=location, snapshot_schedule_policy=snapshot_schedule_policy, )
    ...
    def parse_snapshot_schedule_policy_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/snapshotSchedulePolicies/(?P<snapshot_schedule_policy>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def volume_path(project: str,location: str,volume: str,) -> str:
        """Returns a fully-qualified volume string."""
        return "projects/{project}/locations/{location}/volumes/{volume}".format(project=project, location=location, volume=volume, )

    @staticmethod
    def parse_volume_path(path: str) -> Dict[str,str]:
        """Parses a volume path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/volumes/(?P<volume>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def volume_snapshot_path(project: str,location: str,volume: str,snapshot: str,) -> str:
        """Returns a fully-qualified volume_snapshot string."""
        return "projects/{project}/locations/{location}/volumes/{volume}/snapshots/{snapshot}".format(project=project, location=location, volume=volume, snapshot=snapshot, )

    @staticmethod
    def parse_volume_snapshot_path(path: str) -> Dict[str,str]:
        """Parses a volume_snapshot path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/volumes/(?P<volume>.+?)/snapshots/(?P<snapshot>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def list_instances(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.ListInstancesRequest, dict]):
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListInstancesPager:
    ...
    def get_instance(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.GetInstanceRequest, dict]):
        ...
        Returns:
            google.cloud.baremetalsolution_v2.types.Instance:
                A server.
        """
        # Create or coerce a protobuf request object.
        # Sanity check: If we got a request object, we should *not* have
    ...
    def reset_instance(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.ResetInstanceRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.baremetalsolution_v2.types.ResetInstanceResponse`
    ...
    def list_volumes(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.ListVolumesRequest, dict]):
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListVolumesPager:
    ...
    def get_volume(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.GetVolumeRequest, dict]):
        ...
        Returns:
            google.cloud.baremetalsolution_v2.types.Volume:
                A storage volume.
        """
        # Create or coerce a protobuf request object.
        # Sanity check: If we got a request object, we should *not* have
    ...
    def update_volume(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.UpdateVolumeRequest, dict]):
                The request object. Message for updating a volume.
            volume (google.cloud.baremetalsolution_v2.types.Volume):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.baremetalsolution_v2.types.Volume`
                A storage volume.
    ...
    def list_networks(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.ListNetworksRequest, dict]):
                The request object. Message for requesting a list of
                networks.
            parent (str):
                Required. Parent value for
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListNetworksPager:
                Response message containing the list
                of networks.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def get_network(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.GetNetworkRequest, dict]):
        ...
        Returns:
            google.cloud.baremetalsolution_v2.types.Network:
                A Network.
        """
        # Create or coerce a protobuf request object.
        # Sanity check: If we got a request object, we should *not* have
    ...
    def list_snapshot_schedule_policies(self,
            request: Union[baremetalsolution.ListSnapshotSchedulePoliciesRequest, dict] = None,
            *,
            parent: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.ListSnapshotSchedulePoliciesRequest, dict]):
                The request object. Message for requesting a list of
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListSnapshotSchedulePoliciesPager:
                Response message containing the list
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, baremetalsolution.ListSnapshotSchedulePoliciesRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_snapshot_schedule_policies]
    ...
    def get_snapshot_schedule_policy(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.GetSnapshotSchedulePolicyRequest, dict]):
        ...
        Returns:
            google.cloud.baremetalsolution_v2.types.SnapshotSchedulePolicy:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_snapshot_schedule_policy]
    ...
    def create_snapshot_schedule_policy(self,
            request: Union[baremetalsolution.CreateSnapshotSchedulePolicyRequest, dict] = None,
            *,
            parent: str = None,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.CreateSnapshotSchedulePolicyRequest, dict]):
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            snapshot_schedule_policy (google.cloud.baremetalsolution_v2.types.SnapshotSchedulePolicy):
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, snapshot_schedule_policy, snapshot_schedule_policy_id])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, baremetalsolution.CreateSnapshotSchedulePolicyRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_snapshot_schedule_policy]
    ...
    def update_snapshot_schedule_policy(self,
            request: Union[baremetalsolution.UpdateSnapshotSchedulePolicyRequest, dict] = None,
            *,
            snapshot_schedule_policy: baremetalsolution.SnapshotSchedulePolicy = None,
            update_mask: field_mask_pb2.FieldMask = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.UpdateSnapshotSchedulePolicyRequest, dict]):
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, baremetalsolution.UpdateSnapshotSchedulePolicyRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_snapshot_schedule_policy]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("snapshot_schedule_policy.name", request.snapshot_schedule_policy.name),
            )),
        )
    ...
    def delete_snapshot_schedule_policy(self,
            request: Union[baremetalsolution.DeleteSnapshotSchedulePolicyRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.DeleteSnapshotSchedulePolicyRequest, dict]):
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, baremetalsolution.DeleteSnapshotSchedulePolicyRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_snapshot_schedule_policy]
    ...
    def create_volume_snapshot(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.CreateVolumeSnapshotRequest, dict]):
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            volume_snapshot (google.cloud.baremetalsolution_v2.types.VolumeSnapshot):
        ...
        Returns:
            google.cloud.baremetalsolution_v2.types.VolumeSnapshot:
    ...
    def restore_volume_snapshot(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.RestoreVolumeSnapshotRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.baremetalsolution_v2.types.VolumeSnapshot`
    ...
    def delete_volume_snapshot(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.DeleteVolumeSnapshotRequest, dict]):
    ...
    def get_volume_snapshot(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.GetVolumeSnapshotRequest, dict]):
                The request object. Message for requesting storage
    ...
    def list_volume_snapshots(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.ListVolumeSnapshotsRequest, dict]):
                The request object. Message for requesting a list of
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListVolumeSnapshotsPager:
                Response message containing the list
    ...
    def get_lun(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.GetLunRequest, dict]):
        ...
        Returns:
            google.cloud.baremetalsolution_v2.types.Lun:
    ...
    def list_luns(self,
        ...
        Args:
            request (Union[google.cloud.baremetalsolution_v2.types.ListLunsRequest, dict]):
                The request object. Message for requesting a list of
                storage volume luns.
            parent (str):
                Required. Parent value for
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListLunsPager:
                Response message containing the list
