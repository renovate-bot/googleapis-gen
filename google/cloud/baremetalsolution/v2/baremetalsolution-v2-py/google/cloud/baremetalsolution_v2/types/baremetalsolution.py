...
class Volume(proto.Message):
    ...
    Attributes:
        ...
        storage_type (google.cloud.baremetalsolution_v2.types.Volume.StorageType):
            The storage type for this volume.
        state (google.cloud.baremetalsolution_v2.types.Volume.State):
        ...
        remaining_space_gib (int):
            ...
            snapshots.
        snapshot_reservation_detail (google.cloud.baremetalsolution_v2.types.Volume.SnapshotReservationDetail):
            Details about snapshot space reservation and
            usage on the storage volume.
        snapshot_auto_delete_behavior (google.cloud.baremetalsolution_v2.types.Volume.SnapshotAutoDeleteBehavior):
...
class ListVolumesResponse(proto.Message):
    ...
    Attributes:
        volumes (Sequence[google.cloud.baremetalsolution_v2.types.Volume]):
...
class Lun(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.baremetalsolution_v2.types.Lun.State):
            The state of this storage volume.
        size_gb (int):
            The size of this LUN, in gigabytes.
        multiprotocol_type (google.cloud.baremetalsolution_v2.types.Lun.MultiprotocolType):
        ...
        storage_type (google.cloud.baremetalsolution_v2.types.Lun.StorageType):
...
class Network(proto.Message):
    ...
    Attributes:
        ...
        network (str):
            Name of the network.
        type_ (google.cloud.baremetalsolution_v2.types.Network.Type):
            The type of this network.
        ip_address (str):
            IP address configured.
        mac_address (Sequence[str]):
            List of physical interfaces.
        state (google.cloud.baremetalsolution_v2.types.Network.State):
            The Network state.
        vlan_id (str):
            The vlan id of the Network.
        cidr (str):
            The cidr of the Network.
        vrf (google.cloud.baremetalsolution_v2.types.VRF):
...
class VRF(proto.Message):
    ...
    Attributes:
        name (str):
            The name of the VRF.
        state (google.cloud.baremetalsolution_v2.types.VRF.State):
            The possible state of VRF.
        qos_policy (google.cloud.baremetalsolution_v2.types.VRF.QosPolicy):
            The QOS policy applied to this VRF.
        vlan_attachments (Sequence[google.cloud.baremetalsolution_v2.types.VRF.VlanAttachment]):
...
class ListNetworksResponse(proto.Message):
    ...
    Attributes:
        networks (Sequence[google.cloud.baremetalsolution_v2.types.Network]):
...
class Instance(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.baremetalsolution_v2.types.Instance.State):
            The state of the server.
        hyperthreading_enabled (bool):
            True if you enable hyperthreading for the
            server, otherwise false. The default value is
            false.
        labels (Sequence[google.cloud.baremetalsolution_v2.types.Instance.LabelsEntry]):
            Labels as key value pairs.
        luns (Sequence[google.cloud.baremetalsolution_v2.types.Lun]):
...
class ListInstancesResponse(proto.Message):
    ...
    Attributes:
        instances (Sequence[google.cloud.baremetalsolution_v2.types.Instance]):
            The list of servers.
        next_page_token (str):
            A token identifying a page of results from
            the server.
...
class ListVolumeSnapshotsResponse(proto.Message):
    ...
    Attributes:
        volume_snapshots (Sequence[google.cloud.baremetalsolution_v2.types.VolumeSnapshot]):
            The list of storage volumes.
        next_page_token (str):
            A token identifying a page of results from
            the server.
...
class SnapshotSchedulePolicy(proto.Message):
    ...
    Attributes:
        ...
        description (str):
            ...
            policy.
        schedules (Sequence[google.cloud.baremetalsolution_v2.types.SnapshotSchedulePolicy.Schedule]):
...
class ListSnapshotSchedulePoliciesResponse(proto.Message):
    ...
    Attributes:
        snapshot_schedule_policies (Sequence[google.cloud.baremetalsolution_v2.types.SnapshotSchedulePolicy]):
