...
class BareMetalSolutionAsyncClient:
    ...
    snapshot_schedule_policy_path = staticmethod(BareMetalSolutionClient.snapshot_schedule_policy_path)
    parse_snapshot_schedule_policy_path = staticmethod(BareMetalSolutionClient.parse_snapshot_schedule_policy_path)
    ...
    async def list_instances(self,
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListInstancesAsyncPager:
    ...
    async def list_volumes(self,
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListVolumesAsyncPager:
    ...
    async def update_volume(self,
        ...
        Args:
            ...
            volume (:class:`google.cloud.baremetalsolution_v2.types.Volume`):
    ...
    async def list_networks(self,
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListNetworksAsyncPager:
                Response message containing the list
                of networks.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    async def list_snapshot_schedule_policies(self,
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListSnapshotSchedulePoliciesAsyncPager:
                Response message containing the list
    ...
    async def get_snapshot_schedule_policy(self,
    ...
    async def create_snapshot_schedule_policy(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            snapshot_schedule_policy (:class:`google.cloud.baremetalsolution_v2.types.SnapshotSchedulePolicy`):
    ...
    async def update_snapshot_schedule_policy(self,
    ...
    async def delete_snapshot_schedule_policy(self,
    ...
    async def create_volume_snapshot(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            volume_snapshot (:class:`google.cloud.baremetalsolution_v2.types.VolumeSnapshot`):
    ...
    async def list_volume_snapshots(self,
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListVolumeSnapshotsAsyncPager:
                Response message containing the list
    ...
    async def list_luns(self,
        ...
        Returns:
            google.cloud.baremetalsolution_v2.services.bare_metal_solution.pagers.ListLunsAsyncPager:
                Response message containing the list
