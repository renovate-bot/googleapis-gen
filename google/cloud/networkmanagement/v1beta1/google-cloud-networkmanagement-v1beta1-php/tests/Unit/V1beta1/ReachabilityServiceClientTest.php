...
namespace Google\Cloud\NetworkManagement\Tests\Unit\V1beta1;
...
use Google\Cloud\NetworkManagement\V1beta1\ConnectivityTest;
use Google\Cloud\NetworkManagement\V1beta1\Endpoint;

use Google\Cloud\NetworkManagement\V1beta1\ListConnectivityTestsResponse;
use Google\Cloud\NetworkManagement\V1beta1\ReachabilityServiceClient;
...
class ReachabilityServiceClientTest extends GeneratedTest
{
    ...
    public function createConnectivityTestTest()
    {
        ...
        $this->assertSame('/google.cloud.networkmanagement.v1beta1.ReachabilityService/CreateConnectivityTest', $actualApiFuncCall);
    ...
    public function deleteConnectivityTestTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkmanagement.v1beta1.ReachabilityService/DeleteConnectivityTest', $actualApiFuncCall);
    ...
    public function getConnectivityTestTest()
    {
        ...
        $this->assertSame('/google.cloud.networkmanagement.v1beta1.ReachabilityService/GetConnectivityTest', $actualFuncCall);
    ...
    public function listConnectivityTestsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkmanagement.v1beta1.ReachabilityService/ListConnectivityTests', $actualFuncCall);
    ...
    public function rerunConnectivityTestTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkmanagement.v1beta1.ReachabilityService/RerunConnectivityTest', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($name, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function updateConnectivityTestTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkmanagement.v1beta1.ReachabilityService/UpdateConnectivityTest', $actualApiFuncCall);
