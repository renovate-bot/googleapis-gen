...
namespace Google\Cloud\NetworkManagement\V1beta1\DropInfo;
 ...
 * Drop cause types:
 *
 * Protobuf type <code>google.cloud.networkmanagement.v1beta1.DropInfo.Cause</code>
 */
class Cause
{
    /**
...
class_alias(Cause::class, \Google\Cloud\NetworkManagement\V1beta1\DropInfo_Cause::class);
