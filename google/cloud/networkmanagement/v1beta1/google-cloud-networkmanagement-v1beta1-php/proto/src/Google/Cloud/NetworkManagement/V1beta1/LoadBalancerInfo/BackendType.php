 ...
 *
 * Protobuf type <code>google.cloud.networkmanagement.v1beta1.LoadBalancerInfo.BackendType</code>
 */
class BackendType
{
    /**
...
class_alias(BackendType::class, \Google\Cloud\NetworkManagement\V1beta1\LoadBalancerInfo_BackendType::class);
