...
namespace Google\Cloud\NetworkManagement\V1beta1\RouteInfo;
 ...
 * Type of route:
 *
 * Protobuf type <code>google.cloud.networkmanagement.v1beta1.RouteInfo.RouteType</code>
 */
class RouteType
{
    /**
...
class_alias(RouteType::class, \Google\Cloud\NetworkManagement\V1beta1\RouteInfo_RouteType::class);
