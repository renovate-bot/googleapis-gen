...
namespace Google\Cloud\NetworkManagement\V1beta1\ForwardInfo;
 ...
 *
 * Protobuf type <code>google.cloud.networkmanagement.v1beta1.ForwardInfo.Target</code>
 */
class Target
{
    /**
...
class_alias(Target::class, \Google\Cloud\NetworkManagement\V1beta1\ForwardInfo_Target::class);
