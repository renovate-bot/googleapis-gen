...
namespace Google\Cloud\NetworkManagement\V1beta1\Step;
 ...
 *
 * Protobuf type <code>google.cloud.networkmanagement.v1beta1.Step.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\NetworkManagement\V1beta1\Step_State::class);
