 ...
 *
 * Generated from protobuf message <code>google.cloud.networkmanagement.v1beta1.ConnectivityTest</code>
 */
class ConnectivityTest extends \Google\Protobuf\Internal\Message
{
     ...
     * intend to test.
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.Endpoint source = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * intend to test.
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.Endpoint destination = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.ReachabilityDetails reachability_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * test.
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.ProbingDetails probing_details = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           The user-supplied description of the Connectivity Test.
     *           Maximum of 512 characters.
     *     @type \Google\Cloud\NetworkManagement\V1beta1\Endpoint $source
     *           Required. Source specification of the Connectivity Test.
     *           You can use a combination of source IP address, virtual machine
     *           (VM) instance, or Compute Engine network to uniquely identify
     *           the source location.
     ...
     *           ambiguous. However, the test result may include endpoints that you don't
     *           intend to test.
     *     @type \Google\Cloud\NetworkManagement\V1beta1\Endpoint $destination
     *           Required. Destination specification of the Connectivity Test.
     *           You can use a combination of destination IP address, Compute Engine
     *           VM instance, or VPC network to uniquely identify the destination
     *           location.
     ...
     *           Output only. The time the test's configuration was updated.
     *     @type \Google\Cloud\NetworkManagement\V1beta1\ReachabilityDetails $reachability_details
     *           Output only. The reachability details of this test from the latest run.
     *           The details are updated when creating a new test, updating an
     *           existing test, or triggering a one-time rerun of an existing test.
     *     @type \Google\Cloud\NetworkManagement\V1beta1\ProbingDetails $probing_details
     *           Output only. The probing details of this test from the latest run, present for
     *           applicable tests only. The details are updated when creating a new test,
     *           updating an existing test, or triggering a one-time rerun of an existing
     *           test.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.Endpoint source = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\NetworkManagement\V1beta1\Endpoint|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.Endpoint source = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\NetworkManagement\V1beta1\Endpoint $var
     * @return $this
     */
    public function setSource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\NetworkManagement\V1beta1\Endpoint::class);
        $this->source = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.ReachabilityDetails reachability_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\NetworkManagement\V1beta1\ReachabilityDetails|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.ReachabilityDetails reachability_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\NetworkManagement\V1beta1\ReachabilityDetails $var
     * @return $this
     */
    public function setReachabilityDetails($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\NetworkManagement\V1beta1\ReachabilityDetails::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.ProbingDetails probing_details = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\NetworkManagement\V1beta1\ProbingDetails|null
     */
    public function getProbingDetails()
    {
        return isset($this->probing_details) ? $this->probing_details : null;
    }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.ProbingDetails probing_details = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\NetworkManagement\V1beta1\ProbingDetails $var
     * @return $this
     */
    public function setProbingDetails($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\NetworkManagement\V1beta1\ProbingDetails::class);
