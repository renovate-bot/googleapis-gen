...
namespace Google\Cloud\NetworkManagement\V1beta1\ReachabilityDetails;
 ...
 *
 * Protobuf type <code>google.cloud.networkmanagement.v1beta1.ReachabilityDetails.Result</code>
 */
class Result
{
    /**
...
class_alias(Result::class, \Google\Cloud\NetworkManagement\V1beta1\ReachabilityDetails_Result::class);
