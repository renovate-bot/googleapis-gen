...
namespace Google\Cloud\NetworkManagement\V1beta1\AbortInfo;
 ...
 * Abort cause types:
 *
 * Protobuf type <code>google.cloud.networkmanagement.v1beta1.AbortInfo.Cause</code>
 */
class Cause
{
    /**
...
class_alias(Cause::class, \Google\Cloud\NetworkManagement\V1beta1\AbortInfo_Cause::class);
