 ...
 * Type of next hop:
 *
 * Protobuf type <code>google.cloud.networkmanagement.v1beta1.RouteInfo.NextHopType</code>
 */
class NextHopType
{
    /**
...
class_alias(NextHopType::class, \Google\Cloud\NetworkManagement\V1beta1\RouteInfo_NextHopType::class);
