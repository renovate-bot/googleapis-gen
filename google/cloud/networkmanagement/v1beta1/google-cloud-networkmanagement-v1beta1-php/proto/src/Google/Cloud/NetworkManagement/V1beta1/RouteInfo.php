 ...
 *
 * Generated from protobuf message <code>google.cloud.networkmanagement.v1beta1.RouteInfo</code>
 */
class RouteInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * Type of route.
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.RouteInfo.RouteType route_type = 8;</code>
     */
    protected $route_type = 0;
    /**
     * Type of next hop.
     *
     * Generated from protobuf field <code>.google.cloud.networkmanagement.v1beta1.RouteInfo.NextHopType next_hop_type = 9;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\NetworkManagement\V1beta1\RouteInfo\RouteType::class);
        $this->route_type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\NetworkManagement\V1beta1\RouteInfo\NextHopType::class);
