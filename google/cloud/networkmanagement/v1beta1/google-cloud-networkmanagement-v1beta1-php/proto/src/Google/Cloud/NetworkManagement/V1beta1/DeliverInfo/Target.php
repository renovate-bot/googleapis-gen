...
namespace Google\Cloud\NetworkManagement\V1beta1\DeliverInfo;
 ...
 *
 * Protobuf type <code>google.cloud.networkmanagement.v1beta1.DeliverInfo.Target</code>
 */
class Target
{
    /**
...
class_alias(Target::class, \Google\Cloud\NetworkManagement\V1beta1\DeliverInfo_Target::class);
