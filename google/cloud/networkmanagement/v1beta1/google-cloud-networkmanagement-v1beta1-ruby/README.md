# Ruby Client for the Network Management V1beta1 API

API Client library for the Network Management V1beta1 API
...
specific version of the Network Management V1beta1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-network_management-v1beta1
```
...
View the [Client Library Documentation](https://googleapis.dev/ruby/google-cloud-network_management-v1beta1/latest)
...
`google-cloud-network_management-v1beta1`.
...
is part of the name, e.g. `google-cloud-network_management-v1beta1`.
