...
class ListConnectivityTestsPager:
    ...
    :class:`google.cloud.networkmanagement_v1beta1.types.ListConnectivityTestsResponse` object, and
    ...
    All the usual :class:`google.cloud.networkmanagement_v1beta1.types.ListConnectivityTestsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.networkmanagement_v1beta1.types.ListConnectivityTestsResponse):
