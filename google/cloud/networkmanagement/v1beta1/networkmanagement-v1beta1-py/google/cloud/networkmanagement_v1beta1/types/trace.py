...
class Trace(proto.Message):
    ...
    Attributes:
        endpoint_info (google.cloud.networkmanagement_v1beta1.types.EndpointInfo):
            ...
            between traces.
        steps (Sequence[google.cloud.networkmanagement_v1beta1.types.Step]):
...
class Step(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.networkmanagement_v1beta1.types.Step.State):
        ...
        instance (google.cloud.networkmanagement_v1beta1.types.InstanceInfo):
            Display information of a Compute Engine
            instance.
            This field is a member of `oneof`_ ``step_info``.
        firewall (google.cloud.networkmanagement_v1beta1.types.FirewallInfo):
            Display information of a Compute Engine
            firewall rule.
            This field is a member of `oneof`_ ``step_info``.
        route (google.cloud.networkmanagement_v1beta1.types.RouteInfo):
            Display information of a Compute Engine
            route.
            This field is a member of `oneof`_ ``step_info``.
        endpoint (google.cloud.networkmanagement_v1beta1.types.EndpointInfo):
            ...
            This field is a member of `oneof`_ ``step_info``.
        forwarding_rule (google.cloud.networkmanagement_v1beta1.types.ForwardingRuleInfo):
            Display information of a Compute Engine
            forwarding rule.
            This field is a member of `oneof`_ ``step_info``.
        vpn_gateway (google.cloud.networkmanagement_v1beta1.types.VpnGatewayInfo):
            Display information of a Compute Engine VPN
            gateway.
            This field is a member of `oneof`_ ``step_info``.
        vpn_tunnel (google.cloud.networkmanagement_v1beta1.types.VpnTunnelInfo):
            Display information of a Compute Engine VPN
            tunnel.
            This field is a member of `oneof`_ ``step_info``.
        deliver (google.cloud.networkmanagement_v1beta1.types.DeliverInfo):
            Display information of the final state
            "deliver" and reason.
            This field is a member of `oneof`_ ``step_info``.
        forward (google.cloud.networkmanagement_v1beta1.types.ForwardInfo):
            Display information of the final state
            "forward" and reason.
            This field is a member of `oneof`_ ``step_info``.
        abort (google.cloud.networkmanagement_v1beta1.types.AbortInfo):
            Display information of the final state
            "abort" and reason.
            This field is a member of `oneof`_ ``step_info``.
        drop (google.cloud.networkmanagement_v1beta1.types.DropInfo):
            Display information of the final state "drop"
            and reason.
            This field is a member of `oneof`_ ``step_info``.
        load_balancer (google.cloud.networkmanagement_v1beta1.types.LoadBalancerInfo):
            Display information of the load balancers.
            This field is a member of `oneof`_ ``step_info``.
        network (google.cloud.networkmanagement_v1beta1.types.NetworkInfo):
            Display information of a Google Cloud
            network.
            This field is a member of `oneof`_ ``step_info``.
        gke_master (google.cloud.networkmanagement_v1beta1.types.GKEMasterInfo):
            Display information of a Google Kubernetes
            Engine cluster master.
            This field is a member of `oneof`_ ``step_info``.
        cloud_sql_instance (google.cloud.networkmanagement_v1beta1.types.CloudSQLInstanceInfo):
...
class FirewallInfo(proto.Message):
    ...
    Attributes:
        ...
        firewall_rule_type (google.cloud.networkmanagement_v1beta1.types.FirewallInfo.FirewallRuleType):
...
class RouteInfo(proto.Message):
    ...
    Attributes:
        route_type (google.cloud.networkmanagement_v1beta1.types.RouteInfo.RouteType):
            Type of route.
        next_hop_type (google.cloud.networkmanagement_v1beta1.types.RouteInfo.NextHopType):
            Type of next hop.
        display_name (str):
...
class LoadBalancerInfo(proto.Message):
    ...
    Attributes:
        load_balancer_type (google.cloud.networkmanagement_v1beta1.types.LoadBalancerInfo.LoadBalancerType):
            Type of the load balancer.
        health_check_uri (str):
            URI of the health check for the load
            balancer.
        backends (Sequence[google.cloud.networkmanagement_v1beta1.types.LoadBalancerBackend]):
            Information for the loadbalancer backends.
        backend_type (google.cloud.networkmanagement_v1beta1.types.LoadBalancerInfo.BackendType):
...
class LoadBalancerBackend(proto.Message):
    ...
    Attributes:
        ...
        uri (str):
            ...
            endpoint.
        health_check_firewall_state (google.cloud.networkmanagement_v1beta1.types.LoadBalancerBackend.HealthCheckFirewallState):
...
class VpnTunnelInfo(proto.Message):
    ...
    Attributes:
        ...
        region (str):
            Name of a Google Cloud region where this VPN
            tunnel is configured.
        routing_type (google.cloud.networkmanagement_v1beta1.types.VpnTunnelInfo.RoutingType):
...
class DeliverInfo(proto.Message):
    ...
    Attributes:
        target (google.cloud.networkmanagement_v1beta1.types.DeliverInfo.Target):
...
class ForwardInfo(proto.Message):
    ...
    Attributes:
        target (google.cloud.networkmanagement_v1beta1.types.ForwardInfo.Target):
...
class AbortInfo(proto.Message):
    ...
    Attributes:
        cause (google.cloud.networkmanagement_v1beta1.types.AbortInfo.Cause):
...
class DropInfo(proto.Message):
    ...
    Attributes:
        cause (google.cloud.networkmanagement_v1beta1.types.DropInfo.Cause):
