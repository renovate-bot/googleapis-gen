...
from google.cloud.networkmanagement_v1beta1.services.reachability_service import ReachabilityServiceAsyncClient
from google.cloud.networkmanagement_v1beta1.services.reachability_service import ReachabilityServiceClient
from google.cloud.networkmanagement_v1beta1.services.reachability_service import pagers
from google.cloud.networkmanagement_v1beta1.services.reachability_service import transports
from google.cloud.networkmanagement_v1beta1.services.reachability_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_reachability_service_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
def test_reachability_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_reachability_service_client_client_options_from_dict():
    with mock.patch('google.cloud.networkmanagement_v1beta1.services.reachability_service.transports.ReachabilityServiceGrpcTransport.__init__') as grpc_transport:
...
def test_list_connectivity_tests(transport: str = 'grpc', request_type=reachability.ListConnectivityTestsRequest):
    client = ReachabilityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_connectivity_tests_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, connectivity_test.ConnectivityTest)
                   for i in results)
...
def test_get_connectivity_test(transport: str = 'grpc', request_type=reachability.GetConnectivityTestRequest):
    client = ReachabilityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_connectivity_test),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_connectivity_test(transport: str = 'grpc', request_type=reachability.CreateConnectivityTestRequest):
    client = ReachabilityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_connectivity_test),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_connectivity_test(transport: str = 'grpc', request_type=reachability.UpdateConnectivityTestRequest):
    client = ReachabilityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_connectivity_test),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_rerun_connectivity_test(transport: str = 'grpc', request_type=reachability.RerunConnectivityTestRequest):
    client = ReachabilityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rerun_connectivity_test),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_connectivity_test(transport: str = 'grpc', request_type=reachability.DeleteConnectivityTestRequest):
    client = ReachabilityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_connectivity_test),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_reachability_service_base_transport():
    ...
    with mock.patch('google.cloud.networkmanagement_v1beta1.services.reachability_service.transports.ReachabilityServiceTransport.__init__') as Transport:
...
def test_reachability_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.networkmanagement_v1beta1.services.reachability_service.transports.ReachabilityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_reachability_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.networkmanagement_v1beta1.services.reachability_service.transports.ReachabilityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ReachabilityServiceTransport()
        adc.assert_called_once()
