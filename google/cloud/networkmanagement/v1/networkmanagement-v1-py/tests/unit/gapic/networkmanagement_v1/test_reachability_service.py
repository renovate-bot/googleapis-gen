...
from google.cloud.networkmanagement_v1.services.reachability_service import ReachabilityServiceAsyncClient
from google.cloud.networkmanagement_v1.services.reachability_service import ReachabilityServiceClient
from google.cloud.networkmanagement_v1.services.reachability_service import pagers
from google.cloud.networkmanagement_v1.services.reachability_service import transports
from google.cloud.networkmanagement_v1.services.reachability_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_reachability_service_client_client_options_from_dict():
    with mock.patch('google.cloud.networkmanagement_v1.services.reachability_service.transports.ReachabilityServiceGrpcTransport.__init__') as grpc_transport:
...
def test_reachability_service_base_transport():
    ...
    with mock.patch('google.cloud.networkmanagement_v1.services.reachability_service.transports.ReachabilityServiceTransport.__init__') as Transport:
...
def test_reachability_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.networkmanagement_v1.services.reachability_service.transports.ReachabilityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_reachability_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.networkmanagement_v1.services.reachability_service.transports.ReachabilityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ReachabilityServiceTransport()
        adc.assert_called_once()
