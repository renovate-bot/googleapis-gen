...
class ReachabilityServiceClient(metaclass=ReachabilityServiceClientMeta):
    ...
    def list_connectivity_tests(self,
        ...
        Returns:
            google.cloud.networkmanagement_v1.services.reachability_service.pagers.ListConnectivityTestsPager:
    ...
    def get_connectivity_test(self,
        ...
        Args:
            request (google.cloud.networkmanagement_v1.types.GetConnectivityTestRequest):
                The request object. Request for the
    ...
    def create_connectivity_test(self,
        ...
        Args:
            request (google.cloud.networkmanagement_v1.types.CreateConnectivityTestRequest):
                The request object. Request for the
    ...
    def update_connectivity_test(self,
        ...
        Args:
            request (google.cloud.networkmanagement_v1.types.UpdateConnectivityTestRequest):
                The request object. Request for the
    ...
    def rerun_connectivity_test(self,
        ...
        Args:
            request (google.cloud.networkmanagement_v1.types.RerunConnectivityTestRequest):
                The request object. Request for the
    ...
    def delete_connectivity_test(self,
        ...
        Args:
            request (google.cloud.networkmanagement_v1.types.DeleteConnectivityTestRequest):
                The request object. Request for the
