...
from google.apps.script.type.docs import docs_addon_manifest_pb2 as docs_addon_manifest  # type: ignore
from google.apps.script.type.drive import drive_addon_manifest_pb2 as drive_addon_manifest  # type: ignore
from google.apps.script.type.gmail import gmail_addon_manifest_pb2 as gmail_addon_manifest  # type: ignore
from google.apps.script.type.sheets import sheets_addon_manifest_pb2 as sheets_addon_manifest  # type: ignore
from google.apps.script.type.slides import slides_addon_manifest_pb2 as slides_addon_manifest  # type: ignore
...
class Deployment(proto.Message):
    ...
    Attributes:
        ...
        add_ons (google.cloud.workspace_add_ons_v1.types.AddOns):
