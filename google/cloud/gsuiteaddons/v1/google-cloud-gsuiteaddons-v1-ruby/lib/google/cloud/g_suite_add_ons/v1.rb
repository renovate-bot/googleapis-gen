...
module Google
  module Cloud
    module GSuiteAddOns
      ...
      ##
      # # Ruby Client for Google Workspace Add-ons API ([Alpha](https://github.com/GoogleCloudPlatform/google-cloud-ruby#versioning))
      #
      # [Google Workspace Add-ons API][Product Documentation]:
      #
      ...
      # 3. [Enable the Google Workspace Add-ons API.](https://console.cloud.google.com/apis/library/gsuiteaddons.googleapis.com)
      # 4. [Setup Authentication.](https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud/master/guides/authentication)
      #
      # ### Installation
      # ```
      # $ gem install google-cloud-g_suite_add_ons
      # ```
      #
      # ### Next Steps
      # - Read the [Google Workspace Add-ons API Product documentation][Product Documentation]
      #   to learn more about the product and see How-to Guides.
      # - View this [repository's main README](https://github.com/GoogleCloudPlatform/google-cloud-ruby/blob/master/README.md)
      #   to see the full list of Cloud APIs that we cover.
      #
      # [Product Documentation]: https://cloud.google.com/gsuiteaddons
      #
      # ## Enabling Logging
      #
      ...
      module V1
        ...
        def self.new \
          ...
          Google::Cloud::GSuiteAddOns::V1::GSuiteAddOnsClient.new(**kwargs)
        end
      end
    end
  end
