  ...
  module Apps
    module Script
      module Type
        ...
        #     the URL must also
        #     [match](https://cloud.google.com/gmail/add-ons/concepts/manifests#whitelisting_urls) one of the
