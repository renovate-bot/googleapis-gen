...
module Google
  module Cloud
    ...
    module GSuiteAddOns
      ...
      FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("g_suite_add_ons"))
      ...
      def self.new(*args, version: :v1, **kwargs)
        ...
        version_module = Google::Cloud::GSuiteAddOns
          .constants
          .select {|sym| sym.to_s.downcase == version.to_s.downcase}
          .first
        Google::Cloud::GSuiteAddOns.const_get(version_module).new(*args, **kwargs)
      end
    end
  end
end
