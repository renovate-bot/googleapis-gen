...
class GSuiteAddOnsClientTest extends GeneratedTest
{
    ...
    public function createDeploymentTest()
    {
        ...
        $response = $client->createDeployment($formattedParent, $deploymentId, $deployment);
    ...
    public function createDeploymentExceptionTest()
    {
        ...
        $deployment = new Deployment();
        try {
            $client->createDeployment($formattedParent, $deploymentId, $deployment);
    ...
    public function deleteDeploymentTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->deploymentName('[PROJECT]', '[DEPLOYMENT]');
        $client->deleteDeployment($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function getAuthorizationTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->authorizationName('[PROJECT]');
        $response = $client->getAuthorization($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getAuthorizationExceptionTest()
    {
        ...
        $formattedName = $client->authorizationName('[PROJECT]');
        try {
            $client->getAuthorization($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getInstallStatusTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->installStatusName('[PROJECT]', '[DEPLOYMENT]');
        $response = $client->getInstallStatus($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getInstallStatusExceptionTest()
    {
        ...
        $formattedName = $client->installStatusName('[PROJECT]', '[DEPLOYMENT]');
        try {
            $client->getInstallStatus($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function installDeploymentTest()
    {
        ...
        // Mock request
        $formattedName = $client->deploymentName('[PROJECT]', '[DEPLOYMENT]');
        $client->installDeployment($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function replaceDeploymentTest()
    {
        ...
        // Mock request
        $deployment = new Deployment();
        $response = $client->replaceDeployment($deployment);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function uninstallDeploymentTest()
    {
        ...
        // Mock request
        $formattedName = $client->deploymentName('[PROJECT]', '[DEPLOYMENT]');
        $client->uninstallDeployment($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
