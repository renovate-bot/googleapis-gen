...
class GSuiteAddOnsGapicClient
{
    ...
    {
        if (null == self::$authorizationNameTemplate) {
    ...
    {
        if (null == self::$deploymentNameTemplate) {
    ...
    {
        if (null == self::$installStatusNameTemplate) {
    ...
    public function replaceDeployment($deployment, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor([
          'deployment.name' => $request->getDeployment()->getName(),
        ]);
        $optionalArgs['headers'] = isset($optionalArgs['headers'])
            ? array_merge($requestParams->getHeader(), $optionalArgs['headers'])
            : $requestParams->getHeader();
