...
class gsuiteaddonsCallTransformer(cst.CSTTransformer):
...
def fix_files(
    ...
    *,
    transformer=gsuiteaddonsCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the gsuiteaddons client library.
