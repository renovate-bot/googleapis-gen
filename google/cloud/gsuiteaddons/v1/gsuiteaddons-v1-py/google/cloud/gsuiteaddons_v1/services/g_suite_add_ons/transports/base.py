...
class GSuiteAddOnsTransport(abc.ABC):
    ...
    @property
    def get_authorization(self) -> typing.Callable[
            [gsuiteaddons.GetAuthorizationRequest],
            typing.Union[
                gsuiteaddons.Authorization,
                typing.Awaitable[gsuiteaddons.Authorization]
            ]]:
        raise NotImplementedError()

    @property
    def create_deployment(self) -> typing.Callable[
            [gsuiteaddons.CreateDeploymentRequest],
            typing.Union[
                gsuiteaddons.Deployment,
                typing.Awaitable[gsuiteaddons.Deployment]
            ]]:
        raise NotImplementedError()

    @property
    def replace_deployment(self) -> typing.Callable[
    ...
    @property
    def get_deployment(self) -> typing.Callable[
    ...
    @property
    def list_deployments(self) -> typing.Callable[
            [gsuiteaddons.ListDeploymentsRequest],
            typing.Union[
                gsuiteaddons.ListDeploymentsResponse,
                typing.Awaitable[gsuiteaddons.ListDeploymentsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def delete_deployment(self) -> typing.Callable[
    ...
    @property
    def install_deployment(self) -> typing.Callable[
    ...
    @property
    def uninstall_deployment(self) -> typing.Callable[
    ...
    @property
    def get_install_status(self) -> typing.Callable[
            [gsuiteaddons.GetInstallStatusRequest],
            typing.Union[
                gsuiteaddons.InstallStatus,
                typing.Awaitable[gsuiteaddons.InstallStatus]
            ]]:
        raise NotImplementedError()
