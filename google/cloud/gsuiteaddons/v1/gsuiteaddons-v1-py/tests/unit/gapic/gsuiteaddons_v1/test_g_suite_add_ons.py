...
from google.apps.script.type import addon_widget_set_pb2 as addon_widget_set  # type: ignore
from google.apps.script.type import extension_point_pb2 as extension_point  # type: ignore
...
from google.cloud.gsuiteaddons_v1.services.g_suite_add_ons.transports.base import _API_CORE_VERSION
from google.cloud.gsuiteaddons_v1.services.g_suite_add_ons.transports.base import _GOOGLE_AUTH_VERSION
...
def test_g_suite_add_ons_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.gsuiteaddons_v1.services.g_suite_add_ons.transports.GSuiteAddOnsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_g_suite_add_ons_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.gsuiteaddons_v1.services.g_suite_add_ons.transports.GSuiteAddOnsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.GSuiteAddOnsTransport()
        adc.assert_called_once()
