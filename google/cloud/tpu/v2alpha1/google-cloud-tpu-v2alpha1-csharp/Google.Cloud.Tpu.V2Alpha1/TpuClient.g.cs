...
namespace Google.Cloud.Tpu.V2Alpha1
{
    ...
    public sealed partial class TpuSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private TpuSettings(TpuSettings existing) : base(existing)
        {
            ...
            UpdateNodeSettings = existing.UpdateNodeSettings;
            UpdateNodeOperationsSettings = existing.UpdateNodeOperationsSettings.Clone();
            ...
            ListRuntimeVersionsSettings = existing.ListRuntimeVersionsSettings;
            GetRuntimeVersionSettings = existing.GetRuntimeVersionSettings;
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to <c>TpuClient.UpdateNode</c>
        /// and <c>TpuClient.UpdateNodeAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings UpdateNodeSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// Long Running Operation settings for calls to <c>TpuClient.UpdateNode</c> and <c>TpuClient.UpdateNodeAsync</c>
        /// .
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        ...
        /// </list>
        /// </remarks>
        public lro::OperationsSettings UpdateNodeOperationsSettings { get; set; } = new lro::OperationsSettings
        {
            DefaultPollSettings = new gax::PollSettings(gax::Expiration.FromTimeout(sys::TimeSpan.FromHours(24)), sys::TimeSpan.FromSeconds(20), 1.5, sys::TimeSpan.FromSeconds(45)),
        };
        ...
        /// <c>TpuClient.GenerateServiceIdentity</c> and <c>TpuClient.GenerateServiceIdentityAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GenerateServiceIdentitySettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>TpuClient.ListRuntimeVersions</c> and <c>TpuClient.ListRuntimeVersionsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListRuntimeVersionsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to <c>TpuClient.GetRuntimeVersion</c>
        ///  and <c>TpuClient.GetRuntimeVersionAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetRuntimeVersionSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>TpuClient.GetGuestAttributes</c> and <c>TpuClient.GetGuestAttributesAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetGuestAttributesSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));
    ...
    public abstract partial class TpuClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Node, OperationMetadata> UpdateNode(UpdateNodeRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Node, OperationMetadata>> UpdateNodeAsync(UpdateNodeRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Node, OperationMetadata>> UpdateNodeAsync(UpdateNodeRequest request, st::CancellationToken cancellationToken) =>
            UpdateNodeAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));

        /// <summary>The long-running operations client for <c>UpdateNode</c>.</summary>
        public virtual lro::OperationsClient UpdateNodeOperationsClient => throw new sys::NotImplementedException();

        /// <summary>
        /// Poll an operation once, using an <c>operationName</c> from a previous invocation of <c>UpdateNode</c>.
        /// </summary>
        /// <param name="operationName">
        /// The name of a previously invoked operation. Must not be <c>null</c> or empty.
        /// </param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The result of polling the operation.</returns>
        public virtual lro::Operation<Node, OperationMetadata> PollOnceUpdateNode(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<Node, OperationMetadata>.PollOnceFromName(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), UpdateNodeOperationsClient, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A task representing the result of polling the operation.</returns>
        public virtual stt::Task<lro::Operation<Node, OperationMetadata>> PollOnceUpdateNodeAsync(string operationName, gaxgrpc::CallSettings callSettings = null) =>
            lro::Operation<Node, OperationMetadata>.PollOnceFromNameAsync(gax::GaxPreconditions.CheckNotNullOrEmpty(operationName, nameof(operationName)), UpdateNodeOperationsClient, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual lro::Operation<Node, OperationMetadata> UpdateNode(Node node, wkt::FieldMask updateMask, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Node, OperationMetadata>> UpdateNodeAsync(Node node, wkt::FieldMask updateMask, gaxgrpc::CallSettings callSettings = null) =>
            UpdateNodeAsync(new UpdateNodeRequest
            {
                UpdateMask = gax::GaxPreconditions.CheckNotNull(updateMask, nameof(updateMask)),
                Node = gax::GaxPreconditions.CheckNotNull(node, nameof(node)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<lro::Operation<Node, OperationMetadata>> UpdateNodeAsync(Node node, wkt::FieldMask updateMask, st::CancellationToken cancellationToken) =>
            UpdateNodeAsync(node, updateMask, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual GenerateServiceIdentityResponse GenerateServiceIdentity(GenerateServiceIdentityRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateServiceIdentityResponse> GenerateServiceIdentityAsync(GenerateServiceIdentityRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GenerateServiceIdentityResponse> GenerateServiceIdentityAsync(GenerateServiceIdentityRequest request, st::CancellationToken cancellationToken) =>
        ...
        /// <param name="request">The request object containing all of the parameters for the API call.</param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="RuntimeVersion"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListRuntimeVersionsResponse, RuntimeVersion> ListRuntimeVersions(ListRuntimeVersionsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="request">The request object containing all of the parameters for the API call.</param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="RuntimeVersion"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListRuntimeVersionsResponse, RuntimeVersion> ListRuntimeVersionsAsync(ListRuntimeVersionsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="RuntimeVersion"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListRuntimeVersionsResponse, RuntimeVersion> ListRuntimeVersions(string parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListRuntimeVersions(new ListRuntimeVersionsRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                PageToken = pageToken ?? "",
                PageSize = pageSize ?? 0,
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="RuntimeVersion"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListRuntimeVersionsResponse, RuntimeVersion> ListRuntimeVersionsAsync(string parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListRuntimeVersionsAsync(new ListRuntimeVersionsRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                PageToken = pageToken ?? "",
                PageSize = pageSize ?? 0,
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="RuntimeVersion"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListRuntimeVersionsResponse, RuntimeVersion> ListRuntimeVersions(RuntimeVersionName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListRuntimeVersions(new ListRuntimeVersionsRequest
            {
                ParentAsRuntimeVersionName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
                PageSize = pageSize ?? 0,
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="RuntimeVersion"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListRuntimeVersionsResponse, RuntimeVersion> ListRuntimeVersionsAsync(RuntimeVersionName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListRuntimeVersionsAsync(new ListRuntimeVersionsRequest
            {
                ParentAsRuntimeVersionName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual RuntimeVersion GetRuntimeVersion(GetRuntimeVersionRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<RuntimeVersion> GetRuntimeVersionAsync(GetRuntimeVersionRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<RuntimeVersion> GetRuntimeVersionAsync(GetRuntimeVersionRequest request, st::CancellationToken cancellationToken) =>
            GetRuntimeVersionAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual RuntimeVersion GetRuntimeVersion(string name, gaxgrpc::CallSettings callSettings = null) =>
            GetRuntimeVersion(new GetRuntimeVersionRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<RuntimeVersion> GetRuntimeVersionAsync(string name, gaxgrpc::CallSettings callSettings = null) =>
            GetRuntimeVersionAsync(new GetRuntimeVersionRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<RuntimeVersion> GetRuntimeVersionAsync(string name, st::CancellationToken cancellationToken) =>
            GetRuntimeVersionAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual RuntimeVersion GetRuntimeVersion(RuntimeVersionName name, gaxgrpc::CallSettings callSettings = null) =>
            GetRuntimeVersion(new GetRuntimeVersionRequest
            {
                RuntimeVersionName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<RuntimeVersion> GetRuntimeVersionAsync(RuntimeVersionName name, gaxgrpc::CallSettings callSettings = null) =>
            GetRuntimeVersionAsync(new GetRuntimeVersionRequest
            {
                RuntimeVersionName = gax::GaxPreconditions.CheckNotNull(name, nameof(name)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<RuntimeVersion> GetRuntimeVersionAsync(RuntimeVersionName name, st::CancellationToken cancellationToken) =>
            GetRuntimeVersionAsync(name, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual GetGuestAttributesResponse GetGuestAttributes(GetGuestAttributesRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GetGuestAttributesResponse> GetGuestAttributesAsync(GetGuestAttributesRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<GetGuestAttributesResponse> GetGuestAttributesAsync(GetGuestAttributesRequest request, st::CancellationToken cancellationToken) =>
    ...
    public sealed partial class TpuClientImpl : TpuClient
    {
        ...
        private readonly gaxgrpc::ApiCall<UpdateNodeRequest, lro::Operation> _callUpdateNode;

        private readonly gaxgrpc::ApiCall<GenerateServiceIdentityRequest, GenerateServiceIdentityResponse> _callGenerateServiceIdentity;
        ...
        private readonly gaxgrpc::ApiCall<ListRuntimeVersionsRequest, ListRuntimeVersionsResponse> _callListRuntimeVersions;

        private readonly gaxgrpc::ApiCall<GetRuntimeVersionRequest, RuntimeVersion> _callGetRuntimeVersion;

        private readonly gaxgrpc::ApiCall<GetGuestAttributesRequest, GetGuestAttributesResponse> _callGetGuestAttributes;
        ...
        public TpuClientImpl(Tpu.TpuClient grpcClient, TpuSettings settings)
        {
            ...
            UpdateNodeOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.UpdateNodeOperationsSettings);
            ...
            _callUpdateNode = clientHelper.BuildApiCall<UpdateNodeRequest, lro::Operation>(grpcClient.UpdateNodeAsync, grpcClient.UpdateNode, effectiveSettings.UpdateNodeSettings).WithGoogleRequestParam("node.name", request => request.Node?.Name);
            Modify_ApiCall(ref _callUpdateNode);
            Modify_UpdateNodeApiCall(ref _callUpdateNode);
            _callGenerateServiceIdentity = clientHelper.BuildApiCall<GenerateServiceIdentityRequest, GenerateServiceIdentityResponse>(grpcClient.GenerateServiceIdentityAsync, grpcClient.GenerateServiceIdentity, effectiveSettings.GenerateServiceIdentitySettings).WithGoogleRequestParam("parent", request => request.Parent);
            ...
            _callListRuntimeVersions = clientHelper.BuildApiCall<ListRuntimeVersionsRequest, ListRuntimeVersionsResponse>(grpcClient.ListRuntimeVersionsAsync, grpcClient.ListRuntimeVersions, effectiveSettings.ListRuntimeVersionsSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callListRuntimeVersions);
            Modify_ListRuntimeVersionsApiCall(ref _callListRuntimeVersions);
            _callGetRuntimeVersion = clientHelper.BuildApiCall<GetRuntimeVersionRequest, RuntimeVersion>(grpcClient.GetRuntimeVersionAsync, grpcClient.GetRuntimeVersion, effectiveSettings.GetRuntimeVersionSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callGetRuntimeVersion);
            Modify_GetRuntimeVersionApiCall(ref _callGetRuntimeVersion);
            _callGetGuestAttributes = clientHelper.BuildApiCall<GetGuestAttributesRequest, GetGuestAttributesResponse>(grpcClient.GetGuestAttributesAsync, grpcClient.GetGuestAttributes, effectiveSettings.GetGuestAttributesSettings).WithGoogleRequestParam("name", request => request.Name);
        ...
        partial void Modify_UpdateNodeApiCall(ref gaxgrpc::ApiCall<UpdateNodeRequest, lro::Operation> call);

        partial void Modify_GenerateServiceIdentityApiCall(ref gaxgrpc::ApiCall<GenerateServiceIdentityRequest, GenerateServiceIdentityResponse> call);
        ...
        partial void Modify_ListRuntimeVersionsApiCall(ref gaxgrpc::ApiCall<ListRuntimeVersionsRequest, ListRuntimeVersionsResponse> call);

        partial void Modify_GetRuntimeVersionApiCall(ref gaxgrpc::ApiCall<GetRuntimeVersionRequest, RuntimeVersion> call);

        partial void Modify_GetGuestAttributesApiCall(ref gaxgrpc::ApiCall<GetGuestAttributesRequest, GetGuestAttributesResponse> call);
        ...
        partial void Modify_UpdateNodeRequest(ref UpdateNodeRequest request, ref gaxgrpc::CallSettings settings);
        ...
        partial void Modify_ListRuntimeVersionsRequest(ref ListRuntimeVersionsRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_GetRuntimeVersionRequest(ref GetRuntimeVersionRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_GetGuestAttributesRequest(ref GetGuestAttributesRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <summary>The long-running operations client for <c>UpdateNode</c>.</summary>
        public override lro::OperationsClient UpdateNodeOperationsClient { get; }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override lro::Operation<Node, OperationMetadata> UpdateNode(UpdateNodeRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_UpdateNodeRequest(ref request, ref callSettings);
            return new lro::Operation<Node, OperationMetadata>(_callUpdateNode.Sync(request, callSettings), UpdateNodeOperationsClient);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override async stt::Task<lro::Operation<Node, OperationMetadata>> UpdateNodeAsync(UpdateNodeRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_UpdateNodeRequest(ref request, ref callSettings);
            return new lro::Operation<Node, OperationMetadata>(await _callUpdateNode.Async(request, callSettings).ConfigureAwait(false), UpdateNodeOperationsClient);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override GenerateServiceIdentityResponse GenerateServiceIdentity(GenerateServiceIdentityRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GenerateServiceIdentityRequest(ref request, ref callSettings);
            return _callGenerateServiceIdentity.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<GenerateServiceIdentityResponse> GenerateServiceIdentityAsync(GenerateServiceIdentityRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GenerateServiceIdentityRequest(ref request, ref callSettings);
            return _callGenerateServiceIdentity.Async(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="RuntimeVersion"/> resources.</returns>
        public override gax::PagedEnumerable<ListRuntimeVersionsResponse, RuntimeVersion> ListRuntimeVersions(ListRuntimeVersionsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListRuntimeVersionsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedEnumerable<ListRuntimeVersionsRequest, ListRuntimeVersionsResponse, RuntimeVersion>(_callListRuntimeVersions, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="RuntimeVersion"/> resources.</returns>
        public override gax::PagedAsyncEnumerable<ListRuntimeVersionsResponse, RuntimeVersion> ListRuntimeVersionsAsync(ListRuntimeVersionsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListRuntimeVersionsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedAsyncEnumerable<ListRuntimeVersionsRequest, ListRuntimeVersionsResponse, RuntimeVersion>(_callListRuntimeVersions, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override RuntimeVersion GetRuntimeVersion(GetRuntimeVersionRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetRuntimeVersionRequest(ref request, ref callSettings);
            return _callGetRuntimeVersion.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<RuntimeVersion> GetRuntimeVersionAsync(GetRuntimeVersionRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetRuntimeVersionRequest(ref request, ref callSettings);
            return _callGetRuntimeVersion.Async(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override GetGuestAttributesResponse GetGuestAttributes(GetGuestAttributesRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetGuestAttributesRequest(ref request, ref callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<GetGuestAttributesResponse> GetGuestAttributesAsync(GetGuestAttributesRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_GetGuestAttributesRequest(ref request, ref callSettings);
    ...
    public partial class ListRuntimeVersionsRequest : gaxgrpc::IPageRequest
    {
    }
    ...
    public partial class ListRuntimeVersionsResponse : gaxgrpc::IPageResponse<RuntimeVersion>
    {
        /// <summary>Returns an enumerator that iterates through the resources in this response.</summary>
        public scg::IEnumerator<RuntimeVersion> GetEnumerator() => RuntimeVersions.GetEnumerator();
