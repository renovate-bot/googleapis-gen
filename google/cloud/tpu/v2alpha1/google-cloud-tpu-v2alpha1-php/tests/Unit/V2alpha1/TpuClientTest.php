...
namespace Google\Cloud\Tpu\Tests\Unit\V2alpha1;
...
use Google\Cloud\Tpu\V2alpha1\TpuClient;
...
class TpuClientTest extends GeneratedTest
{
    ...
    public function createNodeTest()
    {
        ...
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/CreateNode', $actualApiFuncCall);
    ...
    public function deleteNodeTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/DeleteNode', $actualApiFuncCall);
    ...
    public function generateServiceIdentityTest()
    {
        ...
        // Mock request
        $formattedParent = $client->locationName('[PROJECT]', '[LOCATION]');
        $response = $client->generateServiceIdentity($formattedParent);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/GenerateServiceIdentity', $actualFuncCall);
    ...
    public function generateServiceIdentityExceptionTest()
    {
        ...
        $formattedParent = $client->locationName('[PROJECT]', '[LOCATION]');
        try {
            $client->generateServiceIdentity($formattedParent);
    ...
    public function getAcceleratorTypeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/GetAcceleratorType', $actualFuncCall);
    ...
    public function getGuestAttributesTest()
    {
        ...
        // Mock request
        $formattedName = $client->nodeName('[PROJECT]', '[LOCATION]', '[NODE]');
        $response = $client->getGuestAttributes($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/GetGuestAttributes', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getGuestAttributesExceptionTest()
    {
        ...
        $formattedName = $client->nodeName('[PROJECT]', '[LOCATION]', '[NODE]');
        try {
            $client->getGuestAttributes($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getNodeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/GetNode', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getRuntimeVersionTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->runtimeVersionName('[PROJECT]', '[LOCATION]', '[RUNTIME_VERSION]');
        $response = $client->getRuntimeVersion($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/GetRuntimeVersion', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getRuntimeVersionExceptionTest()
    {
        ...
        $formattedName = $client->runtimeVersionName('[PROJECT]', '[LOCATION]', '[RUNTIME_VERSION]');
        try {
            $client->getRuntimeVersion($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listAcceleratorTypesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/ListAcceleratorTypes', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listNodesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/ListNodes', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listRuntimeVersionsTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $client->runtimeVersionName('[PROJECT]', '[LOCATION]', '[RUNTIME_VERSION]');
        $response = $client->listRuntimeVersions($formattedParent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/ListRuntimeVersions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listRuntimeVersionsExceptionTest()
    {
        ...
        $formattedParent = $client->runtimeVersionName('[PROJECT]', '[LOCATION]', '[RUNTIME_VERSION]');
        try {
            $client->listRuntimeVersions($formattedParent);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function startNodeTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/StartNode', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function stopNodeTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/StopNode', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function updateNodeTest()
    {
        ...
        $nodeRuntimeVersion = 'nodeRuntimeVersion-385109886';
        $node->setRuntimeVersion($nodeRuntimeVersion);
        $response = $client->updateNode($updateMask, $node);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.tpu.v2alpha1.Tpu/UpdateNode', $actualApiFuncCall);
