 ...
 * Next ID: 8;
 *
 * Generated from protobuf message <code>google.cloud.tpu.v2alpha1.AttachedDisk</code>
 */
class AttachedDisk extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tpu.v2alpha1.AttachedDisk.DiskMode mode = 4;</code>
     */
    protected $mode = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Tpu\V2alpha1\AttachedDisk\DiskMode::class);
        $this->mode = $var;
