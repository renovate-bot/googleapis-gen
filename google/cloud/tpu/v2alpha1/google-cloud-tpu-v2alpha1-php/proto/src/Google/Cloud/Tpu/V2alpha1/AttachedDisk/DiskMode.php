...
namespace Google\Cloud\Tpu\V2alpha1\AttachedDisk;
 ...
 *
 * Protobuf type <code>google.cloud.tpu.v2alpha1.AttachedDisk.DiskMode</code>
 */
class DiskMode
{
    /**
...
class_alias(DiskMode::class, \Google\Cloud\Tpu\V2alpha1\AttachedDisk_DiskMode::class);
