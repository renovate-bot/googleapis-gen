...
namespace Google\Cloud\Tpu\V2alpha1\Symptom;
 ...
 * at.
 *
 * Protobuf type <code>google.cloud.tpu.v2alpha1.Symptom.SymptomType</code>
 */
class SymptomType
{
    /**
...
class_alias(SymptomType::class, \Google\Cloud\Tpu\V2alpha1\Symptom_SymptomType::class);
