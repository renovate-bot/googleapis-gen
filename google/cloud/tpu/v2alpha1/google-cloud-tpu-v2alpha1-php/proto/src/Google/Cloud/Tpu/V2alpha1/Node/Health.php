...
namespace Google\Cloud\Tpu\V2alpha1\Node;
 ...
 * Health Monitor.
 *
 * Protobuf type <code>google.cloud.tpu.v2alpha1.Node.Health</code>
 */
class Health
{
    /**
...
class_alias(Health::class, \Google\Cloud\Tpu\V2alpha1\Node_Health::class);
