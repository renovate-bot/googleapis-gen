 ...
 *
 * Generated from protobuf message <code>google.cloud.tpu.v2alpha1.NetworkEndpoint</code>
 */
class NetworkEndpoint extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tpu.v2alpha1.AccessConfig access_config = 5;</code>
     */
     ...
     *     @type int $port
     *           The port of this network endpoint.
     *     @type \Google\Cloud\Tpu\V2alpha1\AccessConfig $access_config
     *           The access config for the TPU worker.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tpu.v2alpha1.AccessConfig access_config = 5;</code>
     * @return \Google\Cloud\Tpu\V2alpha1\AccessConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tpu.v2alpha1.AccessConfig access_config = 5;</code>
     * @param \Google\Cloud\Tpu\V2alpha1\AccessConfig $var
     * @return $this
     */
    public function setAccessConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Tpu\V2alpha1\AccessConfig::class);
