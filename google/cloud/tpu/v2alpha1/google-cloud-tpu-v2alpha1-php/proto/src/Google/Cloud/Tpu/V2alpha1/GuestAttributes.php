 ...
 * A guest attributes.
 *
 * Generated from protobuf message <code>google.cloud.tpu.v2alpha1.GuestAttributes</code>
 */
class GuestAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tpu.v2alpha1.GuestAttributesValue query_value = 2;</code>
     */
     ...
     *           nested namespace ('/\<namespace\>/') or a specified key
     *           ('/\<namespace\>/\<key\>')
     *     @type \Google\Cloud\Tpu\V2alpha1\GuestAttributesValue $query_value
     *           The value of the requested queried path.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tpu.v2alpha1.GuestAttributesValue query_value = 2;</code>
     * @return \Google\Cloud\Tpu\V2alpha1\GuestAttributesValue|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tpu.v2alpha1.GuestAttributesValue query_value = 2;</code>
     * @param \Google\Cloud\Tpu\V2alpha1\GuestAttributesValue $var
     * @return $this
     */
    public function setQueryValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Tpu\V2alpha1\GuestAttributesValue::class);
