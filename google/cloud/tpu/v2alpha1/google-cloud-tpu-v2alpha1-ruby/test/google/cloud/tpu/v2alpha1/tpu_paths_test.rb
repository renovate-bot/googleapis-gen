...
class ::Google::Cloud::Tpu::V2alpha1::Tpu::ClientPathsTest < Minitest::Test
  ...
  def test_runtime_version_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.runtime_version_path project: "value0", location: "value1", runtime_version: "value2"
      assert_equal "projects/value0/locations/value1/runtimeVersions/value2", path
    end
  end
end
