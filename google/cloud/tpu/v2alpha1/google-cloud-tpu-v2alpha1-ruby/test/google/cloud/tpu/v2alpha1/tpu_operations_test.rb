...
class ::Google::Cloud::Tpu::V2alpha1::Tpu::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Tpu::V2alpha1::Tpu::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Tpu::V2alpha1::Tpu::Operations::Configuration, config
  end
end
