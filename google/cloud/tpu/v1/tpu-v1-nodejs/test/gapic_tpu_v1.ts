...
describe('v1.TpuClient', () => {
    ...
    describe('getNode', () => {
        it('invokes getNode without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tpu.v1.Node());
            client.innerApiCalls.getNode = stubSimpleCall(expectedResponse);
            const [response] = await client.getNode(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getNode as SinonStub)
    ...
    describe('getTensorFlowVersion', () => {
        it('invokes getTensorFlowVersion without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tpu.v1.TensorFlowVersion());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getTensorFlowVersion as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getAcceleratorType', () => {
        it('invokes getAcceleratorType without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tpu.v1.AcceleratorType());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAcceleratorType as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createNode', () => {
        it('invokes createNode without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createNode as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteNode', () => {
        it('invokes deleteNode without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteNode as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('reimageNode', () => {
        it('invokes reimageNode without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.reimageNode as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('stopNode', () => {
        it('invokes stopNode without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.stopNode as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('startNode', () => {
        it('invokes startNode without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.startNode as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listNodes', () => {
        it('invokes listNodes without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listNodes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listTensorFlowVersions', () => {
        it('invokes listTensorFlowVersions without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listTensorFlowVersions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listAcceleratorTypes', () => {
        it('invokes listAcceleratorTypes without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAcceleratorTypes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
