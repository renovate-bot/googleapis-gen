...
public class IdentityAwareProxyOAuthServiceClient implements BackgroundResource {
   ...
   * who belong to the same G Suite organization as the project. The brand is created in an
   ...
   *             .call(request);
   *     for (IdentityAwareProxyClient element : response.getResponsesList()) {
   *       // doThingsWith(element);
   *     }
  ...
  public static class ListIdentityAwareProxyClientsPagedResponse
      extends AbstractPagedListResponse<
          ListIdentityAwareProxyClientsRequest, ListIdentityAwareProxyClientsResponse,
          IdentityAwareProxyClient, ListIdentityAwareProxyClientsPage,
