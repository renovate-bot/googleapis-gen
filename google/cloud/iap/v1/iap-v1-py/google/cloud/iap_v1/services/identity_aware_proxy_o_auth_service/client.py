...
class IdentityAwareProxyOAuthServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[IdentityAwareProxyOAuthServiceTransport]]
...
class IdentityAwareProxyOAuthServiceClient(metaclass=IdentityAwareProxyOAuthServiceClientMeta):
    ...
    def create_identity_aware_proxy_client(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_identity_aware_proxy_client]
    ...
    def list_identity_aware_proxy_clients(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_identity_aware_proxy_clients]
    ...
    def get_identity_aware_proxy_client(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_identity_aware_proxy_client]
    ...
    def reset_identity_aware_proxy_client_secret(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reset_identity_aware_proxy_client_secret]
    ...
    def delete_identity_aware_proxy_client(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_identity_aware_proxy_client]
