...
from .transports.base import IdentityAwareProxyAdminServiceTransport, DEFAULT_CLIENT_INFO
...
class IdentityAwareProxyAdminServiceClientMeta(type):
    """Metaclass for the IdentityAwareProxyAdminService client.
...
class IdentityAwareProxyAdminServiceClient(metaclass=IdentityAwareProxyAdminServiceClientMeta):
    ...
    def transport(self) -> IdentityAwareProxyAdminServiceTransport:
        ...
        Returns:
            IdentityAwareProxyAdminServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, IdentityAwareProxyAdminServiceTransport):
            # transport is a IdentityAwareProxyAdminServiceTransport instance.
    ...
    def get_iap_settings(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_iap_settings]
    ...
    def update_iap_settings(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_iap_settings]
