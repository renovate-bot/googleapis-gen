...
from .base import IdentityAwareProxyOAuthServiceTransport, DEFAULT_CLIENT_INFO
...
class IdentityAwareProxyOAuthServiceGrpcTransport(IdentityAwareProxyOAuthServiceTransport):
    ...
    @property
    def create_brand(self) -> Callable[
    ...
    @property
    def create_identity_aware_proxy_client(self) -> Callable[
        ...
        if 'create_identity_aware_proxy_client' not in self._stubs:
            self._stubs['create_identity_aware_proxy_client'] = self.grpc_channel.unary_unary(
    ...
    @property
    def list_identity_aware_proxy_clients(self) -> Callable[
        ...
        if 'list_identity_aware_proxy_clients' not in self._stubs:
            self._stubs['list_identity_aware_proxy_clients'] = self.grpc_channel.unary_unary(
    ...
    @property
    def get_identity_aware_proxy_client(self) -> Callable[
        ...
        if 'get_identity_aware_proxy_client' not in self._stubs:
            self._stubs['get_identity_aware_proxy_client'] = self.grpc_channel.unary_unary(
    ...
    @property
    def reset_identity_aware_proxy_client_secret(self) -> Callable[
        ...
        if 'reset_identity_aware_proxy_client_secret' not in self._stubs:
            self._stubs['reset_identity_aware_proxy_client_secret'] = self.grpc_channel.unary_unary(
    ...
    @property
    def delete_identity_aware_proxy_client(self) -> Callable[
        ...
        if 'delete_identity_aware_proxy_client' not in self._stubs:
            self._stubs['delete_identity_aware_proxy_client'] = self.grpc_channel.unary_unary(
