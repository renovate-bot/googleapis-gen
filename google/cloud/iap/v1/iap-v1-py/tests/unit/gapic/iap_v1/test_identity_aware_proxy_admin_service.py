...
from google.cloud.iap_v1.services.identity_aware_proxy_admin_service import IdentityAwareProxyAdminServiceAsyncClient
from google.cloud.iap_v1.services.identity_aware_proxy_admin_service import IdentityAwareProxyAdminServiceClient
from google.cloud.iap_v1.services.identity_aware_proxy_admin_service import transports
from google.cloud.iap_v1.services.identity_aware_proxy_admin_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_identity_aware_proxy_admin_service_client_from_service_account_info(client_class):
...
def test_identity_aware_proxy_admin_service_client_service_account_always_use_jwt(client_class):
...
def test_identity_aware_proxy_admin_service_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
def test_identity_aware_proxy_admin_service_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (IdentityAwareProxyAdminServiceClient, transports.IdentityAwareProxyAdminServiceGrpcTransport, "grpc"),
    (IdentityAwareProxyAdminServiceAsyncClient, transports.IdentityAwareProxyAdminServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (IdentityAwareProxyAdminServiceClient, transports.IdentityAwareProxyAdminServiceGrpcTransport, "grpc", "true"),
    (IdentityAwareProxyAdminServiceAsyncClient, transports.IdentityAwareProxyAdminServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (IdentityAwareProxyAdminServiceClient, transports.IdentityAwareProxyAdminServiceGrpcTransport, "grpc", "false"),
    (IdentityAwareProxyAdminServiceAsyncClient, transports.IdentityAwareProxyAdminServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(IdentityAwareProxyAdminServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(IdentityAwareProxyAdminServiceClient))
@mock.patch.object(IdentityAwareProxyAdminServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(IdentityAwareProxyAdminServiceAsyncClient))
...
def test_identity_aware_proxy_admin_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_get_iap_settings(transport: str = 'grpc', request_type=service.GetIapSettingsRequest):
    client = IdentityAwareProxyAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_iap_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_iap_settings(transport: str = 'grpc', request_type=service.UpdateIapSettingsRequest):
    client = IdentityAwareProxyAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_iap_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.IapSettings(
            name='name_value',
...
def test_update_iap_settings_field_headers():
    ...
    request.iap_settings.name = 'iap_settings.name/value'
    ...
    assert (
        'x-goog-request-params',
        'iap_settings.name=iap_settings.name/value',
    ) in kw['metadata']
...
@requires_google_auth_lt_1_25_0
def test_identity_aware_proxy_admin_service_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        IdentityAwareProxyAdminServiceClient()
...
@requires_google_auth_lt_1_25_0
def test_identity_aware_proxy_admin_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.IdentityAwareProxyAdminServiceGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
