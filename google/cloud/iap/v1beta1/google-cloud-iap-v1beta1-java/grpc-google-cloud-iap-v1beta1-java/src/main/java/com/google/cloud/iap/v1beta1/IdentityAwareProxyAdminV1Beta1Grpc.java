...
public final class IdentityAwareProxyAdminV1Beta1Grpc {
  ...
  public static final String SERVICE_NAME = "google.cloud.iap.v1beta1.IdentityAwareProxyAdminV1Beta1";
  ...
  public static io.grpc.MethodDescriptor<com.google.iam.v1.SetIamPolicyRequest,
    ...
    if ((getSetIamPolicyMethod = IdentityAwareProxyAdminV1Beta1Grpc.getSetIamPolicyMethod) == null) {
      synchronized (IdentityAwareProxyAdminV1Beta1Grpc.class) {
        if ((getSetIamPolicyMethod = IdentityAwareProxyAdminV1Beta1Grpc.getSetIamPolicyMethod) == null) {
          IdentityAwareProxyAdminV1Beta1Grpc.getSetIamPolicyMethod = getSetIamPolicyMethod =
              ...
              .setSchemaDescriptor(new IdentityAwareProxyAdminV1Beta1MethodDescriptorSupplier("SetIamPolicy"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<com.google.iam.v1.GetIamPolicyRequest,
    ...
    if ((getGetIamPolicyMethod = IdentityAwareProxyAdminV1Beta1Grpc.getGetIamPolicyMethod) == null) {
      synchronized (IdentityAwareProxyAdminV1Beta1Grpc.class) {
        if ((getGetIamPolicyMethod = IdentityAwareProxyAdminV1Beta1Grpc.getGetIamPolicyMethod) == null) {
          IdentityAwareProxyAdminV1Beta1Grpc.getGetIamPolicyMethod = getGetIamPolicyMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.iam.v1.Policy.getDefaultInstance()))
              .setSchemaDescriptor(new IdentityAwareProxyAdminV1Beta1MethodDescriptorSupplier("GetIamPolicy"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<com.google.iam.v1.TestIamPermissionsRequest,
    ...
    if ((getTestIamPermissionsMethod = IdentityAwareProxyAdminV1Beta1Grpc.getTestIamPermissionsMethod) == null) {
      synchronized (IdentityAwareProxyAdminV1Beta1Grpc.class) {
        if ((getTestIamPermissionsMethod = IdentityAwareProxyAdminV1Beta1Grpc.getTestIamPermissionsMethod) == null) {
          IdentityAwareProxyAdminV1Beta1Grpc.getTestIamPermissionsMethod = getTestIamPermissionsMethod =
              ...
              .setSchemaDescriptor(new IdentityAwareProxyAdminV1Beta1MethodDescriptorSupplier("TestIamPermissions"))
              .build();
        }
      }
    }
  ...
  public static IdentityAwareProxyAdminV1Beta1Stub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<IdentityAwareProxyAdminV1Beta1Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<IdentityAwareProxyAdminV1Beta1Stub>() {
        @java.lang.Override
        public IdentityAwareProxyAdminV1Beta1Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static IdentityAwareProxyAdminV1Beta1BlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<IdentityAwareProxyAdminV1Beta1BlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<IdentityAwareProxyAdminV1Beta1BlockingStub>() {
        @java.lang.Override
        public IdentityAwareProxyAdminV1Beta1BlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static IdentityAwareProxyAdminV1Beta1FutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<IdentityAwareProxyAdminV1Beta1FutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<IdentityAwareProxyAdminV1Beta1FutureStub>() {
        @java.lang.Override
        public IdentityAwareProxyAdminV1Beta1FutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static abstract class IdentityAwareProxyAdminV1Beta1ImplBase implements io.grpc.BindableService {
   ...
   * </pre>
   */
  public static final class IdentityAwareProxyAdminV1Beta1Stub extends io.grpc.stub.AbstractAsyncStub<IdentityAwareProxyAdminV1Beta1Stub> {
   ...
   * </pre>
   */
  public static final class IdentityAwareProxyAdminV1Beta1BlockingStub extends io.grpc.stub.AbstractBlockingStub<IdentityAwareProxyAdminV1Beta1BlockingStub> {
   ...
   * </pre>
   */
  public static final class IdentityAwareProxyAdminV1Beta1FutureStub extends io.grpc.stub.AbstractFutureStub<IdentityAwareProxyAdminV1Beta1FutureStub> {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    private final IdentityAwareProxyAdminV1Beta1ImplBase serviceImpl;
    private final int methodId;

    MethodHandlers(IdentityAwareProxyAdminV1Beta1ImplBase serviceImpl, int methodId) {
  ...
  private static abstract class IdentityAwareProxyAdminV1Beta1BaseDescriptorSupplier
  ...
  private static final class IdentityAwareProxyAdminV1Beta1MethodDescriptorSupplier
    ...
    IdentityAwareProxyAdminV1Beta1MethodDescriptorSupplier(String methodName) {
      ...
      synchronized (IdentityAwareProxyAdminV1Beta1Grpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new IdentityAwareProxyAdminV1Beta1FileDescriptorSupplier())
