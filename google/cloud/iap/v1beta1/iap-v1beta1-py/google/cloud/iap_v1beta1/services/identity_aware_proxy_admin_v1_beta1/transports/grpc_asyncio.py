...
from .base import IdentityAwareProxyAdminV1Beta1Transport, DEFAULT_CLIENT_INFO
from .grpc import IdentityAwareProxyAdminV1Beta1GrpcTransport


class IdentityAwareProxyAdminV1Beta1GrpcAsyncIOTransport(IdentityAwareProxyAdminV1Beta1Transport):
    """gRPC AsyncIO backend transport for IdentityAwareProxyAdminV1Beta1.
