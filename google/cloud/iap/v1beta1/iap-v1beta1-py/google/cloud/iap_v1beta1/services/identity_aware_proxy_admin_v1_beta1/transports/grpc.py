...
class IdentityAwareProxyAdminV1Beta1GrpcTransport(IdentityAwareProxyAdminV1Beta1Transport):
    """gRPC backend transport for IdentityAwareProxyAdminV1Beta1.
...
__all__ = (
    'IdentityAwareProxyAdminV1Beta1GrpcTransport',
)
