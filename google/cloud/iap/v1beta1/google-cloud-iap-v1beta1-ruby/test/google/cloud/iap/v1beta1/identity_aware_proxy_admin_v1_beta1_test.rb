...
require "google/cloud/iap/v1beta1/identity_aware_proxy_admin_v1_beta1"

class ::Google::Cloud::Iap::V1beta1::IdentityAwareProxyAdminV1Beta1::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Iap::V1beta1::IdentityAwareProxyAdminV1Beta1::Client::Configuration, config
  end
end
