# Ruby Client for the Identity-Aware Proxy V1beta1 API

API Client library for the Identity-Aware Proxy V1beta1 API
...
specific version of the Identity-Aware Proxy V1beta1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-iap-v1beta1
```
...
View the [Client Library Documentation](https://googleapis.dev/ruby/google-cloud-iap-v1beta1/latest)
...
is part of the name, e.g. `google-cloud-iap-v1beta1`.
