...
class DataMigrationServiceClient(metaclass=DataMigrationServiceClientMeta):
    ...
    def list_migration_jobs(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.ListMigrationJobsRequest):
        ...
        Returns:
            google.cloud.database_migration_v1.services.data_migration_service.pagers.ListMigrationJobsPager:
    ...
    def get_migration_job(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.GetMigrationJobRequest):
        ...
        Returns:
            google.cloud.database_migration_v1.types.MigrationJob:
    ...
    def create_migration_job(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.CreateMigrationJobRequest):
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            migration_job (google.cloud.database_migration_v1.types.MigrationJob):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.database_migration_v1.types.MigrationJob`
    ...
    def update_migration_job(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.UpdateMigrationJobRequest):
                The request object. Request message for
    ...
    def delete_migration_job(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.DeleteMigrationJobRequest):
                The request object. Request message for
    ...
    def start_migration_job(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.StartMigrationJobRequest):
                The request object. Request message for
    ...
    def stop_migration_job(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.StopMigrationJobRequest):
                The request object. Request message for
    ...
    def resume_migration_job(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.ResumeMigrationJobRequest):
                The request object. Request message for
    ...
    def promote_migration_job(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.PromoteMigrationJobRequest):
                The request object. Request message for
    ...
    def verify_migration_job(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.VerifyMigrationJobRequest):
                The request object. Request message for
    ...
    def restart_migration_job(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.RestartMigrationJobRequest):
                The request object. Request message for
    ...
    def generate_ssh_script(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.GenerateSshScriptRequest):
                The request object. Request message for
        ...
        Returns:
            google.cloud.database_migration_v1.types.SshScript:
                Response message for
                'GenerateSshScript' request.
    ...
    def list_connection_profiles(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.ListConnectionProfilesRequest):
                The request object. Request message for
        ...
        Returns:
            google.cloud.database_migration_v1.services.data_migration_service.pagers.ListConnectionProfilesPager:
                Response message for
                'ListConnectionProfiles' request.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def get_connection_profile(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.GetConnectionProfileRequest):
                The request object. Request message for
        ...
        Returns:
            google.cloud.database_migration_v1.types.ConnectionProfile:
    ...
    def create_connection_profile(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.CreateConnectionProfileRequest):
                The request object. Request message for
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            connection_profile (google.cloud.database_migration_v1.types.ConnectionProfile):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.database_migration_v1.types.ConnectionProfile`
                A connection profile definition.
    ...
    def update_connection_profile(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.UpdateConnectionProfileRequest):
                The request object. Request message for
    ...
    def delete_connection_profile(self,
        ...
        Args:
            request (google.cloud.database_migration_v1.types.DeleteConnectionProfileRequest):
                The request object. Request message for
