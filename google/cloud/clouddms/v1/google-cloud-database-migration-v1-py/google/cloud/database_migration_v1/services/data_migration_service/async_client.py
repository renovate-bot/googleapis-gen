...
class DataMigrationServiceAsyncClient:
    ...
    async def list_migration_jobs(self,
        ...
        Args:
            request (:class:`google.cloud.database_migration_v1.types.ListMigrationJobsRequest`):
        ...
        Returns:
            google.cloud.database_migration_v1.services.data_migration_service.pagers.ListMigrationJobsAsyncPager:
    ...
    async def get_migration_job(self,
        ...
        Args:
            request (:class:`google.cloud.database_migration_v1.types.GetMigrationJobRequest`):
    ...
    async def create_migration_job(self,
        ...
        Args:
            request (:class:`google.cloud.database_migration_v1.types.CreateMigrationJobRequest`):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            migration_job (:class:`google.cloud.database_migration_v1.types.MigrationJob`):
    ...
    async def update_migration_job(self,
        ...
        Args:
            request (:class:`google.cloud.database_migration_v1.types.UpdateMigrationJobRequest`):
                The request object. Request message for
    ...
    async def delete_migration_job(self,
        ...
        Args:
            request (:class:`google.cloud.database_migration_v1.types.DeleteMigrationJobRequest`):
                The request object. Request message for
    ...
    async def list_connection_profiles(self,
        ...
        Args:
            request (:class:`google.cloud.database_migration_v1.types.ListConnectionProfilesRequest`):
                The request object. Request message for
        ...
        Returns:
            google.cloud.database_migration_v1.services.data_migration_service.pagers.ListConnectionProfilesAsyncPager:
                Response message for
                'ListConnectionProfiles' request.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    async def get_connection_profile(self,
        ...
        Args:
            request (:class:`google.cloud.database_migration_v1.types.GetConnectionProfileRequest`):
                The request object. Request message for
    ...
    async def create_connection_profile(self,
        ...
        Args:
            request (:class:`google.cloud.database_migration_v1.types.CreateConnectionProfileRequest`):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            connection_profile (:class:`google.cloud.database_migration_v1.types.ConnectionProfile`):
    ...
    async def update_connection_profile(self,
        ...
        Args:
            request (:class:`google.cloud.database_migration_v1.types.UpdateConnectionProfileRequest`):
                The request object. Request message for
    ...
    async def delete_connection_profile(self,
        ...
        Args:
            request (:class:`google.cloud.database_migration_v1.types.DeleteConnectionProfileRequest`):
                The request object. Request message for
