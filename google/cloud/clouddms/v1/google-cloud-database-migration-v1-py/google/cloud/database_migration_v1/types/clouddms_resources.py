...
class SslConfig(proto.Message):
    ...
    Attributes:
        type_ (google.cloud.database_migration_v1.types.SslConfig.SslType):
...
class MySqlConnectionProfile(proto.Message):
    ...
    Attributes:
        ...
        ssl (google.cloud.database_migration_v1.types.SslConfig):
    ...
    ssl = proto.Field(proto.MESSAGE, number=6,
        message='SslConfig',
    )
...
class CloudSqlConnectionProfile(proto.Message):
    ...
    Attributes:
        ...
        settings (google.cloud.database_migration_v1.types.CloudSqlSettings):
    ...
    settings = proto.Field(proto.MESSAGE, number=2,
...
class SqlAclEntry(proto.Message):
    ...
    expire_time = proto.Field(proto.MESSAGE, number=10, oneof='expiration',
        message=timestamp.Timestamp,
    )

    ttl = proto.Field(proto.MESSAGE, number=11, oneof='expiration',
...
class SqlIpConfig(proto.Message):
    ...
    Attributes:
        ...
        require_ssl (google.protobuf.wrappers_pb2.BoolValue):
            ...
            enforced or not.
        authorized_networks (Sequence[google.cloud.database_migration_v1.types.SqlAclEntry]):
    ...
    enable_ipv4 = proto.Field(proto.MESSAGE, number=1,
        message=wrappers.BoolValue,
    )

    private_network = proto.Field(proto.STRING, number=2)

    require_ssl = proto.Field(proto.MESSAGE, number=3,
        message=wrappers.BoolValue,
    )

    authorized_networks = proto.RepeatedField(proto.MESSAGE, number=4,
        message='SqlAclEntry',
    )
...
class CloudSqlSettings(proto.Message):
    ...
    Attributes:
        database_version (google.cloud.database_migration_v1.types.CloudSqlSettings.SqlDatabaseVersion):
            The database engine type and version.
        user_labels (Sequence[google.cloud.database_migration_v1.types.CloudSqlSettings.UserLabelsEntry]):
        ...
        storage_auto_resize_limit (google.protobuf.wrappers_pb2.Int64Value):
            ...
            limit.
        activation_policy (google.cloud.database_migration_v1.types.CloudSqlSettings.SqlActivationPolicy):
        ...
        ip_config (google.cloud.database_migration_v1.types.SqlIpConfig):
        ...
        auto_storage_increase (google.protobuf.wrappers_pb2.BoolValue):
            ...
            maximum of 30 TB.
        database_flags (Sequence[google.cloud.database_migration_v1.types.CloudSqlSettings.DatabaseFlagsEntry]):
        ...
        data_disk_type (google.cloud.database_migration_v1.types.CloudSqlSettings.SqlDataDiskType):
    ...
    database_version = proto.Field(proto.ENUM, number=1,
    ...
    storage_auto_resize_limit = proto.Field(proto.MESSAGE, number=4,
        message=wrappers.Int64Value,
    )

    activation_policy = proto.Field(proto.ENUM, number=5,
        enum=SqlActivationPolicy,
    )

    ip_config = proto.Field(proto.MESSAGE, number=6,
        message='SqlIpConfig',
    )

    auto_storage_increase = proto.Field(proto.MESSAGE, number=7,
        message=wrappers.BoolValue,
    )

    database_flags = proto.MapField(proto.STRING, proto.STRING, number=8)

    data_disk_type = proto.Field(proto.ENUM, number=9,
        enum=SqlDataDiskType,
    )

    data_disk_size_gb = proto.Field(proto.MESSAGE, number=10,
        message=wrappers.Int64Value,
    )
...
class DatabaseType(proto.Message):
    ...
    Attributes:
        provider (google.cloud.database_migration_v1.types.DatabaseProvider):
            The database provider.
        engine (google.cloud.database_migration_v1.types.DatabaseEngine):
            The database engine.
    """
    ...
    engine = proto.Field(proto.ENUM, number=2,
        enum='DatabaseEngine',
    )
...
class MigrationJob(proto.Message):
    ...
    Attributes:
        ...
        labels (Sequence[google.cloud.database_migration_v1.types.MigrationJob.LabelsEntry]):
        ...
        state (google.cloud.database_migration_v1.types.MigrationJob.State):
            The current migration job state.
        phase (google.cloud.database_migration_v1.types.MigrationJob.Phase):
            Output only. The current migration job phase.
        type_ (google.cloud.database_migration_v1.types.MigrationJob.Type):
        ...
        reverse_ssh_connectivity (google.cloud.database_migration_v1.types.ReverseSshConnectivity):
            The details needed to communicate to the
            source over Reverse SSH tunnel connectivity.
        vpc_peering_connectivity (google.cloud.database_migration_v1.types.VpcPeeringConnectivity):
            The details of the VPC network that the
            source database is located in.
        static_ip_connectivity (google.cloud.database_migration_v1.types.StaticIpConnectivity):
        ...
        error (google.rpc.status_pb2.Status):
            ...
            state FAILED.
        source_database (google.cloud.database_migration_v1.types.DatabaseType):
            The database engine type and provider of the
            source.
        destination_database (google.cloud.database_migration_v1.types.DatabaseType):
            The database engine type and provider of the
            destination.
    ...
    phase = proto.Field(proto.ENUM, number=7,
        enum=Phase,
    )
    ...
    reverse_ssh_connectivity = proto.Field(proto.MESSAGE, number=101, oneof='connectivity',
        message='ReverseSshConnectivity',
    )

    vpc_peering_connectivity = proto.Field(proto.MESSAGE, number=102, oneof='connectivity',
        message='VpcPeeringConnectivity',
    )

    static_ip_connectivity = proto.Field(proto.MESSAGE, number=103, oneof='connectivity',
        message='StaticIpConnectivity',
    )

    duration = proto.Field(proto.MESSAGE, number=12,
        message=gp_duration.Duration,
    )

    error = proto.Field(proto.MESSAGE, number=13,
        message=status.Status,
    )

    source_database = proto.Field(proto.MESSAGE, number=14,
        message='DatabaseType',
    )

    destination_database = proto.Field(proto.MESSAGE, number=15,
        message='DatabaseType',
    )

    end_time = proto.Field(proto.MESSAGE, number=16,
        message=timestamp.Timestamp,
    )
...
class ConnectionProfile(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            "2014-10-02T15:01:23.045123456Z".
        labels (Sequence[google.cloud.database_migration_v1.types.ConnectionProfile.LabelsEntry]):
            ...
            Example:
            ``{ "name": "wrench", "mass": "1.3kg", "count": "3" }``.
        state (google.cloud.database_migration_v1.types.ConnectionProfile.State):
            The current connection profile state (e.g.
            DRAFT, READY, or FAILED).
        display_name (str):
            The connection profile display name.
        mysql (google.cloud.database_migration_v1.types.MySqlConnectionProfile):
            A MySQL database connection profile.
        postgresql (google.cloud.database_migration_v1.types.PostgreSqlConnectionProfile):
            A PostgreSQL database connection profile.
        cloudsql (google.cloud.database_migration_v1.types.CloudSqlConnectionProfile):
    ...
    mysql = proto.Field(proto.MESSAGE, number=100, oneof='connection_profile',
        message='MySqlConnectionProfile',
    )

    postgresql = proto.Field(proto.MESSAGE, number=101, oneof='connection_profile',
        message='PostgreSqlConnectionProfile',
    )

    cloudsql = proto.Field(proto.MESSAGE, number=102, oneof='connection_profile',
    ...
    provider = proto.Field(proto.ENUM, number=8,
        enum='DatabaseProvider',
    )
...
class MigrationJobVerificationError(proto.Message):
    ...
    Attributes:
        error_code (google.cloud.database_migration_v1.types.MigrationJobVerificationError.ErrorCode):
