...
class ListMigrationJobsPager:
    ...
    :class:`google.cloud.database_migration_v1.types.ListMigrationJobsResponse` object, and
    ...
    All the usual :class:`google.cloud.database_migration_v1.types.ListMigrationJobsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.database_migration_v1.types.ListMigrationJobsResponse):
...
class ListConnectionProfilesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.database_migration_v1.types.ListConnectionProfilesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.database_migration_v1.types.ListConnectionProfilesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.database_migration_v1.types.ListConnectionProfilesRequest):
                The initial request object.
            response (google.cloud.database_migration_v1.types.ListConnectionProfilesResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
