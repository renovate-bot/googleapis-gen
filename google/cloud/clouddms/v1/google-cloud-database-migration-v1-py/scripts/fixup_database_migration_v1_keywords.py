...
class database_migrationCallTransformer(cst.CSTTransformer):
...
def fix_files(
    ...
    *,
    transformer=database_migrationCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the database_migration client library.
