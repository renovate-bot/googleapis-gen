...
from google.cloud.database_migration_v1.services.data_migration_service import DataMigrationServiceAsyncClient
from google.cloud.database_migration_v1.services.data_migration_service import DataMigrationServiceClient
from google.cloud.database_migration_v1.services.data_migration_service import pagers
from google.cloud.database_migration_v1.services.data_migration_service import transports
from google.cloud.database_migration_v1.services.data_migration_service.transports.base import _API_CORE_VERSION
from google.cloud.database_migration_v1.services.data_migration_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_data_migration_service_client_client_options_from_dict():
    with mock.patch('google.cloud.database_migration_v1.services.data_migration_service.transports.DataMigrationServiceGrpcTransport.__init__') as grpc_transport:
...
def test_data_migration_service_base_transport():
    ...
    with mock.patch('google.cloud.database_migration_v1.services.data_migration_service.transports.DataMigrationServiceTransport.__init__') as Transport:
...
def test_data_migration_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.database_migration_v1.services.data_migration_service.transports.DataMigrationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_migration_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.database_migration_v1.services.data_migration_service.transports.DataMigrationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataMigrationServiceTransport()
        adc.assert_called_once()
