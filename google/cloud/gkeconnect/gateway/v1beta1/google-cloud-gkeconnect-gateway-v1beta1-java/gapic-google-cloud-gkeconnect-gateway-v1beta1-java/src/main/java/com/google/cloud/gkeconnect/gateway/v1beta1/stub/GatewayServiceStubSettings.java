...
/**
 * Settings class to configure an instance of {@link GatewayServiceStub}.
 *
...
public class GatewayServiceStubSettings extends StubSettings<GatewayServiceStubSettings> {
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(GatewayServiceStubSettings.class))
        .setTransportToken(
  ...
  protected GatewayServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    postResourceSettings = settingsBuilder.postResourceSettings().build();
    deleteResourceSettings = settingsBuilder.deleteResourceSettings().build();
    putResourceSettings = settingsBuilder.putResourceSettings().build();
    patchResourceSettings = settingsBuilder.patchResourceSettings().build();
  }

  /** Builder for GatewayServiceStubSettings. */
  public static class Builder extends StubSettings.Builder<GatewayServiceStubSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      ...
      postResourceSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      deleteResourceSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      putResourceSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      patchResourceSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(GatewayServiceStubSettings settings) {
      ...
      postResourceSettings = settings.postResourceSettings.toBuilder();
      deleteResourceSettings = settings.deleteResourceSettings.toBuilder();
      putResourceSettings = settings.putResourceSettings.toBuilder();
      patchResourceSettings = settings.patchResourceSettings.toBuilder();
