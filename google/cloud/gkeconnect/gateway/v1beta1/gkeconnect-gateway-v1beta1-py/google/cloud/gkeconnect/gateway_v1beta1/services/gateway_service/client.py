...
from .transports.grpc import GatewayServiceGrpcTransport
from .transports.grpc_asyncio import GatewayServiceGrpcAsyncIOTransport


class GatewayServiceClientMeta(type):
    """Metaclass for the GatewayService client.
...
class GatewayServiceClient(metaclass=GatewayServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            GatewayServiceClient: The constructed client.
        """
    ...
    def transport(self) -> GatewayServiceTransport:
        ...
        Returns:
            GatewayServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, GatewayServiceTransport):
            # transport is a GatewayServiceTransport instance.
    ...
    def post_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.post_resource]
    ...
    def delete_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_resource]
    ...
    def put_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.put_resource]
    ...
    def patch_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.patch_resource]
