 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/videointelligence/v1p2beta1/video_intelligence.proto
 * and updates to that file get reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\VideoIntelligence\V1p2beta1\Gapic;
...
use Google\Cloud\VideoIntelligence\V1p2beta1\AnnotateVideoProgress;
use Google\Cloud\VideoIntelligence\V1p2beta1\AnnotateVideoRequest;
use Google\Cloud\VideoIntelligence\V1p2beta1\AnnotateVideoResponse;
use Google\Cloud\VideoIntelligence\V1p2beta1\Feature;
use Google\Cloud\VideoIntelligence\V1p2beta1\VideoContext;
 ...
 *     $operationResponse = $videoIntelligenceServiceClient->annotateVideo($features, ['inputUri' => $inputUri]);
...
class VideoIntelligenceServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.videointelligence.v1p2beta1.VideoIntelligenceService';
     ...
     *                            For allowed values, use constants defined on {@see \Google\Cloud\VideoIntelligence\V1p2beta1\Feature}
