...
from google.cloud.videointelligence_v1p3beta1.services.video_intelligence_service import VideoIntelligenceServiceAsyncClient
from google.cloud.videointelligence_v1p3beta1.services.video_intelligence_service import VideoIntelligenceServiceClient
from google.cloud.videointelligence_v1p3beta1.services.video_intelligence_service import transports
from google.cloud.videointelligence_v1p3beta1.services.video_intelligence_service.transports.base import _API_CORE_VERSION
from google.cloud.videointelligence_v1p3beta1.services.video_intelligence_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_video_intelligence_service_client_client_options_from_dict():
    with mock.patch('google.cloud.videointelligence_v1p3beta1.services.video_intelligence_service.transports.VideoIntelligenceServiceGrpcTransport.__init__') as grpc_transport:
...
def test_video_intelligence_service_base_transport():
    ...
    with mock.patch('google.cloud.videointelligence_v1p3beta1.services.video_intelligence_service.transports.VideoIntelligenceServiceTransport.__init__') as Transport:
...
def test_video_intelligence_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.videointelligence_v1p3beta1.services.video_intelligence_service.transports.VideoIntelligenceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_video_intelligence_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.videointelligence_v1p3beta1.services.video_intelligence_service.transports.VideoIntelligenceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.VideoIntelligenceServiceTransport()
        adc.assert_called_once()
