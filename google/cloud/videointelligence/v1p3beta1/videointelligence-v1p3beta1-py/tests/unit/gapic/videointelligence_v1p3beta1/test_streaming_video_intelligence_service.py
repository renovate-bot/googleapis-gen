...
from google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service import StreamingVideoIntelligenceServiceAsyncClient
...
from google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service import transports
from google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.base import _API_CORE_VERSION
from google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_streaming_video_intelligence_service_client_from_service_account_info(client_class):
...
def test_streaming_video_intelligence_service_client_from_service_account_file(client_class):
    creds = credentials.AnonymousCredentials()
...
def test_streaming_video_intelligence_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_streaming_annotate_video(transport: str = 'grpc', request_type=video_intelligence.StreamingAnnotateVideoRequest):
    client = StreamingVideoIntelligenceServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.streaming_annotate_video),
            '__call__') as call:
...
def test_streaming_annotate_video_from_dict():
    test_streaming_annotate_video(request_type=dict)
...
def test_transport_get_channel():
    ...
    transport = transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport(
        credentials=credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_streaming_video_intelligence_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.StreamingVideoIntelligenceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_streaming_video_intelligence_service_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.StreamingVideoIntelligenceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_streaming_video_intelligence_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.StreamingVideoIntelligenceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.StreamingVideoIntelligenceServiceTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_streaming_video_intelligence_service_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        StreamingVideoIntelligenceServiceClient()
...
@requires_google_auth_lt_1_25_0
def test_streaming_video_intelligence_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
...
def test_streaming_video_intelligence_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_streaming_video_intelligence_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
