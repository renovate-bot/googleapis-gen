...
class StreamingVideoIntelligenceServiceAsyncClient:
    ...
    from_service_account_info = StreamingVideoIntelligenceServiceClient.from_service_account_info
    from_service_account_file = StreamingVideoIntelligenceServiceClient.from_service_account_file
