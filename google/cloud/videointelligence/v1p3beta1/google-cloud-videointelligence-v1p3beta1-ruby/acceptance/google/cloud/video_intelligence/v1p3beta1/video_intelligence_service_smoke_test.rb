...
describe "VideoIntelligenceServiceSmokeTest v1p3beta1" do
  it "runs one smoke test with annotate_video" do

    video_intelligence_client = Google::Cloud::VideoIntelligence::VideoIntelligence.new(version: :v1p3beta1)
