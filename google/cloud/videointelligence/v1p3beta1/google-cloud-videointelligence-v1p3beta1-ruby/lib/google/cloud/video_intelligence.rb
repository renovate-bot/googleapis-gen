...
module Google
  module Cloud
    ...
    #
    # video_intelligence_client = Google::Cloud::VideoIntelligence::VideoIntelligence.new
    ...
    #
    # [Product Documentation]: https://cloud.google.com/videointelligence
    #
    # ## Enabling Logging
    #
    ...
    module VideoIntelligence
      ...
      module VideoIntelligence
        ...
        #   The major version of the service to be used. By default :v1p3beta1
        #   is used.
        ...
        def self.new(*args, version: :v1p3beta1, **kwargs)
          ...
          version_module = Google::Cloud::VideoIntelligence
            ...
            .first
          Google::Cloud::VideoIntelligence.const_get(version_module)::VideoIntelligence.new(*args, **kwargs)
        end
      end

      module StreamingVideoIntelligence
        ##
        ...
        def self.new(*args, version: :v1p3beta1, **kwargs)
          ...
          version_module = Google::Cloud::VideoIntelligence
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::VideoIntelligence.const_get(version_module)::StreamingVideoIntelligence.new(*args, **kwargs)
        end
      end
    end
  end
