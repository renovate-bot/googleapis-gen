      ...
      module V1p3beta1
        module StreamingVideoIntelligenceService
          ...
          class Client
            ...
            # ## Example
            #
            # To modify the configuration for all StreamingVideoIntelligenceService clients:
            #
            ...
            # ## Examples
            #
            # To create a new StreamingVideoIntelligenceService client with the default
            # configuration:
            #
            #     client = ::Google::Cloud::Videointelligence::V1p3beta1::StreamingVideoIntelligenceService::Client.new
            #
            # To create a new StreamingVideoIntelligenceService client with a custom
            # configuration:
            #
            ...
            # # Examples
            #
            # To modify the global config, setting the timeout for streaming_annotate_video
