  ...
  module Cloud
    module Videointelligence
      module V1p3beta1
        ...
        class PersonDetectionConfig; end
        ...
        class CelebrityRecognitionAnnotation; end
        ...
        class FaceDetectionAnnotation; end

        # Person detection annotation per video.
        # @!attribute [rw] tracks
        #   @return [Array<Google::Cloud::Videointelligence::V1p3beta1::Track>]
        #     The detected tracks of a person.
        class PersonDetectionAnnotation; end
        ...
        class StreamingAnnotateVideoRequest; end
        ...
        class StreamingVideoConfig; end
        ...
        class StreamingAnnotateVideoResponse; end
        ...
        class StreamingVideoAnnotationResults; end

        # Config for STREAMING_SHOT_CHANGE_DETECTION.
        class StreamingShotChangeDetectionConfig; end
        ...
        class StreamingLabelDetectionConfig; end

        # Config for STREAMING_EXPLICIT_CONTENT_DETECTION.
        class StreamingExplicitContentDetectionConfig; end

        # Config for STREAMING_OBJECT_TRACKING.
        class StreamingObjectTrackingConfig; end
        ...
        class StreamingAutomlActionRecognitionConfig; end
        ...
        class StreamingAutomlClassificationConfig; end
        ...
        #     Resource name of AutoML model.
        #     Format: `projects/{project_id}/locations/{location_id}/models/{model_id}`
        class StreamingAutomlObjectTrackingConfig; end
        ...
        class StreamingStorageConfig; end
