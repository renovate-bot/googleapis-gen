  ...
  module Cloud
    module VideoIntelligence
      module V1p3beta1
        ...
        #   @return [Google::Cloud::Videointelligence::V1p3beta1::VideoIntelligenceService::Stub]
        class VideoIntelligenceServiceClient
          ...
          def initialize \
            ...
            @video_intelligence_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Videointelligence::V1p3beta1::VideoIntelligenceService::Stub.method(:new)
            )
          ...
          #   A hash of the same form as `Google::Cloud::Videointelligence::V1p3beta1::VideoContext`
          ...
          def annotate_video \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Videointelligence::V1p3beta1::AnnotateVideoRequest)
