      ...
      module V1p3beta1
        ...
        module VideoIntelligence
          ...
          def self.new \
            ...
            Google::Cloud::VideoIntelligence::V1p3beta1::VideoIntelligenceServiceClient.new(**kwargs)
          end
        end
        ...
        module StreamingVideoIntelligence
          ...
          def self.new \
            ...
            Google::Cloud::VideoIntelligence::V1p3beta1::StreamingVideoIntelligenceServiceClient.new(**kwargs)
          end
        end
      end
    end
