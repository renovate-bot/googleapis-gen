...
use Google\Cloud\VideoIntelligence\V1p3beta1\AnnotateVideoProgress;
use Google\Cloud\VideoIntelligence\V1p3beta1\AnnotateVideoRequest;
use Google\Cloud\VideoIntelligence\V1p3beta1\AnnotateVideoResponse;
use Google\Cloud\VideoIntelligence\V1p3beta1\Feature;
use Google\Cloud\VideoIntelligence\V1p3beta1\VideoContext;
...
class VideoIntelligenceServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.videointelligence.v1p3beta1.VideoIntelligenceService';
     ...
     *                            For allowed values, use constants defined on {@see \Google\Cloud\VideoIntelligence\V1p3beta1\Feature}
