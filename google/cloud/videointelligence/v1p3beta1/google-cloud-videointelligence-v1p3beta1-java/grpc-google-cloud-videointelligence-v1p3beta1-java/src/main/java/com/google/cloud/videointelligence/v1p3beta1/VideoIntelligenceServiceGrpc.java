...
public final class VideoIntelligenceServiceGrpc {
  ...
  public static final String SERVICE_NAME = "google.cloud.videointelligence.v1p3beta1.VideoIntelligenceService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoRequest,
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoRequest,
      com.google.longrunning.Operation> getAnnotateVideoMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoRequest, com.google.longrunning.Operation> getAnnotateVideoMethod;
      ...
      synchronized (VideoIntelligenceServiceGrpc.class) {
        if ((getAnnotateVideoMethod = VideoIntelligenceServiceGrpc.getAnnotateVideoMethod) == null) {
          VideoIntelligenceServiceGrpc.getAnnotateVideoMethod = getAnnotateVideoMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AnnotateVideo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoRequest.getDefaultInstance()))
  ...
  public static abstract class VideoIntelligenceServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void annotateVideo(com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoRequest request,
  ...
  public static final class VideoIntelligenceServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<VideoIntelligenceServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.longrunning.Operation annotateVideo(com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ANNOTATE_VIDEO:
          serviceImpl.annotateVideo((com.google.cloud.videointelligence.v1p3beta1.AnnotateVideoRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        default:
