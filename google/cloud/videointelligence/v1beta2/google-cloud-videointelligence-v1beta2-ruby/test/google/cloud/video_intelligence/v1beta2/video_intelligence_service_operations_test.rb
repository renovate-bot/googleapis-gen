...
class ::Google::Cloud::VideoIntelligence::V1beta2::VideoIntelligenceService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::VideoIntelligence::V1beta2::VideoIntelligenceService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::VideoIntelligence::V1beta2::VideoIntelligenceService::Operations::Configuration, config
  end
end
