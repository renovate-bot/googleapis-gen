...
namespace Google\Cloud\VideoIntelligence\Tests\Unit\V1p1beta1;

use Google\Cloud\VideoIntelligence\V1p1beta1\VideoIntelligenceServiceClient;
...
class VideoIntelligenceServiceClientTest extends GeneratedTest
{
    ...
    public function annotateVideoTest()
    {
        ...
        $this->assertSame('/google.cloud.videointelligence.v1p1beta1.VideoIntelligenceService/AnnotateVideo', $actualApiFuncCall);
