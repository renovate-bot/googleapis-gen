 ...
 *
 * Generated from protobuf message <code>google.cloud.videointelligence.v1p1beta1.AnnotateVideoRequest</code>
 */
class AnnotateVideoRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.videointelligence.v1p1beta1.Feature features = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $features;
    /**
     ...
     *           Required. Requested video annotation features.
     *     @type \Google\Cloud\VideoIntelligence\V1p1beta1\VideoContext $video_context
     *           Additional video context and/or feature-specific parameters.
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\VideoIntelligence\V1p1beta1\Feature::class);
        $this->features = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.videointelligence.v1p1beta1.VideoContext video_context = 3;</code>
     * @param \Google\Cloud\VideoIntelligence\V1p1beta1\VideoContext $var
     * @return $this
     */
    public function setVideoContext($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\VideoIntelligence\V1p1beta1\VideoContext::class);
