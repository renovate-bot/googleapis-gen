...
import (
	...
	videointelligencepb "google.golang.org/genproto/googleapis/cloud/videointelligence/v1p1beta1"
...
// internalClient is an interface that defines the methods availaible from Cloud Video Intelligence API.
