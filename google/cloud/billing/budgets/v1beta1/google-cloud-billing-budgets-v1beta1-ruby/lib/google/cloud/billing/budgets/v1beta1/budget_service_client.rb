...
require "google/cloud/billing/budgets/v1beta1/credentials"
    ...
    module Billing
      module Budgets
        module V1beta1
          ...
          #   @return [Google::Cloud::Billing::Budgets::V1beta1::BudgetService::Stub]
          class BudgetServiceClient
            ...
            def initialize \
              ...
              credentials ||= Google::Cloud::Billing::Budgets::V1beta1::Credentials.default

              if credentials.is_a?(String) || credentials.is_a?(Hash)
                updater_proc = Google::Cloud::Billing::Budgets::V1beta1::Credentials.new(credentials).updater_proc
              end
              ...
              @budget_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Cloud::Billing::Budgets::V1beta1::BudgetService::Stub.method(:new)
              )
            ...
            #   A hash of the same form as `Google::Cloud::Billing::Budgets::V1beta1::Budget`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Cloud::Billing::Budgets::V1beta1::Budget]
            ...
            #
            #   budget_client = Google::Cloud::Billing::Budgets.new(version: :v1beta1)
            ...
            def create_budget \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Billing::Budgets::V1beta1::CreateBudgetRequest)
            ...
            def update_budget \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Billing::Budgets::V1beta1::UpdateBudgetRequest)
            ...
            def get_budget \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Billing::Budgets::V1beta1::GetBudgetRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Billing::Budgets::V1beta1::Budget>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Cloud::Billing::Budgets::V1beta1::Budget>]
            #   An enumerable of Google::Cloud::Billing::Budgets::V1beta1::Budget instances.
            ...
            def list_budgets \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Billing::Budgets::V1beta1::ListBudgetsRequest)
            ...
            def delete_budget \
              ...
              req = Google::Gax::to_proto(req, Google::Cloud::Billing::Budgets::V1beta1::DeleteBudgetRequest)
