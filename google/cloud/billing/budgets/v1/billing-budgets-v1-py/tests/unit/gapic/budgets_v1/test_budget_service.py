...
from google.cloud.billing.budgets_v1.services.budget_service import BudgetServiceAsyncClient
...
from google.cloud.billing.budgets_v1.services.budget_service.transports.base import _API_CORE_VERSION
from google.cloud.billing.budgets_v1.services.budget_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert BudgetServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert BudgetServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert BudgetServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert BudgetServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (BudgetServiceAsyncClient, transports.BudgetServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(BudgetServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BudgetServiceClient))
@mock.patch.object(BudgetServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BudgetServiceAsyncClient))
def test_budget_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (BudgetServiceAsyncClient, transports.BudgetServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (BudgetServiceClient, transports.BudgetServiceGrpcTransport, "grpc", "false"),
    (BudgetServiceAsyncClient, transports.BudgetServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(BudgetServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BudgetServiceClient))
@mock.patch.object(BudgetServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BudgetServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_budget_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_budget_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_budget_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_budget_service_client_client_options_from_dict():
    with mock.patch('google.cloud.billing.budgets_v1.services.budget_service.transports.BudgetServiceGrpcTransport.__init__') as grpc_transport:
...
async def test_list_budgets_async(transport: str = 'grpc_asyncio', request_type=budget_service.ListBudgetsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(budget_service.ListBudgetsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_budget_service_base_transport():
    ...
    with mock.patch('google.cloud.billing.budgets_v1.services.budget_service.transports.BudgetServiceTransport.__init__') as Transport:
...
def test_budget_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.billing.budgets_v1.services.budget_service.transports.BudgetServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_budget_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.billing.budgets_v1.services.budget_service.transports.BudgetServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.BudgetServiceTransport()
        adc.assert_called_once()
...
def test_budget_service_transport_auth_adc(transport_class):
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        ...
        adc.assert_called_once_with(
            scopes=["1", "2"],
            default_scopes=(                'https://www.googleapis.com/auth/cloud-billing',                'https://www.googleapis.com/auth/cloud-platform',),
            quota_project_id="octopus",
        )
...
def test_budget_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_budget_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@pytest.mark.parametrize("transport_class", [transports.BudgetServiceGrpcTransport, transports.BudgetServiceGrpcAsyncIOTransport])
def test_budget_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_budget_service_host_no_port():
    client = BudgetServiceClient(
        credentials=credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='billingbudgets.googleapis.com'),
    )
    assert client.transport._host == 'billingbudgets.googleapis.com:443'
...
def test_budget_service_host_with_port():
    client = BudgetServiceClient(
        credentials=credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='billingbudgets.googleapis.com:8000'),
    )
...
@pytest.mark.parametrize("transport_class", [transports.BudgetServiceGrpcTransport, transports.BudgetServiceGrpcAsyncIOTransport])
def test_budget_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.BudgetServiceGrpcTransport, transports.BudgetServiceGrpcAsyncIOTransport])
def test_budget_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_budget_path():
    ...
    budget = "clam"
    expected = "billingAccounts/{billing_account}/budgets/{budget}".format(billing_account=billing_account, budget=budget, )
