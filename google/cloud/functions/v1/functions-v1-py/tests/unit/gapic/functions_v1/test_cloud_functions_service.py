...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (CloudFunctionsServiceClient, transports.CloudFunctionsServiceGrpcTransport, "grpc"),
    (CloudFunctionsServiceAsyncClient, transports.CloudFunctionsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_cloud_functions_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_list_functions(transport: str = 'grpc', request_type=functions.ListFunctionsRequest):
    client = CloudFunctionsServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_functions_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, functions.CloudFunction)
                   for i in results)
...
def test_create_function(transport: str = 'grpc', request_type=functions.CreateFunctionRequest):
    client = CloudFunctionsServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_function(transport: str = 'grpc', request_type=functions.UpdateFunctionRequest):
    client = CloudFunctionsServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_function_field_headers():
    ...
    assert (
        'x-goog-request-params',
        'function.name=function.name/value',
    ) in kw['metadata']
...
def test_delete_function(transport: str = 'grpc', request_type=functions.DeleteFunctionRequest):
    client = CloudFunctionsServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_call_function(transport: str = 'grpc', request_type=functions.CallFunctionRequest):
    client = CloudFunctionsServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_generate_upload_url(transport: str = 'grpc', request_type=functions.GenerateUploadUrlRequest):
    client = CloudFunctionsServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_generate_download_url(transport: str = 'grpc', request_type=functions.GenerateDownloadUrlRequest):
    client = CloudFunctionsServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CloudFunctionsServiceGrpcTransport, transports.CloudFunctionsServiceGrpcAsyncIOTransport])
def test_cloud_functions_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
