...
class ::Google::Cloud::Functions::V1::CloudFunctionsService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Functions::V1::CloudFunctionsService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Functions::V1::CloudFunctionsService::Operations::Configuration, config
  end
end
