...
class DataFusionAsyncClient:
    ...
    async def list_available_versions(self,
        ...
        Args:
            request (:class:`google.cloud.datafusion_v1.types.ListAvailableVersionsRequest`):
        ...
        Returns:
            google.cloud.datafusion_v1.services.data_fusion.pagers.ListAvailableVersionsAsyncPager:
    ...
    async def list_instances(self,
        ...
        Args:
            request (:class:`google.cloud.datafusion_v1.types.ListInstancesRequest`):
        ...
        Returns:
            google.cloud.datafusion_v1.services.data_fusion.pagers.ListInstancesAsyncPager:
                Response message for the list
                instance request.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    async def get_instance(self,
        ...
        Args:
            request (:class:`google.cloud.datafusion_v1.types.GetInstanceRequest`):
    ...
    async def create_instance(self,
        ...
        Args:
            request (:class:`google.cloud.datafusion_v1.types.CreateInstanceRequest`):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            instance (:class:`google.cloud.datafusion_v1.types.Instance`):
    ...
    async def delete_instance(self,
        ...
        Args:
            request (:class:`google.cloud.datafusion_v1.types.DeleteInstanceRequest`):
    ...
    async def update_instance(self,
        ...
        Args:
            request (:class:`google.cloud.datafusion_v1.types.UpdateInstanceRequest`):
                The request object.
            instance (:class:`google.cloud.datafusion_v1.types.Instance`):
    ...
    async def restart_instance(self,
        ...
        Args:
            request (:class:`google.cloud.datafusion_v1.types.RestartInstanceRequest`):
