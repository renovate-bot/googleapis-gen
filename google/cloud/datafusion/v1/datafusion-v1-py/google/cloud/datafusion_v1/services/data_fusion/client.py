...
class DataFusionClient(metaclass=DataFusionClientMeta):
    ...
    def list_available_versions(self,
        ...
        Returns:
            google.cloud.datafusion_v1.services.data_fusion.pagers.ListAvailableVersionsPager:
        ...
        # in a datafusion.ListAvailableVersionsRequest.
    ...
    def list_instances(self,
        ...
        Returns:
            google.cloud.datafusion_v1.services.data_fusion.pagers.ListInstancesPager:
                Response message for the list
                instance request.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a datafusion.ListInstancesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_instance(self,
        ...
        Args:
            request (google.cloud.datafusion_v1.types.GetInstanceRequest):
        ...
        Returns:
            google.cloud.datafusion_v1.types.Instance:
                Represents a Data Fusion instance.
        """
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a datafusion.GetInstanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_instance(self,
        ...
        Args:
            request (google.cloud.datafusion_v1.types.CreateInstanceRequest):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.datafusion_v1.types.Instance`
                Represents a Data Fusion instance.
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a datafusion.CreateInstanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_instance(self,
        ...
        Args:
            request (google.cloud.datafusion_v1.types.DeleteInstanceRequest):
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a datafusion.DeleteInstanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_instance(self,
        ...
        Args:
            request (google.cloud.datafusion_v1.types.UpdateInstanceRequest):
                The request object.
            instance (google.cloud.datafusion_v1.types.Instance):
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a datafusion.UpdateInstanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def restart_instance(self,
        ...
        Args:
            request (google.cloud.datafusion_v1.types.RestartInstanceRequest):
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a datafusion.RestartInstanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
