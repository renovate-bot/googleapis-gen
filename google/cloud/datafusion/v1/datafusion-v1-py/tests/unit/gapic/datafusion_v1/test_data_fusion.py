...
def test_list_available_versions(transport: str = 'grpc', request_type=datafusion.ListAvailableVersionsRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_available_versions_async(transport: str = 'grpc_asyncio', request_type=datafusion.ListAvailableVersionsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(datafusion.ListAvailableVersionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_available_versions_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, datafusion.Version)
                   for i in results)
...
def test_list_instances(transport: str = 'grpc', request_type=datafusion.ListInstancesRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_instances_async(transport: str = 'grpc_asyncio', request_type=datafusion.ListInstancesRequest):
    client = DataFusionAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(datafusion.ListInstancesResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_instances_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, datafusion.Instance)
                   for i in results)
...
def test_get_instance(transport: str = 'grpc', request_type=datafusion.GetInstanceRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_instance_async(transport: str = 'grpc_asyncio', request_type=datafusion.GetInstanceRequest):
    client = DataFusionAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_instance(transport: str = 'grpc', request_type=datafusion.CreateInstanceRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_instance_async(transport: str = 'grpc_asyncio', request_type=datafusion.CreateInstanceRequest):
    client = DataFusionAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_instance(transport: str = 'grpc', request_type=datafusion.DeleteInstanceRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_instance_async(transport: str = 'grpc_asyncio', request_type=datafusion.DeleteInstanceRequest):
    client = DataFusionAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_instance_async(transport: str = 'grpc_asyncio', request_type=datafusion.UpdateInstanceRequest):
    client = DataFusionAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_restart_instance(transport: str = 'grpc', request_type=datafusion.RestartInstanceRequest):
    client = DataFusionClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_restart_instance_async(transport: str = 'grpc_asyncio', request_type=datafusion.RestartInstanceRequest):
    client = DataFusionAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
