...
class DataFusionTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.add_dns_peering: gapic_v1.method.wrap_method(
                self.add_dns_peering,
                default_timeout=None,
                client_info=client_info,
            ),
            self.remove_dns_peering: gapic_v1.method.wrap_method(
                self.remove_dns_peering,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_dns_peerings: gapic_v1.method.wrap_method(
                self.list_dns_peerings,
                default_timeout=None,
                client_info=client_info,
            ),
         }
