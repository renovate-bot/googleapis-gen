...
namespace Google\Cloud\DataFusion\Tests\Unit\V1beta1;
...
use Google\Cloud\DataFusion\V1beta1\DataFusionClient;
...
class DataFusionClientTest extends GeneratedTest
{
     ...
     * @test
     */
    public function addDnsPeeringTest()
    {
        ...
        // Mock response
        $expectedResponse = new AddDnsPeeringResponse();
        $transport->addResponse($expectedResponse);
        $response = $client->addDnsPeering();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/AddDnsPeering', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
     ...
     * @test
     */
    public function addDnsPeeringExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
    ...
    public function createInstanceTest()
    {
        ...
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/CreateInstance', $actualApiFuncCall);
    ...
    public function deleteInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/DeleteInstance', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getInstanceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/GetInstance', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listAvailableVersionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/ListAvailableVersions', $actualFuncCall);
     ...
     * @test
     */
    public function listDnsPeeringsTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        // Mock response
        $nextPageToken = '';
        $dnsPeeringsElement = new DnsPeering();
        $dnsPeerings = [
            $dnsPeeringsElement,
        ];
        $expectedResponse = new ListDnsPeeringsResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setDnsPeerings($dnsPeerings);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $client->instanceName('[PROJECT]', '[LOCATION]', '[INSTANCE]');
        $response = $client->listDnsPeerings($formattedParent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getDnsPeerings()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/ListDnsPeerings', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
     ...
     * @test
     */
    public function listDnsPeeringsExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        $formattedParent = $client->instanceName('[PROJECT]', '[LOCATION]', '[INSTANCE]');
        try {
            $client->listDnsPeerings($formattedParent);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listInstancesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/ListInstances', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listNamespacesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/ListNamespaces', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
     ...
     * @test
     */
    public function removeDnsPeeringTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        $this->assertTrue($transport->isExhausted());
        // Mock response
        $expectedResponse = new RemoveDnsPeeringResponse();
        $transport->addResponse($expectedResponse);
        // Mock request
        $zone = 'zone3744684';
        $response = $client->removeDnsPeering($zone);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/RemoveDnsPeering', $actualFuncCall);
     ...
     * @test
     */
    public function removeDnsPeeringExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
    ...
    public function removeIamPolicyTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        $response = $client->removeIamPolicy();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/RemoveIamPolicy', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function restartInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/RestartInstance', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function updateInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/UpdateInstance', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function upgradeInstanceTest()
    {
        ...
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $client->upgradeInstance();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datafusion.v1beta1.DataFusion/UpgradeInstance', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
