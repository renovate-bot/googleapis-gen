...
namespace Google\Cloud\DataFusion\V1beta1\Instance;
 ...
 *
 * Protobuf type <code>google.cloud.datafusion.v1beta1.Instance.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\DataFusion\V1beta1\Instance_State::class);
