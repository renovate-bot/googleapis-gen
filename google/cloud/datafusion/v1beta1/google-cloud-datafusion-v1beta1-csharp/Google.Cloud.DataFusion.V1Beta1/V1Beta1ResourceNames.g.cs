...
namespace Google.Cloud.DataFusion.V1Beta1
{
    ...
    public sealed partial class NamespaceName : gax::IResourceName, sys::IEquatable<NamespaceName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <c>projects/{project}/locations/{location}/instances/{instance}/namespaces/{namespace}</c>.
            /// </summary>
            ProjectLocationInstanceNamespace = 1,
        }

        private static gax::PathTemplate s_projectLocationInstanceNamespace = new gax::PathTemplate("projects/{project}/locations/{location}/instances/{instance}/namespaces/{namespace}");
        ...
        public static NamespaceName FromProjectLocationInstanceNamespace(string projectId, string locationId, string instanceId, string namespaceId) =>
            new NamespaceName(ResourceNameType.ProjectLocationInstanceNamespace, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), instanceId: gax::GaxPreconditions.CheckNotNullOrEmpty(instanceId, nameof(instanceId)), namespaceId: gax::GaxPreconditions.CheckNotNullOrEmpty(namespaceId, nameof(namespaceId)));
        ...
        /// <c>projects/{project}/locations/{location}/instances/{instance}/namespaces/{namespace}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string instanceId, string namespaceId) =>
            FormatProjectLocationInstanceNamespace(projectId, locationId, instanceId, namespaceId);
        ...
        /// <c>projects/{project}/locations/{location}/instances/{instance}/namespaces/{namespace}</c>.
        /// </returns>
        public static string FormatProjectLocationInstanceNamespace(string projectId, string locationId, string instanceId, string namespaceId) =>
            s_projectLocationInstanceNamespace.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(instanceId, nameof(instanceId)), gax::GaxPreconditions.CheckNotNullOrEmpty(namespaceId, nameof(namespaceId)));
        ...
        public static bool TryParse(string namespaceName, bool allowUnparsed, out NamespaceName result)
        {
            ...
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationInstanceNamespace.TryParseName(namespaceName, out resourceName))
            {
                result = FromProjectLocationInstanceNamespace(resourceName[0], resourceName[1], resourceName[2], resourceName[3]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private NamespaceName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string instanceId = null, string locationId = null, string namespaceId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            InstanceId = instanceId;
        ...
        /// <param name="instanceId">The <c>Instance</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="namespaceId">The <c>Namespace</c> ID. Must not be <c>null</c> or empty.</param>
        public NamespaceName(string projectId, string locationId, string instanceId, string namespaceId) : this(ResourceNameType.ProjectLocationInstanceNamespace, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), instanceId: gax::GaxPreconditions.CheckNotNullOrEmpty(instanceId, nameof(instanceId)), namespaceId: gax::GaxPreconditions.CheckNotNullOrEmpty(namespaceId, nameof(namespaceId)))
        {
        }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationInstanceNamespace: return s_projectLocationInstanceNamespace.Expand(ProjectId, LocationId, InstanceId, NamespaceId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
    ...
    {
        /// <summary>
        /// <see cref="gcdv::NamespaceName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcdv::NamespaceName NamespaceName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcdv::NamespaceName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
    }

    public partial class ListDnsPeeringsRequest
    {
        /// <summary>
        /// <see cref="InstanceName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
