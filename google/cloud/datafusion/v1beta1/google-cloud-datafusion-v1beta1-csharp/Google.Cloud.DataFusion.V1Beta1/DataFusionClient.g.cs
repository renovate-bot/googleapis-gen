...
namespace Google.Cloud.DataFusion.V1Beta1
{
    ...
    public sealed partial class DataFusionSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private DataFusionSettings(DataFusionSettings existing) : base(existing)
        {
            ...
            AddDnsPeeringSettings = existing.AddDnsPeeringSettings;
            RemoveDnsPeeringSettings = existing.RemoveDnsPeeringSettings;
            ListDnsPeeringsSettings = existing.ListDnsPeeringsSettings;
            OnCopy(existing);
        }
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DataFusionClient.UpgradeInstance</c> and <c>DataFusionClient.UpgradeInstanceAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// <summary>
        /// Long Running Operation settings for calls to <c>DataFusionClient.UpgradeInstance</c> and
        /// <c>DataFusionClient.UpgradeInstanceAsync</c>.
        /// </summary>
        /// <remarks>
        /// Uses default <see cref="gax::PollSettings"/> of:
        /// <list type="bullet">
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DataFusionClient.RemoveIamPolicy</c> and <c>DataFusionClient.RemoveIamPolicyAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings RemoveIamPolicySettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DataFusionClient.ListNamespaces</c> and <c>DataFusionClient.ListNamespacesAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListNamespacesSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DataFusionClient.AddDnsPeering</c> and <c>DataFusionClient.AddDnsPeeringAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings AddDnsPeeringSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DataFusionClient.RemoveDnsPeering</c> and <c>DataFusionClient.RemoveDnsPeeringAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings RemoveDnsPeeringSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));

        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>DataFusionClient.ListDnsPeerings</c> and <c>DataFusionClient.ListDnsPeeringsAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListDnsPeeringsSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));
    ...
    public sealed partial class DataFusionClientBuilder : gaxgrpc::ClientBuilderBase<DataFusionClient>
    {
        ...
        private DataFusionClient BuildImpl()
        {
            ...
            return DataFusionClient.Create(callInvoker, Settings);
        }
        ...
        protected override string GetDefaultEndpoint() => DataFusionClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => DataFusionClient.DefaultScopes;
    ...
    public abstract partial class DataFusionClient
    {
        ...
        /// <returns>The created <see cref="DataFusionClient"/>.</returns>
        internal static DataFusionClient Create(grpccore::CallInvoker callInvoker, DataFusionSettings settings = null)
        {
            ...
            return new DataFusionClientImpl(grpcClient, settings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="Namespace"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListNamespacesResponse, Namespace> ListNamespaces(InstanceName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListNamespaces(new ListNamespacesRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="Namespace"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListNamespacesResponse, Namespace> ListNamespacesAsync(InstanceName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListNamespacesAsync(new ListNamespacesRequest
            {
                ParentAsInstanceName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual AddDnsPeeringResponse AddDnsPeering(AddDnsPeeringRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AddDnsPeeringResponse> AddDnsPeeringAsync(AddDnsPeeringRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AddDnsPeeringResponse> AddDnsPeeringAsync(AddDnsPeeringRequest request, st::CancellationToken cancellationToken) =>
            AddDnsPeeringAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual AddDnsPeeringResponse AddDnsPeering(string parent, gaxgrpc::CallSettings callSettings = null) =>
            AddDnsPeering(new AddDnsPeeringRequest { Parent = parent ?? "", }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AddDnsPeeringResponse> AddDnsPeeringAsync(string parent, gaxgrpc::CallSettings callSettings = null) =>
            AddDnsPeeringAsync(new AddDnsPeeringRequest { Parent = parent ?? "", }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<AddDnsPeeringResponse> AddDnsPeeringAsync(string parent, st::CancellationToken cancellationToken) =>
            AddDnsPeeringAsync(parent, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual RemoveDnsPeeringResponse RemoveDnsPeering(RemoveDnsPeeringRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<RemoveDnsPeeringResponse> RemoveDnsPeeringAsync(RemoveDnsPeeringRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<RemoveDnsPeeringResponse> RemoveDnsPeeringAsync(RemoveDnsPeeringRequest request, st::CancellationToken cancellationToken) =>
            RemoveDnsPeeringAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual RemoveDnsPeeringResponse RemoveDnsPeering(string parent, gaxgrpc::CallSettings callSettings = null) =>
            RemoveDnsPeering(new RemoveDnsPeeringRequest { Parent = parent ?? "", }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<RemoveDnsPeeringResponse> RemoveDnsPeeringAsync(string parent, gaxgrpc::CallSettings callSettings = null) =>
            RemoveDnsPeeringAsync(new RemoveDnsPeeringRequest { Parent = parent ?? "", }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<RemoveDnsPeeringResponse> RemoveDnsPeeringAsync(string parent, st::CancellationToken cancellationToken) =>
            RemoveDnsPeeringAsync(parent, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="request">The request object containing all of the parameters for the API call.</param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="DnsPeering"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListDnsPeeringsResponse, DnsPeering> ListDnsPeerings(ListDnsPeeringsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="request">The request object containing all of the parameters for the API call.</param>
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="DnsPeering"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListDnsPeeringsResponse, DnsPeering> ListDnsPeeringsAsync(ListDnsPeeringsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="DnsPeering"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListDnsPeeringsResponse, DnsPeering> ListDnsPeerings(string parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListDnsPeerings(new ListDnsPeeringsRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                PageToken = pageToken ?? "",
                PageSize = pageSize ?? 0,
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="DnsPeering"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListDnsPeeringsResponse, DnsPeering> ListDnsPeeringsAsync(string parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListDnsPeeringsAsync(new ListDnsPeeringsRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                PageToken = pageToken ?? "",
                PageSize = pageSize ?? 0,
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="DnsPeering"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListDnsPeeringsResponse, DnsPeering> ListDnsPeerings(InstanceName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListDnsPeerings(new ListDnsPeeringsRequest
            {
                ParentAsInstanceName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="DnsPeering"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListDnsPeeringsResponse, DnsPeering> ListDnsPeeringsAsync(InstanceName parent, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListDnsPeeringsAsync(new ListDnsPeeringsRequest
            {
                ParentAsInstanceName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                PageToken = pageToken ?? "",
    ...
    public sealed partial class DataFusionClientImpl : DataFusionClient
    {
        ...
        private readonly gaxgrpc::ApiCall<AddDnsPeeringRequest, AddDnsPeeringResponse> _callAddDnsPeering;

        private readonly gaxgrpc::ApiCall<RemoveDnsPeeringRequest, RemoveDnsPeeringResponse> _callRemoveDnsPeering;

        private readonly gaxgrpc::ApiCall<ListDnsPeeringsRequest, ListDnsPeeringsResponse> _callListDnsPeerings;
        ...
        public DataFusionClientImpl(DataFusion.DataFusionClient grpcClient, DataFusionSettings settings)
        {
            ...
            RestartInstanceOperationsClient = new lro::OperationsClientImpl(grpcClient.CreateOperationsClient(), effectiveSettings.RestartInstanceOperationsSettings);
            ...
            _callListAvailableVersions = clientHelper.BuildApiCall<ListAvailableVersionsRequest, ListAvailableVersionsResponse>(grpcClient.ListAvailableVersionsAsync, grpcClient.ListAvailableVersions, effectiveSettings.ListAvailableVersionsSettings).WithGoogleRequestParam("parent", request => request.Parent);
            ...
            _callRestartInstance = clientHelper.BuildApiCall<RestartInstanceRequest, lro::Operation>(grpcClient.RestartInstanceAsync, grpcClient.RestartInstance, effectiveSettings.RestartInstanceSettings).WithGoogleRequestParam("name", request => request.Name);
            ...
            _callRemoveIamPolicy = clientHelper.BuildApiCall<RemoveIamPolicyRequest, RemoveIamPolicyResponse>(grpcClient.RemoveIamPolicyAsync, grpcClient.RemoveIamPolicy, effectiveSettings.RemoveIamPolicySettings).WithGoogleRequestParam("resource", request => request.Resource);
            ...
            _callAddDnsPeering = clientHelper.BuildApiCall<AddDnsPeeringRequest, AddDnsPeeringResponse>(grpcClient.AddDnsPeeringAsync, grpcClient.AddDnsPeering, effectiveSettings.AddDnsPeeringSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callAddDnsPeering);
            Modify_AddDnsPeeringApiCall(ref _callAddDnsPeering);
            _callRemoveDnsPeering = clientHelper.BuildApiCall<RemoveDnsPeeringRequest, RemoveDnsPeeringResponse>(grpcClient.RemoveDnsPeeringAsync, grpcClient.RemoveDnsPeering, effectiveSettings.RemoveDnsPeeringSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callRemoveDnsPeering);
            Modify_RemoveDnsPeeringApiCall(ref _callRemoveDnsPeering);
            _callListDnsPeerings = clientHelper.BuildApiCall<ListDnsPeeringsRequest, ListDnsPeeringsResponse>(grpcClient.ListDnsPeeringsAsync, grpcClient.ListDnsPeerings, effectiveSettings.ListDnsPeeringsSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callListDnsPeerings);
            Modify_ListDnsPeeringsApiCall(ref _callListDnsPeerings);
        ...
        partial void Modify_AddDnsPeeringApiCall(ref gaxgrpc::ApiCall<AddDnsPeeringRequest, AddDnsPeeringResponse> call);

        partial void Modify_RemoveDnsPeeringApiCall(ref gaxgrpc::ApiCall<RemoveDnsPeeringRequest, RemoveDnsPeeringResponse> call);

        partial void Modify_ListDnsPeeringsApiCall(ref gaxgrpc::ApiCall<ListDnsPeeringsRequest, ListDnsPeeringsResponse> call);
        ...
        partial void Modify_AddDnsPeeringRequest(ref AddDnsPeeringRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_RemoveDnsPeeringRequest(ref RemoveDnsPeeringRequest request, ref gaxgrpc::CallSettings settings);

        partial void Modify_ListDnsPeeringsRequest(ref ListDnsPeeringsRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override AddDnsPeeringResponse AddDnsPeering(AddDnsPeeringRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_AddDnsPeeringRequest(ref request, ref callSettings);
            return _callAddDnsPeering.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<AddDnsPeeringResponse> AddDnsPeeringAsync(AddDnsPeeringRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_AddDnsPeeringRequest(ref request, ref callSettings);
            return _callAddDnsPeering.Async(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override RemoveDnsPeeringResponse RemoveDnsPeering(RemoveDnsPeeringRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_RemoveDnsPeeringRequest(ref request, ref callSettings);
            return _callRemoveDnsPeering.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<RemoveDnsPeeringResponse> RemoveDnsPeeringAsync(RemoveDnsPeeringRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_RemoveDnsPeeringRequest(ref request, ref callSettings);
            return _callRemoveDnsPeering.Async(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="DnsPeering"/> resources.</returns>
        public override gax::PagedEnumerable<ListDnsPeeringsResponse, DnsPeering> ListDnsPeerings(ListDnsPeeringsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListDnsPeeringsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedEnumerable<ListDnsPeeringsRequest, ListDnsPeeringsResponse, DnsPeering>(_callListDnsPeerings, request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="DnsPeering"/> resources.</returns>
        public override gax::PagedAsyncEnumerable<ListDnsPeeringsResponse, DnsPeering> ListDnsPeeringsAsync(ListDnsPeeringsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListDnsPeeringsRequest(ref request, ref callSettings);
            return new gaxgrpc::GrpcPagedAsyncEnumerable<ListDnsPeeringsRequest, ListDnsPeeringsResponse, DnsPeering>(_callListDnsPeerings, request, callSettings);
        }
    }
    ...
    public partial class ListDnsPeeringsRequest : gaxgrpc::IPageRequest
    {
    }
    ...
    public partial class ListDnsPeeringsResponse : gaxgrpc::IPageResponse<DnsPeering>
    {
        /// <summary>Returns an enumerator that iterates through the resources in this response.</summary>
        public scg::IEnumerator<DnsPeering> GetEnumerator() => DnsPeerings.GetEnumerator();
