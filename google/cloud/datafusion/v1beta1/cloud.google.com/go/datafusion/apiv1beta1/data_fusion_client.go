...
type CallOptions struct {
	...
	AddDnsPeering         []gax.CallOption
	RemoveDnsPeering      []gax.CallOption
	ListDnsPeerings       []gax.CallOption
}
...
type internalClient interface {
	...
	UpgradeInstance(context.Context, *datafusionpb.UpgradeInstanceRequest, ...gax.CallOption) (*UpgradeInstanceOperation, error)
	UpgradeInstanceOperation(name string) *UpgradeInstanceOperation
	RemoveIamPolicy(context.Context, *datafusionpb.RemoveIamPolicyRequest, ...gax.CallOption) (*datafusionpb.RemoveIamPolicyResponse, error)
	ListNamespaces(context.Context, *datafusionpb.ListNamespacesRequest, ...gax.CallOption) *NamespaceIterator
	AddDnsPeering(context.Context, *datafusionpb.AddDnsPeeringRequest, ...gax.CallOption) (*datafusionpb.AddDnsPeeringResponse, error)
	RemoveDnsPeering(context.Context, *datafusionpb.RemoveDnsPeeringRequest, ...gax.CallOption) (*datafusionpb.RemoveDnsPeeringResponse, error)
	ListDnsPeerings(context.Context, *datafusionpb.ListDnsPeeringsRequest, ...gax.CallOption) *DnsPeeringIterator
}
...
// UpgradeInstance upgrade a single Data Fusion instance.
// At the end of an operation instance is fully upgraded.
func (c *Client) UpgradeInstance(ctx context.Context, req *datafusionpb.UpgradeInstanceRequest, opts ...gax.CallOption) (*UpgradeInstanceOperation, error) {
...
func (c *Client) UpgradeInstanceOperation(name string) *UpgradeInstanceOperation {
...
func (c *Client) RemoveIamPolicy(ctx context.Context, req *datafusionpb.RemoveIamPolicyRequest, opts ...gax.CallOption) (*datafusionpb.RemoveIamPolicyResponse, error) {
	return c.internalClient.RemoveIamPolicy(ctx, req, opts...)
}

// ListNamespaces list namespaces in a given instance
func (c *Client) ListNamespaces(ctx context.Context, req *datafusionpb.ListNamespacesRequest, opts ...gax.CallOption) *NamespaceIterator {
	return c.internalClient.ListNamespaces(ctx, req, opts...)
}

// AddDnsPeering add DNS peering on the given resource.
func (c *Client) AddDnsPeering(ctx context.Context, req *datafusionpb.AddDnsPeeringRequest, opts ...gax.CallOption) (*datafusionpb.AddDnsPeeringResponse, error) {
	return c.internalClient.AddDnsPeering(ctx, req, opts...)
}

// RemoveDnsPeering remove DNS peering on the given resource.
func (c *Client) RemoveDnsPeering(ctx context.Context, req *datafusionpb.RemoveDnsPeeringRequest, opts ...gax.CallOption) (*datafusionpb.RemoveDnsPeeringResponse, error) {
	return c.internalClient.RemoveDnsPeering(ctx, req, opts...)
}

// ListDnsPeerings list DNS peering for a given resource.
func (c *Client) ListDnsPeerings(ctx context.Context, req *datafusionpb.ListDnsPeeringsRequest, opts ...gax.CallOption) *DnsPeeringIterator {
	return c.internalClient.ListDnsPeerings(ctx, req, opts...)
}
...
func (c *gRPCClient) UpgradeInstance(ctx context.Context, req *datafusionpb.UpgradeInstanceRequest, opts ...gax.CallOption) (*UpgradeInstanceOperation, error) {
	if _, ok := ctx.Deadline(); !ok && !c.disableDeadlines {
		cctx, cancel := context.WithTimeout(ctx, 60000*time.Millisecond)
		defer cancel()
		ctx = cctx
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.UpgradeInstance(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) RemoveIamPolicy(ctx context.Context, req *datafusionpb.RemoveIamPolicyRequest, opts ...gax.CallOption) (*datafusionpb.RemoveIamPolicyResponse, error) {
	if _, ok := ctx.Deadline(); !ok && !c.disableDeadlines {
		cctx, cancel := context.WithTimeout(ctx, 60000*time.Millisecond)
		defer cancel()
		ctx = cctx
	...
	var resp *datafusionpb.RemoveIamPolicyResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.RemoveIamPolicy(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) ListNamespaces(ctx context.Context, req *datafusionpb.ListNamespacesRequest, opts ...gax.CallOption) *NamespaceIterator {
	md := metadata.Pairs("x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent())))
	ctx = insertMetadata(ctx, c.xGoogMetadata, md)
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*datafusionpb.Namespace, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = c.client.ListNamespaces(ctx, req, settings.GRPC...)
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *gRPCClient) AddDnsPeering(ctx context.Context, req *datafusionpb.AddDnsPeeringRequest, opts ...gax.CallOption) (*datafusionpb.AddDnsPeeringResponse, error) {
	if _, ok := ctx.Deadline(); !ok && !c.disableDeadlines {
		cctx, cancel := context.WithTimeout(ctx, 60000*time.Millisecond)
		defer cancel()
		ctx = cctx
	...
	md := metadata.Pairs("x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent())))
	ctx = insertMetadata(ctx, c.xGoogMetadata, md)
	opts = append((*c.CallOptions).AddDnsPeering[0:len((*c.CallOptions).AddDnsPeering):len((*c.CallOptions).AddDnsPeering)], opts...)
	var resp *datafusionpb.AddDnsPeeringResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.AddDnsPeering(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) RemoveDnsPeering(ctx context.Context, req *datafusionpb.RemoveDnsPeeringRequest, opts ...gax.CallOption) (*datafusionpb.RemoveDnsPeeringResponse, error) {
	if _, ok := ctx.Deadline(); !ok && !c.disableDeadlines {
		cctx, cancel := context.WithTimeout(ctx, 60000*time.Millisecond)
		defer cancel()
		ctx = cctx
	...
	md := metadata.Pairs("x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent())))
	ctx = insertMetadata(ctx, c.xGoogMetadata, md)
	opts = append((*c.CallOptions).RemoveDnsPeering[0:len((*c.CallOptions).RemoveDnsPeering):len((*c.CallOptions).RemoveDnsPeering)], opts...)
	var resp *datafusionpb.RemoveDnsPeeringResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.RemoveDnsPeering(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) ListDnsPeerings(ctx context.Context, req *datafusionpb.ListDnsPeeringsRequest, opts ...gax.CallOption) *DnsPeeringIterator {
	md := metadata.Pairs("x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent())))
	ctx = insertMetadata(ctx, c.xGoogMetadata, md)
	opts = append((*c.CallOptions).ListDnsPeerings[0:len((*c.CallOptions).ListDnsPeerings):len((*c.CallOptions).ListDnsPeerings)], opts...)
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*datafusionpb.DnsPeering, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = c.client.ListDnsPeerings(ctx, req, settings.GRPC...)
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
		...
		it.Response = resp
		return resp.GetDnsPeerings(), resp.GetNextPageToken(), nil
	}
	fetch := func(pageSize int, pageToken string) (string, error) {
		items, nextPageToken, err := it.InternalFetch(pageSize, pageToken)
		if err != nil {
...
// UpgradeInstanceOperation returns a new UpgradeInstanceOperation from a given name.
// The name must be that of a previously created UpgradeInstanceOperation, possibly from a different process.
func (c *gRPCClient) UpgradeInstanceOperation(name string) *UpgradeInstanceOperation {
	return &UpgradeInstanceOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
//
// See documentation of Poll for error-handling information.
func (op *UpgradeInstanceOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*datafusionpb.Instance, error) {
	var resp datafusionpb.Instance
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *UpgradeInstanceOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*datafusionpb.Instance, error) {
	var resp datafusionpb.Instance
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
	}
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *UpgradeInstanceOperation) Metadata() (*datafusionpb.OperationMetadata, error) {
	var meta datafusionpb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// DnsPeeringIterator manages a stream of *datafusionpb.DnsPeering.
type DnsPeeringIterator struct {
	items    []*datafusionpb.DnsPeering
	...
	InternalFetch func(pageSize int, pageToken string) (results []*datafusionpb.DnsPeering, nextPageToken string, err error)
}

// PageInfo supports pagination. See the google.golang.org/api/iterator package for details.
func (it *DnsPeeringIterator) PageInfo() *iterator.PageInfo {
	return it.pageInfo
}

// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *DnsPeeringIterator) Next() (*datafusionpb.DnsPeering, error) {
	var item *datafusionpb.DnsPeering
...
func (it *DnsPeeringIterator) bufLen() int {
	return len(it.items)
}

func (it *DnsPeeringIterator) takeBuf() interface{} {
	b := it.items
	it.items = nil
	return b
}
...
// NamespaceIterator manages a stream of *datafusionpb.Namespace.
type NamespaceIterator struct {
	items    []*datafusionpb.Namespace
	pageInfo *iterator.PageInfo
	nextFunc func() error
	...
	// The number of results is no greater than pageSize.
	// If there are no more results, nextPageToken is empty and err is nil.
	InternalFetch func(pageSize int, pageToken string) (results []*datafusionpb.Namespace, nextPageToken string, err error)
}
...
// Next returns the next result. Its second return value is iterator.Done if there are no more
// results. Once Next returns Done, all subsequent calls will return Done.
func (it *NamespaceIterator) Next() (*datafusionpb.Namespace, error) {
	var item *datafusionpb.Namespace
	if err := it.nextFunc(); err != nil {
		return item, err
	}
	item = it.items[0]
