...
class ::Google::Cloud::DataFusion::V1beta1::DataFusion::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::DataFusion::V1beta1::DataFusion::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::DataFusion::V1beta1::DataFusion::Operations::Configuration, config
  end
end
