# Ruby Client for the Cloud Data Fusion V1beta1 API

API Client library for the Cloud Data Fusion V1beta1 API
...
specific version of the Cloud Data Fusion V1beta1 API. Most users should consider using
the main client gem,
[google-cloud-data_fusion](https://rubygems.org/gems/google-cloud-data_fusion).
See the section below titled *Which client should I use?* for more information.

## Installation

```
$ gem install google-cloud-data_fusion-v1beta1
```
...
View the [Client Library Documentation](https://googleapis.dev/ruby/google-cloud-data_fusion-v1beta1/latest)
...
client library with a name such as `google-cloud-data_fusion`,
and lower-level _versioned_ client libraries with names such as
`google-cloud-data_fusion-v1beta1`.
...
is part of the name, e.g. `google-cloud-data_fusion-v1beta1`.
