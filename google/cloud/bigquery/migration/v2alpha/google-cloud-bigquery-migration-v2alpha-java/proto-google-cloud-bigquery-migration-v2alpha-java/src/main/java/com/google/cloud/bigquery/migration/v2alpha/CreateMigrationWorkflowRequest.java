...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            com.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow.Builder subBuilder = null;
            if (migrationWorkflow_ != null) {
              subBuilder = migrationWorkflow_.toBuilder();
            }
            migrationWorkflow_ = input.readMessage(com.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.bigquery.migration.v2alpha.CreateMigrationWorkflowRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.bigquery.migration.v2alpha.CreateMigrationWorkflowRequest) e.getUnfinishedMessage();
