...
public class MigrationWorkflowName implements ResourceName {
  ...
  @Deprecated
  protected MigrationWorkflowName() {
    project = null;
    location = null;
    workflow = null;
  }

  private MigrationWorkflowName(Builder builder) {
  ...
  public static MigrationWorkflowName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_WORKFLOW.validatedMatch(
            formattedString, "MigrationWorkflowName.parse: formattedString not in valid format");
  ...
  public static List<MigrationWorkflowName> parseList(List<String> formattedStrings) {
    List<MigrationWorkflowName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<MigrationWorkflowName> values) {
    ...
    for (MigrationWorkflowName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      MigrationWorkflowName that = ((MigrationWorkflowName) o);
  ...
  public static class Builder {
    ...
    public MigrationWorkflowName build() {
      return new MigrationWorkflowName(this);
    }
  }
}
