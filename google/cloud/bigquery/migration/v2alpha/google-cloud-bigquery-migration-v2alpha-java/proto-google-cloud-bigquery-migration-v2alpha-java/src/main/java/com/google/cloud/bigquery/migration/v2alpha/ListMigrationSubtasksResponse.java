...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              migrationSubtasks_ = new java.util.ArrayList<com.google.cloud.bigquery.migration.v2alpha.MigrationSubtask>();
              mutable_bitField0_ |= 0x00000001;
            }
            migrationSubtasks_.add(
                input.readMessage(com.google.cloud.bigquery.migration.v2alpha.MigrationSubtask.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.bigquery.migration.v2alpha.ListMigrationSubtasksResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.bigquery.migration.v2alpha.ListMigrationSubtasksResponse) e.getUnfinishedMessage();
