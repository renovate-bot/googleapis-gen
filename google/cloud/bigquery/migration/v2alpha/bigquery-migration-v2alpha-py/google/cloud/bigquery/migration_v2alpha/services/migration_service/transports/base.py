...
class MigrationServiceTransport(abc.ABC):
    ...
    @property
    def create_migration_workflow(self) -> typing.Callable[
            [migration_service.CreateMigrationWorkflowRequest],
            typing.Union[
                migration_entities.MigrationWorkflow,
                typing.Awaitable[migration_entities.MigrationWorkflow]
            ]]:
        raise NotImplementedError()

    @property
    def get_migration_workflow(self) -> typing.Callable[
    ...
    @property
    def list_migration_workflows(self) -> typing.Callable[
            [migration_service.ListMigrationWorkflowsRequest],
            typing.Union[
                migration_service.ListMigrationWorkflowsResponse,
                typing.Awaitable[migration_service.ListMigrationWorkflowsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def delete_migration_workflow(self) -> typing.Callable[
    ...
    @property
    def start_migration_workflow(self) -> typing.Callable[
    ...
    @property
    def get_migration_subtask(self) -> typing.Callable[
            [migration_service.GetMigrationSubtaskRequest],
            typing.Union[
                migration_entities.MigrationSubtask,
                typing.Awaitable[migration_entities.MigrationSubtask]
            ]]:
        raise NotImplementedError()

    @property
    def list_migration_subtasks(self) -> typing.Callable[
            [migration_service.ListMigrationSubtasksRequest],
            typing.Union[
                migration_service.ListMigrationSubtasksResponse,
                typing.Awaitable[migration_service.ListMigrationSubtasksResponse]
            ]]:
        raise NotImplementedError()
