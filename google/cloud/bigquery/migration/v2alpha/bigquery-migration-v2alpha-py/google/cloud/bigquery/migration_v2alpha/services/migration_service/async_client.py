...
class MigrationServiceAsyncClient:
    ...
    async def create_migration_workflow(self,
    ...
    async def get_migration_workflow(self,
    ...
    async def list_migration_workflows(self,
    ...
    async def delete_migration_workflow(self,
    ...
    async def start_migration_workflow(self,
    ...
    async def get_migration_subtask(self,
    ...
    async def list_migration_subtasks(self,
