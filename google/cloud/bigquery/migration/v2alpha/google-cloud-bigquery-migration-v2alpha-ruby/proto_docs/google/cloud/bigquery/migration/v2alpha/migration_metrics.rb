    ...
    module Bigquery
      module Migration
        module V2alpha
          ...
          # @!attribute [rw] points
          #   @return [::Array<::Google::Cloud::Bigquery::Migration::V2alpha::Point>]
          ...
          #   @return [::Google::Cloud::Bigquery::Migration::V2alpha::TimeInterval]
          ...
          #     points.
          # @!attribute [rw] value
          #   @return [::Google::Cloud::Bigquery::Migration::V2alpha::TypedValue]
