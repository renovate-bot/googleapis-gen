    ...
    module Bigquery
      module Migration
        module V2alpha
          ...
          # @!attribute [rw] tasks
          #   @return [::Google::Protobuf::Map{::String => ::Google::Cloud::Bigquery::Migration::V2alpha::MigrationTask}]
          ...
          #     in a workflow.
          # @!attribute [r] state
          #   @return [::Google::Cloud::Bigquery::Migration::V2alpha::MigrationWorkflow::State]
          ...
          class MigrationWorkflow
            ...
            #   @return [::String]
            # @!attribute [rw] value
            #   @return [::Google::Cloud::Bigquery::Migration::V2alpha::MigrationTask]
            class TasksEntry
              include ::Google::Protobuf::MessageExts
              extend ::Google::Protobuf::MessageExts::ClassMethods
            end
          ...
          # @!attribute [r] state
          #   @return [::Google::Cloud::Bigquery::Migration::V2alpha::MigrationTask::State]
          ...
          # @!attribute [r] state
          #   @return [::Google::Cloud::Bigquery::Migration::V2alpha::MigrationSubtask::State]
          #     Output only. The current state of the subtask.
          # @!attribute [r] processing_error
          #   @return [::Google::Rpc::ErrorInfo]
          #     Output only. An explanation that may be populated when the task is in FAILED state.
          # @!attribute [r] resource_error_details
          #   @return [::Array<::Google::Cloud::Bigquery::Migration::V2alpha::ResourceErrorDetail>]
          ...
          #   @return [::Array<::Google::Cloud::Bigquery::Migration::V2alpha::TimeSeries>]
