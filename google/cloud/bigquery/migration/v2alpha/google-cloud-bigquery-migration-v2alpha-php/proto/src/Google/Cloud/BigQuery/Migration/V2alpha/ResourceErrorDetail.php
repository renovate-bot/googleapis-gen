 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.migration.v2alpha.ResourceErrorDetail</code>
 */
class ResourceErrorDetail extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.bigquery.migration.v2alpha.ErrorDetail error_details = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. Information about the resource where the error is located.
     *     @type \Google\Cloud\BigQuery\Migration\V2alpha\ErrorDetail[]|\Google\Protobuf\Internal\RepeatedField $error_details
     *           Required. The error details for the resource.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.bigquery.migration.v2alpha.ErrorDetail error_details = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\BigQuery\Migration\V2alpha\ErrorDetail[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setErrorDetails($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\BigQuery\Migration\V2alpha\ErrorDetail::class);
