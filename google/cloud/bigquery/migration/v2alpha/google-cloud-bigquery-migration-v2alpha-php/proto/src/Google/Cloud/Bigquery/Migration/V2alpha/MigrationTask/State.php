...
namespace Google\Cloud\Bigquery\Migration\V2alpha\MigrationTask;
 ...
 *
 * Protobuf type <code>google.cloud.bigquery.migration.v2alpha.MigrationTask.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Bigquery\Migration\V2alpha\MigrationTask_State::class);
