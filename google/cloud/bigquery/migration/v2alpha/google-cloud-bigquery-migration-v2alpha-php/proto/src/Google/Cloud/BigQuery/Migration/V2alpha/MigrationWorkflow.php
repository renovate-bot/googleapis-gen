 ...
 * migration.
 *
 * Generated from protobuf message <code>google.cloud.bigquery.migration.v2alpha.MigrationWorkflow</code>
 */
class MigrationWorkflow extends \Google\Protobuf\Internal\Message
{
     ...
     * in a workflow.
     *
     * Generated from protobuf field <code>map<string, .google.cloud.bigquery.migration.v2alpha.MigrationTask> tasks = 2;</code>
     */
    private $tasks;
    /**
     * Output only. That status of the workflow.
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\BigQuery\Migration\V2alpha\MigrationTask::class);
        $this->tasks = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BigQuery\Migration\V2alpha\MigrationWorkflow\State::class);
        $this->state = $var;
