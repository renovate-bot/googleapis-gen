 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.migration.v2alpha.CreateMigrationWorkflowRequest</code>
 */
class CreateMigrationWorkflowRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow migration_workflow = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The name of the project to which this migration workflow belongs.
     *           Example: `projects/foo/locations/bar`
     *     @type \Google\Cloud\BigQuery\Migration\V2alpha\MigrationWorkflow $migration_workflow
     *           Required. The migration workflow to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow migration_workflow = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\BigQuery\Migration\V2alpha\MigrationWorkflow|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow migration_workflow = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\BigQuery\Migration\V2alpha\MigrationWorkflow $var
     * @return $this
     */
    public function setMigrationWorkflow($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BigQuery\Migration\V2alpha\MigrationWorkflow::class);
