...
namespace Google\Cloud\BigQuery\Migration\V2alpha\MigrationWorkflow;
 ...
 *
 * Protobuf type <code>google.cloud.bigquery.migration.v2alpha.MigrationWorkflow.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\BigQuery\Migration\V2alpha\MigrationWorkflow_State::class);
