 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.migration.v2alpha.TimeSeries</code>
 */
class TimeSeries extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.bigquery.migration.v2alpha.Point points = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $points;
     ...
     *           this field specifies the metric kind of the new descriptor and must be
     *           either `GAUGE` (the default) or `CUMULATIVE`.
     *     @type \Google\Cloud\Bigquery\Migration\V2alpha\Point[]|\Google\Protobuf\Internal\RepeatedField $points
     *           Required. The data points of this time series. When listing time series, points are
     *           returned in reverse time order.
     *           When creating a time series, this field must contain exactly one point and
     *           the point's type must be the same as the value type of the associated
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.bigquery.migration.v2alpha.Point points = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Bigquery\Migration\V2alpha\Point[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPoints($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Bigquery\Migration\V2alpha\Point::class);
        $this->points = $arr;
