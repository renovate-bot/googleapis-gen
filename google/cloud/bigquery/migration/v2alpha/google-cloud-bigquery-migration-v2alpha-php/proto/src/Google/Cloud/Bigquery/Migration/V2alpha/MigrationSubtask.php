 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.migration.v2alpha.MigrationSubtask</code>
 */
class MigrationSubtask extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.migration.v2alpha.MigrationSubtask.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.bigquery.migration.v2alpha.ResourceErrorDetail resource_error_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.bigquery.migration.v2alpha.TimeSeries metrics = 11;</code>
     */
    private $metrics;
     ...
     *           Output only. An explanation that may be populated when the task is in FAILED state.
     *     @type \Google\Cloud\Bigquery\Migration\V2alpha\ResourceErrorDetail[]|\Google\Protobuf\Internal\RepeatedField $resource_error_details
     *           Output only. Provides details to errors and issues encountered while processing the
     *           subtask. Presence of error details does not mean that the subtask failed.
     ...
     *           Time when the subtask was last updated.
     *     @type \Google\Cloud\Bigquery\Migration\V2alpha\TimeSeries[]|\Google\Protobuf\Internal\RepeatedField $metrics
     *           The metrics for the subtask.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Bigquery\Migration\V2alpha\MigrationSubtask\State::class);
        $this->state = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.bigquery.migration.v2alpha.ResourceErrorDetail resource_error_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Bigquery\Migration\V2alpha\ResourceErrorDetail[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResourceErrorDetails($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Bigquery\Migration\V2alpha\ResourceErrorDetail::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.bigquery.migration.v2alpha.TimeSeries metrics = 11;</code>
     * @param \Google\Cloud\Bigquery\Migration\V2alpha\TimeSeries[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMetrics($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Bigquery\Migration\V2alpha\TimeSeries::class);
        $this->metrics = $arr;
