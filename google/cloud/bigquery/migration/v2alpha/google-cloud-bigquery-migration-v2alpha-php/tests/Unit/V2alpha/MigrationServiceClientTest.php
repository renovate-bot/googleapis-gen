...
class MigrationServiceClientTest extends GeneratedTest
{
    ...
    public function createMigrationWorkflowTest()
    {
        ...
        $response = $client->createMigrationWorkflow($formattedParent, $migrationWorkflow);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.migration.v2alpha.MigrationService/CreateMigrationWorkflow', $actualFuncCall);
    ...
    public function createMigrationWorkflowExceptionTest()
    {
        ...
        $migrationWorkflow = new MigrationWorkflow();
        try {
            $client->createMigrationWorkflow($formattedParent, $migrationWorkflow);
    ...
    public function deleteMigrationWorkflowTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->migrationWorkflowName('[PROJECT]', '[LOCATION]', '[WORKFLOW]');
        $client->deleteMigrationWorkflow($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.migration.v2alpha.MigrationService/DeleteMigrationWorkflow', $actualFuncCall);
    ...
    public function getMigrationSubtaskTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->migrationSubtaskName('[PROJECT]', '[LOCATION]', '[WORKFLOW]', '[SUBTASK]');
        $response = $client->getMigrationSubtask($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.migration.v2alpha.MigrationService/GetMigrationSubtask', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getMigrationSubtaskExceptionTest()
    {
        ...
        $formattedName = $client->migrationSubtaskName('[PROJECT]', '[LOCATION]', '[WORKFLOW]', '[SUBTASK]');
        try {
            $client->getMigrationSubtask($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getMigrationWorkflowTest()
    {
        ...
        // Mock request
        $formattedName = $client->migrationWorkflowName('[PROJECT]', '[LOCATION]', '[WORKFLOW]');
        $response = $client->getMigrationWorkflow($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.migration.v2alpha.MigrationService/GetMigrationWorkflow', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getMigrationWorkflowExceptionTest()
    {
        ...
        $formattedName = $client->migrationWorkflowName('[PROJECT]', '[LOCATION]', '[WORKFLOW]');
        try {
            $client->getMigrationWorkflow($formattedName);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listMigrationSubtasksTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $client->migrationWorkflowName('[PROJECT]', '[LOCATION]', '[WORKFLOW]');
        $response = $client->listMigrationSubtasks($formattedParent);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.migration.v2alpha.MigrationService/ListMigrationSubtasks', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listMigrationSubtasksExceptionTest()
    {
        ...
        $formattedParent = $client->migrationWorkflowName('[PROJECT]', '[LOCATION]', '[WORKFLOW]');
        try {
            $client->listMigrationSubtasks($formattedParent);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listMigrationWorkflowsTest()
    {
        ...
        // Mock request
        $formattedParent = $client->locationName('[PROJECT]', '[LOCATION]');
        $response = $client->listMigrationWorkflows($formattedParent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.migration.v2alpha.MigrationService/ListMigrationWorkflows', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listMigrationWorkflowsExceptionTest()
    {
        ...
        $formattedParent = $client->locationName('[PROJECT]', '[LOCATION]');
        try {
            $client->listMigrationWorkflows($formattedParent);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function startMigrationWorkflowTest()
    {
        ...
        // Mock request
        $formattedName = $client->migrationWorkflowName('[PROJECT]', '[LOCATION]', '[WORKFLOW]');
        $client->startMigrationWorkflow($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.migration.v2alpha.MigrationService/StartMigrationWorkflow', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
