...
namespace Google.Cloud.BigQuery.Migration.V2Alpha
{
    ...
    public sealed partial class MigrationServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings GetMigrationSubtaskSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(120000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 5, initialBackoff: sys::TimeSpan.FromMilliseconds(1000), maxBackoff: sys::TimeSpan.FromMilliseconds(10000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable)));
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings ListMigrationSubtasksSettings { get; set; } = gaxgrpc::CallSettingsExtensions.WithRetry(gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(120000))), gaxgrpc::RetrySettings.FromExponentialBackoff(maxAttempts: 5, initialBackoff: sys::TimeSpan.FromMilliseconds(1000), maxBackoff: sys::TimeSpan.FromMilliseconds(10000), backoffMultiplier: 1.3, retryFilter: gaxgrpc::RetrySettings.FilterForStatusCodes(grpccore::StatusCode.Unavailable)));
    ...
    public sealed partial class MigrationServiceClientImpl : MigrationServiceClient
    {
        ...
        public MigrationServiceClientImpl(MigrationService.MigrationServiceClient grpcClient, MigrationServiceSettings settings)
        {
            ...
            _callCreateMigrationWorkflow = clientHelper.BuildApiCall<CreateMigrationWorkflowRequest, MigrationWorkflow>(grpcClient.CreateMigrationWorkflowAsync, grpcClient.CreateMigrationWorkflow, effectiveSettings.CreateMigrationWorkflowSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callCreateMigrationWorkflow);
            Modify_CreateMigrationWorkflowApiCall(ref _callCreateMigrationWorkflow);
            _callGetMigrationWorkflow = clientHelper.BuildApiCall<GetMigrationWorkflowRequest, MigrationWorkflow>(grpcClient.GetMigrationWorkflowAsync, grpcClient.GetMigrationWorkflow, effectiveSettings.GetMigrationWorkflowSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callGetMigrationWorkflow);
            Modify_GetMigrationWorkflowApiCall(ref _callGetMigrationWorkflow);
            _callListMigrationWorkflows = clientHelper.BuildApiCall<ListMigrationWorkflowsRequest, ListMigrationWorkflowsResponse>(grpcClient.ListMigrationWorkflowsAsync, grpcClient.ListMigrationWorkflows, effectiveSettings.ListMigrationWorkflowsSettings).WithGoogleRequestParam("parent", request => request.Parent);
            Modify_ApiCall(ref _callListMigrationWorkflows);
            Modify_ListMigrationWorkflowsApiCall(ref _callListMigrationWorkflows);
            _callDeleteMigrationWorkflow = clientHelper.BuildApiCall<DeleteMigrationWorkflowRequest, wkt::Empty>(grpcClient.DeleteMigrationWorkflowAsync, grpcClient.DeleteMigrationWorkflow, effectiveSettings.DeleteMigrationWorkflowSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callDeleteMigrationWorkflow);
            Modify_DeleteMigrationWorkflowApiCall(ref _callDeleteMigrationWorkflow);
            _callStartMigrationWorkflow = clientHelper.BuildApiCall<StartMigrationWorkflowRequest, wkt::Empty>(grpcClient.StartMigrationWorkflowAsync, grpcClient.StartMigrationWorkflow, effectiveSettings.StartMigrationWorkflowSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callStartMigrationWorkflow);
            Modify_StartMigrationWorkflowApiCall(ref _callStartMigrationWorkflow);
            _callGetMigrationSubtask = clientHelper.BuildApiCall<GetMigrationSubtaskRequest, MigrationSubtask>(grpcClient.GetMigrationSubtaskAsync, grpcClient.GetMigrationSubtask, effectiveSettings.GetMigrationSubtaskSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callGetMigrationSubtask);
            Modify_GetMigrationSubtaskApiCall(ref _callGetMigrationSubtask);
            _callListMigrationSubtasks = clientHelper.BuildApiCall<ListMigrationSubtasksRequest, ListMigrationSubtasksResponse>(grpcClient.ListMigrationSubtasksAsync, grpcClient.ListMigrationSubtasks, effectiveSettings.ListMigrationSubtasksSettings).WithGoogleRequestParam("parent", request => request.Parent);
