...
class CapacityCommitment(proto.Message):
    ...
    Attributes:
        ...
        plan (google.cloud.bigquery.reservation_v1beta1.types.CapacityCommitment.CommitmentPlan):
            Capacity commitment commitment plan.
        state (google.cloud.bigquery.reservation_v1beta1.types.CapacityCommitment.State):
        ...
        renewal_plan (google.cloud.bigquery.reservation_v1beta1.types.CapacityCommitment.CommitmentPlan):
...
class ListReservationsRequest(proto.Message):
    ...
    Attributes:
        ...
        page_token (str):
            ...
            request, if any.
        filter (str):
            Can be used to filter out reservations based on names,
            capacity, etc, e.g.: filter="reservation.slot_capacity >
            200" filter="reservation.name = "*dev/*"" Advanced filtering
            syntax can be
            `here <https://cloud.google.com/logging/docs/view/advanced-filters>`__.
    """
...
class ListReservationsResponse(proto.Message):
    ...
    Attributes:
        reservations (Sequence[google.cloud.bigquery.reservation_v1beta1.types.Reservation]):
...
class ListCapacityCommitmentsResponse(proto.Message):
    ...
    Attributes:
        capacity_commitments (Sequence[google.cloud.bigquery.reservation_v1beta1.types.CapacityCommitment]):
...
class SplitCapacityCommitmentResponse(proto.Message):
    ...
    Attributes:
        first (google.cloud.bigquery.reservation_v1beta1.types.CapacityCommitment):
            First capacity commitment, result of a split.
        second (google.cloud.bigquery.reservation_v1beta1.types.CapacityCommitment):
...
class Assignment(proto.Message):
    ...
    Attributes:
        ...
        assignee (str):
            ...
            ``organizations/456``.
        job_type (google.cloud.bigquery.reservation_v1beta1.types.Assignment.JobType):
            Which type of jobs will use the reservation.
        state (google.cloud.bigquery.reservation_v1beta1.types.Assignment.State):
...
class ListAssignmentsResponse(proto.Message):
    ...
    Attributes:
        assignments (Sequence[google.cloud.bigquery.reservation_v1beta1.types.Assignment]):
