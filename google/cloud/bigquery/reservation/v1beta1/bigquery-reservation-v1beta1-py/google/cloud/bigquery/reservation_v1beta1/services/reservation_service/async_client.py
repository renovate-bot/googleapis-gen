...
class ReservationServiceAsyncClient:
    ...
    async def list_reservations(self,
        ...
        Returns:
            google.cloud.bigquery.reservation_v1beta1.services.reservation_service.pagers.ListReservationsAsyncPager:
                The response for
                   [ReservationService.ListReservations][google.cloud.bigquery.reservation.v1beta1.ReservationService.ListReservations].
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_capacity_commitments(self,
        ...
        Returns:
            google.cloud.bigquery.reservation_v1beta1.services.reservation_service.pagers.ListCapacityCommitmentsAsyncPager:
                The response for
                   [ReservationService.ListCapacityCommitments][google.cloud.bigquery.reservation.v1beta1.ReservationService.ListCapacityCommitments].
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def create_assignment(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            assignment (:class:`google.cloud.bigquery.reservation_v1beta1.types.Assignment`):
    ...
    async def list_assignments(self,
        ...
        **Note** "-" cannot be used for projects nor locations.
        ...
        Returns:
            google.cloud.bigquery.reservation_v1beta1.services.reservation_service.pagers.ListAssignmentsAsyncPager:
                The response for
                   [ReservationService.ListAssignments][google.cloud.bigquery.reservation.v1beta1.ReservationService.ListAssignments].
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def search_assignments(self,
        ...
        **Note** "-" cannot be used for projects nor locations.
        ...
        Returns:
            google.cloud.bigquery.reservation_v1beta1.services.reservation_service.pagers.SearchAssignmentsAsyncPager:
                The response for
                   [ReservationService.SearchAssignments][google.cloud.bigquery.reservation.v1beta1.ReservationService.SearchAssignments].
