...
namespace Google.Cloud.Bigquery.Reservation.V1Beta1
{
    ...
    public abstract partial class ReservationServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual BiReservation UpdateBiReservation(BiReservation reservation, wkt::FieldMask updateMask, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BiReservation> UpdateBiReservationAsync(BiReservation reservation, wkt::FieldMask updateMask, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<BiReservation> UpdateBiReservationAsync(BiReservation reservation, wkt::FieldMask updateMask, st::CancellationToken cancellationToken) =>
            UpdateBiReservationAsync(reservation, updateMask, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    }
    ...
    public sealed partial class ReservationServiceClientImpl : ReservationServiceClient
    {
        ...
        public ReservationServiceClientImpl(ReservationService.ReservationServiceClient grpcClient, ReservationServiceSettings settings)
        {
            ...
            _callUpdateBiReservation = clientHelper.BuildApiCall<UpdateBiReservationRequest, BiReservation>(grpcClient.UpdateBiReservationAsync, grpcClient.UpdateBiReservation, effectiveSettings.UpdateBiReservationSettings).WithGoogleRequestParam("reservation.name", request => request.Reservation?.Name);
