...
using gcbrv = Google.Cloud.Bigquery.Reservation.V1Beta1;
using sys = System;
...
namespace Google.Cloud.Bigquery.Reservation.V1Beta1
{
    ...
    public sealed partial class BiReservationName : gax::IResourceName, sys::IEquatable<BiReservationName>
    {
        ...
        public enum ResourceNameType
        {
            ...
            /// <summary>
            /// A resource name with pattern <c>projects/{project}/locations/{location}/bireservation/{bireservation}</c>
            /// .
            /// </summary>
            ProjectLocationBireservation = 1,
        }

        private static gax::PathTemplate s_projectLocationBireservation = new gax::PathTemplate("projects/{project}/locations/{location}/bireservation/{bireservation}");
        ...
        /// <c>projects/{project}/locations/{location}/bireservation/{bireservation}</c>.
        /// </summary>
        /// <param name="projectId">The <c>Project</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="bireservationId">The <c>Bireservation</c> ID. Must not be <c>null</c> or empty.</param>
        /// <returns>A new instance of <see cref="BiReservationName"/> constructed from the provided ids.</returns>
        public static BiReservationName FromProjectLocationBireservation(string projectId, string locationId, string bireservationId) =>
            new BiReservationName(ResourceNameType.ProjectLocationBireservation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), bireservationId: gax::GaxPreconditions.CheckNotNullOrEmpty(bireservationId, nameof(bireservationId)));
        ...
        /// <c>projects/{project}/locations/{location}/bireservation/{bireservation}</c>.
        /// </returns>
        public static string Format(string projectId, string locationId, string bireservationId) =>
            FormatProjectLocationBireservation(projectId, locationId, bireservationId);
        ...
        /// <c>projects/{project}/locations/{location}/bireservation/{bireservation}</c>.
        /// </returns>
        public static string FormatProjectLocationBireservation(string projectId, string locationId, string bireservationId) =>
            s_projectLocationBireservation.Expand(gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), gax::GaxPreconditions.CheckNotNullOrEmpty(bireservationId, nameof(bireservationId)));
        ...
        /// <list type="bullet">
        /// <item>
        /// <description><c>projects/{project}/locations/{location}/bireservation/{bireservation}</c></description>
        /// </item>
        /// </list>
        /// </remarks>
        ...
        public static bool TryParse(string biReservationName, bool allowUnparsed, out BiReservationName result)
        {
            ...
            gax::TemplatedResourceName resourceName;
            if (s_projectLocationBireservation.TryParseName(biReservationName, out resourceName))
            {
                result = FromProjectLocationBireservation(resourceName[0], resourceName[1], resourceName[2]);
                return true;
            }
            if (allowUnparsed)
            {
        ...
        private BiReservationName(ResourceNameType type, gax::UnparsedResourceName unparsedResourceName = null, string bireservationId = null, string locationId = null, string projectId = null)
        {
            Type = type;
            UnparsedResource = unparsedResourceName;
            BireservationId = bireservationId;
            LocationId = locationId;
            ProjectId = projectId;
        }
        ...
        /// <param name="locationId">The <c>Location</c> ID. Must not be <c>null</c> or empty.</param>
        /// <param name="bireservationId">The <c>Bireservation</c> ID. Must not be <c>null</c> or empty.</param>
        public BiReservationName(string projectId, string locationId, string bireservationId) : this(ResourceNameType.ProjectLocationBireservation, projectId: gax::GaxPreconditions.CheckNotNullOrEmpty(projectId, nameof(projectId)), locationId: gax::GaxPreconditions.CheckNotNullOrEmpty(locationId, nameof(locationId)), bireservationId: gax::GaxPreconditions.CheckNotNullOrEmpty(bireservationId, nameof(bireservationId)))
        {
        }
        ...
        /// <summary>
        /// The <c>Bireservation</c> ID. Will not be <c>null</c>, unless this instance contains an unparsed resource
        /// name.
        /// </summary>
        public string BireservationId { get; }
        ...
        public override string ToString()
        {
            ...
            {
                case ResourceNameType.Unparsed: return UnparsedResource.ToString();
                case ResourceNameType.ProjectLocationBireservation: return s_projectLocationBireservation.Expand(ProjectId, LocationId, BireservationId);
                default: throw new sys::InvalidOperationException("Unrecognized resource-type.");
            }
        }
