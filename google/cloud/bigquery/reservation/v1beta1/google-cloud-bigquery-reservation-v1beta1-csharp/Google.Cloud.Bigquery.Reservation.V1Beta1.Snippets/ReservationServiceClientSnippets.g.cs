...
namespace Google.Cloud.Bigquery.Reservation.V1Beta1.Snippets
{
    ...
    public sealed class GeneratedReservationServiceClientSnippets
    {
        ...
        public void GetBiReservation()
        {
            ...
            ReservationServiceClient reservationServiceClient = ReservationServiceClient.Create();
            // Initialize request argument(s)
            string name = "projects/[PROJECT]/locations/[LOCATION]/bireservation/[BIRESERVATION]";
            // Make the request
        ...
        public void UpdateBiReservation()
        {
            ...
            FieldMask updateMask = new FieldMask();
            // Make the request
            BiReservation response = reservationServiceClient.UpdateBiReservation(reservation, updateMask);
            // End snippet
        }
