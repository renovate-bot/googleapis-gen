...
import static com.google.cloud.bigquery.reservation.v1beta1.ReservationServiceClient.ListAssignmentsPagedResponse;
import static com.google.cloud.bigquery.reservation.v1beta1.ReservationServiceClient.ListCapacityCommitmentsPagedResponse;
import static com.google.cloud.bigquery.reservation.v1beta1.ReservationServiceClient.ListReservationsPagedResponse;
import static com.google.cloud.bigquery.reservation.v1beta1.ReservationServiceClient.SearchAssignmentsPagedResponse;
...
public class ReservationServiceClientTest {
  ...
  public void listCapacityCommitmentsTest() throws Exception {
    ...
    ListCapacityCommitmentsPagedResponse pagedListResponse =
  ...
  public void getBiReservationTest() throws Exception {
    BiReservation expectedResponse =
        BiReservation.newBuilder()
            .setName(BiReservationName.of("[PROJECT]", "[LOCATION]", "[BIRESERVATION]").toString())
            .setUpdateTime(Timestamp.newBuilder().build())
            .setSize(3530753)
            .build();
    mockReservationService.addResponse(expectedResponse);

    BiReservationName name = BiReservationName.of("[PROJECT]", "[LOCATION]", "[BIRESERVATION]");
  ...
  public void updateBiReservationTest() throws Exception {
    ...
    BiReservation reservation = BiReservation.newBuilder().build();
    FieldMask updateMask = FieldMask.newBuilder().build();

    BiReservation actualResponse = client.updateBiReservation(reservation, updateMask);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void updateBiReservationExceptionTest() throws Exception {
    ...
    try {
      BiReservation reservation = BiReservation.newBuilder().build();
      FieldMask updateMask = FieldMask.newBuilder().build();
      client.updateBiReservation(reservation, updateMask);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
