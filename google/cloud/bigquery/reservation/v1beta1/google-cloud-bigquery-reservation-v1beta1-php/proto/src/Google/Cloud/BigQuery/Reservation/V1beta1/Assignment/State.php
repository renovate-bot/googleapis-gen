 ...
 * active.
 *
 * Protobuf type <code>google.cloud.bigquery.reservation.v1beta1.Assignment.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\BigQuery\Reservation\V1beta1\Assignment_State::class);
