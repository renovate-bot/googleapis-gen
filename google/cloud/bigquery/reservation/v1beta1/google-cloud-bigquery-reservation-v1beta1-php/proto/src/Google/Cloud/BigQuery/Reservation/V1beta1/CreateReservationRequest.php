 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.reservation.v1beta1.CreateReservationRequest</code>
 */
class CreateReservationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           The reservation ID. This field must only contain lower case alphanumeric
     *           characters or dash. Max length is 64 characters.
     *     @type \Google\Cloud\BigQuery\Reservation\V1beta1\Reservation $reservation
     *           Content of the new reservation to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.reservation.v1beta1.Reservation reservation = 3;</code>
     * @param \Google\Cloud\BigQuery\Reservation\V1beta1\Reservation $var
     * @return $this
     */
    public function setReservation($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BigQuery\Reservation\V1beta1\Reservation::class);
