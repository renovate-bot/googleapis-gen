...
namespace Google\Cloud\BigQuery\Reservation\V1beta1\CapacityCommitment;
 ...
 *
 * Protobuf type <code>google.cloud.bigquery.reservation.v1beta1.CapacityCommitment.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\BigQuery\Reservation\V1beta1\CapacityCommitment_State::class);
