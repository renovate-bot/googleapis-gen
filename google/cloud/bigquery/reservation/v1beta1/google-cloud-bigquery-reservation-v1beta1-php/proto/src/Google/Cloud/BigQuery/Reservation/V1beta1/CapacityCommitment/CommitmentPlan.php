 ...
 *
 * Protobuf type <code>google.cloud.bigquery.reservation.v1beta1.CapacityCommitment.CommitmentPlan</code>
 */
...
class_alias(CommitmentPlan::class, \Google\Cloud\BigQuery\Reservation\V1beta1\CapacityCommitment_CommitmentPlan::class);
