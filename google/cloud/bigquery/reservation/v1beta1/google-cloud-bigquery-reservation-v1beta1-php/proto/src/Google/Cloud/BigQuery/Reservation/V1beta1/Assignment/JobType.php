...
namespace Google\Cloud\BigQuery\Reservation\V1beta1\Assignment;
 ...
 *
 * Protobuf type <code>google.cloud.bigquery.reservation.v1beta1.Assignment.JobType</code>
 */
class JobType
{
    /**
...
class_alias(JobType::class, \Google\Cloud\BigQuery\Reservation\V1beta1\Assignment_JobType::class);
