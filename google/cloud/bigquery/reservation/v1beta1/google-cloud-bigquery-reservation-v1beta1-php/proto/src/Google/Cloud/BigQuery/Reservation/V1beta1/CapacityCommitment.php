 ...
 * project.
 *
 * Generated from protobuf message <code>google.cloud.bigquery.reservation.v1beta1.CapacityCommitment</code>
 */
class CapacityCommitment extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.reservation.v1beta1.CapacityCommitment.CommitmentPlan plan = 3;</code>
     */
    protected $plan = 0;
    /**
     * Output only. State of the commitment.
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.reservation.v1beta1.CapacityCommitment.State state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.reservation.v1beta1.CapacityCommitment.CommitmentPlan renewal_plan = 8;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BigQuery\Reservation\V1beta1\CapacityCommitment\CommitmentPlan::class);
        $this->plan = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BigQuery\Reservation\V1beta1\CapacityCommitment\State::class);
        $this->state = $var;
