 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.reservation.v1beta1.UpdateCapacityCommitmentRequest</code>
 */
class UpdateCapacityCommitmentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.reservation.v1beta1.CapacityCommitment capacity_commitment = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\BigQuery\Reservation\V1beta1\CapacityCommitment $capacity_commitment
     *           Content of the capacity commitment to update.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.reservation.v1beta1.CapacityCommitment capacity_commitment = 1;</code>
     * @param \Google\Cloud\BigQuery\Reservation\V1beta1\CapacityCommitment $var
     * @return $this
     */
    public function setCapacityCommitment($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BigQuery\Reservation\V1beta1\CapacityCommitment::class);
