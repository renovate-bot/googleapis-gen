...
describe('v1beta1.ReservationServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = reservationserviceModule.v1beta1.ReservationServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = reservationserviceModule.v1beta1.ReservationServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = reservationserviceModule.v1beta1.ReservationServiceClient.port;
        assert(port);
    ...
    describe('createReservation', () => {
        it('invokes createReservation without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.reservation.v1beta1.Reservation());
        ...
        it('invokes createReservation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createReservation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.reservation.v1beta1.IReservation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createCapacityCommitment', () => {
        it('invokes createCapacityCommitment without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.reservation.v1beta1.CapacityCommitment());
        ...
        it('invokes createCapacityCommitment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCapacityCommitment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.reservation.v1beta1.ICapacityCommitment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('splitCapacityCommitment', () => {
        it('invokes splitCapacityCommitment without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.reservation.v1beta1.SplitCapacityCommitmentResponse());
        ...
        it('invokes splitCapacityCommitment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.splitCapacityCommitment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.reservation.v1beta1.ISplitCapacityCommitmentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createAssignment', () => {
        it('invokes createAssignment without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.reservation.v1beta1.Assignment());
        ...
        it('invokes createAssignment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createAssignment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.reservation.v1beta1.IAssignment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBiReservation', () => {
        it('invokes getBiReservation without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.reservation.v1beta1.BiReservation());
        ...
        it('invokes getBiReservation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBiReservation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.reservation.v1beta1.IBiReservation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listReservations', () => {
        ...
        it('invokes listReservationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.bigquery.reservation.v1beta1.Reservation[] = [];
                stream.on('data', (response: protos.google.cloud.bigquery.reservation.v1beta1.Reservation) => {
        ...
        it('uses async iteration with listReservations without error', async () => {
            ...
            const responses: protos.google.cloud.bigquery.reservation.v1beta1.IReservation[] = [];
    ...
    describe('listCapacityCommitments', () => {
        ...
        it('invokes listCapacityCommitmentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.bigquery.reservation.v1beta1.CapacityCommitment[] = [];
                stream.on('data', (response: protos.google.cloud.bigquery.reservation.v1beta1.CapacityCommitment) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listCapacityCommitments without error', async () => {
            ...
            const responses: protos.google.cloud.bigquery.reservation.v1beta1.ICapacityCommitment[] = [];
    ...
    describe('listAssignments', () => {
        ...
        it('invokes listAssignmentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.bigquery.reservation.v1beta1.Assignment[] = [];
                stream.on('data', (response: protos.google.cloud.bigquery.reservation.v1beta1.Assignment) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listAssignments without error', async () => {
            ...
            const responses: protos.google.cloud.bigquery.reservation.v1beta1.IAssignment[] = [];
    ...
    describe('Path templates', () => {
        ...
        describe('biReservation', () => {
            ...
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                bireservation: "bireservationValue",
            };
            const client = new reservationserviceModule.v1beta1.ReservationServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            it('biReservationPath', () => {
                const result = client.biReservationPath("projectValue", "locationValue", "bireservationValue");
                assert.strictEqual(result, fakePath);
            ...
            it('matchBireservationFromBiReservationName', () => {
                const result = client.matchBireservationFromBiReservationName(fakePath);
                assert.strictEqual(result, "bireservationValue");
                assert((client.pathTemplates.biReservationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
