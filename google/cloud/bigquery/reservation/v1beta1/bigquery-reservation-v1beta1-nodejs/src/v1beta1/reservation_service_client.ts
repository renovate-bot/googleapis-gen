 ...
 * `src/v1beta1/reservation_service_client_config.json`.
...
export class ReservationServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.bigquery.reservation.v1beta1.ReservationService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.reservationServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.bigquery.reservation.v1beta1.ReservationService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.bigquery.reservation.v1beta1.ReservationService,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const reservationServiceStubMethods =
        ['createReservation', 'listReservations', 'getReservation', 'deleteReservation', 'updateReservation', 'createCapacityCommitment', 'listCapacityCommitments', 'getCapacityCommitment', 'deleteCapacityCommitment', 'updateCapacityCommitment', 'splitCapacityCommitment', 'mergeCapacityCommitments', 'createAssignment', 'listAssignments', 'deleteAssignment', 'searchAssignments', 'moveAssignment', 'getBiReservation', 'updateBiReservation'];
 ...
 */
  ...
  getReservation(
      ...
      Promise<[
        protos.google.cloud.bigquery.reservation.v1beta1.IReservation,
        protos.google.cloud.bigquery.reservation.v1beta1.IGetReservationRequest|undefined, {}|undefined
      ]>;
  getReservation(
      request: protos.google.cloud.bigquery.reservation.v1beta1.IGetReservationRequest,
      options: CallOptions,
 ...
 */
  ...
  deleteReservation(
      ...
      Promise<[
        ...
        protos.google.cloud.bigquery.reservation.v1beta1.IDeleteReservationRequest|undefined, {}|undefined
      ]>;
  deleteReservation(
      request: protos.google.cloud.bigquery.reservation.v1beta1.IDeleteReservationRequest,
      options: CallOptions,
 ...
 */
  ...
  updateReservation(
      ...
      Promise<[
        protos.google.cloud.bigquery.reservation.v1beta1.IReservation,
        protos.google.cloud.bigquery.reservation.v1beta1.IUpdateReservationRequest|undefined, {}|undefined
      ]>;
  updateReservation(
      request: protos.google.cloud.bigquery.reservation.v1beta1.IUpdateReservationRequest,
      options: CallOptions,
 ...
 *      `projects/myproject/locations/US`
 * @param {google.cloud.bigquery.reservation.v1beta1.CapacityCommitment} request.capacityCommitment
 ...
 */
  ...
  getCapacityCommitment(
      ...
      Promise<[
        protos.google.cloud.bigquery.reservation.v1beta1.ICapacityCommitment,
        protos.google.cloud.bigquery.reservation.v1beta1.IGetCapacityCommitmentRequest|undefined, {}|undefined
      ]>;
  getCapacityCommitment(
      request: protos.google.cloud.bigquery.reservation.v1beta1.IGetCapacityCommitmentRequest,
      options: CallOptions,
 ...
 */
  ...
  deleteCapacityCommitment(
      ...
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.cloud.bigquery.reservation.v1beta1.IDeleteCapacityCommitmentRequest|undefined, {}|undefined
      ]>;
  deleteCapacityCommitment(
      request: protos.google.cloud.bigquery.reservation.v1beta1.IDeleteCapacityCommitmentRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [SplitCapacityCommitmentResponse]{@link google.cloud.bigquery.reservation.v1beta1.SplitCapacityCommitmentResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 * @param {google.cloud.bigquery.reservation.v1beta1.Assignment} request.assignment
 *   Assignment resource to create.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [Assignment]{@link google.cloud.bigquery.reservation.v1beta1.Assignment}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 ...
 */
  ...
  getBiReservation(
      ...
      Promise<[
        ...
        protos.google.cloud.bigquery.reservation.v1beta1.IGetBiReservationRequest|undefined, {}|undefined
      ]>;
  getBiReservation(
      request: protos.google.cloud.bigquery.reservation.v1beta1.IGetBiReservationRequest,
      options: CallOptions,
 ...
 * @param {Object} request
 *   The request object that will be sent.
 * @param {google.cloud.bigquery.reservation.v1beta1.BiReservation} request.reservation
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Reservation]{@link google.cloud.bigquery.reservation.v1beta1.Reservation}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Reservation]{@link google.cloud.bigquery.reservation.v1beta1.Reservation} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [Reservation]{@link google.cloud.bigquery.reservation.v1beta1.Reservation}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listReservationsAsync(
      request?: protos.google.cloud.bigquery.reservation.v1beta1.IListReservationsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.bigquery.reservation.v1beta1.IReservation>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [CapacityCommitment]{@link google.cloud.bigquery.reservation.v1beta1.CapacityCommitment}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [CapacityCommitment]{@link google.cloud.bigquery.reservation.v1beta1.CapacityCommitment} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listCapacityCommitmentsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
 *   When you iterate the returned iterable, each element will be an object representing
 *   [CapacityCommitment]{@link google.cloud.bigquery.reservation.v1beta1.CapacityCommitment}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 ...
 */
  listCapacityCommitmentsAsync(
      request?: protos.google.cloud.bigquery.reservation.v1beta1.IListCapacityCommitmentsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.bigquery.reservation.v1beta1.ICapacityCommitment>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Assignment]{@link google.cloud.bigquery.reservation.v1beta1.Assignment}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Assignment]{@link google.cloud.bigquery.reservation.v1beta1.Assignment} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listAssignmentsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
 *   When you iterate the returned iterable, each element will be an object representing
 *   [Assignment]{@link google.cloud.bigquery.reservation.v1beta1.Assignment}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 ...
 */
  listAssignmentsAsync(
      request?: protos.google.cloud.bigquery.reservation.v1beta1.IListAssignmentsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.bigquery.reservation.v1beta1.IAssignment>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
 ...
 */
   ...
   * @returns {string} Resource name string.
   */
  biReservationPath(project:string,location:string,bireservation:string) {
  ...
  /**
   * Parse the bireservation from BiReservation resource.
   *
   * @param {string} biReservationName
   *   A fully-qualified path representing BiReservation resource.
   * @returns {string} A string representing the bireservation.
   */
  matchBireservationFromBiReservationName(biReservationName: string) {
    return this.pathTemplates.biReservationPathTemplate.match(biReservationName).bireservation;
  }
