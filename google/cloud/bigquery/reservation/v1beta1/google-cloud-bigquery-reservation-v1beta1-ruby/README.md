...
### Next Steps
- Read the [Client Library Documentation][] for BigQuery Reservation API
...
[Client Library Documentation]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-bigquery-reservation/latest/google/cloud/bigquery/reservation/v1beta1
