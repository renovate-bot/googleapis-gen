...
require "google/cloud/bigquery/reservation/v1beta1/reservation_service"

class ::Google::Cloud::Bigquery::Reservation::V1beta1::ReservationService::ClientPathsTest < Minitest::Test
  ...
  def test_bi_reservation_path
    ...
    ::Gapic::ServiceStub.stub :new, nil do
      ...
      path = client.bi_reservation_path project: "value0", location: "value1", bireservation: "value2"
      assert_equal "projects/value0/locations/value1/bireservation/value2", path
    end
  end
