  ...
  module Cloud
    module Bigquery
      ...
      module Reservation
        ...
        FILE_DIR = File.realdirpath(Pathname.new(__FILE__).join("..").join("reservation"))
        ...
        def self.new(*args, version: :v1beta1, **kwargs)
          ...
          version_module = Google::Cloud::Bigquery::Reservation
            .constants
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Bigquery::Reservation.const_get(version_module).new(*args, **kwargs)
        end
      end
    end
  end
