...
class DataTransferServiceAsyncClient:
    ...
    parse_data_source_path = staticmethod(DataTransferServiceClient.parse_data_source_path)
    ...
    get_transport_class = functools.partial(type(DataTransferServiceClient).get_transport_class, type(DataTransferServiceClient))
    ...
    async def create_transfer_config(self,
    ...
    async def update_transfer_config(self,
    ...
    async def delete_transfer_config(self,
    ...
    async def list_transfer_configs(self,
    ...
    async def schedule_transfer_runs(self,
    ...
    async def start_manual_transfer_runs(self,
    ...
    async def get_transfer_run(self,
    ...
    async def delete_transfer_run(self,
    ...
    async def list_transfer_runs(self,
    ...
    async def list_transfer_logs(self,
    ...
    async def check_valid_creds(self,
