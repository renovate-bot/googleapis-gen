        ...
        module V1beta1
          module ConnectionService
            ...
            class Client
              ...
              #
              # See {::Google::Cloud::Bigquery::Connection::V1beta1::ConnectionService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all ConnectionService clients
              #   ::Google::Cloud::Bigquery::Connection::V1beta1::ConnectionService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Cloud::Bigquery::Connection::V1beta1::ConnectionService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @connection_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Cloud::Bigquery::Connection::V1beta1::ConnectionService::Stub,
              ...
              #   {::Google::Cloud::Bigquery::Connection::V1beta1::CreateConnectionRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Bigquery::Connection::V1beta1::CreateConnectionRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Cloud::Bigquery::Connection::V1beta1::Connection]
              ...
              #   request = Google::Cloud::Bigquery::Connection::V1beta1::CreateConnectionRequest.new
              #
              #   # Call the create_connection method.
              #   result = client.create_connection request
              #
              #   # The returned object is of type Google::Cloud::Bigquery::Connection::V1beta1::Connection.
              #   p result
              #
              def create_connection request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Bigquery::Connection::V1beta1::CreateConnectionRequest
                ...
                metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                  ...
                  gapic_version: ::Google::Cloud::Connection::V1beta1::VERSION
              ...
              #   {::Google::Cloud::Bigquery::Connection::V1beta1::GetConnectionRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Bigquery::Connection::V1beta1::GetConnectionRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Bigquery::Connection::V1beta1::GetConnectionRequest.new
              #
              ...
              def get_connection request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Bigquery::Connection::V1beta1::GetConnectionRequest
              ...
              #   {::Google::Cloud::Bigquery::Connection::V1beta1::ListConnectionsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Bigquery::Connection::V1beta1::ListConnectionsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload list_connections(parent: nil, max_results: nil, page_token: nil)
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Cloud::Bigquery::Connection::V1beta1::ListConnectionsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Bigquery::Connection::V1beta1::ListConnectionsRequest.new
              #
              #   # Call the list_connections method.
              #   result = client.list_connections request
              #
              #   # The returned object is of type Google::Cloud::Bigquery::Connection::V1beta1::ListConnectionsResponse.
              #   p result
              #
              def list_connections request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Bigquery::Connection::V1beta1::ListConnectionsRequest
              ...
              #   {::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionRequest.new
              #
              ...
              def update_connection request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionRequest
              ...
              #
              # @overload update_connection_credential(request, options = nil)
              #   Pass arguments to `update_connection_credential` via a request object, either of type
              #   {::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionCredentialRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionCredentialRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload update_connection_credential(name: nil, credential: nil)
              #   Pass arguments to `update_connection_credential` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param name [::String]
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionCredentialRequest.new
              #
              #   # Call the update_connection_credential method.
              #   result = client.update_connection_credential request
              #
              #   # The returned object is of type Google::Protobuf::Empty.
              #   p result
              #
              def update_connection_credential request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionCredentialRequest

                # Converts hash and nil to an options object
                options = ::Gapic::CallOptions.new(**options.to_h) if options.respond_to? :to_h

                # Customize the options with defaults
                metadata = @config.rpcs.update_connection_credential.metadata.to_h
                ...
                options.apply_defaults timeout:      @config.rpcs.update_connection_credential.timeout,
                                       metadata:     metadata,
                                       retry_policy: @config.rpcs.update_connection_credential.retry_policy

                options.apply_defaults timeout:      @config.timeout,
                                       metadata:     @config.metadata,
                                       retry_policy: @config.retry_policy

                @connection_service_stub.call_rpc :update_connection_credential, request, options: options do |response, operation|
                  yield response, operation if block_given?
                  return response
                end
              rescue ::GRPC::BadStatus => e
              ...
              #   {::Google::Cloud::Bigquery::Connection::V1beta1::DeleteConnectionRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Cloud::Bigquery::Connection::V1beta1::DeleteConnectionRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Cloud::Bigquery::Connection::V1beta1::DeleteConnectionRequest.new
              #
              ...
              def delete_connection request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Bigquery::Connection::V1beta1::DeleteConnectionRequest
              ...
              # {::Google::Cloud::Bigquery::Connection::V1beta1::ConnectionService::Client::Configuration::Rpcs}
              ...
              class Configuration
                ...
                class Rpcs
                  ...
                  ##
                  # RPC-specific configuration for `update_connection_credential`
                  # @return [::Gapic::Config::Method]
                  #
                  attr_reader :update_connection_credential
                  ##
                  ...
                  def initialize parent_rpcs = nil
                    ...
                    update_connection_credential_config = parent_rpcs.update_connection_credential if parent_rpcs.respond_to? :update_connection_credential
                    @update_connection_credential = ::Gapic::Config::Method.new update_connection_credential_config
