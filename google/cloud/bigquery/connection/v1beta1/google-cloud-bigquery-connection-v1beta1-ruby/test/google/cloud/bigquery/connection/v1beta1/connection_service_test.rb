...
require "google/cloud/bigquery/connection/v1beta1/connection_service"

class ::Google::Cloud::Bigquery::Connection::V1beta1::ConnectionService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_connection
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Bigquery::Connection::V1beta1::Connection.new
    ...
    create_connection_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Bigquery::Connection::V1beta1::CreateConnectionRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["connection_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Bigquery::Connection::V1beta1::Connection), request["connection"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, create_connection_client_stub do
      ...
      # Use protobuf object
      client.create_connection ::Google::Cloud::Bigquery::Connection::V1beta1::CreateConnectionRequest.new(parent: parent, connection_id: connection_id, connection: connection) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.create_connection(::Google::Cloud::Bigquery::Connection::V1beta1::CreateConnectionRequest.new(parent: parent, connection_id: connection_id, connection: connection), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_connection
    ...
    get_connection_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Bigquery::Connection::V1beta1::GetConnectionRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_connection_client_stub do
      ...
      # Use protobuf object
      client.get_connection ::Google::Cloud::Bigquery::Connection::V1beta1::GetConnectionRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_connection(::Google::Cloud::Bigquery::Connection::V1beta1::GetConnectionRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_connections
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Bigquery::Connection::V1beta1::ListConnectionsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_connections_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Bigquery::Connection::V1beta1::ListConnectionsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_connections_client_stub do
      ...
      # Use hash object
      client.list_connections({ parent: parent, max_results: max_results, page_token: page_token }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.list_connections ::Google::Cloud::Bigquery::Connection::V1beta1::ListConnectionsRequest.new(parent: parent, max_results: max_results, page_token: page_token) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.list_connections({ parent: parent, max_results: max_results, page_token: page_token }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      client.list_connections(::Google::Cloud::Bigquery::Connection::V1beta1::ListConnectionsRequest.new(parent: parent, max_results: max_results, page_token: page_token), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_connection
    ...
    update_connection_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionRequest, request
      assert_equal "hello world", request["name"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Bigquery::Connection::V1beta1::Connection), request["connection"]
    ...
    Gapic::ServiceStub.stub :new, update_connection_client_stub do
      ...
      # Use protobuf object
      client.update_connection ::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionRequest.new(name: name, connection: connection, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_connection(::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionRequest.new(name: name, connection: connection, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_connection_credential
    # Create GRPC objects.
    ...
    update_connection_credential_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :update_connection_credential, name
      assert_kind_of ::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionCredentialRequest, request
      assert_equal "hello world", request["name"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Bigquery::Connection::V1beta1::ConnectionCredential), request["credential"]
      refute_nil options
    end

    Gapic::ServiceStub.stub :new, update_connection_credential_client_stub do
      # Create client
      client = ::Google::Cloud::Bigquery::Connection::V1beta1::ConnectionService::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      client.update_connection_credential({ name: name, credential: credential }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.update_connection_credential ::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionCredentialRequest.new(name: name, credential: credential) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.update_connection_credential({ name: name, credential: credential }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      client.update_connection_credential(::Google::Cloud::Bigquery::Connection::V1beta1::UpdateConnectionCredentialRequest.new(name: name, credential: credential), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Verify method calls
      assert_equal 5, update_connection_credential_client_stub.call_rpc_count
    end
  end
  ...
  def test_delete_connection
    ...
    delete_connection_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Bigquery::Connection::V1beta1::DeleteConnectionRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_connection_client_stub do
      ...
      # Use protobuf object
      client.delete_connection ::Google::Cloud::Bigquery::Connection::V1beta1::DeleteConnectionRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_connection(::Google::Cloud::Bigquery::Connection::V1beta1::DeleteConnectionRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Bigquery::Connection::V1beta1::ConnectionService::Client::Configuration, config
  end
end
