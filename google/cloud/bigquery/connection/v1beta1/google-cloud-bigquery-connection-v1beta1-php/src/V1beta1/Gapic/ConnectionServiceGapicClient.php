...
namespace Google\Cloud\BigQuery\Connection\V1beta1\Gapic;
...
use Google\Cloud\BigQuery\Connection\V1beta1\CreateConnectionRequest;
use Google\Cloud\BigQuery\Connection\V1beta1\DeleteConnectionRequest;
use Google\Cloud\BigQuery\Connection\V1beta1\GetConnectionRequest;
use Google\Cloud\BigQuery\Connection\V1beta1\ListConnectionsRequest;
use Google\Cloud\BigQuery\Connection\V1beta1\ListConnectionsResponse;
use Google\Cloud\BigQuery\Connection\V1beta1\UpdateConnectionCredentialRequest;
use Google\Cloud\BigQuery\Connection\V1beta1\UpdateConnectionRequest;
...
class ConnectionServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.bigquery.connection.v1beta1.ConnectionService';
     ...
     *     $response = $connectionServiceClient->listConnections($formattedParent, $maxResults);
     * } finally {
     *     $connectionServiceClient->close();
     * }
     * ```
     ...
     * @param UInt32Value $maxResults   Required. Maximum number of results per page.
     * @param array       $optionalArgs {
     *                                  Optional.
     *
     ...
     * @experimental
     */
    public function listConnections($parent, $maxResults, array $optionalArgs = [])
    {
     ...
     * @param ConnectionCredential $credential   Required. Credential to use with the connection.
     * @param array                $optionalArgs {
     *                                           Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @experimental
     */
    public function updateConnectionCredential($name, $credential, array $optionalArgs = [])
    {
        $request = new UpdateConnectionCredentialRequest();
        $request->setName($name);
