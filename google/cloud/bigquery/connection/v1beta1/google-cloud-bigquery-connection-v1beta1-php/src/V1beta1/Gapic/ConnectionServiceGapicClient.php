...
class ConnectionServiceGapicClient
{
    ...
    public function listConnections($parent, $maxResults, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ListConnections', ListConnectionsResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updateConnectionCredential($name, $credential, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateConnectionCredential', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
}
