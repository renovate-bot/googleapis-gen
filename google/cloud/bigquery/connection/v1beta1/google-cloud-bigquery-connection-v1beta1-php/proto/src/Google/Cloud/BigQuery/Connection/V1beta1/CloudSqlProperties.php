 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.connection.v1beta1.CloudSqlProperties</code>
 */
class CloudSqlProperties extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.connection.v1beta1.CloudSqlProperties.DatabaseType type = 3;</code>
     */
    protected $type = 0;
    /**
     * Input only. Cloud SQL credential.
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.connection.v1beta1.CloudSqlCredential credential = 4 [(.google.api.field_behavior) = INPUT_ONLY];</code>
     */
     ...
     *     @type int $type
     *           Type of the Cloud SQL database.
     *     @type \Google\Cloud\BigQuery\Connection\V1beta1\CloudSqlCredential $credential
     *           Input only. Cloud SQL credential.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BigQuery\Connection\V1beta1\CloudSqlProperties\DatabaseType::class);
        $this->type = $var;
