 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.connection.v1beta1.Connection</code>
 */
class Connection extends \Google\Protobuf\Internal\Message
{
     ...
     *           User provided description.
     *     @type \Google\Cloud\BigQuery\Connection\V1beta1\CloudSqlProperties $cloud_sql
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.connection.v1beta1.CloudSqlProperties cloud_sql = 4;</code>
     * @param \Google\Cloud\BigQuery\Connection\V1beta1\CloudSqlProperties $var
     * @return $this
     */
    public function setCloudSql($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BigQuery\Connection\V1beta1\CloudSqlProperties::class);
