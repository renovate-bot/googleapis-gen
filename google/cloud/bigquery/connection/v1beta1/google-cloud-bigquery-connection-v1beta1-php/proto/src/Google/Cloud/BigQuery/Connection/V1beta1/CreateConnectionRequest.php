 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.connection.v1beta1.CreateConnectionRequest</code>
 */
class CreateConnectionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.connection.v1beta1.Connection connection = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Optional. Connection id that should be assigned to the created connection.
     *     @type \Google\Cloud\BigQuery\Connection\V1beta1\Connection $connection
     *           Required. Connection to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.connection.v1beta1.Connection connection = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\BigQuery\Connection\V1beta1\Connection|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.connection.v1beta1.Connection connection = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\BigQuery\Connection\V1beta1\Connection $var
     * @return $this
     */
    public function setConnection($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BigQuery\Connection\V1beta1\Connection::class);
        $this->connection = $var;
