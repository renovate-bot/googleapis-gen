...
from google.cloud.bigquery.connection_v1beta1.services.connection_service import ConnectionServiceAsyncClient
from google.cloud.bigquery.connection_v1beta1.services.connection_service import ConnectionServiceClient
from google.cloud.bigquery.connection_v1beta1.services.connection_service import transports
from google.cloud.bigquery.connection_v1beta1.services.connection_service.transports.base import _API_CORE_VERSION
from google.cloud.bigquery.connection_v1beta1.services.connection_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_create_connection(transport: str = 'grpc', request_type=gcbc_connection.CreateConnectionRequest):
    ...
    with mock.patch.object(
        ...
        call.return_value = gcbc_connection.Connection(
            ...
            has_credential=True,
            cloud_sql=gcbc_connection.CloudSqlProperties(instance_id='instance_id_value'),
        )
...
def test_update_connection_credential(transport: str = 'grpc', request_type=connection.UpdateConnectionCredentialRequest):
    ...
    with mock.patch.object(
        ...
        response = client.update_connection_credential(request)
...
async def test_update_connection_credential_async(transport: str = 'grpc_asyncio', request_type=connection.UpdateConnectionCredentialRequest):
    ...
    with mock.patch.object(
        ...
        response = await client.update_connection_credential(request)
...
@pytest.mark.asyncio
async def test_update_connection_credential_async_from_dict():
    await test_update_connection_credential_async(request_type=dict)


def test_update_connection_credential_field_headers():
    client = ConnectionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = connection.UpdateConnectionCredentialRequest()
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = None
        client.update_connection_credential(request)
...
@pytest.mark.asyncio
async def test_update_connection_credential_field_headers_async():
    client = ConnectionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.update_connection_credential(request)
...
def test_update_connection_credential_flattened():
    client = ConnectionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.update_connection_credential(
            name='name_value',
            credential=connection.ConnectionCredential(cloud_sql=connection.CloudSqlCredential(username='username_value')),
        )
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].name == 'name_value'
        assert args[0].credential == connection.ConnectionCredential(cloud_sql=connection.CloudSqlCredential(username='username_value'))


def test_update_connection_credential_flattened_error():
    client = ConnectionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_connection_credential_flattened_async():
    client = ConnectionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.update_connection_credential(
            name='name_value',
            credential=connection.ConnectionCredential(cloud_sql=connection.CloudSqlCredential(username='username_value')),
        )
...
@pytest.mark.asyncio
async def test_update_connection_credential_flattened_error_async():
    client = ConnectionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_connection_credential(
            connection.UpdateConnectionCredentialRequest(),
            name='name_value',
            credential=connection.ConnectionCredential(cloud_sql=connection.CloudSqlCredential(username='username_value')),
        )
...
def test_connection_service_base_transport():
    ...
    with mock.patch('google.cloud.bigquery.connection_v1beta1.services.connection_service.transports.ConnectionServiceTransport.__init__') as Transport:
...
def test_connection_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery.connection_v1beta1.services.connection_service.transports.ConnectionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_connection_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery.connection_v1beta1.services.connection_service.transports.ConnectionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ConnectionServiceTransport()
        adc.assert_called_once()
...
def test_connection_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_connection_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
def test_connection_service_host_no_port():
    client = ConnectionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='bigqueryconnection.googleapis.com'),
    )
    assert client.transport._host == 'bigqueryconnection.googleapis.com:443'
...
def test_connection_service_host_with_port():
    client = ConnectionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='bigqueryconnection.googleapis.com:8000'),
    )
