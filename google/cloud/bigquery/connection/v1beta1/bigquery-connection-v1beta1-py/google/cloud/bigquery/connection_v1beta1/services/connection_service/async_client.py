    ...
    async def create_connection(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                should not be set.
            connection (:class:`google.cloud.bigquery.connection_v1beta1.types.Connection`):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def update_connection_credential(self,
        ...
        Args:
            ...
            name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            credential (:class:`google.cloud.bigquery.connection_v1beta1.types.ConnectionCredential`):
        ...
        # and friendly error handling.
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.update_connection_credential,
            default_timeout=60.0,
            client_info=DEFAULT_CLIENT_INFO,
        )
