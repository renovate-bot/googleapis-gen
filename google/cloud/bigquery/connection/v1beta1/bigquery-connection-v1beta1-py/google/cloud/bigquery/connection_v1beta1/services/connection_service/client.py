...
class ConnectionServiceClient(metaclass=ConnectionServiceClientMeta):
    ...
    def create_connection(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.connection_v1beta1.types.CreateConnectionRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            connection (google.cloud.bigquery.connection_v1beta1.types.Connection):
        ...
        Returns:
            google.cloud.bigquery.connection_v1beta1.types.Connection:
    ...
    def get_connection(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.connection_v1beta1.types.GetConnectionRequest, dict]):
                The request object. The request for
    ...
    def list_connections(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.connection_v1beta1.types.ListConnectionsRequest, dict]):
                The request object. The request for
            ...
            max_results (google.protobuf.wrappers_pb2.UInt32Value):
                Required. Maximum number of results
                per page.
        ...
        Returns:
            google.cloud.bigquery.connection_v1beta1.types.ListConnectionsResponse:
                The response for
                [ConnectionService.ListConnections][google.cloud.bigquery.connection.v1beta1.ConnectionService.ListConnections].
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, max_results])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_connection(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.connection_v1beta1.types.UpdateConnectionRequest, dict]):
                The request object. The request for
    ...
    def update_connection_credential(self,
            request: Union[connection.UpdateConnectionCredentialRequest, dict] = None,
            *,
            name: str = None,
        ...
        Args:
            request (Union[google.cloud.bigquery.connection_v1beta1.types.UpdateConnectionCredentialRequest, dict]):
                The request object. The request for
            ...
            name (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            credential (google.cloud.bigquery.connection_v1beta1.types.ConnectionCredential):
                Required. Credential to use with the
                connection.
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([name, credential])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')

        # Minor optimization to avoid making a copy if the user passes
        # in a connection.UpdateConnectionCredentialRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_connection_credential]
    ...
    def delete_connection(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.connection_v1beta1.types.DeleteConnectionRequest, dict]):
                The request object. The request for
