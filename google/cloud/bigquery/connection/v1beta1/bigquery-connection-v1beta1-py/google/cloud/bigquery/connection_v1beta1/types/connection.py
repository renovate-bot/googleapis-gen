...
class ListConnectionsResponse(proto.Message):
    ...
    Attributes:
        next_page_token (str):
            Next page token.
        connections (Sequence[google.cloud.bigquery.connection_v1beta1.types.Connection]):
            List of connections.
    """
...
class UpdateConnectionCredentialRequest(proto.Message):
    r"""The request for
...
class CloudSqlProperties(proto.Message):
    ...
    Attributes:
        ...
        database (str):
            Database name.
        type_ (google.cloud.bigquery.connection_v1beta1.types.CloudSqlProperties.DatabaseType):
            Type of the Cloud SQL database.
        credential (google.cloud.bigquery.connection_v1beta1.types.CloudSqlCredential):
