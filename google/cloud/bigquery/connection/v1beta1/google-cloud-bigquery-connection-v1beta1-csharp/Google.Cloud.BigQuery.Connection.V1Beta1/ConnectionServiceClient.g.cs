...
namespace Google.Cloud.BigQuery.Connection.V1Beta1
{
    ...
    public sealed partial class ConnectionServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        private ConnectionServiceSettings(ConnectionServiceSettings existing) : base(existing)
        {
            ...
            UpdateConnectionCredentialSettings = existing.UpdateConnectionCredentialSettings;
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>ConnectionServiceClient.UpdateConnectionCredential</c> and
        /// <c>ConnectionServiceClient.UpdateConnectionCredentialAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This call will not be retried.</description></item>
        ...
        /// </list>
        /// </remarks>
        public gaxgrpc::CallSettings UpdateConnectionCredentialSettings { get; set; } = gaxgrpc::CallSettings.FromExpiration(gax::Expiration.FromTimeout(sys::TimeSpan.FromMilliseconds(60000)));
    ...
    public abstract partial class ConnectionServiceClient
    {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ListConnectionsResponse ListConnections(ListConnectionsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListConnectionsResponse> ListConnectionsAsync(ListConnectionsRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListConnectionsResponse> ListConnectionsAsync(ListConnectionsRequest request, st::CancellationToken cancellationToken) =>
            ListConnectionsAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ListConnectionsResponse ListConnections(string parent, uint? maxResults, gaxgrpc::CallSettings callSettings = null) =>
            ListConnections(new ListConnectionsRequest
            {
                Parent = gax::GaxPreconditions.CheckNotNullOrEmpty(parent, nameof(parent)),
                MaxResults = maxResults ?? throw new sys::ArgumentNullException(nameof(maxResults)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListConnectionsResponse> ListConnectionsAsync(string parent, uint? maxResults, gaxgrpc::CallSettings callSettings = null) =>
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListConnectionsResponse> ListConnectionsAsync(string parent, uint? maxResults, st::CancellationToken cancellationToken) =>
            ListConnectionsAsync(parent, maxResults, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual ListConnectionsResponse ListConnections(gagr::LocationName parent, uint? maxResults, gaxgrpc::CallSettings callSettings = null) =>
            ListConnections(new ListConnectionsRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                MaxResults = maxResults ?? throw new sys::ArgumentNullException(nameof(maxResults)),
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListConnectionsResponse> ListConnectionsAsync(gagr::LocationName parent, uint? maxResults, gaxgrpc::CallSettings callSettings = null) =>
            ListConnectionsAsync(new ListConnectionsRequest
            {
                ParentAsLocationName = gax::GaxPreconditions.CheckNotNull(parent, nameof(parent)),
                MaxResults = maxResults ?? throw new sys::ArgumentNullException(nameof(maxResults)),
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task<ListConnectionsResponse> ListConnectionsAsync(gagr::LocationName parent, uint? maxResults, st::CancellationToken cancellationToken) =>
            ListConnectionsAsync(parent, maxResults, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void UpdateConnectionCredential(UpdateConnectionCredentialRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task UpdateConnectionCredentialAsync(UpdateConnectionCredentialRequest request, gaxgrpc::CallSettings callSettings = null) =>
            throw new sys::NotImplementedException();
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task UpdateConnectionCredentialAsync(UpdateConnectionCredentialRequest request, st::CancellationToken cancellationToken) =>
            UpdateConnectionCredentialAsync(request, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public virtual void UpdateConnectionCredential(string name, ConnectionCredential credential, gaxgrpc::CallSettings callSettings = null) =>
            UpdateConnectionCredential(new UpdateConnectionCredentialRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
                Credential = gax::GaxPreconditions.CheckNotNull(credential, nameof(credential)),
            }, callSettings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task UpdateConnectionCredentialAsync(string name, ConnectionCredential credential, gaxgrpc::CallSettings callSettings = null) =>
            UpdateConnectionCredentialAsync(new UpdateConnectionCredentialRequest
            {
                Name = gax::GaxPreconditions.CheckNotNullOrEmpty(name, nameof(name)),
                Credential = gax::GaxPreconditions.CheckNotNull(credential, nameof(credential)),
            }, callSettings);
        ...
        /// <param name="cancellationToken">A <see cref="st::CancellationToken"/> to use for this RPC.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public virtual stt::Task UpdateConnectionCredentialAsync(string name, ConnectionCredential credential, st::CancellationToken cancellationToken) =>
            UpdateConnectionCredentialAsync(name, credential, gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
    ...
    public sealed partial class ConnectionServiceClientImpl : ConnectionServiceClient
    {
        ...
        private readonly gaxgrpc::ApiCall<UpdateConnectionCredentialRequest, wkt::Empty> _callUpdateConnectionCredential;
        ...
        public ConnectionServiceClientImpl(ConnectionService.ConnectionServiceClient grpcClient, ConnectionServiceSettings settings)
        {
            ...
            _callUpdateConnectionCredential = clientHelper.BuildApiCall<UpdateConnectionCredentialRequest, wkt::Empty>(grpcClient.UpdateConnectionCredentialAsync, grpcClient.UpdateConnectionCredential, effectiveSettings.UpdateConnectionCredentialSettings).WithGoogleRequestParam("name", request => request.Name);
            Modify_ApiCall(ref _callUpdateConnectionCredential);
            Modify_UpdateConnectionCredentialApiCall(ref _callUpdateConnectionCredential);
        ...
        partial void Modify_UpdateConnectionCredentialApiCall(ref gaxgrpc::ApiCall<UpdateConnectionCredentialRequest, wkt::Empty> call);
        ...
        partial void Modify_UpdateConnectionCredentialRequest(ref UpdateConnectionCredentialRequest request, ref gaxgrpc::CallSettings settings);
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override ListConnectionsResponse ListConnections(ListConnectionsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListConnectionsRequest(ref request, ref callSettings);
            return _callListConnections.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task<ListConnectionsResponse> ListConnectionsAsync(ListConnectionsRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_ListConnectionsRequest(ref request, ref callSettings);
            return _callListConnections.Async(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>The RPC response.</returns>
        public override void UpdateConnectionCredential(UpdateConnectionCredentialRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_UpdateConnectionCredentialRequest(ref request, ref callSettings);
            _callUpdateConnectionCredential.Sync(request, callSettings);
        }
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A Task containing the RPC response.</returns>
        public override stt::Task UpdateConnectionCredentialAsync(UpdateConnectionCredentialRequest request, gaxgrpc::CallSettings callSettings = null)
        {
            Modify_UpdateConnectionCredentialRequest(ref request, ref callSettings);
            return _callUpdateConnectionCredential.Async(request, callSettings);
        }
