...
namespace Google.Cloud.BigQuery.Connection.V1Beta1.Tests
{
    ...
    public sealed class GeneratedConnectionServiceClientTest
    {
        ...
        public void ListConnectionsRequestObject()
        {
            ...
            ListConnectionsResponse expectedResponse = new ListConnectionsResponse
            {
                NextPageToken = "next_page_tokendbee0940",
                Connections = { new Connection(), },
            };
            mockGrpcClient.Setup(x => x.ListConnections(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            ConnectionServiceClient client = new ConnectionServiceClientImpl(mockGrpcClient.Object, null);
        ...
        [xunit::FactAttribute]
        public async stt::Task ListConnectionsRequestObjectAsync()
        {
            moq::Mock<ConnectionService.ConnectionServiceClient> mockGrpcClient = new moq::Mock<ConnectionService.ConnectionServiceClient>(moq::MockBehavior.Strict);
            ListConnectionsRequest request = new ListConnectionsRequest
            {
            ...
            mockGrpcClient.Setup(x => x.ListConnectionsAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<ListConnectionsResponse>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            ConnectionServiceClient client = new ConnectionServiceClientImpl(mockGrpcClient.Object, null);
            ListConnectionsResponse responseCallSettings = await client.ListConnectionsAsync(request, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            ListConnectionsResponse responseCancellationToken = await client.ListConnectionsAsync(request, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void ListConnections()
        {
            ...
            mockGrpcClient.Setup(x => x.ListConnections(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            ConnectionServiceClient client = new ConnectionServiceClientImpl(mockGrpcClient.Object, null);
            ListConnectionsResponse response = client.ListConnections(request.Parent, request.MaxResults);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task ListConnectionsAsync()
        {
            moq::Mock<ConnectionService.ConnectionServiceClient> mockGrpcClient = new moq::Mock<ConnectionService.ConnectionServiceClient>(moq::MockBehavior.Strict);
            ListConnectionsRequest request = new ListConnectionsRequest
            {
            ...
            mockGrpcClient.Setup(x => x.ListConnectionsAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<ListConnectionsResponse>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            ConnectionServiceClient client = new ConnectionServiceClientImpl(mockGrpcClient.Object, null);
            ListConnectionsResponse responseCallSettings = await client.ListConnectionsAsync(request.Parent, request.MaxResults, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            ListConnectionsResponse responseCancellationToken = await client.ListConnectionsAsync(request.Parent, request.MaxResults, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void ListConnectionsResourceNames()
        {
            ...
            mockGrpcClient.Setup(x => x.ListConnections(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            ConnectionServiceClient client = new ConnectionServiceClientImpl(mockGrpcClient.Object, null);
            ListConnectionsResponse response = client.ListConnections(request.ParentAsLocationName, request.MaxResults);
            xunit::Assert.Same(expectedResponse, response);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task ListConnectionsResourceNamesAsync()
        {
            moq::Mock<ConnectionService.ConnectionServiceClient> mockGrpcClient = new moq::Mock<ConnectionService.ConnectionServiceClient>(moq::MockBehavior.Strict);
            ListConnectionsRequest request = new ListConnectionsRequest
            {
            ...
            mockGrpcClient.Setup(x => x.ListConnectionsAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<ListConnectionsResponse>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            ConnectionServiceClient client = new ConnectionServiceClientImpl(mockGrpcClient.Object, null);
            ListConnectionsResponse responseCallSettings = await client.ListConnectionsAsync(request.ParentAsLocationName, request.MaxResults, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            xunit::Assert.Same(expectedResponse, responseCallSettings);
            ListConnectionsResponse responseCancellationToken = await client.ListConnectionsAsync(request.ParentAsLocationName, request.MaxResults, st::CancellationToken.None);
            xunit::Assert.Same(expectedResponse, responseCancellationToken);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void UpdateConnectionCredentialRequestObject()
        {
            ...
            mockGrpcClient.Setup(x => x.UpdateConnectionCredential(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            ConnectionServiceClient client = new ConnectionServiceClientImpl(mockGrpcClient.Object, null);
            client.UpdateConnectionCredential(request);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task UpdateConnectionCredentialRequestObjectAsync()
        {
            moq::Mock<ConnectionService.ConnectionServiceClient> mockGrpcClient = new moq::Mock<ConnectionService.ConnectionServiceClient>(moq::MockBehavior.Strict);
            UpdateConnectionCredentialRequest request = new UpdateConnectionCredentialRequest
            {
            ...
            wkt::Empty expectedResponse = new wkt::Empty { };
            mockGrpcClient.Setup(x => x.UpdateConnectionCredentialAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<wkt::Empty>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            ConnectionServiceClient client = new ConnectionServiceClientImpl(mockGrpcClient.Object, null);
            await client.UpdateConnectionCredentialAsync(request, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            await client.UpdateConnectionCredentialAsync(request, st::CancellationToken.None);
            mockGrpcClient.VerifyAll();
        }
        ...
        public void UpdateConnectionCredential()
        {
            ...
            mockGrpcClient.Setup(x => x.UpdateConnectionCredential(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(expectedResponse);
            ConnectionServiceClient client = new ConnectionServiceClientImpl(mockGrpcClient.Object, null);
            client.UpdateConnectionCredential(request.Name, request.Credential);
            mockGrpcClient.VerifyAll();
        }

        [xunit::FactAttribute]
        public async stt::Task UpdateConnectionCredentialAsync()
        {
            moq::Mock<ConnectionService.ConnectionServiceClient> mockGrpcClient = new moq::Mock<ConnectionService.ConnectionServiceClient>(moq::MockBehavior.Strict);
            UpdateConnectionCredentialRequest request = new UpdateConnectionCredentialRequest
            {
            ...
            mockGrpcClient.Setup(x => x.UpdateConnectionCredentialAsync(request, moq::It.IsAny<grpccore::CallOptions>())).Returns(new grpccore::AsyncUnaryCall<wkt::Empty>(stt::Task.FromResult(expectedResponse), null, null, null, null));
            ConnectionServiceClient client = new ConnectionServiceClientImpl(mockGrpcClient.Object, null);
            await client.UpdateConnectionCredentialAsync(request.Name, request.Credential, gaxgrpc::CallSettings.FromCancellationToken(st::CancellationToken.None));
            await client.UpdateConnectionCredentialAsync(request.Name, request.Credential, st::CancellationToken.None);
            mockGrpcClient.VerifyAll();
        }
