...
describe('v1beta1.ConnectionServiceClient', () => {
    ...
    describe('createConnection', () => {
        it('invokes createConnection without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.connection.v1beta1.Connection());
            client.innerApiCalls.createConnection = stubSimpleCall(expectedResponse);
            const [response] = await client.createConnection(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createConnection as SinonStub)
    ...
    describe('getConnection', () => {
        it('invokes getConnection without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listConnections', () => {
        it('invokes listConnections without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.connection.v1beta1.ListConnectionsResponse());
            client.innerApiCalls.listConnections = stubSimpleCall(expectedResponse);
            const [response] = await client.listConnections(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listConnections as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateConnection', () => {
        it('invokes updateConnection without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateConnectionCredential', () => {
        it('invokes updateConnectionCredential without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateConnectionCredential as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteConnection', () => {
        it('invokes deleteConnection without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteConnection as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
