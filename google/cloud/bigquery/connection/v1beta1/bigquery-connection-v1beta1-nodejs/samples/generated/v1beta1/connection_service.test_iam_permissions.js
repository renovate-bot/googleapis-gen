...
function main(resource, permissions) {
  // [START connection_v1beta1_generated_ConnectionService_TestIamPermissions_async]
  /**
  ...
  testIamPermissions();
  // [END connection_v1beta1_generated_ConnectionService_TestIamPermissions_async]
}
