...
class ConnectionServiceTransport(abc.ABC):
    ...
    @property
    def create_connection(self) -> typing.Callable[
            [gcbc_connection.CreateConnectionRequest],
            typing.Union[
                gcbc_connection.Connection,
                typing.Awaitable[gcbc_connection.Connection]
            ]]:
        raise NotImplementedError()

    @property
    def get_connection(self) -> typing.Callable[
            [connection.GetConnectionRequest],
            typing.Union[
                connection.Connection,
                typing.Awaitable[connection.Connection]
            ]]:
        raise NotImplementedError()

    @property
    def list_connections(self) -> typing.Callable[
    ...
    @property
    def update_connection(self) -> typing.Callable[
    ...
    @property
    def delete_connection(self) -> typing.Callable[
