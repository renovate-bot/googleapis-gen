...
namespace Google\Cloud\Bigquery\Storage\Tests\Unit\V1alpha2;

use Google\Cloud\Bigquery\Storage\V1alpha2\BigQueryWriteClient;
use Google\ApiCore\ApiException;
use Google\ApiCore\BidiStream;
use Google\ApiCore\CredentialsWrapper;
use Google\ApiCore\Testing\GeneratedTest;
use Google\ApiCore\Testing\MockTransport;
use Google\Cloud\Bigquery\Storage\V1alpha2\AppendRowsRequest;
use Google\Cloud\Bigquery\Storage\V1alpha2\AppendRowsResponse;
use Google\Cloud\Bigquery\Storage\V1alpha2\BatchCommitWriteStreamsResponse;
use Google\Cloud\Bigquery\Storage\V1alpha2\FinalizeWriteStreamResponse;
use Google\Cloud\Bigquery\Storage\V1alpha2\FlushRowsResponse;
use Google\Cloud\Bigquery\Storage\V1alpha2\WriteStream;
...
class BigQueryWriteClientTest extends GeneratedTest
{
    ...
    public function createWriteStreamTest()
    {
        ...
        $this->assertSame('/google.cloud.bigquery.storage.v1alpha2.BigQueryWrite/CreateWriteStream', $actualFuncCall);
    ...
    public function appendRowsTest()
    {
        ...
        $expectedResponse2->setOffset($offset2);
        $transport->addResponse($expectedResponse2);
        $offset3 = 755984505;
        $expectedResponse3 = new AppendRowsResponse();
        $expectedResponse3->setOffset($offset3);
        ...
        $this->assertSame('/google.cloud.bigquery.storage.v1alpha2.BigQueryWrite/AppendRows', $streamFuncCall);
    ...
    public function getWriteStreamTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.storage.v1alpha2.BigQueryWrite/GetWriteStream', $actualFuncCall);
    ...
    public function finalizeWriteStreamTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.storage.v1alpha2.BigQueryWrite/FinalizeWriteStream', $actualFuncCall);
    ...
    public function batchCommitWriteStreamsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.storage.v1alpha2.BigQueryWrite/BatchCommitWriteStreams', $actualFuncCall);
    ...
    public function flushRowsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.storage.v1alpha2.BigQueryWrite/FlushRows', $actualFuncCall);
