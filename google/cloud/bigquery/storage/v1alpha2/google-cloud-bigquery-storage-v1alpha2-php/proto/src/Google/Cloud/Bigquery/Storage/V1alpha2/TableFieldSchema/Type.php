...
namespace Google\Cloud\Bigquery\Storage\V1alpha2\TableFieldSchema;

use UnexpectedValueException;

/**
 * Protobuf type <code>google.cloud.bigquery.storage.v1alpha2.TableFieldSchema.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\Bigquery\Storage\V1alpha2\TableFieldSchema_Type::class);
