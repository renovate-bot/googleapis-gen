    ...
    async def create_write_stream(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                should not be set.
            write_stream (:class:`google.cloud.bigquery.storage_v1alpha2.types.WriteStream`):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    def append_rows(self,
        ...
        Returns:
            AsyncIterable[google.cloud.bigquery.storage_v1alpha2.types.AppendRowsResponse]:
