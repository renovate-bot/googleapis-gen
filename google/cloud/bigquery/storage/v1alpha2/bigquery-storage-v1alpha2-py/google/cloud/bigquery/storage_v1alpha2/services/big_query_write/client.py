...
class BigQueryWriteClient(metaclass=BigQueryWriteClientMeta):
    ...
    def table_path(project: str,dataset: str,table: str,) -> str:
        ...
        return "projects/{project}/datasets/{dataset}/tables/{table}".format(project=project, dataset=dataset, table=table, )

    @staticmethod
    def parse_table_path(path: str) -> Dict[str,str]:
        """Parse a table path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/datasets/(?P<dataset>.+?)/tables/(?P<table>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def write_stream_path(project: str,dataset: str,table: str,stream: str,) -> str:
        """Return a fully-qualified write_stream string."""
        return "projects/{project}/datasets/{dataset}/tables/{table}/streams/{stream}".format(project=project, dataset=dataset, table=table, stream=stream, )

    @staticmethod
    def parse_write_stream_path(path: str) -> Dict[str,str]:
        """Parse a write_stream path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/datasets/(?P<dataset>.+?)/tables/(?P<table>.+?)/streams/(?P<stream>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def create_write_stream(self,
        ...
        Returns:
            google.cloud.bigquery.storage_v1alpha2.types.WriteStream:
    ...
    def append_rows(self,
        ...
        Returns:
            Iterable[google.cloud.bigquery.storage_v1alpha2.types.AppendRowsResponse]:
    ...
    def finalize_write_stream(self,
        ...
        Returns:
            google.cloud.bigquery.storage_v1alpha2.types.FinalizeWriteStreamResponse:
    ...
    def batch_commit_write_streams(self,
        ...
        Returns:
            google.cloud.bigquery.storage_v1alpha2.types.BatchCommitWriteStreamsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_commit_write_streams]
    ...
    def flush_rows(self,
        ...
        Returns:
            google.cloud.bigquery.storage_v1alpha2.types.FlushRowsResponse:
