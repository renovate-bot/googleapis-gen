...
def test_big_query_write_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery.storage_v1alpha2.services.big_query_write.transports.BigQueryWriteGrpcTransport.__init__') as grpc_transport:
...
def test_big_query_write_base_transport():
    ...
    with mock.patch('google.cloud.bigquery.storage_v1alpha2.services.big_query_write.transports.BigQueryWriteTransport.__init__') as Transport:
...
def test_big_query_write_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery.storage_v1alpha2.services.big_query_write.transports.BigQueryWriteTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_big_query_write_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery.storage_v1alpha2.services.big_query_write.transports.BigQueryWriteTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BigQueryWriteTransport()
        adc.assert_called_once()
