...
use Google\Cloud\Bigquery\Storage\V1beta1\ShardingStrategy;
...
class BigQueryStorageGapicClient
{
    ...
    public function createReadSession($tableReference, $parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor([
          'table_reference.project_id' => $request->getTableReference()->getProjectId(),
          'table_reference.dataset_id' => $request->getTableReference()->getDatasetId(),
        ]);
    ...
    public function readRows($readPosition, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor([
          'read_position.stream.name' => $request->getReadPosition()->getStream()->getName(),
        ]);
        $optionalArgs['headers'] = isset($optionalArgs['headers'])
            ? array_merge($requestParams->getHeader(), $optionalArgs['headers'])
            : $requestParams->getHeader();
    ...
    public function batchCreateReadSessionStreams($session, $requestedStreams, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor([
          'session.name' => $request->getSession()->getName(),
        ]);
        $optionalArgs['headers'] = isset($optionalArgs['headers'])
            ? array_merge($requestParams->getHeader(), $optionalArgs['headers'])
            : $requestParams->getHeader();
    ...
    public function splitReadStream($originalStream, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor([
          'original_stream.name' => $request->getOriginalStream()->getName(),
        ]);
        $optionalArgs['headers'] = isset($optionalArgs['headers'])
            ? array_merge($requestParams->getHeader(), $optionalArgs['headers'])
            : $requestParams->getHeader();
