...
class ReadSession(proto.Message):
    ...
    Attributes:
        ...
        table_modifiers (google.cloud.bigquery.storage_v1beta1.types.TableModifiers):
            Any modifiers which are applied when reading
            from the specified table.
        sharding_strategy (google.cloud.bigquery.storage_v1beta1.types.ShardingStrategy):
...
class CreateReadSessionRequest(proto.Message):
    ...
    Attributes:
        ...
        read_options (google.cloud.bigquery.storage_v1beta1.types.TableReadOptions):
            Read options for this session (e.g. column
            selection, filters).
        format_ (google.cloud.bigquery.storage_v1beta1.types.DataFormat):
...
class StreamStatus(proto.Message):
    ...
    Attributes:
        ...
        progress (google.cloud.bigquery.storage_v1beta1.types.Progress):
...
class ReadRowsResponse(proto.Message):
    ...
    Attributes:
        ...
        status (google.cloud.bigquery.storage_v1beta1.types.StreamStatus):
            Estimated stream statistics.
        throttle_status (google.cloud.bigquery.storage_v1beta1.types.ThrottleStatus):
...
class SplitReadStreamResponse(proto.Message):
    ...
    Attributes:
        ...
        remainder_stream (google.cloud.bigquery.storage_v1beta1.types.Stream):
