...
class BigQueryStorageAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            BigQueryStorageAsyncClient: The constructed client.
        """
        return BigQueryStorageClient.from_service_account_info.__func__(BigQueryStorageAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            BigQueryStorageAsyncClient: The constructed client.
        """
        return BigQueryStorageClient.from_service_account_file.__func__(BigQueryStorageAsyncClient, filename, *args, **kwargs)  # type: ignore
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    def read_rows(self,
        ...
        Returns:
            AsyncIterable[google.cloud.bigquery.storage_v1beta1.types.ReadRowsResponse]:
