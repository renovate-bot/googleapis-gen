...
class BigQueryStorageClient(metaclass=BigQueryStorageClientMeta):
    ...
    @property
    def transport(self) -> BigQueryStorageTransport:
        """Returns the transport used by the client instance.

        Returns:
            BigQueryStorageTransport: The transport used by the client
                instance.
        """
    ...
    def read_session_path(project: str,location: str,session: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/sessions/{session}".format(project=project, location=location, session=session, )

    @staticmethod
    def parse_read_session_path(path: str) -> Dict[str,str]:
        """Parses a read_session path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/sessions/(?P<session>.+?)$", path)
    ...
    def __init__(self, *,
            ...
            transport: Union[str, BigQueryStorageTransport, None] = None,
            client_options: Optional[client_options_lib.ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the big query storage client.
    ...
    def create_read_session(self,
        ...
        Returns:
            google.cloud.bigquery.storage_v1beta1.types.ReadSession:
    ...
    def read_rows(self,
        ...
        Returns:
            Iterable[google.cloud.bigquery.storage_v1beta1.types.ReadRowsResponse]:
    ...
    def batch_create_read_session_streams(self,
        ...
        Returns:
            google.cloud.bigquery.storage_v1beta1.types.BatchCreateReadSessionStreamsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_create_read_session_streams]
    ...
    def split_read_stream(self,
        ...
        Returns:
            google.cloud.bigquery.storage_v1beta1.types.SplitReadStreamResponse:
