...
class BigQueryStorageTransport(abc.ABC):
    ...
    @property
    def create_read_session(self) -> typing.Callable[
            [storage.CreateReadSessionRequest],
            typing.Union[
                storage.ReadSession,
                typing.Awaitable[storage.ReadSession]
            ]]:
    ...
    def read_rows(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[storage.ReadRowsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def batch_create_read_session_streams(self) -> typing.Callable[
            [storage.BatchCreateReadSessionStreamsRequest],
            typing.Union[
                storage.BatchCreateReadSessionStreamsResponse,
                typing.Awaitable[storage.BatchCreateReadSessionStreamsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def finalize_stream(self) -> typing.Callable[
    ...
    @property
    def split_read_stream(self) -> typing.Callable[
