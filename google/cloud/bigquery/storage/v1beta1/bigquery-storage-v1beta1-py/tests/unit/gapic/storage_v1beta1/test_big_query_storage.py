...
def test_big_query_storage_client_service_account_always_use_jwt(client_class):
...
def test_big_query_storage_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
