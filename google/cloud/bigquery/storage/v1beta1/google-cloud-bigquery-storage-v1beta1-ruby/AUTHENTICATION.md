...
In general, the google-cloud-bigquery-storage-v1beta1 library uses
...
```sh
export STORAGE_CREDENTIALS=path/to/keyfile.json
```
...
The google-cloud-bigquery-storage-v1beta1 library aims to make authentication
...
The environment variables that google-cloud-bigquery-storage-v1beta1
checks for credentials are configured on the service Credentials class (such as
{::Google::Cloud::Bigquery::Storage::V1beta1::BigQueryStorage::Credentials}):
...
connect to most services with google-cloud-bigquery-storage-v1beta1.
