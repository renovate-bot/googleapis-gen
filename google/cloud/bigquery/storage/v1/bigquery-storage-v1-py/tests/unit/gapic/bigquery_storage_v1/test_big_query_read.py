...
from google.cloud.bigquery_storage_v1.services.big_query_read.transports.base import _API_CORE_VERSION
from google.cloud.bigquery_storage_v1.services.big_query_read.transports.base import _GOOGLE_AUTH_VERSION
...
def test_big_query_read_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery_storage_v1.services.big_query_read.transports.BigQueryReadGrpcTransport.__init__') as grpc_transport:
...
def test_big_query_read_base_transport():
    ...
    with mock.patch('google.cloud.bigquery_storage_v1.services.big_query_read.transports.BigQueryReadTransport.__init__') as Transport:
...
def test_big_query_read_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery_storage_v1.services.big_query_read.transports.BigQueryReadTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_big_query_read_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery_storage_v1.services.big_query_read.transports.BigQueryReadTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.BigQueryReadTransport()
        adc.assert_called_once()
