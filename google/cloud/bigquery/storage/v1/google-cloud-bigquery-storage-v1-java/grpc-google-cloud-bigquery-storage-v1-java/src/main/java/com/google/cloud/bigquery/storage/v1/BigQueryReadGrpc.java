...
public final class BigQueryReadGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.bigquery.storage.v1.CreateReadSessionRequest,
      com.google.cloud.bigquery.storage.v1.ReadSession> getCreateReadSessionMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.bigquery.storage.v1.CreateReadSessionRequest,
      com.google.cloud.bigquery.storage.v1.ReadSession> getCreateReadSessionMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.bigquery.storage.v1.CreateReadSessionRequest, com.google.cloud.bigquery.storage.v1.ReadSession> getCreateReadSessionMethod;
      ...
      synchronized (BigQueryReadGrpc.class) {
        if ((getCreateReadSessionMethod = BigQueryReadGrpc.getCreateReadSessionMethod) == null) {
          BigQueryReadGrpc.getCreateReadSessionMethod = getCreateReadSessionMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.bigquery.storage.v1.CreateReadSessionRequest, com.google.cloud.bigquery.storage.v1.ReadSession>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.bigquery.storage.v1.ReadRowsRequest,
      com.google.cloud.bigquery.storage.v1.ReadRowsResponse> getReadRowsMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.bigquery.storage.v1.ReadRowsRequest,
      com.google.cloud.bigquery.storage.v1.ReadRowsResponse> getReadRowsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.bigquery.storage.v1.ReadRowsRequest, com.google.cloud.bigquery.storage.v1.ReadRowsResponse> getReadRowsMethod;
    if ((getReadRowsMethod = BigQueryReadGrpc.getReadRowsMethod) == null) {
      synchronized (BigQueryReadGrpc.class) {
        if ((getReadRowsMethod = BigQueryReadGrpc.getReadRowsMethod) == null) {
          BigQueryReadGrpc.getReadRowsMethod = getReadRowsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.bigquery.storage.v1.ReadRowsRequest, com.google.cloud.bigquery.storage.v1.ReadRowsResponse>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.bigquery.storage.v1.SplitReadStreamRequest,
      com.google.cloud.bigquery.storage.v1.SplitReadStreamResponse> getSplitReadStreamMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.bigquery.storage.v1.SplitReadStreamRequest,
      com.google.cloud.bigquery.storage.v1.SplitReadStreamResponse> getSplitReadStreamMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.bigquery.storage.v1.SplitReadStreamRequest, com.google.cloud.bigquery.storage.v1.SplitReadStreamResponse> getSplitReadStreamMethod;
      ...
      synchronized (BigQueryReadGrpc.class) {
        if ((getSplitReadStreamMethod = BigQueryReadGrpc.getSplitReadStreamMethod) == null) {
          BigQueryReadGrpc.getSplitReadStreamMethod = getSplitReadStreamMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.bigquery.storage.v1.SplitReadStreamRequest, com.google.cloud.bigquery.storage.v1.SplitReadStreamResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
   ...
   * </pre>
   */
  public static abstract class BigQueryReadImplBase implements io.grpc.BindableService {
    ...
    public void createReadSession(com.google.cloud.bigquery.storage.v1.CreateReadSessionRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.bigquery.storage.v1.ReadSession> responseObserver) {
    ...
    public void readRows(com.google.cloud.bigquery.storage.v1.ReadRowsRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.bigquery.storage.v1.ReadRowsResponse> responseObserver) {
    ...
    public void splitReadStream(com.google.cloud.bigquery.storage.v1.SplitReadStreamRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.bigquery.storage.v1.SplitReadStreamResponse> responseObserver) {
   ...
   * </pre>
   */
  public static final class BigQueryReadStub extends io.grpc.stub.AbstractAsyncStub<BigQueryReadStub> {
   ...
   * </pre>
   */
  public static final class BigQueryReadBlockingStub extends io.grpc.stub.AbstractBlockingStub<BigQueryReadBlockingStub> {
   ...
   * </pre>
   */
  public static final class BigQueryReadFutureStub extends io.grpc.stub.AbstractFutureStub<BigQueryReadFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.bigquery.storage.v1.ReadSession> createReadSession(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.bigquery.storage.v1.SplitReadStreamResponse> splitReadStream(
