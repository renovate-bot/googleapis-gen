...
public interface ReadSessionOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.bigquery.storage.v1.AvroSchema avro_schema = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.bigquery.storage.v1.ArrowSchema arrow_schema = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>string table = 6 [(.google.api.field_behavior) = IMMUTABLE, (.google.api.resource_reference) = { ... }</code>
   * @return The table.
   */
   ...
   * <code>.google.cloud.bigquery.storage.v1.ReadSession.TableModifiers table_modifiers = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.bigquery.storage.v1.ReadSession.TableModifiersOrBuilder getTableModifiersOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.bigquery.storage.v1.ReadSession.TableReadOptions read_options = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * <code>.google.cloud.bigquery.storage.v1.ReadSession.TableReadOptions read_options = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.bigquery.storage.v1.ReadSession.TableReadOptionsOrBuilder getReadOptionsOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.bigquery.storage.v1.ReadStream streams = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.bigquery.storage.v1.ReadStream> 
      getStreamsList();
  /**
   * <pre>
   * Output only. A list of streams created with the session.
   ...
   * <code>repeated .google.cloud.bigquery.storage.v1.ReadStream streams = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.bigquery.storage.v1.ReadStreamOrBuilder getStreamsOrBuilder(
      int index);
