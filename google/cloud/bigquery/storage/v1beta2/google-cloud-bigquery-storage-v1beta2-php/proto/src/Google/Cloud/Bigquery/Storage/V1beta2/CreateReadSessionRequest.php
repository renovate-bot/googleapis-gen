 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.storage.v1beta2.CreateReadSessionRequest</code>
 */
class CreateReadSessionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The request project that owns the session, in the form of
     *           `projects/{project_id}`.
     *     @type \Google\Cloud\Bigquery\Storage\V1beta2\ReadSession $read_session
     *           Required. Session to be created.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.storage.v1beta2.ReadSession read_session = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Bigquery\Storage\V1beta2\ReadSession $var
     * @return $this
     */
    public function setReadSession($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Bigquery\Storage\V1beta2\ReadSession::class);
