...
namespace Google\Cloud\Bigquery\Storage\V1beta2\AppendRowsResponse;
...
class_alias(AppendResult::class, \Google\Cloud\Bigquery\Storage\V1beta2\AppendRowsResponse_AppendResult::class);
