...
namespace Google\Cloud\Bigquery\Storage\V1beta2\AppendRowsRequest;
 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.storage.v1beta2.AppendRowsRequest.ProtoData</code>
 */
class ProtoData extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Bigquery\Storage\V1beta2\ProtoSchema $writer_schema
     *           Proto schema used to serialize the data.
     *     @type \Google\Cloud\Bigquery\Storage\V1beta2\ProtoRows $rows
     *           Serialized row data in protobuf message format.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.storage.v1beta2.ProtoSchema writer_schema = 1;</code>
     * @param \Google\Cloud\Bigquery\Storage\V1beta2\ProtoSchema $var
     * @return $this
     */
    public function setWriterSchema($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Bigquery\Storage\V1beta2\ProtoSchema::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.storage.v1beta2.ProtoRows rows = 2;</code>
     * @param \Google\Cloud\Bigquery\Storage\V1beta2\ProtoRows $var
     * @return $this
     */
    public function setRows($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Bigquery\Storage\V1beta2\ProtoRows::class);
        $this->rows = $var;
...
class_alias(ProtoData::class, \Google\Cloud\Bigquery\Storage\V1beta2\AppendRowsRequest_ProtoData::class);
