 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.storage.v1beta2.ReadSession.TableReadOptions</code>
 */
class TableReadOptions extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $arrow_serialization_options = null;
    ...
    {
        return isset($this->arrow_serialization_options);
    }

    public function clearArrowSerializationOptions()
    {
        unset($this->arrow_serialization_options);
    }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.bigquery.storage.v1beta2.ArrowSerializationOptions arrow_serialization_options = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Bigquery\Storage\V1beta2\ArrowSerializationOptions $var
     * @return $this
     */
    public function setArrowSerializationOptions($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Bigquery\Storage\V1beta2\ArrowSerializationOptions::class);
        $this->arrow_serialization_options = $var;
...
class_alias(TableReadOptions::class, \Google\Cloud\Bigquery\Storage\V1beta2\ReadSession_TableReadOptions::class);
