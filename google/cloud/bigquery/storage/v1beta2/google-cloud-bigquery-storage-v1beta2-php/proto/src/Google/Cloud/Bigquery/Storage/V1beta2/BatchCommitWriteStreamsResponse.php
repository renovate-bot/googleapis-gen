 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.storage.v1beta2.BatchCommitWriteStreamsResponse</code>
 */
class BatchCommitWriteStreamsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Bigquery\Storage\V1beta2\StorageError::class);
