...
/**
 * Protobuf type <code>google.cloud.bigquery.storage.v1beta2.TableFieldSchema.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\Bigquery\Storage\V1beta2\TableFieldSchema_Type::class);
