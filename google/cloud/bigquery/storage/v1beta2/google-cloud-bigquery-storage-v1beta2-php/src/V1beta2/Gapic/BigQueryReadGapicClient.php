...
use Google\Cloud\Bigquery\Storage\V1beta2\CreateReadSessionRequest;
use Google\Cloud\Bigquery\Storage\V1beta2\ReadRowsRequest;
use Google\Cloud\Bigquery\Storage\V1beta2\ReadRowsResponse;
use Google\Cloud\Bigquery\Storage\V1beta2\ReadSession;
use Google\Cloud\Bigquery\Storage\V1beta2\SplitReadStreamRequest;
...
class BigQueryReadGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.bigquery.storage.v1beta2.BigQueryRead';
     ...
     * }
     *
     * @return \Google\Cloud\Bigquery\Storage\V1beta2\SplitReadStreamResponse
     *
     * @throws ApiException if the remote call fails
     * @experimental
     */
