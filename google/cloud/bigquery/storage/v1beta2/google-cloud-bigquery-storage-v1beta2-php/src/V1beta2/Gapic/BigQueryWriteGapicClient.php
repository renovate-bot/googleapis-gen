 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/bigquery/storage/v1beta2/storage.proto
...
class BigQueryWriteGapicClient
{
    ...
    {
        return $this->startCall('AppendRows', AppendRowsResponse::class, $optionalArgs, null, Call::BIDI_STREAMING_CALL);
    }
    ...
    public function batchCommitWriteStreams($parent, $writeStreams, array $optionalArgs = [])
    {
        ...
        return $this->startCall('BatchCommitWriteStreams', BatchCommitWriteStreamsResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function createWriteStream($parent, $writeStream, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateWriteStream', WriteStream::class, $optionalArgs, $request)->wait();
    }
    ...
    public function finalizeWriteStream($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('FinalizeWriteStream', FinalizeWriteStreamResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function flushRows($writeStream, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('FlushRows', FlushRowsResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getWriteStream($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetWriteStream', WriteStream::class, $optionalArgs, $request)->wait();
    }
}
