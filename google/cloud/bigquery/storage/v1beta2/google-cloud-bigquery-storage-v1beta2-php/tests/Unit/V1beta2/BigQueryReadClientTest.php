...
use Google\Cloud\Bigquery\Storage\V1beta2\BigQueryReadClient;
use Google\Cloud\Bigquery\Storage\V1beta2\ReadRowsResponse;
use Google\Cloud\Bigquery\Storage\V1beta2\ReadSession;
use Google\Cloud\Bigquery\Storage\V1beta2\SplitReadStreamResponse;
use Google\Rpc\Code;
use stdClass;
...
class BigQueryReadClientTest extends GeneratedTest
{
    ...
    public function createReadSessionTest()
    {
        ...
        $this->assertSame('/google.cloud.bigquery.storage.v1beta2.BigQueryRead/CreateReadSession', $actualFuncCall);
    ...
    public function readRowsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.storage.v1beta2.BigQueryRead/ReadRows', $actualFuncCall);
    ...
    public function splitReadStreamTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.storage.v1beta2.BigQueryRead/SplitReadStream', $actualFuncCall);
