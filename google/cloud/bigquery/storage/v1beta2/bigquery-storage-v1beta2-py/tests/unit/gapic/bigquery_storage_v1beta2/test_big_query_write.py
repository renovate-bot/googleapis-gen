...
from google.cloud.bigquery_storage_v1beta2.services.big_query_write import BigQueryWriteClient
from google.cloud.bigquery_storage_v1beta2.services.big_query_write import transports
from google.cloud.bigquery_storage_v1beta2.services.big_query_write.transports.base import _API_CORE_VERSION
from google.cloud.bigquery_storage_v1beta2.services.big_query_write.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert BigQueryWriteClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert BigQueryWriteClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert BigQueryWriteClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert BigQueryWriteClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert BigQueryWriteClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (BigQueryWriteAsyncClient, transports.BigQueryWriteGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
def test_big_query_write_client_client_options(client_class, transport_class, transport_name):
...
def test_big_query_write_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_big_query_write_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_big_query_write_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_big_query_write_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery_storage_v1beta2.services.big_query_write.transports.BigQueryWriteGrpcTransport.__init__') as grpc_transport:
...
def test_append_rows(transport: str = 'grpc', request_type=storage.AppendRowsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.append_rows),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_append_rows_async(transport: str = 'grpc_asyncio', request_type=storage.AppendRowsRequest):
    client = BigQueryWriteAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_append_rows_flattened():
    client = BigQueryWriteClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_append_rows_flattened_async():
    client = BigQueryWriteAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_append_rows_flattened_error_async():
    client = BigQueryWriteAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_big_query_write_base_transport():
    ...
    with mock.patch('google.cloud.bigquery_storage_v1beta2.services.big_query_write.transports.BigQueryWriteTransport.__init__') as Transport:
...
def test_big_query_write_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery_storage_v1beta2.services.big_query_write.transports.BigQueryWriteTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_big_query_write_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery_storage_v1beta2.services.big_query_write.transports.BigQueryWriteTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BigQueryWriteTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.BigQueryWriteGrpcTransport, transports.BigQueryWriteGrpcAsyncIOTransport])
def test_big_query_write_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.BigQueryWriteGrpcTransport, transports.BigQueryWriteGrpcAsyncIOTransport])
def test_big_query_write_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
