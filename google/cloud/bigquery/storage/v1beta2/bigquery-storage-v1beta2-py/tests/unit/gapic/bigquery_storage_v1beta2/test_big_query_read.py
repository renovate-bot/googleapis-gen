...
from google.cloud.bigquery_storage_v1beta2.services.big_query_read import BigQueryReadAsyncClient
from google.cloud.bigquery_storage_v1beta2.services.big_query_read import BigQueryReadClient
from google.cloud.bigquery_storage_v1beta2.services.big_query_read import transports
from google.cloud.bigquery_storage_v1beta2.services.big_query_read.transports.base import _API_CORE_VERSION
from google.cloud.bigquery_storage_v1beta2.services.big_query_read.transports.base import _GOOGLE_AUTH_VERSION
...
def test__get_default_mtls_endpoint():
    ...
    assert BigQueryReadClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert BigQueryReadClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert BigQueryReadClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert BigQueryReadClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (BigQueryReadAsyncClient, transports.BigQueryReadGrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(BigQueryReadClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BigQueryReadClient))
@mock.patch.object(BigQueryReadAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BigQueryReadAsyncClient))
def test_big_query_read_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (BigQueryReadAsyncClient, transports.BigQueryReadGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (BigQueryReadClient, transports.BigQueryReadGrpcTransport, "grpc", "false"),
    (BigQueryReadAsyncClient, transports.BigQueryReadGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(BigQueryReadClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BigQueryReadClient))
@mock.patch.object(BigQueryReadAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BigQueryReadAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_big_query_read_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
def test_big_query_read_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_big_query_read_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_big_query_read_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery_storage_v1beta2.services.big_query_read.transports.BigQueryReadGrpcTransport.__init__') as grpc_transport:
...
def test_big_query_read_base_transport():
    ...
    with mock.patch('google.cloud.bigquery_storage_v1beta2.services.big_query_read.transports.BigQueryReadTransport.__init__') as Transport:
...
def test_big_query_read_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery_storage_v1beta2.services.big_query_read.transports.BigQueryReadTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_big_query_read_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery_storage_v1beta2.services.big_query_read.transports.BigQueryReadTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_big_query_read_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery_storage_v1beta2.services.big_query_read.transports.BigQueryReadTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BigQueryReadTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_big_query_read_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        BigQueryReadClient()
...
@requires_google_auth_gte_1_25_0
def test_big_query_read_transport_auth_adc(transport_class):
...
@requires_google_auth_lt_1_25_0
def test_big_query_read_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize(
    ...
    [
        (transports.BigQueryReadGrpcTransport, grpc_helpers),
        (transports.BigQueryReadGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
@requires_api_core_gte_1_26_0
def test_big_query_read_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_big_query_read_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_big_query_read_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@pytest.mark.parametrize("transport_class", [transports.BigQueryReadGrpcTransport, transports.BigQueryReadGrpcAsyncIOTransport])
def test_big_query_read_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.BigQueryReadGrpcTransport, transports.BigQueryReadGrpcAsyncIOTransport])
def test_big_query_read_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.BigQueryReadGrpcTransport, transports.BigQueryReadGrpcAsyncIOTransport])
def test_big_query_read_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(transports.BigQueryReadTransport, '_prep_wrapped_messages') as prep:
        client = BigQueryReadClient(
            credentials=ga_credentials.AnonymousCredentials(),
