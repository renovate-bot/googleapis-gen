...
class BigQueryWriteTransport(abc.ABC):
    ...
    @property
    def create_write_stream(self) -> typing.Callable[
            [storage.CreateWriteStreamRequest],
            typing.Union[
                stream.WriteStream,
                typing.Awaitable[stream.WriteStream]
            ]]:
        raise NotImplementedError()

    @property
    def append_rows(self) -> typing.Callable[
            [storage.AppendRowsRequest],
            typing.Union[
                storage.AppendRowsResponse,
                typing.Awaitable[storage.AppendRowsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_write_stream(self) -> typing.Callable[
    ...
    @property
    def finalize_write_stream(self) -> typing.Callable[
            [storage.FinalizeWriteStreamRequest],
            typing.Union[
                storage.FinalizeWriteStreamResponse,
                typing.Awaitable[storage.FinalizeWriteStreamResponse]
            ]]:
        raise NotImplementedError()

    @property
    def batch_commit_write_streams(self) -> typing.Callable[
            [storage.BatchCommitWriteStreamsRequest],
            typing.Union[
                storage.BatchCommitWriteStreamsResponse,
                typing.Awaitable[storage.BatchCommitWriteStreamsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def flush_rows(self) -> typing.Callable[
            [storage.FlushRowsRequest],
            typing.Union[
                storage.FlushRowsResponse,
                typing.Awaitable[storage.FlushRowsResponse]
            ]]:
        raise NotImplementedError()
