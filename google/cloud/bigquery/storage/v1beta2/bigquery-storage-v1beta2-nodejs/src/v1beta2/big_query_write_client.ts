...
export class BigQueryWriteClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.bigquery.storage.v1beta2.BigQueryWrite', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.bigQueryWriteStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.bigquery.storage.v1beta2.BigQueryWrite') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.bigquery.storage.v1beta2.BigQueryWrite,
 ...
 */
  createWriteStream(
      ...
      Promise<[
        ...
        protos.google.cloud.bigquery.storage.v1beta2.ICreateWriteStreamRequest|undefined, {}|undefined
      ]>;
  createWriteStream(
      request: protos.google.cloud.bigquery.storage.v1beta2.ICreateWriteStreamRequest,
      options: CallOptions,
 ...
 */
  getWriteStream(
      ...
      Promise<[
        protos.google.cloud.bigquery.storage.v1beta2.IWriteStream,
        protos.google.cloud.bigquery.storage.v1beta2.IGetWriteStreamRequest|undefined, {}|undefined
      ]>;
  getWriteStream(
      request: protos.google.cloud.bigquery.storage.v1beta2.IGetWriteStreamRequest,
      options: CallOptions,
 ...
 */
  finalizeWriteStream(
      ...
      Promise<[
        ...
        protos.google.cloud.bigquery.storage.v1beta2.IFinalizeWriteStreamRequest|undefined, {}|undefined
      ]>;
  finalizeWriteStream(
      request: protos.google.cloud.bigquery.storage.v1beta2.IFinalizeWriteStreamRequest,
      options: CallOptions,
 ...
 */
  batchCommitWriteStreams(
      ...
      Promise<[
        ...
        protos.google.cloud.bigquery.storage.v1beta2.IBatchCommitWriteStreamsRequest|undefined, {}|undefined
      ]>;
  batchCommitWriteStreams(
      request: protos.google.cloud.bigquery.storage.v1beta2.IBatchCommitWriteStreamsRequest,
      options: CallOptions,
 ...
 */
  flushRows(
      ...
      Promise<[
        ...
        protos.google.cloud.bigquery.storage.v1beta2.IFlushRowsRequest|undefined, {}|undefined
      ]>;
  flushRows(
      request: protos.google.cloud.bigquery.storage.v1beta2.IFlushRowsRequest,
      options: CallOptions,
