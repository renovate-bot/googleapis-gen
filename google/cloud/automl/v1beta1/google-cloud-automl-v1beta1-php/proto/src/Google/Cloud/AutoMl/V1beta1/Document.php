...
class Document extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.automl.v1beta1.Document.Layout layout = 3;</code>
     */
    private $layout;
    /**
     ...
     *           An input config specifying the content of the document.
     *     @type \Google\Cloud\AutoMl\V1beta1\TextSnippet $document_text
     *           The plain text version of this document.
     *     @type \Google\Cloud\AutoMl\V1beta1\Document\Layout[]|\Google\Protobuf\Internal\RepeatedField $layout
     *           Describes the layout of the document.
     *           Sorted by [page_number][].
     *     @type \Google\Cloud\AutoMl\V1beta1\DocumentDimensions $document_dimensions
     *           The dimensions of the page in the document.
     *     @type int $page_count
     *           Number of pages in the document.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.automl.v1beta1.Document.Layout layout = 3;</code>
     * @param \Google\Cloud\AutoMl\V1beta1\Document\Layout[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLayout($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AutoMl\V1beta1\Document\Layout::class);
        $this->layout = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.automl.v1beta1.DocumentDimensions document_dimensions = 4;</code>
     * @param \Google\Cloud\AutoMl\V1beta1\DocumentDimensions $var
     * @return $this
     */
    public function setDocumentDimensions($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AutoMl\V1beta1\DocumentDimensions::class);
