...
class AutoMlClient(metaclass=AutoMlClientMeta):
    ...
    @staticmethod
    def column_spec_path(project: str,location: str,dataset: str,table_spec: str,column_spec: str,) -> str:
        """Return a fully-qualified column_spec string."""
        return "projects/{project}/locations/{location}/datasets/{dataset}/tableSpecs/{table_spec}/columnSpecs/{column_spec}".format(project=project, location=location, dataset=dataset, table_spec=table_spec, column_spec=column_spec, )

    @staticmethod
    def parse_column_spec_path(path: str) -> Dict[str,str]:
        """Parse a column_spec path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasets/(?P<dataset>.+?)/tableSpecs/(?P<table_spec>.+?)/columnSpecs/(?P<column_spec>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def table_spec_path(project: str,location: str,dataset: str,table_spec: str,) -> str:
        """Return a fully-qualified table_spec string."""
        return "projects/{project}/locations/{location}/datasets/{dataset}/tableSpecs/{table_spec}".format(project=project, location=location, dataset=dataset, table_spec=table_spec, )

    @staticmethod
    def parse_table_spec_path(path: str) -> Dict[str,str]:
        """Parse a table_spec path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasets/(?P<dataset>.+?)/tableSpecs/(?P<table_spec>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def create_dataset(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.CreateDatasetRequest):
                The request object.
                Request message for
    ...
    def get_dataset(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.GetDatasetRequest):
                The request object.
                Request message for
    ...
    def update_dataset(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.UpdateDatasetRequest):
                The request object.
                Request message for
    ...
    def delete_dataset(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.DeleteDatasetRequest):
                The request object.
                Request message for
    ...
    def import_data(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.ImportDataRequest):
                The request object.
                Request message for
    ...
    def export_data(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.ExportDataRequest):
                The request object.
                Request message for
    ...
    def get_annotation_spec(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.GetAnnotationSpecRequest):
                The request object.
                Request message for
    ...
    def get_table_spec(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.GetTableSpecRequest):
                The request object.
                Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.GetTableSpecRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_table_spec]
    ...
    def list_table_specs(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.ListTableSpecsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_table_specs]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListTableSpecsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def update_table_spec(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.UpdateTableSpecRequest):
                The request object.
                Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.UpdateTableSpecRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_table_spec]
    ...
    def get_column_spec(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.GetColumnSpecRequest):
                The request object.
                Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.GetColumnSpecRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_column_spec]
    ...
    def list_column_specs(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.ListColumnSpecsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_column_specs]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListColumnSpecsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def update_column_spec(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.UpdateColumnSpecRequest):
                The request object.
                Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.UpdateColumnSpecRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_column_spec]
    ...
    def get_model(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.GetModelRequest):
                The request object.
                Request message for
    ...
    def deploy_model(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.DeployModelRequest):
                The request object.
                Request message for
    ...
    def undeploy_model(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.UndeployModelRequest):
                The request object.
                Request message for
    ...
    def export_model(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.ExportModelRequest):
                The request object.
                Request message for
    ...
    def export_evaluated_examples(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.ExportEvaluatedExamplesRequest):
                The request object.
                Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.ExportEvaluatedExamplesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_evaluated_examples]
    ...
    def get_model_evaluation(self,
        ...
        Args:
            request (google.cloud.automl_v1beta1.types.GetModelEvaluationRequest):
                The request object.
                Request message for
