...
from google.cloud.automl_v1beta1.services.prediction_service import PredictionServiceAsyncClient
from google.cloud.automl_v1beta1.services.prediction_service import PredictionServiceClient
from google.cloud.automl_v1beta1.services.prediction_service import transports
from google.cloud.automl_v1beta1.services.prediction_service.transports.base import _API_CORE_VERSION
from google.cloud.automl_v1beta1.services.prediction_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_prediction_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_prediction_service_client_client_options_from_dict():
    with mock.patch('google.cloud.automl_v1beta1.services.prediction_service.transports.PredictionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_predict(transport: str = 'grpc', request_type=prediction_service.PredictRequest):
    client = PredictionServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_predict_flattened():
    ...
    with mock.patch.object(
        ...
        client.predict(
            name='name_value',
            payload=data_items.ExamplePayload(image=data_items.Image(image_bytes=b'image_bytes_blob')),
        ...
        assert args[0].payload == data_items.ExamplePayload(image=data_items.Image(image_bytes=b'image_bytes_blob'))
...
def test_batch_predict_flattened():
    ...
    with mock.patch.object(
        ...
        client.batch_predict(
            name='name_value',
            input_config=io.BatchPredictInputConfig(gcs_source=io.GcsSource(input_uris=['input_uris_value'])),
            output_config=io.BatchPredictOutputConfig(gcs_destination=io.GcsDestination(output_uri_prefix='output_uri_prefix_value')),
            params={'key_value': 'value_value'},
        )
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].name == 'name_value'
        assert args[0].input_config == io.BatchPredictInputConfig(gcs_source=io.GcsSource(input_uris=['input_uris_value']))
        assert args[0].output_config == io.BatchPredictOutputConfig(gcs_destination=io.GcsDestination(output_uri_prefix='output_uri_prefix_value'))
        assert args[0].params == {'key_value': 'value_value'}
...
def test_prediction_service_base_transport():
    ...
    with mock.patch('google.cloud.automl_v1beta1.services.prediction_service.transports.PredictionServiceTransport.__init__') as Transport:
...
def test_prediction_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.automl_v1beta1.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_prediction_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.automl_v1beta1.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.PredictionServiceTransport()
        adc.assert_called_once()
...
def test_prediction_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_prediction_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
