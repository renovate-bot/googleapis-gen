...
namespace Google.Cloud.Automl.V1Beta1.Snippets
{
    ...
    public sealed partial class GeneratedAutoMlClientStandaloneSnippets
    {
        ...
        public async Task ListTableSpecsResourceNamesAsync()
        {
            // Snippet: ListTableSpecsAsync(DatasetName, string, int?, CallSettings)
            // Create client
            ...
            // Make the request
            PagedAsyncEnumerable<ListTableSpecsResponse, TableSpec> response = autoMlClient.ListTableSpecsAsync(parent);
