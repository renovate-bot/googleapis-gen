...
namespace Google.Cloud.Automl.V1Beta1.Snippets
{
    ...
    public sealed partial class GeneratedAutoMlClientStandaloneSnippets
    {
        ...
        public async Task ExportEvaluatedExamplesResourceNamesAsync()
        {
            // Snippet: ExportEvaluatedExamplesAsync(ModelName, ExportEvaluatedExamplesOutputConfig, CallSettings)
            // Additional: ExportEvaluatedExamplesAsync(ModelName, ExportEvaluatedExamplesOutputConfig, CancellationToken)
            // Create client
