...
namespace Google.Cloud.Automl.V1Beta1.Snippets
{
    ...
    public sealed partial class GeneratedAutoMlClientStandaloneSnippets
    {
        ...
        {
            // Snippet: ExportEvaluatedExamplesAsync(ExportEvaluatedExamplesRequest, CallSettings)
            // Additional: ExportEvaluatedExamplesAsync(ExportEvaluatedExamplesRequest, CancellationToken)
            // Create client
