...
namespace Google.Cloud.Automl.V1Beta1.Snippets
{
    ...
    public sealed partial class GeneratedAutoMlClientStandaloneSnippets
    {
        ...
        public async Task GetTableSpecRequestObjectAsync()
        {
            // Snippet: GetTableSpecAsync(GetTableSpecRequest, CallSettings)
            // Additional: GetTableSpecAsync(GetTableSpecRequest, CancellationToken)
            // Create client
            ...
            // Make the request
            TableSpec response = await autoMlClient.GetTableSpecAsync(request);
            // End snippet
        }
    }
}
