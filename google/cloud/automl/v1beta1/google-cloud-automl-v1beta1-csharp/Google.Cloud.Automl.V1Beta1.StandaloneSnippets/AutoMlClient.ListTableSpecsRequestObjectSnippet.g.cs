...
namespace Google.Cloud.Automl.V1Beta1.Snippets
{
    ...
    public sealed partial class GeneratedAutoMlClientStandaloneSnippets
    {
        ...
        public void ListTableSpecsRequestObject()
        {
            // Snippet: ListTableSpecs(ListTableSpecsRequest, CallSettings)
            // Create client
            ...
            // Make the request
            PagedEnumerable<ListTableSpecsResponse, TableSpec> response = autoMlClient.ListTableSpecs(request);
