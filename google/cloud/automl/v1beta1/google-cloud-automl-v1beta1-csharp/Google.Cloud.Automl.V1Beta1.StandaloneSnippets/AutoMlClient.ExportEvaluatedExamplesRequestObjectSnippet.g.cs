...
namespace Google.Cloud.Automl.V1Beta1.Snippets
{
    ...
    public sealed partial class GeneratedAutoMlClientStandaloneSnippets
    {
        ...
        public void ExportEvaluatedExamplesRequestObject()
        {
            // Snippet: ExportEvaluatedExamples(ExportEvaluatedExamplesRequest, CallSettings)
            // Create client
            ...
            // Make the request
            Operation<Empty, OperationMetadata> response = autoMlClient.ExportEvaluatedExamples(request);
