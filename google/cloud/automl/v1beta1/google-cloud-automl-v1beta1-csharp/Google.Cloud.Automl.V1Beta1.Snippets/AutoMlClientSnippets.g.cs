...
namespace Google.Cloud.Automl.V1Beta1.Snippets
{
    ...
    public sealed class GeneratedAutoMlClientSnippets
    {
        ...
        public async Task CreateDatasetRequestObjectAsync()
        {
            ...
            // Make the request
            Dataset response = await autoMlClient.CreateDatasetAsync(request);
            // End snippet
        }
        ...
        {
            // Snippet: ListTableSpecsAsync(ListTableSpecsRequest, CallSettings)
            // Create client
            AutoMlClient autoMlClient = await AutoMlClient.CreateAsync();
            // Initialize request argument(s)
            ListTableSpecsRequest request = new ListTableSpecsRequest
        ...
        /// <summary>Snippet for ListTableSpecs</summary>
        public async Task ListTableSpecsAsync()
        {
            // Snippet: ListTableSpecsAsync(string, string, int?, CallSettings)
            // Create client
            AutoMlClient autoMlClient = await AutoMlClient.CreateAsync();
            // Initialize request argument(s)
            string parent = "projects/[PROJECT]/locations/[LOCATION]/datasets/[DATASET]";
        ...
        {
            // Snippet: GetColumnSpecAsync(ColumnSpecName, CallSettings)
            // Additional: GetColumnSpecAsync(ColumnSpecName, CancellationToken)
            // Create client
            AutoMlClient autoMlClient = await AutoMlClient.CreateAsync();
            // Initialize request argument(s)
            ColumnSpecName name = ColumnSpecName.FromProjectLocationDatasetTableSpecColumnSpec("[PROJECT]", "[LOCATION]", "[DATASET]", "[TABLE_SPEC]", "[COLUMN_SPEC]");
        ...
        /// <summary>Snippet for ListColumnSpecs</summary>
        public async Task ListColumnSpecsRequestObjectAsync()
        {
            // Snippet: ListColumnSpecsAsync(ListColumnSpecsRequest, CallSettings)
            // Create client
            AutoMlClient autoMlClient = await AutoMlClient.CreateAsync();
            // Initialize request argument(s)
            ListColumnSpecsRequest request = new ListColumnSpecsRequest
            ...
            // Make the request
            PagedAsyncEnumerable<ListColumnSpecsResponse, ColumnSpec> response = autoMlClient.ListColumnSpecsAsync(request);
        ...
        /// <summary>Snippet for ListColumnSpecs</summary>
        public async Task ListColumnSpecsAsync()
        {
            // Snippet: ListColumnSpecsAsync(string, string, int?, CallSettings)
            // Create client
            AutoMlClient autoMlClient = await AutoMlClient.CreateAsync();
            // Initialize request argument(s)
            string parent = "projects/[PROJECT]/locations/[LOCATION]/datasets/[DATASET]/tableSpecs/[TABLE_SPEC]";
        ...
        {
            // Snippet: ExportEvaluatedExamples(string, ExportEvaluatedExamplesOutputConfig, CallSettings)
            // Create client
            AutoMlClient autoMlClient = AutoMlClient.Create();
            // Initialize request argument(s)
            string name = "projects/[PROJECT]/locations/[LOCATION]/models/[MODEL]";
        ...
        /// <summary>Snippet for ExportEvaluatedExamples</summary>
        public void ExportEvaluatedExamplesResourceNames()
        {
            // Snippet: ExportEvaluatedExamples(ModelName, ExportEvaluatedExamplesOutputConfig, CallSettings)
            // Create client
            AutoMlClient autoMlClient = AutoMlClient.Create();
            // Initialize request argument(s)
            ModelName name = ModelName.FromProjectLocationModel("[PROJECT]", "[LOCATION]", "[MODEL]");
