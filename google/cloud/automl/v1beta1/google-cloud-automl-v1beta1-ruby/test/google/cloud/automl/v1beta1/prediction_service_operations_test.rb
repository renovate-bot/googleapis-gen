...
class ::Google::Cloud::AutoML::V1beta1::PredictionService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::AutoML::V1beta1::PredictionService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AutoML::V1beta1::PredictionService::Operations::Configuration, config
  end
end
