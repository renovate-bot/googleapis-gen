...
class ::Google::Cloud::AutoML::V1::AutoML::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::AutoML::V1::AutoML::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::AutoML::V1::AutoML::Operations::Configuration, config
  end
end
