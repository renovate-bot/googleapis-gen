...
describe('v1.IDSClient', () => {
    ...
    describe('getEndpoint', () => {
        it('invokes getEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.ids.v1.GetEndpointRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.ids.v1.Endpoint());
    ...
    describe('createEndpoint', () => {
        it('invokes createEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.ids.v1.CreateEndpointRequest());
            request.parent = '';
    ...
    describe('listEndpoints', () => {
        it('invokes listEndpoints without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.ids.v1.ListEndpointsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
