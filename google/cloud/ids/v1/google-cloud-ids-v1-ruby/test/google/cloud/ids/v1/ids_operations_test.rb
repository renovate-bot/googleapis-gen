...
class ::Google::Cloud::Ids::V1::IDS::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Ids::V1::IDS::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Ids::V1::IDS::Operations::Configuration, config
  end
end
