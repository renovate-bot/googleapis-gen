...
class IDSClient(metaclass=IDSClientMeta):
    """The IDS Service"""
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            IDSClient: The constructed client.
        """
    ...
    def transport(self) -> IDSTransport:
        ...
        Returns:
            IDSTransport: The transport used by the client
                instance.
        """
    ...
    def create_endpoint(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a ids.CreateEndpointRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_endpoint(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a ids.DeleteEndpointRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
