...
class IDSAsyncClient:
    ...
    parse_common_billing_account_path = staticmethod(IDSClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(IDSClient.parse_common_organization_path)
    ...
    get_transport_class = functools.partial(type(IDSClient).get_transport_class, type(IDSClient))
