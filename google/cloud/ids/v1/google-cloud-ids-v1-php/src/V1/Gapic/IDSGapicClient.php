 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/ids/v1/ids.proto
...
class IDSGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'descriptorsConfigPath' => __DIR__ . '/../resources/ids_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/ids_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ids_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function deleteEndpoint($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteEndpoint', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
