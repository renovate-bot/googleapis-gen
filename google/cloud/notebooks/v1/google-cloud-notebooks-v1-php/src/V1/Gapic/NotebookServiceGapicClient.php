...
use Google\Cloud\Notebooks\V1\Instance\ShieldedInstanceConfig;
use Google\Cloud\Notebooks\V1\InstanceConfig;
...
class NotebookServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.notebooks.v1.NotebookService';
    ...
    private static function getExecutionNameTemplate()
    {
        if (self::$executionNameTemplate == null) {
            self::$executionNameTemplate = new PathTemplate('projects/{project}/location/{location}/executions/{execution}');
        }
    ...
    private static function getScheduleNameTemplate()
    {
        if (self::$scheduleNameTemplate == null) {
            self::$scheduleNameTemplate = new PathTemplate('projects/{project}/location/{location}/schedules/{schedule}');
        }
     ...
     */
    public static function executionName($project, $location, $execution)
    {
     ...
     *     $operationResponse = $notebookServiceClient->createExecution($formattedParent, $executionId, $execution);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *     // doSomethingWith($result)
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $notebookServiceClient->resumeOperation($operationName, 'createExecution');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @param Execution $execution    Required. The execution to be created.
     * @param array     $optionalArgs {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException if the remote call fails
     */
    public function createExecution($parent, $executionId, $execution, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateExecution', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     *     $operationResponse = $notebookServiceClient->createSchedule($formattedParent, $scheduleId, $schedule);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *     // doSomethingWith($result)
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $notebookServiceClient->resumeOperation($operationName, 'createSchedule');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @param Schedule $schedule     Required. The schedule to be created.
     * @param array    $optionalArgs {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException if the remote call fails
     */
    public function createSchedule($parent, $scheduleId, $schedule, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateSchedule', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     *     $operationResponse = $notebookServiceClient->deleteExecution($formattedName);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // operation succeeded and returns no value
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $notebookServiceClient->resumeOperation($operationName, 'deleteExecution');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     *     $operationResponse = $notebookServiceClient->deleteSchedule($formattedName);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // operation succeeded and returns no value
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $notebookServiceClient->resumeOperation($operationName, 'deleteSchedule');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * try {
     *     $formattedName = $notebookServiceClient->executionName('[PROJECT]', '[LOCATION]', '[EXECUTION]');
     *     $response = $notebookServiceClient->getExecution($formattedName);
     * } finally {
     *     $notebookServiceClient->close();
     * }
     * ```
     ...
     *     $response = $notebookServiceClient->getInstanceHealth($formattedName);
     * } finally {
     *     $notebookServiceClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function getInstanceHealth($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetInstanceHealth', GetInstanceHealthResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * try {
     *     $formattedName = $notebookServiceClient->scheduleName('[PROJECT]', '[LOCATION]', '[SCHEDULE]');
     *     $response = $notebookServiceClient->getSchedule($formattedName);
     * } finally {
     *     $notebookServiceClient->close();
     * }
     * ```
     ...
     *     $formattedParent = $notebookServiceClient->executionName('[PROJECT]', '[LOCATION]', '[EXECUTION]');
     *     // Iterate over pages of elements
     *     $pagedResponse = $notebookServiceClient->listExecutions($formattedParent);
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
     ...
     *     $formattedParent = $notebookServiceClient->scheduleName('[PROJECT]', '[LOCATION]', '[SCHEDULE]');
     *     // Iterate over pages of elements
     *     $pagedResponse = $notebookServiceClient->listSchedules($formattedParent);
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
     ...
     *     $operationResponse = $notebookServiceClient->rollbackInstance($name, $targetSnapshot);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *     // doSomethingWith($result)
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $notebookServiceClient->resumeOperation($operationName, 'rollbackInstance');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @param string $name           Required. Format:
     *                               `projects/{project_id}/locations/{location}/instances/{instance_id}`
     * @param string $targetSnapshot Required. The snapshot for rollback.
     ...
     * @throws ApiException if the remote call fails
     */
    public function rollbackInstance($name, $targetSnapshot, array $optionalArgs = [])
    {
        $request = new RollbackInstanceRequest();
        $requestParamHeaders = [];
        $request->setName($name);
        $request->setTargetSnapshot($targetSnapshot);
        $requestParamHeaders['name'] = $name;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('RollbackInstance', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     *                             For allowed values, use constants defined on {@see \Google\Cloud\Notebooks\V1\Instance\AcceleratorType}
     ...
     * try {
     *     $formattedName = $notebookServiceClient->scheduleName('[PROJECT]', '[LOCATION]', '[SCHEDULE]');
     *     $operationResponse = $notebookServiceClient->triggerSchedule($formattedName);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *     // doSomethingWith($result)
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $notebookServiceClient->resumeOperation($operationName, 'triggerSchedule');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function triggerSchedule($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('TriggerSchedule', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * try {
     *     $name = 'name';
     *     $operationResponse = $notebookServiceClient->updateInstanceConfig($name);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *     // doSomethingWith($result)
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $notebookServiceClient->resumeOperation($operationName, 'updateInstanceConfig');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateInstanceConfig($name, array $optionalArgs = [])
    {
     ...
     * try {
     *     $name = 'name';
     *     $operationResponse = $notebookServiceClient->updateShieldedInstanceConfig($name);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *     // doSomethingWith($result)
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $notebookServiceClient->resumeOperation($operationName, 'updateShieldedInstanceConfig');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     *     Optional.
     *
     *     @type ShieldedInstanceConfig $shieldedInstanceConfig
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateShieldedInstanceConfig($name, array $optionalArgs = [])
    {
        $request = new UpdateShieldedInstanceConfigRequest();
        $requestParamHeaders = [];
        $request->setName($name);
        $requestParamHeaders['name'] = $name;
        if (isset($optionalArgs['shieldedInstanceConfig'])) {
            $request->setShieldedInstanceConfig($optionalArgs['shieldedInstanceConfig']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateShieldedInstanceConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
