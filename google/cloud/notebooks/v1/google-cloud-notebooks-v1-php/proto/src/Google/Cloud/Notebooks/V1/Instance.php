...
class Instance extends \Google\Protobuf\Internal\Message
{
     ...
     *           `projects/{project_id}/locations/{location}/keyRings/{key_ring_id}/cryptoKeys/{key_id}`
     *           Learn more about [using your own encryption keys](/kms/docs/quickstart).
     *     @type \Google\Cloud\Notebooks\V1\Instance\Disk[]|\Google\Protobuf\Internal\RepeatedField $disks
     *           Output only. Attached disks to notebook instance.
     ...
     *           Optional. The Compute Engine tags to add to runtime (see [Tagging
     *           instances](https://cloud.google.com/compute/docs/label-or-tag-resources#tags)).
     *     @type \Google\Cloud\Notebooks\V1\Instance\UpgradeHistoryEntry[]|\Google\Protobuf\Internal\RepeatedField $upgrade_history
     *           The upgrade history of this instance.
     *     @type int $nic_type
     *           Optional. The type of vNIC to be used on this interface. This may be gVNIC or
     *           VirtioNet.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.notebooks.v1.Instance.Disk disks = 28 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Notebooks\V1\Instance\Disk[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.notebooks.v1.Instance.UpgradeHistoryEntry upgrade_history = 29;</code>
     * @param \Google\Cloud\Notebooks\V1\Instance\UpgradeHistoryEntry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
