 ...
 * instance.
 *
 * Protobuf type <code>google.cloud.notebooks.v1.Instance.AcceleratorType</code>
 */
...
class_alias(AcceleratorType::class, \Google\Cloud\Notebooks\V1\Instance_AcceleratorType::class);
