...
class VirtualMachineConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *           * `n1-standard-2`
     *           * `e2-standard-8`
     *     @type \Google\Cloud\Notebooks\V1\ContainerImage[]|\Google\Protobuf\Internal\RepeatedField $container_images
     *           Optional. Use a list of container images to start the notebook instance.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.notebooks.v1.ContainerImage container_images = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Notebooks\V1\ContainerImage[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
