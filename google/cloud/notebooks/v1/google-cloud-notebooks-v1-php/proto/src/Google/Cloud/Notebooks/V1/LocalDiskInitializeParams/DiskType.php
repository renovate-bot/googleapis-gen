...
namespace Google\Cloud\Notebooks\V1\LocalDiskInitializeParams;
 ...
 * Possible disk types.
 *
 * Protobuf type <code>google.cloud.notebooks.v1.LocalDiskInitializeParams.DiskType</code>
 */
class DiskType
{
    /**
...
class_alias(DiskType::class, \Google\Cloud\Notebooks\V1\LocalDiskInitializeParams_DiskType::class);
