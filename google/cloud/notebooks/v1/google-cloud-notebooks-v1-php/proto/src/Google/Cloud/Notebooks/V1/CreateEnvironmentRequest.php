 ...
 *
 * Generated from protobuf message <code>google.cloud.notebooks.v1.CreateEnvironmentRequest</code>
 */
class CreateEnvironmentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           numeric characters, and dashes. The first character must be a lowercase
     *           letter and the last character cannot be a dash.
     *     @type \Google\Cloud\Notebooks\V1\Environment $environment
     *           Required. The environment to be created.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.notebooks.v1.Environment environment = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Notebooks\V1\Environment|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Notebooks\V1\Environment::class);
