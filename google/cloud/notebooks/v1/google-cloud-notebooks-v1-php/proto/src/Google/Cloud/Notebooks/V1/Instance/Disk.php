...
class Disk extends \Google\Protobuf\Internal\Message
{
     ...
     *           Indicates the size of the disk in base-2 GB.
     *     @type \Google\Cloud\Notebooks\V1\Instance\Disk\GuestOsFeature[]|\Google\Protobuf\Internal\RepeatedField $guest_os_features
     *           Indicates a list of features to enable on the guest operating system.
     *           Applicable only for bootable images. Read  Enabling guest operating
     *           system features to see a list of available options.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.notebooks.v1.Instance.Disk.GuestOsFeature guest_os_features = 5;</code>
     * @param \Google\Cloud\Notebooks\V1\Instance\Disk\GuestOsFeature[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
