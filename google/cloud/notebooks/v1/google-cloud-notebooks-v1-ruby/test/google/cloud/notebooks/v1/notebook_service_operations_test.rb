...
class ::Google::Cloud::Notebooks::V1::NotebookService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Notebooks::V1::NotebookService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Notebooks::V1::NotebookService::Operations::Configuration, config
  end
end
