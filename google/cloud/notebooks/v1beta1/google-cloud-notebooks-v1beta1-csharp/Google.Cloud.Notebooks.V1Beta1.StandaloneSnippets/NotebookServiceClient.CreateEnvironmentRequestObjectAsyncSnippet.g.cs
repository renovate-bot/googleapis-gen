...
namespace Google.Cloud.Notebooks.V1Beta1.Snippets
{
    ...
    public sealed partial class GeneratedNotebookServiceClientStandaloneSnippets
    {
        ...
        public async Task CreateEnvironmentRequestObjectAsync()
        {
            ...
            // Make the request
            Operation<Environment, OperationMetadata> response = await notebookServiceClient.CreateEnvironmentAsync(request);
            ...
            Operation<Environment, OperationMetadata> retrievedResponse = await notebookServiceClient.PollOnceCreateEnvironmentAsync(operationName);
