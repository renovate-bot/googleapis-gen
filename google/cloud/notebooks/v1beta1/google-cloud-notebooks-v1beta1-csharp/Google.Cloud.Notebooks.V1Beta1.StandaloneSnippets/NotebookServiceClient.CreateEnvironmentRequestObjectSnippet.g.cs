...
namespace Google.Cloud.Notebooks.V1Beta1.Snippets
{
    ...
    public sealed partial class GeneratedNotebookServiceClientStandaloneSnippets
    {
        ...
        public void CreateEnvironmentRequestObject()
        {
            ...
            // Make the request
            Operation<Environment, OperationMetadata> response = notebookServiceClient.CreateEnvironment(request);
            ...
            Operation<Environment, OperationMetadata> retrievedResponse = notebookServiceClient.PollOnceCreateEnvironment(operationName);
