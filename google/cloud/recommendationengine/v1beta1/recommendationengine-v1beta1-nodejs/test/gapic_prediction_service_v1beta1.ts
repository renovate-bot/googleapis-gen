...
describe('v1beta1.PredictionServiceClient', () => {
    ...
    describe('predict', () => {
        it('invokes predict without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.recommendationengine.v1beta1.PredictRequest());
            request.name = '';
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult()),
              generateSampleMessage(new protos.google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult()),
              generateSampleMessage(new protos.google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult()),
            ];
        ...
        it('invokes predict without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.predict(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recommendationengine.v1beta1.PredictResponse.IPredictionResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes predictStream without error', async () => {
            ...
            client.descriptors.page.predict.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult) => {
            ...
            assert((client.descriptors.page.predict.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.predict, request));
            assert.strictEqual(
        ...
        it('invokes predictStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "name=";
            const expectedError = new Error('expected');
            client.descriptors.page.predict.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.predictStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult[] = [];
                stream.on('data', (response: protos.google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult) => {
        ...
        it('uses async iteration with predict without error', async () => {
            ...
            client.descriptors.page.predict.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.predict.asyncIterate as SinonStub)
        ...
        it('uses async iteration with predict with error', async () => {
            ...
            client.descriptors.page.predict.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.predictAsync(request);
