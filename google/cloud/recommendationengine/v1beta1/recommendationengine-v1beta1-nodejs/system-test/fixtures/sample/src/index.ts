...
import {CatalogServiceClient, PredictionApiKeyRegistryClient, PredictionServiceClient, UserEventServiceClient} from 'recommendationengine';

// check that the client class type name can be used
function doStuffWithCatalogServiceClient(client: CatalogServiceClient) {
  client.close();
}
function doStuffWithPredictionApiKeyRegistryClient(client: PredictionApiKeyRegistryClient) {
  client.close();
}
...
function main() {
  ...
  // check that the client instance can be created
  const predictionApiKeyRegistryClient = new PredictionApiKeyRegistryClient();
  doStuffWithPredictionApiKeyRegistryClient(predictionApiKeyRegistryClient);
  // check that the client instance can be created
