 ...
 *   The first element of the array is Array of [PredictionResult]{@link google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `predictAsync()`
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [PredictionResult]{@link google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
...
/**
 * Equivalent to `predict`, but returns an iterable object.
 *
 ...
 *   [PredictionResult]{@link google.cloud.recommendationengine.v1beta1.PredictResponse.PredictionResult}. The API will be called under the hood as needed, once per the page,
