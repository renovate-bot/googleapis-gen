 ...
 * `src/v1beta1/catalog_service_client_config.json`.
...
export class CatalogServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.pathTemplates = {
      ...
      catalogItemPathPathTemplate: new this._gaxModule.PathTemplate(
    ...
    this.descriptors.page = {
      listCatalogItems:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'catalogItems')
    };
    ...
    const importCatalogItemsResponse = protoFilesRoot.lookup(
      '.google.cloud.recommendationengine.v1beta1.ImportCatalogItemsResponse') as gax.protobuf.Type;
    const importCatalogItemsMetadata = protoFilesRoot.lookup(
      '.google.cloud.recommendationengine.v1beta1.ImportMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      importCatalogItems: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        importCatalogItemsResponse.decode.bind(importCatalogItemsResponse),
        importCatalogItemsMetadata.decode.bind(importCatalogItemsMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.recommendationengine.v1beta1.CatalogService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.catalogServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.recommendationengine.v1beta1.CatalogService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.recommendationengine.v1beta1.CatalogService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const catalogServiceStubMethods =
        ['createCatalogItem', 'getCatalogItem', 'listCatalogItems', 'updateCatalogItem', 'deleteCatalogItem', 'importCatalogItems'];
 ...
 */
  createCatalogItem(
      ...
      Promise<[
        ...
        protos.google.cloud.recommendationengine.v1beta1.ICreateCatalogItemRequest|undefined, {}|undefined
      ]>;
  createCatalogItem(
      request: protos.google.cloud.recommendationengine.v1beta1.ICreateCatalogItemRequest,
      options: CallOptions,
 ...
 */
  getCatalogItem(
      ...
      Promise<[
        protos.google.cloud.recommendationengine.v1beta1.ICatalogItem,
        protos.google.cloud.recommendationengine.v1beta1.IGetCatalogItemRequest|undefined, {}|undefined
      ]>;
  getCatalogItem(
      request: protos.google.cloud.recommendationengine.v1beta1.IGetCatalogItemRequest,
      options: CallOptions,
 ...
 */
  deleteCatalogItem(
      ...
      Promise<[
        ...
        protos.google.cloud.recommendationengine.v1beta1.IDeleteCatalogItemRequest|undefined, {}|undefined
      ]>;
  deleteCatalogItem(
      request: protos.google.cloud.recommendationengine.v1beta1.IDeleteCatalogItemRequest,
      options: CallOptions,
 ...
 */
  ...
  importCatalogItems(
    ...
    this.initialize();
    return this.innerApiCalls.importCatalogItems(request, options, callback);
  }
/**
 * Check the status of the long running operation returned by `importCatalogItems()`.
 * @param {String} name
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [CatalogItem]{@link google.cloud.recommendationengine.v1beta1.CatalogItem}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listCatalogItemsAsync()`
 ...
 */
  ...
  listCatalogItems(
    ...
    this.initialize();
    return this.innerApiCalls.listCatalogItems(request, options, callback);
  }
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [CatalogItem]{@link google.cloud.recommendationengine.v1beta1.CatalogItem} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
...
/**
 * Equivalent to `listCatalogItems`, but returns an iterable object.
 *
 ...
 *   [CatalogItem]{@link google.cloud.recommendationengine.v1beta1.CatalogItem}. The API will be called under the hood as needed, once per the page,
 ...
 */
  ...
  /**
   * Return a fully-qualified catalogItemPath resource name string.
   *
   * @param {string} project
   * @param {string} location
   * @param {string} catalog
   * @param {string} catalog_item_path
   * @returns {string} Resource name string.
   */
  catalogItemPathPath(project:string,location:string,catalog:string,catalogItemPath:string) {
    return this.pathTemplates.catalogItemPathPathTemplate.render({
      project: project,
      location: location,
      catalog: catalog,
  ...
  /**
   * Parse the project from CatalogItemPath resource.
   *
   * @param {string} catalogItemPathName
   *   A fully-qualified path representing CatalogItemPath resource.
   * @returns {string} A string representing the project.
   */
  matchProjectFromCatalogItemPathName(catalogItemPathName: string) {
    return this.pathTemplates.catalogItemPathPathTemplate.match(catalogItemPathName).project;
  }

  /**
   * Parse the location from CatalogItemPath resource.
   *
   * @param {string} catalogItemPathName
   *   A fully-qualified path representing CatalogItemPath resource.
   * @returns {string} A string representing the location.
   */
  matchLocationFromCatalogItemPathName(catalogItemPathName: string) {
    return this.pathTemplates.catalogItemPathPathTemplate.match(catalogItemPathName).location;
  }

  /**
   * Parse the catalog from CatalogItemPath resource.
   *
   * @param {string} catalogItemPathName
   *   A fully-qualified path representing CatalogItemPath resource.
   * @returns {string} A string representing the catalog.
   */
  matchCatalogFromCatalogItemPathName(catalogItemPathName: string) {
    return this.pathTemplates.catalogItemPathPathTemplate.match(catalogItemPathName).catalog;
  }

  /**
   * Parse the catalog_item_path from CatalogItemPath resource.
   *
   * @param {string} catalogItemPathName
   *   A fully-qualified path representing CatalogItemPath resource.
   * @returns {string} A string representing the catalog_item_path.
   */
  matchCatalogItemPathFromCatalogItemPathName(catalogItemPathName: string) {
    return this.pathTemplates.catalogItemPathPathTemplate.match(catalogItemPathName).catalog_item_path;
  }
