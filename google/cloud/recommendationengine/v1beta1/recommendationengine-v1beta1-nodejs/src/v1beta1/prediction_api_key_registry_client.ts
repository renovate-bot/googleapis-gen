 ...
 * `src/v1beta1/prediction_api_key_registry_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './prediction_api_key_registry_client_config.json';
 ...
 * @memberof v1beta1
 */
export class PredictionApiKeyRegistryClient {
  ...
  predictionApiKeyRegistryStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of PredictionApiKeyRegistryClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof PredictionApiKeyRegistryClient;
    ...
    this.pathTemplates = {
      ...
      predictionApiKeyRegistrationPathTemplate: new this._gaxModule.PathTemplate(
    ...
    this.descriptors.page = {
      listPredictionApiKeyRegistrations:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'predictionApiKeyRegistrations')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistry', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.predictionApiKeyRegistryStub) {
      return this.predictionApiKeyRegistryStub;
    }

    // Put together the "service stub" for
    // google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistry.
    this.predictionApiKeyRegistryStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistry') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistry,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const predictionApiKeyRegistryStubMethods =
        ['createPredictionApiKeyRegistration', 'listPredictionApiKeyRegistrations', 'deletePredictionApiKeyRegistration'];
    for (const methodName of predictionApiKeyRegistryStubMethods) {
      const callPromise = this.predictionApiKeyRegistryStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  createPredictionApiKeyRegistration(
      ...
      Promise<[
        ...
        protos.google.cloud.recommendationengine.v1beta1.ICreatePredictionApiKeyRegistrationRequest|undefined, {}|undefined
      ]>;
  createPredictionApiKeyRegistration(
      request: protos.google.cloud.recommendationengine.v1beta1.ICreatePredictionApiKeyRegistrationRequest,
      options: CallOptions,
 ...
 */
  deletePredictionApiKeyRegistration(
      ...
      Promise<[
        ...
        protos.google.cloud.recommendationengine.v1beta1.IDeletePredictionApiKeyRegistrationRequest|undefined, {}|undefined
      ]>;
  deletePredictionApiKeyRegistration(
      request: protos.google.cloud.recommendationengine.v1beta1.IDeletePredictionApiKeyRegistrationRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [PredictionApiKeyRegistration]{@link google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistration}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listPredictionApiKeyRegistrationsAsync()`
 ...
 */
  ...
  listPredictionApiKeyRegistrations(
    ...
    this.initialize();
    return this.innerApiCalls.listPredictionApiKeyRegistrations(request, options, callback);
  }
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [PredictionApiKeyRegistration]{@link google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistration} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 */
  listPredictionApiKeyRegistrationsStream(
    ...
    this.initialize();
    return this.descriptors.page.listPredictionApiKeyRegistrations.createStream(
      this.innerApiCalls.listPredictionApiKeyRegistrations as gax.GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listPredictionApiKeyRegistrations`, but returns an iterable object.
 *
 ...
 *   [PredictionApiKeyRegistration]{@link google.cloud.recommendationengine.v1beta1.PredictionApiKeyRegistration}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listPredictionApiKeyRegistrationsAsync(
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize();
    return this.descriptors.page.listPredictionApiKeyRegistrations.asyncIterate(
  ...
  /**
   * Return a fully-qualified predictionApiKeyRegistration resource name string.
   *
   * @param {string} project
   * @param {string} location
   * @param {string} catalog
   * @param {string} event_store
   * @param {string} prediction_api_key_registration
   * @returns {string} Resource name string.
   */
  predictionApiKeyRegistrationPath(project:string,location:string,catalog:string,eventStore:string,predictionApiKeyRegistration:string) {
    return this.pathTemplates.predictionApiKeyRegistrationPathTemplate.render({
      project: project,
      location: location,
      catalog: catalog,
      event_store: eventStore,
  ...
  /**
   * Parse the project from PredictionApiKeyRegistration resource.
   *
   * @param {string} predictionApiKeyRegistrationName
   *   A fully-qualified path representing PredictionApiKeyRegistration resource.
   * @returns {string} A string representing the project.
   */
  matchProjectFromPredictionApiKeyRegistrationName(predictionApiKeyRegistrationName: string) {
    return this.pathTemplates.predictionApiKeyRegistrationPathTemplate.match(predictionApiKeyRegistrationName).project;
  }

  /**
   * Parse the location from PredictionApiKeyRegistration resource.
   *
   * @param {string} predictionApiKeyRegistrationName
   *   A fully-qualified path representing PredictionApiKeyRegistration resource.
   * @returns {string} A string representing the location.
   */
  matchLocationFromPredictionApiKeyRegistrationName(predictionApiKeyRegistrationName: string) {
    return this.pathTemplates.predictionApiKeyRegistrationPathTemplate.match(predictionApiKeyRegistrationName).location;
  }

  /**
   * Parse the catalog from PredictionApiKeyRegistration resource.
   *
   * @param {string} predictionApiKeyRegistrationName
   *   A fully-qualified path representing PredictionApiKeyRegistration resource.
   * @returns {string} A string representing the catalog.
   */
  matchCatalogFromPredictionApiKeyRegistrationName(predictionApiKeyRegistrationName: string) {
    return this.pathTemplates.predictionApiKeyRegistrationPathTemplate.match(predictionApiKeyRegistrationName).catalog;
  }

  /**
   * Parse the event_store from PredictionApiKeyRegistration resource.
   *
   * @param {string} predictionApiKeyRegistrationName
   *   A fully-qualified path representing PredictionApiKeyRegistration resource.
   * @returns {string} A string representing the event_store.
   */
  matchEventStoreFromPredictionApiKeyRegistrationName(predictionApiKeyRegistrationName: string) {
    return this.pathTemplates.predictionApiKeyRegistrationPathTemplate.match(predictionApiKeyRegistrationName).event_store;
  }

  /**
   * Parse the prediction_api_key_registration from PredictionApiKeyRegistration resource.
   *
   * @param {string} predictionApiKeyRegistrationName
   *   A fully-qualified path representing PredictionApiKeyRegistration resource.
   * @returns {string} A string representing the prediction_api_key_registration.
   */
  matchPredictionApiKeyRegistrationFromPredictionApiKeyRegistrationName(predictionApiKeyRegistrationName: string) {
    return this.pathTemplates.predictionApiKeyRegistrationPathTemplate.match(predictionApiKeyRegistrationName).prediction_api_key_registration;
  }
  ...
  close(): Promise<void> {
    this.initialize();
    if (!this._terminated) {
      return this.predictionApiKeyRegistryStub!.then(stub => {
