...
from google.cloud.recommendationengine_v1beta1.services.prediction_service import PredictionServiceAsyncClient
from google.cloud.recommendationengine_v1beta1.services.prediction_service import PredictionServiceClient
from google.cloud.recommendationengine_v1beta1.services.prediction_service import pagers
from google.cloud.recommendationengine_v1beta1.services.prediction_service import transports
from google.cloud.recommendationengine_v1beta1.services.prediction_service.transports.base import _API_CORE_VERSION
from google.cloud.recommendationengine_v1beta1.services.prediction_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_prediction_service_client_client_options_from_dict():
    with mock.patch('google.cloud.recommendationengine_v1beta1.services.prediction_service.transports.PredictionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_predict_flattened():
    ...
    with mock.patch.object(
        ...
        assert args[0].user_event == gcr_user_event.UserEvent(event_type='event_type_value')
...
def test_predict_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, prediction_service.PredictResponse.PredictionResult)
                   for i in results)
...
def test_prediction_service_base_transport():
    ...
    with mock.patch('google.cloud.recommendationengine_v1beta1.services.prediction_service.transports.PredictionServiceTransport.__init__') as Transport:
...
def test_prediction_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.recommendationengine_v1beta1.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_prediction_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.recommendationengine_v1beta1.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.PredictionServiceTransport()
        adc.assert_called_once()
...
def test_placement_path():
    ...
    event_store = "octopus"
    placement = "oyster"
    expected = "projects/{project}/locations/{location}/catalogs/{catalog}/eventStores/{event_store}/placements/{placement}".format(project=project, location=location, catalog=catalog, event_store=event_store, placement=placement, )
    actual = PredictionServiceClient.placement_path(project, location, catalog, event_store, placement)
