...
class PredictionApiKeyRegistryTransport(abc.ABC):
    ...
    @property
    def create_prediction_api_key_registration(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[prediction_apikey_registry_service.PredictionApiKeyRegistration]
            ]]:
        raise NotImplementedError()

    @property
    def list_prediction_api_key_registrations(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def delete_prediction_api_key_registration(self) -> typing.Callable[
