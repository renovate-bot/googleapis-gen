...
class CatalogServiceTransport(abc.ABC):
    ...
    @property
    def list_catalogs(self) -> typing.Callable[
            [catalog_service.ListCatalogsRequest],
            typing.Union[
                catalog_service.ListCatalogsResponse,
                typing.Awaitable[catalog_service.ListCatalogsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def update_catalog(self) -> typing.Callable[
            [catalog_service.UpdateCatalogRequest],
            typing.Union[
                gcr_catalog.Catalog,
                typing.Awaitable[gcr_catalog.Catalog]
            ]]:
        raise NotImplementedError()
