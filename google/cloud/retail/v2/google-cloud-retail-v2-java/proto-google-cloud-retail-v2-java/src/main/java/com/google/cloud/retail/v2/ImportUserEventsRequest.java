...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            com.google.cloud.retail.v2.UserEventInputConfig.Builder subBuilder = null;
            if (inputConfig_ != null) {
              subBuilder = inputConfig_.toBuilder();
            }
            inputConfig_ = input.readMessage(com.google.cloud.retail.v2.UserEventInputConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 26: {
            ...
            errorsConfig_ = input.readMessage(com.google.cloud.retail.v2.ImportErrorsConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.retail.v2.ImportUserEventsRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.retail.v2.ImportUserEventsRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeInputConfig(com.google.cloud.retail.v2.UserEventInputConfig value) {
      if (inputConfigBuilder_ == null) {
        if (inputConfig_ != null) {
          inputConfig_ =
            com.google.cloud.retail.v2.UserEventInputConfig.newBuilder(inputConfig_).mergeFrom(value).buildPartial();
        } else {
          inputConfig_ = value;
        }
        onChanged();
    ...
    public Builder mergeErrorsConfig(com.google.cloud.retail.v2.ImportErrorsConfig value) {
      if (errorsConfigBuilder_ == null) {
        if (errorsConfig_ != null) {
          errorsConfig_ =
            com.google.cloud.retail.v2.ImportErrorsConfig.newBuilder(errorsConfig_).mergeFrom(value).buildPartial();
        } else {
          errorsConfig_ = value;
        }
        onChanged();
