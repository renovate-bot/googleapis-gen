...
public final class CompletionServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.retail.v2.CompleteQueryRequest,
      com.google.cloud.retail.v2.CompleteQueryResponse> getCompleteQueryMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.retail.v2.CompleteQueryRequest,
      com.google.cloud.retail.v2.CompleteQueryResponse> getCompleteQueryMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.retail.v2.CompleteQueryRequest, com.google.cloud.retail.v2.CompleteQueryResponse> getCompleteQueryMethod;
      ...
      synchronized (CompletionServiceGrpc.class) {
        if ((getCompleteQueryMethod = CompletionServiceGrpc.getCompleteQueryMethod) == null) {
          CompletionServiceGrpc.getCompleteQueryMethod = getCompleteQueryMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.retail.v2.CompleteQueryRequest, com.google.cloud.retail.v2.CompleteQueryResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.retail.v2.CompleteQueryResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.retail.v2.ImportCompletionDataRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.retail.v2.ImportCompletionDataRequest,
      com.google.longrunning.Operation> getImportCompletionDataMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.retail.v2.ImportCompletionDataRequest, com.google.longrunning.Operation> getImportCompletionDataMethod;
      ...
      synchronized (CompletionServiceGrpc.class) {
        if ((getImportCompletionDataMethod = CompletionServiceGrpc.getImportCompletionDataMethod) == null) {
          CompletionServiceGrpc.getImportCompletionDataMethod = getImportCompletionDataMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.retail.v2.ImportCompletionDataRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ImportCompletionData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.retail.v2.ImportCompletionDataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static abstract class CompletionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void completeQuery(com.google.cloud.retail.v2.CompleteQueryRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.retail.v2.CompleteQueryResponse> responseObserver) {
     ...
     * </pre>
     */
    public void importCompletionData(com.google.cloud.retail.v2.ImportCompletionDataRequest request,
  ...
  public static final class CompletionServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CompletionServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.retail.v2.CompleteQueryResponse completeQuery(com.google.cloud.retail.v2.CompleteQueryRequest request) {
     ...
     * </pre>
     */
    public com.google.longrunning.Operation importCompletionData(com.google.cloud.retail.v2.ImportCompletionDataRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CompletionServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CompletionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.retail.v2.CompleteQueryResponse> completeQuery(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_COMPLETE_QUERY:
          serviceImpl.completeQuery((com.google.cloud.retail.v2.CompleteQueryRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.retail.v2.CompleteQueryResponse>) responseObserver);
          break;
        case METHODID_IMPORT_COMPLETION_DATA:
          serviceImpl.importCompletionData((com.google.cloud.retail.v2.ImportCompletionDataRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        default:
