...
import com.google.cloud.retail.v2alpha.CompletionServiceGrpc.CompletionServiceImplBase;
...
public class MockCompletionServiceImpl extends CompletionServiceImplBase {
  ...
  public void importCompletionData(
      ImportCompletionDataRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
