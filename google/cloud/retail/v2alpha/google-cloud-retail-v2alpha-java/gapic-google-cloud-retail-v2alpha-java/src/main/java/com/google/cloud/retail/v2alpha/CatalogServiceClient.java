...
public class CatalogServiceClient implements BackgroundResource {
   ...
   *     [Catalog][google.cloud.retail.v2alpha.Catalog], regardless of whether or not it exists, a
   *     PERMISSION_DENIED error is returned.
   *     <p>If the [Catalog][google.cloud.retail.v2alpha.Catalog] to update does not exist, a
   ...
   * [ProductService.ListProducts][google.cloud.retail.v2alpha.ProductService.ListProducts] will
   ...
   * default, setting [SearchRequest.branch][google.cloud.retail.v2alpha.SearchRequest.branch] to
   * `projects/&#42;/locations/&#42;/catalogs/&#42;/branches/default_branch` is equivalent to
   * setting [SearchRequest.branch][google.cloud.retail.v2alpha.SearchRequest.branch] to
   ...
   * [SearchRequest.branch][google.cloud.retail.v2alpha.SearchRequest.branch] to route the traffic
