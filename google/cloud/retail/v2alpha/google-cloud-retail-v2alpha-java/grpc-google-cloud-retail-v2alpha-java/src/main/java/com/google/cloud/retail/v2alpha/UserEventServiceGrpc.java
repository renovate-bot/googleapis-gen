...
public final class UserEventServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.WriteUserEventRequest,
      com.google.cloud.retail.v2alpha.UserEvent> getWriteUserEventMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.WriteUserEventRequest,
      com.google.cloud.retail.v2alpha.UserEvent> getWriteUserEventMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.WriteUserEventRequest, com.google.cloud.retail.v2alpha.UserEvent> getWriteUserEventMethod;
      ...
      synchronized (UserEventServiceGrpc.class) {
        if ((getWriteUserEventMethod = UserEventServiceGrpc.getWriteUserEventMethod) == null) {
          UserEventServiceGrpc.getWriteUserEventMethod = getWriteUserEventMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.retail.v2alpha.WriteUserEventRequest, com.google.cloud.retail.v2alpha.UserEvent>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "WriteUserEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.retail.v2alpha.WriteUserEventRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.CollectUserEventRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.CollectUserEventRequest,
      com.google.api.HttpBody> getCollectUserEventMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.CollectUserEventRequest, com.google.api.HttpBody> getCollectUserEventMethod;
      ...
      synchronized (UserEventServiceGrpc.class) {
        if ((getCollectUserEventMethod = UserEventServiceGrpc.getCollectUserEventMethod) == null) {
          UserEventServiceGrpc.getCollectUserEventMethod = getCollectUserEventMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.retail.v2alpha.CollectUserEventRequest, com.google.api.HttpBody>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CollectUserEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.retail.v2alpha.CollectUserEventRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.PurgeUserEventsRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.PurgeUserEventsRequest,
      com.google.longrunning.Operation> getPurgeUserEventsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.PurgeUserEventsRequest, com.google.longrunning.Operation> getPurgeUserEventsMethod;
      ...
      synchronized (UserEventServiceGrpc.class) {
        if ((getPurgeUserEventsMethod = UserEventServiceGrpc.getPurgeUserEventsMethod) == null) {
          UserEventServiceGrpc.getPurgeUserEventsMethod = getPurgeUserEventsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.retail.v2alpha.PurgeUserEventsRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PurgeUserEvents"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.retail.v2alpha.PurgeUserEventsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.ImportUserEventsRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = com.google.longrunning.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.ImportUserEventsRequest,
      com.google.longrunning.Operation> getImportUserEventsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.ImportUserEventsRequest, com.google.longrunning.Operation> getImportUserEventsMethod;
      ...
      synchronized (UserEventServiceGrpc.class) {
        if ((getImportUserEventsMethod = UserEventServiceGrpc.getImportUserEventsMethod) == null) {
          UserEventServiceGrpc.getImportUserEventsMethod = getImportUserEventsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.retail.v2alpha.ImportUserEventsRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ImportUserEvents"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.retail.v2alpha.ImportUserEventsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.longrunning.Operation.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.RejoinUserEventsRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = com.google.longrunning.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.RejoinUserEventsRequest,
      com.google.longrunning.Operation> getRejoinUserEventsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.RejoinUserEventsRequest, com.google.longrunning.Operation> getRejoinUserEventsMethod;
      ...
      synchronized (UserEventServiceGrpc.class) {
        if ((getRejoinUserEventsMethod = UserEventServiceGrpc.getRejoinUserEventsMethod) == null) {
          UserEventServiceGrpc.getRejoinUserEventsMethod = getRejoinUserEventsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.retail.v2alpha.RejoinUserEventsRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RejoinUserEvents"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.retail.v2alpha.RejoinUserEventsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.longrunning.Operation.getDefaultInstance()))
  ...
  public static abstract class UserEventServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void writeUserEvent(com.google.cloud.retail.v2alpha.WriteUserEventRequest request,
     ...
     * </pre>
     */
    public void collectUserEvent(com.google.cloud.retail.v2alpha.CollectUserEventRequest request,
     ...
     * </pre>
     */
    public void purgeUserEvents(com.google.cloud.retail.v2alpha.PurgeUserEventsRequest request,
     ...
     * </pre>
     */
    public void importUserEvents(com.google.cloud.retail.v2alpha.ImportUserEventsRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
     ...
     * </pre>
     */
    public void rejoinUserEvents(com.google.cloud.retail.v2alpha.RejoinUserEventsRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
  ...
  public static final class UserEventServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<UserEventServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.retail.v2alpha.UserEvent writeUserEvent(com.google.cloud.retail.v2alpha.WriteUserEventRequest request) {
     ...
     * </pre>
     */
    public com.google.api.HttpBody collectUserEvent(com.google.cloud.retail.v2alpha.CollectUserEventRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public com.google.longrunning.Operation purgeUserEvents(com.google.cloud.retail.v2alpha.PurgeUserEventsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public com.google.longrunning.Operation importUserEvents(com.google.cloud.retail.v2alpha.ImportUserEventsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public com.google.longrunning.Operation rejoinUserEvents(com.google.cloud.retail.v2alpha.RejoinUserEventsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class UserEventServiceFutureStub extends io.grpc.stub.AbstractFutureStub<UserEventServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.retail.v2alpha.UserEvent> writeUserEvent(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_WRITE_USER_EVENT:
          serviceImpl.writeUserEvent((com.google.cloud.retail.v2alpha.WriteUserEventRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.retail.v2alpha.UserEvent>) responseObserver);
          break;
        case METHODID_COLLECT_USER_EVENT:
          serviceImpl.collectUserEvent((com.google.cloud.retail.v2alpha.CollectUserEventRequest) request,
              (io.grpc.stub.StreamObserver<com.google.api.HttpBody>) responseObserver);
          break;
        case METHODID_PURGE_USER_EVENTS:
          serviceImpl.purgeUserEvents((com.google.cloud.retail.v2alpha.PurgeUserEventsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        case METHODID_IMPORT_USER_EVENTS:
          serviceImpl.importUserEvents((com.google.cloud.retail.v2alpha.ImportUserEventsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        case METHODID_REJOIN_USER_EVENTS:
          serviceImpl.rejoinUserEvents((com.google.cloud.retail.v2alpha.RejoinUserEventsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        default:
