...
public final class SearchServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.SearchRequest,
      com.google.cloud.retail.v2alpha.SearchResponse> getSearchMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.SearchRequest,
      com.google.cloud.retail.v2alpha.SearchResponse> getSearchMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.SearchRequest, com.google.cloud.retail.v2alpha.SearchResponse> getSearchMethod;
      ...
      synchronized (SearchServiceGrpc.class) {
        if ((getSearchMethod = SearchServiceGrpc.getSearchMethod) == null) {
          SearchServiceGrpc.getSearchMethod = getSearchMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.retail.v2alpha.SearchRequest, com.google.cloud.retail.v2alpha.SearchResponse>newBuilder()
  ...
  public static abstract class SearchServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void search(com.google.cloud.retail.v2alpha.SearchRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.retail.v2alpha.SearchResponse> responseObserver) {
  ...
  public static final class SearchServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SearchServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.retail.v2alpha.SearchResponse search(com.google.cloud.retail.v2alpha.SearchRequest request) {
  ...
  public static final class SearchServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SearchServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.retail.v2alpha.SearchResponse> search(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH:
          serviceImpl.search((com.google.cloud.retail.v2alpha.SearchRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.retail.v2alpha.SearchResponse>) responseObserver);
          break;
        default:
