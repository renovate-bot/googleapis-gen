...
public interface SearchResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.retail.v2alpha.SearchResponse.SearchResult> 
      getResultsList();
  /**
   * <pre>
   * A list of matched items. The order represents the ranking.
   ...
   */
  java.util.List<com.google.cloud.retail.v2alpha.SearchResponse.Facet> 
      getFacetsList();
  /**
   * <pre>
   * Results of facets requested by user.
   ...
   * <code>repeated .google.cloud.retail.v2alpha.SearchResponse.Facet facets = 2;</code>
   */
  com.google.cloud.retail.v2alpha.SearchResponse.FacetOrBuilder getFacetsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.retail.v2alpha.SearchResponse.QueryExpansionInfo query_expansion_info = 7;</code>
