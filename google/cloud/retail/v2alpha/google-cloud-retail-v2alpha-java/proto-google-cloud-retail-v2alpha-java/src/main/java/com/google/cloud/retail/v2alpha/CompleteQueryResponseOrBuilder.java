...
public interface CompleteQueryResponseOrBuilder extends
   ...
   * <code>repeated .google.cloud.retail.v2alpha.CompleteQueryResponse.CompletionResult completion_results = 1;</code>
   */
  com.google.cloud.retail.v2alpha.CompleteQueryResponse.CompletionResult getCompletionResults(int index);
  /**
   * <pre>
   * Results of the matching suggestions. The result list is ordered and the
   * first result is top suggestion.
   ...
   * <code>repeated .google.cloud.retail.v2alpha.CompleteQueryResponse.CompletionResult completion_results = 1;</code>
   */
  java.util.List<? extends com.google.cloud.retail.v2alpha.CompleteQueryResponse.CompletionResultOrBuilder> 
   ...
   * <code>repeated .google.cloud.retail.v2alpha.CompleteQueryResponse.CompletionResult completion_results = 1;</code>
   */
  com.google.cloud.retail.v2alpha.CompleteQueryResponse.CompletionResultOrBuilder getCompletionResultsOrBuilder(
      int index);
   ...
   * <code>repeated .google.cloud.retail.v2alpha.CompleteQueryResponse.RecentSearchResult recent_search_results = 3;</code>
   */
  com.google.cloud.retail.v2alpha.CompleteQueryResponse.RecentSearchResult getRecentSearchResults(int index);
  /**
   * <pre>
   * Matched recent searches of this user. The maximum number of recent searches
   * is 10. This field is a restricted feature. Contact Retail Search support
   ...
   * <code>repeated .google.cloud.retail.v2alpha.CompleteQueryResponse.RecentSearchResult recent_search_results = 3;</code>
   */
  java.util.List<? extends com.google.cloud.retail.v2alpha.CompleteQueryResponse.RecentSearchResultOrBuilder> 
   ...
   * <code>repeated .google.cloud.retail.v2alpha.CompleteQueryResponse.RecentSearchResult recent_search_results = 3;</code>
   */
  com.google.cloud.retail.v2alpha.CompleteQueryResponse.RecentSearchResultOrBuilder getRecentSearchResultsOrBuilder(
      int index);
}
