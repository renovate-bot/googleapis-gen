...
public interface SearchRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.retail.v2alpha.SearchRequest.FacetSpec> 
      getFacetSpecsList();
  /**
   * <pre>
   * Facet specifications for faceted search. If empty, no facets are returned.
   ...
   * <code>.google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpec dynamic_facet_spec = 21;</code>
   */
  com.google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpecOrBuilder getDynamicFacetSpecOrBuilder();
   ...
   * <code>.google.cloud.retail.v2alpha.SearchRequest.QueryExpansionSpec query_expansion_spec = 14;</code>
   */
  com.google.cloud.retail.v2alpha.SearchRequest.QueryExpansionSpecOrBuilder getQueryExpansionSpecOrBuilder();
