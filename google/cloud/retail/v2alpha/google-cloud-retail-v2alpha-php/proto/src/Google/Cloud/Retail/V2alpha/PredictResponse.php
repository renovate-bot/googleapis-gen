 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.PredictResponse</code>
 */
class PredictResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.PredictResponse.PredictionResult results = 1;</code>
     */
    private $results;
    /**
     ...
     *
     *     @type \Google\Cloud\Retail\V2alpha\PredictResponse\PredictionResult[]|\Google\Protobuf\Internal\RepeatedField $results
     *           A list of recommended products. The order represents the ranking (from the
     *           most relevant product to the least).
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Retail\V2Alpha\PredictionService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.PredictResponse.PredictionResult results = 1;</code>
     * @param \Google\Cloud\Retail\V2alpha\PredictResponse\PredictionResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2alpha\PredictResponse\PredictionResult::class);
        $this->results = $arr;
