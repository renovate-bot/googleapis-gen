 ...
 *
 * Protobuf type <code>google.cloud.retail.v2alpha.SearchRequest.SearchMode</code>
 */
class SearchMode
{
    /**
...
class_alias(SearchMode::class, \Google\Cloud\Retail\V2alpha\SearchRequest_SearchMode::class);
