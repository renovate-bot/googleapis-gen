 ...
 * method.
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.UpdateCatalogRequest</code>
 */
class UpdateCatalogRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Retail\V2alpha\Catalog $catalog
     *           Required. The [Catalog][google.cloud.retail.v2alpha.Catalog] to update.
     *           If the caller does not have permission to update the
     *           [Catalog][google.cloud.retail.v2alpha.Catalog], regardless of whether or
     *           not it exists, a PERMISSION_DENIED error is returned.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Catalog catalog = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Retail\V2alpha\Catalog $var
     * @return $this
     */
    public function setCatalog($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\Catalog::class);
        $this->catalog = $var;
