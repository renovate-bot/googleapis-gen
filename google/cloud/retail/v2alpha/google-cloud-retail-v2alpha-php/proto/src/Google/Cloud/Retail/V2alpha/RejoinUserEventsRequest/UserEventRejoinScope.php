...
namespace Google\Cloud\Retail\V2alpha\RejoinUserEventsRequest;
 ...
 *
 * Protobuf type <code>google.cloud.retail.v2alpha.RejoinUserEventsRequest.UserEventRejoinScope</code>
 */
...
class_alias(UserEventRejoinScope::class, \Google\Cloud\Retail\V2alpha\RejoinUserEventsRequest_UserEventRejoinScope::class);
