 ...
 * searched.
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.Product</code>
 */
class Product extends \Google\Protobuf\Internal\Message
{
     ...
     * if unset.
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Product.Type type = 3 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $type = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.retail.v2alpha.CustomAttribute> attributes = 12;</code>
     */
    private $attributes;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Rating rating = 15;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Product.Availability availability = 19;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.FulfillmentInfo fulfillment_info = 21;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.Image images = 23;</code>
     */
    private $images;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Audience audience = 24;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.ColorInfo color_info = 25;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.Promotion promotions = 34;</code>
     */
    private $promotions;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.Product variants = 31 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $variants;
     ...
     *           Google Merchant Center property
     *           [price](https://support.google.com/merchants/answer/6324371).
     *     @type \Google\Cloud\Retail\V2alpha\Rating $rating
     *           The rating of this product.
     ...
     *           The available quantity of the item.
     *     @type \Google\Cloud\Retail\V2alpha\FulfillmentInfo[]|\Google\Protobuf\Internal\RepeatedField $fulfillment_info
     *           Fulfillment information, such as the store IDs for in-store pickup or
     *           region IDs for different shipping methods.
     *           All the elements must have distinct
     *           [FulfillmentInfo.type][google.cloud.retail.v2alpha.FulfillmentInfo.type].
     ...
     *           [link](https://support.google.com/merchants/answer/6324416). Schema.org
     *           property [Offer.url](https://schema.org/url).
     *     @type \Google\Cloud\Retail\V2alpha\Image[]|\Google\Protobuf\Internal\RepeatedField $images
     *           Product images for the product.Highly recommended to put the main image
     *           to the first.
     *           A maximum of 300 images are allowed.
     *           Google Merchant Center property
     *           [image_link](https://support.google.com/merchants/answer/6324350).
     *           Schema.org property [Product.image](https://schema.org/image).
     *     @type \Google\Cloud\Retail\V2alpha\Audience $audience
     *           The target group associated with a given audience (e.g. male, veterans,
     *           car owners, musicians, etc.) of the product.
     *     @type \Google\Cloud\Retail\V2alpha\ColorInfo $color_info
     *           The color of the product.
     *           Google Merchant Center property
     *           [color](https://support.google.com/merchants/answer/6324487). Schema.org
     *           property [Product.color](https://schema.org/color).
     ...
     *           Schema.org property
     *           [Offer.itemCondition](https://schema.org/itemCondition).
     *     @type \Google\Cloud\Retail\V2alpha\Promotion[]|\Google\Protobuf\Internal\RepeatedField $promotions
     *           The promotions applied to the product. A maximum of 10 values are allowed
     *           per [Product][google.cloud.retail.v2alpha.Product].
     ...
     *           [SearchResponse][google.cloud.retail.v2alpha.SearchResponse] may increase
     *           response payload size and serving latency.
     *     @type \Google\Cloud\Retail\V2alpha\Product[]|\Google\Protobuf\Internal\RepeatedField $variants
     *           Output only. Product variants grouped together on primary product which
     *           share similar product attributes. It's automatically grouped by
     *           [primary_product_id][google.cloud.retail.v2alpha.Product.primary_product_id]
     *           for all the product variants. Only populated for
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Retail\V2alpha\Product\Type::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Rating rating = 15;</code>
     * @return \Google\Cloud\Retail\V2alpha\Rating|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Rating rating = 15;</code>
     * @param \Google\Cloud\Retail\V2alpha\Rating $var
     * @return $this
     */
    public function setRating($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\Rating::class);
        $this->rating = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Retail\V2alpha\Product\Availability::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.FulfillmentInfo fulfillment_info = 21;</code>
     * @param \Google\Cloud\Retail\V2alpha\FulfillmentInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFulfillmentInfo($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2alpha\FulfillmentInfo::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.Image images = 23;</code>
     * @param \Google\Cloud\Retail\V2alpha\Image[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setImages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2alpha\Image::class);
        $this->images = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Audience audience = 24;</code>
     * @return \Google\Cloud\Retail\V2alpha\Audience|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Audience audience = 24;</code>
     * @param \Google\Cloud\Retail\V2alpha\Audience $var
     * @return $this
     */
    public function setAudience($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\Audience::class);
        $this->audience = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.ColorInfo color_info = 25;</code>
     * @return \Google\Cloud\Retail\V2alpha\ColorInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.ColorInfo color_info = 25;</code>
     * @param \Google\Cloud\Retail\V2alpha\ColorInfo $var
     * @return $this
     */
    public function setColorInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\ColorInfo::class);
        $this->color_info = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.Promotion promotions = 34;</code>
     * @param \Google\Cloud\Retail\V2alpha\Promotion[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPromotions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2alpha\Promotion::class);
        $this->promotions = $arr;
