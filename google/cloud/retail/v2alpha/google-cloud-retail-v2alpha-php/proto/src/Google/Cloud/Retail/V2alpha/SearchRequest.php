 ...
 * method.
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.SearchRequest</code>
 */
class SearchRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * User information.
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.UserInfo user_info = 5;</code>
     */
     ...
     * is returned.
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.SearchRequest.FacetSpec facet_specs = 12;</code>
     */
    private $facet_specs;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.SearchRequest.SearchMode search_mode = 31;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.SearchRequest.FacetSpec facet_specs = 12;</code>
     * @param \Google\Cloud\Retail\V2alpha\SearchRequest\FacetSpec[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFacetSpecs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2alpha\SearchRequest\FacetSpec::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\SearchRequest\DynamicFacetSpec::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\SearchRequest\BoostSpec::class);
        $this->boost_spec = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\SearchRequest\QueryExpansionSpec::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Retail\V2alpha\SearchRequest\RelevanceThreshold::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Retail\V2alpha\SearchRequest\SearchMode::class);
