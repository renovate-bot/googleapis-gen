...
namespace Google\Cloud\Retail\V2alpha\SearchRequest\QueryExpansionSpec;
 ...
 *
 * Protobuf type <code>google.cloud.retail.v2alpha.SearchRequest.QueryExpansionSpec.Condition</code>
 */
class Condition
{
    /**
...
class_alias(Condition::class, \Google\Cloud\Retail\V2alpha\SearchRequest_QueryExpansionSpec_Condition::class);
