 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.ProductInputConfig</code>
 */
class ProductInputConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Retail\V2alpha\ProductInlineSource $product_inline_source
     ...
     * The Inline source for the input content for products.
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.ProductInlineSource product_inline_source = 1;</code>
     * @return \Google\Cloud\Retail\V2alpha\ProductInlineSource|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.ProductInlineSource product_inline_source = 1;</code>
     * @param \Google\Cloud\Retail\V2alpha\ProductInlineSource $var
     * @return $this
     */
    public function setProductInlineSource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\ProductInlineSource::class);
     ...
     * Google Cloud Storage location for the input content.
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.GcsSource gcs_source = 2;</code>
     ...
     * BigQuery input source.
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.BigQuerySource big_query_source = 3;</code>
