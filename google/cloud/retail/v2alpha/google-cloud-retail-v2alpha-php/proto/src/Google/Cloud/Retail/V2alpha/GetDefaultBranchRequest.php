 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.GetDefaultBranchRequest</code>
 */
class GetDefaultBranchRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Retail\V2Alpha\CatalogService::initOnce();
