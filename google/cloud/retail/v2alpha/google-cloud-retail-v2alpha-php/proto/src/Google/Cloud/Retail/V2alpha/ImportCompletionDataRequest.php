 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.ImportCompletionDataRequest</code>
 */
class ImportCompletionDataRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.CompletionDataInputConfig input_config = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The catalog which the suggestions dataset belongs to.
     *           Format: `projects/1234/locations/global/catalogs/default_catalog`.
     *     @type \Google\Cloud\Retail\V2alpha\CompletionDataInputConfig $input_config
     *           Required. The desired input location of the data.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.CompletionDataInputConfig input_config = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Retail\V2alpha\CompletionDataInputConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.CompletionDataInputConfig input_config = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Retail\V2alpha\CompletionDataInputConfig $var
     * @return $this
     */
    public function setInputConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\CompletionDataInputConfig::class);
