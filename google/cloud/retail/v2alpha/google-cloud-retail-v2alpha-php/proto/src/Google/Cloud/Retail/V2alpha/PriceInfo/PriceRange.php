...
namespace Google\Cloud\Retail\V2alpha\PriceInfo;
 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.PriceInfo.PriceRange</code>
 */
class PriceRange extends \Google\Protobuf\Internal\Message
{
     ...
     * [Product.primary_product_id][google.cloud.retail.v2alpha.Product.primary_product_id].
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Interval price = 1;</code>
     */
     ...
     * [Product.primary_product_id][google.cloud.retail.v2alpha.Product.primary_product_id].
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Interval original_price = 2;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Retail\V2alpha\Interval $price
     *           The inclusive
     *           [Product.pricing_info.price][google.cloud.retail.v2alpha.PriceInfo.price]
     *           interval of all
     *           [variant][google.cloud.retail.v2alpha.Product.Type.VARIANT]
     *           [Product][google.cloud.retail.v2alpha.Product] having the same
     *           [Product.primary_product_id][google.cloud.retail.v2alpha.Product.primary_product_id].
     *     @type \Google\Cloud\Retail\V2alpha\Interval $original_price
     *           The inclusive
     *           [Product.pricing_info.original_price][google.cloud.retail.v2alpha.PriceInfo.original_price]
     *           internal of all
     *           [variant][google.cloud.retail.v2alpha.Product.Type.VARIANT]
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Interval price = 1;</code>
     * @return \Google\Cloud\Retail\V2alpha\Interval|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Interval price = 1;</code>
     * @param \Google\Cloud\Retail\V2alpha\Interval $var
     * @return $this
     */
    public function setPrice($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\Interval::class);
        $this->price = $var;
...
class_alias(PriceRange::class, \Google\Cloud\Retail\V2alpha\PriceInfo_PriceRange::class);
