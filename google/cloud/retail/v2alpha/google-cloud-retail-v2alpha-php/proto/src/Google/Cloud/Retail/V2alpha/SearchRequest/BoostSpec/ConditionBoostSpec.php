...
namespace Google\Cloud\Retail\V2alpha\SearchRequest\BoostSpec;
 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.SearchRequest.BoostSpec.ConditionBoostSpec</code>
 */
...
class_alias(ConditionBoostSpec::class, \Google\Cloud\Retail\V2alpha\SearchRequest_BoostSpec_ConditionBoostSpec::class);
