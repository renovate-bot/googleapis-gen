 ...
 * occurred.
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.SearchResponse.QueryExpansionInfo</code>
 */
...
class_alias(QueryExpansionInfo::class, \Google\Cloud\Retail\V2alpha\SearchResponse_QueryExpansionInfo::class);
