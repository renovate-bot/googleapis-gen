 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.ImportUserEventsResponse</code>
 */
class ImportUserEventsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * the request.
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.ImportErrorsConfig errors_config = 2;</code>
     */
    protected $errors_config = null;
    /**
     * Aggregated statistics of user event import status.
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.UserEventImportSummary import_summary = 3;</code>
     */
     ...
     *           Echoes the destination for the complete errors if this field was set in
     *           the request.
     *     @type \Google\Cloud\Retail\V2alpha\UserEventImportSummary $import_summary
     *           Aggregated statistics of user event import status.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.UserEventImportSummary import_summary = 3;</code>
     * @return \Google\Cloud\Retail\V2alpha\UserEventImportSummary|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.UserEventImportSummary import_summary = 3;</code>
     * @param \Google\Cloud\Retail\V2alpha\UserEventImportSummary $var
     * @return $this
     */
    public function setImportSummary($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\UserEventImportSummary::class);
