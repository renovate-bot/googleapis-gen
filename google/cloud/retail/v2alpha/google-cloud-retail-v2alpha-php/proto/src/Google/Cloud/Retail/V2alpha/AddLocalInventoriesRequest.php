 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.AddLocalInventoriesRequest</code>
 */
class AddLocalInventoriesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * request.
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.LocalInventory local_inventories = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           [Product][google.cloud.retail.v2alpha.Product], regardless of whether or
     *           not it exists, a PERMISSION_DENIED error is returned.
     *     @type \Google\Cloud\Retail\V2alpha\LocalInventory[]|\Google\Protobuf\Internal\RepeatedField $local_inventories
     *           Required. A list of inventory information at difference places. Each place
     *           is identified by its place ID. At most 1000 inventories are allowed per
     *           request.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.LocalInventory local_inventories = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Retail\V2alpha\LocalInventory[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLocalInventories($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2alpha\LocalInventory::class);
