 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.SetInventoryRequest</code>
 */
class SetInventoryRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Product inventory = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\Retail\V2alpha\Product $inventory
     *           Required. The inventory information to update. The allowable fields to
     *           update are:
     *           * [Product.price_info][google.cloud.retail.v2alpha.Product.price_info]
     *           * [Product.availability][google.cloud.retail.v2alpha.Product.availability]
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Product inventory = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Retail\V2alpha\Product|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Product inventory = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Retail\V2alpha\Product $var
     * @return $this
     */
    public function setInventory($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2alpha\Product::class);
        $this->inventory = $var;
