...
class CatalogServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Cloud\Retail\V2alpha\SetDefaultBranchRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function SetDefaultBranch(\Google\Cloud\Retail\V2alpha\SetDefaultBranchRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.retail.v2alpha.CatalogService/SetDefaultBranch',
        $argument,
     ...
     * Contact Retail Support (retail-search-support@google.com) if you are
     * interested in using Retail Search.
     * @param \Google\Cloud\Retail\V2alpha\GetDefaultBranchRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GetDefaultBranch(\Google\Cloud\Retail\V2alpha\GetDefaultBranchRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.retail.v2alpha.CatalogService/GetDefaultBranch',
        $argument,
        ['\Google\Cloud\Retail\V2alpha\GetDefaultBranchResponse', 'decode'],
        $metadata, $options);
    }
