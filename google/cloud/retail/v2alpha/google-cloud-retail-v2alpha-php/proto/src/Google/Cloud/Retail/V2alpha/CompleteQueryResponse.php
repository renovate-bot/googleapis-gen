 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.CompleteQueryResponse</code>
 */
class CompleteQueryResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.CompleteQueryResponse.CompletionResult completion_results = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.CompleteQueryResponse.RecentSearchResult recent_search_results = 3;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Retail\V2alpha\CompleteQueryResponse\CompletionResult[]|\Google\Protobuf\Internal\RepeatedField $completion_results
     *           Results of the matching suggestions. The result list is ordered and the
     *           first result is top suggestion.
     ...
     *           this completion, which enables accurate attribution of complete model
     *           performance.
     *     @type \Google\Cloud\Retail\V2alpha\CompleteQueryResponse\RecentSearchResult[]|\Google\Protobuf\Internal\RepeatedField $recent_search_results
     *           Matched recent searches of this user. The maximum number of recent searches
     *           is 10. This field is a restricted feature. Contact Retail Search support
     *           team if you are interested in enabling it.
     *           This feature is only available when
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.CompleteQueryResponse.CompletionResult completion_results = 1;</code>
     * @param \Google\Cloud\Retail\V2alpha\CompleteQueryResponse\CompletionResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCompletionResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2alpha\CompleteQueryResponse\CompletionResult::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.CompleteQueryResponse.RecentSearchResult recent_search_results = 3;</code>
     * @param \Google\Cloud\Retail\V2alpha\CompleteQueryResponse\RecentSearchResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRecentSearchResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2alpha\CompleteQueryResponse\RecentSearchResult::class);
