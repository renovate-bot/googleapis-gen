...
namespace Google\Cloud\Retail\V2alpha\SearchRequest\FacetSpec;
 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.SearchRequest.FacetSpec.FacetKey</code>
 */
class FacetKey extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.Interval intervals = 2;</code>
     */
    private $intervals;
    /**
     ...
     *           * ratingCount
     *           * attributes.key
     *     @type \Google\Cloud\Retail\V2alpha\Interval[]|\Google\Protobuf\Internal\RepeatedField $intervals
     *           Set only if values should be bucketized into intervals. Must be set
     *           for facets with numerical values. Must not be set for facet with text
     *           values. Maximum number of intervals is 30.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2alpha.Interval intervals = 2;</code>
     * @param \Google\Cloud\Retail\V2alpha\Interval[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setIntervals($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2alpha\Interval::class);
        $this->intervals = $arr;
...
class_alias(FacetKey::class, \Google\Cloud\Retail\V2alpha\SearchRequest_FacetSpec_FacetKey::class);
