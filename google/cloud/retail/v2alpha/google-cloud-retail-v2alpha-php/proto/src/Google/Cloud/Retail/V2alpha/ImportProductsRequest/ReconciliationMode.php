...
namespace Google\Cloud\Retail\V2alpha\ImportProductsRequest;
 ...
 *
 * Protobuf type <code>google.cloud.retail.v2alpha.ImportProductsRequest.ReconciliationMode</code>
 */
...
class_alias(ReconciliationMode::class, \Google\Cloud\Retail\V2alpha\ImportProductsRequest_ReconciliationMode::class);
