...
namespace Google\Cloud\Retail\V2alpha\Product;
 ...
 *
 * Protobuf type <code>google.cloud.retail.v2alpha.Product.Availability</code>
 */
class Availability
{
    /**
...
class_alias(Availability::class, \Google\Cloud\Retail\V2alpha\Product_Availability::class);
