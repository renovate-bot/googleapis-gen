 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2alpha.SearchResponse.SearchResult</code>
 */
class SearchResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.Product product = 2;</code>
     */
     ...
     *           [Product.id][google.cloud.retail.v2alpha.Product.id] of the searched
     *           [Product][google.cloud.retail.v2alpha.Product].
     *     @type \Google\Cloud\Retail\V2alpha\Product $product
     *           The product data snippet in the search response. Only
     *           [Product.name][google.cloud.retail.v2alpha.Product.name] is guaranteed to
     *           be populated.
     *           [Product.variants][google.cloud.retail.v2alpha.Product.variants] contains
...
class_alias(SearchResult::class, \Google\Cloud\Retail\V2alpha\SearchResponse_SearchResult::class);
