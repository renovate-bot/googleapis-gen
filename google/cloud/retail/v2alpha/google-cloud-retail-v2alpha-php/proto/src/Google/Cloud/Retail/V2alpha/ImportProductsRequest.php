...
class ImportProductsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.ImportProductsRequest.ReconciliationMode reconciliation_mode = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2alpha.ProductInputConfig input_config = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Retail\V2alpha\ProductInputConfig|null
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Retail\V2alpha\ImportProductsRequest\ReconciliationMode::class);
