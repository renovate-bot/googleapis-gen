...
use Google\Cloud\Retail\V2alpha\AddLocalInventoriesResponse;
...
class ProductServiceClientTest extends GeneratedTest
{
    ...
    public function addLocalInventoriesTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ProductService/AddLocalInventories', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getProduct();
        $this->assertProtobufEquals($formattedProduct, $actualValue);
    ...
    public function createProductTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2alpha.ProductService/CreateProduct', $actualFuncCall);
    ...
    public function deleteProductTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ProductService/DeleteProduct', $actualFuncCall);
    ...
    public function getProductTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ProductService/GetProduct', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function importProductsTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ProductService/ImportProducts', $actualApiFuncCall);
    ...
    public function listProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ProductService/ListProducts', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function removeFulfillmentPlacesTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ProductService/RemoveFulfillmentPlaces', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getProduct();
        $this->assertProtobufEquals($formattedProduct, $actualValue);
        $actualValue = $actualApiRequestObject->getType();
        $this->assertProtobufEquals($type, $actualValue);
    ...
    public function removeLocalInventoriesTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ProductService/RemoveLocalInventories', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getProduct();
        $this->assertProtobufEquals($formattedProduct, $actualValue);
        $actualValue = $actualApiRequestObject->getPlaceIds();
        $this->assertProtobufEquals($placeIds, $actualValue);
    ...
    public function setInventoryTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ProductService/SetInventory', $actualApiFuncCall);
    ...
    public function updateProductTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.ProductService/UpdateProduct', $actualFuncCall);
        $actualValue = $actualRequestObject->getProduct();
        $this->assertProtobufEquals($product, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
