...
class CatalogServiceClientTest extends GeneratedTest
{
    ...
    public function listCatalogsTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2alpha.CatalogService/ListCatalogs', $actualFuncCall);
    ...
    public function updateCatalogTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2alpha.CatalogService/UpdateCatalog', $actualFuncCall);
