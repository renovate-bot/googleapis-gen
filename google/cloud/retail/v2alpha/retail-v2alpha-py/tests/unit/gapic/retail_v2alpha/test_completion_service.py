...
from google.cloud.retail_v2alpha.services.completion_service import CompletionServiceAsyncClient
from google.cloud.retail_v2alpha.services.completion_service import CompletionServiceClient
from google.cloud.retail_v2alpha.services.completion_service import transports
from google.cloud.retail_v2alpha.services.completion_service.transports.base import _GOOGLE_AUTH_VERSION
from google.cloud.retail_v2alpha.types import completion_service
...
def test_completion_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_completion_service_client_client_options_from_dict():
    with mock.patch('google.cloud.retail_v2alpha.services.completion_service.transports.CompletionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_import_completion_data(transport: str = 'grpc', request_type=import_config.ImportCompletionDataRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_completion_data),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_import_completion_data_async(transport: str = 'grpc_asyncio', request_type=import_config.ImportCompletionDataRequest):
    client = CompletionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_completion_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2alpha.services.completion_service.transports.CompletionServiceTransport.__init__') as Transport:
...
def test_completion_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2alpha.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_completion_service_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2alpha.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_completion_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2alpha.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CompletionServiceTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_completion_service_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        CompletionServiceClient()
...
@requires_google_auth_lt_1_25_0
def test_completion_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_completion_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CompletionServiceGrpcTransport, transports.CompletionServiceGrpcAsyncIOTransport])
def test_completion_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
