...
class UserEvent(proto.Message):
    ...
    Attributes:
        ...
        product_details (Sequence[google.cloud.retail_v2alpha.types.ProductDetail]):
            ...
            [product_details][google.cloud.retail.v2alpha.UserEvent.product_details]
            is desired. The end user may have not finished broswing the
            whole page yet.
        attributes (Sequence[google.cloud.retail_v2alpha.types.UserEvent.AttributesEntry]):
        ...
        cart_id (str):
            ...
            events.
        purchase_transaction (google.cloud.retail_v2alpha.types.PurchaseTransaction):
    ...
    product_details = proto.RepeatedField(proto.MESSAGE, number=6,
        message='ProductDetail',
    )

    attributes = proto.MapField(proto.STRING, proto.MESSAGE, number=7,
        message=common.CustomAttribute,
    )

    cart_id = proto.Field(proto.STRING, number=8)

    purchase_transaction = proto.Field(proto.MESSAGE, number=9,
    ...
    user_info = proto.Field(proto.MESSAGE, number=12,
...
class ProductDetail(proto.Message):
    ...
    Attributes:
        product (google.cloud.retail_v2alpha.types.Product):
            Required. [Product][google.cloud.retail.v2alpha.Product]
            information.

            Only [Product.id][google.cloud.retail.v2alpha.Product.id]
            field is used when ingesting an event, all other product
    ...
    quantity = proto.Field(proto.MESSAGE, number=2,
