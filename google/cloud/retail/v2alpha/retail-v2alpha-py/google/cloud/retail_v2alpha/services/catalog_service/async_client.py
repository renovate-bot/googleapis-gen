...
class CatalogServiceAsyncClient:
    ...
    async def list_catalogs(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.ListCatalogsRequest`):
    ...
    async def update_catalog(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.UpdateCatalogRequest`):
                The request object. Request for
    ...
    async def set_default_branch(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.SetDefaultBranchRequest`):
    ...
    async def get_default_branch(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.GetDefaultBranchRequest`):
