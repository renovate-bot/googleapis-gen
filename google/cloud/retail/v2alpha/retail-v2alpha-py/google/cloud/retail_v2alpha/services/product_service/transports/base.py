...
from google.cloud.retail_v2alpha.types import product_service
...
class ProductServiceTransport(abc.ABC):
    ...
    def create_product(self) -> typing.Callable[
            ...
            typing.Union[
                gcr_product.Product,
                typing.Awaitable[gcr_product.Product]
            ]]:
        raise NotImplementedError()
    ...
    def get_product(self) -> typing.Callable[
            ...
            typing.Union[
                product.Product,
                typing.Awaitable[product.Product]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def import_products(self) -> typing.Callable[
