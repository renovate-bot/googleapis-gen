...
class PredictRequest(proto.Message):
    ...
    Attributes:
        ...
        params (Sequence[google.cloud.retail_v2alpha.types.PredictRequest.ParamsEntry]):
        ...
        labels (Sequence[google.cloud.retail_v2alpha.types.PredictRequest.LabelsEntry]):
...
class PredictResponse(proto.Message):
    ...
    class PredictionResult(proto.Message):
        ...
        Attributes:
            ...
            metadata (Sequence[google.cloud.retail_v2alpha.types.PredictResponse.PredictionResult.MetadataEntry]):
