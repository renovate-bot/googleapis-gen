...
class SearchRequest(proto.Message):
    ...
    Attributes:
        ...
        variant_rollup_keys (Sequence[str]):
            ...
            [variant][google.cloud.retail.v2alpha.Product.Type.VARIANT]
            [Product][google.cloud.retail.v2alpha.Product]s are merged
            and de-duplicated. Notice that rollup
            [variant][google.cloud.retail.v2alpha.Product.Type.VARIANT]
            [Product][google.cloud.retail.v2alpha.Product]s attributes
            ...
            Attributes:
                key (str):
                    ...
                    -  textual_field = *# The
                       ...
                       "brands"; *# The
                       [Product.categories][google.cloud.retail.v2alpha.Product.categories].*
                       "categories"; *# The
                       [Audience.genders][google.cloud.retail.v2alpha.Audience.genders].*
                       \| "genders"; *# The
                       [Audience.age_groups][google.cloud.retail.v2alpha.Audience.age_groups].*
                       \| "ageGroups"; *# The
                       ...
                       [ColorInfo.color_families][google.cloud.retail.v2alpha.ColorInfo.color_families].*
                       \| "colorFamilies"; *# The
                       [ColorInfo.colors][google.cloud.retail.v2alpha.ColorInfo.colors].*
                       \| "colors"; *# The
                       [Product.sizes][google.cloud.retail.v2alpha.Product.sizes].*
                       \| "sizes"; *# The
                       [Product.materials][google.cloud.retail.v2alpha.Product.materials].*
                       \| "materials"; *# The
                       [Product.patterns][google.cloud.retail.v2alpha.Product.patterns].*
                       \| "patterns"; *# The
                       [Product.conditions][google.cloud.retail.v2alpha.Product.conditions].*
                       \| "conditions"; *# The textual custom attribute in
                       [Product][google.cloud.retail.v2alpha.Product] object.
                       Key can* *# be any key in the
                       [Product.attributes][google.cloud.retail.v2alpha.Product.attributes]
                    ...
                    -  numerical_field = *# The
                       [PriceInfo.price][google.cloud.retail.v2alpha.PriceInfo.price].*
                       "price"; *# The discount. Computed by
                       (original_price-price)/price * "discount"; *# The
                       [Rating.average_rating][google.cloud.retail.v2alpha.Rating.average_rating].*
                       "rating"; *# The
                       [Rating.rating_count][google.cloud.retail.v2alpha.Rating.rating_count].*
...
class SearchResponse(proto.Message):
    ...
    class SearchResult(proto.Message):
        ...
        Attributes:
            ...
            matching_variant_fields (Sequence[google.cloud.retail_v2alpha.types.SearchResponse.SearchResult.MatchingVariantFieldsEntry]):
                If a
                [variant][google.cloud.retail.v2alpha.Product.Type.VARIANT]
                ...
                and the query.
            variant_rollup_values (Sequence[google.cloud.retail_v2alpha.types.SearchResponse.SearchResult.VariantRollupValuesEntry]):
                The rollup matching
                [variant][google.cloud.retail.v2alpha.Product.Type.VARIANT]
