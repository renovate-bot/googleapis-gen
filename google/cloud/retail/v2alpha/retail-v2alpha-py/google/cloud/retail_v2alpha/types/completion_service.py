...
class CompleteQueryRequest(proto.Message):
    ...
    Attributes:
        ...
        dataset (str):
            ...
            [ImportCompletionData][]. "cloud-retail" will use the
            dataset generated by cloud retail based on user events. If
...
class CompleteQueryResponse(proto.Message):
    ...
    Attributes:
        ...
        attribution_token (str):
            ...
            [SearchRequest][google.cloud.retail.v2alpha.SearchRequest]
            resulting from this completion, which enables accurate
            attribution of complete model performance.
        recent_search_results (Sequence[google.cloud.retail_v2alpha.types.CompleteQueryResponse.RecentSearchResult]):
    ...
    class CompletionResult(proto.Message):
        ...
        Attributes:
            ...
            attributes (Sequence[google.cloud.retail_v2alpha.types.CompleteQueryResponse.CompletionResult.AttributesEntry]):
