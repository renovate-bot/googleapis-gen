    ...
    Attributes:
        ...
        data_schema (str):
            ...
            -  ``product`` (default): One JSON
               [Product][google.cloud.retail.v2alpha.Product] per line.
            ...
            -  ``user_event`` (default): One JSON
               [UserEvent][google.cloud.retail.v2alpha.UserEvent] per
               line.
...
class UserEventInlineSource(proto.Message):
    ...
    Attributes:
        user_events (Sequence[google.cloud.retail_v2alpha.types.UserEvent]):
...
class ImportProductsRequest(proto.Message):
    ...
    Attributes:
        ...
        request_id (str):
            ...
            [ImportProductsRequest.reconciliation_mode][google.cloud.retail.v2alpha.ImportProductsRequest.reconciliation_mode]
            is set to ``FULL``.
        input_config (google.cloud.retail_v2alpha.types.ProductInputConfig):
            Required. The desired input location of the
            data.
        errors_config (google.cloud.retail_v2alpha.types.ImportErrorsConfig):
...
class ImportUserEventsRequest(proto.Message):
    ...
    Attributes:
        ...
        input_config (google.cloud.retail_v2alpha.types.UserEventInputConfig):
            Required. The desired input location of the
            data.
        errors_config (google.cloud.retail_v2alpha.types.ImportErrorsConfig):
            The desired location of errors incurred
...
class ImportCompletionDataRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            Format:
            ``projects/1234/locations/global/catalogs/default_catalog``.
        input_config (google.cloud.retail_v2alpha.types.CompletionDataInputConfig):
            Required. The desired input location of the
            data.
        notification_pubsub_topic (str):
            Pub/Sub topic for receiving notification. If this field is
...
class ProductInputConfig(proto.Message):
    ...
    Attributes:
        product_inline_source (google.cloud.retail_v2alpha.types.ProductInlineSource):
            The Inline source for the input content for
            products.
            This field is a member of `oneof`_ ``source``.
        gcs_source (google.cloud.retail_v2alpha.types.GcsSource):
            Google Cloud Storage location for the input
            content.
            This field is a member of `oneof`_ ``source``.
        big_query_source (google.cloud.retail_v2alpha.types.BigQuerySource):
...
class UserEventInputConfig(proto.Message):
    ...
    Attributes:
        user_event_inline_source (google.cloud.retail_v2alpha.types.UserEventInlineSource):
...
class ImportUserEventsResponse(proto.Message):
    ...
    Attributes:
        ...
        import_summary (google.cloud.retail_v2alpha.types.UserEventImportSummary):
