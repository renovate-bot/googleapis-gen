...
class ProductServiceAsyncClient:
    ...
    async def create_product(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.CreateProductRequest`):
    ...
    async def get_product(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.GetProductRequest`):
    ...
    async def list_products(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.ListProductsRequest`):
                The request object. Request message for
    ...
    async def update_product(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.UpdateProductRequest`):
                The request object. Request message for
    ...
    async def delete_product(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.DeleteProductRequest`):
                The request object. Request message for
    ...
    async def import_products(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.ImportProductsRequest`):
...
initial=0.1,maximum=300.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def set_inventory(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.SetInventoryRequest`):
            ...
            set_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                ...
                [Product][google.cloud.retail.v2alpha.Product] to
                update. If not set or set with empty paths, all
    ...
    async def add_fulfillment_places(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.AddFulfillmentPlacesRequest`):
                The request object. Request message for
    ...
    async def remove_fulfillment_places(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.RemoveFulfillmentPlacesRequest`):
                The request object. Request message for
    ...
    async def add_local_inventories(self,
            request: product_service.AddLocalInventoriesRequest = None,
            *,
            product: str = None,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        Store inventory information can only be modified using this
        method.
        [CreateProduct][google.cloud.retail.v2alpha.ProductService.CreateProduct]
        and
        [UpdateProduct][google.cloud.retail.v2alpha.ProductService.UpdateProduct]
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.AddLocalInventoriesRequest`):
                The request object. Request message for
    ...
    async def remove_local_inventories(self,
            request: product_service.RemoveLocalInventoriesRequest = None,
            *,
            product: str = None,
            retry: retries.Retry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        Store inventory information can only be removed using this
        method.
        [CreateProduct][google.cloud.retail.v2alpha.ProductService.CreateProduct]
        and
        [UpdateProduct][google.cloud.retail.v2alpha.ProductService.UpdateProduct]
        ...
        Args:
            request (:class:`google.cloud.retail_v2alpha.types.RemoveLocalInventoriesRequest`):
                The request object. Request message for
