...
class ::Google::Cloud::Retail::V2alpha::UserEventService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_write_user_event
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2alpha::UserEvent.new
    ...
    write_user_event_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::WriteUserEventRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2alpha::UserEvent), request["user_event"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, write_user_event_client_stub do
      ...
      # Use protobuf object
      client.write_user_event ::Google::Cloud::Retail::V2alpha::WriteUserEventRequest.new(parent: parent, user_event: user_event) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.write_user_event(::Google::Cloud::Retail::V2alpha::WriteUserEventRequest.new(parent: parent, user_event: user_event), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_collect_user_event
    ...
    collect_user_event_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::CollectUserEventRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, collect_user_event_client_stub do
      ...
      # Use protobuf object
      client.collect_user_event ::Google::Cloud::Retail::V2alpha::CollectUserEventRequest.new(parent: parent, user_event: user_event, uri: uri, ets: ets) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.collect_user_event(::Google::Cloud::Retail::V2alpha::CollectUserEventRequest.new(parent: parent, user_event: user_event, uri: uri, ets: ets), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_purge_user_events
    ...
    purge_user_events_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::PurgeUserEventsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, purge_user_events_client_stub do
      ...
      # Use protobuf object
      client.purge_user_events ::Google::Cloud::Retail::V2alpha::PurgeUserEventsRequest.new(parent: parent, filter: filter, force: force) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.purge_user_events(::Google::Cloud::Retail::V2alpha::PurgeUserEventsRequest.new(parent: parent, filter: filter, force: force), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_user_events
    ...
    import_user_events_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::ImportUserEventsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2alpha::UserEventInputConfig), request["input_config"]
    ...
    Gapic::ServiceStub.stub :new, import_user_events_client_stub do
      ...
      # Use protobuf object
      client.import_user_events ::Google::Cloud::Retail::V2alpha::ImportUserEventsRequest.new(parent: parent, input_config: input_config, errors_config: errors_config) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.import_user_events(::Google::Cloud::Retail::V2alpha::ImportUserEventsRequest.new(parent: parent, input_config: input_config, errors_config: errors_config), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_rejoin_user_events
    ...
    rejoin_user_events_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::RejoinUserEventsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, rejoin_user_events_client_stub do
      ...
      # Use protobuf object
      client.rejoin_user_events ::Google::Cloud::Retail::V2alpha::RejoinUserEventsRequest.new(parent: parent, user_event_rejoin_scope: user_event_rejoin_scope) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.rejoin_user_events(::Google::Cloud::Retail::V2alpha::RejoinUserEventsRequest.new(parent: parent, user_event_rejoin_scope: user_event_rejoin_scope), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2alpha::UserEventService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Retail::V2alpha::UserEventService::Operations, client.operations_client
  end
end
