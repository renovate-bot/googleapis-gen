...
class ::Google::Cloud::Retail::V2alpha::CatalogService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_list_catalogs
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2alpha::ListCatalogsResponse.new
    ...
    list_catalogs_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::ListCatalogsRequest, request
    ...
    Gapic::ServiceStub.stub :new, list_catalogs_client_stub do
      ...
      # Use protobuf object
      client.list_catalogs ::Google::Cloud::Retail::V2alpha::ListCatalogsRequest.new(parent: parent, page_size: page_size, page_token: page_token) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      client.list_catalogs(::Google::Cloud::Retail::V2alpha::ListCatalogsRequest.new(parent: parent, page_size: page_size, page_token: page_token), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_catalog
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2alpha::Catalog.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    update_catalog_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::UpdateCatalogRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2alpha::Catalog), request["catalog"]
    ...
    Gapic::ServiceStub.stub :new, update_catalog_client_stub do
      ...
      # Use protobuf object
      client.update_catalog ::Google::Cloud::Retail::V2alpha::UpdateCatalogRequest.new(catalog: catalog, update_mask: update_mask) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_catalog(::Google::Cloud::Retail::V2alpha::UpdateCatalogRequest.new(catalog: catalog, update_mask: update_mask), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_set_default_branch
    ...
    set_default_branch_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::SetDefaultBranchRequest, request
    ...
    Gapic::ServiceStub.stub :new, set_default_branch_client_stub do
      ...
      # Use protobuf object
      client.set_default_branch ::Google::Cloud::Retail::V2alpha::SetDefaultBranchRequest.new(catalog: catalog, branch_id: branch_id, note: note) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.set_default_branch(::Google::Cloud::Retail::V2alpha::SetDefaultBranchRequest.new(catalog: catalog, branch_id: branch_id, note: note), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_default_branch
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2alpha::GetDefaultBranchResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    get_default_branch_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::GetDefaultBranchRequest, request
      assert_equal "hello world", request["catalog"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, get_default_branch_client_stub do
      ...
      # Use protobuf object
      client.get_default_branch ::Google::Cloud::Retail::V2alpha::GetDefaultBranchRequest.new(catalog: catalog) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_default_branch(::Google::Cloud::Retail::V2alpha::GetDefaultBranchRequest.new(catalog: catalog), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2alpha::CatalogService::Client::Configuration, config
  end
end
