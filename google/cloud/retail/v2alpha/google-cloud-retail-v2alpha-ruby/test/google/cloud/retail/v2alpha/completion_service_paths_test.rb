...
class ::Google::Cloud::Retail::V2alpha::CompletionService::ClientPathsTest < Minitest::Test
  def test_catalog_path
    grpc_channel = ::GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ::Gapic::ServiceStub.stub :new, nil do
      client = ::Google::Cloud::Retail::V2alpha::CompletionService::Client.new do |config|
