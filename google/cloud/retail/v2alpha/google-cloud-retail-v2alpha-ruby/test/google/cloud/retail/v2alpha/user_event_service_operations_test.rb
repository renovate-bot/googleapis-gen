...
class ::Google::Cloud::Retail::V2alpha::UserEventService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Retail::V2alpha::UserEventService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2alpha::UserEventService::Operations::Configuration, config
  end
end
