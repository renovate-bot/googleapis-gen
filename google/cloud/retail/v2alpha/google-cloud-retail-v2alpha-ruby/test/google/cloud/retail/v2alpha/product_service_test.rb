...
class ::Google::Cloud::Retail::V2alpha::ProductService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_product
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2alpha::Product.new
    ...
    create_product_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::CreateProductRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2alpha::Product), request["product"]
    ...
    Gapic::ServiceStub.stub :new, create_product_client_stub do
      ...
      # Use protobuf object
      client.create_product ::Google::Cloud::Retail::V2alpha::CreateProductRequest.new(parent: parent, product: product, product_id: product_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.create_product(::Google::Cloud::Retail::V2alpha::CreateProductRequest.new(parent: parent, product: product, product_id: product_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_product
    ...
    get_product_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::GetProductRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_product_client_stub do
      ...
      # Use protobuf object
      client.get_product ::Google::Cloud::Retail::V2alpha::GetProductRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_product(::Google::Cloud::Retail::V2alpha::GetProductRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_products
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2alpha::ListProductsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_products_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::ListProductsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal 42, request["page_size"]
      assert_equal "hello world", request["page_token"]
      assert_equal "hello world", request["filter"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["read_mask"]
      assert_equal true, request["require_total_size"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, list_products_client_stub do
      ...
      # Use hash object
      client.list_products({ parent: parent, page_size: page_size, page_token: page_token, filter: filter, read_mask: read_mask, require_total_size: require_total_size }) do |response, operation|
      ...
      # Use protobuf object
      client.list_products ::Google::Cloud::Retail::V2alpha::ListProductsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, read_mask: read_mask, require_total_size: require_total_size) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.list_products({ parent: parent, page_size: page_size, page_token: page_token, filter: filter, read_mask: read_mask, require_total_size: require_total_size }, grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_products(::Google::Cloud::Retail::V2alpha::ListProductsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, read_mask: read_mask, require_total_size: require_total_size), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_product
    ...
    update_product_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::UpdateProductRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2alpha::Product), request["product"]
    ...
    Gapic::ServiceStub.stub :new, update_product_client_stub do
      ...
      # Use protobuf object
      client.update_product ::Google::Cloud::Retail::V2alpha::UpdateProductRequest.new(product: product, update_mask: update_mask, allow_missing: allow_missing) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_product(::Google::Cloud::Retail::V2alpha::UpdateProductRequest.new(product: product, update_mask: update_mask, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_product
    ...
    delete_product_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::DeleteProductRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_product_client_stub do
      ...
      # Use protobuf object
      client.delete_product ::Google::Cloud::Retail::V2alpha::DeleteProductRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_product(::Google::Cloud::Retail::V2alpha::DeleteProductRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_products
    ...
    import_products_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::ImportProductsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["request_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2alpha::ProductInputConfig), request["input_config"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2alpha::ImportErrorsConfig), request["errors_config"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
    ...
    Gapic::ServiceStub.stub :new, import_products_client_stub do
      ...
      # Use protobuf object
      client.import_products ::Google::Cloud::Retail::V2alpha::ImportProductsRequest.new(parent: parent, request_id: request_id, input_config: input_config, errors_config: errors_config, update_mask: update_mask, reconciliation_mode: reconciliation_mode, notification_pubsub_topic: notification_pubsub_topic) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_set_inventory
    ...
    set_inventory_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::SetInventoryRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2alpha::Product), request["inventory"]
    ...
    Gapic::ServiceStub.stub :new, set_inventory_client_stub do
      ...
      # Use protobuf object
      client.set_inventory ::Google::Cloud::Retail::V2alpha::SetInventoryRequest.new(inventory: inventory, set_mask: set_mask, set_time: set_time, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.set_inventory(::Google::Cloud::Retail::V2alpha::SetInventoryRequest.new(inventory: inventory, set_mask: set_mask, set_time: set_time, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_add_fulfillment_places
    ...
    add_fulfillment_places_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::AddFulfillmentPlacesRequest, request
    ...
    Gapic::ServiceStub.stub :new, add_fulfillment_places_client_stub do
      ...
      # Use protobuf object
      client.add_fulfillment_places ::Google::Cloud::Retail::V2alpha::AddFulfillmentPlacesRequest.new(product: product, type: type, place_ids: place_ids, add_time: add_time, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.add_fulfillment_places(::Google::Cloud::Retail::V2alpha::AddFulfillmentPlacesRequest.new(product: product, type: type, place_ids: place_ids, add_time: add_time, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_remove_fulfillment_places
    ...
    remove_fulfillment_places_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::RemoveFulfillmentPlacesRequest, request
      assert_equal "hello world", request["product"]
      assert_equal "hello world", request["type"]
      assert_equal ["hello world"], request["place_ids"]
    ...
    Gapic::ServiceStub.stub :new, remove_fulfillment_places_client_stub do
      ...
      # Use protobuf object
      client.remove_fulfillment_places ::Google::Cloud::Retail::V2alpha::RemoveFulfillmentPlacesRequest.new(product: product, type: type, place_ids: place_ids, remove_time: remove_time, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.remove_fulfillment_places(::Google::Cloud::Retail::V2alpha::RemoveFulfillmentPlacesRequest.new(product: product, type: type, place_ids: place_ids, remove_time: remove_time, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_add_local_inventories
    ...
    add_local_inventories_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::AddLocalInventoriesRequest, request
      assert_equal "hello world", request["product"]
      assert_kind_of ::Google::Cloud::Retail::V2alpha::LocalInventory, request["local_inventories"].first
    ...
    Gapic::ServiceStub.stub :new, add_local_inventories_client_stub do
      ...
      # Use protobuf object
      client.add_local_inventories ::Google::Cloud::Retail::V2alpha::AddLocalInventoriesRequest.new(product: product, local_inventories: local_inventories, add_mask: add_mask, add_time: add_time, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.add_local_inventories(::Google::Cloud::Retail::V2alpha::AddLocalInventoriesRequest.new(product: product, local_inventories: local_inventories, add_mask: add_mask, add_time: add_time, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_remove_local_inventories
    ...
    remove_local_inventories_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::RemoveLocalInventoriesRequest, request
      assert_equal "hello world", request["product"]
      assert_equal ["hello world"], request["place_ids"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::Timestamp), request["remove_time"]
      assert_equal true, request["allow_missing"]
    ...
    Gapic::ServiceStub.stub :new, remove_local_inventories_client_stub do
      ...
      # Use protobuf object
      client.remove_local_inventories ::Google::Cloud::Retail::V2alpha::RemoveLocalInventoriesRequest.new(product: product, place_ids: place_ids, remove_time: remove_time, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.remove_local_inventories(::Google::Cloud::Retail::V2alpha::RemoveLocalInventoriesRequest.new(product: product, place_ids: place_ids, remove_time: remove_time, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2alpha::ProductService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Retail::V2alpha::ProductService::Operations, client.operations_client
  end
end
