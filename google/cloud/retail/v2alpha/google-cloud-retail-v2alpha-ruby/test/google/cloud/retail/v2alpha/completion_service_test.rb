...
class ::Google::Cloud::Retail::V2alpha::CompletionService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_complete_query
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2alpha::CompleteQueryResponse.new
    ...
    complete_query_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::CompleteQueryRequest, request
    ...
    Gapic::ServiceStub.stub :new, complete_query_client_stub do
      ...
      # Use protobuf object
      client.complete_query ::Google::Cloud::Retail::V2alpha::CompleteQueryRequest.new(catalog: catalog, query: query, visitor_id: visitor_id, language_codes: language_codes, device_type: device_type, dataset: dataset, max_suggestions: max_suggestions) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.complete_query(::Google::Cloud::Retail::V2alpha::CompleteQueryRequest.new(catalog: catalog, query: query, visitor_id: visitor_id, language_codes: language_codes, device_type: device_type, dataset: dataset, max_suggestions: max_suggestions), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_completion_data
    ...
    import_completion_data_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2alpha::ImportCompletionDataRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2alpha::CompletionDataInputConfig), request["input_config"]
    ...
    Gapic::ServiceStub.stub :new, import_completion_data_client_stub do
      ...
      # Use protobuf object
      client.import_completion_data ::Google::Cloud::Retail::V2alpha::ImportCompletionDataRequest.new(parent: parent, input_config: input_config, notification_pubsub_topic: notification_pubsub_topic) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.import_completion_data(::Google::Cloud::Retail::V2alpha::ImportCompletionDataRequest.new(parent: parent, input_config: input_config, notification_pubsub_topic: notification_pubsub_topic), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2alpha::CompletionService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Retail::V2alpha::CompletionService::Operations, client.operations_client
  end
end
