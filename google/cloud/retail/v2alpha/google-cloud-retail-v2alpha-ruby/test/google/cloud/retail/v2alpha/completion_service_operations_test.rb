...
require "google/cloud/retail/v2alpha/completion_service_pb"
require "google/cloud/retail/v2alpha/completion_service_services_pb"
require "google/cloud/retail/v2alpha/completion_service"

class ::Google::Cloud::Retail::V2alpha::CompletionService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Retail::V2alpha::CompletionService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2alpha::CompletionService::Operations::Configuration, config
  end
end
