...
module Google
  module Cloud
    module Retail
      module V2alpha
        # An intended audience of the {::Google::Cloud::Retail::V2alpha::Product Product}
        # for whom it's sold.
        ...
        # The color information of a {::Google::Cloud::Retail::V2alpha::Product Product}.
        ...
        #     {::Google::Cloud::Retail::V2alpha::UserEvent UserEvent}.
        #
        #     Only set if type {::Google::Cloud::Retail::V2alpha::CustomAttribute#text text}
        ...
        #     and
        #     {::Google::Cloud::Retail::V2alpha::SearchRequest#boost_spec SearchRequest.boost_spec}
        #     for more details.
        ...
        #   @return [::Array<::String>]
        #     The IDs for this {::Google::Cloud::Retail::V2alpha::FulfillmentInfo#type type},
        #     such as the store IDs for
        #     {::Google::Cloud::Retail::V2alpha::FulfillmentInfo#type FulfillmentInfo.type.pickup-in-store}
        #     or the region IDs for
        #     {::Google::Cloud::Retail::V2alpha::FulfillmentInfo#type FulfillmentInfo.type.same-day-delivery}.
        #
        ...
        #     must share the same
        #     {::Google::Cloud::Retail::V2alpha::PriceInfo#currency_code currency_code}.
        ...
        #     The timestamp when the {::Google::Cloud::Retail::V2alpha::PriceInfo#price price}
        #     starts to be effective. This can be set as a future timestamp, and the
        #     {::Google::Cloud::Retail::V2alpha::PriceInfo#price price} is only used for
        #     search after
        #     {::Google::Cloud::Retail::V2alpha::PriceInfo#price_effective_time price_effective_time}.
        #     If so, the
        #     {::Google::Cloud::Retail::V2alpha::PriceInfo#original_price original_price} must
        #     be set and
        #     {::Google::Cloud::Retail::V2alpha::PriceInfo#original_price original_price} is
        #     used before
        #     {::Google::Cloud::Retail::V2alpha::PriceInfo#price_effective_time price_effective_time}.
        #
        #     Do not set if {::Google::Cloud::Retail::V2alpha::PriceInfo#price price} is
        ...
        #     {::Google::Cloud::Retail::V2alpha::PriceInfo#price price} is used for search
        #     before
        #     {::Google::Cloud::Retail::V2alpha::PriceInfo#price_expire_time price_expire_time}.
        ...
        #   @return [::Google::Cloud::Retail::V2alpha::PriceInfo::PriceRange]
        #     Output only. The price range of all the child
        #     {::Google::Cloud::Retail::V2alpha::Product::Type::VARIANT Product.Type.VARIANT}
        #     {::Google::Cloud::Retail::V2alpha::Product Product}s grouped together on the
        #     {::Google::Cloud::Retail::V2alpha::Product::Type::PRIMARY Product.Type.PRIMARY}
        #     {::Google::Cloud::Retail::V2alpha::Product Product}. Only populated for
        #     {::Google::Cloud::Retail::V2alpha::Product::Type::PRIMARY Product.Type.PRIMARY}
        ...
        class PriceInfo
          ...
          # {::Google::Cloud::Retail::V2alpha::Product Product} having the same
          # {::Google::Cloud::Retail::V2alpha::Product#primary_product_id Product.primary_product_id}.
          # @!attribute [rw] price
          #   @return [::Google::Cloud::Retail::V2alpha::Interval]
          #     The inclusive
          #     {::Google::Cloud::Retail::V2alpha::PriceInfo#price Product.pricing_info.price}
          #     interval of all
          #     {::Google::Cloud::Retail::V2alpha::Product::Type::VARIANT variant}
          #     {::Google::Cloud::Retail::V2alpha::Product Product} having the same
          #     {::Google::Cloud::Retail::V2alpha::Product#primary_product_id Product.primary_product_id}.
          ...
          #   @return [::Google::Cloud::Retail::V2alpha::Interval]
          #     The inclusive
          #     {::Google::Cloud::Retail::V2alpha::PriceInfo#original_price Product.pricing_info.original_price}
          #     internal of all
          #     {::Google::Cloud::Retail::V2alpha::Product::Type::VARIANT variant}
          #     {::Google::Cloud::Retail::V2alpha::Product Product} having the same
          #     {::Google::Cloud::Retail::V2alpha::Product#primary_product_id Product.primary_product_id}.
        ...
        # The rating of a {::Google::Cloud::Retail::V2alpha::Product Product}.
        # @!attribute [rw] rating_count
        #   @return [::Integer]
        #     The total number of ratings. This value is independent of the value of
        #     {::Google::Cloud::Retail::V2alpha::Rating#rating_histogram rating_histogram}.
        #
        #     This value must be nonnegative. Otherwise, an INVALID_ARGUMENT error is
        #     returned.
        # @!attribute [rw] average_rating
        #   @return [::Float]
        #     The average rating of the {::Google::Cloud::Retail::V2alpha::Product Product}.
        #
        ...
        #     {::Google::Cloud::Retail::V2alpha::Product Product} got 41 ratings with 1 star,
        ...
        #     {::Google::Cloud::Retail::V2alpha::UserEventService::Client#collect_user_event UserEventService.CollectUserEvent}
        #     or if
