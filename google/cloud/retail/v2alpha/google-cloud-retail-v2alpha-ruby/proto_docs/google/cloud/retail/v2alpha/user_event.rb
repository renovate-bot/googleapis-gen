  ...
  module Cloud
    module Retail
      module V2alpha
        ...
        #     Only required for
        #     {::Google::Cloud::Retail::V2alpha::UserEventService::Client#import_user_events UserEventService.ImportUserEvents}
        ...
        #     {::Google::Cloud::Retail::V2alpha::PredictionService::Client#predict PredictionService.Predict}.
        ...
        #     {::Google::Cloud::Retail::V2alpha::PredictionService::Client#predict PredictionService.Predict}.
        #     The value must be a valid
        #     {::Google::Cloud::Retail::V2alpha::SearchResponse#attribution_token SearchResponse.attribution_token}
        #     for user events that are the result of
        ...
        #   @return [::Google::Cloud::Retail::V2alpha::CompletionDetail]
        ...
        #
        #     See {::Google::Cloud::Retail::V2alpha::SearchRequest#query SearchRequest.query}
        #     for definition.
        #
        ...
        #
        #     At least one of
        #     {::Google::Cloud::Retail::V2alpha::UserEvent#search_query search_query} or
        #     {::Google::Cloud::Retail::V2alpha::UserEvent#page_categories page_categories} is
        ...
        #
        #     See
        #     {::Google::Cloud::Retail::V2alpha::SearchRequest#order_by SearchRequest.order_by}
        #     for definition and syntax.
        #
        #     The value must be a UTF-8 encoded string with a length limit of 1,000
        #     characters. Otherwise, an INVALID_ARGUMENT error is returned.
        ...
        #
        #     See
        #     {::Google::Cloud::Retail::V2alpha::SearchRequest#offset SearchRequest.offset}
        #     for definition.
        #
        ...
        #     {::Google::Cloud::Retail::V2alpha::CompleteQueryResponse#attribution_token CompleteQueryResponse.attribution_token}.
        # @!attribute [rw] selected_suggestion
        #   @return [::String]
        #     End user selected
        #     {::Google::Cloud::Retail::V2alpha::CompleteQueryResponse::CompletionResult#suggestion CompleteQueryResponse.CompletionResult.suggestion}.
