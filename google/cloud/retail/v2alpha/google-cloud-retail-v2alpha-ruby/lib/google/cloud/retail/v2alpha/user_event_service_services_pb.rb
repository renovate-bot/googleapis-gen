...
# Source: google/cloud/retail/v2alpha/user_event_service.proto for package 'Google.Cloud.Retail.V2alpha'
      ...
      module V2alpha
        module UserEventService
          ...
          class Service
            ...
            self.service_name = 'google.cloud.retail.v2alpha.UserEventService'

            # Writes a single user event.
            rpc :WriteUserEvent, ::Google::Cloud::Retail::V2alpha::WriteUserEventRequest, ::Google::Cloud::Retail::V2alpha::UserEvent
            ...
            # command first.
            rpc :PurgeUserEvents, ::Google::Cloud::Retail::V2alpha::PurgeUserEventsRequest, ::Google::Longrunning::Operation
            ...
            rpc :ImportUserEvents, ::Google::Cloud::Retail::V2alpha::ImportUserEventsRequest, ::Google::Longrunning::Operation
            ...
            rpc :RejoinUserEvents, ::Google::Cloud::Retail::V2alpha::RejoinUserEventsRequest, ::Google::Longrunning::Operation
          end
