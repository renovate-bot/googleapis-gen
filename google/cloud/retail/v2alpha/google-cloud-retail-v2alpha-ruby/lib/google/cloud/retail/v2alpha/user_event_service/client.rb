      ...
      module V2alpha
        module UserEventService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Retail::V2alpha::UserEventService::Client::Configuration}
            ...
            #
            #     ::Google::Cloud::Retail::V2alpha::UserEventService::Client.configure do |config|
            #       config.timeout = 10.0
            #     end
            #
            ...
            def initialize
              ...
              @user_event_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Retail::V2alpha::UserEventService::Stub,
            ...
            #
            # @return [::Google::Cloud::Retail::V2alpha::UserEventService::Operations]
            #
            ...
            #   {::Google::Cloud::Retail::V2alpha::WriteUserEventRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::WriteUserEventRequest, ::Hash]
            ...
            # @yieldparam response [::Google::Cloud::Retail::V2alpha::UserEvent]
            ...
            def write_user_event request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::WriteUserEventRequest
            ...
            #   {::Google::Cloud::Retail::V2alpha::CollectUserEventRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::CollectUserEventRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def collect_user_event request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::CollectUserEventRequest
            ...
            #   {::Google::Cloud::Retail::V2alpha::PurgeUserEventsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::PurgeUserEventsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def purge_user_events request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::PurgeUserEventsRequest
            ...
            #   {::Google::Cloud::Retail::V2alpha::ImportUserEventsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::ImportUserEventsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def import_user_events request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::ImportUserEventsRequest
            ...
            #   {::Google::Cloud::Retail::V2alpha::RejoinUserEventsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::RejoinUserEventsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def rejoin_user_events request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::RejoinUserEventsRequest
            ...
            # {::Google::Cloud::Retail::V2alpha::UserEventService::Client::Configuration::Rpcs}
