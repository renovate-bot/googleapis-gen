...
# Source: google/cloud/retail/v2alpha/catalog_service.proto for package 'Google.Cloud.Retail.V2alpha'
      ...
      module V2alpha
        module CatalogService
          ...
          class Service
            ...
            self.service_name = 'google.cloud.retail.v2alpha.CatalogService'

            # Lists all the [Catalog][google.cloud.retail.v2alpha.Catalog]s associated
            # with the project.
            rpc :ListCatalogs, ::Google::Cloud::Retail::V2alpha::ListCatalogsRequest, ::Google::Cloud::Retail::V2alpha::ListCatalogsResponse
            # Updates the [Catalog][google.cloud.retail.v2alpha.Catalog]s.
            rpc :UpdateCatalog, ::Google::Cloud::Retail::V2alpha::UpdateCatalogRequest, ::Google::Cloud::Retail::V2alpha::Catalog
