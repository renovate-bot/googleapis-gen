      ...
      module V2alpha
        module ProductService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Retail::V2alpha::ProductService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all ProductService clients
            #   ::Google::Cloud::Retail::V2alpha::ProductService::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::Retail::V2alpha::ProductService::Client.new do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @product_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Retail::V2alpha::ProductService::Stub,
            ...
            #
            # @return [::Google::Cloud::Retail::V2alpha::ProductService::Operations]
            #
            ...
            #   {::Google::Cloud::Retail::V2alpha::CreateProductRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::CreateProductRequest, ::Hash]
            ...
            # @yieldparam response [::Google::Cloud::Retail::V2alpha::Product]
            ...
            def create_product request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::CreateProductRequest
            ...
            #   {::Google::Cloud::Retail::V2alpha::GetProductRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::GetProductRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def get_product request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::GetProductRequest
            ...
            ##
            # Gets a list of {::Google::Cloud::Retail::V2alpha::Product Product}s.
            #
            # @overload list_products(request, options = nil)
            #   Pass arguments to `list_products` via a request object, either of type
            #   {::Google::Cloud::Retail::V2alpha::ListProductsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::ListProductsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            #
            # @overload list_products(parent: nil, page_size: nil, page_token: nil, filter: nil, read_mask: nil, require_total_size: nil)
            ...
            #     {::Google::Cloud::Retail::V2alpha::Product Product}s under this branch,
            #     regardless of whether or not this branch exists, a PERMISSION_DENIED error
            #     is returned.
            #   @param page_size [::Integer]
            #     Maximum number of {::Google::Cloud::Retail::V2alpha::Product Product}s to
            ...
            #     A page token
            #     {::Google::Cloud::Retail::V2alpha::ListProductsResponse#next_page_token ListProductsResponse.next_page_token},
            #     received from a previous
            #     {::Google::Cloud::Retail::V2alpha::ProductService::Client#list_products ProductService.ListProducts}
            ...
            #     {::Google::Cloud::Retail::V2alpha::ListProductsRequest#filter filter} is unset.
            #     * List
            #     {::Google::Cloud::Retail::V2alpha::Product::Type::VARIANT Product.Type.VARIANT}
            #     {::Google::Cloud::Retail::V2alpha::Product Product}s sharing the same
            #       {::Google::Cloud::Retail::V2alpha::Product::Type::PRIMARY Product.Type.PRIMARY}
            #       {::Google::Cloud::Retail::V2alpha::Product Product}. For example:
            #         `primary_product_id = "some_product_id"`
            #     * List {::Google::Cloud::Retail::V2alpha::Product Product}s bundled in a
            #     {::Google::Cloud::Retail::V2alpha::Product::Type::COLLECTION Product.Type.COLLECTION}
            #     {::Google::Cloud::Retail::V2alpha::Product Product}.
            #       For example:
            #         `collection_product_id = "some_product_id"`
            #     * List {::Google::Cloud::Retail::V2alpha::Product Product}s with a partibular
            #     type. For example:
            #         `type = "PRIMARY"`
            #         `type = "VARIANT"`
            #         `type = "COLLECTION"`
            ...
            #     If the specified
            #     {::Google::Cloud::Retail::V2alpha::Product::Type::PRIMARY Product.Type.PRIMARY}
            #     {::Google::Cloud::Retail::V2alpha::Product Product} or
            #     {::Google::Cloud::Retail::V2alpha::Product::Type::COLLECTION Product.Type.COLLECTION}
            #     {::Google::Cloud::Retail::V2alpha::Product Product} does not exist, a NOT_FOUND
            #     error is returned.
            #   @param read_mask [::Google::Protobuf::FieldMask, ::Hash]
            #     The fields of {::Google::Cloud::Retail::V2alpha::Product Product} to return in
            #     the responses. If not set or empty, the following fields are returned:
            #
            #     * {::Google::Cloud::Retail::V2alpha::Product#name Product.name}
            #     * {::Google::Cloud::Retail::V2alpha::Product#id Product.id}
            #     * {::Google::Cloud::Retail::V2alpha::Product#title Product.title}
            #     * {::Google::Cloud::Retail::V2alpha::Product#uri Product.uri}
            #     * {::Google::Cloud::Retail::V2alpha::Product#images Product.images}
            #     * {::Google::Cloud::Retail::V2alpha::Product#price_info Product.price_info}
            #     * {::Google::Cloud::Retail::V2alpha::Product#brands Product.brands}
            #
            #     If "*" is provided, all fields are returned.
            #     {::Google::Cloud::Retail::V2alpha::Product#name Product.name} is always returned
            #     no matter what mask is set.
            #
            #     If an unsupported or unknown field is provided, an INVALID_ARGUMENT error
            #     is returned.
            #   @param require_total_size [::Boolean]
            #     If true and
            #     {::Google::Cloud::Retail::V2alpha::ListProductsRequest#page_token page_token} is
            #     empty,
            #     {::Google::Cloud::Retail::V2alpha::ListProductsResponse#total_size ListProductsResponse.total_size}
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Retail::V2alpha::Product>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Retail::V2alpha::Product>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            def list_products request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::ListProductsRequest
            ...
            #   {::Google::Cloud::Retail::V2alpha::UpdateProductRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::UpdateProductRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     exist and
            #     {::Google::Cloud::Retail::V2alpha::UpdateProductRequest#allow_missing allow_missing}
            ...
            #     If set to true, and the {::Google::Cloud::Retail::V2alpha::Product Product} is
            #     not found, a new {::Google::Cloud::Retail::V2alpha::Product Product} will be
            ...
            def update_product request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::UpdateProductRequest
            ...
            #   {::Google::Cloud::Retail::V2alpha::DeleteProductRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::DeleteProductRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     exist, a NOT_FOUND error is returned.
            #
            #     The {::Google::Cloud::Retail::V2alpha::Product Product} to delete can neither be
            #     a
            #     {::Google::Cloud::Retail::V2alpha::Product::Type::COLLECTION Product.Type.COLLECTION}
            #     {::Google::Cloud::Retail::V2alpha::Product Product} member nor a
            #     {::Google::Cloud::Retail::V2alpha::Product::Type::PRIMARY Product.Type.PRIMARY}
            #     {::Google::Cloud::Retail::V2alpha::Product Product} with more than one
            #     {::Google::Cloud::Retail::V2alpha::Product::Type::VARIANT variants}. Otherwise, an
            #     INVALID_ARGUMENT error is returned.
            #
            #     All inventory information for the named
            #     {::Google::Cloud::Retail::V2alpha::Product Product} will be deleted.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            ...
            def delete_product request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::DeleteProductRequest
            ...
            #   {::Google::Cloud::Retail::V2alpha::ImportProductsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::ImportProductsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Retail::V2alpha::ImportMetadata ImportMetadata}.
            #
            #     Only supported when
            #     {::Google::Cloud::Retail::V2alpha::ImportProductsRequest#reconciliation_mode ImportProductsRequest.reconciliation_mode}
            #     is set to `FULL`.
            ...
            #   @param reconciliation_mode [::Google::Cloud::Retail::V2alpha::ImportProductsRequest::ReconciliationMode]
            #     The mode of reconciliation between existing products and the products to be
            #     imported. Defaults to
            #     {::Google::Cloud::Retail::V2alpha::ImportProductsRequest::ReconciliationMode::INCREMENTAL ReconciliationMode.INCREMENTAL}.
            ...
            def import_products request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::ImportProductsRequest
            ...
            # {::Google::Cloud::Retail::V2alpha::Product Product} while respecting the last
            # update timestamps of each inventory field.
            #
            # This process is asynchronous and does not require the
            # {::Google::Cloud::Retail::V2alpha::Product Product} to exist before updating
            # fulfillment information. If the request is valid, the update will be
            # enqueued and processed downstream. As a consequence, when a response is
            # returned, updates are not immediately manifested in the
            # {::Google::Cloud::Retail::V2alpha::Product Product} queried by
            # {::Google::Cloud::Retail::V2alpha::ProductService::Client#get_product GetProduct} or
            # {::Google::Cloud::Retail::V2alpha::ProductService::Client#list_products ListProducts}.
            #
            # When inventory is updated with
            # {::Google::Cloud::Retail::V2alpha::ProductService::Client#create_product CreateProduct}
            # and
            # {::Google::Cloud::Retail::V2alpha::ProductService::Client#update_product UpdateProduct},
            ...
            # {::Google::Cloud::Retail::V2alpha::CreateProductRequest#product CreateProductRequest.product},
            ...
            # {::Google::Cloud::Retail::V2alpha::ProductService::Client#set_inventory SetInventory},
            # {::Google::Cloud::Retail::V2alpha::ProductService::Client#add_fulfillment_places AddFulfillmentPlaces},
            # and
            # {::Google::Cloud::Retail::V2alpha::ProductService::Client#remove_fulfillment_places RemoveFulfillmentPlaces}.
            #
            ...
            #   {::Google::Cloud::Retail::V2alpha::SetInventoryRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::SetInventoryRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #   the default parameter values, pass an empty Hash as a request object (see above).
            #
            #   @param inventory [::Google::Cloud::Retail::V2alpha::Product, ::Hash]
            #     Required. The inventory information to update. The allowable fields to
            #     update are:
            #     * {::Google::Cloud::Retail::V2alpha::Product#price_info Product.price_info}
            #     * {::Google::Cloud::Retail::V2alpha::Product#availability Product.availability}
            #     * {::Google::Cloud::Retail::V2alpha::Product#available_quantity Product.available_quantity}
            #     * {::Google::Cloud::Retail::V2alpha::Product#fulfillment_info Product.fulfillment_info}
            #     The updated inventory fields must be specified in
            #     {::Google::Cloud::Retail::V2alpha::SetInventoryRequest#set_mask SetInventoryRequest.set_mask}.
            #
            #     If [SetInventoryRequest.inventory.name][] is empty or invalid, an
            #     INVALID_ARGUMENT error is returned.
            #
            #     If the caller does not have permission to update the
            #     {::Google::Cloud::Retail::V2alpha::Product Product} named in
            #     {::Google::Cloud::Retail::V2alpha::Product#name Product.name}, regardless of
            ...
            #     will be inserted.
            #
            #     If the {::Google::Cloud::Retail::V2alpha::Product Product} to update has
            ...
            #     {::Google::Cloud::Retail::V2alpha::SetInventoryRequest#set_time SetInventoryRequest.set_time}.
            #
            ...
            #     {::Google::Cloud::Retail::V2alpha::Product Product} to update. If not set or set
            ...
            #   @param allow_missing [::Boolean]
            #     If set to true, and the {::Google::Cloud::Retail::V2alpha::Product Product} with
            ...
            def set_inventory request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::SetInventoryRequest
            ...
            # {::Google::Cloud::Retail::V2alpha::FulfillmentInfo#place_ids Product.fulfillment_info.place_ids}.
            #
            # This process is asynchronous and does not require the
            # {::Google::Cloud::Retail::V2alpha::Product Product} to exist before updating
            # fulfillment information. If the request is valid, the update will be
            ...
            #   {::Google::Cloud::Retail::V2alpha::AddFulfillmentPlacesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::AddFulfillmentPlacesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Retail::V2alpha::AddFulfillmentPlacesRequest#type type}, such
            #     as the store IDs for "pickup-in-store" or the region IDs for
            #     "same-day-delivery" to be added for this
            #     {::Google::Cloud::Retail::V2alpha::AddFulfillmentPlacesRequest#type type}.
            ...
            #     {::Google::Cloud::Retail::V2alpha::AddFulfillmentPlacesRequest#type type} after
            ...
            def add_fulfillment_places request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::AddFulfillmentPlacesRequest
            ...
            #   {::Google::Cloud::Retail::V2alpha::RemoveFulfillmentPlacesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::RemoveFulfillmentPlacesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #   @param place_ids [::Array<::String>]
            #     Required. The IDs for this
            #     {::Google::Cloud::Retail::V2alpha::RemoveFulfillmentPlacesRequest#type type},
            ...
            def remove_fulfillment_places request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::RemoveFulfillmentPlacesRequest
            ...
            # {::Google::Cloud::Retail::V2alpha::Product Product} at a list of places, while
            ...
            #   {::Google::Cloud::Retail::V2alpha::AddLocalInventoriesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::AddLocalInventoriesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Retail::V2alpha::Product Product}, regardless of whether or
            #     not it exists, a PERMISSION_DENIED error is returned.
            #   @param local_inventories [::Array<::Google::Cloud::Retail::V2alpha::LocalInventory, ::Hash>]
            ...
            #     {::Google::Cloud::Retail::V2alpha::LocalInventory LocalInventory} to update. The
            ...
            def add_local_inventories request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::AddLocalInventoriesRequest
            ...
            # {::Google::Cloud::Retail::V2alpha::Product Product} at a list of places at a
            # removal timestamp.
            #
            ...
            #   {::Google::Cloud::Retail::V2alpha::RemoveLocalInventoriesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::RemoveLocalInventoriesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def remove_local_inventories request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::RemoveLocalInventoriesRequest
            ...
            # {::Google::Cloud::Retail::V2alpha::ProductService::Client::Configuration::Rpcs}
