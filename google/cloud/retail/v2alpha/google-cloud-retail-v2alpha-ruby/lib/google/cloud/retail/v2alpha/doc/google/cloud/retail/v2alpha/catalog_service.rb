...
module Google
  module Cloud
    module Retail
      module V2alpha
        # Request for
        # {Google::Cloud::Retail::V2alpha::CatalogService::ListCatalogs CatalogService::ListCatalogs}
        # method.
        # @!attribute [rw] parent
        #   @return [String]
        ...
        #   @return [Integer]
        #     Maximum number of {Google::Cloud::Retail::V2alpha::Catalog Catalog}s to
        ...
        #   @return [String]
        #     A page token
        #     {Google::Cloud::Retail::V2alpha::ListCatalogsResponse#next_page_token ListCatalogsResponse#next_page_token},
        ...
        #   @return [Array<Google::Cloud::Retail::V2alpha::Catalog>]
        #     All the customer's {Google::Cloud::Retail::V2alpha::Catalog Catalog}s.
        # @!attribute [rw] next_page_token
        #   @return [String]
        #     A token that can be sent as
        #     {Google::Cloud::Retail::V2alpha::ListCatalogsRequest#page_token ListCatalogsRequest#page_token}
        #     to retrieve the next page. If this field is omitted, there are no
        #     subsequent pages.
        class ListCatalogsResponse; end

        # Request for
        # {Google::Cloud::Retail::V2alpha::CatalogService::UpdateCatalog CatalogService::UpdateCatalog}
        # method.
