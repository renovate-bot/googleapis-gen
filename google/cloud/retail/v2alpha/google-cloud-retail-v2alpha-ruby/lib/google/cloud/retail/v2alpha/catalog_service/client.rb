      ...
      module V2alpha
        module CatalogService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Retail::V2alpha::CatalogService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all CatalogService clients
            #   ::Google::Cloud::Retail::V2alpha::CatalogService::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::Retail::V2alpha::CatalogService::Client.new do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @catalog_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Retail::V2alpha::CatalogService::Stub,
            ...
            #   {::Google::Cloud::Retail::V2alpha::ListCatalogsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::ListCatalogsRequest, ::Hash]
            ...
            #     {::Google::Cloud::Retail::V2alpha::CatalogService::Client#list_catalogs CatalogService.ListCatalogs}
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Retail::V2alpha::Catalog>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Retail::V2alpha::Catalog>]
            #
            ...
            #   request = Google::Cloud::Retail::V2alpha::ListCatalogsRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::Retail::V2alpha::Catalog.
            #     p response
            #   end
            #
            def list_catalogs request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::ListCatalogsRequest
            ...
            #   {::Google::Cloud::Retail::V2alpha::UpdateCatalogRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::UpdateCatalogRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Retail::V2alpha::Catalog Catalog} to update.
            #
            #     If an unsupported or unknown field is provided, an INVALID_ARGUMENT error
            #     is returned.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Retail::V2alpha::Catalog]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def update_catalog request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::UpdateCatalogRequest
            ...
            # default, setting
            # {::Google::Cloud::Retail::V2alpha::SearchRequest#branch SearchRequest.branch} to
            ...
            # as {::Google::Cloud::Retail::V2alpha::SearchRequest#branch SearchRequest.branch}
            ...
            #   {::Google::Cloud::Retail::V2alpha::SetDefaultBranchRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::SetDefaultBranchRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Retail::V2alpha::CatalogService::Client#get_default_branch CatalogService.GetDefaultBranch}
            ...
            def set_default_branch request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::SetDefaultBranchRequest
            ...
            # {::Google::Cloud::Retail::V2alpha::CatalogService::Client#set_default_branch CatalogService.SetDefaultBranch}
            ...
            #   {::Google::Cloud::Retail::V2alpha::GetDefaultBranchRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2alpha::GetDefaultBranchRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Retail::V2alpha::GetDefaultBranchResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Google::Cloud::Retail::V2alpha::GetDefaultBranchResponse]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            def get_default_branch request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2alpha::GetDefaultBranchRequest
            ...
            # {::Google::Cloud::Retail::V2alpha::CatalogService::Client::Configuration::Rpcs}
