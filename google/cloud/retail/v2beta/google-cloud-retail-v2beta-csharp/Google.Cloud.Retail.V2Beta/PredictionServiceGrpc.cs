...
namespace Google.Cloud.Retail.V2Beta {
  ...
  public static partial class PredictionService
  {
    ...
    static readonly grpc::Marshaller<global::Google.Cloud.Retail.V2Beta.PredictRequest> __Marshaller_google_cloud_retail_v2beta_PredictRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Cloud.Retail.V2Beta.PredictRequest.Parser));
    static readonly grpc::Marshaller<global::Google.Cloud.Retail.V2Beta.PredictResponse> __Marshaller_google_cloud_retail_v2beta_PredictResponse = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Google.Cloud.Retail.V2Beta.PredictResponse.Parser));
