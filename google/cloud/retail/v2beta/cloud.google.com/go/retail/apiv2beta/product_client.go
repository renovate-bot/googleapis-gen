...
// internalProductClient is an interface that defines the methods availaible from Cloud Retail.
...
// ProductClient is a client for interacting with Cloud Retail.
...
func (c *ProductClient) setGoogleClientInfo(...string) {
...
// productGRPCClient is a client for interacting with Cloud Retail over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
