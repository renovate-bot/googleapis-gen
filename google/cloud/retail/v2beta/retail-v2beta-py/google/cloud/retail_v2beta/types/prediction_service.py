...
class PredictRequest(proto.Message):
    ...
    Attributes:
        ...
        params (Sequence[google.cloud.retail_v2beta.types.PredictRequest.ParamsEntry]):
        ...
        labels (Sequence[google.cloud.retail_v2beta.types.PredictRequest.LabelsEntry]):
    ...
    params = proto.MapField(proto.STRING, proto.MESSAGE, number=7,
...
class PredictResponse(proto.Message):
    ...
    class PredictionResult(proto.Message):
        ...
        Attributes:
            ...
            metadata (Sequence[google.cloud.retail_v2beta.types.PredictResponse.PredictionResult.MetadataEntry]):
        ...
        metadata = proto.MapField(proto.STRING, proto.MESSAGE, number=2,
            message=struct.Value,
        )
