...
class ProductServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(ProductServiceClient).get_transport_class, type(ProductServiceClient))
    ...
    async def create_product(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2beta.types.CreateProductRequest`):
                The request object.
                Request message for
    ...
    async def get_product(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2beta.types.GetProductRequest`):
                The request object.
    ...
    async def update_product(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2beta.types.UpdateProductRequest`):
                The request object.
                Request message for
    ...
    async def delete_product(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2beta.types.DeleteProductRequest`):
                The request object.
                Request message for
    ...
    async def import_products(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2beta.types.ImportProductsRequest`):
                The request object.
