...
from google.cloud.retail_v2beta.types import completion_service
...
class CompletionServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(CompletionServiceClient).get_transport_class, type(CompletionServiceClient))
    ...
    async def complete_query(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2beta.types.CompleteQueryRequest`):
    ...
    async def import_completion_data(self,
        ...
        Args:
            request (:class:`google.cloud.retail_v2beta.types.ImportCompletionDataRequest`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.retail_v2beta.types.ImportCompletionDataResponse` Response of the
