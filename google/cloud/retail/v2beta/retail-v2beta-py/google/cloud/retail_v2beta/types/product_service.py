...
class CreateProductRequest(proto.Message):
    ...
    Attributes:
        ...
        product (google.cloud.retail_v2beta.types.Product):
            Required. The [Product][google.cloud.retail.v2beta.Product]
            to create.
        product_id (str):
            Required. The ID to use for the
            [Product][google.cloud.retail.v2beta.Product], which will
...
class UpdateProductRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            [Product][google.cloud.retail.v2beta.Product] to update. The
        ...
        allow_missing (bool):
            ...
            a new [Product][google.cloud.retail.v2beta.Product] will be
...
class DeleteProductRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            The [Product][google.cloud.retail.v2beta.Product] to delete
            can neither be a
            ...
            [Product][google.cloud.retail.v2beta.Product] with more than
            one
...
class ListProductsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            [Product][google.cloud.retail.v2beta.Product]s under this
            branch, regardless of whether or not this branch exists, a
            PERMISSION_DENIED error is returned.
        page_size (int):
            Maximum number of
            [Product][google.cloud.retail.v2beta.Product]s to return. If
        ...
        filter (str):
            ...
            -  List all the products under the parent branch if
               [filter][google.cloud.retail.v2beta.ListProductsRequest.filter]
               is unset.
            -  List
               [Product.Type.VARIANT][google.cloud.retail.v2beta.Product.Type.VARIANT]
               [Product][google.cloud.retail.v2beta.Product]s sharing
               the same
               [Product.Type.PRIMARY][google.cloud.retail.v2beta.Product.Type.PRIMARY]
               [Product][google.cloud.retail.v2beta.Product]. For
               example: ``primary_product_id = "some_product_id"``
            -  List [Product][google.cloud.retail.v2beta.Product]s
               bundled in a
               [Product.Type.COLLECTION][google.cloud.retail.v2beta.Product.Type.COLLECTION]
               [Product][google.cloud.retail.v2beta.Product]. For
               example: ``collection_product_id = "some_product_id"``
            -  List [Product][google.cloud.retail.v2beta.Product]s with
        ...
        read_mask (google.protobuf.field_mask_pb2.FieldMask):
            The fields of [Product][google.cloud.retail.v2beta.Product]
            ...
            [Product.name][google.cloud.retail.v2beta.Product.name] is
...
class SetInventoryRequest(proto.Message):
    ...
    Attributes:
        inventory (google.cloud.retail_v2beta.types.Product):
            ...
            inventory information will be merged while respecting the
            last update time for each inventory field, using the
        ...
        set_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            [Product][google.cloud.retail.v2beta.Product] to update. If
            not set or set with empty paths, all inventory fields will
            be updated.
        ...
        allow_missing (bool):
            If set to true, and the
            [Product][google.cloud.retail.v2beta.Product] with name
            [Product.name][google.cloud.retail.v2beta.Product.name] is
            not found, the inventory update will still be processed and
            retained for at most 1 day until the
            [Product][google.cloud.retail.v2beta.Product] is created. If
            set to false, an INVALID_ARGUMENT error is returned if the
            [Product][google.cloud.retail.v2beta.Product] is not found.
    """
