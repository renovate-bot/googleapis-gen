...
class ListCatalogsPager:
    ...
    :class:`google.cloud.retail_v2beta.types.ListCatalogsResponse` object, and
    ...
    All the usual :class:`google.cloud.retail_v2beta.types.ListCatalogsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.retail_v2beta.types.ListCatalogsRequest):
                The initial request object.
            response (google.cloud.retail_v2beta.types.ListCatalogsResponse):
    ...
    @property
    def pages(self) -> Iterator[catalog_service.ListCatalogsResponse]:
    ...
    def __iter__(self) -> Iterator[catalog.Catalog]:
...
class ListCatalogsAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[catalog_service.ListCatalogsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
            yield self._response
    def __aiter__(self) -> AsyncIterator[catalog.Catalog]:
