...
class CatalogServiceClient(metaclass=CatalogServiceClientMeta):
    ...
    def update_catalog(self,
        ...
        Args:
            request (google.cloud.retail_v2beta.types.UpdateCatalogRequest):
                The request object. Request for
    ...
    def set_default_branch(self,
        ...
        Args:
            request (google.cloud.retail_v2beta.types.SetDefaultBranchRequest):
    ...
    def get_default_branch(self,
        ...
        Args:
            request (google.cloud.retail_v2beta.types.GetDefaultBranchRequest):
