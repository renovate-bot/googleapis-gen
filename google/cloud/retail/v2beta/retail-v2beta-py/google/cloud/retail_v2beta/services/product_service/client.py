...
class ProductServiceClient(metaclass=ProductServiceClientMeta):
    ...
    def list_products(self,
        ...
        Args:
            request (google.cloud.retail_v2beta.types.ListProductsRequest):
                The request object. Request message for
    ...
    def set_inventory(self,
        ...
        Args:
            request (google.cloud.retail_v2beta.types.SetInventoryRequest):
    ...
    def add_fulfillment_places(self,
        ...
        Args:
            request (google.cloud.retail_v2beta.types.AddFulfillmentPlacesRequest):
                The request object. Request message for
    ...
    def remove_fulfillment_places(self,
        ...
        Args:
            request (google.cloud.retail_v2beta.types.RemoveFulfillmentPlacesRequest):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.remove_fulfillment_places]
