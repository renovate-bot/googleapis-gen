...
class SearchRequest(proto.Message):
    ...
    Attributes:
        ...
        variant_rollup_keys (Sequence[str]):
            ...
            [variant][google.cloud.retail.v2beta.Product.Type.VARIANT]
            [Product][google.cloud.retail.v2beta.Product]s are merged
            ...
            Attributes:
                key (str):
                    ...
                    -  textual_field = *# The
                       ...
                       "brands"; *# The
                       [Product.categories][google.cloud.retail.v2beta.Product.categories].*
                       "categories"; *# The
                       [Audience.genders][google.cloud.retail.v2beta.Audience.genders].*
                       \| "genders"; *# The
                       [Audience.age_groups][google.cloud.retail.v2beta.Audience.age_groups].*
                       \| "ageGroups"; *# The
                       ...
                       [ColorInfo.color_families][google.cloud.retail.v2beta.ColorInfo.color_families].*
                       \| "colorFamilies"; *# The
                       [ColorInfo.colors][google.cloud.retail.v2beta.ColorInfo.colors].*
                       \| "colors"; *# The
                       [Product.sizes][google.cloud.retail.v2beta.Product.sizes].*
                       \| "sizes"; *# The
                       [Product.materials][google.cloud.retail.v2beta.Product.materials].*
                       \| "materials"; *# The
                       [Product.patterns][google.cloud.retail.v2beta.Product.patterns].*
                       \| "patterns"; *# The
                       [Product.conditions][google.cloud.retail.v2beta.Product.conditions].*
                       \| "conditions"; *# The textual custom attribute in
                       [Product][google.cloud.retail.v2beta.Product] object. Key
                    ...
                    -  numerical_field = *# The
                       [PriceInfo.price][google.cloud.retail.v2beta.PriceInfo.price].*
                       "price"; *# The discount. Computed by
                       (original_price-price)/price * "discount"; *# The
                       [Rating.average_rating][google.cloud.retail.v2beta.Rating.average_rating].*
                       "rating"; *# The
                       [Rating.rating_count][google.cloud.retail.v2beta.Rating.rating_count].*
...
class SearchResponse(proto.Message):
    ...
    class SearchResult(proto.Message):
        ...
        Attributes:
            ...
            matching_variant_fields (Sequence[google.cloud.retail_v2beta.types.SearchResponse.SearchResult.MatchingVariantFieldsEntry]):
                If a
                [variant][google.cloud.retail.v2beta.Product.Type.VARIANT]
                ...
                the query.
            variant_rollup_values (Sequence[google.cloud.retail_v2beta.types.SearchResponse.SearchResult.VariantRollupValuesEntry]):
                The rollup matching
                [variant][google.cloud.retail.v2beta.Product.Type.VARIANT]
