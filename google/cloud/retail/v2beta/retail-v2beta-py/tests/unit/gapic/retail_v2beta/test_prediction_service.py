...
from google.cloud.retail_v2beta.services.prediction_service import PredictionServiceAsyncClient
from google.cloud.retail_v2beta.services.prediction_service import PredictionServiceClient
from google.cloud.retail_v2beta.services.prediction_service import transports
from google.cloud.retail_v2beta.services.prediction_service.transports.base import _API_CORE_VERSION
from google.cloud.retail_v2beta.services.prediction_service.transports.base import _GOOGLE_AUTH_VERSION
from google.cloud.retail_v2beta.types import common
from google.cloud.retail_v2beta.types import prediction_service
...
def test_prediction_service_client_client_options_from_dict():
    with mock.patch('google.cloud.retail_v2beta.services.prediction_service.transports.PredictionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_prediction_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2beta.services.prediction_service.transports.PredictionServiceTransport.__init__') as Transport:
...
def test_prediction_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2beta.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_prediction_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2beta.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PredictionServiceTransport()
        adc.assert_called_once()
...
def test_product_path():
    ...
    actual = PredictionServiceClient.product_path(project, location, catalog, branch, product)
