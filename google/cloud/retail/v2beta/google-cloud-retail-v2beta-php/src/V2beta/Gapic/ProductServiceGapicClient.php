 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/retail/v2beta/product_service.proto
 * and updates to that file get reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\Retail\V2beta\Gapic;
...
use Google\Cloud\Retail\V2beta\CreateProductRequest;
use Google\Cloud\Retail\V2beta\DeleteProductRequest;
use Google\Cloud\Retail\V2beta\GetProductRequest;
use Google\Cloud\Retail\V2beta\ImportErrorsConfig;
use Google\Cloud\Retail\V2beta\ImportProductsRequest;
use Google\Cloud\Retail\V2beta\Product;
use Google\Cloud\Retail\V2beta\ProductInputConfig;
use Google\Cloud\Retail\V2beta\UpdateProductRequest;
...
class ProductServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.retail.v2beta.ProductService';
     ...
     * @param Product $product   Required. The [Product][google.cloud.retail.v2beta.Product] to create.
     * @param string  $productId Required. The ID to use for the
