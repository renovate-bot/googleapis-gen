 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/retail/v2beta/catalog_service.proto
...
use Google\Cloud\Retail\V2beta\ListCatalogsRequest;
use Google\Cloud\Retail\V2beta\ListCatalogsResponse;
use Google\Cloud\Retail\V2beta\UpdateCatalogRequest;
...
class CatalogServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.retail.v2beta.CatalogService';
     ...
     * ```
     *
     * @param Catalog $catalog Required. The [Catalog][google.cloud.retail.v2beta.Catalog] to update.
     *
    ...
    public function updateCatalog($catalog, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor([
          'catalog.name' => $request->getCatalog()->getName(),
        ]);
        $optionalArgs['headers'] = isset($optionalArgs['headers'])
            ? array_merge($requestParams->getHeader(), $optionalArgs['headers'])
            : $requestParams->getHeader();
