 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/retail/v2beta/user_event_service.proto
...
use Google\Cloud\Retail\V2beta\CollectUserEventRequest;
use Google\Cloud\Retail\V2beta\ImportErrorsConfig;
use Google\Cloud\Retail\V2beta\ImportMetadata;
use Google\Cloud\Retail\V2beta\ImportUserEventsRequest;
use Google\Cloud\Retail\V2beta\PurgeUserEventsRequest;
use Google\Cloud\Retail\V2beta\RejoinUserEventsRequest;
use Google\Cloud\Retail\V2beta\RejoinUserEventsRequest\UserEventRejoinScope;
use Google\Cloud\Retail\V2beta\UserEvent;
use Google\Cloud\Retail\V2beta\UserEventInputConfig;
use Google\Cloud\Retail\V2beta\WriteUserEventRequest;
...
class UserEventServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.retail.v2beta.UserEventService';
     ...
     *          For allowed values, use constants defined on {@see \Google\Cloud\Retail\V2beta\RejoinUserEventsRequest\UserEventRejoinScope}
     *     @type RetrySettings|array $retrySettings
     *          Retry settings to use for this call. Can be a
     *          {@see Google\ApiCore\RetrySettings} object, or an associative array
     *          of retry settings parameters. See the documentation on
