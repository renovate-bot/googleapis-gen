 ...
 *
 * Protobuf type <code>google.cloud.retail.v2beta.SearchRequest.SearchMode</code>
 */
class SearchMode
{
    /**
...
class_alias(SearchMode::class, \Google\Cloud\Retail\V2beta\SearchRequest_SearchMode::class);
