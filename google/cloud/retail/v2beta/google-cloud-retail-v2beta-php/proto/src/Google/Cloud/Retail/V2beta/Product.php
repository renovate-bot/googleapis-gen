 ...
 * searched.
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.Product</code>
 */
class Product extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.PriceInfo price_info = 14;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.Product.Availability availability = 19;</code>
     */
     ...
     *           Google Merchant Center property
     *           [custom_label_0–4](https://support.google.com/merchants/answer/6324473).
     *     @type \Google\Cloud\Retail\V2beta\PriceInfo $price_info
     *           Product price and cost information.
     *           Google Merchant Center property
     *           [price](https://support.google.com/merchants/answer/6324371).
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Retail\V2beta\Product\Type::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.PriceInfo price_info = 14;</code>
     * @return \Google\Cloud\Retail\V2beta\PriceInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.PriceInfo price_info = 14;</code>
     * @param \Google\Cloud\Retail\V2beta\PriceInfo $var
     * @return $this
     */
    public function setPriceInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\PriceInfo::class);
        $this->price_info = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Retail\V2beta\Product\Availability::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2beta.Image images = 23;</code>
     * @param \Google\Cloud\Retail\V2beta\Image[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setImages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2beta\Image::class);
        $this->images = $arr;
