 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.ProductInlineSource</code>
 */
class ProductInlineSource extends \Google\Protobuf\Internal\Message
{
     ...
     * of 100 items.
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2beta.Product products = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $products;
     ...
     *
     *     @type \Google\Cloud\Retail\V2beta\Product[]|\Google\Protobuf\Internal\RepeatedField $products
     *           Required. A list of products to update/create. Each product must have a
     *           valid [Product.id][google.cloud.retail.v2beta.Product.id]. Recommended max
     *           of 100 items.
     * }
