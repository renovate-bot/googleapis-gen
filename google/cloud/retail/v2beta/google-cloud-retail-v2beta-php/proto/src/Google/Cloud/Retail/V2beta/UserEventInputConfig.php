 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.UserEventInputConfig</code>
 */
class UserEventInputConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Retail\V2beta\UserEventInlineSource $user_event_inline_source
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.UserEventInlineSource user_event_inline_source = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Retail\V2beta\UserEventInlineSource $var
     * @return $this
     */
    public function setUserEventInlineSource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\UserEventInlineSource::class);
