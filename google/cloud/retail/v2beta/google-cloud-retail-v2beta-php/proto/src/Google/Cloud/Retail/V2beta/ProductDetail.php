 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.ProductDetail</code>
 */
class ProductDetail extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.Product product = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.Product product = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Retail\V2beta\Product|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.Product product = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Retail\V2beta\Product $var
     * @return $this
     */
    public function setProduct($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\Product::class);
        $this->product = $var;
