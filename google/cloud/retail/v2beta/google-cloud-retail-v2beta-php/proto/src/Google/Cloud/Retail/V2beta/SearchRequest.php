 ...
 * method.
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.SearchRequest</code>
 */
class SearchRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * User information.
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.UserInfo user_info = 5;</code>
     */
     ...
     * is returned.
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2beta.SearchRequest.FacetSpec facet_specs = 12;</code>
     */
    private $facet_specs;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.SearchRequest.DynamicFacetSpec dynamic_facet_spec = 21;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.SearchRequest.SearchMode search_mode = 31;</code>
     */
     ...
     *           The field must be a UTF-8 encoded string with a length limit of 128
     *           characters. Otherwise, an INVALID_ARGUMENT error is returned.
     *     @type \Google\Cloud\Retail\V2beta\UserInfo $user_info
     *           User information.
     *     @type int $page_size
     *           Maximum number of [Product][google.cloud.retail.v2beta.Product]s to return.
     *           If unspecified, defaults to a reasonable value. The maximum allowed value
     ...
     *           A maximum of 100 values are allowed. Otherwise, an INVALID_ARGUMENT error
     *           is returned.
     *     @type \Google\Cloud\Retail\V2beta\SearchRequest\DynamicFacetSpec $dynamic_facet_spec
     *           The specification for dynamically generated facets. Notice that only
     *           textual facets can be dynamically generated.
     *           This feature requires additional allowlisting. Contact Retail Search
     *           support team if you are interested in using dynamic facet feature.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.UserInfo user_info = 5;</code>
     * @param \Google\Cloud\Retail\V2beta\UserInfo $var
     * @return $this
     */
    public function setUserInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\UserInfo::class);
        $this->user_info = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2beta.SearchRequest.FacetSpec facet_specs = 12;</code>
     * @param \Google\Cloud\Retail\V2beta\SearchRequest\FacetSpec[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFacetSpecs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2beta\SearchRequest\FacetSpec::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.SearchRequest.DynamicFacetSpec dynamic_facet_spec = 21;</code>
     * @return \Google\Cloud\Retail\V2beta\SearchRequest\DynamicFacetSpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.SearchRequest.DynamicFacetSpec dynamic_facet_spec = 21;</code>
     * @param \Google\Cloud\Retail\V2beta\SearchRequest\DynamicFacetSpec $var
     * @return $this
     */
    public function setDynamicFacetSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\SearchRequest\DynamicFacetSpec::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\SearchRequest\BoostSpec::class);
        $this->boost_spec = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\SearchRequest\QueryExpansionSpec::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Retail\V2beta\SearchRequest\SearchMode::class);
