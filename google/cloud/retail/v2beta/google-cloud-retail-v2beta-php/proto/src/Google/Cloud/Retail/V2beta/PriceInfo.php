 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.PriceInfo</code>
 */
class PriceInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.PriceInfo.PriceRange price_range = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Do not set if [price][google.cloud.retail.v2beta.PriceInfo.price] is always
     *           effective because it will cause additional latency during search.
     *     @type \Google\Cloud\Retail\V2beta\PriceInfo\PriceRange $price_range
     *           Output only. The price range of all the child
     *           [Product.Type.VARIANT][google.cloud.retail.v2beta.Product.Type.VARIANT]
     *           [Product][google.cloud.retail.v2beta.Product]s grouped together on the
     *           [Product.Type.PRIMARY][google.cloud.retail.v2beta.Product.Type.PRIMARY]
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.PriceInfo.PriceRange price_range = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\Retail\V2beta\PriceInfo\PriceRange|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.PriceInfo.PriceRange price_range = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Retail\V2beta\PriceInfo\PriceRange $var
     * @return $this
     */
    public function setPriceRange($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\PriceInfo\PriceRange::class);
