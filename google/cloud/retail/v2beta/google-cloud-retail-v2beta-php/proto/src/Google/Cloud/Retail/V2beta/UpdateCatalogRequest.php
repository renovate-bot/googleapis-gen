 ...
 * method.
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.UpdateCatalogRequest</code>
 */
class UpdateCatalogRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.Catalog catalog = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\Retail\V2beta\Catalog $catalog
     *           Required. The [Catalog][google.cloud.retail.v2beta.Catalog] to update.
     *           If the caller does not have permission to update the
     *           [Catalog][google.cloud.retail.v2beta.Catalog], regardless of whether or not
     *           it exists, a PERMISSION_DENIED error is returned.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.Catalog catalog = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Retail\V2beta\Catalog|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.Catalog catalog = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Retail\V2beta\Catalog $var
     * @return $this
     */
    public function setCatalog($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\Catalog::class);
        $this->catalog = $var;
