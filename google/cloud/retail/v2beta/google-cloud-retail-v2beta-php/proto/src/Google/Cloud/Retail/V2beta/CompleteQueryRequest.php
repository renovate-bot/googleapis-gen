 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.CompleteQueryRequest</code>
 */
class CompleteQueryRequest extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Retail\V2Beta\CompletionService::initOnce();
