 ...
 * occurred.
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.SearchResponse.QueryExpansionInfo</code>
 */
...
class_alias(QueryExpansionInfo::class, \Google\Cloud\Retail\V2beta\SearchResponse_QueryExpansionInfo::class);
