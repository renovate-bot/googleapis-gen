...
namespace Google\Cloud\Retail\V2beta\SearchRequest\QueryExpansionSpec;
 ...
 *
 * Protobuf type <code>google.cloud.retail.v2beta.SearchRequest.QueryExpansionSpec.Condition</code>
 */
class Condition
{
    /**
...
class_alias(Condition::class, \Google\Cloud\Retail\V2beta\SearchRequest_QueryExpansionSpec_Condition::class);
