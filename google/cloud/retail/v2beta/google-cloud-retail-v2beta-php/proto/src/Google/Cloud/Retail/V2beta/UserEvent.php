 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.UserEvent</code>
 */
class UserEvent extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2beta.ProductDetail product_details = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.CompletionDetail completion_detail = 22;</code>
     */
     ...
     * search, and etc.
     *
     * Generated from protobuf field <code>map<string, .google.cloud.retail.v2beta.CustomAttribute> attributes = 7;</code>
     */
    private $attributes;
    /**
     ...
     *           [PredictResponse.attribution_token][google.cloud.retail.v2beta.PredictResponse.attribution_token]
     *           to this field.
     *     @type \Google\Cloud\Retail\V2beta\ProductDetail[]|\Google\Protobuf\Internal\RepeatedField $product_details
     *           The main product details related to the event.
     *           This field is required for the following event types:
     *           * `add-to-cart`
     *           * `detail-page-view`
     ...
     *           [product_details][google.cloud.retail.v2beta.UserEvent.product_details] is
     *           desired. The end user may have not finished browsing the whole page yet.
     *     @type \Google\Cloud\Retail\V2beta\CompletionDetail $completion_detail
     *           The main completion details related to the event.
     *           In a `completion` event, this field represents the completions returned to
     *           the end user and the clicked completion by the end user. In a `search`
     *           event, it represents the search event happens after clicking completion.
     ...
     *           This can only be set for `add-to-cart`, `purchase-complete`, or
     *           `shopping-cart-page-view` events.
     *     @type \Google\Cloud\Retail\V2beta\PurchaseTransaction $purchase_transaction
     *           A transaction represents the entire purchase transaction.
     *           Required for `purchase-complete` events. Other event types should not set
     *           this field. Otherwise, an INVALID_ARGUMENT error is returned.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2beta.ProductDetail product_details = 6;</code>
     * @param \Google\Cloud\Retail\V2beta\ProductDetail[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProductDetails($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2beta\ProductDetail::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.CompletionDetail completion_detail = 22;</code>
     * @return \Google\Cloud\Retail\V2beta\CompletionDetail|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.CompletionDetail completion_detail = 22;</code>
     * @param \Google\Cloud\Retail\V2beta\CompletionDetail $var
     * @return $this
     */
    public function setCompletionDetail($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\CompletionDetail::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.PurchaseTransaction purchase_transaction = 9;</code>
     * @param \Google\Cloud\Retail\V2beta\PurchaseTransaction $var
     * @return $this
     */
    public function setPurchaseTransaction($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\PurchaseTransaction::class);
