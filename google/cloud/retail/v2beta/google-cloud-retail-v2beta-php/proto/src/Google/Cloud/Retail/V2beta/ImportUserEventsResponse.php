 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.ImportUserEventsResponse</code>
 */
class ImportUserEventsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *           Echoes the destination for the complete errors if this field was set in
     *           the request.
     *     @type \Google\Cloud\Retail\V2beta\UserEventImportSummary $import_summary
     *           Aggregated statistics of user event import status.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.UserEventImportSummary import_summary = 3;</code>
     * @param \Google\Cloud\Retail\V2beta\UserEventImportSummary $var
     * @return $this
     */
    public function setImportSummary($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\UserEventImportSummary::class);
