...
namespace Google\Cloud\Retail\V2beta\SearchRequest;
 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.SearchRequest.FacetSpec</code>
 */
class FacetSpec extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.SearchRequest.FacetSpec.FacetKey facet_key = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\Retail\V2beta\SearchRequest\FacetSpec\FacetKey $facet_key
     *           Required. The facet key specification.
     *     @type int $limit
     *           Maximum of facet values that should be returned for this facet. If
     *           unspecified, defaults to 20. The maximum allowed value is 300. Values
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.SearchRequest.FacetSpec.FacetKey facet_key = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Retail\V2beta\SearchRequest\FacetSpec\FacetKey|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.SearchRequest.FacetSpec.FacetKey facet_key = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Retail\V2beta\SearchRequest\FacetSpec\FacetKey $var
     * @return $this
     */
    public function setFacetKey($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\SearchRequest\FacetSpec\FacetKey::class);
        $this->facet_key = $var;
...
class_alias(FacetSpec::class, \Google\Cloud\Retail\V2beta\SearchRequest_FacetSpec::class);
