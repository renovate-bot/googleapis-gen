...
namespace Google\Cloud\Retail\V2beta\SearchRequest\FacetSpec;
 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.SearchRequest.FacetSpec.FacetKey</code>
 */
class FacetKey extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2beta.Interval intervals = 2;</code>
     */
    private $intervals;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2beta.Interval intervals = 2;</code>
     * @param \Google\Cloud\Retail\V2beta\Interval[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setIntervals($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Retail\V2beta\Interval::class);
        $this->intervals = $arr;
...
class_alias(FacetKey::class, \Google\Cloud\Retail\V2beta\SearchRequest_FacetSpec_FacetKey::class);
