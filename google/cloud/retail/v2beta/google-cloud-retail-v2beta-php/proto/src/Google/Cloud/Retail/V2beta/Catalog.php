 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2beta.Catalog</code>
 */
class Catalog extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.ProductLevelConfig product_level_config = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           This field must be a UTF-8 encoded string with a length limit of 128
     *           characters. Otherwise, an INVALID_ARGUMENT error is returned.
     *     @type \Google\Cloud\Retail\V2beta\ProductLevelConfig $product_level_config
     *           Required. The product level configuration.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.ProductLevelConfig product_level_config = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Retail\V2beta\ProductLevelConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.retail.v2beta.ProductLevelConfig product_level_config = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Retail\V2beta\ProductLevelConfig $var
     * @return $this
     */
    public function setProductLevelConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Retail\V2beta\ProductLevelConfig::class);
