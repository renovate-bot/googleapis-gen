...
namespace Google\Cloud\Retail\V2beta\Product;
 ...
 *
 * Protobuf type <code>google.cloud.retail.v2beta.Product.Availability</code>
 */
class Availability
{
    /**
...
class_alias(Availability::class, \Google\Cloud\Retail\V2beta\Product_Availability::class);
