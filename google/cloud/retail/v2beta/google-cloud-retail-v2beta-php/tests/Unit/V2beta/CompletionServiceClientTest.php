...
use Google\Cloud\Retail\V2beta\BigQuerySource;

use Google\Cloud\Retail\V2beta\CompleteQueryResponse;
use Google\Cloud\Retail\V2beta\CompletionDataInputConfig;
use Google\Cloud\Retail\V2beta\CompletionDataInputConfig\SourceOneof;
use Google\Cloud\Retail\V2beta\CompletionServiceClient;
use Google\Cloud\Retail\V2beta\ImportCompletionDataResponse;
...
class CompletionServiceClientTest extends GeneratedTest
{
    ...
    public function completeQueryTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2beta.CompletionService/CompleteQuery', $actualFuncCall);
    ...
    public function importCompletionDataTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2beta.CompletionService/ImportCompletionData', $actualApiFuncCall);
