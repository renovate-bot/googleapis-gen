...
namespace Google\Cloud\Retail\Tests\Unit\V2beta;
...
use Google\Cloud\Retail\V2beta\AddFulfillmentPlacesResponse;
use Google\Cloud\Retail\V2beta\ImportProductsResponse;

use Google\Cloud\Retail\V2beta\ListProductsResponse;
use Google\Cloud\Retail\V2beta\Product;
use Google\Cloud\Retail\V2beta\ProductInputConfig;
use Google\Cloud\Retail\V2beta\ProductServiceClient;
use Google\Cloud\Retail\V2beta\RemoveFulfillmentPlacesResponse;
use Google\Cloud\Retail\V2beta\SetInventoryResponse;
...
class ProductServiceClientTest extends GeneratedTest
{
    ...
    public function addFulfillmentPlacesTest()
    {
        ...
        // Mock request
        $formattedProduct = $client->productName('[PROJECT]', '[LOCATION]', '[CATALOG]', '[BRANCH]', '[PRODUCT]');
        $type = 'type3575610';
        $placeIds = [];
        $response = $client->addFulfillmentPlaces($formattedProduct, $type, $placeIds);
        ...
        $this->assertSame('/google.cloud.retail.v2beta.ProductService/AddFulfillmentPlaces', $actualApiFuncCall);
    ...
    public function createProductTest()
    {
        ...
        $name = 'name3373707';
        $id = 'id3355';
        $primaryProductId = 'primaryProductId-898851640';
        $gtin = 'gtin3183314';
        ...
        $expectedResponse->setPrimaryProductId($primaryProductId);
        ...
        $this->assertSame('/google.cloud.retail.v2beta.ProductService/CreateProduct', $actualFuncCall);
    ...
    public function deleteProductTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $client->productName('[PROJECT]', '[LOCATION]', '[CATALOG]', '[BRANCH]', '[PRODUCT]');
        $client->deleteProduct($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.ProductService/DeleteProduct', $actualFuncCall);
    ...
    public function getProductTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.ProductService/GetProduct', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function importProductsTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/importProductsTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new ImportProductsResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/importProductsTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $response = $client->importProducts($formattedParent, $inputConfig);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.ProductService/ImportProducts', $actualApiFuncCall);
    ...
    public function listProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.ProductService/ListProducts', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function removeFulfillmentPlacesTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/removeFulfillmentPlacesTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new RemoveFulfillmentPlacesResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/removeFulfillmentPlacesTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $type = 'type3575610';
        $placeIds = [];
        $response = $client->removeFulfillmentPlaces($formattedProduct, $type, $placeIds);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.ProductService/RemoveFulfillmentPlaces', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getProduct();
        $this->assertProtobufEquals($formattedProduct, $actualValue);
        $actualValue = $actualApiRequestObject->getType();
        $this->assertProtobufEquals($type, $actualValue);
    ...
    public function setInventoryTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/setInventoryTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new SetInventoryResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/setInventoryTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $response = $client->setInventory($inventory);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.ProductService/SetInventory', $actualApiFuncCall);
    ...
    public function updateProductTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.ProductService/UpdateProduct', $actualFuncCall);
        $actualValue = $actualRequestObject->getProduct();
        $this->assertProtobufEquals($product, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
