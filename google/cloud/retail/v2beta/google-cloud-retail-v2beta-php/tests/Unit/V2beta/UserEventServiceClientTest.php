...
use Google\Cloud\Retail\V2beta\GcsSource;
use Google\Cloud\Retail\V2beta\ImportUserEventsResponse;
use Google\Cloud\Retail\V2beta\PurgeUserEventsResponse;
use Google\Cloud\Retail\V2beta\RejoinUserEventsResponse;
use Google\Cloud\Retail\V2beta\UserEvent;
use Google\Cloud\Retail\V2beta\UserEventInlineSource;
use Google\Cloud\Retail\V2beta\UserEventInputConfig;
use Google\Cloud\Retail\V2beta\UserEventInputConfig\SourceOneof;
use Google\Cloud\Retail\V2beta\UserEventServiceClient;
...
class UserEventServiceClientTest extends GeneratedTest
{
    ...
    public function collectUserEventTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2beta.UserEventService/CollectUserEvent', $actualFuncCall);
    ...
    public function importUserEventsTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2beta.UserEventService/ImportUserEvents', $actualApiFuncCall);
    ...
    public function purgeUserEventsTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.UserEventService/PurgeUserEvents', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($parent, $actualValue);
    ...
    public function rejoinUserEventsTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.UserEventService/RejoinUserEvents', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($parent, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function writeUserEventTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.UserEventService/WriteUserEvent', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($parent, $actualValue);
        $actualValue = $actualRequestObject->getUserEvent();
        $this->assertProtobufEquals($userEvent, $actualValue);
