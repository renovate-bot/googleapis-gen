...
use Google\Cloud\Retail\V2beta\Catalog;
use Google\Cloud\Retail\V2beta\CatalogServiceClient;
use Google\Cloud\Retail\V2beta\GetDefaultBranchResponse;
use Google\Cloud\Retail\V2beta\ListCatalogsResponse;
use Google\Cloud\Retail\V2beta\ProductLevelConfig;
...
class CatalogServiceClientTest extends GeneratedTest
{
    ...
    public function getDefaultBranchTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2beta.CatalogService/GetDefaultBranch', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listCatalogsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.CatalogService/ListCatalogs', $actualFuncCall);
    ...
    public function setDefaultBranchTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.CatalogService/SetDefaultBranch', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateCatalogTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2beta.CatalogService/UpdateCatalog', $actualFuncCall);
