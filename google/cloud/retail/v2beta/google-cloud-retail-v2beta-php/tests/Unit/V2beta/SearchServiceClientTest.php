...
use Google\Cloud\Retail\V2beta\SearchResponse;
use Google\Cloud\Retail\V2beta\SearchResponse\SearchResult;
use Google\Cloud\Retail\V2beta\SearchServiceClient;
use Google\Rpc\Code;
use stdClass;
...
class SearchServiceClientTest extends GeneratedTest
{
    ...
    public function searchTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2beta.SearchService/Search', $actualFuncCall);
