  ...
  module Cloud
    module Retail
      module V2beta
        ...
        # Request for
        # {::Google::Cloud::Retail::V2beta::CatalogService::Client#update_catalog CatalogService.UpdateCatalog}
        # method.
        ...
        #   @return [::String]
        #     This corresponds to
        #     {::Google::Cloud::Retail::V2beta::SetDefaultBranchRequest#note SetDefaultBranchRequest.note}
