...
module Google
  module Cloud
    module Retail
      module V2beta
        # Request message for
        # {::Google::Cloud::Retail::V2beta::SearchService::Client#search SearchService.Search}
        # method.
        ...
        #   @return [::String]
        #     A page token
        #     {::Google::Cloud::Retail::V2beta::SearchResponse#next_page_token SearchResponse.next_page_token},
        ...
        #     result location, amongst the {::Google::Cloud::Retail::V2beta::Product Product}s
        #     deemed by the API as relevant) in search results. This field is only
        #     considered if
        #     {::Google::Cloud::Retail::V2beta::SearchRequest#page_token page_token} is unset.
        #
        #     If this field is negative, an INVALID_ARGUMENT is returned.
        # @!attribute [rw] filter
        #   @return [::String]
        ...
        #     {::Google::Cloud::Retail::V2beta::SearchRequest#canonical_filter SearchRequest.canonical_filter}
        #     will be returned as a supplement of the original query. This field is
        #     strongly recommended to achieve high search quality.
        #
        #     See {::Google::Cloud::Retail::V2beta::SearchRequest#filter SearchRequest.filter}
        ...
        #   @return [::Array<::Google::Cloud::Retail::V2beta::SearchRequest::FacetSpec>]
        #     Facet specifications for faceted search. If empty, no facets are returned.
        #
        #     A maximum of 100 values are allowed. Otherwise, an INVALID_ARGUMENT error
        #     is returned.
        # @!attribute [rw] dynamic_facet_spec
        #   @return [::Google::Cloud::Retail::V2beta::SearchRequest::DynamicFacetSpec]
        ...
        #     {::Google::Cloud::Retail::V2beta::Product::Type::VARIANT variant}
        #     {::Google::Cloud::Retail::V2beta::Product Product}s attributes. The attributes
        #     from all the matching
        #     {::Google::Cloud::Retail::V2beta::Product::Type::VARIANT variant}
        #     {::Google::Cloud::Retail::V2beta::Product Product}s are merged and
        #     de-duplicated. Notice that rollup
        #     {::Google::Cloud::Retail::V2beta::Product::Type::VARIANT variant}
        #     {::Google::Cloud::Retail::V2beta::Product Product}s attributes will lead to
        ...
        #       {::Google::Cloud::Retail::V2beta::Product#attributes Product.attributes} map.
        ...
        #     the same as
        #     {::Google::Cloud::Retail::V2beta::UserEvent#page_categories UserEvent.page_categories};
        #
        ...
        class SearchRequest
          ...
          #   @return [::Google::Cloud::Retail::V2beta::SearchRequest::FacetSpec::FacetKey]
          ...
          #
          #     By default,
          #     {::Google::Cloud::Retail::V2beta::SearchRequest::FacetSpec::FacetKey#key FacetKey.key}
          ...
          class FacetSpec
            ...
            #     {::Google::Cloud::Retail::V2beta::Product Product} object, over which the
            #     facet values are computed. Facet key is case-sensitive.
            #
            #     Allowed facet keys when
            #     {::Google::Cloud::Retail::V2beta::SearchRequest::FacetSpec::FacetKey#query FacetKey.query}
            #     is not specified:
            #
            #     * textual_field =<br>
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::Product#brands Product.brands}.<br>*
            #         </font>
            #         "brands";
            #         <br>
            #         <font color='categories'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::Product#categories Product.categories}.<br>*
            #         </font>
            #         "categories";
            #         <br>
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::Audience#genders Audience.genders}.<br>*
            #         </font>
            #         | "genders";
            #         <br>
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::Audience#age_groups Audience.age_groups}.<br>*
            #         </font>
            #         | "ageGroups";
            #         <br>
            #         <font color='grey'>
            ...
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::ColorInfo#color_families ColorInfo.color_families}.<br>*
            #         </font>
            #         | "colorFamilies";
            #         <br>
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::ColorInfo#colors ColorInfo.colors}.<br>*
            #         </font>
            #         | "colors";
            #         <br>
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::Product#sizes Product.sizes}.<br>*
            #         </font>
            #         | "sizes";
            #         <br>
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::Product#materials Product.materials}.<br>*
            #         </font>
            #         | "materials";
            #         <br>
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::Product#patterns Product.patterns}.<br>*
            #         </font>
            #         | "patterns";
            #         <br>
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::Product#conditions Product.conditions}.<br>*
            #         </font>
            #         | "conditions";
            #         <br>
            #         <font color='grey'>
            #         *# The textual custom attribute in
            #         {::Google::Cloud::Retail::V2beta::Product Product} object. Key can<br>*
            #         *# be any key in the
            #         {::Google::Cloud::Retail::V2beta::Product#attributes Product.attributes}
            #         map<br>*
            ...
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::PriceInfo#price PriceInfo.price}.<br>*
            #         </font>
            #         "price";
            #         <br>
            #         <font color='grey'>
            ...
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::Rating#average_rating Rating.average_rating}.<br>*
            #         </font>
            #         "rating";
            #         <br>
            #         <font color='grey'>
            #         *# The
            #         {::Google::Cloud::Retail::V2beta::Rating#rating_count Rating.rating_count}.<br>*
            #         </font>
            #         "ratingCount";
            #         <br>
            #         <font color='grey'>
            ...
            #   @return [::Array<::Google::Cloud::Retail::V2beta::Interval>]
            ...
            #     {::Google::Cloud::Retail::V2beta::SearchRequest::FacetSpec::FacetKey#intervals FacetSpec.FacetKey.intervals};
            #     [FulfillmentInfo.ids][] are sorted in the order given by
            #     {::Google::Cloud::Retail::V2beta::SearchRequest::FacetSpec::FacetKey#restricted_values FacetSpec.FacetKey.restricted_values}.
            # @!attribute [rw] query
            #   @return [::String]
            #     The query that is used to compute facet for the given facet key.
            #     When provided, it will override the default behavior of facet
            #     computation. The query syntax is the same as a filter expression. See
            #     {::Google::Cloud::Retail::V2beta::SearchRequest#filter SearchRequest.filter}
          ...
          # @!attribute [rw] mode
          #   @return [::Google::Cloud::Retail::V2beta::SearchRequest::DynamicFacetSpec::Mode]
          #     Mode of the DynamicFacet feature.
          #     Defaults to
          #     {::Google::Cloud::Retail::V2beta::SearchRequest::DynamicFacetSpec::Mode::DISABLED Mode.DISABLED}
          #     if it's unset.
          ...
          #   @return [::Array<::Google::Cloud::Retail::V2beta::SearchRequest::BoostSpec::ConditionBoostSpec>]
          ...
          # occur.
          # @!attribute [rw] condition
          #   @return [::Google::Cloud::Retail::V2beta::SearchRequest::QueryExpansionSpec::Condition]
          #     The condition under which query expansion should occur. Default to
          #     {::Google::Cloud::Retail::V2beta::SearchRequest::QueryExpansionSpec::Condition::DISABLED Condition.DISABLED}.
          class QueryExpansionSpec
            ...
            module Condition
              ...
              # {::Google::Cloud::Retail::V2beta::SearchResponse#total_size SearchResponse.total_size}
              # is zero.
              DISABLED = 1
        ...
        #   @return [::Array<::Google::Cloud::Retail::V2beta::SearchResponse::SearchResult>]
        #     A list of matched items. The order represents the ranking.
        # @!attribute [rw] facets
        #   @return [::Array<::Google::Cloud::Retail::V2beta::SearchResponse::Facet>]
        #     Results of facets requested by user.
        # @!attribute [rw] total_size
        #   @return [::Integer]
        #     The estimated total count of matched items irrespective of pagination. The
        #     count of {::Google::Cloud::Retail::V2beta::SearchResponse#results results}
        #     returned by pagination may be less than the
        #     {::Google::Cloud::Retail::V2beta::SearchResponse#total_size total_size} that
        #     matches.
        ...
        #     {::Google::Cloud::Retail::V2beta::UserEvent UserEvent} logs resulting from this
        #     search, which enables accurate attribution of search model performance.
        # @!attribute [rw] next_page_token
        #   @return [::String]
        #     A token that can be sent as
        #     {::Google::Cloud::Retail::V2beta::SearchRequest#page_token SearchRequest.page_token}
        #     to retrieve the next page. If this field is omitted, there are no
        #     subsequent pages.
        # @!attribute [rw] query_expansion_info
        #   @return [::Google::Cloud::Retail::V2beta::SearchResponse::QueryExpansionInfo]
        #     Query expansion information for the returned results.
        # @!attribute [rw] redirect_uri
        #   @return [::String]
        #     The URI of a customer-defined redirect page. If redirect action is
        #     triggered, no search will be performed, and only
        #     {::Google::Cloud::Retail::V2beta::SearchResponse#redirect_uri redirect_uri} and
        #     {::Google::Cloud::Retail::V2beta::SearchResponse#attribution_token attribution_token}
        ...
        class SearchResponse
          ...
          # @!attribute [rw] id
          #   @return [::String]
          #     {::Google::Cloud::Retail::V2beta::Product#id Product.id} of the searched
          #     {::Google::Cloud::Retail::V2beta::Product Product}.
          # @!attribute [rw] product
          #   @return [::Google::Cloud::Retail::V2beta::Product]
          #     The product data snippet in the search response. Only
          #     {::Google::Cloud::Retail::V2beta::Product#name Product.name} is guaranteed to
          #     be populated.
          #
          #     {::Google::Cloud::Retail::V2beta::Product#variants Product.variants} contains
          ...
          #     {::Google::Cloud::Retail::V2beta::SearchResponse::SearchResult#matching_variant_fields matching_variant_fields}
          ...
          #     If a {::Google::Cloud::Retail::V2beta::Product::Type::VARIANT variant}
          #     {::Google::Cloud::Retail::V2beta::Product Product} matches the search query,
          #     this map indicates which {::Google::Cloud::Retail::V2beta::Product Product}
          #     fields are matched. The key is the
          #     {::Google::Cloud::Retail::V2beta::Product#name Product.name}, the value is a
          #     field mask of the matched {::Google::Cloud::Retail::V2beta::Product Product}
          ...
          #     "sku1" {::Google::Cloud::Retail::V2beta::ColorInfo ColorInfo} and the query.
          # @!attribute [rw] variant_rollup_values
          #   @return [::Google::Protobuf::Map{::String => ::Google::Protobuf::Value}]
          #     The rollup matching
          #     {::Google::Cloud::Retail::V2beta::Product::Type::VARIANT variant}
          #     {::Google::Cloud::Retail::V2beta::Product Product} attributes. The key is one
          #     of the
          #     {::Google::Cloud::Retail::V2beta::SearchRequest#variant_rollup_keys SearchRequest.variant_rollup_keys}.
          #     The values are the merged and de-duplicated
          #     {::Google::Cloud::Retail::V2beta::Product Product} attributes. Notice that the
          ...
          #     "attributes.attr1".
          # @!attribute [rw] values
          #   @return [::Array<::Google::Cloud::Retail::V2beta::SearchResponse::Facet::FacetValue>]
          ...
          class Facet
            ...
            #   @return [::Google::Cloud::Retail::V2beta::Interval]
