  ...
  module Cloud
    module Retail
      module V2beta
        ...
        #   @return [::Array<::Google::Cloud::Retail::V2beta::CompleteQueryResponse::CompletionResult>]
        #     Results of the matching suggestions. The result list is ordered and the
        #     first result is top suggestion.
        # @!attribute [rw] attribution_token
        #   @return [::String]
        #     A unique complete token. This should be included in the
        #     {::Google::Cloud::Retail::V2beta::SearchRequest SearchRequest} resulting from
        #     this completion, which enables accurate attribution of complete model
        #     performance.
        # @!attribute [rw] recent_search_results
        #   @return [::Array<::Google::Cloud::Retail::V2beta::CompleteQueryResponse::RecentSearchResult>]
        #     Matched recent searches of this user. This field is a restricted feature.
        #     Contact Retail Support (retail-search-support@google.com) if you are
        #     interested in enabling it.
        #
        #     This feature is only available when
        #     {::Google::Cloud::Retail::V2beta::CompleteQueryRequest#visitor_id CompleteQueryRequest.visitor_id}
        #     field is set and {::Google::Cloud::Retail::V2beta::UserEvent UserEvent} is
        #     imported. The recent searches satisfy the follow rules:
        #      * They are ordered from latest to oldest.
        #      * They are matched with
        #      {::Google::Cloud::Retail::V2beta::CompleteQueryRequest#query CompleteQueryRequest.query}
        #      case insensitively.
