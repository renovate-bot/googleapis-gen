...
# Source: google/cloud/retail/v2beta/catalog_service.proto for package 'Google.Cloud.Retail.V2beta'
      ...
      module V2beta
        module CatalogService
          ...
          class Service
            ...
            self.service_name = 'google.cloud.retail.v2beta.CatalogService'

            # Lists all the [Catalog][google.cloud.retail.v2beta.Catalog]s associated
            # with the project.
            rpc :ListCatalogs, ::Google::Cloud::Retail::V2beta::ListCatalogsRequest, ::Google::Cloud::Retail::V2beta::ListCatalogsResponse
            # Updates the [Catalog][google.cloud.retail.v2beta.Catalog]s.
            rpc :UpdateCatalog, ::Google::Cloud::Retail::V2beta::UpdateCatalogRequest, ::Google::Cloud::Retail::V2beta::Catalog
            ...
            # Please submit a form [here](https://cloud.google.com/contact) to contact
            # cloud sales if you are interested in using Retail Search.
            rpc :GetDefaultBranch, ::Google::Cloud::Retail::V2beta::GetDefaultBranchRequest, ::Google::Cloud::Retail::V2beta::GetDefaultBranchResponse
          end
