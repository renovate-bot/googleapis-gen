...
# https://github.com/googleapis/googleapis/blob/master/google/cloud/retail/v2beta/product_service.proto,
...
require "google/cloud/retail/v2beta/credentials"

module Google
  module Cloud
    module Retail
      module V2beta
        # Service for ingesting {Google::Cloud::Retail::V2beta::Product Product}
        # information of the customer's website.
        #
        # @!attribute [r] product_service_stub
        #   @return [Google::Cloud::Retail::V2beta::ProductService::Stub]
        class ProductServiceClient
          ...
          def initialize \
            ...
            credentials ||= Google::Cloud::Retail::V2beta::Credentials.default
            ...
            if credentials.is_a?(String) || credentials.is_a?(Hash)
              updater_proc = Google::Cloud::Retail::V2beta::Credentials.new(credentials).updater_proc
            end
            ...
            @product_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Retail::V2beta::ProductService::Stub.method(:new)
            )
          ...
          # Creates a {Google::Cloud::Retail::V2beta::Product Product}.
          #
          # @param parent [String]
          #   Required. The parent catalog resource name, such as
          #   "projects/*/locations/global/catalogs/default_catalog/branches/default_branch".
          # @param product [Google::Cloud::Retail::V2beta::Product | Hash]
          #   Required. The {Google::Cloud::Retail::V2beta::Product Product} to create.
          #   A hash of the same form as `Google::Cloud::Retail::V2beta::Product`
          ...
          # @yieldparam result [Google::Cloud::Retail::V2beta::Product]
          ...
          #
          #   product_client = Google::Cloud::Retail::V2beta::Product.new(version: :v2beta)
          ...
          def create_product \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Retail::V2beta::CreateProductRequest)
            @create_product.call(req, options, &block)
          end

          # Gets a {Google::Cloud::Retail::V2beta::Product Product}.
          #
          # @param name [String]
          ...
          def get_product \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Retail::V2beta::GetProductRequest)
            @get_product.call(req, options, &block)
          end

          # Updates a {Google::Cloud::Retail::V2beta::Product Product}.
          #
          # @param product [Google::Cloud::Retail::V2beta::Product | Hash]
          ...
          def update_product \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Retail::V2beta::UpdateProductRequest)
            @update_product.call(req, options, &block)
          end

          # Deletes a {Google::Cloud::Retail::V2beta::Product Product}.
          #
          # @param name [String]
          #   Required. Full resource name of
          #   {Google::Cloud::Retail::V2beta::Product Product}, such as
          ...
          def delete_product \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Retail::V2beta::DeleteProductRequest)
            @delete_product.call(req, options, &block)
            nil
          end

          # Bulk import of multiple {Google::Cloud::Retail::V2beta::Product Product}s.
          #
          # Request processing may be synchronous. No partial updating is supported.
          # Non-existing items are created.
          #
          # Note that it is possible for a subset of the
          # {Google::Cloud::Retail::V2beta::Product Product}s to be successfully updated.
          #
          # @param parent [String]
          #   Required.
          ...
          # @param input_config [Google::Cloud::Retail::V2beta::ProductInputConfig | Hash]
          #   Required. The desired input location of the data.
          #   A hash of the same form as `Google::Cloud::Retail::V2beta::ProductInputConfig`
          #   can also be provided.
          # @param errors_config [Google::Cloud::Retail::V2beta::ImportErrorsConfig | Hash]
          #   The desired location of errors incurred during the Import.
          #   A hash of the same form as `Google::Cloud::Retail::V2beta::ImportErrorsConfig`
          #   can also be provided.
          # @param update_mask [Google::Protobuf::FieldMask | Hash]
          ...
          def import_products \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Retail::V2beta::ImportProductsRequest)
