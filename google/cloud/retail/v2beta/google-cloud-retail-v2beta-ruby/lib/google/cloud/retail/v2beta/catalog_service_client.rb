...
# https://github.com/googleapis/googleapis/blob/master/google/cloud/retail/v2beta/catalog_service.proto,
...
require "google/cloud/retail/v2beta/catalog_service_pb"
  ...
  module Cloud
    module Retail
      module V2beta
        ...
        #   @return [Google::Cloud::Retail::V2beta::CatalogService::Stub]
        class CatalogServiceClient
          ...
          def initialize \
            ...
            @catalog_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Retail::V2beta::CatalogService::Stub.method(:new)
            )
          ...
          # Lists all the {Google::Cloud::Retail::V2beta::Catalog Catalog}s associated
          # with the project.
          #
          # @param parent [String]
          ...
          # @yieldparam result [Google::Gax::PagedEnumerable<Google::Cloud::Retail::V2beta::Catalog>]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Retail::V2beta::Catalog>]
          #   An enumerable of Google::Cloud::Retail::V2beta::Catalog instances.
          ...
          #
          #   catalog_client = Google::Cloud::Retail::V2beta::Catalog.new(version: :v2beta)
          ...
          def list_catalogs \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Retail::V2beta::ListCatalogsRequest)
            @list_catalogs.call(req, options, &block)
          end

          # Updates the {Google::Cloud::Retail::V2beta::Catalog Catalog}s.
          #
          # @param catalog [Google::Cloud::Retail::V2beta::Catalog | Hash]
          ...
          #   A hash of the same form as `Google::Cloud::Retail::V2beta::Catalog`
          ...
          #   retries, etc.
          # @yield [result, operation] Access the result along with the RPC operation
          # @yieldparam result [Google::Cloud::Retail::V2beta::Catalog]
          # @yieldparam operation [GRPC::ActiveCall::Operation]
          ...
          def update_catalog \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Retail::V2beta::UpdateCatalogRequest)
