      ...
      module V2beta
        module ProductService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Retail::V2beta::ProductService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all ProductService clients
            #   ::Google::Cloud::Retail::V2beta::ProductService::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Google::Cloud::Retail::V2beta::ProductService::Client.new
            #
            #   # Create a client using a custom configuration
            #   client = ::Google::Cloud::Retail::V2beta::ProductService::Client.new do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @product_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Retail::V2beta::ProductService::Stub,
            ...
            #
            # @return [::Google::Cloud::Retail::V2beta::ProductService::Operations]
            #
            ...
            #   {::Google::Cloud::Retail::V2beta::CreateProductRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::CreateProductRequest, ::Hash]
            ...
            # @yieldparam response [::Google::Cloud::Retail::V2beta::Product]
            ...
            #   request = Google::Cloud::Retail::V2beta::CreateProductRequest.new
            #
            #   # Call the create_product method.
            #   result = client.create_product request
            #
            #   # The returned object is of type Google::Cloud::Retail::V2beta::Product.
            #   p result
            #
            def create_product request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::CreateProductRequest
              ...
              metadata[:"x-goog-api-client"] ||= ::Gapic::Headers.x_goog_api_client \
                ...
                gapic_version: ::Google::Cloud::Retail::V2beta::VERSION
            ...
            #   {::Google::Cloud::Retail::V2beta::GetProductRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::GetProductRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::GetProductRequest.new
            #
            ...
            def get_product request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::GetProductRequest
            ...
            ##
            # Gets a list of {::Google::Cloud::Retail::V2beta::Product Product}s.
            #
            # @overload list_products(request, options = nil)
            #   Pass arguments to `list_products` via a request object, either of type
            #   {::Google::Cloud::Retail::V2beta::ListProductsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::ListProductsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Retail::V2beta::Product Product}s under this branch,
            #     regardless of whether or not this branch exists, a PERMISSION_DENIED error
            #     is returned.
            #   @param page_size [::Integer]
            #     Maximum number of {::Google::Cloud::Retail::V2beta::Product Product}s to return.
            ...
            #     A page token
            #     {::Google::Cloud::Retail::V2beta::ListProductsResponse#next_page_token ListProductsResponse.next_page_token},
            #     received from a previous
            #     {::Google::Cloud::Retail::V2beta::ProductService::Client#list_products ProductService.ListProducts}
            ...
            #     {::Google::Cloud::Retail::V2beta::ListProductsRequest#filter filter} is unset.
            #     * List
            #     {::Google::Cloud::Retail::V2beta::Product::Type::VARIANT Product.Type.VARIANT}
            #     {::Google::Cloud::Retail::V2beta::Product Product}s sharing the same
            #       {::Google::Cloud::Retail::V2beta::Product::Type::PRIMARY Product.Type.PRIMARY}
            #       {::Google::Cloud::Retail::V2beta::Product Product}. For example:
            #         `primary_product_id = "some_product_id"`
            #     * List {::Google::Cloud::Retail::V2beta::Product Product}s bundled in a
            #     {::Google::Cloud::Retail::V2beta::Product::Type::COLLECTION Product.Type.COLLECTION}
            #     {::Google::Cloud::Retail::V2beta::Product Product}.
            #       For example:
            #         `collection_product_id = "some_product_id"`
            #     * List {::Google::Cloud::Retail::V2beta::Product Product}s with a partibular
            #     type. For example:
            #         `type = "PRIMARY"`
            #         `type = "VARIANT"`
            #         `type = "COLLECTION"`
            ...
            #     If the specified
            #     {::Google::Cloud::Retail::V2beta::Product::Type::PRIMARY Product.Type.PRIMARY}
            #     {::Google::Cloud::Retail::V2beta::Product Product} or
            #     {::Google::Cloud::Retail::V2beta::Product::Type::COLLECTION Product.Type.COLLECTION}
            #     {::Google::Cloud::Retail::V2beta::Product Product} does not exist, a NOT_FOUND
            #     error is returned.
            #   @param read_mask [::Google::Protobuf::FieldMask, ::Hash]
            #     The fields of {::Google::Cloud::Retail::V2beta::Product Product} to return in
            #     the responses. If not set or empty, the following fields are returned:
            #
            #     * {::Google::Cloud::Retail::V2beta::Product#name Product.name}
            #     * {::Google::Cloud::Retail::V2beta::Product#id Product.id}
            #     * {::Google::Cloud::Retail::V2beta::Product#title Product.title}
            #     * {::Google::Cloud::Retail::V2beta::Product#uri Product.uri}
            #     * {::Google::Cloud::Retail::V2beta::Product#images Product.images}
            #     * {::Google::Cloud::Retail::V2beta::Product#price_info Product.price_info}
            #     * {::Google::Cloud::Retail::V2beta::Product#brands Product.brands}
            #
            #     If "*" is provided, all fields are returned.
            #     {::Google::Cloud::Retail::V2beta::Product#name Product.name} is always returned
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Retail::V2beta::Product>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Retail::V2beta::Product>]
            #
            # @raise [::Google::Cloud::Error] if the RPC is aborted.
            #
            # @example Basic example
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::ListProductsRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::Retail::V2beta::Product.
            #     p response
            #   end
            #
            def list_products request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::ListProductsRequest
            ...
            #   {::Google::Cloud::Retail::V2beta::UpdateProductRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::UpdateProductRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     exist and
            #     {::Google::Cloud::Retail::V2beta::UpdateProductRequest#allow_missing allow_missing}
            ...
            #     If set to true, and the {::Google::Cloud::Retail::V2beta::Product Product} is
            #     not found, a new {::Google::Cloud::Retail::V2beta::Product Product} will be
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::UpdateProductRequest.new
            #
            ...
            def update_product request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::UpdateProductRequest
            ...
            #   {::Google::Cloud::Retail::V2beta::DeleteProductRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::DeleteProductRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     exist, a NOT_FOUND error is returned.
            #
            #     The {::Google::Cloud::Retail::V2beta::Product Product} to delete can neither be
            #     a
            #     {::Google::Cloud::Retail::V2beta::Product::Type::COLLECTION Product.Type.COLLECTION}
            #     {::Google::Cloud::Retail::V2beta::Product Product} member nor a
            #     {::Google::Cloud::Retail::V2beta::Product::Type::PRIMARY Product.Type.PRIMARY}
            #     {::Google::Cloud::Retail::V2beta::Product Product} with more than one
            #     {::Google::Cloud::Retail::V2beta::Product::Type::VARIANT variants}. Otherwise, an
            #     INVALID_ARGUMENT error is returned.
            #
            #     All inventory information for the named
            #     {::Google::Cloud::Retail::V2beta::Product Product} will be deleted.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::DeleteProductRequest.new
            #
            ...
            def delete_product request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::DeleteProductRequest
            ...
            #   {::Google::Cloud::Retail::V2beta::ImportProductsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::ImportProductsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Retail::V2beta::ImportMetadata ImportMetadata}.
            #
            #     Only supported when
            #     {::Google::Cloud::Retail::V2beta::ImportProductsRequest#reconciliation_mode ImportProductsRequest.reconciliation_mode}
            #     is set to `FULL`.
            ...
            #   @param reconciliation_mode [::Google::Cloud::Retail::V2beta::ImportProductsRequest::ReconciliationMode]
            #     The mode of reconciliation between existing products and the products to be
            #     imported. Defaults to
            #     {::Google::Cloud::Retail::V2beta::ImportProductsRequest::ReconciliationMode::INCREMENTAL ReconciliationMode.INCREMENTAL}.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::ImportProductsRequest.new
            #
            ...
            def import_products request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::ImportProductsRequest
            ...
            # {::Google::Cloud::Retail::V2beta::Product Product} while respecting the last
            # update timestamps of each inventory field.
            #
            # This process is asynchronous and does not require the
            # {::Google::Cloud::Retail::V2beta::Product Product} to exist before updating
            # fulfillment information. If the request is valid, the update will be
            # enqueued and processed downstream. As a consequence, when a response is
            # returned, updates are not immediately manifested in the
            # {::Google::Cloud::Retail::V2beta::Product Product} queried by
            # {::Google::Cloud::Retail::V2beta::ProductService::Client#get_product GetProduct} or
            # {::Google::Cloud::Retail::V2beta::ProductService::Client#list_products ListProducts}.
            #
            # When inventory is updated with
            # {::Google::Cloud::Retail::V2beta::ProductService::Client#create_product CreateProduct}
            # and
            # {::Google::Cloud::Retail::V2beta::ProductService::Client#update_product UpdateProduct},
            # the specified inventory field value(s) will overwrite any existing value(s)
            # while ignoring the last update time for this field. Furthermore, the last
            # update time for the specified inventory fields will be overwritten to the
            # time of the
            # {::Google::Cloud::Retail::V2beta::ProductService::Client#create_product CreateProduct} or
            # {::Google::Cloud::Retail::V2beta::ProductService::Client#update_product UpdateProduct}
            # request.
            #
            # If no inventory fields are set in
            # {::Google::Cloud::Retail::V2beta::CreateProductRequest#product CreateProductRequest.product},
            ...
            # {::Google::Cloud::Retail::V2beta::ProductService::Client#set_inventory SetInventory},
            # {::Google::Cloud::Retail::V2beta::ProductService::Client#add_fulfillment_places AddFulfillmentPlaces},
            # and
            # {::Google::Cloud::Retail::V2beta::ProductService::Client#remove_fulfillment_places RemoveFulfillmentPlaces}.
            #
            ...
            #   {::Google::Cloud::Retail::V2beta::SetInventoryRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::SetInventoryRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #   the default parameter values, pass an empty Hash as a request object (see above).
            #
            #   @param inventory [::Google::Cloud::Retail::V2beta::Product, ::Hash]
            #     Required. The inventory information to update. The allowable fields to
            #     update are:
            #     * {::Google::Cloud::Retail::V2beta::Product#price_info Product.price_info}
            #     * {::Google::Cloud::Retail::V2beta::Product#availability Product.availability}
            #     * {::Google::Cloud::Retail::V2beta::Product#available_quantity Product.available_quantity}
            #     * {::Google::Cloud::Retail::V2beta::Product#fulfillment_info Product.fulfillment_info}
            #     The updated inventory fields must be specified in
            #     {::Google::Cloud::Retail::V2beta::SetInventoryRequest#set_mask SetInventoryRequest.set_mask}.
            #
            #     If [SetInventoryRequest.inventory.name][] is empty or invalid, an
            #     INVALID_ARGUMENT error is returned.
            #
            #     If the caller does not have permission to update the
            #     {::Google::Cloud::Retail::V2beta::Product Product} named in
            #     {::Google::Cloud::Retail::V2beta::Product#name Product.name}, regardless of
            ...
            #     will be inserted.
            #
            #     If the {::Google::Cloud::Retail::V2beta::Product Product} to update has existing
            #     inventory information, the provided inventory information will be merged
            #     while respecting the last update time for each inventory field, using the
            #     provided or default value for
            #     {::Google::Cloud::Retail::V2beta::SetInventoryRequest#set_time SetInventoryRequest.set_time}.
            #
            ...
            #     {::Google::Cloud::Retail::V2beta::Product Product} to update. If not set or set
            ...
            #   @param allow_missing [::Boolean]
            #     If set to true, and the {::Google::Cloud::Retail::V2beta::Product Product} with
            #     name {::Google::Cloud::Retail::V2beta::Product#name Product.name} is not found,
            #     the inventory update will still be processed and retained for at most 1 day
            #     until the {::Google::Cloud::Retail::V2beta::Product Product} is created. If set
            #     to false, a NOT_FOUND error is returned if the
            #     {::Google::Cloud::Retail::V2beta::Product Product} is not found.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Gapic::Operation]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::SetInventoryRequest.new
            #
            ...
            def set_inventory request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::SetInventoryRequest
            ...
            # {::Google::Cloud::Retail::V2beta::FulfillmentInfo#place_ids Product.fulfillment_info.place_ids}.
            #
            # This process is asynchronous and does not require the
            # {::Google::Cloud::Retail::V2beta::Product Product} to exist before updating
            # fulfillment information. If the request is valid, the update will be
            ...
            #   {::Google::Cloud::Retail::V2beta::AddFulfillmentPlacesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::AddFulfillmentPlacesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Retail::V2beta::AddFulfillmentPlacesRequest#type type}, such
            #     as the store IDs for "pickup-in-store" or the region IDs for
            #     "same-day-delivery" to be added for this
            #     {::Google::Cloud::Retail::V2beta::AddFulfillmentPlacesRequest#type type}.
            ...
            #     {::Google::Cloud::Retail::V2beta::AddFulfillmentPlacesRequest#type type} after
            ...
            #     {::Google::Cloud::Retail::V2beta::Product Product} is created. If set to false,
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::AddFulfillmentPlacesRequest.new
            #
            ...
            def add_fulfillment_places request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::AddFulfillmentPlacesRequest
            ...
            #   {::Google::Cloud::Retail::V2beta::RemoveFulfillmentPlacesRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::RemoveFulfillmentPlacesRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #   @param place_ids [::Array<::String>]
            #     Required. The IDs for this
            #     {::Google::Cloud::Retail::V2beta::RemoveFulfillmentPlacesRequest#type type},
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::RemoveFulfillmentPlacesRequest.new
            #
            ...
            def remove_fulfillment_places request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::RemoveFulfillmentPlacesRequest
            ...
            # {::Google::Cloud::Retail::V2beta::ProductService::Client::Configuration::Rpcs}
