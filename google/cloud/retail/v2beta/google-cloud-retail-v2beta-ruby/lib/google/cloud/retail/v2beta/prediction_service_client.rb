  ...
  module Cloud
    module Retail
      module V2beta
        ...
        #   @return [Google::Cloud::Retail::V2beta::PredictionService::Stub]
        class PredictionServiceClient
          ...
          def initialize \
            ...
            @prediction_service_stub = Google::Gax::Grpc.create_stub(
              ...
              &Google::Cloud::Retail::V2beta::PredictionService::Stub.method(:new)
            )
          ...
          # @yieldparam result [Google::Cloud::Retail::V2beta::PredictResponse]
          ...
          #
          #   prediction_client = Google::Cloud::Retail::V2beta::Prediction.new(version: :v2beta)
          #
          ...
          def predict \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Retail::V2beta::PredictRequest)
