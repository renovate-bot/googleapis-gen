      ...
      module V2beta
        module CatalogService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Retail::V2beta::CatalogService::Client::Configuration}
            ...
            def initialize
              ...
              @catalog_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Retail::V2beta::CatalogService::Stub,
            ...
            #   {::Google::Cloud::Retail::V2beta::ListCatalogsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::ListCatalogsRequest, ::Hash]
            ...
            #     {::Google::Cloud::Retail::V2beta::CatalogService::Client#list_catalogs CatalogService.ListCatalogs}
            ...
            # @yieldparam response [::Gapic::PagedEnumerable<::Google::Cloud::Retail::V2beta::Catalog>]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            # @return [::Gapic::PagedEnumerable<::Google::Cloud::Retail::V2beta::Catalog>]
            #
            ...
            #   request = Google::Cloud::Retail::V2beta::ListCatalogsRequest.new
            #
            ...
            #     # Each element is of type ::Google::Cloud::Retail::V2beta::Catalog.
            #     p response
            #   end
            #
            def list_catalogs request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::ListCatalogsRequest
            ...
            #   {::Google::Cloud::Retail::V2beta::UpdateCatalogRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::UpdateCatalogRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Retail::V2beta::Catalog Catalog} to update.
            #
            #     If an unsupported or unknown field is provided, an INVALID_ARGUMENT error
            #     is returned.
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Retail::V2beta::Catalog]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def update_catalog request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::UpdateCatalogRequest
            ...
            # default, setting
            # {::Google::Cloud::Retail::V2beta::SearchRequest#branch SearchRequest.branch} to
            ...
            # as {::Google::Cloud::Retail::V2beta::SearchRequest#branch SearchRequest.branch}
            ...
            #   {::Google::Cloud::Retail::V2beta::SetDefaultBranchRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::SetDefaultBranchRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #     {::Google::Cloud::Retail::V2beta::CatalogService::Client#get_default_branch CatalogService.GetDefaultBranch}
            ...
            def set_default_branch request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::SetDefaultBranchRequest
            ...
            # {::Google::Cloud::Retail::V2beta::CatalogService::Client#set_default_branch CatalogService.SetDefaultBranch}
            ...
            #   {::Google::Cloud::Retail::V2beta::GetDefaultBranchRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::GetDefaultBranchRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            # @yield [response, operation] Access the result along with the RPC operation
            # @yieldparam response [::Google::Cloud::Retail::V2beta::GetDefaultBranchResponse]
            # @yieldparam operation [::GRPC::ActiveCall::Operation]
            #
            ...
            def get_default_branch request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::GetDefaultBranchRequest
            ...
            # {::Google::Cloud::Retail::V2beta::CatalogService::Client::Configuration::Rpcs}
