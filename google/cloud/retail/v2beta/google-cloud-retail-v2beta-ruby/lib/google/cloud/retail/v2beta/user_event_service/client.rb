      ...
      module V2beta
        module UserEventService
          ...
          class Client
            ...
            #
            # See {::Google::Cloud::Retail::V2beta::UserEventService::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all UserEventService clients
            #   ::Google::Cloud::Retail::V2beta::UserEventService::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @user_event_service_stub = ::Gapic::ServiceStub.new(
                ::Google::Cloud::Retail::V2beta::UserEventService::Stub,
            ...
            #
            # @return [::Google::Cloud::Retail::V2beta::UserEventService::Operations]
            #
            ...
            #   {::Google::Cloud::Retail::V2beta::WriteUserEventRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::WriteUserEventRequest, ::Hash]
            ...
            # @yieldparam response [::Google::Cloud::Retail::V2beta::UserEvent]
            ...
            #   request = Google::Cloud::Retail::V2beta::WriteUserEventRequest.new
            #
            #   # Call the write_user_event method.
            #   result = client.write_user_event request
            #
            #   # The returned object is of type Google::Cloud::Retail::V2beta::UserEvent.
            #   p result
            #
            def write_user_event request, options = nil
              raise ::ArgumentError, "request must be provided" if request.nil?

              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::WriteUserEventRequest
            ...
            #   {::Google::Cloud::Retail::V2beta::CollectUserEventRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::CollectUserEventRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::CollectUserEventRequest.new
            #
            ...
            def collect_user_event request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::CollectUserEventRequest
            ...
            #   {::Google::Cloud::Retail::V2beta::PurgeUserEventsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::PurgeUserEventsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::PurgeUserEventsRequest.new
            #
            ...
            def purge_user_events request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::PurgeUserEventsRequest
            ...
            #   {::Google::Cloud::Retail::V2beta::ImportUserEventsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::ImportUserEventsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            def import_user_events request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::ImportUserEventsRequest
            ...
            #   {::Google::Cloud::Retail::V2beta::RejoinUserEventsRequest} or an equivalent Hash.
            #
            #   @param request [::Google::Cloud::Retail::V2beta::RejoinUserEventsRequest, ::Hash]
            #     A request object representing the call parameters. Required. To specify no
            #     parameters, or to keep all the default parameter values, pass an empty Hash.
            #   @param options [::Gapic::CallOptions, ::Hash]
            #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
            ...
            #
            #   # Create a request. To set request fields, pass in keyword arguments.
            #   request = Google::Cloud::Retail::V2beta::RejoinUserEventsRequest.new
            #
            ...
            def rejoin_user_events request, options = nil
              ...
              request = ::Gapic::Protobuf.coerce request, to: ::Google::Cloud::Retail::V2beta::RejoinUserEventsRequest
            ...
            # {::Google::Cloud::Retail::V2beta::UserEventService::Client::Configuration::Rpcs}
