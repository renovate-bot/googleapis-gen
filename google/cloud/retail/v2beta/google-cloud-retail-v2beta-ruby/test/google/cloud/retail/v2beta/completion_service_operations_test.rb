...
class ::Google::Cloud::Retail::V2beta::CompletionService::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Retail::V2beta::CompletionService::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2beta::CompletionService::Operations::Configuration, config
  end
end
