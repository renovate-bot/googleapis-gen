...
require "google/cloud/retail/v2beta/product_service"

class ::Google::Cloud::Retail::V2beta::ProductService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_product
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2beta::Product.new
    ...
    create_product_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::CreateProductRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2beta::Product), request["product"]
    ...
    Gapic::ServiceStub.stub :new, create_product_client_stub do
      ...
      # Use protobuf object
      client.create_product ::Google::Cloud::Retail::V2beta::CreateProductRequest.new(parent: parent, product: product, product_id: product_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      client.create_product(::Google::Cloud::Retail::V2beta::CreateProductRequest.new(parent: parent, product: product, product_id: product_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_get_product
    ...
    get_product_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::GetProductRequest, request
    ...
    Gapic::ServiceStub.stub :new, get_product_client_stub do
      ...
      # Use protobuf object
      client.get_product ::Google::Cloud::Retail::V2beta::GetProductRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.get_product(::Google::Cloud::Retail::V2beta::GetProductRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_list_products
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2beta::ListProductsResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    list_products_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::ListProductsRequest, request
      assert_equal "hello world", request["parent"]
    ...
    Gapic::ServiceStub.stub :new, list_products_client_stub do
      ...
      # Use protobuf object
      client.list_products ::Google::Cloud::Retail::V2beta::ListProductsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, read_mask: read_mask) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.list_products(::Google::Cloud::Retail::V2beta::ListProductsRequest.new(parent: parent, page_size: page_size, page_token: page_token, filter: filter, read_mask: read_mask), grpc_options) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_update_product
    ...
    update_product_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::UpdateProductRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2beta::Product), request["product"]
    ...
    Gapic::ServiceStub.stub :new, update_product_client_stub do
      ...
      # Use protobuf object
      client.update_product ::Google::Cloud::Retail::V2beta::UpdateProductRequest.new(product: product, update_mask: update_mask, allow_missing: allow_missing) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.update_product(::Google::Cloud::Retail::V2beta::UpdateProductRequest.new(product: product, update_mask: update_mask, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_delete_product
    ...
    delete_product_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::DeleteProductRequest, request
      assert_equal "hello world", request["name"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, delete_product_client_stub do
      ...
      # Use protobuf object
      client.delete_product ::Google::Cloud::Retail::V2beta::DeleteProductRequest.new(name: name) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.delete_product(::Google::Cloud::Retail::V2beta::DeleteProductRequest.new(name: name), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
  ...
  def test_import_products
    ...
    import_products_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::ImportProductsRequest, request
      assert_equal "hello world", request["parent"]
      assert_equal "hello world", request["request_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2beta::ProductInputConfig), request["input_config"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2beta::ImportErrorsConfig), request["errors_config"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::FieldMask), request["update_mask"]
    ...
    Gapic::ServiceStub.stub :new, import_products_client_stub do
      ...
      # Use protobuf object
      client.import_products ::Google::Cloud::Retail::V2beta::ImportProductsRequest.new(parent: parent, request_id: request_id, input_config: input_config, errors_config: errors_config, update_mask: update_mask, reconciliation_mode: reconciliation_mode, notification_pubsub_topic: notification_pubsub_topic) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_set_inventory
    ...
    set_inventory_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::SetInventoryRequest, request
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2beta::Product), request["inventory"]
    ...
    Gapic::ServiceStub.stub :new, set_inventory_client_stub do
      ...
      # Use protobuf object
      client.set_inventory ::Google::Cloud::Retail::V2beta::SetInventoryRequest.new(inventory: inventory, set_mask: set_mask, set_time: set_time, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.set_inventory(::Google::Cloud::Retail::V2beta::SetInventoryRequest.new(inventory: inventory, set_mask: set_mask, set_time: set_time, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_add_fulfillment_places
    ...
    add_fulfillment_places_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::AddFulfillmentPlacesRequest, request
    ...
    Gapic::ServiceStub.stub :new, add_fulfillment_places_client_stub do
      ...
      # Use protobuf object
      client.add_fulfillment_places ::Google::Cloud::Retail::V2beta::AddFulfillmentPlacesRequest.new(product: product, type: type, place_ids: place_ids, add_time: add_time, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.add_fulfillment_places(::Google::Cloud::Retail::V2beta::AddFulfillmentPlacesRequest.new(product: product, type: type, place_ids: place_ids, add_time: add_time, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_remove_fulfillment_places
    ...
    remove_fulfillment_places_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::RemoveFulfillmentPlacesRequest, request
      assert_equal "hello world", request["product"]
      assert_equal "hello world", request["type"]
      assert_equal ["hello world"], request["place_ids"]
    ...
    Gapic::ServiceStub.stub :new, remove_fulfillment_places_client_stub do
      ...
      # Use protobuf object
      client.remove_fulfillment_places ::Google::Cloud::Retail::V2beta::RemoveFulfillmentPlacesRequest.new(product: product, type: type, place_ids: place_ids, remove_time: remove_time, allow_missing: allow_missing) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.remove_fulfillment_places(::Google::Cloud::Retail::V2beta::RemoveFulfillmentPlacesRequest.new(product: product, type: type, place_ids: place_ids, remove_time: remove_time, allow_missing: allow_missing), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2beta::ProductService::Client::Configuration, config
  end
  ...
  def test_operations_client
    ...
    assert_kind_of ::Google::Cloud::Retail::V2beta::ProductService::Operations, client.operations_client
  end
end
