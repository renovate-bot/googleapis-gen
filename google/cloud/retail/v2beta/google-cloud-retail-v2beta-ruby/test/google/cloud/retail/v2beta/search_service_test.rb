...
class ::Google::Cloud::Retail::V2beta::SearchService::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_search
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::Retail::V2beta::SearchResponse.new
    ...
    search_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::SearchRequest, request
      ...
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2beta::UserInfo), request["user_info"]
      ...
      assert_kind_of ::Google::Cloud::Retail::V2beta::SearchRequest::FacetSpec, request["facet_specs"].first
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2beta::SearchRequest::DynamicFacetSpec), request["dynamic_facet_spec"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2beta::SearchRequest::BoostSpec), request["boost_spec"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Cloud::Retail::V2beta::SearchRequest::QueryExpansionSpec), request["query_expansion_spec"]
    ...
    Gapic::ServiceStub.stub :new, search_client_stub do
      ...
      # Use protobuf object
      client.search ::Google::Cloud::Retail::V2beta::SearchRequest.new(placement: placement, branch: branch, query: query, visitor_id: visitor_id, user_info: user_info, page_size: page_size, page_token: page_token, offset: offset, filter: filter, canonical_filter: canonical_filter, order_by: order_by, facet_specs: facet_specs, dynamic_facet_spec: dynamic_facet_spec, boost_spec: boost_spec, query_expansion_spec: query_expansion_spec, variant_rollup_keys: variant_rollup_keys, page_categories: page_categories) do |response, operation|
        assert_kind_of Gapic::PagedEnumerable, response
        assert_equal grpc_response, response.response
        assert_equal grpc_operation, operation
      end
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Retail::V2beta::SearchService::Client::Configuration, config
  end
end
