...
public interface SetInventoryRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2beta.SetInventoryRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.retail.v2beta.Product inventory = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   */
  com.google.cloud.retail.v2beta.Product getInventory();
  /**
   * <pre>
   * Required. The inventory information to update. The allowable fields to
   * update are:
   ...
   * <code>.google.cloud.retail.v2beta.Product inventory = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.retail.v2beta.ProductOrBuilder getInventoryOrBuilder();
