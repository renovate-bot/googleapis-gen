...
/**
 * Service Description: Service for ingesting [Product][google.cloud.retail.v2beta.Product]
...
public class ProductServiceClient implements BackgroundResource {
   ...
   * @param product Required. The [Product][google.cloud.retail.v2beta.Product] to create.
   * @param productId Required. The ID to use for the [Product][google.cloud.retail.v2beta.Product],
   *     which will become the final component of the
   *     [Product.name][google.cloud.retail.v2beta.Product.name].
   *     <p>If the caller does not have permission to create the
   *     [Product][google.cloud.retail.v2beta.Product], regardless of whether or not it exists, a
   *     PERMISSION_DENIED error is returned.
   *     <p>This field must be unique among all [Product][google.cloud.retail.v2beta.Product]s with
   *     the same [parent][google.cloud.retail.v2beta.CreateProductRequest.parent]. Otherwise, an
   ...
   * }</pre>
   *
   * @param name Required. Full resource name of [Product][google.cloud.retail.v2beta.Product], such
   *     as
   *     `projects/&#42;/locations/global/catalogs/default_catalog/branches/default_branch/products/some_product_id`.
   *     <p>If the caller does not have permission to access the
   *     [Product][google.cloud.retail.v2beta.Product], regardless of whether or not it exists, a
   *     PERMISSION_DENIED error is returned.
   *     <p>If the requested [Product][google.cloud.retail.v2beta.Product] does not exist, a
   ...
   *     [Product][google.cloud.retail.v2beta.Product]s under this branch, regardless of whether or
   ...
   *     [Product][google.cloud.retail.v2beta.Product], regardless of whether or not it exists, a
   *     PERMISSION_DENIED error is returned.
   *     <p>If the [Product][google.cloud.retail.v2beta.Product] to update does not exist and
   *     [allow_missing][google.cloud.retail.v2beta.UpdateProductRequest.allow_missing] is not set,
   *     a NOT_FOUND error is returned.
   * @param updateMask Indicates which fields in the provided
   *     [Product][google.cloud.retail.v2beta.Product] to update. The immutable and output only
   ...
   *     [Product][google.cloud.retail.v2beta.Product], regardless of whether or not it exists, a
   *     PERMISSION_DENIED error is returned.
   *     <p>If the [Product][google.cloud.retail.v2beta.Product] to delete does not exist, a
   *     NOT_FOUND error is returned.
   *     <p>The [Product][google.cloud.retail.v2beta.Product] to delete can neither be a
   ...
   *     [variants][google.cloud.retail.v2beta.Product.Type.VARIANT]. Otherwise, an INVALID_ARGUMENT
   *     error is returned.
   *     <p>All inventory information for the named [Product][google.cloud.retail.v2beta.Product]
   *     will be deleted.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
   ...
   * are created.
   *
   * <p>Note that it is possible for a subset of the [Product][google.cloud.retail.v2beta.Product]s
  ...
  // AUTO-GENERATED DOCUMENTATION AND METHOD.
  /**
   * Updates inventory information for a [Product][google.cloud.retail.v2beta.Product] while
   ...
   * [CreateProduct][google.cloud.retail.v2beta.ProductService.CreateProduct] and
   * [UpdateProduct][google.cloud.retail.v2beta.ProductService.UpdateProduct], the specified
   ...
   * [UpdateProduct][google.cloud.retail.v2beta.ProductService.UpdateProduct] request.
   *
   ...
   *     are:
   *     <ul>
   *       <li> [Product.price_info][google.cloud.retail.v2beta.Product.price_info]
   *       <li> [Product.availability][google.cloud.retail.v2beta.Product.availability]
   *       <li> [Product.available_quantity][google.cloud.retail.v2beta.Product.available_quantity]
   *       <li> [Product.fulfillment_info][google.cloud.retail.v2beta.Product.fulfillment_info] The
   ...
   *     [Product.name][google.cloud.retail.v2beta.Product.name], regardless of whether or not it
   *     exists, a PERMISSION_DENIED error is returned.
   *     <p>If the [Product][google.cloud.retail.v2beta.Product] to update does not have existing
   *     inventory information, the provided inventory information will be inserted.
   *     <p>If the [Product][google.cloud.retail.v2beta.Product] to update has existing inventory
   ...
   *       <li> [Product.availability][google.cloud.retail.v2beta.Product.availability]
   *       <li> [Product.available_quantity][google.cloud.retail.v2beta.Product.available_quantity]
   *       <li> [Product.fulfillment_info][google.cloud.retail.v2beta.Product.fulfillment_info]
   *     </ul>
   ...
   *     [Product][google.cloud.retail.v2beta.Product] to update. If not set or set with empty
   *     paths, all inventory fields will be updated.
   *     <p>If an unsupported or unknown field is provided, an INVALID_ARGUMENT error is returned
   ...
   * the [Product][google.cloud.retail.v2beta.Product] queried by
   * [GetProduct][google.cloud.retail.v2beta.ProductService.GetProduct] or
   * [ListProducts][google.cloud.retail.v2beta.ProductService.ListProducts].
   *
   * <p>This feature is only available for users who have Retail Search enabled. Contact Retail
   ...
   * }</pre>
   *
   * @param product Required. Full resource name of [Product][google.cloud.retail.v2beta.Product],
   *     such as
   *     `projects/&#42;/locations/global/catalogs/default_catalog/branches/default_branch/products/some_product_id`.
   *     <p>If the caller does not have permission to access the
   *     [Product][google.cloud.retail.v2beta.Product], regardless of whether or not it exists, a
   ...
   * in the [Product][google.cloud.retail.v2beta.Product] queried by
   * [GetProduct][google.cloud.retail.v2beta.ProductService.GetProduct] or
   * [ListProducts][google.cloud.retail.v2beta.ProductService.ListProducts].
   *
   * <p>This feature is only available for users who have Retail Search enabled. Contact Retail
