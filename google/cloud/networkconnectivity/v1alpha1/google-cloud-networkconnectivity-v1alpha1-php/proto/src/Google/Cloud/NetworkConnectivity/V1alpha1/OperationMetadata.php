 ...
 *
 * Generated from protobuf message <code>google.cloud.networkconnectivity.v1alpha1.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Networkconnectivity\V1Alpha1\Common::initOnce();
