...
namespace Google\Cloud\NetworkConnectivity\Tests\Unit\V1alpha1;

use Google\Cloud\NetworkConnectivity\V1alpha1\HubServiceClient;
...
class HubServiceClientTest extends GeneratedTest
{
    ...
    public function listHubsTest()
    {
        ...
        $this->assertSame('/google.cloud.networkconnectivity.v1alpha1.HubService/ListHubs', $actualFuncCall);
    ...
    public function getHubTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkconnectivity.v1alpha1.HubService/GetHub', $actualFuncCall);
    ...
    public function createHubTest()
    {
        ...
        $this->assertSame('/google.cloud.networkconnectivity.v1alpha1.HubService/CreateHub', $actualApiFuncCall);
    ...
    public function updateHubTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkconnectivity.v1alpha1.HubService/UpdateHub', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getHub();
    ...
    public function deleteHubTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkconnectivity.v1alpha1.HubService/DeleteHub', $actualApiFuncCall);
    ...
    public function listSpokesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkconnectivity.v1alpha1.HubService/ListSpokes', $actualFuncCall);
    ...
    public function getSpokeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkconnectivity.v1alpha1.HubService/GetSpoke', $actualFuncCall);
    ...
    public function createSpokeTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkconnectivity.v1alpha1.HubService/CreateSpoke', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
    ...
    public function updateSpokeTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkconnectivity.v1alpha1.HubService/UpdateSpoke', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getSpoke();
    ...
    public function deleteSpokeTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkconnectivity.v1alpha1.HubService/DeleteSpoke', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
