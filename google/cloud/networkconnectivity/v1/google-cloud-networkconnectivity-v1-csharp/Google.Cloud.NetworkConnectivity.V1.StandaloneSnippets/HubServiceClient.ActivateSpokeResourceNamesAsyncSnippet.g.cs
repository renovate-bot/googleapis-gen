...
namespace Google.Cloud.NetworkConnectivity.V1.Snippets
{
    ...
    {
        /// <summary>Snippet for ActivateSpokeAsync</summary>
        /// <remarks>
        /// This snippet has been automatically generated for illustrative purposes only.
        /// It may require modifications to work in your environment.
        /// </remarks>
        public async Task ActivateSpokeResourceNamesAsync()
        {
            // Create client
            ...
            // Make the request
            Operation<Spoke, OperationMetadata> response = await hubServiceClient.ActivateSpokeAsync(name);
            ...
            Operation<Spoke, OperationMetadata> retrievedResponse = await hubServiceClient.PollOnceActivateSpokeAsync(operationName);
