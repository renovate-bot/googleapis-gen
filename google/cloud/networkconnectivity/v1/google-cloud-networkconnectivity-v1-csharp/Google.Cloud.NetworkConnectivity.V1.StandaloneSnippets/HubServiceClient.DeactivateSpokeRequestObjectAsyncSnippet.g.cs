...
namespace Google.Cloud.NetworkConnectivity.V1.Snippets
{
    ...
    {
        /// <summary>Snippet for DeactivateSpokeAsync</summary>
        /// <remarks>
        /// This snippet has been automatically generated for illustrative purposes only.
        /// It may require modifications to work in your environment.
        /// </remarks>
        public async Task DeactivateSpokeRequestObjectAsync()
        {
            // Create client
            HubServiceClient hubServiceClient = await HubServiceClient.CreateAsync();
            // Initialize request argument(s)
            DeactivateSpokeRequest request = new DeactivateSpokeRequest
            {
                SpokeName = SpokeName.FromProjectLocationSpoke("[PROJECT]", "[LOCATION]", "[SPOKE]"),
                RequestId = "",
            };
            // Make the request
            Operation<Spoke, OperationMetadata> response = await hubServiceClient.DeactivateSpokeAsync(request);
            ...
            Operation<Spoke, OperationMetadata> retrievedResponse = await hubServiceClient.PollOnceDeactivateSpokeAsync(operationName);
