...
namespace Google.Cloud.NetworkConnectivity.V1.Snippets
{
    ...
    {
        /// <summary>Snippet for DeactivateSpoke</summary>
        /// <remarks>
        /// This snippet has been automatically generated for illustrative purposes only.
        /// It may require modifications to work in your environment.
        /// </remarks>
        public void DeactivateSpokeRequestObject()
        {
            // Create client
            ...
            // Make the request
            Operation<Spoke, OperationMetadata> response = hubServiceClient.DeactivateSpoke(request);
            ...
            Operation<Spoke, OperationMetadata> retrievedResponse = hubServiceClient.PollOnceDeactivateSpoke(operationName);
