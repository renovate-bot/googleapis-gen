 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p3beta1.UpdateProductRequest</code>
 */
class UpdateProductRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p3beta1.Product product = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\Vision\V1p3beta1\Product $product
     *           Required. The Product resource which replaces the one on the server.
     *           product.name is immutable.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p3beta1.Product product = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Vision\V1p3beta1\Product $var
     * @return $this
     */
    public function setProduct($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p3beta1\Product::class);
        $this->product = $var;
