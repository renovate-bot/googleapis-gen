 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p3beta1.Product</code>
 */
class Product extends \Google\Protobuf\Internal\Message
{
     ...
     * 100 product_labels.
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p3beta1.Product.KeyValue product_labels = 5;</code>
     */
     ...
     *           "homegoods", "apparel", and "toys" are still supported, but these should
     *           not be used for new products.
     *     @type \Google\Cloud\Vision\V1p3beta1\Product\KeyValue[]|\Google\Protobuf\Internal\RepeatedField $product_labels
     *           Key-value pairs that can be attached to a product. At query time,
     *           constraints can be specified based on the product_labels.
     *           Note that integer values can be provided as strings, e.g. "1199". Only
     *           strings with integer values can match a range-based restriction which is
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p3beta1.Product.KeyValue product_labels = 5;</code>
     * @param \Google\Cloud\Vision\V1p3beta1\Product\KeyValue[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProductLabels($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Vision\V1p3beta1\Product\KeyValue::class);
