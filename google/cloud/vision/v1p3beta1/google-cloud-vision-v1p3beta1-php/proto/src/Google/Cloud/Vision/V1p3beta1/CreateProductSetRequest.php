 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p3beta1.CreateProductSetRequest</code>
 */
class CreateProductSetRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p3beta1.ProductSet product_set = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The project in which the ProductSet should be created.
     *           Format is `projects/PROJECT_ID/locations/LOC_ID`.
     *     @type \Google\Cloud\Vision\V1p3beta1\ProductSet $product_set
     *           Required. The ProductSet to create.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p3beta1.ProductSet product_set = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Vision\V1p3beta1\ProductSet|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p3beta1.ProductSet product_set = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Vision\V1p3beta1\ProductSet $var
     * @return $this
     */
    public function setProductSet($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p3beta1\ProductSet::class);
