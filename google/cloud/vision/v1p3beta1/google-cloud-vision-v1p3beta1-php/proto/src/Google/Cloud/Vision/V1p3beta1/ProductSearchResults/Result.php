 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p3beta1.ProductSearchResults.Result</code>
 */
...
class_alias(Result::class, \Google\Cloud\Vision\V1p3beta1\ProductSearchResults_Result::class);
