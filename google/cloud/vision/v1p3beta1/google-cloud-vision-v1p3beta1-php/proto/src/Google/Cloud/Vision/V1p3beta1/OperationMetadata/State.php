...
namespace Google\Cloud\Vision\V1p3beta1\OperationMetadata;
 ...
 *
 * Protobuf type <code>google.cloud.vision.v1p3beta1.OperationMetadata.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Vision\V1p3beta1\OperationMetadata_State::class);
