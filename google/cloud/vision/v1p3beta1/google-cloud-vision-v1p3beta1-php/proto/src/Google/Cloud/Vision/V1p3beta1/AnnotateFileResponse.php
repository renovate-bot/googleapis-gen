 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p3beta1.AnnotateFileResponse</code>
 */
class AnnotateFileResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p3beta1.AnnotateImageResponse responses = 2;</code>
     */
    private $responses;
     ...
     *           Information about the file for which this response is generated.
     *     @type \Google\Cloud\Vision\V1p3beta1\AnnotateImageResponse[]|\Google\Protobuf\Internal\RepeatedField $responses
     *           Individual responses to images found within the file.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p3beta1.AnnotateImageResponse responses = 2;</code>
     * @param \Google\Cloud\Vision\V1p3beta1\AnnotateImageResponse[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResponses($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Vision\V1p3beta1\AnnotateImageResponse::class);
        $this->responses = $arr;
