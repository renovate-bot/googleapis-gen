 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/vision/v1p3beta1/image_annotator.proto
 * and updates to that file get reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\Vision\V1p3beta1\Gapic;
...
use Google\Cloud\Vision\V1p3beta1\AnnotateImageRequest;
use Google\Cloud\Vision\V1p3beta1\AsyncAnnotateFileRequest;
use Google\Cloud\Vision\V1p3beta1\AsyncBatchAnnotateFilesRequest;
use Google\Cloud\Vision\V1p3beta1\AsyncBatchAnnotateFilesResponse;
use Google\Cloud\Vision\V1p3beta1\BatchAnnotateImagesRequest;
use Google\Cloud\Vision\V1p3beta1\BatchAnnotateImagesResponse;
use Google\Cloud\Vision\V1p3beta1\OperationMetadata;
...
class ImageAnnotatorGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.vision.v1p3beta1.ImageAnnotator';
