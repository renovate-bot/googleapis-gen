...
use Google\Cloud\Vision\V1p3beta1\AddProductToProductSetRequest;
use Google\Cloud\Vision\V1p3beta1\BatchOperationMetadata;
use Google\Cloud\Vision\V1p3beta1\CreateProductRequest;
use Google\Cloud\Vision\V1p3beta1\CreateProductSetRequest;
use Google\Cloud\Vision\V1p3beta1\CreateReferenceImageRequest;
use Google\Cloud\Vision\V1p3beta1\DeleteProductRequest;
use Google\Cloud\Vision\V1p3beta1\DeleteProductSetRequest;
use Google\Cloud\Vision\V1p3beta1\DeleteReferenceImageRequest;
use Google\Cloud\Vision\V1p3beta1\GetProductRequest;
use Google\Cloud\Vision\V1p3beta1\GetProductSetRequest;
use Google\Cloud\Vision\V1p3beta1\GetReferenceImageRequest;
use Google\Cloud\Vision\V1p3beta1\ImportProductSetsInputConfig;
use Google\Cloud\Vision\V1p3beta1\ImportProductSetsRequest;
use Google\Cloud\Vision\V1p3beta1\ImportProductSetsResponse;
use Google\Cloud\Vision\V1p3beta1\ListProductSetsRequest;
use Google\Cloud\Vision\V1p3beta1\ListProductSetsResponse;
use Google\Cloud\Vision\V1p3beta1\ListProductsInProductSetRequest;
use Google\Cloud\Vision\V1p3beta1\ListProductsInProductSetResponse;
use Google\Cloud\Vision\V1p3beta1\ListProductsRequest;
use Google\Cloud\Vision\V1p3beta1\ListProductsResponse;
use Google\Cloud\Vision\V1p3beta1\ListReferenceImagesRequest;
...
use Google\Cloud\Vision\V1p3beta1\RemoveProductFromProductSetRequest;
use Google\Cloud\Vision\V1p3beta1\UpdateProductRequest;
use Google\Cloud\Vision\V1p3beta1\UpdateProductSetRequest;
...
class ProductSearchGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.vision.v1p3beta1.ProductSearch';
