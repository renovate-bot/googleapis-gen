...
namespace Google\Cloud\Vision\Tests\Unit\V1p3beta1;
...
use Google\Cloud\Vision\V1p3beta1\ImportProductSetsInputConfig;
use Google\Cloud\Vision\V1p3beta1\ImportProductSetsResponse;

use Google\Cloud\Vision\V1p3beta1\ListProductSetsResponse;
use Google\Cloud\Vision\V1p3beta1\ListProductsInProductSetResponse;
use Google\Cloud\Vision\V1p3beta1\ListProductsResponse;
use Google\Cloud\Vision\V1p3beta1\ListReferenceImagesResponse;
use Google\Cloud\Vision\V1p3beta1\Product;
use Google\Cloud\Vision\V1p3beta1\ProductSearchClient;
use Google\Cloud\Vision\V1p3beta1\ProductSet;
use Google\Cloud\Vision\V1p3beta1\ReferenceImage;
...
class ProductSearchClientTest extends GeneratedTest
{
    ...
    public function addProductToProductSetTest()
    {
        ...
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/AddProductToProductSet', $actualFuncCall);
    ...
    public function createProductTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/CreateProduct', $actualFuncCall);
    ...
    public function createProductSetTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/CreateProductSet', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function createReferenceImageTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/CreateReferenceImage', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function deleteProductTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/DeleteProduct', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function deleteProductSetTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/DeleteProductSet', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function deleteReferenceImageTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/DeleteReferenceImage', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getProductTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/GetProduct', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getProductSetTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/GetProductSet', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getReferenceImageTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/GetReferenceImage', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function importProductSetsTest()
    {
        ...
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/ImportProductSets', $actualApiFuncCall);
    ...
    public function listProductSetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/ListProductSets', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/ListProducts', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listProductsInProductSetTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/ListProductsInProductSet', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listReferenceImagesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/ListReferenceImages', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function removeProductFromProductSetTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/RemoveProductFromProductSet', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $actualValue = $actualRequestObject->getProduct();
        $this->assertProtobufEquals($formattedProduct, $actualValue);
    ...
    public function updateProductTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/UpdateProduct', $actualFuncCall);
        $actualValue = $actualRequestObject->getProduct();
        $this->assertProtobufEquals($product, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateProductSetTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p3beta1.ProductSearch/UpdateProductSet', $actualFuncCall);
        $actualValue = $actualRequestObject->getProductSet();
        $this->assertProtobufEquals($productSet, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
