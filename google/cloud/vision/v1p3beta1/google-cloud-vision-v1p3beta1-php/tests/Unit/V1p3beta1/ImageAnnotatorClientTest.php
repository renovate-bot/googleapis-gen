...
class ImageAnnotatorClientTest extends GeneratedTest
{
    ...
    public function asyncBatchAnnotateFilesTest()
    {
        ...
        $this->assertSame('/google.cloud.vision.v1p3beta1.ImageAnnotator/AsyncBatchAnnotateFiles', $actualApiFuncCall);
    ...
    public function batchAnnotateImagesTest()
    {
        ...
        $this->assertSame('/google.cloud.vision.v1p3beta1.ImageAnnotator/BatchAnnotateImages', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
