...
namespace Google\Cloud\Vision\Tests\System\V1p3beta1;

use Google\Cloud\Vision\V1p3beta1\ImageAnnotatorClient;
use Google\ApiCore\Testing\GeneratedTest;
use Google\Cloud\Vision\V1p3beta1\AnnotateImageRequest;
use Google\Cloud\Vision\V1p3beta1\Feature;
use Google\Cloud\Vision\V1p3beta1\Feature\Type;
use Google\Cloud\Vision\V1p3beta1\Image;
use Google\Cloud\Vision\V1p3beta1\ImageSource;
...
class ImageAnnotatorSmokeTest extends GeneratedTest
{
    ...
    public function batchAnnotateImagesTest()
    {
        ...
        $imageAnnotatorClient->batchAnnotateImages(['requests' => $requests]);
    }
}
