...
class ::Google::Cloud::Vision::V1p3beta1::ImageAnnotator::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::Vision::V1p3beta1::ImageAnnotator::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::Vision::V1p3beta1::ImageAnnotator::Operations::Configuration, config
  end
end
