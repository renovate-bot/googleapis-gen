...
class ImageAnnotatorClientTest extends GeneratedTest
{
    ...
    public function asyncBatchAnnotateImagesTest()
    {
        ...
        $incompleteOperation->setName('operations/asyncBatchAnnotateImagesTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new AsyncBatchAnnotateImagesResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/asyncBatchAnnotateImagesTest');
