 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p4beta1.OutputConfig</code>
 */
class OutputConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.GcsDestination gcs_destination = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Vision\V1p4beta1\GcsDestination $gcs_destination
     *           The Google Cloud Storage location to write the output(s) to.
     *     @type int $batch_size
     *           The max number of response protos to put into each output JSON file on
     *           Google Cloud Storage.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.GcsDestination gcs_destination = 1;</code>
     * @return \Google\Cloud\Vision\V1p4beta1\GcsDestination|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.GcsDestination gcs_destination = 1;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\GcsDestination $var
     * @return $this
     */
    public function setGcsDestination($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\GcsDestination::class);
