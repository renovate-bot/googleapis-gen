 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p4beta1.BatchOperationMetadata</code>
 */
class BatchOperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.BatchOperationMetadata.State state = 1;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Vision\V1p4beta1\BatchOperationMetadata\State::class);
        $this->state = $var;
