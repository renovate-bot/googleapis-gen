 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p4beta1.PurgeProductsRequest</code>
 */
class PurgeProductsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Vision\V1p4beta1\ProductSetPurgeConfig $product_set_purge_config
     ...
     * Specify which ProductSet contains the Products to be deleted.
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.ProductSetPurgeConfig product_set_purge_config = 2;</code>
     * @return \Google\Cloud\Vision\V1p4beta1\ProductSetPurgeConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.ProductSetPurgeConfig product_set_purge_config = 2;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\ProductSetPurgeConfig $var
     * @return $this
     */
    public function setProductSetPurgeConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\ProductSetPurgeConfig::class);
