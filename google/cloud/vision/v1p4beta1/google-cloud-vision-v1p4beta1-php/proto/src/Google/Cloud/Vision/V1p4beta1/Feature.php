 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p4beta1.Feature</code>
 */
class Feature extends \Google\Protobuf\Internal\Message
{
     ...
     * The feature type.
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.Feature.Type type = 1;</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Vision\V1p4beta1\Feature\Type::class);
        $this->type = $var;
