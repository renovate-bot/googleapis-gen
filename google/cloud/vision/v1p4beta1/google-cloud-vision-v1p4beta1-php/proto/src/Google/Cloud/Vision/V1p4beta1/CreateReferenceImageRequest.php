 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p4beta1.CreateReferenceImageRequest</code>
 */
class CreateReferenceImageRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Format is
     *           `projects/PROJECT_ID/locations/LOC_ID/products/PRODUCT_ID`.
     *     @type \Google\Cloud\Vision\V1p4beta1\ReferenceImage $reference_image
     *           Required. The reference image to create.
     *           If an image ID is specified, it is ignored.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.ReferenceImage reference_image = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Vision\V1p4beta1\ReferenceImage $var
     * @return $this
     */
    public function setReferenceImage($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\ReferenceImage::class);
