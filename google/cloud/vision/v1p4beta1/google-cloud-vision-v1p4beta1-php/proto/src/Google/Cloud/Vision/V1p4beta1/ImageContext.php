 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p4beta1.ImageContext</code>
 */
class ImageContext extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $face_recognition_params = null;
    /**
     ...
     *
     *     @type \Google\Cloud\Vision\V1p4beta1\LatLongRect $lat_long_rect
     *           Not used.
     ...
     *           error if one or more of the specified languages is not one of the
     *           [supported languages](https://cloud.google.com/vision/docs/languages).
     *     @type \Google\Cloud\Vision\V1p4beta1\CropHintsParams $crop_hints_params
     *           Parameters for crop hints annotation request.
     *     @type \Google\Cloud\Vision\V1p4beta1\FaceRecognitionParams $face_recognition_params
     *           Parameters for face recognition.
     *     @type \Google\Cloud\Vision\V1p4beta1\ProductSearchParams $product_search_params
     *           Parameters for product search.
     *     @type \Google\Cloud\Vision\V1p4beta1\WebDetectionParams $web_detection_params
     *           Parameters for web detection.
     *     @type \Google\Cloud\Vision\V1p4beta1\TextDetectionParams $text_detection_params
     *           Parameters for text detection and document text detection.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.LatLongRect lat_long_rect = 1;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\LatLongRect $var
     * @return $this
     */
    public function setLatLongRect($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\LatLongRect::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.CropHintsParams crop_hints_params = 4;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\CropHintsParams $var
     * @return $this
     */
    public function setCropHintsParams($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\CropHintsParams::class);
    ...
    {
        return isset($this->face_recognition_params) ? $this->face_recognition_params : null;
    }

    public function hasFaceRecognitionParams()
    {
        return isset($this->face_recognition_params);
    }

    public function clearFaceRecognitionParams()
    {
        unset($this->face_recognition_params);
    }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.FaceRecognitionParams face_recognition_params = 10;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\FaceRecognitionParams $var
     * @return $this
     */
    public function setFaceRecognitionParams($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\FaceRecognitionParams::class);
        $this->face_recognition_params = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.ProductSearchParams product_search_params = 5;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\ProductSearchParams $var
     * @return $this
     */
    public function setProductSearchParams($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\ProductSearchParams::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.WebDetectionParams web_detection_params = 6;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\WebDetectionParams $var
     * @return $this
     */
    public function setWebDetectionParams($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\WebDetectionParams::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.TextDetectionParams text_detection_params = 12;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\TextDetectionParams $var
     * @return $this
     */
    public function setTextDetectionParams($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\TextDetectionParams::class);
