 ...
 * field.
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p4beta1.ImportProductSetsResponse</code>
 */
class ImportProductSetsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p4beta1.ReferenceImage reference_images = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Vision\V1p4beta1\ReferenceImage[]|\Google\Protobuf\Internal\RepeatedField $reference_images
     *           The list of reference_images that are imported successfully.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p4beta1.ReferenceImage reference_images = 1;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\ReferenceImage[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setReferenceImages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Vision\V1p4beta1\ReferenceImage::class);
