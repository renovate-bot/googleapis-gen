...
namespace Google\Cloud\Vision\V1p4beta1\TextAnnotation\DetectedBreak;
 ...
 *
 * Protobuf type <code>google.cloud.vision.v1p4beta1.TextAnnotation.DetectedBreak.BreakType</code>
 */
class BreakType
{
    /**
...
class_alias(BreakType::class, \Google\Cloud\Vision\V1p4beta1\TextAnnotation_DetectedBreak_BreakType::class);
