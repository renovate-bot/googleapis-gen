 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p4beta1.FaceAnnotation</code>
 */
class FaceAnnotation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p4beta1.FaceAnnotation.Landmark landmarks = 3;</code>
     */
    private $landmarks;
    /**
     ...
     * Joy likelihood.
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.Likelihood joy_likelihood = 9;</code>
     */
    protected $joy_likelihood = 0;
    /**
     * Sorrow likelihood.
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.Likelihood sorrow_likelihood = 10;</code>
     */
    protected $sorrow_likelihood = 0;
    /**
     * Anger likelihood.
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.Likelihood anger_likelihood = 11;</code>
     */
    protected $anger_likelihood = 0;
    /**
     * Surprise likelihood.
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.Likelihood surprise_likelihood = 12;</code>
     */
    protected $surprise_likelihood = 0;
    /**
     * Under-exposed likelihood.
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.Likelihood under_exposed_likelihood = 13;</code>
     */
    protected $under_exposed_likelihood = 0;
    /**
     * Blurred likelihood.
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.Likelihood blurred_likelihood = 14;</code>
     */
    protected $blurred_likelihood = 0;
    /**
     * Headwear likelihood.
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.Likelihood headwear_likelihood = 15;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p4beta1.FaceRecognitionResult recognition_result = 16;</code>
     */
    private $recognition_result;
     ...
     *
     *     @type \Google\Cloud\Vision\V1p4beta1\BoundingPoly $bounding_poly
     *           The bounding polygon around the face. The coordinates of the bounding box
     *           are in the original image's scale.
     *           The bounding box is computed to "frame" the face in accordance with human
     *           expectations. It is based on the landmarker results.
     ...
     *           `BoundingPoly` (the polygon will be unbounded) if only a partial face
     *           appears in the image to be annotated.
     *     @type \Google\Cloud\Vision\V1p4beta1\BoundingPoly $fd_bounding_poly
     *           The `fd_bounding_poly` bounding polygon is tighter than the
     *           `boundingPoly`, and encloses only the skin part of the face. Typically, it
     *           is used to eliminate the face from any image analysis that detects the
     *           "amount of skin" visible in an image. It is not based on the
     *           landmarker results, only on the initial face detection, hence
     *           the <code>fd</code> (face detection) prefix.
     *     @type \Google\Cloud\Vision\V1p4beta1\FaceAnnotation\Landmark[]|\Google\Protobuf\Internal\RepeatedField $landmarks
     *           Detected face landmarks.
     ...
     *           Headwear likelihood.
     *     @type \Google\Cloud\Vision\V1p4beta1\FaceRecognitionResult[]|\Google\Protobuf\Internal\RepeatedField $recognition_result
     *           Additional recognition information. Only computed if
     *           image_context.face_recognition_params is provided, **and** a match is found
     *           to a [Celebrity][google.cloud.vision.v1p4beta1.Celebrity] in the input
     *           [CelebritySet][google.cloud.vision.v1p4beta1.CelebritySet]. This field is
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.BoundingPoly bounding_poly = 1;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\BoundingPoly $var
     * @return $this
     */
    public function setBoundingPoly($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\BoundingPoly::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p4beta1.FaceAnnotation.Landmark landmarks = 3;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\FaceAnnotation\Landmark[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLandmarks($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Vision\V1p4beta1\FaceAnnotation\Landmark::class);
        $this->landmarks = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Vision\V1p4beta1\Likelihood::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p4beta1.FaceRecognitionResult recognition_result = 16;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\FaceRecognitionResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRecognitionResult($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Vision\V1p4beta1\FaceRecognitionResult::class);
        $this->recognition_result = $arr;
