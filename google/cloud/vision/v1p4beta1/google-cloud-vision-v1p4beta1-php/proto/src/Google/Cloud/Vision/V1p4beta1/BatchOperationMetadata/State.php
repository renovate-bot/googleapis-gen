...
namespace Google\Cloud\Vision\V1p4beta1\BatchOperationMetadata;
 ...
 *
 * Protobuf type <code>google.cloud.vision.v1p4beta1.BatchOperationMetadata.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Vision\V1p4beta1\BatchOperationMetadata_State::class);
