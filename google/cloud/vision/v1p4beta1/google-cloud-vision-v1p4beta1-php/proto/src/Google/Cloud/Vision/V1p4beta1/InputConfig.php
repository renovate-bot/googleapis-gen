 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p4beta1.InputConfig</code>
 */
class InputConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.GcsSource gcs_source = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Vision\V1p4beta1\GcsSource $gcs_source
     *           The Google Cloud Storage location to read the input from.
     *     @type string $content
     *           File content, represented as a stream of bytes.
     *           Note: As with all `bytes` fields, protobuffers use a pure binary
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.GcsSource gcs_source = 1;</code>
     * @return \Google\Cloud\Vision\V1p4beta1\GcsSource|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p4beta1.GcsSource gcs_source = 1;</code>
     * @param \Google\Cloud\Vision\V1p4beta1\GcsSource $var
     * @return $this
     */
    public function setGcsSource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p4beta1\GcsSource::class);
        $this->gcs_source = $var;
