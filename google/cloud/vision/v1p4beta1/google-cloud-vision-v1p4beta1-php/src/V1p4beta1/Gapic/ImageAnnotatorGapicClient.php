...
use Google\Cloud\Vision\V1p4beta1\AnnotateFileRequest;
use Google\Cloud\Vision\V1p4beta1\AnnotateImageRequest;
use Google\Cloud\Vision\V1p4beta1\AsyncAnnotateFileRequest;
use Google\Cloud\Vision\V1p4beta1\AsyncBatchAnnotateFilesRequest;
use Google\Cloud\Vision\V1p4beta1\AsyncBatchAnnotateFilesResponse;
use Google\Cloud\Vision\V1p4beta1\AsyncBatchAnnotateImagesRequest;
use Google\Cloud\Vision\V1p4beta1\AsyncBatchAnnotateImagesResponse;
use Google\Cloud\Vision\V1p4beta1\BatchAnnotateFilesRequest;
use Google\Cloud\Vision\V1p4beta1\BatchAnnotateFilesResponse;
use Google\Cloud\Vision\V1p4beta1\BatchAnnotateImagesRequest;
use Google\Cloud\Vision\V1p4beta1\BatchAnnotateImagesResponse;
use Google\Cloud\Vision\V1p4beta1\OperationMetadata;
use Google\Cloud\Vision\V1p4beta1\OutputConfig;
...
class ImageAnnotatorGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.vision.v1p4beta1.ImageAnnotator';
