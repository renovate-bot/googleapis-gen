...
use Google\Cloud\Vision\V1p4beta1\ImageAnnotatorClient;
...
class ImageAnnotatorClientTest extends GeneratedTest
{
    ...
    public function asyncBatchAnnotateFilesTest()
    {
        ...
        $this->assertSame('/google.cloud.vision.v1p4beta1.ImageAnnotator/AsyncBatchAnnotateFiles', $actualApiFuncCall);
    ...
    public function asyncBatchAnnotateImagesTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p4beta1.ImageAnnotator/AsyncBatchAnnotateImages', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function batchAnnotateFilesTest()
    {
        ...
        $this->assertSame('/google.cloud.vision.v1p4beta1.ImageAnnotator/BatchAnnotateFiles', $actualFuncCall);
    ...
    public function batchAnnotateImagesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.vision.v1p4beta1.ImageAnnotator/BatchAnnotateImages', $actualFuncCall);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
