...
require "google/cloud/vision/v1p4beta1/product_search_client"
...
module Google
  module Cloud
    module Vision
      ...
      ##
      # # Ruby Client for Cloud Vision API ([Beta](https://github.com/GoogleCloudPlatform/google-cloud-ruby#versioning))
      #
      ...
      module V1p4beta1
        ...
        module ProductSearch
          ...
          def self.new \
            ...
            Google::Cloud::Vision::V1p4beta1::ProductSearchClient.new(**kwargs)
          end
        end
        ...
        module ImageAnnotator
          ...
          def self.new \
            ...
            Google::Cloud::Vision::V1p4beta1::ImageAnnotatorClient.new(**kwargs)
          end
        end
      end
    end
