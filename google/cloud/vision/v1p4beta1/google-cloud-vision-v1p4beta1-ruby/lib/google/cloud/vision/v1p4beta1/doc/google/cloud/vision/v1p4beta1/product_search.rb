  ...
  module Cloud
    module Vision
      module V1p4beta1
        ...
        #     {Google::Cloud::Vision::V1p4beta1::ProductSet ProductSet} to be searched for
        #     similar images.
        #
        #     Format is:
        ...
        #   @return [Array<Google::Cloud::Vision::V1p4beta1::ProductSearchResults::Result>]
        #     List of results, one for each product match.
        # @!attribute [rw] product_grouped_results
        #   @return [Array<Google::Cloud::Vision::V1p4beta1::ProductSearchResults::GroupedResult>]
        ...
        class ProductSearchResults
          ...
          #   @return [Array<Google::Cloud::Vision::V1p4beta1::ProductSearchResults::ObjectAnnotation>]
