...
require File.expand_path("lib/google/cloud/vision/v1p4beta1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-vision-v1p4beta1"
  gem.version       = Google::Cloud::Vision::V1p4beta1::VERSION
