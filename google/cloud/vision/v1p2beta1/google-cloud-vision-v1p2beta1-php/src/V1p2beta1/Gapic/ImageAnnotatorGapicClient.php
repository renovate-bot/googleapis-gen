 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/vision/v1p2beta1/image_annotator.proto
 * and updates to that file get reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\Vision\V1p2beta1\Gapic;
...
use Google\Cloud\Vision\V1p2beta1\AnnotateImageRequest;
use Google\Cloud\Vision\V1p2beta1\AsyncAnnotateFileRequest;
use Google\Cloud\Vision\V1p2beta1\AsyncBatchAnnotateFilesRequest;
use Google\Cloud\Vision\V1p2beta1\AsyncBatchAnnotateFilesResponse;
use Google\Cloud\Vision\V1p2beta1\BatchAnnotateImagesRequest;
use Google\Cloud\Vision\V1p2beta1\BatchAnnotateImagesResponse;
use Google\Cloud\Vision\V1p2beta1\OperationMetadata;
...
class ImageAnnotatorGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.vision.v1p2beta1.ImageAnnotator';
