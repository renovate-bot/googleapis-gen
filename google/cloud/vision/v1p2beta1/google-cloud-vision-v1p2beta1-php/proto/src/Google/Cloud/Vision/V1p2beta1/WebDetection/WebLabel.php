 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p2beta1.WebDetection.WebLabel</code>
 */
...
class_alias(WebLabel::class, \Google\Cloud\Vision\V1p2beta1\WebDetection_WebLabel::class);
