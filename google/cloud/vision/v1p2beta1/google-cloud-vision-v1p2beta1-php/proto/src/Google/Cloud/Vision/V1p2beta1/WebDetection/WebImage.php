 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p2beta1.WebDetection.WebImage</code>
 */
...
class_alias(WebImage::class, \Google\Cloud\Vision\V1p2beta1\WebDetection_WebImage::class);
