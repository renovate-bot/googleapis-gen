...
class Block extends \Google\Protobuf\Internal\Message
{
     ...
     *                   1----0
     *             and the vertice order will still be (0, 1, 2, 3).
     *     @type \Google\Cloud\Vision\V1p2beta1\Paragraph[]|\Google\Protobuf\Internal\RepeatedField $paragraphs
     *           List of paragraphs in this block (if this blocks is of type text).
     *     @type int $block_type
     *           Detected block type (text, image etc) for this block.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Vision\V1p2beta1\Block\BlockType::class);
        $this->block_type = $var;
