 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p2beta1.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p2beta1.OperationMetadata.State state = 1;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Vision\V1p2beta1\OperationMetadata\State::class);
        $this->state = $var;
