...
class TextProperty extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Vision\V1p2beta1\TextAnnotation\DetectedLanguage[]|\Google\Protobuf\Internal\RepeatedField $detected_languages
     *           A list of detected languages together with confidence.
     *     @type \Google\Cloud\Vision\V1p2beta1\TextAnnotation\DetectedBreak $detected_break
     *           Detected start or end of a text segment.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p2beta1.TextAnnotation.DetectedLanguage detected_languages = 1;</code>
     * @param \Google\Cloud\Vision\V1p2beta1\TextAnnotation\DetectedLanguage[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDetectedLanguages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Vision\V1p2beta1\TextAnnotation\DetectedLanguage::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p2beta1.TextAnnotation.DetectedBreak detected_break = 2;</code>
     * @return \Google\Cloud\Vision\V1p2beta1\TextAnnotation\DetectedBreak|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p2beta1.TextAnnotation.DetectedBreak detected_break = 2;</code>
     * @param \Google\Cloud\Vision\V1p2beta1\TextAnnotation\DetectedBreak $var
     * @return $this
     */
    public function setDetectedBreak($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p2beta1\TextAnnotation\DetectedBreak::class);
...
class_alias(TextProperty::class, \Google\Cloud\Vision\V1p2beta1\TextAnnotation_TextProperty::class);
