 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p2beta1.Paragraph</code>
 */
class Paragraph extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p2beta1.Word words = 3;</code>
     */
    private $words;
    /**
     ...
     *
     *     @type \Google\Cloud\Vision\V1p2beta1\TextAnnotation\TextProperty $property
     *           Additional information detected for the paragraph.
     *     @type \Google\Cloud\Vision\V1p2beta1\BoundingPoly $bounding_box
     *           The bounding box for the paragraph.
     *           The vertices are in the order of top-left, top-right, bottom-right,
     *           bottom-left. When a rotation of the bounding box is detected the rotation
     *           is represented as around the top-left corner as defined when the text is
     ...
     *                1----0
     *             and the vertice order will still be (0, 1, 2, 3).
     *     @type \Google\Cloud\Vision\V1p2beta1\Word[]|\Google\Protobuf\Internal\RepeatedField $words
     *           List of words in this paragraph.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p2beta1.TextAnnotation.TextProperty property = 1;</code>
     * @return \Google\Cloud\Vision\V1p2beta1\TextAnnotation\TextProperty|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p2beta1.TextAnnotation.TextProperty property = 1;</code>
     * @param \Google\Cloud\Vision\V1p2beta1\TextAnnotation\TextProperty $var
     * @return $this
     */
    public function setProperty($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p2beta1\TextAnnotation\TextProperty::class);
        $this->property = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p2beta1.Word words = 3;</code>
     * @param \Google\Cloud\Vision\V1p2beta1\Word[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setWords($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Vision\V1p2beta1\Word::class);
        $this->words = $arr;
