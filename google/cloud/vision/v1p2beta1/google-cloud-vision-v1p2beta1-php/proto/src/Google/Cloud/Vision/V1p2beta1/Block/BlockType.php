...
namespace Google\Cloud\Vision\V1p2beta1\Block;
 ...
 *
 * Protobuf type <code>google.cloud.vision.v1p2beta1.Block.BlockType</code>
 */
class BlockType
{
    /**
...
class_alias(BlockType::class, \Google\Cloud\Vision\V1p2beta1\Block_BlockType::class);
