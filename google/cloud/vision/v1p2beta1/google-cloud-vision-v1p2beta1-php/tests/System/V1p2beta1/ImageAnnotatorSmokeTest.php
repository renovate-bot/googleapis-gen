...
namespace Google\Cloud\Vision\Tests\System\V1p2beta1;

use Google\Cloud\Vision\V1p2beta1\ImageAnnotatorClient;
use Google\ApiCore\Testing\GeneratedTest;
use Google\Cloud\Vision\V1p2beta1\AnnotateImageRequest;
use Google\Cloud\Vision\V1p2beta1\Feature;
use Google\Cloud\Vision\V1p2beta1\Feature\Type;
use Google\Cloud\Vision\V1p2beta1\Image;
use Google\Cloud\Vision\V1p2beta1\ImageSource;
