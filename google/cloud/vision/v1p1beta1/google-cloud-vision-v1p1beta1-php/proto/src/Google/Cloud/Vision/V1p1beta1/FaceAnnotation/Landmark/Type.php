...
namespace Google\Cloud\Vision\V1p1beta1\FaceAnnotation\Landmark;
 ...
 *
 * Protobuf type <code>google.cloud.vision.v1p1beta1.FaceAnnotation.Landmark.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\Vision\V1p1beta1\FaceAnnotation_Landmark_Type::class);
