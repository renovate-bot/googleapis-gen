...
namespace Google\Cloud\Vision\V1p1beta1\Feature;
 ...
 *
 * Protobuf type <code>google.cloud.vision.v1p1beta1.Feature.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\Vision\V1p1beta1\Feature_Type::class);
