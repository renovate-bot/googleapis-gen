 ...
 *
 * Generated from protobuf message <code>google.cloud.vision.v1p1beta1.ImageContext</code>
 */
class ImageContext extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Vision\V1p1beta1\LatLongRect $lat_long_rect
     *           lat/long rectangle that specifies the location of the image.
     ...
     *           error if one or more of the specified languages is not one of the
     *           [supported languages](https://cloud.google.com/vision/docs/languages).
     *     @type \Google\Cloud\Vision\V1p1beta1\CropHintsParams $crop_hints_params
     *           Parameters for crop hints annotation request.
     *     @type \Google\Cloud\Vision\V1p1beta1\WebDetectionParams $web_detection_params
     *           Parameters for web detection.
     *     @type \Google\Cloud\Vision\V1p1beta1\TextDetectionParams $text_detection_params
     *           Parameters for text detection and document text detection.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p1beta1.LatLongRect lat_long_rect = 1;</code>
     * @param \Google\Cloud\Vision\V1p1beta1\LatLongRect $var
     * @return $this
     */
    public function setLatLongRect($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p1beta1\LatLongRect::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p1beta1.CropHintsParams crop_hints_params = 4;</code>
     * @param \Google\Cloud\Vision\V1p1beta1\CropHintsParams $var
     * @return $this
     */
    public function setCropHintsParams($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p1beta1\CropHintsParams::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p1beta1.WebDetectionParams web_detection_params = 6;</code>
     * @param \Google\Cloud\Vision\V1p1beta1\WebDetectionParams $var
     * @return $this
     */
    public function setWebDetectionParams($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p1beta1\WebDetectionParams::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vision.v1p1beta1.TextDetectionParams text_detection_params = 12;</code>
     * @param \Google\Cloud\Vision\V1p1beta1\TextDetectionParams $var
     * @return $this
     */
    public function setTextDetectionParams($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Vision\V1p1beta1\TextDetectionParams::class);
