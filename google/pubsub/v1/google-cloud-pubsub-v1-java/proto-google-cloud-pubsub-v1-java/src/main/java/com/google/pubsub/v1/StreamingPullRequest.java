...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      for (int i = 0; i < modifyDeadlineSeconds_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream
          .computeInt32SizeNoTag(modifyDeadlineSeconds_.getInt(i));
      }
      size += dataSize;
    ...
    if (maxOutstandingMessages_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(7, maxOutstandingMessages_);
    }
    if (maxOutstandingBytes_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getModifyDeadlineSecondsList()
        .equals(other.getModifyDeadlineSecondsList())) return false;
    if (!getModifyDeadlineAckIdsList()
