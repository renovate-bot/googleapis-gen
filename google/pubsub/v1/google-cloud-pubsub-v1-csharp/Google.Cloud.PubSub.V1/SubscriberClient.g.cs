...
{
    /// <summary>Settings for <see cref="SubscriberClient"/> instances.</summary>
    public sealed partial class SubscriberSettings : gaxgrpc::ServiceSettingsBase
    {
        /// <summary>Get a new instance of the default <see cref="SubscriberSettings"/>.</summary>
        /// <returns>A new instance of the default <see cref="SubscriberSettings"/>.</returns>
        public static SubscriberSettings GetDefault() => new SubscriberSettings();

        /// <summary>Constructs a new <see cref="SubscriberSettings"/> object with default settings.</summary>
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to <c>SubscriberClient.Pull</c>
        /// and <c>SubscriberClient.PullAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds.</description></item>
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>SubscriberClient.StreamingPull</c> and <c>SubscriberClient.StreamingPullAsync</c>.
        /// </summary>
        ...
        /// <summary>
        /// <see cref="gaxgrpc::BidirectionalStreamingSettings"/> for calls to <c>SubscriberClient.StreamingPull</c> and
        /// <c>SubscriberClient.StreamingPullAsync</c>.
        /// </summary>
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to
        /// <c>SubscriberClient.GetSnapshot</c> and <c>SubscriberClient.GetSnapshotAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds.</description></item>
        ...
        /// <summary>
        /// <see cref="gaxgrpc::CallSettings"/> for synchronous and asynchronous calls to <c>SubscriberClient.Seek</c>
        /// and <c>SubscriberClient.SeekAsync</c>.
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Initial retry delay: 100 milliseconds.</description></item>
    ...
    /// <summary>
    /// Builder class for <see cref="SubscriberClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class SubscriberClientBuilder : gaxgrpc::ClientBuilderBase<SubscriberClient>
    {
        /// <summary>The settings to use for RPCs, or <c>null</c> for the default settings.</summary>
        public SubscriberSettings Settings { get; set; }

        /// <summary>Creates a new builder with default settings.</summary>
        public SubscriberClientBuilder()
        {
            UseJwtAccessWithScopes = SubscriberClient.UseJwtAccessWithScopes;
        }

        partial void InterceptBuild(ref SubscriberClient client);

        partial void InterceptBuildAsync(st::CancellationToken cancellationToken, ref stt::Task<SubscriberClient> task);

        /// <summary>Builds the resulting client.</summary>
        public override SubscriberClient Build()
        {
            SubscriberClient client = null;
            InterceptBuild(ref client);
            return client ?? BuildImpl();
        }

        /// <summary>Builds the resulting client asynchronously.</summary>
        public override stt::Task<SubscriberClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            stt::Task<SubscriberClient> task = null;
            InterceptBuildAsync(cancellationToken, ref task);
            return task ?? BuildAsyncImpl(cancellationToken);
        }

        private SubscriberClient BuildImpl()
        {
            Validate();
            grpccore::CallInvoker callInvoker = CreateCallInvoker();
            return SubscriberClient.Create(callInvoker, Settings);
        }

        private async stt::Task<SubscriberClient> BuildAsyncImpl(st::CancellationToken cancellationToken)
        {
            Validate();
        ...
        protected override string GetDefaultEndpoint() => SubscriberClient.DefaultEndpoint;

        /// <summary>
        /// Returns the default scopes for this builder type, used if no scopes are otherwise specified.
        /// </summary>
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => SubscriberClient.DefaultScopes;

        /// <summary>Returns the channel pool to use when no other options are specified.</summary>
        protected override gaxgrpc::ChannelPool GetChannelPool() => SubscriberClient.ChannelPool;

        /// <summary>Returns the default <see cref="gaxgrpc::GrpcAdapter"/>to use if not otherwise specified.</summary>
        protected override gaxgrpc::GrpcAdapter DefaultGrpcAdapter => gaxgrpccore::GrpcCoreAdapter.Instance;
    }

    /// <summary>Subscriber client wrapper, for convenient use.</summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// The default endpoint for the Subscriber service, which is a host of "pubsub.googleapis.com" and a port of
        /// 443.
        /// </summary>
        public static string DefaultEndpoint { get; } = "pubsub.googleapis.com:443";

        /// <summary>The default Subscriber scopes.</summary>
        /// <remarks>
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="SubscriberClient"/> using the default credentials, endpoint and
        /// settings. To specify custom credentials or other settings, use <see cref="SubscriberClientBuilder"/>.
        /// </summary>
        /// <param name="cancellationToken">
        /// The <see cref="st::CancellationToken"/> to use while creating the client.
        /// </param>
        /// <returns>The task representing the created <see cref="SubscriberClient"/>.</returns>
        public static stt::Task<SubscriberClient> CreateAsync(st::CancellationToken cancellationToken = default) =>
            new SubscriberClientBuilder().BuildAsync(cancellationToken);

        /// <summary>
        /// Synchronously creates a <see cref="SubscriberClient"/> using the default credentials, endpoint and settings.
        /// To specify custom credentials or other settings, use <see cref="SubscriberClientBuilder"/>.
        /// </summary>
        /// <returns>The created <see cref="SubscriberClient"/>.</returns>
        public static SubscriberClient Create() => new SubscriberClientBuilder().Build();

        /// <summary>
        /// Creates a <see cref="SubscriberClient"/> which uses the specified call invoker for remote operations.
        /// </summary>
        ...
        /// <returns>The created <see cref="SubscriberClient"/>.</returns>
        internal static SubscriberClient Create(grpccore::CallInvoker callInvoker, SubscriberSettings settings = null)
        {
        ...
        /// <summary>The underlying gRPC Subscriber client</summary>
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="Subscription"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListSubscriptionsResponse, Subscription> ListSubscriptions(ProjectName project, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListSubscriptions(new ListSubscriptionsRequest
            {
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="Subscription"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListSubscriptionsResponse, Subscription> ListSubscriptionsAsync(ProjectName project, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListSubscriptionsAsync(new ListSubscriptionsRequest
            {
                ProjectAsProjectName = gax::GaxPreconditions.CheckNotNull(project, nameof(project)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable sequence of <see cref="Snapshot"/> resources.</returns>
        public virtual gax::PagedEnumerable<ListSnapshotsResponse, Snapshot> ListSnapshots(ProjectName project, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListSnapshots(new ListSnapshotsRequest
            {
                ProjectAsProjectName = gax::GaxPreconditions.CheckNotNull(project, nameof(project)),
                PageToken = pageToken ?? "",
        ...
        /// <param name="callSettings">If not null, applies overrides to this RPC call.</param>
        /// <returns>A pageable asynchronous sequence of <see cref="Snapshot"/> resources.</returns>
        public virtual gax::PagedAsyncEnumerable<ListSnapshotsResponse, Snapshot> ListSnapshotsAsync(ProjectName project, string pageToken = null, int? pageSize = null, gaxgrpc::CallSettings callSettings = null) =>
            ListSnapshotsAsync(new ListSnapshotsRequest
            {
                ProjectAsProjectName = gax::GaxPreconditions.CheckNotNull(project, nameof(project)),
                PageToken = pageToken ?? "",
    ...
    /// <summary>Subscriber client wrapper implementation, for convenient use.</summary>
    /// <remarks>
    /// The service that an application uses to manipulate subscriptions and to
    /// consume messages from a subscription via the `Pull` method or by
    /// establishing a bi-directional stream using the `StreamingPull` method.
    ...
    public sealed partial class SubscriberClientImpl : SubscriberClient
    {
        ...
        partial void OnConstruction(Subscriber.SubscriberClient grpcClient, SubscriberSettings effectiveSettings, gaxgrpc::ClientHelper clientHelper);
        ...
        internal sealed partial class StreamingPullStreamImpl : StreamingPullStream
        {
            ...
            /// this streaming call.
            /// </param>
            public StreamingPullStreamImpl(SubscriberClientImpl service, grpccore::AsyncDuplexStreamingCall<StreamingPullRequest, StreamingPullResponse> call, gaxgrpc::BufferedClientStreamWriter<StreamingPullRequest> writeBuffer)
            {
                _service = service;
                GrpcCall = call;
        ...
        /// <param name="streamingSettings">If not null, applies streaming overrides to this RPC call.</param>
        /// <returns>The client-server stream.</returns>
        public override SubscriberClient.StreamingPullStream StreamingPull(gaxgrpc::CallSettings callSettings = null, gaxgrpc::BidirectionalStreamingSettings streamingSettings = null)
        {
