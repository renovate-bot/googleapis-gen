...
// internalIamPolicyClient is an interface that defines the methods availaible from Cloud Pub/Sub API.
...
func (c *IamPolicyClient) setGoogleClientInfo(...string) {
...
// iamPolicyGRPCClient is a client for interacting with Cloud Pub/Sub API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
