...
from google.pubsub_v1.services.schema_service.transports.base import _GOOGLE_AUTH_VERSION
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (SchemaServiceAsyncClient, transports.SchemaServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (SchemaServiceAsyncClient, transports.SchemaServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (SchemaServiceClient, transports.SchemaServiceGrpcTransport, "grpc", "false"),
    (SchemaServiceAsyncClient, transports.SchemaServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(SchemaServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SchemaServiceClient))
@mock.patch.object(SchemaServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SchemaServiceAsyncClient))
...
def test_schema_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_schema_service_client_client_options_from_dict():
    with mock.patch('google.pubsub_v1.services.schema_service.transports.SchemaServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_schema(transport: str = 'grpc', request_type=gp_schema.CreateSchemaRequest):
    client = SchemaServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_list_schemas_async(transport: str = 'grpc_asyncio', request_type=schema.ListSchemasRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(schema.ListSchemasResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_schemas_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, schema.Schema)
                   for i in results)
...
def test_delete_schema(transport: str = 'grpc', request_type=schema.DeleteSchemaRequest):
    client = SchemaServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_validate_schema(transport: str = 'grpc', request_type=gp_schema.ValidateSchemaRequest):
    client = SchemaServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_validate_schema_async(transport: str = 'grpc_asyncio', request_type=gp_schema.ValidateSchemaRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gp_schema.ValidateSchemaResponse(
        ))
...
def test_validate_message(transport: str = 'grpc', request_type=schema.ValidateMessageRequest):
    client = SchemaServiceClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_validate_message_async(transport: str = 'grpc_asyncio', request_type=schema.ValidateMessageRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(schema.ValidateMessageResponse(
        ))
...
def test_schema_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.pubsub_v1.services.schema_service.transports.SchemaServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_schema_service_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.pubsub_v1.services.schema_service.transports.SchemaServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.SchemaServiceTransport()
        adc.assert_called_once()
...
def test_schema_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_schema_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
def test_schema_path():
    project = "squid"
    schema = "clam"
    expected = "projects/{project}/schemas/{schema}".format(project=project, schema=schema, )
