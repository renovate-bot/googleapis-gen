...
class SchemaServiceTransport(abc.ABC):
    ...
    @property
    def create_schema(self) -> typing.Callable[
            [gp_schema.CreateSchemaRequest],
            typing.Union[
                gp_schema.Schema,
                typing.Awaitable[gp_schema.Schema]
            ]]:
        raise NotImplementedError()

    @property
    def get_schema(self) -> typing.Callable[
            [schema.GetSchemaRequest],
            typing.Union[
                schema.Schema,
                typing.Awaitable[schema.Schema]
            ]]:
        raise NotImplementedError()

    @property
    def list_schemas(self) -> typing.Callable[
            [schema.ListSchemasRequest],
            typing.Union[
                schema.ListSchemasResponse,
                typing.Awaitable[schema.ListSchemasResponse]
            ]]:
        raise NotImplementedError()

    @property
    def delete_schema(self) -> typing.Callable[
    ...
    @property
    def validate_schema(self) -> typing.Callable[
    ...
    @property
    def validate_message(self) -> typing.Callable[
