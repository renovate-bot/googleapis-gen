...
class SchemaSettings(proto.Message):
    ...
    encoding = proto.Field(proto.ENUM, number=2,
...
class Topic(proto.Message):
    ...
    schema_settings = proto.Field(proto.MESSAGE, number=6,
...
class PushConfig(proto.Message):
    ...
    oidc_token = proto.Field(proto.MESSAGE, number=3, oneof='authentication_method',
        message=OidcToken,
    )
...
class SeekRequest(proto.Message):
    ...
    time = proto.Field(proto.MESSAGE, number=2, oneof='target',
        message=timestamp.Timestamp,
    )
