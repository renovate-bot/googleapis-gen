...
class ServiceUsageTransport(abc.ABC):
    ...
    @property
    def enable_service(self) -> typing.Callable[
    ...
    @property
    def disable_service(self) -> typing.Callable[
    ...
    def get_service(self) -> typing.Callable[
            ...
            typing.Union[
                resources.Service,
                typing.Awaitable[resources.Service]
            ]]:
        raise NotImplementedError()
    ...
    def list_services(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[serviceusage.ListServicesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def batch_enable_services(self) -> typing.Callable[
    ...
    @property
    def batch_get_services(self) -> typing.Callable[
            [serviceusage.BatchGetServicesRequest],
            typing.Union[
                serviceusage.BatchGetServicesResponse,
                typing.Awaitable[serviceusage.BatchGetServicesResponse]
            ]]:
        raise NotImplementedError()
