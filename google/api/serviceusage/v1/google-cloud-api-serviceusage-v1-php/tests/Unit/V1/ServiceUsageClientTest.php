...
class ServiceUsageClientTest extends GeneratedTest
{
    ...
    public function batchEnableServicesTest()
    {
        ...
        $expectedResponse = new BatchEnableServicesResponse();
        $anyResponse = new Any();
        ...
        $this->assertSame('/google.api.serviceusage.v1.ServiceUsage/BatchEnableServices', $actualApiFuncCall);
    ...
    public function batchGetServicesTest()
    {
        ...
        $this->assertTrue($transport->isExhausted());
        // Mock response
        $expectedResponse = new BatchGetServicesResponse();
        $transport->addResponse($expectedResponse);
        $response = $client->batchGetServices();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.api.serviceusage.v1.ServiceUsage/BatchGetServices', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function disableServiceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.api.serviceusage.v1.ServiceUsage/DisableService', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function enableServiceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.api.serviceusage.v1.ServiceUsage/EnableService', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getServiceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.api.serviceusage.v1.ServiceUsage/GetService', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listServicesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.api.serviceusage.v1.ServiceUsage/ListServices', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
