...
class Service extends \Google\Protobuf\Internal\Message
{
     ...
     *           A valid name would be:
     *           - projects/123
     *     @type \Google\Api\Serviceusage\V1\ServiceConfig $config
     *           The service configuration of the available service.
     *           Some fields may be filtered out of the configuration in responses to
     *           the `ListServices` method. These fields are present only in responses to
     *           the `GetService` method.
     ...
     *
     * Generated from protobuf field <code>.google.api.serviceusage.v1.ServiceConfig config = 2;</code>
     * @return \Google\Api\Serviceusage\V1\ServiceConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.serviceusage.v1.ServiceConfig config = 2;</code>
     * @param \Google\Api\Serviceusage\V1\ServiceConfig $var
     * @return $this
     */
    public function setConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Api\Serviceusage\V1\ServiceConfig::class);
        $this->config = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Api\Serviceusage\V1\State::class);
        $this->state = $var;
