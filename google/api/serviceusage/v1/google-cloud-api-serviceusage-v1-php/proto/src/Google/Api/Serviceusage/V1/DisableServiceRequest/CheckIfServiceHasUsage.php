...
namespace Google\Api\Serviceusage\V1\DisableServiceRequest;
...
class_alias(CheckIfServiceHasUsage::class, \Google\Api\Serviceusage\V1\DisableServiceRequest_CheckIfServiceHasUsage::class);
