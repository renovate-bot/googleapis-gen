...
namespace Google\Api\Serviceusage\V1\BatchEnableServicesResponse;
...
class_alias(EnableFailure::class, \Google\Api\Serviceusage\V1\BatchEnableServicesResponse_EnableFailure::class);
