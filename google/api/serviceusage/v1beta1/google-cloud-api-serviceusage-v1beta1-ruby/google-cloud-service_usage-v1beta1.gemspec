...
require File.expand_path("lib/google/cloud/service_usage/v1beta1/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-service_usage-v1beta1"
  gem.version       = Google::Cloud::ServiceUsage::V1beta1::VERSION
  ...
  gem.summary       = "API Client library for the Service Usage V1beta1 API"
