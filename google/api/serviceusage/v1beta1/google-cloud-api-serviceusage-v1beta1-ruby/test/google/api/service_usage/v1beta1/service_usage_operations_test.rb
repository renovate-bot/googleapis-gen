...
class ::Google::Api::ServiceUsage::V1beta1::ServiceUsage::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Api::ServiceUsage::V1beta1::ServiceUsage::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Api::ServiceUsage::V1beta1::ServiceUsage::Operations::Configuration, config
  end
end
