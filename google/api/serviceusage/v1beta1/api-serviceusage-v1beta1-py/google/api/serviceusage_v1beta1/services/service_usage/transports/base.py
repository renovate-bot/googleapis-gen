...
class ServiceUsageTransport(abc.ABC):
    ...
    @property
    def list_consumer_quota_metrics(self) -> typing.Callable[
            [serviceusage.ListConsumerQuotaMetricsRequest],
            typing.Union[
                serviceusage.ListConsumerQuotaMetricsResponse,
                typing.Awaitable[serviceusage.ListConsumerQuotaMetricsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_consumer_quota_metric(self) -> typing.Callable[
            [serviceusage.GetConsumerQuotaMetricRequest],
            typing.Union[
                resources.ConsumerQuotaMetric,
                typing.Awaitable[resources.ConsumerQuotaMetric]
            ]]:
        raise NotImplementedError()

    @property
    def get_consumer_quota_limit(self) -> typing.Callable[
            [serviceusage.GetConsumerQuotaLimitRequest],
            typing.Union[
                resources.ConsumerQuotaLimit,
                typing.Awaitable[resources.ConsumerQuotaLimit]
            ]]:
        raise NotImplementedError()

    @property
    def create_admin_override(self) -> typing.Callable[
    ...
    @property
    def update_admin_override(self) -> typing.Callable[
    ...
    @property
    def delete_admin_override(self) -> typing.Callable[
    ...
    @property
    def list_admin_overrides(self) -> typing.Callable[
            [serviceusage.ListAdminOverridesRequest],
            typing.Union[
                serviceusage.ListAdminOverridesResponse,
                typing.Awaitable[serviceusage.ListAdminOverridesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def import_admin_overrides(self) -> typing.Callable[
    ...
    @property
    def create_consumer_override(self) -> typing.Callable[
    ...
    @property
    def update_consumer_override(self) -> typing.Callable[
    ...
    @property
    def delete_consumer_override(self) -> typing.Callable[
    ...
    @property
    def list_consumer_overrides(self) -> typing.Callable[
            [serviceusage.ListConsumerOverridesRequest],
            typing.Union[
                serviceusage.ListConsumerOverridesResponse,
                typing.Awaitable[serviceusage.ListConsumerOverridesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def import_consumer_overrides(self) -> typing.Callable[
    ...
    @property
    def generate_service_identity(self) -> typing.Callable[
