...
class AllocateQuotaRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->allocate_operation);
    }

    public function clearAllocateOperation()
    {
        unset($this->allocate_operation);
    }
     ...
     *
     * Generated from protobuf field <code>.google.api.servicecontrol.v1.QuotaOperation allocate_operation = 2;</code>
     * @param \Google\Cloud\ServiceControl\V1\QuotaOperation $var
     * @return $this
     */
    public function setAllocateOperation($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\ServiceControl\V1\QuotaOperation::class);
