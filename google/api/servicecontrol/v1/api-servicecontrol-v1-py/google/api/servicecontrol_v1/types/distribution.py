...
class Distribution(proto.Message):
    ...
    Attributes:
        ...
        linear_buckets (google.api.servicecontrol_v1.types.Distribution.LinearBuckets):
            Buckets with constant width.
        exponential_buckets (google.api.servicecontrol_v1.types.Distribution.ExponentialBuckets):
            Buckets with exponentially growing width.
        explicit_buckets (google.api.servicecontrol_v1.types.Distribution.ExplicitBuckets):
