...
from google.api.servicecontrol_v1.types import metric_value
...
class AllocateQuotaRequest(proto.Message):
    ...
    Attributes:
        ...
        allocate_operation (google.api.servicecontrol_v1.types.QuotaOperation):
...
class QuotaOperation(proto.Message):
    ...
    Attributes:
        ...
        consumer_id (str):
            ...
            api_key:<api_key>.
        labels (Sequence[google.api.servicecontrol_v1.types.QuotaOperation.LabelsEntry]):
            Labels describing the operation.
        quota_metrics (Sequence[google.api.servicecontrol_v1.types.MetricValueSet]):
        ...
        quota_mode (google.api.servicecontrol_v1.types.QuotaOperation.QuotaMode):
...
class AllocateQuotaResponse(proto.Message):
    ...
    Attributes:
        operation_id (str):
            ...
            purposes.
        allocate_errors (Sequence[google.api.servicecontrol_v1.types.QuotaError]):
...
class QuotaError(proto.Message):
    ...
    Attributes:
        code (google.api.servicecontrol_v1.types.QuotaError.Code):
            Error code.
        subject (str):
