...
from google.api.servicecontrol_v1.types import operation as gas_operation
...
class CheckRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.api.servicecontrol_v1.types.Operation):
...
class CheckResponse(proto.Message):
    ...
    Attributes:
        ...
        check_errors (Sequence[google.api.servicecontrol_v1.types.CheckError]):
        ...
        service_rollout_id (str):
            ...
            process the request.
        check_info (google.api.servicecontrol_v1.types.CheckResponse.CheckInfo):
    ...
    class CheckInfo(proto.Message):
        ...
        Attributes:
            ...
            consumer_info (google.api.servicecontrol_v1.types.CheckResponse.ConsumerInfo):
                Consumer info of this check.
        """

        unused_arguments = proto.RepeatedField(proto.STRING, number=1)

        consumer_info = proto.Field(proto.MESSAGE, number=2,
    ...
    class ConsumerInfo(proto.Message):
        ...
        Attributes:
            ...
            type_ (google.api.servicecontrol_v1.types.CheckResponse.ConsumerInfo.ConsumerType):
    ...
    check_errors = proto.RepeatedField(proto.MESSAGE, number=2,
    ...
    check_info = proto.Field(proto.MESSAGE, number=6,
        message=CheckInfo,
    )
...
class ReportRequest(proto.Message):
    ...
    Attributes:
        service_name (str):
            ...
            `google.api.Service <https://cloud.google.com/service-management/reference/rpc/google.api#google.api.Service>`__
            for the definition of a service name.
        operations (Sequence[google.api.servicecontrol_v1.types.Operation]):
...
class ReportResponse(proto.Message):
    ...
    Attributes:
        report_errors (Sequence[google.api.servicecontrol_v1.types.ReportResponse.ReportError]):
    ...
    report_errors = proto.RepeatedField(proto.MESSAGE, number=1,
        message=ReportError,
    )
