...
class QuotaControllerAsyncClient:
    ...
    from_service_account_info = QuotaControllerClient.from_service_account_info
    from_service_account_file = QuotaControllerClient.from_service_account_file
    ...
    async def allocate_quota(self,
        ...
        **NOTE:** The client **must** fail-open on server errors
        ...
        Args:
            request (:class:`google.api.servicecontrol_v1.types.AllocateQuotaRequest`):
        ...
        Returns:
            google.api.servicecontrol_v1.types.AllocateQuotaResponse:
