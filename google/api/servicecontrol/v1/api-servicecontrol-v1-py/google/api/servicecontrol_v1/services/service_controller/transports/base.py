...
class ServiceControllerTransport(abc.ABC):
    ...
    @property
    def check(self) -> typing.Callable[
            [service_controller.CheckRequest],
            typing.Union[
                service_controller.CheckResponse,
                typing.Awaitable[service_controller.CheckResponse]
            ]]:
        raise NotImplementedError()

    @property
    def report(self) -> typing.Callable[
            [service_controller.ReportRequest],
            typing.Union[
                service_controller.ReportResponse,
                typing.Awaitable[service_controller.ReportResponse]
            ]]:
        raise NotImplementedError()
