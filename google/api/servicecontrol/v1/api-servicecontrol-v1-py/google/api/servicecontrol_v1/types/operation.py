...
class Operation(proto.Message):
    ...
    Attributes:
        ...
        labels (Sequence[google.api.servicecontrol_v1.types.Operation.LabelsEntry]):
        ...
        metric_value_sets (Sequence[google.api.servicecontrol_v1.types.MetricValueSet]):
            ...
            error.
        log_entries (Sequence[google.api.servicecontrol_v1.types.LogEntry]):
            Represents information to be logged.
        importance (google.api.servicecontrol_v1.types.Operation.Importance):
    ...
    metric_value_sets = proto.RepeatedField(proto.MESSAGE, number=7,
        message=metric_value.MetricValueSet,
    )

    log_entries = proto.RepeatedField(proto.MESSAGE, number=8,
        message=log_entry.LogEntry,
    )

    importance = proto.Field(proto.ENUM, number=11,
        enum=Importance,
    )

    extensions = proto.RepeatedField(proto.MESSAGE, number=16,
        message=gp_any.Any,
    )
