...
from google.api.servicecontrol_v1.types import http_request as gas_http_request
...
class LogEntry(proto.Message):
    ...
    Attributes:
        ...
        severity (google.logging.type.log_severity_pb2.LogSeverity):
            ...
            ``LogSeverity.DEFAULT``.
        http_request (google.api.servicecontrol_v1.types.HttpRequest):
        ...
        insert_id (str):
            ...
            operation_id.
        labels (Sequence[google.api.servicecontrol_v1.types.LogEntry.LabelsEntry]):
        ...
        operation (google.api.servicecontrol_v1.types.LogEntryOperation):
            Optional. Information about an operation
            associated with the log entry, if applicable.
        source_location (google.api.servicecontrol_v1.types.LogEntrySourceLocation):
    ...
    timestamp = proto.Field(proto.MESSAGE, number=11,
        message=gp_timestamp.Timestamp,
    )

    severity = proto.Field(proto.ENUM, number=12,
        enum=log_severity.LogSeverity,
    )

    http_request = proto.Field(proto.MESSAGE, number=14,
    ...
    struct_payload = proto.Field(proto.MESSAGE, number=6, oneof='payload',
        message=struct.Struct,
    )

    operation = proto.Field(proto.MESSAGE, number=16,
        message='LogEntryOperation',
    )

    source_location = proto.Field(proto.MESSAGE, number=17,
