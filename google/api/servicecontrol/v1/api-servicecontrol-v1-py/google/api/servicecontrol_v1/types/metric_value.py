...
class MetricValue(proto.Message):
    ...
    Attributes:
        labels (Sequence[google.api.servicecontrol_v1.types.MetricValue.LabelsEntry]):
        ...
        string_value (str):
            A text string value.
        distribution_value (google.api.servicecontrol_v1.types.Distribution):
...
class MetricValueSet(proto.Message):
    ...
    Attributes:
        metric_name (str):
            ...
            configuration.
        metric_values (Sequence[google.api.servicecontrol_v1.types.MetricValue]):
