...
from google.api.servicecontrol_v1.services.service_controller import ServiceControllerAsyncClient
from google.api.servicecontrol_v1.services.service_controller import ServiceControllerClient
from google.api.servicecontrol_v1.services.service_controller import transports
from google.api.servicecontrol_v1.types import check_error
from google.api.servicecontrol_v1.types import distribution
from google.api.servicecontrol_v1.types import http_request
from google.api.servicecontrol_v1.types import log_entry
from google.api.servicecontrol_v1.types import metric_value
from google.api.servicecontrol_v1.types import operation
...
def test_service_controller_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_service_controller_client_client_options_from_dict():
    with mock.patch('google.api.servicecontrol_v1.services.service_controller.transports.ServiceControllerGrpcTransport.__init__') as grpc_transport:
...
def test_service_controller_base_transport():
    ...
    with mock.patch('google.api.servicecontrol_v1.services.service_controller.transports.ServiceControllerTransport.__init__') as Transport:
...
def test_service_controller_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.api.servicecontrol_v1.services.service_controller.transports.ServiceControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_service_controller_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.api.servicecontrol_v1.services.service_controller.transports.ServiceControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ServiceControllerTransport()
        adc.assert_called_once()
