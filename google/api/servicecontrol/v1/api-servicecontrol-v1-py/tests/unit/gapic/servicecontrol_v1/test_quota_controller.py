...
from google.api.servicecontrol_v1.services.quota_controller import QuotaControllerAsyncClient
from google.api.servicecontrol_v1.services.quota_controller import QuotaControllerClient
from google.api.servicecontrol_v1.services.quota_controller import transports
...
def test_quota_controller_client_client_options_from_dict():
    with mock.patch('google.api.servicecontrol_v1.services.quota_controller.transports.QuotaControllerGrpcTransport.__init__') as grpc_transport:
...
def test_quota_controller_base_transport():
    ...
    with mock.patch('google.api.servicecontrol_v1.services.quota_controller.transports.QuotaControllerTransport.__init__') as Transport:
...
def test_quota_controller_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file') as load_creds, mock.patch('google.api.servicecontrol_v1.services.quota_controller.transports.QuotaControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_quota_controller_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default') as adc, mock.patch('google.api.servicecontrol_v1.services.quota_controller.transports.QuotaControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.QuotaControllerTransport()
        adc.assert_called_once()
...
def test_quota_controller_transport_auth_adc():
    ...
    with mock.patch.object(auth, 'default') as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.QuotaControllerGrpcTransport(host="squid.clam.whelk", quota_project_id="octopus")
        adc.assert_called_once_with(scopes=(
            'https://www.googleapis.com/auth/cloud-platform',
            'https://www.googleapis.com/auth/servicecontrol',),
            quota_project_id="octopus",
