...
class QuotaControllerClientMeta(type):
    """Metaclass for the QuotaController client.
...
class QuotaControllerClient(metaclass=QuotaControllerClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            QuotaControllerClient: The constructed client.
        """
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, QuotaControllerTransport):
            # transport is a QuotaControllerTransport instance.
