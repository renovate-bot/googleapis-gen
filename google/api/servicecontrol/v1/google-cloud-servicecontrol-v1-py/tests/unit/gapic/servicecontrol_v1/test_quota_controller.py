...
from google.cloud.servicecontrol_v1.services.quota_controller import QuotaControllerAsyncClient
from google.cloud.servicecontrol_v1.services.quota_controller import QuotaControllerClient
from google.cloud.servicecontrol_v1.services.quota_controller import transports
from google.cloud.servicecontrol_v1.services.quota_controller.transports.base import _API_CORE_VERSION
from google.cloud.servicecontrol_v1.services.quota_controller.transports.base import _GOOGLE_AUTH_VERSION
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (QuotaControllerAsyncClient, transports.QuotaControllerGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (QuotaControllerClient, transports.QuotaControllerGrpcTransport, "grpc", "true"),
    (QuotaControllerAsyncClient, transports.QuotaControllerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (QuotaControllerClient, transports.QuotaControllerGrpcTransport, "grpc", "false"),
    (QuotaControllerAsyncClient, transports.QuotaControllerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(QuotaControllerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(QuotaControllerClient))
@mock.patch.object(QuotaControllerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(QuotaControllerAsyncClient))
...
def test_quota_controller_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_allocate_quota(transport: str = 'grpc', request_type=quota_controller.AllocateQuotaRequest):
    client = QuotaControllerClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_quota_controller_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.servicecontrol_v1.services.quota_controller.transports.QuotaControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_quota_controller_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.servicecontrol_v1.services.quota_controller.transports.QuotaControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_quota_controller_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.servicecontrol_v1.services.quota_controller.transports.QuotaControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.QuotaControllerTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_quota_controller_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        QuotaControllerClient()
...
@requires_google_auth_lt_1_25_0
def test_quota_controller_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize(
    ...
    [
        (transports.QuotaControllerGrpcTransport, grpc_helpers),
        (transports.QuotaControllerGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_quota_controller_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_quota_controller_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
def test_quota_controller_host_no_port():
    client = QuotaControllerClient(
        credentials=credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='servicecontrol.googleapis.com'),
    )
    assert client.transport._host == 'servicecontrol.googleapis.com:443'
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.QuotaControllerGrpcTransport, transports.QuotaControllerGrpcAsyncIOTransport])
def test_quota_controller_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
