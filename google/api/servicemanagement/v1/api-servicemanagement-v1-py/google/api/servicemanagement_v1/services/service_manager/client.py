...
class ServiceManagerClient(metaclass=ServiceManagerClientMeta):
    ...
    def list_services(self,
        ...
        **BETA:** If the caller specifies the ``consumer_id``, it
        ...
        Returns:
            google.api.servicemanagement_v1.services.service_manager.pagers.ListServicesPager:
    ...
    def get_service(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.GetServiceRequest):
    ...
    def create_service(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.CreateServiceRequest):
                The request object. Request message for CreateService
                method.
            service (google.api.servicemanagement_v1.types.ManagedService):
    ...
    def delete_service(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.DeleteServiceRequest):
    ...
    def undelete_service(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.UndeleteServiceRequest):
    ...
    def list_service_configs(self,
        ...
        Returns:
            google.api.servicemanagement_v1.services.service_manager.pagers.ListServiceConfigsPager:
    ...
    def get_service_config(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.GetServiceConfigRequest):
            ...
            config_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            view (google.api.servicemanagement_v1.types.GetServiceConfigRequest.ConfigView):
    ...
    def create_service_config(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.CreateServiceConfigRequest):
                The request object. Request message for
    ...
    def submit_config_source(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.SubmitConfigSourceRequest):
                The request object. Request message for
            ...
            service_name (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            config_source (google.api.servicemanagement_v1.types.ConfigSource):
    ...
    def list_service_rollouts(self,
        ...
        Returns:
            google.api.servicemanagement_v1.services.service_manager.pagers.ListServiceRolloutsPager:
                Response message for
    ...
    def get_service_rollout(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.GetServiceRolloutRequest):
                The request object. Request message for
    ...
    def create_service_rollout(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.CreateServiceRolloutRequest):
                The request object. Request message for
            ...
            service_name (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            rollout (google.api.servicemanagement_v1.types.Rollout):
    ...
    def generate_config_report(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.GenerateConfigReportRequest):
                The request object. Request message for
    ...
    def enable_service(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.EnableServiceRequest):
    ...
    def disable_service(self,
        ...
        Args:
            request (google.api.servicemanagement_v1.types.DisableServiceRequest):
