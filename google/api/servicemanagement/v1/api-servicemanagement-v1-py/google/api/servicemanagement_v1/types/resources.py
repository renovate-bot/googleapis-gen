...
class OperationMetadata(proto.Message):
    ...
    Attributes:
        ...
        steps (Sequence[google.api.servicemanagement_v1.types.OperationMetadata.Step]):
    ...
    class Step(proto.Message):
        ...
        Attributes:
            ...
            status (google.api.servicemanagement_v1.types.OperationMetadata.Status):
                The status code.
        """
    ...
    steps = proto.RepeatedField(proto.MESSAGE, number=2,
        message=Step,
    )
...
class Diagnostic(proto.Message):
    ...
    Attributes:
        location (str):
            ...
            warning.
        kind (google.api.servicemanagement_v1.types.Diagnostic.Kind):
...
class ConfigSource(proto.Message):
    ...
    Attributes:
        ...
        files (Sequence[google.api.servicemanagement_v1.types.ConfigFile]):
...
class ConfigFile(proto.Message):
    ...
    Attributes:
        ...
        file_type (google.api.servicemanagement_v1.types.ConfigFile.FileType):
    ...
    file_type = proto.Field(proto.ENUM, number=4,
        enum=FileType,
    )
...
class ChangeReport(proto.Message):
    ...
    config_changes = proto.RepeatedField(proto.MESSAGE, number=1,
        message=config_change.ConfigChange,
    )
...
class Rollout(proto.Message):
    ...
    Attributes:
        ...
        status (google.api.servicemanagement_v1.types.Rollout.RolloutStatus):
            ...
            version. Readonly.
        traffic_percent_strategy (google.api.servicemanagement_v1.types.Rollout.TrafficPercentStrategy):
            Google Service Control selects service
            configurations based on traffic percentage.
        delete_service_strategy (google.api.servicemanagement_v1.types.Rollout.DeleteServiceStrategy):
    ...
    class TrafficPercentStrategy(proto.Message):
        ...
        Attributes:
            percentages (Sequence[google.api.servicemanagement_v1.types.Rollout.TrafficPercentStrategy.PercentagesEntry]):
    ...
    traffic_percent_strategy = proto.Field(proto.MESSAGE, number=5, oneof='strategy',
        message=TrafficPercentStrategy,
    )

    delete_service_strategy = proto.Field(proto.MESSAGE, number=200, oneof='strategy',
