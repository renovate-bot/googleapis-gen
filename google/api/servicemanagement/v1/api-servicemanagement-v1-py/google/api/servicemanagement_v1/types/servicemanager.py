...
class ListServicesResponse(proto.Message):
    ...
    Attributes:
        services (Sequence[google.api.servicemanagement_v1.types.ManagedService]):
...
class ListServiceRolloutsResponse(proto.Message):
    ...
    Attributes:
        rollouts (Sequence[google.api.servicemanagement_v1.types.Rollout]):
...
class GenerateConfigReportResponse(proto.Message):
    ...
    Attributes:
        ...
        id (str):
            ...
            belongs to.
        change_reports (Sequence[google.api.servicemanagement_v1.types.ChangeReport]):
            list of ChangeReport, each corresponding to
            comparison between two service configurations.
        diagnostics (Sequence[google.api.servicemanagement_v1.types.Diagnostic]):
