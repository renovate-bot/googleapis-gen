...
class ListServicesPager:
    ...
    :class:`google.api.servicemanagement_v1.types.ListServicesResponse` object, and
    ...
    All the usual :class:`google.api.servicemanagement_v1.types.ListServicesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.api.servicemanagement_v1.types.ListServicesRequest):
                The initial request object.
            response (google.api.servicemanagement_v1.types.ListServicesResponse):
...
class ListServiceConfigsPager:
    ...
    This class thinly wraps an initial
    :class:`google.api.servicemanagement_v1.types.ListServiceConfigsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.api.servicemanagement_v1.types.ListServiceConfigsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.api.servicemanagement_v1.types.ListServiceConfigsRequest):
                The initial request object.
            response (google.api.servicemanagement_v1.types.ListServiceConfigsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
...
class ListServiceRolloutsPager:
    ...
    This class thinly wraps an initial
    :class:`google.api.servicemanagement_v1.types.ListServiceRolloutsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``rollouts`` field.
    ...
    All the usual :class:`google.api.servicemanagement_v1.types.ListServiceRolloutsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.api.servicemanagement_v1.types.ListServiceRolloutsRequest):
                The initial request object.
            response (google.api.servicemanagement_v1.types.ListServiceRolloutsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
