...
class ServiceManagerTransport(abc.ABC):
    ...
    def get_service(self) -> typing.Callable[
            ...
            typing.Union[
                ...
                typing.Awaitable[resources.ManagedService]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def undelete_service(self) -> typing.Callable[
    ...
    @property
    def list_service_configs(self) -> typing.Callable[
    ...
    @property
    def get_service_config(self) -> typing.Callable[
    ...
    @property
    def create_service_config(self) -> typing.Callable[
    ...
    @property
    def submit_config_source(self) -> typing.Callable[
    ...
    @property
    def list_service_rollouts(self) -> typing.Callable[
    ...
    @property
    def get_service_rollout(self) -> typing.Callable[
    ...
    @property
    def create_service_rollout(self) -> typing.Callable[
    ...
    @property
    def generate_config_report(self) -> typing.Callable[
