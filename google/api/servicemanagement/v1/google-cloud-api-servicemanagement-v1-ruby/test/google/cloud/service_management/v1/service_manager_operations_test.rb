...
class ::Google::Cloud::ServiceManagement::V1::ServiceManager::OperationsTest < Minitest::Test
  class ClientStub
  ...
  def test_list_operations
    ...
    Gapic::ServiceStub.stub :new, list_operations_client_stub do
      # Create client
      client = ::Google::Cloud::ServiceManagement::V1::ServiceManager::Operations.new do |config|
  ...
  def test_configure
    ...
    assert_kind_of ::Google::Cloud::ServiceManagement::V1::ServiceManager::Operations::Configuration, config
  end
end
