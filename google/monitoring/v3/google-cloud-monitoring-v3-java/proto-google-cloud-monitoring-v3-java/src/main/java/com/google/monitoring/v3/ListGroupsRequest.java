...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    switch (filterCase_) {
      case 2:
        if (!getChildrenOfGroup()
            .equals(other.getChildrenOfGroup())) return false;
        break;
      case 3:
        if (!getAncestorsOfGroup()
            .equals(other.getAncestorsOfGroup())) return false;
        break;
      case 4:
        if (!getDescendantsOfGroup()
            .equals(other.getDescendantsOfGroup())) return false;
        break;
      case 0:
      default:
    }
