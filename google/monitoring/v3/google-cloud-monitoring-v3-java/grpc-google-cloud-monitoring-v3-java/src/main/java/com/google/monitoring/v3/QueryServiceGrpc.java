...
public final class QueryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.monitoring.v3.QueryTimeSeriesRequest,
      com.google.monitoring.v3.QueryTimeSeriesResponse> getQueryTimeSeriesMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.monitoring.v3.QueryTimeSeriesRequest,
      com.google.monitoring.v3.QueryTimeSeriesResponse> getQueryTimeSeriesMethod() {
    io.grpc.MethodDescriptor<com.google.monitoring.v3.QueryTimeSeriesRequest, com.google.monitoring.v3.QueryTimeSeriesResponse> getQueryTimeSeriesMethod;
      ...
      synchronized (QueryServiceGrpc.class) {
        if ((getQueryTimeSeriesMethod = QueryServiceGrpc.getQueryTimeSeriesMethod) == null) {
          QueryServiceGrpc.getQueryTimeSeriesMethod = getQueryTimeSeriesMethod =
              io.grpc.MethodDescriptor.<com.google.monitoring.v3.QueryTimeSeriesRequest, com.google.monitoring.v3.QueryTimeSeriesResponse>newBuilder()
  ...
  public static abstract class QueryServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void queryTimeSeries(com.google.monitoring.v3.QueryTimeSeriesRequest request,
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.QueryTimeSeriesResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getQueryTimeSeriesMethod(), responseObserver);
    }
  ...
  public static final class QueryServiceStub extends io.grpc.stub.AbstractAsyncStub<QueryServiceStub> {
    ...
    public void queryTimeSeries(com.google.monitoring.v3.QueryTimeSeriesRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryTimeSeriesMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class QueryServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<QueryServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.monitoring.v3.QueryTimeSeriesResponse queryTimeSeries(com.google.monitoring.v3.QueryTimeSeriesRequest request) {
  ...
  public static final class QueryServiceFutureStub extends io.grpc.stub.AbstractFutureStub<QueryServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.monitoring.v3.QueryTimeSeriesResponse> queryTimeSeries(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_QUERY_TIME_SERIES:
          serviceImpl.queryTimeSeries((com.google.monitoring.v3.QueryTimeSeriesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.monitoring.v3.QueryTimeSeriesResponse>) responseObserver);
          break;
        default:
