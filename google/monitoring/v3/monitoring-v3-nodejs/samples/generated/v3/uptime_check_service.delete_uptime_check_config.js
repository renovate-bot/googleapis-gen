...
function main(name) {
  // [START monitoring_v3_generated_UptimeCheckService_DeleteUptimeCheckConfig_async]
  /**
  ...
  // [END monitoring_v3_generated_UptimeCheckService_DeleteUptimeCheckConfig_async]
}
