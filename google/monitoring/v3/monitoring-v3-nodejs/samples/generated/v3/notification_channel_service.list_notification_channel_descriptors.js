...
function main(name) {
  // [START monitoring_list_notification_channel_descriptors_sample]
  /**
  ...
  async function listNotificationChannelDescriptors() {
    ...
    // Run request
    const iterable = await monitoringClient.listNotificationChannelDescriptorsAsync(request);
  ...
  // [END monitoring_list_notification_channel_descriptors_sample]
}
