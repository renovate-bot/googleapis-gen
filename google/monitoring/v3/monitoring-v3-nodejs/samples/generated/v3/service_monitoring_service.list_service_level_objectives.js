...
function main(parent) {
  // [START monitoring_list_service_level_objectives_sample]
  /**
  ...
  async function listServiceLevelObjectives() {
    ...
    // Run request
    const iterable = await monitoringClient.listServiceLevelObjectivesAsync(request);
  ...
  // [END monitoring_list_service_level_objectives_sample]
}
