...
describe('v3.AlertPolicyServiceClient', () => {
        ...
        it('invokes getAlertPolicy without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAlertPolicy(
                    request,
                    (err?: Error|null, result?: protos.google.monitoring.v3.IAlertPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listAlertPolicies', () => {
        ...
        it('invokes listAlertPolicies without error using callback', async () => {
            ...
            client.innerApiCalls.listAlertPolicies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('uses async iteration with listAlertPolicies without error', async () => {
            ...
            client.descriptors.page.listAlertPolicies.asyncIterate = stubAsyncIterationCall(expectedResponse);
