...
require File.expand_path("lib/google/cloud/monitoring/v3/version", __dir__)

Gem::Specification.new do |gem|
  gem.name          = "google-cloud-monitoring-v3"
  gem.version       = Google::Cloud::Monitoring::V3::VERSION
  ...
  gem.summary       = "API Client library for the Cloud Monitoring V3 API"
