...
class ListMonitoredResourceDescriptorsPager:
    ...
    @property
    def pages(self) -> Iterable[metric_service.ListMonitoredResourceDescriptorsResponse]:
...
class ListMonitoredResourceDescriptorsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[metric_service.ListMonitoredResourceDescriptorsResponse]],
            request: metric_service.ListMonitoredResourceDescriptorsRequest,
            response: metric_service.ListMonitoredResourceDescriptorsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterable[metric_service.ListMonitoredResourceDescriptorsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListMetricDescriptorsAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterable[metric_service.ListMetricDescriptorsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
