...
class NotificationChannelServiceAsyncClient:
    ...
    from_service_account_info = NotificationChannelServiceClient.from_service_account_info
    from_service_account_file = NotificationChannelServiceClient.from_service_account_file
