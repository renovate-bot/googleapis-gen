...
class NotificationChannelServiceGrpcAsyncIOTransport(NotificationChannelServiceTransport):
    ...
    def list_notification_channel_descriptors(self) -> Callable[
        ...
        if 'list_notification_channel_descriptors' not in self._stubs:
            self._stubs['list_notification_channel_descriptors'] = self.grpc_channel.unary_unary(
    ...
    def get_notification_channel_descriptor(self) -> Callable[
        ...
        if 'get_notification_channel_descriptor' not in self._stubs:
            self._stubs['get_notification_channel_descriptor'] = self.grpc_channel.unary_unary(
    ...
    def get_notification_channel_verification_code(self) -> Callable[
        ...
        if 'get_notification_channel_verification_code' not in self._stubs:
            self._stubs['get_notification_channel_verification_code'] = self.grpc_channel.unary_unary(
