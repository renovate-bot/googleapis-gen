...
class AlertPolicyServiceTransport(abc.ABC):
    ...
    @property
    def list_alert_policies(self) -> typing.Callable[
            [alert_service.ListAlertPoliciesRequest],
            typing.Union[
                alert_service.ListAlertPoliciesResponse,
                typing.Awaitable[alert_service.ListAlertPoliciesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_alert_policy(self) -> typing.Callable[
            [alert_service.GetAlertPolicyRequest],
            typing.Union[
                alert.AlertPolicy,
                typing.Awaitable[alert.AlertPolicy]
            ]]:
        raise NotImplementedError()

    @property
    def create_alert_policy(self) -> typing.Callable[
    ...
    @property
    def delete_alert_policy(self) -> typing.Callable[
    ...
    @property
    def update_alert_policy(self) -> typing.Callable[
