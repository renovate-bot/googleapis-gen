...
class GroupServiceTransport(abc.ABC):
    ...
    @property
    def list_groups(self) -> typing.Callable[
            [group_service.ListGroupsRequest],
            typing.Union[
                group_service.ListGroupsResponse,
                typing.Awaitable[group_service.ListGroupsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_group(self) -> typing.Callable[
            [group_service.GetGroupRequest],
            typing.Union[
                group.Group,
                typing.Awaitable[group.Group]
            ]]:
        raise NotImplementedError()

    @property
    def create_group(self) -> typing.Callable[
            [group_service.CreateGroupRequest],
            typing.Union[
                gm_group.Group,
                typing.Awaitable[gm_group.Group]
            ]]:
        raise NotImplementedError()

    @property
    def update_group(self) -> typing.Callable[
    ...
    @property
    def delete_group(self) -> typing.Callable[
    ...
    @property
    def list_group_members(self) -> typing.Callable[
            [group_service.ListGroupMembersRequest],
            typing.Union[
                group_service.ListGroupMembersResponse,
                typing.Awaitable[group_service.ListGroupMembersResponse]
            ]]:
        raise NotImplementedError()
