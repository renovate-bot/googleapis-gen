...
class AlertPolicyServiceAsyncClient:
    ...
    from_service_account_info = AlertPolicyServiceClient.from_service_account_info
    ...
    get_transport_class = functools.partial(type(AlertPolicyServiceClient).get_transport_class, type(AlertPolicyServiceClient))
