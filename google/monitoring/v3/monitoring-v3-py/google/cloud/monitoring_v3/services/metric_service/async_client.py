...
class MetricServiceAsyncClient:
    ...
    from_service_account_info = MetricServiceClient.from_service_account_info
    ...
    get_transport_class = functools.partial(type(MetricServiceClient).get_transport_class, type(MetricServiceClient))
    ...
    async def get_monitored_resource_descriptor(self,
    ...
    async def get_metric_descriptor(self,
    ...
    async def create_metric_descriptor(self,
    ...
    async def delete_metric_descriptor(self,
    ...
    async def list_time_series(self,
    ...
    async def create_time_series(self,
