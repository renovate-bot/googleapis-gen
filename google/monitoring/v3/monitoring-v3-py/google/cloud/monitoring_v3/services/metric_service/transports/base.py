...
class MetricServiceTransport(abc.ABC):
    ...
    @property
    def list_monitored_resource_descriptors(self) -> typing.Callable[
    ...
    @property
    def get_monitored_resource_descriptor(self) -> typing.Callable[
    ...
    @property
    def list_metric_descriptors(self) -> typing.Callable[
    ...
    @property
    def get_metric_descriptor(self) -> typing.Callable[
            [metric_service.GetMetricDescriptorRequest],
            typing.Union[
                ga_metric.MetricDescriptor,
                typing.Awaitable[ga_metric.MetricDescriptor]
            ]]:
        raise NotImplementedError()

    @property
    def create_metric_descriptor(self) -> typing.Callable[
    ...
    @property
    def delete_metric_descriptor(self) -> typing.Callable[
    ...
    @property
    def list_time_series(self) -> typing.Callable[
    ...
    @property
    def create_time_series(self) -> typing.Callable[
