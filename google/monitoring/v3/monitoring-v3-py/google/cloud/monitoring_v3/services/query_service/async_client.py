...
class QueryServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(QueryServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(QueryServiceClient.parse_common_billing_account_path)
    ...
    parse_common_project_path = staticmethod(QueryServiceClient.parse_common_project_path)
    common_location_path = staticmethod(QueryServiceClient.common_location_path)
    parse_common_location_path = staticmethod(QueryServiceClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return QueryServiceClient.from_service_account_info.__func__(QueryServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            QueryServiceAsyncClient: The constructed client.
        """
        return QueryServiceClient.from_service_account_file.__func__(QueryServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    get_transport_class = functools.partial(type(QueryServiceClient).get_transport_class, type(QueryServiceClient))
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            transport (Union[str, ~.QueryServiceTransport]): The
