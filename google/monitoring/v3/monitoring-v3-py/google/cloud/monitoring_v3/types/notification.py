...
class NotificationChannelDescriptor(proto.Message):
    ...
    labels = proto.RepeatedField(proto.MESSAGE, number=4,
        message=label.LabelDescriptor,
    )

    supported_tiers = proto.RepeatedField(proto.ENUM, number=5,
        enum=common.ServiceTier,
    )

    launch_stage = proto.Field(proto.ENUM, number=7,
...
class NotificationChannel(proto.Message):
    ...
    verification_status = proto.Field(proto.ENUM, number=9,
