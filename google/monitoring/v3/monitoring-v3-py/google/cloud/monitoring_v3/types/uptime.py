...
class UptimeCheckConfig(proto.Message):
    ...
    class HttpCheck(proto.Message):
        ...
        request_method = proto.Field(proto.ENUM, number=8,
        ...
        auth_info = proto.Field(proto.MESSAGE, number=4,
        ...
        content_type = proto.Field(proto.ENUM, number=9,
    ...
    class ContentMatcher(proto.Message):
        ...
        matcher = proto.Field(proto.ENUM, number=2,
    ...
    monitored_resource = proto.Field(proto.MESSAGE, number=3, oneof='resource',
        message=ga_monitored_resource.MonitoredResource,
    )

    resource_group = proto.Field(proto.MESSAGE, number=4, oneof='resource',
        message=ResourceGroup,
    )

    http_check = proto.Field(proto.MESSAGE, number=5, oneof='check_request_type',
        message=HttpCheck,
    )

    tcp_check = proto.Field(proto.MESSAGE, number=6, oneof='check_request_type',
        message=TcpCheck,
    )

    period = proto.Field(proto.MESSAGE, number=7,
        message=duration.Duration,
    )

    timeout = proto.Field(proto.MESSAGE, number=8,
        message=duration.Duration,
    )

    content_matchers = proto.RepeatedField(proto.MESSAGE, number=9,
        message=ContentMatcher,
    )

    selected_regions = proto.RepeatedField(proto.ENUM, number=10,
        enum='UptimeCheckRegion',
    )

    is_internal = proto.Field(proto.BOOL, number=15)

    internal_checkers = proto.RepeatedField(proto.MESSAGE, number=14,
...
class UptimeCheckIp(proto.Message):
    ...
    region = proto.Field(proto.ENUM, number=1,
        enum='UptimeCheckRegion',
    )
