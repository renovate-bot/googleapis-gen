...
namespace Google.Monitoring.Dashboard.V1
{
    ...
    {
        /// <summary>
        /// <see cref="gmdv::AlertPolicyName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gmdv::AlertPolicyName AlertPolicyName
        {
            get => string.IsNullOrEmpty(Name) ? null : gmdv::AlertPolicyName.Parse(Name, allowUnparsed: true);
