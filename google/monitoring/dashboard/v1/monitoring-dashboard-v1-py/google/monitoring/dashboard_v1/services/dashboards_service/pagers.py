...
class ListDashboardsPager:
    ...
    :class:`google.monitoring.dashboard_v1.types.ListDashboardsResponse` object, and
    ...
    All the usual :class:`google.monitoring.dashboard_v1.types.ListDashboardsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.monitoring.dashboard_v1.types.ListDashboardsResponse):
