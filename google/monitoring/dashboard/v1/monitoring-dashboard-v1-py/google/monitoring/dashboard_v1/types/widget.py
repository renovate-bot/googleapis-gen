...
class Widget(proto.Message):
    ...
    Attributes:
        ...
        xy_chart (google.monitoring.dashboard_v1.types.XyChart):
            A chart of time series data.
        scorecard (google.monitoring.dashboard_v1.types.Scorecard):
            A scorecard summarizing time series data.
        text (google.monitoring.dashboard_v1.types.Text):
