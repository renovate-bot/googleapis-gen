...
class DashboardsServiceTransport(abc.ABC):
    ...
    @property
    def create_dashboard(self) -> typing.Callable[
            [dashboards_service.CreateDashboardRequest],
            typing.Union[
                dashboard.Dashboard,
                typing.Awaitable[dashboard.Dashboard]
            ]]:
        raise NotImplementedError()

    @property
    def list_dashboards(self) -> typing.Callable[
    ...
    @property
    def get_dashboard(self) -> typing.Callable[
    ...
    @property
    def delete_dashboard(self) -> typing.Callable[
    ...
    @property
    def update_dashboard(self) -> typing.Callable[
