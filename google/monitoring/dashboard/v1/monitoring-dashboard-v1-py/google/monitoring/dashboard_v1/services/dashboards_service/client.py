...
class DashboardsServiceClient(metaclass=DashboardsServiceClientMeta):
    ...
    def dashboard_path(project: str,dashboard: str,) -> str:
        ...
        return "projects/{project}/dashboards/{dashboard}".format(project=project, dashboard=dashboard, )
    ...
    def list_dashboards(self,
        ...
        Returns:
            google.monitoring.dashboard_v1.services.dashboards_service.pagers.ListDashboardsPager:
