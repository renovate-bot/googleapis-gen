...
class Widget extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $title
     *           Optional. The title of the widget.
     *     @type \Google\Monitoring\Dashboard\V1\XyChart $xy_chart
     *           A chart of time series data.
     *     @type \Google\Monitoring\Dashboard\V1\Scorecard $scorecard
     *           A scorecard summarizing time series data.
     *     @type \Google\Monitoring\Dashboard\V1\Text $text
     ...
     *
     * Generated from protobuf field <code>.google.monitoring.dashboard.v1.XyChart xy_chart = 2;</code>
     * @param \Google\Monitoring\Dashboard\V1\XyChart $var
     * @return $this
     */
    public function setXyChart($var)
    {
        GPBUtil::checkMessage($var, \Google\Monitoring\Dashboard\V1\XyChart::class);
     ...
     *
     * Generated from protobuf field <code>.google.monitoring.dashboard.v1.Scorecard scorecard = 3;</code>
     * @param \Google\Monitoring\Dashboard\V1\Scorecard $var
     * @return $this
     */
    public function setScorecard($var)
    {
        GPBUtil::checkMessage($var, \Google\Monitoring\Dashboard\V1\Scorecard::class);
     ...
     *
     * Generated from protobuf field <code>.google.monitoring.dashboard.v1.Text text = 4;</code>
     * @param \Google\Monitoring\Dashboard\V1\Text $var
     * @return $this
     */
    public function setText($var)
    {
        GPBUtil::checkMessage($var, \Google\Monitoring\Dashboard\V1\Text::class);
