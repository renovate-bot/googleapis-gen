...
class SparkChartView extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Monitoring\Dashboard\V1\SparkChartType::class);
...
class_alias(SparkChartView::class, \Google\Monitoring\Dashboard\V1\Scorecard_SparkChartView::class);
