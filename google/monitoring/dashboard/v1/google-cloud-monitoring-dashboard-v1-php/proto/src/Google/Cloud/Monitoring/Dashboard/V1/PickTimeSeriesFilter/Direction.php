...
namespace Google\Cloud\Monitoring\Dashboard\V1\PickTimeSeriesFilter;
...
class_alias(Direction::class, \Google\Cloud\Monitoring\Dashboard\V1\PickTimeSeriesFilter_Direction::class);
