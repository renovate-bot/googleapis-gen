...
namespace Google\Cloud\Monitoring\Dashboard\V1\Aggregation;
 ...
 *
 * Protobuf type <code>google.monitoring.dashboard.v1.Aggregation.Reducer</code>
 */
class Reducer
{
    /**
...
class_alias(Reducer::class, \Google\Cloud\Monitoring\Dashboard\V1\Aggregation_Reducer::class);
