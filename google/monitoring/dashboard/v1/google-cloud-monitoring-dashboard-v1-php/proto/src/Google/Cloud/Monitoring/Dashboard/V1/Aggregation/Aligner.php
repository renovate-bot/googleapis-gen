 ...
 *
 * Protobuf type <code>google.monitoring.dashboard.v1.Aggregation.Aligner</code>
 */
class Aligner
{
    /**
...
class_alias(Aligner::class, \Google\Cloud\Monitoring\Dashboard\V1\Aggregation_Aligner::class);
