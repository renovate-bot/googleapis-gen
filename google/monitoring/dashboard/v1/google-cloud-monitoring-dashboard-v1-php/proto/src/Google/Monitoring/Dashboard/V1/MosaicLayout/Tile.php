...
namespace Google\Monitoring\Dashboard\V1\MosaicLayout;
...
class Tile extends \Google\Protobuf\Internal\Message
{
     ...
     *           The height of the tile, measured in grid blocks. Tiles must have a
     *           minimum height of 1.
     *     @type \Google\Monitoring\Dashboard\V1\Widget $widget
     *           The informational widget contained in the tile. For example an `XyChart`.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.monitoring.dashboard.v1.Widget widget = 5;</code>
     * @return \Google\Monitoring\Dashboard\V1\Widget|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.monitoring.dashboard.v1.Widget widget = 5;</code>
     * @param \Google\Monitoring\Dashboard\V1\Widget $var
     * @return $this
     */
    public function setWidget($var)
    {
        GPBUtil::checkMessage($var, \Google\Monitoring\Dashboard\V1\Widget::class);
        $this->widget = $var;
...
class_alias(Tile::class, \Google\Monitoring\Dashboard\V1\MosaicLayout_Tile::class);
