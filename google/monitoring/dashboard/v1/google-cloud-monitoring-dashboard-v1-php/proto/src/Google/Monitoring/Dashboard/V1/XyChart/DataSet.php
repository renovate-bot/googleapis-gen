...
class DataSet extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Monitoring\Dashboard\V1\XyChart\DataSet\PlotType::class);
        $this->plot_type = $var;
...
class_alias(DataSet::class, \Google\Monitoring\Dashboard\V1\XyChart_DataSet::class);
