...
class TimeSeriesFilterRatio extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Monitoring\Dashboard\V1\TimeSeriesFilterRatio\RatioPart $numerator
     *           The numerator of the ratio.
     *     @type \Google\Monitoring\Dashboard\V1\TimeSeriesFilterRatio\RatioPart $denominator
     *           The denominator of the ratio.
     *     @type \Google\Monitoring\Dashboard\V1\Aggregation $secondary_aggregation
     *           Apply a second aggregation after the ratio is computed.
     *     @type \Google\Monitoring\Dashboard\V1\PickTimeSeriesFilter $pick_time_series_filter
     *           Ranking based time series filter.
     *     @type \Google\Monitoring\Dashboard\V1\StatisticalTimeSeriesFilter $statistical_time_series_filter
     ...
     *
     * Generated from protobuf field <code>.google.monitoring.dashboard.v1.TimeSeriesFilterRatio.RatioPart numerator = 1;</code>
     * @param \Google\Monitoring\Dashboard\V1\TimeSeriesFilterRatio\RatioPart $var
     * @return $this
     */
    public function setNumerator($var)
    {
        GPBUtil::checkMessage($var, \Google\Monitoring\Dashboard\V1\TimeSeriesFilterRatio\RatioPart::class);
        $this->numerator = $var;
     ...
     *
     * Generated from protobuf field <code>.google.monitoring.dashboard.v1.Aggregation secondary_aggregation = 3;</code>
     * @param \Google\Monitoring\Dashboard\V1\Aggregation $var
     * @return $this
     */
    public function setSecondaryAggregation($var)
    {
        GPBUtil::checkMessage($var, \Google\Monitoring\Dashboard\V1\Aggregation::class);
     ...
     *
     * Generated from protobuf field <code>.google.monitoring.dashboard.v1.PickTimeSeriesFilter pick_time_series_filter = 4;</code>
     * @param \Google\Monitoring\Dashboard\V1\PickTimeSeriesFilter $var
     * @return $this
     */
    public function setPickTimeSeriesFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Monitoring\Dashboard\V1\PickTimeSeriesFilter::class);
