...
class PickTimeSeriesFilter extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Monitoring\Dashboard\V1\PickTimeSeriesFilter\Method::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Monitoring\Dashboard\V1\PickTimeSeriesFilter\Direction::class);
        $this->direction = $var;
