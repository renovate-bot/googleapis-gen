...
class Aggregation extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Monitoring\Dashboard\V1\Aggregation\Aligner::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Monitoring\Dashboard\V1\Aggregation\Reducer::class);
