...
namespace Google\Monitoring\Dashboard\V1\TimeSeriesFilterRatio;
...
class_alias(RatioPart::class, \Google\Monitoring\Dashboard\V1\TimeSeriesFilterRatio_RatioPart::class);
