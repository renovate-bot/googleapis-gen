...
In general, the google-cloud-monitoring-dashboard library uses
...
client = Google::Cloud::Monitoring::Dashboard.dashboards_service
```

## Credential Lookup

The google-cloud-monitoring-dashboard library aims to make authentication
...
The environment variables that google-cloud-monitoring-dashboard
...
Google::Cloud::Monitoring::Dashboard.configure do |config|
  config.credentials = "path/to/keyfile.json"
end
...
connect to most services with google-cloud-monitoring-dashboard.
