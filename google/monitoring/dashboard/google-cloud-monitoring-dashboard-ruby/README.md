# Ruby Client for the Cloud Monitoring Dashboard API

API Client library for the Cloud Monitoring Dashboard API
...
_versioned_ client gems, with names of the form `google-cloud-monitoring-dashboard-v*`.
The gem `google-cloud-monitoring-dashboard` is the main client library that brings the
verisoned gems in as dependencies, and provides high-level methods for
constructing clients. More information on versioned clients can be found below
in the section titled *Which client should I use?*.

View the [Client Library Documentation](https://googleapis.dev/ruby/google-cloud-monitoring-dashboard/latest)
for this library, google-cloud-monitoring-dashboard, to see the convenience methods for
