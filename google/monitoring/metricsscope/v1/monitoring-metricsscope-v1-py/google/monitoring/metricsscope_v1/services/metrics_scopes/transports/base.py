...
class MetricsScopesTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.create_monitored_project: gapic_v1.method.wrap_method(
                self.create_monitored_project,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_monitored_project: gapic_v1.method.wrap_method(
                self.delete_monitored_project,
                default_timeout=None,
                client_info=client_info,
            ),
         }
    ...
    @property
    def get_metrics_scope(self) -> Callable[
            [metrics_scopes.GetMetricsScopeRequest],
            Union[
                metrics_scope.MetricsScope,
                Awaitable[metrics_scope.MetricsScope]
            ]]:
        raise NotImplementedError()

    @property
    def list_metrics_scopes_by_monitored_project(self) -> Callable[
    ...
    @property
    def create_monitored_project(self) -> Callable[
    ...
    @property
    def delete_monitored_project(self) -> Callable[
