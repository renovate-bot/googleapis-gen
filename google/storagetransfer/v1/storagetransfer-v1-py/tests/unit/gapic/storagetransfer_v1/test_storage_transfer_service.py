...
from google.storagetransfer_v1.services.storage_transfer_service import StorageTransferServiceAsyncClient
from google.storagetransfer_v1.services.storage_transfer_service import StorageTransferServiceClient
from google.storagetransfer_v1.services.storage_transfer_service import pagers
from google.storagetransfer_v1.services.storage_transfer_service import transports
from google.storagetransfer_v1.services.storage_transfer_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_storage_transfer_service_client_service_account_always_use_jwt(client_class):
...
def test_storage_transfer_service_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (StorageTransferServiceClient, transports.StorageTransferServiceGrpcTransport, "grpc"),
    (StorageTransferServiceAsyncClient, transports.StorageTransferServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (StorageTransferServiceClient, transports.StorageTransferServiceGrpcTransport, "grpc", "true"),
    (StorageTransferServiceAsyncClient, transports.StorageTransferServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (StorageTransferServiceClient, transports.StorageTransferServiceGrpcTransport, "grpc", "false"),
    (StorageTransferServiceAsyncClient, transports.StorageTransferServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(StorageTransferServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(StorageTransferServiceClient))
@mock.patch.object(StorageTransferServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(StorageTransferServiceAsyncClient))
...
def test_storage_transfer_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_storage_transfer_service_client_client_options_from_dict():
    with mock.patch('google.storagetransfer_v1.services.storage_transfer_service.transports.StorageTransferServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_google_service_account(transport: str = 'grpc', request_type=transfer.GetGoogleServiceAccountRequest):
    client = StorageTransferServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            type(client.transport.get_google_service_account),
            '__call__') as call:
...
def test_create_transfer_job(transport: str = 'grpc', request_type=transfer.CreateTransferJobRequest):
    client = StorageTransferServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_transfer_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_transfer_job(transport: str = 'grpc', request_type=transfer.UpdateTransferJobRequest):
    client = StorageTransferServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_transfer_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = transfer_types.TransferJob(
            name='name_value',
...
def test_get_transfer_job(transport: str = 'grpc', request_type=transfer.GetTransferJobRequest):
    client = StorageTransferServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_transfer_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = transfer_types.TransferJob(
            name='name_value',
...
def test_list_transfer_jobs(transport: str = 'grpc', request_type=transfer.ListTransferJobsRequest):
    client = StorageTransferServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_list_transfer_jobs_async(transport: str = 'grpc_asyncio', request_type=transfer.ListTransferJobsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(transfer.ListTransferJobsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_transfer_jobs_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, transfer_types.TransferJob)
                   for i in results)
...
def test_pause_transfer_operation(transport: str = 'grpc', request_type=transfer.PauseTransferOperationRequest):
    client = StorageTransferServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.pause_transfer_operation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_resume_transfer_operation(transport: str = 'grpc', request_type=transfer.ResumeTransferOperationRequest):
    client = StorageTransferServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resume_transfer_operation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_run_transfer_job(transport: str = 'grpc', request_type=transfer.RunTransferJobRequest):
    client = StorageTransferServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.run_transfer_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_storage_transfer_service_base_transport():
    ...
    with mock.patch('google.storagetransfer_v1.services.storage_transfer_service.transports.StorageTransferServiceTransport.__init__') as Transport:
...
def test_storage_transfer_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.storagetransfer_v1.services.storage_transfer_service.transports.StorageTransferServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_storage_transfer_service_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.storagetransfer_v1.services.storage_transfer_service.transports.StorageTransferServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_storage_transfer_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.storagetransfer_v1.services.storage_transfer_service.transports.StorageTransferServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.StorageTransferServiceTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_storage_transfer_service_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        StorageTransferServiceClient()
...
@requires_google_auth_lt_1_25_0
def test_storage_transfer_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_storage_transfer_service_host_no_port():
    client = StorageTransferServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='storagetransfer.googleapis.com'),
    )
    assert client.transport._host == 'storagetransfer.googleapis.com:443'
...
def test_storage_transfer_service_host_with_port():
    client = StorageTransferServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='storagetransfer.googleapis.com:8000'),
    )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.StorageTransferServiceGrpcTransport, transports.StorageTransferServiceGrpcAsyncIOTransport])
def test_storage_transfer_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
