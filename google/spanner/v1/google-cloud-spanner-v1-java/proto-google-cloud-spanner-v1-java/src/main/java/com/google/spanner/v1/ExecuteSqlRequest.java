      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 82: {
            ...
            queryOptions_ = input.readMessage(com.google.spanner.v1.ExecuteSqlRequest.QueryOptions.parser(), extensionRegistry);
            if (subBuilder != null) {
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (com.google.spanner.v1.ExecuteSqlRequest.QueryOptions) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeQueryOptions(com.google.spanner.v1.ExecuteSqlRequest.QueryOptions value) {
      if (queryOptionsBuilder_ == null) {
        if (queryOptions_ != null) {
          queryOptions_ =
            com.google.spanner.v1.ExecuteSqlRequest.QueryOptions.newBuilder(queryOptions_).mergeFrom(value).buildPartial();
        } else {
          queryOptions_ = value;
        }
        onChanged();
