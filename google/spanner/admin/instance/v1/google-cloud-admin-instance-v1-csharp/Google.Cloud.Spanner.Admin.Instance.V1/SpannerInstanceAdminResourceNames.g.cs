...
namespace Google.Cloud.Spanner.Admin.Instance.V1
{
    ...
    {
        /// <summary>
        /// <see cref="gcsaiv::InstanceName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public gcsaiv::InstanceName InstanceName
        {
            get => string.IsNullOrEmpty(Name) ? null : gcsaiv::InstanceName.Parse(Name, allowUnparsed: true);
            set => Name = value?.ToString() ?? "";
        }
