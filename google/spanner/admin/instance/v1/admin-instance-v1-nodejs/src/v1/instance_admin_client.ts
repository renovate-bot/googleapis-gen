...
export class InstanceAdminClient {
  ...
  initialize() {
    ...
    const instanceAdminStubMethods =
        ['listInstanceConfigs', 'getInstanceConfig', 'listInstances', 'getInstance', 'createInstance', 'updateInstance', 'deleteInstance', 'setIamPolicy', 'getIamPolicy', 'testIamPermissions'];
