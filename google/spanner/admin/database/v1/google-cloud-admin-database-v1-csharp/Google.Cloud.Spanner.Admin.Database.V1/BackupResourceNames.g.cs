...
namespace Google.Cloud.Spanner.Admin.Database.V1
{
    ...
    public partial class Backup
    {
        ...
        /// <summary>
        /// <see cref="DatabaseName"/>-typed view over the <see cref="ReferencingDatabases"/> resource name property.
        /// </summary>
        public gax::ResourceNameList<DatabaseName> ReferencingDatabasesAsDatabaseNames
        {
            get => new gax::ResourceNameList<DatabaseName>(ReferencingDatabases, s => string.IsNullOrEmpty(s) ? null : DatabaseName.Parse(s, allowUnparsed: true));
        }
    }
    ...
    public partial class BackupInfo
    {
        ...
        /// <summary>
        /// <see cref="DatabaseName"/>-typed view over the <see cref="SourceDatabase"/> resource name property.
        /// </summary>
        public DatabaseName SourceDatabaseAsDatabaseName
        {
            get => string.IsNullOrEmpty(SourceDatabase) ? null : DatabaseName.Parse(SourceDatabase, allowUnparsed: true);
