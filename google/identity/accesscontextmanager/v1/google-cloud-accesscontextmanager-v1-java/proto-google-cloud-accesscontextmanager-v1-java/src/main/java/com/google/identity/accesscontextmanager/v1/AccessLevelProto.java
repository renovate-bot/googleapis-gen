...
public final class AccessLevelProto {
  ...
  static {
    ...
    internal_static_google_identity_accesscontextmanager_v1_AccessLevel_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_identity_accesscontextmanager_v1_AccessLevel_descriptor,
        new java.lang.String[] { "Name", "Title", "Description", "Basic", "Custom", "CreateTime", "UpdateTime", "Level", });
    internal_static_google_identity_accesscontextmanager_v1_BasicLevel_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_identity_accesscontextmanager_v1_BasicLevel_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_identity_accesscontextmanager_v1_BasicLevel_descriptor,
        new java.lang.String[] { "Conditions", "CombiningFunction", });
    internal_static_google_identity_accesscontextmanager_v1_Condition_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_identity_accesscontextmanager_v1_Condition_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_identity_accesscontextmanager_v1_Condition_descriptor,
        new java.lang.String[] { "IpSubnetworks", "DevicePolicy", "RequiredAccessLevels", "Negate", "Members", "Regions", });
    internal_static_google_identity_accesscontextmanager_v1_CustomLevel_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_identity_accesscontextmanager_v1_CustomLevel_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_identity_accesscontextmanager_v1_CustomLevel_descriptor,
        new java.lang.String[] { "Expr", });
    internal_static_google_identity_accesscontextmanager_v1_DevicePolicy_descriptor =
      getDescriptor().getMessageTypes().get(4);
    internal_static_google_identity_accesscontextmanager_v1_DevicePolicy_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_identity_accesscontextmanager_v1_DevicePolicy_descriptor,
        new java.lang.String[] { "RequireScreenlock", "AllowedEncryptionStatuses", "OsConstraints", "AllowedDeviceManagementLevels", "RequireAdminApproval", "RequireCorpOwned", });
    internal_static_google_identity_accesscontextmanager_v1_OsConstraint_descriptor =
      getDescriptor().getMessageTypes().get(5);
    internal_static_google_identity_accesscontextmanager_v1_OsConstraint_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_identity_accesscontextmanager_v1_OsConstraint_descriptor,
        new java.lang.String[] { "OsType", "MinimumVersion", "RequireVerifiedChromeOs", });
    com.google.identity.accesscontextmanager.type.TypeProto.getDescriptor();
    com.google.protobuf.TimestampProto.getDescriptor();
    com.google.type.ExprProto.getDescriptor();
    com.google.api.AnnotationsProto.getDescriptor();
