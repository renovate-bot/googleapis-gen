...
class ServicePerimeter(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            UTC.
        perimeter_type (google.identity.accesscontextmanager_v1.types.ServicePerimeter.PerimeterType):
            ...
            lists must be empty.
        status (google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig):
        ...
        spec (google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig):
    ...
    use_explicit_dry_run_spec = proto.Field(
        proto.BOOL,
        number=9,
    )
...
class ServicePerimeterConfig(proto.Message):
    ...
    Attributes:
        ...
        vpc_accessible_services (google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.VpcAccessibleServices):
            Configuration for APIs allowed within
            Perimeter.
        ingress_policies (Sequence[google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.IngressPolicy]):
        ...
        egress_policies (Sequence[google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.EgressPolicy]):
    ...
    class VpcAccessibleServices(proto.Message):
        ...
        enable_restriction = proto.Field(
            proto.BOOL,
            number=1,
        )
        allowed_services = proto.RepeatedField(
            proto.STRING,
            number=2,
        )
    ...
    class ApiOperation(proto.Message):
        ...
        Attributes:
            ...
            method_selectors (Sequence[google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.MethodSelector]):
        ...
        method_selectors = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
    ...
    class EgressTo(proto.Message):
        ...
        Attributes:
            resources (Sequence[str]):
                ...
                perimeter.
            operations (Sequence[google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.ApiOperation]):
    ...
    class IngressFrom(proto.Message):
        ...
        Attributes:
            sources (Sequence[google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.IngressSource]):
            ...
            identities (Sequence[str]):
                ...
                account only.
            identity_type (google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.IdentityType):
    ...
    class IngressPolicy(proto.Message):
        ...
        Attributes:
            ingress_from (google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.IngressFrom):
                Defines the conditions on the source of a request causing
                this [IngressPolicy]
                [google.identity.accesscontextmanager.v1.ServicePerimeterConfig.IngressPolicy]
                to apply.
            ingress_to (google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.IngressTo):
        ...
        ingress_from = proto.Field(
            proto.MESSAGE,
            number=1,
            message='ServicePerimeterConfig.IngressFrom',
        )
        ingress_to = proto.Field(
            proto.MESSAGE,
            number=2,
    ...
    class EgressPolicy(proto.Message):
        ...
        Attributes:
            egress_from (google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.EgressFrom):
                Defines conditions on the source of a request causing this
                [EgressPolicy]
                [google.identity.accesscontextmanager.v1.ServicePerimeterConfig.EgressPolicy]
                to apply.
            egress_to (google.identity.accesscontextmanager_v1.types.ServicePerimeterConfig.EgressTo):
                Defines the conditions on the [ApiOperation]
                [google.identity.accesscontextmanager.v1.ServicePerimeterConfig.ApiOperation]
        ...
        egress_from = proto.Field(
            proto.MESSAGE,
            number=1,
            message='ServicePerimeterConfig.EgressFrom',
        )
        egress_to = proto.Field(
            proto.MESSAGE,
            number=2,
    ...
    restricted_services = proto.RepeatedField(
        proto.STRING,
        number=4,
    )
    vpc_accessible_services = proto.Field(
        proto.MESSAGE,
        number=10,
        message=VpcAccessibleServices,
    )
    ingress_policies = proto.RepeatedField(
        proto.MESSAGE,
        number=8,
        message=IngressPolicy,
    )
    egress_policies = proto.RepeatedField(
        proto.MESSAGE,
        number=9,
