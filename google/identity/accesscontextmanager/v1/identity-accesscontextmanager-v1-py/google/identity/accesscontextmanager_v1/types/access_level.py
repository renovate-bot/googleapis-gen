...
class BasicLevel(proto.Message):
    ...
    Attributes:
        conditions (Sequence[google.identity.accesscontextmanager_v1.types.Condition]):
            Required. A list of requirements for the ``AccessLevel`` to
            be granted.
        combining_function (google.identity.accesscontextmanager_v1.types.BasicLevel.ConditionCombiningFunction):
    ...
    combining_function = proto.Field(
        proto.ENUM,
        number=2,
...
class Condition(proto.Message):
    ...
    Attributes:
        ...
        device_policy (google.identity.accesscontextmanager_v1.types.DevicePolicy):
    ...
    ip_subnetworks = proto.RepeatedField(
        proto.STRING,
        number=1,
    )
    device_policy = proto.Field(
        proto.MESSAGE,
        number=2,
        message='DevicePolicy',
    )
    required_access_levels = proto.RepeatedField(
        proto.STRING,
        number=3,
    )
    negate = proto.Field(
...
class DevicePolicy(proto.Message):
    ...
    Attributes:
        ...
        allowed_encryption_statuses (Sequence[google.identity.accesscontextmanager.type.device_resources_pb2.DeviceEncryptionStatus]):
            Allowed encryptions statuses, an empty list
            allows all statuses.
        os_constraints (Sequence[google.identity.accesscontextmanager_v1.types.OsConstraint]):
            Allowed OS versions, an empty list allows all
            types and all versions.
        allowed_device_management_levels (Sequence[google.identity.accesscontextmanager.type.device_resources_pb2.DeviceManagementLevel]):
    ...
    require_screenlock = proto.Field(
        proto.BOOL,
        number=1,
    )
    allowed_encryption_statuses = proto.RepeatedField(
        proto.ENUM,
        number=2,
        enum=device_resources_pb2.DeviceEncryptionStatus,
    )
    os_constraints = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
        message='OsConstraint',
    )
    allowed_device_management_levels = proto.RepeatedField(
        proto.ENUM,
        number=6,
        enum=device_resources_pb2.DeviceManagementLevel,
    )
    require_admin_approval = proto.Field(
        proto.BOOL,
        number=7,
    )
    require_corp_owned = proto.Field(
        proto.BOOL,
        number=8,
    )
...
class OsConstraint(proto.Message):
    ...
    Attributes:
        ...
        require_verified_chrome_os (bool):
            ...
            requirements that the device is enterprise-
            managed, conformant to domain policies, and the
            caller has permission to call the API targeted
            by the request.
    """
    ...
    minimum_version = proto.Field(
        proto.STRING,
        number=2,
    )
    require_verified_chrome_os = proto.Field(
        proto.BOOL,
        number=3,
    )
