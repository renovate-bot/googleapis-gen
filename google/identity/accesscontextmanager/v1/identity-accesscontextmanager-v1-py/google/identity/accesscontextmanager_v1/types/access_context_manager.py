...
class ListAccessPoliciesResponse(proto.Message):
    ...
    access_policies = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class ListAccessLevelsRequest(proto.Message):
    ...
    Attributes:
        ...
        access_level_format (google.identity.accesscontextmanager_v1.types.LevelFormat):
    ...
    access_level_format = proto.Field(
        proto.ENUM,
        number=4,
        enum='LevelFormat',
    )
...
class ListServicePerimetersResponse(proto.Message):
    ...
    service_perimeters = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class CommitServicePerimetersRequest(proto.Message):
    ...
    Attributes:
        ...
        etag (str):
            Optional. The etag for the version of the [Access Policy]
            [google.identity.accesscontextmanager.v1alpha.AccessPolicy]
            that this commit operation is to be performed on. If, at the
            time of commit, the etag for the Access Policy stored in
            Access Context Manager is different from the specified etag,
            then the commit operation will not be performed and the call
            will fail. This field is not required. If etag is not
            provided, the operation will be performed as if a valid etag
            is provided.
    """
...
class ListGcpUserAccessBindingsResponse(proto.Message):
    ...
    Attributes:
        gcp_user_access_bindings (Sequence[google.identity.accesscontextmanager_v1.types.GcpUserAccessBinding]):
    ...
    gcp_user_access_bindings = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class CreateGcpUserAccessBindingRequest(proto.Message):
    ...
    gcp_user_access_binding = proto.Field(
        proto.MESSAGE,
        number=2,
        message=gia_gcp_user_access_binding.GcpUserAccessBinding,
    )
